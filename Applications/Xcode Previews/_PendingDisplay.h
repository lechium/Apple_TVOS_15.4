...
- (void).cxx_destruct;	// IMP=0x00200000000041a4
...
- (_Bool)matches:(id)arg1;	// IMP=0x00100000000040d0
- (void)cancelTimeoutTimer;	// IMP=0x001000000000409e
- (void)startTimeoutTimerWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003f6d
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000003df1
