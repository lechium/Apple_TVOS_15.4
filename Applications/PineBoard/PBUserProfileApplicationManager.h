...
+ (id)_contentApplicationIdentifiers;	// IMP=0x00200000002828e0
+ (id)sharedInstance;	// IMP=0x0010000000280d20
+ (id)dependencyDescription;	// IMP=0x0010000000280260
- (void).cxx_destruct;	// IMP=0x0020000000283130
...
- (void)userProfileManagerDidUpdate:(id)arg1;	// IMP=0x0010000000282e20
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x0010000000282a10
- (void)_workQueue_addNotifyObserversDidUpdateApplicationsOperationsWithApplicationIdentifiers:(id)arg1;	// IMP=0x00100000002825e0
- (void)_workQueue_addNotifyObserversWillUpdateApplicationsOperationsWithApplicationIdentifiers:(id)arg1;	// IMP=0x00100000002822e0
- (void)_workQueue_addManageApplicationsOperationsWithPersonaApplicationIdentifiers:(id)arg1 updatingApplicationIdentifiers:(id)arg2;	// IMP=0x00100000002816f0
- (void)_workQueue_didUpdatePersonaEnabledApplicationsWithAddedApplicationIdentifiers:(id)arg1 removedApplicationIdentifiers:(id)arg2;	// IMP=0x0010000000281420
- (void)_workQueue_setSelectedUserProfile:(id)arg1;	// IMP=0x0010000000281200
- (void)removeObserver:(id)arg1;	// IMP=0x00100000002811a0
- (void)addObserver:(id)arg1;	// IMP=0x0010000000281140
...
- (id)_init;	// IMP=0x0010000000280b80
- (id)_initWithAppInfoController:(id)arg1;	// IMP=0x00100000002803e0
