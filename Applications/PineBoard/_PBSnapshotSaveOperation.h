...
- (void).cxx_destruct;	// IMP=0x0020000000105140
...
- (void)cancel;	// IMP=0x0010000000104f20
- (void)main;	// IMP=0x0010000000104200
- (id)initWithSnapshot:(id)arg1 dataProvider:(id)arg2 manifest:(id)arg3;	// IMP=0x0010000000104060
