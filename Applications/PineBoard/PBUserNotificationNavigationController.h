...
- (void).cxx_destruct;	// IMP=0x00200000002b6640
...
- (void)didCancelUserNotificationViewController:(id)arg1;	// IMP=0x00100000002b64b0
- (void)userNotificationViewController:(id)arg1 didSelectButtonIndex:(unsigned long long)arg2;	// IMP=0x00100000002b63f0
@property(retain, nonatomic) PBCFUserNotification *notification;
- (id)initWithUserNotificationViewController:(id)arg1;	// IMP=0x00100000002b6210
