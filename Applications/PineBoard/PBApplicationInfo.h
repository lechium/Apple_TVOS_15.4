...
@interface PBApplicationInfo : _UIApplicationInfo
{
    ...
    MISSING_TYPE *_hasRunAsCurrentUserEntitlement;	// 27 = 0x1b
    _Bool _gameCenterEnabled;	// 28 = 0x1c
    _Bool _hasGetCurrentUserEntitlement;	// 29 = 0x1d
    _Bool _archerLinked;	// 30 = 0x1e
...
+ (_Bool)_isExtraMultiUserApplication:(id)arg1;	// IMP=0x00400000000cecf0
+ (id)_infoPlistKeys;	// IMP=0x00100000000ceb50
+ (id)_entitlementKeys;	// IMP=0x00100000000cea10
- (void).cxx_destruct;	// IMP=0x00100000000cf420
...
- (void)_refreshRunsAsCurrentUser;	// IMP=0x00100000000ce7f0
- (void)_refreshLocalizedName;	// IMP=0x00100000000ce6a0
- (id)getEntitlementValueUncached:(id)arg1 ofClass:(Class)arg2;	// IMP=0x00100000000ce5c0
- (id)getInfoPlistValueUncached:(id)arg1;	// IMP=0x00100000000ce330
...
- (void)_loadFromProxy:(id)arg1;	// IMP=0x00100000000ccb30
- (void)pb_reportUntrustedLaunchAttempt;	// IMP=0x00100000002b66f0
