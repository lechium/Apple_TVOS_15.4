...
- (void).cxx_destruct;	// IMP=0x00200000001ded40
...
- (void)_didSelectButton:(id)arg1;	// IMP=0x00100000001deb00
@property(copy, nonatomic) NSString *descriptionText;
@property(copy, nonatomic) NSString *title;
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000001ddec0
- (id)preferredFocusEnvironments;	// IMP=0x00100000001ddcd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000001dca00
