...
+ (_Bool)isWallpaperRequired;	// IMP=0x00200000002915c0
- (void).cxx_destruct;	// IMP=0x0020000000292380
...
- (id)_newWallpaperView;	// IMP=0x00100000002920f0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000291b20
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00100000002918f0
- (id)initWithBundleIdentifier:(id)arg1 allowsGroupOpacity:(_Bool)arg2;	// IMP=0x00100000002915e0
