...
@interface PBCFUserNotification : NSObject
{
    ...
    MISSING_TYPE *_alternateButtonStyle;	// 200 = 0xc8
...
+ (id)_localizedDefaultButtonTitle;	// IMP=0x0020000000216960
+ (id)_defaultLocalizationBundle;	// IMP=0x0010000000216840
- (void).cxx_destruct;	// IMP=0x0020000000218db0
...
- (long long)_typeForCurrentTemplateKey;	// IMP=0x0010000000218740
- (id)description;	// IMP=0x00100000002185b0
- (void)cancel;	// IMP=0x0010000000218580
- (void)_sendResponse:(unsigned long long)arg1 customButtonResponse:(long long)arg2;	// IMP=0x0010000000217ee0
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x0010000000217bc0
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x0010000000217b40
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x0010000000217a40
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x0010000000217a10
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x0010000000216b00
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x00100000002169f0
