...
- (void).cxx_destruct;	// IMP=0x00200000002cd090
...
- (void)_begin;	// IMP=0x00100000002ccc60
- (_Bool)_canBeInterrupted;	// IMP=0x00100000002ccc40
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 deactivationReasons:(unsigned long long)arg4 presentationDelegate:(id)arg5;	// IMP=0x00100000002cca80
- (id)init;	// IMP=0x00100000002cca50
