...
- (void).cxx_destruct;	// IMP=0x0020000000092fb0
...
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000092f00
- (void)_begin;	// IMP=0x0010000000092c50
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0010000000092ad0
