...
- (void).cxx_destruct;	// IMP=0x0020000000193810
...
- (void)invalidateImage;	// IMP=0x0010000000193730
- (id)fetchImage;	// IMP=0x0010000000192f90
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x0010000000192d60
- (id)init;	// IMP=0x0010000000192d30
