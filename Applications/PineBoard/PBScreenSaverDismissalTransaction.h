...
- (void).cxx_destruct;	// IMP=0x00200000001a1db0
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001a1620
- (id)_defaultAppAnimationTransaction;	// IMP=0x00100000001a14c0
- (void)_begin;	// IMP=0x00100000001a0f00
- (_Bool)_canBeInterrupted;	// IMP=0x00100000001a0ee0
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 updateWallpaper:(_Bool)arg3 applyStartValues:(_Bool)arg4;	// IMP=0x00100000001a0db0
