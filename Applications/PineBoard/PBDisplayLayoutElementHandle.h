...
- (void).cxx_destruct;	// IMP=0x00200000002d8bf0
...
- (void)update:(CDUnknownBlockType)arg1 withReason:(id)arg2;	// IMP=0x00100000002d85a0
- (void)invalidate;	// IMP=0x00100000002d8560
- (id)initWithElement:(id)arg1 publisher:(id)arg2;	// IMP=0x00100000002d8470
