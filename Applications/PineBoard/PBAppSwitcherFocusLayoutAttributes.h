...
- (id)description;	// IMP=0x001000000013f230
- (unsigned long long)hash;	// IMP=0x001000000013ed90
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000013e690
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013e320
