...
- (void).cxx_destruct;	// IMP=0x0020000000093b10
...
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000093640
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000093120
...
- (id)initWithSiriViewController:(id)arg1;	// IMP=0x0010000000093010
