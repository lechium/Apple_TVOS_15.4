...
@class HMCameraProfile, HMCameraStreamControl, HMCameraStreamPreferences, HMCameraUserSettings, HMCameraView, MISSING_TYPE, NSError, NSLayoutConstraint, NSString, TVSBVideoBulletinBadgeView, UIActivityIndicatorView, UIImage, UIImageView, UILabel, UIVisualEffectView;
...
@interface TVSBVideoBulletinCameraContentView : UIView
{
    ...
    MISSING_TYPE *_streamControl;	// 72 = 0x48
...
- (void).cxx_destruct;	// IMP=0x002000000001b970
...
- (void)_updateEffect;	// IMP=0x001000000001b010
- (void)_updateCameraViewConstraints;	// IMP=0x001000000001a720
- (void)_updateAudioStream:(_Bool)arg1;	// IMP=0x001000000001a420
- (_Bool)_shouldDisplayErrorContent;	// IMP=0x001000000001a2b0
- (_Bool)_shouldDisplayAccessModeErrorContent;	// IMP=0x001000000001a130
- (void)_updateContentViews;	// IMP=0x0010000000019c90
- (void)_updateCameraNameLabels;	// IMP=0x0010000000019700
- (void)cameraUserSettingsDidUpdate:(id)arg1;	// IMP=0x00100000000196b0
- (void)cameraStreamControl:(id)arg1 didStopStreamWithError:(id)arg2;	// IMP=0x0010000000019310
- (void)cameraStreamControlDidStartStream:(id)arg1;	// IMP=0x0010000000018c50
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000018b70
- (void)stopStream;	// IMP=0x0010000000018b20
- (void)startStreamIfNecessary;	// IMP=0x0010000000018a00
- (void)setLiveBadgeViewHidden:(_Bool)arg1;	// IMP=0x00100000000189b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000015390
