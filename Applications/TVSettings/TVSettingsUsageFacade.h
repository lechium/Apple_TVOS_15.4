...
- (void).cxx_destruct;	// IMP=0x00200000000d6530
...
- (void)_fetchAppUsageInfo;	// IMP=0x00100000000d5d30
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x00100000000d5cb0
- (void)uninstallAppWithBundleIdentifier:(id)arg1;	// IMP=0x00100000000d5af0
- (void)offloadAppWithBundleIdentifier:(id)arg1;	// IMP=0x00100000000d5880
- (void)dealloc;	// IMP=0x00100000000d5780
- (id)init;	// IMP=0x00100000000d5630
