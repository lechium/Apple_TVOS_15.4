...
- (void).cxx_destruct;	// IMP=0x0020000000071ce0
...
- (void)_presentSetAccessoryNameFailedViewControllerWithError:(id)arg1;	// IMP=0x0010000000071810
- (void)_setDeviceName:(id)arg1;	// IMP=0x0010000000071070
- (id)_nameViewControllerForItem:(id)arg1;	// IMP=0x0010000000070e80
- (void)_advanceMoreInfoItem;	// IMP=0x0010000000070d00
- (_Bool)_hasTiltID;	// IMP=0x0010000000070c80
- (_Bool)_showWiFiSettings;	// IMP=0x0010000000070c20
- (void)_updateDiagnosticsItem:(id)arg1;	// IMP=0x00100000000709e0
- (void)_handlePlayPauseGesture:(id)arg1;	// IMP=0x001000000006fef0
- (void)_handleUpGesture:(id)arg1;	// IMP=0x001000000006fe80
- (void)_handleDownGesture:(id)arg1;	// IMP=0x001000000006fdf0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000006fcf0
- (void)networkUpdated:(id)arg1;	// IMP=0x001000000006fca0
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x001000000006f9f0
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x001000000006f740
- (_Bool)tableView:(id)arg1 canFocusRowAtIndexPath:(id)arg2;	// IMP=0x001000000006f660
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x001000000006f400
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x001000000006f2e0
- (id)loadSettingGroups;	// IMP=0x001000000006b8c0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000006b840
- (void)viewDidLoad;	// IMP=0x001000000006b5a0
- (void)dealloc;	// IMP=0x001000000006b4b0
- (id)initWithStyle:(long long)arg1;	// IMP=0x001000000006b310
