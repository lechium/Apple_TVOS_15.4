...
@class HMAccessory, HMActionSet, HMHome, HMRoom, HMService, HMServiceGroup, HMTrigger, HMUser, HMZone, MISSING_TYPE, NSError;
...
- (MISSING_TYPE *)home:didUpdateTrigger: /* Error: Ran out of types for this method. */;
