...
+ (id)sharedInstance;	// IMP=0x004000000008e5d0
- (void).cxx_destruct;	// IMP=0x0020000000090430
...
- (void)_urlBagLoaded:(id)arg1;	// IMP=0x00100000000902d0
- (void)killStoreApps;	// IMP=0x001000000008fff0
- (void)_updateAutoDownloadApps;	// IMP=0x001000000008ff00
- (void)_updateAutoDownloadAppsPerCloudSyncPreferences;	// IMP=0x001000000008fc20
- (void)_automaticDownloadKindsChangedNotification:(id)arg1;	// IMP=0x001000000008fa50
- (void)_availableLocalesUpdated;	// IMP=0x001000000008f9c0
- (void)_localeUpdated;	// IMP=0x001000000008f930
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000008f810
...
- (void)dealloc;	// IMP=0x001000000008e910
- (id)init;	// IMP=0x001000000008e690
