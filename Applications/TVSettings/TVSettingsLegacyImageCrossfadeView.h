...
- (void).cxx_destruct;	// IMP=0x002000000001aaf0
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x001000000001a620
- (void)_loadNextImage:(id)arg1;	// IMP=0x001000000001a530
- (void)_startTimer;	// IMP=0x001000000001a440
- (struct CGSize)_maximumImageSize;	// IMP=0x001000000001a370
- (void)layoutSubviews;	// IMP=0x00100000000198a0
- (void)didMoveToSuperview;	// IMP=0x0010000000019820
- (void)dealloc;	// IMP=0x00100000000197c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000019660
