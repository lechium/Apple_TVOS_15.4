...
@interface TVSettingsOSUpdateConfiguration : NSObject
{
    ...
    _Bool _isCarryOrLiveOnConfiguration;	// 10 = 0xa
...
- (void).cxx_destruct;	// IMP=0x0020000000083850
@property(nonatomic) _Bool isCarryOrLiveOnConfiguration; // @synthesize isCarryOrLiveOnConfiguration=_isCarryOrLiveOnConfiguration;
...
- (unsigned long long)hash;	// IMP=0x0010000000083450
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000083170
@property(readonly, nonatomic) _Bool isCarryProfileLoaded;
@property(readonly, nonatomic) NSString *fullName;
- (id)description;	// IMP=0x0010000000082d30
