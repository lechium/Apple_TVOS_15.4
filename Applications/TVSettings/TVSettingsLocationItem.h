...
+ (id)allowedSystemServices;	// IMP=0x00400000000b6910
- (void).cxx_destruct;	// IMP=0x00200000000b7a50
...
- (id)initWithInfo:(id)arg1 identifier:(id)arg2;	// IMP=0x00100000000b6aa0
- (id)init;	// IMP=0x00100000000b6a40
