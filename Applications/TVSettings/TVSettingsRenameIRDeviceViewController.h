...
- (void).cxx_destruct;	// IMP=0x0020000000074f00
...
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x0010000000074cd0
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x0010000000074880
- (void)viewDidLoad;	// IMP=0x00100000000746d0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000745e0
