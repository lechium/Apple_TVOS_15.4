...
- (void).cxx_destruct;	// IMP=0x0020000000133790
...
- (id)hiddenDigitImage;	// IMP=0x0010000000132fd0
- (id)arrowImage:(_Bool)arg1;	// IMP=0x0010000000132c20
- (void)downGesture:(id)arg1;	// IMP=0x0010000000132a90
- (void)upGesture:(id)arg1;	// IMP=0x0010000000132930
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000132550
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000132360
- (_Bool)canBecomeFocused;	// IMP=0x0010000000132340
- (void)layoutSubviews;	// IMP=0x0010000000131c30
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000131240
