...
+ (_Bool)automaticallyNotifiesObserversOfAllowAccess;	// IMP=0x00400000000eb230
+ (id)infoWithFacade:(id)arg1 identifier:(id)arg2 allowed:(_Bool)arg3;	// IMP=0x00100000000eafa0
- (void).cxx_destruct;	// IMP=0x00200000000eb2e0
