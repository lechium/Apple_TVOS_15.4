...
@class ACAccountStore, NSArray, NSRecursiveLock, NSString, PBSIgnoreUserProfileAccountNotificationsAssertion, RBSAssertion, SFAuthenticateAccountsService, TVCSHomeManager, TVSettingsUserProfilesValidator, UMUserPersonaContext;
...
- (void).cxx_destruct;	// IMP=0x0020000000161510
...
- (void)_cancelIfNotConnectedYet;	// IMP=0x0010000000160f70
- (void)_cleanUp;	// IMP=0x0010000000160de0
- (void)_deletePersonaIfNeeded;	// IMP=0x0010000000160a40
- (void)_finishWithError:(id)arg1;	// IMP=0x001000000015fde0
- (void)_handleHomeConfigurationStateChange;	// IMP=0x001000000015f6f0
- (void)_beginHomeKitSetup;	// IMP=0x001000000015f220
- (void)_finish;	// IMP=0x001000000015df30
- (void)_handleSetupServiceProgressEvent:(unsigned int)arg1 info:(id)arg2;	// IMP=0x001000000015ced0
- (void)_restorePersona;	// IMP=0x001000000015cd70
- (void)_adoptPersona;	// IMP=0x001000000015c680
- (void)_start;	// IMP=0x001000000015bde0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000015bce0
- (void)authenticateAccountsService:(id)arg1 didFinishAuthentication:(id)arg2;	// IMP=0x001000000015bbe0
- (void)authenticateAccountsService:(id)arg1 didAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x001000000015bb50
- (void)authenticateAccountsService:(id)arg1 willAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x001000000015bac0
- (_Bool)authenticateAccountsService:(id)arg1 shouldSignInAccounts:(id)arg2;	// IMP=0x001000000015b6c0
- (void)stop;	// IMP=0x001000000015b2e0
- (void)start;	// IMP=0x001000000015abf0
- (void)dealloc;	// IMP=0x001000000015aba0
- (id)initWithUserProfileType:(long long)arg1;	// IMP=0x001000000015aa70
