...
- (void).cxx_destruct;	// IMP=0x00200000000cfd70
...
- (void)pairWithPasscode:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000cfb90
- (void)unpairWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000cfae0
- (unsigned long long)hash;	// IMP=0x00100000000cfa60
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000cf710
- (id)initWithEndpoint:(id)arg1;	// IMP=0x00100000000cf600
- (id)initWithDeviceRef:(void *)arg1;	// IMP=0x00100000000cf4e0
