...
- (void).cxx_destruct;	// IMP=0x002000000005af60
...
- (id)description;	// IMP=0x001000000005ad40
- (id)init;	// IMP=0x001000000005ace0
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x001000000005abb0
