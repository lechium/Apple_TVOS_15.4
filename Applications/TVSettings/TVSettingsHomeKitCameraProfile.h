...
@class HFCameraItem, MISSING_TYPE, NSString;
...
@interface TVSettingsHomeKitCameraProfile : NSObject
{
    ...
    MISSING_TYPE *_supportsSmartNotifications;	// 11 = 0xb
...
- (void).cxx_destruct;	// IMP=0x00200000000b2bc0
...
- (id)_legacyMotionBulletinNotification;	// IMP=0x00100000000b2980
- (id)_smartDetectionBulletinNotification;	// IMP=0x00100000000b28e0
- (id)_doorbellBulletinNotification;	// IMP=0x00100000000b2810
- (void)toggledSignificantEventType:(unsigned long long)arg1;	// IMP=0x00100000000b2170
@property(readonly, copy, nonatomic) NSString *profileIdentifier;
@property(readonly, nonatomic) NSString *name;
- (id)cameraProfile;	// IMP=0x00100000000b0f80
- (id)initWithCameraItem:(id)arg1 controlCenterAndSiriEnabled:(_Bool)arg2;	// IMP=0x00100000000b0be0
