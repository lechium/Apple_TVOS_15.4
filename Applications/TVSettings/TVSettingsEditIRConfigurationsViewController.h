...
- (void).cxx_destruct;	// IMP=0x00200000000f21a0
@property(retain, nonatomic) TVSettingsRemotesFacade *remotesFacade; // @synthesize remotesFacade=_remotesFacade;
- (void)_editIRConfiguration:(id)arg1;	// IMP=0x00100000000f0d50
- (id)loadSettingGroups;	// IMP=0x00100000000f0a90
- (id)init;	// IMP=0x00100000000f0990
