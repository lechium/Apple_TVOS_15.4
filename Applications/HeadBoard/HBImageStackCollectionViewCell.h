...
@class MISSING_TYPE, NSArray, NSString, UIColor, UIFocusEffect, UIFont, UILabel, UIMotionEffectGroup, UIView, _TVImageStackView, _UIStackedImageConfiguration, _UIStackedImageContainerView;
...
@interface HBImageStackCollectionViewCell : UICollectionViewCell
{
    ...
    MISSING_TYPE *_showsPersistentFocus;	// 51 = 0x33
...
+ (id)_titleHeightCache;	// IMP=0x0020000000063abb
+ (struct CGSize)_scaledSizeForSize:(struct CGSize)arg1 sizeIncreaseOffset:(double)arg2;	// IMP=0x00100000000614bb
- (void).cxx_destruct;	// IMP=0x00200000000645df
...
- (_Bool)shouldHideFocusForReasons:(unsigned long long)arg1;	// IMP=0x001000000006448f
- (void)_updateTitleLabelContentScaleFactor;	// IMP=0x0010000000064431
- (void)_updateTitleLabelFont;	// IMP=0x0010000000064326
- (void)_updateTitleShadowForFocus:(_Bool)arg1;	// IMP=0x0010000000064192
- (void)_updateTitleTextColorForFocus:(_Bool)arg1;	// IMP=0x001000000006413e
- (void)_updateTitleLayerAlphas;	// IMP=0x0010000000064074
- (void)_updateTitleLayers;	// IMP=0x0010000000063e3b
- (void)_updateTitleWidthAndHeight;	// IMP=0x0010000000063cb6
- (void)_updateTitleWidthForAccessory;	// IMP=0x0010000000063c43
- (void)_updateTitleHeightCache;	// IMP=0x0010000000063b29
- (id)_textColorForFocus:(_Bool)arg1;	// IMP=0x0010000000063a87
- (void)_showPressState;	// IMP=0x00100000000638bb
@property(readonly, nonatomic, getter=_imageViewCenter) struct CGPoint imageViewCenter;
- (void)_layoutSubviewsAnimated:(_Bool)arg1 focused:(_Bool)arg2 focusUpdateContext:(id)arg3 focusAnimationCoordinator:(id)arg4;	// IMP=0x0010000000061cb6
- (double)_maxTitleWidthWithFocus:(_Bool)arg1;	// IMP=0x0010000000061ba6
- (id)_highlightFilterChain:(_Bool)arg1;	// IMP=0x0010000000061aa2
- (void)_ensureTitle;	// IMP=0x0010000000061a0f
- (void)_detachMotionEffects;	// IMP=0x00100000000619f2
- (void)_attachMotionEffects;	// IMP=0x0010000000061857
@property(readonly, nonatomic, getter=_imageConfiguration) _UIStackedImageConfiguration *imageConfiguration;
- (Class)_labelClass;	// IMP=0x00100000000617aa
- (double)_scaleForImageViewState;	// IMP=0x0010000000061565
- (id)layeredImageContainerLayer;	// IMP=0x0010000000060b08
...
- (void)clearPressStateWithDuration:(double)arg1;	// IMP=0x00100000000607be
- (void)clearPressState;	// IMP=0x00100000000607a4
@property(readonly, nonatomic) _Bool allowsMotionEffects;
- (void)setOverlay:(id)arg1;	// IMP=0x00100000000606b3
- (void)prepareForReuse;	// IMP=0x0010000000060626
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x00100000000604db
- (_Bool)_unapplyMotionEffect:(id)arg1;	// IMP=0x00100000000604d3
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000060370
- (void)layoutSubviews;	// IMP=0x001000000006030f
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x0010000000060244
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000060232
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000060173
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000000600b4
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x001000000005fff5
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000005fedb
- (void)willMoveToSuperview:(id)arg1;	// IMP=0x001000000005fe6e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000005fd51
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000005fb1a
