...
- (void).cxx_destruct;	// IMP=0x002000000001b70f
...
- (void)_deflateLayerStack;	// IMP=0x001000000001b542
- (void)_inflateLayerStack;	// IMP=0x001000000001b0f5
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x001000000001af7a
- (id)initWithApplication:(id)arg1;	// IMP=0x001000000001abee
