...
- (void).cxx_destruct;	// IMP=0x0020000000058ee9
...
- (void)_updateWithCurrentStyle;	// IMP=0x0010000000058852
- (void)_updateImageViews;	// IMP=0x00100000000584b1
@property(readonly, nonatomic) struct CGSize imageSize;
- (void)layoutSubviews;	// IMP=0x0010000000057e45
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000057cb5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000057c49
