...
+ (id)_pieImageAtFraction:(double)arg1;	// IMP=0x0040000000047bfd
- (void).cxx_destruct;	// IMP=0x00200000000487c5
...
- (id)_maskImage;	// IMP=0x001000000004854e
- (void)_drawPauseUIWithCenter:(struct CGPoint)arg1;	// IMP=0x0010000000048365
- (void)_drawIncomingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0010000000048260
- (void)_drawOutgoingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0010000000048086
- (void)_drawPieWithCenter:(struct CGPoint)arg1;	// IMP=0x0010000000047f90
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00100000000479f7
- (void)_clearDisplayLink;	// IMP=0x00100000000479bf
- (void)_ensureDisplayLink;	// IMP=0x00100000000478f0
- (void)_onDisplayLink:(id)arg1;	// IMP=0x00100000000477d1
- (void)_updateFractionTransitionAnimated:(_Bool)arg1;	// IMP=0x00100000000476e0
- (void)_updateStateTransitionAnimated:(_Bool)arg1;	// IMP=0x00100000000475c9
- (void);	// IMP=0x001000000004754f
- (void)_updateTransitionsAnimated:(_Bool)arg1;	// IMP=0x0010000000047312
- (_Bool)_hasActiveTransitions;	// IMP=0x00100000000472df
- (void)setState:(long long)arg1 paused:(_Bool)arg2 fractionLoaded:(double)arg3 animated:(_Bool)arg4;	// IMP=0x00100000000471f4
- (void)dealloc;	// IMP=0x00100000000471ab
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000047127
