...
- (id)_promotionImageName;	// IMP=0x0020000000042b03
- (id)_topShelfPromotionCarouselItem;	// IMP=0x0010000000042af1
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0010000000042a26
...
- (id)initWithTopShelfPromotionCarouselItem:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x00100000000428a3
