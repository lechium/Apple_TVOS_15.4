...
+ (id)_fastFetchConfiguration;	// IMP=0x0040000000018f98
+ (id)_noRefetchingConfiguration;	// IMP=0x0010000000018f55
+ (id)_defaultFetchConfiguration;	// IMP=0x0010000000018e77
+ (id)sharedConfiguration;	// IMP=0x0010000000018cf1
- (void).cxx_destruct;	// IMP=0x002000000001913f
...
- (id)initWithFetchMode:(id)arg1;	// IMP=0x0010000000018c7e
