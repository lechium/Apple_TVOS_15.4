...
- (void).cxx_destruct;	// IMP=0x002000000002fde8
...
- (id)description;	// IMP=0x001000000002fbcd
- (void)cancel;	// IMP=0x001000000002fade
- (void)_executionDidBegin;	// IMP=0x001000000002f3bb
- (id)initWithApplicationIdentifier:(id)arg1 fetchIdentifier:(id)arg2 contentExtensionController:(id)arg3;	// IMP=0x001000000002f2cb
