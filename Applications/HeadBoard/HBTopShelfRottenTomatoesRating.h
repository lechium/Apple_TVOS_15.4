...
+ (long long)_freshnessTypeFromTopShelfFreshnessType:(unsigned long long)arg1;	// IMP=0x00200000000a95ff
- (void).cxx_destruct;	// IMP=0x00200000000a9630
...
- (id)initWithTopShelfRottenTomatoesRating:(id)arg1;	// IMP=0x00100000000a93fc
