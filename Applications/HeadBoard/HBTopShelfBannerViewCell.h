...
- (void).cxx_destruct;	// IMP=0x002000000001b945
@property(nonatomic) __weak id <HBTopShelfBannerViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)shouldHideFocusForReasons:(unsigned long long)arg1;	// IMP=0x001000000001b921
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000001b89d
- (void)_setFocusDirection:(struct CGPoint)arg1;	// IMP=0x001000000001b7f4
