...
+ (id)_fileDataWithMetadataData:(id)arg1 flattenedImageData:(id)arg2 radiosityImageData:(id)arg3;	// IMP=0x004000000003ce28
+ (id)_imageDataWithImage:(struct CGImage *)arg1 extraOptions:(id)arg2;	// IMP=0x001000000003ccb9
+ (id)iconFileDataWithApplication:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003c467
- (void).cxx_destruct;	// IMP=0x002000000003d083
...
- (id)radiosityImage;	// IMP=0x001000000003cbf2
@property(readonly, nonatomic) NSArray *layers;
@property(readonly, nonatomic) double imageScale;
@property(readonly, nonatomic) struct CGSize imageSize;
- (id)flattenedImage;	// IMP=0x001000000003ca31
- (id)description;	// IMP=0x001000000003c260
- (id)initWithData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003c02e
