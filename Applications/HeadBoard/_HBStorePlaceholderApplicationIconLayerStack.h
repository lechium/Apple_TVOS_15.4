...
- (void).cxx_destruct;	// IMP=0x002000000003dd3f
...
- (double)scale;	// IMP=0x001000000003dc77
@property(readonly, nonatomic) struct CGSize size;
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x001000000003dc4b
- (id)initWithApplication:(id)arg1;	// IMP=0x001000000003d9f1
