...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000002310
- (void)connectAndPair;	// IMP=0x0010000000002300
- (void)togglePlayPause;	// IMP=0x00100000000022f0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000002250
- (id)init;	// IMP=0x0010000000002220
