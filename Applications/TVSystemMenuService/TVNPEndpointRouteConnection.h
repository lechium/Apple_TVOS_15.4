...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0020000000003080
- (void).cxx_destruct;	// IMP=0x00200000000077c0
...
- (id)_preloadArtwork;	// IMP=0x0010000000007320
- (id)_placeholderArtwork;	// IMP=0x0010000000007220
- (void)_updateState;	// IMP=0x0010000000006fc0
- (void)_updateAutomaticResponseLoading;	// IMP=0x0010000000006ed0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000006790
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x00100000000065d0
- (void)_updateMetadata;	// IMP=0x0010000000004430
- (void)_createRequestController;	// IMP=0x0010000000003db0
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0010000000003ae0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00100000000037f0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0010000000003300
- (void)playPause;	// IMP=0x00100000000032d0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0010000000003240
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003160
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000002fe0
- (id)playerPath;	// IMP=0x0010000000002ef0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0010000000002d00
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00100000000028e0
