...
- (void).cxx_destruct;	// IMP=0x002000000001b650
...
- (void)dismissPictureInPictureViewControllerFromFullScreen:(id)arg1;	// IMP=0x001000000001b4d0
- (void)restorePictureInPictureViewControllerToFullScreen:(id)arg1;	// IMP=0x001000000001b300
- (void)_updateOverlayLayoutElementWithFrame:(struct CGRect)arg1 andTransitionContext:(id)arg2;	// IMP=0x001000000001af50
- (void)_updateOverlayLayoutElementWithViewController:(id)arg1 transitionContext:(id)arg2;	// IMP=0x001000000001ad30
- (void)_menuPressed:(id)arg1;	// IMP=0x001000000001aca0
- (_Bool)dismissTeachableMomentIfNeeded;	// IMP=0x001000000001a7d0
- (void)_showTeachableMoment;	// IMP=0x001000000001a250
- (id)navigationController:(id)arg1 animationControllerForOperation:(long long)arg2 fromViewController:(id)arg3 toViewController:(id)arg4;	// IMP=0x001000000001a0b0
- (void)navigationController:(id)arg1 willShowViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x0010000000019e20
- (void)dismissContentAnimated:(_Bool)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000018fb0
- (void)presentContentAnimated:(_Bool)arg1 options:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000185b0
- (id)preferredFocusEnvironments;	// IMP=0x0010000000018460
- (void)viewDidLoad;	// IMP=0x0010000000017e30
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000017c80
