...
@class NSIndexPath, NSString, UICollectionReusableView, UICollectionView, UICollectionViewCell, UICollectionViewFocusUpdateContext, UIContextMenuConfiguration, UIFocusAnimationCoordinator, UITargetedPreview, UIWindowSceneActivationConfiguration;
