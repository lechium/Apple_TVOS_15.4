...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000cd40
- (void).cxx_destruct;	// IMP=0x0020000000017a50
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000017390
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000016f70
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x00100000000159c0
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0010000000011990
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000011500
- (void)_updateAvailableRoutes;	// IMP=0x0010000000010990
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x00000000000107d0
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0010000000010750
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000010700
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000010500
- (void)presentEARCUpsell;	// IMP=0x0010000000010080
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x001000000000fa40
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000f570
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000e0a0
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000dfc0
- (void)dealloc;	// IMP=0x001000000000da10
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000cef0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000ce50
