...
+ (id)sharedInstance;	// IMP=0x0040000000028f30
- (void).cxx_destruct;	// IMP=0x0020000000029160
...
- (void)dismissSystemMenuAnimated:(_Bool)arg1 result:(id)arg2;	// IMP=0x0010000000029020
