...
- (void)_performNavigationBarAnimations;	// IMP=0x0010000000007d10
- (void)coordinateAdditionalTransitionsWithTransitionCoordinator:(id)arg1;	// IMP=0x0010000000007b35
- (void)configureWithNavigationController:(id)arg1;	// IMP=0x0010000000007abc
