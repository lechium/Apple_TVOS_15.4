...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000341cb
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x0010000000033f59
- (id)initWithDuration:(double)arg1 curve:(long long)arg2 beginningFrame:(struct CGRect)arg3 endingFrame:(struct CGRect)arg4;	// IMP=0x0010000000033ecc
