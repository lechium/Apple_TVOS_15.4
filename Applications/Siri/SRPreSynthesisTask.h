...
- (void).cxx_destruct;	// IMP=0x002000000006b1c4
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x001000000006aea9
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x001000000006a21e
- (id)init;	// IMP=0x0010000000069785
