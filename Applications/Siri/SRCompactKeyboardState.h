...
- (void).cxx_destruct;	// IMP=0x0020000000033ebc
@property(readonly, copy, nonatomic) SRCompactKeyboardAnimation *animation; // @synthesize animation=_animation;
@property(readonly, nonatomic) struct CGRect frame; // @synthesize frame=_frame;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000033e8f
@property(readonly, nonatomic) struct CGRect frameForAnimation;
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x0010000000033a8c
- (id)initWithFrame:(struct CGRect)arg1 animation:(id)arg2;	// IMP=0x0010000000033a0e
