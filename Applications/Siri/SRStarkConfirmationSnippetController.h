...
+ (_Bool)_isSpeechDurationValid:(double)arg1;	// IMP=0x002000000002ee12
+ (void)_buttonType:(long long *)arg1 iconType:(long long *)arg2 title:(id *)arg3 unreadMessagesCount:(id *)arg4 fromConfirmationOption:(id)arg5 withSpeechDurationInSeconds:(double)arg6;	// IMP=0x001000000002ebe4
+ (long long)_buttonIconTypeForIconType:(id)arg1 iconLabel:(id)arg2 speechDurationSeconds:(double)arg3;	// IMP=0x001000000002e804
- (void).cxx_destruct;	// IMP=0x002000000002efbf
...
- (void)progressStateMachine:(id)arg1 ignoredEvent:(unsigned long long)arg2;	// IMP=0x001000000002e713
- (void)progressStateMachine:(id)arg1 didTransitionToState:(unsigned long long)arg2 fromState:(unsigned long long)arg3 forEvent:(unsigned long long)arg4;	// IMP=0x001000000002e3df
- (unsigned long long)styleForConfirmationViewStyle:(id)arg1;	// IMP=0x001000000002e37b
- (void)_startAnimatingMessageReadingProgressIndicatorForDuration:(double)arg1;	// IMP=0x001000000002e216
- (void)_sendGenericAceCommands:(id)arg1 turnIdentifier:(id)arg2 dismissSnippet:(_Bool)arg3;	// IMP=0x001000000002e100
- (void)loadView;	// IMP=0x001000000002e0b4
- (void)messageReadingAnimationTimerFired;	// IMP=0x001000000002df1b
- (void)siriDidStartSpeakingWithIdentifier:(id)arg1;	// IMP=0x001000000002dd91
- (_Bool)allowsReschedulingAutodismiss;	// IMP=0x001000000002dd7c
- (unsigned long long)autoDismissalReason;	// IMP=0x001000000002dd71
- (long long)autoDismissalStrategy;	// IMP=0x001000000002dd66
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x001000000002dcea
- (void)stopMessageReadingProgressAnimation;	// IMP=0x001000000002db95
@property(readonly, nonatomic, getter=isSystemStyle) _Bool systemStyle;
- (void)_updateConfirmationButtonToIconType:(long long)arg1;	// IMP=0x001000000002d9e9
- (void)_resetReadingProgressAndConfirmationButtonIcon;	// IMP=0x001000000002d959
- (void)_populateCommand:(id)arg1 withInstrumentationTurn:(id)arg2;	// IMP=0x001000000002d792
- (void)_setupConfirmationOptionButtons:(id)arg1 withStyle:(unsigned long long)arg2 speechDurationSeconds:(double)arg3;	// IMP=0x001000000002cae3
- (void)_setupMessageReadingProgressForDuration:(double)arg1;	// IMP=0x001000000002ca00
- (id)initWithAceObject:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x001000000002c41e
