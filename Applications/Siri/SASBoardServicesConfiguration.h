...
+ (id)configuration;	// IMP=0x004000000006b896
+ (id)new;	// IMP=0x001000000006b88e
- (void).cxx_destruct;	// IMP=0x002000000006b9f4
...
- (id)identifierForService:(long long)arg1;	// IMP=0x001000000006b934
- (id)domainForService:(long long)arg1;	// IMP=0x001000000006b8fb
- (id)init;	// IMP=0x001000000006b880
- (id)_init;	// IMP=0x001000000006b7d2
