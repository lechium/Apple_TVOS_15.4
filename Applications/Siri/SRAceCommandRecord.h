...
- (void).cxx_destruct;	// IMP=0x002000000007a9ac
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x001000000007a8e2
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x001000000007a3fb
- (void)incrementNumberOfStoppedActions;	// IMP=0x001000000007a3c9
- (void)incrementNumberOfStartedActions;	// IMP=0x001000000007a397
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007a26d
