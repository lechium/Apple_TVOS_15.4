...
- (void).cxx_destruct;	// IMP=0x0020000000038100
...
- (void)_pickRoute:(id)arg1;	// IMP=0x0010000000037950
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x00100000000378a0
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0010000000037730
- (void)_calculateVisibleVolumeCells;	// IMP=0x00100000000371e0
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x0010000000037090
- (id)_gradientMask;	// IMP=0x0010000000036a00
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x00100000000368f0
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0010000000036000
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0010000000035f90
- (void)shareAudioSelected;	// IMP=0x0010000000035ef0
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0010000000035be0
- (void)longPressSelect:(id)arg1;	// IMP=0x0010000000035ae0
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0010000000035980
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x00100000000357b0
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x00100000000355e0
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0010000000035540
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00100000000351b0
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0010000000034f70
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000034e40
- (void)handleVolumeDown;	// IMP=0x0010000000034810
- (void)handleVolumeUp;	// IMP=0x0010000000034180
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x0010000000032ea0
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000032af0
- (void)viewDidLoad;	// IMP=0x0010000000031bb0
- (void)dealloc;	// IMP=0x0010000000031b60
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x0010000000031a00
