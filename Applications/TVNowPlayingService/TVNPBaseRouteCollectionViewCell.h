...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0020000000023840
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x00100000000213a0
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x001000000001d320
+ (_Bool)allowsSelection;	// IMP=0x001000000001d300
- (void).cxx_destruct;	// IMP=0x0020000000023d20
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x0010000000023630
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000022790
- (unsigned long long)_controlStateForCell;	// IMP=0x00100000000226c0
- (void)_addInitialConstraints;	// IMP=0x0010000000021550
- (void)accessoryViewSelected;	// IMP=0x0010000000021390
- (void)routeViewSelected;	// IMP=0x0010000000021380
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x0010000000021340
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0010000000020920
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00100000000207f0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000000206e0
- (void)updateConstraints;	// IMP=0x001000000001e8a0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000001e770
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000001e750
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000001e610
- (void)prepareForReuse;	// IMP=0x001000000001e570
- (id)preferredFocusEnvironments;	// IMP=0x001000000001e3f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001d340
