...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000d6c0
- (void).cxx_destruct;	// IMP=0x0020000000018350
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000017c90
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000017870
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x00100000000162c0
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0010000000012290
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000011e00
- (void)_updateAvailableRoutes;	// IMP=0x0010000000011290
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x00100000000110d0
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0010000000011050
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000011000
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000010e00
- (void)presentEARCUpsell;	// IMP=0x00100000000109a0
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x00100000000103d0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000ff00
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000e9f0
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000e910
- (void)dealloc;	// IMP=0x001000000000e390
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000d870
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000d7d0
- (id)init;	// IMP=0x001000000000d770
