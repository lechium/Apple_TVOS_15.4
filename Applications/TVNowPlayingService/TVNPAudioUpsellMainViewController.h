...
- (void).cxx_destruct;	// IMP=0x002000000002e940
...
- (void)dismissPrompt;	// IMP=0x001000000002e710
- (void)_handleSkipButton;	// IMP=0x001000000002e5a0
- (void)_handleAcceptButton;	// IMP=0x001000000002d760
- (void)_configureButtonsAndLabels;	// IMP=0x001000000002cfa0
- (long long)overrideUserInterfaceStyle;	// IMP=0x001000000002cf80
- (id)preferredFocusEnvironments;	// IMP=0x001000000002ce10
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x001000000002cd90
- (void)viewDidLoad;	// IMP=0x001000000002a530
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000002a450
