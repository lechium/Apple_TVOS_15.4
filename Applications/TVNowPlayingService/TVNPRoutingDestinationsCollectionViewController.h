...
- (id)_indexPathForCurrentDestination;	// IMP=0x001000000000afd0
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x001000000000ae30
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x001000000000acc0
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x001000000000ac50
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x001000000000a3e0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0010000000009f50
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000009a10
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x0010000000009790
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x00100000000094e0
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x0010000000008db0
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000008670
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000000085c0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0010000000008490
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000007dd0
- (void)viewDidLoad;	// IMP=0x0010000000007830
- (void)dealloc;	// IMP=0x0010000000007760
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x00100000000074e0
