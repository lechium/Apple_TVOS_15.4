...
+ (id)_remoteViewControllerInterface;	// IMP=0x0020000000006cc0
+ (id)_exportedInterface;	// IMP=0x0010000000006b80
- (void).cxx_destruct;	// IMP=0x0020000000006ea0
...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0010000000006d30
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000006960
- (void)viewServiceHandleMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000068f0
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x00100000000064e0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000060f0
