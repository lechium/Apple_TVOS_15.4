...
@class MISSING_TYPE, NSArray, NSNumber, NSString, UIImage;
...
- (void).cxx_destruct;	// IMP=0x0020000000019b30
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000019630
- (void)connectAndPair;	// IMP=0x0010000000019620
- (void)togglePlayPause;	// IMP=0x0010000000019610
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000019570
- (MISSING_TYPE *)init;	// IMP=0x0010000000019540
