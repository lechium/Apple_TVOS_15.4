...
- (void).cxx_destruct;	// IMP=0x0020000000025790
@property(retain, nonatomic) TVNPDataImageLoader *imageLoader; // @synthesize imageLoader=_imageLoader;
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x0010000000025520
- (void)replaceMediaItemMetadata:(id)arg1 forProperty:(id)arg2;	// IMP=0x0010000000025470
