...
+ (id)_destinationLayout;	// IMP=0x0020000000029160
- (void).cxx_destruct;	// IMP=0x0020000000029d10
...
- (id)_routesLayout;	// IMP=0x00100000000295d0
- (void)_updateHintText;	// IMP=0x0010000000027df0
- (void)_updateTitleView;	// IMP=0x0010000000027d40
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000027c10
- (void)didPressMute:(id)arg1;	// IMP=0x0010000000027920
- (void)didPressPlayPause:(id)arg1;	// IMP=0x0010000000027880
- (void)didPressMenu:(id)arg1;	// IMP=0x00100000000277e0
- (void)routingViewController:(id)arg1 shareAudioPresentationRequested:(id)arg2;	// IMP=0x0010000000027750
- (void)routingViewControllerWillEndEditingVolume:(id)arg1;	// IMP=0x00100000000276d0
- (void)routingViewControllerWillBeginEditingVolume:(id)arg1;	// IMP=0x0010000000027650
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00100000000275c0
- (id)preferredFocusEnvironments;	// IMP=0x0010000000027540
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00100000000274d0
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000027460
- (void)viewDidLoad;	// IMP=0x00100000000262d0
- (void)dealloc;	// IMP=0x0010000000026150
- (id)initWithRoutingController:(id)arg1 options:(id)arg2;	// IMP=0x00100000000257c0
