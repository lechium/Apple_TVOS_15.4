...
@interface TVNPBaseRoutingDestinationCollectionViewCell : UICollectionViewCell
{
    ...
    struct CGRect;	// 144 = 0x90
}

+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000003c470
...
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003dae0
- (unsigned long long)_controlStateForCell;	// IMP=0x001000000003da10
- (void)_addInitialConstraints;	// IMP=0x001000000003c620
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x001000000003bc60
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000003bb30
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000003bb10
- (void)updateConstraints;	// IMP=0x001000000003b0d0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003afc0
- (void)useFocusedAppearance;	// IMP=0x001000000003af90
- (void)layoutSubviews;	// IMP=0x001000000003ab60
- (void)prepareForReuse;	// IMP=0x001000000003ab00
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000039d40
