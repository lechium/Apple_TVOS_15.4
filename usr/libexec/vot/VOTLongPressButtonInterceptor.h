...
- (void).cxx_destruct;	// IMP=0x002000000011b44e
...
- (void)_timerFired;	// IMP=0x001000000011b346
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x001000000011b1ee
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x001000000011b120
- (void)dealloc;	// IMP=0x001000000011b0b5
- (id)initWithThreadKey:(id)arg1 longPressDelay:(double)arg2 longPressHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000011afd6
