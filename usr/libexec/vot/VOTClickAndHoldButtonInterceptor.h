...
- (void).cxx_destruct;	// IMP=0x002000000011c9f0
...
- (void)_drainQueueAndSendEventsToSystem:(_Bool)arg1;	// IMP=0x001000000011c794
- (void)_releaseTimerFired;	// IMP=0x001000000011c725
- (void)_holdTimerFired;	// IMP=0x001000000011c6b6
- (void)_resetStateAndSendPendingEventsToSystem:(_Bool)arg1;	// IMP=0x001000000011c64c
- (void)_processStateChangeWithEvent:(long long)arg1 axEvent:(id)arg2;	// IMP=0x001000000011c256
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x001000000011c17a
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x001000000011c0a1
- (void)dealloc;	// IMP=0x001000000011c00e
- (id)initWithThreadKey:(id)arg1;	// IMP=0x001000000011be88
