...
- (void).cxx_destruct;	// IMP=0x002000000011be35
...
- (void)_drainQueue:(_Bool)arg1;	// IMP=0x001000000011bb9f
- (_Bool)touchEventOccurred:(id)arg1 inTVDirectTouch:(_Bool)arg2;	// IMP=0x001000000011b963
- (void)_timerFired;	// IMP=0x001000000011b936
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x001000000011b77c
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x001000000011b628
- (void)dealloc;	// IMP=0x001000000011b5a3
- (id)initWithThreadKey:(id)arg1 simpleClickHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011b490
