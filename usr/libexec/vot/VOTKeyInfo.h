...
- (void).cxx_destruct;	// IMP=0x00100000000fdba9
...
- (id)description;	// IMP=0x00100000000fd93f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fd3b5
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x00100000000fd255
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x00100000000fdbdc
