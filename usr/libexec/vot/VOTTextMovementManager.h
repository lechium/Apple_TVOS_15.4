...
- (void).cxx_destruct;	// IMP=0x00200000000d4332
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00100000000d4277
- (void)previousSegment;	// IMP=0x00100000000d41eb
- (void)nextSegment;	// IMP=0x00100000000d4178
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00100000000d3e48
