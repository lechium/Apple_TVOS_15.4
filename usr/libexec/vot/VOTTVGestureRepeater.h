...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x001000000005fbc8
- (long long)_currentGestureRepeaterEvent;	// IMP=0x001000000005fba3
- (double)_delayForCurrentRepeatCount;	// IMP=0x001000000005fb95
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x001000000005fab5
- (void)updateWithEvent:(id)arg1;	// IMP=0x001000000005f880
- (void)dealloc;	// IMP=0x001000000005f77d
- (id)initWithThread:(id)arg1;	// IMP=0x001000000005f535
