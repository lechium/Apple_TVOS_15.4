...
- (void).cxx_destruct;	// IMP=0x002000000005f525
...
- (id)description;	// IMP=0x001000000005f27c
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x001000000005f25e
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x001000000005f1a0
- (id)initWithAttributes:(id)arg1;	// IMP=0x001000000005eeac
