...
- (void).cxx_destruct;	// IMP=0x0040000000071ad0
- (id)init;	// IMP=0x0010000000071a70
- (id)cookieForUrlWithName:(id)arg1:(id)arg2;	// IMP=0x00100000000719b0
- (id)cookiesForUrl:(id)arg1;	// IMP=0x00100000000714d0
