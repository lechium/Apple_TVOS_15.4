...
- (void).cxx_destruct;	// IMP=0x002000000001fa78
@property(retain) ACAccount *activeiTunesAccount; // @synthesize activeiTunesAccount=_activeiTunesAccount;
@property(readonly, nonatomic) ACAccountStore *accountStore; // @synthesize accountStore=_accountStore;
- (_Bool)isAutomaticDownloadingEnabled;	// IMP=0x001000000001f9d1
- (_Bool)deletableSystemAppCanBeInstalledOnWatchWithBundleID:(id)arg1;	// IMP=0x001000000001f9c9
- (id)isPairedSystemVersionAtLeast:(id)arg1;	// IMP=0x001000000001f937
- (_Bool)isActivePairedWatchSystemVersionAtLeastMajorVersion:(id)arg1 minorVersion:(id)arg2 patchVersion:(id)arg3;	// IMP=0x001000000001f92f
- (_Bool)deviceHasCapabilities:(id)arg1;	// IMP=0x001000000001f90d
...
- (void)accountStoreDidChange:(id)arg1;	// IMP=0x001000000001f6d5
- (void)dealloc;	// IMP=0x001000000001f660
- (id)initWithAccountStore:(id)arg1;	// IMP=0x001000000001f575
