...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000fa74
- (void).cxx_destruct;	// IMP=0x0020000000011392
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001076c
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000102b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000102aa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000ffce
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000fa7c
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x001000000000f818
