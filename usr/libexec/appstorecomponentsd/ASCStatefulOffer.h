...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001c77f
- (void).cxx_destruct;	// IMP=0x002000000001d8c4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001d024
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001cca7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001cc9c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001ca90
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001c787
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x001000000001c5bf
