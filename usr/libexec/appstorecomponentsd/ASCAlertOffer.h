...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000015d3c
- (void).cxx_destruct;	// IMP=0x0020000000017004
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000016671
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000162b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000162a9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000016069
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000015d44
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0010000000015b65
