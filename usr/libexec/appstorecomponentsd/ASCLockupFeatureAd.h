...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000007d27
- (void).cxx_destruct;	// IMP=0x002000000000883e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000008247
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000080bb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000007f2a
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000007d2f
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x0010000000007bd6
