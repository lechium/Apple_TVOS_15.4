...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000013fb9
- (void).cxx_destruct;	// IMP=0x0020000000014805
...
- (id)description;	// IMP=0x001000000001468a
- (void)endEmitting;	// IMP=0x001000000001457a
- (void)beginEmitting;	// IMP=0x00100000000144b9
- (void)addSupplementaryTag:(unsigned long long)arg1;	// IMP=0x0010000000014443
@property(readonly, copy, nonatomic) NSDateInterval *dateRange;
@property(readonly, copy, nonatomic) NSSet *supplementaryTags;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001418d
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000013fc1
- (id)init;	// IMP=0x0010000000013f5a
