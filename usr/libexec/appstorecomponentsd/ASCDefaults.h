...
+ (id)daemonDefaults;	// IMP=0x0020000000014a97
- (void).cxx_destruct;	// IMP=0x00200000000155f1
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x0010000000015549
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000015443
- (unsigned long long)hash;	// IMP=0x00100000000153c8
...
- (id)objectForKey:(id)arg1;	// IMP=0x0010000000014bf6
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000014b76
- (id)initWithBundleID:(id)arg1;	// IMP=0x0010000000014b03
