...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001a6fb
- (void).cxx_destruct;	// IMP=0x002000000001b691
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001af12
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001abf8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001abed
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001aa15
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001a703
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x001000000001a556
