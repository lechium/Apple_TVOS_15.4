...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001e211
- (void).cxx_destruct;	// IMP=0x002000000001f0a5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001e9cd
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001e6db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001e6d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001e508
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001e219
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001e0a4
