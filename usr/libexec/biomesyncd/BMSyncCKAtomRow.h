...
- (void).cxx_destruct;	// IMP=0x0010000000017bd8
...
- (id)description;	// IMP=0x0010000000017a61
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017a56
- (unsigned long long)hash;	// IMP=0x0010000000017a17
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017986
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 valueData:(id)arg6;	// IMP=0x0010000000017787
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 bookmark:(id)arg6;	// IMP=0x0010000000017588
- (id)initWithFMResultSet:(id)arg1;	// IMP=0x0010000000017c2c
