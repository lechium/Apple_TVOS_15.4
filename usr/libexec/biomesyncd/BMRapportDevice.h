...
- (void).cxx_destruct;	// IMP=0x00200000000156ee
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000015659
- (id)description;	// IMP=0x0010000000015542
- (unsigned long long)hash;	// IMP=0x00100000000154fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000015451
- (void)handleInvalidationWithError:(id)arg1;	// IMP=0x001000000001515b
- (void)invalidateClientWithError:(id)arg1;	// IMP=0x00100000000150a7
...
- (id)initWithRPCompanionLinkDevice:(id)arg1;	// IMP=0x0010000000014e74
