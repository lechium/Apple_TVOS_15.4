...
- (void).cxx_destruct;	// IMP=0x0020000000003c98
@property(nonatomic) _Bool moreComing; // @synthesize moreComing=_moreComing;
- (void)didAddAtomWithData:(id)arg1;	// IMP=0x0010000000003c70
- (_Bool)canAddAtomWithData:(id)arg1;	// IMP=0x0010000000003c5a
- (id)initWithChunkerPolicy:(id)arg1;	// IMP=0x0010000000003be7
