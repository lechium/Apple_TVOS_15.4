...
- (void).cxx_destruct;	// IMP=0x00200000000a138a
...
- (void)main;	// IMP=0x00100000000a12ed
- (int)mainInternal;	// IMP=0x00100000000a12e2
- (_Bool)isCancelled;	// IMP=0x00100000000a1292
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000a11de
- (id)init;	// IMP=0x00100000000a11d0
