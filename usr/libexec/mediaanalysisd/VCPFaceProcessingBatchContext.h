...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000005121a
- (void).cxx_destruct;	// IMP=0x00200000000519e0
...
- (_Bool)downloadTimedout;	// IMP=0x0010000000051775
- (void)updateLastestDownloadTimestamp;	// IMP=0x0010000000051651
- (void)storeResourceURL:(id)arg1 isBestResource:(_Bool)arg2 requestDownload:(_Bool)arg3 downloadStatus:(int)arg4 forLocalIdentifier:(id)arg5;	// IMP=0x0010000000051432
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x00100000000512c5
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000005100c
