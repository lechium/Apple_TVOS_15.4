...
@interface VCPProgressStatistics : NSObject
{
    ...
    MISSING_TYPE *_numNewAssetsUnanalyzedWithResources;	// 376 = 0x178
...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000025258
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002524a
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002523c
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002522e
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000025223
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000025218
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002520d
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000025202
- (id)init;	// IMP=0x00100000000251a1
