...
- (void).cxx_destruct;	// IMP=0x002000000005d8e6
@property(retain, nonatomic) NSDictionary *persistentState; // @synthesize persistentState=_persistentState;
- (id)limitsDescription;	// IMP=0x001000000005d304
- (_Bool)updateWithNewPersistentState:(id)arg1;	// IMP=0x001000000005d2a0
...
- (id)initWithPersistentState:(id)arg1;	// IMP=0x001000000005c545
