...
- (void).cxx_destruct;	// IMP=0x0020000000007bbf
...
- (_Bool)renewCredentials;	// IMP=0x0010000000007513
- (id)publicURLForConfigurationWithService:(id)arg1;	// IMP=0x0010000000007430
@property(readonly, nonatomic) NSString *apsEnvironment;
- (id)initWithAccount:(id)arg1 sydAccount:(id)arg2;	// IMP=0x00100000000070b2
