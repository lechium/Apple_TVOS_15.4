...
- (void).cxx_destruct;	// IMP=0x002000000005350e
...
- (id)initWithType:(long long)arg1 reason:(int)arg2 apps:(id)arg3 soon:(_Bool)arg4 message:(id)arg5;	// IMP=0x00100000000533e9
