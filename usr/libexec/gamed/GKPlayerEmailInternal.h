...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000162454
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016244c
- (void).cxx_destruct;	// IMP=0x0020000000162782
...
- (unsigned long long)hash;	// IMP=0x001000000016264d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000162533
