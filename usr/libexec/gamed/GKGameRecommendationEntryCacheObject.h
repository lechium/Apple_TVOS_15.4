...
+ (id)entityName;	// IMP=0x0040000000066412
- (id)internalRepresentation;	// IMP=0x002000000006670d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006641f
