...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016afce
- (void).cxx_destruct;	// IMP=0x001000000016b6e8
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000016b4e2
- (id)serverRepresentation;	// IMP=0x001000000016b275
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016b189
- (unsigned long long)hash;	// IMP=0x001000000016b173
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0010000000173e17
