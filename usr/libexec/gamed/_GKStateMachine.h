...
- (void).cxx_destruct;	// IMP=0x002000000013338f
...
- (void)_performTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x0010000000133006
- (id)_validateTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00100000001327a5
- (id)missingTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x0010000000132773
- (_Bool)_setCurrentState:(id)arg1;	// IMP=0x00100000001324b5
@property(retain) NSString *currentState; // @synthesize currentState=_currentState;
- (_Bool)applyState:(id)arg1;	// IMP=0x0010000000132491
- (id)init;	// IMP=0x001000000013241f
