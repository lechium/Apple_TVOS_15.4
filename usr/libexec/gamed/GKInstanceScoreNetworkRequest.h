...
@interface GKInstanceScoreNetworkRequest : NSObject
{
    ...
    MISSING_TYPE *requestData;	// 56 = 0x38
    NSString *leaderboardID;	// 64 = 0x40
    long long value;	// 72 = 0x48
}

+ (id)bagKey;	// IMP=0x002000000023d4a9
- (void).cxx_destruct;	// IMP=0x002000000023ddfa
...
- (id)requestIdentifier;	// IMP=0x001000000023dc31
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x001000000023dc1e
- (id)taskInfo;	// IMP=0x001000000023da43
- (id)postBody;	// IMP=0x001000000023da31
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x001000000023d9a0
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x001000000023d6ec
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x001000000023d562
- (id)initWithTask:(id)arg1;	// IMP=0x001000000023d4b6
