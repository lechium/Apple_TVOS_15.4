...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000015ca31
- (void).cxx_destruct;	// IMP=0x002000000015cdff
...
- (unsigned long long)hash;	// IMP=0x001000000015cccf
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015cb2b
