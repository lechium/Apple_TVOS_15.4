...
+ (id)entityName;	// IMP=0x004000000005e759
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000005e766
- (id)internalRepresentation;	// IMP=0x001000000005e540
