...
+ (id)secureCodedPropertyKeys;	// IMP=0x002000000015c34a
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x001000000015c10b
+ (id)_gameProperties;	// IMP=0x00100000001703e6
+ (id)propertiesToFetch;	// IMP=0x001000000017003e
- (void).cxx_destruct;	// IMP=0x002000000015c6cc
...
- (void)updateWithGame:(id)arg1;	// IMP=0x001000000015c17d
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001704e3
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000016fd0a
