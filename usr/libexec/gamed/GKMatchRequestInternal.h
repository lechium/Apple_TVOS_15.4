...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016c864
- (void).cxx_destruct;	// IMP=0x002000000016cf1a
...
// Error: Property attributes should begin with the type ('T') attribute, property name: playerAttributes
...
- (_Bool)hasGuestPlayers;	// IMP=0x001000000016cbf2
- (unsigned long long)hash;	// IMP=0x001000000016c7f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016c091
- (id)init;	// IMP=0x001000000016c01b
