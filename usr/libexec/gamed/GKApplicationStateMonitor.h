...
- (void).cxx_destruct;	// IMP=0x0020000000096591
...
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x0010000000096317
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x0010000000096104
- (void)startObservingApplicationWorkspaceChanges;	// IMP=0x0010000000095f50
- (void)startObservingStateChangesForBundleID:(id)arg1;	// IMP=0x0010000000095c13
- (_Bool)observingStateChangesForBundleID:(id)arg1;	// IMP=0x0010000000095b9c
- (void)dealloc;	// IMP=0x001000000009543a
- (id)init;	// IMP=0x0010000000095380
