...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000000ab34b
- (void).cxx_destruct;	// IMP=0x00200000000ab79d
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x00100000000ab57e
- (_Bool)isNetworkError;	// IMP=0x00100000000ab53d
- (_Bool)isTimeout;	// IMP=0x00100000000ab4fc
- (_Bool)isCancelled;	// IMP=0x00100000000ab4bb
- (_Bool)isFinished;	// IMP=0x00100000000ab47a
- (int)_incrementSequence;	// IMP=0x00100000000ab469
