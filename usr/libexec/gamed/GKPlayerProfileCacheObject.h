...
+ (id)entityName;	// IMP=0x0020000000051174
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000004f1e5
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000004f140
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x001000000004f058
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000004ed89
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x001000000004eae7
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000004de84
+ (id)uniqueAttributeName;	// IMP=0x001000000004de77
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x0010000000052853
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x001000000005282d
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x001000000005224d
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0010000000052019
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0010000000051c18
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0010000000051a11
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x001000000005181c
+ (id)selfPlayerID;	// IMP=0x00100000000517c5
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x00100000000514f7
+ (id)_familiarityLookup;	// IMP=0x001000000005130b
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x0010000000051181
- (id)internalRepresentation;	// IMP=0x0010000000050fc4
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x0010000000050d4c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x001000000004fa5e
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x001000000004f5d7
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000004f5c2
- (void)deleteCachedImage:(id)arg1;	// IMP=0x001000000004e60a
- (void)deleteCachedAvatars;	// IMP=0x001000000004e345
- (void)clearImages;	// IMP=0x001000000004e013
...
- (void)invalidate;	// IMP=0x001000000004df07
