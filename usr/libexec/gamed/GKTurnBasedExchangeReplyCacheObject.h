...
+ (id)entityName;	// IMP=0x004000000006b03e
- (id)internalRepresentation;	// IMP=0x002000000006b39f
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006b04b
