...
+ (id)bagKey;	// IMP=0x002000000023de59
- (void).cxx_destruct;	// IMP=0x002000000023e5aa
...
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x001000000023e438
@property(readonly, copy) NSString *description;
- (id)requestIdentifier;	// IMP=0x001000000023e2c9
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x001000000023e2b6
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x001000000023e1d3
- (id)taskInfo;	// IMP=0x001000000023e0b3
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x001000000023dfb3
- (id)initWithTask:(id)arg1;	// IMP=0x001000000023df07
- (id)postBody;	// IMP=0x001000000023de66
