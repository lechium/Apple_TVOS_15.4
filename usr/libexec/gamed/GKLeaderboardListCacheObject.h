...
+ (id)entityName;	// IMP=0x004000000005ac70
- (_Bool)isValid;	// IMP=0x002000000005ad7d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000005ac7d
