...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x00200000000929f9
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x00100000000929c4
+ (id)shared;	// IMP=0x00100000000912fe
- (void).cxx_destruct;	// IMP=0x0010000000093e67
...
- (void)setMultiplayerShouldAlwaysReloadCollectionView:(_Bool)arg1;	// IMP=0x0010000000092fa5
...
- (void)setRecentNumberOfPlayers:(unsigned long long)arg1 forBundleID:(id)arg2;	// IMP=0x00100000000925ef
- (unsigned long long)recentNumberOfPlayersForBundleID:(id)arg1;	// IMP=0x0010000000092533
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x001000000009195d
- (void)setStringValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000091940
- (id)stringValueForKey:(id)arg1 defaultValue:(id)arg2;	// IMP=0x00100000000918cc
- (void)setTimeInterval:(double)arg1 forKey:(id)arg2;	// IMP=0x0010000000091832
- (double)timeIntervalForKey:(id)arg1 defaultValue:(double)arg2;	// IMP=0x00100000000917e0
- (void)setDictionaryValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000000917c3
- (id)dictionaryValueForKey:(id)arg1;	// IMP=0x0010000000091761
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(id)arg2;	// IMP=0x00100000000916c9
- (long long)unsignedIntegerValueForKey:(id)arg1 defaultValue:(long long)arg2;	// IMP=0x001000000009167e
- (void)setIntegerValue:(long long)arg1 forKey:(id)arg2;	// IMP=0x00100000000915e6
- (long long)integerValueForKey:(id)arg1 defaultValue:(long long)arg2;	// IMP=0x001000000009159b
- (void)setBooleanValue:(_Bool)arg1 forKey:(id)arg2;	// IMP=0x0010000000091522
- (_Bool)booleanValueForKey:(id)arg1;	// IMP=0x001000000009150e
- (_Bool)booleanValueForKey:(id)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00100000000914c3
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x001000000009145f
- (void)_didWriteKey:(id)arg1;	// IMP=0x001000000009143e
- (void)synchronize;	// IMP=0x0010000000091409
- (void)invalidate;	// IMP=0x00100000000913f2
- (_Bool)isInternalBuild;	// IMP=0x001000000009139b
- (id)init;	// IMP=0x00100000000912ec
- (id)initWithoutUIKitNotifications;	// IMP=0x001000000009125b
- (id)initWithUIKitNotifications;	// IMP=0x0010000000091249
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0010000000114cf4
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x0010000000114c6d
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x0010000000114bea
...
- (void)getMultiplayerAllowedPlayerTypeWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001149f0
