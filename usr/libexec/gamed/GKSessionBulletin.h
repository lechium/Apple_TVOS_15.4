...
+ (_Bool)displayNotification;	// IMP=0x004000000010c4bc
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000010c4b4
- (void).cxx_destruct;	// IMP=0x002000000010eb82
...
- (id)description;	// IMP=0x001000000010e90b
- (void)assembleBulletin;	// IMP=0x001000000010e30d
- (void)localizeMessage;	// IMP=0x001000000010e23f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000010df6b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000010dc73
- (id)initWithPushNotification:(id)arg1;	// IMP=0x001000000010d991
- (void)distributeData;	// IMP=0x001000000010d98b
- (void)loadDataWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000010d486
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000010c4c4
