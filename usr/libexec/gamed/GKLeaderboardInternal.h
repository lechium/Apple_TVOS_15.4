...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000164105
- (void).cxx_destruct;	// IMP=0x00200000001648d8
...
- (unsigned long long)hash;	// IMP=0x00100000001645a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001644d0
