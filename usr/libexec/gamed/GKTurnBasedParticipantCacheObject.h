...
+ (id)entityName;	// IMP=0x004000000006a27d
- (id)internalRepresentation;	// IMP=0x002000000006a6ad
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006a28a
