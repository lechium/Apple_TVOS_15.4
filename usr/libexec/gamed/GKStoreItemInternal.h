...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000015b834
- (void).cxx_destruct;	// IMP=0x001000000015c085
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000015bbba
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x001000000015baf1
- (_Bool)isValid;	// IMP=0x001000000015babe
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015ba11
- (unsigned long long)hash;	// IMP=0x001000000015b9f4
- (void)updateWithProperties:(id)arg1;	// IMP=0x0010000000171379
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000170de2
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000017092f
