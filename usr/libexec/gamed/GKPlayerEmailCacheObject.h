...
+ (id)entityName;	// IMP=0x0040000000052fad
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0020000000052ca2
- (id)internalRepresentation;	// IMP=0x0010000000052a46
