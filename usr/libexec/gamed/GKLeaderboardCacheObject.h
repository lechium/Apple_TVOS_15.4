...
+ (id)entityName;	// IMP=0x0020000000063f73
- (id)internalRepresentation;	// IMP=0x0020000000063acc
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000000631d6
