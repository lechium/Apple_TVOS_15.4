...
+ (id)entityName;	// IMP=0x0040000000057395
- (id)internalRepresentation;	// IMP=0x002000000005738d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000000570a6
