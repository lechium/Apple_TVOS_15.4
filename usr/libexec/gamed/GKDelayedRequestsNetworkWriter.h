...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0020000000154a1e
- (void).cxx_destruct;	// IMP=0x0020000000154ec7
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000154b2c
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0010000000154a8e
