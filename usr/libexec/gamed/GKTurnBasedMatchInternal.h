...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016983c
- (void).cxx_destruct;	// IMP=0x002000000016ae8d
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000016ab41
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x001000000016a1d0
- (long long)previousParticipantIndex;	// IMP=0x0010000000169f59
- (long long)localPlayerParticipantIndex;	// IMP=0x0010000000169ec7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000169d2c
- (unsigned long long)hash;	// IMP=0x0010000000169ce8
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001732a6
