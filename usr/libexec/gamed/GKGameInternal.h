...
+ (id)secureCodedPropertyKeys;	// IMP=0x002000000015ade5
+ (id)propertiesToFetch;	// IMP=0x001000000016f6b7
- (void).cxx_destruct;	// IMP=0x002000000015b7ac
...
// Error: Property attributes should begin with the type ('T') attribute, property name: supportsChallenges
...
- (id)description;	// IMP=0x001000000015b128
- (id)serverRepresentation;	// IMP=0x001000000015b116
- (unsigned long long)hash;	// IMP=0x001000000015ada1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015acf4
- (id)defaultCategory;	// IMP=0x001000000015b822
- (unsigned short)numberOfCategories;	// IMP=0x001000000015b810
- (void)updateWithProperties:(id)arg1;	// IMP=0x001000000016f707
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000016eee3
