...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x00400000000ac7a4
- (void).cxx_destruct;	// IMP=0x00200000000acde0
...
- (id)bundleURL;	// IMP=0x00100000000aca58
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000000ac74a
- (id)initWithProxy:(id)arg1;	// IMP=0x00100000000ac6e2
