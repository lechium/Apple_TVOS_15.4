...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x0040000000128077
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000127cc8
- (void).cxx_destruct;	// IMP=0x002000000012856c
...
- (void)setMinPlayers:(long long)arg1;	// IMP=0x001000000012826b
- (long long)minPlayers;	// IMP=0x001000000012825a
