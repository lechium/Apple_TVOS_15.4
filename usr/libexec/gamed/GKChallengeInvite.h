...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000b542f
- (void).cxx_destruct;	// IMP=0x00200000000b6c7b
@property(retain, nonatomic) NSDictionary *pushDescriptor; // @synthesize pushDescriptor=_pushDescriptor;
- (id);	// IMP=0x00100000000b6c60
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b5fe9
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b5516
- (id)initWithChallenge:(id)arg1;	// IMP=0x00100000000b54ab
- (id)challengeInternalObject;	// IMP=0x00100000000b54a3
- (id)description;	// IMP=0x00100000000b5437
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000b534a
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000b5140
