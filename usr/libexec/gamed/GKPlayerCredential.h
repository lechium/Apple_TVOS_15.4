...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000015d518
- (void).cxx_destruct;	// IMP=0x002000000015d81c
...
- (id)description;	// IMP=0x001000000015d3cc
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x001000000015d296
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015d029
