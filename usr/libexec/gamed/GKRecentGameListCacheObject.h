...
+ (Class)entryClass;	// IMP=0x0040000000064ace
+ (id)entityName;	// IMP=0x0010000000064ac1
- (id)internalRepresentation;	// IMP=0x0020000000064d60
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000064adf
