...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000000b40c4
- (void).cxx_destruct;	// IMP=0x00200000000b4758
...
- (id)description;	// IMP=0x00100000000b4579
- (id)initWithGameSummary:(id)arg1;	// IMP=0x00100000000b422e
