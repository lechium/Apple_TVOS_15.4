...
+ (id)entityName;	// IMP=0x0040000000062011
- (id)internalRepresentation;	// IMP=0x0020000000061d6d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000000619e7
