...
+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x00200000001604d7
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x00100000001603d1
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x0010000000160230
+ (id)secureCodedPropertyKeys;	// IMP=0x001000000015f758
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000015f750
+ (id)propertiesToFetch;	// IMP=0x0010000000171cba
+ (int)familiarity;	// IMP=0x0010000000171cb2
+ (unsigned char)piecesToLoad;	// IMP=0x0010000000171c7e
- (void).cxx_destruct;	// IMP=0x0010000000160ddc
...
- (void)stripPIIs;	// IMP=0x001000000016091e
- (id)debugDescription;	// IMP=0x001000000016076b
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x0010000000160733
- (_Bool)allowNearbyMultiplayer;	// IMP=0x001000000016072b
...
- (int)globalFriendListSharingStatus;	// IMP=0x00100000001606f0
...
- (int)defaultFamiliarity;	// IMP=0x001000000016053c
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x001000000016030a
- (id)minimalInternal;	// IMP=0x001000000015feea
- (unsigned long long)hash;	// IMP=0x001000000015fea6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015fddb
- (id)serverRepresentation;	// IMP=0x001000000015fcd0
- (id)conciseDescription;	// IMP=0x001000000015fc13
- (id)cacheKey;	// IMP=0x001000000015fc01
- (void)updateWithProperties:(id)arg1;	// IMP=0x0010000000171d0a
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00100000001717ad
