...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000b4f9b
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000000b4e50
- (void).cxx_destruct;	// IMP=0x00200000000b50cb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b4d86
