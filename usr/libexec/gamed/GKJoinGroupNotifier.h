...
- (void).cxx_destruct;	// IMP=0x00200000000b9a54
...
- (void)setResult:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x00100000000b989b
@property(retain) NSError *error; // @synthesize error=_error;
- (oneway void)release;	// IMP=0x00100000000b9770
- (id)retain;	// IMP=0x00100000000b96de
- (void)dealloc;	// IMP=0x00100000000b9682
- (id)init;	// IMP=0x00100000000b9626
