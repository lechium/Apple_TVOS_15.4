...
+ (id)entityName;	// IMP=0x00200000000566e7
- (id)internalRepresentation;	// IMP=0x00200000000563a2
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000055fba
