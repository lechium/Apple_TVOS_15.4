...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000009bdb6
- (void).cxx_destruct;	// IMP=0x002000000009c262
...
- (id)description;	// IMP=0x001000000009c047
@property(readonly) NSDictionary *actionDictionary;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009bdbe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000009ba97
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000009b766
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000009b6a2
- (id)init;	// IMP=0x001000000009b668
