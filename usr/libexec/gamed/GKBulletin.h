...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x0010000000113eab
+ (_Bool)shouldProcessNotification;	// IMP=0x0010000000113b82
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000113795
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000112bcf
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000112446
+ (id)syncQueue;	// IMP=0x00100000001123c5
+ (_Bool)isKettleEnabled;	// IMP=0x00100000001123ad
+ (id)cacheTransactionGroup;	// IMP=0x00100000000f8d22
- (void).cxx_destruct;	// IMP=0x002000000011469a
...
- (void)setTitle:(id)arg1;	// IMP=0x00100000001144c8
- (id)title;	// IMP=0x00100000001144b4
...
- (id)description;	// IMP=0x0010000000114239
- (void)handleAction:(id)arg1;	// IMP=0x0010000000114052
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x0010000000113d21
- (id)initWithPushNotification:(id)arg1;	// IMP=0x001000000011394b
- (id)dataFrom64String:(id)arg1;	// IMP=0x001000000011379d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000113268
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000112d4e
