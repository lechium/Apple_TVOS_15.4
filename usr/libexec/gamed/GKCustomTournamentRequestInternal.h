...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x0040000000126e0a
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000126c14
- (void).cxx_destruct;	// IMP=0x0020000000127188
