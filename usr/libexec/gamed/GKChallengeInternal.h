...
+ (id)internalRepresentation;	// IMP=0x0040000000167e46
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000001679ea
- (void).cxx_destruct;	// IMP=0x0020000000168568
...
- (id)descriptionSubstitutionMap;	// IMP=0x00100000001683ec
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x0010000000167fce
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0010000000167e60
- (id)serverRepresentation;	// IMP=0x0010000000167e4e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000167d99
- (unsigned long long)hash;	// IMP=0x0010000000167d55
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000167c23
