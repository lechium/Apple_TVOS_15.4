...
+ (id)entityName;	// IMP=0x004000000005a831
- (id)internalRepresentation;	// IMP=0x002000000005aaa4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000005a83e
