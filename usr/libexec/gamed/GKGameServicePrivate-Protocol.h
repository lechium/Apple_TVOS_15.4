...
@class GKPlayerInternal, MISSING_TYPE, NSArray, NSDictionary, NSNumber, NSString;
...
- (MISSING_TYPE *)getStoreItemsForAdamIDs:handler: /* Error: Ran out of types for this method. */;
@end
