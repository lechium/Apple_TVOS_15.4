...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00200000001bb205
- (void).cxx_destruct;	// IMP=0x00200000001bb80d
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001bb313
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00100000001bb275
