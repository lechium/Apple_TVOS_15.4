...
+ (id)entityName;	// IMP=0x0020000000055e10
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000053791
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x00100000000535d2
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x0010000000053413
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x00100000000531b2
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x00100000000530b3
+ (id)fetchSortDescriptors;	// IMP=0x0010000000052fd4
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0010000000052fc7
+ (id)uniqueAttributeName;	// IMP=0x0010000000052fba
- (id)gameDescriptor;	// IMP=0x0020000000055a00
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x0010000000055960
- (id)internalRepresentation;	// IMP=0x00100000000557c3
- (_Bool)storePiecesExpired;	// IMP=0x0010000000055776
- (_Bool)storePiecesValid;	// IMP=0x0010000000055743
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000054f5d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000000545dc
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0010000000053d42
- (_Bool)isValid;	// IMP=0x0010000000053cb0
