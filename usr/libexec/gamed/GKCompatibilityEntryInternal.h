...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016dfb5
- (void).cxx_destruct;	// IMP=0x002000000016e580
...
- (unsigned long long)hash;	// IMP=0x001000000016e41c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016e1a2
