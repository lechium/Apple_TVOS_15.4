...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001632d1
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001632c9
- (void).cxx_destruct;	// IMP=0x0020000000163512
...
- (unsigned long long)hash;	// IMP=0x001000000016349b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001633cb
