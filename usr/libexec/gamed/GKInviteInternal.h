...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016d7b7
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x001000000016d728
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x001000000016d56f
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x001000000016cfa0
- (void).cxx_destruct;	// IMP=0x002000000016dec9
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000016dc14
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016db39
- (unsigned long long)hash;	// IMP=0x001000000016daf5
- (id)init;	// IMP=0x001000000016d757
