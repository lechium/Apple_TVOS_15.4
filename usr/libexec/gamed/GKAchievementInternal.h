...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000016377c
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000163543
- (void).cxx_destruct;	// IMP=0x0010000000163ed0
...
- (id)descriptionSubstitutionMap;	// IMP=0x0010000000163d77
...
- (unsigned long long)hash;	// IMP=0x0010000000163c71
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000163b35
- (id)serverRepresentation;	// IMP=0x001000000016395b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000016385c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000163784
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x0010000000163f67
