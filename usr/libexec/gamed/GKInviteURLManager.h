...
+ (id)sharedManager;	// IMP=0x0040000000136475
- (void).cxx_destruct;	// IMP=0x0020000000136998
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00100000001366d9
- (id)init;	// IMP=0x0010000000136625
