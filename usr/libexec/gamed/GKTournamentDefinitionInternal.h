...
@class GKRecurrenceRule, MISSING_TYPE, NSString;
...
@interface GKTournamentDefinitionInternal
{
    ...
    MISSING_TYPE *_customTournamentName;	// 168 = 0xa8
...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001263a8
- (void).cxx_destruct;	// IMP=0x0020000000126b8e
