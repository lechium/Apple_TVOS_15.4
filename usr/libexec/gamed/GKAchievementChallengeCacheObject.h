...
+ (id)entityName;	// IMP=0x004000000006f8e5
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000006fef2
- (id)internalRepresentation;	// IMP=0x001000000006fb04
- (Class)classForInternalRepresentation;	// IMP=0x001000000006faf3
- (_Bool)hasDetails;	// IMP=0x001000000006f8f2
