...
+ (void)migratePreSundanceAccountInformation;	// IMP=0x00200000000a724c
+ (void)migratePreBlacktailAccountInformation;	// IMP=0x00100000000a6c13
+ (id)authMachineForEnvironment:(long long)arg1;	// IMP=0x00100000000a6a76
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a6a6e
- (void).cxx_destruct;	// IMP=0x00200000000a7a41
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000a6b4e
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000a6a7e
