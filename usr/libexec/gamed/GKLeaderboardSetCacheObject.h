...
+ (id)entityName;	// IMP=0x002000000005a61a
- (id)internalRepresentation;	// IMP=0x002000000005a32e
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000059d07
