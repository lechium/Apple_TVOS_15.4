...
- (void).cxx_destruct;	// IMP=0x0020000000005417
...
- (void)stopProducingData;	// IMP=0x0010000000005333
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000005059
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000004f6b
