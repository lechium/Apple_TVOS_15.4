...
- (void).cxx_destruct;	// IMP=0x00200000000052aa
...
- (void)main;	// IMP=0x0010000000005137
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000005095
