...
- (void).cxx_destruct;	// IMP=0x0020000000044b0d
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x0010000000044969
- (void)main;	// IMP=0x0010000000044100
