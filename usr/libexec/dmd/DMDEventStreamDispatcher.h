...
- (void).cxx_destruct;	// IMP=0x0020000000048063
...
- (void)_dispatchToListenerForKey:(id)arg1 inMap:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000047e3b
- (void)_registerListener:(id)arg1 forKeys:(id)arg2 inMap:(id)arg3;	// IMP=0x0010000000047bd4
- (void)_registerEventStreamHandlers;	// IMP=0x0010000000047431
- (id)initWithListeners:(id)arg1;	// IMP=0x00100000000470d0
