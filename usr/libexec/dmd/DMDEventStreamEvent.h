...
- (void).cxx_destruct;	// IMP=0x002000000004834e
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x0010000000048203
- (id)description;	// IMP=0x0010000000048166
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x0010000000048096
