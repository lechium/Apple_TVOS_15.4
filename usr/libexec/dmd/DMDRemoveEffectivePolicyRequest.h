...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000063903
- (void).cxx_destruct;	// IMP=0x0020000000063b6e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000063a56
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006390b
