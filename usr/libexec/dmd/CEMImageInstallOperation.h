...
- (void).cxx_destruct;	// IMP=0x0020000000005b77
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005ae3
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x00100000000057d8
...
- (void)main;	// IMP=0x0010000000005613
- (_Bool)isAsynchronous;	// IMP=0x001000000000560b
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0010000000005569
