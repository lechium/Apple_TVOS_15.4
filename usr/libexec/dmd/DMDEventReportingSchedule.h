...
- (void).cxx_destruct;	// IMP=0x0020000000047087
@property(retain, nonatomic) NSTimer *timer; // @synthesize timer=_timer;
- (id);	// IMP=0x0010000000047062
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000046e52
- (unsigned long long)hash;	// IMP=0x0010000000046d16
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000046ac5
- (id)description;	// IMP=0x0010000000046a12
- (void)dealloc;	// IMP=0x00100000000469d0
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x00100000000466ec
