...
@class CATTaskServer, DMDEmergencyModeListenerDelegate, DMDEventStreamDispatcher, DMDPolicyServerListenerDelegate, DMDTaskServerDelegate, DMDTaskServerListenerDelegate, MISSING_TYPE, NSXPCListener;
...
+ (id)sharedServer;	// IMP=0x0020000000065e5d
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x00200000000660ee
...
- (void)invalidate;	// IMP=0x0010000000065fc5
- (void)run;	// IMP=0x0010000000065eb2
- (id)init;	// IMP=0x0010000000065b6b
