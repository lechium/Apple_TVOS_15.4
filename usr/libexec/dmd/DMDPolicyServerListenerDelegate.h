...
- (void).cxx_destruct;	// IMP=0x0020000000060b42
@property(readonly, nonatomic) DMDPolicyPersistence *policyPersistence; // @synthesize policyPersistence=_policyPersistence;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000609d8
- (id)initWithPolicyPersistence:(id)arg1;	// IMP=0x001000000006096d
