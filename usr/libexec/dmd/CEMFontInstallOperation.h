...
- (void).cxx_destruct;	// IMP=0x0020000000005064
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000004fd0
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000004cc5
...
- (void)main;	// IMP=0x0010000000004b00
- (_Bool)isAsynchronous;	// IMP=0x0010000000004af8
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0010000000004a56
