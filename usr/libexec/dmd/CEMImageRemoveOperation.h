...
- (void).cxx_destruct;	// IMP=0x0020000000005dbd
...
- (void)main;	// IMP=0x0010000000005c4a
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000005ba8
