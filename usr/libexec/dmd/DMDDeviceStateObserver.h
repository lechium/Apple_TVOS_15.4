...
- (void)networkDidChange;	// IMP=0x001000000003917a
- (void)keybagLockStateDidChange;	// IMP=0x0010000000039142
- (void)stopObservingChanges;	// IMP=0x001000000003910a
- (void)startObservingChanges;	// IMP=0x0010000000038f73
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0010000000038e93
