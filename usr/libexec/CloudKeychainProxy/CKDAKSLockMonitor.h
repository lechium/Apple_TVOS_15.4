...
+ (id)monitor;	// IMP=0x00200000000015ca
- (void).cxx_destruct;	// IMP=0x00200000000014f3
...
- (void)_onqueueRecheck;	// IMP=0x0010000000001372
- (void)recheck;	// IMP=0x0010000000001327
- (void)connectTo:(id)arg1;	// IMP=0x00100000000012fc
- (void)notifyListener;	// IMP=0x0010000000001295
- (void)handleNotification:(const char *)arg1;	// IMP=0x0010000000001249
- (id)init;	// IMP=0x00100000000010dc
