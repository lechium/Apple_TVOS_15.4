...
- (_Bool)_isFamilyCircleFresh:(id)arg1;	// IMP=0x001000000000bbf5
- (_Bool)isFamilyCircleFresh;	// IMP=0x001000000000bb9b
- (id)familyCircleValidatingAgeWithDate:(id)arg1;	// IMP=0x001000000000bb57
- (id)familyCircleIfFresh;	// IMP=0x001000000000baf1
- (id)initWithFamilyCircle:(id)arg1 cacheDate:(id)arg2 maxAge:(double)arg3;	// IMP=0x001000000000ba49
