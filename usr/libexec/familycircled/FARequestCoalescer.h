...
+ (id)sharedInstance;	// IMP=0x004000000000b35f
- (void).cxx_destruct;	// IMP=0x002000000000ba21
...
- (id)performBlockForKey:(id)arg1 force:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000000b44d
- (id)init;	// IMP=0x001000000000b3b4
