...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000027e78c
- (unsigned long long)hash;	// IMP=0x001000000027e220
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000027e0a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000027df95
- (void)copyTo:(id)arg1;	// IMP=0x001000000027dec3
- (void)writeTo:(id)arg1;	// IMP=0x001000000027dd95
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000027dd88
- (id)dictionaryRepresentation;	// IMP=0x001000000027d1c6
- (id)description;	// IMP=0x001000000027d14f
@property(nonatomic) _Bool hasMetsFM;
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
- (int)StringAsTruthMetsSource:(id)arg1;	// IMP=0x001000000027cfcc
- (id)truthMetsSourceAsString:(int)arg1;	// IMP=0x001000000027cf52
...
- (int)StringAsUserMetsSource:(id)arg1;	// IMP=0x001000000027ce44
- (id)userMetsSourceAsString:(int)arg1;	// IMP=0x001000000027cdca
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000027c898
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000027c52c
