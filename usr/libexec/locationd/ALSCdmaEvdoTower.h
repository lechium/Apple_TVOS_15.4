...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000062553f
- (unsigned long long)hash;	// IMP=0x001000000062548a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000625383
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000062528a
- (void)copyTo:(id)arg1;	// IMP=0x00100000006251dc
- (void)writeTo:(id)arg1;	// IMP=0x0010000000625119
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000062510c
- (id)dictionaryRepresentation;	// IMP=0x0010000000624be5
- (id)description;	// IMP=0x0010000000624b6e
...
- (void)dealloc;	// IMP=0x0010000000624a14
