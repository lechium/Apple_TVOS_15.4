...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b3312
- (unsigned long long)hash;	// IMP=0x00100000000b3169
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b305d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b2f84
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b2ee9
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b2e09
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b2dfc
- (id)dictionaryRepresentation;	// IMP=0x00100000000b26e9
- (id)description;	// IMP=0x00100000000b2672
- (int)StringAsSource:(id)arg1;	// IMP=0x00100000000b262b
- (id)sourceAsString:(int)arg1;	// IMP=0x00100000000b25ec
@property(nonatomic) _Bool hasSource;
@property(nonatomic) int source; // @synthesize source=_source;
- (int)StringAsRawGradeType:(id)arg1;	// IMP=0x00100000000b24fc
- (id)rawGradeTypeAsString:(int)arg1;	// IMP=0x00100000000b248d
...
- (int)StringAsGradeType:(id)arg1;	// IMP=0x00100000000b2350
- (id)gradeTypeAsString:(int)arg1;	// IMP=0x00100000000b22e1
