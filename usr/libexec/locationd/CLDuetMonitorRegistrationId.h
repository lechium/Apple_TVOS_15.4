...
+ (id)withEvent:(long long)arg1 andPredicate:(id)arg2;	// IMP=0x00200000003f21f5
...
- (void)dealloc;	// IMP=0x00100000003f22b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000003f215b
- (unsigned long long)hash;	// IMP=0x00100000003f20f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000003f2038
