...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000cd993
- (unsigned long long)hash;	// IMP=0x00100000000cd150
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ccf81
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000cce41
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ccd3f
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ccbb9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ccbac
- (id)dictionaryRepresentation;	// IMP=0x00100000000cc1f5
- (id)description;	// IMP=0x00100000000cc17e
