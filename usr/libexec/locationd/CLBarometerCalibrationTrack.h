...
- (void)setFNotification:(unsigned long long)arg1;	// IMP=0x00100000006471bb
- (unsigned long long)fNotification;	// IMP=0x00100000006471b1
...
- (id)description;	// IMP=0x0010000000647131
- (id)initWithContextType:(unsigned long long)arg1 forNotification:(unsigned long long)arg2 startTime:(double)arg3;	// IMP=0x00100000006470cc
