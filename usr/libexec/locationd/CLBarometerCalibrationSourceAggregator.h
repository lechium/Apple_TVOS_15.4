...
+ (_Bool)isLocationUsefulForCalibration:(struct NotificationData)arg1;	// IMP=0x0020000000736de9
- (id).cxx_construct;	// IMP=0x0020000000736f2f
- (void).cxx_destruct;	// IMP=0x0010000000736f1d
...
- (array_c6ef73e3)copyDataBuffersForTrack:(unsigned long long)arg1;	// IMP=0x0010000000736d02
- (void)didUpdateSource:(unsigned long long)arg1 withData:(shared_ptr_16a5184d)arg2;	// IMP=0x0010000000736011
- (void)disableSources:(id)arg1 forContext:(id)arg2;	// IMP=0x0010000000735e1b
- (void)enableSources:(id)arg1 forContext:(id)arg2;	// IMP=0x0010000000735c25
- (void)dealloc;	// IMP=0x0010000000735b6d
- (id)initWithUniverse:(id)arg1 buffers:(void *)arg2;	// IMP=0x0010000000735990
