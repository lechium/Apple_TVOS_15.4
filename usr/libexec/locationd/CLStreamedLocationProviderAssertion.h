...
- (void)releaseAssertion;	// IMP=0x00100000000c6305
- (void)takeAssertion;	// IMP=0x00100000000c619b
- (void)dealloc;	// IMP=0x00100000000c615d
- (void)invalidate;	// IMP=0x00100000000c612d
- (id)initInUniverse:(id)arg1;	// IMP=0x00100000000c60a1
