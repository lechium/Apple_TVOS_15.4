...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d1f6d
- (unsigned long long)hash;	// IMP=0x00100000000d1aa6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d19da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d1927
- (void)copyTo:(id)arg1;	// IMP=0x00100000000d18b2
- (void)writeTo:(id)arg1;	// IMP=0x00100000000d17f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000d17e8
- (id)dictionaryRepresentation;	// IMP=0x00100000000d121f
- (id)description;	// IMP=0x00100000000d11a8
- (int)StringAsFEpochType:(id)arg1;	// IMP=0x00100000000d1141
- (id)fEpochTypeAsString:(int)arg1;	// IMP=0x00100000000d10f4
