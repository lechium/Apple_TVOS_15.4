...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000539ccf
- (unsigned long long)hash;	// IMP=0x001000000053936d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000053906a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000538e88
- (void)copyTo:(id)arg1;	// IMP=0x0010000000538ce4
- (void)writeTo:(id)arg1;	// IMP=0x0010000000538ad9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000538acc
- (id)dictionaryRepresentation;	// IMP=0x0010000000537f32
- (id)description;	// IMP=0x0010000000537ebb
