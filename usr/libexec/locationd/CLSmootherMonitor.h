...
+ (id)getSilo;	// IMP=0x002000000096ef7e
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x001000000096ef65
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x001000000096ef08
...
- (void)smoothLocations:(id)arg1 workoutActivity:(int)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x001000000096fb95
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000096f2c7
- (void)dealloc;	// IMP=0x001000000096f298
- (void)endService;	// IMP=0x001000000096f182
- (void)beginService;	// IMP=0x001000000096f017
- (id)init;	// IMP=0x001000000096efda
