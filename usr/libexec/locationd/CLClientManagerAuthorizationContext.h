...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000937cd9
- (_Bool)inUseLevelIsAtLeast:(int)arg1;	// IMP=0x0010000000937ccd
- (_Bool)isAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0010000000937cae
- (_Bool)isAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x0010000000937c67
- (_Bool)isNonProvisionallyAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0010000000937c48
- (_Bool)isNonProvisionallyAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x0010000000937c22
- (id)description;	// IMP=0x0010000000937be1
- (id)authorizationContextByANDingServiceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg1;	// IMP=0x0010000000937b58
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg4 authorizedForWidgetUpdates:(_Bool)arg5;	// IMP=0x0010000000937af1
