...
- (void)_clearBuffers;	// IMP=0x001000000070c966
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x001000000070c71e
- (void)_closeCurrentTrack;	// IMP=0x001000000070bda4
- (void)_closeTrackCheckPedometer;	// IMP=0x001000000070b560
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x001000000070ae3c
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x001000000070aaa7
- (void)_closeTrackCheckGpsLocation;	// IMP=0x001000000070a8cc
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x0010000000709d81
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x0010000000709d1d
- (id)_filterGpsLocationBuffer;	// IMP=0x00100000007097b9
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x0010000000709673
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x0010000000709401
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x0010000000709328
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x0010000000708caf
- (void)stop;	// IMP=0x0010000000708be3
- (void)dealloc;	// IMP=0x0010000000708b68
- (id)init;	// IMP=0x00100000007089d7
