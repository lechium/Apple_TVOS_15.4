...
+ (_Bool)isSupported;	// IMP=0x0020000000920662
+ (id)getSilo;	// IMP=0x0010000000920606
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000009205ed
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000920590
- (id).cxx_construct;	// IMP=0x0020000000922832
- (void).cxx_destruct;	// IMP=0x00100000009227ed
...
- (void)stopLocation;	// IMP=0x00100000009225bb
- (void)activateRapportLinkIfNecessary;	// IMP=0x0010000000921e60
- (void)registerRequestHandlers;	// IMP=0x00100000009215bf
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x0010000000921077
- (void)toggleLocationUpdates:(_Bool)arg1 inFitnessSession:(_Bool)arg2 inAirborneSession:(_Bool)arg3 emergencyEnablementAssertionActive:(_Bool)arg4;	// IMP=0x0010000000920ebc
- (void)endService;	// IMP=0x0010000000920a6e
- (void)beginService;	// IMP=0x00100000009206f3
- (id)init;	// IMP=0x00100000009206b6
