...
@class CLCppContainer, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSSet, NSString, NSUUID;
...
- (MISSING_TYPE *)reduceAccuracy:withReply: /* Error: Ran out of types for this method. */;
...
- (void)setClientAuthorization:(struct Name (^)(void))arg1 zoneIdentifier:(NSString *)arg2 status:(int)arg3 correctiveCompensation:(int)arg4 entity:(NSString *)arg5;
