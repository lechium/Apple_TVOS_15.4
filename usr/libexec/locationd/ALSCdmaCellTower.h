...
- (int)mcc;	// IMP=0x001000000061da46
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000061d915
- (unsigned long long)hash;	// IMP=0x001000000061d7de
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000061d62c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000061d4d4
- (void)copyTo:(id)arg1;	// IMP=0x001000000061d3ba
- (void)writeTo:(id)arg1;	// IMP=0x001000000061d279
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000061d26c
- (id)dictionaryRepresentation;	// IMP=0x001000000061c9be
- (id)description;	// IMP=0x001000000061c947
...
- (void)setMcc:(int)arg1;	// IMP=0x001000000061c6e4
- (void)dealloc;	// IMP=0x001000000061c6a4
