...
+ (_Bool)isSupported;	// IMP=0x002000000054f844
+ (id)getSilo;	// IMP=0x001000000054f7e8
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x001000000054f7cf
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x001000000054f772
- (id).cxx_construct;	// IMP=0x002000000054f93e
- (void).cxx_destruct;	// IMP=0x001000000054f8c2
- (id)init;	// IMP=0x001000000054f871
