...
- (void)disableSource;	// IMP=0x00200000001c71ea
- (void)enableSource;	// IMP=0x00100000001c71e4
- (void)dealloc;	// IMP=0x00100000001c71ae
- (id)initWithUniverse:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000001c70fb
