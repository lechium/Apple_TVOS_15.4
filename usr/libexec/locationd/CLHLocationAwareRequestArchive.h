...
- (void)eraseAllData;	// IMP=0x00100000008398d0
- (id)jsonObject;	// IMP=0x001000000083980b
- (void)pruneSecondaryDataOlderThan:(double)arg1;	// IMP=0x001000000083960d
- (void)writeSecondaryObject:(id)arg1 collectedAt:(id)arg2 toField:(unsigned int)arg3;	// IMP=0x00100000008395a6
@property(readonly) unsigned long long count;
- (void)dealloc;	// IMP=0x00100000008394f4
- (id)initWithClassifier:(id)arg1 rootDirectory:(id)arg2 basename:(id)arg3 requestCode:(int)arg4 itemCountThresholdForAutoCleanUp:(int)arg5;	// IMP=0x0010000000839360
