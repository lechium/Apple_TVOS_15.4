...
@interface ALCLStepCountEntry : PBCodable
{
    ...
    MISSING_TYPE *_recordId;	// 44 = 0x2c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000cebdf
- (unsigned long long)hash;	// IMP=0x00100000000ce83f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ce71c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ce63b
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ce598
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ce4a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ce494
- (id)dictionaryRepresentation;	// IMP=0x00100000000cdd68
- (id)description;	// IMP=0x00100000000cdcf1
