...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000cb6f5
- (unsigned long long)hash;	// IMP=0x00000000000cb5f6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000cb465
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000cb34f
- (void)copyTo:(id)arg1;	// IMP=0x00100000000cb277
- (void)writeTo:(id)arg1;	// IMP=0x00100000000cb141
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000cb134
- (id)dictionaryRepresentation;	// IMP=0x00100000000ca447
- (id)description;	// IMP=0x00100000000ca3d0
@property(nonatomic) _Bool hasStartTime;
- (int)StringAsExitState:(id)arg1;	// IMP=0x00100000000ca323
- (id)exitStateAsString:(int)arg1;	// IMP=0x00100000000ca2d6
...
- (int)StringAsTurn:(id)arg1;	// IMP=0x00100000000ca171
- (id)turnAsString:(int)arg1;	// IMP=0x00100000000ca124
@property(nonatomic) _Bool hasTurn;
@property(nonatomic) int turn; // @synthesize turn=_turn;
- (int)StringAsMountedConfidence:(id)arg1;	// IMP=0x00100000000ca053
- (id)mountedConfidenceAsString:(int)arg1;	// IMP=0x00100000000ca006
...
- (int)StringAsMounted:(id)arg1;	// IMP=0x00100000000c9f55
- (id)mountedAsString:(int)arg1;	// IMP=0x00100000000c9f16
@property(nonatomic) _Bool hasMounted;
@property(nonatomic) int mounted; // @synthesize mounted=_mounted;
- (int)StringAsConfidence:(id)arg1;	// IMP=0x00100000000c9e45
- (id)confidenceAsString:(int)arg1;	// IMP=0x00100000000c9df8
- (int)StringAsType:(id)arg1;	// IMP=0x00100000000c99fc
- (id)typeAsString:(int)arg1;	// IMP=0x00100000000c96cc
