...
struct CLGnssDisablementStatus {
    _Bool _field1;
};
...
struct CLKappaRecordingSortListener {
    CDUnknownFunctionPointerType *_field1;
};
...
struct CMStrideCalRecorderDb {
    ...
    struct unique_ptr<CLSqliteDatabase, std::default_delete<CLSqliteDatabase>> fDb;
    char *fName;
    struct BasicMutex fMutex;
    _Bool fFatalError;
    struct deque<CLStrideCalEntry, std::allocator<CLStrideCalEntry>> fBuffer;
    ...
    struct NoDataProtectionPolicy fProtectionPolicy;
...
struct KappaSensorDataDirectionOfTravel {
    unsigned long long _field1;
    float _field2[3];
    float _field3;
    float _field4;
...
struct WorkoutEvent {
    ...
    struct WorkoutSettings _field9;
};
...
struct deque<CLStrideCalEntry, std::allocator<CLStrideCalEntry>> {
    struct __split_buffer<CLStrideCalEntry *, std::allocator<CLStrideCalEntry *>> {
        CDStruct_183601bc **__first_;
        CDStruct_183601bc **__begin_;
        CDStruct_183601bc **__end_;
        struct __compressed_pair<CLStrideCalEntry **, std::allocator<CLStrideCalEntry *>> {
            CDStruct_183601bc **__value_;
        } __end_cap_;
    } __map_;
    unsigned long long __start_;
    struct __compressed_pair<unsigned long, std::allocator<CLStrideCalEntry>> {
        unsigned long long __value_;
    } __size_;
};
...
struct unique_ptr<CLSqliteDatabase, std::default_delete<CLSqliteDatabase>> {
    struct __compressed_pair<CLSqliteDatabase *, std::default_delete<CLSqliteDatabase>> {
...
struct vector<VO2MaxSessionAttributes, std::allocator<VO2MaxSessionAttributes>> {
    struct VO2MaxSessionAttributes *_field1;
    struct VO2MaxSessionAttributes *_field2;
    struct __compressed_pair<VO2MaxSessionAttributes *, std::allocator<VO2MaxSessionAttributes>> {
        struct VO2MaxSessionAttributes *_field1;
    } _field3;
};
...
typedef struct {
    ...
    struct CLGnssDisablementStatus _field21;
} NotificationData_83b6dd06;

typedef struct {
    struct Name _field1;
    _Bool _field2;
    int _field3;
} NotificationData_16586dc1;
...
typedef struct vector<VO2MaxSessionAttributes, std::allocator<VO2MaxSessionAttributes>> {
    struct VO2MaxSessionAttributes *_field1;
    struct VO2MaxSessionAttributes *_field2;
    struct __compressed_pair<VO2MaxSessionAttributes *, std::allocator<VO2MaxSessionAttributes>> {
        struct VO2MaxSessionAttributes *_field1;
