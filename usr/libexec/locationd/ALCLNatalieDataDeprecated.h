...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000070ed36
- (unsigned long long)hash;	// IMP=0x001000000070e86e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000070e6c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000070e5a0
- (void)copyTo:(id)arg1;	// IMP=0x001000000070e4ab
- (void)writeTo:(id)arg1;	// IMP=0x001000000070e369
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000070e35c
- (id)dictionaryRepresentation;	// IMP=0x001000000070d72f
- (id)description;	// IMP=0x001000000070d6b8
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000070d078
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000070cd0b
