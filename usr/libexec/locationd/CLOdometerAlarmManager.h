...
+ (id)getSilo;	// IMP=0x00200000006fd6c5
- (id).cxx_construct;	// IMP=0x00200000006fe540
- (void).cxx_destruct;	// IMP=0x00100000006fe4ee
...
- (void)reset;	// IMP=0x00100000006fe274
- (void)handleOdometer:(double)arg1;	// IMP=0x00100000006fe128
- (void)handleOdometerData:(const void *)arg1;	// IMP=0x00100000006fdf02
- (void)handleLocationData:(const void *)arg1;	// IMP=0x00100000006fdb7e
- (void)reschedule;	// IMP=0x00100000006fdb78
- (void)removeAlarm:(id)arg1;	// IMP=0x00100000006fdb1c
- (void)addAlarm:(id)arg1;	// IMP=0x00100000006fda25
- (void)endService;	// IMP=0x00100000006fd9a7
- (void)beginService;	// IMP=0x00100000006fd72f
- (id)init;	// IMP=0x00100000006fd6f2
