...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000161201
- (unsigned long long)hash;	// IMP=0x0010000000160d9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000160c84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000160bac
- (void)copyTo:(id)arg1;	// IMP=0x0010000000160b12
- (void)writeTo:(id)arg1;	// IMP=0x0010000000160a25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000160a18
- (id)dictionaryRepresentation;	// IMP=0x00100000001603e2
- (id)description;	// IMP=0x001000000016036b
