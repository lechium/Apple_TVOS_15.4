...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000df104
- (unsigned long long)hash;	// IMP=0x00100000000dec02
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000de9f9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000de899
- (void)copyTo:(id)arg1;	// IMP=0x00100000000de777
- (void)writeTo:(id)arg1;	// IMP=0x00100000000de5f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000de5e4
- (id)dictionaryRepresentation;	// IMP=0x00100000000dd7db
- (id)description;	// IMP=0x00100000000dd764
@property(nonatomic) _Bool hasIsVehicleConnected;
@property(nonatomic) _Bool hasStartTime;
@property(nonatomic) _Bool hasEstExitTime;
- (int)StringAsExitState:(id)arg1;	// IMP=0x00100000000dd61d
- (id)exitStateAsString:(int)arg1;	// IMP=0x00100000000dd5d0
...
- (int)StringAsMountedConfidence:(id)arg1;	// IMP=0x00100000000dd466
- (id)mountedConfidenceAsString:(int)arg1;	// IMP=0x00100000000dd419
...
- (int)StringAsMountedState:(id)arg1;	// IMP=0x00100000000dd367
- (id)mountedStateAsString:(int)arg1;	// IMP=0x00100000000dd328
@property(nonatomic) _Bool hasMountedState;
@property(nonatomic) int mountedState; // @synthesize mountedState=_mountedState;
- (int)StringAsConfidence:(id)arg1;	// IMP=0x00100000000dd256
- (id)confidenceAsString:(int)arg1;	// IMP=0x00100000000dd209
@property(nonatomic) _Bool hasConfidence;
@property(nonatomic) int confidence; // @synthesize confidence=_confidence;
- (int)StringAsType:(id)arg1;	// IMP=0x00100000000dccd8
- (id)typeAsString:(int)arg1;	// IMP=0x00100000000dc96c
