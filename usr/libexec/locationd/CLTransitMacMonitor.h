...
+ (_Bool)isSupported;	// IMP=0x00200000008d4f95
+ (id)getSilo;	// IMP=0x00100000008d4efc
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000008d4ee3
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00100000008d4e86
- (id).cxx_construct;	// IMP=0x00200000008d70af
- (void).cxx_destruct;	// IMP=0x00100000008d705d
...
- (void)onLocationNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x00100000008d6e5b
- (void)onWifiServiceNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x00100000008d6634
- (void)processNewAccessPoints:(const void *)arg1 transitTileResults:(id)arg2;	// IMP=0x00100000008d595b
- (void)stopMonitoringTransitStateForClient:(byref id)arg1;	// IMP=0x00100000008d5638
- (void)startMonitoringTransitStateForClient:(byref id)arg1;	// IMP=0x00100000008d552a
- (void)endService;	// IMP=0x00100000008d53bd
- (void)beginService;	// IMP=0x00100000008d4f9d
- (id)init;	// IMP=0x00100000008d4f58
