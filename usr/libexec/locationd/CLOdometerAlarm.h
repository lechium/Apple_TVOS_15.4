...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x00100000006e733c
- (void)invalidate;	// IMP=0x00100000006e72d3
- (void)dealloc;	// IMP=0x00100000006e727c
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00100000006e7179
- (id)init;	// IMP=0x00100000006e714a
