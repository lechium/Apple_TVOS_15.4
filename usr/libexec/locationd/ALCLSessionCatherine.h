...
- (float)onsetCatherine;	// IMP=0x0010000000273a27
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000027364b
- (unsigned long long)hash;	// IMP=0x00100000002727c0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000272341
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000272079
- (void)copyTo:(id)arg1;	// IMP=0x0010000000271def
- (void)writeTo:(id)arg1;	// IMP=0x0010000000271ae1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000271ad4
- (id)dictionaryRepresentation;	// IMP=0x001000000027057d
- (id)description;	// IMP=0x0010000000270506
...
- (void)setOnsetCatherine:(float)arg1;	// IMP=0x0010000000270414
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x001000000027036c
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00100000002702f0
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000026f84c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000026f4e0
