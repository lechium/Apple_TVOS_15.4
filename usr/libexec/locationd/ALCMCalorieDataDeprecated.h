...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000441afe
- (unsigned long long)hash;	// IMP=0x001000000044147e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004412dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004411be
- (void)copyTo:(id)arg1;	// IMP=0x00100000004410d6
- (void)writeTo:(id)arg1;	// IMP=0x0010000000440f81
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000440f74
- (id)dictionaryRepresentation;	// IMP=0x0010000000440300
- (id)description;	// IMP=0x0010000000440289
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
@property(nonatomic) _Bool hasTimestamp;
- (int)StringAsMetSource:(id)arg1;	// IMP=0x0010000000440124
- (id)metSourceAsString:(int)arg1;	// IMP=0x00100000004400b4
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000043fbec
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000043f87f
