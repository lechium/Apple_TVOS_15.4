...
@class CLLocation, NSArray, NSDate, NSString, NSUUID, RTPlaceInferenceOptions, RTStoredVisitFetchOptions;
...
- (void)fetchStoredVisitsWithOptions:(RTStoredVisitFetchOptions *)arg1 handler:(void (^)(NSArray *, NSError *))arg2;
