...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010449f
- (unsigned long long)hash;	// IMP=0x0010000000104408
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000104314
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010424a
- (void)copyTo:(id)arg1;	// IMP=0x00100000001041be
- (void)writeTo:(id)arg1;	// IMP=0x00100000001040f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001040e8
- (id)dictionaryRepresentation;	// IMP=0x0010000000103b08
- (id)description;	// IMP=0x0010000000103a91
