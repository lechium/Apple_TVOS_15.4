...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000073b34e
- (unsigned long long)hash;	// IMP=0x001000000073afcd
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000073ae82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000073ad95
- (void)copyTo:(id)arg1;	// IMP=0x001000000073ace6
- (void)writeTo:(id)arg1;	// IMP=0x001000000073abf9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000073abec
- (id)dictionaryRepresentation;	// IMP=0x001000000073a60f
- (id)description;	// IMP=0x001000000073a598
