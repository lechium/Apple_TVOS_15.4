...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000063a65e
- (unsigned long long)hash;	// IMP=0x001000000063a54a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000063a3c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000063a29c
- (void)copyTo:(id)arg1;	// IMP=0x001000000063a1b5
- (void)writeTo:(id)arg1;	// IMP=0x001000000063a069
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000063a05c
- (id)dictionaryRepresentation;	// IMP=0x001000000063971c
- (id)description;	// IMP=0x00100000006396a5
