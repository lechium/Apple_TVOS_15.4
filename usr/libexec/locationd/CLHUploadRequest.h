...
- (id)description;	// IMP=0x00100000008770ba
- (id)jsonObject;	// IMP=0x0010000000877056
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x0010000000876e3c
- (id)initWithArchive:(id)arg1;	// IMP=0x0010000000876dec
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000876d52
- (void)dealloc;	// IMP=0x0010000000876cfa
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000876c74
