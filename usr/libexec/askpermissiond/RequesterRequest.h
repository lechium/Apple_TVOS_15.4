...
@class MISSING_TYPE, NSDate, NSString, RequestLocalizations;

@interface RequesterRequest : NSObject
{
    MISSING_TYPE *_date;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x002000000001ea6c
...
- (id)compile;	// IMP=0x001000000001e813
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001e4f1
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x001000000001e3e5
