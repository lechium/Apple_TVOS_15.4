...
- (void).cxx_destruct;	// IMP=0x0020000000004c4e
...
- (id)description;	// IMP=0x0010000000004a5e
- (id)compile;	// IMP=0x0010000000004648
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000003dbd
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 date:(id)arg3;	// IMP=0x0010000000003d06
- (id)initWithRequest:(id)arg1 date:(id)arg2;	// IMP=0x0010000000003a8e
