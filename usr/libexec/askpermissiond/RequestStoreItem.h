...
- (void).cxx_destruct;	// IMP=0x0020000000016e5e
...
- (id)description;	// IMP=0x0010000000016dae
- (id)compile;	// IMP=0x0010000000016c94
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000016aac
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 date:(id)arg3;	// IMP=0x00100000000169f5
