...
- (id)description;	// IMP=0x001000000001eebb
- (id)compile;	// IMP=0x001000000001eda7
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001eb8f
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x001000000001eab5
