...
- (void).cxx_destruct;	// IMP=0x002000000001c670
...
- (id)compile;	// IMP=0x001000000001bf8a
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x001000000001a81e
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x001000000001a79d
- (id)initWithApproverDSID:(id)arg1 date:(id)arg2 identifier:(id)arg3 itemBundleID:(id)arg4 itemDescription:(id)arg5 itemIdentifier:(id)arg6 itemTitle:(id)arg7 localizations:(id)arg8 offerName:(id)arg9 mocked:(_Bool)arg10 previewURL:(id)arg11 productType:(id)arg12 productTypeName:(id)arg13 productURL:(id)arg14 requesterName:(id)arg15 requesterDSID:(id)arg16 requestInfo:(id)arg17 status:(long long)arg18;	// IMP=0x001000000001a4f2
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000019e99
