...
- (void).cxx_destruct;	// IMP=0x00200000000181ee
...
- (id)description;	// IMP=0x0010000000017ff6
- (unsigned long long)hash;	// IMP=0x0010000000017fb2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017f04
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x0010000000017d7e
