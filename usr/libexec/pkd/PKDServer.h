...
+ (id)server;	// IMP=0x0020000000001949
- (void).cxx_destruct;	// IMP=0x0020000000002e38
...
- (void)stop;	// IMP=0x0010000000002a5f
- (void)unholdClient:(id)arg1;	// IMP=0x00100000000027bc
- (void)unholdToken:(id)arg1 silent:(_Bool)arg2;	// IMP=0x00100000000024d7
- (void)addHold:(id)arg1 silent:(_Bool)arg2;	// IMP=0x001000000000242d
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x0010000000002161
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000001a84
- (void)removedPlugIns:(id)arg1;	// IMP=0x00100000000019a6
- (void)run;	// IMP=0x001000000000195a
- (id)initForService:(const char *)arg1 database:(const char *)arg2;	// IMP=0x0010000000001492
