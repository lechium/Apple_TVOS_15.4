...
- (void).cxx_destruct;	// IMP=0x00200000000208d1
...
- (id)description;	// IMP=0x0010000000020694
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0010000000020640
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x0010000000020589
@property(readonly) int pid;
- (void)dead;	// IMP=0x00100000000204b0
- (void)dying;	// IMP=0x0010000000020465
- (void)dealloc;	// IMP=0x0010000000020426
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x000000000001fa94
