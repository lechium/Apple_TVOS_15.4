...
+ (id)sharedManager;	// IMP=0x0020000000009527
- (void).cxx_destruct;	// IMP=0x002000000000a1dd
...
- (void)setCursorFrameForElement:(id)arg1;	// IMP=0x0010000000009cfd
- (void)hideVisualsSynchronously;	// IMP=0x0010000000009b7a
- (void)setCursorFrame:(struct CGRect)arg1 withPath:(struct CGPath *)arg2 withContextId:(unsigned int)arg3 element:(id)arg4 forceRefresh:(_Bool)arg5;	// IMP=0x0010000000009771
- (void)setCursorStyle:(unsigned long long)arg1;	// IMP=0x0010000000009670
- (struct CGRect)_adjustFrameToFitScreen:(struct CGRect)arg1;	// IMP=0x0010000000009658
- (id)init;	// IMP=0x00100000000095ac
