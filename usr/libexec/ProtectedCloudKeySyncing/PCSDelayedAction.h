...
- (void).cxx_destruct;	// IMP=0x002000000000befe
...
- (void)trigger;	// IMP=0x001000000000bd27
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x001000000000bc9d
- (void)run;	// IMP=0x001000000000bc8b
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x001000000000bc59
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x001000000000b87d
