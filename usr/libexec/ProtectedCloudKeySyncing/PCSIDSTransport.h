...
+ (id)transportWithIDSServiceName:(id)arg1;	// IMP=0x0020000000001a0c
- (void).cxx_destruct;	// IMP=0x0020000000003444
...
- (id)copyLocalPairedDevices;	// IMP=0x00100000000033b3
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5;	// IMP=0x001000000000327c
- (void)service:(id)arg1 account:(id)arg2 incomingMessage:(id)arg3 fromID:(id)arg4 context:(id)arg5;	// IMP=0x0010000000002e81
- (void)sendResponse:(id)arg1 toMessage:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 logDescription:(id)arg5;	// IMP=0x00100000000027d9
- (void)sendMessage:(id)arg1 toDevice:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 logDescription:(id)arg5 handleReply:(CDUnknownBlockType)arg6;	// IMP=0x0010000000002026
- (id)initWithServiceName:(id)arg1;	// IMP=0x0010000000001cbc
