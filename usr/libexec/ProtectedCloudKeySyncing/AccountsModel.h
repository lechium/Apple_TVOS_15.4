...
+ (id)accountForCurrentPersona;	// IMP=0x004000000000f353
+ (_Bool)currentPersonaSupportsPrimaryAccount:(id *)arg1;	// IMP=0x001000000000f34b
+ (id)defaultAccountsModel;	// IMP=0x001000000000e8e8
- (void).cxx_destruct;	// IMP=0x002000000000f3f3
...
- (void)update;	// IMP=0x001000000000f08e
...
- (void)faultIfCurrentPersonaIsDataSeparated;	// IMP=0x001000000000eb82
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x001000000000ea74
- (id)init;	// IMP=0x001000000000e954
