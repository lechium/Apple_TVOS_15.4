...
+ (void)applyFilters:(id)arg1 dict:(id)arg2 type:(unsigned short)arg3 category:(unsigned short)arg4;	// IMP=0x0040000000004385
+ (void)applyFilters:(id)arg1 dict:(id)arg2 type:(unsigned short)arg3 category:(unsigned short)arg4 actions:(id)arg5;	// IMP=0x0010000000003f6a
+ (id)newBackendWithName:(id)arg1 profile:(id)arg2 productFamily:(id)arg3 clientType:(int)arg4;	// IMP=0x0010000000003468
...
- (_Bool)matchClientNameAndServiceID:(id)arg1 clientName:(id)arg2 serviceID:(id)arg3;	// IMP=0x0010000000004b56
- (_Bool)matchStringWithList:(id)arg1 wholeString:(id)arg2 whitelist:(_Bool)arg3;	// IMP=0x00100000000049f0
- (_Bool)matchExactStringWithList:(id)arg1 wholeString:(id)arg2 whitelist:(_Bool)arg3;	// IMP=0x001000000000489d
- (void)checkHashedClientName:(id)arg1 userInfoDict:(id)arg2;	// IMP=0x00100000000044dc
- (id)hashString:(id)arg1;	// IMP=0x001000000000441a
- (unsigned long long)batchedEventsSize;	// IMP=0x0010000000004412
- (void)filterEvent:(id)arg1 type:(unsigned short)arg2 category:(unsigned short)arg3;	// IMP=0x00100000000043fd
- (void)filterEvent:(id)arg1 type:(unsigned short)arg2 category:(unsigned short)arg3 actions:(id)arg4;	// IMP=0x00100000000043a8
- (void)createFiltersFromArray:(id)arg1;	// IMP=0x0010000000003d6b
- (_Bool)isBlacklistedEvent:(unsigned short)arg1;	// IMP=0x0010000000003c23
- (_Bool)isWhitelistedEvent:(unsigned short)arg1;	// IMP=0x0010000000003aef
- (void)setCorrelatedSessionID:(id)arg1;	// IMP=0x0010000000003aab
- (_Bool)uploadLogData:(id)arg1;	// IMP=0x0010000000003aa3
- (_Bool)uploadFileAtPath:(id)arg1 extensionToken:(char *)arg2;	// IMP=0x0010000000003a9b
- (id)flushMessagesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003a84
- (id)sendMessage:(id)arg1 timestamp:(const struct timeval *)arg2 method:(unsigned short)arg3 respCode:(unsigned short)arg4 flag:(int)arg5;	// IMP=0x0010000000003a59
- (void)setStartTimestamp:(const struct timeval *)arg1;	// IMP=0x0010000000003a3c
- (id)sendMessage:(id)arg1 timestamp:(const struct timeval *)arg2 method:(unsigned short)arg3 respCode:(unsigned short)arg4 eventID:(unsigned short)arg5 flag:(int)arg6;	// IMP=0x0010000000003a34
- (int)updateState;	// IMP=0x0010000000003a17
@property int state;
- (void)setSelfVersion:(id)arg1;	// IMP=0x0010000000003831
- (void)setReportingSessionActivitySchedulerDelegate:(id)arg1;	// IMP=0x001000000000381d
- (void)dealloc;	// IMP=0x001000000000373c
- (void)cleanup;	// IMP=0x0010000000003736
- (id)initWithName:(id)arg1 profile:(id)arg2 productFamily:(id)arg3;	// IMP=0x0010000000003653
