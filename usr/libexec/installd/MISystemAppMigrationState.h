...
+ (id)defaultManager;	// IMP=0x0040000000055374
- (void).cxx_destruct;	// IMP=0x002000000005599c
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000055725
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0010000000055236
