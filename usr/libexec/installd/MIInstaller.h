...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x0040000000011c40
- (void).cxx_destruct;	// IMP=0x0020000000018061
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x0010000000015f33
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0010000000015a8b
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x0010000000015664
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x001000000001439f
- (void)_writeLockBundles:(id)arg1;	// IMP=0x0010000000014146
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x0010000000013ee0
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000013ac0
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x00100000000135cf
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x0010000000012d91
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x0010000000012013
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x0010000000011dbd
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x0010000000011d4b
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x0010000000011cd3
- (void)dealloc;	// IMP=0x0010000000011a3c
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x0010000000011985
- (id)init;	// IMP=0x001000000001197c
