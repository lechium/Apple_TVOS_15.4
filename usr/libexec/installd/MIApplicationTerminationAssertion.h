...
- (void)dealloc;	// IMP=0x001000000005608e
- (void)invalidate;	// IMP=0x0010000000056034
- (id)initWithBundleIdentifier:(id)arg1 reason:(unsigned char)arg2;	// IMP=0x0010000000055bfb
