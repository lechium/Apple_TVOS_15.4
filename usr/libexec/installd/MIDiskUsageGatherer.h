...
- (void).cxx_destruct;	// IMP=0x002000000001d817
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x001000000001d53e
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x001000000001cf45
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x001000000001ce0d
