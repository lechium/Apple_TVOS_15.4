...
- (id)debugDescription;	// IMP=0x001000000007f915
- (id)description;	// IMP=0x001000000007f821
- (const char *)objCType;	// IMP=0x001000000007f814
- (void)getValue:(void *)arg1;	// IMP=0x001000000007f7f7
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x001000000007f4f0
