...
- (void).cxx_destruct;	// IMP=0x002000000008e514
...
- (id)statusString;	// IMP=0x001000000008cfea
- (_Bool)pasteboardBitValue;	// IMP=0x001000000008ce17
- (_Bool)pasteboardAvailible;	// IMP=0x001000000008cc33
- (void)removeIOPowerManagerUserIdleNotifications;	// IMP=0x001000000008cbe0
- (void)scheduleIOPowerManagerUserIdleNotifications;	// IMP=0x001000000008cb8a
@property _Bool userIsCurrent; // @synthesize userIsCurrent=_userIsCurrent;
- (_Bool)resume;	// IMP=0x001000000008c926
- (_Bool)suspend;	// IMP=0x001000000008c84b
- (_Bool)active;	// IMP=0x001000000008c7bf
- (_Bool)okToSuspendAdvertising;	// IMP=0x001000000008c6ee
- (_Bool)scheduleAdvertisementUpdate;	// IMP=0x001000000008c6d9
- (_Bool)scheduleAdvertisementUpdate:(double)arg1;	// IMP=0x001000000008c66f
- (void)activityAdvertiser:(id)arg1 pairedDevicesChangedNotification:(id)arg2;	// IMP=0x001000000008c2ab
- (void)activityAdvertiser:(id)arg1 didSendPayloadForActivityIdentifier:(id)arg2 toDevice:(id)arg3 error:(id)arg4;	// IMP=0x001000000008bf57
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 handoffCommand:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000088e7a
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000087f32
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 requestedByDevice:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000087ce9
- (id)dataForMoreAppSuggestions;	// IMP=0x0010000000087233
- (void)setShouldAdvertiseAutoPullActivityList:(_Bool)arg1;	// IMP=0x0010000000087166
@property(copy) NSSet *pairedDevices; // @synthesize pairedDevices=_pairedDevices;
- (void)_updatePairedDeviceCapabilities;	// IMP=0x0010000000086564
- (void)_refreshPairedSFPeerDevices;	// IMP=0x001000000008619e
...
- (id)sfActivityAdvertiser;	// IMP=0x0010000000085e63
- (_Bool)removeSFActivityAdvertiser:(id)arg1;	// IMP=0x0010000000085d9f
- (_Bool)addSFActivityAdvertiser:(id)arg1;	// IMP=0x0010000000085cd2
@property(readonly, copy) NSSet *sfActivityAdvertisers;
- (_Bool)peerDeviceCanAcceptNewerPayload:(id)arg1;	// IMP=0x001000000008577d
- (void)_periodicIdleUpdate;	// IMP=0x001000000008528b
- (void)removeAdvertisement;	// IMP=0x0010000000084d8a
- (void)moveAdvertisementToNonActive;	// IMP=0x0010000000084ccb
- (_Bool)_updateAdvertisement;	// IMP=0x0010000000083cce
- (_Bool)advertiseItem:(id)arg1 force:(_Bool)arg2;	// IMP=0x00100000000817be
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000080e30
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2 sfAdvertiser:(id)arg3;	// IMP=0x0010000000080bcb
- (_Bool)_advertisePayload:(id)arg1;	// IMP=0x0010000000080bb6
- (void)advertisePayload:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000080aca
- (void)updateAdvertisingPowerAssertion:(double)arg1;	// IMP=0x001000000008083a
- (id)mostRecentAdvertisedBytesTime;	// IMP=0x0010000000080828
- (id)currentAdvertisedBytes;	// IMP=0x0010000000080723
- (void)setAdvertisableItems:(id)arg1;	// IMP=0x00100000000800bc
- (id)advertisingItems;	// IMP=0x0010000000080003
- (_Bool)advertising;	// IMP=0x001000000007ffd0
- (id)advertisableItems;	// IMP=0x001000000007ff64
- (id)initWithManager:(id)arg1 advertiser:(id)arg2;	// IMP=0x001000000007f9e3
