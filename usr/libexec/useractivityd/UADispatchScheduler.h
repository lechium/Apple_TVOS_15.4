...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x004000000002b8b0
- (void).cxx_destruct;	// IMP=0x002000000002c8b1
...
- (id)nextRunTimeString;	// IMP=0x001000000002c7fa
- (void)waitUntilComplete;	// IMP=0x001000000002c776
- (void)suspend;	// IMP=0x001000000002c700
- (void)resume;	// IMP=0x001000000002c6cb
- (void)reset;	// IMP=0x001000000002c509
- (void)updateFrequency:(double)arg1;	// IMP=0x001000000002c320
- (void)_doIt;	// IMP=0x001000000002c04e
- (void)doIt;	// IMP=0x001000000002bfc7
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x001000000002bf58
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x001000000002b965
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x001000000002b5a8
