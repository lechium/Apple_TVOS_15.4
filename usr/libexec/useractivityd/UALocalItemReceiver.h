...
- (void).cxx_destruct;	// IMP=0x002000000004a530
@property(readonly, retain) UAUserActivityClientProcessesController *controller; // @synthesize controller=_controller;
- (id)statusString;	// IMP=0x001000000004a439
- (id)receivedItems;	// IMP=0x001000000004a142
- (_Bool)receiving;	// IMP=0x001000000004a0fa
- (id)initWithManager:(id)arg1 controller:(id)arg2;	// IMP=0x001000000004a07b
