...
- (void).cxx_destruct;	// IMP=0x0020000000013f13
...
- (id)statusString;	// IMP=0x0010000000013dc2
- (_Bool)terminate;	// IMP=0x0010000000013c5f
- (_Bool)resume;	// IMP=0x0010000000013b40
- (_Bool)suspend;	// IMP=0x0010000000013a1b
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000001378c
