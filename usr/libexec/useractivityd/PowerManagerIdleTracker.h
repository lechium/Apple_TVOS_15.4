...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x00400000000040de
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000003d07
- (void).cxx_destruct;	// IMP=0x0020000000004a0a
...
- (void)invalidate;	// IMP=0x001000000000462e
- (void)dealloc;	// IMP=0x0010000000003ff2
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000003da9
