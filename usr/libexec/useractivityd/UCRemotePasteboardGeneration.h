...
- (void).cxx_destruct;	// IMP=0x002000000002e28e
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002dd20
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ce36
- (void)dealloc;	// IMP=0x001000000002ccf1
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002cb84
- (id)stateAsString;	// IMP=0x001000000002cb01
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002c944
