...
+ (id)sharedActivityManagerServer;	// IMP=0x002000000001d25e
+ (id)cornerActionManager;	// IMP=0x001000000001d245
- (void).cxx_destruct;	// IMP=0x002000000002a24c
...
- (void)removeHandler:(id)arg1;	// IMP=0x0010000000029d08
- (void)addHandler:(id)arg1;	// IMP=0x0010000000029c57
@property(readonly, copy) NSSet *handlers;
- (void)removeActivityNotifier:(id)arg1;	// IMP=0x0010000000029b53
- (void)addActivityNotifier:(id)arg1;	// IMP=0x0010000000029a92
@property(readonly, copy) NSSet *notifiers;
- (void)removeClient:(id)arg1;	// IMP=0x0010000000029972
- (void)addClient:(id)arg1;	// IMP=0x0010000000029899
@property(readonly, copy) NSSet *clients;
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000297a5
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000296d4
@property(readonly, copy) NSSet *receivers;
- (void)removeAdvertiser:(id)arg1;	// IMP=0x0010000000029526
- (void)addAdvertiser:(id)arg1;	// IMP=0x00100000000293ab
@property(readonly, copy) NSSet *advertisers;
- (id)statusString;	// IMP=0x0010000000026b44
- (id)shortStatusString;	// IMP=0x001000000002619c
- (id)dynamicUserActivitiesString;	// IMP=0x00100000000260cb
- (id)debuggingInfo;	// IMP=0x0010000000025f11
- (id)dictionaryForCornerActionItem:(id)arg1;	// IMP=0x0010000000025f09
- (id)dictionaryForAdvertisableItem:(id)arg1;	// IMP=0x0010000000025f01
- (void)updateUIDeviceLockedState:(_Bool)arg1;	// IMP=0x0010000000025996
- (void)updateScreenDimStateState:(_Bool)arg1;	// IMP=0x001000000002541a
- (void)updateUserActiveState:(_Bool)arg1;	// IMP=0x0010000000024973
@property _Bool userActive; // @synthesize userActive=_userActive;
- (void)terminate;	// IMP=0x00100000000248ff
- (void)resume;	// IMP=0x00100000000239c8
- (void)suspend;	// IMP=0x0010000000023254
@property _Bool suspended;
- (void)resumeListeningForBluetooth;	// IMP=0x0010000000023055
- (void)suspendListeningForBluetooth;	// IMP=0x0010000000022edf
- (void)triggerAll;	// IMP=0x0010000000022e8c
- (void)processWasRemoved;	// IMP=0x0010000000022d41
- (_Bool)fetchMoreAppSuggestions;	// IMP=0x0010000000022b8d
- (_Bool)haveBestAppChangeNotificationClients;	// IMP=0x0010000000022b23
- (void)_checkIfBestApplicationChangedThread;	// IMP=0x00100000000227d1
- (_Bool)scheduleBestAppDetermination:(double)arg1;	// IMP=0x0010000000022767
- (_Bool)scheduleBestAppDetermination;	// IMP=0x0010000000022752
- (void)checkIfBestCornerItemChanged:(double)arg1;	// IMP=0x00100000000226c3
@property(retain, nonatomic) UAUserActivityInfo *debugCornerItem;
- (id)bestCornerItem:(id)arg1;	// IMP=0x001000000002263c
- (id)bestCornerItem;	// IMP=0x00100000000225d8
- (id)cornerActionItemForUUID:(id)arg1;	// IMP=0x00100000000223ae
- (id)cornerActionItems;	// IMP=0x0010000000021fa5
...
- (void)_determineWhenSystemGoesIdleThread;	// IMP=0x0010000000020bee
@property _Bool advertisingSuspended;
- (void)triggerUserIdleDetermination:(double)arg1;	// IMP=0x0010000000020974
- (void)triggerUserIdleDetermination;	// IMP=0x001000000002095f
- (_Bool)isBluetoothEnabled;	// IMP=0x0010000000020957
@property(readonly) _Bool activityReceivingAllowed;
@property(readonly) _Bool activityAdvertisingAllowed;
- (void)updateScreenSaverActive:(_Bool)arg1;	// IMP=0x0010000000020893
- (void)_determineItemToAdvertiseForHandoffThread;	// IMP=0x001000000001edfd
@property(readonly, copy) NSArray *itemsBeingAdvertised; // @synthesize itemsBeingAdvertised=_itemsBeingAdvertised;
- (_Bool)weAreAdvertisingAtLeastOneItem;	// IMP=0x001000000001eba4
- (void)userActivityItemsChanged;	// IMP=0x001000000001eab9
- (id)uaAdvertisableItemsInOrder:(_Bool)arg1;	// IMP=0x001000000001e4b6
- (id)uaAdvertisableItemsInOrder;	// IMP=0x001000000001e4a2
- (id)activeAdvertiseableItemsUUIDs;	// IMP=0x001000000001e25d
- (void)scheduleUpdatingAdvertisableItems:(double)arg1;	// IMP=0x000000000001e1fa
- (void)scheduleUpdatingAdvertisableItems;	// IMP=0x001000000001e1e0
- (_Bool)shouldItemBeAdvertised:(id)arg1;	// IMP=0x001000000001dde3
- (id)advertiseableItems;	// IMP=0x001000000001db6f
- (_Bool)weAreAdvertisingAnItem;	// IMP=0x001000000001d9ea
- (void)dealloc;	// IMP=0x001000000001d9bb
- (id)init;	// IMP=0x001000000001d2b3
