...
- (void).cxx_destruct;	// IMP=0x00200000000676fa
...
- (void)shutdownStream;	// IMP=0x001000000006743c
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x0010000000067379
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000066c07
- (id)headerForData:(id)arg1;	// IMP=0x0010000000066b3f
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000667b5
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x001000000006661f
