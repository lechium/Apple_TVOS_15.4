...
- (void).cxx_destruct;	// IMP=0x002000000003f1fc
...
- (void)extractArchiveWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003f183
- (id)initWithDestinationURL:(id)arg1 forArchiveUUID:(id)arg2;	// IMP=0x001000000003f04d
