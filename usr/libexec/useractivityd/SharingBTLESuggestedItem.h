...
+ (id)statusString;	// IMP=0x0040000000066325
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x0010000000060dbf
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x0010000000060c90
- (void).cxx_destruct;	// IMP=0x002000000006651b
...
- (id)description;	// IMP=0x00100000000661e9
- (void)setWhen:(id)arg1;	// IMP=0x00100000000660e3
- (id)when;	// IMP=0x001000000006600c
- (id)statusString;	// IMP=0x0010000000065a7f
- (void)clearPayload;	// IMP=0x001000000006585b
- (void)resignCurrent;	// IMP=0x00100000000657eb
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000636ca
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x001000000006313a
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x0010000000062517
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x0010000000062473
