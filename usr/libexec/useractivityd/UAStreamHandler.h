...
- (void).cxx_destruct;	// IMP=0x002000000003cdf2
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003caed
- (long long)tryWriteMessage;	// IMP=0x001000000003c448
- (long long)tryWriteRawData;	// IMP=0x001000000003c132
- (long long)handleSpaceAvailable;	// IMP=0x001000000003c0d9
- (void)handleMessageRead;	// IMP=0x001000000003bf9e
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003bf2a
- (void)processHeader;	// IMP=0x001000000003be1a
- (void)handleBytesAvailable;	// IMP=0x001000000003ba41
- (void)handleOpenCompleted;	// IMP=0x001000000003b944
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003b6fb
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003b3d9
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003b1da
- (void)_stop;	// IMP=0x001000000003afaa
- (void)tryStop;	// IMP=0x001000000003ae60
- (void)stop;	// IMP=0x001000000003ad48
- (void)start;	// IMP=0x001000000003a922
- (long long)queueCount;	// IMP=0x001000000003a8a3
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003a6ac
