...
- (void).cxx_destruct;	// IMP=0x00200000000559f2
...
- (id)description;	// IMP=0x0010000000055547
- (id)encodeAsData;	// IMP=0x0010000000054c9d
- (id)initWithData:(id)arg1;	// IMP=0x001000000005429c
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000005418e
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x0010000000054108
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0010000000053f89
