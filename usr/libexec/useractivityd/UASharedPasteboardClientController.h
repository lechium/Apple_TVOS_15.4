...
- (void).cxx_destruct;	// IMP=0x002000000003a4f1
...
- (id)localPBStatus;	// IMP=0x0010000000039a6c
- (id)statusString;	// IMP=0x0010000000039a5f
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x00100000000395c8
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000038a4e
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000037d64
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x001000000003718e
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000035395
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x001000000003523a
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x0010000000035228
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032831
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030700
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000303ca
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x00100000000302d6
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x0010000000030063
- (void)clearLocalPasteboardInformation;	// IMP=0x001000000002ff96
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x001000000002f8d1
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f803
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f791
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f672
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002f2c9
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002efac
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002ee55
- (id)items;	// IMP=0x001000000002ee43
- (void)startConnection:(int)arg1;	// IMP=0x001000000002edae
...
- (id)uuid;	// IMP=0x001000000002eb31
- (void)dealloc;	// IMP=0x001000000002ea69
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002e3b0
