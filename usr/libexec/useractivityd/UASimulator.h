...
+ (id)simulatorWithController:(id)arg1 parentSimulatorPortName:(id)arg2;	// IMP=0x002000000008ed88
+ (id)simulatorWithController:(id)arg1 pairedPort:(unsigned int)arg2 childSimPid:(int)arg3 childVersion:(unsigned long long)arg4;	// IMP=0x001000000008ed80
- (void).cxx_destruct;	// IMP=0x002000000009059b
...
- (id)statusString;	// IMP=0x00100000000903f7
- (_Bool)terminate;	// IMP=0x0010000000090126
- (_Bool)suspend;	// IMP=0x0010000000090037
- (_Bool)resume;	// IMP=0x001000000008ff48
- (void)setSimulatorInFront:(_Bool)arg1;	// IMP=0x001000000008fdbd
- (_Bool)active;	// IMP=0x001000000008fd8a
@property(copy) NSSet *notifiedItems;
@property(readonly) unsigned int pairedClientPort; // @dynamic pairedClientPort;
- (_Bool)reconnectToParentSimulator;	// IMP=0x001000000008f12b
- (void)dealloc;	// IMP=0x001000000008f060
- (id)initWithController:(id)arg1;	// IMP=0x001000000008e660
