...
- (void).cxx_destruct;	// IMP=0x002000000001b914
...
- (void)_triggerWatchdog;	// IMP=0x001000000001b6dc
- (void)cancel;	// IMP=0x001000000001b5e8
- (void)poke;	// IMP=0x001000000001b55b
- (void)start;	// IMP=0x001000000001b345
- (void)dealloc;	// IMP=0x001000000001b2e2
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b21e
