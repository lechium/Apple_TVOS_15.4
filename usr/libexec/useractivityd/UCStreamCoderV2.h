...
- (void).cxx_destruct;	// IMP=0x002000000001afc3
...
- (id)fetchDataForType:(id)arg1;	// IMP=0x001000000001ab24
- (id)unpackMessage:(id)arg1;	// IMP=0x001000000001aab4
- (id)packMessage:(id)arg1;	// IMP=0x001000000001aa8f
- (void)filePackagerError:(id)arg1;	// IMP=0x001000000001a9ad
- (MISSING_TYPE *)packager:gotData:forPacket: /* Error: Ran out of types for this method. */;	// IMP=0x001000000001a512
- (void)sendCompletedWithError:(id)arg1;	// IMP=0x001000000001a2b9
- (void)sendPasteboard:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000018df1
- (void)calculateTimeRemaining;	// IMP=0x0010000000018bd3
- (void)processPasteboardInfo:(id)arg1;	// IMP=0x001000000001853a
- (void)removeReceivedItems:(id)arg1;	// IMP=0x0010000000018280
- (void)completedReceivingPasteboardWithError:(id)arg1;	// IMP=0x0010000000017fd0
- (void)receivedPasteboardInfo:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000017d2d
- (void)cancelReceive;	// IMP=0x0010000000017c72
- (void)receivePasteboardToFile:(id)arg1 withProgress:(id)arg2 infoReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 returnInfoEarly:(_Bool)arg5;	// IMP=0x0010000000017a8d
- (void)sendHeartbeat;	// IMP=0x0010000000017988
- (void)sendTotalSendSize;	// IMP=0x001000000001786e
- (void)sendPasteboardDataResponse;	// IMP=0x00100000000176c6
- (void)sendFileArchiveRequest;	// IMP=0x00100000000171c1
- (void)sendPasteboardDataRequest;	// IMP=0x00100000000170d6
- (void)sendPasteboardInfoResponse;	// IMP=0x0010000000016f2f
- (void)sendPasteboardInfoRequest;	// IMP=0x0010000000016ea1
- (void)handleHeartbeat:(id)arg1;	// IMP=0x0010000000016df6
- (void)handlePasteboardAuxInfoReceived:(id)arg1;	// IMP=0x0010000000016c96
- (void)handlePasteboardFileResponse:(id)arg1;	// IMP=0x0010000000016501
- (void)handlePasteboardDataResponse:(id)arg1;	// IMP=0x00100000000160b9
- (void)handlePasteboardInfoResponse:(id)arg1;	// IMP=0x0010000000015d9b
- (void)handlePasteboardFileRequest:(id)arg1;	// IMP=0x0010000000015672
- (void)handlePasteboardDataRequest:(id)arg1;	// IMP=0x00100000000155ee
- (void)handlePasteboardInfoRequest:(id)arg1;	// IMP=0x001000000001556a
- (void)recvStop:(id)arg1;	// IMP=0x00100000000153d4
- (void)sendStopWithError:(long long)arg1;	// IMP=0x001000000001524c
- (void)streams:(id)arg1 didWriteMessageWithTag:(long long)arg2;	// IMP=0x0010000000014d78
- (void)streams:(id)arg1 didReadMessage:(id)arg2 withTag:(long long)arg3;	// IMP=0x0010000000014b63
- (void)streamsDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000014a54
- (void)removeObject:(id)arg1;	// IMP=0x00100000000149a2
- (void)storeObject:(id)arg1;	// IMP=0x00100000000148f0
- (void)dealloc;	// IMP=0x0010000000014665
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x00100000000141f4
