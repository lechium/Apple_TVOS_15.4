...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000698ed
- (void).cxx_destruct;	// IMP=0x0020000000069cf5
...
- (id)description;	// IMP=0x0010000000069b26
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000699fc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000698f5
- (id)init;	// IMP=0x00100000000698be
