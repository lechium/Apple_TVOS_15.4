...
- (void).cxx_destruct;	// IMP=0x0020000000003cd4
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003b89
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000039dc
- (void)unlockWithError:(id)arg1;	// IMP=0x001000000000375d
- (id)initWithURL:(id)arg1;	// IMP=0x001000000000368e
