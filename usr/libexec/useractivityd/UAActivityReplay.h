...
- (void).cxx_destruct;	// IMP=0x00200000000452c8
...
- (_Bool)terminate;	// IMP=0x0010000000044c78
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000044b0e
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000044b08
- (_Bool)processCommands:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000004483f
- (_Bool)sendResponse:(id)arg1;	// IMP=0x0010000000044837
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000042377
- (id)scanMockAdvertisement:(id)arg1;	// IMP=0x0010000000041a2e
- (void)doAdvertiseAdvertisementPayload:(id)arg1 options:(id)arg2;	// IMP=0x001000000004173d
- (id)sharingAdvertiser;	// IMP=0x001000000004155c
- (id)sharingReceiver;	// IMP=0x001000000004137b
- (void)dealloc;	// IMP=0x00100000000410ee
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000040b50
