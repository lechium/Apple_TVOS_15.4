...
- (void).cxx_destruct;	// IMP=0x0020000000020024
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x001000000001fc3c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x001000000001fa07
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000001f429
- (long long)versionFromTask:(id)arg1;	// IMP=0x001000000001f3cd
- (void)updateDb:(long long)arg1;	// IMP=0x001000000001f16c
- (void)reschedule;	// IMP=0x001000000001efa2
