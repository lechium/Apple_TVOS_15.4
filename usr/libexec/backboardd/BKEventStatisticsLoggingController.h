...
+ (id)workQueue;	// IMP=0x002000000003fa57
- (void).cxx_destruct;	// IMP=0x002000000003f379
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x001000000003f315
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x001000000003f28a
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x001000000003f274
- (void)dealloc;	// IMP=0x001000000003f0ed
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x001000000003ef21
