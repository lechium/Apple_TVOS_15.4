...
+ (id)_bundleInfoOverrides;	// IMP=0x0020000000018182
- (void).cxx_destruct;	// IMP=0x0020000000017ee4
...
- (void)_noteExitedWithContext:(id)arg1;	// IMP=0x0010000000017d3a
- (_Bool)terminate;	// IMP=0x0010000000017b12
- (_Bool)launchWithResultBlock:(CDUnknownBlockType)arg1 exitBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000001688b
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x00100000000167f4
@property(readonly, copy) NSString *description;
- (id)initWithBundleId:(id)arg1 options:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000016711
