...
- (void).cxx_destruct;	// IMP=0x00200000000140fb
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0010000000013f15
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0010000000013e65
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0010000000013de7
