...
+ (id)keyboardInfoWithIOHIDService:(id)arg1;	// IMP=0x00200000000446f2
- (void).cxx_destruct;	// IMP=0x00200000000444a8
...
- (void)setCapsLockDelayOverride:(double)arg1;	// IMP=0x0010000000044266
- (void)setCapsLockLEDOn:(_Bool)arg1;	// IMP=0x001000000004419c
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000043ca0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0010000000043c45
