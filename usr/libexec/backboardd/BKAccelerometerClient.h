...
- (_Bool)_shouldSendSampleEventWithTimestamp:(double)arg1 samplingInterval:(double)arg2;	// IMP=0x001000000003d8b6
- (_Bool)_passesThresholdForX:(float)arg1 y:(float)arg2 z:(float)arg3;	// IMP=0x001000000003d80b
- (void)_queue_invalidate;	// IMP=0x001000000003d7dc
- (void)handleOrientationEvent:(long long)arg1 orientationLocked:(_Bool)arg2;	// IMP=0x001000000003d7d6
- (void)handleAccelerometerEventWithTimestamp:(double)arg1 x:(float)arg2 y:(float)arg3 z:(float)arg4 samplingInterval:(double)arg5;	// IMP=0x001000000003d7d0
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000003d6e3
