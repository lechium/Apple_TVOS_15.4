...
+ (id)sharedInstance;	// IMP=0x0020000000020e53
- (void).cxx_destruct;	// IMP=0x0020000000020c01
...
- (void)_queue_finishBootingIfNecessaryAndTellObservers:(_Bool)arg1;	// IMP=0x00100000000209df
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x0010000000020994
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000020909
- (void)addObserver:(id)arg1;	// IMP=0x001000000002087e
@property(readonly, nonatomic, getter=isFirstBoot) _Bool firstBoot;
@property(readonly, copy) NSString *description;
- (id)initWithSystemAppSentinel:(id)arg1 firstBootToken:(id)arg2 alternateSystemAppManager:(id)arg3;	// IMP=0x0010000000020668
