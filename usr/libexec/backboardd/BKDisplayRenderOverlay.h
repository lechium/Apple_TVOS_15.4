...
- (void).cxx_destruct;	// IMP=0x0020000000019263
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000001911c
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00100000000190cc
- (id)succinctDescriptionBuilder;	// IMP=0x0010000000019064
- (id)succinctDescription;	// IMP=0x0010000000019014
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x0010000000018f9b
- (id)_persistenceData;	// IMP=0x0010000000018f25
- (void)_cleanup;	// IMP=0x0010000000018f1f
- (void)_freeze;	// IMP=0x0010000000018f19
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x0010000000018f13
- (void)_stopAnimating;	// IMP=0x0010000000018f0d
- (void)_startAnimating;	// IMP=0x0010000000018f07
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x0010000000018eff
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x0010000000018db5
- (void)freeze;	// IMP=0x0010000000018b7b
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x00100000000189a7
...
- (void)dealloc;	// IMP=0x001000000001874b
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x001000000001869b
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x0010000000018265
