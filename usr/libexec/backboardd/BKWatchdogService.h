...
- (void).cxx_destruct;	// IMP=0x002000000001ba8b
...
- (_Bool)isAlive;	// IMP=0x001000000001ba3f
- (void)registerClientsForMonitoring;	// IMP=0x001000000001ba29
- (id)init;	// IMP=0x001000000001b98c
