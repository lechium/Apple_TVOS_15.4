...
+ (id)defaultClient;	// IMP=0x0040000000053fac
- (void).cxx_destruct;	// IMP=0x0020000000053f40
...
- (id)initWithMode:(unsigned long long)arg1 port:(id)arg2 auditToken:(id)arg3;	// IMP=0x0010000000053dc2
