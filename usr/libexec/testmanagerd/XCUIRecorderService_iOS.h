...
@class MISSING_TYPE, NSArray, NSDictionary, NSNumber, NSTimer, XCElementSnapshot, XCUIRecorderAction;
...
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x002000000002354a
- (void).cxx_destruct;	// IMP=0x00200000000237dd
...
- (id)_snapshotForTargetApplicationWithError:(id *)arg1;	// IMP=0x0010000000023409
- (id)_snapshotForApplicationContainingElement:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000231ba
- (void)_processKeyboardEvent:(id)arg1;	// IMP=0x001000000002310b
- (void)_processDeviceOrientationEvent:(id)arg1;	// IMP=0x0010000000022ff3
- (void)_recognizedGestures:(id)arg1;	// IMP=0x0010000000022970
- (void)_recognizedEventTypeName:(id)arg1 atAbsoluteTime:(double)arg2 withStartSnapshot:(id)arg3 endSnapshot:(id)arg4;	// IMP=0x0010000000022735
- (id)_recordedEventNames:(id)arg1 timestamp:(double)arg2 duration:(double)arg3 startLocation:(id)arg4 startElementSnapshot:(id)arg5 startApplicationSnapshot:(id)arg6 endLocation:(id)arg7 endElementSnapshot:(id)arg8 endApplicationSnapshot:(id)arg9;	// IMP=0x0010000000022595
- (void)_reportDeferredActionForEventCount:(id)arg1;	// IMP=0x00100000000224d3
- (_Bool)_reportCurrentActionWaitForTimeInterval:(double *)arg1;	// IMP=0x00100000000222e6
- (void)_processHandEvent:(id)arg1;	// IMP=0x0010000000021cbe
- (void)_processButtonUpEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000021b3d
- (void)_processButtonDownEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000021839
- (void)_processButtonUpEvent:(id)arg1;	// IMP=0x00100000000217bf
- (void)_processButtonDownEvent:(id)arg1;	// IMP=0x0010000000021745
- (void)_releasePendingEvents:(double)arg1;	// IMP=0x00100000000215c4
- (id)stringForHandEventType:(unsigned int)arg1;	// IMP=0x001000000002135c
- (id)_elementSnapshotForLocation:(struct CGPoint)arg1 rootElementSnapshot:(id *)arg2;	// IMP=0x0010000000020f5f
- (void)_handleHIDEventReceived:(id)arg1;	// IMP=0x0010000000020998
- (void)stopRecording;	// IMP=0x00100000000205b5
- (void)_registerForKeyEventNotification;	// IMP=0x001000000002011d
- (id)_nativeFocusItemDidChangeAtTime:(double)arg1 parameterSnapshot:(id)arg2 applicationSnapshot:(id)arg3;	// IMP=0x0010000000020053
- (MISSING_TYPE *)_registerForNativeFocusDidChangeNotification;	// IMP=0x001000000001fc96
- (void)startRecordingProcessPID:(int)arg1 applicationSnapshotAttributes:(id)arg2 applicationSnapshotParameters:(id)arg3 elementSnapshotAttributes:(id)arg4 elementSnapshotParameters:(id)arg5 simpleTargetGestureNames:(id)arg6;	// IMP=0x001000000001efed
- (void)dealloc;	// IMP=0x001000000001ef25
- (id)initWithAXManager:(id)arg1;	// IMP=0x001000000001eec7
- (id)initWithError:(id *)arg1;	// IMP=0x001000000001ee0b
