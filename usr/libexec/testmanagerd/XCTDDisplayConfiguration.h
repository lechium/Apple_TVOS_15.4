...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x002000000003ad22
+ (id)sharedDisplayMonitor;	// IMP=0x001000000003accd
- (void).cxx_destruct;	// IMP=0x002000000003b59f
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x001000000003ad4f
