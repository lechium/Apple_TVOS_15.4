...
+ (id)sharedSystem;	// IMP=0x0020000000019e4e
- (void).cxx_destruct;	// IMP=0x002000000001b6c3
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000001b4e3
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000001b2da
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000001b156
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000001aecb
- (void)_queue_unloadAccessibility;	// IMP=0x001000000001aca2
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000001aaab
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001a6ea
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001a37d
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001a0de
- (void)dealloc;	// IMP=0x0010000000019fdd
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x0010000000019ef6
