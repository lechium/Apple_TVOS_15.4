...
- (void).cxx_destruct;	// IMP=0x002000000002a2f1
...
- (id)_dispatchSourceForProcessID:(int)arg1;	// IMP=0x0010000000029fd1
- (_Bool)hasAuthorizedProcessID:(int)arg1;	// IMP=0x0010000000029e6c
- (void)authorizeProcessID:(int)arg1;	// IMP=0x0010000000029b5a
- (void)dealloc;	// IMP=0x0010000000029a35
- (id)init;	// IMP=0x00100000000299f7
- (id)initWithDispatchSourceProvider:(CDUnknownBlockType)arg1;	// IMP=0x001000000002992c
