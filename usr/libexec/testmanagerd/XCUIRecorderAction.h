...
- (void).cxx_destruct;	// IMP=0x0020000000009db2
...
- (id)gestureNamesWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000009351
- (id)eventTypeNameWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000009289
@property(readonly, getter=isHandEvent) _Bool handEvent;
- (id)init;	// IMP=0x0010000000009176
