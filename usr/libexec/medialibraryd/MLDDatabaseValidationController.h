...
- (void).cxx_destruct;	// IMP=0x0020000000003fc8
...
- (void)_tearDownLanguageChangeNotifications;	// IMP=0x0010000000003eb2
- (void)_registerForLanguageChangeNotifications;	// IMP=0x0010000000003d2f
- (void)_exitForLocalizationChange;	// IMP=0x0010000000003c42
- (void)_purgePendingDatabaseValidations;	// IMP=0x0010000000003a5a
- (_Bool)shouldValidateDatabaseForLibrary:(id)arg1;	// IMP=0x0010000000003996
- (void)resumeValidations;	// IMP=0x001000000000394b
- (void)clearValidatedPaths;	// IMP=0x00100000000038ab
- (void)suspendValidations;	// IMP=0x0010000000003860
- (_Bool)isValidatedPath:(id)arg1;	// IMP=0x0010000000003792
- (void)validateMusicLibrary:(id)arg1 shouldTruncateDatabase:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000032db
- (void)dealloc;	// IMP=0x001000000000329d
- (id)init;	// IMP=0x00100000000031e8
