...
- (void).cxx_destruct;	// IMP=0x002000000004cd9b
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x001000000004cbf3
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x001000000004cbe1
- (void)deactivate;	// IMP=0x001000000004cb51
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x001000000004cad9
- (id)initWithClient:(id)arg1;	// IMP=0x001000000004ca6e
