...
+ (id)queryWithString:(id)arg1;	// IMP=0x00400000000869a7
- (void).cxx_destruct;	// IMP=0x0020000000086fc1
...
- (_Bool)_bindStatement:(struct sqlite3_stmt *)arg1 withParameter:(id)arg2 atPosition:(int)arg3;	// IMP=0x0010000000086e6f
- (void)bindParameters:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000086bee
- (void)bindParameter:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000869fd
