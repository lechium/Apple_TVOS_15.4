...
- (void).cxx_destruct;	// IMP=0x002000000008d923
...
- (void)clearContinuationTokenIfSupported;	// IMP=0x001000000008d3cf
- (void)_addExperimentalFeaturesInfoToClientProvidedData:(id)arg1;	// IMP=0x001000000008d23f
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000008ba54
@property(readonly, nonatomic, getter=isContextSecretValidForSRP) _Bool contextSecretValidForSRP;
- (id)initWithContext:(id)arg1;	// IMP=0x001000000008b9a6
