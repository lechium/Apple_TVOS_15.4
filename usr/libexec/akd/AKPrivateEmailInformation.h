...
- (void).cxx_destruct;	// IMP=0x0020000000059b87
...
- (id)description;	// IMP=0x0010000000059b03
- (void)_processDictionary:(id)arg1 addedPrivateEmails:(id *)arg2 removedPrivateEmails:(id *)arg3;	// IMP=0x00100000000598ff
- (id)initWithResponseBody:(id)arg1;	// IMP=0x0010000000059387
