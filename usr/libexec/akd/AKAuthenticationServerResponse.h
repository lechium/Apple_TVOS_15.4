...
+ (id)decodedConfigurationInfo:(id)arg1;	// IMP=0x004000000000ad0f
- (void).cxx_destruct;	// IMP=0x002000000000df63
...
- (id)imageURLString;	// IMP=0x001000000000df07
...
- (id)_numberFormatter;	// IMP=0x001000000000dc31
- (id)_decodeBase64String:(id)arg1;	// IMP=0x001000000000dba8
- (void)_updateDSIDWithRawValue:(id)arg1;	// IMP=0x001000000000daa7
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1 shouldUpdateDSID:(_Bool)arg2;	// IMP=0x001000000000cc2f
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1;	// IMP=0x001000000000cc1b
- (void)_updateAccountInformationWithResultsDictionary:(id)arg1;	// IMP=0x001000000000c81c
- (void)updateWithSecondaryAuthenticationBody:(id)arg1;	// IMP=0x001000000000c769
@property(readonly, nonatomic) _Bool isUpdateable;
- (void)_setHeartbeatToken:(id)arg1;	// IMP=0x001000000000c73e
@property(readonly, nonatomic) AKToken *inheritanceBeneficiarySetupToken;
@property(readonly, nonatomic) AKToken *heartbeatToken;
- (void)_setPasswordEquivalentToken:(id)arg1;	// IMP=0x001000000000c6e7
@property(readonly, nonatomic) AKToken *passwordEquivalentToken;
- (void)_harvestCommonFieldsFromBody:(id)arg1;	// IMP=0x001000000000c1b3
- (void)_harvestCommonFieldsFromResponse:(id)arg1;	// IMP=0x001000000000bf0c
- (id)initWithServerResponse:(id)arg1 responseBody:(id)arg2;	// IMP=0x001000000000be54
- (id)initWithServerResponse:(id)arg1 forAppleID:(id)arg2;	// IMP=0x001000000000bda1
- (id)_federatedPayloadFromInfo:(id)arg1;	// IMP=0x001000000000bcc6
- (id)initWithSRPContext:(id)arg1;	// IMP=0x001000000000aeec
