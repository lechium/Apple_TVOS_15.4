...
- (void).cxx_destruct;	// IMP=0x00100000000104f7
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001011a
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000ff32
- (id)init;	// IMP=0x001000000000fe71
- (void)_loadEnterpriseData;	// IMP=0x001000000001052a
