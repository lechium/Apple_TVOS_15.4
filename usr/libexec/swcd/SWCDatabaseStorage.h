...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000013627
- (void).cxx_destruct;	// IMP=0x00200000000140c3
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000136d5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001362f
