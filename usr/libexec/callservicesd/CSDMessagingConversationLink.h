...
+ (Class)invitedHandlesType;	// IMP=0x0020000000005958
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x0010000000005475
- (void).cxx_destruct;	// IMP=0x0010000000007978
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000753a
- (unsigned long long)hash;	// IMP=0x00100000000071c6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000006edf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000006b3e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000006918
- (void)writeTo:(id)arg1;	// IMP=0x0010000000006685
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000006678
- (id)dictionaryRepresentation;	// IMP=0x0010000000005c6a
- (id)description;	// IMP=0x0010000000005bbb
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x0010000000005b59
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x0010000000005b04
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000000593b
- (unsigned long long)invitedHandlesCount;	// IMP=0x001000000000591e
- (void)addInvitedHandles:(id)arg1;	// IMP=0x00100000000058b4
- (void)clearInvitedHandles;	// IMP=0x0010000000005897
