...
- (void).cxx_destruct;	// IMP=0x001000000007f225
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007f133
- (unsigned long long)hash;	// IMP=0x001000000007f0c6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007efce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007ef0a
- (void)copyTo:(id)arg1;	// IMP=0x001000000007ee87
- (void)writeTo:(id)arg1;	// IMP=0x001000000007ee0d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007ee00
- (id)dictionaryRepresentation;	// IMP=0x001000000007ebcf
- (id)description;	// IMP=0x001000000007eb20
...
- (id)initWithFaceTimeInviteDictionary:(id)arg1;	// IMP=0x0010000000078bf0
- (id)initWithRelayInviteDictionary:(id)arg1;	// IMP=0x0010000000078b22
