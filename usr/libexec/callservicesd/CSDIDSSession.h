...
- (void).cxx_destruct;	// IMP=0x0020000000105000
...
- (void)_updateSessionPreferences;	// IMP=0x0010000000104878
@property(readonly, copy, nonatomic) NSString *UUID;
@property(readonly, copy, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x0010000000104734
- (id)initWithSessionProvider:(id)arg1;	// IMP=0x001000000010469f
- (id)init;	// IMP=0x0010000000104615
