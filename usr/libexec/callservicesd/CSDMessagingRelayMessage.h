...
@interface CSDMessagingRelayMessage : PBCodable
{
    ...
    _Bool _protoSupportsTTYWithVoice;	// 313 = 0x139
    _Bool _protoUplinkMuted;	// 314 = 0x13a
    _Bool _protoVideo;	// 315 = 0x13b
    _Bool _protoVoicemail;	// 316 = 0x13c
    _Bool _protoWantsHoldMusic;	// 317 = 0x13d
    struct {
...
+ (Class)endpointIDSDestinationURIsType;	// IMP=0x0020000000061934
+ (Class)routesType;	// IMP=0x001000000006184d
+ (Class)remoteParticipantHandlesType;	// IMP=0x0010000000060ce0
+ (Class)providersType;	// IMP=0x0010000000060a80
+ (Class)otherUniqueProxyIdentifiersType;	// IMP=0x0010000000060935
+ (Class)protoCallType;	// IMP=0x001000000005fb2d
- (void).cxx_destruct;	// IMP=0x0010000000069ce7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000068a96
- (unsigned long long)hash;	// IMP=0x0010000000067fbf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000673dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000066518
- (void)copyTo:(id)arg1;	// IMP=0x0010000000065b82
- (void)writeTo:(id)arg1;	// IMP=0x0010000000065019
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000006500c
- (id)dictionaryRepresentation;	// IMP=0x0010000000061aee
- (id)description;	// IMP=0x0010000000061a3f
...
- (id)endpointIDSDestinationURIsAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000061917
- (unsigned long long)endpointIDSDestinationURIsCount;	// IMP=0x00100000000618fa
- (void)addEndpointIDSDestinationURIs:(id)arg1;	// IMP=0x0010000000061890
- (void)clearEndpointIDSDestinationURIs;	// IMP=0x0010000000061873
@property(readonly, nonatomic) _Bool hasRoute;
- (id)routesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000061830
- (unsigned long long)routesCount;	// IMP=0x0010000000061813
- (void)addRoutes:(id)arg1;	// IMP=0x00100000000617a9
- (void)clearRoutes;	// IMP=0x001000000006178c
- (int)StringAsRequestActionType:(id)arg1;	// IMP=0x001000000006112c
- (id)requestActionTypeAsString:(int)arg1;	// IMP=0x0010000000060e10
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000060cc3
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x0010000000060ca6
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x0010000000060c3c
- (void)clearRemoteParticipantHandles;	// IMP=0x0010000000060c1f
...
- (id)providersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000060a63
- (unsigned long long)providersCount;	// IMP=0x0010000000060a46
- (void)addProviders:(id)arg1;	// IMP=0x00100000000609dc
- (void)clearProviders;	// IMP=0x00100000000609bf
...
- (id)otherUniqueProxyIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000060918
- (unsigned long long)otherUniqueProxyIdentifiersCount;	// IMP=0x00100000000608fb
- (void)addOtherUniqueProxyIdentifiers:(id)arg1;	// IMP=0x0010000000060891
- (void)clearOtherUniqueProxyIdentifiers;	// IMP=0x0010000000060874
...
- (int)StringAsReceivedMessageType:(id)arg1;	// IMP=0x001000000005ff28
- (id)receivedMessageTypeAsString:(int)arg1;	// IMP=0x001000000005fc0b
@property(nonatomic) _Bool hasReceivedMessageType;
// Error: Property attributes should begin with the type ('T') attribute, property name: receivedMessageType
// Property attributes: (null)

@property(nonatomic) _Bool hasHardPauseState;
@property(readonly, nonatomic) _Bool hasHardPauseDigits;
- (id)protoCallAtIndex:(unsigned long long)arg1;	// IMP=0x001000000005fb10
- (unsigned long long)protoCallsCount;	// IMP=0x001000000005faf3
- (void)addProtoCall:(id)arg1;	// IMP=0x001000000005fa89
- (void)clearProtoCalls;	// IMP=0x001000000005fa6c
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000005f1f8
- (id)typeAsString:(int)arg1;	// IMP=0x001000000005eedb
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x001000000003b52f
...
- (void)addCall:(id)arg1;	// IMP=0x001000000003acf1
...
- (void)customizeForProtocolVersion:(int)arg1;	// IMP=0x0010000000039db1
- (void)addProtocolVersion;	// IMP=0x0010000000039d9a
...
- (void)setService:(int)arg1;	// IMP=0x0010000000039ac3
- (int)service;	// IMP=0x0010000000039ab1
...
- (id)initWithType:(int)arg1 uniqueProxyIdentifier:(id)arg2;	// IMP=0x0010000000038fc9
- (id)initWithType:(int)arg1;	// IMP=0x0010000000038eea
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000038c38
