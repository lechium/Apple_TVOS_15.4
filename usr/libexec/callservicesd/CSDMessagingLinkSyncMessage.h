...
- (void).cxx_destruct;	// IMP=0x0020000000051033
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000050eaf
- (unsigned long long)hash;	// IMP=0x0010000000050dfa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000050c9d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000050b99
- (void)copyTo:(id)arg1;	// IMP=0x0010000000050ad9
- (void)writeTo:(id)arg1;	// IMP=0x0010000000050a11
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000050a04
- (id)dictionaryRepresentation;	// IMP=0x0010000000050439
- (id)description;	// IMP=0x001000000005038a
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000005029c
- (id)typeAsString:(int)arg1;	// IMP=0x001000000005021d
