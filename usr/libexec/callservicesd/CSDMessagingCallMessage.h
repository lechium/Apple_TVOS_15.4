...
- (void).cxx_destruct;	// IMP=0x00100000000fb76b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000fb57a
- (unsigned long long)hash;	// IMP=0x00100000000fb446
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000fb216
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fb0b0
- (void)copyTo:(id)arg1;	// IMP=0x00100000000faf80
- (void)writeTo:(id)arg1;	// IMP=0x00100000000fae35
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000fae28
- (id)dictionaryRepresentation;	// IMP=0x00100000000fa4b9
- (id)description;	// IMP=0x00100000000fa40a
...
- (int)StringAsType:(id)arg1;	// IMP=0x00100000000fa192
- (id)typeAsString:(int)arg1;	// IMP=0x00100000000fa12c
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (void)addProtocolVersion;	// IMP=0x00100000000120a3
...
- (void)setWantsVideo:(_Bool)arg1;	// IMP=0x0010000000011f6d
- (_Bool)wantsVideo;	// IMP=0x0010000000011f5b
