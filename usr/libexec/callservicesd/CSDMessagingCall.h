...
@interface CSDMessagingCall : PBCodable
{
    ...
    _Bool _protoSupportsTTYWithVoice;	// 136 = 0x88
    _Bool _protoUplinkMuted;	// 137 = 0x89
    _Bool _protoVideo;	// 138 = 0x8a
    _Bool _protoVoicemail;	// 139 = 0x8b
    _Bool _protoWantsHoldMusic;	// 140 = 0x8c
    struct {
...
+ (Class)remoteParticipantHandlesType;	// IMP=0x002000000008c4c1
- (void).cxx_destruct;	// IMP=0x00100000000904dd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000008fcd5
- (unsigned long long)hash;	// IMP=0x001000000008f745
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008f01c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008ea42
- (void)copyTo:(id)arg1;	// IMP=0x001000000008e5ea
- (void)writeTo:(id)arg1;	// IMP=0x001000000008e0f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000008e0e4
- (id)dictionaryRepresentation;	// IMP=0x001000000008c6da
- (id)description;	// IMP=0x001000000008c62b
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000008c4a4
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x001000000008c487
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x001000000008c41d
- (void)clearRemoteParticipantHandles;	// IMP=0x001000000008c400
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x0010000000100bb0
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x00100000000ffd8b
- (void)updateRelayCall:(id)arg1;	// IMP=0x00100000000ff8df
...
- (void)setService:(int)arg1;	// IMP=0x00100000000ff3f9
- (int)service;	// IMP=0x00100000000ff3e7
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x00100000000fef10
