...
@class MISSING_TYPE, NSDictionary, NSSet, NSString, NSUUID, TUCallDisplayContext, TUCallProvider, TUHandle;
...
- (void)setLocallyDisconnectedWithReasonIfNone:(int)arg1 stopConference:(_Bool)arg2;	// IMP=0x001000000009362f
- (void)setLocallyDisconnectedWithReasonIfNone:(int)arg1;	// IMP=0x001000000009361b
- (void)setLocallyConnected;	// IMP=0x001000000009358d
- (void)setLocallyConnecting;	// IMP=0x00100000000934fa
- (void)setLocallyHasSentInvitation;	// IMP=0x0010000000093476
- (void)setLocallyHasStartedOutgoing;	// IMP=0x00100000000933de
- (void)becomeEndpointForPullFromRemoteDevice;	// IMP=0x0010000000093380
- (void)sendHardPauseDigits;	// IMP=0x0010000000093334
- (void)playLocalDTMFToneForKey:(unsigned char)arg1;	// IMP=0x00100000000932e3
- (void)unhold;	// IMP=0x00100000000931d7
- (void)hold;	// IMP=0x00100000000930cf
- (void)stopConference;	// IMP=0x0010000000093059
- (void)startConferenceForPulledCallWithTransport:(id)arg1 remoteInviteDictionary:(id)arg2;	// IMP=0x0010000000092d0c
- (void)startConferenceForDialedCallWithTransport:(id)arg1 remoteInviteDictionary:(id)arg2;	// IMP=0x001000000009299b
- (void)startConferenceForAnsweredCallWithTransport:(id)arg1 remoteInviteDictionary:(id)arg2;	// IMP=0x001000000009262a
- (void)disconnectWithReason:(int)arg1;	// IMP=0x0010000000092533
- (void)answerWithRequest:(id)arg1;	// IMP=0x001000000009248f
- (void)dialWithRequest:(id)arg1 displayContext:(id)arg2;	// IMP=0x0010000000092262
- (long long)outputAudioPowerSpectrumToken;	// IMP=0x00100000000921e7
- (long long)inputAudioPowerSpectrumToken;	// IMP=0x001000000009216c
- (void)setIsSendingAudio:(_Bool)arg1;	// IMP=0x00100000000920e7
- (_Bool)isSendingAudio;	// IMP=0x001000000009206c
- (void)setUplinkMuted:(_Bool)arg1;	// IMP=0x0010000000091ede
- (MISSING_TYPE *)isUplinkMuted;	// IMP=0x0010000000091e23
- (void)ungroup;	// IMP=0x0010000000091d06
- (void)groupWithOtherCall:(id)arg1;	// IMP=0x0010000000091b4c
- (void)setHardPauseDigits:(id)arg1;	// IMP=0x0010000000091a42
- (void)setHardPauseDigitsState:(int)arg1;	// IMP=0x001000000009198d
@property(copy, nonatomic) TUCallDisplayContext *displayContext; // @synthesize displayContext=_displayContext;
- (_Bool)supportsDisplayingFaceTimeAudioCalls;	// IMP=0x0010000000091163
@property(readonly, nonatomic) TUCallProvider *localProvider;
- (_Bool)canOnlyBeAnsweredWithoutAudioOrVideoRelayWithRequest:(id)arg1;	// IMP=0x0010000000091027
- (_Bool)canBeAnsweredWithAudioOrVideoRelayWithRequest:(id)arg1;	// IMP=0x0010000000090fcc
- (_Bool)canBeAnsweredWithRequest:(id)arg1;	// IMP=0x0010000000090f29
- (int)callRelaySupport;	// IMP=0x0010000000090e5b
- (long long)audioInterruptionProviderType;	// IMP=0x0010000000090e50
- (long long)audioInterruptionOperationMode;	// IMP=0x0010000000090e45
- (id)audioMode;	// IMP=0x0010000000090dfd
- (id)audioCategory;	// IMP=0x0010000000090db5
- (_Bool)isHostedOnCurrentDevice;	// IMP=0x0010000000090dad
- (id)callUUID;	// IMP=0x0010000000090d9b
- (void)updateWithRelayMessage:(id)arg1;	// IMP=0x0010000000090a30
- (id)initWithRelayMessage:(id)arg1 outgoing:(_Bool)arg2;	// IMP=0x001000000009069a
- (id)initOutgoingWithDialRequest:(id)arg1;	// IMP=0x00100000000905a7
