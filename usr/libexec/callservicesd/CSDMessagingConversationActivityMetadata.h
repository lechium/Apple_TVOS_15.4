...
- (void).cxx_destruct;	// IMP=0x0020000000128796
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001285fb
- (unsigned long long)hash;	// IMP=0x0010000000128516
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000128371
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000128244
- (void)copyTo:(id)arg1;	// IMP=0x001000000012815d
- (void)writeTo:(id)arg1;	// IMP=0x0010000000128079
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000012806c
- (id)dictionaryRepresentation;	// IMP=0x0010000000127bc9
- (id)description;	// IMP=0x0010000000127b1a
