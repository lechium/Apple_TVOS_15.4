...
+ (id)activityContextWithTUActivityContext:(id)arg1;	// IMP=0x001000000003cbb0
- (void).cxx_destruct;	// IMP=0x001000000005db40
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000005da09
- (unsigned long long)hash;	// IMP=0x001000000005d985
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000005d859
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000005d76f
- (void)copyTo:(id)arg1;	// IMP=0x001000000005d6cc
- (void)writeTo:(id)arg1;	// IMP=0x001000000005d635
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000005d628
- (id)dictionaryRepresentation;	// IMP=0x001000000005d3d0
- (id)description;	// IMP=0x001000000005d321
