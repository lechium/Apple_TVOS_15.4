...
- (void).cxx_destruct;	// IMP=0x00100000001279ed
...
- (id)valueForEntitlement:(id)arg1;	// IMP=0x0010000000127944
- (_Bool)isEntitledForCapability:(id)arg1;	// IMP=0x001000000012793c
...
- (void)performBlockAfterCoalescing:(CDUnknownBlockType)arg1;	// IMP=0x0010000000127830
@property(readonly, nonatomic) id objectForBlock;
- (void)performBlock:(CDUnknownBlockType)arg1 coalescedByIdentifier:(id)arg2;	// IMP=0x0010000000127584
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000127516
@property(readonly, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x00100000001273b5
- (id)initWithObject:(id)arg1 queue:(id)arg2;	// IMP=0x00100000001272c6
