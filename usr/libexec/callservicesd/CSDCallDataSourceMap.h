...
- (void).cxx_destruct;	// IMP=0x00200000001267e9
...
- (id)callsForDataSource:(id)arg1 identifier:(id)arg2;	// IMP=0x00100000001266e4
- (void)addCalls:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x00100000001263b7
@property(readonly, copy, nonatomic) NSArray *dataSources;
- (id)init;	// IMP=0x001000000012630a
