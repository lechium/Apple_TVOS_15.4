...
@interface _TtC13callservicesd31CallHistoryNotificationProvider : NSObject
{
    ...
    MISSING_TYPE *dialRecentCall;	// 1937071967 = 0x73755f5f
    ...
    MISSING_TYPE *add;	// 3559156 = 0x364ef4
    MISSING_TYPE *replace;	// 16 = 0x10
    MISSING_TYPE *removeNotification;	// 3559156 = 0x364ef4
    MISSING_TYPE *updateBadgeValue;	// 0 = 0x0
}

- (void).cxx_destruct;	// IMP=0x0040000000241530
- (id)init;	// IMP=0x001000000023c0c0
