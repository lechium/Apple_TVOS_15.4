...
+ (id)callCapabilitiesForCallManagementStateInfo:(id)arg1;	// IMP=0x004000000005e85a
+ (id)callCapabilitiesForCTCallCapabilities:(id)arg1;	// IMP=0x001000000005e77c
...
- (id)debugDescription;	// IMP=0x001000000005eacb
- (id)description;	// IMP=0x001000000005eab9
