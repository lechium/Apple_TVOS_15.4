...
+ (id)participantWithCSDConversationParticipant:(id)arg1;	// IMP=0x0010000000151c93
- (void).cxx_destruct;	// IMP=0x0010000000011d6a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000011aa8
- (unsigned long long)hash;	// IMP=0x00100000000118e3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000115e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000113ff
- (void)copyTo:(id)arg1;	// IMP=0x001000000001124f
- (void)writeTo:(id)arg1;	// IMP=0x0010000000011075
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000011068
- (id)dictionaryRepresentation;	// IMP=0x0010000000010371
- (id)description;	// IMP=0x00100000000102c2
