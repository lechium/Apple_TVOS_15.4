...
- (void).cxx_destruct;	// IMP=0x0020000000094d48
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x0010000000094938
- (id)dequeueAllPauseDigits;	// IMP=0x001000000009483d
- (id)dequeueNextPauseDigits;	// IMP=0x001000000009478e
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000944a6
- (id)initWithDestinationID:(id)arg1;	// IMP=0x001000000009440f
- (id)init;	// IMP=0x0010000000094385
