...
- (void).cxx_destruct;	// IMP=0x0020000000049a73
...
- (id)groupUUID;	// IMP=0x00100000000494e0
- (id)UUID;	// IMP=0x00100000000494ce
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x0010000000049262
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x001000000004913c
