...
@class NSDate, NSSet, NSString, NSURL, NSUUID, TUConversationActivity, TUConversationActivitySession, TUConversationLink, TUConversationMember;
...
- (oneway void)requestScreenShareFromMember:(TUConversationMember *)arg1 conversationUUID:(NSUUID *)arg2;
...
- (oneway void)removeActivitySuggestion:(TUConversationActivity *)arg1;
...
- (oneway void)addActivitySuggestion:(TUConversationActivity *)arg1;
...
- (oneway void)activitySuggestions:(void (^)(NSSet *))arg1;
