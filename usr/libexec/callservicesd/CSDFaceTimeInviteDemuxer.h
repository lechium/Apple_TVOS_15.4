...
- (void).cxx_destruct;	// IMP=0x004000000028a0a0
- (_Bool)destinationIDsCanUseV2Blobs:(id)arg1;	// IMP=0x00100000002892c0
- (void)idsPeersForHandle:(id)arg1 video:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000289230
- (id)init;	// IMP=0x00100000002885a0
