...
- (void).cxx_destruct;	// IMP=0x0040000000238b90
- (id)init;	// IMP=0x0010000000238b30
- (id)initWithStreamToken:(unsigned long long)arg1 requesterID:(id)arg2;	// IMP=0x0010000000238ac0
