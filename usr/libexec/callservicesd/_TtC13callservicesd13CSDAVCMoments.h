...
- (void).cxx_destruct;	// IMP=0x004000000029fd50
- (id)init;	// IMP=0x001000000029fcf0
- (id)newRequestWithMediaType:(unsigned char)arg1 mode:(unsigned char)arg2 requesteeID:(id)arg3;	// IMP=0x001000000029fc70
...
- (id)initWithStreamToken:(long long)arg1 requesterID:(id)arg2 delegate:(id)arg3 dispatchQueue:(id)arg4;	// IMP=0x001000000029fa80
