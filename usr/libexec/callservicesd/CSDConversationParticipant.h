...
- (void).cxx_destruct;	// IMP=0x00200000001262c1
...
- (unsigned long long)hash;	// IMP=0x0010000000125e81
- (_Bool)isEqualToParticipant:(id)arg1;	// IMP=0x0010000000125a6e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000125a11
- (_Bool)pseudonym;	// IMP=0x00100000001259a3
...
- (id)description;	// IMP=0x0010000000125283
- (id)initWithIDSDictionaryRepresentation:(id)arg1;	// IMP=0x00100000001250c7
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3;	// IMP=0x0010000000124f86
