...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000034fbd
- (unsigned long long)hash;	// IMP=0x0010000000034ee7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000034d0d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000034c13
- (void)copyTo:(id)arg1;	// IMP=0x0010000000034b3c
- (void)writeTo:(id)arg1;	// IMP=0x0010000000034a29
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000034a1c
- (id)dictionaryRepresentation;	// IMP=0x0010000000034228
- (id)description;	// IMP=0x0010000000034179
