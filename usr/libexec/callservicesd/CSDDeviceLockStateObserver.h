...
- (void).cxx_destruct;	// IMP=0x0020000000122ff7
...
- (void)performBlockAfterFirstUnlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000122d17
- (void)_handleDeviceFirstUnlockNotification;	// IMP=0x0010000000122b47
- (void)_refreshHasBeenUnlocked;	// IMP=0x00100000001229fb
- (id)initWithQueue:(id)arg1;	// IMP=0x00100000001229e4
- (id)initWithNotifyObserver:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000122835
