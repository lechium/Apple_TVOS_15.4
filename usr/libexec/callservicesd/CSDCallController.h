...
- (void).cxx_destruct;	// IMP=0x00400000001e1b10
- (id)init;	// IMP=0x00100000001e1ab0
- (void)registerCall:(id)arg1;	// IMP=0x00100000001e1920
- (id)initWithDataSources:(id)arg1 queue:(id)arg2;	// IMP=0x00100000001e16e0
