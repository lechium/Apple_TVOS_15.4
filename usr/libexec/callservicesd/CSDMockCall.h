...
@interface CSDMockCall
{
    ...
    _Bool _mockSOS;	// 16 = 0x10
    _Bool _mockOutgoing;	// 17 = 0x11
    _Bool _mockConferenced;	// 18 = 0x12
    _Bool _mockUsingBaseband;	// 19 = 0x13
    _Bool _mockSupportsTTYWithVoice;	// 20 = 0x14
    _Bool _mockNeedsManualInCallSounds;	// 21 = 0x15
    _Bool _mockHasStartedOutgoing;	// 22 = 0x16
    _Bool _mockHasSentInvitation;	// 23 = 0x17
    _Bool _mockConnecting;	// 24 = 0x18
    _Bool _mockConnected;	// 25 = 0x19
    _Bool _mockUplinkMuted;	// 26 = 0x1a
    _Bool _mockUplinkWasExplicitlyMuted;	// 27 = 0x1b
    _Bool _mockMayRequireBreakBeforeMake;	// 28 = 0x1c
    _Bool _mockPrefersExclusiveAccessToCellularNetwork;	// 29 = 0x1d
    _Bool _mockIsThirdPartyVideo;	// 30 = 0x1e
    _Bool _mockShouldSuppressInCallUI;	// 31 = 0x1f
    _Bool _mockKnownCaller;	// 32 = 0x20
    _Bool _mockConversation;	// 33 = 0x21
    ...
    MISSING_TYPE *_mockDisplayContext;	// 184 = 0xb8
...
+ (id)mockCallFromBlock:(CDUnknownBlockType)arg1;	// IMP=0x0040000000163286
+ (id)mockCall;	// IMP=0x0010000000163272
- (void).cxx_destruct;	// IMP=0x00200000001642d3
...
- (void)disconnectWithReason:(int)arg1;	// IMP=0x0010000000163b05
- (void)dialWithRequest:(id)arg1 displayContext:(id)arg2;	// IMP=0x0010000000163989
- (void)answerWithRequest:(id)arg1;	// IMP=0x00100000001638b8
- (void)unhold;	// IMP=0x00100000001638a1
- (void)hold;	// IMP=0x001000000016388a
- (void)setEndpointOnCurrentDevice:(_Bool)arg1;	// IMP=0x0010000000163878
- (void)updateWithCall:(id)arg1;	// IMP=0x001000000016339b
- (id)initWithUniqueProxyIdentifier:(id)arg1;	// IMP=0x00100000001632ca
