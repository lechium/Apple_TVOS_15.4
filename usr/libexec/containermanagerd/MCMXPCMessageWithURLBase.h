...
- (void).cxx_destruct;	// IMP=0x002000000009d81f
@property(readonly, nonatomic) NSURL *url; // @synthesize url=_url;
- (id)initWithXPCObject:(id)arg1 clientConnection:(id)arg2 userIdentityCache:(id)arg3 error:(unsigned long long *)arg4;	// IMP=0x001000000009d714
