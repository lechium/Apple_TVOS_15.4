...
- (void).cxx_destruct;	// IMP=0x00200000000a4dda
...
- (id)initWithContainers:(id)arg1 resolvedLinks:(id)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4;	// IMP=0x00100000000a4cd2
- (_Bool)encodeReplyOntoXPCObject:(id)arg1;	// IMP=0x00100000000a4944
