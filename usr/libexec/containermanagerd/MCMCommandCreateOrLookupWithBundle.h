...
+ (Class)incomingMessageClass;	// IMP=0x002000000009bfd4
+ (unsigned long long)command;	// IMP=0x001000000009bfc9
- (void).cxx_destruct;	// IMP=0x002000000009bf87
...
- (_Bool)fromQueue:(id)arg1 executeWithError:(unsigned long long *)arg2;	// IMP=0x001000000009b913
- (id)initWithMessage:(id)arg1 clientIdentity:(id)arg2 userIdentityCache:(id)arg3;	// IMP=0x001000000009b7c5
- (id)initWithCreateIfNecessary:(_Bool)arg1 transient:(_Bool)arg2 issueSandboxExtension:(_Bool)arg3 sandboxToken:(const char *)arg4 bundleURL:(id)arg5 executableURL:(id)arg6 userIdentityCache:(id)arg7;	// IMP=0x001000000009b6c9
