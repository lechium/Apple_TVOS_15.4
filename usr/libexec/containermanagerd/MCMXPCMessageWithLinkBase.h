...
- (void).cxx_destruct;	// IMP=0x002000000006a8d3
@property(readonly, nonatomic) MCMResolvedLink *link; // @synthesize link=_link;
- (id)initWithXPCObject:(id)arg1 clientConnection:(id)arg2 userIdentityCache:(id)arg3 error:(unsigned long long *)arg4;	// IMP=0x001000000006a701
