...
- (void).cxx_destruct;	// IMP=0x0020000000019c5a
...
- (_Bool)canBeHandledLocally;	// IMP=0x0010000000019ae4
- (id)initWithXPCObject:(id)arg1 clientConnection:(id)arg2 userIdentityCache:(id)arg3 error:(unsigned long long *)arg4;	// IMP=0x00100000000192af
