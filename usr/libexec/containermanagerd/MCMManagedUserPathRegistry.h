...
- (void).cxx_destruct;	// IMP=0x0020000000079d0e
...
- (void)_initPathPropertiesWithUserHomeDirectoryURL:(id)arg1 clientUser:(id)arg2;	// IMP=0x0010000000079b89
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x0010000000079a1b
