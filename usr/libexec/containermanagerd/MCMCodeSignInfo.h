...
- (void).cxx_destruct;	// IMP=0x002000000000c3e1
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x001000000000c092
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x001000000000c047
