...
- (void).cxx_destruct;	// IMP=0x002000000007997a
...
- (void);	// IMP=0x001000000007951b
- (void)_addPaths:(id)arg1;	// IMP=0x00100000000794e5
- (id)managedPathForURL:(id)arg1;	// IMP=0x00100000000792fd
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x0010000000078f66
- (id)initWithDaemonUser:(id)arg1;	// IMP=0x0010000000078e2e
