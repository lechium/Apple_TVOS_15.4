...
- (void).cxx_destruct;	// IMP=0x00200000000a31af
...
- (id)initWithXPCObject:(id)arg1 clientConnection:(id)arg2 userIdentityCache:(id)arg3 error:(unsigned long long *)arg4;	// IMP=0x00100000000a2f2d
