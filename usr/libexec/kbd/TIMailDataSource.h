...
+ (id)searchCriterionForSenderAddresses:(id)arg1;	// IMP=0x00200000000069db
- (void).cxx_destruct;	// IMP=0x002000000000756d
...
- (void)search:(id)arg1 didFinishWithError:(id)arg2;	// IMP=0x00100000000073a8
- (_Bool)search:(id)arg1 didFindResults:(id)arg2;	// IMP=0x001000000000704a
- (id)nextOutgoingMessageBatch;	// IMP=0x0010000000006f01
- (void)searchMailWithSenderAddresses:(id)arg1;	// IMP=0x0010000000006d4d
- (void)searchAccounts:(id)arg1;	// IMP=0x00100000000067da
- (void)initializeSearchIfNecessary;	// IMP=0x00100000000064fc
- (id)init;	// IMP=0x00100000000064a2
- (void)dealloc;	// IMP=0x0010000000006448
