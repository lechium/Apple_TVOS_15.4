...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000067e20
- (void).cxx_destruct;	// IMP=0x0020000000067d89
...
- (id)description;	// IMP=0x0010000000067c5d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000067bc5
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000067ae9
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x001000000006798f
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000006792d
- (id)init;	// IMP=0x00100000000678ed
