...
- (void).cxx_destruct;	// IMP=0x00200000000cc8e8
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000cc838
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000cc795
