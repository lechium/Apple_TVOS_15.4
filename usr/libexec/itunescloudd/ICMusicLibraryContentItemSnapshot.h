...
- (void).cxx_destruct;	// IMP=0x0020000000057024
...
- (id)debugDescription;	// IMP=0x0010000000056e39
- (_Bool)isValid;	// IMP=0x0010000000056e30
- (id)initWithSong:(id)arg1;	// IMP=0x0010000000056a8c
