...
- (void).cxx_destruct;	// IMP=0x00200000000e27b4
...
- (void)_clearAllCloudIDs;	// IMP=0x00100000000e2530
- (id)_determineResultsURLWhenReadyWithUpdateID:(id)arg1 retryTimeout:(double)arg2 responseStatusCode:(out long long *)arg3;	// IMP=0x00100000000e1eff
- (_Bool)_updateLibrary;	// IMP=0x00100000000e0bf5
- (void)_prepareLibraryForInitialUpdate;	// IMP=0x00100000000e0af2
- (_Bool)_uploadLibrary;	// IMP=0x00100000000dddb6
- (_Bool)_ensureDeviceIsRegistered;	// IMP=0x00100000000ddc9b
- (void)main;	// IMP=0x00100000000dc41a
- (void)cancel;	// IMP=0x00100000000dc2d0
@property(readonly, nonatomic) float progress;
@property(readonly, nonatomic, getter=isInitialUpdate) _Bool initialUpdate;
- (void)dealloc;	// IMP=0x00100000000dc260
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 reason:(long long)arg3 updateTaskHelper:(id)arg4;	// IMP=0x00100000000dc1cb
