...
- (void).cxx_destruct;	// IMP=0x00200000000751ee
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007505a
- (unsigned long long)hash;	// IMP=0x0010000000074f84
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000074dea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000074cbf
- (void)writeTo:(id)arg1;	// IMP=0x0010000000074bd8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000748ea
- (id)dictionaryRepresentation;	// IMP=0x0010000000074755
- (id)description;	// IMP=0x00100000000746a6
