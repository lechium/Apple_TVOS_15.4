...
- (void).cxx_destruct;	// IMP=0x002000000009932a
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x0010000000098f0a
- (void)cancel;	// IMP=0x0010000000098e9b
- (void)start;	// IMP=0x00100000000987e0
- (id)description;	// IMP=0x0010000000098710
- (void)callCompletionHandlers;	// IMP=0x0010000000098584
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000984e6
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000983bc
