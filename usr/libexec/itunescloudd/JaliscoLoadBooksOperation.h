...
- (void).cxx_destruct;	// IMP=0x00200000000a05c6
...
- (id)metadataFilter;	// IMP=0x00100000000a053c
- (id)queryFilter;	// IMP=0x00100000000a04cf
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000a04ac
- (void)main;	// IMP=0x001000000009fdde
