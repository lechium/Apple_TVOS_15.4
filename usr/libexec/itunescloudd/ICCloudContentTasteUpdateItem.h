...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000084bea
- (void).cxx_destruct;	// IMP=0x0020000000084bac
...
- (unsigned long long)hash;	// IMP=0x001000000008191c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000081816
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000081740
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000815b4
- (id)description;	// IMP=0x00100000000814c2
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x0010000000081377
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x0010000000081244
