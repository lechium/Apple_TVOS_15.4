...
- (void).cxx_destruct;	// IMP=0x0020000000087541
...
- (_Bool)_updateGlobalPlaylistsFromContainersPayloadAtPath:(id)arg1 downloadPathForSubscribedContainersPayload:(id)arg2 clientIdentity:(id)arg3;	// IMP=0x00100000000872b0
- (void)_importLyricsWithLyricsTokenMap:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x001000000008716b
- (void)_removeUnavailableSubscriptionAssetsInLibrary:(id)arg1;	// IMP=0x00100000000870e4
- (void)importTracksFromRevision:(unsigned int)arg1 toRevision:(unsigned int)arg2 clientIdentity:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000856c8
- (void)cancel;	// IMP=0x00100000000855f9
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000854c1
