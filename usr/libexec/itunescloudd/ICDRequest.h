...
+ (id)request;	// IMP=0x00400000000ece01
- (void).cxx_destruct;	// IMP=0x00200000000ecd55
...
- (id)_HTTPMethodStringForICDRequestMethod:(long long)arg1;	// IMP=0x00100000000ecc79
@property(readonly, nonatomic) _Bool acceptsGzipEncoding;
- (id)canonicalResponseForResponse:(id)arg1;	// IMP=0x00100000000ecc64
- (id)URLRequestForBaseURL:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x00100000000ecb05
- (id)requestURLForBaseURL:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x00100000000ec93a
- (void)setValue:(id)arg1 forArgument:(id)arg2;	// IMP=0x00100000000ec8ba
@property(readonly, nonatomic) double timeoutInterval;
- (id)description;	// IMP=0x00100000000ec7ff
- (id)initWithAction:(id)arg1;	// IMP=0x00100000000ec784
