...
@interface SagaImportControllerParserDelegate : NSObject
{
    ...
    MISSING_TYPE *_currentItemCount;	// 16 = 0x10
...
- (void).cxx_destruct;	// IMP=0x00200000000f7526
...
- (void)parser:(id)arg1 didEndContainerCode:(unsigned int)arg2;	// IMP=0x00100000000f7423
- (void)parser:(id)arg1 didParseDataCode:(unsigned int)arg2 bytes:(char *)arg3 contentLength:(unsigned int)arg4;	// IMP=0x00100000000f7317
- (void)parser:(id)arg1 didStartContainerCode:(unsigned int)arg2 contentLength:(unsigned int)arg3;	// IMP=0x00100000000f72e5
- (_Bool)parser:(id)arg1 shouldParseCodeAsContainer:(unsigned int)arg2;	// IMP=0x00100000000f72b1
- (_Bool)parser:(id)arg1 shouldParseCode:(unsigned int)arg2;	// IMP=0x00100000000f7239
- (void)parserDidStart:(id)arg1;	// IMP=0x00100000000f721b
- (id)init;	// IMP=0x00100000000f71b5
