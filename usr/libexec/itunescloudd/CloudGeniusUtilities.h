...
- (void).cxx_destruct;	// IMP=0x00200000000765b1
...
- (void)_initializeMappings;	// IMP=0x00100000000753c3
- (id)geniusValueForML3ContainerProperty:(id)arg1 value:(id)arg2;	// IMP=0x001000000007533e
- (id)geniusPlaylistPropertyForML3ContainerProperty:(id)arg1;	// IMP=0x0010000000075328
- (id)geniusValueForML3TrackProperty:(id)arg1 value:(id)arg2;	// IMP=0x00100000000752a3
- (id)geniusTrackPropertyForML3TrackProperty:(id)arg1;	// IMP=0x001000000007528d
- (id)init;	// IMP=0x0010000000075241
