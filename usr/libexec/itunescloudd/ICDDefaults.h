...
+ (id)daemonDefaults;	// IMP=0x002000000001d29e
- (void).cxx_destruct;	// IMP=0x002000000001d276
...
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000001d19e
- (id)_init;	// IMP=0x001000000001d0ae
