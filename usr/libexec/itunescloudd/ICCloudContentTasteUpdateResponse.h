...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x004000000003443f
- (void).cxx_destruct;	// IMP=0x0020000000034417
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x0010000000034322
