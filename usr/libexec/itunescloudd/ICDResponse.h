...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x0040000000080339
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x001000000008027c
- (void).cxx_destruct;	// IMP=0x0020000000080233
...
- (id)description;	// IMP=0x0010000000080144
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x0010000000080029
