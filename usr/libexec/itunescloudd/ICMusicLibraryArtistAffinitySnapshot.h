...
- (void).cxx_destruct;	// IMP=0x0020000000059fff
...
- (id)debugDescription;	// IMP=0x0010000000059db7
- (float)legacyScore;	// IMP=0x0010000000059ca5
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x00100000000599b2
