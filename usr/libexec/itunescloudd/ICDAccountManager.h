...
- (void).cxx_destruct;	// IMP=0x00200000000e5089
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x00100000000e4f91
- (id)_buildStateChange;	// IMP=0x00100000000e4d95
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000000e489b
- (void)updateState;	// IMP=0x00100000000e46a0
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000000e4448
