...
- (void)_adjustOperationQueueStatusForMediaDownloads;	// IMP=0x00100000000ca6cd
- (void)downloadManager:(id)arg1 didCancelAssets:(id)arg2;	// IMP=0x00100000000ca6bb
- (void)downloadManager:(id)arg1 didFinishAsset:(id)arg2 withError:(id)arg3;	// IMP=0x00100000000ca6a9
- (void)downloadManager:(id)arg1 didUpdateDownloadProgress:(id)arg2;	// IMP=0x00100000000ca697
- (void)downloadManager:(id)arg1 didEnqueueAssetDownloads:(id)arg2 didRemoveAssetDownloads:(id)arg3;	// IMP=0x00100000000ca685
- (void)cancelAllImports;	// IMP=0x00100000000ca671
- (void)cancelAllImportsAndWaitForOperationsToFinish:(_Bool)arg1;	// IMP=0x00100000000ca5ba
- (void)increasePriorityForAllOperations;	// IMP=0x00100000000ca549
- (void)decreasePriorityForAllOperations;	// IMP=0x00100000000ca4d8
- (void)deprioritizeImportArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2;	// IMP=0x00100000000ca451
- (void)importCloudArtworkForRequests:(id)arg1;	// IMP=0x00100000000ca39a
- (void)importArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2 token:(id)arg3 mediaType:(unsigned int)arg4 allowsCellularData:(_Bool)arg5 clientIdentity:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000ca230
- (void)dealloc;	// IMP=0x00100000000ca128
- (id)initWithConfiguration:(id)arg1 sourceType:(long long)arg2;	// IMP=0x00100000000c9c42
