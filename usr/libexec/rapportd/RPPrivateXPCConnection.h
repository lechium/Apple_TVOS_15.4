...
- (void).cxx_destruct;	// IMP=0x0020000000064135
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000063fb2
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000063e9e
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000063da4
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000063c90
- (void)xpcConnectionInvalidated;	// IMP=0x0010000000063b0d
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x00100000000639e8
