...
- (void).cxx_destruct;	// IMP=0x002000000000916c
...
- (void)home:(id)arg1 didUpdateRoom:(id)arg2 forAccessory:(id)arg3;	// IMP=0x0010000000008e70
- (void)user:(id)arg1 didUpdateAssistantAccessControl:(id)arg2 forHome:(id)arg3;	// IMP=0x0010000000008cac
- (void)_setupHome;	// IMP=0x0010000000008ae0
- (_Bool)personalRequestsStateForAccessory:(id)arg1;	// IMP=0x001000000000866c
- (id)homeHubDeviceWithIdentifier:(id)arg1;	// IMP=0x00100000000085e5
- (void)resetHomeKitUserIdentifiers;	// IMP=0x00100000000085bb
- (id)filterHomeKitUserIdentifiers:(id)arg1;	// IMP=0x0010000000008018
- (id)homeKitUserIdentifiers;	// IMP=0x0010000000007cfa
- (void)invalidate;	// IMP=0x0010000000007bf1
- (id)initWithQueue:(id)arg1;	// IMP=0x0010000000007b1d
