...
- (void).cxx_destruct;	// IMP=0x0020000000061f01
...
- (id)description;	// IMP=0x0010000000061dc4
- (void)invalidate;	// IMP=0x0010000000061b46
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000061948
