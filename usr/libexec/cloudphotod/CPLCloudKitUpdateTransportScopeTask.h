...
- (void).cxx_destruct;	// IMP=0x00200000000b72e9
...
- (void)runOperations;	// IMP=0x00100000000b6f0b
- (id)_errorForUpdateError:(id)arg1;	// IMP=0x00100000000b6daf
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 scopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000b6ca2
