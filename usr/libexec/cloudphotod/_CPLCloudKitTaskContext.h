...
- (void).cxx_destruct;	// IMP=0x00200000000a7435
...
- (_Bool)_operationAllowsCellular:(id)arg1;	// IMP=0x00100000000a67ec
- (id)_priorityDescriptionForOperation:(id)arg1;	// IMP=0x00100000000a66db
...
- (void)cancelAllOperations;	// IMP=0x00100000000a6596
- (id)contextForOperation:(id)arg1;	// IMP=0x00100000000a6580
- (_Bool)hasBlockedOperationsIncludingBackground:(_Bool)arg1;	// IMP=0x00100000000a632d
- (void)operationDidFinish:(id)arg1;	// IMP=0x00100000000a62a0
- (void)operationWillStart:(id)arg1 context:(id)arg2;	// IMP=0x00100000000a6200
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000a6139
