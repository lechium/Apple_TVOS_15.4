...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x00400000000ca429
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x00100000000ca3d4
- (void).cxx_destruct;	// IMP=0x00200000000ca726
...
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x00100000000ca4bd
