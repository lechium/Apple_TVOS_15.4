...
- (void).cxx_destruct;	// IMP=0x00200000000df861
...
- (void)runOperations;	// IMP=0x00100000000dea77
- (void)_checkRecordsExistenceWithOperationType:(long long)arg1 recordIDsToCPLRecord:(id)arg2 recordsToCheckOnly:(id)arg3 recordsToFetch:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000dd55d
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 additionalTransportScopes:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000dd448
