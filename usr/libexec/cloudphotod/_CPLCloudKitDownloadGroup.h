...
- (void).cxx_destruct;	// IMP=0x00200000000ca32b
...
- (id)description;	// IMP=0x00100000000ca1f6
@property(readonly, nonatomic) NSString *resourceTypeDescription;
- (id)propertyKeys;	// IMP=0x00100000000ca1b6
- (id)cloudResourceForRecordWithScopedIdentifier:(id)arg1;	// IMP=0x00100000000ca138
- (void)enumerateRecordScopedIdentifiersAndTasksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000ca034
...
- (_Bool)cancelDownloadTask:(id)arg1;	// IMP=0x00100000000c9b80
- (void)allDownloadsDidFailWithError:(id)arg1;	// IMP=0x00100000000c9970
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didFailToDownloadWithError:(id)arg2;	// IMP=0x00100000000c975e
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didDownloadCKAsset:(id)arg2 withOperationType:(long long)arg3 transcoderVersion:(long long)arg4 withFingerPrint:(id)arg5 andFileUTI:(id)arg6;	// IMP=0x00100000000c8a17
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didProgress:(double)arg2;	// IMP=0x00100000000c87b2
- (void)resourceWithRecordScopedIdentifierDidStart:(id)arg1 operationID:(id)arg2;	// IMP=0x00100000000c85fc
- (void)allDownloadsDidStartWithOperationID:(id)arg1;	// IMP=0x00100000000c849d
- (_Bool)addDownloadTask:(id)arg1;	// IMP=0x00100000000c809a
- (id)initWithResourceType:(unsigned long long)arg1;	// IMP=0x00100000000c7fcd
