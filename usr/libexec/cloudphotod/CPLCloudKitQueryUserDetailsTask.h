...
- (void).cxx_destruct;	// IMP=0x00200000000e78db
- (void)queryUserDetailsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000e6ffa
- (void)runOperations;	// IMP=0x00100000000e6f79
- (id)initWithController:(id)arg1 participants:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000e6ebc
