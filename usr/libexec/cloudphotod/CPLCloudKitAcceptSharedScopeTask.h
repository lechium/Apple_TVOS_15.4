...
- (void).cxx_destruct;	// IMP=0x002000000009f255
- (void)_acceptShareWithMetadata:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000009eb43
- (void)_fetchMetadataForShareURL:(id)arg1 currentUserID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000009db2d
- (void)_acceptShareWithURL:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000009d9e0
- (void)_udpateScopeAndFlagsWithCKRecord:(id)arg1 currentUserID:(id)arg2;	// IMP=0x001000000009d8d7
- (void)runOperations;	// IMP=0x001000000009d2da
- (id)initWithController:(id)arg1 scope:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000009d21d
