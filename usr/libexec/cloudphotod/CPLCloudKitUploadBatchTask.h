...
+ (void)initialize;	// IMP=0x00200000000cf45d
- (void).cxx_destruct;	// IMP=0x00200000000d2be8
...
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000cfc1c
- (void)runOperations;	// IMP=0x00100000000cfb9a
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 additionalTransportScopes:(id)arg4 progressHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000000cf4ae
