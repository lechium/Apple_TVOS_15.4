...
- (void).cxx_destruct;	// IMP=0x00200000000ba8ab
- (id)_scopeChangeFromShareMetadata:(id)arg1 currentUserID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000ba435
- (void)_fetchSharedScopeWithCurrentUserID:(id)arg1;	// IMP=0x00100000000b99ad
- (void)runOperations;	// IMP=0x00100000000b992c
- (id)initWithController:(id)arg1 shareURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b986f
