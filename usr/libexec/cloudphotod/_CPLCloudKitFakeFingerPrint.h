...
- (void).cxx_destruct;	// IMP=0x0020000000096b87
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x001000000009682e
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x001000000009650a
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x00100000000964b4
