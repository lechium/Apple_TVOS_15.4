...
- (void).cxx_destruct;	// IMP=0x00200000000e634e
- (_Bool)isOngoing;	// IMP=0x00100000000e6331
- (id)status;	// IMP=0x00100000000e5a50
- (id)statusObject;	// IMP=0x00100000000e5721
- (void)endTask:(id)arg1 withOperationClasses:(id)arg2 operationsAllowingCellular:(id)arg3;	// IMP=0x00100000000e528c
- (_Bool)beginTask:(id)arg1;	// IMP=0x00100000000e51c6
- (id)init;	// IMP=0x00100000000e50f8
