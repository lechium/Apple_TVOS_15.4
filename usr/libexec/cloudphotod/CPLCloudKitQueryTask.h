...
- (void).cxx_destruct;	// IMP=0x00200000000943e9
...
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x0010000000092a89
- (void);	// IMP=0x0010000000092a07
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x001000000009298d
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 cloudKitScope:(id)arg4 scope:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000927d6
