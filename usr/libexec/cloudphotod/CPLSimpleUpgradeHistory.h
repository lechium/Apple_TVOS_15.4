...
- (void).cxx_destruct;	// IMP=0x002000000006177d
...
- (void)resetVersionHasChanged;	// IMP=0x00100000000613e3
...
- (void)noteDatabaseWasUpgradedToVersion:(long long)arg1 fromVersion:(long long)arg2;	// IMP=0x0010000000061092
- (id)_valueForKey:(id)arg1 class:(Class)arg2;	// IMP=0x0010000000061037
- (id)initWithLibraryIdentifier:(id)arg1;	// IMP=0x00100000000606d8
- (void)_save;	// IMP=0x00100000000605b4
- (id)_defaultsKey;	// IMP=0x0010000000060597
