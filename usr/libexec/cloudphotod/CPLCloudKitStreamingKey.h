...
- (void).cxx_destruct;	// IMP=0x00200000000dd3a1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000dd1b3
- (unsigned long long)hash;	// IMP=0x00100000000dd19d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dd192
- (id)initWithRecordID:(id)arg1 resourceKey:(id)arg2 fingerPrint:(id)arg3 filename:(id)arg4 groupName:(id)arg5 timeRange:(CDStruct_e83c9415)arg6;	// IMP=0x00100000000dd044
