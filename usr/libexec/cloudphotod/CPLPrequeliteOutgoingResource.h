...
- (void).cxx_destruct;	// IMP=0x002000000003af3a
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x001000000003ad95
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x001000000003ac8a
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x001000000003a9c1
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003a86d
