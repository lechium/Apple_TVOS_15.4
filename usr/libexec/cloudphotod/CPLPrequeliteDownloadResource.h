...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x0010000000049e49
- (id)initWithResource:(id)arg1;	// IMP=0x0010000000049c86
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000049b00
