...
+ (id)variableWithName:(id)arg1 forTable:(id)arg2 type:(id)arg3;	// IMP=0x0020000000044f5b
+ (id)variableWithName:(id)arg1 type:(id)arg2;	// IMP=0x0010000000044f44
+ (id)indexVariableForVariableWithName:(id)arg1 forTable:(id)arg2;	// IMP=0x0010000000044976
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 forTable:(id)arg3 type:(id)arg4;	// IMP=0x00100000000448cc
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 type:(id)arg3;	// IMP=0x001000000004483e
- (void).cxx_destruct;	// IMP=0x0020000000045265
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000045172
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000045151
- (id)columnDefinitionWithDefaultValue:(id)arg1;	// IMP=0x0010000000044f89
@property(readonly, nonatomic) id <PQLInjecting> columnDefinition;
- (id)valueFromSet:(id)arg1 atIndex:(int)arg2;	// IMP=0x0010000000044ea7
- (id)bindableValueForValue:(id)arg1;	// IMP=0x0010000000044e10
- (void)discardCachedValue;	// IMP=0x0010000000044dd7
- (void)setCachedValue:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000044d64
- (id)cachedValueForIdentifier:(id)arg1;	// IMP=0x0010000000044d05
- (_Bool)hasCachedValueForIdentifier:(id)arg1;	// IMP=0x0010000000044cba
- (id)redactedDescription;	// IMP=0x0010000000044c71
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000044bf7
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1 defaultValue:(id)arg2 table:(id)arg3 type:(id)arg4;	// IMP=0x0010000000044a30
