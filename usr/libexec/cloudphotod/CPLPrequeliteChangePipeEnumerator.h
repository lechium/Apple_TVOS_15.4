...
- (void).cxx_destruct;	// IMP=0x002000000002ed35
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ebab
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x001000000002ea69
