...
- (void).cxx_destruct;	// IMP=0x002000000008d48a
...
- (void)runOperations;	// IMP=0x001000000008baec
- (void)createRecordZoneWithID:(id)arg1;	// IMP=0x001000000008b4a4
- (void)_callCompletionWithZone:(id)arg1;	// IMP=0x001000000008b329
- (void)_updateCloudKitScopeWithZone:(id)arg1;	// IMP=0x001000000008b209
- (id)initWithController:(id)arg1 scope:(id)arg2 cloudKitScope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000008b0f6
