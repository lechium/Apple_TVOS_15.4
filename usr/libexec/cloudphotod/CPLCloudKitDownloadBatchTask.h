...
- (void).cxx_destruct;	// IMP=0x00200000000a1170
...
- (void)_downloadBatchWithCurrentUserID:(id)arg1;	// IMP=0x001000000009f67b
- (void)runOperations;	// IMP=0x001000000009f5f8
- (void)sendProgressBatch:(id)arg1 updatedScopeChange:(id)arg2 updatedFlags:(id)arg3 updatedSyncAnchor:(id)arg4;	// IMP=0x001000000009f4f5
- (id)initWithController:(id)arg1 syncAnchor:(id)arg2 cloudKitScope:(id)arg3 scope:(id)arg4 currentScopeChange:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000009f327
