...
- (void).cxx_destruct;	// IMP=0x00200000000b0796
- (void)runOperations;	// IMP=0x00100000000b0030
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x00100000000affb4
- (double)timeoutIntervalForRequest;	// IMP=0x00100000000affa6
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000afeeb
