...
- (void).cxx_destruct;	// IMP=0x00200000000c7f69
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(copy, nonatomic) NSArray *downloadTasks; // @synthesize downloadTasks=_downloadTasks;
- (void)runOperations;	// IMP=0x00100000000c7bc1
- (void)_downloadNextGroup;	// IMP=0x00100000000c75e6
- (MISSING_TYPE *)_downloadNextOperationType;	// IMP=0x00100000000c74e4
- (void)_downloadCurrentGroup;	// IMP=0x00100000000c57fd
- (id)_downloadOperationWithRecordIDsAndTasks:(id)arg1 keys:(id)arg2 perRecordProgressBlock:(CDUnknownBlockType)arg3 perRecordCompletionBlock:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x00100000000c51e6
- (void)_finishRemainingTasksWithError:(id)arg1;	// IMP=0x00100000000c4fb7
- (void)cancelDownloadTask:(id)arg1;	// IMP=0x00100000000c4da1
- (id)initWithController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c4cfb
