...
- (void).cxx_destruct;	// IMP=0x002000000008da5f
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) NSArray *messages; // @synthesize messages=_messages;
- (void)runOperations;	// IMP=0x001000000008d616
- (id)initWithController:(id)arg1 messages:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000008d53a
