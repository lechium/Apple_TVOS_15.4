...
- (void).cxx_destruct;	// IMP=0x00200000000dcfe0
...
- (void)runOperations;	// IMP=0x00100000000dc47e
- (id)_streamOperationForKey:(id)arg1 operationType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000dbddb
- (id)initWithController:(id)arg1 resource:(id)arg2 hints:(id)arg3 timeRange:(CDStruct_e83c9415)arg4 transportScope:(id)arg5 cache:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000dbc4d
