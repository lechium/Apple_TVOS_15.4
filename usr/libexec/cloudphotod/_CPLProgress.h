...
- (void)unpublish;	// IMP=0x001000000002e882
- (void)publish;	// IMP=0x001000000002e85b
- (void)_publishRealProgressIfNecessary;	// IMP=0x001000000002e730
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000002e69f
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x001000000002e4df
