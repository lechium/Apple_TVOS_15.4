...
- (void).cxx_destruct;	// IMP=0x0020000000052cc4
...
- (id)resource;	// IMP=0x0010000000052ade
- (id)initWithResource:(id)arg1;	// IMP=0x00100000000528f8
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005277d
