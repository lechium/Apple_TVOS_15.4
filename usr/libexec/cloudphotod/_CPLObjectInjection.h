...
- (void).cxx_destruct;	// IMP=0x0020000000046574
...
- (id)bindValuesToKeepAlive;	// IMP=0x0010000000046548
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x0010000000046270
- (id)initWithVariables:(id)arg1 object:(id)arg2 sql:(id)arg3;	// IMP=0x00100000000461b9
