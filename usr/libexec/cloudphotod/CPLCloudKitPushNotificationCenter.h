...
- (void).cxx_destruct;	// IMP=0x002000000000517d
...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004b48
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003d67
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003cee
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x0010000000003bbf
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x0010000000003644
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x001000000000355e
- (void)unregisterFromPushNotifications;	// IMP=0x00100000000034c7
- (void)stopWaitingForPushNotifications;	// IMP=0x00100000000033e1
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x0010000000002d4d
