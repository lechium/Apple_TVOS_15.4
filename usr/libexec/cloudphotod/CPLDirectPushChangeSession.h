...
+ (id)selfCrashResetReason;	// IMP=0x002000000008aea9
- (void).cxx_destruct;	// IMP=0x002000000008af75
- (void)commitChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000899d1
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000890d5
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000088975
- (id)clientWorkDescription;	// IMP=0x0010000000088968
