...
- (void).cxx_destruct;	// IMP=0x002000000008e9bf
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x001000000008e602
- (id)operationDescription;	// IMP=0x001000000008e5fa
- (id)extendedStatusDescriptionStrings;	// IMP=0x001000000008e5f2
