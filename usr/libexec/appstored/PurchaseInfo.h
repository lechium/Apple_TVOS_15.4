...
- (void).cxx_destruct;	// IMP=0x00100000001a4a1c
...
- (void)updateGeneratedProperties;	// IMP=0x00100000001a4324
- (void)setWatchType:(long long)arg1;	// IMP=0x00100000001a42ca
- (long long)watchType;	// IMP=0x00100000001a427f
...
- (void)purchase_addVendorIDForApplication:(id)arg1;	// IMP=0x00100000001387b4
- (void)purchase_addThinningHeaders;	// IMP=0x0010000000138698
