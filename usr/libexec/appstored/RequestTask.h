...
- (void).cxx_destruct;	// IMP=0x002000000004823c
...
- (void)_setResponse:(id)arg1;	// IMP=0x0010000000048190
@property(readonly) ASDRequestResponse *response; // @synthesize response=_response;
- (id)initForClient:(id)arg1 withOptions:(id)arg2;	// IMP=0x0010000000047ffa
