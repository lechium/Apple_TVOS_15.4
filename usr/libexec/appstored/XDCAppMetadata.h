...
+ (Class)provisioningProfileType;	// IMP=0x002000000015d6cc
- (void).cxx_destruct;	// IMP=0x0020000000160b02
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001601f6
- (unsigned long long)hash;	// IMP=0x001000000015fd98
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015f6a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015f051
- (void)writeTo:(id)arg1;	// IMP=0x001000000015eb71
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000015eb64
- (id)dictionaryRepresentation;	// IMP=0x001000000015d965
- (id)description;	// IMP=0x001000000015d8b6
...
- (id)provisioningProfileAtIndex:(unsigned long long)arg1;	// IMP=0x001000000015d6af
- (unsigned long long)provisioningProfilesCount;	// IMP=0x001000000015d692
- (void)addProvisioningProfile:(id)arg1;	// IMP=0x001000000015d628
- (void)clearProvisioningProfiles;	// IMP=0x001000000015d60b
