...
- (void).cxx_destruct;	// IMP=0x00200000000bd899
...
- (void)softFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000bd7af
- (void)itemSucceeded:(id)arg1 storeItem:(id)arg2;	// IMP=0x00100000000bd504
- (void)hardFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000bd468
- (id)initWithItems:(id)arg1 account:(id)arg2;	// IMP=0x00100000000bcfc1
