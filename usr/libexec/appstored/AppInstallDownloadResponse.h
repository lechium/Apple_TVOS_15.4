...
+ (id)finishInstallID:(long long)arg1;	// IMP=0x00400000000c8031
+ (id)failInstallID:(long long)arg1 withError:(id)arg2;	// IMP=0x00100000000c7fc5
+ (id)continueInstallID:(long long)arg1 withDataConsumer:(id)arg2 assetRequest:(id)arg3 event:(id)arg4;	// IMP=0x00100000000c7f21
- (void).cxx_destruct;	// IMP=0x00200000000c8224
...
- (void)setRequestCount:(unsigned long long)arg1 forPackageID:(long long)arg2;	// IMP=0x00100000000c818a
- (void)setAssetSize:(id)arg1 forPackageID:(long long)arg2;	// IMP=0x00100000000c8168
- (id)_initWithInstallID:(long long)arg1 result:(long long)arg2 dataConsumer:(id)arg3 assetRequest:(id)arg4 error:(id)arg5 event:(id)arg6;	// IMP=0x00100000000c807c
