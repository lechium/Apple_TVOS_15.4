...
@interface StoreItem : NSObject
{
    ...
    MISSING_TYPE *_preflightPackageURL;	// 216 = 0xd8
...
+ (id)itemWithDictionary:(id)arg1;	// IMP=0x00200000001d9146
- (void).cxx_destruct;	// IMP=0x00100000001da8a3
...
- (void)_parseMetadataFromDictionary:(id)arg1;	// IMP=0x00100000001d9b7f
- (void)_parseAssetsFromDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 withInstalledItem:(id)arg3;	// IMP=0x00100000001d9924
- (id)description;	// IMP=0x00100000001d9887
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d9355
- (id)copyWritableMetadataForAccount:(id)arg1 includeVariant:(_Bool)arg2;	// IMP=0x00100000001d929d
- (id)copyWritableMetadataForAccount:(id)arg1;	// IMP=0x00100000001d9286
- (id)initWithDictionary:(id)arg1 applyingAssetStrategy:(long long)arg2 installedItem:(id)arg3;	// IMP=0x00100000001d9198
- (id)_newDateFormatter;	// IMP=0x00100000001dab8a
