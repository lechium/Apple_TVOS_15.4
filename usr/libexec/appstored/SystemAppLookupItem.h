...
+ (id)_stringFromDigest:(char *)arg1;	// IMP=0x00400000000cb5df
+ (id)_hashArrayFromMeasurement:(id)arg1;	// IMP=0x00100000000cb4ba
- (void).cxx_destruct;	// IMP=0x00200000000cb79d
...
- (id)initWithURL:(id)arg1 attributes:(id)arg2;	// IMP=0x00100000000cb0ca
