...
+ (void)reportImpressionFailedForAdNetworkId:(id)arg1 impressionType:(long long)arg2 version:(id)arg3 issueType:(long long)arg4;	// IMP=0x004000000007418d
+ (void)reportImpressionCreatedForAdNetworkId:(id)arg1 impressionType:(long long)arg2 version:(id)arg3;	// IMP=0x001000000007405d
+ (void)reportImpressionErrorForAdNetworkId:(id)arg1 impressionType:(long long)arg2 version:(id)arg3 error:(id)arg4;	// IMP=0x0010000000073ed5
+ (id)shouldAllowImpressionFromSourceAppBundleId:(id)arg1 andSourceAppAdamId:(id)arg2 forVersion:(id)arg3 adNetworkId:(id)arg4;	// IMP=0x0010000000073739
- (void).cxx_destruct;	// IMP=0x00200000000743fd
...
- (long long)impressionTypeForAnalytics;	// IMP=0x0010000000073eb7
- (id)checkForUnexpectedInput;	// IMP=0x00100000000734af
- (_Bool)hasRequisiteValues;	// IMP=0x0010000000073131
