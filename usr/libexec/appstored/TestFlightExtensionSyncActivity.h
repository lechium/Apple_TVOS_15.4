...
- (void).cxx_destruct;	// IMP=0x002000000024d89a
...
- (void)_runPeriodicSync;	// IMP=0x001000000024d800
- (void)run;	// IMP=0x001000000024d79f
...
- (id)initWithTestFlightServiceHost:(id)arg1;	// IMP=0x001000000024d5b8
