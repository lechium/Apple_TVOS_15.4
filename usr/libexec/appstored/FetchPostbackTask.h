...
- (void).cxx_destruct;	// IMP=0x0020000000115e42
@property(retain, nonatomic) NSArray *params; // @synthesize params=_params;
@property(retain, nonatomic) NSArray *results; // @synthesize results=_results;
- (id)processStatusString:(id)arg1 withErrorString:(id)arg2;	// IMP=0x0010000000115cdf
- (id)_requestWithParams:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000115aed
- (void)main;	// IMP=0x00100000001153d2
- (id)initWithAppAdamID:(id)arg1 urlString:(id)arg2;	// IMP=0x0010000000115216
