...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSSet, NSString;
...
- (MISSING_TYPE *)xcodeTestCertificatesWithReply: /* Error: Ran out of types for this method. */;
...
- (void)insertMessageForBundleID:(NSString *)arg1 status:(long long)arg2 useSandboxAccount:(_Bool)arg3 allowDeveloperControl:(_Bool)arg4 reply:(void (^)(NSError *))arg5;
