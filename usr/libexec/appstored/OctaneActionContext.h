...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x00400000002519d7
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x0010000000251973
- (void).cxx_destruct;	// IMP=0x0020000000251a73
...
- (id)init;	// IMP=0x00100000002518d1
