...
- (void).cxx_destruct;	// IMP=0x0020000000167ff9
...
- (id)_bomInstallFromPath:(id)arg1 withError:(id *)arg2;	// IMP=0x00100000001678ab
- (void)_bomInstall;	// IMP=0x00100000001672a3
- (void)_updateDownloadStatus:(id)arg1;	// IMP=0x001000000016721c
- (void)_sendDownloadStatus;	// IMP=0x001000000016715b
- (void)_install;	// IMP=0x0010000000167149
- (void)_finalizeTaskWithError:(id)arg1;	// IMP=0x0010000000166e28
- (void)_downloadedBytes:(long long)arg1 expectedBytes:(long long)arg2;	// IMP=0x0010000000166d21
- (void)pause;	// IMP=0x0010000000166bfd
- (void)cancel;	// IMP=0x0010000000166a57
- (void)main;	// IMP=0x0010000000165df7
- (id)initWithDownloadID:(id)arg1 info:(id)arg2 client:(id)arg3;	// IMP=0x0010000000165c9b
