...
+ (id)contextWithReason:(long long)arg1;	// IMP=0x00400000000e492d
+ (id)defaultContext;	// IMP=0x00100000000e48f8
- (void).cxx_destruct;	// IMP=0x00200000000e4b96
...
- (void)_setLogKey:(id)arg1;	// IMP=0x00100000000e4ae5
...
- (id)humanReadableReason;	// IMP=0x00100000000e49cb
- (id)init;	// IMP=0x00100000000e4965
