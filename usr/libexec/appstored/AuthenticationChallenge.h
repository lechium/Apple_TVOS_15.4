...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x004000000018c66f
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x001000000018c49b
- (void).cxx_destruct;	// IMP=0x002000000018c6e4
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x001000000018c367
