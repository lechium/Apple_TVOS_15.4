...
- (void).cxx_destruct;	// IMP=0x0020000000185a26
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000185817
@property(readonly, nonatomic) RestoreAppInstall *restoreAppInstall;
- (id)initWithApplication:(id)arg1;	// IMP=0x00100000001855cd
