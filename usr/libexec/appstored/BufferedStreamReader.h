...
- (void).cxx_destruct;	// IMP=0x002000000000fab7
- (void)close;	// IMP=0x001000000000fa6d
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000000fa50
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x001000000000f97a
- (id)_initWithBufferedStream:(id)arg1;	// IMP=0x001000000000f90c
