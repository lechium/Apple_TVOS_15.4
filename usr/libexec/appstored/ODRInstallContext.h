...
+ (id)contextWithMetadata:(id)arg1;	// IMP=0x00400000000ba23a
- (void).cxx_destruct;	// IMP=0x00200000000ba776
...
- (void)_findReason;	// IMP=0x00100000000ba54f
- (id)application;	// IMP=0x00100000000ba42b
- (id)init;	// IMP=0x00100000000ba1d4
