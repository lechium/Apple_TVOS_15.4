...
- (void).cxx_destruct;	// IMP=0x00200000001021ce
- (void)_publishStreamEvent:(unsigned long long)arg1;	// IMP=0x0010000000102171
- (void)signalEvent:(unsigned long long)arg1;	// IMP=0x0010000000102160
- (void)open;	// IMP=0x0010000000102128
- (void)close;	// IMP=0x0010000000102111
...
- (id)init;	// IMP=0x0010000000101b09
