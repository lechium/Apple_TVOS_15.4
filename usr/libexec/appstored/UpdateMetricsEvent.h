...
+ (id)_defaultProperties;	// IMP=0x00400000000c4328
- (void).cxx_destruct;	// IMP=0x00200000000c4546
...
- (id)description;	// IMP=0x00100000000c427f
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x00100000000c4277
- (id)initWithTopic:(id)arg1;	// IMP=0x00100000000c3f06
