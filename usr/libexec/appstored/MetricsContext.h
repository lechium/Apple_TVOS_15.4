...
+ (id)shortNameForAppUsageType:(long long)arg1;	// IMP=0x00400000001db2a6
+ (id)contextForType:(long long)arg1;	// IMP=0x00100000001db270
- (void).cxx_destruct;	// IMP=0x00200000001db950
...
- (void)_setLogKey:(id)arg1;	// IMP=0x00100000001db734
- (id)_metricsTopic;	// IMP=0x00100000001db5dc
- (void)recordLaunchesIntervalStartDate;	// IMP=0x00100000001db4ab
- (void)recordIntervalStartDate;	// IMP=0x00100000001db37a
@property(readonly, nonatomic) Class metadataEntityClass;
@property(readonly, nonatomic) Class appEventEntityClass;
- (id)initWithAppUsageType:(long long)arg1;	// IMP=0x00100000001daf10
