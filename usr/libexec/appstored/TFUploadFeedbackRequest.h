...
- (void).cxx_destruct;	// IMP=0x0020000000180247
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018001e
- (unsigned long long)hash;	// IMP=0x001000000017ff23
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017fd73
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000017fc28
- (void)copyTo:(id)arg1;	// IMP=0x001000000017fb22
- (void)writeTo:(id)arg1;	// IMP=0x001000000017fa1c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000017f5b9
- (id)dictionaryRepresentation;	// IMP=0x001000000017f33b
- (id)description;	// IMP=0x001000000017f28c
