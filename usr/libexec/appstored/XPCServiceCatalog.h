...
@interface XPCServiceCatalog : NSObject
{
    ...
    struct _ASDServiceEntitlement _ArcadeServiceEntitlement;	// 144 = 0x90
    struct _ASDServiceEntitlement _diagnosticServiceEntitlement;	// 160 = 0xa0
    struct _ASDServiceEntitlement _CrossfireServerEntitlement;	// 176 = 0xb0
    ...
    struct _ASDServiceEntitlement _installAttributionServiceEntitlement;	// 224 = 0xe0
    struct _ASDServiceEntitlement _libraryServiceEntitlement;	// 240 = 0xf0
    struct _ASDServiceEntitlement _MetricsServiceEntitlement;	// 256 = 0x100
    struct _ASDServiceEntitlement _ManagedAppServiceEntitlement;	// 272 = 0x110
    struct _ASDServiceEntitlement _OcelotServerEntitlement;	// 288 = 0x120
    struct _ASDServiceEntitlement _PurchaseHistoryServiceEntitlement;	// 304 = 0x130
    struct _ASDServiceEntitlement _PurchaseServiceEntitlement;	// 320 = 0x140
    struct _ASDServiceEntitlement _RepairServiceEntitlement;	// 336 = 0x150
    struct _ASDServiceEntitlement _RestoreServiceEntitlement;	// 352 = 0x160
    struct _ASDServiceEntitlement _UpdatesServiceEntitlement;	// 368 = 0x170
}
