...
+ (id)newContextWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x0040000000081f66
- (void).cxx_destruct;	// IMP=0x00200000000820f7
...
- (id)_initWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x0010000000081ff7
