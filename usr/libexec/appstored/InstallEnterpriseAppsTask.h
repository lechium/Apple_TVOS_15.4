...
- (void).cxx_destruct;	// IMP=0x002000000020b726
- (void)main;	// IMP=0x001000000020ada8
- (void)_setProcessedExternalIDs:(id)arg1;	// IMP=0x001000000020ad28
@property(readonly) NSArray *processedExternalIDs; // @synthesize processedExternalIDs=_processedExternalIDs;
- (id)initWithEnterpriseApps:(id)arg1 isXDCRequest:(_Bool)arg2 requestToken:(id)arg3;	// IMP=0x001000000020ac20
