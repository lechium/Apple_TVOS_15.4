...
- (void).cxx_destruct;	// IMP=0x002000000002432d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000024279
- (id)diagnosticDescription;	// IMP=0x0010000000024032
- (id)description;	// IMP=0x0010000000023e7c
