...
+ (id)_variantDescriptorsFromTargetArray:(id)arg1;	// IMP=0x0020000000005f5b
+ (id)_variantDeltasFromDeltasInfo:(id)arg1;	// IMP=0x0010000000005d6e
...
- (id)variantDeltaFromAssetToken:(id)arg1;	// IMP=0x0010000000005a84
@property(readonly) _Bool deltaUpdate;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000058ee
