...
@interface ApplicationProxy : NSObject
{
    ...
    MISSING_TYPE *_profileValidated;	// 43 = 0x2b
...
+ (void)enumerateApplicationsOfType:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x004000000022277d
+ (id)proxyForBundleURL:(id)arg1;	// IMP=0x001000000022144e
+ (id)proxyForItemID:(id)arg1;	// IMP=0x00100000002212f6
+ (id)proxyForBundleID:(id)arg1;	// IMP=0x00100000002212a9
+ (id)proxyForBundle:(id)arg1;	// IMP=0x001000000022125c
- (void).cxx_destruct;	// IMP=0x0020000000222dd9
...
- (id)description;	// IMP=0x0010000000222a98
- (id)validLocationProxy;	// IMP=0x0010000000222a8f
...
- (id)_initWithLSApplicationRecord:(id)arg1;	// IMP=0x0010000000221aa5
- (id)initWithBundleURL:(id)arg1;	// IMP=0x0010000000221797
- (id)initWithBundlePath:(id)arg1;	// IMP=0x001000000022173d
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000002215ed
- (id)initWithBundle:(id)arg1;	// IMP=0x0010000000221597
