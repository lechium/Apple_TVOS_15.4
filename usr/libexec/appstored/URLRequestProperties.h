...
- (void).cxx_destruct;	// IMP=0x0020000000190123
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018fe0d
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x001000000018fdfb
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x001000000018fcba
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x001000000018fb67
- (void)setValue:(id)arg1 forRequestHeader:(id)arg2;	// IMP=0x001000000018fa13
...
- (id)init;	// IMP=0x001000000018e9ea
