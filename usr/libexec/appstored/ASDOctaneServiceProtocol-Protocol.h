...
@class MISSING_TYPE, NSArray, NSData, NSDictionary, NSString, NSUUID;
...
- (MISSING_TYPE *)removeConfigurationForBundleID:completion: /* Error: Ran out of types for this method. */;
