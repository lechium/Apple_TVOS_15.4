...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x00400000000485b6
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x0010000000048532
+ (void)removeAllTaskInfo;	// IMP=0x00100000000484f7
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x001000000004838f
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x001000000004837d
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x001000000004827e
- (void).cxx_destruct;	// IMP=0x0020000000048828
...
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000482e9
