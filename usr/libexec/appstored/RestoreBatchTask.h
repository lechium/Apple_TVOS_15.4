...
+ (_Bool)isErrorBadTokenError:(id)arg1;	// IMP=0x00400000000baebd
- (void).cxx_destruct;	// IMP=0x00200000000bcf5d
...
- (void)_processBatchFailureItems:(id)arg1 error:(id)arg2 context:(id)arg3;	// IMP=0x00100000000bca9c
- (id)_processContentRestoreResponse:(id)arg1 context:(id)arg2;	// IMP=0x00100000000bc003
- (void)main;	// IMP=0x00100000000bb01d
- (_Bool)isErrorSoftFail:(id)arg1;	// IMP=0x00100000000bb015
- (id)initWithRestoreAppInstalls:(id)arg1;	// IMP=0x00100000000bae4f
