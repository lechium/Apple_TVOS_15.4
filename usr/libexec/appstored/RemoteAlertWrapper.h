...
- (void).cxx_destruct;	// IMP=0x002000000009bbfc
...
- (void)activateForTargetXPCConnection:(id)arg1 shouldDismissOnUILock:(_Bool)arg2 userInfo:(id)arg3;	// IMP=0x001000000009b8e5
- (id)initWithServiceName:(id)arg1 viewControllerClassName:(id)arg2;	// IMP=0x001000000009b82a
