...
- (void).cxx_destruct;	// IMP=0x0020000000229736
...
- (id)_typeForMetricsType:(unsigned char)arg1;	// IMP=0x0010000000229361
- (id)_metricsTypeForInstallationType:(unsigned char)arg1;	// IMP=0x0010000000229338
- (id)_eventForType:(unsigned char)arg1;	// IMP=0x00100000002292b6
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x00100000002292ae
- (id)metricsDictionary;	// IMP=0x0010000000228e2a
...
- (id)externalMapping;	// IMP=0x0010000000227cc0
- (id)description;	// IMP=0x0010000000227c54
