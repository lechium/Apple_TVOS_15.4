...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logUUID:(id)arg3;	// IMP=0x00200000000674c9
- (void).cxx_destruct;	// IMP=0x0020000000067ec4
- (_Bool)_handleVPPRecoveryWithOutError:(id *)arg1;	// IMP=0x0010000000067b7f
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000067676
@property(readonly, nonatomic) NSString *repairType;
- (void)setRepairedBundleIDs:(id)arg1;	// IMP=0x001000000006744d
...
- (id)initWithApplication:(id)arg1 options:(id)arg2;	// IMP=0x0010000000067204
- (id)init;	// IMP=0x00100000000671c9
