...
+ (id)selectAssetFromArray:(id)arg1 usingStategy:(long long)arg2 withDeltaForInstalledItem:(id)arg3;	// IMP=0x002000000013ef5a
+ (id)selectAssetFromArray:(id)arg1 usingStategy:(long long)arg2;	// IMP=0x001000000013ed9e
+ (id)deltaAssetsWithDictionary:(id)arg1;	// IMP=0x001000000013ec15
+ (id)assetWithDictionary:(id)arg1;	// IMP=0x001000000013ebc3
- (void).cxx_destruct;	// IMP=0x001000000013fd97
...
- (_Bool)_parseAssetDictionary:(id)arg1;	// IMP=0x001000000013f84b
- (id)description;	// IMP=0x001000000013f798
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013f59e
- (_Bool)isApplicableUpdateWithInstalledItemContext:(id)arg1;	// IMP=0x001000000013f026
@property(readonly, getter=isDelta) _Bool delta;
- (id)initWithDictionary:(id)arg1 assetType:(long long)arg2;	// IMP=0x001000000013ed08
