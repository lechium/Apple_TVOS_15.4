...
@interface DuetLaunchEvent : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00200000001bca93
...
- (id)_formatTimeInternal:(long long)arg1;	// IMP=0x00100000001bc718
- (id)_simpleTime:(id)arg1;	// IMP=0x00100000001bc66c
- (id)_simpleDate:(id)arg1;	// IMP=0x00100000001bc56a
- (id)description;	// IMP=0x00100000001bc41d
- (id)dictionary;	// IMP=0x00100000001bbf91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001bbd63
