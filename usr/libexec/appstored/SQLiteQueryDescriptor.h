...
- (void).cxx_destruct;	// IMP=0x002000000011e338
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000011dbce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011dadc
