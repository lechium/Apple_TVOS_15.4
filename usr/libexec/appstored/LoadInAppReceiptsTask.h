...
@class NSArray, NSSet, NSString, StoreKitClient;
...
- (void).cxx_destruct;	// IMP=0x0020000000214533
...
- (long long)reason;	// IMP=0x00100000002144df
...
- (void)main;	// IMP=0x00100000002131df
- (id)initWithLocalRevision:(id)arg1 reason:(long long)arg2 client:(id)arg3;	// IMP=0x00100000002130e6
