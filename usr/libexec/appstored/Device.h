...
+ (id)_getBootSession;	// IMP=0x002000000020c0b3
+ (id)currentDevice;	// IMP=0x001000000020be8c
- (void).cxx_destruct;	// IMP=0x002000000020c222
...
- (id)copyThinningHeaders;	// IMP=0x001000000020bfcd
...
- (id)_initWithCurrentDevice;	// IMP=0x001000000020bef1
