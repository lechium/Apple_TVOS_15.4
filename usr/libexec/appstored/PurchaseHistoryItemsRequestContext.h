...
+ (id)newContextWithKnownApps:(id)arg1 revision:(id)arg2 forAccountID:(long long)arg3 requestingAccount:(id)arg4 client:(id)arg5 purchaseHistoryContext:(unsigned long long)arg6;	// IMP=0x0040000000065617
- (void).cxx_destruct;	// IMP=0x0020000000065830
...
- (id)_initWithKnownApps:(id)arg1 revision:(id)arg2 forAccountID:(long long)arg3 requestingAccount:(id)arg4 client:(id)arg5 purchaseHistoryContext:(unsigned long long)arg6;	// IMP=0x00100000000656d3
