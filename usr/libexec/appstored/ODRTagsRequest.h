...
- (void).cxx_destruct;	// IMP=0x0020000000057261
...
- (void)updateReportForRequestID:(id)arg1 withSecondsRemaining:(double)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x0010000000056d1f
- (id)initWithProgress:(id)arg1;	// IMP=0x0010000000056c2b
