...
- (void).cxx_destruct;	// IMP=0x0020000000069e83
...
- (id)_newBodyDictionaryWithAccountID:(id)arg1;	// IMP=0x001000000006943a
- (void)main;	// IMP=0x0010000000068b38
- (id)initWithRestoreAppInstalls:(id)arg1 account:(id)arg2;	// IMP=0x0010000000068a96
