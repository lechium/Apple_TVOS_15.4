...
+ (id)_newResponseWithURLResult:(id)arg1 error:(id *)arg2;	// IMP=0x00400000000e8afa
- (void).cxx_destruct;	// IMP=0x00200000000e8ef6
...
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000e83ca
- (id)initWithRequestToken:(id)arg1;	// IMP=0x00100000000e8370
- (id)init;	// IMP=0x00100000000e82dc
