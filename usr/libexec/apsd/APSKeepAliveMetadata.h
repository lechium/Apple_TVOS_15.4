...
- (void).cxx_destruct;	// IMP=0x0020000000051e73
...
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5 hwVersion:(id)arg6 swVersion:(id)arg7 swBuild:(id)arg8;	// IMP=0x0010000000051cc0
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5;	// IMP=0x0010000000051c8c
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 keepAliveState:(id)arg3;	// IMP=0x0010000000051c67
