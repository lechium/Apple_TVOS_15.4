...
@interface APSConfiguration : NSObject
{
    ...
    MISSING_TYPE *_isLoadBalanced;	// 50 = 0x32
    NSURL *_url;	// 56 = 0x38
...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0040000000069be3
+ (void)loadConfigurationForEnvironment:(id)arg1 interface:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0010000000069875
+ (id)configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0010000000069613
+ (id)_onQueue_configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x00100000000693f5
+ (void)initialize;	// IMP=0x001000000006939e
- (void).cxx_destruct;	// IMP=0x002000000006b670
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000006b42f
- (_Bool)_isExpired;	// IMP=0x001000000006b3cf
- (_Bool)_isLoaded;	// IMP=0x001000000006b3c6
...
- (id)bagExpiryInterval;	// IMP=0x001000000006b318
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x001000000006b1bc
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x001000000006aa1d
- (void)_failWithError:(id)arg1;	// IMP=0x001000000006a8fe
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x001000000006a67f
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000006a52d
- (id)pendingCompletionBocks;	// IMP=0x001000000006a51f
- (void)dealloc;	// IMP=0x001000000006a4e0
- (id)initWithEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0010000000069ea6
