...
- (void).cxx_destruct;	// IMP=0x002000000006c0ce
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000006bc0c
- (void)_cleanupConnection:(id)arg1;	// IMP=0x001000000006ba6b
- (void)dealloc;	// IMP=0x001000000006b9d9
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x001000000006b82f
