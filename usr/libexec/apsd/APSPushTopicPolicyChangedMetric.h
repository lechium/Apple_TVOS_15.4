...
- (void).cxx_destruct;	// IMP=0x0020000000011e62
...
- (id)name;	// IMP=0x0010000000011cb9
- (id)initWithGuid:(id)arg1 topic:(id)arg2 changedReason:(long long)arg3 didCauseFilterChange:(_Bool)arg4;	// IMP=0x0010000000011bee
