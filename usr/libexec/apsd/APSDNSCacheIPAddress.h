...
- (void).cxx_destruct;	// IMP=0x00200000000642d1
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x001000000006425c
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x00100000000641cc
