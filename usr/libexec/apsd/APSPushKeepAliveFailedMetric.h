...
@interface APSPushKeepAliveFailedMetric : NSObject
{
    ...
    MISSING_TYPE *_connectionType;	// 20 = 0x14
...
- (void).cxx_destruct;	// IMP=0x002000000003f79b
...
- (id)initWithGuid:(id)arg1 version:(unsigned int)arg2 connectionType:(unsigned int)arg3 linkQuality:(id)arg4 dualChannelState:(unsigned int)arg5 timeSinceLastSuccessfulKeepAlive:(id)arg6 timeSinceConnected:(id)arg7 lastKeepAliveInterval:(id)arg8 currentGrowthStage:(id)arg9;	// IMP=0x001000000003f2ed
