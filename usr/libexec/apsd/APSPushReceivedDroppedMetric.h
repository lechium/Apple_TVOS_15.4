...
- (void).cxx_destruct;	// IMP=0x002000000006f28e
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 dualChannelState:(unsigned int)arg4 receiveOffset:(id)arg5 payloadSize:(id)arg6 isFromStorage:(id)arg7 topic:(id)arg8;	// IMP=0x001000000006ee4c
