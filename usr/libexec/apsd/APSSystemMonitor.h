...
+ (id)sharedInstance;	// IMP=0x0040000000091dff
- (void).cxx_destruct;	// IMP=0x00200000000926b3
...
- (void)removeListener:(id)arg1;	// IMP=0x00100000000925db
- (void)addListener:(id)arg1;	// IMP=0x0010000000092547
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x00100000000923f6
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x00100000000922a5
- (void)_systemWillSleep;	// IMP=0x00100000000921ee
- (void)_systemDidWake;	// IMP=0x00100000000921d1
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x0010000000092120
- (void)dealloc;	// IMP=0x0010000000091ebe
- (id)init;	// IMP=0x0010000000091e54
