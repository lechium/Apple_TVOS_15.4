...
- (void).cxx_destruct;	// IMP=0x00200000000405a8
...
- (void)_clearState;	// IMP=0x0010000000040460
- (void)_fireMetricIfNeeded;	// IMP=0x0010000000040336
- (void)_timerFired:(id)arg1;	// IMP=0x0010000000040305
- (void)noteReceivedLiveMessage;	// IMP=0x00100000000402f3
- (void)noteSystemWillSleep;	// IMP=0x00100000000402e1
- (void)noteReceivedStoredMessage;	// IMP=0x0010000000040291
- (void)noteDidConnect;	// IMP=0x0010000000040221
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x001000000004016c
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000040066
- (id)init;	// IMP=0x001000000003feea
