...
+ (void)_saveCachedProperties;	// IMP=0x002000000006720a
+ (void)_loadCachedProperties;	// IMP=0x0010000000066cbc
+ (id)environmentForName:(id)arg1;	// IMP=0x0010000000066ca3
+ (void)initialize;	// IMP=0x00100000000666be
- (void).cxx_destruct;	// IMP=0x00200000000676cb
...
- (id)description;	// IMP=0x00100000000675ac
@property(readonly, nonatomic) unsigned long long priority;
- (unsigned long long)hash;	// IMP=0x0010000000067556
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006754b
