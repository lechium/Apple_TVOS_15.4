...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001992a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000019ad8
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000019932
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x0010000000019826
