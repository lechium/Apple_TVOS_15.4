...
- (void).cxx_destruct;	// IMP=0x002000000000413e
...
- (void)complete;	// IMP=0x0010000000003e19
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x0010000000003b68
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x00100000000038b7
- (id)_schedulerTaskIdentifier;	// IMP=0x00100000000037d5
- (void)dealloc;	// IMP=0x00100000000035f2
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x00100000000026a4
