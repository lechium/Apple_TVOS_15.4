...
- (_Bool)verifyResponse:(id)arg1 signature:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000003cf8
- (_Bool)verifyCerts:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000395f
- (_Bool)determineAlg:(id)arg1;	// IMP=0x00100000000038f2
- (id)init;	// IMP=0x00100000000038b7
