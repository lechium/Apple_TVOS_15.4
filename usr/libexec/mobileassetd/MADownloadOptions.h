...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000e64e
...
- (void)logOptions;	// IMP=0x001000000000ed22
- (id)description;	// IMP=0x001000000000ebfc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000e9f2
- (void)dealloc;	// IMP=0x001000000000e9a8
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000e6ae
- (id)init;	// IMP=0x001000000000e656
