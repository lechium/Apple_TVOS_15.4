...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000000783c
...
- (id)description;	// IMP=0x0010000000007e45
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000007c0c
- (void)dealloc;	// IMP=0x0010000000007b6e
- (id);	// IMP=0x00100000000078f0
- (id)init;	// IMP=0x0010000000007844
