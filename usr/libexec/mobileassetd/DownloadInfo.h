...
- (id)description;	// IMP=0x0010000000011c70
- (id)_taskState;	// IMP=0x0010000000011bae
- (void)clearCacheServerUrl;	// IMP=0x0010000000011b86
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x0010000000011b69
- (double)currentEstimate;	// IMP=0x0010000000011979
- (void)updateDownloadData:(long long)arg1;	// IMP=0x00100000000118c3
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x0010000000011749
- (void)dealloc;	// IMP=0x00100000000116b7
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0010000000011451
- (id)initWithUrl:(id)arg1 options:(id)arg2;	// IMP=0x0010000000011388
