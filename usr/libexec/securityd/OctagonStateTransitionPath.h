...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00400000000c3eac
- (void).cxx_destruct;	// IMP=0x00200000000c3e84
...
- (id)asPathStep;	// IMP=0x00100000000c3d4b
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00100000000c3cb2
