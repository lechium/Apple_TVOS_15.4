...
- (void).cxx_destruct;	// IMP=0x00200000000ebb7c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000eb9b1
- (void)dealloc;	// IMP=0x00100000000eb8ee
- (void)setCallback:(CDUnknownBlockType)arg1;	// IMP=0x00100000000eb8a6
- (void)callCallback:(_Bool)arg1;	// IMP=0x00100000000eb895
- (id)initWithEngine:(struct __OpaqueSOSEngine *)arg1 peer:(struct __OpaqueSOSPeer *)arg2 localManifest:(struct __OpaqueSOSManifest *)arg3 proposedManifest:(struct __OpaqueSOSManifest *)arg4 confirmedManifest:(struct __OpaqueSOSManifest *)arg5 andMessage:(struct __OpaqueSOSMessage *)arg6;	// IMP=0x00100000000eb7b9
