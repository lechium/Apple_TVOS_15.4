...
- (void).cxx_destruct;	// IMP=0x00200000001e6486
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00100000001e6293
- (void)requestSyncWith:(id)arg1;	// IMP=0x00100000001e61c0
- (void)finish;	// IMP=0x00100000001e47ba
- (void)restart;	// IMP=0x00100000001e478c
- (void)start;	// IMP=0x00100000001e4348
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00100000001e42c0
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00100000001e404b
- (unsigned long long)currentTrustBitmask;	// IMP=0x00100000001e3f3c
