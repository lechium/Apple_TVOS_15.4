...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001b030a
- (void).cxx_destruct;	// IMP=0x00200000001b02d7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001b00ab
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001aff37
- (id)description;	// IMP=0x00100000001afdd5
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6 walrus:(id)arg7;	// IMP=0x00100000001afcf6
