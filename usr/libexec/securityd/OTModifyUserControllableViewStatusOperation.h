...
@class MISSING_TYPE, NSString, OTOperationDependencies;
...
- (void).cxx_destruct;	// IMP=0x0020000000024b97
...
- (void)performWithStatus:(int)arg1;	// IMP=0x00100000000247db
- (void)groupStart;	// IMP=0x0010000000024796
- (id)initWithDependencies:(id)arg1 intendedViewStatus:(int)arg2 intendedState:(id)arg3 peerMissingState:(id)arg4 errorState:(id)arg5;	// IMP=0x0010000000024696
