...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000c9eba
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000c9cfd
- (void)groupStart;	// IMP=0x00100000000c96cd
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000c95c8
