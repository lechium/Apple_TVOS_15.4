...
+ (id)trust;	// IMP=0x0040000000206224
- (void).cxx_destruct;	// IMP=0x00200000002061f1
...
- (void)dealloc;	// IMP=0x0010000000205fc6
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x0010000000205ee7
- (id)init;	// IMP=0x0000000000205dfc
