...
- (void).cxx_destruct;	// IMP=0x0020000000044dfb
...
- (void)setDeviceInfo:(id)arg1;	// IMP=0x0010000000044ca9
- (id)deviceInfo;	// IMP=0x0010000000044c93
@property(retain) NSString<OctagonStateString> *nextState; // @synthesize nextState=_nextState;
@property(readonly) NSString<OctagonStateString> *intendedState; // @synthesize intendedState=_intendedState;
- (void)handleRepairSuggestions:(_Bool)arg1 postEscrowCFU:(_Bool)arg2 resetOctagon:(_Bool)arg3 leaveTrust:(_Bool)arg4 moveRequest:(id)arg5;	// IMP=0x0010000000044a79
- (void)groupStart;	// IMP=0x0010000000043faf
- (_Bool)checkIfPasscodeIsSetForDevice;	// IMP=0x0010000000043fa7
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 skipRateLimitedCheck:(_Bool)arg5;	// IMP=0x0010000000043ea5
