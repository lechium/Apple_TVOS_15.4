...
- (void).cxx_destruct;	// IMP=0x00200000000c16c8
...
- (void)cancel;	// IMP=0x00100000000c138e
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000c0dd2
- (void)performFetch;	// IMP=0x00100000000c0225
- (void)groupStart;	// IMP=0x00100000000c001b
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000bfa94
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00100000000bf854
- (id)init;	// IMP=0x00100000000bf846
