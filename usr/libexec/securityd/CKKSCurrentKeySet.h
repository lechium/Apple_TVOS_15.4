...
+ (id)loadForZone:(id)arg1;	// IMP=0x00400000000a31aa
- (void).cxx_destruct;	// IMP=0x00200000000a3135
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000a2dc7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a2ace
- (id)description;	// IMP=0x00100000000a284d
- (id)initWithZoneID:(id)arg1;	// IMP=0x00100000000a27e2
