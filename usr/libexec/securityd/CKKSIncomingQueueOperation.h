...
+ (id)decryptCKKSItemToAttributes:(id)arg1 keyCache:(id)arg2 error:(id *)arg3;	// IMP=0x0020000000073c1c
- (void).cxx_destruct;	// IMP=0x0020000000071eba
...
- (void)_onqueueHandleIQEDelete:(id)arg1 class:(const struct SecDbClass *)arg2 viewState:(id)arg3;	// IMP=0x0010000000071367
- (_Bool)_onqueueHandleIQEChange:(id)arg1 item:(struct SecDbItem *)arg2 viewState:(id)arg3 sortedForThisView:(_Bool)arg4 keyCache:(id)arg5;	// IMP=0x001000000006fe7c
- (void)_onqueueHandleIQEChange:(id)arg1 attributes:(id)arg2 class:(const struct SecDbClass *)arg3 viewState:(id)arg4 sortedForThisView:(_Bool)arg5 keyCache:(id)arg6;	// IMP=0x001000000006fc8a
- (void)_onqueueGenerateNewUUIDPersistentRefOnSecItem:(struct SecDbItem *)arg1 viewState:(id)arg2;	// IMP=0x001000000006faf5
- (_Bool)fixMismatchedViewItems:(id)arg1;	// IMP=0x001000000006f817
- (_Bool)loadAndProcessEntries:(id)arg1 withActionFilter:(id)arg2;	// IMP=0x001000000006f51d
- (void)main;	// IMP=0x001000000006e6f7
- (_Bool)_onqueueUpdateIQE:(id)arg1 withState:(id)arg2 error:(id *)arg3;	// IMP=0x001000000006e54e
- (void)_onqueueHandleMismatchedViewItem:(id)arg1 secDbClass:(const struct SecDbClass *)arg2 attributes:(id)arg3 intendedView:(id)arg4 viewState:(id)arg5 keyCache:(id)arg6;	// IMP=0x001000000006de0b
- (_Bool)intransaction:(id)arg1 processQueueEntries:(id)arg2;	// IMP=0x001000000006c669
- (_Bool)processNewCurrentItemPointers:(id)arg1 viewState:(id)arg2;	// IMP=0x001000000006c2ba
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 pendingClassAItemsRemainingState:(id)arg3 errorState:(id)arg4 handleMismatchedViewItems:(_Bool)arg5;	// IMP=0x001000000006c155
- (id)init;	// IMP=0x001000000006c147
