...
- (void).cxx_destruct;	// IMP=0x002000000021c47b
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x001000000021c2d8
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x001000000021c1d3
- (id)setUpConfigForPeer;	// IMP=0x001000000021c158
