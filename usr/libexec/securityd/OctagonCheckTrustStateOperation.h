...
- (void).cxx_destruct;	// IMP=0x0020000000165bfe
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x00100000001649fa
- (void)groupStart;	// IMP=0x00100000001647fb
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000164735
