...
+ (id)globalTracker;	// IMP=0x00400000001677e5
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x00100000001672e2
- (_Bool)isLockedError:(id)arg1;	// IMP=0x0010000000167253
- (_Bool)checkErrorChainForLockState:(id)arg1;	// IMP=0x0010000000167175
- (_Bool)lockedError:(id)arg1;	// IMP=0x00100000001670aa
- (void)recheck;	// IMP=0x0010000000167039
- (void)_onqueueRecheck;	// IMP=0x0010000000166cff
- (void)resetUnlockDependency;	// IMP=0x0010000000166c12
- (id)description;	// IMP=0x0010000000166b6a
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x00100000001669a7
- (id)initWithProvider:(id)arg1;	// IMP=0x0010000000166792
