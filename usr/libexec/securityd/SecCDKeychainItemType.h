...
+ (id)itemTypeForVersion:(int)arg1;	// IMP=0x004000000004278c
+ (id)itemType;	// IMP=0x0010000000042784
- (void).cxx_destruct;	// IMP=0x0020000000042746
...
- (id)managedItemTypeWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000042550
@property(readonly, copy) NSArray *syncableKeys;
@property(readonly, copy) NSArray *primaryKeys;
- (id)debugDescription;	// IMP=0x0010000000042492
- (id)description;	// IMP=0x0010000000042465
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004237e
- (id)_initWithName:(id)arg1 version:(int)arg2 primaryKeys:(id)arg3 syncableKeys:(id)arg4;	// IMP=0x0010000000042271
