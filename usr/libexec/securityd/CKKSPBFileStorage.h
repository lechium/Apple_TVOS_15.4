...
- (void).cxx_destruct;	// IMP=0x002000000018a970
...
- (void)setStorage:(id)arg1;	// IMP=0x001000000018a7dc
- (id)storage;	// IMP=0x001000000018a779
- (id)initWithStoragePath:(id)arg1 storageClass:(Class)arg2;	// IMP=0x001000000018a5f2
