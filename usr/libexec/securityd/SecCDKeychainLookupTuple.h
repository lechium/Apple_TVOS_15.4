...
+ (id)lookupTupleWithManagedLookupEntry:(id)arg1;	// IMP=0x004000000003e3e5
+ (id)lookupTupleWithKey:(id)arg1 value:(id)arg2;	// IMP=0x001000000003e379
- (void).cxx_destruct;	// IMP=0x002000000003e346
...
- (id)description;	// IMP=0x001000000003e20c
- (unsigned long long)hash;	// IMP=0x001000000003e1b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003e0bb
- (id)initWithKey:(id)arg1 value:(id)arg2;	// IMP=0x001000000003df32
