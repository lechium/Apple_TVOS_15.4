...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x0020000000036cb8
+ (id)getCircleStatus;	// IMP=0x0010000000036b94
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x0010000000036af5
- (void).cxx_destruct;	// IMP=0x0020000000034aba
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0010000000034743
- (void)triggerOctagonStatusFetch;	// IMP=0x0010000000034558
- (id)checkForAllDeliveries;	// IMP=0x0010000000034438
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x00100000000343fa
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x00100000000343e1
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x0010000000034390
- (void)recheckCKAccountStatus;	// IMP=0x00100000000342e4
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x001000000003419c
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0010000000034003
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0010000000033d18
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0010000000033b89
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x001000000003399f
- (id)notifyCircleChange:(id)arg1;	// IMP=0x001000000003389d
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0010000000033718
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x0010000000033456
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x0010000000033368
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x00100000000331c9
- (void)dealloc;	// IMP=0x001000000003314e
- (void)performInitialDispatches;	// IMP=0x00100000000330c4
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x0010000000032c21
