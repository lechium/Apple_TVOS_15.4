...
- (void).cxx_destruct;	// IMP=0x00200000000ab2c9
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000aafea
- (void)groupStart;	// IMP=0x00100000000aaa82
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000aa9e0
