...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001b191f
- (void).cxx_destruct;	// IMP=0x00200000001b18e1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001b1682
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001b12ab
- (id)description;	// IMP=0x00100000001b1218
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x00100000001b0fb5
