...
- (void).cxx_destruct;	// IMP=0x002000000016638c
...
- (id)sfaStatus;	// IMP=0x00100000001662eb
- (id)sysdiagnoseStatus;	// IMP=0x00100000001662e3
- (_Bool)clearFollowUp:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x0010000000166126
- (_Bool)postFollowUp:(unsigned char)arg1 error:(id *)arg2;	// IMP=0x0010000000165f2c
- (id)createCDPFollowupContext:(unsigned char)arg1;	// IMP=0x0010000000165ee9
- (id)initWithFollowupController:(id)arg1;	// IMP=0x0010000000165e52
- (void)clearAllPostedFlags;	// IMP=0x0010000000166428
- (_Bool)hasPosted:(unsigned char)arg1;	// IMP=0x00100000001663b4
