...
- (void).cxx_destruct;	// IMP=0x00200000001bee91
...
- (long long)wait:(unsigned long long)arg1;	// IMP=0x00100000001bedc5
- (void)fulfill;	// IMP=0x00100000001bed42
- (id)initToChain:(id)arg1;	// IMP=0x00100000001becc2
- (id)init;	// IMP=0x00100000001becae
