...
- (void).cxx_destruct;	// IMP=0x00200000000839d1
...
- (void)afterAuthKitFetch:(id)arg1 accountIsDemo:(_Bool)arg2;	// IMP=0x00100000000836e6
- (void)groupStart;	// IMP=0x00100000000833bd
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 authenticationErrorState:(id)arg4 errorState:(id)arg5 retryFlag:(id)arg6;	// IMP=0x001000000008327d
