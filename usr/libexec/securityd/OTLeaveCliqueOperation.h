...
- (void).cxx_destruct;	// IMP=0x002000000012bce0
...
- (void)groupStart;	// IMP=0x001000000012ba03
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000012b93d
