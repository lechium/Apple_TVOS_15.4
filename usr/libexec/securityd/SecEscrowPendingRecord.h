...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x002000000014c756
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x001000000014c43c
- (void).cxx_destruct;	// IMP=0x00200000001c1a3f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001c17f0
- (unsigned long long)hash;	// IMP=0x00100000001c1694
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001c1436
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c1298
- (void)copyTo:(id)arg1;	// IMP=0x00100000001c1141
- (void)writeTo:(id)arg1;	// IMP=0x00100000001c0fdc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001c0a9e
- (id)dictionaryRepresentation;	// IMP=0x00100000001c07b3
- (id)description;	// IMP=0x00100000001c0704
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x001000000014c177
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x001000000014bb57
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x001000000014c383
