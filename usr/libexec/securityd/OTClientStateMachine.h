...
- (void).cxx_destruct;	// IMP=0x00200000001b36ae
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x00100000001b3205
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000001b2efe
- (void)notifyContainerChange;	// IMP=0x00100000001b2d79
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x00100000001b2896
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x00100000001b27ff
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x00100000001b2722
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x00100000001b24f1
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x00100000001b2453
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x00100000001b22ca
- (void)startOctagonStateMachine;	// IMP=0x00100000001b2259
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x00100000001b20f0
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x00100000001b1de6
