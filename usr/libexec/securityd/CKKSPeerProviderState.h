...
+ (id)createFromProvider:(id)arg1;	// IMP=0x004000000012935d
+ (id)noPeersState:(id)arg1;	// IMP=0x001000000012924a
- (void).cxx_destruct;	// IMP=0x00200000001291f6
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000128201
- (id)description;	// IMP=0x00100000001280cf
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x0010000000127dde
