...
- (void).cxx_destruct;	// IMP=0x002000000007c6c7
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x001000000007c305
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x001000000007c148
- (void)groupStart;	// IMP=0x001000000007ba0c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x001000000007b8be
