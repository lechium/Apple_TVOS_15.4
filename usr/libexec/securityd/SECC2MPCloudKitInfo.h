...
+ (Class)clientOperationType;	// IMP=0x002000000015d2b9
+ (Class)operationGroupType;	// IMP=0x001000000015d2a8
- (void).cxx_destruct;	// IMP=0x002000000015cc26
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000015c791
- (unsigned long long)hash;	// IMP=0x001000000015c61e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015c398
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015bf55
- (void)copyTo:(id)arg1;	// IMP=0x001000000015bcd4
- (void)writeTo:(id)arg1;	// IMP=0x001000000015b992
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000015b985
- (id)dictionaryRepresentation;	// IMP=0x001000000015b327
- (id)description;	// IMP=0x001000000015b278
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x001000000015b1cb
- (unsigned long long)clientOperationsCount;	// IMP=0x001000000015b1ae
- (void)addClientOperation:(id)arg1;	// IMP=0x001000000015b144
- (void)clearClientOperations;	// IMP=0x001000000015b127
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x001000000015b072
- (unsigned long long)operationGroupsCount;	// IMP=0x001000000015b055
- (void)addOperationGroup:(id)arg1;	// IMP=0x001000000015afeb
- (void)clearOperationGroups;	// IMP=0x001000000015afce
