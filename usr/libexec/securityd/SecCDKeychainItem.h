...
- (void).cxx_destruct;	// IMP=0x0020000000040680
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x00100000000400fe
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x001000000003f9cb
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x001000000003f550
- (id)primaryKeys;	// IMP=0x001000000003f53a
...
- (id)description;	// IMP=0x001000000003f358
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003f287
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x001000000003ef1b
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x001000000003edce
