...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001b0fad
- (void).cxx_destruct;	// IMP=0x00200000001b0f64
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001b0d69
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001b0b60
- (id)description;	// IMP=0x00100000001b0a09
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 secureElementIdentity:(id)arg4 viewList:(id)arg5;	// IMP=0x00100000001b0907
