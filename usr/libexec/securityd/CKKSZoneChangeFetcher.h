...
- (void).cxx_destruct;	// IMP=0x00200000001ba06e
...
- (void)halt;	// IMP=0x00100000001b9c68
- (void)cancel;	// IMP=0x00100000001b9c2b
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x00100000001b9c19
- (id)createSuccesfulFetchDependency;	// IMP=0x00100000001b9bae
- (void)_onqueueCreateNewFetch;	// IMP=0x00100000001b941e
- (void)maybeCreateNewFetch;	// IMP=0x00100000001b93ad
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00100000001b91ab
- (id)inflightFetch;	// IMP=0x00100000001b90b4
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x00100000001b8f77
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x00100000001b8bcb
- (void)notifyZoneChange:(id)arg1;	// IMP=0x00100000001b8af0
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x00100000001b8a8a
- (id)strongClientMap;	// IMP=0x00100000001b8802
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000001b8736
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x00100000001b82b2
