...
- (void).cxx_destruct;	// IMP=0x002000000007dc49
...
- (void)proceedAfterFetch;	// IMP=0x001000000007d6fa
- (void)groupStart;	// IMP=0x001000000007d405
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000007d33f
