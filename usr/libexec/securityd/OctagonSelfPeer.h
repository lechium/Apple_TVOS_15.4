...
- (void).cxx_destruct;	// IMP=0x0020000000042b0b
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0010000000042a11
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x001000000004279e
