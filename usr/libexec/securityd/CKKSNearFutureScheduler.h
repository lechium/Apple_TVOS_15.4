...
- (void).cxx_destruct;	// IMP=0x00200000000a8814
...
- (void)cancel;	// IMP=0x00100000000a85da
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000a8020
- (void)trigger;	// IMP=0x00100000000a7f5b
- (void)_onqueueTimerTick;	// IMP=0x00100000000a7c16
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000a7b46
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000a7aca
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000a78f5
- (id)makeOperationDependency;	// IMP=0x00100000000a7828
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000a77a1
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000a75c5
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000a756a
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000a7546
