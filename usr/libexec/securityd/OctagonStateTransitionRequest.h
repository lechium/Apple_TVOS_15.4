...
- (void).cxx_destruct;	// IMP=0x002000000019a195
...
- (id)timeout:(unsigned long long)arg1;	// IMP=0x001000000019a03f
- (id)_onqueueStart;	// IMP=0x0010000000199fba
- (id)description;	// IMP=0x0010000000199ef0
- (id)init:(id)arg1 sourceStates:(id)arg2 serialQueue:(id)arg3 timeout:(unsigned long long)arg4 transitionOp:(id)arg5;	// IMP=0x0010000000199df4
