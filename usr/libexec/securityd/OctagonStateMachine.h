...
- (void).cxx_destruct;	// IMP=0x0020000000112d80
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 transitionOp:(id)arg4 reply:(CDUnknownBlockType)arg5;	// IMP=0x0010000000112605
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00100000001124c0
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x00100000001124ae
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000011210a
- (void)_onqueueRegisterMultiStateArrivalWatcher:(id)arg1;	// IMP=0x0010000000111fce
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x0010000000111f1c
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x0010000000111e6a
- (void)handleExternalRequest:(id)arg1;	// IMP=0x0010000000111db8
- (void)haltOperation;	// IMP=0x0010000000111d0c
- (void)startOperation;	// IMP=0x0010000000111c9b
- (_Bool)isPaused;	// IMP=0x0010000000111bd1
- (void)testReleaseStateMachinePause:(id)arg1;	// IMP=0x0010000000111b1f
- (void)testPauseStateMachineAfterEntering:(id)arg1;	// IMP=0x0010000000111a6d
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x00100000001110d5
- (void)_onqueueRecheckConditions;	// IMP=0x001000000011079c
- (id)possiblePendingFlags;	// IMP=0x001000000011074c
- (id)dumpPendingFlags;	// IMP=0x0010000000110627
- (void)disablePendingFlags;	// IMP=0x00100000001105b6
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x001000000011038f
- (void)_onqueueHandlePendingFlagLater:(id)arg1;	// IMP=0x00100000001102b5
- (void)handlePendingFlag:(id)arg1;	// IMP=0x0010000000110203
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x001000000011015e
- (void)handleFlag:(id)arg1;	// IMP=0x00100000001100ac
- (void)_onqueuePokeStateMachine;	// IMP=0x0010000000110057
- (void)pokeStateMachine;	// IMP=0x001000000010ffe6
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x001000000010fe7f
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x001000000010f987
- (id)_onqueueNextStateMachineTransition;	// IMP=0x001000000010f526
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x001000000010f46f
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x001000000010f136
- (id)pendingFlagsString;	// IMP=0x001000000010f0b5
@property(readonly) NSDictionary *stateConditions;
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8;	// IMP=0x001000000010ea43
