...
- (void).cxx_destruct;	// IMP=0x00200000000a509f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000a4dff
- (unsigned long long)hash;	// IMP=0x00100000000a4cc4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a4ab1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a4917
- (void)copyTo:(id)arg1;	// IMP=0x00100000000a47d6
- (void)writeTo:(id)arg1;	// IMP=0x00100000000a4694
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000a40f5
- (id)dictionaryRepresentation;	// IMP=0x00100000000a3d9a
- (id)description;	// IMP=0x00100000000a3ceb
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00100000000a3b0d
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00100000000a3aa1
