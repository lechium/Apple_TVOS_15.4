...
- (void).cxx_destruct;	// IMP=0x00200000001a14db
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a0c2e
- (unsigned long long)hash;	// IMP=0x00100000001a05ea
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019fd52
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019f77d
- (void)copyTo:(id)arg1;	// IMP=0x001000000019f270
- (void)writeTo:(id)arg1;	// IMP=0x001000000019ed35
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000019ed28
- (id)dictionaryRepresentation;	// IMP=0x001000000019e0b2
- (id)description;	// IMP=0x001000000019e003
