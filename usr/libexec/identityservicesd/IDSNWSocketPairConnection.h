...
- (void).cxx_destruct;	// IMP=0x002000000069fdb0
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x001000000069f230
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x001000000069eaf0
- (double)lastSocketActivityTime;	// IMP=0x001000000069ead0
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000069e2f0
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000069e280
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x001000000069cda0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x001000000069cd40
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x001000000069bd90
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000069bcd0
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x001000000069bc30
- (void)endSession;	// IMP=0x001000000069b930
- (void)dealloc;	// IMP=0x001000000069b840
- (void)start;	// IMP=0x001000000069a650
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x001000000069a370
