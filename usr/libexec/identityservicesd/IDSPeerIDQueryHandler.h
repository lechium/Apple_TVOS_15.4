...
+ (int)queryRetryNumberForBadSignature;	// IMP=0x00200000005aada0
+ (double)queryRetryIntervalForBadSignature;	// IMP=0x00100000005aacd0
+ (_Bool)isQueryRetryForBadSignatureEnabled;	// IMP=0x00100000005aac10
+ (int)serverBackoffModeReceiverRetryInterval;	// IMP=0x00100000005aaac0
+ (int)serverBackoffModeMaxSenderRetries;	// IMP=0x00100000005aa970
+ (_Bool)isServerBackoffModeActive;	// IMP=0x00100000005aa8d0
+ (_Bool)shouldUseSelfTokens;	// IMP=0x00100000005aa800
- (void).cxx_destruct;	// IMP=0x00200000005b9190
...
- (void)removeCompletionBlockForToken:(id)arg1;	// IMP=0x00100000005b8c50
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forToken:(id)arg2;	// IMP=0x00100000005b8780
- (_Bool)startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000005b85c0
- (void)_dequeuePendingQueryIfPossible;	// IMP=0x00100000005ad4e0
- (void)_startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000005ac790
- (void)_removeCompletionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x00100000005ac290
- (id)_completionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x00100000005ac0d0
- (_Bool)_addCompletionBlock:(CDUnknownBlockType)arg1 forURIs:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5;	// IMP=0x00100000005ab590
- (void)_bagLoaded:(id)arg1;	// IMP=0x00100000005ab2c0
- (void)dealloc;	// IMP=0x00100000005ab220
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2 dualMessageDelivery:(id)arg3 networkChangeNotifier:(id)arg4 pushHandler:(id)arg5;	// IMP=0x00100000005aafe0
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2;	// IMP=0x00100000005aae60
