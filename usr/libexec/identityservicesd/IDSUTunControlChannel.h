...
- (void).cxx_destruct;	// IMP=0x00200000001d4b20
...
- (void)resumeOTRNegotiation;	// IMP=0x00100000001d4700
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x00100000001d46c0
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001d4670
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001d4630
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001d3a90
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x00100000001d3a20
- (void)_destroyFairplayDeviceSession;	// IMP=0x00100000001d3a10
- (void)_destroyFairplayHostSession;	// IMP=0x00100000001d3a00
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x00100000001d3930
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x00100000001d38e0
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x00100000001d3890
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x00100000001d3840
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x00100000001d3820
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x00100000001d3800
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x00100000001d37f0
- (void)dealloc;	// IMP=0x00100000001d37a0
- (void)invalidate;	// IMP=0x00100000001d3730
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x00100000001d3680
- (void)sendMessage:(id)arg1;	// IMP=0x00100000001d35d0
- (void)_checkSendNewMessage;	// IMP=0x00100000001d1e60
- (void)_clearChannel;	// IMP=0x00100000001d1ca0
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x00100000001d1c40
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x00100000001d19c0
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x00100000001d18f0
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x00100000001d0350
- (void)writeToConnection;	// IMP=0x00100000001cf760
- (void)readFromConnection;	// IMP=0x00100000001cd6c0
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x00100000001cd690
- (void)simulateDecryptionFailure;	// IMP=0x00100000001cd5c0
- (void)_cleanupConnection;	// IMP=0x00100000001cd510
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001cd220
- (id)description;	// IMP=0x00100000001cd110
