...
- (void).cxx_destruct;	// IMP=0x0020000000407dd0
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x0010000000407380
- (void)_addRemotePacketOutage;	// IMP=0x00100000004072d0
- (id)description;	// IMP=0x00100000004071c0
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00100000004070e0
