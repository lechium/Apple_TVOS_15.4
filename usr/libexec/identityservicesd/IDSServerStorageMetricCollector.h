...
- (void).cxx_destruct;	// IMP=0x00200000003f71f0
...
- (id)dictionaryMetric;	// IMP=0x00100000003f6d70
- (void)reportMetric;	// IMP=0x00100000003f6b40
- (void)endCollector;	// IMP=0x00100000003f6ad0
- (void)incrementMessageCount;	// IMP=0x00100000003f6a80
- (id)awdLogger;	// IMP=0x00100000003f6a50
- (id)initWithTopic:(id)arg1 isPrimary:(_Bool)arg2;	// IMP=0x00100000003f6920
