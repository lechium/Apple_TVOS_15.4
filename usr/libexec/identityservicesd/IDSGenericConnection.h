...
- (void).cxx_destruct;	// IMP=0x002000000056d090
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x001000000056b5c0
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x001000000056ae50
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x001000000056ac30
- (void)invalidate;	// IMP=0x001000000056a250
- (void)dealloc;	// IMP=0x001000000056a160
- (void)_closeSockets;	// IMP=0x0010000000569a50
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000005695f0
- (id)flagsString;	// IMP=0x00100000005694f0
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000005694d0
- (id)description;	// IMP=0x0010000000568f60
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x0010000000568b50
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x0010000000568750
