...
+ (id)sharedInstance;	// IMP=0x004000000006ac30
- (void).cxx_destruct;	// IMP=0x002000000006caf0
...
- (void)_initializePluginWithClass:(Class)arg1;	// IMP=0x001000000006bdc0
- (void)_initializePlugin;	// IMP=0x001000000006ba20
- (void)executeSynchronouslyOnCallbackQueue:(CDUnknownBlockType)arg1;	// IMP=0x001000000006b930
- (void)initializePluginWithClass:(Class)arg1;	// IMP=0x001000000006b850
- (void)notifyWatchToStopAdvertising;	// IMP=0x001000000006b540
- (void)notifyWatchDidStopAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x001000000006b350
- (void)notifyWatchToStartAdvertising;	// IMP=0x001000000006b040
- (void)notifyWatchDidStartAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x001000000006ae90
- (id)init;	// IMP=0x001000000006acf0
