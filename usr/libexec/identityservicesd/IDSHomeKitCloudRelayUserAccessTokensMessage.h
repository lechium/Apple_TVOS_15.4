...
- (void).cxx_destruct;	// IMP=0x0020000000068ed0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000068c00
- (id)bagKey;	// IMP=0x0010000000068be0
- (id)messageBody;	// IMP=0x0010000000068a30
- (id)additionalMessageHeaders;	// IMP=0x0010000000068850
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000068630
