...
- (void).cxx_destruct;	// IMP=0x0020000000544ea0
...
- (void)purgeData;	// IMP=0x0010000000544c20
- (void)saveData:(id)arg1;	// IMP=0x0010000000544830
- (id)data;	// IMP=0x0010000000544490
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x0010000000544300
