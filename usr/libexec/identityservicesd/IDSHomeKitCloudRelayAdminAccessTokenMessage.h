...
- (void).cxx_destruct;	// IMP=0x00200000004822f0
@property(copy) NSNumber *responseExpiry; // @synthesize responseExpiry=_responseExpiry;
- (void)setResponseAdminAcccessToken:(id)arg1;	// IMP=0x0010000000482240
- (id)responseAdminAcccessToken;	// IMP=0x0010000000482210
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000481ef0
- (id)bagKey;	// IMP=0x0010000000481ed0
- (id)messageBody;	// IMP=0x0010000000481d80
- (id)additionalMessageHeaders;	// IMP=0x0010000000481ba0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000481930
