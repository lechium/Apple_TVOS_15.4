...
@class MISSING_TYPE, NSData, NSDate, NSDictionary, NSNumber, NSString;
...
- (id)messageBody;	// IMP=0x001000000016c9d0
- (id)requiredKeys;	// IMP=0x001000000016c8c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016c520
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x001000000016c460
- (id)init;	// IMP=0x001000000016c3c0
