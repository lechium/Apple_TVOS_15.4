...
- (void).cxx_destruct;	// IMP=0x00200000006a78c0
...
- (_Bool)_missingDeviceIdentity:(_Bool *)arg1;	// IMP=0x00100000006a77e0
- (void)recertifyDeviceIfNeeded;	// IMP=0x00100000006a77d0
- (void)_repairTimerHit:(id)arg1;	// IMP=0x00100000006a7780
- (id)init;	// IMP=0x00100000006a76b0
