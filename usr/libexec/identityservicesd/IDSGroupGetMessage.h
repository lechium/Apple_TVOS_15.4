...
- (void).cxx_destruct;	// IMP=0x0020000000679420
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000678f10
- (id)bagKey;	// IMP=0x0010000000678ef0
- (id)requiredKeys;	// IMP=0x0010000000678e90
- (id)messageBody;	// IMP=0x0010000000678af0
- (id)additionalMessageHeaders;	// IMP=0x0010000000678810
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000678500
