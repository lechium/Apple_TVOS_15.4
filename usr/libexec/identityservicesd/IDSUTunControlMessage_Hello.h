...
- (void).cxx_destruct;	// IMP=0x00200000001720d0
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x001000000016eb50
- (id)data;	// IMP=0x001000000016dcc0
- (id)init;	// IMP=0x001000000016dc50
- (_Bool)_isTinkerFlagSet;	// IMP=0x001000000016dbd0
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x001000000016db50
- (id)description;	// IMP=0x001000000016d9b0
