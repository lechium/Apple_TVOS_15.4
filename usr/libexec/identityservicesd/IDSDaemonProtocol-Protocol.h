...
@class ENGroupID, IDSMessagingCapabilities, IDSPseudonym, IDSPseudonymProperties, IDSPseudonymRequestProperties, IDSURI, MISSING_TYPE, NSArray, NSData, NSDictionary, NSNumber, NSObject, NSSet, NSString, NSURL;
...
- (MISSING_TYPE *)getProgressUpdateForIdentifier:service: /* Error: Ran out of types for this method. */;
