...
- (void).cxx_destruct;	// IMP=0x0020000000479a70
...
- (id)decryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x0010000000478d50
- (id)encryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x0010000000477ff0
- (id)initWithOTRController:(id)arg1 OTRToken:(id)arg2;	// IMP=0x0010000000477f00
