...
@interface IDSRegistration : NSObject
{
    ...
    id <FTPasswordManager> _passwordManager;	// 304 = 0x130
}

- (void).cxx_destruct;	// IMP=0x00100000006673b0
...
- (id)debugDescription;	// IMP=0x0010000000662e60
- (id)description;	// IMP=0x0010000000662930
- (id)_userStore;	// IMP=0x0010000000662890
- (id)_user;	// IMP=0x0010000000662810
- (void)voidPassword;	// IMP=0x00100000006624a0
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x0010000000662260
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006602c0
...
- (id)_userID;	// IMP=0x001000000065e590
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x001000000065e410
- (void)addCandidateEmail:(id)arg1;	// IMP=0x001000000065e2f0
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x001000000065e270
- (_Bool)removeFromKeychain;	// IMP=0x001000000065e210
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000006584a0
- (id)init;	// IMP=0x0010000000658410
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x0010000000658310
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006582f0
- (id)_keychain_comparisonValue;	// IMP=0x0010000000341160
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x0010000000340f00
