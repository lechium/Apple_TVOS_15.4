...
- (void).cxx_destruct;	// IMP=0x002000000054aeb0
...
- (id)description;	// IMP=0x001000000054a5b0
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x001000000054a520
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x0010000000549e20
