...
- (void).cxx_destruct;	// IMP=0x00200000003fdc20
...
- (void)handler:(id)arg1 receivedOfflineMessagePendingForTopic:(id)arg2 messageContext:(id)arg3;	// IMP=0x00100000003fd860
- (void)handler:(id)arg1 didReceiveMessage:(id)arg2 forTopic:(id)arg3 fromID:(id)arg4 messageContext:(id)arg5;	// IMP=0x00100000003fc350
- (void)sendCertifiedDeliveryReceipt:(id)arg1;	// IMP=0x00100000003fbf00
- (void)sendMessageData:(id)arg1 onTopic:(id)arg2 withOptions:(id)arg3 identifier:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00100000003fb080
- (void)setupServerMessagingClient:(id)arg1 withUUID:(id)arg2 forTopic:(id)arg3;	// IMP=0x00100000003fa8a0
- (void)_recalculateTopics;	// IMP=0x00100000003fa6f0
- (id)_topics;	// IMP=0x00100000003fa650
- (id)_commands;	// IMP=0x00100000003fa600
- (_Bool)_entitledForTopic:(id)arg1;	// IMP=0x00100000003fa3e0
- (id)initWithQueue:(id)arg1 connection:(id)arg2 messageDelivery:(id)arg3 pushHandler:(id)arg4;	// IMP=0x00100000003f99f0
