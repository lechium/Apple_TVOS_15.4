...
- (void).cxx_destruct;	// IMP=0x0020000000692d50
...
- (id)description;	// IMP=0x0010000000692c30
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x0010000000692b40
