...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x00100000001e3fc0
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00100000001e3f30
- (id)init;	// IMP=0x00100000001e3ed0
