...
- (void).cxx_destruct;	// IMP=0x0020000000548010
...
- (void)purgeData;	// IMP=0x0010000000547c80
- (void)saveData:(id)arg1;	// IMP=0x0010000000547b80
- (id)data;	// IMP=0x0010000000547ae0
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x0010000000547780
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x0010000000547690
