...
- (void).cxx_destruct;	// IMP=0x00200000001d4e60
...
- (id)description;	// IMP=0x00100000001d4d30
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x00100000001d4c40
