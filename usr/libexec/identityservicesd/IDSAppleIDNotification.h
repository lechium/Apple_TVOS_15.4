...
@class IDSEndpointCapabilities, MISSING_TYPE, NSDictionary, NSMutableDictionary, NSMutableSet, NSString;
...
@interface IDSAppleIDNotification : NSObject
{
    ...
    MISSING_TYPE *_deviceCapabilities;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x0020000000269420
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x00100000002690d0
- (void)addSession:(id)arg1;	// IMP=0x0010000000269050
- (void)addServiceType:(id)arg1;	// IMP=0x0010000000268ff0
- (void)addAlias:(id)arg1;	// IMP=0x0010000000268f80
- (id)init;	// IMP=0x0010000000268e70
