...
- (void).cxx_destruct;	// IMP=0x00200000006aa8c0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000006aa440
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x00100000006aa420
- (id)bagKey;	// IMP=0x00100000006aa400
- (id)requiredKeys;	// IMP=0x00100000006aa3a0
- (id)messageBody;	// IMP=0x00100000006aa060
- (id)additionalMessageHeaders;	// IMP=0x00100000006a9ed0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006a9bc0
