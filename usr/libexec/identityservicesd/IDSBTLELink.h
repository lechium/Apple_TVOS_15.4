...
@interface IDSBTLELink : NSObject
{
    ...
    CDStruct_727fadec *_incomingPacketBuffer;	// 48 = 0x30
...
- (void).cxx_destruct;	// IMP=0x0020000000169b10
...
- (id)linkID;	// IMP=0x0010000000169960
@property(readonly) unsigned long long state; // @synthesize state=_state;
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x00100000001694e0
- (void)_didReceiveData:(id)arg1;	// IMP=0x00100000001684d0
- (void)didReceiveData:(id)arg1;	// IMP=0x00100000001683c0
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x0010000000167fe0
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000167f60
- (unsigned long long)sendPacketBuffer:(CDStruct_727fadec *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x0010000000167c30
- (id)copyLinkStatsDict;	// IMP=0x0010000000167ad0
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x0010000000167a10
- (void)triggerBTCorruptionRecovery;	// IMP=0x00100000001679e0
- (void)_localDetectedCorruption;	// IMP=0x00100000001679d0
- (void)dealloc;	// IMP=0x0010000000167970
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000001677f0
