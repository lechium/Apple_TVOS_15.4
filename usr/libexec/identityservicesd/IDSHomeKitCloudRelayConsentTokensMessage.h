...
- (void).cxx_destruct;	// IMP=0x00200000004ff970
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000004ff6a0
- (id)bagKey;	// IMP=0x00100000004ff680
- (id)messageBody;	// IMP=0x00100000004ff4d0
- (id)additionalMessageHeaders;	// IMP=0x00100000004ff2f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004ff0d0
