...
- (void).cxx_destruct;	// IMP=0x0020000000547630
...
- (void)purgeData;	// IMP=0x0010000000547030
- (void)saveData:(id)arg1;	// IMP=0x0010000000545d30
- (id)data;	// IMP=0x0010000000545260
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x0010000000544fe0
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x0010000000544ef0
