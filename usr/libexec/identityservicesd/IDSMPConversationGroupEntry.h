...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x0040000000183420
- (void).cxx_destruct;	// IMP=0x0020000000183ed0
...
- (id)description;	// IMP=0x0010000000183b60
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x00100000001837e0
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x00100000001831e0
