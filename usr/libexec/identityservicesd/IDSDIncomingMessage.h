...
- (void).cxx_destruct;	// IMP=0x0020000000503880
...
- (id)initWithMessage:(id)arg1 fromID:(id)arg2 topic:(id)arg3 guid:(id)arg4 isLocal:(_Bool)arg5;	// IMP=0x0010000000503510
