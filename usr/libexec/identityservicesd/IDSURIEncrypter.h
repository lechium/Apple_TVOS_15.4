...
- (void).cxx_destruct;	// IMP=0x00200000000ad920
...
- (void)decryptData:(id)arg1 usingIdentifier:(id)arg2 onQueue:(id)arg3 isRetry:(_Bool)arg4 replayKey:(id)arg5 withCompletion:(CDUnknownBlockType)arg6;	// IMP=0x00100000000aa330
- (void)encryptData:(id)arg1 withEncryptedAttributes:(id)arg2 onQueue:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000a85e0
- (id)encryptData:(id)arg1 withEncryptedAttributes:(id)arg2 usedIdentifier:(id *)arg3 error:(id *)arg4;	// IMP=0x00100000000a83b0
- (_Bool)_isReplayError:(id)arg1;	// IMP=0x00100000000a81b0
- (id)_lookupIdentityWithLastResortFallback:(_Bool *)arg1;	// IMP=0x00100000000a7db0
- (id)_lookupEndpoint;	// IMP=0x00100000000a7c30
- (void)setupWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x00100000000a7b00
- (id)initWithPeerIDManager:(id)arg1 fullDeviceIdentityContainerEncrypter:(id)arg2 rateLimiter:(id)arg3 replayCommitter:(id)arg4 publicIdentityCache:(id)arg5 avoidMainQueue:(_Bool)arg6;	// IMP=0x00100000000a7930
