...
- (void).cxx_destruct;	// IMP=0x002000000014c100
...
- (id)description;	// IMP=0x001000000014bfe0
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x001000000014bed0
