...
+ (id)sharedInstance;	// IMP=0x00400000005397b0
- (void).cxx_destruct;	// IMP=0x002000000053b6e0
@property __weak id <IDSDaemonMIGQueryInterfaceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)denyIncomingGrantRequests;	// IMP=0x001000000053b620
- (void)acceptIncomingGrantRequests;	// IMP=0x001000000053b530
- (void)__setupServer;	// IMP=0x0010000000539870
