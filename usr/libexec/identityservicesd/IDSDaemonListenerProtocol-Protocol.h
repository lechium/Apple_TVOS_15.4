...
@class IDSPseudonym, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSNumber, NSObject, NSSet, NSString, NSUUID;
...
- (MISSING_TYPE *)protobufReceived:withGUID:forTopic:toIdentifier:fromID:context: /* Error: Ran out of types for this method. */;
