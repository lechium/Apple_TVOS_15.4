...
- (void).cxx_destruct;	// IMP=0x002000000000deb0
...
- (id)copyLinkStatsDict;	// IMP=0x001000000000dbb0
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x001000000000d750
- (void)_processIncomingPacket;	// IMP=0x001000000000d740
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x001000000000d6c0
- (unsigned long long)sendPacketBuffer:(CDStruct_727fadec *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000d650
- (void)start;	// IMP=0x001000000000d640
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)invalidate;	// IMP=0x001000000000d5f0
- (void)dealloc;	// IMP=0x001000000000d5a0
- (id)initWithPipe:(id)arg1 withDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000d4f0
