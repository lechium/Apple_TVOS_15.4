...
- (void).cxx_destruct;	// IMP=0x00200000000a5480
...
- (id)messageBody;	// IMP=0x00100000000a3f70
- (id)requiredKeys;	// IMP=0x00100000000a3e90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a3910
- (void)logFailureInfo;	// IMP=0x00100000000a30b0
- (_Bool)expectingMoreResponses;	// IMP=0x00100000000a3070
- (id)_processMessageResponseForMessage:(id)arg1 withError:(id)arg2 resultCode:(long long)arg3 toURI:(id)arg4 fromURI:(id)arg5 service:(id)arg6 fromIdentity:(id)arg7;	// IMP=0x00100000000a1a50
- (void)noteResponseForToken:(id)arg1;	// IMP=0x00100000000a0df0
- (void)callAllAckBlocks;	// IMP=0x00100000000a0ba0
- (void)clearAllPendingResponseTokens;	// IMP=0x00100000000a0b20
- (void)callAllIndividualCompletionBlocksWithDeliveryContext:(id)arg1;	// IMP=0x00100000000a08b0
- (_Bool)removeAllAggregatableMessages;	// IMP=0x00100000000a0770
- (_Bool)addAggregatableMessage:(id)arg1;	// IMP=0x00100000000a05e0
- (_Bool)hasSpaceForAggregatableMessage:(id)arg1;	// IMP=0x00100000000a0520
- (id)initWithPeerMessage:(id)arg1 service:(id)arg2 fromIdentity:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x001000000009fe70
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x001000000009fda0
- (id)init;	// IMP=0x001000000009fd00
