...
- (void).cxx_destruct;	// IMP=0x00200000001c2a10
...
- (id)_legacyIdentity;	// IMP=0x00100000001c2860
- (_Bool)allowMessageData:(id)arg1 withDelayedCommitBlock:(CDUnknownBlockType *)arg2;	// IMP=0x00100000001c2580
- (_Bool)allowMessageData:(id)arg1;	// IMP=0x00100000001c23c0
- (id)initWithRegistrationKeyManager:(id)arg1 messageHashStore:(id)arg2 usePairingKey:(_Bool)arg3;	// IMP=0x00100000001c22b0
- (id)initWithRegistrationKeyManager:(id)arg1;	// IMP=0x00100000001c21e0
