...
- (void)performSyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001c1cd0
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001c1c60
- (id)initWithName:(char *)arg1 qosClass:(unsigned int)arg2 specific:(char *)arg3;	// IMP=0x00100000001c1aa0
