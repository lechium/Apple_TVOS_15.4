...
- (void).cxx_destruct;	// IMP=0x002000000029fe30
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000029f930
- (_Bool)wantsHTTPGet;	// IMP=0x001000000029f910
- (id)additionalQueryStringParameters;	// IMP=0x001000000029f700
- (id)additionalMessageHeaders;	// IMP=0x001000000029f490
- (id)bagKey;	// IMP=0x001000000029f470
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000029f1b0
