...
- (void).cxx_destruct;	// IMP=0x002000000016a6a0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000016a220
- (id)bagKey;	// IMP=0x001000000016a200
- (id)requiredKeys;	// IMP=0x001000000016a1a0
- (id)messageBody;	// IMP=0x0010000000169fc0
- (id)additionalMessageHeaders;	// IMP=0x0010000000169e30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000169bc0
