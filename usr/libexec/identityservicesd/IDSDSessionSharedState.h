...
@interface IDSDSessionSharedState : NSObject
{
    ...
    _Bool _bypassKeyMaterialReadyCheck;	// 14 = 0xe
    _Bool _encryptionInitialized;	// 15 = 0xf
    _Atomic _Bool _endSessionTimerCleared;	// 16 = 0x10
    _Bool _forceInternetInvitation;	// 17 = 0x11
    _Bool _isInitiator;	// 18 = 0x12
    _Bool _isInUPlusOneMode;	// 19 = 0x13
    _Bool _isScreenSharingSession;	// 20 = 0x14
    _Atomic _Bool _inviteTimerCleared;	// 21 = 0x15
    _Bool _sharedSession;	// 22 = 0x16
    _Bool _useBTDatagramPipe;	// 23 = 0x17
    _Bool _useSecureQRControlMessage;	// 24 = 0x18
    _Bool _useQRDirectly;	// 25 = 0x19
    ...
    NSArray *_pluginRequests;	// 216 = 0xd8
    NSNumber *_remoteUseCloudPairedControlChannel;	// 224 = 0xe0
    NSNumber *_remoteUsePhoneContinuityLocalMessage;	// 232 = 0xe8
    NSString *_serviceName;	// 240 = 0xf0
    NSDate *_startConnectingDate;	// 248 = 0xf8
    long long _transportType;	// 256 = 0x100
    NSString *_uniqueID;	// 264 = 0x108
    NSArray *_requiredLackOfCapabilities;	// 272 = 0x110
    NSArray *_requiredCapabilities;	// 280 = 0x118
    IDSMPFullLegacyIdentity *_localUnauthenticatedFullIdentity;	// 288 = 0x120
    IDSMPPublicLegacyIdentity *_remoteUnauthenticatedPublicIdentity;	// 296 = 0x128
    id <IDSDSession> _delegate;	// 304 = 0x130
    CDStruct_eff2b79e _encryptionStateStruct;	// 312 = 0x138
}

- (void).cxx_destruct;	// IMP=0x0020000000535b10
...
@property(nonatomic) _Bool bypassKeyMaterialReadyCheck; // @synthesize bypassKeyMaterialReadyCheck=_bypassKeyMaterialReadyCheck;
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x0010000000534400
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x0010000000534330
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00100000005342c0
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x0010000000533ee0
- (_Bool)supportsReinitiate;	// IMP=0x0010000000533de0
- (void)_endSessionTimedOut;	// IMP=0x0010000000533c80
- (void)setEndSessionTimeoutTimer;	// IMP=0x0010000000533a00
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x0010000000533810
- (void)_clearPacketLossTimer;	// IMP=0x0010000000533690
- (void)_connectionTimedOut;	// IMP=0x0010000000533540
- (void)setConnectionTimer;	// IMP=0x00100000005330d0
- (void)_clearConnectionTimer;	// IMP=0x0010000000532ee0
- (void)_clearInvitationTimer;	// IMP=0x0010000000532cf0
- (void)_inviteTimedOut;	// IMP=0x0010000000532b30
- (void)setInvitationTimer;	// IMP=0x00100000005328a0
- (void)clearAllTimers;	// IMP=0x0010000000532840
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x001000000052fae0
