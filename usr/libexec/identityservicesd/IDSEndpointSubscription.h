...
- (void).cxx_destruct;	// IMP=0x0020000000015710
...
- (void)_signalDidUpdateEndpoints;	// IMP=0x00100000000154f0
- (void)_noteSourceDidDiscoverEndpointMap:(id)arg1 forLocalURI:(id)arg2;	// IMP=0x0010000000014f30
- (void)_registerEndpointQueryCompletionBlock;	// IMP=0x0010000000014bf0
- (id)resolvedEndpoints;	// IMP=0x0010000000014930
- (void)initializeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000014230
- (id)peerIDManager;	// IMP=0x0010000000014200
- (id)description;	// IMP=0x00100000000140f0
- (void)dealloc;	// IMP=0x0010000000014070
- (id)initWithServiceIdentifier:(id)arg1 localURI:(id)arg2 subscribedURIs:(id)arg3 queue:(id)arg4;	// IMP=0x0010000000013ec0
