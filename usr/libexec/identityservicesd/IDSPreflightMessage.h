...
- (void).cxx_destruct;	// IMP=0x0020000000018130
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000017820
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000017800
- (id)bagKey;	// IMP=0x00100000000177e0
- (id)requiredKeys;	// IMP=0x0010000000017780
- (id)messageBody;	// IMP=0x0010000000017290
- (id)additionalMessageHeaders;	// IMP=0x0010000000017100
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000016d50
