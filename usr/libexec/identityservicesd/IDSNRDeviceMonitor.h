...
- (void).cxx_destruct;	// IMP=0x0020000000006950
...
- (id)init;	// IMP=0x0010000000006840
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x00100000000067a0
