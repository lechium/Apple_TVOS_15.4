...
- (void).cxx_destruct;	// IMP=0x00200000003fe170
...
- (_Bool)wantsBinaryPush;	// IMP=0x00100000003fe0a0
- (id)messageBody;	// IMP=0x00100000003fdea0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000003fdde0
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x00100000003fdcb0
