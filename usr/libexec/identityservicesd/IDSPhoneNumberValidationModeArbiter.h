...
- (void).cxx_destruct;	// IMP=0x0020000000462fc0
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x0010000000462750
...
- (id)initWithServerBag:(id)arg1;	// IMP=0x0010000000462290
- (id)init;	// IMP=0x0010000000462200
