...
@class IDSProtobuf, IDSSocketPairMessage, MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString;
...
@interface IDSLocalDeliveryMessage : NSObject
{
    ...
    MISSING_TYPE *_sentMessageDataSize;	// 200 = 0xc8
...
- (id)socketPairMessage;	// IMP=0x00100000002a1540
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x00100000002a14e0
- (void)kickProgressBlock;	// IMP=0x00100000002a1330
- (id)init;	// IMP=0x00100000002a1090
