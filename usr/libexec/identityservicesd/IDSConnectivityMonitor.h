...
@class IDSNRDeviceMonitor, MISSING_TYPE, NSDate, NSString, NSTimer;
...
@interface IDSConnectivityMonitor : NSObject
{
    ...
    MISSING_TYPE *_lastConnection;	// 64 = 0x40
    NSDate *_lastDisconnection;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x00200000001c9cd0
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x00100000001c98c0
- (void)sendMonitorMessage;	// IMP=0x00100000001c8f70
- (void)checkConnectivityState:(id)arg1;	// IMP=0x00100000001c8b70
- (id)init;	// IMP=0x00100000001c8ae0
