...
+ (id)sharedInstance;	// IMP=0x002000000016a760
- (void).cxx_destruct;	// IMP=0x002000000016c380
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x001000000016bfd0
- (unsigned int)_nextMessageID;	// IMP=0x001000000016bfb0
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x001000000016a9f0
- (void)dealloc;	// IMP=0x001000000016a990
- (id)init;	// IMP=0x001000000016a900
- (id)initWithRapportClient:(id)arg1;	// IMP=0x001000000016a820
