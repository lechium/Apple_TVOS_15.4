...
- (id)createEndpoint;	// IMP=0x0020000000001925
- (id)allClients;	// IMP=0x00100000000018e7
- (void)start;	// IMP=0x0010000000001706
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000168c
- (void)invalidate;	// IMP=0x001000000000153a
- (id)__invalidate;	// IMP=0x00100000000014f7
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x00100000000014eb
- (id)dispatchQueue;	// IMP=0x00100000000014e1
...
- (void)dealloc;	// IMP=0x00100000000012fa
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x0010000000001245
