...
+ (id)bundleIdentifierFromAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x00200000000035d5
...
- (void)registerClassIDs:(id)arg1;	// IMP=0x0010000000006a97
- (id)reloadTokenClassesFromStore;	// IMP=0x0010000000005e58
- (void)loadTokensFromStore:(id)arg1;	// IMP=0x0010000000005099
- (void)failedToken:(id)arg1;	// IMP=0x0010000000004ecb
- (void)disconnectedToken:(id)arg1;	// IMP=0x0010000000004bd5
- (void)connectedToken:(id)arg1 notifyAddedToken:(_Bool)arg2;	// IMP=0x0010000000004933
- (id)createTokenWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x0010000000004696
- (void)notifyTokenReinsertion:(id)arg1;	// IMP=0x0010000000004587
- (void)removeTokenWithTokenID:(id)arg1;	// IMP=0x00100000000042f9
- (id)tokenWithTokenID:(id)arg1;	// IMP=0x00100000000041c2
- (void)commitTransaction;	// IMP=0x0010000000003cbb
- (void)markModified;	// IMP=0x0010000000003c89
@property(readonly, nonatomic) NSDictionary *tokenExtensions;
- (id)beginTransaction;	// IMP=0x0010000000003b62
@property(readonly, nonatomic) NSArray *tokens;
- (void)dealloc;	// IMP=0x0010000000003abc
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003932
- (id)initWithDriverCache:(id)arg1 listener:(id)arg2 keychain:(id)arg3;	// IMP=0x0010000000003439
