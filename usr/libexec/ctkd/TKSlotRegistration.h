...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000c154
- (void).cxx_destruct;	// IMP=0x002000000000c6dc
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000c21e
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000000c0c2
