...
+ (id)keychainItemClasses;	// IMP=0x002000000000219c
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001887
- (void).cxx_destruct;	// IMP=0x00200000000025fc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000240e
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000022d2
- (id)connectionWithError:(id *)arg1;	// IMP=0x0010000000001aa7
- (id)description;	// IMP=0x00100000000019b0
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2 automatic:(_Bool)arg3;	// IMP=0x001000000000188f
