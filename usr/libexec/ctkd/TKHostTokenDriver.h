...
- (void).cxx_destruct;	// IMP=0x0020000000012c74
...
- (void)dealloc;	// IMP=0x0010000000012b2a
- (void)releaseTokenWithTokenID:(id)arg1;	// IMP=0x00100000000129f2
- (_Bool)configureWithError:(id *)arg1;	// IMP=0x001000000001282e
- (id)acquireTokenWithSlot:(id)arg1 AID:(id)arg2 tokenID:(id *)arg3 error:(id *)arg4;	// IMP=0x00100000000122a6
- (id)acquireTokenWithTokenID:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000011d62
@property(readonly, nonatomic) TKTokenDriverHostContext *context;
- (id)contextWithError:(id *)arg1;	// IMP=0x0010000000010e1e
@property(readonly, nonatomic) _Bool valid;
- (void)invalidate;	// IMP=0x0010000000010d51
- (void)keepAlive:(_Bool)arg1;	// IMP=0x0010000000010c0d
@property(readonly, nonatomic) NSString *classID;
- (id)description;	// IMP=0x00100000000109c4
- (id)initWithExtension:(id)arg1 cache:(id)arg2;	// IMP=0x001000000001092b
