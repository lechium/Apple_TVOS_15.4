...
- (id)_createAnimationTransaction;	// IMP=0x001000000000a550
- (void)animateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000a0a0
- (id)initWithContainingView:(id)arg1 goingFullScreenLayout:(id)arg2 goingToPIPLayout:(id)arg3 quadrant:(long long)arg4;	// IMP=0x0010000000009f60
