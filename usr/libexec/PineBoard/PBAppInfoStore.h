...
- (void).cxx_destruct;	// IMP=0x002000000002c0b0
...
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 applicationInfo:(id)arg4;	// IMP=0x001000000002b7f0
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 placeholder:(id)arg4;	// IMP=0x001000000002b510
- (void)queue_processUpdates:(id)arg1;	// IMP=0x0010000000029110
- (void)_extraMultiUserApplicationsDidChange;	// IMP=0x0010000000028d90
- (void)languageDidChange;	// IMP=0x00100000000289e0
- (void)applicationIconDidChange:(id)arg1;	// IMP=0x0010000000028570
- (void)placeholderDidChangeSignificantly:(id)arg1;	// IMP=0x00100000000283e0
- (void)placeholderProgressDidUpdate:(id)arg1;	// IMP=0x0010000000028250
- (void)handleDynamicStateChanged:(id)arg1;	// IMP=0x00100000000281c0
- (void)handlePolicyChanged:(id)arg1;	// IMP=0x0010000000028130
- (id)appInfoControllerWithEnabledApps;	// IMP=0x00100000000280a0
- (id)appInfoControllerWithEnabledAndVisibleApps;	// IMP=0x0010000000028010
- (id)appInfoControllerWithEnabledAndVisibleAppsAndPlaceholders;	// IMP=0x0010000000027f80
- (id)appInfoControllerWithEverything;	// IMP=0x0010000000027f30
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000027e30
- (void)_enqueueUpdate:(id)arg1;	// IMP=0x0010000000027c90
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000027b70
- (id)addObserver:(id)arg1;	// IMP=0x0010000000027890
- (id)configuration;	// IMP=0x0010000000027730
- (id)appInfos;	// IMP=0x00100000000274e0
- (void)dealloc;	// IMP=0x00100000000271c0
- (id)initWithApplicationLibrary:(id)arg1 policy:(id)arg2 dynamicStateDataSource:(id)arg3;	// IMP=0x0010000000025ce0
