...
- (void).cxx_destruct;	// IMP=0x002000000008d650
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000008c9e0
- (void)setServiceDelegate:(id)arg1;	// IMP=0x001000000008c960
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x001000000008c210
- (void)invalidate;	// IMP=0x001000000008c200
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x001000000008bd10
- (id)init;	// IMP=0x001000000008bce0
