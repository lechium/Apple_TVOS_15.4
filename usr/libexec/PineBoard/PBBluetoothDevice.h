...
- (void).cxx_destruct;	// IMP=0x00200000000905d0
...
- (unsigned long long)hash;	// IMP=0x0010000000090380
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008ff10
- (id)description;	// IMP=0x001000000008fd20
- (id)initWithBluetoothDevice:(id)arg1;	// IMP=0x001000000008fb00
- (id)initWithPeripheral:(id)arg1;	// IMP=0x001000000008f950
