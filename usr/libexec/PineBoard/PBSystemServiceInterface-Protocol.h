...
@class INDateComponentsRange, NSArray, NSData, NSDictionary, NSNumber, NSString, NSXPCListenerEndpoint, PBSAudioUpsellConfiguration;
...
- (void)registerSystemHomeUIServiceEndpoint:(NSXPCListenerEndpoint *)arg1 completion:(void (^)(NSError *))arg2;
- (void)fetchSystemHomeUIServiceEndpoint:(void (^)(NSXPCListenerEndpoint *, NSError *))arg1;
