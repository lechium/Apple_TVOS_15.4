...
- (void).cxx_destruct;	// IMP=0x00200000002044f0
...
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00100000002042a0
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000204050
...
- (id)initWithChildViewController:(id)arg1 allowsInteraction:(_Bool)arg2 expectsEventForwarding:(_Bool)arg3;	// IMP=0x0010000000203ef0
