...
- (void).cxx_destruct;	// IMP=0x0020000000179170
- (id);	// IMP=0x0010000000179150
...
- (void)_didComplete;	// IMP=0x0010000000178e40
- (void)_begin;	// IMP=0x0010000000178340
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000178320
- (double)watchdogTimeout;	// IMP=0x0010000000178300
- (_Bool)shouldWatchdog:(id *)arg1;	// IMP=0x00100000001782e0
@property(readonly, nonatomic, getter=isFresh) _Bool fresh;
- (id)init;	// IMP=0x00100000001781a0
- (id)initWithLog:(id)arg1 identityProviderInfoCenter:(id)arg2 currentBundleIdentifier:(id)arg3;	// IMP=0x0010000000178040
