...
- (void).cxx_destruct;	// IMP=0x00200000000bdac0
...
- (_Bool)_needsUI;	// IMP=0x00100000000bd860
- (void)_begin;	// IMP=0x00100000000bd260
- (id)initWithRequest:(id)arg1;	// IMP=0x00100000000bd050
