...
+ (id)pb_CRDSceneIdentity;	// IMP=0x0020000000051160
+ (id)pb_TVWatchListSceneIdentity;	// IMP=0x0010000000050fe0
+ (id)pb_idleScreenSceneIdentity;	// IMP=0x0010000000050e60
+ (id)pb_kioskAppSceneIdentity;	// IMP=0x0010000000050d10
+ (id)pb_defaultKioskAppSceneIdentity;	// IMP=0x0010000000050b90
+ (id)_pb_defaultSceneIdentity;	// IMP=0x0010000000050af0
+ (id)pb_uniqueIdentityForApplicationIdentifier:(id)arg1 role:(id)arg2;	// IMP=0x0010000000050160
+ (id)pb_identityForApplicationIdentifier:(id)arg1 role:(id)arg2;	// IMP=0x001000000004f850
