...
- (void).cxx_destruct;	// IMP=0x00200000000d1990
...
- (id)description;	// IMP=0x00100000000d1890
- (id)initWithBundleIdentifier:(id)arg1;	// IMP=0x00100000000d1790
- (id)init;	// IMP=0x00100000000d1750
