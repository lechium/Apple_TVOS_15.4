...
- (void).cxx_destruct;	// IMP=0x0020000000056c40
...
- (void)unbiasedAlertView:(id)arg1 didSelectOptionAtIndex:(unsigned long long)arg2;	// IMP=0x0010000000056af0
- (void)_handleMenuButton;	// IMP=0x0010000000056a90
- (id)preferredFocusEnvironments;	// IMP=0x0010000000056980
- (void)viewDidLoad;	// IMP=0x00100000000568b0
- (void)loadView;	// IMP=0x0010000000056850
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000056020
