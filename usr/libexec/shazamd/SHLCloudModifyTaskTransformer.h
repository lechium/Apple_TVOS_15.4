...
- (void).cxx_destruct;	// IMP=0x00200000000246f3
...
- (id)recordIDsToDeleteFromModifyTask:(id)arg1;	// IMP=0x0010000000024207
- (id)recordsToSaveFromModifyTask:(id)arg1 container:(id)arg2;	// IMP=0x0010000000023cdd
- (id)cloudBackedOperationFromModifyTask:(id)arg1 container:(id)arg2;	// IMP=0x00100000000229f5
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000002295a
