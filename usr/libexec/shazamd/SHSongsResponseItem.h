...
- (void).cxx_destruct;	// IMP=0x002000000003179b
@property(retain, nonatomic) NSDictionary *songItemDictionary; // @synthesize songItemDictionary=_songItemDictionary;
- (struct CGSize)targetArtworkImageSizeFromOriginalSize:(struct CGSize)arg1;	// IMP=0x0010000000031719
- (id)artworkURLFromDictionary:(id)arg1;	// IMP=0x0010000000031664
- (id)extractIDsFromRelation:(id)arg1;	// IMP=0x001000000003141f
...
- (id)initWithSongItemDictionary:(id)arg1;	// IMP=0x0010000000030d68
