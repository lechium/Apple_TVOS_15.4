...
- (void).cxx_destruct;	// IMP=0x0020000000004b65
...
- (double)timeRequiredToPerformWork;	// IMP=0x0010000000004ac4
@property(readonly, nonatomic) _Bool managesRecordingSession;
- (id)requiredEntitlements;	// IMP=0x0010000000004a6c
- (oneway void)stop;	// IMP=0x0010000000004a5a
@property(readonly, nonatomic) _Bool isRunning;
- (void)stopTap;	// IMP=0x001000000000490f
- (id)startTap;	// IMP=0x001000000000459e
- (id)initWithRecordingService:(id)arg1;	// IMP=0x0010000000004533
- (id)init;	// IMP=0x00100000000044d9
