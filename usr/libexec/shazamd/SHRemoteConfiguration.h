...
+ (id)bagKeySet;	// IMP=0x004000000000dc9c
+ (id)sharedInstance;	// IMP=0x001000000000dbf4
- (void).cxx_destruct;	// IMP=0x002000000000efd0
...
- (void)defaultValuesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ecc9
- (void)campaignTokenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ea9a
- (void)hostForClientType:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000e852
- (void)endpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000e499
@property(retain, nonatomic) SHFeatureFlags *featureFlags; // @synthesize featureFlags=_featureFlags;
- (void)populateFeatureFlags;	// IMP=0x001000000000e209
- (void)populateRemoteConfiguration;	// IMP=0x001000000000e03d
- (id)initWithBag:(id)arg1;	// IMP=0x001000000000dd68
