...
- (void).cxx_destruct;	// IMP=0x002000000000356a
...
- (void)shazamService:(id)arg1 updatedChildService:(id)arg2;	// IMP=0x0010000000002e1f
@property(readonly, nonatomic) SHWatchdogTimer *watchdogTimer; // @synthesize watchdogTimer=_watchdogTimer;
- (void)stopWatchdogTimer;	// IMP=0x0010000000002d3a
- (void)startWatchdogTimerForInterval:(double)arg1 firedCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000002bfc
- (void)stopMediaSafetyNetExemption;	// IMP=0x0010000000002bf6
- (void)startMediaSafetyNetExemption;	// IMP=0x0010000000002bf0
- (void)powerlogCallingProcessBundleID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3;	// IMP=0x0010000000002bea
- (void)registerBundleAttribution:(id)arg1;	// IMP=0x0010000000002be4
- (void)endTransaction;	// IMP=0x0010000000002b66
- (void)startTransaction;	// IMP=0x0010000000002a9c
- (id)initWithConnection:(id)arg1;	// IMP=0x0010000000002888
- (void)dealloc;	// IMP=0x00100000000027fe
