...
+ (id)audioBufferFromData:(void *)arg1 byteSize:(unsigned long long)arg2 inFormat:(id)arg3;	// IMP=0x002000000001346b
- (void).cxx_destruct;	// IMP=0x0020000000013af1
...
- (void)startAudioQueueAfterRetrySecondsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000137e3
- (_Bool)hasAudioQueueFailedWithStatus:(int)arg1 annotateError:(id *)arg2;	// IMP=0x001000000001378d
- (_Bool)stopAudioQueueAndClearBuffersWithError:(id *)arg1;	// IMP=0x0010000000013584
- (_Bool)isAudioQueueRunning;	// IMP=0x001000000001351f
- (_Bool)stopRecordingWithError:(id *)arg1;	// IMP=0x001000000001342f
- (void)startRecordingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000012dce
- (id)initWithRecordingSource:(long long)arg1;	// IMP=0x0010000000012d6b
- (void)dealloc;	// IMP=0x0010000000012ccf
