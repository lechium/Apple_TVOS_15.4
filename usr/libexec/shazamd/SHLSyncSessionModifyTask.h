...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000038a3f
- (void).cxx_destruct;	// IMP=0x0020000000038c0e
...
- (void)updateProgress;	// IMP=0x0010000000038a47
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003896d
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003877e
@property(readonly, nonatomic) NSArray *allItemIdentifiers;
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)subdivideTaskIntoBatchesOfSize:(long long)arg1;	// IMP=0x0010000000037d6a
- (id)_init;	// IMP=0x0010000000037c3e
- (id)initWithTracksToModify:(id)arg1 groupsToModify:(id)arg2;	// IMP=0x0010000000037ab7
