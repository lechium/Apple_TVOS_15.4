...
- (void).cxx_destruct;	// IMP=0x002000000004c551
...
- (double)trailingSilenceDurationAtEndpoint;	// IMP=0x001000000004c440
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000004c3c1
- (void)stopEndpointer;	// IMP=0x001000000004c342
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000004c2c3
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000004c244
- (void)reset;	// IMP=0x001000000004c1c5
- (void)preheat;	// IMP=0x001000000004c146
- (id)init;	// IMP=0x001000000004c08f
