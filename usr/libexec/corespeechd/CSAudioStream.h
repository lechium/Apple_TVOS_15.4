...
- (void).cxx_destruct;	// IMP=0x002000000008f80d
...
- (void)audioStreamProvider:(id)arg1 didHardwareConfigurationChange:(long long)arg2;	// IMP=0x001000000008f5aa
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x001000000008f4e4
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2 lastForwardedSampleCount:(unsigned long long)arg3;	// IMP=0x001000000008f4ce
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x001000000008f408
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x001000000008f13b
- (void)updateAudioStreamStartTimeInSampleCount:(unsigned long long)arg1;	// IMP=0x001000000008ec74
- (_Bool)isNarrowBand;	// IMP=0x001000000008ec30
- (id)recordSettings;	// IMP=0x001000000008ebe0
- (_Bool)isStreaming;	// IMP=0x001000000008eacb
- (void)stopAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008e61d
- (void)startAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008e340
- (void)prepareAudioStreamWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008e2b7
- (_Bool)prepareAudioStreamSyncWithRequest:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008e237
- (void)dealloc;	// IMP=0x001000000008e0d7
- (id)initWithAudioStreamProvider:(id)arg1 streamName:(id)arg2 streamRequest:(id)arg3;	// IMP=0x001000000008dedb
