...
- (void).cxx_destruct;	// IMP=0x00200000000cc186
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000cc022
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000cb9d1
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000cb9cb
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000cb9c5
- (void)stopAudioStream;	// IMP=0x00100000000cb8a5
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000cb71b
- (_Bool)isRecording;	// IMP=0x00100000000cb667
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000cb638
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000cb609
- (void)stop;	// IMP=0x00100000000cb544
- (void)start;	// IMP=0x00100000000cb46c
- (void)dealloc;	// IMP=0x00100000000cb3b2
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000cb2c0
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000cb20c
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000cb1a0
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000cb198
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000cb030
