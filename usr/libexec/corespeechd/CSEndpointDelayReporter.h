...
- (void).cxx_destruct;	// IMP=0x0020000000033a28
...
- (void)_reportUEIUserSpeakingContext;	// IMP=0x0010000000033948
- (void)reportEndpointDelayIfNeed;	// IMP=0x0010000000033942
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x00100000000336a6
- (unsigned long long)estimatedUserSpeakingEndedHostTime;	// IMP=0x0010000000033662
- (unsigned long long)estimatedUserSpeakingStartedHostTime;	// IMP=0x001000000003362c
- (void)reset;	// IMP=0x001000000003356b
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2;	// IMP=0x0010000000033421
