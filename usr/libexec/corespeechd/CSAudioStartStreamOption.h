...
+ (id)noAlertOption;	// IMP=0x0020000000020664
- (void).cxx_destruct;	// IMP=0x0010000000021053
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000020c04
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000207d7
- (id)initTandemWithOption:(id)arg1;	// IMP=0x001000000002069c
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(long long)arg1;	// IMP=0x0010000000006494
- (long long)_avvcAlertOverrideType:(long long)arg1;	// IMP=0x001000000000647d
- (_Bool)isAlertBehaviorOverridedBeep;	// IMP=0x0010000000006427
- (id)avvcAlertBehavior;	// IMP=0x001000000000627f
- (void)setAVVCAlertBehavior:(id)arg1;	// IMP=0x0010000000006025
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned long long)arg1;	// IMP=0x0010000000005d58
