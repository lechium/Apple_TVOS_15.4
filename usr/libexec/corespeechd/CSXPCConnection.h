...
- (void).cxx_destruct;	// IMP=0x00200000000c4fbd
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000c4da5
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x00100000000c4d4a
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x00100000000c4ca0
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x00100000000c4ae2
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000c49b1
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000c486c
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000c46f4
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000c4473
- (void)_handleClientEvent:(id)arg1;	// IMP=0x00100000000c43ac
- (void)sendMessageToClient:(id)arg1;	// IMP=0x00100000000c420d
- (void)activateConnection;	// IMP=0x00100000000c4104
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x00100000000c3ebb
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000c3c9c
