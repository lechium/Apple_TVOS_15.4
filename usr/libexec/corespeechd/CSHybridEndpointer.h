...
@interface CSHybridEndpointer : NSObject
{
    ...
    double _trailingSilenceDurationAtEndpoint;	// 368 = 0x170
    long long _endpointerOperationMode;	// 376 = 0x178
}

- (MISSING_TYPE *).cxx_destruct;	// IMP=0x002000000009951f
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x0010000000098f6b
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x0010000000098ecd
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x0010000000098bf3
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x0010000000098bed
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x0010000000098a27
...
- (void)reset;	// IMP=0x0010000000098a01
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00100000000985ce
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x0010000000097b2e
- (void)stopEndpointer;	// IMP=0x0010000000097a98
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00100000000979f0
- (void)terminateProcessing;	// IMP=0x00100000000979e6
- (void)preheat;	// IMP=0x00100000000979e0
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x00100000000976ea
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x0010000000096f96
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x0010000000096f85
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2;	// IMP=0x0010000000095139
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x0010000000094fc1
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3;	// IMP=0x0010000000094f39
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000094812
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x0010000000094544
- (void)processTaskString:(id)arg1;	// IMP=0x001000000009422b
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x0010000000094184
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x0010000000094042
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x0010000000093ea4
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x0010000000093d8d
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x0010000000093ce0
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x0010000000093cda
- (id)init;	// IMP=0x00100000000935f7
