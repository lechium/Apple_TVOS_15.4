...
+ (void)dumpEARSpeechRecognitionResults:(id)arg1;	// IMP=0x00400000000042b2
- (void).cxx_destruct;	// IMP=0x0020000000004ab8
...
- (double)_getConfidence:(id)arg1;	// IMP=0x0010000000004807
- (void)_calculateTriggerConfidence:(id)arg1;	// IMP=0x001000000000461b
@property(readonly, nonatomic) NSDictionary *phraseIdScores;
- (void)processAudioChunk:(id)arg1;	// IMP=0x0010000000003b67
- (void)flushAudio;	// IMP=0x0010000000003a2a
- (void)resetWithLanguage:(id)arg1 withFarField:(unsigned char)arg2 withAudioSource:(id)arg3;	// IMP=0x00100000000038a5
- (id)initWithConfigPath:(id)arg1 triggerTokens:(id)arg2 useKeywordSpotting:(_Bool)arg3 preventDuplicatedReset:(_Bool)arg4;	// IMP=0x0010000000003533
