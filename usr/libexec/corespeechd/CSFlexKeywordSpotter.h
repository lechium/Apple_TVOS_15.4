...
- (void).cxx_destruct;	// IMP=0x00200000000104fd
...
- (void)speechRecognizer:(id)arg1 didRecognizePartialResult:(id)arg2;	// IMP=0x00100000000103bc
- (void)reset;	// IMP=0x00100000000102fd
- (void)speechRecognizer:(id)arg1 didRecognizePartialResultNbest:(id)arg2;	// IMP=0x001000000000f97c
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResults:(id)arg2;	// IMP=0x001000000000f8d9
- (void)speechRecognizer:(id)arg1 didFinishRecognitionWithError:(id)arg2;	// IMP=0x001000000000f836
- (void)processAudioChunk:(id)arg1;	// IMP=0x001000000000f650
- (void)startKeywordSpottingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ef47
- (id)init;	// IMP=0x001000000000eee7
