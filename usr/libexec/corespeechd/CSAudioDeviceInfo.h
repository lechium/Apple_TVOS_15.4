...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000cf5da
- (void).cxx_destruct;	// IMP=0x00200000000cf77b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000cf665
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000cf5e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000cf5cf
- (id)description;	// IMP=0x00100000000cf510
- (id)xpcObject;	// IMP=0x00100000000cf418
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000cf2b4
- (id)initWithRecordDeviceInfo:(id)arg1 playbackRoute:(id)arg2 playbackDeviceTypeList:(id)arg3;	// IMP=0x00100000000cf1ce
