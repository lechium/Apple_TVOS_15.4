...
- (void).cxx_destruct;	// IMP=0x0020000000017fb5
...
- (id)description;	// IMP=0x0010000000017f18
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0010000000017e7a
