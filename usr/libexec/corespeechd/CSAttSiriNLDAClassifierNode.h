...
- (void).cxx_destruct;	// IMP=0x00200000000b4a72
...
- (id)processSpeechPackageSync:(id)arg1;	// IMP=0x00100000000b485a
- (void)processSpeechPackage:(id)arg1;	// IMP=0x00100000000b443e
- (void)createNLDAClassifierWithAsset:(id)arg1;	// IMP=0x00100000000b41ea
- (void)pause;	// IMP=0x00100000000b400f
- (void)stop;	// IMP=0x00100000000b3f28
- (void)start;	// IMP=0x00100000000b3d8b
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000b3d75
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000b3c7c
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000b3b3c
