...
- (void).cxx_destruct;	// IMP=0x00200000000c5946
...
- (void)_setupSSRListener;	// IMP=0x00100000000c56f2
- (void)_setupAttSiriServiceListener;	// IMP=0x00100000000c55a0
- (void)_setupLocalSpeechRecognitionListener;	// IMP=0x00100000000c53f2
- (void)_setupEndpointListener;	// IMP=0x00100000000c5249
- (void)start;	// IMP=0x00100000000c5233
- (void)setupListeners;	// IMP=0x00100000000c51d6
- (id)init;	// IMP=0x00100000000c5171
- (id)initWithAttSiriController:(id)arg1 supportsAttentiveSiri:(_Bool)arg2 supportsSpeechRecognitionOnDevice:(_Bool)arg3 supportsSSR:(_Bool)arg4;	// IMP=0x00100000000c503b
