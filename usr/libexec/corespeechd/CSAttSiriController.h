...
- (void).cxx_destruct;	// IMP=0x00200000000ae1b4
...
- (void)siriRequestProcessingCompleted;	// IMP=0x00100000000adf12
- (void)stopAttendingWithContext:(id)arg1;	// IMP=0x00100000000adf0c
- (void)startAttendingWithContext:(id)arg1;	// IMP=0x00100000000adf06
- (void)handleAudioStopUnexpectly;	// IMP=0x00100000000ade24
- (void)handleAttendingAudioStopUnexpectly;	// IMP=0x00100000000add90
- (void)_releaseAttSiriTransactionIfNeeded;	// IMP=0x00100000000adcdb
- (void)_holdAttSiriTransactionIfNeeded;	// IMP=0x00100000000adc8d
- (void)_handleStopProcessing;	// IMP=0x00100000000adb8f
- (void)_handleStartProcessingWithRecordContext:(id)arg1;	// IMP=0x00100000000ad769
- (void)_setupAudioSrcNodeWithSiriClientStream:(id)arg1;	// IMP=0x00100000000ad510
- (void)_fetchMitigationAssets;	// IMP=0x00100000000ad50a
- (void)_forceBuildGraph:(_Bool)arg1;	// IMP=0x00100000000ad12d
- (void)attSiriNode:(id)arg1 triggerReportedFromFlxKwdSpotter:(id)arg2;	// IMP=0x00100000000ad056
- (void)attSiriNode:(id)arg1 didDetectStartpointAtTime:(double)arg2;	// IMP=0x00100000000ad050
- (void)attSiriNode:(id)arg1 didDetectHardEndpointAtTime:(double)arg2 withMetrics:(id)arg3;	// IMP=0x00100000000ad04a
- (void)CSSiriEnabledMonitor:(id)arg1 didReceiveEnabled:(_Bool)arg2;	// IMP=0x00100000000acf52
- (void)siriClientBehaviorMonitor:(id)arg1 preparedSiriClientAudioStream:(id)arg2 successfully:(_Bool)arg3;	// IMP=0x00100000000acdb9
- (void)siriClientBehaviorMonitor:(id)arg1 fetchedSiriClientAudioStream:(id)arg2 successfully:(_Bool)arg3;	// IMP=0x00100000000acc20
- (void)siriClientBehaviorMonitor:(id)arg1 didStopStream:(id)arg2 withEventUUID:(id)arg3;	// IMP=0x00100000000acb3e
- (void)siriClientBehaviorMonitor:(id)arg1 willStopStream:(id)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000acad1
- (void)siriClientBehaviorMonitor:(id)arg1 didStartStreamWithContext:(id)arg2 successfully:(_Bool)arg3 option:(id)arg4 withEventUUID:(id)arg5;	// IMP=0x00100000000ac7f0
- (void)siriClientBehaviorMonitor:(id)arg1 willStartStreamWithContext:(id)arg2 option:(id)arg3;	// IMP=0x00100000000ac63a
- (void)stop;	// IMP=0x00100000000ac634
- (void)pause;	// IMP=0x00100000000ac62e
- (void)start;	// IMP=0x00100000000ac57e
- (id)getNodeOfType:(unsigned long long)arg1;	// IMP=0x00100000000ac41e
- (id)initWithEndpointerNode:(id)arg1 osdNode:(id)arg2 ssrNode:(id)arg3 asrNode:(id)arg4 uresNode:(id)arg5 flexKwdNode:(id)arg6 needsSSRNode:(_Bool)arg7 aFtmNode:(id)arg8 speechManager:(id)arg9 siriEnabledMonitor:(id)arg10 siriClientBehaviorMonitor:(id)arg11 supportsAcousticProgressiveChecker:(_Bool)arg12 supportsUnderstandingOnDevice:(_Bool)arg13 requireASROnDevice:(_Bool)arg14;	// IMP=0x00100000000abe4a
- (id)init;	// IMP=0x00100000000abd9a
