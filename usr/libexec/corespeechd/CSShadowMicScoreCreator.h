...
- (void).cxx_destruct;	// IMP=0x002000000007d01a
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x001000000007cd0e
- (void)_calculateSpeechVoicingLevel;	// IMP=0x001000000007ca8b
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x001000000007ca69
- (void)calculateShadowMicScore;	// IMP=0x001000000007c6e7
- (void)addDataToBuffer:(id)arg1;	// IMP=0x001000000007c6d1
- (id)init;	// IMP=0x001000000007c64a
