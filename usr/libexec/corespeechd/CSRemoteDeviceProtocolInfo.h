...
+ (id)localDeviceProtocolInfo;	// IMP=0x004000000005db2e
+ (id)defaultProtocolInfo;	// IMP=0x001000000005dae3
- (void).cxx_destruct;	// IMP=0x002000000005dfbf
...
- (id)description;	// IMP=0x001000000005df4b
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000005dc73
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x001000000005da18
