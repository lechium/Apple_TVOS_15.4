...
- (void).cxx_destruct;	// IMP=0x002000000005ac72
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x001000000005a709
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x001000000005a703
- (_Bool)_shouldReportBoron;	// IMP=0x001000000005a6cb
- (_Bool)_popRemoteVADSignal;	// IMP=0x001000000005a64c
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x001000000005a5be
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x001000000005a20a
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x001000000005a15b
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005a144
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000059dbc
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000597d2
- (void)_resetAlignBuffer;	// IMP=0x00100000000597a9
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000592a9
- (id)init;	// IMP=0x00100000000591bb
