...
- (void).cxx_destruct;	// IMP=0x0020000000090867
...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x0010000000090729
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x0010000000090650
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x001000000009061c
- (id)_fetchCurrentMetrics;	// IMP=0x0010000000090462
- (void)_reportMetrics;	// IMP=0x00100000000903e7
- (void)reportMetricsForSiriRequestWithUUID:(id)arg1;	// IMP=0x00100000000903e1
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x0010000000090381
- (void)flush;	// IMP=0x0010000000090271
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2 arrivalTimestampToAudioRecorder:(unsigned long long)arg3;	// IMP=0x001000000009003d
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x001000000008fe05
- (id)initWithSampleRate:(float)arg1 withNumberOfChannels:(int)arg2;	// IMP=0x001000000008fccf
