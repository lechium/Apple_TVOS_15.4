...
- (void).cxx_destruct;	// IMP=0x00200000000cef47
...
- (void)triggerReportedFromFlxKwdSpotter:(id)arg1;	// IMP=0x00100000000cebaa
- (void)attSiriAudioSrcNodeLPCMRecordBufferAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000ceb91
- (void)attSiriAudioSrcNodeDidStop:(id)arg1;	// IMP=0x00100000000ceb68
- (void)attSiriAudioSrcNodeDidStartRecording:(id)arg1 successfully:(_Bool)arg2 error:(id)arg3;	// IMP=0x00100000000cead4
- (void)startWithContext:(id)arg1 audioStreamId:(unsigned long long)arg2;	// IMP=0x00100000000ce99f
- (void)stop;	// IMP=0x00100000000ce989
- (void)start;	// IMP=0x00100000000ce983
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000ce97d
- (void)pause;	// IMP=0x00100000000ce977
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000ce971
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000ce86d
