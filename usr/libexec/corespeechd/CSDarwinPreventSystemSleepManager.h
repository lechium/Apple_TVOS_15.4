...
- (void).cxx_destruct;	// IMP=0x00200000000d4993
...
- (void)dealloc;	// IMP=0x00100000000d491b
- (void)acquireAssertionForIdleUser;	// IMP=0x00100000000d45f2
- (void)acquireAssertionForActiveUser;	// IMP=0x00100000000d44ed
- (void)acquireAssertion;	// IMP=0x00100000000d4494
- (void)releasePreventSystemSleepAssertion;	// IMP=0x00100000000d4462
- (void)_acquirePreventSystemSleepAssertionWithTimeout:(id)arg1;	// IMP=0x00100000000d434b
- (id)initWithTimeout:(double)arg1;	// IMP=0x00100000000d4308
