...
+ (id)requestForSpeexRecordSettingsWithContext:(id)arg1;	// IMP=0x00200000000b7335
+ (id)requestForOpusRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000b71c7
+ (id)requestForLpcmRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000b703c
+ (id)defaultRequestWithContext:(id)arg1;	// IMP=0x00100000000b6d94
- (void).cxx_destruct;	// IMP=0x00200000000b7ba1
...
- (id)description;	// IMP=0x00100000000b79d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b78f0
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000b7603
- (id)initTandemWithRequest:(id)arg1;	// IMP=0x00100000000b7494
