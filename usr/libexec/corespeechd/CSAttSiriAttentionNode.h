...
+ (_Bool)supportAttentionLostAndGain;	// IMP=0x00200000000c358f
- (void).cxx_destruct;	// IMP=0x00200000000c3610
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000c35bd
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000c35b7
- (void)stop;	// IMP=0x00100000000c35b1
- (void)pause;	// IMP=0x00100000000c35ab
- (void)start;	// IMP=0x00100000000c35a5
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000c3597
