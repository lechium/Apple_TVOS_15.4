...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0010000000034716
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x00100000000346ca
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x001000000003468f
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000034643
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x0010000000031c6b
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000036855
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000033a50
- (id)_sha256:(id)arg1;	// IMP=0x001000000004e528
- (id)_sha1:(id)arg1;	// IMP=0x001000000004e437
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004e28e
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004e25a
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004e241
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004e228
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004e20f
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004e1f2
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004e1d2
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x001000000004d9ae
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000004d5e0
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004d57a
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004d546
...
@property(readonly, nonatomic) NSString *nldaConfigFile;
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
@property(readonly, nonatomic) NSString *mitigatonConfigFile;
