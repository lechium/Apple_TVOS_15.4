...
- (void).cxx_destruct;	// IMP=0x00200000000d6492
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x00100000000d645a
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x00100000000d62bc
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x00100000000d61f3
