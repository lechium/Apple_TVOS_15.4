...
@interface CSSmartSiriVolumeUserIntent : NSObject
{
    ...
    MISSING_TYPE *_userIntentType;	// 72 = 0x48
...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x00100000000b8485
- (void)storeASVStateInformation;	// IMP=0x00100000000b8432
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000b8411
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000b83f0
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00100000000b82a4
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00100000000b819c
