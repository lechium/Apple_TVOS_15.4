...
- (void).cxx_destruct;	// IMP=0x00200000000c6990
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x00100000000c6902
- (void)reportWithRequestMHUUID:(id)arg1;	// IMP=0x00100000000c664d
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x00100000000c6390
- (id)init;	// IMP=0x00100000000c62da
