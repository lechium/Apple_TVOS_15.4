...
+ (id)sharedMonitor;	// IMP=0x00400000000244f3
- (void).cxx_destruct;	// IMP=0x002000000002470b
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x00100000000246d3
- (void)startMonitoring;	// IMP=0x00100000000245a7
- (id)init;	// IMP=0x0010000000024548
