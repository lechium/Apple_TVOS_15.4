...
- (void).cxx_destruct;	// IMP=0x00200000000b5c2c
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000b5ac8
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000b5472
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000b546c
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000b5466
- (void)stopAudioStream;	// IMP=0x00100000000b5346
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000b51bc
- (_Bool)isRecording;	// IMP=0x00100000000b5108
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000b50d9
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000b50aa
- (void)stop;	// IMP=0x00100000000b4fe5
- (void)start;	// IMP=0x00100000000b4f0d
- (void)dealloc;	// IMP=0x00100000000b4e53
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000b4d61
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000b4cad
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000b4c41
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000b4c39
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000b4acf
