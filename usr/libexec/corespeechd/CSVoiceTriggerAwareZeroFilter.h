...
- (void).cxx_destruct;	// IMP=0x00200000000b1319
...
- (id)metrics;	// IMP=0x00100000000b1283
- (void)flush;	// IMP=0x00100000000b11fa
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x00100000000b0f35
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000b0c7d
- (id)init;	// IMP=0x00100000000b0c4e
