...
+ (id)createSmartSiriVolumeListener;	// IMP=0x002000000005e853
- (void).cxx_destruct;	// IMP=0x00200000000c8604
...
- (void)resumeConnection;	// IMP=0x00100000000c84ca
- (void)notifyClientsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000c7fae
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000c744a
- (void)dealloc;	// IMP=0x00100000000c738c
- (id)initWithMachService:(id)arg1 withServiceInterface:(id)arg2 withServiceObject:(id)arg3 withDelegateInterface:(id)arg4;	// IMP=0x00100000000c70eb
