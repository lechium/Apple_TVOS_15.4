...
- (unsigned long long)totalBytesForProgress;	// IMP=0x0010000000002453
- (void)reset;	// IMP=0x00100000000023b8
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002389
- (oneway void)_remote_setArchiveBytesConsumed:(unsigned long long)arg1;	// IMP=0x00100000000024cc
