...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x00100000000281e0
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x00100000000280c9
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x0010000000027f8c
