...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002b578
- (void).cxx_destruct;	// IMP=0x000000000002b6f1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002b434
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002b2df
