...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000031d00
@property(readonly, copy, nonatomic) NSData *data;
- (id)initWithSeed:(id)arg1 data:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000031d08
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000031c7b
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000031c4c
