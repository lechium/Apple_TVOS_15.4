...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000004d35e
- (void).cxx_destruct;	// IMP=0x002000000004d817
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004d69e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000004d50e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004d366
