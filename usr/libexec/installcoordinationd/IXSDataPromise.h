...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000630bf
- (void).cxx_destruct;	// IMP=0x0010000000065001
...
- (id)description;	// IMP=0x0010000000064e47
- (void)supersede;	// IMP=0x0010000000064d8e
- (void)decommission;	// IMP=0x0010000000064c58
...
- (void)_removeSavedState;	// IMP=0x0010000000063ca1
- (void)saveState;	// IMP=0x0010000000063956
- (_Bool)awakeFromSerializationWithLookupBlock:(CDUnknownBlockType)arg1 error:(id *)arg2;	// IMP=0x00100000000638e9
- (void)cancelForReason:(id)arg1 client:(unsigned long long)arg2;	// IMP=0x001000000006341c
- (void)reset;	// IMP=0x00100000000631ca
- (unsigned long long)hash;	// IMP=0x0010000000063186
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000630c7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000062f1b
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000062cdb
@property(readonly, copy, nonatomic) IXDataPromiseSeed *clientSeed; // @dynamic clientSeed;
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000062ae1
- (void)_internalInitWithUniqueIdentifier:(id)arg1;	// IMP=0x0010000000062996
- (oneway void)_remote_preflightWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000065a6a
- (oneway void)_remote_getErrorInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000006592f
- (oneway void)_remote_resetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000065656
- (oneway void)_remote_cancelForReason:(id)arg1 client:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000006550b
- (oneway void)_remote_setIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x001000000006532b
- (oneway void)_remote_getIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000065222
- (oneway void)_remote_setPercentComplete:(double)arg1;	// IMP=0x001000000006514e
- (oneway void)_remote_getPercentComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000065048
