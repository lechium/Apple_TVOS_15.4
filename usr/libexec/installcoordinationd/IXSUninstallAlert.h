...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x0040000000031b0f
- (void).cxx_destruct;	// IMP=0x0020000000031c0e
...
- (void)dealloc;	// IMP=0x0010000000031abc
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x001000000003194d
- (id)localizedStringForKey:(id)arg1;	// IMP=0x001000000003189d
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003188b
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000031221
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x00100000000305c1
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x0010000000030449
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 isRemovable:(_Bool)arg3;	// IMP=0x0010000000030215
