...
+ (double)_computeOverallProgressForCurrentProgress:(double)arg1 progressPhase:(unsigned long long)arg2;	// IMP=0x0040000000009d45
- (void).cxx_destruct;	// IMP=0x002000000000a08e
...
- (void)_notifyDelegateAndUpdateProgressWithPhaseCompleted:(_Bool)arg1;	// IMP=0x0010000000009d7c
- (void)finishInstalling;	// IMP=0x0010000000009cd6
- (void)finishLoading;	// IMP=0x0010000000009c6b
- (id)description;	// IMP=0x0010000000009b89
- (id)initForCoordinatorWithBundleID:(id)arg1 totalUnits:(unsigned long long)arg2 delegate:(id)arg3;	// IMP=0x0010000000009ad4
