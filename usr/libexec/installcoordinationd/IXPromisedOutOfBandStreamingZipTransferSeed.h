...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000032d4f
- (void).cxx_destruct;	// IMP=0x0020000000032ecd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000032d57
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000032bdb
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000032a62
