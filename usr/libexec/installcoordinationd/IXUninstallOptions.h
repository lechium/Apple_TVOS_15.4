...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000004674
...
- (id)description;	// IMP=0x0010000000004d32
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000048e7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000480c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000004730
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000467c
- (id)init;	// IMP=0x00100000000045e2
