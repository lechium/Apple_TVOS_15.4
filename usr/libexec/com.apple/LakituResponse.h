...
- (void).cxx_destruct;	// IMP=0x002000000001688a
...
- (id)initWithURLResponse:(id)arg1 data:(id)arg2;	// IMP=0x0010000000016281
- (id)_parsePlistFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000160b3
