...
+ (id)personaAwareAccountWithDSID:(id)arg1;	// IMP=0x004000000004d219
- (void).cxx_destruct;	// IMP=0x002000000004dcf1
...
- (id)initWithACAccount:(id)arg1;	// IMP=0x001000000004d462
