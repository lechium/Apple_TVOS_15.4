...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x001000000004c470
- (void).cxx_destruct;	// IMP=0x001000000004204a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000041d10
- (unsigned long long)hash;	// IMP=0x0010000000041baf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000418e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000416ba
- (void)copyTo:(id)arg1;	// IMP=0x0010000000041517
- (void)writeTo:(id)arg1;	// IMP=0x0010000000041391
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000041384
- (id)dictionaryRepresentation;	// IMP=0x0010000000040d8f
- (id)description;	// IMP=0x0010000000040ce0
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x0010000000040c1c
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x0010000000040b9e
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x001000000004c227
