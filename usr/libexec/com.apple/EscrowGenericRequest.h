...
@interface EscrowGenericRequest
{
    ...
    MISSING_TYPE *_doubleRecoveryUUID;	// 224 = 0xe0
    LakituAccount *_cachedCurrentAccount;	// 232 = 0xe8
    NSString *_requestDSID;	// 240 = 0xf0
}

- (void).cxx_destruct;	// IMP=0x00200000000195f7
...
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x0010000000019207
- (id)urlString;	// IMP=0x0010000000019157
- (id)urlRequest;	// IMP=0x001000000001901d
- (id)authorizationHeader;	// IMP=0x0010000000018f0d
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x0010000000018d10
- (id)bodyDictionary;	// IMP=0x00100000000189ef
- (id)validateInput;	// IMP=0x00100000000186a0
...
- (id)currentAccount;	// IMP=0x0010000000018221
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x001000000001804d
- (id)initWithRequest:(id)arg1;	// IMP=0x0010000000017bab
