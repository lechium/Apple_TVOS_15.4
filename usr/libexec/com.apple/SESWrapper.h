...
- (void).cxx_destruct;	// IMP=0x002000000005f53c
...
- (void)dealloc;	// IMP=0x001000000005f3c2
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x001000000005eb2f
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x001000000005df81
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 env:(id)arg3 duplicate:(_Bool)arg4;	// IMP=0x001000000005d10a
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x001000000005b17d
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005a1fd
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x001000000005a17f
- (unsigned long long)srpPublicKeySize;	// IMP=0x001000000005a125
- (unsigned long long)srpKeySize;	// IMP=0x001000000005a0ac
- (id)srpInitBlob;	// IMP=0x0010000000059f24
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x0010000000059cb2
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x0010000000059bcd
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x0010000000059a10
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x00100000000599af
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000005999b
