...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000f37d
- (void).cxx_destruct;	// IMP=0x002000000000f643
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000f49d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000f385
- (id)description;	// IMP=0x001000000000f253
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x001000000000f12f
