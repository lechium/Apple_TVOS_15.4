...
- (void).cxx_destruct;	// IMP=0x0020000000040a27
...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000004023e
- (id)sessionConfig;	// IMP=0x001000000004010a
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000003fd60
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x001000000003fca4
- (id)credential;	// IMP=0x001000000003fc9c
- (id)validateInput;	// IMP=0x001000000003fb52
- (id)additionalHeaders;	// IMP=0x001000000003fb45
- (id)authorizationHeader;	// IMP=0x001000000003fb3d
- (id)bodyDictionary;	// IMP=0x001000000003fb35
