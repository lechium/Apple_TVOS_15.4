...
- (void)dealloc;	// IMP=0x001000000000ff61
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f2d8
- (_Bool)_validateOutputSize;	// IMP=0x001000000000f149
- (_Bool)_validateOrientation;	// IMP=0x001000000000f020
- (_Bool)_validateMetadata;	// IMP=0x001000000000ee98
- (_Bool)_validateSource;	// IMP=0x001000000000ec67
- (void)_validate;	// IMP=0x001000000000eaff
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000eac6
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000e969
