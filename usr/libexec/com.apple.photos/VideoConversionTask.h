...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000014d3b
+ (_Bool)supportsDeduplication;	// IMP=0x0010000000014d33
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x00100000000149de
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000014969
- (_Bool)isPassthroughConversion;	// IMP=0x00100000000148f4
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x00100000000148ee
- (void)cancel;	// IMP=0x00100000000148e8
- (void)performConversion;	// IMP=0x001000000001486b
- (void)didEnqueue;	// IMP=0x0010000000014809
- (CDStruct_3c1748cc)trimTimeRange;	// IMP=0x001000000001473d
- (_Bool)hasTrimTimeRange;	// IMP=0x00100000000146d3
- (_Bool)wantsResultAsData;	// IMP=0x001000000001465e
- (void)updateResultTracker;	// IMP=0x001000000001450b
- (void)callCompletionHandler;	// IMP=0x0010000000014210
- (void)loadAsset;	// IMP=0x0010000000014083
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x0010000000013d83
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x0010000000013c31
