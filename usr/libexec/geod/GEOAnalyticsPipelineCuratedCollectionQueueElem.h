...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000029309
- (unsigned long long)hash;	// IMP=0x00100000000292f8
- (id)copy;	// IMP=0x00100000000292b3
- (id)initWithType:(unsigned long long)arg1 collectionId:(unsigned long long)arg2 createTime:(id)arg3;	// IMP=0x0010000000029224
