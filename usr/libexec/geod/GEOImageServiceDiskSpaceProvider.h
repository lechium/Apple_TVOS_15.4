...
- (unsigned long long)freePurgableDiskSpace:(unsigned long long)arg1 urgency:(int)arg2;	// IMP=0x00100000000239b6
- (unsigned long long)purgableDiskSpaceForUrgency:(int)arg1;	// IMP=0x0010000000023933
- (_Bool)_shouldPurgeForUrgency:(int)arg1;	// IMP=0x0010000000023811
- (int)minimumUregency;	// IMP=0x00100000000237f2
