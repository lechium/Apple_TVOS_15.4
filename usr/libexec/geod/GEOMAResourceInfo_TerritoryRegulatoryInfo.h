...
+ (id)_defaultQueryParameters;	// IMP=0x0020000000034d88
+ (id)_defaultQueryType;	// IMP=0x0010000000034d7b
+ (id)allExisitngInfos;	// IMP=0x0010000000034c5d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0020000000034e64
@property(readonly) unsigned long long hash;
- (_Bool)shouldPrefetchResource:(id)arg1;	// IMP=0x0010000000034e52
...
- (id)init;	// IMP=0x0010000000034bb5
