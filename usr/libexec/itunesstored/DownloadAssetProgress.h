...
- (void).cxx_destruct;	// IMP=0x00200000001d0046
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001cfedb
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001cfed1
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001cfd30
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001cfcb4
