...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000086029
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x0010000000085d57
- (void)run;	// IMP=0x0010000000085aad
- (void)dealloc;	// IMP=0x0010000000085a47
