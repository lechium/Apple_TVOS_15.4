...
- (void).cxx_destruct;	// IMP=0x0020000000042364
...
- (void)setOriginatingStorefront:(id)arg1;	// IMP=0x0010000000042269
- (id)originatingStorefront;	// IMP=0x0010000000042253
- (id)_fullBuyParametersWithAppProxy:(id)arg1;	// IMP=0x0010000000041971
- (id)_appProxy;	// IMP=0x0010000000041580
- (void)run;	// IMP=0x001000000004099d
- (_Bool)purchaseOperation:(id)arg1 shouldContinueWithNewStorefront:(id)arg2;	// IMP=0x00100000000408b9
