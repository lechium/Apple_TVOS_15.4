...
+ (id)defaultProperties;	// IMP=0x004000000007e77e
+ (Class)databaseEntityClass;	// IMP=0x001000000007e76d
- (void).cxx_destruct;	// IMP=0x002000000007eacb
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x001000000007e43b
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x001000000007dc84
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x001000000007d7a7
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x001000000007d21c
