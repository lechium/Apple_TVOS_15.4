...
- (void).cxx_destruct;	// IMP=0x002000000003130b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000031171
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000030be8
- (id)initWithApplication:(id)arg1;	// IMP=0x0010000000030a57
