...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001a33d7
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001a3343
- (void)dealloc;	// IMP=0x00100000001a3301
