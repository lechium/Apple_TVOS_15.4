...
- (id)description;	// IMP=0x0020000000026178
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0010000000025cfd
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x00100000000258f1
- (void)dealloc;	// IMP=0x0010000000025899
- (id)initWithInputConnection:(id)arg1;	// IMP=0x001000000002584f
