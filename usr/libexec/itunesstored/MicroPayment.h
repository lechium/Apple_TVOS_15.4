...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x004000000003e923
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x001000000003e8d6
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x001000000003fbab
- (id)_temporaryIdentifier;	// IMP=0x001000000003fb5c
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x001000000003fb00
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x001000000003fa7c
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x001000000003f6ae
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x001000000003f5c7
- (void)setFailedWithError:(id)arg1;	// IMP=0x001000000003f4e3
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x001000000003f104
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x001000000003ef06
- (id)copyPaymentTransaction;	// IMP=0x001000000003e96f
- (void)dealloc;	// IMP=0x001000000003e888
