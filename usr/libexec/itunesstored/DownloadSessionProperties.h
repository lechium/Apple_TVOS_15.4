...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000268bd
- (unsigned long long)hash;	// IMP=0x00100000000268b3
- (id)description;	// IMP=0x001000000002684d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002678d
- (void)dealloc;	// IMP=0x0010000000026735
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000266d3
