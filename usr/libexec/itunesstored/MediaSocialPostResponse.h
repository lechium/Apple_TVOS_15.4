...
{
    MISSING_TYPE *_activityIdentifier;	// 8 = 0x8
...
+ (id)_unrecoverableErrors;	// IMP=0x00200000001436f2
- (void).cxx_destruct;	// IMP=0x0020000000143840
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x001000000014366f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001435bd
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x001000000014318e
