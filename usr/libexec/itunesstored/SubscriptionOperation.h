...
- (void).cxx_destruct;	// IMP=0x00200000000ba201
- (id)_requestPropertiesWithAccount:(id)arg1 syncState:(id)arg2 fairPlaySubscriptionController:(id)arg3;	// IMP=0x00100000000ba1f9
- (id)_newMachineDataOperationWithAccount:(id)arg1 response:(id)arg2;	// IMP=0x00100000000ba0d0
- (void)run;	// IMP=0x00100000000ba067
