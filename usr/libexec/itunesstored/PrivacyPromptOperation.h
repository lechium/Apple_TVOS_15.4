...
- (id)_privacyAcknowledgementURLString;	// IMP=0x001000000013d0fc
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x001000000013cf35
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x001000000013cd98
- (void)run;	// IMP=0x001000000013cae9
- (id)initWithPrivacyIdentifier:(id)arg1;	// IMP=0x001000000013ca7b
