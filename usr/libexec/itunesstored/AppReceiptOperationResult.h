...
- (void)addRefreshed:(id)arg1;	// IMP=0x0010000000111c02
- (void)addRevoked:(id)arg1;	// IMP=0x0010000000111ba6
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000111acb
- (void)dealloc;	// IMP=0x0010000000111a65
