...
- (void).cxx_destruct;	// IMP=0x002000000016d163
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000016c542
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000016bee0
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000016bb89
- (id)sessionConfiguration;	// IMP=0x001000000016b9b1
