...
- (void).cxx_destruct;	// IMP=0x0020000000191743
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001915dd
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x001000000019130f
