...
- (void)_setURLCredential:(id)arg1;	// IMP=0x0020000000181579
- (void)_setState:(long long)arg1;	// IMP=0x001000000018152a
- (id)_openSession;	// IMP=0x00100000001812df
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x001000000018110b
- (void)run;	// IMP=0x0010000000180c1d
- (void)cancel;	// IMP=0x0010000000180b95
...
- (void)dealloc;	// IMP=0x00100000001809b4
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x0010000000180944
