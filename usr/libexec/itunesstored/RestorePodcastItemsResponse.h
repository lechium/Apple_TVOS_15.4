...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00100000001918c8
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00100000001918a1
- (void)dealloc;	// IMP=0x0010000000191849
