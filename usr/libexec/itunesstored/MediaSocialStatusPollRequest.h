...
- (void).cxx_destruct;	// IMP=0x00200000000266a0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000026554
- (unsigned long long)hash;	// IMP=0x001000000002653e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000026477
