...
+ (void)initialize;	// IMP=0x00200000000b7b42
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b7aa7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b797d
- (unsigned long long)hash;	// IMP=0x00100000000b7967
- (id)description;	// IMP=0x00100000000b7907
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000b7854
