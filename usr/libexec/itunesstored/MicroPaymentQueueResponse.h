...
- (_Bool)_ntsLoadFromPropertyList:(id)arg1;	// IMP=0x0020000000044dd8
- (id)_dsidFromDictionary:(id)arg1;	// IMP=0x0010000000044d33
- (id)_copyPaymentsFromDictionary:(id)arg1;	// IMP=0x0010000000044ac6
- (id)_copyAppReceiptFromDictionary:(id)arg1;	// IMP=0x0010000000044a74
@property(copy) NSNumber *userIdentifier;
@property _Bool shouldTriggerQueueCheck;
- (void)setRangesToLoad:(id)arg1;	// IMP=0x00100000000448f0
...
- (_Bool)loadFromPropertyList:(id)arg1;	// IMP=0x0010000000044687
- (void)appendResponse:(id)arg1;	// IMP=0x0010000000044366
- (void)dealloc;	// IMP=0x0010000000044307
- (id)initWithRequestType:(long long)arg1;	// IMP=0x00100000000442ca
