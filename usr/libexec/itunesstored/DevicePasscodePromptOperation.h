...
- (void).cxx_destruct;	// IMP=0x00200000001121d3
- (long long)_keyboardType;	// IMP=0x0010000000112174
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x001000000011215f
- (void)run;	// IMP=0x00100000001120bd
@property(copy) CDUnknownBlockType tokenBlock;
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x0010000000111cc7
