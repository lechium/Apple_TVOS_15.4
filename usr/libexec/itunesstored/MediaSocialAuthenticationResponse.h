...
- (void).cxx_destruct;	// IMP=0x00200000000d9def
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d9cfc
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000d9ca2
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000d9c48
- (id)init;	// IMP=0x00100000000d9bd3
