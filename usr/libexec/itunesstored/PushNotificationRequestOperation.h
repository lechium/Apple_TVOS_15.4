...
- (_Bool)_loadResponseWithAccountIdentifier:(id)arg1 URL:(id)arg2 error:(id *)arg3;	// IMP=0x002000000008425c
- (void)run;	// IMP=0x0010000000083a56
@property(copy) NSString *userAgent;
@property(readonly) SSURLConnectionResponse *URLResponse;
- (void)dealloc;	// IMP=0x00100000000838ed
- (id)initWithPushNotificationParameters:(id)arg1;	// IMP=0x001000000008388f
