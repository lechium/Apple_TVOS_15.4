...
- (void).cxx_destruct;	// IMP=0x00200000000a1897
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a169c
- (id)copyXPCEncoding;	// IMP=0x00100000000a15a7
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000a13d0
