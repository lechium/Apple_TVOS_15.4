...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x00200000000fa395
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x00200000000fb9d5
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x00100000000fb86d
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00100000000faf63
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fa1de
- (void)dealloc;	// IMP=0x00100000000fa16f
- (id)init;	// IMP=0x00100000000fa121
