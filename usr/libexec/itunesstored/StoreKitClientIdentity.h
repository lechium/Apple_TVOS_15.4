...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x002000000019acfc
+ (void)initialize;	// IMP=0x001000000019acce
...
- (id)description;	// IMP=0x001000000019b438
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019b33e
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x001000000019b0d0
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x001000000019af25
- (void)dealloc;	// IMP=0x001000000019aeb8
