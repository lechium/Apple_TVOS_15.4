...
@class MISSING_TYPE, MicroPaymentProductDiscount, MicroPaymentProductSubscriptionPeriod, NSArray, NSNumber, NSString;
...
@interface MicroPaymentProduct : NSObject
{
    ...
    MISSING_TYPE *_subscriptionGroupIdentifier;	// 88 = 0x58
    MicroPaymentProductSubscriptionPeriod *_subscriptionPeriod;	// 96 = 0x60
}

+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x0040000000062d42
...
- (id)copyProduct;	// IMP=0x0010000000062971
- (void)dealloc;	// IMP=0x00100000000628ef
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000062243
