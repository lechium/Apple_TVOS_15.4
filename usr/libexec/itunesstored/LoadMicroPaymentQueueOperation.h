...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x00100000000891a0
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x00100000000890af
- (void)run;	// IMP=0x0010000000088fcf
- (void)dealloc;	// IMP=0x0010000000088f4d
