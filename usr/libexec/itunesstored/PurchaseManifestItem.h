...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000010110
...
- (void)dealloc;	// IMP=0x001000000000ffc7
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000ff70
- (id)init;	// IMP=0x001000000000ff24
