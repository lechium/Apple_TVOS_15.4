...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x002000000009e574
- (void)run;	// IMP=0x001000000009e04c
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x000000000009def4
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x001000000009de6c
- (id)init;	// IMP=0x001000000009de56
