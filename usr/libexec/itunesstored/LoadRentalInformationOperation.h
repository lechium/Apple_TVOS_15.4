...
- (void).cxx_destruct;	// IMP=0x00200000000f9664
...
- (void)run;	// IMP=0x00100000000f95c2
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x00100000000f94fb
