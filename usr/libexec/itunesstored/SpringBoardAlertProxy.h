...
- (void).cxx_destruct;	// IMP=0x0020000000049ec2
@property(readonly) NSObject<OS_xpc_object> *XPCEndpoint; // @synthesize XPCEndpoint=_inputEndpoint;
- (void)_handleMessage:(id)arg1 connection:(id)arg2;	// IMP=0x0010000000049cfa
- (void)_disconnect;	// IMP=0x0010000000049beb
@property __weak id <SpringBoardAlertProxyDelegate> delegate;
- (void)sendMessage:(id)arg1;	// IMP=0x0010000000049a9e
- (void)dealloc;	// IMP=0x0010000000049932
- (id)initWithMessage:(id)arg1;	// IMP=0x00100000000495b5
