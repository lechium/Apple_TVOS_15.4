...
- (id)_track;	// IMP=0x001000000009b504
- (void)_persistURI:(id)arg1 persistentContentKey:(id)arg2;	// IMP=0x001000000009b4fe
- (void)_persistKeys;	// IMP=0x001000000009b4f8
- (id)_pastisKeyServerURL;	// IMP=0x001000000009b440
- (id)_pastisCertificateURL;	// IMP=0x001000000009b388
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x001000000009b380
- (void)persistKeys;	// IMP=0x001000000009b37a
- (void)applyResourceLoaderDelegate:(id)arg1;	// IMP=0x001000000009b35b
- (id)initWithDownloadEntity:(id)arg1;	// IMP=0x001000000009b1e0
