...
- (void).cxx_destruct;	// IMP=0x00200000000cbd58
...
- (_Bool)_shouldSkipInitialDialog:(id)arg1;	// IMP=0x00100000000cb56e
- (_Bool)_shouldAuthenticateForButton:(id)arg1;	// IMP=0x00100000000cb4b0
- (_Bool)_isLocalizationAlreadyConfiguredForAuthContext:(id)arg1;	// IMP=0x00100000000cb3fc
- (void)_handleSelectedButton:(id)arg1;	// IMP=0x00100000000cb132
- (_Bool)_copySelectedButton:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000cae00
- (id)_copyButtonToSkipDialog:(id)arg1;	// IMP=0x00100000000cac55
- (id)_copyAuthenticationContext;	// IMP=0x00100000000ca195
- (_Bool)_copyAccountIdentifier:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000c9d3d
- (void)run;	// IMP=0x00100000000c984c
...
- (id)initWithDialog:(id)arg1;	// IMP=0x00100000000c9509
- (id)init;	// IMP=0x00100000000c92c7
