...
- (void).cxx_destruct;	// IMP=0x00200000000709e4
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x001000000007033c
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006f39f
- (void)run;	// IMP=0x001000000006f302
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x001000000006f15a
