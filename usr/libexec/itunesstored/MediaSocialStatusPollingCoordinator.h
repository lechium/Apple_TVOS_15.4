...
- (void).cxx_destruct;	// IMP=0x00200000001cb1b3
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00100000001cab0a
- (void)_addBackgroundTaskJob;	// IMP=0x00100000001cab04
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00100000001caafe
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00100000001caae2
- (void)dealloc;	// IMP=0x00100000001caab3
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00100000001ca9e4
