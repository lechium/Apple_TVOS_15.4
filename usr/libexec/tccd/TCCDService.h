...
@class NSArray, NSBundle, NSDictionary, NSNumber, NSSet, NSString, TCCDAlertManager;
...
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x004000000002af40
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002af24
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002af08
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002aeec
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002aed0
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002aeb4
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002ae98
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002ae7c
+ (id)requestAdditionalTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002ae60
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002ae44
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002ae28
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002ae0c
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x001000000002ade4
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x001000000002ad6c
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x001000000002aca6
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x001000000002a960
+ (id)serviceAll;	// IMP=0x001000000002a8d2
+ (id)allServices;	// IMP=0x0010000000026eab
- (void).cxx_destruct;	// IMP=0x002000000002c87d
...
- (long long)developmentAuthorizationValue;	// IMP=0x001000000002be43
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x001000000002bd7a
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x001000000002bd0c
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x001000000002bce0
- (long long)compare:(id)arg1;	// IMP=0x001000000002bc4f
- (id)descriptionDictionary;	// IMP=0x001000000002b347
- (id)description;	// IMP=0x001000000002b335
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x001000000002af5c
