...
- (void).cxx_destruct;	// IMP=0x0020000000038003
...
- (id)attributedBundleUsingOutermostBundle:(_Bool)arg1 computedStaticCodeRef:(const void **)arg2 computedNonIdentifiableBundleURL:(id *)arg3;	// IMP=0x0010000000037ca7
...
- (id)description;	// IMP=0x0010000000037aa4
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2;	// IMP=0x0010000000037509
- (id)initWithMessage:(id)arg1;	// IMP=0x00100000000374f2
