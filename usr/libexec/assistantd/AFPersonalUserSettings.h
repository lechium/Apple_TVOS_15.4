...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000013ec40
- (void).cxx_destruct;	// IMP=0x002000000013eec5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000013ecf6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000013ec48
