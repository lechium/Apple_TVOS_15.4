...
- (void).cxx_destruct;	// IMP=0x00200000001a2eaf
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000001a3302
- (id)metricValue;	// IMP=0x00100000001a2f19
