...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00200000000ed004
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a06f9
- (void).cxx_destruct;	// IMP=0x00100000000f008a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ef868
- (unsigned long long)hash;	// IMP=0x00100000000ef4e1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000eeebb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ee8fa
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ee509
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ee0b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ee0a8
- (id)dictionaryRepresentation;	// IMP=0x00100000000ed1e1
- (id)description;	// IMP=0x00100000000ed132
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000ecfe7
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000000ecfca
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00100000000ecf60
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00100000000ecf43
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000bcc6a
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001257d4
