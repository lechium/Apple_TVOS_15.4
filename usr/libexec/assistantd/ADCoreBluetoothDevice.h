...
- (void).cxx_destruct;	// IMP=0x00200000001f8dda
...
- (id)dictionaryRepresentation;	// IMP=0x00100000001f8d16
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x00100000001f8c34
