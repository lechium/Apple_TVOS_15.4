...
- (void).cxx_destruct;	// IMP=0x002000000023601f
- (oneway void)sendContext:(id)arg1;	// IMP=0x0010000000235f0d
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x0010000000235e70
