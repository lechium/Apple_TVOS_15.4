...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x002000000028bc54
+ (id)locallyPairedPeerInfo;	// IMP=0x001000000028b2a3
+ (id)_queue;	// IMP=0x001000000028b216
- (void).cxx_destruct;	// IMP=0x002000000028c04a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000028bd94
- (unsigned long long)hash;	// IMP=0x001000000028bd7e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000028bd73
- (id)afPeerInfo;	// IMP=0x001000000028ba44
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x001000000028b92d
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x001000000028b589
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x001000000028b51c
- (id)initWithIDSIdentifer:(id)arg1;	// IMP=0x001000000028b502
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x001000000028b3f1
