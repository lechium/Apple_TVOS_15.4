...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000d3315
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000d300c
- (void)dealloc;	// IMP=0x00100000000d2d34
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000d2c29
- (id)init;	// IMP=0x00100000000d2c1b
