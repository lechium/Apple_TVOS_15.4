...
- (void).cxx_destruct;	// IMP=0x00200000000ab583
...
- (void)dealloc;	// IMP=0x00100000000ab485
- (void)completeRequestWithSuccess:(_Bool)arg1 forReason:(long long)arg2;	// IMP=0x00100000000ab434
- (id)initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000ab357
