...
- (void).cxx_destruct;	// IMP=0x0020000000118bfe
- (id)generate;	// IMP=0x0010000000118943
- (void)setHomeAccessoryInfo:(id)arg1;	// IMP=0x0010000000118921
- (void)setUserInterfaceIdiom:(id)arg1;	// IMP=0x0010000000118901
- (void)setUserAssignedDeviceName:(id)arg1;	// IMP=0x00100000001188e1
- (void)setSharedUserIdentifier:(id)arg1;	// IMP=0x00100000001188c1
- (void)setProductType:(id)arg1;	// IMP=0x00100000001188a1
- (void)setBuildVersion:(id)arg1;	// IMP=0x0010000000118881
- (void)setAssistantIdentifier:(id)arg1;	// IMP=0x0010000000118861
- (void)setAceVersion:(id)arg1;	// IMP=0x0010000000118841
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00100000001187d6
- (id)init;	// IMP=0x00100000001187c2
