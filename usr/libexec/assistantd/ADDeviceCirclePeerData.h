...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000117ef7
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0010000000118c73
- (void).cxx_destruct;	// IMP=0x0010000000118758
...
- (id)buildDictionaryRepresentation;	// IMP=0x0010000000118599
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000001181fe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000118119
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000117eff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000117eec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000117bee
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x001000000011772d
@property(readonly, copy) NSString *description;
- (id)initWithAceVersion:(id)arg1 assistantIdentifier:(id)arg2 buildVersion:(id)arg3 productType:(id)arg4 sharedUserIdentifier:(id)arg5 userAssignedDeviceName:(id)arg6 userInterfaceIdiom:(id)arg7 homeAccessoryInfo:(id)arg8;	// IMP=0x0010000000117574
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x0010000000118ce2
