...
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a0704
- (void).cxx_destruct;	// IMP=0x00100000001a4042
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a3e96
- (unsigned long long)hash;	// IMP=0x00100000001a3dbf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a3c23
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a3ae9
- (void)copyTo:(id)arg1;	// IMP=0x00100000001a3a06
- (void)writeTo:(id)arg1;	// IMP=0x00100000001a392d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001a3920
- (id)dictionaryRepresentation;	// IMP=0x00100000001a3525
- (id)description;	// IMP=0x00100000001a3476
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000bcb93
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001259e0
