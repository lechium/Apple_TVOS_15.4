...
- (void).cxx_destruct;	// IMP=0x00200000001ca354
...
- (id)analyticsDictionary;	// IMP=0x00100000001ca065
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00100000001ca057
- (void)markSucceeded;	// IMP=0x00100000001ca04d
- (void)markEndTime;	// IMP=0x00100000001ca014
- (void)markStartTime;	// IMP=0x00100000001c9fdb
- (_Bool)hasFailureType;	// IMP=0x00100000001c9fcd
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00100000001c9f4e
