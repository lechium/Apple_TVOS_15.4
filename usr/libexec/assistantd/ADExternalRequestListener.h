...
- (void).cxx_destruct;	// IMP=0x00200000000f3c04
- (void)listen;	// IMP=0x00100000000f39e3
- (id)initWithInstanceContext:(id)arg1;	// IMP=0x00100000000f3946
- (id)init;	// IMP=0x00100000000f38ec
