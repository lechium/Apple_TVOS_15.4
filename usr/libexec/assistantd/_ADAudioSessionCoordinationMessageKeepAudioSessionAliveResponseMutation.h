...
- (void).cxx_destruct;	// IMP=0x00200000000f9eee
- (id)generate;	// IMP=0x00100000000f9ebd
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00100000000f9e52
- (id)init;	// IMP=0x00100000000f9e3e
