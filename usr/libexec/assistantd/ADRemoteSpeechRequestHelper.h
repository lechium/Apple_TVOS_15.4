...
@class AFSpeechRequestOptions, MISSING_TYPE, NSUUID;
...
- (void).cxx_destruct;	// IMP=0x0020000000113608
...
- (MISSING_TYPE *)reset;	// IMP=0x00100000001135a6
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001134ec
