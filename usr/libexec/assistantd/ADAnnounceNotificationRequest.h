...
- (void).cxx_destruct;	// IMP=0x0020000000080705
...
- (long long)_announceNotificationRequestTypeForNotification:(id)arg1 appID:(id)arg2 platform:(long long)arg3;	// IMP=0x00100000000805a5
- (id)initWithNotification:(id)arg1 appID:(id)arg2 platform:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000804b1
