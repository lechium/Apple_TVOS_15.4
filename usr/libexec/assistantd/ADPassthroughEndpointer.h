...
- (void).cxx_destruct;	// IMP=0x002000000010c7c9
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x001000000010c779
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x001000000010c72b
@property double endWaitTime;
@property double interspeechWaitTime;
@property double startWaitTime;
@property int endpointMode;
- (void)reset;	// IMP=0x001000000010c665
- (int)getStatus:(struct AudioQueueBuffer *)arg1;	// IMP=0x001000000010c5ce
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned int)arg2;	// IMP=0x001000000010c52a
