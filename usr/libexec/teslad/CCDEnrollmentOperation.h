...
- (void).cxx_destruct;	// IMP=0x0020000000007afd
...
- (id)errorForStatusCode:(long long)arg1 responseData:(id)arg2;	// IMP=0x0010000000007a23
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 outError:(id *)arg3;	// IMP=0x0010000000007a1b
- (void)completeOperationWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x001000000000789c
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 statusCode:(long long)arg3 retryNeeded:(_Bool *)arg4 outError:(id *)arg5;	// IMP=0x001000000000776a
