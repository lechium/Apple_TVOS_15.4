...
- (void).cxx_destruct;	// IMP=0x002000000002b741
...
- (void)invalidate;	// IMP=0x001000000002b4bb
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x001000000002b442
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x001000000002b3ec
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x001000000002b396
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x001000000002b269
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x001000000002b204
- (struct __SFNode *)copyRootNode;	// IMP=0x001000000002b1ed
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x001000000002b088
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x001000000002b018
- (void)dealloc;	// IMP=0x001000000002afbe
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x001000000002aee1
