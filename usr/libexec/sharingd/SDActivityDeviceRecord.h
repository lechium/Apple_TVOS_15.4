...
- (void).cxx_destruct;	// IMP=0x002000000001e142
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000001d043
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001d02b
- (id)description;	// IMP=0x001000000001cf49
- (id)initWithDevice:(id)arg1;	// IMP=0x001000000001ceb7
