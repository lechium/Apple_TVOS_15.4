...
- (void).cxx_destruct;	// IMP=0x0020000000097fa1
...
- (void)sendProxyTrigger;	// IMP=0x0010000000097ae0
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000097a0c
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00100000000977b1
- (void)deviceConnected:(id)arg1;	// IMP=0x001000000009763e
- (id)results;	// IMP=0x00100000000974de
- (void)removeObservers;	// IMP=0x001000000009748b
- (void)addObservers;	// IMP=0x0010000000097424
- (void)invalidate;	// IMP=0x0010000000097348
- (void)_start;	// IMP=0x0010000000097296
- (void)start;	// IMP=0x001000000009720f
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x001000000009717d
