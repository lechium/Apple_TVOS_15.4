...
- (void).cxx_destruct;	// IMP=0x0020000000099915
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000996b7
- (unsigned long long)hash;	// IMP=0x001000000009943a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000099187
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000098fc9
- (void)copyTo:(id)arg1;	// IMP=0x0010000000098e5c
- (void)writeTo:(id)arg1;	// IMP=0x0010000000098cd5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000098cc8
- (id)dictionaryRepresentation;	// IMP=0x0010000000098322
- (id)description;	// IMP=0x0010000000098273
