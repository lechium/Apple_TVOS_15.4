...
- (void).cxx_destruct;	// IMP=0x00200000000b3672
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b3535
- (unsigned long long)hash;	// IMP=0x00100000000b346a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b3302
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b3206
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b3143
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b3079
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b306c
- (id)dictionaryRepresentation;	// IMP=0x00100000000b2b66
- (id)description;	// IMP=0x00100000000b2ab7
