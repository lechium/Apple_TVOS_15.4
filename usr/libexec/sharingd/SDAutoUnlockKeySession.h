...
- (void).cxx_destruct;	// IMP=0x0020000000015c1a
...
- (void)logAutoUnlockEnd;	// IMP=0x0010000000015758
- (void)logAutoUnlockStart;	// IMP=0x0010000000015752
- (void)invalidateAssertionTimer;	// IMP=0x001000000001567c
- (void)restartAssertionTimer;	// IMP=0x001000000001546d
- (void)releaseIdleSleepAssertion;	// IMP=0x00100000000153ce
- (void)declareSystemActivityAssertion;	// IMP=0x001000000001513a
- (void)sendConfirmationACK;	// IMP=0x0010000000014f18
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0010000000014ab0
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x00100000000147b2
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x00100000000144b7
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000013ea7
- (void)handleCleanUpAWDL;	// IMP=0x0010000000013e19
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x00100000000139cb
- (void)createAuthTokenIfReady;	// IMP=0x00100000000131d6
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0010000000012faf
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0010000000012ce4
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x001000000001280d
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000012250
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000011ad0
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x0010000000011a33
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000001197b
- (void)nq_awdlNetworkStarted;	// IMP=0x001000000001179b
- (void)createWiFiRequest;	// IMP=0x0010000000010ff8
- (void)alertOfUnlock;	// IMP=0x0010000000010edc
- (void)promptForApproval;	// IMP=0x0010000000010ed6
- (void)systemIsActive:(id)arg1;	// IMP=0x0010000000010d22
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0010000000010ad0
- (void)removeObservers;	// IMP=0x0010000000010a7d
- (void)addObservers;	// IMP=0x0010000000010980
- (void)postBeganUnlockingNotification;	// IMP=0x00100000000108ed
- (void)beginAKSSession;	// IMP=0x00100000000108e7
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000010723
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000001071d
- (_Bool)keyInState;	// IMP=0x001000000001057d
- (void)_invalidate;	// IMP=0x00100000000102ea
- (void)invalidateOnQueue;	// IMP=0x00100000000102ab
- (void)invalidate;	// IMP=0x001000000001022a
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x001000000000ff84
