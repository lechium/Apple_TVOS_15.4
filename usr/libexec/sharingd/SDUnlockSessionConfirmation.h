...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000e659
- (unsigned long long)hash;	// IMP=0x001000000000e5bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e477
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e3af
- (void)copyTo:(id)arg1;	// IMP=0x001000000000e30a
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e239
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000e22c
- (id)dictionaryRepresentation;	// IMP=0x001000000000dbca
- (id)description;	// IMP=0x001000000000db1b
