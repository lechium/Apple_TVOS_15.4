...
- (void).cxx_destruct;	// IMP=0x0020000000132fe5
...
- (void)setAppIcon:(id)arg1;	// IMP=0x0010000000132f6c
- (id)appIcon;	// IMP=0x0010000000132f5b
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00100000001327e9
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000132227
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000013220f
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x0010000000131b31
- (void)sendAWDLInfo;	// IMP=0x0010000000131b1d
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000131a80
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000131994
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000131982
- (void)_start;	// IMP=0x0010000000131970
- (void)start;	// IMP=0x00100000001318e9
- (id)getAppName;	// IMP=0x00100000001318e1
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001318db
- (void)connectionActivated;	// IMP=0x00100000001318d5
- (void)invalidate;	// IMP=0x00100000001317dc
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000131740
