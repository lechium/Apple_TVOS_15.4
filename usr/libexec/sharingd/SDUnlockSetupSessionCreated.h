...
- (void).cxx_destruct;	// IMP=0x00200000001347d8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001345a9
- (unsigned long long)hash;	// IMP=0x0010000000134452
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000134220
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000134089
- (void)copyTo:(id)arg1;	// IMP=0x0010000000133f39
- (void)writeTo:(id)arg1;	// IMP=0x0010000000133dd5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000133dc8
- (id)dictionaryRepresentation;	// IMP=0x00100000001334ef
- (id)description;	// IMP=0x0010000000133440
