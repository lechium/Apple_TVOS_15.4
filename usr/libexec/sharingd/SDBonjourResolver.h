...
- (void).cxx_destruct;	// IMP=0x0020000000191e97
...
- (void)cancel;	// IMP=0x0010000000191d42
- (void)resolve;	// IMP=0x00100000001918b5
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x0010000000191508
- (void)notifyClient:(int)arg1;	// IMP=0x00100000001914b4
- (void)dealloc;	// IMP=0x0010000000191476
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x0010000000191342
