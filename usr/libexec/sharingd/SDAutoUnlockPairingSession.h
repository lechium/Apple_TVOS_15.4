...
- (void).cxx_destruct;	// IMP=0x002000000000d716
...
- (void)idsController:(id)arg1 didReceiveProtoData:(id)arg2 forType:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x001000000000d243
- (void)handleTimerFired;	// IMP=0x001000000000d10f
- (void)invalidateResponseTimer;	// IMP=0x001000000000d039
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x001000000000ce3d
- (id)dataFromUUID:(id)arg1;	// IMP=0x001000000000cdba
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x001000000000cbda
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x001000000000cbc2
- (void)handleMessage:(id)arg1 fromDeviceID:(id)arg2 type:(unsigned short)arg3;	// IMP=0x001000000000cbbc
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000000cbb6
- (void)start;	// IMP=0x001000000000cbb0
@property(readonly, nonatomic) SDUnlockTransport *transport;
- (void)invalidate;	// IMP=0x001000000000c9c7
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x001000000000c894
- (id)init;	// IMP=0x001000000000c83c
