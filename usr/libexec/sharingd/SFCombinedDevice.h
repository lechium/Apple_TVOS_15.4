...
- (void).cxx_destruct;	// IMP=0x00200000000748ad
...
- (_Bool)stateIsNearby;	// IMP=0x00100000000744c4
- (_Bool)stateIsMedium;	// IMP=0x0010000000074493
- (_Bool)stateIsClose;	// IMP=0x0010000000074481
- (void)resetTicks;	// IMP=0x00100000000742ea
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000073ffa
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000073f04
- (id)description;	// IMP=0x0010000000073b60
