...
- (void).cxx_destruct;	// IMP=0x002000000019d5aa
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x001000000019c4ff
- (void);	// IMP=0x001000000019c4ea
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x001000000019c443
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x001000000019c191
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x001000000019b933
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x001000000019b52c
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000019b161
- (void)consumeAuthTokenIfReady;	// IMP=0x001000000019aa39
- (void)startAWDL;	// IMP=0x001000000019a01c
- (void)handleConfirmationACK;	// IMP=0x0010000000199da7
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00100000001998e1
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x0010000000198fcd
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x0010000000198c77
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000198584
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x001000000019812e
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000197ee8
- (void)handleWiFiRequestInvalidated;	// IMP=0x0010000000197e8c
- (void)handleRangingStarted;	// IMP=0x0010000000197d88
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x0010000000197cc9
- (void)handleAWDLUp;	// IMP=0x0010000000197b0a
- (void)handlePeerOutOfRange;	// IMP=0x0010000000197820
- (void)handlePeerInRange;	// IMP=0x0010000000197538
- (_Bool)peerInRange:(id)arg1;	// IMP=0x001000000019739a
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x0010000000196e6d
- (void)invalidateConfirmationTimer;	// IMP=0x0010000000196d97
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0010000000196afa
- (void)handleTimerFired;	// IMP=0x0010000000196594
- (void)invalidateTimerIfReady;	// IMP=0x0010000000196549
- (id)aksPeerAvailable;	// IMP=0x0010000000196365
- (void)deviceConnected:(id)arg1;	// IMP=0x0010000000195f9c
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x0010000000195cc3
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x0010000000195c62
- (void)connectionActivated;	// IMP=0x001000000019598b
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x001000000019526e
- (id)getAppName;	// IMP=0x0010000000195266
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x0010000000195138
- (_Bool)isAcceptor;	// IMP=0x0010000000195130
- (id)attemptResults;	// IMP=0x00100000001944cf
- (void)logResults;	// IMP=0x001000000019366f
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00100000001935d3
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x0010000000193537
- (void)removeObservers;	// IMP=0x00100000001934e4
- (void)addObservers;	// IMP=0x00100000001933ea
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x0010000000193299
- (void)_handleCanceledAfterSuccess;	// IMP=0x0010000000193192
- (void)handleCanceledAfterSuccess;	// IMP=0x001000000019310b
- (void)lockKeyBagIfNeeded;	// IMP=0x001000000019302e
- (void)cancelWiFiRequest;	// IMP=0x0010000000192e3c
- (void)_cancel;	// IMP=0x0010000000192af6
- (void)cancel;	// IMP=0x0010000000192a6f
- (void)tearDownAWDLIfNecessary;	// IMP=0x001000000019289b
- (void)completeAttemptIfNecessary;	// IMP=0x00100000001926d9
- (void)invalidateNoDisconnect;	// IMP=0x00100000001926aa
- (void)invalidate;	// IMP=0x0010000000192484
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000192080
