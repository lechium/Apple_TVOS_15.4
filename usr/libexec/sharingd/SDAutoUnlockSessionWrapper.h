...
- (void).cxx_destruct;	// IMP=0x00200000000b5e0a
...
- (id);	// IMP=0x00100000000b5cec
@property(nonatomic) unsigned int version; // @synthesize version=_version;
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b5b64
- (unsigned long long)hash;	// IMP=0x00100000000b59e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b574c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b5560
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b53e8
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b526d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b5260
- (id)dictionaryRepresentation;	// IMP=0x00100000000b4a80
- (id)description;	// IMP=0x00100000000b49d1
