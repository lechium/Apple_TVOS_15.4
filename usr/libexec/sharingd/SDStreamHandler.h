...
- (void).cxx_destruct;	// IMP=0x00200000000fdf93
...
- (id)trimHeader:(id)arg1;	// IMP=0x00100000000fdc28
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x00100000000fdb88
- (void)handleMessageWritten:(id)arg1;	// IMP=0x00100000000fdaa1
- (void)handleSpaceForMessage;	// IMP=0x00100000000fd5d9
- (void)resetReadState;	// IMP=0x00100000000fd595
- (void)handleMessageRead;	// IMP=0x00100000000fd520
- (void)handleHeaderRead;	// IMP=0x00100000000fd400
- (void)handleBytesForMessage;	// IMP=0x00100000000fd12d
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x00100000000fd0c6
- (id)messageWithData:(id)arg1;	// IMP=0x00100000000fd045
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fcd35
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fccf4
- (void)handleSpaceForStream;	// IMP=0x00100000000fc9fa
- (void)handleBytesForStream;	// IMP=0x00100000000fc73b
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x00100000000fc5b8
- (void)handleSpaceAvailable;	// IMP=0x00100000000fc4a5
- (void)handleBytesAvailable;	// IMP=0x00100000000fc392
- (void)handleOpenedStream:(id)arg1;	// IMP=0x00100000000fc177
- (void)setTCPProperties:(id)arg1;	// IMP=0x00100000000fc084
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000fbf00
- (_Bool)evaluateCert;	// IMP=0x00100000000fbc14
- (void)applySSLSettings:(id)arg1;	// IMP=0x00100000000fb8b4
- (void)invalidateOpenTimer;	// IMP=0x00100000000fb822
- (void)openTimerFired:(id)arg1;	// IMP=0x00100000000fb65c
- (void)startOpenTimer;	// IMP=0x00100000000fb585
- (void)logTransfer;	// IMP=0x00100000000fb3b3
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x00100000000fb08f
- (void)stopIfReady;	// IMP=0x00100000000fb04d
- (void)stop;	// IMP=0x00100000000fb00d
- (void)start;	// IMP=0x00100000000fad32
- (void)dealloc;	// IMP=0x00100000000fac76
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x00100000000faacc
