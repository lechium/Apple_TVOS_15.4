...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000c894b
- (unsigned long long)hash;	// IMP=0x00100000000c88e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c87fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c8765
- (void)copyTo:(id)arg1;	// IMP=0x00100000000c86f2
- (void)writeTo:(id)arg1;	// IMP=0x00100000000c8660
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000c8653
- (id)dictionaryRepresentation;	// IMP=0x00100000000c81db
- (id)description;	// IMP=0x00100000000c812c
