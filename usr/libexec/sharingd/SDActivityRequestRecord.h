...
- (void).cxx_destruct;	// IMP=0x002000000000af0b
...
- (void)setDeviceIdentifier:(id)arg1;	// IMP=0x001000000000ae99
- (id)deviceIdentifier;	// IMP=0x001000000000ae8f
...
- (id)description;	// IMP=0x001000000000ad10
- (id)init;	// IMP=0x001000000000acba
