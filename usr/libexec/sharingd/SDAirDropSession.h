...
- (void).cxx_destruct;	// IMP=0x002000000000a86d
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000a3b6
- (void)handleConversionProgress:(id)arg1;	// IMP=0x001000000000a2de
- (void)startProgress;	// IMP=0x0010000000009fee
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x0010000000009fe8
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0010000000009804
- (void)removeClientAlerts;	// IMP=0x00100000000096d3
- (void)dealloc;	// IMP=0x0010000000009652
- (void)stop;	// IMP=0x0010000000009441
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x00100000000090be
- (void)serversChanged:(id)arg1;	// IMP=0x0010000000008d82
- (_Bool)send;	// IMP=0x0010000000008c43
- (void)start;	// IMP=0x001000000000893c
- (void)releaseSandboxExtensions;	// IMP=0x0010000000008808
- (void)consumeSandboxExtensions;	// IMP=0x0010000000008532
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000008506
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x00100000000082d8
