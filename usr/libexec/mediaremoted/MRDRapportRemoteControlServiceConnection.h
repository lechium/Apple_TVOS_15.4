...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000029b0e
- (void).cxx_destruct;	// IMP=0x0020000000029eca
...
- (void)dealloc;	// IMP=0x0010000000029d57
- (id)description;	// IMP=0x0010000000029d0f
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000029bab
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000029b16
