...
- (void).cxx_destruct;	// IMP=0x00200000000116fd
...
- (void)clearRoutedCommands;	// IMP=0x0010000000011684
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0010000000011496
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x0010000000011295
