...
- (void).cxx_destruct;	// IMP=0x00200000000d89c2
...
- (void)cancel;	// IMP=0x00100000000d89a2
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x00100000000d8990
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d88a3
