...
- (void).cxx_destruct;	// IMP=0x0020000000021758
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000215ad
- (id)description;	// IMP=0x001000000002155d
- (id)initWithPID:(int)arg1 audioSessionID:(id)arg2 mxSessionIDs:(id)arg3;	// IMP=0x00100000000214ba
