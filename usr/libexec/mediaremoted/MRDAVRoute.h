...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00400000000dcf60
- (void).cxx_destruct;	// IMP=0x00200000000dd12b
...
- (unsigned long long)sampleRate;	// IMP=0x00100000000dd0b9
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x00100000000dd042
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000dcfb0
