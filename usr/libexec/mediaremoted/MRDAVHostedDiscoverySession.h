...
- (void).cxx_destruct;	// IMP=0x0020000000033f58
...
- (void)_maybeWakeClient;	// IMP=0x0010000000033c96
- (void)_resumeConnection;	// IMP=0x00100000000338e7
- (void)_notifyAvailableEndpointsDidChange:(id)arg1;	// IMP=0x0010000000033687
- (void)_notifyAvailableOutputDevicesDidChange:(id)arg1;	// IMP=0x0010000000033427
- (void)_invalidate;	// IMP=0x00100000000333d3
- (void)connectionDidResume:(id)arg1;	// IMP=0x00100000000333c1
- (void)getAvailableOutputDevicesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003335f
- (void)getAvailableEndpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000332fd
- (void)setDiscoveryMode:(unsigned int)arg1 enableThrottling:(_Bool)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000033247
- (void)getDiscoveryModeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000033234
- (void)getDevicePresenceDetectedWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000331e5
- (void)hostedRoutingController:(id)arg1 outputDevicesDidChange:(id)arg2 forFeature:(unsigned int)arg3;	// IMP=0x001000000003307e
- (void)hostedRoutingController:(id)arg1 endpointsDidChange:(id)arg2;	// IMP=0x0010000000032f17
@property(readonly, nonatomic) NSString *reason;
@property(readonly, copy) NSString *debugDescription;
- (void)dealloc;	// IMP=0x0010000000032a50
- (id)initWithConnection:(id)arg1 hostedRoutingController:(id)arg2;	// IMP=0x0010000000032635
