...
- (void).cxx_destruct;	// IMP=0x00200000000bb21e
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x00100000000bad01
- (void)_checkConnectionStatus;	// IMP=0x00100000000ba834
- (_Bool)_canSendMessage;	// IMP=0x00100000000ba74e
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x00100000000ba696
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x00100000000ba3d9
- (id)description;	// IMP=0x00100000000ba34e
- (id)_initWithLabel:(id)arg1;	// IMP=0x00100000000ba2c7
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000ba20d
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000ba142
