...
- (void).cxx_destruct;	// IMP=0x00200000000cc49a
...
- (void)notifyDelegateOfWake;	// IMP=0x00100000000cc3d3
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000cc337
- (id)init;	// IMP=0x00100000000cc066
