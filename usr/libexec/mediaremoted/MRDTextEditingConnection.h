...
- (void).cxx_destruct;	// IMP=0x0020000000043fb7
...
- (id)concatenatedTextForDocumentState:(id)arg1;	// IMP=0x0010000000043d22
- (void)_setCurrentSession:(id)arg1;	// IMP=0x0010000000043d0e
- (void)_killRemoteTextEditingSession;	// IMP=0x0010000000043c84
- (oneway void)endRemoteTextInputSessionWithID:(id)arg1;	// IMP=0x0010000000043b47
- (oneway void)remoteTextInputSessionWithID:(id)arg1 documentTraitsDidChange:(id)arg2;	// IMP=0x0010000000043a4a
- (oneway void)remoteTextInputSessionWithID:(id)arg1 documentDidChange:(id)arg2;	// IMP=0x00100000000438d8
- (oneway void)beginRemoteTextInputSessionWithID:(id)arg1 documentTraits:(id)arg2 initialDocumentState:(id)arg3;	// IMP=0x0010000000042e79
@property(readonly, nonatomic) MRTextEditingSession *currentSession;
- (void)didInitializeWithConnection:(id)arg1;	// IMP=0x0010000000042d52
