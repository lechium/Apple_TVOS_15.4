...
- (void).cxx_destruct;	// IMP=0x002000000003bc5b
...
- (void)_onQueue_beginTimerWithInterval:(double)arg1;	// IMP=0x001000000003b988
- (void)_onQueue_recalculateStateForReason:(id)arg1;	// IMP=0x001000000003b3ad
- (void)_onQueue_restoreState;	// IMP=0x001000000003b02b
- (void)_handlePersonalDeviceChangeNotification:(id)arg1;	// IMP=0x001000000003afc3
- (id)init;	// IMP=0x001000000003ae19
