...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x004000000003ac44
- (void).cxx_destruct;	// IMP=0x002000000003ae09
...
- (id)_extendedInfo;	// IMP=0x001000000003adbe
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x001000000003ac95
