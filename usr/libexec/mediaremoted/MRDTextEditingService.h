...
- (void)textEditingDidDieForConnection:(id)arg1;	// IMP=0x00100000000a02d5
- (void)_textEditingDidEndForConnection:(id)arg1;	// IMP=0x00100000000a01fc
- (void)textEditingDidEndForConnection:(id)arg1;	// IMP=0x00100000000a00b0
- (void)textEditingConnection:(id)arg1 attributesDidChange:(id)arg2;	// IMP=0x001000000009ff03
- (void)textEditingConnection:(id)arg1 textDidChange:(id)arg2;	// IMP=0x001000000009fd56
- (void)textEditingConnection:(id)arg1 didBeginEditingText:(id)arg2 withAttributes:(id)arg3;	// IMP=0x001000000009fa7a
- (void)inputSystemService:(id)arg1 didCreateInputSession:(id)arg2;	// IMP=0x001000000009f961
...
- (_Bool)handleTextInputMessage:(id)arg1 withError:(id *)arg2;	// IMP=0x001000000009f52f
- (void)stop;	// IMP=0x001000000009f4f0
- (void)start;	// IMP=0x001000000009f3fe
@property(readonly, nonatomic, getter=isRunning) _Bool running;
- (void)dealloc;	// IMP=0x001000000009f35e
- (id)init;	// IMP=0x001000000009f2c5
