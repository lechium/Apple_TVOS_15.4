...
- (void).cxx_destruct;	// IMP=0x0020000000097774
...
- (void)handleCanBeNowPlayingPlayerDidChange:(id)arg1;	// IMP=0x001000000009751c
- (void)_onQueue_popState;	// IMP=0x0010000000096a64
- (void)_onQueue_pushState;	// IMP=0x00100000000969b9
- (id)notificationPlayerPathFromPlayer:(id)arg1;	// IMP=0x0010000000096925
@property(readonly, nonatomic) _Bool hasNowPlayingData;
- (void)_onQueue_removePlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000096679
- (void)removePlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000965cf
- (id)_onQueue_existingPlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000963fa
- (id)existingPlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000962a7
- (id)existingPlayerClientForPlayerPath:(id)arg1;	// IMP=0x0010000000096245
- (id)_onQueue_addPlayer:(id)arg1;	// IMP=0x0010000000096036
- (id)_onQueue_playerClientForPlayer:(id)arg1;	// IMP=0x0010000000095ee8
- (id)playerClientForPlayer:(id)arg1;	// IMP=0x0010000000095d95
- (_Bool)canBeNowPlayingForPlayerClient:(id)arg1;	// IMP=0x0010000000095c92
- (_Bool)_onQueue_anyPlayerIsPlaying;	// IMP=0x0010000000095b4d
@property(readonly, nonatomic) _Bool anyPlayerIsPlaying;
@property(nonatomic) _Bool canBeNowPlaying;
- (void)_reevaluateCanBeNowPlaying;	// IMP=0x001000000009548b
- (id)_onQueue_activePlayerClient;	// IMP=0x001000000009546a
@property(retain, nonatomic) MRDNowPlayingPlayerClient *activePlayerClient;
- (void)_onQueue_setActivePlayerClient:(id)arg1;	// IMP=0x001000000009513d
@property(retain, nonatomic) MRClient *client;
- (void)updateClient:(id)arg1;	// IMP=0x0010000000094e53
...
- (void)initializeDisplayName;	// IMP=0x001000000009490a
- (void)initializeBundleIdentifier;	// IMP=0x001000000009415c
@property(readonly, nonatomic) NSArray *playerClients;
- (id)debugDescription;	// IMP=0x0010000000093b79
- (id)description;	// IMP=0x0010000000093afc
- (void)dealloc;	// IMP=0x0010000000093aba
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x001000000009369b
