...
- (void).cxx_destruct;	// IMP=0x00200000000aabc2
@property(nonatomic) __weak id <MRDPhoneCallObserverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)numberOfActivePhoneCalls:(CDUnknownBlockType)arg1;	// IMP=0x00100000000aaa21
- (void)_notifyDelegate:(id)arg1;	// IMP=0x00100000000aa993
- (void)callObserver:(id)arg1 callChanged:(id)arg2;	// IMP=0x00100000000aa921
- (id)init;	// IMP=0x00100000000aa88b
