...
- (void).cxx_destruct;	// IMP=0x00200000000dd38d
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00100000000dd2de
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dd2ab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dd27f
