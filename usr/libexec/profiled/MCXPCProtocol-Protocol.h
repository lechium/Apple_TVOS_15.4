...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString;
...
- (MISSING_TYPE *)recomputeUserComplianceWarningWithCompletion: /* Error: Ran out of types for this method. */;
