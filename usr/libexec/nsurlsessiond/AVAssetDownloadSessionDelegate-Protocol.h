...
@class AVAssetDownloadSession, AVMediaSelection, MISSING_TYPE, NSArray;
...
- (MISSING_TYPE *)assetDownloadSession:didFailWithError: /* Error: Ran out of types for this method. */;
