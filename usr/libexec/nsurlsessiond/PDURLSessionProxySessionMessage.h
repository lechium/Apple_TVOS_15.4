...
- (void).cxx_destruct;	// IMP=0x0020000000049096
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000048f43
- (unsigned long long)hash;	// IMP=0x0010000000048e90
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000048d41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000048c38
- (void)copyTo:(id)arg1;	// IMP=0x0010000000048b76
- (void)writeTo:(id)arg1;	// IMP=0x0010000000048aac
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000048a9f
- (id)dictionaryRepresentation;	// IMP=0x0010000000048931
- (id)description;	// IMP=0x0010000000048882
