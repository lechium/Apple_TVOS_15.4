...
- (void).cxx_destruct;	// IMP=0x0020000000005788
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000561b
- (id)description;	// IMP=0x001000000000559d
- (id)initWithPluginID:(id)arg1;	// IMP=0x0010000000005436
