...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x00000000000025f0
- (void).cxx_destruct;	// IMP=0x0000000000006d30
...
- (id)_preloadArtwork;	// IMP=0x0000000000006890
- (id)_placeholderArtwork;	// IMP=0x0000000000006790
- (void)_updateState;	// IMP=0x0000000000006530
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000006440
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000005d00
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000005b40
- (void)_updateMetadata;	// IMP=0x00000000000039a0
- (void)_createRequestController;	// IMP=0x0000000000003320
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000003050
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000002d60
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000002870
- (void)playPause;	// IMP=0x0000000000002840
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00000000000027b0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000026d0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000002550
- (id)playerPath;	// IMP=0x0000000000002460
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000002270
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000001e50
