...
- (id)_collectionViewWrapperViewGradientMask;	// IMP=0x0000000000007310
- (void)_handleMenuPress:(id)arg1;	// IMP=0x0000000000007290
- (void)layoutSubviews;	// IMP=0x0000000000007060
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005dd0
