...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0000000000004280
...
- (void)_updateColors;	// IMP=0x0000000000004790
- (void)_updateVisibleAccessoryView;	// IMP=0x00000000000046a0
- (unsigned long long)_floatingContentViewControlState;	// IMP=0x00000000000045d0
- (void)_updateFloatingContentViewControlState;	// IMP=0x0000000000004530
- (_Bool)_canHandlePresses:(id)arg1;	// IMP=0x0000000000004430
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000041b0
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000040e0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000004010
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000003e50
- (void)prepareForReuse;	// IMP=0x0000000000003dd0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000003ce0
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000003cc0
- (void)updateConstraints;	// IMP=0x0000000000003a50
@property(copy, nonatomic) NSString *subtitle;
@property(copy, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001710
