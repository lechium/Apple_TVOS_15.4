...
+ (id)availableStyles;	// IMP=0x0000000000002d10
- (void).cxx_destruct;	// IMP=0x00000000000036a0
...
- (void)_updateContentViewControllerForUser:(id)arg1;	// IMP=0x00000000000033a0
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x00000000000032d0
...
- (void)handleAction;	// IMP=0x0000000000002ec0
- (_Bool)dismissAfterAction;	// IMP=0x0000000000002ea0
- (id)initWithUser:(id)arg1;	// IMP=0x0000000000002d30
