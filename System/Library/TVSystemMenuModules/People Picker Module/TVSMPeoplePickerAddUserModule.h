...
@interface TVSMPeoplePickerAddUserModule : NSObject <TVSMModuleContentViewControllerDelegate, TVSMModule>
{
...
+ (id)availableStyles;	// IMP=0x0000000000003730
- (void).cxx_destruct;	// IMP=0x0000000000003c70
...
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x0000000000003aa0
...
- (id)init;	// IMP=0x0000000000003750
