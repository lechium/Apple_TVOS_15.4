...
+ (Class)layoutAttributesClass;	// IMP=0x0000000000031a90
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000031f40
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000031c20
- (void)prepareLayout;	// IMP=0x0000000000031ac0
