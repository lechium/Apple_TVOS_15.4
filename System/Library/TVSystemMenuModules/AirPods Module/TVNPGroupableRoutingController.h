...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00000000000133f0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000001dad0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001d6b0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000001c100
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00000000000180d0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000017c40
- (void)_updateAvailableRoutes;	// IMP=0x00000000000170d0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000016f10
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000016e90
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000016e40
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000016c40
- (void)presentEARCUpsell;	// IMP=0x00000000000167e0
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000016160
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000015c90
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000014780
- (void)_updateAllowsDestinationSelection;	// IMP=0x00000000000146a0
- (void)dealloc;	// IMP=0x00000000000140f0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000135a0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000013500
