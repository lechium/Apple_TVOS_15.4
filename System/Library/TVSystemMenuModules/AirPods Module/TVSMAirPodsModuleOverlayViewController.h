...
#import "TVSMAirPodsModuleMainViewControllerDelegate-Protocol.h"
...
@interface TVSMAirPodsModuleOverlayViewController : UIViewController <TVSMAirPodsModuleMainViewControllerDelegate, TVSMModuleOverlayContentViewController>
{
...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000031830
- (id)preferredFocusEnvironments;	// IMP=0x00000000000317b0
- (void)viewDidLoad;	// IMP=0x0000000000031370
- (id)initWithRouteController:(id)arg1;	// IMP=0x00000000000311f0
