...
- (void).cxx_destruct;	// IMP=0x0000000000004d40
...
- (unsigned long long)_controlStateForCell;	// IMP=0x00000000000049f0
- (void)_updatePackageRasterizationScale;	// IMP=0x0000000000004920
- (void)_updatePackageViewVisibility;	// IMP=0x0000000000004750
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000004140
- (void)_setupPackageViews;	// IMP=0x00000000000038e0
- (void)_setupConstraints;	// IMP=0x0000000000002e60
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000002d50
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000002cd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000022a0
