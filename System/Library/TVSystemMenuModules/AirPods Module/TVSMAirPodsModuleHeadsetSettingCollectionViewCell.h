...
- (void)updateConstraints;	// IMP=0x0000000000044be0
- (void)_addInitialConstraints;	// IMP=0x0000000000043ae0
- (void)_setupPackageView:(id)arg1;	// IMP=0x0000000000043730
- (void)_updatePackageViewVisibility;	// IMP=0x0000000000043550
@property(nonatomic) _Bool selectionEnabled;
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000000042ec0
- (id)preferredFocusEnvironments;	// IMP=0x0000000000042e40
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000425a0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000042480
- (void)selectedSetting;	// IMP=0x0000000000042420
- (void)prepareForReuse;	// IMP=0x0000000000042320
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000041a30
