...
- (void).cxx_destruct;	// IMP=0x0000000000002210
...
- (void)_calculateAndSetRasterizationScaleForLayer:(id)arg1;	// IMP=0x0000000000001ca0
- (void)_updateRasterizationScale;	// IMP=0x0000000000001c20
- (void)_setPackage:(id)arg1;	// IMP=0x0000000000001a20
- (void)setStateName:(id)arg1;	// IMP=0x0000000000001970
- (void)layoutSubviews;	// IMP=0x00000000000015a0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001480
