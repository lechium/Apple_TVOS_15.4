...
- (void).cxx_destruct;	// IMP=0x0000000000031120
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0000000000030c20
- (void)connectAndPair;	// IMP=0x0000000000030c10
- (void)togglePlayPause;	// IMP=0x0000000000030c00
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0000000000030b60
