...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000000034150
- (void).cxx_destruct;	// IMP=0x00000000000386f0
...
- (id)_preloadArtwork;	// IMP=0x0000000000038250
- (id)_placeholderArtwork;	// IMP=0x0000000000038150
- (void)_updateState;	// IMP=0x0000000000037ef0
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000037e00
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x00000000000377b0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x00000000000375f0
- (void)_updateMetadata;	// IMP=0x00000000000354c0
- (void)_createRequestController;	// IMP=0x0000000000034e40
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000034b70
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000348c0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000000343d0
- (void)playPause;	// IMP=0x00000000000343a0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000034310
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000034230
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x00000000000340b0
- (id)playerPath;	// IMP=0x0000000000033fc0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000033dd0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000033a20
