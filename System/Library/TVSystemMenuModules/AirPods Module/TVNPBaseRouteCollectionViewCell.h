...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0000000000041320
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x000000000003ee80
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x000000000003ae00
+ (_Bool)allowsSelection;	// IMP=0x000000000003ade0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x0000000000041110
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000040270
- (unsigned long long)_controlStateForCell;	// IMP=0x00000000000401a0
- (void)_addInitialConstraints;	// IMP=0x000000000003f030
- (void)accessoryViewSelected;	// IMP=0x000000000003ee70
- (void)routeViewSelected;	// IMP=0x000000000003ee60
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000003ee20
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000003e400
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000003e2d0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000003e1c0
- (void)updateConstraints;	// IMP=0x000000000003c380
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000003c250
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000003c230
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000003c0f0
- (void)prepareForReuse;	// IMP=0x000000000003c050
- (id)preferredFocusEnvironments;	// IMP=0x000000000003bed0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003ae20
