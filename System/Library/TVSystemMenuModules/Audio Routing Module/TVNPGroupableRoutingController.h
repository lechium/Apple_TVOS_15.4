...
@interface TVNPGroupableRoutingController : NSObject <MPAVRoutingControllerDelegate, HMMediaDestinationControllerDelegate, HMAccessoryDelegatePrivate, TVNPRoutingController>
{
...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00000000000016e0
- (void).cxx_destruct;	// IMP=0x000000000000c5a0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000000bee0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000bac0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000a510
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00000000000064e0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000006050
- (void)_updateAvailableRoutes;	// IMP=0x00000000000054e0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x00000000000052d0
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000005250
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000005200
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000005000
- (void)presentEARCUpsell;	// IMP=0x0000000000004b80
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000004500
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000004030
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000002ab0
- (void)_updateAllowsDestinationSelection;	// IMP=0x00000000000029d0
- (void)dealloc;	// IMP=0x0000000000002420
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001890
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x00000000000017f0
- (id)init;	// IMP=0x0000000000001790
