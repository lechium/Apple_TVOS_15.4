...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000000029110
...
- (id)_preloadArtwork;	// IMP=0x000000000002d270
- (id)_placeholderArtwork;	// IMP=0x000000000002d170
- (void)_updateState;	// IMP=0x000000000002cf10
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000002ce20
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000002c770
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000002c5b0
- (void)_updateMetadata;	// IMP=0x000000000002a480
- (void)_createRequestController;	// IMP=0x0000000000029e00
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000029b30
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000029880
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000029390
- (void)playPause;	// IMP=0x0000000000029360
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00000000000292d0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000291f0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000029070
- (id)playerPath;	// IMP=0x0000000000028f80
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000028d90
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00000000000289e0
