...
+ (id)_titleForGroupWithMembers:(id)arg1 leader:(id)arg2;	// IMP=0x000000000002f020
- (void).cxx_destruct;	// IMP=0x000000000002f7c0
...
- (id)_imageForGroupWithMembers:(id)arg1 leader:(id)arg2;	// IMP=0x000000000002f3d0
- (id)deviceImage;	// IMP=0x000000000002ef40
- (void)updateWithGroupLeader:(id)arg1 members:(id)arg2;	// IMP=0x000000000002ebf0
