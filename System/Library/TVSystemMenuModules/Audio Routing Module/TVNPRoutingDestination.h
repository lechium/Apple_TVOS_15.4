...
- (void).cxx_destruct;	// IMP=0x000000000002fe00
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000002f900
- (void)connectAndPair;	// IMP=0x000000000002f8f0
- (void)togglePlayPause;	// IMP=0x000000000002f8e0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000002f840
- (id)init;	// IMP=0x000000000002f810
