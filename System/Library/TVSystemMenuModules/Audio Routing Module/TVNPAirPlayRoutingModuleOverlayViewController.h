...
- (void).cxx_destruct;	// IMP=0x00000000000372a0
...
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000037130
- (id)preferredFocusEnvironments;	// IMP=0x00000000000370b0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000036f10
- (void)viewDidLoad;	// IMP=0x0000000000036d90
- (id)initWithRoutingController:(id)arg1;	// IMP=0x0000000000036c60
