...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x000000000001ff60
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x000000000001dac0
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x0000000000019a40
+ (_Bool)allowsSelection;	// IMP=0x0000000000019a20
- (void).cxx_destruct;	// IMP=0x0000000000020440
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x000000000001fd50
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001eeb0
- (unsigned long long)_controlStateForCell;	// IMP=0x000000000001ede0
- (void)_addInitialConstraints;	// IMP=0x000000000001dc70
- (void)accessoryViewSelected;	// IMP=0x000000000001dab0
- (void)routeViewSelected;	// IMP=0x000000000001daa0
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000001da60
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000001d040
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000001cf10
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001ce00
- (void)updateConstraints;	// IMP=0x000000000001afc0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000001ae90
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000001ae70
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001ad30
- (void)prepareForReuse;	// IMP=0x000000000001ac90
- (id)preferredFocusEnvironments;	// IMP=0x000000000001ab10
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019a60
