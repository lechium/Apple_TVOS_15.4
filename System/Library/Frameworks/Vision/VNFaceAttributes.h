...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000dfb32
- (void).cxx_destruct;	// IMP=0x00000000000df428
...
- (void)setVN5ui9WkMeVvCBruHiQE1q2r6E9kO1AyrP:(id)arg1;	// IMP=0x00000000000df33d
...
- (void)setAgeCategory:(id)arg1;	// IMP=0x00000000000df1db
@property(readonly) VNFaceAttributeCategory *ageCategory; // @synthesize ageCategory=_ageCategory;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000de708
- (unsigned long long)hash;	// IMP=0x00000000000de235
- (id)vn_cloneObject;	// IMP=0x00000000000de0ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000de0e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000dde88
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000dd9ae
- (id)initWithRequestRevision:(unsigned long long)arg1;	// IMP=0x00000000000dd955
