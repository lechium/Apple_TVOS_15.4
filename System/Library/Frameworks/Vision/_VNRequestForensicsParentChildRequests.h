...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a553
- (unsigned long long)hash;	// IMP=0x000000000003a4c2
- (id)description;	// IMP=0x000000000003a401
- (id)initWithParentRequest:(id)arg1 orderedChildRequests:(id)arg2;	// IMP=0x000000000003a347
