...
- (void).cxx_destruct;	// IMP=0x000000000014992c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000149807
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001497b5
