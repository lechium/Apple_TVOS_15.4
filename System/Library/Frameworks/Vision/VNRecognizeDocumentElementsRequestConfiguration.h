...
- (void).cxx_destruct;	// IMP=0x00000000001e0af1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e09b5
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001e08c8
