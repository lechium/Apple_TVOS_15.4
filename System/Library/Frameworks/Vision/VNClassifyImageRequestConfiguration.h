...
- (void).cxx_destruct;	// IMP=0x00000000000db686
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000db53b
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000db4d8
