...
- (void).cxx_destruct;	// IMP=0x00000000001b7659
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b7405
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001b7317
