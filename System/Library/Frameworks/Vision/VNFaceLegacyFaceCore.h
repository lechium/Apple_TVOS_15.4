...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000199227
+ (void)_setFaceExpressionFeatureScoreIfDetected:(id)arg1 features:(id)arg2 detectionKey:(id)arg3 scoreKey:(id)arg4 featureKey:(id)arg5;	// IMP=0x00000000001990cb
- (void).cxx_destruct;	// IMP=0x000000000019903c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000198f98
@property(readonly, nonatomic) unsigned long long requestRevision;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000198bc9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001988ac
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000198634
- (id)initWithFace:(id)arg1;	// IMP=0x0000000000198259
