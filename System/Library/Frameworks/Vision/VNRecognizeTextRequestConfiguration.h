...
- (void).cxx_destruct;	// IMP=0x00000000001f3e1a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f3cc2
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001f3bf7
