...
- (void)releaseAllocations;	// IMP=0x00000000001e31b8
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x00000000001e30ec
- (void)dealloc;	// IMP=0x00000000001e3079
- (void)resetBoxBounds;	// IMP=0x00000000001e3068
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x00000000001e3037
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000001e3022
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000001e300f
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000001e2fff
