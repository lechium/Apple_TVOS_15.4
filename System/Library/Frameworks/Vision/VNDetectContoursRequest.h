...
+ (Class)configurationClass;	// IMP=0x00000000001df652
...
- (_Bool)willAcceptCachedResultsFromRequestWithConfiguration:(id)arg1;	// IMP=0x00000000001defbd
- (_Bool)internalPerformRevision:(unsigned long long)arg1 inContext:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001de964
- (void)applyConfigurationOfRequest:(id)arg1;	// IMP=0x00000000001de7bf
