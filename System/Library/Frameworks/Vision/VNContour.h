...
- (id).cxx_construct;	// IMP=0x00000000001f6958
- (void).cxx_destruct;	// IMP=0x00000000001f691e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f68df
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f6654
- (unsigned long long)hash;	// IMP=0x00000000001f64fe
@property(readonly) const struct CGPath *normalizedPath;
- (id)polygonApproximationWithEpsilon:(float)arg1 error:(id *)arg2;	// IMP=0x00000000001f609c
@property(readonly) const MISSING_TYPE **normalizedPoints;
@property(readonly) long long pointCount;
- (id)childContourAtIndex:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x00000000001f5ec5
...
- (void)dealloc;	// IMP=0x00000000001f5c68
- (id)initWithPoints:(const void *)arg1 topLevelIndex:(unsigned long long)arg2 indexPath:(id)arg3 aspectRatio:(float)arg4;	// IMP=0x00000000001f5a6d
