...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x000000000011e29a
- (void).cxx_destruct;	// IMP=0x000000000011e287
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011e0c2
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000011e008
