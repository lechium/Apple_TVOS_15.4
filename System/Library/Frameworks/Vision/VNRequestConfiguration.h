...
- (void).cxx_destruct;	// IMP=0x0000000000098060
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000097ecd
- (id)description;	// IMP=0x0000000000097bfb
@property(readonly, copy, nonatomic) VNProcessingDevice *resolvedProcessingDevice;
- (id)_allPropertyNames;	// IMP=0x0000000000097a41
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000097990
