...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018da7b
- (void).cxx_destruct;	// IMP=0x000000000018da48
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018d999
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018d740
