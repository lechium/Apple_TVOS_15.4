...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018ee7b
- (void).cxx_destruct;	// IMP=0x000000000018ee48
...
- (void)dealloc;	// IMP=0x000000000018ece7
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000018ea05
- (unsigned long long)serializedLength;	// IMP=0x000000000018e9e5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018e9c3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018e4fc
