...
- (void).cxx_destruct;	// IMP=0x00000000000d3db3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d3bb3
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000d3b1c
