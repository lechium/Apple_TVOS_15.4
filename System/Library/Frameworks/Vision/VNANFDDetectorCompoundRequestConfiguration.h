...
- (void).cxx_destruct;	// IMP=0x000000000024c9ac
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x000000000024c83e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024c75f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000024c698
