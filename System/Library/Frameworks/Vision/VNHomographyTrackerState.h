...
- (id).cxx_construct;	// IMP=0x000000000018f4e1
- (void).cxx_destruct;	// IMP=0x000000000018f4b2
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x000000000018f04c
- (_Bool)ICShouldBeCanceled;	// IMP=0x000000000018f044
- (void)dealloc;	// IMP=0x000000000018efc8
- (id)init;	// IMP=0x000000000018ee8b
