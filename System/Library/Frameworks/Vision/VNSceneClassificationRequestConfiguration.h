...
- (void).cxx_destruct;	// IMP=0x0000000000053a46
...
- (id)description;	// IMP=0x0000000000053831
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053771
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000053722
