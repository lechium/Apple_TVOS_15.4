...
+ (id)modelForMLModel:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000193a0f
- (void).cxx_destruct;	// IMP=0x00000000001939a5
...
- (id)sequencedRequestPreviousObservationsKey;	// IMP=0x000000000019381e
- (_Bool)wantsSequencedRequestObservationsRecording;	// IMP=0x0000000000193816
@property(readonly, copy, nonatomic) id <NSObject><NSCopying> cachingIdentifier;
- (id)predictWithScenePrint:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000019366f
- (id)predictWithCVPixelBuffer:(struct __CVBuffer *)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001934d6
- (void)_updateModelWithFlexibleImageConstraintUsingWidth:(long long)arg1 height:(long long)arg2;	// IMP=0x000000000019336a
- (_Bool)setupInputImageFromModelDescription:(id)arg1;	// IMP=0x0000000000193106
@property(copy, nonatomic) NSString *inputImageFeatureName;
- (id)initWithMLModel:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001927e2
