...
- (void).cxx_destruct;	// IMP=0x00000000001aad2b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001aac56
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001aabe9
