...
- (void).cxx_destruct;	// IMP=0x000000000021cb9f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021cae0
- (void)updateWithPropertiesOfModel:(id)arg1;	// IMP=0x000000000021ca91
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000021ca4e
