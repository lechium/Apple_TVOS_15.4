...
- (void).cxx_destruct;	// IMP=0x0000000000038b9d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038a64
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000389e4
