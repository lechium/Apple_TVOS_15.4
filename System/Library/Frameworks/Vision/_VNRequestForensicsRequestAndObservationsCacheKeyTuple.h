...
- (void).cxx_destruct;	// IMP=0x000000000003a31f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a206
- (unsigned long long)hash;	// IMP=0x000000000003a175
- (id)description;	// IMP=0x000000000003a0e2
- (id)initWithRequest:(id)arg1 observationsCacheKey:(id)arg2;	// IMP=0x000000000003a03a
