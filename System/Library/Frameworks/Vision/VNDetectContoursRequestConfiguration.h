...
- (void).cxx_destruct;	// IMP=0x00000000001de7ac
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001de5e2
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001de51c
