...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000189d81
+ (id)defaultOriginatingRequestClassNameForRequestRevision:(unsigned long long)arg1;	// IMP=0x0000000000189d74
+ (unsigned long long)landmarkPointSizeInBytes;	// IMP=0x0000000000189d69
- (void).cxx_destruct;	// IMP=0x0000000000189c9f
...
- (void *)_createPointArray:(const int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000188d77
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000188cfd
- (void)_initLocks;	// IMP=0x0000000000188c87
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000188a13
- (id)initWithOriginatingRequestSpecifier:(id)arg1 pointsData:(id)arg2 pointCount:(unsigned long long)arg3 userFacingBBox:(struct CGRect)arg4 alignedBBox:(struct _Geometry2D_rect2D_)arg5 landmarkScore:(float)arg6;	// IMP=0x000000000018891b
