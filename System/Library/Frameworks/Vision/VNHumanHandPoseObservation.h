...
- (id)recognizedPointsForJointsGroupName:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000118ccd
- (id)recognizedPointForJointName:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000118cab
