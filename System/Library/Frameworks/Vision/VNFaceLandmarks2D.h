...
+ (id)_createNSArrayFrom:(id)arg1 withPointIndices:(const int *)arg2 andPointCount:(unsigned long long)arg3;	// IMP=0x0000000000188815
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018880d
+ (id)defaultOriginatingRequestClassNameForRequestRevision:(unsigned long long)arg1;	// IMP=0x0000000000188800
+ (unsigned long long)landmarkPointSizeInBytes;	// IMP=0x00000000001887f5
- (void).cxx_destruct;	// IMP=0x00000000001886f8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000188541
...
- (id)_createFaceLandmarks2DRegionFromPointIndexes:(const int *)arg1 andPointCount:(unsigned long long)arg2;	// IMP=0x0000000000187a9a
...
- (void *)_createPointArray:(const int *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000001873a9
- (unsigned long long)hash;	// IMP=0x000000000018733f
- (void)_initLocks;	// IMP=0x00000000001872b5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001871f7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000186df4
- (id)initWithOriginatingRequestSpecifier:(id)arg1 pointsData:(id)arg2 pointCount:(unsigned long long)arg3 constellation:(unsigned long long)arg4 precisionEstimatesPerPoint:(id)arg5 userFacingBBox:(struct CGRect)arg6 alignedBBox:(struct _Geometry2D_rect2D_)arg7 landmarkScore:(float)arg8;	// IMP=0x0000000000186cb9
