...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000012a99c
+ (id)defaultOriginatingRequestClassNameForRequestRevision:(unsigned long long)arg1;	// IMP=0x000000000012a98f
+ (id)allScorePropertyNames;	// IMP=0x000000000012a92c
