...
- (id)itemAtIndex:(long long)arg1;	// IMP=0x00000000001d4fb9
...
- (void)dealloc;	// IMP=0x00000000001d4ecf
- (void)_clear;	// IMP=0x00000000001d50fb
- (void)_removeAllItems;	// IMP=0x00000000001d50ed
