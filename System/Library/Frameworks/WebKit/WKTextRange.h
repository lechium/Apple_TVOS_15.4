...
+ (id)textRangeWithState:(_Bool)arg1 isRange:(_Bool)arg2 isEditable:(_Bool)arg3 startRect:(struct CGRect)arg4 endRect:(struct CGRect)arg5 selectionRects:(id)arg6 selectedTextLength:(unsigned long long)arg7;	// IMP=0x000000000072cbd3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000072ceda
- (_Bool)isEmpty;	// IMP=0x000000000072cec5
- (id)end;	// IMP=0x000000000072ce68
- (id)start;	// IMP=0x000000000072ce0b
- (id)description;	// IMP=0x000000000072cd26
- (void)dealloc;	// IMP=0x000000000072cce4
- (_Bool)_isRanged;	// IMP=0x000000000072cbbe
- (_Bool)_isCaret;	// IMP=0x000000000072cbac
