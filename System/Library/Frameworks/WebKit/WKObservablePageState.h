...
- (id).cxx_construct;	// IMP=0x00000000001b0032
- (void).cxx_destruct;	// IMP=0x00000000001affeb
...
- (void)dealloc;	// IMP=0x00000000001afd7e
- (id)initWithPage:(void *)arg1;	// IMP=0x00000000001afcad
