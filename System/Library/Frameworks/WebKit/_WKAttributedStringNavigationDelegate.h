...
- (void)webView:(id)arg1 didFinishNavigation:(id)arg2;	// IMP=0x00000000001d346e
- (void)webView:(id)arg1 didFailNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x00000000001d344f
- (void)webView:(id)arg1 didFailProvisionalNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x00000000001d3430
- (void)webView:(id)arg1 decidePolicyForNavigationAction:(id)arg2 decisionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001d3407
- (void)webViewWebContentProcessDidTerminate:(id)arg1;	// IMP=0x00000000001d33ee
- (void)dealloc;	// IMP=0x00000000001d3374
