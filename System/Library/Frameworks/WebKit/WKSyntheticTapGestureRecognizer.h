...
- (id).cxx_construct;	// IMP=0x000000000036942e
- (void).cxx_destruct;	// IMP=0x00000000003693b7
...
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000036917a
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000368fe4
- (void)reset;	// IMP=0x0000000000368f58
- (void)setState:(long long)arg1;	// IMP=0x0000000000368eca
- (void)setResetTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000368e9b
- (void)setGestureFailedTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000368e6c
- (void)setGestureIdentifiedTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000368e3d
