...
- (id).cxx_construct;	// IMP=0x0000000000381321
- (void).cxx_destruct;	// IMP=0x0000000000381301
...
- (_Bool)handleKeyEvent:(id)arg1;	// IMP=0x00000000003811cd
@property(readonly, nonatomic) NSObject<WKFormControl> *control;
- (id)assistantView;	// IMP=0x00000000003811ad
- (void)endEditing;	// IMP=0x000000000038118b
- (void)beginEditing;	// IMP=0x0000000000381169
- (id)initWithView:(id)arg1 control:(void *)arg2;	// IMP=0x00000000003810ff
