...
{
    struct ObjectStorage<WebKit::WebPreferences> _preferences;	// 8 = 0x8
}

+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000223fb6
+ (id)_experimentalFeatures;	// IMP=0x000000000022510a
+ (id)_internalDebugFeatures;	// IMP=0x0000000000225039
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022413f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000224065
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000223fbe
- (void)dealloc;	// IMP=0x0000000000223f60
- (id)init;	// IMP=0x0000000000223e56
...
- (void)_setEnabled:(_Bool)arg1 forExperimentalFeature:(id)arg2;	// IMP=0x00000000002251ed
- (_Bool)_isEnabledForExperimentalFeature:(id)arg1;	// IMP=0x00000000002251db
- (void)_setEnabled:(_Bool)arg1 forFeature:(id)arg2;	// IMP=0x00000000002251c9
- (_Bool)_isEnabledForFeature:(id)arg1;	// IMP=0x00000000002251b7
- (void)_setEnabled:(_Bool)arg1 forInternalDebugFeature:(id)arg2;	// IMP=0x00000000002250f8
- (_Bool)_isEnabledForInternalDebugFeature:(id)arg1;	// IMP=0x00000000002250e6
