...
- (id).cxx_construct;	// IMP=0x0000000000392119
- (void).cxx_destruct;	// IMP=0x00000000003920df
...
- (void)advance;	// IMP=0x0000000000391e70
- (id)initWithRange:(id)arg1;	// IMP=0x0000000000391d4c
