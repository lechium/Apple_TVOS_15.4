...
- (id).cxx_construct;	// IMP=0x0000000000714a1c
- (void).cxx_destruct;	// IMP=0x00000000007149b2
...
- (id)initWithFocusedElementInformation:(const void *)arg1 isUserInitiated:(_Bool)arg2 userObject:(id)arg3;	// IMP=0x00000000007147fa
