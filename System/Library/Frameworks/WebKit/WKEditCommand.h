...
- (id).cxx_construct;	// IMP=0x00000000002e2b4c
- (void).cxx_destruct;	// IMP=0x00000000002e2b2b
- (void *)command;	// IMP=0x00000000002e2b21
- (id)initWithWebEditCommandProxy:(void *)arg1;	// IMP=0x00000000002e2abe
