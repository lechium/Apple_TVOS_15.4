...
- (id).cxx_construct;	// IMP=0x00000000007147de
- (void).cxx_destruct;	// IMP=0x000000000071476b
- (void)reloadFocusedElementContextView;	// IMP=0x000000000071474d
- (void)invalidate;	// IMP=0x0000000000714706
@property(readonly, nonatomic) _Bool requiresStrongPasswordAssistance;
@property(copy, nonatomic) NSArray *suggestions;
- (void)endEditing;	// IMP=0x000000000071463f
...
- (id)initWithContentView:(id)arg1 focusedElementInfo:(id)arg2 requiresStrongPasswordAssistance:(_Bool)arg3;	// IMP=0x0000000000714356
