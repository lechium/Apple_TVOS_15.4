...
@interface WKWebViewConfiguration : NSObject <NSSecureCoding, NSCopying>
{
    ...
    _Bool _needsStorageAccessFromFileURLsQuirk;	// 219 = 0xdb
    _Bool _legacyEncryptedMediaAPIEnabled;	// 220 = 0xdc
    _Bool _allowMediaContentTypesRequiringHardwareSupportAsFallback;	// 221 = 0xdd
    _Bool _colorFilterEnabled;	// 222 = 0xde
    _Bool _incompleteImageBorderEnabled;	// 223 = 0xdf
    _Bool _shouldDeferAsynchronousScriptsUntilAfterDocumentLoad;	// 224 = 0xe0
    _Bool _drawsBackground;	// 225 = 0xe1
    _Bool _undoManagerAPIEnabled;	// 226 = 0xe2
...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000261bb4
- (id).cxx_construct;	// IMP=0x00000000002631da
- (void).cxx_destruct;	// IMP=0x000000000026307f
...
- (Ref_2324e752)copyPageConfiguration;	// IMP=0x0000000000262f9d
...
- (id)urlSchemeHandlerForURLScheme:(id)arg1;	// IMP=0x0000000000262d2b
- (void)setURLSchemeHandler:(id)arg1 forURLScheme:(id)arg2;	// IMP=0x0000000000262af9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002621fb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000261e94
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000261bbc
- (id)description;	// IMP=0x0000000000261b36
- (id)init;	// IMP=0x0000000000261972
...
- (void)_setVisitedLinkProvider:(id)arg1;	// IMP=0x0000000000264167
- (id)_visitedLinkProvider;	// IMP=0x0000000000264155
