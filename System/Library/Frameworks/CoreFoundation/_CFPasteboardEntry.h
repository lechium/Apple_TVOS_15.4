...
- (CDUnknownBlockType)requestDataForPasteboard:(struct __CFPasteboard *)arg1 generation:(long long)arg2 immediatelyAvailableResult:(CDStruct_55991ab6 *)arg3;	// IMP=0x0000000000068845
- (void)resolveClientPromisedDataWithQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000068517
- (unsigned char)resolveLocalPromisedData;	// IMP=0x000000000006846a
- (void)promiseDataWithBlock:(CDUnknownBlockType)arg1 forPasteboard:(struct __CFPasteboard *)arg2 generation:(long long)arg3;	// IMP=0x0000000000068341
- (id)createXPCObjectWithMetadataOnly:(unsigned char)arg1;	// IMP=0x0000000000068209
- (id)initFromXPCObject:(id)arg1 fromConnection:(id)arg2;	// IMP=0x0000000000067df4
@property(readonly) unsigned char promisorExistsInCurrentProcess;
- (void)_setLocalPromiseState:(int)arg1;	// IMP=0x0000000000067c98
@property(readonly) unsigned char hasLocalPromise;
- (const struct __CFData *)createDataAndReturnError:(int *)arg1;	// IMP=0x0000000000067b47
- (id)_createXPCData;	// IMP=0x0000000000067af2
- (void)setData:(struct __CFData *)arg1;	// IMP=0x0000000000067a5c
@property(readonly) unsigned char hasData;
- (id)description;	// IMP=0x00000000000678b2
- (void)dealloc;	// IMP=0x00000000000677e2
- (id)initWithFlavorName:(const struct __CFString *)arg1 itemIdentifier:(int)arg2;	// IMP=0x0000000000067747
- (void)promiseDataWithFetchOperation:(id)arg1;	// IMP=0x000000000008e22a
