...
+ (id)sharedInstance;	// IMP=0x0000000000095b13
- (void).cxx_destruct;	// IMP=0x00000000000976e9
...
- (id)debugDescription;	// IMP=0x0000000000097373
...
- (id)preferencesFileChangeNotificationName;	// IMP=0x0000000000096dc5
- (id)preferencesUpdateNotificationName;	// IMP=0x0000000000096daa
- (id)databaseUpdateNotificationNameForUserID:(unsigned int)arg1;	// IMP=0x0000000000096d73
- (id)databaseUpdateNotificationName;	// IMP=0x0000000000096d58
- (id)darwinNotificationNameForCurrentUser:(id)arg1 userID:(const unsigned int *)arg2;	// IMP=0x0000000000096d42
- (unsigned int)proxyUIDForCurrentEffectiveUID;	// IMP=0x0000000000096c6b
- (unsigned int)proxyUIDForUID:(unsigned int)arg1;	// IMP=0x0000000000096c54
- (id)serviceNameForConnectionType:(unsigned short)arg1;	// IMP=0x00000000000969fe
...
- (id)classesWithNameForXCTests:(const char *)arg1;	// IMP=0x000000000009685f
...
- (id)databaseStoreFileURLWithUID:(unsigned int)arg1;	// IMP=0x0000000000096270
...
- (id)userPreferencesURL;	// IMP=0x00000000000961cc
...
- (id)init;	// IMP=0x0000000000095b73
