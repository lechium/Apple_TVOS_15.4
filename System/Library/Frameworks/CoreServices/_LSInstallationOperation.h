...
- (void).cxx_destruct;	// IMP=0x0000000000131d7d
...
- (id)redactedDescription;	// IMP=0x0000000000131d0a
- (id)description;	// IMP=0x0000000000131cbc
- (id)initWithBundleID:(id)arg1 installType:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000131c08
