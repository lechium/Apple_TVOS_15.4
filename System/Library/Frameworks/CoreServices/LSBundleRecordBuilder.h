...
@interface LSBundleRecordBuilder
{
    ...
    NSString *_watchKitVersion;	// 456 = 0x1c8
    NSString *_complicationPrincipalClass;	// 464 = 0x1d0
    NSArray *_supportedComplicationFamilies;	// 472 = 0x1d8
    NSString *_ratingLabel;	// 480 = 0x1e0
    NSNumber *_ratingRank;	// 488 = 0x1e8
    NSString *_genre;	// 496 = 0x1f0
    NSNumber *_genreID;	// 504 = 0x1f8
    NSString *_primaryIconName;	// 512 = 0x200
    NSString *_alternatePrimaryIconName;	// 520 = 0x208
    NSDictionary *_iconsDict;	// 528 = 0x210
    NSArray *_iconFileNames;	// 536 = 0x218
    NSNumber *_purchaserDSID;	// 544 = 0x220
    NSNumber *_downloaderDSID;	// 552 = 0x228
    NSNumber *_familyID;	// 560 = 0x230
    NSNumber *_staticDiskUsage;	// 568 = 0x238
    NSString *_libraryPath;	// 576 = 0x240
    NSArray *_libraryItems;	// 584 = 0x248
    NSArray *_documentClaims;	// 592 = 0x250
    NSArray *_URLClaims;	// 600 = 0x258
    NSArray *_importedTypes;	// 608 = 0x260
    NSArray *_exportedTypes;	// 616 = 0x268
    NSArray *_queriableSchemes;	// 624 = 0x270
    NSDictionary *_pluginPlists;	// 632 = 0x278
    NSDictionary *_pluginMIDicts;	// 640 = 0x280
    NSDictionary *_groupContainers;	// 648 = 0x288
    NSDictionary *_entitlements;	// 656 = 0x290
    NSDictionary *_sandboxEnvironmentVariables;	// 664 = 0x298
    NSDictionary *_extensionSDK;	// 672 = 0x2a0
    NSDictionary *_intentDefinitionURLs;	// 680 = 0x2a8
    NSArray *_bgPermittedIdentifiers;	// 688 = 0x2b0
    NSDictionary *_localizedNames;	// 696 = 0x2b8
    NSDictionary *_localizedShortNames;	// 704 = 0x2c0
    NSDictionary *_localizedStrings;	// 712 = 0x2c8
    NSDictionary *_unlocalizedNamesWithContext;	// 720 = 0x2d0
    NSArray *_managedPersonas;	// 728 = 0x2d8
    NSNumber *_directoryClass;	// 736 = 0x2e0
    NSDictionary *_mobileInstallIDs;	// 744 = 0x2e8
    NSArray *_slices;	// 752 = 0x2f0
    NSNumber *_signatureVersion;	// 760 = 0x2f8
    NSDictionary *_stashedAppInfo;	// 768 = 0x300
    NSString *_applicationManagementDomain;	// 776 = 0x308
    NSString *_linkedParentBundleID;	// 784 = 0x310
}

- (void).cxx_destruct;	// IMP=0x00000000000738d8
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000072b61
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x0000000000072a8a
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000070680
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x000000000007057c
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x0000000000070329
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x000000000006f3a5
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x000000000006d9f8
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x000000000006d780
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x000000000006d615
- (void)parseIconFilenamesFromDict:(id)arg1;	// IMP=0x000000000006d53b
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x000000000006d0d5
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x000000000006d068
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x000000000006cf35
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x000000000006cca8
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x000000000006ca06
- (id)_LSKeyTypeMap;	// IMP=0x000000000006c810
- (id)_LSPlistRaritiesMap;	// IMP=0x000000000006c600
- (id)_LSBundleFlagMap;	// IMP=0x000000000006c0f2
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x000000000006beab
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x000000000006bab6
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x000000000006baa6
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x000000000006ba96
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x000000000006ba86
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x000000000006ba75
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x000000000006b962
