...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002473b
- (void).cxx_destruct;	// IMP=0x0000000000024e17
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x00000000000249a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000024903
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024743
