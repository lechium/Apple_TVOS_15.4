...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d1ff0
- (void).cxx_destruct;	// IMP=0x00000000000d2310
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d20d2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d1ff8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d1f20
@property(nonatomic) _Bool ignoreOpenStrategy;
- (id)init;	// IMP=0x00000000000d1ec4
