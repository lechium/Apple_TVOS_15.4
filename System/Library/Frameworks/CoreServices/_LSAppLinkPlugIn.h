...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x0000000000043cea
+ (id)plugInClasses;	// IMP=0x0000000000043c7e
- (void).cxx_destruct;	// IMP=0x0000000000043f90
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x0000000000043ee7
