...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000041b01
- (id).cxx_construct;	// IMP=0x0000000000041f08
- (void).cxx_destruct;	// IMP=0x0000000000041ebf
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000041c39
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000041b09
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000041a10
- (id)debugDescription;	// IMP=0x00000000000418b3
