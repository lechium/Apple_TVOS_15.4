...
+ (void)beginListening;	// IMP=0x00000000000c7206
+ (id)serviceQueue;	// IMP=0x00000000000c7185
- (void).cxx_destruct;	// IMP=0x00000000000c74c8
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000c73ad
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000000c7314
