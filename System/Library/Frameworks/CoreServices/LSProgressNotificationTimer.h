...
- (void).cxx_destruct;	// IMP=0x000000000013387b
...
- (id)description;	// IMP=0x0000000000133782
- (void)sendMessage:(id)arg1;	// IMP=0x00000000001332df
- (void)notifyObservers:(id)arg1 withApplications:(id)arg2;	// IMP=0x0000000000132eca
- (void)clear;	// IMP=0x0000000000132eb4
- (void)removeApplication:(id)arg1;	// IMP=0x0000000000132d04
- (void)addApplication:(id)arg1;	// IMP=0x0000000000132cb4
- (void)stopTimer;	// IMP=0x0000000000132bfe
- (void)dealloc;	// IMP=0x0000000000132bbc
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000132aec
