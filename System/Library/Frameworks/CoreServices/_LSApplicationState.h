...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000274b2
- (void).cxx_destruct;	// IMP=0x00000000000276ac
@property(readonly, copy, nonatomic) NSString *bundleIdentifier; // @synthesize bundleIdentifier=_bundleIdentifier;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000027697
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002755a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000274ba
- (id)description;	// IMP=0x0000000000027387
- (void)addStateFlag:(unsigned long long)arg1;	// IMP=0x000000000002737d
- (id)initWithBundleIdentifier:(id)arg1 stateFlags:(unsigned long long)arg2 ratingRank:(int)arg3 installType:(unsigned long long)arg4;	// IMP=0x00000000000272e9
