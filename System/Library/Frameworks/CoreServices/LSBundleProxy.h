...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000625d9
+ (_Bool)canInstantiateFromDatabase;	// IMP=0x00000000000616b8
+ (id)bundleProxyWithAuditToken:(CDStruct_4c969caf)arg1 error:(id *)arg2;	// IMP=0x0000000000061648
+ (id)bundleProxyForCurrentProcess;	// IMP=0x000000000006124d
+ (void)clearBundleProxyForCurrentProcess;	// IMP=0x0000000000061212
+ (id)bundleProxyForURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000060fc5
+ (id)bundleProxyForURL:(id)arg1;	// IMP=0x0000000000060fb1
+ (id)bundleProxyForIdentifier:(id)arg1;	// IMP=0x0000000000060daa
- (void).cxx_destruct;	// IMP=0x00000000000639df
...
- (unsigned long long)hash;	// IMP=0x0000000000063838
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000636ed
- (id)_valueForEqualityTesting;	// IMP=0x00000000000636db
- (id)localizedValuesForKeys:(id)arg1 fromTable:(id)arg2;	// IMP=0x00000000000634f3
- (id)objectForInfoDictionaryKey:(id)arg1 ofClass:(Class)arg2 valuesOfClass:(Class)arg3;	// IMP=0x00000000000633f2
- (id)objectForInfoDictionaryKey:(id)arg1 ofClass:(Class)arg2;	// IMP=0x00000000000633dd
- (id)objectsForInfoDictionaryKeys:(id)arg1;	// IMP=0x00000000000632bf
@property(readonly, nonatomic) NSDictionary *groupContainerURLs; // @dynamic groupContainerURLs;
- (id)entitlementValueForKey:(id)arg1 ofClass:(Class)arg2 valuesOfClass:(Class)arg3;	// IMP=0x00000000000631b1
- (id)entitlementValueForKey:(id)arg1 ofClass:(Class)arg2;	// IMP=0x000000000006319c
- (id)entitlementValuesForKeys:(id)arg1;	// IMP=0x000000000006307e
...
- (id)appStoreReceiptName;	// IMP=0x0000000000062f30
@property(readonly, nonatomic) NSURL *dataContainerURL; // @dynamic dataContainerURL;
- (_Bool)_hasAssociatedPersonas;	// IMP=0x0000000000062ee0
- (_Bool)_usesSystemPersona;	// IMP=0x0000000000062ed8
- (id)_managedPersonas;	// IMP=0x0000000000062ecb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000062955
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000625e1
- (id)_initWithBundleUnit:(unsigned int)arg1 context:(struct LSContext *)arg2 bundleType:(unsigned long long)arg3 bundleID:(id)arg4 localizedName:(id)arg5 bundleContainerURL:(id)arg6 dataContainerURL:(id)arg7 resourcesDirectoryURL:(id)arg8 iconsDictionary:(id)arg9 iconFileNames:(id)arg10 version:(id)arg11;	// IMP=0x00000000000616e1
- (id)localizedName;	// IMP=0x0000000000063b91
- (id)localizedNameWithPreferredLocalizations:(id)arg1 useShortNameOnly:(_Bool)arg2;	// IMP=0x0000000000063b7f
@property(readonly, nonatomic) NSString *localizedShortName;
- (id)_localizedNameWithPreferredLocalizations:(id)arg1 useShortNameOnly:(_Bool)arg2;	// IMP=0x0000000000063c70
