...
- (void).cxx_destruct;	// IMP=0x0000000000005d97
...
- (id)_additionalNumericValue;	// IMP=0x0000000000005aba
- (id)_additionalCategoricalValue;	// IMP=0x00000000000058ef
- (id)description;	// IMP=0x00000000000054cf
@property(copy, nonatomic) NSString *label;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005336
- (id)initWithX:(id)arg1 y:(id)arg2 additionalValues:(id)arg3 label:(id)arg4;	// IMP=0x0000000000005239
- (id)initWithX:(id)arg1 y:(id)arg2 additionalValues:(id)arg3;	// IMP=0x0000000000005224
- (id)initWithX:(id)arg1 y:(id)arg2;	// IMP=0x000000000000520c
