...
- (void).cxx_destruct;	// IMP=0x00000000000559b7
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000005590a
- (void)invalidateConnection;	// IMP=0x0000000000055866
- (void)refreshSettings;	// IMP=0x0000000000055744
- (void)newSettingsForBundleID:(id)arg1 defaultSettings:(id)arg2;	// IMP=0x0000000000055602
- (void)_remoteEndpointHasSetSettingsForBundleID:(id)arg1 defaultSettings:(id)arg2;	// IMP=0x00000000000553c8
- (void)setController:(id)arg1;	// IMP=0x00000000000552dc
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000550cd
- (void)stopObservingChangesForSettings:(id)arg1;	// IMP=0x00000000000550ab
- (void)observeChangesForSettings:(id)arg1;	// IMP=0x0000000000055083
- (id)init;	// IMP=0x0000000000055058
- (id)initWithIdentifier:(id)arg1 initialValueForBundleID:(id)arg2 defaultSettings:(id)arg3;	// IMP=0x0000000000054ef3
