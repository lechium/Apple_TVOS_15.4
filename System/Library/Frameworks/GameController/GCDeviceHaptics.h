...
- (void).cxx_destruct;	// IMP=0x000000000007fec9
...
- (id)createEngineWithLocality:(id)arg1;	// IMP=0x000000000007f949
@property(readonly, nonatomic) GCHapticCapabilityGraph *capabilityGraph;
- (id)initWithCapabilityGraph:(id)arg1;	// IMP=0x000000000007fefa
