...
- (void).cxx_destruct;	// IMP=0x00000000000563b9
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000562e3
- (void)invalidateConnection;	// IMP=0x0000000000056230
- (void)fetchSettingsWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000056180
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000055c6b
- (void)invalidateClient;	// IMP=0x0000000000055bbb
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValueForBundleID:(id)arg1 defaultSettings:(id)arg2;	// IMP=0x0000000000055ae5
- (id)initWithIdentifier:(id)arg1 initialValueForBundleID:(id)arg2 defaultSettings:(id)arg3;	// IMP=0x0000000000055a1f
