...
- (void).cxx_destruct;	// IMP=0x00000000000afb0c
@property(readonly, nonatomic) GCDeviceBattery *battery; // @synthesize battery=_battery;
@property(readonly) id <NSObject><NSCopying><NSSecureCoding> identifier; // @synthesize identifier=_identifier;
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000afa82
- (void)invalidateConnection;	// IMP=0x00000000000af9de
- (void)refreshBattery;	// IMP=0x00000000000af8b1
- (void)newBattery:(id)arg1;	// IMP=0x00000000000af793
- (void)_remoteEndpointHasSetBattery:(id)arg1;	// IMP=0x00000000000af650
- (void)setController:(id)arg1;	// IMP=0x00000000000af63f
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000af417
- (id)init;	// IMP=0x00000000000af3ec
- (id)initWithIdentifier:(id)arg1 initialBattery:(id)arg2;	// IMP=0x00000000000af2ae
