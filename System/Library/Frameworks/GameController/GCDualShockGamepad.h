...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003fba
- (void).cxx_destruct;	// IMP=0x0000000000004afc
...
- (void)initializeExtraControllerElements;	// IMP=0x000000000000415b
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000000410f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000040c3
- (id)initWithController:(id)arg1;	// IMP=0x0000000000003fc2
- (void)_activateExtendedSupport;	// IMP=0x0000000000004b3e
