...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000f50b
- (void).cxx_destruct;	// IMP=0x000000000000fa6b
@property(readonly) id <NSObject><NSCopying><NSSecureCoding> identifier; // @synthesize identifier=_identifier;
- (id)materializeWithContext:(id)arg1;	// IMP=0x000000000000f772
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000f704
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f5dc
- (id)init;	// IMP=0x000000000000f5b9
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000000f513
