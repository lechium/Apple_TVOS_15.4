...
- (float)floatValueForElement:(long long)arg1;	// IMP=0x000000000006887d
- (_Bool)hasValidValueForElement:(long long)arg1;	// IMP=0x00000000000687ea
@property(readonly, copy) NSString *debugDescription;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006813f
- (id)initWithGamepadEvent:(id)arg1;	// IMP=0x0000000000068096
- (id)initWithGameControllerInputs:(float [41])arg1 validMask:(unsigned long long)arg2;	// IMP=0x000000000006803c
