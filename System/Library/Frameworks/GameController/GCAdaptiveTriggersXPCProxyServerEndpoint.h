...
- (void).cxx_destruct;	// IMP=0x000000000000f48d
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000f38b
- (void)invalidateConnection;	// IMP=0x000000000000f2d8
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x000000000000f1da
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000f12e
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000ed08
- (void)invalidateClient;	// IMP=0x000000000000ec47
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x000000000000eb8b
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000000ea8b
