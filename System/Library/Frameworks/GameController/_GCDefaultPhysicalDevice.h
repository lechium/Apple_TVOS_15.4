...
+ (id)identifierForService:(id)arg1;	// IMP=0x0000000000052caf
- (void).cxx_destruct;	// IMP=0x0000000000052e58
...
- (id)propertyForKey:(id)arg1;	// IMP=0x0000000000052c30
@property(readonly) NSSet *components;
- (id)driverConnection;	// IMP=0x0000000000052c06
- (void)setDriverConnection:(id)arg1;	// IMP=0x0000000000051f92
- (void)setFilterConnection:(id)arg1;	// IMP=0x0000000000051c06
@property(readonly, copy) NSString *debugDescription;
- (id)redactedDescription;	// IMP=0x0000000000051ab8
@property(readonly, copy) NSString *description;
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000005188e
- (id)init;	// IMP=0x0000000000051863
- (id)initWithHIDDevice:(id)arg1 manager:(id)arg2;	// IMP=0x000000000005178e
@property(readonly) id <_GCGamepadEventSourceDescription> gamepadEventSource;
- (_Bool)supportsGamepad;	// IMP=0x0000000000052f54
...
- (_Bool)supportsMotion;	// IMP=0x000000000005325b
@property long long indicatedPlayerIndex;
- (_Bool)supportsPlayerIndicator;	// IMP=0x00000000000535d9
...
- (_Bool)supportsLight;	// IMP=0x00000000000536d7
...
- (void)setAdaptiveTriggersPayload:(id)arg1 forIndex:(int)arg2;	// IMP=0x0000000000053ba7
@property(copy, nonatomic) CDUnknownBlockType deviceAdaptiveTriggersServiceConnectedHandler;
- (_Bool)supportsAdaptiveTriggers;	// IMP=0x0000000000053a55
- (void)updateAdaptiveTriggerStatusWithLeftMode:(unsigned char)arg1 leftStatus:(unsigned char)arg2 leftArmPosition:(unsigned char)arg3 rightMode:(unsigned char)arg4 rightStatus:(unsigned char)arg5 rightArmPosition:(unsigned char)arg6;	// IMP=0x0000000000053def
...
- (_Bool)supportsBattery;	// IMP=0x0000000000054031
- (void)updateBattery:(unsigned char)arg1 isCharging:(_Bool)arg2;	// IMP=0x0000000000054339
...
- (_Bool)supportsHapticCapabilities;	// IMP=0x00000000000544e4
@property(copy, nonatomic) CDUnknownBlockType deviceGameIntentComponentGameIntentTriggeredHandler;
- (void)setEnableGlobalGameControllerFunctionality:(_Bool)arg1;	// IMP=0x000000000005463c
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x00000000000546b3
- (long long)getGlyphSetOverride;	// IMP=0x00000000000548b1
