...
- (void).cxx_destruct;	// IMP=0x000000000000ea18
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000e94e
- (void)invalidateConnection;	// IMP=0x000000000000e8aa
- (void)refreshStatuses;	// IMP=0x000000000000e77d
- (void)newStatuses:(id)arg1;	// IMP=0x000000000000e65f
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x000000000000e511
- (void)setController:(id)arg1;	// IMP=0x000000000000e46b
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000000e243
- (id)init;	// IMP=0x000000000000e218
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000000e02b
