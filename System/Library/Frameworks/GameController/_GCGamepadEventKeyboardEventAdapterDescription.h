...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007f4c9
- (void).cxx_destruct;	// IMP=0x000000000007f790
- (id)materializeWithContext:(id)arg1;	// IMP=0x000000000007f6e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007f676
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007f58d
- (id)init;	// IMP=0x000000000007f56a
- (id)initWithConfiguration:(id)arg1 source:(id)arg2;	// IMP=0x000000000007f4d1
