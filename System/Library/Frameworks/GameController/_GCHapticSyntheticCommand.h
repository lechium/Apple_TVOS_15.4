...
- (void).cxx_destruct;	// IMP=0x000000000000a54d
...
- (id)description;	// IMP=0x000000000000a4da
...
- (void)cancel;	// IMP=0x000000000000a487
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x000000000000a3f7
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x000000000000a306
