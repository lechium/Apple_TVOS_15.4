...
- (void).cxx_destruct;	// IMP=0x000000000005a813
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000005a446
- (void)dealloc;	// IMP=0x000000000005a3ed
- (id)init;	// IMP=0x000000000005a3c2
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000005a0ec
