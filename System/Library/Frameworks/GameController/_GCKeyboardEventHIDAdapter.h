...
- (void).cxx_destruct;	// IMP=0x000000000001af79
...
- (id)observeKeyboardEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000001abac
- (void)dealloc;	// IMP=0x000000000001ab53
- (id)init;	// IMP=0x000000000001ab28
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000001a80f
