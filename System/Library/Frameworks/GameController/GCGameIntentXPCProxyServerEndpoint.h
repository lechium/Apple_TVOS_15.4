...
#import <GameController/GCGameIntentXPCProxyRemoteServerEndpointInterface-Protocol.h>
...
- (void).cxx_destruct;	// IMP=0x000000000007e148
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000007e086
- (void)invalidateConnection;	// IMP=0x000000000007dfd3
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000007dd64
- (void)invalidateClient;	// IMP=0x000000000007dca3
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x000000000007dc52
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x000000000007dbc1
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000007db4c
