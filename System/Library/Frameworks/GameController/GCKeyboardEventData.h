...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005167e
...
- (id)debugDescription;	// IMP=0x000000000005163a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000515ad
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000051506
