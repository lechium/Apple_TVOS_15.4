...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a0576
- (void).cxx_destruct;	// IMP=0x00000000000a0a53
@property(readonly) id <NSObject><NSCopying><NSSecureCoding> identifier; // @synthesize identifier=_identifier;
- (id)materializeWithContext:(id)arg1;	// IMP=0x00000000000a075a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a06e8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a0621
- (id)init;	// IMP=0x00000000000a05fe
- (id)initWithIdentifier:(id)arg1 initialPlayerIndex:(long long)arg2;	// IMP=0x00000000000a057e
