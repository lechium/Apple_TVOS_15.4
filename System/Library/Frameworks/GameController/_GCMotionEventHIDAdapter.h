...
- (id)observeMotionEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000000d4c1
- (void)dealloc;	// IMP=0x000000000000d468
- (id)init;	// IMP=0x000000000000d43d
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000000ce42
