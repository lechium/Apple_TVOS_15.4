...
- (void).cxx_destruct;	// IMP=0x000000000009f55d
...
- (unsigned long long)hash;	// IMP=0x000000000009f342
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009f2fc
@property(retain, nonatomic) NSString *primaryAlias; // @synthesize primaryAlias=_primaryAlias;
- (_Bool)_setValue:(float)arg1 queue:(id)arg2;	// IMP=0x000000000009f23d
- (_Bool)_setValue:(float)arg1;	// IMP=0x000000000009f1fb
- (_Bool)_commitPendingValueOnQueue:(id)arg1;	// IMP=0x000000000009f161
- (void)_resetPendingValue;	// IMP=0x000000000009f150
- (void)_setPendingValue:(float)arg1;	// IMP=0x000000000009f11a
- (_Bool)_setPendingValueIfChanged:(float)arg1;	// IMP=0x000000000009f0b9
@property(readonly, nonatomic, getter=isAnalog) _Bool analog;
- (float)value;	// IMP=0x000000000009f081
- (int)getAndResetTimesPressed;	// IMP=0x000000000009f079
- (id)init;	// IMP=0x000000000009ef5a
