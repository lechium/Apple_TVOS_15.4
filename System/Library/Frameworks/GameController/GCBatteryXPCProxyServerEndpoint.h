...
- (void).cxx_destruct;	// IMP=0x00000000000b03c7
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b02fb
- (void)invalidateConnection;	// IMP=0x00000000000b0248
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b019c
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000afd81
- (void)invalidateClient;	// IMP=0x00000000000afcc0
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x00000000000afc04
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x00000000000afb5e
