...
- (void).cxx_destruct;	// IMP=0x000000000001d4f6
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001d42b
- (void)invalidateConnection;	// IMP=0x000000000001d378
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001d2cc
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x000000000001d222
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001ce32
- (void)invalidateClient;	// IMP=0x000000000001cd71
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x000000000001ccd7
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x000000000001cc57
