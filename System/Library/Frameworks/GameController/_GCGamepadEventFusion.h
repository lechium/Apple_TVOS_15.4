...
- (void).cxx_destruct;	// IMP=0x0000000000079090
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x0000000000078cd8
- (void)dealloc;	// IMP=0x0000000000078c8f
- (id)init;	// IMP=0x0000000000078c64
- (id)initWithConfiguration:(id)arg1 sources:(id)arg2;	// IMP=0x000000000007877c
