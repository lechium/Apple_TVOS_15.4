...
@interface _GCMotionEventImpl : NSObject <_GCMotionEvent>
{
    ...
    double _gyroPitch;	// 16 = 0x10
    double _gyroYaw;	// 24 = 0x18
    double _gyroRoll;	// 32 = 0x20
    double _accelerometerX;	// 40 = 0x28
    double _accelerometerY;	// 48 = 0x30
    double _accelerometerZ;	// 56 = 0x38
    double _attitudeW;	// 64 = 0x40
    double _attitudeX;	// 72 = 0x48
    double _attitudeY;	// 80 = 0x50
    double _attitudeZ;	// 88 = 0x58
}
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000664a3
- (id)initWithMotionEvent:(id)arg1;	// IMP=0x000000000006635b
