...
- (void).cxx_destruct;	// IMP=0x00000000000811a4
...
- (id)debugDescription;	// IMP=0x0000000000081081
- (id)redactedDescription;	// IMP=0x0000000000081029
- (id)description;	// IMP=0x0000000000080fd1
- (unsigned long long)hash;	// IMP=0x0000000000080fbc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000080f5f
- (_Bool)isEqualToProcess:(id)arg1;	// IMP=0x0000000000080ece
- (void)addConnection:(id)arg1;	// IMP=0x00000000000808df
- (void)populateBundleIdentifierForConnection:(id)arg1;	// IMP=0x0000000000080873
- (id)init;	// IMP=0x0000000000080848
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000008071e
