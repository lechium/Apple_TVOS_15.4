...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000168558
- (void).cxx_destruct;	// IMP=0x000000000016851a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016840d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001681ba
