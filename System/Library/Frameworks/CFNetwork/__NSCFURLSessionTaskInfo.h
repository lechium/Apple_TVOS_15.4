...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001be147
- (void).cxx_destruct;	// IMP=0x00000000001bd802
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bbe67
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bafaa
- (id)initWithAVAggregateAssetDownloadChildDownloadSessionIdentifier:(id)arg1 assetTitle:(id)arg2 assetArtworkData:(id)arg3 options:(id)arg4 taskIdentifier:(unsigned long long)arg5 uniqueIdentifier:(id)arg6 bundleID:(id)arg7 sessionID:(id)arg8;	// IMP=0x00000000001bae06
- (id)initWithAVAggregateDownloadTaskNoChildTaskKindWithURL:(id)arg1 destinationURL:(id)arg2 assetTitle:(id)arg3 assetArtworkData:(id)arg4 options:(id)arg5 taskIdentifier:(unsigned long long)arg6 uniqueIdentifier:(id)arg7 bundleID:(id)arg8 sessionID:(id)arg9 enableSPIDelegateCallbacks:(_Bool)arg10;	// IMP=0x00000000001bac2c
- (id)initWithAVAssetDownloadURL:(id)arg1 destinationURL:(id)arg2 assetTitle:(id)arg3 assetArtworkData:(id)arg4 options:(id)arg5 taskIdentifier:(unsigned long long)arg6 uniqueIdentifier:(id)arg7 bundleID:(id)arg8 sessionID:(id)arg9 downloadConfig:(id)arg10;	// IMP=0x00000000001baa38
- (id)initWithDownloadTask:(id)arg1 uniqueIdentifier:(id)arg2 bundleID:(id)arg3 sessionID:(id)arg4;	// IMP=0x00000000001ba94d
- (id)initWithUploadTask:(id)arg1 uniqueIdentifier:(id)arg2 bundleID:(id)arg3 sessionID:(id)arg4;	// IMP=0x00000000001ba85f
- (id)initWithDataTask:(id)arg1 uniqueIdentifier:(id)arg2 bundleID:(id)arg3 sessionID:(id)arg4;	// IMP=0x00000000001ba771
- (void)_logTaskUUIDMapping;	// IMP=0x00000000001ba605
- (id)_loggableDescription;	// IMP=0x00000000001ba570
