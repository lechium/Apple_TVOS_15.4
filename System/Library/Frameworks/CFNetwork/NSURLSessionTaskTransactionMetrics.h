...
+ (id)new;	// IMP=0x0000000000252600
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000025350d
- (void).cxx_destruct;	// IMP=0x000000000025208c
...
- (id)description;	// IMP=0x0000000000251821
...
- (id)init;	// IMP=0x00000000002509a9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002533bc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002532df
