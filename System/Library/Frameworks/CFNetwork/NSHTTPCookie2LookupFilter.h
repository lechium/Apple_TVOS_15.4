...
- (void).cxx_destruct;	// IMP=0x0000000000131f9b
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x00000000001315e5
- (long long)_flags;	// IMP=0x00000000001310ca
- (id)initWithCookie:(id)arg1;	// IMP=0x0000000000130f38
