...
@interface NSURLSessionConfiguration : NSObject <NSMutableCopying, NSSecureCoding, NSCopying>
{
    ...
    NSURL *_directoryForDownloadedFiles;	// 216 = 0xd8
    NSString *_sourceApplicationBundleIdentifier;	// 224 = 0xe0
    NSString *_sourceApplicationSecondaryIdentifier;	// 232 = 0xe8
    NSData *_sourceApplicationAuditTokenData;	// 240 = 0xf0
    NSString *_attributedBundleIdentifier;	// 248 = 0xf8
    unsigned long long _TCPAdaptiveReadTimeout;	// 256 = 0x100
    unsigned long long _TCPAdaptiveWriteTimeout;	// 264 = 0x108
    long long _timingDataOptions;	// 272 = 0x110
    id <NSURLSessionAppleIDContext> _appleIDContext;	// 280 = 0x118
    NSData *_atsContext;	// 288 = 0x120
    NSString *_connectionPoolName;	// 296 = 0x128
    NSString *_CTDataConnectionServiceType;	// 304 = 0x130
    NSString *_tlsTrustPinningPolicyName;	// 312 = 0x138
    unsigned long long _customReadBufferSize;	// 320 = 0x140
    double _customReadBufferTimeout;	// 328 = 0x148
    long long _duetPreClearedMode;	// 336 = 0x150
    NSObject<OS_xpc_object> *_xpcActivity;	// 344 = 0x158
    long long _IDSMessageTimeout;	// 352 = 0x160
    NSNumber *_maximumWatchCellularTransferSize;	// 360 = 0x168
    unsigned long long _multipathAlternatePort;	// 368 = 0x170
    NSString *_disposition;	// 376 = 0x178
    NSURLCredentialStorage *_phskip_credStorage;	// 384 = 0x180
    NSURLCache *_phskip_urlCache;	// 392 = 0x188
    NSHTTPCookieStorage *_phskip_cookieStorage;	// 400 = 0x190
    _NSHSTSStorage *_phskip_hstsStorage;	// 408 = 0x198
    NSString *_tcpConnectionPoolName;	// 416 = 0x1a0
    NSDictionary *_socketStreamProperties;	// 424 = 0x1a8
    NSSet *_authenticatorStatusCodes;	// 432 = 0x1b0
    NSArray *_contentDispHeadEncFallback;	// 440 = 0x1b8
    NSString *_companionAppBundleIdentifier;	// 448 = 0x1c0
    NSString *_watchAppBundleIdentifier;	// 456 = 0x1c8
    NSString *_watchExtensionBundleIdentifier;	// 464 = 0x1d0
    unsigned long long _forcedNetworkServiceType;	// 472 = 0x1d8
    NSDictionary *_overriddenDelegateOptions;	// 480 = 0x1e0
    NSSet *_suppressedAutoAddedHTTPHeaders;	// 488 = 0x1e8
    long long _expiredDNSBehavior;	// 496 = 0x1f0
    _NSHTTPAlternativeServicesStorage *_phskip_alternativeServicesStorage;	// 504 = 0x1f8
    NSString *_downloadFileProtectionType;	// 512 = 0x200
    long long _multipathServiceType;	// 520 = 0x208
    long long __companionProxyPreference;	// 528 = 0x210
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000025c067
+ (id)backgroundSessionConfiguration:(id)arg1;	// IMP=0x000000000025c01c
+ (id)AVBackgroundSessionConfigurationWithIdentifier:(id)arg1;	// IMP=0x000000000025c00a
+ (id)_AVBackgroundSessionConfigurationWithIdentifier:(id)arg1;	// IMP=0x000000000025bfd5
+ (id)backgroundSessionConfigurationWithIdentifier:(id)arg1;	// IMP=0x000000000025bf12
+ (id)ephemeralSessionConfiguration;	// IMP=0x000000000025bdec
+ (id)sessionConfigurationForSharedSession;	// IMP=0x000000000025bdac
+ (id)defaultSessionConfiguration;	// IMP=0x000000000025bd6c
+ (id)_defaultProtocolClasses;	// IMP=0x000000000025bcd7
+ (id)new;	// IMP=0x000000000025bccd
+ (void)initialize;	// IMP=0x000000000025bc18
+ (id)immutableEffectiveConfigurationFromConfig:(id)arg1;	// IMP=0x00000000001f2491
- (id).cxx_construct;	// IMP=0x000000000025b866
...
- (struct HTTPConnectionCacheLimits)getConnectionCacheLimits;	// IMP=0x000000000025acee
- (void *)_copyAttribute:(struct __CFString *)arg1;	// IMP=0x000000000025aa9c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000259d0e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002591ed
- (void)dealloc;	// IMP=0x0000000000259071
- (unsigned long long)hash;	// IMP=0x00000000002585a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000256e14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000256e02
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000256072
...
- (struct _CFHSTSPolicy *)copyHSTSPolicy;	// IMP=0x0000000000255a19
- (id)copyImmutableVariant:(CDUnknownBlockType)arg1;	// IMP=0x00000000002559e9
- (id)init;	// IMP=0x00000000002559ba
- (id)_sessionConfiguration;	// IMP=0x00000000001f2488
- (id)_initWithConfiguration:(id)arg1;	// IMP=0x00000000001f246a
