...
- (void).cxx_destruct;	// IMP=0x000000000007da82
...
- (id)description;	// IMP=0x000000000007d9a5
- (unsigned long long)hash;	// IMP=0x000000000007d8c7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007d6cb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007d534
- (id)init;	// IMP=0x000000000007d448
