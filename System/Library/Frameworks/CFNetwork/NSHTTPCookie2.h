...
- (void).cxx_destruct;	// IMP=0x0000000000085130
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084e11
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084e06
- (id)description;	// IMP=0x0000000000084bfa
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x00000000000849b2
