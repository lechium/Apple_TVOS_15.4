...
- (id)uploadTaskWithStreamedRequest:(id)arg1;	// IMP=0x00000000001c5b5a
- (id)dataTaskWithRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001c5adf
- (id)dataTaskWithRequest:(id)arg1;	// IMP=0x00000000001c5a77
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000001c5a46
- (void)dealloc;	// IMP=0x00000000001c59fc
