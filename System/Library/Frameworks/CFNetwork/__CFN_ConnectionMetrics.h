...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001a7601
- (id).cxx_construct;	// IMP=0x00000000001a743b
- (void).cxx_destruct;	// IMP=0x00000000001a7385
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a7012
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a6b74
