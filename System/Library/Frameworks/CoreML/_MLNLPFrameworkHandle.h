...
+ (id)sharedHandle;	// IMP=0x0000000000128b0d
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001288d2
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000128783
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000128637
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001284eb
- (const void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001284a3
- (const void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000012845e
- (const void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000128419
- (const void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001283d4
- (id)init;	// IMP=0x0000000000128124
