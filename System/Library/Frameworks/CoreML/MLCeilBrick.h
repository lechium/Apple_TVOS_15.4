...
- (void).cxx_destruct;	// IMP=0x00000000000bfae7
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000bf8e8
- (_Bool)hasGPUSupport;	// IMP=0x00000000000bf8e0
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000bf7a7
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000bf791
