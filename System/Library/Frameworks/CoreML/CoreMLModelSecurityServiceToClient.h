...
- (void).cxx_destruct;	// IMP=0x00000000000b3ca6
...
- (void)clientFeatureNames:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b3b8f
- (void)clientFeatureValueForName:(id)arg1 uniqueKeyForProvider:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b3ab0
- (id)init;	// IMP=0x00000000000b3a16
