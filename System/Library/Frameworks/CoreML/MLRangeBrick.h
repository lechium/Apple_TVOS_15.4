...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000be8b9
- (id)computeDynamicOutputShape:(id)arg1;	// IMP=0x00000000000be5d6
- (_Bool)hasDynamicOutputShape:(unsigned long long)arg1;	// IMP=0x00000000000be5c9
- (_Bool)hasGPUSupport;	// IMP=0x00000000000be5c1
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000be32c
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000be1e3
