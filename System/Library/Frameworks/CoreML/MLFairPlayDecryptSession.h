...
+ (id)decryptSessionForModelAtPath:(id)arg1 keyBlob:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000de8cc
- (void).cxx_destruct;	// IMP=0x00000000000de893
...
- (void)dealloc;	// IMP=0x00000000000de798
