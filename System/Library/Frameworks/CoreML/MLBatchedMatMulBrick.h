...
- (void).cxx_destruct;	// IMP=0x00000000000a4127
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000a3522
- (_Bool)hasGPUSupport;	// IMP=0x00000000000a351a
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000a3281
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000a2eab
