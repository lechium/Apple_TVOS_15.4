...
- (void).cxx_destruct;	// IMP=0x000000000014aa7d
...
- (id)debugDescription;	// IMP=0x000000000014a9c7
- (id)initWithName:(id)arg1 shortDescription:(id)arg2 versionString:(id)arg3 author:(id)arg4 license:(id)arg5 creatorDefined:(id)arg6;	// IMP=0x000000000014a882
- (id)initWithName:(id)arg1;	// IMP=0x000000000014a858
