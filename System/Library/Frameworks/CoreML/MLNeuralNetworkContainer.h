...
+ (id)containerFromCompiledArchive:(void *)arg1 modelVersionInfo:(id)arg2 compilerVersionInfo:(id)arg3 configuration:(id)arg4 error:(id *)arg5;	// IMP=0x00000000000440f0
+ (id)containerFromCompiledArchiveCommon:(void *)arg1 filename:(id)arg2 modelVersionInfo:(id)arg3 compilerVersionInfo:(id)arg4 configuration:(id)arg5 error:(id *)arg6;	// IMP=0x00000000000439e7
+ (_Bool)readIsClassifier:(void *)arg1;	// IMP=0x00000000000439c2
+ (id)containerFromFilePath:(id)arg1 inputLayerNames:(id)arg2 outputLayerNames:(id)arg3 parameters:(id)arg4;	// IMP=0x00000000000438e6
- (id).cxx_construct;	// IMP=0x0000000000043238
- (void).cxx_destruct;	// IMP=0x00000000000430df
...
- (id)initWithFeatureDescriptions:(id)arg1 transformDesc:(id)arg2 outputLayerNames:(id)arg3 classScoreVectorName:(id)arg4 classLabels:(id)arg5 isEncrypted:(_Bool)arg6 modelVersionInfo:(id)arg7 compilerVersionInfo:(id)arg8;	// IMP=0x00000000000428e6
- (id)initWithFeatureDescriptions:(id)arg1 transformDesc:(id)arg2 outputLayerNames:(id)arg3 classScoreVectorName:(id)arg4 classLabels:(id)arg5 isEncrypted:(_Bool)arg6 modelVersionInfo:(id)arg7;	// IMP=0x00000000000428c0
- (id)initWithFilePath:(id)arg1 inputLayerNames:(id)arg2 outputLayerNames:(id)arg3 parameters:(id)arg4;	// IMP=0x0000000000042798
