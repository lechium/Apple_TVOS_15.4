...
- (void).cxx_destruct;	// IMP=0x0000000000117529
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000116d39
- (id)featureValueFromDetectionPrint:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000116b02
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000115c60
