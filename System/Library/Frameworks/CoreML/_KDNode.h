...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000011cf5a
- (id).cxx_construct;	// IMP=0x000000000011ce1d
- (void).cxx_destruct;	// IMP=0x000000000011cde3
...
- (void)print;	// IMP=0x000000000011cc7f
- (void)assignSplitsForData:(const float *)arg1 indices:(unsigned long long *)arg2 numDimensions:(unsigned long long)arg3;	// IMP=0x000000000011ca0d
- (void)partitionDataPoints:(const float *)arg1 indices:(unsigned long long *)arg2 numDimensions:(unsigned long long)arg3;	// IMP=0x000000000011c612
- (void)findMin:(float *)arg1 andMax:(float *)arg2 alongDimension:(unsigned long long)arg3 data:(const float *)arg4 indices:(const unsigned long long *)arg5 numDimensions:(unsigned long long)arg6;	// IMP=0x000000000011c54c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000011c28a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000011c012
