...
- (void).cxx_destruct;	// IMP=0x0000000000130d08
...
- (id)featuresAtIndex:(long long)arg1;	// IMP=0x0000000000130c61
@property(readonly, nonatomic) long long count;
- (id)initWithBatch:(id)arg1 indices:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000130bb2
