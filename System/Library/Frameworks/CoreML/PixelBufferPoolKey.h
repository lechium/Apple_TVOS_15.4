...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044578
- (unsigned long long)hash;	// IMP=0x00000000000444e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000443df
- (id)initWithSize:(struct CGSize)arg1 pixelFormatType:(unsigned int)arg2;	// IMP=0x0000000000044386
