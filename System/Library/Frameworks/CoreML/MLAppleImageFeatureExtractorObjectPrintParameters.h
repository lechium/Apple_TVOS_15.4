...
- (void).cxx_destruct;	// IMP=0x00000000000ea161
...
- (id)initObjectPrintParameters:(unsigned long long)arg1 expectedShapes:(id)arg2 expectedKeys:(id)arg3 error:(id *)arg4;	// IMP=0x00000000000ea01e
