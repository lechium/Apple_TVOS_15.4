...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000117b2e
- (_Bool)hasGPUSupport;	// IMP=0x0000000000117b26
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000117861
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001175d7
