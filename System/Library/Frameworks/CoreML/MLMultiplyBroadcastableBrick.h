...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000006acb2
- (_Bool)hasGPUSupport;	// IMP=0x000000000006acaa
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000006aa69
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000006a748
