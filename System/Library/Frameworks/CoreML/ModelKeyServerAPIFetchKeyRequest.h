...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000bf62d
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bf45e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bf37a
- (void)copyTo:(id)arg1;	// IMP=0x00000000000bf2d7
- (void)writeTo:(id)arg1;	// IMP=0x00000000000bf238
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000befee
- (id)dictionaryRepresentation;	// IMP=0x00000000000beee0
