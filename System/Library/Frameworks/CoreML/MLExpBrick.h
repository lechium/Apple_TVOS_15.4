...
- (void).cxx_destruct;	// IMP=0x00000000000bed6f
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000beb44
- (_Bool)hasGPUSupport;	// IMP=0x00000000000beb3c
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000be9b1
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000be99b
