...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000001e07f
- (_Bool)hasGPUSupport;	// IMP=0x000000000001e077
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000001de36
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000001db15
