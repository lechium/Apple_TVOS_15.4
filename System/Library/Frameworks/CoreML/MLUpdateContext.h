...
+ (id)updateContextForEvent:(long long)arg1 metrics:(id)arg2 parameters:(id)arg3 error:(id)arg4;	// IMP=0x000000000007f428
+ (id)updateContextWithTask:(id)arg1 model:(id)arg2 event:(long long)arg3 metrics:(id)arg4 parameters:(id)arg5;	// IMP=0x000000000007f334
- (void).cxx_destruct;	// IMP=0x000000000007f2eb
...
- (id)description;	// IMP=0x000000000007f124
