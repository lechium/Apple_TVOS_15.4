...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000012bbfc
+ (id)defaultOptions;	// IMP=0x000000000012bbe3
- (void).cxx_destruct;	// IMP=0x000000000012bbbb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012ba1e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000012b8e6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012b7e6
@property(readonly, nonatomic) _Bool predictionUsesCPU;
- (id)init;	// IMP=0x000000000012b7c9
- (id)initWithUsesCPUOnly:(_Bool)arg1;	// IMP=0x000000000012b747
