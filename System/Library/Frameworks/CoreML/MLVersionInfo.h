...
+ (id)versionInfoWithStringProgressive:(id)arg1;	// IMP=0x000000000007cec9
+ (id)versionInfoWithString:(id)arg1;	// IMP=0x000000000007cd3b
+ (id)versionInfoWithMajor:(long long)arg1 minor:(long long)arg2 patch:(long long)arg3 variant:(id)arg4;	// IMP=0x000000000007cccb
- (void).cxx_destruct;	// IMP=0x000000000007ccbb
...
- (_Bool)olderThan:(id)arg1;	// IMP=0x000000000007cbb6
@property(readonly, nonatomic) NSString *versionString;
@property(readonly, nonatomic) NSString *versionNumberString;
- (id)initWithMajor:(long long)arg1 minor:(long long)arg2 patch:(long long)arg3 variant:(id)arg4;	// IMP=0x000000000007ca6f
