...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x000000000000377b
- (void).cxx_destruct;	// IMP=0x0000000000005726
...
- (id)description;	// IMP=0x0000000000005372
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x0000000000003de2
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x00000000000039fd
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x000000000000385d
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x00000000000037cd
