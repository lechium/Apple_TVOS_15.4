...
- (id)_musicKit_innerModelObject;	// IMP=0x00000000000019e8
...
- (id)_musicKit_self_identifierSet;	// IMP=0x000000000000220b
...
- (id)_musicKit_self_artworkColorAnalysis;	// IMP=0x000000000000a815
- (void)musicKit_requestImageDataWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b03e
...
- (id)_musicKit_self_artworkCatalog;	// IMP=0x000000000000aa4c
