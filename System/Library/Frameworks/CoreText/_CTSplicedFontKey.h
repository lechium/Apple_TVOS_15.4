...
- (id)description;	// IMP=0x0000000000080b3e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000808d4
- (unsigned long long)hash;	// IMP=0x00000000000808ca
- (void)dealloc;	// IMP=0x0000000000080879
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000806aa
