...
+ (id)customAttributes;	// IMP=0x00000000001574b4
@property(retain, nonatomic) NSNumber *inputRadius; // @synthesize inputRadius;
@property(retain, nonatomic) NSNumber *inputSharpness; // @synthesize inputSharpness;
@property(retain, nonatomic) CIImage *inputImage; // @synthesize inputImage;
- (id)outputImage;	// IMP=0x0000000000157794
- (id)_kernel;	// IMP=0x0000000000157774
- (_Bool)_isIdentity;	// IMP=0x0000000000157708
