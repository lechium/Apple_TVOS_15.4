...
+ (id)customAttributes;	// IMP=0x000000000010f2f7
...
- (id)outputImage;	// IMP=0x000000000010f804
- (double)effectiveScale;	// IMP=0x000000000010f770
- (id)sensorSize;	// IMP=0x000000000010f64c
