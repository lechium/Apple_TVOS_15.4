...
+ (id)customAttributes;	// IMP=0x00000000000fd1cf
...
- (id)outputImage;	// IMP=0x00000000000fb804
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x00000000000fb7e4
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x00000000000fb7c4
