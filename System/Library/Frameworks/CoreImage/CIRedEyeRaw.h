...
- (id)outputImage;	// IMP=0x0000000000080f1e
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x0000000000080e1c
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x0000000000080cb0
