...
- (struct CGRect)faceRect;	// IMP=0x00000000001c09df
- (id)description;	// IMP=0x00000000001c09a1
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001c0605
