...
+ (id)customAttributes;	// IMP=0x000000000016fb1f
...
- (id)outputImage;	// IMP=0x000000000016fe88
- (id)_geomKernel;	// IMP=0x000000000016fe68
- (id)_colorKernel;	// IMP=0x000000000016fe48
