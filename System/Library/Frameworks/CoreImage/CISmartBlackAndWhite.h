...
+ (id)customAttributes;	// IMP=0x00000000001584b4
...
- (id)outputImage;	// IMP=0x0000000000158a26
- (id)_kernel;	// IMP=0x0000000000158a06
- (id)hueArrayImage:(float *)arg1;	// IMP=0x0000000000158301
- (float *)createHueArray;	// IMP=0x00000000001581b5
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x0000000000157e9e
