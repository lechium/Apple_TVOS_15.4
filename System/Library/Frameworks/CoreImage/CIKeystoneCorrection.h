...
+ (id)customAttributes;	// IMP=0x0000000000272c91
- (id).cxx_construct;	// IMP=0x000000000027353d
...
- (id)outputImage;	// IMP=0x00000000002733cf
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x00000000002730a2
- (void)computeCameraIntrinsics;	// IMP=0x0000000000272f17
