...
- (id)outputImage;	// IMP=0x000000000010cc10
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x000000000010c252
- (id)noiseColorKernel;	// IMP=0x000000000010c1d4
- (id)_noiseGeneratorKernel;	// IMP=0x000000000010c167
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x000000000010c063
