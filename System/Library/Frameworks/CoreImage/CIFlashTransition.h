...
+ (id)customAttributes;	// IMP=0x00000000000a1df0
...
- (id)outputImage;	// IMP=0x00000000000a23fa
- (id)_geomKernel;	// IMP=0x00000000000a23da
- (id)_colorKernel;	// IMP=0x00000000000a23ba
