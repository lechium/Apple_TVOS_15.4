...
+ (id)customAttributes;	// IMP=0x0000000000140029
...
- (id)outputImage;	// IMP=0x0000000000140a5d
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x00000000001407f0
- (id)_kernelKmeans;	// IMP=0x00000000001407d0
- (id)_combine:(id)arg1;	// IMP=0x0000000000140306
