...
- (id).cxx_construct;	// IMP=0x000000000017fe54
- (void).cxx_destruct;	// IMP=0x000000000017fdd6
...
- (void)computeTransform;	// IMP=0x000000000017ed1a
- (void)computeGuides;	// IMP=0x000000000017e1b4
- (void)clusterLineSegments;	// IMP=0x000000000017cba0
- (void)extractLineSegments;	// IMP=0x000000000017c59a
- (void)rangeLimitGradientMap;	// IMP=0x000000000017c2f5
- (void)thresholdGradientMap;	// IMP=0x000000000017c116
- (void)normalizeGradientMap;	// IMP=0x000000000017bdbe
- (void)createGradientMap;	// IMP=0x000000000017ba84
- (void)standardizeImage;	// IMP=0x000000000017b824
- (double)confidence;	// IMP=0x000000000017b79f
- (_Bool)compute;	// IMP=0x000000000017af30
- (void)dealloc;	// IMP=0x000000000017aeef
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x000000000017acf8
