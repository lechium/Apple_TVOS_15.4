...
+ (id)customAttributes;	// IMP=0x00000000000e393e
...
- (id)outputImage;	// IMP=0x00000000000e3cb1
- (id)cpuParams;	// IMP=0x00000000000e3b06
- (id)kernel;	// IMP=0x00000000000e3aa9
- (id)mtlKernel;	// IMP=0x00000000000e3a3c
