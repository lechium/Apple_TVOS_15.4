...
+ (id)customAttributes;	// IMP=0x00000000000f65ee
...
- (id)outputImage;	// IMP=0x00000000000f68c0
- (_Bool)_doMinimum;	// IMP=0x00000000000f68b8
- (_Bool)_isIdentity;	// IMP=0x00000000000f686b
