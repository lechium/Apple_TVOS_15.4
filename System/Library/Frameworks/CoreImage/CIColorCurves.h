...
+ (id)customAttributes;	// IMP=0x0000000000041024
...
- (id)outputImage;	// IMP=0x00000000000415c9
- (_Bool)_checkInputs;	// IMP=0x00000000000414a5
- (id)curvesImage;	// IMP=0x0000000000041281
- (id)_kernel;	// IMP=0x000000000004123e
- (void)dealloc;	// IMP=0x0000000000040f85
