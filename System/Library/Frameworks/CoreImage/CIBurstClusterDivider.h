...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x000000000001d4b4
- (long long)compareIndices:(id)arg1;	// IMP=0x000000000001d445
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000001d3cc
