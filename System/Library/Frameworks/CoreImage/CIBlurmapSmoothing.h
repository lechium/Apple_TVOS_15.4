...
+ (id)customAttributes;	// IMP=0x00000000001060f5
...
- (id)outputImage;	// IMP=0x0000000000106784
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x0000000000106355
- (id)_kernelV;	// IMP=0x00000000001062f8
- (id)_kernelH;	// IMP=0x000000000010629b
