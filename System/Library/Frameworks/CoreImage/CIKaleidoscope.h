...
+ (id)customAttributes;	// IMP=0x00000000000d1610
...
- (id)outputImage;	// IMP=0x00000000000d0e0b
- (struct CGRect)_outputExtent;	// IMP=0x00000000000d0774
- (id)_kernel;	// IMP=0x00000000000d0754
