...
+ (id)customAttributes;	// IMP=0x000000000000a678
...
- (id)outputImage;	// IMP=0x000000000000aa83
- (id)_kernel;	// IMP=0x000000000000aa63
- (id)_kernelMix;	// IMP=0x000000000000aa43
- (id)_kernelWarpT;	// IMP=0x000000000000aa23
- (id)_kernelWarpS;	// IMP=0x000000000000aa03
