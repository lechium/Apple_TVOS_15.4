...
- (_Bool)isBurstAction;	// IMP=0x000000000001d19c
- (float)predictResult;	// IMP=0x000000000001d0ca
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x000000000001d052
- (void)scaleVector;	// IMP=0x000000000001cefe
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000001ce95
- (id)init;	// IMP=0x000000000001ce4a
