...
+ (id)customAttributes;	// IMP=0x00000000000fb502
...
- (id)outputImage;	// IMP=0x00000000000f9852
- (id)_CIPageCurlTransNoEmap;	// IMP=0x00000000000f9832
- (id)_CIPageCurlTransition;	// IMP=0x00000000000f9812
