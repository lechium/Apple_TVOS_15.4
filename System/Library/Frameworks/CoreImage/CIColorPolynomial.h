...
+ (id)customAttributes;	// IMP=0x0000000000044e99
...
- (id)outputImage;	// IMP=0x00000000000455fb
- (_Bool)_isIdentityAlpha;	// IMP=0x0000000000045536
- (_Bool)_isIdentity;	// IMP=0x000000000004524c
- (id)_kernelRGB;	// IMP=0x0000000000044e56
- (id)_kernel;	// IMP=0x0000000000044e36
