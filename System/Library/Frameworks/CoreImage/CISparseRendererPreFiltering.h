...
- (id)outputImage;	// IMP=0x000000000010d5a5
- (void)dumpImage:(id)arg1 extent:(struct CGRect)arg2 prefixFilename:(id)arg3;	// IMP=0x000000000010d33d
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2 width:(double)arg3;	// IMP=0x000000000010cecf
- (id)_kernel:(_Bool)arg1;	// IMP=0x000000000010ce06
