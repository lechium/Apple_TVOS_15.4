...
+ (id)customAttributes;	// IMP=0x0000000000102b04
...
- (id)outputImage;	// IMP=0x0000000000102e07
- (id)_paddedTileKernel;	// IMP=0x0000000000102ae4
- (id)_grainBlendAndMixKernel;	// IMP=0x0000000000102ac4
- (id)_interpolateGrainKernel;	// IMP=0x0000000000102aa4
