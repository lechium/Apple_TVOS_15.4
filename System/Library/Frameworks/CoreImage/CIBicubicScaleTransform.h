...
+ (id)customAttributes;	// IMP=0x000000000016040a
...
- (id)outputImage;	// IMP=0x0000000000160a3b
- (_Bool)_isIdentity;	// IMP=0x00000000001608d3
- (struct vec2)_scale;	// IMP=0x0000000000160858
