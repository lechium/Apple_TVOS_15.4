...
- (float *)colorHistogram;	// IMP=0x000000000003711c
- (long long)compareImageOrder:(id)arg1;	// IMP=0x00000000000370bb
- (long long)compareImageStats:(id)arg1;	// IMP=0x00000000000370b3
- (float)computeScore:(float)arg1;	// IMP=0x0000000000036f7f
- (unsigned short *)aeMatrix;	// IMP=0x0000000000036f72
- (void)computeAEMatrix:(id)arg1;	// IMP=0x0000000000036da5
- (int)setAEMatrix:(id)arg1;	// IMP=0x0000000000036d2f
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x0000000000036cf5
- (float)computeImageDistance:(id)arg1;	// IMP=0x0000000000036ca6
- (float)computeSmilePercentage;	// IMP=0x0000000000036b90
- (float)computeRuleOfThreeDistance;	// IMP=0x00000000000368e0
- (float)computeFacialFocusScoreSum;	// IMP=0x0000000000036362
- (void)collapseSharpnessGrid;	// IMP=0x000000000003607e
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x0000000000035e52
- (void)writeGridROI:(id)arg1;	// IMP=0x0000000000035d81
- (int)canRegister;	// IMP=0x0000000000035d60
- (void)computeImageProjections:(id)arg1;	// IMP=0x0000000000035cb7
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x0000000000034ffc
- (void)flagAsGarbage;	// IMP=0x0000000000034fda
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x0000000000034ec0
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x0000000000034c21
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x000000000003492f
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x00000000000347b5
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x00000000000347a6
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x000000000003462e
- (void)dealloc;	// IMP=0x00000000000345a1
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000000344db
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x0000000000034430
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x000000000003437a
