...
+ (id)defaultVersionString;	// IMP=0x0000000000028149
...
- (_Bool)isAction;	// IMP=0x000000000003345c
- (_Bool)isPortrait;	// IMP=0x0000000000033427
- (_Bool)isFaceDetectionForced;	// IMP=0x0000000000033408
- (id)imageClusterForIdentifier:(id)arg1;	// IMP=0x0000000000033012
- (id)bestImageIdentifiers;	// IMP=0x000000000002f0b1
- (void)selectCoverPhotoFromMultiple:(id)arg1 burstSize:(int)arg2;	// IMP=0x000000000002eb76
- (id)findBestImage:(id)arg1 useActionScores:(_Bool)arg2;	// IMP=0x000000000002e31f
- (void)computeAllImageScores;	// IMP=0x000000000002cb59
- (float)computeBeginningVsEndAEMatrixDiffVsAverageAdjacent;	// IMP=0x000000000002c7ff
- (float)computeCameraTravelDistance;	// IMP=0x000000000002c2cb
- (void)performEmotionalRejectionOnCluster:(id)arg1;	// IMP=0x000000000002bc38
- (int)computeEmotion:(id)arg1;	// IMP=0x000000000002bad8
- (void)addImageFromIOSurface:(struct __IOSurface *)arg1 properties:(id)arg2 identifier:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000002b952
- (void)addYUVImage:(id)arg1 properties:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000002b46c
- (void)processClusters:(_Bool)arg1;	// IMP=0x0000000000028f2e
- (float)computeActionSelectionThreshold;	// IMP=0x0000000000028b90
- (void)dealloc;	// IMP=0x000000000002892f
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000028259
- (id)burstDocumentDirectory;	// IMP=0x00000000000281c5
