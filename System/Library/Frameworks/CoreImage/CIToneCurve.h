...
+ (void)splineCurveTable:(double *)arg1 tableSize:(int)arg2 gamma:(double)arg3 from:(const struct CGPoint *)arg4;	// IMP=0x000000000016ec0b
+ (id)curveImageFromPoints:(const struct CGPoint *)arg1;	// IMP=0x000000000016ebed
+ (id)curveImageFromPoints:(const struct CGPoint *)arg1 linear:(_Bool)arg2;	// IMP=0x000000000016ea59
+ (id)customAttributes;	// IMP=0x000000000016e167
...
- (id)_initFromProperties:(id)arg1;	// IMP=0x000000000016f85e
- (id)_outputProperties;	// IMP=0x000000000016f244
- (id)outputImage;	// IMP=0x000000000016e7c2
- (_Bool)_isIdentity;	// IMP=0x000000000016e635
- (id)_kernel16;	// IMP=0x000000000016e615
- (void)dealloc;	// IMP=0x000000000016df1b
