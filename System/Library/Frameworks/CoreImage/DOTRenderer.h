...
- (void)flushRender;	// IMP=0x00000000000a83ef
- (void)drawEdge:(id)arg1 withPath:(id)arg2;	// IMP=0x00000000000a839a
- (void)drawNode:(id)arg1;	// IMP=0x00000000000a8204
- (_Bool)setCanvasWidth:(unsigned int)arg1 height:(unsigned int)arg2;	// IMP=0x00000000000a8131
- (void)setFileTitle:(id)arg1;	// IMP=0x00000000000a810d
- (void)setFileURL:(id)arg1;	// IMP=0x00000000000a80df
- (void)dealloc;	// IMP=0x00000000000a80b0
- (id)init;	// IMP=0x00000000000a8071
