...
- (_Bool)compute;	// IMP=0x0000000000120f72
- (void)dealloc;	// IMP=0x0000000000120f37
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x0000000000120de5
