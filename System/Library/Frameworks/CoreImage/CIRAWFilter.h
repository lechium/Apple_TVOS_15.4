...
+ (id)filterWithCVPixelBuffer:(struct __CVBuffer *)arg1 properties:(id)arg2;	// IMP=0x0000000000112f78
+ (id)filterWithImageData:(id)arg1 identifierHint:(id)arg2;	// IMP=0x0000000000112f44
+ (id)filterWithImageURL:(id)arg1;	// IMP=0x0000000000112f15
+ (id)supportedCameraModels;	// IMP=0x0000000000112eef
...
- (void)dealloc;	// IMP=0x0000000000112fac
- (id)initWithCVPixelBuffer:(struct __CVBuffer *)arg1 properties:(id)arg2;	// IMP=0x0000000000112eac
- (id)initWithImageData:(id)arg1 identifierHint:(id)arg2;	// IMP=0x0000000000112dc9
- (id)initWithImageURL:(id)arg1;	// IMP=0x0000000000112d67
...
- (id)auxImageWithKey:(id)arg1;	// IMP=0x0000000000112b59
...
- (void)setIsEnableLensCorrection:(_Bool)arg1;	// IMP=0x0000000000111f5b
- (_Bool)lensCorrectionEnabled;	// IMP=0x0000000000111f1d
...
- (id)outputImage;	// IMP=0x00000000001116da
