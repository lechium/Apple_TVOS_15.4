...
+ (id)customAttributes;	// IMP=0x0000000000272176
- (id).cxx_construct;	// IMP=0x0000000000272c5b
...
- (id)outputImage;	// IMP=0x00000000002727d9
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeCameraIntrinsics;	// IMP=0x0000000000272415
