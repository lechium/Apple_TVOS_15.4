...
- (float)computeMergeCost:(id)arg1:(int *)arg2:(int)arg3;	// IMP=0x0000000000037bee
- (void)addItemsFromCluster:(id)arg1;	// IMP=0x0000000000037bd4
- (void)releaseImage;	// IMP=0x0000000000037b96
- (void)dealloc;	// IMP=0x0000000000037b3e
- (id)initWithImageData:(id)arg1 dict:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000037787
- (id)init;	// IMP=0x000000000003772b
