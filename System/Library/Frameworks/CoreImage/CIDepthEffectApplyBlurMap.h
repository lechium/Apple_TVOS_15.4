...
+ (id)customAttributes;	// IMP=0x00000000001b1f6d
...
- (id)outputImage;	// IMP=0x00000000001b280e
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b237b
