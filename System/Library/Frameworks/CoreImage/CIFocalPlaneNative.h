...
+ (id)customAttributes;	// IMP=0x00000000000a35d5
- (id)outputImage;	// IMP=0x00000000000a3bdf
- (id)_focalPlanePreProcessorKernelPow2;	// IMP=0x00000000000a3b61
- (id)_focalPlanePreProcessorKernel;	// IMP=0x00000000000a3ae3
