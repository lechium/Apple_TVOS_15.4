...
- (void).cxx_destruct;	// IMP=0x000000000005e566
...
- (void)executionDidBegin;	// IMP=0x000000000005e2a3
- (id)init;	// IMP=0x000000000005e1c4
- (id)initWithSettings:(id)arg1;	// IMP=0x000000000005e135
