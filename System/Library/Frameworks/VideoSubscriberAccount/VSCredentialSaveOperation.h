...
- (void).cxx_destruct;	// IMP=0x0000000000034c67
...
- (void)executionDidBegin;	// IMP=0x0000000000034a59
- (void)_didSaveAccounts:(id)arg1 withResult:(_Bool)arg2 error:(id)arg3;	// IMP=0x000000000003493f
- (id)initWithUnsavedAccounts:(id)arg1 accountStore:(id)arg2;	// IMP=0x0000000000034815
