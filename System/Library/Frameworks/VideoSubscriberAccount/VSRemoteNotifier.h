...
+ (id)_currentProcessIdentifier;	// IMP=0x00000000000083ca
- (void).cxx_destruct;	// IMP=0x0000000000008823
...
- (void)postNotificationWithUserInfo:(id)arg1;	// IMP=0x000000000000870a
- (void)postNotification;	// IMP=0x00000000000086f6
- (void)_didReceiveDistributedNotification:(id)arg1;	// IMP=0x00000000000085e4
- (void)dealloc;	// IMP=0x0000000000008598
- (id)initWithNotificationName:(id)arg1;	// IMP=0x00000000000084a7
- (id)init;	// IMP=0x000000000000847c
