...
@interface VSIdentityProvider : NSObject <NSCopying, NSSecureCoding>
{
    ...
    NSArray *_allSupportedAppDescriptions;	// 144 = 0x90
    NSArray *_nonChannelAppDescriptions;	// 152 = 0x98
    NSArray *_storefronts;	// 160 = 0xa0
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002810b
- (void).cxx_destruct;	// IMP=0x0000000000028c01
...
@property(copy, nonatomic) NSArray *allSupportedAppDescriptions; // @synthesize allSupportedAppDescriptions=_allSupportedAppDescriptions;
...
- (_Bool)isFullySupportedForRequestsExpectingAuthenticationSchemes:(id)arg1;	// IMP=0x00000000000288a9
- (_Bool)supportsRequestsExpectingAuthenticationSchemes:(id)arg1;	// IMP=0x00000000000287e5
@property(readonly, nonatomic) VSOptional *displayName;
- (id)initWithApplicationProvider:(id)arg1;	// IMP=0x0000000000028291
- (id)description;	// IMP=0x000000000002824c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000281f2
- (unsigned long long)hash;	// IMP=0x00000000000281b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028169
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000028113
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002808b
- (id)init;	// IMP=0x0000000000028027
