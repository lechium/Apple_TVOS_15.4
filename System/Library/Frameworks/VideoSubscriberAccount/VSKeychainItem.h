...
- (void).cxx_destruct;	// IMP=0x0000000000036196
...
- (id)description;	// IMP=0x0000000000035cc0
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x0000000000035be6
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x0000000000035b5a
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x0000000000035a5d
- (id)changedValues;	// IMP=0x0000000000035721
- (id)committedValueForKey:(id)arg1;	// IMP=0x000000000003569e
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x0000000000035620
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000035407
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x00000000000352f3
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x000000000003513a
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x0000000000034e1c
- (id)init;	// IMP=0x0000000000034dad
