...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002ceec
- (void).cxx_destruct;	// IMP=0x000000000002d129
...
- (id)description;	// IMP=0x000000000002d02d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002cfd3
- (unsigned long long)hash;	// IMP=0x000000000002cf9a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002cf4a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002cef4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002ce6c
- (id)init;	// IMP=0x000000000002ce08
- (void)setDefaults;	// IMP=0x000000000002cd6d
