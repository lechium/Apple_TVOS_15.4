...
- (void).cxx_destruct;	// IMP=0x00000000000645f8
...
- (void)connectionHandlerDidFinish:(id)arg1;	// IMP=0x000000000006457c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000006410f
- (void)_removeConnectionHandler:(id)arg1;	// IMP=0x0000000000064074
- (void)_addConnectionHandler:(id)arg1;	// IMP=0x0000000000063fd9
- (id)init;	// IMP=0x0000000000063f83
