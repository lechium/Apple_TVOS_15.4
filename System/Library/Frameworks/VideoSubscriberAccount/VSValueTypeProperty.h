...
+ (id)valueTypePropertyWithName:(id)arg1 kind:(unsigned long long)arg2 allowedClasses:(id)arg3 initialValue:(id)arg4;	// IMP=0x000000000000fa39
- (void).cxx_destruct;	// IMP=0x000000000000fb62
