...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000051950
- (void).cxx_destruct;	// IMP=0x0000000000051d2b
...
- (id)description;	// IMP=0x0000000000051a91
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000051a37
- (unsigned long long)hash;	// IMP=0x00000000000519fe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000519ae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000051958
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000518d0
- (id)init;	// IMP=0x000000000005186c
