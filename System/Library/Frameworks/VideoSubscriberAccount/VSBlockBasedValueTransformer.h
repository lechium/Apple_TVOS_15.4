...
- (void).cxx_destruct;	// IMP=0x0000000000058dcd
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000058d17
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000058ca5
- (id)init;	// IMP=0x0000000000058c2a
