...
- (id)vs_JSONValueTransformer;	// IMP=0x0000000000027a3a
...
- (id)vs_propertyListValueTransformer;	// IMP=0x000000000002739f
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x0000000000027232
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000026f9f
@end
