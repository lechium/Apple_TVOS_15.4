...
+ (id)directoryURL;	// IMP=0x000000000001802c
+ (id)legacyDirectoryURL;	// IMP=0x0000000000017f35
- (void).cxx_destruct;	// IMP=0x0000000000018cc7
...
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000018ba5
- (id)developerIdentityProviderFetchRequest;	// IMP=0x0000000000018b8c
- (id)insertDeveloperIdentityProviderInContext:(id)arg1;	// IMP=0x0000000000018b3f
- (id)init;	// IMP=0x0000000000018b28
- (id)initWithModelVersion:(long long)arg1;	// IMP=0x00000000000187a8
- (void)migrateContainerIfNecessary;	// IMP=0x000000000001832f
