...
- (void).cxx_destruct;	// IMP=0x000000000005a26f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005a11a
- (id)description;	// IMP=0x000000000005a042
- (id)initWithProviderID:(id)arg1 userToken:(id)arg2 activationTime:(id)arg3 isDeveloper:(_Bool)arg4;	// IMP=0x0000000000059f80
