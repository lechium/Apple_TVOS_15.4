...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001e07a
- (void).cxx_destruct;	// IMP=0x000000000001e5a2
...
- (id)description;	// IMP=0x000000000001e1bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001e161
- (unsigned long long)hash;	// IMP=0x000000000001e128
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001e0d8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001e082
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001dffa
- (id)init;	// IMP=0x000000000001df96
