...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003d93d
- (void).cxx_destruct;	// IMP=0x000000000003dd34
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003dc05
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003d996
- (id)init;	// IMP=0x000000000003d945
