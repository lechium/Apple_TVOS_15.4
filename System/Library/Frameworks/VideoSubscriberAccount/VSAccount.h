...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000532c1
- (void).cxx_destruct;	// IMP=0x000000000005450b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000053bb3
- (unsigned long long)hash;	// IMP=0x0000000000053a49
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000536e2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000532c9
@property(readonly, nonatomic) NSString *identityProviderDisplayName;
- (id)init;	// IMP=0x00000000000531b0
- (unsigned long long)contentsHash;	// IMP=0x0000000000008924
- (id)effectiveModificationDate;	// IMP=0x00000000000088d4
