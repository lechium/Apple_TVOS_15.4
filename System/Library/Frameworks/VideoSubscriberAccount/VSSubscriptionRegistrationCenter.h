...
+ (id)defaultSubscriptionRegistrationCenter;	// IMP=0x000000000004bcb1
...
- (void)removeSubscriptions:(id)arg1;	// IMP=0x000000000004ea54
- (void)registerSubscription:(id)arg1;	// IMP=0x000000000004e519
- (void)fetchActiveSubscriptionsWithOptions:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004d8f5
- (void)remoteNotifier:(id)arg1 didReceiveRemoteNotificationWithUserInfo:(id)arg2;	// IMP=0x000000000004d861
...
- (void)_resetExpirationOperation;	// IMP=0x000000000004ca58
- (void)_refreshCachedSubscriptions;	// IMP=0x000000000004c4c1
- (void)_sendLocalNotificationWithUserInfo:(id)arg1;	// IMP=0x000000000004c3df
- (_Bool)_shouldRaiseExceptionsForMisuse;	// IMP=0x000000000004c399
- (_Bool)_shouldAllowAccessToSubscription:(id)arg1;	// IMP=0x000000000004c2dd
- (id)_serviceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000004c25a
- (void)setCurrentSubscription:(id)arg1;	// IMP=0x000000000004bd06
- (void)dealloc;	// IMP=0x000000000004bbed
- (id)init;	// IMP=0x000000000004bb02
