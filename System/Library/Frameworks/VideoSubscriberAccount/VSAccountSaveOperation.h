...
- (void).cxx_destruct;	// IMP=0x00000000000655e8
...
- (void)cancel;	// IMP=0x00000000000654c5
- (void)executionDidBegin;	// IMP=0x00000000000654b3
- (void)_startAccountChannelsSaveOperation;	// IMP=0x0000000000065292
- (void)_startCredentialSaveOperation;	// IMP=0x0000000000064e23
- (id)initWithUnsavedAccounts:(id)arg1 channels:(id)arg2 storage:(id)arg3;	// IMP=0x0000000000064c7c
- (id)init;	// IMP=0x0000000000064c0d
