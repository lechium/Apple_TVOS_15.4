...
+ (_Bool)automaticallyNotifiesObserversOfStatus;	// IMP=0x0000000000057d26
+ (id)defaultCenter;	// IMP=0x0000000000056f54
- (void).cxx_destruct;	// IMP=0x000000000005802f
...
- (void)remoteNotifier:(id)arg1 didReceiveRemoteNotificationWithUserInfo:(id)arg2;	// IMP=0x0000000000057f28
- (void)determineIdentityProviderAvailabilityWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000057dd4
@property(nonatomic) long long status; // @synthesize status=_status;
- (void)_beginStatusUpdateAttemptWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000005722a
- (void)_sendStatusChangeNotification;	// IMP=0x000000000005712a
- (void)_accountStoreChanged:(id)arg1;	// IMP=0x000000000005706c
- (id)init;	// IMP=0x0000000000056ddb
