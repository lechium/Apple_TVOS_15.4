...
- (void).cxx_destruct;	// IMP=0x000000000005686f
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x00000000000567b6
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000567a2
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x0000000000056421
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x000000000005593f
- (void)_removePersistentStore;	// IMP=0x0000000000055826
- (id)init;	// IMP=0x00000000000553e4
