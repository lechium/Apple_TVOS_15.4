...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004e743
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004e5e0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004e3e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004e1f2
- (id)description;	// IMP=0x000000000004de72
- (id)copyBasic;	// IMP=0x000000000004dd8f
