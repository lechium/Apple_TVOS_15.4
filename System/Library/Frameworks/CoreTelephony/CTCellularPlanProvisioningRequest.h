...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000050e11
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000050c6b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000050bae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000050a41
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000050833
- (id)init;	// IMP=0x00000000000507a3
- (id)description;	// IMP=0x000000000005075c
