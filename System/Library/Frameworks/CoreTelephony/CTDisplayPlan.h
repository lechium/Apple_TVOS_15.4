...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c7e6e
- (void).cxx_destruct;	// IMP=0x00000000000c8133
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c8002
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c7e76
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c7b6d
- (id)description;	// IMP=0x00000000000c7941
- (id)initWithPlan:(id)arg1 status:(long long)arg2 attributes:(unsigned long long)arg3 isPhysical:(_Bool)arg4 carrierName:(id)arg5 phoneNumber:(id)arg6 label:(id)arg7;	// IMP=0x00000000000c784a
