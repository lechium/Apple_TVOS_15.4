...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005bf6d
- (void).cxx_destruct;	// IMP=0x000000000005c0a4
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005baf2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005b6a7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005b471
- (id)description;	// IMP=0x000000000005b1ee
- (id)init;	// IMP=0x000000000005b17f
