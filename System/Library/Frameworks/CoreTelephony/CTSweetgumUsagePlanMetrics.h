...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000014e63
- (void).cxx_destruct;	// IMP=0x0000000000014f45
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014b71
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000014576
- (id)description;	// IMP=0x000000000001433c
