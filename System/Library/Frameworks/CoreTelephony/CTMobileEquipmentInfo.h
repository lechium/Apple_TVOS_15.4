...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005013b
- (void).cxx_destruct;	// IMP=0x0000000000050352
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004fd0d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004f8f9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004f356
- (id)description;	// IMP=0x000000000004eeba
