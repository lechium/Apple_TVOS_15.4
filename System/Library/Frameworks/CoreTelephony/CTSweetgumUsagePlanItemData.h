...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000024dce
- (void).cxx_destruct;	// IMP=0x0000000000024e71
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024c42
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000024b7e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000024705
- (id)description;	// IMP=0x0000000000024541
- (id)init;	// IMP=0x00000000000244b8
