...
- (void).cxx_destruct;	// IMP=0x0000000000051b2a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000051921
- (id)init;	// IMP=0x00000000000518a3
- (id)description;	// IMP=0x00000000000517a3
