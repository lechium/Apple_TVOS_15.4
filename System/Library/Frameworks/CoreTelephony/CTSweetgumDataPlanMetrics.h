...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a22f9
- (void).cxx_destruct;	// IMP=0x00000000000a235c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a2203
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a217c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a1f1d
- (id)description;	// IMP=0x00000000000a1dd0
- (id)init;	// IMP=0x00000000000a1d5d
