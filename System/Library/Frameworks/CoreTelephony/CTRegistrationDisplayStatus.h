...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001a0f0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001a00f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019f2f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019e3a
- (id)description;	// IMP=0x0000000000019d22
