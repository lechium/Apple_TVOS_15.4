...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003aa72
- (void).cxx_destruct;	// IMP=0x000000000003abbd
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003a8e6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003a7ce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a650
- (id)description;	// IMP=0x000000000003a453
