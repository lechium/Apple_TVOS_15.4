...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000babd8
- (void).cxx_destruct;	// IMP=0x00000000000bac8d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ba9eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ba911
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ba3f4
- (id)description;	// IMP=0x00000000000ba217
- (id)init;	// IMP=0x00000000000ba18a
