...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006f26a
- (void).cxx_destruct;	// IMP=0x000000000006f314
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006f06d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006eeb0
