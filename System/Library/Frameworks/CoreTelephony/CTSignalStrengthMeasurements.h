...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000063333
- (void).cxx_destruct;	// IMP=0x0000000000063413
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000063129
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000062f41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062c98
- (id)description;	// IMP=0x0000000000062913
