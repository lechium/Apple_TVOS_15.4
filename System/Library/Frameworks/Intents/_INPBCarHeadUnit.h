...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004b6c18
- (void).cxx_destruct;	// IMP=0x00000000004b6a40
...
- (id)dictionaryRepresentation;	// IMP=0x00000000004b690a
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004b6600
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004b6541
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004b64af
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004b63b0
- (void)writeTo:(id)arg1;	// IMP=0x00000000004b6302
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004b62f5
