...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000028d040
- (void).cxx_destruct;	// IMP=0x000000000028ca34
...
- (id)dictionaryRepresentation;	// IMP=0x000000000028c5bb
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000028ba86
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000028b828
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000028b796
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000028b697
- (void)writeTo:(id)arg1;	// IMP=0x000000000028b303
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000028b2f6
