...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002715e4
- (void).cxx_destruct;	// IMP=0x00000000002711a9
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000270e3d
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000270743
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002705a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000270516
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000270417
- (void)writeTo:(id)arg1;	// IMP=0x00000000002701f4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002701e7
@property(readonly, nonatomic) _Bool hasStationName;
- (int)StringAsRadioType:(id)arg1;	// IMP=0x00000000002700ec
- (id)radioTypeAsString:(int)arg1;	// IMP=0x0000000000270060
