...
+ (id)_intents_decodeWithJSONDecoder:(id)arg1 codableDescription:(id)arg2 from:(id)arg3;	// IMP=0x0000000000450253
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000045024b
- (void).cxx_destruct;	// IMP=0x00000000004501c0
...
- (id)_dictionaryRepresentation;	// IMP=0x000000000044fbf4
- (id)descriptionAtIndent:(unsigned long long)arg1;	// IMP=0x000000000044fb18
@property(readonly, copy) NSString *description;
- (id)_intents_encodeWithJSONEncoder:(id)arg1 codableDescription:(id)arg2;	// IMP=0x000000000044f717
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000044f5c7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000044f2c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000044f2b8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000044f0c4
@property(readonly) unsigned long long hash;
- (id)initWithSpeakerIDInfo:(id)arg1 proxiedThirdPartyAppInfo:(id)arg2 isAppAttributionRequired:(id)arg3 useDialogMemoryForAttribution:(id)arg4 isAppCorrection:(id)arg5 fallbackUsername:(id)arg6 wholeHouseAudioMetadata:(id)arg7 nlConfidenceScore:(id)arg8 nlConfidenceLevel:(long long)arg9 asrConfidenceScore:(id)arg10 asrConfidenceLevel:(long long)arg11 resolvedSharedUserID:(id)arg12 homeAutomationEntityProvider:(id)arg13;	// IMP=0x000000000044ed22
- (id)initWithSpeakerIDInfo:(id)arg1 proxiedThirdPartyAppInfo:(id)arg2 isAppAttributionRequired:(id)arg3 useDialogMemoryForAttribution:(id)arg4 isAppCorrection:(id)arg5 fallbackUsername:(id)arg6 wholeHouseAudioMetadata:(id)arg7 nlConfidenceScore:(id)arg8 nlConfidenceLevel:(long long)arg9 asrConfidenceScore:(id)arg10 asrConfidenceLevel:(long long)arg11 resolvedSharedUserID:(id)arg12;	// IMP=0x000000000006d7d6
- (id)initWithSpeakerIDInfo:(id)arg1 proxiedThirdPartyAppInfo:(id)arg2 isAppAttributionRequired:(id)arg3 useDialogMemoryForAttribution:(id)arg4 isAppCorrection:(id)arg5 fallbackUsername:(id)arg6 wholeHouseAudioMetadata:(id)arg7 nlConfidenceScore:(id)arg8 nlConfidenceLevel:(long long)arg9 asrConfidenceScore:(id)arg10 asrConfidenceLevel:(long long)arg11;	// IMP=0x000000000006d790
