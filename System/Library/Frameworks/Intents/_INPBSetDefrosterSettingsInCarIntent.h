...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000132f0c
- (void).cxx_destruct;	// IMP=0x0000000000132b8b
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000132940
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000132504
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001323ee
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013235c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000013225d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000132121
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000132114
@property(readonly, nonatomic) _Bool hasIntentMetadata;
@property(nonatomic) _Bool hasEnable;
- (int)StringAsDefroster:(id)arg1;	// IMP=0x0000000000132005
- (id)defrosterAsString:(int)arg1;	// IMP=0x0000000000131f9e
