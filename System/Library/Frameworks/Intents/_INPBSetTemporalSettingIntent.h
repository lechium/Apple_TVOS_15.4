...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004639c8
- (void).cxx_destruct;	// IMP=0x000000000046360e
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000463349
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000462d32
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000462be3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000462b51
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000462a52
- (void)writeTo:(id)arg1;	// IMP=0x000000000046288b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000046287e
...
- (int)StringAsAction:(id)arg1;	// IMP=0x000000000046273d
- (id)actionAsString:(int)arg1;	// IMP=0x00000000004626d6
