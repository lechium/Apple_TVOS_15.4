...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003dff2c
- (void).cxx_destruct;	// IMP=0x00000000003dfbf9
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003dfa05
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003df4c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003df39a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003df308
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003df209
- (void)writeTo:(id)arg1;	// IMP=0x00000000003df06e
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003df061
