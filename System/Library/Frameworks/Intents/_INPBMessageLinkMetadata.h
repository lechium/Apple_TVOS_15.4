...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000036f2a4
- (void).cxx_destruct;	// IMP=0x000000000036e13f
...
- (id)dictionaryRepresentation;	// IMP=0x000000000036c8a4
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000036933b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000368826
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000368794
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000368695
- (void)writeTo:(id)arg1;	// IMP=0x0000000000367825
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000367818
...
- (int)StringAsLinkMediaType:(id)arg1;	// IMP=0x0000000000366c90
- (id)linkMediaTypeAsString:(int)arg1;	// IMP=0x0000000000366a9b
@property(nonatomic) _Bool hasLinkMediaType;
@property(readonly, nonatomic) _Bool hasItemType;
- (id)imageURLAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003669db
@property(readonly, nonatomic) unsigned long long imageURLsCount;
- (void)addImageURL:(id)arg1;	// IMP=0x0000000000366944
- (void)clearImageURLs;	// IMP=0x0000000000366927
- (id)iconURLAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003668d6
@property(readonly, nonatomic) unsigned long long iconURLsCount;
- (void)addIconURL:(id)arg1;	// IMP=0x000000000036683f
- (void)clearIconURLs;	// IMP=0x0000000000366822
