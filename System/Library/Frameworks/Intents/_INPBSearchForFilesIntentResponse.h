...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d6cd1
+ (Class)entitiesType;	// IMP=0x00000000001d6cc0
- (void).cxx_destruct;	// IMP=0x00000000001d6954
...
- (id)dictionaryRepresentation;	// IMP=0x00000000001d65ab
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d60ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d5fd4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d5f42
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d5e43
- (void)writeTo:(id)arg1;	// IMP=0x00000000001d5c19
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001d5c0c
@property(nonatomic) _Bool hasSuccess;
@property(readonly, nonatomic) _Bool hasQuery;
@property(readonly, nonatomic) _Bool hasNumResults;
- (id)entitiesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001d5b58
@property(readonly, nonatomic) unsigned long long entitiesCount;
- (void)addEntities:(id)arg1;	// IMP=0x00000000001d5ac1
- (void)clearEntities;	// IMP=0x00000000001d5aa4
