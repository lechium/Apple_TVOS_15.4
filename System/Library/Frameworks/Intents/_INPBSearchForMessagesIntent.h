...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000105b20
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000104cf7
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000103fee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000103d35
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000103ca3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000103ba4
- (void)dealloc;	// IMP=0x0000000000103b66
- (void)writeTo:(id)arg1;	// IMP=0x000000000010370e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000103701
...
- (int)StringAsAttributes:(id)arg1;	// IMP=0x000000000010346c
- (id)attributesAsString:(int)arg1;	// IMP=0x00000000001033e1
- (int)attributeAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001033cd
@property(readonly, nonatomic) unsigned long long attributesCount;
- (void)addAttribute:(int)arg1;	// IMP=0x000000000010339f
- (void)clearAttributes;	// IMP=0x000000000010338e
@property(readonly, nonatomic) int *attributes;
- (void)setAttributes:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000103366
