...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003ca010
- (void).cxx_destruct;	// IMP=0x00000000003c9c2a
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003c9936
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003c91a3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003c9010
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003c8f7e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003c8e7f
- (void)writeTo:(id)arg1;	// IMP=0x00000000003c8c47
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003c8c3a
