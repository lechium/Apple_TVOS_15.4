...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003d97a0
- (void).cxx_destruct;	// IMP=0x00000000003d94ed
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003d9362
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003d8f06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d8e1c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003d8d8a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003d8c8b
- (void)writeTo:(id)arg1;	// IMP=0x00000000003d8b4c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003d8b3f
