...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002c1479
+ (Class)associatedItemsType;	// IMP=0x00000000002c1468
- (void).cxx_destruct;	// IMP=0x00000000002c0d3d
...
- (id)dictionaryRepresentation;	// IMP=0x00000000002c0596
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002bfb79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002bf8ea
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002bf858
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002bf759
- (void)writeTo:(id)arg1;	// IMP=0x00000000002bf394
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002bf387
@property(readonly, nonatomic) _Bool hasWorkoutName;
- (int)StringAsWorkoutLocationType:(id)arg1;	// IMP=0x00000000002bf2fc
- (id)workoutLocationTypeAsString:(int)arg1;	// IMP=0x00000000002bf2a7
@property(nonatomic) _Bool hasWorkoutLocationType;
- (int)StringAsWorkoutGoalUnitType:(id)arg1;	// IMP=0x00000000002bf0d4
- (id)workoutGoalUnitTypeAsString:(int)arg1;	// IMP=0x00000000002bf009
@property(nonatomic) _Bool hasWorkoutGoalUnitType;
- (int)StringAsSequenceLabel:(id)arg1;	// IMP=0x00000000002bef47
- (id)sequenceLabelAsString:(int)arg1;	// IMP=0x00000000002beef2
...
- (id)associatedItemsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002bed21
@property(readonly, nonatomic) unsigned long long associatedItemsCount;
- (void)addAssociatedItems:(id)arg1;	// IMP=0x00000000002bec8a
- (void)clearAssociatedItems;	// IMP=0x00000000002bec6d
