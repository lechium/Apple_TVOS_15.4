...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c4ff8
- (void).cxx_destruct;	// IMP=0x00000000000c4cc0
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000c4acc
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c458c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c4461
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c43cf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c42d0
- (void)writeTo:(id)arg1;	// IMP=0x00000000000c4135
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000c4128
