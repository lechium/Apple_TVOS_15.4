...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000082d8
...
- (id)dictionaryRepresentation;	// IMP=0x000000000000794f
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007077
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006e84
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000006df2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000006cf3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000006a48
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000006a3b
...
- (int)StringAsStatus:(id)arg1;	// IMP=0x0000000000006927
- (id)statusAsString:(int)arg1;	// IMP=0x00000000000068c1
@property(nonatomic) _Bool hasStatus;
@property(readonly, nonatomic) _Bool hasSpatialEventTrigger;
- (int)StringAsPriority:(id)arg1;	// IMP=0x00000000000067a8
- (id)priorityAsString:(int)arg1;	// IMP=0x0000000000006742
