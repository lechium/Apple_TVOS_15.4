...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003f1bc0
- (void).cxx_destruct;	// IMP=0x00000000003f195b
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003f1788
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003f13f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f1305
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003f1273
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003f1174
- (void)writeTo:(id)arg1;	// IMP=0x00000000003f109a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003f108d
- (int)StringAsEncodingFormat:(id)arg1;	// IMP=0x00000000003f1026
- (id)encodingFormatAsString:(int)arg1;	// IMP=0x00000000003f0fd0
