...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003d6bb4
- (void).cxx_destruct;	// IMP=0x00000000003d6736
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003d62cc
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003d5808
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d55d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003d553e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003d543f
- (void)writeTo:(id)arg1;	// IMP=0x00000000003d515f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003d5152
