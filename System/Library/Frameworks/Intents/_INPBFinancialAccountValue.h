...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000026e374
- (void).cxx_destruct;	// IMP=0x000000000026dede
...
- (id)dictionaryRepresentation;	// IMP=0x000000000026daff
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026d2c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000026d0ff
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000026d06d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000026cf6e
- (void)writeTo:(id)arg1;	// IMP=0x000000000026cd0a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000026ccfd
...
- (int)StringAsAccountType:(id)arg1;	// IMP=0x000000000026cb3c
- (id)accountTypeAsString:(int)arg1;	// IMP=0x000000000026ca96
