...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f16fc
- (void).cxx_destruct;	// IMP=0x00000000000f132c
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000f10b9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f0ad9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f0989
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f08f7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f07f8
- (void)writeTo:(id)arg1;	// IMP=0x00000000000f0630
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000f0623
