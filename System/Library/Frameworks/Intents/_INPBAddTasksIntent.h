...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019de2e
+ (Class)taskTitlesType;	// IMP=0x000000000019de1d
+ (Class)targetTaskListMembersType;	// IMP=0x000000000019de0c
- (void).cxx_destruct;	// IMP=0x000000000019d7e1
...
- (id)dictionaryRepresentation;	// IMP=0x000000000019d031
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019c52f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019c2d9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019c247
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019c148
- (void)writeTo:(id)arg1;	// IMP=0x000000000019bcac
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000019bc9f
@property(readonly, nonatomic) _Bool hasTemporalEventTrigger;
- (id)taskTitlesAtIndex:(unsigned long long)arg1;	// IMP=0x000000000019bc59
@property(readonly, nonatomic) unsigned long long taskTitlesCount;
- (void)addTaskTitles:(id)arg1;	// IMP=0x000000000019bbc2
- (void)clearTaskTitles;	// IMP=0x000000000019bba5
- (int)StringAsTaskReference:(id)arg1;	// IMP=0x000000000019bb52
- (id)taskReferenceAsString:(int)arg1;	// IMP=0x000000000019bb0e
@property(nonatomic) _Bool hasTaskReference;
- (id)targetTaskListMembersAtIndex:(unsigned long long)arg1;	// IMP=0x000000000019ba93
@property(readonly, nonatomic) unsigned long long targetTaskListMembersCount;
- (void)addTargetTaskListMembers:(id)arg1;	// IMP=0x000000000019b9fc
- (void)clearTargetTaskListMembers;	// IMP=0x000000000019b9df
@property(readonly, nonatomic) _Bool hasTargetTaskList;
@property(readonly, nonatomic) _Bool hasSpatialEventTrigger;
- (int)StringAsPriority:(id)arg1;	// IMP=0x000000000019b8c7
- (id)priorityAsString:(int)arg1;	// IMP=0x000000000019b861
