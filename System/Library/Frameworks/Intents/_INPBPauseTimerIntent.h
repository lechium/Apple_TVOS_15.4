...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000241b3a
- (void).cxx_destruct;	// IMP=0x000000000024185b
...
- (id)dictionaryRepresentation;	// IMP=0x00000000002416c3
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000241313
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024122d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000024119b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000024109c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000240f8c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000240f7f
