...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000467170
- (void).cxx_destruct;	// IMP=0x0000000000466d17
...
- (id)dictionaryRepresentation;	// IMP=0x00000000004669a0
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000046634e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004661cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000046613d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000046603e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000465e4b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000465e3e
...
- (int)StringAsBoundedValue:(id)arg1;	// IMP=0x0000000000465cfd
- (id)boundedValueAsString:(int)arg1;	// IMP=0x0000000000465c96
@property(nonatomic) _Bool hasBoundedValue;
- (int)StringAsAction:(id)arg1;	// IMP=0x0000000000465b9b
- (id)actionAsString:(int)arg1;	// IMP=0x0000000000465b34
