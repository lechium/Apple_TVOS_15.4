...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000dc6fc
- (void).cxx_destruct;	// IMP=0x00000000000dc195
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000dbc9a
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000db54b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000db370
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000db2de
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000db1df
- (void)writeTo:(id)arg1;	// IMP=0x00000000000db00c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000dafff
- (int)StringAsValueType:(id)arg1;	// IMP=0x00000000000daf10
- (id)valueTypeAsString:(int)arg1;	// IMP=0x00000000000dae76
@property(nonatomic) _Bool hasValueType;
- (int)StringAsUnit:(id)arg1;	// IMP=0x00000000000dad44
- (id)unitAsString:(int)arg1;	// IMP=0x00000000000dacb8
@property(nonatomic) _Bool hasUnit;
@property(readonly, nonatomic) _Bool hasStringValue;
@property(readonly, nonatomic) _Bool hasRangeValue;
- (int)StringAsLimitValue:(id)arg1;	// IMP=0x00000000000dab7f
- (id)limitValueAsString:(int)arg1;	// IMP=0x00000000000dab29
