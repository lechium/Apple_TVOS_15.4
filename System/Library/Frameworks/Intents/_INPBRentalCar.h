...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003dd224
- (void).cxx_destruct;	// IMP=0x00000000003dcf7c
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003dccde
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003dc67d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003dc521
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003dc48f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003dc390
- (void)writeTo:(id)arg1;	// IMP=0x00000000003dc21f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003dc212
