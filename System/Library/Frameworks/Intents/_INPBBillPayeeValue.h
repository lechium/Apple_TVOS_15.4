...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003808
- (void).cxx_destruct;	// IMP=0x00000000000034fa
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000032d8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002d98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002c6d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002bdb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002adc
- (void)writeTo:(id)arg1;	// IMP=0x000000000000295c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000294f
