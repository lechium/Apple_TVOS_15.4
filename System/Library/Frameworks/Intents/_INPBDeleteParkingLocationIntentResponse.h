...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000472cbc
- (void).cxx_destruct;	// IMP=0x0000000000472a7e
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000472960
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000472656
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000472597
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000472505
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000472406
- (void)writeTo:(id)arg1;	// IMP=0x0000000000472323
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000472316
