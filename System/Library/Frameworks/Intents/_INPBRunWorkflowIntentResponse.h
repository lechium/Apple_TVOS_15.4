...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000063ef9
+ (Class)stepType;	// IMP=0x0000000000063ee8
- (void).cxx_destruct;	// IMP=0x0000000000063a05
...
- (id)dictionaryRepresentation;	// IMP=0x000000000006350b
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000062e0a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062c4f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000062bbd
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000062abe
- (void)writeTo:(id)arg1;	// IMP=0x00000000000627fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000627ee
...
- (id)stepAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000626eb
@property(readonly, nonatomic) unsigned long long stepsCount;
- (void)addStep:(id)arg1;	// IMP=0x0000000000062654
- (void)clearSteps;	// IMP=0x0000000000062637
