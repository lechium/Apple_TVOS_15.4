...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002e6e01
+ (Class)participantsType;	// IMP=0x00000000002e6df0
- (void).cxx_destruct;	// IMP=0x00000000002e667c
...
- (id)dictionaryRepresentation;	// IMP=0x00000000002e5dc1
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e5123
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e4e2f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002e4d9d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002e4c9e
- (void)writeTo:(id)arg1;	// IMP=0x00000000002e484b
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002e483e
...
- (int)StringAsPreferredCallProvider:(id)arg1;	// IMP=0x00000000002e46c3
- (id)preferredCallProviderAsString:(int)arg1;	// IMP=0x00000000002e465c
@property(nonatomic) _Bool hasPreferredCallProvider;
- (id)participantsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000002e45df
@property(readonly, nonatomic) unsigned long long participantsCount;
- (void)addParticipants:(id)arg1;	// IMP=0x00000000002e4548
- (void)clearParticipants;	// IMP=0x00000000002e452b
...
- (int)StringAsCallType:(id)arg1;	// IMP=0x00000000002e42b0
- (id)callTypeAsString:(int)arg1;	// IMP=0x00000000002e41fa
@property(nonatomic) _Bool hasCallType;
@property(readonly, nonatomic) _Bool hasCallMetrics;
- (int)StringAsCallCapability:(id)arg1;	// IMP=0x00000000002e410c
- (id)callCapabilityAsString:(int)arg1;	// IMP=0x00000000002e40b6
