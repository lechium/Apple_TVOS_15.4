...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003663e8
- (void).cxx_destruct;	// IMP=0x00000000003660c5
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000365ec3
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003658fe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003657dc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000036574a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000036564b
- (void)writeTo:(id)arg1;	// IMP=0x00000000003654de
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003654d1
