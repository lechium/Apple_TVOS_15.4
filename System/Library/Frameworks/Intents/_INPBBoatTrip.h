...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004447d4
- (void).cxx_destruct;	// IMP=0x0000000000444455
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000444184
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004439f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000044385e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004437cc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004436cd
- (void)writeTo:(id)arg1;	// IMP=0x00000000004434cb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004434be
