...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000027d540
- (void).cxx_destruct;	// IMP=0x000000000027ce3e
...
- (id)dictionaryRepresentation;	// IMP=0x000000000027c7db
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027bb95
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000027b8a7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000027b815
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000027b716
- (void)writeTo:(id)arg1;	// IMP=0x000000000027b391
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000027b384
@property(readonly, nonatomic) _Bool hasTitle;
@property(readonly, nonatomic) _Bool hasTemporalEventTrigger;
- (int)StringAsTaskType:(id)arg1;	// IMP=0x000000000027b299
- (id)taskTypeAsString:(int)arg1;	// IMP=0x000000000027b233
@property(nonatomic) _Bool hasTaskType;
- (int)StringAsTaskReference:(id)arg1;	// IMP=0x000000000027b1b4
- (id)taskReferenceAsString:(int)arg1;	// IMP=0x000000000027b170
@property(nonatomic) _Bool hasTaskReference;
- (int)StringAsStatus:(id)arg1;	// IMP=0x000000000027b077
- (id)statusAsString:(int)arg1;	// IMP=0x000000000027b011
@property(nonatomic) _Bool hasStatus;
@property(readonly, nonatomic) _Bool hasSpatialEventTrigger;
- (int)StringAsPriority:(id)arg1;	// IMP=0x000000000027aef8
- (id)priorityAsString:(int)arg1;	// IMP=0x000000000027ae92
