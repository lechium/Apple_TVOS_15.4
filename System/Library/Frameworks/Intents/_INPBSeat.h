...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003c486c
- (void).cxx_destruct;	// IMP=0x00000000003c45ff
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003c43d9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003c3e99
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003c3d6e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003c3cdc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003c3bdd
- (void)writeTo:(id)arg1;	// IMP=0x00000000003c3aad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003c3aa0
