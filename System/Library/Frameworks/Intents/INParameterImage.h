...
- (void).cxx_destruct;	// IMP=0x000000000013f3cb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013f32a
- (id)initWithParameter:(id)arg1 image:(id)arg2;	// IMP=0x000000000013f271
