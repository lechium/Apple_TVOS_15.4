...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004052ef
+ (Class)urlAddressesType;	// IMP=0x00000000004052de
+ (Class)postalAddressesType;	// IMP=0x00000000004052cd
+ (Class)phoneNumbersType;	// IMP=0x00000000004052bc
+ (Class)instantMessageAddressesType;	// IMP=0x00000000004052ab
+ (Class)emailAddressesType;	// IMP=0x000000000040529a
+ (Class)datesType;	// IMP=0x0000000000405289
+ (Class)contactRelationsType;	// IMP=0x0000000000405278
- (void).cxx_destruct;	// IMP=0x00000000004046fd
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000403180
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000040128b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000400c45
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000400bb3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000400ab4
- (void)writeTo:(id)arg1;	// IMP=0x00000000003ffee6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003ffed9
- (id)urlAddressesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ffebc
@property(readonly, nonatomic) unsigned long long urlAddressesCount;
- (void)addUrlAddresses:(id)arg1;	// IMP=0x00000000003ffe25
- (void)clearUrlAddresses;	// IMP=0x00000000003ffe08
- (id)postalAddressesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ffdb7
@property(readonly, nonatomic) unsigned long long postalAddressesCount;
- (void)addPostalAddresses:(id)arg1;	// IMP=0x00000000003ffd20
- (void)clearPostalAddresses;	// IMP=0x00000000003ffd03
...
- (id)phoneNumbersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ffafc
@property(readonly, nonatomic) unsigned long long phoneNumbersCount;
- (void)addPhoneNumbers:(id)arg1;	// IMP=0x00000000003ffa65
- (void)clearPhoneNumbers;	// IMP=0x00000000003ffa48
...
- (id)instantMessageAddressesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ff78a
@property(readonly, nonatomic) unsigned long long instantMessageAddressesCount;
- (void)addInstantMessageAddresses:(id)arg1;	// IMP=0x00000000003ff6f3
- (void)clearInstantMessageAddresses;	// IMP=0x00000000003ff6d6
@property(readonly, nonatomic) _Bool hasImage;
@property(readonly, nonatomic) _Bool hasFullName;
@property(readonly, nonatomic) _Bool hasFirstName;
- (id)emailAddressesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ff5ca
@property(readonly, nonatomic) unsigned long long emailAddressesCount;
- (void)addEmailAddresses:(id)arg1;	// IMP=0x00000000003ff533
- (void)clearEmailAddresses;	// IMP=0x00000000003ff516
@property(readonly, nonatomic) _Bool hasDepartmentName;
- (id)datesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ff47c
@property(readonly, nonatomic) unsigned long long datesCount;
- (void)addDates:(id)arg1;	// IMP=0x00000000003ff3e5
- (void)clearDates;	// IMP=0x00000000003ff3c8
- (id)contactRelationsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003ff377
@property(readonly, nonatomic) unsigned long long contactRelationsCount;
- (void)addContactRelations:(id)arg1;	// IMP=0x00000000003ff2e0
- (void)clearContactRelations;	// IMP=0x00000000003ff2c3
