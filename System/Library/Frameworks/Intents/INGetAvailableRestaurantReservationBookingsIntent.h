...
+ (id)intentDescription;	// IMP=0x000000000016a495
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000016a48d
- (void).cxx_destruct;	// IMP=0x000000000016a418
...
- (id)_dictionaryRepresentation;	// IMP=0x000000000016a091
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000169f0b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000169a12
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001698e8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016964e
- (id)initWithRestaurant:(id)arg1 partySize:(unsigned long long)arg2 preferredBookingDateComponents:(id)arg3 maximumNumberOfResults:(id)arg4 earliestBookingDateForResults:(id)arg5 latestBookingDateForResults:(id)arg6;	// IMP=0x0000000000169529
