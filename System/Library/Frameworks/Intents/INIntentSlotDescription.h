...
- (void).cxx_destruct;	// IMP=0x00000000001aff0b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001afe6f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001afd52
...
- (id)initWithName:(id)arg1 tag:(unsigned long long)arg2 facadePropertyName:(id)arg3 dataPropertyName:(id)arg4 isExtended:(_Bool)arg5 isPrivate:(_Bool)arg6 valueType:(long long)arg7 valueStyle:(long long)arg8 defaultValueSelectorStrings:(id)arg9 provideOptionsSelectorStrings:(id)arg10 resolutionResultClass:(Class)arg11 resolveSelectors:(SEL)arg12;	// IMP=0x00000000001af842
- (id)initWithName:(id)arg1 tag:(unsigned long long)arg2 facadePropertyName:(id)arg3 dataPropertyName:(id)arg4 valueType:(long long)arg5 valueStyle:(long long)arg6 isExtended:(_Bool)arg7 isPrivate:(_Bool)arg8 resolveSelectors:(SEL)arg9;	// IMP=0x00000000001af5f4
- (id)initWithName:(id)arg1 tag:(unsigned long long)arg2 facadePropertyName:(id)arg3 dataPropertyName:(id)arg4 isExtended:(_Bool)arg5 isPrivate:(_Bool)arg6 valueType:(long long)arg7 valueStyle:(long long)arg8 codableAttribute:(id)arg9 defaultValueSelectorStrings:(id)arg10 provideOptionsSelectorStrings:(id)arg11 resolutionResultClass:(Class)arg12 resolveSelectors:(SEL)arg13;	// IMP=0x00000000001af2ef
@property(readonly, nonatomic) _Bool isEnum;
- (id)localizeValue:(id)arg1 withLocalizer:(id)arg2;	// IMP=0x0000000000125f12
- (id)localizeValue:(id)arg1 forLanguage:(id)arg2;	// IMP=0x0000000000125e80
- (void)setValue:(id)arg1 forSlotComposer:(id)arg2;	// IMP=0x000000000024b095
- (id)valueForSlotComposer:(id)arg1;	// IMP=0x000000000024afd9
