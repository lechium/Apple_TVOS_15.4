...
- (void).cxx_destruct;	// IMP=0x000000000016ccf7
...
- (id)dictionaryRepresentation;	// IMP=0x000000000016cb68
- (id)descriptionAtIndent:(unsigned long long)arg1;	// IMP=0x000000000016ca8c
- (id)description;	// IMP=0x000000000016ca78
- (id)initWithParameter:(id)arg1 forIntent:(id)arg2 extensionContextResolutionResult:(id)arg3;	// IMP=0x000000000016c834
