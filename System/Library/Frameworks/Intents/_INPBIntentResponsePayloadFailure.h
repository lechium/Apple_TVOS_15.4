...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000243050
- (void).cxx_destruct;	// IMP=0x0000000000242d98
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000242c01
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000242917
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024283a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002427a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002426a9
- (void)writeTo:(id)arg1;	// IMP=0x00000000002425e3
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002425d6
