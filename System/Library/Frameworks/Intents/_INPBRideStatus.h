...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001f22da
+ (Class)waypointsType;	// IMP=0x00000000001f22c9
+ (Class)additionalActionItemsType;	// IMP=0x00000000001f22b8
- (void).cxx_destruct;	// IMP=0x00000000001f1a6a
...
- (id)dictionaryRepresentation;	// IMP=0x00000000001f1084
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001effa9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001efc3c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001efbaa
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001efaab
- (void)writeTo:(id)arg1;	// IMP=0x00000000001ef438
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001ef42b
- (id)waypointsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001ef40e
@property(readonly, nonatomic) unsigned long long waypointsCount;
- (void)addWaypoints:(id)arg1;	// IMP=0x00000000001ef377
- (void)clearWaypoints;	// IMP=0x00000000001ef35a
...
- (int)StringAsPhase:(id)arg1;	// IMP=0x00000000001ef114
- (id)phaseAsString:(int)arg1;	// IMP=0x00000000001ef076
...
- (id)additionalActionItemsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001eef09
@property(readonly, nonatomic) unsigned long long additionalActionItemsCount;
- (void)addAdditionalActionItems:(id)arg1;	// IMP=0x00000000001eee72
- (void)clearAdditionalActionItems;	// IMP=0x00000000001eee55
