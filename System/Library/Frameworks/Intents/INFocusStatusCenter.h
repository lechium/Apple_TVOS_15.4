...
+ (id)defaultCenter;	// IMP=0x00000000001e9673
- (void).cxx_destruct;	// IMP=0x00000000001e9562
@property(readonly, nonatomic) DNDAvailabilityService *service; // @synthesize service=_service;
- (void)requestAuthorizationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001e9545
@property(readonly, nonatomic) long long authorizationStatus;
@property(readonly, nonatomic) INFocusStatus *focusStatus;
- (id)init;	// IMP=0x00000000001e9232
