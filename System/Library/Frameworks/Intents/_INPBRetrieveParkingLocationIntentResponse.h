...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000042f38b
- (void).cxx_destruct;	// IMP=0x000000000042f14d
...
- (id)dictionaryRepresentation;	// IMP=0x000000000042f02f
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000042ed25
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000042ec66
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000042ebd4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000042ead5
- (void)writeTo:(id)arg1;	// IMP=0x000000000042e9f2
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000042e9e5
