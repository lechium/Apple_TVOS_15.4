...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003f0edc
- (void).cxx_destruct;	// IMP=0x00000000003f0b4b
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003f0842
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003f0147
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003effa8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003eff16
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003efe17
- (void)writeTo:(id)arg1;	// IMP=0x00000000003efc5f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003efc52
