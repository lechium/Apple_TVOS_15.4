...
- (void).cxx_destruct;	// IMP=0x00000000000bf6f9
@property(readonly, nonatomic) NSDictionary *securityScopedURLs; // @synthesize securityScopedURLs=_securityScopedURLs;
- (void)dealloc;	// IMP=0x00000000000bf6a6
- (void)relinquish;	// IMP=0x00000000000bf51f
- (void)acquire;	// IMP=0x00000000000bf37e
@property(readonly, nonatomic) NSSet *bundleIdentifiers;
- (id)initWithSecurityScopedURLs:(id)arg1;	// IMP=0x00000000000bf269
