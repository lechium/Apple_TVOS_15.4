...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003d7dd8
- (void).cxx_destruct;	// IMP=0x00000000003d7a38
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003d77db
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003d717a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d701e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003d6f8c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003d6e8d
- (void)writeTo:(id)arg1;	// IMP=0x00000000003d6c96
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003d6c89
