...
+ (void)initialize;	// IMP=0x0000000000396a08
- (void).cxx_destruct;	// IMP=0x00000000003969bf
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000396984
...
- (id)_initWithLaunchableAppBundleId:(id)arg1 displayableAppBundleId:(id)arg2 containingAppBundleURL:(id)arg3 extensionBundleId:(id)arg4;	// IMP=0x0000000000396644
