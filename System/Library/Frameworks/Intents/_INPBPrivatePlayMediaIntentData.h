...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000043ed0d
+ (Class)audioSearchResultsType;	// IMP=0x000000000043ecfc
- (void).cxx_destruct;	// IMP=0x000000000043e2d1
...
- (id)dictionaryRepresentation;	// IMP=0x000000000043d9f8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000043cd6e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000043ca10
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000043c97e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000043c87f
- (void)writeTo:(id)arg1;	// IMP=0x000000000043c398
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000043c38b
...
- (id)internalSignalAtIndex:(unsigned long long)arg1;	// IMP=0x000000000043c256
@property(readonly, nonatomic) unsigned long long internalSignalsCount;
- (void)addInternalSignal:(id)arg1;	// IMP=0x000000000043c1bf
- (void)clearInternalSignals;	// IMP=0x000000000043c1a2
...
- (id)audioSearchResultsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000043bfd4
@property(readonly, nonatomic) unsigned long long audioSearchResultsCount;
- (void)addAudioSearchResults:(id)arg1;	// IMP=0x000000000043bf3d
- (void)clearAudioSearchResults;	// IMP=0x000000000043bf20
