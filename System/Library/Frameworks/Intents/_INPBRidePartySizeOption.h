...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000027e212
- (void).cxx_destruct;	// IMP=0x000000000027df8a
...
- (id)dictionaryRepresentation;	// IMP=0x000000000027ddeb
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027d98f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000027d8a5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000027d813
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000027d714
- (void)writeTo:(id)arg1;	// IMP=0x000000000027d5f0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000027d5e3
