...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000018720
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000016c8c
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000015c3b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001587e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000157ec
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000156ed
- (void)writeTo:(id)arg1;	// IMP=0x0000000000015132
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000015125
@property(readonly, nonatomic) _Bool hasZone;
- (int)StringAsSubServiceType:(id)arg1;	// IMP=0x0000000000015048
- (id)subServiceTypeAsString:(int)arg1;	// IMP=0x0000000000014fc7
@property(nonatomic) _Bool hasSubServiceType;
- (int)StringAsServiceType:(id)arg1;	// IMP=0x0000000000014a30
- (id)serviceTypeAsString:(int)arg1;	// IMP=0x00000000000147a4
...
- (int)StringAsOuterDeviceType:(id)arg1;	// IMP=0x00000000000140cc
- (id)outerDeviceTypeAsString:(int)arg1;	// IMP=0x0000000000013dca
...
- (int)StringAsEntityType:(id)arg1;	// IMP=0x0000000000013b48
- (id)entityTypeAsString:(int)arg1;	// IMP=0x0000000000013aa1
@property(nonatomic) _Bool hasEntityType;
@property(readonly, nonatomic) _Bool hasEntityName;
- (id)entityIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000139fd
@property(readonly, nonatomic) unsigned long long entityIdentifiersCount;
- (void)addEntityIdentifiers:(id)arg1;	// IMP=0x0000000000013966
- (void)clearEntityIdentifiers;	// IMP=0x0000000000013949
- (int)StringAsDeviceType:(id)arg1;	// IMP=0x0000000000013318
- (id)deviceTypeAsString:(int)arg1;	// IMP=0x0000000000013016
