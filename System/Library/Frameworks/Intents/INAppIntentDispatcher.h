...
- (void).cxx_destruct;	// IMP=0x000000000039707f
@property(nonatomic) __weak id <INIntentDeliveringDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dispatchIntentForwardingAction:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000396df9
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000396d95
