...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a2a94
- (void).cxx_destruct;	// IMP=0x00000000000a20c0
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000a180a
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a049d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a0072
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009ffe0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009fee1
- (void)writeTo:(id)arg1;	// IMP=0x000000000009f8b8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000009f8ab
...
- (int)StringAsActiveConnector:(id)arg1;	// IMP=0x000000000009f474
- (id)activeConnectorAsString:(int)arg1;	// IMP=0x000000000009f3c2
