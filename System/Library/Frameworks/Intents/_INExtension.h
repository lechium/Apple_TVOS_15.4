...
+ (void)initialize;	// IMP=0x000000000006f91e
- (void).cxx_destruct;	// IMP=0x000000000006f3f6
@property(readonly, nonatomic) INExtensionContext *_extensionContext; // @synthesize _extensionContext;
- (id)handlerForIntent:(id)arg1;	// IMP=0x000000000006f3df
- (void)beginRequestWithExtensionContext:(id)arg1;	// IMP=0x000000000006f320
