...
+ (id)sharedManager;	// IMP=0x00000000000bf709
- (void).cxx_destruct;	// IMP=0x00000000000bf241
...
- (id)_stats;	// IMP=0x00000000000bf19b
- (id)_grantForBundleIdentifiers:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000beb7f
- (id)grantForBundleIdentifiers:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000beb14
- (id)grantForBundleIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000bea42
- (id)init;	// IMP=0x00000000000be9d3
