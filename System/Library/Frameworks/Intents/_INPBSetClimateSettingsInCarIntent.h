...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001851ec
- (void).cxx_destruct;	// IMP=0x000000000018498d
...
- (id)dictionaryRepresentation;	// IMP=0x00000000001841ce
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000183654
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000183376
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001832e4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001831e5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000182e8a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000182e7d
@property(readonly, nonatomic) _Bool hasTemperature;
- (int)StringAsRelativeTemperatureSetting:(id)arg1;	// IMP=0x0000000000182da0
- (id)relativeTemperatureSettingAsString:(int)arg1;	// IMP=0x0000000000182d22
@property(nonatomic) _Bool hasRelativeTemperatureSetting;
- (int)StringAsRelativeFanSpeedSetting:(id)arg1;	// IMP=0x0000000000182c10
- (id)relativeFanSpeedSettingAsString:(int)arg1;	// IMP=0x0000000000182b91
...
- (int)StringAsClimateZone:(id)arg1;	// IMP=0x00000000001827c8
- (id)climateZoneAsString:(int)arg1;	// IMP=0x00000000001826b4
@property(nonatomic) _Bool hasClimateZone;
@property(readonly, nonatomic) _Bool hasCarName;
- (int)StringAsAirCirculationMode:(id)arg1;	// IMP=0x00000000001825c6
- (id)airCirculationModeAsString:(int)arg1;	// IMP=0x0000000000182570
