...
- (void).cxx_destruct;	// IMP=0x00000000000d649b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d6433
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d6321
@property(readonly) unsigned long long hash;
- (id)slotDescriptions;	// IMP=0x00000000000d613d
- (id)slotByName:(id)arg1;	// IMP=0x00000000000d6070
- (id)initWithName:(id)arg1 responseName:(id)arg2 facadeClass:(Class)arg3 dataClass:(Class)arg4 type:(id)arg5 isPrivate:(_Bool)arg6 handleSelector:(SEL)arg7 confirmSelector:(SEL)arg8 slotsByName:(id)arg9;	// IMP=0x00000000000d5cb7
