...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003e7af8
- (void).cxx_destruct;	// IMP=0x00000000003e77e5
...
- (id)dictionaryRepresentation;	// IMP=0x00000000003e75b3
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003e70f8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003e6fde
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003e6f4c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003e6e4d
- (void)writeTo:(id)arg1;	// IMP=0x00000000003e6d18
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003e6d0b
- (int)StringAsEncodingFormat:(id)arg1;	// IMP=0x00000000003e6ca4
- (id)encodingFormatAsString:(int)arg1;	// IMP=0x00000000003e6c4e
