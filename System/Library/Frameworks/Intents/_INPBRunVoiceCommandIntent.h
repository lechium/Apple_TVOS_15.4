...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000279f90
- (void).cxx_destruct;	// IMP=0x0000000000279c14
...
- (id)dictionaryRepresentation;	// IMP=0x00000000002799a8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000279347
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002791eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000279159
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000027905a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000278e7e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000278e71
