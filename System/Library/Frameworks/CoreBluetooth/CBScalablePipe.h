...
- (void).cxx_destruct;	// IMP=0x000000000001fa20
...
- (id)description;	// IMP=0x000000000001f850
- (void)dealloc;	// IMP=0x000000000001f810
- (void)setOrphan;	// IMP=0x000000000001f7f0
- (id)initWithPipeManager:(id)arg1 info:(id)arg2;	// IMP=0x000000000001f1a0
