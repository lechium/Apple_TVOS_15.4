...
- (void).cxx_destruct;	// IMP=0x0000000000066240
...
- (void)peripheralManager:(id)arg1 didOpenL2CAPChannel:(id)arg2 error:(id)arg3;	// IMP=0x0000000000065b10
- (void)peripheralManager:(id)arg1 didUnpublishL2CAPChannel:(unsigned short)arg2 error:(id)arg3;	// IMP=0x0000000000065a60
- (void)peripheralManager:(id)arg1 didPublishL2CAPChannel:(unsigned short)arg2 error:(id)arg3;	// IMP=0x00000000000658f0
- (void)peripheralManagerDidUpdateState:(id)arg1;	// IMP=0x0000000000065810
- (void)pairingAgent:(id)arg1 peerDidUnpair:(id)arg2;	// IMP=0x0000000000065500
- (void)pairingAgent:(id)arg1 peerDidFailToCompletePairing:(id)arg2 error:(id)arg3;	// IMP=0x00000000000651a0
- (void)pairingAgent:(id)arg1 peerDidCompletePairing:(id)arg2;	// IMP=0x0000000000064e90
- (void)pairingAgent:(id)arg1 peerDidRequestPairing:(id)arg2 type:(long long)arg3 passkey:(id)arg4;	// IMP=0x0000000000064b10
- (void)pairingSetOOBEnabled:(_Bool)arg1 peer:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000646e0
- (void)pairingGenerateOOBDataForPeer:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000064230
- (void)_handleConnectionInvalidated:(id)arg1;	// IMP=0x0000000000064100
- (void)_startIfNeeded;	// IMP=0x0000000000064070
- (void)_invalidate;	// IMP=0x0000000000063d60
- (void)invalidate;	// IMP=0x0000000000063cf0
- (void)_activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000063990
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000638e0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000637f0
- (id)init;	// IMP=0x0000000000063770
