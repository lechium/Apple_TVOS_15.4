...
- (void).cxx_destruct;	// IMP=0x0000000000067570
...
- (void)_invalidated;	// IMP=0x00000000000673b0
- (void)_invalidate;	// IMP=0x0000000000067330
- (void)invalidate;	// IMP=0x00000000000672c0
- (void)_activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000671f0
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000067140
