...
- (void).cxx_destruct;	// IMP=0x000000000006e2a0
...
- (id)description;	// IMP=0x000000000006e010
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000006de70
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006dbe0
