...
- (void).cxx_destruct;	// IMP=0x000000000001afd0
...
- (id)handleDescriptorsDiscovered:(id)arg1;	// IMP=0x000000000001aa10
- (id)handleValueNotifying:(id)arg1;	// IMP=0x000000000001a9a0
- (id)handleValueBroadcasted:(id)arg1;	// IMP=0x000000000001a930
- (id)handleValueWritten:(id)arg1;	// IMP=0x000000000001a920
- (id)handleValueUpdated:(id)arg1;	// IMP=0x000000000001a860
- (void)invalidate;	// IMP=0x000000000001a6b0
- (id)description;	// IMP=0x000000000001a5c0
- (id)initWithService:(id)arg1 dictionary:(id)arg2;	// IMP=0x000000000001a3b0
