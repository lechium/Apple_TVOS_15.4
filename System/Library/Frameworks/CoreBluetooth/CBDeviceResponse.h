...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0000000000030340
- (id)description;	// IMP=0x0000000000030320
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x00000000000301e0
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002fea0
