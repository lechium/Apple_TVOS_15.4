...
- (void)writeWithRequest:(id)arg1;	// IMP=0x0000000000040e00
- (void)readWithRequest:(id)arg1;	// IMP=0x0000000000040c10
- (void)peripheral:(id)arg1 didOpenL2CAPChannel:(id)arg2 error:(id)arg3;	// IMP=0x0000000000040720
- (void)pairingAgent:(id)arg1 peerDidUnpair:(id)arg2;	// IMP=0x00000000000405b0
- (void)pairingAgent:(id)arg1 peerDidFailToCompletePairing:(id)arg2 error:(id)arg3;	// IMP=0x0000000000040320
- (void)pairingAgent:(id)arg1 peerDidCompletePairing:(id)arg2;	// IMP=0x00000000000400d0
- (void)pairingAgent:(id)arg1 peerDidRequestPairing:(id)arg2 type:(long long)arg3 passkey:(id)arg4;	// IMP=0x000000000003fb50
- (void)centralManager:(id)arg1 didFailToConnectPeripheral:(id)arg2 error:(id)arg3;	// IMP=0x000000000003f8c0
- (void)centralManager:(id)arg1 didConnectPeripheral:(id)arg2;	// IMP=0x000000000003f610
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000003f4a0
- (void)_completeWriteRequest:(id)arg1 error:(id)arg2;	// IMP=0x000000000003f370
- (void)_abortWritesWithError:(id)arg1;	// IMP=0x000000000003f060
- (_Bool)_prepareWriteRequest:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003ec40
- (void)_processWrites;	// IMP=0x000000000003e810
- (void)writeEndOfDataWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e700
- (void)writeWithCBWriteRequest:(id)arg1;	// IMP=0x000000000003e5b0
- (void)_completeReadRequest:(id)arg1 error:(id)arg2;	// IMP=0x000000000003e460
- (_Bool)_processReadStatus;	// IMP=0x000000000003e2f0
- (void)_abortReadsWithError:(id)arg1;	// IMP=0x000000000003dff0
- (void)_prepareReadRequest:(id)arg1;	// IMP=0x000000000003de50
- (void)_processReads:(_Bool)arg1;	// IMP=0x000000000003da50
- (void)readWithCBReadRequest:(id)arg1;	// IMP=0x000000000003d910
- (void)_pairWithOOBData:(id)arg1;	// IMP=0x000000000003d570
- (void)pairWithOOBData:(id)arg1;	// IMP=0x000000000003d4c0
- (void)pairingPerformAction:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003d200
- (void)_pairingSetOOBEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003cd90
- (void)pairingSetOOBEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ccc0
- (void)_pairingGenerateOOBDataWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000003c730
- (void)pairingGenerateOOBDataWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000003c680
- (_Bool)_runSetupChannel;	// IMP=0x000000000003c610
- (_Bool)_runConnectStart;	// IMP=0x000000000003c1c0
- (void)_run;	// IMP=0x000000000003bea0
- (void)_reportError:(id)arg1;	// IMP=0x000000000003bd50
- (_Bool)_setupIOAndReturnError:(id *)arg1;	// IMP=0x000000000003b990
- (_Bool)_startConnectingAndReturnError:(id *)arg1;	// IMP=0x000000000003b820
- (void)xpcReceivedPairingPrompt:(id)arg1;	// IMP=0x000000000003b630
- (void)xpcReceivedPairingCompleted:(id)arg1;	// IMP=0x000000000003b3f0
- (void)_xpcReceivedMessage:(id)arg1;	// IMP=0x000000000003b2b0
- (void)xpcReceivedMessage:(id)arg1;	// IMP=0x000000000003b030
- (void)xpcReceivedForwardedEvent:(id)arg1;	// IMP=0x000000000003aed0
- (void)xpcForwardMessage:(id)arg1;	// IMP=0x000000000003ad00
- (void)_invalidated;	// IMP=0x000000000003ab10
- (void)_invalidate;	// IMP=0x000000000003a920
- (void)invalidate;	// IMP=0x000000000003a8b0
- (void)_interrupted;	// IMP=0x000000000003a820
- (id)_ensureXPCStarted;	// IMP=0x000000000003a6d0
- (void)disconnectWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003a520
- (void)_activateXPCCompleted:(id)arg1;	// IMP=0x000000000003a380
- (void)_activateXPCStart:(_Bool)arg1;	// IMP=0x000000000003a1f0
- (_Bool)activateDirectAndReturnError:(id *)arg1;	// IMP=0x0000000000039b30
- (void)_activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000039750
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000396a0
@property(readonly, copy) NSString *description;
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x0000000000038f80
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000038cc0
- (void)dealloc;	// IMP=0x0000000000038c40
- (id)init;	// IMP=0x0000000000038ba0
