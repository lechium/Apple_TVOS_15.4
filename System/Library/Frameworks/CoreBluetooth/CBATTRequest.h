...
- (void).cxx_destruct;	// IMP=0x0000000000053ac0
...
- (id)description;	// IMP=0x00000000000539b0
- (void)appendValueData:(id)arg1;	// IMP=0x0000000000053920
- (unsigned long long)endOffset;	// IMP=0x00000000000538f0
- (id)initWithCentral:(id)arg1 characteristic:(id)arg2 offset:(unsigned long long)arg3 transactionID:(id)arg4;	// IMP=0x0000000000053810
