...
- (void).cxx_destruct;	// IMP=0x0000000000031020
...
- (id)description;	// IMP=0x0000000000030ea0
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x0000000000030dc0
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000030ba0
