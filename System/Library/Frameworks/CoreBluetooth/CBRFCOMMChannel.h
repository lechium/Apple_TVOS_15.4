...
- (void).cxx_destruct;	// IMP=0x0000000000014820
...
- (id)description;	// IMP=0x00000000000146a0
- (void)configureChannelPortParams:(unsigned int)arg1 dataBits:(unsigned char)arg2 parity:(unsigned char)arg3 stopBits:(unsigned char)arg4;	// IMP=0x0000000000014430
- (void)dealloc;	// IMP=0x00000000000143d0
- (id)initWithPeer:(id)arg1 info:(id)arg2;	// IMP=0x0000000000014080
