...
+ (void)_invalidateStaticCaches;	// IMP=0x0000000000211ac7
+ (id)defaultRecordZoneIDForDatabaseScope:(long long)arg1;	// IMP=0x00000000002118ed
+ (void)initialize;	// IMP=0x0000000000207a93
- (void).cxx_destruct;	// IMP=0x0000000000211afe
- (void)dealloc;	// IMP=0x0000000000207bb2
- (id)initWithMirroringOptions:(id)arg1 metadataCache:(id)arg2 recordNamePrefix:(id)arg3;	// IMP=0x0000000000207b12
