...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000004e16
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005035
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004e1e
- (void)dealloc;	// IMP=0x0000000000004db2
- (id)initForRequest:(id)arg1;	// IMP=0x0000000000004c87
