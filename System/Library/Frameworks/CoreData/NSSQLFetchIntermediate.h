...
- (id)fetchIntermediateForKeypathExpression:(id)arg1;	// IMP=0x000000000017153d
- (id)generateSQLStringInContext:(id)arg1;	// IMP=0x0000000000170f07
- (id)selectIntermediate;	// IMP=0x00000000001705f9
- (_Bool)isFunctionScoped;	// IMP=0x0000000000170589
- (id)fetchIntermediate;	// IMP=0x0000000000170580
- (void)dealloc;	// IMP=0x00000000001704bb
- (id)initWithScope:(id)arg1;	// IMP=0x0000000000170451
