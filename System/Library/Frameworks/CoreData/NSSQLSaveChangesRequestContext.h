...
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002727a4
- (void)executeEpilogue;	// IMP=0x00000000002719c7
- (void)executePrologue;	// IMP=0x000000000027196f
- (_Bool)isWritingRequest;	// IMP=0x0000000000271967
- (id)rowCache;	// IMP=0x0000000000271956
- (void)dealloc;	// IMP=0x00000000002717f2
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000271638
