...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f8404
- (id)copy;	// IMP=0x00000000001f83c0
- (void)dealloc;	// IMP=0x00000000001f8334
- (id)initWithOptions:(id)arg1 monitor:(id)arg2 assetStorageURL:(id)arg3 workQueue:(id)arg4 andDatabase:(id)arg5;	// IMP=0x00000000001f8290
