...
- (void)finishedActivity:(id)arg1 withResult:(id)arg2 inManagedObjectContext:(id)arg3;	// IMP=0x0000000000144ae0
- (oneway void)handleMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000141cd4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000141bb6
- (void)tearDown;	// IMP=0x0000000000141b1d
- (void)setUp;	// IMP=0x000000000014178b
- (void)dealloc;	// IMP=0x0000000000141707
- (id)initWithListener:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000014160d
