...
- (void)dealloc;	// IMP=0x000000000006e109
- (id)initWithSubresults:(id)arg1;	// IMP=0x000000000006dca0
- (id)initWithResult:(id)arg1 ofType:(long long)arg2;	// IMP=0x000000000006dc37
