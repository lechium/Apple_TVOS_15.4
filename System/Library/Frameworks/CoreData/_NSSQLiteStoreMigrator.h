...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x00000000001f8442
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x00000000001f8418
...
- (void)dealloc;	// IMP=0x00000000001f87a8
