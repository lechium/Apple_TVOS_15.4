...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000489c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000498b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000048a4
- (void)dealloc;	// IMP=0x0000000000004859
- (id)initForRequest:(id)arg1;	// IMP=0x00000000000047cc
