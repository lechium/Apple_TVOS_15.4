...
+ (id)eventTypeString:(long long)arg1;	// IMP=0x00000000000f1db6
...
- (id)description;	// IMP=0x00000000000f1c9a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f1c3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f1c31
- (void)dealloc;	// IMP=0x00000000000f1bbc
- (id)initWithCKEvent:(id)arg1;	// IMP=0x00000000000f1a4a
