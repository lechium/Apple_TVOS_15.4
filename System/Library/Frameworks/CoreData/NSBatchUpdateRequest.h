...
+ (id)batchUpdateRequestWithEntityName:(id)arg1;	// IMP=0x0000000000126074
+ (id)decodeFromXPCArchive:(id)arg1 withContext:(id)arg2 withPolicy:(id)arg3;	// IMP=0x000000000000441f
...
- (void)_resolveEntityWithContext:(id)arg1;	// IMP=0x0000000000126a14
...
- (unsigned long long)requestType;	// IMP=0x0000000000126318
@property(readonly) NSEntityDescription *entity; // @synthesize entity=_entity;
@property(readonly, copy) NSString *entityName;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000012616b
- (id)initWithEntity:(id)arg1;	// IMP=0x0000000000126130
- (id)initWithEntityName:(id)arg1;	// IMP=0x00000000001260ea
- (id)init;	// IMP=0x00000000001260a3
- (id)encodeForXPC;	// IMP=0x00000000000042e6
- (_Bool)shouldPerformSecureOperation;	// IMP=0x0000000000127422
- (void)setShouldPerformSecureOperation:(_Bool)arg1;	// IMP=0x0000000000127410
