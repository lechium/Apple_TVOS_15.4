...
+ (id)migrationStoreOptionsFromStoreOptions:(id)arg1;	// IMP=0x00000000001e31e3
+ (id)destinationURLForMigrationSourceURL:(id)arg1 createDocumentReplacementDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00000000001e4595
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x00000000001e4471
+ (int)migrationDebugLevel;	// IMP=0x00000000001e4458
- (id)migrateStoreAtURL:(id)arg1 withManager:(id)arg2 metadata:(id)arg3 options:(id)arg4 error:(id *)arg5;	// IMP=0x00000000001e4311
- (id)createMigrationManagerForSourceModel:(id)arg1 destinationModel:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001e418f
- (id)sourceModelForStoreAtURL:(id)arg1 metadata:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001e396c
- (void)dealloc;	// IMP=0x00000000001e3344
