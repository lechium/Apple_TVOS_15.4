...
+ (id)recordFromEncodedData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003ead8
+ (id)encodeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003ea00
+ (id)insertMetadataForObject:(id)arg1 setRecordName:(_Bool)arg2 inZoneWithID:(id)arg3 recordNamePrefix:(id)arg4 error:(id *)arg5;	// IMP=0x000000000003ceb5
+ (id)entityPath;	// IMP=0x0000000000039ece
- (_Bool)mergeMoveReceiptsWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003e419
- (id)createEncodedMoveReceiptData:(id *)arg1;	// IMP=0x000000000003e319
- (id)createRecordFromSystemFields;	// IMP=0x000000000003a0a9
