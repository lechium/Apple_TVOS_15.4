...
- (void)dealloc;	// IMP=0x000000000021ced8
- (id)initWithRequest:(id)arg1 acceptedShares:(id)arg2 acceptedShareMetadatas:(id)arg3 error:(id)arg4;	// IMP=0x000000000021cd75
