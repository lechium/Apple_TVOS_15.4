...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001306fd
- (void)dealloc;	// IMP=0x00000000001306b3
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x000000000013064a
