...
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x000000000022b9cf
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000229511
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000002293f1
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x000000000022933c
