...
- (id)description;	// IMP=0x00000000001223c2
- (void)updateWithChange:(id)arg1;	// IMP=0x00000000001222ee
- (void)dealloc;	// IMP=0x000000000012227c
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x000000000012216e
