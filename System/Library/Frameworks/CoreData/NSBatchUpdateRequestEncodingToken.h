...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003da3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003fdc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003dab
- (void)dealloc;	// IMP=0x0000000000003d3f
- (id)initForRequest:(id)arg1;	// IMP=0x0000000000003a58
