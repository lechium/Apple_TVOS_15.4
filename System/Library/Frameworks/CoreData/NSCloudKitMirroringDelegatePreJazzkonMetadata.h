...
- (void).cxx_destruct;	// IMP=0x000000000029b863
- (id)description;	// IMP=0x000000000029a810
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000029a642
- (void)dealloc;	// IMP=0x000000000029a5d3
- (id)initWithStore:(id)arg1;	// IMP=0x000000000029a581
