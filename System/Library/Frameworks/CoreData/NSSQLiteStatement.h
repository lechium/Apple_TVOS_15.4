...
- (id)bindIntarrays;	// IMP=0x00000000001d81d3
- (id)bindVariables;	// IMP=0x00000000001d8100
- (id)sqlString;	// IMP=0x00000000001d80bc
- (id)entity;	// IMP=0x00000000001d80b2
- (void)dealloc;	// IMP=0x00000000001d8033
- (id)initWithEntity:(id)arg1;	// IMP=0x00000000001d7fb8
- (id)description;	// IMP=0x00000000001d7f46
- (id)initWithEntity:(id)arg1 sqlString:(id)arg2;	// IMP=0x00000000001d7ee4
