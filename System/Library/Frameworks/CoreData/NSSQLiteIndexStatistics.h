...
- (void)dealloc;	// IMP=0x000000000027ce5a
- (id)init;	// IMP=0x000000000027ce54
- (id)initWithResultDictionary:(id)arg1 storeID:(id)arg2;	// IMP=0x000000000027cd94
- (id)initWithName:(id)arg1 storeID:(id)arg2;	// IMP=0x000000000027cd1a
