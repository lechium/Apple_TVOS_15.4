...
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000226aca
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x00000000002268d8
...
- (void)dealloc;	// IMP=0x00000000002267fe
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x00000000002265e8
