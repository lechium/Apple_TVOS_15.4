...
- (void)dealloc;	// IMP=0x00000000002130c5
- (id)description;	// IMP=0x0000000000213062
- (unsigned long long)requestType;	// IMP=0x0000000000213057
- (id)initWithFetchRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000212fa1
