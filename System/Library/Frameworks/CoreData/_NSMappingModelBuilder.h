...
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x000000000004eb98
+ (int)migrationDebugLevel;	// IMP=0x000000000004eb7f
- (void)dealloc;	// IMP=0x000000000004ec1a
- (id)initWithSourceModel:(id)arg1 destinationModel:(id)arg2;	// IMP=0x000000000004ebb1
