...
+ (id)entityPath;	// IMP=0x0000000000146e8e
+ (id)fetchZoneIDsAssignedToObjectsWithIDs:(id)arg1 fromStore:(id)arg2 inContext:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000146928
