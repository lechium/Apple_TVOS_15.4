...
- (void).cxx_destruct;	// IMP=0x0000000000150b68
...
- (void)presentAtTime:(double)arg1;	// IMP=0x0000000000150a36
- (void)present;	// IMP=0x00000000001509b4
@property(readonly) id <MTLTexture> texture;
- (id)cachedTexture;	// IMP=0x0000000000150970
- (struct _CAMetalDrawablePrivate *)priv;	// IMP=0x0000000000150966
- (void)dealloc;	// IMP=0x0000000000150812
- (void)releasePrivateReferences:(void *)arg1;	// IMP=0x00000000001507d2
- (id)initWithDrawablePrivate:(struct _CAMetalDrawablePrivate *)arg1 layer:(id)arg2;	// IMP=0x00000000001506e7
- (void)didScheduledPresent;	// IMP=0x00000000001505d4
- (void)addPresentScheduledHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001505c3
