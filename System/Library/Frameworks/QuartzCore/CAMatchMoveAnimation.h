...
+ (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000001c354e
...
- (_Bool)CA_validateValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000001c4207
- (unsigned int)_propertyFlagsForLayer:(id)arg1;	// IMP=0x00000000001c41e0
- (void *)_copyRenderAnimationForLayer:(id)arg1;	// IMP=0x00000000001c411e
- (_Bool)_setCARenderAnimation:(void *)arg1 layer:(id)arg2;	// IMP=0x00000000001c3e53
- (void)applyForTime:(double)arg1 presentationObject:(id)arg2 modelObject:(id)arg3;	// IMP=0x00000000001c35da
