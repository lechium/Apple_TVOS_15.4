...
- (void)dealloc;	// IMP=0x0000000000022a40
- (void)addTransition:(id)arg1;	// IMP=0x0000000000022a03
- (void)willAddLayer:(id)arg1;	// IMP=0x00000000000229fd
- (void)addElement:(id)arg1;	// IMP=0x00000000000229c0
