...
- (void)dealloc;	// IMP=0x000000000000df2c
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000000de9c
- (void)invalidate;	// IMP=0x000000000000dca5
- (void)removeAnimationFromLayer:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000000dc44
- (void)addAnimation:(id)arg1;	// IMP=0x000000000000dc07
- (id)init;	// IMP=0x000000000000dba9
