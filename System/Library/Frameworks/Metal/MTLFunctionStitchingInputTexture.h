...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000097d9f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000097d69
- (id)initWithBindIndex:(unsigned long long)arg1;	// IMP=0x0000000000097d31
