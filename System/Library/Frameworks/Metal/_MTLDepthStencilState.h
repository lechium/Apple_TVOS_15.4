...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000095e2f
- (void)dealloc;	// IMP=0x0000000000095de5
- (id)initWithDevice:(id)arg1 depthStencilDescriptor:(id)arg2;	// IMP=0x0000000000095a96
