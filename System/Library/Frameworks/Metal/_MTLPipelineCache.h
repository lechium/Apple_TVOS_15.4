...
- (void)write;	// IMP=0x0000000000042407
@property(readonly) struct MTLCompilerCache *cache; // @synthesize cache=_compilerCache;
- (void)dealloc;	// IMP=0x00000000000423b5
- (id)initWithFilePath:(id)arg1 readOnly:(_Bool)arg2 deviceInfo:(const struct MTLTargetDeviceArch *)arg3;	// IMP=0x00000000000422fc
