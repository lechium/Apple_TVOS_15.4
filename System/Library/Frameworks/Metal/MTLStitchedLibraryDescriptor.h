...
- (id)description;	// IMP=0x0000000000097998
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000976f3
- (void)dealloc;	// IMP=0x00000000000976a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009763d
- (id)init;	// IMP=0x00000000000975ef
