...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009b4c5
+ (id)alloc;	// IMP=0x000000000009b4bb
- (unsigned long long)hash;	// IMP=0x000000000009b5e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009b530
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009b4b3
