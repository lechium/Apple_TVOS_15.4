...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000097bdf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000097b79
- (id)initWithBindIndex:(unsigned long long)arg1 byteOffset:(unsigned long long)arg2 dereference:(_Bool)arg3;	// IMP=0x0000000000097b64
- (id)initWithBindIndex:(unsigned long long)arg1;	// IMP=0x0000000000097b20
