...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003cf5
+ (id)alloc;	// IMP=0x0000000000003ceb
- (unsigned long long)hash;	// IMP=0x0000000000003e14
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003d60
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003ce3
