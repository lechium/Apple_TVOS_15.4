...
- (id)description;	// IMP=0x0000000000024556
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000243ed
- (id)describe;	// IMP=0x0000000000024360
- (void)dealloc;	// IMP=0x0000000000024319
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x000000000002429b
