...
- (id)description;	// IMP=0x0000000000018337
- (void)dealloc;	// IMP=0x00000000000182e4
- (id)initWithData:(id)arg1 importedSymbols:(id)arg2 importedLibraries:(id)arg3;	// IMP=0x000000000001826c
