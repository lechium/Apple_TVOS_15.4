...
+ (id)argumentDescriptor;	// IMP=0x0000000000031628
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000315b5
+ (id)alloc;	// IMP=0x00000000000315ab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000031620
