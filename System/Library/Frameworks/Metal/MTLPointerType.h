...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000080017
+ (id)alloc;	// IMP=0x000000000008000d
- (id)elementArrayType;	// IMP=0x000000000008008a
- (id)elementStructType;	// IMP=0x0000000000080082
