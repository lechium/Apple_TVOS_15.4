...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000097a79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000097a43
- (id)initWithBindIndex:(unsigned long long)arg1;	// IMP=0x0000000000097a0b
