...
@class MTLBinaryArchiveDescriptor, MTLBufferDescriptor, MTLCommandQueueDescriptor, MTLComputePipelineDescriptor, MTLFunction, MTLIndirectCommandBufferDescriptor, MTLRenderPipelineDescriptor, MTLStitchedLibraryDescriptor, MTLStitchedLibraryDescriptorSPI, MTLStructType, MTLTargetDeviceArchitecture, MTLTextureDescriptor, MTLTileRenderPipelineDescriptor, NSArray, NSData, NSDictionary, NSMutableDictionary, NSObject, NSString, NSURL, _MTLIndirectArgumentBufferLayout;
@protocol MTLArgumentEncoder, MTLBinaryArchive, MTLBuffer, MTLCommandQueue, MTLComputePipelineState, MTLDeserializationContext, MTLDevice, MTLDeviceSPI, MTLDynamicLibrary, MTLFunction, MTLIndirectArgumentEncoder, MTLIndirectComputeCommandEncoder, MTLIndirectRenderCommandEncoder, MTLLateEvalEvent, MTLLibrary, MTLPipelineLibrarySPI, MTLRenderPipelineState, MTLResourceGroupSPI, MTLSharedEvent, MTLTexture, MTLTextureLayout, OS_dispatch_data;
