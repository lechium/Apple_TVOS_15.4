...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007bdbf
+ (id)alloc;	// IMP=0x000000000007bdb5
@property(copy, nonatomic) NSArray *insertLibraries; // @synthesize insertLibraries=_insertLibraries;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007be30
- (void)reset;	// IMP=0x000000000007be2a
