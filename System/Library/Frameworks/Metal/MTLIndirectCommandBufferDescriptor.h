...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042247
- (unsigned long long)hash;	// IMP=0x0000000000042231
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000421e0
- (id)init;	// IMP=0x00000000000421ad
