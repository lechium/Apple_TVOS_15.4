...
+ (id)textureBufferDescriptorWithPixelFormat:(unsigned long long)arg1 width:(unsigned long long)arg2 resourceOptions:(unsigned long long)arg3 usage:(unsigned long long)arg4;	// IMP=0x000000000003f97e
+ (id)textureCubeDescriptorWithPixelFormat:(unsigned long long)arg1 size:(unsigned long long)arg2 mipmapped:(_Bool)arg3;	// IMP=0x000000000003f8ca
+ (id)texture2DDescriptorWithPixelFormat:(unsigned long long)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3 mipmapped:(_Bool)arg4;	// IMP=0x000000000003f807
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003f792
+ (id)alloc;	// IMP=0x000000000003f788
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003f7fd
