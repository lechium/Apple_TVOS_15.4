...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000415c7
- (void).cxx_destruct;	// IMP=0x0000000000044dea
...
- (id)debugDescription;	// IMP=0x00000000000443bc
- (id)description;	// IMP=0x000000000004435a
@property(copy, nonatomic) NSDictionary *options;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000043095
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000042777
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004227d
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x0000000000041be6
- (id)xpc_dictionary;	// IMP=0x0000000000041750
...
- (id)initWithQoS:(unsigned int)arg1;	// IMP=0x000000000004150c
- (id)init;	// IMP=0x000000000004149d
