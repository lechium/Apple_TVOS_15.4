...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000027872
+ (id)actionFromUserActivity:(id)arg1 searchableItem:(id)arg2;	// IMP=0x0000000000028c5d
- (void).cxx_destruct;	// IMP=0x000000000002833f
...
- (void)updateWithUserAction:(id)arg1;	// IMP=0x0000000000027fc1
- (id)debugDescription;	// IMP=0x0000000000027f2c
- (id)description;	// IMP=0x0000000000027ea1
- (id)_propertiesDescription;	// IMP=0x00000000000279a0
- (unsigned long long)hash;	// IMP=0x000000000002798a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002787a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000027745
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpc_dictionary;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000026ec9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000026d3b
- (void)encodeWithCSCoder:(id)arg1;	// IMP=0x00000000000224e5
- (id)initWithUserActivity:(id)arg1 searchableItem:(id)arg2;	// IMP=0x00000000000288c5
- (id)initWithXPCDict:(id)arg1;	// IMP=0x00000000000283b4
