...
- (void).cxx_destruct;	// IMP=0x0000000000057b55
...
- (void)saveState:(id)arg1;	// IMP=0x0000000000057a9d
- (void)handlePreferencesChanged;	// IMP=0x00000000000579dc
- (void)dealloc;	// IMP=0x000000000005799f
- (_Bool)notifyStart;	// IMP=0x0000000000057788
