...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003ce99
- (void).cxx_destruct;	// IMP=0x000000000003d926
...
- (id)description;	// IMP=0x000000000003d2f0
- (unsigned long long)hash;	// IMP=0x000000000003d295
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003cea1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003cd97
- (id)xpc_dictionary;	// IMP=0x000000000003cb9d
- (id)initWithXPCDict:(id)arg1;	// IMP=0x000000000003c8ea
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003c494
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003c344
- (id)initWithJobType:(long long)arg1;	// IMP=0x000000000003c330
- (id)initWithJobType:(long long)arg1 jobOptions:(long long)arg2;	// IMP=0x000000000003c2e8
