...
- (void).cxx_destruct;	// IMP=0x0000000000038fed
...
- (void)_didFinishWithError:(id)arg1;	// IMP=0x0000000000038d23
- (void)_didReturnItems:(id)arg1;	// IMP=0x0000000000038c72
@property unsigned long long status;
- (void)cancel;	// IMP=0x0000000000038ab2
- (void)start;	// IMP=0x00000000000388ff
@property(readonly, copy) NSDictionary *options;
- (id)queryString;	// IMP=0x00000000000388d3
- (id)initWithQueryString:(id)arg1 options:(id)arg2;	// IMP=0x0000000000038642
- (id)initWithPredicate:(id)arg1 options:(id)arg2;	// IMP=0x000000000003858e
