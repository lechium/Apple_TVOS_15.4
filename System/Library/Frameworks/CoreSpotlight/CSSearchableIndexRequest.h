...
+ (void)initialize;	// IMP=0x00000000000511ae
- (void).cxx_destruct;	// IMP=0x0000000000052456
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000005223e
- (void)start;	// IMP=0x0000000000052178
- (void)_finishWithError:(id)arg1;	// IMP=0x0000000000051d05
- (void)_perform;	// IMP=0x0000000000051c9b
- (void)retryIfNecessaryWithError:(id)arg1;	// IMP=0x0000000000051c22
- (void)retryIfNecessaryWithError:(id)arg1 dataWrapper:(id)arg2;	// IMP=0x0000000000051709
- (void)_unthrottleIfNecessary;	// IMP=0x00000000000516de
- (void)_throttleIfNecessary;	// IMP=0x00000000000516b3
- (id)description;	// IMP=0x0000000000051368
- (void)dealloc;	// IMP=0x00000000000512d6
- (id)initWithSearchableIndex:(id)arg1 label:(id)arg2;	// IMP=0x00000000000511f5
