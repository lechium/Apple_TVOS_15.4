...
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002070f
- (unsigned long long)count;	// IMP=0x00000000000206e4
- (id)initWithItems:(id)arg1 itemsContent:(id)arg2;	// IMP=0x0000000000020562
- (id)initWithItems:(id)arg1;	// IMP=0x00000000000204f4
