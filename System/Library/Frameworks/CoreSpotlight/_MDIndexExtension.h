...
- (void).cxx_destruct;	// IMP=0x0000000000008537
...
- (void)performJob:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081f3
- (void)_performJob:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007508
- (_Bool)_verifyIntegrityWithHostContext:(id)arg1;	// IMP=0x0000000000007330
...
- (id)description;	// IMP=0x0000000000006bfc
- (id)initWithExtension:(id)arg1 queue:(id)arg2 containerPath:(id)arg3 containerID:(id)arg4 supportedFileTypes:(id)arg5 extensionLabel:(id)arg6;	// IMP=0x00000000000068ba
- (id)initWithExtension:(id)arg1 queue:(id)arg2 containerPath:(id)arg3 containerID:(id)arg4;	// IMP=0x0000000000006898
