...
- (void).cxx_destruct;	// IMP=0x000000000004f595
...
- (void)stopLookingForExtensions;	// IMP=0x000000000004f33b
- (void)startLookingForExtensionsWithMatchUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000004ee36
- (void)findExtensionsWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000004eb75
- (id)init;	// IMP=0x000000000004eb46
