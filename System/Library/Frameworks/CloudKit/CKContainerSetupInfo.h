...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000010a35b
- (void).cxx_destruct;	// IMP=0x000000000010a7bb
...
- (id)hashString;	// IMP=0x000000000010a67d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010a5ae
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010a41e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000010a363
