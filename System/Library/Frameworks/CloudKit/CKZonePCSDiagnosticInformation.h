...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004cb74
- (void).cxx_destruct;	// IMP=0x000000000004cdf8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004cc80
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004cb7c
