...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000146e32
- (void).cxx_destruct;	// IMP=0x000000000014832a
...
- (id)CKDescriptionPropertiesWithPublic:(_Bool)arg1 private:(_Bool)arg2 shouldExpand:(_Bool)arg3;	// IMP=0x0000000000147f34
- (id)description;	// IMP=0x0000000000147f22
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000147a46
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001472f1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000146e3a
...
- (void)setApplicationBundleIdentifierOverride:(id)arg1;	// IMP=0x0000000000146d85
...
- (id)resolveAgainstGenericConfiguration:(id)arg1;	// IMP=0x0000000000145a18
- (id)init;	// IMP=0x00000000001459bc
