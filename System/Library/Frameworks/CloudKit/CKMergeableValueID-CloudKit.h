...
- (id)initWithName:(id)arg1 recordID:(id)arg2 fieldName:(id)arg3 encrypted:(_Bool)arg4;	// IMP=0x0000000000129904
- (id)initWithName:(id)arg1 zoneID:(id)arg2;	// IMP=0x00000000001297d3
@end
