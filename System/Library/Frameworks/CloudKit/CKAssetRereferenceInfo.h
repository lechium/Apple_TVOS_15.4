...
- (void).cxx_destruct;	// IMP=0x00000000000a1c22
...
- (id)description;	// IMP=0x00000000000a1b09
- (id)CKDescriptionPropertiesWithPublic:(_Bool)arg1 private:(_Bool)arg2 shouldExpand:(_Bool)arg3;	// IMP=0x00000000000a16c4
- (id)initWithSourceZoneID:(id)arg1;	// IMP=0x00000000000a1651
