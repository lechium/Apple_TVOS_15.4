...
- (id)dictionaryPropertyEncoding;	// IMP=0x000000000017bd5c
@property(readonly, nonatomic) NSSet *propertyNamesNotToEncode;
@property(readonly, nonatomic) CKObjCClass *objcClass;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017baed
@property(readonly) unsigned long long hash;
- (id)initWithPropertyDictionary:(id)arg1;	// IMP=0x000000000017b844
