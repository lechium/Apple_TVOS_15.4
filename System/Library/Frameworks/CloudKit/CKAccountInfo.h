...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000035c6
+ (void)invalidateCachedAccountInfo;	// IMP=0x0000000000002dc3
...
- (unsigned long long)hash;	// IMP=0x000000000000393d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003815
- (id)CKPropertiesDescription;	// IMP=0x00000000000035e0
- (id)description;	// IMP=0x00000000000035ce
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003518
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003433
- (id)init;	// IMP=0x00000000000032f1
