...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000134771
- (void).cxx_destruct;	// IMP=0x00000000001351bb
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000134a12
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000134779
- (id)init;	// IMP=0x0000000000134727
