...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000052767
- (void).cxx_destruct;	// IMP=0x0000000000052b37
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000052829
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005276f
