...
+ (unsigned long long)maxZonesPerOperation;	// IMP=0x0000000000106fe5
+ (void)setMaxZonesPerOperation:(unsigned long long)arg1;	// IMP=0x0000000000106fd8
- (void).cxx_destruct;	// IMP=0x0000000000107271
...
- (void)fetchRecordZoneChanges;	// IMP=0x00000000001061b5
- (void)fetchDatabaseChangesThenRecordZoneChanges;	// IMP=0x0000000000105cbe
- (void)start;	// IMP=0x0000000000105b1a
- (id)cancelledError;	// IMP=0x0000000000105af3
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000105985
- (void)cancel;	// IMP=0x000000000010569b
- (void)transitionToFinished;	// IMP=0x0000000000105687
- (void)transitionToExecuting;	// IMP=0x0000000000105673
- (_Bool)isExecuting;	// IMP=0x0000000000105633
- (_Bool)isFinished;	// IMP=0x00000000001055f3
- (_Bool)isAsynchronous;	// IMP=0x00000000001055eb
- (id)init;	// IMP=0x000000000010556f
- (id)initWithDatabase:(id)arg1;	// IMP=0x0000000000105437
