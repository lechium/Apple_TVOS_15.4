...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d2ba5
- (void).cxx_destruct;	// IMP=0x00000000000d30d3
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d2d97
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d2bad
- (id)init;	// IMP=0x00000000000d2b66
