...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a6127
+ (_Bool)_templateURLRequiresAssetKey:(id)arg1;	// IMP=0x00000000000a5f2f
+ (id)_canonicalizeTemplateURL:(id)arg1;	// IMP=0x00000000000a5e4f
+ (id)_expandTemplateURL:(id)arg1 fieldValues:(id)arg2;	// IMP=0x00000000000a5a03
+ (id)getFileMetadataAtPath:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000a58e5
+ (id)getFileMetadataWithFileHandle:(id)arg1 openInfo:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000a5494
+ (id)getFileSizeWithOpenInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000a53ef
+ (id)openWithOpenInfo:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000a4f04
+ (id)_openUnencryptedWithOpenInfo:(id)arg1 genCountCheck:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00000000000a4241
+ (int)errorCodeFromPOSIXCode:(int)arg1;	// IMP=0x00000000000a4203
+ (id)assetWithFileURL:(id)arg1;	// IMP=0x00000000000a2b07
- (void).cxx_destruct;	// IMP=0x00000000000a70e9
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a6424
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a612f
@property(copy, nonatomic) NSURL *nullableFileURL;
- (id)downloadURL;	// IMP=0x00000000000a6067
- (id)downloadURLWithFileName:(id)arg1;	// IMP=0x00000000000a5f4b
- (id)openWithError:(id *)arg1;	// IMP=0x00000000000a5227
@property(readonly, copy) NSString *description;
- (id)CKDescriptionPropertiesWithPublic:(_Bool)arg1 private:(_Bool)arg2 shouldExpand:(_Bool)arg3;	// IMP=0x00000000000a31fd
- (_Bool)isConstructedAsset;	// IMP=0x00000000000a31ca
- (_Bool)isRereferencedAssetUpload;	// IMP=0x00000000000a31b9
- (id)assetHandleUUID;	// IMP=0x00000000000a31ab
- (id)initWithAssetContent:(id)arg1 itemTypeHint:(id)arg2;	// IMP=0x00000000000a305b
- (id)initWithCopyInfo:(id)arg1 fileURL:(id)arg2;	// IMP=0x00000000000a2f32
- (id)initWithFileDescriptor:(int)arg1;	// IMP=0x00000000000a2e73
- (id)initWithDeviceID:(id)arg1 fileID:(id)arg2 generationID:(id)arg3;	// IMP=0x00000000000a2b58
- (id)initWithAssetReference:(id)arg1;	// IMP=0x00000000000a2981
- (id)initWithFileURL:(id)arg1;	// IMP=0x00000000000a2898
- (id)initWithFileURL:(id)arg1 signature:(id)arg2 assetHandleUUID:(id)arg3;	// IMP=0x00000000000a27fe
- (id)initWithFileURL:(id)arg1 signature:(id)arg2;	// IMP=0x00000000000a26ab
- (id)_initBare;	// IMP=0x00000000000a265a
- (id)init;	// IMP=0x00000000000a25f7
