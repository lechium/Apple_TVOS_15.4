...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000113bd1
- (void).cxx_destruct;	// IMP=0x0000000000113f0c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000113cb9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000113bd9
