...
+ (void)purgeDirectoryAtURL:(id)arg1;	// IMP=0x00000000000da5b1
- (void).cxx_destruct;	// IMP=0x00000000000db5d4
...
- (void)purge;	// IMP=0x00000000000da70a
- (id)initWithDirectoryURLs:(id)arg1;	// IMP=0x00000000000da69f
