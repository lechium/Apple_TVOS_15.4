...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000061926
- (void).cxx_destruct;	// IMP=0x0000000000061f5c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000061b38
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006192e
- (id)redactedDescription;	// IMP=0x0000000000061914
@property(readonly, copy) NSString *description;
- (void)CKDescribePropertiesUsing:(id)arg1;	// IMP=0x0000000000061710
- (_Bool)isEquivalentToUserIdentityOrPublicKey:(id)arg1;	// IMP=0x000000000006165c
- (_Bool)isEquivalentToUserIdentity:(id)arg1;	// IMP=0x0000000000061565
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006118b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000060dd2
- (_Bool)isOutOfNetwork;	// IMP=0x0000000000060d6d
- (id)initWithUserRecordID:(id)arg1;	// IMP=0x0000000000060c2a
- (id)_init;	// IMP=0x0000000000060bc6
