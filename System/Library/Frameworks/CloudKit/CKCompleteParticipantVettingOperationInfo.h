...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000012dfba
- (void).cxx_destruct;	// IMP=0x000000000012e45e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000012e179
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012dfc2
