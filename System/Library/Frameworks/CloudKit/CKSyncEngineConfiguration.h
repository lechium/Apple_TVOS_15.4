...
- (void).cxx_destruct;	// IMP=0x00000000001774f2
...
- (id)redactedDescription;	// IMP=0x00000000001773e8
@property(readonly, copy) NSString *description;
- (void)CKDescribePropertiesUsing:(id)arg1;	// IMP=0x00000000001771af
- (id)initWithDatabase:(id)arg1 dataSource:(id)arg2 metadata:(id)arg3;	// IMP=0x0000000000176f99
- (id)init;	// IMP=0x0000000000176f56
