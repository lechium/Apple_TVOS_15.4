...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000007cd0
- (void).cxx_destruct;	// IMP=0x000000000000857e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007fcb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000007cd8
