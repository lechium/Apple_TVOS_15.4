...
+ (void)applyDaemonCallbackInterfaceTweaks:(id)arg1;	// IMP=0x000000000014c9c9
- (void).cxx_destruct;	// IMP=0x000000000014cb56
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000014c3d4
- (void)handleRecordAccessRevocationForRecordID:(id)arg1 error:(id)arg2;	// IMP=0x000000000014c040
- (void)handleRecordAccessInitiationForRecordID:(id)arg1 accessToken:(id)arg2 referenceIdentifier:(id)arg3 error:(id)arg4;	// IMP=0x000000000014bc8a
- (void)performCKOperation;	// IMP=0x000000000014b8bb
- (_Bool)CKOperationShouldRun:(id *)arg1;	// IMP=0x000000000014b26c
- (_Bool)hasCKOperationCallbacksSet;	// IMP=0x000000000014b1aa
- (void)fillFromOperationInfo:(id)arg1;	// IMP=0x000000000014b0df
- (void)fillOutOperationInfo:(id)arg1;	// IMP=0x000000000014b01c
- (id)activityCreate;	// IMP=0x000000000014aff3
...
- (id)initWithRecordIDsToGrantAccess:(id)arg1 recordIDsToRevokeAccess:(id)arg2;	// IMP=0x000000000014a451
