...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000135252
- (void).cxx_destruct;	// IMP=0x00000000001386cd
...
- (id)initWithSqliteRepresentation:(id)arg1;	// IMP=0x0000000000137b67
- (id)sqliteRepresentation;	// IMP=0x000000000013709e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000136662
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013621c
- (void)setApplicationBundleIdentifierOverride:(id)arg1;	// IMP=0x00000000001361a7
@property(copy, nonatomic) CKAccountOverrideInfo *accountInfoOverride;
- (void)setUseMMCSEncryptionV2:(_Bool)arg1;	// IMP=0x000000000013616c
- (id)init;	// IMP=0x000000000013612c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001359e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013525a
- (void)ck_bindInStatement:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x000000000013874d
