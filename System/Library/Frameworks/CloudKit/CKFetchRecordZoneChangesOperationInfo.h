...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000119c61
- (void).cxx_destruct;	// IMP=0x000000000011a19f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000119e12
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000119c69
- (id)init;	// IMP=0x0000000000119bbd
