...
+ (void)applyDaemonCallbackInterfaceTweaks:(id)arg1;	// IMP=0x0000000000122584
- (void).cxx_destruct;	// IMP=0x000000000012294f
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000121e60
- (void)copyStreamingAssetServerFieldsFromServerRecord:(id)arg1 toRecord:(id)arg2;	// IMP=0x00000000001218ef
- (void)handleRecordUploadForRecordID:(id)arg1 recordKey:(id)arg2 arrayIndex:(long long)arg3 signature:(id)arg4 size:(unsigned long long)arg5 paddedFileSize:(unsigned long long)arg6 uploaded:(_Bool)arg7 uploadReceipt:(id)arg8 uploadReceiptExpiration:(double)arg9 wrappedAssetKey:(id)arg10 clearAssetKey:(id)arg11 referenceSignature:(id)arg12;	// IMP=0x000000000012115c
- (void)handleSaveForRecordID:(id)arg1 etag:(id)arg2 creationDate:(id)arg3 modificationDate:(id)arg4 expirationDate:(id)arg5 serverRecord:(id)arg6 protectionData:(id)arg7 pcsKeyID:(id)arg8 allPCSKeyIDs:(id)arg9 zoneishKeyID:(id)arg10 error:(id)arg11;	// IMP=0x000000000011fe8d
- (void)handleDeleteForRecordID:(id)arg1 error:(id)arg2;	// IMP=0x000000000011fa5f
- (void)handleRecordModificationForRecordID:(id)arg1 didProgress:(double)arg2;	// IMP=0x000000000011f7b6
- (void)handleRecordIDsInFlight:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000011f415
- (_Bool)claimPackagesInRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000011f15a
- (void)performCKOperation;	// IMP=0x000000000011ed7c
- (void)_trackAssetsToUpload;	// IMP=0x000000000011e888
- (_Bool)CKOperationShouldRun:(id *)arg1;	// IMP=0x000000000011c115
- (void)destroyPackagesInRecords:(id)arg1;	// IMP=0x000000000011bff0
- (void)destroyPackages:(id)arg1;	// IMP=0x000000000011becb
- (_Bool)hasCKOperationCallbacksSet;	// IMP=0x000000000011bd6c
- (void)fillFromOperationInfo:(id)arg1;	// IMP=0x000000000011bb17
- (void)fillOutOperationInfo:(id)arg1;	// IMP=0x000000000011b899
- (id)activityCreate;	// IMP=0x000000000011b870
...
- (id)initWithRecordsToSave:(id)arg1 recordIDsToDelete:(id)arg2;	// IMP=0x000000000011a2fa
- (id)init;	// IMP=0x000000000011a1e1
