...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001341d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001372e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000013425
- (id)init;	// IMP=0x00000000000133c9
