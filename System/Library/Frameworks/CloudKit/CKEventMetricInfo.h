...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017b07e
- (void).cxx_destruct;	// IMP=0x000000000017b7ae
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000017b086
- (id)initWithEventMetric:(id)arg1;	// IMP=0x000000000017ae01
