...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000014e485
- (void).cxx_destruct;	// IMP=0x000000000014fa84
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014ed95
- (unsigned long long)hash;	// IMP=0x000000000014ecd6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014e823
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014e48d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014dec7
- (void)fillAnonymousCKUserID:(id)arg1;	// IMP=0x000000000014db12
@property(readonly, copy, nonatomic) CKRecordID *rootRecordID;
- (long long)environment;	// IMP=0x000000000014da82
@property(readonly, copy, nonatomic) NSString *containerIdentifier;
@property(readonly, nonatomic) long long participantType;
- (void)CKAssignToContainerWithID:(id)arg1;	// IMP=0x000000000014d859
- (id)ckShortDescription;	// IMP=0x000000000014d733
- (id)description;	// IMP=0x000000000014d721
- (id)CKDescriptionPropertiesWithPublic:(_Bool)arg1 private:(_Bool)arg2 shouldExpand:(_Bool)arg3;	// IMP=0x000000000014d0af
@property(readonly, nonatomic, getter=baseToken) NSString *baseToken;
- (id)init;	// IMP=0x000000000014cf0c
