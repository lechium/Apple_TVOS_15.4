...
- (void).cxx_destruct;	// IMP=0x000000000010312b
...
- (_Bool)hasExpired;	// IMP=0x000000000010307f
- (id)initWithPublicKey:(id)arg1 version:(long long)arg2 expiration:(id)arg3 certificateData:(id)arg4 protectionSource:(id)arg5;	// IMP=0x0000000000102f98
