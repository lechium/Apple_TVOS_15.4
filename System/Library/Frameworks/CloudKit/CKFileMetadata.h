...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009ffd5
- (void).cxx_destruct;	// IMP=0x00000000000a0282
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a00b9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009ffdd
