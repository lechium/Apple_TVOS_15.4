...
- (void).cxx_destruct;	// IMP=0x00000000001263a2
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x0000000000125aa1
- (void)invalidate:(id)arg1;	// IMP=0x0000000000125729
