...
+ (double)currentTime;	// IMP=0x000000000008bb83
+ (void)sleep:(double)arg1;	// IMP=0x000000000008bb6c
- (void).cxx_destruct;	// IMP=0x000000000008c1cc
...
- (double)throttleTimeForCount:(long long)arg1 isRetry:(_Bool)arg2;	// IMP=0x000000000008c07c
- (void)gateResponseAction:(long long)arg1 isRetry:(_Bool)arg2 currentTime:(double)arg3;	// IMP=0x000000000008bc60
- (void)gateResponseAction:(long long)arg1 isRetry:(_Bool)arg2;	// IMP=0x000000000008bc16
- (id)init;	// IMP=0x000000000008bb8f
