...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f10ff
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00000000000f039a
+ (id)_realNotificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00000000000a72c5
- (void).cxx_destruct;	// IMP=0x00000000000f1985
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f1301
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f1107
- (void)setSubscriptionID:(id)arg1;	// IMP=0x00000000000f10eb
- (void)setContainerIdentifier:(id)arg1;	// IMP=0x00000000000f1041
@property(readonly, copy, nonatomic) NSString *containerIdentifier;
- (_Bool)isRead;	// IMP=0x00000000000f0fd7
- (id)description;	// IMP=0x00000000000f0fc5
- (id)CKPropertiesDescription;	// IMP=0x00000000000f03ac
- (id)_initBare;	// IMP=0x00000000000f036b
- (id)init;	// IMP=0x00000000000f030b
- (id)initWithRemoteNotificationDictionary:(id)arg1;	// IMP=0x00000000000a742c
