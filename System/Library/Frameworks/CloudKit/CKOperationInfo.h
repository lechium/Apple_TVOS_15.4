...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000142da8
- (void).cxx_destruct;	// IMP=0x0000000000143708
...
- (void)takeValuesFrom:(id)arg1;	// IMP=0x0000000000143400
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001430e9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000142db0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001425d5
- (id)init;	// IMP=0x0000000000142571
