...
- (void).cxx_destruct;	// IMP=0x000000000010be47
...
- (id)operationToModifyBatch:(id)arg1;	// IMP=0x000000000010b3bd
- (void)addNextModifyOperationOrFinishIfNoRemainingWork;	// IMP=0x000000000010b036
- (id)cancelledError;	// IMP=0x000000000010b00f
- (void)finishWithError:(id)arg1;	// IMP=0x000000000010aea9
- (void)cancel;	// IMP=0x000000000010abbf
- (void)start;	// IMP=0x000000000010aa3c
- (void)transitionToFinished;	// IMP=0x000000000010aa28
- (void)transitionToExecuting;	// IMP=0x000000000010aa14
- (_Bool)isExecuting;	// IMP=0x000000000010a9d4
- (_Bool)isFinished;	// IMP=0x000000000010a994
- (_Bool)isAsynchronous;	// IMP=0x000000000010a98c
- (id)init;	// IMP=0x000000000010a910
- (id)initWithDatabase:(id)arg1;	// IMP=0x000000000010a7e3
