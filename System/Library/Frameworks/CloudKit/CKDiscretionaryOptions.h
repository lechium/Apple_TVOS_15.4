...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ab4a2
- (void).cxx_destruct;	// IMP=0x00000000000ab759
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ab5f8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ab4aa
