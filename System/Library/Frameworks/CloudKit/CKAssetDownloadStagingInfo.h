...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000123858
- (void).cxx_destruct;	// IMP=0x0000000000123b81
...
- (id)redactedDescription;	// IMP=0x0000000000123b51
@property(readonly, copy) NSString *description;
- (void)CKDescribePropertiesUsing:(id)arg1;	// IMP=0x0000000000123a53
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000123943
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000123860
- (id)initWithItemID:(id)arg1 trackingUUID:(id)arg2 signature:(id)arg3;	// IMP=0x0000000000123772
