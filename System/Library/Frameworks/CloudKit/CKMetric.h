...
+ (id)unionDictionary:(id)arg1 with:(id)arg2;	// IMP=0x00000000000eb5ed
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000eaaa4
- (void).cxx_destruct;	// IMP=0x00000000000eb9c5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eb433
- (id)description;	// IMP=0x00000000000eb421
- (id)CKPropertiesDescription;	// IMP=0x00000000000eb240
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000eacad
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000eaaac
