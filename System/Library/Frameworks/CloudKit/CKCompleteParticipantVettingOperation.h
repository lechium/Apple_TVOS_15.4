...
- (void).cxx_destruct;	// IMP=0x000000000012df01
...
- (id)activityCreate;	// IMP=0x000000000012dda3
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000012d92a
- (void)handleFetchedShareMetadata:(id)arg1;	// IMP=0x000000000012d918
- (void)handleReconstructedShareURL:(id)arg1;	// IMP=0x000000000012d906
- (void)performCKOperation;	// IMP=0x000000000012d537
- (_Bool)CKOperationShouldRun:(id *)arg1;	// IMP=0x000000000012d2e3
- (void)fillFromOperationInfo:(id)arg1;	// IMP=0x000000000012d132
- (void)fillOutOperationInfo:(id)arg1;	// IMP=0x000000000012cf89
...
- (id)initWithVettingToken:(id)arg1 vettingRecord:(id)arg2 displayedHostname:(id)arg3;	// IMP=0x000000000012c9b6
- (id)init;	// IMP=0x000000000012c961
