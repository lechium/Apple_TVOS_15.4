...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000149aee
+ (void)applyDefaultParametersToServiceURLComponents:(id)arg1;	// IMP=0x00000000001499f1
- (void).cxx_destruct;	// IMP=0x000000000014a3ba
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000149dd8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000149af6
