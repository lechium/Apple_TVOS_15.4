...
- (void).cxx_destruct;	// IMP=0x000000000002691b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000026868
- (id)initWithClientIdentifier:(id)arg1 teamIdentifier:(id)arg2;	// IMP=0x0000000000026765
