...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000007a5e
- (void).cxx_destruct;	// IMP=0x0000000000007e08
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000007cc0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007a66
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000079b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000787a
- (unsigned long long)hash;	// IMP=0x00000000000077eb
- (id)description;	// IMP=0x000000000000768c
