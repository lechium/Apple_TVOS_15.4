...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0000000000006267
- (void).cxx_destruct;	// IMP=0x0000000000006799
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000065cd
- (id)copyXPCEncoding;	// IMP=0x0000000000006510
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000006305
