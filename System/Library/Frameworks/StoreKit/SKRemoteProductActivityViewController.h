...
+ (id)serviceViewControllerInterface;	// IMP=0x00000000000353c2
+ (id)exportedInterface;	// IMP=0x00000000000353a2
...
- (void)didFinishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000035304
