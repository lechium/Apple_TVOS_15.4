...
- (void).cxx_destruct;	// IMP=0x000000000003042e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000301be
- (id)plist;	// IMP=0x000000000002fe24
- (id)copyXPCEncoding;	// IMP=0x000000000002fd2f
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x000000000002fb58
