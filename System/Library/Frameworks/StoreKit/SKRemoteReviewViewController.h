...
+ (id)serviceViewControllerInterface;	// IMP=0x000000000003124d
+ (id)exportedInterface;	// IMP=0x000000000003122d
- (void).cxx_destruct;	// IMP=0x000000000003135b
...
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x000000000003126d
- (void)didFinishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000003118f
