...
- (void)handleEngagementRequest:(id)arg1 replyBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000889c5
- (void)shouldContinueTransactionWithNewStorefront:(id)arg1 replyBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000088568
- (id)init;	// IMP=0x00000000000883ae
