...
- (void).cxx_destruct;	// IMP=0x000000000002fb48
...
- (id)initWithIdentifier:(id)arg1 keyIdentifier:(id)arg2 nonce:(id)arg3 signature:(id)arg4 timestamp:(id)arg5;	// IMP=0x000000000002f91a
