...
- (void).cxx_destruct;	// IMP=0x00000000000330f1
- (void)endDelayingAnimation;	// IMP=0x00000000000330ae
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000032ffb
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000032fed
