...
+ (id)serviceViewControllerInterface;	// IMP=0x00000000000352a6
+ (id)exportedInterface;	// IMP=0x0000000000035286
- (void).cxx_destruct;	// IMP=0x00000000000352f3
...
- (void)showProductPageWithItemIdentifier:(id)arg1;	// IMP=0x0000000000035214
- (void)didFinishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000003518e
