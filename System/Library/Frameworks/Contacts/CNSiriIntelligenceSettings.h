...
- (void)setShouldShowSiriSuggestions:(_Bool)arg1;	// IMP=0x000000000010e58b
- (_Bool)shouldShowSiriSuggestions;	// IMP=0x000000000010e557
- (void)dealloc;	// IMP=0x000000000010e51a
- (id)init;	// IMP=0x000000000010e319
