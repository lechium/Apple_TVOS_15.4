...
- (void).cxx_destruct;	// IMP=0x00000000000521e0
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x0000000000052111
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x00000000000520fb
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x00000000000520e5
- (void)_populateSaveRequestIndexTables;	// IMP=0x0000000000051c75
- (void)dealloc;	// IMP=0x0000000000051c36
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x0000000000051a42
