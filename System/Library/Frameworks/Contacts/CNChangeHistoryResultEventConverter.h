...
- (void).cxx_destruct;	// IMP=0x0000000000036dd9
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x0000000000035e5f
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x0000000000035d91
