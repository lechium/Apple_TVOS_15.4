...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00000000000b537b
+ (id)os_log;	// IMP=0x00000000000b44b4
- (void).cxx_destruct;	// IMP=0x00000000000b556d
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000b5383
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000b46fd
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000b46f5
- (void)resetAllData;	// IMP=0x00000000000b464d
