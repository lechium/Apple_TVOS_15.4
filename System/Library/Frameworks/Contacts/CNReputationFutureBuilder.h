...
- (void).cxx_destruct;	// IMP=0x0000000000085285
...
- (id)build;	// IMP=0x000000000008502b
- (id)contactsTrustForPhoneNumber:(id)arg1;	// IMP=0x0000000000084ca5
- (void)addContactsTrustForPhoneNumber;	// IMP=0x0000000000084abf
- (id)contactsTrustForEmailAddress:(id)arg1;	// IMP=0x00000000000847df
- (void)addContactsTrustForEmailAddress;	// IMP=0x00000000000845f9
- (id)coreRecentsTrustForHandle:(id)arg1;	// IMP=0x0000000000084319
- (void)addCoreRecentsTrust;	// IMP=0x0000000000084133
- (id)initWithHandle:(id)arg1 coreRecentsAdapter:(id)arg2 contactsAdapter:(id)arg3 logger:(id)arg4;	// IMP=0x0000000000084040
