...
- (void).cxx_destruct;	// IMP=0x00000000000caf89
@property(readonly, nonatomic) CRRecentContactsLibrary *library; // @synthesize library=_library;
- (id)recentContactsForHandle:(id)arg1;	// IMP=0x00000000000cad5a
- (id)initWithRecentContactsLibrary:(id)arg1;	// IMP=0x00000000000cacdc
- (id)init;	// IMP=0x00000000000cac80
