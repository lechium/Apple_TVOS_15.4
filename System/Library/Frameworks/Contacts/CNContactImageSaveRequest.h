...
+ (id)saveRequestToDeleteImageForIdentifier:(id)arg1;	// IMP=0x000000000003975f
+ (id)saveRequestToDeleteImagesForContactIdentifiers:(id)arg1;	// IMP=0x0000000000039700
+ (id)saveRequestToCreateImage:(id)arg1 forContactIdentifier:(id)arg2;	// IMP=0x000000000003961d
- (void).cxx_destruct;	// IMP=0x0000000000039ad9
...
- (id)createStoreRequest;	// IMP=0x0000000000039a98
- (id)deleteStoreRequest;	// IMP=0x0000000000039952
@property(readonly, nonatomic) NSPersistentStoreRequest *persistentStoreRequest;
- (id)initWithContactImage:(id)arg1 contactIdentifiers:(id)arg2 attributeName:(id)arg3 operationType:(long long)arg4;	// IMP=0x000000000003982a
