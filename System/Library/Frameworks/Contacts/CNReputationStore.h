...
- (void).cxx_destruct;	// IMP=0x0000000000082b90
...
- (id)makeFutureForHandle:(id)arg1;	// IMP=0x0000000000082a54
- (id)reputationForHandle:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x0000000000082567
- (id)initWithCoreRecentsAdapter:(id)arg1 contactsAdapter:(id)arg2 logger:(id)arg3 schedulerProvider:(id)arg4;	// IMP=0x0000000000082475
- (id)init;	// IMP=0x00000000000823bd
