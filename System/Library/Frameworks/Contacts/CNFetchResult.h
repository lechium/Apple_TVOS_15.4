...
- (void).cxx_destruct;	// IMP=0x0000000000058557
...
- (id)description;	// IMP=0x0000000000058457
- (id)initWithValue:(id)arg1 currentHistoryToken:(id)arg2;	// IMP=0x000000000005839d
