...
+ (CDUnknownBlockType)managedObjectToContactImageTransform;	// IMP=0x0000000000035649
- (id)cropRectStringFromCGRect:(struct CGRect)arg1;	// IMP=0x000000000003563f
- (void)setupWithContactImage:(id)arg1 contactIdentifier:(id)arg2;	// IMP=0x000000000003555f
- (void)updateWithContactImage:(id)arg1;	// IMP=0x000000000003535f
