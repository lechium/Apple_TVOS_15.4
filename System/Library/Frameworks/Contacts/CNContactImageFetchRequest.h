...
+ (id)predicateForImagesMatchingContactIdentifiers:(id)arg1;	// IMP=0x00000000000cda10
+ (id)recentImagesRequestForContactIdenfitiers:(id)arg1;	// IMP=0x00000000000cd9c3
- (void).cxx_destruct;	// IMP=0x00000000000cdc25
...
- (id)initWithContactIdentifiers:(id)arg1;	// IMP=0x00000000000cda3f
