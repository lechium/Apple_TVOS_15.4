...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000047491
- (void).cxx_destruct;	// IMP=0x000000000004841d
...
- (unsigned long long)hash;	// IMP=0x0000000000047e34
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004769f
- (id)description;	// IMP=0x0000000000047499
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000473a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000471a7
- (id)initWithIdentifier:(id)arg1 changeType:(long long)arg2 changeAnchor:(id)arg3 changeID:(id)arg4 externalID:(id)arg5 imagesChanged:(id)arg6 linkToPersonUUID:(id)arg7 personLinkUUID:(id)arg8;	// IMP=0x0000000000046f56
- (id)initWithIdentifier:(id)arg1 changeType:(long long)arg2 changeAnchor:(id)arg3 changeID:(id)arg4;	// IMP=0x0000000000046f2f
