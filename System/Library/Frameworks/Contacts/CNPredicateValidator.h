...
- (void).cxx_destruct;	// IMP=0x000000000010480d
...
- (void)visitPredicateOperator:(id)arg1;	// IMP=0x0000000000104789
- (void)visitPredicate:(id)arg1;	// IMP=0x0000000000104783
- (void)resetUsedKeys;	// IMP=0x000000000010476f
@property(readonly, copy, nonatomic) NSArray *usedKeys;
- (void)visitPredicateExpression:(id)arg1;	// IMP=0x0000000000103fd6
@property(retain, nonatomic) NSArray *allowedKeys;
- (_Bool)validateWithError:(id *)arg1;	// IMP=0x0000000000103b54
