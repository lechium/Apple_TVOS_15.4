...
+ (id)descriptorForAllSupportedKeys;	// IMP=0x000000000009ac8d
+ (id)adapterWithContact:(id)arg1;	// IMP=0x000000000009ac44
- (void).cxx_destruct;	// IMP=0x000000000009c013
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x000000000009be1a
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x000000000009bae3
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x000000000009bacf
...
- (id)initWithContact:(id)arg1;	// IMP=0x000000000009afc0
