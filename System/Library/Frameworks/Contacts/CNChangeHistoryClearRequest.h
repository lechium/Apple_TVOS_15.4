...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000371f6
- (void).cxx_destruct;	// IMP=0x0000000000037421
...
- (id)description;	// IMP=0x00000000000371fe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003714d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000036e96
- (id)initWithClientIdentifier:(id)arg1;	// IMP=0x0000000000036e0c
