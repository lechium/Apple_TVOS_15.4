...
- (void).cxx_destruct;	// IMP=0x0000000000065590
...
- (id)copyWithNewImageData:(id)arg1;	// IMP=0x0000000000065349
- (id)initWithIdentifier:(id)arg1 imageData:(id)arg2 cropRect:(struct CGRect)arg3 lastUsedDate:(id)arg4;	// IMP=0x0000000000065262
- (id)initWithImageData:(id)arg1 cropRect:(struct CGRect)arg2 lastUsedDate:(id)arg3;	// IMP=0x0000000000065194
