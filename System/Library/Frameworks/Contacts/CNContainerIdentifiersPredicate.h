...
- (void).cxx_destruct;	// IMP=0x000000000004dfe3
@property(readonly, copy, nonatomic) NSArray *identifiers; // @synthesize identifiers=_identifiers;
- (id)cn_persistenceFilterRequest;	// IMP=0x000000000004dfca
- (id)cn_topLevelFilter;	// IMP=0x000000000004df17
- (id)initWithIdentifiers:(id)arg1;	// IMP=0x000000000004de4e
