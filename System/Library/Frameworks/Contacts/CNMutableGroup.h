...
- (id)freezeWithSelfAsSnapshot;	// IMP=0x00000000000d90a8
- (id)freeze;	// IMP=0x00000000000d907e
@property(copy, nonatomic) CNGroup *snapshot; // @dynamic snapshot;
- (void)adoptValuesFromAndSetSnapshot:(id)arg1;	// IMP=0x00000000000d8e0c
...
- (id)copy;	// IMP=0x00000000000d8ade
