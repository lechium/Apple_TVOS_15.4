...
- (void).cxx_destruct;	// IMP=0x0000000000006b9c
...
- (id)description;	// IMP=0x0000000000006aa0
- (id)initWithObservedObject:(id)arg1 observedKeyPath:(id)arg2 bindingOptions:(id)arg3 updateHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000000699e
