...
- (void).cxx_destruct;	// IMP=0x0000000000240e09
...
- (_Bool)_storeItemMetadataIsAvailableForContentIdentifier:(id)arg1;	// IMP=0x0000000000240d19
- (id)_storeItemMetadataForContentIdentifier:(id)arg1;	// IMP=0x0000000000240c28
- (void)_populateUnavailableContentIdentifiersFromPageDataDictionary:(id)arg1;	// IMP=0x000000000024090f
- (void)_populateStorePlatformDataResultsFromRawResponseOutputDictionary:(id)arg1;	// IMP=0x000000000024071d
- (void)_parseUsingAdditionalContentIdentifiersFromPreviousParser;	// IMP=0x00000000002403ef
- (void)_parseSingleContentListFromPageDataDictionary:(id)arg1 isMemberOfChartSet:(_Bool)arg2;	// IMP=0x000000000023f823
- (_Bool)_parseFeaturedContentChild:(id)arg1 isMemberOfChartSet:(_Bool)arg2 insertingResultsToSectionedCollection:(id)arg3 atSectionIndex:(long long)arg4 additionalContentIdentifiers:(id)arg5 allAdditionalContentIdentifiersNeedingLookup:(id)arg6;	// IMP=0x000000000023eb08
- (void)_parseFeaturedContentStructureModelChildren:(id)arg1;	// IMP=0x000000000023e3f2
- (void)_parse;	// IMP=0x000000000023e1f9
...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_d2d88407)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6;	// IMP=0x000000000023dfc3
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_d2d88407)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000023dedd
