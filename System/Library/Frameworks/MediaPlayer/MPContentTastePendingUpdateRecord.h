...
- (void).cxx_destruct;	// IMP=0x00000000002a4ec0
...
- (void)_initializeWithType:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002a4e4d
- (id)initWithStoreAdamID:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002a4de7
- (id)initWithPlaylistGlobalID:(id)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002a4d53
