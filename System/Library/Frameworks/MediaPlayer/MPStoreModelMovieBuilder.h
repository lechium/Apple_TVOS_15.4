...
+ (id)allSupportedProperties;	// IMP=0x00000000002b6d5e
- (void).cxx_destruct;	// IMP=0x00000000002b75b6
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x00000000002b6fbd
