...
+ (id)allSupportedProperties;	// IMP=0x00000000001ae68e
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x00000000001ae77e
