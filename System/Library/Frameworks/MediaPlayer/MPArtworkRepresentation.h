...
+ (id)representationForVisualIdentity:(id)arg1 withSize:(struct CGSize)arg2 video:(id)arg3;	// IMP=0x00000000000be5a3
+ (id)representationForVisualIdentity:(id)arg1 withSize:(struct CGSize)arg2 image:(id)arg3;	// IMP=0x00000000000be4c4
+ (id)representationWithSize:(struct CGSize)arg1 video:(id)arg2;	// IMP=0x00000000000be4a8
+ (id)representationWithSize:(struct CGSize)arg1 image:(id)arg2;	// IMP=0x00000000000be48c
- (void).cxx_destruct;	// IMP=0x00000000000be44e
...
- (id)representationWithPreparedImage:(id)arg1;	// IMP=0x00000000000be2a9
- (id)debugQuickLookObject;	// IMP=0x00000000000be297
