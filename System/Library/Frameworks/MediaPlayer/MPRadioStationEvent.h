...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000044526
- (void).cxx_destruct;	// IMP=0x00000000000444e8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000442be
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000004425f
