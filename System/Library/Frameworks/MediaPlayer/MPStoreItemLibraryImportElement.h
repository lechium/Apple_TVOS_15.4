...
- (void).cxx_destruct;	// IMP=0x00000000001cbd06
...
- (id)storeItem;	// IMP=0x00000000001cbcea
- (id)initWithStoreItemID:(long long)arg1 additionalTrackMetadata:(id)arg2;	// IMP=0x00000000001cbc6c
