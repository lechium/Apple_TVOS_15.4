...
+ (id)allSupportedProperties;	// IMP=0x000000000018b100
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000018b1da
