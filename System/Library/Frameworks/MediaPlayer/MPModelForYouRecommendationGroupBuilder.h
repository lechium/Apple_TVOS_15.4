...
+ (id)allSupportedItemProperties;	// IMP=0x00000000002175e8
+ (id)allSupportedGroupProperties;	// IMP=0x000000000021750e
- (void).cxx_destruct;	// IMP=0x0000000000216abd
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000002165e1
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x00000000002164c5
