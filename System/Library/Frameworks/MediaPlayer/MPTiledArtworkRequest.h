...
- (void).cxx_destruct;	// IMP=0x0000000000011e7e
...
- (_Bool)hasExistingArtworkCatalogsWithCount:(long long)arg1;	// IMP=0x0000000000011d7d
- (id)existingArtworkCatalogsWithCount:(long long)arg1;	// IMP=0x0000000000011cdb
- (id)artworkCatalogsWithCount:(unsigned long long)arg1;	// IMP=0x0000000000011c16
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000011b31
- (id)init;	// IMP=0x0000000000011af6
