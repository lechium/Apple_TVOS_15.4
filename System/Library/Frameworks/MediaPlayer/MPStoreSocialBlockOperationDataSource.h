...
- (void).cxx_destruct;	// IMP=0x000000000028a167
@property(retain, nonatomic) MPModelSocialPerson *person; // @synthesize person=_person;
- (id)queryItems;	// IMP=0x000000000028a144
- (long long)httpMethod;	// IMP=0x000000000028a139
- (long long)httpBodyType;	// IMP=0x000000000028a12e
- (id)httpBody;	// IMP=0x000000000028a007
- (id)bagKey;	// IMP=0x0000000000289ffa
