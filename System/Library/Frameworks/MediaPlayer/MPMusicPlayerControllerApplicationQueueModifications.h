...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001afe35
- (void).cxx_destruct;	// IMP=0x00000000001afe0d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001afd8b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001afbf0
- (id)initWithInsertedDescriptors:(id)arg1 removedItemIdentifiers:(id)arg2;	// IMP=0x00000000001afb37
