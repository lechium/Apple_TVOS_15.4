...
- (void).cxx_destruct;	// IMP=0x0000000000293fab
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)genericObjectForStorePlatformMetadata:(id)arg1 userIdentity:(id)arg2;	// IMP=0x0000000000293544
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x00000000002934d1
