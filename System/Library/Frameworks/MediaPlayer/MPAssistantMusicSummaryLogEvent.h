...
- (void).cxx_destruct;	// IMP=0x0000000000068507
...
- (id)eventPayload;	// IMP=0x0000000000068342
- (long long)eventCode;	// IMP=0x0000000000068337
- (id)eventName;	// IMP=0x000000000006832a
