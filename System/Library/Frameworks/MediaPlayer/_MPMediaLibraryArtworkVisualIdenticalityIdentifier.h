...
- (void).cxx_destruct;	// IMP=0x000000000028892e
...
- (id)stringRepresentation;	// IMP=0x0000000000288880
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000288875
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000288795
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithArtworkType:(long long)arg1 availableArtworkToken:(id)arg2 fetchableArtworkToken:(id)arg3;	// IMP=0x0000000000288555
- (id)init;	// IMP=0x000000000028853c
