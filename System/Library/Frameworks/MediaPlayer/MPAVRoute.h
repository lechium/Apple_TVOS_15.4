...
+ (long long)clusterTypeForMRClusterType:(unsigned int)arg1;	// IMP=0x000000000014cf43
+ (id)clusterCompositionForOutputDevice:(id)arg1;	// IMP=0x000000000014cc24
+ (long long)routeSubtypeForMRSubtype:(unsigned int)arg1 mrType:(unsigned int)arg2;	// IMP=0x000000000014cb2f
+ (long long)routeSubtypeForMRSubtype:(unsigned int)arg1 withOverridesFromMRType:(unsigned int)arg2;	// IMP=0x000000000014caf2
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000014caea
- (void).cxx_destruct;	// IMP=0x000000000014ca1e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014c72c
- (id)description;	// IMP=0x000000000014c5e5
- (id)debugDescription;	// IMP=0x000000000014c4b0
- (unsigned long long)hash;	// IMP=0x000000000014c3c8
- (_Bool)containsDeviceWithSubtype:(long long)arg1;	// IMP=0x000000000014c2d2
...
- (void)setAVRouteDescription:(id)arg1;	// IMP=0x000000000014b397
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014b2ce
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014b2c0
