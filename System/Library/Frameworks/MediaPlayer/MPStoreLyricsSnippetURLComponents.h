...
- (void).cxx_destruct;	// IMP=0x00000000002897d8
...
- (id)signatureWithCountryCode:(id)arg1 adamID:(id)arg2 startTime:(id)arg3 endTime:(id)arg4 language:(id)arg5;	// IMP=0x000000000028967b
- (void)URLWithAdditionalParameters:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000289539
- (id)initWithSong:(id)arg1 language:(id)arg2 startTime:(double)arg3 endTime:(double)arg4;	// IMP=0x0000000000289404
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000288cfd
