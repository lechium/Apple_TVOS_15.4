...
- (void).cxx_destruct;	// IMP=0x00000000002bf839
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000002bf705
- (id)initWithModel:(id)arg1;	// IMP=0x00000000002bf660
