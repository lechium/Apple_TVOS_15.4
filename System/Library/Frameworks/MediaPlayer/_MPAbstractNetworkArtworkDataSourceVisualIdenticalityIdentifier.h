...
- (void).cxx_destruct;	// IMP=0x00000000001088b1
...
- (id)stringRepresentation;	// IMP=0x00000000001087ba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000108767
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001086ba
