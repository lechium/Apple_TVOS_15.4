...
+ (id)allSupportedProperties;	// IMP=0x00000000000b202b
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x00000000000b22ef
