...
+ (id)headEntryWithSectionIdentifier:(id)arg1;	// IMP=0x0000000000073232
- (void).cxx_destruct;	// IMP=0x00000000000731df
...
- (void)setBranchDepth:(long long)arg1;	// IMP=0x00000000000730e9
- (id)nextEntries;	// IMP=0x0000000000073042
@property(readonly, nonatomic) long long entryType;
@property(readonly, copy) NSString *description;
- (id)initWithPositionKey:(id)arg1 sectionIdentifier:(id)arg2;	// IMP=0x0000000000072ed7
