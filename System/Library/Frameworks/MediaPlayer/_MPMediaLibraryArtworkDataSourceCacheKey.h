...
- (void).cxx_destruct;	// IMP=0x000000000028804d
...
- (unsigned long long)hash;	// IMP=0x0000000000287f5f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000287e3c
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x0000000000287da3
