...
- (void).cxx_destruct;	// IMP=0x000000000005c0a0
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000005bfb3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005bf16
