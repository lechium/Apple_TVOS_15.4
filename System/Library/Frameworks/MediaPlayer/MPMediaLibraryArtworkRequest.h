...
+ (id)artworkTokenWithParameters:(id)arg1;	// IMP=0x00000000001b2620
- (void).cxx_destruct;	// IMP=0x00000000001b1e1f
...
- (void)_onQueue_updateTokens;	// IMP=0x00000000001b1d7c
- (id)_onQueue_musicLibrary;	// IMP=0x00000000001b1d09
- (void)promoteFetchableArtworkTokenIfNeeded;	// IMP=0x00000000001b1cbe
- (void)clearFailedFetchableToken;	// IMP=0x00000000001b1c73
- (id)artworkTokenParameters;	// IMP=0x00000000001b1bd7
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b19b5
...
- (void)setLibraryArtwork:(id)arg1;	// IMP=0x00000000001b1553
...
- (id)initWithLibrary:(id)arg1 identifier:(unsigned long long)arg2 entityType:(long long)arg3 artworkType:(long long)arg4 mediaType:(unsigned long long)arg5;	// IMP=0x00000000001b0f53
- (id)initWithLibrary:(id)arg1 identifier:(unsigned long long)arg2 entityType:(long long)arg3 artworkType:(long long)arg4;	// IMP=0x00000000001b0e94
