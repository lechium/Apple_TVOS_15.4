...
- (void).cxx_destruct;	// IMP=0x000000000004b1b8
- (id)stringRepresentation;	// IMP=0x000000000004b179
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004b16e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004b028
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithTiledArtworkRequest:(id)arg1 scaledFittingSize:(struct CGSize)arg2;	// IMP=0x000000000004ac70
- (id)init;	// IMP=0x000000000004ac4c
