...
- (void).cxx_destruct;	// IMP=0x000000000017635c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000176044
- (id)description;	// IMP=0x0000000000175f13
- (id)initWithOutputDevice:(void *)arg1;	// IMP=0x0000000000175e23
- (id)initWithRouteDescription:(id)arg1;	// IMP=0x0000000000175d42
