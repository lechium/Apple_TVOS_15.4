...
+ (void)getPendingCommandTypesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c9bd5
+ (long long)_numberOfCommandCentersWithTargets;	// IMP=0x00000000001c9985
+ (id)commandCenterForPlayerPath:(id)arg1;	// IMP=0x00000000001c98f0
+ (id)commandCenterForPlayerID:(id)arg1;	// IMP=0x00000000001c97bb
+ (id)sharedCommandCenter;	// IMP=0x00000000001c978b
+ (void)updateLaunchCommandsWithConfigurationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c96a7
- (void).cxx_destruct;	// IMP=0x00000000001c835c
...
- (void)_stopMediaRemoteSync;	// IMP=0x00000000001c8292
- (void)_startMediaRemoteSync;	// IMP=0x00000000001c814e
- (void)_scheduleSupportedCommandsChanged;	// IMP=0x00000000001c80e5
- (id)_onQueue_stateDictionary;	// IMP=0x00000000001c7fc2
- (_Bool)containsCommand:(id)arg1;	// IMP=0x00000000001c7f89
- (void)_updateCanBeNowPlayingApplicationIfNeeded;	// IMP=0x00000000001c7ee8
- (void)_commandTargetsDidChangeNotification:(id)arg1;	// IMP=0x00000000001c7c4c
- (id)_createRemoteCommandWithConcreteClass:(Class)arg1 mediaRemoteType:(unsigned int)arg2;	// IMP=0x00000000001c7ac9
- (id)_activeCommands;	// IMP=0x00000000001c7a10
- (_Bool)isInvalidated;	// IMP=0x00000000001c7972
...
- (void)getPendingCommandTypesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c6883
- (void)_flushEventQueue;	// IMP=0x00000000001c6695
- (void)dispatchCommandEvent:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001c632d
- (void)_pushMediaRemoteCommand:(unsigned int)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001c607d
- (void)remoteCommandDidMutatePropagatableProperty:(id)arg1;	// IMP=0x00000000001c5ec6
...
- (void)invalidate;	// IMP=0x00000000001c5bd1
- (void)dealloc;	// IMP=0x00000000001c5b30
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x00000000001c587e
- (id)initWithPlayerID:(id)arg1;	// IMP=0x00000000001c5760
