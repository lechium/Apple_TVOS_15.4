...
+ (id)allSupportedProperties;	// IMP=0x0000000000206a26
- (void).cxx_destruct;	// IMP=0x0000000000206777
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x0000000000206562
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x00000000002064d3
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x000000000020591b
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x0000000000205816
