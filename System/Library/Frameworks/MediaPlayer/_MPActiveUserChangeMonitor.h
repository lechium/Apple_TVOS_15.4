...
- (void).cxx_destruct;	// IMP=0x0000000000234a09
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x00000000002347c8
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000023457e
- (void)ingestNotificationName:(id)arg1;	// IMP=0x00000000002341ac
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000023404d
