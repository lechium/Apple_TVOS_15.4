...
+ (id)requiredPlaylistEntryProperties;	// IMP=0x0000000000222193
- (void).cxx_destruct;	// IMP=0x00000000002220fd
...
- (id)newOperationWithLocalPersistenceResponseHandler:(CDUnknownBlockType)arg1 completeResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000221f24
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000221df2
- (id)init;	// IMP=0x0000000000221d8c
