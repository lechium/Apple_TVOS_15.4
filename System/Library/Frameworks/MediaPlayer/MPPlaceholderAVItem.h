...
+ (_Bool)isPlaceholder;	// IMP=0x00000000001df1ac
- (void).cxx_destruct;	// IMP=0x00000000001df159
...
- (void)loadAssetAndPlayerItem;	// IMP=0x00000000001df09c
- (_Bool)isValidPlayerSubstituteForItem:(id)arg1;	// IMP=0x00000000001df051
- (_Bool)supportsRateChange;	// IMP=0x00000000001df049
- (id)description;	// IMP=0x00000000001dec5a
- (id)init;	// IMP=0x00000000001deb98
