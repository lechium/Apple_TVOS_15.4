...
- (void).cxx_destruct;	// IMP=0x000000000018e671
...
- (id)newRTCReportingPayloadDictionary;	// IMP=0x000000000018dfa1
- (unsigned short)rtcReportingCategory;	// IMP=0x000000000018df96
