...
- (void).cxx_destruct;	// IMP=0x0000000000046fc2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000046f5d
- (unsigned long long)hash;	// IMP=0x0000000000046f47
...
- (id)initWithMediaRemoteAudioFormat:(id)arg1;	// IMP=0x00000000000467d6
- (id)init;	// IMP=0x0000000000046780
