...
+ (id)standardUserDefaults;	// IMP=0x0000000000180e57
- (void).cxx_destruct;	// IMP=0x000000000017f529
...
- (void)_accountStoreChangedNotification:(id)arg1;	// IMP=0x000000000017f50d
- (void)_loadAccountProperties;	// IMP=0x000000000017f4c2
- (void)_migrateUserDefaults;	// IMP=0x000000000017f36d
- (void)resetAllInternalSettings;	// IMP=0x000000000017f214
...
- (void)setPlaybackAuthorizationTokenHalfLifeDuration:(double)arg1;	// IMP=0x000000000017e413
...
- (void)setAutoPlayEnabled:(_Bool)arg1 forUserIdentity:(id)arg2;	// IMP=0x000000000017de14
- (_Bool)autoPlayEnabledForUserIdentity:(id)arg1;	// IMP=0x000000000017dc19
- (void)dealloc;	// IMP=0x000000000017db73
- (id)_init;	// IMP=0x000000000017d71c
