...
- (void).cxx_destruct;	// IMP=0x00000000002d5546
...
- (void)downloadManager:(id)arg1 downloadPurchaseDidFinish:(id)arg2;	// IMP=0x00000000002d53b3
- (void)downloadManager:(id)arg1 downloadDidFinish:(id)arg2;	// IMP=0x00000000002d523c
- (id)initWithDownload:(id)arg1;	// IMP=0x00000000002d512c
