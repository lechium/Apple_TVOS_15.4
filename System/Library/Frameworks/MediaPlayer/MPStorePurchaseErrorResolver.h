...
- (void).cxx_destruct;	// IMP=0x000000000022c980
...
- (void)resolveError:(id)arg1;	// IMP=0x000000000022c95b
- (id)initWithStoreAccountIdentifier:(id)arg1;	// IMP=0x000000000022c8ed
