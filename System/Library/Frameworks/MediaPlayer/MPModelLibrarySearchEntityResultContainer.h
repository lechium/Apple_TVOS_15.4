...
- (id).cxx_construct;	// IMP=0x000000000024716d
- (void).cxx_destruct;	// IMP=0x000000000024713c
...
- (id)initWithEntityQueryResult:(shared_ptr_274c5e8b)arg1 forScope:(id)arg2 entityTranslationContext:(id)arg3;	// IMP=0x0000000000247004
