...
+ (id)__hasTimeSyncedLyrics_KEY;	// IMP=0x000000000000f393
+ (id)__hasLibraryLyrics_KEY;	// IMP=0x000000000000f386
+ (id)__hasStoreLyrics_KEY;	// IMP=0x000000000000f379
+ (id)__TTML_KEY;	// IMP=0x000000000000f36c
+ (id)__text_KEY;	// IMP=0x000000000000f35f
