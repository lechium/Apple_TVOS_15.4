...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002bf614
+ (id)emptyIdentifierSet;	// IMP=0x00000000002bf5e4
- (void).cxx_destruct;	// IMP=0x00000000002bd990
...
- (void)_setDefaultPersonIDIfNeeded;	// IMP=0x00000000002bd62f
- (void)_setDefaultDatabaseIDIfNeeded;	// IMP=0x00000000002bd582
@property(readonly, nonatomic) _Bool needsPersonalization;
- (id)prioritizedStoreStringIdentifiersForPersonID:(id)arg1;	// IMP=0x00000000002bcfb8
- (id)preferredStoreStringIdentifierForPersonID:(id)arg1;	// IMP=0x00000000002bcf68
- (id)identifierDescriptions:(_Bool)arg1;	// IMP=0x00000000002bc49a
- (id)_stateDumpObject;	// IMP=0x00000000002bc3f7
...
- (void)clearRadioIdentifiers;	// IMP=0x00000000002bc0dd
- (void)setRadioIdentifiersWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002bc0cc
- (void)clearUniversalStoreIdentifiers;	// IMP=0x00000000002bc03a
- (void)setUniversalStoreIdentifiersWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002bc029
- (void)clearPersonalStoreIdentifiers;	// IMP=0x00000000002bbfe1
- (void)setPersonalStoreIdentifiersWithPersonID:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000002bbebb
- (void)clearLibraryIdentifiers;	// IMP=0x00000000002bbe90
- (void)setLibraryIdentifiersWithDatabaseID:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000002bbd6a
- (id)unionSet:(id)arg1;	// IMP=0x00000000002bbcc6
- (_Bool)hasCommonIdentifierWithIdentifierSet:(id)arg1;	// IMP=0x00000000002bb4b6
- (_Bool)intersectsSet:(id)arg1;	// IMP=0x00000000002ba029
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002b9d15
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002b9c3f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002b993a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b8ef1
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) NSString *humanDescription;
@property(readonly, copy) NSString *description;
- (id)copyWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002b8767
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002b8750
- (id)initWithModelKind:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b873e
- (id)_initWithModelKind:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b868f
