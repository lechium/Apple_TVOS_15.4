...
+ (id)allSupportedProperties;	// IMP=0x00000000000447fd
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x0000000000044919
