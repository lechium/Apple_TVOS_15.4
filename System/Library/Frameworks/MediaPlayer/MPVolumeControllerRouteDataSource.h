...
- (void).cxx_destruct;	// IMP=0x00000000002c8032
...
- (void)_routeVolumeControlCapabilitiesDidChangeNotification:(id)arg1;	// IMP=0x00000000002c7d9c
- (void)_routeVolumeDidChangeNotification:(id)arg1;	// IMP=0x00000000002c7b9a
- (void)getVolumeValueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002c79ec
- (void)_updateVolumeControlCapabilities:(unsigned int)arg1;	// IMP=0x00000000002c78cb
- (void)initializeVolume;	// IMP=0x00000000002c74f4
- (void)adjustVolumeValue:(float)arg1;	// IMP=0x00000000002c7498
- (void)reload;	// IMP=0x00000000002c7419
- (void)_sendVolumeButtonEventWithUsagePage:(unsigned int)arg1 usage:(unsigned int)arg2 down:(_Bool)arg3;	// IMP=0x00000000002c73be
- (void)endIncreasingRelativeVolume;	// IMP=0x00000000002c739f
- (void)beginIncreasingRelativeVolume;	// IMP=0x00000000002c737d
- (void)endDecreasingRelativeVolume;	// IMP=0x00000000002c735e
- (void)beginDecreasingRelativeVolume;	// IMP=0x00000000002c733c
- (void)_setPendingVolumeIfNeeded;	// IMP=0x00000000002c6ec3
...
- (void)dealloc;	// IMP=0x00000000002c6b6e
- (id)initWithGroupRoute:(id)arg1 outputDeviceRoute:(id)arg2;	// IMP=0x00000000002c6913
