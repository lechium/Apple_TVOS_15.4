...
- (void).cxx_destruct;	// IMP=0x0000000000008203
@property(retain, nonatomic) MPModelSocialPerson *person; // @synthesize person=_person;
- (id)queryItems;	// IMP=0x00000000000081e0
- (long long)httpMethod;	// IMP=0x00000000000081d5
- (long long)httpBodyType;	// IMP=0x00000000000081ca
- (id)httpBody;	// IMP=0x00000000000080a3
- (id)bagKey;	// IMP=0x0000000000008096
