...
- (void).cxx_destruct;	// IMP=0x00000000001886fe
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x000000000018843c
- (id)_parsedElements:(id)arg1;	// IMP=0x0000000000188211
- (id)_parsedSectionedCollection;	// IMP=0x0000000000187a6e
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000018790d
