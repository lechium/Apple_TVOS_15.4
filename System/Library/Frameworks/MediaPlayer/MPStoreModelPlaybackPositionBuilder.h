...
+ (id)allSupportedProperties;	// IMP=0x000000000015cd86
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000015ce6b
