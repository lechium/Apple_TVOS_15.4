...
+ (id)allSupportedProperties;	// IMP=0x0000000000102102
- (void).cxx_destruct;	// IMP=0x0000000000103281
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000010271f
