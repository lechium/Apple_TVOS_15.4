...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000070fe0
- (void).cxx_destruct;	// IMP=0x0000000000070f5a
...
- (id)sectionTranslationContext;	// IMP=0x0000000000070802
- (id)itemTranslationContext;	// IMP=0x0000000000070563
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000070534
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000700c0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006ff12
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006fbc6
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000006fb3f
