...
- (void).cxx_destruct;	// IMP=0x0000000000075f5f
...
- (id)initWithCommand:(id)arg1 playbackQueue:(id)arg2 options:(id)arg3;	// IMP=0x0000000000075d6b
- (id)initWithCommand:(id)arg1 mediaRemoteType:(unsigned int)arg2 options:(id)arg3;	// IMP=0x0000000000075b3f
