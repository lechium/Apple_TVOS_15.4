...
- (void).cxx_destruct;	// IMP=0x0000000000244df8
...
- (void)setStoreItemMetadata:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x0000000000244cea
- (id)storeItemMetadataForItemIdentifier:(id)arg1 returningIsFinalMetadata:(_Bool *)arg2;	// IMP=0x0000000000244cb8
- (id)storeItemMetadataForItemIdentifier:(id)arg1;	// IMP=0x0000000000244ca4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002449b6
- (id)init;	// IMP=0x000000000024491c
