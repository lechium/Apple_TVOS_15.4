...
- (void).cxx_destruct;	// IMP=0x00000000002a82a9
...
- (id)description;	// IMP=0x00000000002a7fa0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a7eea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a7e14
