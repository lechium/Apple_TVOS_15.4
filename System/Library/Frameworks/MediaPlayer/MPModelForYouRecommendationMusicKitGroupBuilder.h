...
+ (id)allSupportedItemProperties;	// IMP=0x00000000001c4234
+ (id)allSupportedGroupProperties;	// IMP=0x00000000001c4139
- (void).cxx_destruct;	// IMP=0x00000000001c2721
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001c2391
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001c226b
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001c2145
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001c1e55
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001c1d24
