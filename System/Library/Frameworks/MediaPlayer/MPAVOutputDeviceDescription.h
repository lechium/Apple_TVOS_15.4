...
- (void).cxx_destruct;	// IMP=0x000000000014b14a
...
- (unsigned long long)hash;	// IMP=0x000000000014b0cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014afcc
- (id)description;	// IMP=0x000000000014aea5
- (id)initWithDeviceType:(long long)arg1 deviceSubtype:(long long)arg2 uid:(id)arg3 modelID:(id)arg4;	// IMP=0x000000000014adf4
- (id)initWithDeviceType:(long long)arg1 deviceSubtype:(long long)arg2 uid:(id)arg3;	// IMP=0x000000000014addf
