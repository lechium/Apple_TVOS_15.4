...
+ (id)allSupportedProperties;	// IMP=0x000000000016ad17
- (void).cxx_destruct;	// IMP=0x000000000016ba03
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000016b112
