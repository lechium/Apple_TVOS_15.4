...
- (unsigned long long)hash;	// IMP=0x0000000000231778
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000231692
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x0000000000231637
