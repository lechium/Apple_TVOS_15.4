...
- (void)_setRadioAvailable:(_Bool)arg1;	// IMP=0x00000000000446a6
- (void)getRecentStationGroupsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000004468f
@property(readonly, nonatomic, getter=isRadioAvailable) _Bool radioAvailable;
- (void)dealloc;	// IMP=0x00000000000445a6
- (id)init;	// IMP=0x000000000004452e
