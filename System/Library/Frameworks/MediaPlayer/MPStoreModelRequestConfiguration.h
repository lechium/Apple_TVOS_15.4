...
- (void).cxx_destruct;	// IMP=0x00000000001c097d
...
- (id)initWithRequestedItemIdentifiers:(id)arg1 reason:(unsigned long long)arg2;	// IMP=0x00000000001c08cf
@property(readonly, copy, nonatomic) NSURLRequest *URLRequest;
- (id)initWithURLRequests:(id)arg1;	// IMP=0x00000000001c0821
- (id)initWithURLRequest:(id)arg1;	// IMP=0x00000000001c0745
