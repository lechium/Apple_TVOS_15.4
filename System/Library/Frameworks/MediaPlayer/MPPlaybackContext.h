...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000963dc
+ (_Bool)supportsAutoPlay;	// IMP=0x00000000000963d4
+ (Class)queueFeederClass;	// IMP=0x00000000000963c3
- (void).cxx_destruct;	// IMP=0x000000000009634e
...
- (_Bool)isCompatibleWithReplacementContext:(id)arg1 incompatibleReason:(id *)arg2;	// IMP=0x0000000000096173
- (void)clearStartItem;	// IMP=0x000000000009616d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000095efe
- (id)description;	// IMP=0x0000000000095bdc
- (id)descriptionComponents;	// IMP=0x0000000000095960
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000095888
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000095721
@property(readonly, nonatomic) _Bool shouldBecomeActive;
- (id)init;	// IMP=0x00000000000956bd
