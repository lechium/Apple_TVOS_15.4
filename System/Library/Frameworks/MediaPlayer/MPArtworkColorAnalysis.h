...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000161ba9
- (void).cxx_destruct;	// IMP=0x0000000000161b76
...
- (id)_copyWithClass:(Class)arg1;	// IMP=0x0000000000161aa9
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000161a7b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000161a70
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000161920
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001617dc
- (id)description;	// IMP=0x0000000000161679
