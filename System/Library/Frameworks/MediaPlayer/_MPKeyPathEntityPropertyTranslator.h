...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x0000000000173c16
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000173b84
- (void).cxx_destruct;	// IMP=0x0000000000173b5c
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x0000000000173b0a
