...
- (void).cxx_destruct;	// IMP=0x00000000001081f3
@property(retain, nonatomic) MPModelSocialPerson *person; // @synthesize person=_person;
- (id)queryItems;	// IMP=0x00000000001081d0
- (long long)httpMethod;	// IMP=0x00000000001081c5
- (long long)httpBodyType;	// IMP=0x00000000001081ba
- (id)httpBody;	// IMP=0x0000000000108093
- (id)bagKey;	// IMP=0x0000000000108086
