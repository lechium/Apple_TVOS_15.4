...
- (void).cxx_destruct;	// IMP=0x00000000001cbf6c
...
- (id)initWithImportElements:(id)arg1 referralObject:(id)arg2 usingCloudLibraryDestination:(_Bool)arg3;	// IMP=0x00000000001cbea0
- (id)initWithImportElements:(id)arg1 usingCloudLibraryDestination:(_Bool)arg2;	// IMP=0x00000000001cbe89
