...
+ (id)personalizedResponseForContentDescriptor:(id)arg1 requestedProperties:(id)arg2;	// IMP=0x000000000017995f
- (void).cxx_destruct;	// IMP=0x0000000000177b46
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy, nonatomic) MPStoreLibraryPersonalizationRequest *request; // @synthesize request=_request;
- (void)execute;	// IMP=0x0000000000176825
- (void)cancel;	// IMP=0x00000000001767dc
