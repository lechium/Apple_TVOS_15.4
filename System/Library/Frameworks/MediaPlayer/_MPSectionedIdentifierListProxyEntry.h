...
+ (id)endEntry;	// IMP=0x00000000000672ef
+ (id)startEntry;	// IMP=0x00000000000672ce
...
- (id)trackingEntryResult;	// IMP=0x00000000000672b4
- (id)itemResult;	// IMP=0x00000000000672ac
