...
- (void).cxx_destruct;	// IMP=0x00000000001cbc39
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001cbb6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001cba6c
