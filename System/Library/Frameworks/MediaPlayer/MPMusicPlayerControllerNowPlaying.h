...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001afb2f
+ (id)nowPlayingWithItem:(id)arg1 itemIdentifier:(id)arg2 artworkIdentifier:(id)arg3 index:(long long)arg4 count:(long long)arg5;	// IMP=0x00000000001afa52
- (void).cxx_destruct;	// IMP=0x00000000001afa1f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001af93d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001af7fe
- (id)_init;	// IMP=0x00000000001af7cf
