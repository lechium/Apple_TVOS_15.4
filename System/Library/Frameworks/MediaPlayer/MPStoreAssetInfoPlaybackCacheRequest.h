...
- (void).cxx_destruct;	// IMP=0x0000000000214352
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000214180
- (unsigned long long)hash;	// IMP=0x00000000002140f8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000214054
