...
+ (id)URLFromPath:(id)arg1;	// IMP=0x000000000001bec2
+ (_Bool)isPlaceholder;	// IMP=0x000000000001beba
- (void).cxx_destruct;	// IMP=0x000000000001ad0b
...
- (void)resumeContentKeySession;	// IMP=0x000000000001a903
- (void)pauseContentKeySession;	// IMP=0x000000000001a8fd
- (id)analyticsFormatType;	// IMP=0x000000000001a8f0
- (id)analyticsContentType;	// IMP=0x000000000001a8e3
- (void)_didBecomeActivePlayerItem;	// IMP=0x000000000001a8dd
- (void)_didResignActivePlayerItem;	// IMP=0x000000000001a8d7
- (void)_willResignActivePlayerItem;	// IMP=0x000000000001a8ca
- (void)_willBecomeActivePlayerItem;	// IMP=0x000000000001a8b6
- (void)_updateHasFinishedDownloading;	// IMP=0x000000000001a3e8
- (void)resolvePlaybackError:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000001a2a5
- (void)replacePlayerItemWithPlayerItem:(id)arg1;	// IMP=0x000000000001a178
- (void)reevaluateType;	// IMP=0x0000000000019cf8
- (void)reevaluateHasProtectedContent;	// IMP=0x0000000000019c70
- (void)invalidateContentItemAudioFormatInfo;	// IMP=0x0000000000019c1d
- (void)invalidateContentItemDeviceSpecificUserInfo;	// IMP=0x0000000000019bca
- (void)invalidateContentItemUserInfo;	// IMP=0x0000000000019b77
- (void)_setNeedsPersistedLikedStateUpdate;	// IMP=0x0000000000019abc
- (long long)_persistedLikedState;	// IMP=0x0000000000019a76
- (void)_handleUpdatedLikedState:(long long)arg1 forUserIdentity:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000019a70
- (double)_expectedStopTimeWithPlaybackInfo:(id)arg1;	// IMP=0x00000000000199c2
- (double)_expectedStartTimeWithPlaybackInfo:(id)arg1;	// IMP=0x0000000000019966
- (void)_applyLoudnessInfo;	// IMP=0x0000000000019960
- (void)_currentPlaybackRateDidChange:(float)arg1;	// IMP=0x000000000001995a
- (void)_updateDurationSnapshotWithElapsedTime:(double)arg1 playbackRate:(float)arg2;	// IMP=0x0000000000019904
- (void)setupWithPlaybackInfo;	// IMP=0x0000000000018f7d
- (void)setupEQPresetWithDefaultPreset:(long long)arg1;	// IMP=0x0000000000018e4c
- (id)_contentItemDeviceSpecificUserInfo;	// IMP=0x0000000000018115
- (id)_contentItemUserInfo;	// IMP=0x0000000000017754
- (void)_updateAudioFormatInfoForContentItem:(id)arg1;	// IMP=0x000000000001774e
- (void)_updateContentItem;	// IMP=0x0000000000016d9b
- (void)_onAssetQueueClearAsset;	// IMP=0x0000000000016d5a
- (void)_clearAssetNow;	// IMP=0x0000000000016d0f
- (void)_clearAsset;	// IMP=0x0000000000016cc4
- (void)_performContentItemUpdate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000016c12
- (_Bool)_shouldPublishArtworkURL;	// IMP=0x0000000000016bc0
- (void)_updateSoundCheckVolumeNormalizationForPlayerItem;	// IMP=0x0000000000016a07
- (void)_loadAssetProperties;	// IMP=0x00000000000169e1
- (double)_playableDurationForLoadedTimeRanges:(id)arg1;	// IMP=0x00000000000168df
- (id)_seekableTimeRanges;	// IMP=0x0000000000016820
- (id)_initialPlaybackStartTimeForPlaybackInfo:(id)arg1;	// IMP=0x0000000000016727
- (void)_likedStateDidChange;	// IMP=0x00000000000166b8
- (void)_removeObservationsForAVPlayerItem:(id)arg1;	// IMP=0x0000000000016631
- (void)_addObservationsForAVPlayerItem:(id)arg1;	// IMP=0x0000000000016598
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001633f
- (void)_itemAttributeAvailableKey:(id)arg1;	// IMP=0x0000000000016186
- (void)_internalLikedStateDidChangeNotification:(id)arg1;	// IMP=0x0000000000016121
...
- (double)_durationFromExternalMetadataIfAvailable;	// IMP=0x0000000000015b36
...
- (id)_imageChapterTrackIDsForAsset:(id)arg1;	// IMP=0x00000000000157f8
...
- (void)setLikedState:(long long)arg1 forUserIdentity:(id)arg2;	// IMP=0x000000000001548f
@property(nonatomic) long long likedState;
@property(nonatomic) _Bool hasPlayedThisSession;
- (float)scanIntervalForLevel:(unsigned long long)arg1 paused:(_Bool)arg2;	// IMP=0x0000000000015406
...
- (void)prepareForRate:(float)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000152ea
- (float)playbackRateForLevel:(unsigned long long)arg1 direction:(long long)arg2 paused:(_Bool)arg3;	// IMP=0x000000000001524e
...
- (_Bool)isAd;	// IMP=0x0000000000015032
...
- (_Bool)isValidPlayerSubstituteForItem:(id)arg1;	// IMP=0x0000000000014e08
...
- (void)applyVolumeNormalizationWithSoundCheckEnabled:(_Bool)arg1;	// IMP=0x0000000000014dea
...
- (long long)albumYear;	// IMP=0x0000000000014db2
@property(readonly, nonatomic) NSString *album;
@property(readonly, nonatomic) AVPlayerItemAccessLog *accessLog;
- (id)url;	// IMP=0x0000000000014cba
- (id)path;	// IMP=0x0000000000014bf4
- (double)durationInSeconds;	// IMP=0x0000000000014b55
...
- (void)setSubtitleTrackID:(int)arg1;	// IMP=0x0000000000014af4
- (int)subtitleTrackID;	// IMP=0x0000000000014aec
- (void)setRating:(float)arg1;	// IMP=0x0000000000014ae6
- (void)setPlaybackFinishedTime:(double)arg1;	// IMP=0x0000000000014adc
- (void)setPlaybackCheckpointCurrentTime:(double)arg1;	// IMP=0x0000000000014ad6
- (void)notePlaybackFinishedByHittingEnd;	// IMP=0x0000000000014ac5
- (void)setPlaybackStoppedTime:(double)arg1;	// IMP=0x0000000000014abf
- (void)resetBookkeeping;	// IMP=0x0000000000014ab5
...
- (void)updatePlayerItemMetadata;	// IMP=0x00000000000145de
- (void)_loadAssetAndPlayerItem;	// IMP=0x0000000000014480
- (void)loadAssetAndPlayerItem;	// IMP=0x000000000001447a
- (void)disableItemReuse;	// IMP=0x000000000001446d
- (id)description;	// IMP=0x00000000000143e5
...
- (void)dealloc;	// IMP=0x0000000000014252
- (id)initWithPlayerItem:(id)arg1;	// IMP=0x0000000000014032
- (id)initWithAsset:(id)arg1;	// IMP=0x0000000000013fd9
- (id)initWithURL:(id)arg1 options:(id)arg2;	// IMP=0x0000000000013f7f
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000013f23
- (id)init;	// IMP=0x0000000000013f0f
- (_Bool)isSupportedDefaultPlaybackSpeed:(long long)arg1;	// IMP=0x0000000000013f03
@property(readonly, nonatomic, getter=isPlaceholder) _Bool placeholder;
- (void)setMeetsPlaybackHistoryThresholdForElapsedTime:(double)arg1 startTime:(double)arg2;	// IMP=0x0000000000013ed0
- (CDUnknownBlockType)artworkCatalogBlock;	// IMP=0x00000000000429c6
- (id)artworkCatalogForPlaybackTime:(double)arg1;	// IMP=0x0000000000042962
