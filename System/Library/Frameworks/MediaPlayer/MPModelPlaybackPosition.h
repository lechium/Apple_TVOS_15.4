...
+ (id)__userPlayCount_KEY;	// IMP=0x0000000000216137
+ (id)__storeUbiquitousIdentifier_KEY;	// IMP=0x000000000021612a
+ (id)__stopTime_KEY;	// IMP=0x000000000021611d
+ (id)__startTime_KEY;	// IMP=0x0000000000216110
+ (id)__hasBeenPlayed_KEY;	// IMP=0x0000000000216103
+ (id)__shouldRememberBookmarkTime_KEY;	// IMP=0x00000000002160f6
+ (id)__bookmarkTime_KEY;	// IMP=0x00000000002160e9
