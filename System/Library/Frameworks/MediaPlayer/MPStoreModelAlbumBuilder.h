...
@interface MPStoreModelAlbumBuilder
{
    ...
    } _requestedAlbumProperties;	// 8 = 0x8
}

+ (id)allSupportedProperties;	// IMP=0x0000000000052321
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000005261d
