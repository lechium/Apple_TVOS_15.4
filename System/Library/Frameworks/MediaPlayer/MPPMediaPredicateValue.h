...
- (void).cxx_destruct;	// IMP=0x00000000002a9040
...
- (unsigned long long)hash;	// IMP=0x00000000002a8cd0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a8b5d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a8a2f
- (void)copyTo:(id)arg1;	// IMP=0x00000000002a889c
- (void)writeTo:(id)arg1;	// IMP=0x00000000002a875e
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002a8751
- (id)dictionaryRepresentation;	// IMP=0x00000000002a852a
- (id)description;	// IMP=0x00000000002a847b
...
- (void)dealloc;	// IMP=0x00000000002a82d1
