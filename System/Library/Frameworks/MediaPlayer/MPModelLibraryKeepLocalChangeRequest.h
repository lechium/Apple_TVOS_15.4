...
- (void).cxx_destruct;	// IMP=0x0000000000049d29
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000049c92
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000049c53
