...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000032809
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003265b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003251e
- (id)init;	// IMP=0x00000000000324bf
