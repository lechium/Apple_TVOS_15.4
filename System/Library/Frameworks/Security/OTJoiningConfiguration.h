...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000d661
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000d345
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000d240
- (id)initWithProtocolType:(id)arg1 uniqueDeviceID:(id)arg2 uniqueClientID:(id)arg3 pairingUUID:(id)arg4 containerName:(id)arg5 contextID:(id)arg6 epoch:(unsigned long long)arg7 isInitiator:(_Bool)arg8;	// IMP=0x000000000000d0dc
