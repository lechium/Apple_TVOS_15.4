...
- (void).cxx_destruct;	// IMP=0x000000000000f31b
...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x000000000000f168
- (unsigned int)hostHash;	// IMP=0x000000000000f13d
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000000ef91
