...
+ (id)typeForValue:(id)arg1;	// IMP=0x000000000002c990
+ (id)typeForEncoding:(const char *)arg1;	// IMP=0x000000000002c425
- (void).cxx_destruct;	// IMP=0x000000000002c3f2
...
- (void)getBytes:(void *)arg1 forObject:(id)arg2;	// IMP=0x000000000002c32c
- (id)objectWithBytes:(const void *)arg1;	// IMP=0x000000000002c148
...
- (id)initWithCode:(long long)arg1 encoding:(id)arg2 name:(id)arg3 className:(id)arg4 size:(unsigned long long)arg5 flags:(unsigned long long)arg6;	// IMP=0x000000000002c042
