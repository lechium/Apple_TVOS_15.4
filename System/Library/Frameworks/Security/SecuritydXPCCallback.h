...
- (void).cxx_destruct;	// IMP=0x000000000001a53e
@property(copy) CDUnknownBlockType callback; // @synthesize callback=_callback;
- (void)callCallback:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000001a4ae
- (id)initWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000001a443
