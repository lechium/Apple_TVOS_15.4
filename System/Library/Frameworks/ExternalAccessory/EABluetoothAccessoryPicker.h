...
+ (void)wakeSelectedBluetoothAccessories:(id)arg1;	// IMP=0x000000000000de07
@property(nonatomic) id <EABluetoothAccessoryPickerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dismissPicker;	// IMP=0x000000000000de9d
- (void)show;	// IMP=0x000000000000de89
- (void)dealloc;	// IMP=0x000000000000de5a
- (id)initWithPredicate:(id)arg1;	// IMP=0x000000000000de1b
