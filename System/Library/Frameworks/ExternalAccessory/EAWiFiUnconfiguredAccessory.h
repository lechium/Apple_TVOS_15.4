...
- (void).cxx_destruct;	// IMP=0x000000000000e50f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e2d5
- (id)description;	// IMP=0x000000000000e28d
- (id)initWithAirPortAssistantWACDevice:(id)arg1;	// IMP=0x000000000000e047
