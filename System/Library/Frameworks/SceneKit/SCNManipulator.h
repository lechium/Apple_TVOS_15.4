...
- (MISSING_TYPE *)_snapPositionToAlign:(struct SCNVector3)arg1 original:(double)arg2 unit:(_Bool)arg3 axisMove:(_Bool *)arg4 rayStart:(long long *)arg5 rayDir:didSnap:snapIndexes: /* Error: Ran out of types for this method. */;	// IMP=0x000000000006368e
- (void)prepareSnapToAlignDataIfNeeded;	// IMP=0x00000000000634e1
- (void)prepareSnapToAlignData;	// IMP=0x0000000000062f45
- (void)_prepareSnapToAlignData:(unsigned short)arg1 minOffset:maxOffset: /* Error: Ran out of types for this method. */;	// IMP=0x00000000000628e5
- (const CDStruct_962da47d *)snapInfoAtIndex:(unsigned long long)arg1 axis:(unsigned long long)arg2;	// IMP=0x0000000000062894
- (id)snapGuideIndexesOnAxis:(unsigned long long)arg1;	// IMP=0x000000000006286c
- (void)_updateCloneStateWithEvent:(CDStruct_8affffdd)arg1;	// IMP=0x0000000000062866
- (id)setupClones;	// IMP=0x0000000000062676
- (void)validateClones;	// IMP=0x0000000000062466
- (void)addClonesToScene;	// IMP=0x00000000000623fa
- (void)removeClonesFromScene;	// IMP=0x000000000006239d
- (id)scene;	// IMP=0x0000000000062366
- (_Bool)mouseUp:(CDStruct_8affffdd)arg1;	// IMP=0x0000000000062160
- (_Bool)mouseDown:(CDStruct_8affffdd)arg1;	// IMP=0x0000000000061c0e
- (_Bool)mouseDragged:(CDStruct_8affffdd)arg1;	// IMP=0x0000000000061b94
- (void)clearSnapIndexes;	// IMP=0x0000000000061b11
- (_Bool)_applyWithEvent:(CDStruct_8affffdd)arg1;	// IMP=0x0000000000060860
- (void)_deleteOriginalData;	// IMP=0x0000000000060805
- (void)_saveOriginalData;	// IMP=0x000000000006060c
- (void)updateItemsScale:(float)arg1;	// IMP=0x0000000000060251
- (void)updateItemsRotation: /* Error: Ran out of types for this method. */;	// IMP=0x000000000005fd0a
- (void)updateItemsPosition;	// IMP=0x000000000005f846
- (_Bool)mouseMoved:(CDStruct_8affffdd)arg1;	// IMP=0x000000000005f79c
- (void)_updateActionWithEvent:(CDStruct_8affffdd)arg1;	// IMP=0x000000000005f5ea
- (id)hitTest:(CDStruct_8affffdd)arg1;	// IMP=0x000000000005f273
- (void)unhighlightSelectedNode;	// IMP=0x000000000005f180
- (void)unlockLayout;	// IMP=0x000000000005f173
- (void)lockLayout;	// IMP=0x000000000005f166
@property(nonatomic) unsigned long long features;
- (void)setAlternateMode:(_Bool)arg1;	// IMP=0x000000000005f129
- (unsigned long long)_effectiveFeatures;	// IMP=0x000000000005f0e5
- (void)updateManipulatorComponents;	// IMP=0x000000000005eef2
- (void)editingSpaceChanged;	// IMP=0x000000000005eee0
- (void)updateManipulatorNode;	// IMP=0x000000000005ee4c
- (void)updateManipulatorPosition:(struct __C3DEngineContext *)arg1;	// IMP=0x000000000005e199
- (void)setupNode;	// IMP=0x000000000005d2ff
@property(readonly) SCNNode *manipulatorNode;
- (_Bool)isDragging;	// IMP=0x000000000005d2c9
- (long long)effectiveEditingSpace;	// IMP=0x000000000005d240
- (id)copy;	// IMP=0x000000000005d1f2
- (void)dealloc;	// IMP=0x000000000005d136
- (id)init;	// IMP=0x000000000005d01a
@property(readonly) struct SCNMatrix4 transform;
- (void)_setAuthoringEnvironment:(id)arg1;	// IMP=0x000000000005cfee
