...
- (void)dealloc;	// IMP=0x00000000001a70fd
- (id)prepareRendererAtIndex:(int)arg1 withScene:(id)arg2 renderSize:(struct CGSize)arg3 pointOfView:(id)arg4 parentRenderer:(id)arg5;	// IMP=0x00000000001a6f8b
- (struct __C3DFXPass *)transitionPass;	// IMP=0x00000000001a6f37
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a6e95
