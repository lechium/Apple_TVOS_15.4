...
+ (id)classesForKey;	// IMP=0x00000000000cf601
- (void).cxx_destruct;	// IMP=0x00000000000cf6b6
...
- (id)createAttachment;	// IMP=0x00000000000cf63d
- (id)initWithAttachment:(id)arg1;	// IMP=0x00000000000cf60e
