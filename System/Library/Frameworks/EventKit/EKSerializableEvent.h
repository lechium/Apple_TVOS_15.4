...
+ (id)classesForKey;	// IMP=0x000000000009c0f5
+ (id)serializedProperties;	// IMP=0x000000000009c036
- (void).cxx_destruct;	// IMP=0x000000000009dc82
...
- (id)createEventInEventStore:(id)arg1;	// IMP=0x000000000009d23e
- (void)_initRecurrenceRules:(id)arg1;	// IMP=0x000000000009d013
- (void)_initAttachments:(id)arg1;	// IMP=0x000000000009cdf7
- (void)_initAlarms:(id)arg1;	// IMP=0x000000000009cbdb
- (void)_initAttendees:(id)arg1;	// IMP=0x000000000009c9b3
- (id)initWithEvent:(id)arg1;	// IMP=0x000000000009c65a
