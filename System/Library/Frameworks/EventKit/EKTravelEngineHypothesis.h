...
+ (id)syntheticHypothesisWithStartDate:(id)arg1 conservativeTravelTime:(double)arg2 estimatedTravelTime:(double)arg3 aggressiveTravelTime:(double)arg4;	// IMP=0x000000000006b12b
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006aa67
- (void).cxx_destruct;	// IMP=0x000000000006b2c9
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006adbe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006aa6f
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006a8c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006a8b5
- (unsigned long long)hash;	// IMP=0x000000000006a652
- (_Bool)isEqualToHypothesis:(id)arg1;	// IMP=0x000000000006a2f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006a294
- (id)description;	// IMP=0x0000000000069ef1
- (id)initWithTransportType:(int)arg1 conservativeDepartureDate:(id)arg2 conservativeTravelTime:(double)arg3 suggestedDepartureDate:(id)arg4 estimatedTravelTime:(double)arg5 aggressiveDepartureDate:(id)arg6 aggressiveTravelTime:(double)arg7 routeName:(id)arg8 supportsLiveTraffic:(_Bool)arg9 currentTrafficDensity:(unsigned long long)arg10 trafficDensityDescription:(id)arg11 travelState:(long long)arg12;	// IMP=0x0000000000069d6c
