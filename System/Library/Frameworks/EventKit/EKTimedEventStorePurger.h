...
- (void).cxx_destruct;	// IMP=0x0000000000031284
...
- (void)_fireChangedBlock;	// IMP=0x00000000000310a8
- (void)_eventStoreChangedNotification:(id)arg1;	// IMP=0x0000000000030fb8
- (void)_removeTransientEventStoreChangeObserver;	// IMP=0x0000000000030f07
- (void)_databaseChangedExternally;	// IMP=0x0000000000030e07
- (void)_removePersistentNotificationObservers;	// IMP=0x0000000000030db4
- (void)_addPersistentNotificationObservers;	// IMP=0x0000000000030d41
- (void)_uninstallTimer;	// IMP=0x0000000000030cc1
- (void)_resetIdleTimer;	// IMP=0x0000000000030788
- (id)acquireCachedEventStoreOrCreate:(_Bool)arg1;	// IMP=0x00000000000304cd
...
- (void)dealloc;	// IMP=0x000000000002fa57
- (id)init;	// IMP=0x000000000002f923
