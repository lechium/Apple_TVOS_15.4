...
+ (id)classesForKey;	// IMP=0x000000000000bc33
- (void).cxx_destruct;	// IMP=0x000000000000c454
...
- (id)createAttendee:(id *)arg1;	// IMP=0x000000000000c080
- (id)initWithParticipant:(id)arg1;	// IMP=0x000000000000befe
