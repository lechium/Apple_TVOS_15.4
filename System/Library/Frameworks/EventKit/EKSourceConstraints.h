...
+ (id)allAllowSourceConstraints;	// IMP=0x0000000000005b4d
...
- (id)init;	// IMP=0x0000000000005bd8
- (id)initWithCDBSourceConstraintFlags:(CDStruct_d497be9b)arg1;	// IMP=0x0000000000005b93
