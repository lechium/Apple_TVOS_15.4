...
+ (id)sourceForInviteReplyNotification:(id)arg1;	// IMP=0x000000000003e2db
+ (id)knownRelationshipSingleValueKeys;	// IMP=0x000000000003e181
+ (Class)frozenClass;	// IMP=0x000000000003e170
- (_Bool)validate:(id *)arg1;	// IMP=0x000000000003e8d5
- (void)clearAlertedStatus;	// IMP=0x000000000003e88e
...
- (void)setShareeURLString:(id)arg1;	// IMP=0x000000000003e5a4
- (id)shareeURLString;	// IMP=0x000000000003e588
...
- (void)_setInviteReplyCalendar:(id)arg1;	// IMP=0x000000000003e3b2
@property(readonly, nonatomic) EKCalendar *inviteReplyCalendar;
- (id)initWithInviteReplyCalendar:(id)arg1;	// IMP=0x000000000003e32e
