...
+ (void)fetchCalendarItemChangesInCalendar:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000183e0
+ (void)fetchCalendarItemChangesInSource:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000182de
+ (void)fetchCalendarItemChangesInStore:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000181dc
+ (int)entityType;	// IMP=0x00000000000181d1
- (void).cxx_destruct;	// IMP=0x0000000000018961
...
- (id)initWithChangeProperties:(id)arg1;	// IMP=0x00000000000184e2
