...
- (void).cxx_destruct;	// IMP=0x0000000000044921
...
- (_Bool)proposedStartDateIsInFutureForAttendee:(id)arg1;	// IMP=0x00000000000447b7
- (_Bool)isProposedNewTime;	// IMP=0x00000000000447af
- (_Bool)acknowledgeWithEventStore:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004475f
- (_Bool)isInvitation;	// IMP=0x0000000000044757
- (_Bool)isSharedCalendarInvitation;	// IMP=0x000000000004474f
@property(readonly, nonatomic) _Bool needsAlert;
@property(readonly, nonatomic) NSString *uniqueIdentifier;
- (void)dealloc;	// IMP=0x0000000000044676
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000044620
