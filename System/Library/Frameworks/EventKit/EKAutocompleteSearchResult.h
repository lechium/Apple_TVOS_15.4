...
+ (_Bool)_participantShouldBeUsedForAutocomplete:(id)arg1;	// IMP=0x00000000000195d6
- (void).cxx_destruct;	// IMP=0x0000000000019a3f
...
- (unsigned long long)hash;	// IMP=0x0000000000019797
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000019538
- (void)dealloc;	// IMP=0x00000000000194fe
- (id)initWithUniqueID:(id)arg1;	// IMP=0x0000000000019496
