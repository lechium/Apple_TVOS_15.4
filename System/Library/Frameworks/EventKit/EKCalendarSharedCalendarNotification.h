...
- (_Bool)isSharedCalendarInvitation;	// IMP=0x000000000004061e
- (id)calendarFromEventStore:(id)arg1;	// IMP=0x00000000000405f8
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000040549
