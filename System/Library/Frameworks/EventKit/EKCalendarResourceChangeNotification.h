...
- (void).cxx_destruct;	// IMP=0x00000000000c2e8b
...
- (_Bool)needsAlert;	// IMP=0x00000000000c2c33
- (id)resourceChangeFromEventStore:(id)arg1;	// IMP=0x00000000000c2c0d
- (id)initWithType:(long long)arg1;	// IMP=0x00000000000c2bde
