...
+ (id)ownerForEKCalendar:(id)arg1;	// IMP=0x00000000000b55f1
+ (id)shareeWithEKSharee:(id)arg1 forCalendar:(id)arg2;	// IMP=0x00000000000b5387
- (void).cxx_destruct;	// IMP=0x00000000000b599b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b57df
