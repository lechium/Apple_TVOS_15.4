...
- (void).cxx_destruct;	// IMP=0x000000000009e1ed
...
- (void)faultIfNeededForObject:(id)arg1;	// IMP=0x000000000009e134
- (id)initWithRootObject:(id)arg1;	// IMP=0x000000000009e0c9
