...
- (void).cxx_destruct;	// IMP=0x000000000001772e
...
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x00000000000175f5
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001736e
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x0000000000017138
- (id)init;	// IMP=0x00000000000170d2
