...
- (void).cxx_destruct;	// IMP=0x00000000000452e3
...
- (_Bool)_vacuumQueue_vacuumKey:(id)arg1;	// IMP=0x0000000000045077
- (void)_vacuumQueue_vacuum;	// IMP=0x0000000000044cc3
- (void)vacuumIfNeeded;	// IMP=0x0000000000044adf
- (id)simpleRateLimiterForKey:(id)arg1;	// IMP=0x000000000004484a
- (_Bool)reservePerformActionForKey:(id)arg1;	// IMP=0x00000000000447ee
- (id)initWithMaximum:(unsigned long long)arg1 inTimeInterval:(double)arg2;	// IMP=0x0000000000044675
