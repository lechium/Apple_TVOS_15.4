...
- (void).cxx_destruct;	// IMP=0x000000000000648c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006125
- (unsigned long long)hash;	// IMP=0x0000000000005ee6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005c50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005a5e
- (void)copyTo:(id)arg1;	// IMP=0x00000000000058dd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000005761
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005754
- (id)dictionaryRepresentation;	// IMP=0x0000000000004ef4
- (id)description;	// IMP=0x0000000000004e45
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x000000000004f8e5
- (id)initWithObjectValue:(id)arg1;	// IMP=0x000000000004f86c
