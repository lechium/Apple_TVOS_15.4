...
- (void).cxx_destruct;	// IMP=0x0000000000054029
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000053d97
- (unsigned long long)hash;	// IMP=0x0000000000053c34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000539cb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053810
- (void)copyTo:(id)arg1;	// IMP=0x00000000000536bc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000053569
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000005355c
- (id)dictionaryRepresentation;	// IMP=0x0000000000052dc3
- (id)description;	// IMP=0x0000000000052d14
