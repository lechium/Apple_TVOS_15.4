...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000082389
+ (id)speechUtteranceWithSSMLRepresentation:(id)arg1;	// IMP=0x0000000000082381
+ (id)speechUtteranceWithAttributedString:(id)arg1;	// IMP=0x0000000000082379
+ (id)speechUtteranceWithString:(id)arg1;	// IMP=0x0000000000082371
+ (void)initialize;	// IMP=0x000000000008234d
- (void).cxx_destruct;	// IMP=0x000000000008231a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000082082
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000081cf1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000081a46
- (id)initWithSSMLRepresentation:(id)arg1;	// IMP=0x0000000000081a38
- (id)initWithAttributedString:(id)arg1;	// IMP=0x0000000000081a2a
- (id)initWithString:(id)arg1;	// IMP=0x0000000000081a1c
