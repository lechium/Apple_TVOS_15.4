...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000746dc
- (void).cxx_destruct;	// IMP=0x00000000000746cc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007456d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000744b2
- (id)initWithData:(id)arg1 inputID:(long long)arg2 outputID:(long long)arg3 sampleRate:(double)arg4 correlationValue:(double)arg5;	// IMP=0x0000000000074413
