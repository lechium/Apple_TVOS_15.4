...
- (_Bool)setManualRenderingInputPCMFormat:(id)arg1 inputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003015
- (float)rate;	// IMP=0x0000000000002fdf
- (void)setRate:(float)arg1;	// IMP=0x0000000000002fd9
