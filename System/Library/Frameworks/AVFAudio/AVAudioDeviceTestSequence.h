...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000074d57
- (void).cxx_destruct;	// IMP=0x0000000000074b6b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007489b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000074777
- (id)init;	// IMP=0x00000000000746e4
