...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000074d4f
- (void).cxx_destruct;	// IMP=0x0000000000074d27
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000074c17
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000074ba9
