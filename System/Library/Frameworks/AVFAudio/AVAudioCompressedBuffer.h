...
- (id)initWithFormat:(id)arg1 packetCapacity:(unsigned int)arg2;	// IMP=0x000000000007231e
- (id)initWithFormat:(id)arg1 packetCapacity:(unsigned int)arg2 maximumPacketSize:(long long)arg3;	// IMP=0x0000000000072048
