...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d0f9c
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d0f80
- (void).cxx_destruct;	// IMP=0x00000000000d1018
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d0f96
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d0f88
