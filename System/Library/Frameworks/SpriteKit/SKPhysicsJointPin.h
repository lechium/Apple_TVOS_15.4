...
+ (id)jointWithBodyA:(id)arg1 bodyB:(id)arg2 anchor:(struct CGPoint)arg3;	// IMP=0x00000000000d10b9
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d10a0
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d1098
