...
- (void).cxx_destruct;	// IMP=0x0000000000016410
...
- (void)_saveFavorite:(id)arg1;	// IMP=0x00000000000161e1
- (void)favoritesEntryPicker:(id)arg1 didPickEntry:(id)arg2;	// IMP=0x000000000001610f
- (void)performActionWithSender:(id)arg1;	// IMP=0x0000000000015fc1
- (_Bool)canPerformAction;	// IMP=0x0000000000015fb9
