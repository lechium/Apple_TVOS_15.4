...
+ (_Bool)sortUsingCoreDuetAvailable;	// IMP=0x00000000000c0f76
+ (id)managerForContact:(id)arg1;	// IMP=0x00000000000c0e68
- (void).cxx_destruct;	// IMP=0x00000000000c1695
...
- (id)sortedActions:(id)arg1;	// IMP=0x00000000000c1322
- (void)_updateDuetInteractionsIfNeeded;	// IMP=0x00000000000c131c
- (void)updateCachedEnabledStateForAction:(id)arg1;	// IMP=0x00000000000c1273
- (void)cacheEnabledStateForAction:(id)arg1;	// IMP=0x00000000000c11bf
- (double)scoreForAction:(id)arg1;	// IMP=0x00000000000c110b
- (void)actionPerformed:(id)arg1;	// IMP=0x00000000000c107b
- (id)init;	// IMP=0x00000000000c0f7e
