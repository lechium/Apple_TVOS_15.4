...
- (void).cxx_destruct;	// IMP=0x00000000000a1fe3
...
- (void)layoutSubviews;	// IMP=0x00000000000a1b9e
- (void)_updateGradients;	// IMP=0x00000000000a19dd
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000a199a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a189d
