...
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x000000000004cab7
- (void).cxx_destruct;	// IMP=0x000000000004e07c
...
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x000000000004de6c
- (void)handleTapGesture:(id)arg1;	// IMP=0x000000000004ddcd
- (void)updateLabelState;	// IMP=0x000000000004da77
- (void)updateImageViewState;	// IMP=0x000000000004d967
- (void)updatePlatterViewState;	// IMP=0x000000000004d919
- (void)updateConstraints;	// IMP=0x000000000004cbb7
- (void)didMoveToWindow;	// IMP=0x000000000004cb76
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004c9be
