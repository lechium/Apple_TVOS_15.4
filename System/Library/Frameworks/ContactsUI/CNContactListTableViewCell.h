...
+ (void)contentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000000004e237
+ (void)initialize;	// IMP=0x000000000004e133
- (void).cxx_destruct;	// IMP=0x000000000004ea2a
...
- (void)setUserInteractionEnabled:(_Bool)arg1;	// IMP=0x000000000004e754
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000004e23d
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000004e1b6
