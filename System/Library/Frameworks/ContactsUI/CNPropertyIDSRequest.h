...
+ (id)sharedWorkQueue;	// IMP=0x000000000005b005
- (void).cxx_destruct;	// IMP=0x000000000005c36a
...
- (void)_requestStatusOnMainQueue:(_Bool)arg1;	// IMP=0x000000000005b564
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x000000000005b49f
@property(readonly, nonatomic) _Bool cancelled;
- (void)cancel;	// IMP=0x000000000005b3b7
- (void)cleanupDelegate;	// IMP=0x000000000005b312
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 postToMainQueue:(_Bool)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000005b088
