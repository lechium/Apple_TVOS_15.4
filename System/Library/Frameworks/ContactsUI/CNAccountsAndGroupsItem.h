...
- (void).cxx_destruct;	// IMP=0x00000000000ae585
...
- (long long)localizedCompare:(id)arg1;	// IMP=0x00000000000ae433
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x00000000000ae136
- (void)_setSelected:(_Bool)arg1;	// IMP=0x00000000000adcb5
- (id)initWithType:(long long)arg1;	// IMP=0x00000000000ada85
