...
- (id)_cardViewControllerTransitioning;	// IMP=0x00000000000cf5e7
- (void)set_cardViewControllerTransitioning:(id)arg1;	// IMP=0x00000000000cf5d1
- (void)cnui_addChildViewController:(id)arg1;	// IMP=0x00000000000cf998
...
- (_Bool)_ab_isInPopoverRecursive:(_Bool)arg1;	// IMP=0x00000000000cf6e3
