...
+ (id)sourceWithEnvironment:(id)arg1 contactStore:(id)arg2;	// IMP=0x000000000000d56e
+ (id)sourceKind;	// IMP=0x000000000000d561
- (void).cxx_destruct;	// IMP=0x000000000000db83
...
- (id)peopleInGroup:(id)arg1 keysToFetch:(id)arg2;	// IMP=0x000000000000d72e
- (id)groups;	// IMP=0x000000000000d605
