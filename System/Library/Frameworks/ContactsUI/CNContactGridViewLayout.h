...
- (void).cxx_destruct;	// IMP=0x000000000009f54a
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x000000000009f33e
- (void)_updateLayoutMetrics;	// IMP=0x000000000009e97b
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000009e6d6
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000009e3ac
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x000000000009e37d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e2a8
