...
@interface CNFaceTimeCell <CNActionViewProtocol>
{
...
- (void).cxx_destruct;	// IMP=0x000000000004c96d
...
- (void)didPressActionView:(id)arg1 longPress:(_Bool)arg2;	// IMP=0x000000000004c825
- (void)tintColorDidChange;	// IMP=0x000000000004c81f
- (id)variableConstraints;	// IMP=0x000000000004c557
- (id)constantConstraints;	// IMP=0x000000000004c43c
- (id)rightMostView;	// IMP=0x000000000004c42a
- (double)minCellHeight;	// IMP=0x000000000004c41c
- (void)performDefaultAction;	// IMP=0x000000000004c3a5
- (id)labelView;	// IMP=0x000000000004c2c9
- (void)setActionsDataSource:(id)arg1;	// IMP=0x000000000004c2c3
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000004c0be
