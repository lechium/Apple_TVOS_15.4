...
+ (id)descriptorForRequiredKeys;	// IMP=0x0000000000053718
- (void).cxx_destruct;	// IMP=0x00000000000552d3
...
- (void)cellWasSingleTapped:(id)arg1;	// IMP=0x00000000000550a2
- (void)cellWasLongPressed:(id)arg1;	// IMP=0x0000000000055052
- (void)showMenu;	// IMP=0x0000000000054f6a
- (void)menuDidHide:(id)arg1;	// IMP=0x0000000000054f0d
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000000054f05
- (void)copy:(id)arg1;	// IMP=0x0000000000054e71
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x0000000000054e35
- (void)setMeContact:(id)arg1 footnoteTitle:(id)arg2 footnoteValue:(id)arg3;	// IMP=0x0000000000054aae
- (id)footnoteTextColor;	// IMP=0x00000000000548c1
- (id)footnoteFont;	// IMP=0x0000000000054833
- (_Bool)displaysContactInfo;	// IMP=0x0000000000054800
- (void)updateFontRelatedConstraints;	// IMP=0x0000000000054571
- (void)dealloc;	// IMP=0x00000000000544fc
- (id)init;	// IMP=0x0000000000053847
