...
+ (id)subtitleTextColor;	// IMP=0x0000000000079459
- (void).cxx_destruct;	// IMP=0x0000000000079d22
...
- (void)updateFonts;	// IMP=0x0000000000079a33
- (void)viewWillMoveToSuperview:(id)arg1;	// IMP=0x00000000000799e6
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000007948d
