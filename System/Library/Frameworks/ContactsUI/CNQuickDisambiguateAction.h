...
- (id)description;	// IMP=0x000000000001a24c
- (void)performWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000019b91
- (id)subtitleForContext:(long long)arg1;	// IMP=0x0000000000019b34
- (id)titleForContext:(long long)arg1;	// IMP=0x0000000000019a3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001993e
- (id)initWithActions:(id)arg1;	// IMP=0x00000000000198ce
