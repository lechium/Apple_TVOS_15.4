...
+ (id)sourceWithEnvironment:(id)arg1 contactStore:(id)arg2;	// IMP=0x0000000000092c2b
+ (id)sourceKind;	// IMP=0x0000000000092c1e
- (void).cxx_destruct;	// IMP=0x0000000000093a9c
...
- (CDUnknownBlockType)friendContactFromFriendHandleTransformWithKeysToFetch:(id)arg1;	// IMP=0x0000000000093320
- (void)fetchFriends;	// IMP=0x0000000000093197
- (id)peopleInGroup:(id)arg1 keysToFetch:(id)arg2;	// IMP=0x0000000000092e77
- (id)groups;	// IMP=0x0000000000092cd6
