...
- (void).cxx_destruct;	// IMP=0x00000000000ca469
...
- (void)invalidate;	// IMP=0x00000000000ca365
- (void)invalidateSearch;	// IMP=0x00000000000ca2e8
- (void)invalidateResults;	// IMP=0x00000000000ca262
- (void)reloadWithRequest:(id)arg1;	// IMP=0x00000000000c9cb9
- (void)reload;	// IMP=0x00000000000c9b24
@property(readonly, nonatomic) CNContactFilter *effectiveFilter;
- (id)indexPathForContact:(id)arg1;	// IMP=0x00000000000c99b1
- (id)completeContactFromContact:(id)arg1 fromMainStoreOnly:(_Bool)arg2 keysToFetch:(id)arg3;	// IMP=0x00000000000c9811
...
- (void)dealloc;	// IMP=0x00000000000c9649
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c9505
- (id)initWithStore:(id)arg1;	// IMP=0x00000000000c9321
