...
+ (id)animatingCell;	// IMP=0x000000000004fb79
+ (id)cellNibForContacts;	// IMP=0x000000000004fb71
+ (id)cellNibForMode:(long long)arg1;	// IMP=0x000000000004fb69
- (void).cxx_destruct;	// IMP=0x0000000000052cf9
...
- (void)trackHighlight:(id)arg1;	// IMP=0x000000000005275f
- (void)_animateActions:(id)arg1 fromIndex:(unsigned long long)arg2 withDelta:(long long)arg3 scrollDirection:(unsigned long long)arg4;	// IMP=0x0000000000051ff4
- (void)trackSwipe:(id)arg1;	// IMP=0x0000000000051a80
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000518aa
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000517a6
- (void)reloadData;	// IMP=0x0000000000050a34
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x00000000000506b9
- (void)prepareForReuse;	// IMP=0x000000000005061d
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000050303
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000502ec
- (void)awakeFromNib;	// IMP=0x000000000004fdc8
- (void)_updateFonts;	// IMP=0x000000000004fc78
