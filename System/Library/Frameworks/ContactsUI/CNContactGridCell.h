...
+ (double)actionsLeftMargin;	// IMP=0x00000000000a46d5
...
- (_Bool)isHighlighted;	// IMP=0x00000000000a5edf
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a5e93
- (void)_updateActionsMask;	// IMP=0x00000000000a5dc6
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x00000000000a5ced
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x00000000000a56dd
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x00000000000a4be8
- (void)_createViewsIfNeeded;	// IMP=0x00000000000a48aa
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000000000a4894
