...
- (void).cxx_destruct;	// IMP=0x0000000000083e61
...
- (void)reject;	// IMP=0x0000000000083ddc
- (void)confirm;	// IMP=0x0000000000083d8a
- (_Bool)_confirmOrReject:(_Bool)arg1;	// IMP=0x0000000000083d82
- (void)performActionForItem:(id)arg1 sender:(id)arg2;	// IMP=0x0000000000083a55
