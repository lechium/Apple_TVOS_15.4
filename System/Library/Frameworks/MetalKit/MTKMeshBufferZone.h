...
- (void).cxx_destruct;	// IMP=0x0000000000013be3
...
- (void)destroyBuffer:(id)arg1;	// IMP=0x0000000000013a99
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000013773
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x0000000000013630
