...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001c67c
@property(nonatomic) _Bool detected; // @synthesize detected=_detected;
@property(nonatomic) double confidence; // @synthesize confidence=_confidence;
@property(nonatomic) CDStruct_e83c9415 timeRange; // @synthesize timeRange=_timeRange;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001c7a8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001c684
@property(readonly) unsigned long long hash;
- (_Bool)isEqualToSpeechUtteranceResult:(id)arg1;	// IMP=0x000000000001c3c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c35c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001c298
