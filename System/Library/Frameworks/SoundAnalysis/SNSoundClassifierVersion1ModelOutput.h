...
{
    NSDictionary *__646;	// 8 = 0x8
    NSString *_classLabel;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x000000000007beb2
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007bdc8
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWith_646:(id)arg1 classLabel:(id)arg2;	// IMP=0x000000000007bd0f
