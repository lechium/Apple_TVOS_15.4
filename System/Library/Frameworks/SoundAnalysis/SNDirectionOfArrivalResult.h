...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000014506
- (void).cxx_destruct;	// IMP=0x0000000000014876
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014700
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001450e
@property(readonly) unsigned long long hash;
- (_Bool)isEqualToDirectionOfArrivalResult:(id)arg1;	// IMP=0x00000000000141c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000014162
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001408a
