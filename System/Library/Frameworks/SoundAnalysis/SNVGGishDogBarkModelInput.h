...
- (void).cxx_destruct;	// IMP=0x000000000007d54f
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007d43f
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000007d368
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000007d351
