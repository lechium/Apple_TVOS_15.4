...
- (void).cxx_destruct;	// IMP=0x0000000000072cbd
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000072bad
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000072ad6
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000072abf
