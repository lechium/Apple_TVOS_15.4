...
- (void).cxx_destruct;	// IMP=0x000000000008204f
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000081f3f
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000081e68
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000081e51
