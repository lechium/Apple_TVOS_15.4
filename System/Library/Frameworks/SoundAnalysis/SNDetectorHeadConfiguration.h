...
- (void).cxx_destruct;	// IMP=0x000000000006aee2
...
- (id)initWithMLModel:(id)arg1 detectorIdentifier:(id)arg2 outputLabel:(id)arg3 sampleRate:(double)arg4 windowLengthFrames:(unsigned int)arg5 stepSizeFrames:(unsigned int)arg6 featureExtractorConfiguration:(id)arg7;	// IMP=0x000000000006ad70
