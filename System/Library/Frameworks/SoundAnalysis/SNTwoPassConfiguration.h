...
- (void).cxx_destruct;	// IMP=0x0000000000050616
...
- (id)initWithFirstPassRequest:(id)arg1 secondPassRequest:(id)arg2 historicalDataAmount:(double)arg3;	// IMP=0x000000000005053b
