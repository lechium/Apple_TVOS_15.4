...
- (void).cxx_destruct;	// IMP=0x0000000000019651
@property(readonly) MLModelDescription *modelDescription; // @synthesize modelDescription=_modelDescription;
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000019617
- (id)initWithMLCustomModel:(id)arg1 modelDescription:(id)arg2;	// IMP=0x0000000000019560
