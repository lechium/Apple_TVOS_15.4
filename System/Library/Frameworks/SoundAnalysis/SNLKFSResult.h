...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001844
@property(nonatomic) float decibelLevel; // @synthesize decibelLevel=_decibelLevel;
@property(nonatomic) CDStruct_e83c9415 timeRange; // @synthesize timeRange=_timeRange;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001958
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000184c
@property(readonly) unsigned long long hash;
- (_Bool)isEqualToLKFSResult:(id)arg1;	// IMP=0x00000000000015fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000001597
