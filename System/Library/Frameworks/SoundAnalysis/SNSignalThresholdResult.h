...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006725a
@property(nonatomic) CDStruct_e83c9415 timeRange; // @synthesize timeRange=_timeRange;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006733f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000067262
@property(readonly) unsigned long long hash;
- (_Bool)isEqualToSignalThresholdResult:(id)arg1;	// IMP=0x00000000000670af
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000067048
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000066fbb
