...
- (void).cxx_destruct;	// IMP=0x0000000000083ae4
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000839d4
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x00000000000838fd
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000000838e6
