...
- (void).cxx_destruct;	// IMP=0x0000000000076813
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000076703
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000007662c
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000076615
