...
- (void).cxx_destruct;	// IMP=0x000000000007efe4
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007eed4
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000007edfd
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000007ede6
