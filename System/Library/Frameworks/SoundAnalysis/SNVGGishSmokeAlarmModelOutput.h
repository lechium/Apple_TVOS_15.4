...
- (void).cxx_destruct;	// IMP=0x0000000000084d00
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000084bc3
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x0000000000084ac1
