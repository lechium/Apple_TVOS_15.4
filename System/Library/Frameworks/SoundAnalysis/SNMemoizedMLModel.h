...
+ (unsigned long long)defaultMaxCacheSize;	// IMP=0x00000000000301d4
+ (id)withWrappedModel:(id)arg1;	// IMP=0x0000000000030176
+ (id)withWrappedModel:(id)arg1 maxCacheSize:(unsigned long long)arg2;	// IMP=0x0000000000030109
+ (id)new;	// IMP=0x000000000002ffc8
- (id).cxx_construct;	// IMP=0x0000000000030625
- (void).cxx_destruct;	// IMP=0x00000000000305f6
@property(readonly) id <SNMLModel> wrappedModel; // @synthesize wrappedModel=_wrappedModel;
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000301f5
@property(readonly) MLModelDescription *modelDescription;
- (id)initWithWrappedModel:(id)arg1 maxCacheSize:(unsigned long long)arg2;	// IMP=0x000000000003007f
- (id)initWithWrappedModel:(id)arg1;	// IMP=0x000000000002fffe
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002ff6c
- (id)init;	// IMP=0x000000000002ff10
