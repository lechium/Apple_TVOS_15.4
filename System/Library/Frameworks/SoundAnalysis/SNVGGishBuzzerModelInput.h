...
- (void).cxx_destruct;	// IMP=0x000000000008700e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000086efe
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000086e27
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000086e10
