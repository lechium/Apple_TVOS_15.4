...
- (void).cxx_destruct;	// IMP=0x0000000000068b65
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000068a6f
- (id)initWithModel:(id)arg1 modelDescription:(id)arg2;	// IMP=0x000000000006887c
