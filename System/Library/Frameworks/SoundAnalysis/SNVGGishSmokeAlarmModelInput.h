...
- (void).cxx_destruct;	// IMP=0x0000000000084a8e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008497e
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x00000000000848a7
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000084890
