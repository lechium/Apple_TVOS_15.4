...
- (void).cxx_destruct;	// IMP=0x000000000007ae54
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007ad44
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000007ac6d
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000007ac56
