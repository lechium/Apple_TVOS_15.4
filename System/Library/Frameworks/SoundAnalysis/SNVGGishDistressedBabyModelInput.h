...
- (void).cxx_destruct;	// IMP=0x0000000000071d13
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000071c03
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000071b2c
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000071b15
