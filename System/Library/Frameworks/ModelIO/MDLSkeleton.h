...
- (void).cxx_destruct;	// IMP=0x00000000004388a0
...
- (id)initWithName:(id)arg1 jointPaths:(id)arg2;	// IMP=0x00000000004386a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004385ca
