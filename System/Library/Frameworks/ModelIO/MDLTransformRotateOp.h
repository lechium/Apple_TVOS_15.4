...
- (void).cxx_destruct;	// IMP=0x000000000036ccaa
...
- (CDStruct_14d5dc5e)double4x4AtTime:(double)arg1;	// IMP=0x000000000036b904
- (CDStruct_14d5dc5e)float4x4AtTime:(double)arg1;	// IMP=0x000000000036a385
- (_Bool)IsInverseOp;	// IMP=0x000000000036a37c
- (id)initWithName:(id)arg1 inverse:(_Bool)arg2 order:(unsigned long long)arg3 data:(id)arg4;	// IMP=0x000000000036a2a0
