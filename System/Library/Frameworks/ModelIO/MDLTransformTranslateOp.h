...
- (void).cxx_destruct;	// IMP=0x000000000036a278
...
- (CDStruct_14d5dc5e)double4x4AtTime:(double)arg1;	// IMP=0x000000000036a0e6
- (CDStruct_14d5dc5e)float4x4AtTime:(double)arg1;	// IMP=0x000000000036a028
- (_Bool)IsInverseOp;	// IMP=0x000000000036a01f
- (id)initWithName:(id)arg1 inverse:(_Bool)arg2 data:(id)arg3;	// IMP=0x0000000000369f50
