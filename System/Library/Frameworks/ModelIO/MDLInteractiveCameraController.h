...
- (id).cxx_construct;	// IMP=0x00000000003eb31b
- (void).cxx_destruct;	// IMP=0x00000000003eb30b
...
- (void)update:(float)arg1;	// IMP=0x00000000003eb042
- (void)frameObject;	// IMP=0x00000000003eaebf
- (void)mouseMotionX:(float)arg1 Y:(float)arg2;	// IMP=0x00000000003eaeb9
...
- (void)frameBounds;	// IMP=0x00000000003eae18
- (id)init;	// IMP=0x00000000003ead44
