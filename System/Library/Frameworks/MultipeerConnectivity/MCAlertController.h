...
- (void)dealloc;	// IMP=0x00000000000312bb
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000031226
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000311c7
- (void)dismiss;	// IMP=0x0000000000031189
- (void)show;	// IMP=0x0000000000031037
