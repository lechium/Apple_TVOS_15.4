...
- (void)applicationWillTerminateNotification:(id)arg1;	// IMP=0x00000000000100da
- (void)applicationDidEnterBackgroundNotification:(id)arg1;	// IMP=0x0000000000010062
- (void)advertiser:(id)arg1 didReceiveInvitationFromPeer:(id)arg2 withContext:(id)arg3 invitationHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000000ff3f
- (void)presentNextInvitation;	// IMP=0x000000000000faee
- (void)handleUserInvitationDecision:(_Bool)arg1;	// IMP=0x000000000000fa2d
- (void)stop;	// IMP=0x000000000000fa02
- (void)start;	// IMP=0x000000000000f9d7
@property(nonatomic) __weak id <MCAdvertiserAssistantDelegate> delegate;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000000f81d
- (id)initWithServiceType:(id)arg1 discoveryInfo:(id)arg2 session:(id)arg3;	// IMP=0x000000000000f548
- (id)init;	// IMP=0x000000000000f514
