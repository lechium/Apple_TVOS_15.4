...
+ (id)logCategory;	// IMP=0x000000000009dfc9
+ (id)shortDescription;	// IMP=0x000000000009dfb7
- (void).cxx_destruct;	// IMP=0x000000000009df17
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009dcc2
@property(readonly, copy) NSString *description;
@property(readonly, copy, nonatomic) NSArray *attributeDescriptions;
@property(readonly, copy) NSString *privateDescription;
@property(readonly, copy) NSString *shortDescription;
- (id)payloadCopy;	// IMP=0x000000000009da5d
- (id)initWithPayload:(id)arg1;	// IMP=0x000000000009d8c7
- (id)initWithAccessoryUUID:(id)arg1 keyPaths:(id)arg2;	// IMP=0x000000000009d807
