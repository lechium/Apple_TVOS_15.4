...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000037b3a
- (void).cxx_destruct;	// IMP=0x0000000000037b12
...
- (unsigned long long)hash;	// IMP=0x00000000000379f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000037851
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000037759
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003761d
- (id)description;	// IMP=0x000000000003753c
- (id)initWithAudioPreferences:(id)arg1 videoPreferences:(id)arg2;	// IMP=0x000000000003749e
