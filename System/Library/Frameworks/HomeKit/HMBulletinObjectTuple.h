...
+ (id)tupleWithQueryType:(long long)arg1 uuidString:(id)arg2;	// IMP=0x00000000000c8428
...
- (id)initWithQueryType:(long long)arg1 uuidString:(id)arg2;	// IMP=0x00000000000c82b9
