...
- (void).cxx_destruct;	// IMP=0x0000000000245ff1
...
- (void)invalidate;	// IMP=0x0000000000245d25
- (void)acquireWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000245a0a
- (id)initWithHomeManager:(id)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000245935
