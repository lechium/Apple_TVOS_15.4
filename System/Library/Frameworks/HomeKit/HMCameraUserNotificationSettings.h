...
+ (id)shortDescription;	// IMP=0x00000000000e5c44
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000e5c3c
- (void).cxx_destruct;	// IMP=0x00000000000e5b57
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e56ff
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e55fb
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e5526
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e551b
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e530e
- (id)init;	// IMP=0x00000000000e52d2
