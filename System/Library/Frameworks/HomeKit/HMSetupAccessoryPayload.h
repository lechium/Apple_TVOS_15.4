...
+ (id)shortDescription;	// IMP=0x000000000025760a
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000257602
- (void).cxx_destruct;	// IMP=0x000000000025714e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025647a
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025626c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000256261
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000255ffb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000255c43
@property(readonly, copy, nonatomic) HMAccessoryCategory *category;
- (id)initWithSetupCode:(id)arg1 communicationProtocol:(long long)arg2;	// IMP=0x0000000000255b1c
- (id)initWithSetupCode:(id)arg1;	// IMP=0x0000000000255b0a
- (id)initWithSetupPayloadURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000255af8
- (id)initWithHAPSetupCode:(id)arg1;	// IMP=0x0000000000255ae1
- (id)initWithHAPSetupPayloadURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000254c52
