...
- (void).cxx_destruct;	// IMP=0x00000000002545d5
...
- (id)initWithUser:(id)arg1 URL:(id)arg2 shareToken:(id)arg3 containerID:(id)arg4 forHome:(id)arg5 fromUser:(id)arg6;	// IMP=0x000000000025441d
