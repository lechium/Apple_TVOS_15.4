...
+ (id)logCategory;	// IMP=0x000000000001cbb1
+ (id)remoteObjectInterface;	// IMP=0x000000000001cac4
+ (id)exportedInterface;	// IMP=0x000000000001ca31
- (void).cxx_destruct;	// IMP=0x000000000001c1bd
...
- (void)messageTransport:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x000000000001bff4
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001b7fd
- (void)registerReconnectionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000001b7c0
- (void)dealloc;	// IMP=0x000000000001b275
- (id)initWithConfiguration:(id)arg1 userInfo:(id)arg2;	// IMP=0x000000000001afda
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000001afc1
- (id)init;	// IMP=0x000000000001af60
