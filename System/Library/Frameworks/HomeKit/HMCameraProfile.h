...
+ (id)logCategory;	// IMP=0x00000000000f172a
- (void).cxx_destruct;	// IMP=0x00000000000f1661
...
- (id)logIdentifier;	// IMP=0x00000000000f14a1
- (_Bool)_mergeWithNewObject:(id)arg1;	// IMP=0x00000000000f1130
- (id)services;	// IMP=0x00000000000f10e0
...
- (id)initWithCameraProfile:(id)arg1;	// IMP=0x00000000000f0d5a
