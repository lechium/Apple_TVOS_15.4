...
- (void).cxx_destruct;	// IMP=0x000000000020c320
...
- (id)description;	// IMP=0x000000000020c1a6
...
- (id)asHomeEventTopic;	// IMP=0x000000000020c07d
- (id)asAccessorySettingTopic;	// IMP=0x000000000020c002
- (id)asAccessoryTopic;	// IMP=0x000000000020bf87
- (id)initWithTopic:(id)arg1;	// IMP=0x000000000020bf1c
