...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005b341
- (void).cxx_destruct;	// IMP=0x000000000005b2cc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005ae99
- (id)initWithName:(id)arg1 channel:(unsigned char)arg2 PANID:(id)arg3 extendedPANID:(id)arg4 masterKey:(id)arg5 passPhrase:(id)arg6 PSKc:(id)arg7;	// IMP=0x000000000005acff
