...
+ (id)shortDescription;	// IMP=0x000000000022a266
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000022a25e
- (void).cxx_destruct;	// IMP=0x000000000022a0ae
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000229cfc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000229c04
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000229b2e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000229b23
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002298d0
