...
- (void)requestAccessWithQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000001fb16
- (unsigned long long)queryAuthorizationStatus;	// IMP=0x000000000001faee
