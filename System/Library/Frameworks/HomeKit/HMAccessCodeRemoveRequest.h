...
- (void).cxx_destruct;	// IMP=0x00000000001c3e8a
@property(readonly) HMAccessoryAccessCode *accessoryAccessCode; // @synthesize accessoryAccessCode=_accessoryAccessCode;
- (id)createAccessCodeRemoveRequestValue;	// IMP=0x00000000001c3dec
- (id)initWithAccessoryAccessCode:(id)arg1;	// IMP=0x00000000001c3d81
