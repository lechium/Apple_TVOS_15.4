...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001bf607
- (void).cxx_destruct;	// IMP=0x00000000001bf515
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bf4b6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bf1f9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bf0e2
- (void)recomputeAssistantIdentifier;	// IMP=0x00000000001bf075
- (void)_recomputeAssistantIdentifier;	// IMP=0x00000000001bed8b
@property(readonly, nonatomic) NSUUID *uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (_Bool)_mergeWithNewObject:(id)arg1;	// IMP=0x00000000001bebfc
- (void)handleRuntimeStateUpdate:(id)arg1;	// IMP=0x00000000001bebf6
- (void)_registerNotificationHandlers;	// IMP=0x00000000001bebf0
- (void)_unconfigure;	// IMP=0x00000000001bebde
- (void)_unconfigureContext;	// IMP=0x00000000001beb48
- (void)__configureWithContext:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000001bea9b
@property(readonly, copy) NSString *description;
- (id)initWithUUID:(id)arg1 services:(id)arg2;	// IMP=0x00000000001be8f9
