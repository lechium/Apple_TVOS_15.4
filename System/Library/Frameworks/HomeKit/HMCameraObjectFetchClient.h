...
+ (id)logCategory;	// IMP=0x00000000001a88ca
- (void).cxx_destruct;	// IMP=0x00000000001a8469
...
- (id)logIdentifier;	// IMP=0x00000000001a82fb
- (void)handleDidFetchObjectsMessage:(id)arg1;	// IMP=0x00000000001a7d39
- (void)fetchWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a7a41
- (void)dealloc;	// IMP=0x00000000001a79ad
- (id)initWithUUID:(id)arg1 context:(id)arg2 messageName:(id)arg3 destination:(id)arg4;	// IMP=0x00000000001a7846
