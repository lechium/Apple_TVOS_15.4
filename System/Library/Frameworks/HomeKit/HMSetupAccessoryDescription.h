...
+ (id)shortDescription;	// IMP=0x00000000000594e6
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000594de
- (void).cxx_destruct;	// IMP=0x00000000000593cf
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000578d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000573d9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000056f8e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000056a89
...
- (void)updateAccessoryCategory:(id)arg1;	// IMP=0x000000000005667b
- (void)updateAppIdentifier:(id)arg1;	// IMP=0x0000000000056634
- (void)updateOwnershipToken:(id)arg1;	// IMP=0x0000000000056622
- (void)updateWithAccessory:(id)arg1;	// IMP=0x0000000000056514
- (void)updateWithSetupAccessoryPayload:(id)arg1;	// IMP=0x00000000000564cd
- (id)initWithStagedCHIPAccessoryPairingIdentifier:(id)arg1;	// IMP=0x000000000005644a
- (id)initWithAddRequest:(id)arg1 setupAccessoryPayload:(id)arg2 appID:(id)arg3 ownershipToken:(id)arg4;	// IMP=0x00000000000562e3
- (id)initToSetupAccessoriesWithSetupAccessoryPayload:(id)arg1 appID:(id)arg2 homeName:(id)arg3 homeUUID:(id)arg4 trustedOrigin:(_Bool)arg5 ownershipToken:(id)arg6;	// IMP=0x00000000000562ca
- (id)initWithSetupAccessoryPayload:(id)arg1 appID:(id)arg2 homeUUID:(id)arg3 ownershipToken:(id)arg4;	// IMP=0x00000000000561bb
- (id)initWithAppIdentifier:(id)arg1 homeUUID:(id)arg2;	// IMP=0x00000000000560f6
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 appID:(id)arg3 homeName:(id)arg4 homeUUID:(id)arg5 trustedOrigin:(_Bool)arg6;	// IMP=0x00000000000560e0
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 appID:(id)arg3 homeUUID:(id)arg4;	// IMP=0x0000000000055fc7
