...
+ (id)logCategory;	// IMP=0x00000000001e1947
- (void).cxx_destruct;	// IMP=0x00000000001e190b
...
- (id)logIdentifier;	// IMP=0x00000000001e17dc
- (void)fillSlotWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001e17cc
@property(readonly) double currentAspectRatio;
- (id)initWithProfileUniqueIdentifier:(id)arg1 slotIdentifier:(id)arg2 aspectRatio:(id)arg3;	// IMP=0x00000000001e1697
