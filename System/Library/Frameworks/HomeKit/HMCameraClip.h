...
+ (id)shortDescription;	// IMP=0x00000000000476c9
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000476c1
+ (id)requiredHTTPHeadersForStreamingAssetVersion:(id)arg1;	// IMP=0x000000000004761c
- (void).cxx_destruct;	// IMP=0x0000000000047505
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000046ae1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000468b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000468aa
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004646f
