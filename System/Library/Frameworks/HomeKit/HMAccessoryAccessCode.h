...
+ (id)shortDescription;	// IMP=0x00000000001b4c09
+ (id)accessoryAccessCodeWithValue:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000001b4b27
- (void).cxx_destruct;	// IMP=0x00000000001b4af4
...
- (id)createAccessoryAccessCodeValue;	// IMP=0x00000000001b47ac
- (id)initWithAccessory:(id)arg1 accessCodeValue:(id)arg2 uniqueIdentifier:(id)arg3 hasRestrictions:(_Bool)arg4;	// IMP=0x00000000001b46d6
