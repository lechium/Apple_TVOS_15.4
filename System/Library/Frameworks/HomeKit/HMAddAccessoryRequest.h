...
+ (id)shortDescription;	// IMP=0x00000000000f2dc2
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f2dba
- (void).cxx_destruct;	// IMP=0x00000000000f2d71
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f2968
- (id)initWithIdentifer:(id)arg1 accessoryName:(id)arg2 accessoryCategory:(id)arg3;	// IMP=0x00000000000f2842
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f270f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f2659
- (id)payloadWithURL:(id)arg1 ownershipToken:(id)arg2;	// IMP=0x00000000000f257e
- (id)payloadWithOwnershipToken:(id)arg1;	// IMP=0x00000000000f24a3
