...
- (void)main;	// IMP=0x000000000020ca37
- (id)initWithHomeManager:(id)arg1 timeout:(double)arg2;	// IMP=0x000000000020c9c6
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000020c9b1
