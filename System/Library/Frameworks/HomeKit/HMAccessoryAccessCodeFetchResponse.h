...
+ (id)responseWithValue:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000001a8a82
- (void).cxx_destruct;	// IMP=0x00000000001a8a4f
...
- (id)initWithAccessory:(id)arg1 accessoryAccessCodes:(id)arg2 error:(id)arg3;	// IMP=0x00000000001a8931
