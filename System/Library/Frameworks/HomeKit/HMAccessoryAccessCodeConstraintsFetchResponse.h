...
+ (id)responseWithValue:(id)arg1 home:(id)arg2;	// IMP=0x00000000000c0e67
- (void).cxx_destruct;	// IMP=0x00000000000c0e34
...
- (id)initWithAccessory:(id)arg1 constraints:(id)arg2 error:(id)arg3;	// IMP=0x00000000000c0d16
