...
- (void).cxx_destruct;	// IMP=0x000000000022b5ff
@property __weak id <HMMediaProfileDelegate> delegate; // @synthesize delegate=_delegate;
- (void)refreshStateWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000022b3a1
- (_Bool)_mergeWithNewObject:(id)arg1;	// IMP=0x000000000022b275
- (void)fetchAccessorySleepWakeStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000022acfc
- (void)mediaProfile:(id)arg1 didUpdateMediaSession:(id)arg2;	// IMP=0x000000000022a745
@property(readonly) __weak NSUUID *containerUUID;
@property(readonly) __weak HMHome *containerHome;
- (void)setCapability:(unsigned long long)arg1;	// IMP=0x000000000022a56d
...
- (id)initWithMediaProfile:(id)arg1;	// IMP=0x000000000022a320
- (id)init;	// IMP=0x000000000022a278
