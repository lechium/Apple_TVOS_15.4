...
- (void).cxx_destruct;	// IMP=0x000000000022cc36
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000022cb2d
- (unsigned long long)hash;	// IMP=0x000000000022cac0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000022c9c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022c904
- (void)copyTo:(id)arg1;	// IMP=0x000000000022c881
- (void)writeTo:(id)arg1;	// IMP=0x000000000022c807
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000022c7fa
- (id)dictionaryRepresentation;	// IMP=0x000000000022c722
- (id)description;	// IMP=0x000000000022c673
