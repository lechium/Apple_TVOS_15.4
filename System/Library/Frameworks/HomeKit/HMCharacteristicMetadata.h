...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006c261
- (void).cxx_destruct;	// IMP=0x000000000006bf27
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006bf1c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006bcb1
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) NSUUID *uniqueIdentifier;
- (_Bool)_mergeWithNewObject:(id)arg1;	// IMP=0x000000000006b57e
@property(readonly, copy) NSString *description;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006af4e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006ad77
...
- (id)init;	// IMP=0x0000000000069dc9
