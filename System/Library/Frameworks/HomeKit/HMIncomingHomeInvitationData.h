...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000021095e
- (void).cxx_destruct;	// IMP=0x00000000002108e9
...
- (id)description;	// IMP=0x0000000000210700
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000021054c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000210335
@property(copy, nonatomic) NSString *inviterName; // @synthesize inviterName=_inviterName;
- (id)initWithInviterUserID:(id)arg1 invitationIdentifier:(id)arg2 inviterName:(id)arg3 invitationState:(long long)arg4 homeName:(id)arg5 homeUUID:(id)arg6 expiryDate:(id)arg7;	// IMP=0x0000000000210095
