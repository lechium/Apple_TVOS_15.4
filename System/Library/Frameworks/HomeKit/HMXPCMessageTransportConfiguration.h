...
+ (id)shortDescription;	// IMP=0x000000000002231f
- (void).cxx_destruct;	// IMP=0x0000000000021f7b
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021cd2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021cc7
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000021b58
- (id)initWithMachServiceName:(id)arg1;	// IMP=0x0000000000021ac8
