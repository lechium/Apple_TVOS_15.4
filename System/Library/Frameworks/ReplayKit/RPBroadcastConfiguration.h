...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001038a
- (void).cxx_destruct;	// IMP=0x00000000000103c3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000102b7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000101c8
