...
- (void).cxx_destruct;	// IMP=0x0000000000010d3d
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000010be7
- (id)init;	// IMP=0x0000000000010b0d
- (void)updateBroadcastURL:(id)arg1;	// IMP=0x0000000000010b07
- (void)_completeRequestWithReturnItems:(id)arg1;	// IMP=0x0000000000010917
- (void)updateServiceInfo:(id)arg1;	// IMP=0x0000000000010905
- (void)beginRequestWithExtensionContext:(id)arg1;	// IMP=0x00000000000108ff
