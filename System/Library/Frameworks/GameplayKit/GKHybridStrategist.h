...
- (id)bestMoveForActivePlayer;	// IMP=0x000000000002f196
- (_Bool)validateRandomSource;	// IMP=0x000000000002f121
- (_Bool)validateGameModel:(id)arg1;	// IMP=0x000000000002efda
- (void)dealloc;	// IMP=0x000000000002ef8c
- (id)init;	// IMP=0x000000000002ef01
