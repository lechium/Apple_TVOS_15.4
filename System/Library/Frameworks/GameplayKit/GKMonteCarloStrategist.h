...
- (id)bestMoveForActivePlayer;	// IMP=0x000000000002c7e4
- (_Bool)validateGameModel:(id)arg1;	// IMP=0x000000000002c69d
- (void)dealloc;	// IMP=0x000000000002c63f
- (id)init;	// IMP=0x000000000002c5b4
