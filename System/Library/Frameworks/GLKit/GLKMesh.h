...
+ (id)newMeshesFromAsset:(id)arg1 sourceMeshes:(id *)arg2 error:(id *)arg3;	// IMP=0x0000000000008c8b
+ (void)_createMeshesFromObject:(id)arg1 newMeshes:(id)arg2 sourceMeshes:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000008a1c
- (void).cxx_destruct;	// IMP=0x0000000000008f21
...
- (id)initWithMesh:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000008440
