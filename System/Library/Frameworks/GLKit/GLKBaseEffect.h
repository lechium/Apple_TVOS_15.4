...
- (id)description;	// IMP=0x000000000000181e
- (void)prepareToDraw;	// IMP=0x00000000000017d9
- (void)updateBaseEffect;	// IMP=0x000000000000168c
- (_Bool)perPixelLightingEnabled;	// IMP=0x0000000000001627
- (_Bool)perVertexLightingEnabled;	// IMP=0x00000000000015c2
...
- (id)init;	// IMP=0x0000000000000f6c
