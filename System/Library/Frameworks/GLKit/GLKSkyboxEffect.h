...
- (id)description;	// IMP=0x000000000001a788
- (void)dealloc;	// IMP=0x000000000001a714
- (void)draw;	// IMP=0x000000000001a6df
- (void)prepareToDraw;	// IMP=0x000000000001a697
- (void)updateSkyboxEffect;	// IMP=0x000000000001a519
- (void)createAndBindVAOWithPositions:(float *)arg1 texCoords:(float *)arg2;	// IMP=0x000000000001a39a
