...
- (_Bool)premultiplyWithAlpha:(void *)arg1 source:(void *)arg2 withWidth:(unsigned int)arg3 withHeight:(unsigned int)arg4 withRowBytes:(unsigned int)arg5 error:(id *)arg6;	// IMP=0x0000000000016da4
- (_Bool)reorientToGL:(void *)arg1 source:(void *)arg2 withWidth:(unsigned int)arg3 withHeight:(unsigned int)arg4 withRowBytes:(unsigned int)arg5 error:(id *)arg6;	// IMP=0x0000000000016c38
- (_Bool)determinePVRFormat:(unsigned int)arg1;	// IMP=0x0000000000016a19
- (_Bool)determineCGImageBlockFormatWithComponentType:(int)arg1 andPixelSize:(unsigned long long)arg2 andColorModel:(int)arg3;	// IMP=0x0000000000016966
- (_Bool)uploadToGLTexture:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x000000000001648b
- (_Bool)_uploadToGLTexture:(unsigned int)arg1 data:(id)arg2 width:(int)arg3 height:(int)arg4 dataCategory:(int)arg5 cubeMapIndex:(int)arg6 mipMapIndex:(int)arg7 error:(id *)arg8;	// IMP=0x000000000001618a
- (_Bool)loadCGImage:(struct CGImage *)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000160a7
- (_Bool)loadWithData:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000015e78
- (_Bool)decodeCGImage:(struct CGImage *)arg1;	// IMP=0x0000000000015e2d
- (_Bool)decodeCGImageImageProvider:(struct CGImage *)arg1 CGImageProvider:(struct CGImageProvider *)arg2;	// IMP=0x0000000000015bdd
- (_Bool)decodeCGImageDataProvider:(struct CGImage *)arg1;	// IMP=0x0000000000015945
- (void *)alignmentFix:(unsigned int)arg1 data:(const void *)arg2;	// IMP=0x0000000000015874
- (_Bool)loadPVRTCData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000015674
- (id)initWithDecodedData:(id)arg1 width:(unsigned int)arg2 height:(unsigned int)arg3 rowBytes:(unsigned int)arg4 texture:(id)arg5 cubeMapIndex:(int)arg6 options:(id)arg7 error:(id *)arg8;	// IMP=0x00000000000154f1
- (id)initWithCGImage:(struct CGImage *)arg1 forceCubeMap:(_Bool)arg2 wasCubeMap:(_Bool *)arg3 cubeMapIndex:(int)arg4 options:(id)arg5 error:(id *)arg6;	// IMP=0x000000000001545a
- (id)initWithData:(id)arg1 forceCubeMap:(_Bool)arg2 wasCubeMap:(_Bool *)arg3 cubeMapIndex:(int)arg4 options:(id)arg5 error:(id *)arg6;	// IMP=0x0000000000015330
- (_Bool)canHonorSRGBrequest;	// IMP=0x000000000001531c
- (_Bool)shouldApplyReorientToGL;	// IMP=0x0000000000015305
- (_Bool)shouldApplyPremultiplication;	// IMP=0x00000000000152e2
- (void)updateRequestedOperationsFromOptions:(id)arg1;	// IMP=0x0000000000015209
- (void)dealloc;	// IMP=0x00000000000151a0
- (id)init;	// IMP=0x0000000000015148
