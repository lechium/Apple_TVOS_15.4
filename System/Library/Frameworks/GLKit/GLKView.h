...
+ (Class)layerClass;	// IMP=0x000000000001d408
...
- (void)layoutSubviews;	// IMP=0x000000000001e964
- (void)setContentScaleFactor:(double)arg1;	// IMP=0x000000000001e8e5
- (void)display;	// IMP=0x000000000001e8ce
- (_Bool)_controlsOwnScaleFactor;	// IMP=0x000000000001e8c6
- (_Bool)_canDrawContent;	// IMP=0x000000000001e8be
- (void)displayLayer:(id)arg1;	// IMP=0x000000000001e898
...
- (void)bindDrawable;	// IMP=0x000000000001e5b9
...
- (void)_display:(_Bool)arg1;	// IMP=0x000000000001e301
- (_Bool)_presentFramebuffer;	// IMP=0x000000000001e2c1
- (void)_resolveAndDiscard;	// IMP=0x000000000001e1bd
- (void)_setFramebuffer:(_Bool *)arg1;	// IMP=0x000000000001e0de
- (void)_deleteFramebuffer;	// IMP=0x000000000001df82
- (void)deleteDrawable;	// IMP=0x000000000001df70
- (void)_createFramebuffer;	// IMP=0x000000000001d97b
- (void)dealloc;	// IMP=0x000000000001d8b7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001d7de
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d65a
- (id)initWithFrame:(struct CGRect)arg1 context:(id)arg2;	// IMP=0x000000000001d5de
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001d581
- (void)_initCommon;	// IMP=0x000000000001d419
