...
- (void).cxx_destruct;	// IMP=0x0000000000007455
...
- (void)dealloc;	// IMP=0x00000000000073f9
- (void)destroyBuffer:(id)arg1;	// IMP=0x00000000000072cd
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000006fc7
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x0000000000006f04
