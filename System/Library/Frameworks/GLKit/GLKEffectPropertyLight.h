...
+ (void)setStaticMasksWithVshRoot:(id)arg1 fshRoot:(id)arg2;	// IMP=0x000000000000bcd8
...
- (void)dealloc;	// IMP=0x000000000000c508
- (id)description;	// IMP=0x000000000000c2be
- (void)bind;	// IMP=0x000000000000bfdb
@property(readonly, nonatomic) unsigned char isAttenuated;
@property(readonly, nonatomic) unsigned char isSpot;
- (_Bool)includeFshShaderTextForRootNode:(id)arg1;	// IMP=0x000000000000bec6
- (_Bool)includeVshShaderTextForRootNode:(id)arg1;	// IMP=0x000000000000be71
@property(nonatomic) float spotCutoff; // @synthesize spotCutoff=_spotCutoff;
- (void)setNormalize:(unsigned char)arg1;	// IMP=0x000000000000b994
- (void)setShaderBindings;	// IMP=0x000000000000acd4
- (void)initializeMasks;	// IMP=0x000000000000aaf7
- (void)setGLDefaults;	// IMP=0x000000000000a9ce
- (void)dirtyAllUniforms;	// IMP=0x000000000000a9b2
- (id)initWithTransform:(id)arg1 lightingType:(int)arg2 firstLight:(unsigned char)arg3;	// IMP=0x000000000000a87e
