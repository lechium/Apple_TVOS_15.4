...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017634
- (void)dealloc;	// IMP=0x0000000000017605
- (_Bool)lossyCompressedSource;	// IMP=0x00000000000175fc
- (id)description;	// IMP=0x0000000000017423
- (id)initWithTextureTXR:(id)arg1 textureName:(unsigned int)arg2;	// IMP=0x0000000000017329
- (id)initWithTexture:(id)arg1 textureName:(unsigned int)arg2;	// IMP=0x00000000000171c4
