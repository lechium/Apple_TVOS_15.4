...
- (void)dealloc;	// IMP=0x000000000000d9ac
- (void)bind;	// IMP=0x000000000000d916
- (void)initializeMasks;	// IMP=0x000000000000d8b5
- (void)setShaderBindings;	// IMP=0x000000000000d791
- (void)dirtyAllUniforms;	// IMP=0x000000000000d5bc
- (id)initWithMode:(int)arg1 coord:(int)arg2;	// IMP=0x000000000000d4bc
- (id)init;	// IMP=0x000000000000d4a4
