...
+ (void)setStaticMasksWithVshRoot:(id)arg1 fshRoot:(id)arg2;	// IMP=0x0000000000010770
...
- (void)dealloc;	// IMP=0x0000000000010946
- (id)description;	// IMP=0x0000000000010776
- (void)bind;	// IMP=0x0000000000010671
@property(readonly, nonatomic) union _GLKMatrix3 normalMatrix; // @synthesize normalMatrix=_normalMatrix;
- (void)setShaderBindings;	// IMP=0x00000000000101aa
- (void)loadMatrix:(int)arg1 matrix:(union _GLKMatrix4)arg2;	// IMP=0x00000000000100b2
- (void)loadIdentity:(int)arg1;	// IMP=0x000000000001006e
- (void)dirtyAllUniforms;	// IMP=0x0000000000010052
