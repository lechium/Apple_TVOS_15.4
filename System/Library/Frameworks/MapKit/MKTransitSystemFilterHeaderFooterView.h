...
- (void).cxx_destruct;	// IMP=0x000000000016aacf
@property(readonly, nonatomic) MKTransitSystemFilterView *filterView; // @synthesize filterView=_filterView;
@property(retain, nonatomic) NSString *titleText;
- (void)_contentSizeDidChange;	// IMP=0x000000000016a9f1
- (void)_setupConstraints;	// IMP=0x000000000016a56b
- (void)_setupSubviews;	// IMP=0x000000000016a3b3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000016a341
