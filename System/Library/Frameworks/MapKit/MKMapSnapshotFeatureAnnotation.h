...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000217999
- (void).cxx_destruct;	// IMP=0x0000000000217c5c
...
- (void)setShowsBalloonCallout:(_Bool)arg1;	// IMP=0x0000000000217c24
- (id)feature;	// IMP=0x0000000000217c16
@property(readonly, copy) NSString *description;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000217a85
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002179a1
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 title:(id)arg2 representation:(long long)arg3;	// IMP=0x000000000021781b
