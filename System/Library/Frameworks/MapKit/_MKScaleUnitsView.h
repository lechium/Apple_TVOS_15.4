...
- (void).cxx_destruct;	// IMP=0x000000000018adeb
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x000000000018ac05
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x000000000018a929
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x000000000018a38f
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x0000000000189c36
- (void)setUnits:(id)arg1;	// IMP=0x00000000001899e0
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001898d7
- (void)clearCaches:(id)arg1;	// IMP=0x00000000001898ba
- (id)init;	// IMP=0x00000000001896b4
