...
- (void).cxx_destruct;	// IMP=0x00000000001fff6b
...
- (_Bool)_shouldCollapseTopMessageLabel;	// IMP=0x00000000001ffe85
- (void)_collapseAllLabelsFromOptions;	// IMP=0x00000000001ffc8d
- (void)_updateHoursView;	// IMP=0x00000000001fe4e8
- (void)_updateOptionsForCollapsingToSingleLineAndColor;	// IMP=0x00000000001fe468
- (id)_standardLabel;	// IMP=0x00000000001fe351
- (void)infoCardThemeChanged;	// IMP=0x00000000001fe280
- (_Bool)wantsDefaultClipping;	// IMP=0x00000000001fe278
- (void)applyRulesForTopAndBottomLabel;	// IMP=0x00000000001fdd1e
- (void)setTopLabel:(id)arg1;	// IMP=0x00000000001fdbb3
@property(readonly, nonatomic) _MKUILabel *topLabel;
- (void)_contentSizeDidChange;	// IMP=0x00000000001fd818
- (id)hoursGrayColor;	// IMP=0x00000000001fd7da
- (void)_commonInit;	// IMP=0x00000000001fd17f
- (id)initWithBusinessHours:(id)arg1;	// IMP=0x00000000001fd0b4
