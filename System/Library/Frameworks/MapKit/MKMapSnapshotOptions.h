...
@interface MKMapSnapshotOptions : NSObject <NSSecureCoding, NSCopying>
{
    ...
    _Bool _rendersInBackground;	// 100 = 0x64
    _Bool _useSnapshotService;	// 101 = 0x65
    _Bool _snapshotServiceSerialPerProcess;	// 102 = 0x66
    ...
    CDStruct_0b8f182b _cartographicConfiguration;	// 208 = 0xd0
    _Bool _usingRect;	// 248 = 0xf8
    _Bool _showsVenues;	// 249 = 0xf9
    unsigned char _searchResultsType;	// 250 = 0xfa
    MKPointOfInterestFilter *_pointOfInterestFilter;	// 256 = 0x100
    NSArray *_annotationViews;	// 264 = 0x108
    NSArray *_customFeatureAnnotations;	// 272 = 0x110
}

+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000213e1d
- (void).cxx_destruct;	// IMP=0x0000000000216366
...
- (void)_prepareToSubmit;	// IMP=0x0000000000215f17
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000215a69
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000214e73
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000214ab3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002141bf
- (id)init;	// IMP=0x0000000000213e25
