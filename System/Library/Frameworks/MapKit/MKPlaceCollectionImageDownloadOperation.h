...
- (void).cxx_destruct;	// IMP=0x00000000000e04e9
...
- (void)cancel;	// IMP=0x00000000000e037a
- (_Bool)isFinished;	// IMP=0x00000000000e036a
- (_Bool)isExecuting;	// IMP=0x00000000000e035a
- (void)markOperationAsComplete;	// IMP=0x00000000000e0222
- (void)main;	// IMP=0x00000000000dfa66
- (void)start;	// IMP=0x00000000000df9b8
- (id)initWithUrl:(id)arg1 downloadCache:(id)arg2 cacheId:(id)arg3;	// IMP=0x00000000000df8c4
