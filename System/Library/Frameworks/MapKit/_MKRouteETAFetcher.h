...
- (void).cxx_destruct;	// IMP=0x0000000000134b32
...
- (void)_didUpdateETAResult;	// IMP=0x0000000000134ac0
- (void)invalidateETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000134a6c
- (_Bool)isValidETA:(id)arg1;	// IMP=0x00000000001349c3
- (void)expireETAsIfNoLongerValid;	// IMP=0x0000000000134738
- (_Bool)shouldUpdateEstimatedTravelTimeForNewOrigin:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0000000000134642
...
- (_Bool)isUsingCurrentLocationForOrigin;	// IMP=0x00000000001343fc
- (void)requestNewETAForTransportType:(unsigned long long)arg1 additionalTransportTypes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000133d23
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000133cbc
- (void)_resetState;	// IMP=0x0000000000133c4f
- (void)dealloc;	// IMP=0x00000000001339bf
- (id)init;	// IMP=0x00000000001338fa
