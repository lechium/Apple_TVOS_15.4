...
- (void).cxx_destruct;	// IMP=0x000000000019cdfc
...
- (void)captureUserAction:(int)arg1;	// IMP=0x000000000019ccc6
- (id)infoCardChildUnactionableUIElements;	// IMP=0x000000000019ccb9
- (id)infoCardChildPossibleActions;	// IMP=0x000000000019cc22
- (void)updateUIForTheme:(id)arg1;	// IMP=0x000000000019cb79
- (void)infoCardThemeChanged;	// IMP=0x000000000019cb08
...
- (void)openAttribution;	// IMP=0x000000000019c8fe
- (void)pictureItemContainerRequestsSceneActivationWithPhotoGallery:(id)arg1;	// IMP=0x000000000019c889
- (void)viewDidLoad;	// IMP=0x000000000019b64c
- (id)initWithTextItemContainer:(id)arg1 title:(id)arg2 attribution:(id)arg3;	// IMP=0x000000000019b550
- (id)initWithPictureItemContainer:(id)arg1 title:(id)arg2 attribution:(id)arg3 presentingProtocol:(id)arg4;	// IMP=0x000000000019b3e2
- (id)initWithChildViewController:(id)arg1 title:(id)arg2 attribution:(id)arg3;	// IMP=0x000000000019b2ba
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000019b2b2
