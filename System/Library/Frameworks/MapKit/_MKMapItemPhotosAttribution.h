...
- (void).cxx_destruct;	// IMP=0x000000000005de8f
...
- (id)urlsForPhotoWithIdentifier:(id)arg1;	// IMP=0x000000000005ddee
@property(readonly, nonatomic) NSArray *addPhotoURLs;
- (id)initWithGEOMapItemAttribution:(id)arg1;	// IMP=0x000000000005dd4d
