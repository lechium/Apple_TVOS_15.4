...
- (void).cxx_destruct;	// IMP=0x0000000000069f1d
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000069e04
@property(readonly, nonatomic) UIImageView *badgeView;
- (void)_updateImageView;	// IMP=0x0000000000069a2d
- (void)setImage:(id)arg1;	// IMP=0x00000000000699ba
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000069929
