...
- (void).cxx_destruct;	// IMP=0x000000000011175b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000111586
- (unsigned long long)hash;	// IMP=0x00000000001114c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000111476
- (id)initWithNativeControllerName:(id)arg1 webControllerName:(id)arg2 bridgeVersion:(id)arg3;	// IMP=0x0000000000111390
