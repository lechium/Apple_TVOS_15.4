...
- (void).cxx_destruct;	// IMP=0x0000000000070bea
...
- (id)description;	// IMP=0x0000000000070aff
- (id)initWithAttributedString:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x0000000000070a66
