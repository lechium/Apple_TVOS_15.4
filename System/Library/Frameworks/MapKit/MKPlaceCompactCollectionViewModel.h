...
- (void).cxx_destruct;	// IMP=0x000000000016b28a
...
- (id)description;	// IMP=0x000000000016b132
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016b04d
@property(readonly, nonatomic) _Bool isWorldwide;
- (id)initWithGuideLocation:(id)arg1 titleFont:(id)arg2 subTitleFont:(id)arg3 context:(long long)arg4 useBorderHighlight:(_Bool)arg5;	// IMP=0x000000000016ab00
- (void)compactCollectionImageForSize:(struct CGSize)arg1 onCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000016b2e9
