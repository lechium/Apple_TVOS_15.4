...
- (void).cxx_destruct;	// IMP=0x00000000000bcf2a
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2;	// IMP=0x00000000000bcc14
- (void)cancel;	// IMP=0x00000000000bcbfe
@property(readonly, nonatomic) GEOMapRegion *boundingRegion;
- (id)traits;	// IMP=0x00000000000bcbda
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000bcb6f
