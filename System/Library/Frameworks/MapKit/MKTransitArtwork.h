...
+ (id)artworkWithIcon:(id)arg1 accessibilityText:(id)arg2;	// IMP=0x0000000000226493
+ (id)artworkWithText:(id)arg1;	// IMP=0x000000000022644a
+ (id)artworkWithShield:(id)arg1 accessibilityText:(id)arg2;	// IMP=0x0000000000226296
- (void).cxx_destruct;	// IMP=0x0000000000226647
...
- (id)initWithIcon:(id)arg1 fallbackShield:(id)arg2 accessibilityText:(id)arg3;	// IMP=0x0000000000226516
- (id)initWithIcon:(id)arg1 accessibilityText:(id)arg2;	// IMP=0x00000000002264ff
- (id)initWithText:(id)arg1;	// IMP=0x00000000002263c4
- (id)initWithShield:(id)arg1 accessibilityText:(id)arg2;	// IMP=0x0000000000226302
