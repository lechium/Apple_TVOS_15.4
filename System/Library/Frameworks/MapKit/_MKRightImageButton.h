...
- (void).cxx_destruct;	// IMP=0x00000000000e3b36
- (_Bool)isHighlighted;	// IMP=0x00000000000e3b26
@property(readonly, nonatomic) UIImageView *imageView; // @synthesize imageView=_imageView;
@property(readonly, nonatomic) _MKUILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000e3a68
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000e3a53
@property(retain, nonatomic) UIImage *image;
@property(retain, nonatomic) NSString *title;
- (void)updateConstraints;	// IMP=0x00000000000e3710
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000e36a1
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000e35e8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000e31df
