...
- (void).cxx_destruct;	// IMP=0x00000000001a540b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a5390
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a527e
- (unsigned long long)hash;	// IMP=0x00000000001a522e
- (id)initWithSize:(struct CGSize)arg1 headingString:(id)arg2 compassViewStyle:(long long)arg3;	// IMP=0x00000000001a5187
