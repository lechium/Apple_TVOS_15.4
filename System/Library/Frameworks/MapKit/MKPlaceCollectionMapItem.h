...
- (void).cxx_destruct;	// IMP=0x000000000021c721
...
- (id)description;	// IMP=0x000000000021c633
@property(readonly, nonatomic) GEOQuickLink *appClip;
- (id)initWithMapItem:(id)arg1 placeCollectionItem:(id)arg2;	// IMP=0x000000000021c494
