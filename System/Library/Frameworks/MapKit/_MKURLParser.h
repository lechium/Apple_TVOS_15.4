...
+ (_Bool)isAppleMapsGuidesURL:(id)arg1;	// IMP=0x000000000003e411
+ (_Bool)isValidMapURL:(id)arg1;	// IMP=0x000000000003e3f8
- (void).cxx_destruct;	// IMP=0x000000000003e9d0
...
- (_Bool)parseIncludingCustomParameters:(_Bool)arg1;	// IMP=0x000000000003e559
- (id)initWithURL:(id)arg1;	// IMP=0x000000000003e4d7
