...
- (void).cxx_destruct;	// IMP=0x000000000015507e
...
- (void)clearQueryState;	// IMP=0x0000000000154c17
@property(readonly, nonatomic) NSArray *results;
- (void)retry;	// IMP=0x0000000000154bc6
- (void)cancel;	// IMP=0x0000000000154a35
- (void)_cancelTimer;	// IMP=0x00000000001549ee
- (_Bool)resultsAreCurrent;	// IMP=0x00000000001549e2
@property(readonly, nonatomic, getter=isSearching) _Bool searching;
- (int)source;	// IMP=0x000000000015492e
- (void)setSource:(int)arg1;	// IMP=0x00000000001548e4
- (void)_updateFilters;	// IMP=0x0000000000154726
@property(nonatomic) long long filterType; // @synthesize filterType=_filterType;
- (double)timeToNextRequest;	// IMP=0x000000000015401b
- (void)_scheduleRequestWithTimeToNextRequest:(double)arg1;	// IMP=0x0000000000153fbb
- (void)_markDirtyAndScheduleRequestWithTimeToNextRequest:(double)arg1;	// IMP=0x0000000000153f08
- (void)_markDirty;	// IMP=0x0000000000153eda
- (void)_schedulePendingRequest;	// IMP=0x0000000000153e8e
- (id)_completionTicketForPrivateFilterType:(long long)arg1 traits:(id)arg2;	// IMP=0x0000000000153c0f
- (id)_completionTicketForFilterTypeWithTraits:(id)arg1;	// IMP=0x00000000001539ce
- (void)_fireRequest;	// IMP=0x0000000000152e48
- (void)_handleError:(id)arg1 forTicket:(id)arg2;	// IMP=0x00000000001529b3
- (void)_notifyDelegatesWithResults:(id)arg1 sections:(id)arg2 shouldDisplayNoResults:(_Bool)arg3 shouldEnableRAPForNoResults:(_Bool)arg4 ticket:(id)arg5;	// IMP=0x00000000001524b5
- (void)_handleCompletion:(id)arg1 shouldDisplayNoResults:(_Bool)arg2 shouldEnableRAPForNoResults:(_Bool)arg3 forTicket:(id)arg4;	// IMP=0x0000000000151667
- (void)dealloc;	// IMP=0x0000000000151629
- (id)init;	// IMP=0x00000000001514ba
