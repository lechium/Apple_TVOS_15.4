...
+ (_Bool)_newStationCardUIEnabled;	// IMP=0x000000000005e83c
+ (unsigned long long)_kMaxLinesInSectionBeforePage;	// IMP=0x000000000005e82a
+ (unsigned long long)_kNumLinesFallbackValue;	// IMP=0x000000000005e805
+ (id)defaultFilterForInactiveLines;	// IMP=0x000000000005e784
+ (id)defaultFilterForDepartures;	// IMP=0x000000000005e703
