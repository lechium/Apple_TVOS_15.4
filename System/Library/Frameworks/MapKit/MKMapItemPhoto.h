...
- (void).cxx_destruct;	// IMP=0x0000000000202c00
...
- (id)urlForBestPhotoForSize:(struct CGSize)arg1;	// IMP=0x0000000000202b41
...
- (id)initWithGeoMapItemPhoto:(id)arg1 fallbackTitle:(id)arg2;	// IMP=0x000000000020260a
- (id)initWithGeoMapItemPhoto:(id)arg1;	// IMP=0x00000000002025f1
- (id)initWithPictureItem:(id)arg1;	// IMP=0x00000000002024a2
- (id)initWithGeoMapItemPhoto:(id)arg1 title:(id)arg2 subtitleComponents:(id)arg3;	// IMP=0x000000000020236d
