...
- (void)_updateSeparatorInset;	// IMP=0x0000000000001ee3
- (struct CGRect)_separatorFrame;	// IMP=0x0000000000001dcc
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000001d80
