...
- (void).cxx_destruct;	// IMP=0x00000000001e20f7
...
- (_Bool)hasAdditionalSnappingAngle;	// IMP=0x00000000001e2012
- (void)updateSnappedToNorth;	// IMP=0x00000000001e1e17
- (void)snapToNorthAnimated:(_Bool)arg1 forceTrueNorth:(_Bool)arg2;	// IMP=0x00000000001e1c38
- (void)stopRotatingWithFocusPoint:(struct CGPoint)arg1;	// IMP=0x00000000001e1bf0
- (void)updateRotationWithFocusPoint:(struct CGPoint)arg1 newValue:(double)arg2;	// IMP=0x00000000001e1945
- (void)startRotatingWithFocusPoint:(struct CGPoint)arg1 withSnapping:(_Bool)arg2;	// IMP=0x00000000001e182b
- (id)initWithMapLayer:(id)arg1;	// IMP=0x00000000001e17c7
- (id)init;	// IMP=0x00000000001e179d
