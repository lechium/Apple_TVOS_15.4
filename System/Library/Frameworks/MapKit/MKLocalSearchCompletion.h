...
- (void).cxx_destruct;	// IMP=0x0000000000151458
...
- (id)iconWithScale:(double)arg1;	// IMP=0x00000000001513cb
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x000000000015138b
...
- (void)sendFeedback;	// IMP=0x0000000000151180
- (id)copyStorage;	// IMP=0x0000000000151157
- (unsigned long long)hash;	// IMP=0x0000000000151141
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001510e2
- (id)description;	// IMP=0x0000000000150fe5
...
- (id)_geoCompletionItem;	// IMP=0x0000000000150e47
...
- (id)calloutTitle;	// IMP=0x0000000000150d16
- (id)queryLine;	// IMP=0x0000000000150d00
- (_Bool)getCoordinate:(struct CLLocationCoordinate2D *)arg1;	// IMP=0x0000000000150c6d
...
- (_Bool)isKindOfClass:(Class)arg1;	// IMP=0x0000000000150a2b
- (id)initWithGeoCompletionItem:(id)arg1 serverSectionIndex:(unsigned long long)arg2 serverItemIndexInSection:(unsigned long long)arg3;	// IMP=0x0000000000150940
