...
- (void).cxx_destruct;	// IMP=0x000000000017f839
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017f561
- (id)description;	// IMP=0x000000000018054b
@property(readonly, copy, nonatomic) NSDictionary *JSONObject;
- (id)initWithJSONObject:(id)arg1;	// IMP=0x000000000017f8ae
