...
- (void).cxx_destruct;	// IMP=0x0000000000226938
...
- (id)initWithKey:(unsigned int)arg1 value:(unsigned int)arg2;	// IMP=0x0000000000226811
@property(readonly, nonatomic) int iconType;
- (id)initWithCartoId:(unsigned int)arg1 defaultTransitType:(unsigned int)arg2;	// IMP=0x00000000002267a5
