...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000a5524
- (void)keyDown:(id)arg1;	// IMP=0x00000000000a5423
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000a5366
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000a527e
