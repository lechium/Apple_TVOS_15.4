...
- (void).cxx_destruct;	// IMP=0x000000000016444c
...
- (void)reset;	// IMP=0x0000000000164111
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x0000000000164030
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x0000000000163cf7
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x00000000001637b6
