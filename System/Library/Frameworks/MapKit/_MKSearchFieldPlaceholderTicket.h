...
- (void).cxx_destruct;	// IMP=0x00000000000bc8c6
@property(readonly, nonatomic) GEOMapServiceTraits *traits;
- (void)cancel;	// IMP=0x00000000000bc89a
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000bc611
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000bc593
