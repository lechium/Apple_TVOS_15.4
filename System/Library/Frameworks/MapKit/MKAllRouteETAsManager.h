...
- (void).cxx_destruct;	// IMP=0x000000000013789a
@property(nonatomic) __weak id <MKAllRouteETAsManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateETA;	// IMP=0x0000000000136d0d
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000136c82
...
- (id)init;	// IMP=0x0000000000136b3e
