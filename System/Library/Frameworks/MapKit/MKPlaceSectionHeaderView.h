...
- (void).cxx_destruct;	// IMP=0x0000000000005759
...
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000053d9
@property(retain, nonatomic) UIImage *icon;
@property(retain, nonatomic) NSString *seeMoreButtonText; // @synthesize seeMoreButtonText=_seeMoreButtonText;
- (void)updateConstraints;	// IMP=0x0000000000004ea0
- (void)updateContent;	// IMP=0x0000000000004e00
- (void)createConstraints;	// IMP=0x0000000000004012
- (_Bool)shouldStack;	// IMP=0x0000000000003cbd
- (void)_updateConstraints;	// IMP=0x0000000000003982
- (void)contentSizeDidChange;	// IMP=0x0000000000003971
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000367e
