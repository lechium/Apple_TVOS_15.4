...
- (void).cxx_destruct;	// IMP=0x00000000000babd5
...
- (id)viewForZoomingInScrollView:(id)arg1;	// IMP=0x00000000000bab6e
- (void)zoomWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000ba893
@property(retain, nonatomic) UIImage *image;
- (id)initWithImage:(id)arg1;	// IMP=0x00000000000ba191
