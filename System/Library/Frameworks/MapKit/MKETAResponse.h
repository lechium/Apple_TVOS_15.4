...
- (void).cxx_destruct;	// IMP=0x00000000000691f3
...
- (id)description;	// IMP=0x00000000000690ed
- (unsigned long long)_transportType:(int)arg1;	// IMP=0x00000000000690d1
- (id)initWithSource:(id)arg1 destination:(id)arg2 expectedTravelTime:(double)arg3 distance:(double)arg4 sortedETAs:(id)arg5;	// IMP=0x0000000000068ee2
