...
- (void).cxx_destruct;	// IMP=0x000000000016a2ce
...
- (void)_contentSizeDidChange;	// IMP=0x000000000016a1be
- (struct UIEdgeInsets)collectionView:(id)arg1 layout:(id)arg2 insetForSectionAtIndex:(long long)arg3;	// IMP=0x000000000016a1a4
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000000169fc7
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000000169ecb
- (void)_updateAppearance;	// IMP=0x0000000000169e2b
- (void)_setupConstraints;	// IMP=0x0000000000169a68
- (void)_setupCollectionView;	// IMP=0x00000000001697a4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000169732
