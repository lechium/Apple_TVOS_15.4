...
- (void).cxx_destruct;	// IMP=0x000000000017e110
@property(retain, nonatomic) NSDate *lastUpdated; // @synthesize lastUpdated=_lastUpdated;
@property(retain, nonatomic) UIImage *icon; // @synthesize icon=_icon;
@property(copy, nonatomic) NSString *title; // @synthesize title=_title;
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x000000000017e089
- (void)_updateLastUpdatedLabel;	// IMP=0x000000000017de46
@property(copy, nonatomic) NSString *incidentDescription;
- (void)didMoveToWindow;	// IMP=0x000000000017dd26
- (void)_contentSizeCategoryDidChange;	// IMP=0x000000000017dc62
- (void)dealloc;	// IMP=0x000000000017dbed
- (void)_updateConstraintValues;	// IMP=0x000000000017dab9
- (void)updateConstraints;	// IMP=0x000000000017d744
- (void)_setConstraints;	// IMP=0x000000000017cf38
- (void)infoCardThemeChanged;	// IMP=0x000000000017cdd3
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x000000000017c712
