...
- (void).cxx_destruct;	// IMP=0x0000000000197f35
@property(retain, nonatomic) MKMapItem *mapItem; // @synthesize mapItem=_mapItem;
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x0000000000197f1c
- (id)factoidAtIndex:(int)arg1;	// IMP=0x0000000000197e6c
- (id)initWithMapItem:(id)arg1 isUserLocation:(_Bool)arg2;	// IMP=0x0000000000197df6
@property(readonly, nonatomic) NSArray *factoids;
@property(readonly, nonatomic) NSArray *placeSummaryFactoids;
- (_Bool)canBeDisplayedInPlaceSummary;	// IMP=0x0000000000197ac6
