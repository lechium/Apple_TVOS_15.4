...
+ (id)keyPathsForValuesAffectingSubtitle;	// IMP=0x00000000001e3f8f
+ (void)_setAnnotationClass:(Class)arg1;	// IMP=0x00000000001e3c96
+ (id)title;	// IMP=0x00000000001e3c13
- (void).cxx_destruct;	// IMP=0x00000000001e4a0d
...
- (void)reset;	// IMP=0x00000000001e4991
@property(readonly, nonatomic) NSString *shortDescription;
- (void)_updateCoordinate;	// IMP=0x00000000001e46b1
- (id)annotation;	// IMP=0x00000000001e469f
@property(readonly, nonatomic) double headingDegrees;
- (_Bool)hasValidHeading;	// IMP=0x00000000001e4656
@property(nonatomic) struct CLLocationCoordinate2D coordinate;
- (_Bool)isEqualToLocation:(id)arg1;	// IMP=0x00000000001e42cd
@property(readonly, nonatomic) double accuracy;
@property(retain, nonatomic) CLLocation *location;
@property(copy, nonatomic) NSString *subtitle;
- (void)setCourse:(double)arg1;	// IMP=0x00000000001e3f79
- (double)course;	// IMP=0x00000000001e3f63
...
- (void)dealloc;	// IMP=0x00000000001e3d59
- (id)init;	// IMP=0x00000000001e3cd1
