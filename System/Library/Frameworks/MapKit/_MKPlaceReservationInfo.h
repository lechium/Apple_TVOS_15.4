...
- (void).cxx_destruct;	// IMP=0x0000000000217db8
...
- (id)initWithOpenTimes:(id)arg1 attributionProviderName:(id)arg2 providerLogoImage:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000000217c84
