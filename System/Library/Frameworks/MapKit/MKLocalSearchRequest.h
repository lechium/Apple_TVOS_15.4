...
+ (id)searchRequestWithCompletion:(id)arg1;	// IMP=0x000000000000ef65
- (void).cxx_destruct;	// IMP=0x000000000010fed2
...
- (id)description;	// IMP=0x000000000010fc3f
- (id)_dictionaryRepresentation;	// IMP=0x000000000010f986
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010f833
- (id)initWithMapsURL:(id)arg1;	// IMP=0x000000000010f465
- (id)initWithNaturalLanguageQuery:(id)arg1 region:(CDStruct_b7cb895d)arg2;	// IMP=0x000000000010f3c9
- (id)initWithNaturalLanguageQuery:(id)arg1;	// IMP=0x000000000010f35b
- (id)initWithCompletion:(id)arg1;	// IMP=0x000000000010f27b
- (id)init;	// IMP=0x000000000010f24c
