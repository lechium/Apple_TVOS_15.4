...
- (double)minimumInterItemSpacing;	// IMP=0x00000000001cdd48
- (struct UIEdgeInsets)sectionInsets;	// IMP=0x00000000001cdd29
- (struct CGSize)sizeForCollectionWithMaxCollectionsWidth:(double)arg1;	// IMP=0x00000000001cdab0
- (id)initWithCollectionsConfiguration:(CDStruct_7ddafc85)arg1 isSingleCollection:(_Bool)arg2 usingTraitCollections:(id)arg3 inContext:(long long)arg4;	// IMP=0x00000000001cd83b
- (id)initWithDefaultCollectionsConfigurationUsingTraitCollections:(id)arg1 inContext:(long long)arg2;	// IMP=0x00000000001cd80c
