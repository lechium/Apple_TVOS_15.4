...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000012498
+ (id)_soundWithAlertType:(long long)arg1 audioVolume:(id)arg2 critical:(_Bool)arg3 toneFileName:(id)arg4;	// IMP=0x0000000000011798
+ (id)soundWithAlertType:(long long)arg1;	// IMP=0x000000000001177e
+ (id)ringtoneSoundNamed:(id)arg1;	// IMP=0x000000000001175f
+ (id)soundNamed:(id)arg1;	// IMP=0x0000000000011740
+ (id)criticalSoundNamed:(id)arg1 withAudioVolume:(float)arg2;	// IMP=0x000000000001169e
+ (id)criticalSoundNamed:(id)arg1;	// IMP=0x000000000001167c
+ (id)defaultCriticalSoundWithAudioVolume:(float)arg1;	// IMP=0x0000000000011608
+ (id)defaultCriticalSound;	// IMP=0x00000000000115e6
+ (id)defaultRingtoneSound;	// IMP=0x00000000000115cf
+ (id)defaultSystemSound;	// IMP=0x00000000000115b8
+ (id)defaultSound;	// IMP=0x00000000000115a1
- (void).cxx_destruct;	// IMP=0x0000000000012af2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000012778
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000124a0
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012284
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012279
- (id)description;	// IMP=0x0000000000012240
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000011d82
- (unsigned long long)hash;	// IMP=0x0000000000011abc
- (id)init;	// IMP=0x0000000000011a35
