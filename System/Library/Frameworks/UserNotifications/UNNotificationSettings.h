...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000098e1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000096a1
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000009507
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000094fc
- (id)description;	// IMP=0x000000000000907e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008de5
- (unsigned long long)hash;	// IMP=0x000000000000895a
- (_Bool)hasEnabledAlertSettings;	// IMP=0x00000000000088c0
- (_Bool)hasEnabledSettings;	// IMP=0x0000000000008856
- (id)initWithAuthorizationStatus:(long long)arg1 soundSetting:(long long)arg2 badgeSetting:(long long)arg3 alertSetting:(long long)arg4 notificationCenterSetting:(long long)arg5 lockScreenSetting:(long long)arg6 carPlaySetting:(long long)arg7 announcementSetting:(long long)arg8 criticalAlertSetting:(long long)arg9 timeSensitiveSetting:(long long)arg10 scheduledDeliverySetting:(long long)arg11 directMessagesSetting:(long long)arg12 alertStyle:(long long)arg13 showPreviewsSetting:(long long)arg14 groupingSetting:(long long)arg15 providesAppNotificationSettings:(_Bool)arg16;	// IMP=0x0000000000008797
