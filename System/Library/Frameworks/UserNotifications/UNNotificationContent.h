...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001f580
- (void).cxx_destruct;	// IMP=0x0000000000020e8d
...
- (void)leaveSecurityScope;	// IMP=0x0000000000020d86
- (void)enterSecurityScope;	// IMP=0x0000000000020d2d
- (void)removeSecurityScope;	// IMP=0x0000000000020cd4
- (void)addSecurityScope:(id)arg1;	// IMP=0x0000000000020bfc
- (id)init;	// IMP=0x0000000000020aae
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001fea0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001f588
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001eeda
- (id)markedMutableCopyWithMessage:(id)arg1;	// IMP=0x000000000001ee74
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001ee69
- (id)_safeStringForString:(id)arg1 debug:(_Bool)arg2;	// IMP=0x000000000001ee16
- (id)_descriptionForDebug:(_Bool)arg1;	// IMP=0x000000000001eb5f
