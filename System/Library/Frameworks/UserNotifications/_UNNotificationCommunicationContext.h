...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000014918
...
- (id)_summaryFromContacts:(id)arg1 effectiveCount:(unsigned long long)arg2 includeMe:(_Bool)arg3;	// IMP=0x00000000000157b8
- (unsigned long long)_effectiveRecipientCount;	// IMP=0x0000000000015751
- (unsigned long long)_effectiveAllContactsCount;	// IMP=0x00000000000156fc
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000153c4
- (id)succinctDescription;	// IMP=0x0000000000015374
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000014ef1
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000014ea1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000014bb3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014920
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000014740
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000014735
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000141db
- (id)_initWithIdentifier:(id)arg1 associatedObjectUri:(id)arg2 bundleIdentifier:(id)arg3 displayName:(id)arg4 sender:(id)arg5 recipients:(id)arg6 contentURL:(id)arg7 imageName:(id)arg8 systemImage:(_Bool)arg9 mentionsCurrentUser:(_Bool)arg10 notifyRecipientAnyway:(_Bool)arg11 replyToCurrentUser:(_Bool)arg12 recipientCount:(unsigned long long)arg13;	// IMP=0x0000000000014012
- (_Bool)isAvatarImagePossible;	// IMP=0x0000000000013f9b
