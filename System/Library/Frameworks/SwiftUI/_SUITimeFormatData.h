...
+ (id)_timeLocaleForLocale:(id)arg1;	// IMP=0x000000000000a0e2
+ (id)_timeFormatDataAccessLock;	// IMP=0x000000000000a08d
+ (id)instanceForLocale:(id)arg1;	// IMP=0x0000000000009f8b
- (void).cxx_destruct;	// IMP=0x000000000000a513
...
- (id)initWithLocale:(id)arg1;	// IMP=0x000000000000a169
