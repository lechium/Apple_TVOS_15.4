...
- (void).cxx_destruct;	// IMP=0x0000000000570dcc
- (id)init;	// IMP=0x0000000000570d7d
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x0000000000570cc9
