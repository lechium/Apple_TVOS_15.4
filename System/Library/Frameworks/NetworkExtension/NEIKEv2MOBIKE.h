...
- (void).cxx_destruct;	// IMP=0x00000000000f7f1d
...
- (void)initiateMOBIKE:(unsigned long long)arg1 pathStatus:(long long)arg2 serverAddress:(id)arg3 earlyDisconnect:(_Bool)arg4;	// IMP=0x00000000000f7c22
- (_Bool)startMOBIKE:(id)arg1;	// IMP=0x00000000000f7713
- (void)mobikeDisconnect;	// IMP=0x00000000000f76d1
- (void)mobikeReassert;	// IMP=0x00000000000f75b8
- (_Bool)mobikeReadyCheck:(unsigned long long)arg1 pathStatus:(long long)arg2 mobikeServer:(id)arg3;	// IMP=0x00000000000f7489
- (void)mobikeStopWaitTimer;	// IMP=0x00000000000f7404
- (void)mobikeStartWaitTimer;	// IMP=0x00000000000f7295
- (void)dealloc;	// IMP=0x00000000000f722a
- (id)initWithQueue:(id)arg1 tunnelProvider:(id)arg2;	// IMP=0x00000000000f7106
