...
- (void).cxx_destruct;	// IMP=0x00000000000460b0
...
- (id)createAnswer;	// IMP=0x0000000000045c95
- (id)initWithName:(id)arg1 recordType:(long long)arg2 recordClass:(long long)arg3;	// IMP=0x0000000000045c14
