...
- (void).cxx_destruct;	// IMP=0x000000000010e092
...
- (void)releasePowerAssertionIfNeeded;	// IMP=0x000000000010dee7
- (void)takePowerAssertionIfNeededWithSession:(id)arg1;	// IMP=0x000000000010dd0e
- (void)sendCallbackSuccess:(_Bool)arg1 session:(id)arg2;	// IMP=0x000000000010dc1b
- (id)description;	// IMP=0x000000000010dbfa
- (void)dealloc;	// IMP=0x000000000010dbbc
- (id)initWithRequestType:(int)arg1;	// IMP=0x000000000010db4f
