...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ba0d4
- (void).cxx_destruct;	// IMP=0x00000000001bc7a5
...
- (id)copyLegacyDictionary;	// IMP=0x00000000001bbb4a
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000001bb2d8
- (_Bool)checkValidityAndCollectErrors:(id)arg1;	// IMP=0x00000000001bb203
- (id)clone;	// IMP=0x00000000001bb19e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bade1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ba94a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ba43d
- (id)init;	// IMP=0x00000000001ba429
- (id)initWithPluginType:(id)arg1;	// IMP=0x00000000001ba259
- (void)setPluginType:(id)arg1;	// IMP=0x00000000001ba0dc
