...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000013df02
- (void).cxx_destruct;	// IMP=0x000000000013e1ef
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013e09d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000013df0a
- (id)initWithIdentifier:(id)arg1 url:(id)arg2 machOUUIDs:(id)arg3 name:(id)arg4;	// IMP=0x000000000013de20
