...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000080ceb
- (void).cxx_destruct;	// IMP=0x0000000000081d22
...
- (_Bool)setIdentity:(struct __SecIdentity *)arg1;	// IMP=0x0000000000081a7d
- (_Bool)setTrustedServerCertificates:(id)arg1;	// IMP=0x000000000008168c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000081438
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000810ca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000080fcb
- (id)description;	// IMP=0x0000000000080cf3
