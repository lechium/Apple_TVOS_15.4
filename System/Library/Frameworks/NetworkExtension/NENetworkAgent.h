...
+ (id)agentFromData:(id)arg1;	// IMP=0x000000000013f1ff
+ (id)agentType;	// IMP=0x000000000013f1f2
+ (id)agentDomain;	// IMP=0x000000000013f1e5
- (void).cxx_destruct;	// IMP=0x000000000013fda3
...
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x000000000013f890
- (void)setStartHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000013f87e
@property(readonly) int sessionType;
@property(readonly, copy) NSUUID *configurationUUID;
- (id)copyAgentData;	// IMP=0x000000000013f71c
- (_Bool)matchesFileHandle:(id)arg1;	// IMP=0x000000000013f39c
- (id)initWithConfigUUID:(id)arg1 sessionType:(int)arg2 name:(id)arg3;	// IMP=0x000000000013f2f9
