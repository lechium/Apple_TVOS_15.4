...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000016fa57
- (void).cxx_destruct;	// IMP=0x0000000000170c49
...
- (id)copyLegacyDictionary;	// IMP=0x00000000001708ed
- (id)initFromLegacyDictionary:(id)arg1;	// IMP=0x00000000001704b1
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000170180
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016ff84
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016fd54
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000016fb1b
- (id)init;	// IMP=0x000000000016fa5f
