...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001b97bd
...
- (id)copyDictionary;	// IMP=0x00000000001b9e0b
- (_Bool)checkValidityAndCollectErrors:(id)arg1;	// IMP=0x00000000001b9c6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b9bb0
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000001b9975
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b98bd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b9813
- (id)init;	// IMP=0x00000000001b97c5
