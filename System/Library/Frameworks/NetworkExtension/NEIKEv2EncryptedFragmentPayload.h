...
+ (id)copyTypeDescription;	// IMP=0x00000000000d886b
...
- (_Bool)parsePayloadData;	// IMP=0x00000000000d88e7
- (_Bool)hasRequiredFields;	// IMP=0x00000000000d8883
- (unsigned long long)type;	// IMP=0x00000000000d8878
