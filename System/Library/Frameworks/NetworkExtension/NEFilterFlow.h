...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005c1c5
- (void).cxx_destruct;	// IMP=0x000000000005dcff
...
- (_Bool)createDataCompleteReply:(id)arg1 controlSocket:(int)arg2 direction:(long long)arg3 verdict:(id)arg4 context:(id)arg5;	// IMP=0x000000000005dac6
- (_Bool)createDataReply:(id)arg1 controlSocket:(int)arg2 direction:(long long)arg3 verdict:(id)arg4 context:(id)arg5;	// IMP=0x000000000005dabe
- (_Bool)createNewFlowReply:(id)arg1 controlSocket:(int)arg2 verdict:(id)arg3 context:(id)arg4;	// IMP=0x000000000005dab6
- (_Bool)shouldCloseWithVerdict:(id)arg1;	// IMP=0x000000000005d99c
- (_Bool)updateCurrentVerdictFromDataVerdict:(id)arg1 direction:(long long)arg2;	// IMP=0x000000000005d38d
@property(readonly, nonatomic) NSString *identifierString;
@property(readonly) NSUUID *identifier;
- (void)updateSourceAppInfoWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000005ce13
- (id)initWithURL:(id)arg1 sourceAppIdentifier:(id)arg2;	// IMP=0x000000000005cd8b
- (id)init;	// IMP=0x000000000005cd53
- (id)description;	// IMP=0x000000000005cd3a
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000005c9ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005c760
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005c480
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005c1cd
