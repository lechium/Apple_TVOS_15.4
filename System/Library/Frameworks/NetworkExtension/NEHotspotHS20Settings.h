...
- (void).cxx_destruct;	// IMP=0x0000000000080cad
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000080ae0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000808c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000080808
- (id)initWithDomainName:(id)arg1 roamingEnabled:(_Bool)arg2;	// IMP=0x000000000008078a
- (id)description;	// IMP=0x0000000000080718
