...
- (unsigned long long)nextRetransmissionInterval;	// IMP=0x00000000001b95d3
- (void)updateRTT:(id)arg1 responseMessageID:(int)arg2;	// IMP=0x00000000001b91b2
- (void)resetRTTMeasurement;	// IMP=0x00000000001b906d
- (_Bool)startRTTMeasurement:(id)arg1 requestMessageID:(int)arg2;	// IMP=0x00000000001b8ebc
- (_Bool)getCurrentTime:(struct timeval *)arg1;	// IMP=0x00000000001b8da2
- (id)init;	// IMP=0x00000000001b8d0a
- (void)reset;	// IMP=0x00000000001b8c63
