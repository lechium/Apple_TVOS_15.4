...
+ (id)chooseChildSAProposalFromLocalProposals:(id)arg1 remoteProposals:(id)arg2 preferRemoteProposals:(_Bool)arg3 checkDHGroup:(_Bool)arg4;	// IMP=0x0000000000091dc7
- (void).cxx_destruct;	// IMP=0x00000000000924d5
...
- (_Bool)isAValidResponse;	// IMP=0x0000000000091c82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009191b
- (_Bool)matchesProposal:(id)arg1 checkDHGroup:(_Bool)arg2;	// IMP=0x0000000000090f6c
- (id)copyForRekey;	// IMP=0x0000000000090f19
- (id)copyFromRemote:(id)arg1 checkDHGroup:(_Bool)arg2 preferRemoteProposal:(_Bool)arg3;	// IMP=0x00000000000900f8
...
- (id)description;	// IMP=0x000000000008ff02
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000008fbb9
- (id)init;	// IMP=0x000000000008fb1c
