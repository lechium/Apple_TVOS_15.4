...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000000143218
+ (id)agentType;	// IMP=0x000000000014320b
+ (id)agentDomain;	// IMP=0x00000000001431fe
- (void).cxx_destruct;	// IMP=0x0000000000143752
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000000014360f
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x000000000014358f
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x000000000014350f
- (void)closeNexusWithOptions:(id)arg1;	// IMP=0x0000000000143490
- (_Bool)requestNexusWithOptions:(id)arg1;	// IMP=0x000000000014340c
...
- (id)copyAgentData;	// IMP=0x00000000001432d5
