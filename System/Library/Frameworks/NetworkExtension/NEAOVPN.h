...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000ac74
- (void).cxx_destruct;	// IMP=0x000000000000c3ab
...
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000000c044
- (_Bool)checkValidityAndCollectErrors:(id)arg1;	// IMP=0x000000000000b346
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b19a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000afc7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ac7c
