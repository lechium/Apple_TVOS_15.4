...
- (void).cxx_destruct;	// IMP=0x00000000000f5e71
...
- (void)dealloc;	// IMP=0x00000000000f5d83
- (void)invokeChildRekeyHandler;	// IMP=0x00000000000f5d12
- (void)invokeIKERekeyHandler;	// IMP=0x00000000000f5ca1
- (void)clearTimers;	// IMP=0x00000000000f5bab
- (void)startChildTimer:(int)arg1 timeoutHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f5982
- (void)startIKETimer:(int)arg1 timeoutHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f5759
