...
- (void).cxx_destruct;	// IMP=0x000000000007bd17
...
- (void)sendRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000007b942
- (id)getConnection;	// IMP=0x000000000007b3df
- (void)dealloc;	// IMP=0x000000000007b33e
- (id)initWithDelegateClassID:(int)arg1 queue:(id)arg2 additionalProperties:(id)arg3;	// IMP=0x000000000007b279
- (id)initWithDelegateClassID:(int)arg1 queue:(id)arg2;	// IMP=0x000000000007b264
