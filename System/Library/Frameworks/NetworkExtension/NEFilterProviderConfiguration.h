...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006386a
- (void).cxx_destruct;	// IMP=0x00000000000649e5
...
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000064388
- (_Bool)checkValidityAndCollectErrors:(id)arg1;	// IMP=0x00000000000642af
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000063fa4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000063c41
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000063872
