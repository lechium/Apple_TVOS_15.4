...
+ (id)chooseSAProposalFromLocalProposals:(id)arg1 remoteProposals:(id)arg2 preferRemoteProposals:(_Bool)arg3;	// IMP=0x000000000008f4a1
- (void).cxx_destruct;	// IMP=0x000000000008fa9c
...
- (_Bool)isAValidResponse;	// IMP=0x000000000008f2d3
- (unsigned long long)lifetimeSecondsBeyondSoftLifetimeForInitiator:(_Bool)arg1;	// IMP=0x000000000008f28f
- (unsigned long long)softLifetimeSecondsForInitiator:(_Bool)arg1;	// IMP=0x000000000008f21a
- (_Bool)matchesProposal:(id)arg1;	// IMP=0x000000000008e627
- (id)copyFromRemote:(id)arg1 preferRemoteProposal:(_Bool)arg2;	// IMP=0x000000000008d4f7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008d101
...
- (id)description;	// IMP=0x000000000008cd32
- (id)descriptionWithIndent:(int)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000008c976
- (id)init;	// IMP=0x000000000008c8ee
