...
+ (id)copySharedSecretFromConfig:(id)arg1;	// IMP=0x00000000000cbd34
+ (_Bool)checkValidityOfDigitalSignature:(id)arg1 authenticationProtocol:(id)arg2 sessionConfiguration:(id)arg3 remoteSignedOctets:(id)arg4;	// IMP=0x00000000000ae39d
+ (_Bool)checkValidityOfDigitalSignature:(id)arg1 sessionConfiguration:(id)arg2 remoteSignedOctets:(id)arg3;	// IMP=0x00000000000ae2f5
+ (id)createAuthenticationDataForSharedSecret:(id)arg1 octets:(id)arg2 prfProtocol:(id)arg3;	// IMP=0x00000000000ac85d
- (void).cxx_destruct;	// IMP=0x00000000000cd23a
...
- (void)resetShortDPDParameters;	// IMP=0x00000000000cc786
- (_Bool)shouldReportShortDPD;	// IMP=0x00000000000cc60f
- (unsigned long long)dpdRetryIntervalMilliseconds;	// IMP=0x00000000000cc554
...
- (unsigned char (*)[32])dhCurveKeyForDesc:(int)arg1;	// IMP=0x00000000000cc299
- (struct ccec_full_ctx *)dhECPKeyForDesc:(int)arg1;	// IMP=0x00000000000cc279
- (id)copyResponderIdentifier;	// IMP=0x00000000000cc234
- (id)copyInitiatorIdentifier;	// IMP=0x00000000000cc1ef
...
- (_Bool)resetRemoteAddress:(id)arg1;	// IMP=0x00000000000cb433
- (void)resetSessionConfiguration:(id)arg1;	// IMP=0x00000000000cb421
- (void)detachTransportWithShouldInvalidate:(_Bool)arg1;	// IMP=0x00000000000cb241
- (id)copyTransport;	// IMP=0x00000000000cad6b
- (void)resyncAddress;	// IMP=0x00000000000caca6
@property(readonly) _Bool hasTransport;
- (_Bool)supportsSignHash:(unsigned long long)arg1;	// IMP=0x00000000000caab0
- (_Bool)switchToTCPEncapsulation;	// IMP=0x00000000000ca4eb
- (_Bool)switchToNATTraversalPorts;	// IMP=0x00000000000c9ef4
@property(retain) NEIKEv2IKESPI *responderSPI;
@property(retain) NEIKEv2IKESPI *initiatorSPI;
- (void)assignRemoteSPI:(id)arg1;	// IMP=0x00000000000c9d81
- (void)assignRemoteSPI:(id)arg1 disableWildCard:(_Bool)arg2;	// IMP=0x00000000000c9d49
- (void)disableWildcard;	// IMP=0x00000000000c9ba5
@property(readonly) NWAddressEndpoint *responderAddress;
@property(readonly) NWAddressEndpoint *initiatorAddress;
- (void)sentStateUpdate;	// IMP=0x00000000000c9af9
- (void)setState:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000000000c9715
- (void)reset;	// IMP=0x00000000000c946e
- (void)dealloc;	// IMP=0x00000000000c929b
- (id)copyForRekey;	// IMP=0x00000000000c8c40
- (id)copyChildConfig;	// IMP=0x00000000000c89d6
- (id)copySessionConfig;	// IMP=0x00000000000c8814
- (void)updateConfiguration:(id)arg1;	// IMP=0x00000000000c8802
@property(readonly) NEIKEv2DHProtocol *preferredDHProtocol;
- (id)initIKESAWithConfiguration:(id)arg1 sessionConfiguration:(id)arg2 queue:(id)arg3 initialTransport:(id)arg4 transportDelegate:(id)arg5 socketGetBlock:(CDUnknownBlockType)arg6 packetDelegate:(id)arg7 configurationDelegate:(id)arg8 ikeSessionUniqueIndex:(unsigned long long)arg9;	// IMP=0x00000000000c74a9
- (id)description;	// IMP=0x00000000000c73cf
- (_Bool)shouldReceiveWildcard;	// IMP=0x00000000000c7329
- (id)createLocalSPIForLocalAddress:(id)arg1 remoteAddress:(id)arg2;	// IMP=0x00000000000c700f
- (id)createResponderEAPAuthenticationData;	// IMP=0x00000000000aff54
- (id)createInitiatorEAPAuthenticationData;	// IMP=0x00000000000afd34
- (CDUnknownBlockType)copyValidateAuthBlock;	// IMP=0x00000000000af7eb
- (_Bool)checkNonCertAuthData:(id)arg1;	// IMP=0x00000000000af5ee
- (id)createResponderAuthenticationData;	// IMP=0x00000000000af37b
- (id)createInitiatorAuthenticationData;	// IMP=0x00000000000af108
- (_Bool)checkValidityOfDigitalSignature:(id)arg1;	// IMP=0x00000000000adf1f
- (_Bool)checkValidityOfCertificates:(id)arg1 signature:(id)arg2;	// IMP=0x00000000000ad3b7
- (id)createRemoteSignedOctets;	// IMP=0x00000000000ad379
- (id)createResponderSignedOctets;	// IMP=0x00000000000acf6b
- (id)createInitiatorSignedOctets;	// IMP=0x00000000000aca87
- (id)createAuthenticationDataForSharedSecret:(id)arg1 octets:(id)arg2;	// IMP=0x00000000000ac620
- (id)copyDigitalSignatureSignedData:(id)arg1;	// IMP=0x00000000000ab8a0
- (id)copyCertSignedData:(id)arg1;	// IMP=0x00000000000ab4ad
- (id)copyLocalCertificateData;	// IMP=0x00000000000ab3a2
- (struct __SecIdentity *)copyLocalSecIdentity;	// IMP=0x00000000000ab312
- (id)copyRemoteCertificateAuthorityHashData;	// IMP=0x00000000000ab059
- (id)copyRemoteCertificateAuthorityDataArray;	// IMP=0x00000000000aae0d
- (id)copyRemoteCertificateAuthorityArray;	// IMP=0x00000000000aa931
- (_Bool)generateAllValuesForRekey:(id)arg1;	// IMP=0x00000000000aa8f8
- (_Bool)generateLocalValues;	// IMP=0x00000000000aa8ab
- (_Bool)calculateSKEYSEEDDerivatives;	// IMP=0x00000000000a9753
- (_Bool)calculateSKEYSEEDForRekey:(id)arg1;	// IMP=0x00000000000a9110
- (_Bool)fetchLocalCertificateIdentity;	// IMP=0x00000000000a8d12
- (_Bool)generateLocalNonce;	// IMP=0x00000000000a8c56
- (_Bool)generateLocalDHValues;	// IMP=0x00000000000a8974
