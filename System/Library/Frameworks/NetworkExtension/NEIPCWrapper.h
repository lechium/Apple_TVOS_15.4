...
+ (id)sharedWrapperForSession:(void *)arg1;	// IMP=0x0000000000187ead
+ (void)cancelSharedWrapperForSession:(void *)arg1;	// IMP=0x0000000000187d84
- (void).cxx_destruct;	// IMP=0x00000000001880a6
...
- (void)cancel;	// IMP=0x0000000000187cc0
- (id)initWithSession:(void *)arg1 identifier:(id)arg2;	// IMP=0x00000000001879bd
