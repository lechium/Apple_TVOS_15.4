...
- (void).cxx_destruct;	// IMP=0x00000000000626a4
...
- (void)dispatchEventWithName:(id)arg1 canBubble:(_Bool)arg2 cancellable:(_Bool)arg3 extraInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000000625c2
- (void)dispatchEventOfType:(long long)arg1 canBubble:(_Bool)arg2 cancellable:(_Bool)arg3 extraInfo:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000062505
- (void)resetProperty:(long long)arg1;	// IMP=0x00000000000624a4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062054
- (id)initWithViewElement:(id)arg1;	// IMP=0x0000000000061ff0
