...
- (void).cxx_destruct;	// IMP=0x00000000000f2a0f
...
- (void)_showSpinner;	// IMP=0x00000000000f27c3
- (_Bool)canBecomeFocused;	// IMP=0x00000000000f27bb
- (void)layoutSubviews;	// IMP=0x00000000000f22ff
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000f2088
