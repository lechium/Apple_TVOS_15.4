...
- (void).cxx_destruct;	// IMP=0x00000000000d8c53
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d82e4
- (id)identifier;	// IMP=0x00000000000d7d6d
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x00000000000d7cb4
