...
+ (void)postNotificationForImageProxy:(id)arg1 withLoadingStatus:(_Bool)arg2;	// IMP=0x00000000001856d2
+ (_Bool)isPerformanceUIEnabled;	// IMP=0x0000000000185648
- (void).cxx_destruct;	// IMP=0x0000000000187374
...
- (void)_maybeDeliverMetrics;	// IMP=0x00000000001870ca
- (_Bool)_isMetricsReady;	// IMP=0x0000000000186f36
- (void)_calculatePageDurations;	// IMP=0x0000000000186c02
- (id)buildPagePerformanceView;	// IMP=0x0000000000186669
@property(readonly, nonatomic) NSDictionary *metrics;
- (unsigned long long)templateDidComplete;	// IMP=0x00000000001861e3
- (id)getEntryForTemplate:(id)arg1;	// IMP=0x0000000000185df0
- (void)markViewDidDisappear;	// IMP=0x0000000000185cff
- (void)markViewWillDisappear;	// IMP=0x0000000000185c34
- (void)markViewDidAppear;	// IMP=0x0000000000185b69
- (void)markViewWillAppear;	// IMP=0x0000000000185ab7
- (void)markViewDidLoad;	// IMP=0x0000000000185a05
- (void)markViewWillLoad;	// IMP=0x0000000000185953
- (id)init;	// IMP=0x00000000001858d6
