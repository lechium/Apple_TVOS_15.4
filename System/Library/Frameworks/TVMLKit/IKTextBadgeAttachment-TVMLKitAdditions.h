...
- (void)tv_resolveWithTextLayoutDirection:(long long)arg1 layoutObserver:(CDUnknownBlockType)arg2;	// IMP=0x000000000009f089
- (void)tv_setImage:(id)arg1;	// IMP=0x000000000009edb9
...
- (void)tv_setResolving:(_Bool)arg1;	// IMP=0x000000000009ec4d
@property(readonly, nonatomic, getter=tv_isResolving) _Bool tv_resolving;
- (void)tv_setImageProxy:(id)arg1;	// IMP=0x000000000009eba1
- (id)tv_imageProxy;	// IMP=0x000000000009eb90
@end
