...
- (void).cxx_destruct;	// IMP=0x0000000000154f05
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000001549cb
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000001548f9
- (id)initWithInlineFrame:(struct CGRect)arg1 playerViewController:(id)arg2;	// IMP=0x000000000015487b
