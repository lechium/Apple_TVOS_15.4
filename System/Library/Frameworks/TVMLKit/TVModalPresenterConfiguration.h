...
- (void).cxx_destruct;	// IMP=0x000000000005de80
...
- (void)_configureWithDictionary:(id)arg1;	// IMP=0x000000000005dc9b
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000005dc33
- (id)init;	// IMP=0x000000000005dc1f
