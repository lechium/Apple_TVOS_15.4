...
- (void).cxx_destruct;	// IMP=0x0000000000078412
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000780c5
- (long long)_positionFromView:(id)arg1;	// IMP=0x00000000000780a3
- (struct CGSize)_contentSizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000077b85
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000077a99
- (id)preferredFocusEnvironments;	// IMP=0x0000000000077843
- (_Bool)canBecomeFocused;	// IMP=0x000000000007783b
- (void)tv_setShowcaseFactor:(double)arg1;	// IMP=0x000000000007760f
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000775fa
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000077142
- (void)layoutSubviews;	// IMP=0x0000000000075ceb
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000075b1e
- (struct UIEdgeInsets)tv_alignmentInsetsForExpectedWidth:(double)arg1;	// IMP=0x000000000007457e
@property(nonatomic) double cornerRadius;
- (void)setComponentsNeedUpdate;	// IMP=0x0000000000073115
@property(nonatomic) __weak UIView *preferredFocusedComponent;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000073004
