...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000000014f0f4
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000000014ee05
- (void).cxx_destruct;	// IMP=0x0000000000150468
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000014fa34
- (_Bool)canBecomeFocused;	// IMP=0x000000000014fa2c
