...
- (id)valueForStyleProperty:(id)arg1;	// IMP=0x000000000005b1ac
- (id)cssValueForStyleProperty:(id)arg1;	// IMP=0x000000000005b129
@property(retain, nonatomic) TVAppStyle *styleMetrics;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005b05c
- (id)initWithStyle:(id)arg1;	// IMP=0x000000000005aff8
