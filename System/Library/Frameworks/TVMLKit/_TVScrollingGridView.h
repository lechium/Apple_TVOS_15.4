...
- (void).cxx_destruct;	// IMP=0x00000000000b7ada
...
- (void)_imageWithImages:(id)arg1 cellSize:(struct CGSize)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b71e2
- (void)_stopAnimating;	// IMP=0x00000000000b705d
- (void)_startAnimating;	// IMP=0x00000000000b6b50
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000000b6b3b
- (void)resume;	// IMP=0x00000000000b6b29
- (void)pause;	// IMP=0x00000000000b6b17
- (void)layoutSubviews;	// IMP=0x00000000000b6714
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b5f1b
