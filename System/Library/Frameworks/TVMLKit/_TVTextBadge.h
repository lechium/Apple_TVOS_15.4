...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0000000000050ae6
- (void).cxx_destruct;	// IMP=0x0000000000051253
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000050f8e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000050e7f
