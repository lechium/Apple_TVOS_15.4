...
- (void).cxx_destruct;	// IMP=0x00000000000d7309
...
- (void)_present:(_Bool)arg1;	// IMP=0x00000000000d6e9b
- (id)_ikMediaItemForPublicObj:(id)arg1;	// IMP=0x00000000000d6d03
- (void)dispatchEvent:(id)arg1 userInfo:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d6b6b
- (void)presentWithAnimation:(_Bool)arg1;	// IMP=0x00000000000d6b13
- (void)stopObservingEvent:(id)arg1;	// IMP=0x00000000000d6a9b
- (void)startObservingEvent:(id)arg1 extraInfo:(id)arg2;	// IMP=0x00000000000d69fb
- (void)cleanup;	// IMP=0x00000000000d69e9
- (void)scan:(double)arg1;	// IMP=0x00000000000d698b
- (void)setElapsedTime:(double)arg1;	// IMP=0x00000000000d693c
...
- (void)changeToMediaAtIndex:(long long)arg1;	// IMP=0x00000000000d58a1
- (void)previous;	// IMP=0x00000000000d5859
- (void)next;	// IMP=0x00000000000d5811
- (void)stop;	// IMP=0x00000000000d57d4
- (void)pause;	// IMP=0x00000000000d578c
- (void)play;	// IMP=0x00000000000d575b
- (void)present;	// IMP=0x00000000000d5744
@property(readonly, nonatomic) long long state;
@property(copy, nonatomic) NSDictionary *userInfo;
- (void)reset;	// IMP=0x00000000000d55e5
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000d52db
- (void)dealloc;	// IMP=0x00000000000d5289
- (id)initWithIKAppPlayer:(id)arg1 navigationController:(id)arg2;	// IMP=0x00000000000d518a
- (id)initWithPlayer:(id)arg1;	// IMP=0x00000000000d4e61
