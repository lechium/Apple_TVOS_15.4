...
+ (id)layoutWithLayout:(id)arg1 element:(id)arg2;	// IMP=0x00000000000f3a79
- (void).cxx_destruct;	// IMP=0x00000000000f52d1
...
- (struct CGSize)_aspectFitToSize:(struct CGSize)arg1 scaleToSize:(struct CGSize)arg2 aspectRatio:(double)arg3;	// IMP=0x00000000000f4e28
@property(readonly, nonatomic) struct CGSize decoratorSize;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f49b7
- (id)init;	// IMP=0x00000000000f4974
- (double)defaultFocusSizeIncrease;	// IMP=0x00000000000f538a
