...
+ (id)presentationTypeKeyMap;	// IMP=0x000000000002f850
- (void).cxx_destruct;	// IMP=0x000000000002fd6b
...
- (void)_applyAlertActionsForController:(id)arg1;	// IMP=0x000000000002fc0a
- (id)initWithOptions:(id)arg1;	// IMP=0x000000000002fa9a
- (id)init;	// IMP=0x000000000002fa06
