...
- (void).cxx_destruct;	// IMP=0x000000000016c89b
@property(nonatomic) double lineSpacing; // @synthesize lineSpacing=_lineSpacing;
@property(copy, nonatomic) NSArray *labelViews; // @synthesize labelViews=_labelViews;
- (void)layoutSubviews;	// IMP=0x000000000016c5e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000016c3d8
