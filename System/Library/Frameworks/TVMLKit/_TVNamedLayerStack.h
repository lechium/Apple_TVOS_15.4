...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x0000000000148a65
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x00000000001486b2
- (void).cxx_destruct;	// IMP=0x000000000014943f
...
- (id)_init;	// IMP=0x0000000000148683
- (id)init;	// IMP=0x0000000000148675
