...
- (struct CGRect)lastItemFrame;	// IMP=0x0000000000096672
- (struct CGRect)firstItemFrame;	// IMP=0x0000000000096647
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x0000000000096628
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x0000000000096607
- (void)dealloc;	// IMP=0x000000000009657d
