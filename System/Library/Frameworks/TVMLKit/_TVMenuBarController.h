...
- (void).cxx_destruct;	// IMP=0x0000000000066ad3
...
- (id)activeDocument;	// IMP=0x00000000000668a8
- (void)_updateNowPlayingPlayer:(id)arg1;	// IMP=0x0000000000066256
- (void)_playerDidChangeState:(id)arg1;	// IMP=0x0000000000066174
- (void)_playbackViewControllerWillPresent:(id)arg1;	// IMP=0x00000000000660f8
- (_Bool)_shouldShowNowPlayingMenuItem;	// IMP=0x00000000000660c5
- (void)_configureTabBarItem:(id)arg1 forMenuItemElement:(id)arg2;	// IMP=0x00000000000658a6
- (void)_configureTabBarSelectionStyleFromElement:(id)arg1;	// IMP=0x00000000000656fa
- (void)_configureViewController:(id)arg1 forMenuItemElement:(id)arg2;	// IMP=0x000000000006513f
- (id)_fontForTextElement:(id)arg1;	// IMP=0x0000000000064f99
- (void)updateWithViewElement:(id)arg1;	// IMP=0x0000000000063a35
- (void)tabBarController:(id)arg1 didSelectViewController:(id)arg2;	// IMP=0x0000000000063799
- (void)menuBarDocument:(id)arg1 didSelectMenuItem:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000000000636f5
- (void)menuBarDocument:(id)arg1 didReplaceDocumentForMenuItem:(id)arg2;	// IMP=0x00000000000633e7
- (void)viewDidLoad;	// IMP=0x000000000006337b
- (void)dealloc;	// IMP=0x00000000000632fa
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000631a4
