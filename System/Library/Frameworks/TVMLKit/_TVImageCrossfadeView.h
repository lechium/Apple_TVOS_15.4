...
@interface _TVImageCrossfadeView : UIView
{
    ...
    __TVImageLoaderQueue *_loaderQueue;	// 24 = 0x18
...
- (void).cxx_destruct;	// IMP=0x000000000005a483
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x000000000005a1fe
- (void)_loadNextImage:(id)arg1;	// IMP=0x000000000005a17f
- (void)_startTimer;	// IMP=0x000000000005a0d6
- (void)layoutSubviews;	// IMP=0x0000000000059aca
- (void)didMoveToSuperview;	// IMP=0x0000000000059a67
- (void)dealloc;	// IMP=0x0000000000059a1e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000059931
