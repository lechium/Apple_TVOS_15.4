...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x000000000009d0cd
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x000000000009d059
- (void).cxx_destruct;	// IMP=0x000000000009d515
...
- (id)imageObj;	// IMP=0x000000000009d4c4
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x000000000009d01e
- (id)init;	// IMP=0x000000000009d010
