...
- (void).cxx_destruct;	// IMP=0x00000000000c0333
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x00000000000c00fc
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000bfb8b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000bfb29
