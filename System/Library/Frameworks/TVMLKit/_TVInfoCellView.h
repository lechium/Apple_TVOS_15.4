...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000000000e42d8
- (void).cxx_destruct;	// IMP=0x00000000000e640b
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000e5feb
- (void)layoutSubviews;	// IMP=0x00000000000e57c2
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000e5201
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000e51b4
- (double)minimumHeaderWidth;	// IMP=0x00000000000e4e6a
