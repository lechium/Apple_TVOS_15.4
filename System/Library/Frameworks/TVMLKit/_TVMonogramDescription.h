...
- (void).cxx_destruct;	// IMP=0x000000000001afbd
...
- (unsigned long long)preferedMonogramType;	// IMP=0x000000000001ac71
- (unsigned long long)hash;	// IMP=0x000000000001ab27
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001a141
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019e66
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x0000000000019dba
- (id)init;	// IMP=0x0000000000019d9e
- (id)initWithFirstName:(id)arg1 lastName:(id)arg2 imageURL:(id)arg3 font:(id)arg4;	// IMP=0x0000000000019c29
