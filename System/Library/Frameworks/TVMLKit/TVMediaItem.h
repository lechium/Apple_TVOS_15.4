...
+ (id)_imageDataForImage:(id)arg1;	// IMP=0x00000000000a2f58
+ (id)_metadataItemForIdentifier:(id)arg1 value:(id)arg2;	// IMP=0x00000000000a2eab
- (void).cxx_destruct;	// IMP=0x000000000009ca36
...
- (void)updatePlayerItem:(id)arg1;	// IMP=0x00000000000a144a
