...
+ (id)productInfoViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000000000a9ca0
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000aba34
- (void)layoutSubviews;	// IMP=0x00000000000aaf11
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000aa7e6
- (id)preferredFocusEnvironments;	// IMP=0x00000000000aa6e6
- (_Bool)canBecomeFocused;	// IMP=0x00000000000aa63d
