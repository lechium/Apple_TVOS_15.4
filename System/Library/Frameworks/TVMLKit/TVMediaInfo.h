...
- (void).cxx_destruct;	// IMP=0x0000000000015e8f
...
- (id)description;	// IMP=0x0000000000015ca4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000015b48
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000015790
- (unsigned long long)hash;	// IMP=0x00000000000156cf
