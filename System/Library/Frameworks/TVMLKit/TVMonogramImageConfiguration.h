...
- (void).cxx_destruct;	// IMP=0x00000000000ed6f2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ed4fc
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000000ed419
