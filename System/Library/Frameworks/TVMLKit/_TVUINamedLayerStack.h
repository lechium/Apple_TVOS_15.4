...
@interface _TVUINamedLayerStack : NSObject <UINamedLayerStack, NSCopying>
{
    ...
    _TVImageStack *_imageStack;	// 56 = 0x38
    struct CGSize _size;	// 64 = 0x40
    struct CGSize _radiosityImageScale;	// 80 = 0x50
}

- (void).cxx_destruct;	// IMP=0x0000000000080a6d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000080881
- (void)dealloc;	// IMP=0x0000000000080842
