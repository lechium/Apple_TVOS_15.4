...
- (void).cxx_destruct;	// IMP=0x000000000001d308
...
- (id)initUrlWithProperties:(id)arg1 imageSize:(struct CGSize)arg2 focusSizeIncrease:(double)arg3 cropCode:(id)arg4 urlFormat:(id)arg5;	// IMP=0x000000000001d126
