...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002806c
- (void).cxx_destruct;	// IMP=0x0000000000029364
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002888e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000028074
- (void)updateCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x0000000000027c8e
- (id)sanitizedCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000027c86
- (void)updateAsFulfilledWithDateStarted:(id)arg1;	// IMP=0x0000000000027c34
- (void)fulfillWithDateStarted:(id)arg1;	// IMP=0x0000000000027b6e
- (void)fulfill;	// IMP=0x0000000000027b1b
- (id)customDescription;	// IMP=0x00000000000274b4
- (id)initWithCallUUID:(id)arg1 groupUUID:(id)arg2;	// IMP=0x00000000000273c6
