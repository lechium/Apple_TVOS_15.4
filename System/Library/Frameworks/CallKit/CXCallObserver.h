...
- (void)dataSource:(id)arg1 callChanged:(id)arg2;	// IMP=0x000000000004f669
- (void)_performDelegateCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000004f586
- (void)setDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x000000000004f44e
@property(readonly, copy, nonatomic) NSArray *calls;
- (void)dealloc;	// IMP=0x000000000004f1c5
- (id)initWithDataSource:(id)arg1 concurrentQueue:(id)arg2;	// IMP=0x000000000004f0be
- (id)init;	// IMP=0x000000000004f04d
