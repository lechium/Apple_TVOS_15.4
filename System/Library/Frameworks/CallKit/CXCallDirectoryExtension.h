...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000049c73
- (void).cxx_destruct;	// IMP=0x000000000004a217
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000049ef0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000049c7b
- (id)description;	// IMP=0x0000000000049b8f
