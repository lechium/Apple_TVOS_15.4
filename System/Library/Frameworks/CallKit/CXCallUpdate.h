...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000312e7
+ (id)callUpdateWithDefaultValuesSet;	// IMP=0x000000000002cfb6
- (void).cxx_destruct;	// IMP=0x00000000000330b7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003235a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000312ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003128b
- (void)updateCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x00000000000304ff
- (id)sanitizedCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003049f
- (id)sanitizedCopy;	// IMP=0x000000000003048b
- (void)updateSanitizedCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x00000000000301b5
- (void)updateWithUpdate:(id)arg1;	// IMP=0x000000000002f555
@property(nonatomic) _Bool ignoresBluetoothDeviceUID; // @synthesize ignoresBluetoothDeviceUID=_ignoresBluetoothDeviceUID;
- (_Bool)sharingScreen;	// IMP=0x000000000002f493
- (_Bool)oneToOneModeEnabled;	// IMP=0x000000000002f432
...
- (_Bool)conversation;	// IMP=0x000000000002f30f
...
- (_Bool)mutuallyExclusiveCall;	// IMP=0x000000000002f173
...
- (_Bool)remoteUplinkMuted;	// IMP=0x000000000002f050
...
- (_Bool)blocked;	// IMP=0x000000000002dfa4
- (_Bool)usingBaseband;	// IMP=0x000000000002df43
- (_Bool)failureExpected;	// IMP=0x000000000002dee2
- (_Bool)emergency;	// IMP=0x000000000002de81
...
- (id)init;	// IMP=0x000000000002cf38
