...
- (void).cxx_destruct;	// IMP=0x000000000004377e
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000004358f
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x0000000000043489
- (oneway void)removeCall:(id)arg1;	// IMP=0x0000000000043417
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x00000000000433a5
...
- (void)dealloc;	// IMP=0x000000000004319e
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000042b8a
- (id)init;	// IMP=0x0000000000042b7c
