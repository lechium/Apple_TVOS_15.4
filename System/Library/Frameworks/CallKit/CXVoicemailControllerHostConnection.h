...
- (void).cxx_destruct;	// IMP=0x0000000000048bf2
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000048a15
- (oneway void)requestVoicemails:(CDUnknownBlockType)arg1;	// IMP=0x000000000004890f
- (oneway void)removeVoicemails:(id)arg1;	// IMP=0x000000000004889d
- (oneway void)addOrUpdateVoicemails:(id)arg1;	// IMP=0x000000000004882b
...
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000047f74
- (id)init;	// IMP=0x0000000000047f66
