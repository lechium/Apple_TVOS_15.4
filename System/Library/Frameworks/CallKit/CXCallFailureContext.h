...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002c8e6
- (void).cxx_destruct;	// IMP=0x000000000002cf10
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002cb5d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002c8ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002c88a
- (void)updateCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x000000000002c709
- (id)sanitizedCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002c701
- (id)sanitizedCopy;	// IMP=0x000000000002c6ed
- (void)updateSanitizedCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x000000000002c6e7
