...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000004780c
- (void)networkExtensionMessageControllerHostConnection:(id)arg1 didReceiveIncomingMessage:(id)arg2 forBundleIdentifier:(id)arg3;	// IMP=0x000000000004754a
- (void)networkExtensionMessageControllerHostConnectionInvalidated:(id)arg1;	// IMP=0x00000000000474d2
- (void)removeDelegate:(id)arg1;	// IMP=0x000000000004745a
- (void)addDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x000000000004739e
- (id)init;	// IMP=0x00000000000472b9
