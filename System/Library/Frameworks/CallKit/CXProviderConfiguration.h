...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004d6bf
- (void).cxx_destruct;	// IMP=0x000000000004e5a8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004de60
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004d6c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004d663
- (void)updateCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x000000000004d4dd
- (id)sanitizedCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004d47d
- (id)sanitizedCopy;	// IMP=0x000000000004d469
- (void)updateSanitizedCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x000000000004d30b
@property(readonly) unsigned long long hash;
- (_Bool)isEqualToConfiguration:(id)arg1;	// IMP=0x000000000004cbdc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004cb7f
@property(retain, nonatomic) NSString *ringtoneSound;
@property(copy, nonatomic) NSSet *senderIdentities;
@property(readonly, copy) NSString *description;
- (id)initWithLocalizedName:(id)arg1;	// IMP=0x000000000004c086
- (id)init;	// IMP=0x000000000004bfa2
