...
- (void).cxx_destruct;	// IMP=0x000000000004b019
@property(readonly, nonatomic) struct os_unfair_lock_s accessorLock; // @synthesize accessorLock=_accessorLock;
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000004ae1b
- (void)invalidate;	// IMP=0x000000000004ade8
@property(retain, nonatomic) NSXPCConnection *connection; // @synthesize connection=_connection;
- (void)dealloc;	// IMP=0x000000000004a9ff
- (id)init;	// IMP=0x000000000004a9c4
