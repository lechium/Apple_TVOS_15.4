...
- (void).cxx_destruct;	// IMP=0x0000000000014d40
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000014bf2
- (_Bool)appendPhoneNumber:(long long)arg1 label:(id)arg2;	// IMP=0x0000000000014a20
- (id)init;	// IMP=0x0000000000014a0c
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x000000000001491f
