...
- (void).cxx_destruct;	// IMP=0x000000000001dfff
...
- (id)_performMigrationsStartingAtSchemaVersion:(long long)arg1 error:(id *)arg2;	// IMP=0x000000000001d338
- (id)performMigrationsWithError:(id *)arg1;	// IMP=0x000000000001d238
- (id)init;	// IMP=0x000000000001d178
