...
+ (id)matchesInString:(id)arg1 types:(unsigned long long)arg2 range:(struct _NSRange)arg3;	// IMP=0x00000000000a98e9
...
- (id)description;	// IMP=0x00000000000a9884
- (void)dealloc;	// IMP=0x00000000000a9817
- (id)initWithType:(unsigned long long)arg1 range:(struct _NSRange)arg2 score:(double)arg3;	// IMP=0x00000000000a9792
