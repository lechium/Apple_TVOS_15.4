...
+ (id)_localizedAttributedStringParsingOptions;	// IMP=0x000000000001ae30
+ (id)allowingExtendedAttributes;	// IMP=0x00000000001635d4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016383d
- (unsigned long long)hash;	// IMP=0x0000000000163792
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001636cf
- (void)dealloc;	// IMP=0x0000000000163671
- (id)init;	// IMP=0x0000000000163605
