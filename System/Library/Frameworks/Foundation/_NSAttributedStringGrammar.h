...
+ (id)identityGrammar;	// IMP=0x0000000000197b96
...
- (id)initWithMorphology:(id)arg1;	// IMP=0x0000000000197f85
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000197db0
- (unsigned long long)hash;	// IMP=0x0000000000197ca6
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000197c94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000197ba8
- (id)init;	// IMP=0x0000000000197b44
@property(readonly, getter=_wordAttributes) CDStruct_be0ff5be _wordAttributes;
- (id)_initWithMarkdownDictionary:(id)arg1;	// IMP=0x0000000000198c07
