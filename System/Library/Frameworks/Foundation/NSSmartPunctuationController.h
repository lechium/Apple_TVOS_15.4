...
- (void)clientDidReplaceRange:(struct _NSRange)arg1 changeInLength:(long long)arg2;	// IMP=0x00000000001898c5
...
- (void)dealloc;	// IMP=0x00000000001897ac
- (id)init;	// IMP=0x0000000000189702
