...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007dc94
...
- (void)dealloc;	// IMP=0x000000000007e055
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007df58
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007dc9c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007dbda
- (id)init;	// IMP=0x000000000007db6c
