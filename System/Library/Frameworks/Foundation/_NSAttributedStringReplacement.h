...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x00000000000a5536
...
- (void)dealloc;	// IMP=0x00000000000a54d8
- (id)_initWithMetadata:(id)arg1;	// IMP=0x00000000000a51da
