...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000058657
...
- (id)_variantSubstrings;	// IMP=0x00000000000587b9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000058718
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005865f
- (void)dealloc;	// IMP=0x00000000000585f9
