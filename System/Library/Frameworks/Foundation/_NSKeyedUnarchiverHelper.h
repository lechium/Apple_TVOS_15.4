...
- (_Bool)classNameAllowed:(Class)arg1;	// IMP=0x00000000000b8132
- (void)setAllowedClassNames:(id)arg1;	// IMP=0x00000000000b80fd
- (id)allowedClassNames;	// IMP=0x00000000000b80e6
- (void)dealloc;	// IMP=0x00000000000b8072
- (id)init;	// IMP=0x00000000000b8049
