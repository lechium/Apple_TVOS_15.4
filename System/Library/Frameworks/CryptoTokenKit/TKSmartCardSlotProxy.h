...
- (void).cxx_destruct;	// IMP=0x0000000000009cf9
@property(readonly) NSHashTable *cards; // @synthesize cards=_cards;
- (id)initWithSlot:(id)arg1;	// IMP=0x0000000000009c57
- (void)cardSessionRequested;	// IMP=0x0000000000009b2a
- (void)notifyWithParameters:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000095ac
