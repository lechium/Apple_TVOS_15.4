...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000029c45
- (void).cxx_destruct;	// IMP=0x0000000000029dfe
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000029d5d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000029c4d
- (id)initWithTokenAccessRequest:(id)arg1;	// IMP=0x0000000000029af6
