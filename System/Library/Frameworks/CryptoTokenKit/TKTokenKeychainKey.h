...
- (void).cxx_destruct;	// IMP=0x00000000000244de
...
- (_Bool)satisfiesKeyUsage:(unsigned long long)arg1;	// IMP=0x000000000002436d
@property(readonly) unsigned long long keyUsage;
- (void)createConstraints:(unsigned char)arg1;	// IMP=0x00000000000242a8
- (id)initWithItemInfo:(id)arg1;	// IMP=0x0000000000023ffa
- (id)encodedObjectID;	// IMP=0x0000000000023f97
- (id)keychainAttributes;	// IMP=0x0000000000023ba5
- (id)initWithCertificate:(struct __SecCertificate *)arg1 objectID:(id)arg2;	// IMP=0x00000000000237cf
