...
- (void)dealloc;	// IMP=0x000000000001bf5e
- (void)terminateWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001bf1a
- (void)setSessionEndPolicy:(long long)arg1;	// IMP=0x000000000001bf10
- (void)transmit:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000001bb43
- (id)initWithSlot:(id)arg1 connection:(id)arg2;	// IMP=0x000000000001baa6
