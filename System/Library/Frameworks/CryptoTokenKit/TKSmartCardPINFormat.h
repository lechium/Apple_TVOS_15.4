...
+ (void)_writeNumber:(unsigned long long)arg1 into:(id)arg2 bitOffset:(long long)arg3 bitLength:(long long)arg4;	// IMP=0x000000000000fdf4
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000f761
...
- (_Bool)fillPIN:(id)arg1 intoAPDUTemplate:(id)arg2 PINByteOffset:(long long)arg3 error:(id *)arg4;	// IMP=0x000000000000fe8f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000fcbe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000fa53
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f769
- (id)init;	// IMP=0x000000000000f704
