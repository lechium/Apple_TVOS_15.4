...
- (void).cxx_destruct;	// IMP=0x0000000000021c4e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002183f
- (id)initWithCaller:(id)arg1 tokenID:(id)arg2 extension:(id)arg3;	// IMP=0x000000000002169e
- (id)initWithClientBundleID:(id)arg1 clientName:(id)arg2 clientConnection:(id)arg3 clientHasAccessTokenEntitlement:(_Bool)arg4 tokenID:(id)arg5 providerBundleID:(id)arg6 providerName:(id)arg7 correlationID:(id)arg8;	// IMP=0x0000000000021553
