...
+ (id)keychainItemWithInfo:(id)arg1;	// IMP=0x0000000000022d08
+ (id)accessControlForConstraints:(id)arg1 tokenID:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000021f7a
+ (id)operationMap;	// IMP=0x0000000000021eb9
- (void).cxx_destruct;	// IMP=0x0000000000022e4f
...
- (id)initWithItemInfo:(id)arg1;	// IMP=0x0000000000022983
...
- (id)initWithObjectID:(id)arg1;	// IMP=0x0000000000021cad
