...
- (void).cxx_destruct;	// IMP=0x000000000002c181
...
- (void)dealloc;	// IMP=0x000000000002c0cc
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000002c004
- (void)invalidate;	// IMP=0x000000000002bfee
- (id)initWithToken:(id)arg1;	// IMP=0x000000000002be9e
