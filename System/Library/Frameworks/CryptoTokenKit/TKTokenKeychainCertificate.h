...
- (id)keychainAttributes;	// IMP=0x00000000000233c0
- (id)initWithItemInfo:(id)arg1;	// IMP=0x00000000000231db
- (id)encodedObjectID;	// IMP=0x0000000000023178
- (id)initWithCertificate:(struct __SecCertificate *)arg1 objectID:(id)arg2;	// IMP=0x0000000000022e98
