...
@interface AVPictureInPicturePlatformAdapter : NSObject <AVPictureInPictureControlsStyleAppearance>
{
    ...
    _Bool _microphoneEnabled;	// 14 = 0xe
    _Bool _managesWiredSecondScreenPlayback;	// 15 = 0xf
    _Bool _canAnimatePictureInPictureTransition;	// 16 = 0x10
    _Bool _anyPictureInPictureActive;	// 17 = 0x11
    _Bool _routingVideoToHostedWindow;	// 18 = 0x12
...
+ (id)stopPictureInPictureButtonImageName;	// IMP=0x0000000000112a9d
+ (id)startPictureInPictureButtonImageName;	// IMP=0x0000000000112a90
+ (_Bool)isPictureInPictureSupported;	// IMP=0x0000000000112a88
+ (id)imageSymbolConfiguration;	// IMP=0x0000000000112a80
- (void).cxx_destruct;	// IMP=0x0000000000112c46
...
- (void)updateLayoutDependentBehaviors;	// IMP=0x0000000000112acc
- (void)stopPictureInPictureAndRestoreUserInterface:(_Bool)arg1;	// IMP=0x0000000000112ac6
- (void)startPictureInPicture;	// IMP=0x0000000000112ac0
- (id)initWithSource:(id)arg1;	// IMP=0x0000000000112ab2
- (_Bool)isPictureInPicturePossible;	// IMP=0x0000000000112aaa
- (void)_setRoutingVideoToHostedWindow:(_Bool)arg1 pictureInPictureViewController:(id)arg2 source:(id)arg3;	// IMP=0x00000000000758d7
- (void)_updateStatusUsingProposedStatus:(long long)arg1;	// IMP=0x000000000007543b
- (void)_updateStatus;	// IMP=0x000000000007540a
- (void)_setStatusAndNotifyDelegateIfNeeded:(long long)arg1;	// IMP=0x00000000000752e8
