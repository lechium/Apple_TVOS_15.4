...
+ (id)searchResultForMenu:(id)arg1 atIndex:(long long)arg2;	// IMP=0x0000000000009342
+ (id)searchResultForPiPMenuAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000009311
- (void).cxx_destruct;	// IMP=0x0000000000009301
...
- (id)initWithMenu:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0000000000009267
