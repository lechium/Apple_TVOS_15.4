...
- (void).cxx_destruct;	// IMP=0x00000000000fda15
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000fd95c
- (id)preferredFocusEnvironments;	// IMP=0x00000000000fd8e3
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000fd86d
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000fd766
- (void)loadView;	// IMP=0x00000000000fcc40
