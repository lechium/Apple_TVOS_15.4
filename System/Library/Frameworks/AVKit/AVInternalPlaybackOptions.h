...
- (void).cxx_destruct;	// IMP=0x000000000003471f
...
- (id)debugDescription;	// IMP=0x0000000000034360
- (id)_descriptionOfBooleanProperty:(id)arg1;	// IMP=0x00000000000342bc
- (id)_descriptionOfTrueBooleanProperty:(id)arg1;	// IMP=0x000000000003421d
@property(readonly, getter=isOffOptionAvailableForSubtitles) _Bool offOptionAvailableForSubtitles;
- (id)init;	// IMP=0x00000000000340f5
