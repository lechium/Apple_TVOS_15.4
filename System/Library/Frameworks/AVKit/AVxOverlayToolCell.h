...
- (void).cxx_destruct;	// IMP=0x0000000000072ce1
...
- (void)updateFocusState:(id)arg1;	// IMP=0x00000000000729fc
- (void)didHintFocusMovement:(id)arg1;	// IMP=0x00000000000729d9
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000728e2
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000072837
- (_Bool)canBecomeFocused;	// IMP=0x0000000000072811
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000715b9
