...
- (void).cxx_destruct;	// IMP=0x00000000000a3c8b
@property(readonly, nonatomic) AVUnifiedPlayerContextMenuView *contextMenuView; // @synthesize contextMenuView=_contextMenuView;
- (id)preferredFocusEnvironments;	// IMP=0x00000000000a3c53
- (void)layoutSubviews;	// IMP=0x00000000000a3b8e
- (void)flipHorizontalAxisIfNeededMatchingCollectionView:(id)arg1;	// IMP=0x00000000000a3ae9
@property(readonly, nonatomic) UIView *viewForAnimatingOpacity;
@property(readonly, nonatomic) UIView *viewForAnimatingTransform;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a3879
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000000a3d2f
