...
+ (id)messagePartsWithData:(id)arg1 lineSeparator:(id)arg2 data:(id)arg3 headerBodySeparator:(id)arg4 data:(id)arg5 bodyLengthKey:(id)arg6;	// IMP=0x000000000007d7e8
+ (void)registerClass:(Class)arg1 forMessageVersion:(id)arg2;	// IMP=0x000000000007e149
- (void).cxx_destruct;	// IMP=0x000000000007d789
...
- (_Bool)shouldCallReverseTransformerAgain;	// IMP=0x000000000007d6c9
- (id)decompressBodyUsingNamedAlgorithm:(id)arg1;	// IMP=0x000000000007d4de
- (id)decompressBodyUsingAlgorithm:(long long)arg1;	// IMP=0x000000000007d39c
...
- (void)_identifyUniqueAndRepeatedHeadersIfNecessary;	// IMP=0x000000000007cd7d
- (void)_setIncomplete;	// IMP=0x000000000007cd73
- (id)initWithVersion:(id)arg1 headers:(id)arg2 expectedBodyLength:(long long)arg3 body:(id)arg4 extra:(id)arg5;	// IMP=0x000000000007cc10
@property(readonly, nonatomic) id airMessage;
- (Class)_matchingClass;	// IMP=0x000000000007de76
