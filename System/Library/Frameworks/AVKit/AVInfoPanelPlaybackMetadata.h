...
+ (_Bool)_closedCaptioningStatusForPlayerController:(id)arg1;	// IMP=0x00000000000efb61
+ (double)_durationForPlayerController:(id)arg1;	// IMP=0x00000000000efaa7
+ (id)_metadataItemsForPlayerItem:(id)arg1 withAsset:(id)arg2;	// IMP=0x00000000000ef845
+ (void)_loadAssetValues:(id)arg1 into:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000ef701
+ (id)playbackMetadataForPlayerController:(id)arg1 fulfillment:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ef59f
- (void).cxx_destruct;	// IMP=0x00000000000ef56c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ef3cc
- (unsigned long long)hash;	// IMP=0x00000000000ef3b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ef36e
- (id)initWithPlaybackMetadata:(id)arg1;	// IMP=0x00000000000ef22a
- (id)initWithPlayerController:(id)arg1;	// IMP=0x00000000000ef08f
- (id)_releaseDateStringItem;	// IMP=0x00000000000f0bd6
...
- (id)metadataItemForIdentifiers:(id)arg1;	// IMP=0x00000000000f0744
