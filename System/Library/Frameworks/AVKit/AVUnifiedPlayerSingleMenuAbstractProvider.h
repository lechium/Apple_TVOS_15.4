...
@interface AVUnifiedPlayerSingleMenuAbstractProvider : NSObject <AVUnifiedPlayerMenuElementProviding, UIAccessibilityIdentification>
{
...
+ (id)menuProviderWithTitle:(id)arg1 image:(id)arg2;	// IMP=0x00000000000ee066
+ (id)inlineMenuProviderWithTitle:(id)arg1;	// IMP=0x00000000000ee015
- (void).cxx_destruct;	// IMP=0x00000000000edfcc
...
- (void)prepareForDisplay;	// IMP=0x00000000000edd70
@property(readonly, nonatomic) NSArray *menuElements;
- (id)initWithTitle:(id)arg1 image:(id)arg2 menuOptions:(unsigned long long)arg3;	// IMP=0x00000000000edc4c
