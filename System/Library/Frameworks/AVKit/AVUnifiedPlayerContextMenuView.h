...
+ (id)_createVisualEffectView;	// IMP=0x00000000000a3755
+ (id)_createBackgroundView;	// IMP=0x00000000000a3306
- (void).cxx_destruct;	// IMP=0x00000000000a2834
...
- (id)_collectionViewLayout;	// IMP=0x00000000000a24a6
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000000a23ef
- (void)layoutSubviews;	// IMP=0x00000000000a227c
- (id)preferredFocusEnvironments;	// IMP=0x00000000000a2255
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000a2238
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000a2218
- (void)dealloc;	// IMP=0x00000000000a21c5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a10b8
