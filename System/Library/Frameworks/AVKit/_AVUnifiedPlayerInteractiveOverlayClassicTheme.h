...
@interface _AVUnifiedPlayerInteractiveOverlayClassicTheme : NSObject <AVUnifiedPlayerInteractiveOverlayTheme>
{
    id <AVShadowSettings> _platterShadowSettings;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x000000000005958f
...
- (id)init;	// IMP=0x0000000000059432
