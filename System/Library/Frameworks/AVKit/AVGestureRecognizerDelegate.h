...
#import <AVKit/_UIRotaryGestureRecognizerDelegate-Protocol.h>

@class NSSet, NSString, UITapGestureRecognizer, _UIRotaryGestureRecognizer;

__attribute__((visibility("hidden")))
@interface AVGestureRecognizerDelegate : NSObject <_UIRotaryGestureRecognizerDelegate>
{
...
- (void).cxx_destruct;	// IMP=0x00000000000d808f
...
- (void)rotaryGestureRecognizerFailedClassifyingMovement:(id)arg1;	// IMP=0x00000000000d7ec0
- (void)rotaryGestureRecognizerUpdatedClassifyingMovement:(id)arg1;	// IMP=0x00000000000d7e40
- (void)rotaryGestureRecognizerBeganClassifyingMovement:(id)arg1;	// IMP=0x00000000000d7dc0
- (_Bool)rotaryGestureRecognizerMustBeginFromRest:(id)arg1;	// IMP=0x00000000000d7d34
- (_Bool)rotaryGestureRecognizerCanBeginFromRest:(id)arg1;	// IMP=0x00000000000d7ca8
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000d7c32
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x00000000000d7b67
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000d7ab7
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000d7908
@property(readonly, nonatomic, getter=isUserInteractionAllowed) _Bool userInteractionAllowed;
- (id)init;	// IMP=0x00000000000d77f9
