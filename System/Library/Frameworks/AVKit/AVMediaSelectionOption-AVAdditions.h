...
+ (id)avkit_autoOption;	// IMP=0x00000000000d9bf9
+ (id)avkit_offOption;	// IMP=0x00000000000d9be8
@property(readonly, nonatomic) NSString *shortLocalizedDisplayName;
@property(readonly, nonatomic) NSString *localizedDisplayName;
- (id)avkit_title;	// IMP=0x00000000000e993a
- (id)avkit_mediaRemoteIdentifier;	// IMP=0x00000000000e9810
- (long long)languageCompare:(id)arg1 currentLanguageCode:(id)arg2 currentLanguageIdentifier:(id)arg3;	// IMP=0x0000000000121825
