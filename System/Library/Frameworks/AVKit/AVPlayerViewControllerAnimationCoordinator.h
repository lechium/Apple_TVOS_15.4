...
- (void).cxx_destruct;	// IMP=0x000000000005f3c6
...
- (void)didFinishAnimations:(_Bool)arg1;	// IMP=0x000000000005f208
- (void)performCoordinatedAnimations;	// IMP=0x000000000005f06c
- (void)addCoordinatedAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000005ef34
- (id)init;	// IMP=0x000000000005ee97
