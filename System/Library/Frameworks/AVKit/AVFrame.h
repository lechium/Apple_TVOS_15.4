...
- (void).cxx_destruct;	// IMP=0x000000000001a143
...
- (unsigned long long)estimatedSizeOfImageInMemory;	// IMP=0x000000000001a09d
- (id)description;	// IMP=0x0000000000019fee
- (id)initWithImage:(id)arg1 actualTime:(double)arg2 frameIndex:(long long)arg3;	// IMP=0x0000000000019f65
