...
+ (id)airMessageParser;	// IMP=0x000000000007e087
- (void).cxx_destruct;	// IMP=0x000000000007cbbc
...
- (id)partsWithData:(id)arg1;	// IMP=0x000000000007c90d
- (id)init;	// IMP=0x000000000007c74e
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x000000000007c65d
