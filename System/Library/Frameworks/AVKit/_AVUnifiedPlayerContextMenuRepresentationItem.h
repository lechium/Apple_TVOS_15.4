...
@interface _AVUnifiedPlayerContextMenuRepresentationItem : NSObject <AVUnifiedPlayerContextMenuItem>
{
    _Bool _on;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x0000000000116ebb
...
- (id)initWithAction:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0000000000116c6d
- (id)initWithTitle:(id)arg1 image:(id)arg2 attributes:(unsigned long long)arg3 state:(long long)arg4 actionIndexPath:(id)arg5;	// IMP=0x0000000000116b8f
