...
#import <AVKit/AVUnifiedPlayerInteractiveOverlayTheme-Protocol.h>

@class NSString, UIColor, UIImageSymbolConfiguration;
@protocol AVShadowSettings, AVUnifiedPlayerBaseTheme;

__attribute__((visibility("hidden")))
@interface _AVUnifiedPlayerInteractiveOverlay2021Theme : NSObject <AVUnifiedPlayerInteractiveOverlayTheme>
{
    id <AVShadowSettings> _platterShadowSettings;	// 8 = 0x8
    id <AVUnifiedPlayerBaseTheme> _baseTheme;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x000000000005974b
...
- (id)initWithBaseTheme:(id)arg1;	// IMP=0x000000000005959f
