...
+ (id)pathWithProtocolBufferData:(id)arg1;	// IMP=0x0000000000061d10
+ (id)createStringFromStatus:(long long)arg1;	// IMP=0x0000000000061c80
+ (id)pathForClientID:(id)arg1 parametersTLV:(id)arg2 pathResultTLV:(id)arg3;	// IMP=0x0000000000061b20
+ (id)pathForClientID:(id)arg1;	// IMP=0x0000000000061a60
+ (id)allClientIDs;	// IMP=0x0000000000061950
- (void).cxx_destruct;	// IMP=0x000000000005ff30
...
- (id)createProtocolBufferObject;	// IMP=0x000000000005fca0
...
- (_Bool)hasUnsatisfiedFallbackAgent;	// IMP=0x000000000005f360
- (_Bool)unsatisfiedVoluntaryAgentMatchesAddress:(id)arg1 triggerImmediately:(_Bool *)arg2;	// IMP=0x000000000005f2d0
- (id)copyFlowDivertToken;	// IMP=0x000000000005f290
...
- (id)delegateInterface;	// IMP=0x000000000005e910
@property(readonly, nonatomic) NWInterface *interface;
@property(readonly, nonatomic) NWInterface *scopedInterface;
- (id)inactiveNetworkAgentUUIDsOnlyVoluntary:(_Bool)arg1;	// IMP=0x000000000005e6b0
- (id)genericNetworkAgentsWithDomain:(id)arg1 type:(id)arg2;	// IMP=0x000000000005e520
- (id)networkAgentsOfType:(Class)arg1;	// IMP=0x000000000005e3f0
- (_Bool)usesNetworkAgent:(id)arg1;	// IMP=0x000000000005e1e0
- (_Bool)usesNetworkAgentType:(Class)arg1;	// IMP=0x000000000005e0c0
- (_Bool)usesInterfaceType:(long long)arg1;	// IMP=0x000000000005e070
- (_Bool)isListenerInterfaceSpecific;	// IMP=0x000000000005e030
- (_Bool)isLinkQualityAbort;	// IMP=0x000000000005dff0
- (_Bool)shouldProbeConnectivity;	// IMP=0x000000000005dfb0
...
- (_Bool)isEqualToPath:(id)arg1;	// IMP=0x000000000005dbd0
@property(readonly, copy, nonatomic) NSString *privateDescription;
- (id)description;	// IMP=0x000000000005db80
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x000000000005cfe0
@property(readonly, nonatomic) NSString *statusAsString;
- (id)initWithPath:(id)arg1;	// IMP=0x000000000005cb40
- (id)init;	// IMP=0x000000000005c8d0
