...
- (void).cxx_destruct;	// IMP=0x000000000004ec30
...
- (id)initWithParameters:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000004e0e0
- (void)handleError:(id)arg1;	// IMP=0x000000000004e090
- (void)handleConnection:(id)arg1;	// IMP=0x000000000004df00
