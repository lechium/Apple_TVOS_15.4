...
- (void).cxx_destruct;	// IMP=0x00000000000e1b58
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000000e1b40
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x00000000000e1b2c
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x00000000000e16c7
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x00000000000e14d6
