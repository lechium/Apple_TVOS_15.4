...
- (void)_lastKnownIndoorOutdoorStateWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000109ebe
- (void)_stopIndoorOutdoorUpdates;	// IMP=0x0000000000109bfb
- (void)_startIndoorOutdoorUpdates;	// IMP=0x00000000001096c7
- (void)_teardown;	// IMP=0x000000000010963e
- (void)dealloc;	// IMP=0x00000000001095fc
- (id)init;	// IMP=0x000000000010921a
