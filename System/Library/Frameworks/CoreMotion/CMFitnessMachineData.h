...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019b872
+ (_Bool)isAvailable;	// IMP=0x000000000019b72e
...
- (void)convertToCLFitnessMachineData:(struct _CLFitnessMachineData *)arg1;	// IMP=0x000000000019bd27
- (id)description;	// IMP=0x000000000019bc9d
@property(readonly, nonatomic) NSDate *timestamp;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019bb35
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019b9f0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019b87a
- (void)dealloc;	// IMP=0x000000000019b843
- (id)initWithTimestamp:(id)arg1;	// IMP=0x000000000019b744
