...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000189fd6
...
- (id)debugDescription;	// IMP=0x000000000018adbe
- (id)description;	// IMP=0x000000000018ab00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018a9d3
- (void)dealloc;	// IMP=0x000000000018a989
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018a5bf
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018a181
- (id)initWithDeviceMotionLite:(CDStruct_946f299f)arg1 andDeviceID:(id)arg2;	// IMP=0x0000000000189fde
