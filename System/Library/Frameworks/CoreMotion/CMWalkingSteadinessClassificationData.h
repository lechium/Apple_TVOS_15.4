...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d73a6
...
- (id)description;	// IMP=0x00000000000d74b4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d7449
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d73ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d7353
- (void)dealloc;	// IMP=0x00000000000d7324
- (id)initWithLowerBound:(double)arg1 upperBound:(double)arg2 classificationType:(long long)arg3;	// IMP=0x00000000000d72c9
