...
- (void)simulateMotionStateYouthWithState:(long long)arg1;	// IMP=0x000000000014474c
- (void)simulateMotionState:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x000000000014450e
- (void)overrideOscarSideband:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x00000000001442d0
- (void)stopActivityUpdatesPrivate;	// IMP=0x00000000001440d7
- (void)startActivityUpdatesWithHandlerPrivate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000143f0b
- (void)disconnect;	// IMP=0x0000000000143edb
- (void)connect;	// IMP=0x00000000001434ee
- (void)dealloc;	// IMP=0x000000000014346c
- (id)init;	// IMP=0x000000000014341e
