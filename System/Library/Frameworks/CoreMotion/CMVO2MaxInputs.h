...
+ (struct VO2MaxInput)VO2MaxInputFromCMVO2MaxInputs:(id)arg1;	// IMP=0x000000000010af0c
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000010aa50
- (id)description;	// IMP=0x000000000010b134
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000010adbe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010abef
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010aa58
- (void)dealloc;	// IMP=0x000000000010aa15
- (id)initWithSample:(struct VO2MaxInput)arg1;	// IMP=0x000000000010a94f
- (id)initWithRecordId:(unsigned long long)arg1 startDate:(id)arg2 mets:(double)arg3 metSource:(long long)arg4 heartRate:(double)arg5 heartRateConfidence:(double)arg6 grade:(double)arg7 gradeType:(long long)arg8 cadence:(double)arg9 pace:(double)arg10 hasGPS:(_Bool)arg11 hasStrideCal:(_Bool)arg12 workoutType:(long long)arg13;	// IMP=0x000000000010a81a
