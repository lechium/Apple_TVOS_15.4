...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x00000000000eccc2
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ec47a
- (void)_stopOdometerUpdates;	// IMP=0x00000000000ec2ab
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ebbbe
- (void)_startDaemonConnection;	// IMP=0x00000000000eb59a
- (void)_teardown;	// IMP=0x00000000000eb54e
- (void)dealloc;	// IMP=0x00000000000eb504
- (id)initWithOdometer:(id)arg1;	// IMP=0x00000000000eb422
