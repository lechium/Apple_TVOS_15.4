...
- (void)dealloc;	// IMP=0x000000000029ef45
- (id)initWithClientBundleIdentifier:(id)arg1 dispatchQueue:(id)arg2;	// IMP=0x000000000029edd2
- (void)debug;	// IMP=0x000000000029ed81
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x000000000029ec6b
