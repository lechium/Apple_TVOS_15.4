...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017447f
- (void).cxx_destruct;	// IMP=0x0000000000174b04
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001745db
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000174487
