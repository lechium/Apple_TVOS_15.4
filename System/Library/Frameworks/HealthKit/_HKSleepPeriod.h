...
- (void).cxx_destruct;	// IMP=0x00000000001e37e8
...
- (void)enumerateDateIntervalsForCategoryValue:(long long)arg1 intersectedWithDateInterval:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e3272
- (id)segmentDateIntervalsForCategoryValue:(long long)arg1 intersectedWithDateInterval:(id)arg2;	// IMP=0x00000000001e31a6
- (void)_setType:(long long)arg1;	// IMP=0x00000000001e319c
- (id)segmentsForCategory:(long long)arg1;	// IMP=0x00000000001e3110
- (id)initWithStartDate:(id)arg1 endDate:(id)arg2 segments:(id)arg3;	// IMP=0x00000000001e2d83
