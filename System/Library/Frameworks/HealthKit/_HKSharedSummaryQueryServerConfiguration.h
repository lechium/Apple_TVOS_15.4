...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000155f64
- (void).cxx_destruct;	// IMP=0x000000000015613e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000015605b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000155f6c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000155eee
