...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ce8e1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c1e3
- (id)description;	// IMP=0x00000000001ce896
- (id)hkWorkoutFromFriendWorkout;	// IMP=0x000000000001643d
