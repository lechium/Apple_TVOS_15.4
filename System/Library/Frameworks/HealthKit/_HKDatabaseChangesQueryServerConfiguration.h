...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d83f3
- (void).cxx_destruct;	// IMP=0x00000000001d8727
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d8583
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d83fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d8334
