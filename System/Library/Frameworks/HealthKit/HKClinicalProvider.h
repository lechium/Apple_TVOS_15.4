...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001c266f
- (void).cxx_destruct;	// IMP=0x00000000001c2a97
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c282b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c2677
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c2664
@property(readonly, nonatomic, getter=isSupported) _Bool supported;
@property(readonly, copy) NSString *description;
- (id)initWithExternalID:(id)arg1 title:(id)arg2 subtitle:(id)arg3 location:(id)arg4 informationURL:(id)arg5 brand:(id)arg6 gateways:(id)arg7;	// IMP=0x00000000001c235b
- (id)init;	// IMP=0x00000000001c22e1
