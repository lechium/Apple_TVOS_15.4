...
- (void).cxx_destruct;	// IMP=0x00000000001b402b
...
- (_Bool)matchesElementStack:(id)arg1;	// IMP=0x00000000001b3edb
- (id)initWithSpecificationString:(id)arg1;	// IMP=0x00000000001b3c55
