...
- (void).cxx_destruct;	// IMP=0x00000000000c64b5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000c6237
- (unsigned long long)hash;	// IMP=0x00000000000c60eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c5ea4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c5cf2
- (void)copyTo:(id)arg1;	// IMP=0x00000000000c5b93
- (void)writeTo:(id)arg1;	// IMP=0x00000000000c5a35
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000c5a28
- (id)dictionaryRepresentation;	// IMP=0x00000000000c530e
- (id)description;	// IMP=0x00000000000c525f
