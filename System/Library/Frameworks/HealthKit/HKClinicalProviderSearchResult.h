...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000bb6aa
- (void).cxx_destruct;	// IMP=0x00000000000bbb31
...
- (id)informationURL;	// IMP=0x00000000000bbad0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000bb8ae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bb6b2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bb69f
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bb520
- (id)initWithExternalID:(id)arg1 batchID:(id)arg2 title:(id)arg3 subtitle:(id)arg4 location:(id)arg5 supported:(_Bool)arg6 countryCode:(id)arg7 brand:(id)arg8 minCompatibleAPIVersion:(long long)arg9;	// IMP=0x00000000000bb399
