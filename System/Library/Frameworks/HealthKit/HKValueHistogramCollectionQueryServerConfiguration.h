...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ce010
- (void).cxx_destruct;	// IMP=0x00000000001ce28c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ce16c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ce018
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001cdf9c
