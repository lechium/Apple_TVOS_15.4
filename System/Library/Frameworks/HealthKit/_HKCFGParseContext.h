...
- (void).cxx_destruct;	// IMP=0x000000000001a2c0
...
- (void)increaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000019ce2
- (void)decreaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x00000000000198df
- (void)decrementRecursiveDepth;	// IMP=0x0000000000019cec
- (void)incrementRecursiveDepth;	// IMP=0x00000000000198e9
- (id)initWithScanner:(id)arg1 lengthAllowance:(unsigned long long)arg2;	// IMP=0x0000000000018e6a
