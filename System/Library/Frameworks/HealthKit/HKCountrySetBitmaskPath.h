...
+ (id)pathWithBitmask:(unsigned long long)arg1 index:(long long)arg2;	// IMP=0x0000000000172acb
@property(readonly, nonatomic) long long index; // @synthesize index=_index;
@property(readonly, nonatomic) unsigned long long bitmask; // @synthesize bitmask=_bitmask;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000172b3a
- (unsigned long long)hash;	// IMP=0x0000000000172b2c
