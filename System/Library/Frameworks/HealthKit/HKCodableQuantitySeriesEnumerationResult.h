...
- (void).cxx_destruct;	// IMP=0x0000000000147ec0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000147c8f
- (unsigned long long)hash;	// IMP=0x0000000000147850
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000147617
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000147485
- (void)copyTo:(id)arg1;	// IMP=0x0000000000147329
- (void)writeTo:(id)arg1;	// IMP=0x00000000001471b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001471ac
- (id)dictionaryRepresentation;	// IMP=0x00000000001468ca
- (id)description;	// IMP=0x000000000014681b
