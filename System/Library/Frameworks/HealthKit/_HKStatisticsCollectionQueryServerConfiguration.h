...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001b0954
- (void).cxx_destruct;	// IMP=0x00000000001b0cdd
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b0afb
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b095c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b087e
