...
+ (_Bool)_isConcreteObjectClass;	// IMP=0x00000000001ed54f
+ (_Bool)supportsEquivalence;	// IMP=0x00000000001eae4b
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ea0bc
+ (id)_newProcedureRecordWithType:(id)arg1 note:(id)arg2 enteredInError:(_Bool)arg3 modifiedDate:(id)arg4 originIdentifier:(id)arg5 locale:(id)arg6 extractionVersion:(long long)arg7 device:(id)arg8 metadata:(id)arg9 sortDate:(id)arg10 country:(id)arg11 state:(unsigned long long)arg12 procedureCodingCollection:(id)arg13 performers:(id)arg14 executionStartDate:(id)arg15 executionEndDate:(id)arg16 notPerformed:(_Bool)arg17 statusCoding:(id)arg18 categoryCodingCollection:(id)arg19 reasonCodingCollections:(id)arg20 reasonsNotPerformedCodingCollections:(id)arg21 outcomeCodingCollection:(id)arg22 complicationsCodingCollections:(id)arg23 followUpsCodingCollections:(id)arg24 bodySitesCodingCollections:(id)arg25 config:(CDUnknownBlockType)arg26;	// IMP=0x00000000001e9760
+ (id)procedureRecordWithType:(id)arg1 note:(id)arg2 enteredInError:(_Bool)arg3 modifiedDate:(id)arg4 originIdentifier:(id)arg5 locale:(id)arg6 extractionVersion:(long long)arg7 device:(id)arg8 metadata:(id)arg9 sortDate:(id)arg10 country:(id)arg11 state:(unsigned long long)arg12 procedureCodingCollection:(id)arg13 performers:(id)arg14 executionStartDate:(id)arg15 executionEndDate:(id)arg16 notPerformed:(_Bool)arg17 statusCoding:(id)arg18 categoryCodingCollection:(id)arg19 reasonCodingCollections:(id)arg20 reasonsNotPerformedCodingCollections:(id)arg21 outcomeCodingCollection:(id)arg22 complicationsCodingCollections:(id)arg23 followUpsCodingCollections:(id)arg24 bodySitesCodingCollections:(id)arg25;	// IMP=0x00000000001e96b6
+ (id)defaultDisplayString;	// IMP=0x000000000004343f
+ (id)cachedConceptRelationshipKeyPaths;	// IMP=0x00000000000dc825
+ (id)indexableConceptKeyPaths;	// IMP=0x00000000000dc672
+ (id)procedureRecordWithType:(id)arg1 note:(id)arg2 enteredInError:(_Bool)arg3 modifiedDate:(id)arg4 originIdentifier:(id)arg5 locale:(id)arg6 extractionVersion:(long long)arg7 device:(id)arg8 metadata:(id)arg9 country:(id)arg10 state:(unsigned long long)arg11 procedureCodingCollection:(id)arg12 performers:(id)arg13 executionStartDate:(id)arg14 executionEndDate:(id)arg15 notPerformed:(_Bool)arg16 statusCoding:(id)arg17 categoryCodingCollection:(id)arg18 reasonCodingCollections:(id)arg19 reasonsNotPerformedCodingCollections:(id)arg20 outcomeCodingCollection:(id)arg21 complicationsCodingCollections:(id)arg22 followUpsCodingCollections:(id)arg23 bodySitesCodingCollections:(id)arg24;	// IMP=0x000000000010dc9d
+ (_Bool)groupsByUserDomainConcept;	// IMP=0x0000000000212924
- (void).cxx_destruct;	// IMP=0x00000000001ed569
@property(readonly, copy) HKProcedureRecordType *procedureRecordType;
- (id)_validateWithConfiguration:(struct HKObjectValidationConfiguration)arg1;	// IMP=0x00000000001ed453
- (void)_setBodySites:(id)arg1;	// IMP=0x00000000001ed41f
@property(readonly, copy) NSArray *bodySites;
- (void)_setFollowUps:(id)arg1;	// IMP=0x00000000001ed34a
@property(readonly, copy) NSArray *followUps;
- (void)_setComplications:(id)arg1;	// IMP=0x00000000001ed275
@property(readonly, copy) NSArray *complications;
- (void)_setOutcome:(id)arg1;	// IMP=0x00000000001ed1a0
@property(readonly, copy) HKConcept *outcome;
- (void)_setReasonsNotPerformed:(id)arg1;	// IMP=0x00000000001ed0d9
@property(readonly, copy) NSArray *reasonsNotPerformed;
- (void)_setReason:(id)arg1;	// IMP=0x00000000001ed004
@property(readonly, copy) NSArray *reason;
- (void)_setCategory:(id)arg1;	// IMP=0x00000000001ecf2f
@property(readonly, copy) HKConcept *category;
- (void)_setStatus:(id)arg1;	// IMP=0x00000000001ece1a
@property(readonly, copy) HKConcept *status;
- (void)_setProcedure:(id)arg1;	// IMP=0x00000000001ecd17
@property(readonly, copy) HKConcept *procedure;
- (void)_setBodySitesCodingCollections:(id)arg1;	// IMP=0x00000000001ecbc9
@property(readonly, copy) NSArray *bodySitesCodingCollections;
- (void)_setFollowUpsCodingCollections:(id)arg1;	// IMP=0x00000000001ecae7
@property(readonly, copy) NSArray *followUpsCodingCollections;
- (void)_setComplicationsCodingCollections:(id)arg1;	// IMP=0x00000000001eca05
@property(readonly, copy) NSArray *complicationsCodingCollections;
- (void)_setOutcomeCodingCollection:(id)arg1;	// IMP=0x00000000001ec93d
@property(readonly, copy) HKMedicalCodingCollection *outcomeCodingCollection;
- (void)_setReasonsNotPerformedCodingCollections:(id)arg1;	// IMP=0x00000000001ec85b
@property(readonly, copy) NSArray *reasonsNotPerformedCodingCollections;
- (void)_setReasonCodingCollections:(id)arg1;	// IMP=0x00000000001ec779
@property(readonly, copy) NSArray *reasonCodingCollections;
- (void)_setCategoryCodingCollection:(id)arg1;	// IMP=0x00000000001ec6b1
@property(readonly, copy) HKMedicalCodingCollection *categoryCodingCollection;
- (void)_setStatusCoding:(id)arg1;	// IMP=0x00000000001ec5ff
@property(readonly, copy) HKMedicalCoding *statusCoding;
- (void)_setNotPerformed:(_Bool)arg1;	// IMP=0x00000000001ec5da
@property(readonly) _Bool notPerformed;
- (void)_setExecutionEndDate:(id)arg1;	// IMP=0x00000000001ec596
@property(readonly, copy) HKMedicalDate *executionEndDate;
- (void)_setExecutionStartDate:(id)arg1;	// IMP=0x00000000001ec54d
@property(readonly, copy) HKMedicalDate *executionStartDate;
- (void)_setPerformers:(id)arg1;	// IMP=0x00000000001ec504
@property(readonly, copy) NSArray *performers;
- (void)_setProcedureCodingCollection:(id)arg1;	// IMP=0x00000000001ec452
@property(readonly, copy) HKMedicalCodingCollection *procedureCodingCollection;
- (id)statusCodingCollection;	// IMP=0x00000000001ec3da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ec3cf
- (_Bool)isEquivalent:(id)arg1;	// IMP=0x00000000001eae53
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ea384
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ea0c4
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00000000001e9e78
- (id)medicalRecordCodings;	// IMP=0x00000000000433ef
@property(readonly, nonatomic) long long recordCategoryType;
- (_Bool)applyConcepts:(id)arg1 forKeyPath:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000dcd57
- (id)codingsForKeyPath:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000dc863
