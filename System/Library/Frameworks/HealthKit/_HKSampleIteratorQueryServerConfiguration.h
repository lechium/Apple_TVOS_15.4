...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001b7677
- (void).cxx_destruct;	// IMP=0x00000000001b7825
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKSampleIteratorQueryCursor *queryCursor; // @synthesize queryCursor=_queryCursor;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b7741
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b767f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b7601
