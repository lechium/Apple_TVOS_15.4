...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000098b1c
- (void).cxx_destruct;	// IMP=0x00000000000994f7
...
- (id)description;	// IMP=0x0000000000099373
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000099213
- (unsigned long long)hash;	// IMP=0x000000000009916d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000099040
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000098e0d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000098cf3
- (id)initWithSyncEnabled:(_Bool)arg1 accountSupportsSecureContainer:(_Bool)arg2 lastPullDate:(id)arg3 lastPushDate:(id)arg4 lastPulledUpdateDate:(id)arg5 restoreCompletionDate:(id)arg6 errorRequiringUserAction:(id)arg7 dataUploadRequestStatus:(long long)arg8 dataUploadRequestStartDate:(id)arg9 dataUploadRequestCompletionDate:(id)arg10;	// IMP=0x0000000000098b5d
- (id)init;	// IMP=0x0000000000098b24
