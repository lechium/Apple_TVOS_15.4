...
- (void).cxx_destruct;	// IMP=0x00000000000df1a7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000df031
- (id)description;	// IMP=0x00000000000def9c
- (id)initWithEvent:(long long)arg1 label:(id)arg2 from:(id)arg3 to:(id)arg4;	// IMP=0x00000000000deec7
- (id)init;	// IMP=0x00000000000dee4d
