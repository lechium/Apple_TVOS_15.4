...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000bda7
+ (id)_mostSignificantSnapshotAmongSnapshots:(id)arg1;	// IMP=0x0000000000010691
+ (id)snapshotWithActivitySummary:(id)arg1;	// IMP=0x000000000000f021
+ (_Bool)_isConcreteObjectClass;	// IMP=0x00000000000a8770
+ (id)_fitnessFriendActivitySnapshotWithSnapshotIndex:(long long)arg1 startDate:(id)arg2 endDate:(id)arg3 sourceUUID:(id)arg4;	// IMP=0x000000000000f6a0
+ (id)_fitnessFriendActivitySnapshotWithFriendUUID:(id)arg1 sourceUUID:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 snapshotIndex:(long long)arg5 snapshotUploadedDate:(id)arg6;	// IMP=0x00000000000a82fb
- (void).cxx_destruct;	// IMP=0x000000000000fc21
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000bdaf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a8f72
...
- (id)_mostSignificantSnapshot:(id)arg1;	// IMP=0x00000000000a8e18
- (id)activitySummary;	// IMP=0x00000000000a8846
- (id)description;	// IMP=0x00000000000a8778
