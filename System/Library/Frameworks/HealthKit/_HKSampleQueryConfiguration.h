...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000183b6
- (void).cxx_destruct;	// IMP=0x00000000000119bb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008282d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002404
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008276d
