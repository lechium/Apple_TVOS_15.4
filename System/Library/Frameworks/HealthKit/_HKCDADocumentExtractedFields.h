...
- (void).cxx_destruct;	// IMP=0x000000000009e909
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x000000000009e72d
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x000000000009e52b
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x000000000009e48b
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x000000000009e1cb
- (id)initWithDocumentData:(id)arg1;	// IMP=0x000000000009e163
