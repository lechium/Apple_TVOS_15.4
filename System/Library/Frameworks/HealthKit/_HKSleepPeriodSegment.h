...
- (void).cxx_destruct;	// IMP=0x00000000001e2d50
...
- (id)initWithStartDate:(id)arg1 endDate:(id)arg2 category:(long long)arg3 samples:(id)arg4 duration:(double)arg5;	// IMP=0x00000000001e2c1c
