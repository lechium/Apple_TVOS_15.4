...
+ (id)emptyAnalysis;	// IMP=0x0000000000080689
- (void).cxx_destruct;	// IMP=0x0000000000080780
...
- (id)initWithSleepDays:(id)arg1 numberOfAsleepSamples:(long long)arg2 averageTimeInBed:(double)arg3 averageTimeAlseep:(double)arg4;	// IMP=0x00000000000806ba
