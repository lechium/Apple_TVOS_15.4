...
- (void).cxx_destruct;	// IMP=0x000000000011e95a
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x000000000011e7f2
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000011e787
