...
- (void).cxx_destruct;	// IMP=0x00000000000a1798
...
- (void)dealloc;	// IMP=0x00000000000a1689
- (id)initWithSubjectUUID:(id)arg1 studyUUID:(id)arg2 channel:(id)arg3 payloadType:(id)arg4 certificate:(struct __SecCertificate *)arg5;	// IMP=0x00000000000a14a7
- (id)initWithChannel:(id)arg1 payloadType:(id)arg2 certificate:(struct __SecCertificate *)arg3;	// IMP=0x00000000000a127d
