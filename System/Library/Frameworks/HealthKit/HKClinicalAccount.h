...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001bf6a7
- (void).cxx_destruct;	// IMP=0x00000000001bfa93
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bfa26
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bf7c9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bf6af
@property(readonly, nonatomic) _Bool needsRelogin;
@property(readonly, nonatomic) _Bool needsScopeUpgrade;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bf599
...
- (id)initWithIdentifier:(id)arg1 state:(long long)arg2 userEnabled:(_Bool)arg3 lastFetchDate:(id)arg4 lastFullFetchDate:(id)arg5 lastFailedFetchDate:(id)arg6 failedFetchAttemptsCount:(id)arg7 clinicalSharingStatus:(id)arg8 hasClinicalSharingScopes:(_Bool)arg9 provenance:(id)arg10;	// IMP=0x00000000001bf0e3
- (id)init;	// IMP=0x00000000001bf069
