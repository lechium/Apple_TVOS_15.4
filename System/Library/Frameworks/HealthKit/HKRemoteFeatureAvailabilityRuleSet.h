...
- (void).cxx_destruct;	// IMP=0x00000000001e4374
...
- (id)evaluateAll;	// IMP=0x00000000001e40ef
- (void)_parseRulesFromRawValue:(id)arg1 dataSource:(id)arg2;	// IMP=0x00000000001e3dc3
- (id)initWithRawValue:(id)arg1 dataSource:(id)arg2 supportedConditions:(id)arg3;	// IMP=0x00000000001e3ce3
