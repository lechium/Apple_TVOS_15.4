...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d6618
- (void).cxx_destruct;	// IMP=0x000000000001d594
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d6620
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000017ce8
- (id)description;	// IMP=0x0000000000017a27
@property(readonly, nonatomic) long long workoutEventType;
@property(readonly, copy, nonatomic) NSUUID *sessionUUID;
- (id)initWithWorkoutEventType:(long long)arg1 sessionUUID:(id)arg2 dateInterval:(id)arg3 metadata:(id)arg4 error:(id)arg5;	// IMP=0x00000000001d65af
- (id)initWithSessionId:(id)arg1 error:(id)arg2;	// IMP=0x00000000001d650e
- (id)initWithEventType:(long long)arg1 sessionId:(id)arg2 dateInterval:(id)arg3 metadata:(id)arg4;	// IMP=0x0000000000017950
