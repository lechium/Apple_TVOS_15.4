...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000b8dbe
- (void).cxx_destruct;	// IMP=0x00000000000b9151
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b8fd1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b8dc6
