...
- (void).cxx_destruct;	// IMP=0x00000000002117f3
...
- (id)description;	// IMP=0x0000000000211779
@property(readonly, nonatomic) long long provenance;
- (id)initWithMobileCountryCode:(id)arg1 ISOCode:(id)arg2 isOverridden:(_Bool)arg3;	// IMP=0x00000000002116a2
