...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000156d90
- (void).cxx_destruct;	// IMP=0x0000000000157205
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000156fa9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000156d98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000156c8a
