...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000009751
- (void).cxx_destruct;	// IMP=0x00000000000182b3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d1101
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000030ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d100e
