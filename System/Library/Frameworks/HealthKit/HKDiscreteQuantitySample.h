...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000089526
+ (_Bool)_isConcreteObjectClass;	// IMP=0x000000000008909f
- (void).cxx_destruct;	// IMP=0x00000000000899e2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000089603
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008952e
- (id)_validateWithConfiguration:(struct HKObjectValidationConfiguration)arg1;	// IMP=0x00000000000890a7
