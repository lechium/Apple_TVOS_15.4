...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005b7fe
+ (id)_conceptWithIdentifier:(id)arg1 attributes:(id)arg2;	// IMP=0x000000000005a1f3
+ (id)conceptWithIdentifier:(id)arg1 attributes:(id)arg2 relationships:(id)arg3;	// IMP=0x000000000005a15f
+ (id)preferredLanguages;	// IMP=0x000000000005a0aa
+ (id)fallbackLanguagesForLocale:(id)arg1;	// IMP=0x000000000005a001
- (void).cxx_destruct;	// IMP=0x000000000005bb9e
...
- (id)description;	// IMP=0x000000000005bae4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005ba4a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005b806
- (void)setRelationships:(id)arg1;	// IMP=0x000000000005b79d
...
- (id)stringsForAttributeType:(long long)arg1;	// IMP=0x000000000005b223
- (void)enumerateAttributesWithType:(long long)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000005b0a4
- (id)attributesForType:(long long)arg1;	// IMP=0x000000000005b018
- (id)firstAttributeForType:(long long)arg1;	// IMP=0x000000000005af8c
...
- (id)_conceptsOfRelationshipType:(long long)arg1;	// IMP=0x000000000005a8b1
- (id)_firstConceptOfRelationshipType:(long long)arg1;	// IMP=0x000000000005a772
@property(readonly, copy, nonatomic) NSArray *relationships;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005a5ac
- (unsigned long long)hash;	// IMP=0x000000000005a568
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005a55d
- (id)init;	// IMP=0x000000000005a4e3
- (id)initWithIdentifier:(id)arg1 attributes:(id)arg2 relationships:(id)arg3 relationshipsAreLoaded:(_Bool)arg4;	// IMP=0x000000000005a26b
