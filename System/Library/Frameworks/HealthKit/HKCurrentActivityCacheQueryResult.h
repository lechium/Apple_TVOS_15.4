...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017771e
- (void).cxx_destruct;	// IMP=0x0000000000177d18
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000017787a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000177726
