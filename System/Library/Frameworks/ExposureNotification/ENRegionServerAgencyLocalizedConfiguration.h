...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000014e31
+ (_Bool)getLocalizedAgencyConfiguration:(id *)arg1 region:(id)arg2 fromDictionary:(id)arg3 locale:(id)arg4;	// IMP=0x0000000000013c47
- (void).cxx_destruct;	// IMP=0x0000000000015011
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000014e26
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001483e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014671
- (id)description;	// IMP=0x0000000000014439
- (id)notificationConfigurationForName:(id)arg1;	// IMP=0x0000000000013a74
- (id)initWithRegion:(id)arg1;	// IMP=0x000000000001399c
