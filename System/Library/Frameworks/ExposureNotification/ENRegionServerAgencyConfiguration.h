...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000015f53
- (void).cxx_destruct;	// IMP=0x0000000000016028
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000015ef8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015b30
- (id)initWithServerResponseDictionary:(id)arg1 locale:(id)arg2;	// IMP=0x0000000000015573
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000015413
- (id)description;	// IMP=0x0000000000015217
- (id)initWithRegion:(id)arg1;	// IMP=0x0000000000015100
