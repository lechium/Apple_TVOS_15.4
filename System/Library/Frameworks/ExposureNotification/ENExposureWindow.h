...
- (void).cxx_destruct;	// IMP=0x000000000000e0c4
...
- (id)description;	// IMP=0x000000000000de5d
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000000dbae
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000d6f3
