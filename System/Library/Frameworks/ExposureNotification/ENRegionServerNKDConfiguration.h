...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000012fdd
- (void).cxx_destruct;	// IMP=0x0000000000013054
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012fd2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000012b0e
- (id)initWithServerResponseDictionary:(id)arg1;	// IMP=0x0000000000012341
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001221a
