...
- (void).cxx_destruct;	// IMP=0x000000000001b920
...
- (id)description;	// IMP=0x000000000001b72d
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000001b4fa
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001b30d
- (_Bool)_encodeInfoWithProtobufCoder:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001b1a7
- (_Bool)encodeWithProtobufCoder:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001b01a
- (_Bool)_readSignatureInfoPtr:(const char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000001abc6
- (id)initWithBytes:(const char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000001a6df
