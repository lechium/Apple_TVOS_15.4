...
- (void).cxx_destruct;	// IMP=0x000000000000b54e
...
- (double)weightedDurationWithExposureInfo:(id)arg1;	// IMP=0x000000000000b0f5
- (double)transmissionLevelValueWithTransmissionRiskLevel:(unsigned char)arg1;	// IMP=0x000000000000b0d0
- (double)reportTypeWeightWithReportType:(unsigned int)arg1 skip:(_Bool *)arg2;	// IMP=0x000000000000b059
- (unsigned int)mappedDiagnosisReportType:(unsigned int)arg1;	// IMP=0x000000000000b046
- (double)infectiousnessWeightWithDaysSinceOnsetOfSymptoms:(long long)arg1 skip:(_Bool *)arg2;	// IMP=0x000000000000b008
- (unsigned int)infectiousnessWithDaysSinceOnsetOfSymptoms:(long long)arg1;	// IMP=0x000000000000afb7
- (double)durationLevelValueWithDuration:(double)arg1;	// IMP=0x000000000000af0b
- (double)daysSinceLastExposureLevelValueWithDays:(long long)arg1;	// IMP=0x000000000000ae9e
- (double)attenuationLevelValueWithAttenuation:(unsigned char)arg1;	// IMP=0x000000000000ae8c
- (id)description;	// IMP=0x000000000000ab49
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000000a771
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000099d2
- (id)dictionaryRepresentation;	// IMP=0x0000000000009423
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000009388
- (id)initWithDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000007cb2
- (id)init;	// IMP=0x0000000000007b71
