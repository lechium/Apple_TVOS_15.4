...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000013919
+ (_Bool)getNotificationConfiguration:(id *)arg1 fromDictionary:(id)arg2 locale:(id)arg3 index:(unsigned char)arg4;	// IMP=0x00000000000130d4
- (void).cxx_destruct;	// IMP=0x0000000000013953
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001390e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000013705
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001365c
