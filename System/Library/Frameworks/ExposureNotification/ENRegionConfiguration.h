...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002f8b4
- (void).cxx_destruct;	// IMP=0x000000000002fe1b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f8bc
- (id)updatedWithConfiguration:(id)arg1;	// IMP=0x000000000002f5a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002f436
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002f1ab
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002ee8a
- (id)initWithVersion:(unsigned long long)arg1 region:(id)arg2;	// IMP=0x000000000002edd6
- (id)description;	// IMP=0x000000000002ec51
