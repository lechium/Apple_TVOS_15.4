...
- (void).cxx_destruct;	// IMP=0x0000000000005433
...
- (id)description;	// IMP=0x0000000000005152
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x0000000000004fba
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000004cb6
