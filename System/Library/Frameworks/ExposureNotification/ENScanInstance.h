...
- (id)description;	// IMP=0x000000000000e2cf
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000000e264
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000e0ec
