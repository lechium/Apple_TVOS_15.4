...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000011afa
- (void).cxx_destruct;	// IMP=0x0000000000011db7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000011aef
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011375
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010aca
- (id)preferredLocalizationsFromArray:(id)arg1;	// IMP=0x00000000000109c9
- (id)initWithServerResponseDictionary:(id)arg1;	// IMP=0x000000000000fa74
- (_Bool)supportsFeatures:(unsigned int)arg1;	// IMP=0x000000000000fa51
- (id)description;	// IMP=0x000000000000f633
