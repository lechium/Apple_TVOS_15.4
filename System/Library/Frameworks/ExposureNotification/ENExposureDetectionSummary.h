...
- (void).cxx_destruct;	// IMP=0x000000000000cb49
...
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000000c64a
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000c0a9
