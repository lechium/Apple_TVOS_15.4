...
- (void)roundDurations;	// IMP=0x000000000000d63f
- (id)description;	// IMP=0x000000000000d61d
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000000d59a
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000d47e
