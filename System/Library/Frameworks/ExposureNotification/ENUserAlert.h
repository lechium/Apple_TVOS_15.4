...
- (void).cxx_destruct;	// IMP=0x0000000000036527
...
- (void)_responseCallback:(struct __CFUserNotification *)arg1 responseFlags:(unsigned long long)arg2;	// IMP=0x00000000000362e0
- (void)_invalidated;	// IMP=0x00000000000361f2
- (void)_autoInvalidate;	// IMP=0x00000000000360a3
- (void)invalidate;	// IMP=0x0000000000035fdb
- (void)_activateWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000035926
- (void)activateWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000035694
- (void)dealloc;	// IMP=0x000000000003564b
- (id)init;	// IMP=0x00000000000355db
