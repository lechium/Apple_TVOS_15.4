...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001b974
- (void).cxx_destruct;	// IMP=0x000000000001bee3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001bd09
@property(readonly, copy, nonatomic) NSDate *date;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b97c
