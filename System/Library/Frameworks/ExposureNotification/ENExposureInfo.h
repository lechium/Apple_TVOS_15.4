...
- (void).cxx_destruct;	// IMP=0x000000000000d44b
...
- (id)description;	// IMP=0x000000000000d0db
- (void)encodeWithXPCObject:(id)arg1;	// IMP=0x000000000000cf76
- (id)initWithXPCObject:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000cbed
- (id)init;	// IMP=0x000000000000cb7c
