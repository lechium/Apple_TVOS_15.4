...
- (void).cxx_destruct;	// IMP=0x0000000000024ecb
...
- (long long)rightAccessoryType;	// IMP=0x0000000000024c0e
- (long long)leftAccessoryType;	// IMP=0x0000000000024bda
- (id)rightIconProperties;	// IMP=0x0000000000024b96
- (id)leftIconProperties;	// IMP=0x0000000000024b52
- (id)rightIcon;	// IMP=0x0000000000024b0e
- (id)leftIcon;	// IMP=0x0000000000024aca
- (void)applyToAllCaptions:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024a4e
...
- (id)init;	// IMP=0x000000000002489b
