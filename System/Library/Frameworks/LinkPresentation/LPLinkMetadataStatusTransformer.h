...
- (void).cxx_destruct;	// IMP=0x00000000000200b5
...
- (id)originalURL;	// IMP=0x000000000001fff4
@property(readonly, copy, nonatomic) NSURL *actionURL;
@property(readonly, copy, nonatomic) NSAttributedString *statusText;
- (void)dealloc;	// IMP=0x000000000001f9cd
- (id)initWithMetadata:(id)arg1 URL:(id)arg2;	// IMP=0x000000000001f81a
