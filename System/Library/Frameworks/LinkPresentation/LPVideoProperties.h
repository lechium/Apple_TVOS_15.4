...
- (void).cxx_destruct;	// IMP=0x0000000000031b8b
...
- (unsigned long long)hash;	// IMP=0x0000000000031b2f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000031a4e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003195c
