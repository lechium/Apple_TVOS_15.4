...
+ (id)keyPathsForValuesAffecting_dummyPropertyForObservation;	// IMP=0x00000000000172b1
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000016d02
- (void).cxx_destruct;	// IMP=0x000000000001741e
...
- (void)_enumerateAsynchronousFields:(CDUnknownBlockType)arg1;	// IMP=0x000000000001729c
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000170fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016f82
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016e9b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016d0a
- (id)storeIdentifierForTransformer:(id)arg1;	// IMP=0x000000000002b535
- (void)populateMetadataForBackwardCompatibility:(id)arg1;	// IMP=0x000000000002b495
- (id)previewImageForTransformer:(id)arg1;	// IMP=0x000000000002b48d
- (id)previewSummaryForTransformer:(id)arg1;	// IMP=0x000000000002b3f6
- (_Bool)canGeneratePresentationPropertiesForURL:(id)arg1;	// IMP=0x000000000002b3dd
- (id)presentationPropertiesForTransformer:(id)arg1;	// IMP=0x000000000002b2ba
