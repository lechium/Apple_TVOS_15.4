...
@interface HapticServerConfig : NSObject
{
    ...
    _Bool _supportsAdvancedPatternPlayers;	// 18 = 0x12
...
- (id).cxx_construct;	// IMP=0x000000000000799b
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000057f6
