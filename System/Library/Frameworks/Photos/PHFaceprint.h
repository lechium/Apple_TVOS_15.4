...
- (void).cxx_destruct;	// IMP=0x000000000002b3e4
...
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000002b31f
- (id)dictionaryRepresentation;	// IMP=0x000000000002b256
- (id)initWithFaceprintData:(id)arg1 faceprintVersion:(long long)arg2;	// IMP=0x000000000002b167
