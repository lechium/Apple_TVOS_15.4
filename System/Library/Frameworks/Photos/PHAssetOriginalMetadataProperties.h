...
+ (id)propertiesToFetch;	// IMP=0x00000000000e2e59
+ (id)propertySetName;	// IMP=0x00000000000e2e4c
- (void).cxx_destruct;	// IMP=0x00000000000e299f
...
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e25fa
