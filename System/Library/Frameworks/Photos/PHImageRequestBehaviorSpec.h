...
+ (unsigned long long)loadingOptionsFromLoadingMode:(long long)arg1;	// IMP=0x00000000001b8e1d
...
- (_Bool)isExplicitUserAction;	// IMP=0x00000000001b8ce1
- (_Bool)shouldLoadDataOrURL;	// IMP=0x00000000001b8cd4
- (_Bool)shouldLoadURL;	// IMP=0x00000000001b8cc6
- (_Bool)shouldLoadData;	// IMP=0x00000000001b8cb9
- (_Bool)shouldLoadImage;	// IMP=0x00000000001b8cae
- (id)description;	// IMP=0x00000000001b8c0c
- (id)shortDescription;	// IMP=0x00000000001b8972
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b88ec
