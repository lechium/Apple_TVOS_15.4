...
+ (id)propertiesToFetch;	// IMP=0x00000000000e49e4
+ (id)propertySetName;	// IMP=0x00000000000e49d7
- (void).cxx_destruct;	// IMP=0x00000000000e4995
...
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e47b7
