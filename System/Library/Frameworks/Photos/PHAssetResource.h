...
+ (id)assetResourcesForLivePhoto:(id)arg1;	// IMP=0x00000000000c9b46
+ (id)assetResourcesForAsset:(id)arg1;	// IMP=0x00000000000c9b32
+ (id)_assetResourcesFromPLResources:(id)arg1 includeMetadata:(_Bool)arg2 mediaMetadataVirtualResources:(id)arg3 asset:(id)arg4 assetHasAdjustments:(_Bool)arg5 includeDerivatives:(_Bool)arg6 includeAdjustmentOverflowDataBlob:(_Bool)arg7;	// IMP=0x00000000000ca0b4
+ (id)assetResourceForAsset:(id)arg1 qualityClass:(id)arg2;	// IMP=0x00000000000c9f1a
+ (id)assetResourcesForAsset:(id)arg1 includeDerivatives:(_Bool)arg2 includeMetadata:(_Bool)arg3 includeAdjustmentOverflowDataBlob:(_Bool)arg4;	// IMP=0x00000000000c9dbc
+ (id)assetResourcesForAsset:(id)arg1 includeDerivatives:(_Bool)arg2 includeMetadata:(_Bool)arg3;	// IMP=0x00000000000c9da7
+ (id)assetResourcesForAsset:(id)arg1 includeDerivatives:(_Bool)arg2;	// IMP=0x00000000000c9d92
- (void).cxx_destruct;	// IMP=0x00000000000c96b6
...
- (id)debugDescription;	// IMP=0x00000000000c93c3
- (id)description;	// IMP=0x00000000000c92a0
- (id)initWithType:(long long)arg1 livePhoto:(id)arg2;	// IMP=0x00000000000c8e94
- (id)initWithResource:(id)arg1 asset:(id)arg2 hasAdjustments:(_Bool)arg3;	// IMP=0x00000000000c7cbe
