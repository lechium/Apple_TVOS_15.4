...
- (void).cxx_destruct;	// IMP=0x00000000001a29ae
...
- (id)initWithFetchedPropertySetClass:(Class)arg1;	// IMP=0x00000000001a2899
- (id)initWithFetchedObjectClass:(Class)arg1;	// IMP=0x00000000001a27ca
