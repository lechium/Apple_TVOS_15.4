...
+ (id)propertiesToFetch;	// IMP=0x00000000000e6e8e
+ (id)entityName;	// IMP=0x00000000000e6e81
+ (id)keyPathFromPrimaryObject;	// IMP=0x00000000000e6e74
+ (id)propertySetName;	// IMP=0x00000000000e6e67
...
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e64ea
- (void)initWithDefaultValues;	// IMP=0x00000000000e6410
