...
+ (id)propertiesToFetch;	// IMP=0x00000000000e50f6
+ (id)propertySetName;	// IMP=0x00000000000e50e9
- (void).cxx_destruct;	// IMP=0x00000000000e50b8
...
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e4f14
