...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017b46f
+ (unsigned long long)maximumAdjustmentDataLength;	// IMP=0x000000000017b464
+ (id)renderURLWithExtensionForMediaType:(long long)arg1 useHEICImage:(_Bool)arg2;	// IMP=0x000000000017b2cd
+ (id)renderURLWithExtensionForMediaType:(long long)arg1;	// IMP=0x000000000017b2b9
+ (id)outputForFlippingFullSizeRenderWithContentEditingInput:(id)arg1 error:(id *)arg2;	// IMP=0x000000000017b2b1
- (void).cxx_destruct;	// IMP=0x000000000017b138
...
- (id)debugDescription;	// IMP=0x000000000017ad3d
- (id)description;	// IMP=0x000000000017ac4d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000017a9a3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000017a5c6
- (void)_setupRequiredRenderedContentURLsWithEditingInput:(id)arg1 options:(id)arg2;	// IMP=0x000000000017a1f1
- (_Bool)isOnlyChangingOriginalChoice;	// IMP=0x000000000017a183
- (id)assetAdjustmentsWithEditorBundleID:(id)arg1;	// IMP=0x000000000017a01a
- (void)setRenderedJPEGData:(id)arg1;	// IMP=0x0000000000179fa0
@property long long baseVersion;
@property(retain) PHAdjustmentData *adjustmentData;
- (void)clearRenderedContentURL;	// IMP=0x0000000000179d21
- (id)renderURLWithExtensionForMediaType:(long long)arg1;	// IMP=0x0000000000179cfa
- (id)initWithAdjustmentBaseVersion:(long long)arg1 mediaType:(long long)arg2;	// IMP=0x0000000000179c7f
- (id)initWithPlaceholderForCreatedAsset:(id)arg1;	// IMP=0x0000000000179b63
- (id)initWithContentEditingInput:(id)arg1 withOptions:(id)arg2;	// IMP=0x00000000001798c4
- (id)initWithContentEditingInput:(id)arg1;	// IMP=0x00000000001798b0
