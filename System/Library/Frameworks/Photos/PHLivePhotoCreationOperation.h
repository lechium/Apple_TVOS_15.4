...
- (void).cxx_destruct;	// IMP=0x000000000012c8db
...
- (id)_createImageOnlyLivePhotoWithImageURL:(id)arg1;	// IMP=0x000000000012c6de
- (void)main;	// IMP=0x000000000012c2f2
- (id)initWithResourceURLs:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000012c1f8
