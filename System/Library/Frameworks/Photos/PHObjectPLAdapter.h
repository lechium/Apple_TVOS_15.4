...
- (void).cxx_destruct;	// IMP=0x000000000018d349
...
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000000018d2d7
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000018d242
- (void)removeObjectForKey:(id)arg1;	// IMP=0x000000000018d1ca
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000000018d1b8
- (id)objectForKey:(id)arg1;	// IMP=0x000000000018d125
- (id)mutableAccessingCopy;	// IMP=0x000000000018d09a
- (id)newObjectWithPropertySets:(id)arg1;	// IMP=0x000000000018d092
- (id)initWithPLManagedObject:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x000000000018cead
