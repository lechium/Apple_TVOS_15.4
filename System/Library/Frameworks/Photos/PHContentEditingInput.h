...
- (void).cxx_destruct;	// IMP=0x0000000000189d3f
...
- (id)description;	// IMP=0x00000000001899ef
- (void)_invalidateAVAsset;	// IMP=0x00000000001899a4
@property(readonly) AVAsset *audiovisualAsset; // @synthesize audiovisualAsset=_avAsset;
@property(readonly) AVAsset *avAsset;
- (void)consumeSandboxExtensionToken:(id)arg1;	// IMP=0x000000000018975d
- (void)requestFullSizeImageURLWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001896db
- (id)videoComposition;	// IMP=0x00000000001896d3
- (id)audioMix;	// IMP=0x00000000001896cb
- (id)imagePreview;	// IMP=0x00000000001896b9
- (void)loadFullSizeImageDataWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000018962b
- (_Bool)isMediaSubtype:(unsigned long long)arg1;	// IMP=0x0000000000189618
- (void)dealloc;	// IMP=0x000000000018947b
- (id)init;	// IMP=0x0000000000189423
