...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000195818
...
- (_Bool)isExplicitUserAction;	// IMP=0x00000000001956fe
- (_Bool)streamingIntentAllowsFallbackToDownload;	// IMP=0x00000000001956e9
- (_Bool)hasValidTimeRange;	// IMP=0x0000000000195654
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001954b6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000195352
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001951bc
- (long long)videoVersion;	// IMP=0x000000000019519c
- (long long)videoDeliveryMode;	// IMP=0x000000000019517c
- (id)shortDescription;	// IMP=0x0000000000194f2f
