...
- (void).cxx_destruct;	// IMP=0x00000000001b718f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b70c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b6e55
- (id)initWithFetchRequest:(id)arg1 containerIdentifier:(id)arg2 fetchPropertySets:(id)arg3;	// IMP=0x00000000001b6d1e
