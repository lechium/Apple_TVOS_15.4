...
- (void).cxx_destruct;	// IMP=0x00000000001bf5ab
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bf430
- (id)renderResultHandlerQueue;	// IMP=0x000000000018050f
- (_Bool)liveRenderAndOnDemandRenderVideoConcurrently;	// IMP=0x0000000000180507
- (_Bool)isCurrentVersion;	// IMP=0x00000000001804ee
- (id)resultHandlerQueue;	// IMP=0x00000000001c82b6
- (_Bool)isSynchronous;	// IMP=0x00000000001c82ae
