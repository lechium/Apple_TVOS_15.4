...
+ (id)additionalPropertiesToFetchOnPrimaryObject;	// IMP=0x00000000000e7ec5
+ (id)propertiesToFetch;	// IMP=0x00000000000e7ea1
+ (id)entityName;	// IMP=0x00000000000e7e94
+ (id)keyPathToPrimaryObject;	// IMP=0x00000000000e7e87
+ (id)keyPathFromPrimaryObject;	// IMP=0x00000000000e7e7a
+ (id)propertySetName;	// IMP=0x00000000000e7e6d
- (void).cxx_destruct;	// IMP=0x00000000000e7e3c
...
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e7171
- (void)initWithDefaultValues;	// IMP=0x00000000000e703e
