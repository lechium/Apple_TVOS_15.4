...
- (void).cxx_destruct;	// IMP=0x00000000000b0d9d
...
- (void)assetResourceRequest:(id)arg1 didFinishWithError:(id)arg2;	// IMP=0x00000000000b0c93
- (void)startRequest;	// IMP=0x00000000000b0b1f
- (void)cancel;	// IMP=0x00000000000b0b09
@property(readonly, nonatomic, getter=isCancelled) _Bool cancelled;
- (void)_handleDidFindFileURL:(id)arg1;	// IMP=0x00000000000b096d
- (void)setErrorIfNone:(id)arg1;	// IMP=0x00000000000b092e
- (id)initWithAssetResource:(id)arg1 destinationFileURL:(id)arg2 options:(id)arg3 requestID:(int)arg4 managerID:(unsigned long long)arg5 delegate:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00000000000b0782
