...
- (void).cxx_destruct;	// IMP=0x0000000000077a1b
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000776f7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000774e9
- (id)init;	// IMP=0x000000000007747b
