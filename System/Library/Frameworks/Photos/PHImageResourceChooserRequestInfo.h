...
- (void).cxx_destruct;	// IMP=0x000000000003e51d
...
- (id)initWithAsset:(id)arg1 desiredSize:(struct CGSize)arg2 requestedScale:(float)arg3 allowedResourceVersions:(id)arg4 behaviorSpec:(id)arg5 cloudSharedMode:(_Bool)arg6 fallbackRequestedScaleIfPreferredResourceNotLocallyAvailable:(double)arg7 loggingPrefix:(id)arg8;	// IMP=0x000000000003e392
