...
- (void).cxx_destruct;	// IMP=0x0000000000052478
...
- (void)dealloc;	// IMP=0x00000000000523d4
@property(readonly, nonatomic) _Bool cancelRequested;
- (void)cancel;	// IMP=0x0000000000052367
- (id)initWithImageIODecoder:(id)arg1;	// IMP=0x00000000000522f4
- (id)initWithFigRequestID:(unsigned long long)arg1 container:(struct CMPhotoDecompressionContainer *)arg2 figDecoder:(id)arg3;	// IMP=0x000000000005225f
