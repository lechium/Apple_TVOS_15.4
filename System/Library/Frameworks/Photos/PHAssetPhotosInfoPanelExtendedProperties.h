...
+ (id)propertiesToFetch;	// IMP=0x00000000000e4145
+ (id)keyPathFromPrimaryObject;	// IMP=0x00000000000e4138
+ (id)entityName;	// IMP=0x00000000000e412b
+ (id)propertySetName;	// IMP=0x00000000000e411e
- (void).cxx_destruct;	// IMP=0x00000000000e3faa
...
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e364b
