...
- (void).cxx_destruct;	// IMP=0x0000000000045814
...
- (double)scoreForSuggestionMatchingType:(long long)arg1;	// IMP=0x0000000000045729
- (void)registerMatchingType:(long long)arg1 weight:(double)arg2;	// IMP=0x000000000004563a
- (id)initWithSuggestion:(id)arg1 messageContext:(id)arg2;	// IMP=0x0000000000045577
