...
- (void).cxx_destruct;	// IMP=0x0000000000092d1a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000092bd2
- (id)propertyListRepresentation;	// IMP=0x0000000000092a80
- (id)initWithPropertyListRepresentation:(id)arg1;	// IMP=0x00000000000928d6
