...
+ (id)defaultDetectionTypes;	// IMP=0x00000000000ab36b
+ (id)fetchOptionsCopyFromNullableFetchOptions:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00000000000ab2e3
+ (id)effectivePhotoLibraryForFetchOptions:(id)arg1 object:(id)arg2;	// IMP=0x00000000000ab251
+ (id)fetchOptionsWithPhotoLibrary:(id)arg1 orObject:(id)arg2;	// IMP=0x00000000000ab19f
+ (id)fetchOptionsWithInclusiveDefaultsForPhotoLibrary:(id)arg1;	// IMP=0x00000000000ab149
+ (id)fetchOptionsWithInclusiveDefaults;	// IMP=0x00000000000ab0e3
- (void).cxx_destruct;	// IMP=0x00000000000aadd2
...
- (id)description;	// IMP=0x00000000000aa9b6
...
- (void)addFetchPropertySets:(id)arg1;	// IMP=0x00000000000a9a24
@property(retain, nonatomic) NSArray *fetchPropertySets;
@property(readonly, nonatomic) _Bool hasAnySortDescriptors;
- (void)mergeWithFetchOptions:(id)arg1;	// IMP=0x00000000000a8c99
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a8491
- (id)init;	// IMP=0x00000000000a83d7
