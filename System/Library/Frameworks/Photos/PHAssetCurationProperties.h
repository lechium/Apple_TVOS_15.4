...
+ (id)propertiesToFetch;	// IMP=0x00000000000e62fc
+ (id)keyPathToPrimaryObject;	// IMP=0x00000000000e62f4
+ (id)keyPathFromPrimaryObject;	// IMP=0x00000000000e62ec
+ (id)entityName;	// IMP=0x00000000000e62e4
+ (id)propertySetName;	// IMP=0x00000000000e62d7
- (void).cxx_destruct;	// IMP=0x00000000000e6251
...
- (float)_semanticScoreFromBehavioralScore:(double)arg1;	// IMP=0x00000000000e6195
@property(readonly, nonatomic) NSArray *objectSaliencyRects;
- (id)initWithFetchDictionary:(id)arg1 asset:(id)arg2 prefetched:(_Bool)arg3;	// IMP=0x00000000000e5d04
