...
- (void).cxx_destruct;	// IMP=0x00000000001bf35b
...
- (_Bool)hasValidTimeRange;	// IMP=0x00000000001bf138
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001beb92
- (id)init;	// IMP=0x00000000001beb2f
- (id)renderResultHandlerQueue;	// IMP=0x00000000001804dc
- (_Bool)isCurrentVersion;	// IMP=0x00000000001804c3
- (_Bool)isSynchronous;	// IMP=0x00000000001c82a6
