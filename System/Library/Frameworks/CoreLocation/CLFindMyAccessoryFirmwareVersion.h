...
- (id)description;	// IMP=0x0000000000066745
- (void)dealloc;	// IMP=0x000000000006670b
- (id)initWithData:(id)arg1;	// IMP=0x00000000000666b9
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000006664b
