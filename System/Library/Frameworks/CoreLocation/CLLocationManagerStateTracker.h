...
+ (const char *)trackerStateTypeName;	// IMP=0x000000000000eab9
+ (unsigned long long)trackerStateSize;	// IMP=0x000000000000eaae
- (void *)identifier;	// IMP=0x000000000000eac6
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x000000000000e995
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x000000000000e67f
...
- (void)dealloc;	// IMP=0x000000000000bf24
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000bb4b
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x000000000000bb36
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000bad5
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x000000000000bac0
