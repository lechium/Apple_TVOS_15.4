...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006a511
+ (unsigned long long)_placeInferencePlaceTypeFromRTPlaceType:(unsigned long long)arg1;	// IMP=0x000000000002b706
+ (unsigned long long)_userSpecificPlaceTypeFromRTUserType:(unsigned long long)arg1;	// IMP=0x000000000002b64d
...
- (id)description;	// IMP=0x000000000006a849
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006a83e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006a6e3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006a519
- (void)dealloc;	// IMP=0x000000000006a4b9
- (id)initWithUserType:(unsigned long long)arg1 placeType:(unsigned long long)arg2 placemark:(id)arg3 referenceLocation:(id)arg4 confidence:(double)arg5 preferredName:(id)arg6 loiIdentifier:(id)arg7;	// IMP=0x000000000006a419
- (id)_initWithRTPlaceInference:(id)arg1;	// IMP=0x000000000002b4c8
