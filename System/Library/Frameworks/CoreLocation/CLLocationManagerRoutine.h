...
- (void)stopUpdatingLocation;	// IMP=0x000000000000ad88
- (void)startUpdatingLocation;	// IMP=0x000000000000ac44
- (void)dealloc;	// IMP=0x000000000000ac09
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000000ab38
- (id)init;	// IMP=0x000000000000aac4
