...
- (id)initWithBeaconType:(unsigned long long)arg1 transmitPower:(double)arg2;	// IMP=0x00000000000648ef
- (id)initWithBeaconType:(unsigned long long)arg1;	// IMP=0x00000000000648c8
- (id)init;	// IMP=0x00000000000648b4
