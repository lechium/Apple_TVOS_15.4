...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004a96d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004acc6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004a975
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004a962
- (id)initWithCoordinateFused:(_Bool)arg1 coordinateFusedWithVL:(_Bool)arg2 coordinate:(CDStruct_c3b9c2ee)arg3 horizontalAccuracy:(double)arg4 referenceFrame:(int)arg5 altitude:(double)arg6 verticalAccuracy:(double)arg7 course:(double)arg8 courseAccuracy:(double)arg9;	// IMP=0x000000000004a872
- (id)init;	// IMP=0x000000000004a83c
