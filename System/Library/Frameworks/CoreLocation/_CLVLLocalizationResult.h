...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000050035
...
- (id)descriptionWithMemberIndent:(id)arg1 endIndent:(id)arg2;	// IMP=0x00000000000502f9
- (id)description;	// IMP=0x00000000000502d9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000501f0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005003d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004ff3e
