...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000057cce
...
- (id)description;	// IMP=0x000000000005821e
- (void)dealloc;	// IMP=0x00000000000581c6
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 horizontalAccuracy:(double)arg2 arrivalDate:(id)arg3 departureDate:(id)arg4 detectionDate:(id)arg5;	// IMP=0x00000000000581ae
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 horizontalAccuracy:(double)arg2 arrivalDate:(id)arg3 departureDate:(id)arg4 detectionDate:(id)arg5 placeInference:(id)arg6;	// IMP=0x00000000000580b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000057fea
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000057e75
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000057cd6
