...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002b8bd
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002b9cd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002b8c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b8b2
- (id)initWithEstimate:(double)arg1 uncertainty:(double)arg2 undulation:(double)arg3 undulationModel:(int)arg4;	// IMP=0x000000000002b804
- (id)initWithEstimate:(double)arg1 uncertainty:(double)arg2;	// IMP=0x000000000002b7ea
