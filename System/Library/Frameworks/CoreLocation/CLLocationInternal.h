...
- (void)dealloc;	// IMP=0x000000000006cb8a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006ca4d
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawAltitude:(double)arg7 rawVerticalAccuracy:(double)arg8 rawCourseAccuracy:(double)arg9 positionContextStateType:(int)arg10 probabilityPositionContextStateIndoor:(double)arg11 probabilityPositionContextStateOutdoor:(double)arg12 gnssOdometerInfo:(id)arg13 coarseMetaData:(id)arg14;	// IMP=0x000000000006c902
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawAltitude:(double)arg7 rawVerticalAccuracy:(double)arg8 rawCourseAccuracy:(double)arg9 positionContextStateType:(int)arg10 probabilityPositionContextStateIndoor:(double)arg11 probabilityPositionContextStateOutdoor:(double)arg12 gnssOdometerInfo:(id)arg13;	// IMP=0x000000000006c8a6
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4;	// IMP=0x000000000006c83b
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 clientLocationPrivate:(CDStruct_d25f1cbc)arg2 coarseMetaData:(id)arg3;	// IMP=0x000000000006c7c7
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 clientLocationPrivate:(CDStruct_d25f1cbc)arg2;	// IMP=0x000000000006c55a
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 coarseMetaData:(id)arg2;	// IMP=0x000000000006c4fd
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1;	// IMP=0x000000000006c450
