...
- (void)createConnection;	// IMP=0x000000000000a70b
- (void)didUpdateLocations:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000a402
- (void)didUpdateLocations:(id)arg1;	// IMP=0x000000000000a163
- (void)dealloc;	// IMP=0x000000000000a0ba
- (id)initWithQueue:(id)arg1 locationManagerRoutine:(id)arg2;	// IMP=0x0000000000009efb
