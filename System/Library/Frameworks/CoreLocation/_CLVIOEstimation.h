...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000073ecd
...
- (id)descriptionWithMemberIndent:(id)arg1 endIndent:(id)arg2;	// IMP=0x00000000000743d9
- (id)description;	// IMP=0x00000000000743b9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007423a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000073ed5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000073da7
- (void)dealloc;	// IMP=0x0000000000073d5d
