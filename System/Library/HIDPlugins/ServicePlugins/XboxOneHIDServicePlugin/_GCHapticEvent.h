...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000002082
...
- (id)description;	// IMP=0x0000000000001f48
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001d59
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001cc6
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001adc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000021bc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000208a
