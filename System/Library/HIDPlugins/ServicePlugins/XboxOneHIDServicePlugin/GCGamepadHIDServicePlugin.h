...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x00000000000043f1
- (void).cxx_destruct;	// IMP=0x0000000000008563
...
- (void)readBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000082f7
- (void)connectToGameIntentServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000082e5
- (void)connectToBatteryServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000008201
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081ef
- (void)connectToAdaptiveTriggersServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081dd
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081cb
- (void)enqueueTransient:(id)arg1 hapticMotor:(unsigned long long)arg2;	// IMP=0x00000000000080fe
- (void)setHapticMotor:(unsigned long long)arg1 frequency:(float)arg2 amplitude:(float)arg3;	// IMP=0x000000000000808a
- (void)fetchDeviceRegistryIDWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000008007
- (void)requestServiceWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007f3c
- (void)ping;	// IMP=0x0000000000007ee0
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000007ed2
- (id)defaultHapticMotors;	// IMP=0x0000000000007eb9
- (float)defaultRightAxisSnapRadius;	// IMP=0x0000000000007eb0
- (float)defaultLeftAxisSnapRadius;	// IMP=0x0000000000007ea7
- (float)defaultRightThumbstickDeadzoneRadius;	// IMP=0x0000000000007e99
- (float)defaultLeftThumbstickDeadzoneRadius;	// IMP=0x0000000000007e8b
- (float)defaultIdleTimeoutDuration;	// IMP=0x0000000000007e7d
- (float)defaultRightThumbstickNoiseBuffer;	// IMP=0x0000000000007e74
- (float)defaultLeftThumbstickNoiseBuffer;	// IMP=0x0000000000007e6b
- (void)enableHaptics;	// IMP=0x0000000000007ba7
- (_Bool)updateHapticMotor:(id)arg1;	// IMP=0x0000000000007a9f
- (void)stopHaptics;	// IMP=0x00000000000078b5
- (unsigned int)numberOfTimesToSendZeroHapticReport;	// IMP=0x00000000000078aa
- (_Bool)isHapticsActive;	// IMP=0x000000000000789e
- (void)updateHaptics:(_Bool)arg1;	// IMP=0x0000000000007898
- (void)dispatchHapticEvent;	// IMP=0x0000000000007892
- (_Bool)isAnyHapticMotorEnabled;	// IMP=0x000000000000767e
- (void)dispatchShareButtonEventWithValue:(_Bool)arg1;	// IMP=0x00000000000075aa
- (void)dispatchOptionsButtonEventWithValue:(_Bool)arg1;	// IMP=0x00000000000074d6
- (void)dispatchMenuButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000007402
- (void)dispatchHomeButtonEventWithValue:(_Bool)arg1;	// IMP=0x000000000000732e
- (void)dispatchGameControllerExtendedEventWithState:(CDStruct_5be5f302)arg1;	// IMP=0x0000000000006e2d
- (void)dispatchMotionEventWithState:(CDStruct_06597ee6)arg1;	// IMP=0x0000000000006b8d
- (_Bool)isTwoAxisInputIdle:(MISSING_TYPE **)arg1 prevInput:(MISSING_TYPE **)arg2 noiseBuffer:(float)arg3;	// IMP=0x0000000000006b34
- (void)applyDeadzone:(float)arg1 axisSnapRadius:(float)arg2 input:(MISSING_TYPE **)arg3;	// IMP=0x0000000000006a33
- (void)dispatchEvent:(id)arg1;	// IMP=0x0000000000006a1c
- (void)dispatchEvent:(id)arg1 updateLastEventTime:(_Bool)arg2;	// IMP=0x00000000000069a0
- (id)createEvent:(unsigned int)arg1;	// IMP=0x000000000000694d
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000006945
- (_Bool)isIdle;	// IMP=0x00000000000067d3
- (void)updateIdleState;	// IMP=0x0000000000006719
- (void)scheduleIdleTimer;	// IMP=0x00000000000065e3
- (_Bool)shouldCreateBatteryDevice;	// IMP=0x00000000000065db
- (void)sendBatteryReport;	// IMP=0x00000000000064ce
- (void)updateClientBattery;	// IMP=0x0000000000006401
- (void)createVirtualHIDDeviceForBattery;	// IMP=0x00000000000060c0
- (void)disconnect;	// IMP=0x0000000000005e6a
- (void)setupRawReportHandling;	// IMP=0x0000000000005e64
- (void)clientNotification:(id)arg1 added:(_Bool)arg2;	// IMP=0x0000000000005d70
- (void)setDispatchQueue:(id)arg1;	// IMP=0x0000000000005c83
- (void)cancel;	// IMP=0x0000000000005b19
- (void)activate;	// IMP=0x0000000000005a9a
- (void)setCancelHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000589c
- (void)setEventDispatcher:(id)arg1;	// IMP=0x00000000000057de
- (id)eventMatching:(id)arg1 forClient:(id)arg2;	// IMP=0x000000000000566d
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000005547
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x00000000000051e7
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000004eb0
- (id)initWithService:(unsigned int)arg1;	// IMP=0x00000000000047f2
- (void)initGameControllerDaemonXPC;	// IMP=0x00000000000043f9
