...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000024c2
...
- (id)description;	// IMP=0x0000000000002388
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000002199
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000002106
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001f1c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000025fc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000024ca
