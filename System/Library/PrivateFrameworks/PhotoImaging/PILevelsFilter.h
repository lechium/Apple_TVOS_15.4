...
+ (id)customAttributes;	// IMP=0x000000000000d910
+ (id)_customAttributesForKey:(id)arg1;	// IMP=0x000000000000d83b
+ (id)defaultValueForKey:(id)arg1;	// IMP=0x000000000000d6a8
+ (id)P3Kernel;	// IMP=0x000000000000d678
- (void).cxx_destruct;	// IMP=0x0000000000010ca1
...
- (id)outputImage;	// IMP=0x00000000000103c1
- (id)_LUTImage;	// IMP=0x000000000000e6ee
- (double)floatValueForKey:(id)arg1 defaultValue:(double)arg2 clearIfNotDefault:(_Bool *)arg3;	// IMP=0x000000000000e67c
- (void)setDefaults;	// IMP=0x000000000000e19c
