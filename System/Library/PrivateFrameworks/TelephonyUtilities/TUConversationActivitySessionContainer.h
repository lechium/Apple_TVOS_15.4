...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000675ba
- (void).cxx_destruct;	// IMP=0x00000000000685f2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000681c7
- (id)description;	// IMP=0x0000000000067ec1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000679c8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000675c2
