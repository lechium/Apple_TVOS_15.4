...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000529cd
- (void).cxx_destruct;	// IMP=0x00000000000532bb
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000529d5
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00000000000524b7
- (id)initWithCall:(id)arg1;	// IMP=0x0000000000052461
- (id)initWithUniqueProxyIdentifier:(id)arg1;	// IMP=0x00000000000523ee
