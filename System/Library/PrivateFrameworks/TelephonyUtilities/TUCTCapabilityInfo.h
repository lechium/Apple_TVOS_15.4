...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007b7a3
- (void).cxx_destruct;	// IMP=0x000000000007bc96
...
- (id)publiclyAccessibleCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007bb48
- (id)publiclyAccessibleCopy;	// IMP=0x000000000007bb34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007ba3c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007b8e2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007b7ab
- (void)invalidateProvisioningURL;	// IMP=0x000000000007b749
