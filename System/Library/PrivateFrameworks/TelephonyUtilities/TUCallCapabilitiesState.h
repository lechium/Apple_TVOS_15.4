...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000816bd
- (void).cxx_destruct;	// IMP=0x0000000000082610
...
- (id)publiclyAccessibleCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000821bd
- (id)publiclyAccessibleCopy;	// IMP=0x00000000000821a9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000082065
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000081c99
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000816c5
@property(readonly, nonatomic) TUCloudCallingDevice *defaultPairedDevice;
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000000080f41
