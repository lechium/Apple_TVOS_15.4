...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000652b8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000065495
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000652c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000651a3
- (id)description;	// IMP=0x0000000000065042
- (unsigned long long)hash;	// IMP=0x0000000000064f1a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000064d7f
