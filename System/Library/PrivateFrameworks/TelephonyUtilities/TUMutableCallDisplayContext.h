...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005ac39
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005a967
- (void)mergeValuesFromDisplayContext:(id)arg1;	// IMP=0x000000000005a30a
