...
- (void).cxx_destruct;	// IMP=0x00000000000c2b83
...
- (id)description;	// IMP=0x00000000000c27ca
- (id)initWithHandle:(id)arg1;	// IMP=0x00000000000c26af
- (id)initWithHandles:(id)arg1;	// IMP=0x00000000000c25b4
- (id)initWithCall:(id)arg1;	// IMP=0x00000000000c23a6
- (id)init;	// IMP=0x00000000000c231c
