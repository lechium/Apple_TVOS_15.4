...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a01ae
- (void).cxx_destruct;	// IMP=0x00000000000a06e5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a0512
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a03b3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a01b6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a00e8
- (id)description;	// IMP=0x000000000009ffb9
