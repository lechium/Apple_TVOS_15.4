...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000bc295
- (void).cxx_destruct;	// IMP=0x00000000000bcb5a
...
- (id)publiclyAccessibleCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bc8f8
- (id)publiclyAccessibleCopy;	// IMP=0x00000000000bc8e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bc748
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bc4f8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000bc29d
@property(readonly, copy) NSString *description;
- (id)initWithSenderIdentityUUID:(id)arg1;	// IMP=0x00000000000bc02d
