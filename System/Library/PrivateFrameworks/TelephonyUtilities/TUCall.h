...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c06e9
+ (id)faceTimeSupplementalDialTelephonyCallStringIncludingFTA:(_Bool)arg1;	// IMP=0x00000000000bfb7b
+ (id)supplementalDialTelephonyCallString;	// IMP=0x00000000000bfb5a
+ (id)supplementalDialTelephonyCallStringForDestination:(id)arg1 isPhoneNumber:(_Bool)arg2;	// IMP=0x00000000000bfb38
+ (id)_supplementalDialTelephonyCallStringForLocString:(id)arg1 destination:(id)arg2 isPhoneNumber:(_Bool)arg3 includeFaceTimeAudio:(_Bool)arg4;	// IMP=0x00000000000bf831
+ (_Bool)isJunkConfidenceLevelJunk:(long long)arg1;	// IMP=0x00000000000bdc77
+ (long long)maxJunkConfidence;	// IMP=0x00000000000bdc6c
+ (long long)acceptableJunkConfidence;	// IMP=0x00000000000bdc61
- (void).cxx_destruct;	// IMP=0x00000000000c156e
...
- (_Bool)isDialRequestVideoUpgrade:(id)arg1;	// IMP=0x00000000000c10ab
- (_Bool)isVideoUpgradeFromCall:(id)arg1;	// IMP=0x00000000000c0fad
- (void)setSharingScreen:(_Bool)arg1 attributes:(id)arg2;	// IMP=0x00000000000c0fa7
- (void)setScreenShareAttributes:(id)arg1;	// IMP=0x00000000000c0fa1
- (void)setRemoteVideoPresentationState:(int)arg1;	// IMP=0x00000000000c0f9b
- (void)setRemoteVideoPresentationSize:(struct CGSize)arg1;	// IMP=0x00000000000c0f95
- (struct CGSize)localAspectRatioForOrientation:(long long)arg1;	// IMP=0x00000000000c0f8b
...
- (void)setRemoteVideoLayer:(id)arg1 forMode:(long long)arg2;	// IMP=0x00000000000c0f16
- (void)setLocalVideoLayer:(id)arg1 forMode:(long long)arg2;	// IMP=0x00000000000c0f10
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c0bb3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c06f1
- (void)updateWithCall:(id)arg1;	// IMP=0x00000000000c03a4
- (id)errorAlertMessage;	// IMP=0x00000000000bffd4
- (id)errorAlertTitle;	// IMP=0x00000000000bfcf7
- (id)supplementalInCallString;	// IMP=0x00000000000bfc5a
- (id)serviceDisplayString;	// IMP=0x00000000000bfb9c
@property(readonly, copy, nonatomic) NSDictionary *endedReasonUserInfo;
- (_Bool)hasRelaySupport:(int)arg1;	// IMP=0x00000000000bf808
...
- (_Bool)setMuted:(_Bool)arg1;	// IMP=0x00000000000bf3ee
- (_Bool)isMuted;	// IMP=0x00000000000bf3dc
...
- (unsigned long long)hash;	// IMP=0x00000000000bef3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000beedd
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x00000000000bee4c
...
- (void)ungroup;	// IMP=0x00000000000becf4
- (void)groupWithOtherCall:(id)arg1;	// IMP=0x00000000000becee
...
- (void)suppressRingtoneDueToRemoteSuppression;	// IMP=0x00000000000be734
- (void)suppressRingtone;	// IMP=0x00000000000be71d
- (void)resetWantsHoldMusic;	// IMP=0x00000000000be709
...
- (void)postNotificationsAfterUpdatesInBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000be2bf
@property(readonly, nonatomic) NSString *hardPauseDigitsDisplayString;
- (void)sendHardPauseDigits;	// IMP=0x00000000000be272
- (void)playDTMFToneForKey:(unsigned char)arg1;	// IMP=0x00000000000be26c
- (void)resetProvisionalState;	// IMP=0x00000000000be258
- (void)disconnectWithReason:(int)arg1;	// IMP=0x00000000000be17a
- (void)unhold;	// IMP=0x00000000000be163
- (void)hold;	// IMP=0x00000000000be14c
- (void)setIsOnHold:(_Bool)arg1;	// IMP=0x00000000000be0ed
@property(readonly, nonatomic) _Bool isOnHold;
- (void)answerWithRequest:(id)arg1;	// IMP=0x00000000000bde74
- (void)_handleStatusChange;	// IMP=0x00000000000bde2f
...
- (void)updateComparativeCall;	// IMP=0x00000000000bdca1
- (id)description;	// IMP=0x00000000000bd19e
- (void)dealloc;	// IMP=0x00000000000bd129
- (id)initWithUniqueProxyIdentifier:(id)arg1 endpointOnCurrentDevice:(_Bool)arg2;	// IMP=0x00000000000bcfd0
- (id)initWithCall:(id)arg1;	// IMP=0x00000000000bcf4e
- (id)initWithUniqueProxyIdentifier:(id)arg1;	// IMP=0x00000000000bcf37
- (id)init;	// IMP=0x00000000000bcebc
