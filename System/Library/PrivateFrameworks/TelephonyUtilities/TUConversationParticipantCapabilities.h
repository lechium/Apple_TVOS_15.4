...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000773c8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007759c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000773d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000772c0
- (unsigned long long)hash;	// IMP=0x00000000000771c4
- (_Bool)isEqualToCapabilities:(id)arg1;	// IMP=0x00000000000770a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000077045
- (id)description;	// IMP=0x0000000000076e96
