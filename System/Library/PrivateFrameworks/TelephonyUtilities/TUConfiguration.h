...
- (void).cxx_destruct;	// IMP=0x00000000000cfce4
...
- (void)removeDelegate:(id)arg1;	// IMP=0x00000000000cfc5e
- (void)addDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00000000000cfbd8
- (id)numberForKey:(id)arg1;	// IMP=0x00000000000cfad8
...
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000000cf6d0
