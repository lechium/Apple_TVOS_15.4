...
- (void)reset;	// IMP=0x0000000000006fd4
- (id)annotationForLayoutItem:(id)arg1;	// IMP=0x0000000000006f38
- (id)_changesBetweenSourceLayoutResult:(id)arg1 targetLayoutResult:(id)arg2;	// IMP=0x0000000000006e9d
- (id)removalPlanResult;	// IMP=0x0000000000006da8
- (id)resultForNewLayoutResult:(id)arg1;	// IMP=0x0000000000005c65
- (id)init;	// IMP=0x0000000000005c11
