...
- (void)reset;	// IMP=0x0000000000008b11
- (id)layoutItemForGeotaggable:(id)arg1;	// IMP=0x0000000000008b09
- (id)layoutForViewPort:(id)arg1 andDataSourceChange:(id)arg2;	// IMP=0x000000000000875d
- (id)initWithDataSource:(id)arg1;	// IMP=0x0000000000008703
