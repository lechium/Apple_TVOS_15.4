...
- (_Bool)hasChanges;	// IMP=0x0000000000023fba
- (void)updateWithChange:(id)arg1;	// IMP=0x0000000000023e20
- (void)dealloc;	// IMP=0x0000000000023dcf
- (id)initWithAddedItems:(id)arg1 removedItems:(id)arg2 updatedItems:(id)arg3;	// IMP=0x0000000000023d55
