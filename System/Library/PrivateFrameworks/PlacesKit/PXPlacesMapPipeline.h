...
- (void).cxx_destruct;	// IMP=0x000000000000c8cc
...
- (void)cancel;	// IMP=0x000000000000c853
- (id)executeRemoval;	// IMP=0x000000000000c7c0
- (id)executeWithUpdatedViewPort:(id)arg1 andDataSourceChange:(id)arg2;	// IMP=0x000000000000c6d4
@property(readonly, nonatomic) id <PXPlacesGeotaggedItemDataSource> dataSource;
- (id)initWithLayout:(id)arg1 updatePlan:(id)arg2 renderer:(id)arg3 selectionHandler:(id)arg4;	// IMP=0x000000000000c58e
