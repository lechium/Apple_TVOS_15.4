...
- (void).cxx_destruct;	// IMP=0x0000000000022c59
...
- (id)initWithConfigFilePath:(id)arg1 withModelPath:(id)arg2 withCompareModelFilePaths:(id)arg3;	// IMP=0x0000000000022b84
