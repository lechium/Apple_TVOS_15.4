...
- (void)voiceRecognitionOrchestratorFinishedProcessing:(id)arg1 withFinalVoiceRecognitionInfo:(id)arg2;	// IMP=0x000000000003e109
- (void)voiceRecognitionOrchestrator:(id)arg1 hasVoiceRecognitionInfo:(id)arg2;	// IMP=0x000000000003dca2
- (id)getLatestSpeakerInfo;	// IMP=0x000000000003dc8c
- (id)resetWithContext:(id)arg1;	// IMP=0x000000000003dc6b
- (void)endAudio;	// IMP=0x000000000003dc55
- (void)processAudio:(id)arg1 withNumberOfSamples:(unsigned long long)arg2;	// IMP=0x000000000003dc3f
- (id)initWithContext:(id)arg1 withDelegate:(id)arg2 error:(id *)arg3;	// IMP=0x000000000003dafd
