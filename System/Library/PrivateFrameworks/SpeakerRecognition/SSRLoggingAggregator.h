...
- (void).cxx_destruct;	// IMP=0x000000000000f8ab
...
- (void)pushAnalytics;	// IMP=0x000000000000f74f
- (void)appendVoiceProfileFailedExplicitUtteranceScoreWith:(float)arg1;	// IMP=0x000000000000f50d
- (void)appendVoiceProfileDiscardedImplicitUtteranceScoreWith:(float)arg1;	// IMP=0x000000000000f461
- (void)appendVoiceProfileImplicitUtteranceScoreWith:(float)arg1;	// IMP=0x000000000000f3b5
- (void)appendVoiceProfileExplicitUtteranceScoreWith:(float)arg1;	// IMP=0x000000000000f309
- (void)setvoiceProfilePrunedUtteranceCount:(unsigned long long)arg1;	// IMP=0x000000000000f24b
- (void)pushAnalyticsWithLazyBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000f053
- (id)initWithEvent:(id)arg1 locale:(id)arg2 configVersion:(id)arg3;	// IMP=0x000000000000ef26
