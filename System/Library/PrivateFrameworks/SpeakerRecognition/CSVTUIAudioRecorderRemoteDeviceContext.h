...
- (void).cxx_destruct;	// IMP=0x0000000000039dd6
...
- (id)initWithRemoteTrainingDeviceType:(unsigned long long)arg1 remoteTrainingDeviceUUIDList:(id)arg2;	// IMP=0x0000000000039d44
