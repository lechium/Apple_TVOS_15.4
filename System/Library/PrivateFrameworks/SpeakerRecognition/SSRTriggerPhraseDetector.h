...
+ (id)filterVTAudioFiles:(id)arg1 withLocale:(id)arg2 withAsset:(id)arg3;	// IMP=0x000000000000ca69
...
- (void)computeTriggerConfidenceForAudio:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000d315
- (id)initWithLocale:(id)arg1 asset:(id)arg2;	// IMP=0x000000000000d0e7
