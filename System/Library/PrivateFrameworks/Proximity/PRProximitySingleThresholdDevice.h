...
- (id).cxx_construct;	// IMP=0x0000000000024078
- (void).cxx_destruct;	// IMP=0x0000000000024022
@property(readonly) NSUUID *peer; // @synthesize peer=_peer;
- (long long)deviceProximity;	// IMP=0x0000000000024004
- (_Bool)proxReady;	// IMP=0x0000000000023f91
- (void)addSample:(struct BtProxData)arg1;	// IMP=0x0000000000023f0c
- (id)initWithPeer:(id)arg1 andPeerModel:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000000023bcc
- (id)init;	// IMP=0x0000000000023b8e
