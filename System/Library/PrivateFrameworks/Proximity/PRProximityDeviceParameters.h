...
- (void).cxx_destruct;	// IMP=0x0000000000012e89
...
- (id)initWithFilter:(void *)arg1 sampleSize:(unsigned long long)arg2 rssiImmediate:(id)arg3 rssiNear:(id)arg4;	// IMP=0x0000000000012d7d
- (id)init;	// IMP=0x0000000000012d3f
