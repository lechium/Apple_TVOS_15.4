...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000020e4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000027d3
- (id)description;	// IMP=0x00000000000026fc
...
- (id)initWithHelloResponse:(const void *)arg1;	// IMP=0x0000000000001de8
- (id)initWithRoseFirmwareVersion:(id)arg1 hsiVersionMajor:(unsigned char)arg2 hsiVersionMinor:(unsigned char)arg3 hardwareVersion:(unsigned long long)arg4;	// IMP=0x0000000000001d43
