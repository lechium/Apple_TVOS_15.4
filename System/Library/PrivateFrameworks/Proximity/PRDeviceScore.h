...
- (_Bool)isEqualToPRDeviceScore:(id)arg1;	// IMP=0x000000000001fd28
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001fcc0
- (id)initWithValues:(id)arg1 proximity:(long long)arg2 range:(id)arg3 angle:(id)arg4 score:(double)arg5 scoreUncertainty:(double)arg6;	// IMP=0x000000000001fb2f
- (id)init;	// IMP=0x000000000001fb04
