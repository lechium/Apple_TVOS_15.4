...
- (void).cxx_destruct;	// IMP=0x000000000002edb2
...
- (void)_updateBookmarkWhenLocked;	// IMP=0x000000000002eb1a
- (id)newBookmark;	// IMP=0x000000000002ea3c
- (void)requestDemand:(long long)arg1;	// IMP=0x000000000002e9f0
- (void)cancel;	// IMP=0x000000000002e965
- (void)receiveSubscription:(id)arg1;	// IMP=0x000000000002e8cc
- (long long)receiveInput:(id)arg1;	// IMP=0x000000000002e837
- (void)receiveCompletion:(id)arg1;	// IMP=0x000000000002e78b
- (id)initWithUpstream:(id)arg1 downstream:(id)arg2 state:(id)arg3;	// IMP=0x000000000002e66c
