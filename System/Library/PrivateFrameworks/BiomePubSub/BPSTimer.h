...
- (void).cxx_destruct;	// IMP=0x0000000000015004
...
- (void)subscribe:(id)arg1;	// IMP=0x0000000000014ebd
- (id)initWithUpstream:(id)arg1 interval:(double)arg2 getTimestamp:(CDUnknownBlockType)arg3;	// IMP=0x0000000000014d7a
