...
- (id)upstreamSubscriptions;	// IMP=0x0000000000007dcb
- (void)cancel;	// IMP=0x0000000000007d75
- (void)requestDemand:(long long)arg1;	// IMP=0x0000000000007a41
- (id)initWithDownstream:(id)arg1 sequence:(id)arg2;	// IMP=0x000000000000791f
