...
- (void).cxx_destruct;	// IMP=0x000000000002b42b
...
- (id)newBookmark;	// IMP=0x000000000002b1f3
- (void)updateBookmarksWhenLockedForIndex:(unsigned long long)arg1;	// IMP=0x000000000002b090
- (id)upstreamSubscriptions;	// IMP=0x000000000002b049
- (void)cancel;	// IMP=0x000000000002afe6
- (long long)compareFirst:(id)arg1 withSecond:(id)arg2;	// IMP=0x000000000002afba
- (id)nextValueIndex:(id *)arg1;	// IMP=0x000000000002ac4b
- (void)flushBufferAndRequestMoreWhileLocked;	// IMP=0x000000000002a6be
- (void)receiveCompletion:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x000000000002a35f
- (void)_guardedBecomeTerminal;	// IMP=0x000000000002a036
- (void)_completeWhileLockedWithCompletion:(id)arg1;	// IMP=0x0000000000029ebb
- (_Bool)_isBuffersEmpty;	// IMP=0x0000000000029d0c
- (long long)receiveInput:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000000297d0
- (void)receiveSubscription:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x0000000000029572
- (_Bool)isWaitingForMoreValues;	// IMP=0x000000000002937d
- (void)requestDemand:(long long)arg1;	// IMP=0x0000000000028fc8
- (id)initWithDownstream:(id)arg1 upstreamCount:(unsigned long long)arg2;	// IMP=0x0000000000028cb3
