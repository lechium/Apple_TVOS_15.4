...
- (void).cxx_destruct;	// IMP=0x000000000002d841
...
- (void)subscribe:(id)arg1;	// IMP=0x000000000002d6c8
- (id)initWithUpstream:(id)arg1 interval:(double)arg2 latest:(_Bool)arg3 getTimestamp:(CDUnknownBlockType)arg4;	// IMP=0x000000000002d575
