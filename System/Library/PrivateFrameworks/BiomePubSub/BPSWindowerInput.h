...
- (void).cxx_destruct;	// IMP=0x00000000000330e5
...
- (id)initWithAggregate:(id)arg1 key:(id)arg2 metadata:(id)arg3;	// IMP=0x0000000000033010
- (id)init;	// IMP=0x000000000003300a
