...
- (void).cxx_destruct;	// IMP=0x0000000000017afe
...
- (void)receiveInnerCompletion:(id)arg1 index:(long long)arg2;	// IMP=0x00000000000172c1
- (long long)receiveInnerInput:(id)arg1 index:(long long)arg2;	// IMP=0x0000000000017003
- (void)receiveInnerSubscription:(id)arg1 index:(long long)arg2;	// IMP=0x0000000000016ef4
- (id)newBookmark;	// IMP=0x0000000000016dfe
- (void)_updateBookmarkWhenLocked;	// IMP=0x0000000000016c1c
- (id)upstreamSubscriptions;	// IMP=0x0000000000016b55
- (void)cancel;	// IMP=0x0000000000016901
- (void)requestDemand:(long long)arg1;	// IMP=0x0000000000015df7
- (void)receiveCompletion:(id)arg1;	// IMP=0x00000000000158fc
- (long long)receiveInput:(id)arg1;	// IMP=0x0000000000015793
- (void)receiveSubscription:(id)arg1;	// IMP=0x00000000000156c6
- (id)initWithDownstream:(id)arg1 maxPublishers:(long long)arg2 map:(CDUnknownBlockType)arg3;	// IMP=0x0000000000015564
