...
- (void).cxx_destruct;	// IMP=0x0000000000003ad4
...
- (id)receiveNewValue:(id)arg1;	// IMP=0x00000000000039f0
- (id)initWithDownstream:(id)arg1 isDuplicate:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003952
