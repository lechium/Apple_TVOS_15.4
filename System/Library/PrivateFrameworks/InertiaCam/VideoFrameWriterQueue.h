...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x000000000001bcb5
- (void)StartWatchingForFrames;	// IMP=0x000000000001bbf2
- (void)FrameRequestCallback;	// IMP=0x000000000001b71f
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x000000000001b638
- (_Bool)WaitForFinish;	// IMP=0x000000000001b3e1
- (unsigned long long)FramesInQueue;	// IMP=0x000000000001b392
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000001b309
- (void)dealloc;	// IMP=0x000000000001b2da
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x000000000001aebb
