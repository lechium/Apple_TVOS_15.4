...
- (void).cxx_destruct;	// IMP=0x000000000001c185
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c06d
- (id)bestPolicyVersion;	// IMP=0x000000000001c00a
- (id)description;	// IMP=0x000000000001bf9b
- (id)dictionaryRepresentation;	// IMP=0x000000000001bf11
- (_Bool)isEqualToPeerStableInfo:(id)arg1;	// IMP=0x000000000001be07
- (_Bool)checkSignatureWithKey:(id)arg1;	// IMP=0x000000000001bd6d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001bb1f
- (id)initWithData:(id)arg1 sig:(id)arg2;	// IMP=0x000000000001b466
