...
+ (Class)custodianRecoveryKeysType;	// IMP=0x000000000002a96d
+ (Class)policySecretsType;	// IMP=0x000000000002a95c
- (void).cxx_destruct;	// IMP=0x000000000002a1db
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000029b64
- (unsigned long long)hash;	// IMP=0x0000000000029956
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000295b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000029097
- (void)copyTo:(id)arg1;	// IMP=0x0000000000028d73
- (void)writeTo:(id)arg1;	// IMP=0x00000000000289a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000028994
- (id)dictionaryRepresentation;	// IMP=0x00000000000281d8
- (id)description;	// IMP=0x0000000000028129
...
- (id)custodianRecoveryKeysAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000028097
- (unsigned long long)custodianRecoveryKeysCount;	// IMP=0x000000000002807a
- (void)addCustodianRecoveryKeys:(id)arg1;	// IMP=0x0000000000028010
- (void)clearCustodianRecoveryKeys;	// IMP=0x0000000000027ff3
- (int)StringAsUserControllableViewStatus:(id)arg1;	// IMP=0x0000000000027f44
- (id)userControllableViewStatusAsString:(int)arg1;	// IMP=0x0000000000027ec6
...
- (id)policySecretsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000027e3f
- (unsigned long long)policySecretsCount;	// IMP=0x0000000000027e22
- (void)addPolicySecrets:(id)arg1;	// IMP=0x0000000000027db8
- (void)clearPolicySecrets;	// IMP=0x0000000000027d9b
