...
- (void).cxx_destruct;	// IMP=0x000000000004f857
...
- (unsigned long long)hash;	// IMP=0x000000000004f2d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004ecfc
- (id)description;	// IMP=0x000000000004e88a
- (id)dictionaryRepresentation;	// IMP=0x000000000004e3d4
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000004def5
