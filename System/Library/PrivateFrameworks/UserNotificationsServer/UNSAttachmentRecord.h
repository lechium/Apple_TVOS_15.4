...
- (void).cxx_destruct;	// IMP=0x000000000004de3f
...
- (unsigned long long)hash;	// IMP=0x000000000004db94
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004d863
- (id)description;	// IMP=0x000000000004d62b
- (id)dictionaryRepresentation;	// IMP=0x000000000004d3f0
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000004d1f7
