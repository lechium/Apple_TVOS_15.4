...
- (void).cxx_destruct;	// IMP=0x000000000002be2c
...
- (unsigned long long)hash;	// IMP=0x000000000002b89a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b3b8
- (id)description;	// IMP=0x000000000002af44
- (id)dictionaryRepresentation;	// IMP=0x000000000002aa4c
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000002a416
