...
@interface UNSNotificationSourceDescription : NSObject
{
    ...
    NSString *_customSettingsBundle;	// 184 = 0xb8
    NSString *_customSettingsDetailControllerClass;	// 192 = 0xc0
    NSURL *_bundleURL;	// 200 = 0xc8
    NSURL *_dataContainerURL;	// 208 = 0xd0
    NSDictionary *_groupContainerURLS;	// 216 = 0xd8
    NSArray *_defaultCategories;	// 224 = 0xe0
    UNSNotificationSourceSettingsDescription *_defaultSettings;	// 232 = 0xe8
    NSArray *_defaultTopics;	// 240 = 0xf0
    NSArray *_activityTypes;	// 248 = 0xf8
}

+ (id)_validEnvironmentFromEnvironment:(id)arg1;	// IMP=0x000000000002f3f9
+ (id)systemSourceDescriptionWithBundleURL:(id)arg1;	// IMP=0x000000000002f16b
+ (id)systemSourceDescriptionWithBundleIdentifier:(id)arg1;	// IMP=0x000000000002eee6
+ (id)sourceDescriptionWithBundleIdentifier:(id)arg1;	// IMP=0x000000000002ee71
+ (id)applicationSourceDescriptionWithApplication:(id)arg1;	// IMP=0x000000000002df39
+ (id)applicationSourceDescriptionWithBundleIdentifier:(id)arg1;	// IMP=0x000000000002de8e
+ (id)systemSourceDirectoryURLs;	// IMP=0x000000000002dc4d
+ (id)systemSourcePathExtension;	// IMP=0x000000000002dc40
+ (id)descriptionWithBundleIdentifier:(id)arg1 path:(id)arg2 allowServiceExtensionFiltering:(_Bool)arg3;	// IMP=0x0000000000033886
- (void).cxx_destruct;	// IMP=0x000000000003371b
...
- (id)description;	// IMP=0x0000000000032895
- (unsigned long long)hash;	// IMP=0x00000000000320c4
- (void)setDefaultTopicsFromArray:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000031cbf
- (void)setDefaultCategoriesFromArray:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000030bfa
- (void)setIconFilesFromDictionary:(id)arg1;	// IMP=0x000000000003082f
- (void)setSystemPropertiesFromDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000030137
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f4be
