...
+ (id)notificationSourceSettingsDescriptionFromDictionary:(id)arg1;	// IMP=0x000000000002d0d2
...
- (id)description;	// IMP=0x000000000002d936
- (unsigned long long)hash;	// IMP=0x000000000002d74d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d555
