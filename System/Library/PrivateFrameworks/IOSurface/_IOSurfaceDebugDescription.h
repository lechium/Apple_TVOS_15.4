...
- (id)description;	// IMP=0x0000000000008876
- (void)dealloc;	// IMP=0x0000000000008811
- (id)initWithBasicInfo:(const CDStruct_6175285a *)arg1 layoutInfo:(const CDStruct_6c6f70a4 *)arg2 name:(id)arg3;	// IMP=0x0000000000008714
