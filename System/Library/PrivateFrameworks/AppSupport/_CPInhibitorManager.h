...
+ (id)sharedInstance;	// IMP=0x000000000001c2e8
- (void).cxx_destruct;	// IMP=0x000000000001cd7a
...
- (id)popAssertionWithIdentifier:(id)arg1;	// IMP=0x000000000001cb8c
- (void)pushAssertion:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000000001ca56
- (void)stopInhibitorWithIdentifier:(id)arg1;	// IMP=0x000000000001c9ad
- (id)startAnInhibitor;	// IMP=0x000000000001c77b
- (id)init;	// IMP=0x000000000001c33d
