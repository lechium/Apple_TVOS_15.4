...
- (_Bool)_attemptReadingValuesFromDiskAndUpdateFileState;	// IMP=0x0000000000012444
- (_Bool)_readGreenKeysFromDictionary:(id)arg1;	// IMP=0x00000000000122dd
@property(readonly, nonatomic) _Bool valuesFinalized;
- (id)init;	// IMP=0x000000000001221f
