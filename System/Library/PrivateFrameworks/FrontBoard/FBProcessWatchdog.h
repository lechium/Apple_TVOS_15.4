...
- (void).cxx_destruct;	// IMP=0x0000000000013b09
...
- (id)_policyDesc;	// IMP=0x00000000000137cb
- (void)activate;	// IMP=0x0000000000013753
- (id)initWithProcess:(id)arg1 context:(id)arg2 policy:(id)arg3;	// IMP=0x0000000000013633
