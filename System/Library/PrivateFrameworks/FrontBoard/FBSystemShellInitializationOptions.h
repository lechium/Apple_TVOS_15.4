...
- (void).cxx_destruct;	// IMP=0x0000000000065ac1
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000065a50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000065a45
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000065918
- (unsigned long long)hash;	// IMP=0x00000000000657f8
- (id)init;	// IMP=0x00000000000657ae
- (id)_initWithOptions:(id)arg1;	// IMP=0x0000000000065719
