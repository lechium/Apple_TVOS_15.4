...
- (void).cxx_destruct;	// IMP=0x000000000004ea50
...
- (id)prettyProcessDescription;	// IMP=0x000000000004ea18
...
- (void)invalidate;	// IMP=0x000000000004e866
- (id)initWithFacilityID:(id)arg1 connection:(id)arg2;	// IMP=0x000000000004e63e
