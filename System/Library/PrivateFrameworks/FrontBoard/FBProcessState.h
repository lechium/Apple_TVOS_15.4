...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000005eb0c
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000000005eabc
- (id)succinctDescriptionBuilder;	// IMP=0x000000000005e956
- (id)succinctDescription;	// IMP=0x000000000005e906
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005e85f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005e7e4
@property(readonly, copy) NSString *description;
- (id)initWithPid:(int)arg1;	// IMP=0x000000000005e757
- (id)init;	// IMP=0x000000000005e71c
