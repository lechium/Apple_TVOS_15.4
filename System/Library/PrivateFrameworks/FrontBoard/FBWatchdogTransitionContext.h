...
- (void).cxx_destruct;	// IMP=0x000000000004c642
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004c59c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004c58a
