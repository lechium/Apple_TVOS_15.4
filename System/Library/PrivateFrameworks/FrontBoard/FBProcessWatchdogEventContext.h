...
+ (id)contextForEvent:(long long)arg1 settings:(id)arg2 transitionContext:(id)arg3;	// IMP=0x00000000000113c0
- (void).cxx_destruct;	// IMP=0x00000000000116f6
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000115a7
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000011557
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000114d6
- (id)succinctDescription;	// IMP=0x0000000000011486
