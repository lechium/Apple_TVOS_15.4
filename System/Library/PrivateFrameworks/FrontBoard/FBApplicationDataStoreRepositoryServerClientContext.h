...
- (void)_repositoryInvalidated:(id)arg1;	// IMP=0x00000000000146ac
- (void)_valueChanged:(id)arg1;	// IMP=0x000000000001455b
- (void)_queue_updateObservers;	// IMP=0x00000000000144ae
- (void)dealloc;	// IMP=0x00000000000142f2
- (id)initWithDataStore:(id)arg1;	// IMP=0x0000000000014214
