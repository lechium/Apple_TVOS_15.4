...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000bc8a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000bc7f
- (id)_initWithExecutionContext:(id)arg1;	// IMP=0x000000000000bad9
- (id)initWithIdentity:(id)arg1;	// IMP=0x000000000000ba7c
