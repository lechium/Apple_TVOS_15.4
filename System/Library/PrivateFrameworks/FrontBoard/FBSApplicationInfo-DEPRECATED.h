...
- (long long)_mapSignatureStateFromTrustState:(unsigned long long)arg1;	// IMP=0x000000000004c345
- (void)acceptApplicationSignatureIdentity;	// IMP=0x000000000004c23e
- (id)_signatureValidationService;	// IMP=0x000000000004c126
...
- (id)_initForProfileManagerTesting;	// IMP=0x000000000004c02b
@end
