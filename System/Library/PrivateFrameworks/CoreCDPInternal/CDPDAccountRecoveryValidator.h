...
- (id)_cdpErrorFromAuthKitError:(id)arg1;	// IMP=0x0000000000002c99
- (void)generateRecoveryKey:(CDUnknownBlockType)arg1;	// IMP=0x0000000000002c11
- (void)confirmRecoveryKey:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000002965
- (id)initWithContext:(id)arg1 authProvider:(id)arg2;	// IMP=0x00000000000028dd
