...
- (void).cxx_destruct;	// IMP=0x0000000000019367
...
- (void)generateRecoveryKey:(CDUnknownBlockType)arg1;	// IMP=0x00000000000191be
- (void)confirmRecoveryKey:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000018f6a
- (id)initWithContext:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000018ede
