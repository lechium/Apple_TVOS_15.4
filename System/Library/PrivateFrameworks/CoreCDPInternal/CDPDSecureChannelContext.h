...
- (void).cxx_destruct;	// IMP=0x00000000000317e0
...
- (void)dealloc;	// IMP=0x000000000003170b
- (_Bool)initialize:(id *)arg1;	// IMP=0x000000000003141f
- (id)initWithChannel:(id)arg1 dataProvider:(id)arg2 circleProxy:(id)arg3;	// IMP=0x0000000000031373
- (id)initWithContext:(id)arg1 circleProxy:(id)arg2;	// IMP=0x00000000000312eb
