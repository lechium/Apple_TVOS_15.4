...
@interface StreamingUnzipState : NSObject
{
    ...
    CDStruct_3b890e00 _hashContext;	// 112 = 0x70
...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000022473
- (void).cxx_destruct;	// IMP=0x0000000000022809
...
- (id)initWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001e72c
- (_Bool)openCurrentOutputFDForPath:(id)arg1 withOpenFlags:(int)arg2 mode:(unsigned short)arg3 error:(id *)arg4;	// IMP=0x000000000001e35c
- (id)finishStream;	// IMP=0x000000000001e233
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x000000000001e21e
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x000000000001df76
- (id)checkLastChunkPartialHash;	// IMP=0x000000000001dcb3
- (id)_checkHashForOffset:(unsigned long long)arg1;	// IMP=0x000000000001d616
- (id)serializeState;	// IMP=0x000000000001c889
- (void)markResumptionPoint;	// IMP=0x000000000001c883
- (void)clearSavedState;	// IMP=0x000000000001c7c0
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x000000000001c3a6
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x000000000001c33b
- (id)init;	// IMP=0x000000000001c318
