...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002e584d
- (void).cxx_destruct;	// IMP=0x00000000002e5c3e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e59ca
- (unsigned long long)hash;	// IMP=0x00000000002e597c
- (id)description;	// IMP=0x00000000002e5855
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002e538c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002e5185
...
- (id)asDictionary;	// IMP=0x00000000002e4d53
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002e48b5
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000002e485b
- (id)initWithKeyInformation:(id)arg1;	// IMP=0x00000000002e484d
