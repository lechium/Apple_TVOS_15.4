...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002986d7
- (void).cxx_destruct;	// IMP=0x0000000000298733
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002985de
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000029842f
- (id)nextStepInfo;	// IMP=0x0000000000298381
- (id)initWithData:(id)arg1;	// IMP=0x000000000029814c
