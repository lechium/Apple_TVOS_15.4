...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000602e
- (void).cxx_destruct;	// IMP=0x0000000000006a0f
...
- (id)_urlRequestWithAppleAccountInformation:(id)arg1;	// IMP=0x0000000000006036
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005eac
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005bd9
