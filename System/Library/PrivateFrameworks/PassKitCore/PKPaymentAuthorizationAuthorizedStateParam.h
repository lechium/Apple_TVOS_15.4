...
+ (id)paramWithInstallmentAuthorizationToken:(id)arg1;	// IMP=0x00000000002f806b
+ (id)paramWithApplePayTrustSignature:(id)arg1;	// IMP=0x00000000002f8019
+ (id)paramWithDisbursementVoucher:(id)arg1;	// IMP=0x00000000002f7fc7
+ (id)paramWithAuthorizedPeerPaymentQuote:(id)arg1;	// IMP=0x00000000002f7f75
+ (id)paramWithPurchase:(id)arg1 purchaseTransactionIdentifier:(id)arg2;	// IMP=0x00000000002f7ee0
+ (id)paramWithPayment:(id)arg1;	// IMP=0x00000000002f7e72
+ (id)paramWithPaymentToken:(id)arg1;	// IMP=0x00000000002f7e04
- (void).cxx_destruct;	// IMP=0x00000000002f8246
...
- (id)description;	// IMP=0x00000000002f80bd
