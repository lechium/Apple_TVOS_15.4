...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002eec61
- (void).cxx_destruct;	// IMP=0x00000000002eef35
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002eed2f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002eec69
- (id)description;	// IMP=0x00000000002eebaa
- (unsigned long long)hash;	// IMP=0x00000000002eeb8d
- (_Bool)isEqualToInvitationReceipt:(id)arg1;	// IMP=0x00000000002eeb7b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002eeb13
- (id)initWithInvitationData:(id)arg1 recipientIdentifier:(id)arg2;	// IMP=0x00000000002eeb0a
