...
+ (id)regionFeatureWithType:(long long)arg1 dictionary:(id)arg2 region:(id)arg3;	// IMP=0x0000000000084314
- (void).cxx_destruct;	// IMP=0x00000000000847ee
...
- (id)initWithFeatureType:(long long)arg1 dictionary:(id)arg2 region:(id)arg3;	// IMP=0x00000000000843cd
