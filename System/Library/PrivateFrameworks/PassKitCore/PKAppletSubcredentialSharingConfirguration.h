...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002c31f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002c3c1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002c327
- (id)description;	// IMP=0x000000000002c2bb
- (id)supportedEntitlementWithValue:(unsigned long long)arg1;	// IMP=0x000000000002c166
- (id)asDictionary;	// IMP=0x000000000002bff7
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000002bbd8
