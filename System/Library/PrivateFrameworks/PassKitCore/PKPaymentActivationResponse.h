...
+ (id)responseWithData:(id)arg1 forPass:(id)arg2;	// IMP=0x000000000041d732
- (void).cxx_destruct;	// IMP=0x000000000041dfe8
...
- (id)initWithData:(id)arg1 forPass:(id)arg2;	// IMP=0x000000000041d7a8
