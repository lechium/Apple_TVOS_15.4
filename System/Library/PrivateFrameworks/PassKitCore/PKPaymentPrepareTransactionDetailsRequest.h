...
+ (id)serverSupportedLanguages;	// IMP=0x00000000002b6ad6
- (void).cxx_destruct;	// IMP=0x00000000002b6bc1
...
- (id)_urlRequestWithServiceURL:(id)arg1 appleAccountInformation:(id)arg2;	// IMP=0x00000000002b67bf
- (id)initWithMerchantSession:(id)arg1 secureElementIdentifier:(id)arg2 amount:(id)arg3 currencyCode:(id)arg4;	// IMP=0x00000000002b66a0
