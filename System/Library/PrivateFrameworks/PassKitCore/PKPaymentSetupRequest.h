...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000033041b
- (void).cxx_destruct;	// IMP=0x00000000003305e8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000330544
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000330423
