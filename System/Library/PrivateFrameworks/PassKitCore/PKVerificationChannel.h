...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001651af
+ (id)verificationChannelWithDictionary:(id)arg1 andOrganizationName:(id)arg2;	// IMP=0x0000000000164c24
- (void).cxx_destruct;	// IMP=0x000000000016564d
...
- (_Bool)needsServerRequest;	// IMP=0x0000000000165592
- (id)description;	// IMP=0x0000000000165450
@property(readonly, copy, nonatomic) NSString *typeDescriptionUnlocalized;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001651b7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016501b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000164e05
