...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000010f8d8
- (void).cxx_destruct;	// IMP=0x0000000000110f08
...
- (unsigned long long)hash;	// IMP=0x0000000000110c49
- (_Bool)isEqualToTransitAppletHistoryRecord:(id)arg1;	// IMP=0x0000000000110a65
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001109fd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000110857
- (void)dealloc;	// IMP=0x0000000000110828
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000110640
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000011025a
- (void)_setTransactionHistoryDetailsFromString:(id)arg1;	// IMP=0x0000000000110254
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000110225
- (id)_transactionAmountsWithBalanceLabels:(id)arg1 unitDictionary:(id)arg2;	// IMP=0x000000000010fd22
- (id)_transactionCommutePlanUnitsWithPlanLabels:(id)arg1;	// IMP=0x000000000010fac2
...
- (id)concreteTransactionWithCurrency:(id)arg1 balanceLabels:(id)arg2 unitDictionary:(id)arg3 planLabels:(id)arg4;	// IMP=0x000000000011177e
- (id)felicaHistoryRecord;	// IMP=0x00000000004387ce
