...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003e11ca
- (void).cxx_destruct;	// IMP=0x00000000003e1309
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003e1283
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003e11d2
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000003e1114
