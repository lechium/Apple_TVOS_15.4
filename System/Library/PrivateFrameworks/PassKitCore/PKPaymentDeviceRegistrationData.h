...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001eda3
- (void).cxx_destruct;	// IMP=0x000000000001eec1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001ec2a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001eb04
