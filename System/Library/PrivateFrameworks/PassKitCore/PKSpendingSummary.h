...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c1b59
- (void).cxx_destruct;	// IMP=0x00000000000c2562
...
- (id)description;	// IMP=0x00000000000c220b
- (unsigned long long)hash;	// IMP=0x00000000000c214a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c205d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c1f05
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c1b61
