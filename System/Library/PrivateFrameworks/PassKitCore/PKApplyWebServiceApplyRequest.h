...
- (void).cxx_destruct;	// IMP=0x0000000000005adc
...
- (id)_urlRequestWithAppleAccountInformation:(id)arg1;	// IMP=0x0000000000004c82
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000004a20
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004569
