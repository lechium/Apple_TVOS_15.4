...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003c9adf
- (void).cxx_destruct;	// IMP=0x00000000003ca2bb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003c9f05
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003c9ae7
- (void)flushFormattedFieldValues;	// IMP=0x00000000003c96e4
- (id)initWithDictionary:(id)arg1 bundle:(id)arg2 privateBundle:(id)arg3;	// IMP=0x00000000003c4f65
