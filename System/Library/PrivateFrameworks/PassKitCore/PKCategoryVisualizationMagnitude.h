...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000026dee0
- (void).cxx_destruct;	// IMP=0x000000000026e1b1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000026e0e1
- (unsigned long long)hash;	// IMP=0x000000000026e057
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026dfb2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000026dee8
