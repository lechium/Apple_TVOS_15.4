...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000800a1
...
- (id)description;	// IMP=0x000000000007ffee
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007ff6b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007fe5b
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000007fd55
