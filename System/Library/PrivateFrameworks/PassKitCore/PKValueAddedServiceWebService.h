...
- (void).cxx_destruct;	// IMP=0x000000000010abb4
...
- (void)downloadPassWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000010a75d
- (void)downloadMerchantPayloadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000010a502
- (id)initWithValueAddedServiceTransaction:(id)arg1;	// IMP=0x000000000010a42d
