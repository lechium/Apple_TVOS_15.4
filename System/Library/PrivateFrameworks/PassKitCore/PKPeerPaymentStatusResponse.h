...
- (void).cxx_destruct;	// IMP=0x00000000003538c3
...
- (_Bool)amountHashIsValidForAmount:(id)arg1 andCurrency:(id)arg2;	// IMP=0x00000000003536c7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000353402
