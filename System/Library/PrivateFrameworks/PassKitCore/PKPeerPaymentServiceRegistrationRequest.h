...
- (void).cxx_destruct;	// IMP=0x00000000003e46f3
...
- (id)_urlRequestWithServiceURL:(id)arg1 appleAccountInformation:(id)arg2 deviceIdentifier:(id)arg3 deviceScore:(id)arg4 deviceMetadata:(id)arg5;	// IMP=0x00000000003e3e4e
