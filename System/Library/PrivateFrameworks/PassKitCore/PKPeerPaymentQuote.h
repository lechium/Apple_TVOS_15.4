...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000293f22
- (void).cxx_destruct;	// IMP=0x0000000000294f28
...
- (_Bool)preservesCurrentBalance;	// IMP=0x0000000000294d9d
- (id)firstQuoteItemOfType:(unsigned long long)arg1;	// IMP=0x0000000000294c3e
- (_Bool)hasExpired;	// IMP=0x0000000000294bde
- (id)description;	// IMP=0x00000000002948ed
- (unsigned long long)hash;	// IMP=0x00000000002947a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002945c3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002943f2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000293f2a
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000029391e
