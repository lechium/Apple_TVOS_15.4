...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000040b055
- (void).cxx_destruct;	// IMP=0x000000000040b20e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000040b16d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000040b05d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000040afac
- (id)initWithImageAssetsDictionary:(id)arg1;	// IMP=0x000000000040ad8a
