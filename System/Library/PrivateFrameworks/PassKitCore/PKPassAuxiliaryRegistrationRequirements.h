...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d06a2
- (void).cxx_destruct;	// IMP=0x00000000000d0806
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d0784
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d06aa
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000d057c
