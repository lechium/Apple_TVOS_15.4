...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a2302
- (void).cxx_destruct;	// IMP=0x00000000000a251b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a23a3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a230a
- (id)description;	// IMP=0x00000000000a22ab
