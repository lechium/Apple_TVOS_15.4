...
- (void).cxx_destruct;	// IMP=0x000000000036399b
...
- (id)description;	// IMP=0x00000000003638a5
- (id)initWithActions:(long long)arg1 deviceCredential:(id)arg2 address:(id)arg3;	// IMP=0x0000000000363800
- (id)init;	// IMP=0x00000000003637f2
