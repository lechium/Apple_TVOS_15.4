...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007cc7c
...
- (id)_geoFenceWithDictionary:(id)arg1;	// IMP=0x000000000007d110
- (unsigned long long)hash;	// IMP=0x000000000007d0fa
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007d09b
- (double)shortestDistanceFromLocation:(id)arg1;	// IMP=0x000000000007cf58
- (_Bool)containsLocation:(id)arg1;	// IMP=0x000000000007ce2d
...
- (id)description;	// IMP=0x000000000007cc84
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007cae1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007c61f
- (id)initWithDictionary:(id)arg1 forDeviceClass:(id)arg2 version:(id)arg3;	// IMP=0x000000000007b8fd
