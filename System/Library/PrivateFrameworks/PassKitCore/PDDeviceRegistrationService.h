...
- (void).cxx_destruct;	// IMP=0x00000000000cf59d
...
- (void)performDeviceRegistrationForReason:(id)arg1 brokerURL:(id)arg2 actionType:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000cf287
- (id)initWithConnection:(id)arg1;	// IMP=0x00000000000cf1f8
