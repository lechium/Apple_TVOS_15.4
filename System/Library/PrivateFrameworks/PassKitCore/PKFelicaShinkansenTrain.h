...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002691ed
- (void).cxx_destruct;	// IMP=0x0000000000269594
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000026945f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000269255
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000269203
- (id)init;	// IMP=0x00000000002691f5
