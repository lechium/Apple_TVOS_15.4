...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001729df
- (void).cxx_destruct;	// IMP=0x0000000000173585
...
- (id)description;	// IMP=0x0000000000173175
- (unsigned long long)hash;	// IMP=0x0000000000173068
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000172f2b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000172db3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001729e7
