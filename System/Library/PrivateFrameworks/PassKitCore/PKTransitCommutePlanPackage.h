...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000037ba8f
- (void).cxx_destruct;	// IMP=0x000000000037bd70
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000037bcb9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000037bb1e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000037ba97
- (id)planForIdentifier:(id)arg1;	// IMP=0x000000000037ba79
- (id)initWithDictionary:(id)arg1 backFieldBuckets:(id)arg2 bundle:(id)arg3 privateBundle:(id)arg4;	// IMP=0x000000000037ad1b
