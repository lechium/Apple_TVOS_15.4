...
- (void).cxx_destruct;	// IMP=0x000000000025cca5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025cc04
@property(readonly, nonatomic) id <NSCopying> identifier;
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000025c76c
