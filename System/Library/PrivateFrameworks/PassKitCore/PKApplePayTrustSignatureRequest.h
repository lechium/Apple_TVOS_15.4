...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000278d5b
- (void).cxx_destruct;	// IMP=0x0000000000278d81
...
- (id)description;	// IMP=0x0000000000278c86
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000278c03
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000278af3
- (id)initWithKeyIdentifier:(id)arg1 manifestHash:(id)arg2 nonce:(id)arg3;	// IMP=0x0000000000278a3c
