...
- (void).cxx_destruct;	// IMP=0x0000000000256c1d
...
- (id)initWithWebService:(id)arg1 registrationMetadata:(id)arg2 configurationType:(long long)arg3;	// IMP=0x0000000000256b5f
