...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000079c33
- (void).cxx_destruct;	// IMP=0x000000000007a181
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000079f15
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000079c3b
- (_Bool)isEqualToInstallmentConfiguration:(id)arg1;	// IMP=0x0000000000079b48
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000079ae0
- (unsigned long long)hash;	// IMP=0x0000000000079a07
- (void)encodeToBodyDictionary:(id)arg1;	// IMP=0x0000000000002a08
