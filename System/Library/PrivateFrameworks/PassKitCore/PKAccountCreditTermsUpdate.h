...
+ (id)recordNamePrefix;	// IMP=0x000000000006b028
+ (id)recordType;	// IMP=0x000000000006b014
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006a818
- (void).cxx_destruct;	// IMP=0x000000000006b39c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006b035
- (void)encodeWithRecord:(id)arg1;	// IMP=0x000000000006ae1f
- (id)initWithRecord:(id)arg1;	// IMP=0x000000000006aa55
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006a991
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006a820
