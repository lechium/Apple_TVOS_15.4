...
+ (id)inAppQueryWithSupportedNetworkIDs:(id)arg1 merchantCapabilities:(unsigned long long)arg2 merchantCountryCode:(id)arg3 paymentMode:(long long)arg4 paymentApplicationStates:(id)arg5 isMultiTokensRequest:(_Bool)arg6 webService:(id)arg7;	// IMP=0x00000000000e7328
+ (id)webQueryWithSupportedNetworkIDs:(id)arg1 merchantCapabilities:(unsigned long long)arg2 merchantCountryCode:(id)arg3 paymentMode:(long long)arg4 paymentApplicationStates:(id)arg5 isMultiTokensRequest:(_Bool)arg6 webService:(id)arg7;	// IMP=0x00000000000e725a
- (void).cxx_destruct;	// IMP=0x00000000000e7577
...
- (id)initWithIssuedOnTheWeb:(_Bool)arg1 supportedNetworkIDs:(id)arg2 merchantCapabilities:(unsigned long long)arg3 merchantCountryCode:(id)arg4 paymentMode:(long long)arg5 paymentApplicationStates:(id)arg6 isMultiTokensRequest:(_Bool)arg7 webService:(id)arg8;	// IMP=0x00000000000e73f3
