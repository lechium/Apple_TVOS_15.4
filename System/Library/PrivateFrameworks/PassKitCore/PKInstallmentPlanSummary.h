...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a11fb
- (void).cxx_destruct;	// IMP=0x00000000000a177e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a1538
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a143f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a1203
- (unsigned long long)hash;	// IMP=0x00000000000a1136
- (_Bool)isEqualToInstallmentPlanSummary:(id)arg1;	// IMP=0x00000000000a105f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a0ff7
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000a0e33
