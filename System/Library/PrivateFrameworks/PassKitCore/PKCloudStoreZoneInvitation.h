...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001bd5f7
+ (id)cloudStoreZoneInvitationWithProtobuf:(id)arg1;	// IMP=0x0000000000170d4d
- (void).cxx_destruct;	// IMP=0x00000000001bda89
...
- (id)description;	// IMP=0x00000000001bd901
- (_Bool)isEqualToCloudStoreZoneInvitation:(id)arg1;	// IMP=0x00000000001bd884
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bd81c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bd773
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bd5ff
- (id)protobuf;	// IMP=0x0000000000170edf
