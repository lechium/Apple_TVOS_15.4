...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001c6167
- (void).cxx_destruct;	// IMP=0x00000000001c7052
...
- (id)description;	// IMP=0x00000000001c6eac
- (id)asMutableDictionary;	// IMP=0x00000000001c6bfe
- (id)asDictionary;	// IMP=0x00000000001c6bb6
- (void)flushCachedValue;	// IMP=0x00000000001c6b9c
@property(readonly) __weak NSString *value;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c68ed
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c661c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c616f
- (id)init;	// IMP=0x00000000001c6120
