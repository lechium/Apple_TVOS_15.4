...
- (void).cxx_destruct;	// IMP=0x0000000000086f93
...
- (_Bool)preferenceObject:(id)arg1 representsContact:(id)arg2;	// IMP=0x0000000000086ead
- (void)clearAllErrors;	// IMP=0x0000000000086e84
- (id)errorsForPreference:(id)arg1;	// IMP=0x0000000000086e6e
- (void)setErrors:(id)arg1 forPreference:(id)arg2;	// IMP=0x0000000000086ded
- (id)initWithTitle:(id)arg1 preferences:(id)arg2 selectedIndex:(unsigned long long)arg3 readOnly:(_Bool)arg4;	// IMP=0x0000000000086d0b
