...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d082e
- (void).cxx_destruct;	// IMP=0x00000000000d0af9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d09e1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d08ec
- (id)initWithBankAccountInformation:(id)arg1 peerPaymentBalance:(id)arg2 deviceSupportsPeerPaymentAccountPayment:(_Bool)arg3;	// IMP=0x00000000000d0836
