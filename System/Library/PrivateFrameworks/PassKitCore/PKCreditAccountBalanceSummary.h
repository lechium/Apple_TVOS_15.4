...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001e0bd8
- (void).cxx_destruct;	// IMP=0x00000000001e181f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e1549
- (id)description;	// IMP=0x00000000001e121f
- (unsigned long long)hash;	// IMP=0x00000000001e1126
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e0fe7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e0eb2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e0be0
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001e09b3
