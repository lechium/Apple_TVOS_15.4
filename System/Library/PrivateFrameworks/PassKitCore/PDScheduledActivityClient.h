...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000122691
- (void).cxx_destruct;	// IMP=0x0000000000122850
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012279b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000122699
- (id)initWithClientInstance:(id)arg1 activityQueue:(id)arg2;	// IMP=0x00000000001225d5
