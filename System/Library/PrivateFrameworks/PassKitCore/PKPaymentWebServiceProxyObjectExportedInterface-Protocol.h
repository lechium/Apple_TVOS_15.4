...
- (void)updateHasLocallyProvisionedPass:(_Bool)arg1 forFeatureIdentifier:(unsigned long long)arg2 withCompletion:(void (^)(void))arg3;
- (void)hasLocallyProvisionedPassForFeatureIdentifier:(unsigned long long)arg1 completion:(void (^)(_Bool))arg2;
...
- (void)hasPassesWithFeatureIdentifier:(unsigned long long)arg1 completion:(void (^)(_Bool))arg2;
