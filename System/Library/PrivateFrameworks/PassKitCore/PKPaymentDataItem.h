...
+ (_Bool)validateBillingAddressForItem:(id)arg1 billingAddress:(id)arg2 outError:(id *)arg3;	// IMP=0x00000000000428df
+ (_Bool)supportsMultipleItems;	// IMP=0x00000000000427c9
+ (long long)dataType;	// IMP=0x00000000000427b4
...
- (_Bool)isValidWithError:(id *)arg1;	// IMP=0x000000000004288d
...
- (id)initWithModel:(id)arg1;	// IMP=0x00000000000427d1
