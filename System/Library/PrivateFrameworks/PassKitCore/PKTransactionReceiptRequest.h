...
- (void).cxx_destruct;	// IMP=0x00000000002b9ef4
...
- (id)_urlRequest;	// IMP=0x00000000002b9c18
- (id)initWithReceiptProviderURL:(id)arg1 authorizationToken:(id)arg2 signature:(id)arg3 receiptIdentifier:(id)arg4;	// IMP=0x00000000002b9af4
