...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000068f87
- (void).cxx_destruct;	// IMP=0x000000000006a712
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006a1ab
- (id)description;	// IMP=0x0000000000069bc5
- (unsigned long long)hash;	// IMP=0x0000000000069a0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000697a6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006952a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000068f8f
- (id)accountUserActivityForAccountUserAltDSID:(id)arg1;	// IMP=0x0000000000068d3e
- (void)ingestExtendedAccountDetails:(id)arg1;	// IMP=0x0000000000068c6d
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000684e2
