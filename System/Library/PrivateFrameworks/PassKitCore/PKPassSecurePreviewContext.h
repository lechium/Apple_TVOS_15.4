...
+ (id)createMessagesPreviewForPassesFileURL:(id)arg1 withOutputDirectory:(id)arg2;	// IMP=0x0000000000350060
+ (id)createMessagesPreviewForPassFileURL:(id)arg1 withOutputDirectory:(id)arg2;	// IMP=0x0000000000350050
- (void).cxx_destruct;	// IMP=0x000000000034f2e1
...
- (void)setBackgroundImage:(struct CGImage *)arg1;	// IMP=0x000000000034f1f2
- (void)setImage:(struct CGImage *)arg1;	// IMP=0x000000000034f1c6
- (void)dealloc;	// IMP=0x000000000034f183
- (id)_initWithBackgroundColor:(id)arg1 primaryColor:(id)arg2 secondaryColor:(id)arg3 tertiaryColor:(id)arg4;	// IMP=0x000000000034f076
- (id)init;	// IMP=0x000000000034f068
