...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017407f
- (void).cxx_destruct;	// IMP=0x0000000000174543
...
- (id)description;	// IMP=0x00000000001743e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000174328
- (unsigned long long)hash;	// IMP=0x0000000000174291
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001741e1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000174087
- (id)errorRepresentation;	// IMP=0x0000000000173f94
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000173de3
