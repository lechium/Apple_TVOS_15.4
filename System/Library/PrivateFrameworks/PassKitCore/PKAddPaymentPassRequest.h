...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000295e23
- (void).cxx_destruct;	// IMP=0x00000000002965a1
...
- (_Bool)_hasRequiredFields:(_Bool)arg1;	// IMP=0x0000000000296266
- (_Bool)_hasRequiredThirdPartyFields:(_Bool)arg1;	// IMP=0x0000000000296060
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000295fcb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000295e89
- (void)dealloc;	// IMP=0x0000000000295e5a
- (id)init;	// IMP=0x0000000000295e2b
