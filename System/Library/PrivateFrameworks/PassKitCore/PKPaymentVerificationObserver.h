...
- (void).cxx_destruct;	// IMP=0x00000000003303c9
...
- (void)stop;	// IMP=0x000000000033037e
- (void)startObservingVerificationSourceWithTimeout:(double)arg1;	// IMP=0x0000000000330378
- (void)dealloc;	// IMP=0x0000000000330349
- (id)initWithPaymentPass:(id)arg1 verificationChannel:(id)arg2 identifier:(id)arg3;	// IMP=0x000000000033033b
