...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000013d0fd
- (void).cxx_destruct;	// IMP=0x000000000013d4c6
...
- (unsigned long long)hash;	// IMP=0x000000000013d3b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000013d306
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000013d23d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000013d105
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000013cea9
