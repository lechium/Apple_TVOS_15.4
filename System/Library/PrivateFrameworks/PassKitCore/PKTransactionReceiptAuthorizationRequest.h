...
- (void).cxx_destruct;	// IMP=0x00000000002b9ab2
...
- (void)_urlRequestWithServiceURL:(id)arg1 appleAccountInformation:(id)arg2 webService:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002b9882
- (id)initWithReceiptServiceIdentifier:(id)arg1 receiptIdentifier:(id)arg2 cardNumberSuffix:(id)arg3;	// IMP=0x00000000002b9787
