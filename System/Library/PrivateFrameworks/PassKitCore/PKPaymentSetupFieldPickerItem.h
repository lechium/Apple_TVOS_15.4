...
+ (id)_itemWithDictionary:(id)arg1;	// IMP=0x00000000000380cd
- (void).cxx_destruct;	// IMP=0x0000000000038278
...
- (id)initWithName:(id)arg1 value:(id)arg2;	// IMP=0x0000000000038181
