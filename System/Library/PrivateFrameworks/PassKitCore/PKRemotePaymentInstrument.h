...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000026059f
+ (id)sortDescriptorForDefaultPaymentInstrument:(id)arg1 paymentSupportedQuery:(id)arg2;	// IMP=0x00000000000e7a6c
+ (id)remotePaymentInstrumentWithProtobuf:(id)arg1;	// IMP=0x00000000001701c8
+ (id)thumbnailCachePathForManifestHash:(id)arg1 size:(struct CGSize)arg2;	// IMP=0x00000000002617b6
- (void).cxx_destruct;	// IMP=0x0000000000261720
...
- (_Bool)isEqualToRemotePaymentInstrument:(id)arg1;	// IMP=0x000000000026126c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000261204
- (unsigned long long)hash;	// IMP=0x0000000000261119
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000260f5e
- (id)sortedPaymentApplications:(id)arg1 ascending:(_Bool)arg2;	// IMP=0x0000000000260f4b
- (id)description;	// IMP=0x0000000000260d0e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000260b90
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002607db
- (id)initWithPaymentPass:(id)arg1;	// IMP=0x00000000002605a7
- (id)protobuf;	// IMP=0x000000000017072a
