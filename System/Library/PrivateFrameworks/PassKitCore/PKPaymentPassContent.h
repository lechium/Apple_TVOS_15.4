...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003cb9f4
- (void).cxx_destruct;	// IMP=0x00000000003cc7ff
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003cc151
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003cb9fc
- (id)initWithDictionary:(id)arg1 bundle:(id)arg2 privateBundle:(id)arg3;	// IMP=0x00000000003ca385
