...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000150efd
- (void).cxx_destruct;	// IMP=0x000000000015128f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001510ba
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000150f05
@property(readonly, nonatomic) _Bool isTall;
- (id)initWithPassDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000001508de
- (unsigned long long)hash;	// IMP=0x000000000015082b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000015064a
