...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002a481a
+ (id)uniqueIDFromRecordName:(id)arg1;	// IMP=0x00000000002a195e
+ (id)recordNameForUniqueID:(id)arg1;	// IMP=0x00000000002a18c8
+ (id)recordNamePrefix;	// IMP=0x00000000002a18bb
+ (unsigned long long)defaultSettings;	// IMP=0x00000000002a11f5
+ (id)fetchSigningDateForObjectWithFileDataAccessor:(id)arg1 passDictionary:(id)arg2;	// IMP=0x00000000002a1046
+ (_Bool)isValidObjectWithFileDataAccessor:(id)arg1 validationOptions:(unsigned long long)arg2 warnings:(id *)arg3 error:(id *)arg4 signingDate:(id *)arg5 passDictionary:(id)arg6;	// IMP=0x00000000002a0fc4
+ (id)dataTypeIdentifier;	// IMP=0x00000000002a0fb0
+ (Class)classForDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000002a0f44
+ (Class)resolvingClass;	// IMP=0x00000000002a0f33
+ (Class)classForPassType:(unsigned long long)arg1;	// IMP=0x000000000029fc1b
- (void).cxx_destruct;	// IMP=0x00000000002a6842
...
- (id)_changeMessageForFieldKey:(id)arg1;	// IMP=0x00000000002a5e9c
- (id)_localizationKeyForMultipleDiff;	// IMP=0x00000000002a5e2d
- (id)dictionariesForSemanticKey:(id)arg1;	// IMP=0x00000000002a5d8c
- (id)stringsForSemanticKey:(id)arg1;	// IMP=0x00000000002a5ceb
- (id)personNameComponentsForSemanticKey:(id)arg1;	// IMP=0x00000000002a5c4a
- (id)currencyAmountForSemanticKey:(id)arg1;	// IMP=0x00000000002a5ba9
- (id)locationForSemanticKey:(id)arg1;	// IMP=0x00000000002a5b08
- (id)numberForSemanticKey:(id)arg1;	// IMP=0x00000000002a5a67
- (id)dateForSemanticKey:(id)arg1;	// IMP=0x00000000002a59c6
- (id)stringForSemanticKey:(id)arg1;	// IMP=0x00000000002a5925
- (_Bool)availableForAutomaticPresentationUsingBeaconContext;	// IMP=0x00000000002a58dd
- (_Bool)availableForAutomaticPresentationUsingVASContext;	// IMP=0x00000000002a58cb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a551c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002a50fa
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002a4822
- (_Bool)isEqualToPassIncludingMetadata:(id)arg1;	// IMP=0x00000000002a4610
@property(readonly, nonatomic) struct CGRect logoRect;
- (id)passLocalizedStringForKey:(id)arg1;	// IMP=0x00000000002a450b
...
- (id)thumbnailImage;	// IMP=0x00000000002a41ff
- (id)stripImage;	// IMP=0x00000000002a41aa
- (id)backgroundImage;	// IMP=0x00000000002a4155
- (id)logoImage;	// IMP=0x00000000002a4100
...
- (id)allSemantics;	// IMP=0x00000000002a3c47
- (id)semantics;	// IMP=0x00000000002a3bf7
...
- (id)balanceFields;	// IMP=0x00000000002a3a04
- (id)primaryFields;	// IMP=0x00000000002a39b4
...
- (id)diff:(id)arg1;	// IMP=0x00000000002a2c40
- (id)localizedDescriptionForDiff:(id)arg1;	// IMP=0x00000000002a2891
- (id)fieldForKey:(id)arg1;	// IMP=0x00000000002a22a9
- (id)localizedValueForFieldKey:(id)arg1;	// IMP=0x00000000002a2250
- (_Bool)supportsSharing;	// IMP=0x00000000002a2236
- (_Bool)linksToApp;	// IMP=0x00000000002a21a8
- (_Bool)supportsSyncing;	// IMP=0x00000000002a216c
- (_Bool)isExpiredBasedOnSigningDate;	// IMP=0x00000000002a20b7
- (_Bool)isExpired;	// IMP=0x00000000002a2039
- (_Bool)isUpdatable;	// IMP=0x00000000002a2006
- (_Bool)isRelevantDateOld;	// IMP=0x00000000002a1f4f
- (_Bool)hasValidNFCPayload;	// IMP=0x00000000002a1eac
- (_Bool)hasLocationRelevancyInfo;	// IMP=0x00000000002a1e5e
- (_Bool)hasTimeOrLocationRelevancyInfo;	// IMP=0x00000000002a1e07
...
- (unsigned long long)itemType;	// IMP=0x00000000002a18b0
- (id)primaryIdentifier;	// IMP=0x00000000002a189e
- (id)systemFieldsData;	// IMP=0x00000000002a1855
- (id)recordTypesAndNamesForCodingType:(unsigned long long)arg1;	// IMP=0x00000000002a1709
- (void)encodeWithCloudStoreCoder:(id)arg1 codingType:(unsigned long long)arg2;	// IMP=0x00000000002a1462
- (void)applyPropertiesFromCloudStoreRecord:(id)arg1;	// IMP=0x00000000002a145c
- (id)initWithCloudStoreCoder:(id)arg1;	// IMP=0x00000000002a1200
- (void)downloadRemoteAssetsForSEIDS:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002a10ce
- (void)downloadRemoteAssetsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002a10b7
- (id)initWithDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000029fc58
- (id)initWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000029fbec
