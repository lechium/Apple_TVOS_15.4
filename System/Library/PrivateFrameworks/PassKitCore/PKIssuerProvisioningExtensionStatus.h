...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003a6272
...
- (id)description;	// IMP=0x00000000003a63de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a6358
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a62b4
- (id)init;	// IMP=0x00000000003a627a
