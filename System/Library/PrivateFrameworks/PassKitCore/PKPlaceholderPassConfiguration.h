...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003a802d
- (void).cxx_destruct;	// IMP=0x00000000003a8085
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a7ecc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a7e33
- (id)description;	// IMP=0x00000000003a7ddc
- (id)initWithSubcredential:(id)arg1 automaticSelectionCriterion:(id)arg2;	// IMP=0x00000000003a7d20
