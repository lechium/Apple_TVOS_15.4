...
- (void).cxx_destruct;	// IMP=0x00000000002980dd
...
- (void)_handleCertificates:(id)arg1;	// IMP=0x0000000000297e20
- (id)initWithJSONObject:(id)arg1 featureApplication:(id)arg2;	// IMP=0x0000000000297843
