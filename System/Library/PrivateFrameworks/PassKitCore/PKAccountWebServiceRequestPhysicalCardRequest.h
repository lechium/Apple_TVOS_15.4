...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008eae3
- (void).cxx_destruct;	// IMP=0x000000000008eec1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008ec9b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008eaeb
- (id)manifestHashWithReferenceIdentifier:(id)arg1;	// IMP=0x000000000008e955
- (Class)signatureResponseClass;	// IMP=0x000000000008e944
- (id)endpointComponents;	// IMP=0x000000000008e895
- (id)_urlRequestWithAppleAccountInformation:(id)arg1;	// IMP=0x000000000008e35f
