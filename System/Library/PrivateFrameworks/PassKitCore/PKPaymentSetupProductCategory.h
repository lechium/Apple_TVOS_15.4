...
- (void).cxx_destruct;	// IMP=0x000000000040bdca
...
- (_Bool)needsProducts;	// IMP=0x000000000040bc8a
- (id)description;	// IMP=0x000000000040bbbe
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000040b422
