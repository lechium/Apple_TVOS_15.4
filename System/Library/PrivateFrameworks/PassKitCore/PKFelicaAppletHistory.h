...
+ (long long)appletTypeForDictionary:(id)arg1;	// IMP=0x000000000043811b
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000438113
- (void).cxx_destruct;	// IMP=0x0000000000438734
...
- (_Bool)isInStation;	// IMP=0x0000000000438686
@property(readonly, nonatomic, getter=isInShinkansenStation) _Bool inShinkansenStation; // @dynamic inShinkansenStation;
- (void)sanitizeValuesWithState:(id)arg1;	// IMP=0x0000000000438630
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004384c0
- (void)dealloc;	// IMP=0x0000000000438491
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000438213
- (id)initWithDictionary:(id)arg1 source:(long long)arg2;	// IMP=0x0000000000438123
