...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ed082
- (void).cxx_destruct;	// IMP=0x00000000000ed367
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ed107
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ed095
- (unsigned long long)tokenType;	// IMP=0x00000000000ed08a
