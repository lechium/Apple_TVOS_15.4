...
+ (Class)equalityClass;	// IMP=0x00000000001e85c4
+ (id)passPropertiesForPass:(id)arg1;	// IMP=0x00000000001e81b2
...
- (unsigned long long)hash;	// IMP=0x00000000001e854b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e8467
- (id)_initWithProperties:(id)arg1;	// IMP=0x00000000001e82a1
