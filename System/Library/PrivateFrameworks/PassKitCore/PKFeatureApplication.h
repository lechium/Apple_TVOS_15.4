...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000036733d
- (void).cxx_destruct;	// IMP=0x000000000036832e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000367fb4
- (unsigned long long)hash;	// IMP=0x0000000000367e5d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000367be4
- (id)description;	// IMP=0x0000000000367856
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000367694
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000367345
...
- (_Bool)hasSufficientOTBForInstallmentConfiguration:(id)arg1;	// IMP=0x000000000036718d
@property(readonly, nonatomic) _Bool isActive;
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000366aea
