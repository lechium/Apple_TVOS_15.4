...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001e7c5
- (void).cxx_destruct;	// IMP=0x000000000001e811
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001e74d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001e67b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001e586
