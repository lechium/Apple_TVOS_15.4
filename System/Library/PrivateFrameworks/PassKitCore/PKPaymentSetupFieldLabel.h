...
- (void).cxx_destruct;	// IMP=0x0000000000037e5d
...
- (unsigned long long)fieldType;	// IMP=0x0000000000037d42
- (_Bool)submissionStringMeetsAllRequirements;	// IMP=0x0000000000037d3a
- (id)submissionString;	// IMP=0x0000000000037d32
- (id)displayString;	// IMP=0x0000000000037d20
@property(readonly, copy, nonatomic) NSString *title;
- (void)setCurrentValue:(id)arg1;	// IMP=0x0000000000037d08
- (void)_commonUpdate;	// IMP=0x0000000000037c9a
- (void)updateWithConfiguration:(id)arg1;	// IMP=0x0000000000037a0f
