...
- (void).cxx_destruct;	// IMP=0x00000000000a229b
- (void)dealloc;	// IMP=0x00000000000a225c
@property(readonly, nonatomic, getter=isInvalidated) _Bool invalidated;
- (void)invalidate;	// IMP=0x00000000000a222a
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a2194
- (id)init;	// IMP=0x00000000000a2186
