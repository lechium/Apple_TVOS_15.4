...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002451e5
+ (CDUnknownBlockType)acceptedComparatorWithPaymentSupportedQuery:(id)arg1;	// IMP=0x00000000000e8283
+ (CDUnknownBlockType)preferenceComparator;	// IMP=0x00000000000e7fd4
- (void).cxx_destruct;	// IMP=0x0000000000246166
...
- (long long)_deviceTypeForModelIdentifier:(id)arg1;	// IMP=0x0000000000245f6b
@property(readonly, nonatomic) _Bool canMakePayments;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000245c60
- (id)description;	// IMP=0x00000000002457d7
- (_Bool)isEqualToRemoteDevice:(id)arg1;	// IMP=0x000000000024578a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000245722
- (unsigned long long)hash;	// IMP=0x0000000000245686
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000245516
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002451ed
- (id)initWithIDSDevice:(id)arg1;	// IMP=0x00000000002450b4
- (id)pk_idsDestination;	// IMP=0x000000000036c91b
