...
+ (id)createWithPassDictionary:(id)arg1 privateDictionary:(id)arg2;	// IMP=0x00000000003db8eb
+ (id)createWithFileURL:(id)arg1;	// IMP=0x00000000003db021
- (void).cxx_destruct;	// IMP=0x00000000003dbd49
...
- (id)createTileForState:(id)arg1 withBundle:(id)arg2 privateBundle:(id)arg3;	// IMP=0x00000000003dbb15
- (id)init;	// IMP=0x00000000003db9d6
- (id)_init;	// IMP=0x00000000003db9a7
