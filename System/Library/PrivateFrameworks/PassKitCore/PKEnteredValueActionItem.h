...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001e01e4
- (void).cxx_destruct;	// IMP=0x00000000001e0949
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e0775
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e0677
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e01ec
- (void)_processLocalizableStrings:(CDUnknownBlockType)arg1;	// IMP=0x00000000001e01de
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001dfac3
- (id)init;	// IMP=0x00000000001dfab5
