...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000349492
+ (id)verificationRequestRecordForPass:(id)arg1;	// IMP=0x0000000000348c20
- (void).cxx_destruct;	// IMP=0x00000000003497e7
...
- (id)requiredVerificationFields;	// IMP=0x000000000034949a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003492ba
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000348dc3
