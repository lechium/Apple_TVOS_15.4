...
+ (Class)multiTokenContextsType;	// IMP=0x0000000000311e7a
+ (Class)shippingMethodsType;	// IMP=0x0000000000311d39
+ (Class)paymentSummaryItemsType;	// IMP=0x0000000000311c67
- (void).cxx_destruct;	// IMP=0x000000000031414a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000313b9f
- (unsigned long long)hash;	// IMP=0x0000000000313a4a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003137e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000031329e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000312fc3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000312bf9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000312bec
- (id)dictionaryRepresentation;	// IMP=0x0000000000311f64
- (id)description;	// IMP=0x0000000000311eb5
...
- (id)multiTokenContextsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000311e5d
- (unsigned long long)multiTokenContextsCount;	// IMP=0x0000000000311e40
- (void)addMultiTokenContexts:(id)arg1;	// IMP=0x0000000000311dd6
- (void)clearMultiTokenContexts;	// IMP=0x0000000000311db9
...
- (id)shippingMethodsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000311d1c
- (unsigned long long)shippingMethodsCount;	// IMP=0x0000000000311cff
- (void)addShippingMethods:(id)arg1;	// IMP=0x0000000000311c95
- (void)clearShippingMethods;	// IMP=0x0000000000311c78
- (id)paymentSummaryItemsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000311c4a
- (unsigned long long)paymentSummaryItemsCount;	// IMP=0x0000000000311c2d
- (void)addPaymentSummaryItems:(id)arg1;	// IMP=0x0000000000311bc3
- (void)clearPaymentSummaryItems;	// IMP=0x0000000000311ba6
