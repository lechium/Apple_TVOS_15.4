...
+ (id)paramWithWrappedPayment:(id)arg1 nonce:(id)arg2 credential:(id)arg3 cryptogramType:(long long)arg4;	// IMP=0x00000000002f7bba
- (void).cxx_destruct;	// IMP=0x00000000002f7dc2
...
- (id)description;	// IMP=0x00000000002f7c8f
