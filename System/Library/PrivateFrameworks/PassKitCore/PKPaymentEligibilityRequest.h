...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002ab82b
- (void).cxx_destruct;	// IMP=0x00000000002ad575
...
- (void)_updateRequestForRedirect:(id)arg1 overrides:(id)arg2 webService:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002ad142
- (void)_updateRequestForRetry:(id)arg1 retryFields:(id)arg2 webService:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002acf33
- (void)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 appleAccountInformation:(id)arg3 certChain:(id)arg4 devSigned:(_Bool)arg5 deviceData:(id)arg6 webService:(id)arg7 completion:(CDUnknownBlockType)arg8;	// IMP=0x00000000002ab9e0
- (_Bool)requiresNonce;	// IMP=0x00000000002ab9c6
- (unsigned long long)_requestHTTPMethod;	// IMP=0x00000000002ab94b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002ab580
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002ab050
- (id)initWithAddRequestConfiguration:(id)arg1 addRequest:(id)arg2;	// IMP=0x00000000002aadbe
- (id)initWithPaymentCredential:(id)arg1;	// IMP=0x00000000002aad6c
- (id)initWithSource:(long long)arg1;	// IMP=0x00000000002aad28
- (id)init;	// IMP=0x00000000002aad11
