...
- (void).cxx_destruct;	// IMP=0x000000000029ceb1
@property(nonatomic) long long state; // @synthesize state=_state;
@property(nonatomic) __weak id <PKBluetoothMonitorerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x000000000029ce1f
- (id)initWithManagerOptions:(id)arg1;	// IMP=0x000000000029cd73
