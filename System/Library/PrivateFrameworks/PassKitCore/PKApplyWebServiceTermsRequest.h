...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000008195
- (void).cxx_destruct;	// IMP=0x0000000000008766
...
- (id)_urlRequestWithAppleAccountInformation:(id)arg1;	// IMP=0x000000000000819d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000008034
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007dd1
