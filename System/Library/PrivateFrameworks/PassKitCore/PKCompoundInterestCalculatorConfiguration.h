...
+ (id)configurationWithCreditAccount:(id)arg1;	// IMP=0x00000000000c837d
- (void).cxx_destruct;	// IMP=0x00000000000c8e59
...
- (id)description;	// IMP=0x00000000000c898b
- (long long)_daysInYearForDate:(id)arg1 withTimeZone:(id)arg2;	// IMP=0x00000000000c87e9
- (void)updateWithCreditAccount:(id)arg1;	// IMP=0x00000000000c848d
- (id)init;	// IMP=0x00000000000c83d3
