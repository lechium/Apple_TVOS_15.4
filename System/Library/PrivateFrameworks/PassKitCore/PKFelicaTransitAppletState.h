...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e1c5
- (void).cxx_destruct;	// IMP=0x0000000000042086
...
- (id)transitPassPropertiesWithPaymentApplication:(id)arg1 fieldCollection:(id)arg2;	// IMP=0x0000000000041bb1
- (id)transitPassPropertiesWithPaymentApplication:(id)arg1 pass:(id)arg2;	// IMP=0x0000000000041b0e
- (id)transitPassPropertiesWithPaymentApplication:(id)arg1;	// IMP=0x0000000000041aaf
- (id)_concreteTransactionForRecordAtIndex:(unsigned long long)arg1 withBalance:(unsigned int *)arg2 historyRecords:(id)arg3 terminalState:(id)arg4 numberProcessed:(unsigned long long *)arg5 exitedShinkansen:(_Bool *)arg6;	// IMP=0x0000000000040cdb
- (void)_resolveTransactionsFromState:(id)arg1 toState:(id)arg2 withHistoryRecords:(id)arg3 concreteTransactions:(id *)arg4 ephemeralTransaction:(id *)arg5;	// IMP=0x00000000000404b6
- (id)processUpdateWithAppletHistory:(id)arg1 concreteTransactions:(id *)arg2 ephemeralTransaction:(id *)arg3;	// IMP=0x000000000003f819
- (id)processUpdateWithAppletHistory:(id)arg1 concreteTransactions:(id *)arg2 ephemeralTransaction:(id *)arg3 mutatedBalances:(id *)arg4 balanceLabelDictionary:(id)arg5 unitDictionary:(id)arg6;	// IMP=0x000000000003f807
- (unsigned long long)hash;	// IMP=0x000000000003f51a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003f11d
@property(readonly, nonatomic, getter=isInShinkansenStation) _Bool inShinkansenStation; // @dynamic inShinkansenStation;
- (_Bool)isInStation;	// IMP=0x000000000003f10d
- (void)dealloc;	// IMP=0x000000000003f0de
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003ed7a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003e965
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003e220
- (id)init;	// IMP=0x000000000003e1cd
