...
+ (id)paramWithCallbackKind:(long long)arg1 object:(id)arg2;	// IMP=0x00000000002f6e1e
- (void).cxx_destruct;	// IMP=0x00000000002f70cb
@property(retain, nonatomic) id object; // @synthesize object=_object;
@property(nonatomic) long long kind; // @synthesize kind=_kind;
- (id)description;	// IMP=0x00000000002f6f71
