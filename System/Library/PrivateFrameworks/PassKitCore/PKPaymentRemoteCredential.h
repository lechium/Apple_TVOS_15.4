...
- (void).cxx_destruct;	// IMP=0x00000000001a7e0d
...
- (id)description;	// IMP=0x00000000001a7b78
- (unsigned long long)hash;	// IMP=0x00000000001a7a92
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a7876
- (void)updateWithDictionary:(id)arg1;	// IMP=0x00000000001a6e10
- (id)initWithIdentifier:(id)arg1 status:(long long)arg2 credentialType:(long long)arg3 passURL:(id)arg4;	// IMP=0x00000000001a6d23
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001a6ca9
- (id)init;	// IMP=0x00000000001a6c95
