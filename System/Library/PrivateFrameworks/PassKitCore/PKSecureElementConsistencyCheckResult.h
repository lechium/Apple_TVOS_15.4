...
- (void).cxx_destruct;	// IMP=0x00000000003413a6
...
- (id)description;	// IMP=0x0000000000341269
- (id)initWithCleanupActions:(long long)arg1 resultsSummary:(id)arg2 requestedActions:(id)arg3 registeredRegions:(id)arg4;	// IMP=0x0000000000341154
