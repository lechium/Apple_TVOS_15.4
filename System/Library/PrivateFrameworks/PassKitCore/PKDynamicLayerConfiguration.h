...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000101f32
- (void).cxx_destruct;	// IMP=0x0000000000102498
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001022b6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001021ad
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000101f3a
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000101b5e
