...
+ (id)contextWithArchive:(id)arg1;	// IMP=0x000000000026455b
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000264553
- (void).cxx_destruct;	// IMP=0x0000000000264838
...
- (void)updateContextWithDeviceRegistrationData:(id)arg1 registrationResponse:(id)arg2;	// IMP=0x00000000002645e5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000026444c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000026425e
