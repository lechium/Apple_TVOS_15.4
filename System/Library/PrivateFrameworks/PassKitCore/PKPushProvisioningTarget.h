...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000035eb74
- (void).cxx_destruct;	// IMP=0x000000000035f34e
...
- (id)jsonRepresentation;	// IMP=0x000000000035f117
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000035ef86
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000035ee31
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000035eb7c
- (unsigned long long)hash;	// IMP=0x000000000035ea74
- (_Bool)isEqualToProvisioningTarget:(id)arg1;	// IMP=0x000000000035e5d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000035e568
- (id)initWithAppleIdentifier:(id)arg1 appleIdentifierType:(long long)arg2 pushProvisioningPolicyIdentifier:(id)arg3 provisioningCredentialIdentifier:(id)arg4 cardConfigurationIdentifier:(id)arg5 sharingInstanceIdentifier:(id)arg6 nonce:(id)arg7 accountHash:(id)arg8 templateIdentifier:(id)arg9 relyingPartyIdentifier:(id)arg10 requiresSimultaneousRequestRouting:(_Bool)arg11 targetDevice:(unsigned long long)arg12;	// IMP=0x000000000035e3a6
- (id)initWithAppleIdentifier:(id)arg1 appleIdentifierType:(long long)arg2 pushProvisioningPolicyIdentifier:(id)arg3 provisioningCredentialIdentifier:(id)arg4 cardConfigurationIdentifier:(id)arg5 sharingInstanceIdentifier:(id)arg6 nonce:(id)arg7;	// IMP=0x000000000035e358
