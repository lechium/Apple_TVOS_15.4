...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000031e17d
- (void).cxx_destruct;	// IMP=0x000000000031ea2b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000031e6a0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000031e185
