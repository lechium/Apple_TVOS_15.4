...
- (void).cxx_destruct;	// IMP=0x000000000008c6a7
...
- (id)manifestHashWithReferenceIdentifier:(id)arg1;	// IMP=0x000000000008c38d
- (id)endpointComponents;	// IMP=0x000000000008c303
- (Class)signatureResponseClass;	// IMP=0x000000000008c2f2
- (id)_urlRequestWithAppleAccountInformation:(id)arg1;	// IMP=0x000000000008bd86
