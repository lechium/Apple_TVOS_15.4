...
- (void).cxx_destruct;	// IMP=0x0000000000308f98
...
- (id)initWithPassField:(id)arg1;	// IMP=0x0000000000308e62
- (id)initWithPaymentPassFieldDictionary:(id)arg1;	// IMP=0x0000000000308cd8
