...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000038b3c4
+ (_Bool)shouldCache;	// IMP=0x000000000038b2c9
+ (unsigned int)currentVersion;	// IMP=0x000000000038b2be
+ (id)archiveName;	// IMP=0x000000000038b2b1
+ (long long)imageSetType;	// IMP=0x000000000038b2a6
- (void).cxx_destruct;	// IMP=0x000000000038bfb3
...
- (unsigned long long)hash;	// IMP=0x000000000038bafc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000038b916
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000038b740
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000038b3cc
- (void)preheatImages;	// IMP=0x000000000038b2d1
- (id)initWithDisplayProfile:(id)arg1 fileURL:(id)arg2 screenScale:(double)arg3 suffix:(id)arg4;	// IMP=0x000000000038aebb
