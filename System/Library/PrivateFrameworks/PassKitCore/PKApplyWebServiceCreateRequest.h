...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003c03
- (void).cxx_destruct;	// IMP=0x0000000000004298
...
- (id)_urlRequestWithServiceURL:(id)arg1 appleAccountInformation:(id)arg2;	// IMP=0x0000000000003c0b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003a9c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003881
