...
- (void).cxx_destruct;	// IMP=0x00000000003637bf
...
- (id)description;	// IMP=0x0000000000363649
- (unsigned long long)hash;	// IMP=0x000000000036359c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003633e6
- (id)initWithType:(long long)arg1 recordType:(long long)arg2 recordUniqueID:(id)arg3;	// IMP=0x00000000003632d5
- (id)init;	// IMP=0x0000000000363241
