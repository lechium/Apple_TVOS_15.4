...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002ae2ef
- (void).cxx_destruct;	// IMP=0x00000000002b0325
...
- (void)_updateContextUsingWebService:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002afce2
- (void)_deviceScoreWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002afb4a
- (id)_secureParemters;	// IMP=0x00000000002af759
- (void)_encryptSecureDictionary:(id)arg1 intoDictionary:(id)arg2;	// IMP=0x00000000002af46e
- (void)_requestBodyWithWebService:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002aecad
- (void)_updateRequestForRedirect:(id)arg1 overrides:(id)arg2 webService:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002aeb33
- (void)_updateRequestForRetry:(id)arg1 retryFields:(id)arg2 webService:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002ae865
- (void)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 appleAccountInformation:(id)arg3 certChain:(id)arg4 devSigned:(_Bool)arg5 deviceData:(id)arg6 webService:(id)arg7 completion:(CDUnknownBlockType)arg8;	// IMP=0x00000000002ae38c
@property(readonly, nonatomic, getter=isDeviceProvisioningDataExpected) _Bool deviceProvisioningDataExpected;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002adf89
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002ad827
- (id)initWithEligibilityResponse:(id)arg1 addRequestConfiguration:(id)arg2 addRequest:(id)arg3;	// IMP=0x00000000002ad75e
- (id)initWithEligibilityResponse:(id)arg1 style:(long long)arg2;	// IMP=0x00000000002ad6de
- (id)initWithEligibilityResponse:(id)arg1;	// IMP=0x00000000002ad6ca
- (id)init;	// IMP=0x00000000002ad6b6
