...
+ (id)sharedURLSession;	// IMP=0x00000000003b6f2a
+ (id)itemWithLocalURL:(id)arg1 passURL:(id)arg2 dictionary:(id)arg3 error:(id *)arg4;	// IMP=0x00000000003b6880
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003b6878
- (void).cxx_destruct;	// IMP=0x00000000003b7198
...
- (void)downloadAssetWithCloudStoreCoordinatorDelegate:(id)arg1 tryCount:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000003b69f3
- (void)downloadAssetWithCloudStoreCoordinatorDelegate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003b69d9
@property(readonly, nonatomic) unsigned long long itemType;
- (_Bool)isZipFile;	// IMP=0x00000000003b695c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003b65a9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003b61bd
- (id)initWithLocalURL:(id)arg1 passURL:(id)arg2 dictionary:(id)arg3 error:(id *)arg4;	// IMP=0x00000000003b5c59
- (void)downloadAssetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000003b7793
