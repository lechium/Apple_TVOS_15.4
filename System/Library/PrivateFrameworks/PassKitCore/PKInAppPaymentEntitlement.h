...
- (void).cxx_destruct;	// IMP=0x0000000000076308
...
- (void)_probeEntitlementsWithToken:(CDStruct_6ad76789)arg1;	// IMP=0x00000000000762f5
@property(readonly, nonatomic) _Bool hasMerchantIdentifiers;
- (_Bool)hasMerchantIdentifier:(id)arg1;	// IMP=0x00000000000762c2
- (id)initWithToken:(CDStruct_6ad76789)arg1;	// IMP=0x0000000000076262
