...
- (void).cxx_destruct;	// IMP=0x0000000000202c31
...
- (void)_updateBalancesAndPlans;	// IMP=0x00000000002014ab
- (id)filteredActionsForDisplayableEntities;	// IMP=0x0000000000201104
...
- (void)updateWithDynamicCommutePlans:(id)arg1;	// IMP=0x0000000000200a89
- (void)applyStoredValueBalancesFromProperties:(id)arg1;	// IMP=0x000000000020076a
- (void)setTransitProperties:(id)arg1 andApplyStoredValueBalances:(_Bool)arg2;	// IMP=0x00000000002006f1
- (void)setTransitProperties:(id)arg1;	// IMP=0x00000000002006dd
- (id)balanceForIdentifiers:(id)arg1;	// IMP=0x0000000000200691
- (void)setDynamicBalancesByID:(id)arg1;	// IMP=0x0000000000200633
- (void)setDynamicBalances:(id)arg1;	// IMP=0x0000000000200426
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002002d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002001a9
- (id)initWithPass:(id)arg1;	// IMP=0x000000000020006f
