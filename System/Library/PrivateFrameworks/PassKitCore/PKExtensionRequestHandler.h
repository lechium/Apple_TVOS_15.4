...
- (void).cxx_destruct;	// IMP=0x00000000001a1fc9
@property(readonly, nonatomic, getter=isInvalidated) _Bool invalidated;
- (void)invalidate;	// IMP=0x00000000001a1ea5
@property(readonly, nonatomic) NSExtensionContext *extensionContext;
- (void)dealloc;	// IMP=0x00000000001a1e30
- (id)_initWithExtension:(id)arg1 extensionRequestOptions:(unsigned long long)arg2;	// IMP=0x00000000001a1c3f
- (id)init;	// IMP=0x00000000001a1c31
