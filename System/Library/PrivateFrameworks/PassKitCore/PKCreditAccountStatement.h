...
+ (id)recordNamePrefix;	// IMP=0x00000000000775c8
+ (id)recordType;	// IMP=0x00000000000775b4
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007679d
- (void).cxx_destruct;	// IMP=0x0000000000078304
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000077e0e
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000775d5
- (void)encodeWithRecord:(id)arg1;	// IMP=0x00000000000771c1
- (id)initWithRecord:(id)arg1;	// IMP=0x0000000000076e58
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000076c5d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000767a5
@property(readonly, nonatomic) unsigned long long monthNumber;
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000076318
