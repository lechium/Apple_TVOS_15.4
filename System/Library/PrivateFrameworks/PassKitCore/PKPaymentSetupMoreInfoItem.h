...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001de3f
- (void).cxx_destruct;	// IMP=0x000000000001e4f0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001e30b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001e1d2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001de47
- (void)_updateActionStrings;	// IMP=0x000000000001dd5b
- (id)initWithMoreInfoDictionary:(id)arg1 imageData:(id)arg2;	// IMP=0x000000000001d940
- (id)initWithMoreInfoDictionary:(id)arg1;	// IMP=0x000000000001d92c
