...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000338f2b
- (void).cxx_destruct;	// IMP=0x00000000003391d2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000338ff0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000338f33
- (id)description;	// IMP=0x0000000000338df8
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000338b83
