...
- (void).cxx_destruct;	// IMP=0x000000000036292f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003623d9
- (unsigned long long)hash;	// IMP=0x0000000000362085
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000361b4b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003617ce
- (void)copyTo:(id)arg1;	// IMP=0x00000000003614e8
- (void)writeTo:(id)arg1;	// IMP=0x00000000003611f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003611e4
- (id)dictionaryRepresentation;	// IMP=0x00000000003601ab
- (id)description;	// IMP=0x00000000003600fc
