...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000042b6d4
- (void).cxx_destruct;	// IMP=0x000000000042b742
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000042b5c6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000042b508
- (id)init;	// IMP=0x000000000042b4d4
