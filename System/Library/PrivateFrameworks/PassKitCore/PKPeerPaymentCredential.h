...
- (id)longDescription;	// IMP=0x00000000001ab244
- (unsigned long long)hash;	// IMP=0x00000000001ab1b4
- (_Bool)_isEqualToCredential:(id)arg1;	// IMP=0x00000000001ab0bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ab058
- (id)initWithPeerPaymentAccount:(id)arg1;	// IMP=0x00000000001aafd8
