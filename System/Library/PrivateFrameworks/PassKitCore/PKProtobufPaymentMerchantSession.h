...
+ (Class)signedFieldsType;	// IMP=0x0000000000315ee2
- (void).cxx_destruct;	// IMP=0x00000000003179d3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003174fd
- (unsigned long long)hash;	// IMP=0x000000000031733d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000317008
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000316c19
- (void)copyTo:(id)arg1;	// IMP=0x00000000003169af
- (void)writeTo:(id)arg1;	// IMP=0x00000000003166e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003166dc
- (id)dictionaryRepresentation;	// IMP=0x0000000000315fcc
- (id)description;	// IMP=0x0000000000315f1d
...
- (id)signedFieldsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000315ec5
- (unsigned long long)signedFieldsCount;	// IMP=0x0000000000315ea8
- (void)addSignedFields:(id)arg1;	// IMP=0x0000000000315e3e
- (void)clearSignedFields;	// IMP=0x0000000000315e21
