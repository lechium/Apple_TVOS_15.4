...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a1d7b
- (void).cxx_destruct;	// IMP=0x00000000000a2111
...
- (id)description;	// IMP=0x00000000000a1d83
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a1b3b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a17f3
