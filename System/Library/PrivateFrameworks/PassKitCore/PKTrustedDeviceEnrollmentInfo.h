...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004146dd
- (void).cxx_destruct;	// IMP=0x0000000000414a81
...
- (id)description;	// IMP=0x0000000000414932
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000414870
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004146e5
