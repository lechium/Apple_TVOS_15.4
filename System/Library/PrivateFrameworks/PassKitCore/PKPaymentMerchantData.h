...
- (void).cxx_destruct;	// IMP=0x00000000003d8693
...
- (id)encode;	// IMP=0x00000000003d850f
- (id)init;	// IMP=0x00000000003d84f6
- (id)initWithMerchantIdentifier:(id)arg1 applicationData:(id)arg2 merchantSession:(id)arg3;	// IMP=0x00000000003d8417
