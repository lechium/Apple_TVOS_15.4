...
- (void).cxx_destruct;	// IMP=0x00000000003b7a51
...
- (void)removeAnimationIfPossible;	// IMP=0x00000000003b7911
- (id)initWithLayer:(id)arg1 key:(id)arg2;	// IMP=0x00000000003b784a
- (id)init;	// IMP=0x00000000003b783c
