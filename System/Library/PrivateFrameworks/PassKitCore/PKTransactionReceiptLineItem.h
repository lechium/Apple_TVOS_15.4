...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003a71ac
- (void).cxx_destruct;	// IMP=0x00000000003a776c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a7502
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a73ee
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a71b4
- (unsigned long long)hash;	// IMP=0x00000000003a70e3
- (_Bool)isEqualToTransactionReceiptLineItem:(id)arg1;	// IMP=0x00000000003a6dc9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003a6d61
- (id)description;	// IMP=0x00000000003a6bc6
- (id)initWithDictionary:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000003a688b
