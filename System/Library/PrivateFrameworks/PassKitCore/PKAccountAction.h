...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c29c8
- (void).cxx_destruct;	// IMP=0x00000000000c2c39
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c2b10
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c29d0
