...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000cc8c0
- (void).cxx_destruct;	// IMP=0x00000000000ccd01
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ccc06
- (id)description;	// IMP=0x00000000000ccb41
- (unsigned long long)hash;	// IMP=0x00000000000ccaf3
- (_Bool)isEqualToEncryptedProvisioningTarget:(id)arg1;	// IMP=0x00000000000ccad9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000cca71
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000cc9d5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000cc8c8
