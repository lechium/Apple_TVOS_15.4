...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000036bc2f
- (void).cxx_destruct;	// IMP=0x000000000036be60
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000036bd5f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000036bc37
- (unsigned long long)hash;	// IMP=0x000000000036bba4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000036baf8
