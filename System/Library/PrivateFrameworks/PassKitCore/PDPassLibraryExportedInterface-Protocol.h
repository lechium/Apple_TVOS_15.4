...
- (void)hasLocallyProvisionedPassForFeatureIdentifier:(unsigned long long)arg1 withHandler:(void (^)(_Bool))arg2;
...
- (void)hasPassesWithFeatureIdentifier:(unsigned long long)arg1 handler:(void (^)(_Bool))arg2;
