...
+ (id)deviceCredentialWithApplet:(id)arg1;	// IMP=0x00000000000eb1e7
- (void).cxx_destruct;	// IMP=0x00000000000eb5c7
...
- (id)description;	// IMP=0x00000000000eb3ba
- (id)initWithType:(unsigned long long)arg1 state:(unsigned long long)arg2 underlyingCredentialState:(id)arg3 address:(id)arg4;	// IMP=0x00000000000eb136
- (id)init;	// IMP=0x00000000000eb128
