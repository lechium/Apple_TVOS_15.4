...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001f6f9
- (void).cxx_destruct;	// IMP=0x000000000002013f
...
- (_Bool)isEqualToPaymentDeviceMetadata:(id)arg1;	// IMP=0x000000000001ff6b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ff03
- (unsigned long long)hash;	// IMP=0x000000000001fdbf
- (id)description;	// IMP=0x000000000001fc24
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001faae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001f9a1
...
- (id)dictionaryRepresentation;	// IMP=0x000000000001f45b
