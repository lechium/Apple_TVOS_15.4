...
- (void).cxx_destruct;	// IMP=0x00000000001d46f2
...
- (id)familyMemberForAltDSID:(id)arg1;	// IMP=0x00000000001d4698
- (id)familyMemberForTransactionSource:(id)arg1;	// IMP=0x00000000001d45b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d4550
- (id)initWithFamilyMembers:(id)arg1;	// IMP=0x00000000001d42ac
