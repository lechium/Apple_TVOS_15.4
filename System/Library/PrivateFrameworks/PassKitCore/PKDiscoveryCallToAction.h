...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a47da
- (void).cxx_destruct;	// IMP=0x00000000000a4d6f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a4940
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a47e2
- (id)description;	// IMP=0x00000000000a45d7
- (unsigned long long)hash;	// IMP=0x00000000000a44de
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a438a
...
- (void)localizeWithBundle:(id)arg1 table:(id)arg2;	// IMP=0x00000000000a3e08
- (void)localizeWithBundle:(id)arg1;	// IMP=0x00000000000a3dec
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000a3a4e
