...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000011953
- (void).cxx_destruct;	// IMP=0x0000000000011c36
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011ac1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001195b
