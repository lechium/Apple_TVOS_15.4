...
- (void).cxx_destruct;	// IMP=0x000000000017fad2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000017f908
- (unsigned long long)hash;	// IMP=0x000000000017f823
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017f676
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017f535
- (void)copyTo:(id)arg1;	// IMP=0x000000000017f444
- (void)writeTo:(id)arg1;	// IMP=0x000000000017f355
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000017f348
- (id)dictionaryRepresentation;	// IMP=0x000000000017ee16
- (id)description;	// IMP=0x000000000017ed67
...
- (int)StringAsStatus:(id)arg1;	// IMP=0x000000000017ec24
- (id)statusAsString:(int)arg1;	// IMP=0x000000000017eb8c
