...
- (void).cxx_destruct;	// IMP=0x000000000031a26c
...
- (id)initWithNonce:(id)arg1 authenticationCredential:(id)arg2 networkMerchantIdentifier:(id)arg3 cryptogramType:(long long)arg4;	// IMP=0x000000000031a130
