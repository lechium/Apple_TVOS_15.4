...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017c646
- (void).cxx_destruct;	// IMP=0x000000000017e052
...
- (long long)numberOfActiveStatementedInstallments;	// IMP=0x000000000017dbad
- (long long)numberOfActiveInstallments;	// IMP=0x000000000017da6d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017d29a
- (id)description;	// IMP=0x000000000017cf30
- (unsigned long long)hash;	// IMP=0x000000000017cdeb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017cc3f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000017ca94
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000017c64e
- (id)virtualCardWithIdentifier:(id)arg1;	// IMP=0x000000000017c40e
- (void)removeVirtualCard:(id)arg1;	// IMP=0x000000000017c140
- (void)addOrUpdateVirtualCard:(id)arg1;	// IMP=0x000000000017bdb9
- (id)installmentPlanWithIdentifier:(id)arg1;	// IMP=0x000000000017bb7e
- (void)ingestExtendedAccountDetails:(id)arg1;	// IMP=0x000000000017b95a
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000017b41f
