...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000030ff41
- (void).cxx_destruct;	// IMP=0x0000000000310d03
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003105a0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003103c7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000030ff49
- (id)description;	// IMP=0x000000000030fcbf
- (unsigned long long)hash;	// IMP=0x000000000030fb68
- (_Bool)isEqualToInstallmentPlan:(id)arg1;	// IMP=0x000000000030f7fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030f794
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000030ec1b
