...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003d027d
+ (id)sanitizedErrors:(id)arg1;	// IMP=0x00000000003cfea6
- (void).cxx_destruct;	// IMP=0x00000000003d02be
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003cfdb5
- (id)init;	// IMP=0x00000000003cfd9a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003cfc64
- (id)initWithStatus:(long long)arg1 errors:(id)arg2;	// IMP=0x00000000003cfbc4
