...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000155900
- (void).cxx_destruct;	// IMP=0x00000000001559cb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001557f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001555d0
- (void)setPrimaryAppleAccount:(id)arg1;	// IMP=0x00000000001555ca
- (unsigned long long)hash;	// IMP=0x000000000015550f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000155401
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001552e0
