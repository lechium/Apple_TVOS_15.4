...
+ (Class)equalityClass;	// IMP=0x0000000000147d98
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000014680a
+ (id)passPropertiesForPass:(id)arg1;	// IMP=0x0000000000146010
- (void).cxx_destruct;	// IMP=0x0000000000148143
...
- (unsigned long long)hash;	// IMP=0x0000000000147af5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001477dc
- (id)_stringForRow:(id)arg1 seat:(id)arg2;	// IMP=0x00000000001476a2
- (_Bool)isInStation;	// IMP=0x000000000014769a
- (id)displayableShinkansenSecondarySeat;	// IMP=0x000000000014766a
- (id)displayableShinkansenSeat;	// IMP=0x0000000000147642
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014736e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000146f60
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000146812
- (id)initWithTransitAppletState:(id)arg1 paymentApplication:(id)arg2 fieldCollection:(id)arg3;	// IMP=0x00000000001460a2
- (id)initWithFelicaAppletState:(id)arg1 paymentApplication:(id)arg2;	// IMP=0x000000000014608d
