...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002f0de5
- (void).cxx_destruct;	// IMP=0x00000000002f13af
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002f10cd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002f0ded
- (id)description;	// IMP=0x00000000002f0abe
- (id)initWithTechnology:(unsigned long long)arg1 terminalType:(long long)arg2 accessTerminalSubtype:(long long)arg3 valueAddedServiceMode:(long long)arg4;	// IMP=0x00000000002f0a50
