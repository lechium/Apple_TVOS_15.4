...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000432ce6
- (void).cxx_destruct;	// IMP=0x0000000000432daf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000432ba6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000432994
- (id)description;	// IMP=0x00000000004328b5
- (id)init;	// IMP=0x0000000000432821
