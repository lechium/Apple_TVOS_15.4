...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004b339
- (void).cxx_destruct;	// IMP=0x000000000004bc29
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004b8c9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004b768
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004b341
- (unsigned long long)hash;	// IMP=0x000000000004b242
- (_Bool)isEqualToTransactionReceipt:(id)arg1;	// IMP=0x000000000004af36
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004aece
- (id)description;	// IMP=0x000000000004ad58
- (void)updateWithBundle:(id)arg1;	// IMP=0x000000000004a621
- (id)initWithFileURL:(id)arg1;	// IMP=0x000000000004a562
