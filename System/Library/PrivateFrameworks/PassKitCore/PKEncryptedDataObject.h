...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000011ee90
- (void).cxx_destruct;	// IMP=0x000000000011f108
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000011efe9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000011ee98
- (id)initWithWebServiceDictionary:(id)arg1;	// IMP=0x000000000011ec5d
- (id)asWebServiceDictionary;	// IMP=0x000000000011eb1c
