...
- (void).cxx_destruct;	// IMP=0x000000000026f9ca
...
- (id)description;	// IMP=0x000000000026f869
...
- (id)initWithPassCredential:(id)arg1 address:(id)arg2 paymentMethod:(unsigned long long)arg3;	// IMP=0x000000000026f6a9
- (id)init;	// IMP=0x000000000026f69b
