...
- (void).cxx_destruct;	// IMP=0x00000000002b5cae
...
- (id)bodyDictionary;	// IMP=0x00000000002b5694
@property(readonly, nonatomic) NSArray *endpointComponents;
- (id)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 rewrapData:(id)arg3 appleAccountInformation:(id)arg4;	// IMP=0x00000000002b5314
