...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000250406
- (void).cxx_destruct;	// IMP=0x0000000000251bef
...
- (id)regionBySettingConsistencyCheckBackoffLevel:(long long)arg1;	// IMP=0x0000000000251a8f
- (id)regionBySettingLastDeviceUpgradeTaskBuildVersion:(id)arg1;	// IMP=0x0000000000251a46
- (id)regionBySettingLastDeviceCheckInBuildVersion:(id)arg1;	// IMP=0x00000000002519fd
- (id)regionBySettingOutstandingCheckInAction:(long long)arg1 lastDeviceCheckInBuildVersion:(id)arg2;	// IMP=0x00000000002519a1
- (id)regionBySettingLastUpdatedTag:(id)arg1;	// IMP=0x0000000000251958
...
- (id)description;	// IMP=0x0000000000251464
@property(readonly, nonatomic) NSURL *inAppPaymentServicesURL; // @synthesize inAppPaymentServicesURL=_inAppPaymentServicesURL;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000251297
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000250fef
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000250a51
- (id)initWithCeritficates:(id)arg1 brokerURL:(id)arg2 trustedServiceManagerURL:(id)arg3 trustedServiceManagerPushTopic:(id)arg4 paymentServicesURL:(id)arg5 inAppPaymentServicesURL:(id)arg6 consistencyCheckBackoffLevel:(long long)arg7 lastUpdatedTag:(id)arg8;	// IMP=0x0000000000250904
- (id)initWithDictionary:(id)arg1 hasPeerPaymentAccount:(_Bool)arg2;	// IMP=0x000000000025040e
