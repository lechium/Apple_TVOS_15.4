...
- (void).cxx_destruct;	// IMP=0x00000000002b2127
...
- (id)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 appleAccountInformation:(id)arg3;	// IMP=0x00000000002b1ef2
- (id)initWithPaymentPass:(id)arg1 updateRequest:(id)arg2;	// IMP=0x00000000002b1e50
