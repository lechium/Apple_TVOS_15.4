...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000014fd43
- (void).cxx_destruct;	// IMP=0x00000000001505ca
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000150178
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000015003c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014fd4b
- (unsigned long long)hash;	// IMP=0x000000000014fc62
- (_Bool)isEqualToInstallmentPlanPayment:(id)arg1;	// IMP=0x000000000014f9f6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014f98e
@property(readonly, nonatomic) NSString *localizedDisplay;
@property(readonly, nonatomic, getter=isPaid) _Bool paid;
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000014f575
