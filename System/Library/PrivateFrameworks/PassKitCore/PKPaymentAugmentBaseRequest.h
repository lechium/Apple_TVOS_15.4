...
- (void).cxx_destruct;	// IMP=0x00000000002b49bb
...
- (id)bodyDictionary;	// IMP=0x00000000002b4754
- (id)endpointComponents;	// IMP=0x00000000002b474c
- (id)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 appleAccountInformation:(id)arg3;	// IMP=0x00000000002b44df
- (id)initWithPaymentPass:(id)arg1;	// IMP=0x00000000002b4471
