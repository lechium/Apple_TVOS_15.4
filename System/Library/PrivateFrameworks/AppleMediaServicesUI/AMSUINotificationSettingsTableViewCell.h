...
- (void).cxx_destruct;	// IMP=0x00000000000289d7
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000002884b
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000285d6
