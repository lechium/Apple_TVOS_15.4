...
- (void).cxx_destruct;	// IMP=0x00000000000732a0
...
- (id)_webPageViewController;	// IMP=0x000000000007309d
- (id)loadPage;	// IMP=0x0000000000073084
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x000000000007306a
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000072ec0
