...
- (void).cxx_destruct;	// IMP=0x000000000006d6f1
...
- (id)loadPage;	// IMP=0x000000000006d650
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x000000000006d5f4
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006d2e5
