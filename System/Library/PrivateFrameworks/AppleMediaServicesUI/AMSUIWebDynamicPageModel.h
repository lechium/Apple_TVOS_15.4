...
- (void).cxx_destruct;	// IMP=0x0000000000052381
...
- (id)loadPage;	// IMP=0x00000000000522b3
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x0000000000052119
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000051d69
