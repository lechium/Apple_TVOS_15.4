...
- (void).cxx_destruct;	// IMP=0x000000000003f364
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x000000000003f176
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x000000000003f04a
- (id)runAction;	// IMP=0x000000000003e962
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000003e0cf
