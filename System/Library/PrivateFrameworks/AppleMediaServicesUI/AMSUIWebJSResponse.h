...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000063908
- (void).cxx_destruct;	// IMP=0x0000000000063bce
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000639df
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000063910
- (id)initWithRequest:(id)arg1 duration:(double)arg2;	// IMP=0x000000000006388e
