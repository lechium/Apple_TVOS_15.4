...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000005cc12
- (void).cxx_destruct;	// IMP=0x000000000005d44d
...
- (void)reset;	// IMP=0x000000000005d289
- (void)pause;	// IMP=0x000000000005d04d
- (void)start;	// IMP=0x000000000005cc9a
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000005cb5b
