...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x000000000007b41e
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x000000000007b2c3
- (void).cxx_destruct;	// IMP=0x000000000007b593
...
- (id)runAction;	// IMP=0x000000000007adc8
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007a588
