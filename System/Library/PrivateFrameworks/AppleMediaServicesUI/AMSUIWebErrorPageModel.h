...
+ (id)_messageFromError:(id)arg1;	// IMP=0x0000000000053707
- (void).cxx_destruct;	// IMP=0x00000000000539fc
...
- (id)loadPage;	// IMP=0x00000000000536ee
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x000000000005367d
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000053284
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000052ffa
