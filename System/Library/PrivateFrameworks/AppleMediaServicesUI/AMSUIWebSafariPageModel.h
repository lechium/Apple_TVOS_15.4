...
- (void).cxx_destruct;	// IMP=0x000000000007397f
...
- (id)loadPage;	// IMP=0x0000000000073836
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x00000000000737c5
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000732fd
