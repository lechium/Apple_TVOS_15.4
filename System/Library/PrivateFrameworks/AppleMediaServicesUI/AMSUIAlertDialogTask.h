...
+ (long long)_keyboardTypeFromType:(long long)arg1;	// IMP=0x0000000000005970
- (void).cxx_destruct;	// IMP=0x00000000000059ac
...
- (id)_createIOSViewControllerFromRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000050d7
- (_Bool)cancel;	// IMP=0x0000000000004f9c
- (id)present;	// IMP=0x0000000000004c21
- (id)initWithRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x0000000000004b7f
