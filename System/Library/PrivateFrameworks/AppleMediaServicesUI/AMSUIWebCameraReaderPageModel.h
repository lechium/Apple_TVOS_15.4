...
- (void).cxx_destruct;	// IMP=0x0000000000047307
...
- (id)loadPage;	// IMP=0x0000000000047192
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x0000000000047121
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000046be7
