...
- (void).cxx_destruct;	// IMP=0x0000000000070c98
...
- (void)_transitionToSnapshot;	// IMP=0x0000000000070a72
- (void)_transitionToLoadingAnimated:(_Bool)arg1;	// IMP=0x0000000000070a21
- (void)_replacePrimaryViewWithView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000070807
- (void)_startReappearTransitionTimerAnimated:(_Bool)arg1;	// IMP=0x0000000000070613
- (void)_applyAppearance;	// IMP=0x00000000000704b3
- (void)willPresentPageModel:(id)arg1 appearance:(id)arg2;	// IMP=0x0000000000070297
- (void)viewWillLayoutSubviews;	// IMP=0x00000000000701ce
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000007016e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000007003d
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000006ffc4
- (void)willAppearAfterDismiss;	// IMP=0x000000000006ffb0
- (void)loadView;	// IMP=0x000000000006fdf1
- (void)dealloc;	// IMP=0x000000000006fd7c
- (void)awaitSnapshotWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000006fcb5
- (id)initWithSnapshot:(id)arg1 context:(id)arg2 appearance:(id)arg3;	// IMP=0x000000000006fa9b
- (id)initWithModel:(id)arg1 context:(id)arg2 appearance:(id)arg3;	// IMP=0x000000000006f9ff
- (id)initWithContext:(id)arg1;	// IMP=0x000000000006f90e
