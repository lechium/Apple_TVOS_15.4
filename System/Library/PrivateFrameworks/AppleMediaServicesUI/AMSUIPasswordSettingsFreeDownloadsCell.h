...
- (void)_toggleChanged:(id)arg1;	// IMP=0x000000000002fceb
- (long long)selectionStyle;	// IMP=0x000000000002fce3
- (void)_setup;	// IMP=0x000000000002fbd5
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000002fb89
