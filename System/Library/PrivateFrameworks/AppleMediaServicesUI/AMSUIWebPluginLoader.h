...
- (id)_loadInstalledPlugins;	// IMP=0x0000000000071e1e
- (id)pluginForBundleIdentifier:(id)arg1;	// IMP=0x0000000000071565
@property(readonly, nonatomic) NSArray *loadedPlugins;
- (id)initWithContext:(id)arg1;	// IMP=0x000000000007146c
