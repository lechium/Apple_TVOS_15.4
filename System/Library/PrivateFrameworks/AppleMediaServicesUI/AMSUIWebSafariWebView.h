...
+ (id)_createContentControllerWithScheme:(id)arg1 data:(id)arg2 messageHandler:(id)arg3;	// IMP=0x0000000000077f6d
- (void).cxx_destruct;	// IMP=0x00000000000785e7
...
- (void)webView:(id)arg1 stopURLSchemeTask:(id)arg2;	// IMP=0x0000000000077db0
- (void)webView:(id)arg1 startURLSchemeTask:(id)arg2;	// IMP=0x00000000000778ac
- (void)userContentController:(id)arg1 didReceiveScriptMessage:(id)arg2 replyHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000077594
@property(nonatomic) double topInset;
- (id)initWithAppearance:(id)arg1 scheme:(id)arg2 data:(id)arg3 delegate:(id)arg4;	// IMP=0x000000000007728c
