...
- (void).cxx_destruct;	// IMP=0x0000000000063ffe
...
- (id)loadPage;	// IMP=0x0000000000063f5d
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewController;	// IMP=0x0000000000063ed0
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000063c61
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000063bf6
