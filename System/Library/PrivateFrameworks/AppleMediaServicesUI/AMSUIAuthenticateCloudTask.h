...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x000000000000848d
- (id)performAuthenticate;	// IMP=0x0000000000007f2f
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x0000000000007e8d
