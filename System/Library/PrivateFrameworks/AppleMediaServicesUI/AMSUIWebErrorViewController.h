...
- (void).cxx_destruct;	// IMP=0x0000000000054d9a
...
- (void)_showCancelButtonIfNeeded;	// IMP=0x000000000005498f
- (void)_applyAppearance;	// IMP=0x0000000000054825
- (void)willPresentPageModel:(id)arg1 appearance:(id)arg2;	// IMP=0x0000000000054619
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000054550
- (void)loadView;	// IMP=0x0000000000053ccf
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000053ad9
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000053a7c
