...
+ (id)exportedInterface;	// IMP=0x000000000001162d
+ (id)serviceViewControllerInterface;	// IMP=0x000000000001160d
- (void).cxx_destruct;	// IMP=0x0000000000011882
@property(nonatomic) __weak id <AMSUIEngagementTaskHostInterface> delegate; // @synthesize delegate=_delegate;
- (void)preferredContentSizeDidChange:(struct CGSize)arg1;	// IMP=0x0000000000011772
- (void)engagementTaskDidFinishWithResult:(id)arg1 error:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000001164d
