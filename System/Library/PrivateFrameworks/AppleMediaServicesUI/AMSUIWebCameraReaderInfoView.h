...
- (void).cxx_destruct;	// IMP=0x0000000000046b94
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x0000000000046a6b
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x00000000000468b2
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x000000000004686d
- (void)layoutSubviews;	// IMP=0x0000000000046355
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004618a
