...
@interface AMSUIWebClientContext : NSObject
{
    ...
    _Bool _signatureResumption;	// 9 = 0x9
...
+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x000000000004b89d
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x000000000004b833
- (void).cxx_destruct;	// IMP=0x000000000004becf
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x000000000004b821
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x000000000004b21b
- (id)loadSnapshot;	// IMP=0x000000000004af2b
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x000000000004a950
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x000000000004a836
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x000000000004a37b
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x000000000004a123
