...
- (void).cxx_destruct;	// IMP=0x00000000000379e3
@property(retain, nonatomic) UIViewController *viewController; // @synthesize viewController=_viewController;
@property(getter=isPresentation) _Bool presentation; // @synthesize presentation=_presentation;
- (void)_animateTransition:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000375b2
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000037509
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000374fb
- (id)_presentedViewControllerForContext:(id)arg1;	// IMP=0x0000000000037446
