...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000197a0
@property(nonatomic, getter=isEnabled) _Bool enabled; // @synthesize enabled=_enabled;
@property(nonatomic, getter=isEditable) _Bool editable; // @synthesize editable=_editable;
- (id)description;	// IMP=0x00000000000199a3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019933
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000198a2
- (id)initWithActions:(id)arg1;	// IMP=0x00000000000197a8
