...
- (void).cxx_destruct;	// IMP=0x000000000000a60e
...
- (id)_modelForFlow:(unsigned long long)arg1;	// IMP=0x000000000000a4a1
- (void)_prepareModelForFlow:(unsigned long long)arg1;	// IMP=0x000000000000a3d9
- (id)initWithFlow:(unsigned long long)arg1;	// IMP=0x000000000000a37f
