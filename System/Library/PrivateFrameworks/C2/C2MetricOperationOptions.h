...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000004f3a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004fc5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000004f42
- (unsigned long long)hash;	// IMP=0x0000000000004ee0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004cb3
