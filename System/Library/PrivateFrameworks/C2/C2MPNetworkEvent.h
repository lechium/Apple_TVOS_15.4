...
+ (Class)networkPathInfoType;	// IMP=0x0000000000007bb2
- (void).cxx_destruct;	// IMP=0x000000000000dc08
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000cfc1
- (unsigned long long)hash;	// IMP=0x000000000000c86d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000be61
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b63a
- (void)copyTo:(id)arg1;	// IMP=0x000000000000aff3
- (void)writeTo:(id)arg1;	// IMP=0x000000000000a901
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000a8f4
- (id)dictionaryRepresentation;	// IMP=0x0000000000008349
- (id)description;	// IMP=0x000000000000829a
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000007b95
- (unsigned long long)networkPathInfosCount;	// IMP=0x0000000000007b78
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x0000000000007b0e
- (void)clearNetworkPathInfos;	// IMP=0x0000000000007af1
