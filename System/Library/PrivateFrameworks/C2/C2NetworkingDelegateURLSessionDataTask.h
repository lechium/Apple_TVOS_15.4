...
- (id)_timingData;	// IMP=0x0000000000018b1f
- (void)cancel;	// IMP=0x0000000000018a8a
- (void)resume;	// IMP=0x00000000000186e1
- (void)handleCompletion;	// IMP=0x0000000000018531
- (void)streamResponseBody:(id)arg1 offset:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001809f
- (void)handleResponse:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000017d5c
- (void)processRequest:(id)arg1 configuration:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000176a6
- (void)setupRequestBodyForRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000017158
- (void)_drainInputStream:(id)arg1 sinkData:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000016c07
- (void)willSendRequest:(CDUnknownBlockType)arg1;	// IMP=0x00000000000168b3
- (void)setupRequest:(CDUnknownBlockType)arg1;	// IMP=0x0000000000016558
- (id)init;	// IMP=0x00000000000164c8
