...
- (void).cxx_destruct;	// IMP=0x0000000000029881
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000029501
- (unsigned long long)hash;	// IMP=0x000000000002935f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000029064
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028e38
- (void)copyTo:(id)arg1;	// IMP=0x0000000000028c81
- (void)writeTo:(id)arg1;	// IMP=0x0000000000028ac5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000028ab8
- (id)dictionaryRepresentation;	// IMP=0x0000000000027f6f
- (id)description;	// IMP=0x0000000000027ec0
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000000027c22
- (id)metricTypeAsString:(int)arg1;	// IMP=0x0000000000027bb6
