...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000020a7a
+ (_Bool)triesteMetricsEnabled;	// IMP=0x000000000001f177
+ (void)initialize;	// IMP=0x000000000001f115
+ (id)stringForDuetPreClearedMode:(unsigned long long)arg1;	// IMP=0x000000000001f0dc
+ (id)stringForDiscretionaryNetworkBehavior:(unsigned long long)arg1;	// IMP=0x000000000001f0a3
+ (id)stringForQualityOfService:(long long)arg1;	// IMP=0x000000000001f045
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000020cd9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000020a82
- (unsigned long long)hash;	// IMP=0x00000000000208fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000201d1
...
- (id)decorateTask:(id)arg1;	// IMP=0x0000000000020070
- (id)copyAndDecorateRequest:(id)arg1;	// IMP=0x000000000001ff13
- (id)sessionConfigurationWithName:(id)arg1;	// IMP=0x000000000001fa96
@property(nonatomic) _Bool allowsCellularAccess; // @synthesize allowsCellularAccess=_allowsCellularAccess;
- (void)setOutOfProcess:(_Bool)arg1;	// IMP=0x000000000001fa72
@property(readonly, nonatomic) _Bool outOfProcess;
- (id)defaultSessionConfigurationWithName:(id)arg1;	// IMP=0x000000000001f858
- (id)sessionConfigurationNameWithRouteHost:(id)arg1;	// IMP=0x000000000001f4fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f2da
- (id)init;	// IMP=0x000000000001f183
