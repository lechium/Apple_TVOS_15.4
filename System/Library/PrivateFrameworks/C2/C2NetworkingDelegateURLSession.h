...
+ (id)sessionWithConfiguration:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x0000000000016171
- (void).cxx_destruct;	// IMP=0x0000000000016483
...
- (void)_useTLSSessionCacheFromSession:(id)arg1;	// IMP=0x00000000000163c6
- (void)invalidateAndCancel;	// IMP=0x00000000000162a1
- (id)dataTaskWithRequest:(id)arg1;	// IMP=0x0000000000016225
