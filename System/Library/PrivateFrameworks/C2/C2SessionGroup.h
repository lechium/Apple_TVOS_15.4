...
- (void).cxx_destruct;	// IMP=0x0000000000010e2d
...
- (_Bool)removeSession:(id)arg1;	// IMP=0x0000000000010d1b
@property(readonly, nonatomic) NSArray *sessions;
- (void)setSession:(id)arg1 forOptions:(id)arg2;	// IMP=0x0000000000010a60
- (id)sessionForOptions:(id)arg1;	// IMP=0x00000000000109a8
- (id)initWithConfigurationName:(id)arg1;	// IMP=0x0000000000010916
