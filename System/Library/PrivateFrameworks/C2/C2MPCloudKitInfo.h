...
+ (Class)clientOperationType;	// IMP=0x0000000000011e03
+ (Class)operationGroupType;	// IMP=0x0000000000011c99
- (void).cxx_destruct;	// IMP=0x0000000000014497
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000013ea9
- (unsigned long long)hash;	// IMP=0x0000000000013ca6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001391a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001341a
- (void)copyTo:(id)arg1;	// IMP=0x00000000000130f9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000012d25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000012d18
- (id)dictionaryRepresentation;	// IMP=0x0000000000011f53
- (id)description;	// IMP=0x0000000000011ea4
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000011de6
- (unsigned long long)clientOperationsCount;	// IMP=0x0000000000011dc9
- (void)addClientOperation:(id)arg1;	// IMP=0x0000000000011d5f
- (void)clearClientOperations;	// IMP=0x0000000000011d42
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000011c7c
- (unsigned long long)operationGroupsCount;	// IMP=0x0000000000011c5f
- (void)addOperationGroup:(id)arg1;	// IMP=0x0000000000011bf5
- (void)clearOperationGroups;	// IMP=0x0000000000011bd8
