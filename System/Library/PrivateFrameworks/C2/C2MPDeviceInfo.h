...
+ (Class)internalTestConfigType;	// IMP=0x000000000002ceae
- (void).cxx_destruct;	// IMP=0x000000000002e5e8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002e214
- (unsigned long long)hash;	// IMP=0x000000000002e0d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002de5d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002db41
- (void)copyTo:(id)arg1;	// IMP=0x000000000002d957
- (void)writeTo:(id)arg1;	// IMP=0x000000000002d719
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002d70c
- (id)dictionaryRepresentation;	// IMP=0x000000000002cf6e
- (id)description;	// IMP=0x000000000002cebf
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002ce91
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000002ce74
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x000000000002ce0a
- (void)clearInternalTestConfigs;	// IMP=0x000000000002cded
