...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003e66
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004077
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003e6e
- (unsigned long long)hash;	// IMP=0x0000000000003d16
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003417
- (_Bool)operationGroupTriggered:(id)arg1;	// IMP=0x000000000000335f
- (_Bool)clientOperationTriggered:(id)arg1;	// IMP=0x00000000000032a7
@property(readonly, nonatomic) NSString *headerValueForTriggers;
- (int)generateTriggerWithResponseHeader:(unsigned char)arg1;	// IMP=0x0000000000002fec
- (id)generateCloudKitInfo;	// IMP=0x00000000000029ce
- (void)rollReportFrequencyRandomValue;	// IMP=0x0000000000002927
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000257c
- (id)init;	// IMP=0x000000000000245e
