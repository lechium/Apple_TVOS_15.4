...
- (void).cxx_destruct;	// IMP=0x000000000006c725
...
- (void)setView:(id)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006c360
- (id)viewForContentType:(long long)arg1;	// IMP=0x000000000006c2e0
- (void)setPreferredSize:(struct CGSize)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006bf68
- (struct CGSize)preferredSizeForContentType:(long long)arg1;	// IMP=0x000000000006beb5
- (id)_keyForContentType:(long long)arg1;	// IMP=0x000000000006be9c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006be58
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006b66e
