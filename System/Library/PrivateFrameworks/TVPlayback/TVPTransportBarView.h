...
- (void).cxx_destruct;	// IMP=0x00000000000493ce
...
- (void)_updateUserInteractionEnabled;	// IMP=0x0000000000049181
- (void)setLabelAlpha:(double)arg1;	// IMP=0x0000000000049132
...
- (id)createProgressBarView;	// IMP=0x0000000000048e8e
- (double)dimmingAlpha;	// IMP=0x0000000000048e80
- (void)setInteractionMode:(long long)arg1;	// IMP=0x000000000004883c
...
- (struct CGRect)playerHeadFrameForRect:(struct CGRect)arg1;	// IMP=0x00000000000477b5
- (void)layoutSubviews;	// IMP=0x0000000000046b56
- (void)updateProgressBarPlayheadLocations;	// IMP=0x000000000004697d
- (id)timeFont;	// IMP=0x0000000000046772
@property(nonatomic) _Bool dimsWithGradient;
@property(nonatomic) _Bool dimsEntireBounds;
- (id)initWithPlayer:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000000045573
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004555f
