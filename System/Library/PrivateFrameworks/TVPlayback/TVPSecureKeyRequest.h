...
- (void).cxx_destruct;	// IMP=0x0000000000007eab
...
- (void)finishLoadingWithResponseData:(id)arg1 renewalDate:(id)arg2 keyType:(long long)arg3;	// IMP=0x0000000000007bb6
- (id)offlineKeyDataForResponseData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000007b22
- (void)loadKeyRequestDataAsynchronouslyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000756b
- (_Bool)loadKeyRequestDataWithError:(id *)arg1;	// IMP=0x00000000000073a4
- (id)initWithAssetResourceLoadingRequest:(id)arg1;	// IMP=0x00000000000072d0
