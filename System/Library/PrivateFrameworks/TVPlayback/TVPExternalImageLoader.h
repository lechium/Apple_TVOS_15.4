...
- (void).cxx_destruct;	// IMP=0x000000000002aa44
...
- (id)_closestURLForImageTime:(double)arg1 actualTime:(double *)arg2;	// IMP=0x000000000002a797
- (unsigned long long)_closestImageIndexForTime:(double)arg1 actualTime:(double *)arg2 imageInterval:(double)arg3;	// IMP=0x000000000002a60c
- (id)loadedImageForTime:(double)arg1;	// IMP=0x000000000002a28d
- (_Bool)imageIsLoadedForTime:(double)arg1;	// IMP=0x000000000002a100
@property(readonly, nonatomic) double lastImageTime;
@property(readonly, nonatomic) double firstImageTime;
- (void)cancelImageLoadingForIdentifiers:(id)arg1;	// IMP=0x0000000000029dbf
- (id)loadImagesForTimes:(id)arg1 maxSize:(struct CGSize)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000292d0
- (double)closestImageTimeForTime:(double)arg1 imageInterval:(double)arg2;	// IMP=0x00000000000292a4
- (double)closestImageTimeForTime:(double)arg1;	// IMP=0x0000000000029236
- (void)invalidate;	// IMP=0x0000000000029088
- (id)initWithConfig:(id)arg1;	// IMP=0x0000000000028f10
