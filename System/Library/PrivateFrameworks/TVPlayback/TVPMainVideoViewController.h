...
- (void)viewDidLoad;	// IMP=0x000000000000aacd
- (void)loadView;	// IMP=0x000000000000a9f6
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000a8d5
- (void)_addPlaybackView:(id)arg1;	// IMP=0x000000000000a675
- (void)_handleSelectButton:(id)arg1;	// IMP=0x000000000000a565
- (void)_didSelect;	// IMP=0x000000000000a508
- (void)preserveVideoViewForReuse;	// IMP=0x000000000000a361
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000000a2ef
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000a2c4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000a299
