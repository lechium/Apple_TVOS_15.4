...
- (void).cxx_destruct;	// IMP=0x000000000001d229
...
- (id)nearestChapterForDate:(id)arg1;	// IMP=0x000000000001cd88
- (id)chapterForDate:(id)arg1;	// IMP=0x000000000001cbb5
- (id)nearestChapterForTime:(double)arg1;	// IMP=0x000000000001c874
- (id)chapterForTime:(double)arg1;	// IMP=0x000000000001c6c1
- (id)init;	// IMP=0x000000000001c689
