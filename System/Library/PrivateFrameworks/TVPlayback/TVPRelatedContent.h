...
{
    UIViewController *_detailViewController;	// 8 = 0x8
    UIViewController *_optionsViewController;	// 16 = 0x10
    NSNumber *_durationUntilPlaybackWillAdvance;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x00000000000a5cee
