...
- (void).cxx_destruct;	// IMP=0x00000000000f0e28
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000f0c1e
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000f0b38
- (void)cancelScrub;	// IMP=0x00000000000f0b06
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000f0a26
