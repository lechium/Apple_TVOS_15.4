...
+ (void)initialize;	// IMP=0x0000000000015a72
- (void).cxx_destruct;	// IMP=0x0000000000015d83
...
- (_Bool)isFinished;	// IMP=0x0000000000015c25
- (double)currentPlaybackTime;	// IMP=0x0000000000015ac2
