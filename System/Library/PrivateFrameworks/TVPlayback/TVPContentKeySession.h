...
+ (void)initialize;	// IMP=0x000000000009f05b
- (void).cxx_destruct;	// IMP=0x000000000009fbec
...
- (void)_loadAVContentKeyRequests:(id)arg1 type:(long long)arg2 isRenewal:(_Bool)arg3;	// IMP=0x000000000009f887
- (void)contentKeySession:(id)arg1 didProvideRenewingContentKeyRequest:(id)arg2;	// IMP=0x000000000009f7d0
- (void)contentKeySession:(id)arg1 didProvideContentKeyRequest:(id)arg2;	// IMP=0x000000000009f71c
- (void)finishKeyRequest:(id)arg1;	// IMP=0x000000000009f1e5
- (id)initWithContentKeyLoader:(id)arg1 avAsset:(id)arg2;	// IMP=0x000000000009f0c1
- (id)init;	// IMP=0x000000000009f0ab
