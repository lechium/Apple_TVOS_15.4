...
- (void).cxx_destruct;	// IMP=0x000000000002144e
...
- (unsigned long long)hash;	// IMP=0x00000000000213b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002132e
- (id)description;	// IMP=0x00000000000212f3
