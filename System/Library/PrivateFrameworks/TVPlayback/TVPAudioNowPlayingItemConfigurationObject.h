...
- (void).cxx_destruct;	// IMP=0x00000000000939b2
...
- (_Bool)_isStringEqual:(id)arg1 rhsString:(id)arg2;	// IMP=0x0000000000093807
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000093380
