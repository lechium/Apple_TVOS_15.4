...
- (void).cxx_destruct;	// IMP=0x000000000009da9d
...
- (id)_typeDescription;	// IMP=0x000000000009da0e
- (id)description;	// IMP=0x000000000009d97c
- (id)initWithType:(unsigned long long)arg1 start:(double)arg2 duration:(double)arg3;	// IMP=0x000000000009d921
