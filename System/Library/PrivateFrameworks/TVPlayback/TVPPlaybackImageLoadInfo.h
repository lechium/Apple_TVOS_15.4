...
- (void).cxx_destruct;	// IMP=0x000000000009e5d5
...
- (void)callCompletionHandlerWithImage:(id)arg1 actualCMTime:(CDStruct_1b6d18a9)arg2 actualDate:(id)arg3;	// IMP=0x000000000009e395
- (id)description;	// IMP=0x000000000009e2de
