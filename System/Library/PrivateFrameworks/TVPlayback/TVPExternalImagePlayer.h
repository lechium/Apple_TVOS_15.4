...
- (void).cxx_destruct;	// IMP=0x000000000004536a
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x000000000004514c
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x0000000000045078
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x0000000000044e47
- (void)_cancelAllImageLoads;	// IMP=0x0000000000044db3
- (void)_loadImagesIfNecessary;	// IMP=0x00000000000442b4
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x0000000000043ea8
- (void)invalidate;	// IMP=0x0000000000043e93
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000043aa6
