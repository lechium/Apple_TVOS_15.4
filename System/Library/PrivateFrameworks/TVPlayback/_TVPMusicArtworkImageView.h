...
- (void).cxx_destruct;	// IMP=0x000000000008de9d
...
- (void)_updatePlaceholderImageIfNeeded;	// IMP=0x000000000008dd79
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000008dcd1
- (void)didMoveToWindow;	// IMP=0x000000000008dc63
- (_Bool)canBecomeFocused;	// IMP=0x000000000008dc31
