...
+ (void)initialize;	// IMP=0x00000000000062b4
...
- (void)finishByRequestingOfflineKeysIfPossible;	// IMP=0x0000000000006948
- (void)finish;	// IMP=0x00000000000068fc
- (id)offlineKeyDataFromServerKeyData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000006813
- (void)makeKeyRequestDataForCertificateData:(id)arg1 assetIDData:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000660b
- (id)description;	// IMP=0x0000000000006549
@property(readonly, nonatomic) _Bool isCancelled;
- (id)initWithAVContentKeyRequest:(id)arg1;	// IMP=0x0000000000006304
