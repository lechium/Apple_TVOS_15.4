...
- (void).cxx_destruct;	// IMP=0x00000000000e8bd9
...
- (void)selectMediaOption:(id)arg1 inMediaSelectionGroup:(id)arg2;	// IMP=0x00000000000e8806
- (void)selectMediaOptionAutomaticallyInMediaSelectionGroup:(id)arg1;	// IMP=0x00000000000e86e6
- (void)dealloc;	// IMP=0x00000000000e869d
- (id)initWithAsset:(id)arg1;	// IMP=0x00000000000e865e
