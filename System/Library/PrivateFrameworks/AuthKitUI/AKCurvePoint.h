...
+ (id)pointWithX:(double)arg1 y:(double)arg2;	// IMP=0x0000000000001d2a
+ (id)pointWithCGPoint:(struct CGPoint)arg1;	// IMP=0x0000000000001d18
...
- (id)initWithX:(double)arg1 y:(double)arg2;	// IMP=0x0000000000001d6f
