...
- (void).cxx_destruct;	// IMP=0x0000000000002966
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000027e0
- (unsigned long long)hash;	// IMP=0x000000000000271b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000025b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000024b0
- (void)copyTo:(id)arg1;	// IMP=0x00000000000023e8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000002321
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002314
- (id)dictionaryRepresentation;	// IMP=0x0000000000001e05
- (id)description;	// IMP=0x0000000000001d56
