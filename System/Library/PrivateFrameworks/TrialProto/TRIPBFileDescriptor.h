...
- (void)dealloc;	// IMP=0x0000000000019c80
- (id)initWithPackage:(id)arg1 syntax:(unsigned char)arg2;	// IMP=0x0000000000019c1e
- (id)initWithPackage:(id)arg1 objcPrefix:(id)arg2 syntax:(unsigned char)arg3;	// IMP=0x0000000000019b9d
