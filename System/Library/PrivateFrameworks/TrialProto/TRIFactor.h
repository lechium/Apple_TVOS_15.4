...
+ (id)descriptor;	// IMP=0x000000000001b96e
- (_Bool)isInNamespaceName:(id)arg1;	// IMP=0x0000000000058d41
- (id)namespaceString;	// IMP=0x0000000000058cad
- (_Bool)hasNamespace;	// IMP=0x0000000000058c74
- (id)typeString;	// IMP=0x0000000000058b24
