...
- (void)dealloc;	// IMP=0x000000000001a5a5
- (id)initWithFieldDescription:(void *)arg1 includesDefault:(_Bool)arg2 syntax:(unsigned char)arg3;	// IMP=0x000000000001a39f
- (id)init;	// IMP=0x000000000001a351
