...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002e422
- (unsigned long long)hash;	// IMP=0x000000000002e36f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002e25f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002e162
- (void)copyTo:(id)arg1;	// IMP=0x000000000002e0b2
- (void)writeTo:(id)arg1;	// IMP=0x000000000002dfed
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002dfe0
- (id)dictionaryRepresentation;	// IMP=0x000000000002daff
- (id)description;	// IMP=0x000000000002da88
...
- (void)dealloc;	// IMP=0x000000000002d92c
