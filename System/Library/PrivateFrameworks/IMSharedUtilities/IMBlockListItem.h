...
- (_Bool)isEqualToBlockListItem:(id)arg1;	// IMP=0x0000000000008076
- (id)formattedAddress;	// IMP=0x0000000000008020
- (id)formattedHandle;	// IMP=0x0000000000007efd
- (id)fullName;	// IMP=0x0000000000007ea5
- (void)lookupPerson;	// IMP=0x0000000000007e5e
- (void)dealloc;	// IMP=0x0000000000007e1f
@property(readonly, nonatomic) CNContact *cnPerson;
- (id)initWithCNContact:(id)arg1 address:(id)arg2 cmfItemRef:(void *)arg3;	// IMP=0x0000000000007db6
- (id)initWithPerson:(id)arg1 address:(id)arg2 cmfItemRef:(void *)arg3;	// IMP=0x0000000000007d41
