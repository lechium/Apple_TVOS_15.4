...
+ (id)guidByStrippingAuxPrefix:(id)arg1;	// IMP=0x0000000000078cf2
+ (id)AuxGUIDFromFileTransferGUID:(id)arg1;	// IMP=0x0000000000078cc2
+ (id)guidForFileTransferDictionary:(id)arg1;	// IMP=0x000000000007819b
+ (id)whitelistedKeys;	// IMP=0x0000000000077f4f
+ (_Bool)_doesLocalURLRequireArchiving:(id)arg1;	// IMP=0x0000000000076897
...
- (void)setMimeType:(id)arg1;	// IMP=0x0000000000079502
- (void)_swizzleTransferStateIfMissingAttachmentCanBeDownloadedFromCloudKit;	// IMP=0x000000000007949f
- (_Bool)_missingAttachmentCanBeDownloadedFromCloudKit;	// IMP=0x000000000007943c
- (_Bool)_isCloudKitEnabled;	// IMP=0x000000000007941c
- (id)_auxVideoPathIfItExists;	// IMP=0x0000000000079346
- (id)createAndPersistLivePhotoBundleIfNecessary;	// IMP=0x0000000000078d2f
- (id)description;	// IMP=0x0000000000078a74
...
- (void)_calculateTypeInformation;	// IMP=0x00000000000782dd
@property(nonatomic) NSDate *refreshDate;
- (id)_dictionaryToSend;	// IMP=0x000000000007809f
- (void)_updateWithDictionaryRepresentationForWhitelistedKeys:(id)arg1;	// IMP=0x0000000000078008
- (id)_dictionaryRepresentation;	// IMP=0x0000000000077928
- (_Bool)_updateWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000000770b6
- (void)_clear;	// IMP=0x0000000000076f4d
- (void)_setDirectory:(_Bool)arg1 hfsType:(unsigned int)arg2 hfsCreator:(unsigned int)arg3 hfsFlags:(unsigned short)arg4;	// IMP=0x0000000000076f38
- (void)_setAveragedTransferRate:(unsigned long long)arg1 lastAveragedInterval:(double)arg2 lastAveragedBytes:(unsigned long long)arg3;	// IMP=0x0000000000076f22
- (void)_setCurrentBytes:(unsigned long long)arg1 totalBytes:(unsigned long long)arg2;	// IMP=0x0000000000076ee5
- (void)_setAccount:(id)arg1 otherPerson:(id)arg2;	// IMP=0x0000000000076e35
- (id)_initWithGUID:(id)arg1 filename:(id)arg2 isDirectory:(_Bool)arg3 localURL:(id)arg4 account:(id)arg5 otherPerson:(id)arg6 totalBytes:(unsigned long long)arg7 hfsType:(unsigned int)arg8 hfsCreator:(unsigned int)arg9 hfsFlags:(unsigned short)arg10 isIncoming:(_Bool)arg11;	// IMP=0x0000000000076ca5
- (id)init;	// IMP=0x0000000000076c4d
- (void)dealloc;	// IMP=0x0000000000076814
