...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000054b2b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000054e2b
- (id)copyDictionaryRepresentation;	// IMP=0x0000000000054d2a
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000054c20
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000054b33
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000549f3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005491c
- (id)description;	// IMP=0x00000000000548ae
- (void)dealloc;	// IMP=0x000000000005483a
