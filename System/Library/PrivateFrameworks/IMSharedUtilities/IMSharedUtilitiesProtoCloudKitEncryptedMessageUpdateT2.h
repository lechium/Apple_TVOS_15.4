...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000005472e
- (unsigned long long)hash;	// IMP=0x0000000000054697
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005459d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000544b4
- (void)copyTo:(id)arg1;	// IMP=0x000000000005441e
- (void)writeTo:(id)arg1;	// IMP=0x000000000005438d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000054380
- (id)dictionaryRepresentation;	// IMP=0x0000000000053fc9
- (id)description;	// IMP=0x0000000000053f52
...
- (void)dealloc;	// IMP=0x0000000000053e68
