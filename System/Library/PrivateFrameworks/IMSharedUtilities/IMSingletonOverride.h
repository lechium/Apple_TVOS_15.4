...
- (void).cxx_destruct;	// IMP=0x0000000000061e1f
@property __weak id overriddenSingleton; // @synthesize overriddenSingleton=_overriddenSingleton;
- (_Bool)shouldInvokeSelector:(SEL)arg1 onSingleton:(id)arg2;	// IMP=0x0000000000061df0
- (void)didOverrideSingleton:(id)arg1;	// IMP=0x0000000000061dde
