...
+ (id)newMessageItemFrom:(id)arg1 withText:(id)arg2 deleteSubject:(_Bool)arg3 withFileTransferGUIDs:(id)arg4;	// IMP=0x000000000002bcbb
+ (id)_messageItemWithIndexesDeleted:(id)arg1 subRangesToDeleteMapping:(id)arg2 deleteSubject:(_Bool)arg3 deleteTransferCallback:(CDUnknownBlockType)arg4 createItemCallback:(CDUnknownBlockType)arg5 fromMessageItem:(id)arg6;	// IMP=0x000000000002b49c
+ (_Bool)messageContainsSurfDD:(id)arg1;	// IMP=0x0000000000027bac
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000027ba4
+ (unsigned long long)partKeyForAttachmentGUID:(id)arg1 inBody:(id)arg2;	// IMP=0x0000000000026f3f
...
- (id)fileTransferGUIDs;	// IMP=0x000000000002c11d
...
- (_Bool)isReply;	// IMP=0x000000000002b448
- (id)_localizedBackwardsCompatibleExpressiveSendText;	// IMP=0x000000000002b15c
- (_Bool)isLastMessageCandidate;	// IMP=0x000000000002b154
- (_Bool)isFirstMessageCandidate;	// IMP=0x000000000002b14c
- (id)description;	// IMP=0x000000000002aabd
@property(readonly, copy, nonatomic) NSAttributedString *breadcrumbText;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002a28f
@property(retain, nonatomic) NSAttributedString *body; // @synthesize body=_body;
- (void)_clearBodyData;	// IMP=0x000000000002a11a
- (void)_regenerateBodyData;	// IMP=0x000000000002a03d
- (void)_regenerateBodyText;	// IMP=0x0000000000029f47
- (void)_generateBodyTextIfNeeded;	// IMP=0x0000000000029f09
- (void)_generateBodyDataIfNeeded;	// IMP=0x0000000000029ed9
- (void)adjustIsEmptyFlag;	// IMP=0x0000000000029dcd
- (void)_updateFlags:(unsigned long long)arg1;	// IMP=0x0000000000029d95
- (void)setFileTransferGUIDs:(id)arg1;	// IMP=0x0000000000029d3d
- (unsigned long long)getCMMAssetOffset;	// IMP=0x0000000000029cff
- (void)setCMMAssetOffset:(unsigned long long)arg1;	// IMP=0x0000000000029c55
- (void)setCMMState:(unsigned long long)arg1;	// IMP=0x0000000000029bab
- (unsigned long long)getCMMState;	// IMP=0x0000000000029b6d
- (void)setCMMStateToRegisteredAndAssetOffsetTo:(unsigned long long)arg1;	// IMP=0x0000000000029a8d
- (void)setWasDataDetected:(_Bool)arg1;	// IMP=0x0000000000029a68
...
- (_Bool)isFromMe;	// IMP=0x0000000000029799
...
- (id)sender;	// IMP=0x00000000000296cb
- (void)dealloc;	// IMP=0x0000000000029515
- (id)initWithSenderInfo:(id)arg1 time:(id)arg2 timeRead:(id)arg3 timeDelivered:(id)arg4 timePlayed:(id)arg5 subject:(id)arg6 body:(id)arg7 bodyData:(id)arg8 attributes:(id)arg9 fileTransferGUIDs:(id)arg10 flags:(unsigned long long)arg11 guid:(id)arg12 messageID:(long long)arg13 account:(id)arg14 accountID:(id)arg15 service:(id)arg16 handle:(id)arg17 roomName:(id)arg18 unformattedID:(id)arg19 countryCode:(id)arg20 expireState:(long long)arg21 balloonBundleID:(id)arg22 payloadData:(id)arg23 expressiveSendStyleID:(id)arg24 timeExpressiveSendPlayed:(id)arg25 bizIntent:(id)arg26 locale:(id)arg27 errorType:(unsigned int)arg28 type:(long long)arg29 threadIdentifier:(id)arg30 syndicationRanges:(id)arg31 syncedSyndicationRanges:(id)arg32;	// IMP=0x00000000000292dd
- (id)initWithSenderInfo:(id)arg1 time:(id)arg2 timeRead:(id)arg3 timeDelivered:(id)arg4 timePlayed:(id)arg5 subject:(id)arg6 body:(id)arg7 bodyData:(id)arg8 attributes:(id)arg9 fileTransferGUIDs:(id)arg10 flags:(unsigned long long)arg11 guid:(id)arg12 messageID:(long long)arg13 account:(id)arg14 accountID:(id)arg15 service:(id)arg16 handle:(id)arg17 roomName:(id)arg18 unformattedID:(id)arg19 countryCode:(id)arg20 expireState:(long long)arg21 balloonBundleID:(id)arg22 payloadData:(id)arg23 expressiveSendStyleID:(id)arg24 timeExpressiveSendPlayed:(id)arg25 bizIntent:(id)arg26 locale:(id)arg27 errorType:(unsigned int)arg28 threadIdentifier:(id)arg29 syndicationRanges:(id)arg30 syncedSyndicationRanges:(id)arg31;	// IMP=0x00000000000291f5
- (id)initWithSenderInfo:(id)arg1 time:(id)arg2 guid:(id)arg3 messageID:(long long)arg4 account:(id)arg5 accountID:(id)arg6 service:(id)arg7 handle:(id)arg8 roomName:(id)arg9 unformattedID:(id)arg10 countryCode:(id)arg11;	// IMP=0x0000000000029148
- (id)initWithSender:(id)arg1 time:(id)arg2 guid:(id)arg3 type:(long long)arg4;	// IMP=0x0000000000029072
- (id)initWithSender:(id)arg1 time:(id)arg2 body:(id)arg3 attributes:(id)arg4 fileTransferGUIDs:(id)arg5 flags:(unsigned long long)arg6 error:(id)arg7 guid:(id)arg8 type:(long long)arg9 threadIdentifier:(id)arg10;	// IMP=0x0000000000028f52
- (id)initWithSender:(id)arg1 time:(id)arg2 body:(id)arg3 attributes:(id)arg4 fileTransferGUIDs:(id)arg5 flags:(unsigned long long)arg6 error:(id)arg7 guid:(id)arg8 threadIdentifier:(id)arg9;	// IMP=0x0000000000028f14
- (id)copyDictionaryRepresentation;	// IMP=0x0000000000028768
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000028754
- (id)initWithDictionary:(id)arg1 hint:(id)arg2;	// IMP=0x000000000002817a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000027d0b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002753b
- (id)attachmentGUIDAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000027351
- (void)enumerateAttachmentGUIDsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000027184
- (unsigned long long)partKeyForAttachmentGUID:(id)arg1;	// IMP=0x0000000000026ef5
- (id)copyForBackwardsCompatibility;	// IMP=0x0000000000026d08
- (id)copyWithFlags:(unsigned long long)arg1;	// IMP=0x0000000000026cc9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000268c7
@property(readonly, copy, nonatomic) NSArray *messageParts;
- (unsigned long long)powerLogMessageType;	// IMP=0x000000000007aaf5
