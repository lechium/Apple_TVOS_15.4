...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000013924
- (unsigned long long)hash;	// IMP=0x000000000001369f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000132f9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013023
- (void)copyTo:(id)arg1;	// IMP=0x0000000000012ddf
- (void)writeTo:(id)arg1;	// IMP=0x0000000000012b89
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000012b7c
- (id)dictionaryRepresentation;	// IMP=0x0000000000011ece
- (id)description;	// IMP=0x0000000000011e57
...
- (void)dealloc;	// IMP=0x0000000000011a34
