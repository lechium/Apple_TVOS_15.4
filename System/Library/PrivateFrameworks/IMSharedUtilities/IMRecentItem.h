...
- (id)asJSONObject;	// IMP=0x0000000000037439
- (unsigned long long)hash;	// IMP=0x000000000003740e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000037391
- (id)initWithGUID:(id)arg1 data:(id)arg2 messageItemInfo:(id)arg3;	// IMP=0x000000000003729c
- (void)dealloc;	// IMP=0x0000000000037236
