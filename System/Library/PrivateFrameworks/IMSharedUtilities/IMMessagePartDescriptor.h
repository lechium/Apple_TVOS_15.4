...
- (void).cxx_destruct;	// IMP=0x00000000000556b2
...
- (id)messagePartGUIDForMessageGUID:(id)arg1;	// IMP=0x00000000000555fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000551e5
- (id)initWithMessagePartBody:(id)arg1 messagePartIndex:(unsigned long long)arg2 messagePartRange:(struct _NSRange)arg3 transferGUID:(id)arg4 links:(id)arg5 mapLocations:(id)arg6;	// IMP=0x00000000000550c9
