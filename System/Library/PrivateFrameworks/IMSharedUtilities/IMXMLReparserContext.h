...
- (void)_setOutContent:(id)arg1 error:(id)arg2;	// IMP=0x000000000006c9d1
- (void)dealloc;	// IMP=0x000000000006c972
- (id)initWithContent:(id)arg1 attributesToPreserve:(id)arg2 attributesToMerge:(id)arg3;	// IMP=0x000000000006c8f8
