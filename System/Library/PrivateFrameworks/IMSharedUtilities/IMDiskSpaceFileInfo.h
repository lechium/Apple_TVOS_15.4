...
- (void).cxx_destruct;	// IMP=0x0000000000040180
...
- (void)log;	// IMP=0x000000000004007b
- (id)logString;	// IMP=0x000000000003ff70
- (void)addLogItems:(id)arg1;	// IMP=0x000000000003fc94
- (id)initWithPath:(id)arg1 fileSize:(struct IMFileSize)arg2 isDirectory:(_Bool)arg3 isAttachment:(_Bool)arg4 isSticker:(_Bool)arg5 isPurgableOnDisk:(_Bool)arg6;	// IMP=0x000000000003fb9a
