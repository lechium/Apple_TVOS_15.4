...
+ (id)itemAtPath:(id)arg1 enclosedFilename:(id)arg2 extensionID:(id)arg3;	// IMP=0x000000000006c0a6
- (void).cxx_destruct;	// IMP=0x000000000006c4c0
...
- (id)description;	// IMP=0x000000000006c311
- (id)publicDescription;	// IMP=0x000000000006c24a
- (id)promiseFilename;	// IMP=0x000000000006c238
