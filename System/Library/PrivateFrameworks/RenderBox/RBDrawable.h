...
- (id).cxx_construct;	// IMP=0x0000000000025a36
- (void).cxx_destruct;	// IMP=0x00000000000259f3
...
- (void)_RBDrawableStatisticsDidChange;	// IMP=0x00000000000258e9
@property(copy, nonatomic) CDUnknownBlockType statisticsHandler;
@property(readonly, copy, nonatomic) NSDictionary *statistics;
- (void)resetStatistics:(unsigned long long)arg1 alpha:(double)arg2;	// IMP=0x00000000000257f6
@property(readonly, nonatomic) double GPUDuration;
- (void)dumpTexture:(id)arg1 name:(id)arg2;	// IMP=0x00000000000255e5
- (void)finish;	// IMP=0x00000000000255d7
- (void)renderDisplayList:(id)arg1 flags:(unsigned int)arg2;	// IMP=0x0000000000024c43
...
- (void)dealloc;	// IMP=0x0000000000024b96
- (id)initWithDevice:(id)arg1;	// IMP=0x0000000000024acc
