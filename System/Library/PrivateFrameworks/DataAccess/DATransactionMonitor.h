...
+ (id)sharedTransactionMonitor;	// IMP=0x000000000000bdf7
...
- (void)decrementTransactionCountForTransaction:(id)arg1;	// IMP=0x000000000000c188
- (void)incrementTransactionCountForTransaction:(id)arg1;	// IMP=0x000000000000bf21
- (id)init;	// IMP=0x000000000000be4c
