...
- (void).cxx_destruct;	// IMP=0x000000000001b676
...
- (id)description;	// IMP=0x000000000001b52c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b3a2
- (unsigned long long)hash;	// IMP=0x000000000001b2ef
- (id)initRequestForBodyFormat:(int)arg1 withFolderID:(id)arg2 withServerID:(id)arg3 withLongID:(id)arg4 withBodySizeLimit:(int)arg5;	// IMP=0x000000000001b1ba
- (id)initRequestForBodyFormat:(int)arg1 withLongID:(id)arg2 withBodySizeLimit:(int)arg3;	// IMP=0x000000000001b0ff
