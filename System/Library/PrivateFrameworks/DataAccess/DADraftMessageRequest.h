...
- (void).cxx_destruct;	// IMP=0x000000000001c374
...
- (id)description;	// IMP=0x000000000001c25e
- (id)initWithRequestType:(int)arg1 message:(id)arg2 send:(_Bool)arg3;	// IMP=0x000000000001c1bf
