...
+ (id)protocolMessageWithProtobufData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000196d15
+ (unsigned long long)currentProtocolVersion;	// IMP=0x0000000000196d0a
- (void).cxx_destruct;	// IMP=0x0000000000198edc
...
- (_Bool)replyWithMessage:(id)arg1;	// IMP=0x0000000000198254
- (_Bool)reply;	// IMP=0x0000000000198240
...
- (void)dealloc;	// IMP=0x0000000000197eb8
- (id)initWithUnderlyingCodableMessage:(id)arg1 error:(id)arg2;	// IMP=0x0000000000197e30
- (id)init;	// IMP=0x0000000000197d9c
