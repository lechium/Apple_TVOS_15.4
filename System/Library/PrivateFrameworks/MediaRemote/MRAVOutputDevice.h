...
+ (id)localDeviceLocalizedName;	// IMP=0x0000000000043664
+ (id)localDeviceUID;	// IMP=0x0000000000043657
- (void).cxx_destruct;	// IMP=0x0000000000046646
...
- (_Bool)containsUID:(id)arg1;	// IMP=0x0000000000045f5f
...
- (unsigned long long)hash;	// IMP=0x000000000004487e
- (_Bool)isEqualToOutputDevice:(id)arg1;	// IMP=0x000000000004474c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004460d
- (id)description;	// IMP=0x0000000000043e97
