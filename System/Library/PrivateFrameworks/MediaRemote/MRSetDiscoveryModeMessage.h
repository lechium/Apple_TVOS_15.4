...
- (void).cxx_destruct;	// IMP=0x00000000000a492b
...
- (unsigned long long)type;	// IMP=0x00000000000a48ff
- (id)initWithMode:(unsigned int)arg1 features:(unsigned int)arg2;	// IMP=0x00000000000a489c
- (id)initWithMode:(unsigned int)arg1 configuration:(id)arg2;	// IMP=0x00000000000a479e
- (id)initWithUnderlyingCodableMessage:(id)arg1 error:(id)arg2;	// IMP=0x00000000000a467c
