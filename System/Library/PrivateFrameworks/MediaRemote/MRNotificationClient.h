...
+ (id)nowPlayingNotifications;	// IMP=0x000000000013dc26
- (void).cxx_destruct;	// IMP=0x000000000013dddb
...
- (_Bool)_postNotification:(id)arg1 userInfo:(id)arg2 object:(id)arg3 withHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000013d78a
- (_Bool)postNotification:(id)arg1 userInfo:(id)arg2 object:(id)arg3;	// IMP=0x000000000013d683
- (void)dispatchNotification:(id)arg1 userInfo:(id)arg2 object:(id)arg3;	// IMP=0x000000000013d567
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *notificationQueue;
- (void)restoreNowPlayingClientState;	// IMP=0x000000000013d3d2
- (void)_syncWakingPlayerPathsWithReplyQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000013d328
- (void)unregisterForWakingNowPlayingNotificationsForPlayerPath:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000013cdc1
- (void)registerForWakingNowPlayingNotificationsForPlayerPath:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000013c85e
- (_Bool)_processAlwaysNeedsNowPlayingNotifications;	// IMP=0x000000000013c791
@property(readonly, nonatomic, getter=isRegisteredForNowPlayingNotifications) _Bool registeredForNowPlayingNotifications;
- (void)unregisterForNowPlayingNotifications;	// IMP=0x000000000013c5b8
- (void)registerForNowPlayingNotificationsWithQueue:(id)arg1 force:(_Bool)arg2;	// IMP=0x000000000013c3ff
- (void)registerForNowPlayingNotificationsWithQueue:(id)arg1;	// IMP=0x000000000013c3eb
- (id)debugDescription;	// IMP=0x000000000013c1ee
- (id)init;	// IMP=0x000000000013ba1d
