...
- (void).cxx_destruct;	// IMP=0x0000000000024f8a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000024d06
- (unsigned long long)hash;	// IMP=0x0000000000024bbb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000024987
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000247df
- (void)copyTo:(id)arg1;	// IMP=0x000000000002469d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000024561
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000024554
- (id)dictionaryRepresentation;	// IMP=0x000000000002392c
- (id)description;	// IMP=0x000000000002387d
...
- (int)StringAsCommand:(id)arg1;	// IMP=0x0000000000022fc4
- (id)commandAsString:(int)arg1;	// IMP=0x0000000000022abc
