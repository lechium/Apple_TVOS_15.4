...
- (void).cxx_destruct;	// IMP=0x00000000000221ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000021dc4
- (unsigned long long)hash;	// IMP=0x0000000000021780
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002135e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021097
- (void)copyTo:(id)arg1;	// IMP=0x0000000000020e37
- (void)writeTo:(id)arg1;	// IMP=0x0000000000020bc1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000020bb4
- (id)dictionaryRepresentation;	// IMP=0x000000000001fd7e
- (id)description;	// IMP=0x000000000001fccf
...
- (int)StringAsShuffleMode:(id)arg1;	// IMP=0x000000000001f9ac
- (id)shuffleModeAsString:(int)arg1;	// IMP=0x000000000001f92e
@property(nonatomic) _Bool hasShuffleMode;
@property(nonatomic) int shuffleMode; // @synthesize shuffleMode=_shuffleMode;
- (int)StringAsRepeatMode:(id)arg1;	// IMP=0x000000000001f814
- (id)repeatModeAsString:(int)arg1;	// IMP=0x000000000001f796
