...
- (unsigned long long)type;	// IMP=0x00000000000d322a
@property(readonly, nonatomic) NSString *outputDeviceUID;
@property(readonly, nonatomic) NSString *endpointUID;
@property(readonly, nonatomic) unsigned int capabilities;
- (id)initWithCapabilities:(unsigned int)arg1 endpointUID:(id)arg2 outputDeviceUID:(id)arg3;	// IMP=0x00000000000d3054
