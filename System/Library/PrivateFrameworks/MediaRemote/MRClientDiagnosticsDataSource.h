...
+ (id)sharedDataSource;	// IMP=0x000000000023c172
- (void).cxx_destruct;	// IMP=0x000000000023c94a
@property(readonly, nonatomic) struct os_unfair_lock_s lock; // @synthesize lock=_lock;
@property(readonly, nonatomic) NSMutableDictionary *map; // @synthesize map=_map;
- (void)remove:(id)arg1;	// IMP=0x000000000023c7ca
- (void)add:(id)arg1;	// IMP=0x000000000023c651
@property(readonly, nonatomic) NSString *diagnostic;
- (id)init;	// IMP=0x000000000023c1c7
