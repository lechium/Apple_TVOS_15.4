...
- (void).cxx_destruct;	// IMP=0x00000000001741a5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000173334
- (unsigned long long)hash;	// IMP=0x0000000000172335
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001714c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000170b13
- (void)copyTo:(id)arg1;	// IMP=0x0000000000170302
- (void)writeTo:(id)arg1;	// IMP=0x000000000016fb09
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000016fafc
- (id)dictionaryRepresentation;	// IMP=0x000000000016d152
- (id)description;	// IMP=0x000000000016d0a3
...
- (int)StringAsPlaybackSessionPriority:(id)arg1;	// IMP=0x000000000016cccd
- (id)playbackSessionPriorityAsString:(int)arg1;	// IMP=0x000000000016cc61
...
- (int)StringAsQueueEndAction:(id)arg1;	// IMP=0x000000000016c9b8
- (id)queueEndActionAsString:(int)arg1;	// IMP=0x000000000016c93a
...
- (int)StringAsReplaceIntent:(id)arg1;	// IMP=0x000000000016c6e8
- (id)replaceIntentAsString:(int)arg1;	// IMP=0x000000000016c668
...
- (int)StringAsSendOptions:(id)arg1;	// IMP=0x000000000016c313
- (id)sendOptionsAsString:(int)arg1;	// IMP=0x000000000016c2be
...
- (int)StringAsShuffleMode:(id)arg1;	// IMP=0x000000000016c0a0
- (id)shuffleModeAsString:(int)arg1;	// IMP=0x000000000016c023
@property(nonatomic) _Bool hasShuffleMode;
@property(nonatomic) int shuffleMode; // @synthesize shuffleMode=_shuffleMode;
- (int)StringAsRepeatMode:(id)arg1;	// IMP=0x000000000016bf00
- (id)repeatModeAsString:(int)arg1;	// IMP=0x000000000016be83
