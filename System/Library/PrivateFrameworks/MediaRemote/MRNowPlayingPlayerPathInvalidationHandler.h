...
- (void).cxx_destruct;	// IMP=0x00000000001b5d82
...
- (id)description;	// IMP=0x00000000001b5d4e
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2 invalidationCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000000001b5c2f
