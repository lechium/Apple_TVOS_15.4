...
+ (long long)deviceClass;	// IMP=0x000000000009a25d
+ (id)dataFromDeviceInfos:(id)arg1;	// IMP=0x0000000000098579
+ (id)deviceInfosFromData:(id)arg1;	// IMP=0x0000000000098452
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009c172
- (id)description;	// IMP=0x000000000009c0e7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009b44b
- (id)minimalDeltaDescriptionFromDeviceInfo:(id)arg1;	// IMP=0x000000000009b434
- (id)deltaDescriptionFromDeviceInfo:(id)arg1;	// IMP=0x000000000009b420
- (id)deltaDescriptionFromDeviceInfo:(id)arg1 minimal:(_Bool)arg2;	// IMP=0x000000000009b11b
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000009a3be
...
- (id)initWithData:(id)arg1;	// IMP=0x00000000000983d2
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000097c55
- (id)initWithOutputDevice:(id)arg1;	// IMP=0x0000000000097a75
