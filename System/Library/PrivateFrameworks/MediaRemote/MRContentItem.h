...
+ (id)mergeContentItems:(id)arg1;	// IMP=0x000000000018461c
+ (id)extractedIdentifierFromNowPlayingInfo:(id)arg1;	// IMP=0x00000000001844a8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018531f
- (id)description;	// IMP=0x0000000000185294
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001848e0
@property(readonly, nonatomic) MRContentItem *skeleton;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000183eb7
- (void)setNowPlayingInfo:(id)arg1 policy:(unsigned char)arg2 request:(id)arg3;	// IMP=0x000000000018104c
...
- (id)initWithData:(id)arg1;	// IMP=0x000000000017dc52
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000017d85b
- (id)initWithNowPlayingInfo:(id)arg1;	// IMP=0x000000000017d759
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000017d6c6
