...
- (unsigned long long)hash;	// IMP=0x0000000000009025
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008f52
...
- (id)initWithDeviceType:(unsigned int)arg1 deviceSubtype:(unsigned int)arg2 uid:(id)arg3 name:(id)arg4 modelID:(id)arg5;	// IMP=0x0000000000008c85
- (id)initWithDeviceType:(unsigned int)arg1 deviceSubtype:(unsigned int)arg2 uid:(id)arg3 name:(id)arg4;	// IMP=0x0000000000008c62
- (id)initWithDeviceType:(unsigned int)arg1 deviceSubtype:(unsigned int)arg2 uid:(id)arg3;	// IMP=0x0000000000008c4d
