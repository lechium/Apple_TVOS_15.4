...
- (void).cxx_destruct;	// IMP=0x000000000012015c
- (unsigned long long)hash;	// IMP=0x000000000011f85f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011f2a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011eaf0
- (void)writeTo:(id)arg1;	// IMP=0x000000000011e321
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000011e314
- (id)dictionaryRepresentation;	// IMP=0x000000000011bffb
- (id)description;	// IMP=0x000000000011bf4c
- (void)dealloc;	// IMP=0x000000000011b730
