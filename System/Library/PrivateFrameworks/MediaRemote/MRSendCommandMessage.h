...
- (void).cxx_destruct;	// IMP=0x00000000000ecce3
...
- (unsigned long long)type;	// IMP=0x00000000000ecb13
- (id)initWithCommand:(unsigned int)arg1 options:(id)arg2 playerPath:(id)arg3;	// IMP=0x00000000000ec9e7
