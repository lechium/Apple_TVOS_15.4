...
- (void).cxx_destruct;	// IMP=0x0000000000224513
...
- (void)_handleGameControllerDidChange:(id)arg1;	// IMP=0x00000000002243df
- (void)sendGameControllerEvent:(id)arg1;	// IMP=0x000000000022384a
- (void)dealloc;	// IMP=0x0000000000223804
- (id)initWithProperties:(id)arg1;	// IMP=0x0000000000223502
