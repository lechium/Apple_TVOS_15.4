...
- (void).cxx_destruct;	// IMP=0x00000000000880ee
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000087f54
- (unsigned long long)hash;	// IMP=0x0000000000087e4d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000087c8d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000087b5b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000087a5e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000087951
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000087944
- (id)dictionaryRepresentation;	// IMP=0x0000000000087273
- (id)description;	// IMP=0x00000000000871c4
