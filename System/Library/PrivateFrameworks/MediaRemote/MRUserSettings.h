...
+ (id)currentSettings;	// IMP=0x000000000013e067
- (void).cxx_destruct;	// IMP=0x000000000013f631
...
- (void)setLocalLastPlayingDate:(id)arg1;	// IMP=0x000000000013f2b2
- (id)localLastPlayingDate;	// IMP=0x000000000013f295
- (void)setLocalPlaybackState:(unsigned int)arg1;	// IMP=0x000000000013f276
- (unsigned int)localPlaybackState;	// IMP=0x000000000013f263
@property(readonly, nonatomic) double activeSystemEndpointStartupDelayToAllowAllPreviousClientsTimeToInitializeInterval;
- (id)defaultSupportedCommandsData;	// IMP=0x000000000013f22d
- (void)updateDefaultSupportedCommandsData:(id)arg1 forClient:(id)arg2;	// IMP=0x000000000013f158
- (id)defaultSupportedCommandsDataForClient:(id)arg1;	// IMP=0x000000000013f0d5
...
- (id)init;	// IMP=0x000000000013e0bc
