...
- (void).cxx_destruct;	// IMP=0x000000000010dd26
...
- (id)debugDescription;	// IMP=0x000000000010daf6
- (void)_maybeAttemptToDiscoverAndConnectToCompanionWithReason:(id)arg1;	// IMP=0x000000000010d423
- (_Bool)_shouldAttemptToDiscoverAndConnectToCompanion;	// IMP=0x000000000010d33d
- (void)_handleExternalDeviceConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x000000000010d13f
- (void)_handleCompanionDeviceConnectedNotification:(id)arg1;	// IMP=0x000000000010d126
- (id)init;	// IMP=0x000000000010cb6f
