...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007b549
- (void).cxx_destruct;	// IMP=0x000000000008197d
...
- (void)modifyWithOutputContext:(id)arg1 queue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000007ba07
@property(readonly, nonatomic) NSArray *outputDeviceUIDs;
- (id)description;	// IMP=0x000000000007b8b4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007b74d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007b551
- (id)initWithType:(unsigned long long)arg1 devices:(id)arg2;	// IMP=0x000000000007b45c
