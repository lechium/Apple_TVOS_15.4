...
- (void).cxx_destruct;	// IMP=0x0000000000139967
...
- (id)description;	// IMP=0x0000000000139824
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000139463
@property(readonly, nonatomic) struct _NSRange range;
@property(readonly, copy, nonatomic) NSData *data;
@property(readonly, nonatomic) _MRPlaybackSessionRequestProtobuf *protobuf;
- (id)initWithData:(id)arg1;	// IMP=0x00000000001391ce
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000139072
- (id)initWithIdentifier:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x0000000000138fe3
- (id)initWithIdentifier:(id)arg1 type:(id)arg2;	// IMP=0x0000000000138f2a
