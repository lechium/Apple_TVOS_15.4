...
- (id)description;	// IMP=0x0000000000007f36
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007e80
- (id)dictionaryRepresentation;	// IMP=0x0000000000007d34
@property(readonly, copy, nonatomic) NSData *data;
@property(readonly, nonatomic) _MRPlaybackSessionProtobuf *protobuf;
- (id)initWithData:(id)arg1;	// IMP=0x0000000000007b53
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000007a41
- (id)initWithIdentifier:(id)arg1 type:(id)arg2 playbackSessionData:(id)arg3 revision:(id)arg4 metadata:(id)arg5;	// IMP=0x0000000000007912
