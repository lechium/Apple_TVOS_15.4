...
+ (id)proactiveDevice;	// IMP=0x00000000000c436b
- (void).cxx_destruct;	// IMP=0x00000000000c5442
...
- (void)_notifyDelegateOfPlayerStateChange;	// IMP=0x00000000000c5296
- (void)_notifyDelegateOfStateChange;	// IMP=0x00000000000c5181
- (void)controllerWillReloadForInvalidation:(id)arg1;	// IMP=0x00000000000c50ed
- (void)controller:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000c4ff7
- (void)controller:(id)arg1 didUpdateResponse:(id)arg2;	// IMP=0x00000000000c4fe5
- (void)controller:(id)arg1 didLoadResponse:(id)arg2;	// IMP=0x00000000000c4f1b
- (void)_checkIfAirPlayPossible;	// IMP=0x00000000000c4ce0
- (void)prepare;	// IMP=0x00000000000c4b44
...
- (void)dealloc;	// IMP=0x00000000000c4707
- (id)dictionaryRepresentation;	// IMP=0x00000000000c44ce
- (id)initWithUID:(id)arg1;	// IMP=0x00000000000c439b
