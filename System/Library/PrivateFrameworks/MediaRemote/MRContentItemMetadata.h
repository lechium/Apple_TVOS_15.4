...
- (void).cxx_destruct;	// IMP=0x00000000000353ab
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000309b9
- (double)calculatedPlaybackPositionFromDate:(id)arg1;	// IMP=0x00000000000308b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002f0a6
- (id)description;	// IMP=0x000000000002f01b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b850
- (void)setArtworkDataHeightDeprecated:(long long)arg1;	// IMP=0x000000000002b68f
- (void)setArtworkDataWidthDeprecated:(long long)arg1;	// IMP=0x000000000002b67e
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000029b69
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000028878
