...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001417a0
+ (double)defaultArtwortHeight;	// IMP=0x000000000013ffb9
+ (double)defaultArtworkWidth;	// IMP=0x000000000013ffab
+ (id)requestWithCurrentState:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x000000000013f6cc
+ (id)defaultPlaybackQueueRequestWithRange:(struct _NSRange)arg1;	// IMP=0x000000000013f65d
+ (id)defaultPlaybackQueueRequest;	// IMP=0x000000000013f644
...
- (void)performRequestForDestination:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000141ddd
- (_Bool)exactMatch:(id)arg1;	// IMP=0x0000000000141c80
- (_Bool)match:(id)arg1;	// IMP=0x0000000000141b28
- (id)requestByRemovingArtwork;	// IMP=0x0000000000141ae1
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000141902
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000141889
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001417a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000141319
- (id)description;	// IMP=0x0000000000140e83
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001405d3
...
- (id)initWithData:(id)arg1;	// IMP=0x000000000013fb5f
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000013f8b4
- (id)initFromTransactionName:(unsigned long long)arg1;	// IMP=0x000000000013f804
- (id)initWithIdentifiers:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x000000000013f7d2
- (id)initWithIdentifiers:(id)arg1;	// IMP=0x000000000013f75f
- (id)initWithRange:(struct _NSRange)arg1;	// IMP=0x000000000013f72d
