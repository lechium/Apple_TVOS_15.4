...
- (void).cxx_destruct;	// IMP=0x000000000014a166
...
- (void)resetWithError:(id)arg1;	// IMP=0x000000000014a0ae
- (id)createConnectionWithUserInfo:(id)arg1;	// IMP=0x000000000014a01c
