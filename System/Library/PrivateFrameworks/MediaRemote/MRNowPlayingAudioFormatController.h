...
- (void).cxx_destruct;	// IMP=0x000000000011b6f1
...
- (void)updateAudioFormatContentInfo:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x000000000011af39
- (void)updateAudioFormatWithReason:(id)arg1;	// IMP=0x000000000011a8e4
- (void)updateNotifications;	// IMP=0x000000000011a87d
- (void)sourceFormatDidChange:(id)arg1;	// IMP=0x000000000011a82e
- (id)description;	// IMP=0x000000000011a7ed
- (id)init;	// IMP=0x000000000011a785
