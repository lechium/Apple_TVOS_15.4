...
- (void).cxx_destruct;	// IMP=0x000000000018e64c
...
- (_Bool)isComplete;	// IMP=0x000000000018e5f4
...
- (void)writeComplete;	// IMP=0x000000000018e2e1
- (id)description;	// IMP=0x000000000018e276
@property(readonly, nonatomic) _MRTransactionPacketProtobuf *protobuf;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018dfe1
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000018de59
- (id)initWithPackets:(id)arg1;	// IMP=0x000000000018da24
- (id)initWithData:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000018d89c
