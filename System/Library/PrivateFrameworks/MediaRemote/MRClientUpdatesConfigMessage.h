...
- (id)initWithNowPlayingUpdates:(_Bool)arg1 artworkUpdates:(_Bool)arg2 volumeUpdates:(_Bool)arg3 keyboardUpdates:(_Bool)arg4 outputDeviceUpdates:(_Bool)arg5 systemEndpointUpdates:(_Bool)arg6 subscribedPlayerPaths:(id)arg7;	// IMP=0x000000000000892f
- (id)initWithUnderlyingCodableMessage:(id)arg1 error:(id)arg2;	// IMP=0x00000000000086ec
