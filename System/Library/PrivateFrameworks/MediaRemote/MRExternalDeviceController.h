...
+ (Class)externalDeviceClass;	// IMP=0x00000000001480a5
- (void).cxx_destruct;	// IMP=0x0000000000149365
...
- (_Bool)_isManagedConfigIDAllowed:(id)arg1;	// IMP=0x0000000000149003
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x0000000000148d2c
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x000000000014898b
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x000000000014861c
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x000000000014850c
- (void)endDiscovery;	// IMP=0x000000000014845a
- (void)beginDiscovery;	// IMP=0x0000000000148399
- (void)dealloc;	// IMP=0x0000000000148343
- (id)initWithBonjourServiceType:(id)arg1;	// IMP=0x00000000001480b6
