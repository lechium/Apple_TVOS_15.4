...
+ (Class)availableBluetoothListeningModesType;	// IMP=0x000000000012882f
+ (Class)clusterCompositionType;	// IMP=0x000000000012863f
- (void).cxx_destruct;	// IMP=0x000000000012f52c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000012e849
- (unsigned long long)hash;	// IMP=0x000000000012deac
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012d25c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012c8a2
- (void)copyTo:(id)arg1;	// IMP=0x000000000012c120
- (void)writeTo:(id)arg1;	// IMP=0x000000000012b8c1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012b8b4
- (id)dictionaryRepresentation;	// IMP=0x0000000000128ccc
- (id)description;	// IMP=0x0000000000128c1d
@property(nonatomic) _Bool hasSupportsSharePlayHandoff;
@property(readonly, nonatomic) _Bool hasAirPlayGroupID;
- (int)StringAsHostDeviceClass:(id)arg1;	// IMP=0x0000000000128a30
- (id)hostDeviceClassAsString:(int)arg1;	// IMP=0x0000000000128960
...
- (id)availableBluetoothListeningModesAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000128812
- (unsigned long long)availableBluetoothListeningModesCount;	// IMP=0x00000000001287f5
- (void)addAvailableBluetoothListeningModes:(id)arg1;	// IMP=0x000000000012878b
- (void)clearAvailableBluetoothListeningModes;	// IMP=0x000000000012876e
...
- (id)clusterCompositionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000128622
- (unsigned long long)clusterCompositionsCount;	// IMP=0x0000000000128605
- (void)addClusterComposition:(id)arg1;	// IMP=0x000000000012859b
- (void)clearClusterCompositions;	// IMP=0x000000000012857e
...
- (int)StringAsDeviceSubType:(id)arg1;	// IMP=0x0000000000127acc
- (id)deviceSubTypeAsString:(int)arg1;	// IMP=0x000000000012798d
@property(nonatomic) _Bool hasDeviceSubType;
@property(nonatomic) int deviceSubType; // @synthesize deviceSubType=_deviceSubType;
- (int)StringAsDeviceType:(id)arg1;	// IMP=0x0000000000127830
- (id)deviceTypeAsString:(int)arg1;	// IMP=0x0000000000127799
