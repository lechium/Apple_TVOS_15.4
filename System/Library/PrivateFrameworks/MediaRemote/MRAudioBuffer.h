...
- (void).cxx_destruct;	// IMP=0x0000000000013802
...
- (id)initWithFormatSettings:(id)arg1 packetCapacity:(unsigned long long)arg2 maximumPacketSize:(unsigned long long)arg3;	// IMP=0x00000000000136e8
