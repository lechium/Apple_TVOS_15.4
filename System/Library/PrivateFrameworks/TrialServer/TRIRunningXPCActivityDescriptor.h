...
- (void).cxx_destruct;	// IMP=0x000000000010083b
...
- (id)initForImmediateWorkWithCapabilities:(unsigned long long)arg1;	// IMP=0x0000000000100595
- (id)initWithActivity:(id)arg1 capabilities:(unsigned long long)arg2 name:(id)arg3;	// IMP=0x00000000000fffee
- (id)init;	// IMP=0x00000000000fffe8
