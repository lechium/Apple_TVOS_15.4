...
- (void).cxx_destruct;	// IMP=0x00000000000d724e
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000d6fb9
- (id)initWithServerContextPromise:(id)arg1;	// IMP=0x00000000000d6c3f
