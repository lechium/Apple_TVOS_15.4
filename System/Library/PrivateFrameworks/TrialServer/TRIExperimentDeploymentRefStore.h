...
- (void).cxx_destruct;	// IMP=0x00000000000483cd
- (_Bool)hasReferenceToPath:(id)arg1;	// IMP=0x00000000000480f4
- (id)initWithServerContext:(id)arg1;	// IMP=0x0000000000048089
