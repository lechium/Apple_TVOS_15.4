...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000035fdd
+ (id)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003592f
+ (id)_convertNamespaceIdsToNames:(id)arg1;	// IMP=0x0000000000033d28
+ (id)artifactWithExperiment:(id)arg1;	// IMP=0x0000000000033625
+ (id)artifactFromCKRecordResult:(id)arg1 withNamespaceDescriptorProvider:(id)arg2 container:(int)arg3 teamId:(id)arg4 requireDeploymentId:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x00000000000d73b2
+ (id)allReferencedCKRecordKeys;	// IMP=0x00000000000d728c
- (void).cxx_destruct;	// IMP=0x0000000000036b32
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003622e
- (unsigned long long)hash;	// IMP=0x00000000000361ea
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000360d5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000035fe5
- (id)data;	// IMP=0x000000000003584f
- (id)asPersistedArtifact;	// IMP=0x00000000000352c4
- (_Bool)hasNamespacesAvailableForExperimentWithDatabase:(id)arg1;	// IMP=0x0000000000035039
- (_Bool)saveWithDatabase:(id)arg1 paths:(id)arg2;	// IMP=0x0000000000034a7c
- (_Bool)isCompatibleWithNamespaceDescriptorProvider:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000033f29
- (_Bool)isValid;	// IMP=0x0000000000033e45
@property(readonly, nonatomic) TRIClientExperiment *experiment;
- (id)initWithExperiment:(id)arg1;	// IMP=0x00000000000336b6
- (id)init;	// IMP=0x0000000000033672
