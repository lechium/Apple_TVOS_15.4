...
- (void).cxx_destruct;	// IMP=0x0000000000048079
- (_Bool)hasReferenceToPath:(id)arg1;	// IMP=0x0000000000047d8e
- (id)initWithServerContext:(id)arg1;	// IMP=0x0000000000047d23
