...
- (void).cxx_destruct;	// IMP=0x0000000000051489
...
- (void)addBlockToExecuteAfterPromiseFullfillment:(CDUnknownBlockType)arg1;	// IMP=0x0000000000051312
- (void)reject;	// IMP=0x00000000000512dd
- (void)fullfillWithContext:(id)arg1 taskQueue:(id)arg2;	// IMP=0x0000000000051250
- (id)init;	// IMP=0x000000000005113b
