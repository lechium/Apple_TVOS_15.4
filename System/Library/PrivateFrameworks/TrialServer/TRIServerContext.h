...
- (void).cxx_destruct;	// IMP=0x000000000008cd50
...
- (id)ensureFakeCKDatabase;	// IMP=0x000000000008c9b6
- (void)setXpcActivityManager:(id)arg1;	// IMP=0x000000000008c87d
- (id)initWithPaths:(id)arg1 client:(id)arg2 storageManagement:(id)arg3 xpcActivityManagement:(id)arg4;	// IMP=0x000000000008c379
- (id)initWithPaths:(id)arg1 client:(id)arg2 storageManagement:(id)arg3;	// IMP=0x000000000008c364
- (void)_logInitErrorWithClient:(id)arg1 message:(id)arg2;	// IMP=0x000000000008c2ab
- (void)logErrorMetric:(id)arg1;	// IMP=0x000000000008c162
- (id)init;	// IMP=0x000000000008c15c
