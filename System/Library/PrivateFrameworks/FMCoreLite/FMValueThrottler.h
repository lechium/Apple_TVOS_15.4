...
- (void)flushValueChanges;	// IMP=0x00000000000070a6
- (id)observeValueChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006e7f
- (void)_notifyObserversOfValueUpdate;	// IMP=0x0000000000006d0d
- (void)_enqueueValueUpdateIfNecessary;	// IMP=0x0000000000006b8d
- (void)dealloc;	// IMP=0x00000000000069e7
- (id)init;	// IMP=0x00000000000069d2
- (id)initWithThrottleInterval:(double)arg1 initialValue:(id)arg2;	// IMP=0x00000000000068fa
- (id)initWithThrottleInterval:(double)arg1;	// IMP=0x00000000000068e6
