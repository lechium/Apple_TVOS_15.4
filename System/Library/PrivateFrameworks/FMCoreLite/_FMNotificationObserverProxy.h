...
- (void).cxx_destruct;	// IMP=0x000000000000e58b
...
- (void)invalidate;	// IMP=0x000000000000e4bd
- (void)performObserverBlock;	// IMP=0x000000000000e464
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000e21c
