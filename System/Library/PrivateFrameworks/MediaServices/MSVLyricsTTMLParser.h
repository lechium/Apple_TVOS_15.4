...
- (void)parser:(id)arg1 parseErrorOccurred:(id)arg2;	// IMP=0x000000000000453f
- (void)parser:(id)arg1 foundCharacters:(id)arg2;	// IMP=0x00000000000042ec
- (void)parser:(id)arg1 didEndElement:(id)arg2 namespaceURI:(id)arg3 qualifiedName:(id)arg4;	// IMP=0x00000000000035e9
- (void)parser:(id)arg1 didStartElement:(id)arg2 namespaceURI:(id)arg3 qualifiedName:(id)arg4 attributes:(id)arg5;	// IMP=0x00000000000025fd
- (void)parseWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000254c
- (id)parseWithError:(id *)arg1;	// IMP=0x0000000000002342
- (id)initWithTTMLStream:(id)arg1;	// IMP=0x0000000000002232
- (id)initWithTTMLData:(id)arg1;	// IMP=0x00000000000021b4
