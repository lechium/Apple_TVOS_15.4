...
+ (id)createHeader:(unsigned long long)arg1;	// IMP=0x000000000002c93c
- (void).cxx_destruct;	// IMP=0x000000000002cd8d
...
- (void)_notifyDelegate:(id)arg1;	// IMP=0x000000000002cc8d
- (void)processData:(id)arg1;	// IMP=0x000000000002c9b5
