...
+ (id)new;	// IMP=0x000000000001cc06
- (void).cxx_destruct;	// IMP=0x000000000001cf94
...
- (id)initWithMediaItem:(id)arg1 sessionState:(id)arg2 requestSession:(id)arg3;	// IMP=0x000000000001cca4
- (id)init;	// IMP=0x000000000001cc35
