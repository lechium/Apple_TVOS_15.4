...
+ (id)_nonPersistentIDsFromMediaEntityIdentifiers:(id)arg1;	// IMP=0x0000000000037e70
+ (id)_nonPersistentIDFromMediaEntityIdentifier:(id)arg1;	// IMP=0x0000000000037dc7
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaItemType:(unsigned long long)arg2 mediaCategoryType:(unsigned long long)arg3;	// IMP=0x0000000000037d41
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0000000000037d2a
+ (id)_mediaEntityTypePredicateWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0000000000037d10
+ (id)_sortedMediaEntitiesWithMediaEntities:(id)arg1;	// IMP=0x0000000000037c35
+ (_Bool)_updateMediaEntitiesDictionary:(id)arg1 withMediaEntityFetchResponse:(id)arg2;	// IMP=0x000000000003754d
+ (id)new;	// IMP=0x000000000003629e
- (void).cxx_destruct;	// IMP=0x000000000003820f
...
- (id)_albumsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000037b6a
- (id)_albumArtistsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000037a9f
- (id)_mediaItemsWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x00000000000378ea
- (void)_updateAlbumsWithAlbumsResponse:(id)arg1;	// IMP=0x00000000000374c8
- (void)_updateAlbumArtistsWithAlbumArtistResponse:(id)arg1;	// IMP=0x0000000000037443
- (void)_updateMediaItemsWithMediaItemsResponse:(id)arg1;	// IMP=0x00000000000373be
- (void)_clearCachedMediaItemArrays;	// IMP=0x00000000000372f6
- (void)_clearCachedAlbumArrays;	// IMP=0x0000000000037297
- (void)_clearCachedAlbumArtistArrays;	// IMP=0x0000000000037265
- (id)description;	// IMP=0x0000000000036c1e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036b4b
- (void)reset;	// IMP=0x0000000000036525
- (void)updateWithSearchFetchResponse:(id)arg1 searchText:(id)arg2;	// IMP=0x000000000003641a
- (id)initWithMediaServerIdentifier:(id)arg1;	// IMP=0x000000000003633c
- (id)init;	// IMP=0x00000000000362cd
