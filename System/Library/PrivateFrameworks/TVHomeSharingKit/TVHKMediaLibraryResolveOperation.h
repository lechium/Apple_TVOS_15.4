...
@interface TVHKMediaLibraryResolveOperation <NSNetServiceDelegate>
{
...
+ (id)new;	// IMP=0x0000000000090a23
- (void).cxx_destruct;	// IMP=0x00000000000914fd
...
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x00000000000912c4
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x0000000000090eca
- (void)cancel;	// IMP=0x0000000000090e74
- (void)executionDidBegin;	// IMP=0x0000000000090bd9
- (void)_stopResolving;	// IMP=0x0000000000090b72
- (id)initWithBonjourServiceConfiguration:(id)arg1;	// IMP=0x0000000000090ac1
- (id)init;	// IMP=0x0000000000090a52
