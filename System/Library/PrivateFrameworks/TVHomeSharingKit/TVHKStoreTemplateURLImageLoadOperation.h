...
@interface TVHKStoreTemplateURLImageLoadOperation <TVHKImageLoadingOperation>
{
...
+ (id)new;	// IMP=0x000000000006818e
- (void).cxx_destruct;	// IMP=0x0000000000068b8d
...
- (void)_handleResponse:(id)arg1 andData:(id)arg2;	// IMP=0x0000000000068793
- (void)cancel;	// IMP=0x0000000000068715
- (void)executionDidBegin;	// IMP=0x0000000000068363
- (id)initWithTemplateImageURLString:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000006822c
- (id)init;	// IMP=0x00000000000681bd
