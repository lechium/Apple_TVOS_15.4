...
@interface TVHKCollectionChange : NSObject
{
    ...
    TVHKCollectionChangeSet *_amendChangeSet;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00000000000a7269
@property(retain, nonatomic) TVHKCollectionChangeSet *amendChangeSet; // @synthesize amendChangeSet=_amendChangeSet;
...
- (id)description;	// IMP=0x00000000000a6f5e
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x00000000000a6e9e
- (id)init;	// IMP=0x00000000000a6e2f
- (id)new;	// IMP=0x00000000000a6e00
