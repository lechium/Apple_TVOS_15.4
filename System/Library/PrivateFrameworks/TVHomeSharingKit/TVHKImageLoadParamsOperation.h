...
@interface TVHKImageLoadParamsOperation <TVHKImageLoadingOperation>
{
...
+ (id)new;	// IMP=0x00000000000a65f6
- (void).cxx_destruct;	// IMP=0x00000000000a682a
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x00000000000a6694
- (id)init;	// IMP=0x00000000000a6625
