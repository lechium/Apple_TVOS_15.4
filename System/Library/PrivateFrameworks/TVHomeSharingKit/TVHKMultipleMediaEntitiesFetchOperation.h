...
@interface TVHKMultipleMediaEntitiesFetchOperation
{
...
- (void)_runNextFetchOperationIfPossible;	// IMP=0x00000000000320af
- (void)cancel;	// IMP=0x0000000000032031
- (void)executionDidBegin;	// IMP=0x000000000003201f
- (id)initWithRequests:(id)arg1 mediaServerIdentifier:(id)arg2 sessionState:(id)arg3 requestSession:(id)arg4 fetchCache:(id)arg5;	// IMP=0x0000000000031e4a
- (id)init;	// IMP=0x0000000000031ddb
