...
+ (id)new;	// IMP=0x0000000000098dec
- (void).cxx_destruct;	// IMP=0x00000000000997c8
...
- (void)addEpisode:(id)arg1;	// IMP=0x0000000000098f45
- (id)initWithShow:(id)arg1;	// IMP=0x0000000000098e8a
- (id)init;	// IMP=0x0000000000098e1b
