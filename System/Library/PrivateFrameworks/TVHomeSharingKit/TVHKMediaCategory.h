...
+ (id)new;	// IMP=0x00000000000b1d4c
+ (id)mediaCatgeoryForType:(unsigned long long)arg1;	// IMP=0x00000000000b122d
- (void).cxx_destruct;	// IMP=0x00000000000b225d
...
- (id)description;	// IMP=0x00000000000b1ed5
- (id)_initWithType:(unsigned long long)arg1 typeString:(id)arg2;	// IMP=0x00000000000b1dea
- (id)init;	// IMP=0x00000000000b1d7b
