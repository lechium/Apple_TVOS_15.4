...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0000000000002c2c
+ (Class)transformedValueClass;	// IMP=0x0000000000002c1b
- (void).cxx_destruct;	// IMP=0x000000000000357d
...
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000002c34
- (id)initWithIdentifierKeyPath:(id)arg1;	// IMP=0x0000000000002b6a
