...
- (void).cxx_destruct;	// IMP=0x000000000008baf3
...
- (id)description;	// IMP=0x000000000008b8b5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008b440
- (unsigned long long)hash;	// IMP=0x000000000008b28d
