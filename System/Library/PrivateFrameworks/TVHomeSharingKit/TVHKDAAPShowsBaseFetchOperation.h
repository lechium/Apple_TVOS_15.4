...
@interface TVHKDAAPShowsBaseFetchOperation <TVHKMediaEntitiesNetworkFetching>
{
...
- (void).cxx_destruct;	// IMP=0x0000000000088adf
...
- (id)_episodesFetchRequest;	// IMP=0x00000000000888db
- (id)_mediaEntitiesWithFetchedEpisodes:(id)arg1 andMediaEntityCache:(id)arg2;	// IMP=0x0000000000088873
- (id)_mediaEntityCacheWithFetchCache:(id)arg1;	// IMP=0x0000000000088810
- (void)_mediaEntitiesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000008819a
- (void)cancel;	// IMP=0x000000000008812c
- (id)initWithRequest:(id)arg1 mediaServerIdentifier:(id)arg2 sessionState:(id)arg3 requestSession:(id)arg4 fetchCache:(id)arg5;	// IMP=0x0000000000087eda
- (id)_initWithRequest:(id)arg1;	// IMP=0x0000000000087e6b
