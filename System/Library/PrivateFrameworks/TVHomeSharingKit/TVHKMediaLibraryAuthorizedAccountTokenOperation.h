...
- (void).cxx_destruct;	// IMP=0x000000000006b33d
...
- (id)_decryptTokenData:(id)arg1;	// IMP=0x000000000006b231
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000006ae70
- (id)initWithUserIdentifier:(id)arg1 sessionState:(id)arg2 useTokenEncryption:(_Bool)arg3 requestSession:(id)arg4;	// IMP=0x000000000006ac99
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x000000000006ac2a
