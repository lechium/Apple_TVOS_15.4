...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x000000000008684b
- (void).cxx_destruct;	// IMP=0x00000000000869fe
...
- (id)description;	// IMP=0x00000000000864bd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000086387
- (id)init;	// IMP=0x0000000000085f6c
