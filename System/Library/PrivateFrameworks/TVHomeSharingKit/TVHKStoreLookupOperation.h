...
@interface TVHKStoreLookupOperation
{
...
- (id)_countryCode;	// IMP=0x00000000000081f8
- (void)cancel;	// IMP=0x000000000000817a
- (void)executionDidBegin;	// IMP=0x0000000000007e48
...
- (id)initWithStoreID:(unsigned long long)arg1;	// IMP=0x0000000000007d1d
- (id)init;	// IMP=0x0000000000007cae
