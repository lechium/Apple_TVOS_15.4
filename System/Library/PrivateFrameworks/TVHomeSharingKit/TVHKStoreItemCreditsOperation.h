...
@interface TVHKStoreItemCreditsOperation
{
...
+ (id)_contributorsFromStoreCredits:(id)arg1;	// IMP=0x000000000005d9af
+ (id)new;	// IMP=0x000000000005d1d6
- (void).cxx_destruct;	// IMP=0x000000000005ddd0
...
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000005d61a
- (void)cancel;	// IMP=0x000000000005d59c
- (void)executionDidBegin;	// IMP=0x000000000005d300
- (id)initWithItemTitle:(id)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x000000000005d274
- (id)init;	// IMP=0x000000000005d205
