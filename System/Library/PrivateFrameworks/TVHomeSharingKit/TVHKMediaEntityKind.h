...
- (void).cxx_destruct;	// IMP=0x0000000000097811
...
- (id)description;	// IMP=0x000000000009759b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000974de
- (id)sortingPropertyDescriptorForName:(id)arg1;	// IMP=0x000000000009745b
- (id)propertyDescriptorForName:(id)arg1;	// IMP=0x00000000000973d8
@property(readonly, copy, nonatomic) NSDictionary *propertyDescriptorByName;
- (id)init;	// IMP=0x00000000000972e1
