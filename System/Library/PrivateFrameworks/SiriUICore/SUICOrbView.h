...
+ (Class)layerClass;	// IMP=0x0000000000014ddc
- (void).cxx_destruct;	// IMP=0x000000000001b402
...
- (float)linearPowerLevel;	// IMP=0x000000000001b364
- (void)_invalidateDisplayLink;	// IMP=0x000000000001b1c3
- (void)invalidate;	// IMP=0x000000000001b052
- (void)_updateMetalTextureRasterSize:(struct CGSize)arg1;	// IMP=0x000000000001a7bf
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000001a6f5
- (void)_drawSiriFrame:(id)arg1;	// IMP=0x00000000000199c9
- (void)_blurInCommandBuffer:(id)arg1 sourceTexture:(id)arg2 destinationTexture:(id)arg3;	// IMP=0x000000000001953a
- (void)_updateSiriGraphicsState:(double)arg1;	// IMP=0x0000000000018ab0
- (void)_updateSiriPhysics:(float)arg1;	// IMP=0x0000000000017f6f
- (void)_updateChipsSizesForOnOff;	// IMP=0x0000000000017c5a
- (void)_updateDynamicBufferState;	// IMP=0x0000000000017c27
- (void)_loadAssets;	// IMP=0x0000000000017b55
- (void)_createNoiseTexture;	// IMP=0x00000000000179de
- (void)_createSmoothStepTexture;	// IMP=0x0000000000017872
- (void)_createSiriChipBuffer;	// IMP=0x00000000000176a6
- (void)_createSphereBuffer;	// IMP=0x00000000000172a9
- (void)_loadMetalState;	// IMP=0x0000000000016fe4
- (void)_loadMetalPipelines;	// IMP=0x000000000001600d
- (void)_prewarmBlurWithBlitEncoder:(id)arg1 src:(id)arg2 dst:(id)arg3 mipCount:(unsigned int)arg4;	// IMP=0x0000000000015ead
- (void)prewarmOrb;	// IMP=0x0000000000015d3e
- (void)setPowerLevel:(float)arg1;	// IMP=0x0000000000015ceb
- (void)animateToOffWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000015c18
- (void)pauseAnimationAndReset;	// IMP=0x00000000000159be
- (void)_didSetRenderModeFrom:(long long)arg1 to:(long long)arg2;	// IMP=0x00000000000157eb
- (void)_updateRenderModeWithDelta:(float)arg1;	// IMP=0x000000000001577e
- (void)_setMode:(long long)arg1;	// IMP=0x00000000000156f5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000015148
- (void)_initCommandQueue;	// IMP=0x0000000000015101
- (void)_initNoiseOffsets;	// IMP=0x00000000000150b6
- (void)_initSprings;	// IMP=0x0000000000014f4b
- (void)_setupSpring:(CDStruct_d7a90142 *)arg1 withType:(unsigned long long)arg2 initialValue:(float)arg3;	// IMP=0x0000000000014ded
