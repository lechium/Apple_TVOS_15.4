...
- (void).cxx_destruct;	// IMP=0x00000000000129d9
...
- (void)_notifyDelegateOfAutoDismissalDecisionChangeIfNeededPermanent:(_Bool)arg1;	// IMP=0x0000000000012855
- (void)_notifyDelegateOfAutoDismissalDecisionChangeIfNeeded;	// IMP=0x0000000000012841
- (void)setViewRequiringExtendedTimeoutStartTime:(double)arg1;	// IMP=0x0000000000012836
- (id)initWithIdleTimeout:(double)arg1 extendedIdleTimeout:(double)arg2 deviceSupportsFaceDetection:(_Bool)arg3 deviceSupportsRaiseGestureDetection:(_Bool)arg4;	// IMP=0x00000000000126d0
