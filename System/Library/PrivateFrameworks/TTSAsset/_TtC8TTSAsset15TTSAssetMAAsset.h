...
- (void).cxx_destruct;	// IMP=0x00000000000125f0
- (id)init;	// IMP=0x00000000000125a0
- (void)purge;	// IMP=0x00000000000124e0
- (void)cancelDownloadingThen:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012370
- (void)downloadWithReservation:(id)arg1 useBattery:(_Bool)arg2 progress:(CDUnknownBlockType)arg3 then:(CDUnknownBlockType)arg4;	// IMP=0x0000000000012140
