...
- (id)init;	// IMP=0x0000000000036f10
- (void)purge;	// IMP=0x0000000000036e90
- (void)cancelDownloadingThen:(CDUnknownBlockType)arg1;	// IMP=0x0000000000036970
- (void)downloadWithReservation:(id)arg1 useBattery:(_Bool)arg2 progress:(CDUnknownBlockType)arg3 then:(CDUnknownBlockType)arg4;	// IMP=0x0000000000036240
