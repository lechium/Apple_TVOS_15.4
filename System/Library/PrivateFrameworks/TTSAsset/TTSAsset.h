...
+ (struct _NSRange)_gryphonVoiceCompatibility;	// IMP=0x0000000000001711
+ (_Bool)_hasTrialEntitlements;	// IMP=0x000000000000157d
+ (void)_postNewAssetNotification;	// IMP=0x000000000000156c
+ (id)NewAssetNotification;	// IMP=0x000000000000155f
+ (id)bestAssetOfTypes:(id)arg1 matching:(id)arg2;	// IMP=0x0000000000018870
+ (id)listAssetsOfTypes:(id)arg1 matching:(id)arg2;	// IMP=0x0000000000018660
+ (void)waitForCatalogUpdates;	// IMP=0x000000000001f1e0
+ (id)describeServer:(id)arg1 source:(id)arg2;	// IMP=0x000000000001f090
+ (id)describeServer:(id)arg1 forType:(id)arg2;	// IMP=0x000000000001ef30
+ (id)getServerForType:(id)arg1 source:(id)arg2;	// IMP=0x000000000001ee10
+ (id)getServerForType:(id)arg1;	// IMP=0x000000000001ed10
+ (_Bool)setServer:(id)arg1 forType:(id)arg2 source:(id)arg3;	// IMP=0x000000000001ebe0
+ (_Bool)setServer:(id)arg1 forType:(id)arg2;	// IMP=0x000000000001eaa0
+ (_Bool)handleProxyEvent:(id)arg1 reply:(id)arg2 connection:(id)arg3;	// IMP=0x000000000002d190
- (void).cxx_destruct;	// IMP=0x00000000000017e8
...
- (id)init;	// IMP=0x0000000000001530
- (id)relatedAssetsWithOnlyAvailable:(_Bool)arg1;	// IMP=0x00000000000187a0
@property(nonatomic, readonly) NSString *description;
- (_Bool)isNewer:(id)arg1;	// IMP=0x000000000001e230
- (_Bool)isOlder:(id)arg1;	// IMP=0x000000000001e0b0
- (id)legacyAssetWithBundle:(id)arg1;	// IMP=0x0000000000029ea0
- (void)purge;	// IMP=0x0000000000029e20
- (void)cancelDownloadingThen:(CDUnknownBlockType)arg1;	// IMP=0x0000000000029dc0
- (void)downloadWithReservation:(id)arg1 useBattery:(_Bool)arg2 progress:(CDUnknownBlockType)arg3 then:(CDUnknownBlockType)arg4;	// IMP=0x0000000000029d10
