...
- (void).cxx_destruct;	// IMP=0x000000000005458f
...
- (id)knowledgeEvent;	// IMP=0x00000000000540a5
- (id)feedbackPayload;	// IMP=0x0000000000053e5f
- (id)getTrialID;	// IMP=0x0000000000053d99
@property(readonly, nonatomic) unsigned long long indexOfEngagedSuggestion;
- (id)initWithFeedbackAction:(id)arg1 predictionContext:(id)arg2 suggestions:(id)arg3;	// IMP=0x0000000000053a3e
