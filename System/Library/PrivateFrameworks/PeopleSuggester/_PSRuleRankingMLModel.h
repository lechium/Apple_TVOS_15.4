...
- (void).cxx_destruct;	// IMP=0x000000000000aa26
...
- (id)rankRules:(id)arg1 contextItems:(id)arg2;	// IMP=0x0000000000009d9b
- (id)scoresOnRules:(id)arg1 contextItems:(id)arg2;	// IMP=0x00000000000097f5
- (id)giveModelDescription;	// IMP=0x00000000000097df
- (id)extractAdaptedModelRecipeID;	// IMP=0x00000000000097cd
- (_Bool)isAdaptedModelUsed;	// IMP=0x00000000000097bb
- (_Bool)isAdaptedModelCreated;	// IMP=0x0000000000009738
- (void)loadDefaultRuleMinerMLModel;	// IMP=0x00000000000092fa
- (id)getAdaptedModelVersion;	// IMP=0x00000000000091a0
- (id)initWithAdaptableModelConfig:(id)arg1 isAdaptedMLModelOK:(_Bool)arg2 scoreThreshold:(double)arg3;	// IMP=0x0000000000008ef6
- (id)initWithMLModel:(id)arg1 scoreThreshold:(double)arg2 isAdaptedModel:(_Bool)arg3 psConfigForAdaptableModel:(id)arg4 isAdaptedMLModelOK:(_Bool)arg5;	// IMP=0x0000000000008ccd
