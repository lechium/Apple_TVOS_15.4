...
- (void).cxx_destruct;	// IMP=0x00000000000a2ec5
...
- (long long)compare:(id)arg1;	// IMP=0x00000000000a2dba
- (id)initWithLabel:(long long)arg1 score:(float)arg2 recipientUniqueID:(id)arg3;	// IMP=0x00000000000a2d35
