...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003709e
- (void).cxx_destruct;	// IMP=0x0000000000037b0b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003767d
- (unsigned long long)hash;	// IMP=0x0000000000037601
- (id)description;	// IMP=0x00000000000374da
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000037409
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003721e
- (id)initWithCreationDate:(id)arg1 UTI:(id)arg2 photoLocalIdentifier:(id)arg3 identifier:(id)arg4 cloudIdentifier:(id)arg5 contentURL:(id)arg6 contentText:(id)arg7;	// IMP=0x00000000000370a6
