...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000027fed
- (void).cxx_destruct;	// IMP=0x0000000000028008
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000027f7a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000027eb5
- (id)initWithContact:(id)arg1 viaContactPicker:(_Bool)arg2;	// IMP=0x0000000000027e3f
