...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000545c2
- (void).cxx_destruct;	// IMP=0x00000000000548d3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000547e4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005468f
- (id)init;	// IMP=0x00000000000545ca
