...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000881b0
- (unsigned long long)hash;	// IMP=0x00000000000864ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000085d91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008596f
- (void)copyTo:(id)arg1;	// IMP=0x000000000008558b
- (void)writeTo:(id)arg1;	// IMP=0x00000000000850d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000850c4
- (id)dictionaryRepresentation;	// IMP=0x0000000000083024
- (id)description;	// IMP=0x0000000000082f75
...
- (int)StringAsTimeSinceLastContactViaOutgoingCall:(id)arg1;	// IMP=0x0000000000082520
- (id)timeSinceLastContactViaOutgoingCallAsString:(int)arg1;	// IMP=0x0000000000082437
...
- (int)StringAsTimeSinceLastContactViaIncomingCall:(id)arg1;	// IMP=0x000000000008220c
- (id)timeSinceLastContactViaIncomingCallAsString:(int)arg1;	// IMP=0x0000000000082123
...
- (int)StringAsTimeSinceLastContactViaOutgoingText:(id)arg1;	// IMP=0x0000000000081ef8
- (id)timeSinceLastContactViaOutgoingTextAsString:(int)arg1;	// IMP=0x0000000000081e10
- (int)StringAsTimeSinceLastContactViaIncomingText:(id)arg1;	// IMP=0x0000000000081c54
- (id)timeSinceLastContactViaIncomingTextAsString:(int)arg1;	// IMP=0x0000000000081b6c
- (int)StringAsTimeSinceLastContactViaShare:(id)arg1;	// IMP=0x00000000000819b0
- (id)timeSinceLastContactViaShareAsString:(int)arg1;	// IMP=0x00000000000818c8
