...
+ (id)feedbackForAction:(id)arg1 delay:(double)arg2 context:(id)arg3 suggestions:(id)arg4 numberOfVisibleSuggestions:(float)arg5 sessionIdentifier:(id)arg6;	// IMP=0x000000000007a125
- (void).cxx_destruct;	// IMP=0x000000000007b754
...
- (id)knowledgeEvent;	// IMP=0x000000000007a806
- (id)feedbackPayloadShowFamily:(id)arg1;	// IMP=0x000000000007a4a4
@property(readonly, nonatomic) unsigned long long indexOfEngagedSuggestion;
- (id)getTrialID;	// IMP=0x000000000007a2f6
- (id)initWithAction:(id)arg1 delay:(double)arg2 context:(id)arg3 suggestions:(id)arg4 numberOfVisibleSuggestions:(float)arg5 sessionIdentifier:(id)arg6;	// IMP=0x000000000007a1e3
