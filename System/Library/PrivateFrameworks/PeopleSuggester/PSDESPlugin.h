...
+ (void)initialize;	// IMP=0x000000000007b792
- (void).cxx_destruct;	// IMP=0x000000000007b809
@property(retain, nonatomic) id <_DKKnowledgeQuerying> knowledgeStore; // @synthesize knowledgeStore=_knowledgeStore;
- (void)performEvaluation:(id)arg1;	// IMP=0x000000000007b7e8
- (_Bool)shouldDownloadAttachmentWithURL:(id)arg1 recipe:(id)arg2 recordInfo:(id)arg3;	// IMP=0x000000000007b7e0
