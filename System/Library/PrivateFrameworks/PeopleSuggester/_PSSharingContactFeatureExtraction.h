...
@class CAPContactFillerUserEvent, NSDictionary, NSMutableDictionary, _CDInteractionStore, _PSContactFillerNormalizationConstants;
...
- (void).cxx_destruct;	// IMP=0x0000000000037e58
...
- (void)extractFeaturesInto:(id)arg1 withPredictionContext:(id)arg2 forContactId:(id)arg3 forInteraction:(id)arg4 behaviorRulesConsideringInTheContext:(id)arg5 ruleRankingMLModelScores:(id)arg6 interactionModelScores:(id)arg7;	// IMP=0x0000000000037dca
- (void)transferConstantFeatures:(id)arg1 to:(id)arg2;	// IMP=0x0000000000037c1f
- (void)extractConstantFeaturesInto:(id)arg1;	// IMP=0x0000000000037c19
- (id)initWithMetadata:(id)arg1 interactionStore:(id)arg2;	// IMP=0x0000000000037b6a
