...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005fa89
- (void).cxx_destruct;	// IMP=0x0000000000060250
...
- (id)description;	// IMP=0x000000000006000d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005fec1
- (unsigned long long)hash;	// IMP=0x000000000005feab
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005fdbc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005fa91
- (id)initWithContact:(id)arg1 andScore:(double)arg2;	// IMP=0x000000000005fa0c
