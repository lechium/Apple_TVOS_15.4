...
- (void).cxx_destruct;	// IMP=0x0000000000063f1c
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000063e11
- (id)initWithLabel:(long long)arg1 score:(float)arg2 recipientUniqueID:(id)arg3;	// IMP=0x0000000000063d8c
