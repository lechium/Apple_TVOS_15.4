...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000004408
- (void)mediaPause;	// IMP=0x000000000000427d
- (void)imageViewTapped:(id)arg1;	// IMP=0x0000000000004240
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000003aa4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000039b4
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000003689
- (void)loadView;	// IMP=0x00000000000032bd
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000000024d7
