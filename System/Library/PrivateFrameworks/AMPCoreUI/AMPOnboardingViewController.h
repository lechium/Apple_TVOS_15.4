...
- (void)didTapPrimaryButton:(id)arg1;	// IMP=0x0000000000002095
@property(readonly, nonatomic) UIImage *headerImage;
- (void)updateOverrideTraits;	// IMP=0x0000000000001eaa
- (id)childTraitCollectionForViewController:(id)arg1;	// IMP=0x0000000000001dab
@property(readonly, nonatomic) UITraitCollection *cappedTraitCollection;
- (_Bool)isModalInPresentation;	// IMP=0x0000000000001b11
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x0000000000001abe
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000001a47
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000001959
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000018fe
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000184a
- (void)viewDidLoad;	// IMP=0x00000000000017af
- (id)initWithTitleText:(id)arg1 features:(id)arg2 primaryButtonText:(id)arg3 privacyLinkController:(id)arg4;	// IMP=0x0000000000001709
- (id)initWithHeaderImage:(id)arg1 titleText:(id)arg2 descriptionText:(id)arg3 primaryButtonText:(id)arg4 privacyLinkController:(id)arg5;	// IMP=0x0000000000001619
