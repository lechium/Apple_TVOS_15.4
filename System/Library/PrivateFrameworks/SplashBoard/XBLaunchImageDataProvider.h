...
- (void).cxx_destruct;	// IMP=0x0000000000012ef4
@property(readonly, retain, nonatomic) XBSnapshotDataProviderContext *context; // @synthesize context=_context;
- (void)invalidateImage;	// IMP=0x0000000000012e71
- (id)fetchImage;	// IMP=0x0000000000012d49
- (id)initWithRequest:(id)arg1 contextID:(unsigned int)arg2 opaque:(_Bool)arg3;	// IMP=0x0000000000012902
