...
- (void)_addToEngine:(id)arg1;	// IMP=0x000000000001a3b9
- (id)secondItem;	// IMP=0x000000000001a3b1
- (id)firstItem;	// IMP=0x000000000001a3a9
- (id)description;	// IMP=0x000000000001a344
- (int)nsis_orientationHintForVariable:(id)arg1;	// IMP=0x000000000001a332
- (_Bool)nsis_valueOfVariableIsUserObservable:(id)arg1;	// IMP=0x000000000001a320
- (id)nsis_descriptionOfVariable:(id)arg1;	// IMP=0x000000000001a30e
- (void)nsis_valueOfVariable:(id)arg1 didChangeInEngine:(id)arg2;	// IMP=0x000000000001a308
- (void)dealloc;	// IMP=0x000000000001a2b7
