...
- (id)makeChildRules;	// IMP=0x0000000000003925
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000389a
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003848
- (void)dealloc;	// IMP=0x00000000000037fe
