...
- (id)makeChildRules;	// IMP=0x0000000000003d63
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003cd0
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003c7e
- (void)dealloc;	// IMP=0x0000000000003c34
