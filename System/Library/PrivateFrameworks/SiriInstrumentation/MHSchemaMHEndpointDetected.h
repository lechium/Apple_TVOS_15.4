...
- (void).cxx_destruct;	// IMP=0x00000000001f7202
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001f6932
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000001f6874
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000001f6085
- (unsigned long long)hash;	// IMP=0x00000000001f5c8a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f54ab
- (void)writeTo:(id)arg1;	// IMP=0x00000000001f518a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001f450b
- (void)deleteTimeoutMetadata;	// IMP=0x00000000001f44f7
- (void)deleteAsrFeatureLatencyDistribution;	// IMP=0x00000000001f44ce
- (void)deleteEndpointResetPositionInNs;	// IMP=0x00000000001f448e
@property(nonatomic) _Bool hasEndpointResetPositionInNs;
- (void)deleteAudioSkippedDurationInNs;	// IMP=0x00000000001f4412
@property(nonatomic) _Bool hasAudioSkippedDurationInNs;
- (void)deleteEndpointerScore;	// IMP=0x00000000001f4396
@property(nonatomic) _Bool hasEndpointerScore;
- (void)deleteEndpointerThreshold;	// IMP=0x00000000001f431c
@property(nonatomic) _Bool hasEndpointerThreshold;
- (void)deleteDerivedBufferTimeFromHistoricalAudio;	// IMP=0x00000000001f42a4
@property(nonatomic) _Bool hasDerivedBufferTimeFromHistoricalAudio;
- (void)deleteEndpointModelConfigVersion;	// IMP=0x00000000001f4244
- (void)deleteExtraDelayInNs;	// IMP=0x00000000001f4205
@property(nonatomic) _Bool hasExtraDelayInNs;
- (void)deleteEndpointerDecisionLagInNs;	// IMP=0x00000000001f418e
@property(nonatomic) _Bool hasEndpointerDecisionLagInNs;
- (void)deleteEndpointFeaturesAtEndpoint;	// IMP=0x00000000001f412d
- (void)deleteEndpointedBufferTimeInNs;	// IMP=0x00000000001f40ee
@property(nonatomic) _Bool hasEndpointedBufferTimeInNs;
- (void)deleteFirstBufferTimeInNs;	// IMP=0x00000000001f4079
@property(nonatomic) _Bool hasFirstBufferTimeInNs;
- (void)deleteEndpointAudioDurationInNs;	// IMP=0x00000000001f4004
@property(nonatomic) _Bool hasEndpointAudioDurationInNs;
- (void)deleteEndpointerType;	// IMP=0x00000000001f3f90
@property(nonatomic) _Bool hasEndpointerType;
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000032cf60
- (id)suppressMessageUnderConditions;	// IMP=0x000000000032cf28
