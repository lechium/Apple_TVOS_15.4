...
- (void).cxx_destruct;	// IMP=0x00000000000077ed
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000758d
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000074cf
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000007239
- (unsigned long long)hash;	// IMP=0x00000000000070d6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006dca
- (void)writeTo:(id)arg1;	// IMP=0x0000000000006cbf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000006b29
- (void)deleteTimeIntervalSince1970;	// IMP=0x0000000000006afe
@property(nonatomic) _Bool hasTimeIntervalSince1970;
- (void)deleteSpeechId;	// IMP=0x0000000000006aa3
- (void)deleteSiriDeviceId;	// IMP=0x0000000000006a7a
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000030c4fa
- (id)suppressMessageUnderConditions;	// IMP=0x000000000030c4c2
