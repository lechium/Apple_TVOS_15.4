...
- (void).cxx_destruct;	// IMP=0x000000000008640e
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000008617d
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000860bf
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000085dda
- (unsigned long long)hash;	// IMP=0x0000000000085d6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000085994
- (void)writeTo:(id)arg1;	// IMP=0x0000000000085855
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000085221
- (void)deleteEnded;	// IMP=0x00000000000851ee
@property(retain, nonatomic) NLXSchemaCDMSpanMatcherEnded *ended; // @synthesize ended=_ended;
- (void)deleteStartedOrChanged;	// IMP=0x0000000000085120
@property(retain, nonatomic) NLXSchemaCDMSpanMatcherStarted *startedOrChanged; // @synthesize startedOrChanged=_startedOrChanged;
- (void)deleteContextId;	// IMP=0x0000000000085073
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x0000000000315081
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000315049
