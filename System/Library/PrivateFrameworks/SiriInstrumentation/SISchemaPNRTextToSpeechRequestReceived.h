...
- (void).cxx_destruct;	// IMP=0x00000000002a4ab9
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002a46fe
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000002a4640
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000002a422b
- (unsigned long long)hash;	// IMP=0x00000000002a4159
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a3d91
- (void)writeTo:(id)arg1;	// IMP=0x00000000002a3c5a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002a3c4d
- (void)deleteSpeechError;	// IMP=0x00000000002a3c23
@property(nonatomic) _Bool hasSpeechError;
- (void)deleteSourceOfTTS;	// IMP=0x00000000002a3bae
@property(nonatomic) _Bool hasSourceOfTTS;
- (void)deleteIsSynthesisCached;	// IMP=0x00000000002a3b39
@property(nonatomic) _Bool hasIsSynthesisCached;
- (void)deleteIsWarmStart;	// IMP=0x00000000002a3ac6
@property(nonatomic) _Bool hasIsWarmStart;
- (void)deleteVoiceResourceAssetKey;	// IMP=0x00000000002a3a6d
- (void)deleteVoiceAssetKey;	// IMP=0x00000000002a3a44
- (id)suppressMessageUnderConditions;	// IMP=0x00000000003373d5
