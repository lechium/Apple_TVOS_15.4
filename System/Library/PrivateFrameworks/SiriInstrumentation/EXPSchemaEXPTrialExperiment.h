...
- (void).cxx_destruct;	// IMP=0x000000000012f66f
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000012f200
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000012f142
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000012ed62
- (unsigned long long)hash;	// IMP=0x000000000012ec70
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012e7b7
- (void)writeTo:(id)arg1;	// IMP=0x000000000012e627
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012e61a
- (void)deleteCompatibilityVersion;	// IMP=0x000000000012e5f0
@property(nonatomic) _Bool hasCompatibilityVersion;
- (void)deleteLastUpdatedAtInMs;	// IMP=0x000000000012e57b
@property(nonatomic) _Bool hasLastUpdatedAtInMs;
- (void)deleteAllocationStatus;	// IMP=0x000000000012e505
@property(nonatomic) _Bool hasAllocationStatus;
- (void)deleteDeploymentId;	// IMP=0x000000000012e492
@property(nonatomic) _Bool hasDeploymentId;
- (void)deleteTreatmentId;	// IMP=0x000000000012e438
- (void)deleteExperimentId;	// IMP=0x000000000012e40f
- (void)deleteExperimentNamespace;	// IMP=0x000000000012e3e6
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x0000000000320e73
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000320e1e
