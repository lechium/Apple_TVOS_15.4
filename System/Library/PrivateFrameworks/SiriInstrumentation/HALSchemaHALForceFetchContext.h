...
- (void).cxx_destruct;	// IMP=0x000000000018f896
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000018f55e
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000018f4a0
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000018f10b
- (unsigned long long)hash;	// IMP=0x000000000018f087
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018eb63
- (void)writeTo:(id)arg1;	// IMP=0x000000000018e9c8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000018e454
- (void)deleteFailed;	// IMP=0x000000000018e421
@property(retain, nonatomic) HALSchemaHALForceFetchFailed *failed; // @synthesize failed=_failed;
- (void)deleteEnded;	// IMP=0x000000000018e338
@property(retain, nonatomic) HALSchemaHALForceFetchEnded *ended; // @synthesize ended=_ended;
- (void)deleteStartedOrChanged;	// IMP=0x000000000018e25a
@property(retain, nonatomic) HALSchemaHALForceFetchStarted *startedOrChanged; // @synthesize startedOrChanged=_startedOrChanged;
- (void)deleteContextId;	// IMP=0x000000000018e191
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x0000000000326477
- (id)suppressMessageUnderConditions;	// IMP=0x000000000032643f
