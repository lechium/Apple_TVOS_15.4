...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000066e86
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000066dc8
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000006693c
- (unsigned long long)hash;	// IMP=0x0000000000066826
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000066562
- (void)writeTo:(id)arg1;	// IMP=0x000000000006640c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000663ff
- (void)deleteRecentAlarmBoost;	// IMP=0x00000000000663d4
@property(nonatomic) _Bool hasRecentAlarmBoost;
- (void)deleteTrumpReason;	// IMP=0x000000000006635d
@property(nonatomic) _Bool hasTrumpReason;
- (void)deleteIsTrump;	// IMP=0x00000000000662e7
@property(nonatomic) _Bool hasIsTrump;
- (void)deleteRecentPlaybackBoost;	// IMP=0x0000000000066271
@property(nonatomic) _Bool hasRecentPlaybackBoost;
- (void)deleteRecentMotionBoost;	// IMP=0x00000000000661fb
@property(nonatomic) _Bool hasRecentMotionBoost;
- (void)deleteRecentSiriRequestBoost;	// IMP=0x0000000000066185
@property(nonatomic) _Bool hasRecentSiriRequestBoost;
- (void)deleteRecentRaiseToWakeBoost;	// IMP=0x0000000000066111
@property(nonatomic) _Bool hasRecentRaiseToWakeBoost;
- (void)deleteRecentUnlockBoost;	// IMP=0x000000000006609d
@property(nonatomic) _Bool hasRecentUnlockBoost;
- (void)deleteDeviceBoost;	// IMP=0x000000000006602a
@property(nonatomic) _Bool hasDeviceBoost;
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000312c32
