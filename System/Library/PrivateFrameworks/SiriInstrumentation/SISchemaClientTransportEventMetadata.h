...
- (void).cxx_destruct;	// IMP=0x00000000000e3e02
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000e3b42
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000e3a84
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000e3819
- (unsigned long long)hash;	// IMP=0x00000000000e378b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e3451
- (void)writeTo:(id)arg1;	// IMP=0x00000000000e335c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000e334f
- (void)deleteArrivedServerPod;	// IMP=0x00000000000e333b
- (void)deleteServerArrivedTimestampNs;	// IMP=0x00000000000e32fc
@property(nonatomic) _Bool hasServerArrivedTimestampNs;
- (void)deleteEventTransmittedRelativeToBootTimeTimestampNs;	// IMP=0x00000000000e3288
@property(nonatomic) _Bool hasEventTransmittedRelativeToBootTimeTimestampNs;
- (void)deleteEventTransmittedTimestampRefId;	// IMP=0x00000000000e322e
- (id)suppressMessageUnderConditions;	// IMP=0x000000000031bfb6
