...
- (void).cxx_destruct;	// IMP=0x00000000002180c8
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000021545a
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000021539c
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000212c04
- (unsigned long long)hash;	// IMP=0x0000000000210556
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000020ddf0
- (void)writeTo:(id)arg1;	// IMP=0x000000000020d044
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000020a4e9
- (void)deleteSecondPassCheckerModelKeywordDetectionEndTimeInNs;	// IMP=0x000000000020a4be
@property(nonatomic) _Bool hasSecondPassCheckerModelKeywordDetectionEndTimeInNs;
- (void)deleteSecondPassCheckerModelKeywordDetectionStartTimeInNs;	// IMP=0x000000000020a42d
@property(nonatomic) _Bool hasSecondPassCheckerModelKeywordDetectionStartTimeInNs;
- (void)deleteSecondPassLastAudioPacketReceptionTimeInNs;	// IMP=0x000000000020a39e
@property(nonatomic) _Bool hasSecondPassLastAudioPacketReceptionTimeInNs;
- (void)deleteSecondPassFirstAudioPacketReceptionTimeInNs;	// IMP=0x000000000020a30f
@property(nonatomic) _Bool hasSecondPassFirstAudioPacketReceptionTimeInNs;
- (void)deleteSecondPassAudioStreamReadyTimeInNs;	// IMP=0x000000000020a27e
@property(nonatomic) _Bool hasSecondPassAudioStreamReadyTimeInNs;
- (void)deleteSecondPassAudioStreamStartTimeInNs;	// IMP=0x000000000020a1ed
@property(nonatomic) _Bool hasSecondPassAudioStreamStartTimeInNs;
- (void)deleteSecondPassAssetLoadCompleteTimeInNs;	// IMP=0x000000000020a15c
@property(nonatomic) _Bool hasSecondPassAssetLoadCompleteTimeInNs;
- (void)deleteSecondPassAssetLoadStartTimeInNs;	// IMP=0x000000000020a0cb
@property(nonatomic) _Bool hasSecondPassAssetLoadStartTimeInNs;
- (void)deleteSecondPassAssetQueryCompleteTimeInNs;	// IMP=0x000000000020a03a
@property(nonatomic) _Bool hasSecondPassAssetQueryCompleteTimeInNs;
- (void)deleteSecondPassAssetQueryStartTimeInNs;	// IMP=0x0000000000209fa9
@property(nonatomic) _Bool hasSecondPassAssetQueryStartTimeInNs;
- (void)deleteIsWakeFromSleep;	// IMP=0x0000000000209f18
@property(nonatomic) _Bool hasIsWakeFromSleep;
- (void)deleteIsBargeIn;	// IMP=0x0000000000209e8a
@property(nonatomic) _Bool hasIsBargeIn;
- (void)deleteDidAudioStall;	// IMP=0x0000000000209dfd
@property(nonatomic) _Bool hasDidAudioStall;
- (void)deleteSiriIsActiveOrOtherAssertion;	// IMP=0x0000000000209d70
@property(nonatomic) _Bool hasSiriIsActiveOrOtherAssertion;
- (void)deleteConfigDataHash;	// IMP=0x0000000000209cfa
- (void)deleteCaptureFilePath;	// IMP=0x0000000000209cd1
- (void)deleteLastConsecutiveVTRejects;	// IMP=0x0000000000209c91
@property(nonatomic) _Bool hasLastConsecutiveVTRejects;
- (void)deleteDowntimeInSec;	// IMP=0x0000000000209c05
@property(nonatomic) _Bool hasDowntimeInSec;
- (void)deleteUptimeInSec;	// IMP=0x0000000000209b77
@property(nonatomic) _Bool hasUptimeInSec;
- (void)deleteDidWakeAP;	// IMP=0x0000000000209aeb
@property(nonatomic) _Bool hasDidWakeAP;
- (void)deleteOnBatteryPower;	// IMP=0x0000000000209a66
@property(nonatomic) _Bool hasOnBatteryPower;
- (void)deleteAudioProviderUUID;	// IMP=0x00000000002099fb
- (void)deleteMediaVolume;	// IMP=0x00000000002099ba
@property(nonatomic) _Bool hasMediaVolume;
- (void)deleteIsMediaPlaying;	// IMP=0x0000000000209933
@property(nonatomic) _Bool hasIsMediaPlaying;
- (void)deleteHostPowerStateAtTrigger;	// IMP=0x00000000002098ae
@property(nonatomic) _Bool hasHostPowerStateAtTrigger;
- (void)deleteCumulativeDowntimeInSec;	// IMP=0x0000000000209828
@property(nonatomic) _Bool hasCumulativeDowntimeInSec;
- (void)deleteCumulativeUptimeInSec;	// IMP=0x00000000002097a0
@property(nonatomic) _Bool hasCumulativeUptimeInSec;
- (void)deleteTwoShotAudibleFeedbackDelayInNs;	// IMP=0x0000000000209719
@property(nonatomic) _Bool hasTwoShotAudibleFeedbackDelayInNs;
- (void)deleteActiveChannel;	// IMP=0x0000000000209693
@property(nonatomic) _Bool hasActiveChannel;
- (void)deleteDeviceHandheld;	// IMP=0x0000000000209611
@property(nonatomic) _Bool hasDeviceHandheld;
- (void)deleteIsSecondChance;	// IMP=0x000000000020958c
@property(nonatomic) _Bool hasIsSecondChance;
- (void)deleteConfigPath;	// IMP=0x000000000020951e
- (void)deleteConfigVersion;	// IMP=0x00000000002094f5
- (void)deleteTotalSamplesAtEndOfCapture;	// IMP=0x00000000002094b5
@property(nonatomic) _Bool hasTotalSamplesAtEndOfCapture;
- (void)deleteTotalSamplesAtTriggerEnd;	// IMP=0x000000000020942f
@property(nonatomic) _Bool hasTotalSamplesAtTriggerEnd;
- (void)deleteTotalSamplesAtTriggerStart;	// IMP=0x00000000002093a9
@property(nonatomic) _Bool hasTotalSamplesAtTriggerStart;
- (void)deleteTriggerDurationInNs;	// IMP=0x0000000000209322
@property(nonatomic) _Bool hasTriggerDurationInNs;
- (void)deleteIsContinuous;	// IMP=0x000000000020929b
@property(nonatomic) _Bool hasIsContinuous;
- (void)deleteHardwareSamplerate;	// IMP=0x0000000000209216
@property(nonatomic) _Bool hasHardwareSamplerate;
- (void)deleteTriggerFiredTime;	// IMP=0x0000000000209193
@property(nonatomic) _Bool hasTriggerFiredTime;
- (void)deleteTriggerEndTime;	// IMP=0x000000000020910b
@property(nonatomic) _Bool hasTriggerEndTime;
- (void)deleteTriggerStartTime;	// IMP=0x0000000000209083
@property(nonatomic) _Bool hasTriggerStartTime;
- (void)deleteTriggerFireTimeOffsetInNs;	// IMP=0x0000000000208ffc
@property(nonatomic) _Bool hasTriggerFireTimeOffsetInNs;
- (void)deleteTriggerEndTimeOffsetInNs;	// IMP=0x0000000000208f76
@property(nonatomic) _Bool hasTriggerEndTimeOffsetInNs;
- (void)deleteTriggerStartTimeOffsetInNs;	// IMP=0x0000000000208ef0
@property(nonatomic) _Bool hasTriggerStartTimeOffsetInNs;
- (void)deleteThreshold;	// IMP=0x0000000000208e69
@property(nonatomic) _Bool hasThreshold;
- (void)deleteRecognizerScaleFactor;	// IMP=0x0000000000208de1
@property(nonatomic) _Bool hasRecognizerScaleFactor;
- (void)deleteRecognizerWaitTimeInNs;	// IMP=0x0000000000208d5a
@property(nonatomic) _Bool hasRecognizerWaitTimeInNs;
- (void)deleteRecognizerThresholdOffset;	// IMP=0x0000000000208cd3
@property(nonatomic) _Bool hasRecognizerThresholdOffset;
- (void)deleteRecognizerScore;	// IMP=0x0000000000208c4b
@property(nonatomic) _Bool hasRecognizerScore;
- (void)deleteEffectiveThreshold;	// IMP=0x0000000000208bc3
@property(nonatomic) _Bool hasEffectiveThreshold;
- (void)deleteIsMaximized;	// IMP=0x0000000000208b3c
@property(nonatomic) _Bool hasIsMaximized;
- (void)deleteTriggerScore;	// IMP=0x0000000000208ab6
@property(nonatomic) _Bool hasTriggerScore;
- (void)deleteTotalSampleCount;	// IMP=0x0000000000208a2f
@property(nonatomic) _Bool hasTotalSampleCount;
- (void)deleteIsTriggerEvent;	// IMP=0x00000000002089a9
@property(nonatomic) _Bool hasIsTriggerEvent;
- (void)deleteAnalyzerTrailingSamples;	// IMP=0x0000000000208928
@property(nonatomic) _Bool hasAnalyzerTrailingSamples;
- (void)deleteAnalyzerPrependingSamples;	// IMP=0x00000000002088a5
@property(nonatomic) _Bool hasAnalyzerPrependingSamples;
- (void)deleteExtraSamplesAtStart;	// IMP=0x0000000000208822
@property(nonatomic) _Bool hasExtraSamplesAtStart;
- (void)deleteTriggerFireNs;	// IMP=0x000000000020879f
@property(nonatomic) _Bool hasTriggerFireNs;
- (void)deleteTriggerEndNs;	// IMP=0x000000000020871c
@property(nonatomic) _Bool hasTriggerEndNs;
- (void)deleteTriggerStartNs;	// IMP=0x0000000000208699
@property(nonatomic) _Bool hasTriggerStartNs;
- (void)deleteTriggerFireSampleCount;	// IMP=0x0000000000208616
@property(nonatomic) _Bool hasTriggerFireSampleCount;
- (void)deleteTriggerEndSampleCount;	// IMP=0x0000000000208593
@property(nonatomic) _Bool hasTriggerEndSampleCount;
- (void)deleteClientStartSampleCount;	// IMP=0x0000000000208510
@property(nonatomic) _Bool hasClientStartSampleCount;
- (void)deleteTriggerStartSampleCount;	// IMP=0x000000000020848d
@property(nonatomic) _Bool hasTriggerStartSampleCount;
- (void)deleteEnhancedCarplayTriggerMode;	// IMP=0x000000000020840a
@property(nonatomic) _Bool hasEnhancedCarplayTriggerMode;
- (void)deleteRemoteMicVADMyriadThreshold;	// IMP=0x0000000000208387
@property(nonatomic) _Bool hasRemoteMicVADMyriadThreshold;
- (void)deleteRemoteMicVADThreshold;	// IMP=0x0000000000208302
@property(nonatomic) _Bool hasRemoteMicVADThreshold;
- (void)deleteRemoteMicVADScore;	// IMP=0x000000000020827d
@property(nonatomic) _Bool hasRemoteMicVADScore;
- (void)deleteShadowMicScoreThresholdForVAD;	// IMP=0x00000000002081f8
@property(nonatomic) _Bool hasShadowMicScoreThresholdForVAD;
- (void)deleteShadowMicScore;	// IMP=0x0000000000208173
@property(nonatomic) _Bool hasShadowMicScore;
- (void)deleteTriggerExplicitTDSRSatScore;	// IMP=0x00000000002080ee
@property(nonatomic) _Bool hasTriggerExplicitTDSRSatScore;
- (void)deleteTriggerExplicitSatScore;	// IMP=0x000000000020806b
@property(nonatomic) _Bool hasTriggerExplicitSatScore;
- (void)deleteDeltaTimeInNsFromlastPHSReject;	// IMP=0x0000000000207fe7
@property(nonatomic) _Bool hasDeltaTimeInNsFromlastPHSReject;
- (void)deleteLastConsecutivePHSRejects;	// IMP=0x0000000000207f64
@property(nonatomic) _Bool hasLastConsecutivePHSRejects;
- (void)deleteSatBeingTrained;	// IMP=0x0000000000207ee2
@property(nonatomic) _Bool hasSatBeingTrained;
- (void)deleteBiometricClue;	// IMP=0x0000000000207e60
@property(nonatomic) _Bool hasBiometricClue;
- (void)deleteTdSpeakerRecognizerCombinationWeight;	// IMP=0x0000000000207ddd
@property(nonatomic) _Bool hasTdSpeakerRecognizerCombinationWeight;
- (void)deleteTdSpeakerRecognizerCombinedThreshold;	// IMP=0x0000000000207d58
@property(nonatomic) _Bool hasTdSpeakerRecognizerCombinedThreshold;
- (void)deleteTdSpeakerRecognizerCombinedScore;	// IMP=0x0000000000207cd4
@property(nonatomic) _Bool hasTdSpeakerRecognizerCombinedScore;
- (void)deleteTdSpeakerRecognizerScore;	// IMP=0x0000000000207c54
@property(nonatomic) _Bool hasTdSpeakerRecognizerScore;
- (void)deleteSatTriggered;	// IMP=0x0000000000207bd5
@property(nonatomic) _Bool hasSatTriggered;
- (void)deleteSatThreshold;	// IMP=0x0000000000207b57
@property(nonatomic) _Bool hasSatThreshold;
- (void)deleteSatNumTrainingUtterances;	// IMP=0x0000000000207ad8
@property(nonatomic) _Bool hasSatNumTrainingUtterances;
- (void)deleteSatScore;	// IMP=0x0000000000207a5d
@property(nonatomic) _Bool hasSatScore;
- (void)deleteSecondPassAnalyerEndSampleCount;	// IMP=0x00000000002079e1
@property(nonatomic) _Bool hasSecondPassAnalyerEndSampleCount;
- (void)deleteSecondPassAnalyerStartSampleCount;	// IMP=0x0000000000207967
@property(nonatomic) _Bool hasSecondPassAnalyerStartSampleCount;
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000032e376
- (id)suppressMessageUnderConditions;	// IMP=0x000000000032e33e
