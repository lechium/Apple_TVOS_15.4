...
- (void).cxx_destruct;	// IMP=0x0000000000306343
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000305c4d
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000305b8f
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000003055db
- (unsigned long long)hash;	// IMP=0x0000000000305494
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000304b32
- (void)writeTo:(id)arg1;	// IMP=0x0000000000304860
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000304853
- (void)deleteLinkId;	// IMP=0x000000000030483f
- (void)deleteGridCardSection;	// IMP=0x00000000003047f7
@property(retain, nonatomic) SISchemaGridCardSection *gridCardSection; // @synthesize gridCardSection=_gridCardSection;
- (void)deleteViewRegionDesignation;	// IMP=0x0000000000304772
@property(nonatomic) _Bool hasViewRegionDesignation;
- (void)deleteAceViewClass;	// IMP=0x0000000000304715
- (void)deleteAceViewID;	// IMP=0x00000000003046ec
- (void)deleteSiriResponseContext;	// IMP=0x00000000003046c3
- (void)deleteDialogIdentifier;	// IMP=0x000000000030469a
- (void)deleteSiriUILocation;	// IMP=0x000000000030465b
@property(nonatomic) _Bool hasSiriUILocation;
- (void)deleteSnippetClass;	// IMP=0x0000000000304602
- (void)deleteViewID;	// IMP=0x00000000003045d9
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000033e085
- (id)suppressMessageUnderConditions;	// IMP=0x000000000033e04d
