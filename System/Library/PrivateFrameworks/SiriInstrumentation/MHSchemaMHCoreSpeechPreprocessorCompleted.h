...
- (void).cxx_destruct;	// IMP=0x00000000001f0de3
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001f05e4
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000001f0526
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000001efe01
- (unsigned long long)hash;	// IMP=0x00000000001ef808
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ef311
- (void)writeTo:(id)arg1;	// IMP=0x00000000001ef060
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001eee00
- (id)midSegmentContinousZerosAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001eede3
- (unsigned long long)midSegmentContinousZerosCount;	// IMP=0x00000000001eedc6
- (void)addMidSegmentContinousZeros:(id)arg1;	// IMP=0x00000000001eed4c
- (void)deleteMidSegmentContinousZeros;	// IMP=0x00000000001eed3a
- (void)clearMidSegmentContinousZeros;	// IMP=0x00000000001eed1d
- (void)deleteMaxContinousZeros;	// IMP=0x00000000001eecf2
@property(nonatomic) _Bool hasMaxContinousZeros;
- (void)deleteInitialContinousZeros;	// IMP=0x00000000001eec76
@property(nonatomic) _Bool hasInitialContinousZeros;
- (void)deleteNumTotalOutputSamples;	// IMP=0x00000000001eebfb
@property(nonatomic) _Bool hasNumTotalOutputSamples;
- (void)deleteNumTotalInputSamples;	// IMP=0x00000000001eeb83
@property(nonatomic) _Bool hasNumTotalInputSamples;
- (void)deleteAboveNinetyFivepcOfMax;	// IMP=0x00000000001eeb0b
@property(nonatomic) _Bool hasAboveNinetyFivepcOfMax;
- (void)deleteAbsMaxVal;	// IMP=0x00000000001eea92
@property(nonatomic) _Bool hasAbsMaxVal;
- (void)deleteOriginalPower;	// IMP=0x00000000001eea19
@property(nonatomic) _Bool hasOriginalPower;
- (void)deleteSignalPower;	// IMP=0x00000000001ee9a0
@property(nonatomic) _Bool hasSignalPower;
- (void)deleteBeepPower;	// IMP=0x00000000001ee929
@property(nonatomic) _Bool hasBeepPower;
- (void)deleteStatsComputed;	// IMP=0x00000000001ee8b3
@property(nonatomic) _Bool hasStatsComputed;
- (void)deleteBeepLocation;	// IMP=0x00000000001ee840
@property(nonatomic) _Bool hasBeepLocation;
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000032cb38
- (id)suppressMessageUnderConditions;	// IMP=0x000000000032cb00
