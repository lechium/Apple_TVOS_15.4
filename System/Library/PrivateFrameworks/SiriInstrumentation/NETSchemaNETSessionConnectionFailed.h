...
- (void).cxx_destruct;	// IMP=0x0000000000254361
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000253d62
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000253ca4
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000025358f
- (unsigned long long)hash;	// IMP=0x0000000000253452
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000252ed0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000252cc3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000252cb6
- (void)deleteUnderlyingError;	// IMP=0x0000000000252ca2
- (void)deleteError;	// IMP=0x0000000000252c79
- (void)deletePolicyId;	// IMP=0x0000000000252c50
- (void)deleteSendBufferSize;	// IMP=0x0000000000252c11
@property(nonatomic) _Bool hasSendBufferSize;
- (void)deleteIsDormant;	// IMP=0x0000000000252b9b
@property(nonatomic) _Bool hasIsDormant;
- (void)deleteIsWwanPreferred;	// IMP=0x0000000000252b26
@property(nonatomic) _Bool hasIsWwanPreferred;
- (void)deleteNetworkSessionState;	// IMP=0x0000000000252ab1
@property(nonatomic) _Bool hasNetworkSessionState;
- (void)deleteSessionType;	// IMP=0x0000000000252a3c
@property(nonatomic) _Bool hasSessionType;
- (void)deleteConnectionMode;	// IMP=0x00000000002529c7
@property(nonatomic) _Bool hasConnectionMode;
- (void)deleteConnectionType;	// IMP=0x0000000000252954
@property(nonatomic) _Bool hasConnectionType;
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x0000000000331681
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000331649
