...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000029bfbc
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000029befe
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000029bca7
- (unsigned long long)hash;	// IMP=0x000000000029bc2c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000029bacf
- (void)writeTo:(id)arg1;	// IMP=0x000000000029ba20
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000029b67e
- (void)deleteNumberOfContactSuggestionsUpdated;	// IMP=0x000000000029b654
@property(nonatomic) _Bool hasNumberOfContactSuggestionsUpdated;
- (void)deleteNumberOfContactSuggestionsGenerated;	// IMP=0x000000000029b5df
@property(nonatomic) _Bool hasNumberOfContactSuggestionsGenerated;
- (void)deleteNumberOfGroundTruthsGenerated;	// IMP=0x000000000029b56a
@property(nonatomic) _Bool hasNumberOfGroundTruthsGenerated;
- (void)deleteNumberOfConversationsReviewed;	// IMP=0x000000000029b4f7
@property(nonatomic) _Bool hasNumberOfConversationsReviewed;
- (id)suppressMessageUnderConditions;	// IMP=0x00000000003368be
