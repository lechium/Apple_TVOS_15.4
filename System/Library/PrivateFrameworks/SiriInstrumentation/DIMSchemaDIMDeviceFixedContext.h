...
- (void).cxx_destruct;	// IMP=0x00000000000eda20
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000ed16a
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000ed0ac
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000eb254
- (unsigned long long)hash;	// IMP=0x00000000000eaf80
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ea587
- (void)writeTo:(id)arg1;	// IMP=0x00000000000ea238
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000e9a3a
- (void)deleteSiriInputLocaleV2;	// IMP=0x00000000000e9a26
- (void)deleteSystemLocaleV2;	// IMP=0x00000000000e99fd
- (void)deleteIsLowPowerModeEnabled;	// IMP=0x00000000000e99be
@property(nonatomic) _Bool hasIsLowPowerModeEnabled;
- (void)deleteWatchDeviceAttributes;	// IMP=0x00000000000e9940
...
- (void)deleteTimeIntervalSince1970;	// IMP=0x00000000000e98ba
@property(nonatomic) _Bool hasTimeIntervalSince1970;
- (void)deleteIsStoreDemoMode;	// IMP=0x00000000000e9843
@property(nonatomic) _Bool hasIsStoreDemoMode;
- (void)deleteSystemBuild;	// IMP=0x00000000000e97e4
- (void)deleteDeviceType;	// IMP=0x00000000000e97bb
- (void)deleteCountryCode;	// IMP=0x00000000000e977c
@property(nonatomic) _Bool hasCountryCode;
- (void)deleteTimezoneOffset;	// IMP=0x00000000000e971d
- (void)deleteDataSharingOptInState;	// IMP=0x00000000000e96de
@property(nonatomic) _Bool hasDataSharingOptInState;
- (void)deleteSiriVoiceSettings;	// IMP=0x00000000000e967f
- (void)deleteSiriInputLocale;	// IMP=0x00000000000e9640
@property(nonatomic) _Bool hasSiriInputLocale;
- (void)deleteSystemLocale;	// IMP=0x00000000000e95cd
@property(nonatomic) _Bool hasSystemLocale;
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000031c88f
- (id)suppressMessageUnderConditions;	// IMP=0x000000000031c857
