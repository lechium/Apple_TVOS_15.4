...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002478bc
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000002477fe
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000002470da
- (unsigned long long)hash;	// IMP=0x0000000000246ea5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002469f1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000246794
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000245c30
- (void)deleteSubflowSwitchCount;	// IMP=0x0000000000245c05
@property(nonatomic) _Bool hasSubflowSwitchCount;
- (void)deleteTfoSynDataAcked;	// IMP=0x0000000000245b8e
@property(nonatomic) _Bool hasTfoSynDataAcked;
- (void)deleteSynRetransmits;	// IMP=0x0000000000245b16
@property(nonatomic) _Bool hasSynRetransmits;
- (void)deleteSendBandwidth;	// IMP=0x0000000000245a9c
@property(nonatomic) _Bool hasSendBandwidth;
- (void)deleteSendBufferBytes;	// IMP=0x0000000000245a21
@property(nonatomic) _Bool hasSendBufferBytes;
- (void)deleteOutOfOrderBytesReceived;	// IMP=0x00000000002459a6
@property(nonatomic) _Bool hasOutOfOrderBytesReceived;
- (void)deleteDuplicateBytesReceived;	// IMP=0x000000000024592b
@property(nonatomic) _Bool hasDuplicateBytesReceived;
- (void)deleteBytesReceived;	// IMP=0x00000000002458b0
@property(nonatomic) _Bool hasBytesReceived;
- (void)deleteBytesUnacked;	// IMP=0x0000000000245836
@property(nonatomic) _Bool hasBytesUnacked;
- (void)deleteBytesRetransmitted;	// IMP=0x00000000002457bf
@property(nonatomic) _Bool hasBytesRetransmitted;
- (void)deleteBytesSent;	// IMP=0x0000000000245749
@property(nonatomic) _Bool hasBytesSent;
- (void)deletePacketsReceived;	// IMP=0x00000000002456d3
@property(nonatomic) _Bool hasPacketsReceived;
- (void)deletePacketsSent;	// IMP=0x000000000024565d
@property(nonatomic) _Bool hasPacketsSent;
- (void)deleteRttBest;	// IMP=0x00000000002455e7
@property(nonatomic) _Bool hasRttBest;
- (void)deleteRttVariance;	// IMP=0x0000000000245574
@property(nonatomic) _Bool hasRttVariance;
- (void)deleteRttSmoothed;	// IMP=0x0000000000245501
@property(nonatomic) _Bool hasRttSmoothed;
- (void)deleteRttCurrent;	// IMP=0x000000000024548f
@property(nonatomic) _Bool hasRttCurrent;
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000330eb6
