...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000046112
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000046054
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000045d18
- (unsigned long long)hash;	// IMP=0x0000000000045c5f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000045a7b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000045989
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000004597c
- (void)deleteIsCarPlayMuted;	// IMP=0x0000000000045952
@property(nonatomic) _Bool hasIsCarPlayMuted;
- (void)deleteIsEnabledForHeadphones;	// IMP=0x00000000000458dd
@property(nonatomic) _Bool hasIsEnabledForHeadphones;
- (void)deleteCarPlayStatus;	// IMP=0x0000000000045868
@property(nonatomic) _Bool hasCarPlayStatus;
- (void)deleteReplyWithoutConfirmation;	// IMP=0x00000000000457f3
@property(nonatomic) _Bool hasReplyWithoutConfirmation;
- (void)deleteProxCardSeen;	// IMP=0x000000000004577e
@property(nonatomic) _Bool hasProxCardSeen;
- (void)deleteIsEnabled;	// IMP=0x000000000004570b
@property(nonatomic) _Bool hasIsEnabled;
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000310c83
