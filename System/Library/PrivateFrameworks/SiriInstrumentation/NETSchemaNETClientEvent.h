...
- (void).cxx_destruct;	// IMP=0x0000000000240ae5
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002403ab
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000002402ed
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000023fb38
- (unsigned long long)hash;	// IMP=0x000000000023fa0f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023ef5b
- (void)writeTo:(id)arg1;	// IMP=0x000000000023eb98
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000023c30f
- (void)deleteDebugNetworkConnectionStateReadySnapshotCaptured;	// IMP=0x000000000023c2dc
...
- (void)deleteNetworkConnectionStateReadySnapshotCaptured;	// IMP=0x000000000023c192
...
- (void)deleteDebugNetworkConnectionStatePreparationSnapshotCaptured;	// IMP=0x000000000023c048
...
- (void)deleteNetworkConnectionStatePreparationSnapshotCaptured;	// IMP=0x000000000023befe
...
- (void)deletePeerConnectionFailed;	// IMP=0x000000000023bdb4
...
- (void)deleteSessionConnectionFailed;	// IMP=0x000000000023bc6a
...
- (void)deleteDebugSessionConnectionSnapshotCaptured;	// IMP=0x000000000023bb20
...
- (void)deleteSessionConnectionSnapshotCaptured;	// IMP=0x000000000023b9d6
...
- (void)deleteSessionConnectionHttpHeaderCreated;	// IMP=0x000000000023b88c
...
- (void)deleteEventMetadata;	// IMP=0x000000000023b761
- (id)qualifiedMessageName;	// IMP=0x000000000023b6a0
- (int)getAnyEventType;	// IMP=0x000000000023b695
- (id)applySensitiveConditionsPolicy:(id)arg1;	// IMP=0x000000000033057d
- (id)suppressMessageUnderConditions;	// IMP=0x0000000000330545
