...
- (void).cxx_destruct;	// IMP=0x000000000024f815
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000024f601
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000024f543
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000024f33f
- (unsigned long long)hash;	// IMP=0x000000000024f2d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000024f0b5
- (void)writeTo:(id)arg1;	// IMP=0x000000000024f001
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000024eff4
- (void)deleteConnectionEstablishmentAttemptDelay;	// IMP=0x000000000024efca
@property(nonatomic) _Bool hasConnectionEstablishmentAttemptDelay;
- (void)deleteConnectionEstablishmentPreviousAttemptCount;	// IMP=0x000000000024ef57
@property(nonatomic) _Bool hasConnectionEstablishmentPreviousAttemptCount;
- (void)deleteConnectionInfo;	// IMP=0x000000000024eefe
- (id)suppressMessageUnderConditions;	// IMP=0x000000000033145e
