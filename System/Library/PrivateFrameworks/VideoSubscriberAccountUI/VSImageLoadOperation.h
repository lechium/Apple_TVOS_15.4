...
- (void).cxx_destruct;	// IMP=0x00000000000605aa
...
- (void)cancel;	// IMP=0x0000000000060477
- (void)executionDidBegin;	// IMP=0x0000000000060136
- (void)_beginFetchingDataFromURL:(id)arg1;	// IMP=0x000000000005fef9
- (void)_finishWithImageData:(id)arg1 orError:(id)arg2;	// IMP=0x000000000005fbcf
- (id)initWithItemProvider:(id)arg1 preferredImageSize:(struct CGSize)arg2;	// IMP=0x000000000005fb1a
- (id)init;	// IMP=0x000000000005faab
