...
- (void).cxx_destruct;	// IMP=0x000000000004d755
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x000000000004d63b
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000004d470
- (id)init;	// IMP=0x000000000004d0d8
