...
+ (id)keyPathsForValuesAffectingAccessGranted;	// IMP=0x000000000002c22b
- (void).cxx_destruct;	// IMP=0x000000000002d8a3
...
- (id)appIconURLForSize:(struct CGSize)arg1;	// IMP=0x000000000002d736
- (id)appAdamIDs;	// IMP=0x000000000002d6ab
- (id)appBundleIDs;	// IMP=0x000000000002d620
- (id)name;	// IMP=0x000000000002d60e
@property(readonly, copy) NSString *description;
- (void)applicationsDidFailToUninstall:(id)arg1;	// IMP=0x000000000002d136
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x000000000002cee2
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x000000000002ccad
- (void)applicationsDidFailToInstall:(id)arg1;	// IMP=0x000000000002ca78
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x000000000002c79c
- (void)applicationsWillInstall:(id)arg1;	// IMP=0x000000000002c565
- (void)_denyPrivacyAccess;	// IMP=0x000000000002c441
- (void)_grantPrivacyAccess;	// IMP=0x000000000002c31a
@property(nonatomic, getter=isAccessGranted) _Bool accessGranted;
@property(readonly, nonatomic) _Bool canChangePrivacyAccess;
- (void)launchApp;	// IMP=0x000000000002c04b
- (void)installApp;	// IMP=0x000000000002bdaa
- (void)revokeVoucher;	// IMP=0x000000000002bcf6
...
- (id)iconURLForSize:(struct CGSize)arg1;	// IMP=0x000000000002bb01
@property(readonly, copy, nonatomic) NSURL *appStoreURL;
- (void)_updatePrivacyState;	// IMP=0x000000000002b9f2
- (id)initWithAppDescription:(id)arg1 privacyVoucher:(id)arg2 restrictionsCenter:(id)arg3 privacyFacade:(id)arg4;	// IMP=0x000000000002b5b2
- (id)initWithBundle:(struct __CFBundle *)arg1 restrictionsCenter:(id)arg2 privacyFacade:(id)arg3;	// IMP=0x000000000002b37f
- (id)initWithBundle:(struct __CFBundle *)arg1 restrictionsCenter:(id)arg2 privacyFacade:(id)arg3 adamID:(id)arg4;	// IMP=0x000000000002b309
- (id)init;	// IMP=0x000000000002b2af
- (void)dealloc;	// IMP=0x000000000002b256
- (id)initWithApplicationWorkspace:(id)arg1;	// IMP=0x000000000002afdc
