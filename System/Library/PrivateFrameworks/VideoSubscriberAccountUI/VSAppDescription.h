...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006ab61
- (void).cxx_destruct;	// IMP=0x000000000006b555
...
- (id)iconURLForSize:(struct CGSize)arg1;	// IMP=0x000000000006ace7
- (id)description;	// IMP=0x000000000006aca2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006ac48
- (unsigned long long)hash;	// IMP=0x000000000006ac0f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006abbf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006ab69
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006aae1
- (id)init;	// IMP=0x000000000006aa7d
