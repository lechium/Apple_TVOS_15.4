...
- (void).cxx_destruct;	// IMP=0x0000000000019578
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000019447
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000193b4
- (void)dealloc;	// IMP=0x000000000001937e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019329
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000018a6f
