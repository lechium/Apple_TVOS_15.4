...
- (void).cxx_destruct;	// IMP=0x000000000001d633
...
- (void)setupLayout;	// IMP=0x000000000001cd57
- (void)setupSeparatorContainer;	// IMP=0x000000000001ccf2
- (void)setupWebsiteContainer;	// IMP=0x000000000001cc5e
- (void)setupQRCodeContainer;	// IMP=0x000000000001cbf9
- (void)buttonLockupPressed;	// IMP=0x000000000001cbbc
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000001cb1c
- (void)setupViews;	// IMP=0x000000000001cae1
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000001ca72
