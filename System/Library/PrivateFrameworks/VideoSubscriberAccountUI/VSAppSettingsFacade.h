...
- (void).cxx_destruct;	// IMP=0x000000000006f515
...
- (void)presentMVPDAppInstallPromptFromViewController:(id)arg1;	// IMP=0x000000000006ef4c
- (_Bool)shouldShowMVPDAppInstallPrompt;	// IMP=0x000000000006ee69
- (_Bool)shouldShowMVPDAppInstallPromptFromViewController:(id)arg1;	// IMP=0x000000000006ee3b
- (void)_setNeedsUpdateApps;	// IMP=0x000000000006ea26
- (id)viewModelsForAppDescriptions:(id)arg1 bundleByBundleID:(id)arg2 vouchersForProvider:(id)arg3 restrictionsCenter:(id)arg4 privacyFacade:(id)arg5;	// IMP=0x000000000006e3fd
- (id)viewModelsForChannelAppDescriptions:(id)arg1 andNonChannelAppDescriptions:(id)arg2;	// IMP=0x000000000006dcc0
- (void)_updateApps;	// IMP=0x000000000006c42d
- (void)dealloc;	// IMP=0x000000000006c3e3
- (id)init;	// IMP=0x000000000006c374
- (id)initWithStorage:(id)arg1 restrictionsCenter:(id)arg2;	// IMP=0x000000000006bf73
- (id)autorelease;	// IMP=0x000000000001b3e2
- (oneway void)release;	// IMP=0x000000000001b3ac
- (id)retain;	// IMP=0x000000000001b376
