...
- (void).cxx_destruct;	// IMP=0x0000000000064210
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000063fbd
- (unsigned long long)hash;	// IMP=0x0000000000063f24
- (id)description;	// IMP=0x0000000000063e0b
