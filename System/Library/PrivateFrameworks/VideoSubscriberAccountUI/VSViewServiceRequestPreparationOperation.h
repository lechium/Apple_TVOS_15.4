...
- (void).cxx_destruct;	// IMP=0x0000000000024f1a
...
- (void)cancel;	// IMP=0x0000000000024cac
- (void)executionDidBegin;	// IMP=0x0000000000024c9a
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x0000000000024926
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x00000000000242f4
- (void)_checkSupportedProviders;	// IMP=0x0000000000023c14
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x0000000000023376
- (void)_checkAvailability;	// IMP=0x00000000000231f3
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x0000000000023054
- (void)_checkPrivacy;	// IMP=0x0000000000022874
- (void)_checkEntitlement;	// IMP=0x000000000002272c
- (void)_finishWithError:(id)arg1;	// IMP=0x0000000000022616
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000022593
- (void)dealloc;	// IMP=0x000000000002254a
- (id)init;	// IMP=0x00000000000222f7
