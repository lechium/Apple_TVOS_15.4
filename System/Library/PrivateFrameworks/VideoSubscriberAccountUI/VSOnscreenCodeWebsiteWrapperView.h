...
- (void)buttonLockupPressed;	// IMP=0x0000000000063447
- (void)setupLocalizedStrings;	// IMP=0x000000000006321e
- (void)setupLayout;	// IMP=0x00000000000616df
- (void)setupDetailsView;	// IMP=0x000000000006135d
- (void)setupInfoView;	// IMP=0x0000000000061270
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x0000000000061127
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000006109e
