...
- (void).cxx_destruct;	// IMP=0x0000000000018394
...
- (id)removeAllMessages;	// IMP=0x0000000000018305
- (void)addMessage:(id)arg1;	// IMP=0x00000000000181e7
- (id)init;	// IMP=0x00000000000180eb
