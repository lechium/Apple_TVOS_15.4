...
- (void).cxx_destruct;	// IMP=0x0000000000014e41
...
- (void)cancel;	// IMP=0x0000000000014cff
- (void)_registerSubscriptions:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x0000000000014945
- (void)_removeSubscriptionsForBundleIdentifiers:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x000000000001430d
- (id)_authorizedBundleIdsFromAppDescriptions:(id)arg1;	// IMP=0x000000000001416c
- (void)executionDidBegin;	// IMP=0x0000000000013531
- (id)initWithRegistrationCenter:(id)arg1 andDeveloperSettingsFetchOperation:(id)arg2;	// IMP=0x0000000000013496
- (id)init;	// IMP=0x00000000000133ad
