...
- (void).cxx_destruct;	// IMP=0x00000000000588d5
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000058668
- (void)didSelectManualSignInButton;	// IMP=0x000000000005861c
- (id)init;	// IMP=0x0000000000058558
