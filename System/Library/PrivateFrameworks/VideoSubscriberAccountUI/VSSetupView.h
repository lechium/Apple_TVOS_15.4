...
- (void).cxx_destruct;	// IMP=0x0000000000080a05
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000805e3
- (void)_appsButtonPressed:(id)arg1;	// IMP=0x0000000000080586
- (void)_skipButtonPressed:(id)arg1;	// IMP=0x000000000008053a
- (void)_beginButtonPressed:(id)arg1;	// IMP=0x00000000000804ee
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000007ffb1
- (void)dealloc;	// IMP=0x000000000007ff7b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000007ff26
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007e059
