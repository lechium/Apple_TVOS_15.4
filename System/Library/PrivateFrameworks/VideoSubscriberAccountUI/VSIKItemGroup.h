...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0000000000019fdc
+ (void)registerFeature;	// IMP=0x0000000000019faa
- (void).cxx_destruct;	// IMP=0x000000000001a3e0
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000001a073
