...
- (void).cxx_destruct;	// IMP=0x000000000001e269
...
- (id)formattedWebsiteURL;	// IMP=0x000000000001ddc4
- (id)websiteURLWithQueryParameters;	// IMP=0x000000000001d8b7
- (void)generateQRCode;	// IMP=0x000000000001d6e8
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000001d684
