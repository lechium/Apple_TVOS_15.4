...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x00000000000574b9
- (void).cxx_destruct;	// IMP=0x0000000000057810
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000057681
- (id)toVSSubscription;	// IMP=0x0000000000057353
- (id)init;	// IMP=0x0000000000057275
