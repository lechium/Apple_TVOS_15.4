...
- (void).cxx_destruct;	// IMP=0x000000000000e907
...
- (void)viewDidLoad;	// IMP=0x000000000000d9a5
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000000d912
- (void)identityProviderSearchResultsViewController:(id)arg1 didPickStorefront:(id)arg2;	// IMP=0x000000000000d8fd
- (void)identityProviderSearchResultsViewControllerDidPickAdditionalIdentityProviders:(id)arg1;	// IMP=0x000000000000d8eb
- (void)identityProviderSearchResultsViewController:(id)arg1 didPickIdentityProvider:(id)arg2;	// IMP=0x000000000000d8d6
- (void)deselectSelectedProviderAnimated:(_Bool)arg1;	// IMP=0x000000000000d742
- (void)_handleMenuButtonRecognizer:(id)arg1;	// IMP=0x000000000000d730
- (void)_didPickStorefront:(id)arg1;	// IMP=0x000000000000d5ec
- (void)_didPickAdditionalIdentityProviders;	// IMP=0x000000000000d473
- (void)_didPickIdentityProvider:(id)arg1;	// IMP=0x000000000000d3f9
- (void)_didCancel;	// IMP=0x000000000000d39c
- (id)_message;	// IMP=0x000000000000d1a1
- (id)_header;	// IMP=0x000000000000d0c2
- (void)setRequestedStorefrontCountryCode:(id)arg1 defaultToDeveloperProviders:(_Bool)arg2;	// IMP=0x000000000000cba6
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000cab2
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000c7cc
