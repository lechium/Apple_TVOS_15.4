...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0000000000008836
+ (Class)transformedValueClass;	// IMP=0x0000000000008825
@property(nonatomic) struct CGSize preferredSize; // @synthesize preferredSize=_preferredSize;
- (id)transformedValue:(id)arg1;	// IMP=0x000000000000883e
