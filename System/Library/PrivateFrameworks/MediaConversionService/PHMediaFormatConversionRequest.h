...
+ (double)heifToJPEGFactorForBitsPerPixel:(double)arg1;	// IMP=0x0000000000010eee
+ (double)bitsPerPixelWithImageDimensions:(struct CGSize)arg1 fileLength:(unsigned long long)arg2;	// IMP=0x0000000000010ebb
+ (double)heifToJPEGFactorWithImageDimensions:(struct CGSize)arg1 fileLength:(unsigned long long)arg2;	// IMP=0x0000000000010e58
+ (_Bool)hasInternalDiagnostics;	// IMP=0x0000000000010e2d
+ (id)requestForSource:(id)arg1 destinationCapabilities:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000010cac
+ (id)stringForRequestStatus:(long long)arg1;	// IMP=0x0000000000010c4a
...
- (void)updateSinglePassVideoConversionStatus:(long long)arg1 addedRange:(struct _NSRange)arg2 error:(id)arg3;	// IMP=0x00000000000106a1
- (void)enableSinglePassVideoEncodingWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000105bf
- (void)didFinishProcessing;	// IMP=0x00000000000104a4
- (void)padOutputFileToEstimatedLength;	// IMP=0x0000000000010202
@property(nonatomic) double formatConversionExpansionFactor;
@property(readonly) unsigned long long estimatedOutputFileLength;
- (_Bool)userPreferenceProhibitsFormatConversion;	// IMP=0x000000000000fd39
@property(readonly) NSString *outputFileType;
@property(readonly) NSString *outputPathExtension;
- (void)setAccessibilityDescriptionMetadataBehavior:(long long)arg1 withAccessibilityDescription:(id)arg2;	// IMP=0x000000000000f86d
- (void)setCaptionMetadataBehavior:(long long)arg1 withCaption:(id)arg2;	// IMP=0x000000000000f760
- (void)setCreationDateMetadataBehavior:(long long)arg1 withCreationDate:(id)arg2 inTimeZone:(id)arg3;	// IMP=0x000000000000f5ae
- (void)setLocationMetadataBehavior:(long long)arg1 withLocation:(id)arg2;	// IMP=0x000000000000f4a8
- (_Bool)destinationCapabilitiesHintsIndicateSupportForSource;	// IMP=0x000000000000f088
@property(readonly) _Bool requiresFormatConversion;
- (_Bool)requiresAccessibilityDescriptionMetadataChange;	// IMP=0x000000000000e9d2
- (_Bool)requiresCaptionMetadataChange;	// IMP=0x000000000000e923
- (_Bool)requiresCreationDateMetadataChange;	// IMP=0x000000000000e8d3
- (_Bool)requiresLocationMetadataChange;	// IMP=0x000000000000e824
- (_Bool)requiresLivePhotoPairingIdentifierChange;	// IMP=0x000000000000e67d
@property(readonly) _Bool requiresMetadataChanges;
- (_Bool)sourceSupportsPassthroughConversion;	// IMP=0x000000000000e369
@property(readonly) _Bool requiresPassthroughConversion;
@property(readonly) long long backwardsCompatibilityStatus;
- (void)preflightWithConversionManager:(id)arg1;	// IMP=0x000000000000dc4c
- (void)markAsCancelled;	// IMP=0x000000000000dbdb
- (void)setupProgress;	// IMP=0x000000000000db9d
@property(readonly) _Bool isCompositeRequest;
@property(readonly) NSString *statusString;
@property(readonly, copy) NSString *description;
- (_Bool)prepareWithError:(id *)arg1;	// IMP=0x000000000000d9dd
- (id)init;	// IMP=0x000000000000d7ed
