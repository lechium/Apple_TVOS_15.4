...
- (void).cxx_destruct;	// IMP=0x000000000000b6da
@property long long mediaType; // @synthesize mediaType=_mediaType;
@property(retain) NSURL *fileURL; // @synthesize fileURL=_fileURL;
- (id)description;	// IMP=0x000000000000b5de
@property(readonly) NSString *fileSignature;
@property(readonly) NSString *fileType;
- (id)typeFromFileExtensionWithError:(id *)arg1;	// IMP=0x000000000000b172
- (_Bool)isAssetBundle;	// IMP=0x000000000000b164
- (_Bool)isImage;	// IMP=0x000000000000b156
