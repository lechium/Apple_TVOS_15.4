...
- (void).cxx_destruct;	// IMP=0x000000000001f285
...
- (void)stopObserving;	// IMP=0x000000000001f199
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001eec5
- (void)startObservingProgress:(id)arg1 forRequest:(id)arg2;	// IMP=0x000000000001eba3
