...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000350e
...
- (id)description;	// IMP=0x00000000000038c3
- (id)initWithEmbeddingType:(unsigned long long)arg1 assetCreationDate:(id)arg2 data:(id)arg3 checksum:(id)arg4 andThumbnail:(id)arg5;	// IMP=0x000000000000378a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003696
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003516
