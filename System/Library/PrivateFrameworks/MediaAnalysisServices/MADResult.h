...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001e55
@property(readonly, nonatomic) CDStruct_e83c9415 timerange; // @synthesize timerange=_timerange;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002013
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001ee9
@property(readonly) double executionTimeInterval;
- (void)setExecutionNanoseconds:(unsigned long long)arg1;	// IMP=0x0000000000001eb9
