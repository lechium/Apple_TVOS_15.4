...
- (void)fetchTypeURL:(id)arg1;	// IMP=0x000000000003fabd
- (_Bool)addType:(id)arg1 toItemAtIndex:(unsigned long long)arg2;	// IMP=0x000000000003f470
- (_Bool)addItem:(id)arg1;	// IMP=0x000000000003f1e6
- (id)getTypePaths;	// IMP=0x000000000003f19e
- (id)initWithGeneration:(unsigned long long)arg1;	// IMP=0x000000000003f0ce
