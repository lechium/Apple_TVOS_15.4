...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004604a
- (void).cxx_destruct;	// IMP=0x0000000000046c0e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000468c8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000046675
- (unsigned long long)hash;	// IMP=0x000000000004665f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000465b1
@property(readonly, copy) NSDate *when; // @dynamic when;
- (id)debugDescription;	// IMP=0x00000000000463dc
- (id)description;	// IMP=0x000000000004630d
- (id)initWithBundleIdentifier:(id)arg1 uuid:(id)arg2 activityType:(id)arg3 dynamicIdentifier:(id)arg4 lastUpdateTime:(id)arg5 lastActiveTime:(id)arg6 type:(unsigned long long)arg7 deviceName:(id)arg8 deviceIdentifier:(id)arg9 deviceType:(id)arg10 options:(id)arg11 isActive:(_Bool)arg12;	// IMP=0x0000000000046052
