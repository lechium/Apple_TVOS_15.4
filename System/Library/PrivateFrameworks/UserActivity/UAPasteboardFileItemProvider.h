...
+ (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000003e5d4
- (void).cxx_destruct;	// IMP=0x000000000003ed00
...
- (void)accessFileAtURLWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e85c
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e6a0
- (void)getDataFileWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e68e
- (id)getFileName;	// IMP=0x000000000003e63e
- (id)initWithURL:(id)arg1 sandboxExtension:(id)arg2;	// IMP=0x000000000003e2da
