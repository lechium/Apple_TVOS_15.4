...
- (void).cxx_destruct;	// IMP=0x000000000001e49c
...
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001dd7f
- (id)initWithType:(id)arg1 fileHandle:(id)arg2 offsetInFile:(id)arg3 size:(long long)arg4;	// IMP=0x000000000001dc6e
