...
- (void).cxx_destruct;	// IMP=0x0000000000035314
...
- (id)streamError;	// IMP=0x0000000000035231
- (unsigned long long)streamStatus;	// IMP=0x000000000003521f
- (void)close;	// IMP=0x0000000000035208
- (void)open;	// IMP=0x00000000000351ca
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000351c2
- (id)propertyForKey:(id)arg1;	// IMP=0x00000000000351ba
- (_Bool)getBuffer:(char **)arg1 length:(unsigned long long *)arg2;	// IMP=0x00000000000351b2
- (long long)read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0000000000034e12
- (_Bool)hasBytesAvailable;	// IMP=0x0000000000034db2
- (id)initWithFileHandle:(id)arg1 offsetInFile:(id)arg2 size:(long long)arg3;	// IMP=0x0000000000034ccf
