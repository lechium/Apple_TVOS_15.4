...
+ (id)encodedInfoToOldEncodedInfo:(id)arg1;	// IMP=0x0000000000022296
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001ebf5
- (void).cxx_destruct;	// IMP=0x00000000000236d6
...
- (id)statusString;	// IMP=0x0000000000023083
- (id)description;	// IMP=0x00000000000227e1
- (id)logString;	// IMP=0x000000000002238a
- (id)archiveUserActivityInfo;	// IMP=0x0000000000022207
- (void)clearPayload;	// IMP=0x00000000000221f3
- (_Bool)wasResumedOnAnotherDeviceWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000221e3
- (_Bool)requestPayloadWithCompletionHandlerEvenIfClean:(_Bool)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000221d3
- (void)fetchAllNearbyAppSuggestions:(CDUnknownBlockType)arg1;	// IMP=0x00000000000221c3
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000221ac
- (id)optionalUserActivityData;	// IMP=0x0000000000022119
- (id)secondaryUserActivityString;	// IMP=0x0000000000022085
- (id)userActivityString;	// IMP=0x0000000000021ff1
- (void)_createUserActivityStrings:(id)arg1 secondaryString:(id)arg2 optionalData:(id)arg3;	// IMP=0x0000000000020f7d
- (_Bool)setPayload:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000020e38
- (id)payloadForIdentifier:(id)arg1;	// IMP=0x0000000000020d99
- (id)payloadIdentifiers;	// IMP=0x0000000000020d27
@property(copy) NSDictionary *payloads;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002078b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001fedb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001f2ca
- (id)initWithArchivedUserActivityInfo:(id)arg1;	// IMP=0x000000000001f23d
- (id)initWithUserActivityInfo:(id)arg1;	// IMP=0x000000000001ed1a
- (id)initWithUUID:(id)arg1 type:(unsigned long long)arg2 options:(id)arg3;	// IMP=0x000000000001ebfd
