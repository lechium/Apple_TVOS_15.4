...
+ (_Bool)educationModeEnabled;	// IMP=0x000000000001fe9a
+ (id)sharedInstance;	// IMP=0x000000000001f13f
- (void).cxx_destruct;	// IMP=0x0000000000020f85
...
- (void)gatherTelephonyData;	// IMP=0x0000000000020546
@property(nonatomic) _Bool isPersonalizedAdsEnabled;
- (_Bool)isRestrictedByScreenTime;	// IMP=0x0000000000020346
- (void)setIdentifierForAdvertisingAllowed:(_Bool)arg1;	// IMP=0x00000000000202e9
- (_Bool)isAccountRestricted;	// IMP=0x0000000000020189
- (void)reloadStorefront:(CDUnknownBlockType)arg1;	// IMP=0x00000000000200f8
- (_Bool)purpleBuddyWillRun;	// IMP=0x00000000000200f0
- (int)deviceRunStateForBundleIdentifier:(id)arg1;	// IMP=0x000000000001ff58
- (id)deviceDescription;	// IMP=0x000000000001fea2
...
- (void)expire;	// IMP=0x000000000001f360
- (id)init;	// IMP=0x000000000001f1cc
