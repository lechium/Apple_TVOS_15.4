...
- (void).cxx_destruct;	// IMP=0x0000000000005a03
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000058c0
- (unsigned long long)hash;	// IMP=0x0000000000005711
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000055ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000054b0
- (void)copyTo:(id)arg1;	// IMP=0x00000000000053e9
- (void)writeTo:(id)arg1;	// IMP=0x000000000000531d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005310
- (id)dictionaryRepresentation;	// IMP=0x0000000000004e14
- (id)description;	// IMP=0x0000000000004d65
