...
+ (id)options;	// IMP=0x000000000002c70c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002d402
- (unsigned long long)hash;	// IMP=0x000000000002d310
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d142
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002cfed
- (void)copyTo:(id)arg1;	// IMP=0x000000000002ceed
- (void)writeTo:(id)arg1;	// IMP=0x000000000002cde9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002cddc
- (id)dictionaryRepresentation;	// IMP=0x000000000002c902
- (id)description;	// IMP=0x000000000002c853
