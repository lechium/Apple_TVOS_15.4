...
+ (id)options;	// IMP=0x000000000002a414
- (void).cxx_destruct;	// IMP=0x000000000002bab1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002b851
- (unsigned long long)hash;	// IMP=0x000000000002b6ea
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b472
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b2d4
- (void)copyTo:(id)arg1;	// IMP=0x000000000002b17f
- (void)writeTo:(id)arg1;	// IMP=0x000000000002b019
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002b00c
- (id)dictionaryRepresentation;	// IMP=0x000000000002a721
- (id)description;	// IMP=0x000000000002a672
