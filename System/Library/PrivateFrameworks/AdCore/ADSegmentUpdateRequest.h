...
+ (id)options;	// IMP=0x000000000001494e
- (void).cxx_destruct;	// IMP=0x00000000000174ad
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000170cb
- (unsigned long long)hash;	// IMP=0x0000000000016c6f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016970
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001674d
- (void)copyTo:(id)arg1;	// IMP=0x000000000001644c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000016239
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001622c
- (id)dictionaryRepresentation;	// IMP=0x000000000001536d
- (id)description;	// IMP=0x00000000000152be
- (int)StringAsAccountStates:(id)arg1;	// IMP=0x000000000001522c
- (id)accountStatesAsString:(int)arg1;	// IMP=0x00000000000151c6
- (void)setAccountStates:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000151af
- (int)accountStateAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000150e2
- (void)addAccountState:(int)arg1;	// IMP=0x00000000000150cf
- (void)clearAccountStates;	// IMP=0x00000000000150be
@property(readonly, nonatomic) int *accountStates;
@property(readonly, nonatomic) unsigned long long accountStatesCount;
- (int)StringAsAccountTypes:(id)arg1;	// IMP=0x0000000000014f84
- (id)accountTypesAsString:(int)arg1;	// IMP=0x0000000000014edf
- (void)setAccountTypes:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000014ec8
- (int)accountTypeAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000014dfb
- (void)addAccountType:(int)arg1;	// IMP=0x0000000000014de8
- (void)clearAccountTypes;	// IMP=0x0000000000014dd7
@property(readonly, nonatomic) int *accountTypes;
@property(readonly, nonatomic) unsigned long long accountTypesCount;
- (int)StringAsDeviceModes:(id)arg1;	// IMP=0x0000000000014d22
- (id)deviceModesAsString:(int)arg1;	// IMP=0x0000000000014cbc
- (void)setDeviceModes:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000014ca5
- (int)deviceModeAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000014bd8
- (void)addDeviceMode:(int)arg1;	// IMP=0x0000000000014bc5
- (void)clearDeviceModes;	// IMP=0x0000000000014bb4
