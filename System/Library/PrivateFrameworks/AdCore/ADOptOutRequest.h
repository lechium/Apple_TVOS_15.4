...
+ (id)options;	// IMP=0x000000000001016c
- (void).cxx_destruct;	// IMP=0x00000000000112a9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000011137
- (unsigned long long)hash;	// IMP=0x0000000000010db4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010c2b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010b0b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000010a29
- (void)writeTo:(id)arg1;	// IMP=0x0000000000010939
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001092c
- (id)dictionaryRepresentation;	// IMP=0x00000000000103bf
- (id)description;	// IMP=0x0000000000010310
