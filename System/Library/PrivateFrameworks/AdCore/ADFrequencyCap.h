...
- (void).cxx_destruct;	// IMP=0x0000000000008955
...
- (id)dictionaryRepresentation;	// IMP=0x000000000000878a
- (id)splitCapData:(id)arg1;	// IMP=0x0000000000008553
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000008425
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000008300
