...
+ (id)options;	// IMP=0x00000000000021c0
- (void).cxx_destruct;	// IMP=0x000000000000465e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000042f3
- (unsigned long long)hash;	// IMP=0x0000000000003c21
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000038ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000363f
- (void)copyTo:(id)arg1;	// IMP=0x0000000000003441
- (void)writeTo:(id)arg1;	// IMP=0x0000000000003241
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000003234
- (id)dictionaryRepresentation;	// IMP=0x00000000000027d8
- (id)description;	// IMP=0x0000000000002729
- (int)StringAsDownloadType:(id)arg1;	// IMP=0x0000000000002697
- (id)downloadTypeAsString:(int)arg1;	// IMP=0x0000000000002631
...
- (int)StringAsRunState:(id)arg1;	// IMP=0x0000000000002462
- (id)runStateAsString:(int)arg1;	// IMP=0x00000000000023fc
