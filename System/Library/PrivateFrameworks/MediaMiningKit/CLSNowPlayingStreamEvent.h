...
+ (id)playbackStreamEventDateSortDescriptors;	// IMP=0x000000000005e114
- (void).cxx_destruct;	// IMP=0x000000000005e36d
...
- (id)description;	// IMP=0x000000000005e1f6
- (id)initWithDuetKnowledgeEvent:(id)arg1;	// IMP=0x000000000005e3a0
