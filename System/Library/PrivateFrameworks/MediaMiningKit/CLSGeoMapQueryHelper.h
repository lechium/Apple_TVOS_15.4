...
- (void).cxx_destruct;	// IMP=0x000000000001501b
...
- (void)dealloc;	// IMP=0x0000000000014ec8
- (void)cancel;	// IMP=0x0000000000014e7d
- (void)_cancel;	// IMP=0x0000000000014e4c
- (void)_handleError:(id)arg1;	// IMP=0x0000000000014d4a
- (void)_heartBeat;	// IMP=0x0000000000014a84
- (void)_startQuery;	// IMP=0x0000000000014931
- (void)_handleQueryResultsForQuery:(id)arg1 error:(id)arg2;	// IMP=0x0000000000014799
- (void)_forwardToGeoThread;	// IMP=0x00000000000146c1
- (void)launchQueryWithCancellerBlock:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000014602
- (id)initWithQueryObject:(id)arg1;	// IMP=0x000000000001440b
