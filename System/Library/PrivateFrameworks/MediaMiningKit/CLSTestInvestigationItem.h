...
+ (id)itemWithUniversalDate:(id)arg1 sceneClassifications:(id)arg2;	// IMP=0x000000000005698f
+ (id)itemWithPeopleNames:(id)arg1 universalDate:(id)arg2 coordinate:(struct CLLocationCoordinate2D)arg3;	// IMP=0x000000000005689d
- (void).cxx_destruct;	// IMP=0x0000000000056814
...
- (_Bool)clsAvoidIfPossibleAsKeyItemForMemories:(_Bool)arg1 allowGuestAsset:(_Bool)arg2;	// IMP=0x0000000000056518
- (double)scoreInContext:(id)arg1;	// IMP=0x00000000000564f9
...
- (id)init;	// IMP=0x00000000000562ea
