...
+ (id)playbackStreamSessionDateSortDescriptors;	// IMP=0x0000000000062913
- (void).cxx_destruct;	// IMP=0x0000000000062cec
...
- (id)debugDescription;	// IMP=0x0000000000062b49
- (id)description;	// IMP=0x00000000000629f5
- (id)initWithDataCluster:(id)arg1;	// IMP=0x0000000000063043
- (id)initWithEvents:(id)arg1;	// IMP=0x0000000000062d1f
