...
+ (id)feederPrefetchOptionsWithDefaultMode:(unsigned long long)arg1;	// IMP=0x0000000000047bec
...
- (void)mergeWithFeederPrefetchOptions:(id)arg1;	// IMP=0x0000000000047a63
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000047a11
- (id)init;	// IMP=0x00000000000479ca
