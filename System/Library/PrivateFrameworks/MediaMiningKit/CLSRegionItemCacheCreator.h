...
+ (id)businessItemsForRegion:(id)arg1;	// IMP=0x000000000002642a
- (void).cxx_destruct;	// IMP=0x0000000000025461
...
- (_Bool)createCacheForRegions:(id)arg1 progressBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x00000000000248e1
- (id)initWithQueryPerformers:(id)arg1;	// IMP=0x000000000002483b
