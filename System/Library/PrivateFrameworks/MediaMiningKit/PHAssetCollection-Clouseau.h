...
- (id)_fetchFirstAssetSortedByCreationDateAscending:(_Bool)arg1;	// IMP=0x000000000009781a
- (id)_legacyLocalEndDate;	// IMP=0x00000000000977a9
- (id)_legacyLocalStartDate;	// IMP=0x0000000000097735
- (id)_legacyUniversalEndDate;	// IMP=0x000000000009766e
- (id)_legacyUniversalStartDate;	// IMP=0x00000000000975a4
- (id)_legacyLocalEndDateComponents;	// IMP=0x0000000000097533
- (id)_legacyLocalStartDateComponents;	// IMP=0x00000000000974bf
