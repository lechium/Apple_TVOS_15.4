...
- (void).cxx_destruct;	// IMP=0x000000000006e816
...
- (id)description;	// IMP=0x000000000006e640
@property(readonly) CLLocation *geoLocation;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006e571
- (unsigned long long)hash;	// IMP=0x000000000006e55b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006e3d2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006e0d7
- (id)initWithEKEvent:(id)arg1;	// IMP=0x000000000006dc4b
