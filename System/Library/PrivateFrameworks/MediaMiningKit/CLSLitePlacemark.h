...
+ (_Bool)_isIslandForGeoMapItem:(id)arg1;	// IMP=0x00000000000938d9
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000938d1
+ (id)litePlacemarkFromCLPlacemark:(id)arg1;	// IMP=0x0000000000093884
- (void).cxx_destruct;	// IMP=0x0000000000093727
...
- (id)description;	// IMP=0x00000000000934a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000092b87
- (void)_extractValuesFromGeoMapItem:(id)arg1;	// IMP=0x0000000000092933
@property(readonly, nonatomic) _Bool isOcean;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009274b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000092388
- (id)initWithRTMapItem:(id)arg1;	// IMP=0x0000000000091dcd
- (id)initWithCLPlacemark:(id)arg1;	// IMP=0x0000000000091cc2
