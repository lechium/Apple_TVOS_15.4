...
- (void).cxx_destruct;	// IMP=0x0000000000089b77
...
- (void)cancel;	// IMP=0x0000000000089a36
- (void)_cancel;	// IMP=0x0000000000089a05
- (void)_handleError:(id)arg1;	// IMP=0x0000000000089863
- (void)_heartBeat;	// IMP=0x000000000008959d
- (void)_startQuery;	// IMP=0x000000000008944a
- (void)_handleQueryResultsForQuery:(id)arg1 error:(id)arg2;	// IMP=0x0000000000089304
- (void)launchQueryWithCancellerBlock:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000089245
- (id)initWithQueryObject:(id)arg1;	// IMP=0x000000000008904e
