...
+ (double)defaultPrecision;	// IMP=0x000000000001661f
+ (unsigned long long)numberOfRegionsPerBatch;	// IMP=0x0000000000016614
+ (id)queryWithTemplate:(id)arg1 forRegions:(id)arg2;	// IMP=0x000000000001657a
- (void).cxx_destruct;	// IMP=0x00000000000164f0
...
- (void)logGeoLookupFailureResult;	// IMP=0x00000000000163ba
- (void)logGeoLookupCounterAndDurationWithLookupDuration:(id)arg1;	// IMP=0x00000000000162d6
- (_Bool)shouldQueryItemsForRegion:(id)arg1 selectedRegions:(id)arg2;	// IMP=0x0000000000016115
- (void)cancel;	// IMP=0x00000000000160f0
- (void)submitWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000001609e
- (unsigned long long)cacheItems:(id)arg1;	// IMP=0x0000000000015ba8
- (id)initWithRegions:(id)arg1 precision:(double)arg2;	// IMP=0x0000000000015769
- (id)init;	// IMP=0x00000000000156dc
