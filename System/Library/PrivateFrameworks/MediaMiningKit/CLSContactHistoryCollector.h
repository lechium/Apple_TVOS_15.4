...
- (void).cxx_destruct;	// IMP=0x00000000000a45ff
...
- (void)visitDeleteContactEvent:(id)arg1;	// IMP=0x00000000000a44ef
- (void)visitUpdateContactEvent:(id)arg1;	// IMP=0x00000000000a4441
- (void)visitAddContactEvent:(id)arg1;	// IMP=0x00000000000a4393
- (void)visitDropEverythingEvent:(id)arg1;	// IMP=0x00000000000a4389
- (id)init;	// IMP=0x00000000000a42fd
