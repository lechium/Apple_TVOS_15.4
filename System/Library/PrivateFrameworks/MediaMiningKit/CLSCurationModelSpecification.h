...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000982fa
- (unsigned long long)hash;	// IMP=0x00000000000982d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000982c7
- (id)initWithItemInfo:(id)arg1 options:(id)arg2;	// IMP=0x000000000009818f
- (id)initWithAsset:(id)arg1 curationModelVersion:(unsigned long long)arg2;	// IMP=0x00000000000980c1
- (id)initWithCurationModelVersion:(unsigned long long)arg1 sceneAnalysisVersion:(unsigned long long)arg2 mediaAnalysisVersion:(unsigned long long)arg3 faceAnalysisVersion:(unsigned long long)arg4;	// IMP=0x0000000000098063
