...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a3e13
+ (id)supportedCategories;	// IMP=0x00000000000a3de3
- (void).cxx_destruct;	// IMP=0x00000000000a3d9a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a3b39
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a386d
@property(readonly, nonatomic) _Bool hasExpectedAttendance;
- (id)_calculateUniversalDateFromLocalDate:(id)arg1 includingTimeZone:(id)arg2 localStartTime:(double)arg3;	// IMP=0x00000000000a37d6
@property(readonly, nonatomic) NSDateInterval *universalDateIntervalIncludingTime;
- (id)debugDescription;	// IMP=0x00000000000a358f
- (id)description;	// IMP=0x00000000000a3486
@property(readonly, nonatomic) _Bool isEnriched;
- (id)init;	// IMP=0x00000000000a3420
