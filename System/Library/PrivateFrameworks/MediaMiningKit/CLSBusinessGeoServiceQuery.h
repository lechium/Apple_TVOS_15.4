...
- (void).cxx_destruct;	// IMP=0x0000000000013d72
...
- (void)prepareForRetry;	// IMP=0x0000000000013cd9
- (void)cancel;	// IMP=0x0000000000013cbf
- (void)submitWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013c27
- (id)initWithMUIDs:(id)arg1;	// IMP=0x0000000000013b2c
