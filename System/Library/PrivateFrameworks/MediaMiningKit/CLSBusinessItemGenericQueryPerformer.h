...
+ (id)categories;	// IMP=0x00000000000686ad
+ (double)defaultPrecision;	// IMP=0x00000000000686a4
+ (unsigned long long)numberOfRegionsPerBatch;	// IMP=0x0000000000068699
+ (id)queryWithTemplate:(id)arg1 forRegions:(id)arg2;	// IMP=0x00000000000685d4
- (void).cxx_destruct;	// IMP=0x0000000000068052
...
- (void)logGeoLookupFailureResult;	// IMP=0x0000000000067f1c
- (void)logGeoLookupCounterAndDurationWithLookupDuration:(id)arg1;	// IMP=0x0000000000067e2f
@property(readonly, nonatomic) CLSBusinessCategoryCache *cache;
- (unsigned long long)cacheItems:(id)arg1;	// IMP=0x00000000000674d5
- (_Bool)shouldQueryItemsForRegion:(id)arg1 selectedRegions:(id)arg2;	// IMP=0x000000000006726f
- (void)cancel;	// IMP=0x0000000000067220
- (void)submitWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000006710e
- (id)initWithRegions:(id)arg1 categories:(id)arg2 precision:(double)arg3;	// IMP=0x0000000000066d28
- (id)init;	// IMP=0x0000000000066cbc
