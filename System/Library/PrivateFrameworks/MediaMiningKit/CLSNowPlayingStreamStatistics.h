...
- (void).cxx_destruct;	// IMP=0x000000000004f887
...
- (void)logStatistics;	// IMP=0x000000000004f662
- (void)computeStatistics;	// IMP=0x000000000004ef76
- (id)initWithNowPlayingStreamSessions:(id)arg1;	// IMP=0x000000000004eec6
