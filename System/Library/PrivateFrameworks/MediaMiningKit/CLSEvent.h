...
+ (id)event;	// IMP=0x000000000003e1a3
- (void).cxx_destruct;	// IMP=0x000000000003e12e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003dcf8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003db92
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x000000000003d6d4
- (id)description;	// IMP=0x000000000003d476
