...
+ (double)maximumScoreForItems:(id)arg1;	// IMP=0x0000000000091b62
+ (double)meanScoreForItems:(id)arg1;	// IMP=0x00000000000919cf
+ (double)scoreForItems:(id)arg1;	// IMP=0x0000000000091813
+ (id)clustering;	// IMP=0x00000000000917f9
...
- (id)adaptiveElection:(id)arg1 identifiersOfEligibleItems:(id)arg2 maximumNumberOfItemsToElect:(unsigned long long)arg3 debugInfo:(id)arg4 progressBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000008fb9b
- (id)performWithItems:(id)arg1 identifiersOfEligibleItems:(id)arg2 maximumNumberOfItemsToElect:(unsigned long long)arg3 debugInfo:(id)arg4 progressBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000008ef2c
- (id)performWithItems:(id)arg1 identifiersOfEligibleItems:(id)arg2 maximumNumberOfItemsToElect:(unsigned long long)arg3 progressBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000008ef0a
- (id)_densityClustersWithItems:(id)arg1 progressBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000008e57c
- (id)densityClustersWithItems:(id)arg1 progressBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000008e389
- (id)init;	// IMP=0x000000000008e2e8
- (CDUnknownBlockType)densityClusteringDistanceBlock;	// IMP=0x000000000001e05d
