...
- (void).cxx_destruct;	// IMP=0x0000000000093bf5
...
- (id)sceneImportanceStringForSceneName:(id)arg1;	// IMP=0x0000000000093bac
- (id)initWithUUID:(id)arg1 countryCode:(id)arg2 dateRuleOverrides:(id)arg3 locationScore:(double)arg4 sceneImportanceOverrides:(id)arg5;	// IMP=0x0000000000093aba
