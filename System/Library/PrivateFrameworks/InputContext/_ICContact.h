...
- (void).cxx_destruct;	// IMP=0x00000000000078cb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000077e0
- (_Bool)isEqualToContact:(id)arg1;	// IMP=0x0000000000007674
- (unsigned long long)hash;	// IMP=0x00000000000074f4
- (id)description;	// IMP=0x00000000000074b0
- (id)flatten;	// IMP=0x0000000000006f1f
- (id)initWithFirstName:(id)arg1 phoneticFirstName:(id)arg2 middleName:(id)arg3 phoneticMiddleName:(id)arg4 lastName:(id)arg5 phoneticLastName:(id)arg6 organizationName:(id)arg7 jobTitle:(id)arg8 nickname:(id)arg9 relations:(id)arg10 streets:(id)arg11 cities:(id)arg12 score:(double)arg13;	// IMP=0x0000000000006cd6
