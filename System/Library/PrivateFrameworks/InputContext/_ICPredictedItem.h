...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003a94
- (void).cxx_destruct;	// IMP=0x0000000000004424
...
- (_Bool)isEqualToPredictedItem:(id)arg1;	// IMP=0x0000000000004196
- (_Bool)hasScoreSimilarToItem:(id)arg1;	// IMP=0x000000000000416f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004107
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003f73
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003dea
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003a9c
- (unsigned long long)hash;	// IMP=0x0000000000003912
- (id)description;	// IMP=0x000000000000388e
...
- (id)initWithIdentifier:(id)arg1 score:(double)arg2 value:(id)arg3 label:(id)arg4 name:(id)arg5 date:(id)arg6 originatingBundleID:(id)arg7 originatingWebsiteURL:(id)arg8 predictionAge:(unsigned long long)arg9 shouldAggregate:(_Bool)arg10 flags:(unsigned char)arg11 proactiveTrigger:(id)arg12;	// IMP=0x0000000000003643
