...
- (void).cxx_destruct;	// IMP=0x000000000000bb19
...
- (id)initWithLocale:(id)arg1 recipients:(id)arg2 applicationBundleIdentifier:(id)arg3 isResponseContextDenylisted:(_Bool)arg4 shouldDisableAutoCaps:(_Bool)arg5;	// IMP=0x000000000000b9da
