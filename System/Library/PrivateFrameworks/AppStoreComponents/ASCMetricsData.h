...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000039df0
- (void).cxx_destruct;	// IMP=0x000000000003a878
...
- (id)metricsDataByMergingFields:(id)arg1 uniquingFieldsWithBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003a702
- (id)description;	// IMP=0x000000000003a598
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a294
- (unsigned long long)hash;	// IMP=0x000000000003a161
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a156
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003a01a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039df8
- (id)initWithTopic:(id)arg1 shouldFlush:(_Bool)arg2 fields:(id)arg3 includingFields:(id)arg4 excludingFields:(id)arg5;	// IMP=0x0000000000039cdd
