...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x0000000000038dde
- (void)invalidate;	// IMP=0x0000000000038b2e
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000038650
- (void)dealloc;	// IMP=0x0000000000038612
- (id)initWithView:(id)arg1;	// IMP=0x0000000000038594
