...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001b447
- (void).cxx_destruct;	// IMP=0x000000000001cbae
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x000000000001c999
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x000000000001c6d3
- (id)featureWithClass:(Class)arg1;	// IMP=0x000000000001c586
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001bba9
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b968
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b718
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b44f
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x000000000001b406
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x000000000001b205
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x0000000000014337
@property(readonly, copy, nonatomic) NSSet *signpostTags;
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x000000000001cc2e
