...
- (void).cxx_destruct;	// IMP=0x0000000000012621
...
- (void)invalidateTemporaryStateForcingUpdate:(_Bool)arg1;	// IMP=0x000000000001246c
- (void)installTemporaryWaitingState;	// IMP=0x00000000000121e4
- (id)performActionWithActivity:(id)arg1;	// IMP=0x0000000000012140
- (void)offerStatusTextDidChange:(id)arg1;	// IMP=0x0000000000012063
- (void)offerStateDidChange:(id)arg1 withMetadata:(id)arg2 flags:(long long)arg3;	// IMP=0x0000000000011cf1
- (void)enumerateDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000011b3f
- (void)removeDelegate:(id)arg1;	// IMP=0x0000000000011a29
- (void)addDelegate:(id)arg1;	// IMP=0x00000000000117ae
- (void)dealloc;	// IMP=0x00000000000115b7
- (id)initWithOffer:(id)arg1 stateCenter:(id)arg2;	// IMP=0x00000000000114f6
