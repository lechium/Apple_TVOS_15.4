...
- (void)finishAllWithError:(id)arg1;	// IMP=0x000000000004130d
- (void)cancelAll;	// IMP=0x00000000000412c3
- (void)enumerateBinaryPromises:(CDUnknownBlockType)arg1 andPromises:(CDUnknownBlockType)arg2;	// IMP=0x0000000000040f9e
- (void)addPromise:(id)arg1;	// IMP=0x0000000000040cfe
- (_Bool)containsPromise:(id)arg1;	// IMP=0x0000000000040bf6
@property(readonly, nonatomic) _Bool hasPromises;
- (void)addBinaryPromise:(id)arg1;	// IMP=0x000000000004079d
- (_Bool)containsBinaryPromise:(id)arg1;	// IMP=0x0000000000040695
@property(readonly, nonatomic) NSMutableArray *promises;
@property(readonly, nonatomic) NSMutableArray *binaryPromises;
- (id)init;	// IMP=0x0000000000040591
