...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000024b6d
- (void).cxx_destruct;	// IMP=0x0000000000025684
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002508d
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000024f01
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000024d70
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024b75
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x0000000000024a1c
