...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000015e70
- (void).cxx_destruct;	// IMP=0x0000000000017138
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000167a5
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000163e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000163dd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001619d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015e78
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0000000000015c99
