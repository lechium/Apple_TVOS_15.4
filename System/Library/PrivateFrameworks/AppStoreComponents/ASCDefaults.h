...
+ (id)daemonDefaults;	// IMP=0x000000000002c701
- (void).cxx_destruct;	// IMP=0x000000000002d25b
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x000000000002d1b3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d0ad
- (unsigned long long)hash;	// IMP=0x000000000002d032
...
- (id)objectForKey:(id)arg1;	// IMP=0x000000000002c860
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000002c7e0
- (id)initWithBundleID:(id)arg1;	// IMP=0x000000000002c76d
