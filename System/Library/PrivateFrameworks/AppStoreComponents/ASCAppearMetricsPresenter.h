...
+ (id)log;	// IMP=0x000000000000495d
- (void).cxx_destruct;	// IMP=0x00000000000061f0
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000000615b
- (void)disappearIfNeeded;	// IMP=0x0000000000005fcf
@property(readonly, nonatomic) _Bool canDisappear;
- (void)appearIfNeeded;	// IMP=0x0000000000005c13
@property(readonly, nonatomic) _Bool canAppear;
- (void)viewDidRetryFailedRequest;	// IMP=0x000000000000580a
- (void)viewDidFailRequest:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000005485
- (void)viewDidEndRenderWithPredicate:(id)arg1;	// IMP=0x00000000000052b2
- (void)viewDidAction;	// IMP=0x0000000000005106
- (void)viewDidSetHidden;	// IMP=0x000000000000509b
- (void)viewDidMoveToWindow;	// IMP=0x0000000000004efa
@property(readonly, copy) NSString *description;
- (id)initWithView:(id)arg1;	// IMP=0x0000000000004a6b
- (id)initWithView:(id)arg1 metrics:(id)arg2;	// IMP=0x00000000000049b9
