...
- (void).cxx_destruct;	// IMP=0x000000000000e1a8
...
- (void)reset;	// IMP=0x000000000000e0e4
- (double)nextSleepTimeInterval;	// IMP=0x000000000000e002
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x000000000000df86
