...
- (void).cxx_destruct;	// IMP=0x0000000000004363
...
- (void)invalidate;	// IMP=0x00000000000042eb
- (id)initWithIdleHandler:(CDUnknownBlockType)arg1 onResume:(CDUnknownBlockType)arg2;	// IMP=0x000000000000424d
