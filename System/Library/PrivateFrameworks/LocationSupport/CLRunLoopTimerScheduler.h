...
- (void).cxx_destruct;	// IMP=0x0000000000006d7d
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000006c29
- (void)dealloc;	// IMP=0x0000000000006be7
- (id)initWithRunLoopSilo:(id)arg1;	// IMP=0x00000000000069c2
