...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000007529
- (void).cxx_destruct;	// IMP=0x0000000000007989
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000761f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000007531
...
- (id)memberForAltDSID:(id)arg1;	// IMP=0x0000000000006911
- (id)initWithServerResponse:(id)arg1;	// IMP=0x00000000000063a3
- (id)init;	// IMP=0x000000000000633d
