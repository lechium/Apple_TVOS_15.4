...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000037d0
...
- (_Bool)_nilEqualProperty:(id)arg1 with:(id)arg2;	// IMP=0x0000000000004af5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004a90
- (_Bool)isEqualToFamilyMember:(id)arg1;	// IMP=0x0000000000004343
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000042dc
- (unsigned long long)hash;	// IMP=0x0000000000004298
- (id)contactIncludingImage:(_Bool)arg1;	// IMP=0x0000000000004248
- (id)contactsIncludingImage:(_Bool)arg1;	// IMP=0x0000000000003949
@property(readonly, nonatomic) CNContact *contact;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000037fb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000037d8
- (void)fetchFamilyPhotoWithRequestedSize:(unsigned long long)arg1 fallbackToLocalAddressBook:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000000371c
...
- (id)_dateWithEpochString:(id)arg1;	// IMP=0x00000000000031f5
...
- (id)description;	// IMP=0x0000000000002ac8
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000002a55
