...
- (void).cxx_destruct;	// IMP=0x000000000000d023
...
- (_Bool)isEqualToSharedService:(id)arg1;	// IMP=0x000000000000cba5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000cb48
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000c91c
