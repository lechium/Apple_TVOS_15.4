...
+ (id)tagWithDialects:(id)arg1 range:(struct _NSRange)arg2 content:(id)arg3 predictedByTagger:(_Bool)arg4;	// IMP=0x0000000000061d1c
- (void).cxx_destruct;	// IMP=0x0000000000062a02
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062883
- (_Bool)canBeSpokenByLanguage:(id)arg1;	// IMP=0x00000000000627d6
- (_Bool)canBeSpokenByDialect:(id)arg1;	// IMP=0x000000000006275e
- (id)description;	// IMP=0x0000000000062676
- (void)addPredictedSecondaryDialects:(id)arg1;	// IMP=0x00000000000625b4
- (void)addAmbiguousDialects:(id)arg1;	// IMP=0x000000000006248a
- (void)addAmbiguousDialect:(id)arg1;	// IMP=0x00000000000623c8
- (void)addUnambiguousDialect:(id)arg1;	// IMP=0x0000000000062306
...
- (_Bool)hasAmbigiousDialects;	// IMP=0x0000000000061f97
