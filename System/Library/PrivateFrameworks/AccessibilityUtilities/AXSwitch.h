...
+ (id)switchWithAction:(long long)arg1 name:(id)arg2 source:(id)arg3 type:(id)arg4;	// IMP=0x00000000000a5687
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a4d4f
- (void).cxx_destruct;	// IMP=0x00000000000a675e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a5f7e
- (unsigned long long)hash;	// IMP=0x00000000000a5f3a
- (id)description;	// IMP=0x00000000000a5c8c
...
- (id)initWithAction:(long long)arg1 name:(id)arg2 source:(id)arg3 type:(id)arg4;	// IMP=0x00000000000a5720
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a51b0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a4d57
