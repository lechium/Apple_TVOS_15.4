...
+ (id)observerKeys;	// IMP=0x00000000000364a9
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000356cc
- (void).cxx_destruct;	// IMP=0x00000000000378fc
...
- (id)description;	// IMP=0x0000000000037494
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000373e7
- (_Bool)isIdenticalTo:(id)arg1;	// IMP=0x0000000000036a12
- (_Bool)identicalProperty:(id)arg1 property2:(id)arg2;	// IMP=0x0000000000036991
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000364b6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000035ccf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003574f
- (id)init;	// IMP=0x00000000000356d4
