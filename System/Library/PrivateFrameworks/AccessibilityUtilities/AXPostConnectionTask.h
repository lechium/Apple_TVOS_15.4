...
- (void).cxx_destruct;	// IMP=0x0000000000028e9c
...
- (void)_performTask;	// IMP=0x0000000000028d92
- (void)performTask;	// IMP=0x0000000000028d3a
- (id)initWithConnectBlock:(CDUnknownBlockType)arg1 timeout:(double)arg2 accessQueue:(id)arg3;	// IMP=0x0000000000028b74
