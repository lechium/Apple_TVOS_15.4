...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009c613
...
- (id)accessibilityEventRepresentationTabularDescription;	// IMP=0x000000000009cddb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009cb3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009c8eb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009c61b
