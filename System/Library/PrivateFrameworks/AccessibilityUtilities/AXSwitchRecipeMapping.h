...
+ (id)recipeMappingWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000057a9b
- (void).cxx_destruct;	// IMP=0x000000000005887a
...
- (id)description;	// IMP=0x0000000000058683
- (id)init;	// IMP=0x0000000000058644
- (id)dictionaryRepresentation;	// IMP=0x0000000000057ee4
