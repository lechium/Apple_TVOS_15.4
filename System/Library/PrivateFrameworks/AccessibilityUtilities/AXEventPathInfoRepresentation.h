...
+ (id)representationWithPathInfo:(CDStruct_723b0d29 *)arg1;	// IMP=0x000000000003e3a3
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e39b
...
- (id)accessibilityEventRepresentationTabularDescription;	// IMP=0x000000000003ec62
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003ea14
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003e779
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e510
- (void)writeToPathInfo:(CDStruct_723b0d29 *)arg1;	// IMP=0x000000000003e466
