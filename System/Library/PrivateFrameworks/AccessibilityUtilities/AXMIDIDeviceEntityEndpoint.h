...
- (void).cxx_destruct;	// IMP=0x000000000002e658
...
- (id)description;	// IMP=0x000000000002e464
- (id)initWithMIDIEndpoint:(unsigned int)arg1 entity:(id)arg2;	// IMP=0x000000000002e3f5
