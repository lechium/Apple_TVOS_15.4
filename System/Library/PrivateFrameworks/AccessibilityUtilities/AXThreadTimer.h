...
- (void).cxx_destruct;	// IMP=0x0000000000069f8b
...
- (void)cancel;	// IMP=0x0000000000069d90
- (void)afterDelay:(double)arg1 processBlock:(CDUnknownBlockType)arg2 cancelBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000069bbe
- (void)afterDelay:(double)arg1 processBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000069baa
- (void)_runAfterDelay:(id)arg1;	// IMP=0x0000000000069b15
- (id)initWithThread:(id)arg1;	// IMP=0x0000000000069a97
