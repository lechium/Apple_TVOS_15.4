...
- (void).cxx_destruct;	// IMP=0x0000000000040613
...
- (_Bool)isValidWithError:(id *)arg1;	// IMP=0x00000000000403c6
- (id)selectorString;	// IMP=0x00000000000401d3
- (id)initWithCommandDictionary:(id)arg1 forDomain:(id)arg2;	// IMP=0x000000000003fcf3
