...
- (void)processReturnJSValue:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000002a859
- (_Bool)expectsReturnValue;	// IMP=0x000000000002a851
@property(readonly, nonatomic) NSDictionary *properties;
- (id)initWithIndex:(long long)arg1;	// IMP=0x000000000002a770
