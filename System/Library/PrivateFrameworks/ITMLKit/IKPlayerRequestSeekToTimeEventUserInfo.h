...
- (void)processReturnJSValue:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000002a454
@property(readonly, nonatomic) NSDictionary *properties;
- (id)initWithRequestedTime:(double)arg1 currentTime:(double)arg2;	// IMP=0x000000000002a30f
