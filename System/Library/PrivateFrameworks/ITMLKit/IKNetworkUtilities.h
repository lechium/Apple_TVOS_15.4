...
+ (id)sharedInstance;	// IMP=0x00000000000e351a
- (void).cxx_destruct;	// IMP=0x00000000000e3bf7
- (void)_notifyObservers;	// IMP=0x00000000000e3b0b
- (void)airplaneModeChanged;	// IMP=0x00000000000e3af9
...
- (void)dealloc;	// IMP=0x00000000000e386a
- (id)init;	// IMP=0x00000000000e356f
