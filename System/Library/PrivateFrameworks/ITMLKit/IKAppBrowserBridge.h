...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x000000000001b1f9
...
- (void)present;	// IMP=0x000000000001b3c2
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000001b2ce
