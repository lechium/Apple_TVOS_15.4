...
- (void).cxx_destruct;	// IMP=0x00000000000e32fb
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e3231
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e3226
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e2f88
- (unsigned long long)hash;	// IMP=0x00000000000e2f44
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e2e38
