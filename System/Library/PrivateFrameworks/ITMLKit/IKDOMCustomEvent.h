...
- (void).cxx_destruct;	// IMP=0x0000000000023a4f
@property(retain, nonatomic) IKJSObject *detail; // @synthesize detail=_detail;
- (id)initWithAppContext:(id)arg1 type:(id)arg2 xmlAttribute:(id)arg3 canBubble:(_Bool)arg4 isCancelable:(_Bool)arg5 detail:(id)arg6;	// IMP=0x000000000002391a
- (id)initWithType:(id)arg1 eventInit:(id)arg2;	// IMP=0x0000000000023761
