...
- (void).cxx_destruct;	// IMP=0x000000000002fc97
...
- (void)_resolveWithMediaQueryEvaluator:(id)arg1;	// IMP=0x000000000002f8be
- (void)setNeedsReresolution;	// IMP=0x000000000002f847
- (id)resolvedStyleWithMediaQueryEvaluator:(id)arg1;	// IMP=0x000000000002f7da
- (id)initWithClassSelector:(id)arg1 styles:(id)arg2 baseStyleList:(id)arg3;	// IMP=0x000000000002f54c
