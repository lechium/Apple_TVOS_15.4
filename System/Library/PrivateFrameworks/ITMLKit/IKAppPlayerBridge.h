...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x000000000002bcab
- (void).cxx_destruct;	// IMP=0x000000000002e386
...
- (void)_evaluateDelegateBlockSync:(CDUnknownBlockType)arg1;	// IMP=0x000000000002e14d
- (void)dispatchEvent:(id)arg1 userInfo:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000002dedb
- (void)stopObservingEvent:(id)arg1;	// IMP=0x000000000002ddc4
- (void)startObservingEvent:(id)arg1 extraInfo:(id)arg2;	// IMP=0x000000000002dc6e
...
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000000002c868
- (void)scan:(double)arg1;	// IMP=0x000000000002c659
- (void)changeToMediaAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002c5ba
- (void)previous;	// IMP=0x000000000002c561
- (void)next;	// IMP=0x000000000002c508
- (void)stop;	// IMP=0x000000000002c4af
- (void)pause;	// IMP=0x000000000002c456
- (void)present;	// IMP=0x000000000002c3fd
- (void)play;	// IMP=0x000000000002c3a4
- (void)cleanup;	// IMP=0x000000000002c203
- (id)initWithAppContext:(id)arg1 jsPlayer:(id)arg2;	// IMP=0x000000000002be09
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000002bd45
