...
- (void).cxx_destruct;	// IMP=0x000000000002a73d
...
- (void)processReturnJSValue:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000002a674
@property(readonly, nonatomic) NSDictionary *properties;
- (id)initWithRequestDate:(id)arg1 currentDate:(id)arg2;	// IMP=0x000000000002a53d
