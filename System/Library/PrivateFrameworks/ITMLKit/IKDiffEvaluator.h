...
- (void).cxx_destruct;	// IMP=0x00000000000712a9
...
- (void)_evaluateWithHashing:(CDUnknownBlockType)arg1;	// IMP=0x00000000000700e5
- (void)enumerateCommonObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000006ff2b
- (id)initWithObjects:(id)arg1 oldObjects:(id)arg2 hashing:(CDUnknownBlockType)arg3;	// IMP=0x000000000006fe4d
