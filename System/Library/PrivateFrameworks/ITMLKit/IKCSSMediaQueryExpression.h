...
- (id)description;	// IMP=0x000000000000a96e
- (id)valueAsString;	// IMP=0x000000000000a8d6
- (id)expressionAsString;	// IMP=0x000000000000a84e
- (_Bool)evaluate;	// IMP=0x000000000000a846
