...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0000000000055897
- (void).cxx_destruct;	// IMP=0x00000000000565f5
...
- (void)_setText:(id)arg1 then:(CDUnknownBlockType)arg2;	// IMP=0x0000000000056302
@property(copy, nonatomic, setter=setJSHints:) JSValue *jsHints;
- (void)didSelectHintWithText:(id)arg1 searchTerm:(id)arg2;	// IMP=0x0000000000055aef
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000005593e
