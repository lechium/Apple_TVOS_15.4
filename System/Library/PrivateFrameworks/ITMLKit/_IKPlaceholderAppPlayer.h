...
- (void).cxx_destruct;	// IMP=0x000000000002bbaa
...
- (void)cleanup;	// IMP=0x000000000002ba80
- (void)stopObservingEvent:(id)arg1;	// IMP=0x000000000002ba6a
- (void)startObservingEvent:(id)arg1 extraInfo:(id)arg2;	// IMP=0x000000000002b982
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000000002b97c
- (void)scan:(double)arg1;	// IMP=0x000000000002b976
- (void)changeToMediaAtIndex:(long long)arg1;	// IMP=0x000000000002b970
- (void)previous;	// IMP=0x000000000002b96a
- (void)next;	// IMP=0x000000000002b964
- (void)stop;	// IMP=0x000000000002b95e
- (void)pause;	// IMP=0x000000000002b958
- (void)play;	// IMP=0x000000000002b952
- (void)present;	// IMP=0x000000000002b94c
- (void)transferValuesToAppPlayer:(id)arg1;	// IMP=0x000000000002b5f0
