...
- (void).cxx_destruct;	// IMP=0x00000000000babe0
...
- (id)description;	// IMP=0x00000000000baa4d
- (struct _NSRange)range;	// IMP=0x00000000000ba943
- (id)init;	// IMP=0x00000000000ba8e0
