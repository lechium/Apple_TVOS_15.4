...
- (void).cxx_destruct;	// IMP=0x00000000000a4f6d
...
- (void)_evaluateDelegateBlockSync:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a4dd4
- (void)_resolveArtworkImageURL;	// IMP=0x00000000000a4c8f
- (void)loadKeyDataForURL:(id)arg1 keyRequestData:(id)arg2 withCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000000000a4824
- (void)loadContentIdentifierDataForURL:(id)arg1 withCallback:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a4471
- (void)loadCertificateDataForURL:(id)arg1 withCallback:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a4080
- (void)prepareForLoadingWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a3c00
...
- (void)cleanup;	// IMP=0x00000000000a17b8
- (id)initWithAppContext:(id)arg1 jsMediaItem:(id)arg2;	// IMP=0x00000000000a152c
