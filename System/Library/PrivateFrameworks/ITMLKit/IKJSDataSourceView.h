...
- (void).cxx_destruct;	// IMP=0x00000000000555e2
...
- (void)reset;	// IMP=0x0000000000055515
- (void)dealloc;	// IMP=0x000000000005540f
- (id)initForDataSource:(id)arg1;	// IMP=0x0000000000055387
