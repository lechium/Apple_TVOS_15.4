...
+ (id)jsNodeDataForNode:(id)arg1;	// IMP=0x000000000008dbc0
- (void).cxx_destruct;	// IMP=0x000000000008dec1
...
- (id)featureForName:(id)arg1;	// IMP=0x000000000008dd6c
- (void)setFeature:(id)arg1 forName:(id)arg2;	// IMP=0x000000000008dc63
