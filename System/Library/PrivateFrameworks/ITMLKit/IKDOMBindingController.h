...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x00000000000951bc
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x0000000000094d0d
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x0000000000093bb3
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x0000000000092353
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x0000000000092299
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x0000000000091a7d
- (void).cxx_destruct;	// IMP=0x00000000000971e0
...
- (void)_evaluateMutationRules;	// IMP=0x0000000000096efb
- (void)_resolveBinding;	// IMP=0x0000000000095bff
- (_Bool)_canBeReused;	// IMP=0x0000000000095980
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x00000000000943df
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x0000000000093fdd
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x000000000009349d
- (void)dealloc;	// IMP=0x00000000000933ec
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000092368
