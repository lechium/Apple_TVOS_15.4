...
+ (id)hashForObserver:(id)arg1;	// IMP=0x000000000002526b
- (void).cxx_destruct;	// IMP=0x0000000000025503
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x0000000000025399
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000025290
