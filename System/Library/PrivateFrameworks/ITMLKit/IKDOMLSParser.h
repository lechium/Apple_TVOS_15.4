...
+ (id)_dataFromInput:(id)arg1;	// IMP=0x000000000008075f
...
- (id)parseWithContext:(id)arg1:(id)arg2:(long long)arg3;	// IMP=0x000000000007fc80
- (id)parse:(id)arg1;	// IMP=0x000000000007fa7c
