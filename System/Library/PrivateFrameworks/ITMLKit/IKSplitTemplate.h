...
+ (id)supportedFeatures;	// IMP=0x0000000000064412
- (void).cxx_destruct;	// IMP=0x00000000000647de
...
- (id)_featureWithName:(id)arg1;	// IMP=0x00000000000645b2
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000006448a
