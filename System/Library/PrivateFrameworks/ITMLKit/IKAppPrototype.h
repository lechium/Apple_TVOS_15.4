...
- (void).cxx_destruct;	// IMP=0x00000000000e2dfc
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e24c3
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e2385
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e236f
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e2317
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e212c
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x0000000000002d12
- (id)dsepm_viewElement;	// IMP=0x0000000000002d01
