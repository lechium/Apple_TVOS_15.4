...
- (void)_completedWithStatus:(long long)arg1 errorDictionary:(id)arg2;	// IMP=0x000000000001472a
- (void)cancel;	// IMP=0x00000000000146c2
- (void)send;	// IMP=0x00000000000146a1
- (id)initWithAppContext:(id)arg1 serviceContext:(id)arg2;	// IMP=0x00000000000145bc
