...
@interface IKJSTabBarItem <NSObject, IKJSTabBarItem, _IKJSTabBarItemProxy>
{
...
- (void).cxx_destruct;	// IMP=0x000000000009ed2b
...
- (void)dealloc;	// IMP=0x000000000009eb42
- (id)initWithAppContext:(id)arg1 identifier:(id)arg2 navigationController:(id)arg3 owner:(id)arg4;	// IMP=0x000000000009e87d
- (id)asPrivateIKJSTabBarItem;	// IMP=0x000000000009e84a
