...
+ (id)timestampDateFormatter;	// IMP=0x000000000002b9bb
+ (void)initialize;	// IMP=0x000000000002b977
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b05d
- (id)initWithEvent:(id)arg1;	// IMP=0x000000000002ad2e
- (id)initWithIdentifier:(id)arg1 sourceAppIdentifier:(id)arg2 interaction:(id)arg3;	// IMP=0x000000000002aa1e
