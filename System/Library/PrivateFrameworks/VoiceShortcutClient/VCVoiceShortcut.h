...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001d1d7
+ (void)initialize;	// IMP=0x000000000001d193
- (void).cxx_destruct;	// IMP=0x000000000001d11e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001ce7f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001cb2a
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001c99c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c380
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) WFWorkflow *workflow;
@property(readonly, nonatomic) _Bool hasBeenModified;
- (id)initWithIdentifier:(id)arg1 phrase:(id)arg2 shortcutName:(id)arg3 shortcutDescription:(id)arg4 associatedAppBundleIdentifier:(id)arg5 dateCreated:(id)arg6 dateLastModified:(id)arg7 shortcut:(id)arg8 keyImageData:(id)arg9 error:(id *)arg10;	// IMP=0x000000000001bb2e
