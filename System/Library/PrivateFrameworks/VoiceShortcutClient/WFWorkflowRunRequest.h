...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001b549
- (void).cxx_destruct;	// IMP=0x000000000001b482
...
- (id)unableToDecodeInputError;	// IMP=0x000000000001b209
- (void)getInputWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000001aeec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001ac31
- (id)description;	// IMP=0x000000000001aa83
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001a763
- (id)initWithDescriptor:(id)arg1 input:(id)arg2 presentationMode:(unsigned long long)arg3;	// IMP=0x000000000001a5c4
