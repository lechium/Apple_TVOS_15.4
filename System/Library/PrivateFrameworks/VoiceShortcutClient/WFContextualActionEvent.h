...
- (void).cxx_destruct;	// IMP=0x0000000000006f68
...
- (id)initWithAction:(id)arg1 contentTypes:(id)arg2 containerName:(id)arg3 surface:(unsigned long long)arg4;	// IMP=0x0000000000006de6
