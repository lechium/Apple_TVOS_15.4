...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000b3f5
- (void).cxx_destruct;	// IMP=0x000000000000b3c2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b26a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b187
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b17c
@property(readonly, copy, nonatomic) NSString *bundleIdentifierForDisplay;
- (id)initWithActions:(id)arg1;	// IMP=0x000000000000af1d
