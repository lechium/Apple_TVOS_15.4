...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002c920
+ (struct CGSize)glyphSize;	// IMP=0x000000000002c90f
- (void).cxx_destruct;	// IMP=0x000000000002c8bc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002c55a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002c3cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002c3c1
- (void)setIconImage:(struct CGImage *)arg1 scale:(double)arg2;	// IMP=0x000000000002c375
- (id)initWithWorkflowIdentifier:(id)arg1 bundleIdentifierForDisplay:(id)arg2 summaryString:(id)arg3 name:(id)arg4 actionIdentifier:(id)arg5 glyphCharacter:(unsigned short)arg6 backgroundColorValue:(long long)arg7;	// IMP=0x000000000002c215
