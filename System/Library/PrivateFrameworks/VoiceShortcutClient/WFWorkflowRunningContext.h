...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002e3e8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002dfb4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002dd9a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002dbe2
- (id)description;	// IMP=0x000000000002db19
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002da47
- (unsigned long long)hash;	// IMP=0x000000000002da03
- (id)progressForPublishingWithTotalUnitCount:(long long)arg1 cancellationHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000002d8d6
- (void)removeProgressSubscriber:(id)arg1;	// IMP=0x000000000002d8bd
- (id)addProgressSubscriberUsingPublishingHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000002d80b
@property(readonly, nonatomic) _Bool isShortcutsApp;
- (id)initWithWorkflowIdentifier:(id)arg1;	// IMP=0x000000000002d663
