...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000175f54
- (void).cxx_destruct;	// IMP=0x0000000000175f16
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001759f2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017590f
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000175404
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000174eb2
- (id)initWithIdentifier:(id)arg1 accessCode:(id)arg2 flags:(id)arg3 statusCode:(id)arg4;	// IMP=0x0000000000174dd0
- (id)init;	// IMP=0x0000000000174da1
