...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000013d52d
- (void).cxx_destruct;	// IMP=0x0000000000137417
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000136b48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001369f1
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000136130
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001358b2
- (id)initWithOperationType:(id)arg1 issuerKeyRequest:(id)arg2 issuerKeyResponse:(id)arg3 deviceCredentialKeyRequest:(id)arg4 deviceCredentialKeyResponse:(id)arg5 readerKeyRequest:(id)arg6 readerKeyResponse:(id)arg7;	// IMP=0x000000000013576d
- (id)init;	// IMP=0x000000000013573e
