...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000137fcf
- (void).cxx_destruct;	// IMP=0x0000000000137fa7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000137cb9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000137c2b
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000137911
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000013753e
- (id)initWithIdentifier:(id)arg1 statusCode:(id)arg2;	// IMP=0x00000000001374a5
- (id)init;	// IMP=0x0000000000137476
