...
- (void).cxx_destruct;	// IMP=0x0000000000093297
...
- (id)description;	// IMP=0x0000000000093003
- (void)updatePairedPeripheralConfiguration:(_Bool)arg1 connectionPriority:(unsigned long long)arg2;	// IMP=0x0000000000092e77
- (void)updateWithPeripheral:(id)arg1;	// IMP=0x0000000000092afe
- (id)initRecentlySeenPairedHAPBLEPeripheral:(id)arg1;	// IMP=0x0000000000092a96
