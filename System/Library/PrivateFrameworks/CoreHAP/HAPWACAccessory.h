...
- (void).cxx_destruct;	// IMP=0x00000000001afb0e
...
- (void)updateWithHAPWACAccessory:(id)arg1;	// IMP=0x00000000001af4d5
- (id)description;	// IMP=0x00000000001af202
- (id)initWithName:(id)arg1 identifier:(id)arg2 category:(id)arg3 ssid:(id)arg4 deviceId:(id)arg5 flags:(unsigned int)arg6;	// IMP=0x00000000001af09d
- (void)__setupSupportedFlags:(unsigned int)arg1;	// IMP=0x00000000001aefc2
- (id)initWithWiFiDevice:(id)arg1;	// IMP=0x00000000001aebd9
