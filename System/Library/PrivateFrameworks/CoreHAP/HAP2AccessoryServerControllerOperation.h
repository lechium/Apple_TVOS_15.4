...
- (void).cxx_destruct;	// IMP=0x0000000000049cc2
@property(readonly, copy) NSString *description;
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000049a8d
- (void)_cleanUp;	// IMP=0x0000000000049a87
- (void)_parseResponseData:(id)arg1;	// IMP=0x0000000000049950
- (void)_sendRequest;	// IMP=0x0000000000049621
- (void)_openTransport;	// IMP=0x0000000000049333
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000000492cf
- (void)cancel;	// IMP=0x0000000000049291
- (void)finishWithError:(id)arg1;	// IMP=0x000000000004918f
- (void)finish;	// IMP=0x00000000000490b9
- (void)main;	// IMP=0x000000000004900e
- (id)initWithName:(id)arg1 controller:(id)arg2 encoding:(id)arg3 transport:(id)arg4 request:(id)arg5 endpoint:(id)arg6 mimeType:(id)arg7 timeout:(double)arg8 options:(unsigned long long)arg9;	// IMP=0x0000000000048ea6
