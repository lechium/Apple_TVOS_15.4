...
- (void).cxx_destruct;	// IMP=0x00000000001504d8
...
- (void)dump;	// IMP=0x00000000001501c8
- (id)description;	// IMP=0x00000000001500b1
- (id)generateDictionary:(id)arg1;	// IMP=0x000000000014fe6a
- (id)initWithName:(id)arg1 uuid:(id)arg2 description:(id)arg3 format:(id)arg4 properties:(id)arg5;	// IMP=0x000000000014fcc9
