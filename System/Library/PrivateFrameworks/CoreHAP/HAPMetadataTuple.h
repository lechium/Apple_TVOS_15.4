...
- (void).cxx_destruct;	// IMP=0x0000000000156d86
...
- (unsigned long long)hash;	// IMP=0x0000000000156d0f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000156c45
- (id)initWithCharacteristicType:(id)arg1 serviceType:(id)arg2;	// IMP=0x0000000000156b2e
