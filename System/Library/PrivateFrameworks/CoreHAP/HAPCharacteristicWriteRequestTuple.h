...
+ (id)writeRequestTupleForCharacteristic:(id)arg1 value:(id)arg2 authorizationData:(id)arg3 timedWrite:(_Bool)arg4 responseValue:(_Bool)arg5 type:(unsigned long long)arg6 contextData:(id)arg7;	// IMP=0x00000000001c4e1d
+ (id)writeRequestTupleForCharacteristic:(id)arg1 value:(id)arg2 authorizationData:(id)arg3 timedWrite:(_Bool)arg4 responseValue:(_Bool)arg5 type:(unsigned long long)arg6;	// IMP=0x00000000001c4df6
- (void).cxx_destruct;	// IMP=0x00000000001c4d92
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018f180
