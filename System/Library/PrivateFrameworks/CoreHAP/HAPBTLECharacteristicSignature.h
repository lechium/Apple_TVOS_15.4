...
- (void).cxx_destruct;	// IMP=0x00000000000ab3a1
...
- (id)initWithCharacteristicType:(id)arg1 serviceInstanceID:(id)arg2 serviceType:(id)arg3 characteristicProperties:(unsigned long long)arg4 characteristicMetadata:(id)arg5 authenticated:(_Bool)arg6;	// IMP=0x00000000000aaeb4
