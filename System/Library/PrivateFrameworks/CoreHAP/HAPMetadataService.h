...
- (void).cxx_destruct;	// IMP=0x0000000000158307
...
- (void)dump;	// IMP=0x00000000001579ba
- (id)description;	// IMP=0x0000000000157518
- (id)generateDictionary:(id)arg1 metadata:(id)arg2;	// IMP=0x0000000000156f72
- (id)initWithName:(id)arg1 uuid:(id)arg2 description:(id)arg3 mandatoryChrTypes:(id)arg4 properties:(id)arg5 linkedServices:(id)arg6;	// IMP=0x0000000000156dc8
