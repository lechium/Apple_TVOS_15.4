...
+ (id)getInstance;	// IMP=0x000000000005a27c
- (void).cxx_destruct;	// IMP=0x000000000005a140
...
- (void)registerCentralManagerDelegate:(id)arg1;	// IMP=0x0000000000059ffe
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x0000000000059e55
- (id)_getCentralManager;	// IMP=0x0000000000059d58
- (id)init;	// IMP=0x0000000000059c89
