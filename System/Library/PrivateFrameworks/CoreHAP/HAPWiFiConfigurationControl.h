...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001b6b95
- (void).cxx_destruct;	// IMP=0x00000000001b5bb9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b540f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b52dc
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000001b4bbc
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001b449d
- (id)initWithOperationType:(id)arg1 cookie:(id)arg2 updateStatus:(id)arg3 operationTimeout:(id)arg4 countryCodeConfiguration:(id)arg5 stationConfiguration:(id)arg6;	// IMP=0x00000000001b4375
- (id)init;	// IMP=0x00000000001b4346
