...
- (void).cxx_destruct;	// IMP=0x000000000017eb55
...
- (_Bool)reapSession:(id)arg1;	// IMP=0x000000000017ea99
- (id)initWithSession:(struct coap_session_t *)arg1 startTime:(id)arg2;	// IMP=0x000000000017ea23
