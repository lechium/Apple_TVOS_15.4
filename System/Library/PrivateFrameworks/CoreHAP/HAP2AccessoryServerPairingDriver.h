...
+ (id)_generateWorkItemsForAuthMethod:(unsigned long long)arg1;	// IMP=0x000000000017245d
- (void).cxx_destruct;	// IMP=0x0000000000171ff7
...
- (void)workItem:(id)arg1 finishedWithError:(id)arg2;	// IMP=0x0000000000171aed
- (void)_pairingFinishedWithError:(id)arg1;	// IMP=0x0000000000171854
- (void)_cancelWithError:(id)arg1;	// IMP=0x000000000017176f
- (void)cancelWithError:(id)arg1;	// IMP=0x0000000000171673
- (id)currentWorkItem;	// IMP=0x0000000000171594
- (id)moveToNextWorkItem;	// IMP=0x000000000017151e
- (id)pairAccessory:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000001712ae
...
- (id)initWithTransport:(id)arg1 secureTransportFactory:(id)arg2 encoding:(id)arg3 featureFlags:(unsigned long long)arg4;	// IMP=0x000000000017083e
- (id)initWithTransport:(id)arg1 secureTransportFactory:(id)arg2 encoding:(id)arg3 featureFlags:(unsigned long long)arg4 workItems:(id)arg5;	// IMP=0x00000000001706a6
