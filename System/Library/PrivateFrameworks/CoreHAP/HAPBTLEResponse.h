...
- (void).cxx_destruct;	// IMP=0x0000000000047c36
...
- (unsigned long long)_deserializeHeaderBodyLengthWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000479cd
- (unsigned long long)_deserializeHeaderWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000478a4
- (unsigned long long)appendData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004743c
- (unsigned long long)_remainingBodyLength;	// IMP=0x00000000000473af
...
- (id)description;	// IMP=0x00000000000471f3
- (id)debugDescription;	// IMP=0x00000000000471dc
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x000000000004704a
- (id)shortDescription;	// IMP=0x0000000000047038
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000046fca
- (id)init;	// IMP=0x0000000000046f22
