...
- (void).cxx_destruct;	// IMP=0x000000000005f5f3
@property(readonly, nonatomic) NSSet *updatedValues; // @synthesize updatedValues=_updatedValues;
- (id)initWithNotificationResponses:(id)arg1 updatedValues:(id)arg2;	// IMP=0x000000000005f56a
- (id)initWithNotificationResponses:(id)arg1;	// IMP=0x000000000005f556
