...
+ (id)configurationTupleForCharacteristic:(id)arg1 broadcastEnable:(_Bool)arg2 broadcastInterval:(unsigned long long)arg3;	// IMP=0x00000000001c5272
- (void).cxx_destruct;	// IMP=0x00000000001c525f
