...
- (void).cxx_destruct;	// IMP=0x000000000013e28b
...
- (id)initWithAccessory:(id)arg1 forLinkType:(id)arg2 duration:(id)arg3 reason:(id)arg4 pvError:(id)arg5;	// IMP=0x000000000013e103
