...
- (void).cxx_destruct;	// IMP=0x00000000000abed9
...
- (void)reset;	// IMP=0x00000000000aba7d
- (id)initWithDiscoveryType:(long long)arg1;	// IMP=0x00000000000ab8a8
- (id)init;	// IMP=0x00000000000ab800
