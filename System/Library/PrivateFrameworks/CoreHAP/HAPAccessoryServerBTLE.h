...
+ (id)hapUUIDFromBTLEUUID:(id)arg1;	// IMP=0x00000000001c0ccc
- (void).cxx_destruct;	// IMP=0x00000000001c0b75
...
- (_Bool)isCached;	// IMP=0x00000000001c09d8
- (void)discoverAccessoriesAndReadCharacteristicTypes:(id)arg1;	// IMP=0x00000000001c09c6
- (_Bool)isPaired;	// IMP=0x00000000001c0952
- (void)generateBroadcastKey:(unsigned char)arg1 queue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001c0891
- (void)configureCharacteristics:(id)arg1 queue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001c07c7
- (void)updateConnectionIdleTime:(unsigned char)arg1;	// IMP=0x00000000001c071f
- (_Bool)updatePeripheralIdentifier:(id *)arg1 isPairing:(_Bool)arg2;	// IMP=0x00000000001c0234
- (void)updatePeripheral:(id)arg1;	// IMP=0x00000000001c0220
- (_Bool)updateResumeSessionID:(unsigned long long)arg1;	// IMP=0x00000000001bff6d
- (void)handleDisconnectionWithError:(id)arg1 completionQueue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001bfea3
- (void)handleConnectionWithPeripheral:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001bfde2
...
- (long long)linkType;	// IMP=0x00000000001bf8f1
- (id)initWithPeripheral:(id)arg1 name:(id)arg2 pairingUsername:(id)arg3 statusFlags:(id)arg4 stateNumber:(id)arg5 stateChanged:(_Bool)arg6 connectReason:(unsigned char)arg7 configNumber:(id)arg8 category:(id)arg9 setupHash:(id)arg10 connectionIdleTime:(unsigned char)arg11 browser:(id)arg12 keyStore:(id)arg13 whbStableIdentifier:(id)arg14;	// IMP=0x00000000001bf663
- (id)readAndResetHAPMetrics:(_Bool)arg1;	// IMP=0x00000000001c0f1a
- (void)incrementHAPBTLEMetricsDiscoveryCount;	// IMP=0x00000000001c0e78
- (void)incrementHAPBTLEMetricsConnectionCount;	// IMP=0x00000000001c0dd6
