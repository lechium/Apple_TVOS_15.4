...
+ (id)new;	// IMP=0x000000000006285f
- (void).cxx_destruct;	// IMP=0x000000000006270c
...
- (id)debugDescription;	// IMP=0x0000000000062633
- (id)description;	// IMP=0x00000000000625b0
@property(readonly, nonatomic, getter=isForWriting) _Bool forWriting;
- (id)initForWritingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x0000000000062582
- (id)initForReadingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x0000000000062566
- (id)init;	// IMP=0x00000000000624be
