...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006a90c
- (void).cxx_destruct;	// IMP=0x000000000006a897
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000069d5a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000069bc5
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000000690d0
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000068624
- (id)initWithInstanceID:(id)arg1 characteristicType:(id)arg2 characteristicProperties:(id)arg3 userDescription:(id)arg4 bluetoothFormat:(id)arg5 validRange:(id)arg6 stepValue:(id)arg7 validValues:(id)arg8 validValuesRange:(id)arg9;	// IMP=0x000000000006849f
- (id)init;	// IMP=0x0000000000068470
