...
- (void).cxx_destruct;	// IMP=0x00000000001c1894
...
- (id)description;	// IMP=0x00000000001c16b7
- (_Bool)isDenylisted;	// IMP=0x00000000001c163f
- (_Bool)isCertified;	// IMP=0x00000000001c15c7
- (id)initWithName:(id)arg1 manufacturer:(id)arg2 modelName:(id)arg3 category:(id)arg4 certificationStatus:(id)arg5 denylisted:(id)arg6 ppid:(id)arg7;	// IMP=0x00000000001c139b
