...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001456de
- (void).cxx_destruct;	// IMP=0x0000000000145669
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001453ba
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014523a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000145027
- (_Bool)isEqualToMetadataConstraints:(id)arg1;	// IMP=0x0000000000144d90
- (id)description;	// IMP=0x000000000014485a
