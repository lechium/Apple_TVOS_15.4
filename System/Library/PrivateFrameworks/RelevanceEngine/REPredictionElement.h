...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008ccfb
+ (id)predictionElementFromElement:(id)arg1;	// IMP=0x000000000008cbb3
+ (id)predictionElementWithIdentifier:(id)arg1 relevanceProviders:(id)arg2 bundleIdentifier:(id)arg3;	// IMP=0x000000000008d338
- (void).cxx_destruct;	// IMP=0x000000000008d2ef
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008d06e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008cd03
