...
+ (_Bool)_wantsSeperateRelevanceQueue;	// IMP=0x000000000008e4bd
- (void).cxx_destruct;	// IMP=0x000000000008e7bb
- (void)locationManagerDidUpdateLocation:(id)arg1;	// IMP=0x000000000008e6b9
- (void)pause;	// IMP=0x000000000008e623
- (void)resume;	// IMP=0x000000000008e559
- (void)_queue_loadLocation:(id)arg1;	// IMP=0x000000000008e4da
