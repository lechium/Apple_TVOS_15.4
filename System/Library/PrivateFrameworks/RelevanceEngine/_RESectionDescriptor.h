...
- (void).cxx_destruct;	// IMP=0x000000000006cac3
...
- (id)initWithHistoricSectionDescriptor:(id)arg1;	// IMP=0x000000000006c9aa
- (id)initWithSectionDescriptor:(id)arg1;	// IMP=0x000000000006c8e6
