...
@class NSAttributedString, NSDictionary, NSMutableDictionary, NSNumber, NSString, NSTimeZone, REAccessoryDescription, REAccessoryImage, REAccessoryMatchup, REImageContentProvider, RETextContentProvider, UIColor, UIImage;
...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000c13e
- (void).cxx_destruct;	// IMP=0x000000000000da21
...
- (id)description;	// IMP=0x000000000000c715
@property(readonly, nonatomic) NSDictionary *loggingContentValues;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c4d6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c41a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c394
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c2e7
- (unsigned long long)hash;	// IMP=0x000000000000c2a8
- (id)objectForKey:(id)arg1;	// IMP=0x000000000000c292
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000000c1fe
- (id)init;	// IMP=0x000000000000c146
