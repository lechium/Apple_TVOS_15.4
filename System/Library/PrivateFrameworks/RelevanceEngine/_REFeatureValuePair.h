...
- (void).cxx_destruct;	// IMP=0x0000000000041156
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000040ff9
- (unsigned long long)hash;	// IMP=0x0000000000040fc6
- (void)dealloc;	// IMP=0x0000000000040f8c
- (id)initWithFeature:(id)arg1 value:(unsigned long long)arg2 index:(unsigned long long)arg3 rootFeatures:(id)arg4;	// IMP=0x0000000000040ed6
