...
+ (id)sharedTrainingClientListener;	// IMP=0x0000000000050c4f
- (void).cxx_destruct;	// IMP=0x000000000005123e
@property(nonatomic) __weak id <RERemoteTrainingClientListenerDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000050ee3
- (void)dealloc;	// IMP=0x0000000000050e77
