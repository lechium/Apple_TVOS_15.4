...
+ (id)parseBuffer:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008b1ef
- (void).cxx_destruct;	// IMP=0x000000000008b6cc
...
- (id)dependencies;	// IMP=0x000000000008b66b
- (id)initWithType:(id)arg1 options:(id)arg2 name:(id)arg3 expression:(id)arg4;	// IMP=0x000000000008b569
