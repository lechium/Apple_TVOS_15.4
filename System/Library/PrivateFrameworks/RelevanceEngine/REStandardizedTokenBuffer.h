...
- (void).cxx_destruct;	// IMP=0x00000000000de688
- (void)next;	// IMP=0x00000000000de656
@property(readonly, nonatomic) REScriptToken *currentToken;
@property(readonly, nonatomic, getter=isEmpty) _Bool empty;
- (void)_cleanTokens;	// IMP=0x00000000000de562
- (id)initWithTokenBuffer:(id)arg1;	// IMP=0x00000000000de4e7
