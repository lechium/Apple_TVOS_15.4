...
- (void).cxx_destruct;	// IMP=0x000000000007fedc
...
- (id)description;	// IMP=0x000000000007febf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007fda3
- (unsigned long long)hash;	// IMP=0x000000000007fd99
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007fd24
- (id)initWithValues:(id)arg1 isHistoric:(_Bool)arg2;	// IMP=0x000000000007fc22
