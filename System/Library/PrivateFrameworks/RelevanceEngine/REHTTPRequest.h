...
- (void).cxx_destruct;	// IMP=0x000000000009ac7e
...
- (void)appendData:(id)arg1;	// IMP=0x000000000009ac28
@property(readonly, nonatomic) NSData *bodyData;
- (id)responseWithStatusCode:(long long)arg1;	// IMP=0x000000000009abcf
- (void)dealloc;	// IMP=0x000000000009ab88
- (id)initWithConnect:(id)arg1 request:(struct _CFHTTPServerRequest *)arg2;	// IMP=0x000000000009a9fb
