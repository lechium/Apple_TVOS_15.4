...
+ (id)eventWithInterval:(id)arg1 value:(id)arg2 confidence:(double)arg3;	// IMP=0x00000000000bda2c
- (void).cxx_destruct;	// IMP=0x00000000000bdc6e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bdb5c
- (unsigned long long)hash;	// IMP=0x00000000000bdad5
