...
- (void).cxx_destruct;	// IMP=0x000000000007a750
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007a567
- (id)description;	// IMP=0x000000000007a55d
- (unsigned long long)hash;	// IMP=0x000000000007a380
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007a1cf
- (id)init;	// IMP=0x000000000007a16b
