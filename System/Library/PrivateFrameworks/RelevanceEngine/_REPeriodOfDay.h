...
- (void).cxx_destruct;	// IMP=0x000000000004d598
...
- (id)description;	// IMP=0x000000000004d54e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004d4bf
- (unsigned long long)hash;	// IMP=0x000000000004d49a
- (id)initWithInterval:(id)arg1 periodOfDay:(unsigned long long)arg2;	// IMP=0x000000000004d41c
