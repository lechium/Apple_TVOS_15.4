...
- (void).cxx_destruct;	// IMP=0x00000000000e2b56
@property(nonatomic) _Bool forceExecution; // @synthesize forceExecution=_forceExecution;
- (void)_didFinish:(_Bool)arg1;	// IMP=0x00000000000e2ab8
- (void)_performWithContext:(id)arg1;	// IMP=0x00000000000e2ab2
@property(nonatomic) __weak id <REElementActionDelegate> delegate;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e2a85
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e2a56
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e2a44
