...
- (void).cxx_destruct;	// IMP=0x00000000000b63aa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b62d6
- (unsigned long long)hash;	// IMP=0x00000000000b623b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b6117
- (id)initWithLeftCondition:(id)arg1 rightCondition:(id)arg2 comparisonCondition:(id)arg3 order:(long long)arg4;	// IMP=0x00000000000b5f54
