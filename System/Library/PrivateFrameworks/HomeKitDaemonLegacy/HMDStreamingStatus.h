...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000065f27
@property(readonly, nonatomic) unsigned long long streamingStatus; // @synthesize streamingStatus=_streamingStatus;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000065ebe
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000065e45
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000065dac
- (id)tlvData;	// IMP=0x0000000000065cf3
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000065be8
