...
+ (id)shortDescription;	// IMP=0x0000000000705658
- (void).cxx_destruct;	// IMP=0x0000000000705605
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x0000000000704e05
- (void)resetRecord;	// IMP=0x0000000000704dc6
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x0000000000704d54
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x00000000007043b1
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x00000000007042ae
- (void)updateCloudRecord:(id)arg1;	// IMP=0x0000000000703d8f
- (void)forceChangeToInvalid;	// IMP=0x0000000000703d7b
- (void)forceChangeToDelete;	// IMP=0x0000000000703c88
...
- (id)shortDescription;	// IMP=0x0000000000703858
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x0000000000703841
- (id)initWithObjectChange:(id)arg1;	// IMP=0x000000000070382d
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x00000000007034f8
- (id)init;	// IMP=0x0000000000703450
