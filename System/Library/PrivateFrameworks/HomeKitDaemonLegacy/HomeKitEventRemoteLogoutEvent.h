...
- (void).cxx_destruct;	// IMP=0x0000000000564536
...
- (void)setError:(id)arg1;	// IMP=0x000000000056441d
- (id)metricForAWD;	// IMP=0x000000000056440b
- (unsigned int)AWDMessageType;	// IMP=0x0000000000564400
- (id)initWithSessionID:(id)arg1;	// IMP=0x0000000000564319
