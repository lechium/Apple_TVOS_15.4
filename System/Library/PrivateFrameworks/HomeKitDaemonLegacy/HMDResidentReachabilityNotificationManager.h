...
+ (id)logCategory;	// IMP=0x00000000007b65cd
- (void).cxx_destruct;	// IMP=0x00000000007b5874
...
- (id)logIdentifier;	// IMP=0x00000000007b572e
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007b55d5
- (void)_startDebounceTimer;	// IMP=0x00000000007b5307
- (void)updateNotificationEnabled;	// IMP=0x00000000007b5096
- (_Bool)shouldPostUnreachableNotification;	// IMP=0x00000000007b501b
- (_Bool)shouldPostReachableNotification;	// IMP=0x00000000007b4fa9
...
- (void)_evaluateReachabilityBulletin;	// IMP=0x00000000007b42ce
- (void)_handleResidentUpdated:(id)arg1;	// IMP=0x00000000007b425d
- (void)_handleResidentRemoved:(id)arg1;	// IMP=0x00000000007b41ec
- (void)_handleResidentAdded:(id)arg1;	// IMP=0x00000000007b417b
- (void)_handleNetworkReachabilityChange:(id)arg1;	// IMP=0x00000000007b410a
- (void)_handleCameraProfileUnconfigured:(id)arg1;	// IMP=0x00000000007b4099
- (void)_handleCameraProfileSettingsDidChange:(id)arg1;	// IMP=0x00000000007b3fe8
- (void)configureWithHome:(id)arg1 deviceMonitor:(id)arg2 notificationCenter:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000007b3e89
- (void)configureWithHome:(id)arg1 deviceMonitor:(id)arg2;	// IMP=0x00000000007b3df4
- (id)initWithResidentReachabilityContext:(id)arg1 workQueue:(id)arg2 timerFactory:(CDUnknownBlockType)arg3 bulletinBoard:(id)arg4;	// IMP=0x00000000007b3ce4
- (id)initWithResidentReachabilityContext:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000007b3c46
