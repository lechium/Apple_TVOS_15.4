...
- (void).cxx_destruct;	// IMP=0x00000000001d8e2c
@property(copy, nonatomic) CDUnknownBlockType fetchResult; // @synthesize fetchResult=_fetchResult;
- (id)mainReturningError;	// IMP=0x00000000001d8d31
- (id)initWithFetchResult:(CDUnknownBlockType)arg1;	// IMP=0x00000000001d8ca8
