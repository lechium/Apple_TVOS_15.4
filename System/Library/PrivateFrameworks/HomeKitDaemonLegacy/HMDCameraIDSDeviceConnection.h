...
+ (id)logCategory;	// IMP=0x0000000000331715
- (void).cxx_destruct;	// IMP=0x00000000003302a6
...
- (id)logIdentifier;	// IMP=0x0000000000330187
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x00000000003300d1
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x000000000033001b
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000032fd2e
- (void)startKeepAlive;	// IMP=0x000000000032fcc5
- (void)_createStreamSocketWithDevice:(id)arg1;	// IMP=0x000000000032e78a
- (void)dealloc;	// IMP=0x000000000032e6e3
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 idsProxyStreamService:(id)arg3;	// IMP=0x000000000032e4df
