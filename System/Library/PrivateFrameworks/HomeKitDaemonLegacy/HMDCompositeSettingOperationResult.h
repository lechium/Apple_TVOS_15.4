...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x000000000027ee2e
- (void).cxx_destruct;	// IMP=0x000000000027eddb
...
- (id)attributeDescriptions;	// IMP=0x000000000027ebbb
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x000000000027eacf
