...
+ (id)logCategory;	// IMP=0x000000000076b003
- (void).cxx_destruct;	// IMP=0x000000000076afaa
...
- (id)logIdentifier;	// IMP=0x000000000076aedb
@property(readonly, copy) NSString *description;
- (void)main;	// IMP=0x000000000076ad93
- (id)mainReturningError;	// IMP=0x000000000076ad8b
- (id)init;	// IMP=0x000000000076ad77
- (id)initWithResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000076aca3
