...
- (void).cxx_destruct;	// IMP=0x0000000000753f87
...
- (id)dictionaryRepresentation:(_Bool)arg1;	// IMP=0x00000000007537cd
- (id)initWithMediaAction:(id)arg1 source:(id)arg2 clientName:(id)arg3;	// IMP=0x000000000075366f
- (id)initWithDictionaryRepresentation:(id)arg1 profileSource:(id)arg2;	// IMP=0x0000000000752c3a
- (id)initWithMediaProfiles:(id)arg1 playbackState:(id)arg2 playbackVolume:(id)arg3 playbackArchive:(id)arg4 source:(id)arg5 clientName:(id)arg6;	// IMP=0x000000000075285f
