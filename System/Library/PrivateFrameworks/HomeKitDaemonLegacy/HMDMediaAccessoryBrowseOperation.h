...
+ (id)logCategory;	// IMP=0x000000000033ca1f
+ (double)defaultTimeout;	// IMP=0x000000000033c9f2
- (void).cxx_destruct;	// IMP=0x000000000033c3eb
@property(readonly, copy) NSString *accessoryIdentifier; // @synthesize accessoryIdentifier=_accessoryIdentifier;
- (void)cancel;	// IMP=0x000000000033c38f
- (void)main;	// IMP=0x000000000033c176
...
- (void)dealloc;	// IMP=0x000000000033bd3e
- (id)initWithAccessoryIdentifier:(id)arg1 timeout:(double)arg2;	// IMP=0x000000000033bb77
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x000000000033bb62
