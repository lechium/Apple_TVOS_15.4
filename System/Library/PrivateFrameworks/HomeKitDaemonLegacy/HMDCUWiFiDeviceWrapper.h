...
+ (id)logCategory;	// IMP=0x00000000005b9819
- (void).cxx_destruct;	// IMP=0x00000000005b9136
@property(readonly, nonatomic) NSString *deviceID; // @synthesize deviceID;
- (id)logIdentifier;	// IMP=0x00000000005b911a
@property(readonly, copy) NSString *description;
- (void)cancelConfigurationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000005b8f23
- (void)startConfigurationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000005b8c94
...
- (id)initWithCUWiFiDevice:(id)arg1 dispatchQueue:(id)arg2;	// IMP=0x00000000005b8a5b
