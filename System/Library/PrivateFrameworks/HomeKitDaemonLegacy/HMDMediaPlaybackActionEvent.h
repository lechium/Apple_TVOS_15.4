...
- (void).cxx_destruct;	// IMP=0x00000000006200a5
...
- (id)initWithIsPlaybackArchivePresent:(_Bool)arg1 playbackStateNumber:(id)arg2 volumeNumber:(id)arg3 sourceNumber:(id)arg4 sourceClientName:(id)arg5 accessories:(id)arg6;	// IMP=0x000000000061fb6a
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x000000000001b647
