...
+ (_Bool)isNewBetter:(unsigned long long)arg1 present:(unsigned long long)arg2;	// IMP=0x0000000000929b7b
- (void).cxx_destruct;	// IMP=0x0000000000929b39
...
- (id)description;	// IMP=0x0000000000929a9e
- (void)dealloc;	// IMP=0x00000000009299ff
- (_Bool)removeSync;	// IMP=0x0000000000929842
- (void)addNewSync:(id)arg1;	// IMP=0x000000000092920c
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, nonatomic) HMDWatchSync *currentSync;
- (id)initWithDeviceId:(id)arg1 pairedSync:(id)arg2;	// IMP=0x0000000000929067
