...
+ (id)logCategory;	// IMP=0x00000000008797aa
+ (id)shortDescription;	// IMP=0x0000000000879798
- (void).cxx_destruct;	// IMP=0x0000000000879725
...
- (void)clearData;	// IMP=0x0000000000879567
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x0000000000878aad
- (id)extractObjectChange;	// IMP=0x0000000000877fd9
- (id)description;	// IMP=0x0000000000877f6d
- (id)shortDescription;	// IMP=0x0000000000877e7d
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x0000000000877d25
- (id)init;	// IMP=0x0000000000877c7d
