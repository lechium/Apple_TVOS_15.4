...
#import <HomeKitDaemonLegacy/HMDSettingTransaction-Protocol.h>
...
- (void).cxx_destruct;	// IMP=0x00000000001b7b58
...
- (void)addModelToBeUpdated:(id)arg1;	// IMP=0x00000000001b7a9f
- (void)removeModelWithIdentifier:(id)arg1;	// IMP=0x00000000001b7a2d
- (void)addModel:(id)arg1;	// IMP=0x00000000001b79bb
- (void)addSettingModel:(id)arg1;	// IMP=0x00000000001b7876
- (id)initForInitialCreationWithTransactionLabel:(id)arg1;	// IMP=0x00000000001b77aa
- (id)initWithTransactionLabel:(id)arg1;	// IMP=0x00000000001b76de
