...
- (void).cxx_destruct;	// IMP=0x00000000009b95f1
...
- (id)attributeDescriptions;	// IMP=0x00000000009b92fb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009b9278
- (unsigned long long)hash;	// IMP=0x00000000009b9234
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x00000000009b8bb2
- (long long)compare:(id)arg1;	// IMP=0x00000000009b8b9e
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x00000000009b86f6
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x00000000009b8502
