...
- (void).cxx_destruct;	// IMP=0x00000000001dc88e
...
- (id)mainReturningError;	// IMP=0x00000000001dc207
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001dc126
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001dc045
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001dbf64
