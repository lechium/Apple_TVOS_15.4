...
+ (id)logCategory;	// IMP=0x000000000049d47a
+ (long long)colorTemperatureMiredsFromKelvins:(long long)arg1;	// IMP=0x000000000049d457
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000049d44f
- (void).cxx_destruct;	// IMP=0x000000000049d30d
...
- (id)transitionPointsWithmillisecondsElapsedSinceStartOfDay:(unsigned long long)arg1;	// IMP=0x000000000049c6b5
- (id)colorTemperatureForBrightness:(long long)arg1 millisecondsElapsedSinceStartOfDay:(unsigned long long)arg2;	// IMP=0x000000000049c4e7
@property(readonly) unsigned long long checksum;
- (id)attributeDescriptions;	// IMP=0x000000000049bd33
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000049bc04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000049bbf9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000049b8b3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000049b47b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000049aa74
- (id)initWithCurve:(id)arg1 minimumColorTemperature:(long long)arg2 maximumColorTemperature:(long long)arg3;	// IMP=0x000000000049a4eb
- (id)initWithVersion:(unsigned long long)arg1 transitionPoints:(id)arg2 minimumBrightness:(long long)arg3 maximumBrightness:(long long)arg4 minimumColorTemperature:(long long)arg5 maximumColorTemperature:(long long)arg6;	// IMP=0x000000000049a41d
