...
+ (id)eventWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x0000000000356ea0
@property(readonly, nonatomic) struct _HMFRate budgetRate; // @synthesize budgetRate=_budgetRate;
- (id)initWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x0000000000356e35
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000a780b8
