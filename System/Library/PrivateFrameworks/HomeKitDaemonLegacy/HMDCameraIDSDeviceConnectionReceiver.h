...
+ (id)logCategory;	// IMP=0x0000000000236087
- (void).cxx_destruct;	// IMP=0x0000000000235ff9
...
- (id)logIdentifier;	// IMP=0x0000000000235f57
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x0000000000235d9b
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x0000000000235bdf
@property(readonly, nonatomic) int remoteAudioSocket;
@property(readonly, nonatomic) int remoteVideoSocket;
- (void)setUpRemoteConnectionWithDevice:(id)arg1;	// IMP=0x0000000000235aa6
@property(readonly) IDSSession *session;
- (void)dealloc;	// IMP=0x00000000002359b9
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 delegate:(id)arg3 delegateQueue:(id)arg4;	// IMP=0x000000000023584d
