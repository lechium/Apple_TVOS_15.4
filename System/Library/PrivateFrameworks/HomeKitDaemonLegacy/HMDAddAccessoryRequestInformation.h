...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000009ca5ac
- (void).cxx_destruct;	// IMP=0x00000000009ca54f
...
- (void)storeIdentifierFromUnassociatedAccessory:(id)arg1 setupCode:(id)arg2;	// IMP=0x00000000009ca3ec
- (void)cancelCleanupTimer;	// IMP=0x00000000009ca38e
- (void)startCleanupTimerForDelegate:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x00000000009ca1f9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009ca070
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009c9fba
- (id)initWithAccessoryName:(id)arg1 category:(id)arg2 bundleID:(id)arg3 accessoryDescription:(id)arg4;	// IMP=0x00000000009c9e70
