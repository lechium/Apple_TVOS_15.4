...
- (void).cxx_destruct;	// IMP=0x0000000000283096
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000282f95
- (unsigned long long)hash;	// IMP=0x0000000000282ef6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000282dd1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000282d00
- (void)copyTo:(id)arg1;	// IMP=0x0000000000282c5c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000282bae
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000282ba1
- (id)dictionaryRepresentation;	// IMP=0x00000000002829d9
- (id)description;	// IMP=0x000000000028292a
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000282898
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000282832
