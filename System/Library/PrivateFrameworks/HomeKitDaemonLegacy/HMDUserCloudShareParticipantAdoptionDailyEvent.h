...
- (void).cxx_destruct;	// IMP=0x00000000007c2cf8
...
- (id)initWithConfigureState:(long long)arg1 hasOwnerCloudShareID:(_Bool)arg2;	// IMP=0x00000000007c2c13
- (id)serializedEvent;	// IMP=0x00000000005bbedd
- (id)eventName;	// IMP=0x00000000005bbed0
