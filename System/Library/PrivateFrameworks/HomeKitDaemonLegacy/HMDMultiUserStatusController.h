...
+ (id)logCategory;	// IMP=0x00000000009bcdb0
- (void).cxx_destruct;	// IMP=0x00000000009bcbaf
...
- (void)didChangeHasActiveAccountState:(_Bool)arg1;	// IMP=0x00000000009bc95e
- (void)didUpdateDataSyncState:(unsigned long long)arg1;	// IMP=0x00000000009bc7ee
@property long long multiUserState; // @synthesize multiUserState=_multiUserState;
- (id)initWithQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000009bc6b5
