...
- (void).cxx_destruct;	// IMP=0x00000000001cbc9a
...
- (void)deregisterFromAllMessages;	// IMP=0x00000000001cbaf1
- (void)registerForMessage:(id)arg1 policies:(id)arg2 messageDispatcher:(id)arg3 messageHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000001cba4e
- (id)initWithIdentifier:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001cb9ac
