...
- (void).cxx_destruct;	// IMP=0x000000000027d931
...
- (id)attributeDescriptions;	// IMP=0x000000000027d6be
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027d608
- (_Bool)isEqualValue:(id)arg1;	// IMP=0x000000000027d3b9
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4 readVersion:(id)arg5 writeVersion:(id)arg6;	// IMP=0x000000000027d2bb
