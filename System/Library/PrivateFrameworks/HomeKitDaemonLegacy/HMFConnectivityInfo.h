...
+ (id)shortDescription;	// IMP=0x000000000052303f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000523037
+ (id)connectivityInfoWithAccessoryIdentifier:(id)arg1 wakeConfiguration:(id)arg2;	// IMP=0x0000000000522d5e
- (void).cxx_destruct;	// IMP=0x0000000000522d1c
...
- (id)description;	// IMP=0x0000000000522c04
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005228de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000052274c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052259d
- (unsigned long long)hash;	// IMP=0x00000000005224de
@property(readonly, nonatomic) HMFWoWLANInfo *woWLANInfo;
- (id)initWithAccessoryIdentifier:(id)arg1 woBLEInfo:(id)arg2 woWLANInfos:(id)arg3;	// IMP=0x000000000052212b
