...
+ (id)logCategory;	// IMP=0x0000000000247386
- (void).cxx_destruct;	// IMP=0x000000000024731f
...
- (id)logIdentifier;	// IMP=0x0000000000247260
@property(readonly, nonatomic) NSArray *logEventProviderDailySubmissionBlocks;
- (void)triggerLogEventProviderDailySubmissionBlocks;	// IMP=0x000000000024709c
- (void)submitMultiUserSettingsDailyEvent;	// IMP=0x0000000000246d6b
- (void)registerForDailyMultiUserSettingsEvents;	// IMP=0x0000000000246d1f
- (id)initWithIdentifier:(id)arg1 logEventSubmitter:(id)arg2 logEventDailyScheduler:(id)arg3;	// IMP=0x0000000000246c59
