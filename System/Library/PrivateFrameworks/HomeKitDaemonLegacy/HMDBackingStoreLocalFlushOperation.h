...
- (void).cxx_destruct;	// IMP=0x00000000006dac77
...
- (void)main;	// IMP=0x00000000006da642
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006da576
