...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x000000000076988d
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x0000000000769691
- (void).cxx_destruct;	// IMP=0x0000000000769669
...
- (id)description;	// IMP=0x00000000007694f6
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x0000000000769349
