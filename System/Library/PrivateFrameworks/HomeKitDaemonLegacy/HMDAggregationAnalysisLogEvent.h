...
@interface HMDAggregationAnalysisLogEvent : HMMLogEvent <HMDAWDLogEvent, HMMCoreAnalyticsLogging>
{
    ...
    unsigned long long _currentDeviceStartedElectionCount;	// 632 = 0x278
    unsigned long long _activeDaysPerMonthCount;	// 640 = 0x280
    long long _countOfDaysSinceLastActive;	// 648 = 0x288
    HMDEventCountersManager *_eventCountersManager;	// 656 = 0x290
    HMDEventFlagsManager *_eventFlagsManager;	// 664 = 0x298
}

+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x000000000008a485
- (void).cxx_destruct;	// IMP=0x000000000008a443
...
@property unsigned long long currentDeviceStartedElectionCount; // @synthesize currentDeviceStartedElectionCount=_currentDeviceStartedElectionCount;
...
- (id)metricForAWD;	// IMP=0x0000000000088ec1
- (unsigned int)AWDMessageType;	// IMP=0x0000000000088eb6
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (void)submitAtDate:(id)arg1;	// IMP=0x0000000000086b66
- (id)alertMessageForRadarDialogWithCloudSyncBytesThreshold:(unsigned long long)arg1 remoteMessageCountThreshold:(unsigned long long)arg2;	// IMP=0x0000000000086821
- (id)alertMessageForRadarDialog;	// IMP=0x00000000000866c7
- (id)initWithDataSyncStateDescription:(id)arg1 eventCountersManager:(id)arg2 eventFlagsManager:(id)arg3;	// IMP=0x0000000000086625
