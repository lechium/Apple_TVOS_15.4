...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000008c3b06
- (void).cxx_destruct;	// IMP=0x00000000008c3ab3
...
- (void)close;	// IMP=0x00000000008c3a32
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000008c3858
