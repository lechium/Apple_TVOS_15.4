...
+ (id)logCategory;	// IMP=0x00000000006ceb5e
- (void).cxx_destruct;	// IMP=0x00000000006ceafa
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x00000000006ce62f
- (void)dealloc;	// IMP=0x00000000006ce5b3
- (id)logIdentifier;	// IMP=0x00000000006ce563
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x00000000006ce397
