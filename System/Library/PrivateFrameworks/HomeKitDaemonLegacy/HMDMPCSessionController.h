...
- (void).cxx_destruct;	// IMP=0x0000000000a8ba52
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a8aaf9
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000a8aa03
