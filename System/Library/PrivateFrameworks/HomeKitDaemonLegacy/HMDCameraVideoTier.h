...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000892eae
- (void).cxx_destruct;	// IMP=0x0000000000892e4a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000892c95
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000892afe
- (unsigned long long)hash;	// IMP=0x0000000000892aba
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008929e7
- (id)description;	// IMP=0x00000000008928d0
- (id)initWithVideoResolution:(id)arg1 framerate:(id)arg2 minBitRate:(id)arg3 maxBitRate:(id)arg4 rtcpInterval:(id)arg5;	// IMP=0x00000000008927b8
