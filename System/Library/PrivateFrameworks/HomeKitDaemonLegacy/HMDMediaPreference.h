...
+ (void)load;	// IMP=0x000000000023be87
- (void).cxx_destruct;	// IMP=0x000000000023be74
@property(readonly) HMFSystemPreference *homeKitPreference; // @synthesize homeKitPreference=_homeKitPreference;
- (id)stringValue;	// IMP=0x000000000023be0e
- (id)numberValue;	// IMP=0x000000000023bce5
- (_Bool)boolValue;	// IMP=0x000000000023bca1
...
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x000000000023ba0e
