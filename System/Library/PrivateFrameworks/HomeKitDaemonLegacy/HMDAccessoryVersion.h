...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000007ed619
- (void).cxx_destruct;	// IMP=0x00000000007ed606
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007ed592
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007ed4f7
@property(readonly, copy, nonatomic) NSString *rawVersionString; // @synthesize rawVersionString=_rawVersionString;
- (id)initWithVersionString:(id)arg1;	// IMP=0x00000000007ed385
