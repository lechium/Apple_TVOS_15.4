...
- (void).cxx_destruct;	// IMP=0x000000000076b608
...
- (id)mainReturningError;	// IMP=0x000000000076b168
- (id)initWithAtomicSaveEnabled:(_Bool)arg1 transaction:(id)arg2;	// IMP=0x000000000076b0d5
- (id)initWithTransaction:(id)arg1;	// IMP=0x000000000076b06a
