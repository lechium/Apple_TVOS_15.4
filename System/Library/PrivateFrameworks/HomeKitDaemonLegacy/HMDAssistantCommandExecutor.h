...
+ (id)executorWithCommand:(id)arg1 workQueue:(id)arg2 messageDispatcher:(id)arg3;	// IMP=0x00000000005846d0
- (void).cxx_destruct;	// IMP=0x0000000000583b6e
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000058386b
- (id)_command;	// IMP=0x0000000000583852
- (void)performWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000582bc4
- (id)initWithCommand:(id)arg1 workQueue:(id)arg2 messageDispatcher:(id)arg3;	// IMP=0x0000000000582ab4
