...
+ (id)tupleWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x000000000000f7c9
- (void).cxx_destruct;	// IMP=0x000000000000f765
...
- (void)updatePostingTime;	// IMP=0x000000000000f699
- (id)initWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x000000000000f554
