...
- (void).cxx_destruct;	// IMP=0x00000000000515ef
...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x000000000005151b
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x000000000005138d
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000510af
