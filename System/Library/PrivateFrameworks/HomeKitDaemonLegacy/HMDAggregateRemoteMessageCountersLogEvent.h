...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x00000000004e2e64
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 count:(id)arg5;	// IMP=0x00000000004e2d9c
- (void).cxx_destruct;	// IMP=0x00000000004e2d38
...
- (id)__initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 count:(id)arg5;	// IMP=0x00000000004e2a37
- (id)init;	// IMP=0x00000000004e298f
