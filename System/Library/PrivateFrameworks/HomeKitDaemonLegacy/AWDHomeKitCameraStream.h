...
+ (Class)resolutionCountType;	// IMP=0x00000000003e3551
+ (Class)reconfigurationsType;	// IMP=0x00000000003e3540
- (void).cxx_destruct;	// IMP=0x00000000003e2a85
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003e22d1
- (unsigned long long)hash;	// IMP=0x00000000003e1fe3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003e1b31
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003e1526
- (void)copyTo:(id)arg1;	// IMP=0x00000000003e1154
- (void)writeTo:(id)arg1;	// IMP=0x00000000003e0cc1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003e0cb4
- (id)dictionaryRepresentation;	// IMP=0x00000000003e01b5
- (id)description;	// IMP=0x00000000003e0106
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003e00e9
- (unsigned long long)resolutionCountsCount;	// IMP=0x00000000003e00cc
- (void)addResolutionCount:(id)arg1;	// IMP=0x00000000003e0062
- (void)clearResolutionCounts;	// IMP=0x00000000003e0045
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x00000000003dfea4
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x00000000003dfdca
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003dfb7b
- (unsigned long long)reconfigurationsCount;	// IMP=0x00000000003dfb5e
- (void)addReconfigurations:(id)arg1;	// IMP=0x00000000003dfaf4
- (void)clearReconfigurations;	// IMP=0x00000000003dfad7
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000003df8f0
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000003df88a
