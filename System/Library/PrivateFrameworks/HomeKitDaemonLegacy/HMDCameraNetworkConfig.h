...
+ (id)localIPAddress;	// IMP=0x000000000056bf85
- (void).cxx_destruct;	// IMP=0x000000000056bf54
...
- (id)description;	// IMP=0x000000000056bdfa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056bd1c
- (id)initWithAddress:(id)arg1 ipv6:(_Bool)arg2 rtpPort:(id)arg3;	// IMP=0x000000000056bc7b
- (id)init;	// IMP=0x000000000056bc3c
