...
- (void).cxx_destruct;	// IMP=0x00000000007479e2
...
- (id)description;	// IMP=0x00000000007478aa
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x00000000007477f9
