...
- (void).cxx_destruct;	// IMP=0x00000000002d3d13
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d3b51
- (id)description;	// IMP=0x00000000002d39fb
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x00000000002d3902
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x00000000002d383c
