...
+ (id)shortDescription;	// IMP=0x000000000001b635
- (void).cxx_destruct;	// IMP=0x000000000001b606
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000001b14f
- (id)initWithBiomeEventManager:(id)arg1 dataSource:(id)arg2;	// IMP=0x000000000001b0ad
