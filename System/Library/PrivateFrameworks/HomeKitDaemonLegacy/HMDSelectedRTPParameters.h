...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000733a0
- (void).cxx_destruct;	// IMP=0x000000000007331a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000730ca
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000072bfb
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000729bc
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000072647
- (id)tlvData;	// IMP=0x0000000000072430
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 maxMTU:(id)arg5 comfortNoisePayloadType:(id)arg6;	// IMP=0x00000000000722ec
