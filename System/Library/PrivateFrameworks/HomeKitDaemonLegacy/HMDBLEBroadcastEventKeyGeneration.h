...
+ (id)broadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x00000000007289bc
- (void).cxx_destruct;	// IMP=0x00000000007289a9
...
- (id)initBroadcastKeyGenerationEventForAccessory:(id)arg1 reason:(int)arg2;	// IMP=0x0000000000728908
- (id)metricForAWD;	// IMP=0x000000000079795c
- (unsigned int)AWDMessageType;	// IMP=0x0000000000797951
