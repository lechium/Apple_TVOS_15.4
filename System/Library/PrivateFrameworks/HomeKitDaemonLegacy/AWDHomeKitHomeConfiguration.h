...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x00000000005b2ca9
+ (Class)hapServicesListCertifiedType;	// IMP=0x00000000005b2c98
+ (Class)primaryHAPServicesListType;	// IMP=0x00000000005b2c87
+ (Class)hapServicesListType;	// IMP=0x00000000005b2c76
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x00000000005b2c65
+ (Class)eventTriggersType;	// IMP=0x00000000005b2c54
- (void).cxx_destruct;	// IMP=0x00000000005af67c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000005adbc8
- (unsigned long long)hash;	// IMP=0x00000000005acda7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005abaad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005aa446
- (void)copyTo:(id)arg1;	// IMP=0x00000000005a9163
- (void)writeTo:(id)arg1;	// IMP=0x00000000005a7c63
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005a7c56
- (id)dictionaryRepresentation;	// IMP=0x00000000005a4e26
- (id)description;	// IMP=0x00000000005a4d77
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x00000000005a484a
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x00000000005a47e3
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005a3ea7
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x00000000005a3e8a
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x00000000005a3e20
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x00000000005a3e03
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005a3de6
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x00000000005a3dc9
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x00000000005a3d5f
- (void)clearHapServicesListCertifieds;	// IMP=0x00000000005a3d42
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005a3d25
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x00000000005a3d08
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x00000000005a3c9e
- (void)clearPrimaryHAPServicesLists;	// IMP=0x00000000005a3c81
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005a3c64
- (unsigned long long)hapServicesListsCount;	// IMP=0x00000000005a3c47
- (void)addHapServicesList:(id)arg1;	// IMP=0x00000000005a3bdd
- (void)clearHapServicesLists;	// IMP=0x00000000005a3bc0
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005a3998
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x00000000005a397b
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x00000000005a3911
- (void)clearHomeKitMultiUserSettings;	// IMP=0x00000000005a38f4
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x00000000005a35a0
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x00000000005a353a
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000005a2edb
- (unsigned long long)eventTriggersCount;	// IMP=0x00000000005a2ebe
- (void)addEventTriggers:(id)arg1;	// IMP=0x00000000005a2e54
- (void)clearEventTriggers;	// IMP=0x00000000005a2e37
