...
+ (void)initialize;	// IMP=0x0000000000249101
- (void).cxx_destruct;	// IMP=0x00000000002490d0
...
- (_Bool)isSubmitted;	// IMP=0x0000000000248e36
...
- (id)createHistogrammedCommonDimensions;	// IMP=0x0000000000247f90
- (id)initWithHomeConfigurations:(id)arg1;	// IMP=0x0000000000247658
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x00000000002473ed
- (int)convertToAWDNetworkProtectionStatus:(int)arg1;	// IMP=0x0000000000790c2c
- (int)convertToAWDMultiUserValueType:(int)arg1;	// IMP=0x0000000000790c0c
- (id)convertToAWDMultiUserSettings:(id)arg1;	// IMP=0x0000000000790851
- (id)convertToAWDMultiUserSettingsList:(id)arg1;	// IMP=0x000000000079066f
- (id)getHomeConfiguration:(id)arg1;	// IMP=0x000000000078fa2b
- (id)generateAWDHomeConfiguration:(id)arg1;	// IMP=0x000000000078f849
- (id)metricForAWD;	// IMP=0x000000000078f544
- (unsigned int)AWDMessageType;	// IMP=0x000000000078f539
