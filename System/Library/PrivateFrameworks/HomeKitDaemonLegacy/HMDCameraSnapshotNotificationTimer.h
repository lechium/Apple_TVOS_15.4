...
- (void).cxx_destruct;	// IMP=0x0000000000913649
...
- (id)initWithCameraSessionID:(id)arg1 changedCharacteristics:(id)arg2 timeInterval:(double)arg3;	// IMP=0x0000000000913554
