...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000047c3e1
- (void).cxx_destruct;	// IMP=0x000000000047c38d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000047bbe3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000047bab0
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000047b444
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000047ad51
- (id)initWithProtocol:(id)arg1 hostDNSName:(id)arg2 hostIPStart:(id)arg3 hostIPEnd:(id)arg4 hostPortStart:(id)arg5 hostPortEnd:(id)arg6;	// IMP=0x000000000047ac29
- (id)init;	// IMP=0x000000000047abfa
- (void)addTo:(id)arg1;	// IMP=0x0000000000406e58
