...
+ (id)logCategory;	// IMP=0x000000000025cd5a
+ (_Bool)isRoleSupported:(long long)arg1;	// IMP=0x000000000025cd26
- (void).cxx_destruct;	// IMP=0x000000000025c061
...
- (id)setupTrackingInfo;	// IMP=0x000000000025bdac
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x000000000025bd38
- (void)_sendRequestData:(id)arg1;	// IMP=0x000000000025bb5c
- (void)_handleReceiveData:(id)arg1;	// IMP=0x000000000025babf
- (void)_handleClose:(id)arg1;	// IMP=0x000000000025b94e
- (void)_closeWithError:(id)arg1;	// IMP=0x000000000025b39c
- (void)open;	// IMP=0x000000000025b2d4
- (void)__registerForMessages;	// IMP=0x000000000025b18a
- (id)messageDispatcher;	// IMP=0x000000000025b136
- (id)messageDestination;	// IMP=0x000000000025b0cd
@property(readonly) long long role;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025afad
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3 dateFactory:(CDUnknownBlockType)arg4;	// IMP=0x000000000025ab85
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3;	// IMP=0x000000000025ab6c
- (id)init;	// IMP=0x000000000025aac4
