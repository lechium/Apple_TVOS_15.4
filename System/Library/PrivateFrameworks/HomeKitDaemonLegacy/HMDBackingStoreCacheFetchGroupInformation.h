...
- (void).cxx_destruct;	// IMP=0x00000000001dbe6b
...
- (id)mainReturningError;	// IMP=0x00000000001dbc09
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001dbb4d
