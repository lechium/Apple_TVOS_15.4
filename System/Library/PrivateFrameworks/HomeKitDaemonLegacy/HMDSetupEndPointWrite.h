...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000071287
- (void).cxx_destruct;	// IMP=0x0000000000071234
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007110d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070e66
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000070c78
- (_Bool)_parseFromTLVDataOnFailure;	// IMP=0x0000000000070b85
- (_Bool)_parseFromTLVDataOnSuccess;	// IMP=0x0000000000070b73
- (_Bool)_parseFromTLVDataImpl;	// IMP=0x00000000000708a5
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000070893
- (id)tlvData;	// IMP=0x00000000000706e8
- (id)initWithSessionIdentifier:(id)arg1 address:(id)arg2 videoSrtpParameters:(id)arg3 audioSrtpParameters:(id)arg4;	// IMP=0x00000000000705f1
