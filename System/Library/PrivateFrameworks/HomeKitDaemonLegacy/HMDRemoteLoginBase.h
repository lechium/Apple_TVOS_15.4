...
+ (id)logCategory;	// IMP=0x0000000000665f2e
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x0000000000665f26
- (void).cxx_destruct;	// IMP=0x0000000000665eb5
...
- (id)logIdentifier;	// IMP=0x0000000000665e05
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)registerForMessages;	// IMP=0x0000000000665ddb
- (void)configureWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x0000000000665d7a
@property(readonly, copy) NSString *description;
- (id)initWithUUID:(id)arg1 accessory:(id)arg2 remoteLoginHandler:(id)arg3;	// IMP=0x0000000000665b8c
