...
- (void).cxx_destruct;	// IMP=0x0000000000621825
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000006216b7
- (unsigned long long)hash;	// IMP=0x0000000000621422
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006212ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000621190
- (void)copyTo:(id)arg1;	// IMP=0x00000000006210b1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000620fc2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000620fb5
- (id)dictionaryRepresentation;	// IMP=0x0000000000620dbd
- (id)description;	// IMP=0x0000000000620d0e
