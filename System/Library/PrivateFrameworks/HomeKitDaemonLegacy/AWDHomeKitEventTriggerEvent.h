...
- (void).cxx_destruct;	// IMP=0x000000000072182f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007214fc
- (unsigned long long)hash;	// IMP=0x00000000007213cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000072118a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000720fd3
- (void)copyTo:(id)arg1;	// IMP=0x0000000000720e90
- (void)writeTo:(id)arg1;	// IMP=0x0000000000720d60
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000720d53
- (id)dictionaryRepresentation;	// IMP=0x0000000000720a59
- (id)description;	// IMP=0x00000000007209aa
