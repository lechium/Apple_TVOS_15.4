...
- (void).cxx_destruct;	// IMP=0x00000000007c2b5a
...
- (id)initWithConfigureState:(long long)arg1 isPrimaryResident:(_Bool)arg2 trustStatusCounts:(struct CloudShareTrustManagerTrustStatusCounts)arg3;	// IMP=0x00000000007c2857
