...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x0000000000624904
+ (id)logCategory;	// IMP=0x00000000006248d4
- (void).cxx_destruct;	// IMP=0x0000000000624d56
...
- (id)logIdentifier;	// IMP=0x0000000000624c4e
- (void)residentChanged;	// IMP=0x0000000000624c48
- (void)timerFired:(id)arg1;	// IMP=0x0000000000624c42
- (void)handleHomeDataLoadedNotification:(id)arg1;	// IMP=0x0000000000624c3c
- (void)_registerForMessages;	// IMP=0x0000000000624bee
- (void)configure:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x0000000000624b7e
- (void)_initialize:(id)arg1;	// IMP=0x0000000000624943
