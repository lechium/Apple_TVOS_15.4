...
+ (id)xpcFilteredCountersLogEventWithPeerInformation:(id)arg1 messageName:(id)arg2 count:(id)arg3;	// IMP=0x000000000028adb6
+ (id)xpcSentCountersLogEventWithPeerInformation:(id)arg1 messageName:(id)arg2 count:(id)arg3;	// IMP=0x000000000028ad21
+ (id)xpcAcceptedCountersLogEventWithPeerInformation:(id)arg1 messageName:(id)arg2 count:(id)arg3;	// IMP=0x000000000028ac8c
- (void).cxx_destruct;	// IMP=0x000000000028ac39
...
- (id)initWithEventName:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x000000000028a97c
