...
+ (id)logCategory;	// IMP=0x00000000008f8425
- (void).cxx_destruct;	// IMP=0x00000000008f75c3
...
- (void)remove;	// IMP=0x00000000008f7374
- (void)database:(id)arg1 didReceiveMessageWithUserInfo:(id)arg2;	// IMP=0x00000000008f7284
- (void)database:(id)arg1 didRemoveZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x00000000008f71ab
- (id)database:(id)arg1 willRemoveZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x00000000008f70c1
- (void)database:(id)arg1 didCreateZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x00000000008f6ffa
- (id)logIdentifier;	// IMP=0x00000000008f6fe8
@property(readonly, getter=isConfigured) _Bool configured;
- (id)initWithDatabase:(id)arg1 workQueue:(id)arg2 zoneName:(id)arg3 createZoneIfNotExists:(_Bool)arg4;	// IMP=0x00000000008f6da7
