...
+ (int)awdOperationEnumFromCameraClipOperationType:(unsigned long long)arg1;	// IMP=0x00000000007987a5
- (void).cxx_destruct;	// IMP=0x00000000008767b5
...
- (id)attributeDescriptions;	// IMP=0x0000000000876355
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x00000000008762a2
- (id)metricForAWD;	// IMP=0x0000000000791747
- (unsigned int)AWDMessageType;	// IMP=0x000000000079173c
