...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002de739
- (unsigned long long)hash;	// IMP=0x00000000002de6be
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002de5c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002de518
- (void)copyTo:(id)arg1;	// IMP=0x00000000002de48c
- (void)writeTo:(id)arg1;	// IMP=0x00000000002de3dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002de3d0
- (id)dictionaryRepresentation;	// IMP=0x00000000002de22b
- (id)description;	// IMP=0x00000000002de17c
