...
- (void).cxx_destruct;	// IMP=0x0000000000803b4f
...
- (id)initWithUUID:(id)arg1 accessoryName:(id)arg2 manufacturerName:(id)arg3 category:(id)arg4 certificationStatus:(unsigned long long)arg5 productData:(id)arg6;	// IMP=0x00000000008039c0
