...
+ (id)logCategory;	// IMP=0x000000000040a791
- (void).cxx_destruct;	// IMP=0x000000000040a654
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x000000000040a217
- (id)logIdentifier;	// IMP=0x000000000040a1c7
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x000000000040a03f
