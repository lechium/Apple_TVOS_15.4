...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000882f9d
- (void).cxx_destruct;	// IMP=0x0000000000882f5b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000882e36
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000882d07
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000882b41
- (id)attributeDescriptions;	// IMP=0x00000000008829cb
- (id)shortDescription;	// IMP=0x0000000000882930
- (id)initWithDevice:(id)arg1 state:(unsigned long long)arg2;	// IMP=0x0000000000882850
