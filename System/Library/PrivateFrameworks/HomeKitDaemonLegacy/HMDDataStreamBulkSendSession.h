...
+ (id)logCategory;	// IMP=0x0000000000a37b9c
- (void).cxx_destruct;	// IMP=0x0000000000a378c5
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000a3768c
- (void)_closeSession;	// IMP=0x0000000000a375b2
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000a37501
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000a3744a
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a3730b
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000a37278
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000a37132
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000a36fed
