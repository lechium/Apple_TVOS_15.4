...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000a50891
- (void).cxx_destruct;	// IMP=0x0000000000a507a4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000a50648
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a503cd
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000a501ef
- (id)tlvData;	// IMP=0x0000000000a4ffe2
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000a4fd8b
- (id)initWithChannelCount:(id)arg1 bitRateModes:(id)arg2 audioSampleRates:(id)arg3 maxAudioBitRate:(id)arg4;	// IMP=0x0000000000a4fc94
