...
+ (id)logCategory;	// IMP=0x00000000002c3a25
- (void).cxx_destruct;	// IMP=0x00000000002c2c05
...
- (void)removeResponses:(id)arg1;	// IMP=0x00000000002c29b8
- (void)addActionSetRequest:(id)arg1 actionSet:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c2533
- (void)addWriteRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c2141
- (void)addReadRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c1d50
- (void)addMediaWriteRequests:(id)arg1 withRequestProperty:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c1645
- (void)handleAccessoryCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000002c1594
- (void)__handleAccessoryCharacteristicsChanged:(id)arg1;	// IMP=0x00000000002c06cc
- (void)_reportOperationStartedForAccessory:(id)arg1;	// IMP=0x00000000002bfe89
- (void)reportOperationStartedForAccessory:(id)arg1;	// IMP=0x00000000002bfdd8
- (void)_reportResponses;	// IMP=0x00000000002bf134
- (void)_reportResponsesForMediaRequests;	// IMP=0x00000000002bea07
- (void)timeoutAndReportResults;	// IMP=0x00000000002be996
- (void)_register;	// IMP=0x00000000002be932
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)dealloc;	// IMP=0x00000000002be866
- (id)initWithQueue:(id)arg1 msgDispatcher:(id)arg2;	// IMP=0x00000000002be708
