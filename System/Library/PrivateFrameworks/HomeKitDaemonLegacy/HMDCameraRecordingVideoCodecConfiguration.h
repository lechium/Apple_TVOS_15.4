...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000007a3bb7
- (void).cxx_destruct;	// IMP=0x00000000007a3b28
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007a3a12
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007a3854
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000007a3655
- (id)tlvData;	// IMP=0x00000000007a3496
- (_Bool)_parseFromTLVData;	// IMP=0x00000000007a326e
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 videoAttributes:(id)arg3;	// IMP=0x00000000007a31a8
