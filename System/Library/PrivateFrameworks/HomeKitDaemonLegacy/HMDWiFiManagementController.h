...
+ (id)logCategory;	// IMP=0x00000000003cada5
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x00000000003cab3e
- (void).cxx_destruct;	// IMP=0x00000000003c8b45
...
- (id)logIdentifier;	// IMP=0x00000000003c89de
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000003c8330
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000000003c80f3
- (void)_commitConfigurationUpdate;	// IMP=0x00000000003c7fb6
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003c7e15
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x00000000003c7da4
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000003c7c30
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000003c7af8
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000003c7997
