...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000522123
- (void).cxx_destruct;	// IMP=0x00000000005220d0
...
- (id)description;	// IMP=0x0000000000521e1b
@property(readonly, nonatomic) NSString *wakeAddressString;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005219eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000052176d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052147e
- (unsigned long long)hash;	// IMP=0x000000000052135a
- (id)initWithWakeVersion:(unsigned char)arg1 wakePort:(unsigned short)arg2 wakeAddress:(id)arg3 wakeType:(long long)arg4 wakePacketType:(long long)arg5 wakePattern:(id)arg6;	// IMP=0x000000000052116a
- (id)initWithPrimaryIdentifier:(id)arg1 wifiIdentifiers:(id)arg2;	// IMP=0x0000000000520fef
