...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x000000000041147c
- (void).cxx_destruct;	// IMP=0x0000000000411429
...
- (id)proto;	// IMP=0x0000000000411350
- (id)initWithProtoData:(id)arg1;	// IMP=0x00000000004112b4
- (id)initWithProto:(id)arg1;	// IMP=0x0000000000411170
- (id)encodeAsProto;	// IMP=0x0000000000411120
- (id)serialize;	// IMP=0x000000000041110e
@property(readonly, nonatomic) unsigned int dataVersion;
- (id)initWithHomeUUID:(id)arg1 accessoryUUID:(id)arg2 characteristicUUID:(id)arg3 brightness:(id)arg4;	// IMP=0x000000000041100c
