...
+ (id)logCategory;	// IMP=0x0000000000632870
- (void).cxx_destruct;	// IMP=0x0000000000632311
...
- (void)setTrafficClass:(unsigned long long)arg1;	// IMP=0x00000000006321de
- (void)_handleInterruptCharacteristicValue:(id)arg1;	// IMP=0x0000000000631d69
- (void)_handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x0000000000631cb8
- (void)_handleReceivedData:(id)arg1;	// IMP=0x00000000006319c2
- (void)_notifyWriteOperation:(id)arg1 didCompleteWithError:(id)arg2;	// IMP=0x00000000006318d9
- (void)_cancelAllPendingWritesWithError:(id)arg1;	// IMP=0x0000000000631741
- (void)_removeAndMarkCompleteAllCompletedWrites;	// IMP=0x0000000000631545
- (void)_stopTransportForWriteFailureError:(id)arg1;	// IMP=0x00000000006314ea
- (void)_handleCompletionWithResponseTuples:(id)arg1;	// IMP=0x0000000000630d1b
- (void)_doNextWriteOperation;	// IMP=0x000000000063082a
- (id)_buildWriteRequestWithError:(id *)arg1 shouldForceClose:(_Bool)arg2;	// IMP=0x000000000063040e
- (id)_getPendingWritesUpToLength:(unsigned long long)arg1;	// IMP=0x000000000063018d
- (void)sendRawFrame:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000006300cd
- (void)_notifyDelegateDidReceiveFrame:(id)arg1;	// IMP=0x000000000063001c
- (void)_notifyDelegateDidFailWithError:(id)arg1;	// IMP=0x000000000062ff6b
- (void)_notifyDelegateDidClose;	// IMP=0x000000000062fefa
- (void)_notifyDelegateDidOpen;	// IMP=0x000000000062fe89
- (void)_deregisterForMessages;	// IMP=0x000000000062fcd2
- (void)_registerForMessages;	// IMP=0x000000000062fb97
- (void)_teardownSessionWithError:(id)arg1;	// IMP=0x000000000062f906
- (void)_stopWithError:(id)arg1;	// IMP=0x000000000062f7fc
- (void)close;	// IMP=0x000000000062f6a3
- (void)connect;	// IMP=0x000000000062f202
- (_Bool)_isRunning;	// IMP=0x000000000062f1cf
- (void)dealloc;	// IMP=0x000000000062f1a0
- (id)initWithAccessory:(id)arg1 sessionIdentifier:(long long)arg2 maxControllerTransportMTU:(unsigned long long)arg3 workQueue:(id)arg4 logIdentifier:(id)arg5;	// IMP=0x000000000062efca
