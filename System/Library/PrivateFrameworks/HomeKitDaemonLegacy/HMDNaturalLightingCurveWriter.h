...
+ (id)logCategory;	// IMP=0x0000000000a6fba0
- (void).cxx_destruct;	// IMP=0x0000000000a6f5ee
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x0000000000a6f4bb
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a6f185
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)writeForNaturalLightingEnabledWithReason:(id)arg1;	// IMP=0x0000000000a6f081
- (void)synchronizeCurveWithActiveTransitionContext:(id)arg1;	// IMP=0x0000000000a6ec0a
- (void)writeWithNaturalLightingEnabled:(_Bool)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a6ea06
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)arg1;	// IMP=0x0000000000a6e833
- (void)handlePrimaryResidentUpdateNotification:(id)arg1;	// IMP=0x0000000000a6e782
- (void)handleActiveTransitionContextUpdated:(id)arg1;	// IMP=0x0000000000a6df5b
- (void)configureWithLightProfile:(id)arg1;	// IMP=0x0000000000a6dc8c
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3 dataSource:(id)arg4 notificationCenter:(id)arg5 timerFactory:(CDUnknownBlockType)arg6;	// IMP=0x0000000000a6db47
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3;	// IMP=0x0000000000a6da69
