...
- (void).cxx_destruct;	// IMP=0x00000000001de1e5
...
- (id)mainReturningError;	// IMP=0x00000000001ddf1f
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001dde63
