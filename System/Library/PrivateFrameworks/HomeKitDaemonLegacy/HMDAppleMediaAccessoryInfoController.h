...
- (void).cxx_destruct;	// IMP=0x00000000003c729d
...
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x00000000003c70a4
- (id)currentWifiNetworkInfo;	// IMP=0x00000000003c6fd5
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x00000000003c6dac
- (void)configure;	// IMP=0x00000000003c6ca7
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 notificationCenter:(id)arg3 wifiManager:(id)arg4;	// IMP=0x00000000003c6bca
