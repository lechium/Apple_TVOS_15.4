...
- (void).cxx_destruct;	// IMP=0x0000000000775513
...
- (void)forceRefresh;	// IMP=0x000000000077544f
- (void)markDeleted;	// IMP=0x000000000077543e
- (void)markChanged;	// IMP=0x000000000077542d
- (id)initWithZoneID:(id)arg1;	// IMP=0x0000000000775376
