...
+ (id)logCategory;	// IMP=0x00000000008ff799
+ (id)processInfoWithConnection:(id)arg1;	// IMP=0x00000000008ff69e
+ (id)privateClientIdentifierSalt;	// IMP=0x00000000008ff66e
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00000000008ff607
- (void).cxx_destruct;	// IMP=0x00000000008ff15d
...
- (id)logIdentifier;	// IMP=0x00000000008ff07a
- (id)clientIdentifierSalt:(id *)arg1;	// IMP=0x00000000008fef6f
- (void)removeConnection:(id)arg1;	// IMP=0x00000000008fee94
- (void)addConnection:(id)arg1;	// IMP=0x00000000008fec2b
...
- (void)_updateProcessState:(id)arg1;	// IMP=0x00000000008fddc8
@property(readonly) _Bool shouldMonitor;
- (id)attributeDescriptions;	// IMP=0x00000000008fdae2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008fd9be
- (id)initWithIdentifier:(int)arg1;	// IMP=0x00000000008fd762
- (id)initWithAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x00000000008fd31a
- (id)init;	// IMP=0x00000000008fd272
