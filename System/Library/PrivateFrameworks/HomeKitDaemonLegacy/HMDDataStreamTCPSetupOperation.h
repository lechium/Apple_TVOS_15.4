...
+ (id)logCategory;	// IMP=0x00000000001f0208
- (void).cxx_destruct;	// IMP=0x00000000001ed849
...
- (void)_finishStreamTransport;	// IMP=0x00000000001ed572
- (id)_createTCPTransport;	// IMP=0x00000000001ed307
- (void)_generateStreamKeys;	// IMP=0x00000000001ed0fe
- (void)processTransportSetupResponse:(id)arg1;	// IMP=0x00000000001eccf4
- (void)startSetup;	// IMP=0x00000000001ec635
- (id)_fullKeySalt;	// IMP=0x00000000001ec591
- (_Bool)_isComplete;	// IMP=0x00000000001ec51a
- (id)initWithAccessory:(id)arg1 queue:(id)arg2 logIdentifier:(id)arg3 transferManagementService:(id)arg4;	// IMP=0x00000000001ec4b7
