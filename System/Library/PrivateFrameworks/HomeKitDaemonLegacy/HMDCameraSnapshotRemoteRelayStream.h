...
+ (id)logCategory;	// IMP=0x00000000004cc990
- (void).cxx_destruct;	// IMP=0x00000000004cc4e7
...
- (void)snapshotStreamSender:(id)arg1 didCompleteSendImage:(id)arg2 sessionID:(id)arg3;	// IMP=0x00000000004cc388
- (void)snapshotStreamSender:(id)arg1 didStartCaptureImage:(id)arg2 sessionID:(id)arg3;	// IMP=0x00000000004cc277
- (void)snapshotRelayReceiver:(id)arg1 didSaveSnapshotFile:(id)arg2 error:(id)arg3 sessionID:(id)arg4;	// IMP=0x00000000004cc101
- (void)snapshotRelayReceiver:(id)arg1 didStartGettingImage:(id)arg2 sessionID:(id)arg3;	// IMP=0x00000000004cbfff
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x00000000004cbb9e
- (void)_callDidCompleteSendImageDelegate:(id)arg1;	// IMP=0x00000000004cb989
- (void)_callDidStartCaptureImageDelegate:(id)arg1;	// IMP=0x00000000004cb774
- (void)snapShotSendFailed:(id)arg1;	// IMP=0x00000000004cb6c3
- (void)snapShotTransferComplete;	// IMP=0x00000000004cb652
- (void)getSnapshot:(unsigned long long)arg1;	// IMP=0x00000000004cb5d6
- (id)logIdentifier;	// IMP=0x00000000004cb55c
- (void)dealloc;	// IMP=0x00000000004cb477
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 options:(id)arg3 device:(id)arg4 accessory:(id)arg5 delegate:(id)arg6 delegateQueue:(id)arg7 uniqueIdentifier:(id)arg8 snapshotRequestHandler:(id)arg9 residentMessageHandler:(id)arg10;	// IMP=0x00000000004cb26e
