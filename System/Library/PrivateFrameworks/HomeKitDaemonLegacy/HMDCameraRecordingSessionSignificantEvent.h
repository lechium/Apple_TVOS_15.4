...
- (void).cxx_destruct;	// IMP=0x000000000003ad4b
...
- (id)attributeDescriptions;	// IMP=0x000000000003a6d0
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a520
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a515
- (unsigned long long)hash;	// IMP=0x000000000003a4d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a160
- (id)initWithUUID:(id)arg1;	// IMP=0x000000000003a03a
