...
+ (int)closeReasonFromError:(id)arg1;	// IMP=0x000000000079f3d1
- (void).cxx_destruct;	// IMP=0x000000000079f3a0
...
- (id)metricForAWD;	// IMP=0x000000000079ee62
- (void)open;	// IMP=0x000000000079ed0a
- (id)initWithClientMode:(_Bool)arg1 sessionID:(id)arg2;	// IMP=0x000000000079eb77
- (unsigned int)AWDMessageType;	// IMP=0x000000000079eb6c
