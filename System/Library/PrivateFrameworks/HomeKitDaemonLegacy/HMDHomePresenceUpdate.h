...
- (void).cxx_destruct;	// IMP=0x0000000000323db6
...
- (id)description;	// IMP=0x0000000000323c7f
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x0000000000323ba7
