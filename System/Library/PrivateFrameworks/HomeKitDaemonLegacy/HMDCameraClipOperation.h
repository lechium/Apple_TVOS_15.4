...
+ (id)logCategory;	// IMP=0x00000000002a8086
+ (id)shortDescription;	// IMP=0x00000000002a8074
+ (unsigned long long)cameraClipOperationType;	// IMP=0x00000000002a7fcc
- (void).cxx_destruct;	// IMP=0x00000000002a7f35
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x00000000002a79f0
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x00000000002a76c5
- (id)fetchClipModel;	// IMP=0x00000000002a7479
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000002a735f
- (void)finish;	// IMP=0x00000000002a7245
- (void)main;	// IMP=0x00000000002a71c1
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000002a6e50
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x00000000002a6dcc
