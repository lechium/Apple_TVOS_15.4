...
+ (id)logCategory;	// IMP=0x000000000061f755
- (void).cxx_destruct;	// IMP=0x000000000061f5a1
...
- (void)_generateAllCombinations;	// IMP=0x000000000061d9c0
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x000000000061d855
- (id)createSelectedVideoParameters;	// IMP=0x000000000061d462
- (id)createSRTPParamters;	// IMP=0x000000000061d3e2
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x000000000061cafe
- (_Bool)selectVideoParameters;	// IMP=0x000000000061bb4a
- (id)logIdentifier;	// IMP=0x000000000061bafa
- (void)_setVideoResolutionPreference;	// IMP=0x000000000061b7c0
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x000000000061b5d0
