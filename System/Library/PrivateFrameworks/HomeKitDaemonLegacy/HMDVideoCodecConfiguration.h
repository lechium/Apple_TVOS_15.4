...
- (void).cxx_destruct;	// IMP=0x000000000006a9c9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006a8b3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006a641
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006a465
- (id)tlvData;	// IMP=0x000000000006a2a9
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006a06b
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 attributes:(id)arg3;	// IMP=0x0000000000069fa5
