...
+ (id)logCategory;	// IMP=0x0000000000324758
- (void).cxx_destruct;	// IMP=0x00000000003246ee
...
- (id)logIdentifier;	// IMP=0x000000000032464f
- (id)dataSourceAccessoryWithUUID:(id)arg1;	// IMP=0x0000000000324504
- (void)handleSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x0000000000323eb8
- (id)initWithIdentifier:(id)arg1 assistantSettingsConnection:(id)arg2;	// IMP=0x0000000000323df8
