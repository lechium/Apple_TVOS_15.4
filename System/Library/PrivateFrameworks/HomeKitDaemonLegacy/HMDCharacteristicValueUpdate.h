...
- (void).cxx_destruct;	// IMP=0x00000000005691c0
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x00000000005690a4
- (id)initWithError:(id)arg1;	// IMP=0x0000000000569036
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x0000000000568f70
