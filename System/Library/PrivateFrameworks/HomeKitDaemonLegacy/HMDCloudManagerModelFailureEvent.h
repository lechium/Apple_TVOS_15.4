...
- (void).cxx_destruct;	// IMP=0x000000000054354b
...
- (id)attributeDescriptions;	// IMP=0x000000000054332b
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithModel:(id)arg1 failureCode:(unsigned long long)arg2 error:(id)arg3;	// IMP=0x000000000054306e
