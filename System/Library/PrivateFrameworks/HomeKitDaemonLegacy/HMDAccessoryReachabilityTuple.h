...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x000000000009cda9
- (void).cxx_destruct;	// IMP=0x000000000009cd96
...
- (id)description;	// IMP=0x000000000009cb95
- (unsigned long long)hash;	// IMP=0x000000000009cb51
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009cac0
