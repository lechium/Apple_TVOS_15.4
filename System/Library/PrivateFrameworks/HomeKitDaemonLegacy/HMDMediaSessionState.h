...
- (void).cxx_destruct;	// IMP=0x0000000000619e11
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x0000000000619be4
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000619788
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x0000000000619258
