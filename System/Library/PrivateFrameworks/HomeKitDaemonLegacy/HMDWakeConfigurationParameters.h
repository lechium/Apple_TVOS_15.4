...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000a4668f
- (void).cxx_destruct;	// IMP=0x0000000000a4665c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a46260
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a461a8
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000a45bfa
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000a456ef
- (id)initWithDelimiter:(id)arg1 primaryIdentifier:(id)arg2 secondaryIdentifier:(id)arg3;	// IMP=0x0000000000a45625
- (id)init;	// IMP=0x0000000000a455f6
