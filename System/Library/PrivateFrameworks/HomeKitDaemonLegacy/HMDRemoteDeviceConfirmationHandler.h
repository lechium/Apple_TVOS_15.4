...
- (void).cxx_destruct;	// IMP=0x00000000008ad063
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000008acf9a
- (id)initWithTimeoutTimer:(id)arg1 workQueue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000008ace7c
