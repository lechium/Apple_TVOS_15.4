...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x00000000002eeb6f
+ (id)eventWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x00000000002eeae1
- (void).cxx_destruct;	// IMP=0x00000000002eea6c
...
- (id)__initWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x00000000002ee20b
- (id)init;	// IMP=0x00000000002ee163
