...
+ (id)logCategory;	// IMP=0x0000000000460757
- (void).cxx_destruct;	// IMP=0x0000000000460726
...
- (id)logIdentifier;	// IMP=0x00000000004606aa
- (_Bool)canAcceptInvitationFromDeviceWithHandle:(id)arg1 forSessionWithIdentifier:(id)arg2;	// IMP=0x0000000000460305
- (id)initWithSessionID:(id)arg1 expectedInviter:(id)arg2;	// IMP=0x000000000046023c
