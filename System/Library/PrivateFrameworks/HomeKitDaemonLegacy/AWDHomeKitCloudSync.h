...
+ (Class)topErrorsType;	// IMP=0x00000000003fc531
+ (Class)topReasonsType;	// IMP=0x00000000003fc520
- (void).cxx_destruct;	// IMP=0x00000000003fb935
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003fb35c
- (unsigned long long)hash;	// IMP=0x00000000003fb0bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003faccf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003fa78c
- (void)copyTo:(id)arg1;	// IMP=0x00000000003fa447
- (void)writeTo:(id)arg1;	// IMP=0x00000000003f9ffd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003f9ff0
- (id)dictionaryRepresentation;	// IMP=0x00000000003f95a4
- (id)description;	// IMP=0x00000000003f94f5
...
- (int)StringAsDataSyncState:(id)arg1;	// IMP=0x00000000003f91a8
- (id)dataSyncStateAsString:(int)arg1;	// IMP=0x00000000003f9110
...
- (id)topErrorsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003f8fa4
- (unsigned long long)topErrorsCount;	// IMP=0x00000000003f8f87
- (void)addTopErrors:(id)arg1;	// IMP=0x00000000003f8f1d
- (void)clearTopErrors;	// IMP=0x00000000003f8f00
- (id)topReasonsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003f8ee3
- (unsigned long long)topReasonsCount;	// IMP=0x00000000003f8ec6
- (void)addTopReasons:(id)arg1;	// IMP=0x00000000003f8e5c
- (void)clearTopReasons;	// IMP=0x00000000003f8e3f
