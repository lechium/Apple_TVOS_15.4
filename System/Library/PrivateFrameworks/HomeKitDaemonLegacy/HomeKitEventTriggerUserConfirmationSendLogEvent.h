...
- (void).cxx_destruct;	// IMP=0x00000000005a0fc3
...
- (id)metricForAWD;	// IMP=0x00000000005a0ead
- (unsigned int)AWDMessageType;	// IMP=0x00000000005a0ea2
- (id)initWithSessionID:(id)arg1;	// IMP=0x00000000005a0dc5
