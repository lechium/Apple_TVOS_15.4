...
+ (id)eventUpdateStartedWithAutomaticUpdateEnabled:(_Bool)arg1;	// IMP=0x00000000006cebe5
...
- (id)metricForAWD;	// IMP=0x000000000078d781
- (unsigned int)AWDMessageType;	// IMP=0x000000000078d776
