...
+ (id)logCategory;	// IMP=0x0000000000914e1f
- (void).cxx_destruct;	// IMP=0x0000000000914cbd
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000009149ed
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x000000000091493c
- (void)handleAccessoryConnected:(id)arg1;	// IMP=0x00000000009148cb
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x0000000000913d49
- (void)start;	// IMP=0x0000000000913bf8
- (void)dealloc;	// IMP=0x0000000000913a82
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x0000000000913868
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000091368b
