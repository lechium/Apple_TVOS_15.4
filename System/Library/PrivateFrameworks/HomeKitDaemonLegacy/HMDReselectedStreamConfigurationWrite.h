...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007704a
- (void).cxx_destruct;	// IMP=0x0000000000077019
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000076f49
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000076d86
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000076c63
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000076a4c
- (id)tlvData;	// IMP=0x000000000007692e
- (id)initWithSessionControl:(id)arg1;	// IMP=0x00000000000768c0
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2;	// IMP=0x000000000007681e
