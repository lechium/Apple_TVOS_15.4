...
- (void).cxx_destruct;	// IMP=0x00000000008f1958
...
- (_Bool)isThreadAccessory:(id)arg1;	// IMP=0x00000000008f1030
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithAccessory:(id)arg1 characteristic:(id)arg2;	// IMP=0x00000000008f0f85
