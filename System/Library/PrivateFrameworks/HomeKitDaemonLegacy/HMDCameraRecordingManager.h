...
#import <HomeKitDaemonLegacy/HMDCameraRecordingSessionDelegate-Protocol.h>
#import <HomeKitDaemonLegacy/HMDCameraRecordingSessionNotificationTriggerDelegate-Protocol.h>
#import <HomeKitDaemonLegacy/HMDCameraRecordingSettingsControlDelegate-Protocol.h>
...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x000000000002e70a
+ (id)logCategory;	// IMP=0x000000000002e6da
- (void).cxx_destruct;	// IMP=0x000000000002c2ef
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x000000000002bfd5
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
- (void)handleResidentDeviceUpdated:(id)arg1;	// IMP=0x000000000002bf52
- (void)session:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x000000000002bc97
@property(readonly) NSString *logIdentifier;
- (void)_updateSessionRestoreRegistration;	// IMP=0x000000000002ba98
- (void)_resetCurrentRecordingSession:(id)arg1;	// IMP=0x000000000002b550
- (void)_startSessionRetryTimer;	// IMP=0x000000000002b2b8
- (void)_resetRetryContextWithReason:(id)arg1;	// IMP=0x000000000002b14a
- (void)_closeCurrentSessionsWithReason:(unsigned short)arg1;	// IMP=0x000000000002af44
- (unsigned short)_closeEventReasonForRecordingSessionError:(id)arg1;	// IMP=0x000000000002aec9
- (void)_handleDataReceived:(id)arg1;	// IMP=0x000000000002a787
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000002a4ea
- (void)_readDataForCurrentSession;	// IMP=0x000000000002a3be
- (void)_handleBulkSendSessionCreated:(id)arg1;	// IMP=0x000000000002a120
- (void)_startRecordingSessionForTrigger:(unsigned long long)arg1 homePresenceByPairingIdentity:(id)arg2 reason:(id)arg3 completionCallback:(CDUnknownBlockType)arg4;	// IMP=0x0000000000029a2d
- (id)bulkSendSessionOpenReasonWithError:(id *)arg1;	// IMP=0x00000000000295b0
- (void)_processQueuedCameraRecordingSessionStartRequests;	// IMP=0x00000000000293ba
- (void)handleStartRecordingSessionRequest:(id)arg1;	// IMP=0x0000000000028d73
- (void)_startRecordingSessionForTrigger:(unsigned long long)arg1 homePresenceByPairingIdentity:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000028c15
- (void)_createRecordingSessionForTrigger:(unsigned long long)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000028556
- (void)_submitLoadBalancingEventWithDecision:(id)arg1 numberOfRetries:(unsigned long long)arg2;	// IMP=0x00000000000281d3
- (void)_forwardRecordingSessionForTrigger:(unsigned long long)arg1 withLoadBalancerDecision:(id)arg2 deviceFilter:(CDUnknownBlockType)arg3 sessionCoordinationLogEvent:(id)arg4 retryAttemptNumber:(long long)arg5;	// IMP=0x0000000000027bd6
@property(readonly) NSDictionary *homePresenceByPairingIdentity;
- (void)_coordinateRecordingSessionForTrigger:(unsigned long long)arg1;	// IMP=0x0000000000027502
- (void)_clipManagerDidStartUpCloudZone;	// IMP=0x00000000000272cb
- (void)_shutDown;	// IMP=0x0000000000027130
- (void)_start;	// IMP=0x0000000000026aab
- (void)recordingSettingsControlDidFailToConfigure:(id)arg1;	// IMP=0x00000000000268db
- (void)recordingSettingsControlDidConfigure:(id)arg1;	// IMP=0x0000000000026543
- (void)handleCameraSettingsDidChangeNotification:(id)arg1;	// IMP=0x00000000000264d2
- (void)clipManagerDidStop:(id)arg1;	// IMP=0x0000000000026461
- (void)clipManagerDidStartUpCloudZone:(id)arg1;	// IMP=0x00000000000263f0
- (void)notificationTrigger:(id)arg1 didObserveTriggerType:(unsigned long long)arg2 changeToActive:(_Bool)arg3;	// IMP=0x00000000000260f1
- (void)shutDown;	// IMP=0x0000000000026080
- (void)start;	// IMP=0x000000000002600f
- (void)dealloc;	// IMP=0x0000000000025efc
- (id)initWithCamera:(id)arg1 recordingManagementService:(id)arg2 dependencyFactory:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x0000000000025947
- (id)initWithCamera:(id)arg1 recordingManagementService:(id)arg2;	// IMP=0x0000000000025894
