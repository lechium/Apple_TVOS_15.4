...
- (void).cxx_destruct;	// IMP=0x00000000003da01b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003d9e33
- (id)description;	// IMP=0x00000000003d9d76
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x00000000003d9cb0
