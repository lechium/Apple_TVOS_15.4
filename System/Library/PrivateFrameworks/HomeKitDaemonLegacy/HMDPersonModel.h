...
+ (id)sentinelParentUUID;	// IMP=0x0000000000639bed
+ (id)hmbProperties;	// IMP=0x0000000000639bbd
- (id)createPerson;	// IMP=0x000000000063a257
- (id)initWithPerson:(id)arg1;	// IMP=0x000000000063a144
