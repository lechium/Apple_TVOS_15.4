...
- (void).cxx_destruct;	// IMP=0x00000000005685bc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000005683b0
- (unsigned long long)hash;	// IMP=0x0000000000568262
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000056801f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000567e8c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000567d26
- (void)writeTo:(id)arg1;	// IMP=0x0000000000567b91
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000567b84
- (id)dictionaryRepresentation;	// IMP=0x000000000056765d
- (id)description;	// IMP=0x00000000005675ae
...
- (int)StringAsOutcome:(id)arg1;	// IMP=0x0000000000567214
- (id)outcomeAsString:(int)arg1;	// IMP=0x000000000056712b
@property(nonatomic) _Bool hasOutcome;
@property(nonatomic) int outcome; // @synthesize outcome=_outcome;
@property(nonatomic) _Bool hasDuration;
- (int)StringAsActionType:(id)arg1;	// IMP=0x0000000000566f3c
- (id)actionTypeAsString:(int)arg1;	// IMP=0x0000000000566e89
