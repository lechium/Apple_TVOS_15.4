...
+ (id)logCategory;	// IMP=0x000000000079d303
- (void).cxx_destruct;	// IMP=0x000000000079d2c1
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x000000000079d0e8
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x000000000079cf3c
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x000000000079cb81
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x000000000079c80e
- (id)logIdentifier;	// IMP=0x000000000079c7be
- (id)initWithSessionID:(id)arg1;	// IMP=0x000000000079c750
