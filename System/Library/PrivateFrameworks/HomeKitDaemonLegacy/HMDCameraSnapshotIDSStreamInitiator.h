...
+ (id)logCategory;	// IMP=0x0000000000a79e64
- (void).cxx_destruct;	// IMP=0x0000000000a79dc4
...
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5;	// IMP=0x0000000000a79b53
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x0000000000a79a51
- (void)dealloc;	// IMP=0x0000000000a7996c
- (void)_sendFile:(id)arg1;	// IMP=0x0000000000a79403
- (void)sendFile:(id)arg1;	// IMP=0x0000000000a79352
- (id)logIdentifier;	// IMP=0x0000000000a79302
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 destinationID:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5;	// IMP=0x0000000000a79228
