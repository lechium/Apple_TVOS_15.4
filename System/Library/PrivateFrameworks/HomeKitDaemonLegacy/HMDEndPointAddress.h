...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006fb19
- (void).cxx_destruct;	// IMP=0x000000000006fad7
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006f70e
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006f57e
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006f345
- (id)tlvData;	// IMP=0x000000000006f1e9
- (_Bool)compatibleWithRemoteEndPoint:(id)arg1;	// IMP=0x000000000006f11f
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x000000000006f047
