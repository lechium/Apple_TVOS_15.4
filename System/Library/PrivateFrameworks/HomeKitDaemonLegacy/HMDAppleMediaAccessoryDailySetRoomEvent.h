...
+ (id)filterToAllowedRoomName:(id)arg1;	// IMP=0x00000000005c01af
- (void).cxx_destruct;	// IMP=0x000000000031cc2e
...
- (id)initWithCurrentRoom:(id)arg1 previousRoom:(id)arg2;	// IMP=0x000000000031cb60
