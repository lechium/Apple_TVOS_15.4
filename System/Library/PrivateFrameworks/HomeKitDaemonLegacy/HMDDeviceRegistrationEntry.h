...
- (void).cxx_destruct;	// IMP=0x000000000009d0f9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009d005
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x000000000009cf63
