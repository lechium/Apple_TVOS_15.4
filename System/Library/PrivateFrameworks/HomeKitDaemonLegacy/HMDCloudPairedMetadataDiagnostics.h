...
+ (id)logCategory;	// IMP=0x00000000006fdb31
- (void).cxx_destruct;	// IMP=0x00000000006fdaef
...
- (id)attributeDescriptions;	// IMP=0x00000000006fd6de
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x00000000006fd5e4
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x00000000006fd1b9
