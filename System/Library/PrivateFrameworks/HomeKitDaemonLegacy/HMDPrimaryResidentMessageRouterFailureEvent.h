...
- (void).cxx_destruct;	// IMP=0x0000000000077ce8
...
- (id)attributeDescriptions;	// IMP=0x0000000000077b1c
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithMessageName:(id)arg1 failureType:(long long)arg2;	// IMP=0x0000000000077984
