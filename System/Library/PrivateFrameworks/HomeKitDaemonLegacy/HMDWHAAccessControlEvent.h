...
+ (int)awdUserPrivilegeFromHMUserPrivilege:(long long)arg1;	// IMP=0x00000000008ac34e
+ (id)eventWithP2PEnabled:(_Bool)arg1 privilegeLevel:(long long)arg2 passwordSet:(_Bool)arg3;	// IMP=0x00000000008ac2c8
...
- (id)metricForAWD;	// IMP=0x000000000078d31e
- (unsigned int)AWDMessageType;	// IMP=0x000000000078d313
