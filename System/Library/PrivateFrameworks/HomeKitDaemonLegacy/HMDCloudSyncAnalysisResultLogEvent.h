...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x00000000007c8fb8
- (void).cxx_destruct;	// IMP=0x00000000007ca8ea
...
- (id)metricForAWD;	// IMP=0x00000000007c8fcb
- (unsigned int)AWDMessageType;	// IMP=0x00000000007c8fc0
