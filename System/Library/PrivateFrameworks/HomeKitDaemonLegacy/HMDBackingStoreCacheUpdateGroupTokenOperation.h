...
- (void).cxx_destruct;	// IMP=0x00000000001da799
...
- (id)mainReturningError;	// IMP=0x00000000001da480
- (id)initWithGroup:(id)arg1 serverChangeToken:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001da3c7
