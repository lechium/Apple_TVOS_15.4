...
+ (Class)reasonsType;	// IMP=0x0000000000a09994
- (void).cxx_destruct;	// IMP=0x0000000000a09521
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000a092a0
- (unsigned long long)hash;	// IMP=0x0000000000a091ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a09065
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a08dea
- (void)copyTo:(id)arg1;	// IMP=0x0000000000a08c99
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a08aad
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a08aa0
- (id)dictionaryRepresentation;	// IMP=0x0000000000a08882
- (id)description;	// IMP=0x0000000000a087d3
...
- (id)reasonsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000a086d7
- (unsigned long long)reasonsCount;	// IMP=0x0000000000a086ba
- (void)addReasons:(id)arg1;	// IMP=0x0000000000a08650
- (void)clearReasons;	// IMP=0x0000000000a08633
