...
+ (id)logCategory;	// IMP=0x000000000032e478
+ (id)shortDescription;	// IMP=0x000000000032e466
+ (double)timeout;	// IMP=0x000000000032e388
- (void).cxx_destruct;	// IMP=0x000000000032e335
...
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5 context:(id)arg6;	// IMP=0x000000000032e0f0
- (id)logIdentifier;	// IMP=0x000000000032e095
- (void)main;	// IMP=0x000000000032d985
@property(readonly, copy, nonatomic) NSArray *attributeDescriptions;
@property(readonly, copy) NSString *description;
@property(readonly, copy) NSString *privateDescription;
@property(readonly, copy) NSString *shortDescription;
- (id)initWithMessage:(id)arg1 service:(id)arg2;	// IMP=0x000000000032d3d8
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000032d339
