...
- (void).cxx_destruct;	// IMP=0x000000000067b4c4
...
- (id)initWithMediaSystemController:(id)arg1;	// IMP=0x000000000067b431
- (void)submitLogEvent:(id)arg1 error:(id)arg2;	// IMP=0x000000000067b3a7
- (void)submitLogEvent:(id)arg1;	// IMP=0x000000000067b331
- (void)registerLogEventDailyProvider:(id)arg1;	// IMP=0x000000000067b2bf
