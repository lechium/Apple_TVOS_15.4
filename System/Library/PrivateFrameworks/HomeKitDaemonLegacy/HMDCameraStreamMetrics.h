...
- (void).cxx_destruct;	// IMP=0x0000000000218a5f
...
- (void)dealloc;	// IMP=0x000000000021892e
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3;	// IMP=0x0000000000218875
