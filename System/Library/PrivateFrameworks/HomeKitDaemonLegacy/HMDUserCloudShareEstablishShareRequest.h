...
- (void).cxx_destruct;	// IMP=0x000000000059c7b2
...
- (id)description;	// IMP=0x000000000059c681
- (id)initWithHome:(id)arg1 fromUser:(id)arg2 toUser:(id)arg3 encodedShareURL:(id)arg4 shareToken:(id)arg5 containerID:(id)arg6 currentDate:(id)arg7 completion:(CDUnknownBlockType)arg8;	// IMP=0x000000000059c54f
