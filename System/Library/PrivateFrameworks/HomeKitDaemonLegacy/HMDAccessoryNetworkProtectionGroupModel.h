...
+ (id)properties;	// IMP=0x00000000007741ac
+ (id)modelIDForHome:(id)arg1 manufacturer:(id)arg2 category:(id)arg3;	// IMP=0x0000000000773fb5
+ (id)modelNamespace;	// IMP=0x0000000000773f85
