...
+ (id)logCategory;	// IMP=0x00000000006ab164
- (void).cxx_destruct;	// IMP=0x00000000006aab95
...
- (void)_drainVariantFragmentQueue;	// IMP=0x00000000006aa5e9
- (void)handleVariantFragment:(id)arg1;	// IMP=0x00000000006aa2bc
- (void)handleFullFragment:(id)arg1;	// IMP=0x00000000006aa1d0
@property(readonly) _Bool expectsVariantFragment;
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x00000000006aa0af
