...
+ (id)logCategory;	// IMP=0x00000000006b5bbc
+ (id)shortDescription;	// IMP=0x00000000006b5baa
- (void).cxx_destruct;	// IMP=0x00000000006b58eb
...
- (id)logIdentifier;	// IMP=0x00000000006b5829
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000006b57c0
- (void)main;	// IMP=0x00000000006b548d
- (void)_respondWithError:(id)arg1 playload:(id)arg2;	// IMP=0x00000000006b538d
@property(readonly, copy, nonatomic) NSArray *attributeDescriptions;
@property(readonly, copy) NSString *description;
@property(readonly, copy) NSString *privateDescription;
@property(readonly, copy) NSString *shortDescription;
- (id)initWithMessage:(id)arg1 transport:(id)arg2;	// IMP=0x00000000006b4e3a
