...
- (void).cxx_destruct;	// IMP=0x000000000072ab30
@property(retain, nonatomic) NSString *errorDomain; // @synthesize errorDomain=_errorDomain;
@property(nonatomic) long long errorCode; // @synthesize errorCode=_errorCode;
@property(nonatomic) _Bool didSucceed; // @synthesize didSucceed=_didSucceed;
@property(nonatomic) unsigned long long timestamp; // @synthesize timestamp=_timestamp;
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000072aa06
- (unsigned long long)hash;	// IMP=0x000000000072a94a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000072a7e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000072a6e2
- (void)copyTo:(id)arg1;	// IMP=0x000000000072a60f
- (void)writeTo:(id)arg1;	// IMP=0x000000000072a521
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000072a514
- (id)dictionaryRepresentation;	// IMP=0x000000000072a22f
- (id)description;	// IMP=0x000000000072a180
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsZoneType:(id)arg1;	// IMP=0x000000000072a07c
- (id)zoneTypeAsString:(int)arg1;	// IMP=0x0000000000729fe5
@property(nonatomic) _Bool hasZoneType;
@property(nonatomic) int zoneType; // @synthesize zoneType=_zoneType;
- (int)StringAsContainerType:(id)arg1;	// IMP=0x0000000000729ecc
- (id)containerTypeAsString:(int)arg1;	// IMP=0x0000000000729e4f
