...
+ (id)logCategory;	// IMP=0x000000000058116f
+ (id)_streamingStatusForResponse:(id)arg1;	// IMP=0x0000000000580e00
- (void).cxx_destruct;	// IMP=0x00000000005808d6
...
- (void)_callDidCompleteReadDelegateCallback;	// IMP=0x000000000058075d
- (id)_inUseStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x00000000005805a2
- (id)_availableStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x00000000005803e7
- (void)_handleStreamStatusMultireadResponse:(id)arg1;	// IMP=0x000000000057fe69
- (void)readSetting;	// IMP=0x000000000057f911
- (void)handleMessage:(id)arg1;	// IMP=0x000000000057f4e8
- (_Bool)hasPendingNegotiateMessageForSessionWithIdentifier:(id)arg1;	// IMP=0x000000000057f414
- (id)initWithWorkQueue:(id)arg1 sessionID:(id)arg2 accessory:(id)arg3 message:(id)arg4 streamControlMessageHandlers:(id)arg5 streamPreferences:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x000000000057f1de
