...
+ (id)logCategory;	// IMP=0x000000000062486d
- (void).cxx_destruct;	// IMP=0x00000000006246e6
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000062429a
- (id)logIdentifier;	// IMP=0x000000000062424a
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x000000000062412f
