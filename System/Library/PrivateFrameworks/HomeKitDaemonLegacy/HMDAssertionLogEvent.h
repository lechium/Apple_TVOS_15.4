...
- (void).cxx_destruct;	// IMP=0x000000000023043b
@property(readonly, copy) NSString *reason; // @synthesize reason=_reason;
- (id)description;	// IMP=0x000000000023040f
- (id)initWithReason:(id)arg1;	// IMP=0x00000000002302b4
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000a780ed
