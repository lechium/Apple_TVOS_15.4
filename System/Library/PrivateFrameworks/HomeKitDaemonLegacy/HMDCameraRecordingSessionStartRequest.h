...
- (void).cxx_destruct;	// IMP=0x000000000063ef41
...
- (id)initWithHomePresenceByPairingIdentity:(id)arg1 trigger:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000063ee2d
