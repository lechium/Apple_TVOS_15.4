...
- (void).cxx_destruct;	// IMP=0x00000000006a3caf
...
- (id)attributeDescriptions;	// IMP=0x00000000006a392b
- (id)serializeFields;	// IMP=0x00000000006a3741
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x00000000006a3530
