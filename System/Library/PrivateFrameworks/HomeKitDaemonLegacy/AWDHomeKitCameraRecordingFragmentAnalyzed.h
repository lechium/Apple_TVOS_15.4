...
- (void).cxx_destruct;	// IMP=0x000000000083e742
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000083e572
- (unsigned long long)hash;	// IMP=0x000000000083e437
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000083e25b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000083e0f2
- (void)copyTo:(id)arg1;	// IMP=0x000000000083dfd5
- (void)writeTo:(id)arg1;	// IMP=0x000000000083dead
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000083dea0
- (id)dictionaryRepresentation;	// IMP=0x000000000083dbdb
- (id)description;	// IMP=0x000000000083db2c
- (int)StringAsRecordingReason:(id)arg1;	// IMP=0x000000000083da78
- (id)recordingReasonAsString:(int)arg1;	// IMP=0x000000000083d9f8
