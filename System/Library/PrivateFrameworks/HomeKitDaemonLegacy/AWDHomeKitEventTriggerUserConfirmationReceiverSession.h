...
- (void).cxx_destruct;	// IMP=0x00000000009bf178
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000009bf07c
- (unsigned long long)hash;	// IMP=0x00000000009befea
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009beed4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009bee02
- (void)copyTo:(id)arg1;	// IMP=0x00000000009bed5d
- (void)writeTo:(id)arg1;	// IMP=0x00000000009becaf
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009beca2
- (id)dictionaryRepresentation;	// IMP=0x00000000009beb2e
- (id)description;	// IMP=0x00000000009bea7f
