...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000904e31
- (void).cxx_destruct;	// IMP=0x0000000000904dfe
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000904c83
