...
- (void).cxx_destruct;	// IMP=0x00000000004647f5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000046436b
- (unsigned long long)hash;	// IMP=0x000000000046410d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000463d4d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000463a92
- (void)copyTo:(id)arg1;	// IMP=0x0000000000463867
- (void)writeTo:(id)arg1;	// IMP=0x0000000000463635
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000463628
- (id)dictionaryRepresentation;	// IMP=0x0000000000463093
- (id)description;	// IMP=0x0000000000462fe4
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000462ca4
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000462c3e
