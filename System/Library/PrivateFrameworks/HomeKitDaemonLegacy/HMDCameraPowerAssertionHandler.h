...
+ (id)logCategory;	// IMP=0x0000000000720831
+ (id)sharedHandler;	// IMP=0x0000000000720801
- (void).cxx_destruct;	// IMP=0x00000000007200c4
...
- (void)deregisterRemoteRequestHandler:(id)arg1;	// IMP=0x000000000071ffd1
- (void)registerRemoteRequestHandler:(id)arg1 forSessionID:(id)arg2;	// IMP=0x000000000071fef5
- (id)init;	// IMP=0x000000000071fe24
