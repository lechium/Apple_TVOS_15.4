...
- (void).cxx_destruct;	// IMP=0x00000000008038c5
...
- (_Bool)matchesAccessoryServer:(id)arg1;	// IMP=0x000000000080355a
- (_Bool)matchesUnpairedAccessory:(id)arg1;	// IMP=0x000000000080348b
- (id)description;	// IMP=0x00000000008032d1
- (id)initWithAccessoryDescription:(id)arg1 linkType:(long long)arg2 needsUserConsent:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4 progressHandler:(CDUnknownBlockType)arg5 wiFiPSK:(id)arg6 country:(id)arg7;	// IMP=0x000000000080300a
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 linkType:(long long)arg3 setupCode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 setupCodeProvider:(CDUnknownBlockType)arg6 wiFiPSK:(id)arg7 country:(id)arg8;	// IMP=0x0000000000802e40
