...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000448e2d
- (void).cxx_destruct;	// IMP=0x0000000000448da7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000448b8c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000448a2e
