...
+ (void)load;	// IMP=0x000000000023c28b
- (void).cxx_destruct;	// IMP=0x000000000023c25a
...
- (id)stringValue;	// IMP=0x000000000023c1de
- (id)numberValue;	// IMP=0x000000000023c0e0
- (_Bool)boolValue;	// IMP=0x000000000023c09c
@property(readonly, copy) NSString *propertyDescription;
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x000000000023beaa
