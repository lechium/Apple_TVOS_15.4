...
- (void).cxx_destruct;	// IMP=0x0000000000022273
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000021f53
- (id)description;	// IMP=0x0000000000021e3c
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x0000000000021d2b
