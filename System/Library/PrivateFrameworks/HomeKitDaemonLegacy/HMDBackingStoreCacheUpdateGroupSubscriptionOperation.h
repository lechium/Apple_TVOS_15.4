...
- (void).cxx_destruct;	// IMP=0x00000000001dab9c
...
- (id)mainReturningError;	// IMP=0x00000000001da883
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001da7ca
