...
+ (id)logCategory;	// IMP=0x0000000000563b60
- (void).cxx_destruct;	// IMP=0x0000000000563b0d
...
- (id)logIdentifier;	// IMP=0x0000000000563a1e
- (_Bool)acceptMessage:(id)arg1 target:(id)arg2 errorReason:(id *)arg3;	// IMP=0x0000000000562ef2
- (id)initWithTarget:(id)arg1 whitelistedMessages:(id)arg2 appleAccountManager:(id)arg3 systemKeychainStore:(id)arg4;	// IMP=0x0000000000562dc5
- (id)initWithTarget:(id)arg1 whitelistedMessages:(id)arg2;	// IMP=0x0000000000562d05
- (id)initWithTarget:(id)arg1;	// IMP=0x0000000000562cf1
- (id)initWithName:(id)arg1;	// IMP=0x0000000000562c3b
