...
- (void).cxx_destruct;	// IMP=0x00000000008e6101
...
- (id)mainReturningError;	// IMP=0x00000000008e5f4e
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x00000000008e5e8c
