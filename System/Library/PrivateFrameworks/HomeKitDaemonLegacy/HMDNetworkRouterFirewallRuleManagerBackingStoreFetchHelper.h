...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x000000000000d772
+ (unsigned long long)maxRetryCount;	// IMP=0x000000000000d754
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x000000000000d66d
+ (id)logCategory;	// IMP=0x000000000000d63d
- (void).cxx_destruct;	// IMP=0x000000000000d5d9
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000000d2d6
- (void)finishWithError:(id)arg1;	// IMP=0x000000000000d2bf
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000000d2ab
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x000000000000cf0d
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x000000000000ccf9
