...
+ (id)__decodeRuleConfigurationWithVersionString:(id)arg1 ruleConfigurationValue:(id)arg2 baseAccessoryIdentifier:(id)arg3;	// IMP=0x00000000008eea4a
+ (id)__decodeRuleConfigurationsFromJSONDictionary:(id)arg1 baseAccessoryIdentifier:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x00000000008ee3e1
+ (id)logCategory;	// IMP=0x00000000008ee3b1
- (void).cxx_destruct;	// IMP=0x00000000008ee35e
...
- (id)attributeDescriptions;	// IMP=0x00000000008edddd
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x00000000008eda67
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2;	// IMP=0x00000000008eda52
- (id)initWithBaseAccessoryIdentifier:(id)arg1 name:(id)arg2 lastModifiedTime:(id)arg3 ruleConfigurations:(id)arg4;	// IMP=0x00000000008ed94b
