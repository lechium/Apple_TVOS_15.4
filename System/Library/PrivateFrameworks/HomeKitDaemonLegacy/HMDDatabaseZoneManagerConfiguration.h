...
- (void).cxx_destruct;	// IMP=0x00000000004132ed
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004130c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004130be
- (unsigned long long)hash;	// IMP=0x0000000000412f99
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000412d22
- (id)attributeDescriptions;	// IMP=0x0000000000412a18
- (id)init;	// IMP=0x000000000041290e
