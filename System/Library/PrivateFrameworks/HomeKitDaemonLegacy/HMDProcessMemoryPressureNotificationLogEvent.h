...
+ (id)createEventWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00000000005553ba
- (void).cxx_destruct;	// IMP=0x0000000000555389
...
- (id)initWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00000000005552c5
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)metricForAWD;	// IMP=0x000000000078ec4f
- (unsigned int)AWDMessageType;	// IMP=0x000000000078ec44
