...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000477fce
- (void).cxx_destruct;	// IMP=0x000000000046f6b6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000046f192
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000046f0af
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000046e7e8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000046e1bc
- (id)initWithMulticastBridgingRules:(id)arg1 staticPortRules:(id)arg2 dynamicPortRules:(id)arg3 staticICMPRules:(id)arg4;	// IMP=0x000000000046e0da
- (id)init;	// IMP=0x000000000046e0ab
