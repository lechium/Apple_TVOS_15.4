...
+ (id)logCategory;	// IMP=0x000000000007e27a
...
- (id)logIdentifier;	// IMP=0x000000000007e10f
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x000000000007df3a
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x000000000007dda5
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x000000000007dc77
