...
- (void).cxx_destruct;	// IMP=0x00000000005a04e8
...
- (id)metricForAWD;	// IMP=0x00000000005a02a6
- (int)toAWDExecutionState:(int)arg1;	// IMP=0x00000000005a0295
- (unsigned int)AWDMessageType;	// IMP=0x00000000005a028a
- (id)initWithSessionID:(id)arg1;	// IMP=0x00000000005a0160
