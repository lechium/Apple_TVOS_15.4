...
- (void).cxx_destruct;	// IMP=0x00000000006a5e3d
...
- (id)attributeDescriptions;	// IMP=0x00000000006a5c40
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 accessoryUUID:(id)arg3;	// IMP=0x00000000006a5b39
