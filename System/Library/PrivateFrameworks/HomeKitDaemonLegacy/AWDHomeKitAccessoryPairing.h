...
- (void).cxx_destruct;	// IMP=0x000000000073ab65
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000073a65a
- (unsigned long long)hash;	// IMP=0x000000000073a2f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000739d29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007399ae
- (void)copyTo:(id)arg1;	// IMP=0x000000000073967f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000739319
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000073930c
- (id)dictionaryRepresentation;	// IMP=0x000000000073897e
- (id)description;	// IMP=0x00000000007388cf
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x000000000073845f
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000007383f9
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000738262
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000007381fc
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x0000000000738048
- (id)transportTypeAsString:(int)arg1;	// IMP=0x0000000000737f97
