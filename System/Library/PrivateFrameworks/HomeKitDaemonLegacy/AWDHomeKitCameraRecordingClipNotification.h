...
- (void).cxx_destruct;	// IMP=0x0000000000a8e7f7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000a8e686
- (unsigned long long)hash;	// IMP=0x0000000000a8e5a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a8e42b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a8e310
- (void)copyTo:(id)arg1;	// IMP=0x0000000000a8e22d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a8e140
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a8e133
- (id)dictionaryRepresentation;	// IMP=0x0000000000a8df40
- (id)description;	// IMP=0x0000000000a8de91
