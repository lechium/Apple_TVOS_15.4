...
+ (id)logCategory;	// IMP=0x000000000087621b
- (void).cxx_destruct;	// IMP=0x00000000008754ed
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x00000000008748b1
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000874757
