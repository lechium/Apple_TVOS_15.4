...
- (void).cxx_destruct;	// IMP=0x00000000006a5b26
...
- (id)attributeDescriptions;	// IMP=0x00000000006a58fc
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2;	// IMP=0x00000000006a5870
