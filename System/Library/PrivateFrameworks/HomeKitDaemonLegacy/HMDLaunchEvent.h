...
- (void).cxx_destruct;	// IMP=0x00000000008a1824
...
- (void)markXPCMessageTransportStarted;	// IMP=0x00000000008a1364
- (id)init;	// IMP=0x00000000008a1310
@property(readonly, copy) NSString *diagnosticReportEventSubType;
@property(readonly, copy) NSString *diagnosticReportEventType;
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000a780d2
