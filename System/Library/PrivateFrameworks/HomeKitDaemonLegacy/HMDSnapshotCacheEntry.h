...
- (void).cxx_destruct;	// IMP=0x00000000008b7f56
...
- (id)description;	// IMP=0x00000000008b7e6e
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x00000000008b7da8
