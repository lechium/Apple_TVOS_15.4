...
- (void).cxx_destruct;	// IMP=0x00000000001d9986
...
- (id)mainReturningError;	// IMP=0x00000000001d8eca
- (id)initWithZone:(id)arg1 resultBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001d8e3f
