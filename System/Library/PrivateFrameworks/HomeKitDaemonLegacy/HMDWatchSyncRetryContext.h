...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x00000000001d80a3
- (void).cxx_destruct;	// IMP=0x00000000001d8072
...
- (id)attributeDescriptions;	// IMP=0x00000000001d7e7f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d7e74
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x00000000001d7d3a
