...
+ (id)logCategory;	// IMP=0x000000000023147b
- (void).cxx_destruct;	// IMP=0x0000000000231044
...
- (id)logIdentifier;	// IMP=0x0000000000230fae
- (id)intermediateApplyOnboardingSelectionsRequestMessageForMessage:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000230d56
- (void)routeSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x0000000000230cb7
- (void)routeSiriEndpointApplyOnboardingSelectionsRequestMessage:(id)arg1;	// IMP=0x0000000000230af6
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x00000000002308d1
- (id)initWithMessageTargetUUID:(id)arg1 messageDispatcher:(id)arg2 messageRouter:(id)arg3 messageHandler:(id)arg4;	// IMP=0x0000000000230785
