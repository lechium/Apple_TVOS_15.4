...
+ (id)logCategory;	// IMP=0x00000000006ac1bc
+ (double)timeout;	// IMP=0x00000000006ac0de
- (void).cxx_destruct;	// IMP=0x00000000006abc82
...
- (id)logIdentifier;	// IMP=0x00000000006abb53
- (void)main;	// IMP=0x00000000006ab6f5
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000006ab5aa
