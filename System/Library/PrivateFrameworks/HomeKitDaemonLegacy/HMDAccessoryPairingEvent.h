...
@interface HMDAccessoryPairingEvent : HMMLogEvent <HMDAWDLogEvent, HMMCoreAnalyticsLogging>
{
    ...
    HMDAccessory *_pairedAccessory;	// 48 = 0x30
    NSString *_accessoryModel;	// 56 = 0x38
    NSString *_accessoryManufacturer;	// 64 = 0x40
    NSString *_accessoryCategory;	// 72 = 0x48
    NSString *_primaryServiceType;	// 80 = 0x50
    HMDAccessoryMetricVendorDetails *_vendorDetailsForReporting;	// 88 = 0x58
    NSString *_appIdentifier;	// 96 = 0x60
    long long _linkType;	// 104 = 0x68
    long long _communicationProtocol;	// 112 = 0x70
    long long _certificationStatus;	// 120 = 0x78
    unsigned long long _authMethod;	// 128 = 0x80
    long long _retryCount;	// 136 = 0x88
    NSError *_threadCommissioningError;	// 144 = 0x90
    double _threadCommissioningDuration;	// 152 = 0x98
    NSDictionary *_vendorDetailsForCoreAnalytics;	// 160 = 0xa0
}

+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x00000000004bf9c3
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x00000000004bf917
+ (id)pairingAccessory:(id)arg1 home:(id)arg2;	// IMP=0x00000000004bf891
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x00000000004bf821
- (void).cxx_destruct;	// IMP=0x00000000004bf757
...
- (void)submitAtDate:(id)arg1;	// IMP=0x00000000004be23e
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000004be19a
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000004be0dd
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x00000000004bde6d
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x00000000004bde5b
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x00000000004bde49
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x00000000004bda98
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 home:(id)arg4 isAddOperation:(_Bool)arg5;	// IMP=0x00000000004bd3d2
- (id)metricForAWD;	// IMP=0x0000000000797f79
- (unsigned int)AWDMessageType;	// IMP=0x0000000000797f6e
