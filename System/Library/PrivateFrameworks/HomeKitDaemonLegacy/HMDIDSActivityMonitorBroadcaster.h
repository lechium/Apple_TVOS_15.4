...
+ (id)logCategory;	// IMP=0x00000000007a6732
- (void).cxx_destruct;	// IMP=0x00000000007a66f4
...
- (id)logIdentifier;	// IMP=0x00000000007a664a
- (void)dataSourceDidUpdate:(id)arg1;	// IMP=0x00000000007a6517
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007a61fe
- (void)configureWithDataSource:(id)arg1;	// IMP=0x00000000007a6071
- (void)configureWithQueue:(id)arg1;	// IMP=0x00000000007a5ee1
- (id)initWithActivityMonitor:(id)arg1;	// IMP=0x00000000007a5dd8
- (id)initWithActivityMonitor:(id)arg1 timer:(id)arg2;	// IMP=0x00000000007a5d2b
