...
- (void).cxx_destruct;	// IMP=0x00000000001f141f
...
- (id)description;	// IMP=0x00000000001f129f
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x00000000001f114a
- (id)init;	// IMP=0x00000000001f10a2
