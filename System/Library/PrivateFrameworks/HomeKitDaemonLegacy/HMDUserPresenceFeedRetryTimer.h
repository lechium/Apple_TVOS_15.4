...
+ (id)logCategory;	// IMP=0x0000000000082c9a
- (void).cxx_destruct;	// IMP=0x0000000000082c69
...
- (id)logIdentifier;	// IMP=0x0000000000082bba
- (_Bool)shouldRetryImmediately:(double)arg1;	// IMP=0x0000000000082b8e
@property(readonly) double retryTimeInterval;
- (void)cancel;	// IMP=0x0000000000082b0c
- (void)startWithDelegate:(id)arg1 delegateQueue:(id)arg2 responseTime:(double)arg3;	// IMP=0x0000000000082725
- (id)attributeDescriptions;	// IMP=0x00000000000825e6
- (id)init;	// IMP=0x0000000000082579
