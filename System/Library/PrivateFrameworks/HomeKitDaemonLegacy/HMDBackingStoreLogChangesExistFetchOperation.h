...
- (void).cxx_destruct;	// IMP=0x000000000076c4be
...
- (id)mainReturningError;	// IMP=0x000000000076c180
- (id)initWithNeedsPushTo:(unsigned long long)arg1 result:(CDUnknownBlockType)arg2;	// IMP=0x000000000076c0d4
