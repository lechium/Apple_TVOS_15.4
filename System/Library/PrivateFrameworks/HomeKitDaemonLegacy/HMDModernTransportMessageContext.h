...
- (void).cxx_destruct;	// IMP=0x000000000057981d
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000579591
- (void)done;	// IMP=0x00000000005794d4
- (void)startTransportFallbackTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000057933a
- (void)startResponseTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005791a0
- (double)timeoutRemaining;	// IMP=0x00000000005790bc
- (id)preparedMessageWithTimeout:(double)arg1;	// IMP=0x0000000000578b06
- (void)completeSendingOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x00000000005786e9
- (void)startSendingOverTransport:(id)arg1;	// IMP=0x0000000000578315
...
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5;	// IMP=0x0000000000577dd2
