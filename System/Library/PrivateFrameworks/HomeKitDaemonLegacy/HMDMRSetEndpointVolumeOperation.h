...
+ (id)logCategory;	// IMP=0x0000000000241173
+ (id)shortDescription;	// IMP=0x0000000000241166
- (void).cxx_destruct;	// IMP=0x000000000023f0cb
...
- (id)setVolumeOnEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000023ea8a
- (id)getVolumeCapabilitiesForEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000023e7e7
- (id)connectToEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000023e550
- (id)discoverRemoteControlEndpointsForUIDs:(id)arg1;	// IMP=0x000000000023e36c
- (_Bool)cancelOnSetup;	// IMP=0x000000000023ddbd
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)arg1;	// IMP=0x000000000023d29c
- (void)main;	// IMP=0x000000000023d037
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2;	// IMP=0x000000000023cfb3
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2 externalObjectInterface:(id)arg3;	// IMP=0x000000000023ce5e
