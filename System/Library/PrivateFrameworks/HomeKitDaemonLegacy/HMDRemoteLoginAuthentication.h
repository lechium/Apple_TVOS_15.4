...
+ (id)logCategory;	// IMP=0x000000000053621f
- (void).cxx_destruct;	// IMP=0x00000000005361cc
...
- (void)authenticate;	// IMP=0x00000000005360e0
- (id)logIdentifier;	// IMP=0x00000000005360ce
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x0000000000535fd7
