...
+ (id)logCategory;	// IMP=0x000000000057a38e
- (void).cxx_destruct;	// IMP=0x000000000057a33b
...
- (void)dealloc;	// IMP=0x000000000057a1c5
- (id)logIdentifier;	// IMP=0x000000000057a175
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000579fd5
