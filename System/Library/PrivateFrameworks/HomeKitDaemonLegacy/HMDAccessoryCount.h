...
- (void).cxx_destruct;	// IMP=0x000000000044c177
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x000000000044bfb6
...
- (id)initWithHome:(id)arg1;	// IMP=0x000000000044bbaa
