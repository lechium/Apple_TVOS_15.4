...
- (void).cxx_destruct;	// IMP=0x00000000002196fc
...
- (void)routeAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x00000000002194ab
- (void)routeAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x00000000002192ae
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x0000000000219073
- (id)initWithMessageTargetUUID:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x0000000000218faa
