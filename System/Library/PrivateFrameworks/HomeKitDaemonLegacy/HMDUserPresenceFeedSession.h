...
+ (id)logCategory;	// IMP=0x000000000035e834
- (void).cxx_destruct;	// IMP=0x000000000035e405
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000035e175
- (id)logIdentifier;	// IMP=0x000000000035e163
- (void)_callDelegate;	// IMP=0x000000000035e0a2
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x000000000035df8c
- (void)_send;	// IMP=0x000000000035d23c
- (void)send;	// IMP=0x000000000035d1cb
- (id)attributeDescriptions;	// IMP=0x000000000035cfa7
- (void)dealloc;	// IMP=0x000000000035ce64
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x000000000035cb3e
