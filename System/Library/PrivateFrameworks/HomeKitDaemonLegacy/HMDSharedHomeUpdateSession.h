...
+ (id)logCategory;	// IMP=0x0000000000a0ab9a
- (void).cxx_destruct;	// IMP=0x0000000000a09fad
...
- (id)dumpState;	// IMP=0x0000000000a09ee6
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a09e8f
- (void)requestDataSync;	// IMP=0x0000000000a09e3b
@property(readonly, nonatomic) NSString *homeIdentifier;
@property(readonly, copy) NSString *description;
- (id)logIdentifier;	// IMP=0x0000000000a09bea
- (void)dealloc;	// IMP=0x0000000000a09b05
- (id)initWithHome:(id)arg1 delegate:(id)arg2 workQueue:(id)arg3 messagePayload:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x0000000000a099a5
