...
+ (_Bool)hmbExcludeFromCloudStorage;	// IMP=0x0000000000316536
+ (id)hmbProperties;	// IMP=0x0000000000316506
- (id)userActionPrediction;	// IMP=0x00000000003170b1
- (id)initWithUserActionPrediction:(id)arg1;	// IMP=0x0000000000316aa3
