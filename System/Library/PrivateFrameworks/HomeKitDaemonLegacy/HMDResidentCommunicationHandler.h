...
+ (id)logCategory;	// IMP=0x00000000002357cc
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x00000000002356b8
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x0000000000235469
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000234b47
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x000000000023460c
- (void).cxx_destruct;	// IMP=0x0000000000233a0f
...
- (id)logIdentifier;	// IMP=0x00000000002338e8
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x00000000002333ea
- (void)_sendMultipleCharacteristicRead;	// IMP=0x000000000023257a
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000002324c9
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x000000000023236e
- (long long)preferredDeviceType;	// IMP=0x000000000023226e
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x00000000002321b6
- (_Bool)containsDevice:(id)arg1;	// IMP=0x0000000000231fc9
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x0000000000231e24
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x0000000000231d39
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000231af2
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x000000000023195f
