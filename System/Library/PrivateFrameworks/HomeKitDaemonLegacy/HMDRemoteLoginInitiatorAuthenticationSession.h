...
- (void).cxx_destruct;	// IMP=0x0000000000411a5c
...
- (id)description;	// IMP=0x00000000004119ce
- (void)dealloc;	// IMP=0x00000000004118de
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3 home:(id)arg4;	// IMP=0x00000000004116e0
