...
+ (id)sharedInstance;	// IMP=0x000000000040bd67
- (void).cxx_destruct;	// IMP=0x000000000040bb4e
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000040b9ff
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x000000000040b8ea
- (void)completeCurrentReport;	// IMP=0x000000000040b848
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x000000000040b7a6
- (void)incrementWatchAddedNotificationCount;	// IMP=0x000000000040b704
- (id)init;	// IMP=0x000000000040b616
