...
+ (id)logCategory;	// IMP=0x000000000057155a
+ (id)timeToLiveHeaderKey;	// IMP=0x000000000057154d
+ (id)requestStartTimeHeaderKey;	// IMP=0x0000000000571540
- (void).cxx_destruct;	// IMP=0x000000000056cdbc
...
- (void)messageTransport:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x000000000056cbe9
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000056c96e
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x000000000056c828
- (void)start;	// IMP=0x000000000056c6f1
- (long long)qualityOfService;	// IMP=0x000000000056c6e6
- (_Bool)isSecure;	// IMP=0x000000000056c6de
- (id)initWithAccountRegistry:(id)arg1 rapportTransport:(id)arg2 idsTransport:(id)arg3 contextManager:(id)arg4 systemDateProvider:(id)arg5 idsDateProvider:(id)arg6 timerProvider:(id)arg7;	// IMP=0x000000000056c4b4
- (id)initWithAccountRegistry:(id)arg1;	// IMP=0x000000000056c38c
