...
- (void).cxx_destruct;	// IMP=0x00000000005a1295
...
- (id)metricForAWD;	// IMP=0x00000000005a1135
- (unsigned int)AWDMessageType;	// IMP=0x00000000005a112a
- (id)initWithSessionID:(id)arg1;	// IMP=0x00000000005a104d
