...
- (void).cxx_destruct;	// IMP=0x00000000005375eb
...
- (void)computeNextRetryInterval;	// IMP=0x0000000000537515
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x0000000000537243
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000005371ac
