...
- (void).cxx_destruct;	// IMP=0x00000000002e00a9
@property __weak id <HMDAccessorySettingsBackingStoreTransactionReceiverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)transactionObjectRemoved:(id)arg1 message:(id)arg2;	// IMP=0x00000000002dfd14
- (void)transactionObjectUpdated:(id)arg1 newValues:(id)arg2 message:(id)arg3;	// IMP=0x00000000002df9ac
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002df945
