...
- (void).cxx_destruct;	// IMP=0x00000000006113de
...
- (_Bool)accessorySupportsCoordinationDoorbellChime:(id)arg1;	// IMP=0x0000000000611364
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x000000000061127c
- (id)clearCoordinationStateForKeyPaths:(id)arg1;	// IMP=0x0000000000611263
- (id)keyPathFromComponents:(id)arg1;	// IMP=0x000000000061125b
- (id)postCoordinationState:(id)arg1;	// IMP=0x0000000000611242
...
- (id)postCULiveAction:(id)arg1;	// IMP=0x0000000000610ff6
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x0000000000610d8a
