...
- (void).cxx_destruct;	// IMP=0x000000000023b981
...
- (void)logRateTrigger:(id)arg1 triggerValue:(unsigned long long)arg2;	// IMP=0x000000000023b7ae
- (void)updatedCounterForEventName:(id)arg1 requestGroup:(id)arg2 fromOldValue:(unsigned long long)arg3 toNewValue:(unsigned long long)arg4;	// IMP=0x000000000023b3fa
- (void)dealloc;	// IMP=0x000000000023b3c0
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 timeSourceBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000023b2d7
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4;	// IMP=0x000000000023b2b1
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3;	// IMP=0x000000000023b29c
