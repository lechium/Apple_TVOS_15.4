...
- (void).cxx_destruct;	// IMP=0x0000000000644d9b
...
- (void)dealloc;	// IMP=0x0000000000644d0f
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x0000000000644c21
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x0000000000644b5b
