...
+ (id)managedEventCounterRequestGroups;	// IMP=0x000000000075edaf
- (void).cxx_destruct;	// IMP=0x000000000075ed18
...
- (void)resetAggregationAnalysisContext;	// IMP=0x000000000075ec80
- (void)populateAggregationAnalysisLogEvent:(id)arg1;	// IMP=0x000000000075ea82
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000075ea02
- (void)submitProcessLaunchEventWithCurrentAnalysis;	// IMP=0x000000000075e869
- (void)handleExitContextForHomed:(id)arg1;	// IMP=0x000000000075e2ff
- (void)updateProcessLaunchInfoFromDisk;	// IMP=0x000000000075e119
- (void)submitProcessLaunchInfoEventPendingConfiguration;	// IMP=0x000000000075e082
- (void)handleDataSyncStateUpdateLogEvent:(id)arg1;	// IMP=0x000000000075dfb7
- (void)handleProcessLaunchLogEvent:(id)arg1;	// IMP=0x000000000075de40
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000075dd0e
- (id)initWithProcessLaunchInfoTimer:(id)arg1 eventCountersManager:(id)arg2 logEventSubmitter:(id)arg3;	// IMP=0x000000000075dc33
