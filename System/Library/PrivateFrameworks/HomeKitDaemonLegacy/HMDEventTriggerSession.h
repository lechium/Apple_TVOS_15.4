...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x00000000004a75b3
+ (id)logCategory;	// IMP=0x00000000004a7583
- (void).cxx_destruct;	// IMP=0x00000000004a74ff
...
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 target:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000004a71ab
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000004a70d8
- (_Bool)sendResidentMessage:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004a6fa9
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x00000000004a6f73
@property(readonly, copy) NSString *description;
- (id)dumpState;	// IMP=0x00000000004a6dff
- (void)_registerForMessages;	// IMP=0x00000000004a6df9
- (void)dealloc;	// IMP=0x00000000004a6c67
- (id)initWithSessionID:(id)arg1 eventTrigger:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000004a6a40
