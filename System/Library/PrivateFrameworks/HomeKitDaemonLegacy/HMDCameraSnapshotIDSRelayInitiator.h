...
+ (id)logCategory;	// IMP=0x000000000091fa33
- (void).cxx_destruct;	// IMP=0x000000000091f53a
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x000000000091f34f
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x000000000091f1a1
- (void)sessionStarted:(id)arg1;	// IMP=0x000000000091f00f
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x000000000091ee94
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x000000000091ed19
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x000000000091ebdb
- (void)dealloc;	// IMP=0x000000000091ea6e
- (void)_startDataTransfer;	// IMP=0x000000000091e79f
- (void)sendIDSInvitation;	// IMP=0x000000000091e2bd
- (void)_sendData;	// IMP=0x000000000091e224
- (void)sendData:(id)arg1;	// IMP=0x000000000091e03d
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x000000000091de97
