...
+ (id)logCategory;	// IMP=0x000000000008c057
- (void).cxx_destruct;	// IMP=0x000000000008bf5a
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x000000000008b89c
- (id)createSelectedAudioParameters;	// IMP=0x000000000008b4d5
- (id)createSRTPParamters;	// IMP=0x000000000008b455
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x000000000008ae90
- (_Bool)selectAudioParameters;	// IMP=0x000000000008a671
- (id)logIdentifier;	// IMP=0x000000000008a621
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x000000000008a48d
