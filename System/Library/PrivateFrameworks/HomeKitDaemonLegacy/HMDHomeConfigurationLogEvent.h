...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x0000000000496d3f
- (void).cxx_destruct;	// IMP=0x000000000049614a
...
- (id)initWithHome:(id)arg1 metadataVersion:(unsigned int)arg2 databaseSize:(unsigned int)arg3 homeIndex:(unsigned long long)arg4;	// IMP=0x0000000000490e0d
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000490da1
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000490cdc
- (void)setHomeConfigurationBitMasks;	// IMP=0x0000000000490bd5
