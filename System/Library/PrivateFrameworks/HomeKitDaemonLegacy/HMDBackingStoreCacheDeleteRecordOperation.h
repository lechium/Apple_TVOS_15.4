...
- (void).cxx_destruct;	// IMP=0x00000000001db7bd
...
- (id)mainReturningError;	// IMP=0x00000000001db34f
- (id)initWithGroup:(id)arg1 recordNames:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001db296
