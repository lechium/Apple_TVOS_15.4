...
+ (id)errorEventWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x00000000009faec6
- (void).cxx_destruct;	// IMP=0x00000000009faeb5
...
- (id)initWithErrorType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x00000000009fae12
- (id)metricForAWD;	// IMP=0x000000000078d4a2
- (unsigned int)AWDMessageType;	// IMP=0x000000000078d497
