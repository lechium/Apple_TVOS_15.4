...
+ (id)logCategory;	// IMP=0x0000000000606b8b
- (void).cxx_destruct;	// IMP=0x0000000000606b3a
...
- (void)resetConfig;	// IMP=0x0000000000606939
- (void)beginPairingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000060681a
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000006066c3
