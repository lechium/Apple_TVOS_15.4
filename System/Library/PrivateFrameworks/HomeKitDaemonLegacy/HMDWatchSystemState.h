...
+ (id)sharedState;	// IMP=0x0000000000737d10
- (void).cxx_destruct;	// IMP=0x0000000000737a96
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x0000000000737a29
- (void)registerDelegate:(id)arg1;	// IMP=0x000000000073795e
...
- (id)init;	// IMP=0x0000000000737434
