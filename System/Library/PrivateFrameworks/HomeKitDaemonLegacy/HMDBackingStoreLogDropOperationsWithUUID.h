...
- (void).cxx_destruct;	// IMP=0x000000000076d2f5
...
- (id)mainReturningError;	// IMP=0x000000000076ccfa
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000076cc52
