...
+ (id)shortDescription;	// IMP=0x00000000009c5fbf
- (void).cxx_destruct;	// IMP=0x00000000009c5f2a
...
- (id)replayTransaction:(id)arg1 stagedTransaction:(id)arg2;	// IMP=0x00000000009c59c5
- (void)loadObjectChanges;	// IMP=0x00000000009c59a2
- (id)changeWithRecordName:(id)arg1;	// IMP=0x00000000009c591f
- (id)changeWithObjectID:(id)arg1;	// IMP=0x00000000009c589c
...
- (void)updateCloudCache;	// IMP=0x00000000009c567c
- (void)setDeleteAsProcessedWithRecordID:(id)arg1;	// IMP=0x00000000009c560a
- (void)resetRecordWithRecordID:(id)arg1;	// IMP=0x00000000009c5598
- (void)setSaveAsProcessedWithRecord:(id)arg1;	// IMP=0x00000000009c5526
- (void)fetchBatchToUpload:(CDUnknownBlockType)arg1;	// IMP=0x00000000009c54b4
- (_Bool)moreChangesToProcess;	// IMP=0x00000000009c5470
- (void)setAllChangedAsProcessed;	// IMP=0x00000000009c5433
- (void)loadCloudRecordsAndDetermineDeletesFromCache:(CDUnknownBlockType)arg1;	// IMP=0x00000000009c529f
- (void)cachedCloudRecordWithObjectID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000009c5219
- (id)cachedCloudRecordWithObjectID:(id)arg1;	// IMP=0x00000000009c5196
@property(readonly) _Bool doRecordsExistInCache;
- (_Bool)doesRecordExistInCacheWithObjectID:(id)arg1;	// IMP=0x00000000009c50db
- (_Bool)doesRecordExistWithObjectID:(id)arg1;	// IMP=0x00000000009c5064
@property(readonly, nonatomic) _Bool hasValidChanges;
- (void)removeChangeWithObjectID:(id)arg1;	// IMP=0x00000000009c4fae
- (void)addChangeWithDeletedRecordID:(id)arg1;	// IMP=0x00000000009c4f3c
- (void)addChangeWithRecord:(id)arg1;	// IMP=0x00000000009c4eca
- (void)addChangeWithObjectChange:(id)arg1;	// IMP=0x00000000009c4e58
...
- (id)description;	// IMP=0x00000000009c4b7c
- (id)shortDescription;	// IMP=0x00000000009c4a4c
- (void)updateCloudZone:(id)arg1;	// IMP=0x00000000009c49c7
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2 noLocalData:(_Bool)arg3;	// IMP=0x00000000009c4924
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2;	// IMP=0x00000000009c490f
- (id)init;	// IMP=0x00000000009c4867
