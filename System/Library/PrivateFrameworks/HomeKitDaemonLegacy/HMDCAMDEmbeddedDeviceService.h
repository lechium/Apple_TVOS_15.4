...
+ (id)logCategory;	// IMP=0x0000000000516986
+ (void)confirmSemaphoreAndSignal:(id)arg1;	// IMP=0x0000000000516845
- (void).cxx_destruct;	// IMP=0x0000000000515a86
...
- (id)logIdentifier;	// IMP=0x00000000005159ad
- (void)_testCommunication:(CDUnknownBlockType)arg1;	// IMP=0x000000000051599a
- (void)_performCommandFromClass:(id)arg1 method:(id)arg2 arguments:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000000005156c7
- (void)_removeActualBlockForKey:(id)arg1;	// IMP=0x000000000051559d
- (void)_fireActualBlockWithArguments:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000051547a
- (_Bool)testCommunication;	// IMP=0x00000000005152aa
- (id)performCommandFromClass:(id)arg1 method:(id)arg2 arguments:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000514ec2
- (id)remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000514e13
- (id)remoteObjectProxy;	// IMP=0x0000000000514dff
- (void)resetConnection;	// IMP=0x0000000000514c78
- (void)start;	// IMP=0x0000000000514835
- (void)blockReleased:(id)arg1;	// IMP=0x0000000000514781
- (void)dealloc;	// IMP=0x00000000005146d7
- (id)initAsMobile;	// IMP=0x00000000005146c5
- (id)initAsRoot;	// IMP=0x00000000005146ae
- (id)init;	// IMP=0x000000000051469a
- (id)_initAsRoot:(_Bool)arg1;	// IMP=0x000000000051458d
