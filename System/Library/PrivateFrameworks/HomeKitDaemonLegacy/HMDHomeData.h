...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x000000000044d2d5
- (void).cxx_destruct;	// IMP=0x000000000044d1c7
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x000000000044cea1
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000044ce4f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000044ce44
