...
- (void).cxx_destruct;	// IMP=0x00000000001d9ece
...
- (id)dumpDebug;	// IMP=0x00000000001d9c3f
- (id)initWithGroupID:(long long)arg1 zone:(id)arg2 rootRecord:(id)arg3 serverChangeToken:(id)arg4 subscriptionName:(id)arg5 owner:(id)arg6 subscription:(id)arg7;	// IMP=0x00000000001d9ae4
