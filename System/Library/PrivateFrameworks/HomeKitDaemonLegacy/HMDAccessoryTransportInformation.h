...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003d78d1
- (void).cxx_destruct;	// IMP=0x00000000003d786d
...
- (id)attributeDescriptions;	// IMP=0x00000000003d765f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003d758d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003d737b
- (id)report;	// IMP=0x00000000003d7198
...
- (id)initWithServerIdentifier:(id)arg1 instanceID:(id)arg2 linkType:(long long)arg3;	// IMP=0x00000000003d6e1e
