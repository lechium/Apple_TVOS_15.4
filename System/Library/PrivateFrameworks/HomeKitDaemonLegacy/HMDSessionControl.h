...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000722e4
- (void).cxx_destruct;	// IMP=0x00000000000722d1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000072213
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000720c9
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000071f92
- (id)tlvData;	// IMP=0x0000000000071ea6
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000071d34
- (id)initWithCommand:(unsigned long long)arg1 sessionIdentifier:(id)arg2;	// IMP=0x0000000000071cb4
