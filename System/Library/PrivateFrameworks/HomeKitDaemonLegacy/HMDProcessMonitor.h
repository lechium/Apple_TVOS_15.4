...
+ (id)logCategory;	// IMP=0x0000000000690f98
- (void).cxx_destruct;	// IMP=0x000000000068fe13
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000068fcde
- (void)_processAppStateChange:(id)arg1;	// IMP=0x000000000068fbcb
- (void)removeFromPendingTerminated:(id)arg1;	// IMP=0x000000000068f7ae
- (void)_removeProcess:(id)arg1;	// IMP=0x000000000068f6ea
- (void)removeProcess:(id)arg1;	// IMP=0x000000000068f4d0
- (id)processInfoForConnection:(id)arg1;	// IMP=0x000000000068f257
- (id)processInfoForPID:(int)arg1;	// IMP=0x000000000068f1d3
@property(readonly, copy) NSArray *processes;
- (void)updateApplicationMonitor;	// IMP=0x000000000068eef6
- (void)dealloc;	// IMP=0x000000000068eead
- (id)initWithXpcListenerQueue:(id)arg1;	// IMP=0x000000000068eda5
- (id)init;	// IMP=0x000000000068ed01
