...
+ (id)logCategory;	// IMP=0x00000000009cde76
- (void).cxx_destruct;	// IMP=0x00000000009cde47
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x00000000009cdb82
- (id)logIdentifier;	// IMP=0x00000000009cdaad
- (id)initWithRegisterer:(id)arg1;	// IMP=0x00000000009cda15
