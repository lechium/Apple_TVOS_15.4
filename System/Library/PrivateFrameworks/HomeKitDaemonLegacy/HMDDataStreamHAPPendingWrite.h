...
- (void).cxx_destruct;	// IMP=0x000000000062efa2
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x000000000062ee86
- (_Bool)isComplete;	// IMP=0x000000000062ee25
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000062ed79
