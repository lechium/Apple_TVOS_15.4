...
+ (id)properties;	// IMP=0x00000000005cb3ae
+ (id)homePodAccessoryModelWithChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x00000000005cb329
+ (id)appleMediaAccessoryModelWithChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x00000000005cb2a4
- (id)_initWithObjectChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x00000000005cb275
