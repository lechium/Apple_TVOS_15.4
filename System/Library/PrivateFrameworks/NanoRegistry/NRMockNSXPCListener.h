...
- (void).cxx_destruct;	// IMP=0x000000000000688b
@property(retain, nonatomic) id <NRNSXPCListenerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dealloc;	// IMP=0x000000000000677c
- (void)invalidate;	// IMP=0x0000000000006659
- (void)suspend;	// IMP=0x00000000000065be
- (void)resume;	// IMP=0x0000000000006518
- (id)initWithMachServiceName:(id)arg1;	// IMP=0x00000000000062f7
