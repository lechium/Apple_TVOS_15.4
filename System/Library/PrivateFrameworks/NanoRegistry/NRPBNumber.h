...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001f768
- (unsigned long long)hash;	// IMP=0x000000000001f4b3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001f302
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f1fe
- (void)copyTo:(id)arg1;	// IMP=0x000000000001f11d
- (void)writeTo:(id)arg1;	// IMP=0x000000000001f009
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001effc
- (id)dictionaryRepresentation;	// IMP=0x000000000001e829
- (id)description;	// IMP=0x000000000001e77a
