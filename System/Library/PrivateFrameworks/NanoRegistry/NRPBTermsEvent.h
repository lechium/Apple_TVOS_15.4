...
- (void).cxx_destruct;	// IMP=0x0000000000057ded
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000057b0e
- (unsigned long long)hash;	// IMP=0x00000000000578bd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000057628
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005742d
- (void)copyTo:(id)arg1;	// IMP=0x00000000000572a8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000057131
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000057124
- (id)dictionaryRepresentation;	// IMP=0x0000000000056aa6
- (id)description;	// IMP=0x00000000000569f7
