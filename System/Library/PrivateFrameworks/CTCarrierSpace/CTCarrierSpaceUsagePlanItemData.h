...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000053d8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000524c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005188
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004d0f
- (id)description;	// IMP=0x0000000000004b4b
- (id)init;	// IMP=0x0000000000004ac2
