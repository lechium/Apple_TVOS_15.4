...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000583b
- (void).cxx_destruct;	// IMP=0x00000000000058a6
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005714
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000567a
- (id)description;	// IMP=0x0000000000005533
