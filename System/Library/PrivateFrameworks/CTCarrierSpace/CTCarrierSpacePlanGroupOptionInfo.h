...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000024ed
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002288
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002164
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000001f7e
@property(readonly, nonatomic) long long planStatus;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000001705
- (id)description;	// IMP=0x000000000000147e
- (id)init;	// IMP=0x00000000000013e4
