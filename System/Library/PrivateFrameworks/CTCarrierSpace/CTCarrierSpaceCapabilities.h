...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000853d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000083ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000832f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008242
- (id)description;	// IMP=0x0000000000008147
