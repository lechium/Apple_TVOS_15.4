...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000002bb7
- (void).cxx_destruct;	// IMP=0x0000000000002c1a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002ac1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002a3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000027db
- (id)description;	// IMP=0x000000000000268e
- (id)init;	// IMP=0x000000000000261b
