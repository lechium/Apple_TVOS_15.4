...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000008049
- (void).cxx_destruct;	// IMP=0x00000000000080fe
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007e5c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000007d82
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007865
- (id)description;	// IMP=0x0000000000007688
- (id)init;	// IMP=0x00000000000075fb
