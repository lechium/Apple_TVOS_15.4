...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000009897
- (void).cxx_destruct;	// IMP=0x000000000000996e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000096a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000095be
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000009231
- (id)description;	// IMP=0x000000000000900e
- (id)init;	// IMP=0x0000000000008f6f
