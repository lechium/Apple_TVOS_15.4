...
- (void).cxx_destruct;	// IMP=0x000000000000caef
@property(retain, nonatomic) NSString *rmAccountID; // @synthesize rmAccountID=_rmAccountID;
- (_Bool)authenticateRequest:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000c9ff
- (id)initWithRMAccountID:(id)arg1;	// IMP=0x000000000000c997
