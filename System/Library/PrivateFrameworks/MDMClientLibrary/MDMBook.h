...
- (void).cxx_destruct;	// IMP=0x0000000000010f14
...
- (id)description;	// IMP=0x0000000000010a19
- (void)updateBookAttributesByCopyingFromBook:(id)arg1;	// IMP=0x000000000001094b
- (id)friendlyName;	// IMP=0x000000000001082a
- (id)manifestDictionary;	// IMP=0x000000000001064d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010441
- (id)initWithManifestDictionary:(id)arg1;	// IMP=0x0000000000010269
- (id)init;	// IMP=0x0000000000010255
