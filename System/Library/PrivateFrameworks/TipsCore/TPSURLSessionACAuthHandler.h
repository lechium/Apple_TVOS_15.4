...
+ (_Bool)canAuthenticateWithURLResponse:(id)arg1;	// IMP=0x000000000004be47
- (void).cxx_destruct;	// IMP=0x000000000004c61e
...
- (id)_authenticationTokenForHost:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004c3f4
- (void)_authenticateWithAppleConnect:(CDUnknownBlockType)arg1;	// IMP=0x000000000004c36a
- (id)customHeaderFields;	// IMP=0x000000000004c291
- (void)authenticateForURLResponse:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000004c0db
- (id)initWithAuthenticationContext:(id)arg1;	// IMP=0x000000000004c054
