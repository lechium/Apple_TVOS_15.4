...
+ (id)transactionWithName:(id)arg1;	// IMP=0x0000000000008529
- (void).cxx_destruct;	// IMP=0x0000000000008936
...
- (void)dealloc;	// IMP=0x00000000000087e6
- (void)endTransaction;	// IMP=0x0000000000008664
- (id)initWithTransactionName:(id)arg1;	// IMP=0x0000000000008572
