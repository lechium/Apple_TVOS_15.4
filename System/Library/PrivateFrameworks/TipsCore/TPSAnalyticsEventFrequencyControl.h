...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000031e79
- (void).cxx_destruct;	// IMP=0x00000000000324af
...
- (id)mutableAnalyticsEventRepresentation;	// IMP=0x000000000003231e
- (id)eventName;	// IMP=0x00000000000322eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000321f2
- (void)setDataProvider:(id)arg1;	// IMP=0x00000000000320ec
- (id)initWithDisplayType:(id)arg1 displayCount:(id)arg2 notDisplayedDueToFrequencyControlCount:(id)arg3;	// IMP=0x0000000000032024
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000031e81
