...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004f408
- (void).cxx_destruct;	// IMP=0x000000000004fc33
...
- (id)debugDescription;	// IMP=0x000000000004f993
- (id)description;	// IMP=0x000000000004f8ae
@property(readonly, copy, nonatomic) NSString *identifier; // @dynamic identifier;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004f722
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004f5aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004f489
- (id)initWithContent:(id)arg1;	// IMP=0x000000000004f410
