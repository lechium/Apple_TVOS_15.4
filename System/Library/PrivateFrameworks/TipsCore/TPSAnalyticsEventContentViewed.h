...
+ (void)setAppReferrer:(id)arg1;	// IMP=0x0000000000062126
+ (void)incrementSessionViewNumberForKey:(id)arg1;	// IMP=0x0000000000061edd
+ (id)eventWithContentID:(id)arg1 collectionID:(id)arg2 correlationID:(id)arg3 viewMethod:(id)arg4 contentStyle:(id)arg5 viewMode:(id)arg6 timeOnScreen:(double)arg7 animationLoadTime:(double)arg8 animationFinished:(_Bool)arg9 seenThisContentBefore:(_Bool)arg10 hardwareWelcome:(_Bool)arg11 softwareWelcome:(_Bool)arg12;	// IMP=0x0000000000061923
+ (id)eventWithContentID:(id)arg1 collectionID:(id)arg2 correlationID:(id)arg3 widgetType:(id)arg4 hardwareWelcome:(_Bool)arg5 softwareWelcome:(_Bool)arg6;	// IMP=0x000000000006185e
+ (_Bool)updateSessionViewNumber;	// IMP=0x0000000000061189
+ (void)resetSessionViewNumber;	// IMP=0x0000000000061131
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000061129
- (void).cxx_destruct;	// IMP=0x0000000000062325
...
- (id)mutableAnalyticsEventRepresentation;	// IMP=0x0000000000061fb5
@property(readonly, nonatomic) NSNumber *sessionViewNumber;
- (void)log;	// IMP=0x0000000000061e19
- (id)eventName;	// IMP=0x0000000000061db6
- (_Bool)isWidget;	// IMP=0x0000000000061d92
- (void)setDataProvider:(id)arg1;	// IMP=0x0000000000061d07
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000061a5a
- (id)_initWithContentID:(id)arg1 collectionID:(id)arg2 correlationID:(id)arg3 widgetType:(id)arg4 hardwareWelcome:(_Bool)arg5 softwareWelcome:(_Bool)arg6;	// IMP=0x0000000000061748
- (id)_initWithContentID:(id)arg1 collectionID:(id)arg2 correlationID:(id)arg3 viewMethod:(id)arg4 contentStyle:(id)arg5 viewMode:(id)arg6 timeOnScreen:(double)arg7 animationLoadTime:(double)arg8 animationFinished:(_Bool)arg9 seenThisContentBefore:(_Bool)arg10 hardwareWelcome:(_Bool)arg11 softwareWelcome:(_Bool)arg12;	// IMP=0x0000000000061597
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000611e4
