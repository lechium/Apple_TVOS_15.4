...
+ (id)eventWithContentID:(id)arg1 collectionID:(id)arg2 correlationID:(id)arg3 url:(id)arg4;	// IMP=0x000000000003442f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000034063
...
- (id)mutableAnalyticsEventRepresentation;	// IMP=0x00000000000346f9
- (id)eventName;	// IMP=0x00000000000346c6
- (void)setDataProvider:(id)arg1;	// IMP=0x000000000003463b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000344e9
- (id)_initWithContentID:(id)arg1 collectionID:(id)arg2 correlationID:(id)arg3 url:(id)arg4 bundleID:(id)arg5 context:(id)arg6 displayType:(id)arg7;	// IMP=0x00000000000342a1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003406b
