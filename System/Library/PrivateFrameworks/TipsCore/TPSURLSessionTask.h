...
@interface TPSURLSessionTask : NSObject
{
    ...
    NSString *_requestType;	// 64 = 0x40
    id _formattedData;	// 72 = 0x48
    NSURLSessionTask *_task;	// 80 = 0x50
    NSHTTPURLResponse *_response;	// 88 = 0x58
    NSString *_lastModified;	// 96 = 0x60
    NSMutableData *_dataTaskData;	// 104 = 0x68
    NSError *_dataError;	// 112 = 0x70
    NSHashTable *_sessionTaskDelegates;	// 120 = 0x78
}

+ (struct TPSURLSessionDelegateResponds)delegateRespondsWithDelegate:(id)arg1;	// IMP=0x000000000001d7d1
- (void).cxx_destruct;	// IMP=0x000000000001dee5
...
- (void)cancel;	// IMP=0x000000000001dcae
- (void)resume;	// IMP=0x000000000001dc98
- (void)unregisterDelegate:(id)arg1;	// IMP=0x000000000001db92
- (void)registerDelegate:(id)arg1;	// IMP=0x000000000001da93
- (void)didCompleteWithError:(id)arg1;	// IMP=0x000000000001d89f
@property(nonatomic) float priority; // @dynamic priority;
@property(readonly, nonatomic) NSURL *URL;
- (id)initWithSessionTask:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000001d54d
- (void)dealloc;	// IMP=0x000000000001d50f
