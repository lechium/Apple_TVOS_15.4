...
- (void)appendBindParameterMarkersToQueryString:(id)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000655c1
- (void)appendOrderByClauseToQueryString:(id)arg1;	// IMP=0x000000000006541b
- (void)bindWhereClause:(id)arg1;	// IMP=0x000000000006536b
- (void)appendWhereClauseToQueryString:(id)arg1;	// IMP=0x00000000000652ee
- (void)appendFromClauseToQueryString:(id)arg1;	// IMP=0x00000000000651c8
- (void)bindWithClause:(id)arg1;	// IMP=0x00000000000650cd
- (void)prependWithClauseToQueryString:(id)arg1 whereClause:(id)arg2;	// IMP=0x0000000000064d9a
- (void)appendCustomPropertySelectsToQueryString:(id)arg1;	// IMP=0x0000000000064c8f
- (void)dealloc;	// IMP=0x0000000000064c06
- (id)scopedStoresForManagedConfiguration:(id)arg1;	// IMP=0x0000000000064b87
- (void)_initSetupPropertySet:(struct __CFSet *)arg1 includeLinkedContacts:(_Bool)arg2;	// IMP=0x00000000000649c1
- (id)initWithAddressBook:(void *)arg1 predicate:(id)arg2 requestedProperties:(struct __CFSet *)arg3 includeLinkedContacts:(_Bool)arg4 sortOrder:(unsigned int)arg5 managedConfiguration:(id)arg6;	// IMP=0x000000000006439c
