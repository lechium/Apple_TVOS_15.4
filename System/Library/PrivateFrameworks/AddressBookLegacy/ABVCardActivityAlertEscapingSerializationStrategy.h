...
+ (id)regex;	// IMP=0x000000000006ce5c
+ (id)serializeString:(id)arg1;	// IMP=0x000000000006ce00
+ (id)charactersToTriggerStrategy;	// IMP=0x000000000006cda3
+ (_Bool)strategyWouldAlterString:(id)arg1;	// IMP=0x000000000006cd63
