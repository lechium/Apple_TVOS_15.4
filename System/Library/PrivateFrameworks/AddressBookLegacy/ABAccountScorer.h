...
- (void).cxx_destruct;	// IMP=0x0000000000013504
...
- (int)_findBestSourceID;	// IMP=0x00000000000132ae
- (void)calculateScore;	// IMP=0x0000000000012fff
...
- (void)dealloc;	// IMP=0x0000000000012dff
- (id)initWithAddressBook:(void *)arg1 accountStore:(id)arg2 account:(void *)arg3 defaultSourceID:(int)arg4;	// IMP=0x0000000000012d42
