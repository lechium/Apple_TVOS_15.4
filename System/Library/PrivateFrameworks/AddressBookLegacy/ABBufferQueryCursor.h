...
- (void)dealloc;	// IMP=0x00000000000665d0
- (void)fetchNextBatchWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000065a4d
- (id)initWithQuery:(id)arg1 batchSize:(unsigned long long)arg2 managedConfiguration:(id)arg3;	// IMP=0x00000000000657bc
- (id)initWithAddressBook:(void *)arg1 predicate:(id)arg2 propertyIdentifierSet:(struct __CFSet *)arg3 includeLinkedContacts:(_Bool)arg4 sortOrder:(unsigned int)arg5 suggestedContactsPerBatch:(unsigned long long)arg6 managedConfiguration:(id)arg7;	// IMP=0x000000000006571c
