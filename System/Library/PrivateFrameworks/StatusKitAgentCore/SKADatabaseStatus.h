...
- (void).cxx_destruct;	// IMP=0x000000000002311c
...
- (id)description;	// IMP=0x0000000000022fff
@property(readonly, nonatomic) _Bool isExpired;
- (id)initWithChannelIdentifier:(id)arg1 dateCreated:(id)arg2 datePublished:(id)arg3 dateReceived:(id)arg4 dateExpired:(id)arg5 rawData:(id)arg6 uniqueIdentifier:(id)arg7;	// IMP=0x0000000000022dd4
- (id)initWithCoreDataStatus:(id)arg1;	// IMP=0x000000000001b8bf
