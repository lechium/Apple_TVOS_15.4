...
- (void).cxx_destruct;	// IMP=0x000000000006aa30
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000006a8b0
- (unsigned long long)hash;	// IMP=0x000000000006a840
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006a740
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006a670
- (void)copyTo:(id)arg1;	// IMP=0x000000000006a5e0
- (void)writeTo:(id)arg1;	// IMP=0x000000000006a560
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006a550
- (id)dictionaryRepresentation;	// IMP=0x000000000006a450
- (id)description;	// IMP=0x000000000006a3a0
