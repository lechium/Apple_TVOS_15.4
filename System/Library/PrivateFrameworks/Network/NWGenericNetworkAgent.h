...
- (_Bool)supportsGroups;	// IMP=0x000000000005b190
- (_Bool)supportsResolve;	// IMP=0x000000000005b150
- (_Bool)requiresAssert;	// IMP=0x000000000005b110
- (_Bool)supportsBrowse;	// IMP=0x000000000005b0d0
- (_Bool)isNexusProvider;	// IMP=0x000000000005b090
...
- (id)description;	// IMP=0x000000000005ad00
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x000000000005a940
- (void)dealloc;	// IMP=0x000000000005a8c0
- (id)initWithKernelAgent:(const struct netagent *)arg1;	// IMP=0x000000000005a840
