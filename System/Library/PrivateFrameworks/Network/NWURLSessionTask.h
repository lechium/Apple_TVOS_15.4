...
- (void).cxx_destruct;	// IMP=0x000000000004fec0
...
- (void)_setExplicitCookieStorage:(struct OpaqueCFHTTPCookieStorage *)arg1;	// IMP=0x000000000004fc70
@property(readonly, nonatomic) NSArray *_resolvedCNAMEChain;
- (id)_timingData;	// IMP=0x000000000004fc50
@property(readonly) NSURLSessionTaskMetrics *_incompleteTaskMetrics;
- (void)getUnderlyingHTTPConnectionInfoWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000004fc20
@property(readonly, nonatomic) long long state;
- (void)cancel;	// IMP=0x000000000004fbd0
- (void)suspend;	// IMP=0x000000000004fbc0
- (void)resume;	// IMP=0x000000000004ee90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004ee80
- (_Bool)isKindOfClass:(Class)arg1;	// IMP=0x000000000004ee20
