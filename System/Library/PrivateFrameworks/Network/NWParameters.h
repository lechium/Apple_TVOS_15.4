...
+ (id)parametersWithProtocolBufferData:(id)arg1;	// IMP=0x00000000000598d0
+ (id)parametersWithCParameters:(id)arg1;	// IMP=0x0000000000059860
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000059850
- (void).cxx_destruct;	// IMP=0x0000000000059430
...
- (id)createProtocolBufferObject;	// IMP=0x00000000000582b0
@property(retain, nonatomic) NSData *metadata;
- (unsigned long long)hash;	// IMP=0x0000000000058130
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000058060
- (void)setProtocolAtLevel:(unsigned long long)arg1 protocol:(struct nw_protocol_identifier *)arg2;	// IMP=0x0000000000058000
- (id)copyRequiredAgentsDescription;	// IMP=0x0000000000057e50
@property(readonly, nonatomic, getter=isDryRun) _Bool dryRun;
- (_Bool)hasNonEmptyProxyConfiguration;	// IMP=0x0000000000057dd0
- (_Bool)hasProhibitedNetworkAgents;	// IMP=0x0000000000057d90
- (_Bool)hasPreferredNetworkAgents;	// IMP=0x0000000000057d50
- (_Bool)hasRequiredNetworkAgents;	// IMP=0x0000000000057d10
...
- (void)setInitialDataPayload:(id)arg1;	// IMP=0x00000000000576b0
- (void)setSourceApplicationWithBundleID:(id)arg1;	// IMP=0x0000000000057630
- (void)setSourceApplicationWithToken:(CDStruct_6ad76789)arg1;	// IMP=0x00000000000575e0
...
- (unsigned short)tlsVersionWithSSLProtocol:(int)arg1;	// IMP=0x0000000000057330
...
- (void)avoidNetworkAgentWithDomain:(id)arg1 type:(id)arg2;	// IMP=0x0000000000056100
- (void)avoidNetworkAgentWithUUID:(id)arg1;	// IMP=0x0000000000055ff0
- (void)preferNetworkAgentWithDomain:(id)arg1 type:(id)arg2;	// IMP=0x0000000000055e40
- (void)preferNetworkAgentWithUUID:(id)arg1;	// IMP=0x0000000000055d30
- (void)requireNetworkAgentWithDomain:(id)arg1 type:(id)arg2;	// IMP=0x0000000000055b80
- (void)requireNetworkAgentWithUUID:(id)arg1;	// IMP=0x0000000000055a70
...
- (void)prohibitNetworkAgentsWithDomain:(id)arg1 type:(id)arg2;	// IMP=0x0000000000055240
- (void)prohibitNetworkAgentWithUUID:(id)arg1;	// IMP=0x0000000000055130
- (void)prohibitInterface:(id)arg1;	// IMP=0x0000000000055030
- (void)prohibitInterfaceSubtype:(long long)arg1;	// IMP=0x0000000000054f80
- (void)prohibitInterfaceType:(long long)arg1;	// IMP=0x0000000000054ed0
...
- (_Bool)copyEffectiveAuditToken:(CDStruct_6ad76789 *)arg1;	// IMP=0x0000000000054690
@property(copy, nonatomic) NSString *effectiveBundleID;
@property(copy, nonatomic) NSUUID *effectiveProcessUUID;
- (_Bool)hasDelegatedProcessUUID;	// IMP=0x0000000000054400
@property(copy, nonatomic) NSUUID *processUUID;
@property(nonatomic) unsigned int uid;
- (_Bool)hasDelegatedPIDForOriginatingPID:(int)arg1;	// IMP=0x00000000000541d0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053d60
@property(readonly, copy, nonatomic) NSString *privateDescription;
- (id)description;	// IMP=0x0000000000053d10
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x0000000000052970
- (id)copyCParameters;	// IMP=0x0000000000052930
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000524d0
- (id)init;	// IMP=0x0000000000052070
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000051b60
