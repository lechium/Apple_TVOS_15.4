...
+ (id)flushTimerIdentifier;	// IMP=0x0000000000041238
- (void).cxx_destruct;	// IMP=0x00000000000415d8
@property(nonatomic) __weak id <CATIDSServiceConnectionDataMessageQueueDelegate> delegate; // @synthesize delegate=_delegate;
- (void)retransmitContent:(id)arg1;	// IMP=0x0000000000041471
- (void)flushTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x00000000000413db
- (void)scheduleFlushTimer;	// IMP=0x000000000004125d
- (void)retransmitSequenceNumbers:(id)arg1;	// IMP=0x000000000004112c
- (void)receiveRemoteSequenceNumber:(unsigned long long)arg1;	// IMP=0x0000000000040ff1
