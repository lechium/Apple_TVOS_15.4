...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002390c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000023bc1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000023914
- (id)initWithSessionUUID:(id)arg1;	// IMP=0x0000000000023882
