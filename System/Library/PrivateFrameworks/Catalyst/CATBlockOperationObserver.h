...
- (void)invokeBlock:(CDUnknownBlockType)arg1 operation:(id)arg2;	// IMP=0x00000000000052aa
- (void)operationDidFinish:(id)arg1;	// IMP=0x0000000000005235
- (void)operationDidProgress:(id)arg1;	// IMP=0x00000000000051c0
- (void)operationDidStart:(id)arg1;	// IMP=0x000000000000514b
- (id)init;	// IMP=0x0000000000005071
