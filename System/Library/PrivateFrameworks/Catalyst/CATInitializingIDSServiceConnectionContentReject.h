...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0000000000041803
- (void).cxx_destruct;	// IMP=0x000000000004193b
...
- (id)initWithConnectionIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x0000000000041656
