...
- (void).cxx_destruct;	// IMP=0x00000000000229ff
- (void)didSendMessagesWithError:(id)arg1;	// IMP=0x00000000000229d8
- (void)sendMessages;	// IMP=0x00000000000224f1
- (void)main;	// IMP=0x00000000000224df
- (_Bool)isAsynchronous;	// IMP=0x00000000000224d7
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x0000000000022347
