...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0000000000041aa0
- (void).cxx_destruct;	// IMP=0x0000000000041b16
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000041963
