...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0000000000010396
- (void).cxx_destruct;	// IMP=0x000000000001040c
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000010259
