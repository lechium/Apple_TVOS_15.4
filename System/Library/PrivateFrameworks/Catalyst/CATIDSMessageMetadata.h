...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x00000000000020a2
- (void).cxx_destruct;	// IMP=0x0000000000002258
...
- (id)initWithMessageType:(long long)arg1;	// IMP=0x0000000000001ec0
- (id)initWithMessageIdentifier:(id)arg1 messageType:(long long)arg2 messagingVersion:(long long)arg3;	// IMP=0x0000000000001e3f
