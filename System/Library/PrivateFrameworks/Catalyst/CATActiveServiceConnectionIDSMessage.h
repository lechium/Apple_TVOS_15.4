...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x000000000000dc10
- (void).cxx_destruct;	// IMP=0x000000000000deb2
...
- (id)initWithConnectionIdentifier:(id)arg1 receivedSequenceNumber:(id)arg2 content:(id)arg3;	// IMP=0x000000000000d97c
