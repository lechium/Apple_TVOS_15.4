...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000b6b9
- (void).cxx_destruct;	// IMP=0x000000000000b806
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b6c1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b60d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b46f
- (id)init;	// IMP=0x000000000000b3db
@property(readonly, nonatomic) _Bool asynchronous;
- (void)loadCardWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b3bc
