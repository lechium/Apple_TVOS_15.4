...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001a136a
- (void).cxx_destruct;	// IMP=0x00000000001a1328
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a10b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a0ff8
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a0ea9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a0de3
- (_Bool)hasMediaEntityType;	// IMP=0x00000000001a0dd1
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001d3f38
