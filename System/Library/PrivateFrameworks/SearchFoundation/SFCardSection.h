...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000d34a
- (void).cxx_destruct;	// IMP=0x000000000000d274
...
- (void)addCardsFromEmbeddedSectionsTo:(id)arg1;	// IMP=0x000000000000ceb6
- (void)addCardsFromButtonsTo:(id)arg1;	// IMP=0x000000000000ccb9
- (void)addCardsFromCommandsTo:(id)arg1;	// IMP=0x000000000000cbd6
@property(readonly) NSArray *embeddedCards;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c3bb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c1f7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c01e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000bbbd
@property(nonatomic) _Bool hideDivider; // @synthesize hideDivider=_hideDivider;
- (id)init;	// IMP=0x000000000000bafe
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000033555
