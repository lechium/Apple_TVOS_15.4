...
- (void).cxx_destruct;	// IMP=0x00000000000e2cee
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000e228e
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000e21d0
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000e16d8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e0ae4
- (void)writeTo:(id)arg1;	// IMP=0x00000000000e06a6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000e0699
- (id)buttonItemsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000e0668
- (unsigned long long)buttonItemsCount;	// IMP=0x00000000000e064b
- (void)addButtonItems:(id)arg1;	// IMP=0x00000000000e05d1
- (void)clearButtonItems;	// IMP=0x00000000000e05b4
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000e044b
- (unsigned long long)punchoutOptionsCount;	// IMP=0x00000000000e042e
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x00000000000e03b4
- (void)clearPunchoutOptions;	// IMP=0x00000000000e0397
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001b3585
