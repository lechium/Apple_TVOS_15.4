...
@interface SFMediaRemoteControlCardSection <SFMediaRemoteControlCardSection, NSSecureCoding, NSCopying>
{
    struct {
    ...
    _Bool _playbackRouteUniqueIdentifierIsEncrypted;	// 15 = 0xf
    ...
    NSString *_playbackRouteUniqueIdentifier;	// 64 = 0x40
    NSString *_playbackBundleIdentifier;	// 72 = 0x48
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019300a
- (void).cxx_destruct;	// IMP=0x0000000000192f84
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000192a6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001928f1
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001927a2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001926f0
- (_Bool)hasPlaybackRouteUniqueIdentifierIsEncrypted;	// IMP=0x00000000001926db
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001926ab
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000019267b
- (_Bool)hasHasTopPadding;	// IMP=0x000000000019264c
- (_Bool)hasCanBeHidden;	// IMP=0x000000000019261f
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000019574b
