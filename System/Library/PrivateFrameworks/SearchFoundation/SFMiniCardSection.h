...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001e7b7e
- (void).cxx_destruct;	// IMP=0x00000000001e7ae7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e7576
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e73dd
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e728e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e71dc
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001e71c7
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001e7197
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001e7168
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001e713b
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000001429c
