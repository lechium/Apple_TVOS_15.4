...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019e2cc
- (void).cxx_destruct;	// IMP=0x000000000019e1fe
...
- (_Bool)compareWithSection:(id)arg1 logger:(CDUnknownBlockType)arg2;	// IMP=0x000000000019dbde
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019da77
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019d96f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019d6f5
- (id)init;	// IMP=0x000000000019d672
