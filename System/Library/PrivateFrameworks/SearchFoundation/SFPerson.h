...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019882d
- (void).cxx_destruct;	// IMP=0x0000000000198b7c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000198a36
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001988e7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000198835
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001cf855
