...
- (void).cxx_destruct;	// IMP=0x000000000001a903
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001a69d
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001a54e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001a49c
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000018487c
