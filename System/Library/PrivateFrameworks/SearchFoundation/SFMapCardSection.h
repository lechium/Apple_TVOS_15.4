...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001a4c07
- (void).cxx_destruct;	// IMP=0x00000000001a4b3d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a43d5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a41bf
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a4070
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a3fbe
- (_Bool)hasPinBehavior;	// IMP=0x00000000001a3fa9
- (_Bool)hasSizeFormat;	// IMP=0x00000000001a3f79
- (_Bool)hasInteractive;	// IMP=0x00000000001a3f49
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001a3f19
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001a3ee9
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001a3eba
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001a3e8d
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000028a84
