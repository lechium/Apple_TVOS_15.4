...
- (void).cxx_destruct;	// IMP=0x00000000001357d6
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000134922
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000134864
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000133a2b
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000013282f
- (void)writeTo:(id)arg1;	// IMP=0x00000000001322cc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001322bf
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000132072
- (unsigned long long)punchoutOptionsCount;	// IMP=0x0000000000132055
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x0000000000131fdb
- (void)clearPunchoutOptions;	// IMP=0x0000000000131fbe
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000018fead
