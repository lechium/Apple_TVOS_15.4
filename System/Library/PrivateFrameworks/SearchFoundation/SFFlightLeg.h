...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001e447d
- (void).cxx_destruct;	// IMP=0x00000000001e4a46
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e469e
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e454f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e449d
- (_Bool)hasStatus;	// IMP=0x00000000001e4492
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001d3436
