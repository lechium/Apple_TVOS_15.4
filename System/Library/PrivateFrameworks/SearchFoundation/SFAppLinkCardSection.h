...
@interface SFAppLinkCardSection <SFAppLinkCardSection, NSSecureCoding, NSCopying>
{
    ...
    NSArray *_appLinks;	// 80 = 0x50
}

+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000547cb
- (void).cxx_destruct;	// IMP=0x0000000000054734
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000054448
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000542f9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000054247
- (_Bool)hasSeparatorStyle;	// IMP=0x0000000000054232
- (_Bool)hasHasBottomPadding;	// IMP=0x0000000000054202
- (_Bool)hasHasTopPadding;	// IMP=0x00000000000541d3
- (_Bool)hasCanBeHidden;	// IMP=0x00000000000541a6
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001aac2b
