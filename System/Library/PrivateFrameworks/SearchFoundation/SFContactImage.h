...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002f76c
- (void).cxx_destruct;	// IMP=0x000000000002f73b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f539
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002f496
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002f347
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002f281
- (_Bool)hasThreeDTouchEnabled;	// IMP=0x000000000002f26f
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000002ff47
