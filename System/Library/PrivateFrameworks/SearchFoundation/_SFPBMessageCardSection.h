...
- (void).cxx_destruct;	// IMP=0x0000000000111edb
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000111566
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000001114a8
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000110a83
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010ff19
- (void)writeTo:(id)arg1;	// IMP=0x000000000010fb6b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000010fb5e
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000010f9d5
- (unsigned long long)punchoutOptionsCount;	// IMP=0x000000000010f9b8
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x000000000010f93e
- (void)clearPunchoutOptions;	// IMP=0x000000000010f921
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001abfe6
