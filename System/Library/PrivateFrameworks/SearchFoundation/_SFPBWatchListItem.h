...
- (void).cxx_destruct;	// IMP=0x0000000000091522
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000090edf
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000090e21
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000908f5
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008fd12
- (void)writeTo:(id)arg1;	// IMP=0x000000000008fa86
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000008fa79
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001da49a
