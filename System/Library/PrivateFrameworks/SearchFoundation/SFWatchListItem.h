...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002dae5
- (void).cxx_destruct;	// IMP=0x000000000002df42
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002dd06
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002dbb7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002db05
- (_Bool)hasIsMediaContainer;	// IMP=0x000000000002dafa
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001da8f2
