...
@interface SFCompactRowCardSection <SFCompactRowCardSection, NSSecureCoding, NSCopying>
{
    ...
    _Bool _isSubtitleDetatched;	// 15 = 0xf
    ...
    SFImage *_image;	// 80 = 0x50
}

+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ee63b
- (void).cxx_destruct;	// IMP=0x00000000001ee5a4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ee001
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ede67
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001edd18
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001edc66
- (_Bool)hasIsSubtitleDetatched;	// IMP=0x00000000001edc51
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001edc21
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001edbf1
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001edbc2
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001edb95
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000019398
