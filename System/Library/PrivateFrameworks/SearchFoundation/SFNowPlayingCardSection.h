...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000017e36
- (void).cxx_destruct;	// IMP=0x0000000000017d9f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017ab3
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000017964
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000178b2
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000001789d
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000001786d
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001783e
- (_Bool)hasCanBeHidden;	// IMP=0x0000000000017811
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001f0770
