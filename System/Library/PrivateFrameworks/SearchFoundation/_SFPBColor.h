...
- (void).cxx_destruct;	// IMP=0x000000000006e340
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000006dfc9
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000006df0b
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000006dad9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006d478
- (void)writeTo:(id)arg1;	// IMP=0x000000000006d32c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006d31f
@property(retain, nonatomic) _SFPBCalendarColor *calendarColor; // @synthesize calendarColor=_calendarColor;
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001c3cad
