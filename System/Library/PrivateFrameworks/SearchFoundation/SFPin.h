...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001dd371
- (void).cxx_destruct;	// IMP=0x00000000001dd6ec
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001dd592
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001dd443
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001dd391
- (_Bool)hasPinBehavior;	// IMP=0x00000000001dd386
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000017514
