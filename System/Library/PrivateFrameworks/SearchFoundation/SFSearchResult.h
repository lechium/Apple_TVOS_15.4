...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ce0af
- (void).cxx_destruct;	// IMP=0x00000000001cd95e
...
- (void)updatePunchout;	// IMP=0x00000000001ccea5
- (_Bool)compareWithResult:(id)arg1 logger:(CDUnknownBlockType)arg2;	// IMP=0x00000000001ca3dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ca2d8
- (id)initWithSearchResult:(id)arg1;	// IMP=0x00000000001c9330
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c8a74
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c765b
