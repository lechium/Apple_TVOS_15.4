...
@interface SFMediaInfoCardSection <SFMediaInfoCardSection, NSSecureCoding, NSCopying>
{
    ...
    _Bool _isMediaContainer;	// 15 = 0xf
    ...
    SFMediaItem *_mediaItem;	// 64 = 0x40
    NSArray *_details;	// 72 = 0x48
    SFActionItem *_playAction;	// 80 = 0x50
    NSArray *_offers;	// 88 = 0x58
    NSString *_watchListIdentifier;	// 96 = 0x60
    NSString *_watchListButtonLabel;	// 104 = 0x68
    NSString *_watchListContinuationText;	// 112 = 0x70
    NSString *_watchListConfirmationText;	// 120 = 0x78
    SFRichText *_specialOfferButtonLabel;	// 128 = 0x80
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001117c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010804
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000105aa
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001045b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000103a9
- (_Bool)hasIsMediaContainer;	// IMP=0x0000000000010394
- (_Bool)hasSeparatorStyle;	// IMP=0x0000000000010364
- (_Bool)hasHasBottomPadding;	// IMP=0x0000000000010334
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000010305
- (_Bool)hasCanBeHidden;	// IMP=0x00000000000102d8
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001b5537
