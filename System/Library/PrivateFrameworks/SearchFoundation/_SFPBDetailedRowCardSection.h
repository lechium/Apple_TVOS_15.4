...
- (void).cxx_destruct;	// IMP=0x000000000010e76f
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000010d476
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000010d3b8
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000010bf96
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010a88c
- (void)writeTo:(id)arg1;	// IMP=0x000000000010a113
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000010a106
- (id)buttonItemsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000010a0c5
- (unsigned long long)buttonItemsCount;	// IMP=0x000000000010a0a8
- (void)addButtonItems:(id)arg1;	// IMP=0x000000000010a02e
- (void)clearButtonItems;	// IMP=0x000000000010a011
- (id)descriptionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000109f38
- (unsigned long long)descriptionsCount;	// IMP=0x0000000000109f1b
- (void)addDescriptions:(id)arg1;	// IMP=0x0000000000109ea1
- (void)clearDescriptions;	// IMP=0x0000000000109e84
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000109cd3
- (unsigned long long)punchoutOptionsCount;	// IMP=0x0000000000109cb6
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x0000000000109c3c
- (void)clearPunchoutOptions;	// IMP=0x0000000000109c1f
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001ae868
