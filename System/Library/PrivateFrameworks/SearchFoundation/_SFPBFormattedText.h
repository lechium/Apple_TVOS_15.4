...
- (void).cxx_destruct;	// IMP=0x0000000000080eb6
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000080ba2
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000080ae4
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000008070b
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000080353
- (void)writeTo:(id)arg1;	// IMP=0x0000000000080246
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000080239
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001ec874
