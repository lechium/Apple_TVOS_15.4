...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000007847a
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000783bc
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000777f7
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000076447
- (void)writeTo:(id)arg1;	// IMP=0x000000000007602c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000007601f
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001d2b50
