...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001a9a9c
- (void).cxx_destruct;	// IMP=0x00000000001a9a89
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a9878
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a97db
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a968c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a95c6
- (_Bool)hasSecondaryColor;	// IMP=0x00000000001a95b1
- (_Bool)hasPrimaryColor;	// IMP=0x00000000001a9581
- (_Bool)hasBackgroundColor;	// IMP=0x00000000001a9552
- (_Bool)hasPunchThroughBackground;	// IMP=0x00000000001a9525
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001f16c8
