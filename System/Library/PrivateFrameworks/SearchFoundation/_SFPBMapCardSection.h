...
- (void).cxx_destruct;	// IMP=0x000000000014e7f3
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000014daba
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000014d9fc
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000014cca9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014bdac
- (void)writeTo:(id)arg1;	// IMP=0x000000000014b896
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000014b889
- (id)pinsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000014b86c
- (unsigned long long)pinsCount;	// IMP=0x000000000014b84f
- (void)addPins:(id)arg1;	// IMP=0x000000000014b7d5
- (void)clearPins;	// IMP=0x000000000014b7b8
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000014b5a3
- (unsigned long long)punchoutOptionsCount;	// IMP=0x000000000014b586
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x000000000014b50c
- (void)clearPunchoutOptions;	// IMP=0x000000000014b4ef
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000000281a6
