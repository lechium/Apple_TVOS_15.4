...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000054183
- (void).cxx_destruct;	// IMP=0x0000000000054075
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000053709
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005345a
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005330b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000053259
- (_Bool)hasCardPaddingBottom;	// IMP=0x0000000000053246
- (_Bool)hasValueNoWrap;	// IMP=0x0000000000053216
- (_Bool)hasKeyNoWrap;	// IMP=0x00000000000531e6
- (_Bool)hasImageIsRightAligned;	// IMP=0x00000000000531b6
- (_Bool)hasSeparatorStyle;	// IMP=0x0000000000053186
- (_Bool)hasHasBottomPadding;	// IMP=0x0000000000053156
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000053127
- (_Bool)hasCanBeHidden;	// IMP=0x00000000000530fa
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000019084e
