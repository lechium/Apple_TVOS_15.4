...
@interface SFButtonCardSection <SFButtonCardSection, NSSecureCoding, NSCopying>
{
    ...
    SFImage *_thumbnail;	// 72 = 0x48
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002dadd
- (void).cxx_destruct;	// IMP=0x000000000002da57
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d56a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d3f0
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002d2a1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002d1ef
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000002d1da
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000002d1aa
- (_Bool)hasHasTopPadding;	// IMP=0x000000000002d17b
- (_Bool)hasCanBeHidden;	// IMP=0x000000000002d14e
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001a6d2a
