...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001bea41
- (void).cxx_destruct;	// IMP=0x00000000001bede6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bec62
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001beb13
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bea61
- (_Bool)hasMediaType;	// IMP=0x00000000001bea56
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001a9fe9
