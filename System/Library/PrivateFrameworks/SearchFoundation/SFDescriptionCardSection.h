...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000037d4
- (void).cxx_destruct;	// IMP=0x00000000000036a4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000030f2
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002fa3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002ef1
- (_Bool)hasTextAlign;	// IMP=0x0000000000002ede
- (_Bool)hasImageAlign;	// IMP=0x0000000000002eae
- (_Bool)hasDescriptionExpand;	// IMP=0x0000000000002e7e
- (_Bool)hasTitleNoWrap;	// IMP=0x0000000000002e4e
- (_Bool)hasSeparatorStyle;	// IMP=0x0000000000002e1e
- (_Bool)hasHasBottomPadding;	// IMP=0x0000000000002dee
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000002dbf
- (_Bool)hasCanBeHidden;	// IMP=0x0000000000002d92
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000189bc3
