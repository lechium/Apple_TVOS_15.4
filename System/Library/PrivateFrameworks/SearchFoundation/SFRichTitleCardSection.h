...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018d482
- (void).cxx_destruct;	// IMP=0x000000000018d2ca
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018ca56
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018c907
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018c855
- (_Bool)hasSubtitleIsEmphasized;	// IMP=0x000000000018c83f
- (_Bool)hasPlayActionAlign;	// IMP=0x000000000018c80d
- (_Bool)hasThumbnailCropCircle;	// IMP=0x000000000018c7db
- (_Bool)hasTitleNoWrap;	// IMP=0x000000000018c7aa
- (_Bool)hasTitleAlign;	// IMP=0x000000000018c77b
- (_Bool)hasHideVerticalDivider;	// IMP=0x000000000018c74c
- (_Bool)hasAuxiliaryBottomTextColor;	// IMP=0x000000000018c71c
- (_Bool)hasReviewNewLine;	// IMP=0x000000000018c6ec
- (_Bool)hasIsCentered;	// IMP=0x000000000018c6bc
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000018c68c
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000018c65c
- (_Bool)hasHasTopPadding;	// IMP=0x000000000018c62d
- (_Bool)hasCanBeHidden;	// IMP=0x000000000018c600
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001e1218
