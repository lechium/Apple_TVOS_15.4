...
@interface SFScoreboardCardSection <SFScoreboardCardSection, NSSecureCoding, NSCopying>
{
    ...
    SFSportsTeam *_team1;	// 80 = 0x50
    SFSportsTeam *_team2;	// 88 = 0x58
    NSString *_accessibilityDescription;	// 96 = 0x60
    NSString *_eventStatus;	// 104 = 0x68
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018c5dd
- (void).cxx_destruct;	// IMP=0x000000000018c513
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018c168
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018c019
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018bf67
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000018bf52
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000018bf22
- (_Bool)hasHasTopPadding;	// IMP=0x000000000018bef3
- (_Bool)hasCanBeHidden;	// IMP=0x000000000018bec6
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001dc009
