...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000006b64
- (void).cxx_destruct;	// IMP=0x0000000000006e85
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006d6d
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000006c1e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000006b6c
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000000067de
