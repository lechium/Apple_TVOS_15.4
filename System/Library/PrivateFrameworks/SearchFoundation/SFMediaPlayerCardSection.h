...
@interface SFMediaPlayerCardSection <SFMediaPlayerCardSection, NSSecureCoding, NSCopying>
{
...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001ee2b
- (void).cxx_destruct;	// IMP=0x000000000001ed94
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001e82c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001e693
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001e544
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001e492
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000001e47d
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000001e44d
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001e41e
- (_Bool)hasCanBeHidden;	// IMP=0x000000000001e3f1
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000018b779
