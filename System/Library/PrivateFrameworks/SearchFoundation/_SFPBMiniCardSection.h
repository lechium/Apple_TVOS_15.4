...
- (void).cxx_destruct;	// IMP=0x00000000000dd9ec
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000dd166
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000dd0a8
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000dc7ab
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000dbccd
- (void)writeTo:(id)arg1;	// IMP=0x00000000000db965
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000db958
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000db80f
- (unsigned long long)punchoutOptionsCount;	// IMP=0x00000000000db7f2
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x00000000000db778
- (void)clearPunchoutOptions;	// IMP=0x00000000000db75b
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000013c84
