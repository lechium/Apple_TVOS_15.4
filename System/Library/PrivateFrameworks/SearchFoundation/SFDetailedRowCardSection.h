...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018f127
- (void).cxx_destruct;	// IMP=0x000000000018efe6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018e4e7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018e1d2
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018e083
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018dfd1
- (_Bool)hasButtonItemsAreTrailing;	// IMP=0x000000000018dfbe
- (_Bool)hasShouldUseCompactDisplay;	// IMP=0x000000000018df8e
- (_Bool)hasIsSecondaryTitleDetached;	// IMP=0x000000000018df5e
- (_Bool)hasPreventThumbnailImageScaling;	// IMP=0x000000000018df2e
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000018defe
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000018dece
- (_Bool)hasHasTopPadding;	// IMP=0x000000000018de9f
- (_Bool)hasCanBeHidden;	// IMP=0x000000000018de72
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001af6c6
