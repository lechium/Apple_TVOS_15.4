...
- (void).cxx_destruct;	// IMP=0x00000000000ed746
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000ece42
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000ecd84
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000ec424
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000eb8f8
- (void)writeTo:(id)arg1;	// IMP=0x00000000000eb56a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000eb55d
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000eb404
- (unsigned long long)punchoutOptionsCount;	// IMP=0x00000000000eb3e7
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x00000000000eb36d
- (void)clearPunchoutOptions;	// IMP=0x00000000000eb350
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000018d6d
