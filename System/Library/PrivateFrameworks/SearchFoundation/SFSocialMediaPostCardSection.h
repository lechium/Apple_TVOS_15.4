...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d5501
- (void).cxx_destruct;	// IMP=0x00000000001d5404
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d4b8e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d4929
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d47da
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d4728
- (_Bool)hasNameNoWrap;	// IMP=0x00000000001d4713
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001d46e3
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001d46b3
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001d4684
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001d4657
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001c4b6d
