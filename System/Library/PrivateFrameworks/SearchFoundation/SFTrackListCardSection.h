...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018b091
- (void).cxx_destruct;	// IMP=0x000000000018affa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018ad0e
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018abbf
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018ab0d
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000018aaf8
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000018aac8
- (_Bool)hasHasTopPadding;	// IMP=0x000000000018aa99
- (_Bool)hasCanBeHidden;	// IMP=0x000000000018aa6c
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000000a85e
