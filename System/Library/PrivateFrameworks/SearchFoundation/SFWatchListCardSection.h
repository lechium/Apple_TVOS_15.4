...
@interface SFWatchListCardSection <SFWatchListCardSection, NSSecureCoding, NSCopying>
{
    ...
    SFWatchListItem *_watchListItem;	// 64 = 0x40
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001d96b
- (void).cxx_destruct;	// IMP=0x000000000001d8f6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001d482
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001d32b
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001d1dc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d12a
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000001d115
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000001d0e5
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001d0b6
- (_Bool)hasCanBeHidden;	// IMP=0x000000000001d089
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000019a32d
