...
- (void).cxx_destruct;	// IMP=0x00000000001077f1
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000106dae
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000106cf0
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000106260
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001055c6
- (void)writeTo:(id)arg1;	// IMP=0x00000000001051dc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001051cf
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000105032
- (unsigned long long)punchoutOptionsCount;	// IMP=0x0000000000105015
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x0000000000104f9b
- (void)clearPunchoutOptions;	// IMP=0x0000000000104f7e
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000019e2d4
