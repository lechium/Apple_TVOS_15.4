...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001be021
- (void).cxx_destruct;	// IMP=0x00000000001bdf79
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bd93d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bd761
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bd612
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bd560
- (_Bool)hasSuggestionType;	// IMP=0x00000000001bd54b
- (_Bool)hasIsContact;	// IMP=0x00000000001bd51b
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001bd4eb
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001bd4bb
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001bd48c
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001bd45f
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000019e96a
