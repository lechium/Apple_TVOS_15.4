...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d270d
- (void).cxx_destruct;	// IMP=0x00000000001d2ae6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d2916
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d27c7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d2715
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000000287b
