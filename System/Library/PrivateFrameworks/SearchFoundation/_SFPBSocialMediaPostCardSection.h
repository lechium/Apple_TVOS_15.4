...
- (void).cxx_destruct;	// IMP=0x000000000012e12a
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000012d482
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000012d3c4
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000012c7b0
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012b6c9
- (void)writeTo:(id)arg1;	// IMP=0x000000000012b1fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012b1ee
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000012afa1
- (unsigned long long)punchoutOptionsCount;	// IMP=0x000000000012af84
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x000000000012af0a
- (void)clearPunchoutOptions;	// IMP=0x000000000012aeed
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001c42cc
