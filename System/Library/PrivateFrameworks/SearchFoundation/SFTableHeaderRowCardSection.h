...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000191aa9
- (void).cxx_destruct;	// IMP=0x0000000000191a01
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000191665
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000191516
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000191464
- (_Bool)hasAlignRowsToHeader;	// IMP=0x0000000000191451
- (_Bool)hasVerticalAlign;	// IMP=0x0000000000191421
- (_Bool)hasReducedRowHeight;	// IMP=0x00000000001913f1
- (_Bool)hasIsSubHeader;	// IMP=0x00000000001913c1
- (_Bool)hasSeparatorStyle;	// IMP=0x0000000000191391
- (_Bool)hasHasBottomPadding;	// IMP=0x0000000000191361
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000191332
- (_Bool)hasCanBeHidden;	// IMP=0x0000000000191305
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000029f90
