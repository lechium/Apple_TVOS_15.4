...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000183a3f
- (void).cxx_destruct;	// IMP=0x000000000018397f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001832bd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000183108
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000182fb9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000182f07
- (_Bool)hasFlexibleSectionOrder;	// IMP=0x0000000000182ef9
- (_Bool)hasQueryId;	// IMP=0x0000000000182ede
- (_Bool)hasSource;	// IMP=0x0000000000182ec3
- (_Bool)hasType;	// IMP=0x0000000000182eab
- (void)loadCardSectionsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000023220
- (void)loadCardSectionsWithCompletionAndErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000231a1
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001f78c1
