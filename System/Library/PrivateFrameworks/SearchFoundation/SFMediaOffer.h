...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000188065
- (void).cxx_destruct;	// IMP=0x0000000000188012
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000187e91
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000187d42
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000187c90
- (_Bool)hasIsEnabled;	// IMP=0x0000000000187c7e
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000001f09e
