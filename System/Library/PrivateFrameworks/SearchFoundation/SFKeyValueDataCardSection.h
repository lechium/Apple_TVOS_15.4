...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000e4b0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000df40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000ddc6
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000dc77
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000dbc5
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000000dbb0
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000000db80
- (_Bool)hasHasTopPadding;	// IMP=0x000000000000db51
- (_Bool)hasCanBeHidden;	// IMP=0x000000000000db24
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000000123d7
