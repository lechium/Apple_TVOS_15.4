...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001c5f1c
- (void).cxx_destruct;	// IMP=0x00000000001c61e1
@property(copy, nonatomic) NSArray *availability; // @synthesize availability=_availability;
@property(copy, nonatomic) NSString *productIdentifier; // @synthesize productIdentifier=_productIdentifier;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c6125
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c5fd6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c5f24
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000001c414
