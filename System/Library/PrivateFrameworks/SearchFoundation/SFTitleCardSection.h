...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001bbe8
- (void).cxx_destruct;	// IMP=0x000000000001bb62
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b645
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b4bd
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b36e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b2bc
- (_Bool)hasIsCentered;	// IMP=0x000000000001b2a7
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000001b277
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000001b247
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001b218
- (_Bool)hasCanBeHidden;	// IMP=0x000000000001b1eb
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001a2e93
