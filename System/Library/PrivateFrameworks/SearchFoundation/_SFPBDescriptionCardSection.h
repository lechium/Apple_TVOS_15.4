...
- (void).cxx_destruct;	// IMP=0x0000000000154e0e
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000153d0e
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000153c50
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x0000000000152ba3
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000015186a
- (void)writeTo:(id)arg1;	// IMP=0x000000000015121a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000015120d
- (id)richDescriptionsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001511f0
- (unsigned long long)richDescriptionsCount;	// IMP=0x00000000001511d3
- (void)addRichDescriptions:(id)arg1;	// IMP=0x0000000000151159
- (void)clearRichDescriptions;	// IMP=0x000000000015113c
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000150e6b
- (unsigned long long)punchoutOptionsCount;	// IMP=0x0000000000150e4e
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x0000000000150dd4
- (void)clearPunchoutOptions;	// IMP=0x0000000000150db7
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000018905d
