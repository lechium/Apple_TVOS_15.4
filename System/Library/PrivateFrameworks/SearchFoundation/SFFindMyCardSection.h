...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ae860
- (void).cxx_destruct;	// IMP=0x00000000001ae84d
@property(retain, nonatomic) SFPerson *person; // @synthesize person=_person;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ae712
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ae6ad
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ae55e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ae4ac
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001be12b
