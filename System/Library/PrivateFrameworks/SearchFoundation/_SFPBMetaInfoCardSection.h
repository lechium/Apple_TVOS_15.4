...
- (void).cxx_destruct;	// IMP=0x00000000001003c1
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000ffa92
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000000ff9d4
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x00000000000ff072
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fe543
- (void)writeTo:(id)arg1;	// IMP=0x00000000000fe1b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000fe1a8
- (id)punchoutOptionsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000fe04f
- (unsigned long long)punchoutOptionsCount;	// IMP=0x00000000000fe032
- (void)addPunchoutOptions:(id)arg1;	// IMP=0x00000000000fdfb8
- (void)clearPunchoutOptions;	// IMP=0x00000000000fdf9b
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000001f34ac
