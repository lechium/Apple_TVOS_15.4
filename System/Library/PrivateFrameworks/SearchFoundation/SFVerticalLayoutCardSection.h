...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001f6e4e
- (void).cxx_destruct;	// IMP=0x00000000001f6da6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f6793
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f65d9
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001f648a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001f63d8
- (_Bool)hasContentsLeading;	// IMP=0x00000000001f63c3
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001f6393
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001f6363
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001f6334
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001f6307
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001d9d41
