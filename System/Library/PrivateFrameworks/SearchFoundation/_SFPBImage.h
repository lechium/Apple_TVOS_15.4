...
- (void).cxx_destruct;	// IMP=0x000000000005e32b
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000005d566
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000005d4a8
@property(readonly, nonatomic) NSData *jsonData;
- (id)dictionaryRepresentation;	// IMP=0x000000000005c558
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005af95
- (void)writeTo:(id)arg1;	// IMP=0x000000000005aaaf
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000005aaa2
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000024881
