...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d7a2e
- (void).cxx_destruct;	// IMP=0x00000000001d79a8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d748d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d7312
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d71c3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d7111
- (_Bool)hasTitleWeight;	// IMP=0x00000000001d70fc
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001d70cb
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001d709b
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001d706c
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001d703f
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001c26ab
