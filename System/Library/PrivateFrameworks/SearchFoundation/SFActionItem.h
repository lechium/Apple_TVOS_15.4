...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019c583
- (void).cxx_destruct;	// IMP=0x000000000019c450
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019b951
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019b662
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019b513
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019b461
- (_Bool)hasDirectionsMode;	// IMP=0x000000000019b455
- (_Bool)hasShouldSearchDirectionsAlongCurrentRoute;	// IMP=0x000000000019b43a
- (_Bool)hasMediaEntityType;	// IMP=0x000000000019b41f
- (_Bool)hasIsITunes;	// IMP=0x000000000019b404
- (_Bool)hasLongitude;	// IMP=0x000000000019b3e9
- (_Bool)hasLatitude;	// IMP=0x000000000019b3cc
- (_Bool)hasRequiresLocalMedia;	// IMP=0x000000000019b3b0
- (_Bool)hasIsOverlay;	// IMP=0x000000000019b398
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000181f66
