...
@interface SFStrokeAnimationCardSection <SFStrokeAnimationCardSection, NSSecureCoding, NSCopying>
{
    ...
    NSString *_strokeAnimationRepresentation;	// 64 = 0x40
    NSArray *_strokeNames;	// 72 = 0x48
    NSArray *_characters;	// 80 = 0x50
    NSArray *_pronunciations;	// 88 = 0x58
}

+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001fb9
- (void).cxx_destruct;	// IMP=0x0000000000001f11
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000192e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000001775
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001626
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001574
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000000155f
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000000152f
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000001500
- (_Bool)hasCanBeHidden;	// IMP=0x00000000000014d3
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000004e28
