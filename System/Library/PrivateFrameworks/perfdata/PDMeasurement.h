...
- (void).cxx_destruct;	// IMP=0x0000000000009f7a
...
- (_Bool)enumeratePercentilesWithError:(id *)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000099fd
@property(readonly, nonatomic) unsigned long long percentileCount;
- (_Bool)enumerateHistogramBucketsWithError:(id *)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000009495
@property(readonly, nonatomic) unsigned long long histogramBucketCount;
- (_Bool)isComparableTo:(id)arg1 ignoringNullableVariables:(id)arg2;	// IMP=0x00000000000090f5
- (_Bool)isComparableTo:(id)arg1 ignoringVariables:(id)arg2;	// IMP=0x00000000000090e3
- (_Bool)isLike:(id)arg1;	// IMP=0x0000000000009082
- (_Bool)isComparableTo:(id)arg1;	// IMP=0x000000000000906e
- (id)metricFilterIgnoringNullableVariables:(id)arg1;	// IMP=0x0000000000008d4f
- (id)metricFilterIgnoringVariables:(id)arg1;	// IMP=0x0000000000008d3d
- (id)metricFilter;	// IMP=0x0000000000008cb8
- (_Bool)matchesVariables:(id)arg1 ignoringMissing:(_Bool)arg2;	// IMP=0x0000000000008a53
- (_Bool)matchesMetricFilter:(id)arg1;	// IMP=0x0000000000008931
- (id)description;	// IMP=0x000000000000889e
- (id)initWithContainer:(id)arg1 dictionary:(id)arg2 group:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x00000000000050ca
