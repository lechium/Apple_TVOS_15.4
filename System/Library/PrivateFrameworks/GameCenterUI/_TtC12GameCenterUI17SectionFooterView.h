...
- (void).cxx_destruct;	// IMP=0x000000000027e0e0
...
- (void)prepareForReuse;	// IMP=0x000000000027ca00
- (void)handleTapWithGestureRecognizer:(id)arg1;	// IMP=0x000000000027c640
- (void)layoutSubviews;	// IMP=0x000000000027c550
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x000000000027bca0
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000027b8b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000027b880
