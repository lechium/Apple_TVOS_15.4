...
+ (struct CGSize)platformSizeForTitle:(id)arg1 withFont:(id)arg2;	// IMP=0x0000000000007c9c
+ (double)widthForTitle:(id)arg1 withFont:(id)arg2;	// IMP=0x0000000000007b2a
+ (double)defaultHeight;	// IMP=0x0000000000007b1c
- (void).cxx_destruct;	// IMP=0x0000000000007f93
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000007e64
@property(copy, nonatomic) UIFont *font; // @dynamic font;
@property(copy, nonatomic) NSString *title; // @dynamic title;
- (void)awakeFromNib;	// IMP=0x0000000000007ce7
