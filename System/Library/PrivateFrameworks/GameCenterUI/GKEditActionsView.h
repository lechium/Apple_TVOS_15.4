...
- (void).cxx_destruct;	// IMP=0x00000000000a3a9f
...
- (void)didTouchMoreEditAction:(id)arg1;	// IMP=0x00000000000a3597
- (void)didTouchEditAction:(id)arg1;	// IMP=0x00000000000a348e
- (void)prepareActionButtons;	// IMP=0x00000000000a28bb
- (id)initWithFrame:(struct CGRect)arg1 cell:(id)arg2;	// IMP=0x00000000000a2631
