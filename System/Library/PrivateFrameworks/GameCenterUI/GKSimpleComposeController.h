...
- (void).cxx_destruct;	// IMP=0x00000000000f5e83
...
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000f5c74
- (void)donePressed;	// IMP=0x00000000000f5bc8
- (void)pushOntoNavigationController:(id)arg1 withDoneHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f5b62
- (void)setupSendButton;	// IMP=0x00000000000f5a43
- (void)loadView;	// IMP=0x00000000000f5a02
