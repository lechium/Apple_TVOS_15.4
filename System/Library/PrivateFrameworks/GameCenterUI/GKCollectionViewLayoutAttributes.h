...
- (void).cxx_destruct;	// IMP=0x00000000000835a7
...
- (unsigned long long)hash;	// IMP=0x0000000000083395
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000083199
- (id)description;	// IMP=0x0000000000082e18
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000082c6f
- (id)init;	// IMP=0x0000000000082c30
