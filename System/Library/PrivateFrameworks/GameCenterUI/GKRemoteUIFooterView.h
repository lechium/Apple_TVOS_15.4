...
- (void).cxx_destruct;	// IMP=0x0000000000007b09
...
- (id)attributedStringForString:(id)arg1 withStyle:(id)arg2;	// IMP=0x0000000000007704
- (double)footerHeightForWidth:(double)arg1 inTableView:(id)arg2;	// IMP=0x0000000000007553
- (id)initWithAttributes:(id)arg1;	// IMP=0x0000000000006e77
