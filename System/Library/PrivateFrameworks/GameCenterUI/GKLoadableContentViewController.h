...
- (void).cxx_destruct;	// IMP=0x000000000001e82f
...
- (void)didExitLoadedState;	// IMP=0x000000000001e7aa
- (void)didEnterLoadedState;	// IMP=0x000000000001e7a4
- (void)didExitLoadingState;	// IMP=0x000000000001e671
- (void)didEnterLoadingState;	// IMP=0x000000000001e240
@property(retain, nonatomic) NSString *loadingState;
- (id)init;	// IMP=0x000000000001e011
