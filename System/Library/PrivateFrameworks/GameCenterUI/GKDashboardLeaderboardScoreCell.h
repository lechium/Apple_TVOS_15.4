...
+ (id)highRankNib;	// IMP=0x0000000000082604
+ (id)lowRankNib;	// IMP=0x00000000000825e3
+ (struct CGSize)defaultSize;	// IMP=0x00000000000825cd
- (void).cxx_destruct;	// IMP=0x0000000000082bfc
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000082a41
@property(nonatomic) _Bool linesVisible; // @dynamic linesVisible;
- (void)setupForScore:(id)arg1;	// IMP=0x0000000000082860
@property(readonly, nonatomic) UIView *popoverSourceView;
- (void)awakeFromNib;	// IMP=0x0000000000082625
