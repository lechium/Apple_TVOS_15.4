...
+ (id)supplementaryMetrics;	// IMP=0x0000000000087c0d
- (void).cxx_destruct;	// IMP=0x0000000000088172
...
- (struct CGSize)sizeForCollectionView:(id)arg1;	// IMP=0x0000000000087fde
- (id)description;	// IMP=0x0000000000087fcc
- (id)localDescription;	// IMP=0x0000000000087d86
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000087c73
- (id)init;	// IMP=0x0000000000087c26
