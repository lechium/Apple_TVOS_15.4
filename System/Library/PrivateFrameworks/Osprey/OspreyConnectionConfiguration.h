...
- (void).cxx_destruct;	// IMP=0x00000000000049d2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004949
- (unsigned long long)hash;	// IMP=0x000000000000490a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004835
