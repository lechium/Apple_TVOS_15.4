...
+ (id)requestWithMethodName:(id)arg1;	// IMP=0x0000000000005594
- (void).cxx_destruct;	// IMP=0x0000000000005c61
...
- (id)grpcRequestWithBaseURL:(id)arg1;	// IMP=0x00000000000055e1
- (id)initWithMethodName:(id)arg1;	// IMP=0x00000000000054d9
