...
- (void).cxx_destruct;	// IMP=0x000000000000547a
...
- (void)deleteDeviceAttestationData;	// IMP=0x0000000000005379
- (id)deviceAttestationData;	// IMP=0x00000000000052ba
- (_Bool)setDeviceAttestationData:(id)arg1 withExpiration:(id)arg2;	// IMP=0x0000000000005169
@property(readonly, nonatomic) _Bool isDeviceAttestionExpired;
- (id)_deviceAttestationDataKey;	// IMP=0x00000000000050e0
- (void)deleteCertificateData;	// IMP=0x0000000000005044
@property(retain, nonatomic) NSData *certificateData;
- (id)_certificateDataKey;	// IMP=0x0000000000004edd
- (void)resetCachedDeviceAttestation;	// IMP=0x0000000000004e86
- (void)deleteAll;	// IMP=0x0000000000004e58
- (id)dictionaryRepresentation;	// IMP=0x0000000000004dcd
- (id)initWithDictionary:(id)arg1 keychain:(id)arg2;	// IMP=0x0000000000004cae
- (id)initWithConnectionHost:(id)arg1 keychain:(id)arg2;	// IMP=0x0000000000004bcf
