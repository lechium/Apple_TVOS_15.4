...
- (void).cxx_destruct;	// IMP=0x0000000000006ea0
...
- (id)calculateDuration:(id)arg1 and:(id)arg2;	// IMP=0x0000000000006d6b
- (void)setAbsintheConnectionMethodWith:(id)arg1;	// IMP=0x0000000000006d24
- (void)setAbsintheAuthenticationTimestampForKey:(id)arg1;	// IMP=0x0000000000006c14
- (void)reportAbsintheAuthenticationDurations;	// IMP=0x0000000000006867
- (id)init;	// IMP=0x00000000000067f2
