...
+ (id)rootURL;	// IMP=0x0000000000024d24
+ (id)frameworkPaths;	// IMP=0x0000000000024c78
- (void).cxx_destruct;	// IMP=0x0000000000026b2e
...
- (void)main;	// IMP=0x0000000000026688
- (void)processExtensionsInDirectory:(id)arg1;	// IMP=0x000000000002643b
- (void)processExtensionsFromBundle:(struct __CFBundle *)arg1;	// IMP=0x00000000000263c5
- (void)processExtensionSDK:(id)arg1 declaringURL:(id)arg2;	// IMP=0x0000000000025f46
- (void)processExtensionSDKFromFile:(id)arg1;	// IMP=0x0000000000025d65
- (void)processExtensionSDKFromBundle:(struct __CFBundle *)arg1;	// IMP=0x0000000000025caa
- (void)enumerateFrameworksBundlesWithFrameworkURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000025ad6
- (void)enumerateAppexptAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000000256c2
- (void)enumerateBundlesWithPathExtension:(id)arg1 atURL:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000025294
- (_Bool)isAppleInternalURL:(id)arg1;	// IMP=0x000000000002508a
- (_Bool)isCatalystSupportURL:(id)arg1;	// IMP=0x0000000000024f68
...
- (id)initWithSourceURL:(id)arg1;	// IMP=0x0000000000024de3
