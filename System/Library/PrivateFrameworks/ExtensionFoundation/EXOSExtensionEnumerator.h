...
+ (void)enumerateExtensionsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000002dbfa
- (void).cxx_destruct;	// IMP=0x000000000002e90e
...
- (id)nextObject;	// IMP=0x000000000002e872
- (id)initWithCacheURLs:(id)arg1 paths:(id)arg2;	// IMP=0x000000000002e1ef
- (id)initWithCacheURLs:(id)arg1;	// IMP=0x000000000002e1d6
