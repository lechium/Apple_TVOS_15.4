...
- (void).cxx_destruct;	// IMP=0x000000000002f9d6
...
- (id)description;	// IMP=0x000000000002f8e2
- (void)update;	// IMP=0x000000000002f249
- (void)removeObserver:(id)arg1;	// IMP=0x000000000002f1d7
- (void)addObserver:(id)arg1;	// IMP=0x000000000002f165
@property(readonly) NSSet *observers;
- (unsigned long long)hash;	// IMP=0x000000000002f103
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f0a0
- (_Bool)isEqualToActiveQuery:(id)arg1;	// IMP=0x000000000002f086
- (id)initWithQuery:(id)arg1 discoveryController:(id)arg2;	// IMP=0x000000000002efb2
