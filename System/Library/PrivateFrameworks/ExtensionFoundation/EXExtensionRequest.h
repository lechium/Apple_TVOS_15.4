...
- (void).cxx_destruct;	// IMP=0x0000000000024c26
...
- (id)description;	// IMP=0x0000000000024a9a
- (void)dealloc;	// IMP=0x0000000000024a40
- (id)init;	// IMP=0x00000000000249ea
- (void)applyActiveWebPageAlternativeIfNeededForExtension:(id)arg1;	// IMP=0x0000000000016148
