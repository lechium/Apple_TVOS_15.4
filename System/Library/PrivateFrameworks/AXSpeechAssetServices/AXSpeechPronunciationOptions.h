...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001b1e
- (void).cxx_destruct;	// IMP=0x0000000000001d98
@property(retain, nonatomic) NSString *language; // @synthesize language=_language;
@property(retain, nonatomic) NSString *orthography; // @synthesize orthography=_orthography;
- (id)description;	// IMP=0x0000000000001ccf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001c21
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001b26
