...
- (void).cxx_destruct;	// IMP=0x000000000012509b
...
- (void)home:(id)arg1 didRemoveRoom:(id)arg2 fromZone:(id)arg3;	// IMP=0x0000000000124ee0
- (void)home:(id)arg1 didAddRoom:(id)arg2 toZone:(id)arg3;	// IMP=0x0000000000124e49
- (void)home:(id)arg1 didUpdateNameForZone:(id)arg2;	// IMP=0x0000000000124da9
- (void)home:(id)arg1 didRemoveZone:(id)arg2;	// IMP=0x0000000000124d09
- (void)home:(id)arg1 didAddZone:(id)arg2;	// IMP=0x0000000000124c69
- (void)_reloadItemProviders;	// IMP=0x0000000000124bbb
- (_Bool)canExpand;	// IMP=0x0000000000124a98
- (_Bool)toggleExpansion;	// IMP=0x0000000000124a50
- (id)buildSectionsWithDisplayedItems:(id)arg1;	// IMP=0x00000000001243b4
- (id)initWithItemUpdater:(id)arg1 room:(id)arg2;	// IMP=0x000000000012372c
