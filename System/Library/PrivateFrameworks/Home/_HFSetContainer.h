...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x000000000025d1e3
- (void).cxx_destruct;	// IMP=0x000000000025d508
...
- (unsigned long long)hash;	// IMP=0x000000000025d3e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025d2af
