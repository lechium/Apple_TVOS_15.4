...
- (void).cxx_destruct;	// IMP=0x00000000001f0500
...
- (id)invalidationReasons;	// IMP=0x00000000001f03fa
- (id)items;	// IMP=0x00000000001f03e8
- (id)reloadItems;	// IMP=0x00000000001efd91
- (id)initWithHome:(id)arg1 personManager:(id)arg2;	// IMP=0x00000000001efcbe
