...
+ (id)sentinelWithKey:(id)arg1;	// IMP=0x0000000000163a25
- (void).cxx_destruct;	// IMP=0x0000000000163bdf
...
- (id)initWithCameraClip:(id)arg1 operation:(id)arg2 key:(id)arg3;	// IMP=0x0000000000163a7b
