...
+ (id)_accessoryLikeObjectForObject:(id)arg1;	// IMP=0x0000000000235a8b
+ (id)objectMap;	// IMP=0x0000000000235a26
- (void).cxx_destruct;	// IMP=0x00000000002363ef
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0000000000236364
...
- (id)hf_parentRoom;	// IMP=0x00000000002361da
...
- (id)hf_representableAccessoryLikeObject;	// IMP=0x000000000023611f
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x0000000000235f2e
...
- (id)initWithHomeKitObject:(id)arg1;	// IMP=0x0000000000235b6a
