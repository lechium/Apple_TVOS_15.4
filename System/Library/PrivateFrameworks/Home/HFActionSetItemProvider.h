...
- (void).cxx_destruct;	// IMP=0x0000000000072ab3
...
- (CDUnknownBlockType)_favoriteFilter;	// IMP=0x000000000007290d
- (CDUnknownBlockType)_roomFilter;	// IMP=0x000000000007220e
@property(retain, nonatomic) id <HFCharacteristicValueSource> valueSource;
- (id)invalidationReasons;	// IMP=0x00000000000720e8
- (id)items;	// IMP=0x00000000000720d6
- (id)reloadItems;	// IMP=0x0000000000071bcd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000071a6e
- (id)initWithHome:(id)arg1 actionSetItemStyle:(unsigned long long)arg2;	// IMP=0x00000000000719bd
- (id)initWithHome:(id)arg1;	// IMP=0x00000000000719a6
