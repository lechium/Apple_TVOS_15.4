...
- (void).cxx_destruct;	// IMP=0x000000000014977f
...
- (id)description;	// IMP=0x000000000014966f
- (id)initWithWallpaper:(id)arg1 originalSlice:(id)arg2 processedSlice:(id)arg3;	// IMP=0x00000000001495b8
