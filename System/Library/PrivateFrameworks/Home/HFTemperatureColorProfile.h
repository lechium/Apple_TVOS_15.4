...
- (float)adjustedTemperatureForTemperature:(float)arg1;	// IMP=0x00000000000c1657
- (id)adjustedColorPrimitiveForPrimitive:(id)arg1;	// IMP=0x00000000000c1566
- (id)initWithMinimumTemperature:(float)arg1 maximumTemperature:(float)arg2;	// IMP=0x00000000000c1514
