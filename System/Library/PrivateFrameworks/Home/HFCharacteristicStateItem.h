...
+ (id)na_identity;	// IMP=0x000000000017390d
- (void).cxx_destruct;	// IMP=0x0000000000173f33
...
- (id)_subclass_updateWithOptions:(id)arg1;	// IMP=0x0000000000173b06
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000173a90
@property(readonly) unsigned long long hash;
- (id)init;	// IMP=0x0000000000173858
- (id)initWithCharacteristicType:(id)arg1 valueSource:(id)arg2 resultsProvider:(CDUnknownBlockType)arg3;	// IMP=0x00000000001736f3
