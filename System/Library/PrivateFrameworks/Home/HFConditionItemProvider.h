...
- (void).cxx_destruct;	// IMP=0x000000000025d0d9
...
- (id)reloadItems;	// IMP=0x000000000025cc84
- (id)items;	// IMP=0x000000000025cc72
- (id)initWithConditions:(id)arg1 home:(id)arg2;	// IMP=0x000000000025cb9f
- (id)init;	// IMP=0x000000000025caea
