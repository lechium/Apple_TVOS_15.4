...
+ (id)_createContainerSetFromArray:(id)arg1 options:(id)arg2;	// IMP=0x000000000025e6fd
+ (id)diffFromArray:(id)arg1 toArray:(id)arg2 options:(id)arg3;	// IMP=0x000000000025d53b
- (void).cxx_destruct;	// IMP=0x000000000025efd8
...
- (void)enumerateMovesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000025ed4c
- (void)enumerateChangesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000025ec81
- (void)enumerateDeletesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000025ebb1
- (void)enumerateInsertsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000025eae6
