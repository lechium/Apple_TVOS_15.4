...
- (void).cxx_destruct;	// IMP=0x00000000000501fb
...
- (void)assertConfigurationIsValid;	// IMP=0x000000000004ff8d
- (id)initWithHome:(id)arg1 cameraProfile:(id)arg2;	// IMP=0x000000000004feca
