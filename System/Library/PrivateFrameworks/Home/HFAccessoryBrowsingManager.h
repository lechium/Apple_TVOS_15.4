...
- (void).cxx_destruct;	// IMP=0x00000000001cc403
...
- (void)accessoryBrowser:(id)arg1 didRemoveNewAccessory:(id)arg2;	// IMP=0x00000000001cc16e
- (void)accessoryBrowser:(id)arg1 didFindNewAccessory:(id)arg2;	// IMP=0x00000000001cbf57
- (void)removeBrowsingObserver:(id)arg1;	// IMP=0x00000000001cbee5
- (void)addBrowsingObserver:(id)arg1;	// IMP=0x00000000001cbe73
- (void)stopSearchingForNewAccessoriesWithError:(id)arg1;	// IMP=0x00000000001cbd7a
- (void)startSearchingForNewAccessories;	// IMP=0x00000000001cbb54
@property(readonly, nonatomic) NSArray *discoveredSharingDevices;
@property(readonly, nonatomic) NSArray *discoveredHMAccessories;
- (id)init;	// IMP=0x00000000001cb380
