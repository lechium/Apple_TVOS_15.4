...
- (void).cxx_destruct;	// IMP=0x0000000000238275
...
- (id)invalidationReasons;	// IMP=0x0000000000238194
- (id)items;	// IMP=0x0000000000238182
- (id)reloadItems;	// IMP=0x0000000000237ec5
- (id)initWithHomeManager:(id)arg1;	// IMP=0x0000000000237e26
