...
- (void).cxx_destruct;	// IMP=0x00000000002a4b4c
...
- (id)initWithSystemImageName:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000002a4a9f
- (id)initWithSystemImageName:(id)arg1;	// IMP=0x00000000002a4a1e
