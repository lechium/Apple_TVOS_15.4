...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000db491
- (id)initWithFormattingContext:(long long)arg1 formattingStyle:(long long)arg2;	// IMP=0x00000000000db43b
