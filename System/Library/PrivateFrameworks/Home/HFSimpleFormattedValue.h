...
- (void).cxx_destruct;	// IMP=0x0000000000064256
...
- (id)observeFormattedValueChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000064233
@property(readonly, nonatomic) id value;
- (id)initWithFormattedValue:(id)arg1;	// IMP=0x00000000000641b6
