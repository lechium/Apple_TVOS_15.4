...
- (void).cxx_destruct;	// IMP=0x0000000000250f32
@property(copy, nonatomic) NSTimeZone *timeZone; // @synthesize timeZone;
- (void)triggerEnabledStateDidChange:(_Bool)arg1;	// IMP=0x0000000000250e48
- (void)copyCurrentStateFromTriggerBuilder:(id)arg1;	// IMP=0x0000000000250d22
