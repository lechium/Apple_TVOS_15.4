...
- (void).cxx_destruct;	// IMP=0x000000000024f062
...
- (void)_getTriggerName:(id)arg1 home:(id)arg2;	// IMP=0x000000000024eeb9
- (void)_updateWithTrigger:(id)arg1 inHome:(id)arg2 forceDisabled:(_Bool)arg3 ignoringDisabled:(_Bool)arg4;	// IMP=0x000000000024ec90
- (id)initWithTrigger:(id)arg1 inHome:(id)arg2 forceDisabled:(_Bool)arg3 ignoringDisabled:(_Bool)arg4;	// IMP=0x000000000024ebef
- (id)initWithTrigger:(id)arg1 inHome:(id)arg2 forceDisabled:(_Bool)arg3;	// IMP=0x000000000024eb54
