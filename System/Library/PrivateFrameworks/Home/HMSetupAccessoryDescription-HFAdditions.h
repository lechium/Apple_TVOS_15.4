...
- (void)hf_updateWithDiscoveredAccessory:(id)arg1;	// IMP=0x00000000000a2aa2
...
- (_Bool)hf_isLogitechCircleViewDoorbell;	// IMP=0x00000000000a2858
- (id)hf_home;	// IMP=0x00000000000a26fe
@end
