...
- (void).cxx_destruct;	// IMP=0x00000000002655d7
...
- (long long)_resolvedLoginType:(id *)arg1;	// IMP=0x0000000000265526
- (id)pendingArbitrationExecutionFuture;	// IMP=0x00000000002654b7
- (id)init;	// IMP=0x0000000000265402
- (id)initWithAccessories:(id)arg1 account:(id)arg2 contextGenerator:(CDUnknownBlockType)arg3;	// IMP=0x0000000000265299
