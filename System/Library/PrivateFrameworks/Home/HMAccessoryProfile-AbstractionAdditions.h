...
+ (id)_profilesWithNonStandardTileUI;	// IMP=0x000000000003fefd
@property(readonly, nonatomic) HMRoom *hf_safeRoom;
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00000000000371c0
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0000000000076a2e
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x000000000008d23d
...
- (_Bool)hf_isValidObject;	// IMP=0x00000000001ae3ca
