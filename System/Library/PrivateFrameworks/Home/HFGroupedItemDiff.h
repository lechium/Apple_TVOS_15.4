...
+ (id)diffFromGroups:(id)arg1 toGroups:(id)arg2 changeTest:(CDUnknownBlockType)arg3;	// IMP=0x000000000012543c
+ (id)diffFromGroups:(id)arg1 toGroups:(id)arg2;	// IMP=0x000000000012541b
- (void).cxx_destruct;	// IMP=0x0000000000126f68
...
- (id)_operationDescriptionWithPrefix:(id)arg1;	// IMP=0x0000000000126d93
@property(readonly, copy, nonatomic) NSString *operationDescription;
- (id)debugDescription;	// IMP=0x0000000000126ceb
- (id)description;	// IMP=0x0000000000126b4d
- (id)_briefDescriptionForOperations:(id)arg1 type:(id)arg2;	// IMP=0x000000000012673a
- (id)_performItemDiffFromGroup:(id)arg1 atIndex:(id)arg2 toGroup:(id)arg3 atIndex:(unsigned long long)arg4;	// IMP=0x0000000000125f37
- (void)_performDiff;	// IMP=0x0000000000125625
@property(readonly, copy, nonatomic) NSArray *allOperations;
- (id)initWithFromGroups:(id)arg1 toGroups:(id)arg2 changeTest:(CDUnknownBlockType)arg3;	// IMP=0x00000000001254d1
