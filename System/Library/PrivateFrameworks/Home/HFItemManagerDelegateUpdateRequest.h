...
- (void).cxx_destruct;	// IMP=0x000000000014dcab
...
- (id)description;	// IMP=0x000000000014dba3
- (void)performWithOptions:(unsigned long long)arg1;	// IMP=0x000000000014db2c
- (id)initWithChanges:(id)arg1 isInitialUpdate:(_Bool)arg2 applyChangesBlock:(CDUnknownBlockType)arg3 issueDelegateMessagesBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000014da52
- (id)init;	// IMP=0x000000000014d99d
