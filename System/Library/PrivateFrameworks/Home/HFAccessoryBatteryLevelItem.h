...
- (void).cxx_destruct;	// IMP=0x000000000004cd65
@property(readonly, nonatomic) id <HFCharacteristicValueSource> valueSource; // @synthesize valueSource=_valueSource;
@property(readonly, nonatomic) HMAccessory *accessory; // @synthesize accessory=_accessory;
- (id)_subclass_updateWithOptions:(id)arg1;	// IMP=0x000000000004c3e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004c35e
- (id)initWithAccessory:(id)arg1 valueSource:(id)arg2;	// IMP=0x000000000004c2bc
