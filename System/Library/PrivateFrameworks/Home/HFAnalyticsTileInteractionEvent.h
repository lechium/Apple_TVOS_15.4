...
+ (unsigned long long)_numberOfRepresentedHomeKitObjectsForItem:(id)arg1;	// IMP=0x00000000001d6304
- (void).cxx_destruct;	// IMP=0x00000000001d65aa
...
- (id)payload;	// IMP=0x00000000001d5f12
- (id)initWithData:(id)arg1;	// IMP=0x00000000001d5aea
