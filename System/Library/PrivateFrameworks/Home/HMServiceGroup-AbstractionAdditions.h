...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x0000000000036d60
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0000000000075063
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x000000000007ad45
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x000000000008c8e8
...
- (_Bool)hf_isValidObject;	// IMP=0x00000000001add4d
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00000000001d920a
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)_hf_allBulletinBoardNotifications;	// IMP=0x00000000001d9135
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x00000000002a5422
