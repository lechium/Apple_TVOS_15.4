...
+ (unsigned long long)hf_presenceDisableReasonsForHome:(id)arg1;	// IMP=0x00000000000643b6
+ (unsigned long long)hf_locationEventTypeForPresenceEventType:(unsigned long long)arg1;	// IMP=0x0000000000064354
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00000000000766d3
