...
+ (id)na_identity;	// IMP=0x0000000000120a03
- (void).cxx_destruct;	// IMP=0x0000000000120c4e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000120b5f
...
- (id)initWithServiceType:(id)arg1 serviceSubtype:(id)arg2 parentServiceDescriptor:(id)arg3;	// IMP=0x00000000001208e7
- (id)initWithServiceType:(id)arg1 serviceSubtype:(id)arg2 parentServiceDescriptorGenerator:(CDUnknownBlockType)arg3;	// IMP=0x000000000012081d
- (id)init;	// IMP=0x0000000000120768
