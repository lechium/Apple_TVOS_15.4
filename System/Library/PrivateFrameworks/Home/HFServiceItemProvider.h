...
- (void).cxx_destruct;	// IMP=0x00000000000f6696
...
- (id)invalidationReasons;	// IMP=0x00000000000f643a
- (id)items;	// IMP=0x00000000000f6428
- (id)reloadItems;	// IMP=0x00000000000f5d0b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f5c81
- (id)initWithHome:(id)arg1 serviceTypes:(id)arg2;	// IMP=0x00000000000f5b35
- (id)initWithHome:(id)arg1;	// IMP=0x00000000000f5b21
