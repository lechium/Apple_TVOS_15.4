...
+ (Class)homeKitRepresentationClass;	// IMP=0x00000000001fa715
- (void).cxx_destruct;	// IMP=0x00000000001fb302
...
- (id)_lazilyUpdateFavorite;	// IMP=0x00000000001fb0f1
- (id)_lazilyUpdateRoom;	// IMP=0x00000000001faeab
- (id)_lazilyUpdateName;	// IMP=0x00000000001facbd
- (id)commitItem;	// IMP=0x00000000001fa9f8
- (id)_performValidation;	// IMP=0x00000000001fa9dc
- (id)removeItemFromHome;	// IMP=0x00000000001fa9c3
@property(readonly, nonatomic) _Bool supportsFavoriting;
- (id)accessories;	// IMP=0x00000000001fa958
@property(readonly, nonatomic) NSString *originalName;
@property(readonly, nonatomic) HMAccessory *accessory;
- (id)initWithExistingObject:(id)arg1 inHome:(id)arg2;	// IMP=0x00000000001fa726
