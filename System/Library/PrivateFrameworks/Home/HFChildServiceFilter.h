...
- (void).cxx_destruct;	// IMP=0x00000000000daabb
@property(readonly, copy, nonatomic) NSSet *childServiceTypes; // @synthesize childServiceTypes=_childServiceTypes;
- (id)filteredChildServicesForParentService:(id)arg1;	// IMP=0x00000000000da942
- (id)initWithChildServiceTypes:(id)arg1;	// IMP=0x00000000000da8cf
