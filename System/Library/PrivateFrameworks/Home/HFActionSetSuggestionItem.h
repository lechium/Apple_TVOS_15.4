...
- (id)_subclass_updateWithOptions:(id)arg1;	// IMP=0x000000000008e808
@property(readonly, nonatomic) id <HFHomeKitObject> homeKitObject;
- (id)initWithHome:(id)arg1 actionSet:(id)arg2;	// IMP=0x000000000008e754
- (id)init;	// IMP=0x000000000008e6cd
