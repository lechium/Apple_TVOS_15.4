...
- (void).cxx_destruct;	// IMP=0x000000000022a87e
...
- (long long)fixStateForSymptom:(id)arg1;	// IMP=0x000000000022a7cb
- (_Bool)shouldDisplayManualFixOptionForSymptom:(id)arg1;	// IMP=0x000000000022a746
...
- (id)initWithAccessory:(id)arg1 mediaSystem:(id)arg2;	// IMP=0x000000000022a3a8
- (id)init;	// IMP=0x000000000022a2f3
