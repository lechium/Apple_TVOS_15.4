...
- (void).cxx_destruct;	// IMP=0x00000000000c2597
...
- (id)items;	// IMP=0x00000000000c2398
- (id)reloadItems;	// IMP=0x00000000000c1e8b
- (id)_builtInActionSetOfType:(id)arg1;	// IMP=0x00000000000c1d50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c1cea
- (id)initWithHome:(id)arg1;	// IMP=0x00000000000c16b0
