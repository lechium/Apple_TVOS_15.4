...
- (void).cxx_destruct;	// IMP=0x00000000000ec101
...
- (id)_createAdapterForIdentifier:(id)arg1;	// IMP=0x00000000000ec000
- (id)adapterForIdentifier:(id)arg1;	// IMP=0x00000000000ebf0f
- (id)init;	// IMP=0x00000000000ebe5a
- (id)initWithHomeKitSettingsVendor:(id)arg1;	// IMP=0x00000000000ebdb3
