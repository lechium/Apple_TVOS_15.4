...
+ (_Bool)hf_isSuspendedStateSupported:(unsigned long long)arg1;	// IMP=0x0000000000136d68
+ (_Bool)hf_isSuspendedStateSuspended:(unsigned long long)arg1;	// IMP=0x0000000000136cb5
+ (id)hf_userFriendlyLocalizedLowercaseDescription:(id)arg1;	// IMP=0x00000000001367a1
+ (id)hf_userFriendlyLocalizedCapitalizedDescription:(id)arg1;	// IMP=0x0000000000136645
+ (id)hf_getUserFriendlyDescriptionKey:(id)arg1;	// IMP=0x0000000000136101
@property(readonly, nonatomic) HMRoom *hf_safeRoom;
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00000000000365f5
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0000000000074773
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x000000000008d02f
@property(readonly, nonatomic) _Bool hf_shouldShowInFavorites;
- (_Bool)hf_areAllSensorServices;	// IMP=0x000000000008cf3d
- (_Bool)hf_anyNonSensorServiceIsFavorite;	// IMP=0x000000000008cea2
...
- (void)_pushSymptomUpdate;	// IMP=0x0000000000096467
...
- (_Bool)hf_shouldDisplayManualFixOptionForSymptom:(long long)arg1;	// IMP=0x0000000000095875
- (_Bool)hf_shouldShowSoftwareUpdateInfo;	// IMP=0x00000000000957c2
- (id)hf_identifyHomePod;	// IMP=0x0000000000095753
...
- (_Bool)hf_supportsMultiUserLanguage:(id)arg1;	// IMP=0x0000000000095542
...
- (_Bool)hf_hasSoftwareOrFirmwareUpdate;	// IMP=0x00000000001373a2
- (_Bool)hf_supportsSoftwareUpdate;	// IMP=0x000000000013736f
- (_Bool)hf_shouldNotifyUserOfSoftwareUpdate;	// IMP=0x0000000000137367
- (_Bool)hf_shouldHideNearbyAccessoryService:(id)arg1;	// IMP=0x0000000000137161
- (id)hf_errorForCurrentSessionState;	// IMP=0x0000000000136f80
- (_Bool)hf_needsOnboarding;	// IMP=0x0000000000136f3c
- (id)hf_siriEndpointProfile;	// IMP=0x0000000000136e1b
...
- (id)_hf_categoryType;	// IMP=0x00000000001369cd
...
- (id)hf_serviceOfType:(id)arg1;	// IMP=0x00000000001355ee
...
- (id)hf_primaryService;	// IMP=0x0000000000134cf5
...
- (id)hf_setShowAsIndividualServices:(_Bool)arg1;	// IMP=0x00000000001345bf
...
- (_Bool)hf_isValidObject;	// IMP=0x00000000001adbfc
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x00000000002a5566
