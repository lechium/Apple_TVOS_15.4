...
- (void).cxx_destruct;	// IMP=0x000000000002e816
...
- (void)_defaultsDidChange;	// IMP=0x000000000002e667
- (void)locationManagerDidChangeAuthorization:(id)arg1;	// IMP=0x000000000002e5a9
@property(nonatomic) _Bool homeSensingEnabled;
@property(readonly, nonatomic) NAFuture *locationSensingAvailableFuture;
- (void)dealloc;	// IMP=0x000000000002e287
- (id)init;	// IMP=0x000000000002e273
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000002df29
