...
- (void).cxx_destruct;	// IMP=0x00000000001f99d5
...
- (id)_bucketingValueForAction:(id)arg1;	// IMP=0x00000000001f98b3
- (id)suggestedActionForCharacteristic:(id)arg1 candidateActions:(id)arg2;	// IMP=0x00000000001f91d9
- (id)initWithCharacteristicType:(id)arg1 normalStateValue:(id)arg2 bucketingPolicy:(unsigned long long)arg3;	// IMP=0x00000000001f9134
- (id)initWithCharacteristicType:(id)arg1 normalStateValue:(id)arg2;	// IMP=0x00000000001f911f
