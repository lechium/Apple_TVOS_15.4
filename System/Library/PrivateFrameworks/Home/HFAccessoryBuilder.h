...
+ (Class)homeKitRepresentationClass;	// IMP=0x000000000009210f
- (void).cxx_destruct;	// IMP=0x000000000009519e
...
- (id)_lazilyUpdateFavorite;	// IMP=0x000000000009451d
- (id)_lazilyUpdateRoom;	// IMP=0x0000000000093f81
- (id)_lazilyUpdateName;	// IMP=0x000000000009301d
- (id)commitItem;	// IMP=0x0000000000092c96
- (id)_performValidation;	// IMP=0x0000000000092c7d
- (_Bool)_shouldUpdateNilNameWithRoomName;	// IMP=0x0000000000092b17
- (id)removeItemFromHome;	// IMP=0x000000000009249b
@property(readonly, nonatomic) _Bool supportsFavoriting;
- (id)accessories;	// IMP=0x00000000000923f5
@property(readonly, nonatomic) NSString *originalName;
@property(readonly, nonatomic) HMAccessory *accessory;
- (id)initWithExistingObject:(id)arg1 inHome:(id)arg2;	// IMP=0x0000000000092120
