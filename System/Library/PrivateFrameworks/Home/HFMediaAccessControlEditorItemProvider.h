...
- (void).cxx_destruct;	// IMP=0x00000000002339f9
...
- (id)items;	// IMP=0x00000000002338a3
- (id)_buildItems;	// IMP=0x0000000000232a0c
- (id)initWithItems:(id)arg1;	// IMP=0x0000000000232957
- (id)initWithHome:(id)arg1;	// IMP=0x000000000023289d
