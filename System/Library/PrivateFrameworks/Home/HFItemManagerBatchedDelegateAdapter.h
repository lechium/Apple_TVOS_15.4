...
- (void).cxx_destruct;	// IMP=0x00000000001f41ad
...
- (void)_reset;	// IMP=0x00000000001f4007
- (void)_executeBatch;	// IMP=0x00000000001f3c58
- (id)_itemProvidersToReloadForInvalidationReasons:(id)arg1;	// IMP=0x00000000001f3b1d
- (id)requestUpdateForItems:(id)arg1 itemProviderInvalidationReasons:(id)arg2 modifiedHome:(id)arg3 senderSelector:(SEL)arg4;	// IMP=0x00000000001f3786
- (id)commitBatchWithReason:(id)arg1 senderSelector:(SEL)arg2;	// IMP=0x00000000001f35ce
- (void)beginBatchWithReason:(id)arg1;	// IMP=0x00000000001f321c
- (id)initWithItemManager:(id)arg1 readPolicy:(id)arg2;	// IMP=0x00000000001f30d7
