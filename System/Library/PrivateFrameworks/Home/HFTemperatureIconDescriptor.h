...
- (void).cxx_destruct;	// IMP=0x0000000000008b5b
...
- (long long)compare:(id)arg1;	// IMP=0x00000000000089b1
@property(readonly, nonatomic) NSString *identifier;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000087eb
- (id)initWithFormattedTemperature:(id)arg1 heatingCoolingMode:(long long)arg2 targetHeatingCoolingMode:(long long)arg3;	// IMP=0x000000000000876a
