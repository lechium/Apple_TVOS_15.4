...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000e97f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000f0f1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ecc4
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e987
