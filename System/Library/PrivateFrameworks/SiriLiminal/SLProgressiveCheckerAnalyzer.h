...
- (void)_endAudio;	// IMP=0x000000000000547d
- (void)_addAudio:(id)arg1;	// IMP=0x0000000000004d6d
- (void)_startNewRequestWithContext:(id)arg1;	// IMP=0x0000000000004a62
- (void)endAudio;	// IMP=0x0000000000004a01
- (void)addAudio:(id)arg1;	// IMP=0x0000000000004959
- (void)startNewRequestWithContext:(id)arg1;	// IMP=0x00000000000048b1
- (id)initWithConfig:(id)arg1 withDelegate:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000003cf5
