...
- (id)debugDescription;	// IMP=0x00000000000027ec
- (void)dealloc;	// IMP=0x00000000000027a2
- (id)initWithResultCode:(unsigned long long)arg1 failedMessages:(id)arg2 transferedMessage:(id)arg3;	// IMP=0x0000000000002721
