...
- (id)description;	// IMP=0x0000000000094ca3
- (void)setConnectionServiceType:(struct __CFString *)arg1;	// IMP=0x0000000000094c69
- (struct __CFString *)connectionServiceType;	// IMP=0x0000000000094c5f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000094aef
- (void)dealloc;	// IMP=0x0000000000094a7b
