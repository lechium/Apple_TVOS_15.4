...
- (id)description;	// IMP=0x00000000000b8874
- (_Bool)wasSuccessful;	// IMP=0x00000000000b8866
- (void)dealloc;	// IMP=0x00000000000b8815
- (id)initWithStatusCode:(long long)arg1 error:(id)arg2 folderID:(id)arg3 folderName:(id)arg4;	// IMP=0x00000000000b8784
