...
- (void)dealloc;	// IMP=0x00000000000ca3cf
- (id)initWithDebugOutput:(id)arg1 modelInfo:(id)arg2;	// IMP=0x00000000000ca35a
- (id)initWithDebugOutput:(id)arg1;	// IMP=0x00000000000ca346
