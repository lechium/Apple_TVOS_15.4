...
@interface MFMessageInfo : NSObject <MFBaseMessage, NSCopying>
{
    ...
    unsigned int _dateReceivedInterval;	// 24 = 0x18
    unsigned int _sortUid;	// 28 = 0x1c
    unsigned int _sortDateReceivedInterval;	// 32 = 0x20
    long long _conversationHash;	// 40 = 0x28
    long long _generationNumber;	// 48 = 0x30
    long long _messageIDHash;	// 56 = 0x38
}

+ (long long)newGenerationNumber;	// IMP=0x00000000000aaa8a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000aadcd
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000aabab
- (long long)generationCompare:(id)arg1;	// IMP=0x00000000000aab8d
- (id)initWithUid:(unsigned int)arg1 mailboxID:(unsigned int)arg2 messageID:(long long)arg3 dateReceivedInterval:(unsigned int)arg4 dateSentInterval:(unsigned int)arg5 conversationHash:(long long)arg6 read:(_Bool)arg7 knownToHaveAttachments:(_Bool)arg8 flagged:(_Bool)arg9 isVIP:(_Bool)arg10;	// IMP=0x00000000000aaaea
- (id)init;	// IMP=0x00000000000aaaa1
...
- (id)copyMessageInfo;	// IMP=0x00000000000395f9
