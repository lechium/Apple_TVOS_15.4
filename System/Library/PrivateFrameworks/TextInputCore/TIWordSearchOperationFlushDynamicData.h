...
- (void).cxx_destruct;	// IMP=0x00000000001304a7
@property(retain, nonatomic) TIMecabraWrapper *mecabraWrapper; // @synthesize mecabraWrapper=_mecabraWrapper;
- (void)perform;	// IMP=0x000000000013042b
- (void)cancel;	// IMP=0x0000000000130425
- (id)initWithWordSearch:(id)arg1;	// IMP=0x00000000001303a3
