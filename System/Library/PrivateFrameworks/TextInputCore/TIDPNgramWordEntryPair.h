...
- (void).cxx_destruct;	// IMP=0x000000000018f189
...
- (id)initWithWordString:(id)arg1;	// IMP=0x000000000018f0d1
- (id)initWithWordString:(id)arg1 wordEntryAligned:(id)arg2;	// IMP=0x000000000018f033
