...
- (void).cxx_destruct;	// IMP=0x0000000000094c7a
...
- (void)perform;	// IMP=0x0000000000094b4b
- (void)cancel;	// IMP=0x0000000000094b45
- (void)dealloc;	// IMP=0x0000000000094aff
- (id)initWithWordSearch:(id)arg1 mecabraCandidate:(void *)arg2 isPartial:(_Bool)arg3 isPrediction:(_Bool)arg4;	// IMP=0x0000000000094a36
