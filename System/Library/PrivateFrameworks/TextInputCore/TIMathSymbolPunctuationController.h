...
- (void).cxx_destruct;	// IMP=0x0000000000085a96
...
- (id)mathSymbolPunctuationedStringForInputString:(id)arg1;	// IMP=0x000000000008554c
- (_Bool)updateInputString:(id)arg1;	// IMP=0x0000000000085374
- (void)setInputString:(id)arg1;	// IMP=0x0000000000085322
- (void)reset;	// IMP=0x0000000000085310
- (id)init;	// IMP=0x0000000000085278
