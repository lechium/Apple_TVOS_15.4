...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001a32dc
- (void).cxx_destruct;	// IMP=0x00000000001a3293
...
- (id)description;	// IMP=0x00000000001a2ff8
- (id)init;	// IMP=0x00000000001a2fc9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a2f03
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a2d06
