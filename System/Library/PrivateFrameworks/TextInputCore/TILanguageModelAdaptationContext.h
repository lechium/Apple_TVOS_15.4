...
- (void).cxx_destruct;	// IMP=0x000000000001ace8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001ac3a
@property(readonly, nonatomic) NSString *identifierForResponseKit;
@property(readonly, nonatomic) NSString *identifier;
- (id)description;	// IMP=0x000000000001abb1
- (id)initWithClientIdentifier:(id)arg1 andRecipientContactInfo:(id)arg2;	// IMP=0x000000000001aab9
- (id)initWithClientIdentifier:(id)arg1 andRecipientRecord:(id)arg2;	// IMP=0x000000000001a880
