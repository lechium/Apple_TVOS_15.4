...
+ (id)eventDescriptorWithEventName:(id)arg1 eventDescription:(id)arg2 fieldDescriptors:(id)arg3 includeTestingParameters:(_Bool)arg4;	// IMP=0x00000000000ce300
- (void).cxx_destruct;	// IMP=0x00000000000ce2cd
...
- (id)initWithEventName:(id)arg1 eventDescription:(id)arg2 fieldDescriptors:(id)arg3 includeTestingParameters:(_Bool)arg4;	// IMP=0x00000000000ce1e4
