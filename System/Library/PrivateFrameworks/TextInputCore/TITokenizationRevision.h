...
- (void).cxx_destruct;	// IMP=0x00000000000c0231
...
- (id)initWithTokenIterator:(struct _TIRevisionHistoryTokenIterator)arg1;	// IMP=0x00000000000c012d
- (id)init;	// IMP=0x00000000000c0117
