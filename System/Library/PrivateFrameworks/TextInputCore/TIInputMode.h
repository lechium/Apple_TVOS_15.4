...
+ (id)inputModeWithIdentifier:(id)arg1;	// IMP=0x00000000000265be
...
- (id)description;	// IMP=0x0000000000025772
- (unsigned long long)hash;	// IMP=0x000000000002572e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002565b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000025650
- (id)initWithNormalizedIdentifier:(id)arg1;	// IMP=0x00000000000255dd
