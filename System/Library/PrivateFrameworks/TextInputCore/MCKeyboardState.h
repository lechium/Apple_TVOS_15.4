...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000cdf1f
- (id)initWithUserInterfaceIdiom:(long long)arg1 isSplitKeyboard:(_Bool)arg2 isHardwareKeyboard:(_Bool)arg3;	// IMP=0x00000000000cdecc
