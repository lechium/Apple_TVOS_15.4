...
+ (id)sharedCryptographer;	// IMP=0x00000000001a566a
+ (id)singletonInstance;	// IMP=0x00000000001a563a
+ (void)setSharedCryptographer:(id)arg1;	// IMP=0x00000000001a56cc
- (void).cxx_destruct;	// IMP=0x00000000001a5315
...
- (id)stringDigestForName:(id)arg1;	// IMP=0x00000000001a51bd
@property(readonly, nonatomic) NSData *deviceSalt;
- (id)init;	// IMP=0x00000000001a50bf
