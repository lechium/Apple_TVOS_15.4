...
- (void).cxx_destruct;	// IMP=0x000000000019f0ff
...
- (id)initWithActiveInputModes:(id)arg1 wordSeparator:(id)arg2 testingParameters:(id)arg3 assetAvailabilityStatus:(long long)arg4;	// IMP=0x000000000019f014
