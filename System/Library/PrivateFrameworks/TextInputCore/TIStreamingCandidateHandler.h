...
- (void).cxx_destruct;	// IMP=0x00000000000aefd7
...
- (void)close;	// IMP=0x00000000000aee98
- (void)pushCandidates:(id)arg1;	// IMP=0x00000000000aed00
- (void)open;	// IMP=0x00000000000aecf2
@property(readonly, nonatomic) _Bool asynchronous;
- (void)dealloc;	// IMP=0x00000000000aecbb
- (id)initWithClientProxy:(id)arg1 keyboardState:(id)arg2 requestToken:(id)arg3 logger:(id)arg4 inputManager:(id)arg5 candidateHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000000aeb7c
