...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000025052
- (void).cxx_destruct;	// IMP=0x0000000000024fee
...
- (void)sendTo:(id)arg1;	// IMP=0x0000000000024dee
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024b72
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000249b0
- (id)initWithCandidateAccepted:(id)arg1 withInput:(id)arg2 documentState:(id)arg3 inputContext:(id)arg4 inputStem:(id)arg5 predictionBarHit:(_Bool)arg6 useCandidateSelection:(_Bool)arg7 candidateIndex:(long long)arg8 keyboardState:(id)arg9;	// IMP=0x0000000000024863
