...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001a2cfe
- (void).cxx_destruct;	// IMP=0x00000000001a2be1
...
- (void)setClientID:(id)arg1 keyboardState:(id)arg2;	// IMP=0x00000000001a2914
- (void)contextDidChange:(id)arg1 wordDelete:(_Bool)arg2 cursorMoved:(_Bool)arg3 extendsPriorWord:(_Bool)arg4 inWord:(id)arg5 range:(struct _NSRange)arg6 selectionLocation:(unsigned long long)arg7 keyboardState:(id)arg8;	// IMP=0x00000000001a2416
- (void)candidateAccepted:(id)arg1 withInput:(id)arg2 documentState:(id)arg3 inputContext:(id)arg4 inputStem:(id)arg5 predictionBarHit:(_Bool)arg6 useCandidateSelection:(_Bool)arg7 candidateIndex:(long long)arg8 keyboardState:(id)arg9;	// IMP=0x00000000001a098c
- (void)candidatesOffered:(id)arg1 keyboardState:(id)arg2;	// IMP=0x00000000001a0893
- (void)layoutDidChange:(id)arg1 keyboardState:(id)arg2;	// IMP=0x00000000001a06a9
- (void)addTouchEvent:(id)arg1;	// IMP=0x000000000019fffe
- (void)addDrawInputWithSyllableCount:(unsigned long long)arg1 keyboardState:(id)arg2;	// IMP=0x000000000019ff13
- (void)addKeyInput:(id)arg1 keyboardState:(id)arg2;	// IMP=0x000000000019fd8b
- (_Bool)testForRapidDeleteContextChange:(id)arg1;	// IMP=0x000000000019f9be
- (_Bool)isCurrentWordEmpty;	// IMP=0x000000000019f975
- (double)calibratedCurrentTimestamp;	// IMP=0x000000000019f801
@property(readonly, copy) NSString *description;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019f675
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019f317
- (id)initWithLocale:(id)arg1 keyboardLayout:(id)arg2;	// IMP=0x000000000019f18e
- (id)init;	// IMP=0x000000000019f132
