...
- (void).cxx_destruct;	// IMP=0x000000000007c6ee
...
- (void)perform;	// IMP=0x000000000007c4b3
- (void)cancel;	// IMP=0x000000000007c4ad
- (id)initWithWordSearch:(id)arg1 paragraph:(id)arg2 adaptationContext:(id)arg3 timeStamp:(double)arg4;	// IMP=0x000000000007c390
