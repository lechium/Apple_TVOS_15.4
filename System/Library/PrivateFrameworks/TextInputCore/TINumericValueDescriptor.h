...
+ (id)numericValueDescriptorWithMetricName:(id)arg1 calculationExpression:(id)arg2 calculationPrecondition:(id)arg3 calculationDefaultValue:(id)arg4 calculationDependencies:(id)arg5 bucketThresholds:(id)arg6 bucketValues:(id)arg7;	// IMP=0x000000000006b28e
- (void).cxx_destruct;	// IMP=0x000000000006b219
...
- (id)initWithMetricName:(id)arg1 calculationExpression:(id)arg2 calculationPrecondition:(id)arg3 calculationDefaultValue:(id)arg4 calculationDependencies:(id)arg5 bucketThresholds:(id)arg6 bucketValues:(id)arg7;	// IMP=0x000000000006b069
