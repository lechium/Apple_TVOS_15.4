...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000255cd
- (void).cxx_destruct;	// IMP=0x00000000000255ba
@property(readonly, nonatomic) TIAutocorrectionList *candidates; // @synthesize candidates=_candidates;
@property(readonly, copy) NSString *description;
- (void)sendTo:(id)arg1;	// IMP=0x00000000000251ea
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002514f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000250d2
- (id)initWithCandidatesOffered:(id)arg1 keyboardState:(id)arg2;	// IMP=0x000000000002505a
