...
- (void).cxx_destruct;	// IMP=0x00000000001402e5
...
- (_Bool)canComposeNew:(id)arg1;	// IMP=0x000000000014026d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000140183
- (id)initWithCandidateText:(id)arg1 convertedInput:(id)arg2;	// IMP=0x00000000001400bc
