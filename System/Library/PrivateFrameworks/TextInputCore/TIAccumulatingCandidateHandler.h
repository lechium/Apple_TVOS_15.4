...
- (void).cxx_destruct;	// IMP=0x00000000000aeb54
...
- (void)close;	// IMP=0x00000000000aea50
- (void)pushCandidates:(id)arg1;	// IMP=0x00000000000aea3e
- (void)open;	// IMP=0x00000000000aea30
@property(readonly, nonatomic) _Bool asynchronous;
- (void)dealloc;	// IMP=0x00000000000ae9f9
- (id)initWithHandlerBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ae97e
