...
+ (id)loaderWithSentenceDelimiters:(id)arg1 trailingChars:(id)arg2 prefixChars:(id)arg3;	// IMP=0x00000000001848e0
- (void).cxx_destruct;	// IMP=0x0000000000184433
...
- (void)startBackgroundLoad;	// IMP=0x00000000001842dd
- (id)initWithSentenceDelimiters:(id)arg1 trailingChars:(id)arg2 prefixChars:(id)arg3;	// IMP=0x00000000001841f7
