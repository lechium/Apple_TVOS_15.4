...
- (void).cxx_destruct;	// IMP=0x000000000017b9d5
...
- (void)reportToSession:(id)arg1;	// IMP=0x000000000017b571
- (id)description;	// IMP=0x000000000017b54f
- (id)init:(id)arg1 emojiSearchMode:(_Bool)arg2 order:(long long)arg3 wordBucketCategory:(id)arg4 isAutocorrection:(_Bool)arg5;	// IMP=0x000000000017b484
