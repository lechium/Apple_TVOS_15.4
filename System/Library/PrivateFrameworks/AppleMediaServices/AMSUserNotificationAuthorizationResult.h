...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000023db88
- (void).cxx_destruct;	// IMP=0x000000000023dbbf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000023daeb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000023da3a
