...
- (void).cxx_destruct;	// IMP=0x00000000001a6dde
...
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000001a6d61
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000001a6d59
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000001a6d51
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a6b5c
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 error:(id)arg3 delay:(double)arg4;	// IMP=0x00000000001a6a57
