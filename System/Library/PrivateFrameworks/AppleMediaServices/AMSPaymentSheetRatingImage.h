...
- (void).cxx_destruct;	// IMP=0x00000000001bcb6e
...
- (long long)_ratingTypeForType:(id)arg1;	// IMP=0x00000000001bc9d2
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001bc227
- (id)initWithURLString:(id)arg1;	// IMP=0x00000000001bc1ac
