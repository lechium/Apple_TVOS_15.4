...
- (void).cxx_destruct;	// IMP=0x00000000001a0e44
...
- (void)setBagContract:(id)arg1;	// IMP=0x00000000001a0cd8
- (id)bagContract;	// IMP=0x00000000001a0c6f
- (id)initWithTaskInfo:(id)arg1 serverPayload:(id)arg2;	// IMP=0x00000000001a0a75
- (id)initWithTask:(id)arg1 metrics:(id)arg2;	// IMP=0x00000000001a09dc
