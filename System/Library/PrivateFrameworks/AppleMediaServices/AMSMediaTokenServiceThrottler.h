...
- (void).cxx_destruct;	// IMP=0x0000000000179d8b
...
- (double)_calculateThrottleInterval;	// IMP=0x0000000000179ca4
- (void)throttle;	// IMP=0x0000000000179c1d
- (_Bool)shouldThrottle;	// IMP=0x0000000000179bd0
- (void)reset;	// IMP=0x0000000000179b9e
- (id)initWithBaseSleepInterval:(double)arg1 maxSleepInterval:(double)arg2;	// IMP=0x0000000000179b34
