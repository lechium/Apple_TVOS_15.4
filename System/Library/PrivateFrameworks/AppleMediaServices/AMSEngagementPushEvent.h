...
+ (id)archiveClasses;	// IMP=0x000000000011bf1f
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000011bf17
- (void).cxx_destruct;	// IMP=0x000000000011c034
@property(retain, nonatomic) AMSEngagementRequest *request; // @synthesize request=_request;
@property(retain, nonatomic) NSArray *actions; // @synthesize actions=_actions;
@property(retain, nonatomic) NSDictionary *data; // @synthesize data=_data;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000011bdd0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000011bced
