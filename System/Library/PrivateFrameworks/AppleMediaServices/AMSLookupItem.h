...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000016523d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001652ed
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000165245
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001651fc
...
- (id)initWithLookupDictionary:(id)arg1;	// IMP=0x000000000016452a
