...
- (void).cxx_destruct;	// IMP=0x00000000000aa3e9
...
- (id)createFrozenDataSource;	// IMP=0x00000000000aa051
- (id)createFrozenBag;	// IMP=0x00000000000a9606
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x00000000000a93b7
