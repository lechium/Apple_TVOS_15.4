...
- (void).cxx_destruct;	// IMP=0x0000000000199f65
...
- (_Bool)_shouldClearEventsDespiteError:(id)arg1 result:(id)arg2;	// IMP=0x0000000000199c47
- (id)_postBatch:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001990e1
- (id)_nextBatchWithConfig:(id)arg1 error:(id *)arg2;	// IMP=0x000000000019823e
- (id)_mescalSignatureWithBodyData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000198003
- (id)performFlush;	// IMP=0x00000000001978e5
- (void)cancel;	// IMP=0x000000000019776a
@property(readonly, nonatomic) AMSURLSession *URLSession; // @synthesize URLSession=_URLSession;
- (id)initWithDataSource:(id)arg1 bag:(id)arg2;	// IMP=0x000000000019759c
