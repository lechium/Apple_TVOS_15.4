...
- (void).cxx_destruct;	// IMP=0x00000000000c4fc3
...
- (void)handleDialogRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c4dfd
- (void)handleAuthenticateRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c4c4b
- (id)initWithSession:(id)arg1 task:(id)arg2;	// IMP=0x00000000000c4bb2
