...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001541fc
- (void).cxx_destruct;	// IMP=0x0000000000154222
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001540ec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000154009
- (id)initWithURLTaskInfo:(id)arg1;	// IMP=0x0000000000153eec
