...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c6512
+ (id)biometricsSignatureRequestForURLResponse:(id)arg1 account:(id)arg2 session:(id)arg3 task:(id)arg4 clientInfo:(id)arg5 options:(id)arg6 error:(id *)arg7;	// IMP=0x00000000000c5b48
- (void).cxx_destruct;	// IMP=0x00000000000c6616
...
- (id)_localAuthOptions;	// IMP=0x00000000000c6594
- (void)dealloc;	// IMP=0x00000000000c6555
- (void)setLocalAuthAccessControlRef:(struct __SecAccessControl *)arg1;	// IMP=0x00000000000c6524
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c63b5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c60e6
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 challenge:(id)arg3 options:(id)arg4 error:(id *)arg5;	// IMP=0x00000000000c5f38
