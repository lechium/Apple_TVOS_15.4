...
+ (id)bagKeySet;	// IMP=0x0000000000171ab6
+ (id)createBagForSubProfile;	// IMP=0x0000000000171a1c
+ (id)bagSubProfileVersion;	// IMP=0x00000000001719cc
+ (id)bagSubProfile;	// IMP=0x000000000017197c
- (void).cxx_destruct;	// IMP=0x0000000000171cc5
...
- (id)perform;	// IMP=0x0000000000171234
- (id)initWithType:(long long)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3 bag:(id)arg4;	// IMP=0x0000000000171135
