...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000010a20c
+ (id)actionWithTitle:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000109983
+ (id)actionWithTitle:(id)arg1 style:(long long)arg2;	// IMP=0x0000000000109938
+ (id)actionWithTitle:(id)arg1;	// IMP=0x0000000000109924
- (void).cxx_destruct;	// IMP=0x000000000010a721
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010a214
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000109f0f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000109b1f
- (id)description;	// IMP=0x0000000000109a1e
- (id)init;	// IMP=0x0000000000109875
