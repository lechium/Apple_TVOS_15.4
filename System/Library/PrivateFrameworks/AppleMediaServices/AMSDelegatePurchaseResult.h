...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f1476
- (void).cxx_destruct;	// IMP=0x00000000000f14a3
@property(retain, nonatomic) AMSDelegatePurchaseRequest *request; // @synthesize request=_request;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f13db
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f135e
