...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c67fd
- (void).cxx_destruct;	// IMP=0x00000000000c683b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c674f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c6675
