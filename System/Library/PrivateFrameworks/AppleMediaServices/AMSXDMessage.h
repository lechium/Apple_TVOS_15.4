...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000243f3a
+ (id)messageFromProtoMessage:(id)arg1;	// IMP=0x000000000024249e
+ (id)_allowedClassNamesForDecoding;	// IMP=0x00000000002422ab
+ (id)_allowedClassesForDecoding;	// IMP=0x0000000000242225
- (void).cxx_destruct;	// IMP=0x0000000000244056
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000243d3f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000243b00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000243a8c
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)description;	// IMP=0x0000000000243874
- (id)createProtoMessage;	// IMP=0x0000000000243642
@property(readonly, nonatomic) NSDictionary *JSONDictionary;
- (id)initWithJSONDictionary:(id)arg1;	// IMP=0x00000000002427ba
- (id)initWithIdentifier:(id)arg1 destination:(id)arg2 purpose:(long long)arg3 object:(id)arg4;	// IMP=0x0000000000242382
