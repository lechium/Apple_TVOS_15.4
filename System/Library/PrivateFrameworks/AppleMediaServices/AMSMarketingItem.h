...
- (id)video;	// IMP=0x0000000000169a00
@property(readonly, nonatomic) NSString *URLString;
- (id)tagline;	// IMP=0x00000000001699f0
- (id)renderingAttributes;	// IMP=0x00000000001699e8
- (id)endDate;	// IMP=0x00000000001699e0
- (id)abSettings;	// IMP=0x00000000001699d8
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000168b4e
