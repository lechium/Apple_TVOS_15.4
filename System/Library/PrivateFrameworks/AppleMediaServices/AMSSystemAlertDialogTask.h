...
- (void).cxx_destruct;	// IMP=0x0000000000214a1d
...
- (id)_reorderButtonActions;	// IMP=0x00000000002145d6
- (long long)_keyboardTypeFor:(long long)arg1;	// IMP=0x00000000002145bc
- (id)_handleResponseForNote:(struct __CFUserNotification *)arg1 buttonActions:(id)arg2 keys:(struct ButtonKey *)arg3;	// IMP=0x0000000000214262
- (long long)_defaultButtonIndexForActions:(id)arg1;	// IMP=0x0000000000213e03
- (struct __CFUserNotification *)_showNotificationFromDictionary:(struct __CFDictionary *)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000213c38
- (struct __CFDictionary *)_createNoteDictionaryWithKeys:(struct ButtonKey *)arg1 buttonActions:(id)arg2 outOptions:(unsigned long long *)arg3;	// IMP=0x00000000002133ab
- (void)_dismiss;	// IMP=0x000000000021305f
- (id)present;	// IMP=0x0000000000212ab3
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000212a07
