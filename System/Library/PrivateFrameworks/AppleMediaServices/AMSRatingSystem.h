...
+ (id)ratingSystemWithDictionary:(id)arg1;	// IMP=0x00000000001eef09
- (void).cxx_destruct;	// IMP=0x00000000001ef100
...
- (id)description;	// IMP=0x00000000001eef56
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001eed9b
