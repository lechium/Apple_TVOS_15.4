...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a930a
- (void).cxx_destruct;	// IMP=0x00000000000a9358
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a8ff6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a8dfd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a8ce4
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000a8cde
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000000a8c12
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a8b91
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000000a8a62
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)_initWithProfile:(id)arg1 profileVersion:(id)arg2 data:(id)arg3 expirationDate:(id)arg4 account:(id)arg5 processInfo:(id)arg6 defaultValues:(id)arg7;	// IMP=0x00000000000a880e
