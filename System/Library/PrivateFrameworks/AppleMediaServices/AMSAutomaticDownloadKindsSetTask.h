...
+ (id)bagKeySet;	// IMP=0x00000000000a31f3
+ (id)createBagForSubProfile;	// IMP=0x00000000000a3159
+ (id)bagSubProfileVersion;	// IMP=0x00000000000a3109
+ (id)bagSubProfile;	// IMP=0x00000000000a30b9
- (void).cxx_destruct;	// IMP=0x00000000000a32a2
...
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a2fcd
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a2ee1
- (id)perform;	// IMP=0x00000000000a1ddc
- (id)initWithEnabledMediaKinds:(id)arg1 account:(id)arg2 bag:(id)arg3;	// IMP=0x00000000000a1cb7
- (id)initWithEnabledMediaKinds:(id)arg1 account:(id)arg2 bag:(id)arg3 presentationDelegate:(id)arg4;	// IMP=0x00000000000a1b5e
