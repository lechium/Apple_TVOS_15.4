...
+ (id)bagKeySet;	// IMP=0x000000000022940b
+ (id)createBagForSubProfile;	// IMP=0x000000000022792e
+ (id)bagSubProfileVersion;	// IMP=0x00000000002278de
+ (id)bagSubProfile;	// IMP=0x000000000022788e
- (void).cxx_destruct;	// IMP=0x0000000000229ce3
...
- (id)requestWithMethod:(long long)arg1 URLString:(id)arg2 parameters:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000229985
- (id)requestWithMethod:(long long)arg1 URLString:(id)arg2 error:(id *)arg3;	// IMP=0x000000000022996d
- (id)requestWithMethod:(long long)arg1 URL:(id)arg2 parameters:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000229896
- (id)requestWithMethod:(long long)arg1 URL:(id)arg2 error:(id *)arg3;	// IMP=0x000000000022987e
- (id)requestWithMethod:(long long)arg1 bagURL:(id)arg2 parameters:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000229661
- (id)requestWithMethod:(long long)arg1 bagURL:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000229649
- (id)requestByEncodingRequest:(id)arg1 parameters:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000229424
- (id)initWithBagContract:(id)arg1;	// IMP=0x0000000000229325
- (void)_personalizeKeychainOptionsForAccount:(id)arg1;	// IMP=0x0000000000229184
- (id)_methodStringFromMethod:(long long)arg1;	// IMP=0x0000000000229112
- (void)_addSecuritySigningHeadersToRequest:(id)arg1 buyParams:(id)arg2 bag:(id)arg3;	// IMP=0x000000000022902e
- (id)requestByEncodingRequest:(id)arg1 parameters:(id)arg2;	// IMP=0x00000000002279c8
- (id)requestWithMethod:(long long)arg1 URL:(id)arg2 headers:(id)arg3 parameters:(id)arg4;	// IMP=0x000000000022772e
- (id)requestWithMethod:(long long)arg1 URL:(id)arg2 parameters:(id)arg3;	// IMP=0x0000000000227716
- (id)requestWithMethod:(long long)arg1 bagURL:(id)arg2 headers:(id)arg3 parameters:(id)arg4;	// IMP=0x0000000000227511
- (id)requestWithMethod:(long long)arg1 bagURL:(id)arg2 parameters:(id)arg3;	// IMP=0x00000000002274f9
...
- (id)initWithBag:(id)arg1;	// IMP=0x000000000022701b
- (id)init;	// IMP=0x0000000000226f08
