...
{
    unsigned long long _downloaderAccountID;	// 8 = 0x8
    unsigned long long _familyID;	// 16 = 0x10
    unsigned long long _purchaserAccountID;	// 24 = 0x18
}
...
- (id)initWithDownloaderAccountID:(unsigned long long)arg1 purchaserAccountID:(unsigned long long)arg2 familyID:(unsigned long long)arg3;	// IMP=0x000000000011fb63
