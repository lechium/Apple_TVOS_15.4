...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000123bb9
- (void).cxx_destruct;	// IMP=0x0000000000123bf8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000123a77
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012393b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000123872
- (id)initWithPurchaseIdentifier:(id)arg1 account:(id)arg2 options:(id)arg3;	// IMP=0x00000000001237ab
