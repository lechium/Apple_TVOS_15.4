...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001d21fd
...
- (id)_generateIdentifier;	// IMP=0x00000000001d22b5
- (unsigned long long)hash;	// IMP=0x00000000001d2271
- (id)description;	// IMP=0x00000000001d2205
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d1f3f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d1c45
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d1822
- (id)authenticationContextForRequest:(id)arg1;	// IMP=0x00000000001d15c4
...
- (id)initWithPurchaseType:(long long)arg1 buyParams:(id)arg2;	// IMP=0x00000000001d13c3
