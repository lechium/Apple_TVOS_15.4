...
- (void).cxx_destruct;	// IMP=0x0000000000201f56
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000000002017ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002016fa
