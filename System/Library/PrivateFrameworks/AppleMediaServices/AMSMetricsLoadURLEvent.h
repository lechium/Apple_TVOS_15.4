...
+ (double)_timingDataMetricToServerTimeInterval:(id)arg1;	// IMP=0x00000000001a4b35
+ (id)_resolvedIPAddressFromTask:(id)arg1;	// IMP=0x00000000001a4a46
+ (double)_randomDouble;	// IMP=0x00000000001a4a0c
+ (id)_radioTypeStringValueFromRadioType:(int)arg1;	// IMP=0x00000000001a48cb
+ (id)_metricsDictionaryFromConfig:(id)arg1;	// IMP=0x00000000001a440c
+ (id)_fetchNetworkQualityReports;	// IMP=0x00000000001a41d8
+ (id)_DNSServerIPAddresses;	// IMP=0x00000000001a403e
+ (_Bool)shouldCollectMetricsForContext:(id)arg1;	// IMP=0x00000000001a2442
...
- (void)_prepareEventWithContext:(id)arg1;	// IMP=0x00000000001a0f28
- (id)initWithContext:(id)arg1;	// IMP=0x00000000001a0eb9
