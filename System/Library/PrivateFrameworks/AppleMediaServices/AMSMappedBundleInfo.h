...
+ (id)_clientVersionFromProcessInfo:(id)arg1 clientName:(id)arg2;	// IMP=0x000000000016881c
+ (id)_clientNameFromProcessInfo:(id)arg1;	// IMP=0x00000000001686e3
+ (id)_accountMediaTypeForClientName:(id)arg1 bundleID:(id)arg2;	// IMP=0x0000000000168464
+ (id)bundleInfoForMobileAppStoreWithProcessInfo:(id)arg1;	// IMP=0x0000000000167ef2
+ (id)currentBundleInfo;	// IMP=0x0000000000167e8c
+ (id)bundleInfoForProcessInfo:(id)arg1;	// IMP=0x0000000000167d8c
+ (id)accountMediaTypeInfoForProcessInfo:(id)arg1;	// IMP=0x0000000000167d84
- (void).cxx_destruct;	// IMP=0x0000000000168afa
...
- (id)_initWithClient:(long long)arg1 processInfo:(id)arg2;	// IMP=0x0000000000167f44
