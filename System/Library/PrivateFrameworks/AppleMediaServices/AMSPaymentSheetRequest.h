...
+ (id)attributedStringByRemovingPlaceholderTagsFromAttributedString:(id)arg1;	// IMP=0x00000000001be74d
- (void).cxx_destruct;	// IMP=0x00000000001c32e0
...
- (id)init;	// IMP=0x00000000001c2ea8
- (struct CGImage *)_createRGBImageRefForGreyScaleImageRef:(struct CGImage *)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;	// IMP=0x00000000001c2b78
- (struct CGImage *)_createRatingImageWithStringValue:(id)arg1 assetScale:(float *)arg2;	// IMP=0x00000000001c26c4
- (struct CGImage *)_createMaskedImageRefForImageRef:(struct CGImage *)arg1 withPathRef:(struct CGPath *)arg2 andAdornmentStyle:(long long)arg3;	// IMP=0x00000000001c22bc
- (struct CGImage *)_createImageRefWithURL:(id)arg1 adornmentStyle:(long long)arg2 bag:(id)arg3;	// IMP=0x00000000001c16f0
- (struct CGImage *)_createImageRefForImageSource:(struct CGImageSource *)arg1 screenScale:(float)arg2 outAssetScale:(float *)arg3;	// IMP=0x00000000001c1626
- (struct CGImage *)_createImageMaskRefWithSize:(struct CGSize)arg1 andPath:(struct CGPath *)arg2;	// IMP=0x00000000001c1439
- (struct CGImage *)_createImageRefForPDFURL:(id)arg1 outAssetScale:(float *)arg2;	// IMP=0x00000000001c0fb6
- (struct CGImage *)_createImageForResourceName:(id)arg1 outAssetScale:(float *)arg2;	// IMP=0x00000000001c0b4b
- (struct CGImage *)_createDefaultImageWithImageRef:(struct CGImage *)arg1 size:(struct CGSize)arg2 borderPath:(struct CGPath *)arg3;	// IMP=0x00000000001c09b4
- (struct CGPath *)_createBorderPathForAdornmentStyle:(long long)arg1 iconWidth:(double)arg2 iconHeight:(double)arg3;	// IMP=0x00000000001c071a
- (id)_summaryItemsForAttributedList:(id)arg1 assetCache:(id)arg2 bag:(id)arg3;	// IMP=0x00000000001bfc8c
- (id)_replaceImagePlaceholderTagWithImageData:(id)arg1 tag:(id)arg2 data:(id)arg3 scale:(float)arg4 tint:(_Bool)arg5;	// IMP=0x00000000001bf1dc
- (long long)_imageTypeForURL:(id)arg1;	// IMP=0x00000000001bf146
- (id)_contentItemsForFlexibleList:(id)arg1 assetCache:(id)arg2 bag:(id)arg3;	// IMP=0x00000000001beb4d
- (unsigned long long)_countImagePlaceholderTags:(id)arg1;	// IMP=0x00000000001be96d
- (id)ams_createContentItemForSalableInfoWithAssetCache:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001bd80f
- (id)ams_createContentItemForRating;	// IMP=0x00000000001bd707
- (id)ams_createContentItemsForPreScreenDialogWithAssetCache:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001bd66d
- (id)ams_createContentItemsForFlexibleListWithAssetCache:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001bd5d3
- (id)ams_createContentItemForDeviceName:(id)arg1;	// IMP=0x00000000001bd5cb
- (id)ams_createContentItemForAccount;	// IMP=0x00000000001bd27c
- (id)ams_createSummaryItemsForAttributedListWithAssetCache:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001bd1e2
- (id)ams_createSummaryItems;	// IMP=0x00000000001bcc9a
