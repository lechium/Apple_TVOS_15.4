...
- (void).cxx_destruct;	// IMP=0x00000000000c4b6a
...
- (id)perform;	// IMP=0x00000000000c4055
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x00000000000c3f8f
