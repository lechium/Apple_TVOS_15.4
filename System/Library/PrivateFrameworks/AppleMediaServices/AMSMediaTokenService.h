...
+ (id)bagKeySet;	// IMP=0x000000000017716c
+ (id)createBagForSubProfile;	// IMP=0x0000000000175b02
+ (id)bagSubProfileVersion;	// IMP=0x0000000000175ab2
+ (id)bagSubProfile;	// IMP=0x0000000000175a62
- (void).cxx_destruct;	// IMP=0x000000000017726c
...
- (id)initWithClientIdentifier:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x0000000000177157
- (id)_tokenRequestWithError:(id *)arg1;	// IMP=0x0000000000176c0d
- (_Bool)_shouldReturnMediaToken:(id)arg1;	// IMP=0x0000000000176bb4
- (_Bool)_shouldRefreshMediaToken:(id)arg1;	// IMP=0x0000000000176b17
- (void)_refreshMediaTokenIfNeeded:(id)arg1;	// IMP=0x0000000000176ade
- (id)_fetchToken;	// IMP=0x0000000000176105
- (id)_fetchBagProperties;	// IMP=0x0000000000175b9c
- (void)invalidateMediaToken;	// IMP=0x00000000001759ea
- (id)fetchMediaToken;	// IMP=0x0000000000175779
...
- (id)initWithClientIdentifier:(id)arg1 keychainAccessGroup:(id)arg2 bag:(id)arg3;	// IMP=0x0000000000175214
- (id)initWithClientIdentifier:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001751fd
