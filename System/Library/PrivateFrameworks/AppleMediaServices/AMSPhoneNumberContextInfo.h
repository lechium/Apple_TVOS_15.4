...
- (void).cxx_destruct;	// IMP=0x00000000001c8c17
...
- (id)description;	// IMP=0x00000000001c8a62
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x00000000001c89a0
