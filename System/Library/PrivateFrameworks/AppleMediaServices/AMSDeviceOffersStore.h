...
+ (id)serialsFromGroups:(id)arg1;	// IMP=0x000000000010923d
+ (id)serialsBySubtractingAGroups:(id)arg1 fromBGroups:(id)arg2;	// IMP=0x0000000000109159
+ (id)splitGroups:(id)arg1 byItem:(id)arg2;	// IMP=0x0000000000108e0d
- (void)removeCachedRegistrationItem:(id)arg1;	// IMP=0x0000000000108d2c
- (void)_dbSetNullableValue:(id)arg1 forKey:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000108c76
