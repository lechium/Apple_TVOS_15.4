...
+ (id)componentsFromBackingIdentifier:(id)arg1;	// IMP=0x00000000001485ae
+ (id)backingIdentifierForIdentifier:(id)arg1 account:(id)arg2;	// IMP=0x0000000000148483
- (void).cxx_destruct;	// IMP=0x00000000001497cb
...
- (id)postMetricsWithBagContract:(id)arg1;	// IMP=0x0000000000149604
- (_Bool)shouldOverwriteItem:(id)arg1;	// IMP=0x00000000001493ee
- (id)postMetricsWithBag:(id)arg1;	// IMP=0x0000000000149074
- (id)generateItem;	// IMP=0x0000000000148746
...
- (id)initWithFollowUpItem:(id)arg1;	// IMP=0x0000000000146d1a
- (id)initWithIdentifier:(id)arg1 account:(id)arg2 priority:(long long)arg3;	// IMP=0x0000000000146be4
