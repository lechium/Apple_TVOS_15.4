...
- (void).cxx_destruct;	// IMP=0x0000000000179ae0
...
- (void)_teardownKeychainNotifications;	// IMP=0x00000000001799ed
- (void)_setupKeychainNotifications;	// IMP=0x000000000017991d
- (void)_postMediaTokenChangedNotification;	// IMP=0x0000000000179881
- (void)_mediaTokenChanged;	// IMP=0x00000000001796c4
- (id)_mediaTokenChangedNotificationName;	// IMP=0x0000000000179625
- (id)_keychainAccessGroup;	// IMP=0x00000000001795a8
- (_Bool)_hasAppleGroupEnabled;	// IMP=0x00000000001794e6
- (void)dealloc;	// IMP=0x00000000001794a8
- (void)storeToken:(id)arg1;	// IMP=0x0000000000179337
- (id)retrieveToken;	// IMP=0x0000000000178fff
- (id)initWithClientIdentifier:(id)arg1 keychainAccessGroup:(id)arg2;	// IMP=0x0000000000178d72
