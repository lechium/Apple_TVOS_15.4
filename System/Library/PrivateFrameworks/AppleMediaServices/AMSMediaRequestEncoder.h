...
+ (id)createBagForSubProfile;	// IMP=0x000000000016ee2c
+ (id)bagSubProfileVersion;	// IMP=0x000000000016ee13
+ (id)bagSubProfile;	// IMP=0x000000000016edfa
- (void).cxx_destruct;	// IMP=0x00000000001700b4
...
- (id)requestByEncodingRequest:(id)arg1 parameters:(id)arg2;	// IMP=0x000000000016f4ca
- (id)requestWithURL:(id)arg1;	// IMP=0x000000000016f462
- (id)requestWithComponents:(id)arg1;	// IMP=0x000000000016f400
...
- (id)initWithTokenService:(id)arg1 bag:(id)arg2;	// IMP=0x000000000016ed40
