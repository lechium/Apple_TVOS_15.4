...
- (void).cxx_destruct;	// IMP=0x00000000001e2bc0
...
- (id)initWithConfiguration:(id)arg1 bagContract:(id)arg2;	// IMP=0x00000000001e2b09
@property(readonly, nonatomic) NSDictionary *enabledParsables;
- (_Bool)shouldHandleNotification:(id)arg1;	// IMP=0x00000000001e270d
- (void)handleNotification:(id)arg1;	// IMP=0x00000000001e1f18
@property(nonatomic) __weak id <AMSPushHandlerDelegate> delegate;
- (id)initWithConfiguration:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001e1d9b
