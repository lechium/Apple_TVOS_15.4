...
- (void).cxx_destruct;	// IMP=0x0000000000174929
...
- (id)_devicePlatform;	// IMP=0x00000000001745dd
- (void)_addSearchTerm:(id)arg1;	// IMP=0x00000000001743f6
- (void)_addItemIdentifiers:(id)arg1;	// IMP=0x00000000001741cd
- (void)_addCharts:(id)arg1;	// IMP=0x00000000001740ae
- (void)_addBundleIdentifiers:(id)arg1;	// IMP=0x0000000000173f04
- (id)_queryItemsWithLanguage:(id)arg1;	// IMP=0x0000000000173718
- (id)_pathPromise;	// IMP=0x00000000001731b7
- (id)_languagePromise;	// IMP=0x0000000000172dc5
- (id)_hostPromise;	// IMP=0x0000000000172d00
- (id)_verifyConfiguration;	// IMP=0x00000000001729e5
- (id)build;	// IMP=0x0000000000172665
- (id)initWithConfig:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x0000000000172590
