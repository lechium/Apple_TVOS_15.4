...
- (void).cxx_destruct;	// IMP=0x00000000001144d0
...
- (id)exportObject;	// IMP=0x000000000011401a
- (id)initWithIdentifier:(id)arg1 cacheObject:(id)arg2;	// IMP=0x0000000000113ab1
