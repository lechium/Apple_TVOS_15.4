...
- (void).cxx_destruct;	// IMP=0x00000000001d137a
...
- (id)nextPurchase;	// IMP=0x00000000001d12d5
- (_Bool)finishPurchase:(id)arg1 withResult:(id)arg2;	// IMP=0x00000000001d0f8a
- (_Bool)finishPurchase:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001d0b13
- (id)purchaseForPurchaseId:(id)arg1;	// IMP=0x00000000001d0a55
- (id)initWithPurchases:(id)arg1 weakPromise:(id)arg2;	// IMP=0x00000000001d07ba
