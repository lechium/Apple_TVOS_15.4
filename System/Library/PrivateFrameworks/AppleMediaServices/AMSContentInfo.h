...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000e008a
- (void).cxx_destruct;	// IMP=0x00000000000e0119
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000dff16
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000dfdca
