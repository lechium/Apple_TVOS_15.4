...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000365d9
- (void).cxx_destruct;	// IMP=0x0000000000036768
...
- (Class)clientPromiseClass;	// IMP=0x00000000000366cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000365e1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000036465
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000362ec
