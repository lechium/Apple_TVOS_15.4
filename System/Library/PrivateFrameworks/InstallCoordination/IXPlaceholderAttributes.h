...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003df31
- (void).cxx_destruct;	// IMP=0x000000000003faf4
...
- (id)description;	// IMP=0x000000000003f929
- (id)infoPlistContent;	// IMP=0x000000000003f62a
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x000000000003f3e3
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x000000000003ed75
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x000000000003ecde
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003ec29
- (id)_plistKeys;	// IMP=0x000000000003eb87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e91c
- (unsigned long long)hash;	// IMP=0x000000000003e6ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003df39
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003dc8a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003d96e
- (id)init;	// IMP=0x000000000003d93f
