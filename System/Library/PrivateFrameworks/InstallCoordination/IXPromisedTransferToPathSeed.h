...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004b470
- (void).cxx_destruct;	// IMP=0x000000000004b5a3
...
- (Class)clientPromiseClass;	// IMP=0x000000000004b52d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004b478
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004b38a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004b2a4
