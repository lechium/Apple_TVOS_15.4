...
- (void).cxx_destruct;	// IMP=0x00000000000374bd
@property(retain, nonatomic) NSString *targetLastPathComponent; // @synthesize targetLastPathComponent=_targetLastPathComponent;
- (id)targetLastPathComponentWithError:(id *)arg1;	// IMP=0x00000000000370f1
- (_Bool)setTargetLastPathComponent:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000036dbd
@property(readonly, nonatomic) NSURL *stagingBaseDir; // @dynamic stagingBaseDir;
- (Class)seedClass;	// IMP=0x0000000000036d5c
