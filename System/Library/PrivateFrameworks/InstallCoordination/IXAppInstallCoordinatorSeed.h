...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004b98f
- (void).cxx_destruct;	// IMP=0x000000000004be48
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004bccf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004bb3f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004b997
