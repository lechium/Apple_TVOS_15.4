...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000033c4d
...
- (id)description;	// IMP=0x000000000003430b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000033ec0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000033de5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000033d09
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000033c55
- (id)init;	// IMP=0x0000000000033bbb
