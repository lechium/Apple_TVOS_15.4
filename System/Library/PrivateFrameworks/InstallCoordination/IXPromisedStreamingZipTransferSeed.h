...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000029176
- (void).cxx_destruct;	// IMP=0x0000000000029302
...
- (Class)clientPromiseClass;	// IMP=0x0000000000029269
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002917e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000029002
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000028e89
