...
+ (id)sectionWithLocalizedArray:(id)arg1 title:(id)arg2 footer:(id)arg3;	// IMP=0x000000000001afcf
+ (id)sectionWithKeyValues:(id)arg1;	// IMP=0x000000000001af7e
- (void).cxx_destruct;	// IMP=0x000000000001b306
...
- (id)initWithSectionTitle:(id)arg1 footer:(id)arg2 keyValues:(id)arg3;	// IMP=0x000000000001b1fe
