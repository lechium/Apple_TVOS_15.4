...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000f6ba
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f77f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000f6c2
- (id)initWithProfile:(id)arg1;	// IMP=0x000000000000f58b
