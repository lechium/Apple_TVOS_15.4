...
+ (id)localizedPluralForm;	// IMP=0x000000000005194e
+ (id)localizedSingularForm;	// IMP=0x000000000005193b
+ (id)typeStrings;	// IMP=0x000000000005191b
- (void).cxx_destruct;	// IMP=0x0000000000052c9c
...
- (_Bool)containsSensitiveUserInformation;	// IMP=0x0000000000052b27
- (id)payloadDescriptionKeyValueSections;	// IMP=0x00000000000525ef
- (id)subtitle2Description;	// IMP=0x000000000005255d
- (id)subtitle2Label;	// IMP=0x00000000000524d6
- (id)subtitle1Description;	// IMP=0x00000000000524c4
- (id)subtitle1Label;	// IMP=0x000000000005246b
- (id)stubDictionary;	// IMP=0x000000000005227e
- (id)verboseDescription;	// IMP=0x000000000005207b
- (id)initWithDictionary:(id)arg1 profile:(id)arg2 outError:(id *)arg3;	// IMP=0x0000000000051961
