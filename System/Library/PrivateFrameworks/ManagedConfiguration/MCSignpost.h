...
- (void).cxx_destruct;	// IMP=0x00000000000136f7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013607
- (id)initWithProcess:(id)arg1 type:(unsigned long long)arg2 feature:(id)arg3 timestamp:(id)arg4;	// IMP=0x0000000000013515
