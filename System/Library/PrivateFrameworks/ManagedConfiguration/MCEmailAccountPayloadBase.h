...
- (void).cxx_destruct;	// IMP=0x0000000000093966
...
- (_Bool)containsSensitiveUserInformation;	// IMP=0x0000000000093564
- (void)addSMIMEEncryptionPayloadKeysTo:(id)arg1;	// IMP=0x0000000000093051
- (id)payloadDescriptionKeyValueSections;	// IMP=0x0000000000092879
- (id)verboseDescription;	// IMP=0x00000000000923dd
- (id)stubDictionary;	// IMP=0x0000000000092007
- (id)initWithDictionary:(id)arg1 profile:(id)arg2 outError:(id *)arg3;	// IMP=0x000000000009125e
