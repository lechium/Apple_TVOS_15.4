...
+ (id)profileNameFromAccountTag:(id)arg1;	// IMP=0x0000000000032265
+ (id)localizedPluralForm;	// IMP=0x000000000002f9fc
+ (id)localizedSingularForm;	// IMP=0x000000000002f9e9
+ (id)typeStrings;	// IMP=0x000000000002f9c9
- (void).cxx_destruct;	// IMP=0x0000000000032547
...
- (_Bool)containsSensitiveUserInformation;	// IMP=0x0000000000032308
- (id)payloadDescriptionKeyValueSections;	// IMP=0x00000000000315ac
- (id)_authenticationTypeLocalizedString:(id)arg1;	// IMP=0x00000000000314c4
- (id)_emailAccountTypeLocalizedString;	// IMP=0x0000000000031453
- (id)subtitle2Description;	// IMP=0x00000000000313c1
- (id)subtitle2Label;	// IMP=0x000000000003133a
- (id)subtitle1Description;	// IMP=0x0000000000031328
- (id)subtitle1Label;	// IMP=0x00000000000312cf
- (id)verboseDescription;	// IMP=0x0000000000030e9d
- (id)stubDictionary;	// IMP=0x0000000000030b74
- (id)initWithDictionary:(id)arg1 profile:(id)arg2 outError:(id *)arg3;	// IMP=0x000000000002fa0f
- (id)mailAccountIdentifiers;	// IMP=0x00000000000326aa
