...
+ (id)transactionWithURL:(id)arg1 method:(id)arg2;	// IMP=0x0000000000047aa2
- (void).cxx_destruct;	// IMP=0x00000000000492aa
...
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000000049170
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000048fc7
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000000048d67
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000048920
- (_Bool)_shouldAllowTrustWithPinning:(struct __SecTrust *)arg1 forHost:(id)arg2;	// IMP=0x0000000000048551
- (_Bool)_shouldAllowTrust:(struct __SecTrust *)arg1 forHost:(id)arg2;	// IMP=0x00000000000483f7
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000048271
- (void)performCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000047fce
- (void)performSynchronously;	// IMP=0x0000000000047e12
- (void)_beginTransaction;	// IMP=0x0000000000047b51
- (void)dealloc;	// IMP=0x0000000000047b12
- (id)initWithURL:(id)arg1 method:(id)arg2;	// IMP=0x00000000000479e9
- (void)setIdentity:(struct __SecIdentity *)arg1;	// IMP=0x00000000000479b4
- (struct __SecIdentity *)copyIdentity;	// IMP=0x000000000004798e
