...
- (void).cxx_destruct;	// IMP=0x000000000003f7b5
...
- (id)localizedAuthenticationType;	// IMP=0x000000000003f639
- (id)description;	// IMP=0x000000000003f408
- (id)stubDictionary;	// IMP=0x000000000003f1d3
- (id)initWithDictionary:(id)arg1 outError:(id *)arg2;	// IMP=0x000000000003ead4
