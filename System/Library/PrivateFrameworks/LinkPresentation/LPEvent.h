...
- (void).cxx_destruct;	// IMP=0x00000000000310d8
...
- (_Bool)isComplete;	// IMP=0x0000000000030faf
- (_Bool)_childrenAreComplete;	// IMP=0x0000000000030e16
- (void)didCompleteWithStatus:(long long)arg1;	// IMP=0x0000000000030dae
- (void)didCompleteWithErrorCode:(long long)arg1;	// IMP=0x0000000000030d7e
- (id)childWithType:(long long)arg1 subtitle:(id)arg2;	// IMP=0x0000000000030cc6
- (id)initWithType:(long long)arg1 subtitle:(id)arg2;	// IMP=0x0000000000030bd1
- (id)init;	// IMP=0x0000000000030bc3
