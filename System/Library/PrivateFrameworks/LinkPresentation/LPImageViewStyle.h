...
- (void).cxx_destruct;	// IMP=0x000000000003a6f9
...
- (id)emailCompatibleMargin;	// IMP=0x000000000003a4c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a313
- (id)init;	// IMP=0x000000000003a1e6
