...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000db0c
- (void).cxx_destruct;	// IMP=0x000000000000dea8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000dcef
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000dc31
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000db14
- (id)_initWithDictionary:(id)arg1;	// IMP=0x000000000000d9c2
- (id)init;	// IMP=0x000000000000d96d
