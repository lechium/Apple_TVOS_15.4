...
- (void).cxx_destruct;	// IMP=0x000000000003c2c3
...
- (id)rightAccessory;	// IMP=0x000000000003c18c
- (id)leftAccessory;	// IMP=0x000000000003c148
- (id)rightIcon;	// IMP=0x000000000003c104
- (id)leftIcon;	// IMP=0x000000000003c0c0
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000003b5f3
