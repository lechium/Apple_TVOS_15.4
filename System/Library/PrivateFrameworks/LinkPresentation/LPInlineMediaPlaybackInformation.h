...
- (void).cxx_destruct;	// IMP=0x0000000000002d47
...
- (unsigned long long)availability;	// IMP=0x000000000000295f
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x0000000000002906
