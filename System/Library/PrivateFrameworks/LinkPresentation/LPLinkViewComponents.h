...
@class LPCaptionBarView, LPComponentView, LPContactsBadgeView, LPImageView, LPQuoteView, UIView;
...
- (void).cxx_destruct;	// IMP=0x000000000004d00c
...
- (void)applyToAllViews:(CDUnknownBlockType)arg1;	// IMP=0x000000000004ce9f
