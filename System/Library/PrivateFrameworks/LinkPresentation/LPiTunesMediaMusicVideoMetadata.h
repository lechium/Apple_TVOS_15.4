...
+ (id)keyPathsForValuesAffecting_dummyPropertyForObservation;	// IMP=0x0000000000010c77
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000106c8
- (void).cxx_destruct;	// IMP=0x0000000000010d9a
...
- (void)_enumerateAsynchronousFields:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010c62
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010ac1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010948
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010861
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000106d0
- (id)storeIdentifierForTransformer:(id)arg1;	// IMP=0x00000000000284bb
- (void)populateMetadataForBackwardCompatibility:(id)arg1;	// IMP=0x00000000000283d1
- (id)previewImageForTransformer:(id)arg1;	// IMP=0x00000000000283c9
- (id)previewSummaryForTransformer:(id)arg1;	// IMP=0x0000000000028311
- (_Bool)canGeneratePresentationPropertiesForURL:(id)arg1;	// IMP=0x00000000000282f8
- (id)presentationPropertiesForTransformer:(id)arg1;	// IMP=0x00000000000281d2
