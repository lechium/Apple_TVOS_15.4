...
- (void).cxx_destruct;	// IMP=0x0000000000048785
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x00000000000486f7
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x0000000000048093
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x0000000000047d86
- (id)init;	// IMP=0x0000000000047d18
