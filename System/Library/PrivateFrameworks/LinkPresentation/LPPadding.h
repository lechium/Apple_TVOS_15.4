...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000037aef
- (id)_lp_CSSText;	// IMP=0x0000000000037a34
- (struct UIEdgeInsets)asInsetsForLTR:(_Bool)arg1;	// IMP=0x0000000000037980
- (id)init;	// IMP=0x000000000003788d
