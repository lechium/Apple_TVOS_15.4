...
+ (id)iconPlatterCornerRadius;	// IMP=0x0000000000047251
+ (id)iconPlatterPaddingForReason:(long long)arg1;	// IMP=0x00000000000471d9
+ (void)addClient:(id)arg1;	// IMP=0x0000000000046f12
+ (id)themeWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(unsigned long long)arg4 preferredContentSizeCategory:(id)arg5;	// IMP=0x000000000003cab0
+ (id)secondaryLabelColor;	// IMP=0x000000000003ca97
+ (id)primaryLabelColor;	// IMP=0x000000000003ca7e
+ (double)largestIconSizeInPoints;	// IMP=0x000000000003ca70
+ (id)regularTheme;	// IMP=0x000000000003ca3d
+ (void)invalidateThemeCache;	// IMP=0x00000000000474d7
- (void).cxx_destruct;	// IMP=0x00000000000473d9
...
- (id)CSSTextForProperty:(id)arg1 withValue:(id)arg2;	// IMP=0x00000000000470bb
- (id)CSSTextForThemeProperty:(id)arg1;	// IMP=0x0000000000047035
- (id)valueForThemeProperty:(id)arg1;	// IMP=0x0000000000046f90
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x0000000000046f88
- (void)adjustForStyle;	// IMP=0x000000000003d650
- (id)initWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(unsigned long long)arg4 preferredContentSizeCategory:(id)arg5;	// IMP=0x000000000003ccca
