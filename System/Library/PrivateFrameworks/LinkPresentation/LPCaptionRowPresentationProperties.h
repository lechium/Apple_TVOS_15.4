...
- (void).cxx_destruct;	// IMP=0x0000000000024868
@property(retain, nonatomic) LPCaptionButtonPresentationProperties *button; // @synthesize button=_button;
- (void)applyToAllCaptions:(CDUnknownBlockType)arg1;	// IMP=0x00000000000247f9
@property(readonly, nonatomic) _Bool hasAnyContent;
- (id)right;	// IMP=0x0000000000024722
- (id)left;	// IMP=0x00000000000246de
...
- (id)init;	// IMP=0x000000000002461a
