...
- (void).cxx_destruct;	// IMP=0x0000000000038ab3
...
- (id)adjustedForString:(id)arg1;	// IMP=0x00000000000389b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038910
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x0000000000038140
