...
+ (id)recognitionResultsForStrokes:(id)arg1 withRecognizer:(id)arg2 history:(id)arg3 shouldCancel:(CDUnknownBlockType)arg4;	// IMP=0x000000000001b50c
- (void).cxx_destruct;	// IMP=0x000000000001b463
...
- (void)main;	// IMP=0x000000000001b2a1
- (void)dealloc;	// IMP=0x000000000001b24a
- (id)initWithInputManager:(id)arg1 strokes:(id)arg2 history:(id)arg3;	// IMP=0x000000000001b128
