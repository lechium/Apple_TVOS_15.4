...
- (void).cxx_destruct;	// IMP=0x000000000001be3f
...
- (void)main;	// IMP=0x000000000001b92d
- (id)initWithInputManager:(id)arg1 predictionOptions:(unsigned long long)arg2 prefixContext:(id)arg3;	// IMP=0x000000000001b7f5
