...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000c12c
- (void).cxx_destruct;	// IMP=0x000000000000cb68
...
- (id)_initWithSubstring:(id)arg1 range:(struct _NSRange)arg2 timestamp:(double)arg3 duration:(double)arg4 confidence:(float)arg5 alternativeSubstrings:(id)arg6 alternativeConfidences:(id)arg7 phoneSequence:(id)arg8 ipaPhoneSequence:(id)arg9 voiceAnalytics:(id)arg10;	// IMP=0x000000000000c8b1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c3ae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c276
- (id)description;	// IMP=0x000000000000c134
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c121
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000bfb2
- (unsigned long long)hash;	// IMP=0x000000000000bf9c
