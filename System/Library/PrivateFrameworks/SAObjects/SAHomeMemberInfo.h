...
+ (id)homeMemberInfoWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001240b
+ (id)homeMemberInfo;	// IMP=0x00000000000123f9
...
- (id)encodedClassName;	// IMP=0x00000000000123ec
- (id)groupIdentifier;	// IMP=0x00000000000123d8
