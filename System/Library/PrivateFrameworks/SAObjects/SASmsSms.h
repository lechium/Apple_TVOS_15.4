...
+ (id)smsWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000908e
+ (id)sms;	// IMP=0x000000000000907c
...
- (id)encodedClassName;	// IMP=0x000000000000906f
- (id)groupIdentifier;	// IMP=0x000000000000905b
