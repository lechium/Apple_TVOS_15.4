...
+ (id)summaryStructuredAnswerWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000040ca7
+ (id)summaryStructuredAnswer;	// IMP=0x0000000000040c95
...
- (id)encodedClassName;	// IMP=0x0000000000040c88
- (id)groupIdentifier;	// IMP=0x0000000000040c74
