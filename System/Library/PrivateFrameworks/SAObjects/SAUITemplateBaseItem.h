...
+ (id)baseItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000250e6
+ (id)baseItem;	// IMP=0x00000000000250d4
...
- (id)encodedClassName;	// IMP=0x00000000000250c7
- (id)groupIdentifier;	// IMP=0x00000000000250b3
