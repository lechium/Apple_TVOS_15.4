...
+ (id)startSpeechSynthesisRequestWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001ebb4
+ (id)startSpeechSynthesisRequest;	// IMP=0x000000000001eba2
- (_Bool)requiresResponse;	// IMP=0x000000000001ecf0
...
- (id)encodedClassName;	// IMP=0x000000000001eb95
- (id)groupIdentifier;	// IMP=0x000000000001eb81
