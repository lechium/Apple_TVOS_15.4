...
+ (id)answerPropertyWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003eb97
+ (id)answerProperty;	// IMP=0x000000000003eb85
...
- (id)encodedClassName;	// IMP=0x000000000003eb78
- (id)groupIdentifier;	// IMP=0x000000000003eb64
