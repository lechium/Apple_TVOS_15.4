...
+ (id)viewTemplateActionWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003518e
+ (id)viewTemplateAction;	// IMP=0x000000000003517c
@property(copy, nonatomic) NSString *viewTitle;
@property(retain, nonatomic) SASTItemGroup *itemGroupView;
@property(copy, nonatomic) NSArray *commands;
- (id)encodedClassName;	// IMP=0x000000000003516f
- (id)groupIdentifier;	// IMP=0x000000000003515b
