...
+ (id)aceViewWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002fbf1
+ (id)aceView;	// IMP=0x000000000002fbdf
...
- (id)encodedClassName;	// IMP=0x000000000002fbd2
- (id)groupIdentifier;	// IMP=0x000000000002fbbe
