...
+ (id)collectionViewCellWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000030964
+ (id)collectionViewCell;	// IMP=0x0000000000030952
...
- (id)encodedClassName;	// IMP=0x0000000000030945
- (id)groupIdentifier;	// IMP=0x0000000000030931
