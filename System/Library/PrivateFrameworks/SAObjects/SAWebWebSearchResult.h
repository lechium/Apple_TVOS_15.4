...
+ (id)webSearchResultWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002a99f
+ (id)webSearchResult;	// IMP=0x000000000002a98d
...
- (id)encodedClassName;	// IMP=0x000000000002a980
- (id)groupIdentifier;	// IMP=0x000000000002a96c
