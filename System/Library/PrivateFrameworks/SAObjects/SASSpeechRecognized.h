...
+ (id)speechRecognizedWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000007c63
+ (id)speechRecognized;	// IMP=0x0000000000007c51
- (_Bool)requiresResponse;	// IMP=0x0000000000007d7d
...
- (id)encodedClassName;	// IMP=0x0000000000007c44
- (id)groupIdentifier;	// IMP=0x0000000000007c30
