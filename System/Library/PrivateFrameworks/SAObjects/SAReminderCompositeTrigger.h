...
+ (id)compositeTriggerWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001eff1
+ (id)compositeTrigger;	// IMP=0x000000000001efdf
...
- (id)encodedClassName;	// IMP=0x000000000001efd2
- (id)groupIdentifier;	// IMP=0x000000000001efbe
