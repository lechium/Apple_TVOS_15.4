...
+ (id)teamWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000221be
+ (id)team;	// IMP=0x00000000000221ac
...
- (id)encodedClassName;	// IMP=0x000000000002219f
- (id)groupIdentifier;	// IMP=0x000000000002218b
