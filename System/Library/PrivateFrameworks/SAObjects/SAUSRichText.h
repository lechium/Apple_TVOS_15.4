...
+ (id)richTextWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003b4d9
+ (id)richText;	// IMP=0x000000000003b4c7
...
- (id)encodedClassName;	// IMP=0x000000000003b4ba
- (id)groupIdentifier;	// IMP=0x000000000003b4a6
