...
+ (id)updateWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000a8c3
+ (id)update;	// IMP=0x000000000000a8b1
- (_Bool)requiresResponse;	// IMP=0x000000000000a9f9
...
- (id)encodedClassName;	// IMP=0x000000000000a8a4
- (id)groupIdentifier;	// IMP=0x000000000000a890
