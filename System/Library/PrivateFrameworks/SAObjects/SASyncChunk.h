...
+ (id)chunkWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000adf2
+ (id)chunk;	// IMP=0x000000000000ade0
- (_Bool)mutatingCommand;	// IMP=0x000000000000af6e
- (_Bool)requiresResponse;	// IMP=0x000000000000af66
...
- (id)encodedClassName;	// IMP=0x000000000000add3
- (id)groupIdentifier;	// IMP=0x000000000000adbf
