...
+ (id)objectWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000141b7
+ (id)object;	// IMP=0x00000000000141a5
...
- (id)encodedClassName;	// IMP=0x0000000000014198
- (id)groupIdentifier;	// IMP=0x0000000000014184
