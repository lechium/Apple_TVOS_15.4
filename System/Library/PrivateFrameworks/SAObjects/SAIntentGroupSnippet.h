...
+ (id)snippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003fcd5
+ (id)snippet;	// IMP=0x000000000003fcc3
...
- (id)encodedClassName;	// IMP=0x000000000003fcb6
- (id)groupIdentifier;	// IMP=0x000000000003fca2
