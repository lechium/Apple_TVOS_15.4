...
+ (id)locationTriggerWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000015343
+ (id)locationTrigger;	// IMP=0x0000000000015331
...
- (id)encodedClassName;	// IMP=0x0000000000015324
- (id)groupIdentifier;	// IMP=0x0000000000015310
