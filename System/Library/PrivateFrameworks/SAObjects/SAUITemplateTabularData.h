...
+ (id)tabularDataWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000030b2c
+ (id)tabularData;	// IMP=0x0000000000030b1a
...
- (id)encodedClassName;	// IMP=0x0000000000030b0d
- (id)groupIdentifier;	// IMP=0x0000000000030af9
