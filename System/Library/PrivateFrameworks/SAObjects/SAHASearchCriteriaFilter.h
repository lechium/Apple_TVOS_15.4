...
+ (id)searchCriteriaFilterWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000016687
+ (id)searchCriteriaFilter;	// IMP=0x0000000000016675
...
- (id)encodedClassName;	// IMP=0x0000000000016668
- (id)groupIdentifier;	// IMP=0x0000000000016654
