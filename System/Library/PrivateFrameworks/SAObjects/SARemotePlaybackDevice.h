...
+ (id)remotePlaybackDeviceWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001f41c
+ (id)remotePlaybackDevice;	// IMP=0x000000000001f40a
...
- (id)encodedClassName;	// IMP=0x000000000001f3fd
- (id)groupIdentifier;	// IMP=0x000000000001f3e9
