...
+ (id)unitsWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001a46e
+ (id)units;	// IMP=0x000000000001a45c
...
- (id)encodedClassName;	// IMP=0x000000000001a44f
- (id)groupIdentifier;	// IMP=0x000000000001a43b
