...
+ (id)guideSnippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000110ca
+ (id)guideSnippet;	// IMP=0x00000000000110b8
...
- (id)encodedClassName;	// IMP=0x00000000000110ab
- (id)groupIdentifier;	// IMP=0x0000000000011097
