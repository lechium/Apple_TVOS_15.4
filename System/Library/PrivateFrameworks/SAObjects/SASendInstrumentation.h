...
+ (id)sendInstrumentationWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001d59d
+ (id)sendInstrumentation;	// IMP=0x000000000001d58b
- (_Bool)requiresResponse;	// IMP=0x000000000001d62f
...
- (id)encodedClassName;	// IMP=0x000000000001d57e
- (id)groupIdentifier;	// IMP=0x000000000001d56a
