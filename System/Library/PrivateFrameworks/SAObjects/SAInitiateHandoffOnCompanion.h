...
+ (id)initiateHandoffOnCompanionWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000001ffe
+ (id)initiateHandoffOnCompanion;	// IMP=0x0000000000001fec
- (_Bool)requiresResponse;	// IMP=0x00000000000020d4
...
- (id)encodedClassName;	// IMP=0x0000000000001fdf
- (id)groupIdentifier;	// IMP=0x0000000000001fcb
