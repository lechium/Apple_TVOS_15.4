...
+ (id)abstractObjectWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001bd6b
+ (id)abstractObject;	// IMP=0x000000000001bd59
...
- (id)encodedClassName;	// IMP=0x000000000001bd4c
- (id)groupIdentifier;	// IMP=0x000000000001bd38
