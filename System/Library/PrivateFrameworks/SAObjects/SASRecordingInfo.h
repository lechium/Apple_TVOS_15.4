...
+ (id)recordingInfoWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000cf07
+ (id)recordingInfo;	// IMP=0x000000000000cef5
...
- (id)encodedClassName;	// IMP=0x000000000000cee8
- (id)groupIdentifier;	// IMP=0x000000000000ced4
