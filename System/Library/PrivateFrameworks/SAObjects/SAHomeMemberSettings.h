...
+ (id)homeMemberSettingsWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000032480
+ (id)homeMemberSettings;	// IMP=0x000000000003246e
...
- (id)encodedClassName;	// IMP=0x0000000000032461
- (id)groupIdentifier;	// IMP=0x000000000003244d
