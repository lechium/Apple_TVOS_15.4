...
+ (id)callHistoryWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002ac1c
+ (id)callHistory;	// IMP=0x000000000002ac0a
...
- (id)encodedClassName;	// IMP=0x000000000002abfd
- (id)groupIdentifier;	// IMP=0x000000000002abe9
