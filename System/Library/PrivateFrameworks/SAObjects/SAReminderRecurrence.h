...
+ (id)recurrenceWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000015a32
+ (id)recurrence;	// IMP=0x0000000000015a20
...
- (id)encodedClassName;	// IMP=0x0000000000015a13
- (id)groupIdentifier;	// IMP=0x00000000000159ff
