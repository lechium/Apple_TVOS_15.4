...
+ (id)addViewsWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000008b3d
+ (id)addViews;	// IMP=0x0000000000008b2b
...
- (id)encodedClassName;	// IMP=0x0000000000008b1e
- (id)groupIdentifier;	// IMP=0x0000000000008b0a
