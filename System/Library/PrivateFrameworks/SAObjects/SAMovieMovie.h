...
+ (id)movieWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000242ab
+ (id)movie;	// IMP=0x0000000000024299
...
- (id)encodedClassName;	// IMP=0x000000000002428c
- (id)groupIdentifier;	// IMP=0x0000000000024278
