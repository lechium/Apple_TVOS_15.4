...
+ (id)objectLineWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001eaa2
+ (id)objectLine;	// IMP=0x000000000001ea90
...
- (id)encodedClassName;	// IMP=0x000000000001ea83
- (id)groupIdentifier;	// IMP=0x000000000001ea6f
