...
+ (id)userActivityWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000015cb
+ (id)userActivity;	// IMP=0x00000000000015b9
...
- (id)encodedClassName;	// IMP=0x00000000000015ac
- (id)groupIdentifier;	// IMP=0x0000000000001598
