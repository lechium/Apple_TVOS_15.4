...
+ (id)paragraphStyleWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001afd3
+ (id)paragraphStyle;	// IMP=0x000000000001afc1
...
- (id)encodedClassName;	// IMP=0x000000000001afb4
- (id)groupIdentifier;	// IMP=0x000000000001afa0
