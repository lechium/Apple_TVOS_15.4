...
+ (id)tableRowItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003b13d
+ (id)tableRowItem;	// IMP=0x000000000003b12b
...
- (id)encodedClassName;	// IMP=0x000000000003b11e
- (id)groupIdentifier;	// IMP=0x000000000003b10a
