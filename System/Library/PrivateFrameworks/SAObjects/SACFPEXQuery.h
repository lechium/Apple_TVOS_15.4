...
+ (id)queryWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000004086d
+ (id)query;	// IMP=0x000000000004085b
- (_Bool)requiresResponse;	// IMP=0x0000000000040a0f
...
- (id)encodedClassName;	// IMP=0x000000000004084e
- (id)groupIdentifier;	// IMP=0x000000000004083a
