...
+ (id)steerMusicWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000332a4
+ (id)steerMusic;	// IMP=0x0000000000033292
- (_Bool)requiresResponse;	// IMP=0x0000000000033336
...
- (id)encodedClassName;	// IMP=0x0000000000033285
- (id)groupIdentifier;	// IMP=0x0000000000033271
