...
+ (id)leagueWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000239e7
+ (id)league;	// IMP=0x00000000000239d5
...
- (id)encodedClassName;	// IMP=0x00000000000239c8
- (id)groupIdentifier;	// IMP=0x00000000000239b4
