...
+ (id)imageViewWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003db67
+ (id)imageView;	// IMP=0x000000000003db55
...
- (id)encodedClassName;	// IMP=0x000000000003db48
- (id)groupIdentifier;	// IMP=0x000000000003db34
