...
+ (id)specificAnswerItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002f339
+ (id)specificAnswerItem;	// IMP=0x000000000002f327
...
- (id)encodedClassName;	// IMP=0x000000000002f31a
- (id)groupIdentifier;	// IMP=0x000000000002f306
