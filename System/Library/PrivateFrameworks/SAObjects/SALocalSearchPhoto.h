...
+ (id)photoWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000294d8
+ (id)photo;	// IMP=0x00000000000294c6
...
- (id)encodedClassName;	// IMP=0x00000000000294b9
- (id)groupIdentifier;	// IMP=0x00000000000294a5
