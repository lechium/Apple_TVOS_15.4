...
+ (id)processIntentCompletedWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003f09f
+ (id)processIntentCompleted;	// IMP=0x000000000003f08d
- (_Bool)requiresResponse;	// IMP=0x000000000003f131
...
- (id)encodedClassName;	// IMP=0x000000000003f080
- (id)groupIdentifier;	// IMP=0x000000000003f06c
