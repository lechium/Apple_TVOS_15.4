...
+ (id)movieRatingReviewItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000041a73
+ (id)movieRatingReviewItem;	// IMP=0x0000000000041a61
...
- (id)encodedClassName;	// IMP=0x0000000000041a54
- (id)groupIdentifier;	// IMP=0x0000000000041a40
