...
+ (id)startCorrectedSpeechRequestWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001a82f
+ (id)startCorrectedSpeechRequest;	// IMP=0x000000000001a81d
- (_Bool)requiresResponse;	// IMP=0x000000000001a96b
...
- (id)encodedClassName;	// IMP=0x000000000001a810
- (id)groupIdentifier;	// IMP=0x000000000001a7fc
