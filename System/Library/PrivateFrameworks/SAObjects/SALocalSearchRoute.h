...
+ (id)routeWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000270cf
+ (id)route;	// IMP=0x00000000000270bd
...
- (id)encodedClassName;	// IMP=0x00000000000270b0
- (id)groupIdentifier;	// IMP=0x000000000002709c
