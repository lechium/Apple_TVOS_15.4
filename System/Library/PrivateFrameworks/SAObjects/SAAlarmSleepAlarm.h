...
+ (id)sleepAlarmWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002c040
...
- (id)encodedClassName;	// IMP=0x000000000002c033
- (id)groupIdentifier;	// IMP=0x000000000002c01f
