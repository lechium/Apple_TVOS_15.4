...
+ (id)userStateWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000009aba
+ (id)userState;	// IMP=0x0000000000009aa8
...
- (id)encodedClassName;	// IMP=0x0000000000009a9b
- (id)groupIdentifier;	// IMP=0x0000000000009a87
