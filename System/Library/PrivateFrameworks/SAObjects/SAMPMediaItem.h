...
+ (id)mediaItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000d67d
+ (id)mediaItem;	// IMP=0x000000000000d66b
...
- (id)encodedClassName;	// IMP=0x000000000000d65e
- (id)groupIdentifier;	// IMP=0x000000000000d64a
