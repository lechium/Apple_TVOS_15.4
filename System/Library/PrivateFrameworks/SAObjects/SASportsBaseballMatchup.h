...
+ (id)baseballMatchupWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000023faf
+ (id)baseballMatchup;	// IMP=0x0000000000023f9d
...
- (id)encodedClassName;	// IMP=0x0000000000023f90
- (id)groupIdentifier;	// IMP=0x0000000000023f7c
