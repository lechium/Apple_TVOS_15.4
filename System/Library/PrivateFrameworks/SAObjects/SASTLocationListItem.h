...
+ (id)locationListItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000d93b
+ (id)locationListItem;	// IMP=0x000000000000d929
...
- (id)encodedClassName;	// IMP=0x000000000000d91c
- (id)groupIdentifier;	// IMP=0x000000000000d908
