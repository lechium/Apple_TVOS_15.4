...
+ (id)speechSynthesisStreamingBeginWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000105fe
+ (id)speechSynthesisStreamingBegin;	// IMP=0x00000000000105ec
- (_Bool)requiresResponse;	// IMP=0x00000000000106d4
...
- (id)encodedClassName;	// IMP=0x00000000000105df
- (id)groupIdentifier;	// IMP=0x00000000000105cb
