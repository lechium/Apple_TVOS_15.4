...
+ (id)entityWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001f7c1
+ (id)entity;	// IMP=0x000000000001f7af
...
- (id)encodedClassName;	// IMP=0x000000000001f7a2
- (id)groupIdentifier;	// IMP=0x000000000001f78e
