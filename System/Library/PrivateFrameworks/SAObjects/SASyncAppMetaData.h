...
+ (id)appMetaDataWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000016f41
+ (id)appMetaData;	// IMP=0x0000000000016f2f
...
- (id)encodedClassName;	// IMP=0x0000000000016f22
- (id)groupIdentifier;	// IMP=0x0000000000016f0e
