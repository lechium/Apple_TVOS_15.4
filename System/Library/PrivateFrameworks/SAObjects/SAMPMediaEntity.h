...
+ (id)mediaEntityWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000d250
+ (id)mediaEntity;	// IMP=0x000000000000d23e
...
- (id)encodedClassName;	// IMP=0x000000000000d231
- (id)groupIdentifier;	// IMP=0x000000000000d21d
