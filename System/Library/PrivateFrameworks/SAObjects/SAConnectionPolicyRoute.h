...
+ (id)connectionPolicyRouteWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000237b3
+ (id)connectionPolicyRoute;	// IMP=0x00000000000237a1
...
- (id)encodedClassName;	// IMP=0x0000000000023794
- (id)groupIdentifier;	// IMP=0x0000000000023780
