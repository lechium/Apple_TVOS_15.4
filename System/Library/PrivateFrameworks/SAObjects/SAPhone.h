...
+ (id)phoneWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000374c7
+ (id)phone;	// IMP=0x00000000000374b5
...
- (id)encodedClassName;	// IMP=0x00000000000374a8
- (id)groupIdentifier;	// IMP=0x0000000000037494
