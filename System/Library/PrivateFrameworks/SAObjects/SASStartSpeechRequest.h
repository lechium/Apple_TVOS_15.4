...
+ (id)startSpeechRequestWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000017688
+ (id)startSpeechRequest;	// IMP=0x0000000000017676
- (_Bool)requiresResponse;	// IMP=0x00000000000177e6
...
- (id)encodedClassName;	// IMP=0x0000000000017669
- (id)groupIdentifier;	// IMP=0x0000000000017655
