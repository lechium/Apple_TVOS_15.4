...
+ (id)setQueueWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000e431
+ (id)setQueue;	// IMP=0x000000000000e41f
- (_Bool)mutatingCommand;	// IMP=0x000000000000e635
- (_Bool)requiresResponse;	// IMP=0x000000000000e62d
...
- (id)encodedClassName;	// IMP=0x000000000000e412
- (id)groupIdentifier;	// IMP=0x000000000000e3fe
