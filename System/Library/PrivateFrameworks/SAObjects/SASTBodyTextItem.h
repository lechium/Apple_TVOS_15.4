...
+ (id)bodyTextItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000039b8d
+ (id)bodyTextItem;	// IMP=0x0000000000039b7b
@property(copy, nonatomic) NSString *position;
@property(retain, nonatomic) SADecoratedString *decoratedBodyText;
@property(copy, nonatomic) NSString *bodyText;
@property(copy, nonatomic) NSString *alignment;
- (id)encodedClassName;	// IMP=0x0000000000039b6e
- (id)groupIdentifier;	// IMP=0x0000000000039b5a
