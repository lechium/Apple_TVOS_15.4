...
+ (id)baseItemGroupWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000034f66
+ (id)baseItemGroup;	// IMP=0x0000000000034f54
@property(copy, nonatomic) NSArray *templateItems;
- (id)encodedClassName;	// IMP=0x0000000000034f47
- (id)groupIdentifier;	// IMP=0x0000000000034f33
