...
+ (id)matchupWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000021347
+ (id)matchup;	// IMP=0x0000000000021335
...
- (id)encodedClassName;	// IMP=0x0000000000021328
- (id)groupIdentifier;	// IMP=0x0000000000021314
