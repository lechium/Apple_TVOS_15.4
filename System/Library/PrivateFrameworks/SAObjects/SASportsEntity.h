...
+ (id)entityWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000208cb
+ (id)entity;	// IMP=0x00000000000208b9
...
- (id)encodedClassName;	// IMP=0x00000000000208ac
- (id)groupIdentifier;	// IMP=0x0000000000020898
