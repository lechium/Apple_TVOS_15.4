...
+ (id)startWorkoutWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000192e8
+ (id)startWorkout;	// IMP=0x00000000000192d6
- (_Bool)requiresResponse;	// IMP=0x000000000001939c
...
- (id)encodedClassName;	// IMP=0x00000000000192c9
- (id)groupIdentifier;	// IMP=0x00000000000192b5
