...
+ (id)confirmationViewWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001f283
+ (id)confirmationView;	// IMP=0x000000000001f271
...
- (id)encodedClassName;	// IMP=0x000000000001f264
- (id)groupIdentifier;	// IMP=0x000000000001f250
