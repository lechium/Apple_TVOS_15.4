...
+ (id)confidenceScoresWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002b667
+ (id)confidenceScores;	// IMP=0x000000000002b655
- (_Bool)requiresResponse;	// IMP=0x000000000002b77b
...
- (id)encodedClassName;	// IMP=0x000000000002b648
- (id)groupIdentifier;	// IMP=0x000000000002b634
