...
+ (id)aceMicroblogSearchResultWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000e670
+ (id)aceMicroblogSearchResult;	// IMP=0x000000000000e65e
...
- (id)encodedClassName;	// IMP=0x000000000000e651
- (id)groupIdentifier;	// IMP=0x000000000000e63d
