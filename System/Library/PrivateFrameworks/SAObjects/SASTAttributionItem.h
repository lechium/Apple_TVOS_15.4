...
+ (id)attributionItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003f3e0
+ (id)attributionItem;	// IMP=0x000000000003f3ce
...
- (id)encodedClassName;	// IMP=0x000000000003f3c1
- (id)groupIdentifier;	// IMP=0x000000000003f3ad
