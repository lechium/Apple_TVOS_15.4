...
+ (id)clientFlowRequestCallbackWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000127f4
+ (id)clientFlowRequestCallback;	// IMP=0x00000000000127e2
...
- (id)encodedClassName;	// IMP=0x00000000000127d5
- (id)groupIdentifier;	// IMP=0x00000000000127c1
