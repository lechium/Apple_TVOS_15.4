...
+ (id)theaterShowtimeListCellWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002ba27
+ (id)theaterShowtimeListCell;	// IMP=0x000000000002ba15
...
- (id)encodedClassName;	// IMP=0x000000000002ba08
- (id)groupIdentifier;	// IMP=0x000000000002b9f4
