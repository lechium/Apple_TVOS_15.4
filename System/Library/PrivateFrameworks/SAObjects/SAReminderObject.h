...
+ (id)objectWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000015620
+ (id)object;	// IMP=0x000000000001560e
...
- (id)encodedClassName;	// IMP=0x0000000000015601
- (id)groupIdentifier;	// IMP=0x00000000000155ed
