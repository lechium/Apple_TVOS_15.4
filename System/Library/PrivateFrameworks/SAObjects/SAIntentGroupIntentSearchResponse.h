...
+ (id)intentSearchResponseWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000020b03
+ (id)intentSearchResponse;	// IMP=0x0000000000020af1
- (_Bool)requiresResponse;	// IMP=0x0000000000020b8f
@property(copy, nonatomic) NSArray *metadata;
@property(copy, nonatomic) NSString *jsonEncodedIntent;
@property(retain, nonatomic) SAIntentGroupProtobufMessage *intent;
- (id)encodedClassName;	// IMP=0x0000000000020ae4
- (id)groupIdentifier;	// IMP=0x0000000000020ad0
