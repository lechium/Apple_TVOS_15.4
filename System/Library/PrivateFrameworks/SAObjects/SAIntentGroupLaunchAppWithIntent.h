...
+ (id)launchAppWithIntentWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003b070
+ (id)launchAppWithIntent;	// IMP=0x000000000003b05e
- (_Bool)requiresResponse;	// IMP=0x000000000003b102
...
- (id)encodedClassName;	// IMP=0x000000000003b051
- (id)groupIdentifier;	// IMP=0x000000000003b03d
