...
+ (id)forecastWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000190dc
+ (id)forecast;	// IMP=0x00000000000190ca
...
- (id)encodedClassName;	// IMP=0x00000000000190bd
- (id)groupIdentifier;	// IMP=0x00000000000190a9
