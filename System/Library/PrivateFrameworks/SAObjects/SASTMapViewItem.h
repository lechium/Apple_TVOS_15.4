...
+ (id)mapViewItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002eb49
+ (id)mapViewItem;	// IMP=0x000000000002eb37
...
- (id)encodedClassName;	// IMP=0x000000000002eb2a
- (id)groupIdentifier;	// IMP=0x000000000002eb16
