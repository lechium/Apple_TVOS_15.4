...
+ (id)commandSupportWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003265c
+ (id)commandSupport;	// IMP=0x000000000003264a
...
- (id)encodedClassName;	// IMP=0x000000000003263d
- (id)groupIdentifier;	// IMP=0x0000000000032629
