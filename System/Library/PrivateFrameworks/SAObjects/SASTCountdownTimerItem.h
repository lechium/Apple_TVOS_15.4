...
+ (id)countdownTimerItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000376db
+ (id)countdownTimerItem;	// IMP=0x00000000000376c9
...
- (id)encodedClassName;	// IMP=0x00000000000376bc
- (id)groupIdentifier;	// IMP=0x00000000000376a8
