...
+ (id)objectWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000a1b6
+ (id)object;	// IMP=0x000000000000a1a4
...
- (id)encodedClassName;	// IMP=0x000000000000a197
- (id)groupIdentifier;	// IMP=0x000000000000a183
