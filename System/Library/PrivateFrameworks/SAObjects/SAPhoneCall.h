...
+ (id)callWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000006d80
+ (id)call;	// IMP=0x0000000000006d6e
- (_Bool)requiresResponse;	// IMP=0x0000000000006e56
...
- (id)encodedClassName;	// IMP=0x0000000000006d61
- (id)groupIdentifier;	// IMP=0x0000000000006d4d
