...
+ (id)dictionaryStructuredAnswerWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003c02e
+ (id)dictionaryStructuredAnswer;	// IMP=0x000000000003c01c
...
- (id)encodedClassName;	// IMP=0x000000000003c00f
- (id)groupIdentifier;	// IMP=0x000000000003bffb
