...
+ (id)createAssistantWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000032b7d
+ (id)createAssistant;	// IMP=0x0000000000032b6b
- (_Bool)requiresResponse;	// IMP=0x0000000000032cfd
...
- (id)encodedClassName;	// IMP=0x0000000000032b5e
- (id)groupIdentifier;	// IMP=0x0000000000032b4a
