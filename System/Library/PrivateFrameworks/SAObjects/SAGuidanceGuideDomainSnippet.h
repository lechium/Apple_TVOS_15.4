...
+ (id)guideDomainSnippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000369fa
+ (id)guideDomainSnippet;	// IMP=0x00000000000369e8
...
- (id)encodedClassName;	// IMP=0x00000000000369db
- (id)groupIdentifier;	// IMP=0x00000000000369c7
