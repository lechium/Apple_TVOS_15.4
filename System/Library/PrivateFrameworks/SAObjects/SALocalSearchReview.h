...
+ (id)reviewWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000013961
+ (id)review;	// IMP=0x000000000001394f
...
- (id)encodedClassName;	// IMP=0x0000000000013942
- (id)groupIdentifier;	// IMP=0x000000000001392e
