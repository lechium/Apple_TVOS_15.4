...
+ (id)pronunciationSnippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000004164a
+ (id)pronunciationSnippet;	// IMP=0x0000000000041638
...
- (id)encodedClassName;	// IMP=0x000000000004162b
- (id)groupIdentifier;	// IMP=0x0000000000041617
