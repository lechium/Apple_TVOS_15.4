...
+ (id)startUIRequestWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000100bf
+ (id)startUIRequest;	// IMP=0x00000000000100ad
- (_Bool)requiresResponse;	// IMP=0x000000000001010d
@property(retain, nonatomic) SAStartLocalRequest *startLocalRequest;
@property(retain, nonatomic) SAStartRequest *startRequest;
- (id)encodedClassName;	// IMP=0x00000000000100a0
- (id)groupIdentifier;	// IMP=0x000000000001008c
