...
+ (id)movieDetailSnippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002ccc4
+ (id)movieDetailSnippet;	// IMP=0x000000000002ccb2
...
- (id)encodedClassName;	// IMP=0x000000000002cca5
- (id)groupIdentifier;	// IMP=0x000000000002cc91
