...
+ (id)personSearchWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000010c33
+ (id)personSearch;	// IMP=0x0000000000010c21
- (_Bool)mutatingCommand;	// IMP=0x0000000000010d99
- (_Bool)requiresResponse;	// IMP=0x0000000000010d91
...
- (id)encodedClassName;	// IMP=0x0000000000010c14
- (id)groupIdentifier;	// IMP=0x0000000000010c00
