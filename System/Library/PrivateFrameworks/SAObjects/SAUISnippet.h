...
+ (id)snippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000008826
+ (id)snippet;	// IMP=0x0000000000008814
...
- (id)encodedClassName;	// IMP=0x0000000000008807
- (id)groupIdentifier;	// IMP=0x00000000000087f3
