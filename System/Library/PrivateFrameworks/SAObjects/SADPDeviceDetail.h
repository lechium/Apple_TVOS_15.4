...
+ (id)deviceDetailWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000001170b
+ (id)deviceDetail;	// IMP=0x00000000000116f9
...
- (id)encodedClassName;	// IMP=0x00000000000116ec
- (id)groupIdentifier;	// IMP=0x00000000000116d8
