...
@interface SASidekickHubDeviceInfo <SAServerBoundCommand>
{
}

- (_Bool)requiresResponse;	// IMP=0x000000000001d96e
...
- (id)encodedClassName;	// IMP=0x000000000001d895
- (id)groupIdentifier;	// IMP=0x000000000001d881
