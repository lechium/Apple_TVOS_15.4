...
+ (id)runSiriKitExecutorWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000cb4c
+ (id)runSiriKitExecutor;	// IMP=0x000000000000cb3a
- (_Bool)mutatingCommand;	// IMP=0x000000000000cecc
- (_Bool)requiresResponse;	// IMP=0x000000000000cec4
...
- (id)encodedClassName;	// IMP=0x000000000000cb2d
- (id)groupIdentifier;	// IMP=0x000000000000cb19
