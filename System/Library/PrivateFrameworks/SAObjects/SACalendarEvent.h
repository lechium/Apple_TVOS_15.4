...
+ (id)eventWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000006438
+ (id)event;	// IMP=0x0000000000006426
...
- (id)encodedClassName;	// IMP=0x0000000000006419
- (id)groupIdentifier;	// IMP=0x0000000000006405
