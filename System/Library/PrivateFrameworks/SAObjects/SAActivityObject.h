...
+ (id)activityObjectWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000001718
+ (id)activityObject;	// IMP=0x0000000000001706
...
- (id)encodedClassName;	// IMP=0x00000000000016f9
- (id)groupIdentifier;	// IMP=0x00000000000016e5
