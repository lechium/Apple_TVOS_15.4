...
+ (id)updateAudioInfoWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002b139
+ (id)updateAudioInfo;	// IMP=0x000000000002b127
- (_Bool)requiresResponse;	// IMP=0x000000000002b3be
...
- (id)encodedClassName;	// IMP=0x000000000002b11a
- (id)groupIdentifier;	// IMP=0x000000000002b106
