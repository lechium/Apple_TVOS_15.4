...
+ (id)athleteWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000203c5
+ (id)athlete;	// IMP=0x00000000000203b3
...
- (id)encodedClassName;	// IMP=0x00000000000203a6
- (id)groupIdentifier;	// IMP=0x0000000000020392
