...
+ (id)getNavigationStatusCompletedWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002314b
+ (id)getNavigationStatusCompleted;	// IMP=0x0000000000023139
- (_Bool)requiresResponse;	// IMP=0x0000000000023243
...
- (id)encodedClassName;	// IMP=0x000000000002312c
- (id)groupIdentifier;	// IMP=0x0000000000023118
