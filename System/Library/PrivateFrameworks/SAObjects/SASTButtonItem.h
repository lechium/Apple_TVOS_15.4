...
+ (id)buttonItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003feee
+ (id)buttonItem;	// IMP=0x000000000003fedc
...
- (id)encodedClassName;	// IMP=0x000000000003fecf
- (id)groupIdentifier;	// IMP=0x000000000003febb
