...
+ (id)searchWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000016d91
+ (id)search;	// IMP=0x0000000000016d7f
- (_Bool)requiresResponse;	// IMP=0x0000000000016e3f
...
- (id)encodedClassName;	// IMP=0x0000000000016d72
- (id)groupIdentifier;	// IMP=0x0000000000016d5e
