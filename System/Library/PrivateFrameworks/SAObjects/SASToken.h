...
+ (id)tokenWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000017919
+ (id)token;	// IMP=0x0000000000017907
...
- (id)encodedClassName;	// IMP=0x00000000000178fa
- (id)groupIdentifier;	// IMP=0x00000000000178e6
