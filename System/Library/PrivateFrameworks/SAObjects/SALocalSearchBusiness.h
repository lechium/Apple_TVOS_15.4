...
+ (id)businessWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000012be4
+ (id)business;	// IMP=0x0000000000012bd2
...
- (id)encodedClassName;	// IMP=0x0000000000012bc5
- (id)groupIdentifier;	// IMP=0x0000000000012bb1
