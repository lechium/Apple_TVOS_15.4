...
+ (id)startRequestWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000038e74
+ (id)startRequest;	// IMP=0x0000000000038e62
- (_Bool)requiresResponse;	// IMP=0x000000000003907c
...
- (id)encodedClassName;	// IMP=0x0000000000038e55
- (id)groupIdentifier;	// IMP=0x0000000000038e41
