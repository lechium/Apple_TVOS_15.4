...
+ (id)currentConditionsWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000018cee
+ (id)currentConditions;	// IMP=0x0000000000018cdc
...
- (id)encodedClassName;	// IMP=0x0000000000018ccf
- (id)groupIdentifier;	// IMP=0x0000000000018cbb
