...
+ (id)voiceWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000015cd3
+ (id)voice;	// IMP=0x0000000000015cc1
...
- (id)encodedClassName;	// IMP=0x0000000000015cb4
- (id)groupIdentifier;	// IMP=0x0000000000015ca0
