...
+ (id)ancillaryImageItemWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000008343
+ (id)ancillaryImageItem;	// IMP=0x0000000000008331
...
- (id)encodedClassName;	// IMP=0x0000000000008324
- (id)groupIdentifier;	// IMP=0x0000000000008310
