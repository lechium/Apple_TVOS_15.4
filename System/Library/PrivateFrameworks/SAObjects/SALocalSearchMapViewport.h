...
+ (id)mapViewportWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000003e358
+ (id)mapViewport;	// IMP=0x000000000003e346
...
- (id)encodedClassName;	// IMP=0x000000000003e339
- (id)groupIdentifier;	// IMP=0x000000000003e325
