...
+ (id)mapSnippetTemplateWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000bc3f
+ (id)mapSnippetTemplate;	// IMP=0x000000000000bc2d
...
- (id)encodedClassName;	// IMP=0x000000000000bc20
- (id)groupIdentifier;	// IMP=0x000000000000bc0c
