...
+ (id)business2WithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002527e
+ (id)business2;	// IMP=0x000000000002526c
...
- (id)encodedClassName;	// IMP=0x000000000002525f
- (id)groupIdentifier;	// IMP=0x000000000002524b
