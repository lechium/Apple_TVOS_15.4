...
- (void).cxx_destruct;	// IMP=0x00000000000282c4
@property(readonly, retain, nonatomic) DTTapConfig *config; // @synthesize config=_config;
- (id)handleMemo:(id)arg1;	// IMP=0x0000000000027bac
- (void)resume;	// IMP=0x0000000000027b9e
- (void)suspend;	// IMP=0x0000000000027b90
- (id)initWithConfig:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000027a97
