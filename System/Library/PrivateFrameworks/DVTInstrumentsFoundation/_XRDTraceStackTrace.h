...
- (char *)readNextStackTraceFromBuffer:(char *)arg1 withLength:(unsigned long long)arg2;	// IMP=0x000000000004b010
- (void)dealloc;	// IMP=0x000000000004afd6
- (id)initWithMaxStackDepth:(unsigned int)arg1;	// IMP=0x000000000004af61
