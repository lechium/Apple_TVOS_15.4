...
+ (void)heartbeat;	// IMP=0x000000000001ac32
+ (id)heartbeatPredicate;	// IMP=0x000000000001abff
- (id).cxx_construct;	// IMP=0x00000000000206cd
- (void).cxx_destruct;	// IMP=0x000000000002051f
...
- (void)invalidate;	// IMP=0x000000000002047a
- (void)_setupLiveStream:(id)arg1;	// IMP=0x0000000000020244
- (id)_setupLoggedStreamForNextChunk:(id)arg1;	// IMP=0x000000000002015e
- (void)_setupCommonStreamParameters:(id)arg1;	// IMP=0x000000000001f8b5
- (void)_performResetOnOutputStream;	// IMP=0x000000000001f119
- (void)_handleRecord:(id)arg1;	// IMP=0x000000000001b8f3
- (id)_stackReferenceForRepeatedUUID:(id)arg1;	// IMP=0x000000000001b6f5
- (id)_stackReferenceForRepeatedString:(id)arg1;	// IMP=0x000000000001b581
- (void)_escortAgentToExit:(id)arg1 withTicket:(id)arg2;	// IMP=0x000000000001b4e3
- (void)_prepareAgentToExecute:(id)arg1 withTicket:(id)arg2;	// IMP=0x000000000001b445
- (id)ticketToStopStream:(id)arg1;	// IMP=0x000000000001b42c
- (id)ticketToFetchData:(id)arg1 window:(double)arg2;	// IMP=0x000000000001b3d4
- (id)ticketToPrepare:(id)arg1 filterPredicate:(id)arg2 signposting:(unsigned long long)arg3 exclusions:(unsigned long long)arg4 columnInclusions:(unsigned long long)arg5 mode:(unsigned long long)arg6 machTimebase:(struct mach_timebase_info)arg7 importedFileURL:(id)arg8 importForcedStartDate:(id)arg9 importForcedEndDate:(id)arg10 trackPidToExecNameMapping:(_Bool)arg11 dynamicTracingEnabledSubsystems:(id)arg12;	// IMP=0x000000000001b1e6
- (id)ticketToStartStream:(id)arg1;	// IMP=0x000000000001b1cd
- (_Bool)_holdReceivedAgent:(id)arg1 ticket:(id)arg2;	// IMP=0x000000000001affb
- (void)dealloc;	// IMP=0x000000000001af63
- (id)init;	// IMP=0x000000000001ac9b
