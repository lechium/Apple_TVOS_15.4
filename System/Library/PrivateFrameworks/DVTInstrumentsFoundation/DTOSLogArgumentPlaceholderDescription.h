...
- (unsigned long long)hash;	// IMP=0x000000000001ab8e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001ab83
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x000000000001a6a0
