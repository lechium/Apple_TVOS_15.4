...
- (void).cxx_destruct;	// IMP=0x00000000001847ff
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000018462d
- (id)init;	// IMP=0x00000000001845be
