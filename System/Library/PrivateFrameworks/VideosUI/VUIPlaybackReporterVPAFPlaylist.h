...
- (void).cxx_destruct;	// IMP=0x0000000000189eae
...
- (id)itemsBetweenStartOverallPosition:(unsigned long long)arg1 endOverallPosition:(unsigned long long)arg2;	// IMP=0x0000000000189c45
- (id)itemAtOverallPosition:(unsigned long long)arg1 rangeOptions:(long long)arg2;	// IMP=0x0000000000189a6c
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000000188c7f
