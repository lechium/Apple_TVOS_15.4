...
- (void).cxx_destruct;	// IMP=0x00000000000bfb4b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bf7f0
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x00000000000bf632
- (id)initWithMediaItem:(id)arg1 andImageType:(unsigned long long)arg2;	// IMP=0x00000000000bf585
