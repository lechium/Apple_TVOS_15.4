...
- (void).cxx_destruct;	// IMP=0x0000000000024478
...
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000024338
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x00000000000242c0
- (void)_defaultsSwitchPressed:(id)arg1;	// IMP=0x00000000000242a3
- (void)layoutSubviews;	// IMP=0x0000000000023cd2
- (void)configureCellWithDefaults:(id)arg1;	// IMP=0x0000000000023a20
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000236af
