...
- (void).cxx_destruct;	// IMP=0x00000000000a893a
...
- (void)layoutSubviews;	// IMP=0x00000000000a7ebb
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a7e38
- (struct CGSize)legendNameSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a7cb9
- (id)initWithLayout:(id)arg1;	// IMP=0x00000000000a7c34
