...
+ (int)_textBlendMode;	// IMP=0x000000000016db54
+ (id)_textColor:(long long)arg1;	// IMP=0x000000000016daf5
+ (id)scoreboardCLayoutWithInnerMargin:(double)arg1;	// IMP=0x000000000016d8f2
+ (id)scoreboardBLayout;	// IMP=0x000000000016d6c2
+ (id)scoreboardALayout;	// IMP=0x000000000016d484
- (void).cxx_destruct;	// IMP=0x000000000016dbf4
