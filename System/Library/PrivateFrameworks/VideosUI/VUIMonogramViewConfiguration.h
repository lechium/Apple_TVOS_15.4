...
- (void).cxx_destruct;	// IMP=0x0000000000105679
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000105347
- (id)initWithShadowImages:(_Bool)arg1;	// IMP=0x0000000000105210
- (id)initWithStyle:(long long)arg1;	// IMP=0x0000000000104ec8
