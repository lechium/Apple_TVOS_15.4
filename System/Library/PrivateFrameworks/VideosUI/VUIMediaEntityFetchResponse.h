...
- (void).cxx_destruct;	// IMP=0x000000000019eb4f
...
- (id)description;	// IMP=0x000000000019e82e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019e49b
- (unsigned long long)hash;	// IMP=0x000000000019e3a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019e30d
- (_Bool)_updateWithResponse:(id)arg1 changes:(id)arg2 replaceContentsOnNilChanges:(_Bool)arg3;	// IMP=0x000000000019e0af
- (id)init;	// IMP=0x000000000019e05e
