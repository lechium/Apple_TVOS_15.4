...
- (void).cxx_destruct;	// IMP=0x000000000000c91a
@property(copy, nonatomic) NSURL *libraryFileURL; // @synthesize libraryFileURL=_libraryFileURL;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c8f6
- (id)initWithURL:(id)arg1;	// IMP=0x000000000000c883
- (id)init;	// IMP=0x000000000000c814
