...
- (void).cxx_destruct;	// IMP=0x00000000002dc270
...
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000002dfa40
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (void)dealloc;	// IMP=0x00000000002dc1d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002dc100
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002dc0d0
