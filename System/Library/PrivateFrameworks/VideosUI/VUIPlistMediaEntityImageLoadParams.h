...
- (void).cxx_destruct;	// IMP=0x00000000001b16f2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b1251
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x00000000001b1077
- (id)initWithImageURL:(id)arg1 baseImageIdentifier:(id)arg2 imageType:(unsigned long long)arg3;	// IMP=0x00000000001b0f52
