...
- (void).cxx_destruct;	// IMP=0x000000000004ced6
...
- (id)description;	// IMP=0x000000000004c780
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004c4a6
- (unsigned long long)hash;	// IMP=0x000000000004c361
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004c2e7
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x000000000004c280
