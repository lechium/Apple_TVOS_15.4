...
+ (id)mediaCatgeoryForType:(unsigned long long)arg1;	// IMP=0x000000000009dd09
- (void).cxx_destruct;	// IMP=0x000000000009e4c3
...
- (id)description;	// IMP=0x000000000009e0db
- (id)_initWithType:(unsigned long long)arg1;	// IMP=0x000000000009e054
- (id)init;	// IMP=0x000000000009dfe5
