...
+ (_Bool)shouldPlayWhenDoneForActionRef:(id)arg1;	// IMP=0x00000000000524e3
+ (long long)getPurchaseTypeFromActionRef:(id)arg1;	// IMP=0x0000000000052341
- (void).cxx_destruct;	// IMP=0x00000000000529d7
...
- (void)_recordErrorLog:(id)arg1;	// IMP=0x00000000000525f9
- (void)handleRequestCompletionWithResult:(id)arg1 andError:(id)arg2;	// IMP=0x00000000000520fa
- (void)enqueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000051fc5
- (id)initWithBuyParams:(id)arg1 ofPurchaseType:(long long)arg2;	// IMP=0x0000000000051d90
