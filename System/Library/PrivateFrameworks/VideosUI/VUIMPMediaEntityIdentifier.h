...
+ (id)mediaItemIdentifierWithMediaItem:(id)arg1;	// IMP=0x0000000000197446
+ (id)showIdentifierWithMediaItem:(id)arg1;	// IMP=0x00000000001973a2
- (void).cxx_destruct;	// IMP=0x0000000000197ace
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001976f3
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019765b
- (id)initWithPersistentID:(id)arg1 mediaEntityType:(id)arg2;	// IMP=0x000000000019756f
- (id)init;	// IMP=0x0000000000197500
