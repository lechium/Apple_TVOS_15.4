...
- (void).cxx_destruct;	// IMP=0x000000000008a771
...
- (id)_logNameForContentViewType:(unsigned long long)arg1;	// IMP=0x000000000008a638
- (id)_createAlertViewWithTitle:(id)arg1 description:(id)arg2;	// IMP=0x000000000008a4ab
- (void)configureCurrentViewFrameForBounds:(struct CGRect)arg1;	// IMP=0x0000000000089f4c
- (void)setRootViewForViewController:(id)arg1;	// IMP=0x0000000000089eec
