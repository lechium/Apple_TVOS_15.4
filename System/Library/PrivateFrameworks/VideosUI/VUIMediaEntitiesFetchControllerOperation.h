...
- (void).cxx_destruct;	// IMP=0x00000000000922a6
...
- (id)_resultWithResponses:(id)arg1;	// IMP=0x0000000000092140
- (void)_startChangesOperationWithMediaEntityFetchResponses:(id)arg1 currentFetchResponses:(id)arg2;	// IMP=0x0000000000091ec1
- (void)_handleCompletdFetchWithResponses:(id)arg1 error:(id)arg2;	// IMP=0x0000000000091d0d
- (void)_startMediaLibraryFetchOperation;	// IMP=0x0000000000091ac0
- (void)cancel;	// IMP=0x0000000000091a42
- (void)executionDidBegin;	// IMP=0x0000000000091a30
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2 requests:(id)arg3;	// IMP=0x0000000000091963
