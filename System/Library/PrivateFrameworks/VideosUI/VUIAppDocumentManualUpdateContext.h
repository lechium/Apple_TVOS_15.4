...
- (void).cxx_destruct;	// IMP=0x0000000000004b19
...
- (void)updateCurrentUpdateRequestWithAppContext:(id)arg1 documentRef:(id)arg2;	// IMP=0x000000000000495c
- (void)updateRequestCompletedWithViewElements:(id)arg1 documentRef:(id)arg2;	// IMP=0x0000000000004956
- (id)initWithContextDictionary:(id)arg1 viewElement:(id)arg2;	// IMP=0x00000000000048bd
- (id)init;	// IMP=0x000000000000484e
