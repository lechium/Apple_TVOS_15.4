...
- (void).cxx_destruct;	// IMP=0x00000000000d368b
...
- (id)backingDictionary;	// IMP=0x00000000000d29ac
- (id)initWithTitle:(id)arg1 showTitle:(id)arg2 seasonTitle:(id)arg3 seasonNumber:(id)arg4 episodeNumber:(id)arg5 artworkURL:(id)arg6;	// IMP=0x00000000000d2834
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000d26f7
