...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x00000000001734b4
- (void).cxx_destruct;	// IMP=0x00000000001736b8
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x0000000000173578
- (id)description;	// IMP=0x0000000000172e8e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000172d9f
- (id)init;	// IMP=0x0000000000172a5c
