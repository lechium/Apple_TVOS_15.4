...
+ (id)_pieImageAtFraction:(double)arg1;	// IMP=0x0000000000049063
+ (id)_pieImagesMemoryPool;	// IMP=0x0000000000048fb5
...
- (id)_maskImage;	// IMP=0x00000000000498f6
- (void)_drawPauseUIWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000004976c
- (void)_drawIncomingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000000049696
- (void)_drawOutgoingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x00000000000494ef
- (void)_drawPieWithCenter:(struct CGPoint)arg1;	// IMP=0x0000000000049409
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000048dfe
- (void)_clearDisplayLink;	// IMP=0x0000000000048dc6
- (void)_ensureDisplayLink;	// IMP=0x0000000000048d13
- (void)_onDisplayLink:(id)arg1;	// IMP=0x0000000000048c0b
- (void)_clearTransitionIfComplete:(id *)arg1;	// IMP=0x0000000000048bd4
- (void)_updateFractionTransitionAnimated:(_Bool)arg1;	// IMP=0x0000000000048aeb
- (void)_updateStateTransitionAnimated:(_Bool)arg1;	// IMP=0x00000000000489e4
- (void)_updatePausedTransitionAnimated:(_Bool)arg1;	// IMP=0x0000000000048978
- (void)_updateTransitionsAnimated:(_Bool)arg1;	// IMP=0x00000000000487cc
- (_Bool)_hasActiveTransitions;	// IMP=0x0000000000048799
- (void)setState:(long long)arg1 paused:(_Bool)arg2 fractionLoaded:(double)arg3 animated:(_Bool)arg4;	// IMP=0x00000000000486a1
- (void)dealloc;	// IMP=0x0000000000048600
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004857c
