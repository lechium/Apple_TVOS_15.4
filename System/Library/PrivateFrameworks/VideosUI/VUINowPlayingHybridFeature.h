...
- (void).cxx_destruct;	// IMP=0x0000000000025e67
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000025cc8
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x0000000000025af7
- (id)init;	// IMP=0x0000000000025ad3
