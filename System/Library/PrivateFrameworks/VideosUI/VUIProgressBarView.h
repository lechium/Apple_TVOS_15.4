...
- (void).cxx_destruct;	// IMP=0x00000000001b5033
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x00000000001b4dfc
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001b488b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b4829
