...
{
    VUIMediaStartTimeCollection *_startTimeCollection;	// 8 = 0x8
}

+ (void)initialize;	// IMP=0x0000000000117e44
- (void).cxx_destruct;	// IMP=0x000000000011824f
...
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x0000000000117ed5
