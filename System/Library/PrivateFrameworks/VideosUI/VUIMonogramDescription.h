...
- (void).cxx_destruct;	// IMP=0x0000000000066e74
...
- (unsigned long long)preferedMonogramType;	// IMP=0x0000000000066a66
- (unsigned long long)hash;	// IMP=0x000000000006691c
- (struct CGPoint)specialOffsetForString:(id)arg1;	// IMP=0x000000000006681f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000065a34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000065692
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x00000000000655e6
- (id)init;	// IMP=0x00000000000655ca
- (id)initWithFirstName:(id)arg1 lastName:(id)arg2 imageURL:(id)arg3 font:(id)arg4;	// IMP=0x0000000000065455
