...
- (void).cxx_destruct;	// IMP=0x0000000000024c59
...
- (void)layoutSubviews;	// IMP=0x000000000002487a
- (void)configureWithTitle:(id)arg1;	// IMP=0x00000000000247d8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002450f
