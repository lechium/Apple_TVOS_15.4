...
- (id)description;	// IMP=0x00000000001b2c0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b2aa3
- (unsigned long long)hash;	// IMP=0x00000000001b29f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b29ac
- (id)init;	// IMP=0x00000000001b2948
