...
- (void)updateFromCloudWithReason:(long long)arg1;	// IMP=0x00000000001aa203
- (void)updateProgressWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001aa1a1
