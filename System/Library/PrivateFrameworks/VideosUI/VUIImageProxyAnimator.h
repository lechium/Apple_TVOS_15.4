...
- (void).cxx_destruct;	// IMP=0x0000000000065389
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x00000000000651d0
- (void)_fetchNext;	// IMP=0x0000000000064e20
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x0000000000064952
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000646e3
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000006452a
- (void)stopAnimation;	// IMP=0x00000000000644c1
- (void)startAnimation;	// IMP=0x0000000000064400
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x0000000000064331
- (id)init;	// IMP=0x00000000000642ef
