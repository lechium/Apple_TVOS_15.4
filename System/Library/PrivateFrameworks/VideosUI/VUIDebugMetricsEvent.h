...
- (void).cxx_destruct;	// IMP=0x000000000018df10
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000000018dccf
...
- (id)_sortKeys:(id)arg1;	// IMP=0x000000000018da18
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x000000000018cd83
