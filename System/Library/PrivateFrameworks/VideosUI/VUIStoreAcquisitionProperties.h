...
+ (id)acquisitionPropertiesWithBuyParams:(id)arg1 urlbagKey:(id)arg2;	// IMP=0x000000000007228e
+ (id)metricsAugumentedBuyParamsWithBuyParams:(id)arg1;	// IMP=0x00000000000720fc
- (void).cxx_destruct;	// IMP=0x000000000007246b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000072352
- (id)init;	// IMP=0x000000000007231a
