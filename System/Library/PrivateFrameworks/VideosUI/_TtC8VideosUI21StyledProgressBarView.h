...
- (void).cxx_destruct;	// IMP=0x00000000004bced0
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000004bbb70
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000004bb910
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004bb8c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004bb890
