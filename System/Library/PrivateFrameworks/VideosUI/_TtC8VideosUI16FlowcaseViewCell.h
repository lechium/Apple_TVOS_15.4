...
- (void).cxx_destruct;	// IMP=0x00000000003a60a0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a5fc0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003a5f90
- (void)onImageDidLoad:(id)arg1;	// IMP=0x00000000003a3b00
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000003a3700
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000003a3400
- (void)vui_prepareForReuse;	// IMP=0x00000000003a2f30
