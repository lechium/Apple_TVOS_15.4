...
+ (id)_actionForKey:(id)arg1 eventDict:(id)arg2 appContext:(id)arg3;	// IMP=0x0000000000212ac5
+ (id)_documentDataSourceWithDict:(id)arg1;	// IMP=0x0000000000212aac
+ (id)attachPrefetchedDict:(id)arg1 eventDict:(id)arg2;	// IMP=0x00000000002129ac
+ (id)eventDataSourceWithEventDict:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000002126ef
- (void).cxx_destruct;	// IMP=0x0000000000212bf7
