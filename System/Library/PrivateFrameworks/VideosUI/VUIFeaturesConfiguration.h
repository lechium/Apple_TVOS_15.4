...
+ (id)stringValueForKey:(id)arg1;	// IMP=0x00000000001110ea
+ (id)numberValueForKey:(id)arg1;	// IMP=0x0000000000110f87
+ (id)sharedInstance;	// IMP=0x000000000010fcea
- (void).cxx_destruct;	// IMP=0x000000000011123d
...
- (void)parseUpNextConfig:(id)arg1;	// IMP=0x0000000000110e77
- (void)updateWithDictionary:(id)arg1;	// IMP=0x000000000010fe59
- (id)init;	// IMP=0x000000000010fd3f
