...
- (void).cxx_destruct;	// IMP=0x00000000001059b9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001057c3
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001056e3
