...
- (void).cxx_destruct;	// IMP=0x000000000017f2d0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017f229
- (id)initWithMainMenuItems:(id)arg1 genreMenuItems:(id)arg2;	// IMP=0x000000000017f190
