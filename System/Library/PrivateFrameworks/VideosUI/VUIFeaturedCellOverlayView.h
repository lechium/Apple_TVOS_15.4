...
- (void).cxx_destruct;	// IMP=0x00000000001ca1ae
...
- (void)_layoutSubviews;	// IMP=0x00000000001c8bc5
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000001c8b66
- (void)applyAlphaToFadeableView:(double)arg1;	// IMP=0x00000000001c891e
