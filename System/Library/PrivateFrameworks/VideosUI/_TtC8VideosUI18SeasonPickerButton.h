...
- (void).cxx_destruct;	// IMP=0x00000000003145f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000314590
...
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000003144b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000313cd0
- (id)init;	// IMP=0x0000000000313cb0
