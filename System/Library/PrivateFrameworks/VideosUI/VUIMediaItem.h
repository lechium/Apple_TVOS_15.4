...
+ (id)keyPathsForValuesAffectingPlayedState;	// IMP=0x0000000000119e22
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0000000000119d2c
+ (id)_mediaItemWithMPMediaItem:(id)arg1;	// IMP=0x00000000001199c9
- (void).cxx_destruct;	// IMP=0x000000000011a85f
...
- (id)description;	// IMP=0x0000000000119ed4
...
- (id)lastPlayedDate;	// IMP=0x0000000000119af5
- (id)modifiedDate;	// IMP=0x0000000000119adc
- (id)creationDate;	// IMP=0x0000000000119ac3
