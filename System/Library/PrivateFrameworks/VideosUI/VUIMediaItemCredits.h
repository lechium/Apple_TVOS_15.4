...
+ (id)_stringRepresentationFromArray:(id)arg1;	// IMP=0x0000000000172275
+ (id)_arrayFromStringRepresentation:(id)arg1;	// IMP=0x0000000000172259
- (void).cxx_destruct;	// IMP=0x00000000001722cd
...
- (id)description;	// IMP=0x0000000000171fb0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000171c1d
- (unsigned long long)hash;	// IMP=0x0000000000171b2a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000171a8f
- (id)stringRepresentation;	// IMP=0x0000000000171864
- (id)initWithStringRepresentation:(id)arg1;	// IMP=0x000000000017157a
