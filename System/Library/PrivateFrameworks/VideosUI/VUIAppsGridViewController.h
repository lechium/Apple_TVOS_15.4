...
- (void).cxx_destruct;	// IMP=0x000000000003d43a
@property(copy, nonatomic) NSArray *apps; // @synthesize apps=_apps;
- (_Bool)_collectionView:(id)arg1 canFocusItemAtIndexPath:(id)arg2;	// IMP=0x000000000003d421
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x000000000003d2f2
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000000003d2cc
- (void)setTitle:(id)arg1;	// IMP=0x000000000003d256
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000003d20d
- (Class)_collectionViewClass;	// IMP=0x000000000003d1fc
- (id)init;	// IMP=0x000000000003c5ea
