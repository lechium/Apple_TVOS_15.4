...
- (void).cxx_destruct;	// IMP=0x0000000000094472
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009433c
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000942ed
- (id)init;	// IMP=0x000000000009427e
- (id)initWithEntityIdentifier:(id)arg1 mediaEntityType:(id)arg2;	// IMP=0x00000000000941a0
