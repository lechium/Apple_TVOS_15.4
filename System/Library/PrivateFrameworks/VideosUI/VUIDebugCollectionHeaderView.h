...
- (void).cxx_destruct;	// IMP=0x000000000002366d
...
- (void)layoutSubviews;	// IMP=0x00000000000233fd
- (void)configureHeaderViewWithTitle:(id)arg1;	// IMP=0x00000000000233c2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000231d1
