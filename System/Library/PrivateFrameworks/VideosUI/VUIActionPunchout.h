...
- (void).cxx_destruct;	// IMP=0x00000000001b0ebb
...
- (_Bool)isAccountRequired;	// IMP=0x00000000001b0d0e
- (_Bool)_isValidAppInstalled;	// IMP=0x00000000001b0a3c
- (void)_openPunchoutURL:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b010e
- (void)_showErrorMessageAlert:(id)arg1;	// IMP=0x00000000001afbb5
- (void)_openAirplayPicker:(CDUnknownBlockType)arg1;	// IMP=0x00000000001afba3
- (void)_startAppInstallFlow:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001af847
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001af3d9
- (_Bool)canPerformNow;	// IMP=0x00000000001af3a2
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000001af07b
