...
- (void).cxx_destruct;	// IMP=0x000000000010e4b9
...
- (id)description;	// IMP=0x000000000010e243
- (id)initWithFetchReason:(long long)arg1 fetchResponse:(id)arg2;	// IMP=0x000000000010e1cd
- (id)init;	// IMP=0x000000000010e15e
