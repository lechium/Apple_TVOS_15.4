...
- (void).cxx_destruct;	// IMP=0x00000000000de24f
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000dd9d2
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000dd8f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000dd82d
- (unsigned long long)hash;	// IMP=0x00000000000dd7bf
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x00000000000dd703
