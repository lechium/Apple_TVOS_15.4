...
- (void).cxx_destruct;	// IMP=0x000000000002636d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000026209
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 duration:(double)arg2 repeats:(_Bool)arg3;	// IMP=0x000000000002607c
