...
+ (id)_changeSetFromMediaItemEntityTypes:(id)arg1 toMediaItemEntityTypes:(id)arg2;	// IMP=0x00000000000db3f8
- (void).cxx_destruct;	// IMP=0x00000000000db510
...
- (void)executionDidBegin;	// IMP=0x00000000000db012
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2;	// IMP=0x00000000000dafce
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000daf5f
