...
- (void).cxx_destruct;	// IMP=0x0000000000059902
...
- (void)_freeBuffers;	// IMP=0x000000000005984e
- (void)_compute;	// IMP=0x0000000000058c36
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000058b98
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000058b5d
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000058b22
- (void)dealloc;	// IMP=0x0000000000058ae4
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000058a70
