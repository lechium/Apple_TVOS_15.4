...
- (void).cxx_destruct;	// IMP=0x0000000000101fb0
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000101e5f
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000101dab
