...
- (void).cxx_destruct;	// IMP=0x000000000009dccb
...
- (void)dealloc;	// IMP=0x000000000009dc5a
- (void)removeManagedReferences;	// IMP=0x000000000009db27
- (id)description;	// IMP=0x000000000009daa5
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x000000000009d8ee
