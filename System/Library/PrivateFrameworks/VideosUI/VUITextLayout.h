...
@interface VUITextLayout : NSObject <NSCopying>
{
    ...
    unsigned int _fontTraits;	// 16 = 0x10
    ...
    UIColor *_darkHighlightOrSelectedColor;	// 184 = 0xb8
    UIColor *_darkSeeMoreTextColor;	// 192 = 0xc0
    double _minimumScaleFactor;	// 200 = 0xc8
...
- (id)_defaultParagraphStyle;	// IMP=0x0000000000054047
- (id)attributedStringWithAttributedString:(id)arg1 view:(id)arg2 updateTextColor:(_Bool)arg3;	// IMP=0x0000000000053957
- (id)attributedStringWithString:(id)arg1 view:(id)arg2;	// IMP=0x00000000000538a4
- (id)attributedStringWithString:(id)arg1;	// IMP=0x0000000000053890
- (unsigned long long)numberOfLinesForTraitCollection:(id)arg1;	// IMP=0x0000000000053801
- (void)setColorWithOpacityType:(long long)arg1;	// IMP=0x000000000005375e
- (id)defaultAttributesForLabel:(id)arg1;	// IMP=0x000000000005357b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053218
- (id)init;	// IMP=0x0000000000053194
