...
@interface VUIPlistMediaDatabaseItem <NSCopying>
{
    ...
    _TVContentRating *_contentRating;	// 48 = 0x30
...
- (void).cxx_destruct;	// IMP=0x000000000019a947
...
- (id)isLocal;	// IMP=0x000000000019a74f
- (id)description;	// IMP=0x000000000019a029
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001994e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001992cf
@property(readonly, copy, nonatomic, getter=isPlayable) NSNumber *playable;
- (id)dictionaryRepresentation;	// IMP=0x0000000000198e26
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000198849
- (id)initWithIdentifier:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x00000000001987bd
