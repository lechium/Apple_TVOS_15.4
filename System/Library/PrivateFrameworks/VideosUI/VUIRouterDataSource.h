...
- (void).cxx_destruct;	// IMP=0x0000000000068a9b
...
- (id)initWithRouterData:(id)arg1 prefetchedData:(id)arg2;	// IMP=0x0000000000068926
- (id)initWithRouterData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000068755
