...
- (void).cxx_destruct;	// IMP=0x0000000000111fc1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000111d3c
- (id)initWithMediaItem:(id)arg1;	// IMP=0x000000000011183c
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001117a4
