...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0000000000196742
+ (Class)transformedValueClass;	// IMP=0x0000000000196731
- (void).cxx_destruct;	// IMP=0x0000000000196f79
...
- (id)transformedValue:(id)arg1;	// IMP=0x000000000019674a
- (id)initWithIdentifierKeyPath:(id)arg1;	// IMP=0x0000000000196680
- (id)init;	// IMP=0x0000000000196611
