...
@interface VUIProductUberBackgroundView
{
    ...
    UIVisualEffectView *_blurEffectView;	// 24 = 0x18
    unsigned long long _configuredBlurInterfaceStyle;	// 32 = 0x20
    CAGradientLayer *_maskGradientLayer;	// 40 = 0x28
    double _contentOffset;	// 48 = 0x30
    struct CGSize _imageSize;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x000000000019d394
...
- (void)_configureGradientLayer:(id)arg1 currentSizeClass:(long long)arg2 mainRect:(struct CGRect)arg3;	// IMP=0x000000000019cd38
- (double)_gradientHeightForSizeClass:(long long)arg1 mainRect:(struct CGRect)arg2;	// IMP=0x000000000019cce4
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000019ca95
- (void)setImageOffset:(double)arg1;	// IMP=0x000000000019c97b
- (void)setMasksBlur:(_Bool)arg1;	// IMP=0x000000000019c911
- (void)configureBlurWithInterfaceStyle:(unsigned long long)arg1;	// IMP=0x000000000019c63a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000019c536
