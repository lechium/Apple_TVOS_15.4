...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000302e20
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000302df0
...
- (void)vui_prepareForReuse;	// IMP=0x0000000000302b80
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000302a20
