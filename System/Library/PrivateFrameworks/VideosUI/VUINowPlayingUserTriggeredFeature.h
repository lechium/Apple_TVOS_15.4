...
- (void).cxx_destruct;	// IMP=0x000000000002573b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000025664
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x000000000002546d
- (id)init;	// IMP=0x0000000000025454
