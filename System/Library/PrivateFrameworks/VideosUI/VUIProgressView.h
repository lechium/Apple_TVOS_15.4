...
- (void).cxx_destruct;	// IMP=0x00000000001b47a3
...
- (void)_updateForStyleChange;	// IMP=0x00000000001b4516
- (id)_maskImageForProgressBar;	// IMP=0x00000000001b434b
- (void)_layoutMaterialView;	// IMP=0x00000000001b423a
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001b3d8d
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001b3a2f
- (void)layoutSubviews;	// IMP=0x00000000001b36fd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b3428
