...
- (void).cxx_destruct;	// IMP=0x0000000000019f42
...
- (void)prepareForReuse;	// IMP=0x0000000000019c87
- (void)layoutSubviews;	// IMP=0x0000000000019533
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x0000000000019474
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x0000000000019457
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x000000000001943a
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000018b4d
