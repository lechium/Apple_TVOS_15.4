...
- (void).cxx_destruct;	// IMP=0x000000000017e70d
@property(retain, nonatomic) UIActivityIndicatorView *indicatorView; // @synthesize indicatorView=_indicatorView;
@property(retain, nonatomic) VUILabel *loadingLabel; // @synthesize loadingLabel=_loadingLabel;
@property(nonatomic) double delay; // @synthesize delay=_delay;
- (void)layoutSubviews;	// IMP=0x000000000017e464
- (void)startTimer;	// IMP=0x000000000017e3e0
- (id)initWithFrame:(struct CGRect)arg1 loadingString:(id)arg2;	// IMP=0x000000000017e2ed
