...
- (void).cxx_destruct;	// IMP=0x00000000001d0a36
...
- (struct CGSize)_layoutWithSize:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x00000000001d062c
- (void)layoutSubviews;	// IMP=0x00000000001d057b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001d0564
