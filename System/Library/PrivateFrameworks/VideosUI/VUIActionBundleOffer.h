...
- (void).cxx_destruct;	// IMP=0x000000000001276d
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000122c6
- (_Bool)isAccountRequired;	// IMP=0x00000000000122be
- (id)initWithContextData:(id)arg1;	// IMP=0x0000000000012144
