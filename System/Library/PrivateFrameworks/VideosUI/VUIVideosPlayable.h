...
+ (id)videosPlayableFromSerializedData:(id)arg1;	// IMP=0x000000000011241e
+ (id)videosPlayablesFromDictionaries:(id)arg1 andMetadataDictionary:(id)arg2;	// IMP=0x0000000000111fd1
- (void).cxx_destruct;	// IMP=0x000000000011352c
...
- (_Bool)mostRecentResumeTime:(id *)arg1 mostRecentTimestamp:(id *)arg2;	// IMP=0x0000000000112c2f
...
- (id)serializedData;	// IMP=0x0000000000112308
- (id)initWithDictionary:(id)arg1 andMetadataDictionary:(id)arg2;	// IMP=0x0000000000112215
