...
- (void).cxx_destruct;	// IMP=0x0000000000047ec0
...
- (_Bool)_updateWithResponse:(id)arg1 changes:(id)arg2 replaceContentsOnNilChanges:(_Bool)arg3;	// IMP=0x0000000000047cce
- (id)description;	// IMP=0x0000000000047b15
- (id)init;	// IMP=0x0000000000047aaf
