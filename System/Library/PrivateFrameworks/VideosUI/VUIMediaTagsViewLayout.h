...
{
    _Bool _alignBadgeVertically;	// 8 = 0x8
    _Bool _groupActivityTagEnabled;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x0000000000047a5b
...
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x0000000000046ba4
- (id)init;	// IMP=0x0000000000046b90
