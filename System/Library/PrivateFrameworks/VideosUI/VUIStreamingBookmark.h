...
- (void).cxx_destruct;	// IMP=0x00000000000714ef
...
- (id)initWithAbsoluteResumeTime:(id)arg1 absoluteTimestamp:(id)arg2 relativeResumeTime:(id)arg3 relativeBookmarkTimestamp:(id)arg4;	// IMP=0x0000000000071334
