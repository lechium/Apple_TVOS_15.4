...
- (struct CGRect)lastItemFrame;	// IMP=0x0000000000055b99
- (struct CGRect)firstItemFrame;	// IMP=0x0000000000055b6e
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x0000000000055b4f
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x0000000000055b2e
- (void)dealloc;	// IMP=0x0000000000055aa4
