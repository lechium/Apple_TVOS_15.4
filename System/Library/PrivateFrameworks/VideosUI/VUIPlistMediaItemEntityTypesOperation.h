...
- (void).cxx_destruct;	// IMP=0x0000000000197fda
...
- (void)executionDidBegin;	// IMP=0x0000000000197c0a
- (id)initWithDatabase:(id)arg1;	// IMP=0x0000000000197b65
- (id)init;	// IMP=0x0000000000197af6
