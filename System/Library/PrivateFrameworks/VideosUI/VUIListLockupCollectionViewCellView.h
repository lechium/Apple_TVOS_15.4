...
- (void).cxx_destruct;	// IMP=0x000000000004c1fa
...
- (void)vui_prepareForReuse;	// IMP=0x000000000004c087
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000004ad4a
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000004ace8
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000004ac9d
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000004ac17
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004a890
