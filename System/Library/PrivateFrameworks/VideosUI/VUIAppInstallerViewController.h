...
- (void).cxx_destruct;	// IMP=0x00000000001aef7e
...
- (void)_finishInstallationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001aecae
- (void)_updateWithInstallProgress:(double)arg1;	// IMP=0x00000000001aec0f
- (void)_dismissAppInstallWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001aeb1c
- (void)_beginInstallingApp;	// IMP=0x00000000001ade07
- (void)beginInstallingAppWithProgressHandler:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001adb52
- (void)loadView;	// IMP=0x00000000001ada7c
- (void)_initConfirmation;	// IMP=0x00000000001ac83f
- (id)initWithInstallable:(id)arg1 punchoutURL:(id)arg2;	// IMP=0x00000000001ac70e
- (id)initWithInstallable:(id)arg1;	// IMP=0x00000000001ac6fa
- (id)init;	// IMP=0x00000000001ac6bb
