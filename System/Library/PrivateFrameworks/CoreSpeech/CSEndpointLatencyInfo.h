...
- (void).cxx_destruct;	// IMP=0x0000000000029001
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x0000000000028f73
- (void)reportWithRequestMHUUID:(id)arg1;	// IMP=0x0000000000028cbe
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x0000000000028a01
- (id)init;	// IMP=0x000000000002894b
