...
- (void).cxx_destruct;	// IMP=0x0000000000069b3d
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00000000000699d9
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x0000000000069388
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x0000000000069382
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x000000000006937c
- (void)stopAudioStream;	// IMP=0x000000000006925c
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00000000000690d2
- (_Bool)isRecording;	// IMP=0x000000000006901e
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000068fef
- (_Bool)injectAudio:(id)arg1;	// IMP=0x0000000000068fc0
- (void)stop;	// IMP=0x0000000000068efb
- (void)start;	// IMP=0x0000000000068e23
- (void)dealloc;	// IMP=0x0000000000068d69
- (void)attachDevice:(id)arg1;	// IMP=0x0000000000068c77
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x0000000000068bc3
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x0000000000068b57
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x0000000000068b4f
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00000000000689e7
