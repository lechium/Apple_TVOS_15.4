...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004c980
- (void).cxx_destruct;	// IMP=0x000000000004cc7f
...
- (id)description;	// IMP=0x000000000004cbe1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004caf5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004c988
