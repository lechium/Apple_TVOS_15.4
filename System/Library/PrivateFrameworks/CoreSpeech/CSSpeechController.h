...
+ (_Bool)isSmartSiriVolumeAvailable;	// IMP=0x000000000004a046
+ (id)sharedController;	// IMP=0x000000000003c09c
- (void).cxx_destruct;	// IMP=0x000000000004ba1c
...
- (void)clockTimerObserver:(id)arg1 snapshotDidUpdateFrom:(id)arg2 to:(id)arg3;	// IMP=0x000000000004b25b
- (void)clockTimerObserver:(id)arg1 timerDidDismiss:(id)arg2;	// IMP=0x000000000004b177
- (void)clockTimerObserver:(id)arg1 timerDidFire:(id)arg2;	// IMP=0x000000000004b090
- (void)clockAlarmObserver:(id)arg1 snapshotDidUpdateFrom:(id)arg2 to:(id)arg3;	// IMP=0x000000000004b08a
- (void)clockAlarmObserver:(id)arg1 alarmDidDismiss:(id)arg2;	// IMP=0x000000000004afa6
- (void)clockAlarmObserver:(id)arg1 alarmDidFire:(id)arg2;	// IMP=0x000000000004aebf
- (void)nowPlayingObserver:(id)arg1 playbackStateDidChangeFrom:(long long)arg2 to:(long long)arg3 lastPlayingDate:(id)arg4;	// IMP=0x000000000004ad90
- (void)_setTimerIsPlaying:(_Bool)arg1;	// IMP=0x000000000004ac76
- (void)_setAlarmIsPlaying:(_Bool)arg1;	// IMP=0x000000000004ab5c
- (void)_setMediaPlaybackState:(_Bool)arg1 isInterrupted:(_Bool)arg2;	// IMP=0x000000000004aa01
- (void)_teardownAudioProviderIfNeeded;	// IMP=0x000000000004a864
- (void)CSXPCClient:(id)arg1 didDisconnect:(_Bool)arg2;	// IMP=0x000000000004a6a0
- (void)_setSoundPlayingState;	// IMP=0x000000000004a5b8
- (void)endWaitingForMyriadWithDecision:(unsigned long long)arg1;	// IMP=0x000000000004a4f3
- (void)beginWaitingForMyriad;	// IMP=0x000000000004a44c
- (void)setLanguageDetectorInteractionID:(id)arg1;	// IMP=0x000000000004a3a0
- (void)cancelCurrentLanguageDetectorRequest;	// IMP=0x000000000004a2ac
- (void)languageDetectorSetMostRecentRecognitionLanguage:(id)arg1;	// IMP=0x000000000004a293
- (void)setPermanentVolumeOffsetWithDirection:(_Bool)arg1;	// IMP=0x000000000004a21f
- (void)setSmartSiriVolumeDirection:(_Bool)arg1;	// IMP=0x000000000004a1ab
- (void)setSmartSiriVolumePercentage:(float)arg1;	// IMP=0x000000000004a13a
- (float)getSmartSiriVolume;	// IMP=0x000000000004a123
- (float)getVolumeForTTSType:(unsigned long long)arg1;	// IMP=0x000000000004a074
- (_Bool)isSmartSiriVolumeAvailable;	// IMP=0x000000000004a05d
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004a02d
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x000000000004a014
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x0000000000049ffb
- (id)endpointerModelVersion;	// IMP=0x0000000000049ed8
- (double)lastEndOfVoiceActivityTime;	// IMP=0x0000000000049ebf
- (unsigned long long)_phaticPlaybackReason;	// IMP=0x0000000000049eb4
- (float)_scheduledPhaticDelay;	// IMP=0x0000000000049ea6
- (_Bool)_shouldSchedulePhaticAtStartRecording;	// IMP=0x0000000000049e36
- (_Bool)_canPlayPhaticDuringMediaPlayback;	// IMP=0x0000000000049e1d
- (id)_contextToString:(id)arg1;	// IMP=0x0000000000049d69
- (void)_deviceAudioLoggingWithFileWriter:(id)arg1;	// IMP=0x0000000000049ce7
- (id)_getSpeechIdentifier;	// IMP=0x0000000000049bce
- (id)_fetchFallbackAudioSessionReleaseProviding;	// IMP=0x0000000000049b8b
- (void)_setupAudioProviderFromXPC:(id)arg1;	// IMP=0x0000000000049aa4
- (_Bool)_createAudioProviderFromXPCWithContext:(id)arg1;	// IMP=0x0000000000049894
- (_Bool)_fetchAudioProviderWithContext:(id)arg1;	// IMP=0x00000000000497ed
- (id)_fetchAudioDecoderForTV:(unsigned int)arg1;	// IMP=0x000000000004951f
- (void)_logRecordingStopErrorIfNeeded:(long long)arg1;	// IMP=0x0000000000049492
- (_Bool)_shouldTrackLaunchLatency;	// IMP=0x0000000000049413
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x00000000000493fa
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x00000000000493e1
- (void)resetEndpointer;	// IMP=0x00000000000493c8
- (long long)_currentAudioRecorderSampleRate;	// IMP=0x0000000000049304
- (void)setEndpointAnalyzerDelegate:(id)arg1;	// IMP=0x00000000000492eb
@property(readonly, nonatomic) id <CSEndpointAnalyzer> endpointAnalyzer;
- (void)fetchAudioMetricsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000491a5
- (void)keywordDetectorDidDetectKeyword;	// IMP=0x0000000000049067
- (void)endpointer:(id)arg1 detectedTwoShotAtTime:(double)arg2;	// IMP=0x0000000000048e32
- (id)voiceTriggerInfo;	// IMP=0x0000000000048d62
- (unsigned long long)outputReferenceChannel;	// IMP=0x0000000000048ca9
- (void)_createAudioPowerMeterIfNeeded;	// IMP=0x0000000000048ae5
- (float)averagePowerForOutputReference;	// IMP=0x0000000000048a12
- (float)peakPowerForOutputReference;	// IMP=0x000000000004893f
- (float)averagePowerForChannel:(unsigned long long)arg1;	// IMP=0x0000000000048850
- (float)peakPowerForChannel:(unsigned long long)arg1;	// IMP=0x0000000000048761
- (void)updateMeters;	// IMP=0x000000000004875b
- (void)setMeteringEnabled:(_Bool)arg1;	// IMP=0x0000000000048691
- (void)stopEndpointer;	// IMP=0x00000000000485f7
- (_Bool)playRecordStartingAlertAndResetEndpointer;	// IMP=0x0000000000048532
- (unsigned long long)alertStartTime;	// IMP=0x00000000000484ee
- (_Bool)playAlertSoundForType:(long long)arg1;	// IMP=0x000000000004841f
- (_Bool)setAlertSoundFromURL:(id)arg1 forType:(long long)arg2;	// IMP=0x000000000004831d
- (void)audioConverterDidConvertPackets:(id)arg1 packets:(id)arg2 durationInSec:(float)arg3 timestamp:(unsigned long long)arg4 arrivalTimestampToAudioRecorder:(unsigned long long)arg5;	// IMP=0x000000000004813f
- (_Bool)_setupAudioConverter:(_Bool)arg1 isNarrowBand:(_Bool)arg2;	// IMP=0x000000000004806f
- (void)_setupDownsamplerIfNeeded;	// IMP=0x0000000000048028
- (void)didTTSVolumeChange:(id)arg1 forReason:(unsigned long long)arg2;	// IMP=0x0000000000047e5d
- (void)audioSessionProvider:(id)arg1 didSetAudioSessionActive:(_Bool)arg2;	// IMP=0x0000000000047c2b
- (void)audioSessionProvider:(id)arg1 willSetAudioSessionActive:(_Bool)arg2;	// IMP=0x0000000000047a06
- (void)audioSessionProviderEndInterruption:(id)arg1;	// IMP=0x0000000000047856
- (void)audioSessionProviderBeginInterruption:(id)arg1 withContext:(id)arg2;	// IMP=0x0000000000047665
- (void)audioSessionProviderBeginInterruption:(id)arg1;	// IMP=0x00000000000474b5
- (void)audioAlertProvidingDidFinishAlertPlayback:(id)arg1 ofType:(long long)arg2 error:(id)arg3;	// IMP=0x00000000000472b0
- (void)audioSessionController:(id)arg1 didReceiveAudioSessionMediaServicesWereResetNotificationWithUserInfo:(id)arg2;	// IMP=0x0000000000047231
- (void)audioSessionProvider:(id)arg1 didChangeContext:(_Bool)arg2;	// IMP=0x00000000000471b2
- (void)audioSessionProvider:(id)arg1 providerInvalidated:(_Bool)arg2;	// IMP=0x0000000000047084
- (void)audioStreamProvider:(id)arg1 didHardwareConfigurationChange:(long long)arg2;	// IMP=0x0000000000046ec4
- (void)audioDecoderDidDecodePackets:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 timestamp:(unsigned long long)arg5 arrivalTimestampToAudioRecorder:(unsigned long long)arg6 wasBuffered:(_Bool)arg7 receivedNumChannels:(unsigned int)arg8;	// IMP=0x0000000000046d3b
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x0000000000046988
- (void)_audioStreamProvdider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x0000000000045b50
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x0000000000045862
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x00000000000457a6
- (_Bool)_isDuckingAvailableRoute:(id)arg1;	// IMP=0x0000000000045700
- (void)_didStopForReason:(long long)arg1;	// IMP=0x0000000000045122
- (_Bool)_shouldFetchRaiseToSpeakInfo;	// IMP=0x0000000000045109
- (_Bool)_shouldFetchVoiceTriggerInfo;	// IMP=0x00000000000450f0
- (id)playbackRoute;	// IMP=0x000000000004501e
- (id)recordDeviceInfo;	// IMP=0x0000000000044e35
- (id)recordRoute;	// IMP=0x0000000000044d63
- (_Bool)_isRecordRouteBuiltinMic;	// IMP=0x0000000000044ceb
- (_Bool)isRecording;	// IMP=0x0000000000044ca7
- (_Bool)_shouldReportEstimatedSpeechEndHostTime;	// IMP=0x0000000000044c63
- (void)stopRecordingWithOptions:(id)arg1;	// IMP=0x000000000004488b
- (void)stopRecording;	// IMP=0x0000000000044615
- (_Bool)startRecording:(id *)arg1;	// IMP=0x00000000000445f9
- (_Bool)_shouldSetStartSampleCountForRTS;	// IMP=0x0000000000044597
- (_Bool)_shouldSetStartSampleCount;	// IMP=0x0000000000044499
- (_Bool)_shouldUseLanguageDetector:(id)arg1;	// IMP=0x0000000000044392
- (void)_createLanguageDetectorIfNeeded;	// IMP=0x0000000000044352
- (void)_startPhaticDecision;	// IMP=0x000000000004373a
- (_Bool)startRecordingWithSettings:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000041943
- (id)_languageDetectorOptionFromSettings:(id)arg1;	// IMP=0x0000000000040ff9
- (void)_setupSpeakerRecognitionController;	// IMP=0x0000000000040ff3
- (void)_refreshSpeakerRecognitionAssets;	// IMP=0x0000000000040fed
@property(nonatomic) _Bool duckOthersOption;
- (double)getRecordBufferDuration;	// IMP=0x0000000000040f4f
- (_Bool)setRecordBufferDuration:(double)arg1;	// IMP=0x0000000000040f47
- (void)setSynchronousCallbackEnabled:(_Bool)arg1;	// IMP=0x0000000000040f41
- (struct AudioStreamBasicDescription)getLPCMAudioStreamBasicDescription;	// IMP=0x0000000000040ee7
- (id)recordSettings;	// IMP=0x0000000000040c1c
- (void)releaseAudioSession:(unsigned long long)arg1;	// IMP=0x0000000000040b12
- (void)releaseAudioSession;	// IMP=0x0000000000040a0e
- (void)reset;	// IMP=0x000000000004098f
- (void)resetAudioSession;	// IMP=0x00000000000408b9
- (_Bool)prewarmAudioSession;	// IMP=0x00000000000407f2
- (void)preheat;	// IMP=0x0000000000040773
- (_Bool)setCurrentRecordContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004029c
- (void)_updateRecordContextIfNeeded:(id)arg1;	// IMP=0x00000000000401d4
- (_Bool)_doActivateAudioSessionWithReason:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000003ffc0
- (_Bool)_activateAudioSessionWithReason:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000003fe02
- (_Bool)_lazyActivateAudioSessionWithReason:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000003f7e0
- (void)_performPendingAudioSessionActivateForReason:(id)arg1;	// IMP=0x000000000003f5ab
- (void)_cancelPendingAudioSessionActivateForReason:(id)arg1;	// IMP=0x000000000003f499
- (void)_scheduleActivateAudioSessionWithDelay:(double)arg1 sessionActivateReason:(unsigned long long)arg2 scheduleReason:(id)arg3 validator:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x000000000003eeac
- (_Bool)_activateAudioSessionWithReason:(unsigned long long)arg1 delay:(double)arg2 delayRequested:(_Bool)arg3 error:(id *)arg4;	// IMP=0x000000000003e5ed
- (_Bool)_isDelayedDuckingSupportedContext;	// IMP=0x000000000003e579
- (_Bool)_fetchLastTriggerInfo;	// IMP=0x000000000003e305
- (_Bool)prepareRecordWithSettings:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003d2b4
- (_Bool)_shouldResetContextAtPrepare;	// IMP=0x000000000003d28f
- (void)startController;	// IMP=0x000000000003d11d
- (_Bool)initializeRecordSessionWithRecordContext:(id)arg1;	// IMP=0x000000000003d034
- (void)_initializeTimerState;	// IMP=0x000000000003ce7e
- (void)_initializeAlarmState;	// IMP=0x000000000003ccc8
- (void)_initializeMediaPlayingState;	// IMP=0x000000000003cb21
- (id)_createTimerMonitor;	// IMP=0x000000000003caa3
- (id)_createAlarmMonitor;	// IMP=0x000000000003ca25
- (id)_createMediaPlayingMonitor;	// IMP=0x000000000003c93d
...
- (id)initWithEndpointId:(id)arg1;	// IMP=0x000000000003c119
- (id)init;	// IMP=0x000000000003c105
