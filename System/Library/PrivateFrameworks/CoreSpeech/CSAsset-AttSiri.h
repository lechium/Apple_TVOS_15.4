...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x000000000000eb7e
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x000000000000eb32
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x000000000000eaf7
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x000000000000eaab
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0000000000010cbd
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x000000000000deb8
@property(readonly, nonatomic) NSString *flexKwdThresholdFile;
@property(readonly, nonatomic) NSString *flexKwdConfigFile;
- (id)_sha256:(id)arg1;	// IMP=0x000000000004dc89
- (id)_sha1:(id)arg1;	// IMP=0x000000000004db98
- (id)localeMapWithName:(id)arg1;	// IMP=0x000000000004d9ef
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x000000000004d9bb
- (id)remoraRTModelLocaleMap;	// IMP=0x000000000004d9a2
- (id)jarvisRTModelLocaleMap;	// IMP=0x000000000004d989
- (id)hearstRTModelLocaleMap;	// IMP=0x000000000004d970
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x000000000004d953
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x000000000004d933
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x000000000004d10f
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x000000000004cd41
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x000000000004ccdb
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x000000000004cca7
...
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x00000000000a6a72
