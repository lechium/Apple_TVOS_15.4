...
#import <CoreSpeech/AFNotifyObserverDelegate-Protocol.h>
...
- (void).cxx_destruct;	// IMP=0x00000000000a6345
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x00000000000a5eb3
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x00000000000a5dd3
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x00000000000a5cd1
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000a5b5e
