...
+ (id)noAlertOption;	// IMP=0x0000000000078b2b
- (void).cxx_destruct;	// IMP=0x000000000007951a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000790cb
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0000000000078c9e
- (id)initTandemWithOption:(id)arg1;	// IMP=0x0000000000078b63
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(long long)arg1;	// IMP=0x0000000000051847
- (long long)_avvcAlertOverrideType:(long long)arg1;	// IMP=0x0000000000051830
- (_Bool)isAlertBehaviorOverridedBeep;	// IMP=0x00000000000517da
- (id)avvcAlertBehavior;	// IMP=0x0000000000051632
- (void)setAVVCAlertBehavior:(id)arg1;	// IMP=0x00000000000513d8
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned long long)arg1;	// IMP=0x000000000005110b
