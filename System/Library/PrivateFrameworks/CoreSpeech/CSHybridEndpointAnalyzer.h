...
- (void).cxx_destruct;	// IMP=0x00000000000cc2a8
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x00000000000cbcbf
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x00000000000cbc21
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x00000000000cb947
- (void)_updateAssetWithCurrentLanguage;	// IMP=0x00000000000cb8d1
- (void)_updateAssetWithLanguage:(id)arg1;	// IMP=0x00000000000cb6fe
- (void)CSFirstUnlockMonitor:(id)arg1 didReceiveFirstUnlock:(_Bool)arg2;	// IMP=0x00000000000cb634
- (void)CSAssetManagerDidDownloadNewAsset:(id)arg1;	// IMP=0x00000000000cb59e
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x00000000000cb4e1
...
- (void)reset;	// IMP=0x00000000000cb447
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00000000000cb166
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x00000000000ca4af
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x00000000000ca4a7
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x00000000000ca4a1
- (void)stopEndpointer;	// IMP=0x00000000000ca40b
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00000000000ca363
- (void)terminateProcessing;	// IMP=0x00000000000ca2f0
- (void)preheat;	// IMP=0x00000000000ca2ea
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x00000000000c9ff4
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x00000000000c98a0
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x00000000000c988f
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x00000000000c78ea
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c71c3
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x00000000000c6ef5
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x00000000000c6e4c
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x00000000000c6d9f
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x00000000000c6675
- (void)_loadAndSetupEndpointerAssetIfNecessary;	// IMP=0x00000000000c635a
- (id)init;	// IMP=0x00000000000c5ba1
