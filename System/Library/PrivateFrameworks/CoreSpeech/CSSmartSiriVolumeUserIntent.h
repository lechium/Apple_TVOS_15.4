...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x000000000006032e
- (void)storeASVStateInformation;	// IMP=0x00000000000602db
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00000000000602ba
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x0000000000060299
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x000000000006014d
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x0000000000060045
