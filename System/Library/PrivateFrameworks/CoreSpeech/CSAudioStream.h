...
- (void).cxx_destruct;	// IMP=0x00000000000aa8bd
...
- (void)audioStreamProvider:(id)arg1 didHardwareConfigurationChange:(long long)arg2;	// IMP=0x00000000000aa65a
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x00000000000aa594
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2 lastForwardedSampleCount:(unsigned long long)arg3;	// IMP=0x00000000000aa57e
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x00000000000aa4b8
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x00000000000aa1eb
- (void)updateAudioStreamStartTimeInSampleCount:(unsigned long long)arg1;	// IMP=0x00000000000a9d24
- (_Bool)isNarrowBand;	// IMP=0x00000000000a9ce0
- (id)recordSettings;	// IMP=0x00000000000a9c90
- (_Bool)isStreaming;	// IMP=0x00000000000a9b7b
- (void)stopAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a96cd
- (void)startAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a93f0
- (void)prepareAudioStreamWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a9367
- (_Bool)prepareAudioStreamSyncWithRequest:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000a92e7
- (void)dealloc;	// IMP=0x00000000000a9187
- (id)initWithAudioStreamProvider:(id)arg1 streamName:(id)arg2 streamRequest:(id)arg3;	// IMP=0x00000000000a8f8b
