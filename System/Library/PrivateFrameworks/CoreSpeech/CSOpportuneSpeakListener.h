...
- (void).cxx_destruct;	// IMP=0x0000000000026121
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x0000000000025bb8
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x0000000000025bb2
- (_Bool)_shouldReportBoron;	// IMP=0x0000000000025b7a
- (_Bool)_popRemoteVADSignal;	// IMP=0x0000000000025afb
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x0000000000025a6d
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x00000000000256b9
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x000000000002560a
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000255f3
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000002526b
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024c81
- (void)_resetAlignBuffer;	// IMP=0x0000000000024c58
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000024758
- (id)init;	// IMP=0x000000000002466a
