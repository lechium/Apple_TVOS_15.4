...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f025e
- (void).cxx_destruct;	// IMP=0x00000000000f05f6
...
- (id)initWithAVVCRecordDeviceInfo:(id)arg1;	// IMP=0x00000000000f04c4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f0346
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f0266
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f0253
- (id)description;	// IMP=0x00000000000f01b7
- (id)xpcObject;	// IMP=0x00000000000f0059
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00000000000efe0c
- (id)initWithRoute:(id)arg1 isRemoteDevice:(_Bool)arg2 remoteDeviceUID:(id)arg3 remoteDeviceProductIdentifier:(id)arg4 remoteDeviceUIDString:(id)arg5;	// IMP=0x00000000000efcf9
- (id)initWithRoute:(id)arg1 isRemoteDevice:(_Bool)arg2 remoteDeviceUID:(id)arg3 remoteDeviceProductIdentifier:(id)arg4;	// IMP=0x00000000000efcd6
