...
- (void).cxx_destruct;	// IMP=0x00000000000ac357
...
- (id)dictionary;	// IMP=0x00000000000ac0e3
- (id)description;	// IMP=0x00000000000ac032
- (id)initWithWordCount:(long long)arg1 trailingSilenceFrames:(long long)arg2 endOfSilenceLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6;	// IMP=0x00000000000ac00f
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7;	// IMP=0x00000000000abf3b
