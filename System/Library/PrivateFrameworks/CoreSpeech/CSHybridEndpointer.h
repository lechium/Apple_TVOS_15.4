...
- (void).cxx_destruct;	// IMP=0x000000000009ee2a
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x000000000009e876
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x000000000009e7d8
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x000000000009e4fe
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x000000000009e4f8
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x000000000009e332
...
- (void)reset;	// IMP=0x000000000009e298
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x000000000009de65
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x000000000009d3c5
- (void)stopEndpointer;	// IMP=0x000000000009d32f
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x000000000009d287
- (void)terminateProcessing;	// IMP=0x000000000009d27d
- (void)preheat;	// IMP=0x000000000009d277
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x000000000009cf81
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x000000000009c756
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x000000000009c745
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2;	// IMP=0x000000000009a842
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x000000000009a6ca
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3;	// IMP=0x000000000009a642
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000099f1b
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x0000000000099c4d
- (void)processTaskString:(id)arg1;	// IMP=0x0000000000099934
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x000000000009988d
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x000000000009974b
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x00000000000995ad
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x0000000000099496
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x00000000000993e9
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x00000000000993e3
- (id)init;	// IMP=0x0000000000098d00
