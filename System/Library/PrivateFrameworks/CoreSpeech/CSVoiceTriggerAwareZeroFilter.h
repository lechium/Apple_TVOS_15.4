...
- (void).cxx_destruct;	// IMP=0x000000000008a745
...
- (id)metrics;	// IMP=0x000000000008a6af
- (void)flush;	// IMP=0x000000000008a626
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x000000000008a361
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x000000000008a0a9
- (id)init;	// IMP=0x000000000008a07a
