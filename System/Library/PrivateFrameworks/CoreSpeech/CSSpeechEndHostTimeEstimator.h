...
- (unsigned long long)estimatedSpeechEndHostTime;	// IMP=0x000000000002f8ee
- (void)notifyTrailingSilenceDurationAtEndpoint:(double)arg1;	// IMP=0x000000000002f7c4
- (void)addNumSamples:(unsigned long long)arg1 hostTime:(unsigned long long)arg2;	// IMP=0x000000000002f7b6
- (void)reset;	// IMP=0x000000000002f79d
- (id)init;	// IMP=0x000000000002f751
