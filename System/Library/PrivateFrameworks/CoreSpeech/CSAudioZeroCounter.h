...
- (void).cxx_destruct;	// IMP=0x000000000000dd9a
- (void)stopReportZeroStatistics;	// IMP=0x000000000000dcfc
- (void)getZeroStatisticsFromBuffer:(id)arg1 entireSamples:(unsigned int)arg2;	// IMP=0x000000000000db59
- (void)resetWithSampleRate:(float)arg1;	// IMP=0x000000000000da90
- (id)initWithToken:(id)arg1 sampleRate:(float)arg2 numChannels:(unsigned int)arg3;	// IMP=0x000000000000d935
