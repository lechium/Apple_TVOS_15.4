...
+ (id)localDeviceProtocolInfo;	// IMP=0x00000000000c55ed
+ (id)defaultProtocolInfo;	// IMP=0x00000000000c55a2
- (void).cxx_destruct;	// IMP=0x00000000000c5a7e
...
- (id)description;	// IMP=0x00000000000c5a0a
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00000000000c5732
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x00000000000c54d7
