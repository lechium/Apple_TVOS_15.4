...
- (void).cxx_destruct;	// IMP=0x000000000006bc04
...
- (struct AudioStreamBasicDescription)_defaultOutASBD;	// IMP=0x000000000006b9f0
- (id)_compensateChannelDataIfNeeded:(id)arg1 receivedNumChannels:(unsigned int)arg2;	// IMP=0x000000000006b81a
- (id)_deinterleaveBufferIfNeeded:(struct AudioBufferList *)arg1;	// IMP=0x000000000006b6c3
- (void)stopAudioStream;	// IMP=0x000000000006b56b
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x000000000006b47c
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3 playbackStarted:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x000000000006af32
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000006ae71
- (_Bool)injectAudio:(id)arg1;	// IMP=0x000000000006ae52
- (void)_readAudioBufferAndFeed;	// IMP=0x000000000006a1f9
- (void)_startAudioFeedingTimer;	// IMP=0x000000000006a0d6
- (void)stop;	// IMP=0x0000000000069f51
- (void)_createDeInterleaverIfNeeded;	// IMP=0x0000000000069dbe
- (void)start;	// IMP=0x0000000000069d40
- (void)attachDevice:(id)arg1;	// IMP=0x0000000000069d3a
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x0000000000069d32
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x0000000000069d2c
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x0000000000069d24
- (void)dealloc;	// IMP=0x0000000000069cd4
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x0000000000069bae
