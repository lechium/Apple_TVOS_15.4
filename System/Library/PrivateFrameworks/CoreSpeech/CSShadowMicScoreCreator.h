...
- (void).cxx_destruct;	// IMP=0x00000000000a2d03
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x00000000000a29f7
- (void)_calculateSpeechVoicingLevel;	// IMP=0x00000000000a2774
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x00000000000a2752
- (void)calculateShadowMicScore;	// IMP=0x00000000000a23d0
- (void)addDataToBuffer:(id)arg1;	// IMP=0x00000000000a23ba
- (id)init;	// IMP=0x00000000000a2333
