...
- (void).cxx_destruct;	// IMP=0x000000000003bacf
...
- (void)resumeConnection;	// IMP=0x000000000003b995
- (void)notifyClientsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003b443
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000003a8df
- (void)dealloc;	// IMP=0x000000000003a821
- (id)initWithMachService:(id)arg1 withServiceInterface:(id)arg2 withServiceObject:(id)arg3 withDelegateInterface:(id)arg4;	// IMP=0x000000000003a580
