...
- (void).cxx_destruct;	// IMP=0x000000000000d70b
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x000000000000d5a7
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x000000000000cf51
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x000000000000cf4b
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x000000000000cf45
- (void)stopAudioStream;	// IMP=0x000000000000ce25
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x000000000000cc9b
- (_Bool)isRecording;	// IMP=0x000000000000cbe7
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000000cbb8
- (_Bool)injectAudio:(id)arg1;	// IMP=0x000000000000cb89
- (void)stop;	// IMP=0x000000000000cac4
- (void)start;	// IMP=0x000000000000c9ec
- (void)dealloc;	// IMP=0x000000000000c932
- (void)attachDevice:(id)arg1;	// IMP=0x000000000000c840
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x000000000000c78c
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x000000000000c720
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x000000000000c718
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x000000000000c5ae
