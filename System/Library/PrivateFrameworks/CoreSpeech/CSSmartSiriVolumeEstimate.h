...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006ea64
- (void).cxx_destruct;	// IMP=0x000000000006ec17
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006eb5b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006ea6c
- (id)initWithVolumeEstimate:(float)arg1 debugLogFile:(id)arg2;	// IMP=0x000000000006e9ea
