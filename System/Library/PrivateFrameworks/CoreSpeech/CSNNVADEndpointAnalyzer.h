...
- (void).cxx_destruct;	// IMP=0x000000000002768a
...
- (double)trailingSilenceDurationAtEndpoint;	// IMP=0x0000000000027579
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x00000000000274fa
- (void)stopEndpointer;	// IMP=0x000000000002747b
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00000000000273fc
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x000000000002737d
- (void)reset;	// IMP=0x00000000000272fe
- (void)preheat;	// IMP=0x000000000002727f
- (id)init;	// IMP=0x00000000000271c8
