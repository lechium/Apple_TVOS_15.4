...
#import <CoreSpeech/CSSecondPassProgressDelegate-Protocol.h>
...
- (void).cxx_destruct;	// IMP=0x000000000000c51e
...
- (void)secondPassDidStartForClient:(unsigned long long)arg1 deviceId:(id)arg2 withFirstPassEstimate:(double)arg3;	// IMP=0x000000000000c0dc
- (void)secondPassDidStopForClient:(unsigned long long)arg1 deviceId:(id)arg2;	// IMP=0x000000000000bee4
- (void)voiceTriggerDidRejected:(id)arg1 deviceId:(id)arg2;	// IMP=0x000000000000be1c
- (void)raiseToSpeakDetected:(id)arg1;	// IMP=0x000000000000bdc2
- (void)voiceTriggerGotSuperVector:(id)arg1;	// IMP=0x000000000000bd68
- (void)keywordDetectorDidDetectKeyword;	// IMP=0x000000000000bd37
- (void)voiceTriggerDidDetectSpeakerReject:(id)arg1;	// IMP=0x000000000000bcdd
- (void)voiceTriggerDidDetectNearMiss:(id)arg1 deviceId:(id)arg2;	// IMP=0x000000000000bc15
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2;	// IMP=0x000000000000bacf
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000ba28
- (_Bool)_isRemoraSecondPassRunning;	// IMP=0x000000000000b938
- (void)_getHighestRemoraFirstPassGoodnessScore:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b701
- (_Bool)handlePendingBuiltInVoiceTriggerIfNeeded;	// IMP=0x000000000000b394
- (void)_clearPendingBuiltInVoiceTrigger;	// IMP=0x000000000000b297
- (_Bool)handlePendingRemoraVoiceTriggerIfNeeded;	// IMP=0x000000000000ae49
- (void)_clearPendingRemoraVoiceTrigger;	// IMP=0x000000000000ad1e
- (_Bool)isRemoraVoiceTriggerEvent:(id)arg1;	// IMP=0x000000000000ac10
- (_Bool)isBultInVoiceTriggerEvent:(id)arg1;	// IMP=0x000000000000ab02
- (id)initWithTargetQueue:(id)arg1;	// IMP=0x000000000000aa3f
