...
- (void).cxx_destruct;	// IMP=0x000000000002abbb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002aa4f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002a9b4
- (unsigned long long)hash;	// IMP=0x000000000002a975
@property(readonly, nonatomic) NSString *bundleId;
@property(readonly, nonatomic) NSString *domainId;
@property(readonly, nonatomic) double absoluteTimestamp;
- (id)initWithInteraction:(id)arg1 uniqueId:(id)arg2 bundleIdentifier:(id)arg3;	// IMP=0x000000000002a823
- (id)init;	// IMP=0x000000000002a81d
