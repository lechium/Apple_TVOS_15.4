...
- (void).cxx_destruct;	// IMP=0x00000000000f3446
- (id)generate;	// IMP=0x00000000000f327c
- (void)setUserInfo:(id)arg1;	// IMP=0x00000000000f325c
- (void)setDeviceID:(id)arg1;	// IMP=0x00000000000f323c
- (void)setOptions:(unsigned long long)arg1;	// IMP=0x00000000000f322e
- (void)setEvent:(long long)arg1;	// IMP=0x00000000000f3220
- (void)setSource:(long long)arg1;	// IMP=0x00000000000f3212
- (void)setTimestamp:(unsigned long long)arg1;	// IMP=0x00000000000f3204
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000000000f3199
- (id)init;	// IMP=0x00000000000f3185
