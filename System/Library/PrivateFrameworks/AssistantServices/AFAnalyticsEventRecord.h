...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000acc99
- (void).cxx_destruct;	// IMP=0x00000000000acef0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000acd4a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000acca1
- (id)initWithEvent:(id)arg1 streamUID:(id)arg2 dateCreated:(id)arg3 speechId:(id)arg4 recordId:(id)arg5;	// IMP=0x00000000000acacb
- (id)initWithEvent:(id)arg1 streamUID:(id)arg2 dateCreated:(id)arg3 speechId:(id)arg4;	// IMP=0x00000000000acaa8
- (void)siriCoreSQLiteRecord_enumerateColumnNamesAndValuesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000acf39
