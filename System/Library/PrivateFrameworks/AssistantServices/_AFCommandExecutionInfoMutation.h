...
- (void).cxx_destruct;	// IMP=0x00000000001561f1
- (id)generate;	// IMP=0x0000000000155e4e
- (void)setUserInfo:(id)arg1;	// IMP=0x0000000000155e2c
- (void)setDeviceRestrictions:(id)arg1;	// IMP=0x0000000000155e0a
- (void)setRequestHandlingContextSnapshot:(id)arg1;	// IMP=0x0000000000155de8
- (void)setSpeechInfo:(id)arg1;	// IMP=0x0000000000155dc6
- (void)setInstanceInfo:(id)arg1;	// IMP=0x0000000000155da6
- (void)setEndpointInfo:(id)arg1;	// IMP=0x0000000000155d86
- (void)setCurrentHomeInfo:(id)arg1;	// IMP=0x0000000000155d66
- (void)setOriginPeerInfo:(id)arg1;	// IMP=0x0000000000155d46
- (void)setTurnId:(id)arg1;	// IMP=0x0000000000155d26
- (void)setRequestID:(id)arg1;	// IMP=0x0000000000155d06
- (void)setExecutionID:(id)arg1;	// IMP=0x0000000000155ce6
- (id)initWithBaseModel:(id)arg1;	// IMP=0x0000000000155c7b
- (id)init;	// IMP=0x0000000000155c67
