...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000029ddb
- (void).cxx_destruct;	// IMP=0x000000000002a060
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000029f8c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000029de3
