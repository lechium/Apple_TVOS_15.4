...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004efc0
- (void).cxx_destruct;	// IMP=0x000000000004f3c5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004f0ba
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004efc8
- (id)description;	// IMP=0x000000000004ef1d
- (id)initWithAnchor:(id)arg1 forcingReset:(_Bool)arg2;	// IMP=0x000000000004edb6
