...
- (void).cxx_destruct;	// IMP=0x000000000003159c
...
- (void)sendWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000031486
- (id)initWithInfo:(id)arg1;	// IMP=0x000000000003141b
