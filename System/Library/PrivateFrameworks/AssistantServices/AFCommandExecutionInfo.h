...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000154968
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000156287
- (void).cxx_destruct;	// IMP=0x0000000000155bdc
...
- (id)buildDictionaryRepresentation;	// IMP=0x0000000000155753
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000154de3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000154cc2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000154970
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015495d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000154553
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x0000000000153f17
@property(readonly, copy) NSString *description;
- (id)initWithExecutionID:(id)arg1 requestID:(id)arg2 turnId:(id)arg3 originPeerInfo:(id)arg4 currentHomeInfo:(id)arg5 endpointInfo:(id)arg6 instanceInfo:(id)arg7 speechInfo:(id)arg8 requestHandlingContextSnapshot:(id)arg9 deviceRestrictions:(id)arg10 userInfo:(id)arg11;	// IMP=0x0000000000153cde
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x00000000001562f6
