...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000803c8
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000080ee5
- (void).cxx_destruct;	// IMP=0x000000000008097e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000806f2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000803d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000803bd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008010b
- (unsigned long long)hash;	// IMP=0x000000000007ff09
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x000000000007f9eb
- (id)description;	// IMP=0x000000000007f9d7
- (id)initWithAccessibilityState:(id)arg1 deviceRingerSwitchState:(long long)arg2 isDeviceInCarDNDMode:(_Bool)arg3 isDeviceInStarkMode:(_Bool)arg4 isDeviceWatchAuthenticated:(_Bool)arg5 areAnnouncementRequestsPermittedByPresentationWhileActive:(_Bool)arg6 outputVolume:(float)arg7 tapToSiriAudioPlaybackRequest:(id)arg8 twoShotAudioPlaybackRequest:(id)arg9 deviceSetupFlowBeginDate:(id)arg10 deviceSetupFlowEndDate:(id)arg11;	// IMP=0x000000000007f861
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x0000000000080f54
