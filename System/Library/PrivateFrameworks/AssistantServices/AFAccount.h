...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000b01eb
- (void).cxx_destruct;	// IMP=0x00000000000b1823
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b0cf8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b0930
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b03e2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b01f3
- (id)messageDictionary;	// IMP=0x00000000000afece
- (id)initWithMessageDictionary:(id)arg1;	// IMP=0x00000000000af9c5
- (id)description;	// IMP=0x00000000000af938
