...
- (void).cxx_destruct;	// IMP=0x0000000000072759
- (id)generate;	// IMP=0x0000000000072585
- (void)setMediaRemoteRouteIdentifier:(id)arg1;	// IMP=0x0000000000072565
- (void)setMediaRemoteGroupIdentifier:(id)arg1;	// IMP=0x0000000000072545
- (void)setHomeKitMediaSystemIdentifier:(id)arg1;	// IMP=0x0000000000072525
- (void)setHomeKitRoomName:(id)arg1;	// IMP=0x0000000000072505
- (void)setIsSupportedAndEnabled:(_Bool)arg1;	// IMP=0x00000000000724f8
- (id)initWithBaseModel:(id)arg1;	// IMP=0x000000000007248d
- (id)init;	// IMP=0x0000000000072479
