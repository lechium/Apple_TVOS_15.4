...
- (void).cxx_destruct;	// IMP=0x00000000000e72c7
...
- (long long)_announcementPlatform;	// IMP=0x00000000000e7243
- (unsigned long long)_getRouteCapabilities;	// IMP=0x00000000000e723b
- (void)_initializeInternalState;	// IMP=0x00000000000e7235
- (id)initWithRouteDescription:(id)arg1;	// IMP=0x00000000000e7206
