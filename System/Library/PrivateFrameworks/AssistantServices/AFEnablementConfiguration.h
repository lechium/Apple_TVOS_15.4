...
- (void).cxx_destruct;	// IMP=0x0000000000122312
...
- (_Bool)requiresVoiceSelectionForRecognitionLanguage:(id)arg1;	// IMP=0x000000000012226c
- (id)initWithRequiresVoiceSelection:(_Bool)arg1 voiceSelectionAllowsChooseForMe:(_Bool)arg2 voiceCountForRecognitionLanguage:(id)arg3 completionLoggingBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000001221c7
