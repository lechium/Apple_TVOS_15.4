...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000358d8
...
- (id)description;	// IMP=0x0000000000035a5d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000359d6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000358e0
