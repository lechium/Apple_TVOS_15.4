...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000016391b
- (void).cxx_destruct;	// IMP=0x0000000000163b43
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001639bc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000163923
