...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000090c2c
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000091776
- (void).cxx_destruct;	// IMP=0x00000000000912a4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000090f98
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000090c34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000090c21
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000090a06
- (unsigned long long)hash;	// IMP=0x00000000000907a8
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x00000000000902f1
- (id)description;	// IMP=0x00000000000902dd
- (id)initWithAddress:(id)arg1 deviceUID:(id)arg2 vendorID:(unsigned int)arg3 productID:(unsigned int)arg4 isAdvancedAppleAudioDevice:(_Bool)arg5 supportsInEarDetection:(_Bool)arg6 supportsVoiceTrigger:(_Bool)arg7 supportsSpokenNotification:(_Bool)arg8 supportsListeningModeANC:(_Bool)arg9 supportsListeningModeTransparency:(_Bool)arg10 supportsAnnounceCall:(_Bool)arg11;	// IMP=0x00000000000901ea
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x00000000000917e5
