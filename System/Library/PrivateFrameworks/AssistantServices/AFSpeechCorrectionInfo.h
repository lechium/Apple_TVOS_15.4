...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000aa56c
- (void).cxx_destruct;	// IMP=0x00000000000aa7be
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000aa635
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000aa574
