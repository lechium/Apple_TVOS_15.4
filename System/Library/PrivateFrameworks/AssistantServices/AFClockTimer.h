...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004bd9d
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x000000000004d108
- (void).cxx_destruct;	// IMP=0x000000000004cafe
...
- (id)buildDictionaryRepresentation;	// IMP=0x000000000004c844
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000004c2ff
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004c0ec
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004bda5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004bd92
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004ba48
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x000000000004b293
@property(readonly, copy) NSString *description;
- (id)initWithTimerID:(id)arg1 timerURL:(id)arg2 isFiring:(_Bool)arg3 title:(id)arg4 state:(long long)arg5 duration:(double)arg6 type:(long long)arg7 fireTimeInterval:(double)arg8 fireDate:(id)arg9 firedDate:(id)arg10 dismissedDate:(id)arg11 lastModifiedDate:(id)arg12;	// IMP=0x000000000004b0cb
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x000000000004d177
