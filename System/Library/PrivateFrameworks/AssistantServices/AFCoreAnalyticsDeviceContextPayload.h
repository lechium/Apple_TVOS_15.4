...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000315e
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00000000000042bf
...
- (id)buildDictionaryRepresentation;	// IMP=0x0000000000003a05
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000000354a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003429
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003166
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003153
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002d49
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x000000000000270d
@property(readonly, copy) NSString *description;
- (id)initWithNearbyProductType:(id)arg1 proximity:(id)arg2 alarmFiring:(id)arg3 timerFiring:(id)arg4 playbackState:(id)arg5 playbackRecency:(id)arg6 homeAnnouncementState:(id)arg7 homeAnnouncementRecency:(id)arg8 nearbyDevicesRequestIdentifier:(id)arg9 targetedResult:(id)arg10 contextIdentifier:(id)arg11;	// IMP=0x00000000000024d4
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x000000000000432e
