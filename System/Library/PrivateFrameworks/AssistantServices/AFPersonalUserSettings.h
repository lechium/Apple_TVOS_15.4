...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000044320
- (void).cxx_destruct;	// IMP=0x00000000000445a5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000443d6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000044328
