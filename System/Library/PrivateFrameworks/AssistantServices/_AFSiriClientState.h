...
- (void).cxx_destruct;	// IMP=0x000000000014ac4d
...
- (void)removeRequestUUID:(id)arg1;	// IMP=0x000000000014abb2
- (void)addRequestUUID:(id)arg1;	// IMP=0x000000000014ab9c
- (id)init;	// IMP=0x000000000014ab46
