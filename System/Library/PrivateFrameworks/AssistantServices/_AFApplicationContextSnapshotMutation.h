...
- (void).cxx_destruct;	// IMP=0x00000000001484b9
- (id)generate;	// IMP=0x000000000014840c
- (void)setApplicationContexts:(id)arg1;	// IMP=0x00000000001483ec
- (id)initWithBaseModel:(id)arg1;	// IMP=0x0000000000148381
- (id)init;	// IMP=0x000000000014836d
