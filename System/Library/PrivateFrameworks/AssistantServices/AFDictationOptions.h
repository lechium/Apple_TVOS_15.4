...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a28f2
- (void).cxx_destruct;	// IMP=0x00000000000a415d
...
- (id)dictationOptionsWithoutTextContext;	// IMP=0x00000000000a373d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a366d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a2ce8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a28fa
- (id)init;	// IMP=0x00000000000a28ad
