...
{
    AFTwoArgumentSafetyBlock *_relinquishmentHandler;	// 8 = 0x8
    NSUUID *_uuid;	// 16 = 0x10
    AFAssertionContext *_context;	// 24 = 0x18
}
...
- (void)invokeRelinquishmentHandlerWithContext:(id)arg1 error:(id)arg2;	// IMP=0x000000000002aa7e
- (id)initWithUUID:(id)arg1 context:(id)arg2 relinquishmentHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000002a8ec
