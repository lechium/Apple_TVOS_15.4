...
- (void).cxx_destruct;	// IMP=0x0000000000044203
- (id)generate;	// IMP=0x0000000000044151
- (void)setIsVibrationDisabled:(long long)arg1;	// IMP=0x0000000000044143
- (void)setIsVoiceOverTouchEnabled:(long long)arg1;	// IMP=0x0000000000044135
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000000000440ca
- (id)init;	// IMP=0x00000000000440b6
