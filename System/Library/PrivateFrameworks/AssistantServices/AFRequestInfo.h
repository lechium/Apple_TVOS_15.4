...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009543b
+ (id)testRequestWithStartLocalRequest:(id)arg1;	// IMP=0x00000000000ccffc
+ (id)testRequestWithText:(id)arg1 speechRequestOptions:(id)arg2 testOptions:(id)arg3;	// IMP=0x00000000000ccf36
- (void).cxx_destruct;	// IMP=0x00000000000966b0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000960d3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000957f6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000095443
- (id)description;	// IMP=0x0000000000095236
- (_Bool)isSpeechRequest;	// IMP=0x00000000000951cc
- (_Bool)requiresUserInteraction;	// IMP=0x00000000000951a8
- (id)initWithTimestamp:(unsigned long long)arg1;	// IMP=0x0000000000095147
- (id)init;	// IMP=0x0000000000095120
