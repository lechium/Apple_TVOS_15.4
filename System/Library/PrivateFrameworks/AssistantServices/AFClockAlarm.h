...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000160acc
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000162001
- (void).cxx_destruct;	// IMP=0x00000000001619dc
...
- (id)buildDictionaryRepresentation;	// IMP=0x00000000001616af
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000001610e3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000160e6f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000160ad4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000160ac1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016079c
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x000000000015fef3
@property(readonly, copy) NSString *description;
- (id)initWithAlarmID:(id)arg1 alarmURL:(id)arg2 isFiring:(_Bool)arg3 title:(id)arg4 type:(unsigned long long)arg5 hour:(unsigned long long)arg6 minute:(unsigned long long)arg7 repeatOptions:(unsigned long long)arg8 isEnabled:(_Bool)arg9 isSnoozed:(_Bool)arg10 firedDate:(id)arg11 dismissedDate:(id)arg12 lastModifiedDate:(id)arg13;	// IMP=0x000000000015fd49
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x0000000000162070
