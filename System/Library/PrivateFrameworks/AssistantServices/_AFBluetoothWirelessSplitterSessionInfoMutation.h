...
- (void).cxx_destruct;	// IMP=0x000000000002394b
- (id)generate;	// IMP=0x000000000002386d
- (void)setDeviceAddresses:(id)arg1;	// IMP=0x000000000002384d
- (void)setState:(long long)arg1;	// IMP=0x000000000002383f
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000000000237d4
- (id)init;	// IMP=0x00000000000237c0
