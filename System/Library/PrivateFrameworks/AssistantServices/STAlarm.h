...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ed46c
- (void).cxx_destruct;	// IMP=0x00000000000ed8a0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ed5e2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ed474
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ed2dc
