...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ae938
...
- (id)description;	// IMP=0x00000000000ae9ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ae940
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ae8c8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ae84d
- (id)_initWithShowUIDuringListening:(_Bool)arg1 playAlertBeforeListening:(_Bool)arg2;	// IMP=0x00000000000ae823
