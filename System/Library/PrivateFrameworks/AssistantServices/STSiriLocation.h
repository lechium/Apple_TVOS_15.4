...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f0f12
- (void).cxx_destruct;	// IMP=0x00000000000f12ce
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f1074
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f0f1a
