...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000daad2
- (void).cxx_destruct;	// IMP=0x00000000000dc62d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dbc42
@property(copy, nonatomic) NSString *btDeviceAddress;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000db14c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000daada
- (id)description;	// IMP=0x00000000000da88a
- (_Bool)isRaiseToSpeak;	// IMP=0x00000000000da87c
- (_Bool)isVoiceTrigger;	// IMP=0x00000000000da86e
- (id)initForTestWithTestRequestOptions:(id)arg1;	// IMP=0x00000000000da7fc
- (id)initWithActivationEvent:(long long)arg1;	// IMP=0x00000000000da7bf
