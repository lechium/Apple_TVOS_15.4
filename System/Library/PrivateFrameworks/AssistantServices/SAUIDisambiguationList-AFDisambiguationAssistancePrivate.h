...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00000000000b2b14
- (id)af_assistedSelectionItem;	// IMP=0x00000000000b2485
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00000000000b21df
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00000000000b2128
