...
- (void).cxx_destruct;	// IMP=0x000000000001abdc
...
- (id)initWithDuration:(double)arg1;	// IMP=0x000000000001ab70
- (id)initWithPhase:(long long)arg1 displayKey:(id)arg2 speakableKey:(id)arg3;	// IMP=0x000000000001aab0
