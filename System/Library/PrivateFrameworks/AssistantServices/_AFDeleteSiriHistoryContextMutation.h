...
- (id)generate;	// IMP=0x000000000005adf0
- (void)setErrorButtonText:(id)arg1;	// IMP=0x000000000005add0
- (void)setErrorBody:(id)arg1;	// IMP=0x000000000005adb0
- (void)setErrorTitle:(id)arg1;	// IMP=0x000000000005ad90
- (void)setSuccessButtonText:(id)arg1;	// IMP=0x000000000005ad70
- (void)setSuccessBody:(id)arg1;	// IMP=0x000000000005ad50
- (void)setSuccessTitle:(id)arg1;	// IMP=0x000000000005ad30
- (id)initWithBaseModel:(id)arg1;	// IMP=0x000000000005acc5
- (id)init;	// IMP=0x000000000005acb1
