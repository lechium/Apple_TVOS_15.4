...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00000000000b36f5
- (id)af_assistedSelectionItem;	// IMP=0x00000000000b367d
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00000000000b3415
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00000000000b320c
