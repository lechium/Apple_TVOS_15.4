...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000164ec3
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x000000000016679e
- (void).cxx_destruct;	// IMP=0x0000000000165e6c
