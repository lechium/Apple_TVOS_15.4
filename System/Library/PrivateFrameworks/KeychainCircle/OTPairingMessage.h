...
- (void).cxx_destruct;	// IMP=0x00000000000091f5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000009006
- (unsigned long long)hash;	// IMP=0x0000000000008f63
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008e03
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008ceb
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008c28
- (void)writeTo:(id)arg1;	// IMP=0x0000000000008b74
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000884e
- (id)dictionaryRepresentation;	// IMP=0x0000000000008695
- (id)description;	// IMP=0x00000000000085e6
