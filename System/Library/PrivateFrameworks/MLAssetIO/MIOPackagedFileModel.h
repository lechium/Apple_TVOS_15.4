...
- (void).cxx_destruct;	// IMP=0x000000000002fb90
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002f9c7
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f80b
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002df2a
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002deab
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002c710
