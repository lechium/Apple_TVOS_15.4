...
- (void).cxx_destruct;	// IMP=0x000000000002bd5e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002bb35
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b68d
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002b04b
- (id)initWithMessageStream:(struct CodedInputStream *)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002ac24
- (id)initWithSpecificationData:(id)arg1 parserContext:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002aae0
