...
- (void).cxx_destruct;	// IMP=0x0000000000004492
...
- (void)start;	// IMP=0x00000000000041c3
- (void)finishExecuting;	// IMP=0x00000000000040c0
- (void)cancel;	// IMP=0x0000000000003fff
- (id)initWithRemoteOverlay:(id)arg1;	// IMP=0x0000000000003f91
