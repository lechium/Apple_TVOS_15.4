...
+ (Class)eaProtocolStringsType;	// IMP=0x000000000000651c
- (void).cxx_destruct;	// IMP=0x00000000000064a7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000005c44
- (unsigned long long)hash;	// IMP=0x000000000000503d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000048f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004270
- (void)copyTo:(id)arg1;	// IMP=0x0000000000003de3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000003890
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000028ab
- (id)dictionaryRepresentation;	// IMP=0x0000000000001e12
- (id)description;	// IMP=0x0000000000001d63
...
- (id)eaProtocolStringsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001ca7
- (unsigned long long)eaProtocolStringsCount;	// IMP=0x0000000000001c8a
- (void)addEaProtocolStrings:(id)arg1;	// IMP=0x0000000000001c20
- (void)clearEaProtocolStrings;	// IMP=0x0000000000001c03
