...
- (void).cxx_destruct;	// IMP=0x000000000041626e
...
- (void)noteDidComplete;	// IMP=0x00000000004160ac
@property(readonly, nonatomic) double effectiveDuration;
- (id)description;	// IMP=0x0000000000415e0b
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000415d70
