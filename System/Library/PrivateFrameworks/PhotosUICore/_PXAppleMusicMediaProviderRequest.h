...
- (void).cxx_destruct;	// IMP=0x000000000038b877
...
- (id)init;	// IMP=0x000000000038b7c1
- (id)initWithAsset:(id)arg1 options:(id)arg2 requestID:(long long)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000038b6d4
