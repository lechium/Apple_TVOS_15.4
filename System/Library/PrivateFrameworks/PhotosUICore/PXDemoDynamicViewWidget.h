...
- (void).cxx_destruct;	// IMP=0x000000000086ca29
...
- (double)preferredContentHeightForWidth:(double)arg1;	// IMP=0x000000000086c8dd
@property(readonly, nonatomic) _Bool hasContentForCurrentInput;
- (void)_setPreferredHeightPhase:(double)arg1;	// IMP=0x000000000086c7d4
- (void)_heartBeatIncreaseHeightPhase:(_Bool)arg1;	// IMP=0x000000000086c6cd
- (void)_loadView;	// IMP=0x000000000086c62c
