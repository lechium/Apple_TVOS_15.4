...
+ (double)sectionHeaderTitleBottomSpacingForStyle:(unsigned long long)arg1;	// IMP=0x000000000053531f
+ (double)sectionHeaderTopSpacingForStyle:(unsigned long long)arg1;	// IMP=0x000000000053525c
+ (double)sectionHeaderTitleHeightForStyle:(unsigned long long)arg1 dividerHidden:(_Bool)arg2;	// IMP=0x000000000053511c
+ (double)sectionHeaderHeightForStyle:(unsigned long long)arg1 dividerHidden:(_Bool)arg2;	// IMP=0x0000000000535097
+ (id)horizontalContentInsetsInterpolator;	// IMP=0x0000000000085213
- (void).cxx_destruct;	// IMP=0x000000000053506f
...
- (double)columnSpacingForColumnSpan:(long long)arg1;	// IMP=0x0000000000534ede
- (double)columnWidthForColumnSpan:(long long)arg1;	// IMP=0x0000000000534e1b
- (_Bool)isEqualToGadgetSpec:(id)arg1;	// IMP=0x0000000000534b9d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000534b40
@property(readonly, nonatomic) PXExtendedTraitCollection *rootExtendedTraitCollection;
- (id)initWithTraitCollection:(id)arg1 scrollAxis:(long long)arg2;	// IMP=0x0000000000534855
- (struct UIEdgeInsets)acccessoryViewInsetForTraitCollection:(id)arg1;	// IMP=0x0000000000085174
- (_Bool)shouldInsetContentForTraitCollection:(id)arg1;	// IMP=0x000000000008510f
