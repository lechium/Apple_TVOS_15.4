...
+ (id)sharedManager;	// IMP=0x00000000008158a4
- (void).cxx_destruct;	// IMP=0x000000000081577f
...
- (void)_onQueueUpdatePeopleVocabulary;	// IMP=0x000000000081530a
- (id)_localizedTitlesForAssetCollectionFetchResult:(id)arg1;	// IMP=0x0000000000815115
- (void)_onQueueUpdateAlbumVocabulary;	// IMP=0x0000000000814f19
- (void)updateVocabulary;	// IMP=0x0000000000814e61
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x0000000000814bcc
...
- (void)dealloc;	// IMP=0x00000000008148cb
- (id)init;	// IMP=0x00000000008147e2
