...
- (void).cxx_destruct;	// IMP=0x00000000002f7744
...
- (void)registerCleanupHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f75e7
- (void)didEndAnimation:(long long)arg1;	// IMP=0x00000000002f75d9
- (long long)willBeginAnimation;	// IMP=0x00000000002f75af
- (void)cleanup;	// IMP=0x00000000002f7485
- (void)notifyWhenAllAnimationsCompleted:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f73e5
- (id)init;	// IMP=0x00000000002f7367
