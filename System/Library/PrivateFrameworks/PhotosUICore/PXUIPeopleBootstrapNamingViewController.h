...
- (void).cxx_destruct;	// IMP=0x00000000000550b6
...
- (void)namePickerControllerWillChangeText:(id)arg1;	// IMP=0x0000000000054f8f
- (void)namePickerController:(id)arg1 didPickString:(id)arg2;	// IMP=0x0000000000054ebd
- (void)namePickerController:(id)arg1 didPickContact:(id)arg2;	// IMP=0x0000000000054d64
- (void)namePickerController:(id)arg1 didPickPerson:(id)arg2;	// IMP=0x0000000000054c3c
- (void)willTransitionToNextInFlow;	// IMP=0x0000000000054b3a
@property(readonly, nonatomic) _Bool wantsCancelButton; // @synthesize wantsCancelButton=_wantsCancelButton;
- (void)_captureStringSelectionIfNeeded;	// IMP=0x0000000000054a04
- (id)_localizedTitleString;	// IMP=0x00000000000549a3
- (void)_updateNavigationBarForCurrentTraitCollection;	// IMP=0x000000000005486c
@property(readonly, nonatomic) unsigned long long type;
@property(readonly, nonatomic) PHPerson *person;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000054759
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000546a7
- (void)viewDidLoad;	// IMP=0x0000000000053d20
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000053bd2
