...
- (void).cxx_destruct;	// IMP=0x00000000005fa8c7
...
- (id)init;	// IMP=0x00000000005fa825
- (id)initWithAsset:(id)arg1 options:(id)arg2 requestID:(long long)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000005fa738
