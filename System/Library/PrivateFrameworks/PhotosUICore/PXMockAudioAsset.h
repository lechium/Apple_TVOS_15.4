...
- (void).cxx_destruct;	// IMP=0x0000000000110dbd
...
- (id)artworkURLForTargetPixelSize:(struct CGSize)arg1;	// IMP=0x0000000000110abc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000110a9c
- (_Bool)isAudioEqualToAsset:(id)arg1;	// IMP=0x00000000001109e0
- (id)init;	// IMP=0x0000000000110887
- (id)initWithConfiguration:(CDUnknownBlockType)arg1;	// IMP=0x000000000011083e
