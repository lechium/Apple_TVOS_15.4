...
+ (id)sharedInstance;	// IMP=0x00000000008d41de
+ (id)_makeAnimationStyleChoiceRowWithTitle:(id)arg1 valueKeyPath:(id)arg2;	// IMP=0x0000000000515d7b
+ (id)_makeGlobalFocusAnimationSection;	// IMP=0x0000000000515891
+ (id)_makeLocalFocusAnimationSection;	// IMP=0x00000000005155d5
+ (id)settingsControllerModule;	// IMP=0x000000000051539d
...
- (id)globalFocusAnimationShadow;	// IMP=0x00000000008d3e62
- (id)archiveValueForKey:(id)arg1;	// IMP=0x00000000008d3de3
- (void)applyArchiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000008d3d56
- (void)setDefaultValues;	// IMP=0x00000000008d3ba3
- (id)parentSettings;	// IMP=0x00000000008d3b8a
