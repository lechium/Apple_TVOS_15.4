...
+ (id)resultRecordChangeDetailsFor:(id)arg1 withChange:(id)arg2;	// IMP=0x00000000007617ef
- (void).cxx_destruct;	// IMP=0x00000000007617b1
...
- (id)description;	// IMP=0x000000000076165e
- (id)initWithResultRecordBeforeChanges:(id)arg1 resultRecordAfterChanges:(id)arg2 exposedFetchResultChangeDetails:(id)arg3 keyAssetsFetchResultChangeDetails:(id)arg4;	// IMP=0x000000000076157c
