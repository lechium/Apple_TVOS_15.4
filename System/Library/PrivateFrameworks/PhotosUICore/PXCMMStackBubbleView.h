...
+ (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000004dc999
- (void).cxx_destruct;	// IMP=0x00000000004dc885
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000004dc774
- (void)layoutSubviews;	// IMP=0x00000000004dc6b4
- (void)_updateSubviews;	// IMP=0x00000000004dc49b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000004dc293
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004dc210
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004dc141
