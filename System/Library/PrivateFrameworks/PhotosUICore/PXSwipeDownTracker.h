...
- (void).cxx_destruct;	// IMP=0x0000000000047ea2
...
- (void)trackGestureTranslation:(struct CGPoint)arg1 velocity:(struct CGPoint)arg2;	// IMP=0x0000000000047457
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4 velocity:(struct CGPoint)arg5;	// IMP=0x0000000000047326
- (id)initWithOptions:(unsigned long long)arg1;	// IMP=0x00000000000472c7
- (id)init;	// IMP=0x00000000000472b3
