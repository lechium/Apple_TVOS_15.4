...
+ (id)sharedInstance;	// IMP=0x00000000004fc29e
+ (id)settingsControllerModule;	// IMP=0x00000000005aa70e
...
- (void)setDefaultValues;	// IMP=0x00000000004fc0ae
- (id)parentSettings;	// IMP=0x00000000004fc095
