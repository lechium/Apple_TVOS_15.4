...
- (void).cxx_destruct;	// IMP=0x00000000006625aa
...
- (void)dealloc;	// IMP=0x0000000000662515
- (void)_handleDownloadCompleted:(_Bool)arg1 error:(id)arg2;	// IMP=0x0000000000662364
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000006621cf
- (id)initWithArtworkAsset:(id)arg1 maxSize:(struct CGSize)arg2 sharedImageLoadingQueue:(id)arg3;	// IMP=0x00000000006620b7
