...
+ (id)sharedInstance;	// IMP=0x000000000039f1fb
+ (id)settingsControllerModule;	// IMP=0x00000000002fcbcc
...
- (void)setDefaultValues;	// IMP=0x000000000039f0d0
- (id)parentSettings;	// IMP=0x000000000039f0b7
