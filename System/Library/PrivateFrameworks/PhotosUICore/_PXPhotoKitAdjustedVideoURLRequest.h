...
- (void).cxx_destruct;	// IMP=0x00000000000ccd41
...
- (void)_handleExportFinished:(_Bool)arg1 error:(id)arg2 videoURL:(id)arg3;	// IMP=0x00000000000ccbbf
- (void)_renderIfNeeded;	// IMP=0x00000000000cc922
- (void)progressDidChange;	// IMP=0x00000000000cc80d
- (void)editSourceDidChange;	// IMP=0x00000000000cc7fb
- (void)start;	// IMP=0x00000000000cc7e9
- (id)initWithRenderQueue:(id)arg1 asset:(id)arg2 pairingIdentifier:(id)arg3 imageManager:(id)arg4 options:(id)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000000cc6e6
