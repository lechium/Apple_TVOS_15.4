...
- (void).cxx_destruct;	// IMP=0x0000000000621529
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000621398
- (void)setAnimating:(_Bool)arg1 withFlags:(unsigned long long)arg2;	// IMP=0x0000000000621216
- (void)_updateSubviewsOrdering;	// IMP=0x0000000000621169
- (void)_updateCorners;	// IMP=0x0000000000620d22
- (void)_updateFloatingOverlay;	// IMP=0x0000000000620a8e
- (void)setFloatingOverlay:(id)arg1 withInsets:(struct UIEdgeInsets)arg2 parallax:(_Bool)arg3;	// IMP=0x00000000006209fb
- (void)_PXImageUIViewInitialization;	// IMP=0x00000000006202ec
@property(nonatomic) _Bool drawsFocusRing;
@property(nonatomic) _Bool allowsFocus;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000061ff8b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000061ff2e
