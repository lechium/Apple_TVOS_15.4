...
- (void).cxx_destruct;	// IMP=0x00000000005d789b
...
- (void)animateToFinalStateWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d7766
- (void)animateToInitialStateWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d7733
- (void)invalidate;	// IMP=0x00000000005d7729
- (id)initWithAnimations:(id)arg1 layout:(id)arg2;	// IMP=0x00000000005d768c
