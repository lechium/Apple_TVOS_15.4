...
- (void).cxx_destruct;	// IMP=0x000000000066b781
...
- (id)_confidentMatch;	// IMP=0x000000000066b6ed
- (id)_confidentMatchUsingStrategy:(unsigned long long)arg1;	// IMP=0x000000000066b660
- (void)_compareSuggestionsUsingContext;	// IMP=0x000000000066b5c1
- (id)stateUpdatedWithChange:(id)arg1 changeDetails:(id *)arg2;	// IMP=0x000000000066ae79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000066ae6e
- (id)initWithAssetCollections:(id)arg1 suggestionsByAssetCollectionObjectID:(id)arg2 context:(id)arg3;	// IMP=0x000000000066ad7d
