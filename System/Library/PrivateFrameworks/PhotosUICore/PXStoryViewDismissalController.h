...
- (void).cxx_destruct;	// IMP=0x0000000000252c1a
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000002529b7
- (void)_updateCurrentPlacement;	// IMP=0x0000000000252610
- (void)_invalidateCurrentPlacement;	// IMP=0x00000000002525cc
- (void)_updateSwipeDownTracker;	// IMP=0x0000000000251995
- (void)_invalidateSwipeDownTracker;	// IMP=0x0000000000251951
- (void)_updateInitialItemPlacement;	// IMP=0x00000000002518e2
- (void)_invalidateInitialItemPlacement;	// IMP=0x000000000025189e
- (void)_setNeedsUpdate;	// IMP=0x0000000000251813
- (void)handlePanDownGestureRecognizer:(id)arg1;	// IMP=0x00000000002512ba
- (id)initWithViewModel:(id)arg1;	// IMP=0x00000000002511ca
- (id)init;	// IMP=0x0000000000251150
