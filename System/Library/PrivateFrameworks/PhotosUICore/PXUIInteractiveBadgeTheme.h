...
+ (id)sharedToggledOffBadgeTheme;	// IMP=0x00000000008b3616
+ (id)sharedToggledOnBadgeTheme;	// IMP=0x00000000008b35e6
- (void).cxx_destruct;	// IMP=0x00000000008b3558
...
- (id)init;	// IMP=0x00000000008b3436
- (id)initWithIsToggledOn:(_Bool)arg1;	// IMP=0x00000000008b31ee
