...
+ (id)sharedInstance;	// IMP=0x000000000090bc84
+ (id)settingsControllerModule;	// IMP=0x00000000006d8f55
...
- (void)setDefaultValues;	// IMP=0x000000000090b401
- (id)parentSettings;	// IMP=0x000000000090b3e8
