...
- (void).cxx_destruct;	// IMP=0x0000000000899bc5
...
- (id)createInitialPhotosDataSourceForDataSourceManager:(id)arg1;	// IMP=0x0000000000899397
@property(readonly, nonatomic) PXAssetsDataSourceManager *assetsDataSourceManager;
- (id)initWithZoomLevel:(long long)arg1;	// IMP=0x000000000089932d
- (id)initWithZoomLevel:(long long)arg1 assetsDataSourceManager:(id)arg2;	// IMP=0x00000000008992b7
- (id)init;	// IMP=0x000000000089923d
