...
- (void)_handleTap:(id)arg1;	// IMP=0x00000000001a3b9d
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000001a3b6e
- (long long)style;	// IMP=0x00000000001a3b5d
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001a3a2d
