...
- (void).cxx_destruct;	// IMP=0x000000000014945f
...
- (void)_updateEdgeAntialiasing;	// IMP=0x0000000000149303
- (void)_updatePlaceholderVisibility;	// IMP=0x0000000000149236
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000001491db
- (void)videoViewReadinessDidChange:(id)arg1;	// IMP=0x00000000001491c9
- (void)dealloc;	// IMP=0x000000000014916b
@property(readonly, nonatomic) _Bool isVideoLayerReadyForDisplay;
@property(readonly, nonatomic) UIView *viewForSnapshotting;
- (id)generateSnapshotImage;	// IMP=0x0000000000149083
- (void)_updateVideoViewFrame;	// IMP=0x0000000000148e22
- (void)setContentMode:(long long)arg1;	// IMP=0x00000000001489b7
- (void)layoutSubviews;	// IMP=0x0000000000148903
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001487d0
