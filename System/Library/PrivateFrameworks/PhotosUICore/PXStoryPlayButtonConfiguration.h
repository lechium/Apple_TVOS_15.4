...
- (void).cxx_destruct;	// IMP=0x000000000055e1f6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055dfb1
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055def8
- (id)initWithViewModel:(id)arg1;	// IMP=0x000000000055de8d
