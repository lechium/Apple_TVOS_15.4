...
- (void).cxx_destruct;	// IMP=0x00000000007e267a
...
- (void)setAudioSessionCategory:(id)arg1 mode:(id)arg2 routeSharingPolicy:(unsigned long long)arg3 options:(unsigned long long)arg4;	// IMP=0x00000000007e2514
- (void)setVolume:(float)arg1 withFade:(_Bool)arg2;	// IMP=0x00000000007e24f5
