...
- (void).cxx_destruct;	// IMP=0x00000000008cf7db
...
- (id)requestAssetsWithOptions:(unsigned long long)arg1 storyQueue:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000008cf73b
- (id)initWithAssetsDataSourceManager:(id)arg1;	// IMP=0x00000000008cf6d0
- (id)init;	// IMP=0x00000000008cf6bc
