...
- (void).cxx_destruct;	// IMP=0x00000000002f3eef
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002f3bb4
- (id)contentViewController;	// IMP=0x00000000002f3bab
@property(readonly, nonatomic) unsigned long long gadgetCapabilities;
- (void)reviewButtonTapped:(id)arg1;	// IMP=0x00000000002f3b12
- (void)viewDidLoad;	// IMP=0x00000000002f334e
- (id)initWithPerson:(id)arg1;	// IMP=0x00000000002f32e6
