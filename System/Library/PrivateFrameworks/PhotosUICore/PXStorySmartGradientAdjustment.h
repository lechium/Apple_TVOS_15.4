...
- (long long)contentModeForProposedContentMode:(long long)arg1;	// IMP=0x0000000000208469
- (struct CGSize)requestSizeForProposedTargetSize:(struct CGSize)arg1;	// IMP=0x0000000000208458
...
- (_Bool)isEqualToDisplayAssetAdjustment:(id)arg1;	// IMP=0x00000000002081d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002081c7
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002081a2
- (id)applyToImage:(id)arg1 targetSize:(struct CGSize)arg2;	// IMP=0x000000000020696d
