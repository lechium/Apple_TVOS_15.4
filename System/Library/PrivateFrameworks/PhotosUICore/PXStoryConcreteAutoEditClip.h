...
+ (id)composedClipWithClips:(id)arg1;	// IMP=0x00000000001c7d7b
- (void).cxx_destruct;	// IMP=0x00000000001c7d53
...
- (id)description;	// IMP=0x00000000001c774a
- (id)initWithDisplayAssets:(id)arg1;	// IMP=0x00000000001c75d6
- (id)initWithDisplayAsset:(id)arg1;	// IMP=0x00000000001c7526
- (id)init;	// IMP=0x00000000001c74ac
