...
- (void).cxx_destruct;	// IMP=0x00000000002f6b1e
...
- (void)registerCleanupHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f6a78
- (void)didEndAnimation:(long long)arg1;	// IMP=0x00000000002f6a2c
- (long long)willBeginAnimation;	// IMP=0x00000000002f69e8
...
- (id)initWithContext:(id)arg1;	// IMP=0x00000000002f6751
