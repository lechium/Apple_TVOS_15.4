...
- (void).cxx_destruct;	// IMP=0x00000000004d99ab
...
- (void)performAction;	// IMP=0x00000000004d98cb
...
- (id)initWithItemProviders:(id)arg1;	// IMP=0x00000000004d9723
- (id)init;	// IMP=0x00000000004d970a
