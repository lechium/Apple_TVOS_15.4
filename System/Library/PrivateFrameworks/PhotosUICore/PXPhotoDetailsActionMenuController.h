...
- (void).cxx_destruct;	// IMP=0x000000000091a4c0
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x000000000091a330
- (void)assetCollectionActionPerformer:(id)arg1 playMovieForAssetCollection:(id)arg2;	// IMP=0x000000000091a267
- (void)actionPerformer:(id)arg1 didChangeState:(unsigned long long)arg2;	// IMP=0x000000000091a1b5
- (_Bool)actionPerformer:(id)arg1 dismissViewController:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000091a10c
- (_Bool)actionPerformer:(id)arg1 presentViewController:(id)arg2;	// IMP=0x000000000091a07e
- (_Bool)shouldAllowPerformanceOfActionType:(id)arg1;	// IMP=0x0000000000919ff9
- (id)availableActionTypes;	// IMP=0x0000000000919eac
- (id)assetCollectionActionManager;	// IMP=0x0000000000919cb1
- (id)initWithSelectionManager:(id)arg1 displayTitleInfo:(id)arg2;	// IMP=0x0000000000919789
- (id)initWithActionManagers:(id)arg1;	// IMP=0x0000000000919706
