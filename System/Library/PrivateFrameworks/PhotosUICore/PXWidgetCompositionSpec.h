...
- (void).cxx_destruct;	// IMP=0x0000000000865aa1
...
- (id)headerSpecForWidgetContentLayoutStyle:(long long)arg1;	// IMP=0x0000000000865a2f
- (id)initWithExtendedTraitCollection:(id)arg1 widgetSpec:(id)arg2;	// IMP=0x000000000086558b
- (id)init;	// IMP=0x0000000000865575
