...
+ (id)sharedInstance;	// IMP=0x00000000003b27fd
+ (id)_sliderFor:(id)arg1 path:(id)arg2;	// IMP=0x0000000000269afe
+ (id)settingsControllerModule;	// IMP=0x0000000000269509
...
- (void)setDefaultValues;	// IMP=0x00000000003b25bb
- (id)parentSettings;	// IMP=0x00000000003b25a2
