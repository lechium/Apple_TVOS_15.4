...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e83a
- (id)init;	// IMP=0x000000000000e7f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e40f
- (unsigned long long)hash;	// IMP=0x000000000000e312
