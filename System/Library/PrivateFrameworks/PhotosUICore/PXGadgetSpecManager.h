...
- (void).cxx_destruct;	// IMP=0x000000000006544b
...
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x000000000006539f
- (id)mutableChangeObject;	// IMP=0x0000000000065396
- (void)_extendedTraitCollection:(id)arg1 didChange:(unsigned long long)arg2;	// IMP=0x0000000000065247
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x000000000006505b
- (void)updateGadgetDataSourceToSpecIfNeeded:(id)arg1;	// IMP=0x0000000000064f13
- (id)initWithGadgetSpecClass:(Class)arg1 scrollAxis:(long long)arg2 traitCollection:(id)arg3;	// IMP=0x0000000000064da0
