...
+ (id)sharedInstance;	// IMP=0x00000000004fcf7d
+ (id)settingsControllerModule;	// IMP=0x000000000059b46d
...
- (void)setDefaultValues;	// IMP=0x00000000004fcab5
- (id)parentSettings;	// IMP=0x00000000004fca9c
