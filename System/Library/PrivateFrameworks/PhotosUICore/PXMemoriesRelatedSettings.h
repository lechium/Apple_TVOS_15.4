...
+ (_Bool)isAssetCountAcceptableForMemoryPlayback:(long long)arg1;	// IMP=0x00000000001fe824
+ (id)schedulerOptionsFromTimelineSchedulerMode:(unsigned long long)arg1;	// IMP=0x00000000001fe6b6
+ (id)sharedInstance;	// IMP=0x00000000001fe686
+ (void)_presentAlertWithTitle:(id)arg1 andMessage:(id)arg2 inModuleController:(id)arg3;	// IMP=0x000000000028d28f
+ (void)_presentAlertForMemoriesGenerationResult:(id)arg1 error:(id)arg2 inModuleController:(id)arg3;	// IMP=0x000000000028d142
+ (void)_generateQuestionsWithOptions:(long long)arg1 count:(unsigned long long)arg2 inModuleController:(id)arg3;	// IMP=0x000000000028d056
+ (id)settingsControllerModule;	// IMP=0x000000000028b268
...
- (void)performPostSaveActions;	// IMP=0x00000000001fdfc8
- (void)setDefaultValues;	// IMP=0x00000000001fdcad
- (id)parentSettings;	// IMP=0x00000000001fdc94
