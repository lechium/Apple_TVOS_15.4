...
- (void).cxx_destruct;	// IMP=0x00000000003dbbda
...
- (void)enumerateElementsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000003db93d
@property(readonly, nonatomic) long long numberOfColumns;
- (_Bool)_wantsEdgeToEdgeLayoutForElement:(id)arg1;	// IMP=0x00000000003db8a7
- (_Bool)scanRow:(out id *)arg1;	// IMP=0x00000000003db715
