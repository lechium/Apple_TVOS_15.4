...
- (double)remainingTime;	// IMP=0x00000000004b6bdb
- (double)elapsedTime;	// IMP=0x00000000004b6bb9
- (id)description;	// IMP=0x00000000004b6b16
- (id)initWithDuration:(double)arg1 currentMediaTime:(double)arg2 spec:(struct _PXValueAnimationSpec)arg3;	// IMP=0x00000000004b6a9c
- (id)init;	// IMP=0x00000000004b6a29
