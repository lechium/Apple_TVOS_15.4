...
- (void).cxx_destruct;	// IMP=0x0000000000364ef7
...
- (id)init;	// IMP=0x0000000000364e4c
- (id)initWithImageName:(id)arg1 isSystemImage:(_Bool)arg2 tintColor:(id)arg3 imageConfiguration:(id)arg4 inBundle:(id)arg5;	// IMP=0x0000000000364d64
- (id)initWithImageName:(id)arg1 isSystemImage:(_Bool)arg2;	// IMP=0x0000000000364d3b
- (id)initWithImageName:(id)arg1;	// IMP=0x0000000000364d10
