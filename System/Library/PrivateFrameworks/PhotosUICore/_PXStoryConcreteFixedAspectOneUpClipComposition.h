...
- (void).cxx_destruct;	// IMP=0x00000000001c9bb1
...
- (void)getClipFrames:(out struct CGRect *)arg1 forContext:(const CDStruct_0b735c3a *)arg2;	// IMP=0x00000000001c9a92
@property(readonly, nonatomic) long long numberOfClips;
- (id)description;	// IMP=0x00000000001c99e2
- (id)initWithAspectRatioNumerator:(long long)arg1 denominator:(long long)arg2;	// IMP=0x00000000001c9941
