...
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forRotationWithAngle:(double)arg2 scale:(double)arg3 relativeTransformOrigin:(struct CGPoint)arg4;	// IMP=0x00000000004038ed
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forRotationWithAngle:(double)arg2 scale:(double)arg3;	// IMP=0x00000000004038cd
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forSplitAssetOppositePansWithDistance:(double)arg2;	// IMP=0x0000000000403158
- (void)_configureClipAtIndex:(long long)arg1 forPanWithCameraMovingTowardsEdge:(unsigned int)arg2 distance:(double)arg3;	// IMP=0x0000000000403046
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forParallelPansWithDistance:(double)arg2;	// IMP=0x0000000000402f5a
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forOppositePansWithDistance:(double)arg2;	// IMP=0x0000000000402e6e
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forPanWithCameraMovingTowardsEdge:(unsigned int)arg2 distance:(double)arg3;	// IMP=0x0000000000402d79
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forZoomWithScale:(double)arg2 relativeTransformOrigin:(struct CGPoint)arg3;	// IMP=0x0000000000402d1e
- (void)getParameters:(out CDStruct_f7388bc9 *)arg1 forZoomWithScale:(double)arg2;	// IMP=0x0000000000402d01
- (void)getParametersForNoEffect:(out CDStruct_f7388bc9 *)arg1;	// IMP=0x0000000000402cb5
- (void)_getParameters:(out CDStruct_f7388bc9 *)arg1 forConfiguration:(CDUnknownBlockType)arg2;	// IMP=0x0000000000401b17
- (void)_configureWithSpec:(id)arg1 clipComposition:(id)arg2 displayAssets:(id)arg3 croppingContext:(id)arg4 croppingOptions:(unsigned long long)arg5 assetContentInfos:(const CDStruct_4cef5b45 *)arg6 playbackStyles:(const long long *)arg7 separatorEffectParameters:(const CDStruct_5eb12be8 *)arg8;	// IMP=0x00000000004015f6
- (void)dealloc;	// IMP=0x000000000040157a
- (id)_init;	// IMP=0x000000000040154b
- (id)init;	// IMP=0x00000000004014d1
