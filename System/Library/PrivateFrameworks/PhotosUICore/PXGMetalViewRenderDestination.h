...
- (void).cxx_destruct;	// IMP=0x000000000019c87d
...
- (void)drawInMTKView:(id)arg1;	// IMP=0x000000000019c7cc
- (void)mtkView:(id)arg1 drawableSizeWillChange:(struct CGSize)arg2;	// IMP=0x000000000019c769
- (void)present;	// IMP=0x000000000019c6ff
- (void)test_configureForRenderSnapshot;	// IMP=0x000000000019c67e
- (void)releaseCachedResources;	// IMP=0x000000000019c641
- (void)renderImmediately;	// IMP=0x000000000019c604
- (void)setNeedsRender;	// IMP=0x000000000019c5c7
...
- (void)_setupMetalIfNeeded;	// IMP=0x000000000019c026
- (id)init;	// IMP=0x000000000019bb45
