...
- (void).cxx_destruct;	// IMP=0x00000000008219ed
...
- (void)_handlePlaybackTimerFired:(id)arg1;	// IMP=0x00000000008216f4
- (void)setAudioDesiredPlayState:(long long)arg1;	// IMP=0x00000000008216b0
- (void)_handlePlaybackFailureIfNeeded;	// IMP=0x0000000000821477
- (void)_handleDuckingDelayPassedForTouchingBeganDate:(id)arg1;	// IMP=0x0000000000821397
- (void)_replayIfNeeded;	// IMP=0x0000000000821101
- (void)_handlePlayerChangedIsAtEnd;	// IMP=0x000000000082106d
- (CDStruct_1b6d18a9)playbackStartTimeForIncomingSong:(id)arg1;	// IMP=0x0000000000820f49
- (id)AVAudioSessionForPlayer:(id)arg1;	// IMP=0x0000000000820ef9
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x0000000000820e47
- (id)diagnosticErrorsByComponentForHUDType:(long long)arg1;	// IMP=0x0000000000820d88
- (id)diagnosticTextForHUDType:(long long)arg1 displaySize:(struct CGSize)arg2;	// IMP=0x00000000008206a0
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x0000000000820648
- (void)didPerformChanges;	// IMP=0x00000000008205de
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000008205af
- (id)diagnosticCueStringForSize:(struct CGSize)arg1 withIndicatorTime:(CDStruct_1b6d18a9)arg2 rangeIndicatorTimeRange:(CDStruct_e83c9415)arg3;	// IMP=0x0000000000820494
@property(readonly, nonatomic) CDStruct_1b6d18a9 currentTime;
@property(readonly, nonatomic) id <PXAudioCueSource> audioCueSource;
- (void)_updateError;	// IMP=0x00000000008202e8
- (void)_invalidateError;	// IMP=0x00000000008202a4
- (void)_updateFocusVolumeAnimator;	// IMP=0x00000000008200c5
- (void)_invalidateFocusVolumeAnimator;	// IMP=0x0000000000820081
- (void)_updateDuckingVolumeAnimator;	// IMP=0x000000000081ff92
- (void)_invalidateDuckingVolumeAnimator;	// IMP=0x000000000081ff4e
- (void)_updateFadeOutVolumeAnimator;	// IMP=0x000000000081fd9e
- (void)_invalidateFadeOutVolumeAnimator;	// IMP=0x000000000081fd5a
- (void)_updateDucked;	// IMP=0x000000000081fbda
- (void)_invalidateDucked;	// IMP=0x000000000081fb96
- (void)_updateTouchingBeganDate;	// IMP=0x000000000081fb01
- (void)_invalidateTouchingBeganDate;	// IMP=0x000000000081fabd
- (void)_updatePlayerVolume;	// IMP=0x000000000081f7fe
- (void)_invalidatePlayerVolume;	// IMP=0x000000000081f7ba
- (void)_updateModelProperties;	// IMP=0x000000000081f6f1
- (void)_invalidateModelProprties;	// IMP=0x000000000081f6ad
- (void)_updateReadinessStatus;	// IMP=0x000000000081f603
- (void)_invalidateReadinessStatus;	// IMP=0x000000000081f5bf
- (void)_updatePlaybackTimer;	// IMP=0x000000000081f4dd
- (void)_invalidatePlaybackTimer;	// IMP=0x000000000081f499
- (void)_updatePlayerDesiredPlayState;	// IMP=0x000000000081f3ed
- (void)_invalidatePlayerDesiredPlayState;	// IMP=0x000000000081f3a9
- (void)_updateDesiredPlayState;	// IMP=0x000000000081f25f
- (void)_invalidateDesiredPlayState;	// IMP=0x000000000081f21b
- (void)_updatePlayerCurrentAsset;	// IMP=0x000000000081f134
- (void)_invalidatePlayerCurrentAsset;	// IMP=0x000000000081f0f0
- (void)_handleAudioCues:(id)arg1 asset:(id)arg2 error:(id)arg3 requestID:(long long)arg4;	// IMP=0x000000000081efd7
- (void)_updateCueSource;	// IMP=0x000000000081ee81
- (void)_invalidateCueSource;	// IMP=0x000000000081ee2b
- (void)_updateCurrentAudioAsset;	// IMP=0x000000000081edbc
- (void)_invalidateCurrentAudioAsset;	// IMP=0x000000000081ed78
- (void)_handleTargetDurationFlexAsset:(id)arg1 requestID:(long long)arg2;	// IMP=0x000000000081ec83
- (void)_updateCurrentSongResource;	// IMP=0x000000000081e8b9
- (void)_invalidateCurrentSongResource;	// IMP=0x000000000081e875
- (void)_updateTargetDuration;	// IMP=0x000000000081e7bb
- (void)_invalidateTargetDuration;	// IMP=0x000000000081e777
@property(readonly, copy) NSString *description;
- (void)replay;	// IMP=0x000000000081e5c4
- (id)diagnosticTextForHUDType:(long long)arg1;	// IMP=0x000000000081e535
- (void)setCurrentSongResource:(id)arg1 requestID:(long long)arg2;	// IMP=0x000000000081deb4
- (void)setIsActive:(_Bool)arg1;	// IMP=0x000000000081d963
- (id)initWithModel:(id)arg1;	// IMP=0x000000000081d326
- (id)init;	// IMP=0x000000000081d2ac
