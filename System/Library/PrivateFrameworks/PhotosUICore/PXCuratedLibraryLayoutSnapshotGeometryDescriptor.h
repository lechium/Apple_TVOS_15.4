...
- (void).cxx_destruct;	// IMP=0x0000000000683474
...
- (id)description;	// IMP=0x0000000000683244
- (void)compactifySectionsBeyondVisibleRectWithAnchorSection:(long long)arg1;	// IMP=0x000000000068266e
- (void)extrapolateSectionsBetween:(long long)arg1 and:(long long)arg2 withAnchorSection:(long long)arg3;	// IMP=0x0000000000681f5a
@property(readonly, nonatomic) NSIndexSet *sections;
- (id)geometryDescriptorForSectionAtIndexPath:(struct PXSimpleIndexPath)arg1;	// IMP=0x0000000000681cbb
@property(readonly, nonatomic) struct CGRect visibleRect; // @synthesize visibleRect=_visibleRect;
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000681a03
- (id)init;	// IMP=0x0000000000681989
