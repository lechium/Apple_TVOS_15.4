...
+ (id)configurationWithCollectionsFetchResult:(id)arg1;	// IMP=0x00000000000e2b07
+ (id)configurationWithCollectionList:(id)arg1;	// IMP=0x00000000000e2abe
- (void).cxx_destruct;	// IMP=0x00000000000e2a8b
...
- (id)description;	// IMP=0x00000000000e290d
- (id)initWithCollectionsFetchResult:(id)arg1;	// IMP=0x00000000000e28a2
- (id)initWithCollectionList:(id)arg1;	// IMP=0x00000000000e2837
