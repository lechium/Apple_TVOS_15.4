...
- (void).cxx_destruct;	// IMP=0x000000000074414d
...
- (long long)compareByClipFrameOriginY:(id)arg1;	// IMP=0x0000000000743f41
- (long long)compareByClipFrameOriginX:(id)arg1;	// IMP=0x0000000000743e43
