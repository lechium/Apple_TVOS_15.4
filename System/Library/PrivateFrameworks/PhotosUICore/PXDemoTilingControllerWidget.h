...
- (void).cxx_destruct;	// IMP=0x0000000000591491
...
- (id)tilingController:(id)arg1 tileIdentifierConverterForChange:(id)arg2;	// IMP=0x00000000005912d3
- (void)checkInTile:(void *)arg1 withIdentifier:(struct PXTileIdentifier)arg2;	// IMP=0x000000000059106c
- (void *)checkOutTileForIdentifier:(struct PXTileIdentifier)arg1 layout:(id)arg2;	// IMP=0x0000000000590d93
- (id)assetsScene:(id)arg1 layoutForDataSource:(id)arg2;	// IMP=0x0000000000590d7e
- (void)userDidSelectSubtitle;	// IMP=0x0000000000590c5a
@property(readonly, nonatomic) NSString *localizedCaption;
@property(readonly, nonatomic) NSString *localizedTitle; // @dynamic localizedTitle;
@property(readonly, nonatomic) PXTilingController *contentTilingController;
- (double)preferredContentHeightForWidth:(double)arg1;	// IMP=0x0000000000590c04
@property(readonly, nonatomic) _Bool hasContentForCurrentInput;
- (id)_demoTilingLayoutForDataSource:(id)arg1;	// IMP=0x0000000000590add
- (void)_loadTilingController;	// IMP=0x00000000005908a8
- (id)init;	// IMP=0x0000000000590857
