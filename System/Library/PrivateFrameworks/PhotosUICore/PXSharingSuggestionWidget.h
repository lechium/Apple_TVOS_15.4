...
- (void).cxx_destruct;	// IMP=0x00000000003ed1ea
...
- (void)_resetControllerLayoutInfosForWidth:(double)arg1;	// IMP=0x00000000003ecffa
- (unsigned long long)_numberOfVisibleFacesForWidth:(double)arg1;	// IMP=0x00000000003ecf40
- (id)traitCollection;	// IMP=0x00000000003ecebc
- (struct CGSize)_sizeForItemWithWidth:(double)arg1 withInterItemSpacing:(double)arg2;	// IMP=0x00000000003ecdf4
- (_Bool)_calculateLayoutInfosForWidth:(double)arg1 cellSize:(struct CGSize *)arg2 interitemSpacing:(double *)arg3;	// IMP=0x00000000003ecd0f
- (void)_loadContainerView;	// IMP=0x00000000003ecbb5
- (struct UIEdgeInsets)_realContentInset;	// IMP=0x00000000003ecb09
- (void)_prepareDataSource;	// IMP=0x00000000003ec946
- (void)peopleDataSource:(id)arg1 didUpdateMembersAtIndexPaths:(id)arg2;	// IMP=0x00000000003ec8ad
- (void)peopleDataSource:(id)arg1 didRemoveMembersAtIndexPaths:(id)arg2;	// IMP=0x00000000003ec814
- (void)peopleDataSource:(id)arg1 didAddMembersAtIndexPaths:(id)arg2;	// IMP=0x00000000003ec77b
- (void)peopleDataSource:(id)arg1 didApplyIncrementalChanges:(id)arg2;	// IMP=0x00000000003ec683
- (void)peopleDataSourceMembersChanged:(id)arg1;	// IMP=0x00000000003ec51a
- (void)memberTappedAtIndexPath:(id)arg1 atPoint:(struct CGPoint)arg2 forPeopleStripController:(id)arg3;	// IMP=0x00000000003ec514
- (struct UIEdgeInsets)sectionInset;	// IMP=0x00000000003ec4ec
- (double)minimumInteritemSpacing;	// IMP=0x00000000003ec4da
- (double)minimumLineSpacing;	// IMP=0x00000000003ec4c8
- (struct CGSize)sizeForItem;	// IMP=0x00000000003ec4b6
- (void)contentSizeCategoryChanged:(id)arg1;	// IMP=0x00000000003ec3fc
- (double)preferredContentHeightForWidth:(double)arg1;	// IMP=0x00000000003ec31e
@property(readonly, nonatomic) NSString *localizedTitle;
@property(readonly, nonatomic) NSObject<PXAnonymousView> *contentView;
@property(readonly, nonatomic) _Bool hasContentForCurrentInput;
- (void)unloadContentData;	// IMP=0x00000000003ebf83
- (void)loadContentData;	// IMP=0x00000000003ebf12
- (id)initWithSharingStream:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000003ebea6
