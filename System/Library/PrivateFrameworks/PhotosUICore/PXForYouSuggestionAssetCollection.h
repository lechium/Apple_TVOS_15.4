...
@interface PXForYouSuggestionAssetCollection <PXDisplayAssetCollection>
{
    _Bool _isEnriched;	// 8 = 0x8
    _Bool _isEnrichmentComplete;	// 9 = 0x9
    _Bool _isAggregation;	// 10 = 0xa
    _Bool _isRecent;	// 11 = 0xb
    unsigned short _px_highlightEnrichmentState;	// 12 = 0xc
    NSString *_localizedTitle;	// 16 = 0x10
    NSString *_localizedSubtitle;	// 24 = 0x18
    NSString *_localizedSmartDescription;	// 32 = 0x20
    NSString *_localizedDateDescription;	// 40 = 0x28
    NSString *_localizedDebugDescription;	// 48 = 0x30
    NSArray *_localizedLocationNames;	// 56 = 0x38
    NSDate *_startDate;	// 64 = 0x40
    NSDate *_endDate;	// 72 = 0x48
    double _promotionScore;	// 80 = 0x50
    unsigned long long _estimatedAssetCount;	// 88 = 0x58
    long long _px_highlightKind;	// 96 = 0x60
}

- (void).cxx_destruct;	// IMP=0x00000000007850ca
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x0000000000784f4a
@property(readonly, nonatomic) NSString *uuid;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000784ecb
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 startDate:(id)arg3 endDate:(id)arg4;	// IMP=0x0000000000784df5
- (id)init;	// IMP=0x0000000000784d7b
