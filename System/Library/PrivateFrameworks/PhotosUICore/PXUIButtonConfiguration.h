...
+ (id)configurationWithCursorEffect:(long long)arg1;	// IMP=0x0000000000731449
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007313ad
- (id)init;	// IMP=0x0000000000731357
