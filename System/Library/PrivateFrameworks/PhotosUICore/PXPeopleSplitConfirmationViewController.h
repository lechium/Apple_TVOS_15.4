...
- (void).cxx_destruct;	// IMP=0x000000000090463f
...
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000904404
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000009042f7
- (void)contentSizeCategoryDidChangeNotification:(id)arg1;	// IMP=0x00000000009042ba
- (void)noMoreSuggestionsAvailableForSuggestionManager:(id)arg1;	// IMP=0x000000000090423d
- (void)suggestionManager:(id)arg1 hasNewSuggestionsAvailable:(id)arg2;	// IMP=0x00000000009041c0
- (void)_updateUndoButton;	// IMP=0x0000000000904101
- (id)_buttonBackgroundImageFromColor:(id)arg1;	// IMP=0x000000000090404c
- (void)_disableActionButtonsWithSelectedButton:(id)arg1;	// IMP=0x0000000000903f10
- (void)_enableActionButtons;	// IMP=0x0000000000903df5
- (id)_buttonWithTitle:(id)arg1 action:(SEL)arg2 andColor:(id)arg3;	// IMP=0x0000000000903b8d
- (void)undoButtonTapped:(id)arg1;	// IMP=0x0000000000903b2c
- (void)denyTapped:(id)arg1;	// IMP=0x0000000000903a3f
- (void)confirmTapped:(id)arg1;	// IMP=0x0000000000903952
- (void)suggestionDidDisplay;	// IMP=0x0000000000903911
- (void)updateViewWithViewState:(unsigned long long)arg1;	// IMP=0x00000000009037e0
- (void)dealloc;	// IMP=0x00000000009020f8
- (void)updateViewConstraints;	// IMP=0x0000000000901cba
- (void)viewDidLoad;	// IMP=0x00000000009017b7
- (id)initWithPerson:(id)arg1;	// IMP=0x0000000000901723
