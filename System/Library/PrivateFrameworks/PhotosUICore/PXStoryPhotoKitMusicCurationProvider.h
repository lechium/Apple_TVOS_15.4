...
+ (id)sharedInstance;	// IMP=0x000000000004ffd0
- (void).cxx_destruct;	// IMP=0x000000000004d1e6
...
- (void)_saveNegativeFeedbackForSongIdentifier:(id)arg1 memory:(id)arg2;	// IMP=0x000000000004d0ab
- (void)_replaceSongWithSong:(id)arg1 inCachedResultForAssetCollection:(id)arg2;	// IMP=0x000000000004cfcf
- (void)_removeRejectedSong:(id)arg1 fromCachedResultForAssetCollection:(id)arg2;	// IMP=0x000000000004cef3
- (id)_cachedResultForAssetCollection:(id)arg1 options:(id)arg2;	// IMP=0x000000000004cd31
- (void)_handleMusicCurationResult:(id)arg1 forAssetCollection:(id)arg2 options:(id)arg3;	// IMP=0x000000000004cc26
- (id)_performRequestForAssetCollection:(id)arg1 options:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000004c7a1
- (void)updateAudioAsset:(id)arg1 forAssetCollection:(id)arg2;	// IMP=0x000000000004c6b4
- (void)applyNegativeFeedbackToSong:(id)arg1 forMemory:(id)arg2;	// IMP=0x000000000004c58d
- (id)requestMusicCurationForAssetCollection:(id)arg1 options:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000004c049
@property(retain, nonatomic) NSArray *recentlyUsedAppleMusicSongIDs;
@property(retain, nonatomic) NSArray *recentlyUsedFlexSongIDs;
- (id)init;	// IMP=0x000000000004bbd5
