...
- (id)description;	// IMP=0x0000000000251002
@property(readonly, nonatomic) CDStruct_1b6d18a9 currentTime;
- (id)initWithSampleTime:(CDStruct_1b6d18a9)arg1 rate:(float)arg2;	// IMP=0x0000000000250eb3
- (id)initWithSampleTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000250e99
