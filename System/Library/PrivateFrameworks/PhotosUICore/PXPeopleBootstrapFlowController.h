...
- (void).cxx_destruct;	// IMP=0x00000000004a775f
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000004a768d
- (void)cancel:(id)arg1;	// IMP=0x00000000004a75c4
- (void)done:(id)arg1;	// IMP=0x00000000004a74e3
...
- (void)recomputeViewControllersForChangeInKeyPath:(id)arg1;	// IMP=0x00000000004a726f
- (void)computeViewControllersForBootstrapFlow;	// IMP=0x00000000004a7269
@property(readonly, nonatomic) _Bool shouldPresentPostNaming;
@property(readonly, nonatomic) _Bool shouldPresentNaming;
- (void)dealloc;	// IMP=0x00000000004a70e8
- (id)initEmptyFlowWithContext:(id)arg1;	// IMP=0x00000000004a7080
- (id)initWithContext:(id)arg1;	// IMP=0x00000000004a6fb3
- (void)commonInitWithContext:(id)arg1;	// IMP=0x00000000004a6f53
- (id)init;	// IMP=0x00000000004a6f28
