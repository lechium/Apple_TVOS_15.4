...
- (void).cxx_destruct;	// IMP=0x00000000008cdfec
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000008cde8c
- (void)_updateContentLayer;	// IMP=0x00000000008cddde
- (void)_updateLayerPromiseIfNeeded;	// IMP=0x00000000008cdaf0
- (void)_invalidateLayerPromise;	// IMP=0x00000000008cdad3
- (void)layoutSubviews;	// IMP=0x00000000008cda92
- (struct CGRect)contentBounds;	// IMP=0x00000000008cda1a
@property(readonly, nonatomic) NSArray *diagnosticsRenderedLines;
@property(readonly, nonatomic) double lastBaseline;
- (void)_handleChangeFromBounds:(struct CGRect)arg1;	// IMP=0x00000000008cd3b5
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000008cd337
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000008cd2b9
- (void)_PXTitleSubtitleUILabelCommonInitialization;	// IMP=0x00000000008cd217
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000008cd1ba
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008cd16e
