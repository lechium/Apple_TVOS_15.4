...
- (void).cxx_destruct;	// IMP=0x0000000000766245
...
- (id)description;	// IMP=0x0000000000766136
- (id)resultTupleUpdatedWithChange:(id)arg1;	// IMP=0x0000000000765e68
- (id)initWithFetchResult:(id)arg1 fetchedWithReverseSortOrder:(_Bool)arg2 curatedFetchResult:(id)arg3 curatedRefetchCondition:(CDUnknownBlockType)arg4 keyAssetsFetchResult:(id)arg5 filterPredicate:(id)arg6;	// IMP=0x0000000000765d52
