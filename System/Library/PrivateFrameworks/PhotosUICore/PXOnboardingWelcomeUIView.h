...
- (void).cxx_destruct;	// IMP=0x0000000000015f0e
...
- (id)_createPadConstraints;	// IMP=0x00000000000152d5
- (id)_createLandscapeConstraintsPhone;	// IMP=0x00000000000147a4
- (id)_createPortraitConstraintsPhone;	// IMP=0x0000000000013f93
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000013e88
- (void)updateConstraints;	// IMP=0x0000000000013cf3
- (void)_invalidateConstraints;	// IMP=0x0000000000013c4c
- (void)_updateButtonIfNeeded;	// IMP=0x000000000001393b
- (void)_invalidateButton;	// IMP=0x000000000001391e
- (void)tintColorDidChange;	// IMP=0x00000000000135b0
- (void)commonInit;	// IMP=0x0000000000013206
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000131ba
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001315d
