...
- (void).cxx_destruct;	// IMP=0x000000000054ab94
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000054a88d
- (unsigned long long)_ensureAssetsAreLocallyAvailable:(id *)arg1;	// IMP=0x000000000054a6ce
- (id)_setUpLocalAvailabilityRequests;	// IMP=0x000000000054a1b7
- (id)ensureLocalAvailabilityOfAssetsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000549f76
- (id)initWithAssets:(id)arg1;	// IMP=0x0000000000549f0b
