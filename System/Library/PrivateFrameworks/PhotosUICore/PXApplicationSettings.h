...
+ (id)sharedInstance;	// IMP=0x0000000000457c5c
+ (id)settingsControllerModule;	// IMP=0x0000000000497601
- (void).cxx_destruct;	// IMP=0x0000000000457c49
...
- (void)setDefaultValues;	// IMP=0x0000000000457b6f
- (id)parentSettings;	// IMP=0x0000000000457b56
