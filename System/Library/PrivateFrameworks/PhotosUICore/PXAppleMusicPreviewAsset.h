...
+ (CDStruct_1b6d18a9)previewClipDuration;	// IMP=0x00000000003edc09
- (void).cxx_destruct;	// IMP=0x00000000003edbf9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003edb34
- (_Bool)isAudioEqualToAsset:(id)arg1;	// IMP=0x00000000003edb22
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003eda57
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000003eda49
- (id)initWithOriginalAsset:(id)arg1;	// IMP=0x00000000003ed9de
