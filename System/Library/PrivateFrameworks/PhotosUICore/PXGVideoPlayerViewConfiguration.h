...
- (void).cxx_destruct;	// IMP=0x000000000055c5ed
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055c5cf
- (void)prepareForRender;	// IMP=0x000000000055c5c9
- (id)init;	// IMP=0x000000000055c54f
- (id)initWithVideoSession:(id)arg1 toneMapToStandardDynamicRange:(_Bool)arg2;	// IMP=0x000000000055c4d9
