...
- (void).cxx_destruct;	// IMP=0x000000000034bff1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000034bc01
- (_Bool)isEqualToNavigationListItem:(id)arg1;	// IMP=0x000000000034b7c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000034b68a
...
- (id)initWithIdentifier:(id)arg1 title:(id)arg2;	// IMP=0x000000000034b3fb
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 itemCount:(long long)arg3;	// IMP=0x000000000034b31d
