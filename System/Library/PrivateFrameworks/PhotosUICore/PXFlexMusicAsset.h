...
- (void).cxx_destruct;	// IMP=0x000000000000bad0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b8ef
- (id)initWithConfiguration:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b885
- (_Bool)isAudioEqualToAsset:(id)arg1;	// IMP=0x000000000000b75d
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b67c
