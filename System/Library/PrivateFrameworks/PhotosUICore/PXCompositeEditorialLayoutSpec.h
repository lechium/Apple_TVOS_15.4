...
+ (id)defaultSpec;	// IMP=0x00000000007afd53
- (void).cxx_destruct;	// IMP=0x00000000007afbb8
...
- (id)preferredNextTemplatesForTemplate:(id)arg1;	// IMP=0x00000000007afb70
- (void)prepareBuiltinSpec;	// IMP=0x00000000007af553
- (id)_init;	// IMP=0x00000000007af507
- (id)init;	// IMP=0x00000000007af454
