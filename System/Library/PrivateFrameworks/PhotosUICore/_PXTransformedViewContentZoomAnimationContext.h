...
- (void).cxx_destruct;	// IMP=0x00000000002f6fc3
...
- (void)registerCleanupHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f6f13
- (void)didEndAnimation:(long long)arg1;	// IMP=0x00000000002f6ec7
- (long long)willBeginAnimation;	// IMP=0x00000000002f6e83
...
- (id)initWithTransformedView:(id)arg1 context:(id)arg2;	// IMP=0x00000000002f6b51
