...
+ (id)invitationWithAssetCollection:(id)arg1;	// IMP=0x00000000001bb092
+ (id)_invitationWithAssetCollection:(id)arg1 previewAssetsFetchResult:(id)arg2;	// IMP=0x00000000001baf7d
+ (id)_participantsForAssetCollection:(id)arg1;	// IMP=0x00000000001bae56
+ (id)new;	// IMP=0x00000000001baddc
- (void).cxx_destruct;	// IMP=0x00000000001bad7d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bad22
- (void)acceptWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001bad07
- (id)contextForActivityType:(unsigned long long)arg1;	// IMP=0x00000000001bacc8
...
- (id)invitationWithUpdatedPreviewAssetsFetchResult:(id)arg1;	// IMP=0x00000000001bab6c
@property(readonly, copy) NSString *description;
- (id)initWithAssetCollection:(id)arg1;	// IMP=0x00000000001ba8e2
- (id)init;	// IMP=0x00000000001ba868
