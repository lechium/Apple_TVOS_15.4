...
- (void).cxx_destruct;	// IMP=0x0000000000646e1f
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x0000000000646d07
- (void)_updateDataSourceDependentProperties;	// IMP=0x0000000000646bb6
- (id)mutableChangeObject;	// IMP=0x0000000000646bad
- (id)init;	// IMP=0x00000000006467a3
- (id)initWithDataSourceManager:(id)arg1 mediaProvider:(id)arg2 selectionManager:(id)arg3;	// IMP=0x00000000006464cc
- (id)initWithDataSourceManager:(id)arg1 mediaProvider:(id)arg2;	// IMP=0x00000000006464b7
