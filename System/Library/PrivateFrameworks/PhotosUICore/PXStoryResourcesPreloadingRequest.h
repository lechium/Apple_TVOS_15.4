...
- (void).cxx_destruct;	// IMP=0x00000000007a0b7d
...
- (id)initWithTimeline:(id)arg1 timelineAttributes:(unsigned long long)arg2 startingSegmentIdentifier:(long long)arg3 shouldIgnoreStartingSegmentIdentifier:(_Bool)arg4;	// IMP=0x00000000007a0a96
