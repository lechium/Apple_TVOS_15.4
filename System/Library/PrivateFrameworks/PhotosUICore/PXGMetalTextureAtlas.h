...
+ (unsigned int)maxCapacityForThumbnailSize:(struct CGSize)arg1 pixelFormat:(unsigned long long)arg2;	// IMP=0x0000000000604fcc
- (void).cxx_destruct;	// IMP=0x00000000006047a5
...
- (void)_syncQueue_checkinThumbnailIndex:(unsigned int)arg1;	// IMP=0x00000000006046b6
- (unsigned int)_syncQueue_checkoutNextThumbnailIndex;	// IMP=0x000000000060463d
- (void)_syncQueue_resizeStorageIfNeeded;	// IMP=0x00000000006045cf
...
- (void)cleanupAfterRender:(long long)arg1;	// IMP=0x0000000000604552
- (void)prepareForRender:(long long)arg1;	// IMP=0x00000000006044a2
...
- (void)removeSpriteIndex:(unsigned int)arg1;	// IMP=0x0000000000604355
- (void)processPendingTextureRequestIDsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000006042b4
- (void)addSpriteWithTextureRequestID:(int)arg1 deliveryOrder:(unsigned int)arg2;	// IMP=0x000000000060421c
- (_Bool)containsSpriteIndex:(unsigned int)arg1;	// IMP=0x00000000006041c9
- (void)getTextureInfos:(CDStruct_183601bc *)arg1 forSpriteIndexes:(unsigned int *)arg2 geometries:(const CDStruct_4f725fed *)arg3 spriteStyles:(const CDStruct_76b550e2 *)arg4 spriteInfos:(const CDStruct_9d1ebe49 *)arg5 screenScale:(double)arg6 count:(unsigned int)arg7;	// IMP=0x0000000000604053
- (void)enumerateSpriteIndexes:(CDUnknownBlockType)arg1;	// IMP=0x0000000000603f97
- (void)getSpriteIndexes:(unsigned int *)arg1 maxSpriteCount:(unsigned int)arg2;	// IMP=0x0000000000603df4
...
- (void)_syncQueue_releaseThumbnailsAtIndexes:(id)arg1;	// IMP=0x0000000000603cb5
- (void)_syncQueue_releaseThumbnailAtIndex:(long long)arg1;	// IMP=0x0000000000603be9
- (void)_syncQueue_retainThumbnailsAtIndexes:(id)arg1;	// IMP=0x0000000000603b8c
- (void)_syncQueue_retainThumbnailAtIndex:(long long)arg1;	// IMP=0x0000000000603b78
- (void)applyChangeDetails:(id)arg1;	// IMP=0x0000000000603a6f
- (void)processPendingThumbnailRequestIDsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000006039bc
- (void)_checkinPendingThumbnailIndexesIfNeeded;	// IMP=0x00000000006038cd
- (void)removeSpriteIndex:(unsigned int)arg1 atThumbnailIndex:(unsigned int)arg2;	// IMP=0x0000000000603834
- (void)_invalidateRenderedSpriteIndexes;	// IMP=0x0000000000603813
- (void)addSpriteWithTextureRequestID:(int)arg1 thumbnailData:(id)arg2 size:(struct CGSize)arg3 bytesPerRow:(unsigned long long)arg4 contentsRect:(struct CGRect)arg5;	// IMP=0x000000000060341b
...
- (void)dealloc;	// IMP=0x000000000060316f
- (id)init;	// IMP=0x00000000006030f5
- (id)initWithThumbnailSize:(struct CGSize)arg1 pixelFormat:(unsigned long long)arg2 capacity:(unsigned int)arg3 colorProgram:(id)arg4 device:(id)arg5 layoutQueue:(id)arg6;	// IMP=0x0000000000602aa8
