...
- (void).cxx_destruct;	// IMP=0x0000000000354aa3
...
- (void)_enumerateSpriteConstraintsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000035425f
- (void)enumerateSpritesWithEnumerationOptions:(unsigned long long)arg1 referencingOptions:(unsigned long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000354192
- (id)copyWithLayout:(id)arg1;	// IMP=0x0000000000353f16
- (void)enumerateAllSpriteReferencesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000353c2c
- (void)adjustReferencedSpriteIndexesWithChangeDetails:(id)arg1 appliedToLayout:(id)arg2;	// IMP=0x0000000000353a87
@property(readonly, nonatomic) _Bool isScrollingAnimationAnchor;
- (unsigned int)anchoredSpriteIndexInLayout:(id)arg1;	// IMP=0x00000000003538e9
...
- (struct CGRect)adjustVisibleRect:(struct CGRect)arg1;	// IMP=0x0000000000352cf6
@property(readonly, nonatomic) _Bool canBeReused;
- (id)autoInvalidate;	// IMP=0x0000000000352b9c
- (void)invalidate;	// IMP=0x0000000000352b50
@property(readonly, copy) NSString *description;
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000352801
- (id)init;	// IMP=0x0000000000352787
