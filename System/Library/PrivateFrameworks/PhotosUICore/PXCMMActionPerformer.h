...
- (void).cxx_destruct;	// IMP=0x0000000000501d44
@property(retain, nonatomic) NSProgress *progress; // @synthesize progress=_progress;
@property(readonly, nonatomic) PXCMMSession *session; // @synthesize session=_session;
- (id)createActionProgress;	// IMP=0x0000000000501d06
- (id)performActionWithSession:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000501bb3
- (_Bool)canPerformActionWithSession:(id)arg1;	// IMP=0x0000000000501bab
