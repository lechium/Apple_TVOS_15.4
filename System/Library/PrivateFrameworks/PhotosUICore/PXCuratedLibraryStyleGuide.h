...
- (void).cxx_destruct;	// IMP=0x00000000000c5656
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000000c54da
- (void)_update;	// IMP=0x00000000000c51fa
- (void)_invalidate;	// IMP=0x00000000000c51e8
- (id)initWithExtendedTraitCollection:(id)arg1;	// IMP=0x00000000000c4fa1
- (id)init;	// IMP=0x00000000000c4f27
