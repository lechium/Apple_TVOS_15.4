...
- (void).cxx_destruct;	// IMP=0x00000000001bc6a0
...
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x00000000001bc64c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bc5b7
@property(readonly, nonatomic) _Bool isInCloud;
@property(readonly, nonatomic) Class defaultImageProviderClass;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bc4f0
- (id)init;	// IMP=0x00000000001bc476
- (id)initWithAudioAsset:(id)arg1;	// IMP=0x00000000001bc40b
