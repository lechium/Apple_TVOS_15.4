...
+ (struct CGSize)sizeThatFits:(struct CGSize)arg1 withConfiguration:(id)arg2;	// IMP=0x00000000008d5352
- (void).cxx_destruct;	// IMP=0x00000000008d533f
...
- (void)prepareForReuse;	// IMP=0x00000000008d52dc
- (void)becomeReusable;	// IMP=0x00000000008d52d6
