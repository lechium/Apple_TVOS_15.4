...
- (void).cxx_destruct;	// IMP=0x000000000003d505
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x000000000003cfd8
- (unsigned int)axSpriteIndexClosestToSpriteIndex:(unsigned int)arg1 inDirection:(unsigned long long)arg2;	// IMP=0x000000000003cfc6
- (id)axSpriteIndexesInRect:(struct CGRect)arg1;	// IMP=0x000000000003cfb4
- (id)axSpriteIndexes;	// IMP=0x000000000003cf8f
- (id)hitTestResultForSpriteIndex:(unsigned int)arg1;	// IMP=0x000000000003cd09
- (id)_configurationForButton:(unsigned long long)arg1 overBackgroundVariant:(_Bool)arg2;	// IMP=0x000000000003cc3c
- (id)_configurationForButton:(unsigned long long)arg1;	// IMP=0x000000000003cbd8
- (id)configurationForButton:(unsigned long long)arg1 spec:(id)arg2;	// IMP=0x000000000003c3c1
- (void)_discardAllCachedButtonSizes;	// IMP=0x000000000003c381
- (struct CGSize)_sizeOfButton:(unsigned long long)arg1;	// IMP=0x000000000003c2ca
- (id)viewUserDataForSpriteAtIndex:(unsigned int)arg1 inLayout:(id)arg2;	// IMP=0x000000000003bd0c
- (Class)viewClassForSpriteAtIndex:(unsigned int)arg1 inLayout:(id)arg2;	// IMP=0x000000000003bc17
- (void)didRenderTitleAndSubtitleSpriteAtIndex:(unsigned int)arg1 layoutVersion:(long long)arg2 withLastBaseline:(double)arg3;	// IMP=0x000000000003bbc9
- (id)imageConfigurationAtIndex:(unsigned int)arg1 inLayout:(id)arg2;	// IMP=0x000000000003bb79
- (id)_titleSubtitleSpecForItemIdentifier:(id)arg1;	// IMP=0x000000000003ba85
- (id)titleSubtitleSpecForSpriteAtIndex:(unsigned int)arg1;	// IMP=0x000000000003b8f1
- (id)subtitleForSpriteAtIndex:(unsigned int)arg1;	// IMP=0x000000000003b8df
- (id)titleForSpriteAtIndex:(unsigned int)arg1;	// IMP=0x000000000003b8cd
- (void)_handleAsyncDateDescription:(id)arg1 placement:(long long)arg2 generation:(long long)arg3;	// IMP=0x000000000003b31b
- (void)_updateTitleAndSubtitle;	// IMP=0x000000000003ae2d
- (id)_effectiveTitleSubtitleLabelSpec:(id)arg1;	// IMP=0x000000000003ad8a
- (void)_updateEffectiveSpec;	// IMP=0x000000000003aa97
- (void)_invalidateFilterIndicatorButton;	// IMP=0x0000000000039c3b
- (void)_invalidateFilterButton;	// IMP=0x0000000000039b06
- (void)_updateLastBaseline;	// IMP=0x000000000003877f
- (void)alphaDidChange;	// IMP=0x0000000000037df5
- (void)screenScaleDidChange;	// IMP=0x0000000000037ce2
- (void)referenceOptionsDidChange;	// IMP=0x0000000000037bcf
- (void)referenceSizeDidChange;	// IMP=0x0000000000037abc
- (void)safeAreaInsetsDidChange;	// IMP=0x000000000003796c
- (void)visibleRectDidChange;	// IMP=0x0000000000037758
- (void)setVisibleRect:(struct CGRect)arg1;	// IMP=0x0000000000037679
- (unsigned int)spriteIndexForObjectReference:(id)arg1 options:(unsigned long long)arg2 updatedObjectReference:(out id *)arg3;	// IMP=0x000000000003729f
- (id)objectReferenceForSpriteIndex:(unsigned int)arg1;	// IMP=0x000000000003707f
- (id)_selectionTitleLabelConfigurationWithTitle:(id)arg1;	// IMP=0x0000000000037013
@property(readonly, nonatomic) unsigned long long toggleAspectFitButton;
- (struct UIEdgeInsets)safeAreaInsetsWithCurrentBehavior;	// IMP=0x0000000000036e02
- (void)_updateSpritesAlpha;	// IMP=0x0000000000036a69
- (void)_updateSpriteTags;	// IMP=0x0000000000036974
- (void)_updateButtonActionPerformers;	// IMP=0x00000000000368bc
- (void)_updateSprites;	// IMP=0x000000000003431f
- (void)update;	// IMP=0x0000000000033c49
- (id)init;	// IMP=0x0000000000033a34
