...
- (id)description;	// IMP=0x000000000086e8ab
- (double)valueAtTime:(double)arg1;	// IMP=0x000000000086e790
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(double)arg4;	// IMP=0x000000000086da4d
