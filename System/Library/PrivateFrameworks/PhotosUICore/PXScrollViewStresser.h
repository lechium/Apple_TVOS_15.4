...
+ (id)sharedInstance;	// IMP=0x00000000007baf4c
- (void).cxx_destruct;	// IMP=0x00000000007baf24
...
- (void)stopScrolling;	// IMP=0x00000000007bae5f
@property(readonly, nonatomic, getter=isScrolling) _Bool scrolling;
- (void)_handleDisplayLink:(id)arg1;	// IMP=0x00000000007bac46
- (void)startScrollingScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x00000000007bab08
