...
+ (id)transientProperties;	// IMP=0x00000000006615a0
+ (id)sharedInstance;	// IMP=0x0000000000661570
+ (id)settingsControllerModule;	// IMP=0x00000000004a2896
...
- (long long)version;	// IMP=0x0000000000660d8f
- (struct PXAssetBadgeInfo)debugBadgeInfo;	// IMP=0x0000000000660d28
- (void)setDefaultValues;	// IMP=0x00000000006608bd
- (id)parentSettings;	// IMP=0x00000000006608a4
