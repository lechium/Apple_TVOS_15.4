...
- (void).cxx_destruct;	// IMP=0x000000000087982f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008797d4
@property(readonly, nonatomic) NSDate *endDate;
@property(readonly, nonatomic) NSDate *startDate;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000879604
- (id)fetchKeyAssets;	// IMP=0x00000000008794b9
@property(readonly, copy, nonatomic) NSString *localIdentifier;
- (id)initWithAsset:(id)arg1 type:(unsigned short)arg2 subtype:(unsigned short)arg3 title:(id)arg4;	// IMP=0x00000000008793a9
