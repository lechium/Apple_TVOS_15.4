...
+ (id)new;	// IMP=0x000000000084c8e0
- (void).cxx_destruct;	// IMP=0x000000000084c457
...
- (void)_updateCPLStatus;	// IMP=0x000000000084bd09
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x000000000084bc44
- (void)_updateCountsAndStatus;	// IMP=0x000000000084aa58
- (void)setState:(long long)arg1;	// IMP=0x000000000084a9da
- (void)setType:(long long)arg1;	// IMP=0x000000000084a379
- (void)didPerformChanges;	// IMP=0x000000000084a2b8
@property(readonly, nonatomic) id <PXDisplayMomentShare> momentShare;
@property(readonly, copy) NSString *description;
- (id)initWithMomentShare:(id)arg1 presentationStyle:(long long)arg2;	// IMP=0x0000000000849ea6
- (id)initWithMomentShareStatus:(id)arg1 presentationStyle:(long long)arg2;	// IMP=0x0000000000849d0d
- (id)init;	// IMP=0x0000000000849c93
