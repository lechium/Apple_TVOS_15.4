...
- (void).cxx_destruct;	// IMP=0x00000000000bf676
...
- (id)artworkURLForTargetPixelSize:(struct CGSize)arg1;	// IMP=0x00000000000bf230
@property(readonly, nonatomic) id <PXDisplayAsset> artworkDisplayAsset;
- (void)configureCuesWithVideoEventTimestampsInSeconds:(id)arg1 videoEventScores:(id)arg2;	// IMP=0x00000000000bf05c
@property(readonly, copy, nonatomic) NSString *assetTagsDescription;
@property(readonly, nonatomic) long long pace;
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bed62
@property(readonly, copy, nonatomic) NSString *subtitle;
@property(readonly, copy, nonatomic) NSString *identifier;
@property(readonly, nonatomic) Class audioSessionClass;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bec62
- (_Bool)isAudioEqualToAsset:(id)arg1;	// IMP=0x00000000000beb9d
- (id)init;	// IMP=0x00000000000beb23
- (id)initWithMediaItem:(id)arg1;	// IMP=0x00000000000bea8f
- (id)initWithConfiguration:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bea30
