...
- (void).cxx_destruct;	// IMP=0x000000000023fddc
...
- (void)didUpdateCardPosition:(unsigned long long)arg1;	// IMP=0x000000000023fd2e
- (void)didUpdateCardHeight:(double)arg1;	// IMP=0x000000000023fc6b
- (void)_configureForPhotosDetailsViewController:(id)arg1 composition:(id)arg2;	// IMP=0x000000000023f866
...
- (id)initWithPhotosDetailsUIViewController:(id)arg1 widgetComposition:(id)arg2;	// IMP=0x000000000023f4b0
