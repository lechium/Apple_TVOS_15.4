...
+ (id)standardUserDefaults;	// IMP=0x00000000007b86f0
- (void).cxx_destruct;	// IMP=0x00000000007b85af
...
- (long long)generateNextStoryTitleStyleIndex;	// IMP=0x00000000007b82f9
- (void)setallPhotosAspectFitInCompact:(id)arg1;	// IMP=0x00000000007b7767
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000007b6ea2
