...
- (void).cxx_destruct;	// IMP=0x0000000000630f7e
...
- (id)_computedPortraitEffectSettingsForCompositionController:(id)arg1;	// IMP=0x0000000000630f40
- (id)applyAdjustmentsToCompositionController:(id)arg1 renderer:(id)arg2;	// IMP=0x0000000000630f33
...
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x0000000000630dc0
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x0000000000630d50
...
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x0000000000630a53
@property(readonly, nonatomic, getter=isFavorite) _Bool favorite;
- (_Bool)isEqualToSuggestionDisplayAsset:(id)arg1;	// IMP=0x000000000063098c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000063092f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000630924
...
- (id)inverseSuggestionAsset;	// IMP=0x0000000000630568
- (id)initWithSuggestion:(id)arg1 keyAsset:(id)arg2 shouldRevert:(_Bool)arg3;	// IMP=0x00000000006303e9
- (id)initWithSuggestion:(id)arg1 keyAsset:(id)arg2;	// IMP=0x00000000006303d4
