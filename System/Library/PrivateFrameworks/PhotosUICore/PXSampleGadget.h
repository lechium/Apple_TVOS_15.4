...
- (void).cxx_destruct;	// IMP=0x0000000000129a40
...
- (void)userDidSelectAccessoryButton:(id)arg1;	// IMP=0x000000000012975f
- (void)_prepareView:(id)arg1;	// IMP=0x0000000000129709
- (void)prepareCollectionViewItem:(id)arg1;	// IMP=0x000000000012953c
@property(readonly, nonatomic) Class collectionViewItemClass;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001294c3
@property(readonly, nonatomic) unsigned long long gadgetCapabilities;
@property(readonly, nonatomic) unsigned long long gadgetType;
@property(readonly, nonatomic) NSString *localizedTitle;
- (struct CGRect)view:(id)arg1 colorFrameForBounds:(struct CGRect)arg2;	// IMP=0x00000000001293b6
- (id)initWithMininumHeight:(double)arg1;	// IMP=0x0000000000129236
- (id)init;	// IMP=0x000000000012921c
