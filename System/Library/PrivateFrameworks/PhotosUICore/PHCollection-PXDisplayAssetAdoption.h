...
@interface PHCollection (PXDisplayAssetAdoption) <PXDisplayCollection, PXSelectionAssetContainer>
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00000000006da3c0
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchContainsAnyAssets;	// IMP=0x00000000006da252
- (_Bool)px_fetchIsEmpty;	// IMP=0x00000000006da24a
- (id)px_fetchContainedAssetCollections;	// IMP=0x00000000006da18d
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x00000000006d9fe5
