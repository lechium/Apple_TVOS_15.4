...
- (double)updatedOutput;	// IMP=0x0000000000065f7f
- (double)initialOutputForInput:(double)arg1;	// IMP=0x0000000000065f76
- (id)initWithInput:(double)arg1;	// IMP=0x0000000000065f2c
