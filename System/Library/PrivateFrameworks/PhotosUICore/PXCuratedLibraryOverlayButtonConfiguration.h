...
+ (id)tintedImageCache;	// IMP=0x0000000000508cda
+ (id)configurationWithButtonType:(long long)arg1 title:(id)arg2 spec:(id)arg3;	// IMP=0x0000000000508c59
+ (id)configurationWithButtonType:(long long)arg1 spec:(id)arg2;	// IMP=0x0000000000508bf9
+ (id)configurationWithIconImageName:(id)arg1 title:(id)arg2 spec:(id)arg3;	// IMP=0x0000000000508b64
+ (id)configurationWithTitle:(id)arg1 spec:(id)arg2;	// IMP=0x0000000000508aed
+ (id)configurationWithIconImageName:(id)arg1 spec:(id)arg2;	// IMP=0x0000000000508a76
- (void).cxx_destruct;	// IMP=0x00000000005042c9
...
- (id)_tintedImage:(id)arg1 name:(id)arg2 withColor:(id)arg3;	// IMP=0x0000000000503cb8
...
- (id)_contentColorWhenHighlighted:(_Bool)arg1;	// IMP=0x0000000000503491
- (void)prepareForRender;	// IMP=0x000000000050329c
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000502b7b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000502b70
- (id)initWithIconImageName:(id)arg1 title:(id)arg2 spec:(id)arg3 buttonType:(long long)arg4;	// IMP=0x0000000000502986
- (id)init;	// IMP=0x000000000050290c
