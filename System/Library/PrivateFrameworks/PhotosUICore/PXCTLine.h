...
- (void).cxx_destruct;	// IMP=0x00000000000d8445
...
- (id)description;	// IMP=0x00000000000d82e9
- (void)_transformBy:(struct CGAffineTransform)arg1;	// IMP=0x00000000000d825f
- (void)scaleVerticallyBy:(double)arg1;	// IMP=0x00000000000d8208
- (void)scaleBy:(double)arg1;	// IMP=0x00000000000d81b9
- (void)translateVerticallyBy:(double)arg1;	// IMP=0x00000000000d8167
- (void)translateHorizontallyBy:(double)arg1;	// IMP=0x00000000000d8118
...
- (const struct CGPath *)createPath;	// IMP=0x00000000000d7bba
- (void)draw;	// IMP=0x00000000000d7a70
- (void)prepare;	// IMP=0x00000000000d7776
- (void)dealloc;	// IMP=0x00000000000d773c
- (id)initWithLine:(struct __CTLine *)arg1 origin:(struct CGPoint)arg2 frame:(id)arg3 referenceAttributedString:(id)arg4 truncated:(_Bool)arg5;	// IMP=0x00000000000d7669
- (id)init;	// IMP=0x00000000000d75ef
