...
- (void).cxx_destruct;	// IMP=0x00000000005db900
...
- (void)requestCountForAssetCollection:(id)arg1 fetchOptions:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000005db5fe
- (id)init;	// IMP=0x00000000005db4dd
