...
+ (id)stringByConvertingToHTML:(id)arg1;	// IMP=0x000000000037bc77
- (void).cxx_destruct;	// IMP=0x000000000037ba0e
...
- (void)_updateCurrentTraits;	// IMP=0x000000000037b73a
- (void)parse;	// IMP=0x000000000037b5de
- (id)initWithHTMLString:(id)arg1 defaultAttributes:(id)arg2;	// IMP=0x000000000037b4ec
- (id)init;	// IMP=0x000000000037b4d1
