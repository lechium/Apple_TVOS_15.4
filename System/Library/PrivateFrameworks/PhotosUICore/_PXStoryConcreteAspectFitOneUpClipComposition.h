...
- (void)getClipFrames:(out struct CGRect *)arg1 forContext:(const CDStruct_0b735c3a *)arg2;	// IMP=0x00000000001c97ac
@property(readonly, nonatomic) long long numberOfClips;
- (id)description;	// IMP=0x00000000001c96fc
- (id)init;	// IMP=0x00000000001c96bd
