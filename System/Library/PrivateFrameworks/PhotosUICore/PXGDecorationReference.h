...
- (void).cxx_destruct;	// IMP=0x0000000000625c98
...
- (id)init;	// IMP=0x0000000000625c0a
- (id)initWithDecoratedSpriteReference:(id)arg1 decorationType:(long long)arg2;	// IMP=0x0000000000625b94
