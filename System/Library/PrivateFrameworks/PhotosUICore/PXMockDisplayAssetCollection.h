...
- (void).cxx_destruct;	// IMP=0x00000000000dc7b6
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x00000000000dc659
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dbf5a
- (id)init;	// IMP=0x00000000000dbf2e
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 type:(long long)arg3 subtype:(long long)arg4;	// IMP=0x00000000000dbf0c
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 type:(long long)arg3 subtype:(long long)arg4 startDate:(id)arg5 endDate:(id)arg6;	// IMP=0x00000000000dbdf1
