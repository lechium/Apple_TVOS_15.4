...
- (void).cxx_destruct;	// IMP=0x00000000008450f2
...
- (int)requestImageForPreviewItem:(id)arg1 targetSize:(struct CGSize)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000844e78
- (void)feedSectionInfosManager:(id)arg1 sectionInfosDidChange:(id)arg2;	// IMP=0x0000000000844e66
- (id)_sectionInfosForDataSource;	// IMP=0x0000000000844d3a
- (id)_dataSourceSnapshot;	// IMP=0x0000000000844ce3
- (void)_updateDataSource;	// IMP=0x0000000000844b4c
...
- (id)providerSource;	// IMP=0x0000000000844b16
- (id)createInitialDataSource;	// IMP=0x0000000000844aa7
- (id)init;	// IMP=0x0000000000844946
