...
+ (id)defaultAnimationOptions;	// IMP=0x0000000000740440
...
- (id)description;	// IMP=0x000000000074030e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000074029a
- (id)init;	// IMP=0x000000000074026b
