...
+ (id)sharedInstance;	// IMP=0x0000000000518162
+ (CDUnknownBlockType)_predicateValidatorUsingInternalPredicate:(_Bool)arg1;	// IMP=0x000000000018a3da
+ (id)settingsControllerModule;	// IMP=0x0000000000189f8c
- (void).cxx_destruct;	// IMP=0x0000000000518120
...
- (void)setDefaultValues;	// IMP=0x0000000000517f90
- (id)parentSettings;	// IMP=0x0000000000517f77
