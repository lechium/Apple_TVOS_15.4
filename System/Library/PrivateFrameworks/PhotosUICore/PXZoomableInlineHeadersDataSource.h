...
- (void).cxx_destruct;	// IMP=0x000000000045eb10
...
- (void)dealloc;	// IMP=0x000000000045ea7a
- (id)initWithAssetsDataSource:(id)arg1 level:(unsigned long long)arg2 metaDataStore:(id)arg3;	// IMP=0x000000000045e88c
