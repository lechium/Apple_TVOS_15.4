...
- (void).cxx_destruct;	// IMP=0x000000000022d683
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000022d10e
- (id)contentViewController;	// IMP=0x000000000022d105
@property(readonly, nonatomic) unsigned long long gadgetCapabilities;
- (void)undoButtonTapped:(id)arg1;	// IMP=0x000000000022d01d
- (void)noButtonTapped:(id)arg1;	// IMP=0x000000000022cec1
- (void)yesButtonTapped:(id)arg1;	// IMP=0x000000000022cd65
- (void)viewDidLoad;	// IMP=0x000000000022c122
- (id)initWithPerson:(id)arg1 possibleName:(id)arg2;	// IMP=0x000000000022c06d
