...
- (void).cxx_destruct;	// IMP=0x000000000050a9e7
...
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x000000000050a741
- (void)_serialQueue_acquireFetchResultFromBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000050a4ca
- (id)initWithQOSClass:(unsigned int)arg1 photoLibrary:(id)arg2 fetchResultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000050a21f
- (id)init;	// IMP=0x000000000050a1a5
