...
- (void).cxx_destruct;	// IMP=0x000000000012ec81
...
- (id)mutableChangeObject;	// IMP=0x000000000012ec00
- (void)_updateDataSource;	// IMP=0x000000000012e706
- (id)_categoryForAsset:(id)arg1;	// IMP=0x000000000012e613
- (void)_prepare;	// IMP=0x000000000012e34a
- (id)init;	// IMP=0x000000000012e294
