...
- (void).cxx_destruct;	// IMP=0x000000000032d896
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032d793
- (id)initWithFeedConfiguration:(id)arg1 extendedTraitCollection:(id)arg2;	// IMP=0x000000000032d6ef
- (id)init;	// IMP=0x000000000032d675
