...
- (void).cxx_destruct;	// IMP=0x00000000001ef087
...
- (id)description;	// IMP=0x00000000001eef5c
- (id)initWithAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5 requestID:(long long)arg6 signpostID:(unsigned long long)arg7;	// IMP=0x00000000001eee58
- (id)init;	// IMP=0x00000000001eedde
