...
- (void).cxx_destruct;	// IMP=0x000000000005fb15
@property(retain, nonatomic, setter=_setDebugInfo:) PXTilingControllerDebugInfo *_debugInfo; // @synthesize _debugInfo=__debugInfo;
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000005fa99
- (void)tilingControllerDidUpdateDebugInfo:(id)arg1;	// IMP=0x000000000005fa4a
- (id)init;	// IMP=0x000000000005f96f
