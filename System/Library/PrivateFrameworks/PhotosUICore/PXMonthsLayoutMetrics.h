...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033285a
- (unsigned long long)hash;	// IMP=0x00000000003327e9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000332728
- (id)init;	// IMP=0x00000000003326bf
