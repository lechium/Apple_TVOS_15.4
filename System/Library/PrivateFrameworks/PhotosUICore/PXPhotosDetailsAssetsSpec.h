...
+ (_Bool)shouldUsePhoneLayoutWithTraitCollection:(id)arg1;	// IMP=0x0000000000549eb6
- (void).cxx_destruct;	// IMP=0x0000000000549ea3
...
- (void)_computeGridWithExtendedTraitCollection:(id)arg1;	// IMP=0x0000000000549a76
- (void)_computeEditorialWithExtendedTraitCollection:(id)arg1;	// IMP=0x0000000000549905
- (void)_computeSpecWithExtendedTraitCollection:(id)arg1;	// IMP=0x00000000005498b0
- (double)defaultCornerRadius;	// IMP=0x00000000005498a7
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2 detailsOptions:(unsigned long long)arg3;	// IMP=0x0000000000549774
- (id)initWithExtendedTraitCollection:(id)arg1 detailsOptions:(unsigned long long)arg2;	// IMP=0x000000000054975d
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000549748
