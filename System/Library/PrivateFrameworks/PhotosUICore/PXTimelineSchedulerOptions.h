...
+ (id)_sortTimelineSizesFromSet:(id)arg1;	// IMP=0x00000000004b3f8f
- (void).cxx_destruct;	// IMP=0x00000000004b3f7f
...
- (void)updateOptionsForTimelineSize:(unsigned long long)arg1 withTimelineSizes:(id)arg2;	// IMP=0x00000000004b3e07
- (id)init;	// IMP=0x00000000004b3d79
