...
+ (id)transientProperties;	// IMP=0x00000000002a53ee
+ (id)sharedInstance;	// IMP=0x00000000002a53be
+ (id)settingsControllerModule;	// IMP=0x000000000031e7f5
...
- (void)setDefaultValues;	// IMP=0x00000000002a51aa
- (id)parentSettings;	// IMP=0x00000000002a5191
