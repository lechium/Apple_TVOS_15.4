...
- (void).cxx_destruct;	// IMP=0x00000000007ab2f1
...
- (id)description;	// IMP=0x00000000007ab0da
- (void)performWithResultHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000007ab008
- (void)cancel;	// IMP=0x00000000007aafa0
- (id)initWithMediaProvider:(id)arg1 asset:(id)arg2 targetSize:(struct CGSize)arg3 options:(id)arg4;	// IMP=0x00000000007aaec9
