...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000399e63
- (unsigned long long)hash;	// IMP=0x0000000000399df2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000399d57
- (id)init;	// IMP=0x0000000000399d03
