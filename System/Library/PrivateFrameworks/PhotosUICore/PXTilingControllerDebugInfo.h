...
- (void).cxx_destruct;	// IMP=0x000000000026bd76
...
- (id)debugQuickLookObject;	// IMP=0x000000000026bb80
- (void)drawInRect:(struct CGRect)arg1 inContext:(struct CGContext *)arg2;	// IMP=0x000000000026af9a
