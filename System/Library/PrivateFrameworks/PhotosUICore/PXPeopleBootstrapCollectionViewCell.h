...
+ (id)cloudErrorBadgeImage;	// IMP=0x00000000008e14ef
- (void).cxx_destruct;	// IMP=0x00000000008e13b3
...
- (void)_updateCellSizing;	// IMP=0x00000000008e0da7
- (_Bool)_isRTL;	// IMP=0x00000000008e0d57
@property(retain, nonatomic) UIImage *image;
- (void)setImage:(id)arg1 contentsRect:(struct CGRect)arg2;	// IMP=0x00000000008e096a
- (void)prepareForReuse;	// IMP=0x00000000008e0802
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000008e07b0
- (void)layoutSubviews;	// IMP=0x00000000008e076f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000008e0226
