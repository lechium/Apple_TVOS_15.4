...
- (void).cxx_destruct;	// IMP=0x0000000000253fe7
...
- (void)_incrementProgressWithStartDate:(id)arg1;	// IMP=0x0000000000253dc3
- (void)main;	// IMP=0x0000000000253dbd
- (void)cancel;	// IMP=0x0000000000253d7f
- (void)_timeout;	// IMP=0x0000000000253c81
- (id)initWithEditSource:(id)arg1 overcaptureEditSource:(id)arg2 variationType:(long long)arg3 analysisResult:(id)arg4 baseCompositionController:(id)arg5 outputImageURL:(id)arg6 outputVideoURL:(id)arg7 targetSize:(struct CGSize)arg8 renderAllResources:(_Bool)arg9;	// IMP=0x0000000000253992
- (id)init;	// IMP=0x0000000000253918
