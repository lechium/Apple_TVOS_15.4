...
- (void).cxx_destruct;	// IMP=0x00000000003681c6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000367e26
- (id)initWithSpec:(id)arg1;	// IMP=0x0000000000367d21
- (id)initWithExtendedTraitCollection:(id)arg1;	// IMP=0x0000000000367c1c
- (id)initWithUserInterfaceIdiom:(long long)arg1 sizeClass:(long long)arg2 orientation:(long long)arg3 referenceSize:(struct CGSize)arg4 safeAreaInsets:(struct UIEdgeInsets)arg5;	// IMP=0x0000000000367a88
- (id)init;	// IMP=0x0000000000367a4a
