...
- (void).cxx_destruct;	// IMP=0x00000000007293c8
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x000000000072906d
- (void)dealloc;	// IMP=0x0000000000729027
- (id)initWithVideoSession:(id)arg1 maxOutputSize:(struct CGSize)arg2 scale:(double)arg3;	// IMP=0x0000000000728e96
- (id)init;	// IMP=0x0000000000728e1c
