...
- (void).cxx_destruct;	// IMP=0x0000000000188f2c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000188b13
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000188aa2
- (id)init;	// IMP=0x0000000000188a55
