...
- (void).cxx_destruct;	// IMP=0x0000000000549738
...
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x00000000005496e4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000054964f
@property(readonly, nonatomic) _Bool isInCloud;
@property(readonly, nonatomic) Class defaultImageProviderClass;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000549572
- (id)init;	// IMP=0x00000000005494f8
- (id)initWithMusicAsset:(id)arg1;	// IMP=0x000000000054948d
