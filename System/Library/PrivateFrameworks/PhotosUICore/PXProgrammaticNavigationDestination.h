...
- (void).cxx_destruct;	// IMP=0x00000000003f1454
...
- (id)description;	// IMP=0x00000000003f1004
- (unsigned long long)hash;	// IMP=0x00000000003f0e9b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003f0e34
- (_Bool)isEqualToNavigationDestination:(id)arg1;	// IMP=0x00000000003f0ab7
...
- (id)initWithImportSourceUUID:(id)arg1 revealMode:(long long)arg2;	// IMP=0x00000000003f02a7
- (id)initWithType:(long long)arg1 revealMode:(long long)arg2 asset:(id)arg3 assetCollection:(id)arg4;	// IMP=0x00000000003f0207
- (id)initWithType:(long long)arg1 revealMode:(long long)arg2 assetUUID:(id)arg3 assetCollectionUUID:(id)arg4;	// IMP=0x00000000003f014c
- (id)initWithType:(long long)arg1 revealMode:(long long)arg2;	// IMP=0x00000000003f0134
- (id)initWithObject:(id)arg1 revealMode:(long long)arg2 sidebarNavigationBackButtonRootDestination:(id)arg3;	// IMP=0x00000000003efd55
- (id)initWithObject:(id)arg1 revealMode:(long long)arg2;	// IMP=0x00000000003efd40
- (id)initWithURL:(id)arg1;	// IMP=0x00000000003ef27e
