...
- (void).cxx_destruct;	// IMP=0x0000000000224b26
...
- (void)finalizeWithEvent:(id)arg1;	// IMP=0x0000000000224acb
- (void)didSuspendAppWithEvent:(id)arg1;	// IMP=0x0000000000224ac1
- (void)didPauseWithEvent:(id)arg1;	// IMP=0x0000000000224ab7
- (id)initWithEvent:(id)arg1;	// IMP=0x0000000000224a4c
