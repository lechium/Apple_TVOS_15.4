...
- (void).cxx_destruct;	// IMP=0x00000000000817c3
...
- (void)invalidateCompositionWithContext:(id)arg1;	// IMP=0x0000000000081575
- (void)invalidateComposition;	// IMP=0x0000000000081561
- (void)updateComposition;	// IMP=0x00000000000814e7
