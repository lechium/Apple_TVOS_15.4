...
+ (void)makeArrayIndexMovesIncremental:(CDStruct_b4d0f0d1 *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000024ba47
- (void).cxx_destruct;	// IMP=0x000000000024b956
...
- (id)description;	// IMP=0x000000000024b7a8
- (void)enumerateMovedIndexesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000024b4d4
@property(readonly, nonatomic) _Bool hasMoves;
- (id)changedIndexes;	// IMP=0x000000000024b440
@property(readonly, copy, nonatomic) NSIndexSet *insertedIndexes;
@property(readonly, copy, nonatomic) NSIndexSet *removedIndexes;
- (id)initWithArrayChangeDetails:(id)arg1 previousDataSection:(id)arg2;	// IMP=0x000000000024b189
