...
- (void).cxx_destruct;	// IMP=0x00000000004d480b
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000004d4734
- (void)_updateChrome;	// IMP=0x00000000004d45de
- (void)_invalidateChrome;	// IMP=0x00000000004d45cc
- (void)_handleFavoritesToggleButton:(id)arg1;	// IMP=0x00000000004d456c
- (id)initWithViewController:(id)arg1 dataSourceManager:(id)arg2;	// IMP=0x00000000004d447a
- (id)init;	// IMP=0x00000000004d4400
