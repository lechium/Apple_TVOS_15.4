...
+ (long long)maximumNumberOfItems;	// IMP=0x000000000033de7b
- (void).cxx_destruct;	// IMP=0x000000000033dcb6
...
- (void)_updateRoundedCornerOverlayView;	// IMP=0x000000000033daa5
- (void)_updateImageViews;	// IMP=0x000000000033d8b8
- (void)setImage:(id)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x000000000033d546
- (void)setImageSize:(struct CGSize)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x000000000033d472
- (struct CGSize)imageSizeForItemAtIndex:(long long)arg1;	// IMP=0x000000000033d399
- (void)layoutSubviews;	// IMP=0x000000000033d097
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000033cdeb
