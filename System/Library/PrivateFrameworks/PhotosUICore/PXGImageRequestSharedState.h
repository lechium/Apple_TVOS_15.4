...
- (void).cxx_destruct;	// IMP=0x0000000000462534
...
- (id)initWithDisplayAssetFetchResult:(id)arg1 observer:(id)arg2 presentationStyles:(unsigned long long)arg3 targetSize:(struct CGSize)arg4 screenScale:(double)arg5 adjustment:(id)arg6 intent:(unsigned long long)arg7;	// IMP=0x00000000004623ec
