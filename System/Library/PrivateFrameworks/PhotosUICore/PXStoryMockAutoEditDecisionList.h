...
{
    _Bool _allowsNUp;	// 8 = 0x8
    NSString *_colorGradeCategory;	// 16 = 0x10
    id <PXAudioAsset> _song;	// 24 = 0x18
    long long _numberOfClips;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x00000000000e66a7
...
- (void)enumerateClipsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000e65fa
- (id)clipAtIndex:(long long)arg1;	// IMP=0x00000000000e6581
- (id)clipForDisplayAsset:(id)arg1;	// IMP=0x00000000000e6579
- (id)initWithSong:(id)arg1;	// IMP=0x00000000000e6447
- (id)init;	// IMP=0x00000000000e6433
