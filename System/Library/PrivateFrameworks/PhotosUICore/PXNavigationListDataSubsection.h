...
- (void).cxx_destruct;	// IMP=0x0000000000862224
...
- (id)description;	// IMP=0x0000000000862197
- (id)listItemAtExternalIndex:(long long)arg1;	// IMP=0x0000000000861f1d
- (id)initWithDataSection:(id)arg1 indexDelta:(long long)arg2 expandedIndex:(long long)arg3 indentationLevel:(long long)arg4 externalStartIndex:(long long)arg5 skipAssetCountFetches:(_Bool)arg6;	// IMP=0x0000000000861e40
