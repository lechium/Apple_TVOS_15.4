...
+ (id)sharedInstance;	// IMP=0x00000000004c025c
+ (id)settingsControllerModule;	// IMP=0x0000000000090f5b
...
- (id)debugDescription;	// IMP=0x00000000004bfad3
- (void)defaultValueDidChangeForKey:(id)arg1;	// IMP=0x00000000004bfa54
- (void)setDefaultValues;	// IMP=0x00000000004bf6d6
- (id)parentSettings;	// IMP=0x00000000004bf6bd
