...
+ (id)sharedInstance;	// IMP=0x00000000006b11d0
+ (id)settingsControllerModule;	// IMP=0x00000000006519b5
...
- (double)paddingForZoomLevel:(long long)arg1;	// IMP=0x00000000006b0f80
- (long long)interactionOptionsForZoomLevel:(long long)arg1 isAllPhotosAspectFit:(_Bool)arg2;	// IMP=0x00000000006b0ea8
- (long long)cardInteractionOptions;	// IMP=0x00000000006b0e62
- (long long)gridInteractionOptions;	// IMP=0x00000000006b0e1c
- (void)setDefaultValues;	// IMP=0x00000000006b0d2c
- (id)parentSettings;	// IMP=0x00000000006b0d13
