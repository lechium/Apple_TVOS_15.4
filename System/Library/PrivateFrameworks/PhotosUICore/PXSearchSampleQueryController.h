...
- (void).cxx_destruct;	// IMP=0x0000000000434755
...
- (void)performSearch:(id)arg1;	// IMP=0x0000000000434533
- (id)initWithResultsHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000004344c8
