...
- (void).cxx_destruct;	// IMP=0x000000000059cc9d
...
- (id)initWithResourcesDataSource:(id)arg1 style:(id)arg2 spec:(id)arg3 options:(unsigned long long)arg4 loadingCoordinator:(id)arg5 errorReporter:(id)arg6;	// IMP=0x000000000059c9a9
- (id)init;	// IMP=0x000000000059c92f
