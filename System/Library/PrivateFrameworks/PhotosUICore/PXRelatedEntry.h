...
- (void).cxx_destruct;	// IMP=0x0000000000456f88
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000456f44
...
- (id)initWithAssetCollection:(id)arg1 keyAssetFetchResult:(id)arg2 referenceObject:(id)arg3;	// IMP=0x0000000000456ca7
- (id)init;	// IMP=0x0000000000456c8e
