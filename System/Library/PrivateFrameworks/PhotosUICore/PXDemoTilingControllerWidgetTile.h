...
- (void).cxx_destruct;	// IMP=0x00000000000baf65
@property(readonly, nonatomic) UIView *_mapView; // @synthesize _mapView=__mapView;
@property(readonly, nonatomic) UIView *view;
- (void)didApplyGeometry:(struct PXTileGeometry)arg1 withUserData:(id)arg2;	// IMP=0x00000000000baf43
- (id)init;	// IMP=0x00000000000bae9c
