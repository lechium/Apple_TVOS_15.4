...
- (void).cxx_destruct;	// IMP=0x000000000014a75e
...
- (void)userDidSelectDisclosureControl;	// IMP=0x000000000014a5fd
@property(readonly, nonatomic) NSString *localizedDisclosureTitle;
@property(readonly, nonatomic) NSString *localizedTitle;
- (void)contentViewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000014a4cd
@property(readonly, nonatomic) NSObject<PXAnonymousView> *contentView;
- (void)loadContentData;	// IMP=0x000000000014a488
- (void)setContentSize:(struct CGSize)arg1;	// IMP=0x000000000014a476
- (double)preferredContentHeightForWidth:(double)arg1;	// IMP=0x000000000014a409
@property(readonly, nonatomic) _Bool hasContentForCurrentInput;
- (void)_updateContentViewColor;	// IMP=0x000000000014a1e6
- (struct CGRect)_contentViewFrameForSize:(struct CGSize)arg1;	// IMP=0x000000000014a0f5
- (void)_handleLongPressGestureRecognizer:(id)arg1;	// IMP=0x000000000014a081
- (void)_handleTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000149ff0
- (void)_loadViews;	// IMP=0x0000000000149d9d
- (id)init;	// IMP=0x0000000000149d4c
