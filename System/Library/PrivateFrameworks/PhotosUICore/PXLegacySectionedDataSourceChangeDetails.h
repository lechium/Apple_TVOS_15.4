...
- (void).cxx_destruct;	// IMP=0x000000000015efe4
...
- (void)enumerateMovedIndexPathsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000015ee38
- (void)_prepareIncrementalDetails;	// IMP=0x000000000015e94f
- (void)prepareIfNeeded;	// IMP=0x000000000015e72e
- (id)description;	// IMP=0x000000000015e4d6
- (id)contentChangedItemsIndexPaths;	// IMP=0x000000000015e4b1
...
- (id)initWithSectionedDataSourceChangeDetails:(id)arg1 shiftedSection:(long long)arg2;	// IMP=0x000000000015e31d
