...
- (void).cxx_destruct;	// IMP=0x00000000002c5c94
...
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x00000000002c5ab5
- (void)invalidateLayout;	// IMP=0x00000000002c5a4e
- (_Bool)getGeometry:(struct PXTileGeometry *)arg1 group:(unsigned long long *)arg2 userData:(id *)arg3 forTileWithIdentifier:(struct PXTileIdentifier)arg4;	// IMP=0x00000000002c59d1
- (void)enumerateTilesInRect:(struct CGRect)arg1 withOptions:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c5957
@property(readonly, nonatomic) struct CGRect scrollBounds;
@property(readonly, nonatomic) struct CGRect contentBounds;
- (void)prepareLayout;	// IMP=0x00000000002c5827
@property(readonly, nonatomic) struct CGRect visibleRect;
- (id)init;	// IMP=0x00000000002c576a
