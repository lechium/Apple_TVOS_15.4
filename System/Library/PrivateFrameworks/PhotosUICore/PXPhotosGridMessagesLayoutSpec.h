...
- (long long)numberOfColumnsForNumberOfItems:(long long)arg1;	// IMP=0x0000000000456438
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000456136
