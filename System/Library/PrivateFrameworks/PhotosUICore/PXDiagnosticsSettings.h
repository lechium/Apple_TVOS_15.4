...
+ (id)sharedInstance;	// IMP=0x00000000000bfd11
+ (id)settingsControllerModule;	// IMP=0x000000000044009d
...
- (void)setDefaultValues;	// IMP=0x00000000000bfae4
- (id)parentSettings;	// IMP=0x00000000000bfacb
