...
- (void).cxx_destruct;	// IMP=0x00000000000d75c9
...
- (_Bool)_truncateLine:(inout const struct __CTLine **)arg1 withOrigin:(inout struct CGPoint *)arg2 referenceAttributedString:(inout id *)arg3 bounds:(struct CGRect)arg4;	// IMP=0x00000000000d72a8
- (void)prepare;	// IMP=0x00000000000d6f67
- (void)dealloc;	// IMP=0x00000000000d6f2d
- (id)initWithFrame:(struct __CTFrame *)arg1 maximumLineCount:(unsigned long long)arg2 allowTruncation:(_Bool)arg3 framesetter:(id)arg4;	// IMP=0x00000000000d6ea0
- (id)init;	// IMP=0x00000000000d6e26
