...
- (void).cxx_destruct;	// IMP=0x000000000071c0b1
...
- (void)setImageHidden:(_Bool)arg1 forItemAtIndex:(unsigned long long)arg2;	// IMP=0x000000000071bfd2
- (id)imageViewForItemAtIndex:(unsigned long long)arg1;	// IMP=0x000000000071bf39
- (void)setImage:(id)arg1 forItemAtIndex:(unsigned long long)arg2;	// IMP=0x000000000071bec1
- (_Bool)shouldShowBadge;	// IMP=0x000000000071be7e
@property(nonatomic) long long numberOfItems;
- (void)layoutSubviews;	// IMP=0x000000000071b771
- (id)initWithplaceholderImageView:(id)arg1;	// IMP=0x000000000071b587
