...
+ (id)_generatePredicateForAssetTypesToInclude:(unsigned long long)arg1;	// IMP=0x00000000002cfbac
- (void).cxx_destruct;	// IMP=0x00000000002cfb79
...
- (id)_newConfigurationWithCollectionList:(id)arg1 collectionsFetchResult:(id)arg2;	// IMP=0x00000000002cf8b3
- (_Bool)isRootFolder;	// IMP=0x00000000002cf8a1
- (void)setIsRootFolder:(_Bool)arg1;	// IMP=0x00000000002cf88f
- (id)newConfigurationWithCollectionsFetchResult:(id)arg1;	// IMP=0x00000000002cf878
- (id)newConfigurationWithCollectionList:(id)arg1;	// IMP=0x00000000002cf864
- (id)customFetchOptionsForCollection:(id)arg1;	// IMP=0x00000000002cf79a
@property(readonly) PHFetchResult *collectionsFetchResult; // @synthesize collectionsFetchResult=_collectionsFetchResult;
- (id)initWithCollectionList:(id)arg1 collectionsFetchResult:(id)arg2;	// IMP=0x00000000002cf512
- (id)initWithCollectionsFetchResult:(id)arg1;	// IMP=0x00000000002cf4fb
- (id)initWithCollectionList:(id)arg1;	// IMP=0x00000000002cf4e7
- (id)init;	// IMP=0x00000000002cf4d1
