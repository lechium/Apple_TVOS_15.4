...
- (void).cxx_destruct;	// IMP=0x00000000003bc957
...
- (long long)bestColumnIndexForPreferredNumberOfColumns:(long long)arg1 allowedColumns:(id)arg2;	// IMP=0x00000000003bc68f
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2 availableThumbnailSizes:(id)arg3 gridStyle:(long long)arg4 userDefaults:(id)arg5;	// IMP=0x00000000003bb502
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000003bb47f
