...
+ (id)contextWithPersonSuggestion:(id)arg1;	// IMP=0x000000000077462a
+ (id)contextWithFace:(id)arg1 type:(unsigned long long)arg2 delayedPersonBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000774418
+ (id)contextWithPerson:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000774330
- (void).cxx_destruct;	// IMP=0x00000000007742b0
...
- (id)init;	// IMP=0x0000000000774046
