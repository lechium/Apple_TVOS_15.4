...
+ (id)supportedTransitions;	// IMP=0x000000000082894f
+ (id)sharedInstance;	// IMP=0x000000000082891f
+ (id)settingsControllerModule;	// IMP=0x00000000005bf2b0
...
- (double)cueAlignmentForTransitionKind:(BOOL)arg1;	// IMP=0x00000000008284d0
- (void)setDefaultValues;	// IMP=0x0000000000828207
- (id)parentSettings;	// IMP=0x00000000008281ee
