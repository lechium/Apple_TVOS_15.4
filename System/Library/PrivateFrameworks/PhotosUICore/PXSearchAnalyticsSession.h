...
+ (id)_cappedSearchCount:(unsigned long long)arg1;	// IMP=0x00000000003b978e
+ (id)_bucketedTimeInterval:(double)arg1;	// IMP=0x00000000003b9710
+ (id)_stringForResultType:(unsigned long long)arg1;	// IMP=0x00000000003b9688
+ (id)_stringForActionType:(unsigned long long)arg1;	// IMP=0x00000000003b9630
+ (id)_stringForSessionBeginType:(unsigned long long)arg1;	// IMP=0x00000000003b9584
+ (void)logNoSearchResultsFoundSiriSearch;	// IMP=0x00000000003b94dd
- (void).cxx_destruct;	// IMP=0x00000000003b94af
...
- (void)_logSuccess;	// IMP=0x00000000003b91b6
- (void)logSearchWordCompletionTapped;	// IMP=0x00000000003b916b
- (void)logSearchNextTokenSuggestionTapped;	// IMP=0x00000000003b9120
- (void)logSearchWordEmbeddingSelected;	// IMP=0x00000000003b90d5
- (void)logSearchWordEmbeddingsPresented;	// IMP=0x00000000003b908a
- (void)logNoSearchResultsFound;	// IMP=0x00000000003b903f
- (void)logEnteredCollectionResult:(unsigned long long)arg1;	// IMP=0x00000000003b8f37
- (void)logOneUpInTopAssets;	// IMP=0x00000000003b8e51
- (void)logAssetAction:(unsigned long long)arg1 inResult:(unsigned long long)arg2;	// IMP=0x00000000003b8d2c
- (void)logActiveSearch:(id)arg1;	// IMP=0x00000000003b8c59
- (void)logSearch:(id)arg1;	// IMP=0x00000000003b8b86
- (void)endAndInvalidateSession;	// IMP=0x00000000003b842f
- (id)initWithBeginType:(unsigned long long)arg1;	// IMP=0x00000000003b83a2
