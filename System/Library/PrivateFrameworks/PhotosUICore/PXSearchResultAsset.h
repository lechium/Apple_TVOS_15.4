...
- (void).cxx_destruct;	// IMP=0x000000000042d133
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000042cf08
@property(readonly) unsigned long long hash;
- (id)initWithAssetUUID:(id)arg1;	// IMP=0x000000000042cd37
- (id)init;	// IMP=0x000000000042ccbd
