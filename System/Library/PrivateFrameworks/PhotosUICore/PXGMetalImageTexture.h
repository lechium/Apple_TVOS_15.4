...
- (void).cxx_destruct;	// IMP=0x0000000000535988
...
- (void)cleanupAfterRender:(long long)arg1;	// IMP=0x00000000005358e0
- (void)prepareForRender:(long long)arg1;	// IMP=0x00000000005358da
...
- (MISSING_TYPE *)orientationTransform;	// IMP=0x0000000000535814
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000005356d9
- (id)init;	// IMP=0x000000000053565f
- (id)initWithTexture:(id)arg1 chromaTexture:(id)arg2 colorProgram:(id)arg3 isOpaque:(_Bool)arg4 shaderFlags:(int)arg5 orientationTransform: /* Error: Ran out of types for this method. */;	// IMP=0x00000000005353ba
- (id)initWithTexture:(id)arg1 colorProgram:(id)arg2 isOpaque:(_Bool)arg3 shaderFlags:(int)arg4 orientationTransform: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000535390
