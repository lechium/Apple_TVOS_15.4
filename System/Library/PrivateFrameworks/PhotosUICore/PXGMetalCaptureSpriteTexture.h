...
- (void).cxx_destruct;	// IMP=0x0000000000871f03
...
- (void)cleanupAfterRender:(long long)arg1;	// IMP=0x0000000000871e12
- (void)prepareForRender:(long long)arg1;	// IMP=0x0000000000871e0c
@property(readonly, nonatomic) PXGColorProgram *colorProgram;
- (void)getTextureInfos:(CDStruct_183601bc *)arg1 forSpriteIndexes:(unsigned int *)arg2 geometries:(const CDStruct_4f725fed *)arg3 spriteStyles:(const CDStruct_76b550e2 *)arg4 spriteInfos:(const CDStruct_9d1ebe49 *)arg5 screenScale:(double)arg6 count:(unsigned int)arg7;	// IMP=0x0000000000871b59
@property(readonly, nonatomic) id <MTLTexture> chromaTexture;
@property(readonly, copy, nonatomic) PXGCaptureSpritePayload *payload;
- (id)initWithPayload:(id)arg1 presentationType:(int)arg2;	// IMP=0x000000000087195c
