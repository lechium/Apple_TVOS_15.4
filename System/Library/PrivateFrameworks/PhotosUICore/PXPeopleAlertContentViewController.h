...
- (void).cxx_destruct;	// IMP=0x0000000000500533
@property(readonly, nonatomic) NSString *message; // @synthesize message=_message;
@property(readonly, nonatomic) PHPerson *person; // @synthesize person=_person;
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000004ffe05
- (id)initWithPerson:(id)arg1 message:(id)arg2;	// IMP=0x00000000004ffc60
