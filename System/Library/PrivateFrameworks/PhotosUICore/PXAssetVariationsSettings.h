...
+ (id)sharedInstance;	// IMP=0x000000000039f4f0
+ (id)settingsControllerModule;	// IMP=0x00000000002ee078
...
- (void)setDefaultValues;	// IMP=0x000000000039f2a7
- (id)parentSettings;	// IMP=0x000000000039f28e
