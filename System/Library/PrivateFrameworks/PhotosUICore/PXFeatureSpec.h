...
- (void).cxx_destruct;	// IMP=0x00000000007be533
...
- (id)_textAttributesForFontName:(id)arg1 fontSize:(double)arg2 lineHeight:(double)arg3 tracking:(double)arg4 stroke:(double)arg5;	// IMP=0x00000000007be111
- (long long)_capitalizationStyleFromTextAttributes:(id)arg1 defaultCapitalizationStyle:(long long)arg2;	// IMP=0x00000000007be065
...
- (id)collectionTileImageOverlayColorHighlighted;	// IMP=0x00000000007bdfd5
- (id)collectionTileImageOverlayColor;	// IMP=0x00000000007bdfb1
...
- (id)fullscreenMiroViewSpecWithBoundingSize:(struct CGSize)arg1;	// IMP=0x00000000007bda68
- (id)fullscreenMiroViewSpec;	// IMP=0x00000000007bda3a
- (struct UIEdgeInsets)_fullscreenContentInsetsForWidth:(double)arg1;	// IMP=0x00000000007bda04
- (id)createViewSpecWithDescriptor:(struct PXViewSpecDescriptor)arg1;	// IMP=0x00000000007bd508
- (void)configureViewSpec:(id)arg1;	// IMP=0x00000000007bd486
- (id)viewSpecWithDescriptor:(struct PXViewSpecDescriptor)arg1;	// IMP=0x00000000007bd37e
- (struct UIEdgeInsets)contentGuideInsetsForScrollAxis:(long long)arg1;	// IMP=0x00000000007bcfcc
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000007bc967
- (id)initWithExtendedTraitCollection:(id)arg1;	// IMP=0x00000000007bc953
- (id)init;	// IMP=0x00000000007bc93f
