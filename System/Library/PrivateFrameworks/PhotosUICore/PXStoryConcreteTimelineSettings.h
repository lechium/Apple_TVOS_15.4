...
+ (id)sharedInstance;	// IMP=0x000000000069f81c
+ (id)settingsControllerModule;	// IMP=0x0000000000208c13
...
- (void)setDefaultValues;	// IMP=0x000000000069f589
- (id)parentSettings;	// IMP=0x000000000069f570
