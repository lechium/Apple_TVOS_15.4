...
- (void).cxx_destruct;	// IMP=0x00000000005db2ed
...
- (id)description;	// IMP=0x00000000005db11e
@property(readonly, copy) NSString *diagnosticScoresDescription;
- (void)prepareForInvisible;	// IMP=0x00000000005daffa
- (void)prepareForVisible;	// IMP=0x00000000005daff4
@property(readonly, nonatomic) _Bool isPlaying;
- (id)initWithDisplayAsset:(id)arg1 mediaProvider:(id)arg2 geometryReference:(id)arg3;	// IMP=0x00000000005dac90
