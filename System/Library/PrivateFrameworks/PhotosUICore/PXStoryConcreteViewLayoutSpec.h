...
- (void).cxx_destruct;	// IMP=0x00000000005a8668
...
- (double)_predictedChromeTextBoxHeightWithAttributes:(id)arg1 numberOfLines:(long long)arg2;	// IMP=0x00000000005a7e14
- (double)_calculatePredictedBrowseChromeTextHeight;	// IMP=0x00000000005a7cb6
- (id)chromeSongAttributedStringWithTitle:(id)arg1 artist:(id)arg2;	// IMP=0x00000000005a7a5f
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000005a7a4a
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2 storyConfigurationOptions:(unsigned long long)arg3;	// IMP=0x00000000005a5bdf
