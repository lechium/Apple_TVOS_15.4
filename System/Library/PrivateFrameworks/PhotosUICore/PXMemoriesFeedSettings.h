...
+ (id)sharedInstance;	// IMP=0x000000000006cdfc
+ (id)_resetRejectedMemories;	// IMP=0x0000000000827cc9
+ (id)settingsControllerModule;	// IMP=0x0000000000827541
...
- (void)setDefaultValues;	// IMP=0x000000000006cb2a
- (long long)_defaultDataSourceType;	// IMP=0x000000000006cad2
- (id)parentSettings;	// IMP=0x000000000006cab9
