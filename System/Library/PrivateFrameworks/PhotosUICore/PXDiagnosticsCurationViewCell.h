...
+ (double)cellHeightWithCellWidth:(double)arg1;	// IMP=0x0000000000891ded
- (void).cxx_destruct;	// IMP=0x0000000000890c33
...
- (void)setComparisonMatch:(_Bool)arg1;	// IMP=0x0000000000890a79
- (void)setClusterParity:(unsigned long long)arg1;	// IMP=0x00000000008909a9
- (void)prepareForReuse;	// IMP=0x000000000088ff67
- (void)layoutSubviews;	// IMP=0x000000000088f98b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000088f4a4
