...
- (double)weightUsingCriterion:(long long)arg1;	// IMP=0x0000000000399bfc
- (id)initWithSize:(struct CGSize)arg1 weight:(double)arg2;	// IMP=0x0000000000399b7d
- (id)init;	// IMP=0x0000000000399b58
