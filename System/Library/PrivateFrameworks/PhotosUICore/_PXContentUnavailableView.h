...
- (void)didApplyGeometry:(struct PXTileGeometry)arg1 withUserData:(id)arg2;	// IMP=0x00000000005287e0
@property(readonly, nonatomic) UIView *view;
- (void)prepareForReuse;	// IMP=0x00000000005287c3
- (void)becomeReusable;	// IMP=0x00000000005287ac
