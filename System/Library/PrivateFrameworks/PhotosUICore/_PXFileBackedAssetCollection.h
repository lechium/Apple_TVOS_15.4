...
@interface _PXFileBackedAssetCollection <PXDisplayAssetCollection>
{
}
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x0000000000556f12
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000556e3d
