...
- (void).cxx_destruct;	// IMP=0x00000000006afaeb
...
- (void)_performSearch:(id)arg1 retry:(_Bool)arg2;	// IMP=0x00000000006af683
- (void)performSearch:(id)arg1;	// IMP=0x00000000006af66f
- (void)_openSearchIndex;	// IMP=0x00000000006af51a
- (id)initWithSearchIndexManager:(id)arg1 requestSceneAncestryInformation:(_Bool)arg2 resultsHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006af3e5
- (id)init;	// IMP=0x00000000006af36b
