...
+ (id)new;	// IMP=0x000000000072ed21
- (void).cxx_destruct;	// IMP=0x000000000072ec61
...
- (id)createSession;	// IMP=0x000000000072e93c
- (id)initWithAssetsDataSourceManager:(id)arg1 mediaProvider:(id)arg2 activityType:(unsigned long long)arg3;	// IMP=0x000000000072e897
- (id)init;	// IMP=0x000000000072e81d
