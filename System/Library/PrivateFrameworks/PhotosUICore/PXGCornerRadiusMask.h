...
+ (id)cornerRadiusMaskForDevice:(id)arg1 maxCornerRadius:(double)arg2 screenScale:(double)arg3;	// IMP=0x000000000017bd8c
+ (id)_loadQueue;	// IMP=0x000000000017bd5c
- (void).cxx_destruct;	// IMP=0x000000000017b9e8
...
- (void)_loadCornerRadiusTexture;	// IMP=0x000000000017b7ef
- (id)init;	// IMP=0x000000000017b775
- (id)initWithDevice:(id)arg1 maxCornerRadius:(double)arg2 screenScale:(double)arg3;	// IMP=0x000000000017b6dc
