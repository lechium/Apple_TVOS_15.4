...
- (void).cxx_destruct;	// IMP=0x00000000003dc67a
...
- (id)requestStylesWithOptions:(unsigned long long)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000003dc3d3
- (id)initWithPersistedRecipe:(id)arg1 songResource:(id)arg2 autoEditDecisionList:(id)arg3;	// IMP=0x00000000003dc2a8
