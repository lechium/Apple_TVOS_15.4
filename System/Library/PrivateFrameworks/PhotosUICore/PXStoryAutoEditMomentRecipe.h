...
- (id)description;	// IMP=0x000000000020da85
- (id)initWithRecipeType:(unsigned long long)arg1 incomingTransition:(CDStruct_618113c1)arg2 innerTransition:(CDStruct_618113c1)arg3 motion:(CDStruct_b8e7e30c)arg4;	// IMP=0x000000000020da0f
- (id)init;	// IMP=0x000000000020d995
