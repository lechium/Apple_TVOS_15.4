...
- (void).cxx_destruct;	// IMP=0x0000000000728dde
...
- (_Bool)reverseTransformTileIdentifier:(struct PXTileIdentifier *)arg1;	// IMP=0x0000000000728b24
- (_Bool)transformTileIdentifier:(struct PXTileIdentifier *)arg1 group:(unsigned long long *)arg2;	// IMP=0x0000000000728871
- (id)initWithFromDataSource:(id)arg1 toDataSource:(id)arg2 changeDetails:(id)arg3;	// IMP=0x00000000007287ba
- (id)init;	// IMP=0x00000000007287ac
