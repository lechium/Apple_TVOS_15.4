...
+ (id)sharedInstance;	// IMP=0x0000000000660811
+ (id)settingsControllerModule;	// IMP=0x0000000000427853
...
- (void)setDefaultValues;	// IMP=0x000000000066064d
- (id)parentSettings;	// IMP=0x0000000000660634
