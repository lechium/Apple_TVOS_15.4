...
+ (id)px_otherAlbumsWithoutDeletedCollectionList;	// IMP=0x00000000006dc534
+ (id)px_otherAlbumsCollectionList;	// IMP=0x00000000006dc504
+ (id)px_otherAlbumsSidebarCollectionList;	// IMP=0x00000000006dc4d4
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includingDebugAlbums:(_Bool)arg2;	// IMP=0x00000000006dbbb9
+ (id)px_mediaTypesCollectionList;	// IMP=0x00000000006dbb89
+ (id)px_sharedAlbumsAndActivityCollectionList;	// IMP=0x00000000006dbb59
+ (id)px_sharedAlbumsCollectionList;	// IMP=0x00000000006dbb29
+ (id)px_rootAlbumCollectionList;	// IMP=0x00000000006dbac2
+ (id)px_rootProjectCollectionList;	// IMP=0x00000000006dba5b
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00000000006dab58
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x00000000006daa2c
...
- (_Bool)px_fetchContainsAnyAssets;	// IMP=0x00000000006da6f3
- (_Bool)px_fetchIsEmpty;	// IMP=0x00000000006da61a
