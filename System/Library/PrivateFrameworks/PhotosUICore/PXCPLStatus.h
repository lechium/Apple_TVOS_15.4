...
+ (id)statusWithStringRepresentation:(id)arg1 currentDate:(id)arg2;	// IMP=0x00000000003e9512
+ (id)statusWithStringRepresentation:(id)arg1;	// IMP=0x00000000003e94fe
- (void).cxx_destruct;	// IMP=0x0000000000452406
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000452066
- (_Bool)_isEqualToCPLStatus:(id)arg1;	// IMP=0x0000000000451cbe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000451aa0
- (id)description;	// IMP=0x0000000000451a8e
- (id)init;	// IMP=0x0000000000451a52
@property(readonly, copy, nonatomic) NSString *stringRepresentation;
- (id)_dictionaryRepresentation;	// IMP=0x00000000003e82a8
- (id)_initWithDictionaryRepresentation:(id)arg1 currentDate:(id)arg2;	// IMP=0x00000000003e782e
