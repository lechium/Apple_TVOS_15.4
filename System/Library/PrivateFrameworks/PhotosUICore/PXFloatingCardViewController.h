...
- (void).cxx_destruct;	// IMP=0x000000000073129d
...
- (void)contentSizeCategoryDidChangeNotification:(id)arg1;	// IMP=0x00000000007310e4
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000007310dc
@property(readonly, nonatomic) struct CGRect grabAreaBounds;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000730e20
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000730d90
- (void)_dismissTapped;	// IMP=0x0000000000730d44
- (void)removeFromParentViewController;	// IMP=0x0000000000730c56
- (id)_systemFontWithTextStyle:(long long)arg1 weight:(double)arg2;	// IMP=0x0000000000730c42
- (id)initWithContentViewController:(id)arg1;	// IMP=0x000000000072ed9b
