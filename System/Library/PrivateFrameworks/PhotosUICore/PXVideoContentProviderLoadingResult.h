...
- (void).cxx_destruct;	// IMP=0x00000000007eb948
...
- (id)description;	// IMP=0x00000000007eb782
- (id)initWithPlayerItem:(id)arg1 url:(id)arg2 timeRange:(CDStruct_e83c9415)arg3 error:(id)arg4 priority:(long long)arg5 description:(id)arg6;	// IMP=0x00000000007eb5da
