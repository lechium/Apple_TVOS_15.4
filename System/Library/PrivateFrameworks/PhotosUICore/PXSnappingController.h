...
- (void)didSnapByAttraction;	// IMP=0x0000000000299f9f
- (void)updateOffset:(inout double *)arg1 withVelocity:(double)arg2 shouldSnap:(out _Bool *)arg3 shouldBreak:(out _Bool *)arg4;	// IMP=0x0000000000299bb6
- (void)_reset;	// IMP=0x0000000000299b5e
- (void)interactionEnded;	// IMP=0x0000000000299b4c
- (void)interactionBegan;	// IMP=0x0000000000299b46
- (void)_setBoolPointer:(inout _Bool *)arg1 toValue:(_Bool)arg2;	// IMP=0x0000000000299b39
- (_Bool)_isOffset:(double)arg1 inThreshold:(double)arg2;	// IMP=0x0000000000299af7
- (id)initWithSnappingTarget:(double)arg1;	// IMP=0x00000000002998c4
- (id)init;	// IMP=0x000000000029984a
