...
- (void).cxx_destruct;	// IMP=0x000000000044d67e
...
- (void)autoScroller:(id)arg1 didAutoscrollWithTimestamp:(double)arg2;	// IMP=0x000000000044d572
- (void)_updateSelectedIndexPaths;	// IMP=0x000000000044d3ce
- (void)_invalidateSelectedIndexPaths;	// IMP=0x000000000044d3c4
- (void)_endSelection;	// IMP=0x000000000044d2e5
- (void)_updateSelectionWithHitIndexPath:(id)arg1 leadingClosestIndexPath:(id)arg2 aboveClosestIndexPath:(id)arg3;	// IMP=0x000000000044d169
- (void)_beginSelectionFromIndexPath:(id)arg1;	// IMP=0x000000000044d028
- (void)_handleSwipeSelectionGesture:(id)arg1;	// IMP=0x000000000044ce22
- (id)_itemIndexPathClosestAboveLocation:(struct CGPoint)arg1;	// IMP=0x000000000044cda2
- (id)_itemIndexPathClosestLeadingLocation:(struct CGPoint)arg1;	// IMP=0x000000000044cd22
- (id)_itemIndexPathAtLocation:(struct CGPoint)arg1;	// IMP=0x000000000044cca2
@property(readonly, nonatomic) _Bool isSelecting;
- (void)dealloc;	// IMP=0x000000000044caef
- (id)init;	// IMP=0x000000000044ca7c
- (id)initWithScrollView:(id)arg1;	// IMP=0x000000000044c960
