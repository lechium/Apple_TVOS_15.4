...
+ (void)resetLastShownInfo;	// IMP=0x00000000005ba50b
+ (id)sharedInstance;	// IMP=0x00000000005ba4db
+ (id)settingsControllerModule;	// IMP=0x000000000024cdc9
...
- (void)setDefaultValues;	// IMP=0x00000000005ba294
- (id)parentSettings;	// IMP=0x00000000005ba27b
