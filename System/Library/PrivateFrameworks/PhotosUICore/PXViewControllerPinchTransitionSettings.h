...
+ (id)sharedInstance;	// IMP=0x000000000090bb5e
+ (id)settingsControllerModule;	// IMP=0x00000000006d985f
...
- (void)setDefaultValues;	// IMP=0x000000000090b969
- (id)parentSettings;	// IMP=0x000000000090b950
