...
- (void).cxx_destruct;	// IMP=0x0000000000727ca8
...
- (void)enumerateClipsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000727c45
- (id)clipAtIndex:(long long)arg1;	// IMP=0x0000000000727c2f
- (id)clipForDisplayAsset:(id)arg1;	// IMP=0x0000000000727c19
...
- (id)debugDescription;	// IMP=0x000000000072774f
- (id)description;	// IMP=0x0000000000727624
- (id)initWithColorGradeCategory:(id)arg1 song:(id)arg2 clipCatalog:(id)arg3 constrainedOverallDurationInfo:(CDStruct_5d4c7ed3)arg4 outroDuration:(CDStruct_1b6d18a9)arg5;	// IMP=0x00000000007274eb
- (id)init;	// IMP=0x0000000000727471
