...
- (void).cxx_destruct;	// IMP=0x000000000063e480
...
- (id)currentBestLayout;	// IMP=0x000000000063e373
- (unsigned long long)currentLayoutsCount;	// IMP=0x000000000063e316
- (double)scoreOfLayout:(id)arg1;	// IMP=0x000000000063e05a
- (void)validateCurrentLayoutAsFallback;	// IMP=0x000000000063e001
- (_Bool)validateCurrentLayout;	// IMP=0x000000000063de35
- (id)initWithPaddingInputs:(id)arg1 tileAspectRatio:(double)arg2 stopIfAnyGoodLayout:(_Bool)arg3;	// IMP=0x000000000063dd32
