...
- (void).cxx_destruct;	// IMP=0x00000000003eef75
...
- (void)_generateRelatedSearchObjects;	// IMP=0x00000000003ee8cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003ee721
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003ee653
...
- (id)initWithSearchText:(id)arg1 searchTokens:(id)arg2;	// IMP=0x00000000003ee48c
