...
- (void).cxx_destruct;	// IMP=0x0000000000787b33
...
- (void)_updateCaptionIfNeeded;	// IMP=0x000000000078768a
- (void)_invalidateCaption;	// IMP=0x000000000078766c
- (void)_updateSubtitleIfNeeded;	// IMP=0x000000000078732f
- (void)_invalidateSubtitle;	// IMP=0x0000000000787311
- (void)_updateTitleIfNeeded;	// IMP=0x00000000007870da
- (void)_invalidateTitle;	// IMP=0x00000000007870bc
- (void)_updateHasContentIfNeeded;	// IMP=0x0000000000786fbd
- (void)_invalidateHasContent;	// IMP=0x0000000000786fa0
- (void)_setNeedsUpdate;	// IMP=0x0000000000786eff
- (_Bool)_needsUpdate;	// IMP=0x0000000000786ed4
- (void)_updateIfNeeded;	// IMP=0x0000000000786dc1
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000786d61
- (void)_handleCaptionButton:(id)arg1;	// IMP=0x0000000000786cdf
- (void)_handleSubtitleButton:(id)arg1;	// IMP=0x0000000000786c5e
- (_Bool)_canComposeTitleWithSubtitle;	// IMP=0x0000000000786c11
- (_Bool)_hasSubtitle;	// IMP=0x0000000000786bc9
- (id)_captionButtonCreateIfNeeded:(_Bool)arg1;	// IMP=0x0000000000786a6c
- (id)_captionLabelCreateIfNeeded:(_Bool)arg1;	// IMP=0x0000000000786a13
- (id)_subtitleButtonCreateIfNeeded:(_Bool)arg1;	// IMP=0x000000000078697d
- (id)_subtitleLabelCreateIfNeeded:(_Bool)arg1;	// IMP=0x00000000007868c4
- (id)_titleLabelCreateIfNeeded:(_Bool)arg1;	// IMP=0x0000000000786826
- (id)_visualEffectViewCreateIfNeeded:(_Bool)arg1;	// IMP=0x000000000078674a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000786708
- (void)layoutSubviews;	// IMP=0x0000000000786521
- (_Bool)_hasAccessibilityLargeText;	// IMP=0x0000000000786497
