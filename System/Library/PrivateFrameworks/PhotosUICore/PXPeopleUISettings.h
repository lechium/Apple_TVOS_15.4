...
+ (id)sharedInstance;	// IMP=0x00000000006e15ea
+ (id)settingsControllerModule;	// IMP=0x00000000005d5244
...
- (void)setDefaultValues;	// IMP=0x00000000006e12f6
- (id)parentSettings;	// IMP=0x00000000006e12dd
