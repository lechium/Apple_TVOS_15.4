...
+ (id)invitationWithAssetCollection:(id)arg1;	// IMP=0x00000000005cd97e
+ (id)_invitationWithAssetCollection:(id)arg1 previewAssetsFetchResult:(id)arg2 participantsFetchResult:(id)arg3;	// IMP=0x00000000005cd86c
+ (id)new;	// IMP=0x00000000005cd7f2
- (void).cxx_destruct;	// IMP=0x00000000005cd6f9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005cd694
- (void)acceptWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000005cd679
- (id)contextForActivityType:(unsigned long long)arg1;	// IMP=0x00000000005cd63a
...
- (id)invitationWithUpdatedParticipantsFetchResult:(id)arg1;	// IMP=0x00000000005cd4e3
- (id)invitationWithUpdatedPreviewAssetsFetchResult:(id)arg1;	// IMP=0x00000000005cd416
@property(readonly, copy) NSString *description;
- (id)initWithAssetCollection:(id)arg1;	// IMP=0x00000000005cd2d4
- (id)init;	// IMP=0x00000000005cd25a
