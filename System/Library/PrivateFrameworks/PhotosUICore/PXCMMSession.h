...
+ (id)new;	// IMP=0x00000000001c9116
- (void).cxx_destruct;	// IMP=0x00000000001c8e02
...
- (id)momentShareStatusPresentationWithPresentationStyle:(long long)arg1;	// IMP=0x00000000001c8c4e
- (id)initWithContext:(id)arg1;	// IMP=0x00000000001c89cd
- (id)init;	// IMP=0x00000000001c8953
