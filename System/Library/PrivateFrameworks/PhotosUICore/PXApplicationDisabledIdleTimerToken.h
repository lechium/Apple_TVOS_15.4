...
- (void).cxx_destruct;	// IMP=0x0000000000314ca9
@property(readonly, nonatomic) unsigned int powerAssertionID; // @synthesize powerAssertionID=_powerAssertionID;
@property(readonly, nonatomic) NSString *reason; // @synthesize reason=_reason;
- (id)description;	// IMP=0x0000000000314c0b
- (id)initWithReason:(id)arg1 powerAssertionID:(unsigned int)arg2;	// IMP=0x0000000000314b8d
- (id)init;	// IMP=0x0000000000314b13
