...
{
    _Bool __didEmbedContentView;	// 8 = 0x8
    id <PXWidget> _widget;	// 16 = 0x10
    UIView *__containerView;	// 24 = 0x18
    _PXWidgetCompositionUIViewElementTileTransitionContext *__currentTransitionContext;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x0000000000459a43
...
- (void)animateAlongsideTransition:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004597cb
@property(readonly, nonatomic) PXBasicTileAnimationOptions *animationOptions;
@property(readonly, nonatomic) UIView *view;
- (void)didApplyGeometry:(struct PXTileGeometry)arg1 withUserData:(id)arg2;	// IMP=0x000000000045965b
- (void)_didCompleteTileAnimationWithContext:(id)arg1;	// IMP=0x00000000004595e0
- (void)_didAnimateTileWithContext:(id)arg1;	// IMP=0x00000000004595cc
- (id)_willAnimateTileToGeometry:(struct PXTileGeometry)arg1 withOptions:(id)arg2;	// IMP=0x0000000000459448
- (void)_embedContentView;	// IMP=0x0000000000459319
- (id)initWithWidget:(id)arg1;	// IMP=0x0000000000459294
