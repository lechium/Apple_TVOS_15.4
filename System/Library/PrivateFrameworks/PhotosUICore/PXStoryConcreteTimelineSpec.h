...
- (unsigned long long)hash;	// IMP=0x00000000006312b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000631126
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000630fbc
