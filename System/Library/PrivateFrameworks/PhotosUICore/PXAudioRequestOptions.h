...
- (void).cxx_destruct;	// IMP=0x00000000001bfcea
...
- (unsigned long long)hash;	// IMP=0x00000000001bfaf2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bf88f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bf76f
- (id)init;	// IMP=0x00000000001bf721
