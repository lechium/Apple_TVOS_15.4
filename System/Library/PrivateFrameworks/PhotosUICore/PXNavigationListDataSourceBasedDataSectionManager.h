...
- (void).cxx_destruct;	// IMP=0x0000000000124851
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000001247b1
- (id)dataSectionFromDataSource:(id)arg1;	// IMP=0x0000000000124701
- (id)createDataSection;	// IMP=0x00000000001245eb
- (void)_handleDataSourceChange;	// IMP=0x00000000001244e5
- (void)_updateVisibilityViaDataSectionIfNecessary;	// IMP=0x0000000000124400
...
- (_Bool)allowsEmptyDataSection;	// IMP=0x0000000000124279
- (id)initWithChildDataSectionManagers:(id)arg1;	// IMP=0x00000000001241f6
- (id)initWithDataSourceManager:(id)arg1;	// IMP=0x0000000000124181
