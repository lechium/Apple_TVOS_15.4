...
- (void).cxx_destruct;	// IMP=0x00000000008bc8f1
...
- (double)_feedInteritemSpacingForReferenceSize:(struct CGSize)arg1;	// IMP=0x00000000008bc59e
- (void)_calculateSectionInsetWithExtendedTraitCollection:(id)arg1;	// IMP=0x00000000008bc1e3
@property(readonly, nonatomic) struct UIEdgeInsets layoutInsets;
- (id)feedCategoryLabelTextColor;	// IMP=0x00000000008bc0a9
...
- (id)newLayoutGeneratorWithMetrics:(id)arg1;	// IMP=0x00000000008bb953
...
- (id)createViewSpecWithDescriptor:(struct PXViewSpecDescriptor)arg1;	// IMP=0x00000000008bb40f
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2 style:(unsigned long long)arg3;	// IMP=0x00000000008badc7
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000008badb2
