...
- (void).cxx_destruct;	// IMP=0x0000000000385f44
...
- (void)updateWithSectionedChangeDetails:(id)arg1;	// IMP=0x0000000000385700
- (void)addSubitemEntry:(id)arg1;	// IMP=0x00000000003856a6
- (id)initWithIndex:(long long)arg1 changeDetails:(id)arg2;	// IMP=0x0000000000385628
