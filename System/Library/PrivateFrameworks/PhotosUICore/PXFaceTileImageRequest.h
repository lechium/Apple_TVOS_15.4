...
- (void).cxx_destruct;	// IMP=0x00000000001f4bb2
...
- (void)ppt_reportMeasurementsForImageQuality:(long long)arg1;	// IMP=0x00000000001f499a
- (void)cancel;	// IMP=0x00000000001f4928
- (id)initWithFace:(id)arg1 cacheKey:(id)arg2 params:(struct PXFaceTileImageParams)arg3;	// IMP=0x00000000001f4849
