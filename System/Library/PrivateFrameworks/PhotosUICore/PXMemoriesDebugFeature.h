...
+ (id)_tintColorForFeatureType:(unsigned long long)arg1;	// IMP=0x00000000007f8d89
- (void).cxx_destruct;	// IMP=0x00000000007f8d56
...
- (id)initWithLocalizedTitle:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x00000000007f8b43
