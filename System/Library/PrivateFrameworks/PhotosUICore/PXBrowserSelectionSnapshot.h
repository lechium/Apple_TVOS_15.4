...
+ (id)selectionWithIndexPaths:(id)arg1 dataSource:(id)arg2;	// IMP=0x00000000008eb8cf
@property(readonly, nonatomic) NSArray *modelObjects;
@property(readonly, nonatomic) long long estimatedModelObjectsCount;
- (long long)indexOfAssetReference:(id)arg1;	// IMP=0x00000000008eb6d1
- (id)displayAssetAtIndex:(long long)arg1;	// IMP=0x00000000008eb62a
- (id)assetReferenceAtIndex:(long long)arg1;	// IMP=0x00000000008eb583
