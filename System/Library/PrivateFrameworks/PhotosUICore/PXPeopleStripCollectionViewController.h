...
+ (id)_formattedPeopleForMember:(id)arg1;	// IMP=0x000000000046d883
- (void).cxx_destruct;	// IMP=0x000000000046d782
...
- (_Bool)collectionView:(id)arg1 canFocusItemAtIndexPath:(id)arg2;	// IMP=0x000000000046d6fb
- (struct CGPoint)collectionView:(id)arg1 targetContentOffsetForProposedContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000046d68d
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x000000000046d4c0
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000000046d47c
- (void)collectionView:(id)arg1 prefetchItemsAtIndexPaths:(id)arg2;	// IMP=0x000000000046d2d6
- (void)contentWidthChanged;	// IMP=0x000000000046d1b2
- (void)viewDidLoad;	// IMP=0x000000000046cfd0
- (id)initWithDataSource:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000046ce87
