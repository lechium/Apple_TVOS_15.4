...
+ (id)new;	// IMP=0x00000000002d7ea6
- (void).cxx_destruct;	// IMP=0x00000000002d7e73
...
- (id)initWithAssetCollection:(id)arg1 participants:(id)arg2;	// IMP=0x00000000002d78c6
- (id)init;	// IMP=0x00000000002d784c
