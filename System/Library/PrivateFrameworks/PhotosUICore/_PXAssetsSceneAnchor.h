...
- (void).cxx_destruct;	// IMP=0x00000000006f3c28
...
- (id)initWithAssetReference:(id)arg1 anchorOrigin:(struct CGPoint)arg2 distance:(double)arg3;	// IMP=0x00000000006f3b6b
