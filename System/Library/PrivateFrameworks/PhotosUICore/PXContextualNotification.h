...
- (void).cxx_destruct;	// IMP=0x00000000002c81ee
...
- (void)handleDiscard;	// IMP=0x00000000002c7f70
- (void)handleTap:(id)arg1;	// IMP=0x00000000002c7ed7
- (_Bool)shouldPassthroughPoint:(struct CGPoint)arg1 inCoordinateSpace:(id)arg2;	// IMP=0x00000000002c7e42
@property(readonly, nonatomic) long long preferredAnimation;
@property(readonly, nonatomic) UIView *preferredContainerView;
- (struct CGRect)containingFrameInContainerView:(id)arg1;	// IMP=0x00000000002c7cca
- (void)_invalidate;	// IMP=0x00000000002c7bfa
- (void)dismiss;	// IMP=0x00000000002c7b89
- (void)invalidateLayout;	// IMP=0x00000000002c7b05
- (void)present;	// IMP=0x00000000002c79c7
- (id)init;	// IMP=0x00000000002c754f
