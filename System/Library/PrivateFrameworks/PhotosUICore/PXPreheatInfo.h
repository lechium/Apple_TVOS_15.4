...
- (void).cxx_destruct;	// IMP=0x0000000000434bf9
...
- (void)markAsFinished;	// IMP=0x0000000000434b4c
- (id)initWithFetchResult:(id)arg1 origin:(long long)arg2;	// IMP=0x0000000000434abc
