...
- (void).cxx_destruct;	// IMP=0x00000000002899c0
...
- (id)initWithMemory:(id)arg1 memoryInfo:(id)arg2;	// IMP=0x00000000002897e7
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000289718
