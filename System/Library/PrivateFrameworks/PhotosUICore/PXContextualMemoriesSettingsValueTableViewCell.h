...
- (void).cxx_destruct;	// IMP=0x000000000085bf74
...
- (void)layoutMarginsDidChange;	// IMP=0x000000000085bd00
@property(readonly, nonatomic) UILabel *valueLabel; // @synthesize valueLabel=_valueLabel;
- (void)_didPressReset:(id)arg1;	// IMP=0x000000000085b9c6
- (void)_setUpConstraints;	// IMP=0x000000000085b0e7
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000085b099
