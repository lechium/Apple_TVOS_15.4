...
- (void).cxx_destruct;	// IMP=0x00000000003d6658
...
- (id)colorAtIndex:(unsigned int)arg1 inLayout:(id)arg2;	// IMP=0x00000000003d65d7
- (void)referenceSizeDidChange;	// IMP=0x00000000003d61b9
@property(readonly, nonatomic) NSString *configurationDescription;
- (void)_updateContent;	// IMP=0x00000000003d5ecb
- (void)update;	// IMP=0x00000000003d5d0f
- (id)init;	// IMP=0x00000000003d5bdd
