...
- (void).cxx_destruct;	// IMP=0x0000000000083eb0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000083d95
- (id)initWithConfiguration:(id)arg1 extendedTraitCollection:(id)arg2;	// IMP=0x0000000000083cfc
- (id)init;	// IMP=0x0000000000083c82
