...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000045c763
- (id)init;	// IMP=0x000000000045c6e9
- (id)initWithAdditionalItemsCount:(CDStruct_15189878)arg1;	// IMP=0x000000000045c6a1
