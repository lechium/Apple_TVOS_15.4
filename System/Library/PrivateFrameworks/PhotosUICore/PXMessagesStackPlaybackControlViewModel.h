...
- (void).cxx_destruct;	// IMP=0x00000000002eee69
...
- (void)setVideoController:(id)arg1;	// IMP=0x00000000002eedd1
- (void)setCurrentItem:(long long)arg1;	// IMP=0x00000000002eeda7
- (void)setSettled:(_Bool)arg1;	// IMP=0x00000000002eed7f
