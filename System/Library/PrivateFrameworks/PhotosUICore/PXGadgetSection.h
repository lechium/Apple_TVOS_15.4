...
- (void).cxx_destruct;	// IMP=0x000000000034a783
...
- (id)description;	// IMP=0x000000000034a6f0
- (id)init;	// IMP=0x000000000034a591
- (id)initWithIdentifier:(id)arg1 gadgets:(id)arg2;	// IMP=0x000000000034a323
