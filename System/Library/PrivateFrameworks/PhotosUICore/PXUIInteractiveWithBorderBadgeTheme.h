...
+ (id)sharedToggledOffBadgeTheme;	// IMP=0x00000000008b30ce
+ (id)sharedToggledOnBadgeTheme;	// IMP=0x00000000008b309e
+ (id)sharedToggledOffOverContentBadgeTheme;	// IMP=0x00000000008b306e
+ (id)sharedToggledOnOverContentBadgeTheme;	// IMP=0x00000000008b303e
- (void).cxx_destruct;	// IMP=0x00000000008b2fb0
...
- (id)init;	// IMP=0x00000000008b2e8e
- (id)initWithIsToggledOn:(_Bool)arg1 isOverContent:(_Bool)arg2;	// IMP=0x00000000008b2bb3
