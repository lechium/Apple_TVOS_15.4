...
- (void).cxx_destruct;	// IMP=0x000000000088347a
...
- (void)_setLines:(id)arg1;	// IMP=0x00000000008832b7
- (void)didPerformChanges;	// IMP=0x0000000000883276
- (id)mutableChangeObject;	// IMP=0x000000000088326d
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x000000000088323e
- (_Bool)_allowTextOverlapForFont:(id)arg1;	// IMP=0x00000000008831a4
- (unsigned long long)_adjustCutoffLocation:(unsigned long long)arg1 forLineStartingAtIndex:(unsigned long long)arg2;	// IMP=0x0000000000882fdc
- (void)_updateLines;	// IMP=0x000000000088219b
- (void)shiftLinesVerticallyToAvoidOverlap:(id)arg1 referenceFont:(id)arg2;	// IMP=0x0000000000881e89
- (id)initWithContext:(struct CGContext *)arg1;	// IMP=0x0000000000881e3a
- (id)init;	// IMP=0x0000000000881e26
