...
+ (id)_validPhoneNumberFromString:(id)arg1;	// IMP=0x000000000022d7a5
+ (id)_validEmailAddressFromComposeRecipient:(id)arg1;	// IMP=0x000000000022d729
- (void).cxx_destruct;	// IMP=0x000000000022de00
...
- (id)initWithRecipient:(id)arg1;	// IMP=0x000000000022dabb
- (id)init;	// IMP=0x000000000022da41
