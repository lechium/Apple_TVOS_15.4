...
- (void).cxx_destruct;	// IMP=0x000000000000aa85
...
- (double)_baselineOffsetFromBottom;	// IMP=0x000000000000a8ab
- (double)_firstLineBaselineOffsetFromBoundsTop;	// IMP=0x000000000000a88e
@property(nonatomic) long long numberOfLines;
@property(retain, nonatomic) UIColor *textColor;
@property(copy, nonatomic) NSString *text;
@property(retain, nonatomic) UIFont *font;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000009e5a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000009d0a
