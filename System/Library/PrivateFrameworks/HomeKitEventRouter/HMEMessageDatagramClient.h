...
- (void).cxx_destruct;	// IMP=0x000000000000c7fa
...
- (_Bool)handleChangeRegistrationsWithTopicFilterAdditions:(id)arg1 removals:(id)arg2;	// IMP=0x000000000000c582
- (void)updateDormantFetchCondition:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c4cb
- (void)updateConnectionMode:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c414
- (void)connectionCapabilityDidChange;	// IMP=0x000000000000c40a
- (void)serverDidChangeWithServerIdentifier:(id)arg1;	// IMP=0x000000000000c1c7
- (void)didReceiveMessageWithEvents:(id)arg1 serverIdentifier:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000bee5
@property __weak id <HMEMessageDatagramClientDelegate> delegate;
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 keepAliveInterval:(double)arg3 dormantFetchTimerInterval:(double)arg4 retryIntervalProvider:(id)arg5 storeReadHandle:(id)arg6 storeWriteHandle:(id)arg7 logCategory:(const char *)arg8;	// IMP=0x000000000000bce8
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 keepAliveInterval:(double)arg3 dormantFetchTimerInterval:(double)arg4 retryIntervalProvider:(id)arg5;	// IMP=0x000000000000bcc4
