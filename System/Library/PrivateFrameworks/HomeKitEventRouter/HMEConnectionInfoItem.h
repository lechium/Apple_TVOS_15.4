...
@interface HMEConnectionInfoItem : NSObject
{
    ...
    NSDate *_expiry;	// 32 = 0x20
    NSDate *_debounceStartTime;	// 40 = 0x28
    id _connection;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x0000000000012431
...
- (id)initWithConnection:(id)arg1 expiry:(id)arg2;	// IMP=0x00000000000122d3
