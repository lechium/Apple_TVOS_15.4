...
- (void).cxx_destruct;	// IMP=0x0000000000045d35
...
- (_Bool)_shouldFallbackToAuthKitForError:(id)arg1;	// IMP=0x0000000000045c01
- (_Bool)_runSignatureOperationReturningError:(id *)arg1;	// IMP=0x0000000000045468
- (_Bool)_runAuthkitOperationWithError:(id)arg1 returningError:(id *)arg2;	// IMP=0x0000000000045174
- (void)_performMetricsWithBiometricMatch:(unsigned long long)arg1 didBiometricsFail:(_Bool)arg2;	// IMP=0x000000000004478c
- (void)_loadURLBag;	// IMP=0x000000000004456c
- (void)_findSelectedButtonForButtons:(id)arg1;	// IMP=0x00000000000442f3
- (void)run;	// IMP=0x000000000004428a
- (id)initWithTouchIDDialog:(id)arg1 fallbackDialog:(id)arg2;	// IMP=0x00000000000441c5
