...
- (void).cxx_destruct;	// IMP=0x000000000005793e
...
- (id)_newUpdateTouchIDSettingsOperation;	// IMP=0x0000000000056f19
- (void)run;	// IMP=0x0000000000056e6b
- (id)initWithAccountIdentifier:(id)arg1;	// IMP=0x0000000000056da6
