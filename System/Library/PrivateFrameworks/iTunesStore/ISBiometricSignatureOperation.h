...
- (void).cxx_destruct;	// IMP=0x000000000002872a
...
- (_Bool)_promptUserToAuthenticateForIdentityMapChangeWithAccountIdentifier:(id)arg1 accountName:(id)arg2;	// IMP=0x0000000000027a96
- (void)run;	// IMP=0x00000000000279f5
- (id)initWithBiometricAuthenticationContext:(id)arg1 touchIDDialog:(id)arg2 fallbackDialog:(id)arg3;	// IMP=0x000000000002790e
