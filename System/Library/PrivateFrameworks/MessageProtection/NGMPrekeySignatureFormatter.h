...
- (void).cxx_destruct;	// IMP=0x000000000000719c
@property(readonly, nonatomic) NSData *prekeyPublic; // @synthesize prekeyPublic=_prekeyPublic;
@property(readonly, nonatomic) double timestamp; // @synthesize timestamp=_timestamp;
- (id)signedData;	// IMP=0x000000000000708f
- (id)initWithPublicPrekey:(id)arg1;	// IMP=0x0000000000006fd4
- (id)initToSignKey:(id)arg1;	// IMP=0x0000000000006f11
