...
- (void)dealloc;	// IMP=0x000000000000e3a2
- (_Bool)verifySignature:(id)arg1 data:(id)arg2;	// IMP=0x000000000000e21c
- (id)initWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000df0b
- (id)dataRepresentation;	// IMP=0x000000000000dcf5
- (id)initWithSecKeyRef:(struct __SecKey *)arg1;	// IMP=0x000000000000dc8f
