...
- (void)dealloc;	// IMP=0x0000000000009c2a
- (id)bufferData;	// IMP=0x0000000000009bc7
- (_Bool)processIncomingCounter:(unsigned int)arg1;	// IMP=0x0000000000009aa5
- (id)initWithData:(id)arg1 upperBufferIndex:(unsigned int)arg2;	// IMP=0x00000000000099f9
- (id)init;	// IMP=0x000000000000999e
