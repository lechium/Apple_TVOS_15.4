...
- (id)description;	// IMP=0x000000000000374f
- (unsigned long long)hash;	// IMP=0x000000000000370b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000367e
- (_Bool)_isEqualToTable:(id)arg1;	// IMP=0x00000000000034fa
- (id)_brailleTableDictionary;	// IMP=0x000000000000310c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002751
- (id)initWithServiceIdentifier:(id)arg1 language:(id)arg2 variant:(id)arg3;	// IMP=0x000000000000266b
- (id)initWithServiceIdentifier:(id)arg1 tableIdentifier:(id)arg2;	// IMP=0x00000000000025b5
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000000024ea
