...
- (void).cxx_destruct;	// IMP=0x0000000000026365
...
- (void)noteFalseMoreAvailableResponse;	// IMP=0x0000000000026103
- (void)noteTimeSpentInNetworking:(double)arg1;	// IMP=0x000000000002606d
- (void)noteNewHBIDataPoint:(int)arg1;	// IMP=0x0000000000025fae
- (void)noteFailedProtocolRequest;	// IMP=0x0000000000025f1f
- (void)noteFailedNetworkRequest;	// IMP=0x0000000000025e58
- (void)noteSuccessfulRequestWithNumDownloadedElements:(int)arg1;	// IMP=0x0000000000025e44
- (void)noteSuccessfulRequestWithNumDownloadedElements:(int)arg1 numUploadedElements:(int)arg2;	// IMP=0x0000000000025c8a
- (id)description;	// IMP=0x0000000000025b47
- (void)mergeStatusReport:(id)arg1;	// IMP=0x0000000000024d6a
- (id)dictionaryRepresentation;	// IMP=0x0000000000024721
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000024335
- (id)init;	// IMP=0x00000000000242b5
