...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000027471
- (void).cxx_destruct;	// IMP=0x0000000000027926
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002769d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000027479
- (id)description;	// IMP=0x0000000000027354
- (id)initFolderChangeWithChangeType:(unsigned long long)arg1 folderId:(id)arg2 parentFolderId:(id)arg3 displayName:(id)arg4 dataclass:(long long)arg5 consumer:(id)arg6;	// IMP=0x0000000000026ed1
