...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000021ce9
- (void).cxx_destruct;	// IMP=0x00000000000232da
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000022489
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021cf1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000021c81
- (_Bool)isEqualToDAContactSearchResultElement:(id)arg1;	// IMP=0x00000000000209e3
- (id)description;	// IMP=0x00000000000208e4
