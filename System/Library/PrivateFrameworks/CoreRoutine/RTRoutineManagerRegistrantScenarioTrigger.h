...
- (void).cxx_destruct;	// IMP=0x000000000001be23
...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x000000000001b9c6
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x000000000001b8fd
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001b738
- (id)init;	// IMP=0x000000000001b6db
