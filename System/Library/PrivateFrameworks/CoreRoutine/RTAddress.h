...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000015dff
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000176e9
- (_Bool)isEqualToAddress:(id)arg1;	// IMP=0x00000000000165fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016546
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001635d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015e07
- (id)description;	// IMP=0x0000000000015d61
- (id)initWithIdentifier:(id)arg1 subPremises:(id)arg2 subThoroughfare:(id)arg3 thoroughfare:(id)arg4 subLocality:(id)arg5 locality:(id)arg6 subAdministrativeArea:(id)arg7 administrativeArea:(id)arg8 administrativeAreaCode:(id)arg9 postalCode:(id)arg10 country:(id)arg11 countryCode:(id)arg12 inlandWater:(id)arg13 ocean:(id)arg14 areasOfInterest:(id)arg15 isIsland:(_Bool)arg16 creationDate:(id)arg17 expirationDate:(id)arg18 iso3166CountryCode:(id)arg19 iso3166SubdivisionCode:(id)arg20;	// IMP=0x0000000000015886
- (id)init;	// IMP=0x0000000000015857
