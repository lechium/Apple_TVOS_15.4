...
+ (id)presentationTypeKeyMap;	// IMP=0x00000000000076c7
- (void).cxx_destruct;	// IMP=0x0000000000007be2
...
- (void)_applyAlertActionsForController:(id)arg1;	// IMP=0x0000000000007a81
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000007911
- (id)init;	// IMP=0x000000000000787d
