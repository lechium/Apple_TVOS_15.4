...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x000000000000c522
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x000000000000c16f
- (void).cxx_destruct;	// IMP=0x000000000000cefc
...
- (id)_init;	// IMP=0x000000000000c140
- (id)init;	// IMP=0x000000000000c132
