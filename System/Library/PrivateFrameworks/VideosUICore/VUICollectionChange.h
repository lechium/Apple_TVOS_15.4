...
- (void).cxx_destruct;	// IMP=0x000000000000e825
...
- (id)description;	// IMP=0x000000000000e50d
- (id)init;	// IMP=0x000000000000e4f4
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x000000000000e434
