...
- (void).cxx_destruct;	// IMP=0x0000000000012bb4
...
- (void)_handleResponse:(id)arg1 responseData:(id)arg2 error:(id)arg3;	// IMP=0x0000000000012abd
- (void)cancel;	// IMP=0x0000000000012a3f
- (void)executionDidBegin;	// IMP=0x0000000000012831
@property(readonly, nonatomic) unsigned long long elapsedTimeInMilliseconds;
- (id)initWithRequest:(id)arg1 session:(id)arg2;	// IMP=0x000000000001268d
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000012679
- (id)init;	// IMP=0x000000000001260a
