...
- (void).cxx_destruct;	// IMP=0x0000000000011cc0
...
- (id)_changesKinds;	// IMP=0x0000000000011ae5
- (id)description;	// IMP=0x00000000000117c8
- (_Bool)containsOnlyChangeKind:(unsigned long long)arg1;	// IMP=0x000000000001170b
