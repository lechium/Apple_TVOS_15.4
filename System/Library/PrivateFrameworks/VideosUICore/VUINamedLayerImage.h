...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0000000000005f78
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0000000000005f04
...
- (id)imageObj;	// IMP=0x000000000000636f
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x0000000000005ec9
- (id)init;	// IMP=0x0000000000005ebb
