...
+ (id)updateWithState:(id)arg1 previousState:(id)arg2 exitEvent:(id)arg3;	// IMP=0x000000000002a4d9
- (void).cxx_destruct;	// IMP=0x000000000002a768
...
- (id)description;	// IMP=0x000000000002a6b5
