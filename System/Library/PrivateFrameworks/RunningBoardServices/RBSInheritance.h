...
+ (_Bool)supportsRBSXPCSecureCoding;	// IMP=0x0000000000006d38
- (void).cxx_destruct;	// IMP=0x0000000000007194
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006f92
@property(readonly) unsigned long long hash;
- (id)initWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000006e14
- (void)encodeWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000006d40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006d2d
- (id)endowment;	// IMP=0x0000000000006d1f
- (id)_initWithNamespace:(id)arg1 environment:(id)arg2 encodedEndowment:(id)arg3 originatingIdentifier:(id)arg4 attributePath:(unsigned long long)arg5;	// IMP=0x0000000000006afb
- (id)init;	// IMP=0x0000000000006a74
