...
+ (id)limitationForRole:(unsigned char)arg1 withPercentage:(unsigned long long)arg2 duration:(double)arg3 violationPolicy:(unsigned long long)arg4;	// IMP=0x000000000000639a
...
- (unsigned long long)hash;	// IMP=0x00000000000069a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006909
- (id)initWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000006823
- (void)encodeWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000006743
- (id)description;	// IMP=0x0000000000006642
