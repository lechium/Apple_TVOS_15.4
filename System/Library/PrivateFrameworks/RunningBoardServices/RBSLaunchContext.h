...
+ (_Bool)supportsRBSXPCSecureCoding;	// IMP=0x0000000000028ead
+ (id)contextWithIdentity:(id)arg1;	// IMP=0x000000000002899b
+ (id)context;	// IMP=0x0000000000028989
- (void).cxx_destruct;	// IMP=0x000000000002a373
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000029b69
- (id)initWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000029419
- (void)encodeWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000028eb5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028b28
