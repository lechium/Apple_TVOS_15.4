...
+ (_Bool)supportsRBSXPCSecureCoding;	// IMP=0x00000000000260f7
+ (void)setActiveStateDescriptor:(id)arg1;	// IMP=0x0000000000024b74
+ (id)statesForPredicate:(id)arg1 withDescriptor:(id)arg2 error:(out id *)arg3;	// IMP=0x00000000000249d9
+ (id)untrackedRunningStateforProcess:(id)arg1;	// IMP=0x0000000000024956
+ (id)stateWithProcess:(id)arg1;	// IMP=0x00000000000248ae
- (void).cxx_destruct;	// IMP=0x00000000000266f1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000026510
- (id)initWithRBSXPCCoder:(id)arg1;	// IMP=0x0000000000026238
- (void)encodeWithRBSXPCCoder:(id)arg1;	// IMP=0x00000000000260ff
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000025c09
@property(readonly) unsigned long long hash;
- (void)encodeWithPreviousState:(id)arg1;	// IMP=0x0000000000024e98
- (_Bool)isDifferentFromState:(id)arg1 significantly:(out _Bool *)arg2;	// IMP=0x0000000000024c1d
...
- (id)init;	// IMP=0x000000000002499e
