...
@interface HBMManagedConfigurationModeDataSource <HBMDataSource>
{
    HBMStoreCollection *_collection;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x000000000000bd1a
@property(readonly, copy, nonatomic) HBMStoreCollection *collection; // @synthesize collection=_collection;
- (_Bool)load:(id *)arg1;	// IMP=0x000000000000bd01
@property(readonly, nonatomic, getter=isReadOnly) _Bool readOnly;
- (id)initWithManagedHomeScreenLayout:(id)arg1 options:(id)arg2;	// IMP=0x000000000000bc30
