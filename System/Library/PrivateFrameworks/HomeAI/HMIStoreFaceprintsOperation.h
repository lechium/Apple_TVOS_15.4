...
+ (id)logCategory;	// IMP=0x0000000000008073
- (void).cxx_destruct;	// IMP=0x00000000000080a9
...
- (void)mainInsideAutoreleasePool;	// IMP=0x0000000000007d57
- (void)main;	// IMP=0x0000000000007d29
- (id)initWithDataSource:(id)arg1 faceprints:(id)arg2;	// IMP=0x0000000000007c7f
