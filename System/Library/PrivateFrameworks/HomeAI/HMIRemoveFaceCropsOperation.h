...
+ (id)logCategory;	// IMP=0x000000000000bd88
...
- (void)mainInsideAutoreleasePool;	// IMP=0x000000000000ba6c
- (void)main;	// IMP=0x000000000000ba3e
- (id)initWithDataSource:(id)arg1 faceCropUUIDs:(id)arg2;	// IMP=0x000000000000b994
