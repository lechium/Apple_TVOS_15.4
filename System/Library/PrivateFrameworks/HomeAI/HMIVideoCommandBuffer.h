...
+ (id)logCategory;	// IMP=0x00000000000bbbda
- (void).cxx_destruct;	// IMP=0x00000000000bc483
...
- (void)handleBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bc2b0
- (void)flush;	// IMP=0x00000000000bc1ee
- (void)flushAsync;	// IMP=0x00000000000bc12c
- (void)handleSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x00000000000bbde2
@property(readonly) _Bool isEmpty;
@property(readonly) _Bool isFull;
@property(readonly) float fillRatio;
- (void)setDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00000000000bbcb0
- (id)initWithMaxCapacity:(unsigned long long)arg1;	// IMP=0x00000000000bbbe4
