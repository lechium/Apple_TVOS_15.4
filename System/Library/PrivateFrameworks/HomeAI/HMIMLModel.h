...
+ (id)logCategory;	// IMP=0x00000000000928df
- (void).cxx_destruct;	// IMP=0x0000000000092963
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000092707
- (_Bool)_ensureModelWithError:(id *)arg1;	// IMP=0x0000000000092372
- (id)predictionFromFeatures:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000922a4
@property(readonly) MLModel *underlyingModel;
- (id)initWithModelURL:(id)arg1;	// IMP=0x000000000009218b
