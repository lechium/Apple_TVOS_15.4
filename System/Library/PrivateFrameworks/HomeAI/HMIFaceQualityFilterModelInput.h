...
- (void).cxx_destruct;	// IMP=0x000000000001bd68
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000001bc6b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput:(id)arg1 inputName:(id)arg2;	// IMP=0x000000000001bb13
