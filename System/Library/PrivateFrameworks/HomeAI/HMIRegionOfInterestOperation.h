...
- (void).cxx_destruct;	// IMP=0x00000000000b42b3
...
- (void)dealloc;	// IMP=0x00000000000b41ca
- (void)main;	// IMP=0x00000000000b3e8c
- (id)initWithFrame:(id)arg1 size:(struct CGSize)arg2;	// IMP=0x00000000000b3dc8
