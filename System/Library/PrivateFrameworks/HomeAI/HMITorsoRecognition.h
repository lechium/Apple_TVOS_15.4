...
+ (id)logCategory;	// IMP=0x000000000005285f
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005260e
- (void).cxx_destruct;	// IMP=0x00000000000528d2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005271e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000052616
- (id)initWithTorsoprint:(id)arg1 classification:(id)arg2 predictedLinkedEntityUUIDs:(id)arg3 sessionEntityAssignment:(long long)arg4 sessionEntityUUID:(id)arg5;	// IMP=0x000000000005250c
