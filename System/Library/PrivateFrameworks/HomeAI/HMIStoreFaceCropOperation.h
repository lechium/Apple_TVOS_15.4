...
+ (id)logCategory;	// IMP=0x000000000000f5f8
- (void).cxx_destruct;	// IMP=0x000000000000f62e
...
- (void)main;	// IMP=0x000000000000f2c3
- (id)initWithDataSource:(id)arg1 faceCrop:(id)arg2;	// IMP=0x000000000000f219
