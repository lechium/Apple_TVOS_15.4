...
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000034968
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x0000000000034273
- (void)trackPersonBlob:(id)arg1;	// IMP=0x0000000000034224
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000033ee9
