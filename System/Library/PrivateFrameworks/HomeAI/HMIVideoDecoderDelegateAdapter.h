...
- (void).cxx_destruct;	// IMP=0x00000000000c0f61
...
- (void)decoder:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000c0e6c
- (void)decoder:(id)arg1 didDecodeSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000c0ddd
