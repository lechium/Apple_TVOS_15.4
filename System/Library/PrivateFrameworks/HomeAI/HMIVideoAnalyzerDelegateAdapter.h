...
- (void).cxx_destruct;	// IMP=0x00000000000d82a3
...
- (void)analyzer:(id)arg1 didProduceAnalysisStateUpdate:(id)arg2;	// IMP=0x00000000000d8139
- (void)analyzer:(id)arg1 didCreateTimelapseFragment:(id)arg2;	// IMP=0x00000000000d8092
- (void)analyzer:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000d7feb
- (void)analyzer:(id)arg1 didAnalyzeFragmentWithResult:(id)arg2;	// IMP=0x00000000000d7f44
- (void)analyzer:(id)arg1 didAnalyzeFrameWithResult:(id)arg2;	// IMP=0x00000000000d7e9d
