...
- (void).cxx_destruct;	// IMP=0x0000000000036262
...
- (id)initWithFrame:(id)arg1 events:(id)arg2 regionOfInterest:(struct CGRect)arg3 motionDetections:(id)arg4;	// IMP=0x0000000000035e9f
