...
- (void).cxx_destruct;	// IMP=0x00000000000756e3
...
- (void)encoder:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000755ee
- (void)encoder:(id)arg1 didEncodeSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x000000000007555f
