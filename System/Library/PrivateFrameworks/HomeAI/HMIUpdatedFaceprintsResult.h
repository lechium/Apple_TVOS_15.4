...
- (void).cxx_destruct;	// IMP=0x0000000000052db7
...
- (id)initWithExistingAtCurrentVersion:(id)arg1 createdAtCurrentVersion:(id)arg2 existingAtOtherVersions:(id)arg3;	// IMP=0x0000000000052925
