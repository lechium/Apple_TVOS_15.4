...
+ (id)logCategory;	// IMP=0x000000000000fa3e
- (void).cxx_destruct;	// IMP=0x000000000000fa74
...
- (void)main;	// IMP=0x000000000000f709
- (id)initWithDataSource:(id)arg1 faceprint:(id)arg2;	// IMP=0x000000000000f65f
