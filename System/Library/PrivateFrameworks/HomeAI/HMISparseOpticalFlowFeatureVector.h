...
- (void).cxx_destruct;	// IMP=0x00000000000c61f9
...
- (double)distance;	// IMP=0x00000000000c60d4
@property(readonly) struct CGPoint midpoint;
@property(readonly) struct CGPoint target;
- (id)initWithOrigin:(struct CGPoint)arg1 motion:(struct CGVector)arg2;	// IMP=0x00000000000c5fd7
