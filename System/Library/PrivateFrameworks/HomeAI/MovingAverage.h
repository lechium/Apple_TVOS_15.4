...
- (void).cxx_destruct;	// IMP=0x000000000002af07
...
- (double)movingAverageForInterval:(double)arg1 defaultValue:(double)arg2;	// IMP=0x000000000002abcf
- (void)addNumber:(id)arg1;	// IMP=0x000000000002a8e7
- (id)initWithWindowSize:(unsigned long long)arg1;	// IMP=0x000000000002a7de
