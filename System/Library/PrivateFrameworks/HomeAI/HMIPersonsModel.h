...
+ (id)logCategory;	// IMP=0x000000000006e322
- (void).cxx_destruct;	// IMP=0x000000000006e380
...
- (id)initWithPersonsModel:(id)arg1 homeUUID:(id)arg2 sourceUUID:(id)arg3 externalLibrary:(_Bool)arg4;	// IMP=0x000000000006e028
