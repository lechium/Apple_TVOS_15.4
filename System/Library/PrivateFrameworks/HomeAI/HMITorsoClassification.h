...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000bf813
- (void).cxx_destruct;	// IMP=0x00000000000bfa0e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bf901
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000bf81b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bf683
- (id)attributeDescriptions;	// IMP=0x00000000000bf4e6
- (id)initWithPersonUUID:(id)arg1 sourceUUID:(id)arg2 confidence:(double)arg3;	// IMP=0x00000000000bf42e
