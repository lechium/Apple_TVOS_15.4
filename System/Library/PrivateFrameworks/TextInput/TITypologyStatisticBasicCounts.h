...
- (void)visitRecordCandidateRejected:(id)arg1;	// IMP=0x0000000000039333
- (void)visitRecordTextAccepted:(id)arg1;	// IMP=0x00000000000392c5
- (void)visitRecordSkipHitTest:(id)arg1;	// IMP=0x0000000000039276
- (void)visitRecordHitTest:(id)arg1;	// IMP=0x0000000000039227
- (void)visitRecordKeyboardInput:(id)arg1;	// IMP=0x00000000000383c2
- (void)visitRecordSync:(id)arg1;	// IMP=0x0000000000038133
- (void)updateTextWithAcceptedCandidate:(id)arg1;	// IMP=0x0000000000037d8a
- (void)handleTouch:(id)arg1;	// IMP=0x0000000000037d42
- (id)aggregateReport;	// IMP=0x0000000000037b96
- (id)structuredReport;	// IMP=0x000000000003785f
- (id)init;	// IMP=0x00000000000377a0
