...
- (void).cxx_destruct;	// IMP=0x0000000000049baf
...
- (_Bool)validate:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000049883
- (id)initWithName:(id)arg1 isInteger:(_Bool)arg2 minValue:(id)arg3 maxValue:(id)arg4 significantDigits:(id)arg5;	// IMP=0x0000000000049774
