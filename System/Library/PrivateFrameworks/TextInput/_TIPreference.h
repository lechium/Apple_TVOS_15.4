...
+ (id)preferenceWithKey:(id)arg1 domain:(id)arg2 defaultValue:(id)arg3 fallbackKey:(id)arg4 isAnalyzed:(_Bool)arg5;	// IMP=0x000000000005244d
+ (id)preferenceWithKey:(id)arg1 domain:(id)arg2 defaultValue:(id)arg3 fallbackKey:(id)arg4;	// IMP=0x000000000005242b
+ (id)preferenceWithKey:(id)arg1 domain:(id)arg2 defaultValue:(id)arg3;	// IMP=0x0000000000052416
- (void).cxx_destruct;	// IMP=0x0000000000052877
...
- (id)buildAtLastAnalysis;	// IMP=0x000000000005275e
- (id)approxDateOfBuildInstall;	// IMP=0x00000000000526f2
