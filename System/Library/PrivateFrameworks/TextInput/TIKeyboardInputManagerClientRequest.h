...
+ (id)untargetedInvocationWithInvocation:(id)arg1 withCompletion:(_Bool)arg2;	// IMP=0x00000000000257e6
- (void).cxx_destruct;	// IMP=0x00000000000257d6
...
- (id)initWithInvocation:(id)arg1;	// IMP=0x00000000000256f4
- (id)init;	// IMP=0x00000000000256e6
