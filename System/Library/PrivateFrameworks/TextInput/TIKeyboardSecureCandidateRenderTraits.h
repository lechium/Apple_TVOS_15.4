...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000064478
- (void).cxx_destruct;	// IMP=0x00000000000643fd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000063c94
- (id)description;	// IMP=0x000000000006391a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006372c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000063392
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000063236
@property(nonatomic) double singleCellWidth;
- (id)init;	// IMP=0x0000000000062ff9
