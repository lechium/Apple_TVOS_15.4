...
+ (int)type;	// IMP=0x000000000002a51b
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002a513
- (void).cxx_destruct;	// IMP=0x000000000002a4d5
...
- (id)candidateByReplacingWithCandidate:(id)arg1 input:(id)arg2;	// IMP=0x000000000002a3e3
- (id)candidateByReplacingWithCandidate:(id)arg1;	// IMP=0x000000000002a3db
- (void)encodeWithCandidateResultSetCoder:(id)arg1;	// IMP=0x000000000002a0fc
- (id)initWithCandidateResultSetCoder:(id)arg1;	// IMP=0x0000000000029eb5
...
- (_Bool)isPunctuation;	// IMP=0x0000000000029da2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000297ad
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000029273
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000028f05
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028e05
