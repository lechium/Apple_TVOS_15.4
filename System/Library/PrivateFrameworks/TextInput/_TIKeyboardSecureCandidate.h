...
- (void).cxx_destruct;	// IMP=0x0000000000064ce8
...
- (unsigned long long)hash;	// IMP=0x0000000000064c27
- (id)description;	// IMP=0x0000000000064a76
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000064615
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000064582
- (id)initWithSecureHeader:(id)arg1 secureContent:(id)arg2 secureFormattedContent:(id)arg3 input:(id)arg4 truncationSentinel:(id)arg5;	// IMP=0x0000000000064480
