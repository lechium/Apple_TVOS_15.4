...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000048525
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000046ed5
- (id)description;	// IMP=0x000000000004651d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000046276
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000045f28
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000457f1
...
- (void)_createTextInputTraitsIfNecessary;	// IMP=0x0000000000045332
