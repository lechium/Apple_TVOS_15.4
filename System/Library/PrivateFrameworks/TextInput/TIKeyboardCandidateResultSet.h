...
- (_Bool)isSubsetOf:(id)arg1;	// IMP=0x000000000002dccc
- (id)setByAppendingSet:(id)arg1;	// IMP=0x000000000002d96e
- (id)initWithCandidates:(id)arg1 initialSelectedIndex:(unsigned long long)arg2 defaultCandidate:(id)arg3 sortMethods:(id)arg4 sortMethodGroups:(id)arg5 indexTitles:(id)arg6 showExtensionCandidates:(id)arg7 disambiguationCandidates:(id)arg8 selectedDisambiguationCandidateIndex:(unsigned long long)arg9 proactiveTriggers:(id)arg10;	// IMP=0x000000000002d7b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d707
- (unsigned long long)positionInCandidateList:(id)arg1;	// IMP=0x000000000002d5a3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002c266
- (id)description;	// IMP=0x000000000002c10c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002c01b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002be63
