...
+ (id)statisticCompositeWithStatistics:(id)arg1;	// IMP=0x000000000003b061
+ (id)statistic;	// IMP=0x000000000003afd3
- (void).cxx_destruct;	// IMP=0x000000000003afa2
...
- (id)aggregateReport;	// IMP=0x000000000003aeae
@property(readonly, nonatomic) float typingSpeed;
- (id)initWithTimeElapsed:(id)arg1 basicCounts:(id)arg2;	// IMP=0x000000000003aceb
