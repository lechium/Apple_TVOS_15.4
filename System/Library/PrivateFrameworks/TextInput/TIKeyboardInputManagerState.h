...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000035c95
- (void).cxx_destruct;	// IMP=0x0000000000035bdd
...
- (_Bool)stringEndsWord:(id)arg1;	// IMP=0x00000000000358a3
- (_Bool)shouldDeleteAutospaceBeforeTerminator:(id)arg1;	// IMP=0x00000000000357ba
- (_Bool)shouldSuppressAutocorrectionWithTerminator:(id)arg1;	// IMP=0x00000000000356d1
- (_Bool)inputStringAcceptsCurrentCandidateIfSelected:(id)arg1;	// IMP=0x00000000000355fe
- (_Bool)acceptInputString:(id)arg1;	// IMP=0x000000000003552e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003534c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000350de
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000034c17
