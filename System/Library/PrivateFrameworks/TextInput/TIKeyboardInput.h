...
- (void).cxx_destruct;	// IMP=0x0000000000032c6e
...
- (id)description;	// IMP=0x000000000003280a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000326e5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000032515
