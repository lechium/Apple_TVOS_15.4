...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000032325
- (void).cxx_destruct;	// IMP=0x00000000000322dc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000032164
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000031f55
