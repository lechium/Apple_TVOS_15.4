...
- (void)setPlayerState:(long long)arg1 aceId:(id)arg2;	// IMP=0x000000000009d890
- (void)setAsrText:(id)arg1;	// IMP=0x000000000009d810
- (void)updateSharedStateData:(id)arg1;	// IMP=0x000000000009d7a0
- (void)updateSharedState:(id)arg1;	// IMP=0x000000000009d330
