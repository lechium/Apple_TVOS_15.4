...
- (_Bool)isFile:(id)arg1 validForSubmission:(id)arg2 reasonableSize:(long long)arg3 to:(id)arg4 internalTypes:(id)arg5 result:(const char **)arg6;	// IMP=0x000000000000fd32
- (_Bool)isConfigEnabled:(id)arg1;	// IMP=0x000000000000fc8b
- (_Bool)usesLegacySubmission:(id)arg1;	// IMP=0x000000000000fc83
- (id)description;	// IMP=0x000000000000fbee
- (id)metadata;	// IMP=0x000000000000f848
- (id)assembleMetadataAt:(double)arg1 withOptions:(unsigned int)arg2;	// IMP=0x000000000000f33a
@property(readonly) _Bool isInternalBridge;
@property(readonly) _Bool isProxy;
- (id)initFromPath:(id)arg1;	// IMP=0x000000000000f22c
- (id)init:(id)arg1 fromMetadata:(id)arg2;	// IMP=0x000000000000edf5
