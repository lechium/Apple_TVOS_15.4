...
+ (Class)neighborType;	// IMP=0x000000000000f404
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000012dc0
- (unsigned long long)hash;	// IMP=0x00000000000125d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001203c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000011b25
- (void)copyTo:(id)arg1;	// IMP=0x00000000000116e6
- (void)writeTo:(id)arg1;	// IMP=0x0000000000011219
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001120c
- (id)dictionaryRepresentation;	// IMP=0x000000000000f53e
- (id)description;	// IMP=0x000000000000f48f
...
- (id)neighborAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000f3e7
- (unsigned long long)neighborsCount;	// IMP=0x000000000000f3ca
- (void)addNeighbor:(id)arg1;	// IMP=0x000000000000f360
- (void)clearNeighbors;	// IMP=0x000000000000f343
@property(nonatomic) _Bool hasRscp;
@property(nonatomic) _Bool hasEcn0;
- (void)setDerivedMccs:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000000f28f
- (int)derivedMccAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000f1c2
- (void)addDerivedMcc:(int)arg1;	// IMP=0x000000000000f1af
- (void)clearDerivedMccs;	// IMP=0x000000000000f19e
...
- (void)dealloc;	// IMP=0x000000000000ed12
