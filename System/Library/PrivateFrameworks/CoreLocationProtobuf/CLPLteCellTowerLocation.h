...
+ (Class)neighborType;	// IMP=0x0000000000039c10
- (void).cxx_destruct;	// IMP=0x000000000003ccad
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003c4dc
- (unsigned long long)hash;	// IMP=0x000000000003bef6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003b96c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003b3d0
- (void)copyTo:(id)arg1;	// IMP=0x000000000003affd
- (void)writeTo:(id)arg1;	// IMP=0x000000000003ab4f
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003ab42
- (id)dictionaryRepresentation;	// IMP=0x0000000000039ff8
- (id)description;	// IMP=0x0000000000039f49
...
- (id)neighborAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000039bf3
- (unsigned long long)neighborsCount;	// IMP=0x0000000000039bd6
- (void)addNeighbor:(id)arg1;	// IMP=0x0000000000039b6c
- (void)clearNeighbors;	// IMP=0x0000000000039b4f
