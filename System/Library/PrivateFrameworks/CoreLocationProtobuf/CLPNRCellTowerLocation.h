...
+ (Class)neighborType;	// IMP=0x000000000003fc02
- (void).cxx_destruct;	// IMP=0x0000000000042dca
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000425e1
- (unsigned long long)hash;	// IMP=0x0000000000042005
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000041a10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004141b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000041002
- (void)writeTo:(id)arg1;	// IMP=0x0000000000040b40
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000040b33
- (id)dictionaryRepresentation;	// IMP=0x000000000003fff0
- (id)description;	// IMP=0x000000000003ff41
...
- (id)neighborAtIndex:(unsigned long long)arg1;	// IMP=0x000000000003fbe5
- (unsigned long long)neighborsCount;	// IMP=0x000000000003fbc8
- (void)addNeighbor:(id)arg1;	// IMP=0x000000000003fb5e
- (void)clearNeighbors;	// IMP=0x000000000003fb41
