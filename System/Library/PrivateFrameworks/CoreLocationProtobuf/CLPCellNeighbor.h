...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000014251
- (unsigned long long)hash;	// IMP=0x00000000000141b6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000014094
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013fcc
- (void)copyTo:(id)arg1;	// IMP=0x0000000000013f27
- (void)writeTo:(id)arg1;	// IMP=0x0000000000013e59
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000013e4c
- (id)dictionaryRepresentation;	// IMP=0x000000000001380a
- (id)description;	// IMP=0x000000000001375b
