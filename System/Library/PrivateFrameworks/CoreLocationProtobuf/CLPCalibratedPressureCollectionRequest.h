...
- (void).cxx_destruct;	// IMP=0x000000000000df85
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000db7d
- (unsigned long long)hash;	// IMP=0x000000000000cbf4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c7bb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c4fe
- (void)copyTo:(id)arg1;	// IMP=0x000000000000c27c
- (void)writeTo:(id)arg1;	// IMP=0x000000000000bfe6
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000bfd9
- (id)dictionaryRepresentation;	// IMP=0x000000000000ae3f
- (id)description;	// IMP=0x000000000000ad90
@property(readonly, nonatomic) _Bool hasCalibration;
- (int)StringAsReliability:(id)arg1;	// IMP=0x000000000000accc
- (id)reliabilityAsString:(int)arg1;	// IMP=0x000000000000ac4e
