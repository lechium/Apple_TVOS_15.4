...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000024631
- (unsigned long long)hash;	// IMP=0x00000000000241b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002401e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000023f14
- (void)copyTo:(id)arg1;	// IMP=0x0000000000023e2d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000023d19
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000023d0c
- (id)dictionaryRepresentation;	// IMP=0x00000000000235de
- (id)description;	// IMP=0x000000000002352f
