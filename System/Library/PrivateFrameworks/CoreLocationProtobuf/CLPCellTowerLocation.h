...
+ (Class)neighborType;	// IMP=0x0000000000018495
- (void).cxx_destruct;	// IMP=0x000000000001acd3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001a71c
- (unsigned long long)hash;	// IMP=0x000000000001a489
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001a106
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019d37
- (void)copyTo:(id)arg1;	// IMP=0x0000000000019aa5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000019751
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000019744
- (id)dictionaryRepresentation;	// IMP=0x00000000000185c8
- (id)description;	// IMP=0x0000000000018519
...
- (id)neighborAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000018478
- (unsigned long long)neighborsCount;	// IMP=0x000000000001845b
- (void)addNeighbor:(id)arg1;	// IMP=0x00000000000183f1
- (void)clearNeighbors;	// IMP=0x00000000000183d4
