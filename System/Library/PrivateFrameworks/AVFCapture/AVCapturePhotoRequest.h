...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x000000000003423e
+ (void)initialize;	// IMP=0x000000000003422d
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000034476
...
- (void)dealloc;	// IMP=0x0000000000034358
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0000000000034289
