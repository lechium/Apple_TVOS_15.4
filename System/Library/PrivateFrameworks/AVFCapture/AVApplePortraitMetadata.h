...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000717a0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000071593
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007125c
- (void)dealloc;	// IMP=0x0000000000071221
- (id)initWithInternal:(id)arg1;	// IMP=0x00000000000711d1
- (id)initWithPortraitMetadataDictionary:(id)arg1;	// IMP=0x0000000000070e0f
