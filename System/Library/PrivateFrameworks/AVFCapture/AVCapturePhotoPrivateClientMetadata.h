...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000012a24
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000129cd
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000012834
- (void)dealloc;	// IMP=0x00000000000127ea
- (id)initWithMetadataDictionary:(id)arg1;	// IMP=0x000000000001270b
