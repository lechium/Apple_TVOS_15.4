...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000072c63
...
- (void)dealloc;	// IMP=0x0000000000072d03
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000072c9a
