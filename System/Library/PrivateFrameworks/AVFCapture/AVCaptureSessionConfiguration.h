...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x0000000000071e50
- (id)uniqueConnections:(id)arg1;	// IMP=0x0000000000071dd8
- (id)uniqueOutputs:(id)arg1;	// IMP=0x0000000000071d60
- (id)uniqueInputs:(id)arg1;	// IMP=0x0000000000071ce8
- (void)dealloc;	// IMP=0x0000000000071c90
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x0000000000071bec
