...
+ (void)initialize;	// IMP=0x00000000000039b9
...
- (void)setPausesRecordingOnInterruption:(_Bool)arg1;	// IMP=0x0000000000003ab3
- (_Bool)pausesRecordingOnInterruption;	// IMP=0x0000000000003a9f
- (void)resumeRecording;	// IMP=0x0000000000003a99
- (void)pauseRecording;	// IMP=0x0000000000003a93
@property(readonly, nonatomic, getter=isRecordingPaused) _Bool recordingPaused;
- (void)stopRecording;	// IMP=0x0000000000003a85
- (void)startRecordingToOutputFileURL:(id)arg1 recordingDelegate:(id)arg2;	// IMP=0x0000000000003a7f
@property(readonly, nonatomic, getter=isRecording) _Bool recording;
@property(readonly, nonatomic) NSURL *outputFileURL;
- (void)dealloc;	// IMP=0x0000000000003a2d
- (id)initSubclass;	// IMP=0x00000000000039ca
