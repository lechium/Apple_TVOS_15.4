...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000002777
+ (id)optionsWithMessage:(id)arg1;	// IMP=0x0000000000002632
+ (id)optionsWithLabel:(id)arg1;	// IMP=0x00000000000025e9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001ec9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001c89
- (unsigned long long)hash;	// IMP=0x0000000000001c45
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000001932
- (id)attributeDescriptions;	// IMP=0x00000000000014ab
- (id)initWithLabel:(id)arg1;	// IMP=0x0000000000001400
