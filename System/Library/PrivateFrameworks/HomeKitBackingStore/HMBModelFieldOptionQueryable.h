...
- (void).cxx_destruct;	// IMP=0x00000000000a25eb
...
- (void)applyTo:(id)arg1;	// IMP=0x00000000000a2394
- (id)initWithEncodingBlock:(CDUnknownBlockType)arg1 decodingBlock:(CDUnknownBlockType)arg2 descriptionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000a22af
