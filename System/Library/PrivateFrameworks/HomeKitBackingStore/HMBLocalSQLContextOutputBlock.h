...
+ (id)logCategory;	// IMP=0x00000000000752f5
- (void).cxx_destruct;	// IMP=0x0000000000075090
...
- (id)logIdentifier;	// IMP=0x0000000000074fcf
- (id)abort;	// IMP=0x0000000000074b3d
- (id)commit:(id)arg1;	// IMP=0x0000000000074631
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x00000000000742e1
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x000000000007405b
