...
+ (id)hmbProperties;	// IMP=0x0000000000004bfc
- (void).cxx_destruct;	// IMP=0x00000000000053d4
...
- (id)initWithModelID:(id)arg1 parentModelID:(id)arg2;	// IMP=0x0000000000004ee2
