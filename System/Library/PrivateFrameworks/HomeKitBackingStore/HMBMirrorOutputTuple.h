...
- (void).cxx_destruct;	// IMP=0x000000000005d982
...
- (id)attributeDescriptions;	// IMP=0x000000000005d5f1
- (id)initWithOutputBlockRow:(unsigned long long)arg1 recordRow:(unsigned long long)arg2 model:(id)arg3 queryTable:(id)arg4 externalID:(id)arg5 externalData:(id)arg6;	// IMP=0x000000000005d4df
