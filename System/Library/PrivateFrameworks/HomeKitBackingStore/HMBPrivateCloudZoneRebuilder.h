...
+ (id)logCategory;	// IMP=0x000000000003c6e2
...
- (id)logIdentifier;	// IMP=0x000000000003526e
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000034f35
- (void)handleZoneChanged;	// IMP=0x0000000000034b6b
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)rebuild;	// IMP=0x00000000000348e5
- (void)handleIdentityLost;	// IMP=0x00000000000346a2
- (id)zoneStartUp;	// IMP=0x0000000000034545
- (id)initWithCloudZone:(id)arg1;	// IMP=0x000000000003445c
