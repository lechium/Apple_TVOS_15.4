...
- (void).cxx_destruct;	// IMP=0x000000000005abf0
...
- (id)performQueryOn:(id)arg1 arguments:(id)arg2;	// IMP=0x000000000005aa59
- (id)description;	// IMP=0x000000000005a98e
- (id)prepareOnTable:(id)arg1;	// IMP=0x000000000005a391
- (id)initWithSQLPredicate:(id)arg1 sqlColumns:(id)arg2 initialSequence:(id)arg3 maximumRowsPerSelect:(unsigned long long)arg4 arguments:(id)arg5;	// IMP=0x000000000005a1ba
