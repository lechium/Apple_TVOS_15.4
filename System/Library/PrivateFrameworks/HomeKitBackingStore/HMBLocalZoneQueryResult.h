...
+ (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 arguments:(id)arg2 zoneBindRowOffset:(int)arg3 zoneRow:(unsigned long long)arg4 error:(id *)arg5;	// IMP=0x000000000005730b
- (void).cxx_destruct;	// IMP=0x00000000000571ff
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x00000000000570f3
- (id)initWithLocalZone:(id)arg1 statement:(id)arg2 initialSequence:(id)arg3 arguments:(id)arg4 maximumRowsPerSelect:(unsigned long long)arg5;	// IMP=0x0000000000056f70
