...
- (void)finalize;	// IMP=0x000000000001f5be
- (void)dealloc;	// IMP=0x000000000001f456
- (unsigned long long)_updateQueryForZoneRow:(unsigned long long)arg1 recordRow:(unsigned long long)arg2 encodedColumns:(id)arg3 error:(id *)arg4;	// IMP=0x000000000001f328
- (id)buildQueriableFieldsForModel:(id)arg1;	// IMP=0x000000000001f1dd
- (unsigned long long)_deleteAllQueriesForZoneRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001f12a
- (unsigned long long)_deleteQueryForRecordRow:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000001f04c
- (id)performQueryOn:(id)arg1 properties:(id)arg2 filter:(CDUnknownBlockType)arg3;	// IMP=0x000000000001eec1
- (id)initWithContext:(id)arg1 queryModel:(Class)arg2 prepareOnly:(_Bool)arg3;	// IMP=0x000000000001d330
