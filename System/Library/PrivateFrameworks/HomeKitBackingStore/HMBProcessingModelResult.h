...
+ (id)alloc;	// IMP=0x000000000001d255
- (void).cxx_destruct;	// IMP=0x000000000001d213
...
- (id)attributeDescriptions;	// IMP=0x000000000001d03d
- (id)initWithModel:(id)arg1 options:(id)arg2 mirrorOutputFuture:(id)arg3;	// IMP=0x000000000001cf3a
