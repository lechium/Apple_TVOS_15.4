...
- (void).cxx_destruct;	// IMP=0x0000000000056f3f
...
- (id)description;	// IMP=0x0000000000056e5e
- (id)initWithName:(id)arg1 offset:(int)arg2 modelField:(id)arg3;	// IMP=0x0000000000056dab
