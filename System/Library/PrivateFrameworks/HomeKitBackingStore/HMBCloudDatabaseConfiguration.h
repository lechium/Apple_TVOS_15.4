...
- (void).cxx_destruct;	// IMP=0x000000000001cdb2
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001cb82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001cb77
- (id)attributeDescriptions;	// IMP=0x000000000001c9a7
- (id)initWithContainerID:(id)arg1;	// IMP=0x000000000001c88b
