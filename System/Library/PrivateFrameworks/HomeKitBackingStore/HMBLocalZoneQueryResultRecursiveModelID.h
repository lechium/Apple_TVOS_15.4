...
- (void).cxx_destruct;	// IMP=0x000000000005852b
...
- (id)nextObject;	// IMP=0x0000000000058245
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005817f
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000057e8f
