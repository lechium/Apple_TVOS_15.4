...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000ae60
- (void).cxx_destruct;	// IMP=0x000000000000c69d
...
- (void)insertAttributedText:(id)arg1 replacementRange:(struct _NSRange)arg2;	// IMP=0x000000000000c359
- (void)insertAttributedText:(id)arg1;	// IMP=0x000000000000c1f7
@property(readonly, nonatomic) NSMutableDictionary *mutableAttributedPlaceholders;
- (void)_createAttributedPlaceholdersIfNecessary;	// IMP=0x000000000000c19d
- (void)insertText:(id)arg1 replacementRange:(struct _NSRange)arg2;	// IMP=0x000000000000c115
@property(readonly, nonatomic) TIKeyboardOutput *keyboardOutput; // @synthesize keyboardOutput=_keyboardOutput;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000bae2
- (id)description;	// IMP=0x000000000000b63d
- (id)init;	// IMP=0x000000000000b5f2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b154
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ae68
