...
- (void).cxx_destruct;	// IMP=0x0000000000007637
...
- (void)enumerateSessionDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000073f8
- (void)removeSessionDelegate:(id)arg1;	// IMP=0x00000000000073e2
- (void)addSessionDelegate:(id)arg1;	// IMP=0x0000000000007378
- (void)_applyLocalTextOperations:(id)arg1 toDocumentState:(id)arg2;	// IMP=0x0000000000006b87
- (void)applyLocalTextOperations:(id)arg1 toDocumentState:(id)arg2;	// IMP=0x0000000000006b75
- (void)flushOperations;	// IMP=0x0000000000006b6f
@property(readonly, nonatomic) RTITextOperations *_textOperations;
- (void)_createTextOperationsIfNecessary;	// IMP=0x0000000000006b05
