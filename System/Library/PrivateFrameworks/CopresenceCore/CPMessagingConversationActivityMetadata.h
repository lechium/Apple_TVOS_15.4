...
- (void).cxx_destruct;	// IMP=0x0000000000010d4b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000010be4
- (unsigned long long)hash;	// IMP=0x0000000000010b34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000109c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000108b8
- (void)copyTo:(id)arg1;	// IMP=0x00000000000107f5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000010739
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001072c
- (id)dictionaryRepresentation;	// IMP=0x0000000000010370
- (id)description;	// IMP=0x00000000000102c1
