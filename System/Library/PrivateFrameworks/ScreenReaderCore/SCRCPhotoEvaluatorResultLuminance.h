...
- (id)humanReadableResult;	// IMP=0x000000000001f234
- (id)initWithDarknessLevel:(double)arg1 brightnessLevel:(double)arg2 averageLevel:(double)arg3;	// IMP=0x000000000001f198
