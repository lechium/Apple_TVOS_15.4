...
+ (id)stringFromNotificationType:(unsigned char)arg1;	// IMP=0x00000000000500da
- (void).cxx_destruct;	// IMP=0x0000000000050070
...
- (id)initWithType:(unsigned char)arg1;	// IMP=0x000000000004fd9f
