...
+ (id)mergeCandidatePairWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000047737
- (void).cxx_destruct;	// IMP=0x0000000000047704
...
- (id)description;	// IMP=0x0000000000047627
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000047443
- (unsigned long long)hash;	// IMP=0x0000000000047439
- (id)initWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000047353
