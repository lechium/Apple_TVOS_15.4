...
- (void).cxx_destruct;	// IMP=0x000000000007a49b
...
- (id)initWithParameterDeltas:(id)arg1 trainingLossesPerEpoch:(id)arg2 trainingAccuraciesPerEpoch:(id)arg3 trainingEpochs:(unsigned long long)arg4 numberOfTrainingSamples:(unsigned long long)arg5;	// IMP=0x000000000007a357
