...
+ (id)_generateEncryptionKeyFromICloudAggServiceKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cea37
+ (_Bool)_generateError:(id *)arg1 errorCode:(long long)arg2 message:(id)arg3 underlyingError:(id)arg4;	// IMP=0x00000000000ce8f5
+ (id)_mediaAnalysisProgressForPhotoLibrary:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cf470
+ (_Bool)_isInternalDevice;	// IMP=0x00000000000cf445
+ (id)_firstAttachmentURLWithSuffixOfName:(id)arg1 attachments:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000cf147
+ (id)_prepareDatasetForTrainingTask:(id)arg1 fingerprintVersion:(id)arg2 datasetPolicy:(id)arg3 labelPolicy:(id)arg4 positivesDatasetName:(id)arg5 positivesSubsetName:(id)arg6 negativesDatasetName:(id)arg7 negativesSubsetName:(id)arg8 totalNumberOfSamples:(id)arg9 oversamplingRate:(id)arg10 photoLibrary:(id)arg11 graphManager:(id)arg12 modelInputName:(id)arg13 labelName:(id)arg14 attachments:(id)arg15 transformersForFeatureExtractors:(id)arg16 augmenters:(id)arg17 filtersByDatasetName:(id)arg18 error:(id *)arg19;	// IMP=0x00000000000ceacc
