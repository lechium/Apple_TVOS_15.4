...
- (void).cxx_destruct;	// IMP=0x000000000002650c
@property(nonatomic) unsigned long long fetchLimit; // @synthesize fetchLimit=_fetchLimit;
- (id)workInfoWithCount:(unsigned long long)arg1 fetchBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000263c8
@property(readonly, nonatomic) unsigned long long queueCount;
- (id)init;	// IMP=0x000000000002635c
