...
- (_Bool)runWithGraphManager:(id)arg1 progressReporter:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000af778
- (_Bool)shouldRunWithGraphManager:(id)arg1;	// IMP=0x00000000000af651
