...
- (void).cxx_destruct;	// IMP=0x00000000000790f4
...
- (_Bool)stopProcessingOnWorker:(id)arg1 withError:(id *)arg2;	// IMP=0x0000000000078f10
- (_Bool)startProcessingOnWorker:(id)arg1 withError:(id *)arg2;	// IMP=0x0000000000078dac
- (float)completionScore;	// IMP=0x0000000000078d58
- (_Bool)finished;	// IMP=0x0000000000078d46
- (id)initWithFaceProcessingWorker:(id)arg1 jobScenario:(unsigned long long)arg2;	// IMP=0x0000000000078c16
