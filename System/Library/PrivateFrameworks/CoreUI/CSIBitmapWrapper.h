...
- (id)compressedData:(_Bool)arg1 usedEncoding:(int *)arg2 andRowChunkSize:(unsigned int *)arg3;	// IMP=0x00000000000164c1
...
- (id)pixelData;	// IMP=0x0000000000016145
- (void)setPixelData:(id)arg1;	// IMP=0x0000000000016117
- (unsigned int)sourceAlphaInfo;	// IMP=0x000000000001610e
- (void)setSourceAlphaInfo:(unsigned int)arg1;	// IMP=0x0000000000016105
- (struct CGContext *)bitmapContext;	// IMP=0x0000000000015dbf
- (unsigned long long)rowbytes;	// IMP=0x0000000000015db5
- (unsigned int)width;	// IMP=0x0000000000015dac
- (unsigned int)height;	// IMP=0x0000000000015da3
- (void)dealloc;	// IMP=0x0000000000015d38
- (id)initWithCGImage:(struct CGImage *)arg1 width:(unsigned int)arg2 height:(unsigned int)arg3 texturePixelFormat:(long long)arg4;	// IMP=0x0000000000015ca8
- (id)initWithPixelWidth:(unsigned int)arg1 pixelHeight:(unsigned int)arg2;	// IMP=0x0000000000015c3f
