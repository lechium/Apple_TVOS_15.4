...
- (id)description;	// IMP=0x00000000000785c9
- (_Bool)shouldRespectOutputBlending;	// IMP=0x00000000000785c1
- (_Bool)shouldIgnoreForegroundColor;	// IMP=0x00000000000785b9
- (void)dealloc;	// IMP=0x000000000007857e
- (id)init;	// IMP=0x000000000007854f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000784a7
