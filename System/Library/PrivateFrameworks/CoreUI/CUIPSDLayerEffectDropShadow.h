...
- (void)dealloc;	// IMP=0x00000000000913db
- (unsigned int)effectType;	// IMP=0x00000000000913d0
- (id)init;	// IMP=0x000000000009137d
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000003e4dc
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003e2f9
