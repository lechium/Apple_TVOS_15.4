...
- (_Bool)isTintable;	// IMP=0x000000000005a71b
- (void)setRepresentsOnDemandContent:(_Bool)arg1;	// IMP=0x000000000005a70b
...
- (id)_renditionForSpecificKey:(id)arg1;	// IMP=0x000000000005a65c
- (void)dealloc;	// IMP=0x000000000005a60b
- (unsigned long long)hash;	// IMP=0x000000000005a5df
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005a584
@property(readonly, nonatomic) _Bool _cacheRenditionProperties;
- (void)unlock;	// IMP=0x000000000005a517
- (void)lock;	// IMP=0x000000000005a509
- (id)initWithName:(id)arg1 usingRenditionKey:(id)arg2 fromTheme:(unsigned long long)arg3;	// IMP=0x000000000005a437
