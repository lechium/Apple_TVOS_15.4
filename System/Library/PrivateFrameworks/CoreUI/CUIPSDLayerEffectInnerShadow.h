...
- (void)dealloc;	// IMP=0x000000000009156e
- (unsigned int)effectType;	// IMP=0x0000000000091563
- (id)init;	// IMP=0x0000000000091510
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000003e7fc
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003e630
