...
- (void)dealloc;	// IMP=0x0000000000091254
- (void)addLayerEffectComponent:(id)arg1;	// IMP=0x00000000000911fa
- (id)colorOverlay;	// IMP=0x00000000000911dd
- (id)dropShadow;	// IMP=0x00000000000911c0
- (id)init;	// IMP=0x0000000000091164
