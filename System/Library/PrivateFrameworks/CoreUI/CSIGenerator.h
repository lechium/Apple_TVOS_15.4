...
+ (int)fileEncoding;	// IMP=0x00000000000104a5
+ (void)setFileEncoding:(int)arg1;	// IMP=0x000000000001046e
+ (void)initialize;	// IMP=0x00000000000102e4
...
- (id)CSIRepresentationWithCompression:(_Bool)arg1;	// IMP=0x0000000000014f86
- (void)addSubmeshReference:(id)arg1;	// IMP=0x0000000000011754
- (void)addMeshReference:(id)arg1;	// IMP=0x000000000001173b
- (void)addMipReference:(id)arg1;	// IMP=0x0000000000011722
- (void)addLayerReference:(id)arg1;	// IMP=0x000000000001170c
- (void)addMetrics:(CDStruct_1ba92a5e)arg1;	// IMP=0x000000000001167a
- (void)addSliceRect:(struct CGRect)arg1;	// IMP=0x0000000000011628
@property long long targetPlatform;
@property long long compressionType;
@property(nonatomic) double compressionQuality;
- (void)addBitmap:(id)arg1;	// IMP=0x00000000000112a9
- (id)rawData;	// IMP=0x00000000000110a6
- (void)dealloc;	// IMP=0x0000000000010f82
- (id)initWithModelSubmesh:(id)arg1;	// IMP=0x0000000000010f26
- (id)initWithModelMesh:(id)arg1;	// IMP=0x0000000000010eb7
- (id)initWithModelAsset:(id)arg1;	// IMP=0x0000000000010e48
- (id)initWithMultisizeImageSetNamed:(id)arg1 sizesByIndex:(id)arg2;	// IMP=0x0000000000010dd3
- (id)initWithTextStyleNamed:(id)arg1 fontName:(id)arg2 fontSize:(double)arg3 maxPointSize:(double)arg4 minPointSize:(double)arg5 scalingStyle:(short)arg6 alignment:(short)arg7;	// IMP=0x0000000000010d08
- (id)initWithColorNamed:(id)arg1 colorSpaceID:(unsigned long long)arg2 components:(id)arg3 linkedToSystemColorWithName:(id)arg4;	// IMP=0x0000000000010c6f
- (id)initWithColorNamed:(id)arg1 colorSpaceID:(unsigned long long)arg2 components:(id)arg3;	// IMP=0x0000000000010beb
- (id)initWithInternalReferenceRect:(struct CGRect)arg1 layout:(short)arg2;	// IMP=0x0000000000010b0a
- (id)initWithTextureImageWithSize:(struct CGSize)arg1 forPixelFormat:(long long)arg2 cubeMap:(_Bool)arg3;	// IMP=0x0000000000010a3e
- (id)initWithTextureForPixelFormat:(long long)arg1;	// IMP=0x00000000000109b0
- (id)initWithLayerStackData:(id)arg1 withCanvasSize:(struct CGSize)arg2;	// IMP=0x00000000000108ea
- (id)initWithExternalReference:(id)arg1 tags:(id)arg2;	// IMP=0x0000000000010838
- (id)initWithRawData:(id)arg1 pixelFormat:(unsigned int)arg2 layout:(short)arg3;	// IMP=0x00000000000106db
- (id)initWithNameList:(id)arg1;	// IMP=0x0000000000010675
- (id)initWithShapeEffectPreset:(id)arg1 forScaleFactor:(unsigned int)arg2;	// IMP=0x00000000000105ce
- (id)initWithCanvasSize:(struct CGSize)arg1 sliceCount:(unsigned int)arg2 layout:(short)arg3;	// IMP=0x00000000000104b1
