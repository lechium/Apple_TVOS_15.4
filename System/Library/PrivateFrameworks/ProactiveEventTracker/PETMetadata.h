...
- (void).cxx_destruct;	// IMP=0x0000000000011f70
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000011bcc
- (unsigned long long)hash;	// IMP=0x0000000000011989
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000115ce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000011341
- (void)copyTo:(id)arg1;	// IMP=0x0000000000011131
- (void)writeTo:(id)arg1;	// IMP=0x0000000000010f0c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000010eff
- (id)dictionaryRepresentation;	// IMP=0x0000000000010a95
- (id)description;	// IMP=0x00000000000109e6
