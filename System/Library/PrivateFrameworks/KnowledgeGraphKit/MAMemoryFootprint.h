...
- (void).cxx_destruct;	// IMP=0x0000000000101fa7
...
- (void)dump;	// IMP=0x0000000000101a52
- (void)update;	// IMP=0x00000000001019ce
- (unsigned long long)version;	// IMP=0x00000000001019c3
...
- (void)_reportValue:(id)arg1;	// IMP=0x00000000001015f2
...
- (void)_reportKey:(id)arg1;	// IMP=0x0000000000101221
- (unsigned long long)_reportDictionary:(id)arg1;	// IMP=0x00000000001011b8
- (unsigned long long)_reportArray:(id)arg1;	// IMP=0x000000000010114f
- (unsigned long long)_reportOrderedSet:(id)arg1;	// IMP=0x0000000000101098
- (void)_reportEdge:(id)arg1 withSize:(unsigned long long)arg2;	// IMP=0x000000000010108a
- (void)_reportNode:(id)arg1 withSize:(unsigned long long)arg2 edgeCount:(unsigned long long)arg3;	// IMP=0x0000000000101061
- (void)_reportGraph:(id)arg1 withSize:(unsigned long long)arg2;	// IMP=0x0000000000101057
...
- (id)initWithGraph:(id)arg1;	// IMP=0x0000000000100b86
