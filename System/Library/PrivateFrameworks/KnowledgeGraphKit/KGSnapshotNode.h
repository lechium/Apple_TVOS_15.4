...
- (void).cxx_destruct;	// IMP=0x00000000000eb634
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000eb5b2
@property(readonly) unsigned long long hash;
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x00000000000eb59e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eb562
@property(readonly, copy) NSString *description;
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 weight:(float)arg3 properties:(id)arg4;	// IMP=0x00000000000eb406
