...
- (void).cxx_destruct;	// IMP=0x000000000010a369
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010a12f
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x000000000010a125
- (id)oppositeNodeFromNode:(id)arg1;	// IMP=0x000000000010a083
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 weight:(float)arg3 properties:(id)arg4 sourceNode:(id)arg5 targetNode:(id)arg6;	// IMP=0x0000000000109f64
