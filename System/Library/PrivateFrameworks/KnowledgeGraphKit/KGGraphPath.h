...
- (id)description;	// IMP=0x0000000000116341
- (id)initWithSourceNodeIdentifier:(unsigned long long)arg1 targetNodeIdentifier:(unsigned long long)arg2 numberOfPaths:(unsigned long long)arg3;	// IMP=0x00000000001162ee
