...
- (void).cxx_destruct;	// IMP=0x000000000012f4e2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012f342
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x000000000012f338
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 weight:(float)arg3 properties:(id)arg4;	// IMP=0x000000000012f269
