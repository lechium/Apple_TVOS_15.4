...
- (void).cxx_destruct;	// IMP=0x000000000014d12e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014d098
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014d044
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x000000000014d03a
- (id)oppositeNodeFromNode:(id)arg1;	// IMP=0x000000000014cf98
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 weight:(float)arg3 properties:(id)arg4 sourceNode:(id)arg5 targetNode:(id)arg6;	// IMP=0x000000000014ce81
