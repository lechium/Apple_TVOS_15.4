...
+ (id)punctuationEntryFromJSONRepresentation:(id)arg1;	// IMP=0x000000000001d711
+ (id)punctuationEntryFromJSONDictionary:(id)arg1;	// IMP=0x000000000001d35b
- (void).cxx_destruct;	// IMP=0x000000000001deb4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001dd42
- (id)description;	// IMP=0x000000000001dbb4
@property(readonly, nonatomic) NSData *jsonRepresentation;
@property(readonly, nonatomic) NSDictionary *jsonDictionary;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001d170
- (id)init;	// IMP=0x000000000001d0d1
