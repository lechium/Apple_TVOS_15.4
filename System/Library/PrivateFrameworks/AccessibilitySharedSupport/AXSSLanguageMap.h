...
- (void).cxx_destruct;	// IMP=0x000000000000e64b
...
- (id)dialectWithLocaleIdentifier:(id)arg1;	// IMP=0x000000000000e35c
- (id)description;	// IMP=0x000000000000ddf2
- (id)initWithLanguageID:(id)arg1 isWestern:(_Bool)arg2 isAmbiguous:(_Bool)arg3 isRTL:(_Bool)arg4 dialects:(id)arg5 alternateLanguageIDs:(id)arg6 associatedAmbiguousLanguages:(id)arg7;	// IMP=0x000000000000db8c
