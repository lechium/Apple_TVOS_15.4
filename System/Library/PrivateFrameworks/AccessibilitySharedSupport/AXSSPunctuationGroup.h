...
+ (id)punctuationGroupFromJSONRepresentation:(id)arg1;	// IMP=0x000000000001a988
- (void).cxx_destruct;	// IMP=0x000000000001b51c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b36f
- (id)description;	// IMP=0x000000000001b231
...
- (id)init;	// IMP=0x000000000001a8d5
