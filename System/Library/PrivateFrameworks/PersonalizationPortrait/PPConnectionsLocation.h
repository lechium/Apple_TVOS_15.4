...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001d65a
+ (unsigned long long)round:(double)arg1 toNearest:(double)arg2;	// IMP=0x000000000001d601
- (void).cxx_destruct;	// IMP=0x000000000001d33a
...
- (_Bool)isEqualToConnectionsLocation:(id)arg1;	// IMP=0x000000000001c9ac
- (unsigned long long)hash;	// IMP=0x000000000001c996
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c92e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001c5bf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001c34b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001bcc7
- (id)description;	// IMP=0x000000000001bc35
- (id)addressDictionary;	// IMP=0x000000000001ba8a
- (unsigned long long)_roundedPredictionAge;	// IMP=0x000000000001b9db
- (unsigned char)_pexItemSource;	// IMP=0x000000000001b92b
- (id)quickTypeItem;	// IMP=0x000000000001b655
- (id)init;	// IMP=0x000000000001b64f
- (void)setIdentifier:(id)arg1;	// IMP=0x000000000001b63e
- (id)initWithOriginatingBundleID:(id)arg1;	// IMP=0x000000000001b582
