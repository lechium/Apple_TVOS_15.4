...
+ (id)descriptionForSuggestedEventCategory:(unsigned char)arg1;	// IMP=0x00000000000181b6
+ (unsigned char)suggestedEventCategoryFromMetadata:(id)arg1;	// IMP=0x0000000000017e2e
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000017e26
- (void).cxx_destruct;	// IMP=0x0000000000017d2d
...
- (_Bool)isNLEvent;	// IMP=0x0000000000017c6b
- (_Bool)isStructuredEvent;	// IMP=0x0000000000017c33
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x0000000000017858
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000177f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000177e5
- (unsigned long long)hash;	// IMP=0x00000000000177cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001762c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000171bb
- (id)description;	// IMP=0x000000000001716b
- (long long)compareStartDateWithEvent:(id)arg1;	// IMP=0x0000000000017151
- (_Bool)organizerIsCurrentUser;	// IMP=0x0000000000017146
- (_Bool)representsUnscheduledFreeTime;	// IMP=0x0000000000017139
- (id)initWithEventIdentifier:(id)arg1 title:(id)arg2 location:(id)arg3 calendar:(id)arg4 startDate:(id)arg5 endDate:(id)arg6 availability:(BOOL)arg7 externalURI:(id)arg8 attendees:(id)arg9 organizerName:(id)arg10 eventFlags:(unsigned char)arg11 notes:(id)arg12 url:(id)arg13 structuredLocationTitle:(id)arg14 structuredLocationAddress:(id)arg15 structuredLocationCoordinates:(id)arg16 suggestedEventCategory:(unsigned char)arg17;	// IMP=0x0000000000016c88
- (id)initWithEKEvent:(id)arg1 calendarInternPool:(id)arg2;	// IMP=0x000000000001676b
- (id)init;	// IMP=0x0000000000016765
