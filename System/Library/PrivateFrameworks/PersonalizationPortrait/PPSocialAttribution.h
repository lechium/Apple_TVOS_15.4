...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000298e9
- (void).cxx_destruct;	// IMP=0x000000000002987f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002925f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000029149
- (id)description;	// IMP=0x0000000000028f90
- (id)initWithIdentifier:(id)arg1 sourceAppDisplayName:(id)arg2 conversationIdentifier:(id)arg3 groupPhotoPath:(id)arg4 groupDisplayName:(id)arg5 relatedPeople:(id)arg6 sender:(id)arg7 timestamp:(id)arg8 starred:(_Bool)arg9 fromMe:(_Bool)arg10;	// IMP=0x0000000000028e22
- (id)initWithIdentifier:(id)arg1 sourceAppDisplayName:(id)arg2 conversationIdentifier:(id)arg3 groupPhotoPath:(id)arg4 groupDisplayName:(id)arg5 relatedPeople:(id)arg6 sender:(id)arg7 timestamp:(id)arg8 starred:(_Bool)arg9;	// IMP=0x0000000000028de6
- (id)initWithIdentifier:(id)arg1 sourceAppDisplayName:(id)arg2 conversationIdentifier:(id)arg3 groupPhotoPath:(id)arg4 groupDisplayName:(id)arg5 relatedPeople:(id)arg6 sender:(id)arg7 timestamp:(id)arg8;	// IMP=0x0000000000028db0
