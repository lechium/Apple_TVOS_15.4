...
+ (id)queryForMapsWithLimit:(unsigned long long)arg1 fromDate:(id)arg2 consumerType:(unsigned long long)arg3;	// IMP=0x0000000000011f6a
+ (id)_algorithmsDescription:(id)arg1;	// IMP=0x0000000000011ceb
+ (id)_matchingCategoriesDescription:(id)arg1;	// IMP=0x0000000000011a6c
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000011a64
- (void).cxx_destruct;	// IMP=0x000000000000face
...
- (id)customizedDescription;	// IMP=0x000000000000f114
- (id)description;	// IMP=0x000000000000ef12
- (unsigned long long)hash;	// IMP=0x000000000000ed22
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ecba
- (_Bool)isEqualToLocationQuery:(id)arg1;	// IMP=0x000000000000e71e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e566
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000e3a7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000dfb1
- (id)init;	// IMP=0x000000000000df5f
