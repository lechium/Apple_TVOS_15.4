...
+ (id)locationQueryWithLimit:(unsigned long long)arg1 fromDate:(id)arg2 consumerType:(unsigned long long)arg3;	// IMP=0x000000000005f282
+ (id)_excludingAlgorithmsDescription:(id)arg1;	// IMP=0x000000000005f003
+ (id)_matchingCategoriesDescription:(id)arg1;	// IMP=0x000000000005ed84
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005ed7c
- (void).cxx_destruct;	// IMP=0x000000000005ecd5
...
- (id)customizedDescription;	// IMP=0x000000000005e193
- (id)description;	// IMP=0x000000000005df55
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005deee
- (_Bool)isEqualToNamedEntityQuery:(id)arg1;	// IMP=0x000000000005d6e8
- (unsigned long long)hash;	// IMP=0x000000000005d5ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005d3e8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005d1db
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005cd5f
- (id)init;	// IMP=0x000000000005cd0d
