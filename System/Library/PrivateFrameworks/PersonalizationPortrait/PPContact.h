...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000531e8
+ (id)contactWithIdentifier:(id)arg1 source:(unsigned char)arg2 namePrefix:(id)arg3 givenName:(id)arg4 middleName:(id)arg5 familyName:(id)arg6 nameSuffix:(id)arg7 nickname:(id)arg8 localizedFullName:(id)arg9 organizationName:(id)arg10 jobTitle:(id)arg11 birthday:(id)arg12 nonGregorianBirthday:(id)arg13 phoneNumbers:(id)arg14 emailAddresses:(id)arg15 socialProfiles:(id)arg16 postalAddresses:(id)arg17;	// IMP=0x0000000000052fb2
+ (_Bool)identifier:(id)arg1 startsWithPrefix:(id)arg2;	// IMP=0x0000000000052e9f
+ (unsigned char)sourceFromSourceIdentifier:(id)arg1;	// IMP=0x0000000000052db3
+ (id)sourceIdentifierWithSource:(unsigned char)arg1 identifier:(id)arg2;	// IMP=0x0000000000052c7d
+ (id)contactsContactIdentifierWithIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000052ba7
- (void).cxx_destruct;	// IMP=0x0000000000052adf
...
- (_Bool)isEqualToContact:(id)arg1;	// IMP=0x00000000000525a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005253a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000052300
- (unsigned long long)hash;	// IMP=0x0000000000051d8e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000051bea
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000517f7
- (void)setEmailAddressForTesting:(id)arg1;	// IMP=0x0000000000051732
- (void)setIdentifierForTesting:(id)arg1;	// IMP=0x0000000000051721
- (void)_generateLocalizedFullName;	// IMP=0x0000000000051618
- (id)description;	// IMP=0x00000000000515cf
- (id)contactsContactIdentifierWithError:(id *)arg1;	// IMP=0x00000000000513aa
- (id)initWithContactsContact:(id)arg1;	// IMP=0x0000000000050339
- (id)initWithIdentifier:(id)arg1 source:(unsigned char)arg2 namePrefix:(id)arg3 givenName:(id)arg4 middleName:(id)arg5 familyName:(id)arg6 nameSuffix:(id)arg7 nickname:(id)arg8 localizedFullName:(id)arg9 organizationName:(id)arg10 jobTitle:(id)arg11 birthday:(id)arg12 nonGregorianBirthday:(id)arg13 phoneNumbers:(id)arg14 emailAddresses:(id)arg15 socialProfiles:(id)arg16 postalAddresses:(id)arg17;	// IMP=0x0000000000050027
