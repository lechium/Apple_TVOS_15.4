...
- (void)resetRecordData;	// IMP=0x000000000003fe45
- (void)recentRecordLoadingCompletion;	// IMP=0x000000000003fe2b
- (unsigned char)recentRecordLoadingHandler:(id)arg1;	// IMP=0x000000000003fe09
- (unsigned char)recentRecordLoadingSetup;	// IMP=0x000000000003fded
- (void)recordLoadingCompletion;	// IMP=0x000000000003fdd3
- (unsigned char)recordLoadingHandler:(id)arg1;	// IMP=0x000000000003fdb1
- (unsigned char)recordLoadingSetup;	// IMP=0x000000000003fd95
- (id)description;	// IMP=0x000000000003fd57
- (id)initWithName:(id)arg1;	// IMP=0x000000000003fd28
