...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000021b39
- (void).cxx_destruct;	// IMP=0x0000000000021ac4
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000211f4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000210ba
- (id)descriptionDateFormatter;	// IMP=0x0000000000021080
- (id)longDescription;	// IMP=0x0000000000020196
- (id)description;	// IMP=0x000000000001feee
- (id)initWithEvent:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 score:(double)arg4 topics:(id)arg5 entities:(id)arg6 locations:(id)arg7 contacts:(id)arg8 contactHandles:(id)arg9 mediaItems:(id)arg10;	// IMP=0x000000000001fd4f
