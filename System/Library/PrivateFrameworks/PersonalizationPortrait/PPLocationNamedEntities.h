...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004c953
- (void).cxx_destruct;	// IMP=0x000000000004c8c8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004c4db
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004c3a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004c1ff
