...
+ (id)algorithmForName:(id)arg1;	// IMP=0x0000000000056808
+ (id)describeAlgorithm:(unsigned long long)arg1;	// IMP=0x00000000000566ed
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000566e5
- (void).cxx_destruct;	// IMP=0x00000000000561ac
...
- (id)identifier;	// IMP=0x00000000000560eb
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000055e99
@property(readonly, nonatomic) NSSet *featureNames;
@property(readonly, nonatomic) double sentimentScore; // @dynamic sentimentScore;
- (_Bool)isEqualToTopicRecord:(id)arg1;	// IMP=0x0000000000055c7a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000055c12
- (unsigned long long)hash;	// IMP=0x0000000000055ac5
- (id)description;	// IMP=0x00000000000559e1
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005590b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055900
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000557d3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000055562
