...
- (void).cxx_destruct;	// IMP=0x0000000000034475
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000034401
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithLeaf_leaf_predictions_probabilities:(id)arg1;	// IMP=0x0000000000034376
