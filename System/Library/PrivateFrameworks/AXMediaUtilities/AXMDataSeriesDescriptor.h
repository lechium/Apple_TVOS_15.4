...
- (void).cxx_destruct;	// IMP=0x0000000000074cc7
...
- (void)setDataSummary:(id)arg1;	// IMP=0x0000000000074c5e
@property(readonly, copy) NSString *description;
- (id)numericalValuesFromDataPointValues:(id)arg1;	// IMP=0x0000000000074982
...
- (id)_mutableArrayOfNSNullWithCount:(long long)arg1;	// IMP=0x0000000000074679
- (id)dictionaryRepresentation;	// IMP=0x0000000000073bfd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000738b7
- (void)_commonInitWithContinuous:(_Bool)arg1 dataPoints:(id)arg2;	// IMP=0x0000000000073887
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000730fe
- (id)initWithAttributedName:(id)arg1 isContinuous:(_Bool)arg2 dataPoints:(id)arg3;	// IMP=0x0000000000073057
- (id)initWithName:(id)arg1 isContinuous:(_Bool)arg2 dataPoints:(id)arg3;	// IMP=0x0000000000072fae
