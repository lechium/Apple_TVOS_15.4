...
- (id)configuredOptionsDisableAllDetectors:(CDUnknownBlockType)arg1 elementOptions:(unsigned int)arg2 textRecognitionLevel:(CDUnknownBlockType)arg3 textDetectionLocales:(CDUnknownBlockType)arg4 preferringFullCaptions:(_Bool)arg5;	// IMP=0x000000000008b241
@property(nonatomic) unsigned long long genderStrategy;
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000008b169
- (id)init;	// IMP=0x000000000008ad55
