...
- (void).cxx_destruct;	// IMP=0x000000000007cce4
...
- (double)_rawValueForTonePhase:(double)arg1;	// IMP=0x000000000007cbbc
- (void)_setFrequency:(double)arg1;	// IMP=0x000000000007cb40
- (void)renderInBuffer:(void *)arg1 atFrame:(unsigned long long)arg2;	// IMP=0x000000000007cb3a
- (id)initWithSampleRate:(double)arg1 envelope:(id)arg2;	// IMP=0x000000000007ca80
- (id)init;	// IMP=0x000000000007ca04
