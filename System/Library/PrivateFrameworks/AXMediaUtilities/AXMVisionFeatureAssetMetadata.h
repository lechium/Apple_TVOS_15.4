...
+ (id)assetMetadataWithLocalIdentifier:(id)arg1 wellKnownPHPhotoLibraryIdentifier:(long long)arg2 creationDate:(id)arg3 UTI:(id)arg4;	// IMP=0x00000000000603b4
+ (id)assetMetadataFromURL:(id)arg1 localIdentifier:(id)arg2 wellKnownPHPhotoLibraryIdentifier:(long long)arg3;	// IMP=0x000000000006030a
+ (id)assetMetadataFromURL:(id)arg1;	// IMP=0x000000000005fea1
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005f55e
- (void).cxx_destruct;	// IMP=0x00000000000605fc
...
- (id)description;	// IMP=0x000000000005fd6c
- (unsigned long long)hash;	// IMP=0x000000000005fcdf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005fb69
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005f8d1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005f566
