...
- (void).cxx_destruct;	// IMP=0x0000000000072f2e
...
- (id)description;	// IMP=0x0000000000072732
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000722a7
- (id)initWithX:(id)arg1 y:(id)arg2 additionalValues:(id)arg3 label:(id)arg4;	// IMP=0x00000000000721aa
- (id)initWithX:(id)arg1 y:(id)arg2 additionalValues:(id)arg3;	// IMP=0x0000000000072195
- (id)initWithX:(id)arg1 y:(id)arg2;	// IMP=0x000000000007217d
