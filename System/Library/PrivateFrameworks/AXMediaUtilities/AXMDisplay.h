...
- (void).cxx_destruct;	// IMP=0x0000000000062644
...
- (struct CGRect)convertRectToDisplay:(struct CGRect)arg1;	// IMP=0x00000000000623f5
- (struct CGPoint)convertPointToDisplay:(struct CGPoint)arg1;	// IMP=0x0000000000062304
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062282
- (id)description;	// IMP=0x0000000000062046
- (id)_initWithBackingType:(long long)arg1;	// IMP=0x0000000000061fa4
