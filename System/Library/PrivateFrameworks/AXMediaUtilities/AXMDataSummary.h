...
- (void).cxx_destruct;	// IMP=0x0000000000065886
...
- (double)positionForYAxisValue:(double)arg1;	// IMP=0x000000000006560c
- (double)positionForXAxisValue:(double)arg1;	// IMP=0x0000000000065586
- (void)getValues:(double *)arg1 fromNSNumberArray:(id)arg2;	// IMP=0x00000000000654ca
- (double)getVariance:(id)arg1;	// IMP=0x00000000000652c0
- (double)getMedian:(id)arg1;	// IMP=0x0000000000065123
- (double)getMean:(id)arg1;	// IMP=0x0000000000064f33
- (id)stringForComponents:(id)arg1;	// IMP=0x0000000000064cd6
- (id)description;	// IMP=0x0000000000064bc9
- (void)computeOutliers;	// IMP=0x0000000000064a07
- (void)computeResiduals;	// IMP=0x0000000000064811
- (void)computeLinearRegression;	// IMP=0x00000000000647d7
- (void)computeR;	// IMP=0x00000000000647a6
- (void)computeVariances;	// IMP=0x000000000006461f
- (void)computeCovariance;	// IMP=0x00000000000644ab
- (void)computeMeans;	// IMP=0x0000000000064338
- (void)computeRanges;	// IMP=0x0000000000064197
- (void)compute;	// IMP=0x000000000006411b
...
- (void)setRegressionModel:(id)arg1;	// IMP=0x00000000000632ea
- (void)computeRegressionModel:(CDUnknownBlockType)arg1;	// IMP=0x0000000000062e50
- (id)initWithSeries:(id)arg1 chartDescriptor:(id)arg2;	// IMP=0x0000000000062b55
