...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001df0f
+ (id)contextWithSourceParameters:(id)arg1 options:(id)arg2;	// IMP=0x000000000001db09
- (void).cxx_destruct;	// IMP=0x000000000001f786
...
- (void)didFinishProcessingContext;	// IMP=0x000000000001f517
- (void)willBeginProcessingContext;	// IMP=0x000000000001f4af
@property(readonly, nonatomic) id <AXMetricContainer> pipelineMetric;
- (void)removeAllAuxiliaryDetectors;	// IMP=0x000000000001f445
- (id)auxiliaryDetectors;	// IMP=0x000000000001f437
- (void)addAuxiliaryDetector:(id)arg1;	// IMP=0x000000000001f3cd
@property(readonly, nonatomic) AXMPipelineContextInput *sourceInput;
- (id)generateImageRepresentation;	// IMP=0x000000000001f168
- (id)generateFileNameForImageWithPrefix:(id)arg1 extension:(id)arg2;	// IMP=0x000000000001f0bb
- (void)errorOccurred:(id)arg1;	// IMP=0x000000000001f0a9
- (_Bool)_addSignificantEventFeatureGateIfNeededToFeature:(id)arg1 category:(id)arg2 minimumConfidence:(double)arg3;	// IMP=0x000000000001ecf1
- (void)addEvaluatedFeatureType:(unsigned long long)arg1;	// IMP=0x000000000001ec7b
- (void)appendFeature:(id)arg1;	// IMP=0x000000000001ebbb
- (void)produceImage:(CDUnknownBlockType)arg1;	// IMP=0x000000000001ead8
- (void)addSceneLabelForOCRDocumentTypeDetection:(id)arg1;	// IMP=0x000000000001eac2
@property(readonly, nonatomic) NSArray *sceneLabelsForOCRDocumentTypeDetection;
- (void)addResultHandlers:(id)arg1;	// IMP=0x000000000001ea9e
- (void)addResultHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000001ea5e
@property(readonly, nonatomic) NSArray *resultHandlers;
- (id)sceneObservation;	// IMP=0x000000000001e891
- (void)createSceneObservationIfNilWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e7bf
@property(readonly, nonatomic) _Bool visionImageRequestHandlerIsLoaded;
- (id)visionImageRequestHandlerWithOptions:(id)arg1;	// IMP=0x000000000001e77c
- (id)_makeRequestHandlerForInput:(id)arg1 options:(id)arg2;	// IMP=0x000000000001e4bf
@property(readonly, nonatomic) struct CGSize size;
@property(readonly, nonatomic) _Bool sourceProvidesResults;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001e260
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001df17
- (id)description;	// IMP=0x000000000001de80
- (void)_commonInitWithDiagnosticsEnabled:(_Bool)arg1;	// IMP=0x000000000001dcc7
- (id)initWithSourceParameters:(id)arg1 options:(id)arg2;	// IMP=0x000000000001db79
