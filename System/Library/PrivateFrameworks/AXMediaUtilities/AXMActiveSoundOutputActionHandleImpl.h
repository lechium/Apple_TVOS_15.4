...
- (void).cxx_destruct;	// IMP=0x0000000000087fff
...
- (void)stop;	// IMP=0x0000000000087f2b
- (void)setQuantizedRate:(long long)arg1;	// IMP=0x0000000000087f05
- (id)init;	// IMP=0x0000000000087d68
