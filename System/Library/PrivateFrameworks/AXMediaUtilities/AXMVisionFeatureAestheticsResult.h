...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006075b
...
- (id)description;	// IMP=0x000000000006094d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000060863
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000060763
- (id)initWithVisionAestheticsObservation:(id)arg1;	// IMP=0x000000000006067c
