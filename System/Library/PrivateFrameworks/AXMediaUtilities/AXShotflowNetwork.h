...
+ (id)gpuNetworkWithModelPath:(id)arg1 configuration:(id)arg2 preferredMetalDeviceID:(int)arg3 version:(int)arg4 modelType:(long long)arg5;	// IMP=0x000000000008b79f
+ (id)cpuNetworkWithModelPath:(id)arg1 configuration:(id)arg2 version:(int)arg3 modelType:(long long)arg4;	// IMP=0x000000000008b6ed
- (id).cxx_construct;	// IMP=0x0000000000090ebd
- (void).cxx_destruct;	// IMP=0x0000000000090dd1
...
- (id)processCIImage:(id)arg1;	// IMP=0x0000000000090c5d
- (id)resizeAndProcessVImage:(struct vImage_Buffer)arg1 inputIsBGR:(_Bool)arg2;	// IMP=0x00000000000901e9
- (id)processVImage:(struct vImage_Buffer)arg1 inputIsBGR:(_Bool)arg2;	// IMP=0x000000000008f658
- (void)runNetwork:(struct vImage_Buffer)arg1 inputIsBGR:(_Bool)arg2;	// IMP=0x000000000008f58f
- (int)setInputShape:(unsigned long long)arg1 height:(unsigned long long)arg2;	// IMP=0x000000000008f0f8
- (void)dealloc;	// IMP=0x000000000008f080
- (id)initWithModelPath:(id)arg1 espressoEngineID:(int)arg2 espressoDeviceID:(int)arg3 configuration:(id)arg4 version:(int)arg5 modelType:(long long)arg6;	// IMP=0x000000000008b91b
