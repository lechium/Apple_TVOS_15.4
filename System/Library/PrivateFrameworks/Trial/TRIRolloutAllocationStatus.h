...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000028ceb
- (void).cxx_destruct;	// IMP=0x0000000000028d1a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028ce0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000028a91
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000286b4
- (unsigned long long)hash;	// IMP=0x0000000000028661
- (id)initWithRolloutId:(id)arg1 deploymentId:(int)arg2 rampId:(id)arg3 factorPackIds:(id)arg4;	// IMP=0x0000000000028436
