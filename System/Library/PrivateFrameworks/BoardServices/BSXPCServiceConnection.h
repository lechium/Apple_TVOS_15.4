...
- (void).cxx_destruct;	// IMP=0x000000000003b020
@property(readonly, copy) NSString *description;
- (void)invalidate;	// IMP=0x000000000003ad36
- (void)_invalidateChildConnection:(id)arg1;	// IMP=0x000000000003780d
...
- (void)dealloc;	// IMP=0x00000000000327b2
- (id)init;	// IMP=0x0000000000032320
