...
+ (id)extendBootstrap;	// IMP=0x000000000002fc2d
+ (id)listenerWithConfigurator:(CDUnknownBlockType)arg1;	// IMP=0x000000000002eaee
- (void).cxx_destruct;	// IMP=0x0000000000030bc5
...
- (void)didReceiveConnection:(id)arg1;	// IMP=0x0000000000030862
- (void)setDelegate:(id)arg1;	// IMP=0x000000000003069b
- (void)setInstance:(id)arg1;	// IMP=0x000000000003033f
- (void)setService:(id)arg1;	// IMP=0x000000000002ffe3
- (void)setDomain:(id)arg1;	// IMP=0x000000000002fc87
- (void)invalidate;	// IMP=0x000000000002fb07
- (void)activate;	// IMP=0x000000000002f454
- (void)dealloc;	// IMP=0x000000000002e8ec
- (id)init;	// IMP=0x000000000002e774
