...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002067c
- (void).cxx_destruct;	// IMP=0x0000000000020d7d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000020aa4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000020684
