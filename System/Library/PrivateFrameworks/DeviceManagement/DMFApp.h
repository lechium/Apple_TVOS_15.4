...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001d67
+ (id)stringForInstallationState:(unsigned long long)arg1;	// IMP=0x0000000000001718
...
- (id)_stringForType:(unsigned long long)arg1;	// IMP=0x0000000000003aaa
- (id)description;	// IMP=0x00000000000032d4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002aa9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001d6f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000001866
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000017a8
