...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002bc79
+ (_Bool)isPermittedOnUserConnection;	// IMP=0x000000000002bc71
+ (_Bool)isPermittedOnSystemConnection;	// IMP=0x000000000002bc69
+ (id)permittedPlatforms;	// IMP=0x000000000002bc5c
+ (Class)whitelistedClassForResultObject;	// IMP=0x000000000002bc4b
- (void).cxx_destruct;	// IMP=0x000000000002c46b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002c125
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002bc81
