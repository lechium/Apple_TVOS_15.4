...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000b5aa
- (void).cxx_destruct;	// IMP=0x000000000000b9b1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b7e3
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b5b2
