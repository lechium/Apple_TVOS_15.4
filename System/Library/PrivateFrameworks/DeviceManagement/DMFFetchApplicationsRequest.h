...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001d5b3
+ (Class)whitelistedClassForResultObject;	// IMP=0x000000000001d5a2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001d836
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d5bb
