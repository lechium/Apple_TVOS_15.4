...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000031686
- (void).cxx_destruct;	// IMP=0x0000000000032d87
...
- (id)description;	// IMP=0x00000000000328ba
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000032306
- (unsigned long long)hash;	// IMP=0x00000000000320cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000031d1b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003168e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000031493
- (id)initWithUUID:(id)arg1 type:(unsigned long long)arg2 identifier:(id)arg3 profileVersion:(long long)arg4 displayName:(id)arg5 organization:(id)arg6 profileDescription:(id)arg7 isManaged:(_Bool)arg8 isLocked:(_Bool)arg9 hasRemovalPasscode:(_Bool)arg10 isEncrypted:(_Bool)arg11 signerCertificates:(id)arg12 payloads:(id)arg13 restrictions:(id)arg14;	// IMP=0x00000000000312ca
