...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000293a6
+ (_Bool)isPermittedOnUserConnection;	// IMP=0x000000000002939e
+ (_Bool)isPermittedOnSystemConnection;	// IMP=0x0000000000029396
+ (id)permittedPlatforms;	// IMP=0x0000000000029389
- (void).cxx_destruct;	// IMP=0x0000000000029851
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000295ff
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000293ae
