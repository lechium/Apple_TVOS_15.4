...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002dd32
- (void).cxx_destruct;	// IMP=0x000000000002ed5e
...
- (id)description;	// IMP=0x000000000002e950
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002e540
- (unsigned long long)hash;	// IMP=0x000000000002e3be
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002e0f4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002dd3a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002dbbb
- (id)initWithProductKey:(id)arg1 humanReadableName:(id)arg2 productName:(id)arg3 version:(id)arg4 build:(id)arg5 downloadSize:(unsigned long long)arg6 installSize:(unsigned long long)arg7 isCritical:(_Bool)arg8 restartRequired:(_Bool)arg9 allowsInstallLater:(_Bool)arg10;	// IMP=0x000000000002da66
