...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000037397
...
- (id)description;	// IMP=0x0000000000037aa6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000378f1
- (unsigned long long)hash;	// IMP=0x000000000003784d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000375f8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003739f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000372c4
- (id)initWithSupportsBlockLevelEncryption:(_Bool)arg1 supportsFileLevelEncryption:(_Bool)arg2 passcodeIsSet:(_Bool)arg3 passcodeIsCompliantWithGlobalRestrictions:(_Bool)arg4 passcodeIsCompliantWithProfileRestrictions:(_Bool)arg5 passcodeLockGracePeriodEnforced:(unsigned long long)arg6 passcodeLockGracePeriod:(unsigned long long)arg7;	// IMP=0x0000000000037252
