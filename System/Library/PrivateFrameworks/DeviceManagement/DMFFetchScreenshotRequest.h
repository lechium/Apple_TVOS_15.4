...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000025aeb
+ (Class)whitelistedClassForResultObject;	// IMP=0x0000000000025ada
- (void).cxx_destruct;	// IMP=0x0000000000025ebf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000025cb6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000025af3
