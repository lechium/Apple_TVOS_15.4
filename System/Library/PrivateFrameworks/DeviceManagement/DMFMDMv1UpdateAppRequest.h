...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002c502
+ (Class)whitelistedClassForResultObject;	// IMP=0x000000000002c4f1
- (void).cxx_destruct;	// IMP=0x000000000002cc35
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002c948
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002c50a
