...
+ (id)_sanitizedDeviceKey:(id)arg1;	// IMP=0x00000000000188f3
+ (id)propertyNameForKey:(id)arg1;	// IMP=0x0000000000018404
- (void).cxx_destruct;	// IMP=0x0000000000018d08
...
- (id)valueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000186fa
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x0000000000018376
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000000182c6
- (id)initPrivate;	// IMP=0x0000000000018297
