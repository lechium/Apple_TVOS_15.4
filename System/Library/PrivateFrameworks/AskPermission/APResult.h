...
- (id)description;	// IMP=0x0000000000005b3a
- (id)compile;	// IMP=0x0000000000005a26
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000580c
- (id)initWithBundleIdentifier:(id)arg1 buyParams:(id)arg2 itemIdentifier:(id)arg3 productType:(id)arg4;	// IMP=0x000000000000572a
