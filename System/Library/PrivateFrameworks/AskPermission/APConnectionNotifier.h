...
+ (id)sharedNotifier;	// IMP=0x0000000000001ddf
- (void).cxx_destruct;	// IMP=0x0000000000002597
...
- (id)_newRemoteConnection;	// IMP=0x0000000000001f7c
- (id)_remoteConnection;	// IMP=0x0000000000001e34
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x0000000000001b35
