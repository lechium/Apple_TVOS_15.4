...
- (void).cxx_destruct;	// IMP=0x00000000001a9e8d
...
- (id)_interestDataFromInterestDictionary:(id)arg1;	// IMP=0x00000000001a9d2a
- (id)_interestDictionaryFromInterestData:(id)arg1;	// IMP=0x00000000001a9ba1
- (void)_onSerialQueue_faultInProperties;	// IMP=0x00000000001a9b21
...
- (id)fileURLForEffect:(id)arg1;	// IMP=0x00000000001a9770
- (id)fileURLForSize:(struct CGSize)arg1;	// IMP=0x00000000001a95d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a9494
- (unsigned long long)hash;	// IMP=0x00000000001a9451
- (id)initWithToken:(id)arg1 relativePath:(id)arg2 artworkType:(long long)arg3 musicLibrary:(id)arg4;	// IMP=0x00000000001a91c4
- (id)initWithToken:(id)arg1 artworkType:(long long)arg2 musicLibrary:(id)arg3;	// IMP=0x00000000001a9122
