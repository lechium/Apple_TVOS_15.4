...
- (void).cxx_destruct;	// IMP=0x00000000000b5b18
...
- (void)execute;	// IMP=0x00000000000b59b8
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000b590a
