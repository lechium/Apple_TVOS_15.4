...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000007a2ee
- (unsigned long long)hash;	// IMP=0x000000000007a05a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000079c90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000799ea
- (void)copyTo:(id)arg1;	// IMP=0x0000000000079779
- (void)writeTo:(id)arg1;	// IMP=0x00000000000794d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000794cc
- (id)dictionaryRepresentation;	// IMP=0x0000000000078e8c
- (id)description;	// IMP=0x0000000000078ddd
