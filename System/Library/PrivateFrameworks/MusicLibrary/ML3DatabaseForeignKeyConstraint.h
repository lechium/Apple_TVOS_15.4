...
- (void).cxx_destruct;	// IMP=0x0000000000004439
...
- (id)_foreignKeyClauseSQL;	// IMP=0x0000000000003f90
- (id)initWithForeignTable:(id)arg1 localColumns:(id)arg2 foreignColumns:(id)arg3;	// IMP=0x0000000000003eaf
