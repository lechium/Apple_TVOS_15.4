...
- (void).cxx_destruct;	// IMP=0x00000000000e0477
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000e0243
- (unsigned long long)hash;	// IMP=0x00000000000e00bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000dfe1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dfc80
- (void)copyTo:(id)arg1;	// IMP=0x00000000000dfb11
- (void)writeTo:(id)arg1;	// IMP=0x00000000000df979
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000df96c
- (id)dictionaryRepresentation;	// IMP=0x00000000000df58a
- (id)description;	// IMP=0x00000000000df4db
