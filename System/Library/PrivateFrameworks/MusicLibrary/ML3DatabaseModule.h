...
- (void).cxx_destruct;	// IMP=0x00000000000f6803
...
- (id)description;	// IMP=0x00000000000f6793
- (id)initWithName:(id)arg1 moduleMethods:(struct sqlite3_module *)arg2;	// IMP=0x00000000000f6715
