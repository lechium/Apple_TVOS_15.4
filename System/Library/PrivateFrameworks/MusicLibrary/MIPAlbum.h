...
- (void).cxx_destruct;	// IMP=0x00000000000ef791
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000ef4e9
- (unsigned long long)hash;	// IMP=0x00000000000ef372
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ef0fd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eef31
- (void)copyTo:(id)arg1;	// IMP=0x00000000000eedbb
- (void)writeTo:(id)arg1;	// IMP=0x00000000000eec3b
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000eec2e
- (id)dictionaryRepresentation;	// IMP=0x00000000000ee8f7
- (id)description;	// IMP=0x00000000000ee848
