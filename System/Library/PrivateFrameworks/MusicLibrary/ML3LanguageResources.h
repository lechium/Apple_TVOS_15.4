...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018b9c8
- (void).cxx_destruct;	// IMP=0x000000000018b995
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018b881
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018b720
- (id)initWithSectionsInfo:(id)arg1 sortingDetails:(id)arg2 canonicalLanguageIdentifier:(id)arg3;	// IMP=0x000000000018b63a
