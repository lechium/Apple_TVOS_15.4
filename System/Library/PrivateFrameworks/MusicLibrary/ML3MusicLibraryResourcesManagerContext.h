...
+ (id)contextForMultiUserDaemonLibraryWithAccountInfo:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x000000000001fb43
+ (id)contextForMultiUserFrameworkLibraryWithService:(id)arg1;	// IMP=0x000000000001fae1
+ (id)contextForSingleUserLibraryWithLibraryContainerIdentifier:(id)arg1;	// IMP=0x000000000001fa89
+ (id)contextForSingleUserLibraryWithAccountInfo:(id)arg1;	// IMP=0x000000000001fa30
+ (id)contextForAutoupdatingSharedLibrary;	// IMP=0x000000000001f910
- (void).cxx_destruct;	// IMP=0x000000000001f8d2
...
- (id)_initWithResourcesService:(id)arg1 accountInfo:(id)arg2 libraryContainerIdentifier:(id)arg3 accountChangeObserver:(id)arg4 supportsMultiUsers:(_Bool)arg5 runningInDaemon:(_Bool)arg6;	// IMP=0x000000000001f78e
