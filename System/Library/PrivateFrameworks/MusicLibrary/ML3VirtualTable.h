...
- (id).cxx_construct;	// IMP=0x000000000013f394
- (void).cxx_destruct;	// IMP=0x000000000013f344
...
- (_Bool)unregister;	// IMP=0x000000000013f0eb
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x000000000013ee20
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x000000000013ed9f
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x000000000013ec1d
