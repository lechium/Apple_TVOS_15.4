...
- (void).cxx_destruct;	// IMP=0x0000000000189760
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00000000001896a1
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018966e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000189642
