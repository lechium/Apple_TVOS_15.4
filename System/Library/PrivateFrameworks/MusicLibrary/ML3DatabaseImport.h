...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000017199b
- (void).cxx_destruct;	// IMP=0x00000000001717ee
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x000000000017167f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000171325
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001710cf
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017109c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000171070
- (id)description;	// IMP=0x0000000000170ff3
- (id)init;	// IMP=0x0000000000170fda
- (id)initWithLibraryPath:(id)arg1 trackData:(id)arg2 playlistData:(id)arg3 clientIdentity:(id)arg4;	// IMP=0x0000000000170eb3
- (id)initWithLibraryPath:(id)arg1 trackData:(id)arg2 playlistData:(id)arg3;	// IMP=0x0000000000170e16
