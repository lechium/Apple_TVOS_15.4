...
- (void).cxx_destruct;	// IMP=0x00000000000f84b9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000f80db
- (unsigned long long)hash;	// IMP=0x00000000000f7e84
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f7aa9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f7814
- (void)copyTo:(id)arg1;	// IMP=0x00000000000f75c5
- (void)writeTo:(id)arg1;	// IMP=0x00000000000f734c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000f733f
- (id)dictionaryRepresentation;	// IMP=0x00000000000f6d61
- (id)description;	// IMP=0x00000000000f6cb2
