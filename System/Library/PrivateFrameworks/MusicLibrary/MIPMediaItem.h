...
+ (Class)libraryIdentifiersType;	// IMP=0x00000000001a8724
- (void).cxx_destruct;	// IMP=0x00000000001a60b6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001a4e86
- (unsigned long long)hash;	// IMP=0x00000000001a42fd
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a3260
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a2539
- (void)copyTo:(id)arg1;	// IMP=0x00000000001a1abb
- (void)writeTo:(id)arg1;	// IMP=0x00000000001a1025
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001a1018
- (id)dictionaryRepresentation;	// IMP=0x000000000019f691
- (id)description;	// IMP=0x000000000019f5e2
...
- (id)libraryIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x000000000019f208
- (unsigned long long)libraryIdentifiersCount;	// IMP=0x000000000019f1eb
- (void)addLibraryIdentifiers:(id)arg1;	// IMP=0x000000000019f181
- (void)clearLibraryIdentifiers;	// IMP=0x000000000019f164
...
- (int)StringAsMediaType:(id)arg1;	// IMP=0x000000000019dff0
- (id)mediaTypeAsString:(int)arg1;	// IMP=0x000000000019def7
