...
- (void).cxx_destruct;	// IMP=0x000000000008e031
- (id)nextObject;	// IMP=0x000000000008de32
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x000000000008dd90
