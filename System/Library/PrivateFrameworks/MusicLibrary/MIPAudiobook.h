...
- (void).cxx_destruct;	// IMP=0x00000000000e9447
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000e910a
- (unsigned long long)hash;	// IMP=0x00000000000e8f90
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e8cd9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e8ae8
- (void)copyTo:(id)arg1;	// IMP=0x00000000000e895c
- (void)writeTo:(id)arg1;	// IMP=0x00000000000e87bf
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000e87b2
- (id)dictionaryRepresentation;	// IMP=0x00000000000e83bc
- (id)description;	// IMP=0x00000000000e830d
