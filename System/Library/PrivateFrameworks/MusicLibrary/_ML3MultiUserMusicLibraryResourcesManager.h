...
- (void).cxx_destruct;	// IMP=0x000000000019ddba
...
- (void)terminateForFailureToPerformDatabasePathChange;	// IMP=0x000000000019dd6a
- (void)emergencyDisconnectWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019dc69
- (void)performDatabasePathChange:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000019db71
...
- (id)libraryContainerPath;	// IMP=0x000000000019d60c
- (id)initWithLibraryResourcesService:(id)arg1;	// IMP=0x000000000019d53a
