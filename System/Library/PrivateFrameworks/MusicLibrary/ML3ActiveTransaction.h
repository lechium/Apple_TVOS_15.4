...
- (void).cxx_destruct;	// IMP=0x000000000001f73a
...
- (void)unlock;	// IMP=0x000000000001f6ba
- (void)lock;	// IMP=0x000000000001f6a4
- (id)_relinquishConnection;	// IMP=0x000000000001f68b
- (void)updateLastUsed;	// IMP=0x000000000001f662
- (id)description;	// IMP=0x000000000001f56d
@property(readonly, nonatomic) ML3DatabaseConnection *connection;
- (id)initWithLibrary:(id)arg1 connection:(id)arg2 client:(id)arg3;	// IMP=0x000000000001f2b0
- (id)init;	// IMP=0x000000000001f218
