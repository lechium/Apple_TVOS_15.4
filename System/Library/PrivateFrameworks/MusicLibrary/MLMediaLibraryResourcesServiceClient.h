...
+ (id)sharedService;	// IMP=0x00000000000b7924
- (void).cxx_destruct;	// IMP=0x00000000000b6b88
...
- (id)connectionWithListenerEndpoint:(id)arg1;	// IMP=0x00000000000b685c
- (void)terminateForFailureToPerformDatabasePathChange;	// IMP=0x00000000000b6693
- (void)emergencyDisconnectWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b6621
- (void)performDatabasePathChange:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b640f
- (id)_libraryContainerPathWithError:(id *)arg1;	// IMP=0x00000000000b60e4
- (id)_initWithAccountChangeObserver:(id)arg1;	// IMP=0x00000000000b5f5d
- (id)libraryContainerPathWithError:(id *)arg1;	// IMP=0x00000000000b5c0b
