...
- (void).cxx_destruct;	// IMP=0x0000000000013fe6
@property(retain) GKTournamentPlayerStandingsInternal *internal; // @synthesize internal=_internal;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000013fb1
- (id)initWithInternalRepresentation:(id)arg1;	// IMP=0x0000000000013f49
- (id)init;	// IMP=0x0000000000013eef
