...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000000100bf2
- (void).cxx_destruct;	// IMP=0x00000000001012a8
...
- (_Bool)hasGuestPlayers;	// IMP=0x0000000000100f80
- (unsigned long long)hash;	// IMP=0x0000000000100b83
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010041f
- (id)init;	// IMP=0x00000000001003a9
