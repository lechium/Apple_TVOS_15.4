...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000fbc54
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000fb604
- (void).cxx_destruct;	// IMP=0x00000000000fc3e8
...
- (unsigned long long)hash;	// IMP=0x00000000000fc278
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fbf86
- (id)serverRepresentation;	// IMP=0x00000000000fbdf9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fbb40
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000fb628
