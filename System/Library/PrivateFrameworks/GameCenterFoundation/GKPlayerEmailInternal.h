...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f8554
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f854c
- (void).cxx_destruct;	// IMP=0x00000000000f8882
...
- (unsigned long long)hash;	// IMP=0x00000000000f874d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f8633
