...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000000102343
- (void).cxx_destruct;	// IMP=0x000000000010290e
...
- (unsigned long long)hash;	// IMP=0x00000000001027aa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000102530
