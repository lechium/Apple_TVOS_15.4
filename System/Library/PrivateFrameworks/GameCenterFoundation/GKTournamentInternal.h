...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x0000000000039b77
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000397c8
- (void).cxx_destruct;	// IMP=0x000000000003a06c
