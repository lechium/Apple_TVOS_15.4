...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f4b6e
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x00000000000f492f
- (void).cxx_destruct;	// IMP=0x00000000000f4ef0
...
- (void)updateWithGame:(id)arg1;	// IMP=0x00000000000f49a1
