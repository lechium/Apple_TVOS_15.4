...
+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x00000000000f65d7
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x00000000000f64d1
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x00000000000f6330
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f5858
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f5850
- (void).cxx_destruct;	// IMP=0x00000000000f6edc
...
- (void)stripPIIs;	// IMP=0x00000000000f6a1e
- (id)debugDescription;	// IMP=0x00000000000f686b
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x00000000000f6833
- (_Bool)allowNearbyMultiplayer;	// IMP=0x00000000000f682b
...
- (int)globalFriendListSharingStatus;	// IMP=0x00000000000f67f0
...
- (int)defaultFamiliarity;	// IMP=0x00000000000f663c
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x00000000000f640a
- (id)minimalInternal;	// IMP=0x00000000000f5fea
- (unsigned long long)hash;	// IMP=0x00000000000f5fa6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f5edb
- (id)serverRepresentation;	// IMP=0x00000000000f5dd0
- (id)conciseDescription;	// IMP=0x00000000000f5d13
- (id)cacheKey;	// IMP=0x00000000000f5d01
- (_Bool)_gkIsSameAsPlayer:(id)arg1;	// IMP=0x00000000000dbb48
