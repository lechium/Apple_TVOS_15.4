...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f4058
- (void).cxx_destruct;	// IMP=0x00000000000f48a9
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f43de
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x00000000000f4315
- (_Bool)isValid;	// IMP=0x00000000000f42e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f4235
- (unsigned long long)hash;	// IMP=0x00000000000f4218
