...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f3609
- (void).cxx_destruct;	// IMP=0x00000000000f3fd0
...
- (id)description;	// IMP=0x00000000000f394c
- (id)serverRepresentation;	// IMP=0x00000000000f393a
- (unsigned long long)hash;	// IMP=0x00000000000f35c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f3518
- (id)defaultCategory;	// IMP=0x00000000000f4046
- (unsigned short)numberOfCategories;	// IMP=0x00000000000f4034
