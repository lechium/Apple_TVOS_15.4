...
- (void).cxx_destruct;	// IMP=0x00000000000371f4
...
- (void)addUpdatesFromGroup:(id)arg1;	// IMP=0x0000000000036ff1
- (void)addUpdate:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x0000000000036e93
- (void)updateError:(id)arg1;	// IMP=0x0000000000036e19
- (oneway void)release;	// IMP=0x0000000000036d72
- (id)retain;	// IMP=0x0000000000036ce0
- (void)dealloc;	// IMP=0x0000000000036c84
- (id)init;	// IMP=0x0000000000036c28
