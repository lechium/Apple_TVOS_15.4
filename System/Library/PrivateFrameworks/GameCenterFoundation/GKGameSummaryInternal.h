...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000000098888
- (void).cxx_destruct;	// IMP=0x0000000000098f1c
...
- (id)description;	// IMP=0x0000000000098d3d
- (id)initWithGameSummary:(id)arg1;	// IMP=0x00000000000989f2
