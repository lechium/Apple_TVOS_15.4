...
- (void).cxx_destruct;	// IMP=0x00000000000ef76e
...
- (void)_performTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00000000000ef3e5
- (id)_validateTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00000000000eeb84
- (id)missingTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x00000000000eeb52
- (_Bool)_setCurrentState:(id)arg1;	// IMP=0x00000000000ee894
@property(retain) NSString *currentState; // @synthesize currentState=_currentState;
- (_Bool)applyState:(id)arg1;	// IMP=0x00000000000ee870
- (id)init;	// IMP=0x00000000000ee7fe
