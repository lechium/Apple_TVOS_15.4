...
+ (id)internalRepresentation;	// IMP=0x00000000000fc940
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000fc4e4
- (void).cxx_destruct;	// IMP=0x00000000000fd062
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000000000fcee6
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x00000000000fcac8
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x00000000000fc95a
- (id)serverRepresentation;	// IMP=0x00000000000fc948
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fc893
- (unsigned long long)hash;	// IMP=0x00000000000fc84f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000fc71d
