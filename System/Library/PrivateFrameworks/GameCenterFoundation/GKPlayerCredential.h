...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000de5a3
- (void).cxx_destruct;	// IMP=0x00000000000de8a7
...
- (id)description;	// IMP=0x00000000000de457
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x00000000000de321
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000de0b4
