...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000b8bbf
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b8c43
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b8bc7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b8b42
- (id)initWithInterval:(unsigned long long)arg1 frequency:(long long)arg2;	// IMP=0x00000000000b8acd
