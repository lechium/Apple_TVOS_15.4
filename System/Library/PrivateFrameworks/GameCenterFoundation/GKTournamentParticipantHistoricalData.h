...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000361f7
- (void).cxx_destruct;	// IMP=0x000000000003649b
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000363e5
- (id)initWithInternalRepresentation:(id)arg1;	// IMP=0x000000000003637d
- (id)init;	// IMP=0x0000000000036323
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000362aa
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000361ff
