...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x00000000000db226
- (void).cxx_destruct;	// IMP=0x00000000000db862
...
- (id)bundleURL;	// IMP=0x00000000000db4da
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x00000000000db1cc
- (id)initWithProxy:(id)arg1;	// IMP=0x00000000000db164
