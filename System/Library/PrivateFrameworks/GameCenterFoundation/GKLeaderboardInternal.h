...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000fa599
- (void).cxx_destruct;	// IMP=0x00000000000fad6c
...
- (unsigned long long)hash;	// IMP=0x00000000000faa38
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fa964
