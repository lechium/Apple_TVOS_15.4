...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c9add
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000c9992
- (void).cxx_destruct;	// IMP=0x00000000000c9c0d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c98c8
