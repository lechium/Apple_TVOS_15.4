...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000faec6
- (void).cxx_destruct;	// IMP=0x00000000000fb289
...
- (unsigned long long)hash;	// IMP=0x00000000000fb18c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fb0b8
