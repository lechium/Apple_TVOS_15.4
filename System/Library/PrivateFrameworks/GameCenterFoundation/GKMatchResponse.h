...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000ec92f
- (void).cxx_destruct;	// IMP=0x00000000000ecd81
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x00000000000ecb62
- (_Bool)isNetworkError;	// IMP=0x00000000000ecb21
- (_Bool)isTimeout;	// IMP=0x00000000000ecae0
- (_Bool)isCancelled;	// IMP=0x00000000000eca9f
- (_Bool)isFinished;	// IMP=0x00000000000eca5e
- (int)_incrementSequence;	// IMP=0x00000000000eca4d
