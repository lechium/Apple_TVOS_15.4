...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000035bcd
- (void).cxx_destruct;	// IMP=0x0000000000035e82
@property(retain, nonatomic) GKPlayer *player; // @synthesize player=_player;
@property(retain) GKTournamentParticipantInternal *internal; // @synthesize internal=_internal;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000035dbb
- (id)initWithInternalRepresentation:(id)arg1;	// IMP=0x0000000000035d53
- (id)init;	// IMP=0x0000000000035cf9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000035c80
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000035bd5
