...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000000101b45
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x0000000000101ab6
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x00000000001018fd
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x000000000010132e
- (void).cxx_destruct;	// IMP=0x0000000000102257
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000000101fa2
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000101ec7
- (unsigned long long)hash;	// IMP=0x0000000000101e83
- (id)init;	// IMP=0x0000000000101ae5
