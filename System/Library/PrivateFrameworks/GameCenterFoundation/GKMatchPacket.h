...
- (void).cxx_destruct;	// IMP=0x0000000000059f9b
...
- (id)message;	// IMP=0x0000000000059de8
- (id)initWithMessage:(id)arg1;	// IMP=0x0000000000059bcc
- (id)init;	// IMP=0x0000000000059b94
