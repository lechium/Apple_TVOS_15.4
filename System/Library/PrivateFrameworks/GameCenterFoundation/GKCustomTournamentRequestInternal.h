...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x000000000003890a
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000000038714
- (void).cxx_destruct;	// IMP=0x0000000000038c88
