...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007796b
+ (id)requestForPlayerInternals:(id)arg1;	// IMP=0x0000000000077915
+ (id)requestForRankRange:(struct _NSRange)arg1;	// IMP=0x00000000000778ce
- (void).cxx_destruct;	// IMP=0x0000000000077da1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000077c12
- (unsigned long long)hash;	// IMP=0x0000000000077bd3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000077ae6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000077973
