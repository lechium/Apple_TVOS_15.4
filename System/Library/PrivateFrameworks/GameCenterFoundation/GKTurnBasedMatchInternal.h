...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000fdbca
- (void).cxx_destruct;	// IMP=0x00000000000ff21b
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000000000feecf
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x00000000000fe55e
- (long long)previousParticipantIndex;	// IMP=0x00000000000fe2e7
- (long long)localPlayerParticipantIndex;	// IMP=0x00000000000fe255
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fe0ba
- (unsigned long long)hash;	// IMP=0x00000000000fe076
