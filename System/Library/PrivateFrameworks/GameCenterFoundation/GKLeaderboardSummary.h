...
- (void).cxx_destruct;	// IMP=0x00000000000cbe66
@property(retain, nonatomic) GKLeaderboardSummaryInternal *internal; // @synthesize internal=_internal;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000cbe39
- (id)initWithInternalRepresentation:(id)arg1;	// IMP=0x00000000000cbdd1
