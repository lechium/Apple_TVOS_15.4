...
- (void)webkitExitFullScreen;	// IMP=0x0000000000084b40
- (void)webkitEnterFullScreen;	// IMP=0x0000000000084b20
- (void)webkitExitFullscreen;	// IMP=0x0000000000084a30
- (void)webkitEnterFullscreen;	// IMP=0x00000000000848d0
