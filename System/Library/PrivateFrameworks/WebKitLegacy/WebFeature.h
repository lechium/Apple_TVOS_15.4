...
- (id)description;	// IMP=0x00000000000f5060
- (void)dealloc;	// IMP=0x00000000000f5000
- (id)initWithKey:(id)arg1 preferenceKey:(id)arg2 name:(id)arg3 details:(id)arg4 defaultValue:(_Bool)arg5 hidden:(_Bool)arg6;	// IMP=0x00000000000f4f50
