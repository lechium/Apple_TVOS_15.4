...
- (void)initUIEvent:(id)arg1 canBubble:(_Bool)arg2 cancelable:(_Bool)arg3 view:(id)arg4 detail:(int)arg5;	// IMP=0x0000000000098200
...
- (void)initUIEvent:(id)arg1:(_Bool)arg2:(_Bool)arg3:(id)arg4:(int)arg5;	// IMP=0x0000000000098430
