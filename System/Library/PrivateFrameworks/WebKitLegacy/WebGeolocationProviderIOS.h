...
+ (id)sharedGeolocationProvider;	// IMP=0x00000000000fdd50
- (id).cxx_construct;	// IMP=0x00000000000ff480
- (void).cxx_destruct;	// IMP=0x00000000000ff360
- (void)resetGeolocation;	// IMP=0x00000000000ff140
- (void)errorOccurred:(id)arg1;	// IMP=0x00000000000fefd0
- (void)positionChanged:(id)arg1;	// IMP=0x00000000000fee20
- (void)stopTrackingWebView:(id)arg1;	// IMP=0x00000000000fee00
- (void)geolocationAuthorizationDenied;	// IMP=0x00000000000febf0
- (void)geolocationAuthorizationGranted;	// IMP=0x00000000000fe9e0
- (void)initializeGeolocationForWebView:(id)arg1 listener:(id)arg2;	// IMP=0x00000000000fe710
- (void)setEnableHighAccuracy:(_Bool)arg1;	// IMP=0x00000000000fe660
- (id)lastPosition;	// IMP=0x00000000000fe650
- (void)unregisterWebView:(id)arg1;	// IMP=0x00000000000fe350
- (void)registerWebView:(id)arg1;	// IMP=0x00000000000fe120
- (void)_handlePendingInitialPosition:(id)arg1;	// IMP=0x00000000000fdf80
- (void)resume;	// IMP=0x00000000000fde60
- (void)suspend;	// IMP=0x00000000000fdde0
- (void)dealloc;	// IMP=0x00000000000fdcd0
