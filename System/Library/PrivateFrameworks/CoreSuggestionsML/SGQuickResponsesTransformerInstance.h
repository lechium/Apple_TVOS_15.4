...
- (void).cxx_destruct;	// IMP=0x00000000000186b2
...
- (id)initWithConfig:(id)arg1 featurizer:(id)arg2 source:(id)arg3 labeler:(id)arg4 sampler:(id)arg5;	// IMP=0x0000000000018303
