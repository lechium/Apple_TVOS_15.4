...
+ (id)configWithLanguage:(id)arg1 mode:(unsigned long long)arg2 plistPath:(id)arg3;	// IMP=0x0000000000008773
+ (void)_addModelAssetUpdateHandler;	// IMP=0x000000000000874f
+ (id)_sharedCache;	// IMP=0x0000000000008717
+ (id)_cacheKeyForLanguage:(id)arg1 mode:(unsigned long long)arg2 plistPath:(id)arg3;	// IMP=0x0000000000008682
- (void).cxx_destruct;	// IMP=0x000000000000860d
...
- (id)initWithLanguage:(id)arg1 mode:(unsigned long long)arg2 dictionary:(id)arg3;	// IMP=0x00000000000078f0
- (id)initWithLanguage:(id)arg1 mode:(unsigned long long)arg2 plistPath:(id)arg3;	// IMP=0x000000000000774c
