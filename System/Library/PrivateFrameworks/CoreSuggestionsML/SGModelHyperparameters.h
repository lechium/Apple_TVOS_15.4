...
+ (unsigned long long)strategyForString:(id)arg1 modelTypeName:(id)arg2;	// IMP=0x0000000000001c00
- (void).cxx_destruct;	// IMP=0x0000000000001bd8
...
- (id)sessionDescriptorForLanguage:(id)arg1;	// IMP=0x0000000000001aaf
- (id)initWithDictionary:(id)arg1 modelTypeName:(id)arg2;	// IMP=0x00000000000012fc
