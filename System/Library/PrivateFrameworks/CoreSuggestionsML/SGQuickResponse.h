...
- (void)setIsConfident:(_Bool)arg1;	// IMP=0x00000000000123a1
- (id)description;	// IMP=0x0000000000012367
- (id)initWithText:(id)arg1 lang:(id)arg2 replyTextId:(unsigned long long)arg3 styleGroupId:(unsigned long long)arg4 semanticClassId:(unsigned long long)arg5 modelId:(unsigned long long)arg6 categoryId:(unsigned long long)arg7 isCustomResponse:(_Bool)arg8 isConfident:(_Bool)arg9 proactiveTrigger:(id)arg10;	// IMP=0x000000000001217c
- (id)initWithProactiveTrigger:(id)arg1 isConfident:(_Bool)arg2;	// IMP=0x0000000000012130
- (id)initWithText:(id)arg1 lang:(id)arg2 replyTextId:(unsigned long long)arg3 styleGroupId:(unsigned long long)arg4 semanticClassId:(unsigned long long)arg5 modelId:(unsigned long long)arg6 categoryId:(unsigned long long)arg7 isCustomResponse:(_Bool)arg8 isConfident:(_Bool)arg9;	// IMP=0x0000000000011f8e
