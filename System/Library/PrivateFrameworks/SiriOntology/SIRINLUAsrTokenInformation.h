...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000026cb
- (void).cxx_destruct;	// IMP=0x0000000000003057
...
- (id)description;	// IMP=0x0000000000002cc4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000029eb
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000026d3
- (id)initWithPostITNText:(id)arg1 phoneSequence:(id)arg2 ipaPhoneSequence:(id)arg3 addSpaceAfter:(_Bool)arg4 removeSpaceAfter:(_Bool)arg5 removeSpaceBefore:(_Bool)arg6 confidenceScore:(double)arg7 beginIndex:(unsigned int)arg8 endIndex:(unsigned int)arg9;	// IMP=0x00000000000025dd
- (id)initWithPostITNText:(id)arg1 phoneSequence:(id)arg2 ipaPhoneSequence:(id)arg3 addSpaceAfter:(_Bool)arg4 removeSpaceAfter:(_Bool)arg5 removeSpaceBefore:(_Bool)arg6 confidenceScore:(double)arg7 beginIndex:(unsigned int)arg8 endIndex:(unsigned int)arg9 startMilliSeconds:(int)arg10 endMilliSeconds:(int)arg11;	// IMP=0x00000000000024e1
