...
{
    id <SHJSONLDataDetokenizerDelegate> _delegate;	// 8 = 0x8
}
...
- (_Bool)loadDataFromURL:(id)arg1 algorithm:(int)arg2 error:(id *)arg3;	// IMP=0x0000000000001bb7
- (_Bool)loadDataFromURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000001b46
