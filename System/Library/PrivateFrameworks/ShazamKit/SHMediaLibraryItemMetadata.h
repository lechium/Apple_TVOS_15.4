...
- (void).cxx_destruct;	// IMP=0x000000000000a66b
@property(readonly, nonatomic) NSData *encodedSystemData; // @synthesize encodedSystemData=_encodedSystemData;
- (_Bool)validEncodedSystemData:(id)arg1;	// IMP=0x000000000000a645
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a5bc
- (id)initWithEncodedSystemData:(id)arg1;	// IMP=0x000000000000a4fa
