...
+ (_Bool)supportsBSXPCSecureCoding;	// IMP=0x000000000000659b
- (void).cxx_destruct;	// IMP=0x0000000000006899
...
- (id)initWithBSXPCCoder:(id)arg1;	// IMP=0x0000000000006667
- (void)encodeWithBSXPCCoder:(id)arg1;	// IMP=0x00000000000065a3
