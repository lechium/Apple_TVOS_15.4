...
+ (id)_configureEnvironment:(id)arg1 withInfo:(id)arg2 isPreApex:(_Bool)arg3;	// IMP=0x0000000000004a8a
+ (unsigned long long)_applicationTypeForProxy:(id)arg1;	// IMP=0x00000000000049f1
- (void).cxx_destruct;	// IMP=0x0000000000005391
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000004dd1
- (id)succinctDescriptionBuilder;	// IMP=0x0000000000004d3f
- (void)_loadFromProxy:(id)arg1;	// IMP=0x00000000000049eb
- (void)_synchronize:(CDUnknownBlockType)arg1;	// IMP=0x00000000000049a4
- (void)_overrideTags:(id)arg1;	// IMP=0x00000000000047eb
- (_Bool)builtOnOrAfterSDKVersion:(id)arg1;	// IMP=0x00000000000047b8
- (_Bool)supportsDeviceFamily:(unsigned long long)arg1;	// IMP=0x0000000000004756
- (_Bool)supportsAllInterfaceOrientations;	// IMP=0x000000000000473f
- (_Bool)supportsInterfaceOrientation:(long long)arg1;	// IMP=0x000000000000471e
- (_Bool)supportsBackgroundMode:(id)arg1;	// IMP=0x0000000000004701
...
- (id)_initWithApplicationProxy:(id)arg1 overrideURL:(id)arg2;	// IMP=0x00000000000036fa
- (id)_initWithApplicationProxy:(id)arg1;	// IMP=0x00000000000036e6
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x00000000000036d4
- (id)_initWithBundleProxy:(id)arg1 overrideURL:(id)arg2;	// IMP=0x00000000000035df
- (id)_initWithBundleIdentifier:(id)arg1 url:(id)arg2;	// IMP=0x000000000000349b
...
- (unsigned long long)unauthoritativeTrustState;	// IMP=0x0000000000005628
