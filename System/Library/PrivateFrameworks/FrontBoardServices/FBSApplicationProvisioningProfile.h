...
- (void).cxx_destruct;	// IMP=0x000000000000655d
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000000645e
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000000000640e
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000063f2
- (id)succinctDescription;	// IMP=0x00000000000063a2
- (id)description;	// IMP=0x000000000000638e
- (_Bool)allowsApplicationIdentifierEntitlement:(id)arg1;	// IMP=0x0000000000006277
- (id)initWithSignerIdentity:(id)arg1 profile:(id)arg2;	// IMP=0x0000000000006204
