...
+ (id)configurationWithEndpoint:(id)arg1;	// IMP=0x000000000002f221
+ (id)configurationForDefaultMainDisplayMonitor;	// IMP=0x000000000002f1b5
- (void).cxx_destruct;	// IMP=0x000000000002f4bf
...
- (id)_initWithEndpoint:(id)arg1;	// IMP=0x000000000002f14a
- (id)init;	// IMP=0x000000000002f01c
