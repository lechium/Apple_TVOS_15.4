...
- (id)initWithSimualatedDevice:(id)arg1;	// IMP=0x0000000000010a53
- (id)initWithMobileDevice:(void *)arg1 andID:(id)arg2;	// IMP=0x00000000000109e9
- (id)description;	// IMP=0x00000000000107d3
- (id)init;	// IMP=0x0000000000010768
