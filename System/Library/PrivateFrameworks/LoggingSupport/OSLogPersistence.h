...
- (void).cxx_destruct;	// IMP=0x0000000000021e82
...
- (void)fetchFromStartDate:(id)arg1 toEndDate:(id)arg2;	// IMP=0x0000000000021368
- (void)enumerateFromLastBootWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002127c
- (void)enumerateFromStartDate:(id)arg1 toEndDate:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000002109e
- (_Bool)streamChunks:(CDUnknownBlockType)arg1 andEntries:(CDUnknownBlockType)arg2 flags:(unsigned int)arg3;	// IMP=0x0000000000020f73
- (void)resetWorkingState;	// IMP=0x0000000000020f72
@property(readonly, nonatomic) long long archiveState;
@property(readonly, nonatomic) long long archiveVersion;
- (_Bool)allowSensitive;	// IMP=0x0000000000020f18
- (void)dealloc;	// IMP=0x000000000002083b
- (id)init;	// IMP=0x00000000000207fb
- (void)_openFiles;	// IMP=0x0000000000020688
- (void)_openPath:(id)arg1;	// IMP=0x000000000002034d
- (void)_openLocalPersistenceDir;	// IMP=0x0000000000020134
