...
- (void).cxx_destruct;	// IMP=0x0000000000016623
...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x00000000000164f7
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x00000000000162b6
- (void)dealloc;	// IMP=0x000000000001627c
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x00000000000161fe
