...
- (void).cxx_destruct;	// IMP=0x00000000000176f0
...
- (void)enumerateChunksUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000017613
- (id)_decompressedBufferForChunk:(struct tracev3_chunk_s *)arg1 subchunk:(struct catalog_subchunk_s *)arg2;	// IMP=0x000000000001754b
- (long long)endTimeCompare:(id)arg1;	// IMP=0x0000000000017531
- (long long)oldestTimeCompare:(id)arg1;	// IMP=0x0000000000017517
- (id)initWithCatalog:(id)arg1 subchunk:(struct catalog_subchunk_s *)arg2 range:(struct _NSRange)arg3 oldestTime:(unsigned long long)arg4 endTime:(unsigned long long)arg5;	// IMP=0x00000000000174ef
- (id)initWithCatalog:(id)arg1 subchunk:(struct catalog_subchunk_s *)arg2 range:(struct _NSRange)arg3;	// IMP=0x000000000001740d
