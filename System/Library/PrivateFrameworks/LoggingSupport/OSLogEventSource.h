...
- (void).cxx_destruct;	// IMP=0x0000000000034fa2
...
- (void)_enumerateIndexFiles:(CDUnknownBlockType)arg1;	// IMP=0x0000000000034c72
- (void)_insertIndexFile:(id)arg1;	// IMP=0x0000000000034c61
- (void)dealloc;	// IMP=0x0000000000034c16
- (id)initWithCollection:(id)arg1 metadata:(id)arg2 timesync:(struct _os_timesync_db_s *)arg3;	// IMP=0x0000000000034968
