...
+ (id)activityEventFromStreamEntry:(struct os_activity_stream_entry_s *)arg1;	// IMP=0x0000000000014bf6
...
- (void)_addProperties:(id)arg1;	// IMP=0x00000000000143cd
- (void)_initWithProperties:(id)arg1;	// IMP=0x0000000000013fcf
- (id)properties;	// IMP=0x0000000000013f97
- (void)fillFromStreamEntry:(struct os_activity_stream_entry_s *)arg1 eventMessage:(const char *)arg2 persisted:(_Bool)arg3;	// IMP=0x0000000000013d6b
@property(readonly, copy, nonatomic) NSTimeZone *timezone; // @synthesize timezone=_timezone;
- (id)description;	// IMP=0x0000000000013bc8
