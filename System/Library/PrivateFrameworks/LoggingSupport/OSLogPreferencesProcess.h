...
- (void).cxx_destruct;	// IMP=0x0000000000039685
@property(readonly, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (void)reset;	// IMP=0x0000000000039639
@property(nonatomic) long long persistedLevel;
@property(nonatomic) long long enabledLevel;
- (id)_levelPrefs;	// IMP=0x000000000003943c
- (long long)defaultPersistedLevel;	// IMP=0x0000000000039302
- (long long)defaultEnabledLevel;	// IMP=0x0000000000039262
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000000038e15
