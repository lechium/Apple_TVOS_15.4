...
- (void).cxx_destruct;	// IMP=0x0000000000016def
...
- (id)copyMappedChunkStore:(id *)arg1;	// IMP=0x0000000000016da3
- (_Bool)_determineTimespan;	// IMP=0x0000000000016be4
- (_Bool)_loadCatalogMetadataForTimespan;	// IMP=0x00000000000169bd
- (_Bool)_loadHeaderMetadata:(id)arg1;	// IMP=0x00000000000168f7
- (void)dealloc;	// IMP=0x00000000000168bd
- (id)initWithChunkStore:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000167ff
- (id)initWithTraceFile:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000166ca
