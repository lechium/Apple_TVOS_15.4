...
- (void).cxx_destruct;	// IMP=0x0000000000017e1d
...
- (void)enumerateSubchunksUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000017b4a
- (void)unionWithRange:(struct _NSRange)arg1;	// IMP=0x0000000000017b25
...
- (void)dealloc;	// IMP=0x0000000000017ab4
- (id)initWithStore:(id)arg1 index:(id)arg2 fileHeader:(struct tracev3_chunk_s *)arg3 range:(struct _NSRange)arg4 chunk:(struct tracev3_chunk_s *)arg5;	// IMP=0x00000000000179c5
