...
+ (id)_make;	// IMP=0x000000000000c700
...
- (id)formatArguments;	// IMP=0x000000000000edb0
...
- (unsigned long long)processUniqueIdentifier;	// IMP=0x000000000000e7b3
...
- (id)description;	// IMP=0x000000000000e13d
- (void)_fillFromXPCEventObject:(id)arg1;	// IMP=0x000000000000dc08
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000000dbe7
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000000dbe4
- (_Bool)_setLogEvent:(CDStruct_c6d697a1 *)arg1 rangeUUIDIndex:(unsigned long long)arg2 machTimebase:(struct mach_timebase_info *)arg3;	// IMP=0x000000000000c9d7
- (void)_setBuffer:(const void *)arg1 size:(unsigned long long)arg2 privateBuffer:(const void *)arg3 privateSize:(unsigned long long)arg4;	// IMP=0x000000000000c990
- (void)_setDoNotTrackActivites:(_Bool)arg1;	// IMP=0x000000000000c986
- (void)_setFallbackTimezone;	// IMP=0x000000000000c91b
- (void)_setUUIDDBFileDescriptor:(int)arg1;	// IMP=0x000000000000c914
- (void)_setTimesyncDatabase:(struct _os_timesync_db_s *)arg1;	// IMP=0x000000000000c90c
- (_Bool)_shouldIncludeSensitive;	// IMP=0x000000000000c905
- (void)_setIncludeSensitive:(_Bool)arg1;	// IMP=0x000000000000c8fe
- (void)_setThreadCrumb;	// IMP=0x000000000000c8e0
- (void)_assertBalanced;	// IMP=0x000000000000c8cb
- (oneway void)release;	// IMP=0x000000000000c87c
- (id)retain;	// IMP=0x000000000000c82a
- (id)init;	// IMP=0x000000000000c81a
- (oneway void)_unmake;	// IMP=0x000000000000c74c
