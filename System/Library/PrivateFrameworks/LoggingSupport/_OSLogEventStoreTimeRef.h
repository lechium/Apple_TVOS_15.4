...
+ (id)timeRef;	// IMP=0x000000000004786c
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004791a
- (id)initWithUUID:(unsigned char [16])arg1 continuous:(unsigned long long)arg2;	// IMP=0x00000000000478eb
