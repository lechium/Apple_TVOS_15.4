...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0000000000002b4a
- (void).cxx_destruct;	// IMP=0x0000000000002b17
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x0000000000002a1d
