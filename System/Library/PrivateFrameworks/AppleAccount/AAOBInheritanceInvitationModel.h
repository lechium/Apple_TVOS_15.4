...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003a2eb
- (void).cxx_destruct;	// IMP=0x000000000003a568
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a1fc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039fda
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000039ed6
- (id)initWithBenefactorHandle:(id)arg1;	// IMP=0x0000000000039ce6
- (id)initWithBenefactorName:(id)arg1 handle:(id)arg2;	// IMP=0x0000000000039b3d
