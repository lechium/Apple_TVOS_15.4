...
- (void).cxx_destruct;	// IMP=0x0000000000071942
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000718dd
@property(readonly, copy) NSString *description;
- (void)cancel;	// IMP=0x00000000000717b1
- (void)resume;	// IMP=0x000000000007170d
- (void)suspend;	// IMP=0x0000000000071607
- (void)_invokeCompletionWithData:(id)arg1 response:(id)arg2 error:(id)arg3;	// IMP=0x00000000000714de
- (void)_initiateSessionTaskWithConfiguration:(id)arg1;	// IMP=0x000000000007115f
- (void)_unfairLock_initiateConfigurationTask;	// IMP=0x0000000000070fe0
- (id)initWithSession:(id)arg1 request:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000070da4
- (id)init;	// IMP=0x0000000000070d79
