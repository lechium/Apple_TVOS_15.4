...
- (void).cxx_destruct;	// IMP=0x00000000000582e3
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000000005821a
- (void)URLSession:(id)arg1 didBecomeInvalidWithError:(id)arg2;	// IMP=0x0000000000058196
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000000000580f4
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000058090
- (id)init;	// IMP=0x000000000005807c
