...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005adda
- (void).cxx_destruct;	// IMP=0x000000000005aeab
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005ade2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005ad26
- (id)initWithCustodianID:(id)arg1 didAccept:(_Bool)arg2;	// IMP=0x000000000005acac
