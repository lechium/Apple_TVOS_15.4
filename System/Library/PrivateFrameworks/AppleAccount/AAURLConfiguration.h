...
+ (void)setRemoteServer:(id)arg1;	// IMP=0x000000000003fab8
+ (id)remoteServer;	// IMP=0x000000000003fa47
+ (long long)beneficiaryDurationBeforeNotSetupCFU;	// IMP=0x0000000000040ffe
+ (long long)beneficiaryStaleInviteDuration;	// IMP=0x0000000000040f12
+ (void)reset;	// IMP=0x00000000000403dc
+ (id)_urlConfigurationWithError:(id *)arg1;	// IMP=0x00000000000400e6
+ (id)itemForKey:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003ff3c
+ (id)urlConfiguration;	// IMP=0x000000000003ff28
- (void).cxx_destruct;	// IMP=0x000000000003ff18
- (id)description;	// IMP=0x000000000003fea3
@property(readonly, copy, nonatomic) NSNumber *baaInterval;
@property(readonly, copy, nonatomic) NSNumber *absintheEnable;
- (id)urlForEndpoint:(id)arg1;	// IMP=0x000000000003fc83
- (id)_initWithDictionary:(id)arg1;	// IMP=0x000000000003fb93
- (id)init;	// IMP=0x000000000003fb68
...
- (id)_urlStringForKey:(id)arg1;	// IMP=0x00000000000405ac
@property(readonly, nonatomic) NSString *apsEnvironment;
- (id)_envStringForKey:(id)arg1;	// IMP=0x0000000000040472
