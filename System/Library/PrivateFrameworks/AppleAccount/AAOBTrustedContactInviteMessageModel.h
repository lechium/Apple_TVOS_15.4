...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000045f35
- (void).cxx_destruct;	// IMP=0x00000000000461ca
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000045b90
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000045a5e
- (id)initWithType:(unsigned long long)arg1 recipientHandle:(id)arg2;	// IMP=0x0000000000045925
- (id)initWithRecipientHandle:(id)arg1;	// IMP=0x000000000004590e
