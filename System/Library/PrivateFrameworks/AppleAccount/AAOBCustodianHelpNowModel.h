...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000089b6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000088b2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000008676
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000857d
- (id)initWithRecoveryCode:(id)arg1 ownerName:(id)arg2;	// IMP=0x0000000000008463
