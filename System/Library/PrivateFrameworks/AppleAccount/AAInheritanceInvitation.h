...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000028629
- (void).cxx_destruct;	// IMP=0x0000000000028859
...
- (id)description;	// IMP=0x0000000000028778
- (id)_statusDescription;	// IMP=0x0000000000028704
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028631
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028558
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000283b4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000282cd
- (id)initWithBeneficiaryID:(id)arg1 beneficiaryHandle:(id)arg2 beneficiaryFirstName:(id)arg3 beneficiaryLastName:(id)arg4 beneficiaryDisplayName:(id)arg5 status:(long long)arg6;	// IMP=0x00000000000281c1
- (id)initWithBeneficiaryID:(id)arg1 beneficiaryHandle:(id)arg2;	// IMP=0x00000000000281a0
