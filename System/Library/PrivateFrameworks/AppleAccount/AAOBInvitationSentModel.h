...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003bbe6
- (void).cxx_destruct;	// IMP=0x000000000003be62
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003bae2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003b8a6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003b7ad
- (id)initWithType:(long long)arg1 recipientHandle:(id)arg2;	// IMP=0x000000000003b69a
