...
- (void).cxx_destruct;	// IMP=0x000000000001ce26
...
- (id)_deviceSpecificLocalizedString:(id)arg1;	// IMP=0x000000000001cc69
- (id)_stringWithDescriptionForResponseError:(id)arg1;	// IMP=0x000000000001cb4c
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2 bodyIsPlist:(_Bool)arg3;	// IMP=0x000000000001bf8c
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x000000000001bf74
- (void)_parseJSONResponse:(id)arg1;	// IMP=0x000000000001bc52
- (void)_parsePlistResponse:(id)arg1;	// IMP=0x000000000001b92c
