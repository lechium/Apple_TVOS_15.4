...
- (void).cxx_destruct;	// IMP=0x00000000000435b1
...
- (id)contacts;	// IMP=0x00000000000434cb
- (id)initWithContacts:(id)arg1;	// IMP=0x0000000000043471
- (id)init;	// IMP=0x00000000000433aa
