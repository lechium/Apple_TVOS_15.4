...
- (void).cxx_destruct;	// IMP=0x000000000005db7e
...
- (id)detailTextForShareAccessKeyType:(unsigned long long)arg1;	// IMP=0x000000000005da28
- (id)titleForShareAccessKeyType:(unsigned long long)arg1;	// IMP=0x000000000005d9f3
- (void)availableSharingOptionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000005d7f9
- (id)availableSharingOptions;	// IMP=0x000000000005d7ec
- (id)defaultSharingOptions;	// IMP=0x000000000005d7df
- (id)initWithBeneficiaryName:(id)arg1 handle:(id)arg2;	// IMP=0x000000000005d6a6
- (id)initWithBeneficiaryName:(id)arg1;	// IMP=0x000000000005d68d
