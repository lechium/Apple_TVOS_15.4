...
- (void).cxx_destruct;	// IMP=0x0000000000007855
...
- (void)paradeContentViewController:(id)arg1 didSelectAction:(id)arg2 forItem:(id)arg3;	// IMP=0x0000000000007700
- (void)paradeBackgroundViewControllerDidFinish:(id)arg1;	// IMP=0x00000000000076a6
- (void)paradeBackgroundViewControllerContentStateDidChange:(id)arg1;	// IMP=0x0000000000007599
- (void)_configureContentGradientViewWithImage:(id)arg1;	// IMP=0x0000000000007364
- (void)_updateStandardTitleView;	// IMP=0x0000000000006c77
- (_Bool)_promotionVideoIsPlaying;	// IMP=0x0000000000006c59
- (void)_updateActionsDetailsViewAlpha;	// IMP=0x0000000000006bd4
- (void)_updateStandardAndPromotionTitleViewAlpha;	// IMP=0x0000000000006abe
- (id)initWithContentOptions:(unsigned long long)arg1;	// IMP=0x0000000000005b48
