...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000010c00
- (id)preferredFocusEnvironments;	// IMP=0x0000000000010b86
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000010714
