...
- (void).cxx_destruct;	// IMP=0x000000000001b622
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000001b5ef
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001b3d4
