...
- (_Bool)_isSupportedCharacterSetForFont:(id)arg1 string:(id)arg2;	// IMP=0x00000000000026be
- (void)setText:(id)arg1;	// IMP=0x0000000000002538
- (double)_firstBaselineOffsetFromTop;	// IMP=0x00000000000023a3
- (void)drawTextInRect:(struct CGRect)arg1;	// IMP=0x000000000000232b
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000022ce
