...
- (void).cxx_destruct;	// IMP=0x000000000002e14e
...
- (void)_updateTextLabelText:(_Bool)arg1;	// IMP=0x000000000002dfe7
- (void)_applicationDidBecomeActive;	// IMP=0x000000000002dfd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002d471
