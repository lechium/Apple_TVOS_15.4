...
- (void).cxx_destruct;	// IMP=0x000000000000faba
...
- (_Bool)canBecomeFocused;	// IMP=0x000000000000f8c4
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000f7f1
- (id)preferredFocusEnvironments;	// IMP=0x000000000000f786
- (void)updateContentRating:(id)arg1;	// IMP=0x000000000000f638
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000d9c0
