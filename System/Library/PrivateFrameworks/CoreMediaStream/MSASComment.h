...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009b494
+ (id)comment;	// IMP=0x000000000009b482
+ (id)MSASPCommentFromProtocolDictionary:(id)arg1;	// IMP=0x00000000000dbbc1
- (void).cxx_destruct;	// IMP=0x000000000009b40d
...
- (id)description;	// IMP=0x000000000009acd0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009aa10
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009a71f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009a64d
- (unsigned long long)hash;	// IMP=0x000000000009a609
- (id)init;	// IMP=0x000000000009a539
