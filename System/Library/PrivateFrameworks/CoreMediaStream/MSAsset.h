...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001b24b
+ (id)assetWithAsset:(id)arg1;	// IMP=0x000000000001ae76
+ (id)asset;	// IMP=0x000000000001ae64
+ (id)MSASPAssetFromProtocolDictionary:(id)arg1;	// IMP=0x00000000000da731
- (void).cxx_destruct;	// IMP=0x000000000001ad99
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001aa42
- (id)metadataValueForKey:(id)arg1;	// IMP=0x000000000001a9b6
- (void)addMetadataValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000001a9a4
- (void)setMetadataValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000001a8c0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001a402
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001a0d2
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000019e7e
- (unsigned long long)_fileSizeOnDisk;	// IMP=0x0000000000019c95
- (void)setMMCSAccessHeader:(id)arg1 andTimeStamp:(id)arg2;	// IMP=0x0000000000019c29
- (id)MMCSItemType;	// IMP=0x0000000000019aaa
- (int)MMCSOpenNewFileDescriptor;	// IMP=0x0000000000019a18
@property(nonatomic) unsigned long long MMCSItemID;
@property(nonatomic) unsigned int MMCSItemFlags;
- (unsigned long long)_fileSize;	// IMP=0x000000000001983f
- (_Bool)isVideo;	// IMP=0x0000000000019827
- (_Bool)isPhoto;	// IMP=0x0000000000019810
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000000019429
- (id)initWithGUID:(id)arg1;	// IMP=0x00000000000193af
...
- (id)MSASPProtocolDictionary;	// IMP=0x00000000000d9e01
