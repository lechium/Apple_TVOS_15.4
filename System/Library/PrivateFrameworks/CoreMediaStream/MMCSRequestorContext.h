...
+ (id)contextWithEngine:(id)arg1 type:(int)arg2;	// IMP=0x0000000000086665
- (void).cxx_destruct;	// IMP=0x0000000000086657
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000865ae
- (void)dealloc;	// IMP=0x0000000000086536
- (id)initWithEngine:(id)arg1 type:(int)arg2;	// IMP=0x00000000000864c7
