...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001bc78
+ (id)collectionWithMasterAsset:(id)arg1 fileName:(id)arg2 derivedAssets:(id)arg3;	// IMP=0x000000000001bbea
+ (id)collectionWithMasterAsset:(id)arg1 fileName:(id)arg2;	// IMP=0x000000000001bb7b
- (void).cxx_destruct;	// IMP=0x000000000001bb27
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b854
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b72f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b67b
- (id)description;	// IMP=0x000000000001b529
@property(retain, nonatomic) NSArray *derivedAssets;
@property(readonly, nonatomic) __weak NSData *masterAssetHash;
- (id)initWithMasterAsset:(id)arg1 fileName:(id)arg2 derivedAssets:(id)arg3;	// IMP=0x000000000001b253
