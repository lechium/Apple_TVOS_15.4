...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000099fdb
+ (id)MSASPSharingRelationshipFromProtocolDictionary:(id)arg1;	// IMP=0x00000000000daf4f
- (void).cxx_destruct;	// IMP=0x0000000000099f5b
...
- (id)description;	// IMP=0x0000000000099b7d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009983f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009969d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000099458
- (_Bool)isEqualToSharingRelationship:(id)arg1;	// IMP=0x0000000000098fb3
- (id)_fullName;	// IMP=0x0000000000098fa5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000098ed3
- (unsigned long long)hash;	// IMP=0x0000000000098ebd
- (id)init;	// IMP=0x0000000000098e85
