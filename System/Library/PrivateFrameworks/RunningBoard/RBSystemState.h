...
- (void).cxx_destruct;	// IMP=0x000000000003880a
...
- (id)description;	// IMP=0x000000000003873c
- (unsigned long long)hash;	// IMP=0x0000000000038693
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003855c
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000384b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000384ab
- (id)_init;	// IMP=0x000000000003847c
