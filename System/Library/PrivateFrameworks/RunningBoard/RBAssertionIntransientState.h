...
- (void).cxx_destruct;	// IMP=0x000000000001b9be
...
- (id)description;	// IMP=0x000000000001b74d
@property(readonly, nonatomic) NSMutableSet *sourceEnvironments; // @synthesize sourceEnvironments=_sourceEnvironments;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b5a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b4c7
