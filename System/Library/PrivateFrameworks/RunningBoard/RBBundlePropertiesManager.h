...
- (void).cxx_destruct;	// IMP=0x000000000007332d
- (id)captureState;	// IMP=0x000000000007331b
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)bundlePropertiesProvider:(id)arg1 didChangePropertiesForProcessIdentities:(id)arg2;	// IMP=0x00000000000732f0
- (void)removeProcess:(id)arg1;	// IMP=0x0000000000073257
- (void)addProcess:(id)arg1;	// IMP=0x0000000000073203
- (id)propertiesForIdentity:(id)arg1 identifier:(id)arg2;	// IMP=0x00000000000730fa
@property(readonly, copy) NSString *debugDescription;
@property(nonatomic) __weak id <RBBundlePropertiesManagerDelegate> delegate;
- (id)init;	// IMP=0x0000000000072f0c
