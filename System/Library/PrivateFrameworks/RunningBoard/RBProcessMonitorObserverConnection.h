...
- (void).cxx_destruct;	// IMP=0x0000000000059d73
@property(readonly, copy) NSString *description;
- (void)sendMessage:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000059cd2
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000059c67
