...
- (void)_resolveSystemState;	// IMP=0x000000000005f6eb
- (void)_finalizeStateChangeSet;	// IMP=0x000000000005f45e
- (void)_resolveProcessStateForTarget:(id)arg1 ofType:(unsigned long long)arg2 viaAssertion:(id)arg3;	// IMP=0x000000000005ee75
- (void)_suspendOrResumeAssertionsForTarget:(id)arg1 oldState:(id)arg2 newState:(id)arg3;	// IMP=0x000000000005e88b
- (id)_latestStateForIdentity:(id)arg1;	// IMP=0x000000000005e7f8
- (id)_originatorInheritancesForAssertion:(id)arg1;	// IMP=0x000000000005e796
- (id)_inheritancesForOriginator:(id)arg1;	// IMP=0x000000000005e368
- (void)_updateStatesForAssertion:(id)arg1;	// IMP=0x000000000005dd2a
- (void)_assertionGraphFromAssertion:(id)arg1 graph:(id)arg2;	// IMP=0x000000000005d8cb
- (id)_assertionGraphFromAssertion:(id)arg1;	// IMP=0x000000000005d853
