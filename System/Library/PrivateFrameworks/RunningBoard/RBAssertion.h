...
+ (id)assertionWithIdentifier:(id)arg1 target:(id)arg2 explanation:(id)arg3 attributes:(id)arg4 originator:(id)arg5 context:(id)arg6;	// IMP=0x000000000003c515
+ (id)assertionWithDescriptor:(id)arg1 target:(id)arg2 originator:(id)arg3 context:(id)arg4 creationTime:(double)arg5;	// IMP=0x000000000003bea6
+ (id)assertionWithDescriptor:(id)arg1 target:(id)arg2 originator:(id)arg3 context:(id)arg4;	// IMP=0x000000000003bd7b
- (void).cxx_destruct;	// IMP=0x000000000003d67d
...
- (id)captureState;	// IMP=0x000000000003d5f5
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
@property(readonly, copy) NSString *debugDescription;
- (void)applyToSystemState:(id)arg1 withAttributeContext:(id)arg2;	// IMP=0x000000000003d299
- (void)applyToAssertionTransientState:(id)arg1 withAttributeContext:(id)arg2;	// IMP=0x000000000003d211
- (void)applyToProcessState:(id)arg1 withAttributeContext:(id)arg2;	// IMP=0x000000000003d12b
- (id)updateProcessStateWithAttributeContext:(id)arg1;	// IMP=0x000000000003d0fd
- (_Bool)resolveStateWithContext:(id)arg1;	// IMP=0x000000000003cbf9
...
- (unsigned long long)maxCPUUsageViolationPolicyForRole:(unsigned char)arg1;	// IMP=0x000000000003c8eb
...
- (void)resume;	// IMP=0x000000000003c71c
- (void)suspend;	// IMP=0x000000000003c657
- (void)deactivate;	// IMP=0x000000000003c62c
- (void)activate;	// IMP=0x000000000003c601
