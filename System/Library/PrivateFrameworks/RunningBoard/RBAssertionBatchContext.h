...
+ (id)contextForProcess:(id)arg1 acquisitionCompletionPolicy:(unsigned long long)arg2 withDescriptorsToAcquire:(id)arg3 identifiersToInvalidate:(id)arg4 daemonContext:(id)arg5;	// IMP=0x000000000001c17c
+ (id)contextForProcess:(id)arg1 withDescriptorsToAcquire:(id)arg2 identifiersToInvalidate:(id)arg3 daemonContext:(id)arg4;	// IMP=0x000000000001bd94
- (void).cxx_destruct;	// IMP=0x000000000001c536
...
- (id)acquisitionContextForDescriptor:(id)arg1;	// IMP=0x000000000001c42a
- (id)_init;	// IMP=0x000000000001c3fb
