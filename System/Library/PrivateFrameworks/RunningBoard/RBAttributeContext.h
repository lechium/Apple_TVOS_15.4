...
- (void).cxx_destruct;	// IMP=0x0000000000026e1b
...
- (void)popActiveDueToInheritedEndowment;	// IMP=0x0000000000026d0d
- (void)pushActiveDueToInheritedEndowment;	// IMP=0x0000000000026d03
