...
- (void).cxx_destruct;	// IMP=0x000000000005d7f4
...
- (id)assertionDescriptorsWithFlattenedAttributes:(_Bool)arg1;	// IMP=0x000000000005d23d
- (id)resolveForAssertions:(id)arg1;	// IMP=0x000000000005cd85
