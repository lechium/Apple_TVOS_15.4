...
+ (id)context;	// IMP=0x000000000001f1e1
- (void).cxx_destruct;	// IMP=0x000000000001f737
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f47a
...
- (void)setTargetProperties:(id)arg1;	// IMP=0x000000000001f280
- (void)setTargetProcess:(id)arg1;	// IMP=0x000000000001f26f
@property(readonly, nonatomic) _Bool ignoreRestrictions;
- (void)popIgnoreRestrictions;	// IMP=0x000000000001f204
- (void)pushIgnoreRestrictions;	// IMP=0x000000000001f1fa
