...
- (void).cxx_destruct;	// IMP=0x0000000000059a80
@property(readonly, nonatomic) __weak id <RBClientInheritanceManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (id)description;	// IMP=0x00000000000596d8
- (void)setInheritances:(id)arg1;	// IMP=0x0000000000059369
- (id)init;	// IMP=0x00000000000592e2
- (id)initWithInheritances:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000005920f
