...
- (void).cxx_destruct;	// IMP=0x000000000001de1e
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001dd79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001dd6e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001dcc4
- (unsigned long long)hash;	// IMP=0x000000000001dcae
- (id)debugDescription;	// IMP=0x000000000001d87d
- (id)description;	// IMP=0x000000000001d7b8
- (id)clientStateForProcess:(id)arg1;	// IMP=0x000000000001d574
- (_Bool)isEqualToProcessStateIgnoringInheritances:(id)arg1;	// IMP=0x000000000001d51b
- (_Bool)isEqualToProcessStateIgnoringIdentity:(id)arg1;	// IMP=0x000000000001d4a5
- (_Bool)isAppNapEqualToProcessState:(id)arg1;	// IMP=0x000000000001d1fa
- (id)minCPUUsageLimitsForRole:(unsigned char)arg1;	// IMP=0x000000000001d193
- (id)maxCPUUsageLimitsForRole:(unsigned char)arg1;	// IMP=0x000000000001d12c
- (id)inheritancesForEnvironment:(id)arg1;	// IMP=0x000000000001d116
...
- (id)initWithIdentity:(id)arg1;	// IMP=0x000000000001cba7
- (id)init;	// IMP=0x000000000001cb20
