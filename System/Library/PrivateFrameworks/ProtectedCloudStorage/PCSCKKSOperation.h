...
+ (id)operation:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000033bc5
- (void).cxx_destruct;	// IMP=0x00000000000343a5
...
- (void)completeOperation;	// IMP=0x000000000003426a
- (_Bool)startOperation;	// IMP=0x00000000000341d1
- (_Bool)checkDependencies;	// IMP=0x0000000000033d30
- (void)addSuccessDependency:(id)arg1;	// IMP=0x0000000000033c51
