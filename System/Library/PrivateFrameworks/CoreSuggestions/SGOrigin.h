...
+ (id)originWithType:(unsigned long long)arg1 sourceKey:(id)arg2 externalKey:(id)arg3 fromForwardedMessage:(_Bool)arg4;	// IMP=0x000000000003a95f
+ (id)originWithType:(unsigned long long)arg1 sourceKey:(id)arg2 externalKey:(id)arg3 bundleId:(id)arg4 fromForwardedMessage:(_Bool)arg5;	// IMP=0x000000000003a8b5
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003a8ad
- (void).cxx_destruct;	// IMP=0x000000000003a50f
...
- (id)universalURL;	// IMP=0x000000000003a39b
...
- (unsigned long long)hash;	// IMP=0x000000000003a232
- (_Bool)isEqualToOrigin:(id)arg1;	// IMP=0x0000000000039fda
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000039f72
@property(readonly, nonatomic) NSURL *url;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000039ba5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039621
- (void)_resolveAppName;	// IMP=0x0000000000039588
- (id)initWithType:(unsigned long long)arg1 sourceKey:(id)arg2 externalKey:(id)arg3 bundleId:(id)arg4 fromForwardedMessage:(_Bool)arg5;	// IMP=0x0000000000039406
- (id)init;	// IMP=0x00000000000393c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000393bc
