...
+ (void)clearFollowUpWithClientID:(id)arg1;	// IMP=0x00000000000042c2
- (void).cxx_destruct;	// IMP=0x00000000000047f8
...
- (id)_constructFollowUp;	// IMP=0x00000000000043cd
- (void)clearFollowUp;	// IMP=0x000000000000418a
- (void)presentFollowUp;	// IMP=0x0000000000004022
- (id)initWithStyle:(long long)arg1 clientIdentifier:(id)arg2 itemIdentifier:(id)arg3 url:(id)arg4 title:(id)arg5 notificationInfo:(id)arg6 userInfo:(id)arg7;	// IMP=0x0000000000003ec9
