...
+ (id)_dmdKeysToRequestToGetItems:(id)arg1;	// IMP=0x000000000002063f
+ (id)_itemKeyToDMDKeyMappingTable;	// IMP=0x0000000000020478
- (void).cxx_destruct;	// IMP=0x000000000002114a
...
- (id)_appDictionaryFromApp:(id)arg1;	// IMP=0x0000000000020882
- (void)_createAppItems;	// IMP=0x00000000000201d7
- (void)_executeRequest;	// IMP=0x000000000002002e
- (void)_createKeysForRequest;	// IMP=0x000000000001ffa8
- (void)_createRequest;	// IMP=0x000000000001fe7d
- (void)fetchAppItems;	// IMP=0x000000000001fe42
