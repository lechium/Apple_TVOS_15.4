...
- (void).cxx_destruct;	// IMP=0x000000000004117e
...
- (id)initWithConnection:(id)arg1 indexer:(id)arg2;	// IMP=0x0000000000040e16
- (id)initWithConfiguration:(id)arg1 indexer:(id)arg2;	// IMP=0x0000000000040a4d
