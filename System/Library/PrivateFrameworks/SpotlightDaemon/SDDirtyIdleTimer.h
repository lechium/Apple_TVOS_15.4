...
- (void).cxx_destruct;	// IMP=0x000000000003b2c1
...
- (void)cancel;	// IMP=0x000000000003b13e
- (void)dirty;	// IMP=0x000000000003ad14
- (void)_stop;	// IMP=0x000000000003ac8f
- (id)description;	// IMP=0x000000000003ac2c
- (id)initWithQueue:(id)arg1 timeoutBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ab7e
