...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006964e
- (unsigned long long)hash;	// IMP=0x0000000000069640
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x000000000006950f
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x00000000000693a0
