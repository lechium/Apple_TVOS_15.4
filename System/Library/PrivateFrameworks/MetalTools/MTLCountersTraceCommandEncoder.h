...
- (void)endEncoding;	// IMP=0x000000000002a4a8
- (void)setLabel:(id)arg1;	// IMP=0x000000000002a482
- (void)popDebugGroup;	// IMP=0x000000000002a413
- (void)pushDebugGroup:(id)arg1;	// IMP=0x000000000002a3ed
- (void)insertDebugSignpost:(id)arg1;	// IMP=0x000000000002a1f2
- (id)init:(struct BinaryBuffer *)arg1 flags:(unsigned long long)arg2;	// IMP=0x000000000002a194
