...
- (void).cxx_destruct;	// IMP=0x00000000001257ef
...
- (void)_getHasSubscriptionPlaybackCapabilityForUserIdentity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000125711
- (void)loadReportingIdentityPropertiesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012551e
- (id)initWithPlaybackRequestEnvironment:(id)arg1;	// IMP=0x00000000001254ab
