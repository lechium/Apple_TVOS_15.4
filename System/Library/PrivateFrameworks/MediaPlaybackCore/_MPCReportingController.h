...
- (void).cxx_destruct;	// IMP=0x000000000018c6f2
...
- (void)environmentMonitorDidChangeNetworkType:(id)arg1;	// IMP=0x000000000018c59d
- (void)reportUserSeekFromTime:(double)arg1 toTime:(double)arg2;	// IMP=0x000000000018c4f8
- (void)recordLyricsViewEvent:(id)arg1;	// IMP=0x000000000018c4e2
- (void)dealloc;	// IMP=0x000000000018c46d
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x000000000018c1c5
