...
- (void).cxx_destruct;	// IMP=0x00000000000955f4
...
- (_Bool)_configureItem:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000950a4
- (void)main;	// IMP=0x0000000000094953
- (_Bool)isFinished;	// IMP=0x0000000000094943
- (_Bool)isExecuting;	// IMP=0x0000000000094933
- (void)start;	// IMP=0x0000000000094719
- (id)initWithPlayerItem:(id)arg1 configurator:(id)arg2 delegate:(id)arg3 token:(long long)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x00000000000945ea
