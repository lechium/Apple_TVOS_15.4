...
- (void).cxx_destruct;	// IMP=0x00000000001051f8
...
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x00000000001050fe
- (unsigned long long)numberOfItemsInSection:(unsigned long long)arg1;	// IMP=0x0000000000105009
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000104f7e
- (unsigned long long)numberOfSections;	// IMP=0x0000000000104f03
- (id)displayIndexPathForStructuredIndexPath:(id)arg1;	// IMP=0x000000000010497f
- (id)structuredIndexPathForDisplayIndexPath:(id)arg1;	// IMP=0x0000000000104667
- (id)initWithTracklistItems:(id)arg1 playingItemIndexPath:(id)arg2;	// IMP=0x0000000000103d44
