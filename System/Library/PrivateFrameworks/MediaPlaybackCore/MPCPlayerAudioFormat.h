...
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x000000000017c499
- (void).cxx_destruct;	// IMP=0x00000000001761ab
...
- (id)analyticsFormatInfo;	// IMP=0x0000000000175efc
- (id)_descriptionForChannelLayoutTag:(unsigned int)arg1;	// IMP=0x0000000000175d6d
- (_Bool)_isHLSVersion:(id)arg1 greatherThanOrEqualTo:(id)arg2;	// IMP=0x0000000000175cf0
- (unsigned int)_computedChannelLayoutTagFromHLSData:(id)arg1 channelCount:(long long)arg2;	// IMP=0x0000000000175bc0
- (long long)_computedTierFromHLSDataWithChannelCount:(long long)arg1;	// IMP=0x0000000000175b7c
- (_Bool)_isBinauralFormat:(id)arg1;	// IMP=0x0000000000175b27
- (_Bool)_isDerivedFromSpatialFormat:(id)arg1;	// IMP=0x0000000000175ad9
- (_Bool)_isMultichannelFormat:(id)arg1;	// IMP=0x0000000000175a16
- (_Bool)_isSpatialFormat:(id)arg1;	// IMP=0x0000000000175985
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001757aa
- (id)debugOriginChannelLayoutDescription;	// IMP=0x0000000000175795
@property(readonly, nonatomic) NSString *debugChannelLayoutDescription;
- (id)debugOriginChannelCountDescription;	// IMP=0x000000000017575e
...
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000001749e6
@property(readonly, nonatomic) MPNowPlayingInfoAudioFormat *nowPlayingAudioFormat;
- (id)initWithNowPlayingInfoAudioFormat:(id)arg1;	// IMP=0x00000000001746df
- (id)initWithJSONDictionaryRepresentation:(id)arg1 stableVariantID:(id)arg2;	// IMP=0x000000000017425f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000174254
- (id)mpc_jsonValue;	// IMP=0x000000000017a4bf
