...
+ (void)identityPropertySetFromRequestContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000003935d
- (void).cxx_destruct;	// IMP=0x0000000000039335
...
- (id)initWithIdentityProperties:(id)arg1 delegatedIdentityProperties:(id)arg2;	// IMP=0x000000000003924a
