...
- (void).cxx_destruct;	// IMP=0x00000000000e1635
...
- (id)remove;	// IMP=0x00000000000e1604
- (id)initWithModelGenericObject:(id)arg1 sectionIndex:(long long)arg2 response:(id)arg3;	// IMP=0x00000000000e14fd
