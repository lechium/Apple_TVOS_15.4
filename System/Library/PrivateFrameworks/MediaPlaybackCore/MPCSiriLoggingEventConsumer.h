...
+ (id)identifier;	// IMP=0x00000000000e913f
- (void).cxx_destruct;	// IMP=0x00000000000e91f3
...
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x00000000000e91cf
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x00000000000e914c
