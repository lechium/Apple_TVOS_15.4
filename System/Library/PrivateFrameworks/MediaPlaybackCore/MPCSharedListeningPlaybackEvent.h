...
- (void).cxx_destruct;	// IMP=0x00000000000f7628
...
- (id)description;	// IMP=0x00000000000f753c
- (id)initWithKind:(long long)arg1 item:(id)arg2;	// IMP=0x00000000000f74c6
- (id)initWithKind:(long long)arg1;	// IMP=0x00000000000f74b2
