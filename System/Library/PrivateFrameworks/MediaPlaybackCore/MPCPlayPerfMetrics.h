...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x00000000001b1eaf
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x00000000001b034d
- (void).cxx_destruct;	// IMP=0x00000000001b025c
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x00000000001b0195
- (void)addAssetLoadInfoWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x00000000001af4d4
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x00000000001af44a
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x00000000001af260
- (void)addQueueMetadata:(id)arg1;	// IMP=0x00000000001af1b2
- (id)humanDescription;	// IMP=0x00000000001ae462
- (id)description;	// IMP=0x00000000001ae37e
...
- (id)init;	// IMP=0x00000000001ad9a9
