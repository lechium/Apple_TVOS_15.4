...
- (void).cxx_destruct;	// IMP=0x0000000000095eed
...
- (id)stringRepresentation;	// IMP=0x0000000000095e87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000095dd4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000095d1d
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x0000000000095c37
