...
- (void).cxx_destruct;	// IMP=0x0000000000095bf7
...
- (void)cancelLoading;	// IMP=0x0000000000095b6e
- (void)loadAssetFor:(id)arg1 token:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000958cd
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000095809
