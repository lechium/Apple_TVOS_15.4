...
- (void).cxx_destruct;	// IMP=0x00000000000b1458
...
- (void)_activeUserDidChangeNotification:(id)arg1;	// IMP=0x00000000000b1200
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x00000000000b11e3
- (void)_allowsExplicitContentDidChangeNotification:(id)arg1;	// IMP=0x00000000000b11c6
- (id)equivalencySourceStoreAdamIDForLocalStoreAdamID:(long long)arg1;	// IMP=0x00000000000b114f
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(long long)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b1132
- (void)_invalidate;	// IMP=0x00000000000b10d6
- (void)dealloc;	// IMP=0x00000000000b1090
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 networkingTime:(double)arg3;	// IMP=0x00000000000b0ed5
