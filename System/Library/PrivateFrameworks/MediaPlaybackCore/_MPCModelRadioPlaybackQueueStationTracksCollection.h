...
- (void).cxx_destruct;	// IMP=0x00000000001961b6
...
- (id)trackForItemAtIndex:(long long)arg1;	// IMP=0x000000000019611e
- (long long)removeExplicitItems;	// IMP=0x0000000000195fd1
- (void)removeAllItems;	// IMP=0x0000000000195f34
@property(readonly, nonatomic) long long numberOfItems;
- (_Bool)isExplicitItemAtIndex:(long long)arg1;	// IMP=0x0000000000195d82
- (id)AVItemAtIndex:(long long)arg1;	// IMP=0x0000000000195ab0
- (void)updateWithPersonalizedResponse:(id)arg1;	// IMP=0x00000000001952d2
@property(readonly, nonatomic) ICMutableRadioPlaybackHistory *playbackHistory;
- (id)initWithPlaybackContext:(id)arg1;	// IMP=0x00000000001951f9
