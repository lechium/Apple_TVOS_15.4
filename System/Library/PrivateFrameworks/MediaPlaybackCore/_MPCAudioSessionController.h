...
- (void)tearDownObservations;	// IMP=0x0000000000005321
- (void)setupObservations;	// IMP=0x0000000000005101
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x0000000000005093
- (void)snapshotSessionSettings;	// IMP=0x0000000000004fa6
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x0000000000004f17
- (void)dealloc;	// IMP=0x0000000000004ed9
- (id)init;	// IMP=0x0000000000004e4c
