...
+ (id)enumeratorWithQueueController:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x000000000011f709
- (void).cxx_destruct;	// IMP=0x000000000011f5ee
...
- (void)_buildEnumerator;	// IMP=0x000000000011f051
- (id)_init;	// IMP=0x000000000011f022
- (id)nextObject;	// IMP=0x000000000011ef69
