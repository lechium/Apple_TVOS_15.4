...
+ (_Bool)requiresMainThread;	// IMP=0x0000000000172c58
+ (void)preheatPlayback;	// IMP=0x0000000000172c1d
+ (_Bool)usesNewPlaybackImplementation;	// IMP=0x0000000000172bf8
- (void).cxx_destruct;	// IMP=0x0000000000171763
...
- (void)requestAuthorizationForExplicitItem:(id)arg1 reason:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001713aa
- (void)_updateUISnapshotIfNeeded;	// IMP=0x0000000000171363
- (_Bool)_shouldIgnorePlaybackSessionError:(id)arg1;	// IMP=0x00000000001712d6
- (void)_initializePlaybackStack;	// IMP=0x0000000000170db8
- (void)_detectCrashLoopForSessionIdentifier:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000170a77
- (void)_screenBrightnessDidChangeNotification:(id)arg1;	// IMP=0x0000000000170957
- (void)schedulePlaybackStatePreservation;	// IMP=0x0000000000170841
@property(readonly, nonatomic) NSXPCListenerEndpoint *serverEndpoint;
@property(readonly, nonatomic) MPCPlayerPath *playerPath;
- (void)reportUserSeekFromTime:(double)arg1 toTime:(double)arg2;	// IMP=0x0000000000170682
- (void)reportUserBackgroundedApplication;	// IMP=0x000000000017066c
- (void)removeEngineObserver:(id)arg1;	// IMP=0x00000000001705f9
- (void)addEngineObserver:(id)arg1;	// IMP=0x0000000000170586
- (void)invalidate;	// IMP=0x000000000017056d
- (void)restoreStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000170211
- (void)becomeActive;	// IMP=0x00000000001701fb
- (void)start;	// IMP=0x00000000001701a1
- (void)dealloc;	// IMP=0x000000000017015c
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000016ebcf
- (id)initWithPlayerID:(id)arg1;	// IMP=0x000000000016eb51
