...
+ (id)identifier;	// IMP=0x00000000000b6520
- (void).cxx_destruct;	// IMP=0x00000000000b659f
...
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x00000000000b657b
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x00000000000b652d
