...
- (void).cxx_destruct;	// IMP=0x00000000000191d0
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x0000000000018b33
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x000000000001861c
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_339ad95e)arg1;	// IMP=0x00000000000185f8
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x000000000001844d
- (void)execute;	// IMP=0x0000000000018386
- (void)_loadPlayingIdentifierWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000018168
- (void)_loadItemsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000017bd2
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x0000000000017b30
