...
@interface _MPCPlaybackEngineEventStreamSubscription : NSObject <MPCPlaybackEngineEventStreamSubscription>
{
    ...
    NSMutableDictionary *_immediateEventHandlers;	// 64 = 0x40
    NSMutableDictionary *_eventHandlers;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x0000000000157d29
...
- (void)_onQueue_flush;	// IMP=0x0000000000157621
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000157283
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000015726c
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001570e6
- (void)cancelSubscription;	// IMP=0x0000000000156fc1
@property(readonly, copy) NSString *debugDescription;
- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x0000000000156d00
