...
- (void).cxx_destruct;	// IMP=0x0000000000003bb6
...
- (void)_transitionToLiveLinkState:(long long)arg1 error:(id)arg2;	// IMP=0x000000000000327c
- (void)_transitionToLiveLinkState:(long long)arg1;	// IMP=0x0000000000003268
- (void)_transitionToSourceState:(long long)arg1 error:(id)arg2;	// IMP=0x0000000000002b08
- (void)_transitionToSourceState:(long long)arg1;	// IMP=0x0000000000002af4
- (void)_transitionToBuildState:(long long)arg1 intent:(id)arg2 error:(id)arg3;	// IMP=0x0000000000002060
- (void)_transitionToBuildState:(long long)arg1;	// IMP=0x0000000000002049
- (void)liveLink:(id)arg1 didUpdateQueue:(id)arg2;	// IMP=0x0000000000001e87
- (void)liveLink:(id)arg1 didEncounterError:(id)arg2 willRetry:(_Bool)arg3;	// IMP=0x0000000000001e04
- (void)didStartLiveLink:(id)arg1;	// IMP=0x0000000000001cd5
- (void)getPlaybackContextForIntent:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001bea
- (void)buildSharedSessionIntentWithIntent:(id)arg1 identity:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001998
