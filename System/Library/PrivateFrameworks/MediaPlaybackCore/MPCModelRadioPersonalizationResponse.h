...
- (void).cxx_destruct;	// IMP=0x00000000000cf6d8
@property(copy, nonatomic) MPSectionedCollection *radioStationTracks; // @synthesize radioStationTracks=_radioStationTracks;
- (void)dealloc;	// IMP=0x00000000000cf621
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2;	// IMP=0x00000000000cf4c0
