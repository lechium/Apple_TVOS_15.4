...
- (void).cxx_destruct;	// IMP=0x00000000000f8338
...
- (id)description;	// IMP=0x00000000000f81af
- (id)initWithUpdatedAutoPlayEnabled:(_Bool)arg1;	// IMP=0x00000000000f8118
- (id)initWithUpdatedRepeatType:(long long)arg1;	// IMP=0x00000000000f8081
- (id)initWithUpdatedShuffleType:(long long)arg1;	// IMP=0x00000000000f7fea
