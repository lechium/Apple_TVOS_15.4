...
- (void).cxx_destruct;	// IMP=0x00000000000f3646
...
- (long long)exernalPlaybackRouteRestrictionForItem:(id)arg1 route:(id)arg2 isScreenMirroringActive:(_Bool)arg3;	// IMP=0x00000000000f34e9
- (_Bool)playerShouldUseAudiOnlyMode:(id)arg1 item:(id)arg2 externalScreenType:(long long)arg3;	// IMP=0x00000000000f34cc
- (_Bool)isExternalPlaybackAllowedForItem:(id)arg1;	// IMP=0x00000000000f34b7
- (void)routingControllerExternalScreenTypeDidChange:(id)arg1;	// IMP=0x00000000000f34b1
- (void)pickBestDeviceRoute;	// IMP=0x00000000000f3474
- (void)configureExternalPlaybackForPlayer:(id)arg1 queueItem:(id)arg2;	// IMP=0x00000000000f25a5
@property(readonly, nonatomic) MPAVRoutingController *routingController; // @synthesize routingController=_routingController;
- (id)initWithPlaybackEngine:(id)arg1 translator:(id)arg2;	// IMP=0x00000000000f247f
