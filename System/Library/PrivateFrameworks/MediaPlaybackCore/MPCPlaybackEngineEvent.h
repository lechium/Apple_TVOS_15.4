...
- (void).cxx_destruct;	// IMP=0x00000000000b6139
...
- (double)durationSinceEvent:(id)arg1;	// IMP=0x00000000000b608d
...
- (id)description;	// IMP=0x00000000000b5efc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b5e84
- (unsigned long long)hash;	// IMP=0x00000000000b5e6e
- (id)initWithType:(id)arg1 payload:(id)arg2 monotonicTime:(CDStruct_aeb9a598)arg3 identifier:(id)arg4;	// IMP=0x00000000000b5c23
- (id)previousItemEventWithCursor:(id)arg1 type:(id)arg2;	// IMP=0x00000000000a8486
