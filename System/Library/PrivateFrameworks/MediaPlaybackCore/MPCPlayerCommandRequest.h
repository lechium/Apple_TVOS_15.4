...
+ (id)initWithSiriUserActivity:(id)arg1;	// IMP=0x000000000009d375
- (void).cxx_destruct;	// IMP=0x000000000009d316
...
- (id)description;	// IMP=0x000000000009d23b
- (void)setCommandOptionValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000009d0c8
- (id)initWithMediaRemoteCommand:(unsigned int)arg1 options:(id)arg2 playerPath:(id)arg3 label:(id)arg4;	// IMP=0x000000000009cfcd
- (id)initWithMediaRemoteCommand:(unsigned int)arg1 options:(id)arg2 controller:(id)arg3 label:(id)arg4;	// IMP=0x000000000009cf01
