...
- (void).cxx_destruct;	// IMP=0x00000000000fc9f0
...
- (id)initWithCommandResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000000fc7b1
- (id)initWithReturnStatuses:(id)arg1 error:(id)arg2;	// IMP=0x00000000000fc70d
