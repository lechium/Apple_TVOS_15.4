...
- (void).cxx_destruct;	// IMP=0x00000000000f84c3
...
- (id)description;	// IMP=0x00000000000f8467
- (id)initWithReaction:(id)arg1 reactionIdentifier:(id)arg2 item:(id)arg3;	// IMP=0x00000000000f8388
