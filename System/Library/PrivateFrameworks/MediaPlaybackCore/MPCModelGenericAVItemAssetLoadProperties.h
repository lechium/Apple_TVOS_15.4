...
{
    _Bool _allowsHLSContent;	// 8 = 0x8
    _Bool _prefersVideoContent;	// 9 = 0x9
    _Bool _prefersHighQualityContent;	// 10 = 0xa
    _Bool _radioPlayback;	// 11 = 0xb
    _Bool _followUp;	// 12 = 0xc
    ...
    long long _preferredAudioAssetType;	// 112 = 0x70
    MPCAudioAssetTypeSelection *_audioAssetTypeSelection;	// 120 = 0x78
}

- (void).cxx_destruct;	// IMP=0x00000000000b1c58
