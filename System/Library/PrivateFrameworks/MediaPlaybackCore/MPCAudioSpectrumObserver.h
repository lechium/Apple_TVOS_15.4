...
+ (id)defaultObserver;	// IMP=0x0000000000141648
- (void).cxx_destruct;	// IMP=0x0000000000141638
...
- (void)finishReport;	// IMP=0x0000000000141541
- (void)beginReport;	// IMP=0x0000000000141500
- (void)_resizeBandStorage;	// IMP=0x0000000000141483
- (float)averagePowerOfBandAtIndex:(long long)arg1 band:(out struct MPCAudioSpectrumAnalyzerBand *)arg2;	// IMP=0x000000000014146f
- (long long)addAnalysisBand:(struct MPCAudioSpectrumAnalyzerBand)arg1;	// IMP=0x00000000001413e4
@property(readonly, nonatomic) long long numberOfBands; // @synthesize numberOfBands=_numberOfBands;
- (void)dealloc;	// IMP=0x000000000014139b
