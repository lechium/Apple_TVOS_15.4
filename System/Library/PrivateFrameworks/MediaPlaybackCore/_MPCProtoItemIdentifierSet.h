...
- (void).cxx_destruct;	// IMP=0x0000000000062e35
- (unsigned long long)hash;	// IMP=0x0000000000062d28
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000062b50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000629ef
- (void)writeTo:(id)arg1;	// IMP=0x00000000000628c6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000628b9
- (id)dictionaryRepresentation;	// IMP=0x000000000006264a
- (id)description;	// IMP=0x000000000006259b
