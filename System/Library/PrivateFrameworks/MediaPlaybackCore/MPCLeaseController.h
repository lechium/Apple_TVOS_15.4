...
- (void).cxx_destruct;	// IMP=0x000000000018cfa7
...
- (void)relinquishLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000018cc92
- (void)requestLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000018c983
- (id)initWithTranslator:(id)arg1 leaseManager:(id)arg2;	// IMP=0x000000000018c8ea
