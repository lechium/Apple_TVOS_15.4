...
+ (Class)responseClass;	// IMP=0x000000000009eb7b
- (void).cxx_destruct;	// IMP=0x000000000009eb17
...
- (id)_stateDumpObject;	// IMP=0x000000000009e911
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e84b
- (id)middlewareClasses;	// IMP=0x000000000009e5e8
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x000000000009e43d
