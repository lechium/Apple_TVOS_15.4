...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008cd24
- (void).cxx_destruct;	// IMP=0x000000000008cb46
...
- (id)_copyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x000000000008ca3f
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008ca0c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008c930
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008c78c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008c781
- (id)initWithStoreAccountID:(unsigned long long)arg1 deviceGUID:(id)arg2 privateListeningStateSource:(id)arg3;	// IMP=0x000000000008c6c1
