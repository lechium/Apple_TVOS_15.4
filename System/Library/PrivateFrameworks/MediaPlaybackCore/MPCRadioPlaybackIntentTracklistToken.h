...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000015273a
- (void).cxx_destruct;	// IMP=0x0000000000152929
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000152826
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000152742
