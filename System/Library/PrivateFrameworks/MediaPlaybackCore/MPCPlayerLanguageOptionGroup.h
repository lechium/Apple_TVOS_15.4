...
- (void).cxx_destruct;	// IMP=0x000000000018d61a
...
- (id)changeRequestForOptionAtIndex:(unsigned long long)arg1;	// IMP=0x000000000018d3ee
- (id)localizedTitleForOptionAtIndex:(unsigned long long)arg1;	// IMP=0x000000000018d293
...
- (id)initWithLanguageOptionGroups:(id)arg1 currentLanguageOptions:(id)arg2 response:(id)arg3;	// IMP=0x000000000018cfd8
