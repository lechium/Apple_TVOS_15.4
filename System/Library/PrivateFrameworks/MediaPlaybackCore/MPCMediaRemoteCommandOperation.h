...
- (void).cxx_destruct;	// IMP=0x000000000009c3d6
...
- (void)execute;	// IMP=0x000000000009b93c
- (id)initWithCommandRequest:(id)arg1 options:(unsigned long long)arg2 sendDate:(id)arg3;	// IMP=0x000000000009b887
