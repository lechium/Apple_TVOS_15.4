...
+ (id)participantWithSharedListeningIdentifier:(id)arg1 externalIdentifier:(id)arg2;	// IMP=0x00000000000f7355
- (void).cxx_destruct;	// IMP=0x00000000000f732d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f730e
- (id)description;	// IMP=0x00000000000f72dd
