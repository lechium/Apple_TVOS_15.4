...
- (void).cxx_destruct;	// IMP=0x00000000000ff5f9
...
- (_Bool)_isSupportedPlaybackIntent:(id)arg1 forRemotePlayer:(_Bool)arg2 atInsertionPosition:(int)arg3;	// IMP=0x00000000000ff25f
- (id)_createRadioStationCommandRequest;	// IMP=0x00000000000ff0a2
- (id)_insertWithOptions:(id)arg1;	// IMP=0x00000000000fee76
- (id)insertAtEndOfTracklistWithPlaybackIntent:(id)arg1;	// IMP=0x00000000000fed19
- (id)insertPlaybackIntent:(id)arg1 afterItem:(id)arg2;	// IMP=0x00000000000feaf3
- (id)insertAfterPlayingItemWithPlaybackIntent:(id)arg1;	// IMP=0x00000000000fe700
