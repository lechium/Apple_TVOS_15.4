...
- (void).cxx_destruct;	// IMP=0x000000000017d27d
@property(readonly, nonatomic) ICSuzeLeaseSession *icSuzeLeaseSession; // @synthesize icSuzeLeaseSession=_icSuzeLeaseSession;
- (void)endAutomaticallyRefreshingLease;	// IMP=0x000000000017d25d
- (void)beginAutomaticallyRefreshingLease;	// IMP=0x000000000017d247
- (id)initWithICSuzeLeaseSession:(id)arg1;	// IMP=0x000000000017d1dc
