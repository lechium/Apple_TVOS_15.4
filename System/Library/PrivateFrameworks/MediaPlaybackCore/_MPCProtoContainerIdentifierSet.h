...
- (void).cxx_destruct;	// IMP=0x00000000000df15f
- (unsigned long long)hash;	// IMP=0x00000000000df02c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000dee02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dec58
- (void)writeTo:(id)arg1;	// IMP=0x00000000000deb18
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000deb0b
- (id)dictionaryRepresentation;	// IMP=0x00000000000de8d3
- (id)description;	// IMP=0x00000000000de824
