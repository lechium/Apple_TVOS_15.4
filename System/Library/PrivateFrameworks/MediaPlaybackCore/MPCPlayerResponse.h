...
+ (id)builderProtocol;	// IMP=0x000000000009e42c
- (void).cxx_destruct;	// IMP=0x000000000009e071
...
- (id)_commandRequestForMediaRemoteCommand:(unsigned int)arg1;	// IMP=0x000000000009de84
- (id)_stateDumpObject;	// IMP=0x000000000009dd49
- (id)leaveSession;	// IMP=0x000000000009dd32
- (id)createSharedSessionWithIdentity:(id)arg1 intentHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000009dc10
- (id)createSharedSessionWithIntentHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000009db88
- (id)stop;	// IMP=0x000000000009daf8
- (id)play;	// IMP=0x000000000009da2b
- (id)pause;	// IMP=0x000000000009d95b
- (id)description;	// IMP=0x000000000009d894
- (id)initWithRequest:(id)arg1 middleware:(id)arg2;	// IMP=0x000000000009d5d7
