...
+ (id)insertCommandForPlayerPath:(id)arg1 devices:(id)arg2;	// IMP=0x000000000010599b
+ (id)resetCommandForPlayerPath:(id)arg1 devices:(id)arg2;	// IMP=0x000000000010590f
- (void).cxx_destruct;	// IMP=0x000000000010113a
...
- (unsigned long long)_determineChangeItemSupport;	// IMP=0x0000000000100d5c
- (id)_stateDumpObject;	// IMP=0x0000000000100c15
- (id)disableModificationsCommand;	// IMP=0x0000000000100ad9
- (id)changeItemCommand;	// IMP=0x0000000000100a56
- (id)actionAtQueueEndCommand;	// IMP=0x00000000001008c4
- (id)shuffleCommand;	// IMP=0x00000000001006a0
- (id)repeatCommand;	// IMP=0x000000000010047c
- (id)reorderCommand;	// IMP=0x00000000001003b4
- (id)insertCommand;	// IMP=0x00000000000fffbc
- (id)resetCommand;	// IMP=0x00000000000ffc6b
- (id)displayIndexPathForStructuredIndexPath:(id)arg1;	// IMP=0x00000000000ffbe7
- (id)structuredIndexPathForDisplayIndexPath:(id)arg1;	// IMP=0x00000000000ffb63
@property(readonly, nonatomic) MPCPlayerResponseItem *playingItem;
- (id)initWithResponse:(id)arg1;	// IMP=0x00000000000ff64c
