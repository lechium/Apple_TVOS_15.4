...
- (void).cxx_destruct;	// IMP=0x000000000015ad1d
...
- (void)invalidate;	// IMP=0x000000000015ab74
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000015aaf5
- (id)initWithEventStream:(id)arg1 reason:(id)arg2;	// IMP=0x000000000015aa51
