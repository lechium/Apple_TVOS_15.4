...
- (void).cxx_destruct;	// IMP=0x00000000000fe6ad
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x00000000000fe110
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x00000000000fe0f9
- (id)clearUpNextItems;	// IMP=0x00000000000fdfa3
- (id)clear;	// IMP=0x00000000000fddc1
