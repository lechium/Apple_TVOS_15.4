...
- (void).cxx_destruct;	// IMP=0x00000000001389ca
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x000000000013876d
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x000000000013872b
