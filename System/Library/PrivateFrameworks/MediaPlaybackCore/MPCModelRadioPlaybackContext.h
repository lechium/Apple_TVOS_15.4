...
+ (Class)queueFeederClass;	// IMP=0x000000000009fab3
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009faab
- (void).cxx_destruct;	// IMP=0x000000000009f764
...
- (id)descriptionComponents;	// IMP=0x000000000009f34b
- (long long)queueEndAction;	// IMP=0x000000000009f340
- (long long)repeatType;	// IMP=0x000000000009f338
- (long long)shuffleType;	// IMP=0x000000000009f330
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009f142
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009f017
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009ede5
- (id)init;	// IMP=0x000000000009ecc5
- (void)getRemotePlaybackQueueRepresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000879a5
- (id)getSharedListeningTracklistWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000141917
