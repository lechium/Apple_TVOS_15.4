...
+ (id)identifierForMFQueuePlayerItem:(id)arg1;	// IMP=0x00000000001489de
- (void).cxx_destruct;	// IMP=0x00000000001489ce
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014896e
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001488b3
@property(readonly) unsigned long long hash;
- (id)initWithContentItemID:(id)arg1 repeatIndex:(long long)arg2;	// IMP=0x0000000000148810
