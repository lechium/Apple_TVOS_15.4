...
+ (id)metadataIdentifiers;	// IMP=0x00000000001b9e5b
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001b9e53
- (void).cxx_destruct;	// IMP=0x00000000001b7e5b
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b7d1a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b7c8b
- (id)initWithGenericObject:(id)arg1 timedMetadataGroups:(id)arg2 storeRequestContext:(id)arg3;	// IMP=0x00000000001b7b99
