...
- (void).cxx_destruct;	// IMP=0x00000000001058e9
...
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x00000000001056eb
- (unsigned long long)numberOfItemsInSection:(unsigned long long)arg1;	// IMP=0x0000000000105654
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001054f3
- (unsigned long long)numberOfSections;	// IMP=0x0000000000105462
- (id)initWithResponse:(id)arg1 playingItemIndexPath:(id)arg2;	// IMP=0x00000000001053d0
