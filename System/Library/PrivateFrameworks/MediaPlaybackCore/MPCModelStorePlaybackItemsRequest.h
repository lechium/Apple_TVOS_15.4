...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ad8a9
+ (_Bool)requiresNetwork;	// IMP=0x00000000000ad8a1
+ (void)MPC_consumeSiriAssetInfo:(id)arg1 userIdentity:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015297d
- (void).cxx_destruct;	// IMP=0x00000000000ad362
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ad0bb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ace4b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ac765
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ac70d
@property(readonly, copy, nonatomic) NSString *rtcReportingPlayQueueSourceIdentifier;
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00000000000ac19e
