...
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x000000000017c450
- (void).cxx_destruct;	// IMP=0x0000000000176e4a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001767a5
- (id)initWithRoute:(id)arg1 spatialIsAlwaysOn:(_Bool)arg2;	// IMP=0x0000000000176559
- (id)initWithNowPlayingInfoAudioRoute:(id)arg1;	// IMP=0x00000000001764a5
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000176273
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000176268
- (id)mpc_jsonValue;	// IMP=0x000000000017a4ad
