...
+ (id)queueEventWithPlaybackModeChanged:(id)arg1;	// IMP=0x00000000000f79df
+ (id)queueEventWithContentUpdatedMessage:(id)arg1;	// IMP=0x00000000000f799b
+ (id)queueEventWithReplacedContent:(id)arg1;	// IMP=0x00000000000f7957
+ (id)queueEventWithReorderedContent:(id)arg1;	// IMP=0x00000000000f7913
+ (id)queueEventWithRemovedContent:(id)arg1;	// IMP=0x00000000000f78cf
+ (id)queueEventWithPlayedNowContent:(id)arg1;	// IMP=0x00000000000f788b
+ (id)queueEventWithAddedContent:(id)arg1;	// IMP=0x00000000000f7847
- (void).cxx_destruct;	// IMP=0x00000000000f77e8
...
- (id)description;	// IMP=0x00000000000f7638
