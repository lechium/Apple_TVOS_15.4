...
- (void).cxx_destruct;	// IMP=0x0000000000138691
...
- (id)_feedbackCommandWithMediaRemoteCommand:(unsigned int)arg1;	// IMP=0x00000000001380b0
- (id)_buildLanguageOptionGroups:(id)arg1 currentLanguageOptions:(id)arg2;	// IMP=0x0000000000137e56
- (unsigned long long)_determineSeekSupport;	// IMP=0x0000000000137bea
- (id)switchToAlternativeFormat:(id)arg1;	// IMP=0x0000000000137be2
@property(readonly, nonatomic) id <MPCPlayerResponseItemMusicAudio> musicAudio;
- (id)_stateDumpObject;	// IMP=0x0000000000137613
- (id)remove;	// IMP=0x0000000000137392
- (id)rateCommand;	// IMP=0x00000000001370ff
- (id)wishlistCommand;	// IMP=0x00000000001370e8
- (id)dislikeCommand;	// IMP=0x00000000001370d1
- (id)likeCommand;	// IMP=0x00000000001370ba
- (id)playbackRateCommand;	// IMP=0x0000000000136c59
- (id)seekCommand;	// IMP=0x0000000000136847
@property(readonly, copy) NSString *description;
- (id)initWithModelGenericObject:(id)arg1 indexPath:(id)arg2 response:(id)arg3;	// IMP=0x000000000013607b
