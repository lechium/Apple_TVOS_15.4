...
- (void).cxx_destruct;	// IMP=0x000000000003442a
...
- (id)initWithDictionary:(id)arg1 expirationDate:(id)arg2 environmentHash:(unsigned long long)arg3;	// IMP=0x00000000000341c0
