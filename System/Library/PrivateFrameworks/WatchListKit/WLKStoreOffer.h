...
+ (id)offersWithMAPIDictionaries:(id)arg1;	// IMP=0x0000000000030a41
+ (id)offersWithSubscriptionDictionaries:(id)arg1;	// IMP=0x000000000003084c
- (void).cxx_destruct;	// IMP=0x0000000000030c9a
...
- (_Bool)specialOfferEligible;	// IMP=0x00000000000307e0
- (id)initWithMAPIDictionary:(id)arg1;	// IMP=0x0000000000030560
- (id)initWithSubscriptionDictionary:(id)arg1;	// IMP=0x0000000000030241
- (id)sui_buttonTitle;	// IMP=0x000000000000247d
- (id)sui_buttonSubtitleWithServiceName:(id)arg1;	// IMP=0x0000000000002178
