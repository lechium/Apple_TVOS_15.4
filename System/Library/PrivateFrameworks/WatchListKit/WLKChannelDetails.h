...
+ (void)sui_fetchSeasonTitlesSettingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000242c9
- (void).cxx_destruct;	// IMP=0x000000000004e33d
...
- (id)init;	// IMP=0x000000000004e13f
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004dacc
- (id)sui_seasonEpisodeLabel:(_Bool)arg1 seasonTitleAvailable:(_Bool)arg2 seasonNumber:(id)arg3 episodeNumber:(id)arg4;	// IMP=0x0000000000024443
- (id)sui_channelName;	// IMP=0x0000000000024218
- (id)appIconURLForSize:(struct CGSize)arg1;	// IMP=0x000000000004a5aa
