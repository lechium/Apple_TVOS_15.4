...
- (void).cxx_destruct;	// IMP=0x0000000000041d0d
...
- (void)makeRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000041797
- (id)initWithBundleID:(id)arg1 externalID:(id)arg2;	// IMP=0x00000000000415cd
- (id)initWithStatsID:(id)arg1;	// IMP=0x0000000000041501
- (id)initWithCanonicalID:(id)arg1;	// IMP=0x0000000000041435
