...
- (void).cxx_destruct;	// IMP=0x000000000003a031
...
- (void)makeRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000039a35
- (id)initWithBundleID:(id)arg1 externalID:(id)arg2;	// IMP=0x000000000003986b
- (id)initWithStatsID:(id)arg1;	// IMP=0x000000000003979f
- (id)initWithCanonicalID:(id)arg1;	// IMP=0x00000000000396d3
