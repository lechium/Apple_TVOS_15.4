...
+ (id)playablesWithDictionaries:(id)arg1 context:(id)arg2;	// IMP=0x0000000000026e8b
- (void).cxx_destruct;	// IMP=0x00000000000285b4
...
- (id)_localesArrayForDictionary:(id)arg1 andKey:(id)arg2;	// IMP=0x00000000000282d7
...
- (id)openPunchoutURL;	// IMP=0x00000000000281c7
- (id)playPunchoutURL;	// IMP=0x00000000000281a7
- (unsigned long long)hash;	// IMP=0x0000000000028168
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028048
@property(readonly, copy, nonatomic) NSArray *storeOffers;
- (id)description;	// IMP=0x0000000000027ef8
- (id)init;	// IMP=0x0000000000027ee4
- (id)initWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000270c8
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000270b4
