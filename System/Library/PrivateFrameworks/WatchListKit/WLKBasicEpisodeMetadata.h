...
+ (id)episodesWithDictionaries:(id)arg1 context:(id)arg2;	// IMP=0x0000000000022ad6
- (void).cxx_destruct;	// IMP=0x00000000000235b2
...
- (id)initWithDictionary:(id)arg1 context:(id)arg2 playablesDict:(id)arg3 playablesId:(id)arg4 seasonsDict:(id)arg5;	// IMP=0x0000000000022ff8
- (id)initWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000022ce7
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000022cd3
