...
+ (id)browseItemsWithDictionaries:(id)arg1 context:(id)arg2;	// IMP=0x0000000000035a81
- (void).cxx_destruct;	// IMP=0x000000000003612e
...
- (id)preferredComingSoonInfo;	// IMP=0x0000000000035f00
- (id)initWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000035ca6
