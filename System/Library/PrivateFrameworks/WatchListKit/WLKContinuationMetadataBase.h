...
+ (long long)_contextForString:(id)arg1;	// IMP=0x000000000000c8bb
+ (void)remove:(id)arg1 fromCollection:(id)arg2;	// IMP=0x0000000000002de6
+ (void)add:(id)arg1 toCollection:(id)arg2;	// IMP=0x0000000000002a69
- (void).cxx_destruct;	// IMP=0x000000000000ca76
...
- (id)description;	// IMP=0x000000000000c96f
- (id)init;	// IMP=0x000000000000c8a5
- (id)initWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000c672
- (id)_mergingIdentifier;	// IMP=0x0000000000002972
