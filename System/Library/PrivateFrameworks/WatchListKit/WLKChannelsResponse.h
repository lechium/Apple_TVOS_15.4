...
+ (id)parseChannelsFromPayload:(id)arg1;	// IMP=0x00000000000532ad
- (void).cxx_destruct;	// IMP=0x00000000000534c9
...
- (_Bool)isValidForFiltered:(_Bool)arg1;	// IMP=0x00000000000531f5
- (id)initWithDictionary:(id)arg1 expirationDate:(id)arg2 environmentHash:(unsigned long long)arg3 filtered:(_Bool)arg4;	// IMP=0x0000000000052ede
