...
+ (Class)_classForContentType:(unsigned long long)arg1;	// IMP=0x0000000000003bc6
+ (unsigned long long)contentTypeForString:(id)arg1;	// IMP=0x0000000000003b08
...
- (id)init;	// IMP=0x0000000000004202
- (id)description;	// IMP=0x0000000000004167
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000003c38
