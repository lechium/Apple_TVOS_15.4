...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000053ee0
- (void).cxx_destruct;	// IMP=0x00000000000540b7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000053fbc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000053ee8
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000053b63
