...
- (void).cxx_destruct;	// IMP=0x0000000000021f12
...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000021db6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021cab
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x0000000000021bd6
- (id)init;	// IMP=0x0000000000021b2e
