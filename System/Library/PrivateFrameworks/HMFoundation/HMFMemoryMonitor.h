...
+ (id)memoryMonitor;	// IMP=0x000000000001b7d1
- (void).cxx_destruct;	// IMP=0x000000000001c09b
...
- (void)stop;	// IMP=0x000000000001bf24
- (void)start;	// IMP=0x000000000001be47
- (void)dealloc;	// IMP=0x000000000001bdf4
- (id)init;	// IMP=0x000000000001b826
