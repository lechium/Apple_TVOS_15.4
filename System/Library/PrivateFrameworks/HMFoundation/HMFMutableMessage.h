...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003c24f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003c1c3
@property(nonatomic) __weak HMFMessageTransport *transport; // @dynamic transport;
- (void)setHeaderValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000003c04f
@property(copy, nonatomic) NSDictionary *headers; // @dynamic headers;
- (void)setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000003bedb
