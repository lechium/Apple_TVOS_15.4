...
- (id)responseWithStatusCode:(long long)arg1;	// IMP=0x0000000000046c05
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000046bc3
- (id)init;	// IMP=0x0000000000046b14
