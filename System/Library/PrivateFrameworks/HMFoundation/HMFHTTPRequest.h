...
- (void).cxx_destruct;	// IMP=0x0000000000047403
...
- (id)responseWithStatusCode:(long long)arg1;	// IMP=0x00000000000470d1
- (id)attributeDescriptions;	// IMP=0x0000000000046ee0
- (id)initWithInternalRequest:(id)arg1;	// IMP=0x0000000000046e5d
- (id)init;	// IMP=0x0000000000046db5
