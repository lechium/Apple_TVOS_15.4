...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000035e45
+ (id)systemInfo;	// IMP=0x0000000000035df0
- (void).cxx_destruct;	// IMP=0x00000000000365c3
...
- (void)dataSource:(id)arg1 didUpdateMigrating:(_Bool)arg2;	// IMP=0x0000000000036314
...
- (void)dataSource:(id)arg1 didUpdateName:(id)arg2;	// IMP=0x0000000000035f00
