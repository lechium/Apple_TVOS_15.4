...
- (void)reset;	// IMP=0x0000000000004878
- (void)__fire;	// IMP=0x000000000000478d
- (double)timeInterval;	// IMP=0x0000000000004743
- (id)initWithMinimumTimeInterval:(double)arg1 maximumTimeInterval:(double)arg2 exponentialFactor:(long long)arg3 options:(unsigned long long)arg4;	// IMP=0x00000000000044c6
- (id)initWithTimeInterval:(double)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000044a9
