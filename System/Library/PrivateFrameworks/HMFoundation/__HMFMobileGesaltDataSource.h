...
#import <HMFoundation/HMFSystemInfoProductColorDataSource-Protocol.h>
...
- (void).cxx_destruct;	// IMP=0x000000000002b97b
...
- (void)dealloc;	// IMP=0x000000000002b7de
- (id)init;	// IMP=0x000000000002ae43
