...
+ (id)logCategory;	// IMP=0x000000000001d623
- (void).cxx_destruct;	// IMP=0x000000000001d73a
...
- (id)logIdentifier;	// IMP=0x000000000001d68a
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (void)invalidate;	// IMP=0x000000000001d5c4
- (void)setWatchdogTimeout:(double)arg1;	// IMP=0x000000000001d569
- (double)watchdogTimeout;	// IMP=0x000000000001d4a8
@property double connectionIdleTimeout;
- (void)dealloc;	// IMP=0x000000000001d1fa
- (id)initWithPort:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000001c3d7
- (id)init;	// IMP=0x000000000001c32f
