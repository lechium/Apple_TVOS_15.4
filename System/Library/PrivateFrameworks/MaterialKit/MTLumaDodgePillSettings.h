...
+ (id)settingsControllerModule;	// IMP=0x0000000000002c0f
+ (id)sharedInstance;	// IMP=0x000000000000249e
- (void).cxx_destruct;	// IMP=0x0000000000003714
...
- (void)setDefaultValues;	// IMP=0x00000000000024b7
