...
+ (id)allowedDecodableClasses;	// IMP=0x000000000001103d
+ (id)emptyResponse;	// IMP=0x0000000000010dfe
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000010df6
...
- (id)description;	// IMP=0x00000000000115fe
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000111ef
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010f28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010e17
