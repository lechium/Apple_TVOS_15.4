...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001043e
+ (id)allowedDecodableClasses;	// IMP=0x000000000000ffef
+ (void)initialize;	// IMP=0x000000000000fc78
- (void).cxx_destruct;	// IMP=0x00000000000105b0
...
- (id)description;	// IMP=0x0000000000010446
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010291
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001012c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000fe84
- (unsigned long long)hash;	// IMP=0x000000000000fe1d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000fda2
- (id)init;	// IMP=0x000000000000fcc1
