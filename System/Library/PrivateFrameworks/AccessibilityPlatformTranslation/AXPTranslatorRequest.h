...
+ (id)allowedDecodableClasses;	// IMP=0x00000000000108b6
+ (id)requestWithTranslation:(id)arg1;	// IMP=0x00000000000105f6
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000105ee
...
- (id)description;	// IMP=0x0000000000010bf9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010a42
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001077e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001064c
