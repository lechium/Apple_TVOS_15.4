...
- (id)description;	// IMP=0x0000000000001f46
- (unsigned long long)hash;	// IMP=0x0000000000001eeb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000001df9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000001d8c
