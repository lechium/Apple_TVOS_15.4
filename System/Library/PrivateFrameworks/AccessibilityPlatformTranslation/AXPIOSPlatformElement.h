...
+ (id)platformElementWithTranslationObject:(id)arg1;	// IMP=0x000000000000f525
+ (id)platformElementWithTranslationObject:(id)arg1 rootParent:(id)arg2;	// IMP=0x000000000000f49b
- (void).cxx_destruct;	// IMP=0x000000000000f5fa
