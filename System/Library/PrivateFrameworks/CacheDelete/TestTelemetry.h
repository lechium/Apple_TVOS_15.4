...
+ (id)testTelemetryWithInfo:(id)arg1;	// IMP=0x0000000000012aaa
- (void).cxx_destruct;	// IMP=0x0000000000012fa7
...
- (unsigned long long)deletes;	// IMP=0x0000000000012e27
- (void)addDeletes:(unsigned long long)arg1;	// IMP=0x0000000000012d66
- (void)addTerminationFailure:(id)arg1;	// IMP=0x0000000000012c93
- (void)addRemoveFailure:(id)arg1;	// IMP=0x0000000000012bc0
- (id)description;	// IMP=0x0000000000012af7
- (id)initWithInfo:(id)arg1;	// IMP=0x0000000000012728
