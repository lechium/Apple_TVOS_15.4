...
- (void).cxx_destruct;	// IMP=0x000000000001da98
...
- (void)resume;	// IMP=0x000000000001d983
- (void)suspend;	// IMP=0x000000000001d90a
- (void)addRequiredEntitlement:(id)arg1;	// IMP=0x000000000001d7f8
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000001d45f
- (id)initWithName:(id)arg1 listener:(id)arg2 protocol:(id)arg3 exportedObj:(id)arg4 isExtension:(_Bool)arg5;	// IMP=0x000000000001d1e3
