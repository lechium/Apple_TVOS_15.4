...
- (void).cxx_destruct;	// IMP=0x000000000001ee8c
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000001e99e
- (void)callback:(id)arg1;	// IMP=0x000000000001dc34
- (void)dealloc;	// IMP=0x000000000001dbce
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x000000000001dae1
