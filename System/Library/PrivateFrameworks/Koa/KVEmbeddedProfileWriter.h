...
- (id).cxx_construct;	// IMP=0x0000000000010ed1
- (void).cxx_destruct;	// IMP=0x0000000000010e65
- (_Bool)finishProfile:(id *)arg1;	// IMP=0x0000000000010cbb
- (_Bool)finishDataset:(id *)arg1;	// IMP=0x00000000000109ba
- (_Bool)addItem:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000010732
- (_Bool)startDataset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001071e
- (_Bool)startProfile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001070a
- (id)initWithOutputStream:(id)arg1;	// IMP=0x000000000001068b
