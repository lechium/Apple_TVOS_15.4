...
@interface CNVCardNameComponents : NSObject <CNVCardNameDataSource>
{
    ...
    _Bool _isCompany;	// 64 = 0x40
}

+ (id)componentsWithFirstName:(id)arg1 lastName:(id)arg2 middleName:(id)arg3 title:(id)arg4 suffix:(id)arg5 companyName:(id)arg6 isCompany:(_Bool)arg7;	// IMP=0x0000000000022dcd
+ (id)components;	// IMP=0x0000000000022dbb
- (void).cxx_destruct;	// IMP=0x0000000000022fbd
