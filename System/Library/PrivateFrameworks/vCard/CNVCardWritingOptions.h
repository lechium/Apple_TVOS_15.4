...
+ (id)optionsFromPreferences;	// IMP=0x0000000000023299
- (void).cxx_destruct;	// IMP=0x00000000000238a9
...
- (id)description;	// IMP=0x00000000000233ec
- (id)init;	// IMP=0x0000000000023390
