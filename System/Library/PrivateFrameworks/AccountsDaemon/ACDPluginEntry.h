...
- (void).cxx_destruct;	// IMP=0x00000000000836bc
@property(readonly, nonatomic) NSBundle *bundle; // @synthesize bundle=_bundle;
- (id)debugDescription;	// IMP=0x0000000000083582
- (id)description;	// IMP=0x00000000000834df
- (_Bool)principalObjectRespondsToSelector:(SEL)arg1;	// IMP=0x00000000000834aa
...
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000000083093
- (id)init;	// IMP=0x0000000000083068
