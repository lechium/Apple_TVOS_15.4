...
+ (id)shared;	// IMP=0x000000000000c61e
- (void).cxx_destruct;	// IMP=0x000000000000c8ae
...
- (_Bool)activityStream:(id)arg1 deviceUDID:(id)arg2 deviceID:(id)arg3 status:(long long)arg4 error:(id)arg5;	// IMP=0x000000000000c795
- (id)init;	// IMP=0x000000000000c673
