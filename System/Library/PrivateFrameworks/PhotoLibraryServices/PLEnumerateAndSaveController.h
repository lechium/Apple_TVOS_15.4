...
- (void).cxx_destruct;	// IMP=0x00000000004c82a0
...
- (_Bool)processObjectsWithError:(id *)arg1;	// IMP=0x00000000004c7c29
- (void)_inq_runOperationWithObjectIDs:(id)arg1 onContext:(id)arg2;	// IMP=0x00000000004c760e
- (id)initWithName:(id)arg1 fetchRequest:(id)arg2 context:(id)arg3 pathManager:(id)arg4 concurrent:(_Bool)arg5 generateContextBlock:(CDUnknownBlockType)arg6 processResultBlock:(CDUnknownBlockType)arg7;	// IMP=0x00000000004c71e1
