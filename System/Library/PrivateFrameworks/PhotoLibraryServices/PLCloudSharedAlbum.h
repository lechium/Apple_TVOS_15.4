...
+ (id)lightweightReimportDirectoryNameWithGUID:(id)arg1 cloudPersonID:(id)arg2;	// IMP=0x00000000003c9c7c
+ (id)cloudOwnerDisplayNameWithFirstName:(id)arg1 lastName:(id)arg2 fullName:(id)arg3 emailKey:(id)arg4 includingEmail:(_Bool)arg5 allowsEmail:(_Bool)arg6 emailAddressManager:(id)arg7;	// IMP=0x00000000003c9a86
+ (id)localizedSharedByLabelWithFirstName:(id)arg1 lastName:(id)arg2 fullName:(id)arg3 emailKey:(id)arg4 isOwned:(_Bool)arg5 allowsEmail:(_Bool)arg6 emailAddressManager:(id)arg7;	// IMP=0x00000000003c998f
+ (id)allCloudSharedAlbumsInLibrary:(id)arg1;	// IMP=0x00000000003c9924
+ (id)cloudSharedAlbumWithObjectID:(id)arg1 managedObjectContext:(id)arg2;	// IMP=0x00000000003c9762
+ (id)cloudSharedAlbumWithGUID:(id)arg1 inLibrary:(id)arg2;	// IMP=0x00000000003c9544
+ (id)entityName;	// IMP=0x00000000003c9537
- (void)persistRecoveryMetadata;	// IMP=0x00000000003c8cd5
- (void)userDeleteSubscriberRecord:(id)arg1;	// IMP=0x00000000003c8be1
...
- (void)publishBatchOfOriginalAssetUUIDs:(id)arg1 withBatchCommentText:(id)arg2 assetsSharingInfos:(id)arg3 customExportsInfo:(id)arg4 andTrimmedVideoPathInfo:(id)arg5 isNewAlbum:(_Bool)arg6;	// IMP=0x00000000003c8a83
- (void)updateCloudLastContributionDateWithDate:(id)arg1;	// IMP=0x00000000003c8944
- (void)updateCloudLastInterestingChangeDateWithDate:(id)arg1;	// IMP=0x00000000003c86fb
- (id)cloudOwnerDisplayNameIncludingEmail:(_Bool)arg1 allowsEmail:(_Bool)arg2;	// IMP=0x00000000003c85ef
...
- (id)localizedSharedByLabelAllowsEmail:(_Bool)arg1;	// IMP=0x00000000003c8001
- (id)emailAddressManager;	// IMP=0x00000000003c7f87
...
- (id)_expectedKeyAssets:(id)arg1;	// IMP=0x00000000003c7c7d
- (void)delete;	// IMP=0x00000000003c771c
- (void)deleteFromDatabaseOnly;	// IMP=0x00000000003c7679
- (id)albumDirectoryPath;	// IMP=0x00000000003c735f
- (void)prepareForDeletion;	// IMP=0x00000000003c7297
- (void)willSave;	// IMP=0x00000000003c71e3
- (void)awakeFromInsert;	// IMP=0x00000000003c715c
- (void)getUnseenStartMarkerIndex:(unsigned long long *)arg1 count:(unsigned long long *)arg2 showsProgress:(_Bool *)arg3;	// IMP=0x00000000003c70a9
