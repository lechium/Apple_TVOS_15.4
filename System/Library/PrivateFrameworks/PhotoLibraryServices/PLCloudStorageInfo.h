...
+ (id)storageInfoWithTotal:(long long)arg1 available:(long long)arg2 used:(long long)arg3 cameraRollBackupBytes:(long long)arg4 iCloudPhotosSize:(long long)arg5 hasMaxQuotaTier:(_Bool)arg6;	// IMP=0x000000000035311f
...
- (id)description;	// IMP=0x000000000035309a
- (id)initWithTotalQuotaBytes:(long long)arg1 totalAvailableBytes:(long long)arg2 totalUsedBytes:(long long)arg3 cameraRollBackupBytes:(long long)arg4 iCloudPhotosSize:(long long)arg5 hasMaxQuotaTier:(_Bool)arg6;	// IMP=0x000000000035302e
