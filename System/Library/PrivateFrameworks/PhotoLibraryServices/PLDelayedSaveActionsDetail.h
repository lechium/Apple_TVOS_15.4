...
+ (id)_decodeMomentDeletes:(id)arg1 urlToObjectID:(CDUnknownBlockType)arg2;	// IMP=0x00000000005a1d07
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000005a1cff
- (void).cxx_destruct;	// IMP=0x00000000005a1b66
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005a0ce8
- (id)_encodableMomentDeletes;	// IMP=0x00000000005a0c47
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005a07d8
@property(readonly, nonatomic) _Bool shouldHandleMoments;
- (id)init;	// IMP=0x00000000005a0730
