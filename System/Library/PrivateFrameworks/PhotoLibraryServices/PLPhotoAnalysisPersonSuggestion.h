...
- (void).cxx_destruct;	// IMP=0x000000000016ce5d
...
- (id)description;	// IMP=0x000000000016cd7d
- (id)suggestionDictionaryRepresentation;	// IMP=0x000000000016cc24
- (id)initWithSuggestionDictionary:(id)arg1;	// IMP=0x000000000016ca29
