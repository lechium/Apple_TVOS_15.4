...
- (void).cxx_destruct;	// IMP=0x0000000000028b42
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000289e6
- (id)initWithUUID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 title:(id)arg4 subtitle:(id)arg5 keyAssetUUID:(id)arg6 type:(unsigned long long)arg7 numberOfAssets:(unsigned long long)arg8 sortDate:(id)arg9;	// IMP=0x000000000002885a
