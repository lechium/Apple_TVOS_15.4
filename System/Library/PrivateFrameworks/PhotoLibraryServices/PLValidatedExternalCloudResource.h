...
- (void).cxx_destruct;	// IMP=0x00000000003810fe
...
- (unsigned long long)cplTypeWithAssetID:(id)arg1;	// IMP=0x0000000000380f89
- (_Bool)isEqualToValidatedExternalResource:(id)arg1;	// IMP=0x0000000000380e78
- (id)initWithInternalResource:(id)arg1;	// IMP=0x0000000000380cc8
- (id)initWithCloudResource:(id)arg1;	// IMP=0x0000000000380b18
