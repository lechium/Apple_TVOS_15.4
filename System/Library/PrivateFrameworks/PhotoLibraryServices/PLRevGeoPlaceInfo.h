...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000577adb
- (void).cxx_destruct;	// IMP=0x0000000000577acb
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000577986
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000577902
- (void)addPlaceInfoArea:(double)arg1;	// IMP=0x00000000005778d3
- (id)initWithPlaceName:(id)arg1;	// IMP=0x0000000000577851
