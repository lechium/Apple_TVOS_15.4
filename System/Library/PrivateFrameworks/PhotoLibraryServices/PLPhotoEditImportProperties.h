...
+ (id)importPropertiesWithEXIFOrientation:(long long)arg1 duration:(double)arg2;	// IMP=0x00000000005790a4
+ (id)importPropertiesWithEXIFOrientation:(long long)arg1;	// IMP=0x000000000057908f
