...
- (void).cxx_destruct;	// IMP=0x000000000034cf57
...
- (id)summaryDescription;	// IMP=0x000000000034ccf6
- (_Bool)isEmpty;	// IMP=0x000000000034cb92
- (id)init;	// IMP=0x000000000034c985
