...
- (void).cxx_destruct;	// IMP=0x000000000035fad4
...
- (void)addURLs:(id)arg1;	// IMP=0x000000000035f973
- (void)addURL:(id)arg1;	// IMP=0x000000000035f870
@property(readonly, nonatomic) NSSet *urls;
- (id)description;	// IMP=0x000000000035f7ab
- (long long)compare:(id)arg1;	// IMP=0x000000000035f6b4
- (_Bool)isCameraKit;	// IMP=0x000000000035f69b
- (id)initWithAssetPayload:(id)arg1;	// IMP=0x000000000035f58d
- (id)initWithDestinationAlbum:(id)arg1 assetKind:(int)arg2;	// IMP=0x000000000035f4fd
