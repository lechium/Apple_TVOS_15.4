...
+ (id)clusterDescriptor:(struct _NSRange)arg1 rootLevel:(long long)arg2 minCoreDistanceIndex:(long long)arg3 minCoreDistance:(double)arg4;	// IMP=0x000000000020bfe7
- (void).cxx_destruct;	// IMP=0x000000000020bf93
...
- (id)initWithParameters:(struct _NSRange)arg1 rootLevel:(long long)arg2 minCoreDistanceIndex:(long long)arg3 minCoreDistance:(double)arg4;	// IMP=0x000000000020bd31
