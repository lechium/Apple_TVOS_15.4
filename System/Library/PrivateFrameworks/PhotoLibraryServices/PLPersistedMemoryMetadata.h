...
+ (_Bool)isValidPath:(id)arg1;	// IMP=0x00000000001108a1
- (void).cxx_destruct;	// IMP=0x00000000001107a9
...
- (void)_saveMetadata;	// IMP=0x000000000011030d
- (id)_metadataData;	// IMP=0x000000000010f1cb
- (_Bool)_readMetadata;	// IMP=0x000000000010e710
- (id)description;	// IMP=0x000000000010e4bf
- (_Bool)hasAllAssetsAvailableInManagedObjectContext:(id)arg1 includePendingAssetChanges:(_Bool)arg2;	// IMP=0x000000000010e1fc
- (_Bool)updateAssetsInMemory:(id)arg1 includePendingAssetChanges:(_Bool)arg2;	// IMP=0x000000000010dd8c
- (_Bool)_updateAssetsInMemory:(id)arg1 relationshipName:(id)arg2 persistedAssetUUIDs:(id)arg3 includePendingChanges:(_Bool)arg4;	// IMP=0x000000000010da18
- (id)insertMemoryFromDataInManagedObjectContext:(id)arg1;	// IMP=0x000000000010d462
- (_Bool)isObsolete;	// IMP=0x000000000010d451
- (void)removePersistedData;	// IMP=0x000000000010d311
- (void)writePersistedData;	// IMP=0x000000000010d2ff
- (id)initWithPersistedDataAtURL:(id)arg1;	// IMP=0x000000000010d25e
- (id)initWithPLMemory:(id)arg1 pathManager:(id)arg2;	// IMP=0x000000000010d10b
- (id)initWithPLMemory:(id)arg1 metadataURL:(id)arg2;	// IMP=0x000000000010d061
- (id)init;	// IMP=0x000000000010cfda
