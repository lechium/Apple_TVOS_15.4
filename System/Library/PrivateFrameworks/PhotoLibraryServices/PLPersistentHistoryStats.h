...
+ (_Bool)fetchEarliestTransactionDateFromDatabase:(id)arg1 intoStats:(id)arg2;	// IMP=0x00000000003048d2
+ (_Bool)fetchTransactionCountFromDatabase:(id)arg1 intoStats:(id)arg2;	// IMP=0x0000000000304837
+ (_Bool)fetchUnusedPageCountFromDatabase:(id)arg1 intoStats:(id)arg2;	// IMP=0x000000000030479c
+ (_Bool)fetchTotalPageCountFromDatabase:(id)arg1 intoStats:(id)arg2;	// IMP=0x0000000000304701
+ (_Bool)fetchPageCountsOfPersistentHistoryTablesFromDatabase:(id)arg1 intoStats:(id)arg2;	// IMP=0x0000000000304666
+ (id)statsFromDatabase:(id)arg1;	// IMP=0x0000000000304589
- (void).cxx_destruct;	// IMP=0x0000000000304579
...
- (double)_pageCountAsPercentOfPayload:(long long)arg1;	// IMP=0x00000000003044ad
...
- (double)_pageCountAsPercentOfFile:(long long)arg1;	// IMP=0x000000000030441d
