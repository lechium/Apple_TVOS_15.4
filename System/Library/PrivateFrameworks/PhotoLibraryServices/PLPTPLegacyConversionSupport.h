...
- (void).cxx_destruct;	// IMP=0x00000000002de39e
@property(readonly, nonatomic) _Bool peerSupportsAdjustmentBaseResources;
- (id)conversionResultForAsset:(id)arg1 isVideo:(_Bool)arg2 isRender:(_Bool)arg3 forceLegacyConversion:(_Bool)arg4;	// IMP=0x00000000002de34f
@property(readonly, nonatomic) _Bool peerSupportsTranscodeChoice;
@property(readonly, nonatomic) _Bool penultimateIsPublic;
- (id)init;	// IMP=0x00000000002de2ac
