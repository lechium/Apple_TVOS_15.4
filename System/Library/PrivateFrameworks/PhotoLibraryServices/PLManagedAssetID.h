...
- (void).cxx_destruct;	// IMP=0x000000000034b4a7
...
- (id)initWithUUID:(id)arg1 filename:(id)arg2 directory:(id)arg3 libraryID:(id)arg4 bundleScope:(unsigned short)arg5;	// IMP=0x000000000034b161
- (id)initWithManagedAsset:(id)arg1;	// IMP=0x000000000034af33
