...
- (id)performWithDataset:(id)arg1 progressBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000004b0b83
- (CDUnknownBlockType)_timeAndLocationBasedClusteringBlockWithTimeIntervalDistance:(double)arg1;	// IMP=0x00000000004b0b1a
- (CDUnknownBlockType)_locationBasedClusteringBlock;	// IMP=0x00000000004b0b0d
- (id)init;	// IMP=0x00000000004b0a02
