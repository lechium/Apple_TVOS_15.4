...
- (void).cxx_destruct;	// IMP=0x000000000023b113
...
- (void)fetchAssetUUIDsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000023af3b
@property(readonly, nonatomic) NSArray *assetUUIDs;
@property(readonly, nonatomic) unsigned long long assetMatchCount;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023adfe
- (void)dealloc;	// IMP=0x000000000023adbf
- (id)init;	// IMP=0x000000000023ad67
