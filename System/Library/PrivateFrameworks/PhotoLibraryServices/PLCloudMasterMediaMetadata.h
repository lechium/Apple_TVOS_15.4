...
+ (id)entityName;	// IMP=0x0000000000282b41
- (id)payloadsForChangedKeys:(id)arg1;	// IMP=0x000000000044ddf9
- (void)_addPayloadIfValidForAsset:(id)arg1 changedKeys:(id)arg2 toPayloads:(id)arg3 modelProperties:(id)arg4;	// IMP=0x000000000044dc54
- (id)payloadID;	// IMP=0x000000000044daec
