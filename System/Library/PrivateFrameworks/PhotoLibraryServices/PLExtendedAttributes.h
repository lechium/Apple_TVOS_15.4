...
+ (id)distinctValuesForKeyPath:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00000000003184b3
+ (id)entityName;	// IMP=0x00000000003184a6
- (id)formattedCameraModel;	// IMP=0x000000000031841c
- (id)payloadForChangedKeys:(id)arg1;	// IMP=0x000000000044d573
- (id)payloadID;	// IMP=0x000000000044d4ef
