...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003ce336
- (void).cxx_destruct;	// IMP=0x00000000003ce2c1
...
- (id)description;	// IMP=0x00000000003ce00c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003cdd81
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003cdc2d
- (id)initWithAssetCollection:(id)arg1;	// IMP=0x00000000003cd7e7
