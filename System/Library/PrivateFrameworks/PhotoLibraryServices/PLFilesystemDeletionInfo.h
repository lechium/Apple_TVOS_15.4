...
+ (id)deletionInfoWithAsset:(id)arg1;	// IMP=0x0000000000318ca2
- (void).cxx_destruct;	// IMP=0x0000000000318ba8
...
- (id)description;	// IMP=0x0000000000318a63
- (id)initWithObjectIDURI:(id)arg1 directory:(id)arg2 filename:(id)arg3 fileURLs:(id)arg4 thumbnailIndex:(unsigned long long)arg5 thumbnailIdentifier:(id)arg6 uuid:(id)arg7 timestamp:(unsigned long long)arg8;	// IMP=0x00000000003187b9
