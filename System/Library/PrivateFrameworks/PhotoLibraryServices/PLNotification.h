...
+ (id)_UNCategoryFromNotificationType:(long long)arg1;	// IMP=0x0000000000418594
+ (id)requestIdentifierByNotificationType:(long long)arg1 keyObjectUUID:(id)arg2 photosBatchID:(id)arg3;	// IMP=0x00000000004184b6
- (void).cxx_destruct;	// IMP=0x000000000041817e
...
- (_Bool)assetWithUUID:(id)arg1 didChangePlaceholderKindTo:(short)arg2 fromOldKind:(short)arg3;	// IMP=0x0000000000417f74
@property(readonly) NSString *requestIdentifier;
@property(readonly) NSString *keyObjectUUID;
- (_Bool)isCommentPiggyBackedOnPhotosAddedNotification;	// IMP=0x0000000000417e28
- (id)description;	// IMP=0x0000000000417d83
...
- (id)notificationByMergingWithNotificationDictionary:(id)arg1;	// IMP=0x0000000000416129
- (id)notificationByMergingWithNotification:(id)arg1;	// IMP=0x0000000000415af8
@property(readonly) _Bool canMergeWithPersistedNotifications;
- (id)initWithExpiringMomentShareUUIDs:(id)arg1 thumbnailImageData:(id)arg2 notificationTitle:(id)arg3 notificationSubtitle:(id)arg4;	// IMP=0x00000000004158e7
- (id)initWithExpiringMomentShares:(id)arg1;	// IMP=0x0000000000415619
- (id)initCMMInvitationReadyToViewWithMomentShare:(id)arg1;	// IMP=0x0000000000415343
- (id)initCMMInvitationWithMomentShare:(id)arg1;	// IMP=0x00000000004151ed
- (id)initWithSuggestedCMMUUID:(id)arg1 keyAssetUUID:(id)arg2 notificationTitle:(id)arg3 notificationSubtitle:(id)arg4;	// IMP=0x0000000000414f44
- (id)initWithInterestingMemoryNotificationWithMemoryUUID:(id)arg1 keyAssetUUID:(id)arg2 notificationTitle:(id)arg3 notificationSubtitle:(id)arg4 photoLibraryURLString:(id)arg5;	// IMP=0x0000000000414bf7
- (id)_initWithLikesCount:(long long)arg1 commentDate:(id)arg2 firstCommentGUID:(id)arg3 toAssetWithUUID:(id)arg4 photosBatchID:(id)arg5 mainAssetIsMine:(_Bool)arg6 mainAssetIsVideo:(_Bool)arg7 inAlbumWithTitle:(id)arg8 albumUUID:(id)arg9 albumCloudGUID:(id)arg10 assetUUIDs:(id)arg11 placeholderAssetUUIDs:(id)arg12 lowResThumbAssetUUIDs:(id)arg13 senderNames:(id)arg14 forMultipleAsset:(_Bool)arg15 allMultipleAssetIsMine:(_Bool)arg16 isMixedType:(_Bool)arg17;	// IMP=0x00000000004149af
- (id)_initWithCommentsCount:(long long)arg1 commentDate:(id)arg2 firstCommentGUID:(id)arg3 toAssetWithUUID:(id)arg4 photosBatchID:(id)arg5 mainAssetIsMine:(_Bool)arg6 mainAssetIsVideo:(_Bool)arg7 inAlbumWithTitle:(id)arg8 albumUUID:(id)arg9 albumCloudGUID:(id)arg10 assetUUIDs:(id)arg11 placeholderAssetUUIDs:(id)arg12 lowResThumbAssetUUIDs:(id)arg13;	// IMP=0x0000000000414790
- (id)initWithLikeAdded:(id)arg1;	// IMP=0x0000000000414379
- (id)initWithCommentAdded:(id)arg1;	// IMP=0x0000000000413ec3
- (id)_initWithPhotosAddedNotification:(id)arg1 mergedWithNotificationDictionary:(id)arg2;	// IMP=0x0000000000413b2b
- (id)_initWithPhotosAddedNotification:(id)arg1 mergedWithNotification:(id)arg2;	// IMP=0x0000000000413894
- (id)initWithAssetsAdded:(id)arg1 toAlbum:(id)arg2;	// IMP=0x00000000004132aa
- (id)initWithAssetAdded:(id)arg1 atIndex:(unsigned long long)arg2 toAlbum:(id)arg3;	// IMP=0x0000000000412dc5
- (id)initWithMultipleContributorEnabledForAlbum:(id)arg1;	// IMP=0x0000000000412c03
- (id)initWithInvitationRecordStatusChanged:(id)arg1;	// IMP=0x00000000004129c4
- (id)initWithInvitationAlbum:(id)arg1;	// IMP=0x00000000004127f0
- (id)_initWithType:(long long)arg1;	// IMP=0x00000000004126e6
- (id)init;	// IMP=0x000000000041265f
