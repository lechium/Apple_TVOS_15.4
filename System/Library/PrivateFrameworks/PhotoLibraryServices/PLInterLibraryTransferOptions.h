...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000038b951
+ (id)newTransferOptionsForSyndicationToSystemPhotoLibrary;	// IMP=0x000000000038b717
- (void).cxx_destruct;	// IMP=0x000000000038b6ef
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000038b594
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000038b506
- (id)debugDescription;	// IMP=0x000000000038b47e
- (id)description;	// IMP=0x000000000038b402
- (id)_sortedEntityNamesAsString;	// IMP=0x000000000038b353
