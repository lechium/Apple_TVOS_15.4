...
- (void).cxx_destruct;	// IMP=0x00000000002dd3de
...
- (unsigned long long)snapshotIndexForContainedObject:(id)arg1;	// IMP=0x00000000002dd2e4
...
- (void)enumerateMovesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002dcc06
...
- (id)name;	// IMP=0x00000000002dcb0a
- (id)object;	// IMP=0x00000000002dcaf5
- (void)dealloc;	// IMP=0x00000000002dcaaf
- (id)init;	// IMP=0x00000000002dca80
- (void)_calculateDiffs;	// IMP=0x00000000002ddad6
- (void)_calculateDiffsIfNecessary;	// IMP=0x00000000002dda9f
- (_Bool)_getOldSet:(id *)arg1 newSet:(id *)arg2;	// IMP=0x00000000002dd9bd
...
- (id)_initWithObject:(id)arg1 snapshot:(id)arg2 changedObjects:(id)arg3;	// IMP=0x00000000002dd4b6
- (id)_init;	// IMP=0x00000000002dd4ad
