...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003a4445
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcReply; // @synthesize xpcReply=_xpcReply;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a43da
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a433e
- (id)initWithReply:(id)arg1;	// IMP=0x00000000003a42fc
