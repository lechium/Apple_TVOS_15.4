...
- (void).cxx_destruct;	// IMP=0x000000000002d47e
...
- (void)cancel;	// IMP=0x000000000002d363
- (void)main;	// IMP=0x000000000002d17e
- (id)initWithRequestID:(int)arg1 library:(id)arg2 queue:(id)arg3 cloudResourceType:(unsigned long long)arg4 managedObjectID:(id)arg5 progressHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000002ce91
- (void)_onQueueAsync:(CDUnknownBlockType)arg1;	// IMP=0x000000000002ce79
