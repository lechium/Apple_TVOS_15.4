...
+ (id)styleForEnum:(long long)arg1;	// IMP=0x0000000000250a00
- (void).cxx_destruct;	// IMP=0x00000000002509c2
...
- (id)descriptionForObject:(id)arg1 withIndent:(long long)arg2;	// IMP=0x000000000025086e
- (id)initWithIntialFieldSeparator:(id)arg1 fieldSeparator:(id)arg2 nameValueSeparator:(id)arg3 suffix:(id)arg4 extraIndent:(long long)arg5 prettyPrint:(_Bool)arg6;	// IMP=0x0000000000250744
