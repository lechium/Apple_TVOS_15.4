...
- (void).cxx_destruct;	// IMP=0x00000000002026f9
...
- (id)description;	// IMP=0x00000000002025fa
- (id)secondaryOrderSortKey;	// IMP=0x0000000000202580
- (id)childManagedObject;	// IMP=0x00000000002024fe
