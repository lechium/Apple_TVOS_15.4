...
+ (id)distinctValuesForKeyPath:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000000503fc2
+ (id)entityName;	// IMP=0x0000000000503fb5
+ (id)iptcKeyMap;	// IMP=0x0000000000503f85
- (void)willSave;	// IMP=0x0000000000503c73
- (void)clearEditedIPTCData;	// IMP=0x0000000000503be0
- (void)setIPTCData:(id)arg1;	// IMP=0x0000000000503a2b
- (_Bool)supportsCloudUpload;	// IMP=0x00000000005039e7
- (id)payloadForChangedKeys:(id)arg1;	// IMP=0x000000000044d6bc
- (id)payloadID;	// IMP=0x000000000044d611
