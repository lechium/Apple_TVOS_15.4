...
+ (_Bool)shouldPersistImportedByDisplayName:(id)arg1;	// IMP=0x000000000046db35
+ (id)entityName;	// IMP=0x000000000046db28
+ (id)listOfSyncedProperties;	// IMP=0x000000000046dad2
+ (void)fromExtraDurationData:(id)arg1 getStillDisplayTime:(CDStruct_198678f7 *)arg2 videoDuration:(CDStruct_198678f7 *)arg3;	// IMP=0x0000000000293109
+ (id)newExtraDurationDataFromStillDisplayTime:(CDStruct_198678f7)arg1 videoDuration:(CDStruct_198678f7)arg2;	// IMP=0x00000000002930b2
+ (id)descriptionForDestinationAssetCopyState:(short)arg1;	// IMP=0x000000000046e681
- (void).cxx_destruct;	// IMP=0x000000000046dabf
...
- (void)willSave;	// IMP=0x000000000046cce8
- (void)_updateInferredTimeZoneOffsetWithChangedValues:(id)arg1;	// IMP=0x000000000046ca73
- (void)truncatedOriginalCheckChangedValues:(id)arg1;	// IMP=0x000000000046c7c7
- (_Bool)isUserInterfaceChange;	// IMP=0x000000000046c703
- (_Bool)isSyncableChange;	// IMP=0x000000000046c490
- (_Bool)supportsCloudUpload;	// IMP=0x000000000046c44c
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x000000000046c37c
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x000000000046c2ac
- (id)payloadForChangedKeys:(id)arg1;	// IMP=0x000000000044f865
- (id)payloadID;	// IMP=0x000000000044f7e1
@property(retain, nonatomic) NSString *longDescription;
@property(retain, nonatomic) NSData *mediaMetadataData;
- (void)resetCloudRecoveryState;	// IMP=0x000000000046e66d
- (_Bool)hasCloudRecoveryStateFlagSet:(unsigned long long)arg1;	// IMP=0x000000000046e64a
- (void)removeCloudRecoveryStateFlag:(unsigned long long)arg1;	// IMP=0x000000000046e607
- (void)setCloudRecoveryStateFlag:(unsigned long long)arg1;	// IMP=0x000000000046e5c7
- (_Bool)hasConsistentCloudState;	// IMP=0x000000000046e5ae
- (void)setSceneprintWithData:(id)arg1;	// IMP=0x000000000046e029
