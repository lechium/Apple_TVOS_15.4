...
- (void).cxx_destruct;	// IMP=0x000000000034c931
...
- (id)singleLineDescription;	// IMP=0x000000000034be74
- (id)photosCTLJSONDict;	// IMP=0x000000000034ba22
@property(readonly, nonatomic) NSURL *fileURL;
@property(readonly, nonatomic) short utiConformanceHint;
- (_Bool)isInCloud;	// IMP=0x000000000034b955
- (float)scaleGivenAssetHasAdjustments:(_Bool)arg1 currentWidth:(long long)arg2 currentHeight:(long long)arg3;	// IMP=0x000000000034b943
- (_Bool)isPlayableVideo;	// IMP=0x000000000034b93b
...
- (_Bool)isDerivative;	// IMP=0x000000000034b816
- (_Bool)isDefaultOrientation;	// IMP=0x000000000034b80e
- (id)validateForAssetID:(id)arg1 resourceIdentity:(id)arg2;	// IMP=0x000000000034b748
- (id)initWithRecipe:(id)arg1 forAsset:(id)arg2;	// IMP=0x000000000034b653
- (id)initWithAsset:(id)arg1 resourceType:(unsigned int)arg2 version:(unsigned int)arg3 recipeID:(unsigned int)arg4;	// IMP=0x000000000034b4e5
