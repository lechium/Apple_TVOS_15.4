...
- (void).cxx_destruct;	// IMP=0x0000000000398d0d
...
- (_Bool)canPerformEditOperation:(unsigned long long)arg1;	// IMP=0x0000000000398c9c
...
- (long long)_countOfAssetType:(short)arg1;	// IMP=0x0000000000398aeb
- (id)initWithTitle:(id)arg1 assets:(id)arg2;	// IMP=0x0000000000398a32
