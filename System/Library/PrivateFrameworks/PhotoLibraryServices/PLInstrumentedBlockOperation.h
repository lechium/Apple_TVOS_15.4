...
+ (id)blockOperationWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000004c8b92
...
- (id)description;	// IMP=0x00000000004c88ee
- (void)addExecutionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000004c86f9
- (id)init;	// IMP=0x00000000004c85c9
