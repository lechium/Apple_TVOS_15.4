...
+ (_Bool)records:(id)arg1 containsScopedIdentifier:(id)arg2;	// IMP=0x0000000000276717
- (void).cxx_destruct;	// IMP=0x000000000027666b
...
- (void)organizeRecords:(id)arg1;	// IMP=0x0000000000275cfd
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0000000000275b49
