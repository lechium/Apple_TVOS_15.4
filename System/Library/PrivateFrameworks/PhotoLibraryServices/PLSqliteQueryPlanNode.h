...
- (void).cxx_destruct;	// IMP=0x00000000002d01bb
...
- (id)initWithIdentifier:(int)arg1 parentIdentifier:(int)arg2 unused:(int)arg3 nodeDescription:(id)arg4;	// IMP=0x00000000002d00e5
