...
+ (_Bool)isValidPath:(id)arg1;	// IMP=0x00000000003236cb
- (void).cxx_destruct;	// IMP=0x0000000000323554
...
- (void)_saveMetadata;	// IMP=0x000000000032293d
- (id)_fetchChildUUIDs;	// IMP=0x00000000003223a7
- (_Bool)_readMetadata;	// IMP=0x0000000000321d4c
- (id)description;	// IMP=0x000000000032198a
- (void)updateChildrenOrderingInAlbum:(id)arg1 includePendingAssetChanges:(_Bool)arg2;	// IMP=0x0000000000321628
- (id)insertAlbumFromDataInManagedObjectContext:(id)arg1;	// IMP=0x0000000000321201
- (void)removePersistedAlbumData;	// IMP=0x00000000003211ab
- (void)persistAlbumData;	// IMP=0x0000000000321199
- (id)initWithTitle:(id)arg1 uuid:(id)arg2 cloudGUID:(id)arg3 kind:(id)arg4 assetUUIDs:(id)arg5 persistedAlbumDataDirectory:(id)arg6;	// IMP=0x0000000000320fa0
- (id)initWithPersistedDataAtURL:(id)arg1;	// IMP=0x0000000000320eee
- (id)initWithPLGenericAlbum:(id)arg1 pathManager:(id)arg2;	// IMP=0x0000000000320d17
- (id)init;	// IMP=0x0000000000320c90
