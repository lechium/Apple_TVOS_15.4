...
- (void).cxx_destruct;	// IMP=0x0000000000350b26
...
- (id)newShortLivedLibraryWithName:(const char *)arg1;	// IMP=0x0000000000350aa8
- (id)initWithLibraryServicesManager:(id)arg1;	// IMP=0x00000000003509d3
