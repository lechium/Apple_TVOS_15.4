...
+ (id)filteredIndexesInAlbum:(id)arg1 predicate:(id)arg2;	// IMP=0x00000000001931a4
+ (id)descriptionForAlbumFilter:(int)arg1 parameters:(id)arg2;	// IMP=0x0000000000192f99
+ (id)predicateForAlbumFilter:(int)arg1 parameters:(id)arg2 photoLibrary:(id)arg3;	// IMP=0x000000000019279e
+ (id)unfilteredAlbum:(id)arg1;	// IMP=0x0000000000192787
+ (id)filteredAlbum:(id)arg1 intersectFilter:(int)arg2;	// IMP=0x00000000001926b6
+ (id)filteredAlbum:(id)arg1 predicate:(id)arg2;	// IMP=0x000000000019264a
+ (id)filteredAlbum:(id)arg1 filter:(int)arg2 parameters:(id)arg3;	// IMP=0x00000000001924cd
+ (id)filteredAlbum:(id)arg1 filter:(int)arg2;	// IMP=0x00000000001924b8
- (void).cxx_destruct;	// IMP=0x0000000000192466
...
- (void)insertInternalUserEditableAssets:(id)arg1 atIndexes:(id)arg2 customExportsInfo:(id)arg3 trimmedVideoPathInfo:(id)arg4 commentText:(id)arg5;	// IMP=0x0000000000192316
- (void)replaceFilteredAssetsAtIndexes:(id)arg1 withFilteredValues:(id)arg2;	// IMP=0x0000000000192243
- (void)replaceObjectInFilteredAssetsAtIndex:(unsigned long long)arg1 withObject:(id)arg2;	// IMP=0x000000000019219c
- (void)removeFilteredAssetsAtIndexes:(id)arg1;	// IMP=0x000000000019210b
- (void)insertFilteredAssets:(id)arg1 atIndexes:(id)arg2;	// IMP=0x0000000000192053
- (void)removeObjectFromFilteredAssetsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000191fc8
- (void)insertObject:(id)arg1 inFilteredAssetsAtIndex:(unsigned long long)arg2;	// IMP=0x0000000000191f21
- (id)_editableBackingAlbum;	// IMP=0x0000000000191ef5
- (id)filteredAssetsAtIndexes:(id)arg1;	// IMP=0x0000000000191e2c
- (id)objectInFilteredAssetsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000191d8f
- (unsigned long long)indexInFilteredAssetsOfObject:(id)arg1;	// IMP=0x0000000000191cad
- (unsigned long long)countOfFilteredAssets;	// IMP=0x0000000000191c69
- (Class)derivedChangeNotificationClass;	// IMP=0x0000000000191c58
- (_Bool)mappedDataSourceChanged:(id)arg1 remoteNotificationData:(id)arg2;	// IMP=0x0000000000191bdd
- (_Bool)shouldIncludeObjectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000191b15
- (id)currentStateForChange;	// IMP=0x0000000000191af7
...
- (id)initWithBackingAlbum:(id)arg1 filter:(int)arg2 parameters:(id)arg3;	// IMP=0x00000000001918d8
- (id)initWithBackingAlbum:(id)arg1 predicate:(id)arg2;	// IMP=0x000000000019184b
- (void)_commonInitWithBackingAlbum:(id)arg1 predicate:(id)arg2;	// IMP=0x000000000019162a
- (void)reducePendingItemsCountBy:(unsigned long long)arg1;	// IMP=0x0000000000191624
@property(nonatomic) int pendingItemsType;
@property(nonatomic) int pendingItemsCount;
- (void)backingContextDidChange:(id)arg1;	// IMP=0x0000000000191448
- (void)userDeleteSubscriberRecord:(id)arg1;	// IMP=0x00000000001913d6
- (void)getUnseenStartMarkerIndex:(unsigned long long *)arg1 count:(unsigned long long *)arg2 showsProgress:(_Bool *)arg3;	// IMP=0x00000000001912e2
- (void)updateCloudLastContributionDateWithDate:(id)arg1;	// IMP=0x0000000000191270
- (void)updateCloudLastInterestingChangeDateWithDate:(id)arg1;	// IMP=0x00000000001911fe
- (id)cloudOwnerDisplayNameIncludingEmail:(_Bool)arg1 allowsEmail:(_Bool)arg2;	// IMP=0x000000000019119a
...
- (id)localizedSharedByLabelAllowsEmail:(_Bool)arg1;	// IMP=0x0000000000190fbb
...
- (id)_cloudSharedBackingAlbum;	// IMP=0x000000000018ff81
- (void)batchFetchAssets:(id)arg1;	// IMP=0x000000000018ff0f
...
- (_Bool)canPerformEditOperation:(unsigned long long)arg1;	// IMP=0x000000000018fc6b
...
- (unsigned long long)count;	// IMP=0x000000000018efe7
...
- (void)dealloc;	// IMP=0x000000000018eac4
