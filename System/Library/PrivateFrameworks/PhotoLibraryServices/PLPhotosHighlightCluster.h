...
- (void).cxx_destruct;	// IMP=0x00000000002fe366
...
- (void)_calculatePropertyValues;	// IMP=0x00000000002fde83
- (void)setMoments:(id)arg1;	// IMP=0x00000000002fdb85
- (id)initWithMoments:(id)arg1 dateRangeTitleGenerator:(id)arg2;	// IMP=0x00000000002fdae5
