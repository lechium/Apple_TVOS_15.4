...
+ (id)resourceWithExternalResource:(id)arg1;	// IMP=0x00000000003808c3
- (void).cxx_destruct;	// IMP=0x000000000038087a
...
- (void)persistResourceTypeToFileURL;	// IMP=0x000000000038051c
- (_Bool)isEqualToValidatedExternalResource:(id)arg1;	// IMP=0x00000000003803f9
- (void)setTrashedStateFromURL;	// IMP=0x00000000003802c5
- (void)setQualitySortValueBasedOnAssetWidth:(long long)arg1 height:(long long)arg2 isNativeColorSpace:(_Bool)arg3 isLosslessEncoding:(_Bool)arg4;	// IMP=0x00000000003801a3
- (unsigned long long)cplTypeWithAssetID:(id)arg1;	// IMP=0x0000000000380008
- (_Bool)isPlayableVideo;	// IMP=0x0000000000380000
- (_Bool)isDefaultOrientation;	// IMP=0x000000000037ffe7
@property(readonly, nonatomic) _Bool hasRecipe;
@property(readonly, nonatomic) _Bool isDerivative;
- (id)init;	// IMP=0x000000000037ff7f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000037ff74
