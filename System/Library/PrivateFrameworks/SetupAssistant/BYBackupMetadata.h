...
- (void).cxx_destruct;	// IMP=0x0000000000010eab
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000010a76
- (unsigned long long)hash;	// IMP=0x000000000001078d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000102fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010029
- (void)copyTo:(id)arg1;	// IMP=0x000000000000fdae
- (void)writeTo:(id)arg1;	// IMP=0x000000000000fafd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000faf0
- (id)dictionaryRepresentation;	// IMP=0x000000000000ea64
- (id)description;	// IMP=0x000000000000e9b5
