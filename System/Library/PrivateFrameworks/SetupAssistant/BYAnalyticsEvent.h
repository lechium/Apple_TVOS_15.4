...
+ (id)eventWithName:(id)arg1 withPayload:(id)arg2 persist:(_Bool)arg3;	// IMP=0x000000000001c22d
- (void).cxx_destruct;	// IMP=0x000000000001c3d5
...
- (id)description;	// IMP=0x000000000001c2cd
