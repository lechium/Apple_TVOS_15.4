...
- (void).cxx_destruct;	// IMP=0x00000000000848e8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000848c8
- (id)_initWithAcousticFeatureValues:(id)arg1 frameDuration:(float)arg2;	// IMP=0x0000000000084817
