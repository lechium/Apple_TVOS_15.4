...
- (void).cxx_destruct;	// IMP=0x00000000002a8197
@property(copy, nonatomic) NSArray *pronunciations; // @synthesize pronunciations=_pronunciations;
@property(copy, nonatomic) NSString *token; // @synthesize token=_token;
- (struct TokenProns)_quasarProns;	// IMP=0x00000000002a7bc8
- (id)initWithToken:(id)arg1 pronunciations:(id)arg2;	// IMP=0x00000000002a7ae8
