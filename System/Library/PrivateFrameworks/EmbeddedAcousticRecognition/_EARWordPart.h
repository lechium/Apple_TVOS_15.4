...
- (void).cxx_destruct;	// IMP=0x0000000000055c0b
...
- (id)initWithOrthography:(id)arg1 pronunciations:(id)arg2 tagName:(id)arg3 frequency:(unsigned long long)arg4;	// IMP=0x0000000000055a57
- (id)initWithOrthography:(id)arg1 pronunciations:(id)arg2 tag:(long long)arg3;	// IMP=0x0000000000055950
