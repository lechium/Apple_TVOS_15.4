...
- (void).cxx_destruct;	// IMP=0x0000000000084a11
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000849e7
- (id)_initWithSpeechRecognitionFeatures:(id)arg1 acousticFeatures:(id)arg2 snr:(double)arg3;	// IMP=0x00000000000848f8
