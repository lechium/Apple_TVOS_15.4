...
- (id).cxx_construct;	// IMP=0x00000000000443ea
- (void).cxx_destruct;	// IMP=0x00000000000443b0
- (unsigned long long)drawNoise;	// IMP=0x00000000000442b8
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x0000000000043a62
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x00000000000438ec
- (id)init;	// IMP=0x00000000000438de
