...
- (void).cxx_destruct;	// IMP=0x00000000000438cd
@property(readonly, nonatomic) _Bool doNotTranslate; // @synthesize doNotTranslate=_doNotTranslate;
@property(readonly, nonatomic) struct _NSRange range; // @synthesize range=_range;
@property(readonly, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000438a1
- (id)initWithIdentifier:(id)arg1 range:(struct _NSRange)arg2 doNotTranslate:(_Bool)arg3;	// IMP=0x00000000000437fc
