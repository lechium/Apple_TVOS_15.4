...
- (id).cxx_construct;	// IMP=0x00000000000883ce
- (void).cxx_destruct;	// IMP=0x000000000008836f
...
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x000000000008806b
- (id)description;	// IMP=0x0000000000087f8d
- (void)resetPartialResultContext;	// IMP=0x0000000000087f3a
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x0000000000087e4e
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x0000000000087e44
