...
- (void).cxx_destruct;	// IMP=0x0000000000084b58
...
- (id)description;	// IMP=0x0000000000084b01
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084af6
- (id)initWithVersion:(id)arg1 score:(float)arg2 threshold:(float)arg3;	// IMP=0x0000000000084a39
