...
- (void).cxx_destruct;	// IMP=0x000000000054ad7e
...
- (id)initWithAudioResultMat:(id)arg1 vectorSize:(unsigned long long)arg2 numVectors:(unsigned long long)arg3;	// IMP=0x000000000054ac8a
