...
+ (id)_dayOfWeekFromDate:(id)arg1;	// IMP=0x0000000000007868
+ (id)_hourOfDayFromDate:(id)arg1;	// IMP=0x0000000000007827
+ (void)initialize;	// IMP=0x0000000000007803
- (void).cxx_destruct;	// IMP=0x00000000000077ba
...
- (id)copyRawPayload;	// IMP=0x0000000000007744
- (id)propertyForKey:(id)arg1;	// IMP=0x0000000000007584
- (id)initWithName:(id)arg1 payload:(id)arg2 systemProperties:(id)arg3;	// IMP=0x00000000000074a0
