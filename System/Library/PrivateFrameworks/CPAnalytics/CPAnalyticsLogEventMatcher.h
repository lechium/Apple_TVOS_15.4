...
- (void).cxx_destruct;	// IMP=0x0000000000009359
...
- (_Bool)doesMatch:(id)arg1;	// IMP=0x00000000000092f9
- (id)initWithConfig:(id)arg1;	// IMP=0x0000000000008b2a
- (id)init;	// IMP=0x0000000000008b21
