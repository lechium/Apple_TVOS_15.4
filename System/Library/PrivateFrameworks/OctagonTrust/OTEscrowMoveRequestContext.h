...
- (void).cxx_destruct;	// IMP=0x000000000000b581
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000b48f
- (unsigned long long)hash;	// IMP=0x000000000000b422
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b32a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b266
- (void)copyTo:(id)arg1;	// IMP=0x000000000000b1e3
- (void)writeTo:(id)arg1;	// IMP=0x000000000000b169
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000b15c
- (id)dictionaryRepresentation;	// IMP=0x000000000000b0b2
- (id)description;	// IMP=0x000000000000b003
