...
- (void).cxx_destruct;	// IMP=0x0000000000014a29
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000014896
- (unsigned long long)hash;	// IMP=0x0000000000014792
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000145ba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001448c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000014393
- (void)writeTo:(id)arg1;	// IMP=0x0000000000014287
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001427a
- (id)dictionaryRepresentation;	// IMP=0x0000000000014032
- (id)description;	// IMP=0x0000000000013f83
