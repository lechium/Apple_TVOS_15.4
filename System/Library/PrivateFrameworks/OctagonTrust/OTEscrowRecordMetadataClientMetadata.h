...
- (void).cxx_destruct;	// IMP=0x000000000000aa2f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000a739
- (unsigned long long)hash;	// IMP=0x000000000000a5b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000a2fe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a107
- (void)copyTo:(id)arg1;	// IMP=0x0000000000009f69
- (void)writeTo:(id)arg1;	// IMP=0x0000000000009dcc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000009dbf
- (id)dictionaryRepresentation;	// IMP=0x0000000000009ab4
- (id)description;	// IMP=0x0000000000009a05
