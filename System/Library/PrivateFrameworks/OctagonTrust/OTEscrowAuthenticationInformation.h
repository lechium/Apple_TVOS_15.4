...
- (void).cxx_destruct;	// IMP=0x00000000000033b1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000314e
- (unsigned long long)hash;	// IMP=0x0000000000003027
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002de1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002c3e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000002afe
- (void)writeTo:(id)arg1;	// IMP=0x00000000000029c0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000029b3
- (id)dictionaryRepresentation;	// IMP=0x00000000000027a9
- (id)description;	// IMP=0x00000000000026fa
