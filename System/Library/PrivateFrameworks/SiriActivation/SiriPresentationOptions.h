...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003206b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003211c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000032073
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000031fe3
- (id)init;	// IMP=0x0000000000031fa1
- (id)description;	// IMP=0x0000000000031e97
