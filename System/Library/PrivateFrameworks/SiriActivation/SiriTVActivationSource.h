...
+ (id)activationSourceForIdentifier:(long long)arg1;	// IMP=0x0000000000009ef8
...
- (void)setPTTEligible:(_Bool)arg1;	// IMP=0x000000000000a1e9
- (id)_deviceIdentifier;	// IMP=0x000000000000a1d4
- (void)setListening:(_Bool)arg1;	// IMP=0x000000000000a12a
