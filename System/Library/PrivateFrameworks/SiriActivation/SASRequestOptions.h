...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000028861
- (void).cxx_destruct;	// IMP=0x000000000002b585
...
- (_Bool)_isTypeToSiriPermittedAndEnabledForRequestOptions;	// IMP=0x000000000002b0b3
- (long long)_presentationIdentifierFromUIPresentationIdentifier:(id)arg1;	// IMP=0x000000000002afa9
- (void)_updateWithSystemState:(id)arg1 forcefully:(_Bool)arg2;	// IMP=0x000000000002ac9f
- (void)updateIfNeededWithSystemState:(id)arg1;	// IMP=0x000000000002ac8b
- (_Bool)isATVRemotePTTEligible;	// IMP=0x000000000002ac09
- (_Bool)isHTTRequestSource;	// IMP=0x000000000002abb6
- (_Bool)isH1Activation;	// IMP=0x000000000002ab34
...
- (_Bool)_isForSpeechRequest;	// IMP=0x000000000002a6bc
@property(readonly, nonatomic) long long inputType;
- (id)description;	// IMP=0x00000000000298b7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002910f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000028869
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028248
- (void)_configureStreamingDictationForSource:(long long)arg1;	// IMP=0x00000000000281ff
@property(nonatomic) long long requestSource;
- (id)init;	// IMP=0x0000000000028189
- (id)initWithRequestSource:(long long)arg1 uiPresentationIdentifier:(id)arg2 buttonContext:(id)arg3;	// IMP=0x0000000000028077
- (id)initWithRequestSource:(long long)arg1 uiPresentationIdentifier:(id)arg2 systemState:(id)arg3;	// IMP=0x0000000000027f36
- (id)initWithRequestSource:(long long)arg1 uiPresentationIdentifier:(id)arg2;	// IMP=0x0000000000027f21
- (id)initWithRequestSource:(long long)arg1;	// IMP=0x0000000000027f08
