...
- (void)updatePredictedRouteIsZLL;	// IMP=0x000000000000488c
- (void)_suggestPreheat;	// IMP=0x0000000000004831
- (void)_cancelPreparation;	// IMP=0x0000000000004710
- (void)cancelPreparation;	// IMP=0x00000000000045ab
- (void)prepareForUseAfterTimeInterval:(double)arg1;	// IMP=0x00000000000043e0
