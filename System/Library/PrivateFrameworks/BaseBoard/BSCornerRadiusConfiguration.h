...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000578c1
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000576d6
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x0000000000057612
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x0000000000057587
@property(readonly, nonatomic) _Bool isCongruent;
- (id)initWithTopLeft:(double)arg1 bottomLeft:(double)arg2 bottomRight:(double)arg3 topRight:(double)arg4;	// IMP=0x00000000000574a4
- (id)initWithCornerRadius:(double)arg1;	// IMP=0x0000000000057466
