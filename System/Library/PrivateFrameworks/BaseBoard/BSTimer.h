...
+ (id)scheduledTimerWithFireInterval:(double)arg1 queue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000004b0ab
- (void).cxx_destruct;	// IMP=0x000000000004bd2c
...
- (void)cancel;	// IMP=0x000000000004bc30
- (void)schedule;	// IMP=0x000000000004b64b
...
- (void)dealloc;	// IMP=0x000000000004b48f
- (id)initWithFireInterval:(double)arg1 repeatInterval:(double)arg2 leewayInterval:(double)arg3 queue:(id)arg4 handler:(CDUnknownBlockType)arg5;	// IMP=0x000000000004b185
- (id)initWithFireInterval:(double)arg1 queue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000004b165
