...
- (void).cxx_destruct;	// IMP=0x000000000002959f
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000002908d
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000029029
- (id)succinctDescriptionBuilder;	// IMP=0x000000000002900d
- (id)succinctDescription;	// IMP=0x0000000000028fa9
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028ee2
