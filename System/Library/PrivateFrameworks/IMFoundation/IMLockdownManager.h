...
+ (id)sharedInstance;	// IMP=0x000000000002f7e6
...
- (id)description;	// IMP=0x000000000002faf2
...
- (long long)lockdownState;	// IMP=0x000000000002fa6c
...
- (void)_calculateInstallType;	// IMP=0x000000000002f930
- (void)_setupActivationState;	// IMP=0x000000000002f918
@property(nonatomic, setter=_setState:) unsigned long long _state; // @synthesize _state;
- (void)_resetActivationState;	// IMP=0x000000000002f8ab
- (void)dealloc;	// IMP=0x000000000002f86a
- (id)init;	// IMP=0x000000000002f83b
