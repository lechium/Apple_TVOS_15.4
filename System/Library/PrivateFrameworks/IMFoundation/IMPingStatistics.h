...
- (id)description;	// IMP=0x00000000000448de
@property(readonly, nonatomic) double packetLossRate;
- (void)_addReceivedPacket:(double)arg1;	// IMP=0x000000000004485b
- (void)_addTransmittedPacket:(_Bool)arg1;	// IMP=0x000000000004484b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000447ea
- (id)initWithMaxRTT:(double)arg1 medianRTT:(double)arg2 avgRTT:(double)arg3 minRTT:(double)arg4 transmitted:(int)arg5 successful:(int)arg6 received:(int)arg7;	// IMP=0x000000000004475d
