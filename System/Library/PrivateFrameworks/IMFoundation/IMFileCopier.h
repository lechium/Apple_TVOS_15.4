...
- (void).cxx_destruct;	// IMP=0x000000000002164e
...
- (void)_worker_doCopy;	// IMP=0x0000000000020c3c
- (void)_main_copierFinishedWithResult:(id)arg1;	// IMP=0x0000000000020b52
- (void)cleanup;	// IMP=0x0000000000020a85
- (void)cancel;	// IMP=0x0000000000020a0f
- (void)start;	// IMP=0x000000000002098e
- (void)_fillOutputURLFromInputURL;	// IMP=0x0000000000020726
- (id)_temporaryCopierPath;	// IMP=0x00000000000206d8
- (void)dealloc;	// IMP=0x0000000000020608
- (id)initWithInputURL:(id)arg1 outputURL:(id)arg2 identifier:(id)arg3 operation:(unsigned long long)arg4 completionBlock:(CDUnknownBlockType)arg5 queue:(id)arg6;	// IMP=0x0000000000020469
- (id)initWithInputURL:(id)arg1 outputURL:(id)arg2 identifier:(id)arg3 operation:(unsigned long long)arg4 delegate:(id)arg5;	// IMP=0x0000000000020344
