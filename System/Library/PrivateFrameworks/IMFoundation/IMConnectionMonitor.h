...
+ (id)alloc;	// IMP=0x0000000000022e47
- (void).cxx_destruct;	// IMP=0x0000000000022fb7
...
- (void)clear;	// IMP=0x0000000000022f68
- (void)goDisconnected;	// IMP=0x0000000000022f5c
- (void)goConnectedWithLocalSocketAddress:(id)arg1 remoteSocketAddress:(id)arg2;	// IMP=0x0000000000022f56
- (void)_setup;	// IMP=0x0000000000022f50
- (id)initWithRemoteHost:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000022e9b
