...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004450e
- (void)_returnPacketArrived;	// IMP=0x00000000000444f0
- (void)_markPacketAsTimedOut:(double)arg1;	// IMP=0x0000000000044464
- (id)initWithSequeneceNumber:(int)arg1 timesent:(struct timeval *)arg2 error:(int)arg3;	// IMP=0x000000000004440f
