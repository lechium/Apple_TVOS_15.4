...
+ (id)localizedName:(id)arg1 forLanguage:(id)arg2;	// IMP=0x00000000000165f3
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000015bbf
- (void).cxx_destruct;	// IMP=0x000000000001683b
...
- (id)localizedNameForLanguage:(id)arg1;	// IMP=0x00000000000166da
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000163ce
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016005
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000015d86
- (id)description;	// IMP=0x0000000000015c9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000015c34
- (void)setService:(id)arg1;	// IMP=0x0000000000015c23
- (id)service;	// IMP=0x0000000000015c15
- (id)init;	// IMP=0x0000000000015bc7
