...
@interface PFAssertionInfo : NSObject
{
    ...
    NSArray *_backtrace;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x0000000000012ff5
...
- (_Bool)isWarning;	// IMP=0x0000000000012ee1
- (id)description;	// IMP=0x0000000000012e18
- (id)prettyMethodName;	// IMP=0x0000000000012d0b
