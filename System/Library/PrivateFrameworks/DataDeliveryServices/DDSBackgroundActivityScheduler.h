...
- (void)cancelActivityWithIdentifier:(id)arg1;	// IMP=0x0000000000007226
- (void)scheduleActivityWithIdentifier:(id)arg1 interval:(double)arg2 tolerance:(double)arg3;	// IMP=0x0000000000006cd2
- (id)init;	// IMP=0x0000000000006c67
