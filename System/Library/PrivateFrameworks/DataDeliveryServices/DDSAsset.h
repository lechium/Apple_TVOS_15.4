...
+ (id)debuggingIDsForAssets:(id)arg1;	// IMP=0x0000000000006895
+ (id)uniqueIdentifierForMAAsset:(id)arg1;	// IMP=0x0000000000006497
+ (id)assetWithMAAsset:(id)arg1;	// IMP=0x0000000000005e2c
+ (id)asset;	// IMP=0x0000000000005deb
- (void).cxx_destruct;	// IMP=0x0000000000006c08
...
- (_Bool)isEqualToAsset:(id)arg1;	// IMP=0x0000000000006b20
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006ac7
- (id)description;	// IMP=0x0000000000006a3f
...
- (void)_mergeAttributes:(id)arg1;	// IMP=0x0000000000005f24
- (id)init;	// IMP=0x0000000000005dfd
