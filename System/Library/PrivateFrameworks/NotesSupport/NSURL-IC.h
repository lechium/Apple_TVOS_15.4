...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x0000000000018e7e
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x0000000000018a88
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x0000000000017e2d
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x0000000000017b86
- (id)queryComponents;	// IMP=0x000000000001db1e
@end
