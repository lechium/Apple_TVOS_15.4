...
- (void).cxx_destruct;	// IMP=0x000000000001eaf3
...
- (void)_cancelFireRequests;	// IMP=0x000000000001e9c5
- (void)cancelPreviousFireRequests;	// IMP=0x000000000001e93e
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x000000000001e67c
- (void)fireImmediately;	// IMP=0x000000000001e55a
- (void)requestFire;	// IMP=0x000000000001e218
- (void)dealloc;	// IMP=0x000000000001e173
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x000000000001e056
