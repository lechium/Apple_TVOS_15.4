...
- (void).cxx_destruct;	// IMP=0x00000000000224eb
...
- (_Bool)writeURL:(id)arg1 isDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000000021d86
- (_Bool)open:(id *)arg1;	// IMP=0x0000000000021b56
- (_Bool)finish:(id *)arg1;	// IMP=0x00000000000219ec
- (_Bool)writeURLs:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002159f
- (void)dealloc;	// IMP=0x0000000000021555
- (id)initWithDestinationURL:(id)arg1 baseURL:(id)arg2;	// IMP=0x0000000000021467
