...
- (void).cxx_destruct;	// IMP=0x000000000000314a
...
- (id)initWithService:(id)arg1 isToDefaultPairedDevice:(_Bool)arg2 openError:(unsigned long long)arg3 socketError:(unsigned long long)arg4;	// IMP=0x0000000000003091
