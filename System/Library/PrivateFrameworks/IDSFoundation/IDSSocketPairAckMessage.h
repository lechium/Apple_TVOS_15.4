...
- (id)_nonHeaderData;	// IMP=0x00000000000a6644
- (unsigned char)command;	// IMP=0x00000000000a6639
- (id)initWithSequenceNumber:(unsigned int)arg1;	// IMP=0x00000000000a65f7
- (id)initWithCommand:(unsigned char)arg1 underlyingData:(id)arg2;	// IMP=0x00000000000a6560
