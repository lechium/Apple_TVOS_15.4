...
- (void).cxx_destruct;	// IMP=0x0000000000010308
...
- (id)initWithOwnerHandle:(id)arg1 deviceName:(id)arg2 deviceType:(long long)arg3 deviceColor:(id)arg4 buildVersion:(id)arg5 deviceUniqueID:(id)arg6;	// IMP=0x0000000000010169
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000fff5
- (id)dictionaryRepresentation;	// IMP=0x000000000000fefa
