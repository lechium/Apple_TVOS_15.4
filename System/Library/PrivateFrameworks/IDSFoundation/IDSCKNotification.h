...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x000000000007b015
+ (Class)__class;	// IMP=0x000000000007afc5
- (void).cxx_destruct;	// IMP=0x000000000007b082
