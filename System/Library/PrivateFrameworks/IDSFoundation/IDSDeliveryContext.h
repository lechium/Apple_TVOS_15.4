...
+ (long long)_endpointStateForServerDeliveryStatus:(id)arg1;	// IMP=0x000000000001e20e
- (void).cxx_destruct;	// IMP=0x000000000001e852
...
- (id)initWithResponseCode:(long long)arg1 deviceID:(id)arg2 currentAverageRTT:(id)arg3 isDeviceBlackedOut:(id)arg4 localMessageState:(id)arg5;	// IMP=0x000000000001e588
- (id)initWithResponseCode:(long long)arg1 deviceID:(id)arg2;	// IMP=0x000000000001e512
- (id)initWithResponseCode:(long long)arg1 error:(id)arg2 lastCall:(_Bool)arg3;	// IMP=0x000000000001e476
- (id)initWithError:(id)arg1;	// IMP=0x000000000001e40b
- (id)initWithServerResponseDictionary:(id)arg1;	// IMP=0x000000000001e240
