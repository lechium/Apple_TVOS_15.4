...
- (id)description;	// IMP=0x00000000000eff04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000efef9
- (void)dealloc;	// IMP=0x00000000000efeba
- (id)initWithBackingValue:(void *)arg1;	// IMP=0x00000000000efe6b
