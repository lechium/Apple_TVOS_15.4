...
- (void).cxx_destruct;	// IMP=0x00000000000bf1b2
...
- (id)messageBody;	// IMP=0x00000000000bed13
- (id)requiredKeys;	// IMP=0x00000000000beca1
- (long long)responseCommand;	// IMP=0x00000000000bec96
- (_Bool)wantsResponse;	// IMP=0x00000000000bec8e
- (long long)command;	// IMP=0x00000000000bec83
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bea83
- (id)initWithCertifiedDeliveryContext:(id)arg1;	// IMP=0x00000000000be886
