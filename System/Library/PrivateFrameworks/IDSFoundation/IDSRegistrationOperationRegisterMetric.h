...
- (id)initWithGuid:(id)arg1 success:(_Bool)arg2 connectionType:(unsigned int)arg3 resultCode:(unsigned int)arg4 registrationType:(unsigned int)arg5 isHeartbeatRegister:(_Bool)arg6 heartbeatDelay:(id)arg7 genericError:(id)arg8 URLError:(id)arg9 POSIXError:(id)arg10;	// IMP=0x00000000000743c5
