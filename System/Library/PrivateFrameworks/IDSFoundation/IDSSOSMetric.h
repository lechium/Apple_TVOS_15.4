...
+ (id)metricWithDomain:(unsigned long long)arg1 type:(unsigned long long)arg2 error:(long long)arg3 bagURL:(id)arg4;	// IMP=0x000000000009e2a5
- (void).cxx_destruct;	// IMP=0x000000000009e40e
...
- (id)initWithDomain:(unsigned long long)arg1 type:(unsigned long long)arg2 error:(long long)arg3 bagURL:(id)arg4;	// IMP=0x000000000009e311
