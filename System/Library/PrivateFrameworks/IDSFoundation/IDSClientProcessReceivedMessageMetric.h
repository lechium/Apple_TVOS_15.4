...
- (void).cxx_destruct;	// IMP=0x00000000000be77d
...
- (id)initWithServiceIdentifier:(id)arg1 messageSize:(unsigned long long)arg2 deltaTime:(unsigned long long)arg3 priority:(unsigned long long)arg4;	// IMP=0x00000000000be6c3
