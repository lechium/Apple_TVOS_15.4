...
- (void).cxx_destruct;	// IMP=0x0000000000134e1d
...
- (id)initWithService:(id)arg1 accountType:(id)arg2 fromStorage:(_Bool)arg3 serverTimestamp:(double)arg4 localTimeDelta:(double)arg5;	// IMP=0x0000000000134d26
