...
- (void).cxx_destruct;	// IMP=0x00000000000834c1
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000831f1
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000082ef2
- (id)initWithiCloudID:(id)arg1 appleID:(id)arg2 handles:(id)arg3 devices:(id)arg4;	// IMP=0x0000000000082e10
