...
- (void).cxx_destruct;	// IMP=0x000000000008dd2b
...
- (id)initWithGuid:(id)arg1 numberOfRecipients:(id)arg2 remoteSessionEndReason:(unsigned int)arg3;	// IMP=0x000000000008dc6a
