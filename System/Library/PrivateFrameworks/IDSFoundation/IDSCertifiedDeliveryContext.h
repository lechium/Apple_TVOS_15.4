...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c16d9
- (void).cxx_destruct;	// IMP=0x00000000000c1846
...
- (id)description;	// IMP=0x00000000000c16e1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c1587
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c1281
- (id)dataRepresentation;	// IMP=0x00000000000c11c9
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x00000000000c10e0
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithGUID:(id)arg1 service:(id)arg2 certifiedDeliveryVersion:(long long)arg3 certifiedDeliveryRTS:(id)arg4 senderToken:(id)arg5 failureReason:(id)arg6 failureReasonMessage:(id)arg7 replayKey:(id)arg8 generateDeliveryReceipt:(_Bool)arg9 deliveryStatusContext:(id)arg10 localURI:(id)arg11 remoteURI:(id)arg12 queryHash:(id)arg13;	// IMP=0x00000000000c0c00
- (id)initWithCertifiedDeliveryContext:(id)arg1 queryHash:(id)arg2;	// IMP=0x00000000000c09f2
- (id)initWithGUID:(id)arg1 service:(id)arg2 certifiedDeliveryVersion:(long long)arg3 certifiedDeliveryRTS:(id)arg4 senderToken:(id)arg5 localURI:(id)arg6 remoteURI:(id)arg7 replayKey:(id)arg8;	// IMP=0x00000000000c09a1
- (id)initWithGUID:(id)arg1 service:(id)arg2 certifiedDeliveryVersion:(long long)arg3 certifiedDeliveryRTS:(id)arg4 senderToken:(id)arg5 failureReason:(id)arg6 failureReasonMessage:(id)arg7;	// IMP=0x00000000000c0957
- (id)initWithGUID:(id)arg1 service:(id)arg2 certifiedDeliveryVersion:(long long)arg3 certifiedDeliveryRTS:(id)arg4 senderToken:(id)arg5 localURI:(id)arg6 remoteURI:(id)arg7;	// IMP=0x00000000000c090a
- (id)initWithGUID:(id)arg1 service:(id)arg2 certifiedDeliveryVersion:(long long)arg3 certifiedDeliveryRTS:(id)arg4 senderToken:(id)arg5;	// IMP=0x00000000000c08c4
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000000c0649
