...
- (void).cxx_destruct;	// IMP=0x000000000012f951
...
- (id)initWithService:(id)arg1 linkType:(long long)arg2 wasPrimary:(_Bool)arg3 timeTaken:(double)arg4 numberProcessed:(long long)arg5;	// IMP=0x000000000012f87e
