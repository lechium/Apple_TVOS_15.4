...
- (void).cxx_destruct;	// IMP=0x00000000000ef713
...
- (id)initWithCommand:(long long)arg1 success:(_Bool)arg2 errorDomain:(id)arg3 errorCode:(long long)arg4 retryCount:(long long)arg5;	// IMP=0x00000000000ef64a
