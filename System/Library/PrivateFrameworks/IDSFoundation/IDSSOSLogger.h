...
+ (id)loggerWithURLString:(id)arg1;	// IMP=0x00000000000b0728
+ (id)logger;	// IMP=0x00000000000b070f
- (void).cxx_destruct;	// IMP=0x00000000000b0fc7
...
- (void)logMetric:(id)arg1;	// IMP=0x00000000000b0834
- (id)initWithSOSURLString:(id)arg1;	// IMP=0x00000000000b0771
