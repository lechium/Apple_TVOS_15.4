...
+ (id)alloc;	// IMP=0x00000000000d3322
- (void).cxx_destruct;	// IMP=0x00000000000d4d51
...
- (void)cancel;	// IMP=0x00000000000d4b02
- (void)load;	// IMP=0x00000000000d3726
- (void)dealloc;	// IMP=0x00000000000d35d8
- (id)initWithURLRequest:(id)arg1 completionBlockWithTimingData:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d3429
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d337c
- (_Bool)_connect;	// IMP=0x00000000000d30c0
- (_Bool)_disconnect;	// IMP=0x00000000000d2fba
- (void)_disconnected;	// IMP=0x00000000000d2cd5
