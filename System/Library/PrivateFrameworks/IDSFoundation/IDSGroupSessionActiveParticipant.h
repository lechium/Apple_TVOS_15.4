...
- (void).cxx_destruct;	// IMP=0x0000000000010987
...
- (id)debugDescription;	// IMP=0x0000000000010848
- (id)description;	// IMP=0x000000000001073a
- (id)dictionaryRepresentation;	// IMP=0x0000000000010590
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000010423
- (id)initWithGroupUUID:(id)arg1 participantIdentifier:(unsigned long long)arg2 isKnown:(_Bool)arg3 participantURI:(id)arg4 pushToken:(id)arg5;	// IMP=0x0000000000010351
