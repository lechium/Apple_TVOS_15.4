...
- (void).cxx_destruct;	// IMP=0x0000000000022837
...
- (id)messageBody;	// IMP=0x0000000000022440
- (id)requiredKeys;	// IMP=0x00000000000223b7
- (long long)responseCommand;	// IMP=0x00000000000223ac
- (long long)command;	// IMP=0x00000000000223a1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000022267
- (id)init;	// IMP=0x0000000000022216
