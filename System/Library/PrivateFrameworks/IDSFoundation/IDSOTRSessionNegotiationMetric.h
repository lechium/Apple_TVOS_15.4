...
- (void).cxx_destruct;	// IMP=0x00000000000837dc
...
- (id)initWithService:(id)arg1 priority:(unsigned long long)arg2 duration:(unsigned long long)arg3 result:(unsigned int)arg4;	// IMP=0x0000000000083724
