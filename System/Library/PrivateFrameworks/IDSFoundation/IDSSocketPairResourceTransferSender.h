...
- (void).cxx_destruct;	// IMP=0x00000000000aee85
...
- (void)reset;	// IMP=0x00000000000aed4e
- (id)nextMessage;	// IMP=0x00000000000ae443
- (id)nextMessage_old;	// IMP=0x00000000000adca8
- (id)readNextBytes;	// IMP=0x00000000000adc40
- (_Bool)readNextBytes:(id *)arg1 byteOffset:(unsigned long long *)arg2;	// IMP=0x00000000000ad4c2
- (void)closeFileAndMarkDone;	// IMP=0x00000000000ad490
- (void)dealloc;	// IMP=0x00000000000ad280
- (unsigned char)command;	// IMP=0x00000000000ad275
- (id)description;	// IMP=0x00000000000ad1af
- (id)initWithResourceAtPath:(id)arg1 metadata:(id)arg2 sequenceNumber:(unsigned int)arg3 streamID:(unsigned short)arg4 expectsPeerResponse:(_Bool)arg5 wantsAppAck:(_Bool)arg6 compressPayload:(_Bool)arg7 compressed:(_Bool)arg8 didWakeHint:(_Bool)arg9 peerResponseIdentifier:(id)arg10 messageUUID:(id)arg11 expiryDate:(id)arg12;	// IMP=0x00000000000aca45
