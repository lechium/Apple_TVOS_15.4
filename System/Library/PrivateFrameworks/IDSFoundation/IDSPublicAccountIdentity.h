...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000016483
- (void).cxx_destruct;	// IMP=0x0000000000016580
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016478
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016240
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015fb6
- (id)initWithAccountIdentity:(id)arg1 adminIdentity:(id)arg2 signingIdentity:(id)arg3;	// IMP=0x0000000000015eff
