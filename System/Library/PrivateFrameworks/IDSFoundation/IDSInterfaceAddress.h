...
+ (id)interfaceAddress:(struct ifaddrs *)arg1 eflags:(unsigned long long)arg2 v6flags:(int)arg3 iftype:(int)arg4;	// IMP=0x00000000000de51d
+ (id)interfaceAddressWithTransmittedBytes:(char *)arg1 length:(long long)arg2 withLocalInterfaceName:(id)arg3;	// IMP=0x00000000000ddc00
+ (id)BSSIDWithInterfaceName:(id)arg1;	// IMP=0x00000000000ddbf8
- (void).cxx_destruct;	// IMP=0x00000000000deca0
...
- (id)initWithInterfaceAddress:(struct ifaddrs *)arg1 bflags:(unsigned char)arg2 bssid:(char *)arg3 bssidLength:(unsigned char)arg4;	// IMP=0x00000000000de81a
- (long long)getTransmittableBytes:(char *)arg1 withPrefixByte:(unsigned char)arg2;	// IMP=0x00000000000de691
@property(readonly) unsigned long long IPVersion;
- (id)description;	// IMP=0x00000000000de5b7
