...
- (void).cxx_destruct;	// IMP=0x00000000000f0721
- (void)cancel;	// IMP=0x00000000000f0713
- (void)resume;	// IMP=0x00000000000f0705
- (id)initWithConnection:(id)arg1;	// IMP=0x00000000000f069a
