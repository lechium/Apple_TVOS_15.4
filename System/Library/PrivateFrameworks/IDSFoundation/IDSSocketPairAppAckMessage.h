...
- (void).cxx_destruct;	// IMP=0x00000000000a6c4c
...
- (id)_nonHeaderData;	// IMP=0x00000000000a6a14
- (unsigned char)command;	// IMP=0x00000000000a6a09
- (id)initWithSequenceNumber:(unsigned int)arg1 streamID:(unsigned short)arg2 peerResponseIdentifier:(id)arg3;	// IMP=0x00000000000a6976
- (id)initWithCommand:(unsigned char)arg1 underlyingData:(id)arg2;	// IMP=0x00000000000a66d8
