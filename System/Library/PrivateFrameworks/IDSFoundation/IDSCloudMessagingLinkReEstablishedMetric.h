...
{
    double _inactiveTime;	// 8 = 0x8
    unsigned long long _linkType;	// 16 = 0x10
    unsigned long long _priorLinkType;	// 24 = 0x18
}
...
- (id)initWithInactiveTime:(double)arg1 linkType:(unsigned long long)arg2 priorLinkType:(unsigned long long)arg3;	// IMP=0x000000000000ced5
