...
+ (id)loggerWithCategory:(unsigned short)arg1;	// IMP=0x00000000000f2fbc
@property(readonly, nonatomic) unsigned short category; // @synthesize category=_category;
- (void)logMetric:(id)arg1;	// IMP=0x00000000000f2fe9
- (id)initWithCategory:(unsigned short)arg1;	// IMP=0x00000000000f2f80
