...
- (void).cxx_destruct;	// IMP=0x00000000000c6149
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c261d
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000c256d
- (id)objectForKey:(id)arg1;	// IMP=0x00000000000c24e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c2447
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c2384
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000c22b4
- (id)init;	// IMP=0x00000000000c22a0
