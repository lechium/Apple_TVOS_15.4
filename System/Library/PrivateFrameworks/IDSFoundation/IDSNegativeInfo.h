...
- (id)description;	// IMP=0x0000000000021146
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002113b
- (id)initWithTime:(double)arg1 count:(long long)arg2;	// IMP=0x00000000000210ef
