...
- (void).cxx_destruct;	// IMP=0x00000000000a5f24
...
- (id)_nonHeaderData;	// IMP=0x00000000000a5d34
@property(readonly, nonatomic) NSData *data;
- (unsigned char)command;	// IMP=0x00000000000a5c59
- (id)description;	// IMP=0x00000000000a5bf1
- (id)initWithVersion:(unsigned char)arg1 encrypted:(_Bool)arg2 streamID:(unsigned short)arg3 priority:(unsigned short)arg4 sequenceNumber:(unsigned int)arg5 fileXfer:(_Bool)arg6 data:(id)arg7;	// IMP=0x00000000000a5b1e
- (id)initWithCommand:(unsigned char)arg1 underlyingData:(id)arg2;	// IMP=0x00000000000a5933
