...
@interface IDSKeyTransparencyTrustedDeviceVerificationMetric : NSObject <CUTRTCMetric>
{
    ...
    unsigned long long _numberOfTotalDevices;	// 104 = 0x68
    unsigned long long _numberOfCandidateDevices;	// 112 = 0x70
    unsigned long long _numberOfMatchesFromCloudKit;	// 120 = 0x78
    unsigned long long _numberOfMatchesFromAccountKey;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x000000000010a0bc
