...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007299d
- (void).cxx_destruct;	// IMP=0x0000000000072f50
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000072e50
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000072c20
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000729a5
- (id)initWithPublicLegacyIdentity:(id)arg1 modernIdentity:(id)arg2 accountIdentity:(id)arg3;	// IMP=0x00000000000728e6
