...
- (void).cxx_destruct;	// IMP=0x0000000000137bbc
...
- (id)initWithRegistrationType:(int)arg1 serviceIdentifier:(id)arg2 wasSuccessful:(_Bool)arg3 registrationError:(long long)arg4 circleStatus:(long long)arg5;	// IMP=0x000000000013790a
