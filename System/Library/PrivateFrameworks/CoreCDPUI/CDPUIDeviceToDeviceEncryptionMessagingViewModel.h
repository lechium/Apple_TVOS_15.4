...
- (void).cxx_destruct;	// IMP=0x000000000000bb27
...
- (id)cancelTitle;	// IMP=0x000000000000baf0
- (id)continueTitle;	// IMP=0x000000000000bae3
- (id)message;	// IMP=0x000000000000bad6
- (id)title;	// IMP=0x000000000000bac9
- (id)initWithContext:(id)arg1 is2FA:(_Bool)arg2 hasLocalSecret:(_Bool)arg3;	// IMP=0x000000000000ba59
