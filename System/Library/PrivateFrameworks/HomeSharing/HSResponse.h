...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x000000000001059b
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00000000000104de
- (void).cxx_destruct;	// IMP=0x0000000000010495
...
- (id)description;	// IMP=0x00000000000103a6
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x000000000001028b
