...
+ (id)homeSharingBrowserWithGroupID:(id)arg1;	// IMP=0x0000000000012966
- (void).cxx_destruct;	// IMP=0x00000000000120da
...
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x0000000000011e1c
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x000000000001161f
- (void)_removalTimerFired:(id)arg1;	// IMP=0x0000000000011471
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x00000000000110b3
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x0000000000010f22
- (void)netServiceBrowser:(id)arg1 didNotSearch:(id)arg2;	// IMP=0x0000000000010e14
- (void)stop;	// IMP=0x0000000000010da3
- (void)start;	// IMP=0x0000000000010d32
- (id)initWithBrowserType:(long long)arg1 groupID:(id)arg2;	// IMP=0x0000000000010b66
