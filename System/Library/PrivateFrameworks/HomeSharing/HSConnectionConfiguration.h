...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000434e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004171
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000407d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003e8d
- (id)init;	// IMP=0x0000000000003d16
