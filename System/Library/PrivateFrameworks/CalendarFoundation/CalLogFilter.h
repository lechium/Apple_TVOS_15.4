...
- (void).cxx_destruct;	// IMP=0x000000000002e2d6
...
- (_Bool)proceedProcessingLogName:(id)arg1;	// IMP=0x000000000002df2a
- (id)generateRegexesForPatterns:(id)arg1;	// IMP=0x00000000000031e2
- (id)description;	// IMP=0x000000000002dc85
- (id)init;	// IMP=0x00000000000024b0
