...
- (void).cxx_destruct;	// IMP=0x000000000004ab09
...
- (void)stop;	// IMP=0x000000000004aaac
- (void)start;	// IMP=0x000000000004a4de
- (id)description;	// IMP=0x000000000004a3ab
- (void)dealloc;	// IMP=0x000000000004a36c
- (id)initWithPath:(id)arg1 eventBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000004a218
- (id)init;	// IMP=0x000000000004a1ed
