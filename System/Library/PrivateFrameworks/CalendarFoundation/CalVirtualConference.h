...
- (void).cxx_destruct;	// IMP=0x00000000000179f3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001784e
- (id)description;	// IMP=0x0000000000017719
- (id)initWithTitle:(id)arg1 joinMethods:(id)arg2 conferenceDetails:(id)arg3 source:(unsigned long long)arg4 isWritable:(_Bool)arg5;	// IMP=0x000000000001764f
