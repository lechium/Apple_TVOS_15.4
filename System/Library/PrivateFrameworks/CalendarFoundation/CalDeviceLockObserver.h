...
+ (id)stateChangedNotificationName;	// IMP=0x000000000003ecce
+ (_Bool)hasBeenUnlockedSinceBoot;	// IMP=0x000000000003ecc6
- (void).cxx_destruct;	// IMP=0x000000000003ed6a
...
- (void)_notificationReceived;	// IMP=0x000000000003e6cc
- (id)initWithStateChangedCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000003e56f
- (id)init;	// IMP=0x000000000003e550
