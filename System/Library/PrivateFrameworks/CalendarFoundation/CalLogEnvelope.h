...
- (void).cxx_destruct;	// IMP=0x0000000000003f35
...
- (id)description;	// IMP=0x0000000000058a81
- (id)initWithLogName:(id)arg1 level:(int)arg2 message:(id)arg3;	// IMP=0x0000000000001f3f
- (id)init;	// IMP=0x0000000000058a56
