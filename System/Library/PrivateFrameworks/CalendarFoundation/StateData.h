...
- (void).cxx_destruct;	// IMP=0x0000000000024287
...
- (id)description;	// IMP=0x0000000000023f72
- (void)resetToNewSection;	// IMP=0x0000000000023f49
- (id)init;	// IMP=0x0000000000023e84
