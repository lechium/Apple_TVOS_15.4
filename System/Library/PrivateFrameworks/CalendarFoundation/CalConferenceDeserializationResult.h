...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000017be7
- (id)description;	// IMP=0x0000000000017ada
- (id)initWithConference:(id)arg1 range:(struct _NSRange)arg2 blockTitle:(id)arg3;	// IMP=0x0000000000017a26
