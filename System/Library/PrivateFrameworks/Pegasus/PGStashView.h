...
- (void)resetChevronState;	// IMP=0x0000000000042153
- (void)setChevronHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x000000000004211d
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000041ec2
- (void)layoutStashChevrons;	// IMP=0x0000000000041b08
- (void)layoutSubviews;	// IMP=0x000000000004191a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000412e0
