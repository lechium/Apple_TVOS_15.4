...
- (void).cxx_destruct;	// IMP=0x0000000000013816
...
- (void)invalidate;	// IMP=0x00000000000136db
- (oneway void)revokeAuthorization;	// IMP=0x00000000000136c4
- (oneway void)grantAuthorizationForActivitySessionWithIdentifier:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x000000000001361e
@property(readonly, nonatomic, getter=isConnectionActive) _Bool connectionActive;
- (void)transitionToStateIfPossible:(long long)arg1;	// IMP=0x000000000001335b
@property(readonly, nonatomic) long long state;
@property(readonly, copy) NSString *bundleIdentifier;
@property(readonly, copy) NSString *activitySessionIdentifier;
- (id)initWithConnection:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000013223
