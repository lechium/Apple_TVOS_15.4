...
- (void).cxx_destruct;	// IMP=0x0000000000031563
...
- (void)layoutSubviews;	// IMP=0x0000000000031054
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000030f8c
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000030f6f
- (double)_continuousCornerRadius;	// IMP=0x0000000000030f52
- (struct CGRect)_mainBodyBounds;	// IMP=0x0000000000030edf
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000030960
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000030227
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000030205
