...
+ (id)summaryFromSummaries:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x00000000000139ac
- (void).cxx_destruct;	// IMP=0x0000000000015d14
...
- (id)initWithDictionary:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x00000000000151bb
