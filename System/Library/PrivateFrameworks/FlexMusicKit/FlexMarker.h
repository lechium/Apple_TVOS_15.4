...
- (unsigned long long)_decodeTypeAndBarsFromName;	// IMP=0x000000000001726c
- (id)init;	// IMP=0x0000000000017231
- (id)encodeAsDictionary;	// IMP=0x0000000000017113
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000017002
- (id)initWithName:(id)arg1 markerID:(long long)arg2 position:(long long)arg3;	// IMP=0x0000000000016f51
