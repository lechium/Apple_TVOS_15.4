...
+ (id)operationWithRequest:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000000d4de
- (void).cxx_destruct;	// IMP=0x000000000000d4cb
@property(retain, nonatomic) SBKRequest *SBKRequest; // @synthesize SBKRequest=_SBKRequest;
- (id)description;	// IMP=0x000000000000d3f7
@property(nonatomic) _Bool shouldAuthenticate; // @synthesize shouldAuthenticate=_shouldAuthenticate;
- (id)_init;	// IMP=0x000000000000d1f7
