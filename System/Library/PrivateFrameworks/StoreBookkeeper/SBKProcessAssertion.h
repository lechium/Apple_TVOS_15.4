...
- (void).cxx_destruct;	// IMP=0x000000000001131b
@property(retain, nonatomic) id expirationObserver; // @synthesize expirationObserver=_expirationObserver;
@property(readonly, nonatomic) unsigned long long identifier; // @synthesize identifier=_identifier;
- (void)invalidate;	// IMP=0x00000000000112ab
- (void)_expireBackgroundTask;	// IMP=0x00000000000111e1
@property(retain, nonatomic) BKSProcessAssertion *bkProcessAssertion; // @synthesize bkProcessAssertion=_bkProcessAssertion;
- (void)_onQueueSetBkProcessAssertion:(id)arg1;	// IMP=0x0000000000010f07
- (void)dealloc;	// IMP=0x0000000000010e87
- (id)description;	// IMP=0x0000000000010e01
- (id)initWithExpirationBlock:(CDUnknownBlockType)arg1 debugDescription:(id)arg2;	// IMP=0x0000000000010a21
