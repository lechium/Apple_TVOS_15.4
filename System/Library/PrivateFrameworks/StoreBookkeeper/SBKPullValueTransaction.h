...
- (void).cxx_destruct;	// IMP=0x000000000001e4eb
...
- (void)processDataInResponse:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001e299
- (id)newRequest;	// IMP=0x000000000001e274
- (id)clampsKey;	// IMP=0x000000000001e1fb
- (id)description;	// IMP=0x000000000001e093
- (id)initWithStoreBagContext:(id)arg1 requestedKey:(id)arg2 clientItemPayloadPair:(id)arg3 clientItemVersionAnchor:(id)arg4;	// IMP=0x000000000001df5d
