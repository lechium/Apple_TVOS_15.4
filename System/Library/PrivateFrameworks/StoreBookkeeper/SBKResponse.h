...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x0000000000024d1d
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 responseDictionary:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x0000000000024c60
+ (id)responseWithURLResponse:(id)arg1 responseDictionary:(id)arg2;	// IMP=0x0000000000024bf4
- (void).cxx_destruct;	// IMP=0x00000000000243f9
...
- (id)description;	// IMP=0x0000000000024213
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 responseDictionary:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x000000000002400e
- (id)initWithURLResponse:(id)arg1 responseDictionary:(id)arg2;	// IMP=0x0000000000023f23
