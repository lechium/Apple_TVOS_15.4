...
+ (long long)conflictDetectionType;	// IMP=0x000000000002179b
- (void).cxx_destruct;	// IMP=0x00000000000218e1
...
- (void)runWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000217a3
