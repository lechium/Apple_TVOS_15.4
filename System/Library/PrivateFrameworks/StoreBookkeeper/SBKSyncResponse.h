...
+ (id)responseWithResponse:(id)arg1 transaction:(id)arg2;	// IMP=0x000000000001e980
- (void).cxx_destruct;	// IMP=0x000000000001ea9e
@property(readonly, nonatomic) SBKSyncResponseData *syncResponseData; // @synthesize syncResponseData=_syncResponseData;
- (void)deserializeResponseBodyWithTransaction:(id)arg1;	// IMP=0x000000000001e9f4
