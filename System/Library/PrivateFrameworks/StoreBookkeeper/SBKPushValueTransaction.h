...
- (void).cxx_destruct;	// IMP=0x000000000001099b
...
- (id)_resolveConflictBetweenClientPayloadPair:(id)arg1 andServerPayloadPair:(id)arg2;	// IMP=0x000000000001088b
- (void)processDataInResponse:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000010636
- (id)newRequest;	// IMP=0x0000000000010611
- (id)clampsKey;	// IMP=0x0000000000010573
- (id)description;	// IMP=0x00000000000103d1
- (id)initWithStoreBagContext:(id)arg1 clientItemPayloadPair:(id)arg2 clientItemVersionAnchor:(id)arg3;	// IMP=0x0000000000010291
