...
+ (void)_maximumAscentAndDescentForRuns:(struct __CFArray *)arg1 ascender:(double *)arg2 descender:(double *)arg3;	// IMP=0x0000000000095740
+ (void)_lineMetricsForAttributes:(id)arg1 typesetterBehavior:(long long)arg2 usesFontLeading:(_Bool)arg3 applySpacings:(_Bool)arg4 usesSystemFontLeading:(_Bool)arg5 usesNegativeFontLeading:(_Bool)arg6 layoutOrientation:(long long)arg7 lineHeight:(double *)arg8 baselineOffset:(double *)arg9 spacing:(double *)arg10;	// IMP=0x0000000000095632
+ (_Bool)_allowsFontOverridingTextAttachmentVerticalMetricsForStringDrawing;	// IMP=0x0000000000094d76
- (void).cxx_destruct;	// IMP=0x000000000009d418
...
- (struct CGRect)_stringDrawingCoreTextEngineWithOriginalString:(id)arg1 rect:(struct CGRect)arg2 padding:(double)arg3 graphicsContext:(id)arg4 forceClipping:(_Bool)arg5 attributes:(id)arg6 stringDrawingOptions:(long long)arg7 drawingContext:(id)arg8 stringDrawingInterface:(CDStruct_75b03505 *)arg9;	// IMP=0x0000000000097b14
- (int)_NSFastDrawString:(id)arg1 length:(unsigned long long)arg2 attributes:(id)arg3 paragraphStyle:(id)arg4 typesetterBehavior:(long long)arg5 lineBreakMode:(long long)arg6 rect:(struct CGRect)arg7 padding:(double)arg8 graphicsContext:(id)arg9 baselineRendering:(_Bool)arg10 usesFontLeading:(_Bool)arg11 usesScreenFont:(_Bool)arg12 scrollable:(_Bool)arg13 syncAlignment:(_Bool)arg14 mirrored:(_Bool)arg15 boundingRectPointer:(struct CGRect *)arg16 baselineOffsetPointer:(double *)arg17 drawingContext:(id)arg18;	// IMP=0x0000000000096099
- (id)softHyphen;	// IMP=0x000000000009608c
- (CDStruct_39925896)_getLineMetricsForRange:(struct _NSRange)arg1 attributes:(id)arg2 attributedString:(id)arg3 applySpacing:(_Bool)arg4 usesSystemFontLeading:(_Bool)arg5 usesNegativeFontLeading:(_Bool)arg6;	// IMP=0x0000000000095838
- (void)layout;	// IMP=0x0000000000094eb2
- (void)dealloc;	// IMP=0x0000000000094e4c
- (id)init;	// IMP=0x0000000000094dbc
