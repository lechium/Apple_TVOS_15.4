...
- (void)setApplicationFrameworkContext:(long long)arg1;	// IMP=0x000000000008ec73
- (long long)applicationFrameworkContext;	// IMP=0x000000000008ec61
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008e8d1
- (id)description;	// IMP=0x000000000008e81d
- (void)dealloc;	// IMP=0x000000000008e7c9
- (id)init;	// IMP=0x000000000008e775
