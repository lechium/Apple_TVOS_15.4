...
- (void)invalidateAttachmentMeasurements;	// IMP=0x00000000000faa6b
- (void)_invalidateLocations;	// IMP=0x00000000000faa49
...
- (id)textLayoutFragment;	// IMP=0x00000000000fa86d
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x00000000000fa709
- (void)_queryLayout;	// IMP=0x00000000000fa3b7
- (void)dealloc;	// IMP=0x00000000000fa358
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x00000000000fa25b
