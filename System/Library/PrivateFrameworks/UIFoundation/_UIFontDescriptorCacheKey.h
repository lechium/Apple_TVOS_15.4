...
- (id)description;	// IMP=0x00000000000c22e4
- (_Bool)_isEqualToKey:(id)arg1;	// IMP=0x00000000000c220e
- (unsigned long long)_hash;	// IMP=0x00000000000c214e
- (void)dealloc;	// IMP=0x00000000000c20f6
