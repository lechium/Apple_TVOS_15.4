...
- (void)invalidateElementsInRange:(id)arg1 delta:(long long)arg2;	// IMP=0x00000000000aed4f
- (void)setObject:(id)arg1 forRange:(id)arg2;	// IMP=0x00000000000ae652
- (id)enumerateObjectsFromLocation:(id)arg1 options:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000addb8
@property(readonly) long long baseIndex;
@property(readonly) id <NSTextLocation> baseLocation;
- (id)description;	// IMP=0x00000000000ad7cd
- (void)dealloc;	// IMP=0x00000000000ad772
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000000ad671
