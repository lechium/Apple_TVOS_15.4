...
- (void)enumerateViewportElementsFromLocation:(id)arg1 options:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000fb27d
- (struct CGRect)proposedLineFragmentRectForLocation:(id)arg1 attributes:(id)arg2 baselineOffset:(out double *)arg3;	// IMP=0x00000000000fb0c2
- (id)textContainerForLocation:(id)arg1;	// IMP=0x00000000000fb098
- (void)reset;	// IMP=0x00000000000fafeb
@property(readonly, copy) NSArray *textAttachmentViewProviders;
- (id)_sortedKeys;	// IMP=0x00000000000fadef
- (void)_flushCachedInfo;	// IMP=0x00000000000fadb7
- (id)textAttachmentLayoutInfoForLocation:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000000fac57
@property(readonly) id <NSTextLocation> baseLocation;
- (void)dealloc;	// IMP=0x00000000000fabdc
- (id)init;	// IMP=0x00000000000fabc8
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000fab74
- (void)_adjustLocations;	// IMP=0x00000000000faaa0
