...
- (id)correctedString;	// IMP=0x000000000002b9c0
- (id)correctionResult;	// IMP=0x000000000002b9b6
- (id)description;	// IMP=0x000000000002b94f
- (void)dealloc;	// IMP=0x000000000002b905
- (id)initWithCorrectionResult:(id)arg1 correctedString:(id)arg2;	// IMP=0x000000000002b887
