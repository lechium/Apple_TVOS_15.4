...
+ (_Bool)usesEncodedMessages;	// IMP=0x000000000001529f
- (void).cxx_destruct;	// IMP=0x00000000000133c5
...
- (void)startWithConnectionProperties:(id)arg1;	// IMP=0x000000000001321c
- (id)newSessionTaskOnSession:(id)arg1 withURLRequest:(id)arg2;	// IMP=0x00000000000131fb
- (id)newSessionWithDelegate:(id)arg1 delegateQueue:(id)arg2 connectionProperties:(id)arg3;	// IMP=0x00000000000131eb
- (id)newSessionWithDelegate:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x00000000000131db
- (id)newMutableURLRequestWithURL:(id)arg1;	// IMP=0x00000000000131af
- (id)decodeResponseData:(id)arg1;	// IMP=0x00000000000131a2
- (void)encodeRequestData:(id)arg1 startRequestCallback:(CDUnknownBlockType)arg2;	// IMP=0x000000000001318f
@property(readonly, nonatomic) unsigned long long requestResponseTime;
- (void)URLSession:(id)arg1 didReceiveChallenge:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000012fcc
- (void)URLSession:(id)arg1 task:(id)arg2 _willSendRequestForEstablishedConnection:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000012dba
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000000000126be
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000000000124be
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000012230
- (id)tryReadResponseData:(id)arg1 forRequest:(id)arg2 forResponseClass:(Class)arg3;	// IMP=0x000000000001211b
- (_Bool)readResponsePreamble:(id)arg1;	// IMP=0x0000000000012057
- (void)cancelWithErrorCode:(long long)arg1;	// IMP=0x0000000000012048
- (void)resume;	// IMP=0x0000000000012007
- (_Bool)isPaused;	// IMP=0x0000000000011ff7
- (void)pause;	// IMP=0x0000000000011f19
- (void)cancel;	// IMP=0x0000000000011d83
- (void)start;	// IMP=0x0000000000011d79
- (void)writeRequest:(id)arg1 into:(id)arg2;	// IMP=0x0000000000011cb3
- (id)requestPreamble;	// IMP=0x0000000000011a46
- (void)setHttpRequestHeader:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000119b0
@property(copy, nonatomic) NSDictionary *httpRequestHeaders;
- (void)handleResponse:(id)arg1 forInternalRequest:(id)arg2;	// IMP=0x0000000000011956
- (id)responseForInternalRequest:(id)arg1;	// IMP=0x00000000000118a3
- (void)addInternalRequest:(id)arg1;	// IMP=0x0000000000011838
- (id)internalRequests;	// IMP=0x0000000000011827
- (id)responseForRequest:(id)arg1;	// IMP=0x000000000001177a
- (void)addRequest:(id)arg1;	// IMP=0x000000000001171b
- (void)clearRequests;	// IMP=0x0000000000011705
@property(readonly, nonatomic) __weak NSArray *requests;
- (void)setNeedsCancel;	// IMP=0x00000000000116e5
@property(nonatomic) _Bool ignoresResponse;
- (void)dealloc;	// IMP=0x0000000000011667
- (id)initWithURL:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x000000000001148a
