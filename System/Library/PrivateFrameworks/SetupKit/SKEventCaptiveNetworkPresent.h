...
- (void).cxx_destruct;	// IMP=0x000000000000cab2
...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000000000c907
- (id)initWithCaptiveURL:(id)arg1 interfaceIdentifier:(id)arg2 ssid:(id)arg3;	// IMP=0x000000000000c809
