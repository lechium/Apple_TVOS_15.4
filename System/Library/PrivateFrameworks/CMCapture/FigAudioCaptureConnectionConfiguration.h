...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006390
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000062f7
- (id)description;	// IMP=0x0000000000006180
- (id)copyXPCEncoding;	// IMP=0x00000000000060e0
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000006041
