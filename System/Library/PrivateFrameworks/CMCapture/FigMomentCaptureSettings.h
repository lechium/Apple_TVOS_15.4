...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002e4bc
...
- (id)description;	// IMP=0x000000000002ea49
- (unsigned long long)hash;	// IMP=0x000000000002ea3f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002e8a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002e79e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002e661
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002e50c
- (id)initWithSettingsID:(long long)arg1 userInitiatedCaptureTime:(unsigned long long)arg2;	// IMP=0x000000000002e4c4
