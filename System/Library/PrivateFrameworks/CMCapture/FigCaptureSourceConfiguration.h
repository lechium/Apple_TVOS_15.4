...
+ (id)stringForSourceDeviceType:(int)arg1;	// IMP=0x0000000000009ab4
+ (id)stringForSourcePosition:(int)arg1;	// IMP=0x0000000000009a7e
+ (int)sourceTypeForString:(id)arg1;	// IMP=0x0000000000009a25
+ (id)stringForSourceType:(int)arg1;	// IMP=0x0000000000009a11
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000009176
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008d40
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000087dd
- (id)copyXPCEncoding;	// IMP=0x00000000000081fb
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000007e7e
- (id)initWithSourceType:(int)arg1;	// IMP=0x0000000000007e43
- (id)initWithSource:(struct OpaqueFigCaptureSource *)arg1;	// IMP=0x0000000000007deb
