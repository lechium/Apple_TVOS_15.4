...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001d015
...
- (id)description;	// IMP=0x000000000001d574
- (void)dealloc;	// IMP=0x000000000001d4e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001d3d8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001d252
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d01d
