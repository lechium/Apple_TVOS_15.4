...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016be5
- (id)debugDescription;	// IMP=0x0000000000016b82
- (id)description;	// IMP=0x0000000000016a9d
@property(readonly, nonatomic) double standardDeviation;
@property(readonly, nonatomic) double average;
- (void)removeDataPoint:(double)arg1;	// IMP=0x00000000000169e6
- (void)addDataPoint:(double)arg1;	// IMP=0x0000000000016984
- (void)dealloc;	// IMP=0x0000000000016949
- (id)initWithStats:(id)arg1;	// IMP=0x000000000001687b
- (id)init;	// IMP=0x00000000000167f0
