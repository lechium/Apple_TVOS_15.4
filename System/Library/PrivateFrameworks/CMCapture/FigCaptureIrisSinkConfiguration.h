...
- (int)sinkType;	// IMP=0x000000000000cebd
- (void)dealloc;	// IMP=0x000000000000ce65
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c97d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c63e
- (id)description;	// IMP=0x000000000000c310
- (id)copyXPCEncoding;	// IMP=0x000000000000bf7b
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x000000000000bcdf
