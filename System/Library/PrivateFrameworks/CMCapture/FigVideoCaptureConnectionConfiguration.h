...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005d49
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005be7
- (id)description;	// IMP=0x00000000000059c5
- (void)dealloc;	// IMP=0x0000000000005996
- (id)copyXPCEncoding;	// IMP=0x000000000000581a
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000000000056c6
