...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002ef74
...
- (void)dealloc;	// IMP=0x000000000002f374
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002f2a3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002f160
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002efab
- (id)init;	// IMP=0x000000000002ef7c
