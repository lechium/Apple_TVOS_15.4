...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000018d10
...
- (id)figCaptureIrisPreparedSettingsRepresentation;	// IMP=0x000000000001c8b0
- (void)setBracketType:(int)arg1 imageCount:(unsigned int)arg2;	// IMP=0x000000000001c799
...
- (id)description;	// IMP=0x000000000001b864
- (unsigned long long)hash;	// IMP=0x000000000001b85a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001a917
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001a2c5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019920
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000018f04
- (void)dealloc;	// IMP=0x0000000000018e02
- (id)initWithSettingsID:(long long)arg1;	// IMP=0x0000000000018d18
