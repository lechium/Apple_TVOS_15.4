...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005341
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000516b
- (void)dealloc;	// IMP=0x000000000000511a
- (id)copyXPCEncoding;	// IMP=0x0000000000005017
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000004eee
- (id)init;	// IMP=0x0000000000004eb6
