...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002f45a
...
- (id)description;	// IMP=0x000000000002fd44
- (void)dealloc;	// IMP=0x000000000002fca6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002fa61
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002f7b9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002f491
- (id)init;	// IMP=0x000000000002f462
