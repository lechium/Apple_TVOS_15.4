...
- (id)figCaptureStillImageSettingsRepresentation;	// IMP=0x000000000001dd7a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001dc13
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001da37
- (id)copyXPCEncoding;	// IMP=0x000000000001d943
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x000000000001d830
- (void)dealloc;	// IMP=0x000000000001d7f5
- (id)init;	// IMP=0x000000000001d7c6
