...
- (int)sinkType;	// IMP=0x000000000000af31
- (void)dealloc;	// IMP=0x000000000000aed9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ac31
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000aab8
- (id)description;	// IMP=0x000000000000a8bf
- (id)copyXPCEncoding;	// IMP=0x000000000000a618
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x000000000000a2cc
- (id)init;	// IMP=0x000000000000a278
