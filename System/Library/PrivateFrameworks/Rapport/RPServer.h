...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000051c4b
- (void).cxx_destruct;	// IMP=0x0000000000053427
...
- (void)xpcServerHidePassword:(unsigned int)arg1;	// IMP=0x00000000000531f7
- (void)xpcServerShowPassword:(id)arg1 flags:(unsigned int)arg2;	// IMP=0x0000000000053149
- (void)xpcServerAcceptSession:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000005308c
- (void)_update;	// IMP=0x0000000000052f6d
- (void)_updateIfNeededWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000052e96
- (void)tryPassword:(id)arg1;	// IMP=0x0000000000052e90
- (void)_invalidated;	// IMP=0x0000000000052d95
- (void)invalidate;	// IMP=0x0000000000052cb5
- (void)_interrupted;	// IMP=0x0000000000052c2d
- (void)_ensureXPCStarted;	// IMP=0x0000000000052a21
- (void)_activateWithReactivate:(_Bool)arg1;	// IMP=0x0000000000052682
- (void)activate;	// IMP=0x0000000000052513
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x00000000000520ac
- (id)description;	// IMP=0x0000000000052095
- (void)dealloc;	// IMP=0x0000000000052048
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000051f40
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000051cce
- (id)init;	// IMP=0x0000000000051c53
