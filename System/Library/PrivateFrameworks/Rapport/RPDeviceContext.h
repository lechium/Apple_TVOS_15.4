...
- (void).cxx_destruct;	// IMP=0x000000000004266b
...
- (void)systemInfoResponse:(id)arg1 error:(id)arg2;	// IMP=0x00000000000424b1
- (void)pairVerify;	// IMP=0x0000000000042216
- (void)invalidate;	// IMP=0x00000000000421cc
