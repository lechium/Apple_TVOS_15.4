...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000026600
+ (id)nullEndpoint;	// IMP=0x00000000000265ab
- (void).cxx_destruct;	// IMP=0x00000000000289b9
...
- (_Bool)isEqualToDevice:(id)arg1;	// IMP=0x000000000002864d
- (_Bool)removeSFDevice:(id)arg1;	// IMP=0x00000000000285eb
- (unsigned int)updateWithSFDevice:(id)arg1;	// IMP=0x0000000000027b1f
- (unsigned int)removeIDSDevice;	// IMP=0x0000000000027ac8
- (unsigned int)updateWithIDSDevice:(id)arg1;	// IMP=0x0000000000027713
- (_Bool)removeBonjourDevice:(id)arg1;	// IMP=0x00000000000276da
- (unsigned int)updateWithBonjourDevice:(id)arg1;	// IMP=0x0000000000027338
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0000000000026dc8
- (id)description;	// IMP=0x0000000000026db1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000026af4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000026608
