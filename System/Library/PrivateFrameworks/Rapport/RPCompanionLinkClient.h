...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000046c0
- (void).cxx_destruct;	// IMP=0x000000000000bc94
...
- (void)deregisterProfileID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000b5aa
- (void)_reregisterProfileIDs;	// IMP=0x000000000000b406
- (void)_registerProfileID:(id)arg1 reregister:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000b021
- (void)registerProfileID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000aef8
- (void)triggerEnhancedDiscoveryForReason:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000ab34
- (void)launchAppWithURL:(id)arg1 destinationID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000a9c8
- (void)launchAppWithBundleID:(id)arg1 destinationID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000a872
- (void)companionLinkHandleDisconnect;	// IMP=0x000000000000a7f1
- (void)companionLinkReceivedRequestID:(id)arg1 request:(id)arg2 options:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000000a36f
- (void)sendRequestID:(id)arg1 request:(id)arg2 destinationID:(id)arg3 options:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000009d3f
- (void)sendRequestID:(id)arg1 request:(id)arg2 options:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000009d10
- (void)deregisterRequestID:(id)arg1;	// IMP=0x000000000000998b
- (void)_reregisterRequests;	// IMP=0x0000000000009839
- (void)_registerRequestID:(id)arg1 options:(id)arg2 reregister:(_Bool)arg3;	// IMP=0x00000000000094a7
- (void)_registerRequestIDOnQueue:(id)arg1 options:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000000938c
- (void)registerRequestID:(id)arg1 options:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000000927f
- (void)companionLinkReceivedEventID:(id)arg1 event:(id)arg2 options:(id)arg3;	// IMP=0x00000000000090ef
- (void)sendEventID:(id)arg1 event:(id)arg2 destinationID:(id)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000008a22
- (void)sendEventID:(id)arg1 event:(id)arg2 options:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000089f3
- (void)deregisterEventID:(id)arg1;	// IMP=0x0000000000008669
- (void)_reregisterEvents;	// IMP=0x0000000000008517
- (void)_registerEventID:(id)arg1 options:(id)arg2 reregister:(_Bool)arg3;	// IMP=0x0000000000008185
- (void)registerEventID:(id)arg1 options:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000007f8c
- (void)companionLinkUpdateErrorFlags:(unsigned long long)arg1;	// IMP=0x0000000000007eba
- (_Bool)shouldReportDevice:(id)arg1 toXPCConnectionWithLaunchInstanceID:(id)arg2 outReason:(id *)arg3;	// IMP=0x0000000000007ac1
- (void)_lostAllDevices;	// IMP=0x00000000000078a6
- (void)companionLinkLocalDeviceUpdated:(id)arg1;	// IMP=0x0000000000007852
- (void)companionLinkChangedDevice:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x0000000000007741
- (void)companionLinkLostDevice:(id)arg1;	// IMP=0x0000000000007642
- (void)companionLinkFoundDevice:(id)arg1;	// IMP=0x00000000000074bc
@property(readonly) RPCompanionLinkDevice *activePersonalCompanion;
@property(readonly, copy) NSArray *activeDevices;
- (void)companionLinkAuthCompleted:(id)arg1;	// IMP=0x00000000000071ee
- (void)companionLinkPromptForPasswordType:(int)arg1 flags:(unsigned int)arg2 throttleSeconds:(int)arg3;	// IMP=0x000000000000712d
- (void)tryPassword:(id)arg1;	// IMP=0x000000000000704a
- (void)_reregisterAssertions;	// IMP=0x0000000000006cd8
- (void)_invalidateAssertion:(id)arg1;	// IMP=0x0000000000006bdf
- (id)activateAssertionID:(id)arg1 destinationID:(id)arg2 options:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000068f6
- (void)_invalidated;	// IMP=0x0000000000006707
- (void)invalidate;	// IMP=0x0000000000006623
- (void)_interrupted;	// IMP=0x0000000000006545
- (void)_invokeBlockActivateSafe:(CDUnknownBlockType)arg1;	// IMP=0x00000000000063e0
- (id)_ensureXPCStarted;	// IMP=0x0000000000006141
- (id)_connectionWithClient:(id)arg1 queue:(id)arg2 userProvider:(id)arg3 interruptionHandler:(CDUnknownBlockType)arg4 invalidationHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000005d21
- (id)_clientError:(id)arg1;	// IMP=0x0000000000005c89
- (id)_XPCConnectionWithMachServiceName:(id)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000005c2d
- (void)_activateWithCompletion:(CDUnknownBlockType)arg1 reactivate:(_Bool)arg2;	// IMP=0x000000000000554e
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005426
- (id)description;	// IMP=0x0000000000004f45
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000004caa
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000480e
- (id)initWithUserProvider:(id)arg1;	// IMP=0x0000000000004708
- (id)init;	// IMP=0x00000000000046c8
