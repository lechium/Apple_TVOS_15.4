...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000037da7
- (void).cxx_destruct;	// IMP=0x00000000000381ad
...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0000000000037e81
- (id)description;	// IMP=0x0000000000037e6a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000037e64
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000037e16
- (id)init;	// IMP=0x0000000000037daf
