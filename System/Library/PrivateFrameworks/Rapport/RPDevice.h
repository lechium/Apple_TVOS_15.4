...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000e03d
- (void).cxx_destruct;	// IMP=0x000000000000ff4c
...
- (void)updateWithWiFiDevice:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x000000000000faf9
- (void)updateWithSystemInfo:(id)arg1;	// IMP=0x000000000000fa0d
- (unsigned int)updateWithSFDevice:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x000000000000f204
- (unsigned int)updateWithMobileDevice:(id)arg1;	// IMP=0x000000000000efbd
- (unsigned int)updateWithBonjourDevice:(id)arg1;	// IMP=0x000000000000eda1
- (void)_updateTXTDictionary:(id)arg1;	// IMP=0x000000000000ebf8
- (double)timeSinceLastActivityLevelChange;	// IMP=0x000000000000eb99
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000000000e5bd
- (id)description;	// IMP=0x000000000000e5a6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000e3e2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000e093
- (id)init;	// IMP=0x000000000000e045
