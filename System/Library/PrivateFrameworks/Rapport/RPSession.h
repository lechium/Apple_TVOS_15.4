...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000534f0
- (void).cxx_destruct;	// IMP=0x0000000000054557
...
- (void)sendRequestID:(id)arg1 request:(id)arg2 destinationID:(id)arg3 options:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000054327
- (void)sendRequestID:(id)arg1 request:(id)arg2 options:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000542f8
- (void)deregisterRequestID:(id)arg1;	// IMP=0x00000000000542f2
- (void)registerRequestID:(id)arg1 options:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000542ec
- (void)sendEventID:(id)arg1 event:(id)arg2 destinationID:(id)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000000542d4
- (void)sendEventID:(id)arg1 event:(id)arg2 options:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000542be
- (void)deregisterEventID:(id)arg1;	// IMP=0x00000000000542b8
- (void)registerEventID:(id)arg1 options:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000542b2
- (void)tryPassword:(id)arg1;	// IMP=0x00000000000542ac
- (void)_invalidated;	// IMP=0x00000000000541f8
- (void)invalidate;	// IMP=0x000000000005411b
- (void)_interrupted;	// IMP=0x0000000000054097
- (void)_ensureXPCStarted;	// IMP=0x0000000000053e8e
- (void)_activateWithCompletion:(CDUnknownBlockType)arg1 reactivate:(_Bool)arg2;	// IMP=0x0000000000053ad4
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000538f4
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x00000000000537c9
- (id)description;	// IMP=0x00000000000537b2
- (void)dealloc;	// IMP=0x0000000000053765
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000536fc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000053573
- (id)init;	// IMP=0x00000000000534f8
