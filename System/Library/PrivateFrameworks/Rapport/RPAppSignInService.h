...
- (void)_invalidated;	// IMP=0x00000000000016ad
- (void)_invalidate;	// IMP=0x000000000000161c
- (void)invalidate;	// IMP=0x0000000000001554
- (void)_activate;	// IMP=0x00000000000012dd
- (void)activate;	// IMP=0x0000000000001215
- (id)description;	// IMP=0x00000000000011dc
- (id)init;	// IMP=0x000000000000116c
