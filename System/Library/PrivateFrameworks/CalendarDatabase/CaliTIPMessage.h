...
- (id)description;	// IMP=0x0000000000016073
- (long long)compare:(id)arg1;	// IMP=0x0000000000015f03
...
- (id)initWithData:(id)arg1 filename:(id)arg2 scheduleChanges:(id)arg3;	// IMP=0x00000000000155cb
- (id)initWithData:(id)arg1 filename:(id)arg2;	// IMP=0x00000000000155b6
