...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000021861
- (void).cxx_destruct;	// IMP=0x000000000002207f
...
- (id)description;	// IMP=0x0000000000021eaa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021d54
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021acd
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000021869
