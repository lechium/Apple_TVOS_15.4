...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000039191
- (void).cxx_destruct;	// IMP=0x000000000003934c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000039247
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039199
