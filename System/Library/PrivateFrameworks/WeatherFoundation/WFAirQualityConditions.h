...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000298c4
- (void).cxx_destruct;	// IMP=0x000000000002a9ff
...
- (id)debugDescription;	// IMP=0x000000000002a542
- (id)description;	// IMP=0x000000000002a39e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002a10d
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000029ccc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000298cc
