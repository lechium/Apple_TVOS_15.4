...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003b89c
- (void).cxx_destruct;	// IMP=0x000000000003bba4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003b9db
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003b8a4
