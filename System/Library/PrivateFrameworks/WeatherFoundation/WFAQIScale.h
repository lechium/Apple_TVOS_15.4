...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000036cb6
- (void).cxx_destruct;	// IMP=0x00000000000374b1
...
- (id)debugDescription;	// IMP=0x000000000003728a
- (id)description;	// IMP=0x000000000003716f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000036e9b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000036cbe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036b36
- (_Bool)isEqualToScale:(id)arg1;	// IMP=0x0000000000036972
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003690f
