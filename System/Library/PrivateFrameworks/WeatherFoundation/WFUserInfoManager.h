...
- (void)readUserIdentifierAndNotify;	// IMP=0x000000000001eb5d
- (void)encryptedStoreChanged:(id)arg1;	// IMP=0x000000000001eb4b
- (void)synchronize;	// IMP=0x000000000001eb39
- (void)dealloc;	// IMP=0x000000000001eac4
- (id)init;	// IMP=0x000000000001e957
