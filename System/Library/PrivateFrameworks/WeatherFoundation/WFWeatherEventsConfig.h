...
- (void).cxx_destruct;	// IMP=0x000000000000aa9f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a9a1
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000a82d
