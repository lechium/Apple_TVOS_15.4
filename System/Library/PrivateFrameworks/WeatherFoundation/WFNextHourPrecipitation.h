...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001a91e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001aaa6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001a926
- (id)description;	// IMP=0x000000000001a6ba
...
- (unsigned long long)hash;	// IMP=0x0000000000019898
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000196e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019607
- (id)initWithReadDate:(id)arg1 startDate:(id)arg2 expirationDate:(id)arg3 minutes:(id)arg4 conditions:(id)arg5 descriptions:(id)arg6;	// IMP=0x00000000000194a8
