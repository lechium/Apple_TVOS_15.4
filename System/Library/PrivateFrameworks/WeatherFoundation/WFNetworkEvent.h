...
- (void).cxx_destruct;	// IMP=0x000000000003b621
...
- (id)initWithEventType:(long long)arg1 startDate:(id)arg2 error:(id)arg3;	// IMP=0x000000000003b547
- (id)initWithEventType:(long long)arg1 metrics:(id)arg2;	// IMP=0x000000000003b2b2
- (id)initWithEventType:(long long)arg1 startDate:(id)arg2 DNSDuration:(double)arg3 connectDuration:(double)arg4 requestDuration:(double)arg5 responseDuration:(double)arg6 responseSize:(unsigned long long)arg7 HTTPStatusCode:(unsigned long long)arg8 errorCode:(long long)arg9;	// IMP=0x000000000003b1e1
