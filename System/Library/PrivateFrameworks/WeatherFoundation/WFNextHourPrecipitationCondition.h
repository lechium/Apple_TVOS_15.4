...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003547
- (void).cxx_destruct;	// IMP=0x000000000000377b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000364e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000354f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000034c4
- (id)_stringForType:(unsigned long long)arg1;	// IMP=0x000000000000345f
- (unsigned long long)typeForString:(id)arg1;	// IMP=0x000000000000337b
- (id)initWithType:(id)arg1 intensity:(double)arg2 probability:(double)arg3 validUntil:(id)arg4;	// IMP=0x00000000000032c0
