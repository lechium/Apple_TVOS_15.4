...
+ (_Bool)wfSeedBuild;	// IMP=0x000000000001c51b
+ (_Bool)wfInternalBuild;	// IMP=0x000000000001c4d8
+ (_Bool)useInternalBundleID;	// IMP=0x000000000001c46c
+ (id)bundleIDsListFor:(id)arg1 useInternalBundleID:(_Bool)arg2 useSeedBundleID:(_Bool)arg3;	// IMP=0x000000000001c276
+ (id)defaultSettings;	// IMP=0x000000000001c243
+ (id)configurationWithData:(id)arg1 bundleIDs:(id)arg2 country:(id)arg3 userID:(id)arg4 error:(id *)arg5;	// IMP=0x000000000001bfbb
+ (id)configurationWithData:(id)arg1 userID:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001be12
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001da56
- (_Bool)aqiEnabledForCountryCode:(id)arg1;	// IMP=0x000000000001d9b7
@property(readonly, nonatomic) _Bool isExpired;
@property(readonly, copy) NSString *description;
- (_Bool)shouldUseAPIVersionFromDictionary:(id)arg1 userID:(id)arg2;	// IMP=0x000000000001d4a9
- (id)getAPIVersionFromDictionary:(id)arg1 userID:(id)arg2;	// IMP=0x000000000001d1ad
- (id)getSpecificConfigFromConfigs:(id)arg1 configSpecifiers:(id)arg2 specifierKey:(id)arg3;	// IMP=0x000000000001ce4e
- (id)getEnvironmentSpecificConfigDictionaryFromDictionary:(id)arg1 bundleIDs:(id)arg2 country:(id)arg3;	// IMP=0x000000000001c984
- (id)initWithConfigDictionary:(id)arg1 bundleIDs:(id)arg2 country:(id)arg3 userID:(id)arg4;	// IMP=0x000000000001c523
