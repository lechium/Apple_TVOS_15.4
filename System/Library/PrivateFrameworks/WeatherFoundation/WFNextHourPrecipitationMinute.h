...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000038f95
- (void).cxx_destruct;	// IMP=0x0000000000039181
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039074
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000038f9d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038f0f
- (id)initWithIntensity:(double)arg1 chance:(double)arg2 perceivedIntensity:(double)arg3 date:(id)arg4;	// IMP=0x0000000000038e77
