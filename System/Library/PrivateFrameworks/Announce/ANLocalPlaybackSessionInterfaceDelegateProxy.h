...
- (void).cxx_destruct;	// IMP=0x0000000000008afd
@property(nonatomic) __weak id <ANLocalPlaybackSessionServiceInterfaceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)didReceiveAnnouncement:(id)arg1 forGroupID:(id)arg2;	// IMP=0x0000000000008a50
- (void)announcementsStateUpdate:(unsigned long long)arg1;	// IMP=0x0000000000008a04
- (void)announcementsWillStartPlaying:(unsigned long long)arg1;	// IMP=0x00000000000089b8
