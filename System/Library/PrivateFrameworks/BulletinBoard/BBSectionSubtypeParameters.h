...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004d55d
- (void).cxx_destruct;	// IMP=0x000000000004ec3b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004e030
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004d565
- (unsigned long long)hash;	// IMP=0x000000000004cd3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004bafe
...
- (id)initWithFallbackParameters:(id)arg1;	// IMP=0x000000000004a4d3
