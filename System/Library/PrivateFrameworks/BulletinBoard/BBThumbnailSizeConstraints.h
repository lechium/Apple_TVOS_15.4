...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000532c7
...
- (struct CGSize)sizeFromAspectRatio:(double)arg1;	// IMP=0x000000000005380c
- (_Bool)areReasonable;	// IMP=0x0000000000053743
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000053635
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000534f4
- (id)description;	// IMP=0x00000000000532cf
