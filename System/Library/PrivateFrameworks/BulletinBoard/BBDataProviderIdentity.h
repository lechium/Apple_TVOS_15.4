...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005e2da
+ (id)identityForRemoteDataProvider:(id)arg1;	// IMP=0x000000000005d66c
+ (id)identityForDataProvider:(id)arg1;	// IMP=0x000000000005d621
- (void).cxx_destruct;	// IMP=0x000000000005eae1
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005e477
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005e2e2
- (id)description;	// IMP=0x000000000005e299
- (id)initForDataProvider:(id)arg1 forRemoteDataProvider:(_Bool)arg2;	// IMP=0x000000000005d6ba
