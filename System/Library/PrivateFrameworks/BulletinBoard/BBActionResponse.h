...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000722c9
+ (id)actionResponseForResponse:(id)arg1 bulletinRequest:(id)arg2;	// IMP=0x0000000000071e66
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000072665
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000722d1
- (id)description;	// IMP=0x0000000000072103
