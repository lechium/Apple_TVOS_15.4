...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000464ba
- (void).cxx_destruct;	// IMP=0x0000000000046836
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000046606
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000464c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000046392
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000046177
- (unsigned long long)hash;	// IMP=0x00000000000460b2
- (id)description;	// IMP=0x0000000000045b3b
- (id)initWithContentPreviewSetting:(long long)arg1 announceSetting:(long long)arg2 announceHeadphonesSetting:(long long)arg3 announceCarPlaySetting:(long long)arg4 scheduledDeliverySetting:(long long)arg5 scheduledDeliveryTimes:(id)arg6 scheduledDeliveryShowNextSummarySetting:(long long)arg7;	// IMP=0x0000000000045a8a
