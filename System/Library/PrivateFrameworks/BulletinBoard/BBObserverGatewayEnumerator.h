...
- (void).cxx_destruct;	// IMP=0x0000000000064b1c
...
- (void)sendToDefaultGatewayToPlayLightsAndSirens:(_Bool)arg1;	// IMP=0x000000000006490c
- (id)defaultGateway;	// IMP=0x00000000000647c4
- (void)attemptNextGatewayInEnumerator:(id)arg1 playLightsAndSirens:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000641f2
- (void)enumerateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000064174
- (void)cancel;	// IMP=0x0000000000064034
- (id)init;	// IMP=0x0000000000063fde
