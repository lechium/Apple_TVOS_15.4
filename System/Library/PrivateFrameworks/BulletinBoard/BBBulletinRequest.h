...
- (id)awakeAfterUsingCoder:(id)arg1;	// IMP=0x000000000000f40c
- (id)replacementObjectForCoder:(id)arg1;	// IMP=0x000000000000f403
@property(nonatomic) _Bool tentative;
@property(nonatomic) _Bool showsUnreadIndicator;
- (void)generateBulletinID;	// IMP=0x000000000000f3e1
- (void)addAlertSuppressionAppID:(id)arg1;	// IMP=0x000000000000f282
- (void)setUnlockActionLabel:(id)arg1;	// IMP=0x000000000000f270
- (void)_updateSupplementaryAction:(id)arg1;	// IMP=0x000000000000f0d8
- (void)setSupplementaryActions:(id)arg1 forLayout:(long long)arg2;	// IMP=0x000000000000ef3d
@property(copy, nonatomic) NSArray *supplementaryActions; // @dynamic supplementaryActions;
- (void)withdraw;	// IMP=0x000000000000ef15
- (void)publish;	// IMP=0x000000000000eefe
- (void)publish:(_Bool)arg1;	// IMP=0x000000000000eeea
- (void)addButton:(id)arg1;	// IMP=0x000000000000edad
- (void)addAttachmentOfType:(long long)arg1;	// IMP=0x000000000000ece3
@property(nonatomic) long long primaryAttachmentType; // @dynamic primaryAttachmentType;
- (void)setContextValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000000e956
- (void)generateNewBulletinID;	// IMP=0x0000000000010982
- (_Bool)hasAdditionalAttachmentsModificationsRelativeTo:(id)arg1;	// IMP=0x000000000001082b
- (_Bool)hasContentModificationsRelativeTo:(id)arg1;	// IMP=0x000000000000f437
