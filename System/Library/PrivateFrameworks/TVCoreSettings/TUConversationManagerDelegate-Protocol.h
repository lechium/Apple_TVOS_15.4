...
@class NSArray, NSData, NSError, NSSet, NSString, TUConversation, TUConversationActivity, TUConversationActivityEvent, TUConversationActivitySession, TUConversationLink, TUConversationManager, TUConversationMember, TUConversationNotice, TUConversationParticipant;
...
- (void)conversationManager:(TUConversationManager *)arg1 removedActivitySuggestion:(TUConversationActivity *)arg2;
- (void)conversationManager:(TUConversationManager *)arg1 addedActivitySuggestion:(TUConversationActivity *)arg2;
