...
- (void).cxx_destruct;	// IMP=0x000000000012c5a6
...
- (void)close;	// IMP=0x000000000012c451
- (void)writeData:(id)arg1;	// IMP=0x000000000012c2cb
- (void)dealloc;	// IMP=0x000000000012c241
- (id)initWithWriter:(id)arg1 operation:(unsigned int)arg2 key:(id)arg3 iv:(id)arg4;	// IMP=0x000000000012c06b
- (id)init;	// IMP=0x000000000012bfd0
