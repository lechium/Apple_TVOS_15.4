...
+ (void)stateToPb:(id)arg1 statePb:(void *)arg2;	// IMP=0x000000000032b028
+ (id)stateFromPb:(const void *)arg1;	// IMP=0x000000000032aa50
- (void).cxx_destruct;	// IMP=0x000000000032babe
