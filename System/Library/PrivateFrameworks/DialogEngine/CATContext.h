...
- (void).cxx_destruct;	// IMP=0x000000000024463a
...
- (id)toDictionary;	// IMP=0x00000000002442bb
- (id)initWithInputLocale:(id)arg1 outputVoiceLocale:(id)arg2;	// IMP=0x0000000000243c41
- (id)init;	// IMP=0x0000000000243ace
