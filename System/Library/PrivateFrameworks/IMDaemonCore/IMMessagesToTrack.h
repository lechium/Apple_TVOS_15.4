...
+ (id)sharedInstance;	// IMP=0x000000000009990e
- (void).cxx_destruct;	// IMP=0x0000000000099d31
...
- (void)containsMessageID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000099b75
- (void)addMessagesID:(id)arg1;	// IMP=0x0000000000099a05
- (id)init;	// IMP=0x0000000000099963
