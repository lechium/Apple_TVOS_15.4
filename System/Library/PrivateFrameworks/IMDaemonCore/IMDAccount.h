...
- (void)_forceSetLoginStatus:(unsigned int)arg1 message:(id)arg2 reason:(int)arg3 properties:(id)arg4;	// IMP=0x0000000000003efa
- (void)setLoginStatus:(unsigned int)arg1 message:(id)arg2;	// IMP=0x0000000000003ee2
- (void)setLoginStatus:(unsigned int)arg1 message:(id)arg2 reason:(int)arg3 properties:(id)arg4;	// IMP=0x0000000000003e64
...
- (id)_registrationInfo;	// IMP=0x0000000000003d78
@property(readonly, retain, nonatomic) NSString *loginID; // @synthesize loginID=_loginID;
- (void)setRegistrationStatus:(int)arg1 error:(int)arg2 alertInfo:(id)arg3;	// IMP=0x0000000000003c0e
- (void)systemDidBecomeUnidle;	// IMP=0x0000000000003bfc
- (void)systemDidBecomeIdle;	// IMP=0x0000000000003bea
- (void)_updateIdle;	// IMP=0x0000000000003a47
- (void)tunesController:(id)arg1 playerInfoChanged:(id)arg2;	// IMP=0x0000000000003980
...
- (void)changeStatus:(id)arg1;	// IMP=0x0000000000003192
- (void)releaseSession;	// IMP=0x000000000000315d
- (void)createSessionIfNecessary;	// IMP=0x0000000000002bc0
@property(readonly, retain, nonatomic) NSDictionary *accountInfoToPost;
- (void)postAccountCapabilitiesToListener:(id)arg1;	// IMP=0x0000000000002891
- (void)postAccountCapabilities;	// IMP=0x000000000000287d
- (void)writeAccountDefaults:(id)arg1;	// IMP=0x000000000000250e
...
- (void)dealloc;	// IMP=0x00000000000021ff
- (id)initWithAccountID:(id)arg1 defaults:(id)arg2 service:(id)arg3;	// IMP=0x000000000000202c
