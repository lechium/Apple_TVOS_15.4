...
- (void)updateShadowOpacityForFocus:(_Bool)arg1;	// IMP=0x000000000000a760
- (struct CGRect)_shadowFrameForShadowImage:(id)arg1;	// IMP=0x000000000000a64e
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000000a50e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000a21b
