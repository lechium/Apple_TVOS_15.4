...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002fa49
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002fbae
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002fa51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002fa3e
- (id)description;	// IMP=0x000000000002f912
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f50b
- (unsigned long long)hash;	// IMP=0x000000000002f401
- (id)initWithClientIdentifier:(id)arg1 modeIdentifier:(id)arg2 lifetimeType:(unsigned long long)arg3 activeDateInterval:(id)arg4 userVisibleEndDate:(id)arg5;	// IMP=0x000000000002f2eb
