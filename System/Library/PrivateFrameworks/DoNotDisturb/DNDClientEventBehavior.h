...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001cc7f
- (void).cxx_destruct;	// IMP=0x000000000001cea9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001cd8c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001cc87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001cc74
- (id)_descriptionForRedacted:(_Bool)arg1;	// IMP=0x000000000001cb2f
@property(readonly, copy) NSString *redactedDescription;
- (id)description;	// IMP=0x000000000001cb04
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c893
- (unsigned long long)hash;	// IMP=0x000000000001c7de
- (id)initWithEventDetails:(id)arg1 interruptionSuppression:(unsigned long long)arg2 resolutionReason:(unsigned long long)arg3 activeModeUUID:(id)arg4;	// IMP=0x000000000001c713
