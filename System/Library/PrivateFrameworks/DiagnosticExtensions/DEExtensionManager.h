...
+ (id)sharedInstance;	// IMP=0x000000000000bfa0
- (void).cxx_destruct;	// IMP=0x000000000000cbd9
...
- (id)extensionsWithFilter:(id)arg1;	// IMP=0x000000000000c791
- (void)loadExtensions;	// IMP=0x000000000000c288
- (id)init;	// IMP=0x000000000000c259
- (id)extensionForIdentifier:(id)arg1;	// IMP=0x000000000000c086
