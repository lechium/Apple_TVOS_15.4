...
- (void).cxx_destruct;	// IMP=0x000000000000b9b6
...
- (void)dealloc;	// IMP=0x000000000000b895
- (id)initWithSandboxExtensionToken:(id)arg1 itemURL:(id)arg2 errorOut:(id *)arg3;	// IMP=0x000000000000b442
