...
- (void).cxx_destruct;	// IMP=0x000000000009312a
...
- (id)debugDescription;	// IMP=0x0000000000093016
- (id)description;	// IMP=0x0000000000092f59
- (unsigned long long)hash;	// IMP=0x0000000000092eff
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000092d63
- (id)initWithIdentifier:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 metadata:(id)arg4;	// IMP=0x0000000000092c67
