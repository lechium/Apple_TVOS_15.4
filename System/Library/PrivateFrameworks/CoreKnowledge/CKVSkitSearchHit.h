...
- (void).cxx_destruct;	// IMP=0x000000000008be7c
...
- (unsigned long long)hash;	// IMP=0x000000000008bd08
- (_Bool)isEqualToSearchHit:(id)arg1;	// IMP=0x000000000008bbd1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008bb69
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008bac9
- (id)description;	// IMP=0x000000000008b979
- (id)init;	// IMP=0x000000000008b931
- (id)initWithItemInfo:(id)arg1 fields:(id)arg2 rank:(long long)arg3 docId:(long long)arg4 score:(float)arg5 matchCount:(unsigned long long)arg6;	// IMP=0x000000000008b750
