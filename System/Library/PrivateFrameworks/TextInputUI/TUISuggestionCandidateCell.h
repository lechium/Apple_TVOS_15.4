...
+ (id)reuseIdentifier;	// IMP=0x00000000000506c2
- (void).cxx_destruct;	// IMP=0x0000000000050609
...
- (void)updateLabel;	// IMP=0x000000000004fb5e
- (id)image;	// IMP=0x000000000004fb0e
- (id)bodyText;	// IMP=0x000000000004fabe
- (id)headerText;	// IMP=0x000000000004fa6e
- (id)textSuggestion;	// IMP=0x000000000004f9ce
- (void)didMoveToWindow;	// IMP=0x000000000004f98d
- (void)layoutSubviews;	// IMP=0x000000000004f94c
- (void)setStyle:(id)arg1;	// IMP=0x000000000004f8a7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004f7eb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004f78e
- (void)commonInit;	// IMP=0x000000000004eee1
