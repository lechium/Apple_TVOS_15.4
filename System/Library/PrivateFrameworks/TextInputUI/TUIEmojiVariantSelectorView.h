...
+ (id)emojiTextAttributes;	// IMP=0x0000000000045880
- (void).cxx_destruct;	// IMP=0x000000000004512c
...
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000044f03
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000044ece
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000044e9a
- (_Bool)_highlightCellAtLocation:(struct CGPoint)arg1;	// IMP=0x0000000000044e2c
- (id)_variantCellAtLocation:(struct CGPoint)arg1;	// IMP=0x0000000000044c36
- (void)_unhighlightAllViews;	// IMP=0x0000000000044b04
- (void)layoutSubviews;	// IMP=0x000000000004410f
- (id)_backgroundBezierPathForContainerRect:(struct CGRect)arg1 originRect:(struct CGRect)arg2;	// IMP=0x0000000000043c17
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000043b55
- (unsigned long long)_numberOfVariants;	// IMP=0x0000000000043b06
- (struct CGSize)_emojiCellSize;	// IMP=0x0000000000043a85
- (id)initWithFrame:(struct CGRect)arg1 emojiToken:(id)arg2 originRect:(struct CGRect)arg3;	// IMP=0x0000000000042cfd
