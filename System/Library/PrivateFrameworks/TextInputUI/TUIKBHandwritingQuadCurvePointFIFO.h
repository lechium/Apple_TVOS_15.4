...
- (void)clear;	// IMP=0x000000000003d514
- (void)flush;	// IMP=0x000000000003d227
- (void)addPoint:(CDStruct_23d8ee2f)arg1;	// IMP=0x000000000003cc8f
- (id)initWithFIFO:(id)arg1 scale:(double)arg2;	// IMP=0x000000000003cbf9
