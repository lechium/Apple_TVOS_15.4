...
- (id).cxx_construct;	// IMP=0x000000000051ec94
- (void).cxx_destruct;	// IMP=0x000000000051ebdc
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x000000000051eaea
- (_Bool)_updateActiveRouteRange;	// IMP=0x000000000051dd0d
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x000000000051db3b
- (void)_updateCurrentRoadInfo;	// IMP=0x000000000051d8f3
- (void)_initalizeCurrentRoadInfo;	// IMP=0x000000000051d8d6
- (void)_dedupOffRouteRoads;	// IMP=0x000000000051d116
- (void)_updatePreferredLabelPlacements;	// IMP=0x000000000051cec7
- (void)_updateRoadsInGuidance;	// IMP=0x000000000051cabf
- (void)_updateRoadStarts;	// IMP=0x000000000051c7cf
- (void)_updateUniqueOffRouteRoads;	// IMP=0x000000000051c380
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x000000000051b6d9
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x000000000051ab4a
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x000000000051a5c5
- (void)_addVisibleSigns;	// IMP=0x000000000051a501
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x0000000000518237
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000005180a0
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x0000000000517f48
- (optional_b09de0fc)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000517c20
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x00000000005170fc
- (void)styleManagerDidFinishAnimating;	// IMP=0x00000000005170ef
- (void)styleManagerDidStartAnimating;	// IMP=0x00000000005170e0
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x00000000005170c9
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x0000000000516a00
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000515c10
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x0000000000515861
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x000000000051571a
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000515659
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x0000000000515366
- (void)_refreshGuidanceRoadNames;	// IMP=0x00000000005151ce
- (void)_reloadRouteJunctions;	// IMP=0x0000000000514ef5
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x0000000000514e02
- (_Bool)isNavMode;	// IMP=0x0000000000514dea
- (void)dealloc;	// IMP=0x0000000000514d32
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x0000000000514bde
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x00000000005149ca
- (id)init;	// IMP=0x00000000005144c4
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x000000000042b1da
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x000000000042a4ad
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x000000000042a3c3
- (_Bool)needsDebugDraw;	// IMP=0x000000000042a338
