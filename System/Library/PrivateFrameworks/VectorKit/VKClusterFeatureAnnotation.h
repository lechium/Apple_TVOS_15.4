...
- (id)feature;	// IMP=0x0000000000706a7b
- (void)dealloc;	// IMP=0x0000000000706a40
- (id)initWithClusterNode:(void *)arg1 clusterTree:(const void *)arg2 baseStyle:(const void *)arg3 imageText:(id)arg4 annotationText:(id)arg5 annotationLocale:(id)arg6;	// IMP=0x0000000000705a2b
