...
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x00000000006cc214
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x00000000006caed0
- (Matrix_443f5d51)_centerCursor;	// IMP=0x00000000006cadaf
- (void)setEdgeInsets:(struct VKEdgeInsets)arg1;	// IMP=0x00000000006cad64
- (struct VKEdgeInsets)_effectiveEdgeInsets;	// IMP=0x00000000006cac91
- (Matrix_443f5d51)_nonOffsetCenterCursor;	// IMP=0x00000000006cabd8
- (void)dealloc;	// IMP=0x00000000006cab5b
- (id)init;	// IMP=0x00000000006cab14
