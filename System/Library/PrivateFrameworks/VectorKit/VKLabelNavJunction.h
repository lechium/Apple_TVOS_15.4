...
- (id).cxx_construct;	// IMP=0x0000000000616208
- (void).cxx_destruct;	// IMP=0x00000000006161fa
...
- (void)createLabelWithNavContext:(struct NavContext *)arg1 isDrivingSideRight:(_Bool)arg2 artworkCache:(void *)arg3;	// IMP=0x0000000000615a40
- (void)prepareStyleVarsWithContext:(struct NavContext *)arg1;	// IMP=0x0000000000615762
@property(readonly, nonatomic) _Bool isVisible; // @synthesize isVisible=_isVisible;
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006156fb
- (void)_updateWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006156e6
- (void)_updateWithNavContext:(struct NavContext *)arg1 threshold:(double)arg2;	// IMP=0x0000000000615668
- (Mercator3_d8bb135c)_anchorCoordinateForSignOrientation:(unsigned char)arg1;	// IMP=0x000000000061554d
- (unsigned char)_signOrientationWithDrivingSide:(_Bool)arg1;	// IMP=0x00000000006152e8
...
- (void)evaluateCrossStreetsUsingRouteJunction:(id)arg1;	// IMP=0x0000000000614912
- (void)evaluateCrossStreets;	// IMP=0x00000000006148fd
- (void)addRouteEdge:(const struct VKLabelNavRouteRoadEdge *)arg1 atA:(_Bool)arg2;	// IMP=0x000000000061473e
- (void)findRoads;	// IMP=0x000000000061439b
...
- (_Bool)matchesLocationForJunction:(id)arg1;	// IMP=0x0000000000613e4b
- (id)description;	// IMP=0x0000000000613ddc
- (void)dealloc;	// IMP=0x0000000000613d78
- (id)initWithRoadEdge:(const struct GeoCodecsRoadEdge *)arg1 atA:(_Bool)arg2 routeOffset:(struct PolylineCoordinate)arg3 tile:(const void *)arg4;	// IMP=0x0000000000613b40
- (id)initWithGEOJunction:(struct GeoCodecsConnectivityJunction *)arg1 routeOffset:(struct PolylineCoordinate)arg2 tile:(const void *)arg3;	// IMP=0x00000000006138b2
