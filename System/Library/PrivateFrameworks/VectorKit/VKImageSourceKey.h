...
- (id).cxx_construct;	// IMP=0x0000000000796c3b
...
- (void)dealloc;	// IMP=0x0000000000796ad5
...
- (id)initWithLabelImageKey:(const void *)arg1;	// IMP=0x0000000000796839
- (id)initWithIconName:(const char *)arg1;	// IMP=0x00000000007967df
- (id)initWithIconAttributeKey:(unsigned int)arg1 attributeValue:(unsigned int)arg2;	// IMP=0x00000000007967b0
- (id)initWithShieldName:(const char *)arg1 text:(const char *)arg2 locale:(const char *)arg3 color:(Color_c5f82c4a)arg4;	// IMP=0x00000000007966c7
- (id)initWithShieldText:(const char *)arg1 locale:(const char *)arg2 type:(unsigned int)arg3 color:(Color_c5f82c4a)arg4;	// IMP=0x000000000079660c
- (id)initWithDataType:(unsigned char)arg1;	// IMP=0x00000000007965e3
- (id)_initWithKeyType:(unsigned int)arg1;	// IMP=0x00000000007965a8
