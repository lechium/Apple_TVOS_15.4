...
- (id).cxx_construct;	// IMP=0x00000000004791b3
- (void).cxx_destruct;	// IMP=0x0000000000479192
@property long long state; // @synthesize state=_state;
@property(readonly, nonatomic) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (id)description;	// IMP=0x00000000004790bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000478fdf
@property(readonly, nonatomic) NSArray *features;
- (id)initWithFeatures:(id)arg1;	// IMP=0x0000000000478f64
