...
- (id).cxx_construct;	// IMP=0x00000000006272c9
- (void).cxx_destruct;	// IMP=0x00000000006272bb
@property(nonatomic) id <VKMercatorTerrainHeightProvider> heightProvider; // @synthesize heightProvider=_heightProvider;
- (void)invalidateRect:(const void *)arg1;	// IMP=0x00000000006271c7
- (void)removeCachedValueForAnchor:(void *)arg1;	// IMP=0x000000000062716b
- (double)heightForAnchor:(void *)arg1;	// IMP=0x000000000062701c
