...
- (id)shortName;	// IMP=0x000000000055a873
- (id)name;	// IMP=0x000000000055a7c0
...
- (const void *)venueFeatureMarker;	// IMP=0x000000000055a5ac
- (id)initWithVenue:(const void *)arg1 localize:(_Bool)arg2;	// IMP=0x000000000055a440
