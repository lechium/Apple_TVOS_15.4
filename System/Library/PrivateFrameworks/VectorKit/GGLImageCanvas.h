...
- (id).cxx_construct;	// IMP=0x0000000000474afd
- (void).cxx_destruct;	// IMP=0x00000000004749a3
...
- (void)didDrawView;	// IMP=0x0000000000474915
- (void)willDrawView;	// IMP=0x00000000004748b6
- (void)renderWithTimestamp:(double)arg1 completion:(function_2e574590)arg2;	// IMP=0x00000000004743a7
- (_Bool)hasRenderTarget;	// IMP=0x0000000000474396
- (void)destroyRenderTarget;	// IMP=0x000000000047417a
- (void)createRenderTarget;	// IMP=0x0000000000473445
- (struct __IOSurface *)flipImage;	// IMP=0x0000000000473263
...
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x0000000000473049
@property(readonly, nonatomic) void *imageTexture;
@property(readonly, nonatomic) _Bool shouldRasterize;
- (void)dealloc;	// IMP=0x0000000000472fcb
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 useMultisampling:(_Bool)arg3 extraColorFormats:(const void *)arg4 taskContext:(const void *)arg5 device:(void *)arg6 signpostId:(unsigned long long)arg7;	// IMP=0x0000000000472259
- (void *)_internalRenderTarget;	// IMP=0x000000000047224f
@property(readonly, nonatomic) void *finalRenderTarget;
@property(readonly, nonatomic) struct CGSize sizeInPixels;
- (void *)finalSurface;	// IMP=0x000000000047221c
