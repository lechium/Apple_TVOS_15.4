...
+ (id)stringForIncidentSignificance:(long long)arg1;	// IMP=0x00000000003e76e4
+ (id)stringForRouteRelevance:(long long)arg1;	// IMP=0x00000000003e7694
+ (id)stringForIncidentType:(long long)arg1;	// IMP=0x00000000003e75c0
+ (long long)incidentTypeForGeoRouteIncident:(id)arg1;	// IMP=0x00000000003e758f
- (id).cxx_construct;	// IMP=0x00000000003e7aa1
- (void).cxx_destruct;	// IMP=0x00000000003e7a8a
...
- (void)populateDebugNode:(void *)arg1;	// IMP=0x00000000003e7758
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003e741b
...
- (void)dealloc;	// IMP=0x00000000003e72d1
- (id)initWithRouteIncident:(id)arg1 routeOffsetInMeters:(unsigned int)arg2 routeRelevance:(long long)arg3 onRoute:(id)arg4;	// IMP=0x00000000003e6d7a
- (id)initWithIncidentData:(const void *)arg1;	// IMP=0x00000000003e66e0
- (_Bool)hasSameIdentifier:(id)arg1;	// IMP=0x00000000003e657c
