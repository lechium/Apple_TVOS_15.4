...
- (id).cxx_construct;	// IMP=0x0000000000066102
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x0000000000065ea1
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x0000000000065cdb
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x0000000000065c3b
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x0000000000065b1f
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x0000000000065914
- (void)computeFromCamera:(id)arg1;	// IMP=0x0000000000065343
