...
- (id).cxx_construct;	// IMP=0x000000000047bed8
- (void).cxx_destruct;	// IMP=0x000000000047be60
...
- (void)didReceiveMemoryWarning:(_Bool)arg1;	// IMP=0x000000000047be10
- (void)renderSceneWithEngine:(void *)arg1 completion:(function_2e574590)arg2;	// IMP=0x000000000047bc07
- (void)cancelLoad;	// IMP=0x000000000047bbdd
- (void)loadScene;	// IMP=0x000000000047bbc5
@property(readonly, nonatomic) VKCamera *vkCamera;
@property(readonly, nonatomic) double pitch;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) GEOMapRegion *mapRegion;
- (void)setCenterCoordinate:(CDStruct_c3b9c2ee)arg1 altitude:(double)arg2 yaw:(double)arg3 pitch:(double)arg4;	// IMP=0x000000000047ba98
- (void)setMapRegion:(id)arg1 pitch:(double)arg2 yaw:(double)arg3;	// IMP=0x000000000047ba1e
- (void)cancelTileRequests;	// IMP=0x000000000047ba18
- (void)clearScene;	// IMP=0x000000000047ba12
- (void)didLayout;	// IMP=0x000000000047ba0c
- (void)updateWithTimestamp:(double)arg1 withContext:(void *)arg2;	// IMP=0x000000000047b9f6
@property(readonly, nonatomic) shared_ptr_e963992e taskContext;
- (void)dealloc;	// IMP=0x000000000047b999
- (id)initWithMapEngine:(void *)arg1;	// IMP=0x000000000047b70e
