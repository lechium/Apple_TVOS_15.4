...
- (id).cxx_construct;	// IMP=0x0000000000061d72
- (void).cxx_destruct;	// IMP=0x0000000000061d4c
...
- (void)updateCamera:(shared_ptr_46708168)arg1;	// IMP=0x0000000000061a19
- (CameraFrame_406dbd31)cameraFrame;	// IMP=0x000000000006187b
- (View_a667aa2f)view:(struct ViewSize)arg1;	// IMP=0x00000000000617d1
...
- (void)adjustClipPlanes;	// IMP=0x0000000000061648
- (float)zoomAtCentrePoint;	// IMP=0x000000000006162b
- (float)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x000000000006157d
- (double)depthForViewWidth:(double)arg1;	// IMP=0x000000000006154c
- (double)widthOfViewAtDepth:(double)arg1;	// IMP=0x0000000000061523
- (struct CGPoint)screenPointFromGroundPoint:(const void *)arg1;	// IMP=0x000000000006143a
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1 atGroundLevel:(double)arg2;	// IMP=0x0000000000061298
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1;	// IMP=0x0000000000061262
- (void)updateIfNeeded;	// IMP=0x0000000000060802
- (void)setNeedsUpdate;	// IMP=0x00000000000607e1
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x00000000000607cb
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x00000000000607b5
- (Matrix_6e1d3589)groundPlaneIntersectionPoint;	// IMP=0x000000000006069b
@property(nonatomic) struct VKCameraState cameraState;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) double pitch;
- (double)displayZoomLevel;	// IMP=0x00000000000603bd
...
- (Mercator3_d8bb135c)mercatorPosition;	// IMP=0x000000000005fe2b
- (void)setMercatorPosition:(const void *)arg1;	// IMP=0x000000000005fcd2
- (void)_setPosition:(const void *)arg1;	// IMP=0x000000000005fca7
- (id)descriptionDictionaryRepresentation;	// IMP=0x000000000005fa58
- (id)description;	// IMP=0x000000000005f8a5
- (id)detailedDescription;	// IMP=0x000000000005f893
- (void)dealloc;	// IMP=0x000000000005f83f
- (id)initWithRunLoopController:(struct RunLoopController *)arg1;	// IMP=0x000000000005f6fe
