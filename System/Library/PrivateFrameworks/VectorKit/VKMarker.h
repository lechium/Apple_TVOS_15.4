...
+ (id)markerWithFeatureMarker:(const void *)arg1;	// IMP=0x00000000001d3038
- (id).cxx_construct;	// IMP=0x00000000001d32d3
- (void).cxx_destruct;	// IMP=0x00000000001d3294
@property(readonly, nonatomic) int markerType; // @synthesize markerType=_markerType;
- (id)featureHandles;	// IMP=0x00000000001d3283
...
- (void)dealloc;	// IMP=0x00000000001d3086
- (id)initWithFeatureMarkerPtr:(const void *)arg1 markerType:(int)arg2;	// IMP=0x00000000001d2eb4
