...
+ (id)sharedPlatform;	// IMP=0x00000000002e5dc2
...
- (unsigned long long)tileMaximumLimit:(unsigned long long)arg1;	// IMP=0x00000000002e5f8c
@property(readonly, nonatomic) _Bool roadsWithSimpleLineMeshesAvailable;
- (void)_determineHardware;	// IMP=0x00000000002e5ed4
- (unsigned long long)_calculateMemSize;	// IMP=0x00000000002e5e93
- (void)dealloc;	// IMP=0x00000000002e5e64
- (id)init;	// IMP=0x00000000002e5e07
