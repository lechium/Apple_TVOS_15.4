...
- (id).cxx_construct;	// IMP=0x000000000062013a
...
- (id)detailedDescription;	// IMP=0x000000000061ffe8
...
- (void)projectFromLocation:(id)arg1 routeMatch:(id)arg2 speedMultiplier:(double)arg3 routeLine:(id)arg4;	// IMP=0x000000000061f9f3
- (void)_updateCourseAndPositionFromRouteMatch:(id)arg1;	// IMP=0x000000000061f7fd
- (void)reset;	// IMP=0x000000000061f7a1
- (void)dealloc;	// IMP=0x000000000061f763
- (id)init;	// IMP=0x000000000061f717
