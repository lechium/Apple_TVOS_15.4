...
- (id).cxx_construct;	// IMP=0x00000000006608e7
- (void).cxx_destruct;	// IMP=0x00000000006608ae
...
- (void)findOppositeCarriagewayJunctionsWithRouteFeatures:(void *)arg1 distanceThreshold:(double)arg2;	// IMP=0x000000000065ff17
- (void)appendNavJunctionsInWorldRect:(const void *)arg1 junctions:(id)arg2;	// IMP=0x000000000065fdd5
- (void)initializeJunctionInfos;	// IMP=0x000000000065fa5a
- (id)findTileEdgeJunctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x000000000065f8da
- (void)_findTileEdgeJunctions;	// IMP=0x000000000065f79d
- (void)addJunction:(id)arg1;	// IMP=0x000000000065f727
- (id)junctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x000000000065f5e4
- (id)junctionForGeoJunction:(struct GeoCodecsConnectivityJunction *)arg1;	// IMP=0x000000000065f5ce
- (void)dealloc;	// IMP=0x000000000065f57d
- (id)initWithTile:(const void *)arg1;	// IMP=0x000000000065f4a4
