...
- (id).cxx_construct;	// IMP=0x000000000039707d
- (void).cxx_destruct;	// IMP=0x0000000000396ea0
...
- (void)clearRouteAttributes;	// IMP=0x0000000000396e61
- (void)setRouteAttributes:(const struct PolygonRouteAttributes *)arg1;	// IMP=0x0000000000396e35
- (void)updateCachedStyles;	// IMP=0x0000000000396658
@property(readonly, nonatomic) const void *featureIds;
- (_Bool)hasFeatureId:(unsigned long long)arg1;	// IMP=0x0000000000396624
- (_Bool)canAcceptPolygon:(void *)arg1;	// IMP=0x0000000000396570
- (void)didFinishAddingData;	// IMP=0x000000000039631b
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;	// IMP=0x0000000000395eb1
- (unsigned char)indexForGeoFeatureAttributes:(const void *)arg1;	// IMP=0x0000000000395b0d
- (const void *)commitRangesToVerticalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x0000000000395a59
- (const void *)commitRangesToHorizontalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000003959a5
- (const void *)commitRangesToVenueWallEndCapRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000003958f1
- (const void *)commitRangesToVenueWallRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x000000000039583d
- (const void *)commitRangesToStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x000000000039577a
- (const void *)commitRangesToFillRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x00000000003956b7
@property(readonly, nonatomic) void *fillMeshes;
@property(readonly, nonatomic) float tileZoom;
- (void *)styleQueries:(const struct StyleQueryOverride *)arg1;	// IMP=0x00000000003952cb
...
- (const void *)attributeSets;	// IMP=0x0000000000395268
- (unsigned char)maxAttributeSetsPerGroup;	// IMP=0x000000000039525d
- (void)dealloc;	// IMP=0x000000000039522e
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4;	// IMP=0x0000000000394e80
