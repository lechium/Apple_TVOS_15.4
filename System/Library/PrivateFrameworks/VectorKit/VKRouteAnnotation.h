...
- (void)populateDebugNode:(void *)arg1;	// IMP=0x00000000004fc4c1
- (void)dealloc;	// IMP=0x00000000004fc469
@property(readonly, nonatomic) GEOMiniCard *infoCard;
- (id)initWithRouteAnnotation:(id)arg1 onRoute:(id)arg2;	// IMP=0x00000000004fc331
