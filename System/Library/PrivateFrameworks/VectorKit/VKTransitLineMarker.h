...
+ (id)markerWithFeature:(void *)arg1 transitLink:(const void *)arg2;	// IMP=0x000000000011e8aa
...
- (id)description;	// IMP=0x000000000011ed07
- (void)dealloc;	// IMP=0x000000000011eca8
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000011ec58
- (id)initWithFeature:(void *)arg1 transitLink:(const void *)arg2;	// IMP=0x000000000011e8e5
