...
- (void)dealloc;	// IMP=0x0000000000440ff7
- (id)initWithComposedRoute:(id)arg1 etaDescription:(id)arg2;	// IMP=0x0000000000440dcc
- (id)initWithComposedRoute:(id)arg1 etaText:(id)arg2;	// IMP=0x0000000000440d69
- (void)_decodeVisualInfos:(id)arg1 withRouteEtaType:(long long)arg2 into:(id)arg3;	// IMP=0x00000000004405c4
