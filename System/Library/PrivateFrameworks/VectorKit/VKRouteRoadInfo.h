...
- (id).cxx_construct;	// IMP=0x000000000051ee97
...
- (void)dealloc;	// IMP=0x000000000051ee2f
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x000000000051edbf
