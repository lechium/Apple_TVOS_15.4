...
- (void *)puck;	// IMP=0x00000000002dae39
...
- (void)runAnimation:(id)arg1;	// IMP=0x00000000002daa6c
- (void)destroyAnimationRunner;	// IMP=0x00000000002daa5e
@property(readonly, nonatomic) struct VKEdgeInsets annotationTrackingEdgeInsets;
- (void)dealloc;	// IMP=0x00000000002da9fa
- (id)initWithAnimationRunner:(struct AnimationRunner *)arg1;	// IMP=0x00000000002da980
