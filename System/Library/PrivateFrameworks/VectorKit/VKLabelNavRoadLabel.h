...
- (id).cxx_construct;	// IMP=0x0000000000658e38
- (void).cxx_destruct;	// IMP=0x0000000000658e2a
...
- (id)description;	// IMP=0x0000000000658d59
- (id)displayGroup;	// IMP=0x0000000000658c48
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000658c37
...
- (void)dealloc;	// IMP=0x0000000000658b64
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x0000000000658ac6
