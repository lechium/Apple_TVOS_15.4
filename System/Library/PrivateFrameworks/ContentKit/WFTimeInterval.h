...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c5ad7
+ (id)objectWithWFSerializedRepresentation:(id)arg1;	// IMP=0x00000000000c5913
- (void).cxx_destruct;	// IMP=0x00000000000c5903
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c5756
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c5610
- (id)wfSerializedRepresentation;	// IMP=0x00000000000c545a
- (id)wfName;	// IMP=0x00000000000c5448
...
- (long long)compare:(id)arg1;	// IMP=0x00000000000c52a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c5213
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c5176
- (id)initWithTimeInterval:(double)arg1 allowedUnits:(unsigned long long)arg2 unitsStyle:(long long)arg3 zeroFormattingBehavior:(unsigned long long)arg4;	// IMP=0x00000000000c50cc
- (id)initWithTimeInterval:(double)arg1;	// IMP=0x00000000000c50ad
