...
+ (id)randomSortDescriptor;	// IMP=0x00000000000e7281
+ (id)sortDescriptorWithProperty:(id)arg1 ascending:(_Bool)arg2 comparator:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e7206
- (void).cxx_destruct;	// IMP=0x00000000000e71de
...
- (id)description;	// IMP=0x00000000000e6fb0
- (id)initWithProperty:(id)arg1 ascending:(_Bool)arg2 comparator:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e6e73
