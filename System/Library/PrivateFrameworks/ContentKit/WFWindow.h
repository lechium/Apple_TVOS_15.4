...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c4368
+ (id)allWindowsForBundleIdentifiers:(id)arg1;	// IMP=0x00000000000a3a68
+ (id)allWindows;	// IMP=0x00000000000a3a5b
- (void).cxx_destruct;	// IMP=0x00000000000c432a
...
- (void)dealloc;	// IMP=0x00000000000c42b1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c4183
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c402d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c4022
...
- (void)setBoundsNeedReloading;	// IMP=0x00000000000c3f91
