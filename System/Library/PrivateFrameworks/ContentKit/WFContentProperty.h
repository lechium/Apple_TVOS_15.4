...
+ (id)possibleLabelsForClass:(Class)arg1 localized:(_Bool)arg2;	// IMP=0x0000000000040b0f
- (void).cxx_destruct;	// IMP=0x00000000000b0fb6
...
- (unsigned long long)equivalentHash;	// IMP=0x00000000000b0dfa
- (_Bool)isEquivalentToProperty:(id)arg1;	// IMP=0x00000000000b0d02
- (void)updateWithValue:(id)arg1 withTransaction:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b0aaa
- (void)getValuesForObject:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b0a10
- (void)getValueForObject:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b08af
@property(readonly, nonatomic, getter=isLabeledValue) _Bool labeledValue;
- (void)getPossibleValues:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b071a
...
- (id)description;	// IMP=0x00000000000b0079
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b006e
- (id)initWithKeyPath:(id)arg1 block:(CDUnknownBlockType)arg2 setterBlock:(CDUnknownBlockType)arg3 name:(id)arg4 propertyClass:(Class)arg5 multipleValues:(_Bool)arg6 filterable:(_Bool)arg7 sortable:(_Bool)arg8 gettable:(_Bool)arg9 settable:(_Bool)arg10 appendable:(_Bool)arg11 removable:(_Bool)arg12 primary:(_Bool)arg13 allowedOperators:(id)arg14 userInfo:(id)arg15 possibleValues:(id)arg16 possibleValuesGetter:(CDUnknownBlockType)arg17 caseInsensitive:(_Bool)arg18 negativeName:(id)arg19 singularItemName:(id)arg20 irrational:(_Bool)arg21 tense:(unsigned long long)arg22 timeUnits:(unsigned long long)arg23 comparableUnits:(unsigned long long)arg24 measurementUnitType:(id)arg25 displayName:(id)arg26 canLowercaseName:(_Bool)arg27;	// IMP=0x00000000000afc62
@property(readonly, copy, nonatomic) NSArray *possibleLabels;
@property(readonly, nonatomic) Class valueItemClass;
- (id)preferredTransactionModeWithCurrentMode:(id)arg1;	// IMP=0x0000000000099054
