...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c69c5
- (void).cxx_destruct;	// IMP=0x00000000000c6937
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c6302
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c5f19
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c5b3d
- (id)init;	// IMP=0x00000000000c5adf
