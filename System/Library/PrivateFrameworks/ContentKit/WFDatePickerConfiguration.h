...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002d028
- (void).cxx_destruct;	// IMP=0x000000000002cfea
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002ce68
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002cd13
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002cc0f
