...
+ (id)coercingToStringWithDescription:(id)arg1;	// IMP=0x00000000000c9e45
+ (id)accessingProperty:(id)arg1;	// IMP=0x00000000000c9d50
- (void).cxx_destruct;	// IMP=0x00000000000c9d28
...
- (id)initWithProperty:(id)arg1 description:(id)arg2;	// IMP=0x00000000000c9be1
