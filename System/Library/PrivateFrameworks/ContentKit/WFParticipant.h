...
+ (id)objectWithWFSerializedRepresentation:(id)arg1;	// IMP=0x000000000004c2ad
- (void).cxx_destruct;	// IMP=0x000000000004c264
...
- (id)wfSerializedRepresentation;	// IMP=0x000000000004be1a
@property(readonly, copy, nonatomic) NSString *wfName;
- (_Bool)isEquivalentToParticipant:(id)arg1;	// IMP=0x000000000004bcb2
- (id)initWithEKParticipant:(id)arg1;	// IMP=0x000000000004bb2b
- (id)initWithURL:(id)arg1 name:(id)arg2 emailAddress:(id)arg3 status:(long long)arg4 role:(long long)arg5 type:(long long)arg6 sourceIdentifier:(id)arg7 isManaged:(_Bool)arg8 isCurrentUser:(_Bool)arg9 contactPredicate:(id)arg10;	// IMP=0x000000000004b933
