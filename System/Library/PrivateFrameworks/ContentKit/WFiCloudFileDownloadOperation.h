...
- (_Bool)isAsynchronous;	// IMP=0x0000000000042670
- (void)finishRunningWithFiles:(id)arg1 error:(id)arg2;	// IMP=0x0000000000042423
- (void)downloadDirectoryAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000042345
- (void)downloadItemAtFileURL:(id)arg1 ofSize:(id)arg2 fileIsUbiquitous:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000042122
- (void)getFileInfoForURL:(id)arg1 fileIsUbiquitous:(_Bool *)arg2 fileIsDirectory:(_Bool *)arg3 fileSize:(id *)arg4 error:(id *)arg5;	// IMP=0x0000000000042054
- (void)start;	// IMP=0x0000000000041d6b
- (id)initWithFileURL:(id)arg1 retrieveFolderContents:(_Bool)arg2 progress:(id)arg3;	// IMP=0x0000000000041c12
