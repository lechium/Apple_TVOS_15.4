...
- (void).cxx_destruct;	// IMP=0x00000000000c990f
...
- (void)saveWithCompletionHandler:(CDUnknownBlockType)arg1 isNew:(_Bool)arg2;	// IMP=0x00000000000c98da
- (id)initWithContentItem:(id)arg1;	// IMP=0x00000000000c97cc
