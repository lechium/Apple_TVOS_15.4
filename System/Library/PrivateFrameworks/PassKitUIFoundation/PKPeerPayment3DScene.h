...
+ (MISSING_TYPE *)skewForRollPitch: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000003dea
+ (CDStruct_14d5dc5e)rotationMatrixForRollPitch: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000003c37
+ (MISSING_TYPE *)staticRollPitch;	// IMP=0x0000000000003c29
- (void).cxx_destruct;	// IMP=0x0000000000003f5e
...
- (void)resetScene;	// IMP=0x0000000000003a67
- (id)init;	// IMP=0x0000000000003704
