...
@interface PKAuthenticatorEvaluationRequest : NSObject
{
    ...
    _Bool _assumeBiometricOrPasscodeAvailable;	// 10 = 0xa
    _Bool _passcodeOnly;	// 11 = 0xb
...
- (void)dealloc;	// IMP=0x00000000000065a8
- (id)initWithPolicy:(long long)arg1;	// IMP=0x000000000000656b
- (id)init;	// IMP=0x0000000000006557
