...
- (void)motionManager:(id)arg1 didReceiveMotion:(id)arg2;	// IMP=0x00000000000060ca
- (void)didMoveToWindow;	// IMP=0x0000000000006047
- (void)layoutSubviews;	// IMP=0x0000000000006018
- (void)invalidate;	// IMP=0x0000000000005f9c
@property(readonly, nonatomic, getter=isInvalidated) _Bool invalidated;
- (void)dealloc;	// IMP=0x0000000000005f4e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005f40
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005f32
- (id)init;	// IMP=0x0000000000005f24
