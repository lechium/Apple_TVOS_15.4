...
+ (id)responseWithResult:(long long)arg1 biometricMatch:(_Bool)arg2 credential:(id)arg3;	// IMP=0x00000000000067a0
+ (id)responseWithResult:(long long)arg1;	// IMP=0x0000000000006789
- (void).cxx_destruct;	// IMP=0x0000000000006843
