...
- (void).cxx_destruct;	// IMP=0x000000000000cf1b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000cdfb
- (unsigned long long)hash;	// IMP=0x000000000000cd8e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000cc96
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000cbd2
- (void)copyTo:(id)arg1;	// IMP=0x000000000000cb4f
- (void)writeTo:(id)arg1;	// IMP=0x000000000000cad5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000cac8
- (id)dictionaryRepresentation;	// IMP=0x000000000000c793
- (id)description;	// IMP=0x000000000000c6e4
