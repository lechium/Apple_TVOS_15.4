...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000007f90b
- (unsigned long long)hash;	// IMP=0x000000000007f856
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007f709
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007f628
- (void)copyTo:(id)arg1;	// IMP=0x000000000007f56a
- (void)writeTo:(id)arg1;	// IMP=0x000000000007f47d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000007f470
- (id)dictionaryRepresentation;	// IMP=0x000000000007ed69
- (id)description;	// IMP=0x000000000007ecba
