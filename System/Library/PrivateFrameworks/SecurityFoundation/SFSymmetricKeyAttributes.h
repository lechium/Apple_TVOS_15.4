...
- (void).cxx_destruct;	// IMP=0x000000000000966c
...
- (void)setKeySpecifier:(id)arg1;	// IMP=0x000000000000960f
@property(readonly, copy, nonatomic) _SFKeySpecifier *keySpecifier;
@property(copy, nonatomic) NSString *localizedDescription;
@property(copy, nonatomic) NSString *localizedLabel;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000094c8
- (id)initWithSpecifier:(id)arg1 domain:(id)arg2;	// IMP=0x00000000000093f0
- (id)initWithSpecifier:(id)arg1;	// IMP=0x00000000000093d7
