...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000005f94
- (void).cxx_destruct;	// IMP=0x0000000000006d47
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006a6b
- (unsigned long long)hash;	// IMP=0x0000000000006a55
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000659e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000006429
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000006055
- (id)_initWithPrimaryServiceIdentifier:(id)arg1 supplementaryServiceIdentiifers:(id)arg2;	// IMP=0x0000000000005f9c
