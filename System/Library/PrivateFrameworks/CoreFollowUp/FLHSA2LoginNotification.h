...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000010d3e
- (void).cxx_destruct;	// IMP=0x00000000000117af
...
- (id)followUpItemUserInfo;	// IMP=0x000000000001149f
- (id)initWithFollowUpItemUserInfo:(id)arg1;	// IMP=0x000000000001123e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010ebc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010d46
