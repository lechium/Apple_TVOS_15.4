...
+ (id)actionWithLabel:(id)arg1 url:(id)arg2;	// IMP=0x000000000000afa3
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000af9b
- (void).cxx_destruct;	// IMP=0x000000000000b929
...
- (id)description;	// IMP=0x000000000000b7bf
- (_Bool)_loadActionURL;	// IMP=0x000000000000b5d0
@property(retain, nonatomic) NSData *_userInfoData;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b1a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b0e7
- (id)initWithLabel:(id)arg1 url:(id)arg2;	// IMP=0x000000000000b00f
