...
+ (long long)_daysRemaining:(id)arg1 ceiling:(_Bool)arg2;	// IMP=0x000000000000368e
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000023cf
+ (id)_expirationDateFormatter;	// IMP=0x000000000000223c
- (void).cxx_destruct;	// IMP=0x0000000000003a51
...
- (id)description;	// IMP=0x000000000000373d
- (id)_informativeNotificationTextOrDate;	// IMP=0x0000000000003566
- (id)formattedExpirationDate;	// IMP=0x000000000000313b
@property(readonly) _Bool isExpired;
- (id)_midnightAdjustedDate;	// IMP=0x0000000000002e2d
@property(retain, nonatomic) NSData *_userInfoData;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000026c7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002492
- (id)initWithoutDefaults;	// IMP=0x00000000000023a0
- (id)init;	// IMP=0x00000000000022c9
- (_Bool)isHSA2PasswordResetItem;	// IMP=0x00000000000118d0
- (_Bool)isHSA2LoginItem;	// IMP=0x000000000001185b
