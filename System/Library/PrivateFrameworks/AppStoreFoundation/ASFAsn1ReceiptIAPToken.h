...
+ (id)readFromBuffer:(id)arg1;	// IMP=0x00000000000015ff
- (void).cxx_destruct;	// IMP=0x00000000000019e1
...
- (id)description;	// IMP=0x000000000000183c
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x000000000000157e
