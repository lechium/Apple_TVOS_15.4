...
+ (id)readFromBuffer:(id)arg1;	// IMP=0x0000000000004af6
- (void).cxx_destruct;	// IMP=0x0000000000004fac
...
- (id)description;	// IMP=0x0000000000004e07
- (_Bool)contentIsAnInteger;	// IMP=0x0000000000004d81
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x0000000000004a75
