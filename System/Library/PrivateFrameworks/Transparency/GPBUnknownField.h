...
- (void)addGroup:(id)arg1;	// IMP=0x0000000000045315
- (void)addLengthDelimited:(id)arg1;	// IMP=0x00000000000452bc
- (void)addFixed64:(unsigned long long)arg1;	// IMP=0x0000000000045263
- (void)addFixed32:(unsigned int)arg1;	// IMP=0x000000000004520b
- (void)addVarint:(unsigned long long)arg1;	// IMP=0x00000000000451b2
- (void)mergeFromField:(id)arg1;	// IMP=0x0000000000044e86
- (id)description;	// IMP=0x0000000000044b24
- (unsigned long long)serializedSizeAsMessageSetExtension;	// IMP=0x0000000000044a0c
- (void)writeAsMessageSetExtensionToOutput:(id)arg1;	// IMP=0x00000000000448e9
- (unsigned long long)serializedSize;	// IMP=0x0000000000044573
- (void)writeToOutput:(id)arg1;	// IMP=0x0000000000044471
- (unsigned long long)hash;	// IMP=0x00000000000443dc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000044240
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044001
- (void)dealloc;	// IMP=0x0000000000043fa2
- (id)initWithNumber:(int)arg1;	// IMP=0x0000000000043f67
