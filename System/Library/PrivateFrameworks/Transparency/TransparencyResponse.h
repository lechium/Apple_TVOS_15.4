...
- (void).cxx_destruct;	// IMP=0x0000000000030848
...
- (id)serverHint;	// IMP=0x0000000000030752
- (id)initWithRequest:(id)arg1 responseData:(id)arg2 metadata:(id)arg3;	// IMP=0x000000000003068b
