...
- (void).cxx_destruct;	// IMP=0x00000000000b6952
...
- (void)rollKey:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b6306
- (void)signData:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b5eba
@property(readonly) NSData *accountPublicKey;
@property(readonly) NSData *accountPublicKeyInfo;
- (id)initWithApplication:(id)arg1;	// IMP=0x00000000000b5709
