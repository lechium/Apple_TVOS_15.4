...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000065159
- (void).cxx_destruct;	// IMP=0x00000000000662e0
...
- (_Bool)verifySignatureWithAccountKey:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000065e4a
- (void)computeHashesForSalt:(id)arg1;	// IMP=0x0000000000065d29
- (id)description;	// IMP=0x0000000000065d17
- (id)debugDescription;	// IMP=0x0000000000065961
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000655f3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000065378
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000065161
- (id)initWithClientData:(id)arg1;	// IMP=0x00000000000650e7
