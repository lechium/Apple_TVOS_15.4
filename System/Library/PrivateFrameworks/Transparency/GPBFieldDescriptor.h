...
- (void)dealloc;	// IMP=0x0000000000034937
- (id)initWithFieldDescription:(void *)arg1 includesDefault:(_Bool)arg2 usesClassRefs:(_Bool)arg3 proto3OptionalKnown:(_Bool)arg4 syntax:(unsigned char)arg5;	// IMP=0x0000000000034750
- (id)init;	// IMP=0x0000000000034702
