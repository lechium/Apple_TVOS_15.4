...
- (long long)compareByFieldNumber:(id)arg1;	// IMP=0x00000000000356a0
...
- (const char *)singletonNameC;	// IMP=0x00000000000354a3
@property(readonly, nonatomic) NSString *singletonName;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000035474
- (void)dealloc;	// IMP=0x0000000000035429
- (id)initWithExtensionDescription:(struct GPBExtensionDescription *)arg1;	// IMP=0x0000000000035415
- (id)initWithExtensionDescription:(struct GPBExtensionDescription *)arg1 usesClassRefs:(_Bool)arg2;	// IMP=0x000000000003533e
