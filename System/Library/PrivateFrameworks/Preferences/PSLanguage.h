...
+ (id)languageWithCode:(id)arg1 name:(id)arg2 localizedName:(id)arg3;	// IMP=0x0000000000080a15
- (void).cxx_destruct;	// IMP=0x0000000000080b8e
...
- (_Bool)displayNamesAreEqual;	// IMP=0x0000000000080ac9
