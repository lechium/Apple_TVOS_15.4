...
- (void).cxx_destruct;	// IMP=0x00000000000d4524
...
- (void)main;	// IMP=0x00000000000d3983
- (id)initWithResults:(id)arg1 diffableDataSource:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000000d38bd
