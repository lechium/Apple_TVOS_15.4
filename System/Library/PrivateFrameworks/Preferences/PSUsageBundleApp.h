...
+ (id)usageBundleAppForBundleWithIdentifier:(id)arg1 withTotalSize:(float)arg2 andCategories:(id)arg3;	// IMP=0x00000000000c3c91
+ (id)usageBundleAppForBundleWithIdentifier:(id)arg1 withTotalSize:(float)arg2;	// IMP=0x00000000000c3c7d
- (void).cxx_destruct;	// IMP=0x00000000000c3fdb
...
- (id)description;	// IMP=0x00000000000c3df3
