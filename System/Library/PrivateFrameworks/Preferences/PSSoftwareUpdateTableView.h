...
- (void).cxx_destruct;	// IMP=0x000000000004c486
...
- (void)layoutSubviews;	// IMP=0x000000000004b7ab
- (void)preferredContentSizeChanged:(id)arg1;	// IMP=0x000000000004b79e
- (id)initWithFrame:(struct CGRect)arg1 style:(long long)arg2;	// IMP=0x000000000004b421
