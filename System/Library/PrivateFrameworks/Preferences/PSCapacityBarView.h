...
- (void).cxx_destruct;	// IMP=0x00000000000cf1a7
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000ce473
- (id)bezierPathWithLineFrom:(struct CGPoint)arg1 to:(struct CGPoint)arg2;	// IMP=0x00000000000ce3f3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ce362
