...
- (struct CGSize)size;	// IMP=0x0000000000008f10
- (double)scale;	// IMP=0x0000000000008efe
- (struct CGImage *)CGImage;	// IMP=0x0000000000008ea7
- (void)dealloc;	// IMP=0x0000000000008e61
- (id)initWithNamedVectorGlyph:(id)arg1;	// IMP=0x0000000000008bfc
