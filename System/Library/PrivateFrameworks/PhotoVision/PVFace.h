...
+ (id)faceWithFace:(id)arg1 copyPropertiesOption:(long long)arg2;	// IMP=0x00000000000061cd
+ (id)faceFromVNFaceObservation:(id)arg1 fromImage:(id)arg2 additionalVisionRequests:(id)arg3 faceAlgorithmUmbrellaVersion:(unsigned int)arg4 error:(id *)arg5;	// IMP=0x0000000000038170
+ (id)faceFromVNFaceObservation:(id)arg1 fromImageWithPixelWidth:(unsigned long long)arg2 pixelHeight:(unsigned long long)arg3 additionalVisionRequests:(id)arg4 faceAlgorithmUmbrellaVersion:(unsigned int)arg5 error:(id *)arg6;	// IMP=0x00000000000370bf
- (void).cxx_destruct;	// IMP=0x0000000000006084
...
- (double)photosFaceRepresentationQuality;	// IMP=0x0000000000005ad1
- (double)photosFaceRepresentationRoll;	// IMP=0x0000000000005abf
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x0000000000005aad
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x0000000000005a9b
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x0000000000005a89
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x0000000000005a77
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x0000000000005a65
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x0000000000005a53
- (double)photosFaceRepresentationBlurScore;	// IMP=0x0000000000005a41
- (double)photosFaceRepresentationSize;	// IMP=0x0000000000005a2f
- (double)photosFaceRepresentationCenterY;	// IMP=0x0000000000005a1d
- (double)photosFaceRepresentationCenterX;	// IMP=0x0000000000005a0b
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x00000000000059f9
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x00000000000059e7
- (struct CGRect)absoluteFaceRectForImageSize:(struct CGSize)arg1;	// IMP=0x0000000000005902
- (struct CGRect)absoluteFaceRect;	// IMP=0x0000000000005846
- (struct CGRect)normalizedFaceRect;	// IMP=0x0000000000005794
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x0000000000005677
- (id)description;	// IMP=0x0000000000005289
@property(nonatomic) NSString *genderType;
- (void)setCoordinatesAndFeaturesFromFace:(id)arg1;	// IMP=0x0000000000004ea0
- (void)_copyPropertiesFrom:(id)arg1 copyPropertiesOption:(long long)arg2;	// IMP=0x0000000000004a9e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004a4e
