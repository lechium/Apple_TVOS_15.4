...
- (void).cxx_destruct;	// IMP=0x000000000003b7f1
...
- (double)sideFaceRatio;	// IMP=0x000000000003b4e0
- (void)invalidateCaches;	// IMP=0x000000000003b488
- (void)_cacheDatesWithoutOutliersWithMaximumDistanceBetweenMoments:(double)arg1;	// IMP=0x000000000003ade8
- (void)_cacheDates;	// IMP=0x000000000003aaa8
- (id)firstSeenDateWithoutOutliersForAgeType:(unsigned short)arg1;	// IMP=0x000000000003aa46
@property(readonly, nonatomic) double libraryTimespan;
- (void)pv_addMergeCandidatePersons:(id)arg1;	// IMP=0x000000000003a920
...
- (id)personLocalIdentifiers;	// IMP=0x000000000003a3e6
- (id)fetchMoments;	// IMP=0x000000000003a0ee
- (id)fetchAssets;	// IMP=0x0000000000039e04
- (id)fetchFaces;	// IMP=0x0000000000039aef
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000395d5
@property(readonly) unsigned long long hash;
- (id)initWithFaceGroup:(id)arg1 inPhotoLibrary:(id)arg2;	// IMP=0x00000000000394b5
- (id)initWithPerson:(id)arg1 inPhotoLibrary:(id)arg2;	// IMP=0x0000000000039372
