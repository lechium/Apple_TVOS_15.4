...
- (id)description;	// IMP=0x000000000001df03
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001deba
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x000000000001ddde
