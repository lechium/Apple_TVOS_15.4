...
- (void).cxx_destruct;	// IMP=0x000000000003dc8f
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000003d499
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000000003d328
- (id)init;	// IMP=0x000000000003d312
