...
- (void)_updateFrameForDisplay;	// IMP=0x0000000000009dcd
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000009cf8
@property(copy, nonatomic) NSString *password; // @dynamic password;
- (id)initWithDelegate:(id)arg1 uneditableUsername:(id)arg2;	// IMP=0x000000000000973c
