...
+ (id)keyForImageIdentifier:(id)arg1 withImageSource:(id)arg2;	// IMP=0x000000000001caaf
+ (id)fileNameWithIdentifierInImageSource:(id)arg1;	// IMP=0x000000000001c942
- (void).cxx_destruct;	// IMP=0x000000000001cc8f
