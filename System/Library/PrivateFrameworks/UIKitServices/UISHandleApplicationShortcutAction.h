...
- (_Bool)isKindOfClass:(Class)arg1;	// IMP=0x000000000000f862
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x000000000000f84b
@property(readonly, copy, nonatomic) UIApplicationShortcutItem *uiShortcutItem;
- (long long)UIActionType;	// IMP=0x000000000000f73f
@property(readonly, copy, nonatomic) SBSApplicationShortcutItem *sbsShortcutItem;
- (id)initWithSBSShortcutItem:(id)arg1;	// IMP=0x000000000000f4d4
