...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000fe40
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x000000000000fd9b
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000000fd13
- (id)initWithTop:(double)arg1 left:(double)arg2 bottom:(double)arg3 right:(double)arg4;	// IMP=0x000000000000fca3
