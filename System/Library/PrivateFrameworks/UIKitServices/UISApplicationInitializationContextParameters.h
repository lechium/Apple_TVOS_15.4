...
- (void).cxx_destruct;	// IMP=0x000000000000f4c4
...
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000000f1ce
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x000000000000ef81
- (id)init;	// IMP=0x000000000000ef09
