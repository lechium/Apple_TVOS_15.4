...
+ (_Bool)supportsBSXPCSecureCoding;	// IMP=0x000000000000dbb1
- (void).cxx_destruct;	// IMP=0x000000000000e17d
...
- (_Bool)isKindOfClass:(Class)arg1;	// IMP=0x000000000000dffa
- (id)initWithBSXPCCoder:(id)arg1;	// IMP=0x000000000000ddc4
- (void)encodeWithBSXPCCoder:(id)arg1;	// IMP=0x000000000000dbb9
