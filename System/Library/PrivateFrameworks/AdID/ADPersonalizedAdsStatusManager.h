...
+ (id)sharedInstance;	// IMP=0x000000000000bef9
- (void).cxx_destruct;	// IMP=0x000000000000c054
...
- (void)sendPersonalizedAdsStatusToAdPlatforms:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bf86
