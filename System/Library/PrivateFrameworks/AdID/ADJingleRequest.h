...
+ (id)incrementToken;	// IMP=0x000000000000294c
- (void).cxx_destruct;	// IMP=0x0000000000004163
...
- (void)sendJingleRequest:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003e06
- (void)handleJingleResponse;	// IMP=0x0000000000003847
- (void)send;	// IMP=0x0000000000002ac9
- (id)init:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000299a
