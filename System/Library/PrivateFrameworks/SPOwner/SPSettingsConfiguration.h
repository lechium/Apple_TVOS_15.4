...
- (void).cxx_destruct;	// IMP=0x0000000000043e87
...
- (void)setServiceState:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000438cf
- (void)beginRefreshingServiceStateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000435b7
- (void)_invalidate;	// IMP=0x00000000000434ff
- (void)dealloc;	// IMP=0x0000000000043443
- (id)init;	// IMP=0x0000000000043298
- (id)serviceSettingsConfiguration;	// IMP=0x0000000000015909
