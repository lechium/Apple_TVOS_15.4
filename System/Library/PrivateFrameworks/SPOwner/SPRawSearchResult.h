...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e3f7
- (void).cxx_destruct;	// IMP=0x000000000003e935
...
- (id)debugDescription;	// IMP=0x000000000003e823
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003e6df
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003e5fd
- (id)initWithHashedPublicKey:(id)arg1 publicKey:(id)arg2 status:(long long)arg3 timestamp:(id)arg4 latitude:(double)arg5 longitude:(double)arg6 horizontalAccuracy:(double)arg7;	// IMP=0x000000000003e50a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e3ff
