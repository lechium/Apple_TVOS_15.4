...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002fd09
- (void).cxx_destruct;	// IMP=0x0000000000030099
...
- (id)debugDescription;	// IMP=0x000000000002ff3d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002fe57
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002fd11
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002fcb9
- (void)persistToPrefs;	// IMP=0x000000000002fa29
- (id)initFromPrefs;	// IMP=0x000000000002f8a0
- (id)initWithInitialNoBeaconDuration:(double)arg1 fastRollAdvertisementDuration:(double)arg2 fastRollAdvertisementInterval:(double)arg3 slowRollAdvertisementDuration:(double)arg4 slowRollNoAdvertisementDuration:(double)arg5 noAdvertisementDurationDecayFactor:(double)arg6 postInitialDayAdvertisementTimes:(id)arg7;	// IMP=0x000000000002f7bf
