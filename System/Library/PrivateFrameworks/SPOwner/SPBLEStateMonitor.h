...
- (void).cxx_destruct;	// IMP=0x000000000003060f
...
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x00000000000304a8
- (void)notifyDelegate:(unsigned long long)arg1;	// IMP=0x000000000003042d
- (void)startMonitoring;	// IMP=0x000000000003031c
- (id)init;	// IMP=0x00000000000302e0
