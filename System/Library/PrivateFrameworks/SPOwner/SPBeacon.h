...
+ (id)SPOwner;	// IMP=0x000000000000e62a
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000e622
...
- (id)debugDescription;	// IMP=0x000000000000fc49
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f3af
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ef2d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e761
- (unsigned long long)hash;	// IMP=0x000000000000e71d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e64a
