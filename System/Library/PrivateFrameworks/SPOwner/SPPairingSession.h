...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e968
- (void).cxx_destruct;	// IMP=0x000000000003fc69
...
- (id)debugDescription;	// IMP=0x000000000003f89e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003f22b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003ef09
- (void)updateToPairingUsingTool;	// IMP=0x000000000003eef2
- (void)updateAckSuccess:(_Bool)arg1;	// IMP=0x000000000003eee0
- (void)updatePairingLocation:(id)arg1;	// IMP=0x000000000003eece
- (void)updateWithConfiguration:(id)arg1;	// IMP=0x000000000003ed4a
- (void)updateName:(id)arg1 roleId:(long long)arg2 roleEmoji:(id)arg3;	// IMP=0x000000000003ecd9
- (void)updateBeaconId:(id)arg1;	// IMP=0x000000000003ecc7
- (void)updateWithPayloadSignature:(id)arg1 attestation:(id)arg2 collaborativeKey:(id)arg3 systemVersion:(id)arg4 vendorId:(long long)arg5 productId:(long long)arg6 ecid:(id)arg7 chipId:(id)arg8 serialNumber:(id)arg9;	// IMP=0x000000000003eb5e
- (void)updateWithSeed:(id)arg1 collaborativeKeyC2:(id)arg2 serverSignature:(id)arg3 serverPublicKey:(id)arg4 maskedAppleID:(id)arg5 userMessage:(id)arg6 baaIntermediateCert:(id)arg7 baaLeafCert:(id)arg8;	// IMP=0x000000000003ea09
- (id)initWithIdentifier:(id)arg1 nonce:(id)arg2;	// IMP=0x000000000003e970
