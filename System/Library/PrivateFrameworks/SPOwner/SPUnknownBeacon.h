...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000019ae6
- (void).cxx_destruct;	// IMP=0x000000000001a7d0
...
- (id)debugDescription;	// IMP=0x000000000001a5a7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001a12c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019f67
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019c05
- (unsigned long long)hash;	// IMP=0x0000000000019bc1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000019aee
