...
+ (id)_stringFromMotionState:(long long)arg1;	// IMP=0x000000000002a8c4
+ (id)_stringFromPublishReason:(long long)arg1;	// IMP=0x000000000002a849
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002a124
- (void).cxx_destruct;	// IMP=0x000000000002aa4e
...
- (id)debugDescription;	// IMP=0x000000000002a636
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002a44b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002a2e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002a12c
