...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000011620
- (void).cxx_destruct;	// IMP=0x0000000000011d5b
...
- (id)description;	// IMP=0x0000000000011b91
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000119aa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011868
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000011628
