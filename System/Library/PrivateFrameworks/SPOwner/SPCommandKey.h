...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003504
- (void).cxx_destruct;	// IMP=0x0000000000003ce5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000038c2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000037ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000036b8
- (id)initWithBeaconingKey:(id)arg1 commandKey:(id)arg2 connectionToken:(id)arg3 nearbyToken:(id)arg4 primaryIndex:(id)arg5 secondaryIndex:(id)arg6 type:(long long)arg7;	// IMP=0x000000000000358d
