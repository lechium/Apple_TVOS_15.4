...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000019486
- (void).cxx_destruct;	// IMP=0x0000000000019ab3
...
- (id)description;	// IMP=0x000000000001993e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000197cd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000196cd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000195f2
- (id)initWithDateInterval:(id)arg1 key:(id)arg2 secondaryKey:(id)arg3 primaryIndex:(unsigned long long)arg4 secondaryIndex:(unsigned long long)arg5;	// IMP=0x0000000000019527
- (id)initWithDateInterval:(id)arg1 key:(id)arg2;	// IMP=0x000000000001948e
