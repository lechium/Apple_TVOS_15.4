...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000002708
- (void).cxx_destruct;	// IMP=0x0000000000002cae
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002a66
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002975
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000282b
- (id)initWithName:(id)arg1 roleId:(long long)arg2 roleEmoji:(id)arg3 keyStatus:(id)arg4 collaborativeKeyC3:(id)arg5 signatureS4:(id)arg6 isZeus:(_Bool)arg7 batteryLevel:(long long)arg8;	// IMP=0x0000000000002710
