...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000deec
- (void).cxx_destruct;	// IMP=0x000000000000e5d9
...
- (id)debugDescription;	// IMP=0x000000000000e499
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000e320
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000e246
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e11c
- (unsigned long long)hash;	// IMP=0x000000000000e0d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e005
- (id)initWithIdentifier:(id)arg1 handle:(id)arg2 accepted:(_Bool)arg3 expiration:(id)arg4 correlationIdentifier:(id)arg5 shareDate:(id)arg6 sharePrimaryIndex:(unsigned long long)arg7;	// IMP=0x000000000000def4
