...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000018c59
- (void).cxx_destruct;	// IMP=0x0000000000019432
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019219
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019075
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000018c61
