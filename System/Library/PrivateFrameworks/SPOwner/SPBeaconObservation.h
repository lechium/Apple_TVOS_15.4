...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000017459
- (void).cxx_destruct;	// IMP=0x00000000000176c9
...
- (id)description;	// IMP=0x0000000000017617
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000174fa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000017461
- (id)initWithBeaconIdentifier:(id)arg1 type:(long long)arg2 date:(id)arg3 location:(id)arg4;	// IMP=0x0000000000017249
- (id)init;	// IMP=0x00000000000171a8
