...
+ (id)remoteInterface;	// IMP=0x00000000000072fd
+ (id)exportedInterface;	// IMP=0x0000000000007291
- (void).cxx_destruct;	// IMP=0x000000000000797a
...
- (oneway void)discoveryFinished:(id)arg1;	// IMP=0x0000000000007832
- (oneway void)discoveredObject:(id)arg1;	// IMP=0x00000000000077b2
- (void)stopScanning;	// IMP=0x00000000000075b1
- (void)startScanningIncludeServiceCharacteristics:(_Bool)arg1;	// IMP=0x0000000000007369
- (id)userAgentProxy;	// IMP=0x000000000000727f
- (void)invalidationHandler:(id)arg1;	// IMP=0x0000000000006f03
- (void)interruptionHandler:(id)arg1;	// IMP=0x0000000000006d9a
- (id)init;	// IMP=0x0000000000006b42
