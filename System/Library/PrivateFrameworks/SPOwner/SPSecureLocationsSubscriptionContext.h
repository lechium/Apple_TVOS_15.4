...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000a86a
- (void).cxx_destruct;	// IMP=0x000000000000ac96
...
- (id)description;	// IMP=0x000000000000aba0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000aa0a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000a96e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a8d3
