...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000179ca
- (void).cxx_destruct;	// IMP=0x0000000000018b53
...
- (id)description;	// IMP=0x0000000000018834
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001827d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001801b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000179d2
