...
+ (id)feedbackEventsFromAppUsageEvents:(id)arg1 playingEvents:(id)arg2 microLocationEvents:(id)arg3 feedbackEvents:(id)arg4;	// IMP=0x00000000000134ca
- (void).cxx_destruct;	// IMP=0x0000000000014b45
...
- (id)analyticsDictionary;	// IMP=0x00000000000147e2
- (id)description;	// IMP=0x00000000000145dd
- (id)init;	// IMP=0x0000000000013414
