...
- (void).cxx_destruct;	// IMP=0x000000000000ec7a
...
- (void)registerARPHomeControlNotificationTask;	// IMP=0x000000000000ea79
- (void)execute;	// IMP=0x000000000000d0e6
- (id)initWithCorrelationsFile:(id)arg1 knowledgeStore:(id)arg2;	// IMP=0x000000000000d010
