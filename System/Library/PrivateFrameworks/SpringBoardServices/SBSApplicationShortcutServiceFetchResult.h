...
- (void).cxx_destruct;	// IMP=0x0000000000008983
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000895a
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000000887c
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x000000000000879d
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008405
- (id)init;	// IMP=0x00000000000083af
- (id)initWithStaticApplicationShortcutItems:(id)arg1 dynamicApplicationShortcutItems:(id)arg2 composedApplicationShortcutItems:(id)arg3;	// IMP=0x00000000000082c9
