...
- (void)_setupAndActivateConnection;	// IMP=0x00000000000070e4
- (oneway void)presentWithConfiguration:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000000706a
- (oneway void)activateConfiguration:(id)arg1;	// IMP=0x0000000000006ef4
- (void)invalidate;	// IMP=0x0000000000006eb7
