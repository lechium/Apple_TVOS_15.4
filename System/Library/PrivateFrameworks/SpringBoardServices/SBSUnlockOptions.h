...
+ (_Bool)supportsBSXPCSecureCoding;	// IMP=0x00000000000016e9
- (void).cxx_destruct;	// IMP=0x0000000000001942
...
- (id)initWithBSXPCCoder:(id)arg1;	// IMP=0x0000000000001803
- (void)encodeWithBSXPCCoder:(id)arg1;	// IMP=0x00000000000016f1
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x0000000000001591
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x0000000000001470
