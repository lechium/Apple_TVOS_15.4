...
- (void).cxx_destruct;	// IMP=0x000000000003f7e1
...
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x000000000003f6d5
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x000000000003f641
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x000000000003f5ad
