...
+ (_Bool)supportsBSXPCSecureCoding;	// IMP=0x0000000000015ef2
- (void).cxx_destruct;	// IMP=0x000000000001612b
...
- (id)initWithBSXPCCoder:(id)arg1;	// IMP=0x0000000000015f94
- (void)encodeWithBSXPCCoder:(id)arg1;	// IMP=0x0000000000015efa
- (id)initWithListIdentifier:(id)arg1 focusModeIdentifier:(id)arg2 machPortSendRight:(id)arg3;	// IMP=0x0000000000015e0c
