...
+ (id)infoWithConsumer:(id)arg1;	// IMP=0x0000000000001a11
- (void).cxx_destruct;	// IMP=0x0000000000001dfd
...
- (void)invalidate;	// IMP=0x0000000000001d32
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000000196a
