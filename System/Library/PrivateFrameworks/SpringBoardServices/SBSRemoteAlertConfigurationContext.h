...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002aae2
+ (id)configurationContextWithLegacyAlertOptions:(id)arg1;	// IMP=0x000000000002a8a3
- (void).cxx_destruct;	// IMP=0x000000000002aff6
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002ac69
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002aaea
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000002aa32
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x000000000002a946
