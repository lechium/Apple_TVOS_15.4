...
+ (id)_staticApplicationShortcutItemsFromInfoPlistEntry:(id)arg1;	// IMP=0x0000000000009adc
- (void).cxx_destruct;	// IMP=0x000000000000a745
...
- (void)_localizeWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000a54a
@property(copy, nonatomic) NSDictionary *userInfo;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000009825
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000926e
@property(readonly) unsigned long long hash;
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x00000000000090b5
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x0000000000008dd8
