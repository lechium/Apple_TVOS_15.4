...
- (void).cxx_destruct;	// IMP=0x0000000000003efc
...
- (double)heightForWidth:(double)arg1 inView:(id)arg2;	// IMP=0x00000000000032b1
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000003286
- (void)layoutSubviews;	// IMP=0x0000000000002804
- (double)_labelsAndLinksBaselineOffsetForView:(id)arg1;	// IMP=0x0000000000002739
@property(retain, nonatomic) UIColor *bottomLineColor;
- (void)setLinkText:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000023b0
- (void)setTitleText:(id)arg1;	// IMP=0x0000000000002339
- (void)_linkButtonPressed;	// IMP=0x000000000000231f
- (void)tintColorDidChange;	// IMP=0x00000000000021f1
@property(nonatomic) struct CGSize iconSize;
@property(retain, nonatomic) NSString *iconAccessibilityLabel;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001a45
