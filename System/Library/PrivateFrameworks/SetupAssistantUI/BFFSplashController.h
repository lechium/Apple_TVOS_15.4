...
- (void).cxx_destruct;	// IMP=0x0000000000009a08
...
- (void)_buttonPressed:(id)arg1;	// IMP=0x0000000000009751
- (void)_updateTrayVisibility;	// IMP=0x00000000000095d2
- (void)updateBleedViewLayout;	// IMP=0x0000000000009488
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000000945a
- (void)updateBleedColor;	// IMP=0x0000000000009248
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000009184
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000009097
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000009056
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000007c18
- (id)contentScrollView;	// IMP=0x0000000000007c03
- (void)loadView;	// IMP=0x000000000000795e
- (void)setButtonsEnabled:(_Bool)arg1;	// IMP=0x00000000000077d2
- (id)_createButtonWithTitle:(id)arg1 style:(long long)arg2;	// IMP=0x0000000000007534
- (void)_updateButtonFonts;	// IMP=0x0000000000007301
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000072ef
@property(readonly, nonatomic) BFFPaneHeaderView *headerView;
- (void)setLinkText:(id)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006e0d
- (id)buttonAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000006d88
- (void)setTitle:(id)arg1 forButtonAtIndex:(unsigned long long)arg2 action:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006d69
- (void)removeAllButtons;	// IMP=0x0000000000006bd0
- (void)addButtonWithTitle:(id)arg1 style:(long long)arg2 action:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006b3a
- (void)setTitle:(id)arg1;	// IMP=0x00000000000068a1
@property(retain, nonatomic) UIImage *icon;
- (id)init;	// IMP=0x00000000000066b2
