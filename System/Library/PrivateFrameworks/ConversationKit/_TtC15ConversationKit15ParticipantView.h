...
@interface _TtC15ConversationKit15ParticipantView : UIView
{
    ...
    MISSING_TYPE *participantIdentifier;	// 1088 = 0x440
    MISSING_TYPE *delegate;	// 2737752 = 0x29c658
    MISSING_TYPE *isInRoster;	// 2737752 = 0x29c658
    MISSING_TYPE *shouldOverrideShadowHidden;	// 268435456 = 0x10000000
    MISSING_TYPE *customCornerRadius;	// 0 = 0x0
    MISSING_TYPE *isExpanded;	// 0 = 0x0
}

- (void).cxx_destruct;	// IMP=0x0000000000212d77
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000215278
- (void)didTapKickMember;	// IMP=0x00000000002151bf
- (void)layoutSubviews;	// IMP=0x000000000021383f
- (void)dealloc;	// IMP=0x0000000000212d5a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000212cd6
