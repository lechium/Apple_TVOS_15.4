...
- (void).cxx_destruct;	// IMP=0x00000000000d29dc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000d2997
- (void)configureWith:(id)arg1 isFullScreenMode:(_Bool)arg2;	// IMP=0x00000000000d288c
- (void)layoutSubviews;	// IMP=0x00000000000d259f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d2587
- (id)init;	// IMP=0x00000000000d2450
