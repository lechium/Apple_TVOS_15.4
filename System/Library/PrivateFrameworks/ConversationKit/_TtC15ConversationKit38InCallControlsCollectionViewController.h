...
- (void).cxx_destruct;	// IMP=0x00000000000fbad7
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000fba86
- (void)handleContentSizeCategoryDidChange:(id)arg1;	// IMP=0x00000000000fa9dc
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000fa580
- (void)viewDidLoad;	// IMP=0x00000000000fa553
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f9100
