...
- (id)description;	// IMP=0x000000000003470d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003466c
- (unsigned long long)hash;	// IMP=0x0000000000034662
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000345f4
...
- (id)initWithNanosecondsSinceEpoch:(unsigned long long)arg1 onGrandmaster:(unsigned long long)arg2 withLocalPortNumber:(unsigned short)arg3 ptpTimescale:(_Bool)arg4 timeTraceable:(_Bool)arg5 frequencyTraceable:(_Bool)arg6;	// IMP=0x000000000003453b
- (id)initWithSeconds:(unsigned long long)arg1 nanoseconds:(unsigned int)arg2 onGrandmaster:(unsigned long long)arg3 withLocalPortNumber:(unsigned short)arg4 ptpTimescale:(_Bool)arg5 timeTraceable:(_Bool)arg6 frequencyTraceable:(_Bool)arg7;	// IMP=0x00000000000344f8
- (id)init;	// IMP=0x00000000000344bc
