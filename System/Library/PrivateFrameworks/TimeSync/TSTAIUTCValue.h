...
- (void).cxx_destruct;	// IMP=0x0000000000034fae
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000034e01
@property(readonly, nonatomic) NSDictionary *dictionary; // @dynamic dictionary;
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000034934
- (id)init;	// IMP=0x0000000000034845
