...
- (void).cxx_destruct;	// IMP=0x000000000002ccce
@property(retain, nonatomic) TSgPTPPort *port; // @synthesize port=_port;
- (void)didTimeoutOnMACLookupForPort:(id)arg1;	// IMP=0x000000000002cc22
- (void)setMACLookupTimeoutCallback:(CDUnknownFunctionPointerType)arg1 refcon:(void *)arg2;	// IMP=0x000000000002cad2
- (id)initWithgPTPPort:(id)arg1 onClockIdentifier:(unsigned long long)arg2;	// IMP=0x000000000002c9d3
