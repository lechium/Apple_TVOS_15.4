...
+ (id)iokitMatchingDictionaryForClockIdentifier:(unsigned long long)arg1;	// IMP=0x0000000000033637
...
- (_Bool)resetFilterToNominal:(_Bool)arg1 error:(id *)arg2;	// IMP=0x000000000003386b
- (_Bool)resetSyncServiceWithError:(id *)arg1;	// IMP=0x00000000000337f4
- (_Bool)addTimestampWithMachAbsolute:(unsigned long long)arg1 andDomainTime:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000033746
