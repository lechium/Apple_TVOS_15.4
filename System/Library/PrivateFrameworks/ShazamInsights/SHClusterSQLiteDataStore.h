...
+ (_Bool)sqliteDatabaseExistsAtURL:(id)arg1;	// IMP=0x0000000000007d5e
- (void).cxx_destruct;	// IMP=0x000000000000854c
...
- (_Bool)isDataLoaded;	// IMP=0x00000000000080e4
- (_Bool)hasNotPassedExpiryDate:(id)arg1 isForCountryCode:(id)arg2;	// IMP=0x0000000000007f2b
- (_Bool)isDataValid;	// IMP=0x0000000000007e87
- (id)initWithClusterType:(long long)arg1 databaseMaxAge:(double)arg2 forStorefront:(id)arg3 databaseFilePathURL:(id)arg4;	// IMP=0x0000000000007dd6
