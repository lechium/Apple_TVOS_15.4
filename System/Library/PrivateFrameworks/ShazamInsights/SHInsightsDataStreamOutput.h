...
- (void).cxx_destruct;	// IMP=0x000000000000264e
@property(retain, nonatomic) NSOutputStream *outputStream; // @synthesize outputStream=_outputStream;
@property(retain, nonatomic) id <SHInsightsDataStream> next; // @synthesize next=_next;
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000024d3
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x000000000000243a
- (id)initWithDestination:(id)arg1;	// IMP=0x00000000000023a0
- (void)dealloc;	// IMP=0x000000000000235e
