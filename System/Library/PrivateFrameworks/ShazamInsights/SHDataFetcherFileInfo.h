...
+ (id)dataFetcherForSourceURL:(id)arg1;	// IMP=0x0000000000005008
...
- (id)initWithDataURL:(id)arg1;	// IMP=0x0000000000005173
- (id)initWithDataURL:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x00000000000050da
- (id)initWithData:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x0000000000005041
