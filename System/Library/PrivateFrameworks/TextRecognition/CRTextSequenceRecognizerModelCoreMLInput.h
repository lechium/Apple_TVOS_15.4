...
- (void).cxx_destruct;	// IMP=0x0000000000019158
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000190c1
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImg_input:(id)arg1 featureInfo:(id)arg2;	// IMP=0x000000000001902f
