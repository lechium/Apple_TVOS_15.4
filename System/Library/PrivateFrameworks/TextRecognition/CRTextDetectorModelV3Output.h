...
- (void).cxx_destruct;	// IMP=0x0000000000074438
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000742fb
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithRegion_score:(id)arg1 affinity_score:(id)arg2 script_score:(id)arg3 link_score:(id)arg4;	// IMP=0x0000000000074219
