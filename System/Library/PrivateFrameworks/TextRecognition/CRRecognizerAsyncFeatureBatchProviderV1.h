...
- (void).cxx_destruct;	// IMP=0x000000000010ec78
...
- (void)enumerateInputsForImage:(id)arg1 textFeatures:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000010d864
- (id)initWithConfiguration:(id)arg1 inputProvider:(id)arg2 error:(id *)arg3;	// IMP=0x000000000010d7cb
