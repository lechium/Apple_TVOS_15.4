...
- (void).cxx_destruct;	// IMP=0x000000000001be20
...
- (id)initWithImg_input:(struct vImage_Buffer)arg1 batchSize:(unsigned long long)arg2 featureInfo:(id)arg3;	// IMP=0x000000000001bc40
