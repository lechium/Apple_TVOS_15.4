...
- (void).cxx_destruct;	// IMP=0x0000000000111be2
...
- (id)initWithString:(id)arg1 score:(double)arg2 features:(id)arg3 wordID:(int)arg4 properties:(unsigned long long)arg5;	// IMP=0x0000000000111adc
