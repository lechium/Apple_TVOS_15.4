...
- (void).cxx_destruct;	// IMP=0x00000000000f5960
...
- (long long)subscriberCount;	// IMP=0x00000000000f5868
- (_Bool)hasSubscriber:(id)arg1;	// IMP=0x00000000000f5786
- (void)removeSubscriber:(id)arg1;	// IMP=0x00000000000f56ac
- (void)addSubscriber:(id)arg1;	// IMP=0x00000000000f55d2
- (void)pushResource:(id)arg1;	// IMP=0x00000000000f54f6
- (id)popResource;	// IMP=0x00000000000f52ac
- (id)initWithLocaleIdentifier:(id)arg1 resourceType:(long long)arg2;	// IMP=0x00000000000f5198
