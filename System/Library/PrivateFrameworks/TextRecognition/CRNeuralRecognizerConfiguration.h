...
- (void).cxx_destruct;	// IMP=0x0000000000077a0c
...
- (void)setConfidenceThresholdsForRevision:(unsigned long long)arg1;	// IMP=0x00000000000776f7
- (id)textFeatureFilter;	// IMP=0x0000000000077602
- (void)loadLanguageModelWeightsForLanguageIdentifier:(id)arg1 rev:(unsigned long long)arg2;	// IMP=0x0000000000077413
- (long long)bestFitWidthIndexForAspectRatio:(double)arg1;	// IMP=0x0000000000077191
@property(readonly) CRConfidenceThresholds *confidenceThresholds;
@property(readonly) _Bool filterWithLM;
- (id)initV3DefaultConfigWithOptions:(id)arg1;	// IMP=0x000000000007700e
- (id)initV2DefaultConfigWithOptions:(id)arg1;	// IMP=0x0000000000076f2b
- (id)initV1DefaultConfigWithOptions:(id)arg1;	// IMP=0x0000000000076e12
- (_Bool)usesAppleNeuralEngine;	// IMP=0x0000000000076df3
- (id)initWithLocale:(id)arg1 imageReaderOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000076945
