...
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x00000000000430b8
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000042fb2
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000042e49
+ (id)sharedCharacterSetRules;	// IMP=0x0000000000042e04
- (id).cxx_construct;	// IMP=0x00000000000443ff
- (void).cxx_destruct;	// IMP=0x00000000000443c7
...
- (unsigned long long)_characterType:(unsigned int)arg1;	// IMP=0x0000000000043d78
- (unsigned long long)_expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000043b98
- (unsigned long long)_expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x00000000000435d9
- (void)dealloc;	// IMP=0x00000000000434e4
- (id)init;	// IMP=0x00000000000431be
