...
- (void).cxx_destruct;	// IMP=0x000000000010699b
...
- (id)initWithSymbol:(id)arg1 index:(unsigned long long)arg2 score:(double)arg3 startNode:(unsigned long long)arg4 endNode:(unsigned long long)arg5;	// IMP=0x00000000001068b2
