...
+ (id)defaultURLOfModelInThisBundle;	// IMP=0x00000000000fcd8a
...
- (_Bool)preheatWithError:(id *)arg1;	// IMP=0x00000000000fcf40
- (id)inputBatchFromTextFeatures:(id)arg1 image:(id)arg2 featureWidth:(double)arg3 configuration:(id)arg4;	// IMP=0x00000000000fcf38
- (id)predictFromInputs:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000fcf30
- (id)initWithConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000fcf01
- (_Bool)supportCharacterBoxes;	// IMP=0x00000000000fcef9
@property(readonly) NSURL *modelURL;
- (id)populateInputBatchData:(float *)arg1 textFeatures:(id)arg2 image:(id)arg3 batchSize:(long long)arg4 width:(double)arg5 configuration:(id)arg6;	// IMP=0x00000000000fc191
- (void)dealloc;	// IMP=0x00000000000fc14a
