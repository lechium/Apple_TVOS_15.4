...
+ (id)languageSetFromInputLanguages:(id)arg1 supportedLanguages:(id)arg2;	// IMP=0x0000000000075ee8
+ (id)supportedLanguagesForVersion:(long long)arg1;	// IMP=0x0000000000075d25
- (void).cxx_destruct;	// IMP=0x0000000000076482
...
- (id)initV3DefaultConfigWithOptions:(id)arg1;	// IMP=0x0000000000075b48
- (id)initV2DefaultConfigWithOptions:(id)arg1;	// IMP=0x0000000000075afa
- (id)initV1DefaultConfigWithOptions:(id)arg1;	// IMP=0x0000000000075aa6
- (id)initWithImageReaderOptions:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000075781
