...
- (void).cxx_destruct;	// IMP=0x0000000000106c0f
...
- (void)setGraph:(id)arg1;	// IMP=0x0000000000106b90
- (void)appendPath:(id)arg1;	// IMP=0x0000000000106b79
- (id)initWithRect:(struct CGRect)arg1;	// IMP=0x0000000000106ae0
