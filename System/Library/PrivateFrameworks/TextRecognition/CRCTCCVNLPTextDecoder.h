...
+ (id)lmSupportedLanguages;	// IMP=0x000000000011d6c9
- (void).cxx_destruct;	// IMP=0x0000000000120b34
...
- (void)_decodeFeaturesWithInfo:(id)arg1 activations:(id)arg2 imageSize:(struct CGSize)arg3 error:(id *)arg4;	// IMP=0x000000000011ecb7
- (_Bool)_wordLMShouldFilterCandidate:(id)arg1;	// IMP=0x000000000011e64e
- (void)_create2DArraysFromInputArray:(id)arg1 classSize:(unsigned long long *)arg2 outputArrays:(void *)arg3;	// IMP=0x000000000011dc15
- (id)_buildActivationMatrices:(id)arg1;	// IMP=0x000000000011d7bf
- (void)decodeOutput:(id)arg1 imageSize:(struct CGSize)arg2 error:(id *)arg3;	// IMP=0x000000000011d6df
- (_Bool)shouldDecodeWithLM;	// IMP=0x000000000011d6d6
@property(readonly) struct CVNLPTextDecodingPruningPolicy pruningPolicy;
- (void)dealloc;	// IMP=0x000000000011d52b
- (id)initWithConfiguration:(id)arg1 model:(id)arg2 error:(id *)arg3;	// IMP=0x000000000011d160
