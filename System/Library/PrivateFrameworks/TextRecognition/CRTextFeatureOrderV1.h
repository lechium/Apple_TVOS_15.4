...
- (id)orderAndGroupFeatures:(id)arg1 imageSize:(struct CGSize)arg2;	// IMP=0x0000000000112bbb
- (id)initWithAngleThresholdForRotatedCrops:(double)arg1;	// IMP=0x0000000000112b78
