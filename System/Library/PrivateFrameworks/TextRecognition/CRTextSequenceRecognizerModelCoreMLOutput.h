...
- (void).cxx_destruct;	// IMP=0x000000000001927b
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000191e4
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithOutput_label_prob_map:(id)arg1;	// IMP=0x0000000000019180
