...
- (void).cxx_destruct;	// IMP=0x00000000001122cc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000112240
...
- (void)addToken:(id)arg1;	// IMP=0x0000000000111c78
- (id)init;	// IMP=0x0000000000111c0a
