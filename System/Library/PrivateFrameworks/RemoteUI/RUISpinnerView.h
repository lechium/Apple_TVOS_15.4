...
- (void).cxx_destruct;	// IMP=0x0000000000042242
...
- (void)viewDidLayout;	// IMP=0x00000000000417d0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000417b3
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000041796
- (id)spinnerView;	// IMP=0x000000000004164c
