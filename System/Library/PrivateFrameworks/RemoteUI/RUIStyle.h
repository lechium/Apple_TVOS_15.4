...
+ (id)_staticButtonTitleColorWithTintColor:(id)arg1;	// IMP=0x000000000000e909
+ (id)watchDefaultStyle;	// IMP=0x000000000000e41b
+ (id)frontRowStyle;	// IMP=0x000000000000e402
+ (id)setupAssistantModalStyle;	// IMP=0x000000000000e3e9
+ (id)setupAssistantStyle;	// IMP=0x000000000000e3d0
+ (id)osloStyle;	// IMP=0x000000000000e3b7
+ (id)defaultStyle;	// IMP=0x000000000000e31e
+ (id)sharedInstance;	// IMP=0x000000000000e24a
- (void).cxx_destruct;	// IMP=0x000000000000ed83
...
- (id)boldButtonTitleColorWithTintColor:(id)arg1;	// IMP=0x000000000000e83e
- (id)init;	// IMP=0x000000000000e51e
- (void)applyToNavigationBar:(id)arg1;	// IMP=0x000000000000e518
- (void)applyToNavigationController:(id)arg1;	// IMP=0x000000000000e455
- (void)applyToObjectModel:(id)arg1;	// IMP=0x000000000000e44f
- (void)applyToLabel:(id)arg1;	// IMP=0x000000000000e449
