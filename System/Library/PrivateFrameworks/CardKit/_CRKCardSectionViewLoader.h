...
- (id)_viewConfigurationForCardSection:(id)arg1 providerIdentifier:(id)arg2;	// IMP=0x0000000000015355
- (id)_allViewConfigurations;	// IMP=0x00000000000151ba
- (_Bool)cardSectionShouldBeDisplayed:(id)arg1;	// IMP=0x000000000001514d
- (id)viewConfigurationForCardSection:(id)arg1;	// IMP=0x0000000000014b32
- (void)_loadIdentifiedCardSectionViewProvidersFromCard:(id)arg1 identifiedProviders:(id)arg2 delegate:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000013d06
- (id)init;	// IMP=0x0000000000013c7a
