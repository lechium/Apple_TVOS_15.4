...
- (unsigned long long)displayPriorityForCardSection:(id)arg1;	// IMP=0x0000000000011c59
- (_Bool)vetoDisplayOfCardSection:(id)arg1;	// IMP=0x0000000000011c43
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000011bb3
