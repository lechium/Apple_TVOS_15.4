...
- (void).cxx_destruct;	// IMP=0x000000000000fa07
...
- (void)handleResponseHeaders:(id)arg1;	// IMP=0x000000000000f753
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000000000f567
- (id)messageBody;	// IMP=0x000000000000f1fa
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x000000000000f0c0
- (_Bool)isIDSMessage;	// IMP=0x000000000000f0ac
- (_Bool)wantsIDSProtocolVersion;	// IMP=0x000000000000f0a4
- (_Bool)isWebTunnelMessage;	// IMP=0x000000000000f09c
- (_Bool)wantsCompressedBody;	// IMP=0x000000000000f094
- (_Bool)wantsBinaryPush;	// IMP=0x000000000000f08c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000ee20
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000ed52
