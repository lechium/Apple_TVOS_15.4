...
+ (id)dependencies;	// IMP=0x000000000017920b
+ (id)taskWithRequest:(id)arg1 imageAsset:(id)arg2 andSignpostPayload:(id)arg3;	// IMP=0x0000000000179022
- (void).cxx_destruct;	// IMP=0x0000000000179cb3
- (int)run;	// IMP=0x0000000000179239
- (void)cancel;	// IMP=0x000000000017922e
- (_Bool)autoCancellable;	// IMP=0x0000000000179226
- (float)resourceRequirement;	// IMP=0x0000000000179218
- (id)initWithRequest:(id)arg1 imageAsset:(id)arg2 andSignpostPayload:(id)arg3;	// IMP=0x0000000000178f47
