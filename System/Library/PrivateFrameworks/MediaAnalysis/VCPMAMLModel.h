...
+ (id)vcp_sharedModelWithModelName:(id)arg1;	// IMP=0x00000000000c7963
- (void).cxx_destruct;	// IMP=0x00000000000c7ac0
...
- (id)initWithModelName:(id)arg1;	// IMP=0x00000000000c6f88
- (id)init;	// IMP=0x00000000000c6f7a
