...
+ (id)mergeCandidatePairWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x00000000000842d4
- (void).cxx_destruct;	// IMP=0x00000000000847df
...
- (id)description;	// IMP=0x00000000000846e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000844a2
- (unsigned long long)hash;	// IMP=0x0000000000084498
- (id)initWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x000000000008437f
