...
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x0000000000153bf8
- (void).cxx_destruct;	// IMP=0x0000000000154749
...
- (double)photosFaceRepresentationQuality;	// IMP=0x00000000001542f3
- (double)photosFaceRepresentationRoll;	// IMP=0x00000000001542e1
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x00000000001542cf
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x00000000001542bd
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x00000000001542ab
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x0000000000154299
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x0000000000154287
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x0000000000154275
- (double)photosFaceRepresentationBlurScore;	// IMP=0x0000000000154263
- (double)photosFaceRepresentationSize;	// IMP=0x0000000000154251
- (double)photosFaceRepresentationCenterY;	// IMP=0x000000000015423f
- (double)photosFaceRepresentationCenterX;	// IMP=0x000000000015422d
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x000000000015421b
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x0000000000154209
- (id)gistDescription;	// IMP=0x0000000000154081
- (struct CGRect)normalizedFaceRect;	// IMP=0x0000000000154000
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x0000000000153f8d
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x0000000000153c49
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x0000000000153ae2
