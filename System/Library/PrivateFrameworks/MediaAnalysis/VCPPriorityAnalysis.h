...
+ (id)priorityAnalysis;	// IMP=0x0000000000185cfb
- (id).cxx_construct;	// IMP=0x0000000000187337
- (void).cxx_destruct;	// IMP=0x0000000000187270
- (int)calculatePriorityScore:(float *)arg1 ofPixelBuffer:(struct __CVBuffer *)arg2 withMetadata:(id)arg3;	// IMP=0x0000000000186ef0
- (int)fastSignLanguageDetection:(float *)arg1 ofPixelBuffer:(struct __CVBuffer *)arg2 withMetadata:(id)arg3;	// IMP=0x0000000000186130
- (int)addKeypointsToNSArray:(struct CGPoint *)arg1 keypointConfidence:(float [21])arg2 handBox:(id)arg3 keypointsArray:(id)arg4;	// IMP=0x0000000000185d15
- (void)dealloc;	// IMP=0x0000000000185c52
- (id)init;	// IMP=0x00000000001858c0
