...
- (id).cxx_construct;	// IMP=0x000000000023543b
- (void).cxx_destruct;	// IMP=0x00000000002353ff
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x0000000000234f90
- (void)mergeSimilarSegments;	// IMP=0x0000000000234e1a
- (int)processFrameMetadata:(id)arg1;	// IMP=0x0000000000234b85
- (_Bool)decideSegmentPointBasedOn:(float)arg1;	// IMP=0x0000000000234aef
- (id)init;	// IMP=0x00000000002349b8
