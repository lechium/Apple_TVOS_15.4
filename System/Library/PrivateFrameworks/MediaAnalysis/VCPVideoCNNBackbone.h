...
+ (id)sharedModel:(id)arg1 outputNames:(id)arg2 properties:(id)arg3;	// IMP=0x000000000004312d
- (void).cxx_destruct;	// IMP=0x0000000000043707
...
- (int)inference:(float *)arg1;	// IMP=0x0000000000043624
- (id)initWithConfig:(id)arg1;	// IMP=0x00000000000432e4
