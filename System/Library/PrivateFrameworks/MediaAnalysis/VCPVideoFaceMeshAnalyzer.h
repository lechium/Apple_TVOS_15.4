...
- (void).cxx_destruct;	// IMP=0x00000000002188e0
...
- (int)analyzeFrame:(struct __CVBuffer *)arg1 withFaceRect:(struct CGRect)arg2 withRotation:(int)arg3 withTimestamp:(CDStruct_1b6d18a9)arg4;	// IMP=0x000000000021887c
- (_Bool)isTracked;	// IMP=0x0000000000218874
- (_Bool)updateFocalLengthInPixels:(float)arg1;	// IMP=0x000000000021886c
- (id)initWithFocalLengthInPixels:(float)arg1 offline:(_Bool)arg2 isFastMode:(_Bool)arg3;	// IMP=0x000000000021885e
