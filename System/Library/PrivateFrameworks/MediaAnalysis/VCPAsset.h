...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x0000000000160016
- (id)typeDescription;	// IMP=0x0000000000160199
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x0000000000160359
...
- (struct CGSize)originalMovieSize;	// IMP=0x000000000016056b
- (id)originalMovie;	// IMP=0x0000000000160547
- (id)streamedMovie;	// IMP=0x000000000016053f
- (id)movie;	// IMP=0x000000000016051b
