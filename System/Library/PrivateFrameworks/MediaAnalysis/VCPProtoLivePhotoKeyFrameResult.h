...
+ (Class)faceResultsType;	// IMP=0x000000000000b375
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x000000000020803a
- (void).cxx_destruct;	// IMP=0x000000000000d6c0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000d2f5
- (unsigned long long)hash;	// IMP=0x000000000000c885
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c686
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c3df
- (void)copyTo:(id)arg1;	// IMP=0x000000000000c23e
- (void)writeTo:(id)arg1;	// IMP=0x000000000000bfd1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000bfc4
- (id)dictionaryRepresentation;	// IMP=0x000000000000b4c7
...
- (id)faceResultsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000000b358
- (unsigned long long)faceResultsCount;	// IMP=0x000000000000b33b
- (void)addFaceResults:(id)arg1;	// IMP=0x000000000000b2d1
- (void)clearFaceResults;	// IMP=0x000000000000b2b4
- (id)exportToLegacyDictionary;	// IMP=0x00000000002087ac
