...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000016097e
- (void).cxx_destruct;	// IMP=0x0000000000160cb7
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000160a5c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000160986
- (id)initWithTransform:(CDStruct_14d5dc5e)arg1 blendShapes:(id)arg2 geometry:(id)arg3;	// IMP=0x0000000000160878
