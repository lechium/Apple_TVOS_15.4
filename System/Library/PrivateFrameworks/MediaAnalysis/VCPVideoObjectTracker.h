...
- (void).cxx_destruct;	// IMP=0x00000000002366f3
...
- (int)trackObjectInFrame:(struct __CVBuffer *)arg1;	// IMP=0x0000000000236267
- (id)initWithObjectBounds:(struct CGRect)arg1 inFrame:(struct __CVBuffer *)arg2 timestamp:(CDStruct_1b6d18a9)arg3;	// IMP=0x0000000000235f00
