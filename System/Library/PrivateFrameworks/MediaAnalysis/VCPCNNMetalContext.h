...
+ (_Bool)supportVectorForward;	// IMP=0x00000000000201d8
+ (_Bool)supportGPU;	// IMP=0x00000000000201d0
...
- (int)execute;	// IMP=0x00000000000201ee
- (id)initNewContext:(_Bool)arg1;	// IMP=0x00000000000201e0
