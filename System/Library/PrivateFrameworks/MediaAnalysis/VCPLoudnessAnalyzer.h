...
- (id).cxx_construct;	// IMP=0x00000000001a9331
- (void).cxx_destruct;	// IMP=0x00000000001a92d3
- (id)results;	// IMP=0x00000000001a925d
- (int)finalizeAnalysisAtTime:(const CDStruct_1b6d18a9 *)arg1;	// IMP=0x00000000001a8af6
- (int)processAudioSamples:(struct AudioBufferList *)arg1 timestamp:(struct AudioTimeStamp)arg2;	// IMP=0x00000000001a829e
- (void)dealloc;	// IMP=0x00000000001a8226
- (int)setupWithSample:(struct opaqueCMSampleBuffer *)arg1 andSampleBatchSize:(int)arg2;	// IMP=0x00000000001a80b9
- (id)init;	// IMP=0x00000000001a8014
