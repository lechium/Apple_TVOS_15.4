...
- (void).cxx_destruct;	// IMP=0x00000000000e297f
...
- (void)checkAutoPlayable;	// IMP=0x00000000000e2755
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000e2644
- (_Bool)isShort;	// IMP=0x00000000000e25f9
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000e2106
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000e2035
