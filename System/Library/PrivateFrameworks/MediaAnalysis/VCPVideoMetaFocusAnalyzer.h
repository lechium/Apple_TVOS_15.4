...
- (void).cxx_destruct;	// IMP=0x0000000000231271
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x00000000002311cc
- (void)addSegmentToResults;	// IMP=0x0000000000230fa0
- (int)processFrameMetadata:(id)arg1;	// IMP=0x0000000000230d68
- (id)init;	// IMP=0x0000000000230c82
