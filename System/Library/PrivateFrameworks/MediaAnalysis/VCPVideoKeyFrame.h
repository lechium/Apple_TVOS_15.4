...
- (void).cxx_destruct;	// IMP=0x000000000022b3d0
...
- (void)printStats;	// IMP=0x000000000022b073
- (_Bool)hasGoodSubjectAction;	// IMP=0x000000000022b04e
- (float)computeScoreFromExposure;	// IMP=0x000000000022b01b
- (float)computeScoreFromColorfulness;	// IMP=0x000000000022aff1
- (float)computeExpressionScore;	// IMP=0x000000000022acdc
- (float)computeScoreFromAction;	// IMP=0x000000000022ac95
- (void)computeCurationScore;	// IMP=0x000000000022ac04
- (void)computeCurationScoreComponents;	// IMP=0x000000000022ab7a
- (void)storeFrameResults;	// IMP=0x000000000022a4ce
- (float)computePenaltyScore;	// IMP=0x000000000022a12c
- (float)computeContentScore;	// IMP=0x000000000022a0c2
- (float)computeVisualPleasingScore;	// IMP=0x000000000022a058
- (float)computeGlobalQuality;	// IMP=0x0000000000229fe1
- (void)computeGlobalQualityForLivePhoto;	// IMP=0x0000000000229f93
- (void)setMotionStatsFlag:(_Bool)arg1 cameraMotion:(float)arg2 subjectAction:(float)arg3 interestingness:(float)arg4 obstruction:(float)arg5 colorfulness:(float)arg6 exposureScore:(float)arg7 humanActionStatsFlag:(_Bool)arg8 humanPoseScore:(float)arg9 humanActionScore:(float)arg10 subMb:(_Bool)arg11;	// IMP=0x0000000000229f32
- (void)setFaceStatsFlag:(_Bool)arg1 detectedFaces:(id)arg2;	// IMP=0x0000000000229d8d
- (void)resetStatsFlag;	// IMP=0x0000000000229d7f
- (int)loadKeyFrameResult:(id)arg1 timestamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000229543
- (void)copyFrom:(id)arg1;	// IMP=0x0000000000229360
- (id)initWithLivePhoto:(_Bool)arg1;	// IMP=0x0000000000229203
