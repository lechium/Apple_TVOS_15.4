...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000153267
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000153168
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000001530e4
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000015307a
- (id)init;	// IMP=0x0000000000153006
