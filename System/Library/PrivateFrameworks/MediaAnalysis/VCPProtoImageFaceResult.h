...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00000000001aa3b0
- (void).cxx_destruct;	// IMP=0x00000000001aa39d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001aa202
- (unsigned long long)hash;	// IMP=0x00000000001aa056
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a9f1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a9e3a
- (void)copyTo:(id)arg1;	// IMP=0x00000000001a9d92
- (void)writeTo:(id)arg1;	// IMP=0x00000000001a9cbd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001a9cb0
- (id)dictionaryRepresentation;	// IMP=0x00000000001a959e
- (id)description;	// IMP=0x00000000001a94ef
@property(nonatomic) _Bool hasFaceQuality;
- (id)exportToLegacyDictionary;	// IMP=0x00000000001aa743
