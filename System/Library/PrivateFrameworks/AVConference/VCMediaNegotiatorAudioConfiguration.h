...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ab5be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002ab3fc
- (_Bool)isSecondaryPayload:(int)arg1;	// IMP=0x00000000002ab3c3
- (void)addAudioPayload:(int)arg1 isSecondary:(_Bool)arg2;	// IMP=0x00000000002ab23f
- (void)dealloc;	// IMP=0x00000000002ab1d2
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5 audioRuleCollection:(id)arg6;	// IMP=0x00000000002aaf58
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5;	// IMP=0x00000000002aaf3b
