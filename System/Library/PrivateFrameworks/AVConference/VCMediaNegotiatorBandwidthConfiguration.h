...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ca4e
- (id)initWithMode:(int)arg1 connectionType:(int)arg2 maxBandwidth:(unsigned int)arg3;	// IMP=0x000000000001c9da
- (id)initWithConnectionType:(int)arg1 maxBandwidth:(unsigned int)arg2;	// IMP=0x000000000001c966
