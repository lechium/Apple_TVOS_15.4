...
- (void)updateBandwidthDivergeCountAtArrivalTime:(double)arg1 suddenChangeAbove:(_Bool)arg2 suddenChangeBelow:(_Bool)arg3;	// IMP=0x00000000002dbc56
- (_Bool)isSuddenChangeDurationMetAtArrivalTime:(double)arg1;	// IMP=0x00000000002dbbf5
- (void)compensateSuddenChangeBandwidths;	// IMP=0x00000000002dbba5
- (void)recordSuddenChangeBandwidth:(double)arg1;	// IMP=0x00000000002dbb8a
- (void)detectSuddenChangeWithBandwidth:(double)arg1 suddenChangeAbove:(_Bool *)arg2 suddenChangeBelow:(_Bool *)arg3;	// IMP=0x00000000002db8c8
- (void)updateInitialBandwidthEstimationForCellularAtTime:(double)arg1 bandwidth:(double)arg2;	// IMP=0x00000000002db85b
- (void)initializeBandwidthEstimationAtTime:(double)arg1 mediaTimestamp:(unsigned int)arg2 probingSequence:(_Bool)arg3 probingSequenceID:(unsigned int)arg4;	// IMP=0x00000000002db835
- (double)updateBandwidthEstimation:(double)arg1 arrivalTime:(double)arg2;	// IMP=0x00000000002db57b
- (double)resetBandwidthWithParameters:(double)arg1 probingSequenceDuration:(double)arg2 probingSequenceSize:(unsigned int)arg3 packetsInProbingSequence:(unsigned int)arg4;	// IMP=0x00000000002db517
- (_Bool)isPacketProcessedLateWithArrivalTime:(double)arg1;	// IMP=0x00000000002db4f8
- (void)updateQualificationParameters;	// IMP=0x00000000002db32e
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x00000000002db321
- (void)calculateBandwidthEstimationForBandwidthSample:(double)arg1 arrivalTime:(double)arg2;	// IMP=0x00000000002db1d6
- (void)calculateBandwidthEstimationAtTime:(double)arg1 mediaTimestamp:(unsigned int)arg2 mediaDataSize:(unsigned int)arg3 probingSequence:(_Bool)arg4 probingSequenceID:(unsigned int)arg5;	// IMP=0x00000000002daed2
- (void)dealloc;	// IMP=0x00000000002dab50
- (id)init;	// IMP=0x00000000002daa9e
