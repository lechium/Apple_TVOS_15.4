...
- (void)resetAudioBufferPool;	// IMP=0x00000000001f164c
- (void)cleanupQueue:(struct opaqueCMSimpleQueue **)arg1;	// IMP=0x00000000001f15cb
- (_Bool)createAudioBufferPool;	// IMP=0x00000000001f140d
- (_Bool)stop;	// IMP=0x00000000001f12fe
- (_Bool)start;	// IMP=0x00000000001f1204
- (void)dealloc;	// IMP=0x00000000001f10d0
- (id)initWithConfiguration:(CDStruct_0a4efd25 *)arg1;	// IMP=0x00000000001f098a
