...
- (void)didUpdateBasebandCodec:(const struct _VCRemoteCodecInfo *)arg1;	// IMP=0x000000000012b669
- (void)closeRecordings;	// IMP=0x000000000012b663
- (void)createRecordingsWithName:(id)arg1;	// IMP=0x000000000012b65d
- (void)destroyPacketThread;	// IMP=0x000000000012b626
- (_Bool)createPacketThreadWithIOBufferDuration:(double)arg1 name:(id)arg2 error:(id *)arg3;	// IMP=0x000000000012b42e
- (void)pullAudioSamples:(struct opaqueVCAudioBufferList *)arg1;	// IMP=0x000000000012b2ec
- (void)pushAudioSamples:(struct opaqueVCAudioBufferList *)arg1;	// IMP=0x000000000012b26a
- (void)internalPushAudioSamples:(struct opaqueVCAudioBufferList *)arg1;	// IMP=0x000000000012b144
...
- (void)printStreamFormats;	// IMP=0x000000000012af75
- (void)createAudioBuffers;	// IMP=0x000000000012ae9b
- (void)createBuffersForIOContext:(struct tagVCAudioRelayIOContext *)arg1;	// IMP=0x000000000012ae59
@property id <VCBasebandCodecNotifications> relay;
@property(nonatomic) const struct _VCRemoteCodecInfo *remoteCodecInfo;
- (_Bool)isEqualToRelayIO:(id)arg1;	// IMP=0x000000000012acd6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012abe3
- (_Bool)isInitialized;	// IMP=0x000000000012ab88
- (void)initializeFormatContextPointers;	// IMP=0x000000000012ab4e
- (void)dealloc;	// IMP=0x000000000012aa6e
- (id)initWithMicContext:(const struct tagVCAudioRelayIOContext *)arg1 speakerContext:(const struct tagVCAudioRelayIOContext *)arg2;	// IMP=0x000000000012a91a
- (id)init;	// IMP=0x000000000012a8ab
