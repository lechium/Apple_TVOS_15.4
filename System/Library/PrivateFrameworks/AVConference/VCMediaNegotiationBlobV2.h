...
+ (Class)streamGroupsType;	// IMP=0x000000000009783b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000009884a
- (unsigned long long)hash;	// IMP=0x0000000000098778
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000985e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000098371
- (void)copyTo:(id)arg1;	// IMP=0x0000000000098211
- (void)writeTo:(id)arg1;	// IMP=0x0000000000098069
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000009805c
- (id)dictionaryRepresentation;	// IMP=0x00000000000978e6
- (id)description;	// IMP=0x000000000009784c
- (id)streamGroupsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000009781e
- (unsigned long long)streamGroupsCount;	// IMP=0x0000000000097801
- (void)addStreamGroups:(id)arg1;	// IMP=0x00000000000977b4
- (void)clearStreamGroups;	// IMP=0x0000000000097797
...
- (void)dealloc;	// IMP=0x0000000000097654
- (void)printWithTitle:(id)arg1 logFile:(void *)arg2;	// IMP=0x00000000000f5469
