...
- (void)updateRedundancyPercentage;	// IMP=0x00000000001d3e52
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000001d3dd1
- (id)init;	// IMP=0x00000000001d3d65
