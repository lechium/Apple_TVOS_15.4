...
@interface VCEmulatedPacket : NSObject
{
    ...
    unsigned char _datagram[1500];	// 49 = 0x31
...
- (id)initWithPacketID:(unsigned int)arg1 datagram:(char *)arg2 datagramSize:(unsigned int)arg3;	// IMP=0x00000000000bee58
- (id)initWithPacketID:(unsigned int)arg1;	// IMP=0x00000000000bedfa
