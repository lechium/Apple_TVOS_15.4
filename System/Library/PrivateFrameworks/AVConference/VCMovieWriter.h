...
- (void)setupInputs;	// IMP=0x0000000000302955
- (void)startWritingAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000030281d
- (void)appendMetaData;	// IMP=0x0000000000302342
- (void)processSampleQueue:(struct opaqueCMBufferQueue *)arg1 input:(id)arg2 lastPresentationTime:(CDStruct_1b6d18a9 *)arg3;	// IMP=0x0000000000301ff5
- (void)setupInput:(id)arg1 queue:(struct opaqueCMBufferQueue *)arg2 dispatchGroup:(id)arg3 lastPresentationTime:(CDStruct_1b6d18a9 *)arg4;	// IMP=0x0000000000301e1f
- (id)setupAssetWriterWithWidth:(int)arg1 height:(int)arg2 transactionID:(id)arg3;	// IMP=0x00000000003013ef
- (void)finishWritingWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003011a0
- (void)setStillImageTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000030107a
- (_Bool)shouldFinishWritingSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 RTPtimeStamp:(unsigned int)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000300f95
- (_Bool)shouldAppendSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 RTPtimeStamp:(unsigned int)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000300df2
- (void)setEndRTPTimestampWithTimestamp:(unsigned int)arg1;	// IMP=0x0000000000300ddf
- (void)appendAudioSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 mediaType:(unsigned char)arg2;	// IMP=0x0000000000300cb3
- (void)appendVideoSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 cameraStatus:(unsigned char)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000300cad
- (void)setupContectRect:(struct CGRect)arg1 withCaptureHeight:(int)arg2;	// IMP=0x0000000000300b91
- (void)setupWriterWithMode:(unsigned char)arg1;	// IMP=0x0000000000300b85
- (void)dealloc;	// IMP=0x0000000000300a51
- (id)initWithOutputURL:(id)arg1 transactionID:(id)arg2 videoCodec:(unsigned int)arg3;	// IMP=0x00000000003008e3
