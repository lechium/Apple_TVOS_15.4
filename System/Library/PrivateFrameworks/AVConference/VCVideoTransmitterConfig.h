...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x0000000000233bd9
- (void)dealloc;	// IMP=0x0000000000233b32
- (id)description;	// IMP=0x00000000002339f9
- (id)init;	// IMP=0x0000000000233920
