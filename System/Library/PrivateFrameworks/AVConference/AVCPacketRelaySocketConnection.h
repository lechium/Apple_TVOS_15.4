...
- (void)dealloc;	// IMP=0x00000000002ce4a3
- (id)description;	// IMP=0x00000000002ce3d7
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x00000000002ce135
- (void)receiveDataOnSocket:(unsigned short)arg1;	// IMP=0x00000000002cdede
- (void)readyToRead;	// IMP=0x00000000002cdec8
- (int)stop;	// IMP=0x00000000002cddcb
- (int)start;	// IMP=0x00000000002cdc76
- (id)initWithSocket:(unsigned short)arg1 remoteAddress:(id)arg2 packetFilter:(id)arg3;	// IMP=0x00000000002cd874
