...
- (void)setConfig:(id)arg1 pid:(id)arg2;	// IMP=0x000000000035154f
- (void)updateScreenShareWith:(id)arg1 pid:(id)arg2;	// IMP=0x000000000035153d
- (void)dealloc;	// IMP=0x00000000003514c3
- (id)initWithConfig:(id)arg1 pid:(id)arg2;	// IMP=0x0000000000351440
