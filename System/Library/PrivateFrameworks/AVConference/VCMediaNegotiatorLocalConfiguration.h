...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e149a
- (_Bool)isEqualFaceTimeSettings:(id)arg1;	// IMP=0x00000000000e13b5
- (_Bool)isEqualMomentsVideoCodecs:(id)arg1;	// IMP=0x00000000000e1229
- (_Bool)isEqualMomentsImageTypes:(id)arg1;	// IMP=0x00000000000e1097
- (_Bool)isEqualFeatureStrings:(id)arg1;	// IMP=0x00000000000e0b92
- (_Bool)isEqualStreamGroupConfigs:(id)arg1;	// IMP=0x00000000000e0955
- (_Bool)isEqualMultiwayVideoStreamSet:(id)arg1;	// IMP=0x00000000000e071e
- (_Bool)isEqualMultiwayAudioStreamSet:(id)arg1;	// IMP=0x00000000000e04e7
- (_Bool)isEqualBandwidthConfigurations:(id)arg1;	// IMP=0x00000000000e02e2
- (void)resetStreamGroups;	// IMP=0x00000000000e02c9
- (void)addStreamGroupConfig:(id)arg1;	// IMP=0x00000000000e02b0
- (void)addMultiwayVideoStream:(id)arg1;	// IMP=0x00000000000e029a
- (void)addMultiwayAudioStream:(id)arg1;	// IMP=0x00000000000e0284
- (void)addBandwidthConfiguration:(id)arg1;	// IMP=0x00000000000e026e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dff11
- (_Bool)setupBandwidthExtensionConfiguration:(id)arg1;	// IMP=0x00000000000dfadd
- (_Bool)setupBandwidthConfigurationsWithArbiter:(id)arg1;	// IMP=0x00000000000df60b
- (void)dealloc;	// IMP=0x00000000000df541
- (id)initWithBitrateArbiter:(id)arg1;	// IMP=0x00000000000df4f8
- (id)init;	// IMP=0x00000000000df1c7
