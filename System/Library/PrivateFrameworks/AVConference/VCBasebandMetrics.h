...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000015f0f4
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x000000000015efe8
- (void)resetBBNoteHistoryList;	// IMP=0x000000000015efcd
- (void)resetBDCDList;	// IMP=0x000000000015efb2
- (void)normalizeBDCD:(double)arg1;	// IMP=0x000000000015ed51
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x000000000015ece2
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x000000000015ea2d
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000015e96a
- (CDStruct_87b99198)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000015e70b
- (void)dealloc;	// IMP=0x000000000015e6ad
- (id)init;	// IMP=0x000000000015e606
