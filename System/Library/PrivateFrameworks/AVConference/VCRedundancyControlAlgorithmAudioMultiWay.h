...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x000000000022779b
- (void)computeRedundancyInfo;	// IMP=0x0000000000227728
- (void)processRCNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000002275f7
- (void)processNWConnectionStatistics:(CDStruct_87b99198)arg1;	// IMP=0x000000000022755d
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x0000000000227530
- (id)init;	// IMP=0x00000000002274c0
