...
- (void)dealloc;	// IMP=0x0000000000028bf4
- (id)initWithBinCount:(unsigned int)arg1 streamToken:(long long)arg2 sinkContext:(void *)arg3 sinkCallback:(CDUnknownFunctionPointerType)arg4;	// IMP=0x0000000000028a8f
