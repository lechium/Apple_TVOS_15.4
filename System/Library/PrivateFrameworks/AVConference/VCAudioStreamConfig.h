...
+ (int)bundlingSchemeForAudioStreamMode:(long long)arg1 payloadType:(int)arg2;	// IMP=0x000000000033c7b5
...
- (void)addSupportedNumRedundantPayload:(unsigned int)arg1;	// IMP=0x000000000033d309
- (void)addCodecConfiguration:(id)arg1;	// IMP=0x000000000033d22e
@property(nonatomic) const struct tagVCAudioFrameFormat *externalIOFormat;
- (_Bool)setupDTMFCodecWithClientDictionary:(id)arg1;	// IMP=0x000000000033cfa0
- (_Bool)setupCNCodecWithClientDictionary:(id)arg1;	// IMP=0x000000000033cd3e
- (void)setupRedWithRxPayload:(unsigned int)arg1 txPayload:(unsigned int)arg2;	// IMP=0x000000000033ccea
- (_Bool)setupCodecWithClientDictionary:(id)arg1;	// IMP=0x000000000033c85e
- (void)dealloc;	// IMP=0x000000000033c73a
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000033c3d3
- (id)init;	// IMP=0x000000000033c346
