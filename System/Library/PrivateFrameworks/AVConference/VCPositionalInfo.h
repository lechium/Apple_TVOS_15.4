...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002a3012
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002a3131
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002a301a
...
- (void)unserialize:(id)arg1;	// IMP=0x00000000002a2bf6
- (id)serialize;	// IMP=0x00000000002a2b34
- (id)description;	// IMP=0x00000000002a2aea
- (id)init;	// IMP=0x00000000002a2a8f
