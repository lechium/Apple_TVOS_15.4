...
- (id)delegate;	// IMP=0x00000000000f01d2
- (void)dealloc;	// IMP=0x00000000000f00c9
- (id)initWithPixelBuffer:(struct __CVBuffer *)arg1 depthPixelBuffer:(struct __CVBuffer *)arg2 time:(CDStruct_1b6d18a9)arg3 imageData:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000000eff50
- (id)initWithPixelBuffer:(struct __CVBuffer *)arg1 time:(CDStruct_1b6d18a9)arg2 imageData:(id)arg3;	// IMP=0x00000000000efea9
