...
- (void)applyMediaStreamClientDictionary:(id)arg1;	// IMP=0x00000000003233dc
- (void)setupMediaStreamConfig;	// IMP=0x000000000032335e
@property(readonly, nonatomic) long long primaryTxCodecType;
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000032319e
- (void)addTxPayloadType:(int)arg1;	// IMP=0x0000000000323187
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000032311c
- (void)addRxPayloadType:(int)arg1;	// IMP=0x0000000000323105
- (id)description;	// IMP=0x00000000003230c4
- (void)dealloc;	// IMP=0x0000000000322fe6
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x0000000000322f1d
- (id)init;	// IMP=0x0000000000322eae
