...
- (void)dealloc;	// IMP=0x000000000034f6c5
- (id)description;	// IMP=0x000000000034f691
- (long long)compare:(id)arg1;	// IMP=0x000000000034f64d
- (id)initWithBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x000000000034f5c4
