...
+ (_Bool)bundlingAppliedByCodecForPayload:(int)arg1 mode:(int)arg2;	// IMP=0x000000000031b891
+ (id)newAudioTierForPayloadConfig:(id)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 headerSize:(unsigned int)arg6;	// IMP=0x000000000031b79f
...
- (_Bool)isEqualTo:(id)arg1;	// IMP=0x000000000031bb99
- (id)dictionary;	// IMP=0x000000000031ba2b
- (id)description;	// IMP=0x000000000031b986
- (id)initWithNetworkBitrate:(unsigned int)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 payloadConfig:(id)arg6;	// IMP=0x000000000031b8c6
