...
- (void)runUntilTime:(double)arg1;	// IMP=0x000000000006c0fd
- (id)copyPacketFromPop;	// IMP=0x000000000006c0ad
- (void)push:(id)arg1;	// IMP=0x000000000006c074
- (void)dealloc;	// IMP=0x000000000006bff0
- (id)initWithPolicies:(id)arg1;	// IMP=0x000000000006bf01
