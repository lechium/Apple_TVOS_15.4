...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(double *)arg1;	// IMP=0x00000000003363f8
- (void)computeRedundancyInfo;	// IMP=0x0000000000336385
- (void)processRCNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x0000000000336268
- (void)processNWConnectionStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000003361ce
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000003361a1
- (id)init;	// IMP=0x0000000000336129
