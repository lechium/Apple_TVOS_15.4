...
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x000000000029701b
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x0000000000296fd1
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x0000000000296f87
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x0000000000296f71
- (void)dealloc;	// IMP=0x0000000000296ef6
- (id)init;	// IMP=0x0000000000296e57
