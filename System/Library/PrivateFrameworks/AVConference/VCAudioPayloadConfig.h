...
- (id)description;	// IMP=0x000000000036c876
- (id)className;	// IMP=0x000000000036c864
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x000000000036c782
- (void)dealloc;	// IMP=0x000000000036c724
- (id)initWithConfigDict:(id)arg1;	// IMP=0x000000000036c69c
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x000000000036c2f9
- (void)createSupportedBitratesForEVS;	// IMP=0x000000000036c2d8
- (void)createSupportedBitratesForAMR16k;	// IMP=0x000000000036c2b7
- (void)createSupportedBitratesForAMR8k;	// IMP=0x000000000036c296
- (void)createSupportedBitratesForOpus;	// IMP=0x000000000036c275
- (void)createSupportedBitratesForAACELD48;	// IMP=0x000000000036c254
- (void)createSupportedBitratesForAACELD;	// IMP=0x000000000036c233
- (void)createSupportedBitrates;	// IMP=0x000000000036c1b4
- (unsigned int)aacBitrate;	// IMP=0x000000000036c086
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x000000000036c00b
- (_Bool)configure:(id)arg1;	// IMP=0x000000000036b974
