...
- (void)deregisterPeriodicTask;	// IMP=0x00000000002c874b
- (void)setErrorResponseCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000002c872f
- (id)sessionInfoSynchronizerDelegate;	// IMP=0x00000000002c8721
@property(readonly) id reportingAgent;
- (void)setVCIDSSessionInfoPublishedStreamIDs:(id)arg1;	// IMP=0x00000000002c82bf
- (void)sendVCIDSSessionInfoSubscribedStreamIDs:(id)arg1;	// IMP=0x00000000002c7e9c
- (void)retryVCIDSSessionInfoSubscribedStreamIDs;	// IMP=0x00000000002c7c72
- (void)setVCIDSSessionInfoSubscribedStreamIDs:(id)arg1;	// IMP=0x00000000002c79de
- (void)dealloc;	// IMP=0x00000000002c7904
- (void)flushRealTimeReportingStats;	// IMP=0x00000000002c9b7a
- (void)registerPeriodicTask;	// IMP=0x00000000002c9b27
- (void)periodicTask:(void *)arg1;	// IMP=0x00000000002c98f1
- (void)optOutStreamIDsForNonPrimaryConnection:(id)arg1 sentOnConnection:(id)arg2;	// IMP=0x00000000002c967b
- (void)optInStreamIDsForNewPrimaryConnection:(id)arg1 oldPrimaryConnection:(id)arg2;	// IMP=0x00000000002c9639
- (void)optInAllStreamsForConnection:(id)arg1;	// IMP=0x00000000002c9620
- (void)optInStreamIDsForConnection:(id)arg1;	// IMP=0x00000000002c9363
- (void)updateVCIDSSessionInfoResponse:(id)arg1;	// IMP=0x00000000002c8de9
- (void)checkVCIDSSessionInfoNeedUpdate:(unsigned char)arg1;	// IMP=0x00000000002c8b9f
- (void)resetParticipantGenerationCounter;	// IMP=0x00000000002c8ac4
@property(retain, nonatomic) NSNumber *duplicationLinkID;
@property(retain, nonatomic) NSNumber *primaryLinkID;
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 reportingAgent:(id)arg3;	// IMP=0x00000000002c87b5
