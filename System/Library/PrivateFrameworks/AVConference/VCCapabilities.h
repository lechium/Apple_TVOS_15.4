...
+ (id)screenSharingVCCapabilities;	// IMP=0x0000000000194e3f
+ (id)VideoOnlyVCCapabilities;	// IMP=0x0000000000194dbe
+ (id)AudioOnlyVCCapabilities;	// IMP=0x0000000000194d40
+ (id)DataOnlyVCCapabilities;	// IMP=0x0000000000194cc5
...
- (void)decodeFromNSDictionary:(id)arg1;	// IMP=0x00000000001957d7
- (id)newEncodedDictionary;	// IMP=0x00000000001953e3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000195252
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001950b6
- (id)description;	// IMP=0x0000000000194fe2
- (id)initWithEncodedDictionary:(id)arg1;	// IMP=0x0000000000194f6e
- (id)init;	// IMP=0x0000000000194ee4
