...
- (void)streamOutput:(id)arg1 didSuspend:(_Bool)arg2;	// IMP=0x00000000003241e4
- (void)streamOutput:(id)arg1 didDegrade:(_Bool)arg2;	// IMP=0x00000000003240ab
- (void)streamOutput:(id)arg1 didStall:(_Bool)arg2;	// IMP=0x0000000000323f72
- (void)streamOutput:(id)arg1 didPause:(_Bool)arg2;	// IMP=0x0000000000323e39
- (void)streamOutputDidBecomeInvalid:(id)arg1;	// IMP=0x0000000000323e04
- (void)streamOutputServerDidDie:(id)arg1;	// IMP=0x0000000000323d85
- (void)streamOutput:(id)arg1 didReceiveSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x0000000000323d7f
- (void)dealloc;	// IMP=0x0000000000323cdb
- (id)initWithStreamToken:(long long)arg1 delegate:(id)arg2 queue:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000323b6e
