...
- (id)description;	// IMP=0x0000000000251e96
- (void)dealloc;	// IMP=0x0000000000251e38
- (_Bool)addTokenWithString:(id)arg1 confidence:(double)arg2 range:(struct _NSRange)arg3;	// IMP=0x0000000000251db6
- (id)initWithCapacity:(long long)arg1 utteranceComplete:(_Bool)arg2 utteranceNumber:(unsigned int)arg3 updateNumber:(unsigned int)arg4;	// IMP=0x0000000000251cb4
