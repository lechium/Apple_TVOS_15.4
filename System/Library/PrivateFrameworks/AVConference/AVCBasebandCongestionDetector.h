...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x000000000015f813
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000015f6ca
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x000000000015f6bb
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000015f6a1
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x000000000015f452
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x000000000015f34f
- (void)dealloc;	// IMP=0x000000000015f1ad
- (id)init;	// IMP=0x000000000015f13e
