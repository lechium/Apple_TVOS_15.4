...
+ (id)dictionaryForCommonStreamConfig:(id)arg1;	// IMP=0x00000000003b29bb
+ (long long)clientCipherSuiteWithCipherSuite:(long long)arg1;	// IMP=0x00000000003b24d8
+ (long long)cipherSuiteWithClientCipherSuite:(long long)arg1;	// IMP=0x00000000003b24b9
+ (long long)clientStreamDirectionWithDirection:(long long)arg1;	// IMP=0x00000000003b24a5
+ (long long)streamDirectionWithClientDirection:(long long)arg1;	// IMP=0x00000000003b2491
...
- (_Bool)isAudioCodecValid;	// IMP=0x00000000003b3049
- (id)dictionary;	// IMP=0x00000000003b2910
- (void)setUpWithDictionary:(id)arg1;	// IMP=0x00000000003b24f7
- (id)description;	// IMP=0x00000000003b2466
- (_Bool)isValidTextConfig;	// IMP=0x00000000003b23db
- (_Bool)isValidVideoConfig;	// IMP=0x00000000003b232e
- (_Bool)isValidAudioConfig;	// IMP=0x00000000003b22e7
- (void)dealloc;	// IMP=0x00000000003b2247
- (id)init;	// IMP=0x00000000003b2153
