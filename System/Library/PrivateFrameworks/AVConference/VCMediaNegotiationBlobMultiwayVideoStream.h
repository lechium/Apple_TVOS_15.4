...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x00000000002efa9a
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x00000000002efa7c
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x00000000002ef8ec
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x00000000002ef790
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000008413
- (unsigned long long)hash;	// IMP=0x00000000000082c7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000811c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000007fe4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000007eea
- (void)writeTo:(id)arg1;	// IMP=0x0000000000007d65
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000007d58
- (id)dictionaryRepresentation;	// IMP=0x000000000000727c
- (id)description;	// IMP=0x00000000000071e2
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000002ef52e
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x00000000002ef2bf
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000002ef0bd
