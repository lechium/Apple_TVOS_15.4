...
- (id)description;	// IMP=0x0000000000251c16
- (void)dealloc;	// IMP=0x0000000000251bb8
- (id)initWithText:(id)arg1 confidence:(double)arg2 range:(struct _NSRange)arg3;	// IMP=0x0000000000251ac1
