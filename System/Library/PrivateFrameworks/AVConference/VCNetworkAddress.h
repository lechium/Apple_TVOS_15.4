...
- (int)getSockaddrStorage:(struct sockaddr_storage *)arg1 size:(unsigned long long *)arg2;	// IMP=0x000000000032263b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003225bf
- (id)description;	// IMP=0x000000000032253b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000032246f
- (_Bool)isIPv6;	// IMP=0x0000000000322461
- (void)dealloc;	// IMP=0x00000000003223f4
