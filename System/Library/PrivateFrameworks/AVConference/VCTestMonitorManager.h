...
+ (id)sharedManager;	// IMP=0x0000000000346a06
...
- (void)registerBlocksForService;	// IMP=0x0000000000346d13
- (void)reportMemoryUsage:(id)arg1;	// IMP=0x0000000000346a55
- (void)dealloc;	// IMP=0x0000000000346996
- (id)init;	// IMP=0x00000000003468f4
