...
- (id)className;	// IMP=0x000000000004764e
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x000000000004720c
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000046dd3
- (void)resetLossEventBuffer;	// IMP=0x0000000000046dc2
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x0000000000046d9a
- (int)lossEventCount;	// IMP=0x0000000000046d72
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x0000000000046d1d
- (_Bool)shouldRampUp;	// IMP=0x0000000000046c57
- (_Bool)shouldRampDown;	// IMP=0x0000000000046ba3
- (unsigned short)rampDownTier;	// IMP=0x0000000000046b79
- (unsigned short)rampUpTier;	// IMP=0x0000000000046b5a
- (void)stateEnter;	// IMP=0x0000000000046b3b
- (void)stateExit;	// IMP=0x0000000000046b35
- (void)stateChange:(int)arg1;	// IMP=0x00000000000469dc
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x00000000000468bc
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x00000000000468aa
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x00000000000466ad
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x00000000000465f7
- (id)init;	// IMP=0x00000000000463e7
