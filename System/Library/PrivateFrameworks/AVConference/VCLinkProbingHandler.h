...
- (void)resetAggregatedProbingResults;	// IMP=0x000000000033380b
- (void)probingLockdownEnded;	// IMP=0x00000000003336ea
- (void)updateLinkPreferenceOrder;	// IMP=0x0000000000333358
- (void)queryProbingResults;	// IMP=0x0000000000333075
- (void)setLinkProbingResultConfig;	// IMP=0x0000000000333037
- (void)loadStorebagValues;	// IMP=0x0000000000332ba2
- (id)getProbingResultsForLinkID:(id)arg1;	// IMP=0x0000000000332b4d
- (void)removeProbingResultsForLinks:(id)arg1;	// IMP=0x00000000003329f8
- (_Bool)isValidProbingResult:(id)arg1;	// IMP=0x000000000033298d
- (void)flushProbingResults:(id)arg1;	// IMP=0x00000000003328d1
- (void)dispatchedUpdateProbingResults:(id)arg1;	// IMP=0x0000000000332343
- (void)updateProbingResults:(id)arg1;	// IMP=0x00000000003322b4
- (void)stopActiveProbingOnLinks:(id)arg1 resetStats:(_Bool)arg2;	// IMP=0x0000000000331f29
- (void)startActiveProbingOnLinks:(id)arg1;	// IMP=0x0000000000331c86
@property(readonly) _Bool isLinkProbingActive;
@property id <VCLinkProbingHandlerDelegate> linkProbingHandlerDelegate;
- (void)dealloc;	// IMP=0x0000000000331b7d
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000033196c
