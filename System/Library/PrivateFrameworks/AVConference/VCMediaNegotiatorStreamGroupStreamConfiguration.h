...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bc85d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bc28e
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x00000000000bc14c
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x00000000000bbf28
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x00000000000bbecb
- (void)resetCodecs;	// IMP=0x00000000000bbeb5
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x00000000000bbe7c
- (void)addCodec:(unsigned int)arg1;	// IMP=0x00000000000bbe43
- (void)resetPayloads;	// IMP=0x00000000000bbe2d
- (void)addPayload:(int)arg1;	// IMP=0x00000000000bbdf4
- (void)dealloc;	// IMP=0x00000000000bbd87
- (id)init;	// IMP=0x00000000000bbd08
