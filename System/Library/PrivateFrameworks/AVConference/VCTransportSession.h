...
+ (int)vtpPacketTypeForStreamType:(unsigned int)arg1;	// IMP=0x0000000000233668
+ (unsigned int)trafficClassForStreamType:(unsigned int)arg1;	// IMP=0x0000000000233571
...
- (void)resetActiveConnection;	// IMP=0x000000000023356b
- (void)setOneToOneModeEnabled:(_Bool)arg1 isInitiator:(_Bool)arg2;	// IMP=0x0000000000233565
- (void)reportNetworkConditionsDegraded;	// IMP=0x000000000023355f
- (void)handleMediaReceivedOverPeerToPeerLinkWithConnectionId:(int)arg1;	// IMP=0x0000000000233559
- (void)handleMediaReceivedOverRelayLinkWithConnectionId:(int)arg1;	// IMP=0x0000000000233553
- (_Bool)getConnectionSetupData:(id *)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x000000000023354b
...
- (void)setConnectionSelectionVersionWithLocalFrameworkVersion:(id)arg1 remoteFrameworkVersion:(id)arg2;	// IMP=0x00000000002333e6
@property(nonatomic, setter=setCallActive:) _Bool isCallActive;
- (int)deregisterNotificationForTransportStream:(struct OpaqueVCTransportStream *)arg1;	// IMP=0x000000000023321f
- (int)createVFD:(int *)arg1 forStreamType:(unsigned int)arg2;	// IMP=0x00000000002331be
- (int)createTransportStream:(struct OpaqueVCTransportStream **)arg1 withType:(unsigned int)arg2 options:(id)arg3;	// IMP=0x0000000000232f4b
- (void)handleTransportStreamDeactivated:(struct OpaqueVCTransportStream *)arg1;	// IMP=0x0000000000232ee5
- (void)callEventHandlerWithEvent:(unsigned int)arg1 info:(id)arg2;	// IMP=0x0000000000232d30
- (void)stop;	// IMP=0x0000000000232b79
- (void)start;	// IMP=0x0000000000232b18
- (void)dealloc;	// IMP=0x0000000000232945
- (id)initWithNotificationQueue:(id)arg1 reportingAgent:(struct opaqueRTCReporting *)arg2;	// IMP=0x000000000023282e
