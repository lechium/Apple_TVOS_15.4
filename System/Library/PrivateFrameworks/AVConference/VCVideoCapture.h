...
- (void)distributeVideoFrame:(struct opaqueCMSampleBuffer *)arg1 frameTime:(CDStruct_1b6d18a9)arg2 preview:(_Bool)arg3 orientation:(int)arg4 fromCamera:(_Bool)arg5 camera:(int)arg6 switching:(_Bool)arg7 videoMirrored:(_Bool)arg8;	// IMP=0x00000000002fdbc1
- (unsigned int)removeSink:(id)arg1;	// IMP=0x00000000002fd9d3
- (unsigned int)addSink:(id)arg1;	// IMP=0x00000000002fd7e1
@property(readonly) unsigned int sinkCount;
@property(readonly) NSObject<VCVideoCaptureServer> *captureServer;
- (void)dealloc;	// IMP=0x00000000002fd6f8
- (id)initWithCaptureServer:(id)arg1;	// IMP=0x00000000002fd622
