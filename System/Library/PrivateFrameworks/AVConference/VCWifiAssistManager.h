...
+ (id)sharedInstance;	// IMP=0x00000000000d3258
@property(readonly) unsigned char wifiAssistState; // @synthesize wifiAssistState=_wifiAssistState;
- (void)removeDelegate:(id)arg1;	// IMP=0x00000000000d3266
- (void)addDelegate:(id)arg1;	// IMP=0x00000000000d3260
@property(readonly) _Bool isAvailable;
- (id)init;	// IMP=0x00000000000d3242
