...
+ (id)schedulerStreamWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x000000000025e51f
...
- (id)description;	// IMP=0x000000000025e632
- (long long)compareWeightFactor:(id)arg1;	// IMP=0x000000000025e5db
- (id)initWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x000000000025e567
