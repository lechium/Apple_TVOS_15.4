...
+ (unsigned int)encoderUsageTypeWithOperatingMode:(int)arg1;	// IMP=0x0000000000398d8f
...
- (void)featureListString;	// IMP=0x0000000000398fb7
- (unsigned int)numTilesPerVideoFrameForHDRMode:(unsigned long long)arg1;	// IMP=0x0000000000398ec3
- (void)dealloc;	// IMP=0x0000000000398e56
- (id)initWithMode:(int)arg1;	// IMP=0x0000000000398dab
