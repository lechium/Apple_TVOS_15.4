...
- (unsigned long long)hash;	// IMP=0x00000000001fa232
...
- (id)description;	// IMP=0x00000000001fa1a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001fa0f9
- (id)initWithPayload:(int)arg1 isSecondary:(_Bool)arg2 sbr:(_Bool)arg3 samplesPerBlock:(unsigned int)arg4;	// IMP=0x00000000001fa05a
- (id)init;	// IMP=0x00000000001fa04c
