...
- (void)dealloc;	// IMP=0x000000000004eb0a
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x000000000004ea4f
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x000000000004e9bc
