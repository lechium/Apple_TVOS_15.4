...
- (id)className;	// IMP=0x000000000029b429
- (void)releaseLogDumpFile;	// IMP=0x000000000029b360
- (void)createLogDumpFile:(unsigned int)arg1;	// IMP=0x000000000029b2b9
- (void)updateAverageTargetBitrate:(unsigned int)arg1 interval:(double)arg2;	// IMP=0x000000000029b215
- (void)setOperatingTierIndexWithBitrate:(unsigned int)arg1;	// IMP=0x000000000029b00b
- (unsigned short)maxTierIndex:(unsigned int)arg1;	// IMP=0x000000000029af89
- (unsigned short)minTierIndex:(unsigned int)arg1;	// IMP=0x000000000029af02
...
- (void)updateVideoStall:(_Bool)arg1 withStallDuration:(unsigned int)arg2;	// IMP=0x000000000029ae08
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000029ad22
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned int)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x000000000029aa87
- (void)setRateControlInterval:(double)arg1;	// IMP=0x000000000029a9f5
- (void)setMaxTargetBitrate:(unsigned int)arg1 minTargetBitrate:(unsigned int)arg2;	// IMP=0x000000000029a8fb
- (void)dealloc;	// IMP=0x000000000029a887
- (id)initWithDumpID:(unsigned int)arg1;	// IMP=0x000000000029a6e4
