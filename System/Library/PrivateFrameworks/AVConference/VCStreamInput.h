...
- (void)pushSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x000000000012974a
- (struct opaqueCMFormatDescription *)streamFormat;	// IMP=0x0000000000129739
- (void)didStopStreamInputCaptureSource;	// IMP=0x000000000012966e
- (void)didStartStreamInputCaptureSource;	// IMP=0x00000000001295a3
@property(readonly, nonatomic) _Bool isStarted; // @synthesize isStarted=_isStarted;
- (id)delegate;	// IMP=0x00000000001294bb
- (void)dealloc;	// IMP=0x000000000012941b
- (id)initWithStreamInputID:(id)arg1 format:(struct opaqueCMFormatDescription *)arg2 delegate:(id)arg3 delegateQueue:(id)arg4;	// IMP=0x000000000012924c
