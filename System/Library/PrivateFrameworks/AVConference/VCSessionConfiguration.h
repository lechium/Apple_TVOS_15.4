...
- (void)cleanupNwActivity;	// IMP=0x000000000003ccf7
- (_Bool)applyConfigurationUsingClientDict:(id)arg1;	// IMP=0x000000000003cb26
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x000000000003c980
@property(nonatomic) long long sessionMode; // @synthesize sessionMode=_sessionMode;
- (void)dealloc;	// IMP=0x000000000003c7da
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000003c79b
- (id)init;	// IMP=0x000000000003c73c
