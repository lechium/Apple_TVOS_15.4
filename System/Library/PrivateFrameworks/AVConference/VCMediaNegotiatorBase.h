...
+ (_Bool)initializeLocalConfiguration:(id)arg1 negotiationData:(id)arg2 deviceRole:(int)arg3 preferredAudioPayload:(int)arg4;	// IMP=0x0000000000026963
...
- (unsigned int)remoteMaxBandwidthForOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000000269c4
- (_Bool)processRemoteNegotiationData:(id)arg1;	// IMP=0x0000000000026902
- (id)negotiationData;	// IMP=0x00000000000268a1
- (id)getPreferredVideoPayloadList:(id)arg1;	// IMP=0x0000000000026519
- (void)dealloc;	// IMP=0x0000000000026482
- (id)initWithLocalSettings:(id)arg1;	// IMP=0x000000000002604c
