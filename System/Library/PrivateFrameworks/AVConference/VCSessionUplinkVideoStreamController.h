...
- (_Bool)filterPendingTemporalStreams;	// IMP=0x0000000000077330
- (void)restart;	// IMP=0x00000000000771e8
- (void)unlock;	// IMP=0x00000000000771da
- (void)lock;	// IMP=0x00000000000771cc
- (id)schedulerStreamWithVideoStream:(id)arg1;	// IMP=0x0000000000077137
- (id)newVideoStreamKeyFrameScheduleWithStreamIDs:(id)arg1;	// IMP=0x0000000000076fab
- (id)getMultiwayConfigForStreamID:(id)arg1;	// IMP=0x0000000000076db4
- (void)handleStreamsResetIDR;	// IMP=0x00000000000769e1
- (id)videoStreamPendingKeyFrameGenerationWithStreamID:(id)arg1 shouldRemoveFromPendingArray:(_Bool *)arg2;	// IMP=0x00000000000765d8
- (void)handleStreamsPendingKeyFrameGeneration;	// IMP=0x000000000007631c
- (_Bool)pauseStreams;	// IMP=0x0000000000076071
- (_Bool)shouldGenerateIDRWithStreamSchedule:(id)arg1;	// IMP=0x0000000000075d32
- (_Bool)resumeStreams;	// IMP=0x000000000007594c
- (id)delegate;	// IMP=0x000000000007593e
- (void)initilizeStreamInfoMapWithStreamInfos:(id)arg1;	// IMP=0x00000000000754e3
- (id)anchorStreamIDWithCappedVideoStreamIDs:(id)arg1;	// IMP=0x0000000000075204
- (_Bool)setStreamsUseRTCPWithStreamInfos:(id)arg1;	// IMP=0x0000000000074dff
- (void)generateKeyFrameWithStreamID:(id)arg1;	// IMP=0x0000000000074d95
- (void)setIsLocalOnCellular:(_Bool)arg1 cappedVideoStreamIDs:(id)arg2;	// IMP=0x0000000000074a10
- (void)printPendingKeyFrameWarningOnThresholdTimeElapsedWithCurrentFrameTime:(float)arg1;	// IMP=0x000000000007461f
- (void)selectVideoStreamForVideoPriority;	// IMP=0x0000000000074352
- (void)dealloc;	// IMP=0x00000000000736f7
- (id)initWithVideoStreams:(id)arg1 streamInfos:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000000734c2
