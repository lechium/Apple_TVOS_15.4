...
+ (Class)payloadsType;	// IMP=0x00000000002609ae
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000261e28
- (unsigned long long)hash;	// IMP=0x0000000000261d2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000261b9b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000261911
- (void)copyTo:(id)arg1;	// IMP=0x00000000002617aa
- (void)writeTo:(id)arg1;	// IMP=0x00000000002615bd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002615b0
- (id)dictionaryRepresentation;	// IMP=0x0000000000260c13
- (id)description;	// IMP=0x0000000000260b79
...
- (id)payloadsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000260991
- (unsigned long long)payloadsCount;	// IMP=0x0000000000260974
- (void)addPayloads:(id)arg1;	// IMP=0x0000000000260927
- (void)clearPayloads;	// IMP=0x000000000026090a
@property(nonatomic) _Bool hasRtpSSRC;
- (void)dealloc;	// IMP=0x000000000026085c
- (_Bool)setupVideoRuleCollection:(id)arg1;	// IMP=0x00000000002a2106
- (id)rulesForEncodeType:(unsigned char)arg1 paylaod:(int)arg2 videoRuleCollection:(id)arg3;	// IMP=0x00000000002a2071
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2 screenSize:(struct CGSize)arg3;	// IMP=0x00000000002a1d55
@property(readonly, nonatomic) VCVideoRuleCollections *videoRuleCollections;
- (_Bool)addVideoRules:(id)arg1 encodingType:(unsigned char)arg2 payload:(int)arg3 videoRuleCollections:(id)arg4;	// IMP=0x00000000002a18b1
@property(readonly, nonatomic) struct CGSize orientationMismatchDisplayRatio;
- (void)aspectRatioPortrait:(struct CGSize *)arg1 aspectRatioLandscape:(struct CGSize *)arg2 orientationMismatchAspectRatioLandscape:(struct CGSize *)arg3 orientationMismatchAspectRatioPortrait:(struct CGSize *)arg4 screenSize:(struct CGSize)arg5;	// IMP=0x00000000002a163a
- (id)initWithSSRC:(unsigned int)arg1 videoRuleCollections:(id)arg2 screenSize:(struct CGSize)arg3 aspectRatioPortrait:(struct CGSize)arg4 aspectRatioLandscape:(struct CGSize)arg5 orientationMismatchAspectRatioLandscape:(struct CGSize)arg6;	// IMP=0x00000000002a1430
