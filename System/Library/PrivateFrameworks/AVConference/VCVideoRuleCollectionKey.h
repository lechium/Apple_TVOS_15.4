...
- (id)description;	// IMP=0x0000000000399afa
- (unsigned long long)hash;	// IMP=0x0000000000399ac9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000399a3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003999eb
- (id)initWithPayload:(int)arg1 transportType:(unsigned char)arg2 encodingType:(unsigned char)arg3;	// IMP=0x0000000000399977
