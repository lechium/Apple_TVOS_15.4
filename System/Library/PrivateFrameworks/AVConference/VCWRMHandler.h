...
- (unsigned char)processRemoteWRMSuggestion:(int)arg1 isRemoteDuplicating:(_Bool)arg2;	// IMP=0x00000000001030a4
- (unsigned char)processLocalWRMNotification:(CDStruct_cd8cfafa *)arg1 isAudioOnly:(_Bool)arg2;	// IMP=0x0000000000102f53
- (void)updateWRMNotificationRequestTime:(double)arg1;	// IMP=0x0000000000102f48
- (_Bool)shouldRequestWRMNotificationWithDuplicationReason:(unsigned char)arg1 isDuplicationEnabled:(_Bool)arg2 isLocalUsingCellular:(_Bool)arg3 atTime:(double)arg4;	// IMP=0x0000000000102d56
- (_Bool)shouldForceWRMRecommendationUsingUserDefaults;	// IMP=0x0000000000102c49
- (id)init;	// IMP=0x0000000000102bea
