...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x0000000000334148
...
- (_Bool)supportSDPCompression;	// IMP=0x000000000033413b
- (void)setUserAgent:(id)arg1;	// IMP=0x0000000000334004
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x0000000000333fa3
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x0000000000333dbb
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x0000000000333cfc
- (id)init;	// IMP=0x0000000000333b32
