...
+ (void)updateMaxAllowedBitratePerConnection:(unsigned int *)arg1 connectionType:(int)arg2 negotiatedSettings:(id)arg3;	// IMP=0x0000000000350465
...
- (void)updateNegotiatedSettings:(id)arg1;	// IMP=0x0000000000350490
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 operatingMode:(int)arg2;	// IMP=0x0000000000350439
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4;	// IMP=0x0000000000350398
- (id)maxAllowedBitrateRuleForConnection:(int)arg1;	// IMP=0x00000000003501d6
- (unsigned int)maxAllowedAudioOnlyBitrateForConnection:(int)arg1;	// IMP=0x00000000003500dd
- (unsigned int)maxAllowedScreenShareBitrateForConnection:(int)arg1;	// IMP=0x000000000034ffe4
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 encodeRule:(id)arg3;	// IMP=0x000000000034fd55
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2;	// IMP=0x000000000034fd40
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1;	// IMP=0x000000000034fc11
- (unsigned int)maxAllowedScreenShareCellularBitrate;	// IMP=0x000000000034fbf8
- (unsigned int)maxAllowedCellularBitrate;	// IMP=0x000000000034fbd7
- (void)readCarrierBundleValues;	// IMP=0x000000000034fbd1
- (void)updateMaxAllowedBitrate:(unsigned int *)arg1 key:(struct __CFString *)arg2 type:(id)arg3 isAudio:(_Bool)arg4 carrierBundleBitrates:(struct __CFDictionary *)arg5;	// IMP=0x000000000034fbcb
- (void)readStoreBagValues:(void *)arg1;	// IMP=0x000000000034fa8c
- (int)storeBagBitrateForKey:(id)arg1;	// IMP=0x000000000034f9ef
- (void)readHardwareValues;	// IMP=0x000000000034f9e9
- (void)addRuleForBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x000000000034f97c
- (void)createSupportedBitrateRuleSets;	// IMP=0x000000000034f946
- (void)dealloc;	// IMP=0x000000000034f8e8
- (id)initWithDeviceRole:(int)arg1 callLogFile:(void *)arg2;	// IMP=0x000000000034f751
