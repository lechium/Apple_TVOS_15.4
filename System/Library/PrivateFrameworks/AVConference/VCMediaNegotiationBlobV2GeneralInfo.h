...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001389ab
- (unsigned long long)hash;	// IMP=0x0000000000138919
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000013882b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013875a
- (void)copyTo:(id)arg1;	// IMP=0x00000000001386c7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000138621
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000138614
- (id)dictionaryRepresentation;	// IMP=0x00000000001381a3
- (id)description;	// IMP=0x0000000000138109
...
- (void)dealloc;	// IMP=0x0000000000137f98
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2;	// IMP=0x00000000002c1bba
@property(readonly, nonatomic) struct CGSize screenResolution;
@property(readonly, nonatomic) union tagNTP creationTime;
- (id)initWithCreationTime:(union tagNTP)arg1 screenResolution:(struct CGSize)arg2 abSwitches:(unsigned int)arg3;	// IMP=0x00000000002c19c7
