...
- (_Bool)isPrimaryConnectionImprovedFromHistory:(struct ConnectionStatsHistory *)arg1 withIndex:(int)arg2 remoteStatsHistory:(struct ConnectionStatsHistory *)arg3;	// IMP=0x000000000027b39a
- (_Bool)isHistoryImproved:(char *)arg1 currentIndex:(int)arg2;	// IMP=0x000000000027b31f
- (_Bool)isHistoryValid:(char *)arg1;	// IMP=0x000000000027b2f3
- (void)updateRatiosForHistory:(struct ConnectionStatsHistory *)arg1 withIndex:(int)arg2;	// IMP=0x000000000027b282
- (void)reportConnectionHealthWithStatsHistory:(struct ConnectionStatsHistory *)arg1 index:(int)arg2 isPeerStats:(_Bool)arg3;	// IMP=0x000000000027b16e
- (void)resetHistory:(struct ConnectionStatsHistory *)arg1;	// IMP=0x000000000027b14b
- (void)updateStatsHistory;	// IMP=0x000000000027af9e
- (void)resetConnectionStats:(_Bool)arg1;	// IMP=0x000000000027af44
- (void)processPeerStatsBlob:(unsigned int)arg1;	// IMP=0x000000000027ac91
- (unsigned int)generateStatsBlob;	// IMP=0x000000000027abea
- (void)updateReceiveStats;	// IMP=0x000000000027ab32
@property id <VCConnectionHealthMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dealloc;	// IMP=0x000000000027aa89
- (id)init;	// IMP=0x000000000027a908
