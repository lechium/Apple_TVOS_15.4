...
@interface VCSessionBandwidthAllocationTableEntry : NSObject
{
    ...
    _Bool _isLowestQualityAudio;	// 40 = 0x28
    _Bool _isLowestQualityVideo;	// 41 = 0x29
    unsigned char _type;	// 42 = 0x2a
...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x0000000000160448
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x0000000000160043
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x000000000015fea2
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x000000000015fc60
...
- (long long)compare:(id)arg1;	// IMP=0x000000000015fcec
- (id)description;	// IMP=0x000000000015fb42
- (void)dealloc;	// IMP=0x000000000015fae4
...
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8;	// IMP=0x000000000015f9af
