...
- (void)dealloc;	// IMP=0x00000000002cf60a
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x00000000002cf2ca
- (void)readyToRead;	// IMP=0x00000000002cf292
- (int)stop;	// IMP=0x00000000002cf172
- (int)start;	// IMP=0x00000000002cea2e
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x00000000002ce825
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x00000000002ce61b
