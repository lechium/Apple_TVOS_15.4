...
- (id)description;	// IMP=0x0000000000057c99
- (long long)compareBudget:(id)arg1;	// IMP=0x0000000000057c42
- (void)addStream:(id)arg1;	// IMP=0x0000000000057bdd
- (void)dealloc;	// IMP=0x0000000000057b7f
- (id)init;	// IMP=0x0000000000057b09
