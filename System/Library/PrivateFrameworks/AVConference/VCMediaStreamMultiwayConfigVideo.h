...
- (id)streamIds;	// IMP=0x000000000028b20b
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x000000000028b1ee
- (void)addPayload:(int)arg1;	// IMP=0x000000000028b1ae
- (void)dealloc;	// IMP=0x000000000028b133
- (id)init;	// IMP=0x000000000028b0a6
