...
- (void)appendConfigurationToXPCConfiguration:(id)arg1;	// IMP=0x0000000000230b58
- (void)setupConfig;	// IMP=0x000000000023093a
- (void)setupNotificationQueue:(id)arg1;	// IMP=0x0000000000230901
- (void)deregisterFromNotifications;	// IMP=0x0000000000230798
- (void)registerBlocksForNotifications;	// IMP=0x000000000022d8a8
- (id)newNSErrorWithErrorDictionary:(id)arg1;	// IMP=0x000000000022d803
- (id)initWithParticipantID:(unsigned long long)arg1 data:(id)arg2 delegate:(id)arg3 queue:(id)arg4;	// IMP=0x000000000022d407
@property(readonly, nonatomic) NSDictionary *config;
- (long long)streamTokenForStreamGroupID:(unsigned int)arg1;	// IMP=0x000000000022d3a2
@property(readonly, nonatomic) unsigned long long spatialAudioSourceID;
- (void)setStreamTokens:(id)arg1;	// IMP=0x000000000022d33e
...
- (void)setStateScreenEnabled:(_Bool)arg1;	// IMP=0x000000000022d086
- (void)setStateVideoEnabled:(_Bool)arg1;	// IMP=0x000000000022ce69
- (void)setStateAudioEnabled:(_Bool)arg1;	// IMP=0x000000000022cc4c
- (void)setStateVideoPaused:(_Bool)arg1;	// IMP=0x000000000022ca2f
- (void)setStateAudioPaused:(_Bool)arg1;	// IMP=0x000000000022c812
- (_Bool)isConnectedToSession;	// IMP=0x000000000022c7f9
@property(nonatomic) struct tagAVCPositionalInfo videoPositionalInfo;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000022793f
