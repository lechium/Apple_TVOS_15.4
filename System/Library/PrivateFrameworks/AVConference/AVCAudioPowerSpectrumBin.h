...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002df027
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002def6c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002def04
- (void)assign:(const struct _VCAudioPowerSpectrumEntry *)arg1;	// IMP=0x00000000002df050
