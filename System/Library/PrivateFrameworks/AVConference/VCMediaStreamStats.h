...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x00000000001376be
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x0000000000137645
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x00000000001375e2
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x000000000013752b
- (void)dealloc;	// IMP=0x00000000001374c4
- (id)init;	// IMP=0x00000000001373ed
