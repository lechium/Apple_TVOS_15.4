...
- (void)readStoreBagValues;	// IMP=0x0000000000217daf
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x0000000000217ba1
- (void)readHardwareValues;	// IMP=0x0000000000217b77
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x0000000000217afe
- (void)dealloc;	// IMP=0x0000000000217aa0
- (id)init;	// IMP=0x0000000000217a1c
