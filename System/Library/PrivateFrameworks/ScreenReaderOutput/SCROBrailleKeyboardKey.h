...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000025cdb
- (void).cxx_destruct;	// IMP=0x0000000000025f43
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000025de3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000025ce3
- (id)description;	// IMP=0x0000000000025c31
