...
- (void).cxx_destruct;	// IMP=0x000000000000b4cc
...
- (void)removeWatchers;	// IMP=0x000000000000b279
- (void)installWatchers;	// IMP=0x000000000000afb4
- (void)cancel;	// IMP=0x000000000000ad3a
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000a7ca
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000a0af
- (void)dealloc;	// IMP=0x0000000000009f78
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 report:(CDUnknownBlockType)arg3;	// IMP=0x0000000000009b72
