...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000091dc
...
- (id)debugDescription;	// IMP=0x0000000000009374
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000929b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000091e4
