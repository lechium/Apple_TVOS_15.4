...
- (void).cxx_destruct;	// IMP=0x000000000000a02e
...
- (void)_invalidate;	// IMP=0x0000000000009ed3
- (void)invalidate;	// IMP=0x0000000000009dea
- (id)remoteObjectProxy;	// IMP=0x0000000000009d9a
- (void)addFailureBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000009b14
- (id)initWithFMNSXPCConnection:(id)arg1;	// IMP=0x0000000000009a76
