...
- (void).cxx_destruct;	// IMP=0x000000000000486c
...
- (void)tracerIsDeallocating;	// IMP=0x00000000000047d9
- (void)dealloc;	// IMP=0x000000000000470c
- (id)initWithTargetObject:(id)arg1 finalizer:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004629
