...
- (void)invalidate;	// IMP=0x0000000000017f06
- (void)performObserverBlock;	// IMP=0x0000000000017ead
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000017c65
