...
+ (id)_createContainerSetFromArray:(id)arg1 options:(id)arg2;	// IMP=0x0000000000005e74
+ (id)diffFromArray:(id)arg1 toArray:(id)arg2 options:(id)arg3;	// IMP=0x0000000000004cb2
- (void).cxx_destruct;	// IMP=0x000000000000674f
...
- (void)enumerateMovesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000064c3
- (void)enumerateChangesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000063f8
- (void)enumerateDeletesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006328
- (void)enumerateInsertsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000625d
