...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x000000000000495a
- (void).cxx_destruct;	// IMP=0x0000000000004c7f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004a26
