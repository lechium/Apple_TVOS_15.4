...
- (void).cxx_destruct;	// IMP=0x0000000000003e2b
...
- (id)allObjects;	// IMP=0x0000000000003d62
- (id)nextObject;	// IMP=0x0000000000003cbf
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003c0a
