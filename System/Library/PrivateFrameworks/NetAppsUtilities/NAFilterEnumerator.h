...
- (id)allObjects;	// IMP=0x0000000000003b10
- (id)nextObject;	// IMP=0x0000000000003a3d
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003988
