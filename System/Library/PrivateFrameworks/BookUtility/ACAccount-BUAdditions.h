...
+ (id)bu_currentStorefront;	// IMP=0x000000000000683e
+ (id)bu_localStoreAccount;	// IMP=0x00000000000067e7
+ (id)bu_activeStoreAccount;	// IMP=0x0000000000006790
+ (id)bu_storeAccountWithDSID:(id)arg1;	// IMP=0x0000000000006709
- (id)bu_signOut;	// IMP=0x00000000000069e6
- (void)bu_removeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000696a
