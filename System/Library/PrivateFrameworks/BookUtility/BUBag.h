...
+ (void)audiobookStoreIsAvailable:(CDUnknownBlockType)arg1;	// IMP=0x0000000000002be5
+ (void)setOfflineCacheProvider:(id)arg1;	// IMP=0x000000000000247e
+ (id)offlineCacheProvider;	// IMP=0x000000000000246d
+ (id)defaultBagKeysDictionary;	// IMP=0x0000000000001d7d
+ (id)_defaultValueDictionary;	// IMP=0x0000000000001caf
+ (id)defaultBag;	// IMP=0x00000000000016c1
- (void).cxx_destruct;	// IMP=0x00000000000030dd
- (id)dictionaryForKey:(id)arg1;	// IMP=0x00000000000030c7
- (id)URLForKey:(id)arg1;	// IMP=0x00000000000030b1
- (id)stringForKey:(id)arg1;	// IMP=0x000000000000309b
- (id)integerForKey:(id)arg1;	// IMP=0x0000000000003085
- (id)doubleForKey:(id)arg1;	// IMP=0x000000000000306f
- (id)boolForKey:(id)arg1;	// IMP=0x0000000000003059
- (id)arrayForKey:(id)arg1;	// IMP=0x0000000000003043
- (void)createSnapshotWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000302d
@property(readonly, copy, nonatomic) NSString *profileVersion;
@property(readonly, copy, nonatomic) NSString *profile;
@property(readonly, nonatomic) NSDate *expirationDate;
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
@property(readonly, nonatomic) AMSBagValue *bu_writeUserReviewURL;
- (id)bu_voteURL;	// IMP=0x0000000000002bb3
