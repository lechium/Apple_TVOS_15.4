...
+ (id)sharedInstance;	// IMP=0x000000000001247c
...
- (id)_getDefaultResponseSuggestionsExperimentConfig:(id)arg1;	// IMP=0x000000000001206c
- (id)getResponseSuggestionsExperimentConfig:(id)arg1 shouldDownloadAssets:(_Bool)arg2;	// IMP=0x0000000000011bad
- (void)warmupForLocale:(id)arg1;	// IMP=0x0000000000011b8d
- (id)init;	// IMP=0x00000000000116c3
