...
- (void).cxx_destruct;	// IMP=0x0000000000013b32
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000013844
- (unsigned long long)hash;	// IMP=0x0000000000013697
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000133bd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000131bd
- (void)copyTo:(id)arg1;	// IMP=0x000000000001300d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000012e51
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000012e44
- (id)dictionaryRepresentation;	// IMP=0x0000000000012a35
- (id)description;	// IMP=0x0000000000012986
@property(nonatomic) _Bool hasIsCustomResponse;
- (int)StringAsAgeGroup:(id)arg1;	// IMP=0x0000000000012824
- (id)ageGroupAsString:(int)arg1;	// IMP=0x000000000001277d
