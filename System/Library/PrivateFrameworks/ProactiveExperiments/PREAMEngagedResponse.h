...
- (void).cxx_destruct;	// IMP=0x00000000000075dd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000007221
- (unsigned long long)hash;	// IMP=0x0000000000006fbc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006bea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000694e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000006700
- (void)writeTo:(id)arg1;	// IMP=0x0000000000006495
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000006488
- (id)dictionaryRepresentation;	// IMP=0x0000000000005dd9
- (id)description;	// IMP=0x0000000000005d2a
@property(nonatomic) _Bool hasIsCustomResponse;
@property(nonatomic) _Bool hasHasQuestionMark;
- (int)StringAsAgeGroup:(id)arg1;	// IMP=0x0000000000005b74
- (id)ageGroupAsString:(int)arg1;	// IMP=0x0000000000005ace
...
- (int)StringAsGenerationStatus:(id)arg1;	// IMP=0x0000000000005814
- (id)generationStatusAsString:(int)arg1;	// IMP=0x000000000000577b
...
- (int)StringAsInputMethod:(id)arg1;	// IMP=0x0000000000005624
- (id)inputMethodAsString:(int)arg1;	// IMP=0x000000000000558d
