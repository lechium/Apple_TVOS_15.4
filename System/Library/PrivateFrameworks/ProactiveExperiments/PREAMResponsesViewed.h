...
- (void).cxx_destruct;	// IMP=0x0000000000003425
...
- (unsigned long long)hash;	// IMP=0x000000000000316b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002fac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002e64
- (void)copyTo:(id)arg1;	// IMP=0x0000000000002d61
- (void)writeTo:(id)arg1;	// IMP=0x0000000000002c5d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002c50
- (id)dictionaryRepresentation;	// IMP=0x00000000000029ea
- (id)description;	// IMP=0x000000000000293b
- (int)StringAsAgeGroup:(id)arg1;	// IMP=0x0000000000002824
- (id)ageGroupAsString:(int)arg1;	// IMP=0x000000000000277f
