...
- (void).cxx_destruct;	// IMP=0x000000000000eee3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ee2c
- (_Bool)isEqualToConfig:(id)arg1;	// IMP=0x000000000000ec50
- (void)_fillDefaultValueForFactors;	// IMP=0x000000000000eb04
- (void)_setDefaultValuesForFactors;	// IMP=0x000000000000ea95
- (id)initWithNamespaceName:(id)arg1 withTrialClient:(id)arg2 shouldDownloadAssets:(_Bool)arg3;	// IMP=0x000000000000dbf9
- (id)init;	// IMP=0x000000000000dbf3
