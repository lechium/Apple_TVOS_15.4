...
+ (id)buildRequiredOnly;	// IMP=0x00000000000309ee
+ (id)buildWithRfc822Name:(id)arg1 withDNSName:(id)arg2 withUniformResourceIdentifier:(id)arg3 withNtPrincipalName:(id)arg4;	// IMP=0x0000000000030910
+ (id)allowedPayloadKeys;	// IMP=0x000000000003084c
- (void).cxx_destruct;	// IMP=0x0000000000030f28
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000030dcb
- (id)serializePayloadWithAssetProviders:(id)arg1;	// IMP=0x0000000000030cca
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000030a07
