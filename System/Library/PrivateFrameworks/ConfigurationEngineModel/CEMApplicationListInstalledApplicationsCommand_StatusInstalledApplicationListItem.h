...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001d220
- (id)serializePayload;	// IMP=0x000000000001cede
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001c428
