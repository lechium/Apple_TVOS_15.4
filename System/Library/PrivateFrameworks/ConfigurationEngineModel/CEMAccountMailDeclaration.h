...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000a6cf
- (id)serializePayloadWithAssetProviders:(id)arg1;	// IMP=0x000000000000a017
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000009037
- (id)assetReferences;	// IMP=0x0000000000008546
- (int)activationLevel;	// IMP=0x000000000000853b
- (_Bool)mustBeSupervised;	// IMP=0x0000000000008533
- (_Bool)multipleAllowed;	// IMP=0x000000000000852b
