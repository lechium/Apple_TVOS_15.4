...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f33e
- (id)serializePayloadWithAssetProviders:(id)arg1;	// IMP=0x000000000001f111
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001eaab
