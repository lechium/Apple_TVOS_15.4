...
+ (id)buildRequiredOnlyWithURL:(id)arg1;	// IMP=0x000000000002f737
+ (id)buildWithURL:(id)arg1 withName:(id)arg2 withSubject:(id)arg3 withKeysize:(id)arg4 withKeyType:(id)arg5 withKeyUsage:(id)arg6 withCAFingerprint:(id)arg7 withRetries:(id)arg8 withRetryDelay:(id)arg9 withSubjectAltName:(id)arg10 withKeyIsExtractable:(id)arg11 withChallengeCredential:(id)arg12 withAllowAllAppsAccess:(id)arg13;	// IMP=0x000000000002f46f
+ (id)allowedPayloadKeys;	// IMP=0x000000000002f345
- (void).cxx_destruct;	// IMP=0x0000000000030760
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000303b1
- (id)serializePayloadWithAssetProviders:(id)arg1;	// IMP=0x000000000002ffe2
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002f78d
