...
+ (id)buildRequiredOnlyWithBundleIdentifier:(id)arg1 withExtensionPoint:(id)arg2 withDisplayName:(id)arg3 withPath:(id)arg4 withVersion:(id)arg5 withUserElection:(id)arg6;	// IMP=0x000000000001a6c9
+ (id)buildWithBundleIdentifier:(id)arg1 withExtensionPoint:(id)arg2 withDisplayName:(id)arg3 withContainerDisplayName:(id)arg4 withContainerIdentifier:(id)arg5 withPath:(id)arg6 withVersion:(id)arg7 withUserElection:(id)arg8;	// IMP=0x000000000001a542
+ (id)allowedStatusKeys;	// IMP=0x000000000001a452
- (void).cxx_destruct;	// IMP=0x000000000001b1a5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001af40
- (id)serializePayload;	// IMP=0x000000000001ad99
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001a7fd
