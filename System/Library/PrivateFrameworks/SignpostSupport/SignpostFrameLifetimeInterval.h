...
+ (id)_frameSeedForLifetimeIntervalBegin:(id)arg1;	// IMP=0x0000000000024f04
- (void).cxx_destruct;	// IMP=0x0000000000026d62
...
- (id)pidToContextIDtoContextFrameLifetimeDict;	// IMP=0x000000000002681a
...
- (id)_glitchIntervalWithRoundingUp:(_Bool)arg1;	// IMP=0x00000000000265d9
@property(readonly, nonatomic) id <SignpostSupportTimeInterval> frameOverrunInterval;
- (unsigned long long)_overrunBeginMCT;	// IMP=0x000000000002649d
@property(readonly, nonatomic) unsigned long long missedVBLCount;
@property(readonly, nonatomic) NSNumber *displayIDNum;
- (_Bool)_hasDisplayID;	// IMP=0x0000000000026346
- (unsigned int)_displayID;	// IMP=0x000000000002624d
...
- (_Bool)_isLongMCT:(unsigned long long)arg1 expectedFrameLatency:(unsigned char)arg2;	// IMP=0x0000000000025e23
- (id)initWithInterval:(id)arg1 contextArray:(id)arg2 renderInterval:(id)arg3 frameSeedToSkippedRenderIntervals:(id)arg4;	// IMP=0x0000000000025b17
- (id)initWithInterval:(id)arg1 contextArray:(id)arg2 hidLatencyInterval:(id)arg3 renderInterval:(id)arg4 frameLatencyInterval:(id)arg5 frameSeedToSkippedRenderIntervals:(id)arg6;	// IMP=0x0000000000024f20
