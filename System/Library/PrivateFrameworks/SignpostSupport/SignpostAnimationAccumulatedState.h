...
- (void).cxx_destruct;	// IMP=0x000000000000c515
...
- (void)addCompositorInterval:(id)arg1;	// IMP=0x000000000000c3e6
- (void)_handleFrameLifetime:(id)arg1 isLong:(_Bool)arg2 isConcise:(_Bool)arg3;	// IMP=0x000000000000c301
- (void)_handleFrameLatency:(id)arg1 isLong:(_Bool)arg2 isConcise:(_Bool)arg3;	// IMP=0x000000000000c21c
- (void)_handleRenderServerRender:(id)arg1 isLong:(_Bool)arg2 isConcise:(_Bool)arg3;	// IMP=0x000000000000c137
- (void)_handleHIDLatency:(id)arg1 isLong:(_Bool)arg2 isConcise:(_Bool)arg3;	// IMP=0x000000000000c052
- (void)_handleTransactionLifetimeInterval:(id)arg1 isLong:(_Bool)arg2 isConcise:(_Bool)arg3;	// IMP=0x000000000000bf03
- (void)_handleCommitInterval:(id)arg1 isLong:(_Bool)arg2 isConcise:(_Bool)arg3;	// IMP=0x000000000000bccf
- (id)initWithAnimationBeginEvent:(id)arg1 shouldTrackComposites:(_Bool)arg2;	// IMP=0x000000000000b9fa
