...
+ (id)serializationTypeNumber;	// IMP=0x0000000000013f81
- (void).cxx_destruct;	// IMP=0x000000000002aa0f
...
- (double)durationToFirstEndSeconds:(id)arg1;	// IMP=0x000000000002a80f
- (double)durationToFirstBeginSeconds:(id)arg1;	// IMP=0x000000000002a777
- (unsigned long long)durationToFirstEndMachContinuousTime:(id)arg1;	// IMP=0x000000000002a6d6
- (unsigned long long)durationToFirstBeginMachContinuousTime:(id)arg1;	// IMP=0x000000000002a635
@property(readonly, nonatomic) unsigned long long frameCount;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002a30c
- (id)initWithBeginEvent:(id)arg1 endEvent:(id)arg2 accumulatedState:(id)arg3;	// IMP=0x0000000000028c84
@property(readonly, nonatomic) float frameRate;
- (id)debugDescription;	// IMP=0x0000000000028954
- (id)_frameDescription;	// IMP=0x000000000002883c
- (id)_animationStatsDescription;	// IMP=0x0000000000028347
- (id)_statsStringForTimeIntervals:(id)arg1 label:(id)arg2;	// IMP=0x00000000000280ce
...
- (double)_timeRatioForTimeIntervalArray:(id)arg1 applyPerceptionAdjustments:(_Bool)arg2;	// IMP=0x00000000000278c3
- (double)_perceptionAdjustmentMultiplierForTimeInterval:(id)arg1;	// IMP=0x00000000000277d8
- (id)_poorPerfFrameDescription;	// IMP=0x000000000002724c
- (id)_detailedFrameDescription;	// IMP=0x0000000000026fff
- (id)_descriptionStringForColumn:(unsigned long long)arg1 timeFormat:(unsigned long long)arg2 asBegin:(_Bool)arg3;	// IMP=0x0000000000026e06
- (id)_intervalTypeString;	// IMP=0x0000000000026df9
- (id)_dictionaryRepresentationWithIsHumanReadable:(_Bool)arg1 shouldRedact:(_Bool)arg2;	// IMP=0x0000000000013fa4
- (id)humanReadableType;	// IMP=0x0000000000013f97
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000013f89
