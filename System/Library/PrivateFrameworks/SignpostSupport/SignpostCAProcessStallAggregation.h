...
- (id)debugDescription;	// IMP=0x00000000000180cb
- (id)description;	// IMP=0x0000000000017c06
- (void)_addOtherProcessStallAggregation:(id)arg1;	// IMP=0x0000000000017a53
- (void)_addDuration:(unsigned long long)arg1 ofType:(unsigned char)arg2;	// IMP=0x0000000000017a00
- (id)_statsForType:(unsigned char)arg1 initIfMissing:(_Bool)arg2;	// IMP=0x0000000000017616
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017302
- (id)_initWithProcessExecutablePath:(id)arg1 pid:(int)arg2;	// IMP=0x00000000000171fa
- (id)_initAsSystemAggregation;	// IMP=0x00000000000171c2
- (unsigned long long)_totalStallDurationNs;	// IMP=0x00000000000170cd
- (void)_iterateTypeStatsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001704d
