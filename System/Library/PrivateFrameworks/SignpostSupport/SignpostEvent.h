...
+ (id)serializationTypeNumber;	// IMP=0x000000000001224c
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000012fdd
- (id)_dictionaryRepresentationWithIsHumanReadable:(_Bool)arg1 shouldRedact:(_Bool)arg2;	// IMP=0x00000000000122d3
- (id)humanReadableType;	// IMP=0x000000000001229c
