...
- (void).cxx_destruct;	// IMP=0x0000000000007d13
...
- (void)addProcessNameSet:(id)arg1;	// IMP=0x0000000000007a2c
- (void)addProcessName:(id)arg1;	// IMP=0x00000000000079ba
- (_Bool)passesProcessName:(id)arg1;	// IMP=0x00000000000079b2
