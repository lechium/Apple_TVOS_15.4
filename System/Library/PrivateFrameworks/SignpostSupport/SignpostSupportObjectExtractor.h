...
- (void).cxx_destruct;	// IMP=0x000000000000577e
...
- (id)_loggingSupportStreamPredicateFromFiltersWithForLiveStreaming:(_Bool)arg1;	// IMP=0x0000000000004e85
- (void)dealloc;	// IMP=0x0000000000004e45
- (void)_processingCompleted:(id)arg1;	// IMP=0x000000000000495a
- (void)stopProcessing;	// IMP=0x00000000000048d5
- (id)init;	// IMP=0x000000000000483e
@property(nonatomic) _Bool buildAnimationCompositeIntervalTimelines;
- (_Bool)_processSignpostEvent:(id)arg1 shouldReport:(_Bool)arg2;	// IMP=0x0000000000004324
- (_Bool)_processSignpostSupportLogMessage:(id)arg1;	// IMP=0x0000000000004223
- (_Bool)_generateIntervalFromEnd:(id)arg1 shouldReport:(_Bool)arg2;	// IMP=0x0000000000003f47
- (_Bool)_shouldBuildEventWithPid:(int)arg1 uniquePid:(unsigned long long)arg2 processName:(id)arg3 subsystem:(id)arg4 category:(id)arg5 shouldReport:(_Bool *)arg6;	// IMP=0x0000000000003da3
- (_Bool)_shouldProcessEvent:(id)arg1 shouldReport:(_Bool *)arg2;	// IMP=0x0000000000003c92
- (_Bool)_eventPassesFilters:(id)arg1;	// IMP=0x0000000000003baa
- (_Bool)_eventPassesWithPid:(int)arg1 uniquePid:(unsigned long long)arg2 processName:(id)arg3 subsystem:(id)arg4 category:(id)arg5;	// IMP=0x000000000000391a
- (_Bool)_hasNonObjectFilters;	// IMP=0x0000000000003853
- (_Bool)_isTrackingIntervals;	// IMP=0x000000000000378c
- (_Bool)_hasSignpostProcessingBlock;	// IMP=0x0000000000003624
- (_Bool)_hasProcessingBlock;	// IMP=0x0000000000003543
- (_Bool)processSerializedObjectsFromSignpostFile:(id)arg1 errorOut:(id *)arg2;	// IMP=0x0000000000002ef0
- (void)finishProcessingSerializedData;	// IMP=0x0000000000002e83
- (_Bool)processSerializedObjectsFromData:(id)arg1 errorOut:(id *)arg2;	// IMP=0x00000000000028aa
