...
- (void).cxx_destruct;	// IMP=0x000000000000864f
...
- (void)_addSkippedRender:(id)arg1;	// IMP=0x0000000000008401
- (id)initWithFrameSeed:(unsigned int)arg1;	// IMP=0x0000000000008390
