...
- (id)debugDescription;	// IMP=0x000000000001701c
- (id)description;	// IMP=0x0000000000016f61
- (void)_addDurationNsToAggregation:(unsigned long long)arg1;	// IMP=0x0000000000016f01
@property(readonly, nonatomic) float averageIntervalDurationNs;
- (void)_addAggregationStats:(id)arg1;	// IMP=0x0000000000016dc3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016d70
