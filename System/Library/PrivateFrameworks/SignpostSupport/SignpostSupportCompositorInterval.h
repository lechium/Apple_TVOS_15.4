...
+ (id)serializationTypeNumber;	// IMP=0x0000000000013bd7
...
- (id)humanReadableDictionaryRepresentation;	// IMP=0x0000000000013c02
- (id)humanReadableType;	// IMP=0x0000000000013bf5
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000013be7
- (id)serializeableDictionaryWithShouldRedact:(_Bool)arg1;	// IMP=0x0000000000013bdf
