...
+ (id)instructionForUncertainArrivalToStationStep:(id)arg1 context:(long long)arg2;	// IMP=0x0000000000003f71
- (void).cxx_destruct;	// IMP=0x000000000000514e
...
- (id)formattedInstructionForType:(long long)arg1;	// IMP=0x0000000000004e49
- (void)refreshInstructionStrings;	// IMP=0x0000000000004e43
- (id)instructionSetsForInstructionType:(long long)arg1;	// IMP=0x0000000000004cc5
- (id)overridenInstructionsMapping;	// IMP=0x0000000000004c00
- (id)instructionSet;	// IMP=0x0000000000004b3b
- (void)_fillInInstructions;	// IMP=0x00000000000040d9
- (id)initWithContext:(long long)arg1;	// IMP=0x0000000000003f18
