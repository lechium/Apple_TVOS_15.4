...
- (void).cxx_destruct;	// IMP=0x00000000000b4bfd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000b48f1
- (unsigned long long)hash;	// IMP=0x00000000000b47c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b4595
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b43eb
- (void)copyTo:(id)arg1;	// IMP=0x00000000000b42a8
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b4179
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b416c
- (id)dictionaryRepresentation;	// IMP=0x00000000000b3b26
- (id)description;	// IMP=0x00000000000b3a77
