...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c08d8
- (void).cxx_destruct;	// IMP=0x00000000000c5b83
...
- (id)description;	// IMP=0x00000000000c54ee
@property(readonly, nonatomic) NSMapTable *routeIDLookup;
- (void)_updateRouteIDLookup;	// IMP=0x00000000000c51a8
- (id)removeTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000c4fb9
- (id)updateWithTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000c4e9e
- (void)markAnnouncementSpoken:(id)arg1;	// IMP=0x00000000000c4e23
- (id)routeLookupIDs;	// IMP=0x00000000000c4cdd
- (id)routeInfoForRoute:(id)arg1;	// IMP=0x00000000000c4c7a
- (id)routeInfoForID:(id)arg1;	// IMP=0x00000000000c4af5
- (void)updateETATrafficForRoute:(id)arg1;	// IMP=0x00000000000c488d
- (void)setAlternateRoutes:(id)arg1;	// IMP=0x00000000000c3430
- (void)setCurrentRoute:(id)arg1 withAlternateRoutes:(id)arg2;	// IMP=0x00000000000c266a
- (void)setPreviewRoutes:(id)arg1 withSelectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00000000000c1fb6
...
- (void)copySerializableValuesFrom:(id)arg1;	// IMP=0x00000000000c1289
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c0e1f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c08e0
- (id)init;	// IMP=0x00000000000c081c
