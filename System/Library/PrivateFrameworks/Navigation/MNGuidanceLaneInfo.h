...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d976b
- (void).cxx_destruct;	// IMP=0x00000000000d9d4f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d9a77
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d9773
- (id)description;	// IMP=0x00000000000d9514
- (id)initWithID:(id)arg1 isForManeuver:(_Bool)arg2 lanes:(id)arg3 titles:(id)arg4 instructions:(id)arg5 variableOverrides:(id)arg6 distanceDetailLevel:(long long)arg7 composedGuidanceEventIndex:(int)arg8;	// IMP=0x00000000000d93fc
