...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000e7020
- (void).cxx_destruct;	// IMP=0x00000000000e76ff
...
- (id)description;	// IMP=0x00000000000e75f1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e7397
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e7028
...
- (id)initWithRoute:(id)arg1 trafficRoute:(id)arg2 routeInitalizerData:(id)arg3;	// IMP=0x00000000000e6e6d
- (id)initWithRoute:(id)arg1;	// IMP=0x00000000000e6de1
