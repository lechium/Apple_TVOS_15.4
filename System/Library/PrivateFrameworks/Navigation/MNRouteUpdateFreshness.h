...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000055214
...
- (id)jsonDictionary;	// IMP=0x00000000000553ce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055352
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000552c6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005521c
- (id)init;	// IMP=0x00000000000551c7
