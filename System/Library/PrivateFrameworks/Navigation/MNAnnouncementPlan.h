...
+ (double)desiredTimeGapBetweenEvent:(id)arg1 andEvent:(id)arg2;	// IMP=0x0000000000006b7d
...
- (void)sortEvents;	// IMP=0x0000000000006ab5
- (id)nextConflict;	// IMP=0x0000000000006710
- (id)description;	// IMP=0x00000000000064fa
- (id)initWithEvents:(id)arg1 distance:(double)arg2 speed:(double)arg3 durations:(id)arg4;	// IMP=0x00000000000061c3
