...
+ (Class)junctionViewImageIDType;	// IMP=0x00000000000128bf
- (void).cxx_destruct;	// IMP=0x0000000000015748
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000151fc
- (unsigned long long)hash;	// IMP=0x000000000001498b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001452a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000140f0
- (void)copyTo:(id)arg1;	// IMP=0x0000000000013dd7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000013a1d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000013a10
- (id)dictionaryRepresentation;	// IMP=0x00000000000129f9
- (id)description;	// IMP=0x000000000001294a
...
- (id)junctionViewImageIDAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000128a2
- (unsigned long long)junctionViewImageIDsCount;	// IMP=0x0000000000012885
- (void)addJunctionViewImageID:(id)arg1;	// IMP=0x000000000001281b
- (void)clearJunctionViewImageIDs;	// IMP=0x00000000000127fe
...
- (int)StringAsType:(id)arg1;	// IMP=0x0000000000012430
- (id)typeAsString:(int)arg1;	// IMP=0x00000000000123a6
...
- (id)initWithEvent:(id)arg1;	// IMP=0x00000000000157ac
