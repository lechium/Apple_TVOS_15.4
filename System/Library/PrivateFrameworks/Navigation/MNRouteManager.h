...
- (void)locationManager:(id)arg1 didUpdateVehicleHeading:(double)arg2 timestamp:(id)arg3;	// IMP=0x00000000000ce30f
- (void)locationManager:(id)arg1 didUpdateVehicleSpeed:(double)arg2 timestamp:(id)arg3;	// IMP=0x00000000000ce309
- (void)locationManagerDidResumeLocationUpdates:(id)arg1;	// IMP=0x00000000000ce303
- (void)locationManagerDidPauseLocationUpdates:(id)arg1;	// IMP=0x00000000000ce2fd
- (_Bool)locationManagerShouldPauseLocationUpdates:(id)arg1;	// IMP=0x00000000000ce2f5
- (void)locationManagerDidReset:(id)arg1;	// IMP=0x00000000000ce2ef
- (void)locationManagerFailedToUpdateLocation:(id)arg1 withError:(id)arg2;	// IMP=0x00000000000ce2e9
- (void)locationManagerUpdatedLocation:(id)arg1;	// IMP=0x00000000000ce273
- (void)_updatePreloaderForRoute:(id)arg1;	// IMP=0x00000000000ce09f
- (void)_clearPreloader;	// IMP=0x00000000000ce05c
- (void)clearCurrentRoute;	// IMP=0x00000000000ce042
- (void)updateWithAlternateRoutes:(id)arg1;	// IMP=0x00000000000ce001
- (void)updateForLocation:(id)arg1;	// IMP=0x00000000000cdfb1
- (void)updateForReroute:(id)arg1 rerouteReason:(unsigned long long)arg2 request:(id)arg3 response:(id)arg4;	// IMP=0x00000000000cdd6c
- (void)updateWithStartNavigationDetails:(id)arg1;	// IMP=0x00000000000cd4b0
- (void)updateWithPreviewRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00000000000cd40f
- (void)updateWithInitialDirectionsRequest:(id)arg1 directionsResponse:(id)arg2 waypoints:(id)arg3;	// IMP=0x00000000000cd189
- (void)close;	// IMP=0x00000000000cd09f
- (void)open;	// IMP=0x00000000000ccfb7
- (void)dealloc;	// IMP=0x00000000000ccf79
@property(readonly, nonatomic) NSArray *allRoutes;
@property(readonly, nonatomic) GEOComposedRoute *currentRoute;
- (id)initWithAuditToken:(id)arg1;	// IMP=0x00000000000cce3d
- (id)init;	// IMP=0x00000000000cce29
