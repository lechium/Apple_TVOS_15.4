...
+ (id)contentsWithStep:(id)arg1 destination:(id)arg2 options:(CDStruct_61a83fd4 *)arg3 isSecondary:(_Bool)arg4;	// IMP=0x00000000000c73a0
- (void).cxx_destruct;	// IMP=0x00000000000c8106
...
- (id)instructionForStage:(unsigned long long)arg1 distance:(double)arg2;	// IMP=0x00000000000c7d5f
- (id)_instructionsForFormats:(id)arg1 distance:(double)arg2;	// IMP=0x00000000000c797b
- (id)instructionWithShorterAlternatives:(id *)arg1;	// IMP=0x00000000000c78b6
@property(nonatomic) long long context;
@property(readonly, nonatomic) int numSignsWanted;
- (id)description;	// IMP=0x00000000000c7753
- (void)_populateFromStep:(id)arg1;	// IMP=0x00000000000c753e
- (id)init;	// IMP=0x00000000000c74bb
