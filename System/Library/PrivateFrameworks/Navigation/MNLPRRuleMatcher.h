...
- (void).cxx_destruct;	// IMP=0x0000000000053d74
- (id)debug_jsonDescriptionOfLastPlate;	// IMP=0x00000000000532c9
- (id)generateMaskedPlateForWaypoints:(id)arg1 date:(id)arg2 timeZone:(id)arg3 error:(id *)arg4;	// IMP=0x000000000004cdef
- (id)initForVehicle:(id)arg1 withRules:(id)arg2;	// IMP=0x000000000004cd25
