...
+ (_Bool)_navigation_isLocation:(id)arg1 equalTo:(id)arg2;	// IMP=0x0000000000097343
+ (id)_navigation_stringWithType:(int)arg1;	// IMP=0x0000000000096c50
- (CDStruct_071ac149)_navigation_geoCoordinate3D;	// IMP=0x00000000000975fc
- (id)_navigation_geoLocation;	// IMP=0x0000000000097590
...
- (double)_navigation_speedAccuracy;	// IMP=0x0000000000097424
- (_Bool)_navigation_isEqualToLocationCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x00000000000973cd
...
- (id)initWithGeoLocation:(id)arg1;	// IMP=0x0000000000096e7d
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13 serializedCoarseMetaData:(id)arg14;	// IMP=0x0000000000096d20
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13;	// IMP=0x0000000000096d08
@end
