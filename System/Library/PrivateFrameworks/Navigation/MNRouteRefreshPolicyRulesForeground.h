...
- (double)maxTimeIntervalFromNowForDestinationRefresh:(id)arg1 fromDate:(id)arg2;	// IMP=0x0000000000070569
- (double)timeIntervalForDestinationRefresh:(id)arg1 lastUpdate:(id)arg2;	// IMP=0x000000000007051a
@property(readonly, nonatomic) _Bool canWakeDeviceForUpdates;
@property(readonly, nonatomic) _Bool canWakeClientForUpdates;
- (_Bool)canMakeNetworkRequestsForDestination:(id)arg1 atDate:(id)arg2;	// IMP=0x00000000000704f2
- (id)init;	// IMP=0x00000000000704b6
