...
+ (id)requestWithAccuracy:(double)arg1 maxAttempts:(unsigned long long)arg2 timeoutInterval:(double)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000006e8b2
- (void).cxx_destruct;	// IMP=0x000000000006e9eb
...
- (id)init;	// IMP=0x000000000006e832
