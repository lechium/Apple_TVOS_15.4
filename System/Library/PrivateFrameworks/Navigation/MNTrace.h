...
- (void).cxx_destruct;	// IMP=0x0000000000061fd8
...
- (id)prepareStatement:(id)arg1 outError:(out id *)arg2;	// IMP=0x0000000000061d5c
- (id)_handleOpenErrorWithPath:(id)arg1;	// IMP=0x0000000000061b67
@property(readonly, nonatomic) int mainTransportType; // @synthesize mainTransportType=_mainTransportType;
- (_Bool)closeTrace;	// IMP=0x0000000000061334
- (_Bool)startWritingTraceToPath:(id)arg1;	// IMP=0x000000000006113f
- (_Bool)openTrace:(id)arg1 outError:(id *)arg2;	// IMP=0x0000000000060fbc
- (void)dealloc;	// IMP=0x0000000000060f7e
- (id)init;	// IMP=0x0000000000060f04
- (id)serializableBookmarks;	// IMP=0x00000000000c7106
