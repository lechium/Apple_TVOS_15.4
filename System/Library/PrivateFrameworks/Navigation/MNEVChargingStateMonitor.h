...
- (void)_notifyShouldShowChargingInfo;	// IMP=0x0000000000005a6d
- (void)_startTimer;	// IMP=0x0000000000005858
- (void)updateForArrival;	// IMP=0x0000000000005846
- (void)updateForLocation:(id)arg1;	// IMP=0x0000000000005701
- (void)dealloc;	// IMP=0x00000000000056bf
- (id)initWithTargetBatteryCharge:(id)arg1;	// IMP=0x0000000000005650
