...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000020bad
- (void).cxx_destruct;	// IMP=0x0000000000021e5e
...
- (id)description;	// IMP=0x000000000002136b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000210cc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000020bb5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020aac
- (id)init;	// IMP=0x0000000000020a54
