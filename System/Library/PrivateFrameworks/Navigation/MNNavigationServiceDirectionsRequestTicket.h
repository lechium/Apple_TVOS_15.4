...
- (void).cxx_destruct;	// IMP=0x0000000000048fce
...
- (void)cancel;	// IMP=0x0000000000048ef5
- (void)submitWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000048a65
- (id)initWithProxy:(id)arg1 request:(id)arg2;	// IMP=0x0000000000048993
