...
- (void).cxx_destruct;	// IMP=0x00000000000e6dae
...
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000e6d7a
- (void)addObserver:(id)arg1;	// IMP=0x00000000000e6d74
- (id)initWithHFPEnabled:(_Bool)arg1;	// IMP=0x00000000000e6d26
