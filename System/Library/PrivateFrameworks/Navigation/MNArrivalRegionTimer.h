...
- (void).cxx_destruct;	// IMP=0x0000000000020a22
@property(nonatomic) __weak id <MNArrivalRegionTimerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateForLocation:(id)arg1;	// IMP=0x0000000000020684
- (void)dealloc;	// IMP=0x0000000000020642
- (id)initWithArrivalRegion:(id)arg1;	// IMP=0x000000000002058b
- (id)init;	// IMP=0x0000000000020561
