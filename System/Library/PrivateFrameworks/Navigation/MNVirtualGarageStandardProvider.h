...
- (void).cxx_destruct;	// IMP=0x00000000000f4f71
...
- (void)virtualGarageDidUpdate:(id)arg1;	// IMP=0x00000000000f4ead
- (void)dealloc;	// IMP=0x00000000000f4e6f
- (void)stopVirtualGarageUpdates;	// IMP=0x00000000000f4e69
- (void)startVirtualGarageUpdates;	// IMP=0x00000000000f4e63
