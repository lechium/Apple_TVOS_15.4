...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a1ed0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a2256
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a1ed8
- (id)description;	// IMP=0x00000000000a17f5
- (id)debugDescription;	// IMP=0x00000000000a1630
- (id)initWithID:(id)arg1 titles:(id)arg2 details:(id)arg3 variableOverrides:(id)arg4 distanceDetailLevel:(int)arg5 junction:(id)arg6 artworkOverride:(id)arg7 shieldText:(id)arg8 shieldID:(int)arg9 shieldStringID:(id)arg10 composedGuidanceEventIndex:(int)arg11;	// IMP=0x00000000000a14b4
