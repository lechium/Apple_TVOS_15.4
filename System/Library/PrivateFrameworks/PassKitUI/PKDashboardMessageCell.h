...
- (void).cxx_destruct;	// IMP=0x0000000000101475
...
- (struct CGSize)_layoutWithBounds:(struct CGRect)arg1;	// IMP=0x000000000010092b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001008cd
- (void)layoutSubviews;	// IMP=0x000000000010082e
- (void)dismissButtonPressed:(id)arg1;	// IMP=0x00000000001007e6
- (void)prepareForReuse;	// IMP=0x000000000010057e
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000010008c
