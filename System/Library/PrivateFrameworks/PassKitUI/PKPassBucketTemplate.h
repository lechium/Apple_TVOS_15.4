...
- (void).cxx_destruct;	// IMP=0x0000000000051663
...
- (id)templateForFieldAtIndex:(unsigned long long)arg1;	// IMP=0x000000000005151a
- (void)addFieldTemplate:(id)arg1;	// IMP=0x00000000000514c0
