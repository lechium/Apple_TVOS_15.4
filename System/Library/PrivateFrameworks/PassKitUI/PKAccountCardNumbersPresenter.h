...
+ (void)authAndDecryptWithVirtualCard:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000019cef8
- (void).cxx_destruct;	// IMP=0x000000000019cf19
@property(readonly, nonatomic) _Bool isLoadingVirtualCard; // @synthesize isLoadingVirtualCard=_isLoadingVirtualCard;
- (void)_prepareAuthForVirtualCard:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000019cac1
- (void)presentCardNumbersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019c0be
- (id)initWithVirtualCard:(id)arg1 physicalCard:(id)arg2 account:(id)arg3 pass:(id)arg4 context:(long long)arg5;	// IMP=0x000000000019bf9c
