...
- (void).cxx_destruct;	// IMP=0x00000000000d461c
...
- (unsigned long long)peerPaymentSetupConfigurationType;	// IMP=0x00000000000d45a6
- (id)initWithFamilyMember:(id)arg1 associatedAccountSetupDelegate:(id)arg2 setupType:(long long)arg3;	// IMP=0x00000000000d44b4
