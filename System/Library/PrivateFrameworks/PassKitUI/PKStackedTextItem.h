...
- (void).cxx_destruct;	// IMP=0x000000000043e406
...
- (unsigned long long)hash;	// IMP=0x000000000043e275
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000043e172
- (id)initWithNumberOfContentRows:(unsigned long long)arg1 groupingIdentifier:(id)arg2;	// IMP=0x000000000043e0f4
- (id)init;	// IMP=0x000000000043e0de
