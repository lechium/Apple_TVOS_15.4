...
+ (struct CGSize)defaultSize;	// IMP=0x0000000000165b45
- (void).cxx_destruct;	// IMP=0x0000000000166990
...
- (void)_selectedSuggestion:(id)arg1;	// IMP=0x00000000001667ff
- (id)_configuredBorderedButtonForSuggestion:(id)arg1 withBorder:(unsigned long long)arg2 primaryAction:(id)arg3;	// IMP=0x000000000016655f
- (id)initWithDefaultFrame;	// IMP=0x0000000000165add
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001659da
