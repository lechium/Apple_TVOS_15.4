...
- (void).cxx_destruct;	// IMP=0x00000000003cfe3d
...
- (void)deleteBackward;	// IMP=0x00000000003cfd3b
- (void)insertText:(id)arg1;	// IMP=0x00000000003cfa20
@property(readonly, nonatomic) _Bool hasText;
- (_Bool)canBecomeFirstResponder;	// IMP=0x00000000003cf9f4
- (void)layoutSubviews;	// IMP=0x00000000003cf586
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003cf4e1
- (void)updateCharacterVisibility;	// IMP=0x00000000003cf349
@property(copy, nonatomic) NSString *pinCode;
- (id)initWithPinCodeLength:(unsigned long long)arg1 style:(unsigned long long)arg2 delegate:(id)arg3;	// IMP=0x00000000003cebfd
- (id)initWithPinCodeLength:(unsigned long long)arg1 delegate:(id)arg2;	// IMP=0x00000000003cebe6
