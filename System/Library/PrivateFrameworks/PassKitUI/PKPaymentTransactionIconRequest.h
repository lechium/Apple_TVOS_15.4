...
- (void).cxx_destruct;	// IMP=0x0000000000384e0e
...
- (unsigned long long)hash;	// IMP=0x0000000000384d36
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000384c54
- (id)logoURL;	// IMP=0x0000000000384bd0
