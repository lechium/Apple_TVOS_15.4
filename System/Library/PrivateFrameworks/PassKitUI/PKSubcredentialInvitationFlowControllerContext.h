...
- (void).cxx_destruct;	// IMP=0x000000000031ef87
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000031ee55
- (id)initWithInvitation:(id)arg1 localDeviceWebService:(id)arg2 remoteDeviceWebService:(id)arg3;	// IMP=0x000000000031ed93
