...
- (void).cxx_destruct;	// IMP=0x00000000003b6d9d
@property(copy, nonatomic) NSString *amountText; // @synthesize amountText=_amountText;
@property(copy, nonatomic) NSString *descriptionText; // @synthesize descriptionText=_descriptionText;
- (void)_addSubviews;	// IMP=0x00000000003b6c2f
- (void)layoutSubviews;	// IMP=0x00000000003b6846
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000003b67f5
