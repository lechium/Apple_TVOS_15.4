...
+ (_Bool)deviceSupportsContactlessActivation;	// IMP=0x000000000021fc94
- (void).cxx_destruct;	// IMP=0x0000000000220ba6
...
- (void)_updatePhysicalCards;	// IMP=0x0000000000220762
- (void)nextViewControllerWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000220691
- (void)orderFlowViewControllerForReason:(unsigned long long)arg1 content:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000220267
@property(readonly, nonatomic) _Bool physicalCardBlocked;
@property(readonly, nonatomic) _Bool primaryPhysicalCardEnabled;
- (_Bool)_userSupportsActivatingPhysicalCard;	// IMP=0x00000000002201a3
- (_Bool)_userSupportsRequestingPhysicalCard;	// IMP=0x0000000000220160
...
- (void)updateWithPhysicalCards:(id)arg1;	// IMP=0x000000000021fe76
- (void)updateWithAccount:(id)arg1;	// IMP=0x000000000021fe34
- (void)dealloc;	// IMP=0x000000000021fdbf
- (id)initWithAccountService:(id)arg1 paymentPass:(id)arg2 account:(id)arg3 accountUser:(id)arg4 physicalCards:(id)arg5;	// IMP=0x000000000021fc9e
