...
+ (struct CGSize)recommendedCardImageSize;	// IMP=0x000000000007690e
- (void).cxx_destruct;	// IMP=0x0000000000077101
...
- (void)updateCardSizeValues;	// IMP=0x0000000000076fd6
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000076f3c
- (void)layoutSubviews;	// IMP=0x0000000000076bc1
@property(retain, nonatomic) UIImage *cardImage;
- (id)initWithImage:(id)arg1;	// IMP=0x0000000000076924
