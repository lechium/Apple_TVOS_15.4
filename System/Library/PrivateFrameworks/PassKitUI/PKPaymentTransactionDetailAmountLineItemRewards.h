...
- (void).cxx_destruct;	// IMP=0x0000000000424ee7
...
- (id)initWithRewardsValueUnit:(unsigned long long)arg1 eligibleValue:(id)arg2 isEligible:(_Bool)arg3 totalAmount:(id)arg4;	// IMP=0x0000000000424c6a
