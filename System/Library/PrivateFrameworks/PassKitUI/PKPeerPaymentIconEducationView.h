...
- (id)_imageForWatchView;	// IMP=0x0000000000307510
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000307475
- (void)layoutSubviews;	// IMP=0x00000000003072aa
