...
+ (id)cellReuseIdentifier;	// IMP=0x0000000000207783
- (void).cxx_destruct;	// IMP=0x00000000002079ef
...
- (void)handleCellSelection;	// IMP=0x0000000000207970
- (_Bool)shouldHighlight;	// IMP=0x0000000000207968
- (id)tableViewCellForTableView:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0000000000207795
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000020763b
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 value:(id)arg3 tapHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000002074a5
