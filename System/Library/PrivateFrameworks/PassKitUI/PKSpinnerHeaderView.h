...
- (void).cxx_destruct;	// IMP=0x0000000000285442
@property(nonatomic) _Bool showSpinner; // @synthesize showSpinner=_showSpinner;
- (void)layoutSubviews;	// IMP=0x0000000000284fd8
- (void)prepareForReuse;	// IMP=0x0000000000284f95
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x0000000000284f23
