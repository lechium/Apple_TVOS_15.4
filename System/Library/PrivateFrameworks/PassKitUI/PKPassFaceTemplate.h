...
- (void).cxx_destruct;	// IMP=0x000000000005145d
...
- (id)templateForBucketAtIndex:(unsigned long long)arg1;	// IMP=0x000000000005132e
- (void)addBucketTemplate:(id)arg1;	// IMP=0x00000000000512d4
