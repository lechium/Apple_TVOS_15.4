...
+ (id)cellReuseIdentifier;	// IMP=0x00000000002055fb
- (void).cxx_destruct;	// IMP=0x0000000000205838
...
- (_Bool)shouldHighlight;	// IMP=0x00000000002057c9
- (id)tableViewCellForTableView:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000000020560d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000205438
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 value:(id)arg3 sectionID:(id)arg4;	// IMP=0x00000000002052a2
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 value:(id)arg3;	// IMP=0x000000000020528d
