...
+ (id)contextWithWasAutomaticallySelected:(_Bool)arg1 additionalPassUniqueIdentifiers:(id)arg2 userInfo:(id)arg3;	// IMP=0x00000000002407d3
+ (id)contextWithWasAutomaticallySelected:(_Bool)arg1 additionalPassUniqueIdentifiers:(id)arg2;	// IMP=0x00000000002407be
+ (id)contextWithAdditionalPassUniqueIdentifiers:(id)arg1;	// IMP=0x00000000002407a7
- (void).cxx_destruct;	// IMP=0x00000000002409da
...
- (id)description;	// IMP=0x0000000000240880
