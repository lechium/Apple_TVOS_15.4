...
+ (id)identifier;	// IMP=0x00000000000bbb00
- (void).cxx_destruct;	// IMP=0x00000000000bbbb8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bb9d3
- (id)initWithTransactionSourceCollection:(id)arg1 familyCollection:(id)arg2 transaction:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5;	// IMP=0x00000000000bb8d5
