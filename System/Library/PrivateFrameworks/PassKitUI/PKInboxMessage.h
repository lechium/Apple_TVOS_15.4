...
+ (id)accountUserInvitationInboxMessageWithAccountUserInvitation:(id)arg1 familyMember:(id)arg2;	// IMP=0x000000000014ea75
- (void).cxx_destruct;	// IMP=0x000000000014ecb8
...
- (_Bool)_isEqualToInboxMessage:(id)arg1;	// IMP=0x000000000014ebc8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014eb60
- (id)initWithType:(long long)arg1 identifier:(id)arg2;	// IMP=0x000000000014e9f7
