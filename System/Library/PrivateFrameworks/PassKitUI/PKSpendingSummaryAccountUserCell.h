...
- (void).cxx_destruct;	// IMP=0x0000000000433360
...
- (struct CGSize)_layoutWithBounds:(struct CGRect)arg1;	// IMP=0x0000000000432d20
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000432cc2
- (void)layoutSubviews;	// IMP=0x0000000000432c55
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000432748
