...
- (void).cxx_destruct;	// IMP=0x00000000000a3f76
...
- (double)maxWidthForTransactionCellInWidth:(double)arg1;	// IMP=0x00000000000a3ede
- (void)layoutSubviews;	// IMP=0x00000000000a3aaa
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a3a30
- (void)prepareForReuse;	// IMP=0x00000000000a39a6
- (void)_updateSpinnerAndDisclosureIndicator;	// IMP=0x00000000000a383b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000a3573
