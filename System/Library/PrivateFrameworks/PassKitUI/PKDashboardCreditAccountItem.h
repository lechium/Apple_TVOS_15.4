...
+ (id)identifier;	// IMP=0x00000000000bc448
- (void).cxx_destruct;	// IMP=0x00000000000bc58b
...
- (id)initWithAccount:(id)arg1 accountUserCollection:(id)arg2 physicalCards:(id)arg3 transactionSourceCollection:(id)arg4 familyCollection:(id)arg5 avatarManager:(id)arg6 type:(unsigned long long)arg7;	// IMP=0x00000000000bc307
