...
- (void).cxx_destruct;	// IMP=0x00000000004245d7
...
- (id)initWithAmount:(id)arg1 credentialType:(long long)arg2 dpanSuffix:(id)arg3 cardDescription:(id)arg4;	// IMP=0x0000000000424320
- (id)initWithAmount:(id)arg1 transactionSourceCollection:(id)arg2;	// IMP=0x00000000004241ce
