...
+ (id)cellReuseIdentifier;	// IMP=0x0000000000205b62
- (void).cxx_destruct;	// IMP=0x0000000000205d99
...
- (void)_switchValueChanged:(id)arg1;	// IMP=0x0000000000205ccd
- (_Bool)shouldHighlight;	// IMP=0x0000000000205cc5
- (id)tableViewCellForTableView:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0000000000205b74
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000205a1a
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 value:(_Bool)arg3 changeHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000205881
