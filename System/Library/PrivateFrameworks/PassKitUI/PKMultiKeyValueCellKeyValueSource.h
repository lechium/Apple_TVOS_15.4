...
- (void).cxx_destruct;	// IMP=0x0000000000173938
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000173870
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001736da
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) id <NSCopying> identifier;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2;	// IMP=0x0000000000173518
