...
- (void).cxx_destruct;	// IMP=0x00000000003d5855
...
- (_Bool)showSchumerBox;	// IMP=0x00000000003d564d
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003d550e
- (void)layoutSubviews;	// IMP=0x00000000003d4b40
- (id)initWithTermsLinkAction:(id)arg1 actionTitle:(id)arg2;	// IMP=0x00000000003d4386
