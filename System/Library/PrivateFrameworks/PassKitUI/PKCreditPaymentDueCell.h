...
- (void).cxx_destruct;	// IMP=0x0000000000344cf3
...
- (void)_buttonTapped:(id)arg1;	// IMP=0x0000000000344bd2
- (id)_payButtonWithCircleLayout:(_Bool)arg1;	// IMP=0x0000000000344929
- (void)_updateButtonImage:(id)arg1;	// IMP=0x000000000034484f
- (void)setButtonTitle:(id)arg1;	// IMP=0x0000000000344349
...
- (struct CGSize)_layoutWithBounds:(struct CGRect)arg1;	// IMP=0x0000000000343369
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000343302
- (void)layoutSubviews;	// IMP=0x0000000000343295
- (void)createSubviews;	// IMP=0x000000000034313e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003430ce
