...
- (struct CGRect)_separatorFrame;	// IMP=0x00000000002ccf1d
- (void)layoutSubviews;	// IMP=0x00000000002cc907
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000002cc51f
