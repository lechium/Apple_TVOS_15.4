...
- (void).cxx_destruct;	// IMP=0x00000000000af681
...
- (void)_transferBalanceButtonTapped:(id)arg1;	// IMP=0x00000000000af3a2
- (void)_updateMessageLabelForAmount:(id)arg1;	// IMP=0x00000000000aef60
- (void)_updateCurrentAmount:(id)arg1;	// IMP=0x00000000000aee73
- (_Bool)_shouldShakeCard:(id)arg1;	// IMP=0x00000000000aee45
- (_Bool)_isAmountValid:(id)arg1;	// IMP=0x00000000000aed2f
- (id)_defaultSuggestions;	// IMP=0x00000000000aebd9
- (double)_transferButtonBottomOffset;	// IMP=0x00000000000aeb6d
- (id)_defaultValues;	// IMP=0x00000000000ae9ff
- (void)_createConstraints;	// IMP=0x00000000000ae35c
- (void)_createSubviews;	// IMP=0x00000000000adbae
- (void)numberPadSuggestionsView:(id)arg1 didSelectSuggestion:(id)arg2;	// IMP=0x00000000000adb08
- (void)enterCurrencyAmountViewDidLayoutKeyboard:(id)arg1;	// IMP=0x00000000000adacc
- (void)enterCurrencyAmountViewDidChangeAmount:(id)arg1;	// IMP=0x00000000000ada7d
- (_Bool)enterCurrencyAmountView:(id)arg1 shouldChangeAmountFrom:(id)arg2 to:(id)arg3;	// IMP=0x00000000000ad9a4
@property(readonly, nonatomic) struct CGSize defaultKeyboardSize;
@property(readonly, nonatomic) UITextField *amountTextField;
- (void)updateConstraints;	// IMP=0x00000000000ad6fc
- (void)layoutSubviews;	// IMP=0x00000000000ad659
@property(nonatomic, getter=isTransferButtonEnabled) _Bool transferButtonEnabled;
- (id)initWithProduct:(id)arg1 provisioningMethodMetadata:(id)arg2 showTransferButton:(_Bool)arg3;	// IMP=0x00000000000ad2ef
