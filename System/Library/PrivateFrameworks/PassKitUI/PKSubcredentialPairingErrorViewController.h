...
- (void).cxx_destruct;	// IMP=0x000000000042fe6a
...
- (void)explanationViewDidSelectContinue:(id)arg1;	// IMP=0x000000000042fb74
- (void)cancelButtonPressed;	// IMP=0x000000000042fb54
- (void)configureExplanationViewWithError:(id)arg1;	// IMP=0x000000000042f90b
- (void)viewWillLayoutSubviews;	// IMP=0x000000000042f7c8
- (void)viewDidLoad;	// IMP=0x000000000042f601
@property(readonly, nonatomic) unsigned long long operation;
- (id)initWithFlowController:(id)arg1 context:(id)arg2;	// IMP=0x000000000042f424
