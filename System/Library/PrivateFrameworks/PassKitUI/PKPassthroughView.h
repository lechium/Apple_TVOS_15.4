...
- (void).cxx_destruct;	// IMP=0x0000000000008194
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000007ec9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000007e79
