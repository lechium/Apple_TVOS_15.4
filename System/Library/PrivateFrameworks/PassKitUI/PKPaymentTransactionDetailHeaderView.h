...
- (void).cxx_destruct;	// IMP=0x00000000000cdf92
...
- (struct CGSize)_layoutWithBounds:(struct CGRect)arg1;	// IMP=0x00000000000cd995
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000cd937
- (void)layoutSubviews;	// IMP=0x00000000000cd8ca
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000cce01
