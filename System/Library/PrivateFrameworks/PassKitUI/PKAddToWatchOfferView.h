...
- (void).cxx_destruct;	// IMP=0x00000000004326c2
...
- (_Bool)_isSmallPhone;	// IMP=0x000000000043264b
- (double)_sideMargin;	// IMP=0x000000000043261a
- (void)showSpinner:(_Bool)arg1;	// IMP=0x00000000004325ca
- (void)layoutSubviews;	// IMP=0x0000000000431f6b
- (id)initWithPaymentPass:(id)arg1 context:(long long)arg2;	// IMP=0x00000000004316e4
