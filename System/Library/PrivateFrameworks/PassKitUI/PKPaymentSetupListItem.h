...
- (void).cxx_destruct;	// IMP=0x0000000000223457
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000022325d
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022305e
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 icon:(id)arg3;	// IMP=0x0000000000222fb2
- (id)init;	// IMP=0x0000000000222f2f
