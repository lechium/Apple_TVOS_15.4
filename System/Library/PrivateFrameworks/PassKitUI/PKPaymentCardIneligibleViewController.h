...
- (void).cxx_destruct;	// IMP=0x00000000001320a3
...
- (void)handleDone:(id)arg1;	// IMP=0x0000000000131f69
- (void)webView:(id)arg1 decidePolicyForNavigationAction:(id)arg2 decisionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000131e39
- (void)webView:(id)arg1 didFailNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x0000000000131d73
- (void)webView:(id)arg1 didFinishNavigation:(id)arg2;	// IMP=0x0000000000131cf1
- (void)_webViewDidLoad:(_Bool)arg1 withError:(id)arg2;	// IMP=0x0000000000131a31
- (id)_alertWithReason:(long long)arg1 learnMoreURL:(id)arg2 isPreloaded:(_Bool)arg3;	// IMP=0x00000000001310ca
- (void)preflightWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000130e07
- (id)webView;	// IMP=0x0000000000130d7e
- (void)dealloc;	// IMP=0x0000000000130d4f
- (void)viewDidLoad;	// IMP=0x0000000000130aea
- (id)initWithReason:(long long)arg1 context:(long long)arg2 setupDelegate:(id)arg3;	// IMP=0x0000000000130a54
