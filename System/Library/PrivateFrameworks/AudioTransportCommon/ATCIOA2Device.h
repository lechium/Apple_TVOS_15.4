...
+ (id)iokitMatchingDictionary;	// IMP=0x000000000000167b
- (void).cxx_destruct;	// IMP=0x0000000000001782
...
- (_Bool)stopIOError:(id *)arg1;	// IMP=0x00000000000016da
- (_Bool)startIOError:(id *)arg1;	// IMP=0x00000000000016d2
- (_Bool)changeToSampleRate:(double)arg1 error:(id *)arg2;	// IMP=0x00000000000016ca
- (id)initWithService:(id)arg1;	// IMP=0x000000000000169b
