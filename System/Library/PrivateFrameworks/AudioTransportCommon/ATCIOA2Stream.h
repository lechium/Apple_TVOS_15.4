...
- (void).cxx_destruct;	// IMP=0x00000000000018a1
...
- (id)initWithService:(id)arg1 connection:(id)arg2 index:(unsigned long long)arg3 input:(_Bool)arg4 description:(id)arg5;	// IMP=0x00000000000017cb
