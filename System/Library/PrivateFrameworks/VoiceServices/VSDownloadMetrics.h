...
+ (double)_clockFactor;	// IMP=0x0000000000013402
- (void).cxx_destruct;	// IMP=0x000000000001359d
...
- (double)downloadDuration;	// IMP=0x000000000001346b
- (_Bool)endMetrics;	// IMP=0x00000000000133db
- (id)dictionaryMetrics;	// IMP=0x000000000001318c
- (id)description;	// IMP=0x000000000001313c
- (id)initWithVoiceName:(id)arg1 languageCode:(id)arg2 gender:(long long)arg3;	// IMP=0x0000000000013047
