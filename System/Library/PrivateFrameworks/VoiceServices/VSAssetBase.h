...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001d00
- (void).cxx_destruct;	// IMP=0x0000000000002028
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001de2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001d08
