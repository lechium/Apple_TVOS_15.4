...
+ (id)stringOfSourceOfTTS:(long long)arg1;	// IMP=0x0000000000003543
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000023b7
+ (id)descriptionFormatter;	// IMP=0x0000000000002074
- (void).cxx_destruct;	// IMP=0x00000000000038d4
...
- (id)dictionaryMetrics;	// IMP=0x0000000000002d21
- (double)serverStreamLastPacketLatency;	// IMP=0x0000000000002ce1
- (double)serverStreamFirstPacketLatency;	// IMP=0x0000000000002ca1
- (double)cappedRealTimeFactor;	// IMP=0x0000000000002c86
- (double)realTimeFactor;	// IMP=0x0000000000002c51
- (double)eagerRequestTimeGap;	// IMP=0x0000000000002c26
- (_Bool)isSynthesisCached;	// IMP=0x0000000000002c11
- (double)ttsSynthesisLatency;	// IMP=0x0000000000002bd4
- (double)audioQueueLatency;	// IMP=0x0000000000002ba9
- (double)timeToPlaybackLatency;	// IMP=0x0000000000002b47
- (double)timeToSpeakLatency;	// IMP=0x0000000000002b0a
@property(readonly) long long speechEstimatedOutputBeginTimestamp;
- (double)_clockFactor;	// IMP=0x0000000000002a44
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000269a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000023bf
- (id)description;	// IMP=0x0000000000002101
