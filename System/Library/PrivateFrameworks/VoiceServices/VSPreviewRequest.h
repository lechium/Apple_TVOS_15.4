...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000016814
- (void).cxx_destruct;	// IMP=0x0000000000016a21
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000168b9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001681c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001673e
