...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002d343
- (void).cxx_destruct;	// IMP=0x000000000002e15e
...
- (_Bool)canLogRequestText;	// IMP=0x000000000002de0d
- (id)contextInfoString;	// IMP=0x000000000002dca0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002d675
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002d34b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002cec7
- (_Bool)isSimilarTo:(id)arg1;	// IMP=0x000000000002cc3c
- (id)description;	// IMP=0x000000000002ca11
- (id)logUtterance;	// IMP=0x000000000002c9e6
- (id)logText;	// IMP=0x000000000002c9be
- (id)init;	// IMP=0x000000000002c962
