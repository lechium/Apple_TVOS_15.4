...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000380e
- (id)initWithLimit:(unsigned long long)arg1 offset:(unsigned long long)arg2;	// IMP=0x00000000000037c6
- (id)initWithLimit:(unsigned long long)arg1;	// IMP=0x00000000000037b2
