...
- (void).cxx_destruct;	// IMP=0x0000000000006514
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000064e1
- (id)initWithName:(id)arg1 tableName:(id)arg2 columnNames:(id)arg3 options:(unsigned long long)arg4;	// IMP=0x00000000000063ef
