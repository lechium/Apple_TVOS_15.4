...
- (void).cxx_destruct;	// IMP=0x0000000000005d90
...
- (id)getConnectionMetricsDescription;	// IMP=0x0000000000005875
- (void)setConnectionMetricsForIDS:(double)arg1 messageDelay:(double)arg2 openErrorCode:(unsigned long long)arg3;	// IMP=0x0000000000005799
- (void)setConnectionMetricsFromNWConnectionForPOP:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005793
- (void)setConnectionMetricsFromNWConnectionForDirect:(id)arg1 isMPTCP:(_Bool)arg2 attemptedEndpoints:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000004d41
- (void)setConnectionMetricsFromConnection:(id)arg1 isPop:(_Bool)arg2 isMPTCP:(_Bool)arg3 attemptedEndpoints:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004c63
- (void)_setConnectionMetricsTCPInfo:(id)arg1;	// IMP=0x0000000000004a3b
- (void)setConnectionMetricsFromStreamForPOP:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004a08
- (void)setConnectionMetricsFromStreamForDirect:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004015
- (void)setConnectionMetricsFromStream:(id)arg1 isPop:(_Bool)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000003ff0
