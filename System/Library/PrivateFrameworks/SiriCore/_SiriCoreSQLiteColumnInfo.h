...
- (void).cxx_destruct;	// IMP=0x00000000000060f6
...
- (id)initWithIdentifier:(long long)arg1 name:(id)arg2 type:(id)arg3 isPrimaryKey:(_Bool)arg4 isNotNull:(_Bool)arg5 defaultValue:(id)arg6;	// IMP=0x0000000000005fc1
