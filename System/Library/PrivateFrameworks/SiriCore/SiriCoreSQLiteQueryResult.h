...
- (void).cxx_destruct;	// IMP=0x00000000000124a8
...
- (id)description;	// IMP=0x00000000000122a3
- (id)initWithQuery:(id)arg1 beginMachTime:(unsigned long long)arg2 endMachTime:(unsigned long long)arg3 statement:(id)arg4 columnNameTuple:(id)arg5 columnValueTuples:(id)arg6 columnValuesMap:(id)arg7 rowValueTuples:(id)arg8 rowValueMaps:(id)arg9 records:(id)arg10 error:(id)arg11;	// IMP=0x00000000000120d1
