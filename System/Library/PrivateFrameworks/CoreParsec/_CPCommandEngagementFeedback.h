...
- (void).cxx_destruct;	// IMP=0x00000000000634fd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000062d48
- (void)writeTo:(id)arg1;	// IMP=0x0000000000062ac6
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000062ab9
- (id)init;	// IMP=0x0000000000062931
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000090db8
