...
- (void).cxx_destruct;	// IMP=0x000000000006d31e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006cab3
- (void)writeTo:(id)arg1;	// IMP=0x000000000006c82f
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006c822
- (id)init;	// IMP=0x000000000006c6a6
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000007debf
