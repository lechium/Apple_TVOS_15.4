...
- (void).cxx_destruct;	// IMP=0x000000000004b55e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004a257
- (void)writeTo:(id)arg1;	// IMP=0x0000000000049da0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000049d93
