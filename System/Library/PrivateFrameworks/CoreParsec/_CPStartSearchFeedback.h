...
- (void).cxx_destruct;	// IMP=0x000000000007404a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000073c09
- (void)writeTo:(id)arg1;	// IMP=0x0000000000073aa9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000073a9c
- (id)init;	// IMP=0x000000000007398c
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000007d839
