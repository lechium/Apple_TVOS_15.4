...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000064664
- (void)writeTo:(id)arg1;	// IMP=0x00000000000645e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000645dc
- (id)init;	// IMP=0x0000000000064555
