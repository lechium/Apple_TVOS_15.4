...
- (void).cxx_destruct;	// IMP=0x0000000000049bd7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000047e72
- (void)writeTo:(id)arg1;	// IMP=0x000000000004792a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000004791d
