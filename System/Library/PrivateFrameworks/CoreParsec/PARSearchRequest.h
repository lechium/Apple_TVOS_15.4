...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000098cd1
- (void).cxx_destruct;	// IMP=0x00000000000970c4
...
- (unsigned int)nwActivityLabel;	// IMP=0x0000000000096f5f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000096c12
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000096aca
