...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006482d
- (void)writeTo:(id)arg1;	// IMP=0x00000000000647dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000647d0
- (id)init;	// IMP=0x0000000000064759
