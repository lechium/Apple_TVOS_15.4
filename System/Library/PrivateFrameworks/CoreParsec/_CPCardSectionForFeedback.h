...
- (void).cxx_destruct;	// IMP=0x000000000003d65b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003cb79
- (void)writeTo:(id)arg1;	// IMP=0x000000000003c78b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003c77e
- (id)buttonsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000003c761
- (unsigned long long)buttonsCount;	// IMP=0x000000000003c744
- (void)addButtons:(id)arg1;	// IMP=0x000000000003c6ca
- (void)clearButtons;	// IMP=0x000000000003c6ad
- (id)cardSectionsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000003c618
- (unsigned long long)cardSectionsCount;	// IMP=0x000000000003c5fb
- (void)addCardSections:(id)arg1;	// IMP=0x000000000003c581
- (void)clearCardSections;	// IMP=0x000000000003c564
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000091194
