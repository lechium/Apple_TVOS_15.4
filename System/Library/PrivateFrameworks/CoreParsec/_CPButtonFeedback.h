...
- (void).cxx_destruct;	// IMP=0x000000000003aa4f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a7c4
- (void)writeTo:(id)arg1;	// IMP=0x000000000003a6d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003a6c4
- (id)init;	// IMP=0x000000000003a5f8
