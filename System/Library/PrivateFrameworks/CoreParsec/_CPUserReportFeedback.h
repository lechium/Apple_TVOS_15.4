...
- (void).cxx_destruct;	// IMP=0x000000000007c616
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007bffd
- (void)writeTo:(id)arg1;	// IMP=0x000000000007be50
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000007be43
- (id)init;	// IMP=0x000000000007bd5c
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000007d230
