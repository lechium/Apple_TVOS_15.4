...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006c278
- (void)writeTo:(id)arg1;	// IMP=0x000000000006c1d4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006c1c7
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000088323
