...
- (void).cxx_destruct;	// IMP=0x000000000003c113
@property(copy, nonatomic) NSString *uuid; // @synthesize uuid=_uuid;
@property(nonatomic) int triggerEvent; // @synthesize triggerEvent=_triggerEvent;
@property(copy, nonatomic) NSString *input; // @synthesize input=_input;
@property(nonatomic) unsigned long long timestamp;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003bd83
- (void)writeTo:(id)arg1;	// IMP=0x000000000003bc7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003bc6f
- (id)init;	// IMP=0x000000000003bb80
