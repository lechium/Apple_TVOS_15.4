...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000076510
- (void)writeTo:(id)arg1;	// IMP=0x000000000007633d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000076330
- (id)init;	// IMP=0x0000000000076221
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000085c49
