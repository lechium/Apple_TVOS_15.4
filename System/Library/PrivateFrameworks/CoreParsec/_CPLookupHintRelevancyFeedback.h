...
- (void).cxx_destruct;	// IMP=0x0000000000065495
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000064f4d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000064dbe
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000064db1
- (id)init;	// IMP=0x0000000000064c9e
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000087e6b
