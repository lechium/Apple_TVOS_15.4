...
- (void).cxx_destruct;	// IMP=0x000000000006778b
@property(nonatomic) int triggerEvent; // @synthesize triggerEvent=_triggerEvent;
@property(nonatomic) int endpoint; // @synthesize endpoint=_endpoint;
@property(copy, nonatomic) NSString *input; // @synthesize input=_input;
@property(nonatomic) unsigned long long timestamp;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000674fe
- (void)writeTo:(id)arg1;	// IMP=0x000000000006740c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000673ff
- (id)init;	// IMP=0x0000000000067334
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000008a28e
