...
- (void).cxx_destruct;	// IMP=0x000000000007216b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007188b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000071618
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000007160b
- (id)init;	// IMP=0x000000000007146d
- (id)initWithStartSearch:(id)arg1 responseSize:(long long)arg2 statusCode:(long long)arg3 parsecStatus:(id)arg4 parsecDuration:(double)arg5 fbq:(id)arg6 partialClientIp:(id)arg7 networkTimingData:(id)arg8;	// IMP=0x0000000000090873
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000000906c2
