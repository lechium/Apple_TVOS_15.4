...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004eb58
- (void)writeTo:(id)arg1;	// IMP=0x000000000004dad4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000004dac7
...
- (void)clearContained_Feedback;	// IMP=0x000000000004bfa8
@property(readonly, nonatomic) PBCodable<_CPProcessableFeedback> *codable;
@property(readonly, nonatomic) int type;
- (id)initWithCodable:(id)arg1;	// IMP=0x0000000000089374
- (id)initWithFeedback:(id)arg1;	// IMP=0x000000000008856d
- (void)updateResults:(id)arg1 withId:(unsigned long long)arg2;	// IMP=0x00000000000900de
- (void)updateQueryId:(unsigned long long)arg1;	// IMP=0x000000000008fa83
