...
- (void).cxx_destruct;	// IMP=0x0000000000062801
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000060b75
- (void)writeTo:(id)arg1;	// IMP=0x0000000000060275
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000060268
...
- (void)clearApplicationbundleid;	// IMP=0x000000000005fbd5
- (void)clearSectionbundleid;	// IMP=0x000000000005fb95
- (void)clearResultbundleidentifier;	// IMP=0x000000000005fb55
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000007eb54
- (unsigned long long)typeForPQC;	// IMP=0x000000000008f86c
