...
- (void).cxx_destruct;	// IMP=0x00000000000431d9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042c55
- (void)writeTo:(id)arg1;	// IMP=0x0000000000042b25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000042b18
