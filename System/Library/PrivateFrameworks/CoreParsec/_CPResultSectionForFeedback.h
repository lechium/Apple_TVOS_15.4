...
- (void).cxx_destruct;	// IMP=0x0000000000068ff2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000688d5
- (void)writeTo:(id)arg1;	// IMP=0x000000000006863a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006862d
@property(nonatomic) int knownBundleIdentifier; // @synthesize knownBundleIdentifier=_knownBundleIdentifier;
@property(copy, nonatomic) NSString *bundleIdentifier; // @synthesize bundleIdentifier=_bundleIdentifier;
- (id)resultsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000068484
- (unsigned long long)resultsCount;	// IMP=0x0000000000068467
- (void)addResults:(id)arg1;	// IMP=0x00000000000683ed
- (void)clearResults;	// IMP=0x00000000000683d0
- (void)clearBundleid;	// IMP=0x000000000006835c
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000083ae4
