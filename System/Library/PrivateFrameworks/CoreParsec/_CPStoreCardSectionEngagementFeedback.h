...
- (void).cxx_destruct;	// IMP=0x0000000000074ab6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000743d5
- (void)writeTo:(id)arg1;	// IMP=0x00000000000741bf
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000741b2
- (id)init;	// IMP=0x000000000007407b
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000007d586
