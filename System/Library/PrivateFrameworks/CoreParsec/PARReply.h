...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000999b8
- (void).cxx_destruct;	// IMP=0x0000000000099966
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000997ab
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000995b7
