...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000038461
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000382af
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000038169
- (id)initFromBag:(id)arg1;	// IMP=0x0000000000037df8
- (id)init;	// IMP=0x0000000000037d8a
- (id)initFromEnabled:(_Bool)arg1 enableCount:(_Bool)arg2 minCount:(long long)arg3;	// IMP=0x0000000000038469
