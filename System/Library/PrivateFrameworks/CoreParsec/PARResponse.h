...
+ (id)responseFromReply:(id)arg1;	// IMP=0x0000000000093a7a
+ (id)responseFromJSON:(id)arg1 session:(id)arg2;	// IMP=0x00000000000939e6
+ (id)responseFromData:(id)arg1 session:(id)arg2 request:(id)arg3;	// IMP=0x00000000000938e4
- (void).cxx_destruct;	// IMP=0x00000000000937be
...
- (_Bool)compareWithResponse:(id)arg1 logger:(CDUnknownBlockType)arg2;	// IMP=0x0000000000092dac
- (id)initWithReply:(id)arg1;	// IMP=0x0000000000092d1b
- (id)initWithReply:(id)arg1 factory:(id)arg2 dataV2:(id)arg3;	// IMP=0x0000000000011aa3
