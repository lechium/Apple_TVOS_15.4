...
- (void).cxx_destruct;	// IMP=0x0000000000076d53
@property(retain, nonatomic) _CPSearchResultForFeedback *result; // @synthesize result=_result;
@property(nonatomic) unsigned long long timestamp;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000076b52
- (void)writeTo:(id)arg1;	// IMP=0x0000000000076a9e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000076a91
- (id)init;	// IMP=0x0000000000076a06
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000085b2a
