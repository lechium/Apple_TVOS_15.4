...
+ (id)startMetricsForNormalization;	// IMP=0x000000000008d47c
- (void).cxx_destruct;	// IMP=0x00000000000713f8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000704e7
- (void)writeTo:(id)arg1;	// IMP=0x000000000006fefe
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006fef1
- (id)initWithTelemetryDictionary:(id)arg1;	// IMP=0x000000000008bfa0
