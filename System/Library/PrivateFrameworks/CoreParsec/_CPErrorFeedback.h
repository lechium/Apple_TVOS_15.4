...
- (void).cxx_destruct;	// IMP=0x000000000006b8ff
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006b45c
- (void)writeTo:(id)arg1;	// IMP=0x000000000006b30b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006b2fe
- (id)init;	// IMP=0x000000000006b22b
- (id)initWithError:(id)arg1;	// IMP=0x0000000000090573
- (id)initWithFacade:(id)arg1;	// IMP=0x00000000000904d4
