...
- (void).cxx_destruct;	// IMP=0x0000000000041de2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000041802
- (void)writeTo:(id)arg1;	// IMP=0x00000000000414e4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000414d7
