...
- (void).cxx_destruct;	// IMP=0x0000000000040545
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000401b5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000040094
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000040087
- (id)init;	// IMP=0x000000000003ffb8
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000008a827
