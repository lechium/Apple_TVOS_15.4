...
- (void).cxx_destruct;	// IMP=0x0000000000075367
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000074df3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000074c39
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000074c2c
- (id)init;	// IMP=0x0000000000074b09
- (id)initWithFacade:(id)arg1;	// IMP=0x0000000000087c4d
