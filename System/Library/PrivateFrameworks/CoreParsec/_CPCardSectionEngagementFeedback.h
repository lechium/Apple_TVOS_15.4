...
- (void).cxx_destruct;	// IMP=0x000000000003efd0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003e78b
- (void)writeTo:(id)arg1;	// IMP=0x000000000003e507
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003e4fa
- (id)init;	// IMP=0x000000000003e37f
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000008ab95
