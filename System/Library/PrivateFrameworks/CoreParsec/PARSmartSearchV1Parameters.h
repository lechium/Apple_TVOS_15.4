...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000037d82
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000037c51
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000037b65
- (id)initFromLast1hour:(double)arg1 last1day:(double)arg2 last1week:(double)arg3 last1month:(double)arg4 all:(double)arg5 mostRecent:(double)arg6 minThresholdToSend:(double)arg7;	// IMP=0x0000000000037adc
- (id)initFromBag:(id)arg1;	// IMP=0x0000000000037a0b
- (id)init;	// IMP=0x00000000000379ae
