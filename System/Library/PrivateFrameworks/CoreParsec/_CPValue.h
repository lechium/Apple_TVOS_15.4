...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005ea1a
- (void)writeTo:(id)arg1;	// IMP=0x000000000005e826
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000005e819
...
- (void)clearKind;	// IMP=0x000000000005e3fc
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000008d65e
