...
+ (id)startSearchFeedbackWithUUID;	// IMP=0x000000000009284a
- (void).cxx_destruct;	// IMP=0x00000000000735a0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000072ab7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000072621
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000072614
@property(nonatomic) int lookupSelectionType; // @synthesize lookupSelectionType=_lookupSelectionType;
@property(nonatomic) int triggerEvent; // @synthesize triggerEvent=_triggerEvent;
- (void)setHeaders:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000723af
- (_Bool)getHeaders:(id *)arg1 forKey:(id)arg2;	// IMP=0x0000000000072352
- (void)clearTrigger;	// IMP=0x0000000000072235
- (id)init;	// IMP=0x00000000000721cf
- (id)initWithFacade:(id)arg1;	// IMP=0x000000000007d9d7
