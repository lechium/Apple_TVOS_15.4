...
+ (void)getStateFromURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f608f
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f6087
- (void).cxx_destruct;	// IMP=0x00000000000f5ffc
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000f5eae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f5af3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f5658
- (id)initWithWorkflow:(id)arg1 variables:(id)arg2 currentActionIndex:(unsigned long long)arg3 runningContext:(id)arg4 currentInput:(id)arg5 currentProcessedParameters:(id)arg6 startDate:(id)arg7 currentRunSource:(id)arg8 numberOfDialogsPresented:(long long)arg9 outputBehavior:(unsigned long long)arg10 contentAttributionTracker:(id)arg11 contentItemCache:(id)arg12 flowTracker:(id)arg13 allowedOnceSmartPromptStates:(id)arg14;	// IMP=0x00000000000f53aa
