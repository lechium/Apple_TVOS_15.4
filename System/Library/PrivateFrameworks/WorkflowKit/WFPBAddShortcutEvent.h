...
- (void).cxx_destruct;	// IMP=0x0000000000143fb0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000143e5a
- (unsigned long long)hash;	// IMP=0x0000000000143dab
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000143c47
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000143b3a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000143a77
- (void)writeTo:(id)arg1;	// IMP=0x00000000001439bc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001439af
- (id)dictionaryRepresentation;	// IMP=0x000000000014387c
- (id)description;	// IMP=0x00000000001437cd
