...
- (void).cxx_destruct;	// IMP=0x000000000016c5c9
...
- (void)performActionWithInput:(id)arg1 parameters:(id)arg2 userInterface:(id)arg3 successHandler:(CDUnknownBlockType)arg4 errorHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000016c59b
- (void)processInput:(id)arg1 parameters:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000016be96
- (id)description;	// IMP=0x000000000016bd9a
- (unsigned long long)hash;	// IMP=0x000000000016bd56
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016bc31
...
- (id)initWithDefinition:(id)arg1 app:(id)arg2;	// IMP=0x000000000016a237
