...
- (id)defaultSerializedRepresentation;	// IMP=0x00000000001194e4
@property(readonly, nonatomic) double currentLocationAccuracy;
- (id)initWithDefinition:(id)arg1;	// IMP=0x00000000001191ce
- (Class)singleStateClass;	// IMP=0x00000000001191bd
