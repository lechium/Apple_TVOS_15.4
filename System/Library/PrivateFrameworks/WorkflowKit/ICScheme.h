...
- (void).cxx_destruct;	// IMP=0x00000000001aec68
...
- (id)description;	// IMP=0x00000000001aeb2e
- (unsigned long long)hash;	// IMP=0x00000000001aeaea
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001aea34
...
- (_Bool)matchesURL:(id)arg1;	// IMP=0x00000000001ae4d5
...
- (id)initWithDefinition:(id)arg1 app:(id)arg2;	// IMP=0x00000000001adc88
