...
+ (id)properties;	// IMP=0x0000000000114056
+ (id)recordType;	// IMP=0x0000000000114049
- (void).cxx_destruct;	// IMP=0x0000000000113a3b
...
- (id)propertiesForEventLogging;	// IMP=0x0000000000113806
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001131b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000112cb8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001123ba
@property(readonly) unsigned long long hash;
- (void)ensureFileAssets;	// IMP=0x0000000000111fdc
...
- (void)setCreatedAt:(id)arg1 modifiedAt:(id)arg2 createdBy:(id)arg3;	// IMP=0x00000000001119ab
- (unsigned long long)referenceActionForKey:(id)arg1;	// IMP=0x000000000011198b
- (id)sharingURL;	// IMP=0x0000000000111918
