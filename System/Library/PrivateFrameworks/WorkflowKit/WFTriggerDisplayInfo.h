...
- (void).cxx_destruct;	// IMP=0x0000000000165903
...
- (id)initWithLocalizedTitle:(id)arg1 localizedDescription:(id)arg2 actionIcons:(id)arg3 triggerClass:(Class)arg4;	// IMP=0x0000000000165801
