...
+ (id)priceJSONTransformer;	// IMP=0x0000000000174b79
+ (id)explicitJSONTransformer;	// IMP=0x0000000000174b4b
+ (id)durationJSONTransformer;	// IMP=0x0000000000174b24
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x0000000000174955
- (void).cxx_destruct;	// IMP=0x0000000000174575
