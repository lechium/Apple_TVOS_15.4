...
+ (id)workflowSubtitleForActionCount:(unsigned long long)arg1 savedSubtitle:(id)arg2;	// IMP=0x00000000001a91c4
+ (id)defaultPropertyValues;	// IMP=0x00000000001a8e3d
- (void).cxx_destruct;	// IMP=0x00000000001a8c96
...
- (_Bool)isEquivalentForSyncTo:(id)arg1;	// IMP=0x00000000001a7f11
- (_Bool)saveChangesToStorage:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a7de1
- (id)fileRepresentation;	// IMP=0x00000000001a7d3a
- (_Bool)loadFromPeaceData:(id)arg1 keyImageData:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000321f1
- (id)initWithPeaceCoreDataModel:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004c704
- (id)initWithPeaceCloudKitRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004c4e6
@property(readonly, copy, nonatomic) NSString *wfName;
- (_Bool)isEligibleForWatchWithIneligibleActionIdentifiers:(id)arg1;	// IMP=0x000000000024a0a0
- (_Bool)isEligibleForWatch;	// IMP=0x000000000024a01e
- (_Bool)addWatchWorkflowTypeIfEligibleWithIneligibleActionIdentifiers:(id)arg1;	// IMP=0x0000000000249ee0
- (_Bool)addWatchWorkflowTypeIfEligible;	// IMP=0x0000000000249e5e
- (void)addWatchWorkflowType;	// IMP=0x0000000000249d55
