...
- (void).cxx_destruct;	// IMP=0x00000000001cfa46
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001cf795
- (unsigned long long)hash;	// IMP=0x00000000001cf5f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001cf32f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001cf139
- (void)copyTo:(id)arg1;	// IMP=0x00000000001cefa4
- (void)writeTo:(id)arg1;	// IMP=0x00000000001cee05
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001cedf8
- (id)dictionaryRepresentation;	// IMP=0x00000000001ceabf
- (id)description;	// IMP=0x00000000001cea10
