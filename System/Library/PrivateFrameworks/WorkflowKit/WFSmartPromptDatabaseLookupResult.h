...
- (void).cxx_destruct;	// IMP=0x000000000025a065
...
- (id)resultByAddingResult:(id)arg1;	// IMP=0x0000000000259e9b
- (id)initWithAllowedStates:(id)arg1 deniedStates:(id)arg2 undefinedStates:(id)arg3 restrictedStates:(id)arg4;	// IMP=0x0000000000259da9
- (id)initWithAllowedStates:(id)arg1 deniedStates:(id)arg2 undefinedStates:(id)arg3;	// IMP=0x0000000000259d90
