...
- (void).cxx_destruct;	// IMP=0x0000000000018245
...
- (_Bool)allowsMultipleValues;	// IMP=0x000000000001820a
- (id)defaultSupportedVariableTypes;	// IMP=0x00000000000181f0
- (id)initWithDefinition:(id)arg1;	// IMP=0x0000000000017f49
- (Class)singleStateClass;	// IMP=0x0000000000017f38
