...
+ (id)recordIDWithZoneID:(id)arg1 workflowID:(id)arg2;	// IMP=0x00000000000dc120
+ (id)properties;	// IMP=0x00000000000dbdd7
+ (id)recordType;	// IMP=0x00000000000dbdca
- (void).cxx_destruct;	// IMP=0x00000000000dce98
...
- (_Bool)isValidForSyncing;	// IMP=0x00000000000dccc5
- (id)recordRepresentationWithError:(id *)arg1;	// IMP=0x00000000000dc64d
- (id)initWithRecord:(id)arg1 identifier:(id)arg2;	// IMP=0x00000000000dc1fc
- (void)setCreatedAt:(id)arg1 modifiedAt:(id)arg2 createdBy:(id)arg3;	// IMP=0x00000000000dc190
