...
+ (Class)classForParsingJSONDictionary:(id)arg1;	// IMP=0x000000000017388a
+ (id)artworkURLsJSONTransformer;	// IMP=0x0000000000173863
+ (id)releaseDateJSONTransformer;	// IMP=0x00000000001737aa
+ (id)artistIDJSONTransformer;	// IMP=0x0000000000173798
+ (id)identifierJSONTransformer;	// IMP=0x0000000000173778
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x0000000000173702
+ (id)allowedSecureCodingClassesByPropertyKey;	// IMP=0x00000000001735f4
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001735ec
- (void).cxx_destruct;	// IMP=0x0000000000173577
...
- (id)initWithName:(id)arg1 identifier:(id)arg2 kind:(id)arg3;	// IMP=0x00000000001733ed
