...
- (void).cxx_destruct;	// IMP=0x0000000000119db5
...
- (_Bool)requestSandboxExtensionForRunningActionWithAccessResources:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000119cbe
- (void)requestSandboxExtensionForRunningActionWithAccessResources:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000119bfd
- (void)addContentAttributionSet:(id)arg1;	// IMP=0x0000000000119b73
- (id)initWithVariableSource:(id)arg1 actionSandboxExtensionProvider:(id)arg2 parameter:(id)arg3 isInputParameter:(_Bool)arg4 environment:(long long)arg5 contentAttributionTracker:(id)arg6 widgetSizeClass:(id)arg7;	// IMP=0x0000000000119904
