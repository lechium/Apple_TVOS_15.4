...
- (void).cxx_destruct;	// IMP=0x0000000000247aca
...
- (id)serializedRepresentationWithWorkflowActions:(id)arg1;	// IMP=0x000000000024787f
- (id)initWithSerializedRepresentation:(id)arg1 workflowActions:(id)arg2;	// IMP=0x0000000000247595
- (id)initWithAction:(id)arg1 parameter:(id)arg2 question:(id)arg3 defaultState:(id)arg4;	// IMP=0x00000000002473d8
