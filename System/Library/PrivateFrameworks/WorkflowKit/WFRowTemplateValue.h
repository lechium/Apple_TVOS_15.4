...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002b319
- (void).cxx_destruct;	// IMP=0x000000000002b283
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002af7e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002ac0e
- (id)initWithContentItemClass:(Class)arg1 contentPropertyName:(id)arg2 comparisonOperator:(long long)arg3 removable:(_Bool)arg4;	// IMP=0x000000000002ab5c
