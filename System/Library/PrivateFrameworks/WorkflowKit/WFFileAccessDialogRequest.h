...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001b85cc
- (void).cxx_destruct;	// IMP=0x00000000001b8568
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b8396
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b819f
- (id)description;	// IMP=0x00000000001b8018
- (id)initWithPrompt:(id)arg1 message:(id)arg2 okButton:(id)arg3 cancelButton:(id)arg4 attribution:(id)arg5 workflowID:(id)arg6 URLs:(id)arg7;	// IMP=0x00000000001b7e02
