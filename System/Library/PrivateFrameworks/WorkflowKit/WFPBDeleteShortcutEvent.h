...
- (void).cxx_destruct;	// IMP=0x000000000025c977
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000025c821
- (unsigned long long)hash;	// IMP=0x000000000025c772
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025c60e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025c501
- (void)copyTo:(id)arg1;	// IMP=0x000000000025c43e
- (void)writeTo:(id)arg1;	// IMP=0x000000000025c383
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000025c376
- (id)dictionaryRepresentation;	// IMP=0x000000000025c243
- (id)description;	// IMP=0x000000000025c194
