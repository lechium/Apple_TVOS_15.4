...
+ (struct CGSize)pixelSizeForBannerSize:(long long)arg1;	// IMP=0x000000000010f0c3
+ (struct CGSize)pointSizeForBannerSize:(long long)arg1;	// IMP=0x000000000010f0a0
+ (double)scaleForBannerSize:(long long)arg1;	// IMP=0x000000000010f085
+ (id)propertyForSize:(long long)arg1;	// IMP=0x000000000010f05a
+ (id)properties;	// IMP=0x000000000010ecc8
+ (id)recordType;	// IMP=0x000000000010ecbb
- (void).cxx_destruct;	// IMP=0x000000000010eac1
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010e6d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010e417
- (id)imageForSize:(long long)arg1;	// IMP=0x000000000010e37d
- (id)imageFileForSize:(long long)arg1;	// IMP=0x000000000010e34e
- (unsigned long long)referenceActionForKey:(id)arg1;	// IMP=0x000000000010e32e
