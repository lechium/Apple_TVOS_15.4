...
+ (id)recordPropertyMap;	// IMP=0x0000000000094105
+ (id)descriptorFetchRequest;	// IMP=0x0000000000093f65
+ (id)fetchRequest;	// IMP=0x000000000025dfec
- (long long)computedSyncHash;	// IMP=0x0000000000090ea7
...
- (void)didUpdateProperties:(id)arg1;	// IMP=0x000000000008ec7c
- (id)descriptor;	// IMP=0x000000000008ea60
- (id)identifier;	// IMP=0x000000000008ea4e
