...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006860f
- (void).cxx_destruct;	// IMP=0x00000000000685ff
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006854e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000068428
- (id)initWithCompoundType:(long long)arg1 rows:(id)arg2;	// IMP=0x000000000006831c
