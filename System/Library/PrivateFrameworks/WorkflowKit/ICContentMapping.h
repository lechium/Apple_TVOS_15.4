...
- (void)getStringRepresentation:(CDUnknownBlockType)arg1 withInput:(id)arg2 parameters:(id)arg3;	// IMP=0x000000000002bdda
- (void)getContentCollection:(CDUnknownBlockType)arg1 withInput:(id)arg2 parameters:(id)arg3;	// IMP=0x000000000002bacc
...
- (id)initWithDefinition:(id)arg1;	// IMP=0x000000000002b321
