...
+ (_Bool)mustBeAvailableForDisplay;	// IMP=0x00000000002406b4
- (void).cxx_destruct;	// IMP=0x000000000024092d
@property(nonatomic) __weak WFWorkflow *workflow; // @synthesize workflow=_workflow;
- (void)refreshAvailability;	// IMP=0x00000000002408e1
- (_Bool)workflowEnvironmentIsValid;	// IMP=0x00000000002406ed
