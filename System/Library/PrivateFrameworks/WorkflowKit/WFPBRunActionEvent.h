...
- (void).cxx_destruct;	// IMP=0x0000000000240320
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000240162
- (unsigned long long)hash;	// IMP=0x0000000000240066
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023fe81
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023fd27
- (void)copyTo:(id)arg1;	// IMP=0x000000000023fc20
- (void)writeTo:(id)arg1;	// IMP=0x000000000023fb1e
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000023fb11
- (id)dictionaryRepresentation;	// IMP=0x000000000023f957
- (id)description;	// IMP=0x000000000023f8a8
