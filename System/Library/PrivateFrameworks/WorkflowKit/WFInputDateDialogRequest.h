...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007b425
- (void).cxx_destruct;	// IMP=0x000000000007b3d2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007b248
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007b0d4
- (id)description;	// IMP=0x000000000007af4d
- (id)initWithDatePickerConfiguration:(id)arg1 message:(id)arg2 attribution:(id)arg3 prompt:(id)arg4;	// IMP=0x000000000007ae17
