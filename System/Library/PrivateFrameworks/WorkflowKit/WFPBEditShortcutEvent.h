...
- (void).cxx_destruct;	// IMP=0x000000000019d37c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000019d145
- (unsigned long long)hash;	// IMP=0x000000000019cff1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019cdce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019cc38
- (void)copyTo:(id)arg1;	// IMP=0x000000000019cae4
- (void)writeTo:(id)arg1;	// IMP=0x000000000019c984
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000019c977
- (id)dictionaryRepresentation;	// IMP=0x000000000019c691
- (id)description;	// IMP=0x000000000019c5e2
