...
- (void).cxx_destruct;	// IMP=0x000000000017ed63
...
- (id)generateOutputUUIDForAction:(id)arg1;	// IMP=0x000000000017e98a
- (id)initWithAction:(id)arg1 atPosition:(unsigned long long)arg2;	// IMP=0x000000000017e888
