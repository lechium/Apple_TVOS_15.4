...
- (void).cxx_destruct;	// IMP=0x000000000000888e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000087ad
- (unsigned long long)hash;	// IMP=0x0000000000008740
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008648
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008584
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008501
- (void)writeTo:(id)arg1;	// IMP=0x0000000000008487
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000847a
- (id)dictionaryRepresentation;	// IMP=0x00000000000083d0
- (id)description;	// IMP=0x0000000000008321
