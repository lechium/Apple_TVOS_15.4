...
+ (id)accountForContainerEnvironmentString:(id)arg1 userRecordID:(id)arg2;	// IMP=0x00000000001bda7d
+ (id)ignoredPropertyNames;	// IMP=0x00000000001bda51
+ (id)defaultPropertyValues;	// IMP=0x00000000001bd945
- (void).cxx_destruct;	// IMP=0x00000000001bd8ae
...
- (id)newTokenWithCopiedPayload;	// IMP=0x00000000001bd647
