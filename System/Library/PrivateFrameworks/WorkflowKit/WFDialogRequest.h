...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001e9ac3
- (void).cxx_destruct;	// IMP=0x00000000001e9a9b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e99a1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e9899
@property(readonly, nonatomic) _Bool shouldCenterPrompt;
@property(readonly, nonatomic) NSString *promptForDisplay;
- (id)initWithAttribution:(id)arg1 prompt:(id)arg2;	// IMP=0x00000000001e9745
- (id)initWithAppBundleIdentifier:(id)arg1 prompt:(id)arg2;	// IMP=0x00000000001e96bf
