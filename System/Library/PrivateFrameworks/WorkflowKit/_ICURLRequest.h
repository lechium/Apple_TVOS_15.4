...
+ (id)requestWithURL:(id)arg1 scheme:(id)arg2 userInterface:(id)arg3 bundleIdentifier:(id)arg4 successHandler:(CDUnknownBlockType)arg5 failureHandler:(CDUnknownBlockType)arg6;	// IMP=0x0000000000117e17
+ (id)requestWithURL:(id)arg1 fromSourceApplication:(id)arg2;	// IMP=0x0000000000117d9c
+ (id)requestWithURL:(id)arg1;	// IMP=0x0000000000117d3c
- (void).cxx_destruct;	// IMP=0x0000000000117bb7
...
- (id)description;	// IMP=0x00000000001179fe
- (void)parseActions;	// IMP=0x00000000001176f2
...
- (id)initWithURL:(id)arg1 scheme:(id)arg2 userInterface:(id)arg3 successHandler:(CDUnknownBlockType)arg4 failureHandler:(CDUnknownBlockType)arg5 bundleIdentifier:(id)arg6;	// IMP=0x00000000001174a6
