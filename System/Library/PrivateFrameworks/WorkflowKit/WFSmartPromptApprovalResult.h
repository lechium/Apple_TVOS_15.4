...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001fb350
- (void).cxx_destruct;	// IMP=0x00000000001fb307
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001faf5a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001fae0e
- (id)resultByAddingDatabaseResult:(id)arg1;	// IMP=0x00000000001fabd1
- (id)initWithAllowedStates:(id)arg1 deniedStates:(id)arg2 undefinedStates:(id)arg3 restrictedStates:(id)arg4 actionUUID:(id)arg5;	// IMP=0x00000000001faabd
- (id)initWithActionUUID:(id)arg1;	// IMP=0x00000000001faa8e
