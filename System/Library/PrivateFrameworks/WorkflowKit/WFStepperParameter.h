...
- (void).cxx_destruct;	// IMP=0x0000000000192062
...
- (id)localizedLabelWithoutCountAndPrefix;	// IMP=0x0000000000191f4a
- (id)localizedLabelWithState:(id)arg1 includingPrefix:(_Bool)arg2;	// IMP=0x0000000000191c8a
- (id)localizedLabel;	// IMP=0x0000000000191b7f
- (id)defaultSerializedRepresentation;	// IMP=0x0000000000191ac6
@property(readonly, copy, nonatomic) NSString *localizedLabelFormatString;
- (id)initWithDefinition:(id)arg1;	// IMP=0x0000000000191787
- (Class)singleStateClass;	// IMP=0x0000000000191776
