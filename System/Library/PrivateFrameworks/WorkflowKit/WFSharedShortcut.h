...
+ (id)properties;	// IMP=0x000000000011455f
+ (id)recordType;	// IMP=0x0000000000114552
- (void).cxx_destruct;	// IMP=0x00000000001154d9
...
- (id)propertiesForEventLogging;	// IMP=0x00000000001152b2
- (id)sharingURL;	// IMP=0x000000000011523f
- (void)setCreatedAt:(id)arg1 modifiedAt:(id)arg2 createdBy:(id)arg3;	// IMP=0x00000000001151c2
- (void)ensureFileAssets;	// IMP=0x0000000000114f4d
