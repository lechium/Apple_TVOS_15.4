...
- (void).cxx_destruct;	// IMP=0x00000000000661b3
...
- (void)askForParameterIfAvailable;	// IMP=0x0000000000065cf3
- (void)startWithAction:(id)arg1 parameters:(id)arg2 defaultStates:(id)arg3 prompts:(id)arg4;	// IMP=0x000000000006585d
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000657e2
