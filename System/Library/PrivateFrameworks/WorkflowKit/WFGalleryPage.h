...
+ (id)properties;	// IMP=0x00000000001101b2
+ (id)recordType;	// IMP=0x00000000001101a5
- (void).cxx_destruct;	// IMP=0x000000000010fe5b
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010f93f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010f584
- (id)subPageWithIdentifier:(id)arg1;	// IMP=0x000000000010f376
- (id)subPageMatchingName:(id)arg1;	// IMP=0x000000000010f158
- (unsigned long long)referenceActionForKey:(id)arg1;	// IMP=0x000000000010f138
