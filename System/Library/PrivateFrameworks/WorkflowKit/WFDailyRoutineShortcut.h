...
- (void).cxx_destruct;	// IMP=0x000000000020a329
...
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 bannerImage:(id)arg3 actionIcons:(id)arg4 setupFlow:(id)arg5;	// IMP=0x000000000020a1b4
