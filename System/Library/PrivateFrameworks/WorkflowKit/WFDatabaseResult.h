...
- (void).cxx_destruct;	// IMP=0x0000000000243d60
...
- (void)unregisterObserver:(id)arg1;	// IMP=0x0000000000243c20
- (void)registerObserver:(id)arg1;	// IMP=0x0000000000243afc
@property(readonly, nonatomic) NSArray *observers;
- (void)notifyObserversAboutChange:(id)arg1 fromPreviousDescriptors:(id)arg2;	// IMP=0x0000000000243816
@property(readonly, nonatomic) WFCoreDataResultState *state;
- (void)invalidateCacheWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000024366e
@property(readonly, nonatomic) NSArray *descriptors; // @synthesize descriptors=_descriptors;
@property(readonly, nonatomic) unsigned long long count;
- (id)description;	// IMP=0x000000000024334a
- (id)initWithDatabase:(id)arg1 fetchRequest:(id)arg2 relationshipKeysAffectingDescriptors:(id)arg3;	// IMP=0x0000000000243295
- (id)initWithDatabase:(id)arg1 fetchRequest:(id)arg2;	// IMP=0x00000000002431e7
- (id)initWithDatabase:(id)arg1 fetchOperation:(id)arg2 relationshipKeysAffectingDescriptors:(id)arg3;	// IMP=0x0000000000242ff3
- (id)initWithDatabase:(id)arg1 fetchOperation:(id)arg2;	// IMP=0x0000000000242f6f
- (id)initWithStaticDescriptors:(id)arg1;	// IMP=0x0000000000242e64
