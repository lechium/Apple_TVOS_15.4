...
- (void).cxx_destruct;	// IMP=0x000000000015bac5
...
- (void)cancel;	// IMP=0x000000000015b9d2
- (void)start;	// IMP=0x000000000015b375
- (id)initWithRequest:(id)arg1 records:(id)arg2 operationGroup:(id)arg3 task:(id)arg4;	// IMP=0x000000000015b27f
