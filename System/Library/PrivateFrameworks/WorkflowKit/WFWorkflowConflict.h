...
- (void).cxx_destruct;	// IMP=0x0000000000163ad2
...
- (id)resolutionKeepingLocal:(_Bool)arg1 keepingRemote:(_Bool)arg2;	// IMP=0x00000000001639a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016385d
- (id)description;	// IMP=0x0000000000163794
