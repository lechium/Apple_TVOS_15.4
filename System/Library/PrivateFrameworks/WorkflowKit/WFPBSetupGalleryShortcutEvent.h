...
- (void).cxx_destruct;	// IMP=0x00000000001991bc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000199066
- (unsigned long long)hash;	// IMP=0x0000000000198fb3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000198e4a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000198d3c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000198c79
- (void)writeTo:(id)arg1;	// IMP=0x0000000000198bbd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000198bb0
- (id)dictionaryRepresentation;	// IMP=0x0000000000198a7b
- (id)description;	// IMP=0x00000000001989cc
