...
- (void).cxx_destruct;	// IMP=0x00000000001d933c
...
- (id)description;	// IMP=0x00000000001d925e
- (id)initWithActionIdentifier:(id)arg1 serializedParameters:(id)arg2;	// IMP=0x00000000001d9196
