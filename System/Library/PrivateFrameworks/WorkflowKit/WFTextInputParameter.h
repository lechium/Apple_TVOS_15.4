...
- (void).cxx_destruct;	// IMP=0x00000000000a51da
...
- (id)parameterStateFromDialogResponse:(id)arg1;	// IMP=0x00000000000a5024
@property(readonly, nonatomic) NSString *returnKeyType;
- (id)createDialogTextFieldConfigurationWithDefaultState:(id)arg1;	// IMP=0x00000000000a4ceb
- (void)createDialogRequestWithAttribution:(id)arg1 defaultState:(id)arg2 prompt:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a4b8e
- (void)setLocalizedPlaceholder:(id)arg1;	// IMP=0x00000000000a4b4d
- (id)defaultSupportedVariableTypes;	// IMP=0x00000000000a4aed
- (id)hintForState:(id)arg1;	// IMP=0x00000000000a4ae5
- (_Bool)shouldAlignLabels;	// IMP=0x00000000000a4aac
@property(readonly, copy, nonatomic) NSString *textContentType; // @synthesize textContentType=_textContentType;
- (id)defaultSerializedRepresentation;	// IMP=0x00000000000a4900
- (id)initWithDefinition:(id)arg1;	// IMP=0x00000000000a41bd
- (Class)singleStateClass;	// IMP=0x00000000000a41ac
