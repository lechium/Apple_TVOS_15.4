...
- (id)initWithHeight:(unsigned long long)arg1 Width:(unsigned long long)arg2 NumChannels:(unsigned long long)arg3 Scale:(float)arg4 BiasR:(float)arg5 BiasG:(float)arg6 BiasB:(float)arg7 NetworkWantBGR:(_Bool)arg8;	// IMP=0x0000000000254bb1
