...
- (void).cxx_destruct;	// IMP=0x000000000046e954
...
- (int)numberOfDataPoints;	// IMP=0x000000000046e84f
- (id)dataPointAtIndex:(int)arg1;	// IMP=0x000000000046e575
- (struct vImage_Buffer)bufferWithPath:(id)arg1;	// IMP=0x000000000046e49e
- (id)initWithFolder:(id)arg1 balanceClassesForTraining:(_Bool)arg2;	// IMP=0x000000000046db2d
