...
- (void).cxx_destruct;	// IMP=0x000000000060cc93
...
- (struct _mxnetTools_imageID_t_)imageID;	// IMP=0x000000000060cb42
- (id)labels;	// IMP=0x000000000060ca47
- (id)imageData;	// IMP=0x000000000060c8de
- (_Bool)nextRecordAndError:(id *)arg1;	// IMP=0x000000000060c3f7
- (_Bool)seekRecordWithID:(struct _mxnetTools_imageID_t_ *)arg1 error:(id *)arg2;	// IMP=0x000000000060c2fd
- (id)initWithRecFile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000060c031
