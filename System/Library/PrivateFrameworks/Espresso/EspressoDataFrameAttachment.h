...
+ (id)fromDict:(id)arg1 frameStorage:(id)arg2;	// IMP=0x000000000022a8c4
- (void).cxx_destruct;	// IMP=0x000000000022a8b4
...
- (void)loadFromDict:(id)arg1 frameStorage:(id)arg2;	// IMP=0x000000000022a423
