...
- (void).cxx_destruct;	// IMP=0x00000000006048d3
...
- (id)initWithTrainingNetworkPath:(id)arg1 inferenceInputs:(id)arg2 inferenceOutputs:(id)arg3 trainingInputs:(id)arg4 trainingOutputs:(id)arg5 trainingControlVariableName:(id)arg6 withInitializer:(id)arg7 error:(id *)arg8;	// IMP=0x000000000060467f
- (id)initWithInferenceNetworkPath:(id)arg1 inferenceInputs:(id)arg2 inferenceOutputs:(id)arg3 error:(id *)arg4;	// IMP=0x00000000006045a4
- (id)initWithInferenceNetworkPath:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000604585
