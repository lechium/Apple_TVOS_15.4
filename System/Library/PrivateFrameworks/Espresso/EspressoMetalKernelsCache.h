...
- (id).cxx_construct;	// IMP=0x000000000068811e
- (void).cxx_destruct;	// IMP=0x00000000006880a5
...
- (_Bool)shouldUseTexArray;	// IMP=0x000000000068805b
- (id)kernelForFunction:(const char *)arg1 cacheString:(const char *)arg2 withConstants:(id)arg3;	// IMP=0x0000000000686efd
- (id)kernelForFunction:(const char *)arg1;	// IMP=0x0000000000686ee6
- (void)addLibraryAtPath:(id)arg1;	// IMP=0x0000000000686d43
- (void)loadLibraryNamed:(id)arg1;	// IMP=0x0000000000686b87
- (_Bool)wasSetup;	// IMP=0x0000000000686b79
- (void)lazySetup;	// IMP=0x0000000000686457
- (id)initWithDevice:(id)arg1;	// IMP=0x0000000000686322
