...
- (int)_propertyIDForProperty:(long long)arg1;	// IMP=0x000000000000483e
- (CDStruct_7ef4fb35)_propertyDescriptorForProperty:(long long)arg1;	// IMP=0x0000000000004811
- (struct __CFArray *)_localCache;	// IMP=0x00000000000047fa
- (void *)_fetchUpdatedRecord;	// IMP=0x00000000000047e0
- (struct _IMDMessageRecordStruct *)cfMessageRecord;	// IMP=0x00000000000047b8
- (unsigned long long)_cfTypeID;	// IMP=0x00000000000047ae
