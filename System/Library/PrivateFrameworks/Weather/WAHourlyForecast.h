...
+ (long long)TimeValueFromString:(id)arg1;	// IMP=0x00000000000472d3
+ (id)hourlyForecastForLocation:(id)arg1 conditions:(id)arg2 sunriseDateComponents:(id)arg3 sunsetDateComponents:(id)arg4;	// IMP=0x000000000002e767
- (void).cxx_destruct;	// IMP=0x0000000000047808
...
- (id)description;	// IMP=0x00000000000476b3
- (unsigned long long)hash;	// IMP=0x0000000000047619
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004741f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004736b
