...
+ (id)scaleFromFoundationScale:(id)arg1;	// IMP=0x0000000000019178
- (void).cxx_destruct;	// IMP=0x0000000000019695
...
- (void)addCategory:(id)arg1;	// IMP=0x000000000001913d
- (id)initWithRange:(struct _NSRange)arg1;	// IMP=0x0000000000019087
