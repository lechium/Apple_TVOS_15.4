...
+ (id)cityContainingLocation:(id)arg1 expectedName:(id)arg2 fromCities:(id)arg3;	// IMP=0x000000000001cec1
+ (id)_ISO8601Calendar;	// IMP=0x0000000000019a0e
...
- (_Bool)airQualityCanUseDefaultAttribution;	// IMP=0x0000000000021b95
@property(readonly, nonatomic) _Bool airQualityForceHideRecommendation;
- (unsigned long long)aqiDataAvailabilityStatusFromAppConfig;	// IMP=0x0000000000021573
@property(readonly, nonatomic) unsigned long long aqiDataAvailabilityStatus;
@property(readonly, nonatomic) NSString *countryCode;
@property(readonly, nonatomic) NSString *identifier;
- (_Bool)_dataIsValid;	// IMP=0x00000000000212ad
- (_Bool)_isValidLearnMoreURLForSevereEvent:(id)arg1;	// IMP=0x00000000000211a5
- (void)updateCityForSevereWeatherEvents:(id)arg1;	// IMP=0x0000000000020ec0
- (void)updateCityForModel:(id)arg1;	// IMP=0x00000000000201f5
- (void)_generateLocalizableStrings;	// IMP=0x000000000001f275
- (unsigned long long)precipitationForecast;	// IMP=0x000000000001efba
- (id)naturalLanguageDescriptionWithDescribedCondition:(out long long *)arg1;	// IMP=0x000000000001d7ea
- (id)naturalLanguageDescription;	// IMP=0x000000000001d7d6
- (long long)locationOfTime:(long long)arg1;	// IMP=0x000000000001d4c4
- (long long)primaryConditionForRange:(struct _NSRange)arg1;	// IMP=0x000000000001d2ea
- (_Bool)isDuplicateOfCity:(id)arg1;	// IMP=0x000000000001d140
- (double)distanceToLatitude:(double)arg1 longitude:(double)arg2;	// IMP=0x000000000001ce4c
- (double)distanceToLocation:(id)arg1;	// IMP=0x000000000001cd9e
- (_Bool)containsLatitude:(double)arg1 longitude:(double)arg2;	// IMP=0x000000000001cd7c
- (id)windDirectionAsString:(double)arg1;	// IMP=0x000000000001ccd0
- (void)discardDataIfNeeded;	// IMP=0x000000000001cb4c
- (_Bool)populateWithDataFromCity:(id)arg1;	// IMP=0x000000000001c741
@property(readonly, nonatomic) NSString *locationID;
@property(nonatomic) double longitude;
@property(nonatomic) double latitude;
- (struct CLLocationCoordinate2D)coordinate;	// IMP=0x000000000001c407
- (void)setCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x000000000001c381
@property(nonatomic) long long conditionCode; // @synthesize conditionCode=_conditionCode;
- (id)getName;	// IMP=0x000000000001be90
@property(readonly, nonatomic) NSString *weatherLocationCitationName;
- (id)cityAndState;	// IMP=0x000000000001bca8
- (_Bool)isUpdatingOrNoData;	// IMP=0x000000000001bc88
- (_Bool)_isUpdating;	// IMP=0x000000000001bc2e
- (void)cityDidFinishUpdatingWithError:(id)arg1;	// IMP=0x000000000001b87b
- (void)clearForecasts;	// IMP=0x000000000001b72a
- (void)updateTimeZoneWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001b247
- (void)_updateTimeZone;	// IMP=0x000000000001b20e
@property(readonly, nonatomic) _Bool timeZoneIsFresh;
- (void)_notifyDidStartWeatherUpdate;	// IMP=0x000000000001afb4
- (_Bool)update;	// IMP=0x000000000001adc3
- (void)localWeatherDidBeginUpdate;	// IMP=0x000000000001ac31
- (unsigned long long)weatherDataAge;	// IMP=0x000000000001aae4
@property(nonatomic) _Bool isDay; // @synthesize isDay=_isDay;
- (long long)timeDigit;	// IMP=0x000000000001a8d5
...
- (id)displayName;	// IMP=0x000000000001a72a
- (void)_clearAutoUpdateTimer;	// IMP=0x000000000001a633
- (void)removeUpdateObserver:(id)arg1;	// IMP=0x000000000001a5c1
- (void)addUpdateObserver:(id)arg1;	// IMP=0x000000000001a4ab
- (id)detailedDescription;	// IMP=0x0000000000019efc
@property(readonly, copy) NSString *description;
- (id)dictionaryRepresentation;	// IMP=0x0000000000019d01
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000019bd6
- (void)dealloc;	// IMP=0x0000000000019b98
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000019b5e
- (id)init;	// IMP=0x0000000000019a7d
