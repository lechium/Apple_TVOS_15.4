...
- (void).cxx_destruct;	// IMP=0x000000000002e5d1
...
- (void)_mapReferralLinks;	// IMP=0x000000000002dc84
- (void)_determineSunriseAndSunset;	// IMP=0x000000000002d791
- (void)_failWithError:(id)arg1;	// IMP=0x000000000002d6ee
- (_Bool)shouldRequestChangeInConditions;	// IMP=0x000000000002d5fd
- (void)cancel;	// IMP=0x000000000002d534
- (void)main;	// IMP=0x000000000002beaf
- (_Bool)_needsGeolocation;	// IMP=0x000000000002bd06
- (id)initWithLocation:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000000002bc31
- (id)initWithCity:(id)arg1 withUnits:(int)arg2 requestOptions:(id)arg3 canGeocode:(_Bool)arg4 onConnection:(id)arg5;	// IMP=0x000000000002baf6
- (id)initWithCity:(id)arg1 withUnits:(int)arg2 canGeocode:(_Bool)arg3 onConnection:(id)arg4;	// IMP=0x000000000002bace
- (id)initWithCity:(id)arg1 withUnits:(int)arg2 onConnection:(id)arg3;	// IMP=0x000000000002bab3
- (id)initWithCity:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000000002ba9c
