...
- (void).cxx_destruct;	// IMP=0x0000000000041591
...
- (id)description;	// IMP=0x00000000000410d6
- (unsigned long long)hash;	// IMP=0x0000000000041092
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000040c94
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000409ec
