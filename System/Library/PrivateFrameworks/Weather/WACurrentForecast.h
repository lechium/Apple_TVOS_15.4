...
+ (id)currentForecastForLocation:(id)arg1 conditions:(id)arg2;	// IMP=0x00000000000377ba
- (void).cxx_destruct;	// IMP=0x00000000000481c2
...
- (unsigned long long)hash;	// IMP=0x0000000000048045
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000047c50
- (id)description;	// IMP=0x0000000000047a7d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004783b
