...
+ (id)defaultFullKeyboardAccessOptions;	// IMP=0x000000000000b807
+ (id)defaultSpeakScreenOptions;	// IMP=0x000000000000b6af
+ (id)defaultSwitchControlOptions;	// IMP=0x000000000000b5e6
+ (id)voiceOverOptionsIncludingElementsFromOpaqueProviders:(_Bool)arg1 honorsGroups:(_Bool)arg2;	// IMP=0x000000000000b4a5
+ (id)defaultVoiceOverOptionsHonoringGroups;	// IMP=0x000000000000b48c
+ (id)defaultVoiceOverOptions;	// IMP=0x000000000000b476
+ (id)options;	// IMP=0x000000000000b464
- (void).cxx_destruct;	// IMP=0x000000000000bc5f
...
- (id)description;	// IMP=0x000000000000b8dc
- (id)init;	// IMP=0x000000000000b871
