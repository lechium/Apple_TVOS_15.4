...
- (void).cxx_destruct;	// IMP=0x0000000000069139
...
- (void)_processSelectionRects;	// IMP=0x0000000000068940
- (void)updateVisualRects;	// IMP=0x00000000000688e6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000686b8
