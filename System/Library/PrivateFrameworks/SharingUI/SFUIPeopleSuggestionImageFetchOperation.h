...
- (void).cxx_destruct;	// IMP=0x000000000001fcdd
@property(retain) UIImage *image; // @synthesize image=_image;
- (void)main;	// IMP=0x000000000001f932
@property(readonly, nonatomic) NSString *identifier;
- (id)initWithPeopleSuggestion:(id)arg1 targetSize:(struct CGSize)arg2 layoutDirection:(long long)arg3;	// IMP=0x000000000001f87d
