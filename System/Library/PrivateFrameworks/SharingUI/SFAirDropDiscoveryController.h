...
- (void).cxx_destruct;	// IMP=0x000000000000ec52
...
- (id)discoverableModeToString:(long long)arg1;	// IMP=0x000000000000ebc4
- (long long)operationDiscoverableModeToInteger:(id)arg1;	// IMP=0x000000000000eb1d
@property long long discoverableMode;
- (id)discoverableModeAlertController;	// IMP=0x000000000000e2e0
- (void)updateAlertControllerTitle;	// IMP=0x000000000000e181
- (void)wirelessSettingsDidChange:(id)arg1;	// IMP=0x000000000000e16f
- (void)invalidate;	// IMP=0x000000000000e11b
- (void)dealloc;	// IMP=0x000000000000e0dd
...
- (void)handleOperationCallback:(struct __SFOperation *)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x000000000000dcdc
- (id)init;	// IMP=0x000000000000dba0
