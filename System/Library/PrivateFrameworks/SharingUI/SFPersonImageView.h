...
+ (id)darkenImage:(id)arg1 toLevel:(double)arg2;	// IMP=0x0000000000004bec
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000004ac0
- (void)setImage:(id)arg1;	// IMP=0x0000000000004a7f
- (void)layoutSubviews;	// IMP=0x000000000000490a
- (id)initWithImage:(id)arg1 isSquare:(_Bool)arg2;	// IMP=0x0000000000004886
