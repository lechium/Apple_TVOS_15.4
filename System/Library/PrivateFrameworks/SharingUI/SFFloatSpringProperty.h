...
+ (void)_withoutAnimation:(CDUnknownBlockType)arg1;	// IMP=0x000000000000c9fd
@property(nonatomic) _Bool tracking; // @synthesize tracking=_tracking;
@property(nonatomic) _Bool primed; // @synthesize primed=_primed;
- (double)projectForTime:(double)arg1;	// IMP=0x000000000000c9b4
- (double)projectForDeceleration:(double)arg1;	// IMP=0x000000000000c94f
- (CDStruct_aa45ca86)parametersForTransitionFromState:(int)arg1 toState:(int)arg2;	// IMP=0x000000000000c8f8
- (void)setTrackingDampingRatio:(double)arg1 response:(double)arg2;	// IMP=0x000000000000c8da
- (void)setDampingRatio:(double)arg1 response:(double)arg2;	// IMP=0x000000000000c8bc
@property(nonatomic) double output;
@property(nonatomic) double input;
- (id)init;	// IMP=0x000000000000c590
