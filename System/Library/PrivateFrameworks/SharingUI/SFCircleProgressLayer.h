...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0000000000009a75
- (void).cxx_destruct;	// IMP=0x0000000000009dd5
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000009ae7
- (id)initWithLayer:(id)arg1;	// IMP=0x00000000000098a5
- (id)init;	// IMP=0x0000000000009770
