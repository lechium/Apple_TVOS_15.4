...
- (void).cxx_destruct;	// IMP=0x00000000000392cb
...
- (void)dealloc;	// IMP=0x000000000003925b
- (id)initWithName:(id)arg1 queue:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x0000000000039065
