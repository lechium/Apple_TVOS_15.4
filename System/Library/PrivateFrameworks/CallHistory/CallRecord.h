...
+ (id)fetchRequest;	// IMP=0x000000000001c528
...
- (_Bool)supportsJunkConfidence;	// IMP=0x000000000000a077
@property(readonly, nonatomic) _Bool supportsHandleType;
@property(readonly, nonatomic) _Bool supportsCallCategory;
- (id)compositeVerificationStatusForContext:(id)arg1;	// IMP=0x0000000000009f1d
- (id)compositeServiceProviderForContext:(id)arg1;	// IMP=0x0000000000009e7f
- (id)compositeRemoteParticipantHandlesForContext:(id)arg1;	// IMP=0x0000000000009bf1
- (id)compositeParticipantGroupUUIDForContext:(id)arg1;	// IMP=0x0000000000009bad
- (id)compositeOutgoingLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x0000000000009b69
- (id)compositeLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x0000000000009b25
- (id)compositeJunkConfidenceForContext:(id)arg1;	// IMP=0x0000000000009ac5
- (id)compositeHandleTypeForContext:(id)arg1;	// IMP=0x0000000000009a90
- (id)compositeCallCategoryForContext:(id)arg1;	// IMP=0x00000000000099dc
