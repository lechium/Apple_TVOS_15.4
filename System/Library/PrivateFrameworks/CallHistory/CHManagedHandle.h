...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000000000d0bc
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000000000ce53
+ (id)fetchRequest;	// IMP=0x000000000000ee83
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000d38e
