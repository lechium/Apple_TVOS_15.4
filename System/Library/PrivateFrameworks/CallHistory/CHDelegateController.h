...
- (void)enumerateDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000fb11
- (void)removeDelegate:(id)arg1;	// IMP=0x000000000000fa85
- (void)addDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x000000000000f9d7
- (id)init;	// IMP=0x000000000000f96a
