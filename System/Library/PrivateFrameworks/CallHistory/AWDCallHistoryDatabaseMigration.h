...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002b1fa
- (unsigned long long)hash;	// IMP=0x000000000002b163
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002b041
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002af77
- (void)copyTo:(id)arg1;	// IMP=0x000000000002aed0
- (void)writeTo:(id)arg1;	// IMP=0x000000000002ae01
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002adf4
- (id)dictionaryRepresentation;	// IMP=0x000000000002a7af
- (id)description;	// IMP=0x000000000002a700
