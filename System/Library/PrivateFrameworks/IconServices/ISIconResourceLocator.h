...
+ (id)genericIconrResourceLocator;	// IMP=0x0000000000028de8
+ (id)resourceLocatorWithType:(id)arg1;	// IMP=0x0000000000028d9b
+ (id)resourceLocatorWithLSIconResourceLocator:(id)arg1;	// IMP=0x0000000000028cac
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000028ca4
...
- (id)description;	// IMP=0x0000000000029199
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000028f1e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000028e89
