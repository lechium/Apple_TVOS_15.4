...
+ (id)sharedInstance;	// IMP=0x000000000000ffba
- (void).cxx_destruct;	// IMP=0x00000000000100c8
- (id)makeResourceProvider;	// IMP=0x00000000000100b6
@property(readonly) ISResourceProvider *resourceProvider; // @synthesize resourceProvider=_resourceProvider;
- (id)init;	// IMP=0x000000000001000f
