...
- (void).cxx_destruct;	// IMP=0x000000000001d478
...
- (_Bool)removeUnitForUUID:(id)arg1;	// IMP=0x000000000001d201
- (id)addUnitWithData:(id)arg1;	// IMP=0x000000000001d015
- (_Bool)writeStoreUnit:(id)arg1;	// IMP=0x000000000001c9ff
- (id)unitForUUID:(id)arg1;	// IMP=0x000000000001c8fe
- (id)initWithURL:(id)arg1;	// IMP=0x000000000001c893
