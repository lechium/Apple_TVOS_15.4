...
- (void).cxx_destruct;	// IMP=0x00000000000200f4
...
- (void)iconManager:(id)arg1 didInvalidateIcons:(id)arg2;	// IMP=0x000000000001ffd6
- (id)initWithIcon:(id)arg1;	// IMP=0x000000000001feb3
- (id)init;	// IMP=0x000000000001fe9f
