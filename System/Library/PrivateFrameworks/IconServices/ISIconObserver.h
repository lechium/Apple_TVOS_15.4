...
- (void).cxx_destruct;	// IMP=0x000000000003a4bb
@property(readonly) __weak id <ISIconObserverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)iconManager:(id)arg1 didInvalidateIcons:(id)arg2;	// IMP=0x000000000003a449
- (void)dealloc;	// IMP=0x000000000003a3d4
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000003a32c
