...
+ (id)customRecipeWithInfo:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000022638
- (void).cxx_destruct;	// IMP=0x0000000000022b0c
...
- (id)resourceNamed:(id)arg1;	// IMP=0x000000000002295c
- (id)initWithRecipe:(id)arg1 bitmapResources:(id)arg2 symbolResources:(id)arg3 bundle:(id)arg4;	// IMP=0x0000000000022855
