...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000003ff3
+ (id)defaultStyleDescriptor;	// IMP=0x0000000000003f9e
- (void).cxx_destruct;	// IMP=0x00000000000042f6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000414e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000040c5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003ffb
