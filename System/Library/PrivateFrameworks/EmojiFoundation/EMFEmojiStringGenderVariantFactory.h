...
- (void).cxx_destruct;	// IMP=0x000000000000b5f8
...
- (id)stringForGenderVariant:(int)arg1;	// IMP=0x000000000000b2f6
- (id)initWithSourceString:(id)arg1 gender:(int)arg2;	// IMP=0x000000000000b278
