...
+ (long long)activityCategory;	// IMP=0x0000000000060ca0
- (void).cxx_destruct;	// IMP=0x0000000000061260
- (id)init;	// IMP=0x0000000000061200
- (void)performActivity;	// IMP=0x00000000000611d0
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x0000000000061000
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000060e90
