...
- (void).cxx_destruct;	// IMP=0x000000000034e850
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000034e760
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000034e740
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000034e710
