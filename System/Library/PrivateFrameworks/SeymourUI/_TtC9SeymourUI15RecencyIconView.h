...
- (void).cxx_destruct;	// IMP=0x00000000000ba9e0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ba990
- (void)didMoveToSuperview;	// IMP=0x00000000000ba960
- (void)layoutSubviews;	// IMP=0x00000000000ba790
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ba630
