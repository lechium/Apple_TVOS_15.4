...
+ (id)descriptorForRequiredKeys;	// IMP=0x0000000000008f34
- (void).cxx_destruct;	// IMP=0x000000000000915b
@property(readonly, nonatomic) UIView *view; // @synthesize view;
- (void)setContact:(id)arg1;	// IMP=0x0000000000009076
- (id)init;	// IMP=0x0000000000008fb6
