...
- (void).cxx_destruct;	// IMP=0x00000000002084d0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000208470
- (void)didTapOptOutButton;	// IMP=0x00000000002083f0
- (void)didTapOptInButton;	// IMP=0x00000000002083e0
- (void)doNotSharePressed:(id)arg1;	// IMP=0x0000000000208330
- (void)sharePressed:(id)arg1;	// IMP=0x0000000000208320
- (void)viewDidLoad;	// IMP=0x00000000002082f0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000207bb0
