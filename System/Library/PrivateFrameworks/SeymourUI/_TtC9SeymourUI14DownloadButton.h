...
- (void).cxx_destruct;	// IMP=0x0000000000523ee0
- (void)contentSizeCategoryChanged:(id)arg1;	// IMP=0x0000000000522e30
- (void)tintColorDidChange;	// IMP=0x0000000000522890
- (void)layoutSubviews;	// IMP=0x0000000000522680
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005223a0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000522370
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x0000000000521920
