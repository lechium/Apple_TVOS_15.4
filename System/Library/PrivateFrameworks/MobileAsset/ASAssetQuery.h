...
+ (id)queryPredicateForProperties:(id)arg1;	// IMP=0x000000000000f05f
...
- (void)stopQuery;	// IMP=0x000000000000f602
- (void)startQuery:(CDUnknownBlockType)arg1;	// IMP=0x000000000000f563
- (id)runQueryAndReturnError:(id *)arg1;	// IMP=0x000000000000f52e
- (id)runQueryForInfoReturnError:(id *)arg1;	// IMP=0x000000000000f242
- (void)dealloc;	// IMP=0x000000000000f1cc
- (id)initWithAssetType:(id)arg1 sessionIdentifier:(id)arg2;	// IMP=0x000000000000f144
- (id)initWithAssetType:(id)arg1;	// IMP=0x000000000000f130
