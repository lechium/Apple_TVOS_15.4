...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000165e3
...
- (void)logOptions;	// IMP=0x0000000000016cb7
- (id)description;	// IMP=0x0000000000016b91
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016987
- (void)dealloc;	// IMP=0x000000000001693d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016643
- (id)init;	// IMP=0x00000000000165eb
