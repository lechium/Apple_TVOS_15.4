...
- (id).cxx_construct;	// IMP=0x0000000002009190
- (void).cxx_destruct;	// IMP=0x0000000002009180
- (_Bool)multipath;	// IMP=0x0000000002009170
- (_Bool)constrained;	// IMP=0x0000000002009160
- (_Bool)expensive;	// IMP=0x0000000002009150
- (_Bool)cellular;	// IMP=0x0000000002009140
...
- (void)dealloc;	// IMP=0x0000000002008cd0
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x0000000002008c10
