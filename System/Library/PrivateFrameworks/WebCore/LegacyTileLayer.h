...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000a66340
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000a656d0
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x0000000000a65670
- (void)layoutSublayers;	// IMP=0x0000000000a655b0
- (void)setNeedsDisplayInRect:(struct CGRect)arg1;	// IMP=0x0000000000a65560
