...
- (id).cxx_construct;	// IMP=0x0000000002009390
- (void).cxx_destruct;	// IMP=0x0000000002009370
@property(readonly, copy) NSArray *transactionMetrics; // @dynamic transactionMetrics;
- (void)dealloc;	// IMP=0x0000000002009250
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x00000000020091d0
