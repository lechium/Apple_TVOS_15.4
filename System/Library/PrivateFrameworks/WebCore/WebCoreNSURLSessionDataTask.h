...
- (id).cxx_construct;	// IMP=0x000000000200d7e0
- (void).cxx_destruct;	// IMP=0x000000000200d6c0
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x000000000200d5c0
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x000000000200d520
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x000000000200d480
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x000000000200d100
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x000000000200ccc0
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x000000000200cbe0
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x000000000200cb90
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x000000000200c7a0
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x000000000200c790
- (id)_timingData;	// IMP=0x000000000200c780
- (void)dealloc;	// IMP=0x000000000200c600
- (void)resume;	// IMP=0x000000000200c560
- (void)suspend;	// IMP=0x000000000200c4c0
- (void)cancel;	// IMP=0x000000000200c3f0
...
- (void)_cancel;	// IMP=0x000000000200c170
- (void)_restart;	// IMP=0x000000000200bbe0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000200bbd0
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x000000000200baa0
