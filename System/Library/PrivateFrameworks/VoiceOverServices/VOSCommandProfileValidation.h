...
+ (id)keyboardShortcutAssignedToOtherCommandValidation:(id)arg1;	// IMP=0x000000000001bdb0
+ (id)gestureAssignedToOtherCommandValidation:(id)arg1;	// IMP=0x000000000001bd44
+ (id)successfulValidation;	// IMP=0x000000000001bd19
- (void).cxx_destruct;	// IMP=0x000000000001c013
...
- (id)initWithType:(long long)arg1;	// IMP=0x000000000001bcdc
- (id)init;	// IMP=0x000000000001bcc8
