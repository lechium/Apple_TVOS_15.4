...
+ (id)resolverForCurrentHost;	// IMP=0x000000000000c9be
+ (unsigned long long)currentHost;	// IMP=0x000000000000c981
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000cfaf
- (id)description;	// IMP=0x000000000000ceb2
...
- (id)resolverWithScreenreaderModeVariant:(id)arg1;	// IMP=0x000000000000ca08
