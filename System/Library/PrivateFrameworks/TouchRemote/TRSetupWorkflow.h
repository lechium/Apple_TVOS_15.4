...
+ (void)initialize;	// IMP=0x0000000000009082
- (void).cxx_destruct;	// IMP=0x000000000000aae4
...
- (void)_releaseHandlers;	// IMP=0x000000000000a93d
- (void)_abortSetupWithErrorCode:(long long)arg1 userInfo:(id)arg2;	// IMP=0x000000000000a5ed
- (void)_performCompletionOperation;	// IMP=0x000000000000a316
- (void)_performAuthenticationOperation;	// IMP=0x000000000000a0c1
- (void)_performActivationOperation;	// IMP=0x0000000000009e3d
- (void)_performNetworkOperation;	// IMP=0x0000000000009b65
- (void)_performConfigurationOperation;	// IMP=0x000000000000984b
- (void)_performHandshakeOperation;	// IMP=0x0000000000009743
- (void)cancel;	// IMP=0x0000000000009669
- (void)start;	// IMP=0x000000000000915a
- (id)initWithNearbyDevice:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000000000909f
