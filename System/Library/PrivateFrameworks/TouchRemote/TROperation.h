...
+ (id)userCancelledError;	// IMP=0x0000000000011bde
- (void).cxx_destruct;	// IMP=0x000000000001204f
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000011ea0
- (void)finishWithResult:(id)arg1;	// IMP=0x0000000000011d8f
- (void)execute;	// IMP=0x0000000000011d89
- (void)main;	// IMP=0x0000000000011c79
- (id)initWithSession:(id)arg1;	// IMP=0x0000000000011c0b
