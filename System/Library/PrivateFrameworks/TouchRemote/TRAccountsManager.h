...
+ (id)sharedInstance;	// IMP=0x0000000000001f98
- (void).cxx_destruct;	// IMP=0x00000000000023bb
@property(retain, nonatomic) ACAccountStore *iCloudAccountStore; // @synthesize iCloudAccountStore=_iCloudAccountStore;
- (id)accountTypesWithDefaultAccountID:(id)arg1;	// IMP=0x0000000000002254
- (id)defaultAccountIDForAuthenticationAccountType:(unsigned long long)arg1;	// IMP=0x0000000000002191
