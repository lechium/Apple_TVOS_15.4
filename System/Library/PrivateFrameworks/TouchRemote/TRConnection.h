...
- (void)invalidate;	// IMP=0x00000000000198f3
- (void)sendResponse:(id)arg1;	// IMP=0x0000000000019893
- (void)sendRequest:(id)arg1;	// IMP=0x0000000000019833
- (void)sendEvent:(id)arg1;	// IMP=0x00000000000197d3
