...
+ (id)dataClassMigratorForBundleAtPath:(id)arg1;	// IMP=0x0000000000002883
- (void).cxx_destruct;	// IMP=0x0000000000002b7b
...
- (_Bool)performMigration;	// IMP=0x000000000000287b
