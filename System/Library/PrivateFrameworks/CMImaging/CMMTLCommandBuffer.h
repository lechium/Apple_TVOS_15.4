...
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000000711c
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000000000070cc
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000007097
- (void)commit;	// IMP=0x0000000000006c0e
- (id)initWithCMMTLCommandQueue:(id)arg1 unretained:(_Bool)arg2;	// IMP=0x0000000000006ae5
- (void)waitUntilScheduled;	// IMP=0x0000000000006acf
- (void)waitUntilCompleted;	// IMP=0x0000000000006ab9
