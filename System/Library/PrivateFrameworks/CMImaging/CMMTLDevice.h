...
@class FigMetalExecutionStatus, InterceptConfig, MTLTargetDeviceArchitecture, NSArray, NSDictionary, NSString;
...
- (void).cxx_destruct;	// IMP=0x0000000000006581
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000064d5
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000006485
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000006450
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x00000000000063f8
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x00000000000063c5
- (id)newCommandQueue;	// IMP=0x0000000000006397
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x0000000000006296
