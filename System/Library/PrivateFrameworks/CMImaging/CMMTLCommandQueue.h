...
- (void).cxx_destruct;	// IMP=0x0000000000006a78
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000069e7
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000006997
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000006962
@property(readonly) id <MTLDevice> device;
- (id)commandBuffer;	// IMP=0x000000000000691c
- (id)commandBufferWithUnretainedReferences;	// IMP=0x00000000000068e1
- (id)initWithCMMTLDevice:(id)arg1 descriptor:(id)arg2;	// IMP=0x00000000000067bd
- (id)initWithCMMTLDevice:(id)arg1 maxCommandBufferCount:(unsigned long long)arg2;	// IMP=0x00000000000066b0
- (id)initWithCMMTLDevice:(id)arg1;	// IMP=0x00000000000065a9
