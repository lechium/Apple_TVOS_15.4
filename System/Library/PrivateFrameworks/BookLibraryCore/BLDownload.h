...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001eec4
- (void).cxx_destruct;	// IMP=0x0000000000020479
...
- (id)description;	// IMP=0x000000000001fd69
- (double)transferProgressFraction;	// IMP=0x000000000001fcd2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f502
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001f25a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001eecc
