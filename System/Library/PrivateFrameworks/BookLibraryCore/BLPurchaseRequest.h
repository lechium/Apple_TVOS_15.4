...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000256ea
+ (id)requestWithPermlink:(id)arg1 title:(id)arg2;	// IMP=0x00000000000255a0
+ (id)requestWithBuyParameters:(id)arg1 storeIdentifier:(id)arg2;	// IMP=0x00000000000254d7
- (void).cxx_destruct;	// IMP=0x000000000002642c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000026028
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000025caf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000256f2
