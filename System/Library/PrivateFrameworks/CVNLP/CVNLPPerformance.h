...
- (void).cxx_destruct;	// IMP=0x0000000000031530
...
- (void)run:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000031030
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000030f20
