...
- (void).cxx_destruct;	// IMP=0x0000000000009c60
...
- (id)initWithString:(id)arg1 score:(id)arg2 activationRange:(struct _NSRange)arg3 hasPrecedingSpace:(_Bool)arg4;	// IMP=0x0000000000009b10
- (id)initWithString:(id)arg1 score:(id)arg2 activationRange:(struct _NSRange)arg3 terminatingCharacter:(id)arg4;	// IMP=0x0000000000009ad0
- (id)initWithString:(id)arg1 score:(id)arg2 alignmentScore:(id)arg3 activationRange:(struct _NSRange)arg4 terminatingCharacter:(id)arg5;	// IMP=0x00000000000099e0
