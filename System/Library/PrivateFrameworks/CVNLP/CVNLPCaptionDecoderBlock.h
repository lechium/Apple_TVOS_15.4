...
- (id).cxx_construct;	// IMP=0x000000000003fa10
- (void).cxx_destruct;	// IMP=0x000000000003f920
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003eee0
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ed40
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003eb20
- (void)copyOutputState:(id)arg1;	// IMP=0x000000000003e2f0
- (void)copyInputState:(id)arg1;	// IMP=0x000000000003ddb0
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x000000000003ae80
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x0000000000039bb0
- (void)dealloc;	// IMP=0x0000000000039a90
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x0000000000039870
