...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000043d70
- (void).cxx_destruct;	// IMP=0x0000000000043dc0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000043b40
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000439b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000043730
- (unsigned long long)hash;	// IMP=0x0000000000043620
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000043610
- (id)description;	// IMP=0x0000000000043490
- (id)initWithConversationIdentifier:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 result:(long long)arg4;	// IMP=0x0000000000043360
