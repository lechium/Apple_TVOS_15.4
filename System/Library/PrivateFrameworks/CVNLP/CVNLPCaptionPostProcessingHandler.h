...
- (void).cxx_destruct;	// IMP=0x000000000001b900
...
- (id)postProcessCaptions:(id)arg1 visionObservations:(id)arg2;	// IMP=0x000000000001b810
- (id)initWithOptions:(id)arg1 runtimeParameters:(id)arg2;	// IMP=0x000000000001b740
