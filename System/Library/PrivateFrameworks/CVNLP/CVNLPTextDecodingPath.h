...
+ (CDUnknownBlockType)defaultPathScoringFunction;	// IMP=0x0000000000037db0
+ (CDUnknownBlockType)defaultPathScoringFunctionForLanguageResourceBundle:(id)arg1;	// IMP=0x0000000000037af0
...
- (id)initWithCharacterLanguageModelLogProbability:(double)arg1 wordLanguageModelLogProbability:(double)arg2 lexiconScore:(double)arg3 string:(id)arg4;	// IMP=0x0000000000037a50
- (id)init;	// IMP=0x00000000000379e0
