...
+ (id)predicateForModeAssertionInvalidationsWithAssertionClientIdentifiers:(id)arg1;	// IMP=0x000000000008eb84
- (id)resolveWithExpectedRemoteDeviceIdentifier:(id)arg1 localDeviceIdentifier:(id)arg2 remoteDeviceIdentifier:(id)arg3;	// IMP=0x000000000000874f
