...
- (void).cxx_destruct;	// IMP=0x0000000000036fd6
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036f54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036f49
- (id)_initWithInterruptionInvalidationAssertionUUID:(id)arg1 assertionUpdateClientIdentifiers:(id)arg2 activeAssertionUpdateClientIdentifiers:(id)arg3 wantsStateUpdates:(_Bool)arg4 wantsSettingsUpdates:(_Bool)arg5 wantsModeUpdates:(_Bool)arg6 wantsActiveModeUpdates:(_Bool)arg7 wantsGlobalConfigurationUpdates:(_Bool)arg8 wantsMeDeviceStateUpdates:(_Bool)arg9;	// IMP=0x0000000000036d8e
- (id)_initWithDetails:(id)arg1;	// IMP=0x0000000000036c30
- (id)init;	// IMP=0x0000000000036c1c
