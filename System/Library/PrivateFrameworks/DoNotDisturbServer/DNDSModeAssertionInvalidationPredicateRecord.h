...
+ (id)recordForInvalidationPredicate:(id)arg1;	// IMP=0x000000000007131b
+ (id)recordForDictionary:(id)arg1 keys:(const CDStruct_c4e2040f *)arg2;	// IMP=0x000000000004ff88
- (void).cxx_destruct;	// IMP=0x00000000000717bd
...
- (id)object;	// IMP=0x000000000007153f
- (id)dictionaryWithKeys:(const CDStruct_c4e2040f *)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000501ea
