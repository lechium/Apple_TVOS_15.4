...
+ (id)newWithDictionaryRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x000000000007ac23
+ (id)migrateDictionaryRepresentation:(id)arg1 fromVersionNumber:(unsigned long long)arg2 toVersionNumber:(unsigned long long)arg3;	// IMP=0x000000000007a986
- (void).cxx_destruct;	// IMP=0x000000000007b516
...
- (id)dictionaryRepresentationWithContext:(id)arg1;	// IMP=0x000000000007b241
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007a958
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007a94d
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000079fec
@property(readonly) unsigned long long hash;
- (id)_initWithContactIdentifier:(id)arg1 firstName:(id)arg2 middleName:(id)arg3 lastName:(id)arg4 nickName:(id)arg5 organizationName:(id)arg6 phoneNumbers:(id)arg7 emailAddresses:(id)arg8;	// IMP=0x0000000000079c88
- (id)_initWithRecord:(id)arg1;	// IMP=0x0000000000079b0c
- (id)init;	// IMP=0x0000000000079af8
