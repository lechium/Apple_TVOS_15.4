...
+ (id)newWithDictionaryRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x00000000000385ec
- (id)dictionaryRepresentationWithContext:(id)arg1;	// IMP=0x00000000000386ac
