...
+ (id)recordForAssertionStore:(id)arg1;	// IMP=0x000000000006e9c1
+ (id)recordForDictionary:(id)arg1 keys:(const CDStruct_c4e2040f *)arg2;	// IMP=0x000000000004dc4c
...
- (id)object;	// IMP=0x000000000006ebc7
- (id)dictionaryWithKeys:(const CDStruct_c4e2040f *)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000004e028
