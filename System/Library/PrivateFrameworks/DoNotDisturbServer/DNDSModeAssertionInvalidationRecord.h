...
+ (id)recordForInvalidation:(id)arg1;	// IMP=0x00000000000705ae
+ (id)recordForDictionary:(id)arg1 keys:(const CDStruct_c4e2040f *)arg2;	// IMP=0x000000000004f380
- (void).cxx_destruct;	// IMP=0x0000000000070afc
...
- (id)object;	// IMP=0x0000000000070837
- (id)dictionaryWithKeys:(const CDStruct_c4e2040f *)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000004f5f3
