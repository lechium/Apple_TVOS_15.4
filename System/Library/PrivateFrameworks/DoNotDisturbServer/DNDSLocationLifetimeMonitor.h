...
- (void)_queue_refreshMonitorForDate:(id)arg1;	// IMP=0x000000000001b3ba
- (void)meDeviceService:(id)arg1 didReceiveMeDeviceStateUpdate:(id)arg2;	// IMP=0x000000000001b23c
- (void)locationManager:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000000001b0b0
- (void)locationManager:(id)arg1 didUpdateLocations:(id)arg2;	// IMP=0x000000000001af24
- (void)locationManager:(id)arg1 didDetermineState:(long long)arg2 forRegion:(id)arg3;	// IMP=0x000000000001ad8e
- (void)locationManager:(id)arg1 monitoringDidFailForRegion:(id)arg2 withError:(id)arg3;	// IMP=0x000000000001abe6
@property(readonly, nonatomic) unsigned long long availableRegions;
- (void)refreshMonitorForDate:(id)arg1;	// IMP=0x000000000001aad1
@property(readonly, copy, nonatomic) NSArray *activeLifetimeAssertionUUIDs;
- (id)initWithMeDeviceService:(id)arg1;	// IMP=0x000000000001a7ca
