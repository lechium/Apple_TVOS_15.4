...
+ (id)recordForAssertionLifetime:(id)arg1;	// IMP=0x000000000006f7ff
+ (id)recordForDictionary:(id)arg1 keys:(const CDStruct_c4e2040f *)arg2;	// IMP=0x000000000004eac5
- (void).cxx_destruct;	// IMP=0x0000000000070368
...
- (id)object;	// IMP=0x000000000006fd60
- (id)dictionaryWithKeys:(const CDStruct_c4e2040f *)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000004ede5
