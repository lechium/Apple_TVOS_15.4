...
+ (id)recordForInvalidationRequest:(id)arg1;	// IMP=0x0000000000070c6c
+ (id)recordForDictionary:(id)arg1 keys:(const CDStruct_c4e2040f *)arg2;	// IMP=0x000000000004f9ce
- (void).cxx_destruct;	// IMP=0x00000000000712bc
...
- (id)object;	// IMP=0x0000000000070f4c
- (id)dictionaryWithKeys:(const CDStruct_c4e2040f *)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000004fc88
