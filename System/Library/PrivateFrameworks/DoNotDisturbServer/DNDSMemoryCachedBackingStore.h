...
- (void).cxx_destruct;	// IMP=0x000000000001260d
@property(nonatomic) __weak id <DNDSCachedBackingStoreDelegate> delegate; // @synthesize delegate=_delegate;
- (id)backingStore:(id)arg1 migrateDictionaryRepresentation:(id)arg2 fromVersionNumber:(unsigned long long)arg3 toVersionNumber:(unsigned long long)arg4;	// IMP=0x000000000001253a
- (void)purgeCache;	// IMP=0x0000000000012506
- (unsigned long long)writeRecord:(id)arg1 writePartition:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000000012455
- (unsigned long long)writeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001243b
- (id)readRecordWithError:(id *)arg1;	// IMP=0x00000000000123d3
- (id)initWithUnderlyingBackingStore:(id)arg1;	// IMP=0x000000000001234e
