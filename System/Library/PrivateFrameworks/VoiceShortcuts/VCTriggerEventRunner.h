...
- (void).cxx_destruct;	// IMP=0x0000000000003c95
...
- (void)logPowerLogEventForConfiguredTrigger:(id)arg1 workflowReference:(id)arg2;	// IMP=0x00000000000035f2
- (void)runCoordinator:(id)arg1 didFinishRunningWorkflowWithError:(id)arg2 runningContext:(id)arg3 cancelled:(_Bool)arg4;	// IMP=0x00000000000034a7
- (_Bool)isRunningWorkflowWithIdentifier:(id)arg1;	// IMP=0x0000000000003430
- (_Bool)startRunningWorkflow:(id)arg1 forTrigger:(id)arg2 eventInfo:(id)arg3;	// IMP=0x0000000000002437
- (id)initWithDatabaseProvider:(id)arg1 delegate:(id)arg2 runCoordinator:(id)arg3;	// IMP=0x0000000000002278
