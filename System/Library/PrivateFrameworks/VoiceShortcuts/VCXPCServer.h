...
- (void).cxx_destruct;	// IMP=0x000000000005759f
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000056eef
...
- (id)initWithXPCListener:(id)arg1 databaseProvider:(id)arg2 triggerRegistrar:(id)arg3 syncCoordinator:(id)arg4 syncDataEndpoint:(id)arg5 runCoordinator:(id)arg6;	// IMP=0x0000000000056bc8
- (id)initWithUnsecuredAnonymousListenerAndDatabaseProvider:(id)arg1;	// IMP=0x0000000000056aaf
- (id)initWithDatabaseProvider:(id)arg1 triggerRegistrar:(id)arg2 syncCoordinator:(id)arg3 syncDataEndpoint:(id)arg4 runCoordinator:(id)arg5;	// IMP=0x00000000000569aa
