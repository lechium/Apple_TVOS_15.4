...
+ (Class)inputClassesType;	// IMP=0x0000000000040989
+ (Class)workflowTypesType;	// IMP=0x0000000000040978
- (void).cxx_destruct;	// IMP=0x000000000004029a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003fcb7
- (unsigned long long)hash;	// IMP=0x000000000003f8ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003f524
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003f021
- (void)copyTo:(id)arg1;	// IMP=0x000000000003ed0b
- (void)writeTo:(id)arg1;	// IMP=0x000000000003e93c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003e92f
- (id)dictionaryRepresentation;	// IMP=0x000000000003e4f9
- (id)description;	// IMP=0x000000000003e44a
@property(readonly, nonatomic) _Bool hasSubtitle;
- (int)StringAsRemoteQuarantineStatus:(id)arg1;	// IMP=0x000000000003e398
- (id)remoteQuarantineStatusAsString:(int)arg1;	// IMP=0x000000000003e331
...
- (id)inputClassesAtIndex:(unsigned long long)arg1;	// IMP=0x000000000003e1a8
- (unsigned long long)inputClassesCount;	// IMP=0x000000000003e18b
- (void)addInputClasses:(id)arg1;	// IMP=0x000000000003e121
- (void)clearInputClasses;	// IMP=0x000000000003e104
- (id)workflowTypesAtIndex:(unsigned long long)arg1;	// IMP=0x000000000003e0e7
- (unsigned long long)workflowTypesCount;	// IMP=0x000000000003e0ca
- (void)addWorkflowTypes:(id)arg1;	// IMP=0x000000000003e060
- (void)clearWorkflowTypes;	// IMP=0x000000000003e043
