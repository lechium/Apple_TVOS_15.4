...
- (void).cxx_destruct;	// IMP=0x0000000000005070
...
- (id)description;	// IMP=0x0000000000004f8d
- (id)_initWithDomain:(id)arg1 appID:(id)arg2 service:(long long)arg3 isApproved:(_Bool)arg4;	// IMP=0x0000000000004eb3
- (id)initWithServiceDetails:(id)arg1;	// IMP=0x0000000000004c0e
