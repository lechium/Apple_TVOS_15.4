...
- (void).cxx_destruct;	// IMP=0x000000000002330a
...
- (id)debugDescription;	// IMP=0x00000000000231de
- (_Bool)containsVideoAdjustments;	// IMP=0x00000000000231b4
- (_Bool)containsPhotoAdjustments;	// IMP=0x000000000002318a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000023104
- (id)videoAdjustmentStack;	// IMP=0x0000000000008a0e
- (id)photoAdjustmentStack;	// IMP=0x000000000000b7e7
