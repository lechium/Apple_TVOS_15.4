...
- (void).cxx_destruct;	// IMP=0x00000000000d64db
@property(readonly, nonatomic) IDSEndpointCapabilities *capabilities; // @synthesize capabilities=_capabilities;
- (void)_setService:(id)arg1;	// IMP=0x00000000000d63ef
- (void)_setAccount:(id)arg1;	// IMP=0x00000000000d630d
- (void)_stateChanged;	// IMP=0x00000000000d619b
- (void)_cloudConnectedStateChanged;	// IMP=0x00000000000d605c
- (void)_connectedStateChanged;	// IMP=0x00000000000d5f1d
- (void)_nearbyStateChanged;	// IMP=0x00000000000d5dde
- (_Bool)isTinker;	// IMP=0x00000000000d5dc6
- (void)_addIdentity:(id)arg1;	// IMP=0x00000000000d5a72
...
- (id)compactDescription;	// IMP=0x00000000000d3d7e
- (id)description;	// IMP=0x00000000000d3904
- (id)fullDescription;	// IMP=0x00000000000d3450
...
- (void)dealloc;	// IMP=0x00000000000d2d42
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000d256f
