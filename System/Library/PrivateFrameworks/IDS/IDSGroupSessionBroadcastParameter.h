...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003ef04
- (void).cxx_destruct;	// IMP=0x000000000003f0f0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003f087
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003ef8f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003ef0c
- (unsigned long long)hash;	// IMP=0x000000000003eeaa
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003ed60
- (void)_requestNWConnectionforIDSGroupSessionBroadcastParameter:(CDUnknownBlockType)arg1;	// IMP=0x000000000003ec3a
- (id)initWithGroupSessionID:(id)arg1 salt:(id)arg2 serviceName:(id)arg3;	// IMP=0x000000000003e846
- (id)initWithGroupSessionID:(id)arg1 serviceName:(id)arg2;	// IMP=0x000000000003e7af
