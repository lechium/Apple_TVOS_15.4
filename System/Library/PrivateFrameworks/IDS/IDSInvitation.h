...
- (void).cxx_destruct;	// IMP=0x00000000000cefe8
...
- (id)initWithState:(long long)arg1 expirationDate:(id)arg2 uniqueID:(id)arg3 context:(id)arg4;	// IMP=0x00000000000ceeb8
