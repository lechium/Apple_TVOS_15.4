...
- (id)description;	// IMP=0x000000000004450f
- (id)initWithSubscriptionIdentifiers:(id)arg1 authenticationCertificates:(id)arg2 inputData:(id)arg3 nonce:(id)arg4 signature:(id)arg5;	// IMP=0x0000000000044284
