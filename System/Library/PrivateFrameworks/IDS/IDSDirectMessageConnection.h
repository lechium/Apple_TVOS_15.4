...
+ (_Bool)isDirectMessagingRequested:(id)arg1;	// IMP=0x0000000000009e3d
- (void).cxx_destruct;	// IMP=0x000000000001047c
...
- (void)logConnectionStatisticsInPowerDictionary;	// IMP=0x000000000000fe21
- (void)startPowerLogReportTimer;	// IMP=0x000000000000fcf4
- (void)clearPowerAssertion;	// IMP=0x000000000000fc99
- (void)getPowerAssertion;	// IMP=0x000000000000fb12
- (void)dequeueMessages;	// IMP=0x000000000000f698
- (void)sendMessageWithParameters:(id)arg1 options:(id)arg2;	// IMP=0x000000000000e8d4
- (void)failedToSendMessage:(id)arg1 responseCode:(long long)arg2;	// IMP=0x000000000000e681
- (void)suspendPendingAckTimer;	// IMP=0x000000000000e659
- (void)resumePendingAckTimer;	// IMP=0x000000000000e631
- (void)cancelPendingAckTimer;	// IMP=0x000000000000e5f0
- (id)createDispatchDataForMessageSend:(id)arg1 isAck:(_Bool)arg2 ackMessageId:(unsigned int)arg3;	// IMP=0x000000000000db7b
- (unsigned char)getMessageTypeForFirstMessage;	// IMP=0x000000000000d9d2
- (void)sendAppAckWithGUID:(id)arg1;	// IMP=0x000000000000d0cc
- (void)sendAckForMessageID:(unsigned int)arg1 guidToAck:(id)arg2;	// IMP=0x000000000000cdf1
- (void)processIncomingMessage:(id)arg1 messageType:(unsigned char)arg2 messageIdentifier:(unsigned int)arg3;	// IMP=0x000000000000bda7
- (void)receiveMessages;	// IMP=0x000000000000b89b
- (void)setupConnectionIfApplicable;	// IMP=0x000000000000b848
- (void)receivedDirectMessagingSocketWithContext:(id)arg1;	// IMP=0x000000000000b481
- (void)setupIDSDeviceConnection;	// IMP=0x000000000000aff4
- (void)updateTrafficClass:(unsigned short)arg1;	// IMP=0x000000000000afdc
- (void)updateConnection:(id)arg1;	// IMP=0x000000000000ad0b
- (void)resetConnection;	// IMP=0x000000000000ac07
- (void)updateMetadata:(id)arg1;	// IMP=0x000000000000a724
- (void)updateConnectedDevices:(id)arg1;	// IMP=0x000000000000a2d3
- (_Bool)isMessageEligible:(id)arg1 options:(id)arg2 destinationDevice:(id)arg3;	// IMP=0x0000000000009f1f
- (_Bool)canUseDirectMessaging;	// IMP=0x0000000000009e26
- (void)setDestinationDevice:(id)arg1;	// IMP=0x0000000000009cb8
- (void)invalidate;	// IMP=0x0000000000009bbc
- (void)cancel;	// IMP=0x0000000000009af9
- (id)description;	// IMP=0x0000000000009a66
- (void)dealloc;	// IMP=0x0000000000009964
- (void)parseDirectMessagingState;	// IMP=0x00000000000097dc
- (id)initWithServiceName:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000000094dc
