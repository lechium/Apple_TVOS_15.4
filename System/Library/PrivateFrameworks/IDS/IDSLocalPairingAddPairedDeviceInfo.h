...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000070a67
- (void).cxx_destruct;	// IMP=0x0000000000070dfe
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000070c1a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070a6f
- (id)description;	// IMP=0x00000000000708ff
- (id)initWithCBUUID:(id)arg1 pairingProtocolVersion:(long long)arg2 BTOutOfBandKey:(id)arg3;	// IMP=0x0000000000070840
