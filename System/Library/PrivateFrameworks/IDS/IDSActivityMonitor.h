...
- (void).cxx_destruct;	// IMP=0x000000000002979a
...
- (void)handleIncomingUpdate:(id)arg1 onActivity:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000029608
@property(readonly, nonatomic) NSArray *subscriptions;
@property(nonatomic) _Bool listeningForUpdates;
- (void)stopBroadcastingForSubActivity:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000028b59
- (void)beginBroadcastingWithInfo:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000000002884a
- (void)dealloc;	// IMP=0x000000000002864c
- (id)initWithActivity:(id)arg1 serviceIdentifier:(id)arg2 queue:(id)arg3 xpcConnector:(id)arg4;	// IMP=0x000000000002840f
- (id)initWithActivity:(id)arg1 serviceIdentifier:(id)arg2 queue:(id)arg3;	// IMP=0x0000000000028357
- (id)initWithActivity:(id)arg1 serviceIdentifier:(id)arg2;	// IMP=0x00000000000282bd
