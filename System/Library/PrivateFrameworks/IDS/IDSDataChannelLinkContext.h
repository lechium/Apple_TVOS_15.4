...
- (void).cxx_destruct;	// IMP=0x00000000000de7ea
...
- (void)setMaxBitrate:(unsigned int)arg1;	// IMP=0x00000000000de788
- (void)setMTU:(unsigned short)arg1;	// IMP=0x00000000000de77a
- (void)setRATType:(unsigned int)arg1;	// IMP=0x00000000000de76d
...
- (id)description;	// IMP=0x00000000000de679
- (id)initWithAttributes:(CDStruct_ab50c87c *)arg1 maxBitrate:(unsigned int)arg2 relayServerProvider:(long long)arg3 relaySessionToken:(id)arg4 relaySessionKey:(id)arg5;	// IMP=0x00000000000de3ea
...
- (id)initWithDummyInformation;	// IMP=0x00000000000de086
