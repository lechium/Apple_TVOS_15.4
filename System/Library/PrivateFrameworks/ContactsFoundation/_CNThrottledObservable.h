...
- (void).cxx_destruct;	// IMP=0x000000000005803e
...
- (void)observerScheduler_sendResultToObserver:(id)arg1;	// IMP=0x0000000000057dcf
- (id)subscribe:(id)arg1;	// IMP=0x00000000000574f4
- (void)dealloc;	// IMP=0x0000000000057489
- (id)initWithInterval:(double)arg1 options:(unsigned long long)arg2 observable:(id)arg3 schedulerProvider:(id)arg4;	// IMP=0x0000000000057343
