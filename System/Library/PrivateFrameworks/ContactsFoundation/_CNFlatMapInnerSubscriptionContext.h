...
{
    CNSuspendableSchedulerDecorator *_decorator;	// 8 = 0x8
    id <CNCancelable> _token;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x0000000000068f61
...
- (id)initWithDecorator:(id)arg1 token:(id)arg2;	// IMP=0x0000000000068ea5
