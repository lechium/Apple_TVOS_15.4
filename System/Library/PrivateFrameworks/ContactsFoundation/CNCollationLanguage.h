...
@interface CNCollationLanguage : NSObject
{
    ...
    NSString *_lastCharacter;	// 16 = 0x10
    NSString *_firstCharacterAfterLanguage;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x000000000001ef84
...
- (id)initWithSections:(id)arg1 lastCharacter:(id)arg2 firstCharacterAfterLanguage:(id)arg3;	// IMP=0x000000000001ee53
