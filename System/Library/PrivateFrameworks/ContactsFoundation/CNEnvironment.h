...
+ (char *)environmentStackKey;	// IMP=0x00000000000659e6
+ (id)defaultEnvironment;	// IMP=0x0000000000065961
- (void).cxx_destruct;	// IMP=0x0000000000066174
...
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000065feb
- (id)valueForKey:(id)arg1 onCacheMiss:(CDUnknownBlockType)arg2;	// IMP=0x0000000000065e98
- (_Bool)isCommLimitsEnabledImpl;	// IMP=0x0000000000065e90
@property(readonly, getter=isCommLimitsEnabled) _Bool commLimitsEnabled;
- (_Bool)isInternalBuildImpl;	// IMP=0x0000000000065d94
@property(readonly, getter=isInternalBuild) _Bool internalBuild;
- (id)getDefaultCountryCode;	// IMP=0x0000000000065c90
@property(readonly) NSString *defaultCountryCode;
- (id)init;	// IMP=0x00000000000659f3
