...
- (void)sendSampleToObserver:(id)arg1;	// IMP=0x000000000005597a
- (void)receiveResult:(id)arg1;	// IMP=0x00000000000558ff
- (id)subscribe:(id)arg1;	// IMP=0x00000000000554eb
- (id)initWithObservable:(id)arg1 sampler:(id)arg2;	// IMP=0x000000000005543a
