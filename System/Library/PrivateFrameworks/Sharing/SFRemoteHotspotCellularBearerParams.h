...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000be8cd
- (void).cxx_destruct;	// IMP=0x00000000000bedc3
...
- (id)description;	// IMP=0x00000000000beb68
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bea85
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000be8d5
