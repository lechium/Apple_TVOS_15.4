...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000dec8f
- (void).cxx_destruct;	// IMP=0x00000000000ded02
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000de9d8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000de795
- (id)initWithDeviceName:(id)arg1 modelIdentifier:(id)arg2 type:(long long)arg3;	// IMP=0x00000000000de6d2
