...
+ (id)nodeWithSFNode:(struct __SFNode *)arg1;	// IMP=0x0000000000018230
- (void).cxx_destruct;	// IMP=0x00000000000198bc
...
- (void)handleOperationCallback:(struct __SFOperation *)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000000000194ac
- (void)cancelSend;	// IMP=0x000000000001947d
- (void)startSendForBundleID:(id)arg1 sessionID:(id)arg2 items:(id)arg3 description:(id)arg4 previewImage:(struct CGImage *)arg5 fromShareSheet:(_Bool)arg6;	// IMP=0x0000000000019169
- (id)displayNameForLocale:(id)arg1;	// IMP=0x0000000000018fd5
- (void)appendDiscoveryInfoToDisplayName:(id)arg1;	// IMP=0x0000000000018d2c
- (void)updateDisplayName;	// IMP=0x0000000000018a90
- (void)updateWithSFNode:(struct __SFNode *)arg1;	// IMP=0x0000000000018674
@property(readonly, getter=isKnown) _Bool known;
- (id)description;	// IMP=0x000000000001844e
- (unsigned long long)hash;	// IMP=0x0000000000018413
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018305
- (void)dealloc;	// IMP=0x00000000000182c6
- (id)init;	// IMP=0x0000000000018268
