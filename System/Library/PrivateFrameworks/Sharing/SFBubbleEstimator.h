...
+ (id)estimatorWithEnter:(long long)arg1 exit:(long long)arg2 threshold:(double)arg3;	// IMP=0x00000000000be5b2
+ (id)estimatorWithEnter:(long long)arg1 exit:(long long)arg2;	// IMP=0x00000000000be549
- (void).cxx_destruct;	// IMP=0x00000000000be8bd
...
- (_Bool)shouldExpandBubble;	// IMP=0x00000000000be790
- (long long)updateWithRSSI:(long long)arg1;	// IMP=0x00000000000be65b
- (void)reset;	// IMP=0x00000000000be647
