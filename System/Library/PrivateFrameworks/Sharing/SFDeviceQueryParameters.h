...
- (void).cxx_destruct;	// IMP=0x000000000005d0d6
...
- (unsigned long long)hash;	// IMP=0x000000000005d007
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005ce4c
- (id)description;	// IMP=0x000000000005cd1f
- (id)maAssetQueryDescription;	// IMP=0x000000000005cb76
- (id)initWithDeviceAssetQuery:(id)arg1 installedOnly:(_Bool)arg2 imperfectMatch:(_Bool)arg3 fallback:(_Bool)arg4;	// IMP=0x000000000005ca30
