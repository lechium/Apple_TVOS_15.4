...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009528f
- (void).cxx_destruct;	// IMP=0x0000000000095b32
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000956f2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000095297
