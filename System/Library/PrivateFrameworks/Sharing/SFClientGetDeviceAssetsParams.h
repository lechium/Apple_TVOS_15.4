...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000893c6
- (void).cxx_destruct;	// IMP=0x00000000000895a7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000894d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000893ce
