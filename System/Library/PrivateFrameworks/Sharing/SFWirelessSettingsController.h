...
- (void)invalidate;	// IMP=0x000000000001bf81
- (void)dealloc;	// IMP=0x000000000001bf43
...
- (void)handleOperationCallback:(struct __SFOperation *)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x000000000001bba0
- (id)init;	// IMP=0x000000000001bac8
