...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001bfe5
- (void).cxx_destruct;	// IMP=0x000000000001d493
...
- (id)description;	// IMP=0x000000000001d1d5
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000001cdc8
- (id)initWithAppleID:(id)arg1;	// IMP=0x000000000001cd33
- (_Bool)isEqualToAccount:(id)arg1;	// IMP=0x000000000001c5c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c55b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001c494
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001c351
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001bfed
