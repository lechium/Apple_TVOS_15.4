...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000067f8c
- (void).cxx_destruct;	// IMP=0x000000000006cbd2
...
- (unsigned int)updateWithPowerSourceDescription:(id)arg1;	// IMP=0x000000000006b445
- (void)updateWithPowerSource:(id)arg1;	// IMP=0x000000000006b35d
- (unsigned int)updateWithPowerAdapterDetails:(id)arg1;	// IMP=0x000000000006b129
...
- (void)lowPowerModeChanged:(int)arg1;	// IMP=0x000000000006a98d
- (void)startLowPowerMonitoringIfAppropriate;	// IMP=0x000000000006a8d6
- (void)invalidate;	// IMP=0x000000000006a850
- (int)publish;	// IMP=0x0000000000069d35
- (id)detailedDescription;	// IMP=0x0000000000069ce4
- (id)description;	// IMP=0x000000000006947a
- (unsigned long long)hash;	// IMP=0x00000000000693ea
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000069007
- (void)dealloc;	// IMP=0x0000000000068fc9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000068b8f
- (void)_updateWithCoder:(id)arg1;	// IMP=0x000000000006805f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000067ff1
- (id)init;	// IMP=0x0000000000067f94
