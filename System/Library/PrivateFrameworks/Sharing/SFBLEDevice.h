...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000078eeb
+ (void)setRSSIEstimatorInfo:(id)arg1;	// IMP=0x0000000000078c08
- (void).cxx_destruct;	// IMP=0x000000000007b15d
...
- (_Bool)updateRSSI:(long long)arg1;	// IMP=0x000000000007ab38
- (id)description;	// IMP=0x0000000000079beb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000079a75
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007973e
