...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000e8b49
- (void).cxx_destruct;	// IMP=0x00000000000e92cf
...
- (void)invalidate;	// IMP=0x00000000000e91f0
- (id)description;	// IMP=0x00000000000e90e3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e8ffe
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e8b51
