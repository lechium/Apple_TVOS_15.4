...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000013d1b
- (void).cxx_destruct;	// IMP=0x0000000000013e77
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000013bed
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000138d3
- (unsigned long long)hash;	// IMP=0x0000000000013894
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001379f
- (id)description;	// IMP=0x0000000000013720
