...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000095d80
- (void).cxx_destruct;	// IMP=0x00000000000982c5
...
- (void)updateWithRPIdentity:(id)arg1;	// IMP=0x0000000000097da8
- (void)updateWithPairedPeer:(id)arg1;	// IMP=0x0000000000097cdd
- (void)updateWithBLEDevice:(id)arg1;	// IMP=0x00000000000977a6
@property(readonly, nonatomic) _Bool needsKeyboardOnly;
- (id)description;	// IMP=0x0000000000096c11
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000096768
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000095dc4
- (id)init;	// IMP=0x0000000000095d88
