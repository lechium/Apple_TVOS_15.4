...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004eb34
...
- (void)triggerAction;	// IMP=0x000000000004f238
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004f0fe
- (unsigned long long)hash;	// IMP=0x000000000004f071
- (id)description;	// IMP=0x000000000004ee32
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004ed3d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004eb3c
- (id)initWithTransferIdentifier:(id)arg1 actionIdentifier:(id)arg2 title:(id)arg3 singleItemTitle:(id)arg4;	// IMP=0x000000000004ea16
