...
- (void).cxx_destruct;	// IMP=0x00000000000be1c9
...
- (id)description;	// IMP=0x00000000000be00b
- (id)initWithQueryResultHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bdf98
