...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000017f58
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000017e0c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000017c76
- (id)description;	// IMP=0x0000000000017ac1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000017950
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x0000000000017798
