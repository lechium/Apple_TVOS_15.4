...
- (int)_estimateRSSIForSFBLEDevice:(id)arg1;	// IMP=0x00000000000f130e
- (id)description;	// IMP=0x00000000000f121f
- (void)dealloc;	// IMP=0x00000000000f11b0
- (id)initWithProximityInfo:(id)arg1;	// IMP=0x00000000000f109c
