...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000741d0
- (void).cxx_destruct;	// IMP=0x0000000000074db8
...
- (id)description;	// IMP=0x0000000000074ad7
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000074947
- (_Bool)isEqualToPersonInfo:(id)arg1;	// IMP=0x0000000000074630
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000745c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007452c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000074433
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000741d8
