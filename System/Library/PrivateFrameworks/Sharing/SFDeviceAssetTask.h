...
- (void).cxx_destruct;	// IMP=0x000000000005efb6
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000005eaa1
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x000000000005e7e2
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x000000000005e05a
- (_Bool)completeIfPossible;	// IMP=0x000000000005dadd
- (void)cancelTimeout;	// IMP=0x000000000005da93
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000005d89c
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000005d7e6
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000005d753
- (void)createQueryParameters;	// IMP=0x000000000005d42b
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x000000000005d0e6
