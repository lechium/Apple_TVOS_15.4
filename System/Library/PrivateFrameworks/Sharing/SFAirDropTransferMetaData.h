...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000401cb
...
- (void)setItemsDescription:(id)arg1;	// IMP=0x0000000000040f2b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000040eb0
- (unsigned long long)hash;	// IMP=0x0000000000040dde
- (id)description;	// IMP=0x0000000000040b73
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004091f
- (void)updateUsingCoder:(id)arg1;	// IMP=0x0000000000040225
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000401d3
- (id)initWithInformation:(id)arg1;	// IMP=0x000000000003fb2d
