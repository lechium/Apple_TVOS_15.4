...
- (void).cxx_destruct;	// IMP=0x00000000000a972b
...
- (void)_setupResponse:(id)arg1;	// IMP=0x00000000000a95af
- (void)_complete:(id)arg1;	// IMP=0x00000000000a9434
- (void)_bonjourTestTimeout;	// IMP=0x00000000000a939a
- (void)_bonjourTestFoundDevice:(id)arg1;	// IMP=0x00000000000a90bd
- (void)_bonjourTestStart;	// IMP=0x00000000000a8c98
- (void)invalidate;	// IMP=0x00000000000a8b9a
- (void)_activate2;	// IMP=0x00000000000a8525
- (void)_activate;	// IMP=0x00000000000a8176
- (void)activate;	// IMP=0x00000000000a8113
- (id)init;	// IMP=0x00000000000a80bc
