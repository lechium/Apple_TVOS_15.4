...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000fba4
- (void).cxx_destruct;	// IMP=0x000000000000fdab
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000fc41
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000fbac
- (unsigned long long)hash;	// IMP=0x000000000000faef
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000fa5f
@property(readonly, nonatomic) NSString *uniqueIdentifier;
- (id)initWithTestRecipe:(id)arg1 domainInfo:(id)arg2;	// IMP=0x000000000000f737
