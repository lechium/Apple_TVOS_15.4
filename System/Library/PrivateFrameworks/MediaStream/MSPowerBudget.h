...
- (void).cxx_destruct;	// IMP=0x000000000000f00e
...
- (void)_globalResetSyncTimerDidExpire:(id)arg1;	// IMP=0x000000000000eeb6
- (void)_postForegroundTimerDidExpire:(id)arg1;	// IMP=0x000000000000ee45
- (void)didEndExternalPower;	// IMP=0x000000000000ec72
- (void)didBeginExternalPower;	// IMP=0x000000000000ec01
- (void)didReceiveGlobalResetSync;	// IMP=0x000000000000eb90
- (void)didEndForegroundFocus;	// IMP=0x000000000000eb1f
- (void)didBeginForegroundFocus;	// IMP=0x000000000000eaae
- (void)didReceivePushNotification;	// IMP=0x000000000000ea3d
- (void)workQueueCommitPersistedValues;	// IMP=0x000000000000e828
- (void)setIsFileTransferAllowed:(_Bool)arg1;	// IMP=0x000000000000e7ac
- (void)workQueueSetIsFileTransferAllowed:(_Bool)arg1;	// IMP=0x000000000000e7a3
...
- (void)workQueueRecomputeFileTransferAllowed;	// IMP=0x000000000000e46b
- (double)workQueueMaxActiveTimeAfterLossOfForeground;	// IMP=0x000000000000e460
...
- (double)workQueueMaxActiveTimeAfterGlobalResetSync;	// IMP=0x000000000000e283
...
- (double)workQueueMaxActiveTimeAfterPush;	// IMP=0x000000000000e0a6
@property(nonatomic) double maxActiveTimeAfterPush; // @synthesize maxActiveTimeAfterPush=_maxActiveTimeAfterPush;
- (void)shutDown;	// IMP=0x000000000000de63
- (void)workQueueSetGlobalResetSyncTimerDate:(id)arg1;	// IMP=0x000000000000dbd5
- (void)workQueueSetPostForegroundTimerDate:(id)arg1;	// IMP=0x000000000000d947
- (void)workQueueSetPushTimerDate:(id)arg1;	// IMP=0x000000000000d68c
- (id)init;	// IMP=0x000000000000d583
