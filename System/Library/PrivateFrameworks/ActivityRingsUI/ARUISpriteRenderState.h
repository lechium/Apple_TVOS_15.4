...
- (void).cxx_destruct;	// IMP=0x0000000000015eaf
- (id)name;	// IMP=0x0000000000015ea2
- (id)initWithPipelineLibrary:(id)arg1;	// IMP=0x0000000000015dde
- (id)renderPipelineDescriptorFromLibrary:(id)arg1;	// IMP=0x0000000000015c9b
@property(retain, nonatomic) id <MTLRenderPipelineState> renderPipelineState;
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x0000000000015baa
