...
+ (id)animationWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001a0f3
- (void).cxx_destruct;	// IMP=0x000000000001a49f
...
- (void)completeAnimation;	// IMP=0x000000000001a3d0
- (_Bool)isAnimating;	// IMP=0x000000000001a3bf
- (void)update:(double)arg1;	// IMP=0x000000000001a2bc
- (void)dealloc;	// IMP=0x000000000001a25e
- (id)initWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001a187
