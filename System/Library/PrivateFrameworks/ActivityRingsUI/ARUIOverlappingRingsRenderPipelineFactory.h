...
- (void).cxx_destruct;	// IMP=0x000000000001adfc
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x000000000001acb3
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x000000000001ab88
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x000000000001aa36
