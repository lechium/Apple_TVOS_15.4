...
+ (id)randomRing;	// IMP=0x000000000000d4bb
- (void).cxx_destruct;	// IMP=0x000000000000d85b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000d483
- (id)description;	// IMP=0x000000000000d333
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000cb77
- (unsigned long long)hash;	// IMP=0x000000000000ca58
- (void)_updatePremultipliedBottomColor;	// IMP=0x000000000000c97f
- (void)_updatePremultipliedTopColor;	// IMP=0x000000000000c8bd
- (id)initWithRing:(id)arg1;	// IMP=0x000000000000c64a
- (id)init;	// IMP=0x000000000000c5fc
