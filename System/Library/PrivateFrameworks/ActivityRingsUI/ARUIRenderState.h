...
- (void).cxx_destruct;	// IMP=0x00000000000143ca
- (id)renderPipelineDescriptorFromLibrary:(id)arg1;	// IMP=0x00000000000143c2
@property(retain, nonatomic) id <MTLRenderPipelineState> renderPipelineState;
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x00000000000142d1
