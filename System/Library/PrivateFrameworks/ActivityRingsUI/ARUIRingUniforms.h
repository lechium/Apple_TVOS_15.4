...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001c633
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001c237
- (void *)uniformsBytes;	// IMP=0x000000000001c22a
- (void *)vertexAttributesBytes;	// IMP=0x000000000001c220
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001c17c
