...
- (void)deferringResolutionsChanged;	// IMP=0x0000000000011e18
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)_lock_updateStateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000119ef
- (_Bool)_lock_canReceiveEvents;	// IMP=0x0000000000011756
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000115a2
- (void)addObserver:(id)arg1;	// IMP=0x00000000000113ee
...
- (void)dealloc;	// IMP=0x0000000000010bca
- (id)_initWithObserver:(id)arg1;	// IMP=0x000000000001091e
- (id)init;	// IMP=0x0000000000010761
