...
+ (id)protobufSchema;	// IMP=0x000000000001365d
- (void).cxx_destruct;	// IMP=0x000000000001364a
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x000000000001337c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000131ff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001313c
