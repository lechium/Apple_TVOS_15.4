...
+ (id)protobufSchema;	// IMP=0x0000000000012fdf
- (void).cxx_destruct;	// IMP=0x0000000000012fcf
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0000000000012dda
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012bd5
