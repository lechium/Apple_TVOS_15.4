...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e5a7
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003e3ce
- (id)description;	// IMP=0x000000000003e2d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e27d
