...
- (id)debugDescriptionWithMomentNode:(id)arg1;	// IMP=0x00000000004e4f97
- (id)initWithNodes:(id)arg1 negativeNodes:(id)arg2;	// IMP=0x00000000004e4f39
- (id)initWithNodes:(id)arg1;	// IMP=0x00000000004e4e95
