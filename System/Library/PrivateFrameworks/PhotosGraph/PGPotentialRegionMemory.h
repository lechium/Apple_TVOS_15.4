...
- (void).cxx_destruct;	// IMP=0x00000000004bb417
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x00000000004bb190
- (unsigned long long)memoryCategory;	// IMP=0x00000000004bb185
@property(readonly) NSString *region;
- (void)addMomentNode:(id)arg1;	// IMP=0x00000000004bb14b
- (id)initWithRegionNode:(id)arg1 year:(long long)arg2;	// IMP=0x00000000004bb051
