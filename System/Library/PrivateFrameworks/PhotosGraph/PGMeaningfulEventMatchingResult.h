...
- (void).cxx_destruct;	// IMP=0x0000000000246b79
...
- (id)description;	// IMP=0x0000000000246aa2
- (id)initWithIsMatching:(_Bool)arg1 score:(double)arg2 isReliable:(_Bool)arg3 requiredCriteria:(id)arg4;	// IMP=0x0000000000246a12
