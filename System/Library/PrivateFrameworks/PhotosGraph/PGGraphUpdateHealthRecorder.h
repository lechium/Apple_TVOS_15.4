...
- (void).cxx_destruct;	// IMP=0x00000000001c0a25
...
- (void)endRecordingInBackground:(_Bool)arg1;	// IMP=0x00000000001c0563
- (void)beginRecording;	// IMP=0x00000000001c054e
- (void)recordNumberOfDaysSinceMajorOSUpgrade:(unsigned long long)arg1;	// IMP=0x00000000001c0480
- (void)recordTransactionSize:(unsigned long long)arg1;	// IMP=0x00000000001c0476
- (void)recordNumberOfTimesGraphUpdatePaused:(unsigned long long)arg1;	// IMP=0x00000000001c046c
- (void)recordNumberOfDatabaseChangesConvertedToGraphChanges:(unsigned long long)arg1 inBackground:(_Bool)arg2;	// IMP=0x00000000001c0458
- (void)recordNumberOfDatabaseChangesReceived:(unsigned long long)arg1 inBackground:(_Bool)arg2;	// IMP=0x00000000001c0444
- (id)initForChangeConsumer:(_Bool)arg1 analytics:(id)arg2;	// IMP=0x00000000001c03ce
