...
+ (id)criteriaWithDictionary:(id)arg1;	// IMP=0x000000000035868e
+ (id)criteriaKey;	// IMP=0x0000000000358681
...
- (_Bool)isValid;	// IMP=0x0000000000358a07
- (_Bool)passesForAssets:(id)arg1;	// IMP=0x00000000003589ff
- (_Bool)passesForMomentNode:(id)arg1 momentNodeCache:(id)arg2;	// IMP=0x0000000000358834
