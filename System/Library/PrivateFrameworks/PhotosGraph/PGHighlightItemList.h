...
+ (void)updateParentHighlightItemLists:(id)arg1 withChildHighlightItems:(id)arg2;	// IMP=0x00000000003c686f
+ (id)timeSortDescriptors;	// IMP=0x00000000003c67d1
- (void).cxx_destruct;	// IMP=0x00000000003c6730
...
- (void)_updateHighlightItemsOrdering;	// IMP=0x00000000003c6433
- (void)removeHighlightItem:(id)arg1;	// IMP=0x00000000003c6391
- (void)addHighlightItem:(id)arg1;	// IMP=0x00000000003c62f1
...
- (id)initAsNewList;	// IMP=0x00000000003c5860
- (id)initWithParentHighlightItem:(id)arg1 childHighlightItems:(id)arg2;	// IMP=0x00000000003c5723
