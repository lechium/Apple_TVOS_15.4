...
- (void).cxx_destruct;	// IMP=0x00000000002ae2a0
...
- (_Bool)addUpNextMemory:(id)arg1 debugInfo:(id *)arg2;	// IMP=0x00000000002adcf9
- (id)initWithLowercaseTitles:(id)arg1 keyAssetLocalIdentifiers:(id)arg2 gateOnUserFeedback:(_Bool)arg3 loggingConnection:(id)arg4;	// IMP=0x00000000002adbf3
