...
+ (id)suggestionResultWithPerson:(id)arg1 weight:(double)arg2 sourceWeight:(double)arg3 sourceName:(id)arg4;	// IMP=0x00000000001b3514
- (void).cxx_destruct;	// IMP=0x00000000001b34ec
...
- (id)description;	// IMP=0x00000000001b341c
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(readonly, nonatomic) double score;
- (void)mergeWithSuggestionResult:(id)arg1;	// IMP=0x00000000001b2ffd
- (id)initWithPerson:(id)arg1 weight:(double)arg2 sourceWeight:(double)arg3 sourceName:(id)arg4;	// IMP=0x00000000001b2ef5
