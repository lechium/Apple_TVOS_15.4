...
- (void).cxx_destruct;	// IMP=0x00000000002ed818
...
- (id)debugDescription;	// IMP=0x00000000002ed6b5
- (id)description;	// IMP=0x00000000002ed61c
@property(readonly, nonatomic) NSString *meaningNodeLabel;
- (id)initWithIdentifier:(id)arg1 minimumScore:(double)arg2;	// IMP=0x00000000002ed535
