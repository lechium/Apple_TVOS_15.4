...
- (void).cxx_destruct;	// IMP=0x00000000005921a7
...
- (id)description;	// IMP=0x0000000000591f4e
- (void)resetVisitFindingSession;	// IMP=0x0000000000591efb
- (void)closeVisitFindingSession;	// IMP=0x0000000000591e96
- (void)registerMomentNode:(id)arg1 distance:(unsigned long long)arg2;	// IMP=0x0000000000591c95
...
- (id)initWithAddressNode:(id)arg1 localDateInterval:(id)arg2;	// IMP=0x000000000059191b
