...
+ (id)otherMemoryCriteria;	// IMP=0x000000000022f6b4
+ (id)greatMemoryCriteria;	// IMP=0x000000000022f684
+ (id)stellarMemoryCriteria;	// IMP=0x000000000022f654
+ (id)mustSeeMemoryCriteria;	// IMP=0x000000000022f624
- (void).cxx_destruct;	// IMP=0x00000000002c3696
...
- (void)addPersistedFeature:(id)arg1;	// IMP=0x00000000002c31a7
...
- (void)setVersions;	// IMP=0x00000000002c26b3
- (id)initWithAssetCollection:(id)arg1;	// IMP=0x00000000002c2609
- (id)initWithCreationDate:(id)arg1;	// IMP=0x00000000002c258e
- (double)_scoreForMemoryCriteria:(id)arg1;	// IMP=0x000000000022f382
- (double)legacyPHMemoryScore;	// IMP=0x000000000022f04d
- (_Bool)isGreat;	// IMP=0x000000000022f02c
- (_Bool)isStellar;	// IMP=0x000000000022f00b
- (_Bool)isMustSee;	// IMP=0x000000000022efea
- (id)notificationQualityString;	// IMP=0x000000000022ef7d
