...
- (void).cxx_destruct;	// IMP=0x000000000032bc65
...
- (id)_filteredSignificantLocationNodes;	// IMP=0x000000000032a9c3
@property(readonly, nonatomic) NSArray *filteredLocationNodes; // @synthesize filteredLocationNodes=_filteredLocationNodes;
- (id)initWithSortedMomentNodes:(id)arg1 locationNodes:(id)arg2 incompleteLocationResolver:(id)arg3;	// IMP=0x000000000032a8bd
