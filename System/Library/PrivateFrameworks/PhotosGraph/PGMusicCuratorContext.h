...
+ (id)contextWithPhotoLibrary:(id)arg1 adamIDsWithNegativeUserFeedback:(id)arg2 allowExplicitMusicContent:(id)arg3 cache:(id)arg4 musicBag:(id)arg5 recentlyUsedSongs:(id)arg6 error:(id *)arg7;	// IMP=0x00000000000c6550
- (void).cxx_destruct;	// IMP=0x00000000000c67c0
- (id)init;	// IMP=0x00000000000c6760
