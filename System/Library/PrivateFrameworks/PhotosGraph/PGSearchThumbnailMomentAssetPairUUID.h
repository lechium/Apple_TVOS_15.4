...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004e7b1e
- (void).cxx_destruct;	// IMP=0x00000000004e7af6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004e7a74
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004e799a
- (id)initWithAssetUUID:(id)arg1 momentUUID:(id)arg2;	// IMP=0x00000000004e7901
