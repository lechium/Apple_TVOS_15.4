...
- (void)enumerateMomentChangeRequestsForUUIDs:(id)arg1 inPhotoLibrary:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000037eed6
- (void)clearCurations;	// IMP=0x000000000037ee96
