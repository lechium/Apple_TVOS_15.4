...
+ (id)fetchParentDayGroupHighlightsForDayHighlights:(id)arg1;	// IMP=0x000000000037f16d
...
- (id)changeRequest;	// IMP=0x000000000037ee7a
- (double)nonDefaultCurationScorePercentageForPhotoLibrary:(id)arg1;	// IMP=0x000000000037ed13
- (double)sceneAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x000000000037ecee
- (double)faceAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x000000000037ecd1
