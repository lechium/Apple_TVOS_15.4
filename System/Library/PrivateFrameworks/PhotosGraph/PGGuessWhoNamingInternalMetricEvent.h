...
- (void).cxx_destruct;	// IMP=0x0000000000479724
...
- (double)_precisionFromTruePositivesCount:(unsigned long long)arg1 falsePositivesCount:(unsigned long long)arg2;	// IMP=0x0000000000478fad
- (id)_peopleIdentitiesSignals;	// IMP=0x0000000000478fa0
- (void)_incrementSignalEvaluationForSignal:(unsigned long long)arg1 suggestionEdge:(id)arg2 isCorrect:(_Bool)arg3;	// IMP=0x0000000000478a94
- (void)_incrementSignalRegistrationForSignal:(unsigned long long)arg1 suggestionEdge:(id)arg2;	// IMP=0x000000000047879f
- (void)gatherMetricsWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000478745
- (id)payload;	// IMP=0x0000000000477eeb
- (id)identifier;	// IMP=0x0000000000477ede
- (id)initWithGraphManager:(id)arg1;	// IMP=0x0000000000477e2f
