...
- (id)description;	// IMP=0x000000000052c7ad
- (double)scoreForHolidayDetectedScenes:(id)arg1;	// IMP=0x000000000052c696
- (_Bool)isCelebratingForDateScore:(double)arg1 sceneScore:(double)arg2 locationScore:(double)arg3;	// IMP=0x000000000052c5d5
- (id)init;	// IMP=0x000000000052c42d
