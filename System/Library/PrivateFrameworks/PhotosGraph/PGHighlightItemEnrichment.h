...
- (void).cxx_destruct;	// IMP=0x00000000002a7056
...
- (void)enrichHighlightItemLists:(id)arg1 progressBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002a692c
- (id)initWithRule:(id)arg1 contextualKeyAssetByHighlighItemUUID:(id)arg2;	// IMP=0x00000000002a6893
