...
+ (id)criteriaWithDictionary:(id)arg1;	// IMP=0x00000000003fb49d
+ (id)criteriaKey;	// IMP=0x00000000003fb490
...
- (_Bool)isValid;	// IMP=0x00000000003fb7ce
- (_Bool)passesForAssets:(id)arg1;	// IMP=0x00000000003fb7c6
- (_Bool)passesForMomentNode:(id)arg1 momentNodeCache:(id)arg2;	// IMP=0x00000000003fb5ff
