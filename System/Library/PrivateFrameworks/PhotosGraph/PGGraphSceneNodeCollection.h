...
+ (id)sceneNodesForSceneNames:(id)arg1 inGraph:(id)arg2;	// IMP=0x00000000002c83a8
+ (id)sceneNodesForSceneName:(id)arg1 inGraph:(id)arg2;	// IMP=0x00000000002c8316
+ (Class)nodeClass;	// IMP=0x00000000002c8305
