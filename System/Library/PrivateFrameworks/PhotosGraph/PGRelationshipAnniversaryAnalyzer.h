...
- (void).cxx_destruct;	// IMP=0x00000000001bcd1d
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001bc930
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x00000000001bc8cc
