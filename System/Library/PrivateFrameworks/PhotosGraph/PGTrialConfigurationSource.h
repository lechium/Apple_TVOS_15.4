...
- (void).cxx_destruct;	// IMP=0x00000000004b1e58
...
- (id)objectForKey:(id)arg1;	// IMP=0x00000000004b1dce
- (id)initWithTrialSession:(id)arg1 namespaceType:(unsigned short)arg2;	// IMP=0x00000000004b1d57
