...
- (void).cxx_destruct;	// IMP=0x00000000002d2b5d
...
- (id)peopleTraitStringWithGraph:(id)arg1;	// IMP=0x00000000002d2352
- (id)niceDescriptionWithGraph:(id)arg1;	// IMP=0x00000000002d2072
- (double)_scoreForSceneClassifications:(id)arg1 withScenesTrait:(id)arg2 traitFailed:(_Bool *)arg3;	// IMP=0x00000000002d1cbe
- (_Bool)_passesForItem:(id)arg1 score:(double *)arg2 graph:(id)arg3 reasonString:(id *)arg4;	// IMP=0x00000000002d1338
- (_Bool)passesForItem:(id)arg1 score:(double *)arg2 graph:(id)arg3 reasonString:(id *)arg4;	// IMP=0x00000000002d1326
- (_Bool)passesForItem:(id)arg1 score:(double *)arg2;	// IMP=0x00000000002d130e
- (id)passingAssetsInAssets:(id)arg1;	// IMP=0x00000000002d116d
- (_Bool)isPassingForAsset:(id)arg1 score:(double *)arg2;	// IMP=0x00000000002d0ee6
- (id)initWithMinimumAssetsRatio:(double)arg1 client:(unsigned long long)arg2;	// IMP=0x00000000002d0e8e
