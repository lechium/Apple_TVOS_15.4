...
- (void).cxx_destruct;	// IMP=0x0000000000477450
...
- (void)gatherMetricsWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000477233
- (id)payload;	// IMP=0x0000000000476eda
- (id)identifier;	// IMP=0x0000000000476ecd
- (id)initWithGraphManager:(id)arg1;	// IMP=0x0000000000476e34
