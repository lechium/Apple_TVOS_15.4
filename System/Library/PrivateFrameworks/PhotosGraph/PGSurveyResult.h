...
- (void).cxx_destruct;	// IMP=0x000000000042532e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004251f4
@property(readonly) unsigned long long hash;
- (_Bool)isEquivalentToSurveyResult:(id)arg1;	// IMP=0x0000000000424f9e
- (void)remove;	// IMP=0x0000000000424f98
- (void)persistWithCreationDate:(id)arg1;	// IMP=0x0000000000424f92
- (_Bool)isEquivalentToPersistedQuestion:(id)arg1;	// IMP=0x0000000000424f8a
