...
- (void).cxx_destruct;	// IMP=0x00000000002adbb5
@property(readonly, nonatomic) PHMemory *memory; // @synthesize memory=_memory;
- (_Bool)isBlockedByUserFeedback;	// IMP=0x00000000002ad869
...
- (id)initWithMemory:(id)arg1 photoLibrary:(id)arg2 userFeedbackCalculator:(id)arg3;	// IMP=0x00000000002ad652
