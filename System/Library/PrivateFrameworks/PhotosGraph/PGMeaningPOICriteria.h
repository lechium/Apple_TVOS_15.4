...
+ (id)criteriaWithDictionary:(id)arg1;	// IMP=0x000000000016a120
+ (id)criteriaKey;	// IMP=0x000000000016a113
...
- (_Bool)_parkIsLargerThanMaximumDiameterWithAreaNodes:(id)arg1;	// IMP=0x000000000016a9fe
@property(readonly, copy) NSString *description;
- (_Bool)isValid;	// IMP=0x000000000016a56b
- (_Bool)passesForAssets:(id)arg1;	// IMP=0x000000000016a563
- (_Bool)passesForMomentNode:(id)arg1 momentNodeCache:(id)arg2;	// IMP=0x000000000016a309
