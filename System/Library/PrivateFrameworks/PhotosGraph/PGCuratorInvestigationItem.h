...
+ (id)itemWithUUID:(id)arg1 itemInfo:(id)arg2 curationModel:(id)arg3;	// IMP=0x00000000002f1bfe
- (void).cxx_destruct;	// IMP=0x00000000002f1821
...
- (_Bool)isRegularGem;	// IMP=0x00000000002f136a
- (_Bool)isShinyGem;	// IMP=0x00000000002f12fe
...
- (double)clsInteractionScore;	// IMP=0x00000000002f11b7
- (double)clsLikabilityScore;	// IMP=0x00000000002f114a
@property(readonly) _Bool clsHasInterestingScenes;
@property(readonly) _Bool clsHasPoorResolution;
- (_Bool)clsAvoidIfPossibleAsKeyItemForMemories:(_Bool)arg1 allowGuestAsset:(_Bool)arg2;	// IMP=0x00000000002f1006
...
- (double)scoreInContext:(id)arg1;	// IMP=0x00000000002f0728
...
- (id)date;	// IMP=0x00000000002f04d6
@property(readonly, copy) NSString *description;
- (id)initWithUUID:(id)arg1 itemInfo:(id)arg2 curationModel:(id)arg3;	// IMP=0x00000000002ef01a
- (id)init;	// IMP=0x00000000002eef80
