...
- (void).cxx_destruct;	// IMP=0x00000000004ede1e
...
- (id)_whitelistedMeaningLabels;	// IMP=0x00000000004edbe2
- (id)assetCollectionToShareForAssetCollection:(id)arg1 loggingConnection:(id)arg2;	// IMP=0x00000000004ed723
- (id)initWithType:(unsigned short)arg1 subtype:(unsigned short)arg2 enrichableEvent:(id)arg3 sharingSuggestionResults:(id)arg4 photoLibrary:(id)arg5 curationManager:(id)arg6 loggingConnection:(id)arg7 titleGenerationContext:(id)arg8;	// IMP=0x00000000004ed085
