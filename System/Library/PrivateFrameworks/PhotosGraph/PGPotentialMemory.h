...
- (void).cxx_destruct;	// IMP=0x000000000059f1ed
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x000000000059ee2f
@property(readonly, nonatomic) unsigned long long memoryCategory;
- (id)buildAssetCollectionUsingMemoryController:(id)arg1 withMinimumNumberOfAssets:(unsigned long long)arg2;	// IMP=0x000000000059e601
- (double)computeContentScoreUsingMemoryController:(id)arg1;	// IMP=0x000000000059e36f
- (void)_resetOverlapCheck;	// IMP=0x000000000059e32a
- (void)_prepareForOverlapCheck;	// IMP=0x000000000059dec0
...
- (id)initWithCategory:(unsigned long long)arg1 subcategory:(unsigned long long)arg2 momentNodes:(id)arg3 sourceType:(long long)arg4;	// IMP=0x000000000059d6bb
- (id)initWithCategory:(unsigned long long)arg1 subcategory:(unsigned long long)arg2 momentNode:(id)arg3;	// IMP=0x000000000059d620
- (id)initWithCategory:(unsigned long long)arg1 subcategory:(unsigned long long)arg2;	// IMP=0x000000000059d5c6
