...
- (void).cxx_destruct;	// IMP=0x000000000019ad74
...
- (_Bool)_distributeChangesInFetchResult:(id)arg1;	// IMP=0x000000000019a5fd
- (void)_clearConsumerTokenState;	// IMP=0x000000000019a555
- (id)_consumer:(id)arg1 withChangeTokens:(id)arg2 processedChangeTokens:(id)arg3 consumedTokens:(_Bool)arg4;	// IMP=0x000000000019a09b
- (void)consumer:(id)arg1 didIgnoreChangeTokens:(id)arg2;	// IMP=0x0000000000199f9f
- (void)consumer:(id)arg1 didConsumeChangeTokens:(id)arg2;	// IMP=0x0000000000199ea3
- (void)_notifyConsumersWithChangesFromFromChangeToken:(id)arg1;	// IMP=0x0000000000199de0
@property(readonly, nonatomic) PHPersistentChangeToken *currentToken;
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x0000000000199d55
- (void)persistToken:(id)arg1;	// IMP=0x0000000000199ce3
- (void)unregisterChangeConsumer:(id)arg1;	// IMP=0x0000000000199c56
- (void)registerChangeConsumer:(id)arg1;	// IMP=0x0000000000199bc9
- (void)stopListening;	// IMP=0x0000000000199b7e
- (void)startListening;	// IMP=0x0000000000199b33
- (void)photoLibraryDidBecomeUnavailable:(id)arg1;	// IMP=0x0000000000199b00
- (id)initWithPhotoLibrary:(id)arg1 clientIdentifier:(id)arg2 analytics:(id)arg3;	// IMP=0x0000000000199834
