...
- (void).cxx_destruct;	// IMP=0x00000000004eced3
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x00000000004ecd62
- (id)initWithMemoryCategory:(unsigned long long)arg1 memoryCategorySubcategory:(unsigned long long)arg2 momentNodes:(id)arg3 featureNodes:(id)arg4;	// IMP=0x00000000004eccb1
