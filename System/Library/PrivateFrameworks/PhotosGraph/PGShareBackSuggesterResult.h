...
+ (id)momentNodesForSuggesterResults:(id)arg1;	// IMP=0x00000000002333fe
- (void).cxx_destruct;	// IMP=0x00000000002333d6
...
- (id)description;	// IMP=0x00000000002332dc
- (id)initWithInputs:(id)arg1 processingValue:(unsigned short)arg2 momentNodes:(id)arg3;	// IMP=0x000000000023321c
