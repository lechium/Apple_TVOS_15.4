...
+ (id)criteriaWithDictionary:(id)arg1;	// IMP=0x0000000000274822
+ (id)criteriaKey;	// IMP=0x0000000000274815
- (void).cxx_destruct;	// IMP=0x0000000000275350
...
- (_Bool)isValid;	// IMP=0x0000000000274d83
- (_Bool)passesForAssets:(id)arg1;	// IMP=0x0000000000274d7b
- (_Bool)passesForMomentNode:(id)arg1 momentNodeCache:(id)arg2;	// IMP=0x0000000000274aea
