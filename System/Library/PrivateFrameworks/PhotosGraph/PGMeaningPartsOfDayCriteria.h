...
+ (id)_partsOfDayNumbersByString;	// IMP=0x0000000000380ac8
+ (id)_partsOfDayAsNumbersFromStrings:(id)arg1;	// IMP=0x00000000003808ae
+ (id)criteriaWithDictionary:(id)arg1;	// IMP=0x0000000000380698
+ (id)criteriaKey;	// IMP=0x000000000038068b
- (void).cxx_destruct;	// IMP=0x00000000003816a4
...
- (_Bool)_passesPartsOfDayWithMomentNodePartsOfDay:(unsigned long long)arg1 positivePartsOfDay:(id)arg2 negativePartsOfDay:(id)arg3;	// IMP=0x0000000000381312
@property(readonly, copy) NSString *description;
- (_Bool)isValid;	// IMP=0x0000000000380c01
- (_Bool)passesForAssets:(id)arg1;	// IMP=0x0000000000380bf9
- (_Bool)passesForMomentNode:(id)arg1 momentNodeCache:(id)arg2;	// IMP=0x0000000000380ad5
