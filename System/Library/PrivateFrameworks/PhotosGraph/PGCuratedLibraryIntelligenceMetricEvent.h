...
+ (id)librarySizeRangeDescriptionForLibrarySizeRange:(long long)arg1;	// IMP=0x0000000000207a24
- (void).cxx_destruct;	// IMP=0x000000000020503a
...
- (id)_longTripDayGroups;	// IMP=0x0000000000204755
- (id)_shortTripDayGroups;	// IMP=0x000000000020467f
- (id)_daysWithinTrips;	// IMP=0x00000000002045a9
- (id)_aggregationGroups;	// IMP=0x00000000002044d3
- (id)_daysWithinAggregations;	// IMP=0x00000000002043fd
- (id)_defaultHightlights;	// IMP=0x000000000020432a
- (unsigned long long)_numberOfDayHighlights;	// IMP=0x0000000000204270
- (id)_dayHighlights;	// IMP=0x00000000002041da
- (double)_ratioFromNumerator:(unsigned long long)arg1 denominator:(unsigned long long)arg2;	// IMP=0x000000000020418f
- (id)utilityPredicate;	// IMP=0x0000000000204162
- (id)_assetsStatisticsInHighlights:(id)arg1 photoLibrary:(id)arg2 includeUtility:(_Bool)arg3;	// IMP=0x0000000000203da6
- (unsigned long long)_debugNumberOfAssets;	// IMP=0x0000000000203c92
- (id)payload;	// IMP=0x000000000020355b
- (void)_saveKey:(id)arg1 stringValue:(id)arg2 payload:(id)arg3;	// IMP=0x000000000020353d
- (void)_saveKey:(id)arg1 integerValue:(unsigned long long)arg2 payload:(id)arg3;	// IMP=0x00000000002034ab
- (void)_saveKey:(id)arg1 doubleValue:(double)arg2 payload:(id)arg3;	// IMP=0x00000000002033f2
- (void)_fillProcessingLevelStatisticsWithGraph:(id)arg1;	// IMP=0x0000000000203262
- (void)_fillMomentsStatisticsWithGraph:(id)arg1;	// IMP=0x000000000020320b
- (void)_fillKeyAssetsStatisticsWithGraph:(id)arg1;	// IMP=0x0000000000202f1c
- (void)_fillOnesiesHighlightStatisticsWithGraph:(id)arg1;	// IMP=0x0000000000202bfe
- (void)_fillHiddenHighlightsStatisticsWithGraph:(id)arg1;	// IMP=0x0000000000202ac0
- (void)_fillYearHighlightsStatisticsWithGraph:(id)arg1;	// IMP=0x00000000002029dd
- (void)_fillMonthHighlightsStatisticsWithGraph:(id)arg1;	// IMP=0x0000000000202426
- (void)_fillAestheticAndBehavioralCurationStatisticsWithGraph:(id)arg1;	// IMP=0x0000000000202015
- (void)_fillContentScoreStatisticsWithGraph:(id)arg1 withProgressBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000002017e3
- (void)_fillDayHighlightsStatisticsWithGraph:(id)arg1 withProgressBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000200690
- (void)_fillGenericStatisticsWithGraph:(id)arg1;	// IMP=0x00000000002002ec
- (void)gatherMetricsWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000200212
- (id)identifier;	// IMP=0x0000000000200205
- (id)initWithGraphManager:(id)arg1;	// IMP=0x000000000020015e
