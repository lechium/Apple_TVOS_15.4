...
+ (id)contextWithMusicCache:(id)arg1 actionSource:(id)arg2 shouldForceMetadataRefetch:(_Bool)arg3;	// IMP=0x00000000000b11a0
- (void).cxx_destruct;	// IMP=0x00000000000b12f0
- (id)init;	// IMP=0x00000000000b1290
