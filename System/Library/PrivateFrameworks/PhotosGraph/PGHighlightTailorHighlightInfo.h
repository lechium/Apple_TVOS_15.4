...
- (void).cxx_destruct;	// IMP=0x00000000003f57d6
...
- (id)initForTestingWithHighlight:(id)arg1;	// IMP=0x00000000003f5447
- (id)initWithHighlight:(id)arg1 graph:(id)arg2 highlightTailorContext:(id)arg3;	// IMP=0x00000000003f4cbf
