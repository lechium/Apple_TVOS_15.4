...
- (void).cxx_destruct;	// IMP=0x000000000055ac21
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055ab71
- (id)initWithKeyword:(id)arg1 score:(double)arg2;	// IMP=0x000000000055aaf7
