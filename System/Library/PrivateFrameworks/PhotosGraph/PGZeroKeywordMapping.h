...
{
    PGGraphMeaningNode *_displayNode;	// 8 = 0x8
    NSArray *_mappedMeaningNodes;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x00000000002ad62a
...
- (id)initWithDisplayNode:(id)arg1 mappedMeaningNodes:(id)arg2;	// IMP=0x00000000002ad57d
