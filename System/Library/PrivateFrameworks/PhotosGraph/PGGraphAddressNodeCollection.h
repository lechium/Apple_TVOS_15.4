...
+ (id)addressNodesWithinDistance:(double)arg1 ofLocations:(id)arg2 inGraph:(id)arg3;	// IMP=0x000000000047571f
+ (id)addressNodesForUUIDs:(id)arg1 inGraph:(id)arg2;	// IMP=0x00000000004755eb
+ (id)addressNodeAsCollectionForUUID:(id)arg1 inGraph:(id)arg2;	// IMP=0x00000000004754b7
+ (Class)nodeClass;	// IMP=0x00000000004754a6
...
- (void)enumerateLongitudesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000475140
- (void)enumerateLatitudesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000475124
...
- (id)addressNodes;	// IMP=0x0000000000474ac2
