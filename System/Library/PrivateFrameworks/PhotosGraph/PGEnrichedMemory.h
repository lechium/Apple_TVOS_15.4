...
- (void).cxx_destruct;	// IMP=0x00000000003f9088
...
- (id)enrichedDescription;	// IMP=0x00000000003f8c11
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x00000000003f8a14
...
- (id)initWithTriggeredMemory:(id)arg1;	// IMP=0x00000000003f8853
