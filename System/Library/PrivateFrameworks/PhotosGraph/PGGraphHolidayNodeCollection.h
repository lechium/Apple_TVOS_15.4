...
+ (id)holidayNodesWithCategory:(unsigned long long)arg1 inGraph:(id)arg2;	// IMP=0x00000000004b8ff7
+ (id)holidayNodesWithNames:(id)arg1 inGraph:(id)arg2;	// IMP=0x00000000004b8f65
+ (id)holidayNodesWithName:(id)arg1 inGraph:(id)arg2;	// IMP=0x00000000004b8e8d
+ (Class)nodeClass;	// IMP=0x00000000004b8e7c
