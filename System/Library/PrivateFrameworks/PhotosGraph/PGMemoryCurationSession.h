...
- (void).cxx_destruct;	// IMP=0x00000000004bec96
...
- (id)initWithCurationManager:(id)arg1 photoLibrary:(id)arg2 curationContext:(id)arg3 locationHelper:(id)arg4;	// IMP=0x00000000004beb85
