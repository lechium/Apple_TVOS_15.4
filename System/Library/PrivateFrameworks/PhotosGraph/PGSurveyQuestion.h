...
- (void).cxx_destruct;	// IMP=0x0000000000424f62
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000424ec0
@property(readonly) unsigned long long hash;
- (_Bool)isEquivalentToQuestion:(id)arg1;	// IMP=0x0000000000424c9c
- (_Bool)isEquivalentToPersistedQuestion:(id)arg1;	// IMP=0x0000000000424abc
@property(readonly, nonatomic) unsigned short entityType;
@property(readonly, nonatomic) unsigned short displayType;
@property(readonly, nonatomic) unsigned short type;
- (void)remove;	// IMP=0x0000000000424822
- (void)persistWithCreationDate:(id)arg1;	// IMP=0x00000000004246fe
