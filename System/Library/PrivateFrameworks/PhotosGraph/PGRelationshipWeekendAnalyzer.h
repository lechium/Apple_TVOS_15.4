...
- (void).cxx_destruct;	// IMP=0x00000000004db51b
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000004dad7b
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x00000000004dad17
