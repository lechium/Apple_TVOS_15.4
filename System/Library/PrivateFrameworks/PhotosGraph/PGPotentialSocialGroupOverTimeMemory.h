...
- (void).cxx_destruct;	// IMP=0x000000000039a758
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x000000000039a54d
- (unsigned long long)memoryCategory;	// IMP=0x000000000039a542
- (id)initWithSocialGroupNode:(id)arg1 momentNodes:(id)arg2;	// IMP=0x000000000039a14e
