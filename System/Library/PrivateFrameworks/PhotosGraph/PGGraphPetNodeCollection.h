...
+ (id)petNodesForSpecies:(unsigned long long)arg1 inGraph:(id)arg2;	// IMP=0x000000000041b84a
+ (id)petNodesForLocalIdentifier:(id)arg1 inGraph:(id)arg2;	// IMP=0x000000000041b715
+ (Class)nodeClass;	// IMP=0x000000000041b704
