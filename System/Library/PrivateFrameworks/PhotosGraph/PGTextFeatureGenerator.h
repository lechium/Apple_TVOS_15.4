...
+ (id)_knowledgeOptionsByDomain;	// IMP=0x00000000003078b6
+ (id)_naturalLanguageOptionsByDomain;	// IMP=0x0000000000307745
- (void).cxx_destruct;	// IMP=0x0000000000306be5
...
- (id)_sortedTextFeaturesUsingWeightAndTypeFromTextFeatures:(id)arg1;	// IMP=0x000000000030651f
- (id)_textFeaturesForPersonNodes:(id)arg1;	// IMP=0x0000000000306216
- (id)_textFeaturesForNode:(id)arg1 type:(unsigned long long)arg2 weight:(float)arg3;	// IMP=0x000000000030612f
- (id)_textFeaturesForNodes:(id)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000305edf
- (id)bestTextFeaturesFromTextFeatures:(id)arg1;	// IMP=0x0000000000305718
- (id)generateTextFeatures;	// IMP=0x0000000000304aac
- (void)analyzeMomentNodes;	// IMP=0x00000000003041e4
- (id)naturalLanguageFeatures;	// IMP=0x0000000000303ef9
- (id)knowledgeFeatures;	// IMP=0x0000000000303b9f
- (_Bool)boundTextFeaturesPerEvent;	// IMP=0x0000000000303b86
- (unsigned long long)maximumNumberOfTextFeaturesPerEvent;	// IMP=0x0000000000303b6d
- (void)_resetProperties;	// IMP=0x0000000000303905
- (id)initWithMomentNodes:(id)arg1;	// IMP=0x0000000000303690
