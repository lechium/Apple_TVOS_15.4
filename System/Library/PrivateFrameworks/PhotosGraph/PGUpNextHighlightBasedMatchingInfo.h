...
+ (id)matchingInfosWithHighlightNodes:(id)arg1;	// IMP=0x0000000000557c97
- (void).cxx_destruct;	// IMP=0x0000000000557c84
...
- (id)initWithHighlightNodeAsCollection:(id)arg1 momentNodes:(id)arg2;	// IMP=0x0000000000557b14
- (id)initWithHighlightNodeAsCollection:(id)arg1;	// IMP=0x0000000000557a7b
