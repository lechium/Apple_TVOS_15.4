...
+ (unsigned long long)_shareSheetSharingStream;	// IMP=0x00000000003f602c
+ (id)optionsForClient:(unsigned long long)arg1;	// IMP=0x00000000003f5f3e
...
- (id)description;	// IMP=0x00000000003f5d8c
- (id)init;	// IMP=0x00000000003f5d3d
