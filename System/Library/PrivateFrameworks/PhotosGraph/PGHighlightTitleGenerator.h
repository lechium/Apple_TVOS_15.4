...
+ (id)meaningLabelsSortedByPriority;	// IMP=0x000000000023e3a6
+ (_Bool)collectionContainsAppleEvent:(id)arg1;	// IMP=0x000000000023e27f
+ (id)commonMeaningLabelForTitleUsingMomentNodes:(id)arg1;	// IMP=0x000000000023dd10
- (void).cxx_destruct;	// IMP=0x000000000023dcc7
...
- (void)_generateTitleTuples;	// IMP=0x000000000023d81c
- (id)initWithCollection:(id)arg1 curatedAssetCollection:(id)arg2 keyAsset:(id)arg3 createVerboseTitle:(_Bool)arg4 titleGenerationContext:(id)arg5;	// IMP=0x000000000023d709
