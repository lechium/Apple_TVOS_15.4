...
- (void).cxx_destruct;	// IMP=0x00000000003c49a8
...
- (void)_generateTitleAndSubtitleWithManager:(id)arg1 curationContext:(id)arg2 result:(CDUnknownBlockType)arg3;	// IMP=0x00000000003c455c
- (id)initWithCollection:(id)arg1 keyAsset:(id)arg2 curatedAssetCollection:(id)arg3 titleGenerationContext:(id)arg4;	// IMP=0x00000000003c4410
