...
- (void).cxx_destruct;	// IMP=0x000000000041ce2d
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x000000000041cc18
- (unsigned long long)memoryCategorySubcategory;	// IMP=0x000000000041cc0d
- (unsigned long long)memoryCategory;	// IMP=0x000000000041cc02
- (id)initWithSupersetLocationNode:(id)arg1 supersetDateInterval:(id)arg2 interestingMomentNodes:(id)arg3 momentNodes:(id)arg4;	// IMP=0x000000000041cb1e
