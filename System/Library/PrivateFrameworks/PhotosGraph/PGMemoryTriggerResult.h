...
- (void).cxx_destruct;	// IMP=0x0000000000148443
...
- (id)description;	// IMP=0x00000000001483a5
- (id)initWithMemoryNode:(id)arg1 validityInterval:(id)arg2;	// IMP=0x000000000014830c
