...
- (void).cxx_destruct;	// IMP=0x000000000019033f
...
- (id)memoryFeatureNodesInGraph:(id)arg1;	// IMP=0x00000000001902a6
@property(readonly, copy) NSString *description;
- (id)initWithMemoryNode:(id)arg1 validityIntervalByTriggerType:(id)arg2 creationDate:(id)arg3;	// IMP=0x000000000019004b
- (id)initWithMemoryCategory:(unsigned long long)arg1 memoryCategorySubcategory:(unsigned long long)arg2 memoryMomentNodes:(id)arg3 memoryFeatureNodes:(id)arg4 validityIntervalByTriggerType:(id)arg5 creationDate:(id)arg6 uniqueMemoryIdentifier:(id)arg7;	// IMP=0x000000000018ff6f
- (id)initWithMemoryCategory:(unsigned long long)arg1 memoryCategorySubcategory:(unsigned long long)arg2 memoryMomentNodes:(id)arg3 memoryFeatureNodes:(id)arg4 validityIntervalByTriggerType:(id)arg5 creationDate:(id)arg6 uniqueMemoryIdentifier:(id)arg7 photosGraphVersion:(long long)arg8;	// IMP=0x000000000018fc97
