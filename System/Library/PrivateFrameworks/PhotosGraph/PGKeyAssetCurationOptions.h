...
- (void).cxx_destruct;	// IMP=0x0000000000348772
...
- (id)dictionaryRepresentation;	// IMP=0x000000000034813e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000348088
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000347bd7
- (id)initWithReferenceAsset:(id)arg1;	// IMP=0x0000000000347ab5
- (id)init;	// IMP=0x0000000000347a59
