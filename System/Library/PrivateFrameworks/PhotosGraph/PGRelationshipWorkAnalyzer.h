...
- (void).cxx_destruct;	// IMP=0x000000000059190d
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000059109d
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x0000000000591039
