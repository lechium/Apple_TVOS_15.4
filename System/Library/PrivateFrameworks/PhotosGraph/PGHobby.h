...
- (void).cxx_destruct;	// IMP=0x0000000000506f9a
...
- (id)description;	// IMP=0x0000000000506e84
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000506d3f
- (unsigned long long)hash;	// IMP=0x0000000000506aee
