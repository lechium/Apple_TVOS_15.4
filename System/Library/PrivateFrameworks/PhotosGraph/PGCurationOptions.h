...
+ (id)defaultOptions;	// IMP=0x0000000000220f3f
- (void).cxx_destruct;	// IMP=0x0000000000220f0c
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000220763
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000220620
- (id)description;	// IMP=0x0000000000220571
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000021ff63
- (id)initWithDuration:(unsigned long long)arg1 precision:(unsigned long long)arg2;	// IMP=0x000000000021fedd
