...
+ (id)matchingInfosWithMemoryNodes:(id)arg1;	// IMP=0x000000000055795e
+ (id)representativeSceneNodesForMemoryFeatureNodes:(id)arg1;	// IMP=0x00000000005575dd
- (void).cxx_destruct;	// IMP=0x000000000055759f
...
- (id)initWithMemoryNodeAsCollection:(id)arg1;	// IMP=0x0000000000557283
