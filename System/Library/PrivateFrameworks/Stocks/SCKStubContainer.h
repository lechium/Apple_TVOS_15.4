...
- (void).cxx_destruct;	// IMP=0x000000000004ba7e
...
- (long long)_ckErrorCodeForErrorMode:(long long)arg1;	// IMP=0x000000000004b8ac
- (id)_errorForErrorMode:(long long)arg1 itemIDs:(id)arg2;	// IMP=0x000000000004b5f3
- (id)_errorForErrorMode:(long long)arg1;	// IMP=0x000000000004b596
- (void)accountInfoWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000004b48b
- (void)addDatabaseOperation:(id)arg1;	// IMP=0x0000000000048b02
- (id)recordWithName:(id)arg1 inZone:(id)arg2;	// IMP=0x00000000000489e7
- (id)contentsOfZone:(id)arg1 withType:(id)arg2;	// IMP=0x0000000000048899
- (id)contentsOfZone:(id)arg1;	// IMP=0x00000000000487c9
- (void)setContentsOfZone:(id)arg1 toRecords:(id)arg2;	// IMP=0x000000000004855f
- (id)init;	// IMP=0x00000000000484b2
