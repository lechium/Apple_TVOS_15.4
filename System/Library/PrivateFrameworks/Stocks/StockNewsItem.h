...
+ (id)localizedStringForDate:(id)arg1;	// IMP=0x000000000001e0dd
- (void).cxx_destruct;	// IMP=0x000000000001e95c
...
- (id)description;	// IMP=0x000000000001e847
@property(readonly, retain, nonatomic) NSString *localizedDateString;
- (long long)chronologicalComparisonWithNewsItem:(id)arg1;	// IMP=0x000000000001e779
- (id)archiveDictionary;	// IMP=0x000000000001e620
- (id)initWithArchiveDictionary:(id)arg1;	// IMP=0x000000000001e35a
- (void)resetLocale;	// IMP=0x000000000001e301
