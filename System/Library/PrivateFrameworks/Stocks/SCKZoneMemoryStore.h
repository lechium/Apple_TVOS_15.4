...
- (void).cxx_destruct;	// IMP=0x000000000001cc78
...
- (void)clearPendingCommandsUpToCount:(unsigned long long)arg1;	// IMP=0x000000000001cb9e
- (void)addPendingCommands:(id)arg1;	// IMP=0x000000000001cb16
- (void)applyServerRecordsDiff:(id)arg1;	// IMP=0x000000000001ca8e
- (id)init;	// IMP=0x000000000001ca26
