...
- (void).cxx_destruct;	// IMP=0x0000000000026a3d
...
- (void)clearPendingCommandsUpToCount:(unsigned long long)arg1;	// IMP=0x000000000002694a
- (void)addPendingCommands:(id)arg1;	// IMP=0x0000000000026914
- (void)applyServerRecordsDiff:(id)arg1;	// IMP=0x000000000002688c
- (id)initWithZoneName:(id)arg1 serverRecords:(id)arg2 lastSyncDate:(id)arg3 lastDirtyDate:(id)arg4 serverChangeToken:(id)arg5 pendingCommands:(id)arg6;	// IMP=0x000000000002674f
