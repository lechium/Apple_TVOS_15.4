...
- (void).cxx_destruct;	// IMP=0x000000000000b475
...
- (id)validateRecords:(id)arg1;	// IMP=0x000000000000b373
- (_Bool)isValidRecord:(id)arg1;	// IMP=0x000000000000b0b8
- (id)schemaForRecordType:(id)arg1;	// IMP=0x000000000000aee5
@property(readonly, copy, nonatomic) NSArray *allRecordFieldNames;
- (id)initWithName:(id)arg1 atomic:(_Bool)arg2 recordSchemas:(id)arg3;	// IMP=0x000000000000ac5b
