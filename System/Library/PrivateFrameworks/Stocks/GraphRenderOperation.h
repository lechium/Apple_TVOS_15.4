...
- (void).cxx_destruct;	// IMP=0x0000000000032a29
...
- (void)renderVolumeGraph;	// IMP=0x0000000000032684
- (void)renderLineGraph;	// IMP=0x00000000000316d1
- (void)renderGraphLineInContext:(struct CGContext *)arg1 withColor:(id)arg2 offset:(struct CGPoint)arg3;	// IMP=0x00000000000313f7
- (struct CGSize)lineGraphSize;	// IMP=0x00000000000313c2
- (void)render;	// IMP=0x0000000000031291
- (void)cancel;	// IMP=0x0000000000031287
