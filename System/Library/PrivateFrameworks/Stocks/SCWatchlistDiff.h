...
+ (id)reorderedStocksFrom:(id)arg1 to:(id)arg2;	// IMP=0x0000000000030faa
- (void).cxx_destruct;	// IMP=0x0000000000031228
...
- (id)initWithOldStocks:(id)arg1 newStocks:(id)arg2;	// IMP=0x000000000003089f
