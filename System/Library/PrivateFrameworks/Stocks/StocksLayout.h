...
+ (unsigned long long)numberOfRowsForSize:(struct CGSize)arg1;	// IMP=0x00000000000114c1
+ (id)threeColumnsLandscapeLayoutForSize:(struct CGSize)arg1;	// IMP=0x0000000000010bcb
+ (id)twoColumnsLandscapeLayoutForSize:(struct CGSize)arg1;	// IMP=0x0000000000010260
+ (id)fullScreenChartLayoutForSize:(struct CGSize)arg1;	// IMP=0x000000000000fd85
+ (id)twoColumnsPortraitLayoutForSize:(struct CGSize)arg1;	// IMP=0x000000000000f40d
+ (id)singleColumnPortraitLayoutForSize:(struct CGSize)arg1;	// IMP=0x000000000000e867
+ (id)layoutForSize:(struct CGSize)arg1;	// IMP=0x000000000000e7eb
- (void).cxx_destruct;	// IMP=0x0000000000011e04
...
- (id)description;	// IMP=0x0000000000011661
