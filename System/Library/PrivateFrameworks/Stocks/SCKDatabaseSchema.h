...
- (void).cxx_destruct;	// IMP=0x0000000000018182
...
- (id)schemaForZoneName:(id)arg1;	// IMP=0x0000000000017f6e
...
- (id)initWithName:(id)arg1 environment:(long long)arg2 security:(long long)arg3 zoneSchemas:(id)arg4;	// IMP=0x0000000000017c48
