...
+ (id)contextWithContext:(id)arg1;	// IMP=0x000000000000300c
+ (_Bool)accessInstanceVariablesDirectly;	// IMP=0x0000000000003004
- (void).cxx_destruct;	// IMP=0x00000000000031f9
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000316f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003164
