...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000158ae
- (void).cxx_destruct;	// IMP=0x00000000000185a5
...
- (id)description;	// IMP=0x0000000000018389
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000176aa
@property(readonly, copy, nonatomic) NSDictionary *legacyOptionsDictionary;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016bb3
- (id)initWithLegacyOptionsDictionary:(id)arg1;	// IMP=0x0000000000016118
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000015ceb
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000158b6
