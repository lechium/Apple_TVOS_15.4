...
+ (id)sharedInstance;	// IMP=0x00000000000046ad
- (void).cxx_destruct;	// IMP=0x0000000000006c31
...
- (void)reScanInternalApps;	// IMP=0x0000000000006969
- (void)reScanCoreServicesApps;	// IMP=0x0000000000006927
- (void)reScanSystemApps;	// IMP=0x00000000000068c7
...
- (void)setSystemAppPlaceholderBundleIDToInfoMap:(id)arg1;	// IMP=0x0000000000005d3a
...
- (id)_bundleIDMapForAppsInDirectory:(id)arg1;	// IMP=0x00000000000058cd
- (id)_bundleIDMapForAppsInDirectory:(id)arg1 loadingAdditionalKeys:(id)arg2;	// IMP=0x00000000000058b1
- (id)_bundleIDMapForBundlesInDirectory:(id)arg1 withExtension:(id)arg2;	// IMP=0x000000000000589c
- (id)_bundleIDMapForBundlesInDirectory:(id)arg1 withExtension:(id)arg2 loadingAdditionalKeys:(id)arg3;	// IMP=0x00000000000053ba
...
- (id)disableSystemAppDeletionCanaryFile;	// IMP=0x0000000000004be6
...
- (id)init;	// IMP=0x00000000000045ce
