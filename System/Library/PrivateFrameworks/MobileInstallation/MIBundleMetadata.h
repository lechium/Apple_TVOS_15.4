...
+ (id)metadataFromURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000347d1
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000033890
- (void).cxx_destruct;	// IMP=0x0000000000034e81
...
- (_Bool)serializeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000034b35
- (id)description;	// IMP=0x00000000000345c0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003408b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000033dd5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000033b51
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000033898
