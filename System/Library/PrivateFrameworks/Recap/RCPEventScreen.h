...
- (void).cxx_destruct;	// IMP=0x000000000000aaa4
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000a9af
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000a923
- (id)description;	// IMP=0x000000000000a8bc
