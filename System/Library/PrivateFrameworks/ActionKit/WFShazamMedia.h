...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000029e844
- (void).cxx_destruct;	// IMP=0x000000000029e5dc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000029e467
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000029e22e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000029e223
@property(readonly, copy, nonatomic) NSString *wfName;
- (id)description;	// IMP=0x000000000029e119
- (id)initWithMediaItem:(id)arg1;	// IMP=0x000000000029ddaa
