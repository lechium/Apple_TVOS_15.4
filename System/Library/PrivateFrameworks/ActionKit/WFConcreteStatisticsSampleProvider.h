...
- (void).cxx_destruct;	// IMP=0x000000000018d69c
@property(retain, nonatomic) NSObject<WFStatisticsSampleProvider> *sampleProvider; // @synthesize sampleProvider=_sampleProvider;
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000018d605
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000018d5a6
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000018d594
- (id)initWithSampleProvider:(id)arg1;	// IMP=0x000000000018d574
