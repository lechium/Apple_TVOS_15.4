...
+ (id)termIdJSONTransformer;	// IMP=0x00000000001de428
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000001de394
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001de38c
- (void).cxx_destruct;	// IMP=0x00000000001de474
