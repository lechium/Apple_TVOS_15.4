...
- (void).cxx_destruct;	// IMP=0x0000000000216f04
...
- (void)cancel;	// IMP=0x0000000000216e6e
- (void)flush;	// IMP=0x0000000000216b95
- (id)newRequest;	// IMP=0x0000000000216a61
- (void)write:(const char *)arg1 offset:(unsigned int)arg2 length:(unsigned int)arg3;	// IMP=0x00000000002169fe
- (int)readAll:(char *)arg1 offset:(int)arg2 length:(int)arg3;	// IMP=0x000000000021695b
- (id)initWithURL:(id)arg1 userAgent:(id)arg2 timeout:(int)arg3;	// IMP=0x000000000021686c
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000216855
