...
- (void).cxx_destruct;	// IMP=0x00000000001f0232
...
- (unsigned long long)status;	// IMP=0x00000000001f01c0
- (void)action:(id)arg1 parameterStateDidChangeForKey:(id)arg2;	// IMP=0x00000000001f011a
- (Class)accountClass;	// IMP=0x00000000001f0059
