...
+ (id)bookmarkWithBookmarkID:(long long)arg1;	// IMP=0x0000000000262e8d
...
- (void)dealloc;	// IMP=0x0000000000262d35
- (id)description;	// IMP=0x0000000000262c9f
- (id)initWithBookmarkID:(long long)arg1;	// IMP=0x0000000000262c39
- (id)init;	// IMP=0x0000000000262c1d
