...
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000003711e2
+ (id)allowedSecureCodingClassesByPropertyKey;	// IMP=0x000000000037107d
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000371075
- (void).cxx_destruct;	// IMP=0x00000000003712f4
