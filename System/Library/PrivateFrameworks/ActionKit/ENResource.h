...
+ (id)resourceWithServiceResource:(id)arg1;	// IMP=0x00000000002e2903
- (void).cxx_destruct;	// IMP=0x00000000002e28a4
...
- (id)EDAMResource;	// IMP=0x00000000002e2016
- (id)initWithData:(id)arg1 mimeType:(id)arg2;	// IMP=0x00000000002e1e4a
- (id)initWithData:(id)arg1 mimeType:(id)arg2 filename:(id)arg3;	// IMP=0x00000000002e1cbb
