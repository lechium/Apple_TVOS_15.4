...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000022d10c
- (void).cxx_destruct;	// IMP=0x000000000022d0b8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000022ce6c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000022cb72
