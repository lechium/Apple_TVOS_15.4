...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000192c03
- (void).cxx_destruct;	// IMP=0x0000000000192bd0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000192b2f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000192a1d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000192a12
@property(readonly, copy, nonatomic) NSString *wfName;
- (id)initWithAirPollutant:(id)arg1;	// IMP=0x0000000000192758
