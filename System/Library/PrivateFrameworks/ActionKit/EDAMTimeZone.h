...
@interface EDAMTimeZone
{
    ...
    NSNumber *_rawUTCOffsetMillis;	// 24 = 0x18
    NSNumber *_dstSavingsAdjustmentMillis;	// 32 = 0x20
    NSNumber *_nextEnterDaylightSavings;	// 40 = 0x28
    NSNumber *_nextLeaveDaylightSavings;	// 48 = 0x30
}

+ (id)structFields;	// IMP=0x00000000001a8774
+ (id)structName;	// IMP=0x00000000001a8767
- (void).cxx_destruct;	// IMP=0x00000000001a8a49
