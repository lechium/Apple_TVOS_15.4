...
- (void).cxx_destruct;	// IMP=0x000000000036dcdc
...
- (void)action:(id)arg1 parameterStateDidChangeForKey:(id)arg2;	// IMP=0x000000000036d96b
- (void)loadRideOptionsValueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000036d8ba
- (void)loadPossibleStatesForEnumeration:(id)arg1 searchTerm:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000036d7fe
- (id)enumeration:(id)arg1 localizedLabelForPossibleState:(id)arg2;	// IMP=0x000000000036d63a
- (id)init;	// IMP=0x000000000036ceec
