...
+ (id)rangeErrorIntentResponseWithRangeErrorGroupNumber:(id)arg1 rangeErrorGroupCount:(id)arg2;	// IMP=0x0000000000373baf
+ (id)noMatchIntentResponseWithNoMatchIndex:(id)arg1;	// IMP=0x0000000000373b41
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x0000000000373aa5
