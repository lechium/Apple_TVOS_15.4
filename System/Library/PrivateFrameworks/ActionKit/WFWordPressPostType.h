...
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000001de5bc
+ (id)allowedSecureCodingClassesByPropertyKey;	// IMP=0x00000000001de4be
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001de4b6
- (void).cxx_destruct;	// IMP=0x00000000001de67c
