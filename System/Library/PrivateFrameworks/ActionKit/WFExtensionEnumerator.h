...
- (void).cxx_destruct;	// IMP=0x0000000000370460
...
- (void)enumerateExtensions;	// IMP=0x000000000036fb2b
- (void)dealloc;	// IMP=0x000000000036faea
- (id)initWithExtensionPointIdentifier:(id)arg1;	// IMP=0x000000000036f8d9
