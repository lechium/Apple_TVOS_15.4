...
+ (unsigned long long)storageBehaviorForPropertyWithKey:(id)arg1;	// IMP=0x00000000003522e9
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000003522cd
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003522c5
- (void).cxx_destruct;	// IMP=0x0000000000352458
...
- (id)initWithLocalIdentifier:(id)arg1 localizedTitle:(id)arg2;	// IMP=0x0000000000352360
