...
- (void).cxx_destruct;	// IMP=0x00000000002004ec
...
- (_Bool)resumeSessionWithURL:(id)arg1;	// IMP=0x00000000001ffe46
- (id)initWithClientID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001ff811
