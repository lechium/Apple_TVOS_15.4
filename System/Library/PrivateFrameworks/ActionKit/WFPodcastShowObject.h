...
+ (id)childrenJSONTransformer;	// IMP=0x00000000001dd421
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000001dd36f
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001dd367
- (void).cxx_destruct;	// IMP=0x00000000001dd303
