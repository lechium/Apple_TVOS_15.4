...
+ (id)releaseDateJSONTransformer;	// IMP=0x0000000000337b21
+ (id)durationJSONTransformer;	// IMP=0x0000000000337b08
+ (id)descriptionTextJSONTransformer;	// IMP=0x0000000000337ae8
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x000000000033798d
+ (id)allowedSecureCodingClassesByPropertyKey;	// IMP=0x000000000033788f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000337887
- (void).cxx_destruct;	// IMP=0x0000000000337c94
