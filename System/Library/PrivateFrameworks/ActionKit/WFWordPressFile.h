...
+ (id)fileIdJSONTransformer;	// IMP=0x00000000001de2dc
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000001de232
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001de22a
- (void).cxx_destruct;	// IMP=0x00000000001de339
