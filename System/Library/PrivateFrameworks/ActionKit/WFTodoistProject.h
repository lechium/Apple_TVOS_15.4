...
+ (id)collapsedJSONTransformer;	// IMP=0x00000000002e9e6e
+ (id)colorJSONTransformer;	// IMP=0x00000000002e9910
+ (id)JSONKeyPathsByPropertyKey;	// IMP=0x00000000002e986d
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002e9865
- (void).cxx_destruct;	// IMP=0x00000000002e9eca
