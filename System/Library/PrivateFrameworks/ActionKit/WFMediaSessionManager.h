...
- (void).cxx_destruct;	// IMP=0x00000000001d9726
...
- (void)lookupMediaType:(long long)arg1 withIdentifiers:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001d94f6
- (id)initWithClientIdentifier:(id)arg1 clientVersion:(id)arg2;	// IMP=0x00000000001d92c7
- (id)init;	// IMP=0x00000000001d92a7
