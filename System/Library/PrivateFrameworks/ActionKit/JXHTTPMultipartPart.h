...
+ (id)withMultipartType:(int)arg1 key:(id)arg2 data:(id)arg3 contentType:(id)arg4 fileName:(id)arg5 boundary:(id)arg6;	// IMP=0x000000000026c902
- (void).cxx_destruct;	// IMP=0x000000000026c8c4
...
- (unsigned long long)loadMutableData:(id)arg1 withDataInRange:(struct _NSRange)arg2;	// IMP=0x000000000026c2f0
- (long long)contentLength;	// IMP=0x000000000026c0ea
- (long long)dataLength;	// IMP=0x000000000026c04b
- (id)filePath;	// IMP=0x000000000026bfc8
