...
+ (id)effectWithColor:(id)arg1 offset:(struct CGSize)arg2 insets:(struct UIEdgeInsets)arg3 weight:(double)arg4;	// IMP=0x0000000000893a4b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000893e00
- (struct CGColor *)CGColor;	// IMP=0x0000000000893de1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000893cdc
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000893b42
- (id)initWithColor:(id)arg1 offset:(struct CGSize)arg2 insets:(struct UIEdgeInsets)arg3 weight:(double)arg4;	// IMP=0x0000000000893aac
