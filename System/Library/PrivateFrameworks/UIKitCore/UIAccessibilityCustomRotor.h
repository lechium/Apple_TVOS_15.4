...
- (void).cxx_destruct;	// IMP=0x000000000000f5b8
...
- (id)initWithSystemType:(long long)arg1 itemSearchBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000000f308
- (id)initWithAttributedName:(id)arg1 itemSearchBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000000f222
- (id)initWithName:(id)arg1 itemSearchBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000000f13c
