...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005bdf2f
- (id)initWithMovementDirection:(struct CGVector)arg1 itemSize:(struct CGSize)arg2;	// IMP=0x00000000005bde1f
