...
- (void).cxx_destruct;	// IMP=0x00000000000e74f3
...
- (id)description;	// IMP=0x00000000000e739d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e72f6
- (id)initWithHost:(id)arg1;	// IMP=0x00000000000e72b9
