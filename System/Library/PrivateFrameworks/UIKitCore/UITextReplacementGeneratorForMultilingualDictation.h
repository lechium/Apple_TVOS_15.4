...
- (void).cxx_destruct;	// IMP=0x0000000000e3b066
...
- (id)replacements;	// IMP=0x0000000000e3ad73
- (id)initWithMultilingualAlternatives:(id)arg1 stringToReplace:(id)arg2 replacementRange:(id)arg3;	// IMP=0x0000000000e3aca6
