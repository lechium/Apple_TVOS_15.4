...
- (void).cxx_destruct;	// IMP=0x0000000000f59da8
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x0000000000f59c2b
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x0000000000f59b64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f59a2e
