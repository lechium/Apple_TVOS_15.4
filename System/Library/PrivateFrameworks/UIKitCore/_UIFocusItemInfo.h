...
@interface _UIFocusItemInfo : NSObject <NSCopying>
{
    ...
    double _focusSoundPan;	// 40 = 0x28
    long long _focusTouchSensitivityStyle;	// 48 = 0x30
    _UIFocusRegion *_focusedRegion;	// 56 = 0x38
    id <UIFocusItem> _item;	// 64 = 0x40
    UIView *_containingView;	// 72 = 0x48
}

+ (id)infoWithView:(id)arg1;	// IMP=0x00000000005c13a2
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x00000000005c1348
+ (id)infoWithItem:(id)arg1;	// IMP=0x00000000005c12fa
- (void).cxx_destruct;	// IMP=0x00000000005c2ca5
...
- (id)description;	// IMP=0x00000000005c2bfa
- (void)invalidateFocusedRegion;	// IMP=0x00000000005c2bd4
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x00000000005c2a9c
- (id)_focusedRegionInCoordinateSpace:(id)arg1;	// IMP=0x00000000005c1de2
@property(readonly, nonatomic) _UIFocusRegion *focusedRegion; // @synthesize focusedRegion=_focusedRegion;
- (id)_defaultCoordinateSpace;	// IMP=0x00000000005c1c62
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005c155c
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x00000000005c147a
- (id)init;	// IMP=0x00000000005c13f1
