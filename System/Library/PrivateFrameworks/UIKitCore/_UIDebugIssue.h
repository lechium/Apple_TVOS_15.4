...
+ (id)issueWithFormat:(id)arg1;	// IMP=0x00000000005c7201
+ (id)issueWithDescription:(id)arg1;	// IMP=0x00000000005c7134
- (void).cxx_destruct;	// IMP=0x00000000005c74a7
...
- (void)addIssue:(id)arg1;	// IMP=0x00000000005c73b2
@property(readonly, copy, nonatomic) NSArray *subissues;
- (id)init;	// IMP=0x00000000005c70c4
