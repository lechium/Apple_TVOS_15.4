...
- (void).cxx_destruct;	// IMP=0x000000000065b99a
@property(retain, nonatomic) FBSceneSnapshot *sceneSnapshot; // @synthesize sceneSnapshot=_snapshot;
- (id)initWithSnapshot:(id)arg1;	// IMP=0x000000000065b7bc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000065b710
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000065b664
- (id)init;	// IMP=0x000000000065b506
