...
+ (id)sharedLoader;	// IMP=0x000000000078b04d
- (void).cxx_destruct;	// IMP=0x000000000078b6b6
@property(readonly, nonatomic) UISApplicationInitializationContext *applicationInitializationContext;
- (void)startPreloadInitializationContext;	// IMP=0x000000000078b52f
- (id)_loadInitializationContext;	// IMP=0x000000000078b2ea
- (id)_appInitializationContextFactoryClass;	// IMP=0x000000000078b229
@property(readonly, nonatomic) _Bool usesLocalInitializationContext;
@property(readonly, nonatomic) _Bool isFrontBoard;
- (void)dealloc;	// IMP=0x000000000078b103
- (id)_init;	// IMP=0x000000000078b0d4
