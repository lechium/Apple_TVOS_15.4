...
+ (id)extraView:(id)arg1 withAlignment:(int)arg2 animation:(CDUnknownBlockType)arg3 onSnapshot:(_Bool)arg4;	// IMP=0x00000000009bac9f
...
- (void)dealloc;	// IMP=0x00000000009bad2a
