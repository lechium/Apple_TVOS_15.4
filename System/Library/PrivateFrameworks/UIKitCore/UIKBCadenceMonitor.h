...
- (void).cxx_destruct;	// IMP=0x00000000009e08cc
...
- (id)init;	// IMP=0x00000000009e07d3
- (void)reset;	// IMP=0x00000000009e0751
- (void)addTypingTouchTime:(double)arg1;	// IMP=0x00000000009e070a
- (void)logUserTyping:(id)arg1;	// IMP=0x00000000009e0690
- (void)typingCadence:(double)arg1;	// IMP=0x00000000009e03be
- (void)updateConfidenceWithGap:(double)arg1;	// IMP=0x00000000009e0310
- (id)recognizer:(id)arg1 confidenceWhenSettingTouchInfo:(id)arg2;	// IMP=0x00000000009e0308
- (id)recognizer:(id)arg1 confidenceWhenPendingTouchInfo:(id)arg2;	// IMP=0x00000000009e0283
