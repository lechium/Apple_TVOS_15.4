...
+ (id)_genreNameForID:(long long)arg1;	// IMP=0x000000000064a9ca
+ (id)_localizedFolderNameForName:(id)arg1;	// IMP=0x000000000064a5c0
- (void).cxx_destruct;	// IMP=0x000000000064b4dd
...
- (void)_lock_loadFolderNamesIfNecessary;	// IMP=0x000000000064ac58
- (_Bool)statusBarForcedHiddenForInterfaceOrientation:(long long)arg1 onDisplay:(id)arg2;	// IMP=0x000000000064a92e
- (_Bool)statusBarHiddenForInterfaceOrientation:(long long)arg1 onDisplay:(id)arg2;	// IMP=0x000000000064a892
- (_Bool)statusBarForcedHiddenForInterfaceOrientation:(long long)arg1 onDisplay:(id)arg2 withUserInterfaceIdiom:(long long)arg3;	// IMP=0x000000000064a805
- (_Bool)statusBarHiddenForInterfaceOrientation:(long long)arg1 onDisplay:(id)arg2 withUserInterfaceIdiom:(long long)arg3;	// IMP=0x000000000064a77f
@property(readonly, nonatomic) NSString *fallbackFolderName;
@property(readonly, nonatomic) NSArray *folderNames;
- (void)_loadFromProxy:(id)arg1;	// IMP=0x000000000064a360
- (long long)_launchingInterfaceOrientation;	// IMP=0x000000000064b541
