...
- (void).cxx_destruct;	// IMP=0x0000000000351d1f
...
- (_Bool)isNOOP;	// IMP=0x0000000000351c75
- (id)description;	// IMP=0x0000000000351b9e
- (void)commitTargetIndexPath;	// IMP=0x0000000000351b67
- (id)expectedCellIndexPath;	// IMP=0x0000000000351a61
- (id)initWithCell:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000003519cb
