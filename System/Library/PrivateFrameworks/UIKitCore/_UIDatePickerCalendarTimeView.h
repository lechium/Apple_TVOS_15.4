...
- (void).cxx_destruct;	// IMP=0x00000000004fb955
...
- (id)createDatePickerForCompactTimeLabel:(id)arg1;	// IMP=0x00000000004fb832
- (_Bool)compactTimeLabel:(id)arg1 shouldDismissForInteractionAtLocation:(struct CGPoint)arg2;	// IMP=0x00000000004fb82a
- (void)compactTimeLabelDidEndEditing:(id)arg1;	// IMP=0x00000000004fb7de
- (void)compactTimeLabelDidBeginEditing:(id)arg1;	// IMP=0x00000000004fb792
- (void)compactTimeLabelWillBecomeFirstResponder:(id)arg1;	// IMP=0x00000000004fb746
- (void)compactTimeLabel:(id)arg1 didSelectTime:(id)arg2;	// IMP=0x00000000004fb6a3
- (void)_updateFonts;	// IMP=0x00000000004fb337
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000004fb244
- (void)setSelectedDate:(id)arg1;	// IMP=0x00000000004fb097
- (void)_updateTextFieldsFromSelectedDateComponents;	// IMP=0x00000000004fb00a
- (void)reloadWithCalendar:(id)arg1 locale:(id)arg2 selectedDate:(id)arg3;	// IMP=0x00000000004fae4a
- (void)_reload;	// IMP=0x00000000004fadc8
- (void)_reloadDateFormatters;	// IMP=0x00000000004fad0d
- (void)tintColorDidChange;	// IMP=0x00000000004fab82
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000004faa95
- (id)primaryFirstResponder;	// IMP=0x00000000004faa83
- (void)_updateClockLayout;	// IMP=0x00000000004fa4a0
- (void)_setupViewHierarchy;	// IMP=0x00000000004f9d5f
- (void)willMoveToSuperview:(id)arg1;	// IMP=0x00000000004f9cd2
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000000004f9c45
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004f9af9
