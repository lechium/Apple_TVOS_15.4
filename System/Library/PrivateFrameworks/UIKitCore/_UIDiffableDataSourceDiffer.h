...
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x00000000002ad686
+ (id)differWithBeforeDataSourceState:(id)arg1 afterDataSourceState:(id)arg2;	// IMP=0x00000000002ad617
- (void).cxx_destruct;	// IMP=0x00000000002b0ad3
...
- (_Bool)_verifyForUpdates:(id)arg1;	// IMP=0x00000000002aeff1
- (id)_sectionUpdatesForDiffResults:(id)arg1 deletedSections:(id)arg2 insertedSections:(id)arg3;	// IMP=0x00000000002ae961
- (id)_itemUpdatesForDiffResults:(id)arg1 sectionBoundaryMoves:(id)arg2 deletedSections:(id)arg3 insertedSections:(id)arg4;	// IMP=0x00000000002adf32
- (id)_computeSectionBoundaryMovesForItemDiffer:(id)arg1;	// IMP=0x00000000002ade60
- (id)_computeUpdatesForIdentifierBasedDiff;	// IMP=0x00000000002ad746
- (void)_computeUpdates;	// IMP=0x00000000002ad714
- (id)description;	// IMP=0x00000000002ad005
- (id)initWithBeforeDataSource:(id)arg1 afterDataSource:(id)arg2 itemIdentifierDiffer:(id)arg3;	// IMP=0x00000000002acf3e
