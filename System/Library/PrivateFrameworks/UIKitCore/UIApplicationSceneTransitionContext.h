...
- (_Bool)isUISubclass;	// IMP=0x0000000000679def
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofSetting:(unsigned long long)arg3;	// IMP=0x0000000000679c48
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x0000000000679b96
