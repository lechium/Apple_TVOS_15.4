...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0000000000c9c3df
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x0000000000c9bc30
- (void).cxx_destruct;	// IMP=0x0000000000c9fb28
...
- (id)description;	// IMP=0x0000000000c9f684
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000000c9f2ec
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000000c9edab
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x0000000000c9eb1b
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000000c9e924
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000000c9e3f9
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x0000000000c9e1db
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x0000000000c9df21
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000000c9d823
- (_Bool)updatePlacement;	// IMP=0x0000000000c9d746
- (void)resetToPreferredPlacement;	// IMP=0x0000000000c9d730
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c9d5a6
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c9d304
- (void)_updateStatuses;	// IMP=0x0000000000c9d225
- (void)prepareForDataUpdate;	// IMP=0x0000000000c9d20e
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x0000000000c9c21a
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x0000000000c9c036
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x0000000000c9bfa9
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000000c9bf72
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000000c9beee
