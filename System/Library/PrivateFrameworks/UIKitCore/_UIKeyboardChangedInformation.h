...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000001113e3d
+ (id)informationForKeyboardRestore:(id)arg1;	// IMP=0x0000000001113250
+ (id)informationForKeyboardPreserve:(id)arg1;	// IMP=0x0000000001113198
+ (id)informationForKeyboardUp:(struct CGRect)arg1 withIAV:(struct CGRect)arg2;	// IMP=0x00000000011130fb
+ (id)informationForKeyboardDown;	// IMP=0x0000000001113065
+ (id)animationFence;	// IMP=0x000000000111305d
- (void).cxx_destruct;	// IMP=0x0000000001114493
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011141f2
- (id)description;	// IMP=0x0000000001113e45
- (void)resetAnimationFencing;	// IMP=0x0000000001113e0b
- (void)dealloc;	// IMP=0x0000000001113dcd
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011139af
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000111365e
- (id)copyWithIntersectability:(_Bool)arg1;	// IMP=0x0000000001113531
- (id)copyWithoutFence;	// IMP=0x0000000001113409
- (id)copyWithoutIAV;	// IMP=0x0000000001113308
- (id)initWithKeyboardRect:(struct CGRect)arg1 iavPosition:(struct CGRect)arg2 onScreen:(_Bool)arg3 takeSnapshot:(_Bool)arg4 fence:(id)arg5;	// IMP=0x0000000001112fa7
