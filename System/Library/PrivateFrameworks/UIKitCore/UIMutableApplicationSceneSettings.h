...
- (_Bool)isUISubclass;	// IMP=0x00000000006763c9
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofSetting:(unsigned long long)arg3;	// IMP=0x00000000006763b6
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x00000000006763a9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000067637b
...
- (void)setDefaultStatusBarHeight:(double)arg1 forOrientation:(long long)arg2;	// IMP=0x0000000000674fc4
- (double)defaultStatusBarHeightForOrientation:(long long)arg1;	// IMP=0x0000000000674ea1
