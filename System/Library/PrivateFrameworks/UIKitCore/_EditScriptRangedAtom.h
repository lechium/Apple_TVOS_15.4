...
+ (id)atomWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0000000000914d94
- (void).cxx_destruct;	// IMP=0x0000000000914e2c
...
- (id)description;	// IMP=0x0000000000914cdf
- (id)initWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0000000000914c4e
