...
+ (void)_addAnimations:(id)arg1 toDispatchGroup:(id)arg2;	// IMP=0x0000000000c8d4d0
+ (void)_addAnimations:(id)arg1 toPreparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3 visitedDisplayItemIdentifiers:(id)arg4;	// IMP=0x0000000000c8c9f4
+ (void)prepareAnimations:(id)arg1 forStatusBar:(id)arg2;	// IMP=0x0000000000c8c7ca
+ (id)animationWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c8c4a2
+ (void)initialize;	// IMP=0x0000000000c8c44b
- (void).cxx_destruct;	// IMP=0x0000000000c8e98b
...
- (id)description;	// IMP=0x0000000000c8e67d
- (id)_dependentItemIdentifiersEnabledOnly:(_Bool)arg1;	// IMP=0x0000000000c8e43b
@property(readonly, nonatomic) NSSet *effectiveDelayedItemIdentifiers;
- (void)addSubAnimation:(id)arg1 forDisplayItemWithIdentifier:(id)arg2;	// IMP=0x0000000000c8deba
- (void)cancel;	// IMP=0x0000000000c8dcaa
- (void)performForStatusBar:(id)arg1;	// IMP=0x0000000000c8d72a
- (void)_prepareForStatusBar:(id)arg1 preparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3;	// IMP=0x0000000000c8cefb
- (void)addTotalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c8c6f1
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c8c665
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c8c567
