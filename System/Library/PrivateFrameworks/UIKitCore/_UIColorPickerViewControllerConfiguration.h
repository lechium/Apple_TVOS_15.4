...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000010f9006
- (void).cxx_destruct;	// IMP=0x00000000010f943d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000010f916e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000010f900e
- (unsigned long long)hash;	// IMP=0x00000000010f8eed
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010f8c53
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000010f8b10
- (id)init;	// IMP=0x00000000010f8ad8
