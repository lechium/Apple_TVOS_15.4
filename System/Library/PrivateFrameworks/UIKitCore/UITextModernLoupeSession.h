...
+ (id)beginLoupeSessionAtPoint:(struct CGPoint)arg1 withCaretRect:(struct CGRect)arg2 fromView:(id)arg3;	// IMP=0x0000000000c34744
- (void).cxx_destruct;	// IMP=0x0000000000c353b4
...
- (void)dealloc;	// IMP=0x0000000000c352df
- (void)didMoveToPoint:(struct CGPoint)arg1 withCaretRect:(struct CGRect)arg2 tracksCaret:(_Bool)arg3;	// IMP=0x0000000000c34fda
- (struct CGPoint)_locationInContainerCoordinateSpace:(struct CGPoint)arg1;	// IMP=0x0000000000c34f1a
