...
+ (long long)styleForContentColor:(id)arg1 contrast:(double)arg2;	// IMP=0x000000000075c927
+ (long long)styleForContentColor:(id)arg1;	// IMP=0x000000000075c90d
...
- (id)settings;	// IMP=0x000000000075d0e9
- (void)clearContentColorAccumulator;	// IMP=0x000000000075d058
- (_Bool)accumulateChangesToContentColor:(id)arg1 contrast:(double)arg2;	// IMP=0x000000000075cabf
- (_Bool)accumulateChangesToContentColor:(id)arg1;	// IMP=0x000000000075caa5
- (void)dealloc;	// IMP=0x000000000075ca62
