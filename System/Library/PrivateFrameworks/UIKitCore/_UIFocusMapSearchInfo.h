...
- (void).cxx_destruct;	// IMP=0x00000000005f5cf9
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x00000000005f5be8
- (void)addSnapshot:(id)arg1;	// IMP=0x00000000005f5b70
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x00000000005f5a6b
