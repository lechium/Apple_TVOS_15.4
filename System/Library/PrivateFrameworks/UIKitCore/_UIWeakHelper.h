...
- (void).cxx_destruct;	// IMP=0x0000000000f11d1a
@property(copy, nonatomic) CDUnknownBlockType deallocationBlock; // @synthesize deallocationBlock=_deallocationBlock;
- (void)dealloc;	// IMP=0x0000000000f11c9e
- (id)initWithDeallocationBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f11c36
