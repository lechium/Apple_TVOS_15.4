...
- (void).cxx_destruct;	// IMP=0x0000000000693249
...
- (void)configPageView;	// IMP=0x0000000000691f3d
- (void)layoutSubviews;	// IMP=0x0000000000691f2b
- (id)initWithImageView:(id)arg1;	// IMP=0x0000000000691df1
