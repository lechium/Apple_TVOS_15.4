...
- (void).cxx_destruct;	// IMP=0x000000000060bcdd
...
- (id)_requestByRedirectingRequestToFocusSystem:(id)arg1;	// IMP=0x000000000060b9c4
- (id)initWithFocusSystem:(id)arg1 window:(id)arg2;	// IMP=0x000000000060b8bb
- (id)init;	// IMP=0x000000000060b834
