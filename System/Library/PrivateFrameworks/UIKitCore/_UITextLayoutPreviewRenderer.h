...
- (void).cxx_destruct;	// IMP=0x0000000000848d46
...
- (void)removeRenderingAttributes:(id)arg1;	// IMP=0x0000000000848bfd
- (void)addRenderingAttributes:(id)arg1;	// IMP=0x0000000000848b84
- (void)_updateDataIfNeeded;	// IMP=0x0000000000848125
...
- (id)initWithTextLayoutManager:(id)arg1 range:(id)arg2 unifyRects:(_Bool)arg3;	// IMP=0x0000000000847fb5
