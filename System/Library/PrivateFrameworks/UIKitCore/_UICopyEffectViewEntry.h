...
- (void).cxx_destruct;	// IMP=0x0000000000235c24
@property(retain, nonatomic) _UIVisualEffectViewBackdropCaptureGroup *captureGroup; // @synthesize captureGroup=_captureGroup;
- (id)description;	// IMP=0x0000000000235b80
- (_Bool)canTransitionToEffect:(id)arg1;	// IMP=0x0000000000235b78
- (void)removeEffectFromView:(id)arg1;	// IMP=0x0000000000235b2c
- (void)addEffectToView:(id)arg1;	// IMP=0x0000000000235a91
