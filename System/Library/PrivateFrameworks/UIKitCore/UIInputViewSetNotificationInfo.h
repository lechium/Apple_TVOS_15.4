...
+ (id)info;	// IMP=0x0000000000937a58
...
- (void)populateEndInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000938276
- (void)populateStartInfoWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009381f6
- (void)populateWithAnimationStyle:(id)arg1;	// IMP=0x0000000000938196
- (_Bool)containsChange;	// IMP=0x0000000000938115
- (void)logGeometry;	// IMP=0x000000000093810f
@property(readonly, nonatomic) NSDictionary *privateUserInfo;
- (id)rotationUserInfo;	// IMP=0x0000000000937e5c
@property(readonly, nonatomic) NSDictionary *userInfo;
- (id)inverseInfo;	// IMP=0x0000000000937ae6
- (id)init;	// IMP=0x0000000000937a71
