...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000a15df0
...
- (id)description;	// IMP=0x0000000000a15f17
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000a15e5a
- (void)dealloc;	// IMP=0x0000000000a15da6
- (id)init;	// IMP=0x0000000000a15d42
