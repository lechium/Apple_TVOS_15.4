...
- (void).cxx_destruct;	// IMP=0x0000000000e8ed0b
...
- (_Bool)supportsCoalescing;	// IMP=0x0000000000e8ecc0
- (void)undoRedo;	// IMP=0x0000000000e8ecba
- (id)initWithAffectedRange:(struct _NSRange)arg1 inputController:(id)arg2;	// IMP=0x0000000000e8ec2d
