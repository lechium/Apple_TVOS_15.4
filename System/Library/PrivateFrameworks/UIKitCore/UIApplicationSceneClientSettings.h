...
- (_Bool)isUISubclass;	// IMP=0x000000000067046a
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofSetting:(unsigned long long)arg3;	// IMP=0x0000000000670457
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x000000000067044a
- (_Bool)settings:(id)arg1 appendDescriptionToBuilder:(id)arg2 forFlag:(long long)arg3 object:(id)arg4 ofSetting:(unsigned long long)arg5;	// IMP=0x000000000067021e
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006701f0
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofOtherSetting:(unsigned long long)arg3;	// IMP=0x000000000066ff08
- (id)keyDescriptionForOtherSetting:(unsigned long long)arg1;	// IMP=0x000000000066fce1
