...
- (void).cxx_destruct;	// IMP=0x0000000000097f62
...
- (id)initWithPropertyName:(id)arg1 implicit:(_Bool)arg2 additive:(_Bool)arg3;	// IMP=0x0000000000097e36
- (id)init;	// IMP=0x0000000000097daa
