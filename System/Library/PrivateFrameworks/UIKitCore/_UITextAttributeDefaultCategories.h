...
- (void).cxx_destruct;	// IMP=0x000000000022e6ad
...
- (id)_textFieldDefaults:(long long)arg1;	// IMP=0x000000000022e233
- (id)_labelDefaults:(long long)arg1;	// IMP=0x000000000022e124
- (id)_genericDefaults:(long long)arg1;	// IMP=0x000000000022dfb5
- (id)initWithUserInterfaceIdiom:(long long)arg1;	// IMP=0x000000000022ddad
