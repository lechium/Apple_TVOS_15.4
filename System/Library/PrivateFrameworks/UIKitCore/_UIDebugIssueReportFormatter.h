...
- (void).cxx_destruct;	// IMP=0x00000000005c7ccb
...
- (id)stringFromReport:(id)arg1;	// IMP=0x00000000005c7bf5
- (id)_componentsFromReport:(id)arg1;	// IMP=0x00000000005c76d7
- (id)init;	// IMP=0x00000000005c7617
