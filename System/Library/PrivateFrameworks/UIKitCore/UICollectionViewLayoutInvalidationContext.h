...
- (void).cxx_destruct;	// IMP=0x0000000000340ddf
...
- (void)invalidateDecorationElementsOfKind:(id)arg1 atIndexPaths:(id)arg2;	// IMP=0x00000000003409b9
@property(readonly, nonatomic) NSDictionary *invalidatedSupplementaryIndexPaths;
- (void)invalidateSupplementaryElementsOfKind:(id)arg1 atIndexPaths:(id)arg2;	// IMP=0x0000000000340897
@property(readonly, nonatomic) NSArray *invalidatedItemIndexPaths;
- (void)invalidateItemsAtIndexPaths:(id)arg1;	// IMP=0x0000000000340812
- (void)_invalidateSupplementaryElementsOfKind:(id)arg1 atIndexPaths:(id)arg2;	// IMP=0x00000000003406a2
- (void)_setInvalidatedSupplementaryViews:(id)arg1;	// IMP=0x0000000000340641
- (id)_invalidatedSupplementaryViews;	// IMP=0x0000000000340633
