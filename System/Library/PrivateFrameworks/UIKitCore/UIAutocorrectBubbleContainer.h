...
@class NSLayoutConstraint, NSString, UIAutocorrectBubble, UIView;
...
- (void).cxx_destruct;	// IMP=0x0000000000a7b895
...
- (void)performReset;	// IMP=0x0000000000a7b586
- (_Bool)isViewAnimating;	// IMP=0x0000000000a7b4ed
- (void)reset;	// IMP=0x0000000000a7b4b6
- (void)animateAutocorrectionAccepted;	// IMP=0x0000000000a7b193
- (void)dismissAutocorrectBubble;	// IMP=0x0000000000a7b134
- (void)didTapAutocorrectionBubble;	// IMP=0x0000000000a7b122
- (id)createTypedTextViewWithTypedText:(id)arg1;	// IMP=0x0000000000a7ad43
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000a7a710
- (void)updateBubbleWithAutocorrectionText:(id)arg1 referenceRect:(struct CGRect)arg2;	// IMP=0x0000000000a7a335
- (void)updateFakeTextSelectionHighlightForRect:(struct CGRect)arg1;	// IMP=0x0000000000a79d86
- (void)updateWithAutocorrectionText:(id)arg1 typedText:(id)arg2 referenceTextView:(id)arg3 referenceRect:(struct CGRect)arg4;	// IMP=0x0000000000a79cc6
- (id)init;	// IMP=0x0000000000a79c4c
