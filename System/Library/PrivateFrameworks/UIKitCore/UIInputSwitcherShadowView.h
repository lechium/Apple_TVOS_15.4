...
- (void).cxx_destruct;	// IMP=0x00000000007fd9ee
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000007fcc65
- (void)layoutSubviews;	// IMP=0x00000000007fcae3
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000007fc9ec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000007fc730
