...
- (void).cxx_destruct;	// IMP=0x0000000000fcb499
...
- (void)_layoutIfNeeded;	// IMP=0x0000000000fca71d
- (id)layoutDescription;	// IMP=0x0000000000fc9cfc
- (id)description;	// IMP=0x0000000000fc9be8
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000fc9b2b
...
- (void)resetLayout;	// IMP=0x0000000000fc99c5
- (_Bool)hasLayout;	// IMP=0x0000000000fc99b7
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x0000000000fc98e5
