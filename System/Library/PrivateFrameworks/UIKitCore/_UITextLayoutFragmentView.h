...
- (void).cxx_destruct;	// IMP=0x00000000000dcbec
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000dca5b
- (void)layoutSubviews;	// IMP=0x00000000000dc955
- (void)enumerateTextAttachmentViewsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000dc7a3
@property(readonly, nonatomic) struct CGRect clipFrame;
- (void)_updateGeometry;	// IMP=0x00000000000dc3ae
- (id)initWithLayoutFragment:(id)arg1 containerOrigin:(struct CGPoint)arg2 containerSize:(struct CGSize)arg3;	// IMP=0x00000000000dc235
