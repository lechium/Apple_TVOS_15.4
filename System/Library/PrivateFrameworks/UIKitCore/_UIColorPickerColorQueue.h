...
- (void).cxx_destruct;	// IMP=0x00000000006b3489
...
- (void)_pickerDidSelectColor:(id)arg1 colorspace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x00000000006b335b
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x00000000006b328e
- (void)_displayLinkFired;	// IMP=0x00000000006b323e
- (id)init;	// IMP=0x00000000006b30fb
