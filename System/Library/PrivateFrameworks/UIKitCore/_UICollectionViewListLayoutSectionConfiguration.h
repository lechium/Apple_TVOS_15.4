...
+ (id)new;	// IMP=0x0000000000f28ee3
- (void).cxx_destruct;	// IMP=0x0000000000f2a977
...
- (id)_traitCollection;	// IMP=0x0000000000f2a6ce
- (_Bool)_hasFooter;	// IMP=0x0000000000f2a6b2
- (_Bool)_hasSupplementaryAsHeader;	// IMP=0x0000000000f2a696
- (_Bool)_hasHeaderOrFirstItemStyledAsHeader;	// IMP=0x0000000000f2a676
- (double)_defaultSectionFooterHeight;	// IMP=0x0000000000f2a5b7
- (double)_defaultSectionHeaderHeight;	// IMP=0x0000000000f2a4f8
- (double)_defaultRowHeight;	// IMP=0x0000000000f2a4a6
- (double)_effectiveEstimatedSectionFooterHeight;	// IMP=0x0000000000f2a445
- (double)_effectiveEstimatedSectionHeaderHeight;	// IMP=0x0000000000f2a3e4
- (double)_effectiveEstimatedRowHeight;	// IMP=0x0000000000f2a383
- (double)_separatorHeight;	// IMP=0x0000000000f2a37a
- (_Bool)_shouldDrawThickSeparators;	// IMP=0x0000000000f2a313
- (_Bool)_shouldPinSupplementaries;	// IMP=0x0000000000f2a30b
- (_Bool)_shouldSupplementariesFollowSectionInsets;	// IMP=0x0000000000f2a303
- (double)_topContentInsetForGroupedAppearance;	// IMP=0x0000000000f2a252
- (double)_topContentInsetForPaddingAboveHeader;	// IMP=0x0000000000f2a1d1
- (struct NSDirectionalEdgeInsets)_sectionContentInsetsForAppearanceStyleWithDefaultInsets:(struct NSDirectionalEdgeInsets)arg1;	// IMP=0x0000000000f2a04c
- (long long)_defaultContentInsetsReference;	// IMP=0x0000000000f2a041
- (_Bool)_usesSectionBackgroundDecoration;	// IMP=0x0000000000f2a02f
- (void)_addSupplementaryItemsToLayout:(id)arg1;	// IMP=0x0000000000f29b0f
- (id)_generateLayoutGroup:(id)arg1;	// IMP=0x0000000000f2937c
- (id)_createSeparatorForBottom:(_Bool)arg1;	// IMP=0x0000000000f29215
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f290ca
...
- (id)initWithAppearanceStyle:(long long)arg1 layoutEnvironment:(id)arg2;	// IMP=0x0000000000f28f6c
- (id)initWithCollectionView:(id)arg1;	// IMP=0x0000000000f28f17
- (id)init;	// IMP=0x0000000000f28f01
