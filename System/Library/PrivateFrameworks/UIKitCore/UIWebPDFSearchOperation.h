...
- (void)cancel;	// IMP=0x00000000010f1d94
- (void)main;	// IMP=0x00000000010f1c5a
- (void)_search;	// IMP=0x00000000010f151e
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x00000000010f100a
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x00000000010f0d0e
- (void)_notifyDelegateOfStatus;	// IMP=0x00000000010f0b93
- (_Bool)_hitSearchLimit;	// IMP=0x00000000010f0b68
- (void)dealloc;	// IMP=0x00000000010f0b00
- (id)init;	// IMP=0x00000000010f0a7b
