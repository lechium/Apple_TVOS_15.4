...
- (void).cxx_destruct;	// IMP=0x000000000046c6a5
...
- (id)_interactiveStateRequest;	// IMP=0x000000000046c14d
- (id)stateRequest;	// IMP=0x000000000046c062
- (id)_configuration;	// IMP=0x000000000046c054
- (double)_absoluteDistanceFromRequest:(id)arg1;	// IMP=0x000000000046bf45
- (double)_distanceFromRequest:(id)arg1;	// IMP=0x000000000046be68
- (_Bool)matchesRequest:(id)arg1;	// IMP=0x000000000046be44
@property(readonly, nonatomic, getter=isCollapsed) _Bool collapsed;
- (_Bool)_shouldUseSlidingBars;	// IMP=0x000000000046be1f
- (_Bool)_trailingEntirelyOverlapsMain;	// IMP=0x000000000046bd61
@property(readonly, nonatomic) _Bool trailingOverlapsMain;
- (_Bool)_leadingEntirelyOverlapsMain;	// IMP=0x000000000046bbdd
@property(readonly, nonatomic) _Bool leadingOverlapsMain;
- (_Bool)_supplementaryEntirelyOverlapsMain;	// IMP=0x000000000046bab7
@property(readonly, nonatomic) _Bool supplementaryOverlapsMain;
- (unsigned long long)hash;	// IMP=0x000000000046b975
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000046b546
- (id)description;	// IMP=0x000000000046b0b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000046ae5b
