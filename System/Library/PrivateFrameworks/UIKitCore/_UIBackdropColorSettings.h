...
- (_Bool)applyCABackdropLayerStatistics:(id)arg1;	// IMP=0x00000000000c99df
- (void)setValuesFromModel:(id)arg1;	// IMP=0x00000000000c99d9
...
- (void)setDefaultValues;	// IMP=0x00000000000c998e
