...
@interface UIKeyboardCandidateViewStyle : NSObject <NSCopying, TUICandidateViewStyle>
{
    ...
    _Bool _allowCandidateGridExpanding;	// 11 = 0xb
    _Bool _showsIndex;	// 12 = 0xc
    _Bool _showExtraLineBeforeFirstRow;	// 13 = 0xd
    _Bool _fillGridWithLines;	// 14 = 0xe
    _Bool _dontSelectLastItemByBackwardMoving;	// 15 = 0xf
    _Bool _showOneMoreCandidate;	// 16 = 0x10
    _Bool _disableSwitchingSortingMethodByTabKey;	// 17 = 0x11
    _Bool _skipInlineCandidate;	// 18 = 0x12
    _Bool _hidesPartialCandidates;	// 19 = 0x13
    ...
    unsigned long long _maskedCorners;	// 320 = 0x140
    unsigned long long _gridMaskedCorners;	// 328 = 0x148
    double _foregroundOpacity;	// 336 = 0x150
    double _backgroundOpacity;	// 344 = 0x158
    long long _layoutOrientation;	// 352 = 0x160
    unsigned long long _columnsCount;	// 360 = 0x168
    unsigned long long _maxNumberOfProactiveCells;	// 368 = 0x170
    double _minimumCellPadding;	// 376 = 0x178
    double _minimumCellWidth;	// 384 = 0x180
    double _maximumIconWidth;	// 392 = 0x188
    double _singleSlottedCellMargin;	// 400 = 0x190
    long long _cellTextAlignment;	// 408 = 0x198
    long long _alternativeTextAlignment;	// 416 = 0x1a0
    long long _minimumNumberOfCandidates;	// 424 = 0x1a8
    struct CGPoint _gridLineOffset;	// 432 = 0x1b0
    struct UIEdgeInsets _extraCellPadding;	// 448 = 0x1c0
    struct UIEdgeInsets _arrowButtonPadding;	// 480 = 0x1e0
    struct UIEdgeInsets _gridPadding;	// 512 = 0x200
    struct UIEdgeInsets _gridLinePadding;	// 544 = 0x220
    struct UIEdgeInsets _sortControlPadding;	// 576 = 0x240
}

+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x00000000007c936b
+ (id)tvStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x00000000007c8f98
+ (id)disambiguationStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x00000000007c8f66
+ (id)styleForDarkKeyboard:(_Bool)arg1;	// IMP=0x00000000007c8f34
+ (id)darkKeyboardStyleForDisambiguation;	// IMP=0x00000000007c8cc2
+ (id)lightKeyboardStyleForDisambiguation;	// IMP=0x00000000007c8a9e
+ (id)darkKeyboardStyle;	// IMP=0x00000000007c868b
+ (id)lightKeyboardStyle;	// IMP=0x00000000007c8278
- (void).cxx_destruct;	// IMP=0x00000000007c9c33
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007c7aea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007c771a
