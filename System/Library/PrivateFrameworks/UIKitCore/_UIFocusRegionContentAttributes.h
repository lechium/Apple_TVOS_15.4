...
+ (id)attributesForFocusRegionContentInContainer:(id)arg1 coordinateSpace:(id)arg2;	// IMP=0x00000000005debc6
- (void).cxx_destruct;	// IMP=0x00000000005dee6a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005dedf6
