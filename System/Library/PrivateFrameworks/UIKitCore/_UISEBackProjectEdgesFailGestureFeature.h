...
- (void).cxx_destruct;	// IMP=0x00000000006a01ff
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x000000000069ffec
- (id)debugDictionary;	// IMP=0x000000000069ff3d
- (id)initWithSettings:(id)arg1;	// IMP=0x000000000069fe8e
