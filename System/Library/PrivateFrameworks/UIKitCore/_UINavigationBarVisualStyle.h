...
+ (id)visualStyleForIdiom:(long long)arg1;	// IMP=0x000000000016a6c3
...
- (id)_legacyButtonFontForStyle:(long long)arg1;	// IMP=0x000000000016adb8
...
- (id)defaultTitleColorForUserInterfaceStyle:(long long)arg1 barStyle:(long long)arg2;	// IMP=0x000000000016ad56
- (double)imageButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000016ad41
- (double)textButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000016ad2c
- (long long)navigationBar:(id)arg1 metricsForOrientation:(long long)arg2 hasPrompt:(_Bool)arg3;	// IMP=0x000000000016ad06
- (double)leftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000016ac0b
- (_Bool)shouldForceLegacyLeftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000016abff
- (id)buttonFontForStyle:(long long)arg1;	// IMP=0x000000000016aba1
...
- (double)leftBackTitleMarginLetterpressPadding;	// IMP=0x000000000016a9fc
...
- (double)barHeightForMetrics:(long long)arg1;	// IMP=0x000000000016a944
...
- (double)backButtonAnimationClippingPadding;	// IMP=0x000000000016a911
...
- (id)timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2 isInteractive:(_Bool)arg3;	// IMP=0x000000000016a796
- (id)initWithIdiom:(long long)arg1;	// IMP=0x000000000016a759
