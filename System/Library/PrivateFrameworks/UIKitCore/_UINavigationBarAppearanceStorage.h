...
+ (long long)typicalBarPosition;	// IMP=0x0000000000132ee6
- (void).cxx_destruct;	// IMP=0x0000000000133370
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x000000000013319f
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x0000000000133064
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x0000000000132f52
