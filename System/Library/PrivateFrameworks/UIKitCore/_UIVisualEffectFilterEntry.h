...
- (void).cxx_destruct;	// IMP=0x00000000000e7265
...
- (void)forceUniqueName;	// IMP=0x00000000000e68de
- (void)convertToIdentity;	// IMP=0x00000000000e68b7
- (id)copyForTransitionOut;	// IMP=0x00000000000e683f
- (id)copyForTransitionToEffect:(id)arg1;	// IMP=0x00000000000e67bc
- (_Bool)canTransitionToEffect:(id)arg1;	// IMP=0x00000000000e67b4
- (_Bool)isSameTypeOfEffect:(id)arg1;	// IMP=0x00000000000e66a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e662f
- (double)scaleHintAsRequested:(_Bool)arg1;	// IMP=0x00000000000e661d
- (id)valueAsRequested:(_Bool)arg1;	// IMP=0x00000000000e6608
@property(readonly, nonatomic) CAFilter *filter;
- (id)initWithFilterType:(id)arg1 configurationValues:(id)arg2 requestedValues:(id)arg3 identityValues:(id)arg4;	// IMP=0x00000000000e6414
