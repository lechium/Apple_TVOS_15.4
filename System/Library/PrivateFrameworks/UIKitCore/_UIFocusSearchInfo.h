...
+ (id)defaultInfo;	// IMP=0x0000000000ca4324
- (void).cxx_destruct;	// IMP=0x0000000000ca4483
...
- (_Bool)shouldIncludeFocusItem:(id)arg1;	// IMP=0x0000000000ca43bb
- (id)initWithFocusEvaluator:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ca434f
