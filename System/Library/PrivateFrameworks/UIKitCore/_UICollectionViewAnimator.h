...
- (void).cxx_destruct;	// IMP=0x0000000000a9d7c6
@property(readonly, nonatomic) CDUnknownBlockType handler; // @synthesize handler=_handler;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a9d752
@property(retain, nonatomic) _UICollectionViewAnimationContext *animationContext;
- (id)initWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a9d6c8
