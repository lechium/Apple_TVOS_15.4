...
- (void).cxx_destruct;	// IMP=0x00000000005a4df8
...
- (void)shouldAcceptAutocorrection;	// IMP=0x00000000005a4cf7
- (void)didSelectPredictiveCandidate:(id)arg1;	// IMP=0x00000000005a4c81
...
- (void)registerProxyKeysWithViews:(id)arg1;	// IMP=0x00000000005a4c07
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000005a49e4
- (void)viewDidLoad;	// IMP=0x00000000005a45cf
- (id)initWithServiceRole:(unsigned long long)arg1;	// IMP=0x00000000005a4463
- (id)init;	// IMP=0x00000000005a444f
