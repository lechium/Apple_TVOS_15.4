...
+ (id)weakAnimationDelegate:(id)arg1;	// IMP=0x00000000010344bb
- (void).cxx_destruct;	// IMP=0x00000000010345f7
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000103456f
- (void)animationDidStart:(id)arg1;	// IMP=0x0000000001034504
- (id)initWithAnimationDelegate:(id)arg1;	// IMP=0x000000000103441d
