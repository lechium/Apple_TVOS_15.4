...
- (void).cxx_destruct;	// IMP=0x0000000000b271de
@property(nonatomic) _Bool completesAtTargetState; // @synthesize completesAtTargetState=_completesAtTargetState;
- (void)_reset;	// IMP=0x0000000000b271a2
- (void)receiveObservedValue:(id)arg1;	// IMP=0x0000000000b26ff5
- (void)dealloc;	// IMP=0x0000000000b26f75
- (id)init;	// IMP=0x0000000000b26ed4
