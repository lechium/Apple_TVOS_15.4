...
- (void).cxx_destruct;	// IMP=0x00000000007d5e5d
...
- (id)traitCollection;	// IMP=0x00000000007d5ba5
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000007d597a
- (void)layoutSubviews;	// IMP=0x00000000007d57cb
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x00000000007d4fce
- (_Bool)shouldExtendUpwards;	// IMP=0x00000000007d4da4
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x00000000007d476e
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x00000000007d4486
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x00000000007d3fe5
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x00000000007d3758
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x00000000007d36d3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000007d3613
