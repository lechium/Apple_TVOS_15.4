...
- (void).cxx_destruct;	// IMP=0x0000000000e64399
...
- (void)setDefaultResult;	// IMP=0x0000000000e63f06
- (void)setNoResult;	// IMP=0x0000000000e63eeb
- (void)setAttachmentResult:(id)arg1;	// IMP=0x0000000000e63e92
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x0000000000e63e79
- (void)setStringResult:(id)arg1;	// IMP=0x0000000000e63dcf
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x0000000000e63d64
