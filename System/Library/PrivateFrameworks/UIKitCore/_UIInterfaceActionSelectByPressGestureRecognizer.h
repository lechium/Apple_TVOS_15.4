...
- (void)_gestureChanged:(id)arg1;	// IMP=0x000000000003b30a
- (void)reset;	// IMP=0x000000000003b2c7
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b1c2
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003b12b
- (id)initWithFocusedInterfaceActionPressDelegate:(id)arg1;	// IMP=0x000000000003b087
