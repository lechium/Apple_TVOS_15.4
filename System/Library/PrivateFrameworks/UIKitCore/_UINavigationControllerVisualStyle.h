...
- (void)layoutContainerViewSemanticContentAttributeChanged:(id)arg1;	// IMP=0x00000000006d91db
- (void)updateTransitionControllerWithOperation:(long long)arg1;	// IMP=0x00000000006d91d5
...
- (_Bool)shouldUseInteractionControllerForInteractiveTransition;	// IMP=0x00000000006d91bd
- (id)initWithNavigationController:(id)arg1;	// IMP=0x00000000006d9180
