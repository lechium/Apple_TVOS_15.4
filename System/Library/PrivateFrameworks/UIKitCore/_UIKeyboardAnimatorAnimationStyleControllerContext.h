...
- (void).cxx_destruct;	// IMP=0x000000000095ddcc
...
- (void)complete;	// IMP=0x000000000095dd71
@property(readonly, retain, nonatomic) UIView *animatingView;
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3;	// IMP=0x000000000095db93
