...
- (void).cxx_destruct;	// IMP=0x00000000007b2259
...
- (id)_computeMovePairsSTL;	// IMP=0x00000000007b0a5e
- (id)_computeMovePairsFoundation;	// IMP=0x00000000007b012f
- (id)initWithItemDiffer:(id)arg1 beforeDataSourceState:(id)arg2 afterDataSourceState:(id)arg3;	// IMP=0x00000000007b0020
