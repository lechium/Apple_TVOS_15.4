...
- (void).cxx_destruct;	// IMP=0x000000000065474c
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000654694
- (id)initWithSceneLayer:(id)arg1;	// IMP=0x0000000000654545
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000006544be
