...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000141837
- (void).cxx_destruct;	// IMP=0x00000000001443b0
- (id)description;	// IMP=0x0000000000143c7b
...
- (unsigned long long)hash;	// IMP=0x0000000000142db5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000142647
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014250b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000141fa0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014183f
- (id)_initEmpty;	// IMP=0x00000000001417ca
- (id)init;	// IMP=0x000000000014167c
