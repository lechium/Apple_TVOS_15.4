...
- (void).cxx_destruct;	// IMP=0x0000000000506ee8
...
- (_Bool)updateVariableLengthStringForView:(id)arg1;	// IMP=0x0000000000506d86
- (id)description;	// IMP=0x0000000000506ceb
@property(retain, nonatomic) _UIGraphicsLetterpressStyle *letterpressStyle;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000506b2a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005068a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005066c3
