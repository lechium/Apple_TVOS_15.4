...
- (void)_setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x000000000080d347
- (void)_setHasDictation:(_Bool)arg1;	// IMP=0x000000000080d2f0
- (void)_setShouldAdvanceInputMode;	// IMP=0x000000000080d2a3
- (void)_setProceedShouldReturnIfPossibleForASP;	// IMP=0x000000000080d256
- (void)_setShouldDismiss;	// IMP=0x000000000080d209
- (void)_setPrimaryLanguage:(id)arg1;	// IMP=0x000000000080d1b2
- (void)_didPerformOutputOperation;	// IMP=0x000000000080d0ef
- (void)_willPerformOutputOperation;	// IMP=0x000000000080d0dd
- (void)_handleInputViewControllerState:(id)arg1;	// IMP=0x000000000080d07b
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x000000000080cfdf
...
- (void)unmarkText;	// IMP=0x000000000080ce17
- (void)setMarkedText:(id)arg1 selectedRange:(struct _NSRange)arg2;	// IMP=0x000000000080cd30
- (void)deleteBackward;	// IMP=0x000000000080cca5
- (void)insertText:(id)arg1;	// IMP=0x000000000080cc12
...
- (void)_createControllerOutputIfNecessary;	// IMP=0x000000000080c936
- (void)setForwardingInterface:(id)arg1;	// IMP=0x000000000080c886
- (void)dealloc;	// IMP=0x000000000080c82e
