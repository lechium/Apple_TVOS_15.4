...
+ (id)visualStyleForTraitCollection:(id)arg1;	// IMP=0x0000000000b403f5
- (double)columnDividerHeightForHUDHeight:(double)arg1;	// IMP=0x0000000000b403ec
- (double)maxHUDHeightForHeight:(double)arg1;	// IMP=0x0000000000b403e3
- (double)maxHUDWidthForWidth:(double)arg1;	// IMP=0x0000000000b403da
