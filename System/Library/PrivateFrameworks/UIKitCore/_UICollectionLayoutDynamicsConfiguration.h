...
- (void).cxx_destruct;	// IMP=0x0000000000267f78
...
- (id)_dirtyItems;	// IMP=0x0000000000267ef3
- (void)_reset;	// IMP=0x0000000000267e83
- (void)_setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x0000000000267d5b
@property(retain, nonatomic) NSArray *dynamicItems;
- (void)setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x0000000000267c4e
- (id)behaviorsForItem:(id)arg1;	// IMP=0x0000000000267b2b
- (id)init;	// IMP=0x0000000000267ab6
