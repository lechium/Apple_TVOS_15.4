...
+ (id)newTransitionDescriptorForStops:(id)arg1;	// IMP=0x00000000000e7bdb
- (void).cxx_destruct;	// IMP=0x00000000000e82ac
...
- (id)description;	// IMP=0x00000000000e7efd
- (void)uniqueFilterNames;	// IMP=0x00000000000e7d10
- (id)copyForTransitionToDescriptor:(id)arg1;	// IMP=0x00000000000e7706
- (void)addOverlay:(id)arg1;	// IMP=0x00000000000e76f0
- (void)addUnderlay:(id)arg1;	// IMP=0x00000000000e76ad
@property(retain, nonatomic) UIView<_UIVisualEffectViewParticipating> *containerView;
- (void)addViewEffect:(id)arg1;	// IMP=0x00000000000e7616
- (void)addFilterEntry:(id)arg1;	// IMP=0x00000000000e75d3
- (id)init;	// IMP=0x00000000000e7503
