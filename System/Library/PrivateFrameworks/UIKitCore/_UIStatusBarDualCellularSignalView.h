...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x0000000000c55d04
- (void).cxx_destruct;	// IMP=0x0000000000c5640e
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000c562eb
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000c56246
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000c561f6
- (void)_iconSizeDidChange;	// IMP=0x0000000000c560ff
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c560b8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000c56060
- (void)_commonInit;	// IMP=0x0000000000c55d24
