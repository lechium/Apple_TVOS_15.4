...
- (void).cxx_destruct;	// IMP=0x00000000009ee702
...
- (void)onResetDo:(CDUnknownBlockType)arg1;	// IMP=0x00000000009ee5fd
- (void)resetActiveDecayTo:(double)arg1;	// IMP=0x00000000009ee5dd
- (void)startOrUpdateDecay;	// IMP=0x00000000009ee5b1
- (void)updateDecay;	// IMP=0x00000000009ee56c
- (void)reset;	// IMP=0x00000000009ee536
- (void)resetDecayTo:(double)arg1;	// IMP=0x00000000009ee4df
@property(readonly, nonatomic) _Bool isActive;
- (void)startDecaying;	// IMP=0x00000000009ee49c
- (id)initWithTimeoutDuration:(double)arg1;	// IMP=0x00000000009ee459
