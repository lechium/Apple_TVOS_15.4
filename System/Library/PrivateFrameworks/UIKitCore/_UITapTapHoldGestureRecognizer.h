...
- (_Bool)_shouldFailInResponseToPresses:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008e6624
- (void)cancelPendingHoldToAction;	// IMP=0x00000000008e65e1
- (void)scheduleHoldToAction;	// IMP=0x00000000008e65a8
- (void)holdToAction:(id)arg1;	// IMP=0x00000000008e6523
- (void)cancelPendingTooSlowForDoubleTap;	// IMP=0x00000000008e64e0
- (void)scheduleTooSlowForDoubleTap;	// IMP=0x00000000008e64b2
- (void)tooSlowForDoubleTap:(id)arg1;	// IMP=0x00000000008e646f
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008e6361
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008e62bf
- (void)reset;	// IMP=0x00000000008e622d
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000008e61fe
