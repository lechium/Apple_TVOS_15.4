...
- (void)willBeginGesture;	// IMP=0x0000000000a0a054
- (_Bool)_shouldDelayUntilForceLevelRequirementIsMet;	// IMP=0x0000000000a0a04c
@property(readonly, nonatomic) UIKeyboardTaskQueue *taskQueue;
- (void)dealloc;	// IMP=0x0000000000a09fa3
- (id)initWithTextInput:(id)arg1;	// IMP=0x0000000000a09ee3
