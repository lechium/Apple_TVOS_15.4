...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0000000000a156f5
...
- (id)description;	// IMP=0x0000000000a15a95
- (void)dealloc;	// IMP=0x0000000000a15a44
- (void)addSlice:(id)arg1;	// IMP=0x0000000000a15a2e
- (id)initWithSliceID:(id)arg1;	// IMP=0x0000000000a155d2
