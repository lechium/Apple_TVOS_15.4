...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x0000000000d1d432
- (void).cxx_destruct;	// IMP=0x0000000000d1d679
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000d1d621
- (id)description;	// IMP=0x0000000000d1d556
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d1d484
- (id)init;	// IMP=0x0000000000d1d3f6
