...
- (void).cxx_destruct;	// IMP=0x0000000000709e5b
...
- (void)_observeScrollViewDidScroll:(id)arg1;	// IMP=0x0000000000709bc7
- (id)_customScrollViewMaskForScrolling:(struct CGRect)arg1;	// IMP=0x0000000000709a1b
- (void)_removeScreenshotViewIfNeeded;	// IMP=0x00000000007099cd
- (void)_scrollToContentOffset:(struct CGPoint)arg1;	// IMP=0x000000000070954d
- (long long)_currentPage;	// IMP=0x000000000070948e
- (void)_scrollAnimationDidEnd:(id)arg1;	// IMP=0x0000000000709407
- (void)_tearDown;	// IMP=0x000000000070936f
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x00000000007090bb
- (void)dealloc;	// IMP=0x0000000000708fb0
- (id)initWithScrollView:(id)arg1 scrollStyle:(long long)arg2;	// IMP=0x0000000000708e37
