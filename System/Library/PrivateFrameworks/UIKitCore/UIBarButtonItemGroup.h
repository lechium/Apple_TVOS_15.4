...
- (void).cxx_destruct;	// IMP=0x0000000000115f51
...
- (void)_validateAllItems;	// IMP=0x0000000000115d44
...
- (id)description;	// IMP=0x0000000000115a78
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001154d2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000011531f
- (id)initWithBarButtonItems:(id)arg1 representativeItem:(id)arg2;	// IMP=0x0000000000114d51
- (id)init;	// IMP=0x0000000000114d36
- (void)_removeRepresentative:(id)arg1;	// IMP=0x0000000000114bb5
- (void)_removeBarButtonItem:(id)arg1;	// IMP=0x00000000001149b8
