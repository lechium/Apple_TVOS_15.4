...
+ (_Bool)gestureIsInEndState:(long long)arg1;	// IMP=0x000000000053e843
- (void).cxx_destruct;	// IMP=0x000000000053e8cd
...
- (void)_updateMovementVectorForPanInitiatedChanges;	// IMP=0x000000000053e80b
- (_Bool)_isMovementDirectionAndMagnitudeEnoughToPerformOnOffChange:(double)arg1;	// IMP=0x000000000053e7bd
- (_Bool)_isMovementDirectionTrackableForPossibleOnOffChange:(double)arg1;	// IMP=0x000000000053e79e
- (void)_sendStateChangeActionsIfNecessary;	// IMP=0x000000000053e75b
- (void)_applyPendingChangesIfNecessary;	// IMP=0x000000000053e6ae
- (void)applyPendingDisplayedOnValueWithoutSendingActions;	// IMP=0x000000000053e69c
- (void)applyPendingDisplayedOnValueAndSendActions;	// IMP=0x000000000053e66e
- (_Bool)canApplyPendingOnValueForGesture:(id)arg1;	// IMP=0x000000000053e661
- (_Bool)updatePendingDisplayedOnValueIfMovementIsEnoughToInitiateChange:(double)arg1 forGesture:(id)arg2;	// IMP=0x000000000053e5ec
- (_Bool)pendingDisplayedOnValueIsValid;	// IMP=0x000000000053e5de
- (void)invalidatePendingOnValue;	// IMP=0x000000000053e5c6
- (void)setPendingDisplayedOnValue:(_Bool)arg1 forGesture:(id)arg2;	// IMP=0x000000000053e581
- (void)reset;	// IMP=0x000000000053e4d9
- (id)initWithVisualElement:(id)arg1;	// IMP=0x000000000053e424
