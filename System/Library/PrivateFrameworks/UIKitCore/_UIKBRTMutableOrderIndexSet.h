...
- (void).cxx_destruct;	// IMP=0x00000000009f1716
...
- (id)description;	// IMP=0x00000000009f166c
- (void)removeIndexes:(id)arg1;	// IMP=0x00000000009f1656
- (void)removeIndex:(unsigned long long)arg1;	// IMP=0x00000000009f1640
- (void)addIndex:(unsigned long long)arg1;	// IMP=0x00000000009f162a
...
- (id)initWithIndexesInRange:(struct _NSRange)arg1;	// IMP=0x00000000009f151a
- (id)init;	// IMP=0x00000000009f14c0
