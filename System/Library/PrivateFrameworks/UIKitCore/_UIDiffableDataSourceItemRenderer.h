...
- (void).cxx_destruct;	// IMP=0x0000000001114952
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011148a3
- (id)initWithIdentifier:(id)arg1 cellClass:(Class)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000011147df
- (id)initWithIdentifier:(id)arg1 cellClass:(Class)arg2 handler:(CDUnknownBlockType)arg3 cellReuseIdentifier:(id)arg4;	// IMP=0x0000000001114703
