...
+ (id)entryKeys;	// IMP=0x0000000000c9680f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000c96807
- (void).cxx_destruct;	// IMP=0x0000000000c9864f
...
- (void)makeUpdateFromData:(id)arg1;	// IMP=0x0000000000c98069
- (id)updateFromData:(id)arg1;	// IMP=0x0000000000c98003
- (id)dataByApplyingUpdate:(id)arg1 keys:(id)arg2;	// IMP=0x0000000000c97df7
- (id)dataByApplyingOverlay:(id)arg1;	// IMP=0x0000000000c97b6c
- (void)applyUpdate:(id)arg1;	// IMP=0x0000000000c97af0
- (void)_applyUpdate:(id)arg1 keys:(id)arg2;	// IMP=0x0000000000c97948
- (id)description;	// IMP=0x0000000000c97740
@property(readonly, nonatomic) NSSet *existingEntryKeys;
@property(readonly, nonatomic, getter=isEmpty) _Bool empty;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c970db
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c96ede
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c96d1a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c96b57
- (unsigned long long)hash;	// IMP=0x0000000000c969b0
