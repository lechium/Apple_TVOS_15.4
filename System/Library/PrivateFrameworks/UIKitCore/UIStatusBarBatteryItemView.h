...
- (void).cxx_destruct;	// IMP=0x0000000000c07bf8
...
- (id)accessibilityHUDRepresentation;	// IMP=0x0000000000c0786b
- (double)legibilityStrength;	// IMP=0x0000000000c0785d
- (void)_updateAccessoryImage;	// IMP=0x0000000000c07451
- (double)extraRightPadding;	// IMP=0x0000000000c073d4
- (id)contentsImage;	// IMP=0x0000000000c0735c
- (id)_contentsImage;	// IMP=0x0000000000c06e70
- (id)_accessoryImage;	// IMP=0x0000000000c06e19
- (_Bool)_needsAccessoryImage;	// IMP=0x0000000000c06e05
- (struct CGSize)_batteryOffsetWithBackground:(id)arg1;	// IMP=0x0000000000c06d1a
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000c06c6c
