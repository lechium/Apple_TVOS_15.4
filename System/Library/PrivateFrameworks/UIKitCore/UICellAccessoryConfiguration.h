...
- (void).cxx_destruct;	// IMP=0x0000000000d1e0af
...
- (_Bool)alwaysNeedsLayout;	// IMP=0x0000000000d1e086
- (id)description;	// IMP=0x0000000000d1dd6b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d1db71
- (id)init;	// IMP=0x0000000000d1db0e
