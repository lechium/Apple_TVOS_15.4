...
- (void)resetTimer;	// IMP=0x00000000009af9c4
- (void)invalidate;	// IMP=0x00000000009af937
- (_Bool)isValid;	// IMP=0x00000000009af8c7
- (void)handleDeferredTimerFiredEvent;	// IMP=0x00000000009af70a
- (void)timerFired:(id)arg1;	// IMP=0x00000000009af680
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4;	// IMP=0x00000000009af58c
- (void)dealloc;	// IMP=0x00000000009af503
