...
- (void).cxx_destruct;	// IMP=0x0000000000e6ce0a
...
- (_Bool)endEditing;	// IMP=0x0000000000e6cb59
- (id)initWithTextStorage:(id)arg1 attributeNames:(id)arg2;	// IMP=0x0000000000e6cab5
