...
- (void).cxx_destruct;	// IMP=0x0000000000184fe7
...
- (void)removeContent;	// IMP=0x0000000000184ef2
- (struct CGSize)sizeFittingSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x0000000000184eca
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidth:(double)arg1;	// IMP=0x0000000000184930
- (struct CGSize)_cachedTitleHeightSizeAndUpdateRestingSizeForWidthSupportingMultiLineShrinkToFit:(double)arg1;	// IMP=0x0000000000184158
- (void)_invalidateTitleHeightCache;	// IMP=0x000000000018411f
- (double)_textHeightForSize:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x0000000000184086
- (void)setContentHidden:(_Bool)arg1;	// IMP=0x0000000000184065
- (void)setContentAlpha:(double)arg1;	// IMP=0x0000000000184020
- (void)cleanupAfterLayoutTransitionCompleted;	// IMP=0x000000000018400e
- (void)layoutViewsWithOffset:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x000000000018369c
- (void)layoutViewsWithOffsetSupportingMultiLineShrinkToFit:(struct UIOffset)arg1 useRestingTitleHeight:(_Bool)arg2;	// IMP=0x0000000000182aef
- (void)layoutViews;	// IMP=0x0000000000182ad5
- (void)_enforceLayoutOrdering;	// IMP=0x0000000000182a78
- (void)updateRestingTitleHeight;	// IMP=0x0000000000182911
- (struct CGRect)_contentLayoutBounds;	// IMP=0x00000000001828f0
- (struct CGRect)_contentLayoutBoundsUsingRestingTitleHeight:(_Bool)arg1;	// IMP=0x000000000018281e
- (id)initWithContentView:(id)arg1;	// IMP=0x00000000001826ff
- (id)description;	// IMP=0x0000000000182569
