...
- (void).cxx_destruct;	// IMP=0x000000000046ae1d
...
- (id)description;	// IMP=0x000000000046a894
...
- (void)setTrailingBorderWidthInPoints:(double)arg1;	// IMP=0x000000000046a5be
- (void)setTrailingBorderWidthInPixels:(double)arg1;	// IMP=0x000000000046a5a7
- (double)trailingBorderWidthForScale:(double)arg1;	// IMP=0x000000000046a58e
- (void)setLeadingBorderWidthInPoints:(double)arg1;	// IMP=0x000000000046a577
- (void)setLeadingBorderWidthInPixels:(double)arg1;	// IMP=0x000000000046a560
- (double)leadingBorderWidthForScale:(double)arg1;	// IMP=0x000000000046a547
...
- (unsigned long long)hash;	// IMP=0x000000000046a357
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000469f02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000469d0e
- (id)init;	// IMP=0x0000000000469bdf
