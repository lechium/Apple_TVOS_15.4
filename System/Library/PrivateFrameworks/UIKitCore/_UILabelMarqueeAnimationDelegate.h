...
- (void).cxx_destruct;	// IMP=0x0000000000fa8fcc
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000fa8da4
- (void)animationDidStart:(id)arg1;	// IMP=0x0000000000fa8ac9
- (id)initWithLabel:(id)arg1;	// IMP=0x0000000000fa8a65
