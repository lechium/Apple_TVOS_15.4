...
- (void).cxx_destruct;	// IMP=0x0000000000af97fe
...
- (void)expandedAccessoryAreaTapped;	// IMP=0x0000000000af96e3
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0000000000af9508
- (void)layoutSubviews;	// IMP=0x0000000000af9181
@property(nonatomic) int printerState;
- (void)printerAccessoryViewInfoButtonPressed:(id)arg1;	// IMP=0x0000000000af902f
- (void)prepareForReuse;	// IMP=0x0000000000af8fc6
@property(nonatomic) _Bool checked;
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000af8b29
