...
- (void).cxx_destruct;	// IMP=0x00000000000e9528
...
- (id)description;	// IMP=0x00000000000e932f
- (id)describeMergeTable;	// IMP=0x00000000000e9217
- (id)mergeSource:(id)arg1 andDestination:(id)arg2;	// IMP=0x00000000000e9160
@property(readonly, copy, nonatomic) NSArray *merged;
- (void)_calculate;	// IMP=0x00000000000e8fd9
- (void)_calculateMerge;	// IMP=0x00000000000e876f
- (void)_calculateLCSSTable;	// IMP=0x00000000000e8547
- (void)_calculatePrefixAndSuffix;	// IMP=0x00000000000e8367
- (void)_reset;	// IMP=0x00000000000e833a
- (void)dealloc;	// IMP=0x00000000000e8300
