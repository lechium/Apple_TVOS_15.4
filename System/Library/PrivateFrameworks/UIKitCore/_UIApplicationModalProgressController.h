...
+ (id)instanceForScene:(id)arg1;	// IMP=0x00000000004f5ac6
+ (id)sharedInstance;	// IMP=0x00000000004f5a39
- (void).cxx_destruct;	// IMP=0x00000000004f8350
...
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004f6e4a
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004f6e38
- (void)displayForDownloadingURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000004f6e21
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 preDisplayTestBlock:(CDUnknownBlockType)arg5 dismissalHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000004f6a0e
@property(copy, nonatomic) NSString *message;
@property(copy, nonatomic) NSString *title;
- (void)reconfigureWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 dismissalHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000004f6377
- (void)hideAfterDelay:(double)arg1 forceCompletion:(_Bool)arg2 afterMinimumUptimeDismissalHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004f622c
- (void)hideAfterMinimumUptimeWithDismissalHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000004f60f0
- (void)_dismissButtonAction:(id)arg1;	// IMP=0x00000000004f60d1
- (void)_hideTimerAction:(id)arg1;	// IMP=0x00000000004f6094
- (void)_showTimerAction:(id)arg1;	// IMP=0x00000000004f5fc4
- (void)_hideImmediatelyWasDismissedByUser:(_Bool)arg1;	// IMP=0x00000000004f5f74
- (void)_reset;	// IMP=0x00000000004f5ef0
- (void)_callAndClearDismissalHandlerWasDismissedByUser:(_Bool)arg1;	// IMP=0x00000000004f5ea0
- (id)init;	// IMP=0x00000000004f5d8e
