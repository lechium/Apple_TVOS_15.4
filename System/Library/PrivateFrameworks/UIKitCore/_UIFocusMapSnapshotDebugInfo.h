...
+ (id)_summaryImageForDebugInfoArray:(id)arg1 forFocusMovementWithInfo:(id)arg2 scaleFactor:(double)arg3;	// IMP=0x00000000005ca7fb
- (void).cxx_destruct;	// IMP=0x00000000005cb554
...
- (id)_drawImage;	// IMP=0x00000000005c9c6e
- (struct CGRect)_rectContainingAllFocusRegions;	// IMP=0x00000000005c9a76
@property(readonly, nonatomic) struct CGPoint imageAnchorPoint; // @synthesize imageAnchorPoint=_imageAnchorPoint;
@property(readonly, nonatomic) UIImage *image; // @synthesize image=_image;
- (id)initWithSnapshot:(id)arg1 focusMapSearchInfo:(id)arg2;	// IMP=0x00000000005c98f2
