...
+ (id)_withDisabledAppearanceTransitions:(_Bool)arg1 forVisibleDescendantsOf:(id)arg2 perform:(CDUnknownBlockType)arg3;	// IMP=0x000000000045280a
- (void).cxx_destruct;	// IMP=0x0000000000460c1d
...
- (void)_adjustNonOverlayLeadingScrollViewsForKeyboardInfo:(id)arg1;	// IMP=0x00000000004606d5
- (void)_adjustForKeyboardInfo:(id)arg1;	// IMP=0x00000000004600a5
- (void)_stopObservingKeyboardNotifications;	// IMP=0x000000000045fffe
- (void)_observeKeyboardNotificationsOnScreen:(id)arg1;	// IMP=0x000000000045ff16
...
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2 withVelocity:(double)arg3;	// IMP=0x000000000045fb02
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2;	// IMP=0x000000000045faed
- (void)animateToRequest:(id)arg1;	// IMP=0x000000000045fad9
- (_Bool)isSupplementaryViewControllerVisibleAfterAnimation;	// IMP=0x000000000045fa3b
- (_Bool)isTrailingViewControllerVisibleAfterAnimation;	// IMP=0x000000000045f99d
- (_Bool)isLeadingViewControllerVisibleAfterAnimation;	// IMP=0x000000000045f8ff
@property(readonly, nonatomic) id <UIViewControllerTransitionCoordinator> transitionCoordinator;
- (void)_animateFromRequest:(id)arg1 toRequest:(id)arg2 withAffectedSides:(long long)arg3 forceOverlay:(_Bool)arg4 velocity:(double)arg5;	// IMP=0x000000000045e870
- (struct CGSize)_expectedSecondaryColumnSizeAfterAnimatingToState:(id)arg1 getLeadingColumnSize:(struct CGSize *)arg2 trailingColumnSize:(struct CGSize *)arg3 supplementaryColumnSize:(struct CGSize *)arg4;	// IMP=0x000000000045e17a
- (void)stopAnimations;	// IMP=0x000000000045e163
- (void)_stopAnimationsBeginningInteraction:(_Bool)arg1;	// IMP=0x000000000045db49
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000045daca
- (void)_updateBorderViewsBackgroundColor:(id)arg1;	// IMP=0x000000000045d976
- (void)_setBorderViewsObserveViewBackgroundColor:(_Bool)arg1;	// IMP=0x000000000045d906
- (id)_createOverlayEdgeShadowViewForEdge:(unsigned long long)arg1;	// IMP=0x000000000045d8c8
- (id)_createBorderView;	// IMP=0x000000000045d880
- (double)interpolatedMarginForPrimaryNavigationBar:(id)arg1 supplementaryOrSecondaryNavbar:(id)arg2 getInterpolatedAlpha:(double *)arg3;	// IMP=0x000000000045d5cc
- (void)_updateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x0000000000456580
- (void)_unspecifiedUpdateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x0000000000454436
- (void)_performWrappedUpdate:(CDUnknownBlockType)arg1;	// IMP=0x00000000004541c8
- (void)_performSingleDeferredUpdatePass;	// IMP=0x00000000004533fe
- (void)_performDeferredUpdate;	// IMP=0x00000000004533a5
- (void)_setNeedsDeferredUpdate;	// IMP=0x0000000000453209
- (void)_setNeedsLayoutAndPerformImmediately:(_Bool)arg1;	// IMP=0x00000000004531c8
- (void)__viewWillLayoutSubviews;	// IMP=0x0000000000452fd8
- (void)_layoutContainerViewDidMoveToWindow:(id)arg1;	// IMP=0x0000000000452fd2
- (void)_layoutContainerViewWillMoveToWindow:(id)arg1;	// IMP=0x0000000000452e94
- (void)_withDisabledAppearanceTransitionsPerform:(CDUnknownBlockType)arg1;	// IMP=0x0000000000452119
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000004502a0
- (void)traitCollectionDidChange:(id)arg1 toNewTraits:(id)arg2;	// IMP=0x00000000004501e5
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000044ffe4
- (void)_expandWithTransitionCoordinator:(id)arg1;	// IMP=0x000000000044f4f5
- (void)_collapseWithTransitionCoordinator:(id)arg1;	// IMP=0x000000000044e42f
- (void)_updateForTraitCollection:(id)arg1 oldTraitCollection:(id)arg2 withTransitionCoordinator:(id)arg3;	// IMP=0x000000000044e0bc
- (_Bool)_willExpandWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x000000000044dfe1
- (_Bool)_willCollapseWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x000000000044df51
- (id)gatherMultitaskingDragExclusionRectsFromVisibleColumns;	// IMP=0x000000000044d965
- (void)addWrapperBlockForNextUpdate:(CDUnknownBlockType)arg1;	// IMP=0x000000000044d8d9
@property(readonly, nonatomic, getter=isCollapsed) _Bool collapsed;
@property(readonly, nonatomic) long long collapsedState;
- (_Bool)isAnimating;	// IMP=0x000000000044d6c2
- (void)setNeedsUpdate;	// IMP=0x000000000044d6b0
- (id)allViewControllers;	// IMP=0x000000000044d4e2
- (void)navigationControllerDidChangeNavigationBarHidden:(id)arg1;	// IMP=0x000000000044d4dc
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x000000000044d4ca
- (void)removeChildViewController:(id)arg1;	// IMP=0x000000000044d1d1
- (void)_removeIdentifiedChildViewController:(id)arg1;	// IMP=0x000000000044d0c3
- (void)_addIdentifiedChildViewController:(id)arg1;	// IMP=0x000000000044cdaf
- (void)loadView;	// IMP=0x000000000044cb5a
...
- (void)setSupplementaryViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x000000000044c4b2
@property(retain, nonatomic) UIViewController *supplementaryViewController;
- (void)setTrailingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x000000000044c359
@property(retain, nonatomic) UIViewController *trailingViewController;
- (void)setLeadingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x000000000044c200
@property(retain, nonatomic) UIViewController *leadingViewController;
- (void)setMainViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x000000000044c0a7
...
- (void)dealloc;	// IMP=0x000000000044bfc7
@property(readonly, nonatomic) _Bool supportsColumnStyle;
- (id)initWithOwningViewController:(id)arg1;	// IMP=0x000000000044bebb
