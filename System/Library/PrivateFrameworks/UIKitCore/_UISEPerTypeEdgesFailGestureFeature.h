...
- (void).cxx_destruct;	// IMP=0x00000000001c118c
@property(readonly, nonatomic) NSDictionary *edgeTypeSubfeatures; // @synthesize edgeTypeSubfeatures=_edgeTypeSubfeatures;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000001c10c6
- (id)debugDictionary;	// IMP=0x00000000001c0e2d
- (void)featureDidChangeState:(id)arg1;	// IMP=0x00000000001c0dec
@property(readonly, nonatomic) unsigned long long touchedEdges;
- (id)initWithEdgeTypeSubfeatures:(id)arg1;	// IMP=0x00000000001c0a53
