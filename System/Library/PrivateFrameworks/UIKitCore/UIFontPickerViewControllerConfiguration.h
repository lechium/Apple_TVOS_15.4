...
+ (id)filterPredicateForFilteredLanguages:(id)arg1;	// IMP=0x0000000000a86a4f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000a86782
- (void).cxx_destruct;	// IMP=0x0000000000a86b38
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a868c6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000a8678a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a8644f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a862e0
