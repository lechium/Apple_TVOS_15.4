...
+ (id)selectionRectWithRect:(struct CGRect)arg1 fromView:(id)arg2;	// IMP=0x0000000000a9743c
...
- (struct CGRect)rect;	// IMP=0x0000000000a9760c
- (id)description;	// IMP=0x0000000000a97578
- (void)setRect:(struct CGRect)arg1 fromView:(id)arg2;	// IMP=0x0000000000a974b5
