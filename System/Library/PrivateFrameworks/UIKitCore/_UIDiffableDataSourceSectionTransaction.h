...
- (void).cxx_destruct;	// IMP=0x00000000003a152d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003a12e6
- (id)description;	// IMP=0x00000000003a125d
- (id)initWithSectionIdentifier:(id)arg1 initialSnapshot:(id)arg2 finalSnapshot:(id)arg3 difference:(id)arg4;	// IMP=0x00000000003a117b
