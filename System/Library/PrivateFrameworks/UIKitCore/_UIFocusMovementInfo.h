...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000005c32fe
+ (id)_movementWithHeading:(unsigned long long)arg1 isInitial:(_Bool)arg2 fallbackMovementOriginatingFrame:(struct CGRect)arg3;	// IMP=0x00000000005c2efb
+ (id)_movementWithHeading:(unsigned long long)arg1 isInitial:(_Bool)arg2;	// IMP=0x00000000005c2eb7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005c3788
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005c3607
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x00000000005c349f
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x00000000005c3306
- (_Bool)_isLinearMovement;	// IMP=0x00000000005c32da
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005c315e
- (id)initWithHeading:(unsigned long long)arg1 linearHeading:(unsigned long long)arg2 isInitial:(_Bool)arg3 shouldLoadScrollableContainer:(_Bool)arg4 looping:(_Bool)arg5 groupFilter:(long long)arg6;	// IMP=0x00000000005c30b5
- (id)initWithHeading:(unsigned long long)arg1 velocity:(struct CGVector)arg2 isInitial:(_Bool)arg3 shouldLoadScrollableContainer:(_Bool)arg4 groupFilter:(long long)arg5;	// IMP=0x00000000005c2fdc
- (id)init;	// IMP=0x00000000005c2f78
