...
- (void).cxx_destruct;	// IMP=0x00000000006aeea9
...
- (id)description;	// IMP=0x00000000006aed6b
- (void)describeInto:(id)arg1;	// IMP=0x00000000006aec9c
...
- (_Bool)bg2HasHeight;	// IMP=0x00000000006aec33
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006aeb1f
- (id)initWithLayout:(id)arg1;	// IMP=0x00000000006aea5c
- (id)init;	// IMP=0x00000000006aea48
