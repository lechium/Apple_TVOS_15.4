...
+ (id)mergeActionWithOrderedKeyList:(id)arg1 factors:(id)arg2;	// IMP=0x0000000000826c76
+ (id)mergeActionWithRemainingKeyName:(id)arg1 disappearingKeyName:(id)arg2 factors:(id)arg3;	// IMP=0x0000000000826bc7
- (void).cxx_destruct;	// IMP=0x0000000000826d60
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000826b1a
