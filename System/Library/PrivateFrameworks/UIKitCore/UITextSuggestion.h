...
+ (id)textSuggestionWithInputText:(id)arg1 searchText:(id)arg2;	// IMP=0x0000000000a4376a
+ (id)textSuggestionWithInputText:(id)arg1;	// IMP=0x0000000000a43718
- (void).cxx_destruct;	// IMP=0x0000000000a43917
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a437de
- (id)initWithInputText:(id)arg1 searchText:(id)arg2 displayText:(id)arg3 headerText:(id)arg4;	// IMP=0x0000000000a4360b
