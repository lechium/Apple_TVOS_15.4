...
- (void).cxx_destruct;	// IMP=0x00000000002d312c
...
- (void)_writeToStorage:(CDUnknownBlockType)arg1;	// IMP=0x00000000002d278a
- (void)_clearOwner;	// IMP=0x00000000002d277c
- (id)_initWithOwner:(id)arg1 data:(id)arg2 state:(long long)arg3;	// IMP=0x00000000002d26e7
- (id)init;	// IMP=0x00000000002d26bc
