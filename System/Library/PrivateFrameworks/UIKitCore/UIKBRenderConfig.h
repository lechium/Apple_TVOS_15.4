...
+ (long long)backdropStyleForStyle:(long long)arg1 quality:(long long)arg2;	// IMP=0x000000000087a104
+ (id)configForAppearance:(long long)arg1 inputMode:(id)arg2 traitEnvironment:(id)arg3;	// IMP=0x0000000000879fe2
+ (id)lowQualityDarkConfig;	// IMP=0x0000000000879f3c
+ (id)darkConfig;	// IMP=0x0000000000879e16
+ (id)defaultEmojiConfig;	// IMP=0x0000000000879d2c
+ (id)defaultConfig;	// IMP=0x0000000000879be2
...
- (id)description;	// IMP=0x0000000000879b13
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000879a41
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008798b2
- (void)dealloc;	// IMP=0x0000000000879861
