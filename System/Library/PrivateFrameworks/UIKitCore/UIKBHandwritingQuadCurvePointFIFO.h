...
- (void).cxx_destruct;	// IMP=0x000000000084b958
...
- (void)clear;	// IMP=0x000000000084b83f
- (void)flush;	// IMP=0x000000000084b552
- (void)addPoint:(struct)arg1;	// IMP=0x000000000084afba
- (id)initWithFIFO:(id)arg1 scale:(double)arg2;	// IMP=0x000000000084af24
