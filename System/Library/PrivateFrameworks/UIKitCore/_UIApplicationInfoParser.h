...
@interface _UIApplicationInfoParser : NSObject
{
    ...
    _Bool _requiresGameControllerBasedFocus;	// 20 = 0x14
    _Bool _focusEnabledInLimitedControls;	// 21 = 0x15
    _Bool _forcesDefaultFocusAppearance;	// 22 = 0x16
    _Bool _focusSystemEnabled;	// 23 = 0x17
    _Bool _supportsPrintCommand;	// 24 = 0x18
...
+ (id)mainBundleInfoParser;	// IMP=0x000000000064b8ea
- (void).cxx_destruct;	// IMP=0x000000000064c883
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x000000000064c758
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x000000000064c68b
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x000000000064c43c
- (_Bool)_shouldUseHiResForClassic;	// IMP=0x000000000064c434
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x000000000064bc5e
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x000000000064b9e6
- (id)_initWithBundle:(id)arg1;	// IMP=0x000000000064b990
