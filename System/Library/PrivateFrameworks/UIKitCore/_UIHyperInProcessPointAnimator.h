...
@class NSArray, NSString, UIViewSpringAnimationBehavior, _UIHyperInteractor, _UISpringParameters;
...
@interface _UIHyperInProcessPointAnimator : NSObject <_UIHyperAnimator_Internal, _UIHyperAnimator, NSSecureCoding, NSCopying>
{
    ...
    NSArray *__animatableProperties;	// 56 = 0x38
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008b1b9
- (void).cxx_destruct;	// IMP=0x000000000008b7b6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008b4ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008b3d4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008b2dc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008b1c1
- (void)_animateInteractive:(_Bool)arg1 animations:(CDUnknownBlockType)arg2;	// IMP=0x000000000008afec
- (void)_animateWithParameters:(id)arg1 animations:(CDUnknownBlockType)arg2;	// IMP=0x000000000008af2b
- (void)_interactionEndedMutatingState:(CDUnknownBlockType)arg1;	// IMP=0x000000000008ae05
- (void)_interactionChanged;	// IMP=0x000000000008ac10
- (void)_interactionBegan;	// IMP=0x000000000008ab5c
- (void)_updateAnimatablePropertyValuesToConstrainedPoint;	// IMP=0x000000000008aa45
...
- (id)initWithDimensions:(unsigned long long)arg1;	// IMP=0x000000000008a15d
