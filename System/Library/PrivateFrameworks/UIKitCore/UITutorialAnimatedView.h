...
- (void).cxx_destruct;	// IMP=0x00000000001136f1
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001135b8
- (void)_setPackage:(id)arg1;	// IMP=0x0000000000112d9a
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000112c72
