...
- (void).cxx_destruct;	// IMP=0x000000000079918e
...
- (void)connectForSimulator;	// IMP=0x0000000000799139
- (void)connect;	// IMP=0x0000000000799133
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007990b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000798fe2
