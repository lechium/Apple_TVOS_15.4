...
+ (id)sectionWithRows:(id)arg1;	// IMP=0x0000000000d893ac
- (void).cxx_destruct;	// IMP=0x0000000000d89665
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000d8952f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000d89406
