...
- (void).cxx_destruct;	// IMP=0x0000000000a589aa
...
- (void)updateControlWithDirection:(long long)arg1 travelProgress:(double)arg2 isRTL:(_Bool)arg3;	// IMP=0x0000000000a586f4
- (void)controlActionUpOutside:(id)arg1;	// IMP=0x0000000000a58691
- (void)controlActionUpInside:(id)arg1 forEvent:(id)arg2;	// IMP=0x0000000000a584a8
- (void)controlActionDown:(id)arg1;	// IMP=0x0000000000a5840a
- (void)performDelegateRedoAndUpdateHUDIfNeeded;	// IMP=0x0000000000a5838f
- (void)performDelegateUndoAndUpdateHUDIfNeeded;	// IMP=0x0000000000a58314
- (void)updateHUDControlState;	// IMP=0x0000000000a58008
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000a57f94
- (_Bool)availableOfControl:(id)arg1;	// IMP=0x0000000000a57e98
- (id)controlForType:(long long)arg1;	// IMP=0x0000000000a57d19
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000a57ca6
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000a57ca0
- (id)createSeparatorView;	// IMP=0x0000000000a57b65
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2 mode:(long long)arg3 sceneBounds:(struct CGRect)arg4;	// IMP=0x0000000000a55163
