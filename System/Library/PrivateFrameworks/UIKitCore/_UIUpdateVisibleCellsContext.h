...
- (void).cxx_destruct;	// IMP=0x0000000000348f92
...
- (void)didLeaveVisibleCellsPass;	// IMP=0x0000000000348f58
- (void)didEnterVisibleCellsPass;	// IMP=0x0000000000348f4e
@property(readonly, nonatomic) NSIndexSet *sectionIndexes;
- (id)description;	// IMP=0x0000000000348ce7
- (_Bool)shouldInvalidate;	// IMP=0x0000000000348cb5
- (void)addPreferredAttributes:(id)arg1;	// IMP=0x00000000003489fe
- (id)init;	// IMP=0x0000000000348953
