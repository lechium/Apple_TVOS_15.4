...
+ (id)sharedInstance;	// IMP=0x0000000000609fb7
- (void).cxx_destruct;	// IMP=0x000000000060a8d1
...
- (void)_playSystemSound:(unsigned int)arg1 withVolume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000060a313
- (void)playSoundWithFocusSound:(long long)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000060a225
- (void)playSoundWithURL:(id)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x000000000060a0b9
- (void)dealloc;	// IMP=0x000000000060a01c
- (void)_registerForSystemSoundsIfNecessary;	// IMP=0x0000000000609dc3
- (id)_init;	// IMP=0x0000000000609bf4
