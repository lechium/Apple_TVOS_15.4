...
+ (id)configurationWithActions:(id)arg1;	// IMP=0x0000000000cdc213
- (void).cxx_destruct;	// IMP=0x0000000000cdc403
...
- (id)description;	// IMP=0x0000000000cdc2b4
- (id)init;	// IMP=0x0000000000cdc24e
