...
- (void).cxx_destruct;	// IMP=0x0000000000e3a776
...
- (id)replacements;	// IMP=0x0000000000e39d5d
- (void)addSpellingGuessesForString:(id)arg1 ToReplacements:(id)arg2;	// IMP=0x0000000000e39979
- (void)addAutocorrectionGuessesToReplacements:(id)arg1;	// IMP=0x0000000000e395b3
- (void)addPreviouslySuggestedAutocorrectionToReplacements:(id)arg1;	// IMP=0x0000000000e393d8
- (id)addReplacementRevertingAutocorrectionToReplacements:(id)arg1;	// IMP=0x0000000000e391e5
- (_Bool)isStringToReplaceMisspelled;	// IMP=0x0000000000e39192
- (_Bool)isStringMisspelled:(id)arg1;	// IMP=0x0000000000e39037
- (id)init;	// IMP=0x0000000000e38fee
