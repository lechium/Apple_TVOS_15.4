...
+ (id)_focusAnimationCoordinatorForAnimationType:(long long)arg1 withConfiguration:(id)arg2 inContext:(id)arg3;	// IMP=0x00000000005a6745
+ (id)_unfocusingAnimationCoordinatorWithConfiguration:(id)arg1 inContext:(id)arg2;	// IMP=0x00000000005a6728
+ (id)_focusingAnimationCoordinatorWithConfiguration:(id)arg1 inContext:(id)arg2;	// IMP=0x00000000005a670e
- (void).cxx_destruct;	// IMP=0x00000000005a7a02
...
- (void)_cancelFocusAnimation:(long long)arg1;	// IMP=0x00000000005a7954
- (void)_animateFocusAnimation:(long long)arg1;	// IMP=0x00000000005a7636
- (void)_animate;	// IMP=0x00000000005a7605
- (void)addCoordinatedUnfocusingAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000005a7556
- (void)addCoordinatedFocusingAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000005a74a7
- (void)addCoordinatedAnimationsForAnimation:(long long)arg1 animations:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000005a73b3
- (void)addCoordinatedAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000005a7337
- (void)_consumeBlocks:(id)arg1 withAnimationContext:(id)arg2;	// IMP=0x00000000005a7209
- (void)_consumeBlocks:(id)arg1;	// IMP=0x00000000005a70f2
- (void)_prepareForFocusAnimation:(long long)arg1;	// IMP=0x00000000005a70e4
@property(readonly, copy, nonatomic, getter=_activeConfiguration) _UIFocusAnimationConfiguration *activeConfiguration;
- (id)_configurationForFocusAnimation:(long long)arg1;	// IMP=0x00000000005a7056
- (void)_setConfiguration:(id)arg1 forFocusAnimation:(long long)arg2;	// IMP=0x00000000005a6fea
...
- (void)_configureWithFocusUpdateContext:(id)arg1;	// IMP=0x00000000005a6984
- (id)_initWithFocusUpdateContext:(id)arg1;	// IMP=0x00000000005a686c
- (id)init;	// IMP=0x00000000005a6858
