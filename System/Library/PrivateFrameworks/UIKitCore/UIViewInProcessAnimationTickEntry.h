...
- (void).cxx_destruct;	// IMP=0x0000000000fa1f82
...
- (id)initWithPreferredFrameRateRange:(struct CAFrameRateRange)arg1 updateReason:(unsigned int)arg2 velocityUsableForVFD:(_Bool)arg3 callback:(CDUnknownBlockType)arg4;	// IMP=0x0000000000fa1eba
