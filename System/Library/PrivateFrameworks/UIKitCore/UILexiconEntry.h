...
+ (id)_entryWithTILexiconEntry:(id)arg1;	// IMP=0x000000000080f366
- (void).cxx_destruct;	// IMP=0x000000000080f459
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000080f161
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000080f0f0
