...
- (void).cxx_destruct;	// IMP=0x0000000000be4ccd
...
- (void)_loadStateFromPressInfo:(id)arg1;	// IMP=0x0000000000be4a85
- (void)_loadStateFromPress:(id)arg1;	// IMP=0x0000000000be49d5
- (_Bool)_isSynthetic;	// IMP=0x0000000000be49b0
- (id)_phaseDescription;	// IMP=0x0000000000be4948
@property(readonly, copy) NSString *description;
- (_Bool)_isDirectionalPress;	// IMP=0x0000000000be48ac
...
- (SEL)_responderSelectorForPhase:(long long)arg1;	// IMP=0x0000000000be4830
- (id)_forwardingRecord;	// IMP=0x0000000000be4822
- (void)_abandonForwardingRecord;	// IMP=0x0000000000be4804
- (_Bool)_isAbandoningForwardingRecord;	// IMP=0x0000000000be47fb
- (id)_mutableForwardingRecord;	// IMP=0x0000000000be47c0
- (_Bool)_wantsForwardingFromResponder:(id)arg1 toNextResponder:(id)arg2 withEvent:(id)arg3;	// IMP=0x0000000000be47b3
- (long long)_responderForwardableType;	// IMP=0x0000000000be47a8
- (void)_removeGestureRecognizer:(id)arg1;	// IMP=0x0000000000be4759
