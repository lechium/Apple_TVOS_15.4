...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000a9e21c
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000a9e1ef
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000a9e1ba
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000a9e151
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000a9e13f
- (void)reset;	// IMP=0x0000000000a9df53
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000a9db90
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000a9da6a
- (id)description;	// IMP=0x0000000000a9d982
- (void)dealloc;	// IMP=0x0000000000a9d900
- (id)init;	// IMP=0x0000000000a9d7ee
