...
+ (id)proxyDecodingAnimationsForTarget:(id)arg1;	// IMP=0x0000000000f4b040
- (void).cxx_destruct;	// IMP=0x0000000000f4b2d6
- (void)__animateNextInvocationOfSelector:(id)arg1 withAnimationAttributes:(id)arg2 animationsEnabled:(_Bool)arg3;	// IMP=0x0000000000f4b271
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000f4b07e
