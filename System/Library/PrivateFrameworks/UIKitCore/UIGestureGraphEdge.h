...
- (void).cxx_destruct;	// IMP=0x00000000006b13fc
...
- (id)description;	// IMP=0x00000000006b12b0
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x00000000006b1106
- (id)oppositeNode:(id)arg1;	// IMP=0x00000000006b10c9
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x00000000006b0f0f
