...
- (void).cxx_destruct;	// IMP=0x0000000000beada4
- (void)dealloc;	// IMP=0x0000000000bead61
- (void)eventFetcherDidReceiveEvents:(id)arg1;	// IMP=0x0000000000bead40
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000000bea9ec
