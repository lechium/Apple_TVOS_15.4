...
- (void).cxx_destruct;	// IMP=0x0000000000054dda
...
- (void)_animateTransition:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000054a83
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000054475
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000543e5
- (id)_alertControllerForContext:(id)arg1;	// IMP=0x0000000000054318
- (id)initWithInteractionProgress:(id)arg1;	// IMP=0x00000000000542aa
