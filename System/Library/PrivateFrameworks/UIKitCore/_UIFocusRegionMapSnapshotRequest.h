...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x00000000005e4c50
- (void).cxx_destruct;	// IMP=0x00000000005e5ad4
...
- (id)takeSnapshot;	// IMP=0x00000000005e4eac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005e4d89
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x00000000005e4cbc
