...
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000bd058
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x00000000000bcee5
- (void)_updateBackgroundColor;	// IMP=0x00000000000bce32
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000bcdf1
- (_Bool)isUserInteractionEnabled;	// IMP=0x00000000000bcda8
- (_Bool)canBecomeFocused;	// IMP=0x00000000000bcd5f
- (void)layoutSubviews;	// IMP=0x00000000000bcbb8
- (void)resumePersistentAnimation;	// IMP=0x00000000000bca4b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000bc814
