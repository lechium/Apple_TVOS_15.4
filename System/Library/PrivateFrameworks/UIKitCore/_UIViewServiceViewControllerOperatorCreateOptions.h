...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000f38b96
- (void).cxx_destruct;	// IMP=0x0000000000f38c74
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f38791
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000f384a9
