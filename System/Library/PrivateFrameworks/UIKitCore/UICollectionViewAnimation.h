...
- (void).cxx_destruct;	// IMP=0x0000000000351982
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003518f6
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000035189e
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000350b7d
- (void)start;	// IMP=0x0000000000350b69
...
- (id)description;	// IMP=0x0000000000350a85
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x00000000003507f3
