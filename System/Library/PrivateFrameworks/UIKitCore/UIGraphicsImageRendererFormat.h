...
+ (id)formatForTraitCollection:(id)arg1;	// IMP=0x0000000000735b06
+ (id)preferredFormat;	// IMP=0x0000000000735922
+ (id)defaultFormat;	// IMP=0x0000000000735860
...
- (void)dealloc;	// IMP=0x0000000000735d5e
- (id)init;	// IMP=0x0000000000735cfd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000735c37
