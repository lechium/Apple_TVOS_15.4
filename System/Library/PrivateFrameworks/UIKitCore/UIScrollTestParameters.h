...
- (void).cxx_destruct;	// IMP=0x0000000000fdb8c5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000fdb6eb
@property(readonly, nonatomic) double endOffset;
- (void)dealloc;	// IMP=0x0000000000fdb658
- (id)init;	// IMP=0x0000000000fdb609
