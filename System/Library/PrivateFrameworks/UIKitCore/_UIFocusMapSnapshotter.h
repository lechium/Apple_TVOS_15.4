...
- (void).cxx_destruct;	// IMP=0x00000000005fb403
...
- (id)captureSnapshot;	// IMP=0x00000000005fb20b
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x00000000005fab4e
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x00000000005fa843
- (id)init;	// IMP=0x00000000005fa7bc
