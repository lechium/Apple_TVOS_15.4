...
- (void).cxx_destruct;	// IMP=0x000000000061e214
...
- (id)_trimEntries:(id)arg1 toFitCount:(long long)arg2;	// IMP=0x000000000061de5b
- (id)entriesTrimmedToFitCount:(unsigned long long)arg1;	// IMP=0x000000000061da2a
