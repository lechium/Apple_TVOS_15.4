...
+ (id)decorationItemWithSize:(id)arg1 elementKind:(id)arg2 containerAnchor:(id)arg3;	// IMP=0x00000000002421da
+ (id)backgroundDecorationItemWithElementKind:(id)arg1;	// IMP=0x0000000000242126
- (void).cxx_destruct;	// IMP=0x00000000002427ce
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000024240c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002422a2
- (id)initWithElementKind:(id)arg1 size:(id)arg2 contentInsets:(struct NSDirectionalEdgeInsets)arg3 containerAnchor:(id)arg4 itemAnchor:(id)arg5 zIndex:(long long)arg6 registrationViewClass:(Class)arg7 isBackgroundDecoration:(_Bool)arg8;	// IMP=0x0000000000241f93
