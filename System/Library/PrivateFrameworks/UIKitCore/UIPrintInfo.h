...
+ (id)printInfoWithDictionary:(id)arg1;	// IMP=0x0000000000b0bbbd
+ (id)printInfo;	// IMP=0x0000000000b0bb99
- (void).cxx_destruct;	// IMP=0x0000000000b108f7
...
- (id)_createPrintSettingsForPrinter:(id)arg1;	// IMP=0x0000000000b0dd06
- (void)_updateWithPrinter:(id)arg1;	// IMP=0x0000000000b0d522
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b0d4bc
- (void)updateWithDictionary:(id)arg1;	// IMP=0x0000000000b0cf9a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000b0cce6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000b0ca5b
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)_initWithDictionary:(id)arg1;	// IMP=0x0000000000b0bc48
- (id)init;	// IMP=0x0000000000b0bc06
