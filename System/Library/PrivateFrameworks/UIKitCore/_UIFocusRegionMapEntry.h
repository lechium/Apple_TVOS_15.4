...
- (void).cxx_destruct;	// IMP=0x00000000005ec581
...
- (id)description;	// IMP=0x00000000005ec41b
...
- (id)_uniqueElementFromArray:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000005ec0fd
- (void)_wasOccludedByFrame:(struct CGRect)arg1;	// IMP=0x00000000005ebfd5
- (id)sliceWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005ebf62
- (id)_mapEntriesByOccludingWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005eb8d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005eb83f
- (id)initWithFrame:(struct CGRect)arg1 originalRegionFrame:(struct CGRect)arg2;	// IMP=0x00000000005eb7d0
