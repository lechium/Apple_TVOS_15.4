...
- (void).cxx_destruct;	// IMP=0x0000000000f917a0
...
- (void)_handlePan:(id)arg1;	// IMP=0x0000000000f9137d
...
- (void)didMoveToView:(id)arg1;	// IMP=0x0000000000f911bb
- (void)willMoveToView:(id)arg1;	// IMP=0x0000000000f91126
