...
- (void).cxx_destruct;	// IMP=0x00000000006e7940
...
- (unsigned long long)_targetEdges;	// IMP=0x00000000006e7797
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x00000000006e760c
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x00000000006e74d0
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000006e64a4
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000006e5b60
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000006e5ad5
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x00000000006e5a45
- (long long)_type;	// IMP=0x00000000006e5a38
- (void)_setState:(long long)arg1;	// IMP=0x00000000006e58a9
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x00000000006e5814
- (void)dealloc;	// IMP=0x00000000006e57d8
- (id)initWithType:(long long)arg1;	// IMP=0x00000000006e5779
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x00000000006e556f
