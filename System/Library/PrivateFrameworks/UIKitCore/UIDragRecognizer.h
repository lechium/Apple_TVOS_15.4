...
+ (_Bool)_shouldDefaultToTouches;	// IMP=0x0000000000deb678
- (void).cxx_destruct;	// IMP=0x0000000000deb810
...
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000deb645
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000deb580
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000deb144
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000deaeef
- (void)clearIgnoreTouch;	// IMP=0x0000000000deae95
- (void)tooSlow:(id)arg1;	// IMP=0x0000000000deae62
- (void)clearTimer;	// IMP=0x0000000000deae2a
- (void)_resetGestureRecognizer;	// IMP=0x0000000000deadd5
- (void)dealloc;	// IMP=0x0000000000dead73
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000deacd3
