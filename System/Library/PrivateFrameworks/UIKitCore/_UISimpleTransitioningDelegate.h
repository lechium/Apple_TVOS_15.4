...
- (void).cxx_destruct;	// IMP=0x00000000003d1e76
...
- (_Bool)_navigationControllerShouldCrossFadeNavigationBar:(id)arg1;	// IMP=0x00000000003d1e57
- (id)navigationController:(id)arg1 animationControllerForOperation:(long long)arg2 fromViewController:(id)arg3 toViewController:(id)arg4;	// IMP=0x00000000003d1e33
- (id)initWithAnimator:(id)arg1;	// IMP=0x00000000003d1db5
