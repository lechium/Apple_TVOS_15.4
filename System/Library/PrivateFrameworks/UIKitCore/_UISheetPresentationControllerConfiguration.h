...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000de1210
+ (id)_fullScreenConfiguration;	// IMP=0x0000000000de087d
- (void).cxx_destruct;	// IMP=0x0000000000de1335
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000de0fb1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000de0d6a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000de08b5
- (id)init;	// IMP=0x0000000000de07a1
