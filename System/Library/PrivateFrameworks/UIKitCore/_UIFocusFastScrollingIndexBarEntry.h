...
+ (id)placeholderEntryWithEntryBefore:(id)arg1 after:(id)arg2;	// IMP=0x000000000061d6fb
+ (id)entryWithTitle:(id)arg1 generator:(CDUnknownBlockType)arg2;	// IMP=0x000000000061d5d6
+ (id)entryWithTitle:(id)arg1 contentOffset:(struct CGPoint)arg2;	// IMP=0x000000000061d4dc
- (void).cxx_destruct;	// IMP=0x000000000061d9f7
...
- (id)description;	// IMP=0x000000000061d8a2
...
- (id)initWithTitle:(id)arg1 generator:(CDUnknownBlockType)arg2;	// IMP=0x000000000061d642
- (id)initWithTitle:(id)arg1 contentOffset:(struct CGPoint)arg2;	// IMP=0x000000000061d541
