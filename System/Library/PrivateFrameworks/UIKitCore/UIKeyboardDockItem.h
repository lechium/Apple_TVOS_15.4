...
+ (id)_darkStyleGlyphColor;	// IMP=0x000000000095fd3b
+ (id)_standardGlyphColor;	// IMP=0x000000000095fd02
- (void).cxx_destruct;	// IMP=0x0000000000960363
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x000000000095ffa8
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000095fd54
