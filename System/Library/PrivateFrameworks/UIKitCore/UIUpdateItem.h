...
- (void).cxx_destruct;	// IMP=0x0000000000dad1ae
...
- (long long)inverseCompareIndexPaths:(id)arg1;	// IMP=0x0000000000dad157
- (long long)compareIndexPaths:(id)arg1;	// IMP=0x0000000000dad134
