...
+ (id)hostingInfoForWindowScene:(id)arg1;	// IMP=0x0000000000e5d6fd
- (void).cxx_destruct;	// IMP=0x0000000000e5d75b
...
- (_Bool)_matchingOptions:(id)arg1;	// IMP=0x0000000000e5d6b0
- (id)_initWithCanvas:(id)arg1 options:(id)arg2;	// IMP=0x0000000000e5d60f
