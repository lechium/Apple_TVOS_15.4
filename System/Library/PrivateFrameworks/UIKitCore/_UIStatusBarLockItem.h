...
+ (id)textDisplayIdentifier;	// IMP=0x0000000000c32b80
- (void).cxx_destruct;	// IMP=0x0000000000c33ffc
...
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000c33e85
- (void)_create_stringView;	// IMP=0x0000000000c33e0d
- (void)_create_lockView;	// IMP=0x0000000000c33d7c
- (id)removalAnimationForDisplayItemWithIdentifier:(id)arg1;	// IMP=0x0000000000c33c4e
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000c33b63
- (id)additionAnimationForDisplayItemWithIdentifier:(id)arg1;	// IMP=0x0000000000c333f6
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000c32c63
- (_Bool)canEnableDisplayItem:(id)arg1 fromData:(id)arg2;	// IMP=0x0000000000c32bbc
- (id)dependentEntryKeys;	// IMP=0x0000000000c32b99
