...
+ (id)graphCacheForScreen:(id)arg1;	// IMP=0x00000000008ad495
@property(readonly, nonatomic) NSMutableDictionary *graphCache; // @synthesize graphCache=_graphCache;
@property(readonly) NSDictionary *_options;
- (_Bool)_matchingOptions:(id)arg1;	// IMP=0x00000000008ad485
@property(readonly) UIScreen *_intendedScreen;
- (void)dealloc;	// IMP=0x00000000008ad440
- (id)_initWithScreen:(id)arg1 options:(id)arg2;	// IMP=0x00000000008ad3d4
