...
+ (id)defaultConfiguration;	// IMP=0x000000000024bb6e
- (void).cxx_destruct;	// IMP=0x000000000024bfa8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024be9e
@property(nonatomic, getter=_safeAreaReference, setter=_setSafeAreaReference:) long long safeAreaReference;
- (unsigned long long)differencesFromConfiguration:(id)arg1;	// IMP=0x000000000024bc5a
- (id)initWithScrollDirection:(long long)arg1 interSectionSpacing:(double)arg2 boundarySupplememtaryItems:(id)arg3 contentInsetsReference:(long long)arg4;	// IMP=0x000000000024bba2
- (id)init;	// IMP=0x000000000024bb4a
