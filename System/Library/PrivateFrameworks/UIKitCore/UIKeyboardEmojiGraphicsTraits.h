...
+ (id)emojiGraphicsTraitsForCurrentScreenTraits;	// IMP=0x0000000000925332
+ (id)emojiGraphicsTraitsWithScreenTraits:(id)arg1;	// IMP=0x0000000000925303
...
- (id)initWithScreenTrait:(id)arg1;	// IMP=0x0000000000924af0
