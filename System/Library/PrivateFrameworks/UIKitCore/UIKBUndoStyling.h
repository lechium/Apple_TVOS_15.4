...
- (void).cxx_destruct;	// IMP=0x0000000000a53572
...
- (void)createDynamicColors;	// IMP=0x0000000000a5307d
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000a53064
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000a52f90
