...
- (void).cxx_destruct;	// IMP=0x0000000000ca0370
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000ca023b
- (id)type;	// IMP=0x0000000000ca0214
- (id)itemStates;	// IMP=0x0000000000ca0068
- (_Bool)isFulfilled;	// IMP=0x0000000000c9feb3
