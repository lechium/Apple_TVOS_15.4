...
- (void).cxx_destruct;	// IMP=0x0000000000553384
...
- (void)setModalPresentationStyle:(long long)arg1;	// IMP=0x0000000000553237
- (void)_dismissWithOption:(id)arg1;	// IMP=0x0000000000552ed4
- (void)_dismissViewController;	// IMP=0x0000000000552d76
- (void)actionSheetPresentationControllerDidDismissActionSheet:(id)arg1;	// IMP=0x0000000000552d64
- (void)_displayLocationsMenuFromRect:(struct CGRect)arg1;	// IMP=0x0000000000552cea
- (void)_stitchFileCreationAtURL:(id)arg1;	// IMP=0x0000000000552ce4
- (void)_didSelectURL:(id)arg1;	// IMP=0x0000000000552cde
- (void)_didSelectPicker;	// IMP=0x0000000000552b02
...
- (void)addOptionWithTitle:(id)arg1 image:(id)arg2 order:(unsigned long long)arg3 handler:(CDUnknownBlockType)arg4;	// IMP=0x000000000055252f
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x00000000005524d1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005524a2
- (void)_commonInitWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000552059
- (id)initWithURL:(id)arg1 inMode:(unsigned long long)arg2;	// IMP=0x0000000000551c6f
- (id)_initIgnoringApplicationEntitlementForImportOfTypes:(id)arg1;	// IMP=0x0000000000551c50
- (id)initWithDocumentTypes:(id)arg1 inMode:(unsigned long long)arg2;	// IMP=0x0000000000551a82
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000551980
