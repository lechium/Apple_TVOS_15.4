...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000a4e5fa
- (void)placeGlyphs;	// IMP=0x0000000000a4e482
- (void)removeGlyphs;	// IMP=0x0000000000a4e36c
- (void)buildGlyphViews;	// IMP=0x0000000000a4d36f
- (void)dealloc;	// IMP=0x0000000000a4d2f2
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000a4d17a
