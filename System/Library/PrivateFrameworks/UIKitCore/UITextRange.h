...
- (struct _NSRange)_asNSRangeRelativeToDocument:(id)arg1 relativeToCurrentLine:(_Bool)arg2;	// IMP=0x0000000000a40e09
- (struct _NSRange)_asNSRangeRelativeToDocument:(id)arg1;	// IMP=0x0000000000a40df5
