...
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3;	// IMP=0x000000000003f44d
+ (id)shapeWithPath:(id)arg1;	// IMP=0x000000000003f3e9
- (void).cxx_destruct;	// IMP=0x000000000004002f
...
- (id)description;	// IMP=0x000000000003fdc4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003fcef
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003faad
...
- (id)shapeConvertedFromCoordinateSpace:(id)arg1 toCoordinateSpace:(id)arg2;	// IMP=0x000000000003f4b6
