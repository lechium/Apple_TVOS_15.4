...
- (void).cxx_destruct;	// IMP=0x0000000000a9c9f6
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000a9c7ea
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000a9c668
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000a9c5e4
- (id)init;	// IMP=0x0000000000a9c532
