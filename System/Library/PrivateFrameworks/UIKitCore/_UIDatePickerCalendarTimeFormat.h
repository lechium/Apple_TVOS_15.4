...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x0000000000661813
- (void).cxx_destruct;	// IMP=0x0000000000663d7a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000663a73
- (id)withTimeZone:(id)arg1;	// IMP=0x00000000006639c7
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x000000000066397d
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x0000000000663873
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x000000000066385e
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x0000000000662c50
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x000000000066188f
