...
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 desiredUnits:(long long)arg3;	// IMP=0x0000000000abef16
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2;	// IMP=0x0000000000abeefa
- (void).cxx_destruct;	// IMP=0x0000000000abf96a
...
- (id)description;	// IMP=0x0000000000abf6f9
- (id)_initWithFormatString:(id)arg1 calendarUnit:(unsigned long long)arg2;	// IMP=0x0000000000abf65c
