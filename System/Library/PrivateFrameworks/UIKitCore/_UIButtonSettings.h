...
+ (id)settingsControllerModule;	// IMP=0x0000000000e8d399
...
- (void)setDefaultValues;	// IMP=0x0000000000e8d30c
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x0000000000e8d086
- (id)initWithDefaultValues;	// IMP=0x0000000000e8d037
