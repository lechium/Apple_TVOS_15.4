...
- (void).cxx_destruct;	// IMP=0x0000000000d24ee5
...
- (void)listItemSelected:(id)arg1;	// IMP=0x0000000000d24d00
- (id)selectedItem;	// IMP=0x0000000000d24cc9
- (id)itemList;	// IMP=0x0000000000d24c66
- (id)title;	// IMP=0x0000000000d24b7a
- (id)initWithTemplates:(id)arg1 finishingTemplateNames:(id)arg2 printPanelViewController:(id)arg3 finishingOptionsTableView:(id)arg4;	// IMP=0x0000000000d2494b
