...
+ (id)darkeningTintColor;	// IMP=0x00000000000c8959
+ (id)settingsForPrivateStyle:(long long)arg1;	// IMP=0x00000000000c8146
+ (id)settingsForStyle:(long long)arg1;	// IMP=0x00000000000c8132
+ (id)settingsForPrivateStyle:(long long)arg1 graphicsQuality:(long long)arg2;	// IMP=0x00000000000c8120
+ (id)settingsForStyle:(long long)arg1 graphicsQuality:(long long)arg2;	// IMP=0x00000000000c7b5a
+ (id)settingsPreservingHintsFromSettings:(id)arg1 graphicsQuality:(long long)arg2;	// IMP=0x00000000000c7a98
- (void).cxx_destruct;	// IMP=0x00000000000c98e8
...
- (id)description;	// IMP=0x00000000000c932b
@property(readonly, nonatomic) UIColor *combinedTintColor;
- (void)computeOutputSettingsUsingModel:(id)arg1;	// IMP=0x00000000000c91c2
@property(nonatomic) _Bool blursWithHardEdges; // @dynamic blursWithHardEdges;
- (void)scheduleSettingsDidChangeIfNeeded;	// IMP=0x00000000000c907e
- (void)clearRunLoopObserver;	// IMP=0x00000000000c904f
- (_Bool)requiresBackdropLayer;	// IMP=0x00000000000c903d
@property(nonatomic) _Bool zoomsBack;
- (void)setStyle:(long long)arg1;	// IMP=0x00000000000c8f30
- (void)setStackinglevel:(long long)arg1;	// IMP=0x00000000000c8f00
- (void)copyAdditionalSettingsFromSettings:(id)arg1;	// IMP=0x00000000000c89de
- (void)setValuesFromModel:(id)arg1;	// IMP=0x00000000000c8628
- (void)removeKeyPathObserver:(id)arg1;	// IMP=0x00000000000c8622
- (void)addKeyPathObserver:(id)arg1;	// IMP=0x00000000000c861c
- (void)dealloc;	// IMP=0x00000000000c85de
- (void)restoreDefaultValues;	// IMP=0x00000000000c85b0
- (void)setDefaultValues;	// IMP=0x00000000000c82ae
- (id)initWithDefaultValuesForGraphicsQuality:(long long)arg1;	// IMP=0x00000000000c817e
- (id)initWithDefaultValues;	// IMP=0x00000000000c816a
- (id)init;	// IMP=0x00000000000c8158
