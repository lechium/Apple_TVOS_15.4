...
- (_Bool)isUISubclass;	// IMP=0x0000000000674458
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofSetting:(unsigned long long)arg3;	// IMP=0x0000000000673ff8
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x0000000000673e2b
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000673dfd
...
- (double)defaultStatusBarHeightForOrientation:(long long)arg1;	// IMP=0x00000000006733e7
