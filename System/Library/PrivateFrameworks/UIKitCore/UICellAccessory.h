...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000009c44e4
- (void).cxx_destruct;	// IMP=0x00000000009c4996
...
- (unsigned long long)hash;	// IMP=0x00000000009c48ef
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009c4753
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009c46cd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009c4612
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009c44ec
@property(readonly, nonatomic, getter=_identifier) NSString *identifier;
- (long long)_defaultPlacementForHeader:(_Bool)arg1;	// IMP=0x00000000009c4490
- (long long)_systemTypePlacementForHeader:(_Bool)arg1;	// IMP=0x00000000009c4462
...
- (id)init;	// IMP=0x00000000009c430e
