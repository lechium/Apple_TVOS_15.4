...
- (void).cxx_destruct;	// IMP=0x0000000000d169e1
- (id)reorderSeparatorView:(_Bool)arg1;	// IMP=0x0000000000d168e1
- (id)reorderControl:(_Bool)arg1;	// IMP=0x0000000000d16841
- (id)editControl:(_Bool)arg1;	// IMP=0x0000000000d1672a
...
- (void)dealloc;	// IMP=0x0000000000d1666d
- (id)initWithTableViewCell:(id)arg1 editingStyle:(long long)arg2;	// IMP=0x0000000000d165fe
