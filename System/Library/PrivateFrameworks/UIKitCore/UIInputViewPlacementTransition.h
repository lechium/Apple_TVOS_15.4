...
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0000000000939111
...
- (void)dealloc;	// IMP=0x0000000000939236
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000939185
