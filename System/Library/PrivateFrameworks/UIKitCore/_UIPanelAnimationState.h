...
+ (double)defaultDuration;	// IMP=0x00000000004481cb
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x000000000044818d
+ (id)timingCurveProvider;	// IMP=0x0000000000448174
- (void).cxx_destruct;	// IMP=0x00000000004482c8
...
- (id)description;	// IMP=0x00000000004480da
