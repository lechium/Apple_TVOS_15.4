...
+ (id)settingsControllerModule;	// IMP=0x00000000006e52b4
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x00000000006e5294
...
- (void)setDefaultValues;	// IMP=0x00000000006e51f1
