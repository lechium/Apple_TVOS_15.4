...
- (void).cxx_destruct;	// IMP=0x0000000001035c08
...
- (void)runActionForKey:(id)arg1 object:(id)arg2 arguments:(id)arg3;	// IMP=0x00000000010346ce
- (id)initWithPendingAnimation:(id)arg1 withAnimationObject:(id)arg2 forView:(id)arg3;	// IMP=0x0000000001034605
