...
- (void).cxx_destruct;	// IMP=0x000000000002381f
...
- (id)_newMotionEffectsGroupForHighlightedAction;	// IMP=0x00000000000235f5
- (void)_removeMotionEffects;	// IMP=0x0000000000023500
- (void)_insertMotionEffects;	// IMP=0x00000000000233fb
- (struct CATransform3D)_enlargedTransformForSize:(struct CGSize)arg1 pressed:(_Bool)arg2;	// IMP=0x000000000002332d
- (void)_applyHighlightTransform;	// IMP=0x0000000000022ef8
- (id)initWithHighlightTransformTargetView:(id)arg1;	// IMP=0x0000000000022e5c
