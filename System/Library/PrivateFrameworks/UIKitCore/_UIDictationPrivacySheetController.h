...
- (void).cxx_destruct;	// IMP=0x00000000008e6d04
...
- (void)dismiss;	// IMP=0x00000000008e6bfe
- (id)initWithType:(long long)arg1;	// IMP=0x00000000008e696a
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000008e6962
