...
- (void).cxx_destruct;	// IMP=0x0000000000bf9886
- (void)_receiveHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000000bf8012
- (void)threadMain;	// IMP=0x0000000000bf7eb2
- (void)displayLinkDidFire:(id)arg1;	// IMP=0x0000000000bf7977
- (id)init;	// IMP=0x0000000000bf7418
