...
- (id)nextResponder;	// IMP=0x0000000000010401
- (id)_firstViewAncestor;	// IMP=0x0000000000010383
@property(nonatomic) _Bool areChildrenFocused;
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
- (id)focusItemsInRect:(struct CGRect)arg1;	// IMP=0x00000000000102f3
- (id)_regionForFocusedItem:(id)arg1 inCoordinateSpace:(id)arg2;	// IMP=0x000000000001025e
- (id)_preferredFocusRegionCoordinateSpace;	// IMP=0x0000000000010227
- (void)_searchForFocusRegionsInContext:(id)arg1;	// IMP=0x000000000000fd4c
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) _Bool canBecomeFocused;
- (void)_updateFocusLayerFrame;	// IMP=0x000000000000fc4d
- (void)_destroyFocusLayer;	// IMP=0x000000000000fc31
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000fc2b
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x000000000000fc23
- (void)updateFocusIfNeeded;	// IMP=0x000000000000fbde
- (void)setNeedsFocusUpdate;	// IMP=0x000000000000fb96
...
- (void)dealloc;	// IMP=0x000000000000f7f6
- (id)initWithAccessibilityContainer:(id)arg1;	// IMP=0x000000000000f768
