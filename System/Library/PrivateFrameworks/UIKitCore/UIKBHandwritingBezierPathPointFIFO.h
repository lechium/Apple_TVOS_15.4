...
- (void).cxx_destruct;	// IMP=0x000000000084c45e
...
- (void)clear;	// IMP=0x000000000084c34f
- (void)flush;	// IMP=0x000000000084c145
- (void)addPoint:(struct)arg1;	// IMP=0x000000000084ba43
- (id)initWithFIFO:(id)arg1;	// IMP=0x000000000084b989
