...
- (void).cxx_destruct;	// IMP=0x0000000000c4a0df
...
- (_Bool)mayFitDisplayItems:(id)arg1;	// IMP=0x0000000000c49d13
- (void)_updateConstraints;	// IMP=0x0000000000c496d4
- (void)invalidate;	// IMP=0x0000000000c4954e
