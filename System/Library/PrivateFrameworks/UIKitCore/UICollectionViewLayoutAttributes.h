...
+ (id)layoutAttributesForDecorationViewOfKind:(id)arg1 withIndexPath:(id)arg2;	// IMP=0x000000000033e771
+ (id)layoutAttributesForSupplementaryViewOfKind:(id)arg1 withIndexPath:(id)arg2;	// IMP=0x000000000033e6ed
+ (id)layoutAttributesForCellWithIndexPath:(id)arg1;	// IMP=0x000000000033e69b
- (void).cxx_destruct;	// IMP=0x00000000003405f2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033ff2a
- (_Bool)isSizeEqualForPreferredFittingAttributes:(id)arg1;	// IMP=0x000000000033ff18
@property(readonly, copy) NSString *description;
@property(nonatomic) struct CGAffineTransform transform;
@property(nonatomic) struct CGRect frame;
@property(nonatomic) struct CGRect bounds;
- (id)initialLayoutAttributesForInsertedDecorationElementOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000000033f0db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000033eca0
- (id)_valueForCustomAttribute:(id)arg1;	// IMP=0x000000000033ec87
- (void)_setValue:(id)arg1 forCustomAttribute:(id)arg2;	// IMP=0x000000000033ebfb
...
- (void)_setMaskViewFrame:(struct CGRect)arg1 removeAfterAnimation:(_Bool)arg2;	// IMP=0x000000000033eaee
...
- (long long)_zPosition;	// IMP=0x000000000033e91b
- (void)_setZPosition:(long long)arg1;	// IMP=0x000000000033e911
- (id)init;	// IMP=0x000000000033e82c
