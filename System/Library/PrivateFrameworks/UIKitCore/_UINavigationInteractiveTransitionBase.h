...
- (void).cxx_destruct;	// IMP=0x0000000000501b9a
...
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x000000000050181b
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000050177f
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000005016e1
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000501658
- (void)handleNavigationTransition:(id)arg1;	// IMP=0x00000000005011e5
- (double)_translationCoefficient;	// IMP=0x00000000005011ad
- (void)setNotInteractiveTransition;	// IMP=0x00000000005011a7
- (void)startInteractiveTransition;	// IMP=0x000000000050116b
- (_Bool)popGesture:(id)arg1 withRemainingDuration:(double)arg2 shouldPopWithVelocity:(double *)arg3;	// IMP=0x0000000000500fb0
- (void)_updateStatistics:(id)arg1 firstSample:(_Bool)arg2 finalSample:(_Bool)arg3;	// IMP=0x0000000000500b41
- (_Bool)_gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000500b27
- (void)_completeStoppedInteractiveTransition;	// IMP=0x0000000000500ae6
- (void)_stopInteractiveTransition;	// IMP=0x0000000000500aac
- (void)finishInteractiveTransition;	// IMP=0x0000000000500a69
- (void)cancelInteractiveTransition;	// IMP=0x0000000000500a26
@property(readonly, nonatomic, getter=_navigationGesture) UIGestureRecognizer *navigationGesture;
- (void)_resetInteractionController;	// IMP=0x00000000005009e2
- (void)dealloc;	// IMP=0x0000000000500853
- (id)initWithGestureRecognizerView:(id)arg1 animator:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000005006b8
- (id)gestureRecognizerView;	// IMP=0x000000000050069f
