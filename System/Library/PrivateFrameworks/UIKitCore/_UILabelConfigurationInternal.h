...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000144aab
- (void).cxx_destruct;	// IMP=0x00000000001453f5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000145000
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000144bf7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000144ab3
- (unsigned long long)hash;	// IMP=0x0000000000144a2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014447b
- (id)init;	// IMP=0x000000000014441d
