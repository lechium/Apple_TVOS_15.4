...
- (void).cxx_destruct;	// IMP=0x00000000005df7a7
...
- (void)_searchForFocusRegionsInContext:(id)arg1;	// IMP=0x00000000005df28d
- (id)_regionForFocusedItem:(id)arg1 inCoordinateSpace:(id)arg2;	// IMP=0x00000000005df184
- (id)_preferredFocusRegionCoordinateSpace;	// IMP=0x00000000005df16e
@property(readonly, nonatomic) id <UIFocusItemContainer> focusItemContainer;
@property(readonly, nonatomic) __weak id <UIFocusEnvironment> parentFocusEnvironment;
- (void)updateFocusIfNeeded;	// IMP=0x00000000005df0d3
- (void)setNeedsFocusUpdate;	// IMP=0x00000000005df096
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000005df010
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x00000000005def99
@property(readonly, copy, nonatomic) NSArray *preferredFocusEnvironments;
- (id)_focusEnvironment;	// IMP=0x00000000005def05
- (id)initWithItemContainer:(id)arg1;	// IMP=0x00000000005dee7a
