...
- (void).cxx_destruct;	// IMP=0x0000000000923dd3
...
- (id)debugDescription;	// IMP=0x0000000000923c79
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000092378b
@property(nonatomic) long long emojiFontSize;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009228ed
