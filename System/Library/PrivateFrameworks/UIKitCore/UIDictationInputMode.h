...
+ (_Bool)currentInputModeSupportsDictation;	// IMP=0x00000000007e5f0e
...
- (_Bool)includeBarHeight;	// IMP=0x00000000007e5f27
- (Class)viewControllerClass;	// IMP=0x00000000007e5d3a
- (void)dealloc;	// IMP=0x00000000007e5ce2
