...
- (id)_timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000386f91
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000386f75
- (id)initWithCurve:(unsigned long long)arg1;	// IMP=0x0000000000386f38
