...
- (void).cxx_destruct;	// IMP=0x0000000000577336
@property(retain, setter=_setProgress:) NSProgress *_progress; // @synthesize _progress=__progress;
- (_Bool)_really_cancel;	// IMP=0x00000000005772cf
- (void)_really_loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000577145
- (id)initWithItemProvider:(id)arg1 typeIdentifier:(id)arg2;	// IMP=0x0000000000577061
