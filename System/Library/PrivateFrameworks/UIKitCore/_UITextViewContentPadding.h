...
- (void).cxx_destruct;	// IMP=0x0000000000ebfc88
...
- (void)_checkNewCurrentValue;	// IMP=0x0000000000ebfbb7
- (void)resetCurrentValue;	// IMP=0x0000000000ebfb3d
- (void)increaseToValue:(double)arg1;	// IMP=0x0000000000ebfacb
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000ebfa1f
