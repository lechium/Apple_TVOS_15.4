...
- (void).cxx_destruct;	// IMP=0x000000000051f821
...
- (void)_unzoomAnimationDidFinish;	// IMP=0x000000000051f5c5
- (void)_zoomAnimationDidFinish;	// IMP=0x000000000051f577
- (void)unzoom;	// IMP=0x000000000051f192
- (void)_setOverlayViewIsZoomed:(_Bool)arg1 minValue:(float)arg2 maxValue:(float)arg3;	// IMP=0x000000000051f003
- (_Bool)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x000000000051dc53
- (double)zoomAnimationDuration;	// IMP=0x000000000051dc41
- (void)setZoomAnimationDuration:(double)arg1;	// IMP=0x000000000051dc2b
- (void)layoutSubviews;	// IMP=0x000000000051dbdd
- (void)reloadData;	// IMP=0x000000000051dbc0
- (void)_reallyReloadData;	// IMP=0x000000000051d361
- (void)clear;	// IMP=0x000000000051d27b
- (id)_createImageViewForTimestamp:(id)arg1 isSummaryThumbnail:(_Bool)arg2;	// IMP=0x000000000051d095
- (void)setThumbnailImage:(struct CGImage *)arg1 forTimestamp:(id)arg2;	// IMP=0x000000000051ca33
- (void)setEndValue:(double)arg1;	// IMP=0x000000000051c9b9
- (void)setStartValue:(double)arg1;	// IMP=0x000000000051c93f
- (void)animateFillFramesAway;	// IMP=0x000000000051c916
- (void)setEditing:(_Bool)arg1;	// IMP=0x000000000051c881
- (void)setValue:(double)arg1;	// IMP=0x000000000051c833
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000051c425
