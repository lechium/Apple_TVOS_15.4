...
- (void).cxx_destruct;	// IMP=0x0000000000f90f31
...
- (_Bool)isStable;	// IMP=0x0000000000f90d4a
@property(retain, nonatomic) id <UIVectorOperatable> velocity;
- (id)stepWithDelta:(double)arg1;	// IMP=0x0000000000f90abf
- (id)initWithCurrent:(id)arg1 targetValue:(id)arg2;	// IMP=0x0000000000f90a16
- (void)updateWithDescription:(id)arg1 initial:(_Bool)arg2;	// IMP=0x0000000000f90485
- (void)updateWithDescription:(id)arg1;	// IMP=0x0000000000f90471
- (id)initWithDescription:(id)arg1 current:(id)arg2 targetValue:(id)arg3;	// IMP=0x0000000000f9025a
