...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000067f1d2
- (void).cxx_destruct;	// IMP=0x000000000067f7b2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000067f3e8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000067f1da
