...
+ (id)old2xLetterpressStyle;	// IMP=0x00000000007349ac
+ (id)defaultLetterpressStyle;	// IMP=0x0000000000734764
- (void).cxx_destruct;	// IMP=0x00000000007355c0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000734cb4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000734bf8
