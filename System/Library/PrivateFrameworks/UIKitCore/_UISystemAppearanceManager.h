...
- (void).cxx_destruct;	// IMP=0x0000000000237c03
...
- (void)_updateSupportedInterfaceOrientations;	// IMP=0x00000000002376e3
- (void)updateSupportedInterfaceOrientations;	// IMP=0x0000000000237545
- (void)updateMultitaskingDragExclusionRects;	// IMP=0x00000000002370d5
- (void)updateWhitePointAdaptivityStyle;	// IMP=0x0000000000236fa8
- (void)updateUserInterfaceStyle;	// IMP=0x0000000000236ee7
- (void)updateScreenEdgesDeferringSystemGestures;	// IMP=0x0000000000236ee1
- (void)updateHomeIndicatorAutoHidden;	// IMP=0x0000000000236edb
@property(nonatomic, getter=_scene, setter=_setScene:) __weak UIScene *_scene;
- (id)initWithScene:(id)arg1;	// IMP=0x0000000000236d9a
