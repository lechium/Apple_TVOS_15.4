...
- (void).cxx_destruct;	// IMP=0x000000000050666d
...
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000505d40
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000505d2e
- (void)dealloc;	// IMP=0x0000000000505cee
