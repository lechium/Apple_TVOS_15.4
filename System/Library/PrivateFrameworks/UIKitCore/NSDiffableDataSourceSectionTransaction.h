...
- (void).cxx_destruct;	// IMP=0x0000000000a9b882
...
- (id)_spiCopy;	// IMP=0x0000000000a9b778
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a9b559
- (id)description;	// IMP=0x0000000000a9b4d0
- (id)initWithSectionIdentifier:(id)arg1 initialSnapshot:(id)arg2 finalSnapshot:(id)arg3 difference:(id)arg4;	// IMP=0x0000000000a9b3ee
