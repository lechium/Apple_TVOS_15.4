...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x0000000000a54224
- (void).cxx_destruct;	// IMP=0x0000000000a5504a
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000a54ebe
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000a54ea9
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000a54e36
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000a5431c
- (id)controlImageByType:(long long)arg1;	// IMP=0x0000000000a54134
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000a540b3
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000a53d3f
- (void)updateUndoControlStyle;	// IMP=0x0000000000a53997
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000a53991
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000a535e7
