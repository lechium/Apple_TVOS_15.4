...
- (void).cxx_destruct;	// IMP=0x0000000000414acc
...
- (_Bool)isCompatibleWithCurlOfType:(long long)arg1 inDirection:(long long)arg2;	// IMP=0x0000000000414996
- (long long)_effectiveTransitionDirection;	// IMP=0x0000000000414964
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000004148d7
- (void)cleanup;	// IMP=0x00000000004148af
- (void)cleanupWithFinishedState:(_Bool)arg1 completedState:(_Bool)arg2;	// IMP=0x0000000000414839
- (void)finally;	// IMP=0x0000000000414806
- (void)incrementCompletionCount;	// IMP=0x00000000004147f5
@property(readonly, nonatomic, getter=hasPendingAnimations) _Bool pendingAnimations;
- (void)setCurlState:(long long)arg1 willComplete:(_Bool)arg2;	// IMP=0x0000000000414700
- (void)addBackPageContent;	// IMP=0x000000000041464f
- (void)addFrontPageContent;	// IMP=0x000000000041459e
@property(readonly, nonatomic) UIView *backPageView;
@property(readonly, nonatomic) UIView *frontPageView;
- (struct CGRect)_pageViewFrame;	// IMP=0x0000000000413f5e
- (void)invalidatePageCurl;	// IMP=0x0000000000413f3d
- (void)dealloc;	// IMP=0x0000000000413eff
- (id)initWithPageCurl:(id)arg1 andCurlType:(long long)arg2 fromLocation:(struct CGPoint)arg3 withReferenceLocation:(struct CGPoint)arg4 inDirection:(long long)arg5 withView:(id)arg6 revealingView:(id)arg7 completion:(CDUnknownBlockType)arg8 finally:(CDUnknownBlockType)arg9;	// IMP=0x0000000000413d50
