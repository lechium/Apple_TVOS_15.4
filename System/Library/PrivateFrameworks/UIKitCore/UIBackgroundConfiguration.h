...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ad8c5
+ (id)listAccompaniedSidebarCellConfiguration;	// IMP=0x00000000000ad123
+ (id)listSidebarCellConfiguration;	// IMP=0x00000000000acef6
+ (id)listSidebarHeaderConfiguration;	// IMP=0x00000000000accbb
+ (id)_listInsetGroupedHeaderFooterConfiguration;	// IMP=0x00000000000acc13
+ (id)_listInsetGroupedCellConfiguration;	// IMP=0x00000000000acb2d
+ (id)listGroupedHeaderFooterConfiguration;	// IMP=0x00000000000aca9c
+ (id)listGroupedCellConfiguration;	// IMP=0x00000000000ac881
+ (id)listPlainHeaderFooterConfiguration;	// IMP=0x00000000000ac656
+ (id)listPlainCellConfiguration;	// IMP=0x00000000000ac1a2
+ (id)clearConfiguration;	// IMP=0x00000000000ac0c4
- (void).cxx_destruct;	// IMP=0x00000000000b0190
...
- (_Bool)_isEqualToInternalConfigurationQuick:(id)arg1;	// IMP=0x00000000000afedd
- (id)_updatedConfigurationForState:(id)arg1;	// IMP=0x00000000000afecb
- (id)resolvedStrokeColorForTintColor:(id)arg1;	// IMP=0x00000000000afe53
@property(readonly, nonatomic) _Bool isTintBackgroundColor;
- (id)resolvedBackgroundColorForTintColor:(id)arg1;	// IMP=0x00000000000afdcd
...
- (_Bool)_backgroundFillIsEqual:(id)arg1 withTintColor:(id)arg2;	// IMP=0x00000000000af808
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ae86b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ae705
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ae0d7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ad8cd
- (id)updatedConfigurationForState:(id)arg1;	// IMP=0x00000000000ad1a2
