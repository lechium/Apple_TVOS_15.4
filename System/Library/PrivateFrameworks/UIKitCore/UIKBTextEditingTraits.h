...
+ (id)traitsForEditingInteractionWithFirstResponder:(id)arg1 canRespondBlock:(CDUnknownBlockType)arg2 keyMaskFlags:(unsigned long long)arg3;	// IMP=0x00000000009b0e76
+ (id)traitsWithResponder:(id)arg1 keyMaskFlags:(unsigned long long)arg2;	// IMP=0x00000000009b0da6
- (void).cxx_destruct;	// IMP=0x00000000009b0f87
...
- (id)initWithResponder:(id)arg1 canRespondBlock:(CDUnknownBlockType)arg2 keyMaskFlags:(unsigned long long)arg3 sender:(id)arg4;	// IMP=0x00000000009b09f3
