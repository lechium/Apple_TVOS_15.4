...
- (void).cxx_destruct;	// IMP=0x00000000009c162b
...
- (void)_updateBackgroundAndTitleColor;	// IMP=0x00000000009c140d
- (id)_titleColorForState:(unsigned long long)arg1;	// IMP=0x00000000009c13fb
- (id)_currentTitleColor;	// IMP=0x00000000009c13af
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000009c136e
