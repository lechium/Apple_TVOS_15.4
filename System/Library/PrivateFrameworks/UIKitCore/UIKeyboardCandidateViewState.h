...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x00000000007c74ce
- (void).cxx_destruct;	// IMP=0x00000000007c76f2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007c7336
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007c7257
