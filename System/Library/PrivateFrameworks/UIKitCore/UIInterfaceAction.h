...
+ (id)_observableDisplayProperties;	// IMP=0x0000000000023f1f
+ (void)_setInterfaceActionCanInvokeActionsWithoutPresentingController:(_Bool)arg1;	// IMP=0x0000000000023f13
+ (id)actionWithCustomContentView:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000023ad2
+ (id)actionWithCustomContentViewController:(id)arg1;	// IMP=0x0000000000023a6a
+ (id)actionWithTitle:(id)arg1 type:(long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000239e6
+ (_Bool)changedProperties:(id)arg1 containsAny:(id)arg2;	// IMP=0x0000000000023845
...
- (void)_notifyObserversDidChangeActionProperty:(id)arg1;	// IMP=0x00000000000247fc
- (void)_notifyObserversVisualStyleDidChange;	// IMP=0x000000000002468d
@property(readonly, nonatomic) long long _typeForDeterminingViewRepresentation;
- (void)_removeActionDisplayPropertyObserver:(id)arg1;	// IMP=0x00000000000245c4
- (void)_addActionDisplayPropertyObserver:(id)arg1;	// IMP=0x0000000000024564
- (void)_invokeHandlerWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024476
...
- (struct CGSize)_layoutSizeForImageProperty:(id)arg1;	// IMP=0x0000000000024295
...
- (id)description;	// IMP=0x0000000000023ce1
- (id)initWithTitle:(id)arg1 type:(long long)arg2 customContentViewController:(id)arg3 customContentView:(id)arg4 handler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000023b58
