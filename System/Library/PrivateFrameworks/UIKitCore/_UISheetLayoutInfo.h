...
@interface _UISheetLayoutInfo : NSObject <_UIViewBoundingPathChangeObserver, _UISheetPresentationControllerDetentResolutionContext>
{
    ...
    long long __reversedIndexOfCurrentDetentForTappingGrabber;	// 176 = 0xb0
    ...
    long long __reversedIndexOfLastUndimmedDetent;	// 216 = 0xd8
    ...
    double __percentDimmedFromOffset;	// 256 = 0x100
    double __percentDimmed;	// 264 = 0x108
    double __confinedPercentDimmed;	// 272 = 0x110
    double __shadowOpacity;	// 280 = 0x118
    double __alpha;	// 288 = 0x120
    double __grabberAlpha;	// 296 = 0x128
    double __magicShadowOpacity;	// 304 = 0x130
    UIViewController *__presentingViewController;	// 312 = 0x138
    UIViewController *__presentedViewController;	// 320 = 0x140
    UIView *__containerView;	// 328 = 0x148
    UITraitCollection *__containerTraitCollection;	// 336 = 0x150
    double __additionalMinimumTopInset;	// 344 = 0x158
    long long __mode;	// 352 = 0x160
    long long __horizontalAlignment;	// 360 = 0x168
    double __marginInCompactHeight;	// 368 = 0x170
    double __marginInRegularWidthRegularHeight;	// 376 = 0x178
    NSString *__selectedDetentIdentifier;	// 384 = 0x180
    NSString *__largestUndimmedDetentIdentifier;	// 392 = 0x188
    NSString *__largestUndimmedDetentIdentifierWhenEdgeAttachedInCompactHeight;	// 400 = 0x190
    NSString *__largestUndimmedDetentIdentifierWhenFloating;	// 408 = 0x198
    NSString *__sheetID;	// 416 = 0x1a0
    NSString *__hiddenAncestorSheetID;	// 424 = 0x1a8
    double __latestUserChosenOffset;	// 432 = 0x1b0
    double __tearOffset;	// 440 = 0x1b8
    double __grabberSpacing;	// 448 = 0x1c0
    double __dismissCornerRadius;	// 456 = 0x1c8
    double __preferredCornerRadius;	// 464 = 0x1d0
    CDUnknownBlockType __currentOffsetGetter;	// 472 = 0x1d8
    _UISheetLayoutInfo *__parentLayoutInfo;	// 480 = 0x1e0
    _UISheetLayoutInfo *__childLayoutInfo;	// 488 = 0x1e8
    NSArray *__reversedDetents;	// 496 = 0x1f0
    CDUnknownBlockType __indexOfCurrentActiveOrDismissDetentWasInvalidated;	// 504 = 0x1f8
    CDUnknownBlockType __rubberBandExtentBeyondMinimumOffsetWasInvalidated;	// 512 = 0x200
    CDUnknownBlockType __rubberBandExtentBeyondMaximumOffsetWasInvalidated;	// 520 = 0x208
    double __confinedPercentLightened;	// 528 = 0x210
    id <_UISheetLayoutInfoDelegate> __delegate;	// 536 = 0x218
    NSMutableArray *__mutableDetentValues;	// 544 = 0x220
    NSMutableArray *__mutableActiveDetentValues;	// 552 = 0x228
    NSMutableArray *__mutableActiveReversedDetentIndexes;	// 560 = 0x230
    struct CGSize __preferredSize;	// 568 = 0x238
    struct CGPoint __rawCurrentOffset;	// 584 = 0x248
    struct CGPoint __currentOffset;	// 600 = 0x258
    struct UIEdgeInsets __unsafeInsets;	// 616 = 0x268
    struct UIEdgeInsets __marginsWhenFloating;	// 648 = 0x288
    struct UIEdgeInsets __margins;	// 680 = 0x2a8
    struct CGRect __effectiveKeyboardFrame;	// 712 = 0x2c8
    struct CGRect __stackAlignmentFrame;	// 744 = 0x2e8
    struct CGRect __fullHeightUntransformedFrame;	// 776 = 0x308
    struct CGRect __fullHeightUntransformedFrameForDepthLevel;	// 808 = 0x328
    struct CGRect __untransformedFrame;	// 840 = 0x348
    struct CGRect __hostedUntransformedFrame;	// 872 = 0x368
    struct CGRect __frameOfPresentedViewInContainerView;	// 904 = 0x388
    struct UIEdgeInsets __touchInsets;	// 936 = 0x3a8
    struct UIRectCornerRadii __cornerRadii;	// 968 = 0x3c8
    struct CGRect __containerBounds;	// 1000 = 0x3e8
    struct UIEdgeInsets __containerSafeAreaInsets;	// 1032 = 0x408
    struct CGRect __sourceFrame;	// 1064 = 0x428
    struct CGRect __keyboardFrame;	// 1096 = 0x448
    struct CGRect __remoteKeyboardFrame;	// 1128 = 0x468
    struct CGRect __dismissSourceFrame;	// 1160 = 0x488
    struct CGAffineTransform __transform;	// 1192 = 0x4a8
}

- (void).cxx_destruct;	// IMP=0x00000000003aba84
...
- (id)_descendantDescription;	// IMP=0x00000000003ab4b2
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x00000000003aa217
...
- (void)_invalidateCurrentOffset;	// IMP=0x00000000003a3e75
- (void)_invalidateDetents;	// IMP=0x00000000003a3395
@property(retain, nonatomic, setter=_setDetents:) NSArray *_detents;
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x00000000003a2a3c
- (void)_invalidatePreferredSize;	// IMP=0x00000000003a29e9
- (id)init;	// IMP=0x00000000003a270e
