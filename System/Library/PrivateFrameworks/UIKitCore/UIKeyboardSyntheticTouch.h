...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x00000000008ad6e0
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x00000000008ad895
- (struct CGPoint)getLocationInWindow;	// IMP=0x00000000008ad875
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x00000000008ad82e
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x00000000008ad7e7
- (void)dealloc;	// IMP=0x00000000008ad7ac
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x00000000008ad737
