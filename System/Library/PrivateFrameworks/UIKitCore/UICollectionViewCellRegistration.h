...
+ (id)registrationWithCellNib:(id)arg1 configurationHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006d9431
+ (id)registrationWithCellClass:(Class)arg1 configurationHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006d9377
- (void).cxx_destruct;	// IMP=0x00000000006d955c
...
- (id)initWithCellClass:(Class)arg1 cellNib:(id)arg2 configurationHandler:(CDUnknownBlockType)arg3 reuseIdentifier:(id)arg4;	// IMP=0x00000000006d91fd
