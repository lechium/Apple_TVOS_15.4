...
- (void).cxx_destruct;	// IMP=0x000000000014dd3e
...
- (id)_traitCollectionOverridesForNavigationBarTraitCollection:(id)arg1;	// IMP=0x000000000014d9ff
- (void)navigationBarTraitCollectionDidChangeTo:(id)arg1 from:(id)arg2;	// IMP=0x000000000014d9f9
- (void)_navigationBarTraitCollectionDidChangeTo:(id)arg1 from:(id)arg2;	// IMP=0x000000000014d9e7
- (void)transitionCompleted:(long long)arg1 willBeDisplayed:(_Bool)arg2;	// IMP=0x000000000014d9cd
- (void)_navigationBarTransitionCompleted:(long long)arg1 willBeDisplayed:(_Bool)arg2;	// IMP=0x000000000014d9bb
- (void)performTransition:(long long)arg1 willBeDisplayed:(_Bool)arg2;	// IMP=0x000000000014d998
- (void)_performNavigationBarTransition:(long long)arg1 willBeDisplayed:(_Bool)arg2;	// IMP=0x000000000014d986
- (void)transitionWillBegin:(long long)arg1 willBeDisplayed:(_Bool)arg2;	// IMP=0x000000000014d965
- (void)_navigationBarTransitionWillBegin:(long long)arg1 willBeDisplayed:(_Bool)arg2;	// IMP=0x000000000014d953
- (void)contentDidChange;	// IMP=0x000000000014d94d
- (void)_contentDidChange;	// IMP=0x000000000014d93b
- (_Bool)_wantsTwoPartTransition;	// IMP=0x000000000014d933
- (void)preferredContentSizeDidChange;	// IMP=0x000000000014d8e5
- (long long)preferredContentSizeForSize:(long long)arg1;	// IMP=0x000000000014d8dc
- (long long)_preferredContentSizeForSize:(long long)arg1;	// IMP=0x000000000014d8ca
...
- (void)_setDataSource:(id)arg1 navigationItem:(id)arg2 titleLocation:(long long)arg3;	// IMP=0x000000000014cef6
- (void)setTranslatesAutoresizingMaskIntoConstraints:(_Bool)arg1;	// IMP=0x000000000014ce52
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014cdce
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000014cd39
