...
- (void).cxx_destruct;	// IMP=0x00000000006d9142
...
- (void)clearTimer;	// IMP=0x00000000006d9050
- (void)startTimer;	// IMP=0x00000000006d8d1c
- (void)secondDelayElapsed:(id)arg1;	// IMP=0x00000000006d8cc1
- (void)setState:(long long)arg1;	// IMP=0x00000000006d8c15
- (void)_resetGestureRecognizer;	// IMP=0x00000000006d8bc8
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000006d8b77
