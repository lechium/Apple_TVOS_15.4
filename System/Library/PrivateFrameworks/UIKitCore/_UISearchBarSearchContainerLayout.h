...
- (void).cxx_destruct;	// IMP=0x00000000001be819
...
- (void)sendWillLayoutSubviewsForSearchFieldContainerView:(id)arg1;	// IMP=0x00000000001be5f5
- (void)applyLayout;	// IMP=0x00000000001be334
- (void)updateLayout;	// IMP=0x00000000001bd8b7
- (double)searchFieldHeightUpdatingShrinkageAndFadeAlphas;	// IMP=0x00000000001bd7ad
@property(readonly, nonatomic) double naturalSearchFieldHeight;
@property(readonly, nonatomic) double naturalBarHeight;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bd3f3
