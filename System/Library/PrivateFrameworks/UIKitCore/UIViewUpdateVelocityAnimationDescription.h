...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x0000000000f93614
- (void).cxx_destruct;	// IMP=0x0000000000f936b6
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x0000000000f9357b
