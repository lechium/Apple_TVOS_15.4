...
- (void).cxx_destruct;	// IMP=0x00000000005a8c1c
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x00000000005a8b2f
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x00000000005a8a6b
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000005a84f4
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x00000000005a8359
- (id)init;	// IMP=0x00000000005a82ee
