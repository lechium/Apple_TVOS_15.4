...
+ (long long)automaticValueOptionsForRepresentedElementCategory:(unsigned long long)arg1;	// IMP=0x00000000002d22a2
+ (void)applyValuesFromAttributes:(id)arg1 toAttributes:(id)arg2 valueOptions:(long long)arg3;	// IMP=0x00000000002d1e59
- (void).cxx_destruct;	// IMP=0x00000000002d2679
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d1b16
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d1abb
