...
- (_Bool)isUISubclass;	// IMP=0x0000000000672706
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofSetting:(unsigned long long)arg3;	// IMP=0x00000000006726f3
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x00000000006726e6
- (_Bool)settings:(id)arg1 appendDescriptionToBuilder:(id)arg2 forFlag:(long long)arg3 object:(id)arg4 ofSetting:(unsigned long long)arg5;	// IMP=0x00000000006726d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006726a4
