...
+ (id)groupWithTitle:(id)arg1 image:(id)arg2 style:(long long)arg3 children:(id)arg4;	// IMP=0x00000000000b5b7d
- (void).cxx_destruct;	// IMP=0x00000000000b5f10
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b5d1f
- (id)_initWithTitle:(id)arg1 image:(id)arg2 style:(long long)arg3 children:(id)arg4;	// IMP=0x00000000000b5c16
- (id)_apiRepresentation;	// IMP=0x00000000004ea5ff
