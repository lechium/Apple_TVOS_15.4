...
- (void).cxx_destruct;	// IMP=0x00000000000caa1e
...
- (void)computeOutputSettingsUsingModel:(id)arg1;	// IMP=0x00000000000ca34c
- (_Bool)isBackdropVisible;	// IMP=0x00000000000ca344
- (_Bool)requiresBackdropLayer;	// IMP=0x00000000000ca33c
- (void)setRequiresColorStatistics:(_Bool)arg1;	// IMP=0x00000000000ca30b
- (void)copyAdditionalSettingsFromSettings:(id)arg1;	// IMP=0x00000000000ca169
- (void)setDefaultValues;	// IMP=0x00000000000ca134
