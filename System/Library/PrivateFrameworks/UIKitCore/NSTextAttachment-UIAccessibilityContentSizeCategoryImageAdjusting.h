...
+ (id)textAttachmentWithImage:(id)arg1;	// IMP=0x0000000000750f46
+ (id)_imageFromAttachment:(id)arg1;	// IMP=0x0000000000dd2a3a
+ (_Bool)_attachmentHasImage:(id)arg1;	// IMP=0x0000000000dd28d3
