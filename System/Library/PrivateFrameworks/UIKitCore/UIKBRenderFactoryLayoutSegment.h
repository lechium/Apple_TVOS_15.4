...
+ (id)segmentWithTraits:(id)arg1;	// IMP=0x0000000000865956
...
- (_Bool)containsPoint:(struct CGPoint)arg1 inRect:(struct CGRect)arg2 withKeyplane:(id)arg3;	// IMP=0x0000000000865bb2
- (void)addRelativeLayoutRectFromEdge:(unsigned long long)arg1 ofCachedKey:(id)arg2;	// IMP=0x0000000000865b00
- (void)addLayoutRect:(struct CGRect)arg1 asTriangle:(unsigned long long)arg2;	// IMP=0x0000000000865a56
- (void)dealloc;	// IMP=0x00000000008659e3
- (id)initWithTraits:(id)arg1;	// IMP=0x0000000000865985
