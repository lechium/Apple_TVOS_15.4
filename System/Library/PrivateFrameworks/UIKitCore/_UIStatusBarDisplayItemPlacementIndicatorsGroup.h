...
+ (id)groupWithHighPriority:(long long)arg1 lowPriority:(long long)arg2 bluetoothPaddingInset:(double)arg3;	// IMP=0x0000000000c438fa
+ (id)activityItemDisplayIdentifier;	// IMP=0x0000000000c438e1
- (void).cxx_destruct;	// IMP=0x0000000000c440aa
