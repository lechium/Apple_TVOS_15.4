...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x00000000004fbd05
- (void).cxx_destruct;	// IMP=0x00000000004fc065
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000004fbd77
- (id)initWithLayer:(id)arg1;	// IMP=0x00000000004fbb35
- (id)init;	// IMP=0x00000000004fb9fb
