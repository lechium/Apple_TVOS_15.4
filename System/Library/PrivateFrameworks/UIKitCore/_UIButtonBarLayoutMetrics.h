...
- (void).cxx_destruct;	// IMP=0x000000000010cf4a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010cd9f
- (id)_upcastIfReadOnly;	// IMP=0x000000000010cd19
- (id)_copyWithModifications:(CDUnknownBlockType)arg1;	// IMP=0x000000000010cc1c
