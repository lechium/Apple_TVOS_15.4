...
+ (id)defaultConfigurationForStyle:(unsigned long long)arg1;	// IMP=0x00000000000162b8
+ (id)defaultConfiguration;	// IMP=0x00000000000162a1
- (void).cxx_destruct;	// IMP=0x00000000000165cc
...
- (_Bool)__gaxTrampoline_defaultBoolValueForFeatureKey:(id)arg1;	// IMP=0x000000000001656e
- (void)_setBoolValue:(_Bool)arg1 forFeatureKey:(id)arg2;	// IMP=0x00000000000164c4
- (_Bool)_boolValueForFeatureKey:(id)arg1;	// IMP=0x000000000001642a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000162e9
