...
- (void).cxx_destruct;	// IMP=0x00000000001bc54e
...
- (void)setLayoutCustomizationDelegateSearchFieldContainerWillLayoutSubviewsCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000001bc247
- (void)setDelegateSearchFieldFrameManipulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001bc1ed
- (void)cleanUpLayout;	// IMP=0x00000000001bb7d8
- (void)applyScopeContainerSublayout;	// IMP=0x00000000001bb776
- (void)applyLayout;	// IMP=0x00000000001bae84
- (void)ensureCorrectContainerViewOrdering;	// IMP=0x00000000001badee
- (double)minimumLayoutWidth;	// IMP=0x00000000001badb6
- (void)updateLayout;	// IMP=0x00000000001baa02
- (double)layout:(id)arg1 fontScaledValueForValue:(double)arg2;	// IMP=0x00000000001ba94f
- (void)containerLayoutWillUpdateLayout:(id)arg1;	// IMP=0x00000000001ba8e6
- (void)prepareSublayouts;	// IMP=0x00000000001ba8b8
- (void)prepareScopeContainerLayout;	// IMP=0x00000000001ba7a1
- (void)prepareSearchContainerLayout;	// IMP=0x00000000001ba5c3
- (void)prepareBaseConfigurationForSublayout:(id)arg1;	// IMP=0x00000000001ba537
- (void)setUpSearchContainerLayout;	// IMP=0x00000000001ba4b8
- (void)setUpScopeContainerLayout;	// IMP=0x00000000001ba439
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b980e
