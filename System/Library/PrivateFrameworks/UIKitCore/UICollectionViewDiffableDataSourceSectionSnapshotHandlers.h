...
- (void).cxx_destruct;	// IMP=0x0000000000605236
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000605041
- (id)initWithShouldExpandItemHandler:(CDUnknownBlockType)arg1 willExpandItemHandler:(CDUnknownBlockType)arg2 shouldCollapseItemHandler:(CDUnknownBlockType)arg3 willCollapseItemHandler:(CDUnknownBlockType)arg4 snapshotForExpandingParentItemHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000604f1e
