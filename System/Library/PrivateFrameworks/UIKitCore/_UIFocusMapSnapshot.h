...
- (void).cxx_destruct;	// IMP=0x00000000005fa66a
...
- (void)addRegionsInContainers:(id)arg1;	// IMP=0x00000000005fa417
- (void)addRegionsInContainer:(id)arg1;	// IMP=0x00000000005f97d7
- (void)addRegions:(id)arg1;	// IMP=0x00000000005f9611
- (void)addRegion:(id)arg1;	// IMP=0x00000000005f9087
- (id)searchArea;	// IMP=0x00000000005f9075
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
@property(readonly, nonatomic) __weak UIScreen *screen;
- (void)_capture;	// IMP=0x00000000005f8b17
- (struct CGRect)snapshotFrameForRegion:(id)arg1;	// IMP=0x00000000005f89d6
- (id)_cachedNextFocusedItemForRegion:(id)arg1 withFocusMovementRequest:(id)arg2 inMap:(id)arg3;	// IMP=0x00000000005f87ab
- (void)consumeRegionInformationForRegions:(id)arg1 fromSnapshot:(id)arg2;	// IMP=0x00000000005f8598
- (id)occludingRegionsForRegion:(id)arg1;	// IMP=0x00000000005f8480
- (void)_trackOccludingRegion:(id)arg1 forRegion:(id)arg2;	// IMP=0x00000000005f83ba
- (id)originalRegionForRegion:(id)arg1;	// IMP=0x00000000005f8287
- (void)_trackSubregion:(id)arg1 forRegion:(id)arg2;	// IMP=0x00000000005f80ce
- (id)regionsForOriginalRegion:(id)arg1;	// IMP=0x00000000005f7e4e
@property(readonly, copy, nonatomic) NSArray *originalRegions;
@property(readonly, copy, nonatomic) NSArray *regions;
- (void)dealloc;	// IMP=0x00000000005f78a0
- (id)_initWithSnapshotter:(id)arg1 mapArea:(id)arg2 searchArea:(id)arg3;	// IMP=0x00000000005f74bb
- (id)init;	// IMP=0x00000000005f7434
- (id)_debugInfoWithFocusMapSearchInfo:(id)arg1;	// IMP=0x00000000005cb64a
@property(readonly, nonatomic, getter=_debugInfo) _UIFocusMapSnapshotDebugInfo *debugInfo;
- (id)debugQuickLookObject;	// IMP=0x00000000005cb585
