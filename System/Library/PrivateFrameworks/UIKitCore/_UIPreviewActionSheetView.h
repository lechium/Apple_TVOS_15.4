...
- (void).cxx_destruct;	// IMP=0x0000000000a96575
...
- (void)_performActionForPreviewAction:(id)arg1 interfaceAction:(id)arg2;	// IMP=0x0000000000a963aa
- (void)_setupViewHierarchy;	// IMP=0x0000000000a958aa
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a9587b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000a95833
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 items:(id)arg3 contentInsets:(struct UIEdgeInsets)arg4;	// IMP=0x0000000000a95751
