...
- (void).cxx_destruct;	// IMP=0x0000000000a87496
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a8733c
- (id)initWithDidEndHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a87248
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a87181
