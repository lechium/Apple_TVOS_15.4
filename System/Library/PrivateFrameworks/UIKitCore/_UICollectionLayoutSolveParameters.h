...
- (void).cxx_destruct;	// IMP=0x000000000027ffe9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000027ff37
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000027fd84
- (id)init;	// IMP=0x000000000027f80d
