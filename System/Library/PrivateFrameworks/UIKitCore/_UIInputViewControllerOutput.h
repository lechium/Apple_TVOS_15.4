...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000080e036
...
- (id)description;	// IMP=0x000000000080ebf2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000080e8a4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000080e658
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000080e3dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000080e2fb
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x000000000080e2d8
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x000000000080e229
- (void)deleteBackward;	// IMP=0x000000000080e1b4
- (void)insertText:(id)arg1;	// IMP=0x000000000080e183
- (id)_currentKeyboardOutput;	// IMP=0x000000000080e11c
- (void)_pushNewKeyboardOutput;	// IMP=0x000000000080e08f
- (void)dealloc;	// IMP=0x000000000080e03e
