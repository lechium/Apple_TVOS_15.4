...
- (void).cxx_destruct;	// IMP=0x0000000000f9d7ab
...
- (void)performWithoutLock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9d745
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9d69e
- (void)setCompletionCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f9d679
- (void)performCompletionCallbackFinished:(_Bool)arg1;	// IMP=0x0000000000f9d628
@property(nonatomic) _Bool invalidated;
- (id)initWithAnimation:(id)arg1 completion:(CDUnknownBlockType)arg2 composer:(id)arg3;	// IMP=0x0000000000f9d525
