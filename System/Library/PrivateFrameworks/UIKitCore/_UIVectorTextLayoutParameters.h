...
+ (id)parametersSuitableForView:(id)arg1;	// IMP=0x0000000000fcb4c1
- (void).cxx_destruct;	// IMP=0x0000000000fcb8ca
...
- (_Bool)isEqualToParameters:(id)arg1;	// IMP=0x0000000000fcb716
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000fcb6e7
- (void)_copyFromParameters:(id)arg1;	// IMP=0x0000000000fcb5f0
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000fcb588
