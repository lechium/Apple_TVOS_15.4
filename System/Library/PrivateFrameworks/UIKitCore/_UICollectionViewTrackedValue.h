...
- (void).cxx_destruct;	// IMP=0x00000000003507e3
...
- (double)speed;	// IMP=0x00000000003506a7
- (void)addValue:(double)arg1;	// IMP=0x00000000003505e3
- (id)init;	// IMP=0x0000000000350486
