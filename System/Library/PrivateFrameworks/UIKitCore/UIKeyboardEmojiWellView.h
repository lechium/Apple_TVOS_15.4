...
- (void).cxx_destruct;	// IMP=0x00000000009375a4
...
- (void)layoutSubviews;	// IMP=0x0000000000936fca
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000936f95
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x000000000093641c
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x00000000009362ec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000935e07
