...
- (void).cxx_destruct;	// IMP=0x00000000007d6017
...
- (void)dealloc;	// IMP=0x00000000007d5f76
@property(readonly, copy) NSString *description;
- (id)_initWithType:(unsigned long long)arg1 initialState:(_Bool)arg2 reason:(id)arg3;	// IMP=0x00000000007d5e70
