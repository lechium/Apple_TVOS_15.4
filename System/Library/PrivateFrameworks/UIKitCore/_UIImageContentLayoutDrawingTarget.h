...
- (id)_symbolConfigurationForSource:(id)arg1;	// IMP=0x00000000007ce7f6
- (long long)_effectiveRenderingModeForSource:(id)arg1 symbolConfiguration:(id)arg2;	// IMP=0x00000000007ce7de
- (id)_renditionForSource:(id)arg1 size:(struct CGSize)arg2 symbolConfiguration:(id)arg3 withCGImageProvider:(CDUnknownBlockType)arg4 lazy:(_Bool)arg5;	// IMP=0x00000000007ce5f7
- (id)_effectForRenderingSource:(id)arg1;	// IMP=0x00000000007ce5ee
