...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x0000000000ba2807
- (void).cxx_destruct;	// IMP=0x0000000000ba2c5e
...
- (id)description;	// IMP=0x0000000000ba2a42
- (void)dealloc;	// IMP=0x0000000000ba299b
