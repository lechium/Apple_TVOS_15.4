...
- (void).cxx_destruct;	// IMP=0x0000000000a5a1f6
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000a5a0f0
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000a59f59
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000a58a83
