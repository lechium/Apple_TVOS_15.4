...
- (void).cxx_destruct;	// IMP=0x0000000000aa2fab
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000aa2dfa
- (void)stopAnimation;	// IMP=0x0000000000aa2d91
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000aa2c18
- (id)init;	// IMP=0x0000000000aa2c0a
