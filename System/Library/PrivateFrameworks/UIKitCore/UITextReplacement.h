...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x0000000000e388c9
- (void).cxx_destruct;	// IMP=0x0000000000e38bc5
...
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x0000000000e38996
