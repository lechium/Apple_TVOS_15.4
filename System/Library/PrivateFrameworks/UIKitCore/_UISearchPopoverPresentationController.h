...
- (void).cxx_destruct;	// IMP=0x0000000000bb7889
...
- (void)setContentVisible:(_Bool)arg1;	// IMP=0x0000000000bb77a9
...
- (_Bool)_forcePresentationInPresenterScene;	// IMP=0x0000000000bb7732
- (id)_presentationControllerForTraitCollection:(id)arg1;	// IMP=0x0000000000bb7674
- (id)_presentedViewControllerForSizeClassPair:(CDStruct_912cb5d2)arg1;	// IMP=0x0000000000bb7662
- (long long)adaptivePresentationStyle;	// IMP=0x0000000000bb7657
- (void)_transitionFromDidEnd;	// IMP=0x0000000000bb7640
- (void)_transitionFromWillBegin;	// IMP=0x0000000000bb762e
- (void)_transitionToDidEnd;	// IMP=0x0000000000bb7617
- (void)_transitionToWillBegin;	// IMP=0x0000000000bb75dc
- (void)presentationTransitionWillBegin;	// IMP=0x0000000000bb755e
- (id)_popoverHostingWindow;	// IMP=0x0000000000bb7444
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x0000000000bb730d
