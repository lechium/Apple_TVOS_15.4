...
- (void).cxx_destruct;	// IMP=0x0000000000f01de4
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x0000000000f01cb9
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x0000000000f01c2c
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x0000000000f01bb6
- (void)displayLinkFired:(id)arg1;	// IMP=0x0000000000f019a1
- (_Bool)_scrollContinuous;	// IMP=0x0000000000f0193a
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x0000000000f0189e
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x0000000000f01670
- (id)initWithScrollView:(id)arg1;	// IMP=0x0000000000f015a1
