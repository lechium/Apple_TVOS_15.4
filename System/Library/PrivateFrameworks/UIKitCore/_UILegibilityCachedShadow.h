...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000075f4e6
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x000000000075f46c
- (void)dealloc;	// IMP=0x000000000075f413
