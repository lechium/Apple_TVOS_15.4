...
+ (id)_observationKeys;	// IMP=0x0000000000f08b3d
- (void).cxx_destruct;	// IMP=0x0000000000f0a543
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000f0a349
- (void)_updateOutputs;	// IMP=0x0000000000f09538
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x0000000000f093ac
- (id)candidates;	// IMP=0x0000000000f0939b
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f09334
- (id)description;	// IMP=0x0000000000f09053
- (void)dealloc;	// IMP=0x0000000000f08ef0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f08d6d
- (id)init;	// IMP=0x0000000000f08bc2
