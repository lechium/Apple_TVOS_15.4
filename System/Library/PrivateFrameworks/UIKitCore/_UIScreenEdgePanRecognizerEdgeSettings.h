...
+ (id)settingsControllerModule;	// IMP=0x00000000006e4664
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x00000000006e4644
...
- (void)setDefaultValues;	// IMP=0x00000000006e448f
