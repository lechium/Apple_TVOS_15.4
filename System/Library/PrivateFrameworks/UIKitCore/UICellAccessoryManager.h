...
- (void).cxx_destruct;	// IMP=0x0000000000d1fc04
...
- (id)description;	// IMP=0x0000000000d1fa9d
- (void)performWithEnforcedContainerSize:(struct CGSize)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d1fa6a
- (struct CGRect)containerBounds;	// IMP=0x0000000000d1fa34
@property(readonly, nonatomic) struct CGSize containerSize;
@property(readonly, nonatomic) struct CGRect contentFrame;
- (void)layoutIfNeeded;	// IMP=0x0000000000d1f852
- (void)setNeedsLayout;	// IMP=0x0000000000d1f81d
- (struct CGRect)_updateAccessories:(id)arg1 previousAccessories:(id)arg2 withLayout:(id)arg3 edge:(unsigned long long)arg4;	// IMP=0x0000000000d1e725
- (void)_updateFromPreviousConfiguration:(id)arg1;	// IMP=0x0000000000d1e34d
@property(readonly, nonatomic) UICellAccessoryConfiguration *currentConfiguration;
- (id)_configurationWithIdentifier:(id)arg1;	// IMP=0x0000000000d1e2fe
- (void)updateContainerView:(id)arg1;	// IMP=0x0000000000d1e169
- (id)initWithContainerView:(id)arg1;	// IMP=0x0000000000d1e0d7
