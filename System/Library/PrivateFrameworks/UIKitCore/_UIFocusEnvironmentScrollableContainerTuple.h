...
+ (id)tupleWithScrollView:(id)arg1;	// IMP=0x00000000005bdcb5
+ (id)tupleWithEnvironment:(id)arg1 scrollableContainer:(id)arg2;	// IMP=0x00000000005bdc49
- (void).cxx_destruct;	// IMP=0x00000000005bddf7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005bdcca
- (id)initWithEnvironment:(id)arg1 scrollableContainer:(id)arg2;	// IMP=0x00000000005bda23
