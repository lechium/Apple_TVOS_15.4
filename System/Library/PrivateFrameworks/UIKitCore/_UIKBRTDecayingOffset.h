...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x00000000009ee79a
- (void)reset;	// IMP=0x00000000009ee754
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x00000000009ee712
