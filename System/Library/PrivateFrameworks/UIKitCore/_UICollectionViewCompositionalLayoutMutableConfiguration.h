...
+ (id)defaultConfiguration;	// IMP=0x0000000000fc1299
- (void).cxx_destruct;	// IMP=0x0000000000fc1461
...
- (id)_apiRepresentation;	// IMP=0x0000000000fc1369
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000fc12c7
- (id)initWithScrollDirection:(long long)arg1 interSectionSpacing:(double)arg2 boundarySupplememtaryItems:(id)arg3;	// IMP=0x0000000000fc120c
