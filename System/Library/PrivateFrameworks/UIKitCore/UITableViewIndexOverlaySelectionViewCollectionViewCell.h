...
- (void).cxx_destruct;	// IMP=0x0000000000d3fa9c
@property(readonly) UIButton *button; // @synthesize button=_button;
@property(readonly) UILabel *label;
@property(nonatomic) double rightMargin;
@property(nonatomic) long long textAlignment;
@property(copy, nonatomic) NSString *text;
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000d3f8b6
- (void)layoutSubviews;	// IMP=0x0000000000d3f748
- (void)tintColorDidChange;	// IMP=0x0000000000d3f634
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d3f4ad
