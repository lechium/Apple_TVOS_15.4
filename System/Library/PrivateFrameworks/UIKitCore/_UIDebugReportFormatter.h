...
+ (id)defaultFormatter;	// IMP=0x00000000005c8ecf
- (void).cxx_destruct;	// IMP=0x00000000005c9359
...
- (id)stringFromReportComponents:(id)arg1;	// IMP=0x00000000005c8f32
- (id)init;	// IMP=0x00000000005c8ee1
