...
+ (id)settingsControllerModule;	// IMP=0x0000000000c13804
- (void).cxx_destruct;	// IMP=0x0000000000c13ab5
...
- (id)springAnimationBehavior;	// IMP=0x0000000000c13a15
- (void)setDefaultValues;	// IMP=0x0000000000c1379e
