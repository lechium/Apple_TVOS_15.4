...
+ (id)untargetedInvocationWithInvocation:(id)arg1 withCompletion:(_Bool)arg2;	// IMP=0x000000000099fd1e
...
- (id)initWithInvocation:(id)arg1;	// IMP=0x000000000099fc6c
- (void)dealloc;	// IMP=0x000000000099fc31
