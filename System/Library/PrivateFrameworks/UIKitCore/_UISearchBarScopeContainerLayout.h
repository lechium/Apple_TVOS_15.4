...
- (void).cxx_destruct;	// IMP=0x00000000001bcfdf
...
- (void)applyLayout;	// IMP=0x00000000001bce63
- (void)updateLayout;	// IMP=0x00000000001bcb27
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bca87
- (double)scopeControlHeight;	// IMP=0x00000000001bca22
