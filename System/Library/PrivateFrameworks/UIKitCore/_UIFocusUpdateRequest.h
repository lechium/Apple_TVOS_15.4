...
+ (id)requestForRemovingFocusInFocusSystem:(id)arg1;	// IMP=0x000000000060adcd
- (void).cxx_destruct;	// IMP=0x000000000060b805
...
- (_Bool)isValidInFocusSystem:(id)arg1;	// IMP=0x000000000060b638
- (void)cacheCurrentFocusSystem;	// IMP=0x000000000060b5fa
@property(readonly, nonatomic) __weak UIFocusSystem *focusSystem; // @synthesize focusSystem=_focusSystem;
- (id)requestByMergingWithRequest:(id)arg1;	// IMP=0x000000000060b252
- (_Bool)canMergeWithRequest:(id)arg1;	// IMP=0x000000000060b0e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000060b03b
- (id)requestByRedirectingRequestToNextContainerEnvironment;	// IMP=0x000000000060ae82
- (id)requestByRedirectingRequestToEnvironment:(id)arg1;	// IMP=0x000000000060ae22
- (id)initWithFocusSystem:(id)arg1 environment:(id)arg2;	// IMP=0x000000000060ac48
- (id)initWithEnvironment:(id)arg1;	// IMP=0x000000000060ab54
- (id)init;	// IMP=0x000000000060aacd
