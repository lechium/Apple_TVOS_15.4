...
+ (id)registrationWithSupplementaryNib:(id)arg1 elementKind:(id)arg2 configurationHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006d979b
+ (id)registrationWithSupplementaryClass:(Class)arg1 elementKind:(id)arg2 configurationHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006d96c2
- (void).cxx_destruct;	// IMP=0x00000000006d98e7
...
- (id)initWithSupplementaryClass:(Class)arg1 supplementaryNib:(id)arg2 elementKind:(id)arg3 configurationHandler:(CDUnknownBlockType)arg4 reuseIdentifier:(id)arg5;	// IMP=0x00000000006d95a3
