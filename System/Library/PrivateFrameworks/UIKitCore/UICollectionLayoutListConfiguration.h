...
- (void).cxx_destruct;	// IMP=0x000000000056fa0d
...
- (id)_spiConfiguration;	// IMP=0x000000000056f7dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056f754
- (id)initWithAppearance:(long long)arg1;	// IMP=0x000000000056f6ad
- (id)init;	// IMP=0x000000000056f632
