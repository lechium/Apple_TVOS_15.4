...
- (void).cxx_destruct;	// IMP=0x000000000014e06e
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x000000000014defd
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000014de4f
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x000000000014dd8d
