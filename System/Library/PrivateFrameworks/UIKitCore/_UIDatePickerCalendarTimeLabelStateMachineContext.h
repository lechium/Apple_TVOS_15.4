...
- (void).cxx_destruct;	// IMP=0x000000000037a03e
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x0000000000379f01
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x0000000000379ed1
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000379de1
