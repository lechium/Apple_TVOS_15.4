...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0000000000c8f57c
- (void).cxx_destruct;	// IMP=0x0000000000c8f89a
...
- (id)description;	// IMP=0x0000000000c8f739
