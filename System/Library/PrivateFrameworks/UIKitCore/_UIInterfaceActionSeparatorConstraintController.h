...
- (void).cxx_destruct;	// IMP=0x000000000003ebf9
...
- (_Bool)_isFixedWidth;	// IMP=0x000000000003ebb7
- (void)_updateConstantSizedConstraints;	// IMP=0x000000000003eafd
- (void)separatorViewDidUpdateConstraints;	// IMP=0x000000000003eaeb
@property(nonatomic) double constantAxisDimension; // @synthesize constantAxisDimension=_constantAxisDimension;
- (id)initWithSeparatorView:(id)arg1;	// IMP=0x000000000003e7ba
