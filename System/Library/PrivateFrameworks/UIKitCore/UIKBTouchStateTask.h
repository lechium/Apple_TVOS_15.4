...
+ (id)touchStateTaskForTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x00000000009a17e8
...
- (long long)compare:(id)arg1;	// IMP=0x00000000009a191c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009a18d8
- (void)dealloc;	// IMP=0x00000000009a188e
- (id)initWithTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x00000000009a1823
