...
- (void).cxx_destruct;	// IMP=0x0000000000c01f6f
...
- (void)setHighlighted:(_Bool)arg1 initialPress:(_Bool)arg2;	// IMP=0x0000000000c01d5f
- (void)layoutSubviews;	// IMP=0x0000000000c01a92
- (void)updateConstraints;	// IMP=0x0000000000c014a6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000c00fb6
