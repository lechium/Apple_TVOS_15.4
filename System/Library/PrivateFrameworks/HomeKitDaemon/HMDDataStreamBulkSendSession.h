...
+ (id)logCategory;	// IMP=0x0000000000af432c
- (void).cxx_destruct;	// IMP=0x0000000000af4055
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000af3e1c
- (void)_closeSession;	// IMP=0x0000000000af3d42
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000af3c91
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000af3bda
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000af3a9b
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000af3a08
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000af38c2
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000af377d
