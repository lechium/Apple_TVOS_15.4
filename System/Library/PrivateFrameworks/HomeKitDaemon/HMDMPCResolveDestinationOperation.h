...
+ (id)logCategory;	// IMP=0x0000000000694e05
+ (id)shortDescription;	// IMP=0x0000000000694df8
- (void).cxx_destruct;	// IMP=0x00000000006948be
...
- (void)setCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000694593
- (void)main;	// IMP=0x00000000006942ff
- (id)initWithHashedRouteIDs:(id)arg1 mediaApplicationDestination:(long long)arg2 forceSingleGroup:(_Bool)arg3 completion:(CDUnknownBlockType)arg4 remoteControlDestinationFactory:(id)arg5;	// IMP=0x00000000006941f1
- (id)initWithHashedRouteIDs:(id)arg1 mediaApplicationDestination:(long long)arg2 forceSingleGroup:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000694157
