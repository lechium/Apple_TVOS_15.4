...
+ (id)logCategory;	// IMP=0x000000000071fea9
+ (double)timeout;	// IMP=0x000000000071fdcb
- (void).cxx_destruct;	// IMP=0x000000000071fbf7
...
- (id)logIdentifier;	// IMP=0x000000000071fac8
- (void)main;	// IMP=0x000000000071f9f7
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000000071f8ac
