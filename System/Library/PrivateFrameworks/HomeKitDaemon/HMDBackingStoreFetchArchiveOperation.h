...
- (void).cxx_destruct;	// IMP=0x000000000099f612
@property(copy) NSString *identifier; // @synthesize identifier=_identifier;
@property(copy, nonatomic) CDUnknownBlockType fetchResult; // @synthesize fetchResult=_fetchResult;
- (id)mainReturningError;	// IMP=0x000000000099f3b0
- (id)initWithFetchResult:(CDUnknownBlockType)arg1;	// IMP=0x000000000099f33e
