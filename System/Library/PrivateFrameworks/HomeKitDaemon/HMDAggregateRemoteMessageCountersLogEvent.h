...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x000000000053e707
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 count:(id)arg5;	// IMP=0x000000000053e63f
- (void).cxx_destruct;	// IMP=0x000000000053e5db
...
- (id)__initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 count:(id)arg5;	// IMP=0x000000000053e2da
- (id)init;	// IMP=0x000000000053e232
