...
- (void).cxx_destruct;	// IMP=0x00000000001e650a
...
- (id)description;	// IMP=0x00000000001e6310
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 uuid:(id)arg5;	// IMP=0x00000000001e61fe
