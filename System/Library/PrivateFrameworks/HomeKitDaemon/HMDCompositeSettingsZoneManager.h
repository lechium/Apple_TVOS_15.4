...
+ (id)logCategory;	// IMP=0x00000000009ae6ff
- (void).cxx_destruct;	// IMP=0x00000000009ad89d
...
- (void)remove;	// IMP=0x00000000009ad64e
- (void)database:(id)arg1 didReceiveMessageWithUserInfo:(id)arg2;	// IMP=0x00000000009ad55e
- (void)database:(id)arg1 didRemoveZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x00000000009ad485
- (id)database:(id)arg1 willRemoveZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x00000000009ad39b
- (void)database:(id)arg1 didCreateZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x00000000009ad2d4
- (id)logIdentifier;	// IMP=0x00000000009ad2c2
@property(readonly, getter=isConfigured) _Bool configured;
- (id)initWithDatabase:(id)arg1 workQueue:(id)arg2 zoneName:(id)arg3 createZoneIfNotExists:(_Bool)arg4;	// IMP=0x00000000009ad081
