...
- (void).cxx_destruct;	// IMP=0x00000000004a8dae
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004a88d0
- (unsigned long long)hash;	// IMP=0x00000000004a8545
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004a803a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004a7ce5
- (void)copyTo:(id)arg1;	// IMP=0x00000000004a79bd
- (void)writeTo:(id)arg1;	// IMP=0x00000000004a765a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004a764d
- (id)dictionaryRepresentation;	// IMP=0x00000000004a6d50
- (id)description;	// IMP=0x00000000004a6ca1
