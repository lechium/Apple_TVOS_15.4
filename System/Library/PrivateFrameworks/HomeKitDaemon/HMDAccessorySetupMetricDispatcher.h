...
+ (id)logCategory;	// IMP=0x0000000000b06b95
- (void).cxx_destruct;	// IMP=0x0000000000b062cb
...
- (id)logIdentifier;	// IMP=0x0000000000b061fd
- (void)addHome:(id)arg1;	// IMP=0x0000000000b061e3
- (void)markLanguageSettingObserved;	// IMP=0x0000000000b06165
- (void)markFirstSettingObserved;	// IMP=0x0000000000b060e7
- (void)submit;	// IMP=0x0000000000b060db
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b05e5a
- (id)initWithTrackingInfo:(id)arg1 homeManager:(id)arg2;	// IMP=0x0000000000b05dbc
- (id)initWithTrackingInfo:(id)arg1 homeManager:(id)arg2 logEventDispatcher:(id)arg3 timerFactory:(CDUnknownBlockType)arg4;	// IMP=0x0000000000b05ca6
