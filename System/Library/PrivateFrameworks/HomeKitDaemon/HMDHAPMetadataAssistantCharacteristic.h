...
- (void).cxx_destruct;	// IMP=0x00000000001fbfeb
...
- (id)description;	// IMP=0x00000000001fbded
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x00000000001fbc3c
- (id)init;	// IMP=0x00000000001fbb94
