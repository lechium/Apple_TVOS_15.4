...
+ (id)logCategory;	// IMP=0x000000000059e641
- (void).cxx_destruct;	// IMP=0x000000000059e5ee
...
- (void)authenticate;	// IMP=0x000000000059e502
- (id)logIdentifier;	// IMP=0x000000000059e4f0
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x000000000059e3f9
