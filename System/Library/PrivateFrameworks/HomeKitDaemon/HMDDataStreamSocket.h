...
+ (id)logCategory;	// IMP=0x00000000004aaec0
- (void).cxx_destruct;	// IMP=0x00000000004aaa8b
...
- (void)closeInitiated;	// IMP=0x00000000004aa96f
- (void)handleIncomingData:(id)arg1;	// IMP=0x00000000004aa845
- (void)closeWithError:(id)arg1;	// IMP=0x00000000004aa6b5
- (id)readData;	// IMP=0x00000000004aa590
- (void)_writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004aa4b4
- (void)writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004aa40a
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004aa378
- (void)close;	// IMP=0x00000000004aa364
...
- (id)initWithStreamProtocol:(id)arg1 applicationProtocolName:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000004a9d0c
