...
+ (id)logCategory;	// IMP=0x0000000000814abe
- (void).cxx_destruct;	// IMP=0x00000000008147c3
...
- (void)getSyncEntityObjectsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000081469b
@property(readonly, nonatomic) NSArray *homeKitObjects;
- (void)gatherHomeKitObjectsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000008145a2
- (void)_gatherHomeKitObjects;	// IMP=0x0000000000812be4
...
- (id)_getCurrentHome;	// IMP=0x0000000000812804
- (id)_getPrimaryHome;	// IMP=0x00000000008125db
- (id)initWithHomeManager:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000812540
