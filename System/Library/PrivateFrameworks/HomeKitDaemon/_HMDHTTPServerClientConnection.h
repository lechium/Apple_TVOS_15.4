...
+ (id)shortDescription;	// IMP=0x00000000006ac2e1
- (void).cxx_destruct;	// IMP=0x00000000006ab5c7
...
- (void)_reallySendMessage:(id)arg1 timeout:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006aaf31
- (void)sendMessage:(id)arg1 timeout:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006aacf3
- (id)dequeueRequest;	// IMP=0x00000000006aaaa5
- (void)queueRequest:(id)arg1;	// IMP=0x00000000006aa8d1
- (CDUnknownBlockType)removeCompletionHandlerForTransactionIdentifier:(id)arg1;	// IMP=0x00000000006aa5b2
- (void)addCompletionHandler:(CDUnknownBlockType)arg1 forTransactionIdentifier:(id)arg2;	// IMP=0x00000000006aa4e0
@property(readonly, nonatomic, getter=isConnected) _Bool connected;
- (id)description;	// IMP=0x00000000006aa499
- (id)debugDescription;	// IMP=0x00000000006aa482
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x00000000006aa33c
- (id)shortDescription;	// IMP=0x00000000006aa24f
- (void)invalidate;	// IMP=0x00000000006a9dbf
- (id)initWithDevice:(id)arg1;	// IMP=0x00000000006a9ad5
- (id)init;	// IMP=0x00000000006a9a2d
