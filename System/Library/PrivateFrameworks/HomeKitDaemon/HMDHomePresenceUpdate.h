...
- (void).cxx_destruct;	// IMP=0x000000000035fdf5
...
- (id)description;	// IMP=0x000000000035fcbe
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x000000000035fbe6
