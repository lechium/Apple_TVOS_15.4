...
+ (Class)backingModelClass;	// IMP=0x0000000000691476
+ (id)backingModelProtocol;	// IMP=0x0000000000691465
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x000000000069144c
+ (Class)cd_modelClass;	// IMP=0x000000000070a3d6
+ (id)fetchRequest;	// IMP=0x0000000000b57e3e
@property(readonly, retain, nonatomic) NSArray *actionMediaPlaybacks;
- (id)castIfMediaAccessory;	// IMP=0x00000000006913ec
