...
- (void).cxx_destruct;	// IMP=0x00000000001e8bf5
...
- (id)mainReturningError;	// IMP=0x00000000001e892f
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001e8873
