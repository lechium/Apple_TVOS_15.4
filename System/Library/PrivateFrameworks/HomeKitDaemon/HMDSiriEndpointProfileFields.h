...
- (void).cxx_destruct;	// IMP=0x000000000071574e
...
- (id)attributeDescriptions;	// IMP=0x00000000007153ca
- (id)serializeFields;	// IMP=0x00000000007151e0
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x0000000000714fcf
