...
+ (id)logCategory;	// IMP=0x000000000099b587
+ (id)shortDescription;	// IMP=0x000000000099b57a
- (void).cxx_destruct;	// IMP=0x000000000099aca5
...
- (void)main;	// IMP=0x000000000099a415
- (id)initWithPlaybackArchive:(id)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x000000000099a305
- (id)initWithPlaybackArchive:(id)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x000000000099a25e
- (id)initWithCommand:(unsigned int)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x000000000099a141
- (id)initWithCommand:(unsigned int)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x000000000099a0b7
