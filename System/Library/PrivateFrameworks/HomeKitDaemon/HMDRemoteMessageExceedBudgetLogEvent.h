...
+ (id)eventWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x0000000000396c31
@property(readonly, nonatomic) struct _HMFRate budgetRate; // @synthesize budgetRate=_budgetRate;
- (id)initWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x0000000000396bc6
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b3b469
