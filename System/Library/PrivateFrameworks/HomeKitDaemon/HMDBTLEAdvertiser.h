...
+ (id)initializeAdvertiser;	// IMP=0x0000000000362ca4
+ (id)sharedAdvertiser;	// IMP=0x0000000000362c41
- (void).cxx_destruct;	// IMP=0x000000000036253f
...
- (_Bool)isAdvertisingForAccessory:(id)arg1;	// IMP=0x0000000000362237
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000036212f
- (void)_advertisementTimeout;	// IMP=0x0000000000361d99
- (void)powerOn:(id)arg1;	// IMP=0x0000000000361ce8
- (void)_startAdvertising;	// IMP=0x000000000036198b
- (void)cancelOn:(id)arg1;	// IMP=0x00000000003618da
- (void)_cancelOn:(id)arg1;	// IMP=0x0000000000361673
- (void)_completePendingPowerOnRequest:(id)arg1;	// IMP=0x00000000003615a0
- (void)stopAdvertisement:(id)arg1;	// IMP=0x00000000003614ef
- (void)_stopAdvertisement:(id)arg1;	// IMP=0x0000000000361450
- (void)_clearAdvertiser;	// IMP=0x00000000003613c6
- (void)didUpdateBTLEState:(long long)arg1;	// IMP=0x000000000036134a
- (void)_flushQueues;	// IMP=0x0000000000361306
- (void)_flushQueue:(id)arg1;	// IMP=0x00000000003611fd
- (id)init;	// IMP=0x0000000000360fbc
