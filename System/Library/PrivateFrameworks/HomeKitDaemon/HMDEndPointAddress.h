...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000071a39
- (void).cxx_destruct;	// IMP=0x00000000000719f7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000718ac
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000007162e
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007149e
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000071265
- (id)tlvData;	// IMP=0x0000000000071109
- (_Bool)compatibleWithRemoteEndPoint:(id)arg1;	// IMP=0x000000000007103f
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x0000000000070f67
