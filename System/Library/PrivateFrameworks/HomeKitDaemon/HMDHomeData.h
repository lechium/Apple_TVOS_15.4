...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x000000000049855c
- (void).cxx_destruct;	// IMP=0x000000000049844e
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x0000000000498128
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004980d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004980cb
