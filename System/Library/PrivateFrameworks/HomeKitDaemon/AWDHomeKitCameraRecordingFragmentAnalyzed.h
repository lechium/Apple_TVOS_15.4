...
- (void).cxx_destruct;	// IMP=0x00000000008eda2e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008ed85e
- (unsigned long long)hash;	// IMP=0x00000000008ed723
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008ed547
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008ed3de
- (void)copyTo:(id)arg1;	// IMP=0x00000000008ed2c1
- (void)writeTo:(id)arg1;	// IMP=0x00000000008ed199
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008ed18c
- (id)dictionaryRepresentation;	// IMP=0x00000000008ecec7
- (id)description;	// IMP=0x00000000008ece18
- (int)StringAsRecordingReason:(id)arg1;	// IMP=0x00000000008ecd64
- (id)recordingReasonAsString:(int)arg1;	// IMP=0x00000000008ecce3
