...
- (void).cxx_destruct;	// IMP=0x00000000001ba422
...
- (void)addModelToBeUpdated:(id)arg1;	// IMP=0x00000000001ba369
- (void)removeModelWithIdentifier:(id)arg1;	// IMP=0x00000000001ba2f7
- (void)addModel:(id)arg1;	// IMP=0x00000000001ba285
- (void)addSettingModel:(id)arg1;	// IMP=0x00000000001ba140
- (id)initForInitialCreationWithTransactionLabel:(id)arg1;	// IMP=0x00000000001ba074
- (id)initWithTransactionLabel:(id)arg1;	// IMP=0x00000000001b9fa8
