...
+ (id)logCategory;	// IMP=0x000000000030ec84
+ (unsigned long long)entitlementsForConnection:(id)arg1;	// IMP=0x000000000030e910
- (void).cxx_destruct;	// IMP=0x000000000030d8da
...
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000030d686
- (void)updateUserInfo:(id)arg1;	// IMP=0x000000000030d396
- (void)handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000030d384
- (void)handleMessage:(id)arg1;	// IMP=0x000000000030d370
- (void)initiateRefresh;	// IMP=0x000000000030d2d6
- (void)deactivate;	// IMP=0x000000000030d284
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000030d069
- (void)_handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000030c3b5
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x000000000030b7d7
- (_Bool)shouldSendResponseForMessageIdentifier:(id)arg1;	// IMP=0x000000000030b75a
@property(readonly, nonatomic) NSSet *activeRequests;
- (void)updateSendPolicyParameters:(id)arg1;	// IMP=0x000000000030b5e0
...
- (void)__handleApplicationStateChange:(id)arg1;	// IMP=0x000000000030b318
...
- (id)_displayName;	// IMP=0x000000000030add2
...
- (id)counterIdentifierForMessage:(id)arg1;	// IMP=0x000000000030a931
...
- (id)attributeDescriptions;	// IMP=0x000000000030a60c
- (id)shortDescription;	// IMP=0x000000000030a523
- (void)dealloc;	// IMP=0x000000000030a3d0
- (id)initWithConnection:(id)arg1 counterTracker:(id)arg2;	// IMP=0x000000000030a128
