...
- (void).cxx_destruct;	// IMP=0x00000000006685d2
@property(copy) NSSet *validValues; // @synthesize validValues=_validValues;
- (id)initWithValidValues:(id)arg1;	// IMP=0x0000000000668531
- (_Bool)isValidValue:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000668529
