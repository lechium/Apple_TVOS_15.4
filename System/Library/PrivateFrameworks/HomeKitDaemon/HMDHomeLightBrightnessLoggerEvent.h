...
#import <HomeKitDaemon/BMProtoBufWrapper-Protocol.h>
#import <HomeKitDaemon/BMStoreData-Protocol.h>
...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x0000000000459306
- (void).cxx_destruct;	// IMP=0x00000000004592b3
...
- (id)proto;	// IMP=0x00000000004591da
- (id)initWithProtoData:(id)arg1;	// IMP=0x000000000045913e
- (id)initWithProto:(id)arg1;	// IMP=0x0000000000458ffa
- (id)encodeAsProto;	// IMP=0x0000000000458faa
- (id)serialize;	// IMP=0x0000000000458f98
@property(readonly, nonatomic) unsigned int dataVersion;
- (id)initWithHomeUUID:(id)arg1 accessoryUUID:(id)arg2 characteristicUUID:(id)arg3 brightness:(id)arg4;	// IMP=0x0000000000458e96
