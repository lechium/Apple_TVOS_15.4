...
- (void).cxx_destruct;	// IMP=0x00000000007ac334
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007ac001
- (unsigned long long)hash;	// IMP=0x00000000007abed1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007abc8f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007abad8
- (void)copyTo:(id)arg1;	// IMP=0x00000000007ab995
- (void)writeTo:(id)arg1;	// IMP=0x00000000007ab865
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007ab858
- (id)dictionaryRepresentation;	// IMP=0x00000000007ab55e
- (id)description;	// IMP=0x00000000007ab4af
