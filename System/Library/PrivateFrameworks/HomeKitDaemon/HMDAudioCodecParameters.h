...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006ea93
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006e84a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006e527
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006e349
- (id)tlvData;	// IMP=0x000000000006e13d
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006df7c
- (id)initWithChannelCount:(id)arg1 bitRateSetting:(id)arg2 audioSampleRate:(id)arg3 rtpPtime:(id)arg4;	// IMP=0x000000000006de85
