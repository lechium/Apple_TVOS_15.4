...
- (void).cxx_destruct;	// IMP=0x000000000094641b
...
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x000000000094636f
