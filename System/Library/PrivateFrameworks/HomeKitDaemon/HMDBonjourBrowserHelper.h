...
- (void).cxx_destruct;	// IMP=0x0000000000786019
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x0000000000785cf6
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x0000000000785c18
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x0000000000785b3a
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000785a6b
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x0000000000785908
- (void)_removeBrowser:(id)arg1;	// IMP=0x000000000078583d
- (void)_addBrowser:(id)arg1;	// IMP=0x0000000000785772
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x000000000078535a
- (void)_stopBrowsers;	// IMP=0x0000000000784e60
- (void)stop;	// IMP=0x0000000000784def
- (_Bool)_startBrowsers;	// IMP=0x00000000007849b0
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000007848ff
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x0000000000784664
