...
- (void).cxx_destruct;	// IMP=0x00000000008b1019
...
- (id)initWithUUID:(id)arg1 accessoryName:(id)arg2 manufacturerName:(id)arg3 category:(id)arg4 certificationStatus:(unsigned long long)arg5 productData:(id)arg6;	// IMP=0x00000000008b0e8a
