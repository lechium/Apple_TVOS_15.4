...
- (void).cxx_destruct;	// IMP=0x00000000002285b4
...
- (id)description;	// IMP=0x0000000000228515
- (void)dealloc;	// IMP=0x0000000000228425
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000228353
