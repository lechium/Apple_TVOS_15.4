...
- (void).cxx_destruct;	// IMP=0x0000000000696e00
...
- (void)dealloc;	// IMP=0x0000000000696d52
- (id)initWithStreamTracker:(id)arg1 streamIdentifier:(id)arg2;	// IMP=0x0000000000696cb7
