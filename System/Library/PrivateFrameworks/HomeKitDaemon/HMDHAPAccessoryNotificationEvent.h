...
- (void).cxx_destruct;	// IMP=0x00000000009a653f
...
- (_Bool)isThreadAccessory:(id)arg1;	// IMP=0x00000000009a5c17
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithAccessory:(id)arg1 characteristic:(id)arg2;	// IMP=0x00000000009a5b6c
