...
+ (id)properties;	// IMP=0x0000000000aa0617
+ (Class)cd_entityClass;	// IMP=0x00000000007c95af
+ (id)cd_parentReferenceName;	// IMP=0x00000000007c95a2
- (id)dependentUUIDs;	// IMP=0x0000000000aa02c4
