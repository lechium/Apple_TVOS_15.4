...
- (void).cxx_destruct;	// IMP=0x0000000000b1ba69
...
- (id)_makeLocalTaskWithRequests:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b1b91d
- (id)_makeRemoteTaskWithRequests:(id)arg1 delegateDevice:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b1b853
- (CDUnknownBlockType)_remoteTaskCompletionHandler;	// IMP=0x0000000000b1b7d0
- (CDUnknownBlockType)completion;	// IMP=0x0000000000b1b6dc
- (_Bool)_shouldFallbackLocallyWithError:(id)arg1 accessory:(id)arg2;	// IMP=0x0000000000b1b591
- (void)execute;	// IMP=0x0000000000b1b279
- (id)initWithContext:(id)arg1 requests:(id)arg2 delegateDevice:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000b1b1ef
