...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00000000002eb74b
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00000000002eb6d3
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00000000002eb5a9
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00000000005715c3
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000571574
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0000000000571525
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0000000000783a1b
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00000000007839b1
- (void)abortChangesAndRespondWithError:(id)arg1;	// IMP=0x00000000002a602b
- (_Bool)saveChangesAndRespondWitPayload:(id)arg1;	// IMP=0x00000000002a5f65
- (_Bool)saveChangesAndRespondWithSuccess;	// IMP=0x00000000002a5eb8
- (unsigned long long)homeManagerOptions;	// IMP=0x00000000002eb558
...
- (_Bool)_supportsFeature:(unsigned long long)arg1 forCapabilitiesKey:(id)arg2;	// IMP=0x0000000000410617
- (_Bool)supportsRequestedFeature:(unsigned long long)arg1;	// IMP=0x00000000004105fe
- (_Bool)supportsRequiredFeature:(unsigned long long)arg1;	// IMP=0x00000000004105e5
...
- (id)userForHome:(id)arg1;	// IMP=0x0000000000996168
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x0000000000995de9
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0000000000b20e3e
