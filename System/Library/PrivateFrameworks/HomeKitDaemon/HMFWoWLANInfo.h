...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000589fa9
- (void).cxx_destruct;	// IMP=0x0000000000589f56
...
- (id)description;	// IMP=0x0000000000589ca1
@property(readonly, nonatomic) NSString *wakeAddressString;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000589871
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005895f3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000589304
- (unsigned long long)hash;	// IMP=0x00000000005891e0
- (id)initWithWakeVersion:(unsigned char)arg1 wakePort:(unsigned short)arg2 wakeAddress:(id)arg3 wakeType:(long long)arg4 wakePacketType:(long long)arg5 wakePattern:(id)arg6;	// IMP=0x0000000000588ff0
- (id)initWithPrimaryIdentifier:(id)arg1 wifiIdentifiers:(id)arg2;	// IMP=0x0000000000588e75
