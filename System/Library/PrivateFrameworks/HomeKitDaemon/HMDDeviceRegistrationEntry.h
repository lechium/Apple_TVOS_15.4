...
- (void).cxx_destruct;	// IMP=0x000000000009f223
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009f12f
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x000000000009f08d
