...
- (void).cxx_destruct;	// IMP=0x0000000000ad2ca1
...
- (void)dumpForLoggingWithPrefix:(id)arg1 logType:(unsigned char)arg2;	// IMP=0x0000000000ad2a53
- (id)descriptionLines;	// IMP=0x0000000000ad2785
- (id)description;	// IMP=0x0000000000ad2683
