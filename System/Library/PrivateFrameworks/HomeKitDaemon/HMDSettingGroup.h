...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000008aed3c
- (void).cxx_destruct;	// IMP=0x00000000008aece8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000008aea1a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008ae964
- (void)addGroup:(id)arg1;	// IMP=0x00000000008ae873
- (void)addSetting:(id)arg1;	// IMP=0x00000000008ae782
@property(readonly, copy) NSArray *groups;
@property(readonly, copy) NSArray *settings;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 name:(id)arg3 groups:(id)arg4 settings:(id)arg5;	// IMP=0x00000000008ae566
- (id)initWithModel:(id)arg1;	// IMP=0x00000000008ae44b
