...
+ (id)logCategory;	// IMP=0x00000000005216c1
- (void).cxx_destruct;	// IMP=0x0000000000521218
...
- (void)snapshotStreamSender:(id)arg1 didCompleteSendImage:(id)arg2 sessionID:(id)arg3;	// IMP=0x00000000005210b9
- (void)snapshotStreamSender:(id)arg1 didStartCaptureImage:(id)arg2 sessionID:(id)arg3;	// IMP=0x0000000000520fa8
- (void)snapshotRelayReceiver:(id)arg1 didSaveSnapshotFile:(id)arg2 error:(id)arg3 sessionID:(id)arg4;	// IMP=0x0000000000520e32
- (void)snapshotRelayReceiver:(id)arg1 didStartGettingImage:(id)arg2 sessionID:(id)arg3;	// IMP=0x0000000000520d30
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x00000000005208cf
- (void)_callDidCompleteSendImageDelegate:(id)arg1;	// IMP=0x00000000005206ba
- (void)_callDidStartCaptureImageDelegate:(id)arg1;	// IMP=0x00000000005204a5
- (void)snapShotSendFailed:(id)arg1;	// IMP=0x00000000005203f4
- (void)snapShotTransferComplete;	// IMP=0x0000000000520383
- (void)getSnapshot:(unsigned long long)arg1;	// IMP=0x0000000000520307
- (id)logIdentifier;	// IMP=0x000000000052028d
- (void)dealloc;	// IMP=0x00000000005201a8
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 options:(id)arg3 device:(id)arg4 accessory:(id)arg5 delegate:(id)arg6 delegateQueue:(id)arg7 uniqueIdentifier:(id)arg8 snapshotRequestHandler:(id)arg9 residentMessageHandler:(id)arg10;	// IMP=0x000000000051ff9f
