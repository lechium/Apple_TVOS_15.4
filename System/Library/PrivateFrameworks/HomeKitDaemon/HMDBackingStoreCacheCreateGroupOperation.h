...
- (void).cxx_destruct;	// IMP=0x00000000001e4da6
...
- (id)mainReturningError;	// IMP=0x00000000001e4a8f
- (id)initWithZone:(id)arg1 owner:(id)arg2 rootRecord:(id)arg3 subscriptionName:(id)arg4 subscription:(id)arg5 creationBlock:(CDUnknownBlockType)arg6;	// IMP=0x00000000001e4951
