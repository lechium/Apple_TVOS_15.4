...
- (void).cxx_destruct;	// IMP=0x00000000001fc3dd
...
- (id)description;	// IMP=0x00000000001fc25d
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x00000000001fc108
- (id)init;	// IMP=0x00000000001fc060
