...
- (void).cxx_destruct;	// IMP=0x000000000045b540
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000045b31c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000045b311
- (unsigned long long)hash;	// IMP=0x000000000045b1ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000045af75
- (id)attributeDescriptions;	// IMP=0x000000000045ac6b
- (id)init;	// IMP=0x000000000045ab61
