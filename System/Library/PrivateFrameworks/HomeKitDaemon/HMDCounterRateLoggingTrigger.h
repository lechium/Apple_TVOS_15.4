...
- (void).cxx_destruct;	// IMP=0x000000000024aa41
...
- (void)logRateTrigger:(id)arg1 triggerValue:(unsigned long long)arg2;	// IMP=0x000000000024a86e
- (void)updatedCounterForEventName:(id)arg1 requestGroup:(id)arg2 fromOldValue:(unsigned long long)arg3 toNewValue:(unsigned long long)arg4;	// IMP=0x000000000024a4ba
- (void)dealloc;	// IMP=0x000000000024a480
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 timeSourceBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000024a397
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4;	// IMP=0x000000000024a371
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3;	// IMP=0x000000000024a35c
