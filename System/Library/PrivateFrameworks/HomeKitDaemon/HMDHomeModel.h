...
+ (id)properties;	// IMP=0x000000000059264b
+ (id)cd_getHomeFromUUID:(id)arg1;	// IMP=0x0000000000979b6c
+ (Class)cd_entityClass;	// IMP=0x0000000000979b5b
@property(copy, nonatomic) HMDNaturalLightingContext *naturalLightingContext;
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000979292
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000978cfb
