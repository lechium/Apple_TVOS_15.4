...
+ (id)logCategory;	// IMP=0x00000000006bbf16
- (void).cxx_destruct;	// IMP=0x00000000006bbec3
...
- (id)logIdentifier;	// IMP=0x00000000006bbe1b
- (void)startKeepAlive;	// IMP=0x00000000006bbe15
- (void)dealloc;	// IMP=0x00000000006bbcfc
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000006bbbb2
