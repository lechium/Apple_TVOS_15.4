...
- (void).cxx_destruct;	// IMP=0x0000000000a99155
...
- (unsigned long long)hash;	// IMP=0x0000000000a98e77
- (long long)compare:(id)arg1;	// IMP=0x0000000000a98d7f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a989e1
- (id)attributeDescriptions;	// IMP=0x0000000000a986f7
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000a984f5
