...
+ (id)logCategory;	// IMP=0x0000000000a6f567
- (void).cxx_destruct;	// IMP=0x0000000000a6f366
...
- (void)didChangeHasActiveAccountState:(_Bool)arg1;	// IMP=0x0000000000a6f115
- (void)didUpdateDataSyncState:(unsigned long long)arg1;	// IMP=0x0000000000a6efa5
@property long long multiUserState; // @synthesize multiUserState=_multiUserState;
- (id)initWithQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000a6ee6c
