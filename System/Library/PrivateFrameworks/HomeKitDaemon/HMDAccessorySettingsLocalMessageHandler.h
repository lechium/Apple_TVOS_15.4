...
+ (id)logCategory;	// IMP=0x00000000005e3e2e
- (void).cxx_destruct;	// IMP=0x00000000005e3ddf
...
- (id)callerVersionForMessage:(id)arg1;	// IMP=0x00000000005e3bdd
- (unsigned long long)dataSourceCallerPrivilegeWithMessage:(id)arg1 error:(id *)arg2;	// IMP=0x00000000005e39f4
- (void)handleAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x00000000005e333b
- (id)siriAvailableLanguagesSetting;	// IMP=0x00000000005e32ae
- (void)handleAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x00000000005e2acc
- (id)initWithHomeUUID:(id)arg1 languageValuesDataProvider:(id)arg2;	// IMP=0x00000000005e2a2a
