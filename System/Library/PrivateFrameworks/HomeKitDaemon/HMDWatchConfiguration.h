...
- (void).cxx_destruct;	// IMP=0x00000000009e422c
...
- (void)setConfigVersion:(id)arg1 forHome:(id)arg2;	// IMP=0x00000000009e40c8
- (void)setHomeConfiguration:(id)arg1;	// IMP=0x00000000009e3e1a
- (id)description;	// IMP=0x00000000009e3d5a
- (id)initWithUniqueID:(id)arg1;	// IMP=0x00000000009e3ca5
