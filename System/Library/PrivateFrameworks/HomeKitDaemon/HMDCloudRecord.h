...
+ (id)logCategory;	// IMP=0x00000000009330d9
+ (id)shortDescription;	// IMP=0x00000000009330c7
- (void).cxx_destruct;	// IMP=0x0000000000933054
...
- (void)clearData;	// IMP=0x0000000000932e96
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x00000000009323dc
- (id)extractObjectChange;	// IMP=0x0000000000931908
- (id)description;	// IMP=0x000000000093189c
- (id)shortDescription;	// IMP=0x00000000009317ac
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x0000000000931654
- (id)init;	// IMP=0x00000000009315ac
