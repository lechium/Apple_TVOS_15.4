...
- (void).cxx_destruct;	// IMP=0x00000000006b61fa
...
- (id)initWithHomePresenceByPairingIdentity:(id)arg1 trigger:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006b60e6
