...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000752c0
- (void).cxx_destruct;	// IMP=0x000000000007523a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000074fea
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000074b1b
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000748dc
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000074567
- (id)tlvData;	// IMP=0x0000000000074350
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 maxMTU:(id)arg5 comfortNoisePayloadType:(id)arg6;	// IMP=0x000000000007420c
