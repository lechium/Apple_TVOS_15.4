...
+ (id)logCategory;	// IMP=0x00000000009ce092
- (void).cxx_destruct;	// IMP=0x00000000009cd734
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x00000000009cd2e8
- (id)_parsedLanguageSetting:(id)arg1 topic:(id)arg2;	// IMP=0x00000000009ccfcc
- (id)_parsedIntegerSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x00000000009ccd86
- (id)_parsedBoolSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x00000000009cca57
- (id)_transformLegacyLanguageSettingValueToImmutableSetting:(id)arg1;	// IMP=0x00000000009cc82c
- (id)_settingValueForKeyPath:(id)arg1 value:(id)arg2;	// IMP=0x00000000009cc021
- (id)languageValueList;	// IMP=0x00000000009cc014
- (void)updateSettingWithKeyPath:(id)arg1 settingValue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000009cbd0f
- (void)startup;	// IMP=0x00000000009cb9bf
- (id)initWithQueue:(id)arg1 homeUUID:(id)arg2 accessoryUUID:(id)arg3 settingsController:(id)arg4 subscriptionProvider:(id)arg5;	// IMP=0x00000000009cb8b7
