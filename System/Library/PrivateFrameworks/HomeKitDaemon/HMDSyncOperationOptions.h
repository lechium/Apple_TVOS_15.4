...
- (void).cxx_destruct;	// IMP=0x00000000006717d2
...
- (id)description;	// IMP=0x0000000000671555
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x000000000067153d
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x0000000000671487
