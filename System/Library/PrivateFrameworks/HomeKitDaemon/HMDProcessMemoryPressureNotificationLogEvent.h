...
+ (id)createEventWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00000000005c0235
- (void).cxx_destruct;	// IMP=0x00000000005c0204
...
- (id)initWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00000000005c0140
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)metricForAWD;	// IMP=0x0000000000837f63
- (unsigned int)AWDMessageType;	// IMP=0x0000000000837f58
