...
- (void).cxx_destruct;	// IMP=0x0000000000055b0b
...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x0000000000055a37
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x00000000000558a9
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000555cb
