...
+ (id)properties;	// IMP=0x000000000053b2da
+ (id)cd_createMKFCharacteristicFromDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000a6d41f
+ (id)cd_modelTypeForCharacteristicFormat:(id)arg1;	// IMP=0x0000000000a6d3b9
+ (Class)cd_entityClass;	// IMP=0x0000000000a6d3a8
+ (id)cd_parentReferenceName;	// IMP=0x0000000000a6d39b
- (void).cxx_destruct;	// IMP=0x000000000053b2a9
...
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000a6cc4c
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000a6c84d
- (_Bool)cd_updateManagedObjectInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000a6c77a
