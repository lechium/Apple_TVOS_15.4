...
+ (id)logCategory;	// IMP=0x000000000071c632
- (void).cxx_destruct;	// IMP=0x000000000071c5ce
...
- (void)dealloc;	// IMP=0x000000000071c442
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x000000000071c2b7
