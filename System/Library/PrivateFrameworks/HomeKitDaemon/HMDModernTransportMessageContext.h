...
- (void).cxx_destruct;	// IMP=0x0000000000b478c7
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b4763b
- (void)done;	// IMP=0x0000000000b4757e
- (void)startTransportFallbackTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b473e4
- (void)startResponseTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b4724a
- (double)timeoutRemaining;	// IMP=0x0000000000b47166
- (id)preparedMessageWithTimeout:(double)arg1;	// IMP=0x0000000000b46bb0
- (void)completeSendingOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000b46793
- (void)startSendingOverTransport:(id)arg1;	// IMP=0x0000000000b463bf
...
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5;	// IMP=0x0000000000b45e7c
