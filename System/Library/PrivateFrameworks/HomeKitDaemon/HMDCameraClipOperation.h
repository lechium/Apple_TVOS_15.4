...
+ (id)logCategory;	// IMP=0x00000000002c8fe8
+ (id)shortDescription;	// IMP=0x00000000002c8fd6
+ (unsigned long long)cameraClipOperationType;	// IMP=0x00000000002c8f2e
- (void).cxx_destruct;	// IMP=0x00000000002c8e97
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x00000000002c8952
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x00000000002c8627
- (id)fetchClipModel;	// IMP=0x00000000002c83db
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000002c82c1
- (void)finish;	// IMP=0x00000000002c81a7
- (void)main;	// IMP=0x00000000002c8123
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000002c7db2
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x00000000002c7d2e
