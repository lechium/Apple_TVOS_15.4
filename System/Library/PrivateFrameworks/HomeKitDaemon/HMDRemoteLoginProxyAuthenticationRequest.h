...
+ (id)xpcMessageName;	// IMP=0x0000000000369513
+ (id)messageName;	// IMP=0x0000000000369506
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000003694fe
+ (id)objWithMessage:(id)arg1;	// IMP=0x0000000000369367
+ (id)objWithDict:(id)arg1;	// IMP=0x00000000003691f2
- (void).cxx_destruct;	// IMP=0x000000000036919f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000368faa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000368e64
