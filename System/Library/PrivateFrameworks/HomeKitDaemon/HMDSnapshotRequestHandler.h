...
+ (id)logCategory;	// IMP=0x0000000000b4ae2b
- (void).cxx_destruct;	// IMP=0x0000000000b48504
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b48355
- (void)streamSnapshotHandler:(id)arg1 didGetLastSnapshot:(id)arg2;	// IMP=0x0000000000b4825e
- (void)streamSnapshotHandler:(id)arg1 didGetNewSnapshot:(id)arg2;	// IMP=0x0000000000b48167
- (void)requestSnapshot:(id)arg1 streamingTierType:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b47fc1
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 streamSnapshotHandler:(id)arg3 imageCacheDirectory:(id)arg4 logID:(id)arg5;	// IMP=0x0000000000b47e5f
