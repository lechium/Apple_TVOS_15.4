...
- (void).cxx_destruct;	// IMP=0x00000000006ddad4
...
- (id)initWithStagedDestinationIdentifier:(id)arg1 isTriggeredOnControllerDevice:(id)arg2 userPrivilege:(id)arg3;	// IMP=0x00000000006dd9d0
