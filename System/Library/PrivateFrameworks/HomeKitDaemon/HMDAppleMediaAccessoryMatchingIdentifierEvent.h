...
- (void).cxx_destruct;	// IMP=0x000000000006554b
...
- (id)attributeDescriptions;	// IMP=0x00000000000653f3
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithMatchingIdentifiersCount:(long long)arg1;	// IMP=0x000000000006524c
