...
+ (id)shortDescription;	// IMP=0x0000000000791cd8
- (void).cxx_destruct;	// IMP=0x0000000000791c85
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x0000000000791485
- (void)resetRecord;	// IMP=0x0000000000791446
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x00000000007913d4
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x0000000000790a31
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x000000000079092e
- (void)updateCloudRecord:(id)arg1;	// IMP=0x000000000079040f
- (void)forceChangeToInvalid;	// IMP=0x00000000007903fb
- (void)forceChangeToDelete;	// IMP=0x0000000000790308
...
- (id)shortDescription;	// IMP=0x000000000078fed6
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x000000000078febf
- (id)initWithObjectChange:(id)arg1;	// IMP=0x000000000078feab
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x000000000078fb76
- (id)init;	// IMP=0x000000000078face
