...
- (void).cxx_destruct;	// IMP=0x000000000059fa6a
...
- (void)computeNextRetryInterval;	// IMP=0x000000000059f994
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x000000000059f6c2
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x000000000059f62b
