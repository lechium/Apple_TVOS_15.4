...
+ (id)logCategory;	// IMP=0x00000000005d233e
- (void).cxx_destruct;	// IMP=0x00000000005d203c
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000005d1dfa
- (void)handleClientConnectionDidDeactivate:(id)arg1;	// IMP=0x00000000005d1d49
- (void)handleClientConnectionDidActivate:(id)arg1;	// IMP=0x00000000005d1c98
- (void)_updateTimer;	// IMP=0x00000000005d194b
- (void)removeClientConnection:(id)arg1;	// IMP=0x00000000005d1772
- (void)addClientConnection:(id)arg1;	// IMP=0x00000000005d158b
@property(readonly, copy) NSSet *clientConnections;
- (id)initWithTimeInterval:(double)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000005d1374
