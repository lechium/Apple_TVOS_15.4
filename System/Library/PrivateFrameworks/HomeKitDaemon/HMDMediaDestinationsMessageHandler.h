...
- (void).cxx_destruct;	// IMP=0x00000000008ee551
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x00000000008ee45e
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x00000000008ee071
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000008edf00
