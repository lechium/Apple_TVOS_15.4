...
+ (id)logCategory;	// IMP=0x00000000009de011
- (void).cxx_destruct;	// IMP=0x00000000009ddb18
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x00000000009dd92d
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x00000000009dd77f
- (void)sessionStarted:(id)arg1;	// IMP=0x00000000009dd5ed
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x00000000009dd472
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x00000000009dd2f7
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x00000000009dd1b9
- (void)dealloc;	// IMP=0x00000000009dd04c
- (void)_startDataTransfer;	// IMP=0x00000000009dcd7d
- (void)sendIDSInvitation;	// IMP=0x00000000009dc89b
- (void)_sendData;	// IMP=0x00000000009dc802
- (void)sendData:(id)arg1;	// IMP=0x00000000009dc61b
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x00000000009dc475
