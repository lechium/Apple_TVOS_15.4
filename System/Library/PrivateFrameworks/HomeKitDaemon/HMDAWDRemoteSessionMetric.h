...
+ (int)closeReasonFromError:(id)arg1;	// IMP=0x00000000008486e5
- (void).cxx_destruct;	// IMP=0x00000000008486b4
...
- (id)metricForAWD;	// IMP=0x0000000000848176
- (void)open;	// IMP=0x000000000084801e
- (id)initWithClientMode:(_Bool)arg1 sessionID:(id)arg2;	// IMP=0x0000000000847e8b
- (unsigned int)AWDMessageType;	// IMP=0x0000000000847e80
