...
+ (id)eventWithKeyPath:(id)arg1 value:(id)arg2;	// IMP=0x00000000008e7149
- (void).cxx_destruct;	// IMP=0x00000000008e7118
@property(copy, nonatomic) AWDHomeKitValue *value; // @synthesize value=_value;
@property(copy, nonatomic) NSString *keyPath; // @synthesize keyPath=_keyPath;
- (id)metricForAWD;	// IMP=0x00000000008364a0
- (unsigned int)AWDMessageType;	// IMP=0x0000000000836495
