...
+ (id)logCategory;	// IMP=0x000000000008f290
- (void).cxx_destruct;	// IMP=0x000000000008f193
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x000000000008ead5
- (id)createSelectedAudioParameters;	// IMP=0x000000000008e70e
- (id)createSRTPParamters;	// IMP=0x000000000008e68e
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x000000000008e0c9
- (_Bool)selectAudioParameters;	// IMP=0x000000000008d8aa
- (id)logIdentifier;	// IMP=0x000000000008d85a
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x000000000008d6c6
