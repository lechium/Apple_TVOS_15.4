...
- (void).cxx_destruct;	// IMP=0x00000000005d4a98
...
- (id)initWithReason:(unsigned long long)arg1 author:(unsigned long long)arg2;	// IMP=0x00000000005d4979
- (id)initWithReason:(unsigned long long)arg1;	// IMP=0x00000000005d4935
@property(readonly, copy) NSString *diagnosticReportEventType;
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b3b475
