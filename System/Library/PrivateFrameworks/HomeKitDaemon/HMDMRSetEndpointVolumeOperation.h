...
+ (id)logCategory;	// IMP=0x000000000025133f
+ (id)shortDescription;	// IMP=0x0000000000251332
- (void).cxx_destruct;	// IMP=0x000000000024f297
...
- (id)setVolumeOnEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000024ec56
- (id)getVolumeCapabilitiesForEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000024e9b3
- (id)connectToEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000024e71c
- (id)discoverRemoteControlEndpointsForUIDs:(id)arg1;	// IMP=0x000000000024e538
- (_Bool)cancelOnSetup;	// IMP=0x000000000024df89
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)arg1;	// IMP=0x000000000024d468
- (void)main;	// IMP=0x000000000024d203
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2;	// IMP=0x000000000024d17f
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2 externalObjectInterface:(id)arg3;	// IMP=0x000000000024d02a
