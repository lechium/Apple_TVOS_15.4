...
+ (id)xpcMessageName;	// IMP=0x0000000000368c2c
+ (id)messageName;	// IMP=0x0000000000368c1f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000368c17
+ (id)objWithMessage:(id)arg1;	// IMP=0x0000000000368a80
+ (id)objWithDict:(id)arg1;	// IMP=0x000000000036890b
- (void).cxx_destruct;	// IMP=0x00000000003688da
@property(retain, nonatomic) AKDevice *companionDevice; // @synthesize companionDevice=_companionDevice;
@property(retain, nonatomic) ACAccount *account; // @synthesize account=_account;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003687a1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000036867e
