...
- (void).cxx_destruct;	// IMP=0x0000000000b50e06
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b4fead
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000b4fdb7
