...
+ (id)shortDescription;	// IMP=0x000000000001ed38
- (void).cxx_destruct;	// IMP=0x000000000001ed09
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000001e852
- (id)initWithBiomeEventManager:(id)arg1 dataSource:(id)arg2;	// IMP=0x000000000001e7b0
