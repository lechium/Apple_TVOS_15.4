...
- (void).cxx_destruct;	// IMP=0x00000000008e52f3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008e50e4
- (unsigned long long)hash;	// IMP=0x00000000008e4f71
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008e4d37
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008e4bb2
- (void)copyTo:(id)arg1;	// IMP=0x00000000008e4a63
- (void)writeTo:(id)arg1;	// IMP=0x00000000008e48f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008e48ec
- (id)dictionaryRepresentation;	// IMP=0x00000000008e453c
- (id)description;	// IMP=0x00000000008e448d
@property(nonatomic) _Bool hasOperationStartTime;
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x00000000008e435c
- (id)operationTypeAsString:(int)arg1;	// IMP=0x00000000008e42d0
