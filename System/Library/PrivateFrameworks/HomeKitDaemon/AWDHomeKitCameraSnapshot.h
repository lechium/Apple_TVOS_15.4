...
- (void).cxx_destruct;	// IMP=0x00000000004b316d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000004b2ce3
- (unsigned long long)hash;	// IMP=0x00000000004b2a85
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004b26c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004b240a
- (void)copyTo:(id)arg1;	// IMP=0x00000000004b21df
- (void)writeTo:(id)arg1;	// IMP=0x00000000004b1fad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004b1fa0
- (id)dictionaryRepresentation;	// IMP=0x00000000004b1a0b
- (id)description;	// IMP=0x00000000004b195c
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000004b161c
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000004b15b6
