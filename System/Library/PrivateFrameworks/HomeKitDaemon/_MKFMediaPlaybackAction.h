...
+ (Class)backingModelClass;	// IMP=0x00000000001ea122
+ (id)backingModelProtocol;	// IMP=0x00000000001ea111
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00000000001ea05b
+ (Class)cd_modelClass;	// IMP=0x0000000000a9c4b2
+ (id)fetchRequest;	// IMP=0x0000000000b57ebe
- (void)removeAccessoriesObject:(id)arg1;	// IMP=0x00000000001ea03f
- (void)addAccessoriesObject:(id)arg1;	// IMP=0x00000000001ea023
@property(readonly, retain, nonatomic) NSArray *accessories;
@property(readonly) id <MKFHome> home;
- (id)castIfMediaPlaybackAction;	// IMP=0x00000000001e9f73
