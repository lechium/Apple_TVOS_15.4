...
+ (id)logCategory;	// IMP=0x0000000000846617
- (void).cxx_destruct;	// IMP=0x00000000008465d5
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x00000000008463fc
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x0000000000846250
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x0000000000845e95
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x0000000000845b22
- (id)logIdentifier;	// IMP=0x0000000000845ad2
- (id)initWithSessionID:(id)arg1;	// IMP=0x0000000000845a64
