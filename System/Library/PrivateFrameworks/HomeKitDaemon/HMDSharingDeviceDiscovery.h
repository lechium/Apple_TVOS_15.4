...
- (void).cxx_destruct;	// IMP=0x000000000053f947
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000053f85e
- (void)stop;	// IMP=0x000000000053f804
- (void)start;	// IMP=0x000000000053f7c0
...
- (void)dealloc;	// IMP=0x000000000053f2f1
