...
- (void).cxx_destruct;	// IMP=0x0000000000aff902
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)_handleFetchSleepWakeStateMessage:(id)arg1;	// IMP=0x0000000000aff42c
- (void)fetchSleepWakeStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000afef3f
- (void)configureWithHome:(id)arg1 messageDispatcher:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000afecfe
- (id)initWithAccessoryUUID:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000afec42
