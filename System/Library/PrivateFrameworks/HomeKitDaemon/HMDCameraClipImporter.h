...
+ (id)logCategory;	// IMP=0x00000000009295a8
- (void).cxx_destruct;	// IMP=0x000000000092887a
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x0000000000927c3e
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000927ae4
