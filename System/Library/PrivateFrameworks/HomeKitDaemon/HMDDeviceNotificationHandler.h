...
+ (id)logCategory;	// IMP=0x00000000001b4ccc
- (void).cxx_destruct;	// IMP=0x00000000001b3e9c
...
- (id)logIdentifier;	// IMP=0x00000000001b3cb8
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000001b3b01
- (id)timerWithType:(unsigned char)arg1;	// IMP=0x00000000001b39e9
- (void)_dispatchNotificationUpdate:(id)arg1;	// IMP=0x00000000001b2ecb
- (void)_dispatchNotification;	// IMP=0x00000000001b2c84
- (void)_beginCoalesce:(_Bool)arg1;	// IMP=0x00000000001b2947
- (void)sendNotificationForMediaProperties:(id)arg1 withRequestIdentifier:(id)arg2 notificationUpdateIdentifier:(id)arg3;	// IMP=0x00000000001b25c6
- (id)_notificationUpdateWithRequestID:(id)arg1 allowAdd:(_Bool)arg2;	// IMP=0x00000000001b23a0
- (void)sendNotificationForCharacteristicUpdates:(id)arg1 withRequestIdentifier:(id)arg2 notificationUpdateIdentifier:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000001b1bfe
- (id)initWithDestination:(id)arg1 watchDevice:(_Bool)arg2 withRequestIdentifier:(id)arg3 messageDispatcher:(id)arg4 home:(id)arg5 dataSource:(id)arg6;	// IMP=0x00000000001b1a9c
- (id)initWithDestination:(id)arg1 watchDevice:(_Bool)arg2 withRequestIdentifier:(id)arg3 messageDispatcher:(id)arg4 home:(id)arg5;	// IMP=0x00000000001b1a81
