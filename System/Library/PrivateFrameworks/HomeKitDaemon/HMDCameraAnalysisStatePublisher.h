...
+ (id)logCategory;	// IMP=0x00000000002c1a90
- (void).cxx_destruct;	// IMP=0x00000000002c1799
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000002c1659
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)stateManager:(id)arg1 didReceiveLocalUpdate:(id)arg2;	// IMP=0x00000000002c1490
- (void)_handleRemoteAnalysisStateUpdate:(id)arg1;	// IMP=0x00000000002c1215
- (void)_publishAnalysisStateUpdate;	// IMP=0x00000000002c0ee2
- (void)_processStateUpdate:(id)arg1;	// IMP=0x00000000002c0d78
- (void)configureWithHome:(id)arg1;	// IMP=0x00000000002c0b53
- (id)initWithHomeMessagingContext:(id)arg1 analysisStateManager:(id)arg2 workQueue:(id)arg3 cameraAnalysisStatePublisherDebounceTimer:(id)arg4;	// IMP=0x00000000002c0a6b
- (id)initWithHome:(id)arg1;	// IMP=0x00000000002c096b
