...
+ (id)logCategory;	// IMP=0x0000000000a84492
- (void).cxx_destruct;	// IMP=0x0000000000a84463
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000a8419e
- (id)logIdentifier;	// IMP=0x0000000000a840c9
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000a84031
