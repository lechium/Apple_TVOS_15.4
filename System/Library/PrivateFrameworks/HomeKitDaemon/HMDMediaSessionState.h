...
- (void).cxx_destruct;	// IMP=0x0000000000688041
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x0000000000687e14
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006879b8
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x0000000000687488
