...
+ (id)logCategory;	// IMP=0x000000000008019a
- (void).cxx_destruct;	// IMP=0x0000000000080125
...
- (id)logIdentifier;	// IMP=0x000000000008002f
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x000000000007fe5a
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x000000000007fcc5
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x000000000007fb97
