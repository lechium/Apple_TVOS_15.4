...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004cc1d0
+ (id)configurationForFirewallConfiguration:(id)arg1 hapAccessory:(_Bool)arg2 airplayAccessory:(_Bool)arg3 withClientIdentifier:(id)arg4;	// IMP=0x0000000000450c2c
+ (id)configurationForOpenProtectionWithClientIdentifier:(id)arg1;	// IMP=0x0000000000450b76
+ (id)configurationWithClientIdentifier:(id)arg1 lanIdentifier:(long long)arg2;	// IMP=0x0000000000450a63
- (void).cxx_destruct;	// IMP=0x00000000004bc52f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004bbee5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004bbdd6
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004bb84c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004bb22d
- (id)initWithClientIdentifier:(id)arg1 lanIdentifier:(id)arg2 credential:(id)arg3 wanFirewallConfiguration:(id)arg4 lanFirewallConfiguration:(id)arg5;	// IMP=0x00000000004bb12b
- (id)init;	// IMP=0x00000000004bb0fc
