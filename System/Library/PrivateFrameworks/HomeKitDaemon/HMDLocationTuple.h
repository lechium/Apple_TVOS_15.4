...
- (void).cxx_destruct;	// IMP=0x00000000002e1d9a
...
- (id)attributeDescriptions;	// IMP=0x00000000002e1b1a
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x00000000002e1a58
