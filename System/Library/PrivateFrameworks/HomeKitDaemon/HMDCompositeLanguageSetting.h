...
- (void).cxx_destruct;	// IMP=0x0000000000297e0e
...
- (id)attributeDescriptions;	// IMP=0x0000000000297b9b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000297ae5
- (_Bool)isEqualValue:(id)arg1;	// IMP=0x0000000000297896
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4 readVersion:(id)arg5 writeVersion:(id)arg6;	// IMP=0x0000000000297798
