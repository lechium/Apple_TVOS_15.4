...
- (void).cxx_destruct;	// IMP=0x00000000002f76b1
...
- (unsigned long long)hash;	// IMP=0x00000000002f763b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002f7570
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x00000000002f7470
