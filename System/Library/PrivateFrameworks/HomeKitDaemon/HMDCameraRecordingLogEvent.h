...
- (void).cxx_destruct;	// IMP=0x000000000053ef14
...
- (id)attributeDescriptions;	// IMP=0x000000000053ec4f
...
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x000000000053ea66
