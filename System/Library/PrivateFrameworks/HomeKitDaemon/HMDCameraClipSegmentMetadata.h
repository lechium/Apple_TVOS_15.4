...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008e6acf
- (unsigned long long)hash;	// IMP=0x00000000008e6805
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008e667d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008e6577
- (void)copyTo:(id)arg1;	// IMP=0x00000000008e6494
- (void)writeTo:(id)arg1;	// IMP=0x00000000008e6382
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008e6375
- (id)dictionaryRepresentation;	// IMP=0x00000000008e6095
- (id)description;	// IMP=0x00000000008e5fe6
@property(nonatomic) _Bool hasHeight;
@property(nonatomic) _Bool hasWidth;
- (int)StringAsType:(id)arg1;	// IMP=0x00000000008e5ebe
- (id)typeAsString:(int)arg1;	// IMP=0x00000000008e5e58
