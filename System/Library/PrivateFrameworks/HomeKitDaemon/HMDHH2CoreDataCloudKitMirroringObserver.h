...
+ (id)logCategory;	// IMP=0x000000000078ea92
- (void).cxx_destruct;	// IMP=0x000000000078e17c
...
- (void)coreData:(id)arg1 persistentStoreWithIdentifierDidChange:(id)arg2;	// IMP=0x000000000078de19
- (_Bool)verifyModelsPushedToCloudKitUsingCoreDataExportStream;	// IMP=0x000000000078d758
- (void)processExportResult:(id)arg1 withError:(id)arg2;	// IMP=0x000000000078d0f9
- (void)verifyModelsPushedToCloudKit;	// IMP=0x000000000078ce88
- (void)callClientsCompletionHandler:(id)arg1;	// IMP=0x000000000078ce14
- (void)stopMonitoring;	// IMP=0x000000000078cd96
- (void)startMonitoring:(CDUnknownBlockType)arg1;	// IMP=0x000000000078cca2
- (id)initWithObjectIds:(id)arg1 coreData:(id)arg2 storeIdentifier:(id)arg3;	// IMP=0x000000000078cb10
