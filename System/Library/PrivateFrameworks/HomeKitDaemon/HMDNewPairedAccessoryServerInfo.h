...
- (void).cxx_destruct;	// IMP=0x00000000008f38f5
...
- (id)initWithServer:(id)arg1 primaryAccessoryUUID:(id)arg2 certificationStatus:(long long)arg3 configurationAppIdentifier:(id)arg4 hostAccessory:(id)arg5 networkCredential:(id)arg6 pairingEvent:(id)arg7;	// IMP=0x00000000008f3741
