...
+ (Class)backingModelClass;	// IMP=0x00000000004fe5bb
+ (id)backingModelProtocol;	// IMP=0x00000000004fe5aa
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00000000004fe591
+ (Class)cd_modelClass;	// IMP=0x00000000003a5360
+ (id)fetchRequest;	// IMP=0x0000000000b5795e
- (id)findSettingsRelationWithModelID:(id)arg1;	// IMP=0x00000000004fe56e
- (id)materializeOrCreateSettingsRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x00000000004fe548
- (id)castIfAppleMediaAccessory;	// IMP=0x00000000004fe53f
