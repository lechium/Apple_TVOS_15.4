...
+ (Class)backingModelClass;	// IMP=0x00000000002c6122
+ (id)backingModelProtocol;	// IMP=0x00000000002c6111
+ (id)fetchRequest;	// IMP=0x0000000000b57dbe
- (id)castIfIncomingInvitation;	// IMP=0x00000000002c6108
