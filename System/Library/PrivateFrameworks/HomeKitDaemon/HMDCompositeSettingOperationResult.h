...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x000000000029930b
- (void).cxx_destruct;	// IMP=0x00000000002992b8
...
- (id)attributeDescriptions;	// IMP=0x0000000000299098
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x0000000000298fac
