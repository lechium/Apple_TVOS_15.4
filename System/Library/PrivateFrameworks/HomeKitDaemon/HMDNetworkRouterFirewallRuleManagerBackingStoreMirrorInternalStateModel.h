...
+ (id)hmbProperties;	// IMP=0x00000000009a17c4
+ (id)parentModelID;	// IMP=0x00000000009a1794
+ (id)modelID;	// IMP=0x00000000009a1764
+ (id)logCategory;	// IMP=0x00000000009a1734
- (void).cxx_destruct;	// IMP=0x00000000009a1f26
...
- (id)init;	// IMP=0x00000000009a1968
