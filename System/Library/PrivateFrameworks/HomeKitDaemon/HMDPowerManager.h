...
- (void).cxx_destruct;	// IMP=0x000000000042499f
...
- (void)_ensureNetworkInterfaceMonitorStopped;	// IMP=0x00000000004248e7
- (int)_ensureNetworkInterfaceMonitorStarted;	// IMP=0x0000000000424679
- (void)_update;	// IMP=0x00000000004244d4
- (void)stop;	// IMP=0x0000000000424482
- (void)start;	// IMP=0x0000000000424430
- (void)dealloc;	// IMP=0x00000000004243ac
- (id)init;	// IMP=0x000000000042434d
