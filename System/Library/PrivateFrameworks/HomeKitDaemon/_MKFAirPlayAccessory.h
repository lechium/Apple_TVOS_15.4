...
+ (Class)backingModelClass;	// IMP=0x0000000000396da0
+ (id)backingModelProtocol;	// IMP=0x0000000000396d8f
+ (id)homeRelation;	// IMP=0x0000000000396d5f
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0000000000396ca9
+ (Class)cd_modelClass;	// IMP=0x00000000005b6c2d
+ (id)fetchRequest;	// IMP=0x0000000000b5791e
- (id)castIfAirPlayAccessory;	// IMP=0x0000000000396ca0
