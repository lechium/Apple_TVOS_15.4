...
+ (id)logCategory;	// IMP=0x0000000000a7ae1a
- (void).cxx_destruct;	// IMP=0x0000000000a7ab1a
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000a7a894
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000a7a714
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000a7a07a
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000a79f30
- (void)dealloc;	// IMP=0x0000000000a79dc3
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000a796a1
- (void)_startDataReceive;	// IMP=0x0000000000a794fb
- (id)logIdentifier;	// IMP=0x0000000000a794ab
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000a7929c
