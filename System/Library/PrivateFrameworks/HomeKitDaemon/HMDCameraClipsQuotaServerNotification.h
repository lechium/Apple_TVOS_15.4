...
- (void).cxx_destruct;	// IMP=0x00000000006930f9
...
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000692db6
- (id)initWithContainerIdentifier:(id)arg1 reason:(long long)arg2 requestID:(id)arg3 userDSID:(id)arg4;	// IMP=0x0000000000692c78
