...
- (void).cxx_destruct;	// IMP=0x0000000000459caf
...
- (id)description;	// IMP=0x0000000000459c21
- (void)dealloc;	// IMP=0x0000000000459b31
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3 home:(id)arg4;	// IMP=0x0000000000459933
