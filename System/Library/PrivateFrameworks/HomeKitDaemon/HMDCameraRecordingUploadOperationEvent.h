...
+ (int)awdOperationEnumFromCameraClipOperationType:(unsigned long long)arg1;	// IMP=0x0000000000841ab9
- (void).cxx_destruct;	// IMP=0x00000000009300e4
...
- (id)attributeDescriptions;	// IMP=0x000000000092fc84
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x000000000092fbd1
- (id)metricForAWD;	// IMP=0x000000000083aa5b
- (unsigned int)AWDMessageType;	// IMP=0x000000000083aa50
