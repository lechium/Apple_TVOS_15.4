...
+ (id)logCategory;	// IMP=0x0000000000ac3fb8
- (void).cxx_destruct;	// IMP=0x0000000000ac33cb
...
- (id)dumpState;	// IMP=0x0000000000ac3304
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ac32ad
- (void)requestDataSync;	// IMP=0x0000000000ac3259
@property(readonly, nonatomic) NSString *homeIdentifier;
@property(readonly, copy) NSString *description;
- (id)logIdentifier;	// IMP=0x0000000000ac3008
- (void)dealloc;	// IMP=0x0000000000ac2f23
- (id)initWithHome:(id)arg1 delegate:(id)arg2 workQueue:(id)arg3 messagePayload:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x0000000000ac2dc3
