...
+ (id)logCategory;	// IMP=0x0000000000b52bfe
- (void).cxx_destruct;	// IMP=0x0000000000b529b6
...
- (void)handleServicesUpdated:(id)arg1;	// IMP=0x0000000000b52880
- (void)handleCharacteristicsUpdated:(id)arg1;	// IMP=0x0000000000b5280f
- (void)_notifyDelegate;	// IMP=0x0000000000b52639
- (id)_accessoryCharacteristicsToObserve;	// IMP=0x0000000000b52271
- (void)_registerForNotifications;	// IMP=0x0000000000b52189
- (void)start;	// IMP=0x0000000000b52129
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 interestedCharacteristicTypesByServiceType:(id)arg3;	// IMP=0x0000000000b51f47
