...
+ (id)createWithProductData:(id)arg1 firmwareVersion:(id)arg2;	// IMP=0x000000000041fa7e
+ (id)identifierFromRecordID:(id)arg1;	// IMP=0x0000000000a9200a
- (void).cxx_destruct;	// IMP=0x000000000041fa3c
...
- (id)attributeDescriptions;	// IMP=0x000000000041f893
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000041f888
- (unsigned long long)hash;	// IMP=0x000000000041f79d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000041f5ba
- (id)initWithProductGroup:(id)arg1 productNumber:(id)arg2 firmwareVersion:(id)arg3;	// IMP=0x000000000041f4ab
- (id)cloudKitRecordID;	// IMP=0x0000000000a91f41
