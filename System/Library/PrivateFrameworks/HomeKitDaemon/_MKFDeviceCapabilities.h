...
+ (Class)backingModelClass;	// IMP=0x0000000000af818e
+ (id)backingModelProtocol;	// IMP=0x0000000000af817d
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0000000000af8117
+ (Class)cd_modelClass;	// IMP=0x000000000031a131
+ (id)fetchRequest;	// IMP=0x0000000000b57b9e
- (id)castIfDeviceCapabilities;	// IMP=0x0000000000af810e
