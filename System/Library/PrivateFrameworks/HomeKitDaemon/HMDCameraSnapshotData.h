...
- (void).cxx_destruct;	// IMP=0x00000000006bc1bd
...
- (void)dealloc;	// IMP=0x00000000006bc131
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x00000000006bc043
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x00000000006bbf7d
