...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000904bd
- (void).cxx_destruct;	// IMP=0x00000000000902c7
...
- (id)describeWithFormat;	// IMP=0x000000000008ffd2
- (void)_resolve:(_Bool)arg1;	// IMP=0x000000000008fdcf
- (void)_clearTimer;	// IMP=0x000000000008fd1c
- (void)_configureTimer;	// IMP=0x000000000008fbd0
- (void)expire;	// IMP=0x000000000008f9de
- (void)decline;	// IMP=0x000000000008f9ca
- (void)accept;	// IMP=0x000000000008f9b3
- (void)updateTimer:(unsigned long long)arg1 clientQueue:(id)arg2;	// IMP=0x000000000008f88e
- (void)updateInvitationState:(long long)arg1;	// IMP=0x000000000008f842
- (void)notifyStateChangedForMessage:(id)arg1;	// IMP=0x000000000008f83c
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000008f5d6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008f4cf
- (id)initWithCoder:(id)arg1 invitationData:(id)arg2;	// IMP=0x000000000008f3c5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008f3b1
- (_Bool)refreshDisplayName;	// IMP=0x000000000008f3a9
- (id)initWithInvitationData:(id)arg1 forHome:(id)arg2;	// IMP=0x000000000008f2f7
