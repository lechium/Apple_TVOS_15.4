...
- (void).cxx_destruct;	// IMP=0x0000000000a6ba34
...
- (id)attributeDescriptions;	// IMP=0x0000000000a6b73e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a6b6bb
- (unsigned long long)hash;	// IMP=0x0000000000a6b677
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000a6aff5
- (long long)compare:(id)arg1;	// IMP=0x0000000000a6afe1
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000a6ab39
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000a6a945
