...
- (void).cxx_destruct;	// IMP=0x000000000031b066
@property __weak id <HMDAccessorySettingsBackingStoreTransactionReceiverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)transactionObjectRemoved:(id)arg1 message:(id)arg2;	// IMP=0x000000000031acd1
- (void)transactionObjectUpdated:(id)arg1 newValues:(id)arg2 message:(id)arg3;	// IMP=0x000000000031a969
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000031a902
