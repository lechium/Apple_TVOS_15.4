...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000030f68d
- (unsigned long long)hash;	// IMP=0x000000000030f612
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030f51b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000030f46c
- (void)copyTo:(id)arg1;	// IMP=0x000000000030f3e0
- (void)writeTo:(id)arg1;	// IMP=0x000000000030f331
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000030f324
- (id)dictionaryRepresentation;	// IMP=0x000000000030f17f
- (id)description;	// IMP=0x000000000030f0d0
