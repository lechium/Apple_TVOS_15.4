...
- (void).cxx_destruct;	// IMP=0x00000000001e5c42
...
- (id)mainReturningError;	// IMP=0x00000000001e5927
- (id)initWithGroup:(id)arg1 name:(id)arg2 model:(id)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000001e58fb
- (id)initWithGroup:(id)arg1 record:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e5760
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 resultBlock:(CDUnknownBlockType)arg5;	// IMP=0x00000000001e5734
- (id)initWithGroup:(id)arg1 name:(id)arg2 record:(id)arg3 data:(id)arg4 encoding:(unsigned long long)arg5 model:(id)arg6 resultBlock:(CDUnknownBlockType)arg7;	// IMP=0x00000000001e55dd
