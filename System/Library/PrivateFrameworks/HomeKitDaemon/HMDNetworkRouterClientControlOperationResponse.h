...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004ce384
- (void).cxx_destruct;	// IMP=0x00000000004ce35c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004ce06e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004cdfe0
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004cdd10
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004cd911
- (id)initWithStatus:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000004cd878
- (id)init;	// IMP=0x00000000004cd849
