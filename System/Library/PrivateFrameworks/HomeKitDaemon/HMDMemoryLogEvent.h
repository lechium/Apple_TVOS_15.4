...
+ (id)memoryLogEventWithReason:(id)arg1 memoryUsage:(unsigned long long)arg2 maxMemoryUsage:(unsigned long long)arg3;	// IMP=0x00000000009dff65
- (void).cxx_destruct;	// IMP=0x00000000009dff52
...
- (id)__initWithReason:(id)arg1 memoryUsage:(unsigned long long)arg2 maxMemoryUsage:(unsigned long long)arg3;	// IMP=0x00000000009dfcf1
- (id)init;	// IMP=0x00000000009dfc49
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b3b46f
