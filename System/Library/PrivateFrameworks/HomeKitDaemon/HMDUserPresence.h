...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000078bc39
- (void).cxx_destruct;	// IMP=0x000000000078bbf7
...
- (id)attributeDescriptions;	// IMP=0x000000000078b90b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000078b82f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000078b715
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000078b52c
@property(readonly, nonatomic, getter=isNotAtHome) _Bool notAtHome;
@property(readonly, nonatomic, getter=isAtHome) _Bool atHome;
- (id)initWithUser:(id)arg1 presenceRegionStatus:(id)arg2 timeStamp:(id)arg3;	// IMP=0x000000000078b225
- (id)initWithUser:(id)arg1 presenceRegionStatus:(id)arg2;	// IMP=0x000000000078b189
