...
- (void).cxx_destruct;	// IMP=0x00000000003b873b
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003b86bd
- (void)_stopScan;	// IMP=0x00000000003b863e
- (void)_checkCanScan;	// IMP=0x00000000003b8202
- (void)_stopTimer;	// IMP=0x00000000003b81c8
- (void)_flushQueue;	// IMP=0x00000000003b8144
- (id)init;	// IMP=0x00000000003b802b
- (void)didUpdateBTLEState:(long long)arg1;	// IMP=0x00000000003b7fcc
