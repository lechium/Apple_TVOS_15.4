...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x000000000080a6d1
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x000000000080a4d5
- (void).cxx_destruct;	// IMP=0x000000000080a4ad
...
- (id)description;	// IMP=0x000000000080a33a
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x000000000080a18d
