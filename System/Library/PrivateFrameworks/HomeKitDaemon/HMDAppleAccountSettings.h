...
+ (_Bool)supportsCloudSettings;	// IMP=0x00000000006e3264
+ (id)sharedSettings;	// IMP=0x00000000006e3234
+ (id)logCategory;	// IMP=0x0000000000184b55
- (void)updateHomeEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006e31c6
- (void)synchronize;	// IMP=0x00000000006e31c0
...
- (id)attributeDescriptions;	// IMP=0x000000000018496a
