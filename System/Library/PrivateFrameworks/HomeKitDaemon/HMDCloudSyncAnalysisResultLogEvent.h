...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x0000000000872058
- (void).cxx_destruct;	// IMP=0x000000000087398a
...
- (id)metricForAWD;	// IMP=0x000000000087206b
- (unsigned int)AWDMessageType;	// IMP=0x0000000000872060
