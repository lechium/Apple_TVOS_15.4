...
@interface HMDConfigurationLogEvent : HMMLogEvent <HMDAWDLogEvent>
{
    ...
    unsigned int _databaseSize;	// 12 = 0xc
    unsigned int _metadataVersion;	// 16 = 0x10
    ...
    NSDictionary *_histogrammedCommonDimensions;	// 288 = 0x120
}

+ (void)initialize;	// IMP=0x000000000025b949
- (void).cxx_destruct;	// IMP=0x000000000025b918
@property(readonly, nonatomic) NSDictionary *histogrammedCommonDimensions; // @synthesize histogrammedCommonDimensions=_histogrammedCommonDimensions;
...
- (_Bool)isSubmitted;	// IMP=0x000000000025b67e
...
- (id)createHistogrammedCommonDimensions;	// IMP=0x000000000025a7d8
- (id)initWithHomeConfigurations:(id)arg1;	// IMP=0x0000000000259ea0
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x0000000000259c35
- (int)convertToAWDNetworkProtectionStatus:(int)arg1;	// IMP=0x0000000000839f40
- (int)convertToAWDMultiUserValueType:(int)arg1;	// IMP=0x0000000000839f20
- (id)convertToAWDMultiUserSettings:(id)arg1;	// IMP=0x0000000000839b65
- (id)convertToAWDMultiUserSettingsList:(id)arg1;	// IMP=0x0000000000839983
- (id)getHomeConfiguration:(id)arg1;	// IMP=0x0000000000838d3f
- (id)generateAWDHomeConfiguration:(id)arg1;	// IMP=0x0000000000838b5d
- (id)metricForAWD;	// IMP=0x0000000000838858
- (unsigned int)AWDMessageType;	// IMP=0x000000000083884d
