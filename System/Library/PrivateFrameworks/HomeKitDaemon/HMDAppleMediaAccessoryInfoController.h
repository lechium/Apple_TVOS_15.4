...
- (void).cxx_destruct;	// IMP=0x000000000059dcff
...
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x000000000059db06
- (id)currentWifiNetworkInfo;	// IMP=0x000000000059da37
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x000000000059d80e
- (void)configure;	// IMP=0x000000000059d709
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 notificationCenter:(id)arg3 wifiManager:(id)arg4;	// IMP=0x000000000059d62c
