...
+ (Class)backingModelClass;	// IMP=0x000000000048b631
+ (id)backingModelProtocol;	// IMP=0x000000000048b620
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x000000000048b56a
+ (id)fetchRequest;	// IMP=0x0000000000b57a9e
- (id)castIfCameraSignificantEventBulletinRegistration;	// IMP=0x000000000048b561
