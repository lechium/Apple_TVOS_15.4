...
+ (id)logCategory;	// IMP=0x000000000069dc73
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x000000000069dc6b
- (void).cxx_destruct;	// IMP=0x0000000000699710
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000699251
- (void)handleCameraSettingsDidUpdateNotification:(id)arg1;	// IMP=0x00000000006991a3
- (void)handleCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000006990f5
- (void)handleBulletinBoardNotificationDidUpdateNotification:(id)arg1;	// IMP=0x0000000000699047
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x0000000000698ef5
- (void)dealloc;	// IMP=0x0000000000698d35
- (void)registerForMessages;	// IMP=0x0000000000698b1e
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000006985e0
