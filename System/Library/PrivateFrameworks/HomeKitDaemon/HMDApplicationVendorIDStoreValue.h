...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000061518b
- (void).cxx_destruct;	// IMP=0x0000000000615149
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000614ffe
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000614e82
- (id)description;	// IMP=0x0000000000614d8e
- (id)initWithVendorIDSha1:(id)arg1 applicationBundleId:(id)arg2 companionAppBundleId:(id)arg3 spiClient:(_Bool)arg4;	// IMP=0x0000000000614c82
