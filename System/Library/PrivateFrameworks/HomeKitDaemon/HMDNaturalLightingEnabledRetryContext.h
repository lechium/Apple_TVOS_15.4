...
- (void).cxx_destruct;	// IMP=0x0000000000ac6cf9
...
- (id)attributeDescriptions;	// IMP=0x0000000000ac6b01
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ac6af6
- (id)initWithNaturalLightingEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 retryCount:(unsigned long long)arg3;	// IMP=0x0000000000ac6a60
