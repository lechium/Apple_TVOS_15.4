...
+ (id)logCategory;	// IMP=0x0000000000af348b
- (void).cxx_destruct;	// IMP=0x0000000000aef3c8
...
- (id)logIdentifier;	// IMP=0x0000000000aef291
- (void)__handleDeviceRemovedFromAccount:(id)arg1;	// IMP=0x0000000000aef1ff
- (void)__handleAccountRemovedFromRegistry:(id)arg1;	// IMP=0x0000000000aef16d
- (void)__handleRemovedIdentity:(id)arg1;	// IMP=0x0000000000aef0db
- (void)handleSecureMessage:(id)arg1 fromDevice:(id)arg2 fromTransport:(id)arg3;	// IMP=0x0000000000aeefe8
- (void)handleCompletedMessage:(id)arg1 options:(id)arg2 responsePayload:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000aeee9f
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000aeedd4
- (void)stop;	// IMP=0x0000000000aeed82
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000aeec2a
- (void)closedWithError:(id)arg1;	// IMP=0x0000000000aeeb98
- (void)_configureWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000aee485
- (void)startAndInvokeOnQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000aee3c7
@property(readonly, copy) NSDate *lastActivity; // @synthesize lastActivity=_lastActivity;
- (void)setIdle:(_Bool)arg1;	// IMP=0x0000000000aee0c2
...
- (void)setOpen:(_Bool)arg1;	// IMP=0x0000000000aedee4
@property(readonly, getter=isOpen) _Bool open; // @synthesize open=_open;
- (void)setMaximumRemoteStreams:(id)arg1;	// IMP=0x0000000000aedd24
...
- (void)dealloc;	// IMP=0x0000000000aed626
- (id)initWithCurrentDevice:(id)arg1 peerDevice:(id)arg2 clientMode:(_Bool)arg3 sessionID:(id)arg4;	// IMP=0x0000000000aed314
