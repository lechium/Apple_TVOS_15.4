...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x000000000009eed3
...
- (id)description;	// IMP=0x000000000009ecbf
- (unsigned long long)hash;	// IMP=0x000000000009ec7b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009ebea
