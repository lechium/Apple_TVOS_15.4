...
- (void).cxx_destruct;	// IMP=0x000000000030821a
...
- (id)initWithMessageName:(id)arg1 qualityOfService:(long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003080d9
