...
- (void).cxx_destruct;	// IMP=0x00000000005cf47c
...
- (void)setError:(id)arg1;	// IMP=0x00000000005cf363
- (id)metricForAWD;	// IMP=0x00000000005cf351
- (unsigned int)AWDMessageType;	// IMP=0x00000000005cf346
- (id)initWithSessionID:(id)arg1;	// IMP=0x00000000005cf25f
