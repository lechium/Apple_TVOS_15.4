...
- (void).cxx_destruct;	// IMP=0x00000000008fbba8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000008fb91c
- (unsigned long long)hash;	// IMP=0x00000000008fb786
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008fb511
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008fb346
- (void)copyTo:(id)arg1;	// IMP=0x00000000008fb1ad
- (void)writeTo:(id)arg1;	// IMP=0x00000000008faff4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000008fafe7
- (id)dictionaryRepresentation;	// IMP=0x00000000008fabe3
- (id)description;	// IMP=0x00000000008fab34
