...
+ (Class)resolutionCountType;	// IMP=0x0000000000428f29
+ (Class)reconfigurationsType;	// IMP=0x0000000000428f18
- (void).cxx_destruct;	// IMP=0x000000000042845d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000427ca9
- (unsigned long long)hash;	// IMP=0x00000000004279bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000427509
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000426efe
- (void)copyTo:(id)arg1;	// IMP=0x0000000000426b2c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000426699
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000042668c
- (id)dictionaryRepresentation;	// IMP=0x0000000000425b8d
- (id)description;	// IMP=0x0000000000425ade
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000425ac1
- (unsigned long long)resolutionCountsCount;	// IMP=0x0000000000425aa4
- (void)addResolutionCount:(id)arg1;	// IMP=0x0000000000425a3a
- (void)clearResolutionCounts;	// IMP=0x0000000000425a1d
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x000000000042587c
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x00000000004257a2
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000425553
- (unsigned long long)reconfigurationsCount;	// IMP=0x0000000000425536
- (void)addReconfigurations:(id)arg1;	// IMP=0x00000000004254cc
- (void)clearReconfigurations;	// IMP=0x00000000004254af
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000004252c8
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000425262
