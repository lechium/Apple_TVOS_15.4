...
- (void).cxx_destruct;	// IMP=0x00000000007dbede
...
- (id)description;	// IMP=0x00000000007dbda6
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x00000000007dbcf5
