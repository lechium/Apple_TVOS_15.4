...
- (void).cxx_destruct;	// IMP=0x000000000023f2f3
@property(readonly, copy) NSString *reason; // @synthesize reason=_reason;
- (id)description;	// IMP=0x000000000023f2c7
- (id)initWithReason:(id)arg1;	// IMP=0x000000000023f16c
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b3b4b1
