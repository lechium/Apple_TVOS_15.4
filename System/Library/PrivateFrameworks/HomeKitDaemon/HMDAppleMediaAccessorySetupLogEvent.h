...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x000000000062890f
- (void).cxx_destruct;	// IMP=0x000000000039ff9e
...
- (id)initWithRole:(long long)arg1 setupStartTime:(id)arg2 setupEndTime:(id)arg3 configurationEndTime:(id)arg4 setupSessionError:(id)arg5 category:(id)arg6 retryCount:(unsigned long long)arg7 firstSettingTime:(id)arg8 languageSettingTime:(id)arg9;	// IMP=0x000000000039fccb
