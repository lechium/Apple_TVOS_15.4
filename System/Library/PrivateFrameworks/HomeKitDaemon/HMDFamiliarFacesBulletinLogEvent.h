...
- (void).cxx_destruct;	// IMP=0x0000000000079f22
...
- (id)initWithNumberOfKnownPersons:(long long)arg1 numberOfUnknownPersons:(long long)arg2 bulletinReason:(id)arg3 doorbellPressed:(_Bool)arg4 secondsFromDoorbellToFaceClassification:(double)arg5;	// IMP=0x0000000000079e00
