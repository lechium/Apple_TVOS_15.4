...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000d20b
- (void).cxx_destruct;	// IMP=0x000000000000d1c2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000d0a8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ceeb
@property(readonly, copy) NSString *name;
@property(readonly, copy) id value;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 type:(id)arg3 numberValue:(id)arg4 dataValue:(id)arg5;	// IMP=0x000000000000cc13
