...
+ (id)logCategory;	// IMP=0x000000000078b122
- (void).cxx_destruct;	// IMP=0x000000000078b06b
...
- (void)_sendConfirmationToResident:(CDUnknownBlockType)arg1;	// IMP=0x000000000078adbd
- (id)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(CDUnknownBlockType)arg2;	// IMP=0x000000000078aa03
- (id)_sendMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000078a856
- (id)logIdentifier;	// IMP=0x000000000078a806
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 options:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6 snapshotRequestHandler:(id)arg7 residentMessageHandler:(id)arg8;	// IMP=0x000000000078a673
