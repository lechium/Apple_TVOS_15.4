...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000735da1
- (void).cxx_destruct;	// IMP=0x000000000073478d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000073449f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000734411
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000733fb9
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000733bde
- (id)initWithVersion:(id)arg1 supportedWoLPacketConfigurations:(id)arg2;	// IMP=0x0000000000733b33
- (id)init;	// IMP=0x0000000000733b04
