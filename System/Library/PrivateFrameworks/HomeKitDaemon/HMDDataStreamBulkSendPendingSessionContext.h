...
- (void).cxx_destruct;	// IMP=0x000000000079809f
...
- (id)initWithSessionStartCallback:(CDUnknownBlockType)arg1 handleOpenRequestResponseTimer:(id)arg2 sendCloseEventTimer:(id)arg3;	// IMP=0x0000000000797f1b
