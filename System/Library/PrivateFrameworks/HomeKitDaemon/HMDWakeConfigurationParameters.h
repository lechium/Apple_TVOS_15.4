...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000b0497d
- (void).cxx_destruct;	// IMP=0x0000000000b0494a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b0454e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b04496
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000b03ee8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000b039dd
- (id)initWithDelimiter:(id)arg1 primaryIdentifier:(id)arg2 secondaryIdentifier:(id)arg3;	// IMP=0x0000000000b03913
- (id)init;	// IMP=0x0000000000b038e4
