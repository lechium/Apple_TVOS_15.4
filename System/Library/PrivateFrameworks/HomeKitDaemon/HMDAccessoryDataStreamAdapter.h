...
+ (id)logCategory;	// IMP=0x00000000002a034e
- (void).cxx_destruct;	// IMP=0x000000000029f8b5
...
- (id)logIdentifier;	// IMP=0x000000000029f713
- (void)accessoryDidCloseDataStream:(id)arg1;	// IMP=0x000000000029f662
- (void)accessoryDidStartListening:(id)arg1;	// IMP=0x000000000029f5b1
- (void)accessory:(id)arg1 didReceiveBulkSessionCandidate:(id)arg2;	// IMP=0x000000000029f597
- (void)_bulkSendDidComplete;	// IMP=0x000000000029f4fc
- (void)_bulkSendDidFail;	// IMP=0x000000000029f461
- (_Bool)_handleFrame:(id)arg1;	// IMP=0x000000000029f3c1
@property(readonly, getter=isSessionOpenInProgress) _Bool sessionOpenInProgress;
- (void)_handleAccessoryDidClose;	// IMP=0x000000000029f23c
- (void)_callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000029f043
- (void)callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000029ef67
- (void)_openSession;	// IMP=0x000000000029edce
- (void)_setUpTransport;	// IMP=0x000000000029ec7a
- (void)readData;	// IMP=0x000000000029eabc
- (void)setUpWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000029e920
@property(readonly, getter=isBulkSendActive) _Bool bulkSendActive;
- (void)dealloc;	// IMP=0x000000000029e7a1
- (void)shutDown;	// IMP=0x000000000029e618
- (id)attributeDescriptions;	// IMP=0x000000000029e435
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 fileType:(id)arg3 metadata:(id)arg4 reason:(id)arg5;	// IMP=0x000000000029e320
