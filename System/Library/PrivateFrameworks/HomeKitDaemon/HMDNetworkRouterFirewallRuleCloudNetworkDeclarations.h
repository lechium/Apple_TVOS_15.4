...
+ (id)__decodeRuleConfigurationWithVersionString:(id)arg1 ruleConfigurationValue:(id)arg2 baseAccessoryIdentifier:(id)arg3;	// IMP=0x00000000009a3bb3
+ (id)__decodeRuleConfigurationsFromJSONDictionary:(id)arg1 baseAccessoryIdentifier:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x00000000009a354a
+ (id)logCategory;	// IMP=0x00000000009a351a
- (void).cxx_destruct;	// IMP=0x00000000009a34c7
...
- (id)attributeDescriptions;	// IMP=0x00000000009a2f46
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x00000000009a2bd0
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2;	// IMP=0x00000000009a2bbb
- (id)initWithBaseAccessoryIdentifier:(id)arg1 name:(id)arg2 lastModifiedTime:(id)arg3 ruleConfigurations:(id)arg4;	// IMP=0x00000000009a2ab4
