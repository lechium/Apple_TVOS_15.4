...
- (void).cxx_destruct;	// IMP=0x0000000000b546e8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000b54577
- (unsigned long long)hash;	// IMP=0x0000000000b54491
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b5431c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b54201
- (void)copyTo:(id)arg1;	// IMP=0x0000000000b5411e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b54031
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b54024
- (id)dictionaryRepresentation;	// IMP=0x0000000000b53e31
- (id)description;	// IMP=0x0000000000b53d82
