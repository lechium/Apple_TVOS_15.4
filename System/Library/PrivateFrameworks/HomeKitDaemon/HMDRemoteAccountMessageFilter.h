...
+ (id)logCategory;	// IMP=0x00000000005cecf4
- (void).cxx_destruct;	// IMP=0x00000000005ceca1
...
- (id)logIdentifier;	// IMP=0x00000000005cebb2
- (_Bool)acceptMessage:(id)arg1 target:(id)arg2 errorReason:(id *)arg3;	// IMP=0x00000000005cdf62
- (id)initWithTarget:(id)arg1 whitelistedMessages:(id)arg2 appleAccountManager:(id)arg3 systemKeychainStore:(id)arg4;	// IMP=0x00000000005cde35
- (id)initWithTarget:(id)arg1 whitelistedMessages:(id)arg2;	// IMP=0x00000000005cdd75
- (id)initWithTarget:(id)arg1;	// IMP=0x00000000005cdd61
- (id)initWithName:(id)arg1;	// IMP=0x00000000005cdcab
