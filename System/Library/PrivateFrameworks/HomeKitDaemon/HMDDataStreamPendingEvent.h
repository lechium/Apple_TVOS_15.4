...
- (void).cxx_destruct;	// IMP=0x00000000002f780f
...
- (id)initWithProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002f76fa
