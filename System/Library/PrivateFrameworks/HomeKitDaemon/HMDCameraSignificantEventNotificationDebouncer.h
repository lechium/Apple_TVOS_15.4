...
+ (id)logCategory;	// IMP=0x000000000089a453
- (void).cxx_destruct;	// IMP=0x000000000089a3c7
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000089a15a
- (void)trackCameraSignificantEvent:(id)arg1 shouldNotify:(_Bool *)arg2;	// IMP=0x0000000000899a30
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x000000000089988f
