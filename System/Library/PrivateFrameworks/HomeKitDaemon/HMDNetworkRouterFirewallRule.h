...
+ (id)__transportProtocolToString:(unsigned char)arg1;	// IMP=0x00000000005deb96
+ (id)logCategory;	// IMP=0x00000000005deb66
- (void).cxx_destruct;	// IMP=0x00000000005deb35
...
- (id)attributeDescriptions;	// IMP=0x00000000005de6d2
- (id)initWithJSONDictionary:(id)arg1 critical:(_Bool)arg2;	// IMP=0x00000000005de621
- (id)initWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3;	// IMP=0x00000000005de55f
