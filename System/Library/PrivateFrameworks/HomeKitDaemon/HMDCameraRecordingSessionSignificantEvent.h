...
- (void).cxx_destruct;	// IMP=0x000000000003e409
...
- (id)attributeDescriptions;	// IMP=0x000000000003dd8e
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003dbde
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003dbd3
- (unsigned long long)hash;	// IMP=0x000000000003db8f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003d81e
- (id)initWithUUID:(id)arg1;	// IMP=0x000000000003d6f8
