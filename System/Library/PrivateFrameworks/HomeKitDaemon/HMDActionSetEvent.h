...
- (void).cxx_destruct;	// IMP=0x00000000005b6a63
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x00000000005b64fd
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000022014
- (id)metricForAWD;	// IMP=0x0000000000840fcb
- (unsigned int)AWDMessageType;	// IMP=0x0000000000840fc0
