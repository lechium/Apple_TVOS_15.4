...
- (void).cxx_destruct;	// IMP=0x000000000086b7b3
...
- (id)initWithConfigureState:(long long)arg1 hasOwnerCloudShareID:(_Bool)arg2;	// IMP=0x000000000086b6ce
- (id)serializedEvent;	// IMP=0x0000000000624646
- (id)eventName;	// IMP=0x0000000000624639
