...
+ (id)logCategory;	// IMP=0x00000000009b9d47
- (void).cxx_destruct;	// IMP=0x00000000009b8406
...
- (id)encodedMostRecentSnapshotForMessage:(id)arg1;	// IMP=0x00000000009b7f7f
- (id)createSlotForSnapshotFile:(id)arg1 requestMessages:(id)arg2 shouldNotifyClients:(_Bool)arg3;	// IMP=0x00000000009b7e6a
- (void)handleReleaseSnapshot:(id)arg1;	// IMP=0x00000000009b79e9
- (void)handleFillSnapshotSlot:(id)arg1;	// IMP=0x00000000009b7697
- (void)backboardServicesRelaunched:(id)arg1;	// IMP=0x00000000009b763c
- (void)handleProcessStateChange:(id)arg1;	// IMP=0x00000000009b75a5
- (void)registerForMessages;	// IMP=0x00000000009b6ada
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 imageCacheDirectory:(id)arg3 logID:(id)arg4 uniqueIdentifier:(id)arg5 msgDispatcher:(id)arg6;	// IMP=0x00000000009b68fb
