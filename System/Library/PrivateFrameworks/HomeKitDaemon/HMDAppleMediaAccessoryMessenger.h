...
+ (id)logCategory;	// IMP=0x000000000048b4c4
- (void).cxx_destruct;	// IMP=0x000000000048b2f5
...
- (id)logIdentifier;	// IMP=0x000000000048b23b
- (void)routeSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x000000000048b0e2
- (void)sendDeleteSiriHistoryRequestForAccessoryWithUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000048ae5f
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x000000000048ac4c
- (id)initWithIdentifier:(id)arg1 messageDispatcher:(id)arg2 router:(id)arg3 localHandler:(id)arg4;	// IMP=0x000000000048aaf6
