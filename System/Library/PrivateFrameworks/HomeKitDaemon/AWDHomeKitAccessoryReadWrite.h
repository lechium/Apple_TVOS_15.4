...
+ (Class)characteristicsType;	// IMP=0x00000000001f7348
- (void).cxx_destruct;	// IMP=0x00000000001f6597
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001f5e90
- (unsigned long long)hash;	// IMP=0x00000000001f5ac5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f54e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f4fb2
- (void)copyTo:(id)arg1;	// IMP=0x00000000001f4c06
- (void)writeTo:(id)arg1;	// IMP=0x00000000001f47a5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001f4798
- (id)dictionaryRepresentation;	// IMP=0x00000000001f3c8c
- (id)description;	// IMP=0x00000000001f3bdd
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000001f3840
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000001f37da
@property(nonatomic) _Bool hasCertified;
@property(nonatomic) int certified; // @synthesize certified=_certified;
- (int)StringAsSource:(id)arg1;	// IMP=0x00000000001f3620
- (id)sourceAsString:(int)arg1;	// IMP=0x00000000001f3561
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000001f3334
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000001f3283
@property(nonatomic) _Bool hasTransportType;
@property(nonatomic) int transportType; // @synthesize transportType=_transportType;
- (id)characteristicsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001f31fc
- (unsigned long long)characteristicsCount;	// IMP=0x00000000001f31df
- (void)addCharacteristics:(id)arg1;	// IMP=0x00000000001f3175
- (void)clearCharacteristics;	// IMP=0x00000000001f3158
