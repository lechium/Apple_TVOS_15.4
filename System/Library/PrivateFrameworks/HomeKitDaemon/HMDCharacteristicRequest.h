...
+ (id)logCategory;	// IMP=0x0000000000b35fe1
+ (id)requestWithCharacteristic:(id)arg1;	// IMP=0x0000000000b35f98
- (void).cxx_destruct;	// IMP=0x0000000000b35f67
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b35dbc
- (id)attributeDescriptions;	// IMP=0x0000000000b35927
- (id)initWithCharacteristic:(id)arg1;	// IMP=0x0000000000b3588c
