...
- (void).cxx_destruct;	// IMP=0x0000000000ac15a1
...
- (id)description;	// IMP=0x0000000000ac14ff
- (void)dealloc;	// IMP=0x0000000000ac1388
- (id)initWithSessionID:(id)arg1;	// IMP=0x0000000000ac131a
