...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x0000000000614c71
+ (Class)hapServicesListCertifiedType;	// IMP=0x0000000000614c60
+ (Class)primaryHAPServicesListType;	// IMP=0x0000000000614c4f
+ (Class)hapServicesListType;	// IMP=0x0000000000614c3e
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x0000000000614c2d
+ (Class)eventTriggersType;	// IMP=0x0000000000614c1c
- (void).cxx_destruct;	// IMP=0x0000000000611647
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000060fb93
- (unsigned long long)hash;	// IMP=0x000000000060ed72
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000060da78
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000060c411
- (void)copyTo:(id)arg1;	// IMP=0x000000000060b12e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000609c2e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000609c21
- (id)dictionaryRepresentation;	// IMP=0x0000000000606df1
- (id)description;	// IMP=0x0000000000606d42
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x0000000000606815
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x00000000006067ae
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000605e72
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x0000000000605e55
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x0000000000605deb
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x0000000000605dce
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000605db1
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x0000000000605d94
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x0000000000605d2a
- (void)clearHapServicesListCertifieds;	// IMP=0x0000000000605d0d
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000605cf0
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x0000000000605cd3
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x0000000000605c69
- (void)clearPrimaryHAPServicesLists;	// IMP=0x0000000000605c4c
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000605c2f
- (unsigned long long)hapServicesListsCount;	// IMP=0x0000000000605c12
- (void)addHapServicesList:(id)arg1;	// IMP=0x0000000000605ba8
- (void)clearHapServicesLists;	// IMP=0x0000000000605b8b
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000605963
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x0000000000605946
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x00000000006058dc
- (void)clearHomeKitMultiUserSettings;	// IMP=0x00000000006058bf
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x000000000060556b
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x0000000000605505
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000604ea6
- (unsigned long long)eventTriggersCount;	// IMP=0x0000000000604e89
- (void)addEventTriggers:(id)arg1;	// IMP=0x0000000000604e1f
- (void)clearEventTriggers;	// IMP=0x0000000000604e02
