...
- (void).cxx_destruct;	// IMP=0x0000000000955665
...
- (void)markXPCMessageTransportStarted;	// IMP=0x00000000009551a5
- (id)init;	// IMP=0x0000000000955151
@property(readonly, copy) NSString *diagnosticReportEventSubType;
@property(readonly, copy) NSString *diagnosticReportEventType;
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b3b496
