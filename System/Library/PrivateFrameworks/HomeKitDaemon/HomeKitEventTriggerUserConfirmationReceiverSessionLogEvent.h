...
- (void).cxx_destruct;	// IMP=0x0000000000603260
...
- (id)metricForAWD;	// IMP=0x0000000000603100
- (unsigned int)AWDMessageType;	// IMP=0x00000000006030f5
- (id)initWithSessionID:(id)arg1;	// IMP=0x0000000000603018
