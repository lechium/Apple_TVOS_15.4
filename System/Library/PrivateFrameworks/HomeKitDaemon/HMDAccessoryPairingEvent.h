...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x00000000005138ef
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x0000000000513843
+ (id)pairingAccessory:(id)arg1 home:(id)arg2;	// IMP=0x00000000005137bd
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x000000000051374d
- (void).cxx_destruct;	// IMP=0x0000000000513683
...
- (void)submitAtDate:(id)arg1;	// IMP=0x000000000051216a
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000005120c6
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x0000000000512009
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x0000000000511d99
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x0000000000511d87
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x0000000000511d75
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x00000000005119c4
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 home:(id)arg4 isAddOperation:(_Bool)arg5;	// IMP=0x00000000005112fe
- (id)metricForAWD;	// IMP=0x000000000084128d
- (unsigned int)AWDMessageType;	// IMP=0x0000000000841282
