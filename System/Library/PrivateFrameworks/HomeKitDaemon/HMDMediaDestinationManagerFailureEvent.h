...
- (void).cxx_destruct;	// IMP=0x0000000000b47d7a
...
- (id)attributeDescriptions;	// IMP=0x0000000000b47b9c
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithFailureCode:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0000000000b47952
