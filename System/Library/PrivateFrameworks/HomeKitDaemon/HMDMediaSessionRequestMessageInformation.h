...
+ (id)logCategory;	// IMP=0x000000000064caf6
- (void).cxx_destruct;	// IMP=0x000000000064cae3
@property(readonly) HMFMessage *message; // @synthesize message=_message;
- (id)attributeDescriptions;	// IMP=0x000000000064c9a1
@property(readonly) HMDDevice *remoteSourceDevice;
@property(readonly, copy) NSUUID *messageIdentifier;
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000064c7df
