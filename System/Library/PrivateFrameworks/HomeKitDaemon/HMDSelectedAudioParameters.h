...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000076bce
- (void).cxx_destruct;	// IMP=0x0000000000076b7b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000076a1f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000076724
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000007650a
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000076240
- (id)tlvData;	// IMP=0x0000000000076077
- (id)initWithCodecGroup:(id)arg1 codecParameter:(id)arg2 rtpParameter:(id)arg3 comfortNoiseEnabled:(id)arg4;	// IMP=0x0000000000075f80
