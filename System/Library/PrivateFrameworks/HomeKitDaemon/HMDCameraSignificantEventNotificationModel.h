...
+ (id)significantEventsBetweenDatesQueryWithIsAscending:(_Bool)arg1;	// IMP=0x00000000002994fc
+ (id)hmbQueries;	// IMP=0x0000000000299431
+ (id)hmbExternalRecordType;	// IMP=0x0000000000299424
+ (id)hmbProperties;	// IMP=0x00000000002993f4
- (id)createClipSignificantEventWithCameraProfileUUID:(id)arg1 faceClassification:(id)arg2;	// IMP=0x0000000000299c29
