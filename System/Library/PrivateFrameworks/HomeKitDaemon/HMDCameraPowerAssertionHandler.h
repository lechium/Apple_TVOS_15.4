...
+ (id)logCategory;	// IMP=0x00000000007ab336
+ (id)sharedHandler;	// IMP=0x00000000007ab306
- (void).cxx_destruct;	// IMP=0x00000000007aabc9
...
- (void)deregisterRemoteRequestHandler:(id)arg1;	// IMP=0x00000000007aaad6
- (void)registerRemoteRequestHandler:(id)arg1 forSessionID:(id)arg2;	// IMP=0x00000000007aa9fa
- (id)init;	// IMP=0x00000000007aa929
