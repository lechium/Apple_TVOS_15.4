...
- (void).cxx_destruct;	// IMP=0x0000000000b31c82
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b31c27
- (void)suspend;	// IMP=0x0000000000b31bea
- (void)resume;	// IMP=0x0000000000b31bad
- (id)initWithQueue:(id)arg1 interval:(double)arg2 timerFireHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b31abc
