...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004d3360
- (void).cxx_destruct;	// IMP=0x00000000004d332d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004d2f31
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004d2e79
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004d2ab9
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004d2616
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddress:(id)arg3;	// IMP=0x00000000004d255f
- (id)init;	// IMP=0x00000000004d2530
