...
- (void).cxx_destruct;	// IMP=0x00000000001e51a9
...
- (id)mainReturningError;	// IMP=0x00000000001e4e90
- (id)initWithGroup:(id)arg1 serverChangeToken:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e4dd7
