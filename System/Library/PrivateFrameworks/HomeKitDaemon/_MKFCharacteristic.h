...
+ (Class)backingModelClass;	// IMP=0x0000000000588611
+ (id)backingModelProtocol;	// IMP=0x0000000000588600
+ (id)homeRelation;	// IMP=0x00000000005885d0
+ (id)fetchRequest;	// IMP=0x0000000000b57abe
@property(readonly, retain, nonatomic) NSArray *bulletinRegistrations;
@property(readonly) id <MKFHome> home;
- (id)castIfCharacteristic;	// IMP=0x0000000000588520
@property(readonly, copy, nonatomic) MKFCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x000000000058841c
- (void)pr_updateWithDictionary:(id)arg1;	// IMP=0x0000000000588214
