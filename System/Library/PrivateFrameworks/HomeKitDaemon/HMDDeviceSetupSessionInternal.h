...
+ (id)allowedClasses;	// IMP=0x00000000002700c5
+ (_Bool)isSupported;	// IMP=0x000000000027001d
+ (long long)role;	// IMP=0x000000000026ff75
- (void).cxx_destruct;	// IMP=0x000000000027034c
...
- (_Bool)processSessionData:(id)arg1 fromBundle:(id)arg2 outAccessoryUUID:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000270206
- (id)initWithHomeManager:(id)arg1;	// IMP=0x0000000000270190
