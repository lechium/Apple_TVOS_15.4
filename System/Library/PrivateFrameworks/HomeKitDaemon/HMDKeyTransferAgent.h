...
+ (id)logCategory;	// IMP=0x0000000000673a2b
- (void).cxx_destruct;	// IMP=0x00000000006739da
...
- (void)resetConfig;	// IMP=0x00000000006737d9
- (void)beginPairingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000006736ba
- (id)initWithHomeManager:(id)arg1;	// IMP=0x0000000000673563
