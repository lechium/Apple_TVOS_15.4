...
+ (void)__unregisterActivity:(id)arg1;	// IMP=0x000000000073264f
+ (id)logCategory;	// IMP=0x000000000073261f
- (void).cxx_destruct;	// IMP=0x000000000073209f
...
- (void)stop;	// IMP=0x0000000000731f26
- (void)start;	// IMP=0x0000000000731e78
- (void)__transitionActivity:(id)arg1 state:(long long)arg2;	// IMP=0x0000000000731cd3
- (void)__unregisterActivity;	// IMP=0x0000000000731bb1
- (void)__runActivity:(id)arg1;	// IMP=0x00000000007317f2
- (void)__checkInActivity:(id)arg1;	// IMP=0x00000000007313c4
- (void)__registerActivity;	// IMP=0x0000000000731200
- (id)__initialCriteria;	// IMP=0x00000000007310f6
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000730eb9
- (id)initWithIdentifier:(id)arg1 interval:(double)arg2 retryInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x0000000000730dd1
