...
+ (_Bool)isNewBetter:(unsigned long long)arg1 present:(unsigned long long)arg2;	// IMP=0x00000000009e4d93
- (void).cxx_destruct;	// IMP=0x00000000009e4d51
...
- (id)description;	// IMP=0x00000000009e4cb6
- (void)dealloc;	// IMP=0x00000000009e4c17
- (_Bool)removeSync;	// IMP=0x00000000009e4a5a
- (void)addNewSync:(id)arg1;	// IMP=0x00000000009e4424
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, nonatomic) HMDWatchSync *currentSync;
- (id)initWithDeviceId:(id)arg1 pairedSync:(id)arg2;	// IMP=0x00000000009e427f
