...
+ (id)sharedState;	// IMP=0x00000000007cc209
- (void).cxx_destruct;	// IMP=0x00000000007cbf8f
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x00000000007cbf22
- (void)registerDelegate:(id)arg1;	// IMP=0x00000000007cbe57
...
- (id)init;	// IMP=0x00000000007cb92d
