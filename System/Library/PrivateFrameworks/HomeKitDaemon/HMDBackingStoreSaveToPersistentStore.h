...
- (void).cxx_destruct;	// IMP=0x000000000099ca45
...
- (id)mainReturningError;	// IMP=0x000000000099c892
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x000000000099c7d0
