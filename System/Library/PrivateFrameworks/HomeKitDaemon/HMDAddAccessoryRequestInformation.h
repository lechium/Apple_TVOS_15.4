...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000a80bc8
- (void).cxx_destruct;	// IMP=0x0000000000a80b6b
...
- (void)storeIdentifierFromUnassociatedAccessory:(id)arg1 setupCode:(id)arg2;	// IMP=0x0000000000a80a08
- (void)cancelCleanupTimer;	// IMP=0x0000000000a809aa
- (void)startCleanupTimerForDelegate:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x0000000000a80815
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000a8068c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a805d6
- (id)initWithAccessoryName:(id)arg1 category:(id)arg2 bundleID:(id)arg3 accessoryDescription:(id)arg4;	// IMP=0x0000000000a8048c
