...
+ (id)XPCMessageCountersLogEventWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000002eba8e
- (void).cxx_destruct;	// IMP=0x00000000002eba3b
...
- (_Bool)shouldSubmit;	// IMP=0x00000000002eb9ad
- (id)__initWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000002eb875
