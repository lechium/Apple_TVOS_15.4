...
+ (id)logCategory;	// IMP=0x00000000009d0398
- (void).cxx_destruct;	// IMP=0x00000000009d0236
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000009cff66
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x00000000009cfeb5
- (void)handleAccessoryConnected:(id)arg1;	// IMP=0x00000000009cfe44
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x00000000009cf2c2
- (void)start;	// IMP=0x00000000009cf171
- (void)dealloc;	// IMP=0x00000000009ceffb
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x00000000009cede1
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000009cec04
