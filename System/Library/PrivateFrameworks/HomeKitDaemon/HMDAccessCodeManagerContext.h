...
+ (id)logCategory;	// IMP=0x0000000000042a9d
- (void).cxx_destruct;	// IMP=0x000000000004290c
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x0000000000042879
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x0000000000042798
...
- (id)userWithUUID:(id)arg1;	// IMP=0x000000000004255e
- (id)userForMessage:(id)arg1;	// IMP=0x00000000000424db
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x0000000000042427
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x0000000000042276
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x00000000000420cc
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x0000000000041f22
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x0000000000041d71
...
- (void)configure;	// IMP=0x0000000000041480
- (id)initWithHome:(id)arg1 messageDispatcher:(id)arg2 workQueue:(id)arg3 UUID:(id)arg4;	// IMP=0x00000000000412e2
- (id)initWithHome:(id)arg1 messageDispatcher:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000041203
