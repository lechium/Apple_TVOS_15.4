...
+ (id)xpcFilteredCountersLogEventWithPeerInformation:(id)arg1 messageName:(id)arg2 count:(id)arg3;	// IMP=0x00000000002a5ca6
+ (id)xpcSentCountersLogEventWithPeerInformation:(id)arg1 messageName:(id)arg2 count:(id)arg3;	// IMP=0x00000000002a5c11
+ (id)xpcAcceptedCountersLogEventWithPeerInformation:(id)arg1 messageName:(id)arg2 count:(id)arg3;	// IMP=0x00000000002a5b7c
- (void).cxx_destruct;	// IMP=0x00000000002a5b29
...
- (id)initWithEventName:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000002a586c
