...
+ (id)commandEventWithCommandType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0000000000352f86
- (void).cxx_destruct;	// IMP=0x0000000000352f75
...
- (id)initWithCommandType:(unsigned long long)arg1 accessory:(id)arg2;	// IMP=0x0000000000352ed2
- (id)metricForAWD;	// IMP=0x000000000083693f
- (unsigned int)AWDMessageType;	// IMP=0x0000000000836934
