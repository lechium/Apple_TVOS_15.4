...
+ (Class)backingModelClass;	// IMP=0x0000000000221db5
+ (id)backingModelProtocol;	// IMP=0x0000000000221da4
+ (id)homeRelation;	// IMP=0x0000000000221d74
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0000000000221cbe
+ (Class)cd_modelClass;	// IMP=0x00000000007613f9
+ (id)fetchRequest;	// IMP=0x0000000000b5783e
- (void)synchronizeConstraintsRelationWith:(id)arg1;	// IMP=0x0000000000221c9c
- (id)findConstraintsRelationWithModelID:(id)arg1;	// IMP=0x0000000000221c79
- (id)materializeOrCreateConstraintsRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x0000000000221c53
@property(readonly, retain, nonatomic) NSArray *constraints;
@property(readonly) id <MKFHome> home;
- (id)castIfAccessorySetting;	// IMP=0x0000000000221ba3
