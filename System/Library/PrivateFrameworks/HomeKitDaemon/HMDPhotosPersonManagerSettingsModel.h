...
+ (id)sentinelParentUUID;	// IMP=0x00000000006f868f
+ (id)hmbProperties;	// IMP=0x00000000006f865f
- (id)createSettings;	// IMP=0x00000000006f8597
- (id)initWithModelID:(id)arg1 settings:(id)arg2;	// IMP=0x00000000006f848c
