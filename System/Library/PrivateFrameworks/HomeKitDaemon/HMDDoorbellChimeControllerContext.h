...
- (void).cxx_destruct;	// IMP=0x000000000067ed00
...
- (_Bool)accessorySupportsCoordinationDoorbellChime:(id)arg1;	// IMP=0x000000000067ec86
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x000000000067eb9e
- (id)clearCoordinationStateForKeyPaths:(id)arg1;	// IMP=0x000000000067eb85
- (id)keyPathFromComponents:(id)arg1;	// IMP=0x000000000067eb7d
- (id)postCoordinationState:(id)arg1;	// IMP=0x000000000067eb64
...
- (id)postCULiveAction:(id)arg1;	// IMP=0x000000000067e918
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x000000000067e6ac
