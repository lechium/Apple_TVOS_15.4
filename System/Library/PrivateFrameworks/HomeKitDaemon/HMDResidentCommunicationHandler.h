...
+ (id)logCategory;	// IMP=0x000000000024488c
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x0000000000244778
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x0000000000244529
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000243c07
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x00000000002436cc
- (void).cxx_destruct;	// IMP=0x0000000000242acf
...
- (id)logIdentifier;	// IMP=0x00000000002429a8
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x00000000002424aa
- (void)_sendMultipleCharacteristicRead;	// IMP=0x000000000024163a
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000241589
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x000000000024142e
- (long long)preferredDeviceType;	// IMP=0x000000000024132e
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x0000000000241276
- (_Bool)containsDevice:(id)arg1;	// IMP=0x0000000000241089
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x0000000000240ee4
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x0000000000240df9
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000240bb2
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x0000000000240a1f
