...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006f893
- (void).cxx_destruct;	// IMP=0x000000000006f862
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006f792
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006f5cf
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006f46f
- (id)tlvData;	// IMP=0x000000000006f337
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006f156
- (id)initWithAudioCodecGroup:(id)arg1 codecParameter:(id)arg2;	// IMP=0x000000000006f0b4
