...
- (void).cxx_destruct;	// IMP=0x00000000001e729e
...
- (id)mainReturningError;	// IMP=0x00000000001e6c17
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e6b36
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e6a55
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e6974
