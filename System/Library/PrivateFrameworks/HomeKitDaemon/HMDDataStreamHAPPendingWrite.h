...
- (void).cxx_destruct;	// IMP=0x00000000006a174f
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x00000000006a1633
- (_Bool)isComplete;	// IMP=0x00000000006a15d2
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000006a1526
