...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000005f2e2b
- (void).cxx_destruct;	// IMP=0x00000000005f2cd4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005f2ba7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005f29ce
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000005f285c
- (id)tlvData;	// IMP=0x00000000005f26ef
- (_Bool)_parseFromTLVData;	// IMP=0x00000000005f2520
- (id)initWithPrebufferLength:(id)arg1 eventTriggerOptions:(unsigned long long)arg2 mediaContainerConfigurations:(id)arg3;	// IMP=0x00000000005f246b
