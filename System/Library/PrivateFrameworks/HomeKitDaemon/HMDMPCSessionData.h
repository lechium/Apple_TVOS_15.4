...
- (void).cxx_destruct;	// IMP=0x00000000007e7bf2
...
- (id)dictionaryRepresentation:(_Bool)arg1;	// IMP=0x00000000007e7438
- (id)initWithMediaAction:(id)arg1 source:(id)arg2 clientName:(id)arg3;	// IMP=0x00000000007e72da
- (id)initWithDictionaryRepresentation:(id)arg1 profileSource:(id)arg2;	// IMP=0x00000000007e68a5
- (id)initWithMediaProfiles:(id)arg1 playbackState:(id)arg2 playbackVolume:(id)arg3 playbackArchive:(id)arg4 source:(id)arg5 clientName:(id)arg6;	// IMP=0x00000000007e64ca
