...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006ba0
- (unsigned long long)hash;	// IMP=0x0000000000006aeb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000699e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000068b9
- (void)copyTo:(id)arg1;	// IMP=0x00000000000067f7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000006708
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000066fb
- (id)dictionaryRepresentation;	// IMP=0x00000000000064aa
- (id)description;	// IMP=0x00000000000063fb
