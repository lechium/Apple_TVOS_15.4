...
+ (id)properties;	// IMP=0x00000000008ffb26
+ (id)schemaHashRoot;	// IMP=0x00000000008ffb05
+ (Class)cd_entityClass;	// IMP=0x000000000031a14f
+ (id)cd_parentReferenceName;	// IMP=0x000000000031a142
- (void).cxx_destruct;	// IMP=0x00000000008ffad4
