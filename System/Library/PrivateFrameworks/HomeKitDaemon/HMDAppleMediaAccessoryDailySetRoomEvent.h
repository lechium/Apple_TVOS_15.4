...
+ (id)filterToAllowedRoomName:(id)arg1;	// IMP=0x0000000000628917
- (void).cxx_destruct;	// IMP=0x0000000000358c00
...
- (id)initWithCurrentRoom:(id)arg1 previousRoom:(id)arg2;	// IMP=0x0000000000358b32
