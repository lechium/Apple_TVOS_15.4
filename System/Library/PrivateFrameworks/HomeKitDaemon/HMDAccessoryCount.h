...
- (void).cxx_destruct;	// IMP=0x000000000049752b
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x000000000049736a
...
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000496f5e
