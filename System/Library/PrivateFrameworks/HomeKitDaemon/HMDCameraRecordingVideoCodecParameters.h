...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000084b6df
- (void).cxx_destruct;	// IMP=0x000000000084b5f2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000084b496
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000084b22a
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000084afee
- (id)tlvData;	// IMP=0x000000000084add9
- (_Bool)_parseFromTLVData;	// IMP=0x000000000084ab6f
- (id)initWithProfiles:(id)arg1 levels:(id)arg2 bitRate:(id)arg3 iFrameInterval:(id)arg4;	// IMP=0x000000000084aa78
