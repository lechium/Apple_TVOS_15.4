...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x00000000001de8c2
- (void).cxx_destruct;	// IMP=0x00000000001de891
...
- (id)attributeDescriptions;	// IMP=0x00000000001de69e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001de693
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x00000000001de559
