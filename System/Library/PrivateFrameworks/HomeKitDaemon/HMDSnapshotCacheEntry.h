...
- (void).cxx_destruct;	// IMP=0x000000000096c837
...
- (id)description;	// IMP=0x000000000096c74f
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x000000000096c689
