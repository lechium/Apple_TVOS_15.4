...
+ (id)eventWithIsEnabled:(_Bool)arg1 options:(unsigned long long)arg2 areActivityNotificationsEnabledForPersonalRequests:(_Bool)arg3 numEnabledAccessories:(unsigned long long)arg4 numCapableAccessories:(unsigned long long)arg5;	// IMP=0x0000000000420c32
...
- (id)metricForAWD;	// IMP=0x0000000000840e29
- (unsigned int)AWDMessageType;	// IMP=0x0000000000840e1e
