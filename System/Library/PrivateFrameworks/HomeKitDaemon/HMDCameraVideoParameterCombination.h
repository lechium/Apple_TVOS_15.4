...
- (void).cxx_destruct;	// IMP=0x000000000041f469
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000041f281
- (id)description;	// IMP=0x000000000041f1c4
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x000000000041f0fe
