...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004d100d
- (void).cxx_destruct;	// IMP=0x00000000004d05d1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004cfe27
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004cfcf4
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004cf688
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004cef6e
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddressList:(id)arg3 lanIdentifier:(id)arg4 name:(id)arg5 rssi:(id)arg6;	// IMP=0x00000000004cee46
- (id)init;	// IMP=0x00000000004cee17
