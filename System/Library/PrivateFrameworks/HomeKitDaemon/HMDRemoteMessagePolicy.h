...
+ (id)defaultSecurePolicy;	// IMP=0x00000000003a8236
+ (id)defaultPolicy;	// IMP=0x00000000003a8205
+ (id)remoteMessagePolicyWithRequiresSecureMessage:(_Bool)arg1 allowsAnonymousMessage:(_Bool)arg2 requiresAccountMessage:(_Bool)arg3 transportRestriction:(unsigned long long)arg4 roles:(unsigned long long)arg5;	// IMP=0x00000000003a817c
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a7f29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a7f1e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003a7dce
- (unsigned long long)hash;	// IMP=0x00000000003a7d54
- (id)__initWithRequiresSecureMessage:(_Bool)arg1 allowsAnonymousMessage:(_Bool)arg2 requiresAccountMessage:(_Bool)arg3 transportRestriction:(unsigned long long)arg4 roles:(unsigned long long)arg5;	// IMP=0x00000000003a7ccd
- (id)init;	// IMP=0x00000000003a7c25
