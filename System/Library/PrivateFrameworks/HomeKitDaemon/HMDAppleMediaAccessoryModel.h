...
+ (id)properties;	// IMP=0x0000000000634744
+ (Class)cd_entityClass;	// IMP=0x00000000003a5371
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000003a5102
