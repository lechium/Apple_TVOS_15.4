...
- (void).cxx_destruct;	// IMP=0x00000000005abe6c
...
- (id)attributeDescriptions;	// IMP=0x00000000005abc4c
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithModel:(id)arg1 failureCode:(unsigned long long)arg2 error:(id)arg3;	// IMP=0x00000000005ab98f
