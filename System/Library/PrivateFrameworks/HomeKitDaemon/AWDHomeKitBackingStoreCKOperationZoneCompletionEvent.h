...
- (void).cxx_destruct;	// IMP=0x00000000007bcffc
@property(retain, nonatomic) NSString *errorDomain; // @synthesize errorDomain=_errorDomain;
@property(nonatomic) long long errorCode; // @synthesize errorCode=_errorCode;
@property(nonatomic) _Bool didSucceed; // @synthesize didSucceed=_didSucceed;
@property(nonatomic) unsigned long long timestamp; // @synthesize timestamp=_timestamp;
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007bced2
- (unsigned long long)hash;	// IMP=0x00000000007bce16
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007bccae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007bcbae
- (void)copyTo:(id)arg1;	// IMP=0x00000000007bcadb
- (void)writeTo:(id)arg1;	// IMP=0x00000000007bc9ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007bc9e0
- (id)dictionaryRepresentation;	// IMP=0x00000000007bc6fb
- (id)description;	// IMP=0x00000000007bc64c
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsZoneType:(id)arg1;	// IMP=0x00000000007bc548
- (id)zoneTypeAsString:(int)arg1;	// IMP=0x00000000007bc4b1
@property(nonatomic) _Bool hasZoneType;
@property(nonatomic) int zoneType; // @synthesize zoneType=_zoneType;
- (int)StringAsContainerType:(id)arg1;	// IMP=0x00000000007bc398
- (id)containerTypeAsString:(int)arg1;	// IMP=0x00000000007bc319
