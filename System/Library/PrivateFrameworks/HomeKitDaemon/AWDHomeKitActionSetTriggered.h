...
- (void).cxx_destruct;	// IMP=0x00000000005c118c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000005c1007
- (unsigned long long)hash;	// IMP=0x00000000005c0f12
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005c0d6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005c0c3b
- (void)copyTo:(id)arg1;	// IMP=0x00000000005c0b41
- (void)writeTo:(id)arg1;	// IMP=0x00000000005c0a39
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005c0a2c
- (id)dictionaryRepresentation;	// IMP=0x00000000005c074e
- (id)description;	// IMP=0x00000000005c069f
@property(readonly, nonatomic) _Bool hasClientMetricIdentifier;
@property(nonatomic) _Bool hasNumAccessories;
- (int)StringAsTriggerSource:(id)arg1;	// IMP=0x00000000005c04ec
- (id)triggerSourceAsString:(int)arg1;	// IMP=0x00000000005c042d
