...
- (id)shortDescription;	// IMP=0x0000000000ad7bec
- (id)initWithValue:(unsigned long long)arg1 definedPeriod:(double)arg2;	// IMP=0x0000000000ad7b92
- (id)init;	// IMP=0x0000000000ad7b7b
