...
+ (id)eventUpdateStartedWithAutomaticUpdateEnabled:(_Bool)arg1;	// IMP=0x0000000000749701
...
- (id)metricForAWD;	// IMP=0x0000000000836a95
- (unsigned int)AWDMessageType;	// IMP=0x0000000000836a8a
