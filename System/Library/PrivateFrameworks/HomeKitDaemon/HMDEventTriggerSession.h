...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x00000000004f7dc8
+ (id)logCategory;	// IMP=0x00000000004f7d98
- (void).cxx_destruct;	// IMP=0x00000000004f7d14
...
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 target:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000004f79c0
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000004f78ed
- (_Bool)sendResidentMessage:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004f77be
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x00000000004f7788
@property(readonly, copy) NSString *description;
- (id)dumpState;	// IMP=0x00000000004f7614
- (void)_registerForMessages;	// IMP=0x00000000004f760e
- (void)dealloc;	// IMP=0x00000000004f747c
- (id)initWithSessionID:(id)arg1 eventTrigger:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000004f7255
