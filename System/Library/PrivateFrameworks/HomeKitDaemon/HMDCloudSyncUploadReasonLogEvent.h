...
+ (id)uploadReason:(id)arg1 acceptedHomeManagerZonePush:(_Bool)arg2;	// IMP=0x0000000000509428
+ (id)uploadReason:(id)arg1 acceptedHomeZonePush:(_Bool)arg2;	// IMP=0x00000000005093c0
+ (id)uploadReason:(id)arg1 acceptedLegacyPush:(_Bool)arg2;	// IMP=0x0000000000509358
...
- (id)initWithUploadReason:(id)arg1 legacyPushCount:(long long)arg2 homeZonePushCount:(long long)arg3 homeManagerPushCount:(long long)arg4;	// IMP=0x0000000000509257
