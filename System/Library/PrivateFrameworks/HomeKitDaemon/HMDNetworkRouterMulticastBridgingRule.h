...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004c6f2b
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x000000000044f9bb
- (void).cxx_destruct;	// IMP=0x00000000004c6eed
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004c69c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c68e6
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004c6440
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004c5f01
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 destinationIPAddress:(id)arg3 destinationPort:(id)arg4;	// IMP=0x00000000004c5e1f
- (id)init;	// IMP=0x00000000004c5df0
- (void)addTo:(id)arg1;	// IMP=0x000000000044df4d
