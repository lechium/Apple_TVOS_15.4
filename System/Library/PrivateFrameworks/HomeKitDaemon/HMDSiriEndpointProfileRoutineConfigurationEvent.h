...
- (void).cxx_destruct;	// IMP=0x00000000008f36ff
...
- (id)attributeDescriptions;	// IMP=0x00000000008f3547
@property(readonly, nonatomic) NSString *eventName;
@property(readonly, nonatomic) NSDictionary *serializedEvent;
- (id)initWithAccessoryCategoryType:(id)arg1 profileFields:(id)arg2 accessorySettingFields:(id)arg3;	// IMP=0x00000000008f3284
