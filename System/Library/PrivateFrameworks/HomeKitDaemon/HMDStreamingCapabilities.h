...
+ (unsigned long long)aspectRatioOfResolution:(id)arg1;	// IMP=0x00000000004b12ac
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000004b12a4
+ (void)translateCapabilities:(id)arg1;	// IMP=0x00000000004b0b8d
- (void).cxx_destruct;	// IMP=0x00000000004b0921
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004b072c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004b0427
- (void)updateWithRemoteSettings:(id)arg1;	// IMP=0x00000000004b0117
- (void)_updateWithStreamPreference:(id)arg1;	// IMP=0x00000000004af9d6
- (id)_supportedResolutionsWithOverrides;	// IMP=0x00000000004af536
- (id)initWithStreamPreference:(id)arg1;	// IMP=0x00000000004af269
- (id)description;	// IMP=0x00000000004af136
