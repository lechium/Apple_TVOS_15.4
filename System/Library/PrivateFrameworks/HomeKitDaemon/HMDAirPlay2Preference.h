...
+ (void)load;	// IMP=0x000000000024c456
- (void).cxx_destruct;	// IMP=0x000000000024c425
...
- (id)stringValue;	// IMP=0x000000000024c3a9
- (id)numberValue;	// IMP=0x000000000024c2ab
- (_Bool)boolValue;	// IMP=0x000000000024c267
@property(readonly, copy) NSString *propertyDescription;
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x000000000024c075
