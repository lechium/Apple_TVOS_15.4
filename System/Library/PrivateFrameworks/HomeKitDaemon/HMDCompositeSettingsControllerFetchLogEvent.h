...
- (void).cxx_destruct;	// IMP=0x000000000020a63e
@property(readonly, copy) NSString *keyPath; // @synthesize keyPath=_keyPath;
- (id)dictionaryRepresentation;	// IMP=0x000000000020a4a9
- (id)initWithKeyPath:(id)arg1 date:(id)arg2;	// IMP=0x000000000020a406
