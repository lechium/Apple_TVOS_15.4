...
- (void).cxx_destruct;	// IMP=0x00000000005fe3b4
...
- (id)description;	// IMP=0x00000000005fe283
- (id)initWithHome:(id)arg1 fromUser:(id)arg2 toUser:(id)arg3 encodedShareURL:(id)arg4 shareToken:(id)arg5 containerID:(id)arg6 currentDate:(id)arg7 completion:(CDUnknownBlockType)arg8;	// IMP=0x00000000005fe151
