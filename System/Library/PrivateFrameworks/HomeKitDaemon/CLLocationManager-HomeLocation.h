...
+ (long long)hm_hmdRegionStateFromCLRegionState:(long long)arg1;	// IMP=0x00000000003a06b1
+ (long long)hm_hmdLocationAuthorizationFromCLAuthorizationStatus:(int)arg1;	// IMP=0x00000000003a068c
+ (_Bool)hm_isLocationAllowedForAuthorizationStatus:(int)arg1;	// IMP=0x00000000003a067d
