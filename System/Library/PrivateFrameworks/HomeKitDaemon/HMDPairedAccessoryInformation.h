...
- (void).cxx_destruct;	// IMP=0x00000000008b15cb
...
- (id)description;	// IMP=0x00000000008b14f0
- (unsigned long long)hash;	// IMP=0x00000000008b14ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008b13d7
- (id)initWithIdentifier:(id)arg1 transports:(unsigned long long)arg2 setupHash:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000008b12ee
- (id)init;	// IMP=0x00000000008b1246
