...
+ (id)logCategory;	// IMP=0x000000000037d2ab
+ (double)defaultTimeout;	// IMP=0x000000000037d27e
- (void).cxx_destruct;	// IMP=0x000000000037cc77
@property(readonly, copy) NSString *accessoryIdentifier; // @synthesize accessoryIdentifier=_accessoryIdentifier;
- (void)cancel;	// IMP=0x000000000037cc1b
- (void)main;	// IMP=0x000000000037ca02
...
- (void)dealloc;	// IMP=0x000000000037c5ca
- (id)initWithAccessoryIdentifier:(id)arg1 timeout:(double)arg2;	// IMP=0x000000000037c403
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x000000000037c3ee
