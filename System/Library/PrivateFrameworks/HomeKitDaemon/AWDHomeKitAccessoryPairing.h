...
- (void).cxx_destruct;	// IMP=0x00000000007cf061
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007ceb56
- (unsigned long long)hash;	// IMP=0x00000000007ce7f1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007ce225
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007cdeaa
- (void)copyTo:(id)arg1;	// IMP=0x00000000007cdb7b
- (void)writeTo:(id)arg1;	// IMP=0x00000000007cd815
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007cd808
- (id)dictionaryRepresentation;	// IMP=0x00000000007cce7a
- (id)description;	// IMP=0x00000000007ccdcb
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x00000000007cc95b
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000007cc8f5
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000007cc75e
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000007cc6f8
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000007cc544
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000007cc490
