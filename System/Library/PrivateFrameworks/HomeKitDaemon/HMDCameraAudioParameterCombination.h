...
- (void).cxx_destruct;	// IMP=0x0000000000303ab3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003038f1
- (id)description;	// IMP=0x000000000030379b
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x00000000003036a2
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x00000000003035dc
