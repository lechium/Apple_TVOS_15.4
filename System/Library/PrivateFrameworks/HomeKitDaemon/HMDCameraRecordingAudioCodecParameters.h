...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000b0fd51
- (void).cxx_destruct;	// IMP=0x0000000000b0fc64
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000b0fb08
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000b0f88d
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000b0f6af
- (id)tlvData;	// IMP=0x0000000000b0f4a2
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000b0f24b
- (id)initWithChannelCount:(id)arg1 bitRateModes:(id)arg2 audioSampleRates:(id)arg3 maxAudioBitRate:(id)arg4;	// IMP=0x0000000000b0f154
