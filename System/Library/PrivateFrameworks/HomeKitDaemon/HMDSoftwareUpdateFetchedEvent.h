...
+ (id)eventWasUserInitiated:(_Bool)arg1 wasNewUpdateFetched:(_Bool)arg2;	// IMP=0x000000000081695d
...
- (id)metricForAWD;	// IMP=0x0000000000836c41
- (unsigned int)AWDMessageType;	// IMP=0x0000000000836c36
