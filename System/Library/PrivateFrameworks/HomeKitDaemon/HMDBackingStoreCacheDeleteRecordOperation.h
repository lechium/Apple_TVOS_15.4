...
- (void).cxx_destruct;	// IMP=0x00000000001e61cd
...
- (id)mainReturningError;	// IMP=0x00000000001e5d5f
- (id)initWithGroup:(id)arg1 recordNames:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e5ca6
