...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a7032c
- (void).cxx_destruct;	// IMP=0x0000000000a702f9
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000a7017e
