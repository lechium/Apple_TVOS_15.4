...
+ (id)logCategory;	// IMP=0x0000000000529ec7
- (void).cxx_destruct;	// IMP=0x0000000000527669
...
- (void)driverDidReload:(id)arg1;	// IMP=0x000000000052725b
- (void)driver:(id)arg1 didUpdateSettings:(id)arg2;	// IMP=0x0000000000526e83
- (void)languageValueListWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000526dd2
- (void)updateSettingWithKeyPath:(id)arg1 settingValue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000526cc8
- (void)fetchSettingsForKeyPaths:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000526bec
- (void)start;	// IMP=0x0000000000526b7b
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 drivers:(id)arg3;	// IMP=0x0000000000526898
