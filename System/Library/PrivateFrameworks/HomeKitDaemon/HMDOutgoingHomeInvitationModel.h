...
+ (id)properties;	// IMP=0x0000000000092535
+ (Class)cd_entityClass;	// IMP=0x00000000004af125
+ (id)cd_parentReferenceName;	// IMP=0x00000000004af118
- (id)dependentUUIDs;	// IMP=0x0000000000092087
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000004aeac5
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000004ae801
