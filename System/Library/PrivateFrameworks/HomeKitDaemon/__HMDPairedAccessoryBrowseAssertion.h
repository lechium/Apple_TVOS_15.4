...
- (void).cxx_destruct;	// IMP=0x00000000008da740
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x00000000008da6ac
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x00000000008da579
- (id)initWithName:(id)arg1;	// IMP=0x00000000008da4c3
