...
+ (id)logCategory;	// IMP=0x000000000068ea85
- (void).cxx_destruct;	// IMP=0x000000000068e8d1
...
- (void)_generateAllCombinations;	// IMP=0x000000000068ccf0
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x000000000068cb85
- (id)createSelectedVideoParameters;	// IMP=0x000000000068c792
- (id)createSRTPParamters;	// IMP=0x000000000068c712
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x000000000068be2e
- (_Bool)selectVideoParameters;	// IMP=0x000000000068ae7a
- (id)logIdentifier;	// IMP=0x000000000068ae2a
- (void)_setVideoResolutionPreference;	// IMP=0x000000000068aaf0
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x000000000068a900
