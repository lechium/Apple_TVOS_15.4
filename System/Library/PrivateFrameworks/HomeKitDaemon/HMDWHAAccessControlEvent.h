...
+ (int)awdUserPrivilegeFromHMUserPrivilege:(long long)arg1;	// IMP=0x000000000096043a
+ (id)eventWithP2PEnabled:(_Bool)arg1 privilegeLevel:(long long)arg2 passwordSet:(_Bool)arg3;	// IMP=0x00000000009603b4
...
- (id)metricForAWD;	// IMP=0x0000000000836632
- (unsigned int)AWDMessageType;	// IMP=0x0000000000836627
