...
+ (id)logCategory;	// IMP=0x0000000000a82bab
- (void).cxx_destruct;	// IMP=0x0000000000a82b47
...
- (id)logIdentifier;	// IMP=0x0000000000a82a66
- (id)negotiatedParameters;	// IMP=0x0000000000a82913
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000a8258c
