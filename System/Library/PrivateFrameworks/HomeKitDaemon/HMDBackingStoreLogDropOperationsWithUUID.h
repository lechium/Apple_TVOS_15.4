...
- (void).cxx_destruct;	// IMP=0x000000000080d1ca
...
- (id)mainReturningError;	// IMP=0x000000000080cbcf
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000080cb27
