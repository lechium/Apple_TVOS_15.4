...
+ (_Bool)submitEventWithHistogrammedCommonConfigurationDimensions;	// IMP=0x000000000008d6be
...
- (id)metricForAWD;	// IMP=0x000000000008c0fa
- (unsigned int)AWDMessageType;	// IMP=0x000000000008c0ef
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (void)submitAtDate:(id)arg1;	// IMP=0x0000000000089d9f
- (id)alertMessageForRadarDialogWithCloudSyncBytesThreshold:(unsigned long long)arg1 remoteMessageCountThreshold:(unsigned long long)arg2;	// IMP=0x0000000000089a5a
- (id)alertMessageForRadarDialog;	// IMP=0x0000000000089900
- (id)initWithDataSyncStateDescription:(id)arg1 eventCountersManager:(id)arg2 eventFlagsManager:(id)arg3;	// IMP=0x000000000008985e
