...
- (void).cxx_destruct;	// IMP=0x000000000045806e
...
- (id)initWithAction:(id)arg1 characteristicWriteRequests:(id)arg2;	// IMP=0x0000000000457fa0
- (id)init;	// IMP=0x0000000000457ef8
