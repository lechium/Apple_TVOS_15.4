...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003b637c
- (unsigned long long)hash;	// IMP=0x00000000003b6292
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003b60f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003b5fde
- (void)copyTo:(id)arg1;	// IMP=0x00000000003b5eef
- (void)writeTo:(id)arg1;	// IMP=0x00000000003b5dc4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003b5db7
- (id)dictionaryRepresentation;	// IMP=0x00000000003b5aba
- (id)description;	// IMP=0x00000000003b5a0b
