...
+ (id)properties;	// IMP=0x000000000039407d
+ (id)cd_getMKFRoom:(id)arg1;	// IMP=0x000000000076383e
+ (id)cd_getMKFAccessoryFromAccessory:(id)arg1;	// IMP=0x00000000007636a7
+ (id)cd_getMKFAccessoryFromAccessoryUUID:(id)arg1;	// IMP=0x0000000000763615
+ (Class)cd_entityClass;	// IMP=0x0000000000763604
+ (id)cd_parentReferenceName;	// IMP=0x00000000007635f7
- (void).cxx_destruct;	// IMP=0x000000000039404c
...
- (id)dependentUUIDs;	// IMP=0x0000000000393e68
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000762f96
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000762d46
