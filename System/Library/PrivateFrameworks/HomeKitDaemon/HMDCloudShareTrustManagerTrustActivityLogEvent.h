...
- (void).cxx_destruct;	// IMP=0x000000000086b13c
...
- (id)initWithTrustActivityType:(long long)arg1 privilege:(unsigned long long)arg2 isPrimaryResident:(_Bool)arg3;	// IMP=0x000000000086b008
