...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000735cf6
- (void).cxx_destruct;	// IMP=0x0000000000735cad
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000735663
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000735554
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000734f0c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000007348e6
- (id)initWithWakePacketType:(id)arg1 wakeDestinationPort:(id)arg2 wakeDestinationAddress:(id)arg3 wakeType:(id)arg4 wakePattern:(id)arg5;	// IMP=0x00000000007347e4
- (id)init;	// IMP=0x00000000007347b5
