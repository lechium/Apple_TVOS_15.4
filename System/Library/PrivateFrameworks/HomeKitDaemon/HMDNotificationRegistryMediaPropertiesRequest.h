...
- (void).cxx_destruct;	// IMP=0x0000000000717ea9
...
- (id)attributeDescriptions;	// IMP=0x0000000000717cac
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 mediaProfileUUID:(id)arg3;	// IMP=0x0000000000717ba5
