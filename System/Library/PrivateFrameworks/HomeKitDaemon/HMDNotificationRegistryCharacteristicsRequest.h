...
- (void).cxx_destruct;	// IMP=0x0000000000717b74
...
- (id)attributeDescriptions;	// IMP=0x0000000000717977
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 accessoryUUID:(id)arg3;	// IMP=0x0000000000717870
