...
- (void).cxx_destruct;	// IMP=0x000000000081876a
...
- (void)forceRefresh;	// IMP=0x00000000008186a6
- (void)markDeleted;	// IMP=0x0000000000818695
- (void)markChanged;	// IMP=0x0000000000818684
- (id)initWithZoneID:(id)arg1;	// IMP=0x00000000008185cd
