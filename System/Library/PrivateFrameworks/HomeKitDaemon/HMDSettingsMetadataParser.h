...
+ (id)logCategory;	// IMP=0x0000000000467a7d
- (void).cxx_destruct;	// IMP=0x0000000000467a6f
@property(readonly) __weak id <HMDSettingsControllerDependency> dependency; // @synthesize dependency=_dependency;
- (id)logIdentifier;	// IMP=0x00000000004679df
- (id)modelsFromMetadata:(id)arg1;	// IMP=0x0000000000465e18
- (id)initWithDependency:(id)arg1;	// IMP=0x0000000000465db4
