...
+ (id)localizedMessageForCameraAccessModeChange:(unsigned long long)arg1 changeReason:(long long)arg2 camera:(id)arg3;	// IMP=0x0000000000b02709
- (void).cxx_destruct;	// IMP=0x0000000000b026a5
...
- (id)attributeDescriptions;	// IMP=0x0000000000b02392
- (id)initWithAccessMode:(unsigned long long)arg1 camera:(id)arg2 home:(id)arg3 changeReason:(long long)arg4 changeDate:(id)arg5;	// IMP=0x0000000000b02000
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x0000000000b01e5b
