...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000084cecb
- (void).cxx_destruct;	// IMP=0x000000000084ce3c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000084cd26
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000084cb68
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000084c969
- (id)tlvData;	// IMP=0x000000000084c7aa
- (_Bool)_parseFromTLVData;	// IMP=0x000000000084c582
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 videoAttributes:(id)arg3;	// IMP=0x000000000084c4bc
