...
- (void)setReferenceSubstring:(id)arg1 range:(struct _NSRange)arg2 characterRects:(struct CGRect *)arg3;	// IMP=0x0000000000071170
...
- (id)referenceSubstring;	// IMP=0x0000000000070ee0
- (struct CGRect *)characterRectsInReferenceSubstring;	// IMP=0x0000000000070ed0
- (struct _NSRange)referenceSubstringRange;	// IMP=0x0000000000070ec0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000070c80
