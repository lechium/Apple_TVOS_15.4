...
+ (id)defaultWordTerminationCharacterForLocale:(id)arg1;	// IMP=0x00000000000fcf70
- (void).cxx_destruct;	// IMP=0x00000000000fd010
...
- (id)initWithTextResult:(id)arg1 terminatingSpecialCharacter:(id)arg2;	// IMP=0x00000000000fced0
