...
- (void).cxx_destruct;	// IMP=0x0000000000176ed0
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x0000000000175d50
- (id)initShouldAddAlternatives:(_Bool)arg1;	// IMP=0x0000000000175bb0
