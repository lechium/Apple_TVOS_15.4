...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000084f80
- (void).cxx_destruct;	// IMP=0x0000000000085dc0
...
- (_Bool)hasCompleteRecognitionResults;	// IMP=0x0000000000085760
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000856e0
- (_Bool)isEqualToRecognitionSessionResult:(id)arg1;	// IMP=0x00000000000855e0
- (_Bool)isEqualToSerializableRecognitionSessionResult:(id)arg1;	// IMP=0x0000000000084f90
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000084720
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000084430
- (id)encodedStrokeProviderVersion;	// IMP=0x0000000000084420
- (id)contextualResultsWithFullyCoveredStrokeGroups:(id)arg1 partiallyCoveredStrokeGroups:(id)arg2 drawingCanvasSize:(struct CGSize)arg3;	// IMP=0x0000000000083770
- (id)fullyCoveredStrokeGroupsForContextStrokes:(id)arg1 partiallyCoveredStrokeGroups:(id *)arg2;	// IMP=0x00000000000831d0
- (id)textCorrectionResultForStrokeGroupIdentifier:(long long)arg1;	// IMP=0x0000000000083120
- (id)recognitionResultForStrokeGroupIdentifier:(long long)arg1;	// IMP=0x0000000000083070
- (id)_resultsDebugDescriptionIntoGroupsArray:(id)arg1 groupHeaderBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000082300
- (id)allResultsDebugDescriptionWithGroupHeaderBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000822d0
...
- (id)debugDescription;	// IMP=0x0000000000081550
- (id)description;	// IMP=0x0000000000081160
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000081150
- (id)initWithResult:(id)arg1 validStrokes:(id)arg2;	// IMP=0x0000000000081140
- (id)initWithStrokeProviderVersion:(id)arg1 encodedStrokeProviderVersion:(id)arg2 orderedStrokeIdentifiers:(id)arg3 sessionMode:(long long)arg4 locales:(id)arg5 preferredLocales:(id)arg6 clutterFilter:(id)arg7 strokeClassificationResult:(id)arg8 strokeGroupingResult:(id)arg9 recognitionResults:(id)arg10 inlineContinuousModeResults:(id)arg11 generationDuration:(CDStruct_76929b14)arg12 recognitionEnvironment:(long long)arg13;	// IMP=0x0000000000080d00
- (id)init;	// IMP=0x0000000000080c50
