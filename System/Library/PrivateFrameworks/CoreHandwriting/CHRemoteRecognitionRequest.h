...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008ee60
- (void).cxx_destruct;	// IMP=0x0000000000090990
...
- (id)description;	// IMP=0x0000000000090460
- (unsigned long long)hash;	// IMP=0x00000000000901a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000090120
- (_Bool)isEqualToRemoteRecognitionRequest:(id)arg1;	// IMP=0x000000000008fb30
- (id)recognizerConfigurationKeyWithLocale:(id)arg1;	// IMP=0x000000000008ee70
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008ec30
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008e560
- (id)initWithLocales:(id)arg1 recognitionMode:(int)arg2 drawing:(id)arg3 options:(id)arg4 priority:(long long)arg5;	// IMP=0x000000000008e2a0
