...
+ (id)descriptionForStrokeGroupQueryItemType:(long long)arg1;	// IMP=0x000000000000e9e0
- (void).cxx_destruct;	// IMP=0x000000000000f040
...
- (id)description;	// IMP=0x000000000000eef0
- (id)textRecognitionResultForLocale:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000ee20
- (id)initWithStrokeGroupIdentifier:(id)arg1 stableIdentifier:(id)arg2 strokeIdentifiers:(id)arg3 type:(long long)arg4 preferredLocale:(id)arg5 tokenizedTextResultsByLocale:(id)arg6 errorsByLocale:(id)arg7;	// IMP=0x000000000000ea10
