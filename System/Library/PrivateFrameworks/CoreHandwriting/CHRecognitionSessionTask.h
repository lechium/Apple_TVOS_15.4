...
- (void).cxx_destruct;	// IMP=0x00000000000e0bd0
...
- (id)newGroupingManager;	// IMP=0x00000000000e0930
- (id)newStrokeClassifier;	// IMP=0x00000000000e0840
- (id)clutterFilter;	// IMP=0x00000000000e07c0
- (id)_recognitionResultsForNonTextStrokeGroup:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000e04d0
- (id)_tokenizedTextResultForDrawing:(id)arg1 usingRecognizer:(id)arg2 isRemoteRecognizer:(_Bool)arg3 locale:(id)arg4 strokeLimit:(long long)arg5 recognitionError:(id *)arg6;	// IMP=0x00000000000de930
- (id)_textRecognitionResultsForTextStrokeGroup:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000dda70
- (id)textCorrectionResultsForGroupingResult:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000dda60
- (id)recognitionResultsForGroupingResult:(id)arg1 groupingManager:(id)arg2;	// IMP=0x00000000000dcf80
- (void)_logResultsIfAppropriateWithStrokeProvider:(id)arg1;	// IMP=0x00000000000dcf50
- (_Bool)_isTransitionValidFromStatus:(long long)arg1 toStatus:(long long)arg2;	// IMP=0x00000000000dcf20
- (void)cancel;	// IMP=0x00000000000dce10
- (void)main;	// IMP=0x00000000000dacf0
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6 isHighResponsivenessTask:(_Bool)arg7 strokeClassificationModel:(id)arg8 strokeGroupingRequirement:(long long)arg9 subjectStrokeIdentifiers:(id)arg10 partialResultBlock:(CDUnknownBlockType)arg11;	// IMP=0x00000000000dac40
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6 isHighResponsivenessTask:(_Bool)arg7 strokeClassificationModel:(id)arg8 strokeGroupingRequirement:(long long)arg9 partialResultBlock:(CDUnknownBlockType)arg10;	// IMP=0x00000000000da930
- (id)initWithLocales:(id)arg1 preferredLocales:(id)arg2 strokeProvider:(id)arg3 inputResult:(id)arg4 recognitionQOSClass:(unsigned int)arg5 recognitionEnvironment:(long long)arg6;	// IMP=0x00000000000da8e0
- (id)init;	// IMP=0x00000000000da830
