...
- (struct CGRect)unionCharacterRects;	// IMP=0x0000000000070990
- (struct _NSRange)referenceSubstringRangeOfComposedCharacterAtIndex:(long long)arg1;	// IMP=0x00000000000708f0
- (id)referenceSubstringInRange:(struct _NSRange)arg1;	// IMP=0x0000000000070840
- (void)enumerateCharacterRectsInRange:(struct _NSRange)arg1 reverse:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000070610
- (void)enumerateCharacterRectsInRange:(struct _NSRange)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000000705f0
- (struct CGRect)visualCharacterRectForCharacterIndex:(long long)arg1;	// IMP=0x00000000000703b0
- (struct CGRect)characterRectForCharacterIndex:(long long)arg1;	// IMP=0x0000000000070350
- (long long)relativeLocationFromAbsoluteLocation:(long long)arg1;	// IMP=0x0000000000070330
- (long long)absoluteLocationFromRelativeLocation:(long long)arg1;	// IMP=0x0000000000070310
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000700b0
- (id)description;	// IMP=0x000000000006fba0
- (void)dealloc;	// IMP=0x000000000006fb60
- (id)initWithTextInputTarget:(id)arg1 contentLength:(long long)arg2 referenceSubstring:(id)arg3 referenceSubstringRange:(struct _NSRange)arg4 charRectsInReferenceSubstring:(struct CGRect *)arg5 strokeCoveredTextRange:(struct _NSRange)arg6 selectedTextRange:(struct _NSRange)arg7 activePreviewRange:(struct _NSRange)arg8 contentType:(int)arg9 lastCharacterLevelPosition:(long long)arg10;	// IMP=0x000000000006fb00
- (id)initWithTextInputTarget:(id)arg1 contentLength:(long long)arg2 referenceSubstring:(id)arg3 referenceSubstringRange:(struct _NSRange)arg4 charRectsInReferenceSubstring:(struct CGRect *)arg5 strokeCoveredTextRange:(struct _NSRange)arg6 selectedTextRange:(struct _NSRange)arg7 isCursorStrong:(_Bool)arg8 activePreviewRange:(struct _NSRange)arg9 contentType:(int)arg10 isSingleLine:(_Bool)arg11 lastCharacterLevelPosition:(long long)arg12;	// IMP=0x000000000006fa70
- (id)initWithTextInputTarget:(id)arg1 contentLength:(long long)arg2 referenceSubstring:(id)arg3 referenceSubstringRange:(struct _NSRange)arg4 charRectsInReferenceSubstring:(struct CGRect *)arg5 strokeCoveredTextRange:(struct _NSRange)arg6 selectedTextRange:(struct _NSRange)arg7 isCursorStrong:(_Bool)arg8 activePreviewRange:(struct _NSRange)arg9 contentType:(int)arg10 autoCapitalizationMode:(int)arg11 autoCorrectionMode:(int)arg12 isSingleLine:(_Bool)arg13 lastCharacterLevelPosition:(long long)arg14;	// IMP=0x000000000006f9e0
