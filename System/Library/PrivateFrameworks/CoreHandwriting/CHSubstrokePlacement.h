...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000eed40
- (void).cxx_destruct;	// IMP=0x00000000000eede0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000eead0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ee940
- (struct CGRect)orientedBounds;	// IMP=0x00000000000ee370
- (struct CGAffineTransform)orientationTransform;	// IMP=0x00000000000ee220
@property(readonly, nonatomic) struct CGRect rotatedBounds;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eddd0
- (id)initWithSubstroke:(id)arg1;	// IMP=0x00000000000edd50
