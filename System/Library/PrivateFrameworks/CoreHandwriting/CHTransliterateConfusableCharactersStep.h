...
+ (id)characterTransliterations;	// IMP=0x0000000000183e20
- (void).cxx_destruct;	// IMP=0x0000000000184650
...
- (unsigned int)wordIDForCandidateString:(id)arg1;	// IMP=0x0000000000183d90
- (id)handleConfusableCharactersInToken:(id)arg1 previousContext:(id)arg2;	// IMP=0x00000000001833f0
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x0000000000182650
- (id)initWithStaticLexicon:(struct _LXLexicon *)arg1 customLexicon:(struct _LXLexicon *)arg2 locale:(id)arg3;	// IMP=0x0000000000182550
