...
- (void).cxx_destruct;	// IMP=0x0000000000051ae0
...
- (id)description;	// IMP=0x00000000000510c0
- (void)recordTextResult:(id)arg1 recognitionError:(id)arg2;	// IMP=0x0000000000051d40
- (void)recordInputDrawing:(id)arg1;	// IMP=0x0000000000051d20
- (void)recordConfigurationForRecognizer:(id)arg1 options:(id)arg2;	// IMP=0x0000000000051b60
- (void)recordInsightRequest:(id)arg1;	// IMP=0x0000000000051b40
