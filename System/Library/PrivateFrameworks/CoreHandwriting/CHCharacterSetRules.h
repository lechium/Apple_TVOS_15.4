...
+ (unsigned long long)characterTypeFromString:(id)arg1;	// IMP=0x000000000013bf40
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x000000000013bdf0
+ (unsigned long long)expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x000000000013bca0
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x000000000013bb50
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x000000000013ba00
+ (id)sharedCharacterSetRules;	// IMP=0x000000000013b990
- (id).cxx_construct;	// IMP=0x000000000013e4f0
- (void).cxx_destruct;	// IMP=0x000000000013e310
...
- (unsigned long long)_expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x000000000013dbf0
- (unsigned long long)_characterType:(unsigned int)arg1;	// IMP=0x000000000013d510
- (unsigned long long)_expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x000000000013cf70
- (unsigned long long)_expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x000000000013c780
- (id)init;	// IMP=0x000000000013c060
