...
- (void).cxx_destruct;	// IMP=0x00000000000d07f0
...
- (id)initWithModelName:(id)arg1 featureIndex:(long long)arg2;	// IMP=0x00000000000cf8c0
- (id)initWithModelName:(id)arg1;	// IMP=0x00000000000cf840
