...
- (void).cxx_destruct;	// IMP=0x00000000000f3450
...
- (void)_markStrokeGroupsAsActive:(id)arg1;	// IMP=0x00000000000f3120
- (void)toggleVisualizationRegionAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000000f2c00
- (void)drawVisualizationInRect:(struct CGRect)arg1 context:(struct CGContext *)arg2 viewBounds:(struct CGRect)arg3;	// IMP=0x00000000000f2ac0
- (void)recognitionSessionDidUpdateRecognitionResult;	// IMP=0x00000000000f25c0
- (struct CGRect)dirtyRectForStrokeGroup:(id)arg1;	// IMP=0x00000000000f2580
