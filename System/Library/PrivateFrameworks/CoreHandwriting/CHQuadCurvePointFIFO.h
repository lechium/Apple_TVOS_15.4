...
+ (MISSING_TYPE *)interpolateFromPoint:(float)arg1 toPoint:controlPoint:time: /* Error: Ran out of types for this method. */;	// IMP=0x00000000000a6ed0
- (id).cxx_construct;	// IMP=0x00000000000a89a0
...
- (void)clear;	// IMP=0x00000000000a8490
- (void)flush;	// IMP=0x00000000000a7be0
- (void)addPoint: /* Error: Ran out of types for this method. */;	// IMP=0x00000000000a6f50
- (void)setUnitScaleForViewSize:(struct CGSize)arg1 normalizedSize:(struct CGSize)arg2 contentScaleFactor:(double)arg3;	// IMP=0x00000000000a6f10
- (void)dealloc;	// IMP=0x00000000000a6e50
- (id)initWithFIFO:(id)arg1 drawingTarget:(id)arg2;	// IMP=0x00000000000a6dd0
- (id)initWithFIFO:(id)arg1;	// IMP=0x00000000000a6d60
