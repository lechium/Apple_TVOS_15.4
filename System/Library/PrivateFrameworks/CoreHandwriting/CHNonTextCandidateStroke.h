...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000724d0
- (void).cxx_destruct;	// IMP=0x0000000000073060
...
- (unsigned long long)hash;	// IMP=0x00000000000729f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000072970
- (_Bool)isEqualToNonTextCandidateStroke:(id)arg1;	// IMP=0x00000000000724e0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000072070
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000071d70
@property(readonly, nonatomic) long long effectiveClassification;
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000071c90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000071be0
- (id)initWithStrokeIdentifier:(id)arg1 substrokesCount:(long long)arg2 classificationAsNonText:(long long)arg3 lineOrientation:(double)arg4 lineError:(double)arg5 containerScore:(double)arg6 bounds:(struct CGRect)arg7 boundsDiagonal:(double)arg8 enlargedBounds:(struct CGRect)arg9 rotatedBounds:(struct CGRect)arg10 supportByStrokeIdentifier:(id)arg11 support:(double)arg12;	// IMP=0x0000000000071a40
- (id)initWithStroke:(id)arg1 consistingOfSubstrokes:(id)arg2 classificationAsNonText:(long long)arg3 lineOrientation:(double)arg4 lineError:(double)arg5 containerScore:(double)arg6;	// IMP=0x0000000000071360
