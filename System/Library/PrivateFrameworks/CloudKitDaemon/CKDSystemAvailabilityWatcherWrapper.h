...
- (void).cxx_destruct;	// IMP=0x00000000000e21ef
...
- (id)description;	// IMP=0x00000000000e20b3
- (unsigned long long)hash;	// IMP=0x00000000000e20a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e2024
- (void)postSystemAvailabilityChanged:(unsigned long long)arg1;	// IMP=0x00000000000e1f9a
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000e1f08
