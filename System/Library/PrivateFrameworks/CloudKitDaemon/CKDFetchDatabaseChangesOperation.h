...
- (void).cxx_destruct;	// IMP=0x00000000002606b7
...
- (id)analyticsPayload;	// IMP=0x000000000026038f
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002602f4
- (void)main;	// IMP=0x0000000000260127
- (void)_handleAnonymousZoneDataObjects:(id)arg1 schedulerInfo:(id)arg2;	// IMP=0x000000000025f54e
- (void)_sendFetchDatabaseChangesRequestWithChangeToken:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000025d8ea
- (int)operationType;	// IMP=0x000000000025d8df
- (void)_handleFetchDatabaseChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000025d3be
- (id)activityCreate;	// IMP=0x000000000025d395
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (_Bool)shouldReturnServerChangeTokensToAdopter;	// IMP=0x000000000025d201
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000025cf82
