...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000145940
- (unsigned long long)hash;	// IMP=0x00000000001458a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000145786
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001456ba
- (void)copyTo:(id)arg1;	// IMP=0x0000000000145611
- (void)writeTo:(id)arg1;	// IMP=0x0000000000145541
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000145534
- (id)dictionaryRepresentation;	// IMP=0x0000000000144ef4
- (id)description;	// IMP=0x0000000000144e45
