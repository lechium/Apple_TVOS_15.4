...
- (void).cxx_destruct;	// IMP=0x000000000023b049
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000023aa37
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000023a65d
- (id)_handleRecords:(id)arg1;	// IMP=0x000000000023a34c
- (id)generateRequestOperations;	// IMP=0x0000000000239c04
- (id)requestOperationClasses;	// IMP=0x0000000000239b98
- (id)zoneIDsToLock;	// IMP=0x0000000000239b86
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002399d1
