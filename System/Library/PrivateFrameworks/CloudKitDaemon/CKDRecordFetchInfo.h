...
- (void).cxx_destruct;	// IMP=0x00000000001e2be1
...
- (id)description;	// IMP=0x00000000001e2af4
- (id)CKPropertiesDescription;	// IMP=0x00000000001e2784
- (void)performCallback;	// IMP=0x00000000001e23e0
- (id)initWithAggregator:(id)arg1;	// IMP=0x00000000001e22fc
