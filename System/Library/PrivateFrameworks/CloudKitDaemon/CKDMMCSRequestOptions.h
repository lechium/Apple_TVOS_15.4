...
@interface CKDMMCSRequestOptions : NSObject
{
    ...
    unsigned long long _networkServiceType;	// 152 = 0x98
    CKOperationMMCSRequestOptions *_MMCSRequestOptions;	// 160 = 0xa0
}

- (void).cxx_destruct;	// IMP=0x000000000028f0a0
...
- (id)MMCSOptions;	// IMP=0x000000000028e277
- (_Bool)usesBackgroundSession;	// IMP=0x000000000028e223
- (id)description;	// IMP=0x000000000028e211
- (id)CKPropertiesDescription;	// IMP=0x000000000028dd67
- (id)initWithOperation:(id)arg1;	// IMP=0x000000000028da25
