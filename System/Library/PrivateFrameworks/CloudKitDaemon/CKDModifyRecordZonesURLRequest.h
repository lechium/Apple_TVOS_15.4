...
- (void).cxx_destruct;	// IMP=0x0000000000313c2f
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000313a05
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000031374a
- (id)generateRequestOperations;	// IMP=0x0000000000312e38
- (id)requestOperationClasses;	// IMP=0x0000000000312d51
- (id)zoneIDsToLock;	// IMP=0x0000000000312a94
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000312a8c
- (id)initWithOperation:(id)arg1 recordZonesToSave:(id)arg2 recordZoneIDsToDelete:(id)arg3;	// IMP=0x00000000003129c1
