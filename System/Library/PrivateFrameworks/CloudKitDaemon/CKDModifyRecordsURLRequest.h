...
- (void).cxx_destruct;	// IMP=0x00000000002f57fb
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002f5235
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002f46be
- (void)addSignatureForRequestOperation:(id)arg1;	// IMP=0x00000000002f415f
- (id)generateRequestOperations;	// IMP=0x00000000002f1fad
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002f1fa5
- (int)isolationLevel;	// IMP=0x00000000002f1f88
- (id)requestOperationClasses;	// IMP=0x00000000002f1ea1
- (id)zoneIDsToLock;	// IMP=0x00000000002f1b46
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002f1b2c
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x00000000002f199c
