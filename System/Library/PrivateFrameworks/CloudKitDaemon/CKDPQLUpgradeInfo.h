...
+ (id)upgradeInfoWithVersion:(unsigned long long)arg1 function:(CDUnknownFunctionPointerType)arg2 shouldVacuum:(_Bool)arg3 shouldTruncate:(_Bool)arg4;	// IMP=0x000000000030c94f
...
- (id)initWithVersion:(unsigned long long)arg1 function:(CDUnknownFunctionPointerType)arg2 shouldVacuum:(_Bool)arg3 shouldTruncate:(_Bool)arg4;	// IMP=0x000000000030c8f1
