...
- (void).cxx_destruct;	// IMP=0x00000000002fde8e
...
- (id)description;	// IMP=0x00000000002fddaa
- (id)CKPropertiesDescription;	// IMP=0x00000000002fdc2c
- (_Bool)isEmptyOfRereferencesAssets;	// IMP=0x00000000002fdb49
- (_Bool)isEmptyOfAssets;	// IMP=0x00000000002fda66
- (_Bool)isRereferenceAssetBatch;	// IMP=0x00000000002fd954
- (_Bool)isPackageSectionBatch;	// IMP=0x00000000002fd842
- (id)firstMMCSItemError;	// IMP=0x00000000002fd6f2
- (void)failIfNotDoneAllRegularAndSectionAndRereferenceItemsWithError:(id)arg1;	// IMP=0x00000000002fd549
@property(readonly, nonatomic) NSArray *allRegularAndSectionAndRereferenceItems;
- (id)allMMCSAndSectionItems;	// IMP=0x00000000002fd314
...
- (void)addAssetRecord:(id)arg1;	// IMP=0x00000000002fd120
- (id)initWithAssetZone:(id)arg1;	// IMP=0x00000000002fd09b
