...
- (void).cxx_destruct;	// IMP=0x0000000000315c3a
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000031594f
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003144fc
- (id)generateRequestOperations;	// IMP=0x0000000000313e7c
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000313dfe
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x0000000000313df6
- (id)requestOperationClasses;	// IMP=0x0000000000313d8a
- (id)zoneIDsToLock;	// IMP=0x0000000000313d78
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000313d5e
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2;	// IMP=0x0000000000313c93
