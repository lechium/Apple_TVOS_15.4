...
- (void).cxx_destruct;	// IMP=0x00000000002fc971
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002fc758
- (unsigned long long)hash;	// IMP=0x00000000002fc637
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002fc413
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002fc27a
- (void)copyTo:(id)arg1;	// IMP=0x00000000002fc13f
- (void)writeTo:(id)arg1;	// IMP=0x00000000002fc001
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002fbff4
- (id)dictionaryRepresentation;	// IMP=0x00000000002fb53c
- (id)description;	// IMP=0x00000000002fb48d
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x00000000002fb370
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x00000000002fb2ef
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x00000000002faca8
- (id)operationTypeAsString:(int)arg1;	// IMP=0x00000000002fa863
@property(nonatomic) _Bool hasOperationType;
@property(nonatomic) int operationType; // @synthesize operationType=_operationType;
- (int)StringAsContainerEnvironment:(id)arg1;	// IMP=0x00000000002fa792
- (id)containerEnvironmentAsString:(int)arg1;	// IMP=0x00000000002fa73c
