...
- (void).cxx_destruct;	// IMP=0x000000000019b698
...
- (id)readBytesOfInMemoryAssetContentWithContainer:(id)arg1 offset:(unsigned long long)arg2 length:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x000000000019afd5
- (id)getFileMetadataWithFileHandle:(id)arg1 error:(id *)arg2;	// IMP=0x000000000019af43
- (id)getFileMetadataWithContainer:(id)arg1 fileHandle:(id)arg2 error:(id *)arg3;	// IMP=0x000000000019ad87
- (id)getFileSizeWithError:(id *)arg1;	// IMP=0x000000000019ad70
- (id)getFileSizeWithOperation:(id)arg1 error:(id *)arg2;	// IMP=0x000000000019ac27
- (id)openWithError:(id *)arg1;	// IMP=0x000000000019ac10
- (id)openWithOperation:(id)arg1 error:(id *)arg2;	// IMP=0x000000000019a957
- (id)_openInfo;	// IMP=0x000000000019a6ef
- (id)description;	// IMP=0x000000000019a6dd
- (id)CKPropertiesDescription;	// IMP=0x00000000001998e8
- (void)clearFileSize;	// IMP=0x00000000001998c8
- (_Bool)canBeRegistered;	// IMP=0x00000000001998af
- (id)initWithPackage:(id)arg1;	// IMP=0x00000000001996b0
- (void)setupForGetChunkKeysWithAsset:(id)arg1 destinationDatabaseScope:(long long)arg2;	// IMP=0x000000000019941a
- (id)initWithAsset:(id)arg1;	// IMP=0x0000000000198f2c
- (id)init;	// IMP=0x0000000000198efd
