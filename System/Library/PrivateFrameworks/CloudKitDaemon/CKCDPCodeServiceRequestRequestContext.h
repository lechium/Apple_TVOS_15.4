...
- (void).cxx_destruct;	// IMP=0x000000000030c13b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000030be50
- (unsigned long long)hash;	// IMP=0x000000000030bcd9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030ba47
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000030b855
- (void)copyTo:(id)arg1;	// IMP=0x000000000030b6d1
- (void)writeTo:(id)arg1;	// IMP=0x000000000030b559
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000030b54c
- (id)dictionaryRepresentation;	// IMP=0x000000000030ad3a
- (id)description;	// IMP=0x000000000030ac8b
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x000000000030aad8
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x000000000030aa3f
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x000000000030a973
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x000000000030a91e
