...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001c61ed
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c6bae
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c61f5
- (id)initWithProtocol:(id)arg1 invocation:(id)arg2 isCompletionCallback:(_Bool)arg3;	// IMP=0x00000000001c613a
- (void)_validateInvocation;	// IMP=0x00000000001c5bac
