...
- (void).cxx_destruct;	// IMP=0x000000000026cdb1
...
- (id)relevantZoneIDs;	// IMP=0x000000000026c7ed
- (_Bool)supportsClearAssetEncryption;	// IMP=0x000000000026c7e5
- (void)main;	// IMP=0x000000000026c4b8
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000026c3e3
- (void)finishWithError:(id)arg1;	// IMP=0x000000000026c353
- (void)_downloadAssets;	// IMP=0x000000000026a92d
- (void)_fetchCloudCerts;	// IMP=0x000000000026a283
- (void)_didDownloadAssetsWithError:(id)arg1;	// IMP=0x000000000026a0a3
- (void)_finishAllDownloadTasksWithError:(id)arg1;	// IMP=0x0000000000269f80
- (void)_addAssetDownloadTaskForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000026888d
- (void)_addDownloadTasksForRecord:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000268636
- (int)_prepareAsset:(id)arg1 record:(id)arg2 recordKey:(id)arg3 assetTransferOptions:(id)arg4;	// IMP=0x0000000000267d49
- (void)_decryptPropertiesIfNeededForRecord:(id)arg1 record:(id)arg2;	// IMP=0x0000000000267c71
- (void)_handleSharePCSPrepForShare:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000026740d
- (void)_handleRecordFetch:(id)arg1 recordID:(id)arg2 etagMatched:(_Bool)arg3 responseCode:(id)arg4;	// IMP=0x00000000002665db
- (void)_fetchPCSForMergeableValueDeltaRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002660df
- (void)_reallyDecryptPropertiesOnRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x0000000000265c71
- (void)_decryptPropertiesOnRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x0000000000265c5f
...
- (void)_continueHandleFetchedRecord:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002644d8
- (void)setError:(id)arg1 forRecordID:(id)arg2;	// IMP=0x00000000002643ce
- (id)errorForRecordID:(id)arg1;	// IMP=0x00000000002642fe
- (void)fetchRecordsWithIDs:(id)arg1 andFullRecords:(id)arg2;	// IMP=0x0000000000262b26
- (int)operationType;	// IMP=0x0000000000262b1b
- (void)_findSpecialParticipantsOnShare:(id)arg1 identityDelegate:(id)arg2;	// IMP=0x0000000000262678
- (void)_saveUpdatedShareRecords;	// IMP=0x00000000002621a9
- (id)desiredIndexedListKeys;	// IMP=0x0000000000261df4
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000261d5c
- (_Bool)makeStateTransition;	// IMP=0x0000000000261a10
- (id)activityCreate;	// IMP=0x00000000002619e7
- (id)cache:(id *)arg1;	// IMP=0x00000000002618c3
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002614da
