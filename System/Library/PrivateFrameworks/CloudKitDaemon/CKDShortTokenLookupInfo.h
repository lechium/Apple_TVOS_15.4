...
- (void).cxx_destruct;	// IMP=0x00000000000f65f0
...
- (unsigned long long)hash;	// IMP=0x00000000000f6509
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f6294
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f615e
