...
- (void).cxx_destruct;	// IMP=0x00000000003068c3
...
- (void)cancelAllOperations;	// IMP=0x00000000003064ed
- (void)requestFetchOfZoneWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000030629a
- (void)requestFetchOfShareWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000305ef9
- (void)requestFetchOfRecordWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000305ad4
- (_Bool)fetchRequestForExistingOperation:(id)arg1 isDependentOnOperation:(id)arg2;	// IMP=0x0000000000305552
- (id)_lockedGetQueuedFetchForOperation:(id)arg1 ofClass:(Class)arg2;	// IMP=0x0000000000304e57
- (void)_lockedRescheduleFetchTimer;	// IMP=0x0000000000304b68
- (void)_lockedTearDownFetchTimer;	// IMP=0x0000000000304ae3
- (void)_lockedFetchesAreReady;	// IMP=0x0000000000303dc1
- (void)dealloc;	// IMP=0x0000000000303d74
- (id)initWithContainer:(id)arg1;	// IMP=0x0000000000303bbc
- (id)init;	// IMP=0x0000000000303b5c
