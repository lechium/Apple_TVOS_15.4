...
- (void).cxx_destruct;	// IMP=0x00000000002beee8
...
- (void)dealloc;	// IMP=0x00000000002beaff
- (id)initWithIdentitySet:(struct _PCSIdentitySetData *)arg1 withPrimaryServiceName:(id)arg2;	// IMP=0x00000000002bea7c
