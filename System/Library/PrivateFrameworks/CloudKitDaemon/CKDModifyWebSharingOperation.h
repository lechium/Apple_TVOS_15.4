...
+ (long long)isPredominatelyDownload;	// IMP=0x00000000000b5acd
- (void).cxx_destruct;	// IMP=0x00000000000b5ec3
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000b5d29
- (void)main;	// IMP=0x00000000000b5ad5
- (void)_fetchRecords;	// IMP=0x00000000000b52b3
- (void)_handleRecordFetched:(id)arg1 recordID:(id)arg2 error:(id)arg3;	// IMP=0x00000000000b4381
- (struct _PCSIdentityData *)_copyShareProtectionFromRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b3f34
- (void)_saveRecords;	// IMP=0x00000000000b34d4
- (void)_handleRecordSaved:(id)arg1 error:(id)arg2;	// IMP=0x00000000000b2e7a
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000b2e18
- (_Bool)makeStateTransition;	// IMP=0x00000000000b2c84
- (id)activityCreate;	// IMP=0x00000000000b2c5b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000b2b32
