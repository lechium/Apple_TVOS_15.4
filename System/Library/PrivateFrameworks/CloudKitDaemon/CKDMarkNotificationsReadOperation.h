...
+ (long long)isPredominatelyDownload;	// IMP=0x0000000000271d8e
- (void).cxx_destruct;	// IMP=0x000000000027254a
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000272453
- (void)main;	// IMP=0x0000000000271da1
- (int)operationType;	// IMP=0x0000000000271d96
- (void)_handleNotificationID:(id)arg1 withResponse:(id)arg2;	// IMP=0x0000000000271aa1
- (id)activityCreate;	// IMP=0x0000000000271a78
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002719a9
