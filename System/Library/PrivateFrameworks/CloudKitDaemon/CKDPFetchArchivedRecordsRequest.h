...
+ (id)options;	// IMP=0x00000000001818f8
- (void).cxx_destruct;	// IMP=0x000000000018263a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001824bd
- (unsigned long long)hash;	// IMP=0x0000000000182407
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001822ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001821a6
- (void)copyTo:(id)arg1;	// IMP=0x00000000001820e6
- (void)writeTo:(id)arg1;	// IMP=0x000000000018201d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000182010
- (id)dictionaryRepresentation;	// IMP=0x0000000000181ac4
- (id)description;	// IMP=0x0000000000181a15
