...
- (void).cxx_destruct;	// IMP=0x00000000002bea12
...
- (void)cancel;	// IMP=0x00000000002be928
...
- (id)activityCreate;	// IMP=0x00000000002be6be
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x00000000002be518
