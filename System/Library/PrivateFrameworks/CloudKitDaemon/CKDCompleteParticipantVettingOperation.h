...
- (void).cxx_destruct;	// IMP=0x00000000000c4bce
...
- (void)main;	// IMP=0x00000000000c4a77
- (void)_verifyOONParticipant;	// IMP=0x00000000000c4246
- (void)_reconstructShareURL;	// IMP=0x00000000000c3ffc
- (void)_forceFetchShareMetadata;	// IMP=0x00000000000c38c1
- (void)_performAuthKitVerification;	// IMP=0x00000000000c32c6
- (void)_reconstructShortToken;	// IMP=0x00000000000c2d4d
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x00000000000c2d38
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x00000000000c2c3c
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000c2b54
- (_Bool)makeStateTransition;	// IMP=0x00000000000c29f8
- (id)activityCreate;	// IMP=0x00000000000c29cf
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000c27a8
