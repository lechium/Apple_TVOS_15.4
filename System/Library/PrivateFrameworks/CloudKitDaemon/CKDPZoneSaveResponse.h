...
- (void).cxx_destruct;	// IMP=0x0000000000326c6c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000326b61
- (unsigned long long)hash;	// IMP=0x0000000000326aed
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003269ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032692c
- (void)copyTo:(id)arg1;	// IMP=0x00000000003268a9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000326827
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000032681a
- (id)dictionaryRepresentation;	// IMP=0x0000000000326449
- (id)description;	// IMP=0x000000000032639a
