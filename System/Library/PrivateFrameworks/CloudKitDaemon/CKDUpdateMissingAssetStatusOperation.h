...
- (void).cxx_destruct;	// IMP=0x00000000001bfe96
...
- (void)main;	// IMP=0x00000000001bfd64
- (void)_updateMissingAssetStatus;	// IMP=0x00000000001bf825
- (int)operationType;	// IMP=0x00000000001bf81a
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000001bf7ca
- (_Bool)makeStateTransition;	// IMP=0x00000000001bf725
- (id)activityCreate;	// IMP=0x00000000001bf6fc
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001bf5e1
