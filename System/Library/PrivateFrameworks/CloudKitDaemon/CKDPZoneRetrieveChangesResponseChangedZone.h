...
- (void).cxx_destruct;	// IMP=0x000000000020690d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000206766
- (unsigned long long)hash;	// IMP=0x0000000000206686
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000206504
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002063e3
- (void)copyTo:(id)arg1;	// IMP=0x0000000000206300
- (void)writeTo:(id)arg1;	// IMP=0x0000000000206219
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000020620c
- (id)dictionaryRepresentation;	// IMP=0x0000000000205b54
- (id)description;	// IMP=0x0000000000205aa5
...
- (int)StringAsDeleteType:(id)arg1;	// IMP=0x0000000000205993
- (id)deleteTypeAsString:(int)arg1;	// IMP=0x000000000020592c
@property(nonatomic) _Bool hasDeleteType;
@property(nonatomic) int deleteType; // @synthesize deleteType=_deleteType;
- (int)StringAsChangeType:(id)arg1;	// IMP=0x000000000020585a
- (id)changeTypeAsString:(int)arg1;	// IMP=0x0000000000205804
