...
- (void).cxx_destruct;	// IMP=0x0000000000261470
...
- (void)didCompleteTaskWithError:(id)arg1;	// IMP=0x0000000000260eed
- (void)didFillOutURLInfo:(id)arg1 error:(id)arg2;	// IMP=0x0000000000260dcb
- (void)didDownloadAsset:(id)arg1 error:(id)arg2;	// IMP=0x0000000000260c09
- (id)initWithRecord:(id)arg1 trackProgress:(_Bool)arg2 assetsToDownload:(id)arg3 assetsToDownloadInMemory:(id)arg4 packageIndexSets:(id)arg5 assetURLInfosToFillOut:(id)arg6;	// IMP=0x0000000000260760
