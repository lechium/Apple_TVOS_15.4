...
- (void).cxx_destruct;	// IMP=0x00000000000bf097
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bf02e
- (unsigned long long)hash;	// IMP=0x00000000000befef
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bedae
- (id)description;	// IMP=0x00000000000bed9c
- (id)CKPropertiesDescription;	// IMP=0x00000000000beb62
@property(readonly, nonatomic) _Bool isCrossOwner;
- (id)initWithDestinationZoneID:(id)arg1 destinationDatabaseScope:(long long)arg2 sourceZoneID:(id)arg3 sourceDatabaseScope:(long long)arg4;	// IMP=0x00000000000bea14
- (id)initWithDestinationZoneID:(id)arg1 destinationDatabaseScope:(long long)arg2;	// IMP=0x00000000000be9fc
