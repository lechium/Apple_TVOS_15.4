...
- (void).cxx_destruct;	// IMP=0x00000000002e40e0
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002e3b75
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002e3035
- (id)requestedListFieldsForDesiredIndexedListKeys;	// IMP=0x00000000002e293f
- (id)generateRequestOperations;	// IMP=0x00000000002e1758
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002e1750
- (_Bool)requestGETPreAuth;	// IMP=0x00000000002e16e3
- (id)requestOperationClasses;	// IMP=0x00000000002e1677
- (id)zoneIDsToLock;	// IMP=0x00000000002e14b5
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002e149b
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 recordIDsToEtags:(id)arg3 recordIDsToVersionETags:(id)arg4 desiredKeys:(id)arg5;	// IMP=0x00000000002e135b
