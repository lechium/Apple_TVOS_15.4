...
+ (long long)isPredominatelyDownload;	// IMP=0x00000000000ed229
- (void).cxx_destruct;	// IMP=0x00000000000ed964
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000ed703
- (void)main;	// IMP=0x00000000000ed653
- (void)_checkAndPrepareZones;	// IMP=0x00000000000ed231
- (void)_fetchPCSDataForZonesFromServer:(_Bool)arg1;	// IMP=0x00000000000ecc5f
- (void)_fetchPCSDataForZone:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x00000000000ebefe
- (void)_createNewPCSForZone:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ead25
- (_Bool)isOperationType:(int)arg1;	// IMP=0x00000000000eac95
- (int)operationType;	// IMP=0x00000000000eac45
- (_Bool)_saveZonesToServer;	// IMP=0x00000000000ea2a4
- (void)_handleRecordZoneDeleted:(id)arg1 responseCode:(id)arg2;	// IMP=0x00000000000e9db2
- (void)_handleRecordZoneSaved:(id)arg1 responseCode:(id)arg2 serverCapabilities:(unsigned long long)arg3 expirationDate:(id)arg4 expired:(_Bool)arg5;	// IMP=0x00000000000e8a84
- (void)_sendErrorForFailedZones;	// IMP=0x00000000000e835e
- (void)_sendCoreAnalyticsEventForKeySync;	// IMP=0x00000000000e8127
- (void)_sychronizeUserKeyRegistryIfNeeded;	// IMP=0x00000000000e79e8
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000000e79e0
- (id)relevantZoneIDs;	// IMP=0x00000000000e7901
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000e788d
- (id)activityCreate;	// IMP=0x00000000000e7864
- (_Bool)makeStateTransition;	// IMP=0x00000000000e762f
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000e72a0
