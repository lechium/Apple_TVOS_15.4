...
- (void).cxx_destruct;	// IMP=0x000000000001f292
...
- (_Bool)canOpenFileAtURL:(id)arg1;	// IMP=0x000000000001f04a
- (_Bool)hasValidatedEntitlements;	// IMP=0x000000000001ee25
- (void)noteSystemIsAvailable;	// IMP=0x000000000001ede8
- (id)issueSandboxExtensionForItem:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001e844
- (void)handleSignificantIssueBehavior:(unsigned long long)arg1 reason:(id)arg2;	// IMP=0x000000000001e77d
- (id)getFileMetadataWithFileHandle:(id)arg1 openInfo:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001e1dd
- (void)_getProcessScopedClientProxyCreatorSynchronous:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001dd85
- (void)getProcessScopedClientProxySynchronous:(_Bool)arg1 errorHandler:(CDUnknownBlockType)arg2 clientProxyHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001dbeb
- (void)tearDown;	// IMP=0x000000000001dbe5
- (_Bool)processIsAttached;	// IMP=0x000000000001dbcc
- (id)initWithClientConnection:(id)arg1;	// IMP=0x000000000001d726
- (id)description;	// IMP=0x000000000001d714
- (id)CKPropertiesDescription;	// IMP=0x000000000001d5e0
