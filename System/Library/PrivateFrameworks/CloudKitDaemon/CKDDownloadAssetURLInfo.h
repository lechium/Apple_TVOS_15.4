...
- (void).cxx_destruct;	// IMP=0x00000000002d168c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d157b
- (unsigned long long)hash;	// IMP=0x00000000002d1537
- (void)dealloc;	// IMP=0x00000000002d14f0
