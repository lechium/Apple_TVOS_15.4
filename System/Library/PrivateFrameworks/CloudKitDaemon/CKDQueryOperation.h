...
- (void).cxx_destruct;	// IMP=0x00000000000676c6
...
- (id)relevantZoneIDs;	// IMP=0x0000000000067448
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000673e2
- (void)main;	// IMP=0x00000000000669bb
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000000656cf
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000000649e3
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x00000000000647e0
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x0000000000064133
- (id)activityCreate;	// IMP=0x000000000006410a
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x00000000000640f2
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000063d91
