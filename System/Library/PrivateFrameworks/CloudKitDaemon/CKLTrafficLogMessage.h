...
- (void).cxx_destruct;	// IMP=0x00000000002f5d36
...
- (id)description;	// IMP=0x00000000002f5c1a
- (id)CKPropertiesDescription;	// IMP=0x00000000002f5b5d
@property(readonly, nonatomic) NSString *containerIdentifier;
@property(readonly, nonatomic) NSString *bundleIdentifier;
- (id)_initWithUUID:(id)arg1 requestMetadata:(id)arg2 requestObjects:(id)arg3 bodyStreamResetCount:(long long)arg4 responseMetadata:(id)arg5 responseObjects:(id)arg6;	// IMP=0x00000000002f58d6
