...
- (void).cxx_destruct;	// IMP=0x000000000004f7d9
...
- (void)resumeCallbackQueue;	// IMP=0x000000000004f670
- (void)suspendCallbackQueue;	// IMP=0x000000000004f5cd
- (void)cancelAndDisablePerRequestCallbackBlocks;	// IMP=0x000000000004f582
- (void)disablePerRequestCallbackBlocks;	// IMP=0x000000000004f540
- (void)addPerRequestCallbackBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000004f4b1
- (void)dealloc;	// IMP=0x000000000004f431
- (id)initWithRequest:(id)arg1 operation:(id)arg2;	// IMP=0x000000000004f238
