...
- (void).cxx_destruct;	// IMP=0x0000000000248a2e
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000248508
- (id)generateRequestOperations;	// IMP=0x00000000002482b0
- (id)requestOperationClasses;	// IMP=0x0000000000248244
- (id)initWithOperation:(id)arg1 serverChangeTokenData:(id)arg2;	// IMP=0x00000000002481ab
