...
- (void).cxx_destruct;	// IMP=0x0000000000238c87
...
- (void)main;	// IMP=0x000000000023874f
- (_Bool)shouldCheckAppVersion;	// IMP=0x0000000000238747
- (id)activityCreate;	// IMP=0x000000000023871e
