...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001af1a3
- (void).cxx_destruct;	// IMP=0x00000000001af478
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001af39e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001af28e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001af1ab
- (id)initWithZoneID:(id)arg1 shareID:(id)arg2;	// IMP=0x00000000001af10a
