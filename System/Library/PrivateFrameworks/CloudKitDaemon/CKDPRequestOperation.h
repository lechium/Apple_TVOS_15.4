...
- (void).cxx_destruct;	// IMP=0x000000000013758f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000136b77
- (unsigned long long)hash;	// IMP=0x0000000000136667
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000135ce7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013556c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000134fa9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000134a6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000134a60
- (id)dictionaryRepresentation;	// IMP=0x0000000000132cdd
- (id)description;	// IMP=0x0000000000132c2e
