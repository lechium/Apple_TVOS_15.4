...
- (void).cxx_destruct;	// IMP=0x000000000012d5fd
...
- (void)finishWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000012d339
- (void)processData:(id)arg1;	// IMP=0x000000000012d0d8
- (_Bool)_parseObjects:(_Bool)arg1;	// IMP=0x000000000012c7a9
- (_Bool)_parseObjectFromData:(id)arg1 rawData:(id)arg2;	// IMP=0x000000000012c418
- (id)initWithQoS:(long long)arg1;	// IMP=0x000000000012c3d9
