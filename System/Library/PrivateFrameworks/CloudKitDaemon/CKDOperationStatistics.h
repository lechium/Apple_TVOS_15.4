...
- (void).cxx_destruct;	// IMP=0x00000000000d918b
...
- (id)CKStatusReportArray;	// IMP=0x00000000000d896f
- (void)merge:(id)arg1;	// IMP=0x00000000000d8439
- (void)addOperation:(id)arg1;	// IMP=0x00000000000d7f00
- (id)_trimmedError:(id)arg1;	// IMP=0x00000000000d79df
- (void)_addMetrics:(id)arg1 toAggregate:(id)arg2;	// IMP=0x00000000000d781a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d76c8
- (id)initWithOperationClassName:(id)arg1;	// IMP=0x00000000000d7628
