...
- (void).cxx_destruct;	// IMP=0x00000000001e7d21
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000001e7ab0
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001e79ef
- (void)_finishRecordFetchAggregator;	// IMP=0x00000000001e75e7
- (void)finishIfAppropriate;	// IMP=0x00000000001e745d
- (void)fetchRecords:(id)arg1 withPerRecordCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001e7158
- (id)_fetchRecord:(id)arg1 recordReadyHandle:(_Bool *)arg2 withRecordCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e659e
- (void)main;	// IMP=0x00000000001e62f7
- (void)_addRecordFetchInfos:(id)arg1;	// IMP=0x00000000001e5e9a
- (void)_recordFetchesAvailable;	// IMP=0x00000000001e5dd0
- (void)_lockedSendFetchRequest;	// IMP=0x00000000001e41dc
- (void)_flushFetchedRecordsToConsumerLocked;	// IMP=0x00000000001e416c
- (void)_flushFetchedRecordsToConsumerNoOrderingLocked;	// IMP=0x00000000001e3faa
- (void)_flushFetchedRecordsToConsumerOrderedLocked;	// IMP=0x00000000001e3d49
- (void)_performCallbackForFetchInfoLocked:(id)arg1;	// IMP=0x00000000001e3adc
- (id)description;	// IMP=0x00000000001e3aca
- (id)CKPropertiesDescription;	// IMP=0x00000000001e3555
- (void)dealloc;	// IMP=0x00000000001e3490
- (id)recordCache:(id *)arg1;	// IMP=0x00000000001e336c
- (id)activityCreate;	// IMP=0x00000000001e3343
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001e2d6f
