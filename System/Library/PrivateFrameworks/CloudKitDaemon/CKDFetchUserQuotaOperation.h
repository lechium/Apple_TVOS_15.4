...
- (void)main;	// IMP=0x00000000000d9f8b
- (int)operationType;	// IMP=0x00000000000d9f80
- (id)activityCreate;	// IMP=0x00000000000d9f57
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000d9f28
