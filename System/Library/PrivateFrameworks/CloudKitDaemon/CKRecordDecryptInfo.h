...
- (void).cxx_destruct;	// IMP=0x00000000002b4c8b
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x00000000002b492a
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000002b47b6
- (id)init;	// IMP=0x00000000002b473a
