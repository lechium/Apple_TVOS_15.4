...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x000000000031797e
+ (Class)titleLocalizedArgumentsType;	// IMP=0x0000000000317882
- (void).cxx_destruct;	// IMP=0x00000000003198a8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003192ed
- (unsigned long long)hash;	// IMP=0x000000000031910e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000318dca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003188c8
- (void)copyTo:(id)arg1;	// IMP=0x00000000003185ec
- (void)writeTo:(id)arg1;	// IMP=0x0000000000318271
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000318264
- (id)dictionaryRepresentation;	// IMP=0x0000000000317a3e
- (id)description;	// IMP=0x000000000031798f
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000317961
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x0000000000317944
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x00000000003178da
- (void)clearSubtitleLocalizedArguments;	// IMP=0x00000000003178bd
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000317865
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x0000000000317848
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x00000000003177de
- (void)clearTitleLocalizedArguments;	// IMP=0x00000000003177c1
...
- (int)StringAsSource:(id)arg1;	// IMP=0x0000000000317643
- (id)sourceAsString:(int)arg1;	// IMP=0x00000000003175c3
