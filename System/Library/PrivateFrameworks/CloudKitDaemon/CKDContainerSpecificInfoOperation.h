...
- (void).cxx_destruct;	// IMP=0x00000000002bd670
...
- (void)main;	// IMP=0x00000000002bd1b1
- (void)setCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002bd04b
- (_Bool)shouldCheckAppVersion;	// IMP=0x00000000002bd043
- (id)activityCreate;	// IMP=0x00000000002bd01a
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002bcfb7
