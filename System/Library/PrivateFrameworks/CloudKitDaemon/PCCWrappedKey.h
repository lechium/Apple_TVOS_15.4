...
- (void).cxx_destruct;	// IMP=0x0000000000327de7
...
- (void)dealloc;	// IMP=0x0000000000327d69
- (void)clear;	// IMP=0x0000000000327d63
- (id)data;	// IMP=0x0000000000327d39
- (id)initWithKey:(id)arg1 permittedRemoteMeasurement:(id)arg2 attestation:(id)arg3;	// IMP=0x000000000032757f
