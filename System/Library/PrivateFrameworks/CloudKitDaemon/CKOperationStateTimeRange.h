...
- (void).cxx_destruct;	// IMP=0x00000000002efabe
...
- (id)CKPropertiesDescription;	// IMP=0x00000000002ef9ad
@property(readonly) double relativeStart;
@property(readonly) double absoluteStop;
- (long long)compareStopTime:(id)arg1;	// IMP=0x00000000002ef89c
- (long long)compareStartTime:(id)arg1;	// IMP=0x00000000002ef81c
@property(readonly) double executing;
@property(readonly) double queueing;
@property(readonly) double absoluteStart;
- (id)initWithOperationState:(unsigned long long)arg1 startDate:(id)arg2 duration:(double)arg3;	// IMP=0x00000000002ef71d
