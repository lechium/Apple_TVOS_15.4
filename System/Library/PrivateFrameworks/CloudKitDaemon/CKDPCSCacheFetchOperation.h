...
- (void).cxx_destruct;	// IMP=0x000000000026f0dc
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000026ede7
- (void)main;	// IMP=0x000000000026eda3
- (void)_willRetryFetch;	// IMP=0x000000000026ebb1
- (_Bool)_savePCSDataToCache;	// IMP=0x000000000026eba9
- (_Bool)_saveUpdatedPCSToServer;	// IMP=0x000000000026eba1
- (_Bool)_decryptPCS;	// IMP=0x000000000026eb99
- (_Bool)_fetchDependentPCS;	// IMP=0x000000000026eb91
- (_Bool)_createAdditionalPCS;	// IMP=0x000000000026eb89
- (_Bool)_fetchPCSDataFromServer;	// IMP=0x000000000026eb81
- (_Bool)_fetchPCSDataFromDatabase;	// IMP=0x000000000026eb79
- (_Bool)needsAdditionalPCSCreation;	// IMP=0x000000000026eb71
@property(readonly, nonatomic) _Bool hasAllPCSData;
@property(readonly, nonatomic) NSString *itemTypeName;
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000026ea68
- (_Bool)makeStateTransition;	// IMP=0x000000000026dfb5
- (_Bool)canBeUsedForOperation:(id)arg1 withOptions:(unsigned long long)arg2;	// IMP=0x000000000026de66
- (_Bool)_errorShouldImpactFlowControl:(id)arg1;	// IMP=0x000000000026dd0f
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000026dc11
