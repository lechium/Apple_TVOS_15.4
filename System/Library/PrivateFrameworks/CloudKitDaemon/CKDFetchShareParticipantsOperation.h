...
- (void).cxx_destruct;	// IMP=0x000000000014da1a
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000014d948
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000014d8e2
- (void)main;	// IMP=0x000000000014d7f4
- (void)_fetchIdentities;	// IMP=0x000000000014d350
- (int)operationType;	// IMP=0x000000000014d345
- (void)_handleFetchedInfo:(id)arg1 withIdentity:(id)arg2 error:(id)arg3;	// IMP=0x000000000014cf29
- (id)activityCreate;	// IMP=0x000000000014cf00
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000014ce71
