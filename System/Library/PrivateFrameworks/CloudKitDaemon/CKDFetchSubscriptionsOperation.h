...
- (void).cxx_destruct;	// IMP=0x0000000000169692
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001695a0
- (void)main;	// IMP=0x0000000000169226
- (int)operationType;	// IMP=0x000000000016921b
- (void)_handleSubscriptionFetched:(id)arg1 withID:(id)arg2 responseCode:(id)arg3;	// IMP=0x0000000000168fb3
- (id)activityCreate;	// IMP=0x0000000000168f8a
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000168eba
