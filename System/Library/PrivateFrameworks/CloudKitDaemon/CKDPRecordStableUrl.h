...
- (void).cxx_destruct;	// IMP=0x00000000003250af
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000324f33
- (unsigned long long)hash;	// IMP=0x0000000000324e90
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000324d30
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000324c18
- (void)copyTo:(id)arg1;	// IMP=0x0000000000324b55
- (void)writeTo:(id)arg1;	// IMP=0x0000000000324aa1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000324a94
- (id)dictionaryRepresentation;	// IMP=0x0000000000324798
- (id)description;	// IMP=0x00000000003246e9
