...
+ (Class)additionalFieldsType;	// IMP=0x00000000003233bb
- (void).cxx_destruct;	// IMP=0x000000000032463e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000032436d
- (unsigned long long)hash;	// IMP=0x0000000000324290
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003240f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000323e81
- (void)copyTo:(id)arg1;	// IMP=0x0000000000323d19
- (void)writeTo:(id)arg1;	// IMP=0x0000000000323b31
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000323b24
- (id)dictionaryRepresentation;	// IMP=0x0000000000323524
- (id)description;	// IMP=0x0000000000323475
...
- (id)additionalFieldsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000032339e
- (unsigned long long)additionalFieldsCount;	// IMP=0x0000000000323381
- (void)addAdditionalFields:(id)arg1;	// IMP=0x0000000000323317
- (void)clearAdditionalFields;	// IMP=0x00000000003232fa
