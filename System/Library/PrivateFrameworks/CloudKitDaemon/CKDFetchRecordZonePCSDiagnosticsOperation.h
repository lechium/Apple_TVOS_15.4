...
- (void).cxx_destruct;	// IMP=0x000000000021c455
...
- (void)main;	// IMP=0x000000000021bcbb
- (int)operationType;	// IMP=0x000000000021bcb0
- (void)_handleRecordZoneFetch:(id)arg1 zoneID:(id)arg2 responseCode:(id)arg3;	// IMP=0x000000000021b916
- (id)activityCreate;	// IMP=0x000000000021b8ed
- (id)relevantZoneIDs;	// IMP=0x000000000021b67e
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000021b5ef
