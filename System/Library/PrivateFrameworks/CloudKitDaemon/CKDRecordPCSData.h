...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002e5a1e
+ (id)dataWithRecord:(id)arg1;	// IMP=0x00000000002e5532
- (void).cxx_destruct;	// IMP=0x00000000002e60e1
...
- (void)dealloc;	// IMP=0x00000000002e5f12
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002e5c82
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002e5a26
- (id)CKPropertiesDescription;	// IMP=0x00000000002e58d6
- (void)setPcs:(struct _OpaquePCSShareProtection *)arg1;	// IMP=0x00000000002e55c8
- (_Bool)shouldEncodePCSData;	// IMP=0x00000000002e5595
- (id)itemID;	// IMP=0x00000000002e5583
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000002e522d
- (id)initWithPCSData:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000002e51b5
