...
- (void).cxx_destruct;	// IMP=0x00000000001664a2
...
- (void)finishWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001663ed
- (void)processData:(id)arg1;	// IMP=0x0000000000166392
@property(retain, nonatomic) NSMutableData *parserData;
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *parseQueue;
- (id)initWithQoS:(long long)arg1;	// IMP=0x000000000016617e
