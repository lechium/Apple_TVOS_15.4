...
- (void).cxx_destruct;	// IMP=0x000000000018346a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000183289
- (unsigned long long)hash;	// IMP=0x00000000001831ba
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018301d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000182ee5
- (void)copyTo:(id)arg1;	// IMP=0x0000000000182e02
- (void)writeTo:(id)arg1;	// IMP=0x0000000000182d29
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000182d1c
- (id)dictionaryRepresentation;	// IMP=0x00000000001827fe
- (id)description;	// IMP=0x000000000018274f
