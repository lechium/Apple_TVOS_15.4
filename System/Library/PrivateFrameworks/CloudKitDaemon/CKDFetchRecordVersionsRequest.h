...
- (void).cxx_destruct;	// IMP=0x00000000002d1478
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002d1232
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002d0db3
- (id)generateRequestOperations;	// IMP=0x00000000002d0805
- (id)requestOperationClasses;	// IMP=0x00000000002d0799
- (id)zoneIDsToLock;	// IMP=0x00000000002d05d7
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 desiredKeys:(id)arg3 minimumVersionETag:(id)arg4;	// IMP=0x00000000002d04cf
