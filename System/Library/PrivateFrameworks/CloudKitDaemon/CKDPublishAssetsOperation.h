...
- (void).cxx_destruct;	// IMP=0x0000000000118951
...
- (void)cancel;	// IMP=0x00000000001187e8
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000118782
- (void)main;	// IMP=0x00000000001186df
- (void)_fetchRecords;	// IMP=0x00000000001179a6
- (void)_fetchPCSForRecords;	// IMP=0x00000000001175e8
- (void)_dispatchAssetURLsForRecord:(id)arg1 recordID:(id)arg2 pcs:(struct _OpaquePCSShareProtection *)arg3 error:(id)arg4;	// IMP=0x0000000000116d6f
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000116d0d
- (_Bool)makeStateTransition;	// IMP=0x0000000000116c3c
- (id)activityCreate;	// IMP=0x0000000000116c13
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000116af3
