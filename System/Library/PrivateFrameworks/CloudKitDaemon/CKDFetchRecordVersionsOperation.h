...
- (void).cxx_destruct;	// IMP=0x0000000000291ee1
...
- (id)relevantZoneIDs;	// IMP=0x0000000000291c0b
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000291a7c
- (void)main;	// IMP=0x00000000002915c9
- (int)operationType;	// IMP=0x00000000002915be
- (void)_handleRecordVersionsFetchedForID:(id)arg1 isDeleted:(_Bool)arg2 versions:(id)arg3 responseCode:(id)arg4;	// IMP=0x00000000002908af
- (_Bool)hasDecryptOperation;	// IMP=0x000000000029086e
@property(readonly, nonatomic) CKDDecryptRecordsOperation *recordDecryptOperation;
- (id)activityCreate;	// IMP=0x00000000002905f4
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002903fa
