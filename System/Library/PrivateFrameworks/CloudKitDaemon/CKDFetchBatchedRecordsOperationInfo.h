...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000025a8d7
- (void).cxx_destruct;	// IMP=0x000000000025adaa
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000025aa3b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000025a8df
