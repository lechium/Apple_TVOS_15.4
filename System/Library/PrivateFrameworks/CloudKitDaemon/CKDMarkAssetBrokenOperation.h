...
- (void).cxx_destruct;	// IMP=0x0000000000251ff4
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000251cc7
- (void)main;	// IMP=0x0000000000251cb3
- (id)checkPreconditions;	// IMP=0x0000000000251bee
- (id)assetOrPackageForFetchedRecord;	// IMP=0x0000000000251a38
- (id)repairContainer;	// IMP=0x0000000000251601
- (void)_markAssetBroken;	// IMP=0x00000000002501dd
- (int)operationType;	// IMP=0x00000000002501d2
- (void)_breakAsset;	// IMP=0x000000000024f419
- (void)_touchCreateRepairZone;	// IMP=0x000000000024eb13
- (void)_touchFetchRepairZone;	// IMP=0x000000000024e1e7
- (void)_fetchRecord;	// IMP=0x000000000024d9e4
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000024d94c
- (_Bool)makeStateTransition;	// IMP=0x000000000024d4de
- (id)activityCreate;	// IMP=0x000000000024d4b5
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024d354
