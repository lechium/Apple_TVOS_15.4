...
- (void).cxx_destruct;	// IMP=0x000000000017903a
...
- (void)streamDidStop:(id)arg1;	// IMP=0x0000000000178daa
- (void)streamDidFail:(id)arg1 error:(id)arg2;	// IMP=0x0000000000178d2a
- (_Bool)activityStream:(id)arg1 results:(id)arg2;	// IMP=0x0000000000178a8c
- (void)persistenceDidFinishReadingForStartDate:(id)arg1 endDate:(id)arg2;	// IMP=0x00000000001787bf
- (_Bool)persistence:(id)arg1 results:(id)arg2 error:(id)arg3;	// IMP=0x0000000000178508
- (void)streamLogsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000178063
- (void)addStreamObserver:(id)arg1;	// IMP=0x0000000000177ff1
- (id)initWithArchiveAtURL:(id)arg1;	// IMP=0x0000000000177f4b
- (id)initWithRemoteDevice:(id)arg1;	// IMP=0x0000000000177eb8
- (id)initForHostStream;	// IMP=0x0000000000177e5d
- (void)_configureStreamSource:(id)arg1;	// IMP=0x0000000000177df4
- (id)_init;	// IMP=0x0000000000177d9e
