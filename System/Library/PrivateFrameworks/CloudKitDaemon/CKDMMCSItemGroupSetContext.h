...
- (void)start;	// IMP=0x000000000000e361
- (void)addItemGroupContext:(id)arg1;	// IMP=0x000000000000e2d2
- (void)cancel;	// IMP=0x000000000000e1a5
- (id)initWithItemGroupSet:(id)arg1 itemGroupSetCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000000dfdd
