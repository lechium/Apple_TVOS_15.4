...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000257096
- (unsigned long long)hash;	// IMP=0x0000000000256fdd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000256e4e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000256d6d
- (void)copyTo:(id)arg1;	// IMP=0x0000000000256caf
- (void)writeTo:(id)arg1;	// IMP=0x0000000000256bbd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000256bb0
- (id)dictionaryRepresentation;	// IMP=0x0000000000256427
- (id)description;	// IMP=0x0000000000256378
@property(nonatomic) _Bool hasHierarchicalSharing;
@property(nonatomic) _Bool hasZoneSharing;
- (int)StringAsSharingType:(id)arg1;	// IMP=0x0000000000256245
- (id)sharingTypeAsString:(int)arg1;	// IMP=0x00000000002561de
