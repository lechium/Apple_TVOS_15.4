...
- (void).cxx_destruct;	// IMP=0x0000000000165388
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001651e3
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000164e79
- (id)generateRequestOperations;	// IMP=0x0000000000164965
- (_Bool)requestGETPreAuth;	// IMP=0x000000000016491a
- (id)requestOperationClasses;	// IMP=0x00000000001648ae
- (long long)databaseScope;	// IMP=0x000000000016480f
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000001647f5
- (id)initWithOperation:(id)arg1 serviceName:(id)arg2 functionName:(id)arg3 serializedParameters:(id)arg4 attestationEntropy:(id)arg5 pccWrappedInvocationKeys:(id)arg6 trustedTargetWrappedInvocationKey:(id)arg7;	// IMP=0x00000000001646ab
