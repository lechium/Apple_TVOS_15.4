...
- (void).cxx_destruct;	// IMP=0x00000000001029d6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000010265f
- (unsigned long long)hash;	// IMP=0x00000000001024a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001021a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000101f7b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000101dc5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000101c09
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000101bfc
- (id)dictionaryRepresentation;	// IMP=0x000000000010118e
- (id)description;	// IMP=0x00000000001010df
