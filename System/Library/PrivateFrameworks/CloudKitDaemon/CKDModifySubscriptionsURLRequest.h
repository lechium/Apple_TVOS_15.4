...
- (void).cxx_destruct;	// IMP=0x000000000013c9ef
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000013c7f0
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000013c6b2
- (id)generateRequestOperations;	// IMP=0x000000000013bbca
- (id)requestOperationClasses;	// IMP=0x000000000013bae3
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000013badb
- (id)initWithOperation:(id)arg1 subscriptionsToSave:(id)arg2 subscriptionIDsToDelete:(id)arg3;	// IMP=0x000000000013ba10
