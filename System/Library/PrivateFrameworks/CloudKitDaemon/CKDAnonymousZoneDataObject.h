...
- (void).cxx_destruct;	// IMP=0x00000000001af0fa
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x00000000001af05d
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x00000000001aeff2
