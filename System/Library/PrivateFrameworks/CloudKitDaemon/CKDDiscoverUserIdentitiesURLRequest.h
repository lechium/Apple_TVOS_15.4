...
- (void).cxx_destruct;	// IMP=0x000000000022d44f
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000022d17b
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000022c4ca
- (id)generateRequestOperations;	// IMP=0x000000000022c27a
- (id)requestOperationClasses;	// IMP=0x000000000022c20e
- (long long)databaseScope;	// IMP=0x000000000022c203
- (id)initWithOperation:(id)arg1 lookupInfos:(id)arg2;	// IMP=0x000000000022c16a
