...
- (void).cxx_destruct;	// IMP=0x00000000000ca103
...
- (void)requestDidComplete;	// IMP=0x00000000000c9ef4
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000c9c27
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000c935f
- (id)generateRequestOperations;	// IMP=0x00000000000c8801
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000000c879f
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000000c8797
- (id)zoneIDsToLock;	// IMP=0x00000000000c86db
- (_Bool)requestGETPreAuth;	// IMP=0x00000000000c866e
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000000c8654
- (id)requestOperationClasses;	// IMP=0x00000000000c85e8
- (id)initWithOperation:(id)arg1 query:(id)arg2 cursor:(id)arg3 limit:(unsigned long long)arg4 requestedFields:(id)arg5 zoneID:(id)arg6;	// IMP=0x00000000000c8469
