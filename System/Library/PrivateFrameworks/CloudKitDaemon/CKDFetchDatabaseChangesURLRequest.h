...
- (void).cxx_destruct;	// IMP=0x000000000024395c
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000242bea
- (id)generateRequestOperations;	// IMP=0x00000000002429e7
- (id)requestOperationClasses;	// IMP=0x000000000024297b
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000242973
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000242959
- (id)initWithOperation:(id)arg1 previousServerChangeTokenData:(id)arg2;	// IMP=0x000000000024284f
