...
- (void).cxx_destruct;	// IMP=0x00000000000748e8
...
- (void)start;	// IMP=0x000000000007393e
- (void)createFetchOperationForItemIDs:(id)arg1 operationQueue:(id)arg2 operationConfigurationBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000738c4
- (_Bool)dependentOperationListContainsOperationID:(id)arg1;	// IMP=0x000000000007380c
- (_Bool)dependentOperationListContainsRunningFetch:(id)arg1;	// IMP=0x000000000007369b
- (_Bool)canBeUsedForPendingFetch:(id)arg1;	// IMP=0x00000000000735d1
- (_Bool)canBeUsedForOperation:(id)arg1;	// IMP=0x0000000000073520
- (id)description;	// IMP=0x000000000007350e
- (id)CKPropertiesDescription;	// IMP=0x00000000000733df
- (void)cancelFetchOperation;	// IMP=0x0000000000073346
- (void)finishFetchOperationWithError:(id)arg1;	// IMP=0x0000000000072e8c
- (void)performCallbacksForItemWithID:(id)arg1 withItem:(id)arg2 error:(id)arg3;	// IMP=0x0000000000072a48
- (id)allItemIDs;	// IMP=0x0000000000072984
- (id)callbacksForItemWithID:(id)arg1;	// IMP=0x0000000000072891
- (void)removeCallbacksForItemWithID:(id)arg1;	// IMP=0x0000000000072592
- (void)addCallbackForItemWithID:(id)arg1 operation:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x00000000000721d7
- (int)numberOfCallbacks;	// IMP=0x0000000000071fea
@property(nonatomic) _Bool isCancelled; // @synthesize isCancelled=_isCancelled;
@property(nonatomic) _Bool isFinished; // @synthesize isFinished=_isFinished;
- (id)initWithOperation:(id)arg1 container:(id)arg2 operationQueue:(id)arg3;	// IMP=0x000000000007196d
- (id)init;	// IMP=0x000000000007190d
