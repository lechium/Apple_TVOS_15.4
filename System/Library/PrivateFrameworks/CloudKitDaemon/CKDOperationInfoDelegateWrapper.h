...
- (void).cxx_destruct;	// IMP=0x0000000000234078
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000233f48
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000233eca
