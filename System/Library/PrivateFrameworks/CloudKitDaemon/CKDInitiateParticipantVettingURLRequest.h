...
- (void).cxx_destruct;	// IMP=0x00000000000e3885
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000e3725
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000e3508
- (id)generateRequestOperations;	// IMP=0x00000000000e329a
- (id)requestOperationClasses;	// IMP=0x00000000000e322e
- (id)initWithOperation:(id)arg1 shareRecordID:(id)arg2 encryptedKey:(id)arg3 participantID:(id)arg4 baseToken:(id)arg5;	// IMP=0x00000000000e3133
