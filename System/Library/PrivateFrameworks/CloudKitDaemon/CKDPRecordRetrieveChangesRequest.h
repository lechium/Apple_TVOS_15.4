...
+ (id)options;	// IMP=0x00000000002a6a9c
- (void).cxx_destruct;	// IMP=0x00000000002a7f24
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002a7cfc
- (unsigned long long)hash;	// IMP=0x00000000002a7bd2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a79da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a7879
- (void)copyTo:(id)arg1;	// IMP=0x00000000002a775a
- (Class)responseClass;	// IMP=0x00000000002a7749
- (unsigned int)requestTypeCode;	// IMP=0x00000000002a773e
- (void)writeTo:(id)arg1;	// IMP=0x00000000002a7619
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002a760c
- (id)dictionaryRepresentation;	// IMP=0x00000000002a6e39
- (id)description;	// IMP=0x00000000002a6d8a
...
- (int)StringAsRequestedChangeTypes:(id)arg1;	// IMP=0x00000000002a6c42
- (id)requestedChangeTypesAsString:(int)arg1;	// IMP=0x00000000002a6bdb
