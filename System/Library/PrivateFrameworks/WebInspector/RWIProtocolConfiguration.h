...
- (id).cxx_construct;	// IMP=0x000000000002043d
- (void).cxx_destruct;	// IMP=0x0000000000020339
...
- (id)initWithController:(struct AugmentableInspectorController *)arg1;	// IMP=0x000000000001fa9c
