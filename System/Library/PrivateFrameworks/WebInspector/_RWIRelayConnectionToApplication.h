...
- (void).cxx_destruct;	// IMP=0x0000000000003465
...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000000000032ef
- (void)_handleEvent:(id)arg1;	// IMP=0x0000000000003028
- (id)_deserializeMessage:(id)arg1;	// IMP=0x0000000000002ef4
- (void)dealloc;	// IMP=0x0000000000002eb6
- (void)close;	// IMP=0x0000000000002e80
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000002d2b
