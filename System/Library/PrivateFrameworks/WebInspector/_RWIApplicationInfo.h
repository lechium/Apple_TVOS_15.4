...
+ (id)identifierForPID:(int)arg1;	// IMP=0x0000000000001390
- (void).cxx_destruct;	// IMP=0x0000000000001dab
...
- (_Bool)updateFromListing:(id)arg1;	// IMP=0x000000000000172f
- (id)dictionaryRepresentation;	// IMP=0x00000000000014e1
@property(readonly, nonatomic) NSString *identifier; // @dynamic identifier;
- (id)initWithPID:(int)arg1 bundleId:(id)arg2 name:(id)arg3 isProxy:(_Bool)arg4 connection:(id)arg5 debuggerAvailability:(unsigned long long)arg6;	// IMP=0x00000000000013b5
