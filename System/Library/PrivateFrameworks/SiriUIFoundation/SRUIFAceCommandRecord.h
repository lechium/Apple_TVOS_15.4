...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x00000000000027a7
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x00000000000022c0
- (void)incrementNumberOfStoppedActions;	// IMP=0x000000000000228e
- (void)incrementNumberOfStartedActions;	// IMP=0x000000000000225c
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000002132
