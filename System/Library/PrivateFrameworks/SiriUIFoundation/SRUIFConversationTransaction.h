...
- (void).cxx_destruct;	// IMP=0x0000000000012b54
...
- (id)initWithUpdatedItemIndexPaths:(id)arg1 insertedItemIndexPaths:(id)arg2 presentationStateChangedItemIndexPaths:(id)arg3;	// IMP=0x0000000000012a7f
