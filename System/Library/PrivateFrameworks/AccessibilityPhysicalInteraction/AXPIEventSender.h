...
+ (id)sharedInstance;	// IMP=0x000000000000230b
- (void).cxx_destruct;	// IMP=0x0000000000002799
@property(nonatomic) unsigned long long senderID; // @synthesize senderID=_senderID;
- (void)sendIOHIDEventRef:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000000002600
- (void)sendEventRepresentation:(id)arg1;	// IMP=0x00000000000023d2
