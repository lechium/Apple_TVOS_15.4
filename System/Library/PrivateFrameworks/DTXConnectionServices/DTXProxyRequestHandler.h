...
- (_Bool)matchesPublishedProtocolName:(id)arg1 peerProtocolName:(id)arg2;	// IMP=0x0000000000007ec5
@property(readonly, copy) NSString *channelIdentifier;
- (id)initWithPublishedProtocol:(id)arg1 publishedProtocolName:(id)arg2 peerProtocol:(id)arg3 peerProtocolName:(id)arg4 handlerBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000007afb
