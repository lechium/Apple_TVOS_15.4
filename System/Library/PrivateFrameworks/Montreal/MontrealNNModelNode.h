...
- (void).cxx_destruct;	// IMP=0x0000000000135e50
...
- (id)createDataContainer;	// IMP=0x0000000000135a30
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x00000000001358c0
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001357a0
- (id)jsonDescription;	// IMP=0x0000000000135550
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001351b0
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x0000000000135110
- (void)keepTensors:(id)arg1;	// IMP=0x0000000000134e20
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x0000000000134a20
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x0000000000134030
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x0000000000133e60
- (id)checkForValidity;	// IMP=0x0000000000133c20
