...
- (void).cxx_destruct;	// IMP=0x00000000001e40b0
...
- (id)networkOutputs;	// IMP=0x00000000001e3da0
- (id)networkInputs;	// IMP=0x00000000001e3b00
- (void)removeOutput:(id)arg1;	// IMP=0x00000000001e39b0
- (void)addOutputs:(id)arg1;	// IMP=0x00000000001e36b0
- (void)removeInput:(id)arg1;	// IMP=0x00000000001e3560
- (void)addInputs:(id)arg1;	// IMP=0x00000000001e3260
- (id)modelContainerPath;	// IMP=0x00000000001e2f60
- (void *)generateModelContainer;	// IMP=0x00000000001e2da0
- (void)merge:(id)arg1;	// IMP=0x00000000001e2b40
@property struct MontrealNeuralNetwork *nnObject; // @synthesize nnObject=_nnObject;
- (void)dealloc;	// IMP=0x00000000001e2a80
- (id)initWithWeightFormat:(unsigned long long)arg1;	// IMP=0x00000000001e2990
