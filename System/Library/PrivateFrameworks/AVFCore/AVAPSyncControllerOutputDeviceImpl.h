...
+ (void)registerLocalDeviceDidChangeListener:(Class)arg1;	// IMP=0x00000000000065dd
+ (void)localDeviceWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000000648c
- (void).cxx_destruct;	// IMP=0x0000000000007a2d
...
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000079ee
...
- (void)_proposedGroupIDDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x00000000000077cd
@property(readonly, copy, nonatomic) NSString *proposedGroupID;
@property(readonly, copy, nonatomic) NSString *groupID;
@property(readonly, nonatomic) _Bool canBeGrouped;
- (void)setVolume:(float)arg1;	// IMP=0x000000000000769f
- (void)_volumeControlTypeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007635
@property(readonly) long long volumeControlType;
- (void)_volumeControlSupportedDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007510
@property(readonly) _Bool canSetVolume;
- (void)_volumeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007442
@property(readonly) float volume;
@property(readonly, nonatomic, getter=isHeadTrackedSpatialAudioActive) _Bool headTrackedSpatialAudioActive;
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000073b2
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000000007386
...
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000732e
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x0000000000007318
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000007302
...
- (void)dealloc;	// IMP=0x0000000000006ca4
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006c14
- (id)initWithSyncController:(struct OpaqueAPSyncController *)arg1 secondaryImpl:(id)arg2;	// IMP=0x00000000000066f0
