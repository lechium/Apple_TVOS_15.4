...
+ (void)initialize;	// IMP=0x00000000000dea34
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x00000000000decdd
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000decc8
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x00000000000decc2
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x00000000000decbc
...
- (void)cancelLoading;	// IMP=0x00000000000debab
- (id)assetInspector;	// IMP=0x00000000000deba3
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000deb78
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000deb4a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000deb3f
- (void)dealloc;	// IMP=0x00000000000deb04
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x00000000000dea9b
