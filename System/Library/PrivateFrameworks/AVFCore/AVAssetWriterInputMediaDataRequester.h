...
- (void)requestMediaDataIfNecessary;	// IMP=0x00000000000a9afc
@property __weak id <AVAssetWriterInputMediaDataRequesterDelegate> delegate;
- (void)dealloc;	// IMP=0x00000000000a98e7
- (void)_collectUncollectables_invokedFromDeallocAndFinalize;	// IMP=0x00000000000a98b9
- (id)init;	// IMP=0x00000000000a98a3
- (id)initWithRequestQueue:(id)arg1 requestBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a977c
