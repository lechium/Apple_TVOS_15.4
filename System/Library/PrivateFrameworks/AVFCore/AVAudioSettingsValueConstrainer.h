...
- (float)_getAvailableOutputSampleRateFor:(float)arg1 rounding:(long long)arg2;	// IMP=0x000000000010ba6f
- (unsigned int)availableOutputChannelCountForDesiredChannelCount:(unsigned int)arg1 rounding:(long long)arg2;	// IMP=0x000000000010b916
- (float)applicableOutputSampleRateForDesiredSampleRate:(float)arg1 rounding:(long long)arg2;	// IMP=0x000000000010b5d3
...
- (void)setInputPropertiesFromASBD:(struct AudioStreamBasicDescription)arg1;	// IMP=0x000000000010b508
- (void)_bringUpToDate;	// IMP=0x000000000010b450
- (id)_fetchApplicableOutputDataRates;	// IMP=0x000000000010b3b1
- (void)_buildApplicableDataRatesForSampleRates;	// IMP=0x000000000010adf2
- (void)_buildAvailableSampleRates;	// IMP=0x000000000010acb3
- (void)_buildAudioConverter;	// IMP=0x000000000010abeb
- (void)dealloc;	// IMP=0x000000000010ab82
- (id)init;	// IMP=0x000000000010ab27
