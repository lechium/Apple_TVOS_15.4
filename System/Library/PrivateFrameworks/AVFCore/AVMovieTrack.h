...
+ (_Bool)expectsPropertyRevisedNotifications;	// IMP=0x00000000000818d2
- (void).cxx_destruct;	// IMP=0x0000000000081a3d
- (id)description;	// IMP=0x000000000008197f
...
- (id)mediaDataStorage;	// IMP=0x00000000000818da
