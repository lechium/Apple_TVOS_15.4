...
- (id)expectedCurrentItemIdentifier;	// IMP=0x00000000000f412c
- (id)originator;	// IMP=0x00000000000f411b
- (void)dealloc;	// IMP=0x00000000000f40b5
- (id)initWithCoordinator:(id)arg1 originator:(id)arg2 expectedCurrentItemIdentifier:(id)arg3 commandOrderIndex:(long long)arg4 rate:(float)arg5 itemTime:(CDStruct_1b6d18a9)arg6 hostClockTime:(CDStruct_1b6d18a9)arg7;	// IMP=0x00000000000f3fb6
- (id)init;	// IMP=0x00000000000f3f6f
