...
- (long long)status;	// IMP=0x00000000000943b1
- (void)cancelWriting;	// IMP=0x000000000009429a
- (void)_finishWritingOperationsDidFinish;	// IMP=0x00000000000941c7
- (void)dealloc;	// IMP=0x000000000009412c
- (id)initWithConfigurationState:(id)arg1 finishWritingOperations:(id)arg2 figAssetWriterCallbackContextToken:(void *)arg3;	// IMP=0x0000000000093eba
