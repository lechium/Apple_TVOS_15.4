...
@interface AVPlayerItemInternal : NSObject
{
    ...
    _Bool prefersSDRVideo;	// 672 = 0x2a0
    _Bool prefersSDRVideoWasSet;	// 673 = 0x2a1
    _Bool reversesMoreVideoFramesInMemory;	// 674 = 0x2a2
    _Bool reversesMoreVideoFramesInMemoryWasSet;	// 675 = 0x2a3
    _Bool aggressivelyCachesVideoFrames;	// 676 = 0x2a4
    _Bool aggressivelyCachesVideoFramesWasSet;	// 677 = 0x2a5
    _Bool decodesAllFramesDuringOrdinaryPlayback;	// 678 = 0x2a6
    _Bool decodesAllFramesDuringOrdinaryPlaybackWasSet;	// 679 = 0x2a7
    _Bool initialContinuesPlayingDuringPrerollForSeek;	// 680 = 0x2a8
    _Bool initialContinuesPlayingDuringPrerollForRateChange;	// 681 = 0x2a9
    _Bool usesIFrameOnlyPlaybackForHighRateScaledEditsWasSet;	// 682 = 0x2aa
    _Bool usesIFrameOnlyPlaybackForHighRateScaledEdits;	// 683 = 0x2ab
