...
- (id)associatedInputsWithTrackAssociationType:(id)arg1;	// IMP=0x00000000000a6acf
- (id)availableTrackAssociationTypes;	// IMP=0x00000000000a6a98
- (void)addTrackAssociationWithTrackOfInput:(id)arg1 type:(id)arg2;	// IMP=0x00000000000a6a16
- (_Bool)canAddTrackAssociationWithTrackOfInput:(id)arg1 type:(id)arg2;	// IMP=0x00000000000a6a0e
...
- (void)markCurrentPassAsFinished;	// IMP=0x00000000000a68ee
- (void)markAsFinished;	// IMP=0x00000000000a686c
- (_Bool)prepareToFinishWritingReturningError:(id *)arg1;	// IMP=0x00000000000a6864
- (void)prepareToEndSession;	// IMP=0x00000000000a685e
- (void)didStartInitialSession;	// IMP=0x00000000000a6858
- (_Bool)appendPixelBuffer:(struct __CVBuffer *)arg1 withPresentationTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000a67d6
- (long long)appendSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 error:(id *)arg2;	// IMP=0x00000000000a6746
- (void)stopRequestingMediaData;	// IMP=0x00000000000a66c4
- (void)requestMediaDataWhenReadyOnQueue:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a6642
...
- (_Bool)canStartRespondingToEachPassDescriptionReturningReason:(id *)arg1;	// IMP=0x00000000000a62af
...
- (void)transitionAssetWriterAndAllInputsToFailedStatusWithError:(id)arg1;	// IMP=0x00000000000a57ec
- (id)transitionToAndReturnTerminalHelperWithTerminalStatus:(long long)arg1;	// IMP=0x00000000000a575f
@property(readonly, nonatomic) long long status;
- (id)description;	// IMP=0x00000000000a56ce
- (void)dealloc;	// IMP=0x00000000000a5684
- (id)initWithConfigurationState:(id)arg1;	// IMP=0x00000000000a5597
