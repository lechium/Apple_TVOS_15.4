...
+ (id)longFormVideoExternalPlaybackMonitor;	// IMP=0x00000000000fae62
+ (void)initialize;	// IMP=0x00000000000fad5a
...
- (id)description;	// IMP=0x00000000000faeaf
- (void)dealloc;	// IMP=0x00000000000fae74
