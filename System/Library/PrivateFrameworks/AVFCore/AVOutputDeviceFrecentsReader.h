...
- (id)frecencyInfoForDeviceWithID:(id)arg1;	// IMP=0x00000000000c2aa6
@property(readonly, nonatomic) NSArray *deviceIDs;
- (void)dealloc;	// IMP=0x00000000000c2a55
- (id)initWithFrecentsFilePath:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000c2804
- (id)init;	// IMP=0x00000000000c27ee
