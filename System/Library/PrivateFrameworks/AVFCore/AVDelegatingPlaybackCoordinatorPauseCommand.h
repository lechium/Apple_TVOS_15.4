...
- (id)expectedCurrentItemIdentifier;	// IMP=0x00000000000f44f9
- (id)originator;	// IMP=0x00000000000f44e8
- (void)dealloc;	// IMP=0x00000000000f4482
- (id)initWithCoordinator:(id)arg1 originator:(id)arg2 expectedCurrentItemIdentifier:(id)arg3 commandOrderIndex:(long long)arg4 shouldBufferInAnticipationOfPlayback:(_Bool)arg5 anticipatedPlaybackRate:(float)arg6;	// IMP=0x00000000000f43b0
- (id)init;	// IMP=0x00000000000f4369
