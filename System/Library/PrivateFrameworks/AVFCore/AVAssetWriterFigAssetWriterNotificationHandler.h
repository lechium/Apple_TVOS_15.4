...
- (void)_handleFailedNotificationWithError:(id)arg1;	// IMP=0x000000000009002d
- (void)_handleCompletedWritingNotification;	// IMP=0x000000000008fff8
- (void)_teardownNotificationHandlers;	// IMP=0x000000000008ff47
- (void)_callDelegateIfNotCalledWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000008fee4
- (void)dealloc;	// IMP=0x000000000008fe7f
- (id)initWithFigAssetWriter:(struct OpaqueFigAssetWriter *)arg1;	// IMP=0x000000000008fc58
