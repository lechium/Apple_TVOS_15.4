...
+ (void)initialize;	// IMP=0x00000000001225ab
...
- (void)cancelAllPendingVideoCompositionRequests;	// IMP=0x0000000000122baf
- (void)startVideoCompositionRequest:(id)arg1;	// IMP=0x0000000000122973
- (id)defaultCIContext;	// IMP=0x0000000000122840
...
- (void)renderContextChanged:(id)arg1;	// IMP=0x00000000001227c1
@property(readonly, nonatomic) NSDictionary *requiredPixelBufferAttributesForRenderContext;
@property(readonly, nonatomic) NSDictionary *sourcePixelBufferAttributes;
- (void)dealloc;	// IMP=0x0000000000122641
- (void)_willDeallocOrFinalize;	// IMP=0x0000000000122613
- (id)init;	// IMP=0x00000000001225bc
