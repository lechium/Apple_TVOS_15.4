...
- (void).cxx_destruct;	// IMP=0x00000000000be810
@property __weak AVOutputDeviceCommunicationChannel *parentChannel; // @synthesize parentChannel=_parentChannel;
- (void)close;	// IMP=0x00000000000be7d8
- (void)sendData:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000be5a9
- (void)dealloc;	// IMP=0x00000000000be552
- (id)initWithDeviceID:(id)arg1 channelUUID:(struct __CFString *)arg2 syncController:(struct OpaqueAPSyncController *)arg3;	// IMP=0x00000000000be48b
