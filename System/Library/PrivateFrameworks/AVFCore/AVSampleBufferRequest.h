...
+ (id)sampleBufferRequestWithStartCursor:(id)arg1;	// IMP=0x00000000000ec941
...
- (void)dealloc;	// IMP=0x00000000000eca2b
- (id)init;	// IMP=0x00000000000eca17
- (id)initWithStartCursor:(id)arg1;	// IMP=0x00000000000ec978
