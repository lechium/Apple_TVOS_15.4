...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x000000000004fbc4
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x000000000004fb56
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x000000000004faeb
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x000000000004f7e0
- (void).cxx_destruct;	// IMP=0x00000000000518eb
...
- (void)update;	// IMP=0x00000000000510b3
- (void)updateFromPlayerItem;	// IMP=0x00000000000503eb
- (void)updateFromPlayer;	// IMP=0x000000000004fed2
- (void)dealloc;	// IMP=0x000000000004f6ac
