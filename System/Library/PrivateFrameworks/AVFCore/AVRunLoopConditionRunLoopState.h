...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000d7d2a
...
- (void)dealloc;	// IMP=0x00000000000d7dc6
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000d7d61
