...
@class AVWeakReference, NSArray, NSData, NSDictionary, NSNumber, NSString;
...
@interface AVFigEndpointOutputDeviceImpl : NSObject <AVOutputDeviceImpl>
{
    ...
    AVWeakReference *_weakObserver;	// 16 = 0x10
    struct OpaqueFigEndpoint *_figEndpoint;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x00000000000cede2
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000ced22
...
- (void)setVolume:(float)arg1;	// IMP=0x00000000000ceb34
- (void)_canSetEndpointVolumeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x00000000000ceaaf
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
- (void)_volumeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x00000000000cea27
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ce83f
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000ce5c5
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000ce43d
- (void)setCurrentBluetoothListeningMode:(id)arg1;	// IMP=0x00000000000ce302
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000ce020
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000cde07
...
- (struct OpaqueFigEndpoint *)figEndpoint;	// IMP=0x00000000000cda2d
...
- (id)_figEndpointPropertyValueForKey:(struct __CFString *)arg1;	// IMP=0x00000000000cd64a
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000cd5ba
- (void)dealloc;	// IMP=0x00000000000cd571
- (id)initWithFigEndpoint:(struct OpaqueFigEndpoint *)arg1;	// IMP=0x00000000000cd47c
- (id)init;	// IMP=0x00000000000cd468
