...
- (void)_requestMediaDataIfReady;	// IMP=0x00000000000bd3c6
- (void)invalidate;	// IMP=0x00000000000bd32d
- (void)startRequestingMediaData;	// IMP=0x00000000000bd2cc
- (void)dealloc;	// IMP=0x00000000000bd28d
- (id)init;	// IMP=0x00000000000bd274
- (id)initWithMediaDataConsumer:(id)arg1 requestQueue:(id)arg2 requestBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000bd0dd
