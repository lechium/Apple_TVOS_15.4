...
- (void)dealloc;	// IMP=0x0000000000127916
- (id)init;	// IMP=0x00000000001278fd
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x000000000012781d
