...
- (void)drawPackableRenditionInContext:(struct CGContext *)arg1 withDocument:(id)arg2;	// IMP=0x00000000000195b5
- (_Bool)canBePackedWithDocument:(id)arg1;	// IMP=0x00000000000194cb
- (_Bool)updatePackingPropertiesWithDocument:(id)arg1;	// IMP=0x00000000000194c3
...
- (id)propertiesAsDictionary;	// IMP=0x0000000000019128
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned long long)arg2 document:(id)arg3;	// IMP=0x00000000000190c6
- (void)resetToBaseKeySpec;	// IMP=0x0000000000018ff4
- (void)awakeFromInsert;	// IMP=0x0000000000018f24
