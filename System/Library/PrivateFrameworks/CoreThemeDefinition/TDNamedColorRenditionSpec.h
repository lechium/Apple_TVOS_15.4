...
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned long long)arg2 document:(id)arg3;	// IMP=0x000000000004e038
- (void)setColorPropertiesFromCGColor:(struct CGColor *)arg1;	// IMP=0x000000000004de18
