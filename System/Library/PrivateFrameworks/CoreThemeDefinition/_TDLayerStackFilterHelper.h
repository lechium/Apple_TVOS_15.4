...
- (void)dealloc;	// IMP=0x000000000004d74a
- (_Bool)allowKey:(id)arg1;	// IMP=0x000000000004d22a
- (void)establishExclusionsWithHelper:(id)arg1 idioms:(id)arg2 sizeClasses:(id)arg3;	// IMP=0x000000000004ce24
- (id)init;	// IMP=0x000000000004cd34
