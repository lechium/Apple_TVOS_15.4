...
- (void)prepareForDeletion;	// IMP=0x000000000005b56b
- (void)awakeFromFetch;	// IMP=0x000000000005b50d
@property(nonatomic) struct CGSize canvasSize; // @dynamic canvasSize;
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned long long)arg2 document:(id)arg3;	// IMP=0x000000000005b1ac
- (_Bool)canBePackedWithDocument:(id)arg1;	// IMP=0x000000000005b1a4
