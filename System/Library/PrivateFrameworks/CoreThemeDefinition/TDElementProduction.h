...
- (void)deleteRenditionsInDocument:(id)arg1 shouldDeleteAssetFiles:(_Bool)arg2;	// IMP=0x00000000000196b4
- (id)associatedFileModificationDateWithDocument:(id)arg1;	// IMP=0x00000000000195e7
- (id)associatedFileURLWithDocument:(id)arg1;	// IMP=0x00000000000195d1
- (id)relativePath;	// IMP=0x00000000000195bb
