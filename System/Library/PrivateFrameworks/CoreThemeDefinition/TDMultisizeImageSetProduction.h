...
- (void)processRendition:(id)arg1 withBackstop:(id)arg2;	// IMP=0x000000000005cac7
- (id)initWithEntity:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x000000000005ca7b
