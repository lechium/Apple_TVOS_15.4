...
+ (id)keyPathsForValuesAffectingBlueComponent;	// IMP=0x000000000005dc80
+ (id)keyPathsForValuesAffectingGreenComponent;	// IMP=0x000000000005dbc0
+ (id)keyPathsForValuesAffectingRedComponent;	// IMP=0x000000000005db08
+ (id)keyPathsForValuesAffectingColor;	// IMP=0x000000000005dae4
