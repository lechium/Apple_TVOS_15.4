...
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned long long)arg2 document:(id)arg3;	// IMP=0x0000000000004bc1
- (_Bool)canBePackedWithDocument:(id)arg1;	// IMP=0x0000000000004bb9
