...
- (id)description;	// IMP=0x000000000004bba1
@property(nonatomic) _Bool isTemplate;
- (long long)renditionSubtype;	// IMP=0x000000000004baf3
- (void)dealloc;	// IMP=0x000000000004ba16
- (id)init;	// IMP=0x000000000004b9ca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004b243
