...
- (_Bool)canBePackedWithDocument:(id)arg1;	// IMP=0x000000000005bbef
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned long long)arg2 document:(id)arg3;	// IMP=0x000000000005b649
