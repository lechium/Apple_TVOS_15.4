...
- (void).cxx_destruct;	// IMP=0x0000000000012ea8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012dd1
- (id)_nsurlTaskForRequest:(id)arg1;	// IMP=0x0000000000012d5f
@property(readonly) _Bool _isUpload;
@property(readonly, copy) NSString *description;
- (id)initWithNSURLTaskCreator:(CDUnknownBlockType)arg1 initialRequest:(id)arg2 forSession:(id)arg3;	// IMP=0x0000000000012a0e
@property float priority;
- (void)resume;	// IMP=0x0000000000012883
- (void)suspend;	// IMP=0x0000000000012837
@property(readonly, copy) NSError *error;
@property(readonly) long long state;
- (void)cancel;	// IMP=0x00000000000125ef
