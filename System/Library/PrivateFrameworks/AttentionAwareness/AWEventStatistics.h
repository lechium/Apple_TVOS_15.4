...
+ (id)sharedStatistics;	// IMP=0x0000000000002d70
- (void).cxx_destruct;	// IMP=0x00000000000028cc
- (void)logEvent:(unsigned long long)arg1;	// IMP=0x000000000000278d
- (id)init;	// IMP=0x000000000000264f
