...
+ (id)safari_HTMLFormProtectionSpaceForURL:(id)arg1;	// IMP=0x000000000003dec0
@property(readonly, nonatomic) _Bool safari_allowsCredentialSaving;
- (id)safari_creationDateOfCredentialWithUser:(id)arg1;	// IMP=0x000000000003e726
...
- (long long)safari_compareToHighLevelDomainFromProtectionSpace:(id)arg1;	// IMP=0x000000000003e38d
- (long long)safari_compareToHighLevelDomainFromProtectionSpaceOrderingDecimalCharactersLast:(id)arg1;	// IMP=0x000000000003e1d1
