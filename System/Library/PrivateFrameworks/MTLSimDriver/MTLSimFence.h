...
- (unsigned int)fenceRef;	// IMP=0x0000000000008fd2
@property(readonly) id <MTLDevice> device;
- (void)dealloc;	// IMP=0x0000000000008ee6
- (id)initWithDevice:(id)arg1 fenceRef:(unsigned int)arg2;	// IMP=0x0000000000008e7d
