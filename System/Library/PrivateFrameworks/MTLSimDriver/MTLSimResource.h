...
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x000000000001376f
- (void)waitUntilComplete;	// IMP=0x0000000000013769
- (_Bool)isPurgeable;	// IMP=0x0000000000013761
- (_Bool)isComplete;	// IMP=0x0000000000013759
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x0000000000013729
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000013714
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000136fc
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x00000000000135ab
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x000000000001350f
- (void)makeAliasable;	// IMP=0x0000000000013471
- (_Bool)isAliasable;	// IMP=0x0000000000013468
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x0000000000013411
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x0000000000013346
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x00000000000132a9
