...
- (unsigned int)pipelineRef;	// IMP=0x000000000000e3bc
- (void)dealloc;	// IMP=0x000000000000e2e2
- (unsigned long long)uniqueIdentifier;	// IMP=0x000000000000e155
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000e0e9
