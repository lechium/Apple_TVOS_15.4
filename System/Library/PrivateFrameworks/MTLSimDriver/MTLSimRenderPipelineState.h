...
- (unsigned long long)imageblockMemoryLengthForDimensions:(CDStruct_da2e99ad)arg1;	// IMP=0x00000000000132a1
@property(readonly) unsigned long long imageblockSampleLength;
- (unsigned int)getVertexShaderTelemetryID;	// IMP=0x0000000000013291
- (unsigned int)getFragmentShaderTelemetryID;	// IMP=0x0000000000013289
- (id)newVertexShaderDebugInfo;	// IMP=0x0000000000013281
- (id)newFragmentShaderDebugInfo;	// IMP=0x0000000000013279
- (unsigned int)pipelineRef;	// IMP=0x0000000000013269
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (void)dealloc;	// IMP=0x0000000000013002
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x0000000000012f96
