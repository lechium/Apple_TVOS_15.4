...
@interface MTLSimSamplerState : _MTLSamplerState <MTLSamplerStateSPI, MTLSerializerSamplerState>
{
    ...
    unsigned long long _uniqueIdentifier;	// 48 = 0x30
}

@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (unsigned int)samplerRef;	// IMP=0x0000000000013902
- (void)dealloc;	// IMP=0x0000000000013838
- (id)initWithDescriptor:(id)arg1 reference:(unsigned int)arg2 device:(id)arg3;	// IMP=0x00000000000137f0
