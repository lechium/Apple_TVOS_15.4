...
- (void).cxx_destruct;	// IMP=0x000000000011b237
...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000011af1d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011ad3e
- (id)init;	// IMP=0x000000000011ad06
