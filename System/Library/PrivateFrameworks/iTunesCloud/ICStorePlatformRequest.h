...
- (void).cxx_destruct;	// IMP=0x0000000000084566
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008429c
@property(readonly, copy, nonatomic) NSArray *queryItems;
@property(readonly, copy, nonatomic) NSDictionary *HTTPHeaders;
- (id)copyWithItemIdentifiersInRange:(struct _NSRange)arg1;	// IMP=0x0000000000083dac
- (id)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000083470
- (id)init;	// IMP=0x00000000000832ef
