...
- (void).cxx_destruct;	// IMP=0x0000000000126d59
...
- (void)_sendData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000126bd6
- (void)_receivedData:(id)arg1;	// IMP=0x0000000000126960
- (_Bool)_deriveEncryptionKeysReturningError:(id *)arg1;	// IMP=0x000000000012641a
- (void)_handlePairingSessionCompletionWithError:(id)arg1;	// IMP=0x00000000001261d7
- (id)_encryptedDataForData:(id)arg1;	// IMP=0x000000000012605d
- (void)getEncryptedDataForData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000125fa5
- (void)getDecryptedDataForEncryptedData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000125eed
- (void)receievedData:(id)arg1;	// IMP=0x0000000000125e62
- (void)prepareEncryptedSessionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000125dd7
- (void)dealloc;	// IMP=0x0000000000125d98
- (id)initWithRole:(long long)arg1 securitySettings:(id)arg2;	// IMP=0x0000000000125ce5
