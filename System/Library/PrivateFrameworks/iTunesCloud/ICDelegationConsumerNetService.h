...
- (void)_updateNetServiceStatus;	// IMP=0x000000000003dda1
- (void)stop;	// IMP=0x000000000003dd56
- (void)publish;	// IMP=0x000000000003dd0b
@property(readonly, nonatomic) ICDelegationServiceSecuritySettings *securitySettings;
- (void)netService:(id)arg1 didNotPublish:(id)arg2;	// IMP=0x000000000003d9ec
- (void)netServiceDidPublish:(id)arg1;	// IMP=0x000000000003d939
- (void)netService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000003d7c5
- (void)dealloc;	// IMP=0x000000000003d704
- (id)initWithUserIdentityDelegationAccountUUIDs:(id)arg1;	// IMP=0x000000000003d639
