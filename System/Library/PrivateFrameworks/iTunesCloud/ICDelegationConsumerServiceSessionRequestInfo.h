...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000097016
- (unsigned long long)hash;	// IMP=0x0000000000097008
- (id)initWithAccountID:(unsigned long long)arg1 fairPlaySessionID:(unsigned long long)arg2;	// IMP=0x0000000000096fc0
