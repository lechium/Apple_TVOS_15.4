...
- (void).cxx_destruct;	// IMP=0x000000000013c1cc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013bbf0
- (id)initWithItemResponseDictionary:(id)arg1;	// IMP=0x000000000013bacc
