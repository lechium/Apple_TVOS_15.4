...
- (void).cxx_destruct;	// IMP=0x00000000000dc68d
...
- (id)initWithUserIdentityDelegationAccountUUIDs:(id)arg1 requestContext:(id)arg2 timeoutInterval:(double)arg3;	// IMP=0x00000000000dc5a6
