...
- (void).cxx_destruct;	// IMP=0x0000000000040922
...
- (id)_mediaKindFromResponseItemMetadata:(id)arg1;	// IMP=0x00000000000406f4
- (id)_createAVAssetDownloadOptionsDictionary;	// IMP=0x000000000003fcef
- (id)_sessionIdentifier;	// IMP=0x000000000003fb10
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x000000000003fa89
- (_Bool)resourceLoader:(id)arg1 shouldWaitForRenewalOfRequestedResource:(id)arg2;	// IMP=0x000000000003fa77
- (void)finishWithError:(id)arg1;	// IMP=0x000000000003fa10
- (void)cancel;	// IMP=0x000000000003f9b7
- (void)setValue:(id)arg1 forHTTPHeaderField:(id)arg2;	// IMP=0x000000000003f984
- (void)execute;	// IMP=0x000000000003ecd5
- (void)performRequestWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000003ec0b
- (id)initWithRequestContext:(id)arg1 storeMediaResponseItem:(id)arg2 resumeData:(id)arg3;	// IMP=0x000000000003ead7
