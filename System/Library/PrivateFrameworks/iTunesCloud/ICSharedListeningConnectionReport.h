...
- (void).cxx_destruct;	// IMP=0x000000000019b266
...
- (void)_addEvents:(id)arg1 toReportString:(id)arg2 eventLevel:(long long)arg3;	// IMP=0x000000000019ae51
@property(readonly, nonatomic) NSString *formattedReport;
- (void)endEvent:(id)arg1 withError:(id)arg2;	// IMP=0x000000000019aa03
- (void)endEvent:(id)arg1;	// IMP=0x000000000019a9ef
- (void)startEvent:(id)arg1 withParentEvent:(id)arg2;	// IMP=0x000000000019a88d
- (void)startEvent:(id)arg1;	// IMP=0x000000000019a879
- (id)init;	// IMP=0x000000000019a7f4
