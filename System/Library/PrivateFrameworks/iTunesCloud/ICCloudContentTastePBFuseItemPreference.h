...
- (void).cxx_destruct;	// IMP=0x00000000001417d7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000141690
- (unsigned long long)hash;	// IMP=0x00000000001415c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000141475
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000141379
- (void)writeTo:(id)arg1;	// IMP=0x0000000000141294
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000141287
- (id)dictionaryRepresentation;	// IMP=0x0000000000141083
- (id)description;	// IMP=0x0000000000140fd4
