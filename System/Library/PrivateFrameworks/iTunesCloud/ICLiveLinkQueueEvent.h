...
+ (id)queueEventWithPlaybackModeChanged:(id)arg1;	// IMP=0x000000000017c1d3
+ (id)queueEventWithContentUpdatedMessage:(id)arg1;	// IMP=0x000000000017c18f
+ (id)queueEventWithContentReplaced:(id)arg1;	// IMP=0x000000000017c14b
+ (id)queueEventWithContentReordered:(id)arg1;	// IMP=0x000000000017c107
+ (id)queueEventWithContentRemoved:(id)arg1;	// IMP=0x000000000017c0c3
+ (id)queueEventWithContentPlayedNow:(id)arg1;	// IMP=0x000000000017c07f
+ (id)queueEventWithContentAdded:(id)arg1;	// IMP=0x000000000017c03b
- (void).cxx_destruct;	// IMP=0x000000000017bfdc
...
- (id)description;	// IMP=0x000000000017be2a
