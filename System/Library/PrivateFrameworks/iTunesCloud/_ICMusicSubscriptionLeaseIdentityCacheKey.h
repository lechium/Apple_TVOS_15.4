...
- (void).cxx_destruct;	// IMP=0x000000000018ad34
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018ac65
- (unsigned long long)hash;	// IMP=0x000000000018ac0b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018ac00
- (id)initWithDSID:(id)arg1 carrierBundleDeviceIdentifier:(id)arg2 delegatedDSID:(id)arg3;	// IMP=0x000000000018ab1a
