...
- (void).cxx_destruct;	// IMP=0x000000000001b39a
...
- (id)_metadataDictionary;	// IMP=0x000000000001b2bc
...
- (id)initWithFileAssetResponseDictionary:(id)arg1;	// IMP=0x000000000001a740
- (id)initWithAssetURL:(id)arg1;	// IMP=0x000000000001a65c
