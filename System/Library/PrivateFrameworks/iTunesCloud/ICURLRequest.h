...
+ (Class)_responseHandlerClass;	// IMP=0x00000000000d2d79
+ (Class)_responseClass;	// IMP=0x00000000000d2d68
+ (id)_nameForRequestType:(long long)arg1;	// IMP=0x00000000000d2cfd
+ (unsigned long long)_defaultMaxRetryCountForReason:(id)arg1;	// IMP=0x00000000000d2c7e
- (void).cxx_destruct;	// IMP=0x00000000000d2b40
...
- (void)_updateSignpostsForNewState:(long long)arg1;	// IMP=0x00000000000d244f
- (id)_signpostRequestInfo;	// IMP=0x00000000000d2357
- (void)_ensureValidRetryReason:(id)arg1;	// IMP=0x00000000000d22aa
- (void)_incrementRetryCountForReason:(id)arg1;	// IMP=0x00000000000d21b4
- (unsigned long long)_retryCountForReason:(id)arg1;	// IMP=0x00000000000d2118
- (void)_setMaxRetryCount:(unsigned long long)arg1 forReason:(id)arg2;	// IMP=0x00000000000d2052
- (unsigned long long)_maxRetryCountForReason:(id)arg1;	// IMP=0x00000000000d1f7b
@property(readonly, nonatomic) unsigned long long retryCount;
@property(nonatomic) unsigned long long maxRetryCount;
- (void)updateState:(long long)arg1;	// IMP=0x00000000000d1cf3
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000d1c9f
- (void)addObserver:(id)arg1;	// IMP=0x00000000000d1c4b
- (void)buildURLRequestWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d1a78
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000d18e7
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2 resumeData:(id)arg3;	// IMP=0x00000000000d16f9
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2;	// IMP=0x00000000000d16e4
- (id)initWithURL:(id)arg1 requestContext:(id)arg2 resumeData:(id)arg3;	// IMP=0x00000000000d1643
- (id)initWithURL:(id)arg1 requestContext:(id)arg2;	// IMP=0x00000000000d15ba
