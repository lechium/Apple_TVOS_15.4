...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006553c
- (id)fileAssetWithFlavorType:(long long)arg1;	// IMP=0x00000000000653dd
...
- (id)initWithItemResponseDictionary:(id)arg1 urlBag:(id)arg2;	// IMP=0x0000000000064cf9
