...
- (void).cxx_destruct;	// IMP=0x00000000001bd7f1
...
- (id)_urlForBagEnhancedAudioKey:(id)arg1;	// IMP=0x00000000001bd76d
...
- (id)initWithBagEnhancedAudioDictionary:(id)arg1;	// IMP=0x00000000001bd674
