...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000076f30
- (void).cxx_destruct;	// IMP=0x0000000000076e62
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000076b95
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000076609
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007657c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000764e0
- (_Bool)isEqualToIdentityProperties:(id)arg1;	// IMP=0x0000000000075b85
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000075b22
