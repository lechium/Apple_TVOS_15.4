...
+ (id)defaultInfo;	// IMP=0x00000000000c82f6
+ (id)currentDeviceInfo;	// IMP=0x00000000000c82c6
- (void).cxx_destruct;	// IMP=0x00000000000c7e69
- (int)_gestaltDeviceClass;	// IMP=0x00000000000c7dd9
...
- (void)dealloc;	// IMP=0x00000000000c6c0b
- (id)_init;	// IMP=0x00000000000c6bc6
