...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005a5ad
- (void).cxx_destruct;	// IMP=0x000000000005a311
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005a22f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005a10d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005a102
@property(readonly, nonatomic) _Bool isExpired;
@property(readonly, copy, nonatomic) NSDate *expirationDate;
- (id)description;	// IMP=0x0000000000059eff
- (id)initWithResponseDictionary:(id)arg1;	// IMP=0x0000000000059bc0
