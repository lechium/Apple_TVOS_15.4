...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001ba138
- (void).cxx_destruct;	// IMP=0x00000000001ba128
...
- (id)_copyWithClass:(Class)arg1;	// IMP=0x00000000001ba080
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ba052
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ba047
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b9f72
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b9e68
- (id)description;	// IMP=0x00000000001b9ce1
