...
- (void).cxx_destruct;	// IMP=0x000000000017c615
...
- (id)description;	// IMP=0x000000000017c528
- (id)initWithItemIdentifiers:(id)arg1 containerKind:(long long)arg2 containerIdentifier:(id)arg3 containerMediaIdentifier:(id)arg4 startItemIdentifier:(id)arg5;	// IMP=0x000000000017c412
