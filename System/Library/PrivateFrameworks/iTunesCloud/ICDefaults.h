...
+ (id)standardDefaults;	// IMP=0x000000000014b3f4
- (void).cxx_destruct;	// IMP=0x000000000014b1b5
@property(readonly, nonatomic) NSUserDefaults *internalDefaults; // @synthesize internalDefaults=_internalDefaults;
- (void)_setOrRemoveInternalDefaultsObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000014b17f
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000014b153
- (_Bool)_shouldSpoofIPadRequestProperties;	// IMP=0x000000000014b0d1
- (_Bool)_shouldSpoofIPhoneRequestProperties;	// IMP=0x000000000014b04f
- (void)synchronize;	// IMP=0x000000000014aff6
...
- (void)deleteAutomaticDownloadsKey;	// IMP=0x000000000014aeb0
...
- (id)init;	// IMP=0x0000000000149597
