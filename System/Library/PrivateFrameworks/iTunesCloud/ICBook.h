...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000012968c
- (void).cxx_destruct;	// IMP=0x0000000000129622
...
- (id)description;	// IMP=0x0000000000129498
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000129245
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000128f42
