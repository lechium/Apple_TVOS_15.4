...
+ (id)dataSourceForExistingSharedListeningSession:(id)arg1 identity:(id)arg2;	// IMP=0x0000000000179baf
+ (id)dataSourceForNewSharedListeningSessionWithIdentity:(id)arg1;	// IMP=0x0000000000179b60
- (void).cxx_destruct;	// IMP=0x000000000017774c
...
- (id)sessionURLForBag:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000176fad
- (void)_joinSharedListeningSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000176c1a
- (void)_revokeUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000176ac4
- (void)_renewUserPseudonym;	// IMP=0x0000000000176924
- (void)_beginPseudonymAutoRenewal;	// IMP=0x000000000017678b
- (void)_provisionUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000175f6d
- (void)populateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000175ebc
- (void)dealloc;	// IMP=0x0000000000175e10
- (id)initWithSharedListeningSessionIdentifier:(id)arg1 identity:(id)arg2;	// IMP=0x0000000000175d18
