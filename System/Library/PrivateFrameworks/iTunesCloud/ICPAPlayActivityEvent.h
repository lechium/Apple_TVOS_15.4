...
- (void).cxx_destruct;	// IMP=0x000000000012533b
- (unsigned long long)hash;	// IMP=0x0000000000124490
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001236cb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000122b9a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000122284
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000120888
- (id)dictionaryRepresentation;	// IMP=0x000000000011f69b
- (id)description;	// IMP=0x000000000011f5ec
