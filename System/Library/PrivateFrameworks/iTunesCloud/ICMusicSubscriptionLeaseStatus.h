...
- (void).cxx_destruct;	// IMP=0x0000000000080ddb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000080cb3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000080a9e
- (unsigned long long)hash;	// IMP=0x00000000000809f6
- (id)description;	// IMP=0x0000000000080837
