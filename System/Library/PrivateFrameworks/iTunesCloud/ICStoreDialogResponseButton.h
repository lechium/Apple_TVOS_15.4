...
- (void).cxx_destruct;	// IMP=0x000000000016daa7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016da75
- (id)initWithType:(long long)arg1 isDefaultButton:(_Bool)arg2 title:(id)arg3 action:(id)arg4;	// IMP=0x000000000016d9ac
