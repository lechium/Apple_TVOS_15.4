...
- (void).cxx_destruct;	// IMP=0x000000000008574d
@property(nonatomic) double timeoutInterval; // @synthesize timeoutInterval=_timeoutInterval;
@property(nonatomic) long long alertLevel; // @synthesize alertLevel=_alertLevel;
- (void)_setBoolValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x00000000000856f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000085674
...
- (struct __CFUserNotification *)createCFUserNotification;	// IMP=0x00000000000851f0
- (id)initWithStoreDialog:(id)arg1;	// IMP=0x0000000000084fe7
