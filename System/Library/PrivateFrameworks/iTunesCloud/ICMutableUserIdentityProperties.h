...
- (void)setICloudPersonID:(id)arg1;	// IMP=0x0000000000075771
- (void)setCloudBackupEnabled:(_Bool)arg1;	// IMP=0x0000000000075768
@property(copy, nonatomic) NSDictionary *privacyAcknowledgementVersions; // @dynamic privacyAcknowledgementVersions;
- (void)setPrivateListeningEnabledForHomeUsers:(id)arg1;	// IMP=0x00000000000756e2
...
- (void)setHomeUserIdentifiers:(id)arg1;	// IMP=0x0000000000075622
...
- (void)replaceValuesWithValuesFromProperties:(id)arg1;	// IMP=0x00000000000753a8
