...
- (void).cxx_destruct;	// IMP=0x00000000000c3468
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c30e0
- (id)initWithResponseSinfDictionary:(id)arg1;	// IMP=0x00000000000c3083
