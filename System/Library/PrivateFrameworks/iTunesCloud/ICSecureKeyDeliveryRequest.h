...
- (void).cxx_destruct;	// IMP=0x00000000001b1845
...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b1633
- (void)configureUsingContentKeyRequest:(id)arg1;	// IMP=0x00000000001b150a
- (void)configureUsingAssetResourceLoadingRequest:(id)arg1;	// IMP=0x00000000001b13a1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b12b1
- (id)description;	// IMP=0x00000000001b0ff6
- (id)init;	// IMP=0x00000000001b0fba
