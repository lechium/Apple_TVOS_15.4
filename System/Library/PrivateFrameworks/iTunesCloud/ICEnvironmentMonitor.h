...
+ (id)sharedMonitor;	// IMP=0x00000000001b62e5
- (void).cxx_destruct;	// IMP=0x00000000001b5a7a
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000001b58e8
- (void)_handleCTServerConnectionNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000000001b589d
- (void)_handleApplicationDidEnterForegroundNotification:(id)arg1;	// IMP=0x00000000001b5852
- (void)_onQueue_updateTelephonyStateAndNotifyObservers:(_Bool)arg1;	// IMP=0x00000000001b558b
- (long long)_networkTypeFromTelephonyStatusIndicator:(id)arg1;	// IMP=0x00000000001b54fd
- (_Bool)_networkConstrained;	// IMP=0x00000000001b54b5
- (long long)_networkTypeFromWatchCarousel;	// IMP=0x00000000001b54ad
- (long long)_currentNetworkType;	// IMP=0x00000000001b510f
- (void)_onQueue_loadInitialThermalLevel;	// IMP=0x00000000001b4f9b
- (void)_onQueue_updateThermalLevelWithToken:(int)arg1;	// IMP=0x00000000001b4dac
- (void)_onQueue_updateNetworkReachabilityAndNotifyObservers:(_Bool)arg1;	// IMP=0x00000000001b48c7
@property(readonly, nonatomic) NSDictionary *signalStrength;
@property(readonly, nonatomic) NSDictionary *signalInfo;
- (void)removeObserver:(id)arg1;	// IMP=0x00000000001b47f2
- (void)addObserver:(id)arg1;	// IMP=0x00000000001b4793
- (void)dealloc;	// IMP=0x00000000001b46b2
- (id)init;	// IMP=0x00000000001b436a
