...
+ (id)sharedSAPSessionWithVersion:(unsigned int)arg1 URLBag:(id)arg2 requestContext:(id)arg3;	// IMP=0x00000000000097e6
- (void).cxx_destruct;	// IMP=0x00000000000095d3
...
- (void)verifySignatureData:(id)arg1 forData:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000009460
- (void)signData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000935e
- (id)_initWithVersion:(unsigned int)arg1 certificateURL:(id)arg2 setupURL:(id)arg3 requestContext:(id)arg4;	// IMP=0x00000000000091b1
