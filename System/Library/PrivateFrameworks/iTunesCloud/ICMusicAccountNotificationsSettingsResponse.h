...
+ (id)createResponseBodyWithSwitches:(id)arg1;	// IMP=0x00000000001c75f1
- (void).cxx_destruct;	// IMP=0x00000000001c75e1
...
- (id)initWithResponseDictionary:(id)arg1;	// IMP=0x00000000001c71dc
