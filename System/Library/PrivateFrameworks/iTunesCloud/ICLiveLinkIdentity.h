...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000ebc8b
+ (id)identityWithIdentifier:(id)arg1;	// IMP=0x00000000000ebc72
- (void).cxx_destruct;	// IMP=0x00000000000ebc34
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ebbb1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ebb01
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000eb9b8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e9de0
@property(readonly, copy) NSString *description;
- (id)_initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000e9d33
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000e9d21
