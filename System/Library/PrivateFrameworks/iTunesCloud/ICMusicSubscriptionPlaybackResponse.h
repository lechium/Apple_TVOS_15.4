...
- (void).cxx_destruct;	// IMP=0x00000000001b0eb7
...
- (id)itemWithStoreAdamID:(long long)arg1;	// IMP=0x00000000001b0bc2
...
- (id)initWithResponseDictionary:(id)arg1 requestDate:(id)arg2 urlBag:(id)arg3;	// IMP=0x00000000001b0649
