...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001140a6
- (void).cxx_destruct;	// IMP=0x00000000001136bd
...
- (Class)_mutableCopyClass;	// IMP=0x0000000000113445
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000111ac0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000111ab5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000111a32
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001119a5
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x000000000011075f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001106dc
- (unsigned long long)hash;	// IMP=0x00000000001106ca
- (id)description;	// IMP=0x0000000000110064
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x000000000010ecc6
- (id)init;	// IMP=0x000000000010ec7f
