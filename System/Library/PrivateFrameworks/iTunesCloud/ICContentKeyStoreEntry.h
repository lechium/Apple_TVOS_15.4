...
- (void).cxx_destruct;	// IMP=0x00000000000ce890
...
- (id)dictionaryRepresentation;	// IMP=0x00000000000ce701
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000000ce5bb
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000000ce550
