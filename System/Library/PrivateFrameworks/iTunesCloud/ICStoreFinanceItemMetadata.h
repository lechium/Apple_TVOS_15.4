...
- (void).cxx_destruct;	// IMP=0x000000000001f50f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001f4f0
...
- (id)albumID;	// IMP=0x000000000001ecce
...
- (id)initWithMetadataDictionary:(id)arg1;	// IMP=0x000000000001e7d9
