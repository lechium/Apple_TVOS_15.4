...
- (_Bool)_updateAutomaticDownloadKindsByAddingMediaKindMusic:(_Bool)arg1 error:(id *)arg2;	// IMP=0x000000000017e834
...
- (void)ic_updateAutomaticDownloadKindsByAddingMediaKindMusic:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000017e42a
- (_Bool)ic_updateAutomaticDownloadKindsByAddingMediaKindMusic:(_Bool)arg1 error:(id *)arg2;	// IMP=0x000000000017e416
- (_Bool)ic_isAutomaticDownloadsEnabledForMediaKindMusic;	// IMP=0x000000000017e3a3
