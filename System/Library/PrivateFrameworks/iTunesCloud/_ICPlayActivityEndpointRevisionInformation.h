...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009e53f
- (void).cxx_destruct;	// IMP=0x000000000009e517
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e45d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009e3d6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009e290
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009e1f3
- (unsigned long long)hash;	// IMP=0x000000000009e1b0
