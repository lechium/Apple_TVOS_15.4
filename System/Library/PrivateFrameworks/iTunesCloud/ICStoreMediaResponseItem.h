...
- (void).cxx_destruct;	// IMP=0x0000000000057b7e
@property(copy, nonatomic) NSDate *assetExpirationDate; // @synthesize assetExpirationDate=_assetExpirationDate;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000057b5a
- (id)downloadableAssetMatchingFlavorType:(long long)arg1;	// IMP=0x000000000005799b
- (id)downloadableAsset;	// IMP=0x0000000000057822
...
- (id)initWithItemResponseDictionary:(id)arg1 urlBag:(id)arg2;	// IMP=0x0000000000056deb
