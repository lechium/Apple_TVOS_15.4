...
- (void).cxx_destruct;	// IMP=0x000000000013ba0c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013b95d
- (id)initWithIdentity:(id)arg1 identityStore:(id)arg2 clientInfo:(id)arg3;	// IMP=0x000000000013b86f
