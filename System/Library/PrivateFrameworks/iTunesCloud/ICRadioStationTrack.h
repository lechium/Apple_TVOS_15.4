...
+ (id)flattenedTracksWithTracks:(id)arg1;	// IMP=0x00000000000f6ad5
- (void).cxx_destruct;	// IMP=0x00000000000f69ae
...
- (id)_hlsAssetFromAssetDictionary:(id)arg1;	// IMP=0x00000000000f663d
...
- (id)initWithResponseDictionary:(id)arg1 responseVersion:(long long)arg2 expirationDate:(id)arg3;	// IMP=0x00000000000f561f
