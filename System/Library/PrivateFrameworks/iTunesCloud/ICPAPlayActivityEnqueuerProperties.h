...
- (void).cxx_destruct;	// IMP=0x000000000011f131
- (unsigned long long)hash;	// IMP=0x000000000011eff1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011edc5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011ec3f
- (void)writeTo:(id)arg1;	// IMP=0x000000000011eafd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000011eaf0
- (id)dictionaryRepresentation;	// IMP=0x000000000011e88a
- (id)description;	// IMP=0x000000000011e7db
