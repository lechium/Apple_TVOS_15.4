...
- (void).cxx_destruct;	// IMP=0x000000000019645d
...
- (void)_decorateHeaderPropertiesForURLRequest:(id)arg1 withBuilderProperties:(id)arg2;	// IMP=0x0000000000196142
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000195f3e
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2;	// IMP=0x0000000000195efb
