...
+ (id)storeServerCalendar;	// IMP=0x00000000000877e7
- (void).cxx_destruct;	// IMP=0x00000000000876e6
...
- (id)_storePlatformReleaseDateFormatter;	// IMP=0x00000000000876a2
...
- (id)offerWithType:(id)arg1;	// IMP=0x0000000000086b0d
...
- (id)initWithMetadataDictionary:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00000000000859c2
- (id)initWithMetadataDictionary:(id)arg1;	// IMP=0x00000000000859ae
