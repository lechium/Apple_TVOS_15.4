...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000014d794
- (void).cxx_destruct;	// IMP=0x000000000014d568
...
- (id)_copyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x000000000014d3f3
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014d3c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014d3b5
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014d1c8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000014d0c2
- (id)description;	// IMP=0x000000000014cea3
