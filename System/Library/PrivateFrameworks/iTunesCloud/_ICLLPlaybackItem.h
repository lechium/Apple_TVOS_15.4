...
- (void).cxx_destruct;	// IMP=0x00000000000ac192
- (unsigned long long)hash;	// IMP=0x00000000000ac081
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000abeb8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000abd6f
- (void)writeTo:(id)arg1;	// IMP=0x00000000000abc6c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000abc5f
- (id)dictionaryRepresentation;	// IMP=0x00000000000aba2e
- (id)description;	// IMP=0x00000000000ab97f
