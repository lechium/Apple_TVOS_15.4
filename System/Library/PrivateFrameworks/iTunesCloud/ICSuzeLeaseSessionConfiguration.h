...
- (void).cxx_destruct;	// IMP=0x000000000019b58f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019b566
- (id)initWithRequestContext:(id)arg1 leaseID:(id)arg2 mediaType:(long long)arg3;	// IMP=0x000000000019b4b7
