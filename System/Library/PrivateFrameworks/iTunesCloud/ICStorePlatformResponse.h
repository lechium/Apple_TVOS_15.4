...
- (void).cxx_destruct;	// IMP=0x0000000000175578
...
- (void)_enumerateResultDictionariesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000017543c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000175431
...
- (id)itemForIdentifier:(id)arg1;	// IMP=0x000000000017513f
- (void)enumerateItemsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000174ffe
@property(readonly, copy, nonatomic) NSArray *allItems;
- (id)initWithURLResponse:(id)arg1 requestedItemIdentifiers:(id)arg2;	// IMP=0x0000000000174bd6
- (id)initWithResponseDictionary:(id)arg1 requestedItemIdentifiers:(id)arg2;	// IMP=0x0000000000174b1d
- (id)initWithResponseDictionary:(id)arg1;	// IMP=0x0000000000174b04
