...
+ (void)initialize;	// IMP=0x0000000000003be2
...
- (void)_addUserActivities:(id)arg1;	// IMP=0x00000000000035c5
@property(readonly, copy, nonatomic) NSUserActivity *currentUserActivity; // @synthesize currentUserActivity=_currentUserActivity;
- (void)_updateCurrentUserActivityForType:(long long)arg1 intent:(id)arg2 intentResponse:(id)arg3;	// IMP=0x0000000000002f18
- (id)userActivityWithIdentifier:(id)arg1;	// IMP=0x0000000000002ab1
@property(readonly, nonatomic) INCExtensionRequest *request; // @synthesize request=_request;
- (id)initWithIntent:(id)arg1 donateInteraction:(_Bool)arg2 groupIdentifier:(id)arg3;	// IMP=0x0000000000002922
- (id)description;	// IMP=0x000000000000282d
