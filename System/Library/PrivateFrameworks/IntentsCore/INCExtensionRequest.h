...
+ (void)initialize;	// IMP=0x0000000000002370
- (void).cxx_destruct;	// IMP=0x0000000000001a15
...
- (void)_scheduleContextTimer;	// IMP=0x00000000000018b1
- (void)_resetContextTimer;	// IMP=0x000000000000187f
- (void)_resetExtensionContextHostWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000017ab
- (id)_extensionContextHost;	// IMP=0x0000000000001672
- (id)_requestOperationQueue;	// IMP=0x0000000000001621
- (void)reset;	// IMP=0x00000000000015d6
- (void)startRequestForIntent:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001513
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00000000000013cc
