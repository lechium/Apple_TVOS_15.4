...
- (void).cxx_destruct;	// IMP=0x00000000000d334c
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000d321d
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000d310f
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000d2f24
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000d2f1a
- (id)init;	// IMP=0x00000000000d2ea0
