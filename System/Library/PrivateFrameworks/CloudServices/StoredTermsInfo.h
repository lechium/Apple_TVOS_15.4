...
- (void).cxx_destruct;	// IMP=0x0000000000018582
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000184d1
- (unsigned long long)hash;	// IMP=0x0000000000018487
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000183c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000018331
- (void)copyTo:(id)arg1;	// IMP=0x00000000000182cd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000018268
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001825b
- (id)dictionaryRepresentation;	// IMP=0x0000000000017f0b
- (id)description;	// IMP=0x0000000000017e5c
