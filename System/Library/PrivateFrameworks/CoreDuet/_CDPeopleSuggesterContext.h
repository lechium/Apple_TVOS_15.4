...
+ (id)currentContext;	// IMP=0x00000000000aa743
- (void).cxx_destruct;	// IMP=0x00000000000aad88
...
- (id)description;	// IMP=0x00000000000aa9f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000aa808
- (id)init;	// IMP=0x00000000000aa75c
