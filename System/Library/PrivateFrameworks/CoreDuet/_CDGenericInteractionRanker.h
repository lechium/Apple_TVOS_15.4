...
+ (_Bool)isDateInWeekend:(id)arg1;	// IMP=0x00000000000937d9
- (void).cxx_destruct;	// IMP=0x000000000009498f
...
- (_Bool)contactIsAllowed:(id)arg1;	// IMP=0x00000000000945ba
- (double)rankContact:(id)arg1;	// IMP=0x00000000000942ec
- (_Bool)canRankContacts;	// IMP=0x000000000009429c
- (id)rankInteraction:(id)arg1;	// IMP=0x000000000009386c
- (id)init;	// IMP=0x00000000000936c3
