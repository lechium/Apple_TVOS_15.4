...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000048f96
- (void).cxx_destruct;	// IMP=0x0000000000048fef
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000048f13
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000048e1d
- (id)init;	// IMP=0x0000000000048d68
