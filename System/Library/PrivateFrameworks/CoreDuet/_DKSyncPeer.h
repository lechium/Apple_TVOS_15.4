...
- (void).cxx_destruct;	// IMP=0x000000000010d778
...
- (id)description;	// IMP=0x000000000010d4ea
@property(readonly, copy, nonatomic) NSString *identifier;
@property(readonly, copy, nonatomic) NSUUID *sourceDeviceUUID;
- (id)initWithIDSDeviceIdentifier:(id)arg1 zoneName:(id)arg2;	// IMP=0x000000000010d391
- (id)initWithZoneName:(id)arg1;	// IMP=0x000000000010d37a
- (id)initWithIDSDeviceIdentifier:(id)arg1;	// IMP=0x000000000010d366
- (id)init;	// IMP=0x000000000010d350
