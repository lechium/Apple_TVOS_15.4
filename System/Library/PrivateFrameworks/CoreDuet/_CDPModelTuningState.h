...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006462c
+ (id)initialTuningState;	// IMP=0x000000000006421f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000064503
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006440e
- (id)description;	// IMP=0x000000000006437f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000064253
