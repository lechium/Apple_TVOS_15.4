...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000b1fb0
+ (id)topNPredictionQueryForStream:(id)arg1 withPredicate:(id)arg2 withTopN:(long long)arg3 withMinLikelihood:(double)arg4;	// IMP=0x00000000000ad868
+ (id)predictionQueryForStreams:(id)arg1 withPredicate:(id)arg2 withPredictionType:(unsigned long long)arg3;	// IMP=0x00000000000ad6d2
+ (id)predictionQueryForStream:(id)arg1 withPredicate:(id)arg2 withPredictionType:(unsigned long long)arg3;	// IMP=0x00000000000ad5f0
- (void).cxx_destruct;	// IMP=0x00000000000b2558
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b2348
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b21d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b1fb8
- (id)handleResults:(id)arg1 error:(id)arg2;	// IMP=0x00000000000b1f66
- (id)executeUsingCoreDataStorage:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b15aa
