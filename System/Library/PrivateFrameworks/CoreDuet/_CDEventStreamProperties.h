...
+ (id)eventStreamPropertiesFromDictionary:(id)arg1 defaultProperties:(id)arg2;	// IMP=0x000000000004f269
+ (id)eventStreamPropertiesFromDictionary:(id)arg1;	// IMP=0x000000000004f216
...
- (id)initFromDictionary:(id)arg1 defaultProperties:(id)arg2;	// IMP=0x000000000004f2d9
...
- (id)description;	// IMP=0x000000000004e344
