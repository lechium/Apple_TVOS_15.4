...
- (void).cxx_destruct;	// IMP=0x00000000000dfc44
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000de480
- (unsigned long long)hash;	// IMP=0x00000000000d7a31
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d6049
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d5027
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d4049
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d2ffd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d2ff0
- (id)dictionaryRepresentation;	// IMP=0x00000000000cd7c7
- (id)description;	// IMP=0x00000000000cd718
