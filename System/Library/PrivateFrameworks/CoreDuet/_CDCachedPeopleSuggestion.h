...
- (void).cxx_destruct;	// IMP=0x00000000000aa508
...
- (_Bool)isValidForContext:(id)arg1 settings:(id)arg2 timeoutSeconds:(double)arg3;	// IMP=0x00000000000aa321
- (_Bool)isValidForSettings:(id)arg1;	// IMP=0x00000000000a9d83
- (_Bool)isValidForContext:(id)arg1;	// IMP=0x00000000000a98b7
