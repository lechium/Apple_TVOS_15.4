...
+ (id)recipientIdentifiersFromMobileMailConversationId:(id)arg1;	// IMP=0x000000000004ca20
+ (id)generateConversationIdFromInteractionRecipients:(id)arg1;	// IMP=0x000000000004c67e
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004b72f
- (void).cxx_destruct;	// IMP=0x000000000004cd75
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004c5bf
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)descriptionOfArray:(id)arg1;	// IMP=0x000000000004bf3a
- (id)init;	// IMP=0x000000000004bdb0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004bb93
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004b737
