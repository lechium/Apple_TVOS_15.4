...
- (void).cxx_destruct;	// IMP=0x0000000000182b65
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001827e5
- (unsigned long long)hash;	// IMP=0x000000000018257e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018228f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000182059
- (void)copyTo:(id)arg1;	// IMP=0x0000000000181ea4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000181d05
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000181cf8
- (id)dictionaryRepresentation;	// IMP=0x00000000001816df
- (id)description;	// IMP=0x0000000000181630
