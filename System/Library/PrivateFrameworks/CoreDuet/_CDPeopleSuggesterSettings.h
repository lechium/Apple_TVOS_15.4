...
+ (id)defaultSettings;	// IMP=0x00000000000aadfd
- (void).cxx_destruct;	// IMP=0x00000000000ab774
...
- (id)description;	// IMP=0x00000000000ab173
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000aaeee
- (id)init;	// IMP=0x00000000000aae16
