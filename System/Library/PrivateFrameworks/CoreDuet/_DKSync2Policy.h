...
+ (id)disabledFeaturesForSyncType:(id)arg1 transports:(long long)arg2;	// IMP=0x0000000000010d64
+ (id)policyFromDictionary:(id)arg1;	// IMP=0x000000000001008f
+ (void)setOkToDownloadPolicyUpdates:(_Bool)arg1;	// IMP=0x000000000000d27b
+ (_Bool)cloudSyncDisabled;	// IMP=0x000000000000d1c5
+ (_Bool)rapportSyncDisabled;	// IMP=0x000000000000d10f
+ (id)policyForSyncTransportType:(long long)arg1;	// IMP=0x000000000000ce89
- (void).cxx_destruct;	// IMP=0x00000000000124f1
...
- (id)description;	// IMP=0x0000000000011b08
- (double)hoursBetweenSyncsWhenIsSingleDevice:(_Bool)arg1 urgency:(unsigned long long)arg2;	// IMP=0x00000000000119a7
- (double)hoursBetweenSyncsWhenIsSingleDevice:(_Bool)arg1;	// IMP=0x0000000000011993
- (id)queryStartDateWithSyncType:(id)arg1 previousHighWaterMark:(id)arg2;	// IMP=0x000000000001190a
- (id)queryStartDateWithSyncType:(id)arg1 lastSyncDate:(id)arg2 lastDaySyncCount:(unsigned long long)arg3 previousHighWaterMark:(id)arg4;	// IMP=0x0000000000011881
- (_Bool)highPriorityForSyncUpWithSyncType:(id)arg1 lastSyncDate:(id)arg2;	// IMP=0x0000000000011638
- (_Bool)highPriorityForSyncDownWithSyncType:(id)arg1;	// IMP=0x00000000000115c5
- (_Bool)canPerformSyncOperationWithSyncType:(id)arg1 lastSyncDate:(id)arg2 lastDaySyncCount:(unsigned long long)arg3 isCharging:(_Bool)arg4;	// IMP=0x000000000001122b
- (_Bool)canDeferSyncOperationWithSyncType:(id)arg1;	// IMP=0x00000000000111da
- (id)streamNamesToSyncWithSyncType:(id)arg1 transportType:(long long)arg2;	// IMP=0x0000000000011174
- (id)streamNamesToSyncWithDisabledFeatures:(id)arg1;	// IMP=0x0000000000010f26
