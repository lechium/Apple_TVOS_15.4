...
+ (id)extractContactIdentifiers:(id)arg1;	// IMP=0x00000000000e0e2a
+ (id)interactionAdvisorSettingsDefault;	// IMP=0x00000000000e04e3
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000dfc57
- (void).cxx_destruct;	// IMP=0x00000000000e2002
...
- (id)contactPredicate;	// IMP=0x00000000000e1b1e
- (id)interactionPredicate;	// IMP=0x00000000000e104c
- (id)description;	// IMP=0x00000000000e0a80
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e05dc
- (id)init;	// IMP=0x00000000000e04fc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e0266
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000dfc5f
