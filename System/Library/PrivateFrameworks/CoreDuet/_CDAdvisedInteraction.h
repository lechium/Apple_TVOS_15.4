...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000023cca
- (void).cxx_destruct;	// IMP=0x00000000000246ca
...
- (void)addReasons:(id)arg1;	// IMP=0x0000000000024543
- (void)addReason:(long long)arg1;	// IMP=0x00000000000244ba
@property(retain) NSSet *reasons;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000024289
- (id)description;	// IMP=0x00000000000240a7
- (id)descriptionOfReasons:(id)arg1;	// IMP=0x0000000000023f14
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000023e4d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000023cd2
