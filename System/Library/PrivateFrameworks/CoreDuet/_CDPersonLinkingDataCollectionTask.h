...
- (void).cxx_destruct;	// IMP=0x0000000000052715
...
- (id)eventFromFile:(id)arg1;	// IMP=0x0000000000052521
- (void)execute;	// IMP=0x000000000005246b
- (id)eventFromDict:(id)arg1;	// IMP=0x0000000000051f87
- (id)initWithFile:(id)arg1 activity:(id)arg2;	// IMP=0x0000000000051ec5
