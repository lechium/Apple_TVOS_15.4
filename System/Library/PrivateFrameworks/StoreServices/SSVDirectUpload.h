...
- (void).cxx_destruct;	// IMP=0x00000000001812cd
...
- (id)copyXPCEncoding;	// IMP=0x000000000018108a
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000180e28
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000180dac
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (void)_adoptStatusFromUpload:(id)arg1;	// IMP=0x0000000000180c7b
