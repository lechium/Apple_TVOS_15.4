...
- (void).cxx_destruct;	// IMP=0x00000000000b2d07
...
- (void)_enumerateAssetsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b2b72
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b2ac7
- (unsigned long long)hash;	// IMP=0x00000000000b2a54
- (id)description;	// IMP=0x00000000000b2980
...
- (id)assetForFlavor:(id)arg1;	// IMP=0x00000000000b24b4
- (id)initWithItemDictionary:(id)arg1;	// IMP=0x00000000000b2441
