...
+ (id)contextForSignIn;	// IMP=0x000000000005ded1
- (void).cxx_destruct;	// IMP=0x000000000005fd21
...
- (void)_copyIvarsToCopy:(id)arg1 withZone:(struct _NSZone *)arg2;	// IMP=0x000000000005f857
- (_Bool)_allowCreateAccount;	// IMP=0x000000000005f84a
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005f159
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005f101
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x000000000005ec18
- (id)copyXPCEncoding;	// IMP=0x000000000005e8f0
@property(readonly, nonatomic) SSURLBagContext *URLBagContext;
- (id)accountStoreOptions;	// IMP=0x000000000005df3b
- (id)initWithAccountIdentifier:(id)arg1;	// IMP=0x000000000005ddb0
- (id)initWithAccount:(id)arg1;	// IMP=0x000000000005dcb5
- (id)init;	// IMP=0x000000000005dca3
- (id)_initSSAuthenticationContext;	// IMP=0x000000000005dc03
