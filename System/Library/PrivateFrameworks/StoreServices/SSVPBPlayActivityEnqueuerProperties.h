...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002dd38
- (unsigned long long)hash;	// IMP=0x000000000002dbf8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d9c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d842
- (void)copyTo:(id)arg1;	// IMP=0x000000000002d703
- (void)writeTo:(id)arg1;	// IMP=0x000000000002d5c1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002d5b4
- (id)dictionaryRepresentation;	// IMP=0x000000000002ce87
- (id)description;	// IMP=0x000000000002cdd8
...
- (int)StringAsSystemReleaseType:(id)arg1;	// IMP=0x000000000002cc1c
- (id)systemReleaseTypeAsString:(int)arg1;	// IMP=0x000000000002cb90
