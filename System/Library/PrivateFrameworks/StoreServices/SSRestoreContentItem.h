...
- (void)_setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x00000000000cd0ba
- (id)_restoreKeyForDownloadProperty:(id)arg1;	// IMP=0x00000000000ccf9d
- (id)_restoreKeyForAssetProperty:(id)arg1;	// IMP=0x00000000000cceee
...
- (void)setValue:(id)arg1 forDownloadProperty:(id)arg2;	// IMP=0x00000000000ccc29
- (void)setValue:(id)arg1 forAssetProperty:(id)arg2;	// IMP=0x00000000000ccbe6
...
- (_Bool)isEligibleForRestore:(id *)arg1;	// IMP=0x00000000000cc80d
- (id)copyRestoreDictionary;	// IMP=0x00000000000cc673
- (void)dealloc;	// IMP=0x00000000000cc5c8
- (id)initWithRestoreDownload:(id)arg1;	// IMP=0x00000000000cc3ca
- (id)init;	// IMP=0x00000000000cc3b8
- (id)_initSSRestoreContentItem;	// IMP=0x00000000000cc36c
