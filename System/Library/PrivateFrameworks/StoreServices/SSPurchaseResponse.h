...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000116529
- (void).cxx_destruct;	// IMP=0x0000000000116904
...
- (id)copyXPCEncoding;	// IMP=0x000000000011675d
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000116531
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001163ef
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000116151
- (id)responseMetrics;	// IMP=0x000000000011602d
- (id)transactionIdentifierForItemIdentifier:(long long)arg1;	// IMP=0x0000000000115c12
- (id)downloadsMetadata;	// IMP=0x00000000001159a7
- (id)downloadMetadataForItemIdentifier:(long long)arg1;	// IMP=0x00000000001156f1
