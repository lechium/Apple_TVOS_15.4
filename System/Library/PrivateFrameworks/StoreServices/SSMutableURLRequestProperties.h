...
- (void)setMultiPartFormDataWithDictionary:(id)arg1;	// IMP=0x00000000000a4929
...
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x00000000000a45ec
- (void)setValue:(id)arg1 forHTTPHeaderField:(id)arg2;	// IMP=0x00000000000a4498
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a3964
