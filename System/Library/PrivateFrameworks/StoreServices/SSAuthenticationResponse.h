...
- (void).cxx_destruct;	// IMP=0x00000000000c688b
...
- (id)_valueForFirstAvailableKey:(id)arg1;	// IMP=0x00000000000c66cf
- (long long)_responseTypeForStatusValue:(long long)arg1;	// IMP=0x00000000000c669e
- (long long)_responseTypeForFailureType:(long long)arg1;	// IMP=0x00000000000c6678
- (long long)_responseTypeForErrorNumber:(long long)arg1;	// IMP=0x00000000000c6651
@property(readonly) NSString *userMessage;
@property(readonly) NSHTTPURLResponse *URLResponse;
@property(readonly) NSString *token;
@property(readonly) NSString *storeFrontIdentifier;
@property(readonly) long long responseType;
- (id)newAccount;	// IMP=0x00000000000c5b0a
...
- (id)altDSID;	// IMP=0x00000000000c561b
...
- (id)initWithURLResponse:(id)arg1 dictionary:(id)arg2;	// IMP=0x00000000000c5371
