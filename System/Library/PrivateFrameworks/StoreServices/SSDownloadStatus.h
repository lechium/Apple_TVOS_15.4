...
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000020692
- (id)copyXPCEncoding;	// IMP=0x0000000000020610
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020580
- (void)setPercentComplete:(float)arg1;	// IMP=0x0000000000020522
@property(nonatomic, getter=isPausable) _Bool pausable;
- (void)setOperationType:(long long)arg1;	// IMP=0x00000000000204ba
- (void)setOperationProgress:(id)arg1;	// IMP=0x0000000000020472
