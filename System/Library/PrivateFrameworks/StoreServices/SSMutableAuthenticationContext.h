...
@interface SSMutableAuthenticationContext <SSXPCCoding, NSCopying, NSMutableCopying>
{
}

@property(nonatomic, getter=isDemoAccount) _Bool demoAccount; // @dynamic demoAccount;
- (void)setValuesWithAccount:(id)arg1;	// IMP=0x000000000006069b
...
- (void)setValue:(id)arg1 forHTTPHeaderField:(id)arg2;	// IMP=0x0000000000060414
...
@property(nonatomic) _Bool shouldIgnoreAccountConversion; // @dynamic shouldIgnoreAccountConversion;
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005fe7d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005fe06
