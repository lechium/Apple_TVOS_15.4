...
- (void).cxx_destruct;	// IMP=0x000000000014bc5a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014bb41
@property(readonly, nonatomic) NSDictionary *bagDictionary;
- (id)initWithBagDictionary:(id)arg1;	// IMP=0x000000000014b6e1
- (id)initWithLookupURL:(id)arg1 unpersonalizedLookupURL:(id)arg2 signedHeaders:(id)arg3 signedQueryParameters:(id)arg4;	// IMP=0x000000000014b58e
