...
- (void).cxx_destruct;	// IMP=0x000000000018ce6b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018cdb1
...
- (id)itemForItemIdentifier:(id)arg1;	// IMP=0x000000000018cb51
