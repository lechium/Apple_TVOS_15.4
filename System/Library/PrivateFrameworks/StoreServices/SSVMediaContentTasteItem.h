...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d24bd
- (void).cxx_destruct;	// IMP=0x00000000000d25ac
...
- (id)_copyWithMediaContentTasteItemClass:(Class)arg1;	// IMP=0x00000000000d253a
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000000000d24cf
- (id)copyXPCEncoding;	// IMP=0x00000000000d24c5
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d248f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d2484
@property(readonly, copy) NSString *description;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d22b2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d21e0
