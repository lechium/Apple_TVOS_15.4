...
- (void).cxx_destruct;	// IMP=0x0000000000048c27
...
- (id)_appCohortID:(id)arg1;	// IMP=0x0000000000048962
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048679
- (id)financeDictionaryRepresentation;	// IMP=0x0000000000047e33
- (id)dictionaryRepresentation;	// IMP=0x0000000000047765
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004701e
- (id)init;	// IMP=0x0000000000046f9e
