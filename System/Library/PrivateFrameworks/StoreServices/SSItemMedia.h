...
- (id)initWithStoreOfferDictionary:(id)arg1;	// IMP=0x0000000000046866
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000046801
- (unsigned long long)hash;	// IMP=0x00000000000467eb
- (id)description;	// IMP=0x000000000004678b
- (void)dealloc;	// IMP=0x0000000000046741
- (id)init;	// IMP=0x0000000000046705
