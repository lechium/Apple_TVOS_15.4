...
- (void)_handleMessage:(id)arg1 fromServerConnection:(id)arg2;	// IMP=0x00000000000d20b6
- (void)_connectEventConnection;	// IMP=0x00000000000d1e7a
@property id <SSEventMonitorDelegate> delegate;
- (void)dealloc;	// IMP=0x00000000000d1c69
- (id)init;	// IMP=0x00000000000d1b84
