...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000126150
- (void)dealloc;	// IMP=0x0000000000126115
- (id)initWithResponseData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000125ee3
