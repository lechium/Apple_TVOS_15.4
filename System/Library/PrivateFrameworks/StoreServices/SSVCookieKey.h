...
+ (id)keyWithIdentifier:(id)arg1 scope:(long long)arg2;	// IMP=0x00000000000d2642
- (void).cxx_destruct;	// IMP=0x00000000000d27a9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d26b7
