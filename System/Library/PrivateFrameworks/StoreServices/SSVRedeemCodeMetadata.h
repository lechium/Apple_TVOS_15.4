...
- (void).cxx_destruct;	// IMP=0x000000000014cff4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014cf40
@property(readonly, nonatomic) NSArray *items;
@property(readonly, nonatomic) _Bool allowsAutoSubmission;
@property(readonly, nonatomic) NSString *codeType;
@property(readonly, nonatomic) NSString *code;
- (id)initWithRedeemCodeDictionary:(id)arg1;	// IMP=0x000000000014ca3a
