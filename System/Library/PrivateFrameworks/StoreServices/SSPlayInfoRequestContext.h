...
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000000000a76c1
- (id)copyXPCEncoding;	// IMP=0x00000000000a762f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a757d
- (void)dealloc;	// IMP=0x00000000000a7517
