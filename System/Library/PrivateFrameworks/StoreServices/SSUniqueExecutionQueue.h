...
- (void).cxx_destruct;	// IMP=0x00000000000290df
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000028516
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002844b
