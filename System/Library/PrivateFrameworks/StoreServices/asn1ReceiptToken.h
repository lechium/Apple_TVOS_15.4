...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x0000000000164211
...
- (id)description;	// IMP=0x00000000001643db
- (void)dealloc;	// IMP=0x00000000001641d6
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x0000000000164170
