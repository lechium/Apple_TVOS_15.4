...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000163e44
- (void).cxx_destruct;	// IMP=0x0000000000163f06
...
- (id)_copyWithClass:(Class)arg1;	// IMP=0x0000000000163e4c
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000163e16
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000163e0b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000163d22
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000163c04
- (id)description;	// IMP=0x0000000000163a5b
