...
+ (id)defaultOverrideHTTPHeaderFields;	// IMP=0x00000000000afa38
- (void).cxx_destruct;	// IMP=0x00000000000b1231
@property(copy, nonatomic) NSString *currentStoreFrontID; // @synthesize currentStoreFrontID=_currentStoreFrontID;
- (id)propertyListObjectWithPlayActivityEvent:(id)arg1;	// IMP=0x00000000000afabb
