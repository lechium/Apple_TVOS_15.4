...
- (id)_storeFrontSuffix;	// IMP=0x000000000009ef27
- (id)_lookupWithRequest:(id)arg1 error:(id *)arg2;	// IMP=0x000000000009ec1c
- (void)main;	// IMP=0x000000000009e450
...
- (id)initWithBaseURL:(id)arg1 location:(id)arg2;	// IMP=0x000000000009d593
