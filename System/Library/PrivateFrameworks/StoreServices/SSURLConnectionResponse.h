...
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000000000a6215
- (id)copyXPCEncoding;	// IMP=0x00000000000a61ac
@property(readonly, nonatomic) NSString *storeCorrelationID;
@property(readonly, nonatomic) NSData *databaseEncoding;
- (id)initWithDatabaseEncoding:(id)arg1;	// IMP=0x00000000000a5a27
@property(readonly, nonatomic) NSURL *URL;
@property(readonly, nonatomic) NSString *textEncodingName;
@property(readonly, nonatomic) NSString *suggestedFilename;
- (long long)statusCode;	// IMP=0x00000000000a59cf
@property(readonly, nonatomic) NSString *MIMEType;
@property(readonly, nonatomic) long long expectedContentLength;
- (id)allHeaderFields;	// IMP=0x00000000000a598d
- (void)dealloc;	// IMP=0x00000000000a593c
- (id)initWithURLResponse:(id)arg1 bodyData:(id)arg2;	// IMP=0x00000000000a58d1
