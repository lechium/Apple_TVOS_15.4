...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000010bac5
- (void).cxx_destruct;	// IMP=0x000000000010c8a3
...
- (Class)_mutableCopyClass;	// IMP=0x000000000010c6ba
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010b814
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010b809
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000010b786
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010b6f9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010b676
- (unsigned long long)hash;	// IMP=0x000000000010b664
- (id)description;	// IMP=0x000000000010b1a2
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x0000000000109d48
- (id)init;	// IMP=0x0000000000109d01
