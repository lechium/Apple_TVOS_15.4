...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a0557
- (void).cxx_destruct;	// IMP=0x00000000000a38a9
...
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00000000000a0f6a
- (id)copyXPCEncoding;	// IMP=0x00000000000a0b46
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a056a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a055f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009fa5d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009f571
- (id)initWithURLRequest:(id)arg1;	// IMP=0x000000000009f3ba
- (id)initWithURL:(id)arg1;	// IMP=0x000000000009f342
- (id)init;	// IMP=0x000000000009f32e
- (id)_initCommon;	// IMP=0x000000000009f2d6
