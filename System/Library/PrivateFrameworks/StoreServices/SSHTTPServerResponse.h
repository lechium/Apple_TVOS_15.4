...
- (void).cxx_destruct;	// IMP=0x000000000000522d
...
- (struct __CFHTTPMessage *)copyHTTPMessage;	// IMP=0x0000000000004f8d
- (id)bagFromBody;	// IMP=0x0000000000004d3f
- (void)setBodyWithBag:(id)arg1;	// IMP=0x0000000000004abb
- (id)initWithStatusCode:(short)arg1;	// IMP=0x0000000000004a7f
