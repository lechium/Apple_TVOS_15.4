...
+ (_Bool)_errorIsCanceledError:(id)arg1;	// IMP=0x00000000001567ed
+ (id)observableWithObservers:(id)arg1;	// IMP=0x0000000000154716
+ (id)observableWithObserver:(id)arg1;	// IMP=0x00000000001546bc
- (void).cxx_destruct;	// IMP=0x0000000000156967
...
- (_Bool)_isComplete;	// IMP=0x000000000015687c
- (void)subscribe:(id)arg1;	// IMP=0x0000000000155dd5
- (_Bool)sendResult:(id)arg1;	// IMP=0x00000000001553b4
- (_Bool)sendFailure:(id)arg1;	// IMP=0x0000000000154eb4
- (_Bool)sendCompletion;	// IMP=0x0000000000154a4e
- (_Bool)cancel;	// IMP=0x00000000001549e2
@property(readonly, nonatomic, getter=isComplete) _Bool complete;
@property(readonly, nonatomic, getter=isCancelled) _Bool cancelled;
- (id)init;	// IMP=0x00000000001545e4
