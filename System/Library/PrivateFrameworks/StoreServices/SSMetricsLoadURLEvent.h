...
+ (id)_timingMetricsWindowStartTime;	// IMP=0x0000000000136fa8
+ (void)_setTimingMetricsWindowStartTime:(id)arg1;	// IMP=0x0000000000136f87
+ (double)_randomDouble;	// IMP=0x0000000000136f4d
+ (_Bool)shouldReportCachedEventWithSamplingPercentage:(double)arg1;	// IMP=0x00000000001368d9
+ (_Bool)shouldReportCachedEvent;	// IMP=0x0000000000136868
+ (_Bool)shouldLogTimingMetrics;	// IMP=0x000000000013685e
+ (_Bool)shouldCollectTimingDataWithSessionDuration:(double)arg1 samplingPercentage:(double)arg2;	// IMP=0x000000000013673c
+ (_Bool)shouldCollectTimingDataWithSessionDelegate:(id)arg1;	// IMP=0x00000000001366a8
+ (_Bool)shouldCollectTimingData;	// IMP=0x0000000000136694
- (id)description;	// IMP=0x0000000000136914
...
- (id)init;	// IMP=0x0000000000134ed0
