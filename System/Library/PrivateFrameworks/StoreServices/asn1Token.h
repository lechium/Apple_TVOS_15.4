...
+ (id)readOpaqueTokenFromBuffer:(const char *)arg1;	// IMP=0x00000000000f04f0
+ (id)readTokenFromBuffer:(const char *)arg1;	// IMP=0x00000000000f04d5
+ (id)readTokenFromBuffer:(const char *)arg1 opaque:(_Bool)arg2;	// IMP=0x00000000000f0383
...
- (id)description;	// IMP=0x00000000000f050e
- (id)_initWithID:(unsigned long long)arg1 class:(unsigned char)arg2 length:(unsigned long long)arg3 content:(const char *)arg4 opaque:(_Bool)arg5;	// IMP=0x00000000000f0325
