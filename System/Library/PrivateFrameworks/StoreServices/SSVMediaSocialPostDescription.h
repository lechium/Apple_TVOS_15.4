...
- (void).cxx_destruct;	// IMP=0x000000000000bdec
...
- (id)copyXPCEncoding;	// IMP=0x000000000000bc46
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x000000000000b9c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b8df
