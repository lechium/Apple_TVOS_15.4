...
- (void).cxx_destruct;	// IMP=0x0000000000024de5
...
- (void)_enumerateItemsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024bbd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000024b2c
@property(readonly, nonatomic) NSArray *items;
- (id)itemForItemIdentifier:(id)arg1;	// IMP=0x00000000000248a4
- (id)initWithDictionary:(id)arg1 URLResponse:(id)arg2;	// IMP=0x0000000000024800
