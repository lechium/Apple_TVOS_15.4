...
- (void).cxx_destruct;	// IMP=0x000000000000484a
...
- (_Bool)serializeNotificationsWithIntervalTimeoutInSeconds:(unsigned long long)arg1 errorOut:(id *)arg2;	// IMP=0x000000000000476a
- (_Bool)serializeLogArchiveWithPath:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 errorOut:(id *)arg4;	// IMP=0x0000000000003652
- (id)_sanityCheckParameters;	// IMP=0x00000000000035c2
- (_Bool)_hasProcessingBlocks;	// IMP=0x0000000000003556
- (id)init;	// IMP=0x00000000000034ae
- (id)_dataArrayForSignpostSupportObjectArray:(id)arg1 errorOut:(id *)arg2;	// IMP=0x0000000000003143
