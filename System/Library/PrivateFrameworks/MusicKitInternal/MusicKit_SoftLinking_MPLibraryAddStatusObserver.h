...
- (void).cxx_destruct;	// IMP=0x000000000000ce55
...
- (long long)_libraryAddStatusFromUnderlyingStatus:(long long)arg1;	// IMP=0x000000000000ce1e
- (void)_handleUpdatedUnderlyingLibraryAddStatus:(long long)arg1;	// IMP=0x000000000000cde9
@property(readonly, nonatomic) long long currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x000000000000c9d7
