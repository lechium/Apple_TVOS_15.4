...
- (void).cxx_destruct;	// IMP=0x00000000000195f4
...
- (_Bool)validate;	// IMP=0x0000000000018d67
- (id)findErrorMessageForErrorPtr:(struct _xmlError *)arg1;	// IMP=0x0000000000018a24
- (id)initWithSourceURL:(id)arg1 schemaURL:(id)arg2;	// IMP=0x000000000001890a
