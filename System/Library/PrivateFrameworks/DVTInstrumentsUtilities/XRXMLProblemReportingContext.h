...
- (void).cxx_destruct;	// IMP=0x000000000001e18b
...
- (void)reportWarningWithElement:(id)arg1 failure:(id)arg2;	// IMP=0x000000000001ded9
- (void)reportProblemWithElement:(id)arg1 failure:(id)arg2;	// IMP=0x000000000001dc74
