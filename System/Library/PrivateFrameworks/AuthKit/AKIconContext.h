...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000047a23
- (void).cxx_destruct;	// IMP=0x0000000000047c40
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000047b42
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000047a2b
- (id)init;	// IMP=0x00000000000479b0
