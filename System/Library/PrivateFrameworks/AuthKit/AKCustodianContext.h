...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000018e65
- (void).cxx_destruct;	// IMP=0x0000000000019435
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000018e6d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000018c41
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001878c
