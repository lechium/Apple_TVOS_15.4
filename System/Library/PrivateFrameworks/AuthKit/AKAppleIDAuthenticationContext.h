...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005f76e
- (void).cxx_destruct;	// IMP=0x0000000000066193
...
- (void)presentBiometricOrPasscodeValidationForAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000065922
- (id)_secondFactorQueue;	// IMP=0x00000000000658e5
- (void)_handleSecondFactorCodeEntry;	// IMP=0x0000000000065655
- (void)_stopListeningForSecondFactorCodeEntryNotification;	// IMP=0x00000000000655d6
- (void)_startListeningForSecondFactorCodeEntryNotification;	// IMP=0x00000000000654ab
- (void)presentSecondFactorAlertWithError:(id)arg1 title:(id)arg2 message:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000065161
- (void)dismissSecondFactorUIWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000064fd2
- (void)presentSecondFactorUIWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000064997
- (void)presentLoginAlertWithError:(id)arg1 title:(id)arg2 message:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000064616
- (void)dismissBasicLoginUIWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000064601
@property(readonly, nonatomic) _Bool _requiresPasswordInput;
- (void)presentBasicLoginUIWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000063b12
...
- (id)_appendBlameIfRequiredTo:(id)arg1;	// IMP=0x00000000000636d0
...
- (_Bool)_isVerifyCredentialReasonEligibleForBiometricOrPasscodeAuth;	// IMP=0x0000000000062ff7
...
- (_Bool)_localUserHasEmptyPassword;	// IMP=0x0000000000062763
- (void)_updateWithValuesFromContext:(id)arg1;	// IMP=0x0000000000062141
- (id)_sanitizedCopy;	// IMP=0x00000000000619f5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000060e82
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005fa87
- (id)initWithContext:(id)arg1;	// IMP=0x000000000005f92c
- (id)_initWithIdentifier:(id)arg1;	// IMP=0x000000000005f7d0
- (id)init;	// IMP=0x000000000005f776
- (id)authKitAccountForSilentServiceToken:(id *)arg1;	// IMP=0x0000000000041ac0
- (id)authKitAccount:(id *)arg1;	// IMP=0x0000000000041704
