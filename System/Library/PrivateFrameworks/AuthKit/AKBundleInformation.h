...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006c68d
- (void).cxx_destruct;	// IMP=0x000000000006c6c7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006c5ea
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006c406
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006c32b
- (id)initWithBundleIdentifier:(id)arg1 bundleName:(id)arg2 bundleDescription:(id)arg3 bundleType:(unsigned long long)arg4 otherInfo:(id)arg5;	// IMP=0x000000000006c248
