...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006be3a
- (void).cxx_destruct;	// IMP=0x000000000006bf6d
...
- (id)description;	// IMP=0x000000000006be42
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006bcac
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006ba14
- (void)_initWithInfo:(id)arg1;	// IMP=0x000000000006b70c
- (id)initWithInfo:(id)arg1;	// IMP=0x000000000006b6ba
