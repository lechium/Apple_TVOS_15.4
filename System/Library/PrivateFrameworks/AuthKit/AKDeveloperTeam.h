...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000039680
- (void).cxx_destruct;	// IMP=0x0000000000039967
...
- (id)description;	// IMP=0x00000000000398b4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003981f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039688
- (id)initWithResponseInfo:(id)arg1;	// IMP=0x000000000003944d
