...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004ddde
- (void).cxx_destruct;	// IMP=0x000000000004ec0b
...
- (id)description;	// IMP=0x000000000004e819
- (id)altDSID;	// IMP=0x000000000004e77b
@property(readonly, nonatomic) ACAccount *internalAuthKitAccount;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004e509
- (id)_sanitizedCopy;	// IMP=0x000000000004e3f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004e26f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004ded2
- (id)initWithAltDSID:(id)arg1;	// IMP=0x000000000004de43
- (id)init;	// IMP=0x000000000004dde6
