...
+ (id)presentationContextForRequestContext:(id)arg1 client:(id)arg2;	// IMP=0x000000000004ad73
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004a5a1
- (void).cxx_destruct;	// IMP=0x000000000004b35d
...
- (void)_addPresentationParametersForContext:(id)arg1;	// IMP=0x000000000004b0fc
- (void)_addPresenterParameters;	// IMP=0x000000000004aec6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004ac68
- (id)description;	// IMP=0x000000000004abbb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004a91e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004a80c
- (id)initWithUsername:(id)arg1;	// IMP=0x000000000004a789
- (id)initWithContext:(id)arg1 client:(id)arg2;	// IMP=0x000000000004a652
- (id)initWithContext:(id)arg1 bundleID:(id)arg2;	// IMP=0x000000000004a5a9
