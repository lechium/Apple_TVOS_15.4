...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000045902
- (void).cxx_destruct;	// IMP=0x00000000000461e7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004608f
@property(readonly, copy) NSString *description;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000045d3a
- (id)initWithServerResponse:(id)arg1;	// IMP=0x0000000000045939
- (id)init;	// IMP=0x000000000004590a
