...
- (void).cxx_destruct;	// IMP=0x0000000000018743
...
- (unsigned long long)_convertOperationToEnum:(id)arg1;	// IMP=0x000000000001862d
- (id)initWithResponseBody:(id)arg1;	// IMP=0x0000000000018346
