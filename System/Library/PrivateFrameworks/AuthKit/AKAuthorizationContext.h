...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000665d7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000669d7
- (id)initWithRequest:(id)arg1;	// IMP=0x000000000006696c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000665df
