...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001c302
...
- (id)description;	// IMP=0x000000000001d819
...
- (id)initWithProxiedClientContext:(id)arg1;	// IMP=0x000000000001ce5f
- (id)initWithUpgradeContext:(id)arg1;	// IMP=0x000000000001cced
- (id)init;	// IMP=0x000000000001cc3b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001c601
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001c30a
