...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005104e
- (void).cxx_destruct;	// IMP=0x0000000000053710
...
- (id)description;	// IMP=0x000000000005324c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000052d7a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000052aa9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000052319
- (id)initWithResponseBody:(id)arg1;	// IMP=0x0000000000051056
