...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000033df8
- (void).cxx_destruct;	// IMP=0x0000000000034086
...
- (id)description;	// IMP=0x0000000000033fe9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000033fa9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000033f0b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000033e00
- (id)initWithUser:(id)arg1 site:(id)arg2;	// IMP=0x0000000000033d59
