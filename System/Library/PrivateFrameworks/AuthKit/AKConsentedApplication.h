...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001262c
...
- (id)description;	// IMP=0x00000000000128b3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000127f2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000012634
- (id)initWithResponseInfo:(id)arg1;	// IMP=0x00000000000123e4
