...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003dbf6
+ (id)recoveryContextWithServerInfo:(id)arg1;	// IMP=0x000000000003d4a5
- (void).cxx_destruct;	// IMP=0x000000000003dc76
...
- (_Bool)isValid;	// IMP=0x000000000003da7f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003d8c9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003d770
