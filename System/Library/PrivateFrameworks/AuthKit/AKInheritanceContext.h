...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000250aa
- (void).cxx_destruct;	// IMP=0x00000000000252a1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000250b2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000025001
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024e9e
- (id)initWithAuthenticationContext:(id)arg1;	// IMP=0x0000000000024e23
- (id)initWithOwnerAltDSID:(id)arg1;	// IMP=0x0000000000024db8
