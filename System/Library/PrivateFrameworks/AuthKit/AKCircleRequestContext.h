...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004972d
- (void).cxx_destruct;	// IMP=0x00000000000497db
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004964d
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000494c4
- (id)init;	// IMP=0x000000000004948a
