...
- (void)_resetToDefaultValues;	// IMP=0x0000000000018670
- (id)_copyAllowingGlobalCacheLookup:(_Bool)arg1;	// IMP=0x0000000000018507
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000183b6
