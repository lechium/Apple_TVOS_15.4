...
+ (double)requiredOutsetForDropShadow;	// IMP=0x0000000000019d21
- (void).cxx_destruct;	// IMP=0x000000000001a638
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000019f54
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000019dc2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019d2f
