...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000133d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001326c
- (unsigned long long)hash;	// IMP=0x0000000000013171
- (id)init;	// IMP=0x0000000000013127
