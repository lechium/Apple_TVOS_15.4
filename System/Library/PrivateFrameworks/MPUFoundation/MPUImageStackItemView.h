...
- (void).cxx_destruct;	// IMP=0x0000000000009cb6
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000098fe
- (void)layoutSubviews;	// IMP=0x0000000000009882
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000009780
