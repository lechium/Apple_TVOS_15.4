...
- (void).cxx_destruct;	// IMP=0x000000000001745b
...
- (id)initWithHeader:(CDStruct_73a58082)arg1 storePath:(id)arg2 data:(id)arg3 framePtr:(void *)arg4 offset:(unsigned long long)arg5 nextOffset:(unsigned long long)arg6;	// IMP=0x0000000000017313
