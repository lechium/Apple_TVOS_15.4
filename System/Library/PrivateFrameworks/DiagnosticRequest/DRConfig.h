...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000008510
- (void).cxx_destruct;	// IMP=0x0000000000009de0
...
- (id)jsonDictRepresentation;	// IMP=0x00000000000099a6
- (id)initWithJSONDict:(id)arg1 receivedDate:(id)arg2;	// IMP=0x000000000000935b
- (_Bool)isEqualToConfig:(id)arg1;	// IMP=0x0000000000008f42
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008ee0
- (id)initWithBuild:(id)arg1 teamID:(id)arg2 configDescription:(id)arg3 configUUID:(id)arg4 receivedDate:(id)arg5 startDate:(id)arg6 endDate:(id)arg7 payload:(id)arg8 payloadIsJSON:(_Bool)arg9 skipHysteresis:(_Bool)arg10;	// IMP=0x0000000000008998
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000008747
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000008518
