...
+ (id)sharedConnectionState;	// IMP=0x0000000000000df8
- (void).cxx_destruct;	// IMP=0x000000000000173d
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000001513
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000132f
- (id)init;	// IMP=0x0000000000000ec5
- (void)cleanupState;	// IMP=0x0000000000000e4d
