...
+ (id)sharedConnectionState;	// IMP=0x0000000000009ea4
- (void).cxx_destruct;	// IMP=0x000000000000a651
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x000000000000a5cb
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000a45e
- (id)init;	// IMP=0x0000000000009f71
- (void)cleanupState;	// IMP=0x0000000000009ef9
