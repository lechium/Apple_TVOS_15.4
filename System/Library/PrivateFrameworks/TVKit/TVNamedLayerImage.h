...
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1 decodeImmediately:(_Bool)arg2;	// IMP=0x000000000004474f
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x000000000004473b
+ (id)namedLayerImageWithImage:(id)arg1 decodeImmediately:(_Bool)arg2;	// IMP=0x000000000004469b
+ (id)namedLayerImageWithImage:(id)arg1;	// IMP=0x0000000000044687
...
- (id)imageObj;	// IMP=0x0000000000044b2f
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x000000000004464c
- (id)init;	// IMP=0x000000000004463e
