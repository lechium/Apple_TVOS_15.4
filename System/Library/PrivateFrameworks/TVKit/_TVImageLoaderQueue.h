...
- (void).cxx_destruct;	// IMP=0x0000000000036205
...
- (void)_checkForPreloadCompletion;	// IMP=0x00000000000360d9
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000035fec
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x0000000000035f4c
- (void)_loadPendingImages;	// IMP=0x0000000000035b7f
- (id)_imageProxyToLoadNext;	// IMP=0x0000000000035ad0
- (void)_fillQueue;	// IMP=0x00000000000359dc
- (long long)_currentQueueSize;	// IMP=0x0000000000035982
- (id)popNextImage;	// IMP=0x00000000000358e9
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000035899
- (void)dealloc;	// IMP=0x00000000000357b1
- (id)init;	// IMP=0x00000000000356d9
