...
- (void).cxx_destruct;	// IMP=0x00000000000a4b80
...
- (id)init;	// IMP=0x00000000000a4b5c
- (id)initWithFeatureName:(id)arg1;	// IMP=0x00000000000a4b48
- (id)initWithFeatureName:(id)arg1 multiArraySize:(unsigned long long)arg2;	// IMP=0x00000000000a4a8c
