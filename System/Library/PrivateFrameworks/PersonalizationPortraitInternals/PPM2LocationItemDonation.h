...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000b2c5
- (unsigned long long)hash;	// IMP=0x000000000000b1c2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000affd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000aecd
- (void)copyTo:(id)arg1;	// IMP=0x000000000000add3
- (void)writeTo:(id)arg1;	// IMP=0x000000000000acc9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000acbc
- (id)dictionaryRepresentation;	// IMP=0x000000000000a79b
- (id)description;	// IMP=0x000000000000a6ec
...
- (int)StringAsAlgorithm:(id)arg1;	// IMP=0x000000000000a340
- (id)algorithmAsString:(int)arg1;	// IMP=0x000000000000a1c1
...
- (int)StringAsDonationSource:(id)arg1;	// IMP=0x0000000000009d90
- (id)donationSourceAsString:(int)arg1;	// IMP=0x0000000000009be2
