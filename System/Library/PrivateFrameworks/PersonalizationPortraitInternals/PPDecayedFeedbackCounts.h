...
- (void).cxx_destruct;	// IMP=0x0000000000117b69
...
- (id)toDictionary;	// IMP=0x000000000011790b
- (id)initWithLatestDate:(id)arg1 engagedExplicitly:(double)arg2 engagedImplicitly:(double)arg3 rejectedExplicitly:(double)arg4 rejectedImplicitly:(double)arg5;	// IMP=0x0000000000117864
