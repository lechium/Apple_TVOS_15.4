...
- (void).cxx_destruct;	// IMP=0x00000000000cac7a
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000caa38
@property(readonly, nonatomic) NSSet *featureNames;
- (id)toDictionary;	// IMP=0x00000000000ca5ff
- (id)initWithMinRefCount:(long long)arg1 maxRefCount:(long long)arg2 avgRefCount:(double)arg3 medianRefCount:(double)arg4 earliestDate:(id)arg5 latestDate:(id)arg6 uniqueBundleIdCount:(long long)arg7 uniqueDocIdCount:(long long)arg8 recordCount:(unsigned long long)arg9;	// IMP=0x00000000000ca51b
