...
- (void).cxx_destruct;	// IMP=0x0000000000011f48
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000011d92
- (unsigned long long)hash;	// IMP=0x0000000000011c86
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000011a90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000011946
- (void)copyTo:(id)arg1;	// IMP=0x000000000001183a
- (void)writeTo:(id)arg1;	// IMP=0x000000000001170e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000011701
- (id)dictionaryRepresentation;	// IMP=0x000000000001145d
- (id)description;	// IMP=0x00000000000113ae
