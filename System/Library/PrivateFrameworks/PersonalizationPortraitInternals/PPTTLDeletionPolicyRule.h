...
- (void).cxx_destruct;	// IMP=0x00000000000d5c5c
...
- (id)description;	// IMP=0x00000000000d5bf6
- (id)initWithBundleIdentifier:(id)arg1 groupIdentifier:(id)arg2 maxAgeSeconds:(id)arg3;	// IMP=0x00000000000d5b3f
