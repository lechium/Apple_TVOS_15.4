...
- (void).cxx_destruct;	// IMP=0x00000000000c3ef4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000c3d68
- (unsigned long long)hash;	// IMP=0x00000000000c3b9e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c3a1a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c38f3
- (void)copyTo:(id)arg1;	// IMP=0x00000000000c380a
- (void)writeTo:(id)arg1;	// IMP=0x00000000000c3720
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000c3713
- (id)dictionaryRepresentation;	// IMP=0x00000000000c354f
- (id)description;	// IMP=0x00000000000c34a0
