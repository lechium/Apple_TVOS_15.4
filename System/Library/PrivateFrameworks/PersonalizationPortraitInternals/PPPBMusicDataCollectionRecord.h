...
+ (id)options;	// IMP=0x000000000005685c
- (void).cxx_destruct;	// IMP=0x00000000000563f6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000056222
- (unsigned long long)hash;	// IMP=0x0000000000055f28
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000055d38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055bcd
- (void)copyTo:(id)arg1;	// IMP=0x0000000000055aac
- (void)writeTo:(id)arg1;	// IMP=0x0000000000055984
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000055977
- (id)dictionaryRepresentation;	// IMP=0x0000000000055709
- (id)description;	// IMP=0x000000000005565a
