...
+ (Class)calculatedFeaturesType;	// IMP=0x0000000000019c1d
+ (Class)applicationIdentifiersType;	// IMP=0x0000000000019c0c
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x00000000000c513e
- (void).cxx_destruct;	// IMP=0x00000000000191b6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000018981
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000017a35
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017390
- (void)copyTo:(id)arg1;	// IMP=0x0000000000016f2d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000016a1d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000016a10
- (id)dictionaryRepresentation;	// IMP=0x0000000000016157
...
- (id)calculatedFeaturesAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000015d47
- (unsigned long long)calculatedFeaturesCount;	// IMP=0x0000000000015d2a
- (void)addCalculatedFeatures:(id)arg1;	// IMP=0x0000000000015cc0
- (void)clearCalculatedFeatures;	// IMP=0x0000000000015ca3
...
- (id)applicationIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000015c32
- (unsigned long long)applicationIdentifiersCount;	// IMP=0x0000000000015c15
- (void)addApplicationIdentifiers:(id)arg1;	// IMP=0x0000000000015bab
- (void)clearApplicationIdentifiers;	// IMP=0x0000000000015b8e
@property(readonly, nonatomic) _Bool hasSourceBundleId;
@property(nonatomic) _Bool hasSyndicationSecondsSinceReferenceDate;
- (int)StringAsHighlightType:(id)arg1;	// IMP=0x0000000000015a7c
- (id)highlightTypeAsString:(int)arg1;	// IMP=0x00000000000159fd
...
- (id)features;	// IMP=0x00000000000b5a96
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000b588d
@property(readonly, nonatomic) NSSet *featureNames;
- (void)setCalculatedFeaturesFromDictionary:(id)arg1;	// IMP=0x00000000000b5429
- (id)calculatedFeatureValueForKey:(id)arg1;	// IMP=0x00000000000b5236
- (id)json;	// IMP=0x00000000000c5048
- (id)serialize;	// IMP=0x00000000000c5036
