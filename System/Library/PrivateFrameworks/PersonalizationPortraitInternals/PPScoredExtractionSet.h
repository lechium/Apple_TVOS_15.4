...
- (void).cxx_destruct;	// IMP=0x000000000013d819
...
- (id)numberOfExtractions;	// IMP=0x000000000013d655
- (void)flushWrites;	// IMP=0x000000000013d422
- (void)writeWithEntityStore:(id)arg1;	// IMP=0x000000000013d410
- (void)writeSynchronous;	// IMP=0x000000000013cf46
- (void)addLocation:(id)arg1 algorithm:(unsigned short)arg2;	// IMP=0x000000000013cdbf
- (unsigned long long)_donateLocationsWithContextualNamedEntities:(id)arg1;	// IMP=0x000000000013cbe9
- (id)description;	// IMP=0x000000000013cb17
