...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001e3e7
- (unsigned long long)hash;	// IMP=0x000000000001e2db
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001e0e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001df9b
- (void)copyTo:(id)arg1;	// IMP=0x000000000001de8f
- (void)writeTo:(id)arg1;	// IMP=0x000000000001dd63
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001dd56
- (id)dictionaryRepresentation;	// IMP=0x000000000001dab2
- (id)description;	// IMP=0x000000000001da03
