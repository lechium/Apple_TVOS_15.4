...
- (void).cxx_destruct;	// IMP=0x000000000006a482
- (void)visitDeleteContactEvent:(id)arg1;	// IMP=0x000000000006a3f9
- (void)visitUpdateContactEvent:(id)arg1;	// IMP=0x000000000006a33e
- (void)visitAddContactEvent:(id)arg1;	// IMP=0x000000000006a283
- (void)visitDropEverythingEvent:(id)arg1;	// IMP=0x000000000006a279
