...
- (void).cxx_destruct;	// IMP=0x0000000000021bfa
...
- (id)debugDescription;	// IMP=0x00000000000218d9
- (id)recordEvent;	// IMP=0x00000000000214ef
- (void)cancelUnfinishedPromisedEventData;	// IMP=0x0000000000021331
- (id)userAndClientIDFields;	// IMP=0x000000000002106b
- (id)toDictionary;	// IMP=0x0000000000020b72
- (id)composeFieldsMaps;	// IMP=0x000000000002078e
- (void)addPostProcessingBlocks:(id)arg1;	// IMP=0x00000000000206f3
- (void)addPostProcessingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002063e
- (id)getPostProcessingBlocks;	// IMP=0x00000000000205ed
- (void)addFieldsWithPromise:(id)arg1;	// IMP=0x00000000000205d7
- (void)addFieldsWithDictionary:(id)arg1;	// IMP=0x00000000000205c1
- (void)addFields:(id)arg1;	// IMP=0x00000000000203eb
- (id)getAdditionalData;	// IMP=0x000000000002039a
