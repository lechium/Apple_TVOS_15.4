...
- (void).cxx_destruct;	// IMP=0x00000000000467c2
...
- (id)debugInfo;	// IMP=0x0000000000046451
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000461fe
@property(readonly, copy) NSString *description;
@property(readonly, copy, nonatomic) NSDictionary *metricsFields;
- (_Bool)isValueExpired;	// IMP=0x0000000000045e77
...
- (id)initWithScheme:(id)arg1 secret:(id)arg2 idString:(id)arg3 dsId:(id)arg4 effectiveDate:(id)arg5 expirationDate:(id)arg6;	// IMP=0x0000000000045bfe
