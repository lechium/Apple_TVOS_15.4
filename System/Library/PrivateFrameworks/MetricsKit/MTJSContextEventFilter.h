...
- (id)apply:(id)arg1;	// IMP=0x000000000000aa79
- (void)_applyFilter:(id)arg1 promise:(id)arg2;	// IMP=0x000000000000a71e
- (id)initWithJSContext:(id)arg1 functionName:(id)arg2 operationQueue:(id)arg3;	// IMP=0x000000000000a276
- (id)initWithScript:(id)arg1 functionName:(id)arg2 operationQueue:(id)arg3;	// IMP=0x000000000000a1af
