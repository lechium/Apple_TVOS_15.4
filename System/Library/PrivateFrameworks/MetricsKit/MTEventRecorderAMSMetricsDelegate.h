...
+ (id)amsMetricsObjectCache;	// IMP=0x0000000000038b0b
- (void).cxx_destruct;	// IMP=0x000000000003b7b8
...
- (id)amsContainerIdForTopic:(id)arg1;	// IMP=0x000000000003b5ff
- (id)flushUnreportedEvents;	// IMP=0x000000000003b176
- (id)sendMethod;	// IMP=0x000000000003b169
- (id)_sortedEventsFromBatch:(id)arg1;	// IMP=0x000000000003af71
- (void)_flushEvents:(id)arg1 topic:(id)arg2;	// IMP=0x000000000003aa46
- (id)_recordEvent:(id)arg1 toTopic:(id)arg2;	// IMP=0x000000000003a5ad
- (id)recordEvent:(id)arg1 toTopic:(id)arg2;	// IMP=0x000000000003a06a
- (id)activeItunesAccount;	// IMP=0x000000000003a013
- (id)lookupItunesAccount:(id)arg1;	// IMP=0x0000000000039db2
- (void)_endTransaction;	// IMP=0x0000000000039cdf
- (void)_beginTransaction;	// IMP=0x0000000000039bf3
- (id)periodicQueueForTopic:(id)arg1;	// IMP=0x0000000000038ff3
- (id)amsMetricsForTopic:(id)arg1;	// IMP=0x0000000000038b60
- (id)initWithContainerId:(id)arg1 profileName:(id)arg2 profileVersion:(id)arg3;	// IMP=0x0000000000038a7f
- (id)initWithContainerId:(id)arg1 amsBag:(id)arg2;	// IMP=0x000000000003861e
