...
+ (CDUnknownBlockType)comparator;	// IMP=0x000000000002cbbd
- (void).cxx_destruct;	// IMP=0x000000000002ccab
...
- (long long)compare:(id)arg1;	// IMP=0x000000000002cb35
- (id)initWithStartOverallPosition:(unsigned long long)arg1 metricsData:(id)arg2;	// IMP=0x000000000002caae
