...
- (void).cxx_destruct;	// IMP=0x000000000002dbd6
...
- (void)dealloc;	// IMP=0x000000000002dafb
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000002d9f6
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 timeoutBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000002d70b
