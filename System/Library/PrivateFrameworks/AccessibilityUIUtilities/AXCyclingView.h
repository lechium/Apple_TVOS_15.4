...
- (void)_makeNextViewVisible;	// IMP=0x0000000000014570
- (void)_updateForCycleIndex;	// IMP=0x000000000001446d
- (void)didMoveToWindow;	// IMP=0x0000000000014413
- (void)endCycling;	// IMP=0x00000000000143a9
- (void)beginCycling;	// IMP=0x000000000001431f
