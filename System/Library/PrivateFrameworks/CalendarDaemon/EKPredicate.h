...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003368b
- (void).cxx_destruct;	// IMP=0x0000000000033ae7
...
- (id)predicateFormat;	// IMP=0x00000000000338d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003383e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003370d
- (id)initWithCalendars:(id)arg1;	// IMP=0x0000000000033693
