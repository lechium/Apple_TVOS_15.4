...
- (void).cxx_destruct;	// IMP=0x0000000000045e4b
@property(readonly, nonatomic) __weak ClientConnection *connection; // @synthesize connection=_connection;
- (_Bool)_valueForStringEntitlement:(id)arg1 matchesString:(id)arg2;	// IMP=0x0000000000045c9c
- (_Bool)_valueForBooleanEntitlement:(id)arg1 defaultValue:(_Bool)arg2;	// IMP=0x0000000000045b1c
...
- (id)initWithClientConnection:(id)arg1;	// IMP=0x0000000000045682
