...
+ (id)sharedInstance;	// IMP=0x0000000000045e59
...
- (void)removeSyntheticRouteHypothesizerForEventExternalURL:(id)arg1;	// IMP=0x00000000000462f2
- (void)addSyntheticRouteHypothesizer:(id)arg1 forEventExternalURL:(id)arg2;	// IMP=0x0000000000046166
- (id)syntheticRouteHypothesizerForEventExternalURL:(id)arg1;	// IMP=0x0000000000045f93
- (id)_init;	// IMP=0x0000000000045efa
