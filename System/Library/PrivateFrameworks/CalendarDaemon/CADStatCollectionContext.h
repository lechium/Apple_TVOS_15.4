...
- (void).cxx_destruct;	// IMP=0x000000000000e319
@property(nonatomic) struct CalDatabase *database; // @synthesize database=_database;
@property(readonly, nonatomic) ACAccountStore *accountStore;
- (void)dealloc;	// IMP=0x000000000000e226
- (id)initWithDatabase:(struct CalDatabase *)arg1 accountStore:(id)arg2;	// IMP=0x000000000000e1a8
