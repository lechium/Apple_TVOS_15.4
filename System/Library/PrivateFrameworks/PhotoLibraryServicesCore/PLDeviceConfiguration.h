...
+ (id)defaultDeviceConfiguration;	// IMP=0x000000000003df4e
...
- (id)description;	// IMP=0x000000000003dd44
- (id)initWithLogicalScreenSize:(struct CGSize)arg1 screenScale:(double)arg2 deviceClass:(void *)arg3 isRidingCrudSnow:(_Bool)arg4 isRidingPowderSnow:(_Bool)arg5 supportsASTC:(_Bool)arg6 isMigrationService:(_Bool)arg7;	// IMP=0x000000000003dc01
