...
+ (unsigned long long)minimumAvailableBytesRequiredForLibraryOpen;	// IMP=0x000000000007b572
+ (id)capabilitiesWithURL:(id)arg1;	// IMP=0x000000000007b51a
- (void).cxx_destruct;	// IMP=0x000000000007b48c
...
- (id)description;	// IMP=0x000000000007b2aa
- (_Bool)determineCapabilitiesWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007abeb
