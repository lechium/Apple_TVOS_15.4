...
- (void).cxx_destruct;	// IMP=0x00000000000a16c1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000a1558
- (unsigned long long)hash;	// IMP=0x00000000000a146e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a12f9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a11e2
- (void)copyTo:(id)arg1;	// IMP=0x00000000000a1103
- (void)writeTo:(id)arg1;	// IMP=0x00000000000a101a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000a100d
- (id)dictionaryRepresentation;	// IMP=0x00000000000a0e1e
- (id)description;	// IMP=0x00000000000a0d6f
...
- (id)logDescription;	// IMP=0x0000000000060ec6
- (void)setValueAndType:(id)arg1;	// IMP=0x0000000000060d5e
- (int)migratedComparator;	// IMP=0x0000000000060c70
