...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000154bb
- (void).cxx_destruct;	// IMP=0x0000000000016fdc
...
- (_Bool)isValid;	// IMP=0x0000000000016cd9
- (void)updateHandle:(id)arg1;	// IMP=0x0000000000016c5e
@property(retain, nonatomic) CLLocation *location; // @synthesize location=_location;
- (void)updateLocation:(id)arg1;	// IMP=0x0000000000016ba3
- (void)updateLocationForCache:(id)arg1;	// IMP=0x0000000000016b28
- (void)_updateLocation:(id)arg1;	// IMP=0x00000000000169b3
@property(nonatomic) struct CLLocationCoordinate2D coordinate; // @synthesize coordinate=_coordinate;
- (long long)distanceThenNameCompare:(id)arg1;	// IMP=0x00000000000167fd
- (void)resetLocateInProgressTimer;	// IMP=0x0000000000016621
- (void)resetLocateInProgress:(id)arg1;	// IMP=0x0000000000016559
...
- (id)locationShortAddressWithAgeIncludeLocating;	// IMP=0x00000000000162cf
- (id)locationShortAddressWithAge;	// IMP=0x000000000001614c
- (id)locationAge;	// IMP=0x0000000000015cf5
@property(readonly, copy, nonatomic) NSString *subtitle;
@property(readonly, copy, nonatomic) NSString *title;
- (id)agingItemTimestamp;	// IMP=0x0000000000015c81
@property(readonly, copy, nonatomic) NSString *shortAddress;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000015832
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000154c3
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x0000000000015409
- (_Bool)isThisDevice;	// IMP=0x0000000000015401
- (_Bool)hasKnownLocation;	// IMP=0x00000000000153f9
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000015277
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001506b
@property(readonly, copy) NSString *description;
- (id)initWithLatitude:(double)arg1 longitude:(double)arg2;	// IMP=0x0000000000014ef2
- (id)initWithDictionary:(id)arg1 forHandle:(id)arg2 maxLocatingInterval:(double)arg3 TTL:(double)arg4;	// IMP=0x0000000000014247
