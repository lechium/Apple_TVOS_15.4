...
+ (_Bool)isAllowedAtLocation:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0000000000024ebc
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002495c
+ (id)genericFriendName;	// IMP=0x000000000000dffe
+ (id)endDateForMuteTimespan:(unsigned long long)arg1;	// IMP=0x00000000000117db
- (void).cxx_destruct;	// IMP=0x0000000000025cdd
...
- (id)description;	// IMP=0x00000000000257dc
- (id)handlesForArray:(id)arg1;	// IMP=0x0000000000025610
- (id)locationForDictionary:(id)arg1;	// IMP=0x0000000000025373
- (unsigned long long)hash;	// IMP=0x00000000000252f1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000251b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000025019
- (void)updateFenceMuteEndDate:(id)arg1;	// IMP=0x0000000000025007
- (void)updateFenceLocation:(id)arg1 placemark:(id)arg2 label:(id)arg3 trigger:(id)arg4 type:(id)arg5 locationType:(unsigned long long)arg6;	// IMP=0x0000000000024f14
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000023fb6
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000022d4f
- (id)initWithRecipient:(id)arg1 location:(id)arg2 placemark:(id)arg3 label:(id)arg4 trigger:(id)arg5 type:(id)arg6 locationType:(unsigned long long)arg7 recurring:(_Bool)arg8;	// IMP=0x0000000000022add
- (id)localizedSubtitleStringWithLocationName:(id)arg1;	// IMP=0x000000000000f5e6
- (id)localizedWillBeNotifiedStringForFollower:(id)arg1 locationName:(id)arg2;	// IMP=0x000000000000ee76
- (id)localizedRequestNotificationStringForFollower:(id)arg1 locationName:(id)arg2;	// IMP=0x000000000000e706
- (id)localizedNotificationStringForFollower:(id)arg1 locationName:(id)arg2;	// IMP=0x000000000000e078
