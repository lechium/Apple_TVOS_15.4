...
- (id)loggingID;	// IMP=0x0000000000028d4c
- (void)wait;	// IMP=0x0000000000028bc4
- (void)signal;	// IMP=0x0000000000028ae9
- (id)initWithDescription:(id)arg1 andTimeout:(double)arg2;	// IMP=0x0000000000028a5a
