...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000000f381
- (void)animationDidStart:(id)arg1;	// IMP=0x000000000000f36e
- (void)dealloc;	// IMP=0x000000000000f315
