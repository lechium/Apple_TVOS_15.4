...
- (void)performRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000665d5
- (void)setupWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006637b
- (void)invalidate;	// IMP=0x0000000000066349
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000006615e
