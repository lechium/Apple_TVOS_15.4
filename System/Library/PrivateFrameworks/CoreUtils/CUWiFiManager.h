...
- (void).cxx_destruct;	// IMP=0x00000000000bf48e
...
- (void)_wifiEnsureStopped;	// IMP=0x00000000000bf3e1
- (void)_wifiEnsureStarted;	// IMP=0x00000000000bf3db
- (void)_update;	// IMP=0x00000000000bf385
- (void)performUpdate:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bf2cf
- (void)_invalidated;	// IMP=0x00000000000bf1d4
- (void)invalidate;	// IMP=0x00000000000bf189
- (void)_interrupted;	// IMP=0x00000000000bf162
- (void)_activateSafeInvokeBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bf087
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000befc9
- (void)activate;	// IMP=0x00000000000befb5
- (void)dealloc;	// IMP=0x00000000000bed60
- (id)init;	// IMP=0x00000000000becd5
