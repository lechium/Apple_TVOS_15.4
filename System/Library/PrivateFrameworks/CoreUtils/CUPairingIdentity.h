...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008cee4
- (void).cxx_destruct;	// IMP=0x000000000008cea6
...
- (id)description;	// IMP=0x000000000008cd00
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008cc5d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008cae1
