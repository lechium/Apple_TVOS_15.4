...
- (void).cxx_destruct;	// IMP=0x000000000006e4a8
...
- (void)sendAudioDataEvent:(id)arg1;	// IMP=0x000000000006e433
- (void)invalidate;	// IMP=0x000000000006e2c5
- (void)_activateCompleted:(CDUnknownBlockType)arg1;	// IMP=0x000000000006e123
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000006df38
