...
- (void).cxx_destruct;	// IMP=0x00000000000c0bab
...
- (void)_scanWiFiProcessResult:(id)arg1;	// IMP=0x00000000000c0415
- (void)_scanWiFiFinished:(id)arg1 status:(int)arg2;	// IMP=0x00000000000bfe4a
- (void)_scanWiFiStart;	// IMP=0x00000000000bfbdc
- (void)resume;	// IMP=0x00000000000bfb91
- (void)suspend;	// IMP=0x00000000000bfb46
- (void)_invalidated;	// IMP=0x00000000000bfabd
- (void)invalidate;	// IMP=0x00000000000bfa72
- (void)activate;	// IMP=0x00000000000bfa27
- (void)_cleanup;	// IMP=0x00000000000bf8ff
- (void)dealloc;	// IMP=0x00000000000bf888
- (id)init;	// IMP=0x00000000000bf801
