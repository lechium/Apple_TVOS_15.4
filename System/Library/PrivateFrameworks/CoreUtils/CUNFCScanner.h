...
- (void).cxx_destruct;	// IMP=0x00000000000803cd
...
- (void)_invalidateWithError:(id)arg1;	// IMP=0x00000000000801ed
- (void)invalidate;	// IMP=0x00000000000801a2
- (void)resume;	// IMP=0x000000000008019c
- (void)_pause;	// IMP=0x0000000000080196
- (void)pause;	// IMP=0x000000000008014b
- (void)activate;	// IMP=0x0000000000080100
- (id)init;	// IMP=0x0000000000080076
