...
- (void).cxx_destruct;	// IMP=0x000000000005f02d
...
- (_Bool)_updateWithAttributesDictionary:(id)arg1 flags:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000005e5e6
- (void)_mergeItem:(id)arg1;	// IMP=0x000000000005e0ec
- (id)_attributesDictionaryWithFlags:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x000000000005dbe5
- (_Bool)isEqualToKeychainItem:(id)arg1 flags:(unsigned int)arg2;	// IMP=0x000000000005d7a1
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000000005d29e
- (id)description;	// IMP=0x000000000005d287
