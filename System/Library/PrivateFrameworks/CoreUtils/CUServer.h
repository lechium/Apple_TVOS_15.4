...
- (void).cxx_destruct;	// IMP=0x00000000000a2900
...
- (void)_invalidated;	// IMP=0x00000000000a27da
- (void)invalidate;	// IMP=0x00000000000a278f
- (void)activate;	// IMP=0x00000000000a2789
- (id)description;	// IMP=0x00000000000a26fd
- (void)dealloc;	// IMP=0x00000000000a26b0
- (id)init;	// IMP=0x00000000000a2635
