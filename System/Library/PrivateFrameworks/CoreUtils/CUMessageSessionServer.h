...
- (void).cxx_destruct;	// IMP=0x000000000007081c
...
- (void)_connectionInvalidated:(id)arg1;	// IMP=0x0000000000070725
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000070503
- (void)invalidate;	// IMP=0x0000000000070307
- (void)activate;	// IMP=0x000000000007016e
