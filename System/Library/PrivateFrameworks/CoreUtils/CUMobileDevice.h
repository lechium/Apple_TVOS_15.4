...
- (void).cxx_destruct;	// IMP=0x0000000000074631
...
- (id)description;	// IMP=0x00000000000743c6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000742f9
- (void)dealloc;	// IMP=0x00000000000742ca
