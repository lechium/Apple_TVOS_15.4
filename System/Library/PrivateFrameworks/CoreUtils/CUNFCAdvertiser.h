...
- (void).cxx_destruct;	// IMP=0x000000000007ffcc
...
- (void)_invalidateWithError:(id)arg1;	// IMP=0x000000000007fe8f
- (void)invalidate;	// IMP=0x000000000007fe44
- (void)activate;	// IMP=0x000000000007fdf9
- (id)init;	// IMP=0x000000000007fd8b
