...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000008cad9
- (void).cxx_destruct;	// IMP=0x000000000008ca59
...
- (id)detailedDescription;	// IMP=0x000000000008c730
- (id)description;	// IMP=0x000000000008c4f8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008c3ae
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008c13d
