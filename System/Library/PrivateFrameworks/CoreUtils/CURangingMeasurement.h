...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000098844
- (void).cxx_destruct;	// IMP=0x000000000009881c
...
- (id)description;	// IMP=0x00000000000985f6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009843c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000980b5
