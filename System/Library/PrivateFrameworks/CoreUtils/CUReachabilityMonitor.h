...
- (void).cxx_destruct;	// IMP=0x00000000000996c9
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000000099581
- (void)URLSession:(id)arg1 downloadTask:(id)arg2 didFinishDownloadingToURL:(id)arg3;	// IMP=0x00000000000992c2
- (void)invalidate;	// IMP=0x0000000000099277
- (void)_complete:(id)arg1;	// IMP=0x00000000000990cb
- (void)_startDownload;	// IMP=0x0000000000098eef
- (void)_activate;	// IMP=0x0000000000098cfb
- (void)activate;	// IMP=0x0000000000098cb0
- (id)init;	// IMP=0x0000000000098c30
