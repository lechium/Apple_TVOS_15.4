...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009767a
- (void).cxx_destruct;	// IMP=0x00000000000972ce
...
- (unsigned int)updateWithPowerSourceDescription:(id)arg1;	// IMP=0x0000000000095e9b
- (void)updateWithPowerSource:(id)arg1;	// IMP=0x0000000000095db3
- (unsigned int)updateWithPowerAdapterDetails:(id)arg1;	// IMP=0x0000000000095bbc
- (_Bool)isAggregateComponent;	// IMP=0x0000000000095b74
- (void)handleSubComponentsUpdatedWithBaseSource:(id)arg1;	// IMP=0x0000000000095434
- (void)handleSubComponentsUpdated;	// IMP=0x0000000000095420
- (void)invalidate;	// IMP=0x0000000000095306
- (int)publish;	// IMP=0x000000000009490a
- (id)detailedDescription;	// IMP=0x00000000000948ab
- (id)description;	// IMP=0x00000000000941c2
- (unsigned long long)hash;	// IMP=0x0000000000094142
- (_Bool)hasAllComponents;	// IMP=0x0000000000094102
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000093daa
- (void)dealloc;	// IMP=0x0000000000093d6c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000938f7
- (void)_updateWithCoder:(id)arg1;	// IMP=0x0000000000092eec
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000092e6d
