...
- (void).cxx_destruct;	// IMP=0x00000000000b6b6d
...
- (void)_handleConnectionInvalidated:(id)arg1 addr:(const CDUnion_fab80606 *)arg2;	// IMP=0x00000000000b6979
- (void)_handleConnectionAccept:(int)arg1;	// IMP=0x00000000000b6582
- (void)_invalidated;	// IMP=0x00000000000b6436
- (void)invalidate;	// IMP=0x00000000000b63eb
- (_Bool)activateDirectAndReturnError:(id *)arg1;	// IMP=0x00000000000b5ea6
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b5e1b
- (id)detailedDescription;	// IMP=0x00000000000b5c0f
- (id)description;	// IMP=0x00000000000b5b71
- (void)dealloc;	// IMP=0x00000000000b5b24
- (id)init;	// IMP=0x00000000000b5a99
