...
- (void).cxx_destruct;	// IMP=0x00000000000b0736
...
- (void)invalidate;	// IMP=0x00000000000af951
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000af8c6
- (id)init;	// IMP=0x00000000000af856
