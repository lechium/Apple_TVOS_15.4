...
- (void).cxx_destruct;	// IMP=0x00000000000403f8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000040120
- (unsigned long long)hash;	// IMP=0x00000000000400dc
- (id)description;	// IMP=0x000000000003fa8f
- (id)init;	// IMP=0x000000000003fa3a
