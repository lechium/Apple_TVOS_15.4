...
+ (id)defaultConfiguration;	// IMP=0x000000000005cfa8
+ (id)bluetoothRSSIConfiguration;	// IMP=0x000000000005cf78
...
- (id)initWithParamR:(double)arg1 paramQ:(double)arg2 paramA:(double)arg3 paramB:(double)arg4 paramC:(double)arg5;	// IMP=0x000000000005cea8
