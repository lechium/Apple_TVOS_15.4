...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000118ff
- (void).cxx_destruct;	// IMP=0x0000000000011f00
...
- (void)_throwForFrozenInstance;	// IMP=0x0000000000011911
- (void)_freeze;	// IMP=0x0000000000011907
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011728
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000011304
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000111b6
- (id)description;	// IMP=0x0000000000010e94
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010c82
- (unsigned long long)hash;	// IMP=0x0000000000010b15
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000010a70
