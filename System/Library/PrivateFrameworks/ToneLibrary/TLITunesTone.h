...
+ (id)_identifierForPropertyListRepresentation:(id)arg1;	// IMP=0x00000000000137e7
- (void).cxx_destruct;	// IMP=0x0000000000013936
...
- (_Bool)isDuplicateOfTone:(id)arg1;	// IMP=0x00000000000134ec
- (unsigned long long)hash;	// IMP=0x00000000000133bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000012c95
- (id)description;	// IMP=0x0000000000012a3d
- (id)initWithToneStoreDownload:(id)arg1;	// IMP=0x0000000000012863
- (id)initWithPropertyListRepresentation:(id)arg1 filePath:(id)arg2;	// IMP=0x0000000000011f5f
