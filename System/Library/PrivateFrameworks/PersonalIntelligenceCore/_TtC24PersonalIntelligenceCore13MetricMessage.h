...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x0000000000005b33
- (void).cxx_destruct;	// IMP=0x0000000000005e57
- (id)init;	// IMP=0x0000000000005e24
- (id)json;	// IMP=0x0000000000005d8a
- (id)serialize;	// IMP=0x0000000000005c33
