...
- (void).cxx_destruct;	// IMP=0x0000000000019ef0
@property(nonatomic) _Bool hidden;
- (_Bool)isHidden;	// IMP=0x0000000000019df0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000019b20
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019a80
