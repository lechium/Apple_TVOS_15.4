...
@protocol MTLBuffer, MTLComputePipelineState, MTLCounterSampleBuffer, MTLFence, MTLHeap, MTLIndirectCommandBuffer, MTLResource, MTLSamplerState, MTLTexture;
...
@property(nonatomic, readonly) unsigned long long dispatchType;
@end
