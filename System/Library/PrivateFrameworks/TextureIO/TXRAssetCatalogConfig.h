...
- (void).cxx_destruct;	// IMP=0x00000000000c6422
...
- (void)addFileAttributesForLevel:(unsigned long long)arg1 face:(unsigned long long)arg2 fileFormat:(unsigned long long)arg3 colorSpace:(struct CGColorSpace *)arg4 exifOrientation:(unsigned char)arg5;	// IMP=0x00000000000c61be
- (void)addFileAttributesForLevel:(unsigned long long)arg1 fileFormat:(unsigned long long)arg2 colorSpace:(struct CGColorSpace *)arg3 exifOrientation:(unsigned char)arg4;	// IMP=0x00000000000c6061
- (void)addFileAttributesForLevel:(unsigned long long)arg1 face:(unsigned long long)arg2;	// IMP=0x00000000000c5ef9
- (void)addFileAttributesForLevel:(unsigned long long)arg1;	// IMP=0x00000000000c5ddb
- (id)initWithTexture:(id)arg1;	// IMP=0x00000000000c5d3b
