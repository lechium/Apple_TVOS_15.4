...
- (void).cxx_destruct;	// IMP=0x00000000000c66f0
...
- (_Bool)addConfig:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000c654a
- (id)exportAtLocation:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000c6528
- (id)initWithName:(id)arg1;	// IMP=0x00000000000c64c9
- (id)init;	// IMP=0x00000000000c6455
