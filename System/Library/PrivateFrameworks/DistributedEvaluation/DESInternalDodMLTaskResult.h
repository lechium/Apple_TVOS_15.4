...
- (void).cxx_destruct;	// IMP=0x000000000001eb8f
...
- (id)description;	// IMP=0x000000000001ea56
- (id)initWithJSONResult:(id)arg1 binaryResult:(id)arg2 deferred:(_Bool)arg3 deferralURL:(id)arg4 duration:(double)arg5;	// IMP=0x000000000001e984
