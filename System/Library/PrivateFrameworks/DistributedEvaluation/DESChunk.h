...
- (void).cxx_destruct;	// IMP=0x000000000000520a
...
- (unsigned long long)hash;	// IMP=0x0000000000005181
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004fc8
- (id)initWithKey:(id)arg1 clippingBound:(id)arg2 data:(id)arg3;	// IMP=0x0000000000004f11
