...
- (void).cxx_destruct;	// IMP=0x0000000000014ba6
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x0000000000014a6c
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x000000000001489f
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001477f
...
- (int)_linkQualityOnIvarQueue;	// IMP=0x0000000000014380
@property(readonly, nonatomic) long long interfaceIdentifier;
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x00000000000142f9
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x0000000000014280
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x00000000000141cc
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x000000000001417e
- (void)_addMonitor;	// IMP=0x00000000000140be
- (void)dealloc;	// IMP=0x000000000001407a
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000013ef7
