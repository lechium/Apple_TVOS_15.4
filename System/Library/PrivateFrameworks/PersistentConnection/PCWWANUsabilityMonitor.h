...
- (void).cxx_destruct;	// IMP=0x000000000001606f
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x0000000000015f38
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000015de8
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000015cc8
...
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x00000000000155d3
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x000000000001555a
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x00000000000154a6
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x0000000000015458
@property(readonly, nonatomic) struct __CFString *wwanInterfaceName;
@property(readonly, nonatomic) int currentRAT; // @synthesize currentRAT=_currentRAT;
- (id)_currentDataSimContext;	// IMP=0x0000000000015194
...
- (_Bool)_isCurrentDataSimContextOnIvarQueue:(id)arg1;	// IMP=0x000000000001510e
- (void)_adjustInterfaceNameForWWANContextID:(int)arg1 interfaceName:(id)arg2 forContext:(id)arg3;	// IMP=0x0000000000014ec9
- (void)_setupWWANMonitor;	// IMP=0x0000000000014df3
- (void)dealloc;	// IMP=0x0000000000014d95
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000014bfa
