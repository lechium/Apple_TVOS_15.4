...
+ (id)predicateForActiveRegistrationsInBootSession:(id)arg1;	// IMP=0x000000000001f303
+ (id)materializedRegistrationFrom:(id)arg1;	// IMP=0x000000000001f262
+ (void)hydrateMO:(id)arg1 fromRegistration:(id)arg2;	// IMP=0x000000000001f0d7
