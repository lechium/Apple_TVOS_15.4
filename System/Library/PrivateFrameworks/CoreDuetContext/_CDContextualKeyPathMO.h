...
+ (id)materializedContextValueFrom:(id)arg1;	// IMP=0x0000000000012873
+ (id)materializedKeyPathFrom:(id)arg1;	// IMP=0x0000000000012796
+ (void)hydrateMO:(id)arg1 fromKeyPath:(id)arg2 andValue:(id)arg3;	// IMP=0x0000000000012595
