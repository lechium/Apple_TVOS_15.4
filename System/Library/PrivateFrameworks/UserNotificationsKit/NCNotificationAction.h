...
- (void).cxx_destruct;	// IMP=0x0000000000004ccb
...
- (id)succinctDescriptionBuilder;	// IMP=0x0000000000004bc7
- (id)succinctDescription;	// IMP=0x0000000000004b77
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000004759
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000004709
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000046db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000046d0
@property(readonly, nonatomic, getter=isSystemAction) _Bool systemAction;
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)initWithNotificationAction:(id)arg1;	// IMP=0x00000000000043ae
