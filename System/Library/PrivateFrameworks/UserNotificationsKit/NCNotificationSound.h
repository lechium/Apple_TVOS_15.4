...
- (void).cxx_destruct;	// IMP=0x000000000000f0b9
...
- (id)succinctDescriptionBuilder;	// IMP=0x000000000000ee79
- (id)succinctDescription;	// IMP=0x000000000000ee29
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000000eacd
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000000000ea7d
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000ea4f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000ea44
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000e651
- (id)initWithNotificationSound:(id)arg1;	// IMP=0x000000000000e47c
