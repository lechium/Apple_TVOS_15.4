...
- (void).cxx_destruct;	// IMP=0x0000000000011454
...
- (id)initWithCnContactIdentifier:(id)arg1 cnContactFullname:(id)arg2 isSuggestedContact:(_Bool)arg3;	// IMP=0x0000000000011355
