...
- (void).cxx_destruct;	// IMP=0x0000000000018382
...
- (id)succinctDescriptionBuilder;	// IMP=0x000000000001823b
- (id)succinctDescription;	// IMP=0x00000000000181eb
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000017e3d
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000017ded
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017dbf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000017db4
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000017913
- (id)initWithNotificationSectionSettings:(id)arg1;	// IMP=0x00000000000176e7
