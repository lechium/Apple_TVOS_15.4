...
- (void).cxx_destruct;	// IMP=0x0000000000017513
...
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000173bf
- (id)succinctDescription;	// IMP=0x000000000001736f
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000016c0d
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000016bbd
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016b8f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016b84
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016456
- (id)initWithNotificationOptions:(id)arg1;	// IMP=0x0000000000016173
