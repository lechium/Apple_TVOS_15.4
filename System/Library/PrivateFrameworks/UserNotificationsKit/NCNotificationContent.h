...
- (void).cxx_destruct;	// IMP=0x000000000000a67f
...
- (id)succinctDescriptionBuilder;	// IMP=0x000000000000a531
- (id)succinctDescription;	// IMP=0x000000000000a4e1
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000009f41
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000009ef1
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000009ec3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000009eb8
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000097fb
@property(readonly, nonatomic, getter=isCommunicationType) _Bool communicationType;
- (_Bool)isAirDrop;	// IMP=0x0000000000009760
...
- (id)initWithNotificationContent:(id)arg1;	// IMP=0x00000000000091ac
