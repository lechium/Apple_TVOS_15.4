...
- (void).cxx_destruct;	// IMP=0x0000000000003d76
...
- (id)succinctDescriptionBuilder;	// IMP=0x0000000000003c48
- (id)succinctDescription;	// IMP=0x0000000000003bf8
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000003a22
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000039d2
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000039a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003999
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000037f2
- (id)initWithNotificationSystemSettings:(id)arg1;	// IMP=0x0000000000003721
