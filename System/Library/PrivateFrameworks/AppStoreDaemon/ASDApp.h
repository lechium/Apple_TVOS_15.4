...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002b7c4
- (void).cxx_destruct;	// IMP=0x000000000002c3c2
...
- (unsigned char)_cachedOpenableStatus;	// IMP=0x000000000002bfa4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002bbce
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002b7cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b35c
- (_Bool)isEqualToApp:(id)arg1;	// IMP=0x000000000002acea
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002ac87
- (unsigned long long)hash;	// IMP=0x000000000002ac43
- (id)description;	// IMP=0x000000000002a5c4
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000000029c3c
