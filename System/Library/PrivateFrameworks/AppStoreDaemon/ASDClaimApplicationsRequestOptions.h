...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000036749
- (void).cxx_destruct;	// IMP=0x0000000000036daf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000036aa7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000036751
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000365fc
- (id)initWithBundleIdentifiers:(id)arg1;	// IMP=0x000000000003657f
- (id)initWithClaimStyle:(long long)arg1;	// IMP=0x000000000003653b
