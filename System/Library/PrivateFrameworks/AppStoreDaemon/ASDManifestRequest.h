...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000048109
- (void).cxx_destruct;	// IMP=0x00000000000484d4
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000481da
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000048111
