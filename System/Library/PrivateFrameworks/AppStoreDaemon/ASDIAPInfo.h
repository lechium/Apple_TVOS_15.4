...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000187a3
- (void).cxx_destruct;	// IMP=0x0000000000018cd7
...
- (id)_newCopyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x0000000000018ac8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000188c7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000187ab
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000018770
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001870d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000186a6
- (id)description;	// IMP=0x000000000001861a
- (_Bool)isEqualToIAPInfo:(id)arg1;	// IMP=0x0000000000018492
