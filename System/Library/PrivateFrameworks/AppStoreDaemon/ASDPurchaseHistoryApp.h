...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004f431
- (void).cxx_destruct;	// IMP=0x0000000000050100
...
- (void)_setBooleanPropertiesForBitfield:(int)arg1;	// IMP=0x000000000004fc12
- (int)_bitfieldForBooleanProperties;	// IMP=0x000000000004fb03
@property(readonly) _Bool hasAnyMacOSCompatibleIOSVersion;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004f65b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004f439
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004e3af
