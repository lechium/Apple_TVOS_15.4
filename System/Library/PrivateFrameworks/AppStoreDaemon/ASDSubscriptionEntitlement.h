...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004ad1f
- (void).cxx_destruct;	// IMP=0x000000000004af11
- (id)_valueForKey:(id)arg1 ofType:(Class)arg2;	// IMP=0x000000000004ae99
- (id)_dateFromDateString:(id)arg1;	// IMP=0x000000000004adcc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004ad4a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004ad27
...
- (id)initWithDictionary:(id)arg1 forAppAdamID:(id)arg2 segment:(unsigned long long)arg3 hasFamily:(_Bool)arg4;	// IMP=0x000000000004a423
