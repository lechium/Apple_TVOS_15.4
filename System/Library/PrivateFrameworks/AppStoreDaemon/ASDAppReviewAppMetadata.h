...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000313fe
- (void).cxx_destruct;	// IMP=0x0000000000031a63
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003174f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000031406
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003123f
@property(readonly) long long metadataType;
- (id)initWithStoreMetadata:(id)arg1;	// IMP=0x00000000000311cc
