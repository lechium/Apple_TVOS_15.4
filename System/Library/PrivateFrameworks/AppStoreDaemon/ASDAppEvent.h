...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000038f99
- (void).cxx_destruct;	// IMP=0x0000000000039b86
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000039423
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000038fa1
- (id)description;	// IMP=0x0000000000038f18
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038b4c
