...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001b3bd
- (void).cxx_destruct;	// IMP=0x000000000001b729
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b4e8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b3c5
- (id)description;	// IMP=0x000000000001b322
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b274
