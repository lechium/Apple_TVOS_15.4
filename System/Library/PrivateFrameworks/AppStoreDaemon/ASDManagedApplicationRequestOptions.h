...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000033030
- (void).cxx_destruct;	// IMP=0x000000000003344c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003320f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000033038
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000032eff
- (id)initWithItemIdentifer:(id)arg1 externalVersionIdentifier:(id)arg2 bundleIdentifier:(id)arg3 bundleVersion:(id)arg4 skipDownloads:(_Bool)arg5;	// IMP=0x0000000000032dfa
