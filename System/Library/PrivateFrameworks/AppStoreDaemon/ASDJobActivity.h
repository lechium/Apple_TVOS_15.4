...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005fb42
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000060681
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005fb4a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005f4ed
- (_Bool)isValid;	// IMP=0x000000000005f4d0
