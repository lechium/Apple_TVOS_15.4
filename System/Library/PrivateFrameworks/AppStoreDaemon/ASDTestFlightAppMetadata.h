...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000459aa
- (void).cxx_destruct;	// IMP=0x0000000000046664
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000460d1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000459b2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004561e
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000000045570
