...
- (void).cxx_destruct;	// IMP=0x00000000000480d6
...
- (id)dictionary;	// IMP=0x0000000000047f61
- (id)description;	// IMP=0x0000000000047e56
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000047d17
