...
+ (void)_unitTest_SetDisableExcludingSourceApplicationFromOpenActivities:(_Bool)arg1;	// IMP=0x000000000003336f
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000030c4a
- (void).cxx_destruct;	// IMP=0x0000000000033742
...
- (id)availableActivityItemValueClasses;	// IMP=0x0000000000033206
- (id)_contextForMatchingActivityItems:(id)arg1 activityItemValues:(id)arg2 activityItemValueClasses:(id)arg3;	// IMP=0x0000000000032d1e
- (id)contextForMatchingByActivityItems:(id)arg1 itemValues:(id)arg2;	// IMP=0x0000000000032d09
- (id)contextForMatchingByActivityItemValueClasses;	// IMP=0x0000000000032ca6
- (id)description;	// IMP=0x0000000000032a30
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000031d46
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000030c52
