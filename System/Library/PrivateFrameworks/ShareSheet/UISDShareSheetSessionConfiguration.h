...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002e3b2
- (void).cxx_destruct;	// IMP=0x000000000002eb1a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002e805
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002e3ba
