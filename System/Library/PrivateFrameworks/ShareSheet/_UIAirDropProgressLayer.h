...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0000000000002aed
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000002b5f
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000293a
- (id)init;	// IMP=0x000000000000281f
