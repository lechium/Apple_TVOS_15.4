...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000010fa2
- (void).cxx_destruct;	// IMP=0x00000000000112f4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000011128
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010faa
