...
- (void).cxx_destruct;	// IMP=0x0000000000036947
...
- (void)_prepareActivityViewControllerIfNeeded;	// IMP=0x00000000000366f6
- (void)_cleanup;	// IMP=0x00000000000366e2
- (void)_settingsViewControllerDidDismiss:(id)arg1;	// IMP=0x00000000000366ce
- (void)activityDidFinish:(_Bool)arg1 items:(id)arg2 error:(id)arg3;	// IMP=0x0000000000036614
- (id)activityViewController;	// IMP=0x00000000000365e6
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000000365de
- (id)_actionImage;	// IMP=0x000000000003651e
- (id)_activityImage;	// IMP=0x000000000003630e
- (id)activityTitle;	// IMP=0x0000000000036297
- (id)activityType;	// IMP=0x0000000000036283
- (id)initWithUserDefaults:(id)arg1 activityCategory:(long long)arg2;	// IMP=0x00000000000361e9
