...
- (void).cxx_destruct;	// IMP=0x0000000000050e86
...
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000050d7d
- (void)viewDidLoad;	// IMP=0x0000000000050d26
- (id)initWithPrintInteractionController:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000050c76
