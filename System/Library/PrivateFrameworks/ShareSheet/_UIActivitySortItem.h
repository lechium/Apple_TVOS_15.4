...
+ (id)sortDescriptorForActivity:(id)arg1 withGroup:(long long)arg2 secondarySortValue:(id)arg3 tertiarySortValue:(id)arg4;	// IMP=0x000000000005e11f
+ (id)sortDescriptorForActivity:(id)arg1 withGroup:(long long)arg2 secondarySortValue:(id)arg3;	// IMP=0x000000000005e095
...
- (long long)compare:(id)arg1;	// IMP=0x000000000005e26a
- (id)debugDescription;	// IMP=0x000000000005e185
