...
- (void).cxx_destruct;	// IMP=0x0000000000058520
...
- (id)createContextDictionary;	// IMP=0x0000000000058198
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000057f28
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x0000000000057eb5
