...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002eb79
- (void).cxx_destruct;	// IMP=0x000000000002f91e
...
- (_Bool)load;	// IMP=0x000000000002f7ed
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f191
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
@property double platterTextHeight;
@property unsigned int labelSlotID;
@property unsigned int imageSlotID;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002ee32
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002ec12
- (id)initWithActivity:(id)arg1;	// IMP=0x000000000002eb81
