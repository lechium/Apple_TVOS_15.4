...
- (void).cxx_destruct;	// IMP=0x000000000004ca88
...
- (id)activitiesByFilteringExcludedActivities:(id)arg1;	// IMP=0x000000000004c6dc
- (_Bool)shouldExcludeActivity:(id)arg1;	// IMP=0x000000000004c582
- (id)description;	// IMP=0x000000000004c09c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004bbd8
- (id)initWithActivityItems:(id)arg1 itemValues:(id)arg2;	// IMP=0x000000000004bb18
