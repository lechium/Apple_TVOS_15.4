...
- (void).cxx_destruct;	// IMP=0x0000000000071edd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000071e12
- (unsigned long long)hash;	// IMP=0x0000000000071cb0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000071bc3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000071b0a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000071a86
- (void)writeTo:(id)arg1;	// IMP=0x00000000000719f6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000719e9
- (id)dictionaryRepresentation;	// IMP=0x0000000000071645
- (id)description;	// IMP=0x0000000000071596
