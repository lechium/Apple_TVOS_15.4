...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000426c4
- (unsigned long long)hash;	// IMP=0x0000000000042583
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000424ca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000042447
- (void)copyTo:(id)arg1;	// IMP=0x00000000000423e7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000042373
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000042366
- (id)dictionaryRepresentation;	// IMP=0x0000000000042022
- (id)description;	// IMP=0x0000000000041f73
