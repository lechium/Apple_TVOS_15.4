...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000048797
- (unsigned long long)hash;	// IMP=0x0000000000048751
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000048693
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048616
- (void)copyTo:(id)arg1;	// IMP=0x00000000000485bc
- (void)writeTo:(id)arg1;	// IMP=0x000000000004854a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000004853d
- (id)dictionaryRepresentation;	// IMP=0x00000000000481be
- (id)description;	// IMP=0x000000000004810f
