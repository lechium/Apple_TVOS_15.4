...
- (void).cxx_destruct;	// IMP=0x00000000000a1b1b
...
- (id)publisherForQuery:(id)arg1;	// IMP=0x00000000000a1a42
- (id)initWithKnowledgeStore:(id)arg1 clientContext:(id)arg2 identifier:(id)arg3;	// IMP=0x00000000000a198b
- (id)init;	// IMP=0x00000000000a1985
