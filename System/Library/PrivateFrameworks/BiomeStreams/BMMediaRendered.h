...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x000000000004f831
- (void).cxx_destruct;	// IMP=0x000000000004fc84
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004f921
- (id)serialize;	// IMP=0x000000000004f8bb
@property(readonly, nonatomic) unsigned int dataVersion;
- (void)writeTo:(id)arg1;	// IMP=0x000000000004f614
- (id)initByReadFrom:(id)arg1;	// IMP=0x000000000004f1eb
@property(readonly, copy) NSString *description;
- (id)initWithAbsoluteTimestamp:(double)arg1 mediaAttributes:(id)arg2 isOnScreen:(_Bool)arg3 isFirstView:(_Bool)arg4;	// IMP=0x000000000004efda
