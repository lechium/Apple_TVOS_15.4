...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x000000000001af43
- (void).cxx_destruct;	// IMP=0x000000000001bfb7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b907
@property(readonly) unsigned long long hash;
- (id)proto;	// IMP=0x000000000001b765
- (id)initWithProtoData:(id)arg1;	// IMP=0x000000000001b6c9
- (id)initWithProto:(id)arg1;	// IMP=0x000000000001b35c
- (id)encodeAsProto;	// IMP=0x000000000001b30c
- (id)json;	// IMP=0x000000000001b24c
- (id)jsonDict;	// IMP=0x000000000001aff1
- (id)serialize;	// IMP=0x000000000001afdf
@property(readonly, nonatomic) unsigned int dataVersion;
- (id)initWithAbsoluteTimestamp:(double)arg1 userActivityData:(id)arg2 title:(id)arg3 activityType:(id)arg4 associatedBundleId:(id)arg5 associatedURLString:(id)arg6 modeIdentifier:(id)arg7 topics:(id)arg8 hasAssociatedImageRepresentation:(_Bool)arg9 uuid:(id)arg10;	// IMP=0x000000000001ad82
