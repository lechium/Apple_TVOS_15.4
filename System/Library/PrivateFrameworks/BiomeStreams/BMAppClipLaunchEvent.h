...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x000000000005ec74
- (void).cxx_destruct;	// IMP=0x000000000005fb51
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005f40d
@property(readonly) unsigned long long hash;
- (id)proto;	// IMP=0x000000000005f051
- (id)initWithProtoData:(id)arg1;	// IMP=0x000000000005efb5
- (id)initWithProto:(id)arg1;	// IMP=0x000000000005ed57
- (id)encodeAsProto;	// IMP=0x000000000005ed07
- (id)serialize;	// IMP=0x000000000005ec62
@property(readonly, nonatomic) unsigned int dataVersion;
@property(readonly, copy) NSString *description;
- (id)initWithURLHash:(id)arg1 clipBundleID:(id)arg2 appBundleID:(id)arg3 webAppBundleID:(id)arg4 launchReason:(id)arg5 fullURL:(id)arg6 referrerURL:(id)arg7 referrerBundleID:(id)arg8;	// IMP=0x000000000005e8e4
- (id)init;	// IMP=0x000000000005e8de
