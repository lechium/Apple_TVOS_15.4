...
- (void).cxx_destruct;	// IMP=0x00000000000a8236
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000a7feb
- (unsigned long long)hash;	// IMP=0x00000000000a7efa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a7cfe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a7b70
- (void)copyTo:(id)arg1;	// IMP=0x00000000000a7a4d
- (void)writeTo:(id)arg1;	// IMP=0x00000000000a7942
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000a7935
- (id)dictionaryRepresentation;	// IMP=0x00000000000a7641
- (id)description;	// IMP=0x00000000000a7592
