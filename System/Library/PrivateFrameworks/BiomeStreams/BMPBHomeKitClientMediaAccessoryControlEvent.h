...
+ (Class)zoneNamesType;	// IMP=0x0000000000081333
+ (Class)zoneUniqueIdentifiersType;	// IMP=0x0000000000081222
+ (Class)accessoryStateType;	// IMP=0x000000000008113b
- (void).cxx_destruct;	// IMP=0x0000000000083073
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000082aca
- (unsigned long long)hash;	// IMP=0x00000000000829a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008273d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000821d8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000081ef9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000081b39
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000081b2c
- (id)dictionaryRepresentation;	// IMP=0x0000000000081408
- (id)description;	// IMP=0x0000000000081359
@property(readonly, nonatomic) _Bool hasHomeName;
- (id)zoneNamesAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000081316
- (unsigned long long)zoneNamesCount;	// IMP=0x00000000000812f9
- (void)addZoneNames:(id)arg1;	// IMP=0x000000000008128f
- (void)clearZoneNames;	// IMP=0x0000000000081272
...
- (id)zoneUniqueIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000081205
- (unsigned long long)zoneUniqueIdentifiersCount;	// IMP=0x00000000000811e8
- (void)addZoneUniqueIdentifiers:(id)arg1;	// IMP=0x000000000008117e
- (void)clearZoneUniqueIdentifiers;	// IMP=0x0000000000081161
@property(readonly, nonatomic) _Bool hasAccessoryMediaRouteIdentifier;
- (id)accessoryStateAtIndex:(unsigned long long)arg1;	// IMP=0x000000000008111e
- (unsigned long long)accessoryStatesCount;	// IMP=0x0000000000081101
- (void)addAccessoryState:(id)arg1;	// IMP=0x0000000000081097
- (void)clearAccessoryStates;	// IMP=0x000000000008107a
