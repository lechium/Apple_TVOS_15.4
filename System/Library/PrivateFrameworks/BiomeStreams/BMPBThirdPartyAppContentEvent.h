...
- (void).cxx_destruct;	// IMP=0x0000000000073025
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000072da4
- (unsigned long long)hash;	// IMP=0x0000000000072b9d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007295f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000727b1
- (void)copyTo:(id)arg1;	// IMP=0x000000000007266a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000072539
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000007252c
- (id)dictionaryRepresentation;	// IMP=0x000000000007208e
- (id)description;	// IMP=0x0000000000071fdf
