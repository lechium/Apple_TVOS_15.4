...
- (void).cxx_destruct;	// IMP=0x0000000000097ead
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000097d51
- (unsigned long long)hash;	// IMP=0x0000000000097ba3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000097a4b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000097943
- (void)copyTo:(id)arg1;	// IMP=0x000000000009787f
- (void)writeTo:(id)arg1;	// IMP=0x00000000000977b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000977a8
- (id)dictionaryRepresentation;	// IMP=0x0000000000097237
- (id)description;	// IMP=0x0000000000097188
...
- (int)StringAsFeedbackType:(id)arg1;	// IMP=0x0000000000096f7c
- (id)feedbackTypeAsString:(int)arg1;	// IMP=0x0000000000096ea1
