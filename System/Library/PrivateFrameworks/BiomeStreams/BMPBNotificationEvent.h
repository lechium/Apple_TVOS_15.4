...
+ (Class)contactIDsType;	// IMP=0x00000000000a9079
- (void).cxx_destruct;	// IMP=0x00000000000aafc7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000aaae9
- (unsigned long long)hash;	// IMP=0x00000000000aa815
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000aa49e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000aa0bc
- (void)copyTo:(id)arg1;	// IMP=0x00000000000a9e38
- (void)writeTo:(id)arg1;	// IMP=0x00000000000a9b49
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000a9b3c
- (id)dictionaryRepresentation;	// IMP=0x00000000000a9184
- (id)description;	// IMP=0x00000000000a90d5
@property(nonatomic) _Bool hasIsGroupMessage;
- (id)contactIDsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000a905c
- (unsigned long long)contactIDsCount;	// IMP=0x00000000000a903f
- (void)addContactIDs:(id)arg1;	// IMP=0x00000000000a8fd5
- (void)clearContactIDs;	// IMP=0x00000000000a8fb8
...
- (int)StringAsUsageType:(id)arg1;	// IMP=0x00000000000a8bcc
- (id)usageTypeAsString:(int)arg1;	// IMP=0x00000000000a8a5e
