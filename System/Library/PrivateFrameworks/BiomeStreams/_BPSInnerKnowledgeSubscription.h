...
- (id)upstreamSubscriptions;	// IMP=0x00000000000139e8
- (void)cancel;	// IMP=0x00000000000139ae
- (void)requestDemand:(long long)arg1;	// IMP=0x0000000000013476
- (id)initWithQuery:(id)arg1 downstream:(id)arg2 store:(id)arg3;	// IMP=0x0000000000013392
