...
- (void).cxx_destruct;	// IMP=0x000000000005523b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000550e9
- (unsigned long long)hash;	// IMP=0x00000000000550ac
- (id)proto;	// IMP=0x0000000000054f0d
- (id)initWithDeviceType:(unsigned long long)arg1 deviceSubType:(unsigned long long)arg2 deviceId:(id)arg3;	// IMP=0x0000000000054e84
