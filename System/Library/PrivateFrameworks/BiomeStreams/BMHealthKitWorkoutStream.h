...
- (void).cxx_destruct;	// IMP=0x0000000000035ea5
- (id)source;	// IMP=0x0000000000035e8f
- (id)publisher;	// IMP=0x0000000000035e21
- (id)publisherFromStartTime:(double)arg1;	// IMP=0x0000000000035e0b
