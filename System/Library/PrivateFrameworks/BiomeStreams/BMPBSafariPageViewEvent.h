...
- (void).cxx_destruct;	// IMP=0x0000000000045006
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000044ddb
- (unsigned long long)hash;	// IMP=0x0000000000044bdd
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000449d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000044844
- (void)copyTo:(id)arg1;	// IMP=0x0000000000044719
- (void)writeTo:(id)arg1;	// IMP=0x00000000000445f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000445ec
- (id)dictionaryRepresentation;	// IMP=0x00000000000440e5
- (id)description;	// IMP=0x0000000000044036
