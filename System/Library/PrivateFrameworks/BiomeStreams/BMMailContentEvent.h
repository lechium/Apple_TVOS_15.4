...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c9f7f
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x00000000000c9cf5
...
- (_Bool)isValidWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000ca6ed
- (_Bool)isCompleteWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000ca4ed
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ca427
@property(readonly) unsigned long long hash;
- (id)initWithProtoData:(id)arg1;	// IMP=0x00000000000ca2d1
- (id)initWithProto:(id)arg1;	// IMP=0x00000000000ca116
- (id)encodeAsProto;	// IMP=0x00000000000ca0c6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ca000
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c9f87
- (id)json;	// IMP=0x00000000000c9eaa
- (id)jsonDict;	// IMP=0x00000000000c9da3
- (id)serialize;	// IMP=0x00000000000c9d91
@property(readonly, nonatomic) unsigned int dataVersion;
- (id)initWithUniqueId:(id)arg1 domainId:(id)arg2 absoluteTimestamp:(double)arg3 accountIdentifier:(id)arg4 messageIdentifier:(id)arg5 fromHandle:(id)arg6 toHandles:(id)arg7 ccHandles:(id)arg8 bccHandles:(id)arg9 headers:(id)arg10 subject:(id)arg11 htmlContent:(id)arg12 textContent:(id)arg13 isFullyDownloaded:(_Bool)arg14 securityMethod:(id)arg15 accountHandles:(id)arg16 replyTo:(id)arg17 mailboxIdentifiers:(id)arg18 listId:(id)arg19 accountType:(id)arg20 attachments:(id)arg21;	// IMP=0x00000000000c9c67
- (id)initWithUniqueId:(id)arg1 domainId:(id)arg2 absoluteTimestamp:(double)arg3 accountIdentifier:(id)arg4 messageIdentifier:(id)arg5 fromHandle:(id)arg6 toHandles:(id)arg7 ccHandles:(id)arg8 bccHandles:(id)arg9 headers:(id)arg10 subject:(id)arg11 htmlContent:(id)arg12 textContent:(id)arg13 isFullyDownloaded:(_Bool)arg14 securityMethod:(id)arg15 accountHandles:(id)arg16 replyTo:(id)arg17 mailboxIdentifiers:(id)arg18 listId:(id)arg19 accountType:(id)arg20 attachments:(id)arg21 contentProtection:(id)arg22;	// IMP=0x00000000000c90f7
- (id)_initWithUniqueId:(id)arg1 domainId:(id)arg2;	// IMP=0x00000000000c9037
- (void)_loadData;	// IMP=0x00000000000c8f6f
- (void)_inflateFromProto:(id)arg1;	// IMP=0x00000000000c87cc
- (id)proto;	// IMP=0x00000000000c87a7
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000c8795
- (id)init;	// IMP=0x00000000000c878f
