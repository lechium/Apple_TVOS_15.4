...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x00000000000749ce
- (void).cxx_destruct;	// IMP=0x0000000000075a31
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000074fe9
- (id)proto;	// IMP=0x0000000000074ddf
- (id)initWithProtoData:(id)arg1;	// IMP=0x0000000000074d43
- (id)initWithProto:(id)arg1;	// IMP=0x0000000000074a79
- (id)encodeAsProto;	// IMP=0x0000000000074a29
- (id)serialize;	// IMP=0x0000000000074a17
@property(readonly, nonatomic) unsigned int dataVersion;
@property(readonly, copy) NSString *description;
- (id)initWithDKEvent:(id)arg1;	// IMP=0x000000000007463e
- (id)initWithUniqueID:(id)arg1 absoluteTimestamp:(double)arg2 usageType:(unsigned long long)arg3 bundleID:(id)arg4 notificationID:(id)arg5 deviceID:(id)arg6 title:(id)arg7 subtitle:(id)arg8 badge:(unsigned long long)arg9 threadID:(id)arg10 categoryID:(id)arg11 sectionID:(id)arg12 contactIDs:(id)arg13 isGroupMessage:(_Bool)arg14;	// IMP=0x000000000007412a
- (id)init;	// IMP=0x0000000000074124
