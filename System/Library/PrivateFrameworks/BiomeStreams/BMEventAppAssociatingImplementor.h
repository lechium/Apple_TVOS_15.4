...
- (void).cxx_destruct;	// IMP=0x00000000000417f5
@property(copy, nonatomic) NSString *bundleID; // @synthesize bundleID;
- (_Bool)isCompleteWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000417c1
- (_Bool)isValidWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004178e
