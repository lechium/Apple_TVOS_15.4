...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e45c
- (void).cxx_destruct;	// IMP=0x000000000003e768
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003e56d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003e464
- (id)initWithRowTransform:(id)arg1 schema:(id)arg2 tableName:(id)arg3;	// IMP=0x000000000003e433
- (id)initWithRowTransform:(id)arg1 schema:(id)arg2 tableName:(id)arg3 name:(id)arg4 version:(unsigned int)arg5;	// IMP=0x000000000003e349
