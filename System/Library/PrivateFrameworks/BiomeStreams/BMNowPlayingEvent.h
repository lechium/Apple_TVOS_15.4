...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x00000000000560d3
- (void).cxx_destruct;	// IMP=0x000000000005774b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000056e60
@property(readonly) unsigned long long hash;
- (id)proto;	// IMP=0x000000000005678a
- (id)initWithProtoData:(id)arg1;	// IMP=0x00000000000566ee
- (id)initWithProto:(id)arg1;	// IMP=0x000000000005617e
- (id)encodeAsProto;	// IMP=0x000000000005612e
- (id)serialize;	// IMP=0x000000000005611c
@property(readonly, nonatomic) unsigned int dataVersion;
@property(readonly, copy) NSString *description;
- (id)initWithDKEvent:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000055484
...
- (id)init;	// IMP=0x000000000005524b
