...
- (void).cxx_destruct;	// IMP=0x000000000004ada7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000004aa8d
- (unsigned long long)hash;	// IMP=0x000000000004a749
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004a477
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004a24c
- (void)copyTo:(id)arg1;	// IMP=0x000000000004a0a3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000049f0d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000049f00
- (id)dictionaryRepresentation;	// IMP=0x000000000004980f
- (id)description;	// IMP=0x0000000000049760
...
- (int)StringAsStatus:(id)arg1;	// IMP=0x00000000000495e8
- (id)statusAsString:(int)arg1;	// IMP=0x0000000000049568
