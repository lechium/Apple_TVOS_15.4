...
- (void).cxx_destruct;	// IMP=0x0000000000061671
...
- (_Bool)isValidWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000061461
- (id)initWithBegin:(_Bool)arg1 bundleID:(id)arg2 URL:(id)arg3 mediaURL:(id)arg4 usageTrusted:(_Bool)arg5 timestamp:(id)arg6;	// IMP=0x0000000000061234
- (id)initWithBegin:(_Bool)arg1 bundleID:(id)arg2 URL:(id)arg3 mediaURL:(id)arg4 timestamp:(id)arg5;	// IMP=0x0000000000061218
- (id)init;	// IMP=0x0000000000061212
