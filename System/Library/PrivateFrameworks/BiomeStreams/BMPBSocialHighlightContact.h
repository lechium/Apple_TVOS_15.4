...
- (void).cxx_destruct;	// IMP=0x000000000008e575
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000008e4a9
- (unsigned long long)hash;	// IMP=0x000000000008e431
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008e325
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008e271
- (void)copyTo:(id)arg1;	// IMP=0x000000000008e1ea
- (void)writeTo:(id)arg1;	// IMP=0x000000000008e15c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000008e14f
- (id)dictionaryRepresentation;	// IMP=0x000000000008dd70
- (id)description;	// IMP=0x000000000008dcc1
