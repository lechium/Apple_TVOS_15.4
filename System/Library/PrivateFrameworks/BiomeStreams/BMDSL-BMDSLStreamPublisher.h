...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x0000000000045a5b
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x000000000007f1cd
@end
