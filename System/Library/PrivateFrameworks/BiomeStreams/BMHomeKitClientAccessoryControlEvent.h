...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x0000000000094a57
- (void).cxx_destruct;	// IMP=0x000000000009687a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000095913
- (id)proto;	// IMP=0x00000000000953d0
- (id)initWithProtoData:(id)arg1;	// IMP=0x0000000000095334
- (id)initWithProto:(id)arg1;	// IMP=0x0000000000094b50
- (id)encodeAsProto;	// IMP=0x0000000000094b00
- (id)serialize;	// IMP=0x0000000000094aee
