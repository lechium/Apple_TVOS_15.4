...
- (void).cxx_destruct;	// IMP=0x00000000000a137d
- (id)source;	// IMP=0x00000000000a1367
- (id)publisher;	// IMP=0x00000000000a12f9
- (id)publisherFromStartTime:(double)arg1;	// IMP=0x00000000000a12e3
- (id)init;	// IMP=0x00000000000a1232
