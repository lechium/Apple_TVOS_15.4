...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x00000000000902ba
- (void).cxx_destruct;	// IMP=0x0000000000090666
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000903aa
- (id)serialize;	// IMP=0x0000000000090344
@property(readonly, nonatomic) unsigned int dataVersion;
- (void)writeTo:(id)arg1;	// IMP=0x0000000000090228
- (id)initByReadFrom:(id)arg1;	// IMP=0x000000000008ff40
@property(readonly, copy) NSString *description;
- (id)initWithAbsoluteTimestamp:(double)arg1 mediaUUID:(id)arg2 type:(int)arg3;	// IMP=0x000000000008fd28
