...
- (void).cxx_destruct;	// IMP=0x000000000006007f
...
- (_Bool)saveKnowledgeEvent:(id)arg1 error:(id *)arg2;	// IMP=0x000000000005ff60
- (id)removeObjectsMatchingPredicate:(id)arg1 fromArrayAtKeyPath:(id)arg2;	// IMP=0x000000000005fec9
- (_Bool)addContextValue:(id)arg1 toArrayAtKeyPath:(id)arg2;	// IMP=0x000000000005fde8
- (id)init;	// IMP=0x000000000005fbe8
