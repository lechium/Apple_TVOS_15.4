...
- (void).cxx_destruct;	// IMP=0x000000000009c14e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000009bff7
- (unsigned long long)hash;	// IMP=0x000000000009bf48
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009bde4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009bcd7
- (void)copyTo:(id)arg1;	// IMP=0x000000000009bc14
- (void)writeTo:(id)arg1;	// IMP=0x000000000009bb59
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000009bb4c
- (id)dictionaryRepresentation;	// IMP=0x000000000009b2c0
...
- (int)StringAsTaskStep:(id)arg1;	// IMP=0x000000000009a794
- (id)taskStepAsString:(int)arg1;	// IMP=0x000000000009a295
