...
@class NSArray, NSData, NSDate, NSManagedObjectContext, NSManagedObjectID, NSNumber, NSSet, NSString, NSURL, NoteBodyObject, NoteStoreObject;

@interface NoteObject : NSManagedObject <ICSearchIndexableNote>
{
}

- (_Bool)belongsToCollection:(id)arg1;	// IMP=0x000000000001535f
@property(nonatomic) unsigned long long sequenceNumber;
- (_Bool)containsAttachments;	// IMP=0x0000000000015280
...
- (void)markForDeletion;	// IMP=0x0000000000014df1
...
- (id)defaultTitleForEmptyNote;	// IMP=0x0000000000014abc
