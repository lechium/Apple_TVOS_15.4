...
- (void)_beginFadeAnimationFromViewController:(id)arg1 toViewController:(id)arg2 containerView:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000009ee79
- (void)animateTransition:(id)arg1;	// IMP=0x000000000009ed46
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000009ed3b
- (id)init;	// IMP=0x000000000009ecf9
