...
+ (id)name;	// IMP=0x0000000000013caa
- (id)propertiesToIncludeForChecksumVersion:(int)arg1;	// IMP=0x0000000000014211
...
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000013cb7
- (void)fixComponent;	// IMP=0x0000000000012465
