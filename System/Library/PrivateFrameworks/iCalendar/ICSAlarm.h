...
+ (id)createNoneAlarm;	// IMP=0x0000000000022a48
+ (id)parseableDocumentFromICS:(id)arg1;	// IMP=0x0000000000022954
+ (id)ICSStringFromAction:(int)arg1;	// IMP=0x00000000000228f7
+ (int)actionFromICSString:(id)arg1;	// IMP=0x0000000000022839
+ (id)name;	// IMP=0x000000000002282c
...
- (_Bool)isNoneAlarm;	// IMP=0x0000000000022aec
- (void)fixAlarm;	// IMP=0x000000000000f052
