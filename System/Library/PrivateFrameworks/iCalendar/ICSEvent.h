...
+ (id)name;	// IMP=0x0000000000014f2a
- (id)propertiesThatIfPresentExcludeThisComponentFromChecksummingForVersion:(int)arg1;	// IMP=0x00000000000160e4
- (id)propertiesToIncludeForChecksumVersion:(int)arg1;	// IMP=0x0000000000016058
- (_Bool)isDefaultAlarmDeleted;	// IMP=0x0000000000015e93
...
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000014f37
- (void)fixAttendeeComments;	// IMP=0x0000000000012203
- (void)fixComponent;	// IMP=0x000000000001197e
