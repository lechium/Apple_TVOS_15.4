...
+ (id)assertionWithPropertyListRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000001df4
+ (id)assertionsWithPropertyListRepresentations:(id)arg1;	// IMP=0x0000000000001c25
+ (void)partitionAssertionsWithPropertyListRepresentations:(id)arg1 intoVersionLockedAssertions:(id)arg2 upgradableAssertions:(id)arg3;	// IMP=0x0000000000001a37
- (void).cxx_destruct;	// IMP=0x0000000000002275
...
- (id)propertyListRepresentation;	// IMP=0x0000000000001fcf
