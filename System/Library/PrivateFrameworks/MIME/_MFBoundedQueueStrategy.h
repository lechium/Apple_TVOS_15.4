...
- (void)dequeueObject:(id)arg1 buffer:(id)arg2;	// IMP=0x0000000000005b32
- (void)enqueueObject:(id)arg1 buffer:(id)arg2;	// IMP=0x0000000000005ab8
@property(readonly, nonatomic) NSString *descriptionType;
- (id)initWithCapacity:(unsigned long long)arg1 overflowHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005a49
- (void)dealloc;	// IMP=0x0000000000005a0e
