...
- (void)done;	// IMP=0x0000000000005388
- (long long)appendData:(id)arg1;	// IMP=0x000000000000513f
- (id)data;	// IMP=0x0000000000005037
- (void)dealloc;	// IMP=0x0000000000004fd7
- (id)init;	// IMP=0x0000000000004f84
