...
- (void)setStandardLineBreak;	// IMP=0x0000000000036c5b
@property(nonatomic) _Bool allowSlash;
- (void)done;	// IMP=0x000000000003696e
- (long long)appendData:(id)arg1;	// IMP=0x00000000000364cf
- (id)initWithConsumers:(id)arg1;	// IMP=0x000000000003647e
