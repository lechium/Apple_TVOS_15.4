...
+ (id)elementKind;	// IMP=0x000000000002679c
+ (double)defaultHeight;	// IMP=0x000000000002678e
+ (id)reuseIdentifier;	// IMP=0x0000000000026738
- (void).cxx_destruct;	// IMP=0x000000000002680d
...
- (double)desiredHeightForWidth:(double)arg1;	// IMP=0x000000000002646e
- (void)_configureHeaderLabelForBounds:(struct CGRect)arg1;	// IMP=0x0000000000025f46
- (void)layoutSubviews;	// IMP=0x0000000000025cd8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000025b6b
