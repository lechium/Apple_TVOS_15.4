...
+ (id)sharedInstance;	// IMP=0x000000000003c166
...
- (void)_updateProductTypeDerivedProperties;	// IMP=0x000000000003c46f
- (id)initWithLargeFormatPhone:(_Bool)arg1 gestaltModes:(id)arg2 screenSize:(struct CGSize)arg3;	// IMP=0x000000000003c2c7
