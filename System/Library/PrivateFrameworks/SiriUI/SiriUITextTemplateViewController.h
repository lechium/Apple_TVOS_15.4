...
- (_Bool)labelStackTemplateViewShouldLayoutCompressed:(id)arg1;	// IMP=0x0000000000038b2e
- (void)_textTemplateViewDisclosed:(id)arg1;	// IMP=0x0000000000038ae2
- (void)loadView;	// IMP=0x0000000000038a36
