...
- (void).cxx_destruct;	// IMP=0x000000000000d0f1
- (void)finishedFromURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000000cf9a
- (void)appendDownloadedData:(id)arg1 fromURL:(id)arg2;	// IMP=0x000000000000cca6
- (void)_updateImageFromURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000000c37d
- (void)dealloc;	// IMP=0x000000000000c336
- (id)initWithFitToSize:(struct CGSize)arg1 progressHandler:(CDUnknownBlockType)arg2 incremental:(_Bool)arg3 client:(id)arg4 fillColor:(id)arg5;	// IMP=0x000000000000c1d7
