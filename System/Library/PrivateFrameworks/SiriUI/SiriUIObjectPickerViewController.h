...
+ (id)pickerControllerWithPicker:(id)arg1;	// IMP=0x000000000001aea1
- (void).cxx_destruct;	// IMP=0x000000000001afc1
...
- (void)showPicker:(id)arg1;	// IMP=0x000000000001af7d
- (id)initWithPicker:(id)arg1;	// IMP=0x000000000001af0b
