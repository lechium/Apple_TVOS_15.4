...
- (void).cxx_destruct;	// IMP=0x000000000002ddb3
...
- (id)_attributedStringWithString:(id)arg1;	// IMP=0x000000000002dc53
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002db82
@property(readonly, nonatomic) NSAttributedString *attributedStringForMainScreenTraitCollection;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002daf9
- (id)initWithRegularString:(id)arg1 compactString:(id)arg2;	// IMP=0x000000000002da31
