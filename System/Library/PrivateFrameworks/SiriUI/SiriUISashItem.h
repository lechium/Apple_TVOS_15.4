...
+ (void)_setLanguageCode:(id)arg1;	// IMP=0x000000000001b734
+ (id)_languageCode;	// IMP=0x000000000001b723
+ (id)defaultSashItem;	// IMP=0x000000000001b007
- (void).cxx_destruct;	// IMP=0x000000000001b800
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b4b4
- (id)init;	// IMP=0x000000000001b47c
- (id)initWithExtension:(id)arg1;	// IMP=0x000000000001b3c8
- (id)initWithApplicationBundleIdentifier:(id)arg1;	// IMP=0x000000000001b116
- (id)initWithTitle:(id)arg1 image:(id)arg2;	// IMP=0x000000000001b083
