...
- (void).cxx_destruct;	// IMP=0x0000000000031585
...
- (double)desiredHeight;	// IMP=0x000000000003152d
- (void)reloadData;	// IMP=0x000000000003148b
- (void)layoutSubviews;	// IMP=0x00000000000311fc
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000000310a9
