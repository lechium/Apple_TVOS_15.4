...
- (void)mapTemplateViewDidSelectMap:(id)arg1;	// IMP=0x00000000000465db
- (void)mapTemplateView:(id)arg1 didModifyPlacemark:(id)arg2;	// IMP=0x0000000000046566
- (void)prepareForDismissal;	// IMP=0x0000000000046529
- (Class)templateViewClass;	// IMP=0x0000000000046518
- (void)loadView;	// IMP=0x00000000000464a7
