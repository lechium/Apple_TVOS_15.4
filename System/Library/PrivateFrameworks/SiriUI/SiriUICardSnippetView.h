...
- (void).cxx_destruct;	// IMP=0x00000000000373e2
...
- (void)_sashViewRecognizedTapGestureWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000037303
@property(readonly, nonatomic) UIButton *backNavigationButton;
@property(nonatomic, getter=isNavigating) _Bool navigating;
- (void)reloadData;	// IMP=0x00000000000371e6
- (void)setCardView:(id)arg1;	// IMP=0x00000000000370e6
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000036fa8
- (void)layoutSubviews;	// IMP=0x0000000000036d65
- (id)accessibilityIdentifier;	// IMP=0x0000000000036d58
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000036bf4
