...
+ (id)elementKind;	// IMP=0x000000000000a6d7
+ (double)defaultHeight;	// IMP=0x000000000000a6ce
+ (id)reuseIdentifier;	// IMP=0x000000000000a678
- (struct UIEdgeInsets)edgeInsets;	// IMP=0x000000000000a6eb
