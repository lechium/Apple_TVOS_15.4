...
- (void).cxx_destruct;	// IMP=0x0000000000002685
...
- (id)initWithBundleIdentifier:(id)arg1 parameterName:(id)arg2 displayNameLocalizationKey:(id)arg3 descriptionLocalizationKey:(id)arg4 sensitiveInformationLocalizationKey:(id)arg5 needsWAPIKeys:(_Bool)arg6 requiresFollowup:(_Bool)arg7 retry:(_Bool)arg8;	// IMP=0x000000000000244a
- (id)initWithBundleIdentifier:(id)arg1 parameterName:(id)arg2 baseLocalizationKey:(id)arg3 needsWAPIKeys:(_Bool)arg4 requiresFollowup:(_Bool)arg5 retry:(_Bool)arg6;	// IMP=0x0000000000002337
