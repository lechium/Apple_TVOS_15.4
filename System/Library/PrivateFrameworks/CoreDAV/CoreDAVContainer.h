...
+ (id)convertPushTransportsForNSServerNotificationCenter:(id)arg1;	// IMP=0x0000000000004533
+ (id)copyPropertyMappingsForParser;	// IMP=0x0000000000002540
...
- (_Bool)_anyPrivilegesMatches:(CDUnknownBlockType)arg1;	// IMP=0x00000000000036b6
...
- (void)postProcessWithResponseHeaders:(id)arg1;	// IMP=0x0000000000003209
- (void)applyParsedProperties:(id)arg1;	// IMP=0x0000000000002c01
- (id)description;	// IMP=0x0000000000002855
- (id)initWithURL:(id)arg1 andProperties:(id)arg2;	// IMP=0x00000000000027c6
