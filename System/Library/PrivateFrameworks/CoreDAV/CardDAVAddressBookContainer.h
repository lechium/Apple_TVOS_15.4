...
+ (id)copyPropertyMappingsForParser;	// IMP=0x00000000000051bf
- (void).cxx_destruct;	// IMP=0x000000000000591b
...
- (void)applyParsedProperties:(id)arg1;	// IMP=0x0000000000005432
- (id)description;	// IMP=0x00000000000052ed
