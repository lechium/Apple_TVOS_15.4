...
- (void).cxx_destruct;	// IMP=0x00000000000245c0
...
- (id)initWithURL:(id)arg1 eTag:(id)arg2 dataPayload:(id)arg3 inContainerWithURL:(id)arg4 withAccountInfoProvider:(id)arg5;	// IMP=0x00000000000244da
