...
+ (id)copyParseRules;	// IMP=0x000000000002770d
...
- (_Bool)hasPropertyError;	// IMP=0x00000000000282e1
- (id)successfulPropertiesToValues;	// IMP=0x0000000000027e9d
- (id)firstHref;	// IMP=0x0000000000027e4b
- (void)addHref:(id)arg1;	// IMP=0x0000000000027d89
- (void)addPropStat:(id)arg1;	// IMP=0x0000000000027cc7
- (id)description;	// IMP=0x000000000002748f
- (id)init;	// IMP=0x0000000000027469
