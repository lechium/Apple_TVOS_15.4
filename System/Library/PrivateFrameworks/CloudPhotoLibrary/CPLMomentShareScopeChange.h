...
- (void).cxx_destruct;	// IMP=0x000000000004d5d5
...
- (void)udpateScopeFromScopeChange:(id)arg1 direction:(unsigned long long)arg2 didHaveChanges:(_Bool *)arg3;	// IMP=0x000000000004d241
- (void)setLibraryInfo:(id)arg1;	// IMP=0x000000000004d17c
- (void)setMomentShare:(id)arg1;	// IMP=0x000000000004d161
- (id)momentShare;	// IMP=0x000000000004d12b
