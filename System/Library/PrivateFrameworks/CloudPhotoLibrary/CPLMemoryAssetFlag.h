...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000eb7b5
- (unsigned long long)hash;	// IMP=0x00000000000eb6fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000eb55b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eb47a
- (void)copyTo:(id)arg1;	// IMP=0x00000000000eb3bc
- (void)writeTo:(id)arg1;	// IMP=0x00000000000eb2c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000eb2bc
- (id)dictionaryRepresentation;	// IMP=0x00000000000eb065
- (id)description;	// IMP=0x00000000000eafb6
