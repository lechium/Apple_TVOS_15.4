...
+ (id)taskWithEngineLibrary:(id)arg1 session:(id)arg2;	// IMP=0x00000000000e7045
- (void).cxx_destruct;	// IMP=0x00000000000e6f76
...
- (id)description;	// IMP=0x00000000000e6c52
@property(copy) NSString *phaseDescription; // @synthesize phaseDescription=_phaseDescription;
- (id)phaseDescriptionLastChangeDate:(id *)arg1;	// IMP=0x00000000000e6b16
- (void)taskDidProgress:(float)arg1 userInfo:(id)arg2;	// IMP=0x00000000000e6a97
- (void)taskDidFinishWithError:(id)arg1;	// IMP=0x00000000000e693a
- (void)cancel;	// IMP=0x00000000000e6888
- (void)launch;	// IMP=0x00000000000e67eb
@property(readonly, nonatomic) NSString *taskIdentifier;
- (unsigned long long)diskPressureState;	// IMP=0x00000000000e66b4
- (void)launchTransportTask:(id)arg1 withTransportGroup:(id)arg2;	// IMP=0x00000000000e65d1
- (id)initWithEngineLibrary:(id)arg1 session:(id)arg2;	// IMP=0x00000000000e6507
