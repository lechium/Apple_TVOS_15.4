...
+ (id)_createTestMemoryWithAssets:(id)arg1;	// IMP=0x0000000000054899
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005b107
- (void).cxx_destruct;	// IMP=0x00000000000547e6
...
- (CDUnknownBlockType)checkDefaultValueBlockForPropertyWithSelector:(SEL)arg1;	// IMP=0x00000000000544fb
- (id)propertiesDescription;	// IMP=0x00000000000544b1
- (_Bool)supportsDirectDeletion;	// IMP=0x00000000000544a9
- (_Bool)supportsDeletion;	// IMP=0x00000000000544a1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005a419
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005a407
- (id)translateToClientChangeUsingIDMapping:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000691f0
- (id)translateToCloudChangeUsingIDMapping:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000068eb6
- (id)scopedIdentifiersForMapping;	// IMP=0x0000000000068bfc
