...
+ (unsigned long long)maximumResourceDownloadSizeForResourceType:(unsigned long long)arg1;	// IMP=0x000000000009d464
+ (void)initialize;	// IMP=0x000000000009d391
- (void).cxx_destruct;	// IMP=0x000000000009d0da
...
- (void)noteTaskHasBeenPreempted;	// IMP=0x000000000009cf77
- (void)noteActiveQueuesStatusAtEnqueingTime:(id)arg1;	// IMP=0x000000000009cf43
- (void)noteStateDidProgress:(unsigned long long)arg1;	// IMP=0x000000000009c8cf
@property(readonly, nonatomic) _Bool willGenerateReport;
- (void)cancelTask;	// IMP=0x000000000009c86e
- (void)launch;	// IMP=0x000000000009c855
- (void)associateCloudResource:(id)arg1 ofRecord:(id)arg2;	// IMP=0x000000000009c7db
- (id)initWithResource:(id)arg1 taskIdentifier:(id)arg2 launchHandler:(CDUnknownBlockType)arg3 cancelHandler:(CDUnknownBlockType)arg4 didStartHandler:(CDUnknownBlockType)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x000000000009c477
