...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a9a9b
- (void).cxx_destruct;	// IMP=0x00000000000a9a8b
...
- (id)redactedDescription;	// IMP=0x00000000000a9a65
- (id)description;	// IMP=0x00000000000a99d9
@property(readonly, nonatomic) NSString *statusDescription;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a96a5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a952a
- (id)initWithRecord:(id)arg1 generation:(unsigned long long)arg2;	// IMP=0x00000000000a94b4
