...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005b032
+ (id)cplAdditionalSecureClassesForProperty:(id)arg1;	// IMP=0x000000000005af69
- (void).cxx_destruct;	// IMP=0x00000000001175ad
...
- (id)description;	// IMP=0x0000000000117274
- (unsigned long long)hash;	// IMP=0x0000000000117262
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000117250
- (id)translateToScopeChangeWithScopeType:(long long)arg1;	// IMP=0x00000000001171ff
- (void)updateScopeChange:(id)arg1;	// IMP=0x0000000000116e30
- (id)initWithScopeChange:(id)arg1;	// IMP=0x0000000000116b77
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005a31f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005a2b7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005a2a5
