...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005b447
- (void).cxx_destruct;	// IMP=0x00000000000209af
...
- (id)adjustmentSimpleDescription;	// IMP=0x000000000002082c
- (unsigned long long)hash;	// IMP=0x000000000002081a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000020808
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005a879
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005a811
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005a7ff
