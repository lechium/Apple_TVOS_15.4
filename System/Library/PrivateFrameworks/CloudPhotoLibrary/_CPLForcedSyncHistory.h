...
- (void).cxx_destruct;	// IMP=0x000000000012c026
...
- (id)descriptionWithNow:(id)arg1;	// IMP=0x000000000012be99
- (id)initWithForcedSyncTask:(id)arg1 discarded:(_Bool)arg2 error:(id)arg3;	// IMP=0x000000000012bd84
