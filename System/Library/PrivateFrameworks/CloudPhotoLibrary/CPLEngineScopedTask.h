...
- (void).cxx_destruct;	// IMP=0x00000000000e9d61
...
- (_Bool)checkScopeIsValidInTransaction:(id)arg1;	// IMP=0x00000000000e9967
- (id)initWithEngineLibrary:(id)arg1 session:(id)arg2 clientCacheIdentifier:(id)arg3 scope:(id)arg4 transportScope:(id)arg5;	// IMP=0x00000000000e983c
