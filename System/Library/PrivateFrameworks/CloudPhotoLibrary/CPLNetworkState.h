...
- (void).cxx_destruct;	// IMP=0x000000000003e005
...
- (_Bool)isFunctionallyEqual:(id)arg1;	// IMP=0x000000000003debc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003dd75
- (id)redactedDescription;	// IMP=0x000000000003dd63
@property(readonly, nonatomic) NSDictionary *plistDescription;
- (id)description;	// IMP=0x000000000003d9de
...
- (id)initWithNetworkPath:(id)arg1 cellularRestricted:(_Bool)arg2 inAirplaneMode:(_Bool)arg3;	// IMP=0x000000000003d892
