...
+ (CDUnknownBlockType)copyPropertyBlockForDirection:(unsigned long long)arg1;	// IMP=0x000000000011664c
+ (CDUnknownBlockType)equalityBlockForDirection:(unsigned long long)arg1;	// IMP=0x0000000000116635
+ (_Bool)cplShouldIgnorePropertyForEquality:(id)arg1;	// IMP=0x000000000005b3d5
+ (_Bool)cplShouldIgnorePropertyForCoding:(id)arg1;	// IMP=0x000000000005b363
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000005b35b
+ (_Bool)serverSupportsVision;	// IMP=0x00000000001168ee
+ (Class)relatedRecordClass;	// IMP=0x0000000000146c66
- (void).cxx_destruct;	// IMP=0x0000000000115f7a
...
- (_Bool)isAssetChange;	// IMP=0x00000000001159d6
- (id)scopeIdentifiersForQuarantine;	// IMP=0x00000000001158d6
- (unsigned long long)fullChangeTypeForFullRecord;	// IMP=0x00000000001158cb
- (_Bool)_canLowerQuota;	// IMP=0x0000000000115875
@property(copy, nonatomic) CPLFaceAnalysisReference *faces;
- (_Bool)validateChangeWithError:(id *)arg1;	// IMP=0x0000000000115701
- (_Bool)validateFullRecord;	// IMP=0x00000000001156b9
- (CDUnknownBlockType)checkDefaultValueBlockForPropertyWithSelector:(SEL)arg1;	// IMP=0x0000000000115572
- (_Bool)supportsDeletion;	// IMP=0x000000000011556a
- (_Bool)supportsResourceType:(unsigned long long)arg1;	// IMP=0x000000000011555d
- (_Bool)supportsResources;	// IMP=0x0000000000115555
- (id)allRelatedScopedIdentifiers;	// IMP=0x00000000001150fe
- (long long)dequeueOrder;	// IMP=0x000000000011504c
- (void)copyDerivativesFromRecordIfPossible:(id)arg1;	// IMP=0x00000000001147b4
- (id)resourceForType:(unsigned long long)arg1;	// IMP=0x0000000000114710
- (void)setRelatedIdentifier:(id)arg1;	// IMP=0x00000000001144ef
- (id)relatedIdentifier;	// IMP=0x00000000001144dd
- (void)setMasterScopedIdentifier:(id)arg1;	// IMP=0x0000000000114166
- (id)masterScopedIdentifier;	// IMP=0x00000000001140ca
- (id)propertiesForChangeType:(unsigned long long)arg1;	// IMP=0x000000000011403d
- (id)propertiesDescription;	// IMP=0x00000000001139e3
- (id)init;	// IMP=0x000000000011395b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005a69c
- (id)translateToClientChangeUsingIDMapping:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006a20e
- (id)translateToCloudChangeUsingIDMapping:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006a046
- (id)scopedIdentifiersForMapping;	// IMP=0x0000000000069f8c
- (id)compactedChangeWithRelatedChanges:(id)arg1 isOnlyChange:(_Bool)arg2 fullRecord:(id)arg3 usingStorageView:(id)arg4;	// IMP=0x00000000000ad837
- (_Bool)validateRecordForTracker:(id)arg1;	// IMP=0x00000000000f4f70
