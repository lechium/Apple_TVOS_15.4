...
- (void).cxx_destruct;	// IMP=0x000000000006ea42
@property(nonatomic) __weak id <CPLStatusDelegate> delegate; // @synthesize delegate=_delegate;
- (void)preventDelegateWithDelegationClass:(id)arg1 selector:(SEL)arg2;	// IMP=0x000000000006ea0a
...
- (void)setConnectedToNetwork:(_Bool)arg1 cellularIsRestricted:(_Bool)arg2 inAirplaneMode:(_Bool)arg3;	// IMP=0x000000000006e5ce
...
- (void)setHasCellularBudget:(_Bool)arg1 hasBatteryBudget:(_Bool)arg2 isConstrainedNetwork:(_Bool)arg3 isBudgetValid:(_Bool)arg4;	// IMP=0x000000000006e193
- (id)statusDescription;	// IMP=0x000000000006e0da
- (void)_statusDidChange;	// IMP=0x000000000006df7c
@property(readonly, nonatomic) NSDate *cloudAssetCountPerTypeLastCheckDate;
- (void)setCloudAssetCountPerType:(id)arg1 updateCheckDate:(_Bool)arg2;	// IMP=0x000000000006ddd0
...
- (void)refetchFromDisk;	// IMP=0x000000000006d00c
- (void)checkInitialSyncMarker;	// IMP=0x000000000006cfc1
- (_Bool)_deleteInitialSyncMarkerWithError:(id *)arg1;	// IMP=0x000000000006ce27
- (_Bool)writeInitialSyncMarker:(id *)arg1;	// IMP=0x000000000006cd1c
- (_Bool)_writeInitialSyncMarkerForDate:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006c96e
- (void)_save;	// IMP=0x000000000006c7f1
- (void)_loadIfNecessary;	// IMP=0x000000000006c5c8
- (void)_setObjectInStatus:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000006c510
- (id)initWithClientLibraryBaseURLForCPLEngine:(id)arg1;	// IMP=0x000000000006c4f4
- (id)initWithClientLibraryBaseURL:(id)arg1;	// IMP=0x000000000006c451
