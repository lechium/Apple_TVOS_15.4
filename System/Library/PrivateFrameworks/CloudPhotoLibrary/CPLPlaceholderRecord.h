...
- (void).cxx_destruct;	// IMP=0x0000000000146bca
...
- (id)redactedDescription;	// IMP=0x0000000000146b90
- (id)description;	// IMP=0x0000000000146b4c
@property(readonly, nonatomic) CPLScopedIdentifier *relatedScopedIdentifier;
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000001469c6
- (id)initWithRecordClass:(Class)arg1 scopedIdentifier:(id)arg2 relatedRecordClass:(Class)arg3 relatedIdentifier:(id)arg4;	// IMP=0x0000000000146906
- (id)translateToClientRecordUsingIDMapping:(id)arg1;	// IMP=0x0000000000068a65
- (id)translateToCloudRecordUsingIDMapping:(id)arg1;	// IMP=0x00000000000688cb
