...
{
    GEOMapFeatureTileFinder *_tileFinder;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x0000000000f7c619
- (void)cancel;	// IMP=0x0000000000f7c603
- (id)initWithTileFinder:(id)arg1;	// IMP=0x0000000000f7c598
