...
- (void).cxx_destruct;	// IMP=0x00000000006a3faf
- (unsigned long long)hash;	// IMP=0x00000000006a3ea9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006a3cce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006a3732
- (void)writeTo:(id)arg1;	// IMP=0x00000000006a321e
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006a320f
- (id)jsonRepresentation;	// IMP=0x00000000006a2e8e
- (id)dictionaryRepresentation;	// IMP=0x00000000006a286e
- (id)description;	// IMP=0x00000000006a27bf
- (void)dealloc;	// IMP=0x00000000006a111c
- (id)initWithData:(id)arg1;	// IMP=0x00000000006a10c0
- (id)init;	// IMP=0x00000000006a1064
