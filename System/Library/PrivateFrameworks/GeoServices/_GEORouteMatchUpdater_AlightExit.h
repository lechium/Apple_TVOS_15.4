...
- (id).cxx_construct;	// IMP=0x0000000001047a01
- (void).cxx_destruct;	// IMP=0x000000000104799d
- (_Bool)_isLocationNearAlightNode:(id)arg1;	// IMP=0x0000000001047913
- (_Bool)updateRouteMatch:(id)arg1 previousRouteMatch:(id)arg2 forLocation:(id)arg3;	// IMP=0x000000000104739d
- (id)initWithTransitRouteMatcher:(id)arg1 alightStep:(id)arg2;	// IMP=0x0000000001046f32
