...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000010647f4
- (void).cxx_destruct;	// IMP=0x0000000001064f40
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001064cda
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000010647fc
- (id)description;	// IMP=0x000000000106450e
...
- (unsigned int)duration;	// IMP=0x00000000010643d8
- (_Bool)hasDuration;	// IMP=0x0000000001064325
...
- (id)initWithComposedRoute:(id)arg1 routeSegmentType:(long long)arg2 stepIndex:(unsigned long long)arg3 pointRange:(struct _NSRange)arg4 line:(id)arg5 maneuverType:(int)arg6 significance:(int)arg7;	// IMP=0x0000000001063ee2
- (id)initWithComposedRoute:(id)arg1 decoderData:(id)arg2 step:(id)arg3 stepIndex:(unsigned long long)arg4 duration:(unsigned int)arg5 pointRange:(struct _NSRange)arg6;	// IMP=0x0000000001063292
