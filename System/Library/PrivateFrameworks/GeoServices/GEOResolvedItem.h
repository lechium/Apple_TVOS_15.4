...
- (void).cxx_destruct;	// IMP=0x0000000000371b42
...
- (id)initWithAutocompleteResolvedItem:(id)arg1;	// IMP=0x00000000003719eb
- (id)initWithResolvedItem:(id)arg1;	// IMP=0x0000000000371980
