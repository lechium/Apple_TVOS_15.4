...
- (void).cxx_destruct;	// IMP=0x0000000000d26f71
- (unsigned long long)hash;	// IMP=0x0000000000d26b70
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d267d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d262dd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d25e33
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d25e24
- (id)jsonRepresentation;	// IMP=0x0000000000d23e2c
- (id)dictionaryRepresentation;	// IMP=0x0000000000d2349c
- (id)description;	// IMP=0x0000000000d233ed
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d2158b
- (id)init;	// IMP=0x0000000000d2152f
