...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000f5f50e
- (void).cxx_destruct;	// IMP=0x0000000000f60f70
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000f60ea6
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000f60b8f
- (unsigned long long)hash;	// IMP=0x0000000000f607f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000f604e3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f60198
- (void)copyTo:(id)arg1;	// IMP=0x0000000000f5ff6c
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x0000000000f5ff3b
- (void)clearSensitiveFields:(unsigned long long)arg1;	// IMP=0x0000000000f5fdd9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000f5fa0f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000f5fa00
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000f5f25b
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000f5f249
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000f5ea66
- (id)jsonRepresentation;	// IMP=0x0000000000f5e954
- (id)dictionaryRepresentation;	// IMP=0x0000000000f5e20f
- (id)description;	// IMP=0x0000000000f5e160
...
- (int)StringAsReferenceFrame:(id)arg1;	// IMP=0x0000000000f5ded5
- (id)referenceFrameAsString:(int)arg1;	// IMP=0x0000000000f5de6f
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000f5c797
- (id)init;	// IMP=0x0000000000f5c73b
