...
- (void).cxx_destruct;	// IMP=0x0000000000a13d18
...
- (id)convertToGEOPDResultRefinementMultiSelectElement;	// IMP=0x0000000000a13aea
- (id)initWithResultRefinementMultiSelectElement:(id)arg1;	// IMP=0x0000000000a1397a
@property(readonly, nonatomic) NSString *refinementKey;
- (id)initWithDisplayName:(id)arg1 isSelected:(_Bool)arg2 metadata:(id)arg3 elementType:(unsigned long long)arg4 evChargingConnectorType:(int)arg5 selectionSequenceNumber:(id)arg6;	// IMP=0x0000000000a13735
