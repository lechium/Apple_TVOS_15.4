...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000c2db11
- (void).cxx_destruct;	// IMP=0x0000000000c2f6d2
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000c2f4ab
- (unsigned long long)hash;	// IMP=0x0000000000c2ef4f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c2ec3a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c2e8e1
- (void)copyTo:(id)arg1;	// IMP=0x0000000000c2e6ad
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c2e3a3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c2e394
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000c2ce7a
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000c2ce68
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000c2c62f
- (id)jsonRepresentation;	// IMP=0x0000000000c2c620
- (id)dictionaryRepresentation;	// IMP=0x0000000000c2bf79
- (id)description;	// IMP=0x0000000000c2beca
...
- (int)StringAsTrafficSpeed:(id)arg1;	// IMP=0x0000000000c2b890
- (id)trafficSpeedAsString:(int)arg1;	// IMP=0x0000000000c2b804
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c2a6c6
- (id)init;	// IMP=0x0000000000c2a66a
