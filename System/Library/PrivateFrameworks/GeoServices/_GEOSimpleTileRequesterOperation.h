...
- (void).cxx_destruct;	// IMP=0x000000000104ee6c
...
- (void)dataSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x000000000104d0fe
- (void)dataSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000104cf6f
...
- (double)startTime;	// IMP=0x000000000104cdf2
- (double)elapsed;	// IMP=0x000000000104cda2
- (void)clearAllRelatedOperations;	// IMP=0x000000000104cd70
- (void)cancel;	// IMP=0x000000000104cbc9
- (void)start;	// IMP=0x000000000104c5a4
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000104bde6
- (id)init;	// IMP=0x000000000104bdd8
