...
- (void).cxx_destruct;	// IMP=0x00000000007194dd
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x0000000000719380
- (id)factoidAtIndex:(int)arg1;	// IMP=0x00000000007192d0
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x0000000000718d45
