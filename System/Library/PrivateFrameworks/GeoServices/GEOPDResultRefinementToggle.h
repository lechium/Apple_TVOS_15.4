...
- (void).cxx_destruct;	// IMP=0x0000000000d08c1c
- (unsigned long long)hash;	// IMP=0x0000000000d08af3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d088f3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d0866b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d083f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d083e6
- (id)jsonRepresentation;	// IMP=0x0000000000d082d4
- (id)dictionaryRepresentation;	// IMP=0x0000000000d07d3f
- (id)description;	// IMP=0x0000000000d07c90
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d06e27
- (id)init;	// IMP=0x0000000000d06dcb
