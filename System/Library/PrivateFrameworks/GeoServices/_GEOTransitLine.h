...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000001036f09
- (void).cxx_destruct;	// IMP=0x00000000010370d3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001037033
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001036f11
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x0000000001036a24
