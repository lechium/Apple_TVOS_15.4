...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000089d58b
- (void).cxx_destruct;	// IMP=0x000000000089e31b
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x000000000089e2ca
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000089e0e1
- (unsigned long long)hash;	// IMP=0x000000000089dffe
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000089de51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000089dbd9
- (void)copyTo:(id)arg1;	// IMP=0x000000000089da8a
- (void)writeTo:(id)arg1;	// IMP=0x000000000089d82b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000089d81c
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000089d2d8
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000089d2c6
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000089cf36
- (id)jsonRepresentation;	// IMP=0x000000000089ce24
- (id)dictionaryRepresentation;	// IMP=0x000000000089ca79
- (id)description;	// IMP=0x000000000089c9ca
...
- (id)initWithData:(id)arg1;	// IMP=0x000000000089bb9b
- (id)init;	// IMP=0x000000000089bb3f
