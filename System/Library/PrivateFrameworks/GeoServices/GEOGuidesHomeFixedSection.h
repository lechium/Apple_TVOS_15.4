...
- (void).cxx_destruct;	// IMP=0x00000000010bb0e6
- (id)guideResultsFromMapResults;	// IMP=0x00000000010baed0
...
- (id)initWithGuidesHomeFixedSection:(id)arg1 mapsResults:(id)arg2;	// IMP=0x00000000010ba671
