...
- (void).cxx_destruct;	// IMP=0x000000000113fcba
...
- (id)initWithResultRefinementGroup:(id)arg1;	// IMP=0x000000000113fb60
- (id)initWithResultRefinementBar:(id)arg1 resultRefinementView:(id)arg2 refinementSessionState:(id)arg3;	// IMP=0x000000000113fa89
