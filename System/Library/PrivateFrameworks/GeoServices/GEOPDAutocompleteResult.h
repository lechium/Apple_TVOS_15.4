...
- (void).cxx_destruct;	// IMP=0x00000000004de9b1
- (unsigned long long)hash;	// IMP=0x00000000004de749
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004de36b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004ddcb6
- (void)writeTo:(id)arg1;	// IMP=0x00000000004dcf8b
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004dcf7c
- (id)jsonRepresentation;	// IMP=0x00000000004dc5cc
- (id)dictionaryRepresentation;	// IMP=0x00000000004db6f4
- (id)description;	// IMP=0x00000000004db645
- (id)initWithData:(id)arg1;	// IMP=0x00000000004d96df
- (id)init;	// IMP=0x00000000004d9683
