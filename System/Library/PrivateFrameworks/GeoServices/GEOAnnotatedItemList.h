...
- (void).cxx_destruct;	// IMP=0x0000000000406cc6
...
- (id)initWithAnnotatedItemList:(id)arg1 attribution:(id)arg2;	// IMP=0x0000000000406aab
- (id)initWithPictureItemContainer:(id)arg1 textItemContainer:(id)arg2 title:(id)arg3 annotatedItemStyle:(int)arg4 attribution:(id)arg5;	// IMP=0x00000000004069b7
- (id)init;	// IMP=0x000000000040698d
