...
- (id).cxx_construct;	// IMP=0x000000000104a1ac
- (void).cxx_destruct;	// IMP=0x000000000104a174
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outSegmentCoordinate:(struct PolylineCoordinate *)arg2;	// IMP=0x0000000001049f3b
...
- (id)initWithMap:(id)arg1 edge:(shared_ptr_035a2da2)arg2;	// IMP=0x0000000001049ddc
