...
+ (id)defaultPhotoOptionsWithCropStyle:(long long)arg1;	// IMP=0x00000000003810ff
+ (id)defaultPhotoOptionsWithAllowSmaller:(_Bool)arg1;	// IMP=0x00000000003810c6
...
- (id)initWithAllowSmaller:(_Bool)arg1 cropStyle:(long long)arg2 format:(long long)arg3;	// IMP=0x0000000000381075
