...
- (void).cxx_destruct;	// IMP=0x0000000000ce6394
- (unsigned long long)hash;	// IMP=0x0000000000ce5a74
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ce58c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ce564e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ce51cf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ce51c0
- (id)jsonRepresentation;	// IMP=0x0000000000cdfe78
- (id)dictionaryRepresentation;	// IMP=0x0000000000cdf8fe
- (id)description;	// IMP=0x0000000000cdf84f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cde8be
- (id)init;	// IMP=0x0000000000cde862
