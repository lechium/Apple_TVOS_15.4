...
- (id).cxx_construct;	// IMP=0x0000000000358dad
- (void).cxx_destruct;	// IMP=0x0000000000358d27
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1 outClosestCoordinateOnLine:(CDStruct_c3b9c2ee *)arg2;	// IMP=0x0000000000358af7
...
- (id)initWithMap:(id)arg1 transitEdge:(shared_ptr_24ebf3c0)arg2;	// IMP=0x00000000003585db
