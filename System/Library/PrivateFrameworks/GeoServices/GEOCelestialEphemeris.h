...
- (void).cxx_destruct;	// IMP=0x00000000009c4000
...
- (id)description;	// IMP=0x00000000009c3e91
- (id)initWithLocation:(CDStruct_c3b9c2ee)arg1 julianDay:(double)arg2 body:(long long)arg3 altitude:(double)arg4 useHighPrecision:(_Bool)arg5;	// IMP=0x00000000009c38e5
- (id)initWithLocation:(CDStruct_c3b9c2ee)arg1 date:(id)arg2 body:(long long)arg3 useHighPrecision:(_Bool)arg4;	// IMP=0x00000000009c3807
- (id)initWithLocation:(CDStruct_c3b9c2ee)arg1 date:(id)arg2 body:(long long)arg3;	// IMP=0x00000000009c37ef
