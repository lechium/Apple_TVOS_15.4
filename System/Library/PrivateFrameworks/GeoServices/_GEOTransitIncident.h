...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000001035897
- (void).cxx_destruct;	// IMP=0x0000000001036804
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001035d0a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000010359b2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000103590a
- (id)initWithIncident:(id)arg1;	// IMP=0x000000000103589f
