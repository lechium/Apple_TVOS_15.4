...
- (void).cxx_destruct;	// IMP=0x00000000003f9ca2
- (unsigned long long)hash;	// IMP=0x00000000003f9bf3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003f9ab2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f98b3
- (void)writeTo:(id)arg1;	// IMP=0x00000000003f9674
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003f9665
- (id)jsonRepresentation;	// IMP=0x00000000003f9553
- (id)dictionaryRepresentation;	// IMP=0x00000000003f913f
- (id)description;	// IMP=0x00000000003f9090
- (void)dealloc;	// IMP=0x00000000003f8489
- (id)initWithData:(id)arg1;	// IMP=0x00000000003f842d
- (id)init;	// IMP=0x00000000003f83d1
