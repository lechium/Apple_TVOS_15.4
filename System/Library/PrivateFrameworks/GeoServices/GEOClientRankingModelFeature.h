...
- (void).cxx_destruct;	// IMP=0x00000000011c8889
...
- (id)initWithGEOPDClientRankingFeatureMetadata:(id)arg1;	// IMP=0x00000000011c84ee
- (id)initWithFeatureIdentifier:(id)arg1 function:(id)arg2;	// IMP=0x00000000011c8455
- (id)init;	// IMP=0x00000000011c842b
