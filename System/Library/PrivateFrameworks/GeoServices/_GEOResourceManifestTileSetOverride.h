...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000a21bc6
- (void).cxx_destruct;	// IMP=0x0000000000a21f02
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000a21dca
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a21c67
- (id)initWithStyle:(int)arg1 size:(int)arg2 scale:(int)arg3;	// IMP=0x0000000000a21bf8
- (id)init;	// IMP=0x0000000000a21bce
