...
- (void).cxx_destruct;	// IMP=0x0000000000ecce22
- (unsigned long long)hash;	// IMP=0x0000000000eccb4a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ecc949
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ecc6aa
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ecc3e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ecc3da
- (id)jsonRepresentation;	// IMP=0x0000000000ecc059
- (id)dictionaryRepresentation;	// IMP=0x0000000000ecb9ff
- (id)description;	// IMP=0x0000000000ecb950
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ecaf57
- (id)init;	// IMP=0x0000000000ecaefb
