...
- (void).cxx_destruct;	// IMP=0x0000000000544a90
- (unsigned long long)hash;	// IMP=0x00000000005445c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000054412c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000543c7e
- (void)writeTo:(id)arg1;	// IMP=0x00000000005436c8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005436b9
- (id)jsonRepresentation;	// IMP=0x0000000000543338
- (id)dictionaryRepresentation;	// IMP=0x00000000005423d3
- (id)description;	// IMP=0x0000000000542324
- (id)initWithData:(id)arg1;	// IMP=0x0000000000540519
- (id)init;	// IMP=0x00000000005404bd
