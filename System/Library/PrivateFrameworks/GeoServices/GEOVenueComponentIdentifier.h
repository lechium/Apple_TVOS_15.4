...
- (void).cxx_destruct;	// IMP=0x0000000000c009b9
...
- (id)initWithVenueIdentifier:(id)arg1;	// IMP=0x0000000000c00685
- (id)initWithBuildingID:(unsigned long long)arg1 floorInfo:(id)arg2 fixtureID:(unsigned long long)arg3;	// IMP=0x0000000000c0065b
- (id)initWithBuildingID:(unsigned long long)arg1 floorInfo:(id)arg2 unitID:(unsigned long long)arg3;	// IMP=0x0000000000c00631
- (id)initWithBuildingID:(unsigned long long)arg1 floorInfo:(id)arg2;	// IMP=0x0000000000c005d2
- (id)initWithBuildingID:(unsigned long long)arg1;	// IMP=0x0000000000c005a8
- (id)init;	// IMP=0x0000000000c00569
