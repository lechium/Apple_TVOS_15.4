...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000100ea0e
- (void).cxx_destruct;	// IMP=0x000000000100f949
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000100f7d4
- (unsigned long long)hash;	// IMP=0x000000000100f697
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000100f40a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000100f104
- (void)copyTo:(id)arg1;	// IMP=0x000000000100ef36
- (void)writeTo:(id)arg1;	// IMP=0x000000000100ec83
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000100ec74
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000100e75b
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000100e74e
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000100e214
- (id)jsonRepresentation;	// IMP=0x000000000100e205
- (id)dictionaryRepresentation;	// IMP=0x000000000100deb3
- (id)description;	// IMP=0x000000000100de04
...
- (id)initWithData:(id)arg1;	// IMP=0x000000000100c853
- (id)init;	// IMP=0x000000000100c7f7
