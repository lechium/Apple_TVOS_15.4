...
- (void).cxx_destruct;	// IMP=0x000000000097ab00
...
- (id)publicLogDescription;	// IMP=0x000000000097a8b3
- (id)description;	// IMP=0x000000000097a60a
...
- (id)init;	// IMP=0x000000000097a1d0
- (id)newURLRequest;	// IMP=0x0000000000a329ba
- (id)updatedRequestWithNewProtobufRequest:(id)arg1;	// IMP=0x0000000001295e7c
- (id)updatedRequestWithNewBodyData:(id)arg1;	// IMP=0x0000000001295cce
- (id)initForAnalyticsUploadRequest:(id)arg1 toURL:(id)arg2 requiresProxy:(_Bool)arg3 backgroundIdentifier:(id)arg4 compressRequest:(_Bool)arg5 allowCellular:(_Bool)arg6 allowBattery:(_Bool)arg7 timeToLive:(double)arg8 requestCounterTicket:(id)arg9 throttleToken:(id)arg10;	// IMP=0x0000000001295b51
- (id)initHttpOnlyRequestWithKind:(CDStruct_d1a7ebee)arg1 protobufRequest:(id)arg2 URL:(id)arg3 additionalHTTPHeaders:(id)arg4 needsProxy:(_Bool)arg5 allowCellularUse:(_Bool)arg6 compressRequest:(_Bool)arg7 requestCounterTicket:(id)arg8 multipathServiceType:(unsigned long long)arg9 multipathAlternatePort:(unsigned long long)arg10 throttleToken:(id)arg11;	// IMP=0x00000000012959b3
- (id)initWithKind:(CDStruct_d1a7ebee)arg1 protobufRequest:(id)arg2 URL:(id)arg3 additionalHTTPHeaders:(id)arg4 needsProxy:(_Bool)arg5 auditToken:(id)arg6 timeoutInterval:(double)arg7 traits:(id)arg8 requestCounterTicket:(id)arg9 multipathServiceType:(unsigned long long)arg10 multipathAlternatePort:(unsigned long long)arg11 throttleToken:(id)arg12;	// IMP=0x0000000001295413
