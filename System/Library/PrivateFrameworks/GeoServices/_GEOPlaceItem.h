...
@interface _GEOPlaceItem <GEOMapItem>
{
...
- (void).cxx_destruct;	// IMP=0x000000000081d86f
...
- (id)_placecardLayoutConfiguration;	// IMP=0x000000000081d847
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x000000000081d83f
...
- (id)_yelpID;	// IMP=0x000000000081d534
...
- (id)_urlForWritingAReview;	// IMP=0x000000000081d51c
- (id)_urlForReview:(id)arg1;	// IMP=0x000000000081d514
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x000000000081d50c
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000081d489
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000081d481
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x000000000081d0e4
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x000000000081d0a2
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x000000000081d060
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x000000000081d043
- (int)_recommendedTransportType;	// IMP=0x000000000081d038
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x000000000081d01b
...
- (id)weatherDisplayName;	// IMP=0x000000000081cf73
- (id)addressObject;	// IMP=0x000000000081cec0
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x000000000081c8e1
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x000000000081c824
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x000000000081c640
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x000000000081c567
