...
- (void).cxx_destruct;	// IMP=0x00000000002bc798
...
- (id)description;	// IMP=0x00000000002bbda2
- (unsigned long long)hash;	// IMP=0x00000000002bbd34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002bbccb
- (id)initWithCollection:(id)arg1 usingAttribution:(id)arg2;	// IMP=0x00000000002bb87b
