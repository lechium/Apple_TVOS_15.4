...
+ (_Bool)isValid:(id)arg1;	// IMP=0x00000000006ddf3c
+ (Class)alternateResourcesURLType;	// IMP=0x00000000006d8bea
- (void).cxx_destruct;	// IMP=0x00000000006e1f29
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x00000000006e1953
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000006e0c10
- (unsigned long long)hash;	// IMP=0x00000000006e0627
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006dfb0e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006def7f
- (void)copyTo:(id)arg1;	// IMP=0x00000000006de7ec
- (void)writeTo:(id)arg1;	// IMP=0x00000000006ddf58
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006ddf49
- (void)readAll:(_Bool)arg1;	// IMP=0x00000000006dde30
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000006dde1e
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000006dbc5c
- (id)jsonRepresentation;	// IMP=0x00000000006dbb4a
- (id)dictionaryRepresentation;	// IMP=0x00000000006d999d
- (id)description;	// IMP=0x00000000006d98ee
...
- (id)alternateResourcesURLAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006d8bb9
- (unsigned long long)alternateResourcesURLsCount;	// IMP=0x00000000006d8b8d
- (void)addAlternateResourcesURL:(id)arg1;	// IMP=0x00000000006d8acf
- (void)clearAlternateResourcesURLs;	// IMP=0x00000000006d8a9d
...
- (id)initWithData:(id)arg1;	// IMP=0x00000000006d1761
- (id)init;	// IMP=0x00000000006d1705
