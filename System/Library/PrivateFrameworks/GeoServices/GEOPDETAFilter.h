...
+ (id)_etaFilterWithTransportTypes:(int *)arg1 transportTypesCount:(unsigned long long)arg2 automobileOptions:(id)arg3 transitOptions:(id)arg4 walkingOptions:(id)arg5 cyclingOptions:(id)arg6;	// IMP=0x00000000009d1848
+ (id)etaFilterForRouteAttributes:(id)arg1;	// IMP=0x00000000009d1621
+ (id)etaFilterForTraits:(id)arg1;	// IMP=0x00000000009d13fb
- (void).cxx_destruct;	// IMP=0x0000000000b0828c
- (unsigned long long)hash;	// IMP=0x0000000000b08141
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b07eef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b07c25
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b07981
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b07972
- (id)jsonRepresentation;	// IMP=0x0000000000b07064
- (id)dictionaryRepresentation;	// IMP=0x0000000000b0674b
- (id)description;	// IMP=0x0000000000b0669c
- (void)dealloc;	// IMP=0x0000000000b05391
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b05335
- (id)init;	// IMP=0x0000000000b052d9
