...
- (void).cxx_destruct;	// IMP=0x00000000011647fb
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x0000000001164671
- (id)description;	// IMP=0x00000000011645b7
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x0000000001164512
