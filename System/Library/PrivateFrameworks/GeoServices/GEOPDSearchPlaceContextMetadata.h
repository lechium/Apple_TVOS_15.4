...
- (void).cxx_destruct;	// IMP=0x0000000000bada29
- (unsigned long long)hash;	// IMP=0x0000000000bad939
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bad744
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bad36e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bad01b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bad00c
- (id)jsonRepresentation;	// IMP=0x0000000000bacefa
- (id)dictionaryRepresentation;	// IMP=0x0000000000bac62b
- (id)description;	// IMP=0x0000000000bac57c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bab833
- (id)init;	// IMP=0x0000000000bab7d7
