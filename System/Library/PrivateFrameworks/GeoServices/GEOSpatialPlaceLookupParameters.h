...
- (void).cxx_destruct;	// IMP=0x0000000000a132d1
...
- (id)initWithMapRegion:(id)arg1 poiCategoryFilter:(id)arg2;	// IMP=0x0000000000a131d6
- (id)initWithCoordinate:(CDStruct_c3b9c2ee)arg1 radius:(double)arg2 poiCategoryFilter:(id)arg3;	// IMP=0x0000000000a13129
- (id)initWithCoordinate:(CDStruct_c3b9c2ee)arg1 radius:(double)arg2 categories:(id)arg3 maxResultCount:(int)arg4;	// IMP=0x0000000000a1306d
- (id)initWithCoordinate:(CDStruct_c3b9c2ee)arg1 radius:(double)arg2 categories:(id)arg3;	// IMP=0x0000000000a13056
- (id)init;	// IMP=0x0000000000a1302c
