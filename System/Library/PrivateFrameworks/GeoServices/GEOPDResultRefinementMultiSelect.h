...
- (void).cxx_destruct;	// IMP=0x0000000000cf4fc4
- (unsigned long long)hash;	// IMP=0x0000000000cf4ebe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cf4ce2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cf4927
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cf45d2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cf45c3
- (id)jsonRepresentation;	// IMP=0x0000000000cf4242
- (id)dictionaryRepresentation;	// IMP=0x0000000000cf3ae2
- (id)description;	// IMP=0x0000000000cf3a33
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cf2ab7
- (id)init;	// IMP=0x0000000000cf2a5b
