...
- (id)initWithLocatedInsideInfo:(id)arg1;	// IMP=0x00000000011ffda8
- (id)initWithBusinessID:(unsigned long long)arg1 featureType:(int)arg2;	// IMP=0x00000000011ffd60
- (id)init;	// IMP=0x00000000011ffd36
