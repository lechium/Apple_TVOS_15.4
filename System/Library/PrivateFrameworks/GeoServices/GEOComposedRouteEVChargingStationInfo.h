...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000009a1db5
- (void).cxx_destruct;	// IMP=0x00000000009a1fbe
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009a1ecf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009a1dbd
- (id)description;	// IMP=0x00000000009a1d79
- (id)initWithGeoEVChargingInfo:(id)arg1 muid:(unsigned long long)arg2 name:(id)arg3;	// IMP=0x00000000009a1c84
- (id)init;	// IMP=0x00000000009a1c5a
