...
- (void).cxx_destruct;	// IMP=0x0000000001049d69
...
- (void)removeOldData:(id)arg1;	// IMP=0x0000000001049d2d
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000001049cbd
- (void)cancel;	// IMP=0x0000000001049cb7
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000001049bd5
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x0000000001049a4d
- (id)init;	// IMP=0x0000000001049a23
