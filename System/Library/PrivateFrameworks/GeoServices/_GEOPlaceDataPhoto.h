...
- (void).cxx_destruct;	// IMP=0x0000000000c6f8da
...
- (id)bestPhotoForSize:(struct CGSize)arg1 options:(id)arg2;	// IMP=0x0000000000c6f722
- (id)bestPhotoForFrameSize:(struct CGSize)arg1 displayScale:(double)arg2 options:(id)arg3;	// IMP=0x0000000000c6f6e1
- (id)bestPhotoForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000c6f664
- (id)largestPhoto;	// IMP=0x0000000000c6f64e
...
- (id)initWithPhoto:(id)arg1;	// IMP=0x0000000000c6f3aa
- (id)initWithPhoto:(id)arg1 attribution:(id)arg2;	// IMP=0x0000000000c6f338
- (id)initWithCaptionedPhoto:(id)arg1;	// IMP=0x0000000000c6f24c
- (id)initWithCaptionedPhoto:(id)arg1 attribution:(id)arg2;	// IMP=0x0000000000c6f1da
