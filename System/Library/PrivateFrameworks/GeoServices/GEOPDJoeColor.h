...
- (void).cxx_destruct;	// IMP=0x0000000000b34182
- (unsigned long long)hash;	// IMP=0x0000000000b340a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b33ef2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b33c71
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b33a45
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b33a36
- (id)jsonRepresentation;	// IMP=0x0000000000b33924
- (id)dictionaryRepresentation;	// IMP=0x0000000000b33340
- (id)description;	// IMP=0x0000000000b33291
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b32742
- (id)init;	// IMP=0x0000000000b326e6
