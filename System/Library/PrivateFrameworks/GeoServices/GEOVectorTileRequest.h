...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000d7cb95
- (void).cxx_destruct;	// IMP=0x0000000000d7e49f
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000d7e283
- (unsigned long long)hash;	// IMP=0x0000000000d7de76
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d7daba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d7d739
- (void)copyTo:(id)arg1;	// IMP=0x0000000000d7d4c1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d7d155
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d7d148
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000d7c94a
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000d7c938
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000d7c1c8
- (id)jsonRepresentation;	// IMP=0x0000000000d7c1b9
- (id)dictionaryRepresentation;	// IMP=0x0000000000d7bba9
- (id)description;	// IMP=0x0000000000d7bafa
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d7a438
- (id)init;	// IMP=0x0000000000d7a3dc
