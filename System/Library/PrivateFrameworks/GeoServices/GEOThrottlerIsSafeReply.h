...
- (void).cxx_destruct;	// IMP=0x000000000040697a
...
- (_Bool)isValid;	// IMP=0x0000000000406909
- (void)encodeToXPCDictionary:(id)arg1;	// IMP=0x0000000000406801
- (id)initWithXPCDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004066ad
