...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000394305
- (void).cxx_destruct;	// IMP=0x00000000003952b4
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x00000000003951bd
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000394f04
- (unsigned long long)hash;	// IMP=0x0000000000394ddc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000394ba5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003948d9
- (void)copyTo:(id)arg1;	// IMP=0x000000000039474e
- (void)writeTo:(id)arg1;	// IMP=0x00000000003944e4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003944d5
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000393f5d
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000393f4b
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000003939ea
- (id)jsonRepresentation;	// IMP=0x00000000003938d8
- (id)dictionaryRepresentation;	// IMP=0x0000000000393349
- (id)description;	// IMP=0x000000000039329a
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000391da5
- (id)init;	// IMP=0x0000000000391d49
