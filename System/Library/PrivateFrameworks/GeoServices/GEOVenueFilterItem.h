...
- (void).cxx_destruct;	// IMP=0x0000000000ffa8aa
...
- (id)initWithFilterElementInfo:(id)arg1;	// IMP=0x0000000000ffa787
- (id)initWithLabel:(id)arg1 filterID:(id)arg2;	// IMP=0x0000000000ffa6ea
- (id)init;	// IMP=0x0000000000ffa6c0
