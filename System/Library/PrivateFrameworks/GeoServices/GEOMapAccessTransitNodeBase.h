...
- (id).cxx_construct;	// IMP=0x000000000035739d
- (void).cxx_destruct;	// IMP=0x0000000000357355
...
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000357316
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x00000000003572db
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000035703b
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *internalName;
@property(readonly, nonatomic) unsigned long long transitID;
@property(readonly, nonatomic) CDStruct_c3b9c2ee coordinate;
- (void)dealloc;	// IMP=0x0000000000356f11
- (id)initWithMap:(id)arg1 node:(shared_ptr_52e51bdf)arg2;	// IMP=0x0000000000356e22
