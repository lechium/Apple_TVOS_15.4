...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000132c204
- (void).cxx_destruct;	// IMP=0x000000000132d01d
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000132cef5
- (unsigned long long)hash;	// IMP=0x000000000132cc25
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000132ca39
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000132c7c3
- (void)copyTo:(id)arg1;	// IMP=0x000000000132c652
- (void)writeTo:(id)arg1;	// IMP=0x000000000132c416
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000132c407
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000132be25
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000132be13
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000132ba01
- (id)jsonRepresentation;	// IMP=0x000000000132b9f2
- (id)dictionaryRepresentation;	// IMP=0x000000000132b6bc
- (id)description;	// IMP=0x000000000132b60d
...
- (id)initWithData:(id)arg1;	// IMP=0x000000000132a892
- (id)init;	// IMP=0x000000000132a836
