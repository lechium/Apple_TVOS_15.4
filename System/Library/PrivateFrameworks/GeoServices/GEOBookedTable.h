...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000114b0ea
- (void).cxx_destruct;	// IMP=0x000000000114c491
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000114c2b0
- (unsigned long long)hash;	// IMP=0x000000000114c09f
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000114bcfb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000114baff
- (void)copyTo:(id)arg1;	// IMP=0x000000000114b91e
- (void)writeTo:(id)arg1;	// IMP=0x000000000114b717
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000114b708
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000114a5c0
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000114a5ae
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000001149f05
- (id)jsonRepresentation;	// IMP=0x0000000001149ef6
- (id)dictionaryRepresentation;	// IMP=0x000000000114993e
- (id)description;	// IMP=0x000000000114988f
