...
+ (_Bool)isValid:(id)arg1;	// IMP=0x00000000014bcc2e
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000014be2ac
- (unsigned long long)hash;	// IMP=0x00000000014bd653
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000014bd2a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000014bd09c
- (void)copyTo:(id)arg1;	// IMP=0x00000000014bce83
- (void)writeTo:(id)arg1;	// IMP=0x00000000014bcc4a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000014bcc3b
- (void)readAll:(_Bool)arg1;	// IMP=0x00000000014bcbce
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000014bcbbc
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000014bc247
- (id)jsonRepresentation;	// IMP=0x00000000014bc238
- (id)dictionaryRepresentation;	// IMP=0x00000000014bbaae
- (id)description;	// IMP=0x00000000014bb9ff
- (int)StringAsResourceFetchType:(id)arg1;	// IMP=0x00000000014bb950
- (id)resourceFetchTypeAsString:(int)arg1;	// IMP=0x00000000014bb8d3
...
- (int)StringAsProtocolName:(id)arg1;	// IMP=0x00000000014bb68c
- (id)protocolNameAsString:(int)arg1;	// IMP=0x00000000014bb5e8
...
- (id)initWithClientNetworkTransactionMetrics:(id)arg1;	// IMP=0x0000000000cb3368
