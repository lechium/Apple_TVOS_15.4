...
@interface GEORouteBuilderOutput : NSObject
{
    ...
    double _distance;	// 88 = 0x58
    _Bool _usesZilch;	// 96 = 0x60
    NSArray *_cameraInfos;	// 104 = 0x68
    NSArray *_roadComplexities;	// 112 = 0x70
}

- (void).cxx_destruct;	// IMP=0x0000000000dd6df1
