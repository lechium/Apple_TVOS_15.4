...
- (void).cxx_destruct;	// IMP=0x00000000005de177
- (unsigned long long)hash;	// IMP=0x00000000005ddd36
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005dd713
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005dd158
- (void)writeTo:(id)arg1;	// IMP=0x00000000005dcbc5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005dcbb6
- (id)jsonRepresentation;	// IMP=0x00000000005dcaa4
- (id)dictionaryRepresentation;	// IMP=0x00000000005dadf8
- (id)description;	// IMP=0x00000000005dad49
- (void)dealloc;	// IMP=0x00000000005d76eb
- (id)initWithData:(id)arg1;	// IMP=0x00000000005d768f
- (id)init;	// IMP=0x00000000005d7633
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 traits:(id)arg7;	// IMP=0x0000000001203fbf
