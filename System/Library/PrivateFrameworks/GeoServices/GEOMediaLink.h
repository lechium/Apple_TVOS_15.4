...
+ (id)mediaLinkFromProto:(id)arg1;	// IMP=0x00000000009ff97b
- (void).cxx_destruct;	// IMP=0x00000000009ffdac
...
- (id)initWithAdamID:(id)arg1 mediaType:(int)arg2 mediaSubType:(int)arg3 thirdPartyLinks:(id)arg4 relatedCollectionItemIndex:(long long)arg5 position:(unsigned long long)arg6;	// IMP=0x00000000009ffc9a
