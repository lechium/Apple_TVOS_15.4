...
+ (_Bool)isValid:(id)arg1;	// IMP=0x00000000014b2956
- (void).cxx_destruct;	// IMP=0x00000000014b3780
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000014b35f0
- (unsigned long long)hash;	// IMP=0x00000000014b3185
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000014b2ec9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000014b2d35
- (void)copyTo:(id)arg1;	// IMP=0x00000000014b2bbc
- (void)writeTo:(id)arg1;	// IMP=0x00000000014b2972
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000014b2963
- (void)readAll:(_Bool)arg1;	// IMP=0x00000000014b28f6
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000014b28e4
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000014b2350
- (id)jsonRepresentation;	// IMP=0x00000000014b2341
- (id)dictionaryRepresentation;	// IMP=0x00000000014b1ec9
- (id)description;	// IMP=0x00000000014b1e1a
