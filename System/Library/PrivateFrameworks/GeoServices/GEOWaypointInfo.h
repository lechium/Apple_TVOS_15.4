...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000096b594
- (void).cxx_destruct;	// IMP=0x000000000096c295
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x000000000096c1b4
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000096bf35
- (unsigned long long)hash;	// IMP=0x000000000096be31
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000096bc3b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000096b99b
- (void)copyTo:(id)arg1;	// IMP=0x000000000096b82b
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x000000000096b7fa
- (void)writeTo:(id)arg1;	// IMP=0x000000000096b5b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000096b5a1
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000096b488
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000096b476
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000096afdd
- (id)jsonRepresentation;	// IMP=0x000000000096aecb
- (id)dictionaryRepresentation;	// IMP=0x000000000096aa19
- (id)description;	// IMP=0x000000000096a96a
...
- (id)initWithData:(id)arg1;	// IMP=0x000000000096960a
- (id)init;	// IMP=0x00000000009695ae
