...
- (void).cxx_destruct;	// IMP=0x00000000006ea848
...
- (void)encodeToXPCDictionary:(id)arg1;	// IMP=0x00000000006ea5f8
- (id)initWithXPCDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006ea3c3
