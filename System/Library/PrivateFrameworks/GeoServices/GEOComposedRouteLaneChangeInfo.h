...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000f0062b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f006de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000f00633
- (id)description;	// IMP=0x0000000000f005a5
- (id)initWithGeoLaneChangeInfo:(id)arg1 coordinates:(id)arg2;	// IMP=0x0000000000f008c5
