...
- (_Bool)contains:(id)arg1;	// IMP=0x000000000103696d
@property(readonly, nonatomic) NSDate *endDate;
@property(readonly, nonatomic) NSDate *startDate;
@property(readonly, nonatomic) double duration;
@property(readonly, nonatomic) double startTime;
- (id)initWithPDTimeRange:(struct GEOPDTimeRange)arg1;	// IMP=0x0000000001036860
- (id)initWithPBTimeRange:(struct GEOPBTransitTimeRange)arg1;	// IMP=0x0000000001036814
