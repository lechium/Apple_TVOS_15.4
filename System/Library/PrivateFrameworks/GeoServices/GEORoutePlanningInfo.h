...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000090b755
- (void).cxx_destruct;	// IMP=0x000000000090c6b2
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x000000000090c5c3
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000090c34d
- (unsigned long long)hash;	// IMP=0x000000000090c286
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000090c0c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000090be4e
- (void)copyTo:(id)arg1;	// IMP=0x000000000090bd00
- (void)writeTo:(id)arg1;	// IMP=0x000000000090b9d7
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000090b9c8
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000090b4a2
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000090b490
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000090b00c
- (id)jsonRepresentation;	// IMP=0x000000000090aefa
- (id)dictionaryRepresentation;	// IMP=0x000000000090aa21
- (id)description;	// IMP=0x000000000090a972
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000909731
- (id)init;	// IMP=0x00000000009096d5
