...
- (void).cxx_destruct;	// IMP=0x0000000000effb16
@property(retain, nonatomic) GEOTransitRouteUpdateResponse *response; // @synthesize response=_response;
- (_Bool)isValid;	// IMP=0x0000000000effa85
- (void)encodeToXPCDictionary:(id)arg1;	// IMP=0x0000000000eff9c1
- (id)initWithXPCDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000eff8c7
