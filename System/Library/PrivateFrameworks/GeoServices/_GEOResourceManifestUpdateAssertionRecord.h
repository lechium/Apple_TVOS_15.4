...
- (void).cxx_destruct;	// IMP=0x0000000000a3ec4c
...
- (id)initWithProcess:(id)arg1 reason:(id)arg2 creationTimestamp:(double)arg3;	// IMP=0x0000000000a3eabe
- (id)init;	// IMP=0x0000000000a3ea94
