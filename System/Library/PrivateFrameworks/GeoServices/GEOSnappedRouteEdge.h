...
- (id).cxx_construct;	// IMP=0x0000000000a14e6c
- (void).cxx_destruct;	// IMP=0x0000000000a14e2d
...
- (id)description;	// IMP=0x0000000000a14ceb
...
- (void)calculateRouteOffsetsBetweenA:(struct PolylineCoordinate)arg1 andB:(struct PolylineCoordinate)arg2 overLength:(float)arg3 onRoute:(id)arg4;	// IMP=0x0000000000a14595
- (id)initWithRoadPath:(const void *)arg1 sectionRect:(const CDStruct_90e2a262 *)arg2;	// IMP=0x0000000000a13d4c
