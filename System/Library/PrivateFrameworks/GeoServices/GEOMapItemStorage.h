...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000f297a9
+ (Class)additionalPlaceDatasType;	// IMP=0x0000000000f28300
+ (id)mapItemStorageForCoordinate:(CDStruct_c3b9c2ee)arg1;	// IMP=0x0000000000cc19d3
+ (id)mapItemStorageForPlaceData:(id)arg1 detourInfo:(id)arg2 userValues:(id)arg3;	// IMP=0x0000000000cc1933
+ (id)mapItemStorageForPlaceData:(id)arg1 detourInfo:(id)arg2;	// IMP=0x0000000000cc18ab
+ (id)mapItemStorageForPlaceData:(id)arg1;	// IMP=0x0000000000cc1845
+ (id)mapItemStorageForPlaceResult:(id)arg1;	// IMP=0x0000000000cc17f8
+ (id)mapItemStorageForPlace:(id)arg1 clientAttributes:(id)arg2 userValues:(id)arg3;	// IMP=0x0000000000cc1763
+ (id)mapItemStorageForPlace:(id)arg1 clientAttributes:(id)arg2;	// IMP=0x0000000000cc16f0
+ (id)mapItemStorageForPlace:(id)arg1;	// IMP=0x0000000000cc169e
+ (id)mapItemStorageForSerializedPlaceData:(id)arg1 serializedDetourInfo:(id)arg2;	// IMP=0x0000000000cc1592
+ (id)mapItemStorageForSerializedPlaceData:(id)arg1;	// IMP=0x0000000000cc157e
+ (id)mapItemStorageForSerializedMapItemStorage:(id)arg1;	// IMP=0x0000000000cc13e9
+ (id)mapItemStorageForGEOMapItem:(id)arg1 forUseType:(unsigned long long)arg2;	// IMP=0x0000000000cbe1c2
+ (id)mapItemStorageForGEOMapItem:(id)arg1 clientAttributes:(id)arg2;	// IMP=0x0000000000cbe104
+ (id)mapItemStorageForGEOMapItem:(id)arg1;	// IMP=0x0000000000cbdd58
- (void).cxx_destruct;	// IMP=0x0000000000f2b89f
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000f2b69e
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000f2b29e
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000f2af19
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f2aade
- (void)copyTo:(id)arg1;	// IMP=0x0000000000f2a8b4
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x0000000000f2a684
- (void)clearSensitiveFields:(unsigned long long)arg1;	// IMP=0x0000000000f2a166
- (void)writeTo:(id)arg1;	// IMP=0x0000000000f29cbb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000f29cac
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000f2934f
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000f2933d
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000f28bf9
- (id)jsonRepresentation;	// IMP=0x0000000000f28ae7
- (id)dictionaryRepresentation;	// IMP=0x0000000000f283c0
@property(readonly, copy) NSString *description;
- (id)additionalPlaceDatasAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000f282cf
- (unsigned long long)additionalPlaceDatasCount;	// IMP=0x0000000000f282a3
- (void)addAdditionalPlaceDatas:(id)arg1;	// IMP=0x0000000000f281ed
- (void)clearAdditionalPlaceDatas;	// IMP=0x0000000000f281c3
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000f26725
- (id)init;	// IMP=0x0000000000f266b9
...
- (id)_bestHeroBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000cc5a27
- (id)_bestNavbarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000cc59b1
- (id)_bestAvatarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000cc593b
...
- (id)weatherDisplayName;	// IMP=0x0000000000cc54f7
- (id)shortAddress;	// IMP=0x0000000000cc5326
- (id)addressObject;	// IMP=0x0000000000cc52d6
...
- (id)_firstRelatedPlaceListForType:(int)arg1;	// IMP=0x0000000000cc5193
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000cc5134
...
- (id)_asPlaceInfo;	// IMP=0x0000000000cc4c20
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000cc4365
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000cc4306
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000cc3a81
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000cc39fe
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x0000000000cc2791
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (id)_geoMapItem;	// IMP=0x0000000000cc2696
- (id)_geoMapItemCreatingAndAssociatingIfNeeded;	// IMP=0x0000000000cc230f
- (id)initWithPlaceData:(id)arg1 detourInfo:(id)arg2 clientAttributes:(id)arg3 userValues:(id)arg4 additionalPlaceDatas:(id)arg5;	// IMP=0x0000000000cc212d
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x0000000000cc2031
- (id)initWithPlace:(id)arg1 clientAttributes:(id)arg2 userValues:(id)arg3;	// IMP=0x0000000000cc1edc
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000000cc1e8c
...
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000000cc1a4d
- (void)initAdditionalFields;	// IMP=0x0000000000cc69e6
