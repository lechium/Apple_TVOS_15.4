...
- (void).cxx_destruct;	// IMP=0x0000000000371774
...
- (void)dealloc;	// IMP=0x0000000000371451
- (id)initWithDelegate:(id)arg1 andInitialTTL:(double)arg2;	// IMP=0x00000000003712b6
