...
- (void).cxx_destruct;	// IMP=0x0000000000b92845
- (unsigned long long)hash;	// IMP=0x0000000000b92737
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b9255a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b920b0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b91cae
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b91c9f
- (id)jsonRepresentation;	// IMP=0x0000000000b913f2
- (id)dictionaryRepresentation;	// IMP=0x0000000000b90a81
- (id)description;	// IMP=0x0000000000b909d2
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b8f61c
- (id)init;	// IMP=0x0000000000b8f5c0
- (id)publisherDescription;	// IMP=0x00000000009cf978
