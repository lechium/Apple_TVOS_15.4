...
- (id)_bestHeroBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000fd10d3
- (id)_bestNavbarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000fd10cb
- (id)_bestAvatarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000fd10c3
...
- (id)weatherDisplayName;	// IMP=0x0000000000fd1020
- (id)shortAddress;	// IMP=0x0000000000fd1018
- (id)addressObject;	// IMP=0x0000000000fd1010
...
- (id)_firstRelatedPlaceListForType:(int)arg1;	// IMP=0x0000000000fd0ff0
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000fd0fe8
...
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000000fd0f4f
...
- (id)_asPlaceInfo;	// IMP=0x0000000000fd0f2f
...
- (int)_recommendedTransportType;	// IMP=0x0000000000fd0edc
...
- (id)_urlForWritingAReview;	// IMP=0x0000000000fd0ec4
- (id)_urlForReview:(id)arg1;	// IMP=0x0000000000fd0ebc
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x0000000000fd0eb4
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000fd0e51
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000fd0e49
...
- (void)loadTransitAttributionDetails:(CDUnknownBlockType)arg1;	// IMP=0x0000000000fd0ce2
- (id)_transitAttributionSummaries;	// IMP=0x0000000000fd0cda
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000fd0c5e
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x0000000000fd0c56
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x0000000000fd0c4e
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000fd0c46
...
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x0000000000fd0c03
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x0000000000fd0ad8
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000000fd0a99
