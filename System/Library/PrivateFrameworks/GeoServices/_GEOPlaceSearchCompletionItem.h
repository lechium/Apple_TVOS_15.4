...
- (void).cxx_destruct;	// IMP=0x000000000070c9cb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000070c5bd
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x000000000070c4c7
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x000000000070c355
...
- (id)calloutTitle;	// IMP=0x000000000070bfb6
- (id)queryLine;	// IMP=0x000000000070be97
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x000000000070be48
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x000000000070a884
