...
+ (_Bool)isDataItemValid:(id)arg1;	// IMP=0x00000000011f6fbc
- (void).cxx_destruct;	// IMP=0x00000000011f7358
...
- (id)initWithDataItem:(id)arg1 timeZone:(id)arg2 attributionMap:(id)arg3;	// IMP=0x00000000011f7088
