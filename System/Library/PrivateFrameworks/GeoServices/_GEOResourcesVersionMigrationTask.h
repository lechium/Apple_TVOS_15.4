...
+ (id)_resourcesDirectory:(id)arg1;	// IMP=0x00000000009bde26
+ (Class)_resourceLoaderClass;	// IMP=0x00000000009bde15
- (void).cxx_destruct;	// IMP=0x00000000009c17eb
...
- (id)_staleResourceForResource:(id)arg1;	// IMP=0x00000000009c0643
- (void)_loadImmediateResources:(id)arg1 conditionalWifiResources:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000009bfdc7
- (void)removeOldData:(id)arg1;	// IMP=0x00000000009bf4dd
- (void)populateTileGroup:(id)arg1;	// IMP=0x00000000009bf1b3
- (void)cancel;	// IMP=0x00000000009bef94
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000009bde7f
- (id)_resourcesDirectory;	// IMP=0x00000000009bde57
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 dataSet:(id)arg5 oldTileGroup:(id)arg6 activeScales:(id)arg7 activeScenarios:(id)arg8;	// IMP=0x00000000009bdb5f
- (id)init;	// IMP=0x00000000009bdb35
