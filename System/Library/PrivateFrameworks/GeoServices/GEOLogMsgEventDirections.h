...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000001334820
+ (Class)waypointsType;	// IMP=0x00000000013313cd
+ (Class)durationInNavigationModeType;	// IMP=0x0000000001330a29
+ (Class)directionsFeedbackType;	// IMP=0x00000000013304af
- (void).cxx_destruct;	// IMP=0x000000000133769e
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000001336f38
- (unsigned long long)hash;	// IMP=0x000000000133698f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001336212
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001335902
- (void)copyTo:(id)arg1;	// IMP=0x000000000133533e
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x0000000001335058
- (void)clearSensitiveFields:(unsigned long long)arg1;	// IMP=0x0000000001335046
- (void)writeTo:(id)arg1;	// IMP=0x000000000133483c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000133482d
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000001334714
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000001334702
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000013330cb
- (id)jsonRepresentation;	// IMP=0x00000000013330bc
- (id)dictionaryRepresentation;	// IMP=0x0000000001331c19
- (id)description;	// IMP=0x0000000001331b6a
@property(nonatomic) _Bool hasHFPEnabled;
@property(nonatomic) _Bool hFPEnabled;
- (int)StringAsVoiceGuidanceLevel:(id)arg1;	// IMP=0x0000000001331a54
- (id)voiceGuidanceLevelAsString:(int)arg1;	// IMP=0x00000000013319d7
...
- (int)StringAsActiveNavMode:(id)arg1;	// IMP=0x000000000133177c
- (id)activeNavModeAsString:(int)arg1;	// IMP=0x00000000013316d5
...
- (id)waypointsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000133139c
- (unsigned long long)waypointsCount;	// IMP=0x0000000001331370
- (void)addWaypoints:(id)arg1;	// IMP=0x00000000013312bb
- (void)clearWaypoints;	// IMP=0x0000000001331292
...
- (id)durationInNavigationModeAtIndex:(unsigned long long)arg1;	// IMP=0x00000000013309f8
- (unsigned long long)durationInNavigationModesCount;	// IMP=0x00000000013309cc
- (void)addDurationInNavigationMode:(id)arg1;	// IMP=0x0000000001330917
- (void)clearDurationInNavigationModes;	// IMP=0x00000000013308ee
...
- (id)directionsFeedbackAtIndex:(unsigned long long)arg1;	// IMP=0x000000000133047e
- (unsigned long long)directionsFeedbacksCount;	// IMP=0x0000000001330452
- (void)addDirectionsFeedback:(id)arg1;	// IMP=0x000000000133039d
- (void)clearDirectionsFeedbacks;	// IMP=0x0000000001330374
@property(retain, nonatomic) NSMutableArray *directionsFeedbacks;
- (id)initWithData:(id)arg1;	// IMP=0x000000000132e3f2
- (id)init;	// IMP=0x000000000132e396
