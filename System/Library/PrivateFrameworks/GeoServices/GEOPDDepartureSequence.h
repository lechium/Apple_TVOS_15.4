...
- (void).cxx_destruct;	// IMP=0x0000000000afc521
- (unsigned long long)hash;	// IMP=0x0000000000afc0e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000afbe1a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000afb89a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000afb23f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000afb230
- (id)jsonRepresentation;	// IMP=0x0000000000af9c45
- (id)dictionaryRepresentation;	// IMP=0x0000000000af91a3
- (id)description;	// IMP=0x0000000000af90f4
- (void)dealloc;	// IMP=0x0000000000af717e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000af7122
- (id)init;	// IMP=0x0000000000af70c6
