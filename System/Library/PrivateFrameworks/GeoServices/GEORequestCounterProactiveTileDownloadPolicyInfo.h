...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000311ef1
- (void).cxx_destruct;	// IMP=0x000000000031225a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000031213b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000311fce
- (id)initWithPolicy:(unsigned char)arg1 startTimestamp:(id)arg2 endTimestamp:(id)arg3 tilesConsidered:(unsigned long long)arg4 successCount:(unsigned long long)arg5 failureCount:(unsigned long long)arg6 bytesDownloaded:(unsigned long long)arg7;	// IMP=0x0000000000311ef9
