...
@interface GEOURLBackedMapItem <GEOMapItemStorageSerializable>
{
    NSURL *_url;	// 8 = 0x8
    GEOURLExtraStorage *_extraStorage;	// 16 = 0x10
    GEOFeatureStyleAttributes *_styleAttributes;	// 24 = 0x18
    GEOMapItemIdentifier *_identifier;	// 32 = 0x20
    CDStruct_2c43369c _coordinate;	// 40 = 0x28
    _Bool _hasMUID;	// 56 = 0x38
    unsigned long long _muid;	// 64 = 0x40
    GEOAddress *_geoAddress;	// 72 = 0x48
    NSString *_name;	// 80 = 0x50
}

+ (_Bool)urlContainsExtraStorage:(id)arg1;	// IMP=0x0000000000f7b72d
- (void).cxx_destruct;	// IMP=0x0000000000f7bd32
...
- (id)mapItemStorageForGEOMapItem;	// IMP=0x0000000000f7bbd3
...
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000f7b7f9
- (id)init;	// IMP=0x0000000000f7b7cf
