...
- (void).cxx_destruct;	// IMP=0x0000000000fca914
...
- (id)description;	// IMP=0x0000000000fca68c
- (_Bool)dataModelIsValid:(id)arg1;	// IMP=0x0000000000fca5c0
- (id)initWithMapsSearchHomeSection:(id)arg1 mapsResults:(id)arg2;	// IMP=0x0000000000fc9e4c
