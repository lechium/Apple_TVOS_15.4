...
- (void).cxx_destruct;	// IMP=0x000000000107034e
- (void)performHandler:(_Bool)arg1;	// IMP=0x000000000107024b
- (id)initWithQueue:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000001070161
