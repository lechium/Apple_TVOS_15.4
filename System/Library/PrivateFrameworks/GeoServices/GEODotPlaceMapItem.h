...
@class GEOAddress, GEOAppleRating, GEOAssociatedApp, GEODotPlace, GEOEnclosingPlace, GEOEnhancedPlacement, GEOExploreGuides, GEOFeatureStyleAttributes, GEOLabelGeometry, GEOMapItemClientAttributes, GEOMapItemContainedPlace, GEOMapItemDetourInfo, GEOMapItemIdentifier, GEOMapItemPhotosAttribution, GEOMapItemPlaceAttribution, GEOMapItemReviewsAttribution, GEOMapRegion, GEOMessageLink, GEOMiniBrowseCategories, GEOPDBusinessClaim, GEOPDFlyover, GEOPDPlace, GEOPlace, GEOPlaceQuestionnaire, GEOPlaceResult, GEOPlacecardLayoutData, GEOPriceDescription, GEORestaurantFeaturesLink, GEOStyleAttributes, GEOViewportFrame, NSArray, NSData, NSDate, NSDictionary, NSString, NSTimeZone, NSURL;
...
@interface GEODotPlaceMapItem <GEOMapItem>
{
    GEODotPlace *_dotPlace;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x00000000009ae9fd
...
- (id)initWithDotPlace:(id)arg1;	// IMP=0x00000000009ae7ac
- (id)init;	// IMP=0x00000000009ae782
