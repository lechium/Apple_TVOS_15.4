...
+ (id)messageLinkForPlaceData:(id)arg1;	// IMP=0x00000000009cf042
- (void).cxx_destruct;	// IMP=0x0000000000b4a29f
- (unsigned long long)hash;	// IMP=0x0000000000b4a17f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b49f62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b49b66
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b497f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b497e2
- (id)jsonRepresentation;	// IMP=0x0000000000b49608
- (id)dictionaryRepresentation;	// IMP=0x0000000000b48f5e
- (id)description;	// IMP=0x0000000000b48eaf
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b47a12
- (id)init;	// IMP=0x0000000000b479b6
