...
- (void).cxx_destruct;	// IMP=0x0000000000359020
...
- (void *)get;	// IMP=0x0000000000358edb
- (void)dealloc;	// IMP=0x0000000000358ea4
- (id)init:(void *)arg1 withVectorTile:(id)arg2;	// IMP=0x0000000000358dd8
