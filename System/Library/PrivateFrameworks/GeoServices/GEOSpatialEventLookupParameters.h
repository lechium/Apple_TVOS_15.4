...
- (void).cxx_destruct;	// IMP=0x0000000000a13466
...
- (id)initWithCoordinate:(CDStruct_c3b9c2ee)arg1 radius:(double)arg2 categories:(id)arg3 dateInterval:(id)arg4 maxResultCount:(int)arg5;	// IMP=0x0000000000a13346
- (id)initWithCoordinate:(CDStruct_c3b9c2ee)arg1 radius:(double)arg2 categories:(id)arg3 dateInterval:(id)arg4;	// IMP=0x0000000000a1332e
- (id)init;	// IMP=0x0000000000a13304
