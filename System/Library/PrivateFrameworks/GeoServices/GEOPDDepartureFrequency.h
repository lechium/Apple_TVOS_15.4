...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000af560c
- (void).cxx_destruct;	// IMP=0x0000000000af602e
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000af5fe8
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000af5ef5
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000af5ca3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000af5b9a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000af5abc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000af59b3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000af59a4
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000af4ff9
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000af4fe7
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000af4c96
- (id)jsonRepresentation;	// IMP=0x0000000000af4b84
- (id)dictionaryRepresentation;	// IMP=0x0000000000af47c4
...
- (_Bool)isValidAtDate:(id)arg1;	// IMP=0x0000000001038a5c
