...
- (void).cxx_destruct;	// IMP=0x00000000007d5778
...
- (void)motionContextProvider:(id)arg1 didUpdateMotion:(unsigned long long)arg2 exitType:(unsigned long long)arg3 confidence:(unsigned long long)arg4;	// IMP=0x00000000007d5563
...
- (void)stopMotionUpdates;	// IMP=0x00000000007d54ef
- (void)startMotionUpdatesWithProvider:(id)arg1;	// IMP=0x00000000007d548e
- (void)dealloc;	// IMP=0x00000000007d5450
