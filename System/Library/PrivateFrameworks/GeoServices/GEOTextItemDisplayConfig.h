...
- (id)initWithTextItemDisplayConfig:(id)arg1;	// IMP=0x0000000001165d75
- (id)initWithMaxItemsPerRow:(unsigned int)arg1 maxRowCount:(unsigned int)arg2;	// IMP=0x0000000001165d2f
- (id)init;	// IMP=0x0000000001165d05
