...
- (void).cxx_destruct;	// IMP=0x00000000004f7263
- (unsigned long long)hash;	// IMP=0x00000000004f6d8c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004f69c6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004f65d1
- (void)writeTo:(id)arg1;	// IMP=0x00000000004f60cf
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004f60c0
- (id)jsonRepresentation;	// IMP=0x00000000004f5850
- (id)dictionaryRepresentation;	// IMP=0x00000000004f45b2
- (id)description;	// IMP=0x00000000004f4503
- (void)dealloc;	// IMP=0x00000000004f1d07
- (id)initWithData:(id)arg1;	// IMP=0x00000000004f1cab
- (id)init;	// IMP=0x00000000004f1c4f
