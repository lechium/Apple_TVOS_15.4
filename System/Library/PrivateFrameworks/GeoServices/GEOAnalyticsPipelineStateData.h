...
@interface GEOAnalyticsPipelineStateData : PBCodable <NSCopying>
{
    ...
    _Bool _lookAroundIsLabelingShown;	// 562 = 0x232
    _Bool _lookaroundSessionHadMoveAction;	// 563 = 0x233
    _Bool _lookaroundSessionHadPanAction;	// 564 = 0x234
    _Bool _lookaroundSessionHadShareAction;	// 565 = 0x235
    _Bool _lookaroundSessionHadTapPoiAction;	// 566 = 0x236
    _Bool _lookaroundSessionHadZoomAction;	// 567 = 0x237
    _Bool _mapFeatureIsHomeFavoriteSet;	// 568 = 0x238
    _Bool _mapFeatureIsSchoolFavoriteSet;	// 569 = 0x239
    _Bool _mapFeatureIsTransitFavoriteSet;	// 570 = 0x23a
    _Bool _mapFeatureIsWorkFavoriteSet;	// 571 = 0x23b
    _Bool _mapLaunchIsHandoff;	// 572 = 0x23c
    _Bool _mapSettingsAvoidBusyRoads;	// 573 = 0x23d
    _Bool _mapSettingsAvoidHighways;	// 574 = 0x23e
    _Bool _mapSettingsAvoidHills;	// 575 = 0x23f
    _Bool _mapSettingsAvoidStairs;	// 576 = 0x240
    _Bool _mapSettingsAvoidTolls;	// 577 = 0x241
    _Bool _mapSettingsEBike;	// 578 = 0x242
    _Bool _mapSettingsFindMyCarEnabled;	// 579 = 0x243
    _Bool _mapSettingsHeadingEnabled;	// 580 = 0x244
    _Bool _mapSettingsIsHandsFreeProfileEnabled;	// 581 = 0x245
    _Bool _mapSettingsLabelEnabled;	// 582 = 0x246
    _Bool _mapSettingsNotificationsEnabled;	// 583 = 0x247
    _Bool _mapSettingsPauseSpokenAudioEnabled;	// 584 = 0x248
    _Bool _mapSettingsSpeedLimitEnabled;	// 585 = 0x249
    _Bool _mapSettingsTrafficEnabled;	// 586 = 0x24a
    _Bool _mapUiShownAqiShown;	// 587 = 0x24b
    _Bool _mapUiShownWeatherShown;	// 588 = 0x24c
    _Bool _mapViewIsAdvancedMap;	// 589 = 0x24d
    _Bool _mapViewIsGlobeProjection;	// 590 = 0x24e
    _Bool _mapViewLocationIsTourist;	// 591 = 0x24f
    _Bool _mapViewLocationPuckInViewport;	// 592 = 0x250
    _Bool _placeCardTransitAdvisoryBanner;	// 593 = 0x251
    _Bool _rideBookingAppEnabled;	// 594 = 0x252
    _Bool _rideBookingAppInstalled;	// 595 = 0x253
    _Bool _suggestionsSiriEnabled;	// 596 = 0x254
    _Bool _tableBookingAppEnabled;	// 597 = 0x255
    _Bool _tableBookingAppInstalled;	// 598 = 0x256
    _Bool _venueExperienceShown;	// 599 = 0x257
    struct {
...
+ (_Bool)isValid:(id)arg1;	// IMP=0x000000000118aff2
+ (Class)mapSettingsNavVoiceSettingsType;	// IMP=0x000000000117bf0b
+ (Class)suggestionsDisplayedResultsType;	// IMP=0x00000000011754cb
+ (Class)mapsServerMetadataSuggestionEntryDisplayedType;	// IMP=0x0000000001174a9b
- (void).cxx_destruct;	// IMP=0x000000000119583b
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000001194491
- (unsigned long long)hash;	// IMP=0x0000000001192adf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000011910c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000118fa4b
- (void)copyTo:(id)arg1;	// IMP=0x000000000118e863
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x000000000118e7ac
- (void)clearSensitiveFields:(unsigned long long)arg1;	// IMP=0x000000000118e64a
- (void)writeTo:(id)arg1;	// IMP=0x000000000118d0f3
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000118d0e4
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000118ad3f
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000118ad2d
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000001182707
- (id)jsonRepresentation;	// IMP=0x00000000011826f8
- (id)dictionaryRepresentation;	// IMP=0x000000000117c741
- (id)description;	// IMP=0x000000000117c692
...
- (id)mapSettingsNavVoiceSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000117beda
- (unsigned long long)mapSettingsNavVoiceSettingsCount;	// IMP=0x000000000117beae
- (void)addMapSettingsNavVoiceSettings:(id)arg1;	// IMP=0x000000000117bdef
- (void)clearMapSettingsNavVoiceSettings;	// IMP=0x000000000117bdbc
...
- (int)StringAsMapSettingsLocationPrecisionType:(id)arg1;	// IMP=0x000000000117b660
- (id)mapSettingsLocationPrecisionTypeAsString:(int)arg1;	// IMP=0x000000000117b5e3
...
- (int)StringAsRestoreUiTarget:(id)arg1;	// IMP=0x0000000001177a40
- (id)restoreUiTargetAsString:(int)arg1;	// IMP=0x00000000011759a9
@property(nonatomic) _Bool hasRestoreUiTarget;
@property(nonatomic) int restoreUiTarget;
- (int)StringAsRestoreLayoutStyle:(id)arg1;	// IMP=0x0000000001175830
- (id)restoreLayoutStyleAsString:(int)arg1;	// IMP=0x0000000001175799
@property(nonatomic) _Bool hasRestoreLayoutStyle;
@property(nonatomic) int restoreLayoutStyle;
- (int)StringAsRestoreLayoutInfo:(id)arg1;	// IMP=0x0000000001175660
- (id)restoreLayoutInfoAsString:(int)arg1;	// IMP=0x00000000011755e0
...
- (id)suggestionsDisplayedResultsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000117549a
- (unsigned long long)suggestionsDisplayedResultsCount;	// IMP=0x000000000117546e
- (void)addSuggestionsDisplayedResults:(id)arg1;	// IMP=0x00000000011753b9
- (void)clearSuggestionsDisplayedResults;	// IMP=0x0000000001175390
...
- (int)StringAsSuggestionsSearchFieldType:(id)arg1;	// IMP=0x0000000001175008
- (id)suggestionsSearchFieldTypeAsString:(int)arg1;	// IMP=0x0000000001174f88
...
- (id)mapsServerMetadataSuggestionEntryDisplayedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000001174a6a
- (unsigned long long)mapsServerMetadataSuggestionEntryDisplayedsCount;	// IMP=0x0000000001174a3e
- (void)addMapsServerMetadataSuggestionEntryDisplayed:(id)arg1;	// IMP=0x0000000001174986
- (void)clearMapsServerMetadataSuggestionEntryDisplayeds;	// IMP=0x000000000117495a
...
- (int)StringAsPlaceCardPlaceActionDetailsTransitPlaceCardTransitCategory:(id)arg1;	// IMP=0x00000000011742cc
- (id)placeCardPlaceActionDetailsTransitPlaceCardTransitCategoryAsString:(int)arg1;	// IMP=0x0000000001174228
...
- (int)StringAsPlaceCardPlaceCardType:(id)arg1;	// IMP=0x00000000011733f4
- (id)placeCardPlaceCardTypeAsString:(int)arg1;	// IMP=0x00000000011732e2
...
- (void)setPlaceCardUnactionableUiElements:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000011730df
- (int)placeCardUnactionableUiElementsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000001173009
- (void)addPlaceCardUnactionableUiElements:(int)arg1;	// IMP=0x0000000001172fc5
- (void)clearPlaceCardUnactionableUiElements;	// IMP=0x0000000001172f9e
...
- (void)setPlaceCardPossibleActions:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000001172e56
- (int)placeCardPossibleActionsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000001172d80
- (void)addPlaceCardPossibleActions:(int)arg1;	// IMP=0x0000000001172d3c
- (void)clearPlaceCardPossibleActions;	// IMP=0x0000000001172d15
...
- (int)StringAsMapUiShownActiveNavMode:(id)arg1;	// IMP=0x0000000001172248
- (id)mapUiShownActiveNavModeAsString:(int)arg1;	// IMP=0x00000000011721af
...
- (int)StringAsMapUiLayoutStyle:(id)arg1;	// IMP=0x0000000001171e0c
- (id)mapUiLayoutStyleAsString:(int)arg1;	// IMP=0x0000000001171d72
@property(nonatomic) _Bool hasMapUiLayoutStyle;
@property(nonatomic) int mapUiLayoutStyle;
- (int)StringAsMapUiLayoutInfo:(id)arg1;	// IMP=0x0000000001171c3c
- (id)mapUiLayoutInfoAsString:(int)arg1;	// IMP=0x0000000001171bbc
...
- (int)StringAsMapSettingsTransportMode:(id)arg1;	// IMP=0x00000000011715e8
- (id)mapSettingsTransportModeAsString:(int)arg1;	// IMP=0x000000000117154f
@property(nonatomic) _Bool hasMapSettingsTransportMode;
@property(nonatomic) int mapSettingsTransportMode;
- (int)StringAsMapSettingsNavVolume:(id)arg1;	// IMP=0x0000000001171400
- (id)mapSettingsNavVolumeAsString:(int)arg1;	// IMP=0x0000000001171376
...
- (int)StringAsMapViewViewMode:(id)arg1;	// IMP=0x0000000001171018
- (id)mapViewViewModeAsString:(int)arg1;	// IMP=0x0000000001170f58
...
- (int)StringAsMapViewMapType:(id)arg1;	// IMP=0x0000000001170c0c
- (id)mapViewMapTypeAsString:(int)arg1;	// IMP=0x0000000001170b82
...
- (void)dealloc;	// IMP=0x0000000001169d58
- (id)initWithData:(id)arg1;	// IMP=0x0000000001169cfc
- (id)init;	// IMP=0x0000000001169ca0
