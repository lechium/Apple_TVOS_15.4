...
+ (id)transitInfoSnippetForPlaceData:(id)arg1;	// IMP=0x00000000009c80cf
- (void).cxx_destruct;	// IMP=0x0000000000bdbcf0
- (unsigned long long)hash;	// IMP=0x0000000000bdbbcb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bdb97c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bdb371
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bdad74
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bdad65
- (id)jsonRepresentation;	// IMP=0x0000000000bda169
- (id)dictionaryRepresentation;	// IMP=0x0000000000bd990c
- (id)description;	// IMP=0x0000000000bd985d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bd7d78
- (id)init;	// IMP=0x0000000000bd7d1c
