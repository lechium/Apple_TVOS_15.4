...
- (id)initWithGEOPDViewportFrame:(id)arg1;	// IMP=0x000000000122b24f
- (id)initWithAltitude:(double)arg1 latitude:(double)arg2 longitude:(double)arg3 heading:(float)arg4 pitch:(float)arg5 distance:(float)arg6;	// IMP=0x000000000122b1c1
