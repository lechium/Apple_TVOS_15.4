...
- (void).cxx_destruct;	// IMP=0x000000000116570e
...
- (id)initWithDirectionsResponse:(id)arg1 fromRequest:(id)arg2;	// IMP=0x0000000001164cb0
- (id)initWithETAResult:(id)arg1 fromRequest:(id)arg2;	// IMP=0x000000000116482e
