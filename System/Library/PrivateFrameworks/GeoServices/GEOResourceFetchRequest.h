...
+ (Class)replyClass;	// IMP=0x0000000000effb29
- (void).cxx_destruct;	// IMP=0x0000000000f00188
...
- (_Bool)expectsReply;	// IMP=0x0000000000f00116
- (_Bool)isValid;	// IMP=0x0000000000f0010e
- (void)encodeToXPCDictionary:(id)arg1;	// IMP=0x0000000000effe01
- (id)initWithXPCDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000effb5c
- (id)initWithTraits:(id)arg1 auditToken:(id)arg2 throttleToken:(id)arg3;	// IMP=0x0000000000effb3a
