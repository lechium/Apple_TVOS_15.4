...
- (void).cxx_destruct;	// IMP=0x0000000000344254
...
- (id)description;	// IMP=0x0000000000344116
- (id)initWithBundleID:(id)arg1 title:(id)arg2 subtitle:(id)arg3 appClipURL:(id)arg4 artworkURL:(id)arg5;	// IMP=0x0000000000343f3f
