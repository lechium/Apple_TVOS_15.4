...
- (void).cxx_destruct;	// IMP=0x00000000005efb26
- (unsigned long long)hash;	// IMP=0x00000000005ef9a6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005ef6e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005ef1bb
- (void)writeTo:(id)arg1;	// IMP=0x00000000005eed39
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005eed2a
- (id)jsonRepresentation;	// IMP=0x00000000005eec18
- (id)dictionaryRepresentation;	// IMP=0x00000000005ee0fe
- (id)description;	// IMP=0x00000000005ee04f
- (id)initWithData:(id)arg1;	// IMP=0x00000000005ec9f2
- (id)init;	// IMP=0x00000000005ec996
