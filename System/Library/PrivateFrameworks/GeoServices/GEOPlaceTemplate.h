...
- (void).cxx_destruct;	// IMP=0x00000000011f77d1
...
- (id)initWithPlaceTemplate:(id)arg1 attributionMap:(id)arg2;	// IMP=0x00000000011f743b
- (id)initWithIdentifier:(id)arg1 supportsAreaHighlight:(_Bool)arg2;	// IMP=0x00000000011f738b
