...
- (_Bool)applyToSearchParameters:(id)arg1 error:(id *)arg2;	// IMP=0x00000000007df0a1
- (id)initWithResultTypes:(unsigned long long)arg1;	// IMP=0x00000000007df048
- (id)init;	// IMP=0x00000000007df01e
