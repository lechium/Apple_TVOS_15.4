...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x000000000029eb30
- (void).cxx_destruct;	// IMP=0x000000000029ec25
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x000000000029ea7e
