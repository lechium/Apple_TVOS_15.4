...
- (void).cxx_destruct;	// IMP=0x000000000098d399
- (_Bool)isFinished;	// IMP=0x000000000098d389
- (_Bool)isExecuting;	// IMP=0x000000000098d379
- (void)_completeOperation;	// IMP=0x000000000098d2b5
- (void)start;	// IMP=0x000000000098d207
- (id)initWithRemoteProxy:(id)arg1 runQueue:(id)arg2 completionQueue:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000098d0cc
