...
- (void).cxx_destruct;	// IMP=0x0000000001002b3e
...
- (unsigned long long)hash;	// IMP=0x00000000010028b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001002728
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001002631
- (void)writeTo:(id)arg1;	// IMP=0x0000000001002540
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000010020be
- (id)jsonRepresentation;	// IMP=0x00000000010020af
- (id)dictionaryRepresentation;	// IMP=0x0000000001001e31
- (id)description;	// IMP=0x0000000001001d82
