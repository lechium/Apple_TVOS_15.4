...
- (void).cxx_destruct;	// IMP=0x0000000000cd40f5
- (unsigned long long)hash;	// IMP=0x0000000000cd3c85
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cd39be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cd3557
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cd3164
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cd3155
- (id)jsonRepresentation;	// IMP=0x0000000000cd2530
- (id)dictionaryRepresentation;	// IMP=0x0000000000cd1c4f
- (id)description;	// IMP=0x0000000000cd1ba0
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cd01ff
- (id)init;	// IMP=0x0000000000cd01a3
