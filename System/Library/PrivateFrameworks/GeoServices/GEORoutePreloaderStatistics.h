...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000312546
- (void).cxx_destruct;	// IMP=0x0000000000312824
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000031271a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003125fd
- (id)initWithDateInterval:(id)arg1 transportType:(long long)arg2 tilesPreloaded:(unsigned long long)arg3 tilesUsed:(unsigned long long)arg4 tilesMissed:(unsigned long long)arg5;	// IMP=0x000000000031254e
