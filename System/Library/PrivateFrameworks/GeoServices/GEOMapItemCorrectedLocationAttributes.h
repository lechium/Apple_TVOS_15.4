...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000f237ad
- (void).cxx_destruct;	// IMP=0x0000000000f24441
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000f243a8
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000f2418e
- (unsigned long long)hash;	// IMP=0x0000000000f23fbc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000f23dfd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000f23b81
- (void)copyTo:(id)arg1;	// IMP=0x0000000000f23a2e
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x0000000000f239fd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000f237c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000f237ba
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000f236a1
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000f2368f
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000f23319
- (id)jsonRepresentation;	// IMP=0x0000000000f23207
- (id)dictionaryRepresentation;	// IMP=0x0000000000f22e5f
- (id)description;	// IMP=0x0000000000f22db0
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000f21e4d
- (id)init;	// IMP=0x0000000000f21df1
