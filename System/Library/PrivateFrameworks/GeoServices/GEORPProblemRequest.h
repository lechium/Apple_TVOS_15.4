...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000e378fd
- (void).cxx_destruct;	// IMP=0x0000000000e38d87
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000e38b88
- (unsigned long long)hash;	// IMP=0x0000000000e38a4b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e387be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e384b8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000e382ea
- (Class)responseClass;	// IMP=0x0000000000e382d9
- (unsigned int)requestTypeCode;	// IMP=0x0000000000e382ce
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x0000000000e38260
- (void)clearSensitiveFields:(unsigned long long)arg1;	// IMP=0x0000000000e37fa4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e37c4b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e37c3c
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000e3764a
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000e37638
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000e36fad
- (id)jsonRepresentation;	// IMP=0x0000000000e36f9e
- (id)dictionaryRepresentation;	// IMP=0x0000000000e36a83
- (id)description;	// IMP=0x0000000000e369d4
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e3516c
- (id)init;	// IMP=0x0000000000e35110
