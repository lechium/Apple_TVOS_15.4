...
- (void).cxx_destruct;	// IMP=0x0000000000c56128
...
- (id)description;	// IMP=0x0000000000c5609e
- (void)_buildPhotoList;	// IMP=0x0000000000c55d94
- (id)initWithCaptionedPhotoCategory:(id)arg1 attributionMap:(id)arg2;	// IMP=0x0000000000c55cc2
