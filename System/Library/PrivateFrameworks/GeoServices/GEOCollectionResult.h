...
+ (id)collectionResultsFromResponse:(id)arg1;	// IMP=0x00000000007ccc21
- (void).cxx_destruct;	// IMP=0x00000000007ccd82
@property(readonly, nonatomic) NSArray *placeCollectionItems;
@property(readonly, nonatomic) GEOPlaceCollection *collection;
- (id)initWithCollectionResult:(id)arg1;	// IMP=0x00000000007cc4a9
