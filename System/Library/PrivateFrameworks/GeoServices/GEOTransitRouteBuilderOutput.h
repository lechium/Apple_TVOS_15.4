...
- (void).cxx_destruct;	// IMP=0x0000000001230c6e
...
- (void)setSectionOptions:(id)arg1;	// IMP=0x0000000001230c28
- (void)setRideSelections:(id)arg1;	// IMP=0x0000000001230c14
- (void)setIsWalkingOnlyRoute:(_Bool)arg1;	// IMP=0x0000000001230c04
