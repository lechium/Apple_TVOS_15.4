...
- (void).cxx_destruct;	// IMP=0x000000000070e8d2
@property(readonly, nonatomic) CDStruct_d1a7ebee dataRequestKind;
- (void)cancel;	// IMP=0x000000000070e7f8
- (void)submitWithHandler:(CDUnknownBlockType)arg1 auditToken:(id)arg2 networkActivity:(CDUnknownBlockType)arg3 handlerQueue:(id)arg4;	// IMP=0x000000000070e4f6
- (id)initWithIpAddress:(id)arg1;	// IMP=0x000000000070e411
