...
- (void).cxx_destruct;	// IMP=0x000000000081f83f
...
- (void)updateQueryItemsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000081f6dc
- (id)initWithString:(id)arg1;	// IMP=0x000000000081f65e
- (id)initWithURL:(id)arg1;	// IMP=0x000000000081f5db
- (id)init;	// IMP=0x000000000081f59b
- (id)initWithURLComponents:(id)arg1;	// IMP=0x000000000081f4d6
