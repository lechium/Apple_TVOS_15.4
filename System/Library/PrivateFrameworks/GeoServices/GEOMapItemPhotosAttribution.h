...
- (id)urlsForPhotoWithIdentifier:(id)arg1;	// IMP=0x0000000001124ebb
@property(readonly, nonatomic) NSArray *addPhotoURLs;
- (id)initWithSearchAttributionInfo:(id)arg1 attributionURLs:(id)arg2 poiID:(id)arg3;	// IMP=0x0000000001124829
- (id)initWithSearchAttributionInfo:(id)arg1 attributionURLs:(id)arg2 yelpID:(id)arg3;	// IMP=0x000000000112470f
