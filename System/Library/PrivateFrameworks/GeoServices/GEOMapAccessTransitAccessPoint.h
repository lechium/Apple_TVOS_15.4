...
- (id).cxx_construct;	// IMP=0x00000000003585cb
- (void).cxx_destruct;	// IMP=0x0000000000358578
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000003584f6
- (id)findStation:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000035830e
- (id)findStops:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000358306
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003582c2
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000035823f
...
- (id)initWithMap:(id)arg1 accessPoint:(shared_ptr_4792c490)arg2;	// IMP=0x00000000003580bb
