...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000001113132
- (void).cxx_destruct;	// IMP=0x000000000111676a
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000111634a
- (unsigned long long)hash;	// IMP=0x00000000011156d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001114fd1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001114a4b
- (void)copyTo:(id)arg1;	// IMP=0x00000000011145ed
- (void)writeTo:(id)arg1;	// IMP=0x000000000111402d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000111401e
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000001112a4a
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000001112a38
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000011115eb
- (id)jsonRepresentation;	// IMP=0x00000000011115dc
- (id)dictionaryRepresentation;	// IMP=0x00000000011105b9
- (id)description;	// IMP=0x000000000111050a
...
- (int)StringAsTapBehavior:(id)arg1;	// IMP=0x00000000011101c6
- (id)tapBehaviorAsString:(int)arg1;	// IMP=0x0000000001110171
...
- (int)StringAsAutocompleteResultCellType:(id)arg1;	// IMP=0x000000000110ff64
- (id)autocompleteResultCellTypeAsString:(int)arg1;	// IMP=0x000000000110fed7
...
- (int)StringAsPoiOpenState:(id)arg1;	// IMP=0x000000000110e0dc
- (id)poiOpenStateAsString:(int)arg1;	// IMP=0x000000000110e051
...
- (int)StringAsServerEntryType:(id)arg1;	// IMP=0x000000000110dec4
- (id)serverEntryTypeAsString:(int)arg1;	// IMP=0x000000000110de47
...
- (int)StringAsSuggestionType:(id)arg1;	// IMP=0x000000000110d744
- (id)suggestionTypeAsString:(int)arg1;	// IMP=0x000000000110d634
@property(nonatomic) _Bool hasSuggestionType;
@property(nonatomic) int suggestionType;
- (id)initWithData:(id)arg1;	// IMP=0x000000000110d564
- (id)init;	// IMP=0x000000000110d508
