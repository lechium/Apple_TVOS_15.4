...
+ (_Bool)supportsTravelState:(long long)arg1 forTransportType:(int)arg2;	// IMP=0x00000000011590c7
+ (id)_routeHypothesisErrorWithUnderlyingError:(id)arg1;	// IMP=0x0000000001158f7d
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000115810e
- (void).cxx_destruct;	// IMP=0x0000000001159ad2
...
- (id)description;	// IMP=0x00000000011592fd
- (void)_clearHypothesisAndSetErrorWithCode:(long long)arg1;	// IMP=0x000000000115921f
- (void)_setError:(id)arg1;	// IMP=0x00000000011590e3
- (void)_updateTravelStateHasArrived:(_Bool)arg1 isTraveling:(_Bool)arg2 travelScore:(double)arg3 isNavigating:(_Bool)arg4 isNavigatingToDestination:(_Bool)arg5;	// IMP=0x0000000001158f0f
- (void)_updateTrafficIncidents:(id)arg1;	// IMP=0x0000000001158e72
- (void)_updateTrafficDensityDescription:(id)arg1;	// IMP=0x0000000001158e3f
- (void)_updateHistoricTrafficDensity:(double)arg1 staticTravelTime:(double)arg2;	// IMP=0x0000000001158dad
- (void)_updateCurrentTrafficDensity:(double)arg1 staticTravelTime:(double)arg2;	// IMP=0x0000000001158d1b
- (void)_updateDepartureAndArrivalSuggestionsForArrivalDate:(id)arg1 travelTimeWithTraffic:(double)arg2 conservativeTravelTime:(double)arg3 aggressiveTravelTime:(double)arg4 transportType:(int)arg5;	// IMP=0x0000000001158944
@property(readonly, nonatomic) NSString *trafficDensityDescription;
- (void)setRouteName:(id)arg1;	// IMP=0x000000000115889a
- (void)setSupportsLiveTraffic:(_Bool)arg1;	// IMP=0x0000000001158891
- (void)setLastLocation:(id)arg1;	// IMP=0x0000000001158880
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011584ff
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000115815f
- (void)dealloc;	// IMP=0x0000000001158116
