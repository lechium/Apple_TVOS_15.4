...
- (void).cxx_destruct;	// IMP=0x0000000000b80122
- (unsigned long long)hash;	// IMP=0x0000000000b7fe6b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b7fd36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b7fb2b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b7f8eb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b7f8dc
- (id)jsonRepresentation;	// IMP=0x0000000000b7d011
- (id)dictionaryRepresentation;	// IMP=0x0000000000b7cb43
- (id)description;	// IMP=0x0000000000b7ca94
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b7c232
- (id)init;	// IMP=0x0000000000b7c1d6
