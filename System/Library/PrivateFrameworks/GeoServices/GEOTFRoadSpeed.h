...
- (void).cxx_destruct;	// IMP=0x0000000000326e1b
- (unsigned long long)hash;	// IMP=0x000000000032698d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003266a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000326255
- (void)writeTo:(id)arg1;	// IMP=0x0000000000325d8d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000325d7e
- (id)jsonRepresentation;	// IMP=0x0000000000325b00
- (id)dictionaryRepresentation;	// IMP=0x000000000032517e
- (id)description;	// IMP=0x00000000003250cf
- (void)dealloc;	// IMP=0x0000000000323d61
- (id)initWithData:(id)arg1;	// IMP=0x0000000000323d05
- (id)init;	// IMP=0x0000000000323ca9
