...
- (void).cxx_destruct;	// IMP=0x000000000126e2d5
...
- (void)sendReplyWithXPCUserInfo:(id)arg1;	// IMP=0x000000000126e14a
- (void)sendReply:(id)arg1;	// IMP=0x000000000126dfe2
- (id)initWithXPCMessage:(id)arg1 peer:(id)arg2;	// IMP=0x000000000126db8d
- (id)init;	// IMP=0x000000000126db63
