...
- (void).cxx_destruct;	// IMP=0x00000000007750ec
...
- (void)cancel;	// IMP=0x0000000000774a06
- (void)start;	// IMP=0x00000000007747f0
@property float priority;
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)initWithSession:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3 requestKind:(CDStruct_d1a7ebee)arg4 requestCounterTicket:(id)arg5;	// IMP=0x00000000007744d9
- (_Bool)validateTileResponse:(_Bool)arg1 error:(id *)arg2;	// IMP=0x000000000049b977
- (void)_didCompleteSubtask:(id)arg1;	// IMP=0x0000000000775aa3
- (void)dataSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000007758af
- (void)dataSession:(id)arg1 willSendRequest:(id)arg2 forTask:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000775596
- (void)dataSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x0000000000775147
...
- (_Bool)getHeaderValue:(id *)arg1 forField:(id)arg2;	// IMP=0x0000000000776376
- (_Bool)validateTransportWithError:(id *)arg1;	// IMP=0x0000000000775fe2
- (_Bool)didValidateEntityTagForData:(id *)arg1 entityTag:(id *)arg2;	// IMP=0x0000000000775f28
- (double)loadTimeIncludingTask:(id)arg1;	// IMP=0x000000000077676d
