...
- (void).cxx_destruct;	// IMP=0x0000000000ffa682
...
- (id)convertToGEOPDResultRefinementToggle;	// IMP=0x0000000000ffa3ba
- (id)initWithResultRefinementToggle:(id)arg1;	// IMP=0x0000000000ffa195
- (id)initWithDisplayName:(id)arg1 isSelected:(_Bool)arg2 metadata:(id)arg3 toggleType:(unsigned long long)arg4 evChargingConnectorType:(int)arg5 selectionSequenceNumber:(id)arg6 selectionFromView:(_Bool)arg7 refinementKey:(id)arg8 showAsSelected:(_Bool)arg9;	// IMP=0x0000000000ffa035
