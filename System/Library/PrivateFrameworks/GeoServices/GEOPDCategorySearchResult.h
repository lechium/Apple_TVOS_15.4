...
- (void).cxx_destruct;	// IMP=0x00000000004fd8b1
- (unsigned long long)hash;	// IMP=0x00000000004fd665
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004fd287
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004fc9b7
- (void)writeTo:(id)arg1;	// IMP=0x00000000004fbe66
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004fbe57
- (id)jsonRepresentation;	// IMP=0x00000000004fb345
- (id)dictionaryRepresentation;	// IMP=0x00000000004fa230
- (id)description;	// IMP=0x00000000004fa181
- (id)initWithData:(id)arg1;	// IMP=0x00000000004f7367
- (id)init;	// IMP=0x00000000004f730b
