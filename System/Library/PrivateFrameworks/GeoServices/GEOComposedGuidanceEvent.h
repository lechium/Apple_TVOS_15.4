...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000009bcf4b
- (void).cxx_destruct;	// IMP=0x00000000009bd783
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009bd404
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009bcf53
- (long long)comparePriority:(id)arg1;	// IMP=0x00000000009bcd7f
- (long long)compareFactoringInSpeed:(id)arg1 speed:(double)arg2;	// IMP=0x00000000009bcb2a
- (long long)compare:(id)arg1;	// IMP=0x00000000009bca67
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009bc9b9
- (unsigned long long)hash;	// IMP=0x00000000009bc975
- (double)desiredTimeGapToEvent:(id)arg1 chained:(_Bool)arg2;	// IMP=0x00000000009bc6f8
- (double)triggerDistanceForSpeed:(double)arg1 andDuration:(CDUnknownBlockType)arg2;	// IMP=0x00000000009bc5ae
- (double)endDistanceForSpeed:(double)arg1;	// IMP=0x00000000009bc4dd
- (double)startDistanceForSpeed:(double)arg1;	// IMP=0x00000000009bc40e
- (_Bool)isValidForSpeed:(double)arg1;	// IMP=0x00000000009bc395
...
- (id)description;	// IMP=0x00000000009baea8
- (unsigned long long)_junctionViewIDForData:(id)arg1;	// IMP=0x00000000009bae2d
- (id)initWithGeoGuidanceEvent:(id)arg1 step:(id)arg2 legIndex:(unsigned long long)arg3 coordinates:(id)arg4;	// IMP=0x00000000009ba6a8
