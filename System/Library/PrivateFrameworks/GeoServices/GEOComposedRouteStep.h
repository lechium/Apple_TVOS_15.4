...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000011d8448
- (void).cxx_destruct;	// IMP=0x00000000011d88e5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011d8719
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011d8450
- (id)timeCheckpoints;	// IMP=0x00000000011d8432
- (double)travelTime;	// IMP=0x00000000011d8418
- (struct GEOPolylineCoordinateRange)routeCoordinateRange;	// IMP=0x00000000011d8368
...
- (id)firstNameOrBranch;	// IMP=0x00000000011d7f03
...
- (unsigned int)maneuverEndPointIndex;	// IMP=0x00000000011d6f81
- (unsigned int)maneuverStartPointIndex;	// IMP=0x00000000011d6f78
- (struct _NSRange)maneuverPointRange;	// IMP=0x00000000011d6f68
- (unsigned int)pointCount;	// IMP=0x00000000011d6f52
- (unsigned int)endPointIndex;	// IMP=0x00000000011d6f49
- (unsigned int)startPointIndex;	// IMP=0x00000000011d6f40
- (struct _NSRange)pointRange;	// IMP=0x00000000011d6f30
@property(readonly, nonatomic) int maneuverType;
@property(readonly, nonatomic) int transportType;
@property(readonly, nonatomic) GEOComposedRouteSegment *segment;
- (id)initWithComposedRoute:(id)arg1 geoRouteLeg:(id)arg2 geoStep:(id)arg3 routeSegmentType:(long long)arg4 stepIndex:(unsigned long long)arg5 pointRange:(struct _NSRange)arg6 maneuverPointRange:(struct _NSRange)arg7;	// IMP=0x00000000011d6c80
- (id)initWithComposedRoute:(id)arg1 routeSegmentType:(long long)arg2 stepIndex:(unsigned long long)arg3 pointRange:(struct _NSRange)arg4;	// IMP=0x00000000011d6c29
- (id)initWithComposedRoute:(id)arg1 geoRouteLeg:(id)arg2 geoStep:(id)arg3 routeSegmentType:(long long)arg4 stepIndex:(unsigned long long)arg5 startRouteCoordinate:(CDStruct_3f2a7a20)arg6 endRouteCoordinate:(CDStruct_3f2a7a20)arg7 maneuverStartRouteCoordinate:(CDStruct_3f2a7a20)arg8;	// IMP=0x00000000011d6a48
- (_Bool)shouldPreloadWithHighPriority;	// IMP=0x00000000006ef14b
- (_Bool)_belongsToTransferGroup;	// IMP=0x00000000010495ff
...
- (int)maneuver;	// IMP=0x00000000010493b2
