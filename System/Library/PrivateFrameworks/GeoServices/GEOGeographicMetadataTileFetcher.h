...
- (void).cxx_destruct;	// IMP=0x0000000001136f17
- (void)fetchMetadataWithResponseQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000001135b5b
- (id)initForTileStyle:(int)arg1 location:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000001134fdf
