...
- (void).cxx_destruct;	// IMP=0x00000000012b23c6
- (unsigned long long)hash;	// IMP=0x00000000012b22be
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000012b20ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000012b1c67
- (void)writeTo:(id)arg1;	// IMP=0x00000000012b16cb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000012b16bc
- (id)jsonRepresentation;	// IMP=0x00000000012b04f8
- (id)dictionaryRepresentation;	// IMP=0x00000000012afcbb
- (id)description;	// IMP=0x00000000012afc0c
- (id)initWithData:(id)arg1;	// IMP=0x00000000012ae992
- (id)init;	// IMP=0x00000000012ae936
