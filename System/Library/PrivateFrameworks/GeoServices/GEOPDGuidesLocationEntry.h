...
- (void).cxx_destruct;	// IMP=0x0000000000b2a550
- (unsigned long long)hash;	// IMP=0x0000000000b2a462
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b2a29a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b2a014
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b29d61
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b29d52
- (id)jsonRepresentation;	// IMP=0x0000000000b2907e
- (id)dictionaryRepresentation;	// IMP=0x0000000000b28bab
- (id)description;	// IMP=0x0000000000b28afc
- (void)dealloc;	// IMP=0x0000000000b27770
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b27714
- (id)init;	// IMP=0x0000000000b276b8
