...
- (void).cxx_destruct;	// IMP=0x000000000104a780
- (id)description;	// IMP=0x000000000104a70b
...
- (id)initWithContainedPlace:(id)arg1;	// IMP=0x000000000104a1f2
- (id)init;	// IMP=0x000000000104a1c8
