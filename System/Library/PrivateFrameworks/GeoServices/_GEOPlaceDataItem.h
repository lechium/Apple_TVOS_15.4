...
@class GEOAddress, GEOAddressObject, GEOAppleRating, GEOAssociatedApp, GEOBusinessHours, GEOEnclosingPlace, GEOEnhancedPlacement, GEOExploreGuides, GEOFeatureStyleAttributes, GEOLabelGeometry, GEOMapItemClientAttributes, GEOMapItemContainedPlace, GEOMapItemDetourInfo, GEOMapItemIdentifier, GEOMapItemPhotosAttribution, GEOMapItemPlaceAttribution, GEOMapItemReviewsAttribution, GEOMapRegion, GEOMessageLink, GEOMiniBrowseCategories, GEOPDBusinessClaim, GEOPDFlyover, GEOPDMultiLocalizedString, GEOPDPlace, GEOPlace, GEOPlaceQuestionnaire, GEOPlaceResult, GEOPlacecardLayoutData, GEOPriceDescription, GEORestaurantFeaturesLink, GEOStyleAttributes, GEOViewportFrame, NSArray, NSData, NSDate, NSDictionary, NSMapTable, NSString, NSTimeZone, NSURL, _GEOEncyclopedicInfo, geo_isolater, geo_reentrant_isolater;
...
@interface _GEOPlaceDataItem : NSObject <GEOMapItem>
{
    ...
    GEOPDPlace *_placeData;	// 16 = 0x10
    NSMapTable *_attributionMap;	// 24 = 0x18
    GEOPDMultiLocalizedString *_disambiguationLabel;	// 32 = 0x20
    GEOMapItemDetourInfo *_detourInfo;	// 40 = 0x28
    _Bool _isTransitDisplayFeature;	// 48 = 0x30
    NSData *_externalTransitStationCode;	// 56 = 0x38
    geo_isolater *_lazyIvarIsolater;	// 64 = 0x40
    GEOPlace *_place;	// 72 = 0x48
    _GEOEncyclopedicInfo *_encyclopedicInfo;	// 80 = 0x50
    id <GEOMapItemVenueInfo> _venueInfo;	// 88 = 0x58
    NSArray *_additionalPlaces;	// 96 = 0x60
    GEOAddressObject *_addressObject;	// 104 = 0x68
    NSString *_name;	// 112 = 0x70
    GEOBusinessHours *_businessHours;	// 120 = 0x78
    NSArray *_spatialMappedPlaceCategories;	// 128 = 0x80
    NSArray *_childItems;	// 136 = 0x88
    NSArray *_captionedPhotoAlbums;	// 144 = 0x90
    GEOPlacecardLayoutData *_placecardLayoutData;	// 152 = 0x98
    NSDictionary *_relatedPlacesByComponentId;	// 160 = 0xa0
    NSArray *_allPhotoAttributions;	// 168 = 0xa8
    geo_reentrant_isolater *_lazyReentrantIvarIsolater;	// 176 = 0xb0
    NSTimeZone *_timeZone;	// 184 = 0xb8
    NSArray *_prioritizedBusinessHours;	// 192 = 0xc0
    _Bool _checkedPrioritizedBusinessHours;	// 200 = 0xc8
}

- (void).cxx_destruct;	// IMP=0x0000000000c6ed62
...
- (id)_bestHeroBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000c6ceda
- (id)_bestNavbarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000c6cecb
- (id)_bestAvatarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000c6ca46
...
- (id)weatherDisplayName;	// IMP=0x0000000000c6bd2f
- (id)shortAddress;	// IMP=0x0000000000c6bc5f
- (id)addressObject;	// IMP=0x0000000000c6bbb6
...
- (id)_relatedPlacesByComponentId;	// IMP=0x0000000000c6b460
- (id)_firstRelatedPlaceListForType:(int)arg1;	// IMP=0x0000000000c6b303
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000c6b27c
...
- (id)_mapItemBySettingIsTransitDisplayFeature:(_Bool)arg1;	// IMP=0x0000000000c6a0a6
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000000c6a02e
...
- (id)_asPlaceInfo;	// IMP=0x0000000000c694e5
...
- (void)_refreshPhotoAttributions;	// IMP=0x0000000000c68748
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000c67b13
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000c67a14
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000c66969
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000c668e6
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x0000000000c6556a
...
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000000c64c1b
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlaceData:(id)arg1 detourInfo:(id)arg2 additionalPlaceDatas:(id)arg3;	// IMP=0x0000000000c64a2e
- (id)initWithPlaceData:(id)arg1 detourInfo:(id)arg2;	// IMP=0x0000000000c64a04
- (id)initWithPlaceData:(id)arg1;	// IMP=0x0000000000c649da
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2 disambiguationLabel:(id)arg3 detourInfo:(id)arg4 externalTransitStationCode:(id)arg5 additionalPlaces:(id)arg6;	// IMP=0x0000000000c645c5
