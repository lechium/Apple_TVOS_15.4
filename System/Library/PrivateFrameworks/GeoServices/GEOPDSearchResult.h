...
- (void).cxx_destruct;	// IMP=0x00000000005e5fce
- (unsigned long long)hash;	// IMP=0x00000000005e5c89
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005e56e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005e4a0a
- (void)writeTo:(id)arg1;	// IMP=0x00000000005e3f6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005e3f5e
- (id)jsonRepresentation;	// IMP=0x00000000005e3e4c
- (id)dictionaryRepresentation;	// IMP=0x00000000005e2248
- (id)description;	// IMP=0x00000000005e2199
- (id)initWithData:(id)arg1;	// IMP=0x00000000005de303
- (id)init;	// IMP=0x00000000005de2a7
