...
- (void).cxx_destruct;	// IMP=0x0000000000b56863
- (unsigned long long)hash;	// IMP=0x0000000000b56767
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b56551
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b56288
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b56006
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b55ff7
- (id)jsonRepresentation;	// IMP=0x0000000000b527e1
- (id)dictionaryRepresentation;	// IMP=0x0000000000b521a4
- (id)description;	// IMP=0x0000000000b520f5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b50d12
- (id)init;	// IMP=0x0000000000b50cb6
