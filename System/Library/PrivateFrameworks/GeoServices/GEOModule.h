...
- (void).cxx_destruct;	// IMP=0x00000000009d55de
- (id)description;	// IMP=0x00000000009d55c8
...
- (id)initWithModule:(id)arg1 moduleConfigProvider:(id)arg2;	// IMP=0x00000000009d4d4f
