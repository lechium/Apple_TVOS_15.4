...
- (void).cxx_destruct;	// IMP=0x00000000011e24e3
...
- (id)initWithPictureItem:(id)arg1;	// IMP=0x00000000011e238e
- (id)initWithPhoto:(id)arg1 pictureItemPhotoType:(int)arg2 primaryText:(id)arg3 secondaryText:(id)arg4;	// IMP=0x00000000011e225c
- (id)init;	// IMP=0x00000000011e2232
