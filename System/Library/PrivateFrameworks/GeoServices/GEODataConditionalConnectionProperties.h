...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000001266aa1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001266bff
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001266b52
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowDuration:(double)arg2;	// IMP=0x0000000001266b04
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowStartTime:(double)arg2 timeWindowDuration:(double)arg3;	// IMP=0x0000000001266aa9
