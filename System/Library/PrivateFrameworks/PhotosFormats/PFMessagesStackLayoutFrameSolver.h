...
- (void).cxx_destruct;	// IMP=0x000000000006ce0c
...
- (void)getGeometries:(CDStruct_decfe93a *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000006c84e
- (id)init;	// IMP=0x000000000006c7d1
