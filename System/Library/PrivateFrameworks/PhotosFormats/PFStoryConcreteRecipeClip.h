...
- (void).cxx_destruct;	// IMP=0x000000000003183d
...
- (_Bool)isEqualToClip:(id)arg1;	// IMP=0x0000000000031494
@property(readonly, nonatomic) NSString *diagnosticDescription;
- (id)initWithAssetIdentifier:(id)arg1 playbackStyle:(long long)arg2 minimumDuration:(CDStruct_1b6d18a9)arg3 idealDuration:(CDStruct_1b6d18a9)arg4 maximumDuration:(CDStruct_1b6d18a9)arg5 videoCueOffset:(CDStruct_1b6d18a9)arg6 motionStyle:(long long)arg7 transition:(long long)arg8;	// IMP=0x0000000000031361
