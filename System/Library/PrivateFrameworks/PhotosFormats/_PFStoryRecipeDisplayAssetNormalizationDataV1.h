...
+ (id)limits;	// IMP=0x0000000000019ad7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018e81
@property(readonly) unsigned long long hash;
- (id)initWithSliderNetPackedDataV1:(const CDStruct_3de61c9d *)arg1;	// IMP=0x0000000000018e12
