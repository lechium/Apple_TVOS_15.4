...
- (void).cxx_destruct;	// IMP=0x000000000007f129
...
- (void)cancel;	// IMP=0x000000000007f021
- (_Bool)waitForAvailabilityOfRange:(struct _NSRange)arg1 timeout:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000007ea8f
- (void)updateAvailableRange:(struct _NSRange)arg1;	// IMP=0x000000000007ea3c
- (id)init;	// IMP=0x000000000007e98c
