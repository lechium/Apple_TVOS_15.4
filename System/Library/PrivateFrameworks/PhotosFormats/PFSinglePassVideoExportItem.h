...
- (void).cxx_destruct;	// IMP=0x00000000000829cc
...
- (double)inputAssetDuration;	// IMP=0x00000000000825d0
- (void)_cancel;	// IMP=0x00000000000824ab
- (id)bitRateControllerForTargetEncodingBitRate:(long long)arg1;	// IMP=0x00000000000823bc
- (void)notifyDataAvailableToHandler:(CDUnknownBlockType)arg1 ignoreMinimumChunkLength:(_Bool)arg2;	// IMP=0x00000000000821ee
- (void)setupOutputFileSourceWithOutputAvailableHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000081e68
- (void)processCompressedSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 presentationTimeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000081a48
- (void)startReadingInputAssetWithOutputAvailableHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000008168b
- (long long)estimatedOutputBitRate;	// IMP=0x00000000000815c7
- (void)configureDroppableFrameRateForCompressionSession:(struct OpaqueVTCompressionSession *)arg1 inputWidth:(int)arg2 inputHeight:(int)arg3;	// IMP=0x0000000000081443
- (_Bool)setupConversionWithError:(id *)arg1;	// IMP=0x00000000000801b9
- (id)outputDataInRange:(struct _NSRange)arg1 waitUntilAvailableWithTimeout:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000007fe49
- (_Bool)startConversionWithError:(id *)arg1 outputAvailableHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000007fd9a
- (_Bool)preflight;	// IMP=0x000000000007faa5
- (void)dealloc;	// IMP=0x000000000007f8cb
- (id)init;	// IMP=0x000000000007f6eb
