...
- (void).cxx_destruct;	// IMP=0x000000000007e7ac
...
- (id)statisticsDescription;	// IMP=0x000000000007e609
- (void)enumerateStatisticsMeasurementsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000007e2e7
- (void)addStatisticsSampleForTimestamp:(double)arg1 error:(long long)arg2 feedback:(long long)arg3;	// IMP=0x000000000007e141
- (void)updateWithTimestamp:(double)arg1 error:(long long)arg2 feedback:(long long)arg3;	// IMP=0x000000000007e08c
- (id)initWithSetPoint:(long long)arg1;	// IMP=0x000000000007e017
