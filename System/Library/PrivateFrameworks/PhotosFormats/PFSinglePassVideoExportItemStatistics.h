...
+ (id)statisticsWithTargetPlaybackDuration:(CDStruct_1b6d18a9)arg1 frameRate:(float)arg2 targetOutputTotalBytes:(unsigned long long)arg3;	// IMP=0x000000000007df9c
- (void).cxx_destruct;	// IMP=0x000000000007df2c
...
- (id)summaryDescription;	// IMP=0x000000000007dcbb
- (id)outputChunkMeasurementsDescription;	// IMP=0x000000000007db91
...
- (void)enumerateOutputChunkMeasurementsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000007d7c9
- (void)addMeasurementForBytesDelivered:(unsigned long long)arg1;	// IMP=0x000000000007d67f
- (id)init;	// IMP=0x000000000007d604
