...
+ (id)remakerWithOperations:(id)arg1 options:(id)arg2;	// IMP=0x000000000004615d
- (void).cxx_destruct;	// IMP=0x00000000000453d3
...
- (void)_abortWithUnderlyingOperationError:(id)arg1;	// IMP=0x0000000000045206
- (void)_completeOperationWithUUID:(id)arg1;	// IMP=0x0000000000044f92
- (void)_configurePhotoOperation:(id)arg1 withUUID:(id)arg2 dispatchGroup:(id)arg3;	// IMP=0x0000000000044bbf
- (void)_configureVideoOperation:(id)arg1 withUUID:(id)arg2 dispatchGroup:(id)arg3;	// IMP=0x0000000000044823
- (void)_endSessionWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000000000446da
- (void)cancelRemaking;	// IMP=0x000000000004468f
- (void)_callProgressBlockWithProgress:(double)arg1;	// IMP=0x000000000004464d
- (double)_computeProgress;	// IMP=0x0000000000044560
- (void)_updateProgress;	// IMP=0x0000000000044453
- (void)remakeWithProgressHandler:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004439b
- (id)init;	// IMP=0x00000000000442b4
