...
- (_Bool)isEqualToStyle:(id)arg1;	// IMP=0x0000000000017555
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000174fc
@property(readonly, nonatomic) NSString *diagnosticDescription;
- (id)initWithIdentifier:(id)arg1 originalColorGradeCategory:(id)arg2 customColorGradeKind:(long long)arg3 songAssetIdentifier:(id)arg4 isCustomized:(_Bool)arg5;	// IMP=0x0000000000017319
- (id)init;	// IMP=0x0000000000017310
