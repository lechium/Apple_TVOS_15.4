...
+ (_Bool)isValidDCFFileName:(id)arg1;	// IMP=0x000000000008cb35
+ (_Bool)fileName:(id)arg1 matchesRegex:(id)arg2;	// IMP=0x000000000008cab1
+ (id)insertAuxiliaryResourceTypeMarker:(id)arg1 intoFileName:(id)arg2;	// IMP=0x000000000008c9da
+ (id)contentType;	// IMP=0x000000000008c9aa
+ (id)currentFormatVersion;	// IMP=0x000000000008cc22
- (void).cxx_destruct;	// IMP=0x000000000008c19d
...
- (id)writeFolderRepresentationToDirectory:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008b504
- (id)writeDowngradedRepresentationToDirectory:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008ae29
- (id)initWithOriginalVideoURL:(id)arg1 fullSizeRenderedVideoURL:(id)arg2 adjustmentBaseVideoURL:(id)arg3 spatialOvercaptureVideoURL:(id)arg4 adjustmentsURL:(id)arg5 originalAdjustmentsURL:(id)arg6 mediaSubtypes:(unsigned long long)arg7 playbackStyle:(long long)arg8 playbackVariation:(unsigned long long)arg9 reframeVariation:(unsigned long long)arg10;	// IMP=0x000000000008aa20
- (id)initWithOriginalPhotoURL:(id)arg1 alternatePhotoURL:(id)arg2 fullSizePhotoURL:(id)arg3 adjustmentBaseFullSizePhotoURL:(id)arg4 spatialOvercapturePhotoURL:(id)arg5 originalPairedVideoURL:(id)arg6 fullSizePairedVideoURL:(id)arg7 adjustmentBaseFullSizePairedVideoURL:(id)arg8 spatialOvercapturePairedVideoURL:(id)arg9 fullSizeVideoURL:(id)arg10 adjustmentsURL:(id)arg11 originalAdjustmentsURL:(id)arg12 mediaSubtypes:(unsigned long long)arg13 playbackStyle:(long long)arg14 playbackVariation:(unsigned long long)arg15 videoComplementVisibilityState:(unsigned short)arg16 reframeVariation:(unsigned long long)arg17;	// IMP=0x000000000008a3b4
- (_Bool)_writeFileAtURL:(id)arg1 toDirectory:(id)arg2 withUpdatedFilename:(id)arg3 writtenFileURL:(id *)arg4 error:(id *)arg5;	// IMP=0x000000000008a2ad
- (_Bool)_writeFileAtURL:(id)arg1 toDirectory:(id)arg2 writtenFileURL:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000008a285
- (id)createAssetBundleWritingErrorWithDescription:(id)arg1;	// IMP=0x000000000008a0bc
- (_Bool)_verifyFileSourceExistsAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000089eb3
- (_Bool)_pathExtension:(id)arg1 matchesType:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000089cae
- (_Bool)_writeFileAtURL:(id)arg1 toDirectory:(id)arg2 withUpdatedFilename:(id)arg3 updateManifest:(id)arg4 bundlePathKey:(id)arg5 verifyUTIType:(struct __CFString *)arg6 error:(id *)arg7;	// IMP=0x0000000000089870
- (id)urlsByPathKey;	// IMP=0x0000000000089619
- (_Bool)writeToBundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000089120
- (_Bool)writeAllResourceURLsToDirectoryAtURL:(id)arg1 updatingManifest:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000088e8e
- (id)generateCustomFilenamesByPathKey;	// IMP=0x0000000000088932
- (id)dcfCompliantFilenameBaseForWritingResourceFiles;	// IMP=0x00000000000884e3
- (_Bool)linkOrCopyURL:(id)arg1 toURL:(id)arg2 forceCopy:(_Bool)arg3 error:(id *)arg4;	// IMP=0x00000000000883bb
@property(nonatomic) _Bool spatialOvercaptureResourcesPurgeable;
@property(retain, nonatomic) id libraryLocation;
- (void)setLibraryCreationDate:(id)arg1 inTimeZone:(id)arg2;	// IMP=0x0000000000087e77
...
- (_Bool)isMediaSubtype:(unsigned long long)arg1;	// IMP=0x0000000000087c12
- (void)_readLivePhotoVideoMetadataIfNeeded;	// IMP=0x0000000000087b7c
...
- (id)initWithAssetBundleAtURL:(id)arg1;	// IMP=0x00000000000868f2
- (id)initWithPropertyList:(id)arg1;	// IMP=0x0000000000086067
