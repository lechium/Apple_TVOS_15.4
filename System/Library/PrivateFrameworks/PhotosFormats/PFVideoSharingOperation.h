...
+ (id)operationErrorWithCode:(long long)arg1 underlyingError:(id)arg2 withDescription:(id)arg3;	// IMP=0x0000000000090a47
- (void).cxx_destruct;	// IMP=0x000000000008fb93
...
- (void)cancel;	// IMP=0x000000000008f252
@property(readonly, nonatomic) float progress;
- (_Bool)_runExport;	// IMP=0x000000000008e3da
- (void)_validateMetadata;	// IMP=0x000000000008db3f
- (_Bool)_ensureVideoProperties;	// IMP=0x000000000008d89a
- (void)main;	// IMP=0x000000000008d843
- (id)initWithVideoURL:(id)arg1 adjustmentData:(id)arg2;	// IMP=0x000000000008d75a
