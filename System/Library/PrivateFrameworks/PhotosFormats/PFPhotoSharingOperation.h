...
+ (id)operationErrorWithCode:(long long)arg1 withDescription:(id)arg2;	// IMP=0x0000000000042772
+ (_Bool)outputSupportedForTypeIdentifier:(id)arg1;	// IMP=0x0000000000042714
- (void).cxx_destruct;	// IMP=0x0000000000041ebe
...
- (void)main;	// IMP=0x000000000003fdc2
- (id)initWithImageURL:(id)arg1 adjustmentData:(id)arg2;	// IMP=0x000000000003fcd9
