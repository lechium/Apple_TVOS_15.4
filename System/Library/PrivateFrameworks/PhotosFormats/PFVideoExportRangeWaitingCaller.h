...
+ (id)waitingCallerWithRequestedRange:(struct _NSRange)arg1;	// IMP=0x000000000007e94c
- (void).cxx_destruct;	// IMP=0x000000000007e93c
...
- (void)resume;	// IMP=0x000000000007e880
- (void)waitWithTimeout:(unsigned long long)arg1;	// IMP=0x000000000007e86f
- (_Bool)canResumeForRange:(struct _NSRange)arg1;	// IMP=0x000000000007e844
- (id)init;	// IMP=0x000000000007e7f3
