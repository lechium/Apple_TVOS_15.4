...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000d2c3
- (void).cxx_destruct;	// IMP=0x000000000000d0af
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ce86
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cd3b
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000cd0d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000cd02
- (id)initWithEffectFilter:(id)arg1 cropRect:(struct CGRect)arg2;	// IMP=0x000000000000cc7c
- (id)initWithAdjustments:(id)arg1;	// IMP=0x000000000000cb5c
