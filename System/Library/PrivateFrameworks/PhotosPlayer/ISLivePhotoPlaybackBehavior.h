...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d571
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d4dd
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d47e
- (void)_didFinishPreparing;	// IMP=0x000000000000d42c
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000d41a
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000d338
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000d294
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000d04b
- (void)startPlayback;	// IMP=0x000000000000cfc0
- (void)activeDidChange;	// IMP=0x000000000000cf40
- (void)videoDidPlayToEnd;	// IMP=0x000000000000cefc
- (void)_handleDidFinish;	// IMP=0x000000000000ce8d
- (void)videoWillPlayToEnd;	// IMP=0x000000000000cd08
- (long long)behaviorType;	// IMP=0x000000000000ccfd
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000cbc0
