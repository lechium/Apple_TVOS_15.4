...
- (void).cxx_destruct;	// IMP=0x0000000000020cb3
...
- (void)_updateVitalityFilters;	// IMP=0x0000000000020a3d
- (id)_newVitalityFilter;	// IMP=0x00000000000209b9
- (void)canPerformVitalityDidChange;	// IMP=0x00000000000209a0
@property(readonly, nonatomic) _Bool canPerformVitality;
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000208cc
- (void)didLayoutPlayerViews;	// IMP=0x00000000000208b8
- (void)removePlayerView:(id)arg1;	// IMP=0x0000000000020846
- (void)addPlayerView:(id)arg1;	// IMP=0x00000000000207d4
- (id)init;	// IMP=0x0000000000020713
