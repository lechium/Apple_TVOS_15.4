...
- (void)getVisibility:(_Bool *)arg1 offset:(double *)arg2 targetVisibilityOffset:(double *)arg3 forView:(id)arg4;	// IMP=0x0000000000024a9c
- (struct CGRect)boundsForView:(id)arg1 inScrollView:(id)arg2;	// IMP=0x0000000000024a7e
- (struct CGRect)visibleRectForScrollView:(id)arg1;	// IMP=0x0000000000024a60
- (struct ISVisibilityRange)_visibilityRangeForRect:(struct CGRect)arg1;	// IMP=0x0000000000024927
- (void)_updateDirectionIfNeeded;	// IMP=0x0000000000024864
- (void)computeVisibilityOffsetsInScrollView:(id)arg1 withTargetContentOffset:(struct CGPoint)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000247ca
