...
- (void).cxx_destruct;	// IMP=0x0000000000013573
...
- (void)cancelSettleToPhoto;	// IMP=0x00000000000133ca
- (void)_didReachTransitionToPhotoTime;	// IMP=0x0000000000013190
- (void)_didReachTransitionTime;	// IMP=0x0000000000013076
- (void)_startVideoPlayback;	// IMP=0x0000000000012f47
- (void)videoReadyForDisplayDidChange;	// IMP=0x0000000000012ede
- (void)playVitality;	// IMP=0x0000000000012e4d
- (long long)behaviorType;	// IMP=0x0000000000012e42
- (void)_handleDidFinishPreroll;	// IMP=0x0000000000012de9
- (void)_handleDidSeekToStartTime;	// IMP=0x0000000000012cc4
- (void)_stopObservingVideo;	// IMP=0x0000000000012c27
- (void)_startObservingVideo;	// IMP=0x00000000000127dd
- (void)prepareForVitality;	// IMP=0x0000000000012524
- (void)activeDidChange;	// IMP=0x000000000001248a
- (id)initWithInitialLayoutInfo:(id)arg1 playbackEndTime:(CDStruct_1b6d18a9)arg2 playDuration:(CDStruct_1b6d18a9)arg3 playRate:(float)arg4 photoTransitionDuration:(double)arg5 pauseDuringTransition:(_Bool)arg6 assetOptions:(unsigned long long)arg7;	// IMP=0x00000000000123d4
- (void)dealloc;	// IMP=0x0000000000012317
