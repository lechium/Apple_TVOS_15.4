...
- (void)dealloc;	// IMP=0x000000000001d8c2
- (id)description;	// IMP=0x000000000001d842
- (id)initWithPhoto:(struct CGImage *)arg1 photoIsOriginal:(_Bool)arg2 photoEXIFOrientation:(int)arg3 videoPlayer:(id)arg4 videoSize:(struct CGSize)arg5;	// IMP=0x000000000001d791
