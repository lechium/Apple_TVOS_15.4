...
- (void).cxx_destruct;	// IMP=0x000000000002526a
...
- (void)inputDidChange;	// IMP=0x000000000002508d
- (void)_invalidateOutput;	// IMP=0x0000000000025076
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024f9e
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024f0e
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000024ea3
- (id)init;	// IMP=0x0000000000024e8f
