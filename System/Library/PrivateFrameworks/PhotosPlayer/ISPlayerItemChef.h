...
+ (id)defaultChef;	// IMP=0x000000000001d73c
...
- (void)cancelPreparationOfIrisAssetWithRequestID:(long long)arg1;	// IMP=0x000000000001c40a
- (long long)prepareIrisPlayerItemWithAsset:(id)arg1 trimmedTimeRange:(CDStruct_e83c9415)arg2 photoTime:(CDStruct_1b6d18a9)arg3 includeVideo:(_Bool)arg4 includeAudio:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x000000000001c197
- (long long)prepareIrisVideoWithAsset:(id)arg1 photoTime:(CDStruct_1b6d18a9)arg2 trimmedTimeRange:(CDStruct_e83c9415)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000001c0c4
- (id)init;	// IMP=0x000000000001c005
