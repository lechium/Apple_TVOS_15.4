...
- (void)updateOutput;	// IMP=0x0000000000013894
- (void)invalidateOutput;	// IMP=0x000000000001387d
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000137ed
- (void)setState:(long long)arg1;	// IMP=0x000000000001376f
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000013704
- (id)init;	// IMP=0x00000000000136f0
