...
- (long long)behaviorType;	// IMP=0x0000000000010ed0
- (void)_handleDidSeekToSeekTime:(_Bool)arg1;	// IMP=0x0000000000010deb
- (void)_callSeekCompletionHandler:(_Bool)arg1;	// IMP=0x0000000000010d52
- (void)_seekIfNeeded;	// IMP=0x0000000000010c8d
- (void)activeDidChange;	// IMP=0x0000000000010b8a
- (id)initWithInitialLayoutInfo:(id)arg1 seekTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000010ae0
