...
- (void).cxx_destruct;	// IMP=0x000000000000b694
...
- (id)artworkURLForSize:(struct CGSize)arg1 expectedSize:(struct CGSize *)arg2;	// IMP=0x000000000000b178
...
- (void)_radioModelWasDeletedNotification:(id)arg1;	// IMP=0x00000000000056b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000054c0
@property(readonly) unsigned long long hash;
- (void)dealloc;	// IMP=0x000000000000539f
- (id)initWithModel:(id)arg1 managedObject:(id)arg2;	// IMP=0x00000000000052b4
