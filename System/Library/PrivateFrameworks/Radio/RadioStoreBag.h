...
- (id)_platformContext;	// IMP=0x000000000001e6e4
- (id)_cacheRepresentation;	// IMP=0x000000000001e52f
- (id)_initWithCacheRepresentation:(id)arg1;	// IMP=0x000000000001e4c2
@property(readonly, copy, nonatomic) NSDictionary *URLBagDictionary;
@property(readonly, nonatomic) _Bool shouldSendKBSyncData;
- (_Bool)shouldMescalVerifyResponseFromURL:(id)arg1;	// IMP=0x000000000001e40a
- (_Bool)shouldMescalSignRequestWithURL:(id)arg1;	// IMP=0x000000000001e3a6
...
- (id)_initWithURLBagDictionary:(id)arg1;	// IMP=0x000000000001de30
