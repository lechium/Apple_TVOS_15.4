...
+ (id)logHandle;	// IMP=0x0000000000061fc4
- (void).cxx_destruct;	// IMP=0x0000000000062b71
...
- (_Bool)_isChangingEnabledState;	// IMP=0x00000000000629a3
@property(readonly, nonatomic) _Bool canEnableSyncing;
- (id)description;	// IMP=0x000000000006275b
...
- (id)syncErrorWithDomain:(id)arg1 code:(long long)arg2;	// IMP=0x00000000000624e6
@property(readonly, nonatomic) _Bool isSyncingPaused;
@property(readonly, nonatomic) _Bool isSyncing;
- (id)initWithAccountEnabled:(_Bool)arg1 stateDictionary:(id)arg2;	// IMP=0x000000000006203a
- (id)logHandle;	// IMP=0x0000000000062020
- (id)createSyncProgressWithSyncStatistics:(id)arg1;	// IMP=0x000000000010fdeb
- (_Bool)shouldFetchSyncStatistics;	// IMP=0x000000000010fdaf
- (_Bool)shouldRescheduleSyncSyncProgress;	// IMP=0x000000000010fd64
- (_Bool)_shouldHideProgressInFirstSevenDays;	// IMP=0x000000000010fbf4
