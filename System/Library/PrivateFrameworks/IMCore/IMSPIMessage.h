...
- (void).cxx_destruct;	// IMP=0x000000000013ac8b
...
- (id)spiChatWithQOS:(unsigned int)arg1;	// IMP=0x000000000013a529
@property(readonly) NSDate *lastReadDate;
@property(readonly) NSURL *url;
- (id)description;	// IMP=0x000000000013a2f6
- (void)dealloc;	// IMP=0x000000000013a191
