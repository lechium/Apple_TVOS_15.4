...
- (void).cxx_destruct;	// IMP=0x000000000009e7eb
...
- (id)description;	// IMP=0x000000000009e393
- (void)configureSelf;	// IMP=0x000000000009e38d
@property(readonly, nonatomic) NSString *percentCompleteString; // @dynamic percentCompleteString;
- (id)initWithSyncState:(id)arg1 syncStatistics:(id)arg2;	// IMP=0x000000000009e216
- (id)init;	// IMP=0x000000000009e200
