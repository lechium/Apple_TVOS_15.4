...
- (void).cxx_destruct;	// IMP=0x0000000000078ed0
...
- (id)_initWithItem:(id)arg1 sender:(id)arg2 otherHandle:(id)arg3;	// IMP=0x0000000000078d90
@property(readonly, nonatomic) long long direction;
@property(readonly, nonatomic) long long actionType;
@property(readonly, nonatomic) _Bool isFromMe;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000078c78
