...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x0000000000061b83
- (void).cxx_destruct;	// IMP=0x0000000000061f85
...
- (void)invalidate;	// IMP=0x0000000000061e86
- (void)triggerTimeout;	// IMP=0x0000000000061de9
- (void)timerCallback;	// IMP=0x0000000000061d54
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x0000000000061b8b
