...
- (void).cxx_destruct;	// IMP=0x00000000000745ff
...
- (_Bool)wantsAutoPlayback;	// IMP=0x000000000007448a
...
- (id)_initWithItem:(id)arg1 initialPayload:(id)arg2 index:(long long)arg3 messagePartRange:(struct _NSRange)arg4 parentChatHasKnownParticipants:(_Bool)arg5;	// IMP=0x0000000000073c3b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000073b62
@property(readonly, copy) NSString *description;
@property(readonly, retain, nonatomic) NSString *type;
- (id)replyContextPreviewChatItemForReply:(id)arg1 chatContext:(id)arg2;	// IMP=0x0000000000073941
