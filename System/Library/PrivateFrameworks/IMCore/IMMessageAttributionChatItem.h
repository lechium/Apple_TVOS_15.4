...
- (void).cxx_destruct;	// IMP=0x0000000000077cb8
...
- (id)_initWithItem:(id)arg1 attributionInfo:(id)arg2 attributionType:(long long)arg3 showsLearnMoreLink:(_Bool)arg4;	// IMP=0x0000000000077bb1
