...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000019d6f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001a640
- (id)initWithCoder:(id)arg1 additionalAllowedClasses:(id)arg2;	// IMP=0x000000000001a0f2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001a0de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019d77
- (id)payloadDictionary;	// IMP=0x0000000000019b5c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000019af5
- (unsigned long long)hash;	// IMP=0x0000000000019a04
- (_Bool)isEqualToPluginPayload:(id)arg1;	// IMP=0x0000000000019288
@property(readonly, nonatomic) _Bool shouldHideAttachments;
- (void)addAttachmentsFromFilePaths:(id)arg1;	// IMP=0x0000000000018ff4
- (void)addAttachmentsFromFileTransferGUIDs:(id)arg1;	// IMP=0x0000000000018d4a
- (id)initWithMessageItem:(id)arg1 chatContext:(id)arg2;	// IMP=0x000000000001839a
- (id)initWithMessageItem:(id)arg1;	// IMP=0x0000000000018386
- (id)initWithMessage:(id)arg1;	// IMP=0x0000000000018330
