...
- (void).cxx_destruct;	// IMP=0x0000000000077e9f
...
- (id)_initWithItem:(id)arg1 parentItem:(id)arg2 threadIdentifier:(id)arg3 replyMessageGUID:(id)arg4 replyIsFromMe:(_Bool)arg5 count:(unsigned long long)arg6;	// IMP=0x0000000000077ccb
