...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007aa70
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007a9b9
- (unsigned long long)hash;	// IMP=0x000000000007a96a
- (id)_initWithAcknowledgments:(id)arg1;	// IMP=0x000000000007a3a3
