...
- (void).cxx_destruct;	// IMP=0x00000000000751da
...
- (void)configureStatusTextWithAccount:(id)arg1;	// IMP=0x0000000000074b46
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000749f2
- (id)_initWithItem:(id)arg1 datasource:(id)arg2 statusText:(id)arg3 optionFlags:(unsigned long long)arg4;	// IMP=0x00000000000748ab
