...
+ (id)sharedInstance;	// IMP=0x00000000000021dc
- (void).cxx_destruct;	// IMP=0x0000000000003358
...
- (void)_persistMetric;	// IMP=0x0000000000002fbd
- (void)_submitMetric;	// IMP=0x0000000000002d18
- (void)_submitMetricIfNeeded;	// IMP=0x0000000000002c28
- (void)metricHistoryQueryOrder:(id)arg1;	// IMP=0x0000000000002b0f
- (void)_metricHistoryQueryOrder:(id)arg1;	// IMP=0x00000000000029b7
- (_Bool)_metricIncomingMessage:(id)arg1 items:(id)arg2 withContext:(long long)arg3;	// IMP=0x000000000000253d
- (void)metricIncomingMessage:(id)arg1 items:(id)arg2;	// IMP=0x00000000000023dd
- (void)dealloc;	// IMP=0x0000000000002375
- (id)init;	// IMP=0x0000000000002275
