...
- (void).cxx_destruct;	// IMP=0x00000000000794eb
...
- (id)_initWithItem:(id)arg1 sender:(id)arg2 otherHandle:(id)arg3;	// IMP=0x00000000000793ab
@property(readonly, nonatomic) long long actionType;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000792ec
