...
+ (unsigned long long)presentationContextsForInfoPlistArray:(id)arg1 isStickerPackOnly:(_Bool)arg2;	// IMP=0x00000000000d97e4
+ (void)_setUnremovableDisabledApps:(id)arg1;	// IMP=0x00000000000d9785
+ (id)_unremovableDisabledApps;	// IMP=0x00000000000d96b4
+ (id)appWithPluginBundle:(id)arg1 appBundle:(id)arg2;	// IMP=0x00000000000d8efe
+ (id)appWithPluginBundle:(id)arg1;	// IMP=0x00000000000d8eaf
+ (id)appWithPluginBundle:(id)arg1 extension:(id)arg2;	// IMP=0x00000000000d8e3f
+ (id)appWithPluginBundle:(id)arg1 pluginKitProxy:(id)arg2 extension:(id)arg3;	// IMP=0x00000000000d8daa
- (void).cxx_destruct;	// IMP=0x00000000000d9a14
...
- (void)_loadBundle;	// IMP=0x00000000000d9150
- (id)initWithPluginBundle:(id)arg1 appBundle:(id)arg2;	// IMP=0x00000000000d8f6e
