...
- (void).cxx_destruct;	// IMP=0x000000000007aff5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007aee5
@property(readonly, nonatomic) struct IMAssociatedMessageGeometryDescriptor geometryDescriptor;
- (id)_initWithItem:(id)arg1 highlightedMessagePartGUID:(id)arg2 highlightedMessagePartIndex:(long long)arg3 highlightedMessagePartRange:(struct _NSRange)arg4;	// IMP=0x000000000007ad8a
