...
- (void).cxx_destruct;	// IMP=0x0000000000139bb1
...
- (id)description;	// IMP=0x0000000000139aaf
- (id)initWithChatGuid:(id)arg1 displayName:(id)arg2 participants:(id)arg3;	// IMP=0x00000000001399f8
